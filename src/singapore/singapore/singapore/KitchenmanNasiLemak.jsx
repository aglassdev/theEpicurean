...
const KitchenmanNasiLemak = () => (
  <RestaurantPage
    restaurantName="Kitchenman Nasi Lemak"
    address="CT Hub, #01-08/13, 2 Kallang Avenue, 339407, Singapore"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+6591426586"
    website="https://kitchenmannasilemak.oddle.me/en_SG"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Malaysian owner opened this simple shop in 2024, specialising in authentic nasi lemak, often considered the national dish of his home country. The chef, who is also Malaysian, cooks rice in coconut milk with pandan leaves, and garnishes it with fried anchovies, peanuts, fried egg, sliced cucumber and spicy sambal. For a substantial meal, add sides such as ayam berempah (fried chicken leg), rendang chicken or ayam kunyit (turmeric chicken)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=CT%20Hub%2C%20%2301-08%2F13%2C%202%20Kallang%20Avenue%2C%20339407%2C%20Singapore"
    pageTitle="Kitchenman Nasi Lemak"
  />
);

export default KitchenmanNasiLemak;
