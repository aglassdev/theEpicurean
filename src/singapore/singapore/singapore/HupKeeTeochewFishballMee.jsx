...
const HupKeeTeochewFishballMee = () => (
  <RestaurantPage
    restaurantName="Hup Kee Teochew Fishball Mee"
    address="Mei Ling Market & Food Centre, #02-38, 159 Mei Chin Road, 140159, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hup-kee-teochew-fishball-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular stall is always busy, even at off-peak times. There are different noodles to choose from, and these are topped with tasty fish balls, pork balls and fried fish cakes. A little of the hot sauce goes a long way!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mei%20Ling%20Market%20%26%20Food%20Centre%2C%20%2302-38%2C%20159%20Mei%20Chin%20Road%2C%20140159%2C%20Singapore"
    pageTitle="Hup Kee Teochew Fishball Mee"
  />
);

export default HupKeeTeochewFishballMee;
