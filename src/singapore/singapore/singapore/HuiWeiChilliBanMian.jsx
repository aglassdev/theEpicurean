...
const HuiWeiChilliBanMian = () => (
  <RestaurantPage
    restaurantName="Hui Wei Chilli Ban Mian"
    address="Geylang Bahru Market & Food Centre, #01-58, 69 Geylang Bahru, 330069, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hui-wei-chilli-ban-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bouncy ribbon noodles made at the stall are served in soup or dry – tossed in house-made chilli sauce and topped with minced meat, meatballs, poached egg and fried lard. With limited availability, they tend to sell out early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geylang%20Bahru%20Market%20%26%20Food%20Centre%2C%20%2301-58%2C%2069%20Geylang%20Bahru%2C%20330069%2C%20Singapore"
    pageTitle="Hui Wei Chilli Ban Mian"
  />
);

export default HuiWeiChilliBanMian;
