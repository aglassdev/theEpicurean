...
const LianHeBenJiClaypot = () => (
  <RestaurantPage
    restaurantName="Lian He Ben Ji Claypot"
    address="Chinatown Complex Market & Food Centre, #02-198/199, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lian-he-ben-ji-claypot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It takes 30 minutes to cook but is more than worth the wait. The rice, cooked in a claypot over charcoal, exudes smokiness with a crispy scorched crust on the bottom. For toppings, choose between chicken, preserved pork and/or sausage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-198%2F199%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="Lian He Ben Ji Claypot"
  />
);

export default LianHeBenJiClaypot;
