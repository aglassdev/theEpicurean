...
const DaShiJiaBigPrawnMee = () => (
  <RestaurantPage
    restaurantName="Da Shi Jia Big Prawn Mee"
    address="89 Killiney Road, 239534, Singapore"
    cuisine="Singaporean"
    priceRange="$"
    phoneNumber="+6589086949"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/da-shi-jia"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=89%20Killiney%20Road%2C%20239534%2C%20Singapore"
    pageTitle="Da Shi Jia Big Prawn Mee"
  />
);

export default DaShiJiaBigPrawnMee;
