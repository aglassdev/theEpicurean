...
const ChompChompSatay = () => (
  <RestaurantPage
    restaurantName="Chomp Chomp Satay"
    address="Chomp Chomp Food Centre, #01-34, 20 Kensington Park Road, 557269, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/chomp-chomp-satay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opt for pork, chicken, mutton or ketupat served with pineapple sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chomp%20Chomp%20Food%20Centre%2C%20%2301-34%2C%2020%20Kensington%20Park%20Road%2C%20557269%2C%20Singapore"
    pageTitle="Chomp Chomp Satay"
  />
);

export default ChompChompSatay;
