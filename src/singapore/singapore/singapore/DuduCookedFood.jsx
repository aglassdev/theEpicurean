...
const DuduCookedFood = () => (
  <RestaurantPage
    restaurantName="Dudu Cooked Food"
    address="Jurong West 505 Market & Food Centre, #01-19, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6596858694"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/du-du-shou-shi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall carries two varieties of tu tu kueh – coconut and peanut. The steamed rice cake is chewy and springy on the outside; both fillings are nutty, sweet and aromatic. Best enjoyed piping hot!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-19%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Dudu Cooked Food"
  />
);

export default DuduCookedFood;
