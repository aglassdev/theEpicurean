...
const JiangnanChun = () => (
  <RestaurantPage
    ...
    address="Four Seasons Hotel, Level 2, 190 Orchard Boulevard, 248646, Singapore"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+6568317220"
    website="https://www.fourseasons.com/singapore/dining/restaurants/jiang_nan_chun/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This exquisite space, reached via a marble staircase, is warm and welcoming, with heavy leather chairs that are especially comfortable. The kitchen team excels in barbecue meats, double-boiled soups and seafood dishes that use the freshest ingredients of the best quality. Try wok-fried Australian beef tenderloin with portobello mushrooms. Set menus are a great way to sample the popular hits all at once...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Hotel%2C%20Level%202%2C%20190%20Orchard%20Boulevard%2C%20248646%2C%20Singapore"
