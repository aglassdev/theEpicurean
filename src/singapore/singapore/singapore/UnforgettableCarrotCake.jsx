...
const UnforgettableCarrotCake = () => (
  <RestaurantPage
    restaurantName="Unforgettable Carrot Cake"
    address="115 Bukit Merah View Market & Hawker Centre, #01-30, Blk 115 Bukit Merah View, 151115, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/unforgettable-carrot-cake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not to be confused with the western sweet of the same name, carrot cake here is savoury, made with radish and stir-fried in seasoning. Opt for the dark version coated in egg, and tossed in sticky, caramelised dark soy sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Bukit%20Merah%20View%20Market%20%26%20Hawker%20Centre%2C%20%2301-30%2C%20Blk%20115%20Bukit%20Merah%20View%2C%20151115%2C%20Singapore"
    pageTitle="Unforgettable Carrot Cake"
  />
);

export default UnforgettableCarrotCake;
