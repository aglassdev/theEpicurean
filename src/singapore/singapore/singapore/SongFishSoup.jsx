...
const SongFishSoup = () => (
  <RestaurantPage
    restaurantName="Song Fish Soup"
    address="Clementi 448 Food Centre, #01-38, 448 Clementi Ave 3, 120448, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/song-fish-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu offers blanched sliced fish, deep-fried fish and fish maw, either in fish broth or bee hoon soup. Fish maw double fish soup lets you sample three items at once. Fish head, clams and shrimps are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Clementi%20448%20Food%20Centre%2C%20%2301-38%2C%20448%20Clementi%20Ave%203%2C%20120448%2C%20Singapore"
    pageTitle="Song Fish Soup"
  />
);

export default SongFishSoup;
