...
const SpinachSoup = () => (
  <RestaurantPage
    restaurantName="Spinach Soup"
    address="Geylang Bahru Market & Food Centre, #01-12, 69 Geylang Bahru, 330069, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/spinach-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the place to come for a comforting bowl of soup. The broth is flavourful and sweet; the spinach is crisp and fresh. You can also order stuffed tofu or seafood on top, or add mee tai mak for some starchiness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geylang%20Bahru%20Market%20%26%20Food%20Centre%2C%20%2301-12%2C%2069%20Geylang%20Bahru%2C%20330069%2C%20Singapore"
    pageTitle="Spinach Soup"
  />
);

export default SpinachSoup;
