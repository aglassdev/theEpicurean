...
const LorMee178 = () => (
  <RestaurantPage
    restaurantName="Lor Mee 178"
    address="Tiong Bahru Market, #02-23, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lor-mee-178"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rich, robust stock that clings to the egg noodles is the secret behind their tasty lor mee. Deep-fried fish nuggets, pork, and bean sprouts also make every bite satisfying. Grated garlic and cilantro add a zesty boost...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-23%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Lor Mee 178"
  />
);

export default LorMee178;
