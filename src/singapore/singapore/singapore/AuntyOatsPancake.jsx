...
const AuntyOatsPancake = () => (
  <RestaurantPage
    restaurantName="Aunty Oats Pancake"
    address="51 Old Airport Road Food Centre, #01-110, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/aunty-oats-pancake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fluffy and spongy pancakes are made to order with a wheat flour batter and no eggs. Vegan fillings include shredded coconut, red bean paste, and peanuts. Lacto vegetarians may go for cheese or chocolate filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-110%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="Aunty Oats Pancake"
  />
);

export default AuntyOatsPancake;
