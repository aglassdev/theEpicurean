...
const BeachRoadFishHeadBeeHoon = () => (
  <RestaurantPage
    restaurantName="Beach Road Fish Head Bee Hoon"
    address="Whampoa Makan Place, #01-46, 90/91 Whampoa Drive 91, 320091, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/beach-road-fish-head-bee-hoon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sliced fish bee hoon (rice vermicelli) comes in a flavourful, milky fish stock, with fried garlic bits for extra fragrance and crunch. Also worth trying are the tom yam soup, seafood soup and fried fish head bee hoon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Whampoa%20Makan%20Place%2C%20%2301-46%2C%2090%2F91%20Whampoa%20Drive%2091%2C%20320091%2C%20Singapore"
    pageTitle="Beach Road Fish Head Bee Hoon"
  />
);

export default BeachRoadFishHeadBeeHoon;
