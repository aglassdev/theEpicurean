...
const JinHua = () => (
  <RestaurantPage
    restaurantName="Jin Hua"
    address="51 Old Airport Road Food Centre, #01-120, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jin-hua"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here for flavourful made-to-order grouper broth with milk added for extra creaminess. Try the soup on its own or with bee hoon, sliced fish, fried fish meat and fried fish head. The spicy bean sauce and deep-fried shallot work magic with the broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-120%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="Jin Hua"
  />
);

export default JinHua;
