...
const KweeHeng = () => (
  <RestaurantPage
    restaurantName="Kwee Heng"
    address="Newton Food Centre, #01-13, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kwee-heng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With over 40 years of history, Kwee Heng makes boneless braised duck that is tender, juicy and flavoursome; it can be served with rice, congee or noodles. Other dishes such as Hainanese chicken and char siew are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-13%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="Kwee Heng"
  />
);

export default KweeHeng;
