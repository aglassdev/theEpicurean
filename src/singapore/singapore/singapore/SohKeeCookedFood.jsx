...
const SohKeeCookedFood = () => (
  <RestaurantPage
    restaurantName="Soh Kee Cooked Food"
    address="Jurong West 505 Market & Food Centre, #01-44, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/soh-kee-cooked-food"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Serves porridge with chicken, fish or cuttlefish. Sets for one to three people are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-44%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Soh Kee Cooked Food"
  />
);

export default SohKeeCookedFood;
