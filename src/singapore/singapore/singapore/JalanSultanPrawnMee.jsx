...
const JalanSultanPrawnMee = () => (
  <RestaurantPage
    restaurantName="Jalan Sultan Prawn Mee"
    address="2 Jalan Ayer, Lorong 1 Geylang, 389141, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jalan-sultan-prawn-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In operation for over 70 years, this place serves aromatic dry prawn mee in sambal with heaps of fried scallion and depth. The soup version has a prawn broth loaded with natural umami. Choose from three kinds of noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Jalan%20Ayer%2C%20Lorong%201%20Geylang%2C%20389141%2C%20Singapore"
    pageTitle="Jalan Sultan Prawn Mee"
  />
);

export default JalanSultanPrawnMee;
