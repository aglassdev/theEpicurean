...
const TienLaiRiceStall = () => (
  <RestaurantPage
    restaurantName="Tien Lai Rice Stall"
    address="Taman Jurong Market & Food Centre, #02-66, 3 Yung Sheng Road, Jurong West, 618499, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tien-lai-rice-stall"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open mornings only, this stall is famous for its Cantonese barbecue that tends to sell out quickly - so come early! Roast duck boasts velvety meat without being too fatty and the roast pork strikes a fine balance between lean and fatty meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Taman%20Jurong%20Market%20%26%20Food%20Centre%2C%20%2302-66%2C%203%20Yung%20Sheng%20Road%2C%20Jurong%20West%2C%20618499%2C%20Singapore"
    pageTitle="Tien Lai Rice Stall"
  />
);

export default TienLaiRiceStall;
