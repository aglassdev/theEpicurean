...
const TambuahMasOrchard = () => (
  <RestaurantPage
    restaurantName="Tambuah Mas (Orchard)"
    address="Paragon, #B1-44, 290 Orchard Road, 238859, Singapore"
    cuisine="Indonesian"
    priceRange="$$"
    phoneNumber="+6567332220"
    website="https://www.tambuahmas.com.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1981, the Indonesian chefs at Tambuah Mas have been making authentic home-style dishes from Padang, Sulawesi and Java. Family recipes with delicate blends of spices and precise preparations are closely guarded secrets, passed down over generations. The signature tahu telor (deep-fried egg-coated tofu cubes in a dark sweet sauce) boasts crispy skin and perfect briny-sweetness. Always round off a meal here with a cendol...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paragon%2C%20%23B1-44%2C%20290%20Orchard%20Road%2C%20238859%2C%20Singapore"
    pageTitle="Tambuah Mas (Orchard)"
  />
);

export default TambuahMasOrchard;
