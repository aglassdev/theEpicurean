...
const KangsWantonNoodle = () => (
  <RestaurantPage
    restaurantName="Kang's Wanton Noodle"
    address="Zion Riverside Food Centre, #06, 70 Zion Road, 247792, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kang-s-wanton-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alongside wanton or dumpling noodle soup, this stall serves deep-fried wanton and char siew. The springy noodles are best enjoyed with a dollop of chilli sauce, while the wantons encase a tasty filling in their paper-thin skin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zion%20Riverside%20Food%20Centre%2C%20%2306%2C%2070%20Zion%20Road%2C%20247792%2C%20Singapore"
    pageTitle="Kang's Wanton Noodle"
  />
);

export default KangsWantonNoodle;
