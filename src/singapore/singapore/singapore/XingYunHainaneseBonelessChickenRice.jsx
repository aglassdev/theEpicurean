...
const XingYunHainaneseBonelessChickenRice = () => (
  <RestaurantPage
    restaurantName="Xing Yun Hainanese Boneless Chicken Rice"
    address="Yuhua Market & Hawker Centre, #01-202, Blk 347, Jurong East Avenue 1, Jurong East, 600347, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/xing-yun-hainanese-boneless-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its signature Hainanese boneless chicken rice is garnished with pineapple, tomato and cucumber. Dip the juicy, silky chicken in the briny-sweet chilli and ginger sauce before savouring it with the aromatic rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Market%20%26%20Hawker%20Centre%2C%20%2301-202%2C%20Blk%20347%2C%20Jurong%20East%20Avenue%201%2C%20Jurong%20East%2C%20600347%2C%20Singapore"
    pageTitle="Xing Yun Hainanese Boneless Chicken Rice"
  />
);

export default XingYunHainaneseBonelessChickenRice;
