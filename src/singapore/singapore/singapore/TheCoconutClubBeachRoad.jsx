...
const TheCoconutClubBeachRoad = () => (
  <RestaurantPage
    restaurantName="The Coconut Club (Beach Road)"
    address="269 Beach Road, 199546, Singapore"
    cuisine="Malaysian"
    priceRange="$$"
    phoneNumber="+6587253315"
    website="https://www.thecoconutclub.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This whitewashed traditional shophouse evokes unmistakably tropical vibes – wicker back chairs, wallpaper with banana leaf prints and cheerful blue-and-white tiled flooring. On the menu, the coconut theme is also obvious – the nasi lemak set is the best seller, but other dishes deserve equal attention too, such as ayam goreng berempah (spiced fried chicken with crispy rempah crumbs), and sago pudding with pandan, palm sugar and coconut cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=269%20Beach%20Road%2C%20199546%2C%20Singapore"
    pageTitle="The Coconut Club (Beach Road)"
  />
);

export default TheCoconutClubBeachRoad;
