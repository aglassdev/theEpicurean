...
const PohCheuKptCoffeeShop = () => (
  <RestaurantPage
    restaurantName="Poh Cheu (KPT Coffee Shop)"
    address="Blk 127, KPT Coffee Shop, #01-230, Bukit Merah Lane 1, 150127, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6562762287"
    website="https://www.pohcheukitchen.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ideal for fresh kueh, made from scratch daily. Colourful ang ku kueh comes in 10+ different sweet fillings and the black sesame variety stands out. Savoury kueh with bamboo shoot, yam, or chive filling are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%20127%2C%20KPT%20Coffee%20Shop%2C%20%2301-230%2C%20Bukit%20Merah%20Lane%201%2C%20150127%2C%20Singapore"
    pageTitle="Poh Cheu (KPT Coffee Shop)"
  />
);

export default PohCheuKptCoffeeShop;
