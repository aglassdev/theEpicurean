...
const KiSu = () => (
  <RestaurantPage
    restaurantName="Ki Su"
    address="#01-01, 60 Tras Street, 078999, Singapore"
    cuisine="Vegetarian"
    priceRange="$$"
    phoneNumber="+6585226824"
    website="https://www.kisu.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a minimalistic room, the Taiwanese owner-chef serves an omakase menu of creative vegetarian courses in which Japanese and French culinary traditions converge. Modern cooking techniques like sous vide are used to imbue plant-based ingredients with meaty flavours and textures. Smoked capsicum and pumpkin purée are made to look like akami and uni in their nigiri sushi. The menu changes regularly to keep it fresh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%2301-01%2C%2060%20Tras%20Street%2C%20078999%2C%20Singapore"
    pageTitle="Ki Su"
  />
);
