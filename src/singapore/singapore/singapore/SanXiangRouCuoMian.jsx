...
const SanXiangRouCuoMian = () => (
  <RestaurantPage
    restaurantName="San Xiang Rou Cuo Mian"
    address="ABC Brickworks Market & Food Centre, #01-132, Blk 6 Jalan Bukit Merah, 150006, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6596989907"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/san-xiang-rou-cuo-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its bak chor mee can be made with your choice of noodles – mee pok being the most popular. Bouncy noodles are dressed in sambal and topped with sliced pork and meatballs. Also try the noodle soup with fish balls or pork liver...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ABC%20Brickworks%20Market%20%26%20Food%20Centre%2C%20%2301-132%2C%20Blk%206%20Jalan%20Bukit%20Merah%2C%20150006%2C%20Singapore"
    pageTitle="San Xiang Rou Cuo Mian"
  />
);

export default SanXiangRouCuoMian;
