...
const HupHongChickenRice = () => (
  <RestaurantPage
    restaurantName="Hup Hong Chicken Rice"
    address="Yuhua Village Market and Food Centre, #01-51, Blk 254, Jurong East Street 24, 600254, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hup-hong-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The queue to get your roasted or boiled chicken rice may be long, but the wait is worthwhile for the silky-fleshed meat and the heady aromas of rice cooked in chicken stock and fat. Enjoy with char siew or roast pork...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Village%20Market%20and%20Food%20Centre%2C%20%2301-51%2C%20Blk%20254%2C%20Jurong%20East%20Street%2024%2C%20600254%2C%20Singapore"
    pageTitle="Hup Hong Chicken Rice"
  />
);

export default HupHongChickenRice;
