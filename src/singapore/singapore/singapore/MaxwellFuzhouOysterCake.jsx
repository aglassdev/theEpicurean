...
const MaxwellFuzhouOysterCake = () => (
  <RestaurantPage
    restaurantName="Maxwell Fuzhou Oyster Cake"
    address="Maxwell Food Centre, #01-05, 1 Kadayanallur Street, 069184, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/maxwell-fuzhou-oyster-cake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The second-generation owner still fries oyster cakes à la minute as her mother did in the 1960s. They may be darker than usual, but the minced pork, oysters, prawns and coriander are still soft and juicy under the crispy crust...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maxwell%20Food%20Centre%2C%20%2301-05%2C%201%20Kadayanallur%20Street%2C%20069184%2C%20Singapore"
    pageTitle="Maxwell Fuzhou Oyster Cake"
  />
);

export default MaxwellFuzhouOysterCake;
