...
const ZaiShunCurryFishHead = () => (
  <RestaurantPage
    restaurantName="Zai Shun Curry Fish Head"
    address="#01-205, 253 Jurong East Steet 24, 600253, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/zai-shun-curry-fish-head"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fish head curry boasts velvety flesh loaded with umami and is hot and spicy, perfect with steamed rice. Besides its eponymous dish, other equally stunning fish dishes and stir-fries are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%2301-205%2C%20253%20Jurong%20East%20Steet%2024%2C%20600253%2C%20Singapore"
    pageTitle="Zai Shun Curry Fish Head"
  />
);

export default ZaiShunCurryFishHead;
