...
const HokkienManHokkienMee = () => (
  <RestaurantPage
    restaurantName="Hokkien Man Hokkien Mee"
    address="Blk 19, Toa Payoh 7, #01-264, Kim Keat Palm, 310019, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hokkien-man-hokkien-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As its name suggests, this stall specialises in Hokkien fried noodles in a garlicky broth made with prawn heads. Besides the typical toppings of prawns and squid, you may order others, like egg or abalone, at an additional cost...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%2019%2C%20Toa%20Payoh%207%2C%20%2301-264%2C%20Kim%20Keat%20Palm%2C%20310019%2C%20Singapore"
    pageTitle="Hokkien Man Hokkien Mee"
  />
);

export default HokkienManHokkienMee;
