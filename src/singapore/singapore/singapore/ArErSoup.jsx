...
const ArErSoup = () => (
  <RestaurantPage
    restaurantName="Ar Er Soup"
    address="ABC Brickworks Market & Food Centre, #01-141, Blk 6 Jalan Bukit Merah, 150006, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ar-er-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Eight kinds of MSG-free slow-boiled soups, including the signature ginseng Silkie chicken soup that boasts a mild herbal taste are on the menu here. All are served with pumpkin rice or steamed rice. Come early to beat the crowds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ABC%20Brickworks%20Market%20%26%20Food%20Centre%2C%20%2301-141%2C%20Blk%206%20Jalan%20Bukit%20Merah%2C%20150006%2C%20Singapore"
    pageTitle="Ar Er Soup"
  />
);

export default ArErSoup;
