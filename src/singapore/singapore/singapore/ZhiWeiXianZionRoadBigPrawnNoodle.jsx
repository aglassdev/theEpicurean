...
const ZhiWeiXianZionRoadBigPrawnNoodle = () => (
  <RestaurantPage
    restaurantName="Zhi Wei Xian Zion Road Big Prawn Noodle"
    address="Zion Riverside Food Centre, #04, 70 Zion Road, 247792, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/fresh-taste-big-prawn-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The soup has a rich prawn flavour. Fresh prawns, chili and pork rinds combine to make a great bowl of noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zion%20Riverside%20Food%20Centre%2C%20%2304%2C%2070%20Zion%20Road%2C%20247792%2C%20Singapore"
    pageTitle="Zhi Wei Xian Zion Road Big Prawn Noodle"
  />
);

export default ZhiWeiXianZionRoadBigPrawnNoodle;
