...
const HockHaiHongLimCurryChickenNoodle = () => (
  <RestaurantPage
    restaurantName="Hock Hai (Hong Lim) Curry Chicken Noodle"
    address="Bedok Interchange Hawker Centre, #01-58, 208 New Upper Changi Road, 460208, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hock-hai-hong-lim-curry-chicken-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The curry broth may be only mildly hot, but its flavours are deep. The chicken is tender; potato and tofu puffs soak up the sauces. Besides curry, there is satay chicken served on your choice from three varieties of noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bedok%20Interchange%20Hawker%20Centre%2C%20%2301-58%2C%20208%20New%20Upper%20Changi%20Road%2C%20460208%2C%20Singapore"
    pageTitle="Hock Hai (Hong Lim) Curry Chicken Noodle"
  />
);

export default HockHaiHongLimCurryChickenNoodle;
