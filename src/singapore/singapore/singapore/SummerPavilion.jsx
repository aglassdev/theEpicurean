...
const SummerPavilion = () => (
  <RestaurantPage
    restaurantName="Summer Pavilion"
    address="The Ritz-Carlton, Millenia, Level 3, 7 Raffles Avenue, 039799, Singapore"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+6564345286"
    website="https://www.summerpavilion.com.sg"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This large, contemporary dining room is surrounded by a relaxing garden. You’ll be well looked after as the engaging staff provide service with plenty of vim and vigour. The extensive Cantonese menu covers all classics as well as seasonal dishes, with seafood being a particular highlight. The double-boiled sea whelk soup with fish maw, sauteed Dong Xing grouper fillet and braised abalone are just some of the specialities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Ritz-Carlton%2C%20Millenia%2C%20Level%203%2C%207%20Raffles%20Avenue%2C%20039799%2C%20Singapore"
    pageTitle="Summer Pavilion"
  />
);

export default SummerPavilion;
