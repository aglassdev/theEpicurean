...
const NewWorldMuttonSoup = () => (
  <RestaurantPage
    restaurantName="New World Mutton Soup"
    address="Bedok Interchange Hawker Centre, #01-23, 208 New Upper Changi Road, 460208, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/new-world-mutton-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The speciality here – mutton soup – is briny-sweet with plenty of umami, and finely shredded ginger to add zing. Other lamb specialities such as rib soup, kway teow, meatballs, lamb tendon and offal are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bedok%20Interchange%20Hawker%20Centre%2C%20%2301-23%2C%20208%20New%20Upper%20Changi%20Road%2C%20460208%2C%20Singapore"
    pageTitle="New World Mutton Soup"
  />
);

export default NewWorldMuttonSoup;
