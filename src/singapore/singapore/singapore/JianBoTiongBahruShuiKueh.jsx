...
const JianBoTiongBahruShuiKueh = () => (
  <RestaurantPage
    restaurantName="Jian Bo Tiong Bahru Shui Kueh"
    address="Jurong West 505 Market & Food Centre, #01-27, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6598219880"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jian-bo-tiong-bahru-shui-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rice cake with a sauce of preserved vegetables, sesame, dried shrimp and chilli is spicy and delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-27%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Jian Bo Tiong Bahru Shui Kueh"
  />
);

export default JianBoTiongBahruShuiKueh;
