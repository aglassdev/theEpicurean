...
const BedokChweeKueh = () => (
  <RestaurantPage
    restaurantName="Bedok Chwee Kueh"
    address="Bedok Interchange Hawker Centre, #01-19, 208 New Upper Changi Road, 460208, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/bedok-chwee-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The freshly steamed chwee kueh rice cakes are soft and velvety and the sauce on top made with preserved radish, scallion, dried shrimps and chilli is simply irresistible. May be closed without prior notice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bedok%20Interchange%20Hawker%20Centre%2C%20%2301-19%2C%20208%20New%20Upper%20Changi%20Road%2C%20460208%2C%20Singapore"
    pageTitle="Bedok Chwee Kueh"
  />
);

export default BedokChweeKueh;
