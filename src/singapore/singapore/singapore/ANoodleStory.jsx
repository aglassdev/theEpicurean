...
const ANoodleStory = () => (
  <RestaurantPage
    restaurantName="A Noodle Story"
    address="Amoy Street Food Centre, #01-39, 7 Maxwell Road, 069111, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/a-noodle-story"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stall has an interesting look and sells local, traditional noodles cooked in an innovative way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amoy%20Street%20Food%20Centre%2C%20%2301-39%2C%207%20Maxwell%20Road%2C%20069111%2C%20Singapore"
    pageTitle="A Noodle Story"
  />
);

export default ANoodleStory;
