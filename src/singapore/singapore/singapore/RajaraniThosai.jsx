...
const RajaraniThosai = () => (
  <RestaurantPage
    restaurantName="Rajarani Thosai"
    address="Tampines Round Market & Food Centre, #01-33, 137 Tampines Street 11, 521137, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/rajarani-thosai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mother-and-son team serves thosai and appam made from scratch. Their thosai comes in nearly 20 different fillings such as crispy cereal, or cheese, egg and butter – everything tastes better with the sambar and chutney dips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tampines%20Round%20Market%20%26%20Food%20Centre%2C%20%2301-33%2C%20137%20Tampines%20Street%2011%2C%20521137%2C%20Singapore"
    pageTitle="Rajarani Thosai"
  />
);

export default RajaraniThosai;
