...
const BoonTongKeeKwayChapbraisedDuck = () => (
  <RestaurantPage
    restaurantName="Boon Tong Kee Kway Chap‧Braised Duck"
    address="Zion Riverside Food Centre, #024, 70 Zion Road, 247792, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/boon-tong-kee-kway-chap%E2%80%A7braised-duck"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boon Tong Kee prides itself on its spiced soy marinade made with aromatic Chinese herbs. With its springy skin and tasty meat, the signature braised duck is a hit. The braised pork trotter and taro rice are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zion%20Riverside%20Food%20Centre%2C%20%23024%2C%2070%20Zion%20Road%2C%20247792%2C%20Singapore"
    pageTitle="Boon Tong Kee Kway Chap‧Braised Duck"
  />
);

export default BoonTongKeeKwayChapbraisedDuck;
