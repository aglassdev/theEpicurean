...
const IchigoIchie = () => (
  <RestaurantPage
    restaurantName="Ichigo Ichie"
    address="Claymore Connect, #01-16/17, 442 Orchard Road, 238879, Singapore"
    cuisine="Japanese"
    priceRange="$$$"
    phoneNumber="+6590182897"
    website="https://ichigoichie.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After working in a kappo restaurant in Tokyo and helming a famous sushiya in Singapore, Chef Eno has brought to life her own fine-dining concept. At this address since 2024, she serves two set menus that change with the seasons. Her signature somen with kuruma ebi and uni bursts with seafood umami – the briny and sweet prawn broth clings nicely to the silky noodles. Reservations recommended, especially for the sought-after counter seats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Claymore%20Connect%2C%20%2301-16%2F17%2C%20442%20Orchard%20Road%2C%20238879%2C%20Singapore"
    pageTitle="Ichigo Ichie"
  />
);

export default IchigoIchie;
