...
const HokkienStreetBakKutTeh = () => (
  <RestaurantPage
    restaurantName="Hokkien Street Bak Kut Teh"
    address="Hong Lim Market and Food Centre, #01-66, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hokkien-street-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dark amber coloured bak kut teh from this stall is loaded in herbal goodness. Pair with pork knuckle, pork intestines, steamed fish, pork tail, pork kidney or pork liver on the side, as you prefer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2301-66%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Hokkien Street Bak Kut Teh"
  />
);

export default HokkienStreetBakKutTeh;
