...
const FengZhenLorMee = () => (
  <RestaurantPage
    restaurantName="Feng Zhen Lor Mee"
    address="Taman Jurong Market & Food Centre, #03-146, 3 Yung Sheng Road, Jurong West, 618499, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/feng-zhen-lor-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular stall offers lor mee with generous toppings like meatballs and fish flakes. The noodles are springy and the broth is tasty and flavoursome. Also, try their deep-fried prawn rolls with a crispy skin and juicy filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Taman%20Jurong%20Market%20%26%20Food%20Centre%2C%20%2303-146%2C%203%20Yung%20Sheng%20Road%2C%20Jurong%20West%2C%20618499%2C%20Singapore"
    pageTitle="Feng Zhen Lor Mee"
  />
);

export default FengZhenLorMee;
