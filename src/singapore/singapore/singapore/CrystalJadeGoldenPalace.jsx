...
const CrystalJadeGoldenPalace = () => (
  <RestaurantPage
    restaurantName="Crystal Jade Golden Palace"
    address="The Paragon, #05-22, 290 Orchard Road, 238859, Singapore"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+6591772091"
    website="https://www.crystaljade.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 2002, this is the most comfortable branch of this restaurant group and the only one which specialises in Teochew dishes, like cold crab and sugar-coated yam. Look out too for the Cantonese barbecue meat and assorted seafood dishes; more contemporary offerings include chilled foie gras with sake and roasted suckling pig with black truffle. Their wine cellar includes a good international selection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Paragon%2C%20%2305-22%2C%20290%20Orchard%20Road%2C%20238859%2C%20Singapore"
    pageTitle="Crystal Jade Golden Palace"
  />
);

export default CrystalJadeGoldenPalace;
