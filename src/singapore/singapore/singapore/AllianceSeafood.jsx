...
const AllianceSeafood = () => (
  <RestaurantPage
    restaurantName="Alliance Seafood"
    address="Newton Food Centre, #01-27, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/alliance-seafood"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here for cooked-to-order seafood at a range of prices. Barbecue is hugely popular, but you can also opt for sambal, black pepper sauce or salted egg yolk. Don’t miss the cereal butter prawns...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-27%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="Alliance Seafood"
  />
);

export default AllianceSeafood;
