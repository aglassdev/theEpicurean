...
const HuaXingBakKutTeh = () => (
  <RestaurantPage
    restaurantName="Hua Xing Bak Kut Teh"
    address="Yuhua Market & Hawker Centre, #01-171, Blk 347, Jurong East Avenue 1, Jurong East, 600347, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hua-xing-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bak kut teh with a strong, peppery flavour and aromatic pork ribs. Add rice, pork organs, pork trotter, or vegetable soup for a complete meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Market%20%26%20Hawker%20Centre%2C%20%2301-171%2C%20Blk%20347%2C%20Jurong%20East%20Avenue%201%2C%20Jurong%20East%2C%20600347%2C%20Singapore"
    pageTitle="Hua Xing Bak Kut Teh"
  />
);

export default HuaXingBakKutTeh;
