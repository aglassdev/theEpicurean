...
const RbExpress = () => (
  <RestaurantPage
    restaurantName="R&B Express"
    address="Newton Food Centre, #01-76, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/r-b-express"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chicken wings grilled with charcoal are crispy and juicy while the spicy sauce adds to the flavour. Also try satay, traditional popiah and kueh pie tee...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-76%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="R&B Express"
  />
);

export default RbExpress;
