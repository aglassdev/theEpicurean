...
const JaanByKirkWestaway = () => (
  <RestaurantPage
    restaurantName="Jaan by Kirk Westaway"
    address="Swissôtel The Stamford, Equinox Complex, Level 70, 2 Stamford Road, 178882, Singapore"
    cuisine="British Contemporary"
    priceRange="$$$"
    phoneNumber="+6591999008"
    website="https://www.jaan.sg"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Embodying the essence of fine dining, this romantic restaurant has it all – wonderful food, service and ambiance, and spectacular views. Chef Westaway makes good use of top-notch British produce and inspirations to turn out modern culinary creations that never fail to impress. A British classic, fish & chips, gets a posh makeover with sour cream, lemon zest and caviar. Even the alcohol-free gin and tonic palate cleanser is impeccably crafted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Swiss%C3%B4tel%20The%20Stamford%2C%20Equinox%20Complex%2C%20Level%2070%2C%202%20Stamford%20Road%2C%20178882%2C%20Singapore"
    pageTitle="Jaan by Kirk Westaway"
  />
);

export default JaanByKirkWestaway;
