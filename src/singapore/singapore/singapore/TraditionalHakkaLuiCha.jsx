...
const TraditionalHakkaLuiCha = () => (
  <RestaurantPage
    restaurantName="Traditional Hakka Lui Cha"
    address="Jurong West 505 Market & Food Centre, #01-12, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/traditional-hakka-lui-cha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hakkanese Lui Cha is a soupy rice dish in which chicken, cabbage and pickles meet the nuttiness of sesame and peanuts plus a hint of herbs. Order the fish cake, stuffed tofu or fried egg toppings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-12%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Traditional Hakka Lui Cha"
  />
);

export default TraditionalHakkaLuiCha;
