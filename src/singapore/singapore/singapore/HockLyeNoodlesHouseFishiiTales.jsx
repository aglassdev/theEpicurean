...
const HockLyeNoodlesHouseFishiiTales = () => (
  <RestaurantPage
    restaurantName="Hock Lye Noodles House & Fishii Tales"
    address="20 Ghim Moh Road Market & Food Centre, #01-35, Blk 20, Ghim Moh Road, 270020, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hock-lye-noodles-house-fishii-tales"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popular dishes include Hock Lye's noodle soup and dry noodles with meatballs, fish balls, prawns or pork ribs. The hand-made fish balls and fish cakes are springy and flavoursome. Come early, as the meatballs tend to sell out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Ghim%20Moh%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-35%2C%20Blk%2020%2C%20Ghim%20Moh%20Road%2C%20270020%2C%20Singapore"
    pageTitle="Hock Lye Noodles House & Fishii Tales"
  />
);

export default HockLyeNoodlesHouseFishiiTales;
