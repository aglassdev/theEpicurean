...
const JiDeLaiHainaneseChickenRice = () => (
  <RestaurantPage
    restaurantName="Ji De Lai Hainanese Chicken Rice"
    address="Chong Pang Market and Food Centre, #01-152, 105 Yishun Ring Road, 760105, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6597988788"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ji-de-lai-hainanese-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hainanese chicken rice comes with options like roasted or steamed chicken. Sets with rice, soup and vegetables are reasonably priced...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chong%20Pang%20Market%20and%20Food%20Centre%2C%20%2301-152%2C%20105%20Yishun%20Ring%20Road%2C%20760105%2C%20Singapore"
    pageTitle="Ji De Lai Hainanese Chicken Rice"
  />
);

export default JiDeLaiHainaneseChickenRice;
