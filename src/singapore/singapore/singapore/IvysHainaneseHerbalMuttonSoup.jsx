...
const IvysHainaneseHerbalMuttonSoup = () => (
  <RestaurantPage
    restaurantName="Ivy's Hainanese Herbal Mutton Soup"
    address="Pasir Panjang Food Centre, #14, 121 Pasir Panjang Road, 118543, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ivy-s-hainanese-herbal-mutton-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Herbal mutton soup, herbal tendon soup and herbal tulang soup are delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pasir%20Panjang%20Food%20Centre%2C%20%2314%2C%20121%20Pasir%20Panjang%20Road%2C%20118543%2C%20Singapore"
    pageTitle="Ivy's Hainanese Herbal Mutton Soup"
  />
);

export default IvysHainaneseHerbalMuttonSoup;
