...
const YummySarawakKoloMee = () => (
  <RestaurantPage
    restaurantName="Yummy Sarawak Kolo Mee"
    address="Tampines Round Market & Food Centre, #01-45, 137 Tampines Street 11, 521137, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/yummy-sarawak-kolo-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The signature kolo mee set menu is a tour de force starring everything the stall has to offer – braised spareribs, wontons, char siew and curly, bouncy kolo noodles dressed in lard and shallot oil. Ipoh hor fun is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tampines%20Round%20Market%20%26%20Food%20Centre%2C%20%2301-45%2C%20137%20Tampines%20Street%2011%2C%20521137%2C%20Singapore"
    pageTitle="Yummy Sarawak Kolo Mee"
  />
);

export default YummySarawakKoloMee;
