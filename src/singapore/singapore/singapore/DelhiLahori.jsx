...
const DelhiLahori = () => (
  <RestaurantPage
    restaurantName="Delhi Lahori"
    address="Tekka Centre, #01-266, 665 Buffalo Road, 210665, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/delhi-lahori"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The experienced tandoor master knows his clay oven inside out. His fluffy, crispy naans have a loyal following. His grilled-to-order seekh kebab and chicken tikka masala are also exceptional and come in generous portions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tekka%20Centre%2C%20%2301-266%2C%20665%20Buffalo%20Road%2C%20210665%2C%20Singapore"
    pageTitle="Delhi Lahori"
  />
);

export default DelhiLahori;
