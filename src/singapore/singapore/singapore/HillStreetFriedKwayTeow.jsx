...
const HillStreetFriedKwayTeow = () => (
  <RestaurantPage
    restaurantName="Hill Street Fried Kway Teow"
    address="Pasar 16@Bedok (Bedok South Food Centre), #01-41, 16 Bedok South Road, 460016, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hill-street-fried-kway-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall serves a single dish that is drop-dead perfect every time. Full-bodied wok hei, irresistible aromas and generous toppings like cockles, Chinese sausage, chives and bean sprouts justify the often hour-long wait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pasar%2016%40Bedok%20(Bedok%20South%20Food%20Centre)%2C%20%2301-41%2C%2016%20Bedok%20South%20Road%2C%20460016%2C%20Singapore"
    pageTitle="Hill Street Fried Kway Teow"
  />
);

export default HillStreetFriedKwayTeow;
