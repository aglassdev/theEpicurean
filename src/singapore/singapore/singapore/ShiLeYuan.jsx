...
const ShiLeYuan = () => (
  <RestaurantPage
    restaurantName="Shi Le Yuan"
    address="Redhill Market, #01-82, 85 Redhill Lane, 150085, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/shi-le-yuan-570556"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The braised meat platter includes pork belly, hard-boiled eggs, pork intestine, pork skin and tofu puffs – all deeply flavoured and tasty. Kway chap, or silky broad rice noodles in a soy-based soup, is served separately...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Redhill%20Market%2C%20%2301-82%2C%2085%20Redhill%20Lane%2C%20150085%2C%20Singapore"
    pageTitle="Shi Le Yuan"
  />
);

export default ShiLeYuan;
