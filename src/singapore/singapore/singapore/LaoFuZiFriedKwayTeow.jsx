...
const LaoFuZiFriedKwayTeow = () => (
  <RestaurantPage
    restaurantName="Lao Fu Zi Fried Kway Teow"
    address="51 Old Airport Road Food Centre, #01-12, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lao-fu-zi-fried-kway-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fried kway teow comes in two portion sizes and black and white varieties. Both feature good wok hei and silky texture. Bean sprouts, egg, preserved sausage and blood clams provide extra flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-12%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="Lao Fu Zi Fried Kway Teow"
  />
);

export default LaoFuZiFriedKwayTeow;
