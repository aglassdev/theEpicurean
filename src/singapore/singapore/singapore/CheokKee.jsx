...
const CheokKee = () => (
  <RestaurantPage
    restaurantName="Cheok Kee"
    address="Geylang Bahru Market & Food Centre, #01-35, 69 Geylang Bahru, 330069, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/cheok-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its famous soy-marinated duck boasts velvety flesh on a bed of steamed rice perfumed by duck scents. It comes with chilli vinegar that aptly cuts through the richness, plus an aromatic duck soup made with Chinese herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geylang%20Bahru%20Market%20%26%20Food%20Centre%2C%20%2301-35%2C%2069%20Geylang%20Bahru%2C%20330069%2C%20Singapore"
    pageTitle="Cheok Kee"
  />
);

export default CheokKee;
