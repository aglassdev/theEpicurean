...
const GuanKeeFriedCarrotCake = () => (
  <RestaurantPage
    restaurantName="Guan Kee Fried Carrot Cake"
    address="Albert Centre, #01-59, 270 Queen Street, 180270, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6562453989"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/guan-kee-fried-carrot-cake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kind of a misnomer, fried carrot cake is made with radish and not a dessert. It comes in two varieties – black and white. The black one has a caramel-like sweetness while the white one is eggy and salty. Order a mix of both...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Albert%20Centre%2C%20%2301-59%2C%20270%20Queen%20Street%2C%20180270%2C%20Singapore"
    pageTitle="Guan Kee Fried Carrot Cake"
  />
);

export default GuanKeeFriedCarrotCake;
