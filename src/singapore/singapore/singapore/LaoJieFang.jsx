...
const LaoJieFang = () => (
  <RestaurantPage
    restaurantName="Lao Jie Fang"
    address="Mei Ling Market & Food Centre, #02-15, 159 Mei Chin Road, 140159, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lao-jie-fang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cantonese-style noodles topped with beef brisket, pork ribs, pork knuckles or beef tendon are the name of the game here. The noodles are springy, and the pork knuckles are braised until gelatinous in a secret soy sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mei%20Ling%20Market%20%26%20Food%20Centre%2C%20%2302-15%2C%20159%20Mei%20Chin%20Road%2C%20140159%2C%20Singapore"
    pageTitle="Lao Jie Fang"
  />
);

export default LaoJieFang;
