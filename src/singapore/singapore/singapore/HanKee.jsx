...
const HanKee = () => (
  <RestaurantPage
    restaurantName="Han Kee"
    address="Amoy Street Food Centre, #02-129, 7 Maxwell Road, 069111, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/han-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is always a queue at this stall famous for umami-laden soup made with mackerel. Enjoy the soup on its own, or use it as a rich base for porridge or bee hoon with sliced fish or fish head. Come early to beat the crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amoy%20Street%20Food%20Centre%2C%20%2302-129%2C%207%20Maxwell%20Road%2C%20069111%2C%20Singapore"
    pageTitle="Han Kee"
  />
);

export default HanKee;
