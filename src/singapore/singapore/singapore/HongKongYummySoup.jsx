...
const HongKongYummySoup = () => (
  <RestaurantPage
    restaurantName="Hong Kong Yummy Soup"
    address="Alexandra Village Food Centre, #01-51, Blk 120 Bukit Merah Lane 1, 150120, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hong-kong-yummy-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, the second generation of the family sells local-style salad with pineapple, cucumber and deep-fried dough stick, tossed in a special home-made sauce and sprinkled with ground peanuts. Chilli is optional...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alexandra%20Village%20Food%20Centre%2C%20%2301-51%2C%20Blk%20120%20Bukit%20Merah%20Lane%201%2C%20150120%2C%20Singapore"
    pageTitle="Hong Kong Yummy Soup"
  />
);

export default HongKongYummySoup;
