...
const YongChunWanTonNoodle = () => (
  <RestaurantPage
    restaurantName="Yong Chun Wan Ton Noodle"
    address="115 Bukit Merah View Market & Hawker Centre, #01-56, Blk 115 Bukit Merah View, 151115, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/yong-chun-wan-ton-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner has his springy eggy noodles tailor-made. They are best enjoyed in its “dry” form – blanched and dressed in a savoury sweet sauce. Wonton with minced pork is fresh and firm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Bukit%20Merah%20View%20Market%20%26%20Hawker%20Centre%2C%20%2301-56%2C%20Blk%20115%20Bukit%20Merah%20View%2C%20151115%2C%20Singapore"
    pageTitle="Yong Chun Wan Ton Noodle"
  />
);

export default YongChunWanTonNoodle;
