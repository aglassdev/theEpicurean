...
const JasonPenangCuisine = () => (
  <RestaurantPage
    restaurantName="Jason Penang Cuisine"
    address="ABC Brickworks Market & Food Centre, #01-112, Blk 6 Jalan Bukit Merah, 150006, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jason-penang-cuisine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Besides Penangese quick bites from char kway teow to prawn mee, this stall is famous for Penang assam laksa – the tangy, mildly hot yellowtail fish broth works magic with the noodles; but it's the fresh mint that makes it so distinctive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ABC%20Brickworks%20Market%20%26%20Food%20Centre%2C%20%2301-112%2C%20Blk%206%20Jalan%20Bukit%20Merah%2C%20150006%2C%20Singapore"
    pageTitle="Jason Penang Cuisine"
  />
);

export default JasonPenangCuisine;
