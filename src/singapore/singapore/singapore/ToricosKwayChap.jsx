...
const ToricosKwayChap = () => (
  <RestaurantPage
    restaurantName="To-Ricos Kway Chap"
    address="51 Old Airport Road Food Centre, #01-135/136, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6593881098"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/to-ricos-guo-shi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This kway chap stall serves the broad rice noodles with pork belly, trotters, intestine, tripe and dried tofu braised in a spiced soy-based marinade. Noodles are thin and silky; braised pork and tofu impart deep flavours and aromas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-135%2F136%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="To-Ricos Kway Chap"
  />
);

export default ToricosKwayChap;
