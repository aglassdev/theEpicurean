...
const SoonHuat = () => (
  <RestaurantPage
    restaurantName="Soon Huat"
    address="North Bridge Road Market & Food Centre, #01-105, 861 North Bridge Road, 198783, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/soon-huat"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Choose between dry and soup noodles topped with butterflied prawns, fish cake, bean sprouts and fried garlic. The flavoursome prawn soup on the side is also a treat. Not a fan of prawns? Try the pork ribs noodles instead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=North%20Bridge%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-105%2C%20861%20North%20Bridge%20Road%2C%20198783%2C%20Singapore"
    pageTitle="Soon Huat"
  />
);

export default SoonHuat;
