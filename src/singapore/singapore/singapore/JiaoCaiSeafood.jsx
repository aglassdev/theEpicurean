...
const JiaoCaiSeafood = () => (
  <RestaurantPage
    restaurantName="Jiao Cai Seafood"
    address="Yishun Park Hawker Centre, #01-39, 51 Yishun Avenue 11, 768867, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jiao-cai-seafood"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cooked-to-order seafood dishes. Signature sambal stingray is spicy and delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yishun%20Park%20Hawker%20Centre%2C%20%2301-39%2C%2051%20Yishun%20Avenue%2011%2C%20768867%2C%20Singapore"
    pageTitle="Jiao Cai Seafood"
  />
);

export default JiaoCaiSeafood;
