...
const EminentFrogPorridgeSeafoodLor19 = () => (
  <RestaurantPage
    restaurantName="Eminent Frog Porridge & Seafood (Lor 19)"
    address="Geylang Lorong 19, 323 Geylang Road, 389359, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6598422941"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/eminent-frog-porridge-seafood-lor-19"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Frog is certainly big on the menu – besides the famous frog porridge, try frog fried with ginger and scallion or tossed in Kung Pao sauce. A favourite spot among locals for late-night supper, this place is always packed, so be prepared to wait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geylang%20Lorong%2019%2C%20323%20Geylang%20Road%2C%20389359%2C%20Singapore"
    pageTitle="Eminent Frog Porridge & Seafood (Lor 19)"
  />
);

export default EminentFrogPorridgeSeafoodLor19;
