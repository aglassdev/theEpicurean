...
const KohBrotherPigsOrganSoup = () => (
  <RestaurantPage
    restaurantName="Koh Brother Pig's Organ Soup"
    address="Tiong Bahru Market, #02-29, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/koh-brother-pig-s-organ-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pork offal like tripe and liver is served with meatballs and sliced pork in a peppery broth with pickled mustard greens. Dip the pork into chilli sauce for an extra kick. Also try the sticky rice sausage stuffed with pork belly and chestnuts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-29%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Koh Brother Pig's Organ Soup"
  />
);

export default KohBrotherPigsOrganSoup;
