...
const Hayop = () => (
  <RestaurantPage
    restaurantName="Hayop"
    address="104 Amoy Street, 069924, Singapore"
    cuisine="Filipino, Contemporary"
    priceRange="$$"
    phoneNumber="+6580289012"
    website="https://hayopnimanam.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hayop serves modern Filipino fare in a wood-rich space with a subtle maritime theme, a reference to the country's fishing industry. The signature dish is Wagyu and watermelon sinigang, a tangy broth with fall-off-the-bone braised beef short ribs – best enjoyed with steamed rice. Pre-order the roast suckling pig 48 hours ahead; known as lechon de leche, it is copious enough for a few to share. Try their Asian-inspired fruity cocktails, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=104%20Amoy%20Street%2C%20069924%2C%20Singapore"
    pageTitle="Hayop"
  />
);

export default Hayop;
