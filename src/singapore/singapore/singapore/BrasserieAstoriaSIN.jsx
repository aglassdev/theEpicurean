...
const BrasserieAstoriaSIN = () => (
  <RestaurantPage
    restaurantName="Brasserie Astoria"
    address="Victoria Concert Hall, #01-01, 11 Empress Place, 179558, Singapore"
    cuisine="European Contemporary"
    priceRange="$$"
    phoneNumber="+6596191567"
    website="https://www.brasserieastoria.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An outpost of its namesake in Stockholm, this is the brainchild of the Swedish owner-chef Björn Frantzén. Nestled in the historical Victoria Concert Hall (1800s), its retro glamour complements the chef's new spin on brasserie classics, some with trolley or tableside service. Try the råraka, a Swedish potato cake topped with vendace roe, crème fraîche, chives and red onion. Toast Astoria with prawn, king crab and wasabi aioli is also unmissable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Victoria%20Concert%20Hall%2C%20%2301-01%2C%2011%20Empress%20Place%2C%20179558%2C%20Singapore"
    pageTitle="Brasserie Astoria"
  />
);

export default BrasserieAstoriaSIN;
