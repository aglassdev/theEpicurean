...
const FattyOxHkKitchen = () => (
  <RestaurantPage
    restaurantName="Fatty Ox HK Kitchen"
    address="Chinatown Complex Market & Food Centre, #02-84, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/fatty-ox-hk-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Offers a wide array of noodles, including pork trotter and barbecue meats. The fresh yam noodles are handmade and available for take away only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-84%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="Fatty Ox HK Kitchen"
  />
);

export default FattyOxHkKitchen;
