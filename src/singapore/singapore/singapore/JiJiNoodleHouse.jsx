...
const JiJiNoodleHouse = () => (
  <RestaurantPage
    restaurantName="Ji Ji Noodle House"
    address="Hong Lim Market and Food Centre, #02-48/49, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ji-ji-noodle-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Order the Ji Ji noodle bowl – noodle soup or ‘dry’ noodles are topped with char siew, deep-fried wonton and veggies and served with wonton soup. Pork crackling adds a lovely crunch. A dab of homemade chilli sauce is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2302-48%2F49%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Ji Ji Noodle House"
  />
);

export default JiJiNoodleHouse;
