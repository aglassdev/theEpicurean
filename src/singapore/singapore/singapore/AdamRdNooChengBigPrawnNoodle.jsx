...
const AdamRdNooChengBigPrawnNoodle = () => (
  <RestaurantPage
    restaurantName="Adam Rd Noo Cheng Big Prawn Noodle"
    address="Adam Food Centre, #01-27, 2 Adam Road, 289876, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/adam-rd-noo-cheng-big-prawn-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The prawn mee cooked à la minute is a recipe from the owner’s father. Opt for “dry” noodles tossed in prawn paste of your desired level of heat, alongside a bowl of prawn soup. Toppings like pig skin add contrasting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Adam%20Food%20Centre%2C%20%2301-27%2C%202%20Adam%20Road%2C%20289876%2C%20Singapore"
    pageTitle="Adam Rd Noo Cheng Big Prawn Noodle"
  />
);

export default AdamRdNooChengBigPrawnNoodle;
