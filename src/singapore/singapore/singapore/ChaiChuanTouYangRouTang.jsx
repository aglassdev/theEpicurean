...
const ChaiChuanTouYangRouTang = () => (
  <RestaurantPage
    restaurantName="Chai Chuan Tou Yang Rou Tang"
    address="115 Bukit Merah View Market & Hawker Centre, #01-51, Blk 115 Bukit Merah View, 151115, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/chai-chuan-tou-yang-rou-tang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mutton soup here can be paired with tripe, meatballs, tendon or even brain. The mutton boasts the right mix of fatty and lean meat, without tasting gamey. The broth has a mildly herbal flavour. Come early as they tend to sell out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Bukit%20Merah%20View%20Market%20%26%20Hawker%20Centre%2C%20%2301-51%2C%20Blk%20115%20Bukit%20Merah%20View%2C%20151115%2C%20Singapore"
    pageTitle="Chai Chuan Tou Yang Rou Tang"
  />
);

export default ChaiChuanTouYangRouTang;
