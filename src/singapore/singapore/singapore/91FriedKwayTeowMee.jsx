...
const NineOneFriedKwayTeowMee = () => (
  <RestaurantPage
    restaurantName="91 Fried Kway Teow Mee"
    address="Golden Mile Food Centre, #01-91, 505 Beach Road, 199583, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/91-fried-kway-teow-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Their fried kway teow boasts exceptional wok hei and is pork free. Topped with leafy greens, cockles, egg, bean sprouts, deep-fried anchovies and a prawn, the noodles are perfectly seasoned. It closes when sold out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Golden%20Mile%20Food%20Centre%2C%20%2301-91%2C%20505%20Beach%20Road%2C%20199583%2C%20Singapore"
    pageTitle="91 Fried Kway Teow Mee"
  />
);

export default NineOneFriedKwayTeowMee;
