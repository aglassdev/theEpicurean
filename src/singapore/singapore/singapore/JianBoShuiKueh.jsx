...
const JianBoShuiKueh = () => (
  <RestaurantPage
    restaurantName="Jian Bo Shui Kueh"
    address="Tiong Bahru Market, #02-05, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/jian-bo-shui-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Shui kueh is quintessential local street food: white rice cake with salted diced radish and a secret tung tsai sauce, packed with oomph. The house-made sambal, oozing in dried shrimp flavour, is perfect with the rice cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-05%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Jian Bo Shui Kueh"
  />
);

export default JianBoShuiKueh;
