...
const No18ZionRoadFriedKwayTeow = () => (
  <RestaurantPage
    restaurantName="No.18 Zion Road Fried Kway Teow"
    address="Zion Riverside Food Centre, #017, 70 Zion Road, 247792, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/no-18-zion-road-fried-kway-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kway teow noodles are fried to order and topped with fish cake and cockles. The wok hei impresses with its robust flavours and a hint of spiciness, while the cockles impart extra umami. The wait can be long, but is well worth it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zion%20Riverside%20Food%20Centre%2C%20%23017%2C%2070%20Zion%20Road%2C%20247792%2C%20Singapore"
    pageTitle="No.18 Zion Road Fried Kway Teow"
  />
);

export default No18ZionRoadFriedKwayTeow;
