...
const HengHengCookedFood = () => (
  <RestaurantPage
    restaurantName="Heng Heng Cooked Food"
    address="Yuhua Village Market and Food Centre, #01-12, Blk 254, Jurong East Street 24, 600254, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/heng-heng-cooked-food"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Both the laksa and prawn mee are made to order and come in three sizes. Their hallmark laksa is doused in a rich aromatic broth and topped with prawns, fried fish cake, fried tofu and cockles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Village%20Market%20and%20Food%20Centre%2C%20%2301-12%2C%20Blk%20254%2C%20Jurong%20East%20Street%2024%2C%20600254%2C%20Singapore"
    pageTitle="Heng Heng Cooked Food"
  />
);

export default HengHengCookedFood;
