...
const ChengHengKwayChapAndBraisedDuckRice = () => (
  <RestaurantPage
    restaurantName="Cheng Heng Kway Chap and Braised Duck Rice"
    address="Holland Drive Market & Food Centre, #02-05, 44 Holland Drive, 270044, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/cheng-heng-kway-chap-and-braised-duck-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name reveals the two signature dishes – the braised duck is tender, has robust flavours and is accompanied by a perfectly seasoned, spiced soy marinade. The kway (rice noodles) are silky smooth and the soup is moreish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Holland%20Drive%20Market%20%26%20Food%20Centre%2C%20%2302-05%2C%2044%20Holland%20Drive%2C%20270044%2C%20Singapore"
    pageTitle="Cheng Heng Kway Chap and Braised Duck Rice"
  />
);

export default ChengHengKwayChapAndBraisedDuckRice;
