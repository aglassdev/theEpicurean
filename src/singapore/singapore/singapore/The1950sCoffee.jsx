...
const The1950sCoffee = () => (
  <RestaurantPage
    restaurantName="The 1950's Coffee"
    address="Chinatown Complex Market & Food Centre, #02-048, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/the-50s"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here for the quintessential Singaporean teatime classics – kaya toast with kopi kosong (black coffee). This popular stall opened its doors in the 1950s and locals have been lining up to get their caffeine fix ever since...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-048%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="The 1950's Coffee"
  />
);

export default The1950sCoffee;
