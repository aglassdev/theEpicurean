...
const TiongBahruHainaneseBonelessChickenRice = () => (
  <RestaurantPage
    restaurantName="Tiong Bahru Hainanese Boneless Chicken Rice"
    address="Tiong Bahru Market, #02-82, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tiong-bahru-hainanese-boneless-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rice that comes with the signature Hainanese boneless chicken imparts a mild turmeric aroma. Tender juicy meat, without too much fat under the bouncy, gelatinous skin. The roast chicken is also recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-82%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Tiong Bahru Hainanese Boneless Chicken Rice"
  />
);

export default TiongBahruHainaneseBonelessChickenRice;
