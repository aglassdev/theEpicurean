...
const SingaporeFamousRojak = () => (
  <RestaurantPage
    restaurantName="Singapore Famous Rojak"
    address="Albert Centre, #01-45, 270 Queen Street, 180270, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/singapore-famous-rojak"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Albert%20Centre%2C%20%2301-45%2C%20270%20Queen%20Street%2C%20180270%2C%20Singapore"
    pageTitle="Singapore Famous Rojak"
  />
);

export default SingaporeFamousRojak;
