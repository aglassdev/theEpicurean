...
const AllauddinsBriyani = () => (
  <RestaurantPage
    restaurantName="Allauddin's Briyani"
    address="Tekka Centre, #01-229/232, 665 Buffalo Road, 210665, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/allauddin-s-briyani"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The family has been selling its famous biryani since the 1950s. The set comes with yellow basmati rice enhanced by a spice mix; mutton, chicken or fish curry; and papadums. The mutton sambal is tender and tasty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tekka%20Centre%2C%20%2301-229%2F232%2C%20665%20Buffalo%20Road%2C%20210665%2C%20Singapore"
    pageTitle="Allauddin's Briyani"
  />
);

export default AllauddinsBriyani;
