...
const KelantanKwayChapPigOrganSoup = () => (
  <RestaurantPage
    restaurantName="Kelantan Kway Chap · Pig Organ Soup"
    address="Berseh Food Centre, #02-39, 166 Jalan Besar, 208877, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kelantan-kway-chap-pig-organ-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pork cuts and offal like belly, trotter, intestines and skin are cooked in a soy-based marinade with spices. The depth and rich flavours of the meat are the perfect accompaniment to the kway chap ribbon noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Berseh%20Food%20Centre%2C%20%2302-39%2C%20166%20Jalan%20Besar%2C%20208877%2C%20Singapore"
    pageTitle="Kelantan Kway Chap · Pig Organ Soup"
  />
);

export default KelantanKwayChapPigOrganSoup;
