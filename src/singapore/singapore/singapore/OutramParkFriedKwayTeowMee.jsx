...
const OutramParkFriedKwayTeowMee = () => (
  <RestaurantPage
    restaurantName="Outram Park Fried Kway Teow Mee"
    address="Hong Lim Market and Food Centre, #02-17, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/outram-park-fried-kway-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Kway Teow is fried with a dark sauce you can add cockles to the noodles. Always a long queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2302-17%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Outram Park Fried Kway Teow Mee"
  />
);

export default OutramParkFriedKwayTeowMee;
