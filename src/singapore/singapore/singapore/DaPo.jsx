...
const DaPo = () => (
  <RestaurantPage
    restaurantName="Da Po"
    address="Golden Mile Food Centre, #B1-53, 505 Beach Road, 199583, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6598489949"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/da-po"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall serves only curry chicken noodles and Hainanese chicken rice. The latter comes in three portion sizes. Choose between roast or steamed chicken. The steamed one boasts meaty flavour, springy skin and silky flesh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Golden%20Mile%20Food%20Centre%2C%20%23B1-53%2C%20505%20Beach%20Road%2C%20199583%2C%20Singapore"
    pageTitle="Da Po"
  />
);
