...
const SushiMasaaki = () => (
  <RestaurantPage
    restaurantName="Sushi Masaaki"
    address="South Beach Avenue, #B1-17, 26 Beach Road, 189768, Singapore"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+6586881555"
    website="https://sushimasaaki.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This omakase sushiya with only 12 seats boasts a counter crafted from a 250-year-old hinoki tree. In stark contrast, the lively lounge for tea and dessert is clad in wallpaper with dancing cranes on a pink background. The freshest fish is creatively combined with other ingredients to great effects while the well thought-out, sometimes unorthodox, seasoning on the sushi makes the experience unique. Friendly chefs are happy to interact with diners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=South%20Beach%20Avenue%2C%20%23B1-17%2C%2026%20Beach%20Road%2C%20189768%2C%20Singapore"
    pageTitle="Sushi Masaaki"
  />
);

export default SushiMasaaki;
