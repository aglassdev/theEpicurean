...
const HillStreetTaiHwaPorkNoodle = () => (
  <RestaurantPage
    restaurantName="Hill Street Tai Hwa Pork Noodle"
    address="Blk 466, #01-12, Crawford Lane, 190466, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6592723920"
    website="https://www.taihwa.com.sg"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Noodles are cooked-to-order with nicely layered flavours and textures in every bite. Crispy dried plaice, fluffy cracklings, and tender pork liver are all meticulously prepared. Expect to queue any time of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%20466%2C%20%2301-12%2C%20Crawford%20Lane%2C%20190466%2C%20Singapore"
    pageTitle="Hill Street Tai Hwa Pork Noodle"
  />
);

export default HillStreetTaiHwaPorkNoodle;
