...
const SingaporeFriedHokkienMee = () => (
  <RestaurantPage
    restaurantName="Singapore Fried Hokkien Mee"
    address="Whampoa Makan Place, #01-32, 90/91 Whampoa Drive 91, 320091, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/singapore-fried-hokkien-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Their famous Hokkien mee is made with rice vermicelli and yellow egg noodles, which are topped with prawns and squid for that umami flavour – even better with a helping of spicy homemade chilli sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Whampoa%20Makan%20Place%2C%20%2301-32%2C%2090%2F91%20Whampoa%20Drive%2091%2C%20320091%2C%20Singapore"
    pageTitle="Singapore Fried Hokkien Mee"
  />
);

export default SingaporeFriedHokkienMee;
