...
const BoonTongKeeBalestierRoad = () => (
  <RestaurantPage
    restaurantName="Boon Tong Kee (Balestier Road)"
    address="399, 401, 403 Balestier Road, 329801, Singapore"
    cuisine="Singaporean"
    priceRange="$"
    phoneNumber="+6562543937"
    website="https://boontongkee.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You won’t have any trouble finding this enduringly popular restaurant – its colourful neon sign will guide you in from afar. The group may have expanded over the years but this is the original branch, opened in 1983. Their signature boiled chicken, which boosts succulent and tender meat, is still the biggest draw and comes in three different sizes, but those looking for a full zi char feast won’t be disappointed. Avoid peak times if you’re not prepared to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=399%2C%20401%2C%20403%20Balestier%20Road%2C%20329801%2C%20Singapore"
    pageTitle="Boon Tong Kee (Balestier Road)"
  />
);

export default BoonTongKeeBalestierRoad;
