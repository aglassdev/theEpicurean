...
const ToaPayoh93SoonKueh = () => (
  <RestaurantPage
    restaurantName="Toa Payoh 93 Soon Kueh"
    address="Geylang Bahru Market & Food Centre, #01-68, 69 Geylang Bahru, 330069, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/toa-payoh-93-soon-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stall carries three kinds of dumplings – soon kueh stuffed with bamboo shoot, rice kueh and kuchai kueh with chives. All varieties boast elastic skin and generous filling. Try also the limited offer Hakka yam abacus seeds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geylang%20Bahru%20Market%20%26%20Food%20Centre%2C%20%2301-68%2C%2069%20Geylang%20Bahru%2C%20330069%2C%20Singapore"
    pageTitle="Toa Payoh 93 Soon Kueh"
  />
);

export default ToaPayoh93SoonKueh;
