...
const FiveFourFiveWhampoaPrawnNoodles = () => (
  <RestaurantPage
    restaurantName="545 Whampoa Prawn Noodles"
    address="Tekka Centre, #01-326, 665 Buffalo Road, 210665, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/545-whampoa-prawn-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stall dates back to 1920s. Dry noodles dressed in sambal sauce are topped with bean sprouts, prawns and pork, and served with umami-laden prawn soup. Or opt for the noodle soup version. Add fried shallots and lard on top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tekka%20Centre%2C%20%2301-326%2C%20665%20Buffalo%20Road%2C%20210665%2C%20Singapore"
    pageTitle="545 Whampoa Prawn Noodles"
  />
);

export default FiveFourFiveWhampoaPrawnNoodles;
