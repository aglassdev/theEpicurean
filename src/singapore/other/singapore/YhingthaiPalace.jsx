...
const YhingthaiPalace = () => (
  <RestaurantPage
    restaurantName="Yhingthai Palace"
    address="#01-04, 36 Purvis Street, 188613, Singapore"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+6563371161"
    website="https://www.yhingthai.com.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in the 1990s by a couple with a passion for Thai cuisine, this restaurant is spread over three colourful Thai-style rooms. Added authenticity comes courtesy of the helpful waitresses in traditional dress. The Thai and Thai-Chinese dishes are prepared with fresh ingredients sourced daily. Start your meal with som tom: papaya salad with dried shrimps and peanuts. Consider ordering the set if you find the lengthy à la carte menu hard to navigate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%2301-04%2C%2036%20Purvis%20Street%2C%20188613%2C%20Singapore"
    pageTitle="Yhingthai Palace"
  />
);

export default YhingthaiPalace;
