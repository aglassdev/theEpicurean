...
const FuMingCookedFood = () => (
  <RestaurantPage
    restaurantName="Fu Ming Cooked Food"
    address="Redhill Market, #01-49, 85 Redhill Lane, 150085, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/fu-ming-cooked-food"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Homemade black and white carrot cake is served. The black one with dark soya sauce is crispy and tasty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Redhill%20Market%2C%20%2301-49%2C%2085%20Redhill%20Lane%2C%20150085%2C%20Singapore"
    pageTitle="Fu Ming Cooked Food"
  />
);

export default FuMingCookedFood;
