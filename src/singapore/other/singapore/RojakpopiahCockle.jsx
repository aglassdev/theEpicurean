...
const RojakpopiahCockle = () => (
  <RestaurantPage
    restaurantName="Rojak‧Popiah & Cockle"
    address="Maxwell Food Centre, #01-56, 1 Kadayanallur Street, 069184, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/rojak%E2%80%A7popiah-cockle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This clean, tidy stall is named after the three items on its menu. The rojak features pineapple, yam bean, cucumber and fried dough stick dressed in a sweet, tangy and spicy sauce. Try their made-to-order popiah, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maxwell%20Food%20Centre%2C%20%2301-56%2C%201%20Kadayanallur%20Street%2C%20069184%2C%20Singapore"
    pageTitle="Rojak‧Popiah & Cockle"
  />
);

export default RojakpopiahCockle;
