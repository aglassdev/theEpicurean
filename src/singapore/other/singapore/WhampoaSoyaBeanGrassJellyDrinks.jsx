...
const WhampoaSoyaBeanGrassJellyDrinks = () => (
  <RestaurantPage
    restaurantName="Whampoa Soya Bean & Grass Jelly Drinks"
    address="Whampoa Makan Place, #01-52, 90/91 Whampoa Drive 91, 320091, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/whampoa-soya-bean-grass-jelly-drinks"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tofu pudding is freshly made on the spot – just add toppings such as grass jelly, red beans or lotus seeds. Or try their drinkable versions, in which the soybean flavour is complemented by the velvety texture of a smoothie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Whampoa%20Makan%20Place%2C%20%2301-52%2C%2090%2F91%20Whampoa%20Drive%2091%2C%20320091%2C%20Singapore"
    pageTitle="Whampoa Soya Bean & Grass Jelly Drinks"
  />
);

export default WhampoaSoyaBeanGrassJellyDrinks;
