...
const YongKeeClaypotBakKutTeh = () => (
  <RestaurantPage
    restaurantName="Yong Kee Claypot Bak Kut Teh"
    address="Taman Jurong Market & Food Centre, #02-78, 3 Yung Sheng Road, Jurong West, 618499, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/yong-kee-claypot-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pork rib soup is served in a claypot alongside other condiments, such as peppercorns. The Chinese herbal version strikes a fine balance, with distinctive yet not overpowering herbal flavours. Other claypot soups are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Taman%20Jurong%20Market%20%26%20Food%20Centre%2C%20%2302-78%2C%203%20Yung%20Sheng%20Road%2C%20Jurong%20West%2C%20618499%2C%20Singapore"
    pageTitle="Yong Kee Claypot Bak Kut Teh"
  />
);

export default YongKeeClaypotBakKutTeh;
