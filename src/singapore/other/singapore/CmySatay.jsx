...
const CmySatay = () => (
  <RestaurantPage
    restaurantName="C.M.Y. Satay"
    address="Chinatown Complex Market & Food Centre, #02-168, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/168-cmy-satay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two shops share the same venue, so be sure you order from the right one. The grilled-to-order satay comes in pork, chicken and lamb varieties (or an assortment). The nutty, tangy sauce is tasty and you can order rice on top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-168%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="C.M.Y. Satay"
  />
);

export default CmySatay;
