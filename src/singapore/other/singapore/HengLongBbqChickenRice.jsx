...
const HengLongBbqChickenRice = () => (
  <RestaurantPage
    restaurantName="Heng Long BBQ Chicken Rice"
    address="Mei Ling Market & Food Centre, #02-42, 159 Mei Chin Road, 140159, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/heng-long-bbq-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The BBQ chicken rice is an absolute must, but the honey-glazed char siew and roast pork are also popular. Or opt for their brine-poached chicken – succulent, perfectly seasoned and with a wonderful velvety texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mei%20Ling%20Market%20%26%20Food%20Centre%2C%20%2302-42%2C%20159%20Mei%20Chin%20Road%2C%20140159%2C%20Singapore"
    pageTitle="Heng Long BBQ Chicken Rice"
  />
);

export default HengLongBbqChickenRice;
