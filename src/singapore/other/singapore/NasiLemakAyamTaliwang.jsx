...
const NasiLemakAyamTaliwang = () => (
  <RestaurantPage
    restaurantName="Nasi Lemak Ayam Taliwang"
    address="Yishun Park Hawker Centre, #01-33, 51 Yishun Avenue 11, 768867, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/nasi-lemak-ayam-taliwang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional coconut milk rice with Indonesian spicy chicken and sambal sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yishun%20Park%20Hawker%20Centre%2C%20%2301-33%2C%2051%20Yishun%20Avenue%2011%2C%20768867%2C%20Singapore"
    pageTitle="Nasi Lemak Ayam Taliwang"
  />
);

export default NasiLemakAyamTaliwang;
