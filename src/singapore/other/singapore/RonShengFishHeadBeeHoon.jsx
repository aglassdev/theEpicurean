...
const RonShengFishHeadBeeHoon = () => (
  <RestaurantPage
    restaurantName="Ron Sheng Fish Head Bee Hoon"
    address="Yuhua Village Market and Food Centre, #01-44, Blk 254, Jurong East Street 24, 600254, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ron-sheng-fish-head-bee-hoon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Crispy fried fish head and fish meat with bee hoon. The broth infused with milk is smooth and sweet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Village%20Market%20and%20Food%20Centre%2C%20%2301-44%2C%20Blk%20254%2C%20Jurong%20East%20Street%2024%2C%20600254%2C%20Singapore"
    pageTitle="Ron Sheng Fish Head Bee Hoon"
  />
);

export default RonShengFishHeadBeeHoon;
