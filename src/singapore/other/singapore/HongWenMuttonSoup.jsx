...
const HongWenMuttonSoup = () => (
  <RestaurantPage
    restaurantName="Hong Wen Mutton Soup"
    address="Beauty World Food Centre #04-20, 144 Upper Bukit Timah Road, 588177, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6598898948"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hong-wen-mutton-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In operation for over half a century, this stall is now run by the second-generation owner and his wife. Their signature soup comprises mutton, tripe or tendon in a garlicky and peppery broth with strong herbal accents...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beauty%20World%20Food%20Centre%20%2304-20%2C%20144%20Upper%20Bukit%20Timah%20Road%2C%20588177%2C%20Singapore"
    pageTitle="Hong Wen Mutton Soup"
  />
);

export default HongWenMuttonSoup;
