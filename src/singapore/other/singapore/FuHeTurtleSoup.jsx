...
const FuHeTurtleSoup = () => (
  <RestaurantPage
    restaurantName="Fu He Turtle Soup"
    address="Berseh Food Centre, #02-40, 166 Jalan Besar, 208877, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/fu-he-turtle-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is an array of Cantonese soups to choose from here. The eponymous soft-shelled turtle soup emits rich herbal aromas, served with plain steamed rice or taro rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Berseh%20Food%20Centre%2C%20%2302-40%2C%20166%20Jalan%20Besar%2C%20208877%2C%20Singapore"
    pageTitle="Fu He Turtle Soup"
  />
);

export default FuHeTurtleSoup;
