...
const Kotuwa = () => (
  <RestaurantPage
    restaurantName="Kotuwa"
    address="New Bahru, #01-03, 46 Kim Yam Road, 239351, Singapore"
    cuisine="Sri Lankan"
    priceRange="$$"
    phoneNumber="+6565184278"
    website="https://kotuwa.com.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Moved to this spot in 2024, Kotuwa is named after the CBD of Colombo. From quintessential Sri Lankan street food to curries, every bite is loaded with big flavours. Seafood is their strong suit, especially crab prepared in myriad ways. With its balanced, layered flavours and the subtle warmth of cinnamon, the crab curry really stands out. Hoppers – crispy pancakes made with fermented rice – are perfect for mopping up the delicious curry sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=New%20Bahru%2C%20%2301-03%2C%2046%20Kim%20Yam%20Road%2C%20239351%2C%20Singapore"
    pageTitle="Kotuwa"
  />
);

export default Kotuwa;
