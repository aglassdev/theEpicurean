...
const NaNaCurry = () => (
  <RestaurantPage
    restaurantName="Na Na Curry"
    address="115 Bukit Merah View Market & Hawker Centre, #01-47, Blk 115 Bukit Merah View, 151115, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/na-na-curry"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fish head curry with eggplant, okra and tofu puff stands out with its aromatic spice paste made from scratch, paired with a hint of coconut milk. The fish, lamb and chicken curry are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Bukit%20Merah%20View%20Market%20%26%20Hawker%20Centre%2C%20%2301-47%2C%20Blk%20115%20Bukit%20Merah%20View%2C%20151115%2C%20Singapore"
    pageTitle="Na Na Curry"
  />
);

export default NaNaCurry;
