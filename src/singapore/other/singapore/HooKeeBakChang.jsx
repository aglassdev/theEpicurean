...
const HooKeeBakChang = () => (
  <RestaurantPage
    restaurantName="Hoo Kee Bak Chang"
    address="Amoy Street Food Centre, #01-18, 7 Maxwell Road, 069111, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hoo-kee-rice-dumpling"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glutinous rice mixed with salted duck egg yolk pork and chestnut wrapped with bamboo leaf...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amoy%20Street%20Food%20Centre%2C%20%2301-18%2C%207%20Maxwell%20Road%2C%20069111%2C%20Singapore"
    pageTitle="Hoo Kee Bak Chang"
  />
);

export default HooKeeBakChang;
