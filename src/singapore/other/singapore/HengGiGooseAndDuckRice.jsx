...
const HengGiGooseAndDuckRice = () => (
  <RestaurantPage
    restaurantName="Heng Gi Goose and Duck Rice"
    address="Tekka Centre, #01-335, 665 Buffalo Road, 210665, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/heng-gi-goose-and-duck-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The soya sauce duck is very popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tekka%20Centre%2C%20%2301-335%2C%20665%20Buffalo%20Road%2C%20210665%2C%20Singapore"
    pageTitle="Heng Gi Goose and Duck Rice"
  />
);

export default HengGiGooseAndDuckRice;
