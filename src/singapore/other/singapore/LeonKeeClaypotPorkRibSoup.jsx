...
const LeonKeeClaypotPorkRibSoup = () => (
  <RestaurantPage
    restaurantName="Leon Kee Claypot Pork Rib Soup"
    address="Alexandra Village Food Centre, #01-18, Blk 120 Bukit Merah Lane 1, 150120, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/leon-kee-claypot-pork-rib-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The pork rib soup cooked with Chinese herbs is the signature dish; it also offers pig's tail soup, sesame oil chicken and claypot pork liver...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alexandra%20Village%20Food%20Centre%2C%20%2301-18%2C%20Blk%20120%20Bukit%20Merah%20Lane%201%2C%20150120%2C%20Singapore"
    pageTitle="Leon Kee Claypot Pork Rib Soup"
  />
);

export default LeonKeeClaypotPorkRibSoup;
