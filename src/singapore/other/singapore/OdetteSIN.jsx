...
const OdetteSIN = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+6563850498"
    website="https://odetterestaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Where better to find a priceless jewel of the Singapore dining scene than in The National Gallery? Chef Julien Royer and his highly accomplished kitchen make wonderful use of luxury ingredients of unimpeachable quality. Creative combinations, impeccable techniques and exquisite plating result in dishes that are as elegant as they are memorable. The understated and graceful room, overseen by a highly polished service team, provides the perfect backdrop...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=National%20Gallery%2C%20%2301-04%2C%201%20St.%20Andrew's%20Road%20(entrance%20via%20Supreme%20Court%20wing's%20foyer)%2C%20178957%2C%20Singapore"
    pageTitle="Odette"
  />
);

export default OdetteSIN;
