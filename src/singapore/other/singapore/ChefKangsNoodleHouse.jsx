...
const ChefKangsNoodleHouse = () => (
  <RestaurantPage
    restaurantName="Chef Kang's Noodle House"
    address="Blk C, #01-34, Jackson Square, 11 Lorong 3 Toa Payoh, 319579, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6582802782"
    website="https://www.chef-kang.com/noodle-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This joint specialises in noodle soup with wontons and char siu – the springy noodles are shipped from Hong Kong; the lightly charred pork has layers of fat and lean meat. For extra texture and flavour, order shredded abalone on top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%20C%2C%20%2301-34%2C%20Jackson%20Square%2C%2011%20Lorong%203%20Toa%20Payoh%2C%20319579%2C%20Singapore"
    pageTitle="Chef Kang's Noodle House"
  />
);

export default ChefKangsNoodleHouse;
