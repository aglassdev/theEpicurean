...
const SinHoiSaiTiongBahru = () => (
  <RestaurantPage
    restaurantName="Sin Hoi Sai (Tiong Bahru)"
    address="Blk 55, #01-59/61/63, Tiong Bahru Road, 160055, Singapore"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+6562230810"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/sin-hoi-sai-tiong-bahru"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a residential area, this well-known seafood restaurant has over 30 years of history to its name. They serve live seafood only, from fish to shellfish – make your selection from the tank. Don't miss the famous local choices of chilli crab and black pepper crab, which boast firm and briny sweet flesh; the local cze char dishes are also good. You can sit inside or outside – the latter area is particularly atmospheric and relaxing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%2055%2C%20%2301-59%2F61%2F63%2C%20Tiong%20Bahru%20Road%2C%20160055%2C%20Singapore"
    pageTitle="Sin Hoi Sai (Tiong Bahru)"
  />
);

export default SinHoiSaiTiongBahru;
