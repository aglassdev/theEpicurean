...
const MargaretDriveSinKeeChickenRice = () => (
  <RestaurantPage
    restaurantName="Margaret Drive Sin Kee Chicken Rice"
    address="Block 40, Stall 5, #01-39, Holland Drive, 270040, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/margaret-drive-sin-kee-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since this stall opened on Margaret Drive years ago, their chicken rice has been made the same way. The juicy, tender meat is served with aromatic oil rice and an addictive ground ginger sauce. The gizzards are equally good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Block%2040%2C%20Stall%205%2C%20%2301-39%2C%20Holland%20Drive%2C%20270040%2C%20Singapore"
    pageTitle="Margaret Drive Sin Kee Chicken Rice"
  />
);

export default MargaretDriveSinKeeChickenRice;
