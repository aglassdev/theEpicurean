...
const LaiHengHandmadeTeochewKueh = () => (
  <RestaurantPage
    restaurantName="Lai Heng Handmade Teochew Kueh"
    address="Yuhua Market & Hawker Centre, #01-218, Blk 347, Jurong East Avenue 1, Jurong East, 600347, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lai-heng-handmade-teochew-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Handmade Teochew kueh with various flavours. Steamed or pan-fried versions available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Market%20%26%20Hawker%20Centre%2C%20%2301-218%2C%20Blk%20347%2C%20Jurong%20East%20Avenue%201%2C%20Jurong%20East%2C%20600347%2C%20Singapore"
    pageTitle="Lai Heng Handmade Teochew Kueh"
  />
);

export default LaiHengHandmadeTeochewKueh;
