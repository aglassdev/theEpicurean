...
const ComeDailyFriedHokkienPrawnMee = () => (
  <RestaurantPage
    restaurantName="Come Daily Fried Hokkien Prawn Mee"
    address="127 Toa Payoh West Market & Food Centre, #02-27, Blk 127, Lorong 1 Toa Payoh, 310127, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/come-daily-fried-hokkien-prawn-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The signature Hokkien prawn mee is made with yellow egg noodles, rice vermicelli and squid, topped with fried crispy lard that adds an extra layer of texture and flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20Toa%20Payoh%20West%20Market%20%26%20Food%20Centre%2C%20%2302-27%2C%20Blk%20127%2C%20Lorong%201%20Toa%20Payoh%2C%20310127%2C%20Singapore"
    pageTitle="Come Daily Fried Hokkien Prawn Mee"
  />
);

export default ComeDailyFriedHokkienPrawnMee;
