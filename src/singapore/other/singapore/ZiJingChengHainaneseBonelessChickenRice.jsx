...
const ZiJingChengHainaneseBonelessChickenRice = () => (
  <RestaurantPage
    restaurantName="Zi Jing Cheng Hainanese Boneless Chicken Rice"
    address="Alexandra Village Food Centre, #01-15, Blk 120 Bukit Merah Lane 1, 150120, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/zi-jing-cheng-hainanese-boneless-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is only one thing on the menu – Hainanese boneless chicken rice. Set menus are available for one to three guests, all served with steamed chicken, rice and soup. The bird is tender and flavoursome. Expect to queue any time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alexandra%20Village%20Food%20Centre%2C%20%2301-15%2C%20Blk%20120%20Bukit%20Merah%20Lane%201%2C%20150120%2C%20Singapore"
    pageTitle="Zi Jing Cheng Hainanese Boneless Chicken Rice"
  />
);

export default ZiJingChengHainaneseBonelessChickenRice;
