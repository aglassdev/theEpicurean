...
const LongKeeWantonNoodle = () => (
  <RestaurantPage
    restaurantName="Long Kee Wanton Noodle"
    address="Jurong West 505 Market & Food Centre, #01-185, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/long-kee-wanton-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The signature wonton noodles feature flavoursome bite-size dumplings, served either in soup or tossed in sauces. The noodles are cooked to perfect consistency with a lovely chew. Sliced char siew adds depth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-185%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Long Kee Wanton Noodle"
  />
);

export default LongKeeWantonNoodle;
