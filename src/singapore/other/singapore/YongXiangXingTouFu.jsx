...
const YongXiangXingTouFu = () => (
  <RestaurantPage
    restaurantName="Yong Xiang Xing Tou Fu"
    address="People's Park Complex Food Centre, #01-1084, 32 New Market Road, 050032, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/yong-xiang-xing-tou-fu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is only one thing on the menu – assorted tofu stew. Fish balls, tofu skin rolls, silken tofu and deep-fried tofu stuffed with minced fish are ladled into your bowl alongside a clear broth seasoned by scallion. Simply delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=People's%20Park%20Complex%20Food%20Centre%2C%20%2301-1084%2C%2032%20New%20Market%20Road%2C%20050032%2C%20Singapore"
    pageTitle="Yong Xiang Xing Tou Fu"
  />
);

export default YongXiangXingTouFu;
