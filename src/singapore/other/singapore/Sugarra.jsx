...
const Sugarra = () => (
  <RestaurantPage
    restaurantName="Sugarra"
    address="Hotel Michael, Level 1, Resorts World Sentosa, 8 Sentosa Gateway, 098269, Singapore"
    cuisine="Basque"
    priceRange="$$$"
    phoneNumber="+6565776665"
    website="https://www.rwsentosa.com/en/dine/signature-restaurants/sugarra"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sugarra is Basque for ‘flame’ that gave birth to cooking. Here, native Basque chef Aitor Jeronimo Orive pays tribute to this legacy as he returns to his culinary roots, while injecting modern touches into Basque classics deftly crafted with Spanish produce. Sip an aperitif or cocktail at the bar before ordering one of the three menus. The first course stars a lineup of Spain’s best-known tapas and is a genuine tour de force...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Michael%2C%20Level%201%2C%20Resorts%20World%20Sentosa%2C%208%20Sentosa%20Gateway%2C%20098269%2C%20Singapore"
    pageTitle="Sugarra"
  />
);

export default Sugarra;
