...
const Solo = () => (
  <RestaurantPage
    restaurantName="Solo"
    address="45 Amoy Street, 069871, Singapore"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+6562600762"
    website="https://soloristorante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Amoy Street where F&B outlets abound, Solo stands out with a relaxing vibe, an action-packed open kitchen and a regularly changing Italian menu that celebrates fresh, seasonal ingredients. The 5-course gourmet menu is a great way to sample some of its signature dishes, such as al dente homemade tagliolini topped with Japanese Bafun uni bursting with briny sweetness and umami. At lunch, the 3- or 4-course seasonal set offers great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Amoy%20Street%2C%20069871%2C%20Singapore"
    pageTitle="Solo"
  />
);
