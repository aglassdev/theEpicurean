...
const Roia = () => (
  <RestaurantPage
    restaurantName="Roia"
    address="Singapore Botanic Gardens (Nassim Gate entrance), E.J.H Corner House, 1 Cluny Road, 259569, Singapore"
    cuisine="French Contemporary"
    priceRange="$$$"
    phoneNumber="+6589081705"
    website="https://www.roia.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not only can you feast your eyes on the lush greenery, you can also taste the herbs and edible flowers grown in the garden and picked minutes before serving. In a refurbished historic edifice, chef-owner Priyam Chatterjee serves two tasting menus that are updated quarterly and feature modern French fare rooted in tradition and exquisitely plated. The top-notch produce comes from around the world and each course tells a story about its source...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Singapore%20Botanic%20Gardens%20(Nassim%20Gate%20entrance)%2C%20E.J.H%20Corner%20House%2C%201%20Cluny%20Road%2C%20259569%2C%20Singapore"
    pageTitle="Roia"
  />
);
