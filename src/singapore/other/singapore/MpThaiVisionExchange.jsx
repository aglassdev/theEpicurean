...
const MpThaiVisionExchange = () => (
  <RestaurantPage
    restaurantName="MP Thai (Vision Exchange)"
    address="Vision Exchange, #02-41/42, 2 Venture Drive, 608526, Singapore"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+6591199710"
    website="https://mpthai.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple shop may not be the most atmospheric, but its tasty food in generous portions at affordable prices always attracts a crowd. With a Thai owner and all Thai kitchen team, rest assured that the food is as authentic as can be. The tom yum soup strikes a fine balance between sour, sweet, spicy and salty tastes; the BBQ squid is nicely grilled and loaded with umami, perfect with the hot and sour sauce. Reservation recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vision%20Exchange%2C%20%2302-41%2F42%2C%202%20Venture%20Drive%2C%20608526%2C%20Singapore"
    pageTitle="MP Thai (Vision Exchange)"
  />
);

export default MpThaiVisionExchange;
