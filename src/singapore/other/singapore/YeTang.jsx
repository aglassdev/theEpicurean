...
const YeTang = () => (
  <RestaurantPage
    restaurantName="Ye Tang"
    address="Beauty World Food Centre #04-26, 144 Upper Bukit Timah Road, 588177, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6590992289"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ye-tang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner learned to make cendol in Malacca, and his rice flour jelly worms – made on the spot – are softer than most. On top of the classic cendol shaved ice, add red kidney beans, palm seeds, corn kernels or durian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beauty%20World%20Food%20Centre%20%2304-26%2C%20144%20Upper%20Bukit%20Timah%20Road%2C%20588177%2C%20Singapore"
    pageTitle="Ye Tang"
  />
);

export default YeTang;
