...
const TrueBlueCuisine = () => (
  <RestaurantPage
    restaurantName="True Blue Cuisine"
    address="47/49 Armenian Street, 179937, Singapore"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+6564400449"
    website="https://truebluecuisine.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s less like walking into a restaurant, more like falling into the warm embrace of a much loved family member. Here it’s about nostalgia and paying homage to the food, history and customs of the Peranakans – you’ll find all the classic dishes, prepared in an authentic way, and the hard part is narrowing down your choice. The setting really is unique and the Ayam Buah Keluak is one of the signature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%2F49%20Armenian%20Street%2C%20179937%2C%20Singapore"
    pageTitle="True Blue Cuisine"
  />
);

export default TrueBlueCuisine;
