...
const TowKwarPop = () => (
  <RestaurantPage
    restaurantName="Tow Kwar Pop"
    address="Tiong Bahru Market, #02-06, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tow-kwar-pop"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, the rojak is made with sliced cucumber, apple and bean sprouts, topped with either crispy tofu puffs or fried dough sticks. The syrupy dressing is rich and tangy, and the ground peanuts give the salad a lovely crunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-06%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Tow Kwar Pop"
  />
);

export default TowKwarPop;
