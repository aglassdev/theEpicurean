...
const BahrakathMuttonSoup = () => (
  <RestaurantPage
    restaurantName="Bahrakath Mutton Soup"
    address="Adam Food Centre, #01-10, 2 Adam Road, 289876, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/bahrakath-mutton-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1973, this stall has been serving its secret mutton soup recipe. The broth is rich, dense, and full of herbal flavours. Apart from the popular leg, also try other lamb cuts. Order bread to mop up the broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Adam%20Food%20Centre%2C%20%2301-10%2C%202%20Adam%20Road%2C%20289876%2C%20Singapore"
    pageTitle="Bahrakath Mutton Soup"
  />
);

export default BahrakathMuttonSoup;
