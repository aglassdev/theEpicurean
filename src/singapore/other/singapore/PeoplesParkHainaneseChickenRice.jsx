...
const PeoplesParkHainaneseChickenRice = () => (
  <RestaurantPage
    restaurantName="People's Park Hainanese Chicken Rice"
    address="People's Park Complex Food Centre, #01-1098, 32 New Market Road, 050032, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/people-s-park-hainanese-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cantonese barbecue like roast pork and duck aside, the main draws are Hainanese chicken rice and double-boiled soups. The rice is richly perfumed with garlic and the flavourful chicken with a gelatinous skin is not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=People's%20Park%20Complex%20Food%20Centre%2C%20%2301-1098%2C%2032%20New%20Market%20Road%2C%20050032%2C%20Singapore"
    pageTitle="People's Park Hainanese Chicken Rice"
  />
);

export default PeoplesParkHainaneseChickenRice;
