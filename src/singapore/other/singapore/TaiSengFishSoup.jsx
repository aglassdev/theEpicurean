...
const TaiSengFishSoup = () => (
  <RestaurantPage
    restaurantName="Tai Seng Fish Soup"
    address="Taman Jurong Market & Food Centre, #03-145, 3 Yung Sheng Road, Jurong West, 618499, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tai-seng-fish-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This third-generation family business prides itself on its flavoursome fish soup made from scratch and served with sliced fish, deep-fried fish or fish head. Order noodles, rice or congee on the side for a complete meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Taman%20Jurong%20Market%20%26%20Food%20Centre%2C%20%2303-145%2C%203%20Yung%20Sheng%20Road%2C%20Jurong%20West%2C%20618499%2C%20Singapore"
    pageTitle="Tai Seng Fish Soup"
  />
);

export default TaiSengFishSoup;
