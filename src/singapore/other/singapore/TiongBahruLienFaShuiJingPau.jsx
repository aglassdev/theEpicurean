...
const TiongBahruLienFaShuiJingPau = () => (
  <RestaurantPage
    restaurantName="Tiong Bahru Lien Fa Shui Jing Pau"
    address="Alexandra Village Food Centre, #01-10, Blk 120 Bukit Merah Lane 1, 150120, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6562745561"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tiong-bahru-lien-fa-shui-jing-pau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The teochew dumplings are stuffed with jicama for a lovely crunch, while chopped dried shrimps lend briny umami. Try them with the home-made chilli sauce. Dumplings with red bean or taro paste filling are available after 1pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alexandra%20Village%20Food%20Centre%2C%20%2301-10%2C%20Blk%20120%20Bukit%20Merah%20Lane%201%2C%20150120%2C%20Singapore"
    pageTitle="Tiong Bahru Lien Fa Shui Jing Pau"
  />
);

export default TiongBahruLienFaShuiJingPau;
