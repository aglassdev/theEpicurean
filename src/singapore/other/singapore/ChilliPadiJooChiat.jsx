...
const ChilliPadiJooChiat = () => (
  <RestaurantPage
    restaurantName="Chilli Padi (Joo Chiat)"
    address="#01-03, 11 Joo Chiat Place, 427744, Singapore"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+6562751002"
    website="https://chillipadi.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stroll around Joo Chiat is made all the more enjoyable by making a pitstop here, as it’s a great place to share a host of authentic Peranakan dishes. The Nonya specialities include popiah, kueh pai ti, creamy and delicious curry chicken, and chap chye. Many of the dishes come in three sizes but prices are so good that over-ordering is easy and excusable. The batik fabric covering the tables adds some colour to this simple restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%2301-03%2C%2011%20Joo%20Chiat%20Place%2C%20427744%2C%20Singapore"
    pageTitle="Chilli Padi (Joo Chiat)"
  />
);

export default ChilliPadiJooChiat;
