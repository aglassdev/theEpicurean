...
const CheySuaCarrotCake = () => (
  <RestaurantPage
    restaurantName="Chey Sua Carrot Cake"
    address="127 Toa Payoh West Market & Food Centre, #02-30, Blk 127, Lorong 1 Toa Payoh, 310127, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/chey-sua-carrot-cake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The pan-fried radish cake is hugely popular. Fried on one side until golden, it allows you to taste the caramelised crispy bits and the soft moist cake at the same time. The cakes are fried to order, so expect a longer waiting time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20Toa%20Payoh%20West%20Market%20%26%20Food%20Centre%2C%20%2302-30%2C%20Blk%20127%2C%20Lorong%201%20Toa%20Payoh%2C%20310127%2C%20Singapore"
    pageTitle="Chey Sua Carrot Cake"
  />
);

export default CheySuaCarrotCake;
