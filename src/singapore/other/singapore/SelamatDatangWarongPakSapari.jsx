...
const SelamatDatangWarongPakSapari = () => (
  <RestaurantPage
    restaurantName="Selamat Datang Warong Pak Sapari"
    address="Adam Food Centre, #01-09 , 2 Adam Road, 289876, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/selamat-datang-warong-pak-sapari"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Into the third generation, this family business is famous for mee soto and mee rebus, the former served in broth, the latter in a thicker gravy soup. Bold flavours are authentically Malaysian; add more coriander for extra fragrance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Adam%20Food%20Centre%2C%20%2301-09%20%2C%202%20Adam%20Road%2C%20289876%2C%20Singapore"
    pageTitle="Selamat Datang Warong Pak Sapari"
  />
);

export default SelamatDatangWarongPakSapari;
