...
const LoongKeeYongTauFu = () => (
  <RestaurantPage
    restaurantName="Loong Kee Yong Tau Fu"
    address="Jurong West 505 Market & Food Centre, #01-31, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    ...
    bio="Serve yourself with the stuffed tofu or vegetables. You may also add soup, chee cheong fun, laksa, mee or rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-31%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Loong Kee Yong Tau Fu"
  />
);

export default LoongKeeYongTauFu;
