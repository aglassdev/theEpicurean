...
const SinHuatSeafoodRestaurant = () => (
  <RestaurantPage
    restaurantName="Sin Huat Seafood Restaurant"
    address="659/661 Lorong 35 Geylang, 389589, Singapore"
    cuisine="Street Food"
    priceRange="$$"
    phoneNumber="+6567449755"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/sin-huat-eating-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fried rice vermicelli with crab, available for dinner, is the main event. The gigantic crab is loaded with seafood flavour; the vermicelli pick up the juices nicely, exuding scallion, ginger and chilli aromas. The other seafood dishes are also tasty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=659%2F661%20Lorong%2035%20Geylang%2C%20389589%2C%20Singapore"
    pageTitle="Sin Huat Seafood Restaurant"
  />
);

export default SinHuatSeafoodRestaurant;
