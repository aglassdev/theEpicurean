...
const SinHengClaypotBakKootTeh = () => (
  <RestaurantPage
    restaurantName="Sin Heng Claypot Bak Koot Teh"
    address="#01-01, 439 Joo Chiat Road, 427652, Singapore"
    cuisine="Singaporean"
    priceRange="$$"
    phoneNumber="+6563458754"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/sin-heng-claypot-bak-koot-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple shop has been around for over 40 years and is now run by the second generation owner. As its name suggests, bak kut teh with pepper and garlic served in a claypot is their speciality – the broth is rich, but not overpoweringly spicy and the pork ribs are tender and flavoursome. Sesame oil chicken in claypot is another highlight. The wings are succulent and the sauce delivers nutty aromas and mild sweetness. Also try local stir-fries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%2301-01%2C%20439%20Joo%20Chiat%20Road%2C%20427652%2C%20Singapore"
    pageTitle="Sin Heng Claypot Bak Koot Teh"
  />
);

export default SinHengClaypotBakKootTeh;
