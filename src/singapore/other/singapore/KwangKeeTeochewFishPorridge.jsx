...
const KwangKeeTeochewFishPorridge = () => (
  <RestaurantPage
    restaurantName="Kwang Kee Teochew Fish Porridge"
    address="Newton Food Centre, #01-20, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kwang-kee-teochew-fish-porridge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fish porridge and fried fish bee hoon. The porridge is sweet with abundant fish fillets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-20%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="Kwang Kee Teochew Fish Porridge"
  />
);

export default KwangKeeTeochewFishPorridge;
