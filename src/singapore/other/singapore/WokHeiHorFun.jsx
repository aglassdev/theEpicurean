...
const WokHeiHorFun = () => (
  <RestaurantPage
    restaurantName="Wok Hei Hor Fun"
    address="Redhill Market, #01-94, 85 Redhill Lane, 150085, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/wok-hei-hor-fun"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 30 years, locals have been coming here for the fried hor fun (flat rice noodles) – laden with wok hei, nicely charred and in a sauce that clings to the noodles. Choose from beef, fish or assorted toppings, and don't miss the cracklings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Redhill%20Market%2C%20%2301-94%2C%2085%20Redhill%20Lane%2C%20150085%2C%20Singapore"
    pageTitle="Wok Hei Hor Fun"
  />
);

export default WokHeiHorFun;
