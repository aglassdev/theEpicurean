...
const AhHengDuckRice = () => (
  <RestaurantPage
    restaurantName="Ah Heng Duck Rice"
    address="Hong Lim Market and Food Centre, #02-64, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ah-heng-duck-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The taste of duck meat blends with the spice marinade, each boasting a rich flavour. Snacks like duck liver and dried tofu are also offered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2302-64%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Ah Heng Duck Rice"
  />
);

export default AhHengDuckRice;
