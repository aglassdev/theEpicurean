...
const Cloudstreet = () => (
  <RestaurantPage
    restaurantName="Cloudstreet"
    address="84 Amoy Street, 069903, Singapore"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+6565137868"
    website="https://cloudstreet.com.sg/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In addition to naming his venture after the Tim Winton book, Sri Lankan chef Rishi Naleendra pays homage to Australia where he honed his skills. His food embodies balance and harmony, making the best use of top-quality ingredients and well thought-out flavours. Highlights include Sri Lankan curry with blue marron and coconut broth, and Murray cod with fermented bell pepper and almonds. The savvy front-of-house team delivers slick service and the perfect vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=84%20Amoy%20Street%2C%20069903%2C%20Singapore"
    pageTitle="Cloudstreet"
  />
);

export default Cloudstreet;
