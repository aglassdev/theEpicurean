...
const DillSIN = () => (
  <RestaurantPage
    restaurantName="Dill"
    address="33 Duxton Road, 089497, Singapore"
    cuisine="Scandinavian"
    priceRange="$$"
    phoneNumber="+6587911876"
    website="https://www.dill.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Warm beige, wood tones and soft lighting make for a calm and soothing space. Similarly, dishes created by the Norwegian chef are simple and honest, with a touch of Nordic charm. At lunchtime, light meals such as toast, sandwiches and waffles are served. To experience his culinary vision in full, try his dinner set, which may include the unmissable cod, kohlrabi, celeriac – fresh, perfectly cooked fish finessed by solid technique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20Duxton%20Road%2C%20089497%2C%20Singapore"
    pageTitle="Dill"
  />
);

export default DillSIN;
