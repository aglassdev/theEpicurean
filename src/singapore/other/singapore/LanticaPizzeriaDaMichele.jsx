...
const LanticaPizzeriaDaMichele = () => (
  <RestaurantPage
    restaurantName="L’Antica Pizzeria da Michele"
    address="Mercure ICON Hotel, #01-08, 8 Club Street, 069472, Singapore"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+6598235724"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/l-antica-pizzeria-da-michele"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 150-year-old Neapolitan pizza chain opened their first Asian outpost in 2024 and offers 18 different toppings. All the pizzas are made to order and come in one size only – 15 inches (37cm). Piled high with freshly cooked tomato sauce and cheese, the thin crust is perfectly crisp and chewy at the same time. If you can’t make up your mind, opt for a Marita – half marinara half margherita. The menu also offers starters, pasta and desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mercure%20ICON%20Hotel%2C%20%2301-08%2C%208%20Club%20Street%2C%20069472%2C%20Singapore"
    pageTitle="L’Antica Pizzeria da Michele"
  />
);

export default LanticaPizzeriaDaMichele;
