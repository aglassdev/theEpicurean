...
const JooSiahBakKootTeh = () => (
  <RestaurantPage
    restaurantName="Joo Siah Bak Koot Teh"
    address="Blk 349, #01-1215 Jurong East Avenue 1, 600349, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/joo-siah-bak-koot-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The signature dish here is pepper-flavoured bak kut teh. The soft pork rib goes well with chilli soy sauce. Earlier closing hours on Sunday...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%20349%2C%20%2301-1215%20Jurong%20East%20Avenue%201%2C%20600349%2C%20Singapore"
    pageTitle="Joo Siah Bak Koot Teh"
  />
);

export default JooSiahBakKootTeh;
