...
const AhHockFriedHokkienNoodles = () => (
  <RestaurantPage
    restaurantName="Ah Hock Fried Hokkien Noodles"
    address="Chomp Chomp Food Centre, #01-27, 20 Kensington Park Road, 557269, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ah-hock-fried-hokkien-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Serves fried Hokkien noodles with shrimp and squid...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chomp%20Chomp%20Food%20Centre%2C%20%2301-27%2C%2020%20Kensington%20Park%20Road%2C%20557269%2C%20Singapore"
    pageTitle="Ah Hock Fried Hokkien Noodles"
  />
);

export default AhHockFriedHokkienNoodles;
