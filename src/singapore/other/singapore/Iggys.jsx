...
const Iggys = () => (
  <RestaurantPage
    restaurantName="Iggy's"
    address="voco Orchard, Level 3, 581 Orchard Road, 238883, Singapore"
    cuisine="European Contemporary"
    priceRange="$$$"
    phoneNumber="+6567322234"
    website="https://www.iggys.com.sg"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A picture window in this elegantly furnished room gives diners a front-row view of the kitchen team in action. The tasting menu served at dinner features multiple courses that showcase top-notch produce from Japan and France, such as Miyazaki Wagyu and Bresse pigeon, deftly crafted with European techniques. There is also a plant-based menu for vegans. With thousands of labels from Burgundy, the wine list is worth perusing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=voco%20Orchard%2C%20Level%203%2C%20581%20Orchard%20Road%2C%20238883%2C%20Singapore"
    pageTitle="Iggy's"
  />
);

export default Iggys;
