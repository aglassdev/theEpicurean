...
const PathSIN = () => (
  <RestaurantPage
    restaurantName="Path"
    address="Marina Bay Financial Centre, Tower 3, #01–05/06, 12 Marina Boulevard, 018982, Singapore"
    cuisine="Asian Contemporary"
    priceRange="$$$"
    phoneNumber="+6564430180"
    website="https://pathrestaurant.com.sg"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The place is popular with a business lunch clientele craving creative Asian fare underpinned by classic French techniques. Come evening, it turns into a romantic spot, serving a six- or eight-course dinner menu. The mildly hot crabmeat and tofu spread is the perfect accompaniment for the bread baked in the charcoal oven. The pork trotter wrapped in caul fat is doused in a sauce inspired by the Chinese classic of braised pork with pickled mustard greens...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marina%20Bay%20Financial%20Centre%2C%20Tower%203%2C%20%2301%E2%80%9305%2F06%2C%2012%20Marina%20Boulevard%2C%20018982%2C%20Singapore"
    pageTitle="Path"
  />
);

export default PathSIN;
