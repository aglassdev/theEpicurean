...
const TaiWahPorkNoodle = () => (
  <RestaurantPage
    restaurantName="Tai Wah Pork Noodle"
    address="Hong Lim Market and Food Centre, #02-16, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://taiwahnoodles.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Noodles served with soup meat balls, dried fish and pork liver...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2302-16%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Tai Wah Pork Noodle"
  />
);

export default TaiWahPorkNoodle;
