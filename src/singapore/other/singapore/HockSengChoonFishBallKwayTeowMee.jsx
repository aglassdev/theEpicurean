...
const HockSengChoonFishBallKwayTeowMee = () => (
  <RestaurantPage
    restaurantName="Hock Seng Choon Fish Ball Kway Teow Mee"
    address="Pasar 16@Bedok (Bedok South Food Centre), #01-50, 16 Bedok South Road, 460016, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6597896160"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hock-seng-choon-fish-ball-kway-teow-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fish balls are tender and rich. The al dente noodles marry well with the fresh broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pasar%2016%40Bedok%20(Bedok%20South%20Food%20Centre)%2C%20%2301-50%2C%2016%20Bedok%20South%20Road%2C%20460016%2C%20Singapore"
    pageTitle="Hock Seng Choon Fish Ball Kway Teow Mee"
  />
);

export default HockSengChoonFishBallKwayTeowMee;
