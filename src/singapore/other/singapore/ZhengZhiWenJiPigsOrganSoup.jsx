...
const ZhengZhiWenJiPigsOrganSoup = () => (
  <RestaurantPage
    restaurantName="Zheng Zhi Wen Ji Pig's Organ Soup"
    address="Clementi 448 Food Centre, #01-26, 448 Clementi Ave 3, 120448, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/zheng-zhi-wen-ji-pig-s-organ-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As well as pork offal, the menu features marinated pork trotter, kway chap and bak kut teh. But the noodle soup with pork liver and kidney stands out – the offal is cooked perfectly and the broth loaded with herbal aromas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Clementi%20448%20Food%20Centre%2C%20%2301-26%2C%20448%20Clementi%20Ave%203%2C%20120448%2C%20Singapore"
    pageTitle="Zheng Zhi Wen Ji Pig's Organ Soup"
  />
);

export default ZhengZhiWenJiPigsOrganSoup;
