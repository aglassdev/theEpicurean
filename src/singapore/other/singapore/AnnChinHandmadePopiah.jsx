...
const AnnChinHandmadePopiah = () => (
  <RestaurantPage
    restaurantName="Ann Chin Handmade Popiah"
    address="Chinatown Complex Market & Food Centre, #02-112, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6581894699"
    website="https://www.annchinpopiah.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popiah filled with ingredients such as eggs, shrimp, carrot, peanuts, etc. affords rich, varied flavours. The deep-fried spring rolls are crispy on the outside, juicy on the inside and loaded with big-boned oomph...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-112%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="Ann Chin Handmade Popiah"
  />
);

export default AnnChinHandmadePopiah;
