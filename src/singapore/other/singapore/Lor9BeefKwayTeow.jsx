...
const Lor9BeefKwayTeow = () => (
  <RestaurantPage
    restaurantName="Lor 9 Beef Kway Teow"
    address="237 Lorong 9 Geylang, 389296, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6593880723"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/lor-9-beef-kway-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cantonese and Fujian dishes prepared with local ingredients are tweaked to cater to local tastes. The beef kway teow is the main event. Comfort-food classics such as coffee pork ribs and sambal sweet potato leaves are also excellent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=237%20Lorong%209%20Geylang%2C%20389296%2C%20Singapore"
    pageTitle="Lor 9 Beef Kway Teow"
  />
);

export default Lor9BeefKwayTeow;
