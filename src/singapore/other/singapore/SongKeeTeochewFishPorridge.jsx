...
const SongKeeTeochewFishPorridge = () => (
  <RestaurantPage
    restaurantName="Song Kee Teochew Fish Porridge"
    address="Newton Food Centre, #01-37, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/song-kee-teochew-fish-porridge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fish porridge and fish head bee hoon are the main events here. The porridge is loaded with deboned fresh mackerel that imparts deep umami and sweetness. Chinese celery and coriander instantly brighten the flavour profile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-37%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="Song Kee Teochew Fish Porridge"
  />
);

export default SongKeeTeochewFishPorridge;
