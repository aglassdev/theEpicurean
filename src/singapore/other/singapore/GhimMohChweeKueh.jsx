...
const GhimMohChweeKueh = () => (
  <RestaurantPage
    restaurantName="Ghim Moh Chwee Kueh"
    address="20 Ghim Moh Road Market & Food Centre, #01-54, Blk 20, Ghim Moh Road, 270020, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6591766850"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ghim-moh-chwee-kueh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall founded in 1959 is a household name! Its lovingly hand-made chwee kueh – toothsome rice cakes topped with dried radish and mildly spicy sambal – are hugely popular among locals. Minimum order of four pieces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Ghim%20Moh%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-54%2C%20Blk%2020%2C%20Ghim%20Moh%20Road%2C%20270020%2C%20Singapore"
    pageTitle="Ghim Moh Chwee Kueh"
  />
);

export default GhimMohChweeKueh;
