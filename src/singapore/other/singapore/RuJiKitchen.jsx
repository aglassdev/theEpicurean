...
const RuJiKitchen = () => (
  <RestaurantPage
    restaurantName="Ru Ji Kitchen"
    address="Holland Drive Market & Food Centre, #02-28/29, 44 Holland Drive, 270044, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6594350820"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ru-ji-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two adjoining stalls sell noodle soup or dry noodles with minced pork, pork balls or fish balls handmade on the spot. The bouncy-textured, deep-flavoured fish balls made with yellowtail are especially popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Holland%20Drive%20Market%20%26%20Food%20Centre%2C%20%2302-28%2F29%2C%2044%20Holland%20Drive%2C%20270044%2C%20Singapore"
    pageTitle="Ru Ji Kitchen"
  />
);

export default RuJiKitchen;
