...
const KangLeFishballNoodles = () => (
  <RestaurantPage
    restaurantName="Kang Le Fishball Noodles"
    address="Jurong West 505 Market & Food Centre, #01-29, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kang-le-fishball-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the menu also offers laksa, pork balls and fish dumpling soup, the bouncy, flavoursome fishballs with noodles remain its speciality. Choose between wheat or rice noodles, served in a clear broth or tossed in sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-29%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Kang Le Fishball Noodles"
  />
);

export default KangLeFishballNoodles;
