...
const HongPengLaMianXiaoLongBao = () => (
  <RestaurantPage
    restaurantName="Hong Peng La Mian Xiao Long Bao"
    address="People's Park Complex Food Centre, #01-1064, 32 New Market Road, 050032, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hong-peng-la-mian-xiao-long-bao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Offers xiao long bao, dumplings and hand-pulled noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=People's%20Park%20Complex%20Food%20Centre%2C%20%2301-1064%2C%2032%20New%20Market%20Road%2C%20050032%2C%20Singapore"
    pageTitle="Hong Peng La Mian Xiao Long Bao"
  />
);

export default HongPengLaMianXiaoLongBao;
