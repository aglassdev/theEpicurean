...
const HengKee = () => (
  <RestaurantPage
    restaurantName="Heng Kee"
    address="Hong Lim Market and Food Centre, #01-58, Blk 531A, Upper Cross Street, 051531, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/heng-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall, founded in the 1970s, is now run by the second-generation owner. Its hallmark dishes are mild, well-balanced curry broth, custom-made tofu puffs and fish cakes, as well as generous helpings of velvety chicken...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hong%20Lim%20Market%20and%20Food%20Centre%2C%20%2301-58%2C%20Blk%20531A%2C%20Upper%20Cross%20Street%2C%20051531%2C%20Singapore"
    pageTitle="Heng Kee"
  />
);

export default HengKee;
