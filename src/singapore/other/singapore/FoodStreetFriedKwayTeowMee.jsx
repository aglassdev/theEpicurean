...
const FoodStreetFriedKwayTeowMee = () => (
  <RestaurantPage
    restaurantName="Food Street Fried Kway Teow Mee"
    address="Chinatown Complex Market & Food Centre, #02-173, 335 Smith Street, 050335, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/food-street-fried-kway-teow-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Loaded with wok hei, their kway teow mee is ribbon rice noodles, egg noodles, bean sprouts and scrambled egg tossed in a secret sauce. For toppings, choose clams only, or a mix of seafood with fish, squid, shrimps and clams...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chinatown%20Complex%20Market%20%26%20Food%20Centre%2C%20%2302-173%2C%20335%20Smith%20Street%2C%20050335%2C%20Singapore"
    pageTitle="Food Street Fried Kway Teow Mee"
  />
);

export default FoodStreetFriedKwayTeowMee;
