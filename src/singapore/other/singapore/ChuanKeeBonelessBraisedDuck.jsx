...
const ChuanKeeBonelessBraisedDuck = () => (
  <RestaurantPage
    restaurantName="Chuan Kee Boneless Braised Duck"
    address="20 Ghim Moh Road Market & Food Centre, #01-04, Blk 20, Ghim Moh Road, 270020, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/chuan-kee-boneless-braised-duck"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Juicy and flavoursome braised duck is served with rice, congee, kway teow or noodles, plus optional extras such as duck gizzard, duck liver or marinated egg. The set comes with a bowl of bak kut teh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Ghim%20Moh%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-04%2C%20Blk%2020%2C%20Ghim%20Moh%20Road%2C%20270020%2C%20Singapore"
    pageTitle="Chuan Kee Boneless Braised Duck"
  />
);

export default ChuanKeeBonelessBraisedDuck;
