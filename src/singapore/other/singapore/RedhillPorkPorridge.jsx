...
const RedhillPorkPorridge = () => (
  <RestaurantPage
    restaurantName="Redhill Pork Porridge"
    address="Redhill Market, #01-90, 85 Redhill Lane, 150085, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/redhill-pork-porridge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The porridge may not look exciting but the creamy base is loaded with meaty flavour. Pad it out with sliced pork, pork meatballs, pork liver or deep-fried dough sticks. Crack in a raw egg and stir it into wispy ribbons. Open from 6am while stocks lasts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Redhill%20Market%2C%20%2301-90%2C%2085%20Redhill%20Lane%2C%20150085%2C%20Singapore"
    pageTitle="Redhill Pork Porridge"
  />
);

export default RedhillPorkPorridge;
