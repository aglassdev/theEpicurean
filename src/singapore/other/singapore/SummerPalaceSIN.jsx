...
const SummerPalaceSIN = () => (
  <RestaurantPage
    restaurantName="Summer Palace"
    address="Conrad Orchard, Level 3, 1 Cuscaden Road, 249715, Singapore"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+6567253288"
    ...
    bio="The serene interior is furnished in contemporary Chinese style, in a palette dominated by warm whites and muted tones. On the menu, wok hei-laden stir-fries such as crocodile fillet in brown sauce, and venison with Chinese kale feature alongside Cantonese classics including baked stuffed crab shell, steamed Chinese marrow rings stuffed with shrimp, and spinach and tofu in crabmeat sauce. Be sure to try the exquisitely crafted dim sum, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Conrad%20Orchard%2C%20Level%203%2C%201%20Cuscaden%20Road%2C%20249715%2C%20Singapore"
    pageTitle="Summer Palace"
  />
);

export default SummerPalaceSIN;
