...
const GordonGrill = () => (
  <RestaurantPage
    restaurantName="Gordon Grill"
    address="Goodwood Park Hotel, 22 Scotts Road, 228221, Singapore"
    cuisine="European Contemporary"
    priceRange="$$"
    phoneNumber="+6567301744"
    website="https://www.goodwoodparkhotel.com/dining/gordon-grill"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A feature of Goodwood Park hotel since 1963, the restaurant is famed for its meat trolley service which is wheeled over to each table. Along with the meat and plentiful supplies of seafood from the grill, you can expect French-inspired classic dishes like lobster bisque, braised beef cheek, or Crêpes Suzette flambéed tableside. It’s a good choice for a quiet business lunch, a romantic dinner or weekend family outings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Goodwood%20Park%20Hotel%2C%2022%20Scotts%20Road%2C%20228221%2C%20Singapore"
    pageTitle="Gordon Grill"
  />
);

export default GordonGrill;
