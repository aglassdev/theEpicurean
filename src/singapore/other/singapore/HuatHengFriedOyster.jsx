...
const HuatHengFriedOyster = () => (
  <RestaurantPage
    restaurantName="Huat Heng Fried Oyster"
    address="Whampoa Makan Place, #01-26, 90/91 Whampoa Drive 90, 320091, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/huat-heng-fried-oyster"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The oyster omelette is fried to order until the crust is nicely browned, while the oysters remain plump and juicy. The house-made chilli sauce elevates the dish considerably. Various portion sizes are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Whampoa%20Makan%20Place%2C%20%2301-26%2C%2090%2F91%20Whampoa%20Drive%2090%2C%20320091%2C%20Singapore"
    pageTitle="Huat Heng Fried Oyster"
  />
);

export default HuatHengFriedOyster;
