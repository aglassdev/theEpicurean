...
const ShanyuanTeochewKwayTeowMian = () => (
  <RestaurantPage
    restaurantName="Shanyuan Teochew Kway Teow Mian"
    address="North Bridge Road Market & Food Centre, #01-95, 861 North Bridge Road, 198783, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/shanyuan-teochew-kway-teow-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Get your noodle fix 24/7 at this popular stall. With myriad made-to-order options on the menu – from fish dumplings and minced pork noodles to mee tai mak and kway teow noodle soup – you're spoiled for choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=North%20Bridge%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-95%2C%20861%20North%20Bridge%20Road%2C%20198783%2C%20Singapore"
    pageTitle="Shanyuan Teochew Kway Teow Mian"
  />
);

export default ShanyuanTeochewKwayTeowMian;
