...
const HaiNanXingZhouBeefNoodle = () => (
  <RestaurantPage
    restaurantName="Hai Nan Xing Zhou Beef Noodle"
    address="Kim Keat Palm Market & Food Centre, #01-06, 22 Lorong 7 Toa Payoh, 310022, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hai-nan-xing-zhou-beef-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Choose between blanched rice noodles tossed in a thick gravy, or soup noodles in a deeply flavourful ox bone broth. Then top with sliced beef, beef tripe, tendon, beef balls, or a combination...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kim%20Keat%20Palm%20Market%20%26%20Food%20Centre%2C%20%2301-06%2C%2022%20Lorong%207%20Toa%20Payoh%2C%20310022%2C%20Singapore"
    pageTitle="Hai Nan Xing Zhou Beef Noodle"
  />
);

export default HaiNanXingZhouBeefNoodle;
