...
const Heng = () => (
  <RestaurantPage
    restaurantName="Heng"
    address="Newton Food Centre, #01-28, 500 Clemenceau Avenue North, 229495, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/heng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner has 50+ years-experience serving sweet and savoury carrot cakes. Fried oysters and oyster omelettes are also worth a try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Newton%20Food%20Centre%2C%20%2301-28%2C%20500%20Clemenceau%20Avenue%20North%2C%20229495%2C%20Singapore"
    pageTitle="Heng"
  />
);
