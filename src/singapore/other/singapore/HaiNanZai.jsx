...
const HaiNanZai = () => (
  <RestaurantPage
    restaurantName="Hai Nan Zai"
    address="Chong Pang Market and Food Centre, #01-129, 105 Yishun Ring Road, 760105, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hainan-zi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Singaporean food such as oyster omelettes, fried prawn mee and carrot cakes. Fried kway teow with cockles and Chinese sausage are cooked-to-order...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chong%20Pang%20Market%20and%20Food%20Centre%2C%20%2301-129%2C%20105%20Yishun%20Ring%20Road%2C%20760105%2C%20Singapore"
    pageTitle="Hai Nan Zai"
  />
);

export default HaiNanZai;
