...
const HoeKeeKitchen = () => (
  <RestaurantPage
    restaurantName="Hoe Kee Kitchen"
    address="Jurong West 505 Market & Food Centre, #01-39, Blk 505, Jurong West Street 52, 640505, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hoe-kee-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is always a queue at this popular stall. Steamed chicken rice with tender meat and flavourful rice perfumed with chicken oil is the must-try. Char siew and roasted pork are also good – order a combo of either...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jurong%20West%20505%20Market%20%26%20Food%20Centre%2C%20%2301-39%2C%20Blk%20505%2C%20Jurong%20West%20Street%2052%2C%20640505%2C%20Singapore"
    pageTitle="Hoe Kee Kitchen"
  />
);

export default HoeKeeKitchen;
