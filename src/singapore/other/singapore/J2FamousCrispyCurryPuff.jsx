...
const J2FamousCrispyCurryPuff = () => (
  <RestaurantPage
    restaurantName="J2 Famous Crispy Curry Puff"
    address="Amoy Street Food Centre, #01-21, 7 Maxwell Road, 069111, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6594758425"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/j2-famous-crispy-curry-puff"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The curry puff comes in four flavours, all wrapped in a flaky, crispy pastry crust. As well as the classic chicken and potato curry, try the black pepper chicken, sweet taro or chilli sardine-filled pastry...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amoy%20Street%20Food%20Centre%2C%20%2301-21%2C%207%20Maxwell%20Road%2C%20069111%2C%20Singapore"
    pageTitle="J2 Famous Crispy Curry Puff"
  />
);

export default J2FamousCrispyCurryPuff;
