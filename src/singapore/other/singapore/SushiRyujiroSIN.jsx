...
const SushiRyujiroSIN = () => (
  <RestaurantPage
    restaurantName="Sushi Ryujiro"
    address="Shaw Centre, #01-19, 1 Scotts Road, 228208, Singapore"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+6580281940"
    website="https://www.sushiryujiro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tokyo’s legendary sushi-ya has opened its only overseas outpost in the Lion City. Owned and supervised by chef Ryujiro Nakamura, and helmed by his young protégé, Sushi Ryujiro Singapore offers two omakase menus that include otsumami and edomae nigiri sushi. Japanese rice is dressed in a blend of four red vinegars; most ingredients are also shipped from Japan for authenticity. With only 14 counter seats, reservations are essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shaw%20Centre%2C%20%2301-19%2C%201%20Scotts%20Road%2C%20228208%2C%20Singapore"
    pageTitle="Sushi Ryujiro"
  />
);

export default SushiRyujiroSIN;
