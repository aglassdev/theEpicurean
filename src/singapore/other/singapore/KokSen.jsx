...
const KokSen = () => (
  <RestaurantPage
    restaurantName="Kok Sen"
    address="2/4 Keong Saik Road, 089112, Singapore"
    cuisine="Singaporean"
    priceRange="$$"
    phoneNumber="+6562232005"
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/kok-sen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 50 years, Kok Sen has been feeding hungry diners with cze char classics, such as their stir-fries boasting exceptional wok hei. Look out for the colourful lightboxes with signature items like prawn paste chicken or fish cooked in various ways. Seating may be a bit cramped, but the round tables and green booth seats work well with a grey colour scheme and pale wood. Given the small number of tables, expect to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%2F4%20Keong%20Saik%20Road%2C%20089112%2C%20Singapore"
    pageTitle="Kok Sen"
  />
);

export default KokSen;
