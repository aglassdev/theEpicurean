...
const TianTianHainaneseChickenRice = () => (
  <RestaurantPage
    ...
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/tian-tian-hainanese-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Expect a long queue, but the velvety chicken with springy skin is worth the wait. Even the aromatic oil rice and briny-sweet sauce are perfectly made. Consider ordering half a chicken to share, or an extra drumstick...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maxwell%20Food%20Centre%2C%20%2301-10%2F11%2C%201%20Kadayanallur%20Street%2C%20069184%2C%20Singapore"
    pageTitle="Tian Tian Hainanese Chicken Rice"
  />
);

export default TianTianHainaneseChickenRice;
