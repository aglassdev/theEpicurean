...
const HougangTraditionalFamousWantonNoodle = () => (
  <RestaurantPage
    restaurantName="Hougang Traditional Famous Wanton Noodle"
    address="51 Old Airport Road Food Centre, #01-35, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hougang-traditional-famous-wanton-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The traditional wanton here is generously filled with pork, either blanched and served in noodle soup or deep-fried. The noodles, cooked to order, boast bouncy texture. The yellow shrimp broth is loaded with flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-35%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="Hougang Traditional Famous Wanton Noodle"
  />
);

export default HougangTraditionalFamousWantonNoodle;
