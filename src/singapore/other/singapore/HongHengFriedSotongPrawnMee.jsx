...
const HongHengFriedSotongPrawnMee = () => (
  <RestaurantPage
    restaurantName="Hong Heng Fried Sotong Prawn Mee"
    address="Tiong Bahru Market, #02-01, 30 Seng Poh Road, 168898, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/hong-heng-fried-sotong-prawn-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cooked-to-order, the noodles stir-fried with sliced fish, squid and prawn and served with homemade chilli sauce is a favourite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tiong%20Bahru%20Market%2C%20%2302-01%2C%2030%20Seng%20Poh%20Road%2C%20168898%2C%20Singapore"
    pageTitle="Hong Heng Fried Sotong Prawn Mee"
  />
);

export default HongHengFriedSotongPrawnMee;
