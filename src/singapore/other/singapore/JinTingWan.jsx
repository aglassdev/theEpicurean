...
const JinTingWan = () => (
  <RestaurantPage
    restaurantName="Jin Ting Wan"
    address="Marina Bay Sands Hotel, Tower 1, Level 55, 10 Bayfront Avenue, 018956, Singapore"
    cuisine="Cantonese"
    priceRange="$$$$"
    phoneNumber="+6566889969"
    website="https://www.marinabaysands.com/restaurants/jin-ting-wan.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched atop the iconic Marina Bay Sands Hotel, the room affords gorgeous city and harbour views. Gold trim nicely contrasts with the muted dark blue walls in the Song Dynasty-inspired interior. Chef Albert Li is famous for his refined Cantonese fare, such as roasted pipa duck with black pepper sauce – the bird is deboned, minced and stuffed back into its own skin before being roasted to perfection. The predominantly Chinese wine list includes some rare gems...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marina%20Bay%20Sands%20Hotel%2C%20Tower%201%2C%20Level%2055%2C%2010%20Bayfront%20Avenue%2C%20018956%2C%20Singapore"
    pageTitle="Jin Ting Wan"
  />
);

export default JinTingWan;
