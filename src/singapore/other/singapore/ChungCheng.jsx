...
const ChungCheng = () => (
  <RestaurantPage
    restaurantName="Chung Cheng"
    address="Golden Mile Food Centre, #01-59, 505 Beach Road, 199583, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/chung-cheng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three options feature on the menu of this stall – chilli mee, prawn mee and laksa. Go for chilli mee: yellow egg noodles topped with tangy chilli sauce, pork ribs, prawns, hard-boiled egg, fish cake and tofu puffs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Golden%20Mile%20Food%20Centre%2C%20%2301-59%2C%20505%20Beach%20Road%2C%20199583%2C%20Singapore"
    pageTitle="Chung Cheng"
  />
);

export default ChungCheng;
