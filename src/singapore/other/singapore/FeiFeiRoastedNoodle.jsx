...
const FeiFeiRoastedNoodle = () => (
  <RestaurantPage
    restaurantName="Fei Fei Roasted • Noodle"
    address="Yuhua Village Market and Food Centre, #01-28, Blk 254, Jurong East Street 24, 600254, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/fei-fei-roasted-%E2%80%A2-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popular stall for roasted meat and dumplings. Duck leg with shrimp wonton noodles is recommended. Come early before the food runs out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yuhua%20Village%20Market%20and%20Food%20Centre%2C%20%2301-28%2C%20Blk%20254%2C%20Jurong%20East%20Street%2024%2C%20600254%2C%20Singapore"
    pageTitle="Fei Fei Roasted • Noodle"
  />
);

export default FeiFeiRoastedNoodle;
