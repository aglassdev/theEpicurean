...
const NyonyaChendol = () => (
  <RestaurantPage
    restaurantName="Nyonya Chendol"
    address="Chong Pang Market and Food Centre, #01-162, 105 Yishun Ring Road, 760105, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/nyonya-chendol"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stall specialises in the classic iced dessert chendol. Pandan-flavoured flour jelly, coconut milk and palm sugar syrup impart the right level of sweetness. Extra toppings like red beans or durian are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chong%20Pang%20Market%20and%20Food%20Centre%2C%20%2301-162%2C%20105%20Yishun%20Ring%20Road%2C%20760105%2C%20Singapore"
    pageTitle="Nyonya Chendol"
  />
);

export default NyonyaChendol;
