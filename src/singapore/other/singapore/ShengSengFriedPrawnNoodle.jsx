...
const ShengSengFriedPrawnNoodle = () => (
  <RestaurantPage
    restaurantName="Sheng Seng Fried Prawn Noodle"
    address="Pek Kio Market & Food Centre, #01-40, 41 Cambridge Road, 210041, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/sheng-seng-fried-prawn-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's all about rice vermicelli and egg noodles stir-fried with eggs and seafood. Homemade chili sauce enriches the flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pek%20Kio%20Market%20%26%20Food%20Centre%2C%20%2301-40%2C%2041%20Cambridge%20Road%2C%20210041%2C%20Singapore"
    pageTitle="Sheng Seng Fried Prawn Noodle"
  />
);

export default ShengSengFriedPrawnNoodle;
