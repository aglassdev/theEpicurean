...
const ZhangJiShanghaiLaMianXiaoLongBao = () => (
  <RestaurantPage
    restaurantName="Zhang Ji Shanghai La Mian Xiao Long Bao"
    address="Alexandra Village Food Centre, #01-56, Blk 120 Bukit Merah Lane 1, 150120, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/zhang-ji-shanghai-la-mian-xiao-long-bao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Besides xiao long bao, this busy stall offers an array of Shanghainese food, such as pan fried dumplings, sour and spicy soup. Their pork and chives potstickers are filled to the brim and nicely browned on the bottom...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alexandra%20Village%20Food%20Centre%2C%20%2301-56%2C%20Blk%20120%20Bukit%20Merah%20Lane%201%2C%20150120%2C%20Singapore"
    pageTitle="Zhang Ji Shanghai La Mian Xiao Long Bao"
  />
);

export default ZhangJiShanghaiLaMianXiaoLongBao;
