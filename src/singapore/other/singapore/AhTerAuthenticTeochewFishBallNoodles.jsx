...
const AhTerAuthenticTeochewFishBallNoodles = () => (
  <RestaurantPage
    restaurantName="Ah Ter Authentic Teochew Fish Ball Noodles"
    address="Amoy Street Food Centre, #01-14, 7 Maxwell Road, 069111, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/ah-ter-teochew-fish-ball-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the third generation, this family-run stall is famous for its fish ball noodle soup topped with ground pork, pork liver, seaweed and pork rinds. Pork ribs are simmered for hours resulting in a broth rich in gutsy flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amoy%20Street%20Food%20Centre%2C%20%2301-14%2C%207%20Maxwell%20Road%2C%20069111%2C%20Singapore"
    pageTitle="Ah Ter Authentic Teochew Fish Ball Noodles"
  />
);

export default AhTerAuthenticTeochewFishBallNoodles;
