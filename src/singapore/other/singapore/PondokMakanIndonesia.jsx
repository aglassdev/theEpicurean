...
const PondokMakanIndonesia = () => (
  <RestaurantPage
    restaurantName="Pondok Makan Indonesia"
    address="Albert Centre, #01-123, 270 Queen Street, 180270, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/pondok-makan-indonesia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Among the array of Indonesian food on offer, their grilled-to-order satay stands out in particular. Chicken satay is marinated in turmeric, imparting a mild sweetness; juicy, tender mutton satay is immaculately cooked...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Albert%20Centre%2C%20%2301-123%2C%20270%20Queen%20Street%2C%20180270%2C%20Singapore"
    pageTitle="Pondok Makan Indonesia"
  />
);

export default PondokMakanIndonesia;
