...
const KokaWantonNoodles = () => (
  <RestaurantPage
    restaurantName="Koka Wanton Noodles"
    address="North Bridge Road Market & Food Centre, #01-99, 861 North Bridge Road, 198783, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/koka-wanton-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Barbecue pork with wonton noodles is the signature. Deep-fried pork skin and chillies enrich the flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=North%20Bridge%20Road%20Market%20%26%20Food%20Centre%2C%20%2301-99%2C%20861%20North%20Bridge%20Road%2C%20198783%2C%20Singapore"
    pageTitle="Koka Wanton Noodles"
  />
);

export default KokaWantonNoodles;
