...
const NamSingHokkienFriedMee = () => (
  <RestaurantPage
    restaurantName="Nam Sing Hokkien Fried Mee"
    address="51 Old Airport Road Food Centre, #01-32, 51 Old Airport Road, 390051, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/nam-sing-hokkien-fried-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall has been serving just one item since opening its doors in 1960 – Hokkien fried mee with prawns. The egg noodles and rice vermicelli are tossed in a rich broth made with prawn shells and tomalley to impart deep umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Old%20Airport%20Road%20Food%20Centre%2C%20%2301-32%2C%2051%20Old%20Airport%20Road%2C%20390051%2C%20Singapore"
    pageTitle="Nam Sing Hokkien Fried Mee"
  />
);

export default NamSingHokkienFriedMee;
