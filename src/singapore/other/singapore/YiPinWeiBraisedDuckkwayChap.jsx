...
const YiPinWeiBraisedDuckkwayChap = () => (
  <RestaurantPage
    restaurantName="Yi Pin Wei Braised Duck．Kway Chap"
    address="Tampines Round Market & Food Centre, #01-40, 137 Tampines Street 11, 521137, Singapore"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/singapore-region/singapore/restaurant/yi-pin-wei-braised-duck%EF%BC%8Ekway-chap"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In addition to their signature braised duck, they also serve pork trotter and chitterlings. The kway chap set menu enables you to sample different cuts all at once in a mild herbal broth. The stall also features rice dishes and kway teow...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tampines%20Round%20Market%20%26%20Food%20Centre%2C%20%2301-40%2C%20137%20Tampines%20Street%2011%2C%20521137%2C%20Singapore"
    pageTitle="Yi Pin Wei Braised Duck．Kway Chap"
  />
);

export default YiPinWeiBraisedDuckkwayChap;
