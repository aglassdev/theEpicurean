...
const KengEngKeeBukitMerah = () => (
  <RestaurantPage
    restaurantName="Keng Eng Kee (Bukit Merah)"
    address="Blk 124, #01-136, Bukit Merah Lane 1, 150124, Singapore"
    cuisine="Singaporean"
    priceRange="$"
    phoneNumber="+6562721038"
    website="https://www.kek.com.sg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular cze char restaurant may not be the most conveniently placed, but it does some great dishes, like fried salted egg crab, coffee pork ribs and claypot duck with sea cucumber. The setting and environment are not unlike a hawker centre, although there is a smaller inside area that’s air-conditioned. It provides mostly Hainanese cuisine, along with some Cantonese dishes – the stir-fries are particularly delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blk%20124%2C%20%2301-136%2C%20Bukit%20Merah%20Lane%201%2C%20150124%2C%20Singapore"
    pageTitle="Keng Eng Kee (Bukit Merah)"
  />
);

export default KengEngKeeBukitMerah;
