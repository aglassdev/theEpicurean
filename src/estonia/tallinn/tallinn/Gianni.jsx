...
const Gianni = () => (
  <RestaurantPage
    restaurantName="Gianni"
    address="Jõe 4a, Tallinn, 10151, Estonia"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+37257703161"
    website="https://www.gianni.ee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pop into the café for coffee and cake, or dine in a more cossetted environment in the modern restaurant. The charming team are eager to please and will even skilfully fillet your fish at the table for you. The comprehensive menu offers all the Italian dishes you know and love; the saltimbocca is a highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=J%C3%B5e%204a%2C%20Tallinn%2C%2010151%2C%20Estonia"
    pageTitle="Gianni"
  />
);
