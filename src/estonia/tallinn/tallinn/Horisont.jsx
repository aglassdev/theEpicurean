...
const Horisont = () => (
  <RestaurantPage
    restaurantName="Horisont"
    address="Swissôtel, Tornimäe 3, Tallinn, 10145, Estonia"
    cuisine="Modern Cuisine, European"
    priceRange="€€€"
    phoneNumber="+3726243000"
    website="https://horisontrestoran.ee/meist/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arrive early for an aperitif in the bar, which affords stunning panoramic views towards the harbour from the 30th floor of the smart Swissotel Tallinn hotel. There’s a formal feel to the room, with modern European menus to match; to see the full talents of the kitchen, go for the tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Swiss%C3%B4tel%2C%20Tornim%C3%A4e%203%2C%20Tallinn%2C%2010145%2C%20Estonia"
    pageTitle="Horisont"
  />
);

export default Horisont;
