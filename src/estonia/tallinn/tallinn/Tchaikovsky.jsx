...
const Tchaikovsky = () => (
  <RestaurantPage
    restaurantName="Tchaikovsky"
    address="Hotel Telegraaf, Vene 9, Tallinn, 10123, Estonia"
    cuisine="Modern Cuisine, Russian"
    priceRange="€€€"
    phoneNumber="+3726000610"
    website="https://www.telegraafhotel.com/restaurant-tchaikovsky/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set within the well-known Hotel Telegraaf, in the heart of the Old Town, this glass-roofed restaurant has something of a celebratory feel, courtesy of a beautiful chandelier and walls hung with gilt-framed pictures. To the side of the hotel is its large summer terrace, while at the head of the room a living wall, set behind glass, brings the outside inside year-round. Refined cooking has a classical French base with Russian influences and modern overtones – the Siberian dumplings, which come with the likes of horseradish beurre blanc, are a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Telegraaf%2C%20Vene%209%2C%20Tallinn%2C%2010123%2C%20Estonia"
    pageTitle="Tchaikovsky"
  />
);

export default Tchaikovsky;
