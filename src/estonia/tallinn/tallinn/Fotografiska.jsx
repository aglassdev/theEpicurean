...
const Fotografiska = () => (
  <RestaurantPage
    restaurantName="Fotografiska"
    address="Telliskivi 60a/8, Tallinn, 10412, Estonia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+37257450922"
    website="https://tallinn.fotografiska.com/en/restaurants/fotografiska-restaurant"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Above the Fotografiska photo gallery sits an equally striking restaurant offering picture-perfect views out across the Old Town; be sure to make the most of this by either starting or ending your night with cocktails in the rooftop bar. A concept of ‘Sustainable Pleasure’ leads the way, with a ‘leaf-to-root, nose-to-tail’ ethos and a zero-waste approach leading the way. Organic ingredients that are farmed with ecology in mind are showcased in a highly original selection of assured, understated dishes like rabbit agnolotti or apple pie with chanterelle ice cream. On summer Sundays they offer a themed brunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Telliskivi%2060a%2F8%2C%20Tallinn%2C%2010412%2C%20Estonia"
    pageTitle="Fotografiska"
  />
);

export default Fotografiska;
