...
const ArtPriori = () => (
  <RestaurantPage
    restaurantName="Art Priori"
    address="Olevimägi 7, Tallinn, 10123, Estonia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+37253599895"
    website="https://www.artpriori.ee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the heart of the Old Town, this is a wonderfully elegant, romantic spot, where two striking rooms ooze period charm and an eclectic mix of artwork fills the walls. In contrast, the food is modern and understated. Well-formed dishes give each core ingredient the space to shine, with unadulterated flavours fitting together seamlessly. You might find earthy yellow beetroot paired with soft goat’s cheese or wonderfully mature venison with a silky celeriac purée. Friendly service and a great choice of cocktails and wines by the glass finishes things off perfectly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Olevim%C3%A4gi%207%2C%20Tallinn%2C%2010123%2C%20Estonia"
    pageTitle="Art Priori"
  />
);

export default ArtPriori;
