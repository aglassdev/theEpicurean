...
const MantelJaKorsten = () => (
  <RestaurantPage
    restaurantName="Mantel ja Korsten"
    address="Poska 19a, Tallinn, 10216, Estonia"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+3726659555"
    website="https://mantel-korsten.ee/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A residential neighbourhood just outside the city centre plays host to this sweet little house with light turquoise clapboard walls and a bright red roof. Its name means ‘mantel and chimney’ and, fittingly, a green-tiled fireplace and mantel take centre stage in a room furnished with striking wallpapers and bold soft furnishings. Flavoursome dishes have an honest heart and could include goat’s cheese with beer chutney, beetroot and orange or gnocchi with chorizo, sun-dried tomatoes, pine nuts and bechamel sauce. The well-chosen wines have an organic and biodynamic bias, and service is endearing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Poska%2019a%2C%20Tallinn%2C%2010216%2C%20Estonia"
    pageTitle="Mantel ja Korsten"
  />
);

export default MantelJaKorsten;
