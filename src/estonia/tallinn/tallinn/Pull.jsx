...
const Pull = () => (
  <RestaurantPage
    restaurantName="Pull"
    address="Rotermanni 2, Tallinn, 10111, Estonia"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+37253825000"
    website="https://resto.pull.ee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within the rejuvenated pre-war industrial area of the ‘Rotermann Factories’ sits an impressive 19th-century grain elevator and, inside that, this fittingly rustic restaurant proudly displaying exposed stone walls and concrete pillars amongst other original features. At dinner, the wide-ranging menu of generously proportioned Estonian dishes focuses largely on meats and steaks from the charcoal grill – including their signature 'Dirty Steak' – while at lunchtime nearly everyone is here for their great value dish of the day. A good range of alcoholic and non-alcoholic drinks accompanies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rotermanni%202%2C%20Tallinn%2C%2010111%2C%20Estonia"
    pageTitle="Pull"
  />
);
