...
const R14 = () => (
  <RestaurantPage
    restaurantName="R14"
    address="Rotermanni 14, Tallinn, 10111, Estonia"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+37258558120"
    website="https://r14.ee/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The impressive 19C stone-built powerplant of the Rotermann factories is now a wine-shop-cum-wine-bar with a rustic, laid-back vibe, where a glass-walled wine cellar takes centre stage. Good value, unfussy Mediterranean dishes have a leaning towards Italy; come on a Sunday if you’re a fan of brunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rotermanni%2014%2C%20Tallinn%2C%2010111%2C%20Estonia"
    pageTitle="R14"
  />
);
