...
const OsteriaIlCru = () => (
  <RestaurantPage
    restaurantName="Osteria il Cru"
    address="Hotel Cru, Viru 8, Tallinn, 10104, Estonia"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3726140085"
    website="https://www.crurestoran.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spread between the basement and the ground floor of a small hotel in the Old Town, CRU has been reborn as Osteria il Cru – and both its new name and the olive tree at the centre of the cosy room give a good indication of its new direction. Head Chef Ivari Vokk leads a newly formed kitchen team in creating Italian dishes that exhibit all the flavours you know and love, enhanced by a few personal twists. The extensive menu represents good value and offers plenty of choice, including the likes of spinach and ricotta stuffed zucchini flowers, parmigiana di melanzane and delicious homemade pastas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Cru%2C%20Viru%208%2C%20Tallinn%2C%2010104%2C%20Estonia"
    pageTitle="Osteria il Cru"
  />
);

export default OsteriaIlCru;
