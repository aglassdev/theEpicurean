...
const Koyo = () => (
  <RestaurantPage
    restaurantName="Koyo"
    address="The Burman Hotel, Dunkri 8, Tallinn, 10123, Estonia"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+3726188830"
    website="https://koyo.theburmanhotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kazuto Hokari relocated from Japan to open this restaurant and share his love of his native cuisine. 11 bright-red upholstered seats skirt an L-shaped counter in the stylish dining room, where Kazuto serves his omakase menu to two sittings of guests each evening. Sushi is the main event, with the eel and akami tuna particular highlights and also a favourite of the chef himself. He fully guides guests through the menu in an informative and personable way, and service is professional and engaging all-round. A concise but carefully selected range of wines, champagnes and sakes complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Burman%20Hotel%2C%20Dunkri%208%2C%20Tallinn%2C%2010123%2C%20Estonia"
    pageTitle="Koyo"
  />
);
