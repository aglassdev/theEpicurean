...
const ShangShi = () => (
  <RestaurantPage
    restaurantName="Shang Shi"
    address="The Burman Hotel, Rataskaevu 5, Tallinn, 10123, Estonia"
    cuisine="Cantonese"
    priceRange="€€"
    phoneNumber="+3726188840"
    website="https://shangshi.bombayclub.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name, ‘Royal Feast’, gives a good indication as to what to expect here. The understatedly elegant interior dreamed up by Macanese designers creates a calming setting in which to enjoy luxurious ingredients such as King crab from Norway and abalone from South Africa – and then there’s the house speciality, Peking duck, which is carved at the table, where you’re given the option to add Beluga caviar! The wine and cocktail list is one of the most impressive in the city, while the cellar bar, Fox Den, specialises in whisky. If you really want to make a night of it, finish up in The Bombay Club casino...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Burman%20Hotel%2C%20Rataskaevu%205%2C%20Tallinn%2C%2010123%2C%20Estonia"
    pageTitle="Shang Shi"
  />
);

export default ShangShi;
