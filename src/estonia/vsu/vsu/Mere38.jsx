...
const Mere38 = () => (
  <RestaurantPage
    restaurantName="Mere 38"
    address="Mere 38, Võsu, 45501, Estonia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+37257877009"
    website="https://www.mere38.ee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a quiet village, this green-painted wooden house boasts both a fashionable New England style restaurant and smart apartments. It has a cosy dining room with fleece-covered chairs, as well as a lovely summer terrace. Dishes are largely Mediterranean influenced and are vibrant and full of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mere%2038%2C%20V%C3%B5su%2C%2045501%2C%20Estonia"
    pageTitle="Mere 38"
  />
);

export default Mere38;
