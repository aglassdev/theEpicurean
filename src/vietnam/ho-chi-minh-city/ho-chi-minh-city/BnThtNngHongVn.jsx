...
const BnThtNngHongVn = () => (
  <RestaurantPage
    restaurantName="Bún Thịt Nướng Hoàng Văn"
    address="137 Chan Hung Street, Ward 6, Tan Binh District, Ho Chi Minh City, 736090, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84708688445"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/bun-thit-nuong-hoang-van"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is only one item on the menu – rice noodles in a tangy sweet dressing with a spring roll, grilled pork, lettuce, bean sprouts, cucumber, carrot, peanuts and scallion. The contrasting textures and flavours are magical...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=137%20Chan%20Hung%20Street%2C%20Ward%206%2C%20Tan%20Binh%20District%2C%20Ho%20Chi%20Minh%20City%2C%20736090%2C%20Vietnam"
    pageTitle="Bún Thịt Nướng Hoàng Văn"
  />
);

export default BnThtNngHongVn;
