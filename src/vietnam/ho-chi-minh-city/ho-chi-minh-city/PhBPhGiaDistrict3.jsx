...
const PhBPhGiaDistrict3 = () => (
  <RestaurantPage
    restaurantName="Phở Bò Phú Gia (District 3)"
    address="146E Ly Chinh Thang Street, Ward 14, District 3, Ho Chi Minh City, 722700, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84942848268"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-bo-phu-gia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop specialises in beef noodle soup – choose between sliced beef, brisket, or both. As opposed to raw beef instantly blanched in the hot broth, its signature phở tái lăn is topped with wok-seared garlic beef, alongside heaps of chopped scallion, onion and coriander that impart rich aromas. If you fancy the brisket, we recommend the phở dặc biệt. For a different texture, dip the fried dough sticks into the broth before sampling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=146E%20Ly%20Chinh%20Thang%20Street%2C%20Ward%2014%2C%20District%203%2C%20Ho%20Chi%20Minh%20City%2C%20722700%2C%20Vietnam"
    pageTitle="Phở Bò Phú Gia (District 3)"
  />
);

export default PhBPhGiaDistrict3;
