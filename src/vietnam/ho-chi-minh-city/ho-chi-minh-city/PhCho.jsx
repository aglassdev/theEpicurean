...
const PhCho = () => (
  <RestaurantPage
    restaurantName="Phở Chào"
    address="52 Nguyen Cong Tru Street, Ward 19, Binh Thanh District, Ho Chi Minh City, 72323, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84902701208"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-chao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite expanding, Phở Chào has lost none of street-side charm. Choose between a rich three-day beef-bone stock and chicken broth. Top dishes include phở bắp hoa with medium-rare beef, crispy fried chicken gà tôm mắm sốt, and phở tine – a fusion of beef noodle soup, French fries and cheese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20Nguyen%20Cong%20Tru%20Street%2C%20Ward%2019%2C%20Binh%20Thanh%20District%2C%20Ho%20Chi%20Minh%20City%2C%2072323%2C%20Vietnam"
    pageTitle="Phở Chào"
  />
);

export default PhCho;
