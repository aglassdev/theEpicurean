...
const TimCmThChuynK = () => (
  <RestaurantPage
    restaurantName="Tiệm Cơm Thố Chuyên Ký"
    address="67 Ton That Dam Street, Ben Nghe Ward, District 1, Ho Chi Minh City, 70000, Vietnam"
    cuisine="Cantonese"
    priceRange="₫"
    phoneNumber="+842838290150"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/tiem-com-tho-chuyen-ky"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the third generation, this simple shop prides itself on its double-boiled silkie chicken soup, which it has been making the same way since it opened in 1948. The flavoursome clear broth is MSG-free, with mild aromas of Chinese herbs. Another must-try is their steamed rice bowl with beef, chicken or Cantonese preserved pork sausage. Seafood cooked in various ways is also popular. Check with the owner for recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20Ton%20That%20Dam%20Street%2C%20Ben%20Nghe%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%2070000%2C%20Vietnam"
    pageTitle="Tiệm Cơm Thố Chuyên Ký"
  />
);

export default TimCmThChuynK;
