...
const PhHongNguyenTriPhuongStreet = () => (
  <RestaurantPage
    restaurantName="Phở Hoàng (Nguyen Tri Phuong Street)"
    address="460 Nguyen Tri Phuong Street, Vuon Lai Ward, Ho Chi Minh City, 740500, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842839271390"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-hoang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This phở shop has been around since 2008 and the owner Mr Hoang is justly proud of his clear beef broth that takes over 12 hours to make. Feel free to customise your beef noodle soup by ordering tendon, flank, minced beef or even a raw egg on the side. Every bowl comes with garnishes like coriander, basil, lime wedges and onions. For drinks, try their monk fruit herbal tea made with over 10 different herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=460%20Nguyen%20Tri%20Phuong%20Street%2C%20Vuon%20Lai%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20740500%2C%20Vietnam"
    pageTitle="Phở Hoàng (Nguyen Tri Phuong Street)"
  />
);

export default PhHongNguyenTriPhuongStreet;
