...
const CLing = () => (
  <RestaurantPage
    restaurantName="Cô Liêng"
    address="321 Vo Van Tan Street, Ban Co Ward, Ho Chi Minh City, 72407, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84903789487"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/co-lieng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in 1995, Cô Liêng serves up a modest take on Southern Vietnamese cuisine. The main draw is the charcoal-grilled bò lá lốt (minced beef wrapped in betel leaves) that features perfect savoury-sweet flavour. They also serve rice vermicelli bundles (bánh hỏi with grilled meat)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=321%20Vo%20Van%20Tan%20Street%2C%20Ban%20Co%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%2072407%2C%20Vietnam"
    pageTitle="Cô Liêng"
  />
);
