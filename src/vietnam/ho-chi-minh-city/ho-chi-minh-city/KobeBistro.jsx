...
const KobeBistro = () => (
  <RestaurantPage
    restaurantName="Kobe Bistro"
    address="23C Ton Duc Thang Street, Ben Nghe Ward, District 1, Ho Chi Minh City, 710000, Vietnam"
    cuisine="French Contemporary"
    priceRange="₫₫"
    phoneNumber="+842836224999"
    website="https://www.facebook.com/share/1Aab6V9pzd/?mibextid=wwXIfr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner-chef David Thai spent time in France, together with stints in Dubai, Spain and various Asian countries. Formerly a Japanese produce trader and culinary consultant, he makes the most of his connections and expertise in this bistro. On top of French classics such as bouillabaisse and duck leg confit, the menu also features a line-up of marbled Kobe Wagyu steaks, including Bushu Oguma A4 and Satsuma A5+, served with a range of sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23C%20Ton%20Duc%20Thang%20Street%2C%20Ben%20Nghe%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20710000%2C%20Vietnam"
    pageTitle="Kobe Bistro"
  />
);

export default KobeBistro;
