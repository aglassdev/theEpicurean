...
const StokerDistrict1 = () => (
  <RestaurantPage
    restaurantName="Stoker (District 1)"
    address="44 Mac Thi Buoi Street, Sai Gon Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Steakhouse"
    priceRange="₫₫₫"
    phoneNumber="+84907292725"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/stoker-district-1"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The three-storey restaurant has a bar and counter seats around an open kitchen on the ground floor, while upstairs, heavy leather chairs, dark wood wainscoting and antler chandeliers evoke classic steakhouse vibes. Grass-fed and grain-fed beef steaks are the house specialities, especially those dry-aged for over 21 days. The creamy mashed potato cooked over a wood fire is rich in smoky flavour. Round it off with your favourite whisky...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Mac%20Thi%20Buoi%20Street%2C%20Sai%20Gon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Stoker (District 1)"
  />
);

export default StokerDistrict1;
