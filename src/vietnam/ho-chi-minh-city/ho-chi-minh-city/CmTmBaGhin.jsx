...
const CmTmBaGhin = () => (
  <RestaurantPage
    ...
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842838461073"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/com-tam-ba-ghien"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since the 1990s, this unassuming stall has been serving what many locals consider to be the best cơm tấm (broken rice dish) in town. Their most popular version is steamed broken rice topped with pork chop marinated in a secret sauce and perfectly grilled over charcoal, along with pickled radish and sweet and sour fish sauce. There is a chicken version as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=84%20Dang%20Van%20Ngu%20Street%2C%20Ward%2010%2C%20Phu%20Nhuan%20District%2C%20Ho%20Chi%20Minh%20City%2C%20725000%2C%20Vietnam"
    pageTitle="Cơm Tấm Ba Ghiền"
  />
);

export default CmTmBaGhin;
