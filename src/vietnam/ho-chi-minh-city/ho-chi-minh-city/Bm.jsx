...
const Bm = () => (
  <RestaurantPage
    restaurantName="Bờm"
    address="24 Nguyen Thi Nghia Street, Ben Thanh Ward, District 1, Ho Chi Minh City, 71009, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫"
    phoneNumber="+84823999980"
    website="https://bomkitchen.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bờm's ambience and cuisine conjure up a fairy tale-like nostalgia for Vietnamese diners. In a chic, low-lit venue combining traditional bamboo with minimalist cement elements, the modern, refined Vietnamese cuisine ticks all the boxes. Try the bò kho tart – tender braised beef encased in flaky puff pastry – and the signature Bờm Set, comprising bite-size shrimp fritters, snail cakes and fishcakes. Mè đen, a mochi with a black sesame filling, provides a sweet finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Nguyen%20Thi%20Nghia%20Street%2C%20Ben%20Thanh%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%2071009%2C%20Vietnam"
    pageTitle="Bờm"
  />
);
