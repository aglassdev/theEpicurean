...
const XiGNumberOne = () => (
  <RestaurantPage
    restaurantName="Xôi Gà Number One"
    address="15 Nguyen Trung Truc Street, Ben Thanh Ward, District 1, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84908265767"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/xoi-ga-number-one"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On a street corner near Ben Thanh market, this shop has only two dishes on the menu: xôi gà (sticky chicken rice with egg, chicken offal and gravy); and xôi bắp (sticky sweet corn rice with sugar and lard). Both are delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Nguyen%20Trung%20Truc%20Street%2C%20Ben%20Thanh%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Xôi Gà Number One"
  />
);

export default XiGNumberOne;
