...
const BKhoGnh = () => (
  <RestaurantPage
    restaurantName="Bò Kho Gánh"
    address="029 Lot H, Ngo Gia Tu Apartment, Su Van Hanh Street, Ward 2, District 10, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84937828984"
    website="https://www.bokhoganh.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its famous beef stew known as bò kho is served in a stone bowl. Diners may choose to pair it with bread, noodles or rice. The broth is sweet and tasty, with a robust meaty flavour. Help yourself to condiments and sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=029%20Lot%20H%2C%20Ngo%20Gia%20Tu%20Apartment%2C%20Su%20Van%20Hanh%20Street%2C%20Ward%202%2C%20District%2010%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Bò Kho Gánh"
  />
);

export default BKhoGnh;
