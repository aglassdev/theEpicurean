...
const NhT = () => (
  <RestaurantPage
    restaurantName="Nhà Tú"
    address="129/4 Vo Van Tan Street, Vo Thi Sau Ward, District 3, Ho Chi Minh City, 722700, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+842839305069"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/nha-tu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An oasis amid the hustle and bustle of the city, Nhà Tú is depicted by green plants and a nostalgic vibe with the bonus of a lovely top-floor balcony. In terms of food, the owner captures the essence of his childhood with home-style cooking rarely found elsewhere. Steamed snails stuffed with minced pork seduces with umami and lemongrass fragrance. Mixed veggies dressed in a fish sauce reduction with pork crackling are simple, but addictive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=129%2F4%20Vo%20Van%20Tan%20Street%2C%20Vo%20Thi%20Sau%20Ward%2C%20District%203%2C%20Ho%20Chi%20Minh%20City%2C%20722700%2C%20Vietnam"
    pageTitle="Nhà Tú"
  />
);
