...
const COanh = () => (
  <RestaurantPage
    ...
    address="534 Vinh Khanh Street, Ward 8, District 4, Ho Chi Minh City, 754000, Vietnam"
    cuisine="Street Food"
    priceRange="₫₫"
    phoneNumber="+84937916159"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/oc-oanh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This joint on a busy street serves a range of seafood cooked in countless ways. Whelks, tiger prawns, lobster, octopus, crab… the choice is yours. The authentic outdoor vibe more than makes up for the lack of air conditioning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=534%20Vinh%20Khanh%20Street%2C%20Ward%208%2C%20District%204%2C%20Ho%20Chi%20Minh%20City%2C%20754000%2C%20Vietnam"
    pageTitle="Ốc Oanh"
  />
);

export default COanh;
