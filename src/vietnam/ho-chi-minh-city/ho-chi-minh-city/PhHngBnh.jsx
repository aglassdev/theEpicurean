...
const PhHngBnh = () => (
  <RestaurantPage
    restaurantName="Phở Hương Bình"
    address="148 Vo Thi Sau Street, Ward 8, District 3, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84788897777"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-huong-binh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1958, this humble stall has been serving phở – Vietnam's national rice noodle soup. Now led by the second generation, it offers phở gà and phở bò with extra toppings such as chicken skin, egg yolk, brisket and tendon. The broth is freshly made daily – clear, light and savoury-sweet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=148%20Vo%20Thi%20Sau%20Street%2C%20Ward%208%2C%20District%203%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Phở Hương Bình"
  />
);

export default PhHngBnh;
