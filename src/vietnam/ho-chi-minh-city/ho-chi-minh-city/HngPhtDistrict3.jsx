...
const HngPhtDistrict3 = () => (
  <RestaurantPage
    restaurantName="Hồng Phát (District 3)"
    address="389-391 Vo Van Tan Street, Ward 5, District 3, Ho Chi Minh City, 70000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842838390187"
    website="https://hutieuhongphat.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The meeting of Chaozhou and Khmer cultures gave rise to Hủ tiếu hồng phát noodles. The chả giò tôm cua (shrimp and crab spring rolls) and sủi cảo chiên (fried shrimp and pork dumplings) are great appetisers. The soft rice noodle soup comes with minced meat, liver, tiger shrimps or braised blood curd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=389-391%20Vo%20Van%20Tan%20Street%2C%20Ward%205%2C%20District%203%2C%20Ho%20Chi%20Minh%20City%2C%2070000%2C%20Vietnam"
    pageTitle="Hồng Phát (District 3)"
  />
);

export default HngPhtDistrict3;
