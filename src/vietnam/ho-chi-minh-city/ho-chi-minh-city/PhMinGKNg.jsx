...
const PhMinGKNg = () => (
  <RestaurantPage
    restaurantName="Phở Miến Gà Kỳ Đồng"
    address="14/5 Bis Ky Dong Street, Ward 9, District 3, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842838435630"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-mien-ga-ky-%C4%91ong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this true gem in the bustling city, the chicken phở is nothing short of amazing. The essence of its deliciousness lies in the rich, aromatic broth, made by slow-cooking chicken and pork bones for 3-4 hours. The tender chicken slices and rice vermicelli are also divine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%2F5%20Bis%20Ky%20Dong%20Street%2C%20Ward%209%2C%20District%203%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Phở Miến Gà Kỳ Đồng"
  />
);

export default PhMinGKNg;
