...
const PhVitNamDistrict1 = () => (
  <RestaurantPage
    restaurantName="Phở Việt Nam (District 1)"
    address="14 Pham Hong Thai Street, Ben Thanh Ward, District 1, Ho Chi Minh City, 71009, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84902682214"
    website="https://phovietnam.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is one of the more recent outlets of the phở chain, which prides itself on its rice ribbon noodles made from scratch. Besides the habitual raw beef and beef balls, specific cuts such as beef shank, flank, oxtail and ribs render different textures and flavours. Every noodle soup comes with herbs, bean sprouts, onion and lime wedges. If you prefer your food piping hot right down to the last mouthful, order phở thố đá (phở in a hot rock bowl)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Pham%20Hong%20Thai%20Street%2C%20Ben%20Thanh%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%2071009%2C%20Vietnam"
    pageTitle="Phở Việt Nam (District 1)"
  />
);

export default PhVitNamDistrict1;
