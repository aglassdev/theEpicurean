...
const TheMonkeyGalleryDining = () => (
  <RestaurantPage
    restaurantName="The Monkey Gallery Dining"
    address="3F, 91 Mac Thi Buoi Street, Saigon Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫₫₫"
    phoneNumber="+84793991992"
    website="https://monkeygallery.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three wise founders, all born in the year of the monkey, have thoughtfully designed this relaxed gallery with a minimalist, Japanese-influenced decor, in which the food takes centre stage. The result is a lovely ambience that is perfect for social gatherings. A concrete dining counter faces the open kitchen where the young kitchen team uses modern European cooking techniques. Pick from a selection of dishes for each of the four courses, then choose your drink pairing from the creative list of cocktails and mocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2091%20Mac%20Thi%20Buoi%20Street%2C%20Saigon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="The Monkey Gallery Dining"
  />
);

export default TheMonkeyGalleryDining;
