...
const ByTung = () => (
  <RestaurantPage
    restaurantName="Å by T.U.N.G"
    address="31-33 Dang Dung Street, Tan Dinh Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Innovative"
    priceRange="₫₫₫"
    phoneNumber="+84982808533"
    website="https://www.abytung.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a ceiling mural of the Northern Lights, the airy dining space is a nod to chef Tung’s stint in Finland. On entering, diners first catch sight of the open kitchen before they are greeted by the chefs. Only one multi-course tasting menu is offered, and it changes every three months in line with the seasons. Chef Tung’s small plates are creative and original, paying tribute to Vietnamese food culture in terms of ingredients, flavours and techniques...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31-33%20Dang%20Dung%20Street%2C%20Tan%20Dinh%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Å by T.U.N.G"
  />
);

export default ByTung;
