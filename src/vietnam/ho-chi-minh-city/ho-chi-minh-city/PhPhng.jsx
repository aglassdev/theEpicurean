...
const PhPhng = () => (
  <RestaurantPage
    restaurantName="Phở Phượng"
    address="25 Hoang Sa Street, Sai Gon Ward, Ho Chi Minh City, 71007, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842839102422"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-phuong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Each bowl of phở is prepared with the utmost care. The herb garnishes are carefully trimmed and cleaned for ultimate freshness. The house special is a selection of beef cuts. The standout is the oxtail, which is braised for 40 hours until tender and has a delightfully gelatinous finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Hoang%20Sa%20Street%2C%20Sai%20Gon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%2071007%2C%20Vietnam"
    pageTitle="Phở Phượng"
  />
);

export default PhPhng;
