...
const SolKitchenBarDistrict1 = () => (
  <RestaurantPage
    restaurantName="Sol Kitchen & Bar (District 1)"
    address="112 Ly Tu Trong Street, Ben Thanh Ward, District 1, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Latin American"
    priceRange="₫₫"
    phoneNumber="+84799991811"
    website="https://solkitchenbar.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A relaxed vibe provides the perfect foil to Latin-American recipes crafted by Adrian Chong Yen, a Malaysian chef who worked in Singapore for 12 years. His à la carte menu is eclectic and appetising, featuring empanadas from Mexico, scallop ceviche from Peru and burrata salad from Italy. Sol is also famous for its red meat, including marinated steak served with chimichurri sauce, BBQ ribs glazed with fish sauce, and whole roasted chicken served with mojo sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%20Ly%20Tu%20Trong%20Street%2C%20Ben%20Thanh%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Sol Kitchen & Bar (District 1)"
  />
);

export default SolKitchenBarDistrict1;
