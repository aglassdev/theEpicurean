...
const Lai = () => (
  <RestaurantPage
    restaurantName="Lai"
    address="28F, Sedona Suites, 92-94 Nam Ky Khoi Nghia Street, Sai Gon Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Cantonese"
    priceRange="₫₫₫"
    phoneNumber="+84903116038"
    website="https://laivn.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bringing 30 years' experience to the table, the Malaysian-born chef has worked in six major cities across Asia. The interior is done out in traditional Chinese décor featuring modern paintings and flowers. The menu combines classical Cantonese with contemporary elements and a twist of southern Asian in a creative presentation. Be sure to try the há cảo thủy tinh (crystal shrimp dumpling) and the xá xíu ướp thao được quay kieu 'truyền thống' (traditional roasted pork belly with herbs)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28F%2C%20Sedona%20Suites%2C%2092-94%20Nam%20Ky%20Khoi%20Nghia%20Street%2C%20Sai%20Gon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Lai"
  />
);
