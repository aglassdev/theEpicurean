...
const CocoDining = () => (
  <RestaurantPage
    restaurantName="Coco Dining"
    address="143 Nam Ky Khoi Nghia Street, Xuan Hoa Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Innovative"
    priceRange="₫₫₫"
    phoneNumber="+84969730660"
    website="https://cocosgn.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This chic establishment, part of CoCo Saigon, boasts a whisky bar, a private party villa, and a stylish dining room with a kitchen counter and black granite tables. Chef Thanh Vuong Vo presents contemporary cuisine that blends Vietnamese recipes with creative flair. A seasonal tasting menu is built around a unique theme, offering a culinary journey through thoughtfully crafted dishes. Each course follows a storyline that unfolds gradually, with flavours designed to complement one another in perfect balance. While the set menu provides a comprehensive dining experience, the à la carte menu is also a great option. It is served in the adjacent dining room, CoCo Grill, which features an open kitchen and a more casual atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=143%20Nam%20Ky%20Khoi%20Nghia%20Street%2C%20Xuan%20Hoa%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Coco Dining"
  />
);

export default CocoDining;
