...
const PhLDistrict5 = () => (
  <RestaurantPage
    restaurantName="Phở Lệ (District 5)"
    address="413-415 Nguyen Trai Street, Ward 7, District 5, Ho Chi Minh City, 749741, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84908130100"
    website="https://www.phole.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Phở Lệ has been serving authentic Southern Vietnamese phở for over 70 years. Despite its age, the bustling stall remains popular among locals for its bold flavours and generous portions. The mixed beef noodles feature raw and cooked beef, brisket, beef balls and tendon and a rich bone broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=413-415%20Nguyen%20Trai%20Street%2C%20Ward%207%2C%20District%205%2C%20Ho%20Chi%20Minh%20City%2C%20749741%2C%20Vietnam"
    pageTitle="Phở Lệ (District 5)"
  />
);

export default PhLDistrict5;
