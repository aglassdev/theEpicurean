...
const PhMinh = () => (
  <RestaurantPage
    restaurantName="Phở Minh"
    address="63/6 Pasteur Street, Sai Gon Ward, Ho Chi Minh City, 710000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842838220345"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/pho-minh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It may be tucked away down a narrow alley, but Phở Minh has been attracting hungry Saigonese with its traditional beef noodle soup since 1945. Choose between beef tenderloin, brisket and a variety of different cuts available on the day. With its flaky puff pastry and piping-hot meat filling, their freshly baked pâté chaud is a must. They close at 10am, so come early before the food runs out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=63%2F6%20Pasteur%20Street%2C%20Sai%20Gon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20710000%2C%20Vietnam"
    pageTitle="Phở Minh"
  />
);

export default PhMinh;
