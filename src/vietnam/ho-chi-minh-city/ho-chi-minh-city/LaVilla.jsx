...
const LaVilla = () => (
  <RestaurantPage
    ...
    address="14 Ngo Quang Huy Street, An Khanh Ward, Ho Chi Minh City, 700000, Vietnam"
    cuisine="French"
    priceRange="₫₫₫₫"
    phoneNumber="+842838982082"
    website="https://lavilla-restaurant.com.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The culinary Gallic line-up whisks you back to the 1960s with duck foie gras, pâté en croûte, lobster à l'américaine and Grand Marnier soufflé. Decorated with artwork, red velvet curtains and a stunning chandelier, La Villa also offers al fresco dining in the garden. Attentive, suitably formal service, a fine wine list and cheese selection. The starched classical vibe of this restaurant will appeal to those who appreciate vintage charm and nostalgia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Ngo%20Quang%20Huy%20Street%2C%20An%20Khanh%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="La Villa"
  />
);
