...
const BnBHu14b = () => (
  <RestaurantPage
    restaurantName="Bún Bò Huế 14B"
    address="14B Street 46, Ward 2, District 4, Ho Chi Minh City, 754000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84963933081"
    website="https://guide.michelin.com/en/ho-chi-minh/ho-chi-minh_2978179/restaurant/bun-bo-hue-14b"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This take-out only stall specialises in noodle soup topped with sliced beef, beef tendon and fish fillet. The broth made with onion, beef and pork bones is flavoursome. Add bean sprouts, chilli, lime and fish sauce according to your taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14B%20Street%2046%2C%20Ward%202%2C%20District%204%2C%20Ho%20Chi%20Minh%20City%2C%20754000%2C%20Vietnam"
    pageTitle="Bún Bò Huế 14B"
  />
);

export default BnBHu14b;
