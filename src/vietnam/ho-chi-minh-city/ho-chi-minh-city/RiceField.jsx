...
const RiceField = () => (
  <RestaurantPage
    restaurantName="Rice Field"
    address="2F, 75-77 Ho Tung Mau Street, Ben Nghe Ward, District 1, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84906938636"
    website="https://www.ricefield.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spread over three storeys, this delightful venue with an open-air rooftop boasts a rustic décor inspired by local villages and rice fields and serves Vietnamese dishes from the north to the south. The stuffed snails with meat cooked with lemongrass and paired with ginger fish sauce, are succulent, while La Vong fishcakes strike the perfect balance combining vermicelli, marinated fish, fresh Vietnamese vegetables and herbs, shrimp paste sauce and rice paper sheets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2075-77%20Ho%20Tung%20Mau%20Street%2C%20Ben%20Nghe%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Rice Field"
  />
);
