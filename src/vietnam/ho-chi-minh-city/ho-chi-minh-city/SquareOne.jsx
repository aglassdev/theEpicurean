...
const SquareOne = () => (
  <RestaurantPage
    restaurantName="Square One"
    address="2 Lam Son Square, Ben Nghe Ward, District 1, Ho Chi Minh City, 700000, Vietnam"
    cuisine="International"
    priceRange="₫₫₫"
    phoneNumber="+842835202359"
    website="https://www.saigon.park.hyattrestaurants.com/square-one.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With stints all over Europe, including prestigious establishments in France, chef Arnaud delivers a unique dining experience by seamlessly switching between Vietnamese and French recipes. Dishes boast balanced flavours and artful plating, befitting the stylish dining room clad in wood and brick. Generous portion sizes are intended to share and ideal for get-togethers. The dramatically visible kitchens make a meal here entertaining and engaging...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Lam%20Son%20Square%2C%20Ben%20Nghe%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Square One"
  />
);
