...
const HoaTcDistrict1 = () => (
  <RestaurantPage
    restaurantName="Hoa Túc (District 1)"
    address="74/7 Hai Ba Trung Street, Ben Nghe Ward, District 1, Ho Chi Minh City, 700000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+842838251676"
    website="https://hoatuc.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Remodelled from an old opium refinery, Hoa Túc boasts an al fresco dining area steeped in an early 1900s circa Parisian vibe, while the Colonial-style interior pays homage to Vietnam’s history. On the menu, traditional Vietnamese dishes are updated thanks to fancy presentations. Start with refreshing pink pomelo salad with crabmeat and shrimps, followed by bò lá lốt bánh hỏi (grilled beef wrapped in betel leaves on a rice noodle nest)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%2F7%20Hai%20Ba%20Trung%20Street%2C%20Ben%20Nghe%20Ward%2C%20District%201%2C%20Ho%20Chi%20Minh%20City%2C%20700000%2C%20Vietnam"
    pageTitle="Hoa Túc (District 1)"
  />
);

export default HoaTcDistrict1;
