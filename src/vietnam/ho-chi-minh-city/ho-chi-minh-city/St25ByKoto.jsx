...
const St25ByKoto = () => (
  <RestaurantPage
    restaurantName="ST25 by KOTO"
    address="2F, Sofitel Saigon Plaza, 17 Le Duan Boulevard, Saigon Ward, Ho Chi Minh City, 70000, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫"
    phoneNumber="+842838241555"
    website="https://sofitel-saigon-plaza.com/restaurants-bars/st25-by-koto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="ST25, named after ST25 rice, was founded by Jimmy Pham Am to provide opportunities for disadvantaged youth in the industry. The bright space, with its warm décor, features live cooking stations for appetisers, adding a dynamic touch. The menu includes several rice-based dishes. Recommended options include the crispy rice cracker with silken tofu cream and eggplant, as well as the tender slipper lobster paired with a creamy, spiced sauce. Unique cocktails are crafted using ST25 rice wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Sofitel%20Saigon%20Plaza%2C%2017%20Le%20Duan%20Boulevard%2C%20Saigon%20Ward%2C%20Ho%20Chi%20Minh%20City%2C%2070000%2C%20Vietnam"
    pageTitle="ST25 by KOTO"
  />
);

export default St25ByKoto;
