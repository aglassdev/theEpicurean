...
const BnhCunBHonh = () => (
  <RestaurantPage
    restaurantName="Bánh Cuốn Bà Hoành"
    address="66 To Hien Thanh Street, Bui Thi Xuan Ward, Hoan Kiem District, Hanoi, 112300, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84989083570"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/banh-cuon-ba-hoanh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is among the busiest shops in the area because of its steamed rice rolls known as bánh cuốn. Rice noodle sheets are steamed to order and then wrapped around minced shiitake and pork. They also sell bún chả, or grilled pork noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20To%20Hien%20Thanh%20Street%2C%20Bui%20Thi%20Xuan%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20112300%2C%20Vietnam"
    pageTitle="Bánh Cuốn Bà Hoành"
  />
);

export default BnhCunBHonh;
