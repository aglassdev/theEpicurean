...
const BpPrime = () => (
  <RestaurantPage
    restaurantName="Bếp Prime"
    address="12 Hang Dieu Street, Cua Dong Ward, Hoan Kiem District, Hanoi, 111202, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84922615615"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/bep-prime"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a quaint historic edifice, c. 1932, Bếp Prime specialises in traditional delicacies from Hanoi and the rest of Vietnam. For a Hanoian classic, order pigeon and mushroom hot pot – veggies, pigeon meat and offal are served in a bird cage to be blanched in a herbal broth or glutinous rice porridge. The crispy rice dish with the chef’s dip, made from pork jus, dried shrimps, chilli and pepper that packs umami and a spicy kick, is also recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Hang%20Dieu%20Street%2C%20Cua%20Dong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20111202%2C%20Vietnam"
    pageTitle="Bếp Prime"
  />
);

export default BpPrime;
