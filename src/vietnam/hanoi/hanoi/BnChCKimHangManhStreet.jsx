...
const BnChCKimHangManhStreet = () => (
  <RestaurantPage
    restaurantName="Bún Chả Đắc Kim (Hang Manh Street)"
    address="1 Hang Manh Street, Hang Gai Ward, Hoan Kiem District, Hanoi, 11015, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842438287060"
    website="https://bunchahangmanh.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nước chấm – sweet chilli fish sauce with finely sliced pickled green mango – is the perfect condiment for the vermicelli noodles which come with shredded smoky pork and plump pork patties. It’s a win-win combination of meat with sweetness and refreshing acidity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Hang%20Manh%20Street%2C%20Hang%20Gai%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011015%2C%20Vietnam"
    pageTitle="Bún Chả Đắc Kim (Hang Manh Street)"
  />
);

export default BnChCKimHangManhStreet;
