...
const IzakayaByKoki = () => (
  <RestaurantPage
    restaurantName="Izakaya by Koki"
    address="Basement 2, Capella Hanoi, 11 Le Phung Hieu Street, Trang Tien Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Japanese"
    priceRange="₫₫₫"
    phoneNumber="+842439878888"
    website="https://capellahotels.com/en/capella-hanoi/dining/koki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in the basement of Capella hotel, Izakaya is a modern and chic setting, with various seating areas, including more intimate sofa areas. Guests are welcomed with a complimentary sake with aromatic notes of tropical fruit. Sourcing 70% of its ingredients from Japan, this restaurant has an extensive menu including a specialty of grilled dishes: the grilled black cod with Saikyo sauce is particularly impressive. Be sure to save room for the signature dessert: housemade yame matcha or black truffle ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Basement%202%2C%20Capella%20Hanoi%2C%2011%20Le%20Phung%20Hieu%20Street%2C%20Trang%20Tien%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Izakaya by Koki"
  />
);

export default IzakayaByKoki;
