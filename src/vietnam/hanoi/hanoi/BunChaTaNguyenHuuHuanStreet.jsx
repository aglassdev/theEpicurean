...
const BunChaTaNguyenHuuHuanStreet = () => (
  <RestaurantPage
    restaurantName="Bun Cha Ta (Nguyen Huu Huan Street)"
    address="21 Nguyen Huu Huan Street, Ly Thai To Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84966848389"
    website="https://www.bunchata.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popular with tourists, Bun Cha Ta offers various bún chả and fried spring rolls. The classic bún chả features tender, smoky grilled pork, well-seasoned meat patties and smooth rice noodles with a balanced soup base. Among the crispy spring rolls, the seafood crab version delivers a consummate umami flavour, while the chicken is rich and meaty. They also offer rice noodles with fried tofu and tomato sauce and fried spring rolls for vegetarians...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Nguyen%20Huu%20Huan%20Street%2C%20Ly%20Thai%20To%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Bun Cha Ta (Nguyen Huu Huan Street)"
  />
);

export default BunChaTaNguyenHuuHuanStreet;
