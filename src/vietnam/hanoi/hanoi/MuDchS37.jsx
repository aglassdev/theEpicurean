...
const MuDchS37 = () => (
  <RestaurantPage
    restaurantName="Mậu Dịch Số 37"
    address="136G Tran Vu Street, Truc Bach Ward, Ba Dinh District, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+842437154336"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/mau-dich-so-37"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a rustic, vintage ambience inspired by the subsidy period and the owner's antique collection from the last 50 years, Mậu Dịch Số 37 offers a nostalgic experience. Signature dishes include Hanoi spring rolls, fried hemibagrus fish and scorched rice with beef stew (cơm chay bò cay). The crispy rice cracker, made à la minute, and grilled shrimp are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=136G%20Tran%20Vu%20Street%2C%20Truc%20Bach%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Mậu Dịch Số 37"
  />
);

export default MuDchS37;
