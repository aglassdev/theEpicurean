...
const HibanaByKoki = () => (
  <RestaurantPage
    restaurantName="Hibana by Koki"
    address="Basement 1, Capella Hanoi, 11 Le Phung Hieu Street, Trang Tien Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Teppanyaki"
    priceRange="₫₫₫₫"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Basement%201%2C%20Capella%20Hanoi%2C%2011%20Le%20Phung%20Hieu%20Street%2C%20Trang%20Tien%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Hibana by Koki"
  />
);

export default HibanaByKoki;
