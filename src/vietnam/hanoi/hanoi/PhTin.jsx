...
const PhTin = () => (
  <RestaurantPage
    restaurantName="Phở Tiến"
    address="103 Nguyen Truong To Street, Truc Bach Ward, Ba Dinh District, Hanoi, 11117, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84988669981"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-tien"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cheerful stall, now located just across from its old spot, is a local favourite for chicken noodles soup, serving a wide range of phố, bún and miến. Diners can choose from chicken offal toppings, and dark or white meat. The clean, cosy space has large windows, and the classic yellow wall adds to the street vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=103%20Nguyen%20Truong%20To%20Street%2C%20Truc%20Bach%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%2011117%2C%20Vietnam"
    pageTitle="Phở Tiến"
  />
);

export default PhTin;
