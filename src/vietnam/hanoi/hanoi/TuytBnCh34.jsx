...
const TuytBnCh34 = () => (
  <RestaurantPage
    restaurantName="Tuyết Bún Chả 34"
    address="34 Hang Than Street, Nguyen Trung Truc Ward, Ba Dinh District, Hanoi, 100000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842439270879"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/tuyet-bun-cha-34"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall is famous for its bún chả (rice noodles with fresh herbs and pork), chargrilled to order. Dip the noodles in the flavoursome broth and feel free to order an extra spring roll for added crunchiness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20Hang%20Than%20Street%2C%20Nguyen%20Trung%20Truc%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Tuyết Bún Chả 34"
  />
);

export default TuytBnCh34;
