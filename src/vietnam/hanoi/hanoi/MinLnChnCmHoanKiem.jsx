...
const MinLnChnCmHoanKiem = () => (
  <RestaurantPage
    restaurantName="Miến Lươn Chân Cầm (Hoan Kiem)"
    address="1 Chan Cam Street, Hang Trong Ward, Hoan Kiem District, Hanoi, 11006, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84869484841"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/mien-luon-chan-cam-hoan-kiem"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Chan%20Cam%20Street%2C%20Hang%20Trong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011006%2C%20Vietnam"
    pageTitle="Miến Lươn Chân Cầm (Hoan Kiem)"
  />
);

export default MinLnChnCmHoanKiem;
