...
const TmV = () => (
  <RestaurantPage
    restaurantName="Tầm Vị"
    address="4B Yen The Street, Dien Bien Ward, Ba Dinh District, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84966323131"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/tam-vi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Now with a two-storey expansion and lush courtyard, English-speaking staff and a photo menu, this vintage tea house is more tourist-friendly. It retains its North Vietnamese charm with antique decor, artwork and a rustic elegance, and continues to impart the essence of Vietnamese cuisine. Highlights include chả ốc (ham with periwinkle snails) served with herbs, vegetables, vermicelli and fish sauce, and the subtle crab soup with malabar spinach in a clear broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4B%20Yen%20The%20Street%2C%20Dien%20Bien%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Tầm Vị"
  />
);
