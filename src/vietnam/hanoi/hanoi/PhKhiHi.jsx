...
const PhKhiHi = () => (
  <RestaurantPage
    restaurantName="Phở Khôi Hói"
    address="50 Hang Vai Street, Hang Bo Ward, Hoan Kiem District, Hanoi, 11014, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+842439231561"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-khoi-hoi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Khôi Hói means bald head, referring to the owner’s hairstyle. Come here for phở – beef noodle soup. There are many cuts to choose from, including rare cuts like beef heel muscle. You can also specify how you like your beef cooked...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20Hang%20Vai%20Street%2C%20Hang%20Bo%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011014%2C%20Vietnam"
    pageTitle="Phở Khôi Hói"
  />
);

export default PhKhiHi;
