...
const BnhCunBXun = () => (
  <RestaurantPage
    restaurantName="Bánh Cuốn Bà Xuân"
    address="16 Hoe Nhai Street, Nguyen Trung Truc Ward, Ba Dinh District, Hanoi, 11115, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84968404665"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/banh-cuon-ba-xuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef crafts delectable bánh cuốn, Vietnamese steamed rolls with minced pork and black fungus. She also serves an option with a soft poached egg. Order the pork meatloaf and sausage, and season with fresh herbs, chilli, lime or garlic at will for a great breakfast or snack...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Hoe%20Nhai%20Street%2C%20Nguyen%20Trung%20Truc%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%2011115%2C%20Vietnam"
    pageTitle="Bánh Cuốn Bà Xuân"
  />
);

export default BnhCunBXun;
