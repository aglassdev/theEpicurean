...
const LaBadiane = () => (
  <RestaurantPage
    ...
    address="10 Nam Ngu Street, Cua Nam Ward, Hoan Kiem District, Hanoi, 111100, Vietnam"
    cuisine="Fusion"
    priceRange="₫₫"
    phoneNumber="+842439424509"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/la-badiane-1202147"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Badiane is French for star anise and a glass jar of this spice adorns every table. The experienced and well-travelled French chef delivers an impressive selection of vibrant and adventurous fusion dishes with bold flavours and appealing textural contrasts. A black and white tiled floor and a friendly vibe set the scene downstairs, while the rooms upstairs are more intimate. The set lunch menu is deliciously affordable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Nam%20Ngu%20Street%2C%20Cua%20Nam%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20111100%2C%20Vietnam"
