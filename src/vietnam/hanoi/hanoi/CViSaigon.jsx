...
const CViSaigon = () => (
  <RestaurantPage
    restaurantName="Ốc Vi Saigon"
    address="21 Gia Ngu Street, Hang Bac Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Seafood"
    priceRange="₫"
    phoneNumber="+84888323342"
    website="http://ocvisaigon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The extensive, reasonably priced menu is mainly composed of seafood dishes with a wide array of shellfish from oysters to white clams, snails, cockles and scallops. Snails are the specialty here, cooked in a variety of ways and sauces. The stir-fried white clams in garlic butter exude a strong aroma, while an irresistible umami flavour pervades the stir-fried cockles with tamarind. Order a mini baguette so you can mop up the delicious sauce!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Gia%20Ngu%20Street%2C%20Hang%20Bac%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Ốc Vi Saigon"
  />
);

export default CViSaigon;
