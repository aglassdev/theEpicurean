...
const PhGNguyt = () => (
  <RestaurantPage
    restaurantName="Phở Gà Nguyệt"
    address="5B Phu Doan Street, Hang Trong Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84919106192"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-ga-nguyet"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chicken noodle come with a variety of chicken cuts, but the tender thigh is a favourite – perfect in both soup and dry noodle dishes. Mix and match thigh and wings or wings and breast, adding condiments to taste. Open until midnight, it’s a popular late-night spot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5B%20Phu%20Doan%20Street%2C%20Hang%20Trong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Phở Gà Nguyệt"
  />
);

export default PhGNguyt;
