...
const PhGChmYenNinhStreet = () => (
  <RestaurantPage
    restaurantName="Phở Gà Châm (Yen Ninh Street)"
    address="64-68 Yen Ninh Street, Truc Bach Ward, Ba Dinh District, Hanoi, 11117, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber=""
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-ga-cham-yen-ninh-street"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64-68%20Yen%20Ninh%20Street%2C%20Truc%20Bach%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%2011117%2C%20Vietnam"
    pageTitle="Phở Gà Châm (Yen Ninh Street)"
  />
);

export default PhGChmYenNinhStreet;
