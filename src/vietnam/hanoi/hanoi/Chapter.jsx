...
const Chapter = () => (
  <RestaurantPage
    restaurantName="Chapter"
    address="12C Chan Cam Street, Hoan Kiem Ward, Hanoi, 11006, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫₫₫"
    phoneNumber="+84333201221"
    website="https://chapterhanoi.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chapter's façade of Corten steel slats leads into an open kitchen that produces unique flavours and textures over a charcoal grill. The single tasting menu features 10-plus courses anchored in Vietnamese heritage, all artfully plated. Primarily sourced from local farmers who use sustainable practices, the ingredients are interwoven with the rich culinary heritage of Northern Vietnam. Each course comes with a postcard sharing the story behind the dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12C%20Chan%20Cam%20Street%2C%20Hoan%20Kiem%20Ward%2C%20Hanoi%2C%2011006%2C%20Vietnam"
    pageTitle="Chapter"
  />
);
