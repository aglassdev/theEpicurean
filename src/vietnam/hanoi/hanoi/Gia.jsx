...
const Gia = () => (
  <RestaurantPage
    restaurantName="Gia"
    address="61 Van Mieu Street, Van Mieu Ward, Dong Da District, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫₫₫"
    phoneNumber="+84896682996"
    website="https://gia-hanoi.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Gia đình, meaning family, is a reference to chef Sam Tran and partner Long Tran's longing for their homeland during their years working abroad. The restaurant decor draws inspiration from the Temple of Literature just across the road. Their 12-course set menu changes with the seasons and is informed by Vietnamese culinary heritage. Deceptively complex, the beautifully crafted dishes showcase well-judged combinations of subtle flavours, with acidity and texture playing prominent roles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%20Van%20Mieu%20Street%2C%20Van%20Mieu%20Ward%2C%20Dong%20Da%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Gia"
  />
);
