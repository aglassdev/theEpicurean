...
const NgonGarden = () => (
  <RestaurantPage
    restaurantName="Ngon Garden"
    address="70 Nguyen Du Street, Nguyen Du Ward, Hai Ba Trung District, Hanoi, 112310, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84902226224"
    website="https://ngongarden.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the banks of Thien Quang Lake, this restaurant, reminiscent of an Indochinese-style villa, boasts a patio surrounded by lush greenery. The menu features specialities from all over Vietnam, alongside Asian delicacies of Chinese and Thai origins. From the century-old Bat Dan phở recipe from Hanoi and bún bò huế grilled beef from Nha Trang to fresh veggies from Dalat and live seafood from all over the world, every dish is deftly crafted and delicately seasoned...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20Nguyen%20Du%20Street%2C%20Nguyen%20Du%20Ward%2C%20Hai%20Ba%20Trung%20District%2C%20Hanoi%2C%20112310%2C%20Vietnam"
    pageTitle="Ngon Garden"
  />
);

export default NgonGarden;
