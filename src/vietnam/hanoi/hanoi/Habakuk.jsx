...
const Habakuk = () => (
  <RestaurantPage
    restaurantName="Habakuk"
    address="Alley 4, Phan Huy Chu Street, Phan Chu Trinh Ward, Hoan Kiem District, Hanoi, 11021, Vietnam"
    cuisine="European Contemporary"
    priceRange="₫₫"
    phoneNumber="+84389682892"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/habakuk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a narrow side street, Habakuk is easy to miss. By day, it's a specialty coffee shop serving single-origin brews and a small brunch menu. In the evening, it's a modern bistro featuring a concise European menu with Mediterranean influences. The dishes are confidently crafted, beautifully presented and rich in flavour; the service is warm and attentive. Try the homemade pasta with options to suit meat, seafood and vegetarian preferences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alley%204%2C%20Phan%20Huy%20Chu%20Street%2C%20Phan%20Chu%20Trinh%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011021%2C%20Vietnam"
    pageTitle="Habakuk"
  />
);

export default Habakuk;
