...
const PhBLm = () => (
  <RestaurantPage
    restaurantName="Phở Bò Lâm"
    address="48 Hang Vai Street, Hang Bo Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber=""
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-bo-lam"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Early risers delight in this beef phở haven, open from 5:30am until mid‐morning, when beef cuts and broth are sold out. Fresh ingredients shine in the signature beef heel muscle, which boasts tender meat and gelatinous tendon with a pleasant chew. Order phở with eggs and fried dough, just like the locals...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20Hang%20Vai%20Street%2C%20Hang%20Bo%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Phở Bò Lâm"
  />
);

export default PhBLm;
