...
const DuongsNgoHuyenStreet = () => (
  <RestaurantPage
    restaurantName="Duong's (Ngo Huyen Street)"
    address="27 Ngo Huyen Street, Hang Trong Ward, Hoan Kiem District, Hanoi, 110211, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+842436364567"
    website="https://duongsrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Doung's is low profile yet easy to find. Over two storeys, the setting is cosy with comfortable wooden furniture and intimate, soft lighting. The set menu is suitable for smaller parties, while the à la carte presents a selection of more substantial signature dishes from Hanoi. The traditional grilled La Vong-style fish is a treat for the eye, while the consommé of beef soup has a clear broth with layers of spices. The chef also offers cooking classes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20Ngo%20Huyen%20Street%2C%20Hang%20Trong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20110211%2C%20Vietnam"
    pageTitle="Duong's (Ngo Huyen Street)"
  />
);

export default DuongsNgoHuyenStreet;
