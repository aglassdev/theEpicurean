...
const PhBUTriu = () => (
  <RestaurantPage
    restaurantName="Phở Bò Ấu Triệu"
    address="34 Au Trieu Street, Hang Trong Ward, Hoan Kiem District, Hanoi, 11006, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+8468590017"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/pho-bo-au-trieu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The epitome of simplicity, this shop specialising in phở bò only displays its name on its staff uniforms. The bowls feature raw minced beef, tender flank and tendon gently cooked in rich bone broth with rice noodles and spring onions. Harmonious flavours and pure culinary craft...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20Au%20Trieu%20Street%2C%20Hang%20Trong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011006%2C%20Vietnam"
    pageTitle="Phở Bò Ấu Triệu"
  />
);

export default PhBUTriu;
