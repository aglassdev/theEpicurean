...
const Ph10LQucSHoanKiem = () => (
  <RestaurantPage
    restaurantName="Phở 10 Lý Quốc Sư (Hoan Kiem)"
    address="10 Ly Quoc Su Street, Hang Trong Ward, Hoan Kiem District, Hanoi, 11006, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842438257338"
    website="https://pho10lyquocsu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of three branches in Hanoi, this small phở eatery enjoys a fine reputation, but beware of imitations in the city. The menu offers 10 impressive phở options, including tái and chin (brisket), nạm (flank beef) and bắp trần (beef fillet). A competent team operates the compact corner kitchen, which is visible through a glazed partition. The phở itself is hearty and supremely refreshing with tender pieces of beef that melt in the mouth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Ly%20Quoc%20Su%20Street%2C%20Hang%20Trong%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011006%2C%20Vietnam"
    pageTitle="Phở 10 Lý Quốc Sư (Hoan Kiem)"
  />
);

export default Ph10LQucSHoanKiem;
