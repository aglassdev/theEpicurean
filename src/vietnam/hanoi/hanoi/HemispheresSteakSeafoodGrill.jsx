...
const HemispheresSteakSeafoodGrill = () => (
  <RestaurantPage
    restaurantName="Hemispheres Steak & Seafood Grill"
    address="2F, Sheraton Hotel, K5 Nghi Tam, 11 Xuan Dieu Road, Tay Ho Ward, Hanoi, 11207, Vietnam"
    cuisine="Steakhouse"
    priceRange="₫₫₫"
    phoneNumber="+84936337501"
    website="https://www.marriott.com/en-us/dining/restaurant-bar/hanhs-sheraton-hanoi-hotel/5966993-hemispheres-steak-seafood-grill.mi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Embark on a culinary journey around the world with the freshest ingredients from the northern and southern hemispheres, as well as the east and the west. Tailor your itinerary across the continent, possibly with house marinated Atlantic salmon from the north/west, or grilled New Zealand rack of lamb from the south/east. Fine range of worldclass premium beef steaks. The views over West Lake offer a slice of tranquillity amidst the urban turmoil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Sheraton%20Hotel%2C%20K5%20Nghi%20Tam%2C%2011%20Xuan%20Dieu%20Road%2C%20Tay%20Ho%20Ward%2C%20Hanoi%2C%2011207%2C%20Vietnam"
    pageTitle="Hemispheres Steak & Seafood Grill"
  />
);

export default HemispheresSteakSeafoodGrill;
