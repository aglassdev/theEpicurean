...
const TanhTch = () => (
  <RestaurantPage
    restaurantName="Tanh Tách"
    address="3 Yet Kieu Street, Nguyen Du Ward, Hai Ba Trung District, Hanoi, 112605, Vietnam"
    cuisine="Seafood"
    priceRange="₫₫₫"
    phoneNumber="+84559905599"
    website="https://tanhtach.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a historic French colonial villa, the restaurant occupies two storeys. The chef team exhibits a knack for seafood dishes based on textbook European techniques, thus explaining their prominence on the à la carte menu. Before trying the deftly crafted fish or shellfish, kick off your meal with nori or kimchi rice crackers and tom yum mayo dip. Black chicken consommé is another smash hit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Yet%20Kieu%20Street%2C%20Nguyen%20Du%20Ward%2C%20Hai%20Ba%20Trung%20District%2C%20Hanoi%2C%20112605%2C%20Vietnam"
    pageTitle="Tanh Tách"
  />
);

export default TanhTch;
