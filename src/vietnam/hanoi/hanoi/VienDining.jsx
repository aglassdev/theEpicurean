...
const VienDining = () => (
  <RestaurantPage
    restaurantName="Vien Dining"
    address="3 Ba Trieu Alley, Hai Ba Trung Ward, Hanoi, 11606, Vietnam"
    cuisine="Innovative"
    priceRange="₫₫"
    phoneNumber="+84388451919"
    website="https://viendining.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Vien, meaning harmonious circle, celebrates happiness, abundance and the roots of traditional Vietnamese culture. Made with local ingredients, regional specialities are given a modern twist by a creative young team of chefs. Diners can observe the open kitchen on the ground floor or relax in one of the intimate private rooms upstairs. Choose à la carte or opt for the seasonal set menu (pre-booking required), and don't miss the refreshing house-made Junbucha...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Ba%20Trieu%20Alley%2C%20Hai%20Ba%20Trung%20Ward%2C%20Hanoi%2C%2011606%2C%20Vietnam"
    pageTitle="Vien Dining"
  />
);

export default VienDining;
