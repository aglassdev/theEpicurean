...
const HiuLcCanhCRHngYnHaiBaTrung = () => (
  <RestaurantPage
    restaurantName="Hiệu Lực Canh Cá Rô Hưng Yên (Hai Ba Trung)"
    address="39 Hai Ba Trung Street, Tran Hung Dao Ward, Hoan Kiem District, Hanoi, 111000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84972701989"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/hieu-luc-canh-ca-ro-hung-yen-hai-ba-trung"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These speciality rice noodles from Hưng Yên Province are topped with crispy deep-fried climbing perch and bouncy fish cakes for umami; mustard greens and green onions add freshness. Diners choose between silky flat rice noodles and plump red grain noodles for a perfect bite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Hai%20Ba%20Trung%20Street%2C%20Tran%20Hung%20Dao%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20111000%2C%20Vietnam"
    pageTitle="Hiệu Lực Canh Cá Rô Hưng Yên (Hai Ba Trung)"
  />
);

export default HiuLcCanhCRHngYnHaiBaTrung;
