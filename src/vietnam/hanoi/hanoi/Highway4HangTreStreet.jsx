...
const Highway4HangTreStreet = () => (
  <RestaurantPage
    restaurantName="Highway4 (Hang Tre Street)"
    address="5 Hang Tre Street, Hoan Kiem Ward, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+842439264200"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/highway4-hang-tre-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Vietnamese tửu quán (tavern) has always been popular with the locals and tourists alike. Most diners take their time, enjoying the food and drink in good company. The inn serves Northern Vietnamese fare and we recommend the subtly flavoured appetisers, such as salads or spring rolls. The catfish spring roll is the tasty signature dish. The heart-warming main courses come in earthen pots. The deliciously tender oxtail stew with herbs is to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Hang%20Tre%20Street%2C%20Hoan%20Kiem%20Ward%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Highway4 (Hang Tre Street)"
  />
);

export default Highway4HangTreStreet;
