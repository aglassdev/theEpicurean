...
const Backstage = () => (
  <RestaurantPage
    restaurantName="Backstage"
    address="GF, Capella Hanoi, 11 Le Phung Hieu Street, Trang Tien Ward, Hoan Kiem District, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese Contemporary"
    priceRange="₫₫₫"
    phoneNumber="+842439878888"
    website="https://capellahotels.com/en/capella-hanoi/dining/backstage"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Your inner celebrity will revel in this opera-themed restaurant, whose open kitchen takes front stage. Signature dishes like Capella Pho and Bun Cha Hanoi respect their northern heritage, whilst featuring modern techniques with European touches that will leave your tastebuds singing an aria of delight. The impressive cocktail list offers some intriguing mixes. The theatrical setting showcases stunning costumes from the world’s greatest operas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Capella%20Hanoi%2C%2011%20Le%20Phung%20Hieu%20Street%2C%20Trang%20Tien%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Backstage"
  />
);
