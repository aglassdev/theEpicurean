...
const UM = () => (
  <RestaurantPage
    restaurantName="Ưu Đàm"
    address="55 Nguyen Du Street, Nguyen Du Ward, Hai Ba Trung District, Hanoi, 10000, Vietnam"
    cuisine="Vegetarian"
    priceRange="₫"
    phoneNumber="+84981349898"
    website="https://uudamchay.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Buddhist art and statues infuse the space at Ưu Đàm with a calming, Zen atmosphere. Combining Vietnamese, Western and Thai influences, the vegetarian menu is anchored in tradition but is also mindful of nutritional balance. The stir-fried mushrooms and tofu paired with a crisp girdle cake is mildly spicy with complex layers of flavours; top-notch fresh ingredients shine throughout. The juice-based cocktails complete the vibrant, nutrient-rich meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Nguyen%20Du%20Street%2C%20Nguyen%20Du%20Ward%2C%20Hai%20Ba%20Trung%20District%2C%20Hanoi%2C%2010000%2C%20Vietnam"
    pageTitle="Ưu Đàm"
  />
);
