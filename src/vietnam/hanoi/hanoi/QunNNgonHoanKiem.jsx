...
const QunNNgonHoanKiem = () => (
  <RestaurantPage
    restaurantName="Quán Ăn Ngon (Hoan Kiem)"
    address="18 Phan Boi Chau Street, Cua Nam Ward, Hoan Kiem District, Hanoi, 11018, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84903246963"
    website="https://guide.michelin.com/en/ha-noi/ha-noi_2974158/restaurant/quan-an-ngon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a charming colonial villa with bucketloads of character, Quán Ăn Ngon is spread over two storeys. Our favourite spot is the spacious garden-courtyard and its buzzy vibe. The extensive menu, which covers all the bases, takes you on a tour of Vietnam with colourful photographs of each dish to help you make your selection. The cooking is fresh, flavourful and authentic. Even better, the prices won't break the bank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Phan%20Boi%20Chau%20Street%2C%20Cua%20Nam%20Ward%2C%20Hoan%20Kiem%20District%2C%20Hanoi%2C%2011018%2C%20Vietnam"
    pageTitle="Quán Ăn Ngon (Hoan Kiem)"
  />
);

export default QunNNgonHoanKiem;
