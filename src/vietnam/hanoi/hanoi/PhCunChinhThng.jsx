...
const PhCunChinhThng = () => (
  <RestaurantPage
    restaurantName="Phở Cuốn Chinh Thắng"
    address="7 Mac Dinh Chi Street, Truc Bach Ward, Ba Dinh District, Hanoi, 11117, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84961511791"
    website="https://www.phocuonchinhthang.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Said to be the birthplace of phở cuốn in 2000, this spot remains a favourite. Soft rice noodle rolls filled with beef, vegetables and herbs pair perfectly with a sweet-sour dip. The crispy noodle crust of the deep-fried phở with beef gravy creates an irresistible contrast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Mac%20Dinh%20Chi%20Street%2C%20Truc%20Bach%20Ward%2C%20Ba%20Dinh%20District%2C%20Hanoi%2C%2011117%2C%20Vietnam"
    pageTitle="Phở Cuốn Chinh Thắng"
  />
);

export default PhCunChinhThng;
