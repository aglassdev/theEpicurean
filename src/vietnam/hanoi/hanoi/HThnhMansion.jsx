...
const HThnhMansion = () => (
  <RestaurantPage
    restaurantName="Hà Thành Mansion"
    address="14 Ngo Van So Street, Cua Nam Ward, Hanoi, 100000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84946398558"
    website="https://www.hathanhmansion.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a century-old villa, Hà Thành Mansion spans three uniquely designed floors, each radiating artistic charm. The diverse menu, crafted with locally sourced ingredients to guarantee freshness, celebrates Northern Vietnamese cuisine. Standout dishes include the grilled black pork with galangal, notable for its golden crust and hint of ginger. The cocktail bar at the entrance is the perfect spot for a drink before or after your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Ngo%20Van%20So%20Street%2C%20Cua%20Nam%20Ward%2C%20Hanoi%2C%20100000%2C%20Vietnam"
    pageTitle="Hà Thành Mansion"
  />
);

export default HThnhMansion;
