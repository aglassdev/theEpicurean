...
const BpHn = () => (
  <RestaurantPage
    restaurantName="Bếp Hên"
    address="47 Le Hong Phong Street, Phuoc Ninh Ward, Hai Chau District, Da Nang, 840236, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84935337705"
    website="https://www.bephenrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Step back in time and immerse yourself in the room’s vintage circa 1990s decor and memorabilia. The family business has been in operation since 2015 and the kitchen is helmed by mum. The extensive menu, which covers all of Vietnam, might seem overwhelming, but rest assured that all the sharing plates are authentic, hearty and comforting. When unsure, check out the section known as ‘mum’s favourites’, for items like fried garlic prawn, or stir-fried morning glory with garlic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20Le%20Hong%20Phong%20Street%2C%20Phuoc%20Ninh%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20840236%2C%20Vietnam"
    pageTitle="Bếp Hên"
  />
);
