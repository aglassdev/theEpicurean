...
const QunNhn = () => (
  <RestaurantPage
    restaurantName="Quán Nhân"
    address="83 Phan Tu Street, My An Ward, Ngu Hanh Son District, Da Nang, 550000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84899860495"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/quan-nhan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="People flock here for its famous duck porridge. A local duck breed from Cẩm Nam Island, rice, mung beans and coix seeds are slowly simmered in duck broth for a creamy, hearty meal. Poached duck and duck salad are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%20Phan%20Tu%20Street%2C%20My%20An%20Ward%2C%20Ngu%20Hanh%20Son%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Quán Nhân"
  />
);

export default QunNhn;
