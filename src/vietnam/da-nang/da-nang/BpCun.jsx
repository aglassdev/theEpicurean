...
const BpCun = () => (
  <RestaurantPage
    restaurantName="Bếp Cuốn"
    address="31-33 Tran Bach Dang Street, Phuoc My Ward, Son Tra District, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫₫"
    phoneNumber="+84702689989"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/bep-cuon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With both indoor and outdoor seating, diners can enjoy Da Nang’s warm seasons al fresco at this cosy restaurant. The space features greenery, lanterns, and bamboo accents in a charming Vietnamese style. Ideal for first-time tourists, the extensive menu showcases authentic dishes from both the north and south. Large tables suit groups, while solo diners can enjoy platters and combo dishes. The Mẹt Bếp Cuốn platter includes four snacks served with tangy fish and tamarind sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31-33%20Tran%20Bach%20Dang%20Street%2C%20Phuoc%20My%20Ward%2C%20Son%20Tra%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bếp Cuốn"
  />
);

export default BpCun;
