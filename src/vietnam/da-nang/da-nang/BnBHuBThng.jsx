...
const BnBHuBThng = () => (
  <RestaurantPage
    restaurantName="Bún Bò Huế Bà Thương"
    address="23 Tran Quoc Toan Street, Hai Chau 1 Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842363829240"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/bun-bo-hue-ba-thuong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bún bò Huế, a spicy soup from Huế, is famed for its rich lemongrass broth, tender beef and al dente vermicelli served with herbs and vegetables. For over 50 years this eatery has been delighting locals with tasty noodle soups, including sliced beef, pork knuckle and meatball options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Tran%20Quoc%20Toan%20Street%2C%20Hai%20Chau%201%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bún Bò Huế Bà Thương"
  />
);

export default BnBHuBThng;
