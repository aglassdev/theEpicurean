...
const NmNh = () => (
  <RestaurantPage
    restaurantName="Năm Đảnh"
    address="139/59/38 Tran Quang Khai Street, Tho Quang Ward, Son Tra District, Da Nang, 550000, Vietnam"
    cuisine="Seafood"
    priceRange="₫₫"
    phoneNumber="+84762654677"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/nam-%C4%91anh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a residential neighbourhood, Năm Đảnh provides a golf cart shuttle service from Phan Vinh Street. Seafood is the strong suit of this sprawling restaurant, which boasts a huge number of tables. There is even a hut clad in live fish tanks from which diners can make their pick. Lobster, whether steamed, tossed in cheese sauce, or fried with garlic and chilli, is always tasty. Sea whelks in garlic butter exude spellbinding aromas. Early birds get the most choice......"
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139%2F59%2F38%20Tran%20Quang%20Khai%20Street%2C%20Tho%20Quang%20Ward%2C%20Son%20Tra%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Năm Đảnh"
  />
);
