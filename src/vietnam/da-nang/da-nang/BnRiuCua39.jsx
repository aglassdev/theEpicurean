...
const BnRiuCua39 = () => (
  <RestaurantPage
    restaurantName="Bún Riêu Cua 39"
    address="39 Le Hong Phong Street, Phuoc Ninh Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842363897563"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/bun-rieu-cua-39"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set beneath a large tree and only open in the morning, they focus on rice noodles with crab meat in a family-recipe soup that’s rich in umami with a tangy note. Try the Tô Riêu Đặc Biệt, with crab and three types of fish cake. The pork sausage wrapped in banana leaves is also tasty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Le%20Hong%20Phong%20Street%2C%20Phuoc%20Ninh%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bún Riêu Cua 39"
  />
);

export default BnRiuCua39;
