...
const MQungSaHngVn = () => (
  <RestaurantPage
    restaurantName="Mỳ Quảng Sứa Hồng Vân"
    address="59 Le Hong Phong Street, Phuoc Ninh Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84788492977"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/my-quang-sua-hong-van"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open from 6am-1pm, this no-frills shop is packed with people craving their fix of mì quảng. The flavoursome orange-red broth is made with shrimps, and you can top your noodles with a choice of quail egg, pork, shrimp, meatball or springy jelly fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%20Le%20Hong%20Phong%20Street%2C%20Phuoc%20Ninh%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Mỳ Quảng Sứa Hồng Vân"
  />
);

export default MQungSaHngVn;
