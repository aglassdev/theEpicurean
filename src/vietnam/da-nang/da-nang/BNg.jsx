...
const BNg = () => (
  <RestaurantPage
    restaurantName="Bà Đông"
    address="145 Huynh Thuc Khang Street, Binh Hien Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84905734237"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/ba-%C4%91ong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The 70+-year-old owner inherited the heirloom fish sauce recipe from her family. With chilli, garlic and fruit, the pungent seasoning is the heart and soul of her búm mam, cold rice vermicelli dressed in fish sauce and topped with meat, veggies and peanuts. The most popular topping is crispy roast pork; the thập cẩm version includes pork, beef sausage and cured raw pork balls. Fresh sugar cane juice makes a perfect companion to the noodle dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=145%20Huynh%20Thuc%20Khang%20Street%2C%20Binh%20Hien%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bà Đông"
  />
);
