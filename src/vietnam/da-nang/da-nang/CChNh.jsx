...
const CChNh = () => (
  <RestaurantPage
    restaurantName="Cô Chủ Nhỏ"
    address="36 Phan Tu Street, My An Ward, Ngu Hanh Son District, Da Nang, 550000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84362712589"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/co-chu-nho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall sells all things duck. Duck porridge is made with rice and mung beans in a duck broth. Poached duck boasts firm, flavourful meat. When tossed with green mango, green banana, fig and herbs, it makes a refreshing salad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20Phan%20Tu%20Street%2C%20My%20An%20Ward%2C%20Ngu%20Hanh%20Son%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Cô Chủ Nhỏ"
  />
);

export default CChNh;
