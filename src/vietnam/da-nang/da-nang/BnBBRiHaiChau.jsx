...
const BnBBRiHaiChau = () => (
  <RestaurantPage
    restaurantName="Bún Bò Bà Rơi (Hai Chau)"
    address="5 Phan Thanh Tai Street, Hoa Thuan Dong Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84704196497"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/bun-bo-ba-roi-hai-chau"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Phan%20Thanh%20Tai%20Street%2C%20Hoa%20Thuan%20Dong%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bún Bò Bà Rơi (Hai Chau)"
  />
);

export default BnBBRiHaiChau;
