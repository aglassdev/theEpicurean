...
const NThi = () => (
  <RestaurantPage
    restaurantName="Ăn Thôi"
    address="114 Bach Dang Street, Hai Chau 1 Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84987824285"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/an-thoi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A French colonial allure depicts this two-storey restaurant with a blue and yellow façade. A relaxed vibe and its convenient location near the Han River and Han Market make it a popular spot for a meal after shopping. The concise menu features outstanding bánh xèo, boasting crispy, golden pancakes stuffed with carrot, pork, shrimps and squid. Spot-on seasoning, divine aromas and very courteous front-of-house staff...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=114%20Bach%20Dang%20Street%2C%20Hai%20Chau%201%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Ăn Thôi"
  />
);
