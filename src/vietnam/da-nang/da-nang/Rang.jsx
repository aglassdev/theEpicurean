...
const Rang = () => (
  <RestaurantPage
    restaurantName="Rang"
    address="384 Vo Nguyen Giap Street, My An Ward, Ngu Hanh Son District, Da Nang, 550000, Vietnam"
    cuisine="Indian"
    priceRange="₫₫"
    phoneNumber="+84866141217"
    website="https://the-rang.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rang is the Hindi word for colour and splashes of colour adorn the room, including colourful curries in white, yellow, green and red. The owner-chefs are two brothers, born in India and raised in Australia. They received formal training in Western culinary arts and champion a nouvelle cuisine with international influences. Start with chicken tikka, tailed by dal tadka yellow curry with roti or naan. Rice lovers should try their biryani...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=384%20Vo%20Nguyen%20Giap%20Street%2C%20My%20An%20Ward%2C%20Ngu%20Hanh%20Son%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Rang"
  />
);
