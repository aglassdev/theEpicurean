...
const MQungCSu = () => (
  <RestaurantPage
    restaurantName="Mỳ Quảng Cô Sáu"
    address="397 Tran Hung Dao Street, An Hai Ward, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84963982634"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/my-quang-co-sau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on the bank of Han River, the room with yellow walls and greenery feels relaxed and cheerful. The owner hails from Quảng Nam and naturally, he chose to sell mi quảng noodles, a speciality from his homeland. The intense broth is coloured yellow by turmeric and available toppings include chicken, fish and shrimp. Another must-try is thịt heo bánh tráng – thinly sliced pork belly rolled in rice paper with herbs and veggies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=397%20Tran%20Hung%20Dao%20Street%2C%20An%20Hai%20Ward%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Mỳ Quảng Cô Sáu"
  />
);

export default MQungCSu;
