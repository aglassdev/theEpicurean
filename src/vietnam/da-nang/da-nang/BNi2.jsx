...
const BNi2 = () => (
  <RestaurantPage
    restaurantName="Bé Ni 2"
    address="228 Vo Nguyen Giap Street, Phuoc My Ward, Son Tra District, Da Nang, 550000, Vietnam"
    cuisine="Seafood"
    priceRange="₫₫"
    phoneNumber="+84773515685"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/be-ni-2"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bustling, casual spot is open 24/7 – come for rice dishes during the day and seafood at night. Most of the shellfish is sourced locally and the owner ensures the quality is top-notch. Take your pick from the live fish tank and specify how you want it cooked. The grilled shrimp has impressive smoky aromas and simple seasoning that allows the natural umami to shine through. The appetisers, such as quail eggs and poached peanuts, are perfectly made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=228%20Vo%20Nguyen%20Giap%20Street%2C%20Phuoc%20My%20Ward%2C%20Son%20Tra%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bé Ni 2"
  />
);
