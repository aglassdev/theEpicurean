...
const MQung1a = () => (
  <RestaurantPage
    ...
    address="1A Hai Phong Street, Hai Chau I Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842363827936"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/mi-quang-1a"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mì quảng is a dish from Central Vietnam, popular throughout the country. So, unsurprisingly, this simple shop specialises in ribbon rice noodles in a yellow broth seasoned with fish sauce and turmeric and topped with peanuts and bean sprouts. There are two versions here, pork and shrimp or chicken, with or without hardboiled egg. Order the ‘special’ to try them all. Lettuce, cilantro, and banana flower on the side add aromas and a crispy texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1A%20Hai%20Phong%20Street%2C%20Hai%20Chau%20I%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Mì Quảng 1A"
  />
);

export default MQung1a;
