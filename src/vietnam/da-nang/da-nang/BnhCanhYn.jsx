...
const BnhCanhYn = () => (
  <RestaurantPage
    restaurantName="Bánh Canh Yến"
    address="253 Nguyen Hoang Street, Binh Hien Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84364700711"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/banh-canh-yen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here for bánh canh – thick, chewy noodles made with tapioca starch and rice flour in a snakehead fish and pork broth. Choose toppings like fishcake, quail egg or crabcake. Order fried dough sticks for added crunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=253%20Nguyen%20Hoang%20Street%2C%20Binh%20Hien%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bánh Canh Yến"
  />
);

export default BnhCanhYn;
