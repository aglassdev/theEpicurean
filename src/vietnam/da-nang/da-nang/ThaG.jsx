...
const ThaG = () => (
  <RestaurantPage
    restaurantName="Thìa Gỗ"
    address="53 Phan Thuc Duyen Street, Ngu Hanh Son Ward, Da Nang, 50507, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+842363689005"
    website="https://danang.thiagorestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This two-storey oasis away from the bustling main strip features al fresco seating in a lush green setting. Scan the QR code to learn more about the menu and Vietnamese food in general. Phố nam is a must-try with noodles in a clear beef bone broth loaded with flavours. Order the thập cẩm version to try all beef cuts. Bánh xèo miền tây is another popular choice with crispy pancakes and a generous filling. Cheerful, friendly front-of-house team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Phan%20Thuc%20Duyen%20Street%2C%20Ngu%20Hanh%20Son%20Ward%2C%20Da%20Nang%2C%2050507%2C%20Vietnam"
    pageTitle="Thìa Gỗ"
  />
);
