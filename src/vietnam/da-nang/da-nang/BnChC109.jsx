...
const BnChC109 = () => (
  <RestaurantPage
    restaurantName="Bún Chả Cá 109"
    address="109 Nguyen Chi Thanh Street, Hai Chau 1 Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84945713171"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/bun-cha-ca-109"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business for over five decades, it is now run by the third-generation owner. The sign indicates the house speciality – bún chả cá, or fishcake noodle soup. Springy and flavoursome, their house-made deep-fried and steamed fishcakes deserve all the attention they get. But extra tuna, mackerel, crab cake and crab balls make the noodle soup even better. The broth is sweet with a hint of sourness, thanks to pineapple and tomatoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=109%20Nguyen%20Chi%20Thanh%20Street%2C%20Hai%20Chau%201%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bún Chả Cá 109"
  />
);

export default BnChC109;
