...
const NuKitchen = () => (
  <RestaurantPage
    restaurantName="Nu Đồ Kitchen"
    address="11/1 Luu Quang Thuan Street, My An Ward, Ngu Hanh Son District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+84906970607"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/nu-%C4%91o-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner’s parents used to sell mì quảng, noodle soup from Central Vietnam. The shop is named ‘Nu Đồ’, a transliteration of the word ‘noodle’. The menu boasts four versions of mì quảng served in traditional bamboo baskets like in the old days, each with a special broth to highlight the key ingredient. The snakehead fish variety with pronounced turmeric aromas is not to be missed. Tables are laid in the covered patio, surrounded by greenery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%2F1%20Luu%20Quang%20Thuan%20Street%2C%20My%20An%20Ward%2C%20Ngu%20Hanh%20Son%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Nu Đồ Kitchen"
  />
);

export default NuKitchen;
