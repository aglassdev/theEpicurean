...
const BnhXoTmNhyCBa = () => (
  <RestaurantPage
    restaurantName="Bánh Xèo Tôm Nhảy Cô Ba"
    address="248 Trung Nu Vuong Street, Binh Thuan Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84905097071"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/banh-xeo-tom-nhay-co-ba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bright-red lettering looks smart against the artificial turf on a wall. For over 10 years, this small family business has been serving crispy bánh xèo pancakes alongside snacks. Try their bánh xèo tôm nhảy – the wafer-thin crispy crust is done in the style of Binh Dinh province, topped with fresh shrimps. Dip in fish sauce or peanut sauce for complementary flavours. Nem nướng is deep-fried pork sausage with a great peppery taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=248%20Trung%20Nu%20Vuong%20Street%2C%20Binh%20Thuan%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bánh Xèo Tôm Nhảy Cô Ba"
  />
);

export default BnhXoTmNhyCBa;
