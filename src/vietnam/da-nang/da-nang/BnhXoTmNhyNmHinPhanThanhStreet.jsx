...
const BnhXoTmNhyNmHinPhanThanhStreet = () => (
  <RestaurantPage
    restaurantName="Bánh Xèo Tôm Nhảy Năm Hiền (Phan Thanh Street)"
    address="46 Phan Thanh Street, Thanh Khe Ward, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84905684246"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/nam-hien-phan-thanh-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dripping in lush greenery, this simple shop feels like an indoor garden. Its signature dish is a crispy bánh xèo pancake filled with beef, squid or shrimp, alongside herbs and veggies, wrapped in rice paper and dipped in a peanut sauce. Another speciality from Da Nang is bánh tráng thịt heo – rice paper roll filled with sliced pork belly, ribbon rice noodles and fresh herbs. But its umami-loaded fermented anchovy sauce is what delivers the oomph!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20Phan%20Thanh%20Street%2C%20Thanh%20Khe%20Ward%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bánh Xèo Tôm Nhảy Năm Hiền (Phan Thanh Street)"
  />
);

export default BnhXoTmNhyNmHinPhanThanhStreet;
