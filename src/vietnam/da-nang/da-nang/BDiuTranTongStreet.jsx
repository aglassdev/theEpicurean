...
const BDiuTranTongStreet = () => (
  <RestaurantPage
    restaurantName="Bà Diệu (Tran Tong Street)"
    address="17 Tran Tong Street, Thac Gian Ward, Thanh Khe District, Da Nang, 550000, Vietnam"
    cuisine="Noodles"
    priceRange="₫"
    phoneNumber="+842363652323"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/ba-dieu-tran-tong-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple shop specialises in bún bò, or rice noodle soup with assorted cuts of beef – thinly sliced, shin, tongue, tendon... Alternatively, the noodles can be paired with pork balls or pork trotters. The broth boasts a robust meaty flavour with natural sweetness and mild heat; the meat is cooked to perfection and the seasoning is spot on. Their signature thập cẩm noodle dish allows diners to sample the beef and the pork at the same time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Tran%20Tong%20Street%2C%20Thac%20Gian%20Ward%2C%20Thanh%20Khe%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bà Diệu (Tran Tong Street)"
  />
);

export default BDiuTranTongStreet;
