...
const BnhXo76 = () => (
  <RestaurantPage
    restaurantName="Bánh Xèo 76"
    address="85A Le Van Huu Street, Bac My An Ward, Ngu Hanh Son District, Da Nang, 550000, Vietnam"
    cuisine="Vietnamese"
    priceRange="₫"
    phoneNumber="+84982390642"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/banh-xeo-76"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bánh Xèo 76 has a charcoal grill at the entrance for grilling pork. The menu includes classic Vietnamese dishes such as pancakes, corn rolls and noodles with grilled pork. Made from fresh corn and bursting with flavour, the homemade corn rolls are encased in a thin, crispy golden skin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85A%20Le%20Van%20Huu%20Street%2C%20Bac%20My%20An%20Ward%2C%20Ngu%20Hanh%20Son%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Bánh Xèo 76"
  />
);

export default BnhXo76;
