...
const MyHanhSeafood = () => (
  <RestaurantPage
    restaurantName="My Hanh Seafood"
    address="3-5 Vo Nguyen Giap Street, Phuoc My Ward, Son Tra District, Da Nang, 550000, Vietnam"
    cuisine="Seafood"
    priceRange="₫₫₫"
    phoneNumber="+84967748668"
    website="https://www.myhanhseafood.vn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The terrace with panoramic ocean views is one of the biggest draws of this beach-front restaurant. But the well-crafted seafood is more than equal to the setting. The live fish tank heralds a feast of fresh shellfish and fish, to be cooked in various ways. But the stellar attraction is definitely mantis shrimp, boasting firm, flavoursome flesh and rich, buttery roe. Mud crab from Hoi An is another exclusive speciality not found elsewhere in Da Nang...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-5%20Vo%20Nguyen%20Giap%20Street%2C%20Phuoc%20My%20Ward%2C%20Son%20Tra%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="My Hanh Seafood"
  />
);

export default MyHanhSeafood;
