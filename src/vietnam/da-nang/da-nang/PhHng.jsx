...
const PhHng = () => (
  <RestaurantPage
    restaurantName="Phú Hồng"
    address="19 Yen Bai Street, Hai Chau 1 Ward, Hai Chau District, Da Nang, 550000, Vietnam"
    cuisine="Street Food"
    priceRange="₫"
    phoneNumber="+84905588855"
    website="https://guide.michelin.com/en/da-nang-region/da-nang_2984390/restaurant/phu-hong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can smell the barbecue from a distance. Bún thịt nướng, or rice noodles with barbecue pork, is the must-try. Or go for barbecue with salad and rice paper – choose from pork, minced pork skewers, pork belly, and beef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Yen%20Bai%20Street%2C%20Hai%20Chau%201%20Ward%2C%20Hai%20Chau%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="Phú Hồng"
  />
);

export default PhHng;
