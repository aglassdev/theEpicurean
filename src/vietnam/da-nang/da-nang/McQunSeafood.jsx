...
const McQunSeafood = () => (
  <RestaurantPage
    restaurantName="MỘC Quán Seafood"
    address="26 To Hien Thanh, Phuoc My Ward, Son Tra District, Da Nang, 550000, Vietnam"
    cuisine="Seafood"
    priceRange="₫₫"
    phoneNumber="+84905665058"
    website="https://mocseafood.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy a rustic dining atmosphere that includes an outdoor seating area adorned with fairy lights in the trees. The array of fresh seafood in the large water tank can be served in a variety of Southeast-Asian styles. Gloved staff prepare your shellfish for easy consumption; the chef keeps the kitchen spick and span. The popular lobster is best savoured in garlic butter sauce for optimum flavour. Book in advance to skip the queue and indulge in top-quality seafood...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20To%20Hien%20Thanh%2C%20Phuoc%20My%20Ward%2C%20Son%20Tra%20District%2C%20Da%20Nang%2C%20550000%2C%20Vietnam"
    pageTitle="MỘC Quán Seafood"
  />
);

export default McQunSeafood;
