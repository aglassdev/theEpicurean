...
const Augustin = () => (
  <RestaurantPage
    ...
    address="Didžioji Gatvė 18, Vilnius, 01128, Lithuania"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+37064138803"
    website="https://augustin.lt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sister to Momo Grill and monai, this laid-back restaurant has a sleek, modern style. Parquet floors sit below striking faux-candle chandeliers, while shelves of wine fill vintage sideboards. Punchy, colourful dishes blend Mediterranean and Middle Eastern flavours and are offered in two different formats: the majority of the menu comprises modern plant-led small plates – three per person plus a dessert is about right – but there are also three main courses which are based around fish or meat. Service is warm and friendly, and the courtyard terrace is a real boon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Did%C5%BEioji%20Gatv%C4%97%2018%2C%20Vilnius%2C%2001128%2C%20Lithuania"
    pageTitle="Augustin"
  />
);

export default Augustin;
