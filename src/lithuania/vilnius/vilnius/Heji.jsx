...
const Heji = () => (
  <RestaurantPage
    restaurantName="HeJi"
    address="Lukiškių Gatvė 3, Vilnius, 01108, Lithuania"
    cuisine="Asian Influences"
    priceRange="€€€"
    phoneNumber="+37069141414"
    website="https://heji.lt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having been five years in the making, this impressively opulent restaurant seems like it might be more at home in Dubai or Macau than Vilnius! The cavernous glass-roofed main dining room is overlooked by two ‘caged’ balconies and a champagne bar – and there’s an intimate, dimly lit cocktail bar serving innovative Asian creations. A wood-framed open kitchen takes centre stage, and captivating and intriguing design details abound. The original menu fuses East and West, with the dim sum a hit and the signature beef dishes cooked over charcoal a real highlight. The wine list features some fine growers and the whole place makes for a glamorous night out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Luki%C5%A1ki%C5%B3%20Gatv%C4%97%203%2C%20Vilnius%2C%2001108%2C%20Lithuania"
    pageTitle="HeJi"
  />
);
