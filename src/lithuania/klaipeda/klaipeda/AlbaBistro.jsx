...
const AlbaBistro = () => (
  <RestaurantPage
    restaurantName="ALBA Bistro"
    address="Sukilėlių Gatvė 6, Klaipeda, 91244, Lithuania"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+37063201111"
    website="http://Www.albabistro.lt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll receive a truly warm welcome at this contemporary Italian bistro set in the corner of the Grand Theatre Square. Brightly decorated ceramics and colourful paintings pop against white walls, giving the place the feel of a seaside osteria on the Amalfi coast, and while the chef is Lithuanian, his cooking feels authentically Italian too. Dishes are carefully prepared, heartily proportioned and well-seasoned, from the Neapolitan-style pizzas to the likes of rolled snow crab raviolo with beurre blanc or osso bucco with risotto Milanese and gremolata...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sukil%C4%97li%C5%B3%20Gatv%C4%97%206%2C%20Klaipeda%2C%2091244%2C%20Lithuania"
    pageTitle="ALBA Bistro"
  />
);

export default AlbaBistro;
