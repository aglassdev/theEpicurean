...
const KlubKnjievnikaByBrankoKisic = () => (
  <RestaurantPage
    restaurantName="Klub Književnika by Branko Kisic"
    address="Francuska 7, Belgrade, 11000, Serbia"
    cuisine="Balkan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+38163338538"
    website="https://klubknjizevnika.rs/?lang=enhttps://klubknjizevnika.rs/?lang=en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The youthful chef of this culinary and cultural landmark, popular with the locals and tourists alike, has been at the helm since 2019. Diners can choose to eat in a winter garden or in the dining room, often accompanied by live music during the colder months. The menu showcases a patriotic Serbian lineup, including the Krempita dessert that has been served here since the restaurant opened in 1946, and other Serbian specialties (there’s a 25-minute wait for the savoury Gibanica dish), with the occasional interesting, personalised touch and a focus on plating. Since it opened at the end of the Second World War, the ‘Writers’ Club’ has been a magnet for authors, journalists and politicians and it continues to host cultural events, including exhibitions and concerts. Sustainability issues, suc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Francuska%207%2C%20Belgrade%2C%2011000%2C%20Serbia"
    pageTitle="Klub Književnika by Branko Kisic"
  />
);

export default KlubKnjievnikaByBrankoKisic;
