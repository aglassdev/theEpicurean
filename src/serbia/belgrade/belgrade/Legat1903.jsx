...
const Legat1903 = () => (
  <RestaurantPage
    restaurantName="Legat 1903"
    address="Jasenička 7, Belgrade, 11000, Serbia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+381631903003"
    website="https://www.legat1903.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This highly recommended restaurant, though located outside the city centre, is well worth the trip. The sleek, stylish interior and polished service set the scene for one of Belgrade’s foremost fine dining experiences. The repertory features meat and fish, crafted into sensibly creative recipes and each dish stands out by balanced, crisp, legible flavours. While the must-tries are shoulder of lamb and meat dishes, excellent Adriatic and freshwater fish, as well as pasta and risotto also figure on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jaseni%C4%8Dka%207%2C%20Belgrade%2C%2011000%2C%20Serbia"
    pageTitle="Legat 1903"
  />
);

export default Legat1903;
