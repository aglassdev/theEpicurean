...
const FleurDeSelNOV = () => (
  <RestaurantPage
    ...
    address="Počenta bb, Novi Slankamen, 22323, Serbia"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+38169607698"
    website="https://www.sapat.rs/restaurant-fleur-de-sel/?lang=en"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It is well worth driving the 60-odd kilometres from the centre of Belgrade to get to this fascinating property serving fine cuisine and excellent wines. The restaurant is situated within the Atelje Vina Šapat winery, amidst 12 hectares of vines. The dining room, decked in velvet upholstery and chandeliers, is elegant and classical with discreet modern touches, while its picture windows allow guests to enjoy sweeping views of the peaceful Danube, vineyards and surrounding lush green countryside. Talented chef Nikola Stojakovic brilliantly merges high-flying techniques he gleaned in some of France’s top restaurants with premium Serbian produce, including local meat and freshwater fish. His distinctive, creative approach involves presenting three successive versions of each savoury dish in a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Po%C4%8Denta%20bb%2C%20Novi%20Slankamen%2C%2022323%2C%20Serbia"
    pageTitle="Fleur de Sel"
  />
);

export default FleurDeSelNOV;
