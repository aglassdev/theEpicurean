...
const BoenGrd = () => (
  <RestaurantPage
    restaurantName="Boen Gård"
    address="Dønnestadveien 341, Kristiansand, Tveit, 4658, Norway"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4738991813"
    website="https://www.boengaard.no"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lovingly restored buildings in a beautiful bucolic setting make dining here a memorable experience. The surrounding gardens, meadows and river provide the vegetables, fruits, herbs and fish that are used so respectfully and expertly by the classically trained kitchen; all complemented by an impressive wine cellar. The chef's philosophy of using local ingredients will be explained to you by the excellent service team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D%C3%B8nnestadveien%20341%2C%20Kristiansand%2C%20Tveit%2C%204658%2C%20Norway"
    pageTitle="Boen Gård"
  />
);

export default BoenGrd;
