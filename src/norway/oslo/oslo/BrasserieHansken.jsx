...
const BrasserieHansken = () => (
  <RestaurantPage
    restaurantName="Brasserie Hansken"
    address="Christiania torv 4, Oslo, 0158, Norway"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4722426088"
    website="https://www.brasseriehansken.no"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightfully traditional brasserie, centrally located by the City Hall, with various charming dining areas and a fantastic terrace. Classical cooking follows the seasons and mixes French and Scandic influences; seafood is a speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Christiania%20torv%204%2C%20Oslo%2C%200158%2C%20Norway"
    pageTitle="Brasserie Hansken"
  />
);

export default BrasserieHansken;
