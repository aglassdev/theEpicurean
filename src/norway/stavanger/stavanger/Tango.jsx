...
const Tango = () => (
  <RestaurantPage
    restaurantName="Tango"
    address="Skagen 3, Stavanger, 4006, Norway"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4751505050"
    website="https://www.bytango.no"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a feeling of exclusivity to dining at Tango, where the intimate space and décor gives off cool 'Mad Men' vibes; the leather swivel chairs are particularly comfortable. The attractive dishes on the set menu are served and explained by the chefs themselves and feature seasonal ingredients in creative preparations. Wine pairings are well thought-out and service is attentive and charming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Skagen%203%2C%20Stavanger%2C%204006%2C%20Norway"
    pageTitle="Tango"
  />
);
