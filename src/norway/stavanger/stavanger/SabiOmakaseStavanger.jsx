...
const SabiOmakaseStavanger = () => (
  <RestaurantPage
    restaurantName="Sabi Omakase Stavanger"
    address="Pedersgata 38, Stavanger, 4013, Norway"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+4792543781"
    website="https://www.omakase.no"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pedersgata%2038%2C%20Stavanger%2C%204013%2C%20Norway"
    pageTitle="Sabi Omakase Stavanger"
  />
);

export default SabiOmakaseStavanger;
