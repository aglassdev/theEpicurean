...
const LunetaLornetaBistroClub = () => (
  <RestaurantPage
    restaurantName="Luneta & Lorneta Bistro Club"
    address="Ciekocinko 9, Ciekocinko, 84210, Poland"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+48608002220"
    website="https://palacciekocinko.pl/luneta-lorneta-bistro-club/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Pałac Ciekocinko Hotel, a large house dating back to the 1920s, is home to this smart Belle Époque-style restaurant with a few plush details in its décor. Situated in the basement, there’s a pleasantly cosy feel to the dining room, which is accentuated by the cheery, welcoming service; a garden terrace is used to fine effect in the summer. The full-flavoured cooking incorporates French bistro and Italian influences such as confit duck leg and tarte Tatin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ciekocinko%209%2C%20Ciekocinko%2C%2084210%2C%20Poland"
    pageTitle="Luneta & Lorneta Bistro Club"
  />
);

export default LunetaLornetaBistroClub;
