...
const LentreVilles = () => (
  <RestaurantPage
    restaurantName="L’Entre Villes"
    address="Aleja Niepodległości 737, Sopot, 81-838, Poland"
    cuisine="Traditional Cuisine, French"
    priceRange="€€€"
    phoneNumber="+48575160037"
    website="https://entrevilles.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautifully elegant villa dates back to the turn of the 20th Century and sports interior décor that mixes the traditional with the contemporary, chandeliers with modern art – while its bright orangery is the most in-demand dining area come the summer. The neatly laid tables hint at the formality of the place, with dishes arriving under cloches and the smartly aproned team occasionally donning white gloves to serve. The French-inflected cooking demonstrates sound classical skill from the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aleja%20Niepodleg%C5%82o%C5%9Bci%20737%2C%20Sopot%2C%2081-838%2C%20Poland"
    pageTitle="L’Entre Villes"
  />
);

export default LentreVilles;
