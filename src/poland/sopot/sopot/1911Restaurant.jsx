...
const OneNineOneOneRestaurant = () => (
  <RestaurantPage
    restaurantName="1911 Restaurant"
    address="ul. Grunwaldzka 4/6, Sopot, 81-759, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48572945145"
    website="https://www.sopot1911.pl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden behind an unassuming façade, you'll find this smart modern bistro with a team that’s eager to please and food that offers fabulous value for money. The concise menu makes sure the kitchen doesn’t overstretch but instead packs heaps of flavour into every unfussy dish, be it herring toast or fried skrei cod. Desserts are a highlight, with the kitchen’s creative streak coming through in the likes of milled cornflake ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20Grunwaldzka%204%2F6%2C%20Sopot%2C%2081-759%2C%20Poland"
    pageTitle="1911 Restaurant"
  />
);

export default OneNineOneOneRestaurant;
