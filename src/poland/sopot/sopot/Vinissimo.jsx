...
const Vinissimo = () => (
  <RestaurantPage
    restaurantName="Vinissimo"
    address="Generała Józefa Bema 6, Sopot, 81-753, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48881334449"
    website="https://vinissimorestaurant.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The clue’s in the name: wine takes centre stage at this simply styled and bang on-trend bar-cum-restaurant. On-sale bottles can be glimpsed around the room, while the list contains plenty of great options by the glass. The menu is filled with good value dishes which both deliver bags of flavour and show a wise restraint from the kitchen team. Instead of throwing unnecessary ingredients into the mix, they focus on a clean, balanced style of cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Genera%C5%82a%20J%C3%B3zefa%20Bema%206%2C%20Sopot%2C%2081-753%2C%20Poland"
    pageTitle="Vinissimo"
  />
);

export default Vinissimo;
