...
const PetitParis = () => (
  <RestaurantPage
    restaurantName="Petit Paris"
    address="ul. Grunwaldzka 12/16, Sopot, 81-750, Poland"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+48583419449"
    website="http://www.petitparis.pl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As its name suggests, this classic brasserie feels like it’s been flown in from France, with its framed French posters and brass railings. The menu’s Francophone base is blended with some home-grown influences, like the traditional rabbit with mustard sauce coming in a pierogi format, or zander in champagne sauce enlivened by a Żubrówka vodka vinaigrette. For dessert, look no further than crêpes Suzette flambéed in front of the guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20Grunwaldzka%2012%2F16%2C%20Sopot%2C%2081-750%2C%20Poland"
    pageTitle="Petit Paris"
  />
);

export default PetitParis;
