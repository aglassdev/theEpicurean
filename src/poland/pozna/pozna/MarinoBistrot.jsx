...
const MarinoBistrot = () => (
  <RestaurantPage
    restaurantName="Marino Bistrot"
    address="Poznańska 50/2, Poznań, 62-851, Poland"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+48539968319"
    website="https://www.marinobistrot.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden away in a residential area, this basement restaurant sports rustic exposed brickwork and simple bistro furnishings. It’s named after Chef-Owner Livio Marino, who has a passion for authentic Italian dishes that manifests itself here in an extensive menu that includes a selection of homemade pastas. Look out for the gnocchi, which could come with the delicious combination of gorgonzola, pear and walnuts. For dessert, it’s very hard to resist tiramisu in a place like this...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pozna%C5%84ska%2050%2F2%2C%20Pozna%C5%84%2C%2062-851%2C%20Poland"
    pageTitle="Marino Bistrot"
  />
);

export default MarinoBistrot;
