...
const Delicja = () => (
  <RestaurantPage
    restaurantName="Delicja"
    address="Pl. Wolności 5, Poznań, 61 738, Poland"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+48502350086"
    website="https://www.delicja.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dine in the shade of one of the oldest trees in the Wielkopolska region in the small enclosed garden of this romantic restaurant. The elegant dining room is filled with antiques and polished silver, bringing an old-fashioned feel to proceedings. The formal and personable service is a good match for the surroundings, as is the roster of classic yet ambitious dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pl.%20Wolno%C5%9Bci%205%2C%20Pozna%C5%84%2C%2061%20738%2C%20Poland"
    pageTitle="Delicja"
  />
);

export default Delicja;
