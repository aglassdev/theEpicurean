...
const Papavero = () => (
  <RestaurantPage
    restaurantName="Papavero"
    address="ul. 3 Maja 46, Poznań, 61 728, Poland"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+48573336782"
    website="https://papavero-poznan.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established little restaurant serves a mixture of Polish and Mediterranean-inspired cooking in a stylish setting. The generous and well-executed dishes include their signature roast duck with red cabbage, alongside homemade pastas and classic desserts like tiramisu and crème brûlée. Sit overlooking the street or in the smaller, more intimate room to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%203%20Maja%2046%2C%20Pozna%C5%84%2C%2061%20728%2C%20Poland"
    pageTitle="Papavero"
  />
);

export default Papavero;
