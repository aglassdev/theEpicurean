...
const Turestaurant = () => (
  <RestaurantPage
    restaurantName="TU.REStAURANT"
    address="Grunwaldzka 34A, Poznań, 60 786, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48887222121"
    website="https://turestaurant.pl/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a striking, architect-led conversion, this historic military building now boasts a mezzanine, a feature wine wall and a cocktail bar with a communal table. This all adds up to a stylish and characterful restaurant; one which also features a wide-ranging, modern European menu that includes small plates, large dishes to share and a small pasta selection. Everything is well-priced and appealing, with sauces being a real strength of the kitchen, whether it's a madeira jus with scallops or a wonderful truffle-infused velouté with chicken...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grunwaldzka%2034A%2C%20Pozna%C5%84%2C%2060%20786%2C%20Poland"
    pageTitle="TU.REStAURANT"
  />
);

export default Turestaurant;
