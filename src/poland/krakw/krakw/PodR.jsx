...
const PodR = () => (
  <RestaurantPage
    restaurantName="Pod Różą"
    address="ul. Floriańska 14, Kraków, 31 021, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+48124243375"
    website="https://podroza.hotel.com.pl/hotel-pod-roza/restaurants/pod-roza-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of the 300 year old hotel of the same name, within a glass-covered atrium, you'll find this spacious restaurant boasting a lounge bar and a dining area overlooking the kitchen. Quality Polish ingredients power modern dishes underpinned by a strong classical base, with confident and assured presentation, bold flavours and an Italian influence. The well-chosen wine list features over 300 Italian wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20Floria%C5%84ska%2014%2C%20Krak%C3%B3w%2C%2031%20021%2C%20Poland"
    pageTitle="Pod Różą"
  />
);
