...
const BufetKrk = () => (
  <RestaurantPage
    restaurantName="Bufet KRK"
    address="Dajwór 8, Kraków, 31-035, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48530200924"
    website="https://bufetkrk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A younger sibling to the acclaimed Bottiglieria 1881, this buzzing modern brasserie feels distinctly of-the-moment. From the pared-back yet well-appointed décor to the open kitchen and counter seating, it’s no wonder the place is so packed. The cooking resurrects and reinvents Polish classics – such as homemade kaszkanka (black pudding) – while offering a selection of high-quality meats cooked over the grill. Assured, personable service suits the vibe of the place well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dajw%C3%B3r%208%2C%20Krak%C3%B3w%2C%2031-035%2C%20Poland"
    pageTitle="Bufet KRK"
  />
);

export default BufetKrk;
