...
const NotarestoByTomaszLeniak = () => (
  <RestaurantPage
    restaurantName="NOTA_RESTO by Tomasz Leśniak"
    address="ul. Św. Krzyża 17, Kraków, 31 023, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+48517818851"
    website="https://www.notaresto.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef to the Polish national football team is behind this brightly decorated restaurant, and also owns the more informal bistro next door. The wide-ranging menu includes both a variety of steaks – served with a choice of sides and sauces – and a 'flour and water' section that includes homemade pasta alongside classic pierogi. Everything comes in generous portions and delivers bold, gutsy flavours. The professional service team run the place well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20%C5%9Aw.%20Krzy%C5%BCa%2017%2C%20Krak%C3%B3w%2C%2031%20023%2C%20Poland"
    pageTitle="NOTA_RESTO by Tomasz Leśniak"
  />
);

export default NotarestoByTomaszLeniak;
