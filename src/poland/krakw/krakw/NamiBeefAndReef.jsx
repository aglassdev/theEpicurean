...
const NamiBeefAndReef = () => (
  <RestaurantPage
    restaurantName="Nami Beef and Reef"
    address="Stolarska 13, Kraków, 31-043, Poland"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+48798163822"
    website="https://namirestaurant.pl/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stolarska%2013%2C%20Krak%C3%B3w%2C%2031-043%2C%20Poland"
    pageTitle="Nami Beef and Reef"
  />
);

export default NamiBeefAndReef;
