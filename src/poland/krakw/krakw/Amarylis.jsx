...
const Amarylis = () => (
  <RestaurantPage
    restaurantName="Amarylis"
    address="ul. Józefa Dietla 60, Kraków, 31 039, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+48124333306"
    website="https://www.queenhotel.pl/restauracja/restauracja-amarylis"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Global and Polish influences are effectively integrated at this basement restaurant inside the Queen Hotel, close to Krakow Old Town. Choose to sit in either a traditional brick-built room or a more modern space furnished in black and white, then sit back and enjoy the attractively presented modern dishes. There’s a good degree of detail in the cooking, which showcases precision and effective flavour contrasts throughout...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20J%C3%B3zefa%20Dietla%2060%2C%20Krak%C3%B3w%2C%2031%20039%2C%20Poland"
    pageTitle="Amarylis"
  />
);

export default Amarylis;
