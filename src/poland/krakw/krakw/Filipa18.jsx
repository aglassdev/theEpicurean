...
const Filipa18 = () => (
  <RestaurantPage
    restaurantName="Filipa 18"
    address="ul. Św. Filipa 18, Kraków, 31 150, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48123003033"
    website="https://filipa18.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This intimate, modern restaurant blends a small open kitchen with powder blue banquettes and walls decorated with bright artwork from The Polish Poster School. The modernised versions of classic Polish dishes deliver an appealing blend of textures, alongside a careful balancing of complementary flavours. Breads are baked in-house and local ingredients are sourced from the nearby Stary Kleparz market...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20%C5%9Aw.%20Filipa%2018%2C%20Krak%C3%B3w%2C%2031%20150%2C%20Poland"
    pageTitle="Filipa 18"
  />
);

export default Filipa18;
