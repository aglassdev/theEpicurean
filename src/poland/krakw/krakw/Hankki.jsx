...
const Hankki = () => (
  <RestaurantPage
    restaurantName="Hankki"
    address="Zabłocie 19A, Kraków, 30-701, Poland"
    cuisine="Korean, Japanese"
    priceRange="€"
    phoneNumber="+48798399851"
    website="https://www.instagram.com/hankkiKrakow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the up-and-coming Zabłocie neighbourhood, this sister restaurant to Hana Sushi is located on the ground floor of a modern apartment block. Inside, it’s bright and stylish, with an abundance of blonde wood furnishings. Despite bento boxes for lunch and a selection of nigiri, there’s more of a Korean slant to the menu here, with hearty, soul-warming options like red jjamppong. Don’t miss the signature popcorn chicken too!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zab%C5%82ocie%2019A%2C%20Krak%C3%B3w%2C%2030-701%2C%20Poland"
    pageTitle="Hankki"
  />
);
