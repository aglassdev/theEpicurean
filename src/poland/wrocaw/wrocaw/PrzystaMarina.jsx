...
const PrzystaMarina = () => (
  <RestaurantPage
    restaurantName="Przystań & Marina"
    address="ul Księcia Witolda 2, Wrocław, 50-202, Poland"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+48502130893"
    website="https://www.przystan.wroc.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the summer, head straight for the terrace at this large modern brasserie. Situated on Kępa Mieszczańska – an island in the middle of the River Oder, yet still part of the city centre – it offers waterside views to accompany the kitchen’s colourful cooking. Local produce is often to the fore in dishes that look to the Mediterranean for inspiration, be it bouillabaisse with zander or tiramisu for dessert. The friendly service adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul%20Ksi%C4%99cia%20Witolda%202%2C%20Wroc%C5%82aw%2C%2050-202%2C%20Poland"
    pageTitle="Przystań & Marina"
  />
);

export default PrzystaMarina;
