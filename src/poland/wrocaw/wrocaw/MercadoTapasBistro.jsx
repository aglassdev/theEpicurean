...
const MercadoTapasBistro = () => (
  <RestaurantPage
    restaurantName="Mercado Tapas Bistro"
    address="Wojciecha Bogusławskiego 15, Wrocław, 50-001, Poland"
    cuisine="Spanish"
    priceRange="€"
    phoneNumber="+48882415599"
    website="https://www.facebook.com/mercado.wroclaw/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tapas bar under a red-brick railway arch brings a little slice of Spain to Lower Silesia. It’s got all the ingredients of a good night out, from the buzz of happy diners to a drinks list including Spanish wines, sherry and sangria. The cooking marries tapas staples, like croquetas and pan con tomate, with a ‘Something Different’ section incorporating well-judged international tweaks. The Basque cheesecake will provide a fitting finale to a terrific all-round experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wojciecha%20Bogus%C5%82awskiego%2015%2C%20Wroc%C5%82aw%2C%2050-001%2C%20Poland"
    pageTitle="Mercado Tapas Bistro"
  />
);

export default MercadoTapasBistro;
