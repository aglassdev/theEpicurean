...
const RestauracjaSolmarina = () => (
  <RestaurantPage
    restaurantName="Restauracja Solmarina"
    address="Grano Hotel Solmarina, Łąkowa 239, Wiślinka, 83-011, Poland"
    cuisine="Polish, Contemporary"
    priceRange="€€"
    phoneNumber="+48585828960"
    website="https://www.granohotelsolmarina.pl/solmarina-restaurant/menu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located within the Grano Hotel Solmarina, this restaurant benefits from a striking location in a private marina with plenty of space for luxury boats and yachts. Inside, it's as stylish as you’d expect, with light flooding through the floor-to-ceiling windows. The cooking is rooted in Polish classics given a modern spin, like the delicious sour cucumber soup, served here with confit potato and a golden croquette of pulled pork rib...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grano%20Hotel%20Solmarina%2C%20%C5%81%C4%85kowa%20239%2C%20Wi%C5%9Blinka%2C%2083-011%2C%20Poland"
    pageTitle="Restauracja Solmarina"
  />
);

export default RestauracjaSolmarina;
