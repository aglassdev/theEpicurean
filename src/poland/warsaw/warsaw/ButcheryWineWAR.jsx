...
const ButcheryWineWAR = () => (
  <RestaurantPage
    restaurantName="Butchery & Wine"
    address="ul. Żurawia 22, Warsaw, 00 515, Poland"
    cuisine="Meats and Grills, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+48505270516"
    website="https://www.butcheryandwine.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this busy modern bistro says it all; the emphasis is on steaks, which are dry-aged for a minimum of 28 days in their glass-fronted ageing fridges. The cuts are then skilfully cooked in the Bertha oven, where temperatures can reach up to 500°C. Try a Polish cut or one imported from further afield, accompanied by a glass of red wine. Non-steak dishes might include fried duck egg, tuna tartare or grilled octopus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20%C5%BBurawia%2022%2C%20Warsaw%2C%2000%20515%2C%20Poland"
    pageTitle="Butchery & Wine"
  />
);

export default ButcheryWineWAR;
