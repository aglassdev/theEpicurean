...
const CevicheBar = () => (
  <RestaurantPage
    restaurantName="Ceviche Bar"
    address="Twarda 2-4, Warsaw, 00 105, Poland"
    cuisine="South American"
    priceRange="€€"
    phoneNumber="+48223049402"
    website="https://new.cevichebar.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bringing South American flavours to Warsaw, you’ll quickly find that this bright, airy restaurant is much more than a bar and serves far more than just ceviche. The famous Peruvian dish does feature – with sea bass, tuna and oyster among the varieties – but so do empanadas, grilled steaks and picarones. Argentinian chef-owner Martin Gimenez Castro imbues them all with freshness and vitality. In the evening, the music grows louder and the pisco sours start emerging from the bar at increasing speed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Twarda%202-4%2C%20Warsaw%2C%2000%20105%2C%20Poland"
    pageTitle="Ceviche Bar"
  />
);

export default CevicheBar;
