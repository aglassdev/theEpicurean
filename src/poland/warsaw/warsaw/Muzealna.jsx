...
const Muzealna = () => (
  <RestaurantPage
    restaurantName="Muzealna"
    address="The National Museum, al. Jerozolimskie 3, Warsaw, 00 495, Poland"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+48883303333"
    website="https://www.restauracjamuzealna.pl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within the impressive main building of the National Museum of Poland sits this younger sibling to alewino, which serves unfussy bistro-style food. A broad menu includes both hot and cold starters, with hearty dishes like trout paprikash a feature. There is a refined finish to the cooking, but it’s the punchy flavours that really stand out. The friendly team make everyone feel welcome and always serve with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20National%20Museum%2C%20al.%20Jerozolimskie%203%2C%20Warsaw%2C%2000%20495%2C%20Poland"
    pageTitle="Muzealna"
  />
);

export default Muzealna;
