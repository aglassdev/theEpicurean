...
const TreintaYTres = () => (
  <RestaurantPage
    restaurantName="Treinta y Tres"
    address="Olivia Centre, Aleja Grunwaldzka 472c, Gdańsk, 80-309, Poland"
    cuisine="Spanish"
    priceRange="€€"
    phoneNumber="+48731334332"
    website="https://www.oliviastar.pl/restauracje/treinta-y-tres/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The 33rd floor of the Olivia Centre skyscraper provides spectacular panoramic views for this buzzing restaurant where Spanish guitar music soundtracks your visit. The cooking has a similar tone, with a selection of classic tapas to begin – the Ibérico ham croquetas are terrific – before a choice of main dishes. If you’re dining with company, the eye-catching rice dishes for two might include calamari or pork ribs as options. A genuine warmth from the service team and a comprehensive, largely Spanish wine list complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Olivia%20Centre%2C%20Aleja%20Grunwaldzka%20472c%2C%20Gda%C5%84sk%2C%2080-309%2C%20Poland"
    pageTitle="Treinta y Tres"
  />
);

export default TreintaYTres;
