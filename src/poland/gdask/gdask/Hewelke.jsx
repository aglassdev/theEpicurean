...
const Hewelke = () => (
  <RestaurantPage
    restaurantName="Hewelke"
    address="Jana Kilińskiego 7, Gdańsk, 80-452, Poland"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+48583470302"
    website="https://hewelke.pl/restauracja/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gdańsk’s famous brewer and astronomer Johannes Hevelius lends a variant of his surname to this trendy spot situated in, appropriately enough, a former brewery. The stylish décor includes a vaulted brick ceiling, exposed steel support columns and the odd flash of neon. A bakery by day, in the evening it becomes a restaurant where the cooking adopts global influences, including pan-Asian elements ranging from hamachi with ponzu to the rightly popular Peking duck. In a nod to Hevelius, the cocktails are named after the planets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jana%20Kili%C5%84skiego%207%2C%20Gda%C5%84sk%2C%2080-452%2C%20Poland"
    pageTitle="Hewelke"
  />
);

export default Hewelke;
