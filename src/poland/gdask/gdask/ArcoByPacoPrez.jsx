...
const ArcoByPacoPrez = () => (
  <RestaurantPage
    restaurantName="Arco by Paco Pérez"
    ...
    pageTitle="Arco by Paco Pérez"
  />
);

export default ArcoByPacoPrez;
