...
const Sztuczka = () => (
  <RestaurantPage
    restaurantName="Sztuczka"
    address="ul. Stara Stocznia 20/9, Gdańsk, 80-862, Poland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+48532281639"
    website="https://www.sztuczka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated opposite the striking architecture of the Museum of the Second World War, this restaurant boasts elegant contemporary design, where brightly coloured banquettes and velour chairs blend with globe pendant lights and a parquet floor. The dishes – built on French classics like beef tartare and turbot with beurre blanc – are detailed, well-composed and blissfully free of superfluous elements. The friendly service team show palpable pride in their work...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ul.%20Stara%20Stocznia%2020%2F9%2C%20Gda%C5%84sk%2C%2080-862%2C%20Poland"
    pageTitle="Sztuczka"
  />
);

export default Sztuczka;
