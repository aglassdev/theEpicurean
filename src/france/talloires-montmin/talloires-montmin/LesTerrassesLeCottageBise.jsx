...
const LesTerrassesLeCottageBise = () => (
  <RestaurantPage
    restaurantName="Les Terrasses - Le Cottage Bise"
    address="390 route du Port, Talloires-Montmin, 74290, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450607110"
    website="https://www.cottagebise.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A luxurious and smart restaurant, a lovely terrace shaded by chestnut trees with the lake as its horizon, and modern cooking seasoned to a T mean you will enjoy your dining experience here. The chef prepares trout gravlax with asparagus, monkfish glazed with carrot and turmeric jus, and picanha of Black Angus beef with crunchy vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=390%20route%20du%20Port%2C%20Talloires-Montmin%2C%2074290%2C%20France"
    pageTitle="Les Terrasses - Le Cottage Bise"
  />
);

export default LesTerrassesLeCottageBise;
