...
const LeGantxo = () => (
  <RestaurantPage
    restaurantName="Le Gantxo"
    address="130 chemin du Trinquet, Guiche, 64520, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559564663"
    website="https://www.restaurant-le-gantxo.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to the Basque country! Le Gantxo – named after a pass in pelota – gives directly onto the trinquet, the ground where the famous local sport is played. In the kitchen, Isabelle and Laurent Miremont revisit Basque cuisine in a very personal way, composing dishes that are up to the minute, often copious, always tasty. A firm favourite!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=130%20chemin%20du%20Trinquet%2C%20Guiche%2C%2064520%2C%20France"
    pageTitle="Le Gantxo"
  />
);

export default LeGantxo;
