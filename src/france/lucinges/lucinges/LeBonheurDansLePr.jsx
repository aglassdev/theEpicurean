...
const LeBonheurDansLePr = () => (
  <RestaurantPage
    restaurantName="Le Bonheur dans Le Pré"
    address="2011 route de Bellevue, Lucinges, 74380, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33450433777"
    website="https://lebonheurdanslepre.ellohaweb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this 19C farmhouse deep in the countryside, authenticity is the name of the game. The chef creates a single menu (vegetarian version available) using top-notch local ingredients. The food is perfectly paired with wines from the splendid cellar (over 300 references) that abuts the dining room. The restaurant’s name is a playful reference to a well-loved French movie (1995) starring a plethora of Gallic movie stars...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2011%20route%20de%20Bellevue%2C%20Lucinges%2C%2074380%2C%20France"
    pageTitle="Le Bonheur dans Le Pré"
  />
);

export default LeBonheurDansLePr;
