...
const LeBistrotDeMadeleine = () => (
  <RestaurantPage
    restaurantName="Le Bistrot de Madeleine"
    ...
    bio="This village inn is a real boon for lovers of the finer (and healthier) things in life. It would not be out of place to talk about programmatic cuisine in this bistro with a slightly rustic feel: whole carcass approach, local market gardening, fish sourced directly from the fish markets, a menu that changes every week… The end result? Tasty, generous and delicious cuisine...."
    ...
    pageTitle="Le Bistrot de Madeleine"
  />
);

export default LeBistrotDeMadeleine;
