...
const LaubergeDeLucinges = () => (
  <RestaurantPage
    restaurantName="L'Auberge de Lucinges"
    address="67 place de l'Église, Lucinges, 74380, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33450396474"
    website="https://www.laubergedelucinges.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Benjamin Breton (previously at Fiskebar at the Ritz-Carlton hotel in Geneva) is at the helm of this fine dining restaurant next to his Bistrot de Madeleine. Here in the village of Lucinges, he serves up modern and subtly creative cuisine in the form of a monthly single set menu. The rigorously selected ingredients are locally sourced, give or take a few premium-quality exceptions such as blue lobster and Ferme de Clavisy lamb. Vegetables enjoy the limelight, with beautifully contrasting flavours and sublime sauces, and masterful cooking elevating ingredients such as ikejime Arctic char or the famous blue lobster, which is oh-so-lightly seared. The focal point of the bright, contemporary space is the glass-walled wine cellar, which homes in on top-quality and original natural and organ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20place%20de%20l'%C3%89glise%2C%20Lucinges%2C%2074380%2C%20France"
    pageTitle="L'Auberge de Lucinges"
  />
);

export default LaubergeDeLucinges;
