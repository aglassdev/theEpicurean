...
const MichelBjeanninAubergeDeChavannes = () => (
  <RestaurantPage
    restaurantName="Michel Béjeannin - Auberge de Chavannes"
    address="1890 avenue de Châlon, Courlans, 39570, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33384432434"
    website="https://www.auberge-de-chavannes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In winter, an open fire burns brightly in this welcoming and contemporary inn. The food sings an ode to the Mediterranean with bouillabaisse (the chef lived in Marseille for some 26 years), and also the local countryside with Bresse hen in vin jaune and morels, a whimsical nod to his Jura roots. Fine wine list with a fondness for organic and biodynamic produce. Spacious rooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1890%20avenue%20de%20Ch%C3%A2lon%2C%20Courlans%2C%2039570%2C%20France"
    pageTitle="Michel Béjeannin - Auberge de Chavannes"
  />
);

export default MichelBjeanninAubergeDeChavannes;
