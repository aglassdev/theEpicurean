...
const AubergeDeBriant = () => (
  <RestaurantPage
    restaurantName="Auberge de Briant"
    address="au bourg, Briant, 71110, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385259869"
    website="https://aubergedebriant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The spacious and light new dining room gives onto the water and surrounding greenery. Tuck into the delicious dishes made by Filipe, the chef – pressé of Charolais oxtail and crayfish with sauce ravigote, sea bass roasted in olive oil, dill and garlic cromesquis... – and the tasty desserts made by Angélique, his wife!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=au%20bourg%2C%20Briant%2C%2071110%2C%20France"
    pageTitle="Auberge de Briant"
  />
);

export default AubergeDeBriant;
