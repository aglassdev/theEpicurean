...
const Le80 = () => (
  <RestaurantPage
    restaurantName="Le 80"
    address="88 rue des Jeux-Olympiques, Méribel, 73550, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33479416979"
    website="https://www.chaudanne.com/fr/restaurant-bar-meribel-le-80"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Adorned in colourful hot-air balloons, Le 80 presents a patriotic culinary line-up of French traditions in well-crafted dishes: Richelieu pâté en croûte (porkpie), free-range pork chop smoked in hay or rose-scented praline meringues in a vanilla custard cream. More festive in the evenings. Follow in the footsteps of Jules Verne!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=88%20rue%20des%20Jeux-Olympiques%2C%20M%C3%A9ribel%2C%2073550%2C%20France"
    pageTitle="Le 80"
  />
);
