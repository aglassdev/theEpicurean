...
const LeRestaurantDesIsles = () => (
  <RestaurantPage
    restaurantName="Le Restaurant des Isles"
    address="9 boulevard Maritime, Barneville-Carteret, 50270, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33233040599"
    website="https://www.hotel-des-isles.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming old seaside villa, now a hotel-restaurant, boasts a prime location a stone's throw from Barneville's expansive beach and views of the Channel Islands in the distance. Diners are well looked after in the spacious dining area that exudes a holiday ambience. The concise menu, which changes daily – freshness guaranteed! – features precise, straightforward dishes. We enjoyed soft-boiled egg and smoked herring, hake in a butter emulsion with smoked herring roe, and a seasonal dessert pairing strawberry and mint. The set menu, available at lunchtime and in the evening, is an absolute steal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20boulevard%20Maritime%2C%20Barneville-Carteret%2C%2050270%2C%20France"
    pageTitle="Le Restaurant des Isles"
  />
);

export default LeRestaurantDesIsles;
