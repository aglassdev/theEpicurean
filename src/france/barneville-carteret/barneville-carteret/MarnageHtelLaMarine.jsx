...
const MarnageHtelLaMarine = () => (
  <RestaurantPage
    restaurantName="Marnage - Hôtel La Marine"
    address="11 rue de Paris, Barneville-Carteret, 50270, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33233538331"
    website="https://www.hotelmarine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its panoramic view of the sea and the port, this local institution on the Cotentin peninsula faces the Channel Islands of Jersey and Guernsey. In a pleasant contemporary interior, you will sample modern, elegant cuisine that shines the limelight on Normandy produce, with a weakness for local seafood, illustrated by pollock, fennel (confit and roasted) and a lemon-flavoured butter emulsion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20de%20Paris%2C%20Barneville-Carteret%2C%2050270%2C%20France"
    pageTitle="Marnage - Hôtel La Marine"
  />
);

export default MarnageHtelLaMarine;
