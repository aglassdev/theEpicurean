...
const LaSalamandre = () => (
  <RestaurantPage
    restaurantName="La Salamandre"
    address="7 place de l'Église, Saint-Aignan, 41110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254932066"
    website="https://www.restaurantlasalamandre.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a picture postcard medieval village overlooking the River Cher, this eatery occupies an outbuilding of the castle of Saint-Aignan and is decked out in a contemporary bistro vibe beneath an attractive timber ceiling. The seasoned Dutch chef rolls out a fresh, colourful lineup, including a vegetarian menu. Terrace nestled at the foot of the chateau...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20de%20l'%C3%89glise%2C%20Saint-Aignan%2C%2041110%2C%20France"
    pageTitle="La Salamandre"
  />
);

export default LaSalamandre;
