...
const LaBonneAuberge = () => (
  <RestaurantPage
    restaurantName="La Bonne Auberge"
    address="63 route Nationale, Dury, 80480, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33322950333"
    website="https://www.labonneauberge80.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=63%20route%20Nationale%2C%20Dury%2C%2080480%2C%20France"
    pageTitle="La Bonne Auberge"
  />
);

export default LaBonneAuberge;
