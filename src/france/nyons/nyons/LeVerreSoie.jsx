...
const LeVerreSoie = () => (
  <RestaurantPage
    restaurantName="Le Verre à Soie"
    address="12 place des Arcades, Nyons, 26110, France"
    cuisine="Fusion"
    priceRange="€€"
    phoneNumber="+33475261518"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/nyons/restaurant/le-verre-a-soie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a career at Christian Têtedoie’s restaurant (Lyon), Fei - Hsin and Jérôme Lamy decided to take over this place. He still works as a sommelier, offering appetising food and wine pairings that showcase his wife’s lovely cooking, which is inspired by her Taiwanese origins. A wonderful marriage of French and Asian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20place%20des%20Arcades%2C%20Nyons%2C%2026110%2C%20France"
    pageTitle="Le Verre à Soie"
  />
);

export default LeVerreSoie;
