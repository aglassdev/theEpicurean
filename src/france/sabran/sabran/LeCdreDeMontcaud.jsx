...
const LeCdreDeMontcaud = () => (
  <RestaurantPage
    restaurantName="Le Cèdre de Montcaud"
    address="Hameau de Combes, Sabran, 30200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33466891800"
    website="https://www.chateaudemontcaud.com/restaurant/restaurant-de-montcaud"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hameau%20de%20Combes%2C%20Sabran%2C%2030200%2C%20France"
    pageTitle="Le Cèdre de Montcaud"
  />
);

export default LeCdreDeMontcaud;
