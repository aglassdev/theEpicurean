...
const LesGalinas = () => (
  <RestaurantPage
    restaurantName="Les Galinas"
    address="10 rue Constantin, Aix-en-Provence, 13100, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33987191577"
    website="https://lesgalinas.eatbu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a shady little side street in the old town, three young partners, les galinas (or big boys in Provençal), opened this bistro with a view to bringing back Provençal cuisine in the vein of grandma's home cooking. True to their watchwords of simplicity and flavour, they steer clear of exotic recipes and convoluted new takes on dishes; rather, they keep things local, when it comes to both the vibe and the food: Provençal-style tomatoes (a master class!), competition-level aioli, lamb tripe or monkfish raïto sauce to die for… thanks to the freshest ingredients and a sure hand. A warm welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Constantin%2C%20Aix-en-Provence%2C%2013100%2C%20France"
    pageTitle="Les Galinas"
  />
);

export default LesGalinas;
