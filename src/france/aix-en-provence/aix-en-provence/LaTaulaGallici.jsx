...
const LaTaulaGallici = () => (
  <RestaurantPage
    restaurantName="La Taula Gallici"
    address="Villa Gallici, 18 avenue de la Violette, Aix-en-Provence, 13100, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33442232923"
    website="https://www.villagallici.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Luxury and tradition, with not a hint of ostentation... and far from the crowds, in the upper reaches of town. On the menu: good sun-drenched French cuisine to relish around the low tables of the superb lounges, or by the plane trees on the peaceful terrace. The chef's specialities include chilled lobster and gambero rosso bisque; vitello tonnato-style tortellini, ricotta, sun-dried tomatoes and taggiasche olives; Gallici tiramisu. The spirit of the South of France!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Villa%20Gallici%2C%2018%20avenue%20de%20la%20Violette%2C%20Aix-en-Provence%2C%2013100%2C%20France"
    pageTitle="La Taula Gallici"
  />
);

export default LaTaulaGallici;
