...
const LaTableDeLaMaison = () => (
  <RestaurantPage
    restaurantName="La Table de la Maison"
    address="95 cours du Général-Leclerc, Langon, 33210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33556630048"
    website="https://www.darroze.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the border of the Gironde and Landes départements, the legacy of Claude Darroze is scrupulously upheld in generous, bistronomic food that shines the spotlight on unpretentiously crafted regional produce. Some of the house’s iconic dishes still grace the menu, including tuna carpaccio, lobster and Grand Marnier soufflé with blood orange sorbet. Cheerful, smiling service and a pleasant terrace on sunny days...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=95%20cours%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Langon%2C%2033210%2C%20France"
    pageTitle="La Table de la Maison"
  />
);

export default LaTableDeLaMaison;
