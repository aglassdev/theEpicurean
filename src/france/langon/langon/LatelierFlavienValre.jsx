...
const LatelierFlavienValre = () => (
  <RestaurantPage
    restaurantName="L'Atelier Flavien Valère"
    address="62 cours des Fossés, Langon, 33210, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33556762566"
    website="https://restaurant-latelierfv.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After honing his talents around southwest France, Flavien Valère has decided to treat Langon to his culinary flair. He knows his stuff, no doubt about that: impeccable cooking techniques, perfect seasonings, premium produce and carefully crafted recipes – everything is from scratch, to our delight! Eater-friendly priced lunchtime menu. Bookings advisable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20cours%20des%20Foss%C3%A9s%2C%20Langon%2C%2033210%2C%20France"
    pageTitle="L'Atelier Flavien Valère"
  />
);

export default LatelierFlavienValre;
