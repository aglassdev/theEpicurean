...
const LePetitHenri = () => (
  <RestaurantPage
    restaurantName="Le Petit Henri"
    address="Grand Hôtel Henri, 1 cours René-Char, L'Isle-sur-la-Sorgue, 84800, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33490381052"
    website="https://www.grandhotelhenri.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand%20H%C3%B4tel%20Henri%2C%201%20cours%20Ren%C3%A9-Char%2C%20L'Isle-sur-la-Sorgue%2C%2084800%2C%20France"
    pageTitle="Le Petit Henri"
  />
);

export default LePetitHenri;
