...
const Solelh = () => (
  <RestaurantPage
    restaurantName="Solelh"
    address="30 avenue des Compagnons-de-la-Libération, L'Isle-sur-la-Sorgue, 84800, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490890142"
    website="https://solelh-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owners of the fine dining Le Vivier establishment were happily inspired when they opened this bistro, blessed with a double terrace, in the heart of the Carré des Arts du Luberon. From his open-plan kitchen, the chef rustles up a forthright, modern take on traditional bistro recipes, in addition to nibbles with pre-dinner drinks and choice ingredients grilled on a binchotan barbecue (aged rib of beef, squid, presa iberica, etc.). A concise selection of regional (but not only) wines adds the finishing touch to an excellent, sun-drenched meal…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20avenue%20des%20Compagnons-de-la-Lib%C3%A9ration%2C%20L'Isle-sur-la-Sorgue%2C%2084800%2C%20France"
    pageTitle="Solelh"
  />
);

export default Solelh;
