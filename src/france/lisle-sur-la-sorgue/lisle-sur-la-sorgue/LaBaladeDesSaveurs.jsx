...
const LaBaladeDesSaveurs = () => (
  <RestaurantPage
    restaurantName="La Balade des Saveurs"
    address="3 quai Jean-Jaurès, L'Isle-sur-la-Sorgue, 84800, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33490952785"
    website="https://www.balade-des-saveurs.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant young couple – Benjamin and Sophie Fabre – run this spruce and stylish restaurant, which boasts a terrace running alongside the picturesque River Sorgue. The dishes manage to encapsulate and convey both the character and the sweetness of Provence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20quai%20Jean-Jaur%C3%A8s%2C%20L'Isle-sur-la-Sorgue%2C%2084800%2C%20France"
    pageTitle="La Balade des Saveurs"
  />
);

export default LaBaladeDesSaveurs;
