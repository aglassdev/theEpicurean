...
const LaigleDorOST = () => (
  <RestaurantPage
    restaurantName="À l'Aigle d'Or"
    address="14 rue de Gerstheim, Osthouse, 67150, France"
    cuisine="Classic Cuisine, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33388980682"
    website="https://www.hotelalaferme.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At one corner of this imposing village house, the wrought-iron eagle seems to herald your arrival. Inside, tuck into classic dishes (home-made goose foie gras terrine with port jelly, Paul Haeberlin's mousseline of frogs’ legs, sole meunière prepared tableside…) in a traditional and inviting setting. Less formal atmosphere in the winstub...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20de%20Gerstheim%2C%20Osthouse%2C%2067150%2C%20France"
    pageTitle="À l'Aigle d'Or"
  />
);

export default LaigleDorOST;
