...
const LeQuaiTAI = () => (
  <RestaurantPage
    ...
    address="17 rue Joseph-Peala, Tain-l'Hermitage, 26600, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33475070590"
    website="https://www.chabran.com/pages/le-quai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You could stay on this quayside for hours admiring the Rhône and the vineyards. On the terrace or in the bright dining area, you could almost be on an ocean liner! A modern-day bistro in which to enjoy generous dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20Joseph-Peala%2C%20Tain-l'Hermitage%2C%2026600%2C%20France"
    pageTitle="Le Quai"
  />
);

export default LeQuaiTAI;
