...
const LaBelleVie = () => (
  <RestaurantPage
    ...
    address="4 avenue Paul-Blisson, Saint-Hilaire-d'Ozilhan, 30210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33466372915"
    website="https://www.labellevie-hotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a picturesque village not far from the Pont-du-Gard, Denis Martin (ex The Marcel) and his wife Joana have set up shop in a handsome limestone building. The chef crafts spot-on, expressive dishes, in which lamb from Les Baux, Mediterranean seabass and the rich Occitan terroir take centre stage – to be savoured on the terrace or in the bright interior. A champion of regional produce, the chef crafts a festival of spot-on, well-balanced dishes. The weekday lunchtime menu is excellent value for money. Why not stay overnight in one of the attractive guestrooms and enjoy the swimming pool? In a nutshell: the good life!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20avenue%20Paul-Blisson%2C%20Saint-Hilaire-d'Ozilhan%2C%2030210%2C%20France"
    pageTitle="La Belle Vie"
  />
);

export default LaBelleVie;
