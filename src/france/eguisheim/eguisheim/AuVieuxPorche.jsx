...
const AuVieuxPorche = () => (
  <RestaurantPage
    restaurantName="Au Vieux Porche"
    address="16 rue des Trois-Châteaux, Eguisheim, 68420, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33389240190"
    website="https://www.auvieuxporche.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This typical residence (1707) stands in the winegrowing estate of the manager's family. His partner cooks classic regional dishes, but he is also a winemaker. So it goes without saying that you can enjoy some fine vintages here too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20des%20Trois-Ch%C3%A2teaux%2C%20Eguisheim%2C%2068420%2C%20France"
    pageTitle="Au Vieux Porche"
  />
);

export default AuVieuxPorche;
