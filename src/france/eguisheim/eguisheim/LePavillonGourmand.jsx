...
const LePavillonGourmand = () => (
  <RestaurantPage
    restaurantName="Le Pavillon Gourmand"
    address="101 rue du Rempart-Sud, Eguisheim, 68420, France"
    cuisine="Modern Cuisine, Alsatian"
    priceRange="€€"
    phoneNumber="+33389243688"
    website="https://pavillon-gourmand.eatbu.com/?lang=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This village house (1683) offers a setting bathed in light, tastefully combining the historical character of the building with more contemporary touches. Tuck into cuisine that includes Alsace recipes (onion tart, sauerkraut, wild boar stew) and more modern dishes. Wines from the Eguisheim vineyard are well represented, and the small terrace is popular in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101%20rue%20du%20Rempart-Sud%2C%20Eguisheim%2C%2068420%2C%20France"
    pageTitle="Le Pavillon Gourmand"
  />
);

export default LePavillonGourmand;
