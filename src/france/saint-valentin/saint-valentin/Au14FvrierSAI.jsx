...
const Au14FvrierSAI = () => (
  <RestaurantPage
    restaurantName="Au 14 Février"
    address="2 rue du Portail, Saint-Valentin, 36100, France"
    ...
    bio="Japan boasts two museums devoted to the cartoonist Raymond Peynet, who created the famous lovers in 1942, immortalised by a postage stamp. Some of his Japanese admirers thus naturally chose the small village of Saint Valentin to celebrate February 14 in culinary style. In a stripped-back, contemporary interior, graced with posters and lithographs by Peynet, a 100% Japanese brigade conjures up a subtle new take on modern Gallic fare, scattered with delicate Japanese notes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Portail%2C%20Saint-Valentin%2C%2036100%2C%20France"
    pageTitle="Au 14 Février"
  />
);

export default Au14FvrierSAI;
