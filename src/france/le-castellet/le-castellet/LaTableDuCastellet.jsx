...
const LaTableDuCastellet = () => (
  <RestaurantPage
    restaurantName="La Table du Castellet"
    address="3001 route des Hauts-du-Camp, au Circuit Paul Ricard, Le Castellet, 83330, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33494983777"
    website="https://www.hotelducastellet.net/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The walls of this well-known luxury resort is a haven of Provençal bliss from the grounds overlooking the Var hinterland and the sea on the horizon to the ponds, lavender beds and superb cuisine rich in the scents and flavours of the South of France. Former sous-chef to Christophe Bacquié, Fabien Ferré is going from strength to strength and his artistic sensitivity for Mediterranean produce calls to mind Matisse, who was captivated by the light of Provence. Ferré crafts a high-flying veggie and seafood score, starring dishes such as shrimp carabineros with Meyer lemon and coral roe sauce, or squid in marjoram. His refined and virtuoso cuisine elevates the natural flavour of the ingredients, bolstered by memorable full-bodied sauces, a case in point being the aloe vera-scented vinaigrette t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3001%20route%20des%20Hauts-du-Camp%2C%20au%20Circuit%20Paul%20Ricard%2C%20Le%20Castellet%2C%2083330%2C%20France"
    pageTitle="La Table du Castellet"
  />
);

export default LaTableDuCastellet;
