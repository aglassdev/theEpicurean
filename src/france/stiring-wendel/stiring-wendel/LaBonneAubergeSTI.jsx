...
const LaBonneAubergeSTI = () => (
  <RestaurantPage
    restaurantName="La Bonne Auberge"
    address="15 rue Nationale, Stiring-Wendel, 57350, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33387875278"
    website="https://guide.michelin.com/en/grand-est/stiring-wendel/restaurant/la-bonne-auberge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lydia Egloff prepares inventive cuisine with complex flavours, while her sister gracefully welcomes diners. Unusual decor and a winter garden with bay windows. A fine wine list. The name says it all!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20Nationale%2C%20Stiring-Wendel%2C%2057350%2C%20France"
    pageTitle="La Bonne Auberge"
  />
);

export default LaBonneAubergeSTI;
