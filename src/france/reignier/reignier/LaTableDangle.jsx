...
const LaTableDangle = () => (
  <RestaurantPage
    restaurantName="La Table d'Angèle"
    address="273 Grande-Rue, Reignier, 74930, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33450311616"
    website="https://www.tabledangele.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant flanked by a conservatory proposes appetising bistro food in a contemporary setting. Dishes you may find on the menu include roasted calf sweetbreads, pan-fried chanterelles and lardons, meurette sauce; Angus entrecôte and fresh chips from Savoie... Quiet terrace to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=273%20Grande-Rue%2C%20Reignier%2C%2074930%2C%20France"
    pageTitle="La Table d'Angèle"
  />
);

export default LaTableDangle;
