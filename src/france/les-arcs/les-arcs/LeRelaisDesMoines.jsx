...
const LeRelaisDesMoines = () => (
  <RestaurantPage
    restaurantName="Le Relais des Moines"
    address="Route de Sainte-Roseline, Les Arcs, 83460, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33494474093"
    website="https://www.lerelaisdesmoines.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestling amid the greenery, this gorgeous 16C bastide looks out over the Massif des Maures and the picturesque village of Arc-sur-Argens. The son of restaurateurs from the South-West, Sébastien Sanjou has set up shop in the Var, where his early endeavours were supported by Jacques Maximin and Alain Ducasse. This native of Tarbes is savvily making the Mediterranean terroir his own, cultivating, for example, an exceptional partnership with market gardener Philippe Auda. Wonderfully ripe and juicy tomatoes, served with a basil sorbet and burrata and seasoned with olive oil and Baume de Bouteville vinegar, make for a fantastically sunny starter. This is typical of his cuisine: colourful and imaginative, with, at the heart of each dish, a wonderful ingredient that has been carefully prepared wi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Sainte-Roseline%2C%20Les%20Arcs%2C%2083460%2C%20France"
    pageTitle="Le Relais des Moines"
  />
);

export default LeRelaisDesMoines;
