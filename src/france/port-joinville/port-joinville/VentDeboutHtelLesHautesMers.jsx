...
const VentDeboutHtelLesHautesMers = () => (
  <RestaurantPage
    restaurantName="Vent Debout - Hôtel Les Hautes Mers"
    address="27 rue Pierre-Henry, Port-Joinville, 85350, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33251370112"
    website="https://www.lesdomainesdefontenille.com/les-hautes-mers.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just imagine: the Île d'Yeu, a pretty little hotel overlooking the sea, a chic, laid-back restaurant, a terrace and a dining area decorated with models of old sailing ships... All in all, a truly charming spot for food lovers who can expect a deliciously fishy regional menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20Pierre-Henry%2C%20Port-Joinville%2C%2085350%2C%20France"
    pageTitle="Vent Debout - Hôtel Les Hautes Mers"
  />
);

export default VentDeboutHtelLesHautesMers;
