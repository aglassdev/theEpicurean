...
const LeGardeChamptre = () => (
  <RestaurantPage
    restaurantName="Le Garde Champêtre"
    address="50 route des Riceys, Gyé-sur-Seine, 10250, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33352960006"
    website="https://legardechampetre.fr"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Garde Champêtre stands practically at the foot of Notre-Dame des Vignes and within spitting distance of the renowned Les Riceys vineyards. This railway warehouse has been turned into a sustainable farm restaurant with greenhouses and an organic vegetable garden by a group of partners who have also teamed up with two local winegrowers. They serve fresh and fortifying cuisine based on top-notch ingredients sourced locally or from the garden: parsnip tartlet, smoked stracciatella, la-yu and cashews; pollack, pil-pil sauce, carrot cream and puntarelle salad; citrus fruit, crémet d'Anjou, almond praline, yoghurt foam and orange chips. The bucolic terrace is lovely for sunny days...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20route%20des%20Riceys%2C%20Gy%C3%A9-sur-Seine%2C%2010250%2C%20France"
    pageTitle="Le Garde Champêtre"
  />
);

export default LeGardeChamptre;
