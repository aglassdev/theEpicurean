...
const LaFermeDeVoisins = () => (
  <RestaurantPage
    restaurantName="La Ferme de Voisins"
    address="4 rue de Port-Royal, Voisins-le-Bretonneux, 78960, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33130441818"
    website="https://www.lafermedevoisins.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You reach this lovely 19C farmhouse via a flower-decked courtyard, which serves as a patio in summertime. The relatively concise menu shines the spotlight on the house classics, which are prawns on sticks, the ‘irreplaceable’ calf’s head and signature desserts such as the rum and orange punch baba, together with a range of tasty and creative dishes. A fine establishment to try out post-haste!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20de%20Port-Royal%2C%20Voisins-le-Bretonneux%2C%2078960%2C%20France"
    pageTitle="La Ferme de Voisins"
  />
);

export default LaFermeDeVoisins;
