...
const LaCharrueREX = () => (
  <RestaurantPage
    restaurantName="La Charrue"
    address="13 rue Principale, Rexingen, 67320, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33388017736"
    website="https://guide.michelin.com/en/grand-est/rexingen/restaurant/la-charrue"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run eatery (father and daughter in the kitchen, mum in the dining room) proposes dishes inspired by quality produce with contemporary flourishes (duck foie gras with gewurztraminer wine and raspberry chutney; monkfish from Brittany with turmeric and baby vegetables ; mirabelle plum tart with strudel and pistachio ice-cream)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Principale%2C%20Rexingen%2C%2067320%2C%20France"
    pageTitle="La Charrue"
  />
);

export default LaCharrueREX;
