...
const LeGotDuLarge = () => (
  <RestaurantPage
    restaurantName="Le Goût du Large"
    address="4 place Notre-Dame, Le Tréport, 76470, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33235843987"
    website="https://le-gout-du-large.zensites.zenchef.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sheltered from the bustling port, take a seat in this cosy, modern eatery and dig into the contemporary, generous nosh of youthful Jonathan Selliez (assisted by his mum for pastries) who plays on textures and flavours. The fish is from sustainable fishing boats, such as the superb fillet of mackerel, flanked with a maki of leeks rolled in nori seaweed leaves and a medley of carrots, jelly and pickled. All the more reason not to set sail straight away…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20place%20Notre-Dame%2C%20Le%20Tr%C3%A9port%2C%2076470%2C%20France"
    pageTitle="Le Goût du Large"
  />
);

export default LeGotDuLarge;
