...
const Acacia = () => (
  <RestaurantPage
    restaurantName="Acacia"
    address="230 boulevard de la Plage, Arcachon, 33120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33557159221"
    website="https://www.acacia-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Make a beeline for this little place in the heart of Arcachon, just a stone's throw from the beach. Behind the black and white storefront, there is a restaurant with a modern decor and a retro touch. The chef knows his stuff, astutely revising bistronomy and traditional dishes: eg a wonderful terrine of black Bigorre pork/poultry, updated with a red onion and pear compote; veal in a herb crust, sweet potato gnocchi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=230%20boulevard%20de%20la%20Plage%2C%20Arcachon%2C%2033120%2C%20France"
    pageTitle="Acacia"
  />
);
