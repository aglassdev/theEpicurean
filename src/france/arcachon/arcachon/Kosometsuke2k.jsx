...
const Kosometsuke2k = () => (
  <RestaurantPage
    restaurantName="Ko-sometsuke 2K"
    address="156 boulevard de la Plage, Arcachon, 33120, France"
    cuisine="Asian"
    priceRange="€€"
    phoneNumber="+33556836769"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/arcachon/restaurant/ko-sometsuke-2k"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Originally from Cambodia, the Khong family settled in Arcachon, and now they are the ones inviting diners on a journey: from China and Japan to Southeast Asia, using regional ingredients. Don't miss the dim sum, the real stars of the show, wrapped in a remarkably fine dough...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=156%20boulevard%20de%20la%20Plage%2C%20Arcachon%2C%2033120%2C%20France"
    pageTitle="Ko-sometsuke 2K"
  />
);

export default Kosometsuke2k;
