...
const BriketBistrot = () => (
  <RestaurantPage
    restaurantName="Briket' Bistrot"
    address="142 rue de l'Église, Guéthary, 64210, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33559265134"
    website="https://www.briketenia.com/fr/briket-cote-bistrot.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the heights of the picturesque village of Guéthary, the Ibarboure family hotel also operates this pleasant bistro, independent from their fine dining restaurant. The chef crafts meticulous, delicate and flavoursome food in an uncluttered setting. Basque ingredients dominate the generous dishes of the concise menu: Bayonne ham, bellota chorizo, Banka trout, Ardi-Gasna cheese. A youthful, friendly team and sensible prices. A real treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=142%20rue%20de%20l'%C3%89glise%2C%20Gu%C3%A9thary%2C%2064210%2C%20France"
    pageTitle="Briket' Bistrot"
  />
);

export default BriketBistrot;
