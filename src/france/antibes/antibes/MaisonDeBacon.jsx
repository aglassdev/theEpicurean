...
const MaisonDeBacon = () => (
  <RestaurantPage
    restaurantName="Maison de Bacon"
    address="664 boulevard de Bacon, Antibes, 06600, France"
    cuisine="Mediterranean Cuisine, Seafood"
    priceRange="€€€€"
    phoneNumber="+33493615002"
    website="https://maisondebacon.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Bâcon, an Antibes institution since 1948, has been transformed into the Maison de Bâcon. In the kitchens, Nicolas Davouze, formerly of Bocuse and Le Bristol, celebrates the house's signature dishes (such as rockfish soup, bouillabaisse, millefeuille), alongside a fine selection of fish grilled over a wood fire. Splendid view of the sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=664%20boulevard%20de%20Bacon%2C%20Antibes%2C%2006600%2C%20France"
    pageTitle="Maison de Bacon"
  />
);

export default MaisonDeBacon;
