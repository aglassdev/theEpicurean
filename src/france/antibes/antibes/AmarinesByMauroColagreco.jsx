...
const AmarinesByMauroColagreco = () => (
  <RestaurantPage
    restaurantName="Amarines by Mauro Colagreco"
    address="Villa Miraé, 770 chemin de la Garoupe, Antibes, 06160, France"
    cuisine="Creative, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33492933161"
    website="https://www.restaurantamarines.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of a luxurious boutique hotel on the Cap d'Antibes peninsula, this creative fine dining establishment is helmed by renowned chef Mauro Colagreco. The restaurant occupies a charming pavilion set within the hotel gardens. Its dining room, which boasts a decor inspired by the sea and the natural world, opens onto a terrace planted with mulberry plane trees. Expect refined interpretations of Mediterranean cuisine: gamberoni prawn carpaccio with citrus and basil oil; wild-caught Mediterranean fish, sauce vierge with Taggiasca olives, preserved lemon, capers and fennel; floating island calisson-style, lavender-infused crème anglaise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Villa%20Mira%C3%A9%2C%20770%20chemin%20de%20la%20Garoupe%2C%20Antibes%2C%2006160%2C%20France"
    pageTitle="Amarines by Mauro Colagreco"
  />
);

export default AmarinesByMauroColagreco;
