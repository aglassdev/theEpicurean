...
const LeVauban = () => (
  <RestaurantPage
    restaurantName="Le Vauban"
    address="7 bis rue Thuret, Antibes, 06600, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33493343305"
    website="https://www.levauban.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a bustling street in the old town, Le Vauban serves up good contemporary French cuisine that is in step with the seasons and technically sound. Particular attention is paid to the choice of ingredients: amberjack carpaccio with citrus fruits and caviar; low-temperature guinea fowl ballotine; passion fruit soufflé and banana sorbet. It is wise to book...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20bis%20rue%20Thuret%2C%20Antibes%2C%2006600%2C%20France"
    pageTitle="Le Vauban"
  />
);

export default LeVauban;
