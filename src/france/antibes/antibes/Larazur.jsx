...
const Larazur = () => (
  <RestaurantPage
    restaurantName="L'Arazur"
    address="8 rue des Palmiers, Antibes, 06600, France"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+33493347560"
    website="https://www.larazur.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the helm of this pocket - sized restaurant tucked away in historic Antibes, the owner - chef celebrates the seasons with fresh, colourful and simply prepared dishes. Vegetables are particularly pampered. A delicious moment in store for your taste buds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20des%20Palmiers%2C%20Antibes%2C%2006600%2C%20France"
    pageTitle="L'Arazur"
  />
);

export default Larazur;
