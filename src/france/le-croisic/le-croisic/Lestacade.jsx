...
const Lestacade = () => (
  <RestaurantPage
    restaurantName="L'Estacade"
    address="4 quai du Lénigo, Le Croisic, 44490, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33240230377"
    website="https://lestacade.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant eatery on the quayside, opposite the fish market, is managed by two young people with experience in some elite establishments. They propose hearty and meticulously made food that makes good use of regional produce (fish, shellfish and seaweed, of course, but also meat). The lady of the house is a radiant hostess. Smiling staff and attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20quai%20du%20L%C3%A9nigo%2C%20Le%20Croisic%2C%2044490%2C%20France"
    pageTitle="L'Estacade"
  />
);

export default Lestacade;
