...
const LeLnigo = () => (
  <RestaurantPage
    restaurantName="Le Lénigo"
    address="11 quai du Lénigo, Le Croisic, 44490, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33240230031"
    website="https://www.lelenigo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant located opposite the fish market is run by a very pleasant family. Seaside atmosphere (varnished wood, portholes) and fresh, carefully prepared seafood dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20quai%20du%20L%C3%A9nigo%2C%20Le%20Croisic%2C%2044490%2C%20France"
    pageTitle="Le Lénigo"
  />
);

export default LeLnigo;
