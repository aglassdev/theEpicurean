...
const Locan = () => (
  <RestaurantPage
    restaurantName="L'Océan"
    address="Port-Lin, Le Croisic, 44490, France"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+33240629003"
    website="https://www.hotelrestaurant-locean.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in 1981 by Louis and Yolande André, who are now assisted by their daughter Dominique and son-in-law Gérard Samson, L’Océan is a treat for the eye and the palate thanks to the huge conservatory and a menu that stars supremely fresh first-class seafood and fish. The establishment’s timeless signature dishes never fail to deliver: seafood platters, scallops in season, sole meunière or whole seabass in a salt crust (to be shared). We also recommend the big-boned lobster bisque, rich in whole pieces of perfectly cooked lobster and deliciously crunchy croutons. Finish with a wickedly tempting rum and raisin baba – the epitome of comforting nostalgia as you watch the sun set over the waves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Port-Lin%2C%20Le%20Croisic%2C%2044490%2C%20France"
    pageTitle="L'Océan"
  />
);

export default Locan;
