...
const LesJardinsDeKerstphanie = () => (
  <RestaurantPage
    restaurantName="Les Jardins de Kerstéphanie"
    address="Route du Roaliguen, Sarzeau, 56370, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297417241"
    website="https://lesjardinsdekerstephanie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old stone farmstead smothered in Virginia creeper and set in wooded grounds is the HQ of Emmanuel Kouri, previously encountered at Les Climats (Paris). Mindful of the provenance of his produce (line-caught fish, organic market gardeners, local dairy produce), he crafts a predominantly seafood score, like flame-licked young mackerel, carrots in verjuice and nasturtium leaves or pearlescent monkfish, courgette dip, marinière of shellfish and salsa verde. To be enjoyed on the shaded terrace in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20du%20Roaliguen%2C%20Sarzeau%2C%2056370%2C%20France"
    pageTitle="Les Jardins de Kerstéphanie"
  />
);

export default LesJardinsDeKerstphanie;
