...
const LeManoirDeKerbot = () => (
  <RestaurantPage
    restaurantName="Le Manoir de Kerbot"
    address="Lieu-dit Kerbot, Sarzeau, 56370, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33297264038"
    website="https://www.hotelrestaurantkerbot.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 16C manor house (once an orphanage) has been converted into a haven for food lovers. Guests are treated to fairly traditional cuisine – warm oysters, semi-cooked foie gras, catch of the day, pulled pork in a spice crust served with an aromatic reduction: tasty, well-crafted recipes all the way! The service is very attentive, and the terrace overlooking a lake is delightful, as are the lovely guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Kerbot%2C%20Sarzeau%2C%2056370%2C%20France"
    pageTitle="Le Manoir de Kerbot"
  />
);

export default LeManoirDeKerbot;
