...
const Lesage = () => (
  <RestaurantPage
    restaurantName="Lesage"
    address="3 place de la Duchesse-Anne, Sarzeau, 56370, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+33297417729"
    website="https://www.hotelrestaurantlesage.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw from the church, Église St Saturnin, this hotel-restaurant is housed in a handsome stone-built 17C Breton residence. The name pays homage to Alain-René Lesage, a native of Sarzeau and author of the picaresque novel Gil Blas. The interior is as charming as the outside promises: exposed beams, old terracotta floor tiles and a fireplace; a smattering of paintings by local artists add a contemporary touch. In the kitchen, the young chef cooks up delicious dishes, perfectly balancing textures and temperatures, and using high-quality ingredients, such as strips of squid, which he sears, sprinkles with Espelette pepper and serves with corn, either creamed, raw or popped...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20place%20de%20la%20Duchesse-Anne%2C%20Sarzeau%2C%2056370%2C%20France"
    pageTitle="Lesage"
  />
);

export default Lesage;
