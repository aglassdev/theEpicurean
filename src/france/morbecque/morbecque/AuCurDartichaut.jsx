...
const AuCurDartichaut = () => (
  <RestaurantPage
    restaurantName="Au Cœur d'Artichaut"
    address="8 avenue des Flandres, Morbecque, 59190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33328480921"
    website="https://www.aucoeurdartichaut.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary restaurant, run by an enthusiastic young couple from the village, is depicted by dishes that keep pace with current tastes, while remaining true to the ingredients and seasons. The lovely dining room is in a conservatory. Attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20avenue%20des%20Flandres%2C%20Morbecque%2C%2059190%2C%20France"
    pageTitle="Au Cœur d'Artichaut"
  />
);

export default AuCurDartichaut;
