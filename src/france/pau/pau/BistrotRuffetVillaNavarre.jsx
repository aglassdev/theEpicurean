...
const BistrotRuffetVillaNavarre = () => (
  <RestaurantPage
    restaurantName="Bistrot Ruffet - Villa Navarre"
    address="59 avenue Trespoey, Pau, 64000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559146565"
    website="https://maisonruffet.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A large 19C villa set in verdant grounds is home to this snugly welcoming establishment with only six tables. The period herringbone parquet flooring and mouldings contrast with the pared-back interior. The single set menu shines the spotlight on first-class ingredients from Bigorre and Béarn in a new take on regional recipes that are as mouthwatering as they are deftly crafted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%20avenue%20Trespoey%2C%20Pau%2C%2064000%2C%20France"
    pageTitle="Bistrot Ruffet - Villa Navarre"
  />
);

export default BistrotRuffetVillaNavarre;
