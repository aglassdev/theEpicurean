...
const JumoCo = () => (
  <RestaurantPage
    restaurantName="Jumo & Co"
    address="6 rue Henri-IV, Pau, 64000, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33524360418"
    website="https://www.jumoandco.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the old town of Pau, twin brothers, one a chef and the other a pastry chef, have successfully launched their family business in a modern bistro-style setting laid out over two floors, complete with a pastry counter and tea room. The menu is a real draw, and also represents great value for money. This talented pair bring a touch of magic to their apparently simple dishes, drawing on sweet and sour jus and a medley of condiments to enhance their ingenious and generous, yet always light cuisine. Think confit pork belly, barbecue jus, pickled vegetables, radishes, polenta croquette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Henri-IV%2C%20Pau%2C%2064000%2C%20France"
    pageTitle="Jumo & Co"
  />
);

export default JumoCo;
