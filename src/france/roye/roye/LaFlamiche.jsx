...
const LaFlamiche = () => (
  <RestaurantPage
    restaurantName="La Flamiche"
    address="20 place de l'Hôtel-de-Ville, Roye, 80700, France"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+33322870056"
    website="https://www.laflamiche.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A classical interior lies behind the large windows of La Flamiche. Here, cuisine with robust traditional foundations is enhanced by a touch of modernity: one example would be the duck foie gras and smoked trout in a Granny Smith jelly, cucumber pickles and apple chutney – a beautifully crafted starter. Then there are the medallions of monkfish with lime, carrot and rocket, perfectly cooked in butter, the good old-fashioned way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20place%20de%20l'H%C3%B4tel-de-Ville%2C%20Roye%2C%2080700%2C%20France"
    pageTitle="La Flamiche"
  />
);

export default LaFlamiche;
