...
const RestaurantPierreGrein = () => (
  <RestaurantPage
    restaurantName="Restaurant Pierre Grein"
    address="180 avenue Régis-Ryckebusch, Manosque, 04100, France"
    cuisine="Modern Cuisine, Provençal"
    priceRange="€€€€"
    phoneNumber="+33492724186"
    website="https://restaurantpierregrein.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Venture into the business park and make your way to this handsome contemporary establishment – you won’t regret it! In a spacious, comfortable conservatory-cum-dining room, chef Pierre Grein curates a modern score of Provençal leaning, steeped in delicacy and high-flying technique: gnocchis with girolles, cream of mushroom soup; local squab roasted whole with fluffy dauphinoise potatoes; a trompe l’œil strawberry and pistachio tart… The sauces and jus deserve a special mention, as does the slick, friendly service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=180%20avenue%20R%C3%A9gis-Ryckebusch%2C%20Manosque%2C%2004100%2C%20France"
    pageTitle="Restaurant Pierre Grein"
  />
);

export default RestaurantPierreGrein;
