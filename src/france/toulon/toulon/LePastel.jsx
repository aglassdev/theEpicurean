...
const LePastel = () => (
  <RestaurantPage
    restaurantName="Le Pastel"
    address="20 rue Victor Micholet - Square Léon Vérane, Toulon, 83000, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33494647395"
    website="https://restaurant-lepastel.eatbu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone's throw from the harbour, this unassuming eatery is a resounding success thanks to the chef’s tasty, delicate Mediterranean cooking. Courgette flowers stuffed with a creamy, herby emulsion; sardines marinated in finger lime; gribiche-style stuffed veal parcels; ravioles of Tamaris mussels in basil with an aioli emulsion. Everything is made from scratch, including the bread. Cheerful and professional welcome from the hostess. Given its success, bookings are essential!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Victor%20Micholet%20-%20Square%20L%C3%A9on%20V%C3%A9rane%2C%20Toulon%2C%2083000%2C%20France"
    pageTitle="Le Pastel"
  />
);

export default LePastel;
