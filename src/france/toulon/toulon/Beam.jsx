...
const Beam = () => (
  <RestaurantPage
    restaurantName="Beam !"
    address="2 rue Hippolyte-Duprat, Toulon, 83000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33627542706"
    website="https://restaurant.letelegraphe.org/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beaming and buzzing! The kitchens of the Télégraphe, a high spot of Toulon’s cultural life, are all go! Energetic Arnaud Tabarec, born in Burgundy, honed his skills in prestigious establishments and was the star chef of the Five Hotel’s Roof in Cannes. Today he is acclaimed for his delicate, predominantly vegetarian cuisine, whose ingredients are of course sourced locally and combined boldly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Hippolyte-Duprat%2C%20Toulon%2C%2083000%2C%20France"
    pageTitle="Beam !"
  />
);
