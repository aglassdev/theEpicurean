...
const Matcha = () => (
  <RestaurantPage
    restaurantName="MatCha"
    address="Montée du Château-Vieux, Cucuron, 84160, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33486785596"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/cucuron/restaurant/matcha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Everything is fresh and made from scratch: the veg comes from small, local growers and the meat and poultry is free range. An enticing menu tailored to modern appetites. Smiling service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mont%C3%A9e%20du%20Ch%C3%A2teau-Vieux%2C%20Cucuron%2C%2084160%2C%20France"
    pageTitle="MatCha"
  />
);
