...
const TableChezRicLautey = () => (
  <RestaurantPage
    restaurantName="À Table ! Chez Éric Léautey"
    address="28 rue Porte-Saint-Martin, Thoiry, 78770, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33134838873"
    website="https://ericleautey.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Being at Chez Eric Léautey is a pleasure. The small porch prepares you for the tasting to come, and your taste buds stand to attention as you read the menu. The suggestions are deliberately down - to - earth, drawing on the seasons and local terroir, such as the veal chop, as tender and juicy as can be. So, what are you waiting for?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20Porte-Saint-Martin%2C%20Thoiry%2C%2078770%2C%20France"
    pageTitle="À Table ! Chez Éric Léautey"
  />
);

export default TableChezRicLautey;
