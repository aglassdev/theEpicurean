...
const LePtitBouchon = () => (
  <RestaurantPage
    restaurantName="Le P'tit Bouchon"
    address="66 rue Bernard-Palissy, Gien, 45500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33238678440"
    website="https://guide.michelin.com/en/centre-val-de-loire/gien/restaurant/le-p-tit-bouchon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant located between the town centre and the Faïencerie de Gien ceramics museum is a real hub of bistronomy. Tradition is somewhat revisited in a short set menu dictated by the seasons, but the crispy duck confit with its coteaux-du-layon sauce and the chocolate fondant are among the must-tries. Tuck in!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20rue%20Bernard-Palissy%2C%20Gien%2C%2045500%2C%20France"
    pageTitle="Le P'tit Bouchon"
  />
);

export default LePtitBouchon;
