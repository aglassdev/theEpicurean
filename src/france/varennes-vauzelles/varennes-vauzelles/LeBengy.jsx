...
const LeBengy = () => (
  <RestaurantPage
    restaurantName="Le Bengy"
    address="25 route de Paris, Varennes-Vauzelles, 58640, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33386380284"
    website="https://www.le-bengy-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot to the north of Nevers, once a roadside café, has been taken over by a pleasant young couple. The chef serves enjoyable traditional cuisine (roast monkfish, curry and lemongrass fumet, courgette and tomato tarte Tatin; chicken supreme, poultry liver and port stuffing), as well as a vegetarian set menu. In fine weather, make a beeline for the quiet terrace to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20route%20de%20Paris%2C%20Varennes-Vauzelles%2C%2058640%2C%20France"
    pageTitle="Le Bengy"
  />
);

export default LeBengy;
