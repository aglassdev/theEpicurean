...
const Haliotis = () => (
  <RestaurantPage
    restaurantName="Haliotis"
    address="3 avenue Charles-de-Gaulle, La Teste-de-Buch, 33260, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33762882873"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/la-teste-de-buch/restaurant/haliotis"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a simple, inviting setting, a couple who are well versed in the culinary arts are breathing new life into traditional cuisine. Prepared collaboratively by both chefs, the food impresses with its clarity, well-chosen ingredients, good sauces and generosity: mullet ceviche, vanilla-infused lemon and seaweed tapioca; quail stuffed with foie gras, peas à la française and a full-bodied jus. This modern eatery also boasts a pretty wood-decked terrace shaded by plane trees. Friendly service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20avenue%20Charles-de-Gaulle%2C%20La%20Teste-de-Buch%2C%2033260%2C%20France"
    pageTitle="Haliotis"
  />
);

export default Haliotis;
