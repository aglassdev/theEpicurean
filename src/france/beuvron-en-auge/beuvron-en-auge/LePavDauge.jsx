...
const LePavDauge = () => (
  <RestaurantPage
    restaurantName="Le Pavé d'Auge"
    address="Le Bourg, Beuvron-en-Auge, 14430, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231792671"
    website="https://www.pavedauge.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated between Caen and Lisieux in the heart of the Pays d’Auge, Beuvron-en-Auge is picture postcard perfect with its 17-18C half-timbered houses, its manors and its gardens decked in flowers come summertime. The restaurant, which occupies the village’s former covered market, is fully in keeping with this olde worlde character. Chef Adrien Haye champions local producers in a bid to work with the best seasonal produce. The enticing culinary lineup allows diners to choose from oysters from Saint-Vaast, lobster from Carteret or John Dory, as well as foie gras, veal sweetbread, tripe and andouille sausage. The quintessence of Normandy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Bourg%2C%20Beuvron-en-Auge%2C%2014430%2C%20France"
    pageTitle="Le Pavé d'Auge"
  />
);

export default LePavDauge;
