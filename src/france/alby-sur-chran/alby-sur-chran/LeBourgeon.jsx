...
const LeBourgeon = () => (
  <RestaurantPage
    restaurantName="Le Bourgeon"
    address="8 place du Trophée, Alby-sur-Chéran, 74540, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450330152"
    website="https://www.restaurantlebourgeon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A picturesque medieval village lined in colourful houses and formerly renowned for its tanners and cobblers is the setting of this burgeoning establishment! Helmed by chef Enzo Duchesne and sommelier Adrien Lavorel, Le Bourgeon nurtures a modern gourmet horticultural score whose ingredients are painstakingly sourced. Veggies take pride of place in the menu, with guest star appearances from meat and fish, in spot-on dishes steeped in aroma and flavour, illustrated by a starter that mixes raw and mashed courgette, goat’s cheese, gremolata and confit of egg yolk. Several menus are available at lunchtime and evening with a mystery menu in the evening and on Saturday lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20place%20du%20Troph%C3%A9e%2C%20Alby-sur-Ch%C3%A9ran%2C%2074540%2C%20France"
    pageTitle="Le Bourgeon"
  />
);

export default LeBourgeon;
