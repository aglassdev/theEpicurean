...
const LeClosHeurtebise = () => (
  <RestaurantPage
    restaurantName="Le Clos Heurtebise"
    address="13 chemin des Capucins, Remiremont, 88200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33329620804"
    website="https://www.leclosheurtebise.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Away from the hustle and bustle, this traditional house run by a friendly couple serves contemporary cuisine. Sample dishes such as marinated Arctic char with pea mousse, or pavlova with gariguette strawberries. The summer terrace boasts a lovely view of the Vosges mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20chemin%20des%20Capucins%2C%20Remiremont%2C%2088200%2C%20France"
    pageTitle="Le Clos Heurtebise"
  />
);

export default LeClosHeurtebise;
