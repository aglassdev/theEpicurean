...
const LesTourellesChteauDapign = () => (
  <RestaurantPage
    restaurantName="Les Tourelles - Château d'Apigné"
    address="20 route de Chavagne, Le Rheu, 35650, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299148066"
    website="https://www.chateau-apigne.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Relax in the blatantly romantic ambiance of this stylish neo-Renaissance castle dating from 1833 set in sprawling grounds. Its exquisite living rooms provide the perfect foil for appetising cuisine made with local produce in tune with modern sensibilities. Rooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20route%20de%20Chavagne%2C%20Le%20Rheu%2C%2035650%2C%20France"
    pageTitle="Les Tourelles - Château d'Apigné"
  />
);

export default LesTourellesChteauDapign;
