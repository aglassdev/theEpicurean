...
const Plantxa = () => (
  <RestaurantPage
    restaurantName="PLANTXA"
    address="58 rue Gallieni, Boulogne-Billancourt, 92100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33146205093"
    website="https://www.plantxa.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the supervision of the renowned Juan Arbelaez, the chef of this bistro signs cuisine replete with unusual South American notes. The dishes are meticulously crafted and served in a laid-back, “home from home arty interior. Invigorating and welcoming!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20rue%20Gallieni%2C%20Boulogne-Billancourt%2C%2092100%2C%20France"
    pageTitle="PLANTXA"
  />
);

export default Plantxa;
