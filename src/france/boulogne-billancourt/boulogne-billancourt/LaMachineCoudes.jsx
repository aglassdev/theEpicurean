...
const LaMachineCoudes = () => (
  <RestaurantPage
    restaurantName="La Machine à Coudes"
    address="57 rue Yves-Kermen, Boulogne-Billancourt, 92100, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+33675424537"
    website="https://www.lamachineacoudes.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcoming and bubbly owner Marlène has a knack for always surrounding herself with a motivated team. They are happy to work with the seasonal produce – scallops and squash – that goes into creating a single set menu at lunchtime, and a more creative and ambitious dinner menu. Good food and wine pairings. An enjoyable moment of bistronomy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20rue%20Yves-Kermen%2C%20Boulogne-Billancourt%2C%2092100%2C%20France"
    pageTitle="La Machine à Coudes"
  />
);

export default LaMachineCoudes;
