...
const LaTableDeCyble = () => (
  <RestaurantPage
    restaurantName="La Table de Cybèle"
    address="38 rue de Meudon, Boulogne-Billancourt, 92100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33146217590"
    website="https://www.latabledecybele.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Franco-American couple is at the helm of this neo bistro. San Francisco-born Cybèle rustles up original recipes in the kitchen, using premium produce: warm lentil salad with a poached egg and button mushrooms or canederli and minestrone of winter veggies… Fine dining and sustainable development go hand in hand here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20de%20Meudon%2C%20Boulogne-Billancourt%2C%2092100%2C%20France"
    pageTitle="La Table de Cybèle"
  />
);

export default LaTableDeCyble;
