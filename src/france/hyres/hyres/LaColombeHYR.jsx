...
const LaColombeHYR = () => (
  <RestaurantPage
    ...
    address="663 route de Toulon, Hyères, 83400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33494353516"
    website="https://restaurantlacolombe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Salmon gravlax with citrus fruit, cream of chives and Timut pepper; slow-cooked lamb, a gutsy jus, cream of sweetcorn and roast winter squash… The generous, seriously Provençal score of Pascal and Nadège Bonamy has made their restaurant, at the foot of the Maurettes range, one of the region’s gourmet beacons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=663%20route%20de%20Toulon%2C%20Hy%C3%A8res%2C%2083400%2C%20France"
    pageTitle="La Colombe"
  />
);

export default LaColombeHYR;
