...
const AubergeQuintessence = () => (
  <RestaurantPage
    restaurantName="Auberge Quintessence"
    address="Route du Col-de-la-Couillole, Roubion, 06420, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33493020260"
    website="https://auberge-quintessence.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At the Col de la Couillole, a pass in the Mercantour National Park, this former refuge run by Pauline and Christophe Billau is a top destination for foodies. These two serve up a warm welcome and a single set menu that draws inspiration from the mountains and changes with the seasons. Diners can indulge in creamy local mountain nettle cappuccino, superb roasted white asparagus, whether tangy with candied citrus fruit or in a sabayon sauce, or lightly smoked Mediterranean tuna served confit-style and subtly counterbalanced by the herbal notes of oxalis. Dishes such as veal from the Plateau de Longon accompanied by confit shallots and a courgette flower filled with pine nuts and a herb cream are brimming with skilfully mastered flavours, while the cheeses are carefully matured. There's nothi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20du%20Col-de-la-Couillole%2C%20Roubion%2C%2006420%2C%20France"
    pageTitle="Auberge Quintessence"
  />
);

export default AubergeQuintessence;
