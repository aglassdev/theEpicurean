...
const LaPetiteFrance = () => (
  <RestaurantPage
    restaurantName="La Petite France"
    address="34 impasse Raymond-Daujat, Montélimar, 26200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33475460794"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/montlimar/restaurant/petite-france"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is worth seeking out this little place up a cul - de - sac in the heart of the old town. It features a lemon yellow decor and traditional cuisine based on the freshest produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20impasse%20Raymond-Daujat%2C%20Mont%C3%A9limar%2C%2026200%2C%20France"
    pageTitle="La Petite France"
  />
);

export default LaPetiteFrance;
