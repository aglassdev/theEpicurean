...
const LaMareAuxOiseaux = () => (
  <RestaurantPage
    restaurantName="La Mare aux Oiseaux"
    address="223 rue du Chef-de-l'Île-Fedrun, Saint-Joachim, 44720, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33240885301"
    website="https://mareauxoiseaux.fr/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A globetrotter and keen ornithologist, (with birds fluttering freely in his garden,) Éric Guérin has invented a universe that is uniquely his own. On an island ringed by circular canals, in the heart of the Brière Regional Nature Park, he has immersed himself in his terroir, all the better to serve up his own superb take on it. Indeed, the chef is an artist at heart, whose first passion is creating. It is in the kitchen that he has found his mode of expression, and for that we are grateful to him! Using first-class ingredients, he crafts appealing natural dishes that are rife with personality, delicacy, freshness – at times his cooking even borders on the poetic. The charm of the location – not least the exotic guestrooms for those who wish to extend their stay – and the warm, efficient we..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=223%20rue%20du%20Chef-de-l'%C3%8Ele-Fedrun%2C%20Saint-Joachim%2C%2044720%2C%20France"
    pageTitle="La Mare aux Oiseaux"
  />
);

export default LaMareAuxOiseaux;
