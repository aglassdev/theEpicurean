...
const Vertfeuille = () => (
  <RestaurantPage
    restaurantName="Vertfeuille"
    address="9 place de l’Eglise, Arc-et-Senans, 25610, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33381574060"
    website="https://www.vertfeuille-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the village, opposite the church and 1km from the Saline Royale, this inn (tommette floor tiles, exposed stone, painted beams, fireplace and contemporary furnishings) has been refurbished and is now home to a restaurant run by Léa Senot and Clément Bourdiaux. The pair, both in their thirties, learnt the ropes under the tutelage of the likes of Anne-Sophie Pic, Georges Blanc, Yoann Conte and Xavier Beaudiment. Their approach is contemporary with regional touches: organic œuf meurette poached in Trousseau wine, Bresse chicken cooked two ways with ancestral vin jaune sauce, and caramelised Belle Fille de Salins apples. Vegetarian set menus are available. Book a guestroom and visit the UNESCO World Heritage saltworks...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20de%20l%E2%80%99Eglise%2C%20Arc-et-Senans%2C%2025610%2C%20France"
    pageTitle="Vertfeuille"
  />
);

export default Vertfeuille;
