...
const LeBistroDuGrandCerf = () => (
  <RestaurantPage
    restaurantName="Le Bistro du Grand Cerf"
    address="31-32 place Isaac-Bensarade, Lyons-la-Forêt, 27480, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33232495050"
    website="https://www.grandcerf.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic - style neo - bistro has bags of character, with its exposed beams, brickwork and a pretty terrace in the cobbled courtyard. It serves bistro - style food squarely focused on the terroir: what are you waiting for?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31-32%20place%20Isaac-Bensarade%2C%20Lyons-la-For%C3%AAt%2C%2027480%2C%20France"
    pageTitle="Le Bistro du Grand Cerf"
  />
);

export default LeBistroDuGrandCerf;
