...
const LaBulleDair = () => (
  <RestaurantPage
    restaurantName="La Bulle d'Air"
    address="22 place d'Allier, Moulins, 03000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33470342461"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/moulins/restaurant/la-bulle-d-air"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From his open kitchen, the chef consummately crafts dishes such as low-temperature arctic char, flanked with a velvety gribiche sauce and a crunchy salad of fennel. The single set lunchtime menu is a steal – all the better when leisurely sampled on the delightful, cobbled patio in summertime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20place%20d'Allier%2C%20Moulins%2C%2003000%2C%20France"
    pageTitle="La Bulle d'Air"
  />
);

export default LaBulleDair;
