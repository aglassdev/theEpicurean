...
const LeBistrotDeGuillaume = () => (
  <RestaurantPage
    restaurantName="Le Bistrot de Guillaume"
    address="13 rue de Pont, Moulins, 03000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33443512382"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/moulins/restaurant/le-bistrot-de-guillaume"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Right in the centre of Moulins, the small dining area is light and intimate, already setting the tone, and we don't need to be asked twice to be shown to our table. But the best is yet to come: in his little kitchen, the chef-owner composes dishes that are delicate and intelligent to the joy of our tastebuds, such as his textbook perfect Provençal aioli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20de%20Pont%2C%20Moulins%2C%2003000%2C%20France"
    pageTitle="Le Bistrot de Guillaume"
  />
);

export default LeBistrotDeGuillaume;
