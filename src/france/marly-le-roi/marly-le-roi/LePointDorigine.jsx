...
const LePointDorigine = () => (
  <RestaurantPage
    restaurantName="Le Point d'Origine"
    address="5 place de l'Abreuvoir, Marly-le-Roi, 78160, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33134517263"
    website="https://www.lepointdorigine.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated opposite the Abreuvoir – the ‘Watering Place’, framed by its famous sculpted horses, this old bourgeois abode is now home to a delicatessen, a wine shop and a restaurant, enthusiastically run by a dynamic team. The restaurant occupies a lovely conservatory with herringbone parquet flooring and an unrivalled view of the Abreuvoir. The chef crafts modern, well-polished dishes: organic œuf parfait, green lentils from Le Puy, smoked herring, parsley sauce and pickled shallots; confit of turbot in Mat-Khen pepper, braised fennel and citrus notes. A stroll in the park after your meal is just the ticket!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20de%20l'Abreuvoir%2C%20Marly-le-Roi%2C%2078160%2C%20France"
    pageTitle="Le Point d'Origine"
  />
);

export default LePointDorigine;
