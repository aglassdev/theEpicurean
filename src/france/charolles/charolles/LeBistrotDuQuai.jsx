...
const LeBistrotDuQuai = () => (
  <RestaurantPage
    restaurantName="Le Bistrot du Quai"
    address="1 avenue de la Libération, Charolles, 71120, France"
    cuisine="Burgundian"
    priceRange="€€"
    phoneNumber="+33385255175"
    website="https://www.maison-doucet.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this new place, standing opposite the parent restaurant on the other side of the road, the chef proposes traditional cuisine and spit - roast meats. Menu du Jour in harmony with the seasons, and Menu Charolais, showcasing produce from Burgundy. Terrace overlooking the river...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20de%20la%20Lib%C3%A9ration%2C%20Charolles%2C%2071120%2C%20France"
    pageTitle="Le Bistrot du Quai"
  />
);

export default LeBistrotDuQuai;
