...
const FrdricDoucet = () => (
  <RestaurantPage
    restaurantName="Frédéric Doucet"
    address="2 avenue de la Libération, Charolles, 71120, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33385241132"
    website="https://www.maison-doucet.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Frédéric Doucet's restaurant is a creative and exciting take on established ideas of terroir and tradition. The son of bistro owners, he was born into the business, and cut his teeth in the kitchens of some of the greats, from Pierre Orsi and Paul Bocuse to the prestigious Maison Troisgros. In his premises nestled in the heart of a village with pointed towers and weathered roofs, the chef breaks it down for diners: nothing but fine ingredients from Saône-et-Loire (including Charolais beef, snails, pike and goat's cheese), prepared with rigorously applied classical techniques that do not exclude flashes of inspiration. Frogs legs in shades of our prairies, The ox is in the meadow, or a delightfully-risen alfalfa soufflé with roasted hazelnuts and hay-infused ice cream are just a few of the ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20avenue%20de%20la%20Lib%C3%A9ration%2C%20Charolles%2C%2071120%2C%20France"
    pageTitle="Frédéric Doucet"
  />
);

export default FrdricDoucet;
