...
const AubergeLaGaillotire = () => (
  <RestaurantPage
    restaurantName="Auberge La Gaillotière"
    address="Lieu-dit La Gaillotière, Château-Thébaud, 44690, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33228213116"
    website="https://auberge-la-gaillotiere.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Grape vines are a prominent feature of this converted wine storehouse, which sports a pleasant rustic vibe. The food juggles appetisingly between textbook tradition and modern influences: cumin-flavoured velvety carrots, confit of poultry gizzards and gorgonzola crumble; fillet of ling, cream of garden sorrel and seasonal veggies… The menu changes once a fortnight. Fine local Val de Loire wines at prices that make sense. Service with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20La%20Gailloti%C3%A8re%2C%20Ch%C3%A2teau-Th%C3%A9baud%2C%2044690%2C%20France"
    pageTitle="Auberge La Gaillotière"
  />
);

export default AubergeLaGaillotire;
