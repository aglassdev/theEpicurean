...
const PalgriChezLhenri = () => (
  <RestaurantPage
    restaurantName="Palégrié Chez l'Henri"
    address="66 rue de la Tour, Autrans-Méaudre en Vercors, 38112, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33476460783"
    website="https://palegrie.fr/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As enthusiastic as ever, Guillaume Monjuré (who first came to our attention in Lyon and Corrençon-en-Vercors) plays host to guests in this family-owned barn, which has been renovated into a table d'hôte-style restaurant. Fanning the flames of his passion for cooking over an open fire, he has set up a wood-burning oven in full view of diners; he cooks absolutely everything in it, from bread first thing in the morning, to vegetables and fish during the meal. This is natural, primitive cuisine that is no less personal and creative for all that. He is able to elevate vegetables, herbs and fish from the local fish farm, in dishes such as his ikejime char, matured for a fortnight and accompanied by courgettes and herbs from the chef's garden. This free-spirited chef also makes forays into Medite..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20rue%20de%20la%20Tour%2C%20Autrans-M%C3%A9audre%20en%20Vercors%2C%2038112%2C%20France"
    pageTitle="Palégrié Chez l'Henri"
  />
);

export default PalgriChezLhenri;
