...
const LLuyChteauDygrande = () => (
  <RestaurantPage
    restaurantName="L & Luy - Château d'Ygrande"
    address="Le Mont, Ygrande, 03160, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33470663311"
    website="https://www.chateauygrande.fr/fr/restaurant-saveurs-gastronomie-auvergne"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Cédric Denaux works his magic in this elegant Directoire château (1835), whose terrace overlooks the Bourbon countryside. His creative and seasonal cooking prominently features plant-based and of course seasonal ingredients. He uses home-grown aromatic herbs, plants and vegetables from the château garden, paired with top-drawer ingredients. The memory of his Roscoff monkfish, dashi stock, marigold petals and purple basil lingers with us still...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Mont%2C%20Ygrande%2C%2003160%2C%20France"
    pageTitle="L & Luy - Château d'Ygrande"
  />
);

export default LLuyChteauDygrande;
