...
const LaMaisonDespous = () => (
  <RestaurantPage
    restaurantName="La Maison Despouès"
    address="911 route de Montadet, Puylausic, 32220, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33542541576"
    website="https://www.lamaisondespoues.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The former home of French pop singer, Pierre Vassiliu, who was N°1 in the hit parade in 1973, is now devoted to singing the praises of amberjack, sautéed girolles and a woody-scented sabayon or figs and fig leaves, served raw, in a chutney and in a sorbet. The culinary score is the work of chef Julien Razemon from les Landes, who honed his skills with the Coussau family. Julien plays a refined, gourmet melody, with the bonus of a view of the Gers hillsides or the Pyrenees (in fine weather) for some tables. Consummate technique, lashings of creativity and a knockout lineup of ingredients, all of which at eater friendly prices: what more could we want?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=911%20route%20de%20Montadet%2C%20Puylausic%2C%2032220%2C%20France"
    pageTitle="La Maison Despouès"
  />
);

export default LaMaisonDespous;
