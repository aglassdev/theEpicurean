...
const MontBlancRestaurantGoter = () => (
  <RestaurantPage
    restaurantName="Mont Blanc Restaurant & Goûter"
    address="16 rue de la Voûte, Hauteluce, 73620, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33479370161"
    website="https://www.montblanc-restaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This tastefully refurbished century-old inn at the edge of the village overlooks the Beaufortain mountains. It is the domain of an enthusiastic young chef who previously worked in pastry at a Michelin-starred establishment. Benoît Goulard proposes surprise set menus drawing on the best produce in the region – always seasonal and eco-sourced. His aim is not to tell some sort of story with each dish, but simply to conjure up refined and contemporary-style cuisine that looks and tastes great, showcasing his keen eye for detail. This also goes for the desserts, which are well worth a try! The same approach prevails in the dining area, with its beautifully dressed tables and irreproachable welcome and service courtesy of hostess Hélène Fleury. There is much to admire in their dedication to deli..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20de%20la%20Vo%C3%BBte%2C%20Hauteluce%2C%2073620%2C%20France"
    pageTitle="Mont Blanc Restaurant & Goûter"
  />
);

export default MontBlancRestaurantGoter;
