...
const LaFermeDuChozal = () => (
  <RestaurantPage
    restaurantName="La Ferme du Chozal"
    address="361 route des Combes, Hauteluce, 73620, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33479381818"
    website="https://www.lafermeduchozal.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant may sport a characteristic rustic Alpine vibe, but the appetising cuisine is no less modern. It is made with fine local ingredients illustrated by Leman fera in grilled leeks and a herby butter or a haunch of tender veal, poivrade artichokes and gnocchis. And let's not forget the remarkable list of Alpine wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=361%20route%20des%20Combes%2C%20Hauteluce%2C%2073620%2C%20France"
    pageTitle="La Ferme du Chozal"
  />
);

export default LaFermeDuChozal;
