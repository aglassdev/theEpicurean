...
const AnneDeBretagne = () => (
  <RestaurantPage
    restaurantName="Anne de Bretagne"
    address="Port de Gravette, 163 boulevard de la Tara, La Plaine-sur-Mer, 44770, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33240215472"
    website="https://www.annedebretagne.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the south bank of the Loire estuary, this imposing contemporary building overlooks the small port of Gravette. Talented chef Mathieu Guibert, a local lad from the Retz region and a farmer’s son, has forged solid ties, founded on respect, with producers from the region who are as passionate about what they do as he is. It is no surprise that seafood plays a star role here. Depending on the catch of the day, the menu might feature lightly cooked prawns, pommes soufflées (‘puffed potatoes’) and an infusion of green cardamon; risotto of haddock, langoustine carpaccio and parmesan emulsion; stuffed monkfish, mushrooms and celery with a beef and lobster jus… Slick, cheerful service by Claire Bâcle. What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Port%20de%20Gravette%2C%20163%20boulevard%20de%20la%20Tara%2C%20La%20Plaine-sur-Mer%2C%2044770%2C%20France"
    pageTitle="Anne de Bretagne"
  />
);

export default AnneDeBretagne;
