...
const LesPrsDeugnieMichelGurard = () => (
  <RestaurantPage
    restaurantName="Les Prés d'Eugénie - Michel Guérard"
    address="Place de l'Impératrice, Eugénie-les-Bains, 40320, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33558050607"
    website="https://lespresdeugenie.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Some chefs owe their reputation as much to their cuisine as to their human qualities: Michel Guérard, who died in August 2024, was one of them. Considered one of the founding fathers of la nouvelle cuisine, admired by his peers the world over, he always put the same passion and dedication into his work, leaving his kitchen teams and family an incomparable gastronomic heritage. At Les Prés d'Eugénie, you get the full experience: the enchanting setting of a gorgeous mansion set in the verdant grounds, a front-of-house team with laser-like attention to the smallest of details… and, above all, cooking that is exceptional in every way. The dishes reflect the DNA of Chef Guérard: a showcasing of naturalist cuisine, of course, an omnipresent lightness of touch, and the ability to marry the most d..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20l'Imp%C3%A9ratrice%2C%20Eug%C3%A9nie-les-Bains%2C%2040320%2C%20France"
    pageTitle="Les Prés d'Eugénie - Michel Guérard"
  />
);

export default LesPrsDeugnieMichelGurard;
