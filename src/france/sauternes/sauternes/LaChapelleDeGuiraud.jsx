...
const LaChapelleDeGuiraud = () => (
  <RestaurantPage
    restaurantName="La Chapelle de Guiraud"
    address="5 Château Guiraud, Sauternes, 33210, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33540248545"
    website="https://www.lachapelledeguiraud.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The setting, located in a premier grand cru Sauternes wine estate and run by the Cercle Guiraud team, is certainly breathtaking: a spacious dining area beneath a lofty vaulted ceiling, an open kitchen and an inviting lounge with a fireplace… The menu rolls out flavoursome, mouthwatering dishes illustrated by poached egg and a sauternes sauce, pâté en croûte in a tribute to Mère Brazier, roast pork shoulder in smoked pepper or desserts like Belle Hélène pears. A well-crafted, patriotic Gallic lineup at sensible prices and a deliciously peaceful terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Ch%C3%A2teau%20Guiraud%2C%20Sauternes%2C%2033210%2C%20France"
    pageTitle="La Chapelle de Guiraud"
  />
);

export default LaChapelleDeGuiraud;
