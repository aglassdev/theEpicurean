...
const LesServagesDarmelle = () => (
  <RestaurantPage
    restaurantName="Les Servages"
    address="841 route des Servages, Les Carroz-d'Arâches, 74300, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450900162"
    website="https://www.servages.com"
    aliases={["Les Servages d'Armelle"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One thing is sure, the chef loves what he does, and this passion is contagious. He creates food that is contemporary, meticulous and generous with superb quality ingredients such as fresh fish and seafood. His John Dory fillets and squid cooked à la plancha are just one delicious example of his dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=841%20route%20des%20Servages%2C%20Les%20Carroz-d'Ar%C3%A2ches%2C%2074300%2C%20France"
    pageTitle="Les Servages"
  />
);

export default LesServagesDarmelle;
