...
const LesArpents = () => (
  <RestaurantPage
    restaurantName="Les Arpents"
    address="5 rue d'Orange, Amboise, 37400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33236209244"
    website="https://restaurant-lesarpents.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the château, this contemporary bistro nestled behind a traditional burgundy-coloured façade makes an impression! Two old friends, who met at Tours hospitality management school, rustle up a flawless culinary experience, delving freely into the abundance of first-rate local produce available, from asparagus and strawberries in season to Roi Rose pork and goat's cheese. Dishes that taste as delicious as they sound include roasted scallops, cauliflower and vanilla oil; or lemon tart sprinkled with dried black lemon, a wickedly tempting detail that makes this dessert irresistible...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20d'Orange%2C%20Amboise%2C%2037400%2C%20France"
    pageTitle="Les Arpents"
  />
);

export default LesArpents;
