...
const Lcluse = () => (
  <RestaurantPage
    restaurantName="L'Écluse"
    address="Rue Racine, Amboise, 37400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247799491"
    website="https://www.ecluse-amboise.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A step away from the royal castle of Amboise and the Clos Lucé, chef Mélanie Popineau can be relied upon for joyful bistronomic cuisine, rich in flavour, in the form of brief seasonal menus. Diners are simply and warmly welcomed by her partner. In fine weather, the leafy terrace shaded by willows is heaven-sent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Racine%2C%20Amboise%2C%2037400%2C%20France"
    pageTitle="L'Écluse"
  />
);

export default Lcluse;
