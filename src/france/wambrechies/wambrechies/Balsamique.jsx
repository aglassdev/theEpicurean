...
const Balsamique = () => (
  <RestaurantPage
    restaurantName="Balsamique"
    address="13 place du Général-de-Gaulle, Wambrechies, 59118, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33320936855"
    website="https://www.balsamique-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef has more than one trick up his sleeve, and his cuisine, poised between terroir-based and modern, is brimming with flavour. Examples include cappuccino of mushrooms, grilled parsnips and Wambrechies whisky caramel. Bold dishes based on quality ingredients (fish from Boulogne-sur-Mer, for example). Slick service. The peaceful little terrace is a real draw, especially on summer evenings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20place%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Wambrechies%2C%2059118%2C%20France"
    pageTitle="Balsamique"
  />
);

export default Balsamique;
