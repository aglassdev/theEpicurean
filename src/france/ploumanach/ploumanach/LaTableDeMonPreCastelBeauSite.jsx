...
const LaTableDeMonPreCastelBeauSite = () => (
  <RestaurantPage
    restaurantName="La Table de mon Père - Castel Beau Site"
    address="Plage de Saint-Guirec, Ploumanach, 22700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33296914087"
    website="https://www.castelbeausite.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Comfortably ensconced in this sleek, elegant interior, soak up the glow of the magnificent sunsets over Plage St Guirec. As you feast your eyes on the view, tuck into carefully presented, contemporary cuisine featuring ingredients of indisputably high quality, such as pigeon from Le Ménez Bré, monkfish, spider crab and white asparagus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plage%20de%20Saint-Guirec%2C%20Ploumanach%2C%2022700%2C%20France"
    pageTitle="La Table de mon Père - Castel Beau Site"
  />
);

export default LaTableDeMonPreCastelBeauSite;
