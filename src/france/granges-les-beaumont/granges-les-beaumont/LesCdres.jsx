...
const LesCdres = () => (
  <RestaurantPage
    restaurantName="Les Cèdres"
    address="25 rue Henri-Machon, Granges-les-Beaumont, 26600, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33475715067"
    website="https://www.restaurantlescedres.fr/fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20Henri-Machon%2C%20Granges-les-Beaumont%2C%2026600%2C%20France"
    pageTitle="Les Cèdres"
  />
);

export default LesCdres;
