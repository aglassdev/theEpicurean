...
const LaTableDeLaBastide = () => (
  <RestaurantPage
    restaurantName="La Table de la Bastide"
    address="La Bastide de Gordes, 61 rue de la Combe, Gordes, 84220, France"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33490721212"
    website="https://airelles.com/fr/destination/gordes-hotel/restaurants/l-orangerie-bistrot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In one of the most picturesque villages of Luberon, this stately home overlooking the valley now houses a luxury hotel and this restaurant, whose exquisite terrace is shaded by chestnut trees while commanding a knockout view. In the manner of a luxury brasserie, the menu adds a Provençal twist to a patriotic lineup of culinary classics: local lamb with green peas and smoked eel. Swish, seamless service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Bastide%20de%20Gordes%2C%2061%20rue%20de%20la%20Combe%2C%20Gordes%2C%2084220%2C%20France"
    pageTitle="La Table de la Bastide"
  />
);

export default LaTableDeLaBastide;
