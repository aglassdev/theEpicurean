...
const LeMasAlexisOsmont = () => (
  <RestaurantPage
    restaurantName="Le Mas - Alexis Osmont"
    address="Chemin de Saint-Blaise (Les Imberts), Gordes, 84220, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33490040357"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/gordes/restaurant/le-mas-alexis-osmont"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alexis Osmont’s market-inspired cuisine is as spontaneous as the old farmhouse seems timeless. Let yourself be transported into Alexis’ creative and culinary universe – he cannot be rivalled for his knack for enhancing the treasures of the Vaucluse: asparagus, girolle mushrooms, artichoke…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Saint-Blaise%20(Les%20Imberts)%2C%20Gordes%2C%2084220%2C%20France"
    pageTitle="Le Mas - Alexis Osmont"
  />
);

export default LeMasAlexisOsmont;
