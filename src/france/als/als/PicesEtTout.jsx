...
const PicesEtTout = () => (
  <RestaurantPage
    restaurantName="Épices et Tout"
    address="15 avenue Carnot, Alès, 30100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466524379"
    website="https://www.epicesettout.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant with an unobtrusive façade will wake up your taste buds. Carefully prepared dishes, fresh produce and judiciously deployed spices. For example, salmon tartare with a duo of lentils, saddle of lamb with mushroom mousseline or spiced poached pear. An appetising menu to relish on the small terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20avenue%20Carnot%2C%20Al%C3%A8s%2C%2030100%2C%20France"
    pageTitle="Épices et Tout"
  />
);

export default PicesEtTout;
