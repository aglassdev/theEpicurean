...
const LaRserveDuPresbytre = () => (
  <RestaurantPage
    restaurantName="La Réserve du Presbytère"
    address="22 Grand-Rue, Montagne, 33570, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33557790343"
    website="https://www.lareservedupresbytere.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite the Romanesque church of a wine-growing village is this eatery serving bistronomy dishes. Diners savour traditional flavours in a decor comprising bistro tables and industrial chairs set up against a backdrop of exposed stone walls. The delicious desserts deserve a special mention: amandine tartlet with figs, raspberry confit and sorbet. Pleasant terrace to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20Grand-Rue%2C%20Montagne%2C%2033570%2C%20France"
    pageTitle="La Réserve du Presbytère"
  />
);

export default LaRserveDuPresbytre;
