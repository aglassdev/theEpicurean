...
const LaTableDeCourcellesChteauDeCourcelles = () => (
  <RestaurantPage
    restaurantName="La Table de Courcelles - Château de Courcelles"
    address="8 rue du Château, Courcelles-sur-Vesle, 02220, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33323741353"
    website="https://www.chateau-de-courcelles.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With the arrival of Italian chef Massimiliano Sena (originally from Sorrento), armed with his impressive CV, this noble and elegant Grand Siècle-style residence has entered a modern culinary era that bodes well. Local and seasonal ingredients take pride of place, and the chef's Italian roots make themselves felt in a delicate and subtle manner. There's no showboating or recourse to culinary techniques just for the sake of it; the confident expertise and harmoniously preserved marriages of flavours allow diners to fully appreciate the slow-cooked egg with its airy chanterelle mousse, or the cod with courgette, raspberry and black garlic. Terrific wine list with over 700 wines. There is a pleasant view of the formal garden and canal from the glass-roofed dining area...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20du%20Ch%C3%A2teau%2C%20Courcelles-sur-Vesle%2C%2002220%2C%20France"
    pageTitle="La Table de Courcelles - Château de Courcelles"
  />
);

export default LaTableDeCourcellesChteauDeCourcelles;
