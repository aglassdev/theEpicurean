...
const AubergeDeValestalire = () => (
  <RestaurantPage
    restaurantName="Auberge de Valestalière"
    address="855 route de Lasalle, Monoblet, 30170, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466854579"
    website="https://www.aubergedevalestaliere.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This whitewashed roadside inn in the Cévennes boasts a terrace with views of the surrounding countryside. The interior decor is simple and straightforward (terracotta floors, wooden tables). Damien in the kitchen and Suzanne in the dining room pay homage to the Cévennes landscape and terroir and its produce (vegetables and wines): trout from Le Vigan served in a cold soup; chicken cooked with preserved lemon. Sincere and generous cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=855%20route%20de%20Lasalle%2C%20Monoblet%2C%2030170%2C%20France"
    pageTitle="Auberge de Valestalière"
  />
);

export default AubergeDeValestalire;
