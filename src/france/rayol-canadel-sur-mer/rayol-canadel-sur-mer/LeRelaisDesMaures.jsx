...
const LeRelaisDesMaures = () => (
  <RestaurantPage
    restaurantName="Le Relais des Maures"
    address="1 avenue Charles-Koecklin, Rayol-Canadel-sur-Mer, 83820, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33494056127"
    website="https://www.lerelaisdesmaures.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This large inn cultivates the taste of the South. The chef conjures up cuisine oozing in Provençal tradition depending on market availability, all of which at sensible prices: seabream and aioli; seabass in parsley and parmesan cream; Solliès strawberries and a sweet pesto. A few guestrooms are available, just a few dozen metres from a D-Day beach. Well-managed and very friendly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20Charles-Koecklin%2C%20Rayol-Canadel-sur-Mer%2C%2083820%2C%20France"
    pageTitle="Le Relais des Maures"
  />
);

export default LeRelaisDesMaures;
