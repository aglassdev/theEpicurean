...
const LaccentDuSoleil = () => (
  <RestaurantPage
    restaurantName="L'Accent du Soleil"
    address="19 route des Cévennes, Saint-Martin-de-Londres, 34380, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33467552310"
    website="https://www.laccentdusoleil.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Previously chef at Château de Mercuès, in the Lot, Philippe Combet serves up good seasonal cuisine, highlighting the region's produce. Truffle or asparagus menu, Quercy lamb... served by his pleasant and professional wife...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20route%20des%20C%C3%A9vennes%2C%20Saint-Martin-de-Londres%2C%2034380%2C%20France"
    pageTitle="L'Accent du Soleil"
  />
);

export default LaccentDuSoleil;
