...
const Ambroisie = () => (
  <RestaurantPage
    restaurantName="Ambroisie"
    address="64 route du Lac, Saint-Didier-de-la-Tour, 38110, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33474972553"
    website="https://www.restaurant-ambroisie.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="What initially draws the eye, right in front of us, is the lake hemmed in by wooded banks – the location alone is worth seeing. But above all there is the remarkable work of the chef – after all, that's what we came for… He excels at transforming fine ingredients (scallops hot-pâté style; Breton lobster with raspberries, dried caviar and mizuna; pigeon breast roasted and smoked on the barbecue). His trompe l'œil desserts are at once amusing and delicious (apricot, lemon, chestnut – depending on the season). For fans of truffles, the chef serves a truffle menu all year round: it wouldn't seem right not to indulge...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64%20route%20du%20Lac%2C%20Saint-Didier-de-la-Tour%2C%2038110%2C%20France"
    pageTitle="Ambroisie"
  />
);

export default Ambroisie;
