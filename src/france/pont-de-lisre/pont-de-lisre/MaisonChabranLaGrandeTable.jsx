...
const MaisonChabranLaGrandeTable = () => (
  <RestaurantPage
    restaurantName="Maison Chabran - La Grande Table"
    address="26 avenue du 45ème-Parallèle, Pont-de-l'Isère, 26600, France"
    ...
    bio="By the side of the legendary N7 holiday road of France, this family business has come a long way after its debut as a small bistro in the 1930s to what is now a culinary landmark. It continues to champion its own distinctive brand of tradition and modernity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20avenue%20du%2045%C3%A8me-Parall%C3%A8le%2C%20Pont-de-l'Is%C3%A8re%2C%2026600%2C%20France"
    pageTitle="Maison Chabran - La Grande Table"
  />
);

export default MaisonChabranLaGrandeTable;
