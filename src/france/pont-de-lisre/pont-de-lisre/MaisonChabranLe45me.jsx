...
const MaisonChabranLe45me = () => (
  <RestaurantPage
    restaurantName="Maison Chabran - Le 45ème"
    address="29 avenue du 45ème-Parallèle, Pont-de-l'Isère, 26600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475846009"
    website="https://www.chabran.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you motor south down the iconic N7 highway, why not stop off in this verdant spot that boasts a shaded terrace overlooking the garden, which is blissful in fine weather? This bistronomic eatery is a pleasant alternative to the parent establishment, a renowned temple of regional gastronomy. In its younger sibling, you will sample light, unstuffy dishes presented in a series of set menus. A few guestrooms are available should you wish to relax for longer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20avenue%20du%2045%C3%A8me-Parall%C3%A8le%2C%20Pont-de-l'Is%C3%A8re%2C%2026600%2C%20France"
    pageTitle="Maison Chabran - Le 45ème"
  />
);

export default MaisonChabranLe45me;
