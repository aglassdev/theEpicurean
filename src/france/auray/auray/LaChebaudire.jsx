...
const LaChebaudire = () => (
  <RestaurantPage
    restaurantName="La Chebaudière"
    address="6 rue Abbé-Joseph-Martin, Auray, 56400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297240984"
    website="https://guide.michelin.com/en/bretagne/auray/restaurant/la-chebaudiere"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosy and newly refurbished interior – wooden floorboards, green and white walls with a few wooden crates affixed to them, modern tables, brown leather chairs – is the showcase for the talents of the chef-patron. His affordable market-fresh cuisine is sure to tantalise the taste buds, thanks to impeccably fresh ingredients teamed with precise cooking and distinct flavours: just-grilled mackerel, aubergine and green olives; catch of the day, mussel cream and artichoke satay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Abb%C3%A9-Joseph-Martin%2C%20Auray%2C%2056400%2C%20France"
    pageTitle="La Chebaudière"
  />
);

export default LaChebaudire;
