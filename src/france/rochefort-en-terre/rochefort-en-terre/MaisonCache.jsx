...
const MaisonCache = () => (
  <RestaurantPage
    restaurantName="Maison Cachée"
    address="9 rue Haute-Candre, Rochefort-en-Terre, 56220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297610471"
    website="https://guide.michelin.com/en/bretagne/rochefort-en-terre_1569018/restaurant/maison-cachee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of this village with no shortage of medieval charm, this half-timbered house decorated with sculpted faces tells a story. Dating from 1478, it was an inn, then a crêperie and is now home to an inviting restaurant. Alban Chartron and Sarah Alba have brought with them the expertise they acquired in prestigious Michelin-starred establishments (Ducasse, Pic, Crillon), ploughing it into a menu they describe as pastoral. Their cuisine is generous, well-crafted and often enhanced by just the right amount of peppers and spices. The dishes are run through with authentic accents: juicy pork ribs, melt-in-the-mouth beetroot and tuna; and rice pudding sprinkled with roasted seeds. Wallet-friendly bistronomy in an original and eclectic setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Haute-Candre%2C%20Rochefort-en-Terre%2C%2056220%2C%20France"
    pageTitle="Maison Cachée"
  />
);

export default MaisonCache;
