...
const Ardent = () => (
  <RestaurantPage
    restaurantName="Ardent"
    address="Loire Valley Lodges, 1 allée de la Duporterie, Esvres-sur-Indre, 37320, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33247388588"
    website="https://loirevalleylodges.com/ardent-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restored farmstead nestling in the midst of sprawling private woodland houses an unconventional property guided by foraging. Wild plants are picked on the estate and the veggies are from the permaculture cottage garden and neighbouring organic farm, acquired by the owners, all of which sets the scene for unexpected creative cuisine. The dining room is wood-rich, while lodges on stilts and artwork set the scene outdoors. The single set several course menu may include green pea and wild sorrel ice cream, flame-licked mackerel and buds of wild brambles or foie gras wrapped in woodland smartweed… A culinary stroll through the scents and flavours of the woods...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Loire%20Valley%20Lodges%2C%201%20all%C3%A9e%20de%20la%20Duporterie%2C%20Esvres-sur-Indre%2C%2037320%2C%20France"
    pageTitle="Ardent"
  />
);
