...
const LePetitParis = () => (
  <RestaurantPage
    restaurantName="Le Petit Paris"
    address="18 rue de la République, Daglan, 24250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553284110"
    website="https://www.le-petit-paris.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of a picturesque Périgord village, this welcoming establishment features two tastefully rustic dining rooms and a large terrace overlooking the village square. The chef, a local lad, takes pride in showcasing regional produce in seasonal menus that change weekly, jazzed up by his globetrotting souvenirs: duck confit nems and houmous made with Périgord walnuts; lamb sweetbread in Monbazillac wine and pink berries, finishing with an iconic dessert - Grand Marnier soufflé...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20de%20la%20R%C3%A9publique%2C%20Daglan%2C%2024250%2C%20France"
    pageTitle="Le Petit Paris"
  />
);

export default LePetitParis;
