...
const Les5Bouchons = () => (
  <RestaurantPage
    restaurantName="Les 5 Bouchons"
    address="24 place Nationale, Montauban, 82000, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33563936564"
    website="https://guide.michelin.com/en/occitanie/montauban/restaurant/les-5-bouchons"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant restaurant for lunch beneath the arcades of Place Nationale, Montauban's architectural pride and joy. The name refers to the five members of the family of experienced chef David Soulier, who works with his wife Joan front of house. Every fortnight, a new seasonal menu showcases well-sourced local ingredients in straightforward, colourful and tasty dishes, for example roasted hazelnuts grown in Tarn-et-Garonne that accompany the beetroot hummus, or the sticks of celeriac and mustard seed pickles served with the pork loin cooked for five hours. Whether seated on the terrace or in the long room with its vaulted ceiling overlooking the kitchen, you'll have an enjoyable meal without breaking the bank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20place%20Nationale%2C%20Montauban%2C%2082000%2C%20France"
    pageTitle="Les 5 Bouchons"
  />
);

export default Les5Bouchons;
