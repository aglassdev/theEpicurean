...
const LeCairnHtelLeCeltique = () => (
  <RestaurantPage
    restaurantName="Le Cairn - Hôtel le Celtique"
    address="82 avenue des Druides, Carnac, 56340, France"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+33297521415"
    website="https://www.restaurant-lecairn.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Carnac-Plage, just a pebble stone's throw from the sandy beach and the sea, Hôtel Le Celtique has been treated to a magnificent Art deco-inspired refurbishment. The menu features a happy marriage of traditional foundations and modern trends, with the occasional exotic spice, such as on the lobster with ajo blanco, squash and goji berries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20avenue%20des%20Druides%2C%20Carnac%2C%2056340%2C%20France"
    pageTitle="Le Cairn - Hôtel le Celtique"
  />
);

export default LeCairnHtelLeCeltique;
