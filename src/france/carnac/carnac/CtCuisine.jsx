...
const CtCuisine = () => (
  <RestaurantPage
    restaurantName="Côté Cuisine"
    address="36 avenue Zacharie-Le-Rouzic, Carnac, 56340, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297575035"
    website="https://www.lannroz.fr/fr/restaurant-gastronomique-etoile-carnac-morbihan"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Modernity meets conviviality at this gourmet getaway nestled in the Lann Roz hotel in Carnac. The brightly decorated restaurant exudes elegance with its carefully laid tables, shelves filled with cookery books, and contemporary touches. Having trained at Le Bristol and at Taillevent, chef Stéphane Cosnier elevates Breton produce with creativity and precision, while also embracing exotic flavours. Open ravioli with langoustines and artichokes in barigoule, line-caught red mullet with shellfish and green curry, or a delicate bourdaloue tart given a modern twist with strawberries: each plate tells its own delicious story...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20avenue%20Zacharie-Le-Rouzic%2C%20Carnac%2C%2056340%2C%20France"
    pageTitle="Côté Cuisine"
  />
);

export default CtCuisine;
