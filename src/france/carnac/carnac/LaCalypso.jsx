...
const LaCalypso = () => (
  <RestaurantPage
    restaurantName="La Calypso"
    address="158 rue du Pô, Carnac, 56340, France"
    cuisine="Seafood, Grills"
    priceRange="€€€"
    phoneNumber="+33297520614"
    website="https://www.calypso-carnac.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming maritime inspired bistro has a loyal band of regulars. They come here to savour the freshest fish and seafood prepared with great simplicity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=158%20rue%20du%20P%C3%B4%2C%20Carnac%2C%2056340%2C%20France"
    pageTitle="La Calypso"
  />
);

export default LaCalypso;
