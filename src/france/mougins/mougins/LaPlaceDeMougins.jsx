...
const LaPlaceDeMougins = () => (
  <RestaurantPage
    restaurantName="La Place de Mougins"
    address="41 place du Commandant-Lamy, Mougins, 06250, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33493901578"
    website="https://laplacedemougins.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the village square as the name suggests! Chic and pleasing are adjectives equally applicable to this charming restaurant and its cuisine, thanks to a passionate and creative chef. Month by month he gives pride of place to a succession of seasonal ingredients... celebrating the truffle, the asparagus and so on...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20place%20du%20Commandant-Lamy%2C%20Mougins%2C%2006250%2C%20France"
    pageTitle="La Place de Mougins"
  />
);

export default LaPlaceDeMougins;
