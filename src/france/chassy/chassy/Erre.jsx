...
const Erre = () => (
  <RestaurantPage
    restaurantName="Erre"
    address="Domaine du Roncemay, Chassy, 89110, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33386735050"
    website="https://roncemay.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a stunning estate complete with a golf course and spa, this former hunting lodge has been turned into a hotel and fine dining restaurant. The vaulted dining area with white tablecloths and an understated contemporary decor looks out onto the green. Originally from the Cévennes, Clément Vergeat (formerly at Guy Savoy and Alliance in Paris, Kokkeriet in Copenhagen) has devised a surprise menu that combines produce from Southern Europe with Northern European techniques: Camargue oysters with dried duck; smoked prawn tartare smørbrød style; fermented strawberries and matured lamb. Marine Mateos, an experienced pastry chef and the chef's partner, gracefully handles the desserts and front-of-house service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20du%20Roncemay%2C%20Chassy%2C%2089110%2C%20France"
    pageTitle="Erre"
  />
);
