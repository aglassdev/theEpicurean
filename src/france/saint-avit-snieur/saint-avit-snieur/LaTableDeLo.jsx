...
const LaTableDeLo = () => (
  <RestaurantPage
    restaurantName="La Table de Léo"
    address="13 rue de l'Abbaye (Le Bourg), Saint-Avit-Sénieur, 24440, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553578915"
    website="https://www.latabledeleo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stone - built house in the heart of the village has a pretty terrace overlooking the church square. Inside, you will discover a great little restaurant with a chef who dares to branch out from the usual regional fare. He pays special attention to his ingredients and how best to present and cook them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20de%20l'Abbaye%20(Le%20Bourg)%2C%20Saint-Avit-S%C3%A9nieur%2C%2024440%2C%20France"
    pageTitle="La Table de Léo"
  />
);

export default LaTableDeLo;
