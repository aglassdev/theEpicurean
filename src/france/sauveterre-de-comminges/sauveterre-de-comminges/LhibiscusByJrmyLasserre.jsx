...
const LhibiscusByJrmyLasserre = () => (
  <RestaurantPage
    restaurantName="L'Hibiscus by Jérémy Lasserre"
    address="Hameau de Gesset, Sauveterre-de-Comminges, 31510, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33562004693"
    website="https://www.hotel-dubarry.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his stronghold in the Hôtel du Barry, at the foot of the Pyrenees, is a chef who knows his stuff: his intelligent, technically sound cuisine (eg low-temperature cooking, espumas and dashi stock) also hints at the 14 years he spent in Asia. The onsen-style slow-cooked egg served with a trilogy of Tarbais beans and mushrooms is one of his specialities. Attentive service and comfortable guestrooms mean there's no reason not to prolong the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hameau%20de%20Gesset%2C%20Sauveterre-de-Comminges%2C%2031510%2C%20France"
    pageTitle="L'Hibiscus by Jérémy Lasserre"
  />
);

export default LhibiscusByJrmyLasserre;
