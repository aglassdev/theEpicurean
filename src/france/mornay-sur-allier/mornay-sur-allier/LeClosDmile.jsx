...
const LeClosDmile = () => (
  <RestaurantPage
    restaurantName="Le Clos d'Émile"
    address="1 Bel-Air, Mornay-sur-Allier, 18600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33248745803"
    website="https://www.closdemile.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This farmhouse is home to a charming restaurant, where Madame takes care of the cooking and Monsieur provides attentive and high-quality service. They propose straightforward and healthy cuisine, with a strong emphasis on produce from farms located within a 30km radius – as well as their own beef and pork. A welcoming place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Bel-Air%2C%20Mornay-sur-Allier%2C%2018600%2C%20France"
    pageTitle="Le Clos d'Émile"
  />
);

export default LeClosDmile;
