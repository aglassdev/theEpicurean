...
const LaGrenouillre = () => (
  <RestaurantPage
    ...
    address="19 rue de la Grenouillère, La Madelaine-sous-Montreuil, 62170, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33321060722"
    website="https://www.lagrenouillere.fr"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Few chefs show such a strong culinary personality as Alexandre Gauthier in La Madelaine-sous-Montreuil. The story unfolds in a space with two tiered metal rooftops (designed by architect Patrick Bouchain) and views onto the verdant surroundings and the kitchens. This is the laboratory in which the chef cooks up contemporary cuisine with French roots, liberated from its certainties and preconceptions. Like an alchemist, he teases out flavours in on-point dishes, each a vignette of creativity in which the ingredients sing the praises of the seasons. Artistic and experimental cuisine, to be savoured in this old farmhouse imbued with a luxury that remains close to nature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20de%20la%20Grenouill%C3%A8re%2C%20La%20Madelaine-sous-Montreuil%2C%2062170%2C%20France"
    pageTitle="La Grenouillère"
  />
);

export default LaGrenouillre;
