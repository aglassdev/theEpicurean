...
const LeMoulinDeTrbes = () => (
  <RestaurantPage
    restaurantName="Le Moulin de Trèbes"
    address="2 rue du Moulin-de-Trèbes, Trèbes, 11800, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468789757"
    website="https://www.lemoulindetrebes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old mill is steeped in charm, illustrated by the terrace directly overlooking the Canal du Midi. The food is simple and modern, with a speciality of caramelised calf sweetbreads with sesame and stewed endives. A real pleasure to be sampled with one of the carefully selected local vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Moulin-de-Tr%C3%A8bes%2C%20Tr%C3%A8bes%2C%2011800%2C%20France"
    pageTitle="Le Moulin de Trèbes"
  />
);

export default LeMoulinDeTrbes;
