...
const FleurDeSel = () => (
  <RestaurantPage
    restaurantName="Fleur de Sel"
    address="15 place Pierre-Fidèle-Bretonneau, Saint-Georges-sur-Cher, 41400, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33254933226"
    website="https://www.fleurdesel41.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of a picturesque village in the Cher valley, close to the Château de Chenonceau, this friendly, contemporary bistro treats diners to fresh seasonal cuisine curated by a talented chef. Mickaël Renard honed his skills in top establishments of the likes of the Hostellerie de Levernois (at the time of Jean Crotet), the Côte d'Or in Saulieu (alongside Bernard Loiseau) and the Auberge des Templiers. Today: tataki of bonito, bulgur, avocado purée and curcuma-flavoured Caesar sauce; steak with Cajun sauce, baby potatoes and button mushrooms. The regulars know that the menu changes frequently and the place is often packed at lunchtime, all the more so because of the very reasonable prices!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20place%20Pierre-Fid%C3%A8le-Bretonneau%2C%20Saint-Georges-sur-Cher%2C%2041400%2C%20France"
    pageTitle="Fleur de Sel"
  />
);

export default FleurDeSel;
