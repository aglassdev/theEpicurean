...
const GrandHtelDuLionDor = () => (
  <RestaurantPage
    restaurantName="Grand Hôtel du Lion d'Or"
    address="69 rue Georges-Clemenceau, Romorantin-Lanthenay, 41200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33254941515"
    website="https://www.hotel-liondor-romorantin.fr/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Marie-Christine and Didier Clément have successfully enhanced Sologne’s pastoral universe in their historic regional gourmet landmark thanks to some fabulous restoration work. The Offard house was entrusted with creating an incredible natural, ‘rural’ interior out of “stone cardboard”, an 18C handicraft about which chef Didier Clément is passionate. The food embodies a gourmet interpretation of the countryside, courtesy of the chef’s research into forgotten herbs and spices: grains of paradise, sand leek, angelica and lemon thyme. Clément signs a patriotic lineup, free of unnecessary frills and paired with succulent jus and sauces. Let’s not forget the knockout wine list which showcases some of the Loire’s top wineries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=69%20rue%20Georges-Clemenceau%2C%20Romorantin-Lanthenay%2C%2041200%2C%20France"
    pageTitle="Grand Hôtel du Lion d'Or"
  />
);

export default GrandHtelDuLionDor;
