...
const Signature = () => (
  <RestaurantPage
    ...
    address="62 chemin de la Promenade, Combloux, 74920, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450931181"
    website="https://signature-combloux.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the threshold of this listed 19C farmhouse, you can see Mont Blanc on the horizon. With its mountain-style interior (wood panelling, whitewashed walls, parquet flooring) and traditional cuisine by Florent Meyer (who has worked with Flocons de Sel chef Emmanuel Renaut), the restaurant is an instant hit… This is thanks, in particular, to the vin jaune sauce that envelops the delicious free-range chicken supreme, or the moreish tartiflette with a nod to the village's terroir – a signature starter. Plus a warm welcome awaits you!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20chemin%20de%20la%20Promenade%2C%20Combloux%2C%2074920%2C%20France"
    pageTitle="Signature"
  />
);
