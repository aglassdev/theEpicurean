...
const Alexperience = () => (
  <RestaurantPage
    restaurantName="Alexperience"
    address="Plan d'eau Biotope, Combloux, 74920, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33450901750"
    website="https://www.alexperiencerestaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set beside a lake and boasting a magnificent view of Mont Blanc, this chalet has a resolutely understated decor. On the menu, traditional cuisine is given free rein, in dishes such as slow-cooked egg, lentils, smoked diot (pork sausages from the regional repertoire) and a bacon emulsion, or beef bourguignon. In fact, the chef won a competition with his pâté en croûte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plan%20d'eau%20Biotope%2C%20Combloux%2C%2074920%2C%20France"
    pageTitle="Alexperience"
  />
);

export default Alexperience;
