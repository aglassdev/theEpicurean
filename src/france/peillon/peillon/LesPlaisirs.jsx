...
const LesPlaisirs = () => (
  <RestaurantPage
    restaurantName="Les Plaisirs"
    address="2 rue Puada-dau-Gourguet, Peillon, 06440, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33493870601"
    website="https://www.lesplaisirs-peillon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This friendly family-run inn is tucked away in a village high in the hinterland of Nice. The young owner-chef, descended from a long line of restaurant owners, throws his heart and soul into preparing Provençal recipes using impeccably selected regional produce. Authentic flavours, fuss-free plating, enticing recipes and eater-friendly prices! What more do we need to say?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Puada-dau-Gourguet%2C%20Peillon%2C%2006440%2C%20France"
    pageTitle="Les Plaisirs"
  />
);

export default LesPlaisirs;
