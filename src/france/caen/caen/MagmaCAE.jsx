...
const MagmaCAE = () => (
  <RestaurantPage
    ...
    address="24 rue Saint-Manvieu, Caen, 14000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33250536986"
    website="https://magma-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This town house, outside the centre of Caen, is almost on the doorstep of the Abbaye-aux-Hommes. Olivier Barbarin, an experienced chef who is no stranger to fine dining, concocts food that resembles his character – uninhibited and appetising, including a nod to his native Auvergne – the purple walls evoke volcanic rock like pozzolan. Bargain priced lunch deal, and the dinner tasting menu changes depending on the market and the chef’s mood...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20Saint-Manvieu%2C%20Caen%2C%2014000%2C%20France"
    pageTitle="Magma"
  />
);

export default MagmaCAE;
