...
const LintuitionDandr = () => (
  <RestaurantPage
    restaurantName="L'Intuition d'André"
    address="16 rue Caponière, Caen, 14000, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33980829170"
    website="https://intuition-andre.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a stint at L'Espérance in Hérouville-Saint-Clair, chef Kim Ortin opened his first restaurant with his partner Hélène on this spot not far from the Abbaye aux Hommes. In this compact bistro designed for food lovers, he does not directly reference his Caribbean origins, but rather draws on his many travels to concoct his well-constructed contemporary cuisine: tuna tataki with poppy seeds and wasabi mayonnaise; rosemary-infused cod, sweet potato purée with vanilla, grilled chorizo cream. For all that, the chef doesn't forget the comforting classics: roasted farmhouse Camembert; beef fillet with butter and fries cooked in beef fat; crème brûlée...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20Caponi%C3%A8re%2C%20Caen%2C%2014000%2C%20France"
    pageTitle="L'Intuition d'André"
  />
);

export default LintuitionDandr;
