...
const LeDauphin = () => (
  <RestaurantPage
    restaurantName="Le Dauphin"
    address="29 rue Gémare, Caen, 14000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231862226"
    website="https://www.le-dauphin-normandie.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place is just the ticket for fans of Normandy's specialities: oysters from the bay of Isigny - sur - Mer, Swiss Normandy pigeon, and Vire andouille sausage. The onus is on ingredients from the region but the chef also knows how to compose more original recipes. Elegant and bright decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20G%C3%A9mare%2C%20Caen%2C%2014000%2C%20France"
    pageTitle="Le Dauphin"
  />
);

export default LeDauphin;
