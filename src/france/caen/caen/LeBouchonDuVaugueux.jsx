...
const LeBouchonDuVaugueux = () => (
  <RestaurantPage
    restaurantName="Le Bouchon du Vaugueux"
    address="12 rue Graindorge, Caen, 14000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33231442626"
    website="https://www.bouchonduvaugueux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a simple exterior is this bistro with the soul of a true bouchon lyonnais (counter, cheek - to - jowl dining). That said, the chef does not limit himself to tradition and adorns his dishes with more modern ideas. Nice selection of wines from producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Graindorge%2C%20Caen%2C%2014000%2C%20France"
    pageTitle="Le Bouchon du Vaugueux"
  />
);

export default LeBouchonDuVaugueux;
