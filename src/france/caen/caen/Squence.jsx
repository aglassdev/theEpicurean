...
const Squence = () => (
  <RestaurantPage
    restaurantName="Séquence"
    address="6 rue du 11-Novembre, Caen, 14000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231993342"
    website="https://www.sequence-restaurant-gastronomique.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Antoine Triquet may have an unusual career path (which led him from insurance to cooking), but the culinary fundamentals are present and correct! Ingredients are carefully selected to put the spotlight on local producers, nature and the seasons, and the cooking is always on point... This is modern, clear and uncluttered cuisine with a sincere, even generous approach! At dinnertime, the set menu is divided into three sequences, each featuring a given ingredient prepared in three different ways, which allows them to use the ingredient in its entirety. For example, veal: veal croquette, vitello sardinia, or standing rump served medium rare, accompanied by an onion purée and a delicious gravy. To be enjoyed in a contemporary decor with an open kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%2011-Novembre%2C%20Caen%2C%2014000%2C%20France"
    pageTitle="Séquence"
  />
);
