...
const LaSittelle = () => (
  <RestaurantPage
    restaurantName="La Sittelle"
    address="33 rue du Maréchal-Leclerc, Aizenay, 85190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251347990"
    website="https://restaurantlasittellecom.wordpress.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This inviting late-1940’s villa is enjoying a new lease of life thanks to two associates, formerly of Locguénolé chateau. The chef enhances regional produce in recipes with a creative twist, displaying a preference for surf and turf dishes. Welcoming and attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20rue%20du%20Mar%C3%A9chal-Leclerc%2C%20Aizenay%2C%2085190%2C%20France"
    pageTitle="La Sittelle"
  />
);

export default LaSittelle;
