...
const LeTilleulChteauDuTheil = () => (
  <RestaurantPage
    restaurantName="Le Tilleul - Château du Theil"
    ...
    pageTitle="Le Tilleul - Château du Theil"
  />
);

export default LeTilleulChteauDuTheil;
