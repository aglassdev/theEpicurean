...
const LeSaltimbanqueAubergeDuMoulin = () => (
  <RestaurantPage
    restaurantName="Le Saltimbanque - Auberge du Moulin"
    address="1500 rue du 8-Mai (lieu-dit du Moulin), Eaucourt-sur-Somme, 80580, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33322270894"
    website="https://www.lesaltimbanque.fr/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="This characterful rural establishment overlooking the Somme Valley is in the hands of a local lad in love with his region. He works with a tight network of local producers, who bear witness to his commitment and loyalty. The several-course surprise menu showcases ingredients from sustainable farms and independent fishermen. Legible flavours whose simplicity and elegance set the scene for a slap-up meal. Splendid wine cellar with over 300 references and a lovely terrace on fine days. What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1500%20rue%20du%208-Mai%20(lieu-dit%20du%20Moulin)%2C%20Eaucourt-sur-Somme%2C%2080580%2C%20France"
    pageTitle="Le Saltimbanque - Auberge du Moulin"
  />
);

export default LeSaltimbanqueAubergeDuMoulin;
