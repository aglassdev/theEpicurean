...
const ChezRic = () => (
  <RestaurantPage
    restaurantName="Chez Éric"
    address="Place Daniel-Viguier, Montfuron, 04110, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33492777532"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/montfuron/restaurant/chez-eric"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the square of a charming village, this dry-stone building has everything you could wish for, from a shaded terrace to a bistro-style interior. To top it all off, the Provençal fare is full of flavour. For instance, the courgette flower stuffed with Brousse cheese and basil, Mediterranean meagre, rockfish stock with saffron and tarte Tatin with apricots from Provence go down a treat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20Daniel-Viguier%2C%20Montfuron%2C%2004110%2C%20France"
    pageTitle="Chez Éric"
  />
);

export default ChezRic;
