...
const Turbulent = () => (
  <RestaurantPage
    restaurantName="Turbulent"
    address="1 rue Durand-Couyère, Trouville-sur-Mer, 14360, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+33231885624"
    website="https://turbulent-trouville.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just off the tourist trail, these premises, once a crêperie, are now the new headquarters of Jarvis Scott. The bad boy chef, previously at the helm of Liquide, flaunted his talents on French TV's Top Chef. There is a rock 'n' roll vibe to this stripped-back, minimalist space: an intimate first room centred on an open kitchen and, upstairs, a communal table seating 10 guests in a more refined atmosphere. Far from the culinary mores of a seaside resort, the chef shakes up diners' expectations with uninhibited pairings that make a statement: frog's legs teamed with merguez, whelks mingling with sauce algérienne. The chef's message is loud and clear: bold flavours delivered without unnecessary frills. The wine list gives pride of place to natural and organic wines. Be sure to book to save disa..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Durand-Couy%C3%A8re%2C%20Trouville-sur-Mer%2C%2014360%2C%20France"
    pageTitle="Turbulent"
  />
);
