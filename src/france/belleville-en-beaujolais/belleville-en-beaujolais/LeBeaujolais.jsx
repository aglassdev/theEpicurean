...
const LeBeaujolais = () => (
  <RestaurantPage
    restaurantName="Le Beaujolais"
    address="40 rue du Maréchal-Foch, Belleville-en-Beaujolais, 69220, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33474660531"
    website="https://www.restaurant-le-beaujolais.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With such a name, this Beaujolais could not do otherwise than pay tribute to a region famous for its fine food and wines! The friendly couple that runs this house has hit the nail on the head with hearty wholesome fare. Examples include traditional andouillette, whole grain mustard sauce and sautéed potatoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20rue%20du%20Mar%C3%A9chal-Foch%2C%20Belleville-en-Beaujolais%2C%2069220%2C%20France"
    pageTitle="Le Beaujolais"
  />
);

export default LeBeaujolais;
