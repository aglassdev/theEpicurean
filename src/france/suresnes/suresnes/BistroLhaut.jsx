...
const BistroLhaut = () => (
  <RestaurantPage
    restaurantName="Bistro Là-Haut"
    address="70 avenue Franklin-Roosevelt, Suresnes, 92150, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33145062266"
    website="http://www.bistrolahaut.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thanks to the hilltop location on Mont Valérien, this loft-style restaurant commands a superb view of Paris. The à la carte menu boasts a tempting range of contemporary dishes, such as confit farmhouse pork belly grilled on the barbecue, sweet potato mousseline, roast pointed cabbage, grapes with verjuice. For dinnertime, booking is strongly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20avenue%20Franklin-Roosevelt%2C%20Suresnes%2C%2092150%2C%20France"
    pageTitle="Bistro Là-Haut"
  />
);

export default BistroLhaut;
