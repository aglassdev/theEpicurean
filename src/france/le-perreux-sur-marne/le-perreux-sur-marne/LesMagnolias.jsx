...
const LesMagnolias = () => (
  <RestaurantPage
    restaurantName="Les Magnolias"
    address="48 avenue de Bry, Le Perreux-sur-Marne, 94170, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33148724743"
    website="https://www.lesmagnolias.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A young chef is now at the helm of this pleasant restaurant. He pays particular attention to the presentation of his dishes, which are full of flavour and strewn with Asian influences. In the kitchen and the elegant dining room, his young team pulls out all the stops to please...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20avenue%20de%20Bry%2C%20Le%20Perreux-sur-Marne%2C%2094170%2C%20France"
    pageTitle="Les Magnolias"
  />
);

export default LesMagnolias;
