...
const LaCoquerie = () => (
  <RestaurantPage
    restaurantName="La Coquerie"
    address="1 chemin du Cimetière-Marin, Sète, 34200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33647067138"
    website="https://www.restaurantlacoquerie.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to the famous naval cemetery, this chic, contemporary little place boasts the Mediterranean as its backdrop and a panoramic terrace for fine weather. The restaurant serves exceedingly fresh cuisine focused on market produce and local producers, with a single six-course set menu served at both lunch and dinner. Chef Guilhem Blanc-Brude juggles Mediterranean inspirations and more inventive dishes, such as sea bass cooked scales on, potatoes confit with saffron, hollandaise sauce with wild fennel and dill, and chanterelle pickles. They also have a terrific list of natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20chemin%20du%20Cimeti%C3%A8re-Marin%2C%20S%C3%A8te%2C%2034200%2C%20France"
    pageTitle="La Coquerie"
  />
);

export default LaCoquerie;
