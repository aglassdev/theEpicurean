...
const LeYachtman = () => (
  <RestaurantPage
    restaurantName="Le Yachtman"
    address="14 rue Poissonnière, Lorient, 56100, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33297213191"
    website="https://www.leyachtmanlorient.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Unsurprisingly, seafood – in particular fish from the local auction – takes pride of place in this pretty restaurant located close to the marina. Simplicity and accuracy reign on the plate, while the dining area has a minimalist and intimate decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Poissonni%C3%A8re%2C%20Lorient%2C%2056100%2C%20France"
    pageTitle="Le Yachtman"
  />
);

export default LeYachtman;
