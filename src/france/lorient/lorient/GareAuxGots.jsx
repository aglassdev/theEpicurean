...
const GareAuxGots = () => (
  <RestaurantPage
    restaurantName="Gare aux Goûts"
    address="26 bis rue Louis-Blanqui, Lorient, 56100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33297211979"
    website="https://www.gareauxgouts.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Vincent Seviller has come up trumps in this establishment near the railway station. He invites diners on a bistronomic journey in a tasteful, modern setting. An experienced and talented craftsman, each dish is artfully presented, flavoursome and balanced. The lunchtime menu is chalked up on a slate, but more elaborate in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20bis%20rue%20Louis-Blanqui%2C%20Lorient%2C%2056100%2C%20France"
    pageTitle="Gare aux Goûts"
  />
);

export default GareAuxGots;
