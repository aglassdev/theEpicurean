...
const Le2628 = () => (
  <RestaurantPage
    restaurantName="Le 26-28"
    address="26-28 rue Poissonnière, Lorient, 56100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297502913"
    website="https://www.le2628.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Contemporary design, open kitchens, a chef – Arthur Friess (with a fine Michelin-starred career) – and, managing the restaurant floor, Charlotte Le Gall: these are the ingredients that make this place a success. Lovely contemporary cuisine made from impeccable ingredients – such as pigeon, spelt au gratin and roots. Menu renewed every month...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26-28%20rue%20Poissonni%C3%A8re%2C%20Lorient%2C%2056100%2C%20France"
    pageTitle="Le 26-28"
  />
);

export default Le2628;
