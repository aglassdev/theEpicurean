...
const LeTireBouchon = () => (
  <RestaurantPage
    ...
    address="45 rue Jules-le-Grand, Lorient, 56100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33297847192"
    website="https://www.restaurantalorient.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pay little attention to the unremarkable façade of this restaurant, as the main focus is on the pretty dining room with its exposed beams and open fire. Refined traditional cuisine that follows the seasons is served. Friendly service with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20rue%20Jules-le-Grand%2C%20Lorient%2C%2056100%2C%20France"
    pageTitle="Le Tire Bouchon"
  />
);

export default LeTireBouchon;
