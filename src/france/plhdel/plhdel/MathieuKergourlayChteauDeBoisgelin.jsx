...
const MathieuKergourlayChteauDeBoisgelin = () => (
  <RestaurantPage
    restaurantName="Mathieu Kergourlay - Château de Boisgelin"
    address="Domaine de Boisgelin, Pléhédel, 22290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33296223767"
    website="https://www.mathieu-kergourlay.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Mathieu Kergourlay welcomes diners to this 450-hectare property and small castle, tastefully restored and decorated by his companion and himself. The tasty, generous and consummately crafted food is full of surprises, such as the mini pissaladière reworked by the chef, which is served with a marinated fillet of mackerel, perfectly grilled over the BBQ...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20de%20Boisgelin%2C%20Pl%C3%A9h%C3%A9del%2C%2022290%2C%20France"
    pageTitle="Mathieu Kergourlay - Château de Boisgelin"
  />
);

export default MathieuKergourlayChteauDeBoisgelin;
