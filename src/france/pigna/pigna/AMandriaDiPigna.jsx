...
const AMandriaDiPigna = () => (
  <RestaurantPage
    restaurantName="A Mandria di Pigna"
    address="Village, Pigna, 20220, France"
    cuisine="Corsican"
    priceRange="€€"
    phoneNumber="+33495327124"
    website="https://guide.michelin.com/en/corse/fr-pigna/restaurant/a-mandria-di-pigna"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former sheepfold, a family business for 15 years, is perfectly in tune with its authentic, welcoming village. Corsican produce takes pride of place from the veg and herbs fresh from the garden to the grilled or spit roast suckling pork and tender lamb (wood fired cooking is the house specialty). Savour textbook perfect, generous fare on the refreshingly shaded terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Village%2C%20Pigna%2C%2020220%2C%20France"
    pageTitle="A Mandria di Pigna"
  />
);

export default AMandriaDiPigna;
