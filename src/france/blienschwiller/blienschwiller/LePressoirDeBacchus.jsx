...
const LePressoirDeBacchus = () => (
  <RestaurantPage
    restaurantName="Le Pressoir de Bacchus"
    address="50 route des Vins, Blienschwiller, 67650, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388924301"
    website="https://guide.michelin.com/en/grand-est/blienschwiller/restaurant/le-pressoir-de-bacchus"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Such is the renown of Sylvie Grucker and her son that this pretty restaurant on the wine route is greatly in demand. Sylvie combines traditional recipes with an inventive streak in a bid to showcase regional fare: bacon-flavoured choucroute soup or duck shepherd’s pie, mushrooms and 12-spice sauce, side by side perennial favourites like granddad’s snails, ravioles of carp in a creamy, smoked sauce or Sylvie’s meringue and ice cream extravaganza! Local winegrowers and producers from the village (thirty or so) take pride of place on the enticing wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20route%20des%20Vins%2C%20Blienschwiller%2C%2067650%2C%20France"
    pageTitle="Le Pressoir de Bacchus"
  />
);

export default LePressoirDeBacchus;
