...
const CastelDeTrsGirard = () => (
  <RestaurantPage
    restaurantName="Castel de Très Girard"
    address="7 rue de Très-Girard, Morey-Saint-Denis, 21220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33380343309"
    website="https://castel-tres-girard.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a former wine press in the heart of a wine-growing village, this contemporary bistro charms with its bright space overlooking the terrace and garden. The atmosphere is relaxed and the modern cuisine is rife with clever combinations, such as beef tartare and oysters enhanced with fresh herbs and citrus jelly; red tuna loin with lardo di Colonnata, artichoke and Parmesan. The wine list is a major draw: extensive, lively and with regional labels at its heart, it gives you an opportunity to discover small appellations from renowned winemakers as well as to taste great vintages by the glass. Open every day for lunch and dinner!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20de%20Tr%C3%A8s-Girard%2C%20Morey-Saint-Denis%2C%2021220%2C%20France"
    pageTitle="Castel de Très Girard"
  />
);

export default CastelDeTrsGirard;
