...
const Aintimiste = () => (
  <RestaurantPage
    restaurantName="AinTimiste"
    address="4 rue de la Pompe, Poncin, 01450, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+33474380666"
    website="https://www.aintimiste.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the doorstep of the Cerdon vineyards, this picturesque medieval village in the Bugey and Revermont region is home to a knockout establishment! Jérôme Busset works tirelessly (in and out of his open-plan kitchen) to craft an intelligent surprise menu with various options. Painstakingly sourced local produce, insightful wine tips and a soothing interior. The epitome of rural Ain...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20de%20la%20Pompe%2C%20Poncin%2C%2001450%2C%20France"
    pageTitle="AinTimiste"
  />
);

export default Aintimiste;
