...
const Jeux2Gots = () => (
  <RestaurantPage
    restaurantName="Jeux 2 Goûts"
    address="40 rue Grande, Châteauroux, 36000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254276628"
    website="https://jeux2gouts.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having settled in his native region after several years spent in high - end Parisian establishments, Christophe Marchais is bringing a dose of culinary flair to Châteauroux. He prepares tasty and creative dishes, inspired by a building steeped in history. The best restaurant in the city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20rue%20Grande%2C%20Ch%C3%A2teauroux%2C%2036000%2C%20France"
    pageTitle="Jeux 2 Goûts"
  />
);

export default Jeux2Gots;
