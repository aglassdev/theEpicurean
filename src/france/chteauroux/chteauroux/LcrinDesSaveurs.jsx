...
const LcrinDesSaveurs = () => (
  <RestaurantPage
    restaurantName="L'Écrin des Saveurs"
    address="133 avenue Marcel-Lemoine, Châteauroux, 36000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254220820"
    website="https://www.lecrindessaveurs.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A father-and-son team is behind this brasserie-style restaurant with a smart, polished interior and a hint of Scandinavian flair. The father is a seasoned professional who has been cooking since he was 15 (his CV includes the Grand Hôtel du Lion d'Or in Romorantin and the Domaine des Dryades); his son provides enthusiastic service front of house. Farm produce and fish from Brittany are elevated by the sure touch of the chef: pan-fried snails and octopus, root vegetables and black garlic jus; sesame and dried lime biscuit, crumble with toasted sesame oil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=133%20avenue%20Marcel-Lemoine%2C%20Ch%C3%A2teauroux%2C%2036000%2C%20France"
    pageTitle="L'Écrin des Saveurs"
  />
);

export default LcrinDesSaveurs;
