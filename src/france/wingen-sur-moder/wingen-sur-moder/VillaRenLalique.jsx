...
const VillaRenLalique = () => (
  <RestaurantPage
    restaurantName="Villa René Lalique"
    address="18 rue Bellevue, Wingen-sur-Moder, 67290, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33388719898"
    website="https://villarenelalique.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="René Lalique was the most prominent jeweller of the turn of the 20C and the Art nouveau movement. His legacy lives on in Wingen-sur-Moder, with a museum and a luxury hotel in the hundred-year-old Villa, while the Mario Botta-designed contemporary extension houses the restaurant. At the helm is Paul Stradner, a chef influenced by stints in Austria and Germany. Emulsion of potatoes and truffles (one of the signature dishes); lobster with radish, tarragon and spruce-infused mousse; pigeon, rainbow carrots, kumquat and cumin sauce: the epitome of delicate, intelligent, creative food. The wine cellar is quite simply out of this world…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20Bellevue%2C%20Wingen-sur-Moder%2C%2067290%2C%20France"
    pageTitle="Villa René Lalique"
  />
);

export default VillaRenLalique;
