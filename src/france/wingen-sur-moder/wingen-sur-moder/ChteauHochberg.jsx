...
const ChteauHochberg = () => (
  <RestaurantPage
    restaurantName="Château Hochberg"
    address="2 rue de Château-Teutsch, Wingen-sur-Moder, 67290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388006767"
    website="https://chateauhochberg.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within this majestic 19C residence, chef Arnaud Barberis serves up delicious seasonal cuisine with a few French classics: bouchée à la reine royale, heart sweetbreads with chanterelles. The contemporary decor is dotted with creations by master glassmaker René Lalique, whose work is celebrated in the museum just opposite. Gorgeous terrace to the rear of the château, overlooking the grounds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20Ch%C3%A2teau-Teutsch%2C%20Wingen-sur-Moder%2C%2067290%2C%20France"
    pageTitle="Château Hochberg"
  />
);

export default ChteauHochberg;
