...
const LaGrappeDorRIQ = () => (
  <RestaurantPage
    restaurantName="La Grappe d'Or"
    address="1 rue des Écuries-Seigneuriales, Riquewihr, 68340, France"
    cuisine="Traditional Cuisine, Alsatian"
    priceRange="€€"
    phoneNumber="+33389478952"
    website="https://www.restaurant-grappedor.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This flower - decked house built in 1554 could not be more inviting and the characteristic regional interior has lost none of its yesteryear appeal. Classic regional delicacies on the menu: choucroute, baeckeofe, knuckle of ham, stuffed trout, etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20des%20%C3%89curies-Seigneuriales%2C%20Riquewihr%2C%2068340%2C%20France"
    pageTitle="La Grappe d'Or"
  />
);

export default LaGrappeDorRIQ;
