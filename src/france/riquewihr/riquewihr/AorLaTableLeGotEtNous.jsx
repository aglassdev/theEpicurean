...
const AorLaTableLeGotEtNous = () => (
  <RestaurantPage
    restaurantName="AOR La Table, le Goût et Nous"
    address="2 rue de la Piscine, Riquewihr, 68340, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33369341459"
    website="https://www.table-aor.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Something of a UFO in the gastronomic universe of Alsace, globetrotting cook, Serge Burckel, is also part poet, part rock star – check out the old LPs and CDs recycled as place mats! He works with his family in a bohemian, laid-back ambience, with a choice of surprise menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20la%20Piscine%2C%20Riquewihr%2C%2068340%2C%20France"
    pageTitle="AOR La Table, le Goût et Nous"
  />
);

export default AorLaTableLeGotEtNous;
