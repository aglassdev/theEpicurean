...
const Erasmo = () => (
  <RestaurantPage
    restaurantName="Erasmo"
    address="4 rue du Général-Lambert, Carhaix-Plouguer, 29270, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33973894647"
    website="https://www.restaurant-erasmo.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Venetian chef Matteo Vianello chalked up experience in the kitchens of Alain Ducasse and Jean-François Piège before becoming chef at Mensae and at Sellae. Now established nearer the sea, he has dedicated his small contemporary bistro to the island of Sant Erasmo (home of the famous purple artichoke). He has certainly not lost his touch, revisiting the classics in mouth-watering dishes that convincingly draw on Breton and Italian scores – for instance, ravioles of snails, sweet garlic stock, roast buckwheat or tiramisu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20du%20G%C3%A9n%C3%A9ral-Lambert%2C%20Carhaix-Plouguer%2C%2029270%2C%20France"
    pageTitle="Erasmo"
  />
);

export default Erasmo;
