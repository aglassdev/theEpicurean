...
const LeSaintgeorges = () => (
  <RestaurantPage
    restaurantName="Le Saint-Georges"
    address="4 boulevard Maréchal-Foch, Palavas-les-Flots, 34250, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33467683138"
    website="https://restaurant-st-georges.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his restaurant, just a roll of the dice from the casino, Paul Courtaux doesn’t gamble with our appetites. He crafts vibrant, flavoursome cuisine, which cleverly shines the spotlight on regional produce, illustrated by frothy cold fish soup with an aïoli of cuttlefish and mussels, or a slice of Ségala veal simmered in lemon, basil, aubergines, tomatoes and parmesan… The splendid regional wine list deserves special mention, as does the charismatic welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20boulevard%20Mar%C3%A9chal-Foch%2C%20Palavas-les-Flots%2C%2034250%2C%20France"
    pageTitle="Le Saint-Georges"
  />
);

export default LeSaintgeorges;
