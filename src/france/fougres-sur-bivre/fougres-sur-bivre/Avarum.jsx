...
const Avarum = () => (
  <RestaurantPage
    restaurantName="Avarum"
    address="31 rue de l'Église, Fougères-sur-Bièvre, 41120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33951985465"
    website="https://www.avarumrestaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is housed in a converted 19C coaching inn opposite the medieval castle. A tight-knit chef and sommelier duo are at the helm, pooling their gourmet skills. The chef carefully prepares local ingredients and freshly caught fish to create mouth-watering dishes, such as Roi Rose de Touraine pork, perfectly confit, packed with sweet and savoury flavours and served with delicious pak choi steamed then flash-seared over a flame. As you will see, there's a lot of work involved; apart from the wonderful bread from the local baker, everything from the amuse-bouche to the dessert is beautifully crafted and made in-house. A lovely dining experience, not to mention friendly service and savvy wine recommendations from the sommelier...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20de%20l'%C3%89glise%2C%20Foug%C3%A8res-sur-Bi%C3%A8vre%2C%2041120%2C%20France"
    pageTitle="Avarum"
  />
);

export default Avarum;
