...
const AubergeDesGlantiers = () => (
  <RestaurantPage
    restaurantName="Auberge des Églantiers"
    address="170 rue du Mont-Blanc, Flumet, 73590, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33457350370"
    website="https://www.auberge-des-eglantiers.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurateur couple – chef Kevin Bieber (who for a long time worked at Flocons de Sel) and his partner Mélanie Laugier – are the brains behind this fine little restaurant, whose terrace overlooks the Arly Gorges. In the rustic-style interior (think wood panelling and animal skins), diners tuck into delicious traditional fare, combining good quality ingredients (the Arctic char with sorrel comes to mind), well-crafted dishes and traditional mountain hospitality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=170%20rue%20du%20Mont-Blanc%2C%20Flumet%2C%2073590%2C%20France"
    pageTitle="Auberge des Églantiers"
  />
);

export default AubergeDesGlantiers;
