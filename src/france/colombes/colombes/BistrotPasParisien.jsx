...
const BistrotPasParisien = () => (
  <RestaurantPage
    restaurantName="Bistrot Pas Parisien"
    address="3 place du Général-Leclerc, Colombes, 92700, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33147848406"
    website="https://www.bistrotpasparisien.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Colombes, close to the imposing church designed by Jean Hébrard, this place started out as a brasserie in 1907. With its zinc counter, mirrors, ceiling mouldings and chandelier with white globes, the decor is truly eye-catching and makes for a chic setting in which to enjoy traditional cuisine prepared with care and made with quality produce. The menu includes a number of signature dishes, such as veal chop and rib steak to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20place%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Colombes%2C%2092700%2C%20France"
    pageTitle="Bistrot Pas Parisien"
  />
);

export default BistrotPasParisien;
