...
const Lternel = () => (
  <RestaurantPage
    restaurantName="L'Éternel"
    address="Hôtel de la Poste et du Lion d'Or, 9 place du Champ-de-Foire, Vézelay, 89450, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33373530320"
    website="https://www.hplv-vezelay.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of the hill leading to Vézelay basilica, a major pilgrimage site, L'Eternel caters to more earthly needs, in a bright interior. The dishes are of a modern ilk, and contain a few nods to the region (pressed gambas with Morvan ham, mango and celery). The perfect prelude to a visit to the remarkable Musée Zervos (modern art museum). Comfortable guestrooms for a stopover...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20de%20la%20Poste%20et%20du%20Lion%20d'Or%2C%209%20place%20du%20Champ-de-Foire%2C%20V%C3%A9zelay%2C%2089450%2C%20France"
    pageTitle="L'Éternel"
  />
);

export default Lternel;
