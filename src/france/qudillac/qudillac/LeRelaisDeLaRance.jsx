...
const LeRelaisDeLaRance = () => (
  <RestaurantPage
    restaurantName="Le Relais de la Rance"
    address="6 rue de Rennes, Quédillac, 35290, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33299069070"
    website="https://guide.michelin.com/en/bretagne/quedillac_1568933/restaurant/le-relais-de-la-rance"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This granite building dates back to 1880 but its interior decor is decidedly contemporary. In his cooking, Steven Carré, who earned his stripes at Guy Savoy, Le Bristol, La Tour d'Argent and then in New York, puts his own unique spin on the classics. This young chef's dishes are meticulously prepared: Breton scallop tartare with seaweed, citrus fruit and hazelnuts; beef chuck braised for 12hr, creamy parsnips and confit potatoes; house-made kouign amann, cider caramel and lemon sorbet. Nadège, meanwhile, provides warm and attentive service. The restaurant is very often full!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20de%20Rennes%2C%20Qu%C3%A9dillac%2C%2035290%2C%20France"
    pageTitle="Le Relais de la Rance"
  />
);

export default LeRelaisDeLaRance;
