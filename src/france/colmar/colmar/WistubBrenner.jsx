...
const WistubBrenner = () => (
  <RestaurantPage
    restaurantName="Wistub Brenner"
    address="1 rue de Turenne, Colmar, 68000, France"
    cuisine="Alsatian"
    priceRange="€€"
    phoneNumber="+33389414233"
    website="https://wistub-brenner.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this authentic winstub in the heart of Little Venice, the cuisine is – of course – regional: salad with Comté cheese and cervelas, Papi Lucien's onion tart, sauerkraut and braised pork knuckle, Pinot Noir sauce. Local produce, a friendly atmosphere and a pleasant terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Turenne%2C%20Colmar%2C%2068000%2C%20France"
    pageTitle="Wistub Brenner"
  />
);

export default WistubBrenner;
