...
const LaCachette = () => (
  <RestaurantPage
    restaurantName="La Cachette"
    address="20 rue Notre-Dame-de-Soyons, Valence, 26000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33475552413"
    website="https://www.lacachette-valence.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the lower part of Valence, this hidden little gem is now even more tucked away since moving its premises into the cul-de-sac located behind the original restaurant. It is certainly still worth seeking out! You will get acquainted with a meticulous and inspired chef, Masashi Ijichi, who is originally from Japan. In this brand-new, modern setting, he delivers fine and delicate dishes that irresistibly combine flavours from the Drôme area with inspiration from Asia. Red mullet, courgettes, curry and white pepper; pigeon with black trumpet mushrooms; Japanese Wagyu beef, mustard and green beans. This excellent dining experience is made complete by the efficient service and outstanding wine list (superb selection of northern Côtes du Rhône wines)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Notre-Dame-de-Soyons%2C%20Valence%2C%2026000%2C%20France"
    pageTitle="La Cachette"
  />
);

export default LaCachette;
