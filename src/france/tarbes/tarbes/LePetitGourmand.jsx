...
const LePetitGourmand = () => (
  <RestaurantPage
    restaurantName="Le Petit Gourmand"
    address="62 avenue Bertrand-Barère, Tarbes, 65000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33562342686"
    website="https://lepetitgourmand.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Near the city centre, this vintage bistro is now the lair of Mathieu Espagnacq, who has taken over from his father, who opened the establishment back in the eighties. Mathieu, a seasoned chef with stints in Paris working with top chefs under his belt, crafts food in the zeitgeist that respects tradition and stars premium country produce (farm-reared pork cheeks braised in red wine, vegetables confit in thyme and gnocchi in a smoky cream sauce). A treat for your tastebuds from start to finish – remember to book!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20avenue%20Bertrand-Bar%C3%A8re%2C%20Tarbes%2C%2065000%2C%20France"
    pageTitle="Le Petit Gourmand"
  />
);

export default LePetitGourmand;
