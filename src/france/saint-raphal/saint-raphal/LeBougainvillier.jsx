...
const LeBougainvillier = () => (
  <RestaurantPage
    restaurantName="Le Bougainvillier"
    address="1792 route de la Corniche, Saint-Raphaël, 83700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33494830242"
    website="https://www.villa-mauresque.com/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Villa Mauresque, a magical five-star oasis that is the epitome of comfort and luxury, boasts a poolside terrace set in an exotic garden and jaw-dropping sea views. It is an idyllic spot to sample Mediterranean-leaning cuisine rich in crisp, legible flavours and razor-sharp technique, which shines the spotlight on first-rate local produce, in particular fish and vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1792%20route%20de%20la%20Corniche%2C%20Saint-Rapha%C3%ABl%2C%2083700%2C%20France"
    pageTitle="Le Bougainvillier"
  />
);

export default LeBougainvillier;
