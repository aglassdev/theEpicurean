...
const ElizaberrikoEtxeberria = () => (
  <RestaurantPage
    restaurantName="Elizaberriko Etxeberria"
    address="85 chemin d'Errelua, quartier Elizaberri, Hasparren, 64240, France"
    cuisine="Traditional Cuisine, Basque"
    priceRange="€€"
    phoneNumber="+33564721587"
    website="https://www.elizaberriko.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This white building with green shutters is home to a restaurant run by British chef Alex Mahood and Eva Jaurena, who comes from a background in community catering. The DNA of the Spanish Basque Country runs through the couple's cuisine, which includes meat and whole fish, eg wild turbot, grilled over a wood fire on a traditional parilla, txuletas (rib steaks) from carefully selected breeds. The no-frills execution is impressive – think melt-in-the-mouth tortilla, silky rum-infused coq au lait, tripe in a spicy tomato sauce, house-made botifarra sausage with creamy cavolo nero, tarama with fried flat beans and ice cream churned on site. Simple, brilliantly crafted dishes, some of which are already classics that showcase the region's traditions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20chemin%20d'Errelua%2C%20quartier%20Elizaberri%2C%20Hasparren%2C%2064240%2C%20France"
    pageTitle="Elizaberriko Etxeberria"
  />
);

export default ElizaberrikoEtxeberria;
