...
const AubergeDeLleEnchante = () => (
  <RestaurantPage
    restaurantName="Auberge de l'Île Enchantée"
    address="1 rue Saint-André, Fleury-sur-Orne, 14123, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231521552"
    website="https://www.ileenchantee.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former fishermen’s bar enjoys a verdant setting practically on the banks of the Orne. In keeping with the house traditions, the chef revamps hearty, wholesome recipes that keep pace with the seasons. Searingly good food!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Saint-Andr%C3%A9%2C%20Fleury-sur-Orne%2C%2014123%2C%20France"
    pageTitle="Auberge de l'Île Enchantée"
  />
);

export default AubergeDeLleEnchante;
