...
const Alchimy = () => (
  <RestaurantPage
    restaurantName="Alchimy"
    address="12 place du Palais, Albi, 81000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33563761818"
    website="https://www.alchimyalbi.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the old town, this handsome Art Deco building is home to a contemporary-style brasserie with an attractive glazed roof and an imposing Murano chandelier – a pleasant setting in which to peruse a menu packed with enticing options. Using local produce, the chef puts his own spin on the classics: seared salmon gravlax served with a mushroom salad; a fine cut of Tarn pork; a new version of tarte Tatin with Granny Smith opaline. Pure alchemy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20place%20du%20Palais%2C%20Albi%2C%2081000%2C%20France"
    pageTitle="Alchimy"
  />
);

export default Alchimy;
