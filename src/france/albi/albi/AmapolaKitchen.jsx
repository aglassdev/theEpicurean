...
const AmapolaKitchen = () => (
  <RestaurantPage
    restaurantName="Amapola Kitchen"
    address="100 rue Porta, Albi, 81000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33563776304"
    website="https://guide.michelin.com/en/occitanie/albi/restaurant/amapola-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The premium location at the foot of Pont Vieux, overlooking the historic town and cathedral, is eminently Instagram worthy. The savvily revamped dinky bistro is run by a former art historian, whose healthy, colourful, well-crafted dishes hit the spot. This unorthodox, fine food DJ mixes South American, Italian and Comorian influences, with a scattering of lacto-fermented ingredients and a preference for organic sources. First-class organic and natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20rue%20Porta%2C%20Albi%2C%2081000%2C%20France"
    pageTitle="Amapola Kitchen"
  />
);

export default AmapolaKitchen;
