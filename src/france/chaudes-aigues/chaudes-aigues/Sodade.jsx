...
const Sodade = () => (
  <RestaurantPage
    restaurantName="Sodade"
    address="21 avenue du Président-Georges-Pompidou, Chaudes-Aigues, 15110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33471601023"
    website="https://www.sergevieira.com/fr/restaurant-sodade.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sodade is a song by Cesária Évora and a nod to the Portuguese origins of the late owner, Serge Vieira. In a large designer dining room or on the terrace overlooking the stream, you will sample dishes that are the epitome of tasty and simple. Pleasant guestrooms to stay longer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20avenue%20du%20Pr%C3%A9sident-Georges-Pompidou%2C%20Chaudes-Aigues%2C%2015110%2C%20France"
    pageTitle="Sodade"
  />
);

export default Sodade;
