...
const AubergeDesSaintsPres = () => (
  <RestaurantPage
    restaurantName="Auberge des Saints Pères"
    address="212 avenue Nonneville, Aulnay-sous-Bois, 93600, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33148666211"
    website="https://www.auberge-des-saints-peres.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an elegant, pared-back setting, you can enjoy cuisine made with top-notch produce by chef Jean-Claude Cahagnet, whose experience can't be argued with and who leaves us in no doubt about his penchant for herbs and spices. Regular diners keep coming back for the high-quality matured purebred meats, presented in a tempting window display. The hostess provides a warm welcome and impeccable service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=212%20avenue%20Nonneville%2C%20Aulnay-sous-Bois%2C%2093600%2C%20France"
    pageTitle="Auberge des Saints Pères"
  />
);

export default AubergeDesSaintsPres;
