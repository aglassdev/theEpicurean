...
const ChevalBlancFEL = () => (
  <RestaurantPage
    restaurantName="Cheval Blanc"
    address="1 rue de Bisel, Feldbach, 68640, France"
    cuisine="Traditional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33389258186"
    website="https://www.cheval-blanc-feldbach.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this typical Sundgau house, food is a passion that has been handed down from generation to generation. Father and son cook lovely traditional dishes enhanced with a modern edge. Very good choice of wines. This White Horse really is a fine steed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Bisel%2C%20Feldbach%2C%2068640%2C%20France"
    pageTitle="Cheval Blanc"
  />
);

export default ChevalBlancFEL;
