...
const LeCafDeLaFontaine = () => (
  <RestaurantPage
    restaurantName="Le Café de la Fontaine"
    ...
    pageTitle="Le Café de la Fontaine"
  />
);

export default LeCafDeLaFontaine;
