...
const LePrau = () => (
  <RestaurantPage
    restaurantName="Le Préau"
    address="1 cours Saint-Étienne, Rognes, 13840, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33983940277"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/rognes_1508191/restaurant/le-preau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his home village, Antonin Wishart cooks up joyful cuisine using ultra-fresh ingredients from the market and the family's kitchen garden. The mouth-watering set menu changes daily; this son of winegrowers has also curated an attractive wine list. In short: a trendy bistro with relaxed, efficient service, and an urban vibe in the countryside! A charm offensive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20cours%20Saint-%C3%89tienne%2C%20Rognes%2C%2013840%2C%20France"
    pageTitle="Le Préau"
  />
);

export default LePrau;
