...
const AuBonAccueilATT = () => (
  <RestaurantPage
    restaurantName="Au Bon Accueil"
    address="52 route Nationale, Attin, 62170, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33321069355"
    website="https://www.aubonaccueil-attin.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Half-way between Montreuil and Le Touquet, this fashionably appointed, welcoming bistro conjures up tasty home cooking that celebrates market-fresh produce, but not only. Examples: goat’s cheese fritter, poached pear and rocket leaf; scorpion fish, herby polenta, salad veggies and fennel butter. And at such sensible prices, who could ask for more?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20route%20Nationale%2C%20Attin%2C%2062170%2C%20France"
    pageTitle="Au Bon Accueil"
  />
);

export default AuBonAccueilATT;
