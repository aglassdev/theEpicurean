...
const RacineNAN = () => (
  <RestaurantPage
    ...
    address="9 rue Stanislas, Nancy, 54000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33986332420"
    website="https://www.racine-nancy.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone's throw from Place Stanislas, youthful chef Martin Debuiche and his partner, famous butcher, Alexandre Polmard, orchestrate a market-fresh score inspired by regional produce. Carefully sourced ingredients and deftly crafted cooking: good food in a buzzy, friendly vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Stanislas%2C%20Nancy%2C%2054000%2C%20France"
    pageTitle="Racine"
  />
);

export default RacineNAN;
