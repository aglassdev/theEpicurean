...
const BastionNAN = () => (
  <RestaurantPage
    ...
    address="46 boulevard du 26ème-R.I., Nancy, 54000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33383472149"
    website="https://www.bastion-nancy.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The team that has taken over this small Art Nouveau building opposite the Parc de la Pépinière is on a mission to serve as a bastion against junk food and the industrialisation of what we eat. The chef connects with producers to champion local agriculture, delivering vibrant cuisine that is, above all, packed with flavour. Very good value for money at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20boulevard%20du%2026%C3%A8me-R.I.%2C%20Nancy%2C%2054000%2C%20France"
    pageTitle="Bastion"
  />
);

export default BastionNAN;
