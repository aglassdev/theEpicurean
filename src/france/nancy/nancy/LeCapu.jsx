...
const LeCapu = () => (
  <RestaurantPage
    restaurantName="Le Capu"
    address="31 rue Gambetta, Nancy, 54000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33383352698"
    website="https://www.lecapu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an ideal location 300m from Place Stanislas, this restaurant boasts an elegant decor in a bold, contemporary vein, enhanced by baroque notes (rich hues and crushed velvet). The cuisine is suitably generous – for example, filet mignon of veal, with aubergine caviar, grilled courgettes and a tarragon sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20Gambetta%2C%20Nancy%2C%2054000%2C%20France"
    pageTitle="Le Capu"
  />
);

export default LeCapu;
