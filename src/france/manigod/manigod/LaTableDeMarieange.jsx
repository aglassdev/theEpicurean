...
const LaTableDeMarieange = () => (
  <RestaurantPage
    restaurantName="La Table de Marie-Ange"
    address="4910 route du Col-de-la-Croix-Fry, Manigod, 74230, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450449016"
    website="https://www.hotelchaletcroixfry.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The terrace overlooking the Aravis range is so mesmerising, it is difficult to tear oneself away. Marie-Ange aims to serve fine regional dishes oozing with authentic flavour: pan-seared cèpes, fillets of wild perch from Lake Geneva, fillet of beef simmered in mushrooms and grandma’s potato gratin, without forgetting the wickedly lavish dessert trolley. The interior sports old wood and farming tools – charming welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4910%20route%20du%20Col-de-la-Croix-Fry%2C%20Manigod%2C%2074230%2C%20France"
    pageTitle="La Table de Marie-Ange"
  />
);

export default LaTableDeMarieange;
