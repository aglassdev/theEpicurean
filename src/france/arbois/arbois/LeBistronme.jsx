...
const LeBistronme = () => (
  <RestaurantPage
    restaurantName="Le Bistronôme"
    address="62 rue de Faramand, Arbois, 39600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33384530851"
    website="https://le-bistronome-arbois.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Small in size, big in quality! In an exquisite location on the banks of the River Cuisance, Lisa and Jérôme have made their establishment a firm fixture of Arbois’ culinary scene. The chef’s seasonal recipes, emblematic of his technique and flair, are a festival of mouth-watering delicacies from his signature dish, Planches trout stuffed with morel and oyster mushrooms, vin jaune sauce to farm-reared Jura pork chop, pepper and tonka bean meat gravy and dauphine potatoes. The desserts are to die for! Their “au fil du jour” daily special is a steal and the service is refreshingly unstarched and friendly: remember to book!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20rue%20de%20Faramand%2C%20Arbois%2C%2039600%2C%20France"
    pageTitle="Le Bistronôme"
  />
);

export default LeBistronme;
