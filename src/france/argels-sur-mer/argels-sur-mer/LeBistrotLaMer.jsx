...
const LeBistrotLaMer = () => (
  <RestaurantPage
    restaurantName="Le Bistrot à la Mer"
    address="3638 route de Collioure, Argelès-sur-Mer, 66700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468811473"
    website="https://www.grandhoteldugolfe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a hotel overlooking the coastal road to Collioure, you will taste tip-top regional produce, assembled in recipes drenched in Mediterranean aromas. The lovely terrace overlooking the sea provides the perfect foil to the splendid menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3638%20route%20de%20Collioure%2C%20Argel%C3%A8s-sur-Mer%2C%2066700%2C%20France"
    pageTitle="Le Bistrot à la Mer"
  />
);

export default LeBistrotLaMer;
