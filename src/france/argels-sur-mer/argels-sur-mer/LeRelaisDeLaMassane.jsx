...
const LeRelaisDeLaMassane = () => (
  <RestaurantPage
    restaurantName="Le Relais de la Massane"
    address="32 rue Marcelin-Albert, Argelès-sur-Mer, 66700, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33468295312"
    website="https://restaurantlerelaisdelamassane-argeles-sur-mer.eatbu.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20rue%20Marcelin-Albert%2C%20Argel%C3%A8s-sur-Mer%2C%2066700%2C%20France"
    pageTitle="Le Relais de la Massane"
  />
);

export default LeRelaisDeLaMassane;
