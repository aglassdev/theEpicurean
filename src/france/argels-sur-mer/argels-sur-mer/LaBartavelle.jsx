...
const LaBartavelle = () => (
  <RestaurantPage
    ...
    address="24 rue de la République, Argelès-sur-Mer, 66700, France"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+33619257013"
    website="https://www.restaurant-labartavelle.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20de%20la%20R%C3%A9publique%2C%20Argel%C3%A8s-sur-Mer%2C%2066700%2C%20France"
    pageTitle="La Bartavelle"
  />
);

export default LaBartavelle;
