...
const LeValucienChteauDeVaultdelugny = () => (
  <RestaurantPage
    restaurantName="Le Valucien - Château de Vault-de-Lugny"
    address="11 rue du Château, Vault-de-Lugny, 89200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33386340786"
    website="https://lugny.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The terrace of this stately home overlooking sprawling grounds and a 17C plane tree features in a novel by French author Michel Houellebecq. Mauritian chef Franco Bowanee crafts fine contemporary cuisine, strewn with discerning exotic touches. He doesn't mess around: his delicious dishes shine the spotlight not only on premium ingredients, but also the vegetables from the estate's kitchen garden. Surrounded by floor-to-ceiling glass, the dining room slots into the surrounding nature perfectly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20du%20Ch%C3%A2teau%2C%20Vault-de-Lugny%2C%2089200%2C%20France"
    pageTitle="Le Valucien - Château de Vault-de-Lugny"
  />
);

export default LeValucienChteauDeVaultdelugny;
