...
const LeSaintpierre = () => (
  <RestaurantPage
    restaurantName="Le Saint-Pierre"
    address="104 rue Battant, Besançon, 25000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33381812099"
    website="https://www.restaurant-saintpierre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Savour fine dining with a predominance of fish dishes and quality produce in an elegant setting of open stonework and modern touches. The St - Pierre makes for an idyllic experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=104%20rue%20Battant%2C%20Besan%C3%A7on%2C%2025000%2C%20France"
    pageTitle="Le Saint-Pierre"
  />
);

export default LeSaintpierre;
