...
const LeSauvage = () => (
  <RestaurantPage
    restaurantName="Le Sauvage"
    address="6 rue du Chapitre, Besançon, 25000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33381820021"
    website="https://www.lesauvage-besancon.fr/le-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of the Vauban Citadel, this smart hotel occupies the former convent of the Poor Clares. The restaurant provides a cosy setting, with old parquet floors and tablecloths, and – a major asset – its terrace overlooking the park! Chef Hugo Mathieu (trained in Lyon's top restaurants) is no novice, judging by his polished dishes: glazed pea velouté, cod loin fillet cooked at 50C, crispy pistachio tartlet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Chapitre%2C%20Besan%C3%A7on%2C%2025000%2C%20France"
    pageTitle="Le Sauvage"
  />
);

export default LeSauvage;
