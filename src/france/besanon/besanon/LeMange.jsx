...
const LeMange = () => (
  <RestaurantPage
    restaurantName="Le Manège"
    address="2 faubourg Rivotte, Besançon, 25000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33381480148"
    website="https://www.restaurantlemanege.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of the citadel, this former military riding arena specialises in delicate, flavoursome fare rich in regional twists (such as a mushroom crust cooked in vin jaune or their amazing sliced black pudding). The self-taught chef is a stickler for perfection – as the first and last bite will confirm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20faubourg%20Rivotte%2C%20Besan%C3%A7on%2C%2025000%2C%20France"
    pageTitle="Le Manège"
  />
);

export default LeMange;
