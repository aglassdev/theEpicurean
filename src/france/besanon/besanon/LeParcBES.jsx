...
const LeParcBES = () => (
  <RestaurantPage
    ...
    address="Place de la 1ère-Armée-Française, Besançon, 25000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33370886060"
    website="https://leparcbesancon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Parc Micaud, on the banks of the River Doubs, this glass, concrete and steel pavilion is the Modernist work of Besançon architect Michel Demenge. The chic, contemporary interior, with its open-plan kitchen, also offers a view of the river. Dishes are in a contemporary vein, the menu under the supervision of the chef of nearby Château de Germigney...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20la%201%C3%A8re-Arm%C3%A9e-Fran%C3%A7aise%2C%20Besan%C3%A7on%2C%2025000%2C%20France"
    pageTitle="Le Parc"
  />
);

export default LeParcBES;
