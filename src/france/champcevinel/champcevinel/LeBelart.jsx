...
const LeBelart = () => (
  <RestaurantPage
    restaurantName="Le Bel'Art"
    address="2 allée Jean-Boiteux, Champcevinel, 24750, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33553078551"
    website="https://le-bel-art-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a modern building on the higher ground outside Périgueux, Sandrine and Vincent Cardoso's restaurant has a functional dining space. The food represents a complete change of tack, with a different menu on offer every week. Served with good jus, first-rate local ingredients are accompanied by seasonal vegetables that demonstrate the chef's indisputable expertise. Everything is cooked precisely and from the heart. The brandade of salmon with sweet wine, the chicken supreme in a ramekin with bay leaves and farm spinach, or the diced Golden Delicious apple on a buttery sablé reflect the care lavished on each plate. This place is a pleasant surprise, with its enticing set menu at lunchtime served by a friendly, smiling owner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20all%C3%A9e%20Jean-Boiteux%2C%20Champcevinel%2C%2024750%2C%20France"
    pageTitle="Le Bel'Art"
  />
);

export default LeBelart;
