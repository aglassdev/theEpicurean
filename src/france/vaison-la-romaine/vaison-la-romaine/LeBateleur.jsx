...
const LeBateleur = () => (
  <RestaurantPage
    restaurantName="Le Bateleur"
    address="1 place Théodore-Aubanel, Vaison-la-Romaine, 84110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490362804"
    website="https://www.restaurant-lebateleur.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw from the Roman bridge, at the foot of the medieval town, the chef cooks up market-fresh cuisine. In tune with the seasons, it is often Provençal, and occasionally peppered with Italian or Mexican influences. To be enjoyed on the terrace when the weather is mild. A lovely place to sample dishes that are rich in flavours!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20Th%C3%A9odore-Aubanel%2C%20Vaison-la-Romaine%2C%2084110%2C%20France"
    pageTitle="Le Bateleur"
  />
);

export default LeBateleur;
