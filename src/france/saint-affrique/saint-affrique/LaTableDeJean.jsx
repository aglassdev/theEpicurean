...
const LaTableDeJean = () => (
  <RestaurantPage
    restaurantName="La Table de Jean"
    address="7 boulevard Émile-Trémoulet, Saint-Affrique, 12400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565495005"
    website="https://guide.michelin.com/en/occitanie/saint-affrique/restaurant/la-table-de-jean"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's no secret: when the food is good, it's a real hit! The cuisine is delicious and oscillates between traditional brasserie dishes (fillet of beef, knife-cut steak tartare, roast loin of veal etc) and Mediterranean touches such as pasta risotto with baby squid, chorizo and a shellfish jus. Reservations strongly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20boulevard%20%C3%89mile-Tr%C3%A9moulet%2C%20Saint-Affrique%2C%2012400%2C%20France"
    pageTitle="La Table de Jean"
  />
);

export default LaTableDeJean;
