...
const LaClDesChamps = () => (
  <RestaurantPage
    restaurantName="La Clé des Champs"
    address="13 rue des Frères-Caudron, Favières, 80120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33322278800"
    website="https://www.restaurant-lacledeschamps.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment is run by a professional young couple who go to great lengths to keep their guests happy. The fruit of their labours: modern and well-executed cuisine that puts ingredients from the local terroir in the spotlight, as in their tender and tasty haddock sausage accompanied by Picardy mushrooms, or their stuffed farm-reared guinea fowl, apple and onion, chicory jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20des%20Fr%C3%A8res-Caudron%2C%20Favi%C3%A8res%2C%2080120%2C%20France"
    pageTitle="La Clé des Champs"
  />
);

export default LaClDesChamps;
