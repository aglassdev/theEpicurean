...
const CapDeCastel = () => (
  <RestaurantPage
    restaurantName="Cap de Castel"
    address="36 rue Cap-de-Castel, Puylaurens, 81700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33563702176"
    website="https://www.capdecastel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a seat on the splendid terrace with the Pyrenees in the distance and the Montagne Noire in the foreground and get ready to sample modern cuisine with traditional touches. The food highlights local produce, such as veal raised in Puylaurens, lightly seared and served rare with Veggie Wellington and a coffee-flavoured veal gravy. Lovely guestrooms to prolong your stay in style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20Cap-de-Castel%2C%20Puylaurens%2C%2081700%2C%20France"
    pageTitle="Cap de Castel"
  />
);

export default CapDeCastel;
