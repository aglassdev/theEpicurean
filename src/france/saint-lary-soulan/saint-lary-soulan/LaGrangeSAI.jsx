...
const LaGrangeSAI = () => (
  <RestaurantPage
    ...
    address="13 route d'Autun, Saint-Lary-Soulan, 65170, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33562400714"
    website="https://www.restaurant-saint-lary.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former barn is now an inviting country chic restaurant appointed in an alpine vein. The menu stars tasty well-crafted food, made with premium regional ingredients such as marinated salmon trout from Lake Oô; confit of egg, shredded confit of duck and creamy sweetcorn… What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20route%20d'Autun%2C%20Saint-Lary-Soulan%2C%2065170%2C%20France"
    pageTitle="La Grange"
  />
);

export default LaGrangeSAI;
