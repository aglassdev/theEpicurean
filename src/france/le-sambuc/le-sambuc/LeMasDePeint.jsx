...
const LeMasDePeint = () => (
  <RestaurantPage
    restaurantName="Le Mas de Peint"
    address="Le Mas de Peint, route de Salin de Giraud (D36), Le Sambuc, 13200, France"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+33490972062"
    website="https://www.masdepeint.com/fr/hotel-luxe-camargue-arles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Using good ingredients and vegetables from the kitchen garden, the chef creates lovely dishes that put a new spin on the old classics (bull beef gravlax, gazpacho made with old tomato varieties, etc). The ravishing terrace beneath the wisteria and the charm of the setting make this a great choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Mas%20de%20Peint%2C%20route%20de%20Salin%20de%20Giraud%20(D36)%2C%20Le%20Sambuc%2C%2013200%2C%20France"
    pageTitle="Le Mas de Peint"
  />
);

export default LeMasDePeint;
