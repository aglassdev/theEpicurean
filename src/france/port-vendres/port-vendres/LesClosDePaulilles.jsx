...
const LesClosDePaulilles = () => (
  <RestaurantPage
    restaurantName="Les Clos de Paulilles"
    address="Baie de Paulilles, Port-Vendres, 66660, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33468814979"
    website="https://www.lesclosdepaulilles.com/restaurant-clos-de-paulilles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set between vineyards and the sea, just a few minutes from the beach, the location is idyllic. Maison Cazes – a major wine producer in the region – acquired the 90ha estate and runs this restaurant that promises to treat your taste buds. Only local produce is used in bringing the regional recipes to life: capon with green crab bisque and squid ink tagliatelle. A superb terrace overlooking the vineyards... and a friendly tapas bar!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baie%20de%20Paulilles%2C%20Port-Vendres%2C%2066660%2C%20France"
    pageTitle="Les Clos de Paulilles"
  />
);

export default LesClosDePaulilles;
