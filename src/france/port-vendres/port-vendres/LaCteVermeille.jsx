...
const LaCteVermeille = () => (
  <RestaurantPage
    restaurantName="La Côte Vermeille"
    address="Quai du Fanal, Port-Vendres, 66660, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33468820571"
    website="https://guide.michelin.com/en/occitanie/port-vendres/restaurant/cote-vermeille"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Fanal quayside, this eatery boasts a knock-out view of the port, especially from the upstairs terrace. The chef crafts a seafood-centric menu, including a particularly succulent signature bouillabaisse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quai%20du%20Fanal%2C%20Port-Vendres%2C%2066660%2C%20France"
    pageTitle="La Côte Vermeille"
  />
);

export default LaCteVermeille;
