...
const LeComptoirDeLaMreGermaine = () => (
  <RestaurantPage
    restaurantName="Le Comptoir de la Mère Germaine"
    address="7 place Jean-Moulin, Châteauneuf-du-Pape, 84230, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33428690060"
    website="https://www.lameregermaine.com/le-comptoir/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This offshoot of the star establishment doesn’t do things by halves: wood prevails in the contemporary interior and an imposing counter-cum-kitchen with a gleaming spit-roast oven and a shaded terrace. A bistronomic lineup strewn with South American notes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20Jean-Moulin%2C%20Ch%C3%A2teauneuf-du-Pape%2C%2084230%2C%20France"
    pageTitle="Le Comptoir de la Mère Germaine"
  />
);

export default LeComptoirDeLaMreGermaine;
