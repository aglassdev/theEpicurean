...
const HostellerieDuChteauDesFinesRoches = () => (
  <RestaurantPage
    restaurantName="Hostellerie du Château des Fines Roches"
    address="1901 route de Sorgues, Châteauneuf-du-Pape, 84230, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490837023"
    website="https://chateaufinesroches.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On a hilltop in the heart of the prestigious Châteauneuf-du-Pape vineyards, this flamboyant miniature Palais des Papes commands superb views over the vineyards, the Alpilles, the Luberon and Mt Ventoux. The restaurant serves delicate cuisine inspired by Provence and the Mediterranean: line-caught pike-perch, courgette flower and ricotta, shellfish jus; Costières de Nîmes pigeon cooked whole, corn with black garlic and Albufera sauce. All washed down with wines from the estate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1901%20route%20de%20Sorgues%2C%20Ch%C3%A2teauneuf-du-Pape%2C%2084230%2C%20France"
    pageTitle="Hostellerie du Château des Fines Roches"
  />
);

export default HostellerieDuChteauDesFinesRoches;
