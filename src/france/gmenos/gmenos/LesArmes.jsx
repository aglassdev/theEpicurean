...
const LesArmes = () => (
  <RestaurantPage
    restaurantName="Les Arômes"
    address="230 avenue du 2ème-Cuirassier, Gémenos, 13420, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33980730660"
    website="https://www.lesaromesgemenos.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this 1930s house basking in the aromas of Provence, unflappable hostess Françoise Besset and her husband Yannick officiate. His innkeeper's soul has not changed and he continues to regale guests with fresh and inventive regional cuisine. Enjoy in one of the charming little dining spaces or, in fine weather, on the terrace on the veranda overlooking the garden planted with olive trees. An exemplary place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=230%20avenue%20du%202%C3%A8me-Cuirassier%2C%20G%C3%A9menos%2C%2013420%2C%20France"
    pageTitle="Les Arômes"
  />
);

export default LesArmes;
