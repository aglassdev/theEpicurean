...
const LaMagdeleineMathiasDandine = () => (
  <RestaurantPage
    restaurantName="La Magdeleine - Mathias Dandine"
    address="2 rond-point des Charrons, Gémenos, 13420, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33442322016"
    website="https://relais-magdeleine.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Mathias Dandine made his childhood dream come true when he became chef at this handsome 18C mansion with a terrace shaded by mature plane trees, situated far from the noise of the city. Here, his cuisine is in perfect harmony with the setting, where he celebrates Provence with breathtaking skill. His unfussy, pared-down Mediterranean cuisine shuns unnecessary frills, with no particular effort made to impress foodies. Yet behind the apparent simplicity, the chef’s recipes demonstrate real mastery in cooking methods, textures and balance of flavours. In fine weather, make sure you take a seat on the terrace shaded by Mediterranean trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rond-point%20des%20Charrons%2C%20G%C3%A9menos%2C%2013420%2C%20France"
    pageTitle="La Magdeleine - Mathias Dandine"
  />
);

export default LaMagdeleineMathiasDandine;
