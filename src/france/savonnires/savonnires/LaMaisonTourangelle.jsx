...
const LaMaisonTourangelle = () => (
  <RestaurantPage
    restaurantName="La Maison Tourangelle"
    address="9 route des Grottes-Pétrifiantes, Savonnières, 37510, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33247503005"
    website="https://www.lamaisontourangelle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rustic meets modern in this 18C Touraine building. It boasts a delightful terrace on the Cher and fine cuisine using quality ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20route%20des%20Grottes-P%C3%A9trifiantes%2C%20Savonni%C3%A8res%2C%2037510%2C%20France"
    pageTitle="La Maison Tourangelle"
  />
);

export default LaMaisonTourangelle;
