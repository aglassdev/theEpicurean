...
const Lauryvan = () => (
  <RestaurantPage
    restaurantName="Lauryvan"
    address="200 allée du Bois-au-Bœuf, Saint-Junien, 87200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33555022604"
    website="https://www.lauryvan.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this verdant setting in a small wood close to the Vienne River, tuck into meticulous cuisine attuned to the seasons. The inspector was a fan of the organic confit egg, creamy parsnip purée, Cantal cheese shavings and ham crisps, as well as the lovely terrace with a view of the lake. Two spaces: restaurant and bistro...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20all%C3%A9e%20du%20Bois-au-B%C5%93uf%2C%20Saint-Junien%2C%2087200%2C%20France"
    pageTitle="Lauryvan"
  />
);

export default Lauryvan;
