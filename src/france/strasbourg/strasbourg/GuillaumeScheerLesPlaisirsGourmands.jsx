...
const GuillaumeScheerLesPlaisirsGourmands = () => (
  <RestaurantPage
    restaurantName="Guillaume Scheer - Les Plaisirs Gourmands"
    address="21 quai Mullenheim, Strasbourg, 67000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33388835555"
    website="https://www.les-plaisirs-gourmands.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Guillaume Scheer and his wife Charlotte are thriving in their new city-centre location. The chef, who worked at Pavillon Ledoyen in Paris and 1741 in Strasbourg, artfully prepares the finest ingredients, including squab, blue lobster from Brittany, Charolais beef fillet. Rich sauces and jus, perfectly cooked dishes and attentive service: it has all the ingredients of a wonderful meal!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20quai%20Mullenheim%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="Guillaume Scheer - Les Plaisirs Gourmands"
  />
);

export default GuillaumeScheerLesPlaisirsGourmands;
