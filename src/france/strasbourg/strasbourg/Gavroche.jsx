...
const Gavroche = () => (
  <RestaurantPage
    restaurantName="Gavroche"
    address="4 rue Klein, Strasbourg, 67000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388368289"
    website="https://www.restaurantgavroche.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet side street in the Krutenau quarter, this restaurant has an intimate feel. Chef Alexy Fuchs serves contemporary cuisine (langoustine, apple salad and mustard ice, or scallops, sweet potato, crispy ravioli and bisque emulsion) with the odd nod to Alsace, as in the foie gras terrine with fruit chutney and dampfnudel. Service is particularly charming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Klein%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="Gavroche"
  />
);

export default Gavroche;
