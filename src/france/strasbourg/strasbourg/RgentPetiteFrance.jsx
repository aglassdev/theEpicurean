...
const RgentPetiteFrance = () => (
  <RestaurantPage
    restaurantName="Régent Petite France"
    address="5 rue des Moulins, Strasbourg, 67000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388764300"
    website="https://regent-petite-france.com/restaurant-et-bar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within this gorgeous hotel that boasts an ideal location in the Petite France quarter, the fine dining restaurant is run by the team from La Fourchette des Ducs. The chef puts together meticulous, flavourful and elegantly presented dishes, using excellent regional ingredients, eg trout and char from Sparsbach, squab, farm vegetables and more. Plus, there is a pleasant terrace on the bank of the Canal de l'Ill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20des%20Moulins%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="Régent Petite France"
  />
);

export default RgentPetiteFrance;
