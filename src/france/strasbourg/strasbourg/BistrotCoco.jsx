...
const BistrotCoco = () => (
  <RestaurantPage
    restaurantName="Bistrot Coco"
    address="8 rue de l’Écurie, Strasbourg, 67000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33390203939"
    website="https://www.bistrot-coco.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in Strasbourg's old town, this contemporary restaurant with industrial-style decor is run by Constant Meyer, a young chef who earned his stripes at Le Crocodile and Le Relais de la Poste in La Wantzenau. He cooks up refined contemporary cuisine in a multi-course carte-blanche format (omnivore or vegetarian). Expect bold flavours and a friendly atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20l%E2%80%99%C3%89curie%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="Bistrot Coco"
  />
);

export default BistrotCoco;
