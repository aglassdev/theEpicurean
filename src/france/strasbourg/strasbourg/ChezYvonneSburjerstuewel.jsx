...
const ChezYvonneSburjerstuewel = () => (
  <RestaurantPage
    restaurantName="Chez Yvonne - S'Burjerstuewel"
    address="10 rue du Sanglier, Strasbourg, 67000, France"
    cuisine="Alsatian, Country cooking"
    priceRange="€€"
    phoneNumber="+33388328415"
    website="https://www.restaurant-chez-yvonne.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A buzzy vibe and closely packed tables set the scene in this winstub, whose menu is the epitome of Alsace tradition (cockerel in Riesling, garnished sauerkraut, braised knuckle), albeit with a few more creative dishes, such as their delicate Alsace makis. Don’t miss the chance to sample one of the house specialties: melt-in-the-mouth pork cheeks slowly braised and simmered in a velvety pinot noir sauce – to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20du%20Sanglier%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="Chez Yvonne - S'Burjerstuewel"
  />
);

export default ChezYvonneSburjerstuewel;
