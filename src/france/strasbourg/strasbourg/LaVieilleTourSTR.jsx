...
const LaVieilleTourSTR = () => (
  <RestaurantPage
    restaurantName="La Vieille Tour"
    address="1 rue Adolphe-Seyboth, Strasbourg, 67000, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33388325430"
    website="https://guide.michelin.com/en/grand-est/strasbourg/restaurant/la-vieille-tour8731"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We could not but fall in love with this authentic inn, run by a couple of professionals. Their generous restaurant, close to the “Petite France”, nurtures traditional flavours (breast of chicken with jus, cod fillet with vegetables and mushrooms, game in season) depending on market availability. The simple décor is embellished with humorous posters on Alsace by the renowned Tomi Ungerer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Adolphe-Seyboth%2C%20Strasbourg%2C%2067000%2C%20France"
    pageTitle="La Vieille Tour"
  />
);

export default LaVieilleTourSTR;
