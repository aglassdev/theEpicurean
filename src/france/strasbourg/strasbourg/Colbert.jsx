...
const Colbert = () => (
  <RestaurantPage
    restaurantName="Colbert"
    address="127 route de Mittelhausbergen, Strasbourg, 67200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388225216"
    website="https://restaurant-colbert.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a modern bistro decor, the young chef-patron concocts neat and flavoursome cuisine that is in tune with modern tastes; his presentations are original and elegant, for example the venison pâté with foie gras en croûte, the calf sweetbread with meunière sauce, and the savarin cake with whipped cream and citrus fruit syrup. Given the quality of the cuisine, it is hardly surprising that the restaurant is frequently fully booked...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20route%20de%20Mittelhausbergen%2C%20Strasbourg%2C%2067200%2C%20France"
    pageTitle="Colbert"
  />
);
