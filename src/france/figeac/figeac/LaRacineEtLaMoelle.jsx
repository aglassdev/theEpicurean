...
const LaRacineEtLaMoelle = () => (
  <RestaurantPage
    restaurantName="La Racine et la Moelle"
    address="6 rue du Consulat, Figeac, 46100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33983538158"
    website="https://guide.michelin.com/en/occitanie/figeac/restaurant/la-racine-et-la-moelle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Julie and her Irish partner have already won the hearts of Figeac with their flavoursome, modern recipes. Simple, unprissy dishes and flawless execution, the food is served in a friendly, welcoming setting that is as natural as the fine wine list (the establishment also sells wine). Bingo!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Consulat%2C%20Figeac%2C%2046100%2C%20France"
    pageTitle="La Racine et la Moelle"
  />
);

export default LaRacineEtLaMoelle;
