...
const TableDeLevernois = () => (
  <RestaurantPage
    restaurantName="Table de Levernois"
    address="Hostellerie de Levernois, 15 rue du Golf, Levernois, 21200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380247358"
    website="https://www.levernois.com/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The tradition of hospitality is kept alive in this elegant house situated in the middle of extensive grounds dissected by a river. Here, chef Philippe Augé creates carefully prepared cuisine based on classic principles, resulting in dishes such as green carnaroli risotto with frogs’ legs and snails, calf sweetbreads with petits pois à la française and lime-leaf vinegar jus, and a Grand Marnier soufflé with blood orange sorbet. Make sure you save space for the cheese trolley which includes several dozen varieties! Impressive Burgundy wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hostellerie%20de%20Levernois%2C%2015%20rue%20du%20Golf%2C%20Levernois%2C%2021200%2C%20France"
    pageTitle="Table de Levernois"
  />
);

export default TableDeLevernois;
