...
const MangerDormirSurLaPlage = () => (
  <RestaurantPage
    restaurantName="Manger & Dormir sur la Plage"
    address="61 avenue William Bertrand, Marennes, 17320, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33546384193"
    website="https://www.dormirsurlaplage.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It sounds like the title of a song from the 1980s. This young and relaxed restaurant facing the sea offers marine-inspired cuisine, with a mouthwatering choice of shellfish, fish, and of course oysters: the establishment belongs to the Gillardeau family, the famous oyster farmers. The large terrace offers a lovely view, with the Île d'Oléron on the horizon. As for accommodation, Dormir sur la Plage has four large very well-appointed junior suites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%20avenue%20William%20Bertrand%2C%20Marennes%2C%2017320%2C%20France"
    pageTitle="Manger & Dormir sur la Plage"
  />
);

export default MangerDormirSurLaPlage;
