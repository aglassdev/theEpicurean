...
const LaCteBleue = () => (
  <RestaurantPage
    restaurantName="La Côte Bleue"
    address="Avenue Louis-Tudesq, Bouzigues, 34140, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33467783142"
    website="https://www.la-cote-bleue.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Louis-Tudesq%2C%20Bouzigues%2C%2034140%2C%20France"
    pageTitle="La Côte Bleue"
  />
);

export default LaCteBleue;
