...
const Largence = () => (
  <RestaurantPage
    restaurantName="L'Argence"
    address="Rue du Riols, Sainte-Geneviève-sur-Argence, 12420, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565660307"
    website="https://www.largence.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Aubrac, a couple of industry professionals have taken over this old inn dating from the early 1900s that has been completely renovated to sport a refined contemporary style. Chef Jonathan Riboulet, who has a wealth of MICHELIN-starred experience (Guérard, Pic, Lameloise and, above all, 12 years with Bras at Laguiole), serves up a cuisine in which he skilfully allies produce from the terroir (trout from the Monts d'Aubrac, escargots from Aveyron, entrecôte from Aubrac) with local herbs (meadowsweet, wild garlic, salad burnet). The result is playful, fresh and colourful – but also creative, a rare thing in these parts. The bright, modern dining area looks out onto a delightful terrace surrounded by a garden that bursts with blooms in season. Six guestrooms and two spacious, c..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Riols%2C%20Sainte-Genevi%C3%A8ve-sur-Argence%2C%2012420%2C%20France"
    pageTitle="L'Argence"
  />
);

export default Largence;
