...
const ErmitageDeCorton = () => (
  <RestaurantPage
    restaurantName="Ermitage de Corton"
    address="D974, Chorey-lès-Beaune, 21200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33380220528"
    website="https://www.ermitagecorton.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this house set in vineyards opposite Corton “mountain”, the chef aims to shine the spotlight on local producers. His modern meticulous cuisine draws upon his classical training and features a traditional Gallic line-up, including snails and œufs en meurette (poached eggs in red wine) crafted with text-book precision. Stylish interior, inviting patio and spacious guestrooms to prolong your stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D974%2C%20Chorey-l%C3%A8s-Beaune%2C%2021200%2C%20France"
    pageTitle="Ermitage de Corton"
  />
);

export default ErmitageDeCorton;
