...
const LeJourDuPoisson = () => (
  <RestaurantPage
    restaurantName="Le Jour du Poisson"
    address="3 rue de l'Ormeau, Saint-Denis-d'Oléron, 17650, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33546757621"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/saint-denis-d-olron/restaurant/le-jour-du-poisson"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by a youthful team, this friendly little bistro at the tip of the island is often fully booked. The menu, as short as it is tempting, is everything it's cracked up to be: fish, from local fish auctions, features in many guises, short supply chains and natural wines are favoured, the bread is made in-house with flour sourced from Oléron. Agnolotti of langoustines, lemon butter and herbs is the signature dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20de%20l'Ormeau%2C%20Saint-Denis-d'Ol%C3%A9ron%2C%2017650%2C%20France"
    pageTitle="Le Jour du Poisson"
  />
);

export default LeJourDuPoisson;
