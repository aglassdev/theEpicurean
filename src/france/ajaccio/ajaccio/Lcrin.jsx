...
const Lcrin = () => (
  <RestaurantPage
    ...
    address="16 cours du Général-Leclerc, Ajaccio, 20000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33495249432"
    website="https://guide.michelin.com/en/corse/ajaccio/restaurant/ecrin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This endearing restaurant, slightly off the historic town’s crowded tourist track, offers fresh, seasonal, expertly crafted Mediterranean cuisine, such as brandade of forkbeard fish, bottarga and a peppery piquillo cream. The dinky terrace is invariably taken by storm in summertime. Infectiously cosy welcome. A genuine bijou of an eatery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20cours%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Ajaccio%2C%2020000%2C%20France"
    pageTitle="L'Écrin"
  />
);
