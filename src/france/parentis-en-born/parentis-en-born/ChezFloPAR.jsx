...
const ChezFloPAR = () => (
  <RestaurantPage
    ...
    address="9 rue Saint-Barthélémy, Parentis-en-Born, 40160, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33558784021"
    website="https://chezfloparentis.fr/restaurant/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Saint-Barth%C3%A9l%C3%A9my%2C%20Parentis-en-Born%2C%2040160%2C%20France"
    pageTitle="Chez Flo"
  />
);

export default ChezFloPAR;
