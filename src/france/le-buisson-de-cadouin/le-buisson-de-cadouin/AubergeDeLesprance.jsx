...
const AubergeDeLesprance = () => (
  <RestaurantPage
    restaurantName="Auberge de l'Espérance"
    address="3 avenue des Sycomores, Le Buisson-de-Cadouin, 24480, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33553742366"
    website="https://lesperance.eatbu.com/?lang=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Desperate souls should rush to this restaurant that offers hope! The owner extends a warm and smiling welcome, and there is lots of attention to detail in the food, which combines freshness and taste. A reminder that it can be the simple pleasures that leave the deepest impression...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20avenue%20des%20Sycomores%2C%20Le%20Buisson-de-Cadouin%2C%2024480%2C%20France"
    pageTitle="Auberge de l'Espérance"
  />
);

export default AubergeDeLesprance;
