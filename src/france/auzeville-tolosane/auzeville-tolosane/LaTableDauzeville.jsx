...
const LaTableDauzeville = () => (
  <RestaurantPage
    restaurantName="La Table d'Auzeville"
    address="35 chemin de l'Église, Auzeville-Tolosane, 31320, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33561134230"
    website="https://www.latabledauzeville.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this white house in the heart of a village in the suburbs of Toulouse, the chef serves up generous traditional cuisine, including dishes such as fillet of duck with a spicy reduction or tournedos of beef with morel mushrooms. For dessert, a crunchy strawberry tartlet with home-made pistachio ice cream. In fine weather, enjoy your meal on the shady terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20chemin%20de%20l'%C3%89glise%2C%20Auzeville-Tolosane%2C%2031320%2C%20France"
    pageTitle="La Table d'Auzeville"
  />
);

export default LaTableDauzeville;
