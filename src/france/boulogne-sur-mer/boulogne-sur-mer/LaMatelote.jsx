...
const LaMatelote = () => (
  <RestaurantPage
    restaurantName="La Matelote"
    address="80 boulevard Sainte-Beuve, Boulogne-sur-Mer, 62200, France"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€€"
    phoneNumber="+33321301797"
    website="https://www.la-matelote.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run business that pays tribute to women must be a good sign! A “matelote” is the fisherman’s wife, whose talent cannot be equalled when it comes to preparing fish, just like that of this establishment devoted body and soul to seafood (but not to the exclusion of other ingredients). Fish and shellfish are crafted in keeping with culinary tradition and with the firm intention of encouraging sustainable fishing. Save room for the patriotic line-up of Gallic desserts, such as soufflé, the house signature dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20boulevard%20Sainte-Beuve%2C%20Boulogne-sur-Mer%2C%2062200%2C%20France"
    pageTitle="La Matelote"
  />
);

export default LaMatelote;
