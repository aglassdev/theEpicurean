...
const RestaurantDeLaPlage = () => (
  <RestaurantPage
    restaurantName="Restaurant de la Plage"
    address="124 boulevard Sainte-Beuve, Boulogne-sur-Mer, 62200, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33321999090"
    website="https://www.restaurantdelaplage.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After taking a dip, what could be better than a good meal to recharge your batteries? This restaurant across from the beach is an ode to the sea and its bounty – from perfectly cooked and carefully prepared turbot with beetroot and chorizo, to scallops, in season… And, for dessert, crêpes Suzette flambéed in the dining room in front of the customer. Delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=124%20boulevard%20Sainte-Beuve%2C%20Boulogne-sur-Mer%2C%2062200%2C%20France"
    pageTitle="Restaurant de la Plage"
  />
);

export default RestaurantDeLaPlage;
