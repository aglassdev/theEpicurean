...
const LlotVert = () => (
  <RestaurantPage
    restaurantName="L'Îlot Vert"
    address="36 rue de Lille, Boulogne-sur-Mer, 62200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33321920162"
    website="https://www.lilotvert.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20de%20Lille%2C%20Boulogne-sur-Mer%2C%2062200%2C%20France"
    pageTitle="L'Îlot Vert"
  />
);

export default LlotVert;
