...
const Rivage = () => (
  <RestaurantPage
    restaurantName="Rivage"
    address="11 quai Saint-Ivy, Saint-Pierre-Quiberon, 56510, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297309161"
    website="https://rivage-stpierrequiberon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Catherine and Hervé Bourdon (previously of Le Petit Hôtel du Grand Large) have entrusted the keys to their establishment to their former colleagues, Pauline and Thomas Le Morlec. Its prime location on the port of Portivy has not changed. The small seasonal menu draws on local ingredients, often from short supply chains (such as the fish). Diners can look forward to the flavour, simplicity and natural harmony of ikejime sea bream, spider crab emulsion, sweet chilli and grilled courgette. Six guestrooms upstairs with sea views...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20quai%20Saint-Ivy%2C%20Saint-Pierre-Quiberon%2C%2056510%2C%20France"
    pageTitle="Rivage"
  />
);

export default Rivage;
