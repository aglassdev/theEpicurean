...
const AubergeLescale87 = () => (
  <RestaurantPage
    restaurantName="Auberge L'Escale 87"
    address="Lieu-dit Le Petit-Villeblevin, Villeblevin, 89340, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33386664256"
    website="https://www.lescale87.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Auberge alongside the former Route Nationale 6 is really inviting on account of its quaint interior decorated with various agricultural items and its rustic-style furnishings. When it comes to the food, tradition is the name of the game: country-style calf's head; lamb kidney fricassee; tournedos with morels, and, on top of that, service with a smile. An enjoyable mealtime experience. Pleasant terrace to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Le%20Petit-Villeblevin%2C%20Villeblevin%2C%2089340%2C%20France"
    pageTitle="Auberge L'Escale 87"
  />
);

export default AubergeLescale87;
