...
const LeCafDesArtistes = () => (
  <RestaurantPage
    restaurantName="Le Café des Artistes"
    address="55 rue de Versailles, Ville-d'Avray, 92410, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33141153700"
    website="http://www.etangs-corot.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro is the ideal complement to the Michelin-starred restaurant of this oh-so-bucolic establishment on the outskirts of Paris. It serves contemporary, tasty and inspired cuisine made with top-notch produce – delicious cod, Coco de Paimpol beans, chorizo and lobster cream – that you can enjoy on the terrace as you take in the view of the charming garden. Idyllic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20rue%20de%20Versailles%2C%20Ville-d'Avray%2C%2092410%2C%20France"
    pageTitle="Le Café des Artistes"
  />
);

export default LeCafDesArtistes;
