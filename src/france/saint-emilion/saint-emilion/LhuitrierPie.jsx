...
const LhuitrierPie = () => (
  <RestaurantPage
    restaurantName="L'Huitrier Pie"
    address="11 rue de la Porte-Bouqueyre, Saint-Emilion, 33330, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33557246971"
    website="https://www.lhuitrier-pie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this famous wine-growing village, the enthusiasm and talent of the young owners, Camille and Soufiane, take us on a journey over the course of the meal. Appealing dishes featuring carefully selected ingredients (heirloom tomatoes from the South-West, raspberries, garden verbena and burrata; just-seared John Dory, Coco de Paimpol beans). In fine weather, you can sit out in the pretty little courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20de%20la%20Porte-Bouqueyre%2C%20Saint-Emilion%2C%2033330%2C%20France"
    pageTitle="L'Huitrier Pie"
  />
);

export default LhuitrierPie;
