...
const LaTableDelka = () => (
  <RestaurantPage
    restaurantName="La Table d'Elka"
    address="2 place des Canadiens, Varengeville-sur-Mer, 76119, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33235402988"
    website="https://restaurant-elka.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Laurent Kleczewski and his wife Élodie have set up shop in a renovated farmhouse with a contemporary extension here in Varengeville-sur-Mer. An orchard and a small herb garden that they tend themselves surround the property and are visible through the large picture windows. The chef showcases the cornucopia of Normandy, such as locally fished turbot and seabass, to craft indulgent fare packed in flavour. Solidly anchored in purebred Gallic technique, this fine dining score is enhanced by the odd exotic note: fish of the day with a dashi-spiked butter and local seaweed or fillet of beef in a pepper sauce with olives and raisins...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20des%20Canadiens%2C%20Varengeville-sur-Mer%2C%2076119%2C%20France"
    pageTitle="La Table d'Elka"
  />
);

export default LaTableDelka;
