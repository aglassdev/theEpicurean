...
const LeGindreau = () => (
  <RestaurantPage
    restaurantName="Le Gindreau"
    address="146 rue du Gindreau, Saint-Médard, 46150, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33565362227"
    website="https://www.legindreau.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a small village overlooking the hillsides, the old village school has been transformed into a restaurant. Welcome to the Gindreau in Saint Médard. Chef Pascal Bardet, originally from Lot and who worked for Alain Ducasse for 18 years, particularly at the Louis XV, is flourishing in his own kitchen. “My cooking is entirely free of set rules,” confides this shy, but confident craftsman. His knack with regional produce, particularly truffles, is indeed second to none. Take a seat under the shade of the chestnut trees and watch the sun set in Quercy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=146%20rue%20du%20Gindreau%2C%20Saint-M%C3%A9dard%2C%2046150%2C%20France"
    pageTitle="Le Gindreau"
  />
);

export default LeGindreau;
