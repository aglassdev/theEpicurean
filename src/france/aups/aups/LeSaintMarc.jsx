...
const LeSaintMarc = () => (
  <RestaurantPage
    restaurantName="Le Saint Marc"
    address="7 rue Jean-Pierre-Aloisi, Aups, 83630, France"
    cuisine="Provençal"
    priceRange="€"
    phoneNumber="+33494700608"
    website="https://lesaintmarc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The scenic village of Aups, south of the Verdon Gorges, invites you to make a bistronomic halt. Chef Alexandre Dimitch and his small team play a local, bistronomic score, rich in generous flavours, with truffles in summertime and bouillabaisse and bourride by the fireside in winter. Wine lovers may like to know that the next-door wine cellar becomes a wine bar in the evenings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20Jean-Pierre-Aloisi%2C%20Aups%2C%2083630%2C%20France"
    pageTitle="Le Saint Marc"
  />
);

export default LeSaintMarc;
