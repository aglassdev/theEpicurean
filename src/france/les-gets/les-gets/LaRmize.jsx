...
const LaRmize = () => (
  <RestaurantPage
    restaurantName="La R'mize"
    address="160 rue du Vieux-Village, Les Gets, 74260, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450797557"
    website="https://www.larmize.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=160%20rue%20du%20Vieux-Village%2C%20Les%20Gets%2C%2074260%2C%20France"
    pageTitle="La R'mize"
  />
);

export default LaRmize;
