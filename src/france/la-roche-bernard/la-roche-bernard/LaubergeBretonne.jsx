...
const LaubergeBretonne = () => (
  <RestaurantPage
    restaurantName="L'Auberge Bretonne"
    address="2 Place Duguesclin, La Roche-Bernard, 56130, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299906028"
    website="https://www.auberge-bretonne.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This gastronomic restaurant was taken over by a young couple in 2010 and has a good local reputation. It occupies an old stone house overlooking a small square in the heart of a charming, small town...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Place%20Duguesclin%2C%20La%20Roche-Bernard%2C%2056130%2C%20France"
    pageTitle="L'Auberge Bretonne"
  />
);

export default LaubergeBretonne;
