...
const LaTableDeYoannConte = () => (
  <RestaurantPage
    restaurantName="La Table de Yoann Conte"
    address="13 vieille route des Pensières, Veyrier-du-Lac, 74290, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33450099749"
    website="https://yoann-conte.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Breton chef Yoann Conte discovered the meaning of brotherhood and the importance of food on the high seas. He is committed to creating unpolished and sincere dishes within the fine dining context. An extreme hiker in his spare time, his lakeside garden benefits from his herbalist know-how. His cooking is in his likeness: physical, down-to-earth, adventurous and with a wry sense of humour. Supported by a highly motivated team, he tirelessly refines two set menus with distinct themes: Lake and Mountain, which showcases the Alps, and The Sea, a brilliant evocation of his native Brittany. The savvy food and wine pairings devised by the chef and sommelier are emblematic of the establishment's sustainable ethos. The front-of-house team bring a good dose of humour to the lively service. There are..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20vieille%20route%20des%20Pensi%C3%A8res%2C%20Veyrier-du-Lac%2C%2074290%2C%20France"
    pageTitle="La Table de Yoann Conte"
  />
);

export default LaTableDeYoannConte;
