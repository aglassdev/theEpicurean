...
const LeRestaurantDuCerisier = () => (
  <RestaurantPage
    restaurantName="Le Restaurant du Cerisier"
    address="14 avenue du Peuple-Belge, Lille, 59000, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33374494949"
    website="https://www.lecerisier.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the first floor of an ultra-contemporary building in the centre of Lille, the team can be seen at work in a superb open kitchen. The single set menu makes the most of hand-picked produce. A few examples: langoustine, cabbage, buckwheat, watercress; morel, yellow wine, tarragon, Comté; Quercy duck, red onion, beetroot. The chef turns out perfectly executed dishes, and has a knack for finely crafted sauces and jus. Colourful, vibrant and aromatic – the appetising fruit of this Cherry Tree is well worth picking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20avenue%20du%20Peuple-Belge%2C%20Lille%2C%2059000%2C%20France"
    pageTitle="Le Restaurant du Cerisier"
  />
);

export default LeRestaurantDuCerisier;
