...
const Puret = () => (
  <RestaurantPage
    restaurantName="Pureté"
    address="79 rue de la Monnaie, Lille, 59000, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+33359518791"
    website="https://www.restaurant-purete.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79%20rue%20de%20la%20Monnaie%2C%20Lille%2C%2059000%2C%20France"
    pageTitle="Pureté"
  />
);

export default Puret;
