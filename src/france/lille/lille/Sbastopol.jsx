...
const Sbastopol = () => (
  <RestaurantPage
    restaurantName="Sébastopol"
    address="1 place Sébastopol, Lille, 59000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33320131338"
    website="https://www.restaurantsebastopol.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small eatery, just opposite the Sébastopol Theatre, is something of a landmark of Lille. The chef concocts a concise menu and a tasting menu that change regularly in line with the seasons and are strewn with personal touches. The emphasis is on generous, wholesome fare, like seared scallops from Boulogne, roast artichokes, free-range pork belly, a tangy purée of red cabbage and apple jelly. Buzzy vibe and slick yet unstarched service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20S%C3%A9bastopol%2C%20Lille%2C%2059000%2C%20France"
    pageTitle="Sébastopol"
  />
);

export default Sbastopol;
