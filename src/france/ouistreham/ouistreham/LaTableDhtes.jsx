...
const LaTableDhtes = () => (
  <RestaurantPage
    restaurantName="La Table d'Hôtes"
    address="10 avenue du Général-Leclerc, Ouistreham, 14150, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231971844"
    website="https://latabledhotes-caen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the seaside resort, this family restaurant is the stomping ground of a couple who have experience working in some fine establishments. Yoann Lavalley has bought the stove which he used during his apprenticeship and uses it to create seasonal cuisine that is both flavourful and indulgent. The sommelier, his wife, has curated a nice wine list that represents excellent value for money. Fish of the day, local meat, Normandy cheeses… A pleasant place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20avenue%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Ouistreham%2C%2014150%2C%20France"
    pageTitle="La Table d'Hôtes"
  />
);

export default LaTableDhtes;
