...
const LesSaisonniers = () => (
  <RestaurantPage
    restaurantName="Les Saisonniers"
    address="Boulevard de Tahiti, La Croix-Valmer, 83420, France"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33483128341"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/la-croix-valmer/restaurant/les-saisonniers"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boulevard%20de%20Tahiti%2C%20La%20Croix-Valmer%2C%2083420%2C%20France"
    pageTitle="Les Saisonniers"
  />
);

export default LesSaisonniers;
