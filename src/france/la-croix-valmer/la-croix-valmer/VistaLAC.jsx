...
const VistaLAC = () => (
  <RestaurantPage
    ...
    address="Lily of the Valley, colline Saint-Michel, quartier de Gigaro, La Croix-Valmer, 83420, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33422732200"
    website="https://www.lilyofthevalley.com/fr/restaurant-vista"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The luxury hotel, perched on an unspoilt hillside overlooking the sea, is divine, and its hip, swish Vista restaurant ticks all the boxes! Take a seat by the infinity pool and bask in the exclusive vibe as you sample recipes by chef Vincent Maillard (shoulder of Sisteron lamb braised in savory; Lucien Tendret-style stuffed vegetables; strawberry melba and vanilla millefeuille). Then menu always offers a choice of healthy dishes, in line with the hotel’s wellness programme. Valet parking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lily%20of%20the%20Valley%2C%20colline%20Saint-Michel%2C%20quartier%20de%20Gigaro%2C%20La%20Croix-Valmer%2C%2083420%2C%20France"
    pageTitle="Vista"
  />
);

export default VistaLAC;
