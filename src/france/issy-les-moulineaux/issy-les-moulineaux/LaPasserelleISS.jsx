...
const LaPasserelleISS = () => (
  <RestaurantPage
    restaurantName="La Passerelle"
    address="172 quai de Stalingrad, Issy-les-Moulineaux, 92130, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33146488081"
    website="https://lapasserelle-issy.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is presided over by a talented and motivated chef who knows how to take you on a culinary journey of taste and flavours! Enjoy rigorously selected ingredients in the fine and colourful cuisine that is peppered with Mediterranean influences. The best restaurant in town...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=172%20quai%20de%20Stalingrad%2C%20Issy-les-Moulineaux%2C%2092130%2C%20France"
    pageTitle="La Passerelle"
  />
);

export default LaPasserelleISS;
