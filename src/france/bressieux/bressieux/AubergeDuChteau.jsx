...
const AubergeDuChteau = () => (
  <RestaurantPage
    restaurantName="Auberge du Château"
    address="67 montée du Château, Bressieux, 38870, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33474209101"
    website="https://www.aubergedebressieux.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Christèle and Xavier Vanheule are passionate about food and wine, and put their all into making this Auberge a wonderful establishment. The produce they source from surrounding farms is bursting with freshness. While contemplating the peaks of the Monts du Lyonnais, you can enjoy dishes with robust flavours, including filet of Dombes duckling, split pea purée, grilled pork belly etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20mont%C3%A9e%20du%20Ch%C3%A2teau%2C%20Bressieux%2C%2038870%2C%20France"
    pageTitle="Auberge du Château"
  />
);

export default AubergeDuChteau;
