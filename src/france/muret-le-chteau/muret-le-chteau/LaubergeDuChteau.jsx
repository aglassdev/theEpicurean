...
const LaubergeDuChteau = () => (
  <RestaurantPage
    restaurantName="L'Auberge du Château"
    address="Le Bourg, Muret-le-Château, 12330, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33565477157"
    website="https://www.laubergeduchateau.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant opposite the town hall in an Aveyron village is well known to food lovers, who come here to enjoy contemporary cuisine which places the onus on herbs and vegetables. The dishes are colourful and flavoursome. Lovely flower - filled terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Bourg%2C%20Muret-le-Ch%C3%A2teau%2C%2012330%2C%20France"
    pageTitle="L'Auberge du Château"
  />
);

export default LaubergeDuChteau;
