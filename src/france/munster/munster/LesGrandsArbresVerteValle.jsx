...
const LesGrandsArbresVerteValle = () => (
  <RestaurantPage
    restaurantName="Les Grands Arbres - Verte Vallée"
    address="10 rue Alfred-Hartmann, Munster, 68140, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389771515"
    website="https://www.vertevallee.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a cosy hotel, this eatery’s trendy, minimalist interior is the HQ of chef Thony Billon, who adds a new spin to regional ingredients: pan-fried Vosges ceps and hazelnuts; seabass roasted in champagne, tartare of oysters and watercress gnocchis; a meringue, chestnut and cream delight… His flawless modern score is paired with a fine list of Alsace wines. It makes the heart sing!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Alfred-Hartmann%2C%20Munster%2C%2068140%2C%20France"
    pageTitle="Les Grands Arbres - Verte Vallée"
  />
);

export default LesGrandsArbresVerteValle;
