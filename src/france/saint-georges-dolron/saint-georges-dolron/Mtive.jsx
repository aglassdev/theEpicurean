...
const Mtive = () => (
  <RestaurantPage
    restaurantName="Métive"
    address="48 rue des Quatre-Moulins, Saint-Georges-d'Oléron, 17190, France"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+33743265771"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/saint-georges-d-oleron_1471858/restaurant/metive"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After Baston in Bordeaux, chef Julien Borie and baker Pauline Celle have taken the same enticing concept of a restaurant-bakery, and rooted it even more in the terroir. The chef, who is from these parts, thus has an opportunity to work with local artisans and seafood. The result is confident and masterfully executed bistronomy cuisine, incorporating precisely prepared local produce – particularly the matured fish that can be seen in a display case in the dining area. The bakery turns out natural sourdough breads using organic flour and drawing on genuine artisanal expertise. The decor features stone walls, vintage posters and pale wood furniture; you pass through the bakery to get to the restaurant with a counter and open kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20rue%20des%20Quatre-Moulins%2C%20Saint-Georges-d'Ol%C3%A9ron%2C%2017190%2C%20France"
    pageTitle="Métive"
  />
);

export default Mtive;
