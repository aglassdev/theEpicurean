...
const LaubergeDeLaValleCRO = () => (
  <RestaurantPage
    restaurantName="Auberge de la Vallée"
    address="14 rue Armand-Guillaumin, Crozant, 23160, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33555898003"
    website="https://www.laubergedelavallee.fr/"
    aliases={["L'Auberge de la Vallée"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Locally reared meat (lamb, veal, beef), regional cheeses (mainly goat’s) and veggies from his large market garden… The chef is a fan of the region as you will taste. The delicious food is served in a pleasantly rustic interior. The epitome of a French country inn!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Armand-Guillaumin%2C%20Crozant%2C%2023160%2C%20France"
    pageTitle="Auberge de la Vallée"
  />
);

export default LaubergeDeLaValleCRO;
