...
const RestaurantDeLcluse16 = () => (
  <RestaurantPage
    restaurantName="Restaurant de l'Écluse 16"
    address="Lieu-dit Bonnefontaine, Altwiller, 67260, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388009042"
    website="https://ecluse16.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant standing beside the Canal de la Sarre towpath was once a coaching inn, along which horses used to tow coal from the mines. The chef, from Morbihan in Brittany, cooks up delicious and meticulous cuisine, such as saffron risotto with chorizo served alongside premium quality poultry with wild prawns, or his truly unforgettable take on tarte Tatin. He occasionally uses ingredients from the local terroir, enhanced with condiments or home-made aromatic oils...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Bonnefontaine%2C%20Altwiller%2C%2067260%2C%20France"
    pageTitle="Restaurant de l'Écluse 16"
  />
);

export default RestaurantDeLcluse16;
