...
const LaMaisonBadine = () => (
  <RestaurantPage
    restaurantName="La Maison Badine"
    address="2 rue du Pont-Prouiller, La Tronche, 38700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33476010333"
    website="https://www.maison-badine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming modern establishment, named after one of the chef’s forebears, is depicted by a trendy, casual vibe that mirrors its tattooed maestro. From his open-plan kitchen, Florian Poyet crafts a legible bistronomic score with a strong focus on the seasons: squid in parsley and garlic and white asparagus, Trièves lamb with wild garlic and black limes, slow-baked rhubarb and strawberries in Kampot white pepper…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Pont-Prouiller%2C%20La%20Tronche%2C%2038700%2C%20France"
    pageTitle="La Maison Badine"
  />
);

export default LaMaisonBadine;
