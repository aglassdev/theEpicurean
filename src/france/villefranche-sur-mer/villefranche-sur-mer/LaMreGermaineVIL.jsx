...
const LaMreGermaineVIL = () => (
  <RestaurantPage
    restaurantName="La Mère Germaine"
    address="9 quai Amiral-Courbet, Villefranche-sur-Mer, 06230, France"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+33493017139"
    website="https://www.meregermaine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jean Cocteau used to eat at this local institution, which has been serving fresh fish and seafood since 1938. It is lovely just to sit on the terrace and gaze out over the harbour!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20quai%20Amiral-Courbet%2C%20Villefranche-sur-Mer%2C%2006230%2C%20France"
    pageTitle="La Mère Germaine"
  />
);

export default LaMreGermaineVIL;
