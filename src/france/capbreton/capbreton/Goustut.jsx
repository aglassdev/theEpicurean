...
const Goustut = () => (
  <RestaurantPage
    restaurantName="Goustut"
    address="Quai de la Pêcherie, Capbreton, 40130, France"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+33558421838"
    website="https://www.goustut.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the lookout for a friendly restaurant delivering good food with a rich variety of flavours? Sit back in the relaxed atmosphere and enjoy the mezze menus – a host of local dishes served in small portions for sharing. The house specialty, they feature Capbreton fish and vegetables from the Bastelica family market gardeners. Highlights include the excellent cuttlefish and foie gras pâté en croûte, the fried blue whiting ravioli with pil pil sauce and the crispy bonito roll with Asian spinach and courgette purée...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quai%20de%20la%20P%C3%AAcherie%2C%20Capbreton%2C%2040130%2C%20France"
    pageTitle="Goustut"
  />
);

export default Goustut;
