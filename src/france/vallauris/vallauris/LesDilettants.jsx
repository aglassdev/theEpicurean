...
const LesDilettants = () => (
  <RestaurantPage
    restaurantName="Les Dilettants"
    address="1193 chemin de Saint-Bernard, Vallauris, 06220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33493339959"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/vallauris/restaurant/les-dilettants"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Formerly a salesman for a leading pétanque brand, Thomas Filiaggi changed direction at the age of 30 to satisfy his love of cooking. He proposes an individual cuisine, largely based on fresh vegetables and aromatic herbs from his garden. A gem!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1193%20chemin%20de%20Saint-Bernard%2C%20Vallauris%2C%2006220%2C%20France"
    pageTitle="Les Dilettants"
  />
);

export default LesDilettants;
