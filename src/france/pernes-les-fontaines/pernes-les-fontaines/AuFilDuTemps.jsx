...
const AuFilDuTemps = () => (
  <RestaurantPage
    restaurantName="Au Fil du Temps"
    address="51 place Louis-Giraud, Pernes-les-Fontaines, 84210, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33490300948"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/pernes-les-fontaines/restaurant/au-fil-du-temps6889"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a pedestrian area, just opposite the old church, which has been turned into a cultural centre, this former grocery store is now a charming little restaurant. Sustainable agriculture is favoured, with well - packed dishes: for example, the beef carpaccio, slipper lobster jus, marinated seaweed and oyster fritters...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20place%20Louis-Giraud%2C%20Pernes-les-Fontaines%2C%2084210%2C%20France"
    pageTitle="Au Fil du Temps"
  />
);
