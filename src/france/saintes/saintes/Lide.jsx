...
const Lide = () => (
  <RestaurantPage
    restaurantName="L'IØDE"
    address="89 avenue Gambetta, Saintes, 17100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33546907294"
    website="https://www.restaurantliode.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A butcher's son born on the Île d'Oléron, chef Benjamin Girard has chosen to focus on fish and seafood. In this narrow modern dining space done out in white and blue hues, the delicious dishes with creative touches keep on coming: mackerel half-cooked with a blowtorch, grilled watermelon and tomato water; halibut with a langoustine foam and blackberries; black forest gateau-style explosive cherry dessert. Eater-friendly prices and an enticing wine list with plenty of organic options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=89%20avenue%20Gambetta%2C%20Saintes%2C%2017100%2C%20France"
    pageTitle="L'IØDE"
  />
);
