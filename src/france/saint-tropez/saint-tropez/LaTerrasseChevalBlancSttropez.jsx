...
const LaTerrasseChevalBlancSttropez = () => (
  <RestaurantPage
    ...
    pageTitle="La Terrasse - Cheval Blanc St-Tropez"
  />
);

export default LaTerrasseChevalBlancSttropez;
