...
const LePatioSAI = () => (
  <RestaurantPage
    ...
    address="1 boulevard d'Aumale, Saint-Tropez, 83990, France"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+33494558100"
    website="https://www.hotel-le-yaca.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Patio is part of the hotel Le Yaca and is a stone's throw from the hustle and bustle of the port. It proposes flavoursome and refined Italian cuisine that is much indebted to excellent ingredients imported directly from Italy. The meal is even more pleasant when you are seated on the shady terrace alongside the pool...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20boulevard%20d'Aumale%2C%20Saint-Tropez%2C%2083990%2C%20France"
    pageTitle="Le Patio"
  />
);

export default LePatioSAI;
