...
const BeefbarSAI = () => (
  <RestaurantPage
    ...
    address="Chemin du Pinet, Saint-Tropez, 83990, France"
    cuisine="Meats and Grills"
    priceRange="€€€€"
    phoneNumber="+33494979950"
    website="https://www.loupinet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is Saint Tropez’ delightful take on the beef bar concept that is gaining traction around the world. A stunning terrace overlooking the hotel pool allows red meat lovers and fans of exotic flavours to sample outstanding cuts of meat (wagyu and Black Angus beef), as well as dishes of South American and Asian origin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20du%20Pinet%2C%20Saint-Tropez%2C%2083990%2C%20France"
    pageTitle="Beefbar"
  />
);

export default BeefbarSAI;
