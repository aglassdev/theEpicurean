...
const LesToitsHtelDeParisSainttropez = () => (
  <RestaurantPage
    restaurantName="Les Toits - Hôtel de Paris Saint-Tropez"
    address="1 traverse de la Gendarmerie, Saint-Tropez, 83990, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33483096139"
    website="https://www.hoteldeparis-sainttropez.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Timeless Saint Tropez remains as legendary as ever – this outdoor restaurant perched on the roof terrace of the fabled hotel is further proof of that. Gazing out over the bay and the tiled roofs of the village, you can savour cuisine inspired by the Mediterranean and Provence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20traverse%20de%20la%20Gendarmerie%2C%20Saint-Tropez%2C%2083990%2C%20France"
    pageTitle="Les Toits - Hôtel de Paris Saint-Tropez"
  />
);

export default LesToitsHtelDeParisSainttropez;
