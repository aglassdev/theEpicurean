...
const LattilioChteauDeNoirieux = () => (
  <RestaurantPage
    restaurantName="L'Attilio - Château de Noirieux"
    address="Château de Noirieux, 26 route du Moulin, Briollay, 49125, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33241425005"
    website="https://chateaudenoirieux.com/fr/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This handsome little 17C château and charming 15C manor house are set in grounds on the banks of the River Loir. The restaurant has an elegant interior refurbished in a contemporary style, in a palette of light tones, and a pleasant terrace overlooking the valley. Italian chef Attilio Marrazzo chooses quality ingredients – including produce grown in his own vegetable garden – for his modern cuisine. His dishes (free-range poultry, fricassee of chanterelles with parsley, Caesar-style salad) show a good command of culinary techniques, and can be washed down with a wine from a list that focuses on regional tipples...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Noirieux%2C%2026%20route%20du%20Moulin%2C%20Briollay%2C%2049125%2C%20France"
    pageTitle="L'Attilio - Château de Noirieux"
  />
);

export default LattilioChteauDeNoirieux;
