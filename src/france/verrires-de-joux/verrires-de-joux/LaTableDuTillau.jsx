...
const LaTableDuTillau = () => (
  <RestaurantPage
    restaurantName="La Table du Tillau"
    address="Le Mont des Verrières, Verrières-de-Joux, 25300, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33381694672"
    website="https://letillau.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few metres from the Swiss border, this Franche-Comté farmhouse built out of stone and old wood exudes serenity, just like its elegant guestrooms appointed in chalet style. On the menu, modern cuisine that highlights often regional produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Mont%20des%20Verri%C3%A8res%2C%20Verri%C3%A8res-de-Joux%2C%2025300%2C%20France"
    pageTitle="La Table du Tillau"
  />
);

export default LaTableDuTillau;
