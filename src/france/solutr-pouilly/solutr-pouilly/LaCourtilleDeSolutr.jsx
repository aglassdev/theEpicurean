...
const LaCourtilleDeSolutr = () => (
  <RestaurantPage
    restaurantName="La Courtille de Solutré"
    address="Route de la Roche, Solutré-Pouilly, 71960, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33385358073"
    website="https://www.lacourtilledesolutre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pretty country house, its charming terrace in the shade of an old chestnut tree... and a dynamic Basque chef, who puts passion and good - quality ingredients into his cooking, nicely accompanied by a fine selection of Pouilly - Fuissé wines! There is a handful of guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20la%20Roche%2C%20Solutr%C3%A9-Pouilly%2C%2071960%2C%20France"
    pageTitle="La Courtille de Solutré"
  />
);

export default LaCourtilleDeSolutr;
