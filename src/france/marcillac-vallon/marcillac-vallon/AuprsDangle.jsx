...
const AuprsDangle = () => (
  <RestaurantPage
    restaurantName="Auprès d'Angèle"
    address="2 avenue des Prades, Marcillac-Vallon, 12330, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565424743"
    website="https://www.aupresdangele.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely old house built of local stone is now a chic bistro complete with six cosy guestrooms – a delightful new venture launched by Michel Bras and run by his niece, Audrey. Partners Guillem and Zoé, previously at La Halle aux Grains in Paris, work in tandem in the kitchen. The menu is a homage to Audrey's grandmother and Michel's mother: chicken supreme, roasted sunflower seeds, market-fresh aubergine and a deliciously old-fashioned gratin de coquillettes (a cheesy pasta dish). The sophisticated decor features blown-glass lights reminiscent of the grapes of Marcillac, the rapidly expanding local vineyard. The restaurant even serves its own wine, produced by a winegrower friend...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20avenue%20des%20Prades%2C%20Marcillac-Vallon%2C%2012330%2C%20France"
    pageTitle="Auprès d'Angèle"
  />
);

export default AuprsDangle;
