...
const LaCanourgue = () => (
  <RestaurantPage
    restaurantName="La Canourgue"
    address="Place de la Canourgue, Montpellier, 34000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33499661818"
    website="http://www.hotel-richerdebelleval.com/la-canourgue"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in the lavish inner courtyard of Hotel Richer de Belleval under a glass roof, this bistro of the Pourcel brothers is the quintessence of stylish: cornices, mouldings, crystal chandeliers… The food is equally first rate: beautifully crafted, rich in flavour and just the right dose of creativity. A genuine pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20la%20Canourgue%2C%20Montpellier%2C%2034000%2C%20France"
    pageTitle="La Canourgue"
  />
);

export default LaCanourgue;
