...
const LeBistroUrbain = () => (
  <RestaurantPage
    restaurantName="Le Bistro Urbain"
    address="5 rue Alexandre-Cabanel, Montpellier, 34000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33660949616"
    website="https://www.bistrourbain.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Alexandre-Cabanel%2C%20Montpellier%2C%2034000%2C%20France"
    pageTitle="Le Bistro Urbain"
  />
);

export default LeBistroUrbain;
