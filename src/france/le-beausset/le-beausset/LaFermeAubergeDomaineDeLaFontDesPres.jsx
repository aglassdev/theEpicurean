...
const LaFermeAubergeDomaineDeLaFontDesPres = () => (
  <RestaurantPage
    restaurantName="La Ferme Auberge - Domaine de La Font des Pères"
    address="1306 chemin de Pontillaou, Le Beausset, 83330, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33494152121"
    website="https://www.lafontdesperes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Provence’s hilly terraces, the terrace of this Farm Inn commands a staggering view over the valley and the Sainte-Baume range. Produce from the estate takes pride of place on the menu (the chickens have the run of the pinewood, orchard, olive grove, herb and vegetable garden), which is healthily and creatively crafted by the chef and paired with estate wines. Pretty rooms and cottages also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1306%20chemin%20de%20Pontillaou%2C%20Le%20Beausset%2C%2083330%2C%20France"
    pageTitle="La Ferme Auberge - Domaine de La Font des Pères"
  />
);

export default LaFermeAubergeDomaineDeLaFontDesPres;
