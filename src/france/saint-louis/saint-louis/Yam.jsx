...
const Yam = () => (
  <RestaurantPage
    restaurantName="Yam"
    address="4 rue d'Altkirch, Saint-Louis, 68300, France"
    cuisine="Thai"
    priceRange="€€"
    phoneNumber="+33389912728"
    website="https://restaurant-yam.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can rely on chef Chatchai Klanklong (L'Orchidée) and his brother Kriankai to concoct flavoursome Thai cuisine, such as Tom Yam (prawn and coconut milk soup), or 30-day aged Iberico pork chop with cauliflower and spiced tamarind jus... Premium ingredients, distinctive, well-balanced flavours, precise culinary technique and careful presentation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20d'Altkirch%2C%20Saint-Louis%2C%2068300%2C%20France"
    pageTitle="Yam"
  />
);
