...
const AubergeDeSaintemaure = () => (
  <RestaurantPage
    restaurantName="Auberge de Sainte-Maure"
    address="99 route de Méry, Sainte-Maure, 10150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33325769041"
    website="https://auberge-saintemaure.ovh/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Victor Martin and his chef Julien Drapier, a native of the region, are a well-established team. The intelligent and harmonious dishes beautifully showcase local ingredients, in bold-flavoured combinations, often with Asian influences, such as gyozas with a soy and ginger broth or the biscuit and matcha tea cream. Add to that smiling service, good value for money and a pleasant terrace by the water...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20route%20de%20M%C3%A9ry%2C%20Sainte-Maure%2C%2010150%2C%20France"
    pageTitle="Auberge de Sainte-Maure"
  />
);

export default AubergeDeSaintemaure;
