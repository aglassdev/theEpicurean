...
const RosmadecLeMoulin = () => (
  <RestaurantPage
    restaurantName="Rosmadec Le Moulin"
    address="Venelle de Rosmadec, Pont-Aven, 29930, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33298060022"
    website="https://rosmadec.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first restaurant in Finistère to clinch a MICHELIN star (way back in 1933!), the iconic Moulin de Rosmadec is a mecca for Breton gastronomy. It is set against an enchanting backdrop, with its flower-decked terrace on the banks of the Aven, on a site steeped in history - the mill dates back to the 15C. Sébastien Martinez's cuisine is an ode to Brittany's terroir (buckwheat, buttermilk, Plougastel strawberries) and local seafood (spider crab, langoustine, lobster). The chef delivers refined and delicate dishes with robust flavours and characterful sauces: a first-rate dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Venelle%20de%20Rosmadec%2C%20Pont-Aven%2C%2029930%2C%20France"
    pageTitle="Rosmadec Le Moulin"
  />
);

export default RosmadecLeMoulin;
