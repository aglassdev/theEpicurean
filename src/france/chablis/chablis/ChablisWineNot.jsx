...
const ChablisWineNot = () => (
  <RestaurantPage
    restaurantName="Chablis Wine Not"
    address="Rue des Moulins, Chablis, 89800, France"
    cuisine="Meats and Grills, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33672141939"
    website="https://www.chabliswinenot.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this world-famous wine-growing village, a wine bistro is bound to be a hit. Picture the scene: a local entrepreneur, two Japanese chefs who are huge fans of French cuisine, top-notch ingredients (house-made tapas, charcuterie and purebred meats that have been perfectly matured), and an amazing wine list at bargain prices (to sample here or take away). Local patrons and wine-loving tourists mingle here, and a positive atmosphere reigns. To be consumed in moderation!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20des%20Moulins%2C%20Chablis%2C%2089800%2C%20France"
    pageTitle="Chablis Wine Not"
  />
);

export default ChablisWineNot;
