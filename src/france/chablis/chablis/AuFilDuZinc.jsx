...
const AuFilDuZinc = () => (
  <RestaurantPage
    restaurantName="Au Fil du Zinc"
    address="18 rue des Moulins, Chablis, 89800, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33386339639"
    website="https://www.aufilduzinc.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mathieu Sagardoytho, the new owner-chef of the Zinc, signs a creative menu that pays tribute to painstakingly sourced ingredients (mackerel from Trinité-sur-Mer marinated in mirin, lamb from Clavisy farm, plums from Yonne). Remarkable list of Chablis (and other Burgundies)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20des%20Moulins%2C%20Chablis%2C%2089800%2C%20France"
    pageTitle="Au Fil du Zinc"
  />
);

export default AuFilDuZinc;
