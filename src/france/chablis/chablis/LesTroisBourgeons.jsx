...
const LesTroisBourgeons = () => (
  <RestaurantPage
    restaurantName="Les Trois Bourgeons"
    address="10 rue Auxerroise, Chablis, 89800, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33386466323"
    website="https://restaurant-chablis.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary bistro with an understated decor has blossomed in an old cellar belonging to Domaine Laroche, famous for producing Chablis. Trained in Tokyo and some top-flight French establishments, the Japanese chef invites his customers to partake in cuisine inspired by regional dishes revisited with imagination. Good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Auxerroise%2C%20Chablis%2C%2089800%2C%20France"
    pageTitle="Les Trois Bourgeons"
  />
);

export default LesTroisBourgeons;
