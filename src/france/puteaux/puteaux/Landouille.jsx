...
const Landouille = () => (
  <RestaurantPage
    restaurantName="L'Andouille"
    address="6 rue Collin, Puteaux, 92800, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33145064520"
    website="https://restaurantlandouille.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jean-Pierre and Jarlène Vasseur have opened this welcoming neighbourhood restaurant on the corner of a residential street in his hometown. Trained under Thierry Breton, he cooks up sincere and hearty bistro cuisine with nods to Brittany. Cream of pumpkin soup finished to order, andouille de Guémené and grilled pork belly with buttery mashed potatoes, apple kouign amann or Paris-Brest-Paris in homage to his former mentor: delicious, well-made dishes to be enjoyed in a simple but lively setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Collin%2C%20Puteaux%2C%2092800%2C%20France"
    pageTitle="L'Andouille"
  />
);

export default Landouille;
