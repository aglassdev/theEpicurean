...
const Saperlipopette = () => (
  <RestaurantPage
    restaurantName="Saperlipopette !"
    address="9 place du Théâtre, Puteaux, 92800, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33141370000"
    website="https://www.saperlipopette1.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former brewery has had a major facelift, to become an inviting, trendy restaurant, under expert direction. The generous food is in a chic bistro style and neatly presented...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20du%20Th%C3%A9%C3%A2tre%2C%20Puteaux%2C%2092800%2C%20France"
    pageTitle="Saperlipopette !"
  />
);

export default Saperlipopette;
