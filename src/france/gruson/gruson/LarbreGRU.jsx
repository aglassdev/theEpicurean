...
const LarbreGRU = () => (
  <RestaurantPage
    restaurantName="L'Arbre"
    address="1 pavé Jean-Marie-Leblanc, Gruson, 59152, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33320795533"
    website="https://www.larbre.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former café, on the route of the mythical Paris-Roubaix cycling race, turns out a concise bistronomic lineup that shines the spotlight on local, seasonal produce. Lovely terrace in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20pav%C3%A9%20Jean-Marie-Leblanc%2C%20Gruson%2C%2059152%2C%20France"
    pageTitle="L'Arbre"
  />
);

export default LarbreGRU;
