...
const LeStoffletChteauColbert = () => (
  <RestaurantPage
    restaurantName="Le Stofflet - Château Colbert"
    address="Place du Château, Maulévrier, 49360, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33241555133"
    website="https://www.chateaucolbert.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This magnificent 17C tuffeau and granite château is already worth a visit for its rich chequered history and its 800m² cottage garden, voted the most beautiful cottage garden of France in 2016 and 2021. Guests are welcomed beneath a 13m-high dome, before progressing into one of two dining rooms, both of which sport high ceilings and crystal chandeliers. This glamorous interior is fully equal to the fine dining experience of contemporary cuisine: wafer-thin tartlet of aubergine caviar, prawns and radishes; guinea fowl, herb butter, mashed potato and autumn veggies; roast figs in port wine, almond cake, honey and vanilla ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Ch%C3%A2teau%2C%20Maul%C3%A9vrier%2C%2049360%2C%20France"
    pageTitle="Le Stofflet - Château Colbert"
  />
);

export default LeStoffletChteauColbert;
