...
const LedulisJonathanDatin = () => (
  <RestaurantPage
    restaurantName="L'Edulis - Jonathan Datin"
    address="8 rue de l'Abreuvoir, Granville, 50400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33214134588"
    website="https://www.restaurantledulis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant's tasteful interior nicely offsets the food, which is devised by an enthusiastic and talented chef, the grandson of a baker. Meticulous cuisine, fine regional produce and culinary delights: quite simply, the best restaurant in Granville...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20l'Abreuvoir%2C%20Granville%2C%2050400%2C%20France"
    pageTitle="L'Edulis - Jonathan Datin"
  />
);

export default LedulisJonathanDatin;
