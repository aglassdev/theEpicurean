...
const LaTableDeLhtelSaintevictoire = () => (
  <RestaurantPage
    restaurantName="La Table de l'Hôtel Sainte-Victoire"
    address="33 avenue des Maquisards, Vauvenargues, 13126, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33442540101"
    website="https://www.hotelsaintevictoire.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brazilian chef Mateus Marangoni concocts unusual menus rich in exotic notes, in tribute to his South American upbringing and time spent in Spain. The food is balanced and fresh; in fine weather, meals are served on the patio, opposite Sainte-Victoire and Vauvenargues Castle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20avenue%20des%20Maquisards%2C%20Vauvenargues%2C%2013126%2C%20France"
    pageTitle="La Table de l'Hôtel Sainte-Victoire"
  />
);

export default LaTableDeLhtelSaintevictoire;
