...
const LeTerroirDesVignobles = () => (
  <RestaurantPage
    restaurantName="Le Terroir des Vignobles"
    address="CC Le Valaisan 2, Montvalezan, La Rosière, 73700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33981503802"
    website="https://www.leterroirdesvignobles.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Terroir and vineyard: the name says it all, summing up this young couple's passion for good food, good ingredients (local, but not exclusively – you'll see tuna and sea bream on the menu) and fine wines; the wine list features an organic selection from Savoie and elsewhere. Whether after or before skiing, mountain biking or hiking, the chef's recipes will whet your appetite: saddle of rabbit, red cabbage compote; cod loin, parsnip purée and mixed vegetables; vanilla sablé, blueberry cream and sorbet, pistachio cream. This pleasant rustic-style mountain bistro is perched on the top floor of a building in the resort...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=CC%20Le%20Valaisan%202%2C%20Montvalezan%2C%20La%20Rosi%C3%A8re%2C%2073700%2C%20France"
    pageTitle="Le Terroir des Vignobles"
  />
);

export default LeTerroirDesVignobles;
