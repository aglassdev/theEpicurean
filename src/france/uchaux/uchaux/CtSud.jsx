...
const CtSud = () => (
  <RestaurantPage
    restaurantName="Côté Sud"
    address="3395 route d'Orange, Uchaux, 84100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490406608"
    website="https://www.restaurantcotesud.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You are bound to enjoy your visit to this stone house with a garden and pleasant terrace. The chef whips up intelligent recipes packed with regional tributes. Examples include a 64°C poached egg, mushrooms and foie gras, or a breast of guinea fowl marinated in garden thyme and garnished with sweet potatoes and an olive oil sauce. The wine list focuses on organic and biodynamic wines. Charming service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3395%20route%20d'Orange%2C%20Uchaux%2C%2084100%2C%20France"
    pageTitle="Côté Sud"
  />
);

export default CtSud;
