...
const LeTempsDeVivre = () => (
  <RestaurantPage
    restaurantName="Le Temps de Vivre"
    address="322 route de Bollène, Uchaux, 84100, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33490406600"
    website="https://www.letempsdevivre-uchaux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stone-built house, dating back to the 18C but with a contemporary decor, invites you to slow down and enjoy life, especially on its shaded terrace. The chef and his wife have the laws of hospitality down to a T. On the menu: the generosity of Provence, with vegetables grown by the father-in-law, in season; aioli on Friday lunchtime in summer, and a set menu dedicated to truffles in winter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=322%20route%20de%20Boll%C3%A8ne%2C%20Uchaux%2C%2084100%2C%20France"
    pageTitle="Le Temps de Vivre"
  />
);

export default LeTempsDeVivre;
