...
const LeMChteauDeMassillan = () => (
  <RestaurantPage
    restaurantName="Château de Massillan"
    address="730 chemin de Massillan, Uchaux, 84100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490406451"
    website="https://www.chateaudemassillan.fr/"
    aliases={["Le M - Château de Massillan"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautiful 16C castle stands in extensive grounds surrounded by vineyards. The food aims to enhance the estate’s organic cottage garden and orchard produce. You can wash down your meal with a biodynamic wine from the Domaine de la Guicharde, which also produces the olive oil used in the kitchen. Slick, smiling service. In summer, take a seat in the courtyard adorned with a fountain, overlooking the garden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=730%20chemin%20de%20Massillan%2C%20Uchaux%2C%2084100%2C%20France"
    pageTitle="Château de Massillan"
  />
);

export default LeMChteauDeMassillan;
