...
const ChezFrancis = () => (
  <RestaurantPage
    restaurantName="Chez Francis"
    address="61 avenue de Paris, Brive-la-Gaillarde, 19100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33555744172"
    website="https://www.chezfrancis.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chez Francis has the inviting atmosphere of a family-run bistro with its vintage poster adverts, all manner of bric-a-brac and messages left by clients. Kick back and tuck into dishes made with quality seasonal ingredients, in particular Limousin meats aged for some time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%20avenue%20de%20Paris%2C%20Brive-la-Gaillarde%2C%2019100%2C%20France"
    pageTitle="Chez Francis"
  />
);

export default ChezFrancis;
