...
const EnCuisine = () => (
  <RestaurantPage
    restaurantName="En Cuisine"
    address="39 avenue Édouard-Herriot, Brive-la-Gaillarde, 19100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33555749753"
    website="https://www.encuisine.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since undergoing a complete refurbishment following a fire, the interior of this refined restaurant displays a degree of Scandinavian flair. The dishes are all about finesse and mouth-watering flavours: eg the soft and tender skate wing accompanied by delicious home-made gnocchi flavoured with lemon and flat parsley, enhanced by a delicious sweet and sour sauce. Everything is well executed – compliments to the chef!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20avenue%20%C3%89douard-Herriot%2C%20Brive-la-Gaillarde%2C%2019100%2C%20France"
    pageTitle="En Cuisine"
  />
);

export default EnCuisine;
