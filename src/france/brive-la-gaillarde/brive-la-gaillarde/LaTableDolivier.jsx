...
const LaTableDolivier = () => (
  <RestaurantPage
    restaurantName="La Table d'Olivier"
    address="3 rue Saint-Ambroise, Brive-la-Gaillarde, 19100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33555189595"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/brive-la-gaillarde/restaurant/la-table-d-olivier"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At Olivier’s Table, Pierre is in the kitchen, while his partner, Fanny, a talented pastry chef, oversees the front-of-house. Normandy-born Pierre has enthusiastically embraced Corrèze, his land of adoption, in this town centre stone house, whose modern furnishings and designer lighting are the epitome of elegant. The repertory, in tune with the zeitgeist and at bargain prices, ticks all the boxes: enticing, polished and colourful. Examples include poached oysters, marinated seabass with citrus fruit and a lemon-vodka sorbet; veal scallop and sweetbread, ravioles of chanterelle mushrooms and black garlic followed by a chocolate, pecan nut, clementine and citrus fruit sorbet extravaganza to finish. It is well worth taking the time to do justice to such a spread!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Saint-Ambroise%2C%20Brive-la-Gaillarde%2C%2019100%2C%20France"
    pageTitle="La Table d'Olivier"
  />
);

export default LaTableDolivier;
