...
const LesAnnes30 = () => (
  <RestaurantPage
    restaurantName="Les Années 30"
    address="73 rue Haute Saint-Maurice, Chinon, 37500, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33247933718"
    website="https://www.lesannees-30.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20rue%20Haute%20Saint-Maurice%2C%20Chinon%2C%2037500%2C%20France"
    pageTitle="Les Années 30"
  />
);

export default LesAnnes30;
