...
const Locanic = () => (
  <RestaurantPage
    restaurantName="L'Océanic"
    address="13 rue Rabelais, Chinon, 37500, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33247934455"
    website="https://loceanic-chinon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ocean breeze blows as far inland as Chinon! As its name suggests, this restaurant gives seafood pride of place. The chef prepares very fresh fish, adding a dash of originality, with a pinch of spice here and a hint of sweet and sour there. Good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Rabelais%2C%20Chinon%2C%2037500%2C%20France"
    pageTitle="L'Océanic"
  />
);

export default Locanic;
