...
const LeClosDesOliviers = () => (
  <RestaurantPage
    restaurantName="Le Clos des Oliviers"
    address="53 rue de l'Aven, Saint-Gély-du-Fesc, 34980, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33631999613"
    website="https://www.clos-des-oliviers.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taste, simplicity, skilful use of quality ingredients: here, you can enjoy good food without unnecessary complications – and what a real pleasure! The wine list is put together with the neighbouring cellarman. In summer, make the most of the terrace in the shade of the reed screening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20rue%20de%20l'Aven%2C%20Saint-G%C3%A9ly-du-Fesc%2C%2034980%2C%20France"
    pageTitle="Le Clos des Oliviers"
  />
);

export default LeClosDesOliviers;
