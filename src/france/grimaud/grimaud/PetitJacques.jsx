...
const PetitJacques = () => (
  <RestaurantPage
    restaurantName="Petit Jacques"
    address="Place des Pénitents, Grimaud, 83310, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33648686031"
    website="https://www.restaurantpetitjacques.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you make your way up through the pretty paved streets of Grimaud to this enchanting leafy patio, you are already bewitched. Spread over two floors, the charm of this house is undeniable (light wooden floors, raftered ceilings, lime plastered walls, well-worn bench seating and soft lighting). The Quebec-born chef and his partner in charge of the front of house regale diners with spot-on market-fresh cuisine and a traditional culinary line-up, featuring family favourites like onion soup or French toast (of brioche) with a scoop of Madagascan vanilla ice cream to die for! Everything is made in house, including the bread!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20des%20P%C3%A9nitents%2C%20Grimaud%2C%2083310%2C%20France"
    pageTitle="Petit Jacques"
  />
);

export default PetitJacques;
