...
const Lquilibre = () => (
  <RestaurantPage
    restaurantName="L'Équilibre"
    address="10 place de la Libération, Balma, 31130, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33561457043"
    website="https://www.restaurant-lequilibre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by a couple of 30 - somethings, who believe in hearty, wholesome food, this restaurant fully deserves its resounding success. The chef concocts inspired and balanced recipes using top - quality, market - fresh produce: flawlessly poached egg with cream of leeks and ginger; haddock and carrot pickles. Outstanding value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20de%20la%20Lib%C3%A9ration%2C%20Balma%2C%2031130%2C%20France"
    pageTitle="L'Équilibre"
  />
);

export default Lquilibre;
