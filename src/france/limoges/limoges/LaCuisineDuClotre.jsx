...
const LaCuisineDuClotre = () => (
  <RestaurantPage
    restaurantName="La Cuisine du Cloître"
    address="6 rue des Allois, Limoges, 87000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33555102829"
    website="https://www.la-cuisine-du-cloitre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of the cathedral, this former 17C cloister has plenty of character, courtesy of its old stones blended with more contemporary decor and furnishings. The chef's market-fresh cuisine varies with his mood (multi-course surprise menus in the evening) and the season. His consummate technique and the quality of the ingredients make for a pleasant experience, with a simpler, shorter menu at lunchtime. From the shaded terrace, you can even catch a glimpse of the chef at work in the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%20Allois%2C%20Limoges%2C%2087000%2C%20France"
    pageTitle="La Cuisine du Cloître"
  />
);

export default LaCuisineDuClotre;
