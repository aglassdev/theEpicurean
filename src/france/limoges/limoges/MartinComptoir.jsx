...
const MartinComptoir = () => (
  <RestaurantPage
    restaurantName="Martin Comptoir"
    address="13 rue Lansecot, Limoges, 87000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33555342553"
    website="https://www.martincomptoir.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone’s throw from the market (ideal for fresh produce), the clientele is drawn by the work of youthful chef, Martin Dumas, also a local lad. His culinary score, perfectly in tune with today’s tastes, features a brief seasonal menu, generous hunks of meat to be shared and the house speciality, “thickly sliced calf’s liver”, which he learnt from Jean-Paul Arabian in Paris. Small, quiet terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Lansecot%2C%20Limoges%2C%2087000%2C%20France"
    pageTitle="Martin Comptoir"
  />
);

export default MartinComptoir;
