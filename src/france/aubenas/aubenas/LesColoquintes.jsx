...
const LesColoquintes = () => (
  <RestaurantPage
    restaurantName="Les Coloquintes"
    address="18 quai de l'Ardèche, Aubenas, 07200, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€"
    phoneNumber="+33475935833"
    website="https://www.les-coloquintes.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20quai%20de%20l'Ard%C3%A8che%2C%20Aubenas%2C%2007200%2C%20France"
    pageTitle="Les Coloquintes"
  />
);

export default LesColoquintes;
