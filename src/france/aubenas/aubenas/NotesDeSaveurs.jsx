...
const NotesDeSaveurs = () => (
  <RestaurantPage
    restaurantName="Notes de Saveurs"
    address="16 rue Nationale, Aubenas, 07200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475939446"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/aubenas/restaurant/notes-de-saveurs"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting in the vaulted room with exposed stones, looking onto the ruins of the former Benedictine convent, you can enjoy food that places the onus on quality ingredients. The dishes are generous, delicious, flavoursome and original. A friendly and pleasant place, opened by a young couple in 2011...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20Nationale%2C%20Aubenas%2C%2007200%2C%20France"
    pageTitle="Notes de Saveurs"
  />
);

export default NotesDeSaveurs;
