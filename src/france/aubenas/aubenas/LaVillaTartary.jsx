...
const LaVillaTartary = () => (
  <RestaurantPage
    restaurantName="La Villa Tartary"
    address="64 rue de Tartary, Aubenas, 07200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475352311"
    website="https://www.restaurant-ardeche.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fine freestone vaulting, designer furniture, a delightful terrace... This converted water mill – previously used in the silk production process – has bags of charm. Lovely flavours on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64%20rue%20de%20Tartary%2C%20Aubenas%2C%2007200%2C%20France"
    pageTitle="La Villa Tartary"
  />
);

export default LaVillaTartary;
