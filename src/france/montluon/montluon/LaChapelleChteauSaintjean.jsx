...
const LaChapelleChteauSaintjean = () => (
  <RestaurantPage
    restaurantName="La Chapelle - Château Saint-Jean"
    ...
    pageTitle="La Chapelle - Château Saint-Jean"
  />
);

export default LaChapelleChteauSaintjean;
