...
const BistrotSaintjean = () => (
  <RestaurantPage
    restaurantName="Bistrot Saint-Jean"
    address="Avenue Henri-de-la-Tourfondue, Montluçon, 03100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33470032657"
    website="https://www.chateau-saint-jean.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro shares its grounds and chef, Olivier Valade, with Château Saint Jean’s other restaurant. The single set menu is the quintessence of creative bistro nosh: fillet of smoked mackerel, seaweed dressing and crunchy onion rings; tartare of veal, roast figs, red onion pickles, a crisp wafer-thin biscuit and shavings of smoked meat. The kitchen overlooks a long dining room and terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Henri-de-la-Tourfondue%2C%20Montlu%C3%A7on%2C%2003100%2C%20France"
    pageTitle="Bistrot Saint-Jean"
  />
);

export default BistrotSaintjean;
