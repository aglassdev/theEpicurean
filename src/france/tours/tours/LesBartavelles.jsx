...
const LesBartavelles = () => (
  <RestaurantPage
    restaurantName="Les Bartavelles"
    address="33 rue Colbert, Tours, 37000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33247611407"
    website="https://www.bartavelles.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Devoted to pleasure! First-rate, often local produce: smoked trout from the Moulin des Couvent or Touraine asparagus. Ingredients with crisp, legible flavours, such as rack of roast lamb, cocoa flavouring, roast fennel, potatoes and mushrooms. Chef Ghislain Damaye and his sister Véronique, who tends to the wellbeing of the front of house, pay tribute to the memory of French novelist Marcel Pagnol, in their smart, city centre bistro, courtesy of an ethos that seeks to share their love of good food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20rue%20Colbert%2C%20Tours%2C%2037000%2C%20France"
    pageTitle="Les Bartavelles"
  />
);

export default LesBartavelles;
