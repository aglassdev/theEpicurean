...
const Case = () => (
  <RestaurantPage
    restaurantName="Case."
    address="37 rue Étienne-Marcel, Tours, 37000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247385987"
    website="https://guide.michelin.com/en/centre-val-de-loire/tours/restaurant/case"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the old town of Tours, a young couple have breathed new life into this 15C building. The interior decor is now a blend of contemporary style and original architecture: whitewashed and brown stucco-clad walls, zellige tiles, white metal chairs with mesh backs and stainless steel tables. Mélanie Cases, formerly a textile product manager with a passion for art, designed the ceramic tableware and linen herself. In the kitchen, Rodolphe Boidron, with a wealth of experience in high-calibre establishments (Le Lucé, Auberge du Bon Laboureur, Les Hautes Roches), skilfully crafts creative, delicious bistro cuisine, using local ingredients as and when they are available, for example veal knuckle, peas, broad beans, sage juice and fregola. Very pleasant terrace on a small square...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20rue%20%C3%89tienne-Marcel%2C%20Tours%2C%2037000%2C%20France"
    pageTitle="Case."
  />
);
