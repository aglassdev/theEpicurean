...
const LaTableBgsienne = () => (
  <RestaurantPage
    restaurantName="La Table Bâgésienne"
    address="19 Grande-Rue, Bâgé-le-Châtel, 01380, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385305422"
    website="https://www.latablebagesienne.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the spruce façade of this former coaching inn, chef Martin is as comfortable rustling up hearty Bresse cuisine as he is dishes with influences from outside of the region – from chicken liver terrine and crayfish bisque to semi-cooked salmon maki, horseradish mayonnaise or skrei flavoured with sweet spices. The chef extends an invitation to taste new things, in a spirit of discovery echoed by the globes on the tables. This fragrant, skilful and delicate cuisine is an invitation to embark on a journey of the senses. What better way to celebrate sunny weather than with a rum-flambéed banana with hazelnut ice cream on the pleasant, peaceful terrace at the back...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Grande-Rue%2C%20B%C3%A2g%C3%A9-le-Ch%C3%A2tel%2C%2001380%2C%20France"
    pageTitle="La Table Bâgésienne"
  />
);

export default LaTableBgsienne;
