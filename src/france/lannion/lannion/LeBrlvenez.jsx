...
const LeBrlvenez = () => (
  <RestaurantPage
    restaurantName="Le Brélévenez"
    address="1 rue Stang-Ar-Béo, Lannion, 22300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33256140791"
    website="https://www.restaurant-lebrelevenez.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Stang-Ar-B%C3%A9o%2C%20Lannion%2C%2022300%2C%20France"
    pageTitle="Le Brélévenez"
  />
);

export default LeBrlvenez;
