...
const LaPieQuiCouette = () => (
  <RestaurantPage
    restaurantName="La Pie qui Couette"
    address="1 rue Guizot, Nîmes, 30000, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33466235904"
    website="https://guide.michelin.com/en/occitanie/nimes/restaurant/la-pie-qui-couette"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bang in the heart of Nîmes’ bustling food market, this eatery, run by a seasoned chef, will knock the socks off your tastebuds. Market fare crafted with fresher than fresh produce from the neighbouring market stalls. House specialties include matured meat, cod brandade, chopped beef tartare and île flottante (vanilla custard and meringue). Hearty helpings, an intelligent wine list, tightly packed tables and a good-natured, jovial vibe. No bookings possible, open from 11.30am to 3pm and always packed (try and come off peak at the weekend)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Guizot%2C%20N%C3%AEmes%2C%2030000%2C%20France"
    pageTitle="La Pie qui Couette"
  />
);

export default LaPieQuiCouette;
