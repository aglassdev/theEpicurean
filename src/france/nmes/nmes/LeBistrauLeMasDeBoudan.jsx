...
const LeBistrauLeMasDeBoudan = () => (
  <RestaurantPage
    restaurantName="Le Bistr'AU - Le Mas de Boudan"
    address="351 chemin Bas-du-Mas-de-Boudan, Nîmes, 30000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466406075"
    website="https://www.jerome-nutile.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the annex of his Michelin-starred restaurant, Jérôme Nutile offers a market-fresh slate menu. The culinary line-up takes a new look at textbook Gallic classics and smacks of bistronomic creativity. Examples include creamy artichoke soup jazzed up with truffle oil and foie gras; a half duckling cooked over embers with a honey and thyme sauce; fish of the day from Grau-du-Roi fish auction; a sweet-toothed creamy vacherin with chestnut ice cream and a blackcurrant coulis...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=351%20chemin%20Bas-du-Mas-de-Boudan%2C%20N%C3%AEmes%2C%2030000%2C%20France"
    pageTitle="Le Bistr'AU - Le Mas de Boudan"
  />
);

export default LeBistrauLeMasDeBoudan;
