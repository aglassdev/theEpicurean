...
const GigiTableMditerranenne = () => (
  <RestaurantPage
    restaurantName="Gigi, Table Méditerranéenne"
    address="Margaret - Hôtel Chouleur, 6 rue Fresque, Nîmes, 30000, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33448270800"
    ...
    pageTitle="Gigi, Table Méditerranéenne"
  />
);

export default GigiTableMditerranenne;
