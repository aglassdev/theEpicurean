...
const LeLancelot = () => (
  <RestaurantPage
    restaurantName="Le Lancelot"
    address="12 rue des Déportés, Chilleurs-aux-Bois, 45170, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33238329115"
    website="https://www.restaurantlelancelot.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of the village, this welcoming flower-decked place with a garden and terrace is a real oasis of calm. Cosy setting and cuisine that navigates between tradition and modernity (notably the melt-in-the-mouth pithivier pie, rum crème brûlée, pistachio ice cream), not forgetting Sologne game in season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20des%20D%C3%A9port%C3%A9s%2C%20Chilleurs-aux-Bois%2C%2045170%2C%20France"
    pageTitle="Le Lancelot"
  />
);

export default LeLancelot;
