...
const Brasserie4Temps = () => (
  <RestaurantPage
    restaurantName="Brasserie à 4 Temps"
    address="2 boulevard Barbès, Carcassonne, 11000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33468114444"
    website="https://www.brasserie4temps.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A modern brasserie extended by a shady terrace, where you can enjoy classics that have been given a new spin by Franck Putelat's former sous-chef. House pâté en croûte, beef tartare, vol-au-vent or cassoulet… Rustic, wholesome fare throbbing with flavour. Book ahead to be sure of a table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20boulevard%20Barb%C3%A8s%2C%20Carcassonne%2C%2011000%2C%20France"
    pageTitle="Brasserie à 4 Temps"
  />
);

export default Brasserie4Temps;
