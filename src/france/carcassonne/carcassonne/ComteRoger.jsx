...
const ComteRoger = () => (
  <RestaurantPage
    restaurantName="Comte Roger"
    address="14 rue Saint-Louis, Carcassonne, 11000, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468119340"
    website="https://www.comteroger.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Saint-Louis%2C%20Carcassonne%2C%2011000%2C%20France"
    pageTitle="Comte Roger"
  />
);

export default ComteRoger;
