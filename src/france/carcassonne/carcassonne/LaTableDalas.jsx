...
const LaTableDalas = () => (
  <RestaurantPage
    restaurantName="La Table d'Alaïs"
    address="32 rue du Plô, Carcassonne, 11000, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33468716063"
    website="https://table-alais.fr/fr/accueil-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within the medieval walled city, this is your best bet if you want to avoid the tourist traps. Up the stairs, you'll find the pared-back dining area leading onto a courtyard terrace for dining in fine weather. On the menu, traditional and modern go hand in hand: 64-degree egg, truffle and button mushrooms; cassoulet with Castelnaudary beans and duck confit; pavlova with seasonal fruit and vanilla mascarpone cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20rue%20du%20Pl%C3%B4%2C%20Carcassonne%2C%2011000%2C%20France"
    pageTitle="La Table d'Alaïs"
  />
);

export default LaTableDalas;
