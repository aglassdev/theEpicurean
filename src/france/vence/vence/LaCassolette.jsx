...
const LaCassolette = () => (
  <RestaurantPage
    restaurantName="La Cassolette"
    address="10b place Georges-Clemenceau, Vence, 06140, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33493588415"
    website="https://www.lacassolettevence.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This culinary landmark lies in the heart of a picture postcard historic town, facing the town hall. It is a pleasure to take a seat indoors or on the terrace to tuck into dishes of Mediterranean inspiration...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10b%20place%20Georges-Clemenceau%2C%20Vence%2C%2006140%2C%20France"
    pageTitle="La Cassolette"
  />
);

export default LaCassolette;
