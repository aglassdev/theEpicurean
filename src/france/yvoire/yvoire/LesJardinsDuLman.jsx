...
const LesJardinsDuLman = () => (
  <RestaurantPage
    restaurantName="Les Jardins du Léman"
    address="30 Grande-Rue, Yvoire, 74140, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450728032"
    website="https://www.lesjardinsduleman.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the pedestrianised medieval city, this appealing restaurant is laid out over several levels and furnished in a contemporary style. It proposes modern, impeccably crafted and generous dishes, all washed down with the best Savoie wines. Attentive welcome and service. Be sure to book if you wish to enjoy the splendid panoramic terrace overlooking the château and Lake Geneva...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20Grande-Rue%2C%20Yvoire%2C%2074140%2C%20France"
    pageTitle="Les Jardins du Léman"
  />
);

export default LesJardinsDuLman;
