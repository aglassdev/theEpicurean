...
const LePrDeLaCure = () => (
  <RestaurantPage
    restaurantName="Le Pré de la Cure"
    address="1 place de la Mairie, Yvoire, 74140, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33450728358"
    website="https://www.hotel-restaurant-piscine-haute-savoie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fancy diving into Lake Geneva! The view is as stunning as the food is mouth - watering. Fish and produce from the lake take pride of place in the menu, as do succulent local specialties. Depending on availability, you will taste pike, perch or trout. A treat for the taste buds!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20de%20la%20Mairie%2C%20Yvoire%2C%2074140%2C%20France"
    pageTitle="Le Pré de la Cure"
  />
);

export default LePrDeLaCure;
