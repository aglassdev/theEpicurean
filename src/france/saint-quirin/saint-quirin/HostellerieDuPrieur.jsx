...
const HostellerieDuPrieur = () => (
  <RestaurantPage
    restaurantName="Hostellerie du Prieuré"
    address="163 rue du Général-de-Gaulle, Saint-Quirin, 57560, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33387086652"
    website="https://www.prieuresaintquirin.fr/le-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 18C sandstone former convent chants a pure-bred Gallic culinary litany based on regional produce (rack of lamb from the Moselle meadows, fillet of Lorraine beef) and seafood (brill, line-caught whiting, scallops). The portions are generous and the desserts by Maeva (the owners’ daughter) are divinely decadent, illustrated by her Grand Marnier-flavoured strawberry soup. Charming welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=163%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Saint-Quirin%2C%2057560%2C%20France"
    pageTitle="Hostellerie du Prieuré"
  />
);

export default HostellerieDuPrieur;
