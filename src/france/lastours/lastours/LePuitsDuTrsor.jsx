...
const LePuitsDuTrsor = () => (
  <RestaurantPage
    restaurantName="Le Puits du Trésor"
    address="21 route des Quatre-Châteaux, Lastours, 11600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33468775024"
    website="https://lepuitsdutresor.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Jean-Marc Boyer, a true craftsman whose passion is unmistakable, draws his culinary inspiration from solitary walks in the surrounding hills. Aromatic herbs and wild garlic enhance colourful dishes that are rife with crisp, forthright flavours, such as wild asparagus with morels from the Montagne Noire, Banka trout with lomo bacon and sautéed broad beans or confit rhubarb with raspberries accompanied by rhubarb and Limousin cream cheese ice cream. He arranges everything into a single set menu, packed with surprises. The interior, designed by Régis Dho in a Japanese vein, provides the perfect foil to the chef's uncluttered culinary vision. This is a restaurant with a leisurely pace, so if you’re in a hurry, it might be best to come back when you have more time…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20route%20des%20Quatre-Ch%C3%A2teaux%2C%20Lastours%2C%2011600%2C%20France"
    pageTitle="Le Puits du Trésor"
  />
);

export default LePuitsDuTrsor;
