...
const LaTableDuRouan = () => (
  <RestaurantPage
    restaurantName="La Table du Rouan"
    address="2 boulevard de la Jamagne, Gérardmer, 88400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33329633686"
    website="https://www.jamagne.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Julien Jeanselme, a committed and welcoming chef, creates fresh and straightforward cuisine, whose regional roots do not preclude nods to other influences, especially Provence (he's a fan of fish soup), or tributes – here, to his great - grandfather, who was awarded a Michelin star... in 1936! – with the Ernest Jeanselme mountain terrine. A reliably good option...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20boulevard%20de%20la%20Jamagne%2C%20G%C3%A9rardmer%2C%2088400%2C%20France"
    pageTitle="La Table du Rouan"
  />
);

export default LaTableDuRouan;
