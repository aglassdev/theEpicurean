...
const RestaurantMarcon = () => (
  <RestaurantPage
    restaurantName="Restaurant Marcon"
    address="Larsiallas, 18 chemin de Brard, Saint-Bonnet-le-Froid, 43290, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33471599372"
    ...
    bio="The Marcons are a family team: Régis Marcon senior, self-proclaimed Auvergnat-Italian, exceptional cook, entrepreneur and culinary authority, works with his sons, Jacques, who has confidently moved to the forefront, and Paul, Bocuse d’Or 2025. Here, one thing is clear: the market and the seasons dictate the menu. There is something for everyone: meat from the plateau, Le Puy green lentils, asparagus, broad beans, snails and, above all, mushrooms – the family speciality, which they pick in autumn. This is food with strong roots – whole roasted Vocance squab paired with stewed green peas and stuffed morels, or a gently sautéed fillet of Arctic char and fennel confit in a butter of elderflower. Without forgetting, the wickedly enticing cheeseboard, laden with Salers, Fourme and Saint-Nectaire..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Larsiallas%2C%2018%20chemin%20de%20Brard%2C%20Saint-Bonnet-le-Froid%2C%2043290%2C%20France"
    pageTitle="Restaurant Marcon"
  />
);

export default RestaurantMarcon;
