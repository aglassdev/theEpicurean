...
const BistrotLaCoulemelle = () => (
  <RestaurantPage
    restaurantName="Bistrot la Coulemelle"
    address="2 rue du Fanget, Saint-Bonnet-le-Froid, 43290, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33471656362"
    website="https://www.lesmaisonsmarcon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This delightful bistro in the middle of the village is an outpost of Régis and Jacques Marcon's fine dining restaurant. Traditional pâté en croûte, updated with every season; roast chicken fillet, chicken leg rillettes with hazelnut and pumpkin; cheeses from the Ardèche and Auvergne: What more can we say? This hearty fare is fiendishly delicious. The open kitchens lend the place an inviting feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Fanget%2C%20Saint-Bonnet-le-Froid%2C%2043290%2C%20France"
    pageTitle="Bistrot la Coulemelle"
  />
);

export default BistrotLaCoulemelle;
