...
const MaisonChilo = () => (
  <RestaurantPage
    restaurantName="Maison Chilo"
    address="1410 rue Principale, Barcus, 64130, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559289079"
    website="https://www.maison-chilo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arnaud Chilo and his sister Marina embody the fourth generation at the helm of this family inn established back in 1937. They brought a breeze of change, illustrated by new furniture and a reappointed dining room, which has happily retained its comforting rustic character, without forgetting the splendid view over the lush valley and the mountains from the terrace. The delicately updated cuisine is liberally sprinkled in fine Basque produce and keeps pace with the seasons: smoked trout; baked pollock in a crust; 7-hour slow-roasted shoulder of lamb…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1410%20rue%20Principale%2C%20Barcus%2C%2064130%2C%20France"
    pageTitle="Maison Chilo"
  />
);

export default MaisonChilo;
