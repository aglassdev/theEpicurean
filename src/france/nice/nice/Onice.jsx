...
const Onice = () => (
  <RestaurantPage
    restaurantName="ONICE"
    address="5 rue Antoine-Gautier, Nice, 06300, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33786555033"
    website="https://www.restaurantonice.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Oh Nice, how your flavours captivate! Lorenzo Ragni and Florencia Montes are the endearing and talented Italo-Argentinian couple at the helm of this intimate address in the antiques quarter. After an international career in Michelin-starred restaurants, they met at Mauro Colagreco's Mirazur. Today, they jointly sign a festival of crisp, gutsy dishes that reflect the seasons and the local catch, together with the occasional striking, and most welcome, flavour combination: tagliatelle of cuttlefish, lemon and citron dressing; seabass paired with an emulsion of champagne and cockles; bloody orange sorbet, koji rice pudding and green cardamon… A restaurant that delivers the goods every time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Antoine-Gautier%2C%20Nice%2C%2006300%2C%20France"
    pageTitle="ONICE"
  />
);
