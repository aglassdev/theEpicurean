...
const LeBistrotDesDocks = () => (
  <RestaurantPage
    restaurantName="Le Bistrot des Docks"
    address="2 rue Flaminius-Raiberti, Nice, 06000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33423207255"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/nice/restaurant/le-bistrot-des-docks"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At a remove from the tourist trail, this unassuming gourmet bistro has opened its doors opposite the Docks de la Riviera covered market, in the area around the market (Marché de la Libération) and the Gare du Sud food hall. The local clientele, who delight in the cuisine of chef Nicolas Mendjisky, have given it their seal of approval. Presented on a blackboard, his mouth-watering short menu showcases fresh, local ingredients. Dishes such as market vegetables on crostini or sea bass with lemon butter embody refined yet generous cuisine that draws on seasonal Mediterranean flavours. The chef's partner, Sofia, provides smiling service and a warm welcome. Concise wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Flaminius-Raiberti%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Le Bistrot des Docks"
  />
);

export default LeBistrotDesDocks;
