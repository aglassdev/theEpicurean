...
const LeBistrotDeJan = () => (
  <RestaurantPage
    restaurantName="Le Bistrot de Jan"
    address="12 rue Lascaris, Nice, 06000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33493268162"
    website="https://www.janonline.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Next door to its MICHELIN-starred counterpart JAN, the laid-back yet elegant little brother has plenty of panache. With emerald-green walls and floors, crystal chandeliers, exposed stone pillars and floral arrangements, a bistro atmosphere reigns, yes, but a glamorous and refined one! The food strikes a nice balance between classic French bistro dishes – Rossini tournedos, sole meunière, tarte Tatin – and more personal influences. Chef Jan Hendrik, originally from South Africa, mischievously slips in a few childhood memories, such as lentil bobotie and malva pudding with house-made vanilla ice cream. Vegetarian options with a cosmopolitan twist complete the menu. There is also a reasonably priced lunch set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Lascaris%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Le Bistrot de Jan"
  />
);

export default LeBistrotDeJan;
