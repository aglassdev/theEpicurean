...
const LeChantecler = () => (
  <RestaurantPage
    restaurantName="Le Chantecler"
    address="Le Negresco, 37 promenade des Anglais, Nice, 06000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33493166410"
    website="https://www.hotel-negresco-nice.com/fr/les-restaurants/le-chantecler"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Le Negresco regally occupies its seafront location on Nice’s iconic Promenade des Anglais. MOF 2015, Virginie Basselot, is at the helm of its fine dining restaurant, Le Chantecler. In this swanky setting, the Normandy-born chef makes no secret of her ambition to craft a creative, modern score using first-class ingredients, cherry-picked from local artisans with whom she has forged strong ties. Each dish tells a story of purity and simplicity, illustrated by Mediterranean monkfish in a lemon balm and Var lemon-laced butter, or red mullet with combava-flavoured cabbage purée and a seasoning made out of the liver. Slick, swish service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Negresco%2C%2037%20promenade%20des%20Anglais%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Le Chantecler"
  />
);

export default LeChantecler;
