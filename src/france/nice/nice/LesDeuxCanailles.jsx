...
const LesDeuxCanailles = () => (
  <RestaurantPage
    restaurantName="Les Deux Canailles"
    address="6 rue Chauvain, Nice, 06000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33953839199"
    website="https://www.lesdeuxcanailles.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the management of a Japanese chef who lacks neither experience nor enthusiasm, this smart establishment can be relied upon to deliver the goods. The lunchtime menu is something of a bargain for Nice! The score is Mediterranean, minimalist, fresh and wonderfully delicate, with a scattering of Japanese twists...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Chauvain%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Les Deux Canailles"
  />
);

export default LesDeuxCanailles;
