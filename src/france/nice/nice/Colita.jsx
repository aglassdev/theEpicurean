...
const Colita = () => (
  <RestaurantPage
    restaurantName="Colita"
    address="20 rue Catherine-Ségurane, Nice, 06000, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33493071569"
    website="https://www.colita-nice.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located between Nice's port and the Colline du Château, this restaurant brings together the flavours of Colombia and Italy in bright and colourful fusion dishes cooked up by chefs Carlos and Daniele. Diners soak up the warm, relaxed atmosphere on the spacious terrace with orange seating or in the narrow indoor dining space done out in terracotta hues. In the visible kitchen, it is all about open-flame cooking – on plancha and parrilla grills. Grilled octopus, braised veal chop and sardines in a chimichurri sauce deliver intense flavours; a vibrant and well-balanced Peruvian ceviche combines white fish, red onion, crunchy sweetcorn and sweet potato. An authentic spot straddling two culinary cultures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Catherine-S%C3%A9gurane%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Colita"
  />
);
