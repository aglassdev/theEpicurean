...
const Apopino = () => (
  <RestaurantPage
    restaurantName="Apopino"
    address="11 bis rue Grimaldi, Nice, 06000, France"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33497148602"
    website="https://www.apopinorestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestling in a chic neighbourhood, this bistro with a navy blue decor is home to a Piedmontese chef. He prepares market cuisine, Mediterranean – as you might expect, with Italian influences: fillet of bass accompanied by a crushed courgette trumpet and Taggiasca olives. The suggestions on the blackboard change according to the season and to the chef's inspiration. Everything is house-made, with the exception of the artisan bread, which comes from an excellent bakery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20bis%20rue%20Grimaldi%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="Apopino"
  />
);

export default Apopino;
