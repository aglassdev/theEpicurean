...
const Lalchimie = () => (
  <RestaurantPage
    restaurantName="L'Alchimie"
    address="14 rue Maccarani, Nice, 06000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33493546185"
    website="https://www.lalchimie-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Picture a modern, buzzy hangout popular with local foodies for its sensibly priced honest food and its particularly enticing lunch menu, something of a bargain for Nice. Think pork in a tom kha kai stock, beef confit in peas and carrots or upside-down-style apple tartlet – good food that ticks all the boxes. Invariably fully booked for the first service, it is much easier to find a table come 2pm. Only open for dinner on Friday and Saturday...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Maccarani%2C%20Nice%2C%2006000%2C%20France"
    pageTitle="L'Alchimie"
  />
);

export default Lalchimie;
