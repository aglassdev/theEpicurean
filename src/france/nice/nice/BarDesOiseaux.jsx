...
const BarDesOiseaux = () => (
  <RestaurantPage
    restaurantName="Bar des Oiseaux"
    address="5 rue Saint-Vincent, Nice, 06300, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33493802733"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/nice/restaurant/bar-des-oiseaux"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this small corner house, Armand Crespo's Bird Bar won't fail to have foodies flapping with delight. Fine traditional French dishes (brandade, bourride) feature alongside delicious artisanal pasta: ravioli and stuffed chicken, seafood linguine etc. All at reasonable prices, in a decor inspired by pop art...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Saint-Vincent%2C%20Nice%2C%2006300%2C%20France"
    pageTitle="Bar des Oiseaux"
  />
);

export default BarDesOiseaux;
