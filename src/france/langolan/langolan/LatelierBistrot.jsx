...
const LatelierBistrot = () => (
  <RestaurantPage
    restaurantName="L'Atelier Bistrot"
    address="24 rue du Chelas, Langoëlan, 56160, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33297513781"
    website="https://guide.michelin.com/en/bretagne/langolan/restaurant/l-atelier-bistrot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a peaceful Brittany village, this authentic inn dripping in charm has been run by an enthusiastic couple for over a decade now. Wholesome cooking, savvily curated recipes and a spotlight on small local producers and artisans. Single set market-fresh lunchtime menu; more elaborate lineup in the evening. Rustic interior scattered in antiquey paraphernalia and a casual, friendly vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20du%20Chelas%2C%20Lango%C3%ABlan%2C%2056160%2C%20France"
    pageTitle="L'Atelier Bistrot"
  />
);

export default LatelierBistrot;
