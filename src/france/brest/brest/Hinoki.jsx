...
const Hinoki = () => (
  <RestaurantPage
    restaurantName="Hinoki"
    address="6 rue des 11-Martyrs, Brest, 29200, France"
    cuisine="Japanese, Sushi"
    priceRange="€€€€"
    phoneNumber="+33664216846"
    website="https://hinoki-sushi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A real Japanese restaurant in Brest! Hinoki is run by a Breton chef who is deeply passionate about Japanese cuisine. Locally caught fish are selected with minute attention to detail. A word to the wise: opt for a place at the counter (ten covers) for an experience that goes beyond mere dining, as the chef creates his sushi and maki in full view of diners seated here. You will definitely feel a sense of privilege!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%2011-Martyrs%2C%20Brest%2C%2029200%2C%20France"
    pageTitle="Hinoki"
  />
);

export default Hinoki;
