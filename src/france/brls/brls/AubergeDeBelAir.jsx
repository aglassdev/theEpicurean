...
const AubergeDeBelAir = () => (
  <RestaurantPage
    restaurantName="Auberge de Bel Air"
    address="1 Moulin de Bel-Air, Brélès, 29810, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33298043601"
    website="https://www.restaubergedebelair.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This granite-built farmhouse on the banks of the Aber Ildut cuts a picturesque figure with its large garden and lake. On the menu: the fish and seafood cuisine for which Brittany is so famed, eg fillet of pollack with lobster cream. A rustic setting in which to really unwind...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Moulin%20de%20Bel-Air%2C%20Br%C3%A9l%C3%A8s%2C%2029810%2C%20France"
    pageTitle="Auberge de Bel Air"
  />
);

export default AubergeDeBelAir;
