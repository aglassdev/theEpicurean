...
const LatelierLartDesMets = () => (
  <RestaurantPage
    restaurantName="L'Atelier L'Art des Mets"
    address="500 route de Robion, Taillades, 84300, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33490723755"
    website="https://www.latelierlartdesmets.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef proposes neoteric, distinctive cuisine, whose mainstay is wild herbs, which he learned to know through a local herb picker. Goosefoot, wild lemon balm, purslane, mugwort... The culinary score is poetic and rich in flavour, illustrated by Ventoux pork with helichrysum-flavoured poichichade. Consider us smitten!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=500%20route%20de%20Robion%2C%20Taillades%2C%2084300%2C%20France"
    pageTitle="L'Atelier L'Art des Mets"
  />
);

export default LatelierLartDesMets;
