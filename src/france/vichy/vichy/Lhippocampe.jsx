...
const Lhippocampe = () => (
  <RestaurantPage
    restaurantName="L'Hippocampe"
    address="3 boulevard de Russie, Vichy, 03200, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33470976837"
    website="https://www.hippocampe-vichy.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his restaurant near the Parc des Sources, chef Gilles Ruyet prepares seafood dishes in a traditional vein: sole meunière, seared halibut with a beurre blanc sauce, not forgetting the crystallised orange soufflé with Grand Marnier – prepared by his daughter Marianne, who is also to be seen on the restaurant floor. Attractive contemporary decor, plus a view of the kitchen and the lobster tank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20boulevard%20de%20Russie%2C%20Vichy%2C%2003200%2C%20France"
    pageTitle="L'Hippocampe"
  />
);

export default Lhippocampe;
