...
const LcrinDeMarlne = () => (
  <RestaurantPage
    restaurantName="L’Écrin de Marlène"
    address="6 square de la Source-de-l'Hôpital, Vichy, 03200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33470587272"
    website="https://www.marlene-vichy.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in the spa district, the Fer à Cheval shopping mall surrounds the bandstand and the Source de l'Hôpital, which location lends it an undeniable charm. This is the setting in which chef Marlène Chaussemy has set up shop, creating an attractive contemporary decor for her restaurant. Opt for the dining area overlooking the park. By focusing on freshness and seasonality, this cuisine revolving around top-notch ingredients delivers on its promises: tender rack of pork, flavoursome parsnips, delicious delicately breaded black pudding, chocolate soufflé with ice cream and banana flambéed with rum. For those who want to take things up a notch, there is a set menu featuring more premium ingredients (eg pan-fried foie gras, scallops, lamb fillet)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20square%20de%20la%20Source-de-l'H%C3%B4pital%2C%20Vichy%2C%2003200%2C%20France"
    pageTitle="L’Écrin de Marlène"
  />
);

export default LcrinDeMarlne;
