...
const LeGavrinis = () => (
  <RestaurantPage
    restaurantName="Le Gavrinis"
    address="1 rue de l'Île-Gavrinis, Baden, 56870, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33297570082"
    website="https://www.gavrinis.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name of this country house is a nod to the nearby island of Gavrinis. The chef, who trained under Pierre Gagnaire, captures the spirit of Brittany as he showcases the produce of this plentiful, vibrant region, with dishes like a medley of locally grown mushrooms (pleurote, shiitake), served roasted, in ravioles and in consommé or red mullet paired with a chervil coulis and a dressing of bone marrow and andouille, or John Dory, artichokes, cured meat, shellfish and a white wine sauce. A genuine gourmet halt, further enhanced by a ‘sustainable’ interior décor, adorned in driftwood and a soft colour scheme of ecru, oatmeal and grey. The exquisite patio, flower-decked in summertime, adds the final flourish to this felicitous portrait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20l'%C3%8Ele-Gavrinis%2C%20Baden%2C%2056870%2C%20France"
    pageTitle="Le Gavrinis"
  />
);

export default LeGavrinis;
