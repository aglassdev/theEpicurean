...
const Opra = () => (
  <RestaurantPage
    restaurantName="Opéra"
    address="1 rue d'Athènes, Rodez, 12000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565684007"
    website="https://opera-rodez.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After stints in three-star restaurants in Italy and with the Bras family, at the Musée Soulages and at their flagship establishment in Laguiole, Italian chef Vasco Baldisserotto has gone solo in this smart restaurant outside the town centre. He signs a pedigree Gallic score, albeit tinged with Italian influences, particularly from his native Venetian region. Accustomed to top-drawer produce, he painstakingly sources and selects only the best local ingredients. The menus celebrate the seasons and his suppliers, on whom he frequently shines the spotlight. Examples include braised Aveyron beef shank in a carbonara sauce; raviolis stuffed with chocolate and hazelnuts and orange sorbet. If you now add the friendly welcome and seamless service, you will realise why everyone is singing the praise..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20d'Ath%C3%A8nes%2C%20Rodez%2C%2012000%2C%20France"
    pageTitle="Opéra"
  />
);
