...
const AubergeSundgovienne = () => (
  <RestaurantPage
    restaurantName="Auberge Sundgovienne"
    address="1 route de Belfort, Carspach, 68130, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389409718"
    website="https://auberge-sundgovienne.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hotel restaurant is very pleasant: everything is attractive, contemporary and cosy. The cuisine is of a modern slant, concocted by a chef who is eager to please (dressed crab with avocado and grapefruit, pan-fried scallops with sweet potato mousseline). Fine wine list and comfortable rooms for a stopover...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20route%20de%20Belfort%2C%20Carspach%2C%2068130%2C%20France"
    pageTitle="Auberge Sundgovienne"
  />
);

export default AubergeSundgovienne;
