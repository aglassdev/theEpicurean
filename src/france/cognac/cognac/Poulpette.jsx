...
const Poulpette = () => (
  <RestaurantPage
    restaurantName="Poulpette"
    address="46 avenue du Maréchal-de-Lattre-de-Tassigny, Cognac, 16100, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+33545822208"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/cognac/restaurant/poulpette"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now, this is a place that has it in the bag. The deliberately short menu offers tasty market-based cooking, with flights of fancy far and wide; it is made with fine ingredients prepared with care and originality. Amandine, once a dance teacher, now head of service and partner, and Antoine, alumnus of the elite Paris Institute of Political Studies but passionate about food (stints at Lucas Carton and Jadis) have joined forces to offer a delightful culinary experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20avenue%20du%20Mar%C3%A9chal-de-Lattre-de-Tassigny%2C%20Cognac%2C%2016100%2C%20France"
    pageTitle="Poulpette"
  />
);

export default Poulpette;
