...
const MaisonBernard = () => (
  <RestaurantPage
    restaurantName="Maison Bernard"
    address="1 place Frédéric-Mistral, Maillane, 13910, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33973353933"
    website="https://www.maison-bernard.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jérémy Scalia, a thirtysomething chef from the Mazargues neighbourhood in Marseille and former head chef at the MICHELIN-starred La Table de Tourrel, has set up shop on Place Frédéric-Mistral, right next to the church. In this charming bistro with an elegant decor, he serves up relaxed bistronomy cuisine, rooted in uncompromising sourcing of quality produce, including sustainably caught fish from Mathieu Chapel in Le Grau-du-Roi, organic fruit and vegetables from small-scale local producers. The concise, indulgent menu presents a modern, largely seafood-driven taste of Provence: mullet ceviche with turmeric, sea bream with basil sauce vierge and confit fennel, squid in red wine with Camargue rice. Don't miss out on the panisses, served here as an amuse-bouche. There are three guestrooms on..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20Fr%C3%A9d%C3%A9ric-Mistral%2C%20Maillane%2C%2013910%2C%20France"
    pageTitle="Maison Bernard"
  />
);

export default MaisonBernard;
