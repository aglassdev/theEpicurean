...
const LoustaletMaanen = () => (
  <RestaurantPage
    restaurantName="L'Oustalet Maïanen"
    address="16 avenue Lamartine, Maillane, 13910, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33490957460"
    website="https://www.restaurant-saint-remy-de-provence.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here in the hometown of Frédéric Mistral, Provençal culture is celebrated – particularly Léo Lelée's famous painting Les Arlésiennes, represented in this restaurant on blown glass integrated into stunning chandeliers created by a Murano glass artist. Thomas Yvan's sun-drenched fare shines the spotlight on produce from the Alpilles and Camargue: bohémienne de légumes (a medley of vegetables), Alpilles goat's cheese and Parmesan shortbread; hake fillet with roasted fennel, crab sauce and aioli; seasonal fruit pavlova and house-made sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20avenue%20Lamartine%2C%20Maillane%2C%2013910%2C%20France"
    pageTitle="L'Oustalet Maïanen"
  />
);

export default LoustaletMaanen;
