...
const LeMoulinDesQuatreSaisons = () => (
  <RestaurantPage
    restaurantName="Le Moulin des Quatre Saisons"
    address="14 rue Gallieni, La Flèche, 72200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33243451212"
    website="https://www.moulindes4saisons.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This delightful 16C building set in the town centre on the banks of the River Loir offers an absolutely enchanting setting whatever the season! The contemporary cuisine follows the seasons and is accompanied by a fine selection of wines (including some from Austria, the proprietor's home country). On sunny days, you can sit out on the terrace and soak up the enchanting setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Gallieni%2C%20La%20Fl%C3%A8che%2C%2072200%2C%20France"
    pageTitle="Le Moulin des Quatre Saisons"
  />
);

export default LeMoulinDesQuatreSaisons;
