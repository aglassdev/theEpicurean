...
const BistroGaby = () => (
  <RestaurantPage
    restaurantName="Bistro Gaby"
    address="14 avenue du Général-de-Gaulle, Château-Arnoux-Saint-Auban, 04160, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33492644848"
    website="https://www.bonneetape.com/fr/bistrot.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant’s name and wholesome French country cooking are a tribute to Gaby, who was the chef’s grandmother. Market- and garden-fresh ingredients take pride of place in this attractive homely interior, adorned in soft provençal colours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Ch%C3%A2teau-Arnoux-Saint-Auban%2C%2004160%2C%20France"
    pageTitle="Bistro Gaby"
  />
);

export default BistroGaby;
