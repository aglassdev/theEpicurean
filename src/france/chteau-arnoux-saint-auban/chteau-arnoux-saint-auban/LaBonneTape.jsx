...
const LaBonneTape = () => (
  <RestaurantPage
    ...
    address="Chemin du Lac, Château-Arnoux-Saint-Auban, 04160, France"
    cuisine="Provençal"
    priceRange="€€€€"
    phoneNumber="+33492640009"
    website="https://bonneetape.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This imposing Provençal farmstead is steeped in the unmistakable balmy scent of the South of France: think thyme, savory, lavender… A family business for generations, chef Jany Gleize and his daughter Jane embody a vision of Provençal cuisine that is tasty and indulgent, by way of several set menus. Stay over in one of the spacious guestrooms decorated with period furnishings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20du%20Lac%2C%20Ch%C3%A2teau-Arnoux-Saint-Auban%2C%2004160%2C%20France"
    pageTitle="La Bonne Étape"
  />
);

export default LaBonneTape;
