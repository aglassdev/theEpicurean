...
const FleurDeSureau = () => (
  <RestaurantPage
    restaurantName="Fleur de Sureau"
    address="22 rue du Chemin-de-Fer, Gambsheim, 67760, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388218522"
    website="https://fleurdesureau.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This “Elderflower” has taken root opposite the train station! Its gardener is a chef who trained under Jean-Georges Klein at the Arnsbourg and who rustles up food for today’s palate, based on fine seasonal produce : tuna tartare, smoked herring roe, green pepper and blackberry gel, or gently cooked suckling pork, pan-fried cauliflower and plum compote…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20rue%20du%20Chemin-de-Fer%2C%20Gambsheim%2C%2067760%2C%20France"
    pageTitle="Fleur de Sureau"
  />
);

export default FleurDeSureau;
