...
const ChaiNousCommeChaiVous = () => (
  <RestaurantPage
    restaurantName="Chai nous comme Chai vous"
    address="1 rue de la Garde, La Flotte, 17630, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33546094985"
    website="https://www.chainouscommechaivous.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friendly and attractive, this pocket handkerchief restaurant instantly makes you feel at home. The concise, appetising menu showcases island produce with a weakness for seafood, illustrated by the flawlessly cooked monkfish, flanked by a chardonnay-flavoured sabayon and white asparagus. Intelligently curated wine list, the occasional inventive note and a scattering of thoughtful attentions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20la%20Garde%2C%20La%20Flotte%2C%2017630%2C%20France"
    pageTitle="Chai nous comme Chai vous"
  />
);

export default ChaiNousCommeChaiVous;
