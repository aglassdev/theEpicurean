...
const LeBelvdre = () => (
  <RestaurantPage
    ...
    address="11 route du Maquis-Jean-Pierre, Bozouls, 12340, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33565449266"
    website="https://www.belvedere-bozouls.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chic, rustic inn commands a breathtaking view of the famous Bozouls Canyon, a natural cirque hewn out of the limestone plateau. The chef has a contagious enthusiasm for traditional farming methods and wines from small-scale producers, as shown by a dish such as house-smoked bacon, green beans, potatoes and herbs, Causses yoghurt...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20route%20du%20Maquis-Jean-Pierre%2C%20Bozouls%2C%2012340%2C%20France"
    pageTitle="Le Belvédère"
  />
);

export default LeBelvdre;
