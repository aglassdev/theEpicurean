...
const BistrotLouise = () => (
  <RestaurantPage
    restaurantName="Bistrot Louise"
    address="80 place Jean-Vinay, L'Albenc, 38470, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33634201691"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/l-albenc/restaurant/bistrot-louise"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of a village of orchards devoted to walnut growing, this lovely stone building is where Yann Tanneau rolls out a creative and enticing lineup. After learning the ropes in top houses, this tattooed and enthusiastic chef crafts and serves, entirely single-handedly, perfectly executed first-class dishes. You may start with a yummy association of oeuf parfait, creamy celery, smoked haddock and Iberic lomo. For the main course, we recommend juicy, tender poultry breast, underscored by cardamon, combawa and green curry. This elegant, gourmet feast is sampled in a simple, welcoming interior. Booking is essential in this establishment, whose value for pleasure ratio is truly exceptional...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20place%20Jean-Vinay%2C%20L'Albenc%2C%2038470%2C%20France"
    pageTitle="Bistrot Louise"
  />
);

export default BistrotLouise;
