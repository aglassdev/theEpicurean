...
const IthurriaCtBistrot = () => (
  <RestaurantPage
    restaurantName="Ithurria Côté Bistrot"
    address="218 Karrika Nagusia, Ainhoa, 64250, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33559299211"
    website="https://www.ithurria.com/fr/bistrot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his bistro, Xavier Isabal cooks up tasty (and hearty!) Basque cuisine using local ingredients teamed with vegetables from his kitchen garden: traditional piperade with scrambled eggs and Bayonne ham, suckling pig cooked for six hours and potxas (beans) from Navarre, gâteau basque… Diners come here to treat themselves and relax in a laid-back atmosphere – the most coveted spots are on the pleasant terrace shaded by plane trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=218%20Karrika%20Nagusia%2C%20Ainhoa%2C%2064250%2C%20France"
    pageTitle="Ithurria Côté Bistrot"
  />
);

export default IthurriaCtBistrot;
