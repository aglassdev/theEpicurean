...
const LabbayeCaladoise = () => (
  <RestaurantPage
    restaurantName="L’Abbaye Caladoise"
    address="180 rue Georges-Mangin, Villefranche-sur-Saône, 69400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33474621907"
    website="https://www.labbayecaladoise.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This picturesque 17C stone - built edifice has been magnificently transformed into a restaurant. The haunt of discerning foodies (the chef won a 2016 culinary award for his pork pies), the interior has been updated and the menu reflects a distinct regional slant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=180%20rue%20Georges-Mangin%2C%20Villefranche-sur-Sa%C3%B4ne%2C%2069400%2C%20France"
    pageTitle="L’Abbaye Caladoise"
  />
);

export default LabbayeCaladoise;
