...
const LeBistronomeEnBeaujolais = () => (
  <RestaurantPage
    restaurantName="Le Bistronome en Beaujolais"
    address="144 rue d'Anse, Villefranche-sur-Saône, 69400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33474036510"
    website="https://www.le-bistronome-en-beaujolais.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here in the capital of the historical Beaujolais province, this aptly named restaurant boasts a contemporary decor with blue walls, untreated wood and a glass-fronted wine cellar. The dishes, of course, showcase seasonal produce with precision. On this occasion, options included soy-cured egg yolk with shiitake mushrooms and asparagus espuma; pork pluma with artichokes barigoule and a full-bodied liquorice jus; and a chocolate and coffee duo with contrasting textures. The lunch menu is updated every week; the seasonal menu changes throughout the year. Smooth service and a regional wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=144%20rue%20d'Anse%2C%20Villefranche-sur-Sa%C3%B4ne%2C%2069400%2C%20France"
    pageTitle="Le Bistronome en Beaujolais"
  />
);

export default LeBistronomeEnBeaujolais;
