...
const Bellavista = () => (
  <RestaurantPage
    restaurantName="Bellavista"
    address="Place du Foiral, Prats-de-Mollo-la-Preste, 66230, France"
    cuisine="Modern Cuisine, Catalan"
    priceRange="€€"
    phoneNumber="+33468397248"
    website="https://www.hotel-le-bellevue.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is always a pleasure to return to this eatery at the foot of the ramparts. The menu is the epitome of regional, which is not surprising as the chef uses local produce delivered by the farmers in person. Slow-roasted haunch of tender Pyrenean veal, hazelnut-flavoured Catalan picada sauce and millefeuille of potatoes… without forgetting cheese from the Pyrenees! Cosy rooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Foiral%2C%20Prats-de-Mollo-la-Preste%2C%2066230%2C%20France"
    pageTitle="Bellavista"
  />
);
