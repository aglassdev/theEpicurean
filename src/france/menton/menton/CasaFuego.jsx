...
const CasaFuego = () => (
  <RestaurantPage
    restaurantName="Casa Fuego"
    address="80 bis boulevard de Garavan, Menton, 06500, France"
    cuisine="Grills, Argentinian"
    priceRange="€€"
    phoneNumber="+33493171315"
    website="https://www.casafuego.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just opposite Mauro Colagreco's flagship restaurant, this is the Italian-Argentine chef's hacienda-style Argentinian grill, which has a large covered terrace overlooking the sea, the town and the harbour. You are completely transported by this typically Argentine open-flame cooking, which here is well executed and so delicious, with its smoky aromas: empanadas, octopus a la plancha, beef picanha to share, dulce de leche flan. A masterclass in gourmet conviviality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20bis%20boulevard%20de%20Garavan%2C%20Menton%2C%2006500%2C%20France"
    pageTitle="Casa Fuego"
  />
);

export default CasaFuego;
