...
const JrBistronomie = () => (
  <RestaurantPage
    restaurantName="JR Bistronomie"
    address="11 rue Trenca, Menton, 06500, France"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+33607548950"
    website="https://www.jr-bistronomie-restaurant-menton.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw from the sea and the Jean Cocteau Museum, this eatery calls to mind a family home complete with a kids’ play area. The score stars Gallic classics and Provençal and Italian favourites. Examples: caramelised upside-down tomato pie, shoulder of confit lamb and lemon pavlova...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Trenca%2C%20Menton%2C%2006500%2C%20France"
    pageTitle="JR Bistronomie"
  />
);

export default JrBistronomie;
