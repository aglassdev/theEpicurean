...
const LorangerieMEN = () => (
  <RestaurantPage
    ...
    address="3 rue de la Marne, Menton, 06500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33497148491"
    website="https://www.orangeriementon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This inconspicuous restaurant in the centre of town is actually home to a culinary powerhouse. The Japanese chef, who was sous-chef to Bruno Cirino at Café de la Fontaine, masterfully crafts his own addictive take on Mediterranean cuisine, putting a Japanese spin on locally sourced produce. Thanks to ultra-fresh ingredients, spot-on cooking and well-judged seasoning, everything comes together beautifully: eg artichoke hearts à la barigoule with prosciutto chips; salmon tataki with marinated vegetables, or sirloin steak with yuzu kosho. The terrace, partly covered by an awning, looks out onto a pedestrianised street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20de%20la%20Marne%2C%20Menton%2C%2006500%2C%20France"
    pageTitle="L'Orangerie"
  />
);

export default LorangerieMEN;
