...
const AubergeDeGroisy = () => (
  <RestaurantPage
    restaurantName="Auberge de Groisy"
    address="34 route du Chef-Lieu, Groisy, 74570, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450680954"
    website="https://auberge-de-groisy.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This engaging 19C farmstead has been renovated in keeping with today’s tastes: stylish bare beams and stonework and contemporary comforts adorned in beige and linen. Perfect to sample up - to - the - minute cuisine, which focuses on local produce. All the bread and ice cream is homemade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20route%20du%20Chef-Lieu%2C%20Groisy%2C%2074570%2C%20France"
    pageTitle="Auberge de Groisy"
  />
);

export default AubergeDeGroisy;
