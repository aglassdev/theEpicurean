...
const ChteauDorigny = () => (
  <RestaurantPage
    restaurantName="Château d'Origny"
    address="2210 route de Roanne, Ouches, 42155, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33477725267"
    website="https://restaurant.chateaudorigny.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Opening a restaurant in the same village as the mythical Troisgros was a bold decision, to say the least! It has proved a success thanks to chef Julien Laval, who worked with Serge Vieira in Chaudes Aigues, as well as reaching the finals of the French dessert championship. In this 16C château, where terracotta tiles rub shoulders with old stone, the gifted chef is going from strength to strength as his exquisitely plated, classically inspired cooking reveals: royal crab and garden tomatoes in a fermented elderflower and lemon vinegar; rabbit in mustard, roast potatoes, caramelised onions and a meaty sauce; poached plums in lemon, creamy yuzu, sponge finger biscuit and tarragon sorbet. The good life at its best!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2210%20route%20de%20Roanne%2C%20Ouches%2C%2042155%2C%20France"
    pageTitle="Château d'Origny"
  />
);

export default ChteauDorigny;
