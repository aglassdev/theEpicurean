...
const LaTableDeCatusseau = () => (
  <RestaurantPage
    restaurantName="La Table de Catusseau"
    address="86 rue de Catusseau, Pomerol, 33500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33557844040"
    website="https://www.latabledecatusseau.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kendji Wongsodikromo, owner - chef of New Caledonian extraction, fell in love with southwest France and his wife, Nadège, whom you will meet in the dining room. The enthusiastic, young couple does not lack experience as the first taste of their market - fresh, carefully crafted dishes made with tasty, regional ingredients will confirm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=86%20rue%20de%20Catusseau%2C%20Pomerol%2C%2033500%2C%20France"
    pageTitle="La Table de Catusseau"
  />
);

export default LaTableDeCatusseau;
