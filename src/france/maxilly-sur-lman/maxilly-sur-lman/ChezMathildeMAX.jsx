...
const ChezMathildeMAX = () => (
  <RestaurantPage
    restaurantName="Chez Mathilde"
    address="97 route de Lugrin, Maxilly-sur-Léman, 74500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450743631"
    website="https://www.restaurant-chez-mathilde.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mathilde is the daughter of the famous fisherman of Lake Geneva, Eric Jacquier. She is now established in this cheerful eatery in the heart of the village with a concrete counter, off-kilter lighting and light wood bistro furnishings. Her slate menu resembles her spontaneous, playful and intuitive personality!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=97%20route%20de%20Lugrin%2C%20Maxilly-sur-L%C3%A9man%2C%2074500%2C%20France"
    pageTitle="Chez Mathilde"
  />
);

export default ChezMathildeMAX;
