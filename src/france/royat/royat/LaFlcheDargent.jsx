...
const LaFlcheDargent = () => (
  <RestaurantPage
    restaurantName="La Flèche d'Argent"
    address="Hôtel Princesse Flore, 5 place Allard, Royat, 63130, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33473356363"
    website="https://princesse-flore-hotel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Flèche d'Argent – the name is a nod to the incredible Silver Arrows Mercedes-Benz Formula 1 cars of the 1930s – references the nearby Circuit de Charade racetrack. In a plush decor, chef Clément Lorente serves up his contemporary cuisine in a multi-course set menu format. His dishes display excellent technique and incorporate creative touches. The ingredients are of the highest quality: foie gras from the Plaine de Limagne, artichokes from Roussillon, saffron from Mazayes, bluefin tuna from the Mediterranean. For dessert, a tribute to the chef's grandmother's Agen prune flan is a real hit, flambéed tableside. Market-based set menu at lunchtime; brunch on Sundays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Princesse%20Flore%2C%205%20place%20Allard%2C%20Royat%2C%2063130%2C%20France"
    pageTitle="La Flèche d'Argent"
  />
);

export default LaFlcheDargent;
