...
const RacinesSAI = () => (
  <RestaurantPage
    ...
    address="1981 avenue de Trévoux, Saint-Denis-lès-Bourg, 01000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33474524063"
    website="https://domainedulac-racines.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run establishment, which has had a contemporary makeover, affords relaxing views over the surrounding grounds. Chef David Lachavannes continues to deliver tasty and coherent cuisine that makes the most of ties with local producers. The market-fresh Menu du Marché served on weekdays is a bargain; the weekend menus are more ambitious. A real gem...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1981%20avenue%20de%20Tr%C3%A9voux%2C%20Saint-Denis-l%C3%A8s-Bourg%2C%2001000%2C%20France"
    pageTitle="Racines"
  />
);

export default RacinesSAI;
