...
const Cassis = () => (
  <RestaurantPage
    restaurantName="Cassis"
    address="74 rue Joseph-Dufour, Mâcon, 71000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33385382453"
    website="https://www.cassisrestaurant-macon.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is a chef who has worked in some prestigious establishments and who serves meticulous, tasty, no-frills cuisine made from quality ingredients (meat from the Haute-Loire area, vegetables from a local market gardener). Be sure to try the memorable pâté en croûte or the Bresse chicken in a cream sauce. The lunch menu is great value; in the evening a mystery menu is served...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20rue%20Joseph-Dufour%2C%20M%C3%A2con%2C%2071000%2C%20France"
    pageTitle="Cassis"
  />
);
