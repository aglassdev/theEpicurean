...
const LePrXavierBeaudiment = () => (
  <RestaurantPage
    restaurantName="Le Pré - Xavier Beaudiment"
    address="3 route de la Baraque, Clermont-Ferrand, 63000, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33473192500"
    website="https://www.restaurant-lepre.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20route%20de%20la%20Baraque%2C%20Clermont-Ferrand%2C%2063000%2C%20France"
    pageTitle="Le Pré - Xavier Beaudiment"
  />
);

export default LePrXavierBeaudiment;
