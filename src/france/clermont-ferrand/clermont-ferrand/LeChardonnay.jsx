...
const LeChardonnay = () => (
  <RestaurantPage
    restaurantName="Le Chardonnay"
    address="1 place Philippe-Marcombes, Clermont-Ferrand, 63000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33473267995"
    website="https://www.lechardonnay.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hugues Maisonneuve is at the helm of this swish bistro. In the kitchen, a young chef rustles up a concise, seasonal à la carte menu and a particularly enticing market-fresh menu. Everything here looks as good as it tastes. Trendy vintage décor, soft lighting and a pleasant patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20Philippe-Marcombes%2C%20Clermont-Ferrand%2C%2063000%2C%20France"
    pageTitle="Le Chardonnay"
  />
);

export default LeChardonnay;
