...
const Lcureuil = () => (
  <RestaurantPage
    restaurantName="L'Écureuil"
    address="18 rue Saint-Adjutor, Clermont-Ferrand, 63000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33473378386"
    website="https://ecureuil-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern bistro with its chic country decor serves appetising market-fresh cuisine: duck breast with black olives, pork cheeks braised in red wine, French toast made with brioche... The short menu is chalked up on the blackboard, and a simpler lunch deal is available at a snip...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20Saint-Adjutor%2C%20Clermont-Ferrand%2C%2063000%2C%20France"
    pageTitle="L'Écureuil"
  />
);

export default Lcureuil;
