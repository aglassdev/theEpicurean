...
const Linstantan = () => (
  <RestaurantPage
    restaurantName="L'Instantané"
    address="2 rue de l'Abbé-Girard, Clermont-Ferrand, 63000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33473919719"
    website="https://linstantane-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary bistro located in the art gallery district proposes moments of pure culinary bliss, dreamt up by a seasoned chef (Ritz, Lasserre, Plaza). Veal, poultry and pork “porkpie”, 12-hour melt-in-the-mouth beef, roast loin of hake with hazelnut butter, crème brûlée… Finger licking good from start to finish!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20l'Abb%C3%A9-Girard%2C%20Clermont-Ferrand%2C%2063000%2C%20France"
    pageTitle="L'Instantané"
  />
);

export default Linstantan;
