...
const IlVisconti = () => (
  <RestaurantPage
    restaurantName="Il Visconti"
    address="9 rue du Terrail, Clermont-Ferrand, 63000, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33473743526"
    website="https://www.ilvisconti.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20du%20Terrail%2C%20Clermont-Ferrand%2C%2063000%2C%20France"
    pageTitle="Il Visconti"
  />
);

export default IlVisconti;
