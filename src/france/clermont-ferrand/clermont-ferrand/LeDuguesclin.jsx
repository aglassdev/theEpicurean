...
const LeDuguesclin = () => (
  <RestaurantPage
    restaurantName="Le Duguesclin"
    address="3 place des Cordeliers, Clermont-Ferrand, 63100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33473257669"
    website="https://www.le-duguesclin.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This intimate restaurant opposite the former Excise and Duty House serves well-prepared seasonal cuisine in its vaulted room. The short menu is available in the form of land or sea set menus offering very good value for money. During the week, the lunch menu is tailored to the busy business clientele; at dinner, the menu is more ambitious. Summer terrace to the rear to be enjoyed in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20place%20des%20Cordeliers%2C%20Clermont-Ferrand%2C%2063100%2C%20France"
    pageTitle="Le Duguesclin"
  />
);

export default LeDuguesclin;
