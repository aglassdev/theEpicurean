...
const LeMdicis = () => (
  <RestaurantPage
    restaurantName="Le Médicis"
    address="2 allée François-1er, Blois, 41000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33254439404"
    website="https://www.le-medicis.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The contemporary - style interior chimes with the up - to - the - minute culinary creations that keep pace with the market and the seasons; the chef also introduces a handful of welcome Asian touches: a pleasant mealtime in store. Friendly service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20all%C3%A9e%20Fran%C3%A7ois-1er%2C%20Blois%2C%2041000%2C%20France"
    pageTitle="Le Médicis"
  />
);

export default LeMdicis;
