...
const ChristopheHayFleurDeLoire = () => (
  <RestaurantPage
    restaurantName="Christophe Hay - Fleur de Loire"
    address="26 quai Villebois-Mareuil, Blois, 41000, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+33246680181"
    ...
    bio="Chef Christophe Hay is now installed in a grandiose 17C hospice on the banks of the Loire. The centuries-old stone edifice overlooks the river, from which the chef draws all his inspiration. Caroline Tissier, interior designer, was entrusted with recreating his universe in this splendid hotel, that also boasts a brasserie, a pastry shop and a spa. In a modern room decked in premium materials, the chef rolls out his creative fine dining skills and iconic dishes, which are remarkable not only for their lightness, but also flavour and texture. He is determined to highlight the best ingredients from the Loire Valley, fish (exclusively) from the Loire, caught by his “appointed” fisherman, veg from his own kitchen garden as well as from local market gardeners, meat from his Wagyu farm, Ossetra c..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20quai%20Villebois-Mareuil%2C%20Blois%2C%2041000%2C%20France"
    pageTitle="Christophe Hay - Fleur de Loire"
  />
);

export default ChristopheHayFleurDeLoire;
