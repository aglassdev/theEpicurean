...
const LaPlage = () => (
  <RestaurantPage
    ...
    address="21 rue Gustave-Danquin, Audresselles, 62164, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33757679618"
    website="https://www.hoteldelaplage-audresselles.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small hotel-restaurant in a coastal village between Cap Gris-Nez and Cap Blanc-Nez hits all the buttons for a meal on the Opal Coast. Young chef Solène Elliott, whose partner provides friendly service, concocts a tempting seafood-centric menu (sea bream, mackerel, pollack), but not only. Among her delicious and beautifully plated dishes, you may find a velvety soup of white asparagus, caramelised onions, black garlic and fried bread; Licques poultry, mashed potato with cancoillotte cheese, Morteau sausage and braised endive…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20Gustave-Danquin%2C%20Audresselles%2C%2062164%2C%20France"
    pageTitle="La Plage"
  />
);
