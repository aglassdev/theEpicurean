...
const LeBellevueCAM = () => (
  <RestaurantPage
    ...
    address="29 rue des Terrasses, Cambo-les-Bains, 64250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559937575"
    website="https://www.hotel-bellevue64.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The interior is light, and the menu is short. Two reasons to linger in this tastefully decorated restaurant. Traditional cuisine is revisited with enthusiasm and a keen sense of the pleasure of food. Try off - the - bone pig's trotter terrine or, for dessert, the hot soufflé with pear brandy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20des%20Terrasses%2C%20Cambo-les-Bains%2C%2064250%2C%20France"
    pageTitle="Le Bellevue"
  />
);

export default LeBellevueCAM;
