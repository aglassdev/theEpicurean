...
const LeDauphinLEB = () => (
  <RestaurantPage
    ...
    address="2 rue de L'Église, Le Breuil-en-Auge, 14130, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231650811"
    website="https://www.ledauphin-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its half-timbering and quaint charm, this characteristic old inn is the quintessence of Normandy and is now the haunt of a young couple who pay tribute to Normandy’s produce. The Dutch-born chef crafts modern, inspired cuisine, such as monkfish with green peas, aubergine caviar and a floral emulsion, or an upside-down apple tarte Tatin with vanilla ice cream – that is wickedly tempting!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20L'%C3%89glise%2C%20Le%20Breuil-en-Auge%2C%2014130%2C%20France"
    pageTitle="Le Dauphin"
  />
);

export default LeDauphinLEB;
