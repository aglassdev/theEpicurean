...
const LeBoucheOreilleTUL = () => (
  <RestaurantPage
    restaurantName="Le Bouche à Oreille"
    address="39 avenue Charles-de-Gaulle, Tulle, 19000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33544404030"
    website="https://www.leboucheaoreille-tulle.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An opportunity to discover the work of a likeable, self-effacing chef, who is as modest as his food is good. Seasonal ingredients and premium produce feature prominently in his dishes: duck breast cooked rare with prunes and orange, einkorn risotto. It's tasty, flawlessly crafted and delicious! In fine weather, you can sit out on the pretty terrace in the garden to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20avenue%20Charles-de-Gaulle%2C%20Tulle%2C%2019000%2C%20France"
    pageTitle="Le Bouche à Oreille"
  />
);

export default LeBoucheOreilleTUL;
