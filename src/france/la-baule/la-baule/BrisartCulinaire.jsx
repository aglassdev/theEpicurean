...
const BrisartCulinaire = () => (
  <RestaurantPage
    restaurantName="Bris'Art Culinaire"
    address="39 avenue Louis-Lajarrige, La Baule, 44500, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33285959457"
    website="https://www.brisartculinaire.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is space for just eight diners at the large counter laid out face to face with the kitchen, plus a few more tables to the rear. Every day, a single fish-forward set menu is improvised by chef Guillaume Brisard, who has forged an impressive culinary path (Fort de l'Océan in Le Croisic, Le Skipper in Saint-Nazaire). Fine ingredients inspire his dishes, which you can savour as you engage in conversation with the chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20avenue%20Louis-Lajarrige%2C%20La%20Baule%2C%2044500%2C%20France"
    pageTitle="Bris'Art Culinaire"
  />
);

export default BrisartCulinaire;
