...
const LeCastelMarielouise = () => (
  <RestaurantPage
    restaurantName="Le Castel Marie-Louise"
    address="1 avenue Andrieu, La Baule, 44500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33240114838"
    website="https://www.hotelsbarriere.com/fr/la-baule/le-castel-marie-louise.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A prime example of La Baule’s early-20C seaside architecture, this manor house is home to a hotel and a restaurant appointed in a classical bourgeois style whose windows overlook the grounds and pretty terrace. Local lad Jérémy Coirier draws his inspiration from the region (fish, shellfish, Croisic seaweed, Guérande saffron, Mesquer pigeon) to compose a menu that changes with the seasons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20Andrieu%2C%20La%20Baule%2C%2044500%2C%20France"
    pageTitle="Le Castel Marie-Louise"
  />
);

export default LeCastelMarielouise;
