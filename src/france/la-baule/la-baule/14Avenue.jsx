...
const OneFourAvenue = () => (
  <RestaurantPage
    restaurantName="14 Avenue"
    address="14 avenue Pavie, La Baule, 44500, France"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+33240600921"
    website="https://14avenue-labaule.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simplicity and quality are the watchwords here. Seafood ingredients are treated with the utmost respect: appetising when presented on the plate, then nicely prepared by chef Antoine Le Moal. The starter of crab, prawn and lobster is fresh and well seasoned, the skate wing carefully cooked, and the rum baba adds the final flourish of deliciousness. The modern interior is elegant, and the friendly service comes with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20avenue%20Pavie%2C%20La%20Baule%2C%2044500%2C%20France"
    pageTitle="14 Avenue"
  />
);

export default OneFourAvenue;
