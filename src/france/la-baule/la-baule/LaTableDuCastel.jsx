...
const LaTableDuCastel = () => (
  <RestaurantPage
    restaurantName="La Table du Castel"
    address="1 avenue Andrieu, La Baule, 44504, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33240114838"
    website="https://www.hotelsbarriere.com/la-baule/le-castel-marie-louise"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20Andrieu%2C%20La%20Baule%2C%2044504%2C%20France"
    pageTitle="La Table du Castel"
  />
);

export default LaTableDuCastel;
