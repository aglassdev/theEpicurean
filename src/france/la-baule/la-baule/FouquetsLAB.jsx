...
const FouquetsLAB = () => (
  <RestaurantPage
    ...
    address="Le Royal La Baule, 6 avenue Pierre-Loti, La Baule, 44500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33240114848"
    website="https://www.hotelsbarriere.com/la-baule/le-royal/restaurants-et-bars/fouquets-la-baule"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant in the Royal Hotel, typical of the large seaside hotels of the early 20C. The cosy wood panelling and the photos of actors by Studio Harcourt recall the atmosphere of the Parisian Fouquet's. The menu is inspired by brasserie fare (seafood, sole meunière, fillet of beef with Béarnaise sauce, andouillette, profiteroles), but there are also light dishes – as you would expect at a seawater therapy resort...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Royal%20La%20Baule%2C%206%20avenue%20Pierre-Loti%2C%20La%20Baule%2C%2044500%2C%20France"
    pageTitle="Fouquet's"
  />
);

export default FouquetsLAB;
