...
const LesPyrnes = () => (
  <RestaurantPage
    restaurantName="Les Pyrénées"
    address="19 place Charles-de-Gaulle, Saint-Jean-Pied-de-Port, 64220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559370101"
    website="https://hotel-les-pyrenees.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An institution in St Jean Pied de Port, passed down from father to son. Both the decor and the cuisine pay homage to the classicism and taste of the Basque country, all of which with good quality produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20place%20Charles-de-Gaulle%2C%20Saint-Jean-Pied-de-Port%2C%2064220%2C%20France"
    pageTitle="Les Pyrénées"
  />
);

export default LesPyrnes;
