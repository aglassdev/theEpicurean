...
const LaTableDinomoto = () => (
  <RestaurantPage
    restaurantName="La Table d'Inomoto"
    address="85 rue Nationale, Saint-André-de-Cubzac, 33240, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33650726901"
    website="https://www.latabledinomoto.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This endearing bistro has acquired a faithful crowd of regulars, enchanted by the weekly changing menu. Chef Seiji Inomoto expertly crafts fine Franco-Japanese fare, in which humble ingredients are taken to new heights thanks to flawless cooking and astute seasoning (panko breadcrumbs, miso, soy marinated veggies). The food is good, often unusual, and you won't believe the value for money. What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20rue%20Nationale%2C%20Saint-Andr%C3%A9-de-Cubzac%2C%2033240%2C%20France"
    pageTitle="La Table d'Inomoto"
  />
);

export default LaTableDinomoto;
