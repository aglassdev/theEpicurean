...
const LeGrandBleu = () => (
  <RestaurantPage
    restaurantName="Le Grand Bleu"
    address="8 rue Jean-Pierre-Avron, Calais, 62100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33321979798"
    website="https://www.legrandbleu-calais.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef, Matthieu Colin, puts the experience he gained in Michelin-starred establishments to good use. In a lovely contemporary interior, he continues to pay tribute to local fishing, but also brings local produce into creative dishes that thrive on originality: cod with seafood condiments, grapefruit, crozets, spiced fennel. Friendly and efficient service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Jean-Pierre-Avron%2C%20Calais%2C%2062100%2C%20France"
    pageTitle="Le Grand Bleu"
  />
);

export default LeGrandBleu;
