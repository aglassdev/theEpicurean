...
const HistoireAncienne = () => (
  <RestaurantPage
    restaurantName="Histoire Ancienne"
    address="20 rue Royale, Calais, 62100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33321341120"
    website="https://www.histoire-ancienne.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro nurtures its authentic vintage look, courtesy of banquette seating, mirrors and Art deco-style posters. Patrick Comte is at the helm, rolling out his tasty take on traditional seasonal dishes: snail persillade; egg bourguignonne and a buttery golden turnip; Angus faux-filet steak, gratin dauphinois with maroilles and béarnaise sauce; a Paris-Brest-style éclair with hazelnut ice cream… Indulgent cooking that hits the spot every time!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Royale%2C%20Calais%2C%2062100%2C%20France"
    pageTitle="Histoire Ancienne"
  />
);

export default HistoireAncienne;
