...
const Aquaraile = () => (
  <RestaurantPage
    restaurantName="Aquar'aile"
    address="255 rue Jean-Moulin, Calais, 62100, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33321340000"
    website="https://aquaraile.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant top-floor restaurant boasts a peerless panoramic view over the Strait of Dover and the English coast… it is like something you would expect to see in a painting! The food showcases locally caught fish: lobster casserole, sea bass in a salt crust, sole meunière. To be washed down with a good wine chosen from a list carefully curated by the proprietor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=255%20rue%20Jean-Moulin%2C%20Calais%2C%2062100%2C%20France"
    pageTitle="Aquar'aile"
  />
);

export default Aquaraile;
