...
const LinstantROM = () => (
  <RestaurantPage
    ...
    address="10 rue de Delay, Romans-sur-Isère, 26100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475454072"
    website="https://www.restaurant-instant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Outside the centre, in a residential area near the train station, this lovely 1930s town house welcomes you in an attractive contemporary decor; you are served delicious market cuisine, made with lovely fresh ingredients. Dishes that you wolf down... in an Instant!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20de%20Delay%2C%20Romans-sur-Is%C3%A8re%2C%2026100%2C%20France"
    pageTitle="L'Instant"
  />
);

export default LinstantROM;
