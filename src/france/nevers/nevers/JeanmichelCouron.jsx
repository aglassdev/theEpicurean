...
const JeanmichelCouron = () => (
  <RestaurantPage
    restaurantName="Jean-Michel Couron"
    address="21 rue Saint-Étienne, Nevers, 58000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33386611928"
    website="https://www.jm-couron.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Over more than 30 years, this chef has built up a loyal clientele of happy diners courtesy of his contemporary cuisine featuring nods to the Mediterranean, in dishes such as bouillabaisse jus and carpaccio of large wild prawns. The yakitori sauce on the duck fillet is one of his more exotic marriages. You can choose to dine in either the contemporary space or the former 14C cloister...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20Saint-%C3%89tienne%2C%20Nevers%2C%2058000%2C%20France"
    pageTitle="Jean-Michel Couron"
  />
);

export default JeanmichelCouron;
