...
const Largousier = () => (
  <RestaurantPage
    restaurantName="L'Argousier"
    address="1 rue de Sarreguemines, Volmunster, 57720, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33387962899"
    website="https://www.largousier.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this pleasant restaurant with a modern design, chef Jonathan Birkenstock celebrates seasonal and regional produce in contemporary cuisine that demonstrates undeniable finesse. The food is cooked and seasoned to perfection, the presentation flawless, as exemplified by the double-cooked beef with celery, black garlic and passion fruit. The service is extremely obliging! This charming establishment also has a fine selection of aged rums...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Sarreguemines%2C%20Volmunster%2C%2057720%2C%20France"
    pageTitle="L'Argousier"
  />
);

export default Largousier;
