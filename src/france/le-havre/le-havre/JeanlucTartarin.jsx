...
const JeanlucTartarin = () => (
  <RestaurantPage
    restaurantName="Jean-Luc Tartarin"
    address="73 avenue Foch, Le Havre, 76600, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33235454620"
    website="https://www.jeanluc-tartarin.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The late Jean-Luc Tartarin, ever true to his native Normandy, has left his mark on the French gastronomy scene with seafood dishes in which the modernism of Le Havre meets the soul of the region's terroir. In a pleasant, cosy setting decorated in a palette of soothing beige tones, nestled in the historical city centre (a UNESCO World Heritage Site), Annabelle and her team are committed to continuing this legacy and keeping this philosophy alive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20avenue%20Foch%2C%20Le%20Havre%2C%2076600%2C%20France"
    pageTitle="Jean-Luc Tartarin"
  />
);

export default JeanlucTartarin;
