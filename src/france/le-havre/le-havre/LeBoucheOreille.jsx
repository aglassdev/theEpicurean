...
const LeBoucheOreille = () => (
  <RestaurantPage
    restaurantName="Le Bouche à Oreille"
    address="19 rue Paul-Doumer, Le Havre, 76600, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33235454460"
    website="https://guide.michelin.com/en/normandie/le-havre/restaurant/le-bouche-a-oreille531147"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This top-notch establishment is laid out behind a tasteful glazed façade. The chef adheres to tradition when crafting his bold, generous and flavourful cuisine but puts his own stamp on dishes with the odd touch of originality – think prawn tartare, prawn gyoza with coriander and lemongrass, bisque and cashew nuts. His friendly and efficient wife takes care of things front of house, dispensing insightful wine tips along the way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Paul-Doumer%2C%20Le%20Havre%2C%2076600%2C%20France"
    pageTitle="Le Bouche à Oreille"
  />
);

export default LeBoucheOreille;
