...
const Le1815 = () => (
  <RestaurantPage
    restaurantName="Le 1815"
    address="13 place Vauban, Avallon, 89200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33310451616"
    website="https://hoteldelaposteavallon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This venerable 18C coaching inn has played host to some illustrious figures, from Napoleon to Elizabeth Taylor. In its heyday, its restaurant also held three MICHELIN stars. Today, TV presenter and antiques dealer Julien Cohen has restored it to its former glory, decorating it with pieces from his personal collection – all of which are for sale! The restaurant boasts wooden floorboards, chandeliers, painted period ceilings and mirrors. On the menu: a modern take on traditional cuisine, punctuated with creative flourishes and exotic flavours: ikejime yellowtail tataki infused with dashi and served with calamansi pulp, or four-spice magret de canard with a velvety carrot purée...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20place%20Vauban%2C%20Avallon%2C%2089200%2C%20France"
    pageTitle="Le 1815"
  />
);

export default Le1815;
