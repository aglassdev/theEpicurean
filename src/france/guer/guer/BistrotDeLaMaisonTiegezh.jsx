...
const BistrotDeLaMaisonTiegezh = () => (
  <RestaurantPage
    restaurantName="Bistrot de la Maison Tiegezh"
    address="7 place de la Gare, Guer, 56380, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33297220026"
    website="https://www.maisontiegezh.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Garden-fresh tomato salad and courgette cream, local fish of the day, grilled meat and vegetables from local growers, followed by a vanilla millefeuille pastry with salted butter caramel: taste the market-fresh, country cuisine, without killer prices, of a star chef in this bistro, next-door to his star establishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20de%20la%20Gare%2C%20Guer%2C%2056380%2C%20France"
    pageTitle="Bistrot de la Maison Tiegezh"
  />
);

export default BistrotDeLaMaisonTiegezh;
