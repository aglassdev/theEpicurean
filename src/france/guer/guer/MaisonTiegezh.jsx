...
const MaisonTiegezh = () => (
  <RestaurantPage
    ...
    bio="Tiegezh means family in Breton, which does rather say it all! The chef’s grandparents founded Brittany’s first factory to manufacture fresh pancakes. Today, Baptiste Denieul, a gifted young chef who honed his skills at the Bristol with Éric Frechon, invites you to enter this stylish interior, which provides the perfect foil to his delicate, bang on cuisine: fish, vegetables from the garden and farm produce. His wife Marion puts the final touch to this family melody. Nowadays, Maison Tiegezh boasts a gourmet restaurant, a bistro and also a modern, sophisticated hotel with six rooms for overnight stays and longer… A delightful break in the heart of Brittany’s enchanted forest of Broceliande...."
    ...
    pageTitle="Maison Tiegezh"
  />
);

export default MaisonTiegezh;
