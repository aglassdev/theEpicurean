...
const LaPointeDuCapCoz = () => (
  <RestaurantPage
    restaurantName="La Pointe du Cap Coz"
    address="153 avenue de la Pointe, au Cap Coz, Fouesnant, 29170, France"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+33298560163"
    website="https://www.hotel-capcoz.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This white cottage seems to sit right on the ocean. The chef has chosen this isolated location to craft delicious cuisine in line with his commitment to local surf and turf produce. The result is beautifully presented dishes, such as slow-cooked pork cheeks in cider vinegar served with cabbage and apples baked in salted butter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=153%20avenue%20de%20la%20Pointe%2C%20au%20Cap%20Coz%2C%20Fouesnant%2C%2029170%2C%20France"
    pageTitle="La Pointe du Cap Coz"
  />
);

export default LaPointeDuCapCoz;
