...
const LeBastion = () => (
  <RestaurantPage
    restaurantName="Le Bastion"
    address="50 boulevard de la Promenade, Lagrasse, 11220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468120251"
    website="https://www.restaurant-bastion-lagrasse.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a seat in one of two pretty rustic dining spaces to sample avant-garde country fare, inspired by Auguste Escoffier but with a modern twist. Great produce from the region is used – tomatoes from the Estarac Gardens, vinegar by Cyril Codigna, fish fresh from the market at Port la Nouvelle… Concise tapas menu and spacious terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20boulevard%20de%20la%20Promenade%2C%20Lagrasse%2C%2011220%2C%20France"
    pageTitle="Le Bastion"
  />
);

export default LeBastion;
