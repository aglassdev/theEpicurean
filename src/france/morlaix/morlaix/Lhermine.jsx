...
const Lhermine = () => (
  <RestaurantPage
    restaurantName="L'Hermine"
    address="35 rue Ange-de-Guernisac, Morlaix, 29600, France"
    cuisine="Breton, Crêpe"
    priceRange="€"
    phoneNumber="+33298881091"
    website="https://guide.michelin.com/en/bretagne/morlaix/restaurant/l-hermine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This very pleasant crêperie in a picturesque pedestrian area has wooden beams, polished wooden tables and rustic objects. Choose from some 50 savoury buckwheat and sweet pancakes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20rue%20Ange-de-Guernisac%2C%20Morlaix%2C%2029600%2C%20France"
    pageTitle="L'Hermine"
  />
);

export default Lhermine;
