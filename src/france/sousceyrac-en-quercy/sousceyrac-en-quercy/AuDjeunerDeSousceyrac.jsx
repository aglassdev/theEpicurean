...
const AuDjeunerDeSousceyrac = () => (
  <RestaurantPage
    restaurantName="Au Déjeuner de Sousceyrac"
    address="2 allée Gaston-Monnerville, Sousceyrac-en-Quercy, 46190, France"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+33565330056"
    website="https://guide.michelin.com/en/occitanie/sousceyrac-en-quercy/restaurant/au-dejeuner-de-sousceyrac"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A chef dedicated to his craft, Patrick Lagnès draws on solid classical foundations and fine produce to deliver high-quality cuisine. He even tries out a few more contemporary dishes when the inspiration takes him, while desserts are the work of his daughter. Diners are served in the intimate setting of a small dining area done out in traditional style with wainscoting and period furnishings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20all%C3%A9e%20Gaston-Monnerville%2C%20Sousceyrac-en-Quercy%2C%2046190%2C%20France"
    pageTitle="Au Déjeuner de Sousceyrac"
  />
);

export default AuDjeunerDeSousceyrac;
