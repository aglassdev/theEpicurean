...
const LaTableDesMatrus = () => (
  <RestaurantPage
    restaurantName="La Table des Matrus"
    address="26 rue du Grand-Gonnet, Saint-Etienne, 42000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33978802754"
    website="https://www.la-table-des-matrus-restaurant-saint-etienne.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Youth, enthusiasm and creativity: chef Matéo Ravel is a veritable ball of energy, a matru – kid in the Saint-Étienne dialect – who is still only in his early 20s. Here in his trendy bistro with an open kitchen and exposed pipes, he nurtures a network of small-scale producers and natural winegrowers in the Loire. Some of his passion for the trade is also dedicated to making items from scratch: fermented drinks made with indigenous yeasts (beers, kefir, lemonades), sourdough bread, salted bacon matured lardo di Colonnata-style with pork from the Cantal region… And as for his dishes, they are packed with flavour: eg aubergine tarte Tatin, moules-frites and mayonnaise with a twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20rue%20du%20Grand-Gonnet%2C%20Saint-Etienne%2C%2042000%2C%20France"
    pageTitle="La Table des Matrus"
  />
);

export default LaTableDesMatrus;
