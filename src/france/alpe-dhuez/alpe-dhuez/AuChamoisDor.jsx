...
const AuChamoisDor = () => (
  <RestaurantPage
    restaurantName="Au Chamois d'Or"
    address="169 rue Fontbelle, Alpe-d'Huez, 38750, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33476803132"
    website="https://chamoisdor-alpedhuez.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant restaurant is one of the many highlights of the Hotel Chamois d'Or, thanks to its classy, cocooned dining area decked out in wood, and its well-crafted up-to-the-minute cuisine. Inviting lunchtime terrace and a romantic vibe in the evenings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=169%20rue%20Fontbelle%2C%20Alpe-d'Huez%2C%2038750%2C%20France"
    pageTitle="Au Chamois d'Or"
  />
);

export default AuChamoisDor;
