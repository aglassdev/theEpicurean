...
const ManoirDeLankerellec = () => (
  <RestaurantPage
    restaurantName="Manoir de Lan-Kerellec"
    address="11 allée centrale de Lan-Kerellec, Trébeurden, 22560, France"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33296150000"
    website="https://www.lankerellec.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a magical setting overlooking the Channel, this seafront manor house boasts a bright, airy dining room whose raftered ceiling forms the shape of an upside-down ship’s hull. Chef Anthony Avoine, a staunch champion of Brittany produce, rolls out a repertory that gracefully blends finesse with authenticity. Examples include delicate langoustines married with crunchy pig’s trotter and smooth sweet-tasting gwell (a local dairy product) while John Dory is savvily paired with shellfish, wild garlic and a briny foamy emulsion. Attentive service and a breathtaking view further add to the establishment’s value-for-pleasure ratio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20all%C3%A9e%20centrale%20de%20Lan-Kerellec%2C%20Tr%C3%A9beurden%2C%2022560%2C%20France"
    pageTitle="Manoir de Lan-Kerellec"
  />
);

export default ManoirDeLankerellec;
