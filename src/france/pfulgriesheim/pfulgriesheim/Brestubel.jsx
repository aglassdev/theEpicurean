...
const Brestubel = () => (
  <RestaurantPage
    restaurantName="Bürestubel"
    address="8 rue de Lampertheim, Pfulgriesheim, 67370, France"
    cuisine="Alsatian"
    priceRange="€€"
    phoneNumber="+33388200192"
    website="https://www.burestubel.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This half-timbered farmhouse is brimming with Alsatian charm! Pretty regional decor and (very) local specialities: bibalaskas with smoked ham, bacon, garlic and parsley ; veal fleischnacka with mushrooms and cream ; sourdough tartes flammées…and the unmissable “real crème caramel like my grandmother used to make”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20Lampertheim%2C%20Pfulgriesheim%2C%2067370%2C%20France"
    pageTitle="Bürestubel"
  />
);

export default Brestubel;
