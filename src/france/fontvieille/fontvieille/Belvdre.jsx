...
const Belvdre = () => (
  <RestaurantPage
    restaurantName="Belvédère"
    address="Hôtel Belesso, 34 avenue des Baux, Fontvieille, 13990, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33490183140"
    website="https://www.hotelbelesso.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese chef Kohei Ohata skilfully harnesses the flavours of the Mediterranean fare that abounds in the surrounding markets to produce really appealing dishes. His talented wife brings her skills to bear on the pastry section. It is all fresh, fragrant and charged at a fair price. This excellent establishment is a little hidden away in the Hotel Belesso – reserved for those in the know, and all the better for it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Belesso%2C%2034%20avenue%20des%20Baux%2C%20Fontvieille%2C%2013990%2C%20France"
    pageTitle="Belvédère"
  />
);

export default Belvdre;
