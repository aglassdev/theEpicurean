...
const LeRelaisDuCastelet = () => (
  <RestaurantPage
    restaurantName="Le Relais du Castelet"
    address="Mas le Castelet, quartier Montmajour, Fontvieille, 13990, France"
    cuisine="Provençal"
    priceRange="€€€"
    phoneNumber="+33980407481"
    website="https://lerelaisducastelet.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former hunting lodge surrounded by hilly olive groves is a genuine haven of tranquillity. You can expect deftly crafted, local Provençal recipes, served generously with a distinct preference for veggies and herbs from the garden, supplemented by ingredients from local producers. Ten out of ten for Jean-Baptiste Bert who has added a contemporary chapter to the family property where he was born...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mas%20le%20Castelet%2C%20quartier%20Montmajour%2C%20Fontvieille%2C%2013990%2C%20France"
    pageTitle="Le Relais du Castelet"
  />
);

export default LeRelaisDuCastelet;
