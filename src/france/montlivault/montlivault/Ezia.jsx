...
const Ezia = () => (
  <RestaurantPage
    ...
    priceRange="€€€"
    phoneNumber="+33254206230"
    website="https://www.ezia-restaurant.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nicolas Aubry, previously Christophe Hay's executive chef, has now taken over the reins of his mentor's restaurant. The decor has not been changed and it is a pleasure to be back in this modern space with a view into the kitchen. Organised into single set menus that take their cue from the seasons and from produce sourced in the Loire region, the finely crafted dishes are expressions of his delicate cuisine, which may be subtle but has bags of personality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20Chambord%2C%20Montlivault%2C%2041350%2C%20France"
    pageTitle="Ezia"
  />
);
