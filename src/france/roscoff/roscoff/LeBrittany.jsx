...
const LeBrittany = () => (
  <RestaurantPage
    ...
    address="22 boulevard Sainte-Barbe, Roscoff, 29680, France"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+33298697078"
    website="https://www.hotel-brittany.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This elegant Brittany sports a huge stone fireplace and vaulted windows that command a splendid view of the bay and island of Batz. The panoramic dining room is the scene of a feast of gourmet delicacies that shine the spotlight on first-class Breton seafood, like mackerel, but also poultry. Loïc Le Bail is not averse to bold combinations, often influenced by Japanese cuisine – in a nod to his wife and his sous-chef, both of whom are Japanese. The magnificent seaside setting invites us to meditate and wind down, possibly staying over in one of the hotel’s guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20boulevard%20Sainte-Barbe%2C%20Roscoff%2C%2029680%2C%20France"
    pageTitle="Le Brittany"
  />
);

export default LeBrittany;
