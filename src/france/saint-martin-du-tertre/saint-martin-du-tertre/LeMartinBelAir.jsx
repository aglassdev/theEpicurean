...
const LeMartinBelAir = () => (
  <RestaurantPage
    restaurantName="Le Martin Bel Air"
    address="3 place du 19-Mars-1962, Saint-Martin-du-Tertre, 89100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33386664795"
    website="https://www.lemartinbelair.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This completely renovated country bistro opposite the town hall welcomes you into a natural, contemporary setting (pale wood, cork wall decorations, black ceiling). The chef, who has trained in some of the region's finest establishments, creates modern and sophisticated market-fresh dishes that are unbeatable value for money. Think beef tartare with wasabi, onion pickles and spicy carrot – a punchy starter with harmonious flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20place%20du%2019-Mars-1962%2C%20Saint-Martin-du-Tertre%2C%2089100%2C%20France"
    pageTitle="Le Martin Bel Air"
  />
);

export default LeMartinBelAir;
