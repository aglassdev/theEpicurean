...
const LasDeTrfle = () => (
  <RestaurantPage
    restaurantName="L'As de Trèfle"
    address="420 rue Léopold-Hettier, Bernières-sur-Mer, 14990, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+33231972260"
    website="https://www.restaurantasdetrefle.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=420%20rue%20L%C3%A9opold-Hettier%2C%20Berni%C3%A8res-sur-Mer%2C%2014990%2C%20France"
    pageTitle="L'As de Trèfle"
  />
);

export default LasDeTrfle;
