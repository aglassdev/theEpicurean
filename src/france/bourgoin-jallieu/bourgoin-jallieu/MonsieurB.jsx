...
const MonsieurB = () => (
  <RestaurantPage
    restaurantName="Monsieur B"
    address="80 rue de la Liberté, Bourgoin-Jallieu, 38300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33970661511"
    website="https://monsieurb-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cheerful, buzzy bistro stands in the heart of the pedestrian town centre. The young chef cooks up unpretentious, fresh, tasty bistronomic cuisine. The set lunch and evening menus change monthly in line with market availability and the seasons. An example: a creamy soup of parsley roots, scallops and haddock, packed in delicate smoky notes or chicken breast, spelt, supreme sauce and shrimp bisque. The lunchtime menu is a bargain!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20rue%20de%20la%20Libert%C3%A9%2C%20Bourgoin-Jallieu%2C%2038300%2C%20France"
    pageTitle="Monsieur B"
  />
);

export default MonsieurB;
