...
const LaTableDuVentoux = () => (
  <RestaurantPage
    restaurantName="La Table du Ventoux"
    address="Hôtel Crillon Le Brave, place de l'Église, Crillon-le-Brave, 84410, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490656161"
    website="https://www.crillonlebrave.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting an idyllic terrace overlooking Mt Ventoux, the restaurant of this luxury hotel offers two menus, depending on the service: at lunchtime, there are plates for sharing. These cleverly devised and well-prepared dishes are inspired by the Mediterranean and Provence (think Mediterranean prawn carpaccio, flame-roasted octopus with a spicy mayonnaise, potato gnocchi with Parmesan, Sisteron lamb kofta etc). In the evening, the more elaborate menu features premium ingredients (grilled turbot, fennel salad and a peach-verbena condiment; sautéed veal, green beans, artichokes and foie gras and hazelnut jus; poultry from Mazan poached with seaweed). The service, courtesy of a highly attentive team, is professional without being stuffy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Crillon%20Le%20Brave%2C%20place%20de%20l'%C3%89glise%2C%20Crillon-le-Brave%2C%2084410%2C%20France"
    pageTitle="La Table du Ventoux"
  />
);

export default LaTableDuVentoux;
