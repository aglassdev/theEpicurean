...
const Radio = () => (
  <RestaurantPage
    restaurantName="Radio"
    address="43 avenue Pierre-et-Marie-Curie, Chamalières, 63400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33473308783"
    website="https://www.hotel-radio.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="From the heights of the town, this fine hotel dating from the 1930s broadcasts a non-stop resounding tribute to the electro-magnetic waves and the triode vacuum tube that made possible the invention of the talkies and the wireless. Its trendy Art Deco decor has as much impact as it did on the day it opened, with its mosaic flooring, its decorative wrought iron and marriage of glass and mirrors. In the kitchen, chef Wilfrid Chaplain mixes the frequencies of his native Normandy and of his adopted region, Auvergne, a source of gentle, little-known harmonies. Technically proficient, he creates an ambitious, subtle and delicate cuisine that delights the taste buds: Charolais beef, raviolo of confit beef cheek, red wine aromatic jus; monkfish and watercress jus; mackerel marinated in lime, ash-b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20avenue%20Pierre-et-Marie-Curie%2C%20Chamali%C3%A8res%2C%2063400%2C%20France"
    pageTitle="Radio"
  />
);
