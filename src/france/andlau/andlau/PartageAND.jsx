...
const PartageAND = () => (
  <RestaurantPage
    ...
    address="19 rue du Docteur-Stoltz, Andlau, 67140, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388089323"
    website="https://www.restaurant-partage.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Julie and Hugo first met at Lameloise, later setting up shop in the house where Alexis Kreyder (1839-1912) – renowned for his still-life paintings of flowers and fruit – was born. The location, a traditional half-timbered inn painted pomegranate red on the outside and done out in contemporary style inside, wins diners over. As for the food, the talented chef creates nicely fragrant and balanced dishes that taste as good as they look, for example marinated and subtly smoked sea bream, bibalakas-style cream with herbs and beetroot shavings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20du%20Docteur-Stoltz%2C%20Andlau%2C%2067140%2C%20France"
    pageTitle="Partage"
  />
);

export default PartageAND;
