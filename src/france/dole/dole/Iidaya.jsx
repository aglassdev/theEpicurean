...
const Iidaya = () => (
  <RestaurantPage
    restaurantName="Iida-Ya"
    address="18 rue Arney, Dole, 39100, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33384709873"
    website="https://iida-ya.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Confit pork belly with ginger sauce, sushi, maki, tempura… From the soothingly pared-back and chic dining area, diners have an unhampered view of the Japanese chef as he rustles up refined dishes that bring together French and Japanese cuisine. Fine sake selection. A huge hit in Dole!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20Arney%2C%20Dole%2C%2039100%2C%20France"
    pageTitle="Iida-Ya"
  />
);

export default Iidaya;
