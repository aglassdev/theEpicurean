...
const LeV = () => (
  <RestaurantPage
    restaurantName="Le V"
    address="9 chemin Canto-Cigalo, Saint-Rémy-de-Provence, 13210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490920440"
    website="https://www.vallondevalrugues.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A chef with a fine CV to his name (including Lucas Carton and Anne - Sophie Pic) has taken over the kitchen of this restaurant, and quickly made his mark! With a motivated team supporting him, he cooks classic cuisine, adding modern touches, and the result is a hit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20chemin%20Canto-Cigalo%2C%20Saint-R%C3%A9my-de-Provence%2C%2013210%2C%20France"
    pageTitle="Le V"
  />
);
