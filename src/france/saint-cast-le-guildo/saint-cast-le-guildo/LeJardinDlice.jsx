...
const LeJardinDlice = () => (
  <RestaurantPage
    restaurantName="Le Jardin Délice"
    address="23 boulevard Duponchel, Saint-Cast-le-Guildo, 22380, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33296810527"
    website="https://www.lejardindelice.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of this seaside resort on the Côte d'Émeraude (so-called Emerald Coast), this restaurant with its spruce interior is run by a pair who earned their stripes at some top restaurants. Here at his own restaurant, Julien Gourmelen pays tribute to the tastes and ingredients of his native Brittany. Roasted white asparagus, almond milk emulsion, haddock, kumquat, fresh herbs; crispy fillet of pike-perch, artichoke barigoule, coriander: this experienced chef brings commitment to every dish. Adeline Moiroud, the other half of this talented duo, provides well-paced smiling service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20boulevard%20Duponchel%2C%20Saint-Cast-le-Guildo%2C%2022380%2C%20France"
    pageTitle="Le Jardin Délice"
  />
);

export default LeJardinDlice;
