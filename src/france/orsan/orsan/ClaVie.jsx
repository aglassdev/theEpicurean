...
const ClaVie = () => (
  <RestaurantPage
    restaurantName="C'la Vie"
    address="12 avenue du Jasset, Orsan, 30200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466392915"
    website="https://restaurant-clavie.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From a long line of bakers, chef Richard Durand has made C'la Vie a real mecca for food lovers. The food is good and life is good! The daily menu features terrific ingredients (most of them local), the flavours are distinctive, and the focus is firmly on dining pleasure. Enjoy your meal in the pared-back dining area inside, or on the terrace in the shade of a hundred-year-old plane tree. A fine selection of wines that celebrates the Rhône Valley and Languedoc, and rightfully so...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20avenue%20du%20Jasset%2C%20Orsan%2C%2030200%2C%20France"
    pageTitle="C'la Vie"
  />
);

export default ClaVie;
