...
const HostellerieDeLabbayeDeLaCelle = () => (
  <RestaurantPage
    restaurantName="Hostellerie de l'Abbaye de la Celle"
    address="10 place du Général-de-Gaulle, La Celle, 83170, France"
    cuisine="Provençal, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33498051414"
    website="https://www.abbaye-celle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Near Celle Abbey, this remote fine dining inn occupies a stunning 18C edifice. Part of the Ducasse Group, the restaurant boasts all the facilities one would expect of a luxury establishment, including a finely crafted Mediterranean score with a soft spot for veg, illustrated by stuffed Provençal vegetables overflowing with herbs and garlic. Unostentatious tradition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20La%20Celle%2C%2083170%2C%20France"
    pageTitle="Hostellerie de l'Abbaye de la Celle"
  />
);

export default HostellerieDeLabbayeDeLaCelle;
