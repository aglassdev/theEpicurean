...
const LoreDesSablons = () => (
  <RestaurantPage
    restaurantName="L'Orée des Sablons"
    address="1 rue des Sablons, Fontainebleau, 77300, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33160740748"
    website="https://loreedessablons.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on a pedestrian street, this restaurant pays homage to hunting and culinary competitions: the chef, a finalist in the Lièvre à la Royale Championship, is also a fan of pâté en croûte. Meat dominates the menu – oreiller de la belle Aurore; fillet of guinea fowl, grilled green beans, shiso leaf tempura and offal sauce, not to mention the carefully prepared desserts. Small terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20des%20Sablons%2C%20Fontainebleau%2C%2077300%2C%20France"
    pageTitle="L'Orée des Sablons"
  />
);

export default LoreDesSablons;
