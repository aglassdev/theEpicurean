...
const LaTableDole = () => (
  <RestaurantPage
    restaurantName="La Table d'Éole"
    address="9 place Jolyot-de-Crébillon, Brochon, 21220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33380612306"
    website="https://la-table-deole.eatbu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sylvain Gauthier (formerly of La Maison des Cariatides in Dijon) and Valentine have set up shop in a beautiful traditional stone house in the heart of this Burgundy wine-growing village. Instead of a set menu, there is a short à la carte menu of dishes the names of which alone are mouthwatering. The chef's expertise shines through in every course with consistently winning flavour combinations (scallops, cauliflower mousseline, green apple and hazelnut sauce vierge, hint of ginger). The sweet finale hits a perfectly seasonal note with a dessert starring pear. The dining area comprises two distinct spaces: the first is contemporary, with grey tones and a glass-walled kitchen; the second, warmer and more traditional, is laid out beneath a stone vaulted ceiling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20Jolyot-de-Cr%C3%A9billon%2C%20Brochon%2C%2021220%2C%20France"
    pageTitle="La Table d'Éole"
  />
);

export default LaTableDole;
