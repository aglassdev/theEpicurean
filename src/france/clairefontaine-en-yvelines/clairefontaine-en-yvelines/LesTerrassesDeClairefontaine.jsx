...
const LesTerrassesDeClairefontaine = () => (
  <RestaurantPage
    restaurantName="Les Terrasses de Clairefontaine"
    address="1 rue de Rambouillet, Clairefontaine-en-Yvelines, 78120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33130591919"
    website="https://lesterrassesdeclairefontaine.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Chevreuse Valley and Rambouillet forest, this restaurant on the edge of Clairefontaine pond serves heart - warming, up - to - date food, with a weakness for truffles and game (in season). Fine view of the pond (all year long)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Rambouillet%2C%20Clairefontaine-en-Yvelines%2C%2078120%2C%20France"
    pageTitle="Les Terrasses de Clairefontaine"
  />
);

export default LesTerrassesDeClairefontaine;
