...
const LaCteDor = () => (
  <RestaurantPage
    restaurantName="La Côte d'Or"
    address="Le Relais Bernard Loiseau, 2 avenue Bernard-Loiseau, Saulieu, 21210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380905353"
    website="https://www.bernard-loiseau.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This iconic institution of the Morvan region, which has seen so many generations of chefs and fine food lovers pass through its doors, has embarked on a new chapter. In the wake of its auspicious débuts with Alexandre Dumaine and Bernard Loiseau, chef Louis-Philippe Vigilant now rolls out up-to-the-minute cuisine founded on solid classical bases. He has added his hallmark to more personal recipes that star first-class ingredients. Nostalgic guests can travel back in time and sample some of Bernard Loiseau’s iconic classics, such as frog's legs with garlic purée and parsley juice. The lineup of desserts, which are the work of Lucie Vigilant, the chef’s wife, continues to star the emblematic orange-flavoured ‘roses des sables’ with pure chocolate ice cream together with a last-minute Saint H..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Relais%20Bernard%20Loiseau%2C%202%20avenue%20Bernard-Loiseau%2C%20Saulieu%2C%2021210%2C%20France"
    pageTitle="La Côte d'Or"
  />
);

export default LaCteDor;
