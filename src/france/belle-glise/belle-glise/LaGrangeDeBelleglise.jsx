...
const LaGrangeDeBelleglise = () => (
  <RestaurantPage
    restaurantName="La Grange de Belle-Église"
    address="28 boulevard René-Aimé-Lagabrielle, Belle-Église, 60540, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33344084900"
    website="https://www.lagrangedebelleeglise.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20boulevard%20Ren%C3%A9-Aim%C3%A9-Lagabrielle%2C%20Belle-%C3%89glise%2C%2060540%2C%20France"
    pageTitle="La Grange de Belle-Église"
  />
);

export default LaGrangeDeBelleglise;
