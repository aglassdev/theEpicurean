...
const AubergeDuCellier = () => (
  <RestaurantPage
    restaurantName="Auberge du Cellier"
    address="1 rue de Sainte-Eugénie, Montner, 66720, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33468290978"
    website="https://www.aubergeducellier.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Deep in a Catalan village, local lad, Pierre-Louis Marin, in the dining room, and chef Yvon Rossignol, celebrate first and foremost regional produce courtesy of textbook technique and a distinct weakness for truffles. Their signature is a daring, yet accomplished vacherin-inspired extravaganza of melon, serrano ham and Rivesaltes liqueur. Authentic and bursting with flavour. Attractive lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Sainte-Eug%C3%A9nie%2C%20Montner%2C%2066720%2C%20France"
    pageTitle="Auberge du Cellier"
  />
);

export default AubergeDuCellier;
