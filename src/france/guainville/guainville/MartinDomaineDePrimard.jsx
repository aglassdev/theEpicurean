...
const MartinDomaineDePrimard = () => (
  <RestaurantPage
    restaurantName="Martin - Domaine de Primard"
    address="Route départementale 16, Guainville, 28260, France"
    cuisine="Traditional Cuisine, Home Cooking"
    priceRange="€€€"
    phoneNumber="+33236581007"
    website="https://www.lesdomainesdefontenille.com/fr/domainedeprimard.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bistro of this superb hotel, a subtle blend of country chic, is the lair of a new chef, Géraud Dupuis (formerly of the Domaine de Fontenille at Lauris). He crafts a traditional score in the zeitgeist, sourcing most of his vegetables from the estate's kitchen garden. Examples include green asparagus and a sage-flavoured sabayon; catch of the day, broccoli and a vin jaune-flavoured beurre blanc. Peaceful al fresco dining in the castle orchard in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20d%C3%A9partementale%2016%2C%20Guainville%2C%2028260%2C%20France"
    pageTitle="Martin - Domaine de Primard"
  />
);

export default MartinDomaineDePrimard;
