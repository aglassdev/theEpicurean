...
const RelaisDeLabbaye = () => (
  <RestaurantPage
    restaurantName="Relais de l'Abbaye"
    address="415 route du Beaujolais, Charlieu, 42190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33477600088"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/charlieu/restaurant/relais-de-l-abbaye"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern Relais, looking out onto the surrounding meadows, is anchored in local culinary traditions. The chef is passionate about fine ingredients and showcases regional producers (Charlieu andouille, Charolais meat, cheese etc) in contemporary, hearty dishes. Pleasant guestrooms for an overnight stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=415%20route%20du%20Beaujolais%2C%20Charlieu%2C%2042190%2C%20France"
    pageTitle="Relais de l'Abbaye"
  />
);

export default RelaisDeLabbaye;
