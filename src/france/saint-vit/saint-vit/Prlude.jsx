...
const Prlude = () => (
  <RestaurantPage
    restaurantName="Prélude"
    address="5 place Simone-Veil, Saint-Vit, 25410, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33381405350"
    website="https://www.restaurantprelude.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Far more than a prelude, this is a full-blown symphony! Now established in a spruce traditional building, Élodie Ouchelli and Thibault Étienne practiced their scales in top star restaurants, among which that of Romuald Fassenet. The virtuoso chef, whose talent is a masterclass in culinary subtlety, composes harmonious dishes in which first-class local produce plays the leading role. Several tables of the contemporary dining room provide a view of the chef at work in the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20Simone-Veil%2C%20Saint-Vit%2C%2025410%2C%20France"
    pageTitle="Prélude"
  />
);

export default Prlude;
