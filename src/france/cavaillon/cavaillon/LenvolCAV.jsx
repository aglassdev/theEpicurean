...
const LenvolCAV = () => (
  <RestaurantPage
    ...
    address="35 rue Gustave-Flaubert, Cavaillon, 84300, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33490781527"
    website="https://lenvolcavaillon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a small street in the city centre, this restaurant is as charming as it is discreet. At the stove, Laurent Renoult fetes produce such as vegetables from Vert'Tige, in Cabannes, Sisteron lamb or the pigeon of Costières. It's full-flavoured, tasty, and Sarah Hotten's welcome is fuss-free and charming. Don't hesitate to try this place out!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20rue%20Gustave-Flaubert%2C%20Cavaillon%2C%2084300%2C%20France"
    pageTitle="L'Envol"
  />
);

export default LenvolCAV;
