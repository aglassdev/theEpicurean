...
const LesRonins = () => (
  <RestaurantPage
    restaurantName="Les Ronins"
    address="9 route de Megève, Praz-sur-Arly, 74120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450219031"
    website="https://www.les-ronins.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Japanese culture, ronins are samurai without a master, which is Anthony and Émilie’s metaphor for their unfettered approach to cooking and, of course, their exquisitely presented Franco-Asian cuisine, such as Angus beef hanger steak served with crying tiger sauce and a hearty gratin dauphinois. Trendy Alpine-inspired decor, friendly service and good vibes!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20route%20de%20Meg%C3%A8ve%2C%20Praz-sur-Arly%2C%2074120%2C%20France"
    pageTitle="Les Ronins"
  />
);

export default LesRonins;
