...
const LesTroisForts = () => (
  <RestaurantPage
    restaurantName="Les Trois Forts"
    address="36 boulevard Charles-Livon, Marseille, 13007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33491155956"
    website="https://www.sofitel-marseille-vieuxport.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the seventh floor, the panoramic view over the port is simply sublime! The contemporary dishes with a delicious Southern flavour make for a wonderful gourmet interlude...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20boulevard%20Charles-Livon%2C%20Marseille%2C%2013007%2C%20France"
    pageTitle="Les Trois Forts"
  />
);

export default LesTroisForts;
