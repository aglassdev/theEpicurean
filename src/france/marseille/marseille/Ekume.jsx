...
const Ekume = () => (
  <RestaurantPage
    restaurantName="Ekume"
    address="139 rue Sainte, Marseille, 13007, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33491734691"
    website="https://www.ekume-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After clocking up some remarkable experiences, Panamanian chef Edgar Bosquez has dropped anchor in Marseille, not far from the abbey of St Victor. In a spruce, pared-back interior, he showcases fish, seafood and Provençal flavours in a lineup of deftly crafted, suave-tasting menus, including one devoted to bouillabaisse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139%20rue%20Sainte%2C%20Marseille%2C%2013007%2C%20France"
    pageTitle="Ekume"
  />
);

export default Ekume;
