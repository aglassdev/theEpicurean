...
const MichelBrasserieDesCatalans = () => (
  <RestaurantPage
    restaurantName="Michel - Brasserie des Catalans"
    address="6 rue des Catalans, Marseille, 13007, France"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+33491526422"
    website="https://www.restaurant-michel-13.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Soak up the atmosphere of Marseille in this popular restaurant on the Plage des Catalans. Here they take their bouillabaisse very seriously... and it tastes phenomenal! As you would expect, the menu proposes an exceptionally fresh catch of the day: you will see the fish in the tanks as you come in...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%20Catalans%2C%20Marseille%2C%2013007%2C%20France"
    pageTitle="Michel - Brasserie des Catalans"
  />
);

export default MichelBrasserieDesCatalans;
