...
const Peron = () => (
  <RestaurantPage
    restaurantName="Peron"
    address="56 corniche John-Fitzgerald-Kennedy, Marseille, 13007, France"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33491521522"
    website="https://www.restaurant-peron.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the coast road, this building clinging to the rocks offers a breathtaking view of the bay of Marseille and its islands and the château d’If. A brisk sea breeze has shaken up the menu which features dishes such as local and wild fish of the day, stuffed vegetables, duck breast and beef fillet, without forgetting the ubiquitous bouillabaisse, all of which served on the splendid terrace. A genuine institution since 1855!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20corniche%20John-Fitzgerald-Kennedy%2C%20Marseille%2C%2013007%2C%20France"
    pageTitle="Peron"
  />
);
