...
const Cdrat = () => (
  <RestaurantPage
    restaurantName="Cédrat"
    address="81 rue Breteuil, Marseille, 13006, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33491429441"
    website="https://www.cedratxmamakyuna.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A couple, two chefs, two different culinary formulas: at lunchtime, chef Maëlyss Vultaggio chalks up her menu on the blackboard, assisted in the kitchen by Éric Maillet, a young chef who earned his stripes working for the likes of Gérald Passedat. In the evening, the roles are reversed: he takes the lead, creating more of a fine dining menu with his partner supporting him. Dishes such as farmhouse chicken on the barbecue, celeriac confit, sorrel, ginger/lemongrass sauce and XO reduction exemplify this modern Mediterranean-style cuisine. Using organic vegetables, locally caught fish and well-reared meats, the food certainly packs a punch. Contemporary setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20rue%20Breteuil%2C%20Marseille%2C%2013006%2C%20France"
    pageTitle="Cédrat"
  />
);

export default Cdrat;
