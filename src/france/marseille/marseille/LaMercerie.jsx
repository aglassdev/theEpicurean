...
const LaMercerie = () => (
  <RestaurantPage
    ...
    address="9 cours Saint-Louis, Marseille, 13001, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33491061844"
    website="https://www.lamerceriemarseille.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An avalanche of quality local ingredients, undeniable know-how and gourmet delicacies... You can count on the young team to take care of your appetite in the best possible way. As for wine, the menu is lovingly put together with an emphasis on natural wines, with a promising turnover: all the ingredients are in place for you to have a great time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20cours%20Saint-Louis%2C%20Marseille%2C%2013001%2C%20France"
    pageTitle="La Mercerie"
  />
);

export default LaMercerie;
