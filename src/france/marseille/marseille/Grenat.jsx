...
const Grenat = () => (
  <RestaurantPage
    restaurantName="Grenat"
    address="57 rue Grignan, Marseille, 13006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33413941565"
    website="https://www.grenat-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the front, a bistro with garnet-red walls, exposed stone and polished concrete; to the rear, a verdant courtyard planted with edible herbs and flowers: two distinct settings, both with the same stylish atmosphere. At the counter, solo diners can watch the chefs in action around the open fire in the visible kitchen. The garden exudes a relaxed bohemian charm. The kitchen is a riot of smoke and flame! A boldly seasoned, fire-driven cuisine built on short supply chains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20rue%20Grignan%2C%20Marseille%2C%2013006%2C%20France"
    pageTitle="Grenat"
  />
);

export default Grenat;
