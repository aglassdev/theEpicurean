...
const TabiIppeiUemura = () => (
  <RestaurantPage
    restaurantName="Tabi - Ippei Uemura"
    address="165 corniche du Président-John-Fitzgerald-Kennedy, Marseille, 13007, France"
    cuisine="Japanese Contemporary"
    priceRange="€€€"
    phoneNumber="+33491220933"
    website="https://www.restauranttabi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tabi, which means journey in Japanese, says it all! Born in Kyoto, the chef has adopted the city of Marseilles as his own. He incorporates locally caught fish into traditional Japanese recipes, prepared in front of customers. Food-saké pairings for aficionados. One of a kind!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=165%20corniche%20du%20Pr%C3%A9sident-John-Fitzgerald-Kennedy%2C%20Marseille%2C%2013007%2C%20France"
    pageTitle="Tabi - Ippei Uemura"
  />
);

export default TabiIppeiUemura;
