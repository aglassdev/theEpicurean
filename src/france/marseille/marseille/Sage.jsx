...
const Sage = () => (
  <RestaurantPage
    restaurantName="SAGE"
    address="96 rue Grignan, Marseille, 13001, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33486682542"
    website="https://sage-restaurant-marseille.com/site"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="SAGE, which stands for Saison, Artisanat, Goût et Émotion (Season, Craftsmanship, Taste and Emotion), reflects the vision of this friendly, contemporary bistro done out in a palette of soft, muted tones. Expect dishes such as grilled watermelon carpaccio seasoned with blackcurrant, black miso and marigold; perfectly cooked rockfish, saffron fregola sarda, yellow courgette in a sauce vierge. The desserts, including a modern take on peach Melba, also showcase fresh flavours. This creative cuisine, which favours short supply chains and includes plenty of vegetarian dishes, is rife with tempting options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=96%20rue%20Grignan%2C%20Marseille%2C%2013001%2C%20France"
    pageTitle="SAGE"
  />
);
