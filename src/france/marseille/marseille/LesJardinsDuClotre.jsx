...
const LesJardinsDuClotre = () => (
  <RestaurantPage
    restaurantName="Les Jardins du Cloître"
    address="20 boulevard Madeleine-Rémusat, Marseille, 13013, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33491122942"
    website="https://lesjardinsducloitredemars.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a former monastery, this training centre run by the Auteuil Apprentices charity, has a restaurant that is open to the public. Supervised by a professional chef, the brigade of young trainee cooks enthusiastically prepares fine meals in a bistronomic spirit that keeps pace with the seasons, all of which sourced with regional, preferably organic produce. A laudable ethical approach which aims to forge the next generation of restaurateurs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20boulevard%20Madeleine-R%C3%A9musat%2C%20Marseille%2C%2013013%2C%20France"
    pageTitle="Les Jardins du Cloître"
  />
);

export default LesJardinsDuClotre;
