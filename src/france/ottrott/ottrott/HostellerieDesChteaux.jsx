...
const HostellerieDesChteaux = () => (
  <RestaurantPage
    restaurantName="Hostellerie des Châteaux"
    address="11 rue des Châteaux, Ottrott, 67530, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388481414"
    website="https://www.hostellerie-chateaux.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An elegant and intimate backdrop for modern cooking with good classical foundations : millefeuille of Rosheim snails with wild garlic and parsley, or fillet of turbot, champagne beurre blanc and black bean cream. Comfortable guestrooms that combine the contemporary with traditional Alsatian style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20des%20Ch%C3%A2teaux%2C%20Ottrott%2C%2067530%2C%20France"
    pageTitle="Hostellerie des Châteaux"
  />
);

export default HostellerieDesChteaux;
