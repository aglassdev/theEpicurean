...
const LesTrentePas = () => (
  <RestaurantPage
    restaurantName="Les Trente Pas"
    address="16 avenue des Francs-Tireurs, Villard-de-Lans, 38250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33476940675"
    website="https://lestrentepas.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A short stroll from Villard church will take you to the site of this portrait - sized restaurant in the heart of the village. Local artwork adorns the dining room, while the chef pays homage to market - fresh produce with a soft spot for the Vercors, assembled according to his inspiration. Fine handiwork!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20avenue%20des%20Francs-Tireurs%2C%20Villard-de-Lans%2C%2038250%2C%20France"
    pageTitle="Les Trente Pas"
  />
);

export default LesTrentePas;
