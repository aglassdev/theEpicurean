...
const LpicurieuxChezLuc = () => (
  <RestaurantPage
    restaurantName="L'Épicurieux chez Luc"
    address="1080 route des Monts-d'Or, Curis-au-Mont-d'Or, 69250, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33478586151"
    website="https://www.lepicurieuxchezluc.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After many years with the Bocuse group, chef Luc Abadie has set up shop in this restaurant with a partially open kitchen that allows him to interact with his customers. His traditional cuisine is perfectly crafted and bears the hallmarks of the late Paul Bocuse – namely an absence of contrived creativity and unnecessary convolutions. The culinary offering, which is the same for lunch and dinner, is based on an excellent-value weekly set menu – eg carrot royale with cumin, roast rack of pork with herbs and white beans – and an à la carte menu on which the dishes are just as classical, but made with more refined ingredients: seasonal pâté en croûte, sole meunière, Charolais beef rib with a green peppercorn sauce, and Norwegian omelette flambéed with Cointreau...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1080%20route%20des%20Monts-d'Or%2C%20Curis-au-Mont-d'Or%2C%2069250%2C%20France"
    pageTitle="L'Épicurieux chez Luc"
  />
);

export default LpicurieuxChezLuc;
