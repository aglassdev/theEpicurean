...
const Lapart = () => (
  <RestaurantPage
    restaurantName="L'Aparté"
    address="21 rue de l'Europe, Montrabé, 31850, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33534264344"
    website="https://www.restaurant-laparte.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This traditionally-built house, surrounded by lush greenery is so peaceful that you forget its location in the suburbs. The terrace, covered by a bioclimatic pergola, is a hit during the summer, while the stylish interior is both tasteful and comfortable. Chef Jérémy Morin skilfully rolls out creative dishes: roast rack of veal, brioche of sweetbread, vanilla-laced artichoke and a gutsy gravy or roast monkfish in sumac with braised baby gem lettuce in a raspberry seasoning, creamy yoghurt and a red wine and balsamic vinegar sauce. Among the addictive signatures of Nathan Beaumont, the new pastry chef, is a Nyangbo chocolate mousse, with hazelnut ganache and hazelnut ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20de%20l'Europe%2C%20Montrab%C3%A9%2C%2031850%2C%20France"
    pageTitle="L'Aparté"
  />
);

export default Lapart;
