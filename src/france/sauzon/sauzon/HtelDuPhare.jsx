...
const HtelDuPhare = () => (
  <RestaurantPage
    restaurantName="Hôtel du Phare"
    address="Quai Guerveur, Sauzon, 56360, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297316036"
    website="https://www.hotelduphare-belle-ile.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Belle-Île-en-Mer's emblematic Hôtel du Phare (1880) and its restaurant have been redesigned and revamped by a famous architect. The decor is original, juxtaposing bright colours with the black and white of the Breton flag. The menu focuses on marine flavours, with dishes such as spider crab in its shell, bisque, celeriac ravioli with spider crab; viennoise of sea bass cooked on a stone, artichoke fricassee with clams and black garlic. As much as he can, the chef uses quality ingredients, often from the island (eg lamb reared in Bangor, honey, organic vegetables and fish from a local fisherman). There is a lovely terrace overlooking the harbour, and further dining options at Le Bistrot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quai%20Guerveur%2C%20Sauzon%2C%2056360%2C%20France"
    pageTitle="Hôtel du Phare"
  />
);

export default HtelDuPhare;
