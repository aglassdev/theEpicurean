...
const LpicurieuxILL = () => (
  <RestaurantPage
    ...
    address="5 rue Mermoz, Illies, 59480, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33320353601"
    website="https://www.restaurantlepicurieux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spruce, endearing bistro on the main square of Illies is smoothly and passionately run by former Top Chef contestant, Christophe Pirotais and his partner Julie Dieudonné. Their gutsy indulgent cuisine is unveiled in an inspired, big-boned surprise menu, illustrated by a delicate pannacotta of white asparagus with radish-flavoured ice cream or a fillet of seabream escorted by chickpea fritters and a creamy jus of smoked herring roe. The welcome is warm and cheerful and the service is as smooth as a silky bearnaise sauce. Lovely rear patio for alfresco dining in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Mermoz%2C%20Illies%2C%2059480%2C%20France"
    pageTitle="L'Épicurieux"
  />
);

export default LpicurieuxILL;
