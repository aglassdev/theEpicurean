...
const LaChvreDor = () => (
  <RestaurantPage
    ...
    address="Rue du Barri, Èze, 06360, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33492106661"
    website="https://www.chevredor.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Château de la Chèvre d'Or boasts an exceptional location: Perched high up on the flank of a rocky hillside in a medieval village, it commands jaw-dropping views of the Riviera hinterland to the rear and of the sparkling Mediterranean Sea to the fore. After feasting your eyes on your surroundings, it's time to sit down to dinner, courtesy of the chef and his brigade, which includes talented pastry chef Florent Margaillan. Previously chef of Granite, Tom Meyer, also a Meilleur Ouvrier de France, has replaced Arnaud Faye here. He demonstrates the solid qualities for which he is already renowned: masterful technique, beautifully intense jus and sauces, stylised plating. This dynamic cuisine keeps things interesting by alternating between notes of vegetables, herbs and seafood: Mediterranean mu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Barri%2C%20%C3%88ze%2C%2006360%2C%20France"
    pageTitle="La Chèvre d'Or"
  />
);

export default LaChvreDor;
