...
const LaBaratte = () => (
  <RestaurantPage
    restaurantName="La Baratte"
    address="395 rue du Clinquet, Tourcoing, 59200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33320944563"
    website="https://www.la-baratte.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small brick house in a residential neighbourhood has been home to this family-run eatery for four generations. The stylish, contemporary dining room opens onto a pretty garden and teak decked terrace. The chef impressively crafts enticing dishes, such as sautéed snails in a light frothy garlic and parsley emulsion and a bacon-flavoured cake. The after-dinner marshmallow treats are almost too pretty to eat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=395%20rue%20du%20Clinquet%2C%20Tourcoing%2C%2059200%2C%20France"
    pageTitle="La Baratte"
  />
);

export default LaBaratte;
