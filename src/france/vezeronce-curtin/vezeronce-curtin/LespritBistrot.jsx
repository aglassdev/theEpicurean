...
const LespritBistrot = () => (
  <RestaurantPage
    restaurantName="L'Esprit Bistrot"
    address="167 route du Dauphiné, Vezeronce-Curtin, 38300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33474965781"
    website="https://restaurant-lesprit-bistrot.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a trendy bistro interior, you will sample good food crafted by an enthusiastic chef. The long list of local producers with whom he works is emblematic of his mindset. A few examples: a salad of razor clams and lentils from Trept; mallard duck cooked two ways and garnished with braised chicory and an offal-flavoured gravy; Chartreuse-flavoured baba…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=167%20route%20du%20Dauphin%C3%A9%2C%20Vezeronce-Curtin%2C%2038300%2C%20France"
    pageTitle="L'Esprit Bistrot"
  />
);

export default LespritBistrot;
