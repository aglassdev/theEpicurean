...
const VillaMorelia = () => (
  <RestaurantPage
    restaurantName="Villa Morelia"
    address="Avenue des Mexicains, Jausiers, 04850, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33492846778"
    website="https://www.villa-morelia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Villa Morelia exudes a certain discreet charm. The setting offsets the refined, tasty and inventive market - based cuisine. You can really taste the freshness and savour the flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20des%20Mexicains%2C%20Jausiers%2C%2004850%2C%20France"
    pageTitle="Villa Morelia"
  />
);

export default VillaMorelia;
