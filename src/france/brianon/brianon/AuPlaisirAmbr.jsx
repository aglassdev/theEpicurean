...
const AuPlaisirAmbr = () => (
  <RestaurantPage
    restaurantName="Au Plaisir Ambré"
    address="26 Grande Rue, Briançon, 05100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33492526346"
    website="https://www.auplaisirambre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside Vauban's fortifications, this converted butcher's places a premium on fine ingredients. Freshness is the watchword of the skilful chef, who knows how to coax out the best flavours. Examples would be the slow-confit farmhouse pork belly, wasabi jus and parsnip purée, and the dark chocolate tart with coconut sorbet. Sheer pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Grande%20Rue%2C%20Brian%C3%A7on%2C%2005100%2C%20France"
    pageTitle="Au Plaisir Ambré"
  />
);

export default AuPlaisirAmbr;
