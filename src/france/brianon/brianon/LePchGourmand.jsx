...
const LePchGourmand = () => (
  <RestaurantPage
    restaurantName="Le Pêché Gourmand"
    address="2 route de Gap, Briançon, 05100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33492213321"
    website="https://www.peche-gourmand.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant on the banks of the Guisane, run by a young French-Australian couple who are smitten with gastronomy. Sharon creates the lovely seasonal food including pastries, and Jimmy takes care of diners and the wine. Friendly, professional service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20route%20de%20Gap%2C%20Brian%C3%A7on%2C%2005100%2C%20France"
    pageTitle="Le Pêché Gourmand"
  />
);

export default LePchGourmand;
