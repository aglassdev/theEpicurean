...
const LaFermeSainteccile = () => (
  <RestaurantPage
    restaurantName="La Ferme Sainte-Cécile"
    address="Route des Gorges-du-Verdon, Moustiers-Sainte-Marie, 04360, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33492746418"
    website="https://www.ferme-ste-cecile.com/restaurant-moustiers/accueil.php"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once through the gate, follow the lovely cobbled driveway, at the end of which is this 18C farmhouse that has been turned into a go-to place for foodies! At the kitchen stove, the chef concocts delicate and subtle cuisine that draws on the South of France: royal sea bream, vegetable pistou and roasted garlic ice cream. One of the best restaurants in Moustiers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20des%20Gorges-du-Verdon%2C%20Moustiers-Sainte-Marie%2C%2004360%2C%20France"
    pageTitle="La Ferme Sainte-Cécile"
  />
);

export default LaFermeSainteccile;
