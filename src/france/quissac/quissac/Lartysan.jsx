...
const Lartysan = () => (
  <RestaurantPage
    restaurantName="L'ArtYsan"
    address="35 plan de la Gare, Quissac, 30260, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466770245"
    website="https://www.lartysan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yohann Boucard has turned the old station of Quissac into a fine establishment, sporting minimalist lines and iron work by local artisans… The food is equally enthralling, thanks to painstakingly selected ingredients and unusual, flavoursome combinations. Professional service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20plan%20de%20la%20Gare%2C%20Quissac%2C%2030260%2C%20France"
    pageTitle="L'ArtYsan"
  />
);

export default Lartysan;
