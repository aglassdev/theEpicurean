...
const LePanoramic = () => (
  <RestaurantPage
    restaurantName="Le Panoramic"
    address="Glacier de la Grande Motte, Tignes, 73320, France"
    cuisine="Traditional Cuisine, Grills"
    priceRange="€€€€"
    phoneNumber="+33479064721"
    website="https://maison-bouvier.com/le-panoramic-restaurant-tignes/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Accessed by a funicular railway, this high-altitude restaurant (3 032m no less!) promises a unique experience. The kitchen team, enthusiastically and skilfully led by Clément Bouvier (chef of the nearby starred Ursus), rolls out authentic high-flying dishes with a live fire edge. In an inviting interior done out in wood, staff in traditional costume serve a wholesome Alpine lineup, starring choice cuts to share (rib of beef, pork shoulder, sweetbread and whole turbot). All of which is paired with a stonking wine bin boasting over 1,000 references. Change of scenery guaranteed and a breathtaking view...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Glacier%20de%20la%20Grande%20Motte%2C%20Tignes%2C%2073320%2C%20France"
    pageTitle="Le Panoramic"
  />
);

export default LePanoramic;
