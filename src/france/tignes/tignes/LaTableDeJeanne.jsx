...
const LaTableDeJeanne = () => (
  <RestaurantPage
    restaurantName="La Table de Jeanne"
    address="14 avenue de la Grande-Motte, au Val-Claret, Tignes, 73320, France"
    cuisine="Savoyard"
    priceRange="€€€"
    phoneNumber="+33479069990"
    website="https://www.les-suites-du-nevada.com/table-de-jeanne/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This mountainside restaurant, the brainchild of the Bouvier family (of Les Suites, Ursus, Panoramic), is depicted by generous dishes in which country produce takes pride of place. Warm, welcoming and a fine selection of reasonably - priced wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20avenue%20de%20la%20Grande-Motte%2C%20au%20Val-Claret%2C%20Tignes%2C%2073320%2C%20France"
    pageTitle="La Table de Jeanne"
  />
);

export default LaTableDeJeanne;
