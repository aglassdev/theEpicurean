...
const JeuDeQuilles = () => (
  <RestaurantPage
    restaurantName="Jeu de Quilles"
    address="7 boulevard du Tour-de-Ville, Cajarc, 46160, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33581240143"
    website="https://guide.michelin.com/en/occitanie/cajarc/restaurant/jeu-de-quilles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Iced courgette velouté with mint and burrata, or grilled Aubrac beef with smoked pepper: the chef of this tiny bistro proposes simple and appetising market-based cuisine. The very reasonably priced dishes are listed on the blackboard. Don't miss the pleasant terrace under the arbour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20boulevard%20du%20Tour-de-Ville%2C%20Cajarc%2C%2046160%2C%20France"
    pageTitle="Jeu de Quilles"
  />
);

export default JeuDeQuilles;
