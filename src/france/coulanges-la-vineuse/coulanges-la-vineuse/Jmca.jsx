...
const Jmca = () => (
  <RestaurantPage
    restaurantName="J'MCA"
    address="12 rue André-Vildieu, Coulanges-la-Vineuse, 89580, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33386343341"
    website="https://www.jmca-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional, expertly crafted, market-fresh cuisine that lets the ingredient shout its name, such as lacquered sweetbread with peanuts and cauliflower. The à la carte lineup stars a range of pedigree Gallic classics such as homemade terrine, upside-down onion and chicory pie, calf’s head and even game in season. Cheerful service sets the tone in this handsome abode just a stone’s throw from the village church and square...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Andr%C3%A9-Vildieu%2C%20Coulanges-la-Vineuse%2C%2089580%2C%20France"
    pageTitle="J'MCA"
  />
);
