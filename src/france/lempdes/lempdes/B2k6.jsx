...
const B2k6 = () => (
  <RestaurantPage
    restaurantName="B2K6"
    address="6 rue du Caire, Lempdes, 63370, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33473617471"
    website="https://www.b2k6.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This friendly village bistro dishes up food that is in harmony with the seasons and uses local ingredients (free-range eggs and poultry from nearby farms, lamb, mushrooms, etc.), flanked by a splendid mainly organic and natural wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Caire%2C%20Lempdes%2C%2063370%2C%20France"
    pageTitle="B2K6"
  />
);
