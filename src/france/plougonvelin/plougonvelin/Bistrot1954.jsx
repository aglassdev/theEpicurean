...
const Bistrot1954 = () => (
  <RestaurantPage
    restaurantName="Bistrot 1954"
    address="7 place Saint-Tanguy, Plougonvelin, 29217, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33298890019"
    website="https://www.pointe-saint-mathieu.com/bistrot-1954"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the grandiose scenery of Pointe Saint-Mathieu, take a seat either on the terrace and breathe in the fresh sea air, or indoors in a contemporary decor of untreated wood and rattan furniture. The culinary repertory showcases authentic flavours of Brittany: shellfish, fish, buckwheat and seaweed…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20Saint-Tanguy%2C%20Plougonvelin%2C%2029217%2C%20France"
    pageTitle="Bistrot 1954"
  />
);

export default Bistrot1954;
