...
const HostellerieDeLaPointeSaintmathieu = () => (
  <RestaurantPage
    ...
    pageTitle="Hostellerie de la Pointe Saint-Mathieu"
  />
);

export default HostellerieDeLaPointeSaintmathieu;
