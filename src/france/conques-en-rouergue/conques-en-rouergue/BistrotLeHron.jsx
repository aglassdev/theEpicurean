...
const BistrotLeHron = () => (
  <RestaurantPage
    restaurantName="Bistrot le Héron"
    address="61 lieu-dit Cambelong, Conques-en-Rouergue, 12320, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565728477"
    website="https://moulindecambelong.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of this gorgeous village, known for its abbey church and Pierre Soulages's stained-glass windows, Moulin de Cambelong is home to this bistronomy restaurant, a friendly and down-to-earth alternative to Émilie and Thomas's MICHELIN-starred restaurant. Tuck into indulgent cuisine: tomato gazpacho, mussels and vierge vinaigrette; pulled pork with sorrel sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%20lieu-dit%20Cambelong%2C%20Conques-en-Rouergue%2C%2012320%2C%20France"
    pageTitle="Bistrot le Héron"
  />
);

export default BistrotLeHron;
