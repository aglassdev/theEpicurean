...
const MilieThomasMoulinDeCambelong = () => (
  <RestaurantPage
    ...
    pageTitle="Émilie & Thomas - Moulin de Cambelong"
  />
);

export default MilieThomasMoulinDeCambelong;
