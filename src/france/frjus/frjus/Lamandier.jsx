...
const Lamandier = () => (
  <RestaurantPage
    ...
    address="19 rue Marc-Antoine-Désaugiers, Fréjus, 83600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33494534877"
    website="https://www.restaurant-lamandier-frejus.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tomato and mozzarella puff pastry tart, green tomato sorbet and basil vinaigrette; fillet of sea bream, vegetable tian and a warm caper vinaigrette; apricot compote with vanilla, semolina biscuit and pistachio ice cream… The delicious dishes served by this charming couple exude Mediterranean vibes. An excellent, wallet-friendly place!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Marc-Antoine-D%C3%A9saugiers%2C%20Fr%C3%A9jus%2C%2083600%2C%20France"
    pageTitle="L'Amandier"
  />
);

export default Lamandier;
