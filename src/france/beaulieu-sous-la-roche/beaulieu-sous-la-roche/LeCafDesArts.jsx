...
const LeCafDesArts = () => (
  <RestaurantPage
    restaurantName="Le Café des Arts"
    address="2 rue de la Poste, Beaulieu-sous-la-Roche, 85190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251982480"
    website="https://www.lecafedesarts-beaulieu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this peaceful village in the Vendée countryside, Virginie and Antoine Préteux run this beautifully renovated former village café-restaurant. The young couple has a proven track record that includes Michelin-starred establishments. Consolidating the sound classical foundations he has learnt throughout his career, Antoine concocts delicious contemporary cuisine, inspired by the market and making the most of regional produce (vegetable platter, creamy and spicy broth; fresh pollack in a miso crust; his tasty take on the chestnut mont blanc dessert). The interior decor is cosy and intimate (with seating for no more than 12, so book in advance!), enhanced by Virginie's particularly attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20la%20Poste%2C%20Beaulieu-sous-la-Roche%2C%2085190%2C%20France"
    pageTitle="Le Café des Arts"
  />
);

export default LeCafDesArts;
