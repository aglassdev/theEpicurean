...
const LaPinde = () => (
  <RestaurantPage
    ...
    address="Chemin du Langoustier, Ile de Porquerolles, 83400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33494583483"
    website="https://www.langoustier.com/fr/accueil"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Patrons of this out-of-the-way hotel are collected from the village in a shuttle bus; the laidback restaurant of Le Mas du Langoustier is only open at lunchtime. The menu showcases the Mediterranean and Provençal dishes: pistou soup, panier du pêcheur façon bourride, grilled fish and crayfish etc – to savour against a backdrop of Mediterranean plants and the sea: simply sit back, tuck in and enjoy the moment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20du%20Langoustier%2C%20Ile%20de%20Porquerolles%2C%2083400%2C%20France"
    pageTitle="La Pinède"
  />
);

export default LaPinde;
