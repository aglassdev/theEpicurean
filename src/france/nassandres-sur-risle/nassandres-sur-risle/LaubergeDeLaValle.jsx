...
const LaubergeDeLaValle = () => (
  <RestaurantPage
    restaurantName="L'Auberge de la Vallée"
    address="7 route de Brionne, Nassandres-sur-Risle, 27300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33232442173"
    website="https://guide.michelin.com/en/normandie/nassandres-sur-risle_7770325/restaurant/l-auberge-de-la-vallee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming half-timbered house set in a bucolic location is extremely pleasant. In this setting you can tuck into simple, seasonal cuisine concocted with the finest ingredients, such as a charlotte of andouille sausage with cabbage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20route%20de%20Brionne%2C%20Nassandres-sur-Risle%2C%2027300%2C%20France"
    pageTitle="L'Auberge de la Vallée"
  />
);

export default LaubergeDeLaValle;
