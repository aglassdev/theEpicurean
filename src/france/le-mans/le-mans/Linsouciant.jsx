...
const Linsouciant = () => (
  <RestaurantPage
    restaurantName="L'insouciant"
    address="6 rue de la Mission, Le Mans, 72000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33243400058"
    website="https://www.restaurant-linsouciant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to the Église Sainte-Jeanne-d'Arc, this discreet restaurant is destined to make a name for itself: it is run by a charming duo, Corentin Courtien and Madeline Blais, who serve bistronomy fare at lunchtime and a more ambitious set menu in the evening. The chef is all about local ingredients (which account for 80% of his shopping basket) and creative cuisine that gives pride of place to spices and herbs. The dishes are meticulous and bold, with the balance of flavours always carefully calibrated, for instance bluefin tuna with anise hyssop oil, barbecued with green beans and lacto-fermented blackberries. A cosy, intimate atmosphere, and service with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20de%20la%20Mission%2C%20Le%20Mans%2C%2072000%2C%20France"
    pageTitle="L'insouciant"
  />
);

export default Linsouciant;
