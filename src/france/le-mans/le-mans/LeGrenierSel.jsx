...
const LeGrenierSel = () => (
  <RestaurantPage
    restaurantName="Le Grenier à Sel"
    address="26 place de l'Éperon, Le Mans, 72000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33243232630"
    website="https://www.restaurant-le-grenier-a-sel.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the entrance to medieval Le Mans, the team of this former salt loft has one goal in life: to please themselves and their customers! A contemporary vibe and top-quality ingredients (lobster, turbot, foie gras) with bold, authentic flavours, all of which washed down with a fine selection of Rhône, Loire and Bordeaux tipples...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20place%20de%20l'%C3%89peron%2C%20Le%20Mans%2C%2072000%2C%20France"
    pageTitle="Le Grenier à Sel"
  />
);

export default LeGrenierSel;
