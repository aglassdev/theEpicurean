...
const LaubergeDeBagatelle = () => (
  <RestaurantPage
    restaurantName="L'Auberge de Bagatelle"
    address="489 avenue Bollée, Le Mans, 72000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33243852573"
    website="https://www.aubergedebagatelle.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sarthois born and bred, chef Jean-Sébastien Monné is originally from these parts. He presides over this former inn in which the industrial style of a light-filled metal-framed extension meets the bucolic charm of the garden and terrace. He cultivates the art of working with small local producers and is devoted to the joys of rooftop beekeeping. Thanks to the meticulous work that goes into the selection of impeccable-quality ingredients, he is able to put his own more modern spin on the classics: Angus beef prepared as a tartare, breaded and fried quail's egg, puffed potato; duck from Canard Soulard, baby carrots, orange and bigarade sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=489%20avenue%20Boll%C3%A9e%2C%20Le%20Mans%2C%2072000%2C%20France"
    pageTitle="L'Auberge de Bagatelle"
  />
);

export default LaubergeDeBagatelle;
