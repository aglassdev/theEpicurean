...
const WinstubCt = () => (
  <RestaurantPage
    restaurantName="Winstub À Côté"
    address="2 rue Rogg-Haas, Sierentz, 68510, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33983371680"
    website="https://www.auberge-saintlaurent.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An extension of Auberge St Laurent, this winstub gives diners a taste of Alsace – tarte flambée with marinated Scottish salmon, granny's home-made spaetzle – in a contemporary decor (designer furniture and light fittings, copper-topped counter). Unbeatable value for money and excellent service are the key to the success of this establishment: it's often fully booked!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Rogg-Haas%2C%20Sierentz%2C%2068510%2C%20France"
    pageTitle="Winstub À Côté"
  />
);

export default WinstubCt;
