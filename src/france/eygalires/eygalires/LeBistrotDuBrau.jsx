...
const LeBistrotDuBrau = () => (
  <RestaurantPage
    restaurantName="Le Bistrot du Brau"
    address="765 chemin de Pestelade, Eygalières, 13810, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33490959006"
    website="https://www.hotellabastide.com/le-bistrot-du-brau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A gorgeous bastide tucked away in the refreshing shade of a Provençal oak grove, chirping cicadas, the gentle lapping of water in the pool, a menu of traditional cuisine supervised by chef Christopher Hache (whose MICHLIN-starred Maison Hache is next door) and fresh local ingredients: Mollégès escargots with parsley butter; Mt Ventoux pork belly confit and medley of carrots; tartelette with lemon sorbet. The scene is set for an irresistible culinary interlude on the patio dotted with wrought-iron tables or in the all-white dining area furnished in black...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=765%20chemin%20de%20Pestelade%2C%20Eygali%C3%A8res%2C%2013810%2C%20France"
    pageTitle="Le Bistrot du Brau"
  />
);

export default LeBistrotDuBrau;
