...
const Kedem = () => (
  <RestaurantPage
    restaurantName="Kedem"
    address="16 rue Jean-Burguet, Bordeaux, 33000, France"
    cuisine="Middle Eastern"
    priceRange="€€"
    phoneNumber="+33557800430"
    website="https://www.kedem.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Previously cohorts at Miles (now closed), Gil Elad and Ronan Cadoret strike again! In this small bistro complete with a counter, they serve up a veritable feast of small plates celebrating the flavours and spices of the Middle East. Their dishes make good use of the locally sourced produce at hand (Landes free-range chicken marinated in sumac with a spicy chicken jus; shish barak stuffed with porcini and seasonal chanterelles). Other highlights include a wide variety of delicious house-baked breads (eg Yemeni kubaneh) and some excellent desserts, including a Lebanese turnover filled with a date and dried fruit mixture, accompanied by a tasty pistachio ice cream. The short wine list has a penchant for natural wines, in particular Mediterranean labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20Jean-Burguet%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Kedem"
  />
);

export default Kedem;
