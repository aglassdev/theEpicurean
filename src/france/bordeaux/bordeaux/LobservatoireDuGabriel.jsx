...
const LobservatoireDuGabriel = () => (
  <RestaurantPage
    restaurantName="L'Observatoire du Gabriel"
    ...
    pageTitle="L'Observatoire du Gabriel"
  />
);

export default LobservatoireDuGabriel;
