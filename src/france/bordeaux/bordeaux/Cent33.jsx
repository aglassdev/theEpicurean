...
const Cent33 = () => (
  <RestaurantPage
    restaurantName="Cent33"
    address="133 rue du Jardin-Public, Bordeaux, 33000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33556159040"
    website="https://cent33.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A chic, cosy bistro vibe reigns in the restaurant of Grenoble-born chef, Fabien Beaufour, who has stints in some of the finest Michelin-starred restaurants in France (Anne-Sophie Pic in Valence and Patrick Henriroux in Vienne), as well as New York and London, under his belt. So, it's hardly surprising that his cooking is unorthodox, globe-trotting and eco-responsible. Big-boned, contrasting flavours and spot-on cooking and seasonings. Signature dishes include a delicious miso-glazed black cod, slow-cooked on a robatayaki, crispy sweetbread and a passion fruit Grenobloise sauce or a trompe l’œil Piedmont hazelnut with button mushroom-flavoured ice cream…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=133%20rue%20du%20Jardin-Public%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Cent33"
  />
);

export default Cent33;
