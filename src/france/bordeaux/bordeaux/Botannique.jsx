...
const Botannique = () => (
  <RestaurantPage
    restaurantName="Bo-tannique"
    address="2 rue Tustal, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33556813492"
    website="https://www.bo-tannique.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These attractive premises (with a contemporary interior and exposed Bordeaux stonework) are located on a charming cobbled pedestrian square. The fresh cuisine is full of contrasts and draws on influences from far and wide: grilled sardines with burnt miso and Lebanese-style tomato tabbouleh. The fine wine list features mostly organic and natural wines. Friendly service... A recipe for success!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Tustal%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Bo-tannique"
  />
);

export default Botannique;
