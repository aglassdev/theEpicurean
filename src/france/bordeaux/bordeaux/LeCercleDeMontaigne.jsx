...
const LeCercleDeMontaigne = () => (
  <RestaurantPage
    restaurantName="Le Cercle de Montaigne"
    address="144 rue Abbé-de-l'Epée, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33557080127"
    website="https://www.hotel-palais-gallien-bordeaux.com/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a mansion dating from 1895, the restaurant of the Palais Gallien has distinct cachet, with echoes of a chic brasserie: black walls, khaki wood panelling, mouldings, herringbone hardwood floors, Louis XV chairs and black marble tables. French classics are reworked: sole meunière, linguine with prawns and robust bisque, pepper-crusted fillet of beef with bone marrow and Bordelaise sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=144%20rue%20Abb%C3%A9-de-l'Ep%C3%A9e%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Le Cercle de Montaigne"
  />
);

export default LeCercleDeMontaigne;
