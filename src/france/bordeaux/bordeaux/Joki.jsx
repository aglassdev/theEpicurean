...
const Joki = () => (
  <RestaurantPage
    restaurantName="Joki"
    address="33 rue des Bahutiers, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33557832394"
    website="https://www.jokirestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of historic Bordeaux, this cosy, casual eatery dishes up deftly crafted bistronomic cuisine that stars carefully sourced produce: poached oysters, mousse of ham and samphire pickles; pigeon marinated in oriental spices and a combo of turnips and harissa jus. Don’t miss the cocktail-food pairings, the house signature, concocted by Jodie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20rue%20des%20Bahutiers%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Joki"
  />
);
