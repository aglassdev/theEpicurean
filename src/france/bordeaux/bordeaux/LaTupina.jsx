...
const LaTupina = () => (
  <RestaurantPage
    restaurantName="La Tupina"
    address="6 rue Porte-de-la-Monnaie, Bordeaux, 33800, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33556915637"
    website="https://latupina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A genuine institution, this country inn champions dishes of yesteryear... Sanguette (blood pudding), macaronade (pasta with beef and tomato sauce), chips fried in duck fat: local produce is promoted with conviction in hearty dishes from South-West France, but also seasonal vegetables and meat roasted in the hearth. The fine produce on the counter certainly whets the appetite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Porte-de-la-Monnaie%2C%20Bordeaux%2C%2033800%2C%20France"
    pageTitle="La Tupina"
  />
);

export default LaTupina;
