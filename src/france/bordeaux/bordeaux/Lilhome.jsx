...
const Lilhome = () => (
  <RestaurantPage
    restaurantName="Lil'Home"
    address="29 quai des Chartrons, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33557599282"
    website="https://lilhome-restaurant.fr/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant on the Quai des Chartrons has a dining area with parquet flooring made up of repurposed wine crates, velvet-upholstered seats, wicker lampshades and hanging plants – think chic bistro style. The modern and creative cooking takes the form of multi-course surprise menus. Good selection of organic and biodynamic wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20quai%20des%20Chartrons%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Lil'Home"
  />
);
