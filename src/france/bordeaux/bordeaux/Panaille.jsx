...
const Panaille = () => (
  <RestaurantPage
    restaurantName="Panaille"
    address="137 rue du Tondu, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33987744586"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/bordeaux/restaurant/panaille"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this new-generation neighbourhood bistro – often fully booked – a close-knit trio of friends is making a splash. The dishes are meticulously prepared, with a mix of traditional recipes and forays into Asian and South American cuisines. The lunch menu is reasonably priced; in the evening, more elaborate cuisine, including starters to share. Pleasant patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=137%20rue%20du%20Tondu%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Panaille"
  />
);

export default Panaille;
