...
const LePressoirDargentGordonRamsay = () => (
  <RestaurantPage
    restaurantName="Le Pressoir d'Argent - Gordon Ramsay"
    address="InterContinental Bordeaux - Le Grand Hôtel, 2-5 place de la Comédie, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33557304444"
    ...
    bio="British chef Gordon Ramsay (born in Scotland) is a true culinary talent who has already been awarded three Michelin stars in England. He signs off on Le Pressoir d'Argent's menu who breathes a touch of modernity into the classic cuisine. It all comes together to enhance that French art de vivre – the opulent and refined decor and ultra competent service, the celebration of the finest ingredients from the abundant Bordeaux and Aquitaine region (foie gras, truffles, caviar, fish)… and the solid silver Christofle lobster press that is moved from table to table. The competence of the three sommeliers is remarkable, as they advise you on the 1 000-bottle selection, two thirds of which are from Bordeaux, naturally!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=InterContinental%20Bordeaux%20-%20Le%20Grand%20H%C3%B4tel%2C%202-5%20place%20de%20la%20Com%C3%A9die%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Le Pressoir d'Argent - Gordon Ramsay"
  />
);

export default LePressoirDargentGordonRamsay;
