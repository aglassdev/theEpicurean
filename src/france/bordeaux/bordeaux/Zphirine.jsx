...
const Zphirine = () => (
  <RestaurantPage
    restaurantName="Zéphirine"
    address="62 rue de l'Abbé-de-l'Épée, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33972455536"
    website="https://zephirine.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20rue%20de%20l'Abb%C3%A9-de-l'%C3%89p%C3%A9e%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Zéphirine"
  />
);

export default Zphirine;
