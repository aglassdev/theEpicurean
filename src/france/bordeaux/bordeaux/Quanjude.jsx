...
const Quanjude = () => (
  <RestaurantPage
    restaurantName="Quanjude"
    address="42-44 allées de Tourny, Bordeaux, 33000, France"
    cuisine="Chinese"
    priceRange="€€€"
    phoneNumber="+33557149135"
    website="https://quanjude-bordeaux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hundred-year-old brand, specialised in Peking duck, celebrates cuisine from Peking and the rest of China, all of which in a gourmet vein. The duck is carved according to an ancestral technique by a fully trained master carver. The establishment is located on Bordeaux’ exclusive Allées de Tourny in the heart of historic Bordeaux and its handsome 19C edifice boasts several dining rooms, all with moulded ceilings and parquet flooring, etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42-44%20all%C3%A9es%20de%20Tourny%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Quanjude"
  />
);

export default Quanjude;
