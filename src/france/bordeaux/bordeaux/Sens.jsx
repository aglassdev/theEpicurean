...
const Sens = () => (
  <RestaurantPage
    restaurantName="Sens"
    address="93 rue de Soissons, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33983455229"
    website="https://sens-restaurant-bordeaux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Off the bustling tourist track of Bordeaux, this cosy, modern bistro is run by chef Alexandre Bru. His precise, deftly crafted, mouthwatering score is particularly sensibly priced. Nostalgic bistro classics are treated to an intelligent, generous revamp: poached egg in vin jaune and comté, onion soup with beaufort cheese and Espelette pepper, braised chuck beef in red wine… Cheerful service and vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=93%20rue%20de%20Soissons%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Sens"
  />
);
