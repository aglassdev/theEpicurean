...
const LocoByJems = () => (
  <RestaurantPage
    restaurantName="Loco by Jem's"
    address="293 rue d'Ornano, Bordeaux, 33000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33556559937"
    website="https://www.locobyjems.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A hit with the locals, this buzzy, youthful bolthole is home to Jérémy, nicknamed Jem’s by his mates who think he’s a bit wacky (loco in Spanish). Jem finds inspiration in local ingredients which he crafts into dishes rich in crisp, contrasting flavours. The counter commands a fascinating view of the kitchen team at work. Bargain-priced lunchtime menu and tasting menu in the evening with wine-food pairings; vegetarian menu on request...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=293%20rue%20d'Ornano%2C%20Bordeaux%2C%2033000%2C%20France"
    pageTitle="Loco by Jem's"
  />
);

export default LocoByJems;
