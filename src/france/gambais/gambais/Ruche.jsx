...
const Ruche = () => (
  <RestaurantPage
    restaurantName="Ruche"
    address="Domaine les Bruyères, 251 avenue de Neuville, Gambais, 78950, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33134831966"
    website="https://www.domainelesbruyeres.com/ruche-le-restaurant/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the outskirts of Rambouillet Forest, chef Cybèle, who also runs the Table de Cybèle in Boulogne Billancourt, fell in love with this estate dating from 1850, where she now grows practically everything she cooks according to permaculture methods… Fresh greens thus play a pivotal role, flanked by fermentation techniques and produce from local growers. The bread, butter and yoghurt are all homemade and the wine list is rich in biodynamic and natural vintages. The interior displays a Scandinavian slant and offers five pretty guestrooms for peaceful wellness retreats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20les%20Bruy%C3%A8res%2C%20251%20avenue%20de%20Neuville%2C%20Gambais%2C%2078950%2C%20France"
    pageTitle="Ruche"
  />
);
