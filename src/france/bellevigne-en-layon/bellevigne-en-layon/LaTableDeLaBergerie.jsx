...
const LaTableDeLaBergerie = () => (
  <RestaurantPage
    restaurantName="La Table de la Bergerie"
    address="3 route de la Pierre, Bellevigne-en-Layon, 49380, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+33241783062"
    website="https://www.latable-bergerie.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20route%20de%20la%20Pierre%2C%20Bellevigne-en-Layon%2C%2049380%2C%20France"
    pageTitle="La Table de la Bergerie"
  />
);

export default LaTableDeLaBergerie;
