...
const LaFabrique = () => (
  <RestaurantPage
    restaurantName="La Fabrique"
    address="1 bis rue du Coq-Gaulois, Brie-Comte-Robert, 77170, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33160021010"
    website="https://www.restaurantlafabrique.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This industrial - style loft is well hidden at the end of a small alley. Guests enjoy the warm, convivial atmosphere at this contemporary restaurant, which offers delicious, bistro - style gourmet cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20bis%20rue%20du%20Coq-Gaulois%2C%20Brie-Comte-Robert%2C%2077170%2C%20France"
    pageTitle="La Fabrique"
  />
);

export default LaFabrique;
