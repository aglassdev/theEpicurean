...
const LtangDuMoulin = () => (
  <RestaurantPage
    restaurantName="L'Étang du Moulin"
    ...
    pageTitle="L'Étang du Moulin"
  />
);

export default LtangDuMoulin;
