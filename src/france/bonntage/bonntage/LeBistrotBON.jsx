...
const LeBistrotBON = () => (
  <RestaurantPage
    ...
    address="5 chemin de l'Étang-du-Moulin, Bonnétage, 25210, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33381689278"
    website="https://www.etang-du-moulin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Croûte forestière, veal entrecôte, fillet of trout, Morteau sausage: traditional produce and recipes are on the menu at the pleasant Le Bistrot. It is the perfect complement to the Étang du Moulin's restaurant. Simple and well - made food – you will be coming back for more!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20chemin%20de%20l'%C3%89tang-du-Moulin%2C%20Bonn%C3%A9tage%2C%2025210%2C%20France"
    pageTitle="Le Bistrot"
  />
);

export default LeBistrotBON;
