...
const RestaurantDesVoisins = () => (
  <RestaurantPage
    restaurantName="Restaurant des Voisins"
    address="12 rue des Voisins, Salies-de-Béarn, 64270, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559380179"
    website="https://www.restaurant-des-voisins.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, charming old features are enhanced by an eye for designer details (contemporary art, open kitchen). Original, well-crafted cuisine (semi-cooked line-caught albacore tuna from the Basque country, cream of pumpkin soup with coconut milk; cod confit ravioli, broth with herbs and spices, trout roe and sweet spice tuile), accompanied by a fine wine list. A master class in tastefully mixing the traditional and modern, in the decor as well as in the food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20des%20Voisins%2C%20Salies-de-B%C3%A9arn%2C%2064270%2C%20France"
    pageTitle="Restaurant des Voisins"
  />
);

export default RestaurantDesVoisins;
