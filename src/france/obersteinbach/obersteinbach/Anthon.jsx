...
const Anthon = () => (
  <RestaurantPage
    restaurantName="Anthon"
    address="40 rue Principale, Obersteinbach, 67510, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388095501"
    website="https://www.restaurant-anthon.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Georges Flaig represents the fourth generation at the helm of this gorgeous half - timbered house, dating from 1860. No nostalgia on his watch. His cooking is modern and tasty, and readily promotes producers from the surrounding area. For instance, Windstein Highland beef and Wingen trout...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20rue%20Principale%2C%20Obersteinbach%2C%2067510%2C%20France"
    pageTitle="Anthon"
  />
);

export default Anthon;
