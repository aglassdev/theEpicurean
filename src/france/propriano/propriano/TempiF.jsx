...
const TempiF = () => (
  <RestaurantPage
    restaurantName="Tempi Fà"
    address="11 avenue Napoléon-III, Propriano, 20110, France"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+33495760652"
    website="https://www.tempifa.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to bygone days (tempi fà), in this grocer's-cum-bistro run by a passionate man who selects the island's finest ingredients! You enter via the shop, reminiscent of an actual village market (cold cuts, cheeses, myrtle liqueur etc). You'll enjoy tucking into the tender, flavoursome Abbatucci veal chop with a jus flavoured with herbs from the maquis... and a fine wine from the island!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20avenue%20Napol%C3%A9on-III%2C%20Propriano%2C%2020110%2C%20France"
    pageTitle="Tempi Fà"
  />
);

export default TempiF;
