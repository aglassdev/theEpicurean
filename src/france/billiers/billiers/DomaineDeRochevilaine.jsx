...
const DomaineDeRochevilaine = () => (
  <RestaurantPage
    restaurantName="Domaine de Rochevilaine"
    address="à la Pointe de Pen-Lan, Billiers, 56190, France"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€€"
    phoneNumber="+33297416161"
    website="https://www.domainerochevilaine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This smart restaurant is part of the family-owned Grand Hotel de Solesmes estate, which boasts a charming patchwork of traditional cottages, houses and manors, manicured grounds and a jaw-dropping ocean view. Chef Maxime Nouail, also a fisherman, consummately works with premium seafood and local country produce. Lobster is the house signature, but the rest of the enticing menu is equally first-class: carpaccio of langoustines, green peas, cockles; John Dory roasted in butter with artichokes prepared several ways. Deft craftsmanship, crisp forthright flavours, a splendid wine list and flawless service: just the ticket for a culinary maritime experience in a magical setting. Swanky guestrooms and a spa for a luxurious seaside stay!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%A0%20la%20Pointe%20de%20Pen-Lan%2C%20Billiers%2C%2056190%2C%20France"
    pageTitle="Domaine de Rochevilaine"
  />
);

export default DomaineDeRochevilaine;
