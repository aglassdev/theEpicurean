...
const LeffetPapilles = () => (
  <RestaurantPage
    restaurantName="L'effet Papilles"
    address="16 rue des Déportés, Laval, 53000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33243656803"
    website="https://www.effetpapilles.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the town, almost within shouting distance of the castle, this small modern bistro, which sports a workshop vibe of wood and metal, is the brainchild of chef Adrien Barrier, who was born in Le Mans and knows Mayenne inside out. After stints with Yannick Alléno and Philippe Mille, this gifted craftsman curates feel-good, flavoursome food that hits the spot every time, be it his white asparagus with haddock, houmous and hazelnut crumble or the confit of pork belly, pressed aubergine and pork jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20des%20D%C3%A9port%C3%A9s%2C%20Laval%2C%2053000%2C%20France"
    pageTitle="L'effet Papilles"
  />
);

export default LeffetPapilles;
