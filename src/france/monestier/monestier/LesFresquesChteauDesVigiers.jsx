...
const LesFresquesChteauDesVigiers = () => (
  <RestaurantPage
    restaurantName="Les Fresques - Château des Vigiers"
    address="644 route Lars-Urban-Petersson, lieu-dit Le Vigier, Monestier, 24240, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33553615000"
    website="https://vigiers.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the crossroads between Dordogne, Gironde and Lot-et-Garonne, Vigiers Castle is a splendid 16C Périgord edifice set in grounds that are home to a vineyard and a well-known golf course. This several hundred-year-old castle houses a restaurant whose walls are graced with frescoes dating from the Renaissance period. Virtuoso chef Didier Casaguana paints from a palette rich in flavours and aromas, directly inspired by the region. This Toulouse boy, who admits to an overriding passion for nature and small-scale producers, also works with noble produce from the land of abundance that is southwest France, which he crafts into surprise menus: line-caught John Dory and mushrooms; fillet of Blonde d’Aquitaine beef with stuffed artichoke and a pressé of oxtail; a dessert that revolves around grand ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=644%20route%20Lars-Urban-Petersson%2C%20lieu-dit%20Le%20Vigier%2C%20Monestier%2C%2024240%2C%20France"
    pageTitle="Les Fresques - Château des Vigiers"
  />
);

export default LesFresquesChteauDesVigiers;
