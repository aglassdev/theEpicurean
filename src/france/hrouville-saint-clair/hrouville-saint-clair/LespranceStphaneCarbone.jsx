...
const LespranceStphaneCarbone = () => (
  <RestaurantPage
    restaurantName="L'Espérance - Stéphane Carbone"
    address="512 rue Abbé-Alix, Hérouville-Saint-Clair, 14200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231449710"
    website="https://www.esperance-stephanecarbone.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Treat yourself to a bucolic gourmet getaway a stone's throw from Caen, in Stéphane Carbone's terracotta-coloured establishment. The chef, well known to locals, serves traditional dishes with a modern twist, for example knuckle end of lamb, bulgur risotto with turmeric and turnip roasted with sweet tonka pepper. Each table commands a lovely view of the canal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=512%20rue%20Abb%C3%A9-Alix%2C%20H%C3%A9rouville-Saint-Clair%2C%2014200%2C%20France"
    pageTitle="L'Espérance - Stéphane Carbone"
  />
);

export default LespranceStphaneCarbone;
