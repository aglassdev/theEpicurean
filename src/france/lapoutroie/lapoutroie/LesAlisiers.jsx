...
const LesAlisiers = () => (
  <RestaurantPage
    restaurantName="Les Alisiers"
    address="Lieu-dit Faudé, Lapoutroie, 68650, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389475282"
    website="https://www.alisiers.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely panoramic restaurant has a minimalist decor. The food showcases local ingredients but stands out from local dishes by mixing influences and flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Faud%C3%A9%2C%20Lapoutroie%2C%2068650%2C%20France"
    pageTitle="Les Alisiers"
  />
);

export default LesAlisiers;
