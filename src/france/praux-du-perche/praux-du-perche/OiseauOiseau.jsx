...
const OiseauOiseau = () => (
  <RestaurantPage
    restaurantName="Oiseau - Oiseau"
    address="5 place Saint-Germain, Préaux-du-Perche, 61340, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33233735124"
    website="https://www.oiseau-oiseau.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sven Chartier and his wife Marianne have built their new nest in this tiny Perche village, opposite a church several centuries old. Far from the madding crowd, the chef is flourishing in this country chic setting, pampering diners with wholesome fare that respects tradition: scallops, almond milk, cauliflower and citron; crispy chuck steak. Culinary precision meets comfort food…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20Saint-Germain%2C%20Pr%C3%A9aux-du-Perche%2C%2061340%2C%20France"
    pageTitle="Oiseau - Oiseau"
  />
);

export default OiseauOiseau;
