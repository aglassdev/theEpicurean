...
const Arbane = () => (
  <RestaurantPage
    restaurantName="Arbane"
    address="7 rue Noël, Reims, 51100, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33326896070"
    website="https://www.arbane-philippe-mille.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After many years at Le Parc des Crayères, ‘Meilleur Ouvrier de France’ Philippe Mille has opened his own restaurant in this elegant abode dating back to 1874. In a contemporary interior done out in natural shades and strewn with references to the vineyards of Champagne, the chef from Sarthe pursues a culinary vision that is rooted in the Champagne terroir in his open kitchen. He cooks over vine branches, draws inspiration from the seven grape varieties (including Arbane), adding the odd fine seafood ingredient (monkfish, turbot, lobster etc). The champagne list is naturally of interest, and the plush lounge upstairs is adorned with a sculpture by a famous Reims-based master glassmaker...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20No%C3%ABl%2C%20Reims%2C%2051100%2C%20France"
    pageTitle="Arbane"
  />
);

export default Arbane;
