...
const LaGrandeGeorgette = () => (
  <RestaurantPage
    restaurantName="La Grande Georgette"
    address="18 rue Tronsson-Ducoudray, Reims, 51100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33326831818"
    website="https://www.lacasernechanzy.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name is a nod to an amusing tradition, which involved naming the fire engine’s ladder after the captain's wife. In this 1900’s industrial-style building next to the former Chanzy fire station, chef Julien Raphanel rustles up a high-flying score: line-caught cod, seagrapes and shellfish in champagne, braised sweetbread and girolles in vin jaune with a chocolate extravaganza to finish. The terrace with its breathtaking view commands a priceless view of Notre Dame Cathedral. Little Georgette next-door offers a tasty lineup of French family favourites at reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20Tronsson-Ducoudray%2C%20Reims%2C%2051100%2C%20France"
    pageTitle="La Grande Georgette"
  />
);

export default LaGrandeGeorgette;
