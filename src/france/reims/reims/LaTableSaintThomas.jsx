...
const LaTableSaintThomas = () => (
  <RestaurantPage
    restaurantName="La Table Saint Thomas"
    address="58 rue du Docteur-Thomas, Reims, 51100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33326050276"
    website="https://www.la-table-saint-thomas.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the quiet setting of a residential neighbourhood, this restaurant – housed in a converted carpentry workshop – is run by a couple of industry professionals. As for the food, the chef combines tradition with the four seasons to rustle up tasteful, simple and honest cuisine: Label Rouge salmon gravlax, Sichuan pepper emulsion, beetroot gel; turbot, asparagus gratin and Champagne sauce; rum baba with pineapple brunoise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20rue%20du%20Docteur-Thomas%2C%20Reims%2C%2051100%2C%20France"
    pageTitle="La Table Saint Thomas"
  />
);

export default LaTableSaintThomas;
