...
const ChteauDeRochecotte = () => (
  <RestaurantPage
    restaurantName="Château de Rochecotte"
    address="43 rue Dorothée-de-Dino, Saint-Patrice, Coteaux-sur-Loire, 37130, France"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33247961616"
    website="https://www.chateau-de-rochecotte.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the Bourgueil vineyards, this elegant château dating back to the Enlightenment is set in sumptuous grounds. In La Verrière with its contemporary decor and huge windows with views onto the greenery, or in the more classical dining area, enjoy fine dining-style cuisine, for instance, a fricassee of smoked eel in a Thai jus with lemongrass and coriander...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20rue%20Doroth%C3%A9e-de-Dino%2C%20Saint-Patrice%2C%20Coteaux-sur-Loire%2C%2037130%2C%20France"
    pageTitle="Château de Rochecotte"
  />
);

export default ChteauDeRochecotte;
