...
const AtelierSalone = () => (
  <RestaurantPage
    restaurantName="Atelier Salone"
    address="6 rue du Maréchal-Joffre, Salon-de-Provence, 13300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490562801"
    website="https://villa-salone.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Atelier Salone, the bistronomy sibling of Villa Salone, is lavished with attention by Alexandre Lechêne, a chef with a stellar CV (Aux Lyonnais, Louis XV in Monaco) and formerly Michelin-starred in Saint-Véran (Hautes Alpes département). On the day of our visit, the menu included slow-cooked organic egg with pumpkin and truffles, a delicious vol-au-vent and a chestnut and blackcurrant mont blanc dessert with chestnut ice cream. The original style of this early-20C building is underscored by contemporary details...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Mar%C3%A9chal-Joffre%2C%20Salon-de-Provence%2C%2013300%2C%20France"
    pageTitle="Atelier Salone"
  />
);

export default AtelierSalone;
