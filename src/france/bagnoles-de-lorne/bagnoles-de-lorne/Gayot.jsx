...
const Gayot = () => (
  <RestaurantPage
    restaurantName="Ô Gayot"
    address="2 avenue de la Ferté-Macé, Bagnoles-de-l'Orne, 61140, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33233384401"
    website="https://www.ogayot.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chic bistro in a pretty stone house certainly has its finger on the pulse. On the menu find good bistro recipes that change on a weekly basis. These include, soft - boiled egg with cream of mushroom soup and Calvados baba. A taste sensation!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20avenue%20de%20la%20Fert%C3%A9-Mac%C3%A9%2C%20Bagnoles-de-l'Orne%2C%2061140%2C%20France"
    pageTitle="Ô Gayot"
  />
);

export default Gayot;
