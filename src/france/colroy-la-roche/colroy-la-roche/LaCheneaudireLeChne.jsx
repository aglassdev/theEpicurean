...
const LaCheneaudireLeChne = () => (
  <RestaurantPage
    restaurantName="La Cheneaudière - Le Chêne"
    address="3 rue du Vieux-Moulin, Colroy-la-Roche, 67420, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388976164"
    website="https://www.cheneaudiere.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a visit to the hotel spa, why not treat yourself to a meal in the chic natural setting of Le Chêne? The refined menu features a concise range of tempting proposals: seasonal vegetable gazpacho with preserved vegetables on crispy bread and black garlic vinaigrette; prawns with fresh thyme, a vibrant bisque, house-made tagliatelle with Taggiasca olives; cheesecake with Alsace cream and fruit compote...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20du%20Vieux-Moulin%2C%20Colroy-la-Roche%2C%2067420%2C%20France"
    pageTitle="La Cheneaudière - Le Chêne"
  />
);

export default LaCheneaudireLeChne;
