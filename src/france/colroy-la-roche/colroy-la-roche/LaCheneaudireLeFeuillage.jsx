...
const LaCheneaudireLeFeuillage = () => (
  <RestaurantPage
    restaurantName="La Cheneaudière - Le Feuillage"
    ...
    pageTitle="La Cheneaudière - Le Feuillage"
  />
);

export default LaCheneaudireLeFeuillage;
