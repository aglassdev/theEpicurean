...
const Chardon = () => (
  <RestaurantPage
    restaurantName="Chardon"
    address="37 rue des Arènes, Arles, 13200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33972867204"
    website="https://www.hellochardon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Chardon hosts chefs-in-residence, who temporarily take the reins in the kitchen and who share a commitment to locally sourced ingredients. The result is a fresh, succulent score served in a lovely bistro setting paired with a fine selection of natural wines. Spot on!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20rue%20des%20Ar%C3%A8nes%2C%20Arles%2C%2013200%2C%20France"
    pageTitle="Chardon"
  />
);

export default Chardon;
