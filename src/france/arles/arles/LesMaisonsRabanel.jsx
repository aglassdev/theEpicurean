...
const LesMaisonsRabanel = () => (
  <RestaurantPage
    restaurantName="Les Maisons  Rabanel"
    address="7 rue des Carmes, Arles, 13200, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33490910769"
    website="https://www.rabanel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jean-Luc Rabanel is a colourful character with a lilting accent, who perpetually reinvents his vegetable-based cuisine. Les Maisons Rabanel, a single place but two styles of cooking: Greeniotage, which tends towards bistro food, and Greenstronome for fine dining. Always going out on a limb, this engaging chef shakes things up at every service. A unique personality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20des%20Carmes%2C%20Arles%2C%2013200%2C%20France"
    pageTitle="Les Maisons  Rabanel"
  />
);

export default LesMaisonsRabanel;
