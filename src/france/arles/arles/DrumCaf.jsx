...
const DrumCaf = () => (
  <RestaurantPage
    restaurantName="Drum Café"
    address="35 avenue Victor Hugo, Arles, 13200, France"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+33614595793"
    website="https://www.luma.org/arles/nous-rendre-visite/se-restaurer-au-parc-des-ateliers/drum-cafe.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Designed as a landmark and tribute to the Arles region, architect Frank Gehry's Tower for the Luma campus not only draws art lovers but is also a beacon for foodies. The undeniably trendy venue boasts impressively high ceilings and a huge stainless-steel bar in the centre. All the furniture and materials were designed using recycled materials and natural resources, such as merino wool from Arles. As for the food, contemporary art connoisseurs can sample dishes starring good, fresh local produce (lamb from the Alpilles, rice and oysters from the Camargue etc), crafted generously by resident chefs who don’t hesitate to push culinary boundaries: aubergine glazed with soy and mirin, sesame caviar and chimichurri condiment; tartare of quasi of veal, black garlic aioli, preserved lemon and Romai..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20avenue%20Victor%20Hugo%2C%20Arles%2C%2013200%2C%20France"
    pageTitle="Drum Café"
  />
);

export default DrumCaf;
