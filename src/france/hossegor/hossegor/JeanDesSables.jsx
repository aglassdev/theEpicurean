...
const JeanDesSables = () => (
  <RestaurantPage
    restaurantName="Jean des Sables"
    address="121 boulevard de la Dune, à Soorts, Hossegor, 40150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33558722982"
    website="https://www.jeandessables.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beach front restaurant sports a fashionably stark interior: polished concrete, a light colour scheme, a live lobster tank and an ocean view… The modern cuisine is presented in a brief, well-crafted menu. Special lobster menu. Attentive welcome and service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20boulevard%20de%20la%20Dune%2C%20%C3%A0%20Soorts%2C%20Hossegor%2C%2040150%2C%20France"
    pageTitle="Jean des Sables"
  />
);

export default JeanDesSables;
