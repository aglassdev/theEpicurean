...
const LaGrandvigneLesSourcesDeCaudalie = () => (
  <RestaurantPage
    ...
    pageTitle="La Grand'Vigne - Les Sources de Caudalie"
  />
);

export default LaGrandvigneLesSourcesDeCaudalie;
