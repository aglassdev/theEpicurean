...
const LaTableDuLavoirLesSourcesDeCaudalie = () => (
  <RestaurantPage
    restaurantName="La Table du Lavoir - Les Sources de Caudalie"
    address="Chemin de Smith-Haut-Lafitte, Martillac, 33650, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33557838383"
    website="https://www.sources-hotels.com/bordeaux/restaurants/restaurant-table-du-lavoir/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you take a seat in this unabashedly rustic, yet plush establishment, you are reminded of the region’s rich heritage – the winegrowers’ wives used to wash their clothes in the old stone sink that stands in the centre of this reconstructed 18C hall. The menu is accordingly traditional and wholesome: grilled free-range breast of chicken, crunchy potatoes, trompette mushrooms and bearnaise sauce. The epitome of a spruce, country inn of yesteryear, with the bonus of cheerful waiting staff. Even better, it is possible to taste the wines of the property, which is none other than Château Smith Haut Lafitte (also available by the glass)!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Smith-Haut-Lafitte%2C%20Martillac%2C%2033650%2C%20France"
    pageTitle="La Table du Lavoir - Les Sources de Caudalie"
  />
);

export default LaTableDuLavoirLesSourcesDeCaudalie;
