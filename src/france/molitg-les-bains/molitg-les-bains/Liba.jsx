...
const Liba = () => (
  <RestaurantPage
    restaurantName="Òliba"
    address="Château de Riell, Molitg-les-Bains, 66500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33468050440"
    website="https://www.chateauderiell.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set deep in the Catalan Pyrenees, this refined restaurant in a romantic hotel serves flavoursome cuisine inspired by the surrounding countryside and locally picked produce: the local version of chimichurri sauce with mountain herbs exudes aromas of wild dill and burnet flowers. To be enjoyed on the terrace or in front of the picture windows, as you contemplate the snow-capped summit of Mount Canigou in the distance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Riell%2C%20Molitg-les-Bains%2C%2066500%2C%20France"
    pageTitle="Òliba"
  />
);
