...
const LaTableDeLannapurna = () => (
  <RestaurantPage
    restaurantName="La Table de l'Annapurna"
    ...
    pageTitle="La Table de l'Annapurna"
  />
);

export default LaTableDeLannapurna;
