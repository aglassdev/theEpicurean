...
const BaseKampByAnata = () => (
  <RestaurantPage
    restaurantName="Base Kamp by Aïnata"
    address="Le K2 Altitude, 356 route de l'Altiport, Courchevel 1850, Courchevel, 73120, France"
    cuisine="Lebanese"
    priceRange="€€€€"
    phoneNumber="+33479014646"
    website="https://www.lek2altitude.com/fr/deguster/ainata.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zaatar, freekeh, sumac, pomegranate, bulgur, hummus, tahini, mograbieh: French-Lebanese chef Alan Geaam made sure he packed his rucksack full of produce and spices from his homeland before heading up to Courchevel. Mezze and food for sharing, to be enjoyed – at lunchtime only – beneath the rafters in the spacious dining room, or on the terrace with views of the ski slopes...."
    ...
    pageTitle="Base Kamp by Aïnata"
  />
);

export default BaseKampByAnata;
