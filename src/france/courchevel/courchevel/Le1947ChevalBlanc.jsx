...
const Le1947ChevalBlanc = () => (
  <RestaurantPage
    restaurantName="Le 1947 à Cheval Blanc"
    ...
    pageTitle="Le 1947 à Cheval Blanc"
  />
);

export default Le1947ChevalBlanc;
