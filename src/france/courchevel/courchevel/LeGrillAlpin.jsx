...
const LeGrillAlpin = () => (
  <RestaurantPage
    restaurantName="Le Grill Alpin"
    address="Cheval Blanc, Le Jardin Alpin, Courchevel 1850, Courchevel, 73120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33479005050"
    website="https://www.chevalblanc.com/courchevel"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the leadership of Yannick Alléno, the chic Alpine brasserie of the upscale Cheval Blanc hotel has brilliantly reinvented high-altitude dining, serving up a contemporary and uninhibited fine dining offering. Your taste buds won't know what hit them! A sublime list of top-of-the-range wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cheval%20Blanc%2C%20Le%20Jardin%20Alpin%2C%20Courchevel%201850%2C%20Courchevel%2C%2073120%2C%20France"
    pageTitle="Le Grill Alpin"
  />
);

export default LeGrillAlpin;
