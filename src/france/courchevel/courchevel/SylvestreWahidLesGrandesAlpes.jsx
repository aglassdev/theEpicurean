...
const SylvestreWahidLesGrandesAlpes = () => (
  <RestaurantPage
    restaurantName="Sylvestre Wahid - Les Grandes Alpes"
    address="28 rue de l'Église, Courchevel 1850, Courchevel, 73120, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33479000000"
    website="https://restaurantsylvestre.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In an exclusive setting comprising just four tables, Sylvestre Wahid serves only around 15 lucky guests per sitting. This tailor-made culinary interlude is built around the chef's signature dishes, which he reinterprets at this ski resort location according to his inspiration – think Roscoff crab or a lemon and seaweed dessert. In an open kitchen where he is assisted by his trusted team, the chef displays a marvellous sense of daring, masterfully pairing lobster and crab with ingredients typical of Pakistani cuisine – spices, chilli and lemon acar pickles, lentil dahl etc. Magnificent produce, premium ingredients, delicate sauces, expert seasonings, impeccable technical skill and, above all, a dash of emotion – the generous tasting menu showcases it all...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20de%20l'%C3%89glise%2C%20Courchevel%201850%2C%20Courchevel%2C%2073120%2C%20France"
    pageTitle="Sylvestre Wahid - Les Grandes Alpes"
  />
);

export default SylvestreWahidLesGrandesAlpes;
