...
const AubergeDeLabbayeVIL = () => (
  <RestaurantPage
    restaurantName="Auberge de l'Abbaye"
    address="4 place de l'Abbaye, Villemagne-l'Argentière, 34600, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33467953484"
    website="https://www.aubergeabbaye.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small medieval village. Tucked away from view, a 12C tower casts a shadow onto a stone wall, and behind this wall you come across this charming inn, which is certainly worth getting to know! Here they serve good traditional food that is at one with the monastic atmosphere of the place, all vaulted ceilings and stone walls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20place%20de%20l'Abbaye%2C%20Villemagne-l'Argenti%C3%A8re%2C%2034600%2C%20France"
    pageTitle="Auberge de l'Abbaye"
  />
);

export default AubergeDeLabbayeVIL;
