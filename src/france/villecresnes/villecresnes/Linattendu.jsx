...
const Linattendu = () => (
  <RestaurantPage
    ...
    address="36 rue du Général-Leclerc, Villecresnes, 94440, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33175366152"
    website="https://www.restaurantlinattendu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="All that remains of this former butcher's shop are the tiled walls and a few hooks for hanging meat. The rest of the interior is contemporary and charming, with colourful velvet-upholstered seats and sprucely decorated little tables. A table d'hôte (reservation required) is hidden among the bottles in the cellar. The two surprise set menus allow the chef to work with the best ingredients available at any given time, whether they be sourced from the nearby market, Marché de Rungis, or, in the case of certain vegetables, from a small organic farm nearby. Mackerel and beetroot; Vendée poultry and a stew of chickpeas and carrots; almond and hazelnut financier, fig and corn ice cream: healthy, to-the-point cuisine in the form of colourful, flavourful dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Villecresnes%2C%2094440%2C%20France"
    pageTitle="L'Inattendu"
  />
);

export default Linattendu;
