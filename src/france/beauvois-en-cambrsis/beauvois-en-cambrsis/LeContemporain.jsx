...
const LeContemporain = () => (
  <RestaurantPage
    restaurantName="Le Contemporain"
    address="4 rue Jean-Jaurès, Beauvois-en-Cambrésis, 59157, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33327760317"
    website="https://www.restaurant-lecontemporain.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family home dating back to the 19C was converted into a restaurant in 2008. At the helm, an experienced couple: she works in the kitchen, showcasing the home - grown produce by creating tasty dishes; he is in charge of front of house, as well as upkeep of the vegetable garden. Modern, light - filled conservatory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Jean-Jaur%C3%A8s%2C%20Beauvois-en-Cambr%C3%A9sis%2C%2059157%2C%20France"
    pageTitle="Le Contemporain"
  />
);

export default LeContemporain;
