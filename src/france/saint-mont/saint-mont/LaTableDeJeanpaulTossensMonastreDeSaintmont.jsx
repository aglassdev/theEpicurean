...
const LaTableDeJeanpaulTossensMonastreDeSaintmont = () => (
  <RestaurantPage
    restaurantName="La Table de Jean-Paul Tossens - Monastère de Saint-Mont"
    address="627 rue Bernard-Tumapaler, Saint-Mont, 32400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33632864611"
    website="https://www.lemonasteredesaintmont.com/la-table-jeanpaultossens"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To say this place is steeped in history is an understatement: the monastery, rebuilt several times since the Middle Ages, is said to stand on the site of a Roman oppidum. The chef revisits French cuisine through a seasonal lens, showcasing premium ingredients, and serving up his dishes in an elegant setting. Guestrooms available; hotel facilities include swimming pool and spa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=627%20rue%20Bernard-Tumapaler%2C%20Saint-Mont%2C%2032400%2C%20France"
    pageTitle="La Table de Jean-Paul Tossens - Monastère de Saint-Mont"
  />
);

export default LaTableDeJeanpaulTossensMonastreDeSaintmont;
