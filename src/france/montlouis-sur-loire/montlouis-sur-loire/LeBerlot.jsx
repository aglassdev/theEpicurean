...
const LeBerlot = () => (
  <RestaurantPage
    restaurantName="Le Berlot"
    address="2 place François-Mitterrand, Montlouis-sur-Loire, 37270, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247563021"
    website="https://guide.michelin.com/en/centre-val-de-loire/montlouis-sur-loire/restaurant/le-berlot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hervé and Patricia Chardonneau, a couple of foodies formerly of Casse-Cailloux in Tours, have set up shop in the heart of a wine-growing village. Hervé crafts a hearty, wholesome lineup of traditional French nosh, together with game in season: hare à la royale (a sort of jugged hare), a game pie (oreiller de la belle Aurore), lamb’s brains... His bistronomic approach draws its inspiration from the seasons. Fine wine list with a focus on organic and natural wines. Separate wine bar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20Fran%C3%A7ois-Mitterrand%2C%20Montlouis-sur-Loire%2C%2037270%2C%20France"
    pageTitle="Le Berlot"
  />
);

export default LeBerlot;
