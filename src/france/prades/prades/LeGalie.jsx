...
const LeGalie = () => (
  <RestaurantPage
    restaurantName="Le Galie"
    address="3 avenue du Général-de-Gaulle, Prades, 66500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468055376"
    website="https://www.restaurantlegalie.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don’t bother lingering on the ground-floor, but make a beeline for the upstairs, modern, comfy dining room where a sweet young couple rustles up market-fresh fare in keeping with today’s tastes. The chef’s signature dish is fricassee of lobster with a lobster sauce and rice vermicelli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Prades%2C%2066500%2C%20France"
    pageTitle="Le Galie"
  />
);

export default LeGalie;
