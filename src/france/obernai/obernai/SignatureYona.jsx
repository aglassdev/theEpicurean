...
const SignatureYona = () => (
  <RestaurantPage
    restaurantName="Signature - Yona"
    address="Hôtel Yona, 169 route d'Ottrott, Obernai, 67210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388955008"
    website="https://www.yonahotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment in an imposing Alsace building on the outskirts of town has been handed down the generations of the family since 1954 and is now an imposing luxury hotel with a distinctive design. In the contemporary dining room, with its electro soundtrack and subdued lighting, diners are treated to delicious modern cuisine with Asian influences, sometimes reminiscent of comfort food. Chic atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Yona%2C%20169%20route%20d'Ottrott%2C%20Obernai%2C%2067210%2C%20France"
    pageTitle="Signature - Yona"
  />
);

export default SignatureYona;
