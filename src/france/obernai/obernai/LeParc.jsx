...
const LeParc = () => (
  <RestaurantPage
    restaurantName="Le Parc"
    address="169 route d'Ottrott, Obernai, 67210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388955008"
    website="https://www.leparchotel.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the outskirts of the town, this imposing Alsatian hotel/restaurant has been in the family since 1954. The elegant dining room features honey-coloured panelling, a coffered ceiling and a crystal chandelier. Dishes are up-to-date and carefully prepared...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=169%20route%20d'Ottrott%2C%20Obernai%2C%2067210%2C%20France"
    pageTitle="Le Parc"
  />
);
