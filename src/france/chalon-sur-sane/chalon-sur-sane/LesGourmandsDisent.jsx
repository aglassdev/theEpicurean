...
const LesGourmandsDisent = () => (
  <RestaurantPage
    restaurantName="Les Gourmands Disent"
    address="59 rue de Strasbourg, Chalon-sur-Saône, 71100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33385487521"
    website="https://www.les-gourmands-disent-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Île St-Laurent's restaurant street, an enthusiastic double act (Laurent is in charge of savoury dishes, while Nadine handles the desserts) has breathed new life into this engaging eatery. Bare stone walls and high coffered French ceilings set the scene for well-crafted dishes, before perusing the knockout selection of trompe-l’œil desserts, such as the chocolate Montecristo. Do as the regulars do: book well in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%20rue%20de%20Strasbourg%2C%20Chalon-sur-Sa%C3%B4ne%2C%2071100%2C%20France"
    pageTitle="Les Gourmands Disent"
  />
);

export default LesGourmandsDisent;
