...
const Aromatique = () => (
  <RestaurantPage
    restaurantName="Aromatique"
    address="14 rue de Strasbourg, Chalon-sur-Saône, 71100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33358096225"
    website="https://www.aromatique-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A couple works hand in hand in this establishment. Chef Fabien crafts creative and inspired cuisine from fresh premium ingredients, adding the occasional sprinkling of spice. Émilie, in charge of the front of house, ensures diners receive a warm welcome. There is no risk of repetition as the evening menu changes regularly; the lunchtime formula is a genuine bargain. One of our favourite eateries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20de%20Strasbourg%2C%20Chalon-sur-Sa%C3%B4ne%2C%2071100%2C%20France"
    pageTitle="Aromatique"
  />
);

export default Aromatique;
