...
const LeDonjonDomaineSaintclair = () => (
  <RestaurantPage
    restaurantName="Le Donjon - Domaine Saint-Clair"
    address="Chemin de Saint-Clair, Etretat, 76790, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33235270823"
    website="https://www.hoteletretat.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish Normandy manor commissioned a fresco by Jean-Charles Castelbajac for its dining room, creating the perfect foil for the view of the sun setting over the town of Étretat and its cliffs on the horizon. The culinary score has embraced a two-fold seaside/plant theme with just the right blend of balance and harmony as sauces and jus add a welcome gutsy kick greatly appreciated by discerning foodies. Pleasant guestrooms to stay longer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Saint-Clair%2C%20Etretat%2C%2076790%2C%20France"
    pageTitle="Le Donjon - Domaine Saint-Clair"
  />
);

export default LeDonjonDomaineSaintclair;
