...
const LaVillaArchange = () => (
  <RestaurantPage
    restaurantName="La Villa Archange"
    address="Rue de l'Ouest, Le Cannet, 06110, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33492181828"
    website="https://www.bruno-oger.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This handsome 18C provençal villa is perched up in the hills above Cannes. Take a seat in one of the small cosy lounges to sample chef Bruno Oger's cuisine. Breton by birth, he has adopted the Mediterranean as his home, concocting inspired seafood dishes drawn from Brittany and the French Riviera… Abalone from the island of Groix in a parsley herb sauce; roast turbot, celery, shallots and walnuts; a lemon-flavoured praliné and buckwheat dessert. His braised pork cheeks and razor clams with a black pudding tartlet illustrate his knack for meat dishes. A table d'hôte in the kitchen provides the opportunity to glean insights into the culinary process. The cheerful, attentive service further adds to the experience. You can’t go wrong with the lunchtime menu, available on Fridays and Saturdays,..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20l'Ouest%2C%20Le%20Cannet%2C%2006110%2C%20France"
    pageTitle="La Villa Archange"
  />
);

export default LaVillaArchange;
