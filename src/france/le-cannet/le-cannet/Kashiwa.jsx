...
const Kashiwa = () => (
  <RestaurantPage
    restaurantName="Kashiwa"
    address="12 boulevard Gambetta, Le Cannet, 06110, France"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+33749455888"
    website="https://restaurantkashiwa.wixsite.com/kashiwa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don't be fooled by the sign: this small Japanese restaurant (kashiwa means oak leaf) housed in a former tapestry - maker's workship, offers a lovely array of Japanese dishes (sushi, sashimi, soba etc). Small terrace, and prime location close to the Musée Pierre Bonnard. A pleasant place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20boulevard%20Gambetta%2C%20Le%20Cannet%2C%2006110%2C%20France"
    pageTitle="Kashiwa"
  />
);
