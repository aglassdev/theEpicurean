...
const Lmotion = () => (
  <RestaurantPage
    restaurantName="L'Émotion"
    address="13 place Cadelade, Puy-en-Velay, 43000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33471097423"
    website="https://www.restaurant-lemotion.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From one year to the next and from one location to another, local chef-owner Michaël Ruat has been regaling the lucky diners of Puy-en-Velay. The interior sports natural materials and designer details (glazed wine cellar). The food forges a culinary course between regional Haute Loire ingredients (green lentils, Fin Gras du Mézenc beef) and a very modern repertoire of dishes (bluefin tuna, grilled watermelon and feta, sauce vierge and chorizo Bellota)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20place%20Cadelade%2C%20Puy-en-Velay%2C%2043000%2C%20France"
    pageTitle="L'Émotion"
  />
);

export default Lmotion;
