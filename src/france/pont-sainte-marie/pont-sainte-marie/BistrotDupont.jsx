...
const BistrotDupont = () => (
  <RestaurantPage
    restaurantName="Bistrot DuPont"
    address="5 place Charles-de-Gaulle, Pont-Sainte-Marie, 10150, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33325809099"
    website="https://www.bistrotdupont.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant traditional French bistro by the River Seine has a friendly front-of-house team serving up good old-fashioned recipes. Tuck into veal kidneys with mustard sauce, coq au vin, or frogs' legs with persillade sauce in a lively atmosphere… Be sure to sample the house speciality: andouillette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20Charles-de-Gaulle%2C%20Pont-Sainte-Marie%2C%2010150%2C%20France"
    pageTitle="Bistrot DuPont"
  />
);

export default BistrotDupont;
