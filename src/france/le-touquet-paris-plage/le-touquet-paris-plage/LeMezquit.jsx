...
const LeMezquit = () => (
  <RestaurantPage
    restaurantName="Le Mezquité"
    address="70 rue de Paris, Le Touquet-Paris-Plage, 62520, France"
    cuisine="Fusion, Mexican"
    priceRange="€€"
    phoneNumber="+33321058927"
    website="https://www.lemezquite.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Courgettes, samphire and salsa macha; avocado and chocolate parfait – this restaurant in Le Touquet successfully showcases its take on fusion cuisine, with a penchant for smoking certain food items. Chef Julien Szyndler prepares regional ingredients using Mexican methods, sauces and spices, for instance cochinita pibil (with pork marinated and cooked over mezquita wood) or mole poblano with duck. The food mirrors the couple's roots: he hails from nearby Valenciennes, while Laura Flores, his wife, is from Mexico: Puebla, to be precise (southeast of Mexico City)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20rue%20de%20Paris%2C%20Le%20Touquet-Paris-Plage%2C%2062520%2C%20France"
    pageTitle="Le Mezquité"
  />
);

export default LeMezquit;
