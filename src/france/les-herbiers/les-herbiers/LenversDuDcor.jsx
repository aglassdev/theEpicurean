...
const LenversDuDcor = () => (
  <RestaurantPage
    restaurantName="L'Envers du Décor"
    address="23 rue de la Bienfaisance, Les Herbiers, 85500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33986193021"
    website="http://envers-du-decor.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old bakery has been transformed into a smart, contemporary restaurant that sports a minimalist vibe. Chef Aurélien Jousseaume earned his stripes in Michelin-starred kitchens with the likes of Etchebest, Guy Savoy and Guy Martin. To-ing and fro-ing between his open kitchen and the restaurant floor, the chef, who is clearly having a ball, takes the orders and presents the dishes himself. His delicious seasonal cuisine showcases his flair for creating remarkable sauces and jus: creamy jus of trout roe, sabayon enhanced with smoked salt, watercress and horseradish sauce, veal jus with lovage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20de%20la%20Bienfaisance%2C%20Les%20Herbiers%2C%2085500%2C%20France"
    pageTitle="L'Envers du Décor"
  />
);

export default LenversDuDcor;
