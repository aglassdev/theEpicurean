...
const LePiquebaure = () => (
  <RestaurantPage
    restaurantName="Le Piquebaure"
    address="166 avenue Dame-Sirmonde, Roussillon, 84220, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33432529448"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/roussillon/restaurant/le-piquebaure"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of Roussillon village, this picturesque dry-stone house proposes Provençal-inspired food in an enticing menu in which fresh produce is a major component. The restaurant’s pride and joy is its second terrace overlooking the wonderful Luberon countryside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=166%20avenue%20Dame-Sirmonde%2C%20Roussillon%2C%2084220%2C%20France"
    pageTitle="Le Piquebaure"
  />
);

export default LePiquebaure;
