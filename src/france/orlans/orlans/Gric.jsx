...
const Gric = () => (
  <RestaurantPage
    restaurantName="Gric"
    address="8 rue des Halles, Orléans, 45000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33238531645"
    website="https://www.restaurantgric.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Marie Gricourt's career has already taken her to the heights of Christophe Hay's La Table d'à Côté, where she was head chef. She has since opened her own restaurant, a convivial place in keeping with her personality. In this restaurant not far from the banks of the River Loire, the chef and her mainly female team (who provide service with a smile) put a new twist on bistro-style cuisine, simply and precisely: a surf and turf starter with scallops cradled in a sweet potato, bacon and prune purée; conchiglioni stuffed with beef chuck and porcini; and for dessert a delicious floating island with citrus fruit, honey and pollen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20des%20Halles%2C%20Orl%C3%A9ans%2C%2045000%2C%20France"
    pageTitle="Gric"
  />
);
