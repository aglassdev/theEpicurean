...
const LaGourmandire = () => (
  <RestaurantPage
    restaurantName="La Gourmandière"
    address="19 avenue de Blagny, Carignan, 08110, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33324222099"
    website="https://lagourmandiere-carignan.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A longstanding Ardennes institution, this plush 1890 property is enjoying a new lease of life courtesy of two young brothers-cum-partners. The deftly plated dishes slalom between tradition and modernity: pressed foie gras laced in old rum, veal sweetbread, Rossini tournedos steak, turbot and risotto of fregola sarda… Gloriously peaceful patio to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20avenue%20de%20Blagny%2C%20Carignan%2C%2008110%2C%20France"
    pageTitle="La Gourmandière"
  />
);

export default LaGourmandire;
