...
const LaubergeMaisonsGlennAnna = () => (
  <RestaurantPage
    restaurantName="L'Auberge - Maisons Glenn Anna"
    address="56 rue de Vannes, Sainte-Anne-d'Auray, 56400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297576155"
    website="https://maisons-glenn-anna.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ste-Anne-d'Auray is known for its sanctuary and pilgrimages, and Pope John Paul II is said to have stopped off at this restaurant in 1996. But it is by no means stuck in the past: the new generation concocts delicious fare, in which premium seafood takes pride of place, as in the half-cooked tuna with a medley of tomatoes and béarnaise sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20rue%20de%20Vannes%2C%20Sainte-Anne-d'Auray%2C%2056400%2C%20France"
    pageTitle="L'Auberge - Maisons Glenn Anna"
  />
);

export default LaubergeMaisonsGlennAnna;
