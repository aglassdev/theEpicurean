...
const Arkadia = () => (
  <RestaurantPage
    restaurantName="Arkadia"
    address="9 rue du Barry, Vallon-Pont-d'Arc, 07150, France"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+33620770159"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/vallon-pont-d-arc/restaurant/arkadia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the historical centre of this village near the Ardèche Gorges, the chef, who is originally from Brittany, confidently sets about regaling diners with locally sourced ingredients (vegetables and cheeses in particular). The menu, renewed every month, is packed with indulgent and generous dishes. Front of house, Philippine's good humour sets the tone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20du%20Barry%2C%20Vallon-Pont-d'Arc%2C%2007150%2C%20France"
    pageTitle="Arkadia"
  />
);
