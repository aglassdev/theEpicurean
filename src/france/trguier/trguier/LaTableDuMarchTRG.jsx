...
const LaTableDuMarchTRG = () => (
  <RestaurantPage
    restaurantName="La Table du Marché"
    address="30 rue Saint-André, Tréguier, 22220, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33296929322"
    website="https://guide.michelin.com/en/bretagne/trguier/restaurant/la-table-du-marche"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The petrol-blue frontage of this restaurant between the River Jaudy and Cathédrale Saint-Tugdual draws the eyes of passers-by. Inside the small rustic-style space, with white roughcast walls, exposed beams and old stonework, an appetising market-fresh menu is served: foie gras marbled with red wine; roast cod with Coco de Paimpol haricot beans; financier with pan-fried apricots. The chef, who boasts a great CV, draws on both tradition and bistronomy to concoct dishes that are inspired by regional produce. Wide choice of wines by the glass. The bill won't break the bank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20rue%20Saint-Andr%C3%A9%2C%20Tr%C3%A9guier%2C%2022220%2C%20France"
    pageTitle="La Table du Marché"
  />
);

export default LaTableDuMarchTRG;
