...
const LesTroisRochers = () => (
  <RestaurantPage
    restaurantName="Les Trois Rochers"
    address="16 rue du Phare, à Sainte-Marine, Combrit, 29120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33298519494"
    website="https://www.trimen.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the Odet estuary, opposite the pretty port of Bénodet, the view overlooks the sea on one side and a forest of pine and oak on the other… The magnificently located Hotel Villa Tri Men dates from the early 20C, when it was built by a Breton admiral as his home. The chef, who trained in Quimper and has worked in Brittany and Switzerland, aims above all to highlight the work of the artisans and producers of Brittany (most of whom are organic). He combines regional delicacies with spices from afar and fresh herbs on a constant quest to exalt the flavour. His langoustine ravioles and shellfish stock are out of this world!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20du%20Phare%2C%20%C3%A0%20Sainte-Marine%2C%20Combrit%2C%2029120%2C%20France"
    pageTitle="Les Trois Rochers"
  />
);

export default LesTroisRochers;
