...
const BistrotDuBac = () => (
  <RestaurantPage
    restaurantName="Bistrot du Bac"
    address="19 rue du Bac, à Sainte-Marine, Combrit, 29120, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33298563479"
    website="https://www.hoteldubac.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quaint Breton eatery, located on the quayside of Sainte-Marine's little port opposite Bénodet Island, celebrates the sea. The terrace affords picturesque views over the River Odet, the dining area is painted blue and white, as are the guestrooms, and the maritime theme is pursued in the no-frills seafood score...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20du%20Bac%2C%20%C3%A0%20Sainte-Marine%2C%20Combrit%2C%2029120%2C%20France"
    pageTitle="Bistrot du Bac"
  />
);

export default BistrotDuBac;
