...
const ChteauLeCagnard = () => (
  <RestaurantPage
    restaurantName="Château Le Cagnard"
    address="54 rue Sous-Barri, le Haut-de-Cagnes, Cagnes-sur-Mer, 06800, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33493207322"
    website="https://www.lecagnard.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The standout features are the lovely terrace with a view as far as Cap d'Antibes and the flawlessly prepared contemporary cuisine: Vaucluse green asparagus au gratin with aged Parmesan and kumquat; fillet of sea bass with lardo di Colonnata, artichokes from Provence and anchovy condiment; strawberry crisp, elderberry infusion. The detail that seals the deal is the elegant interior with its sliding roof designed to let in the light...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20rue%20Sous-Barri%2C%20le%20Haut-de-Cagnes%2C%20Cagnes-sur-Mer%2C%2006800%2C%20France"
    pageTitle="Château Le Cagnard"
  />
);

export default ChteauLeCagnard;
