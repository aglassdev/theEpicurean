...
const FleurDeSelCAG = () => (
  <RestaurantPage
    ...
    address="85 montée de la Bourgade, Cagnes-sur-Mer, 06800, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33493203333"
    website="https://www.restaurant-fleurdesel.com/fr/bienvenue"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fleur de Sel, taken over by a couple of young industry professionals, Alexis Cachat and Chloé Feuillet, has the requisite crunch, freshness and flavour. The promising pair met while plying their trade at a MICHELIN-starred restaurant in the Massif de l'Estérel, and are now delighting their own guests with meticulous Mediterranean cuisine. Taking their cue from the seasons, they offer good value for money: courgette flower stuffed with ricotta, olives, anchovies, fresh herbs, gazpacho and crunchy local courgette. Chloé not only provides cordial service, she is also in charge of desserts: think brownie with roasted hazelnuts, vanilla cream and candied apricots with rosemary...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20mont%C3%A9e%20de%20la%20Bourgade%2C%20Cagnes-sur-Mer%2C%2006800%2C%20France"
    pageTitle="Fleur de Sel"
  />
);

export default FleurDeSelCAG;
