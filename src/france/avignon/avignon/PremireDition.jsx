...
const PremireDition = () => (
  <RestaurantPage
    restaurantName="Première édition"
    address="5 rue Prévôt, Avignon, 84000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33484145985"
    website="https://premiereedition.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this pleasant bistro in the heart of the city, with its industrial-style interior, street art touches and an open kitchen with a waxed-concrete bar, Jonathan provides friendly, professional service. Meanwhile, in the kitchen, chef Aurélie cooks up creative dishes inspired by bistro recipes or comfort food, adding a playful twist by means of spices, herbs, berries or dried fruit. Examples include devilled eggs with red curry, an old-school pita bread with braised shredded beef and a sesame cream, Carnaroli risotto with chanterelle mushrooms, or Aubrac beef tenderloin with a chicken sauce and suji seaweed. This is tasty, lively fare with a sense of fun, and the motto come, eat, drink perfectly sums up the simplicity and bon vivant spirit of the place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Pr%C3%A9v%C3%B4t%2C%20Avignon%2C%2084000%2C%20France"
    pageTitle="Première édition"
  />
);

export default PremireDition;
