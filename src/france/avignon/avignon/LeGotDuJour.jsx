...
const LeGotDuJour = () => (
  <RestaurantPage
    restaurantName="Le Goût du Jour"
    address="20 rue Saint-Étienne, Avignon, 84000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33432763216"
    website="https://legoutdujour84.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Good ideas, know - how... Julien Chazal, a young chef from Avignon, shows us how it's done! Furthermore, his seasonal cooking is visually meticulous, with presentations that leave nothing to chance. And let's not forget the down - to - earth, smiling service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Saint-%C3%89tienne%2C%20Avignon%2C%2084000%2C%20France"
    pageTitle="Le Goût du Jour"
  />
);

export default LeGotDuJour;
