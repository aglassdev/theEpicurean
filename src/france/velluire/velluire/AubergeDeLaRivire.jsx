...
const AubergeDeLaRivire = () => (
  <RestaurantPage
    restaurantName="Auberge de la Rivière"
    address="Rue du Port-de-la-Fouarne, Velluire, 85770, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33251523215"
    website="https://www.hotel-riviere-vendee.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A riverside location and ivy-clad façade set the charming rural scene for this Vendée inn overlooking the old stone bridge – ideal for a gourmet get-away! The chef works with top produce, aromatic herbs and subtle seasonings and each dish reveals the hallmark of his enthusiastic culinary quest. Make sure you save room for the desserts – to die for! The menu changes fortnightly. A few attractive rooms overlooking the River Vendée are available, together with boats and mountain bikes for rent should you feel more energetic. Perfectly idyllic!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Port-de-la-Fouarne%2C%20Velluire%2C%2085770%2C%20France"
    pageTitle="Auberge de la Rivière"
  />
);

export default AubergeDeLaRivire;
