...
const LeCarrDange = () => (
  <RestaurantPage
    restaurantName="Le Carré d'Ange"
    address="2169 quartier Narbonne, Montauroux, 83440, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33494477165"
    website="https://restaurant-carredange.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This updated, airy Provençal inn outside town provides the perfect foil for generous, throbbingly good Mediterranean food. Examples include a mouthwatering breast of guinea fowl and truffles with girolles and a millefeuille of potatoes. Served on a pretty patio in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2169%20quartier%20Narbonne%2C%20Montauroux%2C%2083440%2C%20France"
    pageTitle="Le Carré d'Ange"
  />
);

export default LeCarrDange;
