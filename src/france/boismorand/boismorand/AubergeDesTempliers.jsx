...
const AubergeDesTempliers = () => (
  <RestaurantPage
    restaurantName="Auberge des Templiers"
    address="20 route Départementale 2007, Boismorand, 45290, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33238318001"
    website="https://www.lestempliers.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Some things never go out of fashion… This quintessential Sologne posthouse with a half-timbered, pink brick façade and stone walls that date back to the 17C, boasts former guests of the likes of none other than Mistinguett and Maurice Chevalier. Take a seat in this timeless setting, depicted by massive oak beams, Gien earthenware and crystal glassware and admire the grounds planted with century-old trees. The enticingly entitled concise menu and tasting menu mingle classical roots with a hint of modernity. While seafood is a firm fixture (splendid tartare of red mullet in a gutsy jus), the chef avows a weakness for red meat and game in particular. A former sauce chef, he coats his pressed duck in an intense sauce, spiked with pear and zest of confit bergamot. The wine cellar, home to some ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20route%20D%C3%A9partementale%202007%2C%20Boismorand%2C%2045290%2C%20France"
    pageTitle="Auberge des Templiers"
  />
);

export default AubergeDesTempliers;
