...
const LeBistrotDuChteauDeBerne = () => (
  <RestaurantPage
    ...
    pageTitle="Le Bistrot du Château de Berne"
  />
);

export default LeBistrotDuChteauDeBerne;
