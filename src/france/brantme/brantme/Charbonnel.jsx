...
const Charbonnel = () => (
  <RestaurantPage
    restaurantName="Charbonnel"
    address="57 rue Gambetta, Brantôme, 24310, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33553057015"
    website="https://www.hotelrestaurantcharbonnel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This emblematic inn stands in the heart of the picturesque village of Brantôme. Enticing seasonal cuisine made from painstakingly sourced produce and scattered with Asian notes is served in a cosily comfortable dining room, which leads onto an enchanting terrace overlooking the River Dronne...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20rue%20Gambetta%2C%20Brant%C3%B4me%2C%2024310%2C%20France"
    pageTitle="Charbonnel"
  />
);

export default Charbonnel;
