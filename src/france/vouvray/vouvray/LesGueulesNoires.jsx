...
const LesGueulesNoires = () => (
  <RestaurantPage
    restaurantName="Les Gueules Noires"
    address="66 rue de la Vallée-Coquette, Vouvray, 37210, France"
    cuisine="Traditional Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33247526218"
    website="https://gueulenoirevouvray.wixsite.com/les-gueules-noires"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The troglodyte dining room, wood burning fire in winter and the terrace shaded by a wisteria in fine weather are just a few of the discreet appeals of this charming establishment. The cuisine is tasty and wholesome, based on local produce and served with Loire wines. Booking advisable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20rue%20de%20la%20Vall%C3%A9e-Coquette%2C%20Vouvray%2C%2037210%2C%20France"
    pageTitle="Les Gueules Noires"
  />
);

export default LesGueulesNoires;
