...
const VillaMarinette = () => (
  <RestaurantPage
    restaurantName="Villa Marinette"
    address="20 avenue du Général-de-Gaulle, Gazeran, 78125, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33134831901"
    website="https://www.villamarinette.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former inn has a modern interior, completely redesigned in black and yellow tones, with light parquet flooring and plant motifs; in the pretty enclosed garden the pleasant terrace remains. The contemporary food is devised to reflect the seasons by a young chef who respects the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Gazeran%2C%2078125%2C%20France"
    pageTitle="Villa Marinette"
  />
);

export default VillaMarinette;
