...
const GrandHtelDeSolesmes = () => (
  <RestaurantPage
    restaurantName="Grand Hôtel de Solesmes"
    address="16 place Dom-Guéranger, Solesmes, 72300, France"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+33243954510"
    website="https://www.grandhotelsolesmes.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="White asparagus, hollandaise sauce; slow-cooked egg, artichoke emulsion; saddle of lamb, chickpea purée and, above all, the excellent Cointreau hot soufflé… A reliable family-run establishment that defies its age and serves delicate, classic cuisine that immediately wins diners over; no corners are cut when it comes to the quality of the ingredients. What's more, the welcome and service are charming and do justice to this former coaching inn, which, in the 19C, welcomed the monks of the nearby Benedictine abbey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20place%20Dom-Gu%C3%A9ranger%2C%20Solesmes%2C%2072300%2C%20France"
    pageTitle="Grand Hôtel de Solesmes"
  />
);

export default GrandHtelDeSolesmes;
