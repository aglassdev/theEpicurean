...
const EnCouleur = () => (
  <RestaurantPage
    restaurantName="Ô en Couleur"
    address="9 rue de Beaugency, Oucques, 41290, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33254232041"
    website="https://www.o-en-couleur-oucques.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the colourful, contemporary interior with its large glass façade, or on the terrace in the leafy garden, tuck into the chef's well-crafted dishes concocted with the finest ingredients. Gribiche-style head cheese, pan-fried beef and crumbled offal, small pot of cream and a madeleine… Appealing to the palate, it's also easy on the wallet. Comfortable and colourful guestrooms are available, should you wish to prolong your stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20de%20Beaugency%2C%20Oucques%2C%2041290%2C%20France"
    pageTitle="Ô en Couleur"
  />
);

export default EnCouleur;
