...
const AubergeDeLaMarine = () => (
  <RestaurantPage
    restaurantName="Auberge de la Marine"
    address="1 rue Florentin-Lefils, Le Crotoy, 80550, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33322279244"
    website="https://www.aubergedelamarine.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a small regional-style building near the docks, this young couple beautifully showcases local ingredients. Example dishes include pressed sea bass with sand carrots, chervil sorbet; fillet of hake, beurre blanc with sea aster, mashed sandy potatoes; baba with a citrus syrup, cream with lemon balm… Tasty and expertly executed cuisine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Florentin-Lefils%2C%20Le%20Crotoy%2C%2080550%2C%20France"
    pageTitle="Auberge de la Marine"
  />
);

export default AubergeDeLaMarine;
