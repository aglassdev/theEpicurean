...
const LaBelleToile = () => (
  <RestaurantPage
    restaurantName="La Belle Étoile"
    address="285 promenade de la Batellerie (Le Bourg), La Roque-Gageac, 24250, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33553295144"
    website="https://hotel-belle-etoile-dordogne.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=285%20promenade%20de%20la%20Batellerie%20(Le%20Bourg)%2C%20La%20Roque-Gageac%2C%2024250%2C%20France"
    pageTitle="La Belle Étoile"
  />
);

export default LaBelleToile;
