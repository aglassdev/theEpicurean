...
const VillaSaintantoine = () => (
  <RestaurantPage
    restaurantName="Villa Saint-Antoine"
    address="8 rue Saint-Antoine, Clisson, 44190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33240854646"
    website="https://www.hotel-villa-saint-antoine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a former textile mill on the banks of the Sèvre Nantaise, diners can enjoy a smart brasserie interior (red velvour banquette seating, bay windows) and the chef's delicious repertoire of dishes, which are full of flavour and lovingly prepared. Last but not least, service courtesy of a young and dynamic team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Saint-Antoine%2C%20Clisson%2C%2044190%2C%20France"
    pageTitle="Villa Saint-Antoine"
  />
);

export default VillaSaintantoine;
