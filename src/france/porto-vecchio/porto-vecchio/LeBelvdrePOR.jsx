...
const LeBelvdrePOR = () => (
  <RestaurantPage
    restaurantName="Le Belvédère"
    address="Route de Palombaggia, Porto-Vecchio, 20137, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33495705413"
    website="https://www.hbcorsica.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tuck into ravioli with preserved lemon and a Greek yoghurt cream with coriander, while comfortably seated on the large waterside terrace in the shade of umbrella pines and palm trees overlooking Porto Vecchio's old town... What more could you ask for? Modern cuisine, top-notch ingredients and true technical prowess: the fennel-roasted meagre is precisely cooked and served with a delicious sauce. In the peace and quiet of this enclave, expect a feast for the eyes and a treat for the taste buds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Palombaggia%2C%20Porto-Vecchio%2C%2020137%2C%20France"
    pageTitle="Le Belvédère"
  />
);

export default LeBelvdrePOR;
