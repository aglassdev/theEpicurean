...
const Casadelmar = () => (
  <RestaurantPage
    restaurantName="Casadelmar"
    address="Route de Palombaggia, Porto-Vecchio, 20137, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33495723434"
    website="https://www.casadelmar.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Here in Porto Vecchio, everything revolves around the sea. The ancient Genoese city fought off the onslaught of barbarian invasions and is a symbol of pride for Corsicans. Another source of pride is this restaurant: a mecca for lovers of seafood. Don't be distracted by the enchanting view of the bay, nor by the location of this superb hotel – it is on the plate that the most remarkable things happen! Chef Fabio Bragagnolo's cooking is inspired by both Corsica and Italy, as can be seen in his John Dory confit in olive oil with red lentils, burrata and tomato water emulsion. Masterful from start to finish, the meal culminates in delicate low-sugar desserts, such as his composition with raspberries and Corsican pomelo, juniper ganache and rose-scented geranium...."
    ...
    pageTitle="Casadelmar"
  />
);

export default Casadelmar;
