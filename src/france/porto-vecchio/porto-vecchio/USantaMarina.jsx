...
const USantaMarina = () => (
  <RestaurantPage
    restaurantName="U Santa Marina"
    address="Marina di Santa-Giulia, Porto-Vecchio, 20137, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33495704500"
    website="https://usantamarina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Idyllically located on the seafront, the view of the Gulf of Santa Giulia is superb, and, come evening, the sunset is to die for! The flavoursome score shines the spotlight on local produce: green asparagus and vuletta, seasoning of Corsican fruit, parmesan and nasturtiums; locally-caught, barbecued langoustine, medley of artichokes and a meaty gravy; rum and lime baba… The quintessence of romantic fine dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marina%20di%20Santa-Giulia%2C%20Porto-Vecchio%2C%2020137%2C%20France"
    pageTitle="U Santa Marina"
  />
);

export default USantaMarina;
