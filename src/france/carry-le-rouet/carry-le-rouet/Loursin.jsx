...
const Loursin = () => (
  <RestaurantPage
    restaurantName="L'Oursin"
    address="Hôtel Bleu, 1 boulevard des Moulins, Carry-le-Rouet, 13620, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33451680000"
    website="https://www.hotelbleucarry.com/fr/restaurant-et-bar.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located within a hotel overlooking the port of Carry-le-Rouet, this fine dining restaurant boasts stunning panoramic views of the sea and the Frioul archipelago. Beyond a gorgeous enamelled lava stone bar, diners drop anchor in a space done out in a maritime decor (shades of white and blue) with marble flooring. Chef Ilane Tinchant has a proven track record, having previously worked at Villa Madie and Sylvestre Wahid. The kitchen lovingly showcases the Mediterranean: first with seasonal produce, local bread and olive oil from Les Baux-de-Provence, but above all with a seafood-oriented menu featuring all manner of marine life. The chef's signature dish is a good example, exploring cuttlefish – textures, served confit in its ink, tempura and a cloud of garlic. The focus is on the sea, both w..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Bleu%2C%201%20boulevard%20des%20Moulins%2C%20Carry-le-Rouet%2C%2013620%2C%20France"
    pageTitle="L'Oursin"
  />
);

export default Loursin;
