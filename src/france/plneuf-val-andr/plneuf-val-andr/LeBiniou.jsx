...
const LeBiniou = () => (
  <RestaurantPage
    restaurantName="Le Biniou"
    address="121 rue Clemenceau, Pléneuf-Val-André, 22370, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33296722435"
    website="https://www.restaurant-lebiniou.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef finds his inspiration in deepest Brittany, illustrated by dishes such as crumbly buckwheat in butter and shallots, but is also open to other influences, as the loin of roast croaker, grenobloise seasoning and shellfish bisque illustrate. Well-crafted food, cheerful service, a digestible bill and only a few knots from the beach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20rue%20Clemenceau%2C%20Pl%C3%A9neuf-Val-Andr%C3%A9%2C%2022370%2C%20France"
    pageTitle="Le Biniou"
  />
);

export default LeBiniou;
