...
const LaRserve = () => (
  <RestaurantPage
    restaurantName="La Réserve"
    address="5 avenue Ney, Metz, 57000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33387171717"
    website="https://www.lareserve-metz.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the 16C former garrison food storeroom, nowadays the Citadelle hotel, Aurélien Person’s cooking demonstrates a gourmet streak paired with a generous nature: stone-bass tartare with fennel, mange-tout and preserved lemon ; seared scallops with chorizo and riso venere, fillet of beef with local bacon and carrots… A storeroom with plenty of surprises in store!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20avenue%20Ney%2C%20Metz%2C%2057000%2C%20France"
    pageTitle="La Réserve"
  />
);

export default LaRserve;
