...
const Derrire = () => (
  <RestaurantPage
    restaurantName="Derrière"
    address="17 rue de la Chèvre, Metz, 57000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33387662363"
    website="https://www.restaurant-derriere.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A great surprise! The chef carefully prepares his appealing dishes without ever giving in to the latest fads, and maintaining a deep respect for the ingredients, as in these calf’s sweetbreads, roasted in butter and served with morel mushrooms. The small dining room to the rear (which gives the restaurant its name) is nicely decorated; the service is relaxed. A delight from start to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20la%20Ch%C3%A8vre%2C%20Metz%2C%2057000%2C%20France"
    pageTitle="Derrière"
  />
);

export default Derrire;
