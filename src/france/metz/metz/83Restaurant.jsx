...
const EightThreeRestaurant = () => (
  <RestaurantPage
    restaurantName="83 Restaurant"
    address="83 rue Mazelle, Metz, 57000, France"
    cuisine="Italian, Provençal"
    priceRange="€€"
    phoneNumber="+33387752020"
    website="https://www.83restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A ten - minute walk from the Centre Pompidou - Metz, this pleasant restaurant showcases Italian food, through carefully selected ingredients (charcuterie, burrata, pasta, wild fish, purebred meats). And to accompany it all, a fine selection of Italin wines!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%20rue%20Mazelle%2C%20Metz%2C%2057000%2C%20France"
    pageTitle="83 Restaurant"
  />
);

export default EightThreeRestaurant;
