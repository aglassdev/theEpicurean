...
const Timila = () => (
  <RestaurantPage
    restaurantName="Timilìa"
    address="20 rue Vigne-Saint-Avold, Metz, 57000, France"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+33387636844"
    website="https://www.ristorante-timilia.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A charming little Italian restaurant run by a chef who hails from Lorraine but has Sicilian roots, and his Milanese partner. By no means fixated on the classic repertoire, the restaurant serves a tasting menu entitled Scoperta della Pasta, which showcases their house-made pasta. Much care goes into dishes that incorporate top-notch, at times premium ingredients, many imported from Italy: fusilli with Brescia caviar, barba di frate and Piedmont hazelnuts; monkfish tail ravioli with hollandaise sauce; tortellini di Bologna stuffed with mortadella and Parma ham, topped with a Parmesan emulsion. With its pared-back decor, just a handful of tables, dark parquet flooring, white walls and colourful Abstract paintings, the interior is both contemporary and intimate. Excellent selection of local wi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Vigne-Saint-Avold%2C%20Metz%2C%2057000%2C%20France"
    pageTitle="Timilìa"
  />
);

export default Timila;
