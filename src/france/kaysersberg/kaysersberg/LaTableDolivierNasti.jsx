...
const LaTableDolivierNasti = () => (
  <RestaurantPage
    restaurantName="La Table d'Olivier Nasti"
    address="9-13 rue du Général-de-Gaulle, Kaysersberg, 68240, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33389471017"
    website="https://www.lechambard.fr/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Ah, Kaysersberg! This small village on the Alsace wine route comes into view between two valleys – you can't miss the iconic red façade of Hotel Le Chambard, which houses La Table d'Olivier Nasti, Meilleur Ouvrier de France 2007. The chef's objective is to showcase the terroir and restore tradition in a series of creative, visually arresting, even playful dishes. To this end, no ingredients are off limits: game, morels from the Vosges, foie gras, truffles and even Arctic char. He has created a personal menu that takes the seasons into account and pays particular attention to sauces and decoctions. As for the wine, talented and enthusiastic sommelier Jean-Baptiste Klein is a mine of information. The Chambard's guestrooms are decorated in a chic, refined style, and let's not forget the gorge..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9-13%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Kaysersberg%2C%2068240%2C%20France"
    pageTitle="La Table d'Olivier Nasti"
  />
);

export default LaTableDolivierNasti;
