...
const LaVieilleForge = () => (
  <RestaurantPage
    restaurantName="La Vieille Forge"
    address="1 rue des Écoles, Kaysersberg, 68240, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33389471751"
    website="https://vieilleforge-kb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beyond the rustic façade of this charming 16C house, some lovely surprises lie in store: chef Laurine Gutleben's dishes give pride of place to fresh produce and free rein to creativity, for instance the scallops with light hollandaise, braised leeks and gomasio popcorn. Well-chosen wine list, particularly from Alsace but not only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20des%20%C3%89coles%2C%20Kaysersberg%2C%2068240%2C%20France"
    pageTitle="La Vieille Forge"
  />
);

export default LaVieilleForge;
