...
const Lorchide = () => (
  <RestaurantPage
    restaurantName="L'Orchidée"
    address="47 rue de la 1ère Armée-Française, Ensisheim, 68190, France"
    cuisine="Thai"
    priceRange="€€€€"
    phoneNumber="+33389282020"
    website="https://www.hotelrestaurant-lorchidee.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a revamped interior, this orchid invites us on mouthwatering, gourmet journey. The modern, scrupulously crafted Thai cuisine is elegant and perfumed, illustrated by a tom yam of blue lobster, coconut milk and galanga or Vosges squab, served with sweetcorn, girolles mushrooms, polenta and red curry. Delicious from start to finish and a phenomenal success story...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20rue%20de%20la%201%C3%A8re%20Arm%C3%A9e-Fran%C3%A7aise%2C%20Ensisheim%2C%2068190%2C%20France"
    pageTitle="L'Orchidée"
  />
);

export default Lorchide;
