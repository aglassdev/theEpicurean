...
const LaTableDeCdricBchadeLaubergeBasque = () => (
  <RestaurantPage
    restaurantName="La Table de Cédric Béchade - L'Auberge Basque"
    address="745 vieille route de Saint-Pée - quartier Helbarron, Saint-Pée-sur-Nivelle, 64310, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33559517000"
    website="https://www.aubergebasque.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=745%20vieille%20route%20de%20Saint-P%C3%A9e%20-%20quartier%20Helbarron%2C%20Saint-P%C3%A9e-sur-Nivelle%2C%2064310%2C%20France"
    pageTitle="La Table de Cédric Béchade - L'Auberge Basque"
  />
);

export default LaTableDeCdricBchadeLaubergeBasque;
