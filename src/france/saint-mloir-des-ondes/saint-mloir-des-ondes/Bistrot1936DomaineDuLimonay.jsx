...
const Bistrot1936DomaineDuLimonay = () => (
  <RestaurantPage
    ...
    pageTitle="Bistrot 1936 - Domaine du Limonay"
  />
);

export default Bistrot1936DomaineDuLimonay;
