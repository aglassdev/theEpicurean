...
const LeCoquillage = () => (
  <RestaurantPage
    restaurantName="Le Coquillage"
    address="Lieu-dit Le Buot, Saint-Méloir-des-Ondes, 35350, France"
    cuisine="Creative, Seafood"
    priceRange="€€€€"
    phoneNumber="+33299896476"
    website="https://www.maisons-de-bricourt.com/fr/page/le-coquillage"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A not-too-imposing and rather romantic manor house, a magical view of the bay of Mont-Saint-Michel... and a true culinary epic. After a first life in the merchant navy, Hugo Roellinger refined his kitchen craft with modesty; today, his menu At the whim of the wind and the moon is a poetic voyage which holds you breathless from start to finish and offers a particularly personal vision of Brittany. Here, seafood is magnified with fluidity, delicacy and a naturalness that is stunning, like these translucent langoustines in a morel tartlet, mead mousseline with “shadow powder”, a marvel of balance... or lobster in two ways, with its sauces of rare complexity. This is a cuisine that speaks with directness, although its apparent simplicity conceals an unrivalled subtlety in the harmony of flavou..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Le%20Buot%2C%20Saint-M%C3%A9loir-des-Ondes%2C%2035350%2C%20France"
    pageTitle="Le Coquillage"
  />
);

export default LeCoquillage;
