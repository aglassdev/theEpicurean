...
const LaGouesnireDomaineDuLimonay = () => (
  <RestaurantPage
    restaurantName="La Gouesnière - Domaine du Limonay"
    address="Lieu-dit Le Limonay, Saint-Méloir-des-Ondes, 35350, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33299891046"
    website="https://www.domaine-du-limonay.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hostelry founded in 1936 is a fine dining establishment whose delicate, creative recipes celebrate Brittany’s splendid produce: seafood from Saint Malo Bay, lamb from the salt marshes, buckwheat… A gourmet experience in every sense of the word, further enhanced by the chef’s inimitable flair for jus and sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Le%20Limonay%2C%20Saint-M%C3%A9loir-des-Ondes%2C%2035350%2C%20France"
    pageTitle="La Gouesnière - Domaine du Limonay"
  />
);

export default LaGouesnireDomaineDuLimonay;
