...
const EntreTerreEtMer = () => (
  <RestaurantPage
    restaurantName="Entre Terre et Mer"
    address="12/14 place Hamelin, Honfleur, 14600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231897060"
    website="https://www.entreterreetmer-honfleur.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%2F14%20place%20Hamelin%2C%20Honfleur%2C%2014600%2C%20France"
    pageTitle="Entre Terre et Mer"
  />
);

export default EntreTerreEtMer;
