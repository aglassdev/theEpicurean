...
const LeManoirDesImpressionnistes = () => (
  <RestaurantPage
    restaurantName="Le Manoir des Impressionnistes"
    address="23 route de Trouville, Honfleur, 14600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231816300"
    website="https://www.manoirdesimpressionnistes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Settle in at your table, in the bright dining room or on sunny days head for the terrace to enjoy the lovely view of the estuary. Savour the modern cuisine, centred on a short and appetising seasonal menu that gives top billing to Normandy's produce from land and sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20route%20de%20Trouville%2C%20Honfleur%2C%2014600%2C%20France"
    pageTitle="Le Manoir des Impressionnistes"
  />
);

export default LeManoirDesImpressionnistes;
