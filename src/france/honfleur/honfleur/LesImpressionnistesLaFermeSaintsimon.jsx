...
const LesImpressionnistesLaFermeSaintsimon = () => (
  <RestaurantPage
    restaurantName="Les Impressionnistes - La Ferme Saint-Siméon"
    address="20 rue Adolphe-Marais, Honfleur, 14600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33231817800"
    website="https://fermesaintsimeon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in the luxury Ferme Saint Siméon Hotel, a historic hamlet in the upper reaches of Honfleur, this property is the quintessence of stylish. The plush elegant Normandy-style interior, the wooded grounds and the terrace with a superb view of the Seine Estuary may be absolutely enchanting, but not enough to distract us from the matter at hand! The chef creates seasonal contemporary cuisine that draws on top-notch Normandy produce. The estate is also home to the half-timbered, thatched roof La Boucane bistro, which serves equally tasty, but more traditional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Adolphe-Marais%2C%20Honfleur%2C%2014600%2C%20France"
    pageTitle="Les Impressionnistes - La Ferme Saint-Siméon"
  />
);

export default LesImpressionnistesLaFermeSaintsimon;
