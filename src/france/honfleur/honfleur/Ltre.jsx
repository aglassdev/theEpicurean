...
const Ltre = () => (
  <RestaurantPage
    restaurantName="L'Âtre"
    address="25 cours des Fossés, Honfleur, 14600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231883082"
    website="https://restaurant-atre.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After stints at some prestigious Michelin-starred establishments in Paris, then at Château Cordeillan-Bages in Pauillac, chef Julien Lefebvre, who hails from Normandy, set up shop a few years ago in this charming medieval town. His cooking is both in step with the seasons and very much in the spirit of the times. Open kitchens giving onto a dining space with contemporary decor or a terrace for sunny days...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20cours%20des%20Foss%C3%A9s%2C%20Honfleur%2C%2014600%2C%20France"
    pageTitle="L'Âtre"
  />
);
