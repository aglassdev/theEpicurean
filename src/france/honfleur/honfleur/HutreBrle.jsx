...
const HutreBrle = () => (
  <RestaurantPage
    restaurantName="Huître Brûlée"
    address="8 rue Brûlée, Honfleur, 14600, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+33982579018"
    website="https://www.huitrebrulee.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Br%C3%BBl%C3%A9e%2C%20Honfleur%2C%2014600%2C%20France"
    pageTitle="Huître Brûlée"
  />
);

export default HutreBrle;
