...
const Logustin = () => (
  <RestaurantPage
    restaurantName="L'Ogustin"
    address="2 place de l'Ormeau, La Vacquerie-et-Saint-Martin-de-Castries, 34520, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33467951688"
    website="https://www.restaurantdularzac.com/l-ogustin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the Cirque de Navacelles, in a small village on the southern edge of the limestone plateau that is the Causse du Larzac, Pricillia Lebon's restaurant is housed in a converted inn. Beneath the stone vaults, the inviting, cosy decor reflects the endearing personality of a chef who has come to this beautiful, isolated setting to cook. The surprise set menu celebrates the Larzac area, with ingredients sourced mainly via short supply chains (not least from local market gardens), as well as from mushroom and plant picking. Plants reign supreme in the intuitive, light and aromatic dishes. The dessert is a tribute to the chef's Malgasy origins, with a sweet potato cream spiked with vanilla. Vegetarian options are also available. A unique and authentic place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20de%20l'Ormeau%2C%20La%20Vacquerie-et-Saint-Martin-de-Castries%2C%2034520%2C%20France"
    pageTitle="L'Ogustin"
  />
);

export default Logustin;
