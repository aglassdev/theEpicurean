...
const LeBnaton = () => (
  <RestaurantPage
    ...
    address="25 rue du Faubourg-Bretonnière, Beaune, 21200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380220026"
    website="https://www.lebenaton.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Burgundy, Beaune is known the world over for its annual charity wine auction held in the iconic Hospices edifice, famous for its glazed tile roof. A steadfast champion of fine French food and wine, Japanese chef Keishi Sugimura, couldn’t have found a town that suits him better. Trained in Japan, the chef excels in the art of the porkpie, which earned him the title of vice world champion in 2013. Flavoursome seasonal dishes sprinkled with creative touches...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20du%20Faubourg-Bretonni%C3%A8re%2C%20Beaune%2C%2021200%2C%20France"
    pageTitle="Le Bénaton"
  />
);

export default LeBnaton;
