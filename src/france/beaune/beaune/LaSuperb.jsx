...
const LaSuperb = () => (
  <RestaurantPage
    restaurantName="La Superb"
    address="15 rue d'Alsace, Beaune, 21200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33380226853"
    website="https://guide.michelin.com/en/bourgogne-franche-comte/beaune/restaurant/la-superb"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of the old town, this contemporary dining bar serves market-fresh dishes that are in tune with the seasons. Take a seat at the counter for views of the chef cooking fine mature meats or his tuna Rossini a la plancha, or alternatively in the small dining room with stone walls and glassed-in wine cellar, and prepare to enjoy tasty, no-frills cuisine. Bargain-price set menu at lunchtime!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20d'Alsace%2C%20Beaune%2C%2021200%2C%20France"
    pageTitle="La Superb"
  />
);

export default LaSuperb;
