...
const ClosDuCdre = () => (
  <RestaurantPage
    restaurantName="Clos du Cèdre"
    address="12 boulevard du Maréchal-Foch, Beaune, 21200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380240101"
    website="https://www.cedrebeaune.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This elegant winegrower's manor house with a plush feel and bags of character is set in a leafy garden where tables are laid out in summer... It's the perfect setting in which to sample Jordan Billan's cuisine, which is rooted in the terroir of Burgundy and showcases the carefully-chosen suppliers. The chef's taste for tradition – think matured Charolais beef, bone marrow and a mustard and tarragon jus – does not prevent him from dreaming up more creative dishes with international influences, such as sole cooked on the bone with shellfish, kasha risotto, seaweed and nashi. Guests will also appreciate the timeless charm of the classically styled guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20boulevard%20du%20Mar%C3%A9chal-Foch%2C%20Beaune%2C%2021200%2C%20France"
    pageTitle="Clos du Cèdre"
  />
);

export default ClosDuCdre;
