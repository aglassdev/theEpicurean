...
const EightClos = () => (
  <RestaurantPage
    restaurantName="8 Clos"
    address="8 rue d'Alsace, Beaune, 21200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33380210419"
    website="https://guide.michelin.com/en/bourgogne-franche-comte/beaune/restaurant/8-clos"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a long, narrow interior, where black leatherette benches meet exposed stone, Stéphane Léger, former Michelin-starred chef, regales us with his Burgundian cuisine and traditional dishes with a Mediterranean edge. Poached eggs in red wine sauce, braised ox cheek, ham and parsley terrine, snails, but also roast langoustine tails, baby potatoes and girolles mushrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20d'Alsace%2C%20Beaune%2C%2021200%2C%20France"
    pageTitle="8 Clos"
  />
);

export default EightClos;
