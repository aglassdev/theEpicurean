...
const MaCuisine = () => (
  <RestaurantPage
    ...
    address="Passage Sainte-Hélène, Beaune, 21200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33380223022"
    website="https://macuisinebeaune.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wine takes pride of place in this friendly bistro with an outstanding selection of some 800 different bottles. The chef certainly knows his way around them, and is equally at ease in the kitchen. Diners delight in his homemade jellied ham with parsley, veal chop in jus and crème caramel. The dishes will have you coming back for more...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Passage%20Sainte-H%C3%A9l%C3%A8ne%2C%20Beaune%2C%2021200%2C%20France"
