...
const LoiseauDesVignes = () => (
  <RestaurantPage
    restaurantName="Loiseau des Vignes"
    address="31 rue Maufoux, Beaune, 21200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33380241206"
    website="https://www.bernard-loiseau.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Bernard Loiseau stamped score and a chic bistro vibe (stone, wood and velvet-upholstered banquettes) paint this culinary portrait. The menu includes classics such as eggs in a red wine sauce, pâté en croûte, Charolais ox cheek and Saône catfish, without forgetting beautifully fresh Burgundy veal tartare with smoked eel. The splendid wine list also unveils a wide range of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20Maufoux%2C%20Beaune%2C%2021200%2C%20France"
    pageTitle="Loiseau des Vignes"
  />
);

export default LoiseauDesVignes;
