...
const AubergeDeGrilly = () => (
  <RestaurantPage
    restaurantName="Auberge de Grilly"
    address="34 ruelle de l'Église, Grilly, 01220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450202514"
    website="https://www.aubergedegrilly.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a charming village between Gex and Divonne, Auberge de Grilly stands close to the church. While the interior decor tends toward the rustic, the cuisine is modern, with dishes based on fine ingredients cleverly curated into just one generous tasting menu. Service with a smile, plus a pleasant terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20ruelle%20de%20l'%C3%89glise%2C%20Grilly%2C%2001220%2C%20France"
    pageTitle="Auberge de Grilly"
  />
);

export default AubergeDeGrilly;
