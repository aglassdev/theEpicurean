...
const MaisonLameloise = () => (
  <RestaurantPage
    restaurantName="Maison Lameloise"
    address="36 place d'Armes, Chagny, 71150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33385876565"
    website="https://www.lameloise.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It's impossible to sum up in just a few lines the story of this institution, whose star-studded career begun back in… 1926! Yet, Lameloise, whose interior features a string of warm, cosy dining rooms, each of which is appointed individually, is far from nostalgic. Éric Pras, former sous-chef to Jacques Lameloise, became head chef in 2009 when his mentor retired; as Éric puts it: Tradition is the future. Faithful to the venue’s founding spirit, as inspired as he is meticulous, Pras pays homage to Burgundy's terroir (snails, Bresse poultry, Charolais beef, Morvan hazelnut cazette) whilst keeping pace with his era and today’s tastes. They serve a fine selection of wines, especially by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20place%20d'Armes%2C%20Chagny%2C%2071150%2C%20France"
    pageTitle="Maison Lameloise"
  />
);

export default MaisonLameloise;
