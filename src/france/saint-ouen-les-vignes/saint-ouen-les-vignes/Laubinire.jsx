...
const Laubinire = () => (
  <RestaurantPage
    restaurantName="L'Aubinière"
    address="29 rue Jules-Gautier, Saint-Ouen-les-Vignes, 37530, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247301529"
    website="https://www.aubiniere.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive, contemporary dining space basks in the light of the windows that open out onto the wooded parkland. The seasonal cuisine never compromises on the quality of the ingredients (Richelieu asparagus, Mouliherne escargots, line-cut meagre etc) and the cellar is packed with regional wines: L'Aubinière restaurant has it all. There are also a number of elegant guestrooms, plus a wellness area...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Jules-Gautier%2C%20Saint-Ouen-les-Vignes%2C%2037530%2C%20France"
    pageTitle="L'Aubinière"
  />
);

export default Laubinire;
