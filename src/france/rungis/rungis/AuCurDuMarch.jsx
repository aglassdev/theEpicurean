...
const AuCurDuMarch = () => (
  <RestaurantPage
    restaurantName="Au Cœur du Marché"
    address="4 avenue de Bourgogne (Marché International de Rungis), Rungis, 94150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33185410501"
    website="https://alasource-als.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is housed in a contemporary building in the heart of the Marché de Rungis – the largest fresh produce market in the world – and is run by chef Nicolas Sale, who is no stranger to MICHELIN. Occupying the middle of the space is a large open kitchen surrounded by varnished oak tables and contemporary banquettes. The menu, dictated by the day's consignment, shows a penchant for putting a new spin on the classics: beef terrine with chanterelle pickles, pollock, vegetable casserole, mashed potatoes, mirabelle plum tart and buckwheat ice cream. The sharing dishes are generous and made on site...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20avenue%20de%20Bourgogne%20(March%C3%A9%20International%20de%20Rungis)%2C%20Rungis%2C%2094150%2C%20France"
    pageTitle="Au Cœur du Marché"
  />
);

export default AuCurDuMarch;
