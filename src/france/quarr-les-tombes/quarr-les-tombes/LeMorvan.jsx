...
const LeMorvan = () => (
  <RestaurantPage
    restaurantName="Le Morvan"
    address="6 rue des Écoles, Quarré-les-Tombes, 89630, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33386322929"
    website="https://www.le-morvan.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="How one imagines Sunday lunch in rural France: traditional, expertly crafted food that keeps pace with the seasons. In summer, relax in the flower-decked garden and soak up the sunshine. Beautifully located at the gate to the Morvan regional park...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%20%C3%89coles%2C%20Quarr%C3%A9-les-Tombes%2C%2089630%2C%20France"
    pageTitle="Le Morvan"
  />
);

export default LeMorvan;
