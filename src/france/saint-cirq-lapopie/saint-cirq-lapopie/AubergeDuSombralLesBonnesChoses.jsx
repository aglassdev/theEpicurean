...
const AubergeDuSombralLesBonnesChoses = () => (
  <RestaurantPage
    restaurantName="Auberge du Sombral - Les Bonnes Choses"
    address="Place du Sombral, Saint-Cirq-Lapopie, 46330, France"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33565312608"
    website="https://aubergelesombral.wordpress.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this house at the foot of the Château des Lapopie, you can be sure that good things – Les Bonnes Choses – are to come! Enjoy the pleasant cuisine du terroir, in which local ingredients are the star (lamb, foie gras, cheese... ). There are a handful of pretty guestrooms, if you wish to stay on in this village overlooking the Lot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Sombral%2C%20Saint-Cirq-Lapopie%2C%2046330%2C%20France"
    pageTitle="Auberge du Sombral - Les Bonnes Choses"
  />
);

export default AubergeDuSombralLesBonnesChoses;
