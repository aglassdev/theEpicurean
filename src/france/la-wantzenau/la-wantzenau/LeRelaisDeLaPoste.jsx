...
const LeRelaisDeLaPoste = () => (
  <RestaurantPage
    restaurantName="Le Relais de la Poste"
    address="21 rue du Général-de-Gaulle, La Wantzenau, 67610, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33388592480"
    website="https://www.relais-poste.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This venerable institution (est. 1789) is far from nostalgic as its refurbished, stylish dining room, dotted in contemporary details, and the conservatory leading out onto a patio, illustrate. The food, also free of culinary cobwebs, is fiendishly tailored to modern tastebuds: crispy scallops with wild prawns, cauliflower and orange vinaigrette; squab pigeon, the breast lightly roasted, the thigh confit in fleischnacka… Slick professional service and knockout wine cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20La%20Wantzenau%2C%2067610%2C%20France"
    pageTitle="Le Relais de la Poste"
  />
);

export default LeRelaisDeLaPoste;
