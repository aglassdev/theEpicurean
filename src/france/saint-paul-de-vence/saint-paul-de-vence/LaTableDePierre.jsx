...
const LaTableDePierre = () => (
  <RestaurantPage
    restaurantName="La Table de Pierre"
    address="Domaine du Mas de Pierre, 2320 route des Serres, Saint-Paul-de-Vence, 06570, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33493590010"
    website="https://www.lemasdepierre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Mas de Pierre has morphed into a sublime, intimate and luxurious resort... and La Table has followed suit. The pair of chefs cooks up modern and locavore Mediterranean cuisine, with subtle international influences. Perfectly cooked and seasoned, there is an overarching harmony to it all: very nicely done...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20du%20Mas%20de%20Pierre%2C%202320%20route%20des%20Serres%2C%20Saint-Paul-de-Vence%2C%2006570%2C%20France"
    pageTitle="La Table de Pierre"
  />
);

export default LaTableDePierre;
