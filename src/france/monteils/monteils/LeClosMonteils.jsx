...
const LeClosMonteils = () => (
  <RestaurantPage
    restaurantName="Le Clos Monteils"
    address="7 chemin du Moulin, Monteils, 82300, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33563930351"
    website="https://www.leclosmonteils.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Françoise and Bernard Bordaries turned this 1771 presbytery into an intimate restaurant that feels like a family home. She extends a genial welcome, while he cracks on with the cooking. He builds dishes on simple foundations to highlight seasonal ingredients in well-crafted recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20chemin%20du%20Moulin%2C%20Monteils%2C%2082300%2C%20France"
    pageTitle="Le Clos Monteils"
  />
);

export default LeClosMonteils;
