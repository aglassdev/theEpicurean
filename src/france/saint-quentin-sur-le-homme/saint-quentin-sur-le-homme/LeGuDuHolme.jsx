...
const LeGuDuHolme = () => (
  <RestaurantPage
    restaurantName="Le Gué du Holme"
    address="14 rue des Estuaires, Saint-Quentin-sur-le-Homme, 50220, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33233606376"
    website="https://le-gue-du-holme.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just opposite the church, in the centre of the village, this house built out of regional stone and its stylish dining room are the picture of hospitality. The seasoned chef showcases the best of seasonal and regional produce: slices of andouille from Vire with apples and camembert; breast of guinea fowl, apple sauce and Crêpes suzette, flambéed in front of you. Pleasant guestrooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20des%20Estuaires%2C%20Saint-Quentin-sur-le-Homme%2C%2050220%2C%20France"
    pageTitle="Le Gué du Holme"
  />
);

export default LeGuDuHolme;
