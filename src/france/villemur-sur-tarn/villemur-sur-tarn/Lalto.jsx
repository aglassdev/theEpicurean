...
const Lalto = () => (
  <RestaurantPage
    restaurantName="L'Alto"
    address="980 chemin de Pellausy, Villemur-sur-Tarn, 31340, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33562223550"
    website="https://www.restaurantalto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this pretty pink-brick château tucked away in the countryside, the kitchen uses only high-quality ingredients with a renewed look at local produce. Highly contrasted flavours, like this fillet of wild seabass with shellfish and a rhubarb emulsion… L’Alto orchestrates a fine-tuned culinary score and an equally musical interior, with a sculpture of a saxophone and a swimming pool in the shape of a violin!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=980%20chemin%20de%20Pellausy%2C%20Villemur-sur-Tarn%2C%2031340%2C%20France"
    pageTitle="L'Alto"
  />
);

export default Lalto;
