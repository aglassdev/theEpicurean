...
const O2c = () => (
  <RestaurantPage
    restaurantName="O2C"
    address="20 place de Strasbourg, Bagnères-de-Bigorre, 65200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33952719258"
    website="https://o2c-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A former helicopter pilot who now devotes himself body and soul to cooking, Christophe Bellegaud is at the controls of this restaurant, which sports a tasteful cream and chocolate colour scheme. He uses local ingredients to create 100% homemade up-to-the-minute market cuisine that is always spot on. Chantal, the second “c” of this o2c, gracefully caters to diner’s needs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20place%20de%20Strasbourg%2C%20Bagn%C3%A8res-de-Bigorre%2C%2065200%2C%20France"
    pageTitle="O2C"
  />
);
