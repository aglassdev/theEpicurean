...
const Moutonbenoit = () => (
  <RestaurantPage
    restaurantName="Mouton-Benoit"
    address="1167 route de Beaucaire, Loire-sur-Rhône, 69700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33698941212"
    website="https://www.restaurant-moutonbenoit.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This roadside establishment founded in 1822 was once home to the Mères Dumas' stoves. In winter you can enjoy the chef's speciality: lièvre à la royale, prepared according to the recipe immortalised by Senator Couteaux more than a century ago! Round off your meal with one of the delicious desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1167%20route%20de%20Beaucaire%2C%20Loire-sur-Rh%C3%B4ne%2C%2069700%2C%20France"
    pageTitle="Mouton-Benoit"
  />
);

export default Moutonbenoit;
