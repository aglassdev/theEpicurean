...
const LeMoulinBabet = () => (
  <RestaurantPage
    restaurantName="Le Moulin Babet"
    address="8 rue du Moulin-Babet, Mézy-Moulins, 02650, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33323714472"
    website="https://www.lemoulinbabet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The only neighbours of this old stone - built watermill (19C) are the greenery and the Surmelin, an affluent of the Marne. The interior decor is on the modern, pared - down side, with a light wood ceiling and designer chairs; the traditional cuisine smacks of all things bucolic. And in the guestrooms, you could hear a pin drop...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20du%20Moulin-Babet%2C%20M%C3%A9zy-Moulins%2C%2002650%2C%20France"
    pageTitle="Le Moulin Babet"
  />
);

export default LeMoulinBabet;
