...
const AuMarquisDeTerme = () => (
  <RestaurantPage
    restaurantName="Au Marquis de Terme"
    address="3 route de Rauzan, Margaux, 33460, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33557082533"
    website="https://au-marquis-de-terme.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Surrounded by the Médoc vineyards, this contemporary restaurant is nestled in an outbuilding of the Château Marquis de Terme (a Grand Cru classified in 1855). It boasts a terrace that opens out onto the estate's pretty garden courtyard. Under the stewardship of Grégory Coutanceau, who devised the menu, chef Thibaud Guena welcomes his guests with fresh, modern cuisine that is very much of its time and shuns unnecessary frills. The appealing wine list features almost 600 labels, including a selection of Bordeaux reds and prestige wines available by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20route%20de%20Rauzan%2C%20Margaux%2C%2033460%2C%20France"
    pageTitle="Au Marquis de Terme"
  />
);

export default AuMarquisDeTerme;
