...
const LeCollet = () => (
  <RestaurantPage
    restaurantName="Le Collet"
    address="9937 route de Colmar, Col de la Schlucht, 88400, France"
    cuisine="Modern Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+33329600957"
    website="https://chalethotel-lecollet.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Instinctive, last-minute” regional dishes, rustled up by a seasoned veteran who has trained many a local chef. In a picture postcard swish Alpine chalet décor, each dish celebrates and pays tribute to authentic regional produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9937%20route%20de%20Colmar%2C%20Col%20de%20la%20Schlucht%2C%2088400%2C%20France"
    pageTitle="Le Collet"
  />
);

export default LeCollet;
