...
const LesAviss = () => (
  <RestaurantPage
    restaurantName="Les Avisés"
    address="59 rue de Cramant, Avize, 51190, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33326577006"
    website="https://www.selosse-lesavises.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You would be well advised to stop off at the Selosse family estate. Both having worked for Anne - Sophie Pic, Stéphane Rossillon (in the kitchen) and his wife (front of house) create a single set menu based on choice ingredients. Served in a charming guesthouse atmosphere; when the sun is out you can enjoy the large terrace. Superb wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%20rue%20de%20Cramant%2C%20Avize%2C%2051190%2C%20France"
    pageTitle="Les Avisés"
  />
);

export default LesAviss;
