...
const Hautlinage = () => (
  <RestaurantPage
    restaurantName="Haut-Linage"
    address="Place du Maréchal-Davout, Penmarc'h, 29760, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33298907738"
    website="https://hautlinage-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from Eckmühl Lighthouse, this restaurant boasts a contemporary interior done out in shades of white, grey and gold. The couple at the helm are Breton born and bred and their easy charm sets the tone: chef Corentin Ogor and the ebullient Klervi Tanniou, who manages the restaurant floor with a broad smile. When it comes to the refined modern cuisine, each dish centres on a fresh ingredient cooked to perfection and matched with a sauce or jus, eg butternut squash, scallops from Finistère and a roasted almond emulsion; fish caught by small boats, spinach pesto and shellfish. In the evening, the food is more ambitious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Mar%C3%A9chal-Davout%2C%20Penmarc'h%2C%2029760%2C%20France"
    pageTitle="Haut-Linage"
  />
);

export default Hautlinage;
