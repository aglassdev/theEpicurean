...
const Domus = () => (
  <RestaurantPage
    restaurantName="Domus"
    address="2 rue des Vignes-d'en-Haut, Mont-près-Chambord, 41250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254740253"
    website="https://domusrestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Domus (Latin for home) is presided over by a dream team of two chefs and a front-of-house manager who earned their stripes in star restaurants and upmarket bistros (the chefs met at La Table du Connétable in Chantilly). They take full advantage of seasonal ingredients and produce from Sologne to concoct an intriguing programme: semi-cooked foie gras, mushroom seasoning; smoked Sologne sturgeon, pickled kohlrabi; slow-baked cod, frothy tomato mousse and basil-flavoured roast courgette. When you now add sensible prices, you will quickly understand why it is often fully booked...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20des%20Vignes-d'en-Haut%2C%20Mont-pr%C3%A8s-Chambord%2C%2041250%2C%20France"
    pageTitle="Domus"
  />
);
