...
const AubergeDaillonEtDailleurs = () => (
  <RestaurantPage
    restaurantName="Auberge d’Aillon et d’Ailleurs"
    address="795 route de la Correrie, Aillon-le-Jeune, 73340, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33458390130"
    website="https://www.aillon-ailleurs.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Bauges Mountains, an unspoilt natural haven, this contemporary hotel has a lovely restaurant run by a young chef who has both technique and ideas. He throws himself into his work to get the best out of the Val d'Aillon terroir: vegetable garden, cooperative cheese, farm lamb, wild herbs... The menu changes regularly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=795%20route%20de%20la%20Correrie%2C%20Aillon-le-Jeune%2C%2073340%2C%20France"
    pageTitle="Auberge d’Aillon et d’Ailleurs"
  />
);

export default AubergeDaillonEtDailleurs;
