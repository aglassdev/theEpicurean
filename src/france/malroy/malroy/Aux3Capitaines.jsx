...
const Aux3Capitaines = () => (
  <RestaurantPage
    restaurantName="Aux 3 Capitaines"
    address="43 rue Principale, Malroy, 57640, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33387715576"
    website="http://www.aux-trois-capitaines.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a village on the banks of the Moselle, this local institution has been given a new lease of life by chef Benoit Potdevin (Le K - Domaine de la Klauss in Montenach). Either in the refurbished dining room or on the peaceful terrace to the rear, diners tuck into classic local dishes, lovingly prepared using carefully selected ingredients: eg asparagus with mousseline sauce, pike quenelle with a lemon-infused beurre blanc, free-range Moselle poultry with morels, braised ham with Auxerrois sauce and bouchée à la reine. The food is generous, indulgent and delicious – and served with a smile by Anaïs, who will recommend the best wines from the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20rue%20Principale%2C%20Malroy%2C%2057640%2C%20France"
    pageTitle="Aux 3 Capitaines"
  />
);

export default Aux3Capitaines;
