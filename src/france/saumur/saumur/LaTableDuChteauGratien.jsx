...
const LaTableDuChteauGratien = () => (
  <RestaurantPage
    restaurantName="La Table du Château Gratien"
    address="94 route de Montsoreau, Saumur, 49400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33787082905"
    website="https://www.restaurant-saumur-gratien.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the landscaped grounds of the Gratien and Meyer wine estate, this adorable late 19C château oozes character and cachet – herringbone parquet, glittering chandeliers and a fireplace. The cuisine deftly showcases the region's fine produce – white asparagus, black truffle and Val de Loire potatoes. Herbs from the garden, excellent home-made bread, warm madeleines served with coffee. A taste of the good life...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=94%20route%20de%20Montsoreau%2C%20Saumur%2C%2049400%2C%20France"
    pageTitle="La Table du Château Gratien"
  />
);

export default LaTableDuChteauGratien;
