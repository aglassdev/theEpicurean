...
const Ahizpak = () => (
  <RestaurantPage
    restaurantName="Ahizpak"
    address="Avenue de Biarritz, Bidart, 64210, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33559225881"
    website="https://restaurant-ahizpak.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the upper reaches of the beach of Erretegia, this former haunt of the Arangoits sisters (‘ahizpak’ in Basque) is idyllically located opposite the ocean. Delphine, now alone at the helm, and her chef David Cerisier have devised a concise, modern and eater-friendly priced menu that keeps step with the seasons. Generous, enticing food, served on the terrace in fine weather, examples of which are a chilled cream of green peas, carrot and lime oil; hanger steak, gratin of potatoes, coppa and comté and a decadent crêpe soufflée in orange and Grand Marnier to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20de%20Biarritz%2C%20Bidart%2C%2064210%2C%20France"
    pageTitle="Ahizpak"
  />
);

export default Ahizpak;
