...
const LaTableDesFrresIbarboure = () => (
  <RestaurantPage
    restaurantName="La Table des Frères Ibarboure"
    ...
    pageTitle="La Table des Frères Ibarboure"
  />
);

export default LaTableDesFrresIbarboure;
