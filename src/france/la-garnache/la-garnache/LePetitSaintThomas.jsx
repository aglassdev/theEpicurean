...
const LePetitSaintThomas = () => (
  <RestaurantPage
    restaurantName="Le Petit Saint Thomas"
    address="25 rue de Lattre de Tassigny, La Garnache, 85710, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251490599"
    website="https://www.lepetitsaintthomas.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This endearing family-run restaurant is popular with a crowd of locals. The chef, at the helm for over twenty years, painstakingly rustles up French staples, albeit with a tasty new twist and the odd hint of exoticism (curry, sobrassada, nori, mafé, coconut)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20de%20Lattre%20de%20Tassigny%2C%20La%20Garnache%2C%2085710%2C%20France"
    pageTitle="Le Petit Saint Thomas"
  />
);

export default LePetitSaintThomas;
