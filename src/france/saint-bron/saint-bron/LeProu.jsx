...
const LeProu = () => (
  <RestaurantPage
    restaurantName="Le Pérou"
    address="341 rue Jules-Ferry, Saint-Béron, 73520, France"
    cuisine="Peruvian"
    priceRange="€€"
    phoneNumber="+33476663505"
    website="https://www.restaurant-leperou.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pulpo anticuchero, lomo saltado, tiradito, arroz cremoso, and, of course, the indispensable ceviches: all the classics of Peruvian cooking are on the menu here in the Alps, thanks to a chef and her team, who all hail from Peru. Much of the produce is imported direct from the Andes, via Spain. Anyone who has been lucky enough to taste authentic South American food will be delighted by the incredible range of flavours and tastes of this cuisine rich in seasoning and unexpected ingredients on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=341%20rue%20Jules-Ferry%2C%20Saint-B%C3%A9ron%2C%2073520%2C%20France"
    pageTitle="Le Pérou"
  />
);

export default LeProu;
