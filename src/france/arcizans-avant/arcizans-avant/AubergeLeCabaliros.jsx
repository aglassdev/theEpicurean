...
const AubergeLeCabaliros = () => (
  <RestaurantPage
    restaurantName="Auberge Le Cabaliros"
    address="16 rue de l'Église, Arcizans-Avant, 65400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33562970431"
    website="https://www.auberge-cabaliros.com/la-table"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant village inn halfway between two famous passes – Col d'Aubisque and Col du Tourmalet – stands surrounded by the peaks of the Pyrenees. The menu features wonderful traditional dishes that are big on flavour and nicely presented: noir de Bigorre black pork loin, braised sweetbreads, Pyrenean trout. Pretty little guestrooms available!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20de%20l'%C3%89glise%2C%20Arcizans-Avant%2C%2065400%2C%20France"
    pageTitle="Auberge Le Cabaliros"
  />
);

export default AubergeLeCabaliros;
