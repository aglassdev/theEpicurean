...
const Zest = () => (
  <RestaurantPage
    restaurantName="Zest"
    address="32 cours de la Vilaine, Cesson-Sévigné, 35510, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299838206"
    website="https://www.restaurant-zest.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The secret behind the Zest’s success is market-fresh cooking, original recipes dusted with exotic notes, spices and seasonings, a delightfully friendly vibe and in summertime, a riverside patio on the banks of the Vilaine. Slick service with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20cours%20de%20la%20Vilaine%2C%20Cesson-S%C3%A9vign%C3%A9%2C%2035510%2C%20France"
    pageTitle="Zest"
  />
);
