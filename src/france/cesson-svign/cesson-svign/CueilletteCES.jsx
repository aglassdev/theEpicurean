...
const CueilletteCES = () => (
  <RestaurantPage
    restaurantName="Cueillette"
    address="54 route de Fougères, Cesson-Sévigné, 35510, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299620013"
    website="https://www.cueilletterestaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small establishment tucked away in the suburbs of Rennes, an attractive façade, a contemporary interior, a covered terrace overlooking the fields, and a charming welcome. As for the food, the chef has got it spot on: competent, pared-back dishes that are full of finesse, with judicious combinations and precise seasoning. Rich pickings at this lovely place outside of the centre...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20route%20de%20Foug%C3%A8res%2C%20Cesson-S%C3%A9vign%C3%A9%2C%2035510%2C%20France"
    pageTitle="Cueillette"
  />
);

export default CueilletteCES;
