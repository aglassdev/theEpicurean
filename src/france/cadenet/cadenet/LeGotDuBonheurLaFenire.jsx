...
const LeGotDuBonheurLaFenire = () => (
  <RestaurantPage
    restaurantName="Le Goût du Bonheur - La Fenière"
    address="1680 route de Lourmarin, Cadenet, 84160, France"
    cuisine="Creative, Farm to table"
    priceRange="€€€€"
    phoneNumber="+33490681179"
    website="https://www.aubergelafeniere.com/"
    ...
    pageTitle="Le Goût du Bonheur - La Fenière"
  />
);

export default LeGotDuBonheurLaFenire;
