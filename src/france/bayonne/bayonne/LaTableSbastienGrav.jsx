...
const LaTableSbastienGrav = () => (
  <RestaurantPage
    restaurantName="La Table - Sébastien Gravé"
    address="21 quai Amiral-Dubourdieu, Bayonne, 64100, France"
    cuisine="Farm to table, Cuisine from South West France"
    priceRange="€€"
    phoneNumber="+33559461494"
    website="https://latable-sebastiengrave.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After the success of Pottoka in Paris, the chef, a key figure on the Bayonne bistronomy scene, is back on his home turf. All smiles behind the stove, he prepares dishes inspired by the best produce South-West France has to offer, including natural hake from Saint-Jean-de-Luz, marinated and charred mackerel and Ibaïma pork shoulder. You can eat at the zinc-topped counter, at the large table d'hôtes with friends or in the kitchen (there is a table for two, for a more immersive experience). An inviting restaurant with a convivial atmosphere!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20quai%20Amiral-Dubourdieu%2C%20Bayonne%2C%2064100%2C%20France"
    pageTitle="La Table - Sébastien Gravé"
  />
);

export default LaTableSbastienGrav;
