...
const AubergeDuChevalBlanc = () => (
  <RestaurantPage
    restaurantName="Auberge du Cheval Blanc"
    address="68 rue Bourgneuf, Bayonne, 64100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33559590133"
    website="http://www.cheval-blanc-bayonne.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 18C coaching inn has been run by the same family since 1959. Chef Jean-Claude Tellechea adds a new spin to the traditional regional line-up: crispy hake, black pudding, Ibaïama ham, Bayonne chocolate. The interior is patriotically decked in red and white Basque Country colours. The range of menus is such that there is something for every budget...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20rue%20Bourgneuf%2C%20Bayonne%2C%2064100%2C%20France"
    pageTitle="Auberge du Cheval Blanc"
  />
);

export default AubergeDuChevalBlanc;
