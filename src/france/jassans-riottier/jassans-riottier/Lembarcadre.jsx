...
const Lembarcadre = () => (
  <RestaurantPage
    restaurantName="L'Embarcadère"
    address="15 avenue de la Plage, Jassans-Riottier, 01480, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33474070707"
    website="https://l-embarcadere.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Georges Blanc's new restaurant, on the banks of the Saône, is a cross between a chic guinguette and a contemporary brasserie. The food is traditional but trendy with dishes like frogs' legs, poached free - range egg with whiting, and Bresse chicken...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20avenue%20de%20la%20Plage%2C%20Jassans-Riottier%2C%2001480%2C%20France"
    pageTitle="L'Embarcadère"
  />
);

export default Lembarcadre;
