...
const LeClosDeLaPrairie = () => (
  <RestaurantPage
    restaurantName="Le Clos de la Prairie"
    address="17 rue de Saint-Rémy, Gouy-Saint-André, 62870, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33321903958"
    website="https://www.leclosdelaprairie.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the countryside, this charming restaurant is peaceful and bucolic. Behind his stove, the chef masterfully prepares dishes in tune with the zeitgeist and the seasons. In summer, enjoy the quiet terrace overlooking the meadow. Accessible only by reservation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20Saint-R%C3%A9my%2C%20Gouy-Saint-Andr%C3%A9%2C%2062870%2C%20France"
    pageTitle="Le Clos de la Prairie"
  />
);

export default LeClosDeLaPrairie;
