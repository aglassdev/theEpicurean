...
const Ltoile = () => (
  <RestaurantPage
    restaurantName="À l'Étoile"
    address="7 place de l'Étoile, Klingenthal, 67530, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33388958290"
    website="https://restaurantaletoile.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a small Alsace village on the Mont Sainte Odile road, this traditional hostelry, opened in 1920, is today run by the fourth generation. A warm welcome and honest, homely recipes, starring market-fresh produce and a slate menu. For example, start with a waffle piled high with smoked salmon and citrus fruit, while offal fans won’t be able to resist the fried kidneys and sweetbread...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20de%20l'%C3%89toile%2C%20Klingenthal%2C%2067530%2C%20France"
    pageTitle="À l'Étoile"
  />
);

export default Ltoile;
