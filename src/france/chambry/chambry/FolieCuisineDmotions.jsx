...
const FolieCuisineDmotions = () => (
  <RestaurantPage
    restaurantName="Folie Cuisine d'Émotions"
    address="23 rue Bonivard, Chambéry, 73000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33485860365"
    website="https://restaurant-folie.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a heritage edifice in the heart of historic Chambéry, not far from the Château des Ducs de Savoie, indulge yourself(ves) in this establishment, set in the former courtyard of what is now a luxury hotel. In a suitably classy yet cosy setting, the chef crafts a “carte blanche” menu inspired by the seasons and travel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20Bonivard%2C%20Chamb%C3%A9ry%2C%2073000%2C%20France"
    pageTitle="Folie Cuisine d'Émotions"
  />
);

export default FolieCuisineDmotions;
