...
const CarrDesSens = () => (
  <RestaurantPage
    restaurantName="Carré des Sens"
    address="32 place Monge, Chambéry, 73000, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33479659807"
    website="https://carre-des-sens.eatbu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a pretty spot on one of the city's central squares, this building is the stomping ground of a chef who revisits classics from French tradition with passion and precision: boiled egg, fricassee of chanterelles and parsley emulsion; chuck of beef cooked at a low temperature, potato galette and truffle jus; hot soufflé with Grand Marnier – quality ingredients go into these delicious and carefully executed dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20place%20Monge%2C%20Chamb%C3%A9ry%2C%2073000%2C%20France"
    pageTitle="Carré des Sens"
  />
);

export default CarrDesSens;
