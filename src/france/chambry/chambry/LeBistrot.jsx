...
const LeBistrot = () => (
  <RestaurantPage
    ...
    address="6 rue du Théâtre, Chambéry, 73000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33982321078"
    website="https://www.restaurant-lebistrot.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the menu of this bistro near the theatre and the cathedral, you will find hearty Gallic seasonal recipes, starring fine ingredients that shout their name. The Savoie-born chef worked for a long time in Ducasse establishments. In fine weather, meals are served on a shaded terrace, which further increases the pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Th%C3%A9%C3%A2tre%2C%20Chamb%C3%A9ry%2C%2073000%2C%20France"
    pageTitle="Le Bistrot"
  />
);

export default LeBistrot;
