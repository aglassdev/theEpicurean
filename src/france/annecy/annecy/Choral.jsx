...
const Choral = () => (
  <RestaurantPage
    restaurantName="Choral"
    address="33 avenue des Romains, Annecy, 74000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33479197105"
    website="https://www.choralrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Romains district, 10 minutes from the centre, take a seat in this long, Scandinavian-inspired dining room opened by a chef who did a stint at Le Clos des Sens with Laurent Petit, before globe-trotting around the planet. The memory of his line-caught cod, tetragon, lemon and capers à la grenobloise lingers with us still. Alban’s instinctive, fine dining score (free of butter, cream and milk, except for desserts) is, for the most part, dictated by the availability of fresh market produce (such as baked apricots, honey and rhubarb sorbet), which are then given a deft professional spin. Mystery menu in several courses in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20avenue%20des%20Romains%2C%20Annecy%2C%2074000%2C%20France"
    pageTitle="Choral"
  />
);
