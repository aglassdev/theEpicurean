...
const Lhaut = () => (
  <RestaurantPage
    ...
    address="8 rue du Baronnet, Annecy, 74000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450446207"
    website="https://www.la-haut-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the top floor of the Parc des Artisans, this contemporary restaurant affords a view over the rooftops and the mountains beyond. The chef homes in on the essentials with his tasty, no-nonsense cuisine. Top-notch ingredients, generous dishes, intense sauces – it all conspires to ensure a pleasant time is had by all. At lunchtime, in particular, there is an affordable set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20du%20Baronnet%2C%20Annecy%2C%2074000%2C%20France"
    pageTitle="Là-Haut"
  />
);

export default Lhaut;
