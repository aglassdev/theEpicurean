...
const MaisonBenotVidal = () => (
  <RestaurantPage
    restaurantName="Maison Benoît Vidal"
    address="Sur-les-Bois, 79 route de Thônes, Annecy, 74940, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33450887318"
    website="https://www.maison-benoit-vidal.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Benoît Vidal is the Catalan chef behind this restaurant done out in a slick contemporary style in the Annecy area. Having completed stints with Michel Trama and Michel Guérard, he has created a light, poetic brand of cuisine that is rooted in the culinary traditions of Savoie, his adopted home. He brings a sense of precision and his own personal style to bear on the rigorously sourced ingredients, elevating them with sound technical skill and elaborate presentations. The strength of this chef may well lie in his pared-down, apparently simple creations showcasing pike, trout and crayfish with understated elegance. Appealing vegetarian set menu (Sentier à fleur d'eau) and wallet-friendly lunch menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sur-les-Bois%2C%2079%20route%20de%20Th%C3%B4nes%2C%20Annecy%2C%2074940%2C%20France"
    pageTitle="Maison Benoît Vidal"
  />
);

export default MaisonBenotVidal;
