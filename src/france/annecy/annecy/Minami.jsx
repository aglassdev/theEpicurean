...
const Minami = () => (
  <RestaurantPage
    ...
    address="19 faubourg Sainte-Claire, Annecy, 74000, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33450457542"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/annecy/restaurant/minami400465"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the old part of Annecy, this compact Japanese restaurant with a minimalist interior serves Japanese specialities (crispy morsels of soft-shell crab; hotpot of vegetables and udon) that are complemented by the occasional foray into French territory: foie gras sushi; caramelised eel; jasmine tea crème brûlée. A few tables on the terrace in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20faubourg%20Sainte-Claire%2C%20Annecy%2C%2074000%2C%20France"
    pageTitle="Minami"
  />
);

export default Minami;
