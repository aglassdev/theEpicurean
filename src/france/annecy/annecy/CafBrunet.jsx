...
const CafBrunet = () => (
  <RestaurantPage
    restaurantName="Café Brunet"
    address="18 place Gabriel-Fauré - à Annecy-le-Vieux, Annecy, 74940, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33450276565"
    website="https://cafebrunet.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This café dating back to 1875 is a real haven. It has managed to keep intact its soul of an authentic and convivial bistro (terrace, boules). As time meanders by, enjoy a good hearty meal or tasty little dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20place%20Gabriel-Faur%C3%A9%20-%20%C3%A0%20Annecy-le-Vieux%2C%20Annecy%2C%2074940%2C%20France"
    pageTitle="Café Brunet"
  />
);

export default CafBrunet;
