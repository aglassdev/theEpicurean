...
const BlackBass = () => (
  <RestaurantPage
    restaurantName="Black Bass"
    address="Black Bass Hotel, 921 route d'Albertville, à Sevrier, Annecy, 74000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450524036"
    website="https://www.blackbasshotel-annecy.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A smart vibe, a hip interior and a sweeping view of the lake set the scene for bistronomic recipes scattered with creative, exotic accents: ceviche of croaker with coriander and jalapenos; barbecued organic seabass with a harissa of raspberries and salad of green beans; spaghetti with toasted breadcrumbs, lemon and basil…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Black%20Bass%20Hotel%2C%20921%20route%20d'Albertville%2C%20%C3%A0%20Sevrier%2C%20Annecy%2C%2074000%2C%20France"
    pageTitle="Black Bass"
  />
);

export default BlackBass;
