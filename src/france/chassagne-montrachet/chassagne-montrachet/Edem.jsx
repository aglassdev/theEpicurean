...
const Edem = () => (
  <RestaurantPage
    restaurantName="Ed.Em"
    address="4 impasse Chenevottes, Chassagne-Montrachet, 21190, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33380219494"
    website="https://restaurant-edem.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This eatery blends the talents of Édouard, a chef whose CV boasts stints at Quai d’Orsay, Philippe Rochat and Lameloise, and Émilie, a talented pastry chef who adds the final flourish to the fixed set menu. In a swish interior of midnight blue walls, carpets and Art Deco-ish light fixtures, you will sample a score rich in premium produce that is loaded in personality, yet subtly delicate: diver scallops, Jerusalem artichoke and truffles; line-caught seabass, a medley of pumpkin and lemon thyme-flavoured hollandaise sauce… Just the ticket for a gourmet halt on the wine road...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20impasse%20Chenevottes%2C%20Chassagne-Montrachet%2C%2021190%2C%20France"
    pageTitle="Ed.Em"
  />
);
