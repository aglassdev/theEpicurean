...
const ColetteLES = () => (
  <RestaurantPage
    restaurantName="Colette"
    address="121 chemin de la Plagnette (lieu-dit La Plagnette), Les Salles, 42440, France"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20chemin%20de%20la%20Plagnette%20(lieu-dit%20La%20Plagnette)%2C%20Les%20Salles%2C%2042440%2C%20France"
    pageTitle="Colette"
  />
);

export default ColetteLES;
