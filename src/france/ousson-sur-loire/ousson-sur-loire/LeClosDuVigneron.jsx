...
const LeClosDuVigneron = () => (
  <RestaurantPage
    restaurantName="Le Clos du Vigneron"
    address="18 route Nationale 7, Ousson-sur-Loire, 45250, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33238314311"
    website="https://www.hotel-clos-du-vigneron.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The hilly vineyards of the Coteaux du Giennois abut this pretty half-timbered property. Step into the airy interior which sports a light colour scheme and dig into the concise, spot-on fare of a veteran chef. Fresh, well-crafted dishes of the likes of crab, semi-cooked foie gras, turbot and pork from the Basque country showcase seasonal produce and talented handiwork. Your hostess’s warm smile further contributes to your pleasure, as do the guestrooms, should you wish to stay overnight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20route%20Nationale%207%2C%20Ousson-sur-Loire%2C%2045250%2C%20France"
    pageTitle="Le Clos du Vigneron"
  />
);

export default LeClosDuVigneron;
