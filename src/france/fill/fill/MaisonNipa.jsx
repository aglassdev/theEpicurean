...
const MaisonNipa = () => (
  <RestaurantPage
    restaurantName="Maison Nipa"
    address="13 rue des Gesleries, Fillé, 72210, France"
    cuisine="Creative, Filipino"
    priceRange="€€€"
    phoneNumber="+33243874040"
    website="https://www.maisonnipa.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, opened by an experienced Franco-Philippine couple (Jason is in charge of savoury dishes, while Sharon rustles up desserts), specialises in Gallic cuisine influenced by the flavours and aromas of the Philippine archipelago. The food takes you on a culinary tour from Sarthe to the Philippines, depicted by Croisic squid à la “Adobong Pusit”, stuffed with a sisig of bellota chorizo and coated in a subtle cuttlefish ink sauce or wild duck with coffee-flavoured ceps and an “Adobo” sauce, together with other delicately perfumed dishes that might feature sweet-savoury or surf-turf notes. The roof may not be covered in palm leaves (meaning of nipa), but the modern dining room which cleverly mixes materials, is delightful, as is the seamless service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20des%20Gesleries%2C%20Fill%C3%A9%2C%2072210%2C%20France"
    pageTitle="Maison Nipa"
  />
);

export default MaisonNipa;
