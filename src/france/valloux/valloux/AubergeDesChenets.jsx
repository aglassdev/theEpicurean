...
const AubergeDesChenets = () => (
  <RestaurantPage
    restaurantName="Auberge des Chenets"
    address="10 D606, Valloux, 89200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33386342334"
    website="https://guide.michelin.com/en/bourgogne-franche-comte/valloux/restaurant/auberge-des-chenets"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You soon forget the road just outside, as you snuggle up near the fireplace of this pleasant Auberge! The menu stars simple dishes of Burgundian inspiration that are nicely crafted and packed with flavour: slow-cooked egg and snails in a red wine sauce, guinea fowl supreme, puréed potato, braised endive, Bourdaloue tart – and the bill won't break the bank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20D606%2C%20Valloux%2C%2089200%2C%20France"
    pageTitle="Auberge des Chenets"
  />
);

export default AubergeDesChenets;
