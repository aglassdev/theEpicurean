...
const LesLogesDuJardinDaymeric = () => (
  <RestaurantPage
    restaurantName="Les Loges du Jardin d'Aymeric"
    address="7 rue du Canigou, Clara, 66500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33468960872"
    website="https://www.logesaymeric.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The quintessential country establishment, where they are still passionate about what they do. Mad about great ingredients, the chef uses vegetables from his kitchen garden and citrus fruits from the surrounding area, and makes his own bread made with ancient flours. Unpretentious family service, reasonable prices: an enjoyable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Canigou%2C%20Clara%2C%2066500%2C%20France"
    pageTitle="Les Loges du Jardin d'Aymeric"
  />
);

export default LesLogesDuJardinDaymeric;
