...
const AubergeLeBoucBleu = () => (
  <RestaurantPage
    restaurantName="Auberge Le Bouc Bleu"
    address="2 rue du 5-Décembre, Beblenheim, 68980, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389478821"
    website="https://www.aubergeleboucbleu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Romain Hertrich and sommelier Romain Lambert, after stints in top establishments in France and abroad, are at the helm of this pretty half-timbered inn. Pan-fried girolles with pak choy, pumpkin seeds and pine nuts, or seared beef chuck steak with onion and beetroot pickles... All produce are from organic or small producers. Thoughtful food-wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%205-D%C3%A9cembre%2C%20Beblenheim%2C%2068980%2C%20France"
    pageTitle="Auberge Le Bouc Bleu"
  />
);

export default AubergeLeBoucBleu;
