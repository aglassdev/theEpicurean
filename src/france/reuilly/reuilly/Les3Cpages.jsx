...
const Les3Cpages = () => (
  <RestaurantPage
    restaurantName="Les 3 Cépages"
    address="17 rue de la Gare, Reuilly, 36260, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254032313"
    website="https://www.les-3-cepages.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of rural Berry and in the famous wine - growing village of Reuilly, this white - fronted ex - hotel is enjoying a new lease of life in the capable hands of a committed Japanese couple crazy about French food. Fine, flavoursome and flawlessly cooked, with a focus on fine quality produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20la%20Gare%2C%20Reuilly%2C%2036260%2C%20France"
    pageTitle="Les 3 Cépages"
  />
);

export default Les3Cpages;
