...
const LePalaceDeMenthon = () => (
  <RestaurantPage
    restaurantName="Le Palace de Menthon"
    address="665 route des Bains, Menthon-Saint-Bernard, 74290, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450648301"
    website="https://www.palacedementhon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A vibrant colour scheme and an unrivalled view of the lake depict this smart, trendy restaurant which serves finely crafted bistronomic fare: foie gras and duck breast; fillet of roast John Dory with seaweed butter; Brittany shortcrust with exotic marmalade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=665%20route%20des%20Bains%2C%20Menthon-Saint-Bernard%2C%2074290%2C%20France"
    pageTitle="Le Palace de Menthon"
  />
);

export default LePalaceDeMenthon;
