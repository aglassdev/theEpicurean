...
const LeConfidentiel = () => (
  <RestaurantPage
    restaurantName="Le Confidentiel"
    address="24 route des Moulins, Menthon-Saint-Bernard, 74290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450440068"
    website="https://www.restaurant-leconfidentiel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant – one of many (including some real juggernauts!) surrounding the lake – proves that good things come in small packages. In a compact dining area, you can enjoy dish after dish that is absolutely on point with its bold flavours, such as low-temperature egg, celery and pear, or hake, vegetable noodles and ginger-lemongrass broth. The atmosphere is friendly and relaxed. It really is love at first bite... Now that you're in on the secret, you know what to do!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20route%20des%20Moulins%2C%20Menthon-Saint-Bernard%2C%2074290%2C%20France"
    pageTitle="Le Confidentiel"
  />
);

export default LeConfidentiel;
