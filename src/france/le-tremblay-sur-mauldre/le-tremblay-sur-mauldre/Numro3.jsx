...
const Numro3 = () => (
  <RestaurantPage
    restaurantName="Numéro 3"
    address="3 rue du Général-de-Gaulle, Le Tremblay-sur-Mauldre, 78490, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33134878096"
    website="https://www.restaurant-numero3.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This village was once home to famous art dealer Ambroise Vollard, as well as Picabia, Picasso and Cendrars, who is buried here. Julie and Laurent Trochain run their lovely restaurant in an entirely refurbished former hunting lodge. What a transformation! Gone are the beams, the fireplace and even the traditional façade, replaced by an eminently contemporary, geometrical, designer finish. Laurent Trochain, originally from Maubeuge, trained in top establishments, not least at Pierre Gagnaire. He champions the produce of his region, starting with his own kitchen garden (vegetables and aromatic herbs), and from his beloved small-scale local producers. His vegetarian menu is gaining in popularity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Le%20Tremblay-sur-Mauldre%2C%2078490%2C%20France"
    pageTitle="Numéro 3"
  />
);

export default Numro3;
