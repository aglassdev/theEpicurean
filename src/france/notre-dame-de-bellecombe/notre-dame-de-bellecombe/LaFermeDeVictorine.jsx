...
const LaFermeDeVictorine = () => (
  <RestaurantPage
    restaurantName="La Ferme de Victorine"
    address="141 route du Plan-Dessert, Notre-Dame-de-Bellecombe, 73590, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33479316346"
    website="https://la-ferme-de-victorine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An authentic farmhouse with a pretty rustic - style restaurant, from which you can even see the cows in the cowshed in winter. The chef is passionate about Savoyard produce, and always on the lookout for the best cheeses and cold cooked meats. An eminently pleasant restaurant and very tasty dishes!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=141%20route%20du%20Plan-Dessert%2C%20Notre-Dame-de-Bellecombe%2C%2073590%2C%20France"
    pageTitle="La Ferme de Victorine"
  />
);

export default LaFermeDeVictorine;
