...
const LeKlberLaMaisonBonnet = () => (
  <RestaurantPage
    restaurantName="Le Kléber - La Maison Bonnet"
    ...
    pageTitle="Le Kléber - La Maison Bonnet"
  />
);

export default LeKlberLaMaisonBonnet;
