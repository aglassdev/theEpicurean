...
const LenkLaMaisonBonnet = () => (
  <RestaurantPage
    restaurantName="Len'K - La Maison Bonnet"
    address="2 place du Champ-de-Mars, Grane, 26400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475626064"
    website="https://www.lamaisonbonnet.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Len'K is the bistronomic wing of the Bonnet establishment. Seated on the terrace shaded by plane trees or in the dining room, diners are in for a treat as they tuck into guinea fowl and olive terrine, or stuffed red mullet paired with a velvety shellfish emulsion. Laid-back service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20du%20Champ-de-Mars%2C%20Grane%2C%2026400%2C%20France"
    pageTitle="Len'K - La Maison Bonnet"
  />
);

export default LenkLaMaisonBonnet;
