...
const LaFermeDeLhospital = () => (
  <RestaurantPage
    restaurantName="La Ferme de l'Hospital"
    address="272 rue de la Mollard, Bossey, 74160, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33450436143"
    website="https://www.ferme-hospital.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The years pass, but this well-known establishment on the Franco-Swiss border continues to uphold time-honoured traditions, as the warm, elegant interior, gleaming silverware and polished service bear witness. The chef concocts impeccably presented, pedigree French cuisine overflowing in flavour: duck ravioli and foie gras, venison in bacon and a pepper sauce…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=272%20rue%20de%20la%20Mollard%2C%20Bossey%2C%2074160%2C%20France"
    pageTitle="La Ferme de l'Hospital"
  />
);

export default LaFermeDeLhospital;
