...
const LeKarelian = () => (
  <RestaurantPage
    restaurantName="Le Karelian"
    address="36 rue du Cuchot, Dommartin-lès-Remiremont, 88200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33329624405"
    website="https://www.lekarelian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An understated, stripped-back dining room is the perfect foil for the chef’s modern, creative recipes, illustrated by flawlessly cooked arctic char served with grilled sarrazin wheat and crisp baby leeks in a saté sauce. The chef’s welcoming, professional spouse oversees the front of house. Those with a sweet tooth will be in seventh heaven thanks to the decadent dessert trolley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20du%20Cuchot%2C%20Dommartin-l%C3%A8s-Remiremont%2C%2088200%2C%20France"
    pageTitle="Le Karelian"
  />
);

export default LeKarelian;
