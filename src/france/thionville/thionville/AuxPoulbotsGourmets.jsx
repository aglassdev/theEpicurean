...
const AuxPoulbotsGourmets = () => (
  <RestaurantPage
    restaurantName="Aux Poulbots Gourmets"
    address="9 place aux Fleurs, Thionville, 57100, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33382881091"
    website="https://www.poulbotsgourmets.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rascally, iconic poulbots (street urchins) of Montmartre have now been joined by those of Thionville! Large bay windows, Lloyd Loom chairs and modern light fixtures add to the timeless elegance. The menu features recipes such as lobster salad and seasonal vegetables or pan-fried frogs’ legs…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20aux%20Fleurs%2C%20Thionville%2C%2057100%2C%20France"
    pageTitle="Aux Poulbots Gourmets"
  />
);

export default AuxPoulbotsGourmets;
