...
const LaTableDemilie = () => (
  <RestaurantPage
    restaurantName="La Table d'Emilie"
    address="8 place Carnot, Marseillan, 34340, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33467776359"
    website="https://guide.michelin.com/en/occitanie/marseillan/restaurant/la-table-d-emilie-4605"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The house where the poet Achille Maffre de Baugé was born is home to this very popular restaurant: the delicious and meticulous cuisine is anchored in French tradition (the pâté en croûte is excellent!). Made using fresh produce, this is particularly artfully plated food. To be enjoyed in a dining space with a vaulted ceiling or out on the pleasant patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20place%20Carnot%2C%20Marseillan%2C%2034340%2C%20France"
    pageTitle="La Table d'Emilie"
  />
);

export default LaTableDemilie;
