...
const BistrotDesHautsDeLoire = () => (
  <RestaurantPage
    restaurantName="Bistrot des Hauts de Loire"
    address="79 rue Gilbert-Navard, Veuzain-sur-Loire, 41150, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33254207257"
    website="https://www.hautsdeloire.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the outbuildings of the estate, a picturesque Sologne building with exposed timber beams and oak floorboards sets the scene. On the terrace, facing the kitchen garden, you can tuck into simple bistro dishes (matured meat, spit-roasts) or the chef’s more imaginative creations. Scrumptious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79%20rue%20Gilbert-Navard%2C%20Veuzain-sur-Loire%2C%2041150%2C%20France"
    pageTitle="Bistrot des Hauts de Loire"
  />
);

export default BistrotDesHautsDeLoire;
