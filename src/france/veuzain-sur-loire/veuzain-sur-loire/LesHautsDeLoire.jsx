...
const LesHautsDeLoire = () => (
  <RestaurantPage
    restaurantName="Les Hauts de Loire"
    ...
    pageTitle="Les Hauts de Loire"
  />
);

export default LesHautsDeLoire;
