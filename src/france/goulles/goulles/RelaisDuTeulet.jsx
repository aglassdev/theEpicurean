...
const RelaisDuTeulet = () => (
  <RestaurantPage
    restaurantName="Relais du Teulet"
    address="19 route d'Aurillac, lieu-dit Le Teulet, Goulles, 19430, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€"
    phoneNumber="+33555287109"
    website="https://www.relais-du-teulet.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former coaching inn, run by the same family for five generations, is a pleasant surprise! The chef devises simple and accessible contemporary cuisine, based on a short menu that highlights the region's great produce – Corrèze meats, Aurillac fruit and vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20route%20d'Aurillac%2C%20lieu-dit%20Le%20Teulet%2C%20Goulles%2C%2019430%2C%20France"
    pageTitle="Relais du Teulet"
  />
);

export default RelaisDuTeulet;
