...
const LaGolmotte = () => (
  <RestaurantPage
    restaurantName="La Golmotte"
    address="Le Barbier, Le Mont-Dore, 63240, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33473650577"
    website="https://www.aubergelagolmotte.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from Le Mont-Dore, authenticity is guaranteed in this inn, where the dining area was originally a cowshed! Fresh ingredients and copious portions of tasty traditional cuisine, such as tender pork cheeks, home-made potato purÉe and Saint-PourÇain white wine sauce… even if the chef allows himself a few incursions into more contemporary territory, with dishes such as salmon gravlax...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Barbier%2C%20Le%20Mont-Dore%2C%2063240%2C%20France"
    pageTitle="La Golmotte"
  />
);

export default LaGolmotte;
