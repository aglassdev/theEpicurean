...
const LaTableDeBeaurecueil = () => (
  <RestaurantPage
    restaurantName="La Table de Beaurecueil"
    address="66 allée des Mûriers, Beaurecueil, 13100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33442669498"
    website="https://www.latabledebeaurecueil.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is housed in a former sheep barn and features a resolutely contemporary design (only a few of the original rustic features remain). It offers “cuisine du terroir” based on high quality produce. Wine by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20all%C3%A9e%20des%20M%C3%BBriers%2C%20Beaurecueil%2C%2013100%2C%20France"
    pageTitle="La Table de Beaurecueil"
  />
);

export default LaTableDeBeaurecueil;
