...
const GrainsDeSel = () => (
  <RestaurantPage
    restaurantName="Grains de Sel"
    address="113 Grand-Rue, Haguenau, 67500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388908382"
    website="https://www.restaurant-grainsdesel.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gilles Schnoering, well established in his restaurant near the Halle aux Houblons, treats his guests to a short seasonal menu; his fresh, well - made creations owe much to the quality of the ingredients used. Savvy food and wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=113%20Grand-Rue%2C%20Haguenau%2C%2067500%2C%20France"
    pageTitle="Grains de Sel"
  />
);

export default GrainsDeSel;
