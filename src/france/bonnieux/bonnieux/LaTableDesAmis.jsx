...
const LaTableDesAmis = () => (
  <RestaurantPage
    restaurantName="La Table des Amis"
    address="Le Mas Les Eydins, 2420 chemin du Four, Bonnieux, 84480, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33633638124"
    website="https://www.leseydins.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Christophe Bacquié greets diners like old friends in his gorgeous farmhouse set in peaceful countryside, surrounded by vineyards, olive groves and lavender fields. With his wife Alexandra and a closeknit, committed team, all of whom share his passion for Southern France and its produce and wines, Bacquié unfolds a single set menu with a strong Mediterranean identity. With flavour as his watchword, he crafts the finest ingredients simply and transparently and we were delighted to see some of his signature dishes, such as his modern aioli and his vision of iced Calisson, in pride of place on the menu. An authentic Provençal property and the guarantee of wholehearted hospitality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Mas%20Les%20Eydins%2C%202420%20chemin%20du%20Four%2C%20Bonnieux%2C%2084480%2C%20France"
    pageTitle="La Table des Amis"
  />
);

export default LaTableDesAmis;
