...
const LaBergerie = () => (
  <RestaurantPage
    restaurantName="La Bergerie"
    address="Chemin des Cabanes, Bonnieux, 84480, France"
    cuisine="Grills, Provençal"
    priceRange="€€"
    phoneNumber="+33490758978"
    website="https://www.beaumier.com/fr/proprietes/hotel-capelongue/gastronomie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bistro offshoot of La Bastide de Capelongue combines a terrace that commands jaw-dropping views with a seasonal menu that spans Provençal recipes to dishes cooked over the wood burning fire in the rustic dining room. The expertise of the crack kitchen team is flawless...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20des%20Cabanes%2C%20Bonnieux%2C%2084480%2C%20France"
    pageTitle="La Bergerie"
  />
);

export default LaBergerie;
