...
const JuMaisonDeCuisine = () => (
  <RestaurantPage
    restaurantName="JU - Maison de Cuisine"
    address="2 rue Lucien-Blanc, Bonnieux, 84480, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490758862"
    website="https://ju-maisondecuisine.com/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Julien Allano (La Mirande, Le Clair de la Plume) chose to go it alone and set up shop in this beautiful traditional building in the heart of the village. In an interior with exposed stonework, the chef can be seen at work behind a wooden counter. Meanwhile, guests are seated on handcrafted furnishings made of untreated walnut wood – a decor that oozes style. The carte blanche menu, which is divided into several sections, reflects the season from day to day. Heirloom varieties of wheat, peanuts from Malataverne, green beans from a neighbouring farm and pigeon from Sarrians are just some of the carefully sourced local ingredients used to create harmonious, delicate cuisine, rife with the flavours of the South of France, about which the chef is genuinely passionate. The Cheese Experience..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Lucien-Blanc%2C%20Bonnieux%2C%2084480%2C%20France"
    pageTitle="JU - Maison de Cuisine"
  />
);

export default JuMaisonDeCuisine;
