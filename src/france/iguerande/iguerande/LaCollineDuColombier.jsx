...
const LaCollineDuColombier = () => (
  <RestaurantPage
    restaurantName="La Colline du Colombier"
    address="Lieu-dit le Colombier, Iguerande, 71340, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33385840724"
    website="https://lacollineducolombier.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Deep in the countryside, overlooking the Loire, this restored farmhouse has a style that is rustic but also chic and minimalist! It allies nature and design and serves refined dishes made from local ingredients, combined with modern touches...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20le%20Colombier%2C%20Iguerande%2C%2071340%2C%20France"
    pageTitle="La Colline du Colombier"
  />
);

export default LaCollineDuColombier;
