...
const AuBonPichet = () => (
  <RestaurantPage
    restaurantName="Au Bon Pichet"
    address="10 place du Marché-aux-Choux, Sélestat, 67600, France"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+33388829665"
    website="https://aubonpichet.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is a delight to eat at this restaurant that has been run by the same family for four generations! Like his forefathers before him, the chef concocts good traditional recipes: smoked pork shank with potato sauerkraut, pike perch quenelles and matelote sauce... The convivial service and winstub decor confirm that the rules of good living never go out of fashion!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20du%20March%C3%A9-aux-Choux%2C%20S%C3%A9lestat%2C%2067600%2C%20France"
    pageTitle="Au Bon Pichet"
  />
);

export default AuBonPichet;
