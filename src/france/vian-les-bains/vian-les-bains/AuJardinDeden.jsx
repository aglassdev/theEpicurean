...
const AuJardinDeden = () => (
  <RestaurantPage
    restaurantName="Au Jardin d'Eden"
    address="1 avenue Général-Dupas, Évian-les-Bains, 74500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450386226"
    website="https://www.jardin-eden-evian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the way into town, this eatery ticks all the boxes: an owner-chef with a fine CV – including 15 years at Le Grand Véfour, who has returned to his roots in Évian and generous, traditional cooking that keeps pace with the seasons. Fricassée of sweetbread and green peas; free-range chicken, lemon confit and roquette; tartare of Charolais beef; fillets of fresh perch…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20G%C3%A9n%C3%A9ral-Dupas%2C%20%C3%89vian-les-Bains%2C%2074500%2C%20France"
    pageTitle="Au Jardin d'Eden"
  />
);

export default AuJardinDeden;
