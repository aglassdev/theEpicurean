...
const LouPinatou = () => (
  <RestaurantPage
    restaurantName="Lou Pinatou"
    address="242 rue de la Mairie, Le Bourg, Solignac-sous-Roche, 43130, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33471652154"
    website="https://www.auberge-loupinatou.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The windows of the dining room of this inn tucked away between Saint Etienne and Le Puy en Velay overlook a magnificent landscape of valleys, as you wonder where the family’s immense 5000m² kitchen garden, orchards and hives that supply most of the kitchen produce are located... The chef, who is from the hills of Le Puy and a fan of bold, crisp flavours and premium produce, works with his pastry buff wife, who hails from Marseille. Their gourmet repertory is two-fold: tomato, courgette and mousseline of smoked sardines; duck, cabbage stuffed with walnuts and honey roasted squash; rice cracker, peanut gateau and crème. Splendid wine cellar with a distinct fondness for local “Volcanic Loire and Ardèche” wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=242%20rue%20de%20la%20Mairie%2C%20Le%20Bourg%2C%20Solignac-sous-Roche%2C%2043130%2C%20France"
    pageTitle="Lou Pinatou"
  />
);

export default LouPinatou;
