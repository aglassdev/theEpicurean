...
const LeBistrotDeLaCaillre = () => (
  <RestaurantPage
    restaurantName="Le Bistrot de la Caillère"
    address="36 route des Montils, Candé-sur-Beuvron, 41120, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33254440308"
    website="https://www.auberge-de-la-caillere.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ideally located for anyone visiting the châteaux of the Loire, this inn is firmly rooted in its era. It is run by an enterprising couple, who work and live in harmony with the bucolic landscape of forests and meadows. The original 18C farmhouse has been replaced by a modern building – modern like chef Éric Rialland's cuisine. His well-thought-out bistronomy dishes follow the seasons and oscillate between creativity and tradition. Pleasant terrace for fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20route%20des%20Montils%2C%20Cand%C3%A9-sur-Beuvron%2C%2041120%2C%20France"
    pageTitle="Le Bistrot de la Caillère"
  />
);

export default LeBistrotDeLaCaillre;
