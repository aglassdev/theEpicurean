...
const LaubergeDeGuillaume = () => (
  <RestaurantPage
    restaurantName="L'Auberge de Guillaume"
    address="4 place de la Mairie, Vandenesse-en-Auxois, 21320, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33380492236"
    website="https://laubergedeguillaume.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After assisting Christophe Bacquié at Le Castellet, becoming a Meilleur Ouvrier de France in 2015 and then a Michelin-starred chef at La Bussière, local lad, Guillaume Royer, has at last opened his own place in his native village. In this charming inn, half a kilometre from the peaceful Canal de Bourgogne, he rolls out his talent in a contemporary bistronomic vein using knockout regional produce. Pleasant terrace and quiet garden to the rear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20place%20de%20la%20Mairie%2C%20Vandenesse-en-Auxois%2C%2021320%2C%20France"
    pageTitle="L'Auberge de Guillaume"
  />
);

export default LaubergeDeGuillaume;
