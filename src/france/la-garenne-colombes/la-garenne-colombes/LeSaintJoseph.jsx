...
const LeSaintJoseph = () => (
  <RestaurantPage
    restaurantName="Le Saint Joseph"
    address="100 boulevard de la République, La Garenne-Colombes, 92250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33142426449"
    website="https://lesaintjoseph-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This local bistro serves wholesome, updated, tasty fare, in the shape of a menu devised by chef Bordier, whose illustrious career speaks for itself. Diners dig into good food in a friendly relaxed venue, washed down with a selection from the concise wine list, which showcases wine - producing women...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20boulevard%20de%20la%20R%C3%A9publique%2C%20La%20Garenne-Colombes%2C%2092250%2C%20France"
    pageTitle="Le Saint Joseph"
  />
);

export default LeSaintJoseph;
