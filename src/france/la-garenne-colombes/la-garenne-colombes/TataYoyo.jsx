...
const TataYoyo = () => (
  <RestaurantPage
    restaurantName="Tata Yoyo"
    address="26 avenue de Verdun-1916, La Garenne-Colombes, 92250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33177379235"
    website="https://www.bistrot-tatayoyo.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet residential neighbourhood, this bistro with a colourful façade and bright green-floored terrace catches the eye. The stylish neo-vintage interior cleverly blends wood, wallpaper, large mirrors, old photographs in gilded frames, and shelves lined with knick-knacks. Friendly welcome and highly attentive service. In the kitchen, Arnaud Delvenne (a Top Chef finalist 2022) has devised a thoughtful and appealing à la carte menu and an affordable lunch menu (add-ons available). A refreshing chilled courgette soup, lightly seared sea bream served with a tasty caponata, and a perfectly made Paris-Brest: a restaurant to be reckoned with...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20avenue%20de%20Verdun-1916%2C%20La%20Garenne-Colombes%2C%2092250%2C%20France"
    pageTitle="Tata Yoyo"
  />
);

export default TataYoyo;
