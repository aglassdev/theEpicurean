...
const BistrotDePortlesney = () => (
  <RestaurantPage
    restaurantName="Bistrot de Port-Lesney"
    address="Place du 8-Mai-1945, Port-Lesney, 39330, France"
    cuisine="Traditional Cuisine, Cuisine from Franche-Comté"
    priceRange="€€"
    phoneNumber="+33384378327"
    website="https://chateaudegermigney.com/fr/restaurant/le-bistrot-de-port-lesney.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a few metres from the River Loue, this bistro with red shutters has a terrace that gives onto the village square. The chef's generous traditional cuisine is a real ode to the terroir: smoked trout and preserved leek; Petit Mercey snails; poultry supreme and a vin jaune cream – served on tables with checked tablecloths in an interior packed with salvaged knick-knacks...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%208-Mai-1945%2C%20Port-Lesney%2C%2039330%2C%20France"
    pageTitle="Bistrot de Port-Lesney"
  />
);

export default BistrotDePortlesney;
