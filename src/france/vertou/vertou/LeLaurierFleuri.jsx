...
const LeLaurierFleuri = () => (
  <RestaurantPage
    restaurantName="Le Laurier Fleuri"
    address="460 route de Clisson, Vertou, 44120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251790101"
    website="https://www.laurierfleuri.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former coaching inn may not enjoy the most appealing of settings, but once seated at your table you will have no trouble understanding the success of this restaurant run by a pair of industry professionals. With plenty of experience in prestigious establishments, the chef concocts a pleasingly refined and fragrant cuisine composed of bistronomy-style dishes delivered at reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=460%20route%20de%20Clisson%2C%20Vertou%2C%2044120%2C%20France"
    pageTitle="Le Laurier Fleuri"
  />
);

export default LeLaurierFleuri;
