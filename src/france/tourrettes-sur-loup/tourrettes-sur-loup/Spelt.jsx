...
const Spelt = () => (
  <RestaurantPage
    restaurantName="Spelt"
    address="6 Grand'Rue, Tourrettes-sur-Loup, 06140, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33986266379"
    website="https://www.spelt-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here in the historical heart of the fortified town, Raphaël (on savoury dishes) and Marion (desserts) delight diners with their no-nonsense and full-flavoured bistronomy creations. At dinner, a tasting menu features the restaurant's namesake dish of spelt risotto with lobster. Don't miss the pastry chef's signature dessert: Caribbean chocolate mousse and cocoa sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Grand'Rue%2C%20Tourrettes-sur-Loup%2C%2006140%2C%20France"
    pageTitle="Spelt"
  />
);
