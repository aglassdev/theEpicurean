...
const AubergeDeLaFort = () => (
  <RestaurantPage
    restaurantName="Auberge de la Forêt"
    address="276 rue des Verriers, à Lettenbach, Abreschviller, 57560, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33387037178"
    website="https://www.aubergedelaforet57.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This turreted inn is nestled in the Abreschviller valley. Gone are any airs of a country bistro; the style is now up to the minute, elegant and refined, in line with the food, which is very contemporary...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=276%20rue%20des%20Verriers%2C%20%C3%A0%20Lettenbach%2C%20Abreschviller%2C%2057560%2C%20France"
    pageTitle="Auberge de la Forêt"
  />
);

export default AubergeDeLaFort;
