...
const LeCoudeCoude = () => (
  <RestaurantPage
    restaurantName="Le Coude à Coude"
    address="8 rue de Saintonge, Jarnac-Champagne, 17520, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33546496653"
    website="https://www.lecoudeacoude.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ten minutes from Cognac, this stone building houses a contemporary bistro with a large terrace overlooking a small garden. With clear names and distinct flavours, the dishes appeal to the taste buds. The chef cooks with vegetables from a nearby farm, fruit from the orchard, fish from La Cotinière. Fresh ingredients, precise seasoning, good technique: everything is made in-house, from the bread to the ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20Saintonge%2C%20Jarnac-Champagne%2C%2017520%2C%20France"
    pageTitle="Le Coude à Coude"
  />
);

export default LeCoudeCoude;
