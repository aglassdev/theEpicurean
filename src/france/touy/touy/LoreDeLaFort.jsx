...
const LoreDeLaFort = () => (
  <RestaurantPage
    restaurantName="L'Orée de la Forêt"
    address="255 rue de la Forêt, Étouy, 60600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33344516518"
    website="https://www.loreedelaforet.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the edge of the forest of Hez, this gracious late-19C mansion, set in peaceful wooded grounds, is ideal for a gourmet weekend in the country. After savouring the peace and quiet of the terrace, the plush bourgeois interior provides the perfect foil for the talents of chef Nicolas Leclercq and his wife Yolaine. Nicolas’ grandmother first opened the restaurant back in 1956, at which time she made her own butter from the milk of her own cow! The large cottage garden (take the time to stroll around it after your meal) supplies the kitchen with fresh vegetables and herbs, which are picked by the chef’s father. Today, the chef, who bakes his own sourdough bread, crafts down-to-earth, mouthwatering, seasonal food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=255%20rue%20de%20la%20For%C3%AAt%2C%20%C3%89touy%2C%2060600%2C%20France"
    pageTitle="L'Orée de la Forêt"
  />
);

export default LoreDeLaFort;
