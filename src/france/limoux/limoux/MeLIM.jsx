...
const MeLIM = () => (
  <RestaurantPage
    restaurantName="ME."
    address="1 place du Général-Leclerc, Limoux, 11300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468310025"
    website="https://grandhotelmodernepigeon.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Limoux%2C%2011300%2C%20France"
    pageTitle="ME."
  />
);

export default MeLIM;
