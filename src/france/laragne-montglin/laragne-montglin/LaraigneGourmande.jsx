...
const LaraigneGourmande = () => (
  <RestaurantPage
    restaurantName="L'Araignée Gourmande"
    address="8 rue de la Paix, Laragne-Montéglin, 05300, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33492651339"
    website="https://www.laraignee-gourmande.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Settle at your table in this bright, modern interior and experience the talent of Thierry Chouin. This Breton chef may have a particular penchant for fish - based fare, but that doesn't mean he snubs lamb and potatoes. He fetes the ingredients with nicely turned - out dishes, each a lovely homage to tradition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20la%20Paix%2C%20Laragne-Mont%C3%A9glin%2C%2005300%2C%20France"
    pageTitle="L'Araignée Gourmande"
  />
);

export default LaraigneGourmande;
