...
const Granit = () => (
  <RestaurantPage
    restaurantName="Granit"
    address="5 Kerhuéno, Plouharnel, 56340, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297291017"
    website="https://granit-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Between Carnac and Quiberon, this modern edifice, deep in the Brittany countryside, is a foodie’s paradise! Chef Charles Moreau has knocked around a bit from China to the Belgian kitchens of Sang Hoon Degeimbre (including the 2-star Air du Temps). Brittany whiskey, buckwheat, artichokes, oysters, gwell and Guéméné andouille, the food ticks all the boxes of traditional Brittany fare. The result is spot on, well-crafted and above all balanced, without forgetting the odd, inspired creative note (such as the dessert of black olives, strawberries and burrata). Concise (mainly organic and biodynamic) wine list and a black and white minimalist interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Kerhu%C3%A9no%2C%20Plouharnel%2C%2056340%2C%20France"
    pageTitle="Granit"
  />
);
