...
const MaisonDesamy = () => (
  <RestaurantPage
    restaurantName="Maison Desamy"
    address="2 rue Hervé-de-Mareuil, Mareuil-sur-Lay-Dissais, 85320, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33251526943"
    website="https://www.restaurant-maisondesamy.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Previously Alexandre Couillon's sous-chef at La Marine, Simon Bessonnet has set up shop in premises dating from 1860 in the heart of a wine-producing village in the Fiefs Vendéens. But as the contemporary interior he has designed for his restaurant suggests, the chef is very much in touch with the times. Drawing on a regional pantry, he comes up with bold and original combinations and chooses just the right emulsions, jus and condiments to intelligently boost his dishes. As for the desserts, they are models of deliciousness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Herv%C3%A9-de-Mareuil%2C%20Mareuil-sur-Lay-Dissais%2C%2085320%2C%20France"
    pageTitle="Maison Desamy"
  />
);

export default MaisonDesamy;
