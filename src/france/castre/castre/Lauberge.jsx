...
const Lauberge = () => (
  <RestaurantPage
    restaurantName="L'Auberge"
    address="2590 route de Bailleul, Caëstre, 59190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33328402525"
    website="https://guide.michelin.com/en/hauts-de-france/castre/restaurant/l-auberge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from Hazebrouck, this Auberge was once a tannery then a tavern true to the traditions of France's northern regions. Now it is a restaurant with a friendly atmosphere showcasing seasonal produce and Flemish roots in reinterpretations of classic local fare (welsh, carbonade). Chef Antonin, who is also a wine enthusiast, pulls off surprising combinations such as snails, haddock and spinach, too!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2590%20route%20de%20Bailleul%2C%20Ca%C3%ABstre%2C%2059190%2C%20France"
    pageTitle="L'Auberge"
  />
);

export default Lauberge;
