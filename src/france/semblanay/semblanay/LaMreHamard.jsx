...
const LaMreHamard = () => (
  <RestaurantPage
    restaurantName="La Mère Hamard"
    address="2 rue du Petit-Bercy, Semblançay, 37360, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+33247566204"
    website="https://www.lamerehamard.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stone-built inn, which opened in 1903, is a genuine institution. The delightful dining room is flanked by a welcoming terrace shaded by wisteria, ideal to sample delicate, generous dishes, tinged with the occasional exotic influence. Attentive welcome and a few guestrooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Petit-Bercy%2C%20Semblan%C3%A7ay%2C%2037360%2C%20France"
    pageTitle="La Mère Hamard"
  />
);

export default LaMreHamard;
