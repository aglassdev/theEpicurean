...
const ArMaenHir = () => (
  <RestaurantPage
    restaurantName="Ar Maen Hir"
    address="15 bis rue du Prieuré, Locronan, 29180, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33256101837"
    website="https://guide.michelin.com/en/bretagne/locronan/restaurant/ar-maen-hir"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For his first restaurant, youthful Thibaud Érard chose the picturesque, medieval village of Locronan, near Quimper, where he is clearly flourishing. His traditional, wholesome cuisine quietly feeds you well. Pleasant, casual service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20bis%20rue%20du%20Prieur%C3%A9%2C%20Locronan%2C%2029180%2C%20France"
    pageTitle="Ar Maen Hir"
  />
);

export default ArMaenHir;
