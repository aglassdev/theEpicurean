...
const LeBoudesLaVigne = () => (
  <RestaurantPage
    restaurantName="Le Boudes La Vigne"
    address="Place de la Mairie, Boudes, 63340, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33473965566"
    website="https://www.le-boudes-la-vigne.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Built on old fortifications, this pleasant restaurant lies at the heart of a wine-growing village that produces Boudes, one of the five wines of Auvergne's vineyards. Christian Coutarel, a jovial chef, works away in the kitchen preparing generous and flavoursome traditional cuisine, without ruling out more modern dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20la%20Mairie%2C%20Boudes%2C%2063340%2C%20France"
    pageTitle="Le Boudes La Vigne"
  />
);

export default LeBoudesLaVigne;
