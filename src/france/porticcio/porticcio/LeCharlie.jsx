...
const LeCharlie = () => (
  <RestaurantPage
    restaurantName="Le Charlie"
    address="Bella Vista Hôtel, Porticcio, 20166, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33495204624"
    website="https://www.lapiscineporticcio.com/the-restaurant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After many years as a MICHELIN-starred chef in his restaurant near Poitiers, Richard Toix has found in the heights of Porticcio an ideal setting for his delicate, flavoursome cuisine. With a sure hand and impeccable taste, he delivers cosmopolitan cuisine, blending influences from Corsica and the French mainland, as well as from stints in Asia, which have nourished his imagination and his palette. His cuisine is particularly attuned to flavours, a case in point being the apricot, tomato, anchovy starter, or the delicious dessert of honey and Brocciu cheese, an ode to the Island of Beauty. The terrace commands a superb view of the Gulf of Ajaccio and the Îles Sanguinaires...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bella%20Vista%20H%C3%B4tel%2C%20Porticcio%2C%2020166%2C%20France"
    pageTitle="Le Charlie"
  />
);

export default LeCharlie;
