...
const CaffCsarLinitial = () => (
  <RestaurantPage
    restaurantName="Caffé César L'initial"
    address="2 route de Nice, Opio, 06650, France"
    cuisine="Modern Cuisine, Provençal"
    priceRange="€€"
    phoneNumber="+33493360903"
    website="https://www.caffecesar.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A large patio and a spacious, modern interior with an open-plan kitchen set the scene for spot-on, bistronomic cuisine, steeped in the aromas and flavours of Provence and the Mediterranean. Delicious chard-flavoured gnocchi (“Merda de Can” - a delicacy of Nice), caponata-style fillet of dentex in red wine and rose-scented rum baba… A cheerful, friendly vibe with wines by the glass from a magnum bottle…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20route%20de%20Nice%2C%20Opio%2C%2006650%2C%20France"
    pageTitle="Caffé César L'initial"
  />
);

export default CaffCsarLinitial;
