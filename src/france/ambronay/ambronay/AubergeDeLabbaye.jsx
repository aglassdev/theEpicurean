...
const AubergeDeLabbaye = () => (
  <RestaurantPage
    restaurantName="Auberge de l'Abbaye"
    address="47 place des Anciens-Combattants, Ambronay, 01500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33474464254"
    website="https://www.aubergedelabbaye-ambronay.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located at the foot of the Benedictine Abbaye d'Ambronay, this contemporary place has been designed down to the very last detail by modern-minded owner Ivan Lavaux, who has put time and thought into the choice of materials and colours (including a specially created toile de Jouy!). He moves between the restaurant floor and the kitchen, showcasing the many selected wines from his cellar, as well as the premium ingredients he loves (asparagus, sea bass, lobster etc). Indulge in one of his tempting set menus, served at lunch and dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20place%20des%20Anciens-Combattants%2C%20Ambronay%2C%2001500%2C%20France"
    pageTitle="Auberge de l'Abbaye"
  />
);

export default AubergeDeLabbaye;
