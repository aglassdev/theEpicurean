...
const Cartouches = () => (
  <RestaurantPage
    restaurantName="Cartouches"
    address="38 rue Pierre-Paul-Riquet, Toulouse, 31000, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33561250707"
    website="https://www.cartouches-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the picturesque and lively neighbourhood of Saint-Aubin, this tiny bistro is always busy! Chef Nicolas Brousse and his wife take great pleasure in serving up tasty, carefully prepared dishes. And in keeping with this spirit of conviviality, why not share a fine steak (butcher's choice – for two people)? This goes down very well with a natural wine from the extensive selection. The set menu changes every week...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20Pierre-Paul-Riquet%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Cartouches"
  />
);

export default Cartouches;
