...
const AuPoisGourmand = () => (
  <RestaurantPage
    restaurantName="Au Pois Gourmand"
    address="3 rue Émile-Heybrard, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33534364200"
    website="https://www.pois-gourmand.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Extended and refurbished, the terrace of the Pois Gourmand, which commands a matchless view of the Garonne, offers a rural setting in the heart of town. The food is equally uplifting from semi-cooked duck foie gras in apricots to grilled Mediterranean croaker with fennel and orange confit. Simply delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20%C3%89mile-Heybrard%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Au Pois Gourmand"
  />
);

export default AuPoisGourmand;
