...
const LesPlaneurs = () => (
  <RestaurantPage
    restaurantName="Les Planeurs"
    address="56 boulevard des Minimes, Toulouse, 31000, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33986515695"
    website="https://lesplaneurs.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Japanese chef and his partner have opened this unusual establishment in a deliberately bohemian and offbeat setting. The French cuisine is precise, original, balanced and flavoursome, illustrated by a risotto of poultry and shellfish, rich in seafaring aromas or roast apricots in rosemary served with homemade yoghurt ice cream. Good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20boulevard%20des%20Minimes%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Les Planeurs"
  />
);

export default LesPlaneurs;
