...
const Sept = () => (
  <RestaurantPage
    restaurantName="SEPT"
    address="11 rue Théodore-Ozenne, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33756921806"
    website="https://www.restaurant-sept.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In this location between the Marché des Carmes (covered market) and the antiques quarter, chef Guillaume Monboise has created a new space for foodies. This former tearoom done out in soothing cream hues boasts a brand new kitchen that opens out onto the restaurant floor – ideal for this talented chef who loves to have direct contact with his customers. In keeping with this philosophy, the service is professional and relaxed, and immediately puts you at ease. The dishes are enhanced with invigorating and refreshing seasonings – take the sea bass cooked skin on and served with a green olive sorbet and grated bottarga for saltiness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Th%C3%A9odore-Ozenne%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="SEPT"
  />
);
