...
const Lalouette = () => (
  <RestaurantPage
    restaurantName="L'alouette"
    address="24 place Victor-Hugo, Toulouse, 31000, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33562891396"
    website="https://lalouette.metro.rest/?lang=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite the magnificent Victor Hugo market is this friendly eatery acclaimed by good food lovers. Splendid range of aged meat and offal (pig’s ears, calf’s liver and sweetbread), spring veggies from the nearby market (white asparagus and chorizo) and desserts to die for (clafouti of seasonal fruit)! A wholesome, casual vibe is perfectly suited to a drink and meal with the mates…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20place%20Victor-Hugo%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="L'alouette"
  />
);

export default Lalouette;
