...
const CcileTOU = () => (
  <RestaurantPage
    restaurantName="Cécile"
    address="43 place des Carmes, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33534257565"
    website="https://cecile-toulouse.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the lively, bustling Carmes neighbourhood, a close-knit young team welcomes you to this modern bistro with a wood-decked veranda, large open kitchen and contemporary decor. The short menu is inspired by a real mix of cultures: exotic touches are incorporated into dishes such as Thai duck tartare and farm-reared pork loin with mango and pomegranate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20place%20des%20Carmes%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Cécile"
  />
);

export default CcileTOU;
