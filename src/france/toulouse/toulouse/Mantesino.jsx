...
const Mantesino = () => (
  <RestaurantPage
    restaurantName="Mantesino"
    address="8 rue Maury, Toulouse, 31000, France"
    cuisine="Italian, Campanian"
    priceRange="€"
    phoneNumber="+33531541329"
    website="https://mantesino.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Naples-born chef, who used to be an engineer, has enthusiastically donned an apron (mantesino in Italian) and opened this small bistro in a street near the Église Saint-Aubin. He gives pride of place to his roots by tapping into the culinary traditions of Southern Italy, from Campania to Puglia. A far cry from stereotypical Italian fare, his no-nonsense bistro cuisine wins diners over by drawing solely on flavoursome, meticulously selected ingredients: mortadella from Bologna, hazelnuts from Piedmont, Ibaïama pork, as well as meat from Aveyron and vegetables from local growers. Uplifting!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Maury%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Mantesino"
  />
);

export default Mantesino;
