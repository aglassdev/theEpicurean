...
const LeCnacle = () => (
  <RestaurantPage
    restaurantName="Le Cénacle"
    address="La Cour des Consuls, 46 rue des Couteliers, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33567161999"
    website="https://www.cite-hotels.com/fr/etablissements/restaurant-la-cenacle.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Cénacle has a plush, elegant atmosphere (superb 16C sculpted fireplace, a Caravaggio print, exposed beams). The chef takes pride in forging long-lasting partnerships with good regional producers: organic vegetables from Gers, lamb from Béarn, line-caught fish. Inventive cuisine with a Mediterranean flavour, and good value for money at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Cour%20des%20Consuls%2C%2046%20rue%20des%20Couteliers%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Le Cénacle"
  />
);

export default LeCnacle;
