...
const UneTableDeux = () => (
  <RestaurantPage
    restaurantName="Une Table à Deux"
    address="10 rue de la Pleau, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33561250351"
    website="https://www.unetableadeux.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After learning the ropes in Toulouse, Morgane and Nicolas made a beeline for Korea and Malaysia to research new flavours. Back in their hometown, they have chosen the Carmes district to regale diners with playful recipes that blend Mediterranean and tropical flavours, resulting in impressively curated and beautifully balanced dishes. Fantastic value for money lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20de%20la%20Pleau%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Une Table à Deux"
  />
);

export default UneTableDeux;
