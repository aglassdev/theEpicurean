...
const LairDeFamille = () => (
  <RestaurantPage
    restaurantName="L'Air de Famille"
    address="6 rue Jules-Chalande, Toulouse, 31000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33567065408"
    website="https://airdefamilletoulouse.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'Air de Famille makes for an appealing place to eat with its period decor (vintage advertising posters, original counter) and unpretentious atmosphere. Tradition and the seasons dictate the menu here, with particular attention paid to flavour combinations and sauces. Calf's head with ravigote sauce and other classics regularly feature… and they boast a well-stocked wine list!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Jules-Chalande%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="L'Air de Famille"
  />
);

export default LairDeFamille;
