...
const Mile = () => (
  <RestaurantPage
    restaurantName="Émile"
    address="13 place Saint-Georges, Toulouse, 31000, France"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+33561210556"
    website="https://www.restaurant-emile.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An appealing wine list, 100% house-made traditional cuisine that focuses on fresh produce and local producers and – the icing on the cake – a pretty terrace overlooking a lovely square. The star of the show is obviously the cassoulet, but the menu proposes plenty of delicious alternatives, all at reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20place%20Saint-Georges%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Émile"
  />
);
