...
const LesTtesDailTOU = () => (
  <RestaurantPage
    restaurantName="Les Têtes d'Ail"
    address="6 rue de la Fonderie, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33561134041"
    website="https://guide.michelin.com/en/occitanie/toulouse/restaurant/les-tetes-d-ail"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the place for wholesome bistronomic fare from southwest France! Market-fresh, flavoursome dishes that keep pace with the seasons, well-selected local produce, excellent value for money (particularly at lunchtime), all of which in a busy shopping high street near Place des Carmes. Invariably packed, which is always a good sign!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20de%20la%20Fonderie%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Les Têtes d'Ail"
  />
);

export default LesTtesDailTOU;
