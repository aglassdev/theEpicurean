...
const Solides = () => (
  <RestaurantPage
    restaurantName="Solides"
    address="38 rue des Polinaires, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33561533488"
    website="https://www.solides.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant opposite the market stands out on account of its fine bistro food, delivered by a chef who is a proponent of short supply chains. It also boasts an excellent (and coherent) natural wine list. In a bohemian atmosphere, sample the house speciality: vol-au-vent with calf sweetbreads, cockerel combs and chicken sauce, as well as terrific cheeses from the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20des%20Polinaires%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Solides"
  />
);
