...
const LesSalesGosses = () => (
  <RestaurantPage
    restaurantName="Les Sales Gosses"
    address="81 rue Riquet, Toulouse, 31000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33967153164"
    website="https://www.lessalesgosses.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Les Sales Gosses (naughty kids) chalks up its creative version of heart-warming bistro classics on large blackboards. The food is the work of chef Bruno, who is definitely top of the class! A great meal every time. And if it’s fully booked, there is now a Plan B: Le Bistrot, not far away, on Rue de l'Industrie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20rue%20Riquet%2C%20Toulouse%2C%2031000%2C%20France"
    pageTitle="Les Sales Gosses"
  />
);

export default LesSalesGosses;
