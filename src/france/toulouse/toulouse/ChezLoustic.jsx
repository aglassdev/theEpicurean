...
const ChezLoustic = () => (
  <RestaurantPage
    restaurantName="Chez Loustic"
    address="19 rue Reclusane, Toulouse, 31300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33562763568"
    website="https://www.chez-loustic.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In one of the busiest parts of the Saint-Cyprien neighbourhood, this modern bistro has an industrial aesthetic that makes for a convivial atmosphere. The pleasant little terrace overlooking the square is a bonus. Having learned the ropes at a Christian Constant restaurant, the chef prepares meticulous seasonal cuisine using market-fresh produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Reclusane%2C%20Toulouse%2C%2031300%2C%20France"
    pageTitle="Chez Loustic"
  />
);

export default ChezLoustic;
