...
const LaBastideSaintantoine = () => (
  <RestaurantPage
    restaurantName="La Bastide Saint-Antoine"
    address="48 avenue Henri-Dunant, Grasse, 06130, France"
    cuisine="Provençal"
    priceRange="€€€€"
    phoneNumber="+33493709494"
    website="https://www.jacques-chibois.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To celebrate the 20th anniversary of his Provençal haven, Jacques Chibois – a leading proponent of cuisine du soleil – has updated all of the restaurant's key posts (head sommelier, chief account manager etc). A dynamic team working to create dishes that fête pell mell citrus fruits, herbs, olive oil and other delicacies of the region... A real treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20avenue%20Henri-Dunant%2C%20Grasse%2C%2006130%2C%20France"
    pageTitle="La Bastide Saint-Antoine"
  />
);

export default LaBastideSaintantoine;
