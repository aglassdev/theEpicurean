...
const Silex = () => (
  <RestaurantPage
    ...
    address="15 place de l'Église, Chahaignes, 72340, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33243446262"
    website="https://silex-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a village that boasts several hundreds of cellars hewn out of the tufa rock, this restaurant housed in a handsome Classical mansion pays tribute to the terroir of Jasnières and Coteaux-du-Loir AOC wines. Beneath the exposed beams, the rather modern interior is accentuated by street art displayed on the walls. There's no doubt about it: chefs Maïté Hervé (starters/desserts) and Florent Demas (main courses) know what they're doing when it comes to both the decor and the food. Drawing on the village's larder, they create delicious straightforward dishes – think white asparagus, lardo di Colonnata, lemon sauce; standing rump of veal smoked in hay, pea cream and a shallot crisp. Perfection on a plate! Excellent value for money at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20place%20de%20l'%C3%89glise%2C%20Chahaignes%2C%2072340%2C%20France"
    pageTitle="Silex"
  />
);

export default Silex;
