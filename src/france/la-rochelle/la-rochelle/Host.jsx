...
const Host = () => (
  <RestaurantPage
    restaurantName="Host"
    address="33 rue des Dames, La Rochelle, 17000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33546299728"
    website="https://host-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alice Roger and her partner have set up shop just a stone's throw from the market, in a simple, contemporary location inspired by their first meeting in the United Kingdom. The warm, unpretentious welcome reflects the philosophy of the restaurant: getting to the heart of the matter. Organised into market-inspired lunch options and a more ambitious tasting menu featuring premium ingredients, the chef's cuisine exudes well-defined flavours. Dishes such as bluefin tuna with beetroot and sorrel, and a dessert bursting with colour and flavour – coffee, tonka bean, hazelnut and Peruvian chocolate – speak to her talent!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20rue%20des%20Dames%2C%20La%20Rochelle%2C%2017000%2C%20France"
    pageTitle="Host"
  />
);
