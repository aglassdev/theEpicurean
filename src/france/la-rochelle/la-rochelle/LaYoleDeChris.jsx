...
const LaYoleDeChris = () => (
  <RestaurantPage
    restaurantName="La Yole de Chris"
    address="Plage de la Concurrence, La Rochelle, 17000, France"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+33546414188"
    website="https://christophercoutanceau.com/fr/la-yole-de-chris.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This dazzling place by Christopher Coutanceau offers two incomparable pleasures: for the eyes and for the taste buds. A long counter in the shape of a skiff (light, long and narrow boat), houses the open kitchen, where the cooks can be seen in action. Seafood (oysters and shellfish) and fish of the day enjoy pride of place on the menu here... to be enjoyed on the terrace that overlooks the sea, in fine weather. Booking recommended...."
    ...
    pageTitle="La Yole de Chris"
  />
);

export default LaYoleDeChris;
