...
const Impressions = () => (
  <RestaurantPage
    restaurantName="Impressions"
    address="7 rue Saint-Michel, La Rochelle, 17000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33546090398"
    website="https://www.restaurant-impressions.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After 18 years at Le Saison near Rennes, David Etcheverry has moved to this restaurant in the centre of La Rochelle. It is a small place with a sleek modern loft design, where they serve refined, unfailingly delicious dishes. A real treat for the taste buds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20Saint-Michel%2C%20La%20Rochelle%2C%2017000%2C%20France"
