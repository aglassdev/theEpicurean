...
const LesFlotsLAR = () => (
  <RestaurantPage
    ...
    address="1 rue de la Chaîne, La Rochelle, 17000, France"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33546413251"
    website="https://les-flots.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20la%20Cha%C3%AEne%2C%20La%20Rochelle%2C%2017000%2C%20France"
    pageTitle="Les Flots"
  />
);

export default LesFlotsLAR;
