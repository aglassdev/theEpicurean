...
const ChristopherCoutanceau = () => (
  <RestaurantPage
    restaurantName="Christopher Coutanceau"
    address="Plage de la Concurrence, La Rochelle, 17000, France"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33546414819"
    website="https://www.christophercoutanceau.com/fr/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Overlooking the Plage de la Concurrence, the sign on the front of the restaurant says it all: Christopher Coutanceau, chef and fisherman. Fishing here is a lifelong family passion, and Christopher takes it further by campaigning for sustainable methods and against waste. His sincere and unfussy cuisine, with its bouquet of marine scents, an invigorating ode to the Atlantic Ocean, is an extension of this commitment. The finest fish and seafood - turbot, sole, sea urchin - is prepared with care and imagination, while the modest mackerel or sardine is rendered sublime by the same devotion and technical skill. Those lucky enough to taste the scallop pithiviers (only in season!) will remember it forever. As for pastry chef Benoît Godillon's sweet creations, they achieve the perfect balance of l..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plage%20de%20la%20Concurrence%2C%20La%20Rochelle%2C%2017000%2C%20France"
    pageTitle="Christopher Coutanceau"
  />
);

export default ChristopherCoutanceau;
