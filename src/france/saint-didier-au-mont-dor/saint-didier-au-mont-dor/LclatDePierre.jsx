...
const LclatDePierre = () => (
  <RestaurantPage
    restaurantName="L'Éclat de Pierre"
    address="2 place André-Michel, Saint-Didier-au-Mont-d'Or, 69370, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33437468885"
    website="https://leclatdepierre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This brasserie in the heart of the village sits just outside the indoor market, serving delicious traditional dishes that scrupulously respect the fundamentals of French cuisine. Made with seasonal produce, the set menu – available at both lunch and dinner – changes every week. The blackboard features mouth-watering dishes: pork and poultry terrine with pink peppercorns; pollock steak with potatoes dressed with parsley and a Parmesan sauce; a custard tart with Madagascar vanilla that won first prize for the best flan pâtissier in France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20Andr%C3%A9-Michel%2C%20Saint-Didier-au-Mont-d'Or%2C%2069370%2C%20France"
    pageTitle="L'Éclat de Pierre"
  />
);

export default LclatDePierre;
