...
const LaTableDeJrme = () => (
  <RestaurantPage
    restaurantName="La Table de Jérôme"
    address="26 rue de la République, Luzy, 58170, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33386300066"
    website="https://www.hotelrestaurantdumorvan58.fr/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the walls of the Hôtel du Morvan, chef Jérôme Raymond plays a modern, culinary score based on regional produce. A single set menu, with more upmarket ingredients at the weekend (Charolais beef is a firm favourite). Whopping 400-bin wine list of mainly Burgundy origins. Comfortable rooms should you wish to stay longer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20rue%20de%20la%20R%C3%A9publique%2C%20Luzy%2C%2058170%2C%20France"
    pageTitle="La Table de Jérôme"
  />
);

export default LaTableDeJrme;
