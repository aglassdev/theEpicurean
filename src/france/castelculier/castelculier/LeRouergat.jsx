...
const LeRouergat = () => (
  <RestaurantPage
    restaurantName="Le Rouergat"
    address="4 place de la Mairie, Castelculier, 47240, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553878045"
    website="https://lerouergat.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary bistro is bistronomic at lunchtime and gastronomic in the evenings. In the hands of a veteran chef from Aveyron, overflowing with contagious enthusiasm, this friendly, invariably-packed eatery focuses on local, seasonal produce, jazzed up with the occasional globetrotting souvenir. We tasted duck foie gras terrine with pineapple and ginger chutney followed by roast guinea fowl, cream of green peas and a samosa of pleurote mushrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20place%20de%20la%20Mairie%2C%20Castelculier%2C%2047240%2C%20France"
    pageTitle="Le Rouergat"
  />
);

export default LeRouergat;
