...
const DomitiaMaisonDeCuisinier = () => (
  <RestaurantPage
    restaurantName="Domitia - Maison de Cuisinier"
    address="440 rue des Micocouliers, Beaumettes, 84220, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33490722305"
    website="https://domitia-maisondecuisinier.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Slices of Mediterranean dentex served raw, caraway, cauliflower and elderberry vinegar; Camargue bull, oyster tartare from the Étang de Thau and salicornia-pistachio pesto: there's no doubt that chef Jérôme Faure has a masterful understanding of gourmet cuisine. His subtly innovative take on fine dining is based on a rigorous selection of local ingredients. The same goes for the wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=440%20rue%20des%20Micocouliers%2C%20Beaumettes%2C%2084220%2C%20France"
    pageTitle="Domitia - Maison de Cuisinier"
  />
);

export default DomitiaMaisonDeCuisinier;
