...
const LesTroisSoleilsDeMontal = () => (
  <RestaurantPage
    restaurantName="Les Trois Soleils de Montal"
    address="687 route de Montal, Saint-Jean-Lespinasse, Saint-Céré, 46400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33565101616"
    website="https://www.3soleils.fr/les-restaurants/les-trois-soleils/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This property located on the Causse de Gramat, near Saint-Céré, boasts a hotel with restaurants, peaceful grounds, a pool, and a nearby golf course. The Trois Soleils wins diners over with its elegant traditional interior leading onto a fragrant summer terrace and grounds. The room is adorned with tapestries and ceramics by Jean Lurçat, an artist dear to chef Frédérik Bizat, an antique dealer in a former life. Today, he devotes himself solely to treating diners to wholesome fare courtesy of quality produce (particularly local herbs) and delicate craftsmanship. A fine dining experience with an outstanding quality-for-pleasure ratio and all with Madame Bizat’s attentive service. A first-class family business...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=687%20route%20de%20Montal%2C%20Saint-Jean-Lespinasse%2C%20Saint-C%C3%A9r%C3%A9%2C%2046400%2C%20France"
    pageTitle="Les Trois Soleils de Montal"
  />
);

export default LesTroisSoleilsDeMontal;
