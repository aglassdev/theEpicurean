...
const BistrotConstant = () => (
  <RestaurantPage
    restaurantName="Bistrot Constant"
    address="25 rue de l'Usine, Montech, 82700, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33563246302"
    website="https://www.bistrotconstant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spruce lock gatehouse, on the banks of a side canal of the Garonne River, is home to a bistro run by a meticulous chef. Christophe Marque, who has taken over from Christian Constant. Marque continues to champion wholesome bistro traditions: egg mimosa served with fatty tuna; hake in breadcrumbs or crunchy sweetbread and baked macaroni with parmesan; île flottante (egg whites on custard) with pink pralines… Time-honoured classics faultlessly executed according to textbook tradition – bon appétit!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20de%20l'Usine%2C%20Montech%2C%2082700%2C%20France"
    pageTitle="Bistrot Constant"
  />
);

export default BistrotConstant;
