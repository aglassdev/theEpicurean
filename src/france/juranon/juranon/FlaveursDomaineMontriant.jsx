...
const FlaveursDomaineMontriant = () => (
  <RestaurantPage
    restaurantName="Flaveurs - Domaine Mont-Riant"
    address="1 avenue des Frères-Barthélémy, Jurançon, 64110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559906094"
    website="https://www.domaine-montriant.fr/deguster-2/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Jurançon hillsides, this handsome 19C white mansion with a slate roof and set in wooded grounds is enjoying a new lease of life in the hands of a locally-born couple, Basque chef Patxi and his Béarn wife, Marilyn. The couple has tastefully revamped the bourgeois interior, whose windows command knockout views of Pau below. The decor provides the perfect foil for the veteran chef’s talented craftsmanship which slaloms between tradition and modernity. All of which is anchored in a commitment to sustainable fishing and local producers, illustrated by cèpe ravioles served with a mouthwatering slab of premium foie gras...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20des%20Fr%C3%A8res-Barth%C3%A9l%C3%A9my%2C%20Juran%C3%A7on%2C%2064110%2C%20France"
    pageTitle="Flaveurs - Domaine Mont-Riant"
  />
);

export default FlaveursDomaineMontriant;
