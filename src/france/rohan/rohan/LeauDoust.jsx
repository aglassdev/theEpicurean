...
const LeauDoust = () => (
  <RestaurantPage
    restaurantName="L'Eau d'Oust"
    address="6 rue du Lac, Rohan, 56580, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33297389186"
    website="https://www.leaudoust.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An old farmstead on the way out of the village near a pond paints the inviting picture. In a contemporary, welcoming décor, the owners focus on genuinely wholesome food with the occasional whimsical touch of creativity. The ingredients are fresh and first - rate, and the service is with a smile. A pleasant meal every time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20du%20Lac%2C%20Rohan%2C%2056580%2C%20France"
    pageTitle="L'Eau d'Oust"
  />
);

export default LeauDoust;
