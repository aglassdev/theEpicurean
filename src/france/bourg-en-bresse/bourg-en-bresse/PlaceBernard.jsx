...
const PlaceBernard = () => (
  <RestaurantPage
    restaurantName="Place Bernard"
    address="19 place Bernard, Bourg-en-Bresse, 01000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33474452911"
    website="https://placebernard.com/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the hands of Georges Blanc, this handsome 1900 edifice is home to a splendid brasserie adorned with a fresco of the Blanc clan. The culinary score showcases a regional line-up of classics: Bresse poultry in cream, frog’s legs in garlic and parsley and traditional Nantua-style quenelle of pike. Lovely conservatory-cum-patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20place%20Bernard%2C%20Bourg-en-Bresse%2C%2001000%2C%20France"
    pageTitle="Place Bernard"
  />
);

export default PlaceBernard;
