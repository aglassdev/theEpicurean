...
const LaubergeBressane = () => (
  <RestaurantPage
    restaurantName="L'Auberge Bressane"
    address="166 boulevard de Brou, Bourg-en-Bresse, 01000, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33474222268"
    website="https://www.aubergebressane.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A firm favourite: justice is done to regional specialities (Bresse chicken, frogs' legs, crayfish and its legendary pike quenelles) and the wine list is packed with vintage bottles. Terrace with a view onto the church of the Royal Monastery of Brou...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=166%20boulevard%20de%20Brou%2C%20Bourg-en-Bresse%2C%2001000%2C%20France"
    pageTitle="L'Auberge Bressane"
  />
);

export default LaubergeBressane;
