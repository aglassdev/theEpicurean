...
const RestaurantDuPont = () => (
  <RestaurantPage
    restaurantName="Restaurant du Pont"
    address="147 rue du Grignon, Basse-Goulaine, 44115, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33240035862"
    website="https://www.restaurant-du-pont.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Next to the small Canal de Goulaine, this white building, once a bar and inn, has a refined contemporary interior and pleasant terrace-garden for fine weather. Having plied his trade abroad, chef Mathieu Corbineau now navigates between rather traditional recipes and more contemporary influences: crispy chicken with tandoori spices, carrot, cumin and kumquat sabayon; herb-crusted catch of the day, cereal risotto, citrus butter; gariguette strawberry, yuzu cream, frosted marshmallow gariguette, Montélimar nougat ice cream. An affordable set menu at lunchtime, and a wine list that gives Muscadet top billing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=147%20rue%20du%20Grignon%2C%20Basse-Goulaine%2C%2044115%2C%20France"
    pageTitle="Restaurant du Pont"
  />
);

export default RestaurantDuPont;
