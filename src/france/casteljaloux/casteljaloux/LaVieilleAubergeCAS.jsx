...
const LaVieilleAubergeCAS = () => (
  <RestaurantPage
    restaurantName="La Vieille Auberge"
    address="13 avenue du 8-Mai-1945, Casteljaloux, 47700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553930136"
    website="https://www.clos-castel.fr/le-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Splendid high vaulted timber ceilings and huge floor-to-ceiling windows reminiscent of a conservatory overlooking the garden: the scene is set in this well-known culinary landmark. Matthijs Bartman rolls out modern, enticing dishes illustrated by pastrami of bazadais beef, smoked beetroot and blueberries or a more classical choux pastry stuffed with tonka bean diplomat crème, yuzu caramel and mango sorbet… A traditional lineup with a modern twist, presented in two eater-friendly priced menus. Enthusiastic and delightful front of house team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20avenue%20du%208-Mai-1945%2C%20Casteljaloux%2C%2047700%2C%20France"
    pageTitle="La Vieille Auberge"
  />
);

export default LaVieilleAubergeCAS;
