...
const MaisonSoubeiran = () => (
  <RestaurantPage
    restaurantName="Maison Soubeiran"
    address="129 cours Gabriel-Péri, Lunel, 34400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33467151455"
    website="https://www.maison-soubeiran.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We fell in love with this family-run establishment whose chef whips up spontaneous regional fare made with fresh, seasonal ingredients from local organic market gardeners. Scents and flavours from the garrigue, Camargue and Mediterranean, jazzed up with spicy notes and flanked by homemade sourdough bread made with heritage wheat. Authentic warm welcome and an exquisite patio shaded by a natural trellis...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=129%20cours%20Gabriel-P%C3%A9ri%2C%20Lunel%2C%2034400%2C%20France"
    pageTitle="Maison Soubeiran"
  />
);

export default MaisonSoubeiran;
