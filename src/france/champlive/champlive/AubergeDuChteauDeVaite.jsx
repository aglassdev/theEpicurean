...
const AubergeDuChteauDeVaite = () => (
  <RestaurantPage
    restaurantName="Auberge du Château de Vaite"
    address="17 Grande Rue, Champlive, 25360, France"
    cuisine="Traditional Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33381552066"
    website="https://www.auberge-chateau-vaite.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Grande%20Rue%2C%20Champlive%2C%2025360%2C%20France"
    pageTitle="Auberge du Château de Vaite"
  />
);

export default AubergeDuChteauDeVaite;
