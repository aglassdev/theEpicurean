...
const LorangeriePOR = () => (
  <RestaurantPage
    ...
    address="9 rue de la Prépoise, Pornic, 44210, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33240828852"
    website="https://www.restaurant-orangerie.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Trained by some of the best (Alain Dutournier, Jean-Michel Lorrain, Alain Ducasse), chef Julien Lainé crafts enticing food that surfs between tradition (leek vinaigrette; veal vol-au-vent; chocolate fondant cake and cocoa sorbet) and modernity (carpaccio of croaker and blood orange dressing; pan-seared line-caught seabass with a haddock emulsion). In a seaside resort such as Pornic, this eatery with two colourful little dining areas and an open kitchen is most welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20de%20la%20Pr%C3%A9poise%2C%20Pornic%2C%2044210%2C%20France"
    pageTitle="L'Orangerie"
  />
);

export default LorangeriePOR;
