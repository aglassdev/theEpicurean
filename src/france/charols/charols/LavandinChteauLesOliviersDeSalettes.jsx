...
const LavandinChteauLesOliviersDeSalettes = () => (
  <RestaurantPage
    restaurantName="Lavandin - Château Les Oliviers de Salettes"
    address="1205 route du Château, Charols, 26450, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33475001930"
    website="https://www.chateaulesoliviersdesalettes.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This peaceful 16C château, restored to the highest standards, is the quintessence of Drôme provençale. From the terrace overlooking the grounds and lavender fields or in the cosy dining room with its vaulted ceiling and a fire crackling in the hearth, get ready to embark on a poetic culinary voyage inspired by regional delicacies. Thanks to chefs Kévin Vaubourg and Lucille Routin, the castle boasts a knockout fine dining option. Each dish is carefully thought out and crafted to allow the ingredients to shout their name, depicted by an incredibly delicate tomato or locally reared lamb prepared in two ways and underscored by a chervil jus and olive seasoning. Delightful welcome. Book one of the lovely rooms and stay longer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1205%20route%20du%20Ch%C3%A2teau%2C%20Charols%2C%2026450%2C%20France"
    pageTitle="Lavandin - Château Les Oliviers de Salettes"
  />
);

export default LavandinChteauLesOliviersDeSalettes;
