...
const LeValtrivin = () => (
  <RestaurantPage
    restaurantName="Le Valtrivin"
    address="4 rue du Wetzelhof, Ammerschwihr, 68770, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33645727054"
    website="https://www.levaltrivin.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Le Valtrivin team, previously in Lapoutroie, has a new home in Ammerschwihr, in the heart of the Haut-Rhin vineyards. It's a brilliant move for this establishment, which is passionate about showcasing Alsace wines – and many others. Here within these old stone walls, a couple is at the helm – he takes pleasure in recommending gems from his incredible wine list; she rustles up appealing contemporary dishes, using top-notch local and seasonal ingredients. Be sure to indulge in one of her truly refined desserts. Highly recommended!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20du%20Wetzelhof%2C%20Ammerschwihr%2C%2068770%2C%20France"
    pageTitle="Le Valtrivin"
  />
);

export default LeValtrivin;
