...
const RestaurantJulienBinz = () => (
  <RestaurantPage
    restaurantName="Restaurant Julien Binz"
    address="7 rue des Cigognes, Ammerschwihr, 68770, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33389229823"
    website="https://www.restaurantjulienbinz.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the Wine Road south of Colmar, the picture postcard wine-growing village of Ammerschwihr nestles in Kaysersberg Valley, dubbed the valley of stars - Michelin stars of course! It is home to a veteran chef and former member of the Auberge de l’Ill team, Julien Binz, for whom the world of cooking has no secrets. Against a plush, stylish background, he rustles up seasonal dishes founded on lashings of culinary technique with an Alsace accent: duck foie gras crafted two ways; a “striped” trout with choucroute and a creamy Kaefferkopf riesling sauce; tortellini of Munster cheese and a buttery stock… Perfect to brush up your gourmet classics!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20des%20Cigognes%2C%20Ammerschwihr%2C%2068770%2C%20France"
    pageTitle="Restaurant Julien Binz"
  />
);

export default RestaurantJulienBinz;
