...
const LaPoste = () => (
  <RestaurantPage
    restaurantName="La Poste"
    address="74 rue du Général-de-Gaulle, Urmatt, 67280, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33388974055"
    website="https://www.hotel-rest-laposte.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fans of tradition will be happy to discover this family - run inn installed opposite the former town hall. Game in season, truite au bleu (blue trout), Rossini beef tournedos, goose foie gras and country terrines... The food is generous and the atmosphere pleasant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Urmatt%2C%2067280%2C%20France"
    pageTitle="La Poste"
  />
);
