...
const LesMrovingiens = () => (
  <RestaurantPage
    restaurantName="Les Mérovingiens"
    address="32 avenue Émile-Cossonneau, Noisy-le-Grand, 93160, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33143036778"
    website="https://www.lesmerovingiens.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jacky Ribault (L'Ours in Vincennes, Qui Plume la Lune in the 11th arrondissement in Paris) opened this brasserie on the ground floor of a residential building in the centre of Noisy-le-Grand. It pays homage to the history of the town, which was built on a Merovingian and Carolingian necropolis. The menu proposes good classic dishes – slightly revamped – made from impeccable produce. Pleasant contemporary setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20avenue%20%C3%89mile-Cossonneau%2C%20Noisy-le-Grand%2C%2093160%2C%20France"
    pageTitle="Les Mérovingiens"
  />
);

export default LesMrovingiens;
