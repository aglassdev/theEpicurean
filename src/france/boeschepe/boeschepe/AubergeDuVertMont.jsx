...
const AubergeDuVertMont = () => (
  <RestaurantPage
    restaurantName="Auberge du Vert Mont"
    address="1318 rue du Mont-Noir, Boeschepe, 59299, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33328494126"
    website="https://www.vertmont.fr/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Tucked away in the heart of the countryside, chef Florent Ladeyn, an ecological champion from the word go, is a standard-bearer of authentic and indulgent Flemish fare that is deeply rooted in the terroir yet creative, instinctive and enticing. In a simply decorated dining room with exposed beams and views of the hilly Monts de Flandre landscape, the chef gives expression to his passion for charcoal cooking, as his guests take in the show. Firmly committed to local produce, he strews his creations with flowers and plants from the region. His Maroilles cheese fries have attained almost legendary status, but his single seasonal carte-blanche menu, which has to be ordered for everyone at the table, has many other surprises in store!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1318%20rue%20du%20Mont-Noir%2C%20Boeschepe%2C%2059299%2C%20France"
    pageTitle="Auberge du Vert Mont"
  />
);

export default AubergeDuVertMont;
