...
const MaisonWessmanParThierryMarx = () => (
  <RestaurantPage
    restaurantName="Maison Wessman par Thierry Marx"
    address="425 impasse des Verdots, Conne-de-Labarde, 24560, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33553583431"
    website="https://maisonwessman-wines.com/fr/la-maison-wessman-par-thierry-marx"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Forming the heart of the stunning Les Verdots wine estate, this detached building in the local architectural style looks out over the vineyards; a travertine-paved terrace is laid out in front. Inside, the comfortable interior is done out in chic bistro-style decor. Chef Thierry Marx has devised a menu that turns tradition on its head: open-field tomatoes with fresh goat's milk cheese, vanilla oil and strawberries; duck confit served with lentils with carrot and dressed in a mustard vinaigrette; floating island with raspberries and custard. The short wine list, of course, highlights the estate and the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=425%20impasse%20des%20Verdots%2C%20Conne-de-Labarde%2C%2024560%2C%20France"
    pageTitle="Maison Wessman par Thierry Marx"
  />
);

export default MaisonWessmanParThierryMarx;
