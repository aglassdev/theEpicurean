...
const Rpu = () => (
  <RestaurantPage
    restaurantName="Rēpu"
    address="944 avenue de la République, Marcq-en-Barœul, 59700, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33320008048"
    website="https://repu.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Abdeldaker Belfatmi wants his guests to leave with a smile and a full stomach! He needn’t worry, his creamy smoked mackerel with a coulis of watercress, daikon radish in miso and peanuts, followed by cod, spinach, mashed potato and jus of lemon confit scallops and then, a rice pudding and passion fruit sorbet, really do the job! His modern brasserie lineup is ample evidence that the chef of the former Michelin-starred Le Marcq has lost none of his legendary culinary flair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=944%20avenue%20de%20la%20R%C3%A9publique%2C%20Marcq-en-Bar%C5%93ul%2C%2059700%2C%20France"
    pageTitle="Rēpu"
  />
);
