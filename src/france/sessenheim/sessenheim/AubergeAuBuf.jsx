...
const AubergeAuBuf = () => (
  <RestaurantPage
    restaurantName="Auberge au Bœuf"
    address="1 rue de l'Église, Sessenheim, 67770, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33388869714"
    website="https://www.auberge-au-boeuf.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="You can’t help but fall in love with this snug Alsace inn with its church pews, wainscoted walls, regional furniture and small museum dedicated to Goethe… The village was the scene of a love affair between the famous writer and the daughter of a local pastor. The seasonal culinary repertory wavers between modernity and tradition. There is also a Stammtisch, a regional “table d’hôtes”, and 4 luxury guestroom-suites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20l'%C3%89glise%2C%20Sessenheim%2C%2067770%2C%20France"
    pageTitle="Auberge au Bœuf"
  />
);

export default AubergeAuBuf;
