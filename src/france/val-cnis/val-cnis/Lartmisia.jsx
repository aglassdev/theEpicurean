...
const Lartmisia = () => (
  <RestaurantPage
    restaurantName="L'Artémisia"
    address="20 rue de la Parrachée, Val-Cénis, 73500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33479205136"
    website="https://www.hotel-laturra.com/restaurant-l-artemisia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hotel restaurant in the heart of the Haute-Maurienne and Vanoise areas is the perfect place to recharge your batteries after a mountain hike. The interior design may look simple, but the food served here is a far cry from your average resort fare, as chef Victor Heiries strives to treat diners to something unexpected. His wonderfully fresh surprise menu varies according to the ingredients available on a given day: Arctic char, Aubrac Wagyu beef, Duroc pork belly or Termignon blue cheese – fantastic. Aromatic herbs and wild plants elevate the vegetable-forward dishes. There are rooms for overnight guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20de%20la%20Parrach%C3%A9e%2C%20Val-C%C3%A9nis%2C%2073500%2C%20France"
    pageTitle="L'Artémisia"
  />
);

export default Lartmisia;
