...
const LaTableMaisonLobies = () => (
  <RestaurantPage
    restaurantName="La Table - Maison Lobies"
    address="2 rue Porte-d'en-Haut, Chevannes, 89240, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33985070527"
    website="https://www.latable-lobies.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the middle of the village, with the church on one side and fields on the other, this beautiful 18C manor house with a courtyard to the front has a refined, classical decor. The premises are both home and place of work for an enthusiastic, smiling couple with experience in some of the world's top restaurants. Sun Young, a pastry chef who hails from South Korea, and chef Jérémie work together to devise an appealing, delicious and rather traditional menu: super-soft poultry with crispy skin and an excellent, generous fricassee of chanterelle mushrooms, and a buttery potato purée; beef chuck confit in its jelly sprinkled with hazelnut and boosted by a real mustard and shallot sauce! As for the desserts (floating island, Tahitian vanilla crème anglaise or raspberry cheesecake), it's as simpl..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Porte-d'en-Haut%2C%20Chevannes%2C%2089240%2C%20France"
    pageTitle="La Table - Maison Lobies"
  />
);

export default LaTableMaisonLobies;
