...
const AlainLlorca = () => (
  <RestaurantPage
    restaurantName="Alain Llorca"
    address="350 route de Saint-Paul, La Colle-sur-Loup, 06480, France"
    cuisine="Provençal"
    priceRange="€€€€"
    phoneNumber="+33493320293"
    website="https://www.alainllorca.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Alain Llorca is an iconic character of French Riviera cuisine with high-profile stints at the mythical luxury Negresco Hotel and the Moulin de Mougins, amongst other fine food affairs. In his farmhouse in La Colle-sur-Loup, whose terrace commands a jaw-dropping view of Saint Paul de Vence, he gives free rein to his affinity for all things Mediterranean. The result is often an ode to seafood, steeped in subtle, delicate notes: seabass in an aubergine crust with garden veggies; Poupeton of courgette flowers with black truffles, but Tarn pigeon, foie gras and tender juicy beef also make guest star appearances...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=350%20route%20de%20Saint-Paul%2C%20La%20Colle-sur-Loup%2C%2006480%2C%20France"
    pageTitle="Alain Llorca"
  />
);

export default AlainLlorca;
