...
const MdlLeBistrot = () => (
  <RestaurantPage
    restaurantName="Mdl le Bistrot"
    address="1 impasse Pépi-Pages, Caux, 34720, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33467931199"
    website="https://www.restaurant-delauzun.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few minutes from his MICHELIN-starred restaurant, Matthieu de Lauzun (MDL) has given a new lease of life to this place, which used to be a private wine cellar. Within these thick stone walls, a laid-back clientele embraces the culinary experience in this buzzing atmosphere. The menu draws on the treasures of the Mediterranean terroir: stuffed tomatoes, Andalusian gazpacho and house-made pâté en croûte sit alongside sea bream tartare and beef cheek confit. With both modest labels and renowned names, the well-constructed wine list, shared with the MICHELIN-starred restaurant, has something for everyone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20impasse%20P%C3%A9pi-Pages%2C%20Caux%2C%2034720%2C%20France"
    pageTitle="Mdl le Bistrot"
  />
);

export default MdlLeBistrot;
