...
const LeVieuxCastillon = () => (
  <RestaurantPage
    restaurantName="Le Vieux Castillon"
    address="10 rue Turion-Sabatier, Castillon-du-Gard, 30210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33466376161"
    website="https://www.vieuxcastillon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="All around, nothing but narrow medieval streets and fields of lavender. In this corner of Provence, bathed in light, this elegant restaurant – done out in the colours of the South of France – adheres to the seasons as it sources sun-kissed ingredients. At lunchtime, a simple menu; in the evening, fine dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Turion-Sabatier%2C%20Castillon-du-Gard%2C%2030210%2C%20France"
    pageTitle="Le Vieux Castillon"
  />
);

export default LeVieuxCastillon;
