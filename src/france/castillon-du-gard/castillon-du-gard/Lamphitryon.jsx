...
const Lamphitryon = () => (
  <RestaurantPage
    restaurantName="L'Amphitryon"
    address="Place du 8-Mai-1945, Castillon-du-Gard, 30210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33466370504"
    website="https://restaurant-lamphitryon.ovh/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%208-Mai-1945%2C%20Castillon-du-Gard%2C%2030210%2C%20France"
    pageTitle="L'Amphitryon"
  />
);

export default Lamphitryon;
