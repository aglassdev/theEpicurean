...
const Glaz = () => (
  <RestaurantPage
    restaurantName="Glaz"
    address="9 place de la République, Pont-Croix, 29790, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33298544347"
    website="https://guide.michelin.com/en/bretagne/pont-croix_1568702/restaurant/glaz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the village square, Glaz – a Breton word evoking the sea's shifting hues of green, blue, and grey – strikes a balance between old and new: wrought iron, earthenware and rugs sit alongside wood panelling, copper and plants. Tanios Nakhle Cerruti presides in the kitchen; Émeline Macé oversees the dining room and wine cellar. Born in Saint-Malo to an Italian mother and Lebanese father, the chef draws on his heritage and his travels to craft precise fusion bistronomy dishes with their roots in French culinary tradition. The menu showcases local ingredients, many organic, skilfully elevated with spices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20de%20la%20R%C3%A9publique%2C%20Pont-Croix%2C%2029790%2C%20France"
    pageTitle="Glaz"
  />
);
