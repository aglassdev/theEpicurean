...
const PetitGrillBasque = () => (
  <RestaurantPage
    restaurantName="Petit Grill Basque"
    address="4 rue Saint-Jacques, Saint-Jean-de-Luz, 64500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33559228795"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/saint-jean-de-luz/restaurant/petit-grill-basque"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Basque chef, Inaki Aizpitarte, of the Parisian Chateaubriand establishment, is breathing new life into this almost centennial institution. The restaurant’s rustic soul has been preserved after a subtle refurbishment that has retained its wooden shelves laden with decorative plates, original stencils by Louis Floutier and wooden punkah fans hanging from the ceiling. The concise bilingual (French-Basque) menu showcases a repertory of traditional, well-crafted, big-boned country dishes. You can expect a lineup of authentic local delicacies like tripe in cod or Biscay-style tuna, side by side bistro classics of the likes of beef tartare, steak in pepper sauce and chocolate mousse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Saint-Jacques%2C%20Saint-Jean-de-Luz%2C%2064500%2C%20France"
    pageTitle="Petit Grill Basque"
  />
);

export default PetitGrillBasque;
