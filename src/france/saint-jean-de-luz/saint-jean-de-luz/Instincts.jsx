...
const Instincts = () => (
  <RestaurantPage
    restaurantName="Instincts"
    address="20 rue Joseph-Garat, Saint-Jean-de-Luz, 64500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559246698"
    website="https://restaurant-instincts.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place run by a dynamic couple turns out to be a pleasant surprise. They are setting about putting a new spin on good old bistro cuisine, in a contemporary setting – exposed brickwork, wood and an open kitchen. Roast scallops, watercress and Ossau Iraty cheese; skate wing, parsley root and Grenobloise sauce: a real treat... and a top tip!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Joseph-Garat%2C%20Saint-Jean-de-Luz%2C%2064500%2C%20France"
    pageTitle="Instincts"
  />
);
