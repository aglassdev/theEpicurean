...
const Pluvise = () => (
  <RestaurantPage
    restaurantName="Pluviôse"
    address="3 rue du 17-Pluviôse, Saint-Jean-de-Luz, 64500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33667417807"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/saint-jean-de-luz/restaurant/pluviose"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Is this as revolutionary a restaurant as its name – a month in the calendar of the French Revolution – suggests? In any case, Australian chef Luke Dolphin (previously at the restaurant L'Antre in Bidart) certainly goes his own way. Working alone to cover both the restaurant floor and (small) kitchen equipped with a wood-fired oven, he cooks and serves up delicious cuisine that is both instinctive and contemporary, making everything from scratch (including the bread and ice cream). The cooking brings out the freshness of fish such as the just-seared red tuna and grouper cooked on one side. Opening times vary – booking essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20du%2017-Pluvi%C3%B4se%2C%20Saint-Jean-de-Luz%2C%2064500%2C%20France"
    pageTitle="Pluviôse"
  />
);

export default Pluvise;
