...
const LessentielSAI = () => (
  <RestaurantPage
    ...
    address="3 rue Vincent-Barjonnet, Saint-Jean-de-Luz, 64500, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33547024147"
    website="https://lessentiel-saint-jean-de-luz.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Off the beaten tourist track, chef Morgan Ortéga goes straight to the essentials: industrial loft interior, open kitchen, huge bay window, glazed wine cellar and leather bench seats. His talent and skill metamorphose market-fresh produce, enabling each ingredient to shout its name, to the delight of diners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Vincent-Barjonnet%2C%20Saint-Jean-de-Luz%2C%2064500%2C%20France"
    pageTitle="L'Essentiel"
  />
);

export default LessentielSAI;
