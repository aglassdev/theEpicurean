...
const LaGloireMON = () => (
  <RestaurantPage
    ...
    address="74 avenue du Général-de-Gaulle, Montargis, 45200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33238850469"
    website="https://www.lagloire-montargis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A venerable Montargis institution, located alongside the N7. For several generations, culinary tradition has been revisited with flair and generosity; do not miss out on the rather imposing dessert trolley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Montargis%2C%2045200%2C%20France"
    pageTitle="La Gloire"
  />
);

export default LaGloireMON;
