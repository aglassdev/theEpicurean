...
const Le11BistrotGourmand = () => (
  <RestaurantPage
    restaurantName="Le 11 Bistrot Gourmand"
    address="11 rue de Verdun, Pontchâteau, 44160, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33240422328"
    website="https://www.restaurant-le11.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Pontchâteau, this urban bistro is run by seasoned chef Gilles Charpy. Against a contemporary backdrop, he serves up appetising dishes made with market-fresh ingredients, such as white asparagus cream soup and Serrano; navarin d'agneau (lamb stew) and spring vegetables; choux chantilly with strawberries and rhubarb. Smiling service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20de%20Verdun%2C%20Pontch%C3%A2teau%2C%2044160%2C%20France"
    pageTitle="Le 11 Bistrot Gourmand"
  />
);

export default Le11BistrotGourmand;
