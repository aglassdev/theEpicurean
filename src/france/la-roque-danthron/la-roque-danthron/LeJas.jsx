...
const LeJas = () => (
  <RestaurantPage
    restaurantName="Le Jas"
    address="10 bis rue de l'Église, La Roque-d'Anthéron, 13640, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33442505058"
    website="https://www.lejas-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Roque-d'Anthéron's church is home to one of the world's best-known piano festivals. Hailing from the village, chef Émeric Corbon, who worked for Michel Kayser and Édouard Loubet, came up with the idea of opening this restaurant just a few metres from the church, in a converted dry-stone sheepfold (a jas in the Provençal dialect). Beneath the centuries-old vaulted ceilings or on the terrace, you can enjoy carefully prepared dishes with a clear Provençal influence: delicious aubergine papeton and tomato concassé with fresh herbs, basil coulis; tasty squab roasted whole, with the legs, gizzards and heart in a samosa, and a creamy pea sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20bis%20rue%20de%20l'%C3%89glise%2C%20La%20Roque-d'Anth%C3%A9ron%2C%2013640%2C%20France"
    pageTitle="Le Jas"
  />
);

export default LeJas;
