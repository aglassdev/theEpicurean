...
const LorangerieChteauDeLaBarbinire = () => (
  <RestaurantPage
    restaurantName="L'Orangerie - Château de la Barbinière"
    address="La Barbinière, Saint-Laurent-sur-Sèvre, 85290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251924600"
    website="https://www.chateau-barbiniere.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This appealing cuisine ticks all the boxes: quality ingredients, bold flavours and appetising presentations. A starter of delicate mushroom ravioli, ricotta, spinach and fried egg; a main dish of guinea fowl with porcini, herb gnocchi, chestnuts and Brussels sprouts. The restaurant is housed in a château – now a hotel – set in wooded grounds. Accommodated in a glass-paned extension, the dining room overlooks the gardens...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Barbini%C3%A8re%2C%20Saint-Laurent-sur-S%C3%A8vre%2C%2085290%2C%20France"
    pageTitle="L'Orangerie - Château de la Barbinière"
  />
);

export default LorangerieChteauDeLaBarbinire;
