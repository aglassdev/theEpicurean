...
const AuCurDeLaFort = () => (
  <RestaurantPage
    restaurantName="Au Cœur de la Forêt"
    address="Avenue du Repos-de-Diane, Montmorency, 95160, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33139649919"
    website="https://www.aucoeurdelaforet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming decor in two rustic rooms, one of which is very spacious with rafters and a fireplace. Shaded summer terrace. Simple, traditional menu in tune with the seasons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20du%20Repos-de-Diane%2C%20Montmorency%2C%2095160%2C%20France"
    pageTitle="Au Cœur de la Forêt"
  />
);

export default AuCurDeLaFort;
