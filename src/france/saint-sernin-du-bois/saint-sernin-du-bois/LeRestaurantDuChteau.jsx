...
const LeRestaurantDuChteau = () => (
  <RestaurantPage
    restaurantName="Le Restaurant du Château"
    address="2120 route de Saint-Sernin, Saint-Sernin-du-Bois, 71200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33385782842"
    website="https://lerestaurantduchateau71.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of the 11C château and facing the lake, the tastefully revamped interior of this restaurant is depicted by two vibes: historic vaults on one side and industrial overlooking a water feature on the other. The food features the same contrast between tradition and modernity. A genuine fine dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2120%20route%20de%20Saint-Sernin%2C%20Saint-Sernin-du-Bois%2C%2071200%2C%20France"
    pageTitle="Le Restaurant du Château"
  />
);

export default LeRestaurantDuChteau;
