...
const LaTableDeMentone = () => (
  <RestaurantPage
    restaurantName="La Table de Mentone"
    address="401 chemin de Mentone, Saint-Antonin-du-Var, 83510, France"
    cuisine="Provençal, Contemporary"
    priceRange="€€"
    phoneNumber="+33494044200"
    website="https://www.chateaumentone.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Sébastien Sanjou pops in from his nearby restaurant (Le Relais des Moines in Les Arcs-sur-Argens) to supervise the cooking at this fabulous restaurant set in the cellar of a wine estate, one of the finest in the Haut Var. As you take in the superlative surroundings (a panoramic landscape of vineyards and olive trees outside and a spacious designer-inspired interior), you can savour fine seasonal Provençal cuisine that makes the most of the estate's wide range of produce (courtesy of the hen house, orchard, vegetable garden, olive groves). For example, vegetable pot-au-feu with fresh herbs; stuffed saddle of rabbit with black olives and creamy polenta; baked pear with almonds and vanilla cream – washed down with a fine organic wine from the estate. A number of guestrooms are available ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=401%20chemin%20de%20Mentone%2C%20Saint-Antonin-du-Var%2C%2083510%2C%20France"
    pageTitle="La Table de Mentone"
  />
);

export default LaTableDeMentone;
