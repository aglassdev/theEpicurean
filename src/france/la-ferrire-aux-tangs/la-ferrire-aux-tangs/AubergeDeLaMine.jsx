...
const AubergeDeLaMine = () => (
  <RestaurantPage
    restaurantName="Auberge de la Mine"
    address="8 rue de Champsecret, La Ferrière-aux-Étangs, 61450, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33233669110"
    website="https://www.aubergedelamine.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Formerly the canteen of the local iron ore mine (closed in April 1970), this inn has been the haunt of the same chef for over 30 years. Trained classically, his watchword is simplicity and his food is the epitome of straightforward authenticity, albeit with flawless technique and inspired creativity. Examples include a knockout combination of foie gras, sparkling pear wine jelly and a spicy apple and pear chutney – culinary bliss! This enticing seasonal score is served in two stylishly sleek dining rooms that manage to avoid the stuffy formality that can be characteristic of such places… What a treat to go down the mine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20Champsecret%2C%20La%20Ferri%C3%A8re-aux-%C3%89tangs%2C%2061450%2C%20France"
    pageTitle="Auberge de la Mine"
  />
);

export default AubergeDeLaMine;
