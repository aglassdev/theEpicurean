...
const LeComptoirDeLaButte = () => (
  <RestaurantPage
    restaurantName="Le Comptoir de La Butte"
    address="12 rue de la Mer, Plouider, 29260, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33298254054"
    website="https://labutte.fr/"
    tags={[]}
    awards={[
    ...
    pageTitle="Le Comptoir de La Butte"
  />
);

export default LeComptoirDeLaButte;
