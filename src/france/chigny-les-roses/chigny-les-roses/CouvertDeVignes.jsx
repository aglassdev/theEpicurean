...
const CouvertDeVignes = () => (
  <RestaurantPage
    restaurantName="Couvert de Vignes"
    address="4 place Pommery, Chigny-les-Roses, 51500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33326058631"
    website="https://www.benjamingillescuisine.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The village of Chigny-les-Roses in the heart of the Montagne de Reims is the site of this restaurant in a former classroom, which is, indeed, entirely hemmed in by vineyards. Chef Benjamin Gilles can be seen in the kitchen through a window in the dining room. Now his own boss, he signs modern dishes overflowing in fresh flavours and enhanced by a zest of creativity. Vegetables and fruit feature prominently in his culinary score through a variety of preparations (raw, cooked, pickled)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20place%20Pommery%2C%20Chigny-les-Roses%2C%2051500%2C%20France"
    pageTitle="Couvert de Vignes"
  />
);

export default CouvertDeVignes;
