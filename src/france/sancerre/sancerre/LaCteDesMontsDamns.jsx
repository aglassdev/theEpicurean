...
const LaCteDesMontsDamns = () => (
  <RestaurantPage
    restaurantName="La Côte des Monts Damnés"
    address="12 place de l'Orme, à Chavignol, Sancerre, 18300, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33248540172"
    website="https://www.hotel-restaurant-chavignol.fr/fr/famille-bourgeois-sancerre-france/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Always in synergy with the wines from the Bourgeois family winegrowing estate, the bistronomy menu particularly showcases the local terroir: green lentils from Berry and smoked bacon, roast quail in chestnut leaves and a reduction of the estate's grape juice; Sancerre croquettes with a cloud of vanilla and raspberry sorbet – pure indulgence. They also have comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20place%20de%20l'Orme%2C%20%C3%A0%20Chavignol%2C%20Sancerre%2C%2018300%2C%20France"
    pageTitle="La Côte des Monts Damnés"
  />
);

export default LaCteDesMontsDamns;
