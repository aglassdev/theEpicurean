...
const LePressoir = () => (
  <RestaurantPage
    restaurantName="Le Pressoir"
    address="7 rue de l'Hôpital, Saint-Avé, 56890, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+33297608763"
    website="https://www.le-pressoir.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20de%20l'H%C3%B4pital%2C%20Saint-Av%C3%A9%2C%2056890%2C%20France"
    pageTitle="Le Pressoir"
  />
);

export default LePressoir;
