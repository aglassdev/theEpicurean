...
const LeCygne = () => (
  <RestaurantPage
    restaurantName="Le Cygne"
    address="35 Grande-Rue, Gundershoffen, 67110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33388729643"
    website="http://www.aucygne.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This picturesque half-timbered Alsace edifice has successfully kept pace with the times and its experienced chef conjures up modern, bistro dishes. Examples include the signature fish casserole with aïoli croutons, or spice-crusted lamb cutlet and fillet with braised vegetables and chickpea cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Grande-Rue%2C%20Gundershoffen%2C%2067110%2C%20France"
    pageTitle="Le Cygne"
  />
);

export default LeCygne;
