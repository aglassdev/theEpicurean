...
const LesJardinsDuMoulin = () => (
  <RestaurantPage
    restaurantName="Les Jardins du Moulin"
    address="7 rue du Moulin, Gundershoffen, 67110, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33388075270"
    website="https://www.jardinsdumoulin.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant blends perfectly into the setting of the mill. Through the bay windows, one can admire the garden and magnificent terrace. Diners can look forward to well - crafted creations from the carpaccio of sea bream with citrus olive oil to the fillet of Simmental beef, béarnaise au siphon and buewespaetzle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Moulin%2C%20Gundershoffen%2C%2067110%2C%20France"
    pageTitle="Les Jardins du Moulin"
  />
);

export default LesJardinsDuMoulin;
