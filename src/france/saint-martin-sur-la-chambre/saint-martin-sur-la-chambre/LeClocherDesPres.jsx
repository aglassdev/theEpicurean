...
const LeClocherDesPres = () => (
  <RestaurantPage
    restaurantName="Le Clocher des Pères"
    address="Le Mollard, 80 impasse du Four, Saint-Martin-sur-la-Chambre, 73130, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33479599806"
    website="https://www.chambres-d-hote-maurienne-le-clocher-des-peres.fr/fr/m_1_accueil.php"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a peaceful hamlet at an altitude of 600m and occupying a former 15C stronghold, the cosy, warm interior is depicted by stone walls and picture windows overlooking the Belledonne mountains. You are greeted by five immaculately laid round tables in a room bathed in light, ready for an encounter between nature and good food. Pierre Troccaz signs a carefully curated, inventive score, mingling local produce, aromatic herbs from the garden and a few well-chosen exotic notes, embodied by blue lobster flanked by a frothy espuma of Beaufort cheese and fragrant confit tomatoes. Regional specialties such as caïon (pork) in wild garlic and a crunchy-melt-in-the-mouth stuffing are emblematic of the chef’s passion and enthusiasm. His wife, Éloïse, warmly and seamlessly pampers diners. Pleasant guestr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Mollard%2C%2080%20impasse%20du%20Four%2C%20Saint-Martin-sur-la-Chambre%2C%2073130%2C%20France"
    pageTitle="Le Clocher des Pères"
  />
);

export default LeClocherDesPres;
