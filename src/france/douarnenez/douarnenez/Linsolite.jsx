...
const Linsolite = () => (
  <RestaurantPage
    restaurantName="L'Insolite"
    address="4 rue Jean-Jaurès, Douarnenez, 29100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33298920002"
    website="https://www.lafrance-dz.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Jean-Jaur%C3%A8s%2C%20Douarnenez%2C%2029100%2C%20France"
    pageTitle="L'Insolite"
  />
);

export default Linsolite;
