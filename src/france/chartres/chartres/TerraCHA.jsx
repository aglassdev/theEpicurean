...
const TerraCHA = () => (
  <RestaurantPage
    ...
    address="65 avenue du Maréchal-Maunoury, Chartres, 28000, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33237848147"
    website="https://www.terrachartres.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A short walk from the city centre, in the suburbs of Chartres, the husband-and-wife team behind Terra (he is an Italian chef and she is a South African pastry chef) extend an invitation to join them on a culinary journey. The excellent and quintessentially Italian cuisine is served in a friendly atmosphere – the fiorentina-style cannelloni stuffed with veal and spinach and the house parmesan sauce is delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=65%20avenue%20du%20Mar%C3%A9chal-Maunoury%2C%20Chartres%2C%2028000%2C%20France"
    pageTitle="Terra"
  />
);

export default TerraCHA;
