...
const LaSuiteBOU = () => (
  <RestaurantPage
    ...
    address="50 rue Bourbonnoux, Bourges, 18000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33248659626"
    website="https://www.lasuite-bourges.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fashionably stylish modern interior sets the scene in this warm, friendly eatery. The regularly renewed seasonal menu will make your mouth water... before the flavours and aromas satisfy your tastebuds and obliterate your hunger pangs. Let's not forget the pretty patio terrace or the wine list that leaves nothing to chance – the owner is a trained sommelier, while his brother is in charge of the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20rue%20Bourbonnoux%2C%20Bourges%2C%2018000%2C%20France"
    pageTitle="La Suite"
  />
);

export default LaSuiteBOU;
