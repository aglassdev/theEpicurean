...
const LeBeauvoir = () => (
  <RestaurantPage
    restaurantName="Le Beauvoir"
    address="1 avenue Marx-Dormoy, Bourges, 18000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33248654244"
    website="https://www.restaurant-lebeauvoir.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Annie and Mickaël Landaud are at the helm of an elegant family establishment which is quite a favourite with the locals. The bluish tones and plant-inspired artwork pay homage to the nearby marshlands… The chef conjures up modern, appetising dishes, adding a playful new spin to a traditional Gallic score. Alfresco dining in the rear courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20avenue%20Marx-Dormoy%2C%20Bourges%2C%2018000%2C%20France"
    pageTitle="Le Beauvoir"
  />
);

export default LeBeauvoir;
