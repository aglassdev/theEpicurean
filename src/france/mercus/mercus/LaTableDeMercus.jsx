...
const LaTableDeMercus = () => (
  <RestaurantPage
    restaurantName="La Table de Mercuès"
    address="Château de Mercuès, route du Château, Mercuès, 46090, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33565200001"
    website="https://chateaudemercues.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on a clifftop overlooking the Lot valley, this Renaissance castle is a majestic setting for contemporary fine dining and luxurious guestrooms. Tuck into delicious cuisine based on premium ingredients such as lobster, foie gras and Quercy pigeon, combined with more traditional local produce such as chanterelles and Rocamadour cheese. A single multi-course tasting menu is served in a refined interior set up within centuries-old stone walls. Chef Clément Costes devises a precise menu of perfectly cooked dishes, such as roast pigeon, which can be accompanied by one of the estate's fine wines. In fine weather, guests can dine on the terrace in the main courtyard. A more bistronomy-style offering is served at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Mercu%C3%A8s%2C%20route%20du%20Ch%C3%A2teau%2C%20Mercu%C3%A8s%2C%2046090%2C%20France"
    pageTitle="La Table de Mercuès"
  />
);

export default LaTableDeMercus;
