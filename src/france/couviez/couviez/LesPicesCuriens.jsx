...
const LesPicesCuriens = () => (
  <RestaurantPage
    restaurantName="Les Épices Curiens"
    address="3b place de la Gare, Écouviez, 55600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33329868458"
    website="https://www.lesepicescuriens.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When strolling around the area you could easily cross over into Belgium without realising it. But the former train station of this border village, since converted into a lovely restaurant, will encourage you to stay in France. Sample the inspired cuisine and nicely prepared dishes, all paired with good local wines. Lots of taste!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3b%20place%20de%20la%20Gare%2C%20%C3%89couviez%2C%2055600%2C%20France"
    pageTitle="Les Épices Curiens"
  />
);

export default LesPicesCuriens;
