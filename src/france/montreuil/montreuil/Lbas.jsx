...
const Lbas = () => (
  <RestaurantPage
    restaurantName="Là-bas"
    address="1 rue du Sergent-Godefroy, Montreuil, 93100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33188504416"
    website="https://guide.michelin.com/en/ile-de-france/montreuil-ile-de-france/restaurant/la-bas"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone's throw from Croix de Chavaux metro station, this new kid on the block catches the eye. The large dining space has a fireplace, original wooden floorboards, a sofa, mismatched upcycled furniture, vintage knick-knacks; there is an old piano in the next room, and the kitchen is located at the entrance. On sunny days, the terrace on the patio is a treat. Founded by four partners, including the owner of the Des Terres restaurant in Paris, this establishment prides itself on its modern, convivial cuisine, with dishes to share and a five-course set menu in the evening. The cellar is quite something, with over 1 200 wines, some produced by young French vintners, others abroad; expert recommendations from the sommelier...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20du%20Sergent-Godefroy%2C%20Montreuil%2C%2093100%2C%20France"
    pageTitle="Là-bas"
  />
);
