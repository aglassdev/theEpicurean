...
const LeBistrotDuChteau = () => (
  <RestaurantPage
    restaurantName="Le Bistrot du Château"
    address="Château de Montreuil, 4 chaussée des Capucins, Montreuil, 62170, France"
    ...
    bio="This Montreuil-sur-Mer institution now revolves around bistronomy: think citrus-marinated sea bream ceviche, marrowbone with parsley, sea bass fillet and leek fondue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Montreuil%2C%204%20chauss%C3%A9e%20des%20Capucins%2C%20Montreuil%2C%2062170%2C%20France"
    pageTitle="Le Bistrot du Château"
  />
);

export default LeBistrotDuChteau;
