...
const LaGrangeDesAgapes = () => (
  <RestaurantPage
    restaurantName="La Grange des Agapes"
    address="7 rue du 11-Novembre, Cogolin, 83310, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33494546097"
    website="https://www.grangeagapes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Like every true enthusiast, Thierry Barot is a master of multi - tasking. Not content to offer tasty and appetising theme - based menus (vegetables, Provence, asparagus, truffles etc), he regularly runs cookery classes and is the author of a book of chocolate recipes. What a feast!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%2011-Novembre%2C%20Cogolin%2C%2083310%2C%20France"
    pageTitle="La Grange des Agapes"
  />
);

export default LaGrangeDesAgapes;
