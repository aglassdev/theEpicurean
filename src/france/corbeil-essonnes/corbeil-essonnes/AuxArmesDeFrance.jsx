...
const AuxArmesDeFrance = () => (
  <RestaurantPage
    restaurantName="Aux Armes de France"
    address="1 boulevard Jean-Jaurès, Corbeil-Essonnes, 91100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33160892710"
    website="https://aux-armes-de-france.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former coaching inn run by Yohann Giraud, a chef who has worked in several Michelin-starred restaurants, has a pleasantly hushed atmosphere. On the menu: dishes bursting with flavour, such as the signature macaroni stuffed with foie gras, celeriac and tartufata au gratin with parmesan, cream and a veal jus, or the oh-so-delicate millefeuille with a caramel sauce. The charming service completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20boulevard%20Jean-Jaur%C3%A8s%2C%20Corbeil-Essonnes%2C%2091100%2C%20France"
    pageTitle="Aux Armes de France"
  />
);

export default AuxArmesDeFrance;
