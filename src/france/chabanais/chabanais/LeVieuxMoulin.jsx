...
const LeVieuxMoulin = () => (
  <RestaurantPage
    restaurantName="Le Vieux Moulin"
    address="Étang du Bouchaud, Chabanais, 16150, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33545842497"
    website="https://www.levieuxmoulin-chabanais.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant housed in an old mill sports a cheerful interior and a splendid fireplace for cosy winter moments. In summer, the riverside terrace is the perfect spot to dig into appetising, market-fresh food, whose original and well-crafted recipes focus on locally sourced produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%89tang%20du%20Bouchaud%2C%20Chabanais%2C%2016150%2C%20France"
    pageTitle="Le Vieux Moulin"
  />
);

export default LeVieuxMoulin;
