...
const MaisonChenetEntreVigneEtGarrigue = () => (
  <RestaurantPage
    restaurantName="Maison Chenet - Entre Vigne et Garrigue"
    address="600 chemin des Falaises, Pujaut, 30131, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33490952029"
    website="https://www.maison-chenet.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Near Avignon, this remote Provençal farmhouse set between cliffs and vineyards does not compromise on authenticity. The scents of the garrigue fill the tastefully renovated interior, which sports a harmonious blend of period details and modern fittings. In the kitchen, Maxime is assisted by his father, Serge Chenet, Meilleur Ouvrier de France. The pair share a love of all things natural and the seasonal ingredients bursting with the flavours of this sun-drenched region. These Bretons, who haven't turned their backs on the staples of butter and cream, work together to concoct a tasty Provençal-inspired market-fresh cuisine: Mediterranean red mullet fillet in a fennel rouille, bouillabaisse jus; duo of strawberries and black olive confit, olive oil ice cream, tapenade madeleine. Housed in a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=600%20chemin%20des%20Falaises%2C%20Pujaut%2C%2030131%2C%20France"
    pageTitle="Maison Chenet - Entre Vigne et Garrigue"
  />
);

export default MaisonChenetEntreVigneEtGarrigue;
