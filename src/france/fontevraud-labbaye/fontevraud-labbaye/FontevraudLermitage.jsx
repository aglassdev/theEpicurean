...
const FontevraudLermitage = () => (
  <RestaurantPage
    restaurantName="Fontevraud L'Ermitage"
    address="38 rue Saint-Jean-de-l'Habit, Fontevraud-l'Abbaye, 49590, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33246461010"
    website="https://www.fontevraud.fr"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Saint Lazare Priory is located in the heart of Fontevraud Abbey, one of Europe’s largest monastic complexes. The former’s cloisters have been morphed into a restaurant by designer Patrick Jouin and architect Sanjit Manku, who have staged a marriage between monastic minimalism and untreated materials to set the scene for Thibaut Ruggeri’s cooking. The latter, who hails from Megève and who won the Bocuse d’Or 2013, learnt the trade with iconic culinary names from Michel Guérard to Georges Blanc. A champion of good food and biodynamic farming, local produce takes pride of place (Racan poultry, Anjou pigeon) in a menu that keeps pace with his garden’s production and the moon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20Saint-Jean-de-l'Habit%2C%20Fontevraud-l'Abbaye%2C%2049590%2C%20France"
    pageTitle="Fontevraud L'Ermitage"
  />
);

export default FontevraudLermitage;
