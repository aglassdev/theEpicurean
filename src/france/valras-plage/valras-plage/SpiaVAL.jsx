...
const SpiaVAL = () => (
  <RestaurantPage
    restaurantName="Sépia"
    address="28 rue Frédéric-Mistral, Valras-Plage, 34350, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33764368111"
    website="https://www.restaurant-sepia-valras.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This little eatery near the beach is perfect for lunch. It is run by a pair of catering pros – she is in the dining room while her hubbie, who boasts stints in fine restaurants, helms the kitchen. Whether in the dining space with its maritime decor, or on the lovely timber-decked terrace, you will sample vibrant, legible food that warms the soul: tartare of sea bream fished off the coast of Valras; pollock, aioli and black rice; creamy coconut and pineapple marinated in ginger...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20Fr%C3%A9d%C3%A9ric-Mistral%2C%20Valras-Plage%2C%2034350%2C%20France"
    pageTitle="Sépia"
  />
);

export default SpiaVAL;
