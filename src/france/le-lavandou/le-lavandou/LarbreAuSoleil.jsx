...
const LarbreAuSoleil = () => (
  <RestaurantPage
    restaurantName="L'Arbre au Soleil"
    address="Nouveau Port, Le Lavandou, 83980, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33494240604"
    website="https://www.larbreausoleil.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="We first met Yorann Vandreissche by the cobblestones of the Paris-Roubaix race, at the Carrefour de l'Arbre. After five successful years there, he is now basking in the sunshine at L'Arbre au Soleil, opposite Le Lavandou marina. He shines the spotlight on premium quality produce in a menu that displays a distinct penchant for fish and seafood, e.g. raviole of blue crab or lobster with a purple-tipped asparagus-flavoured béarnaise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nouveau%20Port%2C%20Le%20Lavandou%2C%2083980%2C%20France"
    pageTitle="L'Arbre au Soleil"
  />
);

export default LarbreAuSoleil;
