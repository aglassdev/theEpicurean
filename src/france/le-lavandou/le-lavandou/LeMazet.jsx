...
const LeMazet = () => (
  <RestaurantPage
    ...
    address="1 chemin de la Cascade, Le Lavandou, 83980, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+33494928861"
    website="https://www.lemazet.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Patrice Hardy, former Michelin-starred chef from Neuilly, has donned his apron again and is working alongside his charming wife, Corinne. At Le Mazet, just off Saint-Clair beach, he indulges in his favourite pastime: working with fine produce (in particular his beloved truffles). The dishes are harmony on a plate: iced velouté of Coco de Paimpol haricot beans, tomatoes, mini-croûtons and aromatic oil; crispy farm-reared pork; roast pineapple tart and sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20chemin%20de%20la%20Cascade%2C%20Le%20Lavandou%2C%2083980%2C%20France"
    pageTitle="Le Mazet"
  />
);

export default LeMazet;
