...
const LesTamarisChezRaymond = () => (
  <RestaurantPage
    restaurantName="Les Tamaris - Chez Raymond"
    address="Boulevard de la Baleine, Le Lavandou, 83980, France"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+33494710722"
    website="https://guide.michelin.com/en/provence-alpes-cote-dazur/le-lavandou/restaurant/les-tamaris-chez-raymond"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bourride, stuffed capon, grilled Mediterranean langouste, and, above all, the iconic bouillabaisse cooked over a wood fire. Under the watchful eye of its colourful boss, Raymond, the local catch of the day takes pride of place in this iconic institution on Saint-Clair beach. The terrace overlooking the sea is exquisite – so remember to ask for a seat here when you book (compulsory)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boulevard%20de%20la%20Baleine%2C%20Le%20Lavandou%2C%2083980%2C%20France"
    pageTitle="Les Tamaris - Chez Raymond"
  />
);

export default LesTamarisChezRaymond;
