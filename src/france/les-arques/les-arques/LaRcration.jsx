...
const LaRcration = () => (
  <RestaurantPage
    restaurantName="La Récréation"
    address="70 rue de la Vialotte, Le Bourg, Les Arques, 46250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565228808"
    website="https://www.la-recreation-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="School’s out! In its place, this gently nostalgic establishment has a classroom - style dining room, courtyard terrace and kitchen garden in the old playground. Contemporary cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20rue%20de%20la%20Vialotte%2C%20Le%20Bourg%2C%20Les%20Arques%2C%2046250%2C%20France"
    pageTitle="La Récréation"
  />
);

export default LaRcration;
