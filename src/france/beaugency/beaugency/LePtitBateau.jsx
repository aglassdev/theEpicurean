...
const LePtitBateau = () => (
  <RestaurantPage
    restaurantName="Le P'tit Bateau"
    address="54 rue du Pont, Beaugency, 45190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33238445638"
    website="https://www.restaurant-lepetitbateau.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the medieval city, Le P'tit Bateau sets out to tantalise our taste buds with fresh produce, including fish sourced directly from Brittany's fish markets, as well as game from Sologne in season. The dishes are generous, precise, carefully presented and tasty. It is worth noting there is a pleasant patio for a meal al fresco. An eatery committed to doing a good job...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20rue%20du%20Pont%2C%20Beaugency%2C%2045190%2C%20France"
    pageTitle="Le P'tit Bateau"
  />
);

export default LePtitBateau;
