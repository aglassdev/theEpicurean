...
const LeJulianon = () => (
  <RestaurantPage
    restaurantName="Le Julianon"
    address="5 place Gérard-de-Nerval, Senlis, 60300, France"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+33344321205"
    website="https://www.le-julianon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The contemporary bistro decor of this charming 17C house sets the scene for the chef’s inventive dishes that tactfully play on combinations of texture and flavour, such as cuttlefish, kohlrabi, romaine lettuce and coppa ham, or raspberries, organic polenta from Piedmont and Columbian coffee. The menu changes daily, depending on market availability...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20G%C3%A9rard-de-Nerval%2C%20Senlis%2C%2060300%2C%20France"
    pageTitle="Le Julianon"
  />
);

export default LeJulianon;
