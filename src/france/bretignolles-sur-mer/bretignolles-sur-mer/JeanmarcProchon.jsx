...
const JeanmarcProchon = () => (
  <RestaurantPage
    restaurantName="Jean-Marc Pérochon"
    address="63 avenue de la Grande-Roche, Bretignolles-sur-Mer, 85470, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33251336553"
    website="https://www.lesbrisants.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Seated behind the restaurant’s floor to ceiling windows, admire the sun’s rays glinting on the ocean. A talented skipper has dropped anchor here in the person of Jean-Marc Pérochon who went to sea at 17, crossing the channel to Scotland, before cruising around Europe and as far as the West Indies. In his hotel-restaurant, his cooking is both minimalist and sprinkled with exotic flavours, extractions, stocks and emulsions, leaving our tastebuds aching for more. He believes in working only with first-rate goods, namely fish and shellfish from the fish auction at Saint-Gilles-Croix-de-Vie (which dominate the menu), but also Challans poultry and vegetables from local growers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=63%20avenue%20de%20la%20Grande-Roche%2C%20Bretignolles-sur-Mer%2C%2085470%2C%20France"
    pageTitle="Jean-Marc Pérochon"
  />
);

export default JeanmarcProchon;
