...
const LaCanope = () => (
  <RestaurantPage
    restaurantName="La Canopée"
    address="2 allée du Pigeonnier, Villevieille, 30250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466359720"
    website="https://www.chateaudepondres.fr/le-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this vaulted Renaissance former weapons room (5m high! ), diners sample cuisine that fetes the Cévennes and Camargue regions. It is accompanied by a nice selection of minor wines from the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20all%C3%A9e%20du%20Pigeonnier%2C%20Villevieille%2C%2030250%2C%20France"
    pageTitle="La Canopée"
  />
);

export default LaCanope;
