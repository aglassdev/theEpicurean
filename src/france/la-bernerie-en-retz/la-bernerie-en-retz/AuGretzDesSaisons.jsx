...
const AuGretzDesSaisons = () => (
  <RestaurantPage
    restaurantName="Au G'Retz des Saisons"
    address="17 rue Jean-Duplessis, La Bernerie-en-Retz, 44760, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251746160"
    website="https://www.augretzdessaisons.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Well-travelled young chef Samuel Duchêne aligns his cooking with the seasons. His short menu, which changes every month, showcases first and foremost local Pays de Retz farmers and artisans – fish, free-range eggs, sea salt. Beetroot marinated in cider, confit egg yolk, watercress coulis or fillet of sea bass, carrot, coconut emulsion, turmeric: hard work, audacity and flavour. The house-made bread is very good, too. Limited capacity, so it's best to book in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20Jean-Duplessis%2C%20La%20Bernerie-en-Retz%2C%2044760%2C%20France"
    pageTitle="Au G'Retz des Saisons"
  />
);

export default AuGretzDesSaisons;
