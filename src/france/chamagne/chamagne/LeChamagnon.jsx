...
const LeChamagnon = () => (
  <RestaurantPage
    restaurantName="Le Chamagnon"
    address="236 rue Claude-Gellée, Chamagne, 88130, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33329381474"
    website="https://www.restaurantlechamagnon.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the village where artist Claude Lorrain was born, this snug bistro serves bang-on French country cooking (a juicy fillet of Hereford beef and home-made béarnaise sauce, sweetbread with morels and a crème brûlée worthy of Amélie Poulain), dotted with modern touches (red tuna and seasonings). Top-notch produce and a savvy wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=236%20rue%20Claude-Gell%C3%A9e%2C%20Chamagne%2C%2088130%2C%20France"
    pageTitle="Le Chamagnon"
  />
);

export default LeChamagnon;
