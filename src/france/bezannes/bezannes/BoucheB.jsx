...
const BoucheB = () => (
  <RestaurantPage
    restaurantName="Bouche B"
    address="9 rue Jean-Dausset, Bezannes, 51430, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33326351937"
    website="https://restaurant-bouche-b.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Bouche B on the Place Gourmande of this village near Reims is the HQ of chef Thibault Laplaige (previously Michelin starred in Reims). His modern, well-crafted dishes rely on top-drawer produce such as tartare of scallops and fennel with soy vinaigrette or braised Black Angus in a sort of “applejack” jus with buttered green cabbage. Bouche B for Bon!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Jean-Dausset%2C%20Bezannes%2C%2051430%2C%20France"
    pageTitle="Bouche B"
  />
);

export default BoucheB;
