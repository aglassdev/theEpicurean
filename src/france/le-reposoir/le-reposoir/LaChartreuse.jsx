...
const LaChartreuse = () => (
  <RestaurantPage
    restaurantName="La Chartreuse"
    address="622 route de Béol, Le Reposoir, 74950, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450981711"
    website="https://www.lachartreuse74.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This village on the road to the Alps has long benefited from the generosity of the Carthusian monks, after whom the restaurant is named. The menu features well-executed modern cuisine that makes the most of seasonal (and often local) ingredients. The ever-popular 64°C egg is beautifully paired with a tempting medley of mushrooms; the classic beef chuck is slowly simmered in Mondeuse and gentian as well as cervelle de canut (a herby cheese spread); the craquelin chou pastry is served with Grenoble walnut praline, hazelnut ice cream and melted chocolate – comfort food that uplifts the spirits! Vegetarian menu available. Large terrace in the heart of the village...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=622%20route%20de%20B%C3%A9ol%2C%20Le%20Reposoir%2C%2074950%2C%20France"
    pageTitle="La Chartreuse"
  />
);

export default LaChartreuse;
