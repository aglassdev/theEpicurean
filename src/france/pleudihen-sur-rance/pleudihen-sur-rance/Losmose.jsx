...
const Losmose = () => (
  <RestaurantPage
    restaurantName="L'Osmose"
    address="7 place de l'Église, Pleudihen-sur-Rance, 22690, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33296833875"
    website="https://www.restaurant-losmose.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Star-studded chef, Ludovic Dirscheri, has set up shop in this picture postcard Brittany village. His refined bill of fare mingles local and exotic inspirations. Carpaccio of scallops in olive oil with a coulis of beetroot, loin of roast boar flanked by cream of parsnips and a red wine gravy, or a pistachio flavoured kouign-amann with halva ice cream are just some of the dishes from the enticing, well-crafted menu. The interior sports untreated wood cladding and bare local stone walls, creating a cosy setting that is ideal to sample a tasting menu that won’t break the bank...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20de%20l'%C3%89glise%2C%20Pleudihen-sur-Rance%2C%2022690%2C%20France"
    pageTitle="L'Osmose"
  />
);

export default Losmose;
