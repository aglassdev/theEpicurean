...
const AuFlamron = () => (
  <RestaurantPage
    restaurantName="Au Flaméron"
    address="236 rue Martainville, Rouen, 76000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33987364424"
    website="https://www.auflameron.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a cobbled lane opposite the church, Église St Maclou, a new gourmet haven awaits foodies in the historical heart of Rouen. Japanese chef Takahiro Oikawa, a devotee of French gastronomy, cooks up his brand of seasonal French cuisine, infused with Japanese accents. He crafts wonderfully vibrant no-nonsense dishes, such as pâté en croûte with confit octopus and yuzu, aubergine-miso dip, karaage-style veal sweetbreads, followed by silky custard tart for dessert: this chef has mastered every aspect of his art...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=236%20rue%20Martainville%2C%20Rouen%2C%2076000%2C%20France"
    pageTitle="Au Flaméron"
  />
);

export default AuFlamron;
