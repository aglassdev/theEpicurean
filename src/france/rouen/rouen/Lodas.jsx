...
const Lodas = () => (
  <RestaurantPage
    restaurantName="L'Odas"
    address="4 passage Maurice-Lenfant, Rouen, 76000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33235738324"
    website="https://www.lodas.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In an ideal location in the heart of the old town, this restaurant has three areas: the main dining room with a view into the kitchen, a pleasantly secluded terrace and Le Balcon de l'Odas, a private lounge with a view of the cathedral. Suzanne Da Silva's bold seasonal cuisine highlights both her origins in the north of France and ingredients from Normandy's terroir: the vegetables come from a market gardener in the Eure, mussels from Mont-Saint-Michel, saffron from the Pays de Caux... and she puts it all to good use in a cleverly devised surprise set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20passage%20Maurice-Lenfant%2C%20Rouen%2C%2076000%2C%20France"
    pageTitle="L'Odas"
  />
);
