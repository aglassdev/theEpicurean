...
const OlivierLeflaive = () => (
  <RestaurantPage
    restaurantName="Olivier Leflaive"
    address="10 place du Monument, Puligny-Montrachet, 21190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33380219527"
    website="https://hotel.olivier-leflaive.com/restaurant-klima/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A plush house in the centre of the village, a glass-paned wine cellar, a bar with an Art Deco look, a chic and inviting dining room: welcome to Olivier Leflaive's place! The famous Côte de Beaune winegrower has created two eateries. Le Bistro d'Olivier offers a seasonal menu inspired by local produce, and the restaurant Klima has more fine dining ambitions. Great wine list, needless to say, thanks to the estate's 80 appellations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20du%20Monument%2C%20Puligny-Montrachet%2C%2021190%2C%20France"
    pageTitle="Olivier Leflaive"
  />
);

export default OlivierLeflaive;
