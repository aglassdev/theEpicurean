...
const LeMontrachet = () => (
  <RestaurantPage
    restaurantName="Le Montrachet"
    address="10 place du Pasquier-de-la-Fontaine, Puligny-Montrachet, 21190, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33380213006"
    website="https://www.comohotels.com/burgundy/como-le-montrachet"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Classic refinement: the description is equally applicable to the restaurant – all exposed stonework and beams – and the seasonal cuisine. This is prepared by a chef who has cut his teeth in some leading restaurants and displays his skills with care and elegance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20du%20Pasquier-de-la-Fontaine%2C%20Puligny-Montrachet%2C%2021190%2C%20France"
    pageTitle="Le Montrachet"
  />
);

export default LeMontrachet;
