...
const Gribiche = () => (
  <RestaurantPage
    restaurantName="Gribiche"
    address="9 rue Max-Richard, Angers, 49100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33241191448"
    website="https://guide.michelin.com/en/pays-de-la-loire/angers/restaurant/gribiche"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We fell head over heels with this lovely bistro! The blackboard features a fresh and generous take on traditional dishes that will make your taste buds go wild: pâté en croûte; calf's head with gribiche sauce; saddle of rabbit, potato purée, mustard sauce; game in season, not forgetting a vegetarian offering. Fine choice of reasonably priced tipples. Reservations recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Max-Richard%2C%20Angers%2C%2049100%2C%20France"
    pageTitle="Gribiche"
  />
);

export default Gribiche;
