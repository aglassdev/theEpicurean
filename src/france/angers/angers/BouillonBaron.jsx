...
const BouillonBaron = () => (
  <RestaurantPage
    restaurantName="Bouillon Baron"
    address="11 avenue Marie-Talet, Angers, 49100, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33241433479"
    website="https://guide.michelin.com/en/pays-de-la-loire/angers/restaurant/bouillon-baron"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jérémie Baron, the former chef-patron of Autour d'un Cep, has set up shop in this building dating back to 1895. In a simple setting with a buzzing atmosphere, he regales a packed house of enthusiastic diners with traditional and popular recipes, such as terrine de campagne with pickles; œuf mimosa (devilled eggs), beetroot and vinaigrette; saucisse de Toulouse; calf's head with ravigote sauce; and chocolat choux craquelin (cream puffs) with pecans for dessert. The lunch menu, featured on the blackboard, is unbeatable value. A selection of organic and biodynamic wines principally from the Loire Valley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20avenue%20Marie-Talet%2C%20Angers%2C%2049100%2C%20France"
    pageTitle="Bouillon Baron"
  />
);

export default BouillonBaron;
