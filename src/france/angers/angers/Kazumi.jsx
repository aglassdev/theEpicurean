...
const Kazumi = () => (
  <RestaurantPage
    restaurantName="Kazumi"
    address="3 rue d'Anjou, Angers, 49100, France"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+33253572142"
    website="https://www.restaurant-kazumi.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese-born Kazumi Hatakenaka originally came to France to work in a traditional inn in the Beaujolais region. Behind his counter, he now crafts a tasting menu devoted entirely to pedigree Japanese cuisine that is the epitome of delicate and fresh. Drool-worthy dishes and flawless cooking and seasonings. Expect to spend three hours to do full justice to this culinary experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20d'Anjou%2C%20Angers%2C%2049100%2C%20France"
    pageTitle="Kazumi"
  />
);

export default Kazumi;
