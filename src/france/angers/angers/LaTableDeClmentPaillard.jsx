...
const LaTableDeClmentPaillard = () => (
  <RestaurantPage
    restaurantName="La Table de Clément Paillard"
    address="5 rue Saint-Christophe, Angers, 49100, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33241600509"
    website="https://www.clementpaillard.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary restaurant is housed in a modern building opposite Cathédrale St Maurice, with large picture windows affording views onto the historical edifice. The bright, intimate space complete with open kitchen has blue-grey carpeting and light wood tables. Clément Paillard, formerly at Aux Jeunes Pousses, is at the helm, dedicated to creative, seasonal cooking made with local produce. Plays on textures are a feature in dishes such as veal sweetbreads and artichokes, wasabi peas, and sole with asparagus purée, tempura and brunoise. In the evening, there is a more ambitious tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Saint-Christophe%2C%20Angers%2C%2049100%2C%20France"
    pageTitle="La Table de Clément Paillard"
  />
);

export default LaTableDeClmentPaillard;
