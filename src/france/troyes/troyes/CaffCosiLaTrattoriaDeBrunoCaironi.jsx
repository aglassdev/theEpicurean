...
const CaffCosiLaTrattoriaDeBrunoCaironi = () => (
  <RestaurantPage
    restaurantName="Caffè Cosi - La trattoria de Bruno Caironi"
    address="5 rue Marie-Pascale-Ragueneau, Troyes, 10000, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33325766134"
    website="https://www.caffecosi-caironi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Of Italian and Mediterranean inspiration, this colourful contemporary trattoria, housed in a former art gallery, overlooks a cobbled courtyard. We fell in love with the risotto with French green peas and different textures of guanciale – to die for! Before leaving, pop into the gourmet grocery store and stock up on first-rate Italian goodies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Marie-Pascale-Ragueneau%2C%20Troyes%2C%2010000%2C%20France"
    pageTitle="Caffè Cosi - La trattoria de Bruno Caironi"
  />
);

export default CaffCosiLaTrattoriaDeBrunoCaironi;
