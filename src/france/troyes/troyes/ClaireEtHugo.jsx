...
const ClaireEtHugo = () => (
  <RestaurantPage
    restaurantName="Claire et Hugo"
    address="77 avenue du Général-Galliéni, à Sainte-Savine, Troyes, 10300, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33973141869"
    website="https://www.claireethugo.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An enthusiastic self-taught young couple runs this restaurant with a subdued decor composed of raw materials. The premises also house a bakery and delicatessen leading onto a lovely terrace and indoor garden (including a citrus tree greenhouse). The ingredients, which are 95% organic, make for healthy, tasty and balanced dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%20avenue%20du%20G%C3%A9n%C3%A9ral-Galli%C3%A9ni%2C%20%C3%A0%20Sainte-Savine%2C%20Troyes%2C%2010300%2C%20France"
    pageTitle="Claire et Hugo"
  />
);

export default ClaireEtHugo;
