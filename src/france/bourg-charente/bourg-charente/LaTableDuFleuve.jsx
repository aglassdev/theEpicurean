...
const LaTableDuFleuve = () => (
  <RestaurantPage
    restaurantName="La Table du Fleuve"
    address="2 place du Port, Bourg-Charente, 16200, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33545813054"
    website="https://latabledufleuve.com/index.php"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The brainchild of Thierry and Julien Verrat, this Charentes restaurant is distinctly bistronomic in style. The menu keeps pace with the seasons. For example, semi-preserved duck foie gras and truffles; tartare of trout with herbs and its caviar or raspberries with pineau des Charentes topping and steamed meringue. On fine days, meals are served on the terrace. An aristocratic yet welcoming setting devoted to good food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20du%20Port%2C%20Bourg-Charente%2C%2016200%2C%20France"
    pageTitle="La Table du Fleuve"
  />
);

export default LaTableDuFleuve;
