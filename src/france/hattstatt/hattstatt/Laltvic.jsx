...
const Laltvic = () => (
  <RestaurantPage
    restaurantName="L'Altévic"
    address="4 rue du Wiggensbach, Hattstatt, 68420, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33389788356"
    website="https://www.restaurant-laltevic.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a contemporary glass and metal setting, Jean-Christophe Perrin serves up-to-date dishes, inspired by the market : poultry and morel mushroom pâté en croute ; stone bass with white beans from Paimpol ; mont-blanc pavlova-style…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20du%20Wiggensbach%2C%20Hattstatt%2C%2068420%2C%20France"
    pageTitle="L'Altévic"
  />
);

export default Laltvic;
