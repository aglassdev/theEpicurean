...
const OneSixMe = () => (
  <RestaurantPage
    restaurantName="16âme"
    address="32 rue des Glaciers, Le Monêtier-les-Bains, 05220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33492468412"
    website="https://www.16ame.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a discreet façade is this inviting restaurant with decor that calls to mind a trapper's hut – we are in the mountains, after all! Julien Momon, originally from Corsica, worked in the kitchens of Christophe Bacquié and Gérard Boyer (formerly chef at Les Crayères in Reims) before becoming head chef at a hotel here in Monêtier-les-Bains. His dishes contain nothing but seasonal and local ingredients from this rural and Alpine territory, such as lamb from the Hautes-Alpes, coriander, mint, a pearly jus with olive oil or his lovage-infused cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20rue%20des%20Glaciers%2C%20Le%20Mon%C3%AAtier-les-Bains%2C%2005220%2C%20France"
    pageTitle="16âme"
  />
);

export default OneSixMe;
