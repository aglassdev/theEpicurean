...
const Lesprance = () => (
  <RestaurantPage
    restaurantName="L'Espérance"
    address="21 rue du Docteur-Louis-Marçon, Bandol, 83150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33494058529"
    website="https://www.lesperance-bandol.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you're lucky enough to be in Bandol, leave the harbour area and make a beeline for the refreshing establishment of Maria and Gilles Pradines, a treasure trove of culinary talent and delight. Born in the Basque country, the chef has retained his love of the south of France, from stuffed piquillo peppers to black cherries and pata negra. Each ingredient is fastidiously sourced and prepared with great care: wild sea bass marinated in fennel seeds, grilled special oyster no. 2, apricots from Provence, olive oil and lemons… The presentation of the dishes is beautiful, and the service is charming!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20du%20Docteur-Louis-Mar%C3%A7on%2C%20Bandol%2C%2083150%2C%20France"
    pageTitle="L'Espérance"
  />
);

export default Lesprance;
