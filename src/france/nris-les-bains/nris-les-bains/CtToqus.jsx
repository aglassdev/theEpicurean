...
const CtToqus = () => (
  <RestaurantPage
    restaurantName="Côté Toqués"
    address="21 rue Hoche, Néris-les-Bains, 03310, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33470030697"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/nris-les-bains/restaurant/cote-toques"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Julien Chabozy's aromatic, tasty food showcases the best of local produce, with lashings of personality to boot. Friendly and endearing depict the front of house vibe, supervised by his wife Marie. The establishment also boasts a delicatessen and a wine shop, La Cave des Toqués, next door… It was love at first bite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20Hoche%2C%20N%C3%A9ris-les-Bains%2C%2003310%2C%20France"
    pageTitle="Côté Toqués"
  />
);

export default CtToqus;
