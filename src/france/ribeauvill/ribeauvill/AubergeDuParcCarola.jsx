...
const AubergeDuParcCarola = () => (
  <RestaurantPage
    restaurantName="Auberge du Parc Carola"
    address="48 route de Bergheim, Ribeauvillé, 68150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33389860575"
    website="https://auberge-parc-carola.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this charming pavilion-style setting, a stone’s throw from the Carola spring, chef Michaela Peters continues to delight a gourmet clientèle. Along with her pastry-chef partner, she creates authentic, inspired food, such as her organic Alsace egg cooked at 64° with summer truffles and new-potato mousseline, or her grilled ribs of wild boar with Kampot pepper, braised kale and lardo di Colonnata. Pretty terrace in the shade of the trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20route%20de%20Bergheim%2C%20Ribeauvill%C3%A9%2C%2068150%2C%20France"
    pageTitle="Auberge du Parc Carola"
  />
);

export default AubergeDuParcCarola;
