...
const LeCammissar = () => (
  <RestaurantPage
    restaurantName="Le Cammissar"
    address="81 Grand'Rue, Ribeauvillé, 68150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33389866087"
    website="https://www.cammissar.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This youthful chef isn’t lacking in ambition. In this half-timbered red-painted 15C edifice, restored at great cost, he produces modern dishes using painstakingly selected produce – pearlescent wild turbot with baby artichokes à la barigoule, or Breton lobster tail, with white asparagus and morels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20Grand'Rue%2C%20Ribeauvill%C3%A9%2C%2068150%2C%20France"
    pageTitle="Le Cammissar"
  />
);

export default LeCammissar;
