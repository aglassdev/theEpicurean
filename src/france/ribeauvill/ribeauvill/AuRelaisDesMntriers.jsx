...
const AuRelaisDesMntriers = () => (
  <RestaurantPage
    restaurantName="Au Relais des Ménétriers"
    address="10 avenue du Général-de-Gaulle, Ribeauvillé, 68150, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389736452"
    website="https://restaurant-menetriers.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The time is long gone when ménétriers or itinerant fiddlers went from inn to inn but hospitality is still the rule at this Relais, as is good food! The chef concocts true traditional French cuisine and buys his vegetables from local farmers. You can't argue with the results, which are generous and tasty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Ribeauvill%C3%A9%2C%2068150%2C%20France"
    pageTitle="Au Relais des Ménétriers"
  />
);

export default AuRelaisDesMntriers;
