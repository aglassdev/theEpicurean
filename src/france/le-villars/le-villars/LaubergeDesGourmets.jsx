...
const LaubergeDesGourmets = () => (
  <RestaurantPage
    restaurantName="L'Auberge des Gourmets"
    address="9 place de l'Église, Le Villars, 71700, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385325880"
    website="https://laubergedesgourmets.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20de%20l'%C3%89glise%2C%20Le%20Villars%2C%2071700%2C%20France"
    pageTitle="L'Auberge des Gourmets"
  />
);

export default LaubergeDesGourmets;
