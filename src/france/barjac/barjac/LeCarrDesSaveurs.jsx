...
const LeCarrDesSaveurs = () => (
  <RestaurantPage
    restaurantName="Le Carré des Saveurs"
    address="1770 chemin du Mas-du-Terme, Barjac, 30430, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33466245631"
    website="https://www.le-carre-des-saveurs.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the charming, peaceful setting of this former silkworm farm, surrounded by vineyards and olive groves, dine in the resolutely contemporary interior or on the pleasant terrace in a pretty courtyard. The cuisine draws inspiration from the terroir and tradition to showcase local ingredients: aubergine caviar with extra virgin olive oil; delicious daube provençale (beef stew); pistachio financier and vanilla mousseline. As an added bonus, you can taste the wines and olive oil produced right here on the estate. Spacious contemporary guestrooms and a sense of serenity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1770%20chemin%20du%20Mas-du-Terme%2C%20Barjac%2C%2030430%2C%20France"
    pageTitle="Le Carré des Saveurs"
  />
);

export default LeCarrDesSaveurs;
