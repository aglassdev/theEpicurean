...
const LaTableDeLaurent = () => (
  <RestaurantPage
    restaurantName="La Table de Laurent"
    address="28 rue Jacques-Prévert, Ramonville-Saint-Agne, 31520, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33561736162"
    website="https://latabledelaurent.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Laurent Prat uses quality produce (langoustine, monkfish etc) to create a range of classic and more modern dishes that are always seamlessly put together and have international influences: pan-fried gnocchi with spinach; seared prawns in a Mexican marinade; grilled grouper, aubergine roll with beetroot hummus. Afternoon tea with house-made pastries, served in an inviting wood-panelled interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20Jacques-Pr%C3%A9vert%2C%20Ramonville-Saint-Agne%2C%2031520%2C%20France"
    pageTitle="La Table de Laurent"
  />
);

export default LaTableDeLaurent;
