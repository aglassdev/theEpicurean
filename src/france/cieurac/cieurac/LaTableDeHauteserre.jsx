...
const LaTableDeHauteserre = () => (
  <RestaurantPage
    restaurantName="La Table de Haute-Serre"
    address="Château de Haute-Serre, Cieurac, 46230, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565208020"
    website="https://hauteserre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the wine storehouse of a château in the heart of the vineyards, this restaurant exudes the very particular charm of truly authentic places. Charcuterie rack, butcher's block, ham slicer and cases of wine herald a wonderful moment of gourmet delights, rounded off by wines from the estate. Rotisserie evening every Friday. Just delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Haute-Serre%2C%20Cieurac%2C%2046230%2C%20France"
    pageTitle="La Table de Haute-Serre"
  />
);

export default LaTableDeHauteserre;
