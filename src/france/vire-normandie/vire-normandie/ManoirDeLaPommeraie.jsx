...
const ManoirDeLaPommeraie = () => (
  <RestaurantPage
    restaurantName="Manoir de la Pommeraie"
    address="1770 route de Tinchebray, L'Auvère, Vire Normandie, 14500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231680771"
    website="https://www.restaurant-pommeraie-vire.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 18C building, whose conservatory overlooks wooded grounds planted with hundred-year-old trees, is run by a Franco-Japanese couple who continues to knock the socks off our tastebuds. While Masako pours her talents into pastries, Julien finetunes his exquisite, flawlessly balanced culinary score: roast monkfish, girolles, mussels and hay or lightly seared tuna in spices, aubergine and cucumber. Regional ingredients invariably take the limelight (Normandy beef, Cahagnes poultry, cheese from local farms and locally grown veggies) and the chef often waxes lyrical about his suppliers when he pops into the dining room, as is his wont...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1770%20route%20de%20Tinchebray%2C%20L'Auv%C3%A8re%2C%20Vire%20Normandie%2C%2014500%2C%20France"
    pageTitle="Manoir de la Pommeraie"
  />
);

export default ManoirDeLaPommeraie;
