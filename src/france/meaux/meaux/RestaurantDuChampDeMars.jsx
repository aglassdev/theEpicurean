...
const RestaurantDuChampDeMars = () => (
  <RestaurantPage
    restaurantName="Restaurant du Champ de Mars"
    address="16 avenue de la Victoire, Meaux, 77100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33164341515"
    website="https://www.restaurantduchampdemars.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant and cosy restaurant giving onto the main road was once a roadside inn and combines old features (beamed ceilings, exposed stone walls, terracotta floor tiles etc) with tasteful contemporary touches. Chef Romain Leydier cooks up a tempting menu that showcases fine ingredients in generous, carefully prepared dishes: crab with Meaux mustard mayonnaise and Brie caviar; Corrèze veal sweetbreads grenobloise style; praline millefeuille with Madagascar vanilla. The tree-lined terrace is popular in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20avenue%20de%20la%20Victoire%2C%20Meaux%2C%2077100%2C%20France"
    pageTitle="Restaurant du Champ de Mars"
  />
);

export default RestaurantDuChampDeMars;
