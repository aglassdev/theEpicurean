...
const LatelierDeNicolas = () => (
  <RestaurantPage
    restaurantName="L'Atelier de Nicolas"
    address="28 rue Alsace-Lorraine, Aigues-Mortes, 30220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33434280484"
    website="https://restaurant-latelierdenicolas.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20Alsace-Lorraine%2C%20Aigues-Mortes%2C%2030220%2C%20France"
    pageTitle="L'Atelier de Nicolas"
  />
);

export default LatelierDeNicolas;
