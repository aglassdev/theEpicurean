...
const MaisonDemarcq = () => (
  <RestaurantPage
    restaurantName="Maison Demarcq"
    address="2 rue Saint-Pol, Cambrai, 59400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33327377778"
    website="https://www.maisondemarcq.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This grand town house is rich in history: Napoleon is said to have stayed here and it is close to where the famous Treaty of Cambrai was signed in 1529. The stylish interior mingles antique and modern pieces, while the culinary score demonstrates the passion and know-how of its father-son team. An example: lobster Bellevue and delicately seasoned shrimp paired with crisp maritime flavours and tangy citrus fruits. Don’t miss one of their signature desserts: warm madeleine cakes dipped in a honey and lemon cream that will whisk you straight to seventh heaven. L'Éphémère brasserie offers more traditional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Saint-Pol%2C%20Cambrai%2C%2059400%2C%20France"
    pageTitle="Maison Demarcq"
  />
);

export default MaisonDemarcq;
