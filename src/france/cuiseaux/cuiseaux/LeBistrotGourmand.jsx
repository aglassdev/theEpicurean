...
const LeBistrotGourmand = () => (
  <RestaurantPage
    restaurantName="Le Bistrot Gourmand"
    address="8 place Puvis-de-Chavannes, Cuiseaux, 71480, France"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+33385727157"
    website="https://www.lebistrotgourmand-cuiseaux.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pleasure and tradition is the motto of this former butchery, where Camille Maître has taken over the family business and is now alone at the helm. The menu is rich in Bresse and Jura ingredients, with distinctive flavours such as quenelle of pike in a creamy lobster bisque. Concise, attractive wine list. Fully deserving of its name!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20place%20Puvis-de-Chavannes%2C%20Cuiseaux%2C%2071480%2C%20France"
    pageTitle="Le Bistrot Gourmand"
  />
);

export default LeBistrotGourmand;
