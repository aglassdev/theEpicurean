...
const AuBonAccueil = () => (
  <RestaurantPage
    restaurantName="Au Bon Accueil"
    address="23 place Saint-Michel, Juvigny-sous-Andaine, 61140, France"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+33233381004"
    website="https://www.aubonaccueil-normand.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a bright, contemporary interior is true to its name when it promises a warm welcome. Chef Gaëtan Crespin works with good seasonal produce, most of it sourced locally, to craft creative and technically on-point cuisine. A shining example comes in the form of his scallops, endive and clementine, or rack of pork, parsley and spelt… And with excellent value for money guaranteed, what's not to love?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20place%20Saint-Michel%2C%20Juvigny-sous-Andaine%2C%2061140%2C%20France"
    pageTitle="Au Bon Accueil"
  />
);

export default AuBonAccueil;
