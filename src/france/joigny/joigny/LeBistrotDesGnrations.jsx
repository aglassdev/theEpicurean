...
const LeBistrotDesGnrations = () => (
  <RestaurantPage
    restaurantName="Le Bistrot des Générations"
    address="La Côte Saint-Jacques, 14 faubourg de Paris, Joigny, 89300, France"
    ...
    bio="On the banks of the Yonne, La Côte Saint-Jacques started out as a guesthouse in 1945. Today, it is a 5-star hotel and its restaurant holds two MICHELIN stars. Le Bistrot des Générations is its more accessible counterpart, homing in on traditional, generous cuisine: œuf parfait (slow-cooked egg) with cep cream and lovage, mustard-confit beef cheek, garden vegetables. Good selection of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20C%C3%B4te%20Saint-Jacques%2C%2014%20faubourg%20de%20Paris%2C%20Joigny%2C%2089300%2C%20France"
    pageTitle="Le Bistrot des Générations"
  />
);

export default LeBistrotDesGnrations;
