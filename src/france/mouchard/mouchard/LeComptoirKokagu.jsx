...
const LeComptoirKokagu = () => (
  <RestaurantPage
    restaurantName="Le Comptoir Kokagué"
    address="8 rue Léopold-Alixant, Mouchard, 39330, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33680617548"
    website="https://guide.michelin.com/en/bourgogne-franche-comte/mouchard_1533221/restaurant/le-comptoir-kokague"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the unlikely location of a tiny village in the Jura, this restaurant serving French-Japanese cuisine based on regional produce has a local following among the people of Mouchard and from the surrounding areas! In an interior that is largely unadorned but for a few plants, diners first make the acquaintance of this French-Japanese couple (she cooks, he manages the restaurant floor). Then the food is served: ingredients from the local terroir are woven into Japanese dishes, as in the celeriac purée with a wasabi kick, the trout marinated with kombu seaweed (on the kawamatsu kobujimè), or the Bresse chicken fillet worked into a tofu and shiitake patty flavoured with ginger (tori daikon). There is a good selection of wines organised by grape variety, mainly showcasing natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20L%C3%A9opold-Alixant%2C%20Mouchard%2C%2039330%2C%20France"
    pageTitle="Le Comptoir Kokagué"
  />
);

export default LeComptoirKokagu;
