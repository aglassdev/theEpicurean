...
const AubergeDeLaBrie = () => (
  <RestaurantPage
    restaurantName="Auberge de la Brie"
    address="14 avenue Alphonse-Boulingre, Couilly-Pont-aux-Dames, 77860, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33164635180"
    website="https://www.aubergedelabrie.net"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This local institution has proudly retained its MICHELIN star for over 30 years. Ever popular with its loyal clientele, the charming restaurant has more than one string to its bow, with its bright and elegant setting (the dining room overlooks the garden), its consistent modern cuisine with a personal touch, and smiling service from Céline. The chef – her husband, Alain Pavard – thrills diners with top-quality ingredients and precise flavours in dishes such as Mediterranean vegetables, burrata espuma, basil and crispy buckwheat tuile; pollock, fennel confit, rouille and bouillabaisse velouté; strawberry millefeuille, verbena cream and strawberry sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20avenue%20Alphonse-Boulingre%2C%20Couilly-Pont-aux-Dames%2C%2077860%2C%20France"
    pageTitle="Auberge de la Brie"
  />
);

export default AubergeDeLaBrie;
