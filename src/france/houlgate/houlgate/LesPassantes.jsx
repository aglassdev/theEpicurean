...
const LesPassantes = () => (
  <RestaurantPage
    restaurantName="Les Passantes"
    address="41 rue des Bains, Houlgate, 14510, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33261923969"
    website="https://www.les-passantes.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When strolling down the main street of Houlgate, you will pass this spruce, slate-roofed villa. In a contemporary, cheerful interior depicted by wood and stone, local lad Maxime Lehoucq has grown into a talented chef. He works with seasonal Normandy ingredients (veal, free-range eggs and cream) together with fish supplied by his fisherman brother from Trouville. Maxime’s bistronomic signature and the occasional exotic note do the rest: flame grilled mackerel, beetroot and seaweed mayonnaise; Prieuré leg of poultry, gnocchi, creamy mushrooms, Comté cheese and hazelnuts. The menu, which changes monthly, is served by a cheerful young team eager to please. Consider us smitten!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20rue%20des%20Bains%2C%20Houlgate%2C%2014510%2C%20France"
    pageTitle="Les Passantes"
  />
);

export default LesPassantes;
