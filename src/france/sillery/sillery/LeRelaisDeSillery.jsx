...
const LeRelaisDeSillery = () => (
  <RestaurantPage
    restaurantName="Le Relais de Sillery"
    address="3 rue de la Gare, Sillery, 51500, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33326491011"
    website="https://www.relaisdesillery.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant inn, a post house in a former life, sports a terrace overlooking the River Vesle. The setting is bucolic, the food classical: sea bass meunière, baby artichokes and confit tomatoes, and a Grand Marnier soufflé. The impressive wine cellar is very competitively priced!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20de%20la%20Gare%2C%20Sillery%2C%2051500%2C%20France"
    pageTitle="Le Relais de Sillery"
  />
);

export default LeRelaisDeSillery;
