...
const LaubergeDallex = () => (
  <RestaurantPage
    restaurantName="L'Auberge d'Allex"
    address="1 montée de l'Ancien-Hôpital, Allex, 26400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475626166"
    website="https://www.laubergedallex.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Between Valence and Montélimar, this erstwhile village inn is continuing its vocation as an eatery thanks to a young couple who have turned it into a cosy and inviting bistro-style restaurant with a smattering of contemporary decorative touches. The food, too, is in a bistro vein – think simple, contemporary cuisine designed for the modern palate. The fillet of hake with citrus sauce, red cabbage and butternut takes no prisoners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20mont%C3%A9e%20de%20l'Ancien-H%C3%B4pital%2C%20Allex%2C%2026400%2C%20France"
    pageTitle="L'Auberge d'Allex"
  />
);

export default LaubergeDallex;
