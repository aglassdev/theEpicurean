...
const LaTableDuConntableAubergeDuJeuDePaume = () => (
  <RestaurantPage
    restaurantName="La Table du Connétable - Auberge du Jeu de Paume"
    address="4 rue du Connétable, Chantilly, 60500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33344655000"
    website="https://aubergedujeudepaumechantilly.fr/fr/latable-du-connetable.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After visiting the Royal Castle of Chantilly, book a table in this luxurious inn abutting the gardens. In a lavish setting, dripping with fine art, chandeliers and tapestries, diners sample unabashedly creative cuisine with a weakness for vegetables and seafood: gyoza-style veal and eels, tarragon-flavoured labneh; wild turbot, salsify, za’atar and cognac with a peat-flavoured, roast chocolate extravaganza to finish. At Le Jardin d'Hiver bistro, traditional and seasonal dishes are served in the gallery or on the pretty patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20du%20Conn%C3%A9table%2C%20Chantilly%2C%2060500%2C%20France"
    pageTitle="La Table du Connétable - Auberge du Jeu de Paume"
  />
);

export default LaTableDuConntableAubergeDuJeuDePaume;
