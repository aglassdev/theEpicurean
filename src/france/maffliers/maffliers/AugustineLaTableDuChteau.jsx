...
const AugustineLaTableDuChteau = () => (
  <RestaurantPage
    restaurantName="Augustine - La Table du Château"
    address="Allée des Marronniers, Maffliers, 95560, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33134083517"
    website="https://www.augustinelatableduchateau-maffliers.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a handsome 19C abode near Montmorency Forest, this restaurant aims to uphold French art de vivre: period tableware and furniture, gleaming silverware and copper and high ceilings – all of which in a plush muted interior dominated by wood. The food is suitably classical and generous, whilst traversing the annals of French cookery: pâté en croûte, rabbit cooked in mustard and rice pudding. A few rooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=All%C3%A9e%20des%20Marronniers%2C%20Maffliers%2C%2095560%2C%20France"
    pageTitle="Augustine - La Table du Château"
  />
);

export default AugustineLaTableDuChteau;
