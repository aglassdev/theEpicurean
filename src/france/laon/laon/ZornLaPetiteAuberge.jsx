...
const ZornLaPetiteAuberge = () => (
  <RestaurantPage
    restaurantName="Zorn - La Petite Auberge"
    address="45 boulevard Pierre-Brossolette, Laon, 02000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33323230238"
    website="https://zornlapetiteauberge.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Low-temperature poached egg, cream of parsnip, mushrooms and shallots; guinea fowl, cabbage, rosemary jus; jellied strawberries, meringue, strawberry sorbet… The “carte blanche” menu of seasoned chef, Willy-Marc Zorn, at the helm of this eatery near Laon station, highlights market-fresh ingredients. Fine wine list. On the spot every time!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20boulevard%20Pierre-Brossolette%2C%20Laon%2C%2002000%2C%20France"
    pageTitle="Zorn - La Petite Auberge"
  />
);

export default ZornLaPetiteAuberge;
