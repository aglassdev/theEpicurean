...
const AubergeDuPontDacign = () => (
  <RestaurantPage
    restaurantName="Auberge du Pont d'Acigné"
    address="8 Le Pont-d'Acigné (lieu-dit), Noyal-sur-Vilaine, 35530, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33299625255"
    website="https://lepontdacigne.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Close to Rennes, on the banks of the River Vilaine, this granite building is worthy of our full attention. Owners Sylvain and Marie-Pierre Guillemot met while working for Alain Passard. Sylvain prides himself on his instinctive, up-to-the-minute cuisine, drawing on regional produce with a sense of invention and real technical skill. He particularly cherishes his relationships with his producer friends, from whom he sources seaweed, chilli, ginger, poultry and, of course, butter. The elegant and light-filled interior, the terrace overlooking the river, and the lovely service add to the pleasure of this gourmet interlude. Very fine wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Le%20Pont-d'Acign%C3%A9%20(lieu-dit)%2C%20Noyal-sur-Vilaine%2C%2035530%2C%20France"
    pageTitle="Auberge du Pont d'Acigné"
  />
);

export default AubergeDuPontDacign;
