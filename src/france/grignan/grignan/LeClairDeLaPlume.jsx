...
const LeClairDeLaPlume = () => (
  <RestaurantPage
    restaurantName="Le Clair de la Plume"
    address="2 place du Mail, Grignan, 26230, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33475000101"
    website="https://www.clairplume.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestling at the foot of a château that is famous for having welcomed Madame de Sévigné as a regular patron, this restaurant is the perfect embodiment of Provence's twin traditions of hospitality and good food: olive oil from Nyons, guinea fowl and diced vegetables from the Drôme are judiciously showcased by chef Benjamin Reilhes in the form of three tasting menus comprising several courses. One of the set menus draws entirely on plants. This restaurant is an ode to the Mediterranean's fine ingredients and Rhône Valley wines. Pastry chef Cédric Perret, meanwhile, creates desserts in harmony with the seasons, often setting them off with an original and striking flourish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20du%20Mail%2C%20Grignan%2C%2026230%2C%20France"
    pageTitle="Le Clair de la Plume"
  />
);

export default LeClairDeLaPlume;
