...
const LeBistroChapouton = () => (
  <RestaurantPage
    restaurantName="Le Bistro Chapouton"
    address="45 rue du Grand-Faubourg, Grignan, 26230, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475000101"
    website="https://www.clairplume.com/la-ferme-chapouton/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The second offshoot of Le Clair de la Plume, the nearby parent establishment, occupies a stunning 18C edifice set in fragrant, flower-decked gardens. Fresh, seasonal produce are the stars of the bistro lineup: homemade terrine of foie gras and Ardèche pork; poultry from the Blaches farm and, to finish, a selection of wickedly appetising home-made pastries. The spacious, covered terrace commands a matchless view of Grignan Castle in the distance and the treelined, walled garden in the foreground...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20rue%20du%20Grand-Faubourg%2C%20Grignan%2C%2026230%2C%20France"
    pageTitle="Le Bistro Chapouton"
  />
);

export default LeBistroChapouton;
