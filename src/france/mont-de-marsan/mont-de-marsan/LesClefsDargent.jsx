...
const LesClefsDargent = () => (
  <RestaurantPage
    restaurantName="Les Clefs d'Argent"
    address="333 avenue des Martyrs-de-la-Résistance, Mont-de-Marsan, 40000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33558061645"
    website="https://www.clefs-dargent.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery, refurbished in a fashionable, low-key vein, is located outside the town centre. The seasoned chef is a champion of nature and local produce and he pays tribute to southwest France (particularly the Landes) with dishes like secreto of pork garnished with apricot and chorizo pickles, or a humus of white pochas beans with crab, peppers and anchovies. The stonking wine bin boasts over 600 references...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=333%20avenue%20des%20Martyrs-de-la-R%C3%A9sistance%2C%20Mont-de-Marsan%2C%2040000%2C%20France"
    pageTitle="Les Clefs d'Argent"
  />
);

export default LesClefsDargent;
