...
const AubergeDuVieuxGachet = () => (
  <RestaurantPage
    restaurantName="Auberge du Vieux Gachet"
    address="Le Vieux Gachet, au bord de l'Erdre, Carquefou, 44470, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33240251092"
    website="https://www.aubergeduvieuxgachet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sprawling terrace, which commands a superlative view of the fairytale Gacherie château, seems to float above the River Erdre. A peaceful, refreshing venue set in the heart of unspoiled countryside. Even better, the floor-to-ceiling windows of the dining room offer the same fantastic view when the weather is less suited to alfresco dining. The owner-chef, Walter Lescot, works only with ingredients he himself loves: Scandinavian gravlax of salmon, lemon cream; loin of cod, celery and chorizo risotto and a piquillos sauce. The tart of citrus fruit and lime sorbet is delicate, flavoursome and fruity – an ideal conclusion to your meal. With over 350 references, the wine cellar adds the final cherry to this appetising portrait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Vieux%20Gachet%2C%20au%20bord%20de%20l'Erdre%2C%20Carquefou%2C%2044470%2C%20France"
    pageTitle="Auberge du Vieux Gachet"
  />
);

export default AubergeDuVieuxGachet;
