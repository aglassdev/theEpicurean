...
const LaTableDomaineDuLiziec = () => (
  <RestaurantPage
    restaurantName="La Table - Domaine du Liziec"
    address="20 route de Rennes, Vannes, 56000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33222075015"
    website="https://www.ledomaineduliziec.com/fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20route%20de%20Rennes%2C%20Vannes%2C%2056000%2C%20France"
    pageTitle="La Table - Domaine du Liziec"
  />
);

export default LaTableDomaineDuLiziec;
