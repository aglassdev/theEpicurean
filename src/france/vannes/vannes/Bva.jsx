...
const Bva = () => (
  <RestaurantPage
    restaurantName="Bvañ"
    address="6 rue Alexandre-le-Pontois, Vannes, 56000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297679830"
    website="https://www.restaurantbvan.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Romain Le Cordroch has travelled extensively, across continents (China, Australia, Brazil) and from one fine restaurant to another (Atelier de Rabanel, Atelier Robuchon, Violon d'Ingres). Now returning to his roots, he has established a natural style of plant- and fish-based cuisine. He lets nothing go to waste – everything is transformed. For instance, his gomasio is made from fish scales warmed in the oven! His dishes always demonstrate his know-how, eg mussels marinière, Armenian cucumber with verbena and a gwell (Breton fermented milk) foam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Alexandre-le-Pontois%2C%20Vannes%2C%2056000%2C%20France"
    pageTitle="Bvañ"
  />
);
