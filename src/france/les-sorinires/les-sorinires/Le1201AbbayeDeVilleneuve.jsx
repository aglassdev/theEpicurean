...
const Le1201AbbayeDeVilleneuve = () => (
  <RestaurantPage
    restaurantName="Le 1201 - Abbaye de Villeneuve"
    address="Lieu-dit Villeneuve, Les Sorinières, 44840, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33255590591"
    website="https://www.abbayedevilleneuve.com/restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The fine dining restaurant of this charming hotel sports two plush, stylish dining rooms. You will sample a polished, appetising score in the zeitgeist, which demonstrates a distinct regional slant and showcases the chef’s craftsmanship, particularly in the realm of sauces and jus. The impressive wine list starts at very reasonable prices and features a fine selection of regional tipples. Cheerful service...."
    ...
    pageTitle="Le 1201 - Abbaye de Villeneuve"
  />
);

export default Le1201AbbayeDeVilleneuve;
