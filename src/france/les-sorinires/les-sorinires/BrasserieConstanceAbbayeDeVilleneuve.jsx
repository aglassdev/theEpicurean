...
const BrasserieConstanceAbbayeDeVilleneuve = () => (
  <RestaurantPage
    restaurantName="Brasserie Constance - Abbaye de Villeneuve"
    address="Lieu-dit Villeneuve, Les Sorinières, 44840, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33255590591"
    website="https://www.abbayedevilleneuve.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The brasserie of this hotel that has been tastefully refurbished from top to bottom, is set up in a space that is flooded with light through a beautiful glass roof and bay windows overlooking the swimming pool and grounds. The chef presents a menu that combines traditional dishes (e.g. pâté en croûte, egg mayonnaise, fish with beurre blanc sauce, Loire fish quenelle with crayfish bisque) with more modern recipes. We also like the attractive wine list with (very) reasonable prices, especially for the wines from the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20Villeneuve%2C%20Les%20Sorini%C3%A8res%2C%2044840%2C%20France"
    pageTitle="Brasserie Constance - Abbaye de Villeneuve"
  />
);

export default BrasserieConstanceAbbayeDeVilleneuve;
