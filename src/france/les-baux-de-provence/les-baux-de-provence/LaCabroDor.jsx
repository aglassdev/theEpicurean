...
const LaCabroDor = () => (
  <RestaurantPage
    restaurantName="La Cabro d'Or"
    address="Mas de Baumanière, Les Baux-de-Provence, 13520, France"
    cuisine="Provençal"
    priceRange="€€€€"
    phoneNumber="+33490543307"
    website="https://www.baumaniere.com/gastronomie/la-cabro-dor"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Michel Hulin crafts generous provençal fare using first-rate ingredients from Alpilles and Camargue, illustrated by hot-cold Mediterranean squid cooked like a bouillabaisse or the incredible roast lamb, confit then smoked in AOP Crau hay, courgette flower and parsnips from Moulin de Daudet… The site is jaw-dropping with a terrace shaded by mulberry plane trees and a view over the jagged skyline that has made this enchanting village and its countryside so famous. Thoroughly enchanting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mas%20de%20Baumani%C3%A8re%2C%20Les%20Baux-de-Provence%2C%2013520%2C%20France"
    pageTitle="La Cabro d'Or"
  />
);

export default LaCabroDor;
