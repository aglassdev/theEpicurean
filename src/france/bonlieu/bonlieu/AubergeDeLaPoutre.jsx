...
const AubergeDeLaPoutre = () => (
  <RestaurantPage
    restaurantName="Auberge de la Poutre"
    address="25 Grande-Rue, Bonlieu, 39130, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33384255777"
    website="https://www.aubergedelapoutre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the hub of a pretty village in the Jura lakes area, this family-run inn dating from 1740 plays on its rustic charm. Chef François Moureaux works with fine ingredients to create delicate and tasty contemporary cuisine, but doesn't neglect to revisit local specialities. As for the decor, the establishment is named after one notable feature: its 17m-long ceiling beam that comes from a 3m3 fir log!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Grande-Rue%2C%20Bonlieu%2C%2039130%2C%20France"
    pageTitle="Auberge de la Poutre"
  />
);

export default AubergeDeLaPoutre;
