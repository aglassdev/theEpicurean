...
const Freya = () => (
  <RestaurantPage
    restaurantName="Freya"
    address="1 rue du Lycée, Biarritz, 64200, France"
    cuisine="Creative, Vegetarian"
    priceRange="€€"
    phoneNumber="+33610463754"
    website="https://freya-biarritz.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Freya, the goddess of nature in Norse mythology, presides over the very vegetable-forward feast served at this compact restaurant in the Saint-Charles neighbourhood. At the helm is a couple with a wealth of professional experience and many trips around the globe under their belt. Chef Guillaume Chatillon doesn't shy away from using meat or fish (particularly the top-notch fish from Saint-Jean-de-Luz fish market), but focuses on vegetables, which are elevated in the same way as any other premium ingredient, with a host of indulgent preparations and occasionally daring combinations, such as his beautifully balanced cauliflower with seaweed. N.B. Guests at the same table are invited to share the same plate. Wine recommendations come, with a smile, from Margot – most are organic or natural, an..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20du%20Lyc%C3%A9e%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Freya"
  />
);
