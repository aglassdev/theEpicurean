...
const LesRosiers = () => (
  <RestaurantPage
    restaurantName="Les Rosiers"
    address="32 avenue Beau-Soleil, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33559231368"
    website="https://www.restaurant-lesrosiers.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The exterior may be the quintessence of the Basque country, but the interior is 100% modern (pared-back walls, wooden floors and round designer-inspired tables). At the helm, Andrée Rosier (first woman Meilleur Ouvrier of France in 2007) and her spouse craft exquisitely unencumbered food. Our virtuoso never flaunts her technique, seeking rather to coax the taste and flavour out of first-class local produce, wild fish and shrimps and free-range poultry and squab, in particular. Ms Rosier also enjoys jazzing up her dishes with the occasional dash of exoticism ranging from lemongrass and nori seaweed to ginger and lemon preserves. Interestingly, the couple also operates a Basque restaurant in Tokyo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20avenue%20Beau-Soleil%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Les Rosiers"
  />
);

export default LesRosiers;
