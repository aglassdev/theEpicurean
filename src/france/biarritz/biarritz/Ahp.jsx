...
const Ahp = () => (
  <RestaurantPage
    restaurantName="AHPĒ"
    address="34 avenue du Président-John-Fitzgerald-Kennedy, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33648814975"
    website="https://ahpe-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a neighbourhood at a remove from the centre, this colourful, bustling bistro with caramel-toned walls and cheerfully mismatched furniture celebrates each season (the name is made up of the first letters of the four seasons) in a light-hearted atmosphere. Chef Idir Fseil is a fan of fermentation, but also of open-fire and a la plancha cooking, and he prepares a good market cuisine: white tuna, cucumber water and orange in brine; pork belly with green chilli, raw cream and beetroot; beef tartare, fermented black radish, bottarga and grenaille potatoes. Booking is essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20avenue%20du%20Pr%C3%A9sident-John-Fitzgerald-Kennedy%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="AHPĒ"
  />
);
