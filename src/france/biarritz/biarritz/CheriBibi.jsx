...
const CheriBibi = () => (
  <RestaurantPage
    restaurantName="Cheri Bibi"
    address="50 rue d'Espagne, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33540071150"
    website="https://cheribibibiarritz.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cheri Bibi is named after the hero of Gaston Leroux's novel Chéri-Bibi et Cécily. The chef at this trendy bistro is Brittany-born Adrien Witte, formerly a financier, who has turned his passion into a career. Seen in action in his kitchen from the restaurant floor, he goes to great lengths to make his guests feel good. The chef's dishes, which are designed for sharing (but don't have to be!), are based on the best local ingredients. Expect uninhibited and flavoursome creations, with nods to his international career: mimosa eggs; grilled sweetcorn, oyster mushroom pickles, peanuts from Aquitaine, shiso and crispy chilli oil; line-caught mahi-mahi, pil-pil sauce and roast aubergine. His efficient partner welcomes guests with a smile. You can choose your own bottle in the wine shop...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20rue%20d'Espagne%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Cheri Bibi"
  />
);

export default CheriBibi;
