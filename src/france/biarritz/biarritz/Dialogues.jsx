...
const Dialogues = () => (
  <RestaurantPage
    restaurantName="Dialogues"
    address="11 rue du Helder, Biarritz, 64200, France"
    cuisine="Creative, Vegetarian"
    priceRange="€€€"
    phoneNumber="+33559231297"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/biarritz/restaurant/dialogues"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two distinct spaces lie behind the cream-coloured façade: the fine dining restaurant upstairs and the cave à manger in the basement. The contemporary elegance of the decor is appealing, with custom-made solid wood tables, emerald-green banquettes, armchairs re-upholstered with vintage fabrics, a backlit white marble counter and a superb mural with natural-pigment swirls. At the helm, Adrien Zedda and Thomas Bouanich (Culina Hortus, Lyon) devise 100% vegetarian or veggie-seafood set menus – plants are always at the fore. Their signature dish is a puff pastry half-moon filled with celeriac roasted for 12hr, mushroom duxelles and caramelised onions, paired with a lovage and celeriac jus whipped with butter and a deep, robust meurette-style red wine and mushroom sauce – vegetarian, of course...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20du%20Helder%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Dialogues"
  />
);
