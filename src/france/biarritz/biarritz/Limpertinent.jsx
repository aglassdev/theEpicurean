...
const Limpertinent = () => (
  <RestaurantPage
    restaurantName="L'Impertinent"
    address="5 rue d'Alsace, Biarritz, 64200, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33559510367"
    website="https://www.l-impertinent.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20d'Alsace%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="L'Impertinent"
  />
);

export default Limpertinent;
