...
const LentreDeuxBIA = () => (
  <RestaurantPage
    restaurantName="L'Entre Deux"
    address="5 avenue du Maréchal-Foch, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33559225150"
    website="https://www.lentredeuxbiarritz.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Young chef Rémy Escale is at the helm of this trendy bistro, which is inviting and tastefully decorated. Food - wise, the objective has been set to stick close to the ingredients and bring out their natural flavour. He weaves flavours together with panache, demonstrating faultless technical know - how: an enjoyable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20avenue%20du%20Mar%C3%A9chal-Foch%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="L'Entre Deux"
  />
);

export default LentreDeuxBIA;
