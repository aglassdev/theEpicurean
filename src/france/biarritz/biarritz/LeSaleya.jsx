...
const LeSaleya = () => (
  <RestaurantPage
    restaurantName="Le Saleya"
    address="34 rue Gambetta, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33983222073"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/biarritz/restaurant/le-saleya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A well-positioned terrace, a cleverly stylised 1970s-style decor, a menu featuring local ingredients (Ispéguy trout, hake from Ciboure fish market, Basque meats from the Axuria cooperative) and seasonal produce, and generous dishes simmered in a Basque sauce: this restaurant has all the elements it needs to make it a success. Slow-cooked egg, green beans, peach, xistora sausages, red onions or pig's loin, cuttlefish, baby spinach, carrots: dishes packed with flavour, to be enjoyed in a relaxed atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20rue%20Gambetta%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Le Saleya"
  />
);

export default LeSaleya;
