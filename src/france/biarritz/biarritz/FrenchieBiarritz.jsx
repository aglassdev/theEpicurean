...
const FrenchieBiarritz = () => (
  <RestaurantPage
    restaurantName="Frenchie Biarritz"
    address="Hôtel Regina Experimental, 52 avenue de l'Impératrice, Biarritz, 64200, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33559413320"
    website="https://frenchie-biarritz.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Regina%20Experimental%2C%2052%20avenue%20de%20l'Imp%C3%A9ratrice%2C%20Biarritz%2C%2064200%2C%20France"
    pageTitle="Frenchie Biarritz"
  />
);

export default FrenchieBiarritz;
