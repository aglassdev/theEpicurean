...
const RestaurantDuMuse = () => (
  <RestaurantPage
    restaurantName="Restaurant du Musée"
    address="2 rue de la Rochette, Fréland, 68240, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389472418"
    website="https://www.restaurantmusee.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this former mill on the Ure, next to the museum of the Welche country, Alain Schmitt’s cooking finds varied inspiration, close to home in “terroir” dishes (fleischschnaka of local trout) and further afield (line-caught grouper in a yosenabe style dashi broth)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20la%20Rochette%2C%20Fr%C3%A9land%2C%2068240%2C%20France"
    pageTitle="Restaurant du Musée"
  />
);

export default RestaurantDuMuse;
