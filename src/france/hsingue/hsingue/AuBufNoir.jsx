...
const AuBufNoir = () => (
  <RestaurantPage
    restaurantName="Au Bœuf Noir"
    address="2 rue Folgensbourg, Hésingue, 68220, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33389697640"
    website="https://www.auboeufnoir.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Quality produce sets the tone here, in the form of flavourful dishes like skate wing à la grenobloise with baby potatoes, fricassee of calf’s sweetbreads and frogs’ legs in the spirit of a carbonara, or hare à la royale in the game season…There is a pretty little terrace to the rear, which is ideal for fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Folgensbourg%2C%20H%C3%A9singue%2C%2068220%2C%20France"
    pageTitle="Au Bœuf Noir"
  />
);

export default AuBufNoir;
