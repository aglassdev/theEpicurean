...
const LeBotanisteLaChenevire = () => (
  <RestaurantPage
    restaurantName="Le Botaniste - La Chenevière"
    address="à Commes, Port-en-Bessin, 14520, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231512525"
    website="https://www.le-botaniste.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wood panelling, parquet floors and 18C furnishings set the swish, elegant scene. The dedicated chef draws inspiration from the château's vegetable garden and from produce grown by small-scale suppliers. His delicate cuisine features a variety of appetising takes on Normandy produce and pleasing alliances of flavours, for example: slow roasted free-range chicken, confit of shredded leg with pleurote mushrooms and elderflower jelly; pearlescent brill, confit of fennel, carrot seasoning and lobster bisque. First-class, seamless service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%A0%20Commes%2C%20Port-en-Bessin%2C%2014520%2C%20France"
    pageTitle="Le Botaniste - La Chenevière"
  />
);

export default LeBotanisteLaChenevire;
