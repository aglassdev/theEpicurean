...
const LePetitJardinLaChenevire = () => (
  <RestaurantPage
    ...
    pageTitle="Le Petit Jardin - La Chenevière"
  />
);

export default LePetitJardinLaChenevire;
