...
const LeGrandSaintbenot = () => (
  <RestaurantPage
    restaurantName="Le Grand Saint-Benoît"
    address="7 place Saint-André, Saint-Benoît-sur-Loire, 45730, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33238351192"
    website="https://www.restaurant-grand-saint-benoit.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a historic village where the poet Max Jacob is buried, this authentically appointed traditional restaurant boasts stone walls, a coffered ceiling and a pretty terrace overlooking a square. The well-crafted culinary score draws on classical textbook roots. Examples include crisp scallops of sweetbread served with lashings of side dishes. Attentive, gracious service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20Saint-Andr%C3%A9%2C%20Saint-Beno%C3%AEt-sur-Loire%2C%2045730%2C%20France"
    pageTitle="Le Grand Saint-Benoît"
  />
);

export default LeGrandSaintbenot;
