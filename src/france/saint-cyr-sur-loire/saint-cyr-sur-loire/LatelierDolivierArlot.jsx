...
const LatelierDolivierArlot = () => (
  <RestaurantPage
    restaurantName="L'Atelier d'Olivier Arlot"
    address="55 quai des Maisons-Blanches, Saint-Cyr-sur-Loire, 37540, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247731863"
    website="https://latelier-olivierarlot.eatbu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set up by Olivier Arlot on the banks of the Loire, L'Atelier is modern both in terms of the decor and the menu. They serve up tasty and savvy creations, such as oxtail terrine and foie gras – a happy combination that melts in the mouth! This is bistronomy at its best, with intriguing and punchy dishes, plus a menu that is renewed very regularly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20quai%20des%20Maisons-Blanches%2C%20Saint-Cyr-sur-Loire%2C%2037540%2C%20France"
    pageTitle="L'Atelier d'Olivier Arlot"
  />
);

export default LatelierDolivierArlot;
