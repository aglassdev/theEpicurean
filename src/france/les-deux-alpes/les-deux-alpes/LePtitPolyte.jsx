...
const LePtitPolyte = () => (
  <RestaurantPage
    restaurantName="Le P'tit Polyte"
    address="Chalet Mounier, 2 rue de la Chapelle, Les Deux-Alpes, 38860, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33476805690"
    website="https://www.chalet-mounier.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The hotel Chalet Mounier is a family affair. It began with Marie and Hippolyte Mounier, who opened this hotel – the first in the resort – in 1933. Then their son Robert took over in 1971, and today Alban and his partner Angélique are carrying on the legacy. The cosy little restaurant has an intimate atmosphere, in which you can enjoy an intelligently designed tasting menu with a strong emphasis on the vegetable component. The chef, who is particularly fond of citrus fruits, does a fine job of selecting the ingredients and presenting them beautifully on the plate. The wine list is excellent, with judicious recommendations from the sommelier. Le P'tit Polyte punches above its weight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chalet%20Mounier%2C%202%20rue%20de%20la%20Chapelle%2C%20Les%20Deux-Alpes%2C%2038860%2C%20France"
    pageTitle="Le P'tit Polyte"
  />
);

export default LePtitPolyte;
