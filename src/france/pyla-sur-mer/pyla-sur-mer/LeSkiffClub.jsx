...
const LeSkiffClub = () => (
  <RestaurantPage
    restaurantName="Le Skiff Club"
    address="Hôtel Ha(a)ïtza, 1 avenue Louis-Gaume, Pyla-sur-Mer, 33115, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33556220606"
    website="https://haaitza.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In this 1930s Basque hotel nestled in a pine forest and given a makeover by designer Philippe Starck, Le Skiff Club is a veritable haven with its cosy little dining area decorated in the style of a yacht club. Stéphane Carrade is a talented and skilled chef, cooking up delightful progressive terroir cuisine, in a superb celebration of the Aquitaine region in southwest France. He combines generosity and finesse in dishes such as honey-glazed sweet-and-sour Noir de Bigorre pork presa, sauce diable with pig's trotters, and green asparagus with stuffed morels. Finally, Alexandre Blay's desserts are the icing on the cake: his Mexican vanilla, crème brûlée and jumbo grapes with JM rum, caramelised gavotte, ice cream and zephyr with roasted pods is at the intersection of finesse and originality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20Ha(a)%C3%AFtza%2C%201%20avenue%20Louis-Gaume%2C%20Pyla-sur-Mer%2C%2033115%2C%20France"
    pageTitle="Le Skiff Club"
  />
);

export default LeSkiffClub;
