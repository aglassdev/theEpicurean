...
const LaFontaineLartisteEtLeCuisinier = () => (
  <RestaurantPage
    restaurantName="La Fontaine - L’Artiste et le Cuisinier"
    address="Le village, Cliousclat, 26270, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475630738"
    website="https://lafontaine-cliousclat.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20village%2C%20Cliousclat%2C%2026270%2C%20France"
    pageTitle="La Fontaine - L’Artiste et le Cuisinier"
  />
);

export default LaFontaineLartisteEtLeCuisinier;
