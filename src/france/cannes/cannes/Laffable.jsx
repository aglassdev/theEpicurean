...
const Laffable = () => (
  <RestaurantPage
    restaurantName="L'Affable"
    address="5 rue La Fontaine, Cannes, 06400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33493680209"
    website="https://www.restaurant-laffable.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of Cannes, this contemporary bistro is always busy and, indeed, it has much to recommend it. First and foremost its menu: courgette flower fritters, cod aioli, rack of lamb roasted with thyme… and the classic Grand Marnier soufflé, the house speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20La%20Fontaine%2C%20Cannes%2C%2006400%2C%20France"
    pageTitle="L'Affable"
  />
);

export default Laffable;
