...
const LaPalmeDor = () => (
  <RestaurantPage
    restaurantName="La Palme d'Or"
    address="73 boulevard de la Croisette, Cannes, 06400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33492987414"
    website="https://www.lapalmedor-restaurant.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20boulevard%20de%20la%20Croisette%2C%20Cannes%2C%2006400%2C%20France"
    pageTitle="La Palme d'Or"
  />
);

export default LaPalmeDor;
