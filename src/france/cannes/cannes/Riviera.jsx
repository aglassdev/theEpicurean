...
const Riviera = () => (
  <RestaurantPage
    ...
    address="Carlton Cannes, 58 boulevard de la Croisette, Cannes, 06400, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+33493064600"
    website="https://www.carltoncannes.com/eat-drink/riviera-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The legendary luxury hotel, which celebrated its 110th anniversary in 2023, now has its own marble-clad restaurant with a superb terrace overlooking the Croisette. In an opulent-feeling dining room where white meets black, the tables set with Gien porcelain are in line with time-honoured tradition of French table arts. The chef's table opposite the open kitchen also draws the eye. Everything else meets the standard set by your surroundings: Mediterranean cuisine made from top-quality local and seasonal ingredients, the calibre of service, with meat and fish cut at your table. You'll enjoy an excellent rack of Alpilles lamb with vegetables and jus, and a remarkable St Honoré cake with vanilla caramel and walnut pieces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carlton%20Cannes%2C%2058%20boulevard%20de%20la%20Croisette%2C%20Cannes%2C%2006400%2C%20France"
    pageTitle="Riviera"
  />
);
