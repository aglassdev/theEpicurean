...
const Table22ParNolMantel = () => (
  <RestaurantPage
    restaurantName="Table 22 par Noël Mantel"
    address="22 rue Saint-Antoine, Cannes, 06400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33493391310"
    website="https://www.restaurantmantel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this very touristy area, a stone's throw from the Marché Forville, a serious and passionate team works to showcase fine ingredients and lovely Provençal flavours – charred mackerel, beefsteak tomatoes and a lime-ginger mustard; John Dory, green vegetables and bourride sauce... A mouth-watering menu from starter to dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20rue%20Saint-Antoine%2C%20Cannes%2C%2006400%2C%20France"
    pageTitle="Table 22 par Noël Mantel"
  />
);

export default Table22ParNolMantel;
