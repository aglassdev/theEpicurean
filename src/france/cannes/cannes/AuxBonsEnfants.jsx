...
const AuxBonsEnfants = () => (
  <RestaurantPage
    restaurantName="Aux Bons Enfants"
    address="80 rue Meynadier, Cannes, 06400, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33768991789"
    website="https://aux-bons-enfants-cannes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family business, opened in 1935, only recently had a telephone line installed, but still accepts cash only! The fourth generation continues to craft authentic Provençal ingredients into heart-warming, hunger obliterating dishes. All the produce, fruit, veg and fish from small boats, comes direct from Forville Market just down the road. We tucked into petits farcis (stuffed vegetables), Niçois-style braised beef cheeks, homemade gnocchi and the house dessert: rum baba with vanilla cream – to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20rue%20Meynadier%2C%20Cannes%2C%2006400%2C%20France"
    pageTitle="Aux Bons Enfants"
  />
);

export default AuxBonsEnfants;
