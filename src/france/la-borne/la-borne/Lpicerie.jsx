...
const Lpicerie = () => (
  <RestaurantPage
    restaurantName="L'Épicerie"
    address="1 chemin des Usages, La Borne, 18250, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33248595750"
    website="https://guide.michelin.com/en/centre-val-de-loire/la-borne/restaurant/l-epicerie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Is the restaurant a grocer’s or is it the other way round? Whatever, this ebullient, two-in-one business quietly feeds us well, which is all that matters! Mathieu (in charge of savoury dishes) and Clémentine (desserts) curate a splendid, seasonal menu that stars regional produce: organic market garden veg from down the road, free-range meat and herbs from the garden. All the tableware (crockery, knife rests, carafes) is the handiwork of artisans established in this thriving pottery village. Their unpretentious eatery is a hit with the locals, which is always a good sign. Beware, 20 seats only, so book before you come. An affably French establishment offering a taste of rural life in times past!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20chemin%20des%20Usages%2C%20La%20Borne%2C%2018250%2C%20France"
    pageTitle="L'Épicerie"
  />
);

export default Lpicerie;
