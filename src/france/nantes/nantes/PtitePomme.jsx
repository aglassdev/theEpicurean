...
const PtitePomme = () => (
  <RestaurantPage
    restaurantName="P'tite Pomme"
    address="18 rue de Mayence, Nantes, 44000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33979323974"
    website="https://www.ptite-pomme.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw from the Cité des Congrès events venue and the lively rue Fouré, this concrete-clad neo-bistro has an industrial edge. It is run by a couple made up of chef Ruddy Maisonneuve (P'tite Pomme is his nickname) and Juliette Jovelin (front of house). Trained as a pastry chef and previously sous-chef at Lulu Rouget, the chef serves ultra-fresh seasonal cuisine, elevated by local produce – some of the vegetables are supplied by his brother, a farmer and baker. Refined and precise, his vibrant dishes are testament to the work of a true professional: crispy mussels and courgettes with house-made puff pastry; pearly hake, beetroot risotto and sage emulsion; sesame and passion fruit tartlet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20de%20Mayence%2C%20Nantes%2C%2044000%2C%20France"
    pageTitle="P'tite Pomme"
  />
);

export default PtitePomme;
