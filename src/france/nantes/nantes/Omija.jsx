...
const Omija = () => (
  <RestaurantPage
    restaurantName="Omija"
    address="54 rue Fouré, Nantes, 44000, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33240748105"
    website="https://www.omija.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20rue%20Four%C3%A9%2C%20Nantes%2C%2044000%2C%20France"
    pageTitle="Omija"
  />
);

export default Omija;
