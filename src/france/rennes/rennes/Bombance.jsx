...
const Bombance = () => (
  <RestaurantPage
    restaurantName="Bombance"
    address="23 rue de la Chalotais, Rennes, 35000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33778523994"
    website="https://bombance-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name hints at an abundance of food, drink and fun with friends, a promise that is kept within the stone walls of this bistro with an open kitchen and a few seats at the counter. From 5pm, you can wash down plates to share with a biodynamic or natural wine from the appealing wine list. From 7pm, you can choose from a menu-carte: roast pak choi, paprika sabayon and roasted hazelnut; skate wing, citrus butter, cream of celery, smoked Jerusalem artichoke, chestnuts and a langoustine jus. Very well cooked and seasoned with pizzazz and skill, each dish is packed with fresh ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20de%20la%20Chalotais%2C%20Rennes%2C%2035000%2C%20France"
    pageTitle="Bombance"
  />
);

export default Bombance;
