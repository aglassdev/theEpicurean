...
const LeParisbrest = () => (
  <RestaurantPage
    ...
    bio="Le Paris-Brest has reinvented the railway station buffet concept with a cheeky new take on traditional Breton fare. A judicious blend of a trendy decor, a bistronomic slant and a coherent menu make this halt a must for discerning foodies...."
    ...
    pageTitle="Le Paris-Brest"
  />
);

export default LeParisbrest;
