...
const LeParisbrestByChristianLeSquer = () => (
  <RestaurantPage
    restaurantName="Le Paris-Brest by Christian Le Squer"
    address="Gare de Rennes, Rennes, 35000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299535989"
    website="https://parisbrest.bzh/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Christian Le Squer has reinvented the railway station buffet concept whilst teasingly jazzing up traditional Breton fare. A trendy interior, a bistronomic menu and a wine list by Eric Beaumard: you’re in for a treat in Rennes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gare%20de%20Rennes%2C%20Rennes%2C%2035000%2C%20France"
    pageTitle="Le Paris-Brest by Christian Le Squer"
  />
);

export default LeParisbrestByChristianLeSquer;
