...
const Fezi = () => (
  <RestaurantPage
    restaurantName="Fezi"
    address="42 avenue du Sergent-Maginot, Rennes, 35000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33299366951"
    website="https://fezi-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The epitome of a friendly neighbourhood bistro steeped in an irresistible buzzy vibe. Fezi means home-made in Brittany's Gallo language. Cédric Bruneau, the young owner-chef, prepares tasty, straightforward, market-fresh cuisine, favouring regional ingredients. We tasted a carpaccio of wrasses (fish), beetroot, smoked cream and fingered citron; skate wing, mashed squash, cream of mussels; lemon curd, shortbread, steamed meringue and dried lime. Natural and biodynamic wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%20avenue%20du%20Sergent-Maginot%2C%20Rennes%2C%2035000%2C%20France"
    pageTitle="Fezi"
  />
);
