...
const Pof = () => (
  <RestaurantPage
    restaurantName="POF"
    address="35 boulevard Georges-Clemenceau, Rennes, 35200, France"
    cuisine="Creative"
    priceRange="€"
    phoneNumber="+33299778888"
    website="https://pof-resto.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The lunchtime menu is chalked up on a slate, while in the evening, the dishes of the concise menu carry playful, tongue-in-cheek names, which do however require a certain command of the French language to be appreciated! The globetrotting partners aim for a friendly vibe, a wide range of culinary influences (cream of cauliflower with Brittany curry spices, wakame crumble; crunchy quinoa and a Mexican-inspired jus; pear, myrtle, star anis, mascarpone and matcha tea) and market-fresh ingredients in line with the zeitgeist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20boulevard%20Georges-Clemenceau%2C%20Rennes%2C%2035200%2C%20France"
    pageTitle="POF"
  />
);
