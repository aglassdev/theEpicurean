...
const Racines = () => (
  <RestaurantPage
    ...
    address="4 passage Antoinette-Caillot, Rennes, 35000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33299656421"
    website="https://www.racines-restaurant.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="When a talented chef from Rennes, Virginie Giboire, embraces her roots (or Racines), the result is pleasing, contemporary cuisine in the form of elegant dishes. Boasting an impressive wealth of experience (of which we will only mention her stints alongside Guy Martin and Thierry Marx who, she says, taught her everything), she delivers clever and well-defined cuisine that always hits the mark, proposed in a short menu. Interesting interplays of textures, subtle marriages of flavours, and always the finest ingredients, often from small-scale Breton producers. All served up in a lovely, bright and modern setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20passage%20Antoinette-Caillot%2C%20Rennes%2C%2035000%2C%20France"
    pageTitle="Racines"
  />
);
