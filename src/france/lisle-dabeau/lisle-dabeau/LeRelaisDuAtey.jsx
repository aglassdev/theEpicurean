...
const LeRelaisDuAtey = () => (
  <RestaurantPage
    restaurantName="Le Relais du Çatey"
    address="10 rue du Didier, L'Isle-d'Abeau, 38080, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33474182650"
    website="https://www.le-relais-du-catey.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A contemporary decor and lighting enhance the authentic character of this regional house from 1774. Arctic char with meadowsweet, roast saddle of venison with juniper and mushrooms or Williams pear on a wafer-thin millefeuille. Pedigree classics and inventive flourishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20du%20Didier%2C%20L'Isle-d'Abeau%2C%2038080%2C%20France"
    pageTitle="Le Relais du Çatey"
  />
);

export default LeRelaisDuAtey;
