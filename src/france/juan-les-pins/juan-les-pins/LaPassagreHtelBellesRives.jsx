...
const LaPassagreHtelBellesRives = () => (
  <RestaurantPage
    restaurantName="La Passagère - Hôtel Belles Rives"
    address="33 boulevard Édouard-Baudoin, Juan-les-Pins, 06160, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33493610279"
    website="https://www.bellesrives.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first thing to strike guests in this hotel, where F. Scott and Zelda Fitzgerald's tumultuous romance played out in the 1920s, is its jaw-dropping location. It's not easy for a chef to make his mark in such a setting, but Aurélien Véquaud does just that. In a high-flying menu pulsating with Mediterranean flavours (such as little tunny, semi-confit tomatoes and rucola vinaigrette), the chef's origins – the Vendée in western France – still shine through on each plate. Unpasteurised cream jazzes up the crab in the signature dish (a soft esquinado cannelloni, verbena foam and fennel), and the marinière of shellfish seasoned with Oscietra caviar accompanies the sea bass. As for the desserts, pastry chef Steve Moracchini treats us to his fragrant strawberry concoction with geranium and rose. ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20boulevard%20%C3%89douard-Baudoin%2C%20Juan-les-Pins%2C%2006160%2C%20France"
    pageTitle="La Passagère - Hôtel Belles Rives"
  />
);

export default LaPassagreHtelBellesRives;
