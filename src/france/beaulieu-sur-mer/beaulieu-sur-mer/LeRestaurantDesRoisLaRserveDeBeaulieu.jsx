...
const LeRestaurantDesRoisLaRserveDeBeaulieu = () => (
  <RestaurantPage
    restaurantName="Le Restaurant des Rois - La Réserve de Beaulieu"
    address="5 boulevard du Maréchal-Leclerc, Beaulieu-sur-Mer, 06310, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33493010001"
    website="https://www.reservebeaulieu.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dating back to 1880 and later extended in a Renaissance Florentine style, this is one of the most opulent luxury hotels on the French Riviera. Since 1900 it has been playing host to monarchs and Hollywood stars, from Rita Hayworth to Frank Sinatra. Dining on the terrace facing the Mediterranean is a magical experience. At the helm is chef Julien Roucheteau, straight from Paris (Table du Lancaster, Scène Thélème). He remains loyal to the establishment's heritage, but adds his signature graphic presentations to dishes characterised by consummate craftsmanship. Each has its own specific theme: fresh, invigorating, luscious, unctuous...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20boulevard%20du%20Mar%C3%A9chal-Leclerc%2C%20Beaulieu-sur-Mer%2C%2006310%2C%20France"
    pageTitle="Le Restaurant des Rois - La Réserve de Beaulieu"
  />
);

export default LeRestaurantDesRoisLaRserveDeBeaulieu;
