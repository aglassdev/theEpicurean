...
const ChezMonJules = () => (
  <RestaurantPage
    restaurantName="Chez Mon Jules"
    address="5 rue Étienne-de-Vesc, Vesc, 26220, France"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+33475042074"
    website="https://www.chezmonjules.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the deliciously homely dining room decked in miscellaneous paraphernalia, you will be treated to tasty regional fare presented in one season-driven menu. Examples include homemade rennet with foie gras or lacquered pork belly from Dieulefit with regional veggies. In fine weather, take a seat on the shaded terrace and savour the knockout view...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20%C3%89tienne-de-Vesc%2C%20Vesc%2C%2026220%2C%20France"
    pageTitle="Chez Mon Jules"
  />
);

export default ChezMonJules;
