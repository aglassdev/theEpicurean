...
const LesLilas = () => (
  <RestaurantPage
    restaurantName="Les Lilas"
    address="12 rue du Général-de-Gaulle, Vagney, 88120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33329236947"
    website="https://www.restaurantleslilas.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the village at the foot of the Vosges, this large salmon - pink building by the roadside is impossible to miss! Diners are warmly welcomed by Armelle, in the handsome Art deco conservatory, while Lionel, in the kitchens, turns out tasty, contemporary dishes with a sprinkling of creative touches. Pleasant terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Vagney%2C%2088120%2C%20France"
    pageTitle="Les Lilas"
  />
);

export default LesLilas;
