...
const FermeLizarraga = () => (
  <RestaurantPage
    restaurantName="Ferme Lizarraga"
    address="550 Chemin de Lizarraga, Urrugne, 64122, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559470376"
    website="https://www.saint-jean-de-luz-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In lovely natural surroundings (lizarraga means ash forest in Basque), Véronique and Stéphane Poulin's restaurant is set in a converted 17C farmhouse with its character very much intact – it tastefully blends original rustic and pastoral cachet with more contemporary details. The chef serves up a sincere and skilful take on market-fresh cuisine that is infused with bold, distinctive flavours, such as the semi-cooked Landes duck foie gras, the line-caught hake served with excellent gnocchi and toasted sesame espuma, not forgetting the melt-in-the-mouth biscuit with almonds, strawberries and basil ice cream. Opt for the terrace in the shade of a century-old walnut tree and enjoy the efficient service of the lady of the house while taking in the view of the Rhune. A real gem!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=550%20Chemin%20de%20Lizarraga%2C%20Urrugne%2C%2064122%2C%20France"
    pageTitle="Ferme Lizarraga"
  />
);

export default FermeLizarraga;
