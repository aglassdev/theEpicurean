...
const LaFermeIlharreguiBaita = () => (
  <RestaurantPage
    restaurantName="La Ferme Ilharregui Baita"
    address="70 chemin de Apezerreka, Urrugne, 64122, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33559547339"
    website="https://ferme-ilharregui-baita.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 17C former farmhouse has been tastefully renovated both inside and out and now accommodates a contemporary Basque inn. Three set menus that focus on the Basque terroir set the tone: the first revolves around pulses, the second is based on seafood and the third showcases local ingredients. The colourful dishes taste as good as they look, a case in point being the lamb with Tarbais beans and smoked aubergine caviar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20chemin%20de%20Apezerreka%2C%20Urrugne%2C%2064122%2C%20France"
    pageTitle="La Ferme Ilharregui Baita"
  />
);

export default LaFermeIlharreguiBaita;
