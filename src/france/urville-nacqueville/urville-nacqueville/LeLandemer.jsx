...
const LeLandemer = () => (
  <RestaurantPage
    restaurantName="Le Landemer"
    address="2 rue des Douanes, Urville-Nacqueville, 50460, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33233040510"
    website="https://www.le-landemer.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fine stone house with a shale roof has an undeniable charm. Inside, a pleasant young Dutch chef cooks up modern cuisine with a dose of creativity, out of which he devises several courses according to his whims. The ingredients are exclusively from Normandy – not least fish, vegetables, wild herbs and flowers. The dishes are precise and on point, as are the food and drink pairings (the drinks, too, are local). The restaurant has a breathtaking view of the sea and coastline, as do the delightful guestrooms – it would be a shame not to book an overnight stay!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20des%20Douanes%2C%20Urville-Nacqueville%2C%2050460%2C%20France"
    pageTitle="Le Landemer"
  />
);

export default LeLandemer;
