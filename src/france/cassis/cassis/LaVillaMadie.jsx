...
const LaVillaMadie = () => (
  <RestaurantPage
    restaurantName="La Villa Madie"
    address="Avenue de Revestel, Cassis, 13260, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33496180000"
    website="https://www.lavillamadie.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestling in Anse Corton, an unspoilt natural cove facing Cap Canaille, La Villa Madie is a beautiful contemporary building with a terrace, set in a dream location above the blue waters of the Mediterranean. Hailing from Normandy, chef Dimitri Droisneau has a CV to be reckoned with (La Tour d'Argent, Lucas Carton, Ambroisie); he fell in love with Provence, which serves as a constant source of inspiration. From dish to dish, his cuisine is light, subtle, flavoursome, fresh and aromatic, punchy when it needs to be, always surprising and original. All the magic of the South of France – produce from land and sea, its fish and herbs, wild and otherwise – is channelled to great effect in this cuisine. A case in point: the Carabineros prawn, red berry tartlet, in which the marriage of the iodine a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20de%20Revestel%2C%20Cassis%2C%2013260%2C%20France"
    pageTitle="La Villa Madie"
  />
);

export default LaVillaMadie;
