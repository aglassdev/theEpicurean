...
const Orabasse = () => (
  <RestaurantPage
    restaurantName="O'Rabasse"
    address="5 place de la Pompe, Richerenches, 84600, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33952973493"
    website="https://www.orabasse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the “truffle capital”, O’Rabasse sings an ode to good food that respects traditions. Everything is made from scratch by the chef, with the help of local suppliers and in line with the seasons. A truly pleasant meal, further enhanced by smiling, professional service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20de%20la%20Pompe%2C%20Richerenches%2C%2084600%2C%20France"
    pageTitle="O'Rabasse"
  />
);

export default Orabasse;
