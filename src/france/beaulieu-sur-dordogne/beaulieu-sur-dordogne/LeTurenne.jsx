...
const LeTurenne = () => (
  <RestaurantPage
    restaurantName="Le Turenne"
    address="1 boulevard Rodolphe-de-Turenne, Beaulieu-sur-Dordogne, 19120, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33555286360"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/beaulieu-sur-dordogne/restaurant/le-turenne"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Contemporary, seasonal cuisine is served in this restaurant that combines original stone walls with modern design. The colourful dishes include rump of Limousin veal, peas, garlic and spring onions, served with a lovage jus. On sunny days, the gorgeous terrace adds to the gourmet experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20boulevard%20Rodolphe-de-Turenne%2C%20Beaulieu-sur-Dordogne%2C%2019120%2C%20France"
    pageTitle="Le Turenne"
  />
);

export default LeTurenne;
