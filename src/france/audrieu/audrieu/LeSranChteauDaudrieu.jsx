...
const LeSranChteauDaudrieu = () => (
  <RestaurantPage
    restaurantName="Le Séran - Château d'Audrieu"
    address="Château d'Audrieu, Audrieu, 14250, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33231802152"
    website="https://chateaudaudrieu.com/fr/le-seran-restaurant.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A listed 18C stately house, the epitome of special occasion indulgence, provides the perfect foil to polished French cuisine. Forthright recipes inspired by the classics which star local and seasonal produce that hit the spot every time, illustrated by saddle of lamb in marjoram garnished with potatoes and seaweed. First-class sauces and craftsmanship courtesy of a virtuoso chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20d'Audrieu%2C%20Audrieu%2C%2014250%2C%20France"
    pageTitle="Le Séran - Château d'Audrieu"
  />
);

export default LeSranChteauDaudrieu;
