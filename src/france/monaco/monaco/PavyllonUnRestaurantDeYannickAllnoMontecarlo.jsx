...
const PavyllonUnRestaurantDeYannickAllnoMontecarlo = () => (
  <RestaurantPage
    restaurantName="Pavyllon, un restaurant de Yannick Alléno, Monte-Carlo"
    address="Square Beaumarchais, Monaco, 98000, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+37798069898"
    website="https://www.montecarlosbm.com/fr/restaurant-monaco/pavyllon-monte-carlo-un-restaurant-yannick-alleno-hotel-hermitage-monte-carlo"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Square%20Beaumarchais%2C%20Monaco%2C%2098000%2C%20France"
    pageTitle="Pavyllon, un restaurant de Yannick Alléno, Monte-Carlo"
  />
);

export default PavyllonUnRestaurantDeYannickAllnoMontecarlo;
