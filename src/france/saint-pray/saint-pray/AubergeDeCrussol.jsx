...
const AubergeDeCrussol = () => (
  <RestaurantPage
    restaurantName="Auberge de Crussol"
    address="Chemin de Beauregard, Saint-Péray, 07130, France"
    cuisine="Grills"
    priceRange="€€"
    phoneNumber="+33475404765"
    website="https://aubergedecrussol.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on the heights of Saint-Péray, a stone’s throw from the ruins of Crussol castle, this former sheepfold is now the venue for regional country cooking. The meat, fish and vegetables are baked in a wood-fired oven or roasted on a spit. The chef showcases local produce, farm-reared veal and pork and organic eggs and veggies... Warm, welcoming vibe and a suitably rustic interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Beauregard%2C%20Saint-P%C3%A9ray%2C%2007130%2C%20France"
    pageTitle="Auberge de Crussol"
  />
);

export default AubergeDeCrussol;
