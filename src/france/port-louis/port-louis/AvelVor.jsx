...
const AvelVor = () => (
  <RestaurantPage
    restaurantName="Avel Vor"
    address="25 rue de Locmalo, Port-Louis, 56290, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33297824759"
    website="https://www.avelvor.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A brisk avel vor (sea breeze in Breton) depicts this seaside eatery. Camille Lacome and Agathe Richou craft flavoursome recipes rooted in the region (flawlessly fresh seafood, buckwheat, Guémené andouille, gwell, fermented milk) dotted with subtle Mediterranean accents (olive oil, thyme, tomato water). Spot-on, aromatic dishes served in a spacious modern setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20de%20Locmalo%2C%20Port-Louis%2C%2056290%2C%20France"
    pageTitle="Avel Vor"
  />
);

export default AvelVor;
