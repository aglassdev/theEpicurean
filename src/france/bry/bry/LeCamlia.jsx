...
const LeCamlia = () => (
  <RestaurantPage
    restaurantName="Le Camélia"
    address="17 rue de l'Église, Bry, 59144, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33327515391"
    website="https://lecameliadebry.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this 19C château built in the brick and white stone that is typical in northern France, the spruce and welcoming decor charms with its blend of old and new: first, a cosy bar that leads on to a dining room flooded with light from the windows on two sides, and giving onto a wooded park. The à la carte menu features carefully selected ingredients and precise, flavourful cuisine, cooked to perfection. A whole lobster, shelled and roasted, is served pearly white in the middle: the tail firm and flavourful, the claws tender, with crunchy or melt-in-the-mouth vegetables, a fragrant sauce with herring roe and a rich potato mash. The turbot in a beautifully golden bread crust is served with baby spinach leaves and a creamy beurre blanc sauce. The delicious dishes are straightforward and full of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20l'%C3%89glise%2C%20Bry%2C%2059144%2C%20France"
    pageTitle="Le Camélia"
  />
);

export default LeCamlia;
