...
const Ochre = () => (
  <RestaurantPage
    restaurantName="Ochre"
    address="56 rue du Gué, Rueil-Malmaison, 92500, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33981208169"
    website="https://ochre.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Welcome to the world of Baptiste Renouard, a seasoned chef who honed his skills at Lasserre, Robuchon and Alléno. In a picturesque, cobbled street in the heart of Rueil, his modern restaurant celebrates creative cuisine with lashings of talent. The reasonably priced lunchtime menu features dishes such as poached egg with green asparagus, ballotine of Atlantic cod and cauliflower or a dessert on the strawberry theme which is a festival of refreshing textures. The tasting menus unveil the chef’s proficient skill and weakness for veggies, in particular those grown locally and herbs that he picks himself on the nearby island of the Impressionists...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20rue%20du%20Gu%C3%A9%2C%20Rueil-Malmaison%2C%2092500%2C%20France"
    pageTitle="Ochre"
  />
);

export default Ochre;
