...
const Inicio = () => (
  <RestaurantPage
    ...
    address="32 avenue Bouloc-Torcatis, Carmaux, 81400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33755679485"
    website="https://guide.michelin.com/en/occitanie/carmaux_1491874/restaurant/inicio-1215745"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the homeland of Jean Jaurès, this restaurant occupies what was once the property of Carmaux Mining Company. Unsurprisingly, it is an imposing building with all the elements of a classic bourgeois interior – herringbone floorboards, mouldings and a marble fireplace. It is invariably packed to capacity (tables get booked up a week in advance). Mexican chef Yazmine Geze has struck on a culinary formula that is winning over the locals and their palates. Mediterranean cuisine with a Mexican twist, for instance vegetarian toastaditas or flame-grilled beef. There's a short, beautifully crafted set menu based on fresh local ingredients at lunchtime, and a more elaborate menu in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20avenue%20Bouloc-Torcatis%2C%20Carmaux%2C%2081400%2C%20France"
    pageTitle="Inicio"
  />
);
