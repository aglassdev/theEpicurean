...
const LesHautesRoches = () => (
  <RestaurantPage
    restaurantName="Les Hautes Roches"
    address="86 quai de la Loire, Rochecorbon, 37210, France"
    cuisine="Classic Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33247528888"
    website="https://www.leshautesroches.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a major refurbishment, the classical grandeur and former lustre of this majestic 18C manor house, whose beautiful troglodytic guestrooms are built directly into the tufa cliff, have been restored. The chef crafts a score that showcases top-notch produce (langoustine, foie gras, lobster, sweetbread), consummately and flawlessly. The terrace overlooking the river is simply divine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=86%20quai%20de%20la%20Loire%2C%20Rochecorbon%2C%2037210%2C%20France"
    pageTitle="Les Hautes Roches"
  />
);

export default LesHautesRoches;
