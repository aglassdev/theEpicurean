...
const DaPassano = () => (
  <RestaurantPage
    restaurantName="Da Passano"
    address="53 quai Comparetti, Bonifacio, 20169, France"
    cuisine="Corsican"
    priceRange="€€"
    phoneNumber="+33495281090"
    website="https://www.da-passano.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the port, this restaurant and wine bar revisits traditional Corsican fare in a modern, designer interior. Live guitar music on summer evenings on the shaded terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20quai%20Comparetti%2C%20Bonifacio%2C%2020169%2C%20France"
    pageTitle="Da Passano"
  />
);

export default DaPassano;
