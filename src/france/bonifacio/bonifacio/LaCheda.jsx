...
const LaCheda = () => (
  <RestaurantPage
    restaurantName="L'A Cheda"
    address="Route de Cavallo-Morto, Bonifacio, 20169, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33495730382"
    website="https://acheda-hotel.com/restaurant-gastronomique-bonifacio/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a seat on the terrace overlooking the pool in a setting, steeped in romanticism. The chef has a preference for local ingredients and rigorously selects his suppliers. You will enjoy wild fish, organic Corsican meat and vegetables fresh from the permaculture garden. Attentive service and a wine list rich in pleasant surprises...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Cavallo-Morto%2C%20Bonifacio%2C%2020169%2C%20France"
    pageTitle="L'A Cheda"
  />
);

export default LaCheda;
