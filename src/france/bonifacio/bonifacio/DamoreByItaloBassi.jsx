...
const DamoreByItaloBassi = () => (
  <RestaurantPage
    restaurantName="D'Amore by Italo Bassi"
    address="51 quai Jérôme-Comparetti, Bonifacio, 20169, France"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+33495102034"
    website="https://d-amore.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on Bonifacio marina, this place immediately appeals with its bright, colourful decor, every last detail of which has been carefully thought through. The menu comprises crudos, cold starters and hot dishes (risottos and pasta, all house-made and cooked to al dente perfection). From olive oil to local fish and Italian ingredients, this restaurant exudes quality and good taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20quai%20J%C3%A9r%C3%B4me-Comparetti%2C%20Bonifacio%2C%2020169%2C%20France"
    pageTitle="D'Amore by Italo Bassi"
  />
);

export default DamoreByItaloBassi;
