...
const LaTaverneAlsacienne = () => (
  <RestaurantPage
    restaurantName="La Taverne Alsacienne"
    address="99 rue de la République, Ingersheim, 68040, France"
    cuisine="Modern Cuisine, Alsatian"
    priceRange="€€"
    phoneNumber="+33389270841"
    website="https://www.tavernealsacienne-familleguggenbuhl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by the Guggenbuhl family since 1964, this salmon-pink-fronted tavern has earned its reputation. Even those who know nothing about Alsace cuisine are smitten by the enticing regional dishes, washed down by fine wines from near and far! The fillet of zander, sautéed sauerkraut and Riesling sauce we sampled lingers with us still...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20rue%20de%20la%20R%C3%A9publique%2C%20Ingersheim%2C%2068040%2C%20France"
    pageTitle="La Taverne Alsacienne"
  />
);

export default LaTaverneAlsacienne;
