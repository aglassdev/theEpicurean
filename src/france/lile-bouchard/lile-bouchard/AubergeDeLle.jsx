...
const AubergeDeLle = () => (
  <RestaurantPage
    restaurantName="Auberge de l'Île"
    address="3 place Bouchard, L'Ile-Bouchard, 37220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247585107"
    website="https://www.aubergedelile.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this plush restaurant on an island in the River Vienne, chef Pierre Koniecko rustles up recipes that are both tasty and generous, such as his medley of lamb (grilled chop and saddle, confit shoulder pastilla). In summertime, the teak deck patio by the riverside is an undeniable draw!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20place%20Bouchard%2C%20L'Ile-Bouchard%2C%2037220%2C%20France"
    pageTitle="Auberge de l'Île"
  />
);

export default AubergeDeLle;
