...
const AubergeDeLaVieilleFerme = () => (
  <RestaurantPage
    restaurantName="Auberge de la Vieille Ferme"
    address="58 rue de la République, Le Meux, 60880, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33344415854"
    website="https://www.hotel-restaurant-oise.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this little village not far from Compiègne, a former farmstead is now a very popular hotel and restaurant. The chef signs a culinary score that is both delicate and appetising, dotted with personal touches such as a starter of razor clams, cuttlefish and potatoes, or the peanut, caramel and vanilla millefeuille dessert – to die for! Highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20rue%20de%20la%20R%C3%A9publique%2C%20Le%20Meux%2C%2060880%2C%20France"
    pageTitle="Auberge de la Vieille Ferme"
  />
);

export default AubergeDeLaVieilleFerme;
