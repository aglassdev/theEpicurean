...
const LePetitComptoir = () => (
  <RestaurantPage
    restaurantName="Le Petit Comptoir"
    address="4 boulevard du Maréchal-Joffre, Narbonne, 11100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33468423035"
    website="https://www.petitcomptoir.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This gastronomic eatery with a 1930s character serves bistro cuisine with fine ingredients. If you fancy buying a bottle of one of the wines served here – there are 350 on the list, most of them local – pay a visit to the cellar!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20boulevard%20du%20Mar%C3%A9chal-Joffre%2C%20Narbonne%2C%2011100%2C%20France"
    pageTitle="Le Petit Comptoir"
  />
);

export default LePetitComptoir;
