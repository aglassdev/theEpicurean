...
const LartDeVivreNAR = () => (
  <RestaurantPage
    restaurantName="L'Art de Vivre"
    address="Château de L'Hospitalet, route de Narbonne-Plage, Narbonne, 11100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33468452850"
    website="https://chateau-hospitalet.com/pages/gastronomie-lart-de-vivre"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this vineyard nestled in the La Clape mountains, chef Laurent Chabert sources some of his ingredients (including aromatic herbs) from his own kitchen garden, and also uses fine local produce (organic for the most part). He creates colourful, fragrant dishes, such as grouper cooked over the embers of a barbecue, braised aubergine glazed with tomato juices… The food and wine pairings draw on a selection of bottles from the estate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20L'Hospitalet%2C%20route%20de%20Narbonne-Plage%2C%20Narbonne%2C%2011100%2C%20France"
    pageTitle="L'Art de Vivre"
  />
);

export default LartDeVivreNAR;
