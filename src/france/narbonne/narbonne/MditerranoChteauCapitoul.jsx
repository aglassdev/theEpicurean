...
const MditerranoChteauCapitoul = () => (
  <RestaurantPage
    restaurantName="Méditerranéo - Château Capitoul"
    address="Route de Gruissan, Narbonne, 11100, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+33448220724"
    website="https://www.chateaucapitoul.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Massif de la Clape, between Narbonne and the Mediterranean, vineyards and garrigue, this manor house sits pretty in a wine estate that has been run by the same family for seven generations. Chef Valère Diochet's cuisine is unabashedly Mediterranean. A host of aromatic plants – basil, purslane, lovage – enhance this aesthetic cuisine, which is refined, precise and light: marinated monkfish, courgette with lovage; red mullet cooked on one side. The restaurant's plush Art Deco interior overlooks the vineyards and the waters of the Étang de Bages. The wine list is informative, with wines from the estate, the La Clape appellation and other Languedoc wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Gruissan%2C%20Narbonne%2C%2011100%2C%20France"
    pageTitle="Méditerranéo - Château Capitoul"
  />
);

export default MditerranoChteauCapitoul;
