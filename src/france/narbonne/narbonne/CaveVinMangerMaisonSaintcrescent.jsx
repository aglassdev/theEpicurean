...
const CaveVinMangerMaisonSaintcrescent = () => (
  <RestaurantPage
    restaurantName="Cave à Vin & à Manger - Maison Saint-Crescent"
    address="Rond-point de la Liberté, 68 avenue du Général-Leclerc, Narbonne, 11100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33468456785"
    website="https://maison.saintcrescent.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Cave à Manger by Lionel Giraud proposes bistro cuisine made with top-notch ingredients from Occitanie. The food is rugged, flavoursome and spot-on – special mention for the chuck beef slowly simmered in its juices and the velvety purée of carrots. La Cave à Vin, located under the same roof, boasts 2,500 wines; pick a bottle to drink with your meal for a corkage fee. A real winner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rond-point%20de%20la%20Libert%C3%A9%2C%2068%20avenue%20du%20G%C3%A9n%C3%A9ral-Leclerc%2C%20Narbonne%2C%2011100%2C%20France"
    pageTitle="Cave à Vin & à Manger - Maison Saint-Crescent"
  />
);

export default CaveVinMangerMaisonSaintcrescent;
