...
const HlneDarrozeVillaLaCoste = () => (
  <RestaurantPage
    ...
    pageTitle="Hélène Darroze à Villa La Coste"
  />
);

export default HlneDarrozeVillaLaCoste;
