...
const LeTempsSuspenduChteauDeFonscolombe = () => (
  <RestaurantPage
    restaurantName="Le Temps Suspendu - Château de Fonscolombe"
    address="Route de Saint-Canadet, Le Puy-Sainte-Réparade, 13610, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33442211313"
    website="https://www.fonscolombe.com/fr/le-temps-suspendu.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a modern wing of Fonscolombe Castle, Le Temps Suspendu is depicted by a smart, understated interior with exposed timber beams and bay windows opening onto the terrace and grounds. The chef’s elegant, well-crafted cuisine is rich in passing nods to the Mediterranean...."
    ...
    pageTitle="Le Temps Suspendu - Château de Fonscolombe"
  />
);

export default LeTempsSuspenduChteauDeFonscolombe;
