...
const FrancisMallmannAuChteauLaCoste = () => (
  <RestaurantPage
    restaurantName="Francis Mallmann au Château La Coste"
    address="2750 route de la Cride, Le Puy-Sainte-Réparade, 13610, France"
    cuisine="Meats and Grills, Argentinian"
    priceRange="€€€€"
    phoneNumber="+33442913737"
    website="https://chateau-la-coste.com/fr/restaurants/restaurant-argentin-francis-mallmann.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The famous Argentine chef's philosophy is adhered to down to the tiniest detail: slowly smoked entrecote, mashed potato and chimichurri; lamb flame - cooked in a dome fire, aubergine, roasted peppers... served in a bright, elegant interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2750%20route%20de%20la%20Cride%2C%20Le%20Puy-Sainte-R%C3%A9parade%2C%2013610%2C%20France"
    pageTitle="Francis Mallmann au Château La Coste"
  />
);

export default FrancisMallmannAuChteauLaCoste;
