...
const JardinSecret = () => (
  <RestaurantPage
    restaurantName="Jardin Secret"
    address="13 rue de l'Araignée, Cotignac, 83570, France"
    cuisine="Provençal"
    priceRange="€€€"
    phoneNumber="+33494783051"
    website="https://www.loucalen.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Back from the rock of Monaco, Benoît Witz has hung his hat in a pretty estate in Provence. In the shade of olive groves and released from gastronomic codes, he crafts 100% authentic dishes in a style that he himself joyfully describes as “grandma’s country cooking”! Garden-fresh beefsteak tomatoes, fish of the day with summer veggies, melt-in-the-mouth chocolate cake. Scrumptious and generous – yummy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20de%20l'Araign%C3%A9e%2C%20Cotignac%2C%2083570%2C%20France"
    pageTitle="Jardin Secret"
  />
);
