...
const LeBistrotDeVilledieu = () => (
  <RestaurantPage
    restaurantName="Le Bistrot de Villedieu"
    address="21 place de la Libération, Villedieu, 84110, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33490289702"
    website="https://www.lebistrotdevilledieu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Laurent Azoulay curates Provençal fare in a locally sourced bistro register. Everything tastes of something in the flawlessly executed, characterful repertory and some of the dishes are cooked in the wood-burning oven of the open kitchen. Meals are served in a contemporary bistro setting, or, in fine weather, on the shaded terrace on the village square...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20place%20de%20la%20Lib%C3%A9ration%2C%20Villedieu%2C%2084110%2C%20France"
    pageTitle="Le Bistrot de Villedieu"
  />
);

export default LeBistrotDeVilledieu;
