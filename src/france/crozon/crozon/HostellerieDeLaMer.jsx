...
const HostellerieDeLaMer = () => (
  <RestaurantPage
    restaurantName="Hostellerie de la Mer"
    address="11 quai du Fret, Crozon, 29160, France"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+33298276190"
    website="https://www.hostelleriedelamer.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef crafts cuisine in tune with the zeitgeist, wonderfully blending fish from the local catch and ingredients from Brittany's terroir, such as house-smoked salmon, tangy herb cream and buckwheat blini, or the blanquette of monkfish and Molène sausage, vegetables and steamed potatoes. The cooking is precise and accentuates the well-chosen ingredients!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20quai%20du%20Fret%2C%20Crozon%2C%2029160%2C%20France"
    pageTitle="Hostellerie de la Mer"
  />
);

export default HostellerieDeLaMer;
