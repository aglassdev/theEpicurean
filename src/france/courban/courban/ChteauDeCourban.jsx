...
const ChteauDeCourban = () => (
  <RestaurantPage
    restaurantName="Château de Courban"
    address="7 rue du Lavoir, Courban, 21520, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380937869"
    website="https://chateaudecourban.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Château de Courban is an elegant 19C mansion with a burnt sienna-coloured façade, looking out over its grounds. Preceded by a plush lounge with a crackling fireplace, the restaurant is housed in the property's converted barn, which boasts a beamed ceiling in the regional style, chandeliers and mirrors. In the manner of a skilled craftsman, the chef shapes his raw materials – excellent ingredients – into delicate seasonal dishes, the leitmotif of which is flavour: tomato confit and its three condiments; line-caught cod with sauce bonne femme; Racan pigeon, pigeon-foie gras sausage, cabbage and truffle jus. The meal is rounded off in fine style with pared-back desserts that are low in sugar. The wine list has a particularly good selection of champagnes and Burgundy labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Lavoir%2C%20Courban%2C%2021520%2C%20France"
    pageTitle="Château de Courban"
  />
);

export default ChteauDeCourban;
