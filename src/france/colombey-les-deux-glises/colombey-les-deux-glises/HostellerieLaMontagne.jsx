...
const HostellerieLaMontagne = () => (
  <RestaurantPage
    restaurantName="Hostellerie la Montagne"
    address="10 rue Pisseloup, Colombey-les-Deux-Églises, 52330, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33325015169"
    website="https://www.hostellerielamontagne.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In this peaceful Haute-Marne village that was close to General de Gaulle's heart, this fine 17C stone house is surrounded by beautiful grounds that blend into the countryside. Inside, however, not a hint of nostalgia! Neither in the contemporary decor, nor in the cuisine – not even in the set menu dubbed Je vous avez compris! (I have understood you! – from de Gaulle's famous speech). Chef Jean-Baptiste Natali has travelled extensively, from Marrakesh to London and New York. He cooks up a contemporary take on French fine dining (with frequent nods to his travels), working with fine produce such as langoustines, red mullet, lobster, Angus beef and calf sweetbreads. HHis broccoli with Galician sea-urchin, his langoustine and foie gras, his calf’s sweetbreads with citron butter and oyster riso..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Pisseloup%2C%20Colombey-les-Deux-%C3%89glises%2C%2052330%2C%20France"
    pageTitle="Hostellerie la Montagne"
  />
);

export default HostellerieLaMontagne;
