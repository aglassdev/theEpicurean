...
const LaubergeDanthy = () => (
  <RestaurantPage
    restaurantName="L'Auberge d'Anthy"
    address="2 rue des Écoles, Anthy-sur-Léman, 74200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33450703500"
    website="https://www.auberge-anthy.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This traditional small hotel-restaurant-café is all about the simple pleasures in life! It is perfect to enjoy fish from Lake Geneva (perch, fera and Arctic char), supplied by local fishermen. The chef also likes to showcase the charcuterie and cheese from the Chablais region!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20des%20%C3%89coles%2C%20Anthy-sur-L%C3%A9man%2C%2074200%2C%20France"
    pageTitle="L'Auberge d'Anthy"
  />
);

export default LaubergeDanthy;
