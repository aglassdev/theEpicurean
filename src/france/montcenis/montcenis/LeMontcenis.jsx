...
const LeMontcenis = () => (
  <RestaurantPage
    restaurantName="Le Montcenis"
    address="2 place du Champ-de-Foire, Montcenis, 71710, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385554436"
    website="https://restaurant-lemontcenis.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Both the decor (vaulted cellar, exposed stone and beams) and the food are full of character. Laurent Dufour draws on fine produce to create generous and authentic dishes, such as fillet of sea bream with Provencal-style vegetables and pesto, or roast pigeon with pan-fried foie gras and sherry jus. The menu changes regularly and, in winter, features truffles, of which the chef is a big fan! The welcome is cordial...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20du%20Champ-de-Foire%2C%20Montcenis%2C%2071710%2C%20France"
    pageTitle="Le Montcenis"
  />
);

export default LeMontcenis;
