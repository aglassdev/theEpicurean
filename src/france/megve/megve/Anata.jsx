...
const Anata = () => (
  <RestaurantPage
    restaurantName="Anata"
    address="36 rue Saint-François, Megève, 74120, France"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+33659559583"
    website="https://www.juliengatillon.fr/anata"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the same roof as Vous but upstairs, this light wooden counter serves traditional Japanese fare. All the nigiri, California rolls, sashimi, maki, tempura and gyoza are crafted with top-drawer ingredients, such as wagyu beef or Otoro tuna belly. Bento at lunchtime...."
