...
const Vous = () => (
  <RestaurantPage
    restaurantName="Vous"
    address="36 rue Saint-François, Megève, 74120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33659559583"
    website="https://www.juliengatillon.fr/vous"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A gorgeous building typical of the sort you find in Megève, a refined decor with an abundance of wood, an elegant counter seating 14 diners: a warm welcome awaits you at Vous! Under the guidance of Julien Gatillon (previously at Le 1920), young chef Jean Pastre delights diners with modern cuisine prepared before their eyes. The finest local (and international) produce is used: vendace, watercress and caviar; langoustine, potato and Savoy saffron; farmhouse veal fillet, celery confit and lovage emulsion. Elegant, delicate dishes boasting clarity and bold flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20Saint-Fran%C3%A7ois%2C%20Meg%C3%A8ve%2C%2074120%2C%20France"
    pageTitle="Vous"
  />
);
