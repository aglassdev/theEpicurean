...
const BrasserieBenjamin = () => (
  <RestaurantPage
    restaurantName="Brasserie Benjamin"
    address="Four Seasons Resort Megève, 373 chemin des Follières, Megève, 74120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33450786265"
    website="https://www.fourseasons.com/fr/megeve/dining/restaurants/brasserie-benjamin/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the foot of Mont d'Arbois, this elegant brasserie within the prestigious Rothschild family hotel tempts skiers, hikers and trail runners with its mouthwatering menu. Sole meunière, Rossini-style beef fillet, Norwegian omelette to share or millefeuille feature alongside linguine with cockles and house-made bottarga, risotto and even vegetarian dishes. Spacious and cosy dining room, attentive service and superb wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Resort%20Meg%C3%A8ve%2C%20373%20chemin%20des%20Folli%C3%A8res%2C%20Meg%C3%A8ve%2C%2074120%2C%20France"
    pageTitle="Brasserie Benjamin"
  />
);

export default BrasserieBenjamin;
