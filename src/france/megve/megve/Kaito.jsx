...
const Kaito = () => (
  <RestaurantPage
    restaurantName="Kaito"
    address="Four Seasons Megève, 373 chemin des Follières, Megève, 74120, France"
    cuisine="Japanese, Fusion"
    priceRange="€€€€"
    phoneNumber="+33450211211"
    website="https://www.fourseasons.com/megeve/dining/restaurants/kaito/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the Four Seasons Hotel, flawlessly fresh sashimi, tataki and sushi rub shoulders with delicately crafted alpine specialties. Fusion cuisine to be enjoyed on the terrace commanding a splendid view of the slopes or in the softly lit interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Meg%C3%A8ve%2C%20373%20chemin%20des%20Folli%C3%A8res%2C%20Meg%C3%A8ve%2C%2074120%2C%20France"
    pageTitle="Kaito"
  />
);
