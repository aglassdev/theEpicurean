...
const LePrieurMEG = () => (
  <RestaurantPage
    ...
    address="116 place de l'Église, Megève, 74120, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450210179"
    website="https://www.leprieure-megeve.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the main square in the heart of Megève, abutting the church, this former priory morphed into a restaurant back in 1930. Today this handsome alpine setting is where Emmanuel Renaut delivers his traditional bistro fare: œuf meurette Savoyard style, pâté en croûte (porkpie), ravioles filled with local cheese, tartare of beef, steak or arctic char. The establishment also boasts a spacious terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=116%20place%20de%20l'%C3%89glise%2C%20Meg%C3%A8ve%2C%2074120%2C%20France"
    pageTitle="Le Prieuré"
  />
);

export default LePrieurMEG;
