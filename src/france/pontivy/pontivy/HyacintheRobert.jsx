...
const HyacintheRobert = () => (
  <RestaurantPage
    restaurantName="Hyacinthe & Robert"
    address="100 rue Nationale, Pontivy, 56300, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33643682645"
    website="https://www.hyacinthe-et-robert.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Damien Le Quillec named his restaurant after his two grandfathers. In this unusual setting – previously a garage, cleverly converted into a contemporary loft – he channels his talent into crafting ambitious dishes that appeal to the modern palate. Meanwhile, he has opened a convivial little bistro next door – Numéro 100, where he serves bistronomy fare in a home-from-home atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20rue%20Nationale%2C%20Pontivy%2C%2056300%2C%20France"
    pageTitle="Hyacinthe & Robert"
  />
);

export default HyacintheRobert;
