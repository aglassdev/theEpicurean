...
const LarcheDeMeslay = () => (
  <RestaurantPage
    restaurantName="L'Arche de Meslay"
    address="14 rue des Ailes, Parçay-Meslay, 37210, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33247290007"
    website="https://www.larchedemeslay.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The surroundings are quickly forgotten (a business estate), as you concentrate on the fine and fresh food, truly bursting with flavours. One case in point is the speciality of the Breton chef: Tours - style bouillabaisse – packed with red mullet, scorpion fish, pork rillons and andouillette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20des%20Ailes%2C%20Par%C3%A7ay-Meslay%2C%2037210%2C%20France"
    pageTitle="L'Arche de Meslay"
  />
);

export default LarcheDeMeslay;
