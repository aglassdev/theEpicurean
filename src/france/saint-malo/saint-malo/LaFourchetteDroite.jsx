...
const LaFourchetteDroite = () => (
  <RestaurantPage
    restaurantName="La Fourchette à Droite"
    address="2 rue de la Pie-qui-Boit, Saint-Malo, 35400, France"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+33299409725"
    website="https://www.restaurant-lafourchetteadroite.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to Caroline and Étienne Corson's eminently hospitable eatery. She is in charge of the front-of-house and, left-handed, hence the fork in the restaurant's name is on the right! The dishes celebrate the best of Brittany, showcasing first-class seasonal ingredients: monkfish gravlax with creamy fennel and seaweed jam; plaice, partly mashed potatoes and mikan sauce; melt-in-the-mouth baked apple with a crunchy almond topping and cider caramel, for example. Booking is recommended, as seating is limited in the small cosy dining room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20de%20la%20Pie-qui-Boit%2C%20Saint-Malo%2C%2035400%2C%20France"
    pageTitle="La Fourchette à Droite"
  />
);

export default LaFourchetteDroite;
