...
const MaisonVermer = () => (
  <RestaurantPage
    restaurantName="Maison Vermer"
    address="79 boulevard de Rochebonne, Saint-Malo, 35400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33299208552"
    website="https://www.maisonvermer.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a spruce house a stone’s throw from Rochebonne beach, rather than a Dutch painter, you will find a chef whose culinary ambition is to unite land and sea (hence the pun: “ver(t)”/green for the land and “mer”/sea for the… sea!). In his open-plan kitchen, he works with locally sourced produce, delivering well-balanced dishes. Market-fresh fare, sensibly priced lunchtime menu, more ambitious in the evenings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79%20boulevard%20de%20Rochebonne%2C%20Saint-Malo%2C%2035400%2C%20France"
    pageTitle="Maison Vermer"
  />
);

export default MaisonVermer;
