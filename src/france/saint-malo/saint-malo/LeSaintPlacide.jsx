...
const LeSaintPlacide = () => (
  <RestaurantPage
    restaurantName="Le Saint Placide"
    address="6 place du Poncel, Saint-Servan-sur-Mer, Saint-Malo, 35400, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33299817073"
    website="https://www.st-placide.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sheltered from St-Malo’s tourist hordes in a district popular with the locals, this handsome contemporary restaurant sports a decor of organic curves, Fornasetti tableware and pendant lights by Tom Dixon. Chef Luc Mobihan, a wizard when it comes to fish, seafood and regional veggies, boasts stints at the Château de la Chenevière (Port-en-Bessin) and at the Amphitryon (Lorient), where he was the second to Jean-Paul Abadie. He conjures up enticing cuisine in the zeitgeist, such as seared scallops, chutney of confit turnips and Noilly Prat. Meanwhile, his wife Isabelle gives free rein to her love of table arts and her passion for fine wines (Champagne, Loire, Burgundy etc). Attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20place%20du%20Poncel%2C%20Saint-Servan-sur-Mer%2C%20Saint-Malo%2C%2035400%2C%20France"
    pageTitle="Le Saint Placide"
  />
);

export default LeSaintPlacide;
