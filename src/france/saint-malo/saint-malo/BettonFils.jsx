...
const BettonFils = () => (
  <RestaurantPage
    restaurantName="Betton Fils"
    address="7 rue des Grands-Degrés, Saint-Malo, 35400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33222668949"
    website="https://www.bettonfils.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant in the city centre sits neatly in a corner building sporting the characteristic grey stone of Saint-Malo. At the helm is chef Victor Betton, once a fencing champion, who deftly dishes up generous cuisine. A devotee of fine food, he searches out the best ingredients within a 50km radius. At lunchtime, the reasonably priced menu would disarm any adversary: fillet of pollack cooked golden, creamy potato purée, flavoursome shellfish foam; roasted figs, rosemary oil, shiso and herbaceous granita. In the evening, the menu focuses on more premium ingredients (hand-dived scallops, line-caught John Dory)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20des%20Grands-Degr%C3%A9s%2C%20Saint-Malo%2C%2035400%2C%20France"
    pageTitle="Betton Fils"
  />
);

export default BettonFils;
