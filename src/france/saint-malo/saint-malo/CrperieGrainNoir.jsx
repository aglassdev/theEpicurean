...
const CrperieGrainNoir = () => (
  <RestaurantPage
    restaurantName="Crêperie Grain Noir"
    address="16 rue de la Herse, Saint-Malo, 35400, France"
    cuisine="Breton"
    priceRange="€"
    phoneNumber="+33223175679"
    website="https://guide.michelin.com/en/bretagne/saint-malo/restaurant/creperie-grain-noir"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite the Halle au Blé in Saint-Malo, this little crêperie is not to be missed. It serves classic galettes (buckwheat pancakes), as well as more original recipes: the langouille galette is with pork tongue; the Grain Noir with Breton trout, fresh goat's cheese, crunchy vegetables and lemon; the Ty Nevez with andouille from Dinan, egg, Emmental and mustard. They also serve hors d'oeuvre, such as chilli butter and raw cocoa nibs, and salted butter and seaweed tartar. Most of the ingredients are organic; the ciders and wines are natural...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20de%20la%20Herse%2C%20Saint-Malo%2C%2035400%2C%20France"
    pageTitle="Crêperie Grain Noir"
  />
);

export default CrperieGrainNoir;
