...
const MaisonPellestorVeyrier = () => (
  <RestaurantPage
    restaurantName="Maison Pellestor Veyrier"
    address="28 chemin de Gramont, Colomiers, 31770, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33561155555"
    website="https://maisonpellestorveyrier.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Quentin Pellestor-Veyrier has set up shop with his partner Camille Hubert (front of house) in the former premises of Yannick Delpech's L'Amphitryon. Now in his thirties, he has built up a remarkable CV, having honed his skills in prestigious restaurants in the South of France (Franck Putelat, Gilles Goujon) and alongside another icon of Mediterranean cuisine, Alain Ducasse. His menu pays tribute to Occitan culinary heritage: from the South-West, foie gras and duck breast, veau du Ségala (veal), fragrant strawberries and toasted almonds; from the Mediterranean, Sétoise rouille, oysters from the Étang de Thau, black olives, and Blanquette de Limoux. He and his team take real pleasure in sharing their flavourful, distinctive creations based on the same high-quality produce used by their ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20chemin%20de%20Gramont%2C%20Colomiers%2C%2031770%2C%20France"
    pageTitle="Maison Pellestor Veyrier"
  />
);

export default MaisonPellestorVeyrier;
