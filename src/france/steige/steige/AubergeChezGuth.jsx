...
const AubergeChezGuth = () => (
  <RestaurantPage
    restaurantName="Auberge Chez Guth"
    address="5A rue du Bas-des-Monts, Steige, 67220, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33388581205"
    website="https://www.auberge-chez-guth.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the upper reaches of the village of Steige in the picturesque Villé valley, this old farmhouse inn is the canvas on which chef Yannick Guth expresses his creativity. With a focus on local ingredients (like the herbs and flowers he picks himself), the chef also works with fish from the lake (pike, zander, whitefish). Examples: whitefish in seaweed with a chickpea rouille sauce; kromesky of pheasant, mountain lovage, parsley and mushrooms… His ingenuity can sometimes surprise, but the striking, consummate result is always succulent. The terrace overlooks a mountain landscape of jaw-dropping proportions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5A%20rue%20du%20Bas-des-Monts%2C%20Steige%2C%2067220%2C%20France"
    pageTitle="Auberge Chez Guth"
  />
);

export default AubergeChezGuth;
