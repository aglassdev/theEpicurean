...
const LLaBoucheLES = () => (
  <RestaurantPage
    restaurantName="L'Ô à la Bouche"
    address="510 route Notre-Dame-de-la-Gorge, Les Contamines-Montjoie, 74170, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450478167"
    website="https://www.lo-contamines.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One site and two moods united by the same desire to make your mouth water! On the ground floor, a contemporary style of decor, and fresh, tasty gourmet cuisine, prepared by a chef with a distinct fondness for fresh produce and fish. Try the excellent home-made deli meats, too. Specials announced according to the market. Sit back and drink in the conviviality of the mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=510%20route%20Notre-Dame-de-la-Gorge%2C%20Les%20Contamines-Montjoie%2C%2074170%2C%20France"
    pageTitle="L'Ô à la Bouche"
  />
);

export default LLaBoucheLES;
