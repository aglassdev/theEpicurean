...
const LessentielATT = () => (
  <RestaurantPage
    ...
    address="19 rue de Neuville, Attiches, 59551, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33320900697"
    website="https://www.essentiel-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This handsome redbrick edifice at a crossroads in the hamlet of Petit Attiches is run by an enthusiastic young couple. A stylish, modern interior, a terrace and a pretty garden to the rear set the inviting scene. Carefully crafted, up-to-the-minute dishes are paired with fine wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20de%20Neuville%2C%20Attiches%2C%2059551%2C%20France"
    pageTitle="L'Essentiel"
  />
);

export default LessentielATT;
