...
const LaubergeDesMontagnes = () => (
  <RestaurantPage
    restaurantName="L'Auberge des Montagnes"
    address="7 chemin de la Beauté, Pailherols, 15800, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33471475701"
    website="https://www.auberge-des-montagnes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This farmstead in the heart of a remote picturesque village (ideal for walks in the country) is the HQ of a chef who competently and carefully crafts traditional recipes. Save room for the cheese board and Salers cheese, produced just a few yards away...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20chemin%20de%20la%20Beaut%C3%A9%2C%20Pailherols%2C%2015800%2C%20France"
    pageTitle="L'Auberge des Montagnes"
  />
);

export default LaubergeDesMontagnes;
