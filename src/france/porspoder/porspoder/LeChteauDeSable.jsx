...
const LeChteauDeSable = () => (
  <RestaurantPage
    restaurantName="Le Château de Sable"
    address="38 rue de l'Europe, Porspoder, 29840, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33229003132"
    website="https://www.lechateaudesablehotel.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Time seems to have stopped here, in this tranquil spot on the coast overlooking the Saint Laurent peninsula, which can be seen from the plush, cosy interior of this smart seaside establishment. The chef uses local Breton produce in traditional recipes, together with more high-flying creations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20de%20l'Europe%2C%20Porspoder%2C%2029840%2C%20France"
    pageTitle="Le Château de Sable"
  />
);

export default LeChteauDeSable;
