...
const LaTableDeLeurope = () => (
  <RestaurantPage
    restaurantName="La Table de l'Europe"
    address="1 place Jean-Moulin, Villeréal, 47210, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553360035"
    website="https://www.europe-villereal.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite the country town’s covered market, this tastefully appointed guesthouse and restaurant invite diners to sit down, relax and enjoy a good meal. You will taste the fine cuisine of a veteran chef who deftly crafts appetising French-accented dishes. The chef’s desserts (she originally trained as a pastry chef) are wickedly irresistible: a hazelnut extravaganza of praline, hazelnut mousse and butterscotch – to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20place%20Jean-Moulin%2C%20Viller%C3%A9al%2C%2047210%2C%20France"
    pageTitle="La Table de l'Europe"
  />
);

export default LaTableDeLeurope;
