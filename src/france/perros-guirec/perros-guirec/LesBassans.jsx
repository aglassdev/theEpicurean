...
const LesBassans = () => (
  <RestaurantPage
    restaurantName="Les Bassans"
    address="67 chemin de la Messe, Perros-Guirec, 22700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33296232542"
    website="https://les-bassans.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the Côte de Granit Rose with the Sept-Îles archipelago on the horizon, this establishment blends modern-day Brittany with exceptional drop-dead views over the Channel from both the restaurant and bar. As for the food, while fish and shellfish take centre stage on the seafood-centric menu, the score also reveals a generous take on Brittany's homegrown ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20chemin%20de%20la%20Messe%2C%20Perros-Guirec%2C%2022700%2C%20France"
    pageTitle="Les Bassans"
  />
);

export default LesBassans;
