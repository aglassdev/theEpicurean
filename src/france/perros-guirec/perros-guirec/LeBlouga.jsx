...
const LeBlouga = () => (
  <RestaurantPage
    restaurantName="Le Bélouga"
    address="L'Agapa, 12 rue des Bons-Enfants, Perros-Guirec, 22700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33296490110"
    website="https://www.lagapa.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This granite, glass and steel structure commands a breath-taking panoramic view over the coast and the bay of the Sept-Îles archipelago from its chic black-and-white interior. The subtle, meticulous cuisine oscillates between classicism and creativity, with the occasional more exotic note, such as raviole of duck foie gras and tonka bean cream or Breton lobster rubbed in saté and served with a red lentil houmous. From Tuesday to Saturday, the evening menu errs towards ambitious, with a more bistronomic streak the rest of the time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L'Agapa%2C%2012%20rue%20des%20Bons-Enfants%2C%20Perros-Guirec%2C%2022700%2C%20France"
    pageTitle="Le Bélouga"
  />
);

export default LeBlouga;
