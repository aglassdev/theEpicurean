...
const LePuyTilleul = () => (
  <RestaurantPage
    restaurantName="Le Puy Tilleul"
    address="La Borie d'Hélipse, 5 chemin du Moulin, Tournemire, 15310, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33471474543"
    website="https://www.laboriedhelipse.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dominated by the feudal castle of Anjony (15C), the village of Tournemire has preserved its stone houses with stone slab roofs that are so typical of the Cantal region. This establishment, a splendid stone and corten steel complex, blends in perfectly. The contemporary dining space offers a breathtaking view of the sunset. The menu is an ode to marine ingredients. Sprinkled with seaweed and briny condiments, the menu is a meticulous showcase of fish and shellfish, and also takes in skilful surf-turf combinations. For all that, the Cantal terroir has not been overlooked: market gardeners, livestock farmers and local fish farmers are also well represented. An ambitious culinary affair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Borie%20d'H%C3%A9lipse%2C%205%20chemin%20du%20Moulin%2C%20Tournemire%2C%2015310%2C%20France"
    pageTitle="Le Puy Tilleul"
  />
);

export default LePuyTilleul;
