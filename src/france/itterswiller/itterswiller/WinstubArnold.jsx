...
const WinstubArnold = () => (
  <RestaurantPage
    restaurantName="Winstub Arnold"
    address="98 route des Vins, Itterswiller, 67140, France"
    cuisine="Alsatian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33388859930"
    website="https://www.hotel-arnold.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dive headlong into Alsace traditions at this winstub featuring numerous elsässische Spezialitäten, including kougelhopf, sauerkraut, black pudding, apple purée, baeckeoffe hotpot or specials such as Marie Leczinsca vol-au-vent… Choose a wine from the family estate to accompany your food, then sit back and enjoy in a setting that couldn't be more characteristic of the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=98%20route%20des%20Vins%2C%20Itterswiller%2C%2067140%2C%20France"
    pageTitle="Winstub Arnold"
  />
);

export default WinstubArnold;
