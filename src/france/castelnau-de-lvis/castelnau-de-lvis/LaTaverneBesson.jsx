...
const LaTaverneBesson = () => (
  <RestaurantPage
    restaurantName="La Taverne Besson"
    address="Rue Aubijoux, Castelnau-de-Lévis, 81150, France"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+33563609016"
    website="https://www.tavernebesson.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is an original Taverne with its contemporary, elegant, light - filled decor – and a terrace giving onto the countryside. Enjoy the enticing food, blending good local ingredients and original touches. You can also stay the night in one of the cleverly designed guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Aubijoux%2C%20Castelnau-de-L%C3%A9vis%2C%2081150%2C%20France"
    pageTitle="La Taverne Besson"
  />
);

export default LaTaverneBesson;
