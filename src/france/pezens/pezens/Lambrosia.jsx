...
const Lambrosia = () => (
  <RestaurantPage
    restaurantName="L'Ambrosia"
    address="Carrefour la Madeleine, sur D 6113, Pezens, 11170, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468249253"
    website="https://www.ambrosia-pezens.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the road to Toulouse, take a break in this modern house: the chef’s preparations are meticulous, coherent and crafted to suit modern tastes, all the more so as he uses premium ingredients: seabass, sweetbread, langoustine… Reasonably priced too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carrefour%20la%20Madeleine%2C%20sur%20D%206113%2C%20Pezens%2C%2011170%2C%20France"
    pageTitle="L'Ambrosia"
  />
);

export default Lambrosia;
