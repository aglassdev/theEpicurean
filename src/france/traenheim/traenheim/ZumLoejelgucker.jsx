...
const ZumLoejelgucker = () => (
  <RestaurantPage
    restaurantName="Zum Loejelgucker"
    address="17 rue Principale, Traenheim, 67310, France"
    cuisine="Traditional Cuisine, Alsatian"
    priceRange="€€"
    phoneNumber="+33388503819"
    website="https://aubergedetraenheim.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a wine-growing village at the foot of the Vosges, this 18C Alsace farmhouse has bags of charm: tasty regional dishes, plus some more modern options, dark wood panelling, frescoes and a flower-decked courtyard in summer. Warm, friendly service and a family vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20Principale%2C%20Traenheim%2C%2067310%2C%20France"
    pageTitle="Zum Loejelgucker"
  />
);

export default ZumLoejelgucker;
