...
const Lestran = () => (
  <RestaurantPage
    restaurantName="L'Estran"
    address="15 quai Vauban, Saint-Vaast-la-Hougue, 50550, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33233448609"
    website="https://www.estranrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this pretty little marina on the Cotentin Peninsula, a seasoned couple have turned a fish wholesale warehouse into a charming bistro, overflowing in maritime character. Shellfish and fish from a village fishmonger, veg from Val de Saire and lamb from Tatihou jostle for position on a “High Tide” menu that changes fortnightly. Each dish embodies the pleasure the chef takes in cooking and his partner's joy in providing attentive service. Knock-out lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20quai%20Vauban%2C%20Saint-Vaast-la-Hougue%2C%2050550%2C%20France"
    pageTitle="L'Estran"
  />
);

export default Lestran;
