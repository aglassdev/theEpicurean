...
const LeRelaisDesSalines = () => (
  <RestaurantPage
    restaurantName="Le Relais des Salines"
    address="Port des Salines, 34E rue des Anciennes-Salines, Le Grand-Village-Plage, 17370, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33546758242"
    website="https://le-relaisdessalines.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This waterside bistro showcases seafood flavours and super-fresh produce. The menu sails between timeless classics (oysters, confit of octopus, lentils, mustard-flavoured sabayon and the chef’s lemon pie) and more spur-of-the-moment recipes. Inside, this former oyster shed upholds its heritage, while the terrace overlooking the marshes is blissful...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Port%20des%20Salines%2C%2034E%20rue%20des%20Anciennes-Salines%2C%20Le%20Grand-Village-Plage%2C%2017370%2C%20France"
    pageTitle="Le Relais des Salines"
  />
);

export default LeRelaisDesSalines;
