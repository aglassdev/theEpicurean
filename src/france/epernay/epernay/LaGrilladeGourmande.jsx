...
const LaGrilladeGourmande = () => (
  <RestaurantPage
    restaurantName="La Grillade Gourmande"
    address="16 rue de Reims, Epernay, 51200, France"
    cuisine="Grills"
    priceRange="€€"
    phoneNumber="+33326554422"
    website="https://www.lagrilladegourmande.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant's signatures include top-drawer produce cooked over embers, such as boned squab with foie gras in puff pastry, venison in a pepper sauce or whole seabass grilled in fennel, all of which are the handiwork of a cheerful chef of Lyon origins. The interior is the epitome of friendly and buzzy and the garden is bliss, come summertime!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20de%20Reims%2C%20Epernay%2C%2051200%2C%20France"
    pageTitle="La Grillade Gourmande"
  />
);

export default LaGrilladeGourmande;
