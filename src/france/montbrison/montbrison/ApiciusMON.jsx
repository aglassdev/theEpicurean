...
const ApiciusMON = () => (
  <RestaurantPage
    ...
    address="29 rue Martin-Bernard, Montbrison, 42600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33982383465"
    website="https://apicius-restaurant-montbrison.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This dinky city-centre eatery is run by a young couple with an enviable track record. In a recently refurbished chic trendy interior, you will sample market-fresh cuisine at unbeatable prices at lunchtime and a more elaborate menu on Friday evenings. The chef makes the most of local ingredients as well as wildflowers and plants. The epitome of generous!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Martin-Bernard%2C%20Montbrison%2C%2042600%2C%20France"
    pageTitle="Apicius"
  />
);

export default ApiciusMON;
