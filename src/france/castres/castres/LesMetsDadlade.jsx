...
const LesMetsDadlade = () => (
  <RestaurantPage
    restaurantName="Les Mets d'Adélaïde"
    address="36 avenue Georges-Alquier-Les Salvages, Castres, 81100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33563357842"
    website="https://www.lesmetsdadelaide.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Adelaide and her cooking have taken up abode in the old village school, whose playground doubles as a summer patio. The chef enjoys adding spices and aromatic herbs from distant lands to her culinary repertory. Smiling welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20avenue%20Georges-Alquier-Les%20Salvages%2C%20Castres%2C%2081100%2C%20France"
    pageTitle="Les Mets d'Adélaïde"
  />
);

export default LesMetsDadlade;
