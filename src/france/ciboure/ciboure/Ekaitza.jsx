...
const Ekaitza = () => (
  <RestaurantPage
    restaurantName="Ekaitza"
    address="15 quai Maurice-Ravel, Ciboure, 64500, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33559512951"
    website="https://www.restaurant-ekaitza.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The location, on the docks of Ciboure overlooking the port, is eminently suited to a restaurant called storm (ekaitza in Basque). The eatery’s interior, meanwhile, is bright and lively, with pretty carpentry tables from which you can steal glances into the kitchen at the far end of the dining room. Guillaume Roget magnifies the best of the Basque region, in particular fish from Saint-Jean-de-Luz fish market opposite. Creativity matched with fine produce and delicate sweet, acidic or vegetable notes embodies the chef’s signature. His flair for deep, intense sauces will knock your socks off, illustrated by a stock of langoustine shells blended with foie gras, or fish stock perfumed with verbena and then reduced with sweet chestnut honey. A banquet of rich, gutsy flavours that nonetheless def..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20quai%20Maurice-Ravel%2C%20Ciboure%2C%2064500%2C%20France"
    pageTitle="Ekaitza"
  />
);

export default Ekaitza;
