...
const QuaiDesSaveurs = () => (
  <RestaurantPage
    restaurantName="Quai des Saveurs"
    address="69 rue de la Gare, Hagondange, 57300, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33387712498"
    website="https://www.quaidessaveurs.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Frédéric Sandrini has hung up his hat in this pink sandstone and white fronted edifice opposite Hagondange railway station, depicted by a pleasantly low-key, contemporary interior. Your tastebuds will be delighted by the modern, imaginative, ever-changing craftsmanship of this chef who works with painstakingly selected supplier-partners: abalone, hand-harvested by divers in the Bay of St Brieuc, fish from Saint-Quay-Portrieux or Boulogne-sur-Mer and a trolley that stars the work of master cheesemakers. Surprise menus and daily suggestions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=69%20rue%20de%20la%20Gare%2C%20Hagondange%2C%2057300%2C%20France"
    pageTitle="Quai des Saveurs"
  />
);

export default QuaiDesSaveurs;
