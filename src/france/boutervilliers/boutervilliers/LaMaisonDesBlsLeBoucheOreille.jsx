...
const LaMaisonDesBlsLeBoucheOreille = () => (
  <RestaurantPage
    restaurantName="La Maison des Blés - Le Bouche à Oreille"
    address="19 rue du Périgord, Boutervilliers, 91150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33164956950"
    website="https://lamaisondesbles.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A contemporary setting, a modern interior and a choice of two venues to treat yourself to a slap-up meal: Brasserie Louis and its traditional lineup or its gourmet sibling, Le Bouche à Oreille. Slick, professional service and food that showcases top-notch ingredients (including lobster, scallops and foie gras) with a creative twist. Modern, comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20du%20P%C3%A9rigord%2C%20Boutervilliers%2C%2091150%2C%20France"
    pageTitle="La Maison des Blés - Le Bouche à Oreille"
  />
);

export default LaMaisonDesBlsLeBoucheOreille;
