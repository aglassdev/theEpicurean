...
const LatelierDuNord = () => (
  <RestaurantPage
    restaurantName="L'Atelier du Nord"
    address="Dock 2, Quai Carnot Bâtiment Ouest Criée, Concarneau, 29900, France"
    cuisine="Fusion, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33954383175"
    website="https://atelierdunord.cc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Res nostra mare (or the sea is our law) is the motto featured on chef Romain Paillet's website and, indeed, his modern, Japanese-inspired cuisine relies solely on what the sea has to offer. The ingredients, such as tuna belly, are impeccably fresh. Thanks to well-balanced condiments and preparations, each plate has plenty of pep… as does the chef, who, passionate about what he does, spends a lot of time in the dining area mingling with his customers. In line with the chef's cooking, the decor has blue walls and more than the odd nod to Japan. The kitchen, literally in the centre of the space, is the beating heart of the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dock%202%2C%20Quai%20Carnot%20B%C3%A2timent%20Ouest%20Cri%C3%A9e%2C%20Concarneau%2C%2029900%2C%20France"
    pageTitle="L'Atelier du Nord"
  />
);

export default LatelierDuNord;
