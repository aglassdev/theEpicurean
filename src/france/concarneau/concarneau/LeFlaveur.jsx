...
const LeFlaveur = () => (
  <RestaurantPage
    restaurantName="Le Flaveur"
    address="4 rue Duquesne, Concarneau, 29900, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33298604347"
    website="https://guide.michelin.com/en/bretagne/concarneau/restaurant/le-flaveur"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Duquesne%2C%20Concarneau%2C%2029900%2C%20France"
    pageTitle="Le Flaveur"
  />
);

export default LeFlaveur;
