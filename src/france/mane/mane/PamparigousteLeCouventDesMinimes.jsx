...
const PamparigousteLeCouventDesMinimes = () => (
  <RestaurantPage
    restaurantName="Pamparigouste - Le Couvent des Minimes"
    ...
    pageTitle="Pamparigouste - Le Couvent des Minimes"
  />
);

export default PamparigousteLeCouventDesMinimes;
