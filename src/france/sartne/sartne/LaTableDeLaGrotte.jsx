...
const LaTableDeLaGrotte = () => (
  <RestaurantPage
    restaurantName="La Table de la Grotte"
    ...
    pageTitle="La Table de la Grotte"
  />
);

export default LaTableDeLaGrotte;
