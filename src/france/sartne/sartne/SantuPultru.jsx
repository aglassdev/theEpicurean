...
const SantuPultru = () => (
  <RestaurantPage
    restaurantName="Santu Pultru"
    address="D48, Sartène, 20100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33682336128"
    website="https://www.randochevalcorse.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a few kilometres from Sartène, this equestrian centre and restaurant set in the middle of the maquis promises an authentic foray into the mountainous side of Corsica. In a rustic-style interior blending wood and stone, the establishment has plenty of charm, with its country garden and white wrought-iron and wooden tables. The cuisine is hearty and delicious, with a focus on local ingredients. The organic veal and beef are reared on site; the fruit and vegetables are sourced from the kitchen garden or local producers. The meal includes a traditional soup, generous cannelloni with Brousse cheese and a delicious strawberry salad with herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D48%2C%20Sart%C3%A8ne%2C%2020100%2C%20France"
    pageTitle="Santu Pultru"
  />
);

export default SantuPultru;
