...
const LaTableDeLaPlage = () => (
  <RestaurantPage
    restaurantName="La Table de la Plage"
    ...
    bio="By the prettiest beach in the Domaine de Murtoli, this restaurant with an exceptional decor inspired by fishermen's wooden huts is well worth a visit. Locally caught fish, grilled crayfish, veal, beef or lamb reared on the estate: diners can tuck into dishes such as John Dory à la meunière, courgettes stuffed with caponata and a rock fish jus. The pasta dishes make for a deliciously indulgent option. To access this highly exclusive property, it is necessary to book – you will then also be able to head for the beach with a deckchair and towel after your meal...."
    ...
    pageTitle="La Table de la Plage"
  />
);

export default LaTableDeLaPlage;
