...
const LaTableDeLaFerme = () => (
  <RestaurantPage
    restaurantName="La Table de la Ferme"
    address="Domaine de Murtoli, Vallée de l'Ortolo, Sartène, 20100, France"
    cuisine="Modern Cuisine, Corsican"
    priceRange="€€€€"
    phoneNumber="+33495716924"
    website="https://www.murtoli.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Murtoli defies classification in classical tourist terms. Poised between the sea and the hills, this huge property dotted with stone houses boasting private pools is the height of rural luxury and combines modernity with the charm of traditional Corsican architecture. Whether you choose the concise or the tasting menu, you will sample a splendid tribute to fine Corsican produce, most of which is from the estate: vegetables, cheese, honey, veal, lamb and olive oil. Traditional country fare with a delicate modern spin and exquisite plating: Bonifaccio-style aubergines, Sartène-style courgettes, colourful, enticing aziminu (Corsican soup), Bonifaccio-style capon… Personal cuisine that celebrates fruit (strawberries paired with red mullet; tangy apricots with langoustine) and delivers crisp fr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20de%20Murtoli%2C%20Vall%C3%A9e%20de%20l'Ortolo%2C%20Sart%C3%A8ne%2C%2020100%2C%20France"
    pageTitle="La Table de la Ferme"
  />
);

export default LaTableDeLaFerme;
