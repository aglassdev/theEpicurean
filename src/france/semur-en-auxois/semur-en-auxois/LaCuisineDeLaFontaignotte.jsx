...
const LaCuisineDeLaFontaignotte = () => (
  <RestaurantPage
    restaurantName="La Cuisine de la Fontaignotte"
    address="4 rue de la Fontaignotte, Semur-en-Auxois, 21140, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33380969169"
    website="https://www.lacuisinedelafontaignotte.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This exquisite 17C mansion, whose conservatory and large terrace command a matchless view over the town’s ramparts and the River Armançon, enjoys a premium location in this picture postcard medieval town. The town and its walls may be rich in heritage, but the incisive, fresh cuisine of chef Martin is light years from old school, as the brook trout smoked over vine shoots and beetroot in a salt crust demonstrates. The chef faithfully keeps pace with the seasons, working with farmers from Auxois and Burgundy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20de%20la%20Fontaignotte%2C%20Semur-en-Auxois%2C%2021140%2C%20France"
    pageTitle="La Cuisine de la Fontaignotte"
  />
);

export default LaCuisineDeLaFontaignotte;
