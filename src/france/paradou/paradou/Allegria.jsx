...
const Allegria = () => (
  <RestaurantPage
    restaurantName="Allegria !"
    address="Les Petites Maisons - Hameau des Baux, 285 chemin de Bourgeac, Paradou, 13520, France"
    cuisine="Provençal"
    priceRange="€€€"
    phoneNumber="+33448700023"
    website="https://www.les-petites-maisons.com/restauration"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this luxury hamlet of maisonettes with guestrooms surrounded by olive and almond trees, tables are set out on the terrace in the shade of the plane trees, with the song of the cicadas in the background, and in the inviting dining room where it is nice and cool. Chef Julie Chaix, who has worked at Pic and Ducasse restaurants, prepares a lovely market-fresh menu inspired by the ingredients and traditions of Provence. Diners can indulge themselves with dishes such as pork terrine with bread toasted in meat juices and olive oil from Baux-de-Provence, pan-fried tuna with aubergine and a tomato reduction, and red berry panna cotta. The lunch menu is good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Les%20Petites%20Maisons%20-%20Hameau%20des%20Baux%2C%20285%20chemin%20de%20Bourgeac%2C%20Paradou%2C%2013520%2C%20France"
    pageTitle="Allegria !"
  />
);
