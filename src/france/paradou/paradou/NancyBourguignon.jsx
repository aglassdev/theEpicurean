...
const NancyBourguignon = () => (
  <RestaurantPage
    restaurantName="Nancy Bourguignon"
    address="Lieu-dit de Bourgeac, 1 chemin de l'Ancienne-Voie-Ferrée, Paradou, 13520, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33490545678"
    website="https://www.ducotedesolivades.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lieu-dit%20de%20Bourgeac%2C%201%20chemin%20de%20l'Ancienne-Voie-Ferr%C3%A9e%2C%20Paradou%2C%2013520%2C%20France"
    pageTitle="Nancy Bourguignon"
  />
);

export default NancyBourguignon;
