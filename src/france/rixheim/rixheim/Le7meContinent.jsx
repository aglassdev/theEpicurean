...
const Le7meContinent = () => (
  <RestaurantPage
    restaurantName="Le 7ème Continent"
    address="35 avenue du Général-de-Gaulle, Rixheim, 68170, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33389642485"
    website="https://www.le7emecontinent.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant's incredible decoration (inside and out) was created by painter and decorative artist François Zenner, an amateur naturalist with a passion for plants. Also passionate about his work, and very much influenced by his years with Bernard Loiseau, chef Laurent Haller is never at a loss for ideas when it comes to sharing his love of good food. He likes to revisit the great classics of French cuisine and creates surf and turf combinations. His menu, a veritable ode to the market and its often local produce (veal from Rixheim, split peas from Petit-landau…), changes every month...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Rixheim%2C%2068170%2C%20France"
    pageTitle="Le 7ème Continent"
  />
);

export default Le7meContinent;
