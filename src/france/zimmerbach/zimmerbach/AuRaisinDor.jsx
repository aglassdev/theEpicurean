...
const AuRaisinDor = () => (
  <RestaurantPage
    restaurantName="Au Raisin d'Or"
    address="1 rue de l'Église, Zimmerbach, 68230, France"
    cuisine="Alsatian"
    priceRange="€€"
    phoneNumber="+33389710569"
    website="https://www.raisindor.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a picture postcard wine-growing village, this inn, helmed by a young couple, strives to uphold Alsace traditions by way of no-nonsense, gutsy, wholehearted fare and premium local produce: presskopf, snails in garlic and parsley butter, Heimbach arctic char, beef in coarse salt, braised ham hock and choucroute... The ice cream is house made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20l'%C3%89glise%2C%20Zimmerbach%2C%2068230%2C%20France"
    pageTitle="Au Raisin d'Or"
  />
);

export default AuRaisinDor;
