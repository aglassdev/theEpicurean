...
const LaBourdasso = () => (
  <RestaurantPage
    restaurantName="La Bourdasso"
    address="La Bourdasse, Pradelles-en-Val, 11220, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33468780831"
    website="https://www.bourdasso.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely traditional building tucked away in Les Corbières has been infused with the energy of an Italian family who fell in love with the region. Authentic Italian cuisine: divine homemade mozzarella (with milk from their own buffaloes, brought over from Italy!), pasta and bread made with ancient wheat, also home grown. The spacious terrace is ideal to appreciate the lovely countryside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Bourdasse%2C%20Pradelles-en-Val%2C%2011220%2C%20France"
    pageTitle="La Bourdasso"
  />
);

export default LaBourdasso;
