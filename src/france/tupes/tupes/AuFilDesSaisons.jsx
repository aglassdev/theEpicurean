...
const AuFilDesSaisons = () => (
  <RestaurantPage
    restaurantName="Au Fil des Saisons"
    address="3 rue de la Libération, Étupes, 25460, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33381941712"
    website="https://aufildessaisons.eu/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stéphane and Fabienne Robinne’s establishment is home to a cleverly refurbished interior, depicted by untreated wooden tables and velvet upholstered chairs… A refreshing modern vibe that provides the backdrop to the chef’s signature recipes oozing in traditional accents...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20de%20la%20Lib%C3%A9ration%2C%20%C3%89tupes%2C%2025460%2C%20France"
    pageTitle="Au Fil des Saisons"
  />
);

export default AuFilDesSaisons;
