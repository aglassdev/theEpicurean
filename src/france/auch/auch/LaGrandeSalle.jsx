...
const LaGrandeSalle = () => (
  <RestaurantPage
    restaurantName="La Grande Salle"
    address="Hôtel de France, place de la Libération, Auch, 32000, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33562617171"
    website="https://www.hoteldefrance-auch.com/restaurant/restaurant-gastronomique-gers-auch.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Revamped from top to toe, this city-centre institution is still going strong under the aegis of a family team, namely three brothers – one in the dining room (an MOF), one in the kitchen and one is a pastry chef! The culinary lineup aims to highlight the gastronomic heritage of the Gers region: raw and cooked scallops; Bigorre black pork and leeks; duck and foie gras pie, sliced at the table; baked Alaska, flambéed in front of you! Foodies with an appetite will be delighted to learn that the sauce boats are left on the table – irresistible with the house made bread! Simpler fare at Le 9ème brasserie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20de%20France%2C%20place%20de%20la%20Lib%C3%A9ration%2C%20Auch%2C%2032000%2C%20France"
    pageTitle="La Grande Salle"
  />
);

export default LaGrandeSalle;
