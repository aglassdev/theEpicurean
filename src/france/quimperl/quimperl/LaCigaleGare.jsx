...
const LaCigaleGare = () => (
  <RestaurantPage
    restaurantName="La Cigale Égarée"
    address="8 rue d'Athenry - ZA Villeneuve-Braouic, Quimperlé, 29300, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33298391553"
    website="https://www.cigaleegaree.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cricket has taken up abode in Brittany, in a quirky antique shop-style décor, flanked by a lush green patio. The menu is depicted by seasonal market produce, fish of the day and garden veggies. Flavoursome, no-frills recipes (roast hake, spring vegetables and gravy)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20d'Athenry%20-%20ZA%20Villeneuve-Braouic%2C%20Quimperl%C3%A9%2C%2029300%2C%20France"
    pageTitle="La Cigale Égarée"
  />
);

export default LaCigaleGare;
