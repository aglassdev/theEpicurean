...
const LaubergeDesGlazicks = () => (
  <RestaurantPage
    restaurantName="L'Auberge des Glazicks"
    address="7 rue de la Plage, Plomodiern, 29550, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33298815232"
    website="https://www.aubergedesglazick.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This former blacksmith's workshop was transformed into a farmhouse inn by the chef's grandmother. Back then, it catered to workers and locals who came for simple, filling victuals: soup, vol-au-vent, leg of lamb. Under the impetus of Olivier Bellin, who returned to his roots in 1998, the family inn has morphed into a sleek, stylish venue as its inventive, versatile chef has come into his own, brandishing an increasingly strong culinary personality. He works with an extraordinary network of cherry-picked, small-scale producers from Finistère whose work and produce are individually highlighted on the menu. His dishes marry surf and turf ingredients with disconcerting poise: blue lobster, pig’s head terrine and farmhouse black pudding; scallops à la bretonne, bard and lardo di Colonnata…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20de%20la%20Plage%2C%20Plomodiern%2C%2029550%2C%20France"
    pageTitle="L'Auberge des Glazicks"
  />
);

export default LaubergeDesGlazicks;
