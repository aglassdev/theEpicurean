...
const LaLozerette = () => (
  <RestaurantPage
    restaurantName="La Lozerette"
    address="Route du Pont-de-Montvert, Cocurès, 48400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33466450604"
    website="https://www.lalozerette.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Cévennes, this charming inn is the domain of a chef who specialises in cleverly crafted dishes using regionally sourced produce. On the wine side, Pierrette, a talented sommelier, will help you choose from the 300 references available… Let’s not forget the splendid cheeseboard!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20du%20Pont-de-Montvert%2C%20Cocur%C3%A8s%2C%2048400%2C%20France"
    pageTitle="La Lozerette"
  />
);

export default LaLozerette;
