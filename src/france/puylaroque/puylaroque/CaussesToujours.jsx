...
const CaussesToujours = () => (
  <RestaurantPage
    restaurantName="Causses Toujours"
    address="2 place de la Libération, Puylaroque, 82240, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33563028225"
    website="https://caussestoujours.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the entrance to this bastide town perched on the heights of the Quercy Caussadais, this small restaurant is run by a versatile duo who are no strangers to the business. Fresh from Alsace, they have swapped the vineyards of eastern France for the hills of the South-West. There are no culinary gimmicks here: it's all about honest, serious cuisine, allying tradition and fresh ingredients, eg seasonal mushroom vol-au-vent and poulette sauce with vin jaune. Friendly atmosphere guaranteed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20de%20la%20Lib%C3%A9ration%2C%20Puylaroque%2C%2082240%2C%20France"
    pageTitle="Causses Toujours"
  />
);

export default CaussesToujours;
