...
const AuChevalBlancNIE = () => (
  <RestaurantPage
    restaurantName="Au Cheval Blanc"
    address="11 rue Principale, Niedersteinbach, 67510, France"
    cuisine="Traditional Cuisine, Alsatian"
    priceRange="€€"
    phoneNumber="+33388095531"
    website="https://www.hotel-cheval-blanc.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The soul of a winstub... and all the flavours of the region lovingly presented: blue trout, venison steak with sauce grand veneur, kirsch mousse etc. The same spirit is mirrored in the decor: lots of wood panelling and two stuben: rustic rooms that are typical of the region. Finally, a special mention for the absolutely exemplary service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Principale%2C%20Niedersteinbach%2C%2067510%2C%20France"
    pageTitle="Au Cheval Blanc"
  />
);

export default AuChevalBlancNIE;
