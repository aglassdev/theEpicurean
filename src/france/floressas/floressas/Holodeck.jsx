...
const Holodeck = () => (
  <RestaurantPage
    restaurantName="Holodeck"
    address="Château de Chambert, lieu-dit Chambert, Floressas, 46700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33565238908"
    website="http://chambert.com/holodeck.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set within a vast wine estate founded in 1690, this restaurant is ensconced in a meticulously restored old barn. Behind the stone façade, the warmth of old materials and high wooden beams meets with more contemporary touches: a black wall, an open kitchen with state-of-the-art equipment, comfortable furniture, and large windows overlooking the vineyards and surrounding countryside. In the kitchen, the chef cooks up exquisite dishes based on impeccable-quality premium ingredients. Breton langoustine is served alongside pearly-fleshed ikejime John Dory, accompanied by sorrel and a carrot jus infused with Quercy saffron; Occitan veal is served with a pissaladière condiment and deliciously crafted artichokes. The marriages of flavours are perfectly balanced, the jus are intense and, in each di..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ch%C3%A2teau%20de%20Chambert%2C%20lieu-dit%20Chambert%2C%20Floressas%2C%2046700%2C%20France"
    pageTitle="Holodeck"
  />
);
