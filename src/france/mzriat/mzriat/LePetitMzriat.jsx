...
const LePetitMzriat = () => (
  <RestaurantPage
    restaurantName="Le Petit Mézériat"
    address="250 Grande-Rue, Mézériat, 01660, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33474252608"
    website="https://le-petit-mezeriat-restaurant.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a small village near Vonnas, the owner chef serves a bargain priced lunchtime menu and a surprise menu (in several stages) which varies according to the season and market availability, with a distinct fondness for locally sourced ingredients. All of which is served by cheerful Amandine, the chef’s spouse, in their spruce, tastefully appointed venue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=250%20Grande-Rue%2C%20M%C3%A9z%C3%A9riat%2C%2001660%2C%20France"
    pageTitle="Le Petit Mézériat"
  />
);

export default LePetitMzriat;
