...
const Lacertus = () => (
  <RestaurantPage
    restaurantName="Lacertus"
    address="4 boulevard Franklin-Roosevelt, Les Sables-d'Olonne, 85100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33986490042"
    website="https://lacertus-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Good-humoured staff, friendly service, a convivial atmosphere, modern cuisine with a touch of inventiveness (eg fish sausage or a seaweed/mustard sorbet as part of the mackerel starter; a lime/pea sorbet alongside a chocolate dessert), quality local produce and a few ingredients gathered wild (mustard seeds): this is the winning formula behind this small restaurant a stone's throw from Le Remblai promenade. In case you were wondering, the name Lacertus means mackerel in Latin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20boulevard%20Franklin-Roosevelt%2C%20Les%20Sables-d'Olonne%2C%2085100%2C%20France"
    pageTitle="Lacertus"
  />
);

export default Lacertus;
