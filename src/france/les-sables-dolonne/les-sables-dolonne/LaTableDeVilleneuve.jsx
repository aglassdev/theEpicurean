...
const LaTableDeVilleneuve = () => (
  <RestaurantPage
    restaurantName="La Table de Villeneuve"
    address="28 rue du Pré-Étienne, Les Sables-d'Olonne, 85180, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33642144732"
    website="https://latabledevilleneuve.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a residential area blissfully free of the seaside town’s throngs of tourists, this enjoyable eatery has a well-designed menu whose dishes star carefully selected ingredients: haddock and beetroot carpaccio; black pudding and Savora-flavoured hollandaise sauce; ballotine of free-range poultry, fried polenta and tomato caviar…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20du%20Pr%C3%A9-%C3%89tienne%2C%20Les%20Sables-d'Olonne%2C%2085180%2C%20France"
    pageTitle="La Table de Villeneuve"
  />
);

export default LaTableDeVilleneuve;
