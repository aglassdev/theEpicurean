...
const AliceLeBistrotManoirDeLaMortire = () => (
  <RestaurantPage
    ...
    pageTitle="Alice, le bistrot - Manoir de la Mortière"
  />
);

export default AliceLeBistrotManoirDeLaMortire;
