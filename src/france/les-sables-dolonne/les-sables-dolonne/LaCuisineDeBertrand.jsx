...
const LaCuisineDeBertrand = () => (
  <RestaurantPage
    restaurantName="La Cuisine de Bertrand"
    address="22 quai de Franqueville, Les Sables-d'Olonne, 85100, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33251953707"
    website="https://guide.michelin.com/en/pays-de-la-loire/les-sables-d-olonne/restaurant/la-cuisine-de-bertrand"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite the fishing harbour, it is well worth keeping an eye open for this low-profile restaurant. The chef unashamedly crafts textbook French recipes with the objective of showcasing first-rate ingredients in dishes that hit the spot every time. Diligent service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20quai%20de%20Franqueville%2C%20Les%20Sables-d'Olonne%2C%2085100%2C%20France"
    pageTitle="La Cuisine de Bertrand"
  />
);

export default LaCuisineDeBertrand;
