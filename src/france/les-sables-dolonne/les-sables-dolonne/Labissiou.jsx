...
const Labissiou = () => (
  <RestaurantPage
    restaurantName="L'Abissiou"
    address="81 rue des Halles, Les Sables-d'Olonne, 85100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33986364229"
    website="https://www.labissiou.fr"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20rue%20des%20Halles%2C%20Les%20Sables-d'Olonne%2C%2085100%2C%20France"
    pageTitle="L'Abissiou"
  />
);

export default Labissiou;
