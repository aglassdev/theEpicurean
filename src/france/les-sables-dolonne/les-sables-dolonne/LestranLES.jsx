...
const LestranLES = () => (
  <RestaurantPage
    ...
    address="8 quai Emmanuel-Garnier, Les Sables-d'Olonne, 85100, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33251954467"
    website="https://lestran-restaurant-les-sables-dolonne.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ceviche of seabass, coconut milk, ginger and sweet potato guacamole; lightly seared wild prawns in Espelette pepper, artichokes glazed in tarragon with a langoustine emulsion… In this dinky quayside restaurant, whose terrace overlooks the port, chef Xavier Audren pursues a bistronomic quest that takes its cue from the seasons and the fish market just down the street. A concise menu, flawless craftsmanship together with lashings of flavour and colour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20quai%20Emmanuel-Garnier%2C%20Les%20Sables-d'Olonne%2C%2085100%2C%20France"
    pageTitle="L'Estran"
  />
);

export default LestranLES;
