...
const CafCsar = () => (
  <RestaurantPage
    restaurantName="Café César"
    address="30 rue Chance-Milly, Clichy, 92110, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33147949686"
    website="https://www.cafecesar.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet little street, opposite a park, Café César is a modern bistro with a colourful, light-filled interior (red bricks, some painted white, blue zellige tiled counter, polished concrete flooring). From morning to night, people come and go, for coffee, lunch or dinner, the common thread being the precise and carefully prepared cuisine. The sauces and gravies, prepared to exacting standards, give layers of flavour to the dishes – crabmeat enhanced with curry, scallops served with a creamy fish roe sauce, or hot chocolate tartlet. Everything served here is house-made, the service is relaxed and, at lunchtime, the bill is more than reasonable. As Henry Miller would say, Quiet Days in Clichy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20rue%20Chance-Milly%2C%20Clichy%2C%2092110%2C%20France"
    pageTitle="Café César"
  />
);

export default CafCsar;
