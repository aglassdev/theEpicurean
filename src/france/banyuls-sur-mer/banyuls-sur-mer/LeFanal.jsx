...
const LeFanal = () => (
  <RestaurantPage
    restaurantName="Le Fanal"
    address="18 avenue Pierre-Fabre, Banyuls-sur-Mer, 66650, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33468986588"
    website="https://www.pascal-borrell.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The lights of Le Fanal (“The Lantern”) will guide you to this idyllic spot overlooking Banyuls marina. Catalan-born Pascal Borrell has decided to drop anchor here after stints in several top Paris restaurants and running the Chapon Fin at Perpignan. The main attraction here is fish: hake, monkfish, sole, turbot, cod and anchovy pickles delicately marinated in Banyuls vinegar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20avenue%20Pierre-Fabre%2C%20Banyuls-sur-Mer%2C%2066650%2C%20France"
    pageTitle="Le Fanal"
  />
);

export default LeFanal;
