...
const LePavillonBleu = () => (
  <RestaurantPage
    restaurantName="Le Pavillon Bleu"
    address="315 rue de la Reine-Blanche, Olivet, 45160, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33238661430"
    website="https://pavillonbleu-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A guinguette atmosphere pervades this 1903 building on the bank of the Loiret, where you can sit on the terrace in the shade of old plane trees, right by the water's edge. Fun fact: the dining area is actually an old boathouse. A few comfortable guestrooms available for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=315%20rue%20de%20la%20Reine-Blanche%2C%20Olivet%2C%2045160%2C%20France"
    pageTitle="Le Pavillon Bleu"
  />
);

export default LePavillonBleu;
