...
const RestaurantCtMarais = () => (
  <RestaurantPage
    restaurantName="Restaurant Côté Marais"
    address="Le Grand Pont, Beauvoir-sur-Mer, 85230, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33253659593"
    website="https://www.restaurant-cotemarais.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A starter of ceviche of white mullet (a fish rarely found on restaurant menus) with rhubarb for a hint of tartness, followed by a savoury/sweet main course of pollack fished by small boats, French peas al dente and a smattering of sweet cherry condiment. The young chef applies his own personal culinary style to local ingredients, while his partner works the restaurant floor in this outlying establishment surrounded by marshland (and with a lovely terrace)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Grand%20Pont%2C%20Beauvoir-sur-Mer%2C%2085230%2C%20France"
    pageTitle="Restaurant Côté Marais"
  />
);

export default RestaurantCtMarais;
