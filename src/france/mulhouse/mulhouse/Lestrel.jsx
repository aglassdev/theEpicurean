...
const Lestrel = () => (
  <RestaurantPage
    restaurantName="L'Estérel"
    address="83 avenue de la 1ère-Division-Blindée, Mulhouse, 68100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33389442324"
    website="https://www.esterel-weber.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mulhouse's Estérel serves 100% homemade dishes made with market - fresh ingredients that are tasty and very contemporary. The shady terrace is taken by storm in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%20avenue%20de%20la%201%C3%A8re-Division-Blind%C3%A9e%2C%20Mulhouse%2C%2068100%2C%20France"
    pageTitle="L'Estérel"
  />
);

export default Lestrel;
