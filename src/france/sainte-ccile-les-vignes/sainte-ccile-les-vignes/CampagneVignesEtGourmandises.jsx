...
const CampagneVignesEtGourmandises = () => (
  <RestaurantPage
    restaurantName="Campagne, Vignes et Gourmandises"
    address="629 chemin des Terres, Sainte-Cécile-les-Vignes, 84290, France"
    cuisine="Provençal"
    priceRange="€€"
    phoneNumber="+33490634011"
    website="https://www.restaurant-cvg.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its atmosphere blending rustic charm (exposed stones, painted wooden furniture) and modern touches (contemporary paintings), this restaurant has bags of character. In the kitchen, chef Sylvain Fernandes prepares fresh ingredients in a subtle celebration of the flavours of the South of France. Extremely courteous service provided by Sylvia, the chef's wife!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=629%20chemin%20des%20Terres%2C%20Sainte-C%C3%A9cile-les-Vignes%2C%2084290%2C%20France"
    pageTitle="Campagne, Vignes et Gourmandises"
  />
);

export default CampagneVignesEtGourmandises;
