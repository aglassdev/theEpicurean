...
const LePrGourmand = () => (
  <RestaurantPage
    restaurantName="Le Pré Gourmand"
    address="175 avenue Max-Dormoy, Eyragues, 13630, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33490945263"
    website="https://www.lepre-gourmand.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This inviting establishment on the way out of the village specialises in seasonal Mediterranean cuisine: courgettes, aubergines, olive oil and lemon accompany local fish and lamb from La Crau. The sublime south-facing terrace overlooks the leafy, well-tended garden. At the end of a flower-decked meadow, a handful of authentic guestrooms done up in Mediterranean colours await you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=175%20avenue%20Max-Dormoy%2C%20Eyragues%2C%2013630%2C%20France"
    pageTitle="Le Pré Gourmand"
  />
);

export default LePrGourmand;
