...
const SimoneLeResto = () => (
  <RestaurantPage
    restaurantName="Simone, Le Resto..."
    address="33 boulevard Arago, Paris, 75013, France"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+33143378270"
    website="https://www.simonelerestolacave.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A two-in-one establishment for twice the culinary pleasure: the wine cellar with a focus on biodynamic wines (a hundred or so metres away) and this lovely, little restaurant-cum-neighbourhood hangout, in which friends dine cheek by jowl in a bistro-style interior. The menu focuses on contemporary, locally sourced cuisine that's both healthy and flavoursome (enticing seasonal menu and an excellent value-for-money lunch set menu), eg white asparagus with mousseline sauce and onion pickles, or boudin basque with piment d'Espelette, beetroot and a red wine and beetroot sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20boulevard%20Arago%2C%20Paris%2C%2075013%2C%20France"
    pageTitle="Simone, Le Resto..."
  />
);

export default SimoneLeResto;
