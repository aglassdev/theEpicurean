...
const BistrotMarloe = () => (
  <RestaurantPage
    restaurantName="Bistrot Marloe"
    address="12 rue du Commandant-Rivière, Paris, 75008, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33153764444"
    website="https://www.marloe.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this upscale neighbourhood on a street corner, Marloe sports a stylish, buzzy bistro vibe: parquet floors, wainscoting, mirrors, green bench seating and a red Berkel meat slicer in the centre, ready to prepare aperitif boards. Deft and fresh depicts the menu: carpaccio of seabream with summer fruits or cod with Mediterranean accents. The black truffle menu (in season) is a must. On-the-ball, cheerful service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20du%20Commandant-Rivi%C3%A8re%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Bistrot Marloe"
  />
);

export default BistrotMarloe;
