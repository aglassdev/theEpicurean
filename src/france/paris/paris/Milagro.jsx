...
const Milagro = () => (
  <RestaurantPage
    restaurantName="Milagro"
    address="85 avenue Bosquet, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33954508331"
    website="https://www.milagroparis.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An American chef who was born in New Mexico, Justin Kent honed his skills with the likes of Alain Passard and David Toutain. His dinky neo-vintage bistro couldn’t be more bang on: white marble and oak counter, parquet floor, light wooden tables, vintage green velvet wooden armchairs. International and Parisian bistronomic influences happily rub shoulders in the kitchen: fritters of chorizo and sweet potatoes, Greek yoghurt; lamb chops, emulsion of sweetcorn, risotto of spelt; creamy delight of celeriac with white chocolate, ice cream and meringues...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20avenue%20Bosquet%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Milagro"
  />
);

export default Milagro;
