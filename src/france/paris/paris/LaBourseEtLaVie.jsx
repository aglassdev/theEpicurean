...
const LaBourseEtLaVie = () => (
  <RestaurantPage
    restaurantName="La Bourse et la Vie"
    address="12 rue Vivienne, Paris, 75002, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33142600883"
    website="https://www.labourselavie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro owned by an American chef is a big hit. So what is the secret of his success? Distinctly French dishes, slightly tweaked, quality ingredients and flavours that are on point. Leeks with vinaigrette; onglet de bœuf (a skirt steak) with peppercorn sauce; chocolate mousse: all manner of bistro classics that you'll be delighted to come across (again)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Vivienne%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="La Bourse et la Vie"
  />
);

export default LaBourseEtLaVie;
