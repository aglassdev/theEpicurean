...
const Gosmine = () => (
  <RestaurantPage
    restaurantName="Géosmine"
    address="71 rue de la Folie-Méricourt, Paris, 75011, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33978804859"
    website="https://www.geosmine.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Geosmin is the wonderful aroma that rises from freshly ploughed or wet soil. Maxime Bouttier's restaurant, in the Oberkampf area of Paris, is located in a two-storey townhouse that has the distinctive feel and decor of the eastern districts of Paris. Hailing from France's Sarthe département, this young chef organises his distinctive, pared-back dishes into a tasting menu that follows the seasons and steers clear of the trap of over-complexity. The wine list will certainly pique your interest with its natural and biodynamic wines, as well as fine Italian, Spanish and Austrian labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71%20rue%20de%20la%20Folie-M%C3%A9ricourt%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Géosmine"
  />
);

export default Gosmine;
