...
const DameAugustine = () => (
  <RestaurantPage
    restaurantName="Dame Augustine"
    address="32 avenue des Gobelins, Paris, 75013, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33183928598"
    website="https://www.dameaugustine.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the other restaurant of chef Lilian Douchet: you can expect a laid-back atmosphere and a veranda-style space with the feel of a small brasserie. He serves several set menus, including a good-value lunch deal. Diners savour dishes such as a selection of heirloom tomatoes, fresh herb pesto, parmesan buttercrumb biscuits and mizuna sorbet, or a fillet of whiting simmered with coco de Paimpol beans and a lemon thyme emulsion. A welcome address in this residential area...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20avenue%20des%20Gobelins%2C%20Paris%2C%2075013%2C%20France"
    pageTitle="Dame Augustine"
  />
);

export default DameAugustine;
