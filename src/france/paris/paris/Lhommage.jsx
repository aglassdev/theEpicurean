...
const Lhommage = () => (
  <RestaurantPage
    restaurantName="L'Hommage"
    address="36 avenue de Choisy, Paris, 75013, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33144243870"
    website="https://www.lhommageparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a neighbourhood swarming with Chinese eateries, this establishment stands out from the crowd by courtesy of a bistronomic purebred Gallic lineup and minimalist Scandinavian-style loft interior. The high-flying culinary score boasts quality ingredients and bang-on cooking and seasoning: ravioles of Ossau-Iraty cheese, smoked pimiento sauce, dusting of chorizo, poached rhubarb and roquette oil, or loin of croaker with asparagus, miso and capers in a gutsy red wine sauce…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20avenue%20de%20Choisy%2C%20Paris%2C%2075013%2C%20France"
    pageTitle="L'Hommage"
  />
);

export default Lhommage;
