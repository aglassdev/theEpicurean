...
const Frenchie = () => (
  <RestaurantPage
    restaurantName="Frenchie"
    address="5 rue du Nil, Paris, 75002, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33140399619"
    website="https://www.frenchie-restaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Grégory Marchand learned the trade in some of the English-speaking world's top restaurants (Gramercy Tavern in New York, Jamie Oliver's Fifteen in London, Mandarin Oriental in Hong Kong). In his compact restaurant in the heart of the Sentier area, the space (with exposed brick, beams and stonework) quickly fills to capacity, thanks to cuisine that is perfectly in tune with today's international inclinations, rooted in meticulous sourcing (from the ceramic plates to the fruit and vegetables from Terroirs d'Avenir opposite). The marriages of flavours are original and ingredient led, and the Anglo-American twist is particularly noticeable when it comes to the desserts. Two services (6.30pm/7pm and 9.30pm)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20du%20Nil%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Frenchie"
  />
);
