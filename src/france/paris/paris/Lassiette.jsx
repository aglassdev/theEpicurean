...
const Lassiette = () => (
  <RestaurantPage
    restaurantName="L'Assiette"
    address="181 rue du Château, Paris, 75014, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33143226486"
    website="https://restaurant-lassiette.paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An honest and generous place where you can see what's going on in the kitchen. Home-made cassoulet (also available in the adjoining shop), pâté en croûte, vegetable pickles; beef chuck braised in red wine and tender carrots; rum baba: Think traditional cuisine with a chic bistro twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=181%20rue%20du%20Ch%C3%A2teau%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="L'Assiette"
  />
);

export default Lassiette;
