...
const LeQuincy = () => (
  <RestaurantPage
    restaurantName="Le Quincy"
    address="28 avenue Ledru-Rollin, Paris, 75012, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33146284676"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/quincy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosy ambience prevails in this utterly timeless establishment, which was dominated by its larger-than-life boss, “Bobosse”, for so many years. Even though he doesn’t pop in quite so often anymore, his personality continues to underscore the DNA of this haunt of foodies. For fifty odd years, fine food lovers have been digging into wholehearted, rustic dishes from Berry or Ardèche. The chef scrimps neither on quality nor quantity when it comes to the house terrine of cabbage and garlic, poultry in cream or the rum-flavoured ice cream! An establishment whose existence is almost anachronistic in today’s restaurant universe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20avenue%20Ledru-Rollin%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Le Quincy"
  />
);

export default LeQuincy;
