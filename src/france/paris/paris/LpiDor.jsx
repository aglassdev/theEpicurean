...
const LpiDor = () => (
  <RestaurantPage
    restaurantName="À l’Épi d’Or"
    address="25 rue Jean-Jacques-Rousseau, Paris, 75001, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33142363812"
    website="https://jeanfrançoispiege.com/a-lepi-dor"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quintessential Parisian bistro of the former Baltard market is the latest acquisition of Elodie and Jean-François Piège. The authentic vintage interior (old tiles and mirrors and stained walls) provides the setting for traditional fare that changes daily during the week. Also available: pork pie, croque madame, foie gras, steak tartare and chips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20Jean-Jacques-Rousseau%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="À l’Épi d’Or"
  />
);

export default LpiDor;
