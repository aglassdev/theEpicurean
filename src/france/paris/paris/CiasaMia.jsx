...
const CiasaMia = () => (
  <RestaurantPage
    restaurantName="Ciasa Mia"
    address="19 rue Laplace, Paris, 75005, France"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+33143291977"
    website="https://www.ciasamia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a side street near the Pantheon, this charming little restaurant with exposed stone walls and wooden furnishings has a rustic feel that calls to mind a chalet. At the helm is an Italian couple in their forties: he is in charge in the kitchen, she takes care of proceedings front of house, dressed in the traditional attire of the Dolomites. The food is presented in surprise set menus, in which an inventive spin is put on local ingredients and bitter flavours are subtly explored – a hallmark of refined Italian cuisine. A good selection of wines completes the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Laplace%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Ciasa Mia"
  />
);

export default CiasaMia;
