...
const Parcelles = () => (
  <RestaurantPage
    restaurantName="Parcelles"
    address="13 rue Chapon, Paris, 75003, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33143379164"
    website="https://www.parcelles-paris.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The quintessence of retro Paris! In a side street between Arts et Métiers and the Centre Pompidou, this 1936 bistro would not have been out of place on the set of Woody Allen's Midnight in Paris: authentic bistro furniture, bare or beige walls, vintage tiled flooring, gilded ceiling, and a copper and wooden counter. The food is all that you'd expect: pressed pork shank, line-caught sea bass with spelt risotto and smoked eel sauce, and, of course, the dark chocolate and caramelised pecan tart. Ten out of ten for this restaurant that fully deserves its success. (Book if you can.)..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Chapon%2C%20Paris%2C%2075003%2C%20France"
    pageTitle="Parcelles"
  />
);
