...
const Eclipses = () => (
  <RestaurantPage
    restaurantName="Eclipses"
    address="27-29 rue de Beaune, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33140139642"
    website="https://eclipses.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, by a chef who has carved out a career in Michelin-starred kitchens (Ledoyen, Apicius, Le Grand Véfour), serves contemporary cuisine that is heedful of ingredients and the seasons. Enjoy your meal in the tastefully decorated neo-Classical setting. Lovely vaulted cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27-29%20rue%20de%20Beaune%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Eclipses"
  />
);
