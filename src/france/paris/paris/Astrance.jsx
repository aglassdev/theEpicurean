...
const Astrance = () => (
  <RestaurantPage
    restaurantName="Astrance"
    address="32 rue de Longchamp, Paris, 75016, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33140508440"
    website="https://www.astranceparis.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Pascal Barbot and his partner Christophe Rohat took the gamble of setting up their restaurant in premises that are the stuff of legend – here, Joël Robuchon made a name for himself with Jamin! They have turned it into a slick, modern space, without for all that neglecting to pay tribute to the great chef with the Salon Joël. With his passion for produce undiminished, the chef creates innovative cuisine in which nothing is out of bounds, with a particular predilection for Asian and plant-based dishes. His fans will be ecstatic to note that his famous button mushroom millefeuille with foie gras marinated in verjuice is still on the menu. The talented maître d' can be counted on to put his guests at ease… and to find them that rare pearl among the vintages that fill the superb glass wine cell..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20rue%20de%20Longchamp%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Astrance"
  />
);

export default Astrance;
