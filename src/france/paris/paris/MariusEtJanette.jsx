...
const MariusEtJanette = () => (
  <RestaurantPage
    restaurantName="Marius et Janette"
    address="4 avenue George-V, Paris, 75008, France"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+33147234188"
    website="https://mariusetjanette-paris.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant yacht-style décor, replete with fishing rods, nets and copper portholes, caters to discerning food lovers. The chef highlights fish and seafood, with a menu that is renewed daily, according to the catch. Carpaccio of salmon and basil, grilled seabass to share or linguine with lobster (a house speciality): a festival of flavours!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20avenue%20George-V%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Marius et Janette"
  />
);

export default MariusEtJanette;
