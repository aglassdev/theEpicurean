...
const LeChardenoux = () => (
  <RestaurantPage
    restaurantName="Le Chardenoux"
    address="1 rue Jules-Vallès, Paris, 75011, France"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33143714952"
    website="https://restaurantlechardenoux.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this Parisian bistro founded by the Chardenoux family and a listed historic monument, the eye wanders from the beautiful painted ceiling to the Art nouveau details, before it is drawn back to the business at hand, the enticing menu in front of us. Fish and seafood are the name of the game here, including Lignac’s iconic signature dishes: lobster roll, salt-crusted sea bass, tuna tartar, avocado, ponzu, wasabi, without forgetting the decadent millefeuille or the rum baba! We fell in love with the crunchy savoury pancake of curry-flavoured crab and avocado: a masterpiece of balanced flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Jules-Vall%C3%A8s%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Le Chardenoux"
  />
);

export default LeChardenoux;
