...
const Shabour = () => (
  <RestaurantPage
    restaurantName="Shabour"
    address="19 rue Saint-Sauveur, Paris, 75002, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33695163287"
    website="https://www.restaurantshabour.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The man behind Shabour is Assaf Granit, the high-profile Israeli chef. Already owner of a dozen restaurants in Jerusalem and London, he also presents Israeli TV's version of Kitchen Nightmares. He set his sights on this 17C building in a lively neighbourhood between rue Saint-Denis and rue Montorgueil. Here, we rediscover his trademarks: a lively atmosphere, rough and ready decoration with metal technical ducts visible on the ceiling, subdued lighting... and, of course, generous and surprising creative cuisine replete with Mediterranean influences, whose freshness gives it wings – for example, carrots with slow-cooked egg, tahini foam, salmon eggs and tzimmes, seared mullet in an eastern take on bouillabaisse, or semolina pudding with orange blossom and crème anglaise with pumpkin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Saint-Sauveur%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Shabour"
  />
);

export default Shabour;
