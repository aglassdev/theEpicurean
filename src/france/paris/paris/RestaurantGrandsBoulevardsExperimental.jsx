...
const RestaurantGrandsBoulevardsExperimental = () => (
  <RestaurantPage
    restaurantName="Restaurant Grands Boulevards Experimental"
    address="17 boulevard Poissonnière, Paris, 75002, France"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33185733332"
    website="https://www.grandsboulevardshotel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A trendy vibe and a warm welcome set the scene beneath the glazed roof of the hotel’s inner courtyard. The concise Italian-themed menu, devised by chef Giovanni Passerini, is both simple and succulent, illustrated by pâté en croûte and giardiniera of veggies; Giovanni’s ravioli: spinach, ricotta, sage butter and parmesan or the tiramillefeuille extravaganza with hazelnut ice cream and crispy, wafer-thin cocoa arlettes. The beverage list features an intriguing lineup of wines and cocktails. Just the ticket for a party night out on the town!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20boulevard%20Poissonni%C3%A8re%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Restaurant Grands Boulevards Experimental"
  />
);

export default RestaurantGrandsBoulevardsExperimental;
