...
const KodawariRamenYokoch = () => (
  <RestaurantPage
    restaurantName="Kodawari Ramen - Yokochō"
    address="29 rue Mazarine, Paris, 75006, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33143293767"
    website="https://www.kodawari-ramen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bustling vibe and cramped dimensions of this eatery instantly conjure up pictures of historic Tokyo. The ramen, made on site and served in delicious broths of Loiret poultry, attract gourmets from every horizon. The house speciality is kurugoma ramen made with a secret black sesame seed sauce and pata negra pork. Avoid peak times, as the place is very popular. Fully deserving of its success...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Mazarine%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Kodawari Ramen - Yokochō"
  />
);

export default KodawariRamenYokoch;
