...
const AtelierMatreAlbert = () => (
  <RestaurantPage
    restaurantName="Atelier Maître Albert"
    address="1 rue Maître-Albert, Paris, 75005, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33156813001"
    website="https://www.ateliermaitrealbert.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive medieval fireplace and roasting spits take pride of place in this handsome interior designed by J.-M. Wilmotte. Guy Savoy signs the menu which boasts a knockout cast of first-class ingredients. T-bone steak, free-range poultry, spit-roasted suckling lamb chops and leg – all that remains is to choose your side dish, for example, gratin dauphinois or purée, both crafted with text-book precision...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Ma%C3%AEtre-Albert%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Atelier Maître Albert"
  />
);

export default AtelierMatreAlbert;
