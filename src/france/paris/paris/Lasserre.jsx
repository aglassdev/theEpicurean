...
const Lasserre = () => (
  <RestaurantPage
    restaurantName="Lasserre"
    address="17 avenue Franklin-D.-Roosevelt, Paris, 75008, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33143590213"
    website="https://www.restaurant-lasserre.com/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the vicinity of the Champs-Élysées, this Directoire-style private mansion oozes with special occasion glamour. During his career, René Lasserre (d. 2006), who came to Paris to learn the trade while still a teenager, raised the restaurant to the rank of iconic landmark. Columns, lush green plants and orchids, silver tableware and knick-knacks, crystal chandeliers, Chinese porcelain, etc, have set the scene in the lavishly appointed dining room for over 80 years. The magical retractable sliding roof, which bathes the tables in natural light, is another highlight of this mythical venue. Jean-Louis Nomicos tweaks the establishment’s culinary heritage, adding a personal twist: stuffed macaroni, black truffles, celery and duck foie gras in a light gratin; André Malraux squab, French peas; gou..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20avenue%20Franklin-D.-Roosevelt%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Lasserre"
  />
);

export default Lasserre;
