...
const Aspic = () => (
  <RestaurantPage
    restaurantName="ASPIC"
    address="24 rue Louise-Émilie-de-la-Tour-d'Auvergne, Paris, 75009, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33982493098"
    website="https://www.aspic-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After ditching the world of finance to enrol in the Ferrandi Culinary School, the chef went on to hone his skills in a variety of establishments (including the French Ministry of Foreign Affairs and L'Épi Dupin). He then went it alone and opened this restaurant. With its vintage vibe and open kitchen, the chef devises a surprise set menu that is unabashedly creative and showcases carefully selected ingredients: free-range meat and poultry, line-caught fish from small boat fishing, citrus fruits, herbs and spices, all sourced as locally as possible...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20Louise-%C3%89milie-de-la-Tour-d'Auvergne%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="ASPIC"
  />
);

export default Aspic;
