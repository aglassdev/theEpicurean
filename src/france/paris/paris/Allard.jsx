...
const Allard = () => (
  <RestaurantPage
    restaurantName="Allard"
    address="41 rue Saint-André-des-Arts, Paris, 75006, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33143264823"
    website="https://www.restaurant-allard.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of bustling Saint Germain des Près, this authentic Parisian bistro, dripping in charm and now part of the Ducasse empire, has changed very little since it opened in 1932. The culinary score wavers between bistro fare and heroic brasserie staples: snails in parsley, butter and garlic, pâté en croûte, sole meunière, profiteroles. Attractive lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20rue%20Saint-Andr%C3%A9-des-Arts%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Allard"
  />
);
