...
const CloverSaintgermain = () => (
  <RestaurantPage
    restaurantName="Clover Saint-Germain"
    address="5 rue Perronet, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33175500005"
    website="https://jeanfrançoispiege.com/cloversaintgermain"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In keeping with the trend of great chefs opening modest restaurants, Jean-François Piège serves generous starters for sharing (oysters, cold meats etc) and home-made pasta dishes (the laboratory is right next door). Penne, ravioli and tortellini are combined with humble ingredients such as ox cheek, premium ingredients such as langoustine, and even exotic elements – see his green curry on tortellini, Mediterranean crab, piquillos and cauliflower. The desserts, such as an invisible apple cake, are simply delicious. The small space is long and narrow, encompassing both the kitchen and dining area...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Perronet%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Clover Saint-Germain"
  />
);

export default CloverSaintgermain;
