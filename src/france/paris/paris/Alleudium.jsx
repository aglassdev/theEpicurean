...
const Alleudium = () => (
  <RestaurantPage
    restaurantName="Alleudium"
    address="24 rue Rodier, Paris, 75009, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33145268626"
    website="https://www.alleudium.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Keiichi Shinohara, a Japanese chef with solid credentials (including a stint at Le Violon d'Ingres during the Christian Constant era), is at the helm of this restaurant with refined contemporary decor. Customer satisfaction is the goal here, in particular when it comes to the food, which is modern and inspired, with the odd nod to Japan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20Rodier%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Alleudium"
  />
);

export default Alleudium;
