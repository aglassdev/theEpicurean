...
const ImprialChoisy = () => (
  <RestaurantPage
    restaurantName="Impérial Choisy"
    address="32 avenue de Choisy, Paris, 75013, France"
    cuisine="Chinese"
    priceRange="€€"
    phoneNumber="+33145864240"
    website="http://imperialchoisy.fr/menu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Paris's Chinatown, this Chinese restaurant is popular with many people from the local Asian community, who have adopted it as their canteen. In a room that is always full (the service runs non-stop from lunch to dinner, and is fast-paced, to say the least!), they serve fine Cantonese specialities, including crispy pork and Peking duck. A truly authentic meal, without breaking the bank! You can't book here; you just have to go and wait to be seated...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20avenue%20de%20Choisy%2C%20Paris%2C%2075013%2C%20France"
    pageTitle="Impérial Choisy"
  />
);

export default ImprialChoisy;
