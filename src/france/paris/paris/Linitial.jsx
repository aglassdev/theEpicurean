...
const Linitial = () => (
  <RestaurantPage
    restaurantName="L'Initial"
    address="9 rue de Bièvre, Paris, 75005, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142018422"
    website="https://restaurant-linitial.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Japanese chef with a brilliant track record proposes French cuisine that demonstrates remarkable precision and is made with fine produce (sea bass, scallops, langoustine, morel mushrooms) and represents good value for money. The roast rack of Lozère lamb, celeriac purée, lemon condiment and reduced lamb jus was a stand-out dish. Highly attentive service and a refined and light-filled setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20de%20Bi%C3%A8vre%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="L'Initial"
  />
);

export default Linitial;
