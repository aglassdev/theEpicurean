...
const AniciaTableNature = () => (
  <RestaurantPage
    restaurantName="Anicia, table nature"
    address="97 rue du Cherche-Midi, Paris, 75006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33143354150"
    website="https://www.anicia-paris.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hailing from the Haute-Loire area, François Gagnaire carefully selects small-scale farmers from the vicinity, kitting himself out with excellent raw material for his cooking. Puy lentils, Limousine des Monts-du-Velay beef, Mézenc fin gras beef, Artisous farmhouse cheese, Vellavia beer… His dishes are both delicious and beautifully presented, making a meal here a real treat; the lunch menu is a real bargain in this neighbourhood. Afternoon tea is served, plus a more fine dining menu in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=97%20rue%20du%20Cherche-Midi%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Anicia, table nature"
  />
);

export default AniciaTableNature;
