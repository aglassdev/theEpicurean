...
const Fugue = () => (
  <RestaurantPage
    restaurantName="Fugue"
    address="128 rue du Faubourg-Saint-Martin, Paris, 75010, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33954949668"
    website="https://fugueparis.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from Gare de l'Est, this contemporary bistro is appealing with its sociable counter, exposed stone walls, weathered beams and walls lined with bottles. The decor is warm and welcoming – the perfect backdrop for Hitoshi Minatani's personal, precise and indulgent cuisine. Think duck gyoza, pigeon bisque; skate wing, spring vegetables, anchoïade and langoustine bisque; citrus vacherin. In the dining room, Victor Baraton-Dorat pairs each dish with carefully selected organic and biodynamic wines. At lunchtime, the affordable set menu serves as a wonderful introduction...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=128%20rue%20du%20Faubourg-Saint-Martin%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Fugue"
  />
);
