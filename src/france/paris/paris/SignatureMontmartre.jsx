...
const SignatureMontmartre = () => (
  <RestaurantPage
    restaurantName="Signature Montmartre"
    address="12 rue des Trois-Frères, Paris, 75018, France"
    cuisine="Fusion"
    priceRange="€€"
    phoneNumber="+33184253000"
    website="https://signature-montmartre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in touristy Montmartre, this Lilliputian restaurant sports a minimalist interior and a buzzy vibe. At the helm of the restaurant, that is fully deserving of its success, is a Franco-Korean couple (bookings highly recommended). He warmly welcomes diners, proffering insightful wine tips along the way, while she deploys her pastry talents in the kitchen. The Franco-Asian repertory quietly feeds you well, courtesy of intelligent recipes scattered in subtle aromas, illustrated by a tataki of bonito with cucumber pickles, a watercress crepe and a vitello tonnato sauce jazzed up with mint – flavoursome and surprising! Consider us smitten!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20des%20Trois-Fr%C3%A8res%2C%20Paris%2C%2075018%2C%20France"
    pageTitle="Signature Montmartre"
  />
);

export default SignatureMontmartre;
