...
const Linconnu = () => (
  <RestaurantPage
    restaurantName="L'Inconnu"
    address="4 rue Pierre-Leroux, Paris, 75007, France"
    cuisine="Italian, Creative"
    priceRange="€€€"
    phoneNumber="+33745285330"
    website="https://restaurant-linconnu.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef, who for a long time was second-in-command at Passage 53, concocts Italian-inspired cuisine with influences from France, as well as his native Japan. He only works with the finest ingredients, using them to produce original and creative dishes, such as Breton langoustine tails topped with a cider and confit lemon emulsion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20Pierre-Leroux%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="L'Inconnu"
  />
);

export default Linconnu;
