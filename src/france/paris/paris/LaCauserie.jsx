...
const LaCauserie = () => (
  <RestaurantPage
    restaurantName="La Causerie"
    address="31 rue Vital, Paris, 75016, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33145203300"
    website="https://lacauserie.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two young associates from Le Royal Monceau preside over the destiny of this famous institution in the neighbourhood of La Muette. The chef revisits tradition here, injecting plenty of freshness, through a menu as straightforward as it is tasty; as for the decoration, it has a pleasant retro side: large mirror, ceramic fresco, Sarreguemines pottery etc. Attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20Vital%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="La Causerie"
  />
);

export default LaCauserie;
