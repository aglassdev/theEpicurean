...
const At = () => (
  <RestaurantPage
    restaurantName="AT"
    address="4bis rue du Cardinal-Lemoine, Paris, 75005, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33156819408"
    website="https://www.atsushitanaka.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A stone's throw from the banks of the Seine, this small, quietly unobtrusive restaurant sports a minimalist interior in line with today’s quest for authenticity rather than hot air! Chef Tanaka, formerly of Pierre Gagnaire, is a fan of fresh ingredients and precision. Armed with boundless creativity and imagination, he conjures up enticing dishes that keep us drooling right up to the very end. The vaulted cellar in the basement is home to a wine bar and delivers take-away meals. It is also nice to know that you will always be surprised here, because the single set menu changes regularly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4bis%20rue%20du%20Cardinal-Lemoine%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="AT"
  />
);
