...
const Pilgrim = () => (
  <RestaurantPage
    restaurantName="Pilgrim"
    address="8 rue Nicolas-Charlet, Paris, 75015, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33140290971"
    website="https://www.pilgrimparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hideki Nishi (owner of Neige d'Été in Paris) has entrusted Yurika Kitano with the cuisine of this restaurant near Montparnasse. In a central and slightly raised kitchen, the chef crafts her elegant, delicate dishes, like tiny masterpieces influenced by France and Japan. This paradise for our tastebuds looks all set to become a place of pilgrimage for foodies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Nicolas-Charlet%2C%20Paris%2C%2075015%2C%20France"
    pageTitle="Pilgrim"
  />
);
