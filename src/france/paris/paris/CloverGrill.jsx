...
const CloverGrill = () => (
  <RestaurantPage
    restaurantName="Clover Grill"
    address="6 rue Bailleul, Paris, 75001, France"
    cuisine="Grills"
    priceRange="€€€"
    phoneNumber="+33140415959"
    website="https://jeanfrançoispiege.com/clover-grill"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mouthwatering dry - aged meats – Baltic black beef, Bavarian beef, Blonde d'Aquitaine, Black Angus – take pride of place in the window, drawing in diners keen to try them for themselves. From the starters to the desserts, everything is cooked over coals or roasted on a spit, giving the dining experience its own particular flavour. A great success...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Bailleul%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Clover Grill"
  />
);

export default CloverGrill;
