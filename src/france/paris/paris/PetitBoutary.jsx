...
const PetitBoutary = () => (
  <RestaurantPage
    restaurantName="Petit Boutary"
    address="16 rue Jacquemont, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33146277623"
    website="https://www.petitboutary.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Petit Boutary is certainly living up to the standard set by its Left Bank counterpart. In this refined bistro, with a black and white chequered floor, zinc-topped bar, leather-clad banquette seating and hanging light bulbs, modern, creative cuisine is served in the form of a single surprise menu with several courses. You may taste the house signature dish: “Potatoes in Boutary caviar”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20Jacquemont%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Petit Boutary"
  />
);

export default PetitBoutary;
