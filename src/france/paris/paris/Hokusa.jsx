...
const Hokusa = () => (
  <RestaurantPage
    restaurantName="Hokusaï"
    address="Metropolitan Paris Tour Eiffel, 3 rue des Belles-Feuilles, Paris, 75116, France"
    cuisine="Japanese, Fusion"
    priceRange="€€€"
    phoneNumber="+33156904012"
    website="https://www.marriott.com/fr/hotels/parxt-le-metropolitan-paris-tour-eiffel-a-tribute-portfolio-hotel/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hotel on Place de Mexico is introducing a new concept of Japanese cuisine with a South American twist. In a contemporary, minimalist setting, the menu combines signature rolls, sushi and teriyaki chicken with ceviche and Hispanic ingredients such as chimichurri sauce and jalapeño. Freshness and flavour are the order of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Metropolitan%20Paris%20Tour%20Eiffel%2C%203%20rue%20des%20Belles-Feuilles%2C%20Paris%2C%2075116%2C%20France"
    pageTitle="Hokusaï"
  />
);

export default Hokusa;
