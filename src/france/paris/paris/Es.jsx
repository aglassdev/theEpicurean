...
const Es = () => (
  <RestaurantPage
    restaurantName="ES"
    address="91 rue de Grenelle, Paris, 75007, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+33145512574"
    website="https://restaurant-es.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=91%20rue%20de%20Grenelle%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="ES"
  />
);
