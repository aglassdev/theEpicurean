...
const LeSergentRecruteur = () => (
  <RestaurantPage
    restaurantName="Le Sergent Recruteur"
    address="41 rue Saint-Louis-en-l'Île, Paris, 75004, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33143547542"
    website="https://www.lesergentrecruteur.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Alain Pégouret inherited his love of precise, painstaking work from Joël Robuchon. For a first-hand taste of his craftsmanship, you only have to enter Le Sergent Recruteur, a historic tavern on Île Saint-Louis that has morphed into a fine dining establishment. The former chef of the Laurent displays an impressive command of his craft. His delicate dishes abound with crisp flavours – you can taste his solid classical foundations – and linger in the memory thanks to their coherence, the sophistication of the jus and sauces (illustrated by the Périgeux sauce that flanks the egg and black truffle mousseline or the royale sauce that is paired with hare in season and squid all year round), and their spot-on cooking. This establishment exudes a hushed, elegant vibe that artfully blends conte..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20rue%20Saint-Louis-en-l'%C3%8Ele%2C%20Paris%2C%2075004%2C%20France"
    pageTitle="Le Sergent Recruteur"
  />
);

export default LeSergentRecruteur;
