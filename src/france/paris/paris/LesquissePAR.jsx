...
const LesquissePAR = () => (
  <RestaurantPage
    ...
    address="151 bis rue Marcadet, Paris, 75018, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33153416304"
    website="https://www.esquisse-paris18.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two enthusiast young food lovers have joined forces to create this inviting vintage bistro with solid wooden flooring and benches. A good time is had here, as you tuck into original dishes that make no bones about drawing on influences from far afield. For lunch there is the menu du jour (with no options) and a mini à la carte menu; at dinner, a more extensive choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=151%20bis%20rue%20Marcadet%2C%20Paris%2C%2075018%2C%20France"
    pageTitle="L'Esquisse"
  />
);

export default LesquissePAR;
