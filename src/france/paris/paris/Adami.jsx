...
const Adami = () => (
  <RestaurantPage
    restaurantName="Adami"
    address="19 bis rue Pierre-Fontaine, Paris, 75009, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33760870264"
    website="https://adamiparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small Italian pasta restaurant has broken free of traditional trattoria codes and embraced a more contemporary vibe, illustrated by the untreated, modern decor and long counter from which diners can admire the kitchen team at work. Dishes to share and a warm, cheerful mood are all part of the experience here. The Italian chef rolls out fresh cuisine that abounds in crisp, bold flavours. A case in point is grilled cos lettuce, pine nut sauce and puttanesca seasoning, or his truly addictive gnocchi in ricotta and creamy smoked mozzarella. The lunch menu is quite as appealing as the mouthwatering à la carte lineup......"
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20bis%20rue%20Pierre-Fontaine%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Adami"
  />
);

export default Adami;
