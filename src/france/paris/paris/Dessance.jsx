...
const Dessance = () => (
  <RestaurantPage
    restaurantName="Dessance"
    address="74 rue des Archives, Paris, 75003, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142772362"
    website="https://www.dessance.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a private mansion in the Marais, this restaurant is run by an Argentinian chef who creates inspired seasonal cuisine. He devises two carte blanche menus, one focusing on meat and fish (Terre & Mer), the other vegetarian. To give a few examples: revisited croque-crevette; foie gras, smoked eel and mushrooms; pollack, celeriac and wasabi. The wine list includes a number of biodynamic and natural choices. The elegant setting, with its high ceilings and greenery, is reminiscent of a winter garden – the location is full of charm and style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20rue%20des%20Archives%2C%20Paris%2C%2075003%2C%20France"
    pageTitle="Dessance"
  />
);

export default Dessance;
