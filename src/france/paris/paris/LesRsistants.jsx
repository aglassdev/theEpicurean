...
const LesRsistants = () => (
  <RestaurantPage
    restaurantName="Les Résistants"
    address="16 rue du Château-d'Eau, Paris, 75010, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33177327761"
    website="https://www.lesresistants.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These résistants believe that taste and traceability should be the backbone of all food. Indeed, the credo of owner, Florent Piard, is none other than good food that respects natural cycles!  and he amply proves his case in this cheerful establishment. The concise menu changes daily in keeping with market availability and the prices are never outlandish. Natural wines bien sûr!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20du%20Ch%C3%A2teau-d'Eau%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Les Résistants"
  />
);

export default LesRsistants;
