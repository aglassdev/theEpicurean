...
const LesDlicesDaphrodite = () => (
  <RestaurantPage
    restaurantName="Les Délices d'Aphrodite"
    address="4 rue de Candolle, Paris, 75005, France"
    cuisine="Greek"
    priceRange="€€"
    phoneNumber="+33143314039"
    website="https://www.mavrommatis.com/les-delices-daphrodite/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this charming tavern-style restaurant, you could be forgiven for thinking you are in Greece! Freshly made, sun-drenched dishes such as marinated peppers, spit-roasted leg of lamb on a skewer, etc., all prepared with top-notch ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20de%20Candolle%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Les Délices d'Aphrodite"
  />
);

export default LesDlicesDaphrodite;
