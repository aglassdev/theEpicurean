...
const CavesPtrissans = () => (
  <RestaurantPage
    restaurantName="Caves Pétrissans"
    address="30 bis avenue Niel, Paris, 75017, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33142275203"
    website="https://www.cavespetrissans.fr/fr,1,13689.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This splendid family business has seen successive generations of the Allemoz dynasty at the helm since 1895. Treat yourself to a chicken liver pâté with onion jam, grilled hanger steak or calf’s head with a ravigote sauce. Bistro classics also depict the dessert lineup, with regressive dishes like rum baba or île flottante. An enticing wine list adds the final cherry to this appetising programme...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20bis%20avenue%20Niel%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Caves Pétrissans"
  />
);

export default CavesPtrissans;
