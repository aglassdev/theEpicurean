...
const LeGeorge = () => (
  <RestaurantPage
    restaurantName="Le George"
    address="Four Seasons George V, 31 avenue George-V, Paris, 75008, France"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+33149527209"
    website="https://www.fourseasons.com/fr/paris/dining/restaurants/le_george/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A magnificent Baccarat chandelier, immaculate white decor and delicate floral arrangements all contribute to the chic yet relaxed decor designed by Pierre-Yves Rochon… Guests are left in no doubt that this is part of the exclusive Four Seasons George V hotel! At Le George, Simone Zanoni has definitely made his culinary mark here with his Italian-inspired dishes. This light and airy cuisine is enchanting; Zanoni's dishes are served in small portions, with particular attention paid to the flavours and cooking methods of the Mediterranean. Enjoy your meal either indoors or in the high-ceilinged conservatory enabling guests to enjoy the courtyard setting whatever the weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20George%20V%2C%2031%20avenue%20George-V%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Le George"
  />
);

export default LeGeorge;
