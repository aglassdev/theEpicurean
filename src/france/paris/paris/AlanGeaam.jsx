...
const AlanGeaam = () => (
  <RestaurantPage
    restaurantName="Alan Geaam"
    address="19 rue Lauriston, Paris, 75016, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33145017297"
    website="https://restaurant.alangeaam.fr/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Lauriston%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Alan Geaam"
  />
);

export default AlanGeaam;
