...
const TudePAR = () => (
  <RestaurantPage
    restaurantName="Étude"
    address="14 rue du Bouquet-de-Longchamp, Paris, 75016, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33145051141"
    website="https://restaurant-etude.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inspired by his encounters with small-scale producers, chef Keisuke Yamagishi, who hails from the rural province of Nagano, Japan, serves surprise menus based on seasonal ingredients. In a minimalist setting (the overhead lighting is by Serge Mouille), the chef treats us to his creative outlook, his refined vision of plating and his passion for Burgundy wines, in particular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20du%20Bouquet-de-Longchamp%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Étude"
  />
);

export default TudePAR;
