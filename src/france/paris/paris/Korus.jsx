...
const Korus = () => (
  <RestaurantPage
    restaurantName="Korus"
    address="73 rue Amelot, Paris, 75011, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33155285331"
    website="https://restaurantkorus.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fashionable dinky bistro tucked away between Bastille and République is run by an enthusiastic duo who works closely with a talented chef. Creativity, premium ingredients and unexpected associations result in forthright flavours that hit the spot every time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20rue%20Amelot%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Korus"
  />
);
