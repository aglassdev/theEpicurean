...
const Euno = () => (
  <RestaurantPage
    restaurantName="Eunoé"
    address="6 rue Rochebrune, Paris, 75011, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33767968636"
    website="https://www.eunoe-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese chef Ryuji Sato and Félix Perotte (front of house) are two friends who are passionate about food and wine. They offer hospitality at this location near Square Maurice Gardette. In a modern, stylishly unfinished setting in sand and ochre tones, the chef delivers his fine, no-holds-barred take on the culinary zeitgeist, with an emphasis on flavour in every dish: pork loin soaked in its full-bodied jus with aged sherry vinegar and a hint of thyme, smoked potato mash and a small salad of fresh herbs, seasoned to perfection. At dinner, the elegance goes up a notch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Rochebrune%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Eunoé"
  />
);
