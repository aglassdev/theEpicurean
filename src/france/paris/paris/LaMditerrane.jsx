...
const LaMditerrane = () => (
  <RestaurantPage
    restaurantName="La Méditerranée"
    address="2 place de l'Odéon, Paris, 75006, France"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+33143260230"
    website="https://www.la-mediterranee.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The frescoes evoke the Mediterranean in this restaurant opposite the historic Odéon Theatre. The maritime inspired cuisine, in which particular attention is paid to first-class ingredients, is influenced by the sunny South of France. House specialties include bouillabaisse, carpaccio of seabass, honey-glazed seabream… Affordable menu, pricier à la carte offering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20de%20l'Od%C3%A9on%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="La Méditerranée"
  />
);

export default LaMditerrane;
