...
const LeTirebouchonRodier = () => (
  <RestaurantPage
    restaurantName="Le Tire-Bouchon Rodier"
    address="47 rue Rodier, Paris, 75009, France"
    cuisine="Traditional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+33186042717"
    website="https://www.letirebouchonrodier.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20rue%20Rodier%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Le Tire-Bouchon Rodier"
  />
);

export default LeTirebouchonRodier;
