...
const LaTableDuCavisteBio = () => (
  <RestaurantPage
    restaurantName="La Table du Caviste Bio"
    address="55 rue de Prony, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33182103702"
    website="https://www.latable.bio/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few well - polished, leather footfalls from Parc Monceau and you are in this stylish restaurant combining a modern dining room and food that is in tune with current tastes, fresh and subtle, concocted by Japanese culinary artist, Junko Kawasaki. The matching wines are naturally organic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20rue%20de%20Prony%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="La Table du Caviste Bio"
  />
);

export default LaTableDuCavisteBio;
