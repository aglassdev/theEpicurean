...
const Neso = () => (
  <RestaurantPage
    restaurantName="NESO"
    address="3 rue Papillon, Paris, 75009, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33148240413"
    website="https://www.neso.paris"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The charismatic and heavily tattooed Guillaume Sanchez crafts fiery, flame-licked cuisine in a stylish arty interior, dominated by black and gold and a profusion of untreated materials. Sanchez’ powerful yet balanced score is emblematic of his flamboyant personality. The chef has a knack for wielding explosive flavours: spicy kimchi on red mullet, horseradish sauce on crushed langoustine or herby lovage oil drizzled onto a “trou normand” (a mid-meal palate cleanser). Cold-steamed extractions and fermented vegetables set the scene and the chef works exclusively with stellar, purebred Gallic produce, to which he adds his imaginative hallmark and high-flying technical expertise. Incredibly varied flavours and textures and art-directed, if unusual plating await the diner. Take a seat at the co..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Papillon%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="NESO"
  />
);
