...
const LabysseAuPavillonLedoyen = () => (
  <RestaurantPage
    ...
    pageTitle="L'Abysse au Pavillon Ledoyen"
  />
);

export default LabysseAuPavillonLedoyen;
