...
const FrenchiePigalle = () => (
  <RestaurantPage
    restaurantName="Frenchie Pigalle"
    address="29 rue Victor-Massé, Paris, 75009, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33185731046"
    website="https://www.frenchie-pigalle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Grégory Marchand has brought a tongue-in-cheek vibe to the ground-floor restaurant of this hotel in Paris’ sleazy yet romantic Pigalle. Dishes to share in a joyful canteen ambience that err between regional comfort food, bang-on Gallic classics and world food, including a splendid cheeseboard and a wine list with natural inclinations…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Victor-Mass%C3%A9%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Frenchie Pigalle"
  />
);

export default FrenchiePigalle;
