...
const LeGrandBain = () => (
  <RestaurantPage
    restaurantName="Le Grand Bain"
    address="14 rue Dénoyez, Paris, 75020, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33983027202"
    website="https://www.legrandbainparis.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the bustling heart of Belleville, we love this hip bistro and its authentic industrial workshop vibe, complete with a central island counter, glazed partitions, untreated materials (brick and concrete) and numbered tables. Tuck into tasty small dishes – chalked up on the blackboard. The funky playlist reflects the tastes of the hipster night owls and discerning foodies who flock here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20D%C3%A9noyez%2C%20Paris%2C%2075020%2C%20France"
    pageTitle="Le Grand Bain"
  />
);

export default LeGrandBain;
