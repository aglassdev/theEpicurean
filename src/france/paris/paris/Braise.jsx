...
const Braise = () => (
  <RestaurantPage
    restaurantName="Braise"
    address="19 rue d'Anjou, Paris, 75008, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33144700099"
    website="https://www.braise.paris"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The former second of Substance, Sylvain Courivaud, is determined to kindle our appetites in this contemporary venue entirely devoted to wood-fired cooking. Whatever the method from Japanese barbecue or Big Green Egg to a smoker, Sylvain combines consummate technique with a love of high-quality produce. The vibe of this trendy eatery is warm and welcoming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20d'Anjou%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Braise"
  />
);

export default Braise;
