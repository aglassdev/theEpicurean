...
const MarieAkaneya = () => (
  <RestaurantPage
    restaurantName="Marie Akaneya"
    address="12 rue Godot-de-Mauroy, Paris, 75009, France"
    cuisine="Japanese, Barbecue"
    priceRange="€€€€"
    phoneNumber="+33987523638"
    website="https://www.marieakaneya.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is Paris's first sumibiyaki-style restaurant. Particularly popular in Kyoto, this cuisine is prepared with top-drawer ingredients, not least the Wagyu that is shipped here from Ito Ranch, a beef farm on the outskirts of the town of Matsusaka – and according to the Japanese themselves, this is the ultimate breed of Kobe beef. Everything is cooked over the famous binchotan charcoal, which is made mainly from Ubame oak wood – every table in the restaurant has its own barbecue taking pride of place. Some of the menus feature Fukuroi's renowned Crown Melon, which can sometimes fetch a price of several thousand euro...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Godot-de-Mauroy%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Marie Akaneya"
  />
);

export default MarieAkaneya;
