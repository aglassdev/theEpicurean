...
const Kisin = () => (
  <RestaurantPage
    restaurantName="Kisin"
    address="7-9 rue de Ponthieu, Paris, 75008, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33171267728"
    website="http://udon-kisin.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When a Bib Gourmand chef from Tokyo arrives in Paris, the first thing he does is open a restaurant, tantalising and bewitching our senses. Diners will sample Japanese produce and genuine udon, made in front of the diner. Natural, additive - free ingredients, most of which are imported direct from the Land of the Rising Sun. Healthy, wholesome and succulent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-9%20rue%20de%20Ponthieu%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Kisin"
  />
);

export default Kisin;
