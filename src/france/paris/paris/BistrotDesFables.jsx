...
const BistrotDesFables = () => (
  <RestaurantPage
    restaurantName="Bistrot des Fables"
    address="139 rue Saint-Dominique, Paris, 75007, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33147537334"
    website="https://www.bistrotdesfables.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fabulous bistro repertoire of tried-and-true classics: think herring fillets, potatoes in oil; œufs mimosa (devilled eggs); scallops roasted in butter; veal blanquette; profiteroles, vanilla ice cream and chocolate gianduja. The menu is devised by David Bottreau in the spirit of Christian Constant, his long-time associate and mentor. Generous, flavoursome cuisine in a typical Parisian bistro atmosphere, where diners tuck in cheek to jowl at small tables laid out next to each other...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139%20rue%20Saint-Dominique%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Bistrot des Fables"
  />
);

export default BistrotDesFables;
