...
const Kapara = () => (
  <RestaurantPage
    restaurantName="Kapara"
    address="9 rue d'Alger, Paris, 75001, France"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+33767405629"
    website="https://kaparaparis.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In their new venue, Kapara, whose interior is almost identical to that of the former Balagan, Assaf Granit and his partner Tomer Lanzman have called upon chef Zohar Sasson. In a setting depicted by groovy background music and hoots of laughter from the ebullient kitchen brigade, Ms Sasson cheerfully conjures up dishes loosely inspired by Sephardic culinary traditions. The menu rolls out a colourful culinary anthology, boosted by spices, seasonings and chickpeas. Some of the emblematic dishes of the former Balagan remain on the menu, such as “deconstructed” kebab. Festive, friendly and (very) buzzy vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20d'Alger%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Kapara"
  />
);

export default Kapara;
