...
const JinPAR = () => (
  <RestaurantPage
    restaurantName="Jin"
    address="6 rue de la Sourdière, Paris, 75001, France"
    cuisine="Japanese, Sushi"
    priceRange="€€€€"
    phoneNumber="+33142616071"
    website="https://www.jin-paris.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wedged between the Louvre Museum and Place Vendôme, this suitably exclusive, well-heeled establishment caters to ten diners at most, who are lucky enough to book a seat at the handsome wooden counter. Diners admire the dexterity of the Japanese chefs as they meticulously craft sushi and sashimi with knife-edged precision using only top-calibre produce (the fish, from Brittany or Spain, is matured to be served at the optimal moment). There is a single omakase menu, meaning the diner leaves the choice to the chef. A consummate performance of virtuoso talent, discreet, slick service and a superb selection of sakes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20de%20la%20Sourdi%C3%A8re%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Jin"
  />
);

export default JinPAR;
