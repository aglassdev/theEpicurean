...
const AuxPrs = () => (
  <RestaurantPage
    restaurantName="Aux Prés"
    address="27 rue du Dragon, Paris, 75006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33145482968"
    website="https://restaurantauxpres.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An unabashed vintage bistro in arty St Germain with red banquette seating, smoked-glass mirrors and floral wallpaper meets globetrotting cuisine from South America to Asia and Italy by Cyril Lignac, whose creativity nonetheless keeps one foot firmly rooted in Gallic traditions. Premium cuts of meat (rib of beef, shoulder of lamb) to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20du%20Dragon%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Aux Prés"
  />
);

export default AuxPrs;
