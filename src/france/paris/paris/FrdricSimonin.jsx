...
const FrdricSimonin = () => (
  <RestaurantPage
    restaurantName="Frédéric Simonin"
    address="25 rue Bayen, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33145747474"
    website="https://www.fredericsimonin.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Frédéric Simonin learned the ropes in top restaurants and alongside great chefs, from Ledoyen to Le Meurice and Joël Robuchon, before becoming Meilleur Ouvrier de France himself in 2019. Out went the black and white and geometric lines, as he set about creating a venue of his very own, with hardwood floors, white walls and bevelled mirrors. This Parisian apartment (in his words) is the perfect foil for his precise, delicate and perfectly balanced cuisine – special mention for his reductions and sauces. There are multi-course tasting menus with a few inventive touches, a great lunch menu and a nice selection of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20Bayen%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Frédéric Simonin"
  />
);

export default FrdricSimonin;
