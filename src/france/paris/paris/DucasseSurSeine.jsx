...
const DucasseSurSeine = () => (
  <RestaurantPage
    restaurantName="Ducasse sur Seine"
    address="Port Debilly, Paris, 75016, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33158002208"
    website="https://www.ducasse-seine.com/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Well, no one can say that Alain Ducasse lacks for boldness or ideas, as the Ducasse sur Seine once again proves. An electric boat, moored on the quayside of Port Debilly in the swanky 16th arrondissement, offers a gastronomic cruise that is both ecological and silent. At the same time as you discover Parisian monuments, you will taste up - to - the - minute cuisine, masterfully crafted by a kitchen team worthy of the best restaurants. Well done, mon capitaine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Port%20Debilly%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Ducasse sur Seine"
  />
);

export default DucasseSurSeine;
