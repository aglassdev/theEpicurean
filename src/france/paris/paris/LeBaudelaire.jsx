...
const LeBaudelaire = () => (
  <RestaurantPage
    restaurantName="Le Baudelaire"
    address="Le Burgundy, 6-8 rue Duphot, Paris, 75001, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33171194911"
    website="https://www.lebaudelaire.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Relax in this stylish, trendy restaurant, nestling in the heart of a snug, arty luxury hotel that embodies the new Parisian chic. The dining room is laid out around an inner courtyard-cum-winter garden, ideal to snuggle up with a good book. This haven of genteel tranquillity is depicted by black lacquered tables, comfy armchairs, floor-to-ceiling windows and sleek white walls. The chef’s well-balanced cuisine revolves around veggies courtesy of painstakingly sourced ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Burgundy%2C%206-8%20rue%20Duphot%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Le Baudelaire"
  />
);

export default LeBaudelaire;
