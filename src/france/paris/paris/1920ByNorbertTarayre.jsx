...
const OneNineTwoZeroByNorbertTarayre = () => (
  <RestaurantPage
    ...
    pageTitle="19.20 by Norbert Tarayre"
  />
);

export default OneNineTwoZeroByNorbertTarayre;
