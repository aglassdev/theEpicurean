...
const LesCanaillesPigalle = () => (
  <RestaurantPage
    restaurantName="Les Canailles Pigalle"
    address="25 rue La Bruyère, Paris, 75009, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33148741048"
    website="https://www.restaurantlescanailles.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The epitome of bistronomic, this eatery was opened by a pair from Brittany who boast impressive culinary backgrounds. Here, bistronomy goes hand in hand with seasonal: beef tongue carpaccio in an olive oil sauce; tender fillet of steak, pleurotes and pommes dauphine; rum baba with whipped vanilla cream – a real treat! Tip: if the restaurant is full, go to Le Comptoir Canaille just a few doors down, which serves more contemporary cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20La%20Bruy%C3%A8re%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Les Canailles Pigalle"
  />
);

export default LesCanaillesPigalle;
