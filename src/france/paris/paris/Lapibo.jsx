...
const Lapibo = () => (
  <RestaurantPage
    restaurantName="L'Apibo"
    address="31 rue Tiquetonne, Paris, 75002, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33155349450"
    website="https://www.restaurant-lapibo.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his small bistro in the Montorgueil neighbourhood (hushed atmosphere, oak floorboards, exposed stone), Antony Boucher, a chef with a strong track record, creates beautifully original and delicate cuisine that fêtes ingredients. He is renowned for his two classics: filet of sea bass, black rice and paprika sauce and the eight-hour confit pork with sweet potato mousseline. The laid-back (and very professional) service evokes the rough and ready spirit that used to characterise Les Halles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20Tiquetonne%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="L'Apibo"
  />
);

export default Lapibo;
