...
const LaPouleAuPot = () => (
  <RestaurantPage
    restaurantName="La Poule au Pot"
    address="9 rue Vauvilliers, Paris, 75001, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33142363296"
    website="https://jeanfrançoispiege.com/la-poule-au-pot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The great classics of the French culinary repertoire are given an overhaul here by Jean-François Piège. Service on a silver tray, old-fashioned bistro decor, zinc counter: it has all the trappings. It's Audiard's Paris down to a T... right down to the food: onion gratinée, quenelle of arctic char, beef chuck hash, Colbert fried whiting with tartar sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20Vauvilliers%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="La Poule au Pot"
  />
);

export default LaPouleAuPot;
