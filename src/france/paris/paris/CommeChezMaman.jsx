...
const CommeChezMaman = () => (
  <RestaurantPage
    restaurantName="Comme Chez Maman"
    address="5 rue des Moines, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142288953"
    website="https://comme-chez-maman.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary bistro near a green square in the heart of the Batignolles neighbourhood is a real home from home. The Belgian chef, Wim Van Gorp, makes lovely contemporary dishes that he peppers with creative touches, and some of which pay delicious tribute to his Flemish roots...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20des%20Moines%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Comme Chez Maman"
  />
);

export default CommeChezMaman;
