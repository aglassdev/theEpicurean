...
const OmarDhiab = () => (
  <RestaurantPage
    restaurantName="Omar Dhiab"
    address="23 rue Hérold, Paris, 75001, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33142335247"
    website="https://www.omardhiab.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Almost next-door to Place des Victoires, Omar Dhiab has found himself a minimalist lair with an open kitchen and a swanky white marble counter. His cuisine revolves around flavoursome ingredients, is rich in creative notes and flanked by a meticulous attention to the sauces and seasonings, some of which are of Egyptian origin. Examples include sea urchin au naturel and cumin-flavoured coral lentils, or roast stag with a herbaceous seasoning and smoked mustard. The light, tempting desserts are an ode to the seasons. Front-of-house service by a youthful, enthusiastic team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20H%C3%A9rold%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Omar Dhiab"
  />
);

export default OmarDhiab;
