...
const Akabeko = () => (
  <RestaurantPage
    restaurantName="Akabeko"
    address="40 rue de l'Université, Paris, 75007, France"
    cuisine="Fusion"
    priceRange="€€€€"
    phoneNumber="+33142612664"
    website="https://www.akabekorestaurant.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20rue%20de%20l'Universit%C3%A9%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Akabeko"
  />
);

export default Akabeko;
