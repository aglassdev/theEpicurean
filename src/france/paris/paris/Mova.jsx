...
const Mova = () => (
  <RestaurantPage
    restaurantName="Mova"
    address="39 rue des Dames, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33145224607"
    website="https://www.mova-paris.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From a line-up of carefully selected seasonal ingredients (vegetables and fish), François Merle conjures up appetising, modern recipes, illustrated by a fresh, light starter of rillettes of seabream, celery pickles, coriander sorbet and fish eggs, whose distinctive flavours are exquisitely harmonious. Single set menu at lunchtime, tasting menu in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20rue%20des%20Dames%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Mova"
  />
);
