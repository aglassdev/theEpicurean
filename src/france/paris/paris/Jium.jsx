...
const Jium = () => (
  <RestaurantPage
    restaurantName="Jium"
    address="26 rue Tiphaine, Paris, 75015, France"
    cuisine="Korean"
    priceRange="€€"
    phoneNumber="+33145752000"
    website="https://www.jium.art/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a rather nondescript façade lies an authentic Korean canteen which boasts a lovely vintage vibe and is popular with a clientele from the land of the Morning Calm. It is the brainchild of photographer and guesthouse owner, Kim Hong-Seung, and his wife Sun-Hee, a former fashion designer. As well as bibimbap classics, the menu is packed with authentic delicacies (soft shell crabs, oyster fritters) and unusual recipes (seafood pancakes, kimchi stew, pork shoulder and tofu, etc). You can season these culinary delights with homemade soy sauce (or not) before finishing with a dessert, also homemade, illustrated by vanilla-flavoured rice pudding with red beans and caramelised pecan nuts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20rue%20Tiphaine%2C%20Paris%2C%2075015%2C%20France"
    pageTitle="Jium"
  />
);
