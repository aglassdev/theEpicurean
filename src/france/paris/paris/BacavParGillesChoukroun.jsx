...
const BacavParGillesChoukroun = () => (
  <RestaurantPage
    restaurantName="Baca'v par Gilles Choukroun"
    address="6 rue des Fossés-Saint-Marcel, Paris, 75005, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33147079125"
    website="https://www.bacav.paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Indulgence and good wine: Gilles Choukroun has taken his friend Émile Cotte's motto and made it his own! In the lively atmosphere of a Parisian bistro, he serves up his generous take on hearty bistro classics: marinated herring and potato salad; calf's head, tongue and brains in sauce ravigote; floating island with praline and crème anglaise… Appealing menu-carte on the blackboard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%20Foss%C3%A9s-Saint-Marcel%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Baca'v par Gilles Choukroun"
  />
);

export default BacavParGillesChoukroun;
