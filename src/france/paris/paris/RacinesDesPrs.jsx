...
const RacinesDesPrs = () => (
  <RestaurantPage
    restaurantName="Racines des Prés"
    address="1 rue de Gribeauval, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33145481416"
    website="https://www.racinesdespres.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant in Saint-Germain-des-Prés is always bustling! Open kitchen counter, laid-back but chic vintage atmosphere, and delicate cuisine that is beautifully presented on the plate. The menu features refined dishes, plus delicious desserts… You'll be coming back for more!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20de%20Gribeauval%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Racines des Prés"
  />
);

export default RacinesDesPrs;
