...
const Clamato = () => (
  <RestaurantPage
    restaurantName="Clamato"
    address="80 rue de Charonne, Paris, 75011, France"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33143727453"
    website="https://www.clamato-charonne.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inspired by the oyster bars of the East Coast of the United States, this outpost of Septime owes its name to a cocktail that is very popular in Quebec, a Bloody Mary of sorts with the addition of clam juice – needless to say, you can try one here! The place has all the makings of a bistronomy hit, with its trendy decor and short menu that puts fish and seafood and vegetables centre stage, and draws on international influences. The ingredients are chosen with great care and prepared as simply as possible, then presented in plates for sharing. Please note that reservations are not possible: first come, first served!..."
