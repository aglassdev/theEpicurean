...
const Zostera = () => (
  <RestaurantPage
    restaurantName="Zostera"
    address="40 rue Pergolèse, Paris, 75116, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33145002140"
    website="https://www.zostera.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a residential neighbourhood in the 16th arrondissement, Julien Dumas (previously of Lucas Carton and Bellefeuille - Saint James Paris) has set up shop in this elegant, tastefully decorated eatery, previously the fine dining restaurant Le Pergolèse. This talented chef's love of the Atlantic Ocean finds expression in flavoursome and remarkably delicate seafood cuisine (zostera is a seagrass). Tender Arctic char with butter and tansy, asparagus confit in wax, or premium hand-dived scallops simply seared: precise seasoning, accurate cooking and delicate combinations are testament to the full potential of meticulously sourced seafood. Supported by flawless technique, the menu also shines the spotlight on vegetables, the chef's other passion. Charming and attentive service...."
