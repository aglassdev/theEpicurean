...
const Capitaine = () => (
  <RestaurantPage
    restaurantName="Capitaine"
    address="4 impasse Guéménée, Paris, 75004, France"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+33144611176"
    website="https://www.restaurantcapitaine.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After working in the kitchens of some restaurants with a great pedigree (L'Ambroisie, L'Arpège, L'Astrance), Baptiste Day decided to open this pleasant bistro. Diners are treated to lovely market-fresh dishes that are inspired by his Breton origins and enhanced by exotic flavours. The popular starter of pork croquettes (ginger, garlic and chilli mayonnaise) will certainly whet your appetite! Selection of organic and natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20impasse%20Gu%C3%A9m%C3%A9n%C3%A9e%2C%20Paris%2C%2075004%2C%20France"
    pageTitle="Capitaine"
  />
);
