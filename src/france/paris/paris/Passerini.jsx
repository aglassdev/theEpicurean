...
const Passerini = () => (
  <RestaurantPage
    restaurantName="Passerini"
    address="65 rue Traversière, Paris, 75012, France"
    cuisine="Italian"
    priceRange="€€"
    ...
    bio="In his convivial restaurant, Giovanni Passerini treats us to tasty, carefully prepared Italian dishes, such as his trippa alla romana, which could hardly be bettered. Here, it's all about the produce and authenticity: sharing plates are a house speciality, as is Black-Headed Manech suckling lamb or whole pigeon in two courses. This place is very popular, so be sure to book!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=65%20rue%20Traversi%C3%A8re%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Passerini"
  />
);

export default Passerini;
