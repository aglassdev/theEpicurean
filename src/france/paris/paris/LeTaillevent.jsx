...
const LeTaillevent = () => (
  <RestaurantPage
    restaurantName="Le Taillevent"
    address="15 rue Lamennais, Paris, 75008, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33144951501"
    website="https://www.letaillevent.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This legendary establishment dating back to 1946 is the epitome of French classicism. Run by the Gardinier family (also owners of Les Crayères in Reims), Taillevent is nothing short of an institution. In the hushed and intimate setting of what used to be the Duke of Morny's private mansion (19C) you feel at a remove from the world outside. Chef Giuliano Sperandio (previously Christophe Pelé's sous-chef at Le Clarence) is now in charge in the kitchen. On the menu: turbot from small-scale fishing, chanterelles and summer truffles; Taillevent tradition langoustine boudin; and veal fillet à la ficelle, artichoke and periwinkles. The desserts are heavenly, especially the crêpes Suzette, flambéed first with Grand Marnier and then with Cognac. Last but not least, the superb wine list reads like a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20Lamennais%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Le Taillevent"
  />
);

export default LeTaillevent;
