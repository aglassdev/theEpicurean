...
const GuySavoy = () => (
  <RestaurantPage
    restaurantName="Guy Savoy"
    address="11 quai de Conti, Paris, 75006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33143804061"
    website="https://www.guysavoy.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the special occasion setting of the Hôtel de la Monnaie, Guy Savoy is continuing the story he began a few decades ago – back when, as a young boy, he would peek into the pans in the kitchen of his family's restaurant, La Buvette de l'Esplanade, in Bourgoin-Jallieu. Here, he has taken things to another level. Imagine six boutique dining rooms, whose windows overlook the Seine and Paris, adorned with contemporary art and sculpture (many loaned by François Pinault). The splendour of this iconic backdrop in no way distracts the chef from his daily mission, which is to pay tribute to French cuisine. It is always a delight to sample his terrine of poultry, foie gras and artichoke with a truffle dressing or his legendary raw-cooked lobster...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20quai%20de%20Conti%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Guy Savoy"
  />
);

export default GuySavoy;
