...
const Eels = () => (
  <RestaurantPage
    restaurantName="Eels"
    address="27 rue d'Hauteville, Paris, 75010, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142288020"
    website="https://www.restaurant-eels.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Eels, the dishes flirt with bistronomie, and some of them focus on eel (the clue is in the name). The young chef, Adrien Ferrand, already has considerable experience under his belt (six years for William Ledeuil, first at Ze Kitchen Galerie, then KGB). And now he has a place of his own. A success!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20d'Hauteville%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Eels"
  />
);
