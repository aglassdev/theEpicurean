...
const LeSavarin = () => (
  <RestaurantPage
    restaurantName="Le Savarin"
    address="4 rue de Navarin, Paris, 75009, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33142811100"
    website="https://www.lapantruchoise.com/lesavarin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its unpretentious, slightly weathered decor, this bistro, which is part of Franck Baranger's La Pantruchoise restaurant group, nails the classic bistro vibe. The straightforward cuisine is grounded in the classic French repertoire – pâté en croûte, tripe in white wine, hand-cut beef tartare with fries and sucrine lettuce – but also allows for more personal, creative ventures, like their seafood vol-au-vent with monkfish. This particular lunchtime, the meal kicked off with fresh crab cannelloni with a tom kha kai sauce, followed by a tasty meat-free pot-au-feu, topped with a quenelle of mustard cream, and a light and generous praline floating island to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20de%20Navarin%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Le Savarin"
  />
);

export default LeSavarin;
