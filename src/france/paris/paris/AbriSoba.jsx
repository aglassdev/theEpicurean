...
const AbriSoba = () => (
  <RestaurantPage
    restaurantName="Abri Soba"
    address="10 rue Saulnier, Paris, 75009, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33183921411"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/abri-soba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You have probably heard of soba: Japanese noodles made from buckwheat. They are the specialty of this eatery and are dished up noon and evening in an amazing variety of preparations: hot, cold, in stock or with finely sliced beef. Splendid lineup of dishes to share in the evenings (mirin-boshi (dried) mackerel, karaage chicken, tonkatsu, sashimi, etc.). Good, simple food – so get out your chopsticks! No bookings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Saulnier%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Abri Soba"
  />
);

export default AbriSoba;
