...
const DesTerres = () => (
  <RestaurantPage
    restaurantName="Des Terres"
    address="82 rue Alexandre-Dumas, Paris, 75020, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33143484249"
    website="https://www.instagram.com/desterres.paris/?hl=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A buzzy casual vibe depicts this neighbourhood bistro in the 20th arrondissement of Paris. In the company of natural wines displayed on a bookshelf, you will joyfully do justice to the chef’s competently crafted fare: cauliflower in a herring, hazelnut and green oil sauce; roast beetroot, Colonnata pork and creamy goat’s cheese. Seasonal nosh and a bargain-priced lunch menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20rue%20Alexandre-Dumas%2C%20Paris%2C%2075020%2C%20France"
    pageTitle="Des Terres"
  />
);

export default DesTerres;
