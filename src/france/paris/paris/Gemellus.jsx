...
const Gemellus = () => (
  <RestaurantPage
    restaurantName="Gemellus"
    address="37 avenue Duquesne, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33145558757"
    website="https://gemellus-restaurant.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spruce, modern eatery done up in oatmeal shades features a square dining room with painted mouldings, a coffered ceiling, an imposing chandelier and upholstered velvet seats. Chef Maxime Le Meur, who trained with some of the greats, leaves nothing to chance as he crafts cuisine inspired as much by seasonal ingredients as by his Breton (check out the surf ‘n turf dish of Breton squab with lobster) and Grenoble roots (Chartreuse liqueur is never far from the culinary score). A festival of forthright, meticulous flavours overflowing in creative ideas. Affordable lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20avenue%20Duquesne%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Gemellus"
  />
);

export default Gemellus;
