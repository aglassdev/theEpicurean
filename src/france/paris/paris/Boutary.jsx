...
const Boutary = () => (
  <RestaurantPage
    ...
    address="25 rue Mazarine, Paris, 75006, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33143436910"
    website="https://www.boutary-restaurant.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20rue%20Mazarine%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Boutary"
  />
);

export default Boutary;
