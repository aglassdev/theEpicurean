...
const TsiLeBistro = () => (
  <RestaurantPage
    restaurantName="étsi - le bistro"
    address="23 rue Eugène-Carrière, Paris, 75018, France"
    cuisine="Greek"
    priceRange="€€"
    phoneNumber="+33171500080"
    website="https://www.etsi-paris.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mikaela Liaroutsos, a young chef of Greek origin, has returned to the cuisine of her childhood, after learning the ropes in some prestigious establishments. She rolls out strikingly fresh mezze designed for sharing – marinated sea bream, capers, Aleppo pepper and some first-rate scallops with pistachio butter, mizithra cheese and tarragon. The feta, olives, capers, charcuterie, cheese, olive oil and wines – all imported directly from Greece – are enjoyed in a relaxed space...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20Eug%C3%A8ne-Carri%C3%A8re%2C%20Paris%2C%2075018%2C%20France"
    pageTitle="étsi - le bistro"
  />
);

export default TsiLeBistro;
