...
const Lagrume = () => (
  <RestaurantPage
    restaurantName="L'Agrume"
    address="15 rue des Fossés-Saint-Marcel, Paris, 75005, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33143318648"
    website="https://restaurant-lagrume.fr/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the open kitchen of this bistro, the chef delicately crafts refreshingly wholesome dishes, such as poultry in vin jaune paired with asparagus or a piece of roast turbot with mashed potatoes and poultry jus. Flawlessly fresh produce is the name of the game (the fish comes from Brittany and the fruit and vegetables from the very best suppliers). Tasting menu in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20des%20Foss%C3%A9s-Saint-Marcel%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="L'Agrume"
  />
);

export default Lagrume;
