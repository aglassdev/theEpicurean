...
const Lazare = () => (
  <RestaurantPage
    ...
    priceRange="€€"
    phoneNumber="+33144908080"
    website="https://lazare-paris.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the famous Gare St - Lazare is this elegant railway brasserie, version 2013. It is the brainchild of Éric Frechon, who respects the canons of the genre: French - style devilled eggs, pike quenelles or mackerel in a white wine sauce. Fine French tradition is right on track! Pleasant and very lively...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Parvis%20de%20la%20gare%20Saint-Lazare%2C%20rue%20Int%C3%A9rieure%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Lazare"
  />
);

export default Lazare;
