...
const Substance = () => (
  <RestaurantPage
    restaurantName="Substance"
    address="18 rue de Chaillot, Paris, 75016, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33147200890"
    website="https://www.substance.paris/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Matthias Marc, a chef who honed his skills in prestigious eateries (Le Saint-James in Bouliac, Le Meurice and Lasserre in Paris) and who also took part in France’s Top Chef TV show, serves a surprise menu that favours short supply chains and sticks close to the seasons, together with nods to his native Jura. Unorthodox, vibrant cooking with a creative streak and a weakness for vegetables, together with low-sugar desserts in a modern vein. A terrific list of mostly organic or natural wines. What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20de%20Chaillot%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Substance"
  />
);
