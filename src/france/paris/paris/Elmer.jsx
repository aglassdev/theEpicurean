...
const Elmer = () => (
  <RestaurantPage
    restaurantName="Elmer"
    address="30 rue Notre-Dame-de-Nazareth, Paris, 75003, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33143562295"
    website="https://www.elmer-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to République, this terribly chic bistro is officiated by a chef with an impressive career (including L'Oustau de Baumanière, Pierre Gagnaire, travels in Asia and Latin America). He composes a flavoursome menu that packs a punch, with fine meats cooked on embers or on the rotisserie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20rue%20Notre-Dame-de-Nazareth%2C%20Paris%2C%2075003%2C%20France"
    pageTitle="Elmer"
  />
);
