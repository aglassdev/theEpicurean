...
const Fana = () => (
  <RestaurantPage
    restaurantName="Fana"
    address="14 rue Ferdinand-Flocon, Paris, 75018, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33986378077"
    website="https://www.fanabistro.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is clear to see that chef Gabriel Gras Fernandez and pastry chef Jorice Sardain are passionate about food. In their compact restaurant on a pedestrian street in Montmartre (where more and more interesting restaurants are popping up), they work in tandem to create their clever take on seasonal cuisine in the from of carefully crafted dishes: oyster mushrooms, coffee sabayon, parsley, brioche; corn-fed chicken, butternut squash, endive, orange; and a stunning chocolate dessert with an array of textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20rue%20Ferdinand-Flocon%2C%20Paris%2C%2075018%2C%20France"
    pageTitle="Fana"
  />
);
