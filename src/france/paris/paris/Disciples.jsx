...
const Disciples = () => (
  <RestaurantPage
    restaurantName="Disciples"
    address="136 boulevard Murat, Paris, 75016, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33145273960"
    website="https://disciples.paris"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Jean-Pierre Vigato has lost nothing of his passion for passing on his knowledge. Indeed, in this bright, contemporary dining space that is in keeping with the chic neighbourhood, he has dubbed Romain Dubuisson his disciple. On the agenda, a short menu of generous and tasty cuisine, specials and fine pieces of meat for sharing (e.g. veal chop, farmhouse pork loin)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=136%20boulevard%20Murat%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Disciples"
  />
);
