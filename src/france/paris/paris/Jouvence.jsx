...
const Jouvence = () => (
  <RestaurantPage
    restaurantName="Jouvence"
    address="172 bis rue du Faubourg-Saint-Antoine, Paris, 75012, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33156580473"
    website="https://www.jouvence.paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from rue de Cîteaux, this restaurant in an apothecary-style shop dating back to the 1900s is not merely aesthetically pleasing. It serves modern cuisine packed with quality ingredients: scallop ceviche, fine Angus beef entrecôte… The chef knows how to draw out flavours with a generous touch, and the service is attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=172%20bis%20rue%20du%20Faubourg-Saint-Antoine%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Jouvence"
  />
);

export default Jouvence;
