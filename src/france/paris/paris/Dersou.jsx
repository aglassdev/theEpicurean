...
const Dersou = () => (
  <RestaurantPage
    restaurantName="Dersou"
    address="21 rue Saint-Nicolas, Paris, 75012, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33981011273"
    website="https://www.dersouparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a pleasant side street near Bastille, Dersou proposes the original experience of pairing food and cocktails in a trendy atmosphere complete with music. A dish of leeks with a coarse grain mustard cream and sorrel vinaigrette is accompanied by a dill, yuzu, gin and Granny Smith apple cocktail; guinea fowl with tangy beetroot puree is paired with a whisky, port and orange cocktail judiciously. The ingredients are top quality and the mixology does not disappoint...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20Saint-Nicolas%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Dersou"
  />
);

export default Dersou;
