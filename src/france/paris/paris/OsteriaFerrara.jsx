...
const OsteriaFerrara = () => (
  <RestaurantPage
    restaurantName="Osteria Ferrara"
    address="7 rue du Dahomey, Paris, 75011, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33143716769"
    website="https://www.osteriaferrara.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Foodies can come here safe in the knowledge that they have found sanctuary in this elegant interior where the culinary magic happens. Sicilian chef Fabrizio Ferrara builds a menu of tasty and well-crafted ingredient-led Italian recipes, such as carpaccio of lean meat, puntarelle and Sicilian citron, or ravioli stuffed with Castelmagno cheese and potatoes. This bistro has soul, and an appealing wine list to boot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Dahomey%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Osteria Ferrara"
  />
);

export default OsteriaFerrara;
