...
const LeBonSaintpourain = () => (
  <RestaurantPage
    restaurantName="Le Bon Saint-Pourçain"
    address="10 bis rue Servandoni, Paris, 75006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142017824"
    website="https://www.bonsaintpourcain.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away behind St Sulpice church in the heart of the high - brow Saint Germain des Prés district, this former 'bougnat' restaurant reopened in the spring of 2015. Bistro traditions with a modern twist depict the delicious food – doubtless due to the high quality fresh produce. Booking advisable!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20bis%20rue%20Servandoni%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Le Bon Saint-Pourçain"
  />
);

export default LeBonSaintpourain;
