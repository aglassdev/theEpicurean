...
const BeurreNoisette = () => (
  <RestaurantPage
    restaurantName="Beurre Noisette"
    address="68 rue Vasco-de-Gama, Paris, 75015, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33148568249"
    website="https://www.restaurantbeurrenoisette.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bistro in which flavours flow thick and fast, and with a loyal following of regulars! Thierry Blanqui finds inspiration in the market stalls to come up with delicious dishes such as carpaccio of calf's head, lentil ravigote; caramelised pork belly, braised red cabbage; or the classic amber rum baba with a light vanilla cream! Straddling the traditional and the new, this place is always a good bet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20rue%20Vasco-de-Gama%2C%20Paris%2C%2075015%2C%20France"
    pageTitle="Beurre Noisette"
  />
);

export default BeurreNoisette;
