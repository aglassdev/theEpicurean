...
const LardoisePAR = () => (
  <RestaurantPage
    ...
    address="28 rue du Mont-Thabor, Paris, 75001, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33142962818"
    website="https://lardoise-paris.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, whose walls are covered in slate, wears its name well! It pays a pleasing tribute to bistro heritage by means of its style and also its food – chicken pâté en croûte, foie gras and ceps; fillet of beef with black pepper and pommes Anna; lemon meringue tartlet; crème brûlée – a feast of generous, fresh and tasty dishes!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20rue%20du%20Mont-Thabor%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="L'Ardoise"
  />
);

export default LardoisePAR;
