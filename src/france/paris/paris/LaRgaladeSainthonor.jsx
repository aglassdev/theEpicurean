...
const LaRgaladeSainthonor = () => (
  <RestaurantPage
    restaurantName="La Régalade Saint-Honoré"
    address="106 rue Saint-Honoré, Paris, 75001, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33142219240"
    website="https://laregalade.paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bruno Doucet regales foodies in the Halles neighbourhood with dishes that sing an ode to fresh market and country produce. After titillating your tastebuds with the chef's delicious terrine, dig into pan-fried snails, mushrooms and chorizo, followed by braised chuck steak with a bourguignon garnish or the “famous” rice pudding with a dairy caramel. Fine wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=106%20rue%20Saint-Honor%C3%A9%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="La Régalade Saint-Honoré"
  />
);

export default LaRgaladeSainthonor;
