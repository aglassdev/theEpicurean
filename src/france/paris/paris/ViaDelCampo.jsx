...
const ViaDelCampo = () => (
  <RestaurantPage
    restaurantName="Via del Campo"
    address="22 rue du Champ-de-Mars, Paris, 75007, France"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+33145516459"
    website="https://www.via-del-campo.paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Authentic Italian cuisine is not as easy to come by in France as one might expect. Thankfully there is this contemporary trattoria, which also boasts a few tables on the verdant pavement terrace in fine weather. Chef Enrico Masia whisks diners off on a culinary voyage that takes in every region of Italy; the traditional fare of Sardinia, his birthplace, inspires the lion's share of dishes. Regulars eagerly consult the daily menu, which is devised in line with the food markets and the chef's inspiration on the day. You can expect dishes such as crunchy puntarella finished with an anchovy sauce, Venetian-style calf liver, and clam paccheri with fresh artichokes and shredded bottarga. Tatiana, the chef's partner, runs the show front of house, providing discreet and efficient service that incl..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20rue%20du%20Champ-de-Mars%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Via del Campo"
  />
);

export default ViaDelCampo;
