...
const FaubourgDaimant = () => (
  <RestaurantPage
    restaurantName="Faubourg Daimant"
    address="20 rue du Faubourg-Poissonnière, Paris, 75010, France"
    cuisine="Vegan"
    priceRange="€€"
    phoneNumber="+33788097348"
    website="https://www.daimant.co/faubourg-daimant.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro has joined the ranks of bistronomy restaurants lining this street familiar to foodies. In a simple interior, the focus is on indulgent vegan cuisine that defies diktats and is designed for sharing. The idea behind this venture is to bring together fine dining and plant-based cuisine by drawing inspiration from France's bourgeois culinary traditions: chou farci (stuffed cabbage), sauceboat of jus, croquettes, Puy lentil pâté, glazed king trumpet mushrooms... The gamble more than pays off, as the absence of butter and cream is soon forgotten, thanks to generous sauces and daring combinations in which the full palette of vegetable flavours is on display...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20du%20Faubourg-Poissonni%C3%A8re%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Faubourg Daimant"
  />
);

export default FaubourgDaimant;
