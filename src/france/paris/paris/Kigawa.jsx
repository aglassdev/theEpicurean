...
const Kigawa = () => (
  <RestaurantPage
    restaurantName="Kigawa"
    address="186 rue du Château, Paris, 75014, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33143353161"
    website="https://www.kigawa.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kigawa is named after Michihiro Kigawa, the chef at this refreshingly simple restaurant. Buoyed by his experience in a French restaurant in Osaka, he now finds himself in Paris, delighting guests with classic French dishes such as pâté en croûte and roast pigeon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=186%20rue%20du%20Ch%C3%A2teau%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="Kigawa"
  />
);

export default Kigawa;
