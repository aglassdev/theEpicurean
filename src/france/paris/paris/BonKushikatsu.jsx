...
const BonKushikatsu = () => (
  <RestaurantPage
    restaurantName="Bon Kushikatsu"
    address="24 rue Jean-Pierre-Timbaud, Paris, 75011, France"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+33143388227"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/bon-kushikatsu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is an express trip to Osaka to discover the city's culinary speciality of kushikatsu (meat, vegetables or seafood skewers coated with breadcrumbs and deep - fried). Dish after dish reveals fine flavours, such as: beef sancho, peppered foie gras, and shiitake mushrooms. The courteous service transports you to Japan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20Jean-Pierre-Timbaud%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Bon Kushikatsu"
  />
);

export default BonKushikatsu;
