...
const TsiLouzeri = () => (
  <RestaurantPage
    restaurantName="étsi - l'ouzeri"
    address="41 rue du Ruisseau, Paris, 75018, France"
    cuisine="Greek"
    priceRange="€€"
    phoneNumber="+33973882417"
    website="http://www.etsi-paris.fr/l-ouzeri"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Saganaki cheese, gyro merida, myzithropita (cheesecake), spanakopita – the menu gives it away: this is French-Greek chef Mikaela Liaroutsos's new Greek taverna, and it's just a stone's throw from the original restaurant that made her name. The food is served as a series of mezes, to savour as you dream of Greek holidays, past or future. The traditional songs playing in the background might tempt you to pull out a sirtaki step after a glass of ouzo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20rue%20du%20Ruisseau%2C%20Paris%2C%2075018%2C%20France"
    pageTitle="étsi - l'ouzeri"
  />
);

export default TsiLouzeri;
