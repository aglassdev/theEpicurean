...
const LesRsistantsLaTable = () => (
  <RestaurantPage
    restaurantName="Les Résistants - La Table"
    address="7 rue de la Fidélité, Paris, 75010, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33981410107"
    website="https://www.lesresistants-latable.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This new restaurant has been opened by the owners of Les Résistants, enthusiastic advocates of small-scale farming. On the menu: meats from local breeds, seafood from small boat fishing and, to wash it all down, a selection of living wines sourced from 150 producers. The natural decor reflects their philosophy: raw materials, wood, stone and glass panes that let light stream in, and a predominantly green colour scheme. The chef delivers modern, instinctive dishes that make the most of seasonal ingredients, such as his starter of agnolotti del plin, lamb ragout and apricot confit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20de%20la%20Fid%C3%A9lit%C3%A9%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Les Résistants - La Table"
  />
);

export default LesRsistantsLaTable;
