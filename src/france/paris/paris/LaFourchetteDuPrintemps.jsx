...
const LaFourchetteDuPrintemps = () => (
  <RestaurantPage
    restaurantName="La Fourchette du Printemps"
    address="30 rue du Printemps, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142272697"
    website="https://lafourchetteduprintemps.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this elegant little neighbourhood bistro, the young chef has come through some top establishments. He hones the taste of quality ingredients (the menu evolves according to the market), and takes pleasure in revisiting the classics. A good place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20rue%20du%20Printemps%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="La Fourchette du Printemps"
  />
);

export default LaFourchetteDuPrintemps;
