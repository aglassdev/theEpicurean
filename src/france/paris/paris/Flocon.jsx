...
const Flocon = () => (
  <RestaurantPage
    restaurantName="Flocon"
    address="75 rue Mouffetard, Paris, 75005, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33147071929"
    website="https://www.restaurantflocon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a lively neighbourhood, the Flocon brothers’ eatery is depicted by a warm welcome, a buzzy vibe and a Scandinavian-ish interior. The mouthwatering score is seasonal and often demonstrates a plant-based edge: burnt leeks, lardo di Colonnata, onion pickles and a vermouth dressing; cabbage stuffed with fish, pistachio beurre blanc, cockles and Brussel sprouts. Handsome cuts of meat to be shared set the scene in the evening menu: Normandy beef tomahawk steak. On top of all that, everything is sensibly priced, including the wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75%20rue%20Mouffetard%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Flocon"
  />
);
