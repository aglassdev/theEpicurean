...
const AubergePyrnesCvennes = () => (
  <RestaurantPage
    restaurantName="Auberge Pyrénées Cévennes"
    address="106 rue de la Folie-Méricourt, Paris, 75011, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33143573378"
    website="https://www.auberge-pyrenees-cevennes.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily closed) Chef Pierre Négrevergne is really flourishing in this house that is over 100 years old. He delights diners with his tasty grandmother's cooking, which highlights French gastronomic heritage (home-made terrine, blanquette de veau à l'ancienne and grilled rice, millefeuille), served in generous portions. It is still a treat to eat here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=106%20rue%20de%20la%20Folie-M%C3%A9ricourt%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Auberge Pyrénées Cévennes"
  />
);

export default AubergePyrnesCvennes;
