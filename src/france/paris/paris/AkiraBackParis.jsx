...
const AkiraBackParis = () => (
  <RestaurantPage
    restaurantName="Akira Back Paris"
    address="Prince de Galles, 33 avenue George-V, Paris, 75008, France"
    cuisine="Japanese, Fusion"
    priceRange="€€€€"
    phoneNumber="+33153237850"
    website="https://www.akirabackparis.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Prince de Galles hotel, this is the first European restaurant of American-Korean chef Akira Back. After a career as a professional snowboarder (he grew up in Aspen, home to the legendary ski resort), he turned his hand to cooking. He was recruited by Nobuyuki Matsuhisa and later became the executive chef at the renowned chef's restaurant. Diners are given the opportunity to taste this new take on Japanese cuisine, a real melting pot of cultures and flavours, including Back's speciality: AB Tuna Pizza. Meanwhile, feast your eyes on the sumptuous decor of this large modern restaurant with Art Deco light fixtures emitting subdued lighting, while the kitchen team busy themselves at the marble counter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Prince%20de%20Galles%2C%2033%20avenue%20George-V%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Akira Back Paris"
  />
);

export default AkiraBackParis;
