...
const Sormani = () => (
  <RestaurantPage
    restaurantName="Sormani"
    address="4 rue du Général-Lanrezac, Paris, 75017, France"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+33143801391"
    website="https://www.sormanirestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Italian restaurant has an opulent feel, with its Murano glass chandeliers, mouldings and mirrors, and is popular with Paris's celebrities. The cooking pays tribute to Italian specialities, with spaghetti alle vongole and Calabrian chilli, for example, or iconic desserts such as the gigantesco – Italian-style vanilla ice cream frozen to order on site, served with meringue, nougatine and liquid caramel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20rue%20du%20G%C3%A9n%C3%A9ral-Lanrezac%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Sormani"
  />
);

export default Sormani;
