...
const Ptrelle = () => (
  <RestaurantPage
    restaurantName="Pétrelle"
    address="34 rue Pétrelle, Paris, 75009, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+33142821102"
    website="https://www.petrelle.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Lucie Boursier-Mougenot and sommelier Luca Danti, formerly at Caves Legrand, have revamped this restaurant once frequented by celebrities. In a romantic and intimate boudoir setting that is decorated with flea-market pieces, the chef serves lovely, delicate and healthy market-fresh cuisine with strong Mediterranean influences. Good wine cellar with over 150 references, for all budgets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20rue%20P%C3%A9trelle%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Pétrelle"
  />
);

export default Ptrelle;
