...
const Taokan = () => (
  <RestaurantPage
    restaurantName="Taokan"
    address="8 rue du Sabot, Paris, 75006, France"
    cuisine="Chinese"
    priceRange="€€"
    phoneNumber="+33142841836"
    website="https://www.taokan.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come inside this pretty restaurant in the heart of St-Germain-des-Prés to enjoy light and fragrant Cantonese cuisine, with a few detours to the territory of Southeast Asia: the obligatory dim sum, steamed fish, spicy beef or lok lak. Lovely presentation and good ingredients: a real ambassador for Chinese food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20du%20Sabot%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Taokan"
  />
);

export default Taokan;
