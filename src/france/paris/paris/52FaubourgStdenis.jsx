...
const FiveTwoFaubourgStdenis = () => (
  <RestaurantPage
    restaurantName="52 Faubourg St-Denis"
    address="52 rue du Faubourg-Saint-Denis, Paris, 75010, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33148009588"
    website="https://www.faubourgstdenis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fans of neo-bistro aesthetics will love this place done out in bare concrete and exposed stone, where diners tuck into cuisine infused with Asian flavours, as well as time-honoured bistro classics such as pâté de campagne (rustic-style pâté) or leeks in vinaigrette. The food is nicely washed down with fine wines or craft beer, and you can round off your meal with coffee selected and roasted by the owner. Please note: no reservations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20rue%20du%20Faubourg-Saint-Denis%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="52 Faubourg St-Denis"
  />
);

export default FiveTwoFaubourgStdenis;
