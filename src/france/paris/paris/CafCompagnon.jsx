...
const CafCompagnon = () => (
  <RestaurantPage
    restaurantName="Café Compagnon"
    address="22-26 rue Léopold-Bellan, Paris, 75002, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33977096224"
    website="https://cafecompagnon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After Richer and 52 Faubourg, Charles Compagnon, restaurant owner, sommelier and coffee roaster, strikes again! This cafe offers an extensive menu ranging from nibbles to share to home-made ices. The original, deftly crafted recipes feature a modern bistro slant, depicted by market-fresh starters and succulent loin of pork. Heart-warming, authentic comfort food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22-26%20rue%20L%C3%A9opold-Bellan%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Café Compagnon"
  />
);

export default CafCompagnon;
