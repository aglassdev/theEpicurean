...
const Lescudella = () => (
  <RestaurantPage
    restaurantName="L'Escudella"
    address="41 avenue de Ségur, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33982287070"
    website="https://www.escudella.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'Escudella is, aptly enough, plate in Occitan! Paul-Arthur Berlan, the young chef, has worked in some prestigious establishments (Michel Sarran, Yannick Alléno). Here, he marries produce from the terroir of the Greater Paris area with the flavours of Languedoc. With fresh, high-quality ingredients and well-crafted dishes, he hits the mark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20avenue%20de%20S%C3%A9gur%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="L'Escudella"
  />
);

export default Lescudella;
