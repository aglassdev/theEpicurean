...
const ChezMonsieur = () => (
  <RestaurantPage
    restaurantName="Chez Monsieur"
    address="11 rue du Chevalier-de-Saint-George, Paris, 75008, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33142601436"
    website="https://www.chezmonsieur.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Parisian bistro in all its splendour (zinc countertop, velvet-upholstered wall seats, patterned tiles), with the immutable – and delicious! – cuisine that goes with it: Burgundy snails with white butter sauce, veal blanquette served in a casserole dish, not to mention a wide selection of wines from all over France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20du%20Chevalier-de-Saint-George%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Chez Monsieur"
  />
);

export default ChezMonsieur;
