...
const Laitcha = () => (
  <RestaurantPage
    restaurantName="Lai'Tcha"
    address="7 rue du Jour, Paris, 75001, France"
    cuisine="Asian"
    priceRange="€"
    phoneNumber="+33140260505"
    website="https://www.yamtcha.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This minimalist restaurant, an outpost of the famous Yam'Tcha, stands at the foot of Église St-Eustache. It serves simple and fragrant Chinese cuisine made with carefully selected seasonal ingredients. The concise menu features dim sum and bao with bold flavours, at affordable prices. Don't miss the Imperial beef stir-fry or the delicious fresh house-made noodles with minced pork, peanuts and Sichuan pepper. Home-cooked cuisine that takes you on a journey, for an interlude of exotic culinary pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Jour%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Lai'Tcha"
  />
);

export default Laitcha;
