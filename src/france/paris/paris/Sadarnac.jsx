...
const Sadarnac = () => (
  <RestaurantPage
    restaurantName="Sadarnac"
    address="17 rue Saint-Blaise, Paris, 75020, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33172607206"
    website="https://www.restaurantsadarnac.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny restaurant is located in a semi-pedestrian street with a village feel in the heart of the 20th arrondissement. In the spruce little dining room, tuck into surprise menus concocted with market ingredients by youthful Lise Deveix. Welcoming, well-run establishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20Saint-Blaise%2C%20Paris%2C%2075020%2C%20France"
    pageTitle="Sadarnac"
  />
);

export default Sadarnac;
