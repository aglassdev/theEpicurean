...
const Les110DeTaillevent = () => (
  <RestaurantPage
    restaurantName="Les 110 de Taillevent"
    address="195 rue du Faubourg-Saint-Honoré, Paris, 75008, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33140742020"
    website="https://www.les-110-taillevent-paris.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the aegis of the prestigious Taillevent name, this ultra - chic brasserie puts the onus on food and wine pairings. The concept is a success, with its remarkable choice of 110 wines by the glass, and nicely done traditional food (pâté en croûte, bavette steak with a peppercorn sauce etc). Elegant and inviting decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=195%20rue%20du%20Faubourg-Saint-Honor%C3%A9%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Les 110 de Taillevent"
  />
);

export default Les110DeTaillevent;
