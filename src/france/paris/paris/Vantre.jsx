...
const Vantre = () => (
  <RestaurantPage
    restaurantName="Vantre"
    address="19 rue de la Fontaine-au-Roi, Paris, 75011, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33148061696"
    website="https://www.vantre.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In France in the Middle Ages, a vantre was a place of enjoyment, and indeed that's certainly still the case here today. In a neo-bistro interior, a former sommelier (Le Bristol, Le Taillevent) and his chef serve fine dining cuisine prepared using carefully selected ingredients. Every dish looks and tastes terrific, a case in point being the roast sea bass with marinière sauce and samphire, presented vertically. Over 3 000 wines… and well-deserved success...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20de%20la%20Fontaine-au-Roi%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Vantre"
  />
);

export default Vantre;
