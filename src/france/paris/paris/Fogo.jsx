...
const Fogo = () => (
  <RestaurantPage
    ...
    website="https://www.fogoparis.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his open kitchen – part of a meticulously appointed decor composed principally of premium and natural materials (such as veined marble, wood and stone) – the chef joyously sets about cooking on a charcoal grill. The resulting dishes are generous, spicy and vibrant...."
