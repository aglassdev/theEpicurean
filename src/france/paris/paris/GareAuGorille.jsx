...
const GareAuGorille = () => (
  <RestaurantPage
    restaurantName="Gare au Gorille"
    address="68 rue des Dames, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33142942402"
    website="https://gareaugorille.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Marc Cordonnier has now found his niche in the Batignolles neighbourhood. He knows how to prepare ingredients without subverting their essence, and devises bold, unfussy and original cooking with more personality than posturing. Meanwhile, his acolyte, Louis Langevin, is a benevolent mine of information on a fine array of natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20rue%20des%20Dames%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Gare au Gorille"
  />
);

export default GareAuGorille;
