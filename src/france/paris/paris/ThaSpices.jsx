...
const ThaSpices = () => (
  <RestaurantPage
    restaurantName="Thaï Spices"
    address="5-7 rue de l'Ave-Maria, Paris, 75004, France"
    cuisine="Thai"
    priceRange="€€"
    phoneNumber="+33142786549"
    website="https://www.thaispices.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Between Quai des Célestins and the village of Saint-Paul, this restaurant is run by Willy Lieu, who was once Jacques Chirac's personal chef! Now his own boss, he serves up a short menu of authentic Thai cuisine, including generous and flavoursome classics such as pad thai and tom yam. Prices remain reasonable; good service. It is a popular haunt for local residents on account of its friendly, unpretentious atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-7%20rue%20de%20l'Ave-Maria%2C%20Paris%2C%2075004%2C%20France"
    pageTitle="Thaï Spices"
  />
);

export default ThaSpices;
