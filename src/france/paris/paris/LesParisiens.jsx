...
const LesParisiens = () => (
  <RestaurantPage
    restaurantName="Les Parisiens"
    address="1 rue du Pré-aux-Clercs, Paris, 75007, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33142966543"
    website="https://pavillon-faubourg-saint-germain.com/restaurant-les-parisiens"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside a new luxury hotel located in Faubourg-Saint-Germain, this restaurant adopts all the codes of the luxury brasserie genre. Wood panelling, large mirrors, mosaic floors, velvet banquettes, gilding, black marble tables: it is elegant, slightly retro and very cosy – a winning formula. Curated by Thibault Sombardier, the menu represents a refreshed and updated take on tradition. A fine and eclectic wine list, complete with some great bottles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20du%20Pr%C3%A9-aux-Clercs%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Les Parisiens"
  />
);

export default LesParisiens;
