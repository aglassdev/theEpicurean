...
const PierreGagnaire = () => (
  <RestaurantPage
    restaurantName="Pierre Gagnaire"
    address="6 rue Balzac, Paris, 75008, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33158361250"
    website="https://pierregagnaire-lerestaurant.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Balzac%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Pierre Gagnaire"
  />
);

export default PierreGagnaire;
