...
const ToscaPAR = () => (
  <RestaurantPage
    ...
    address="18 rue du Cirque, Paris, 75008, France"
    cuisine="Italian"
    priceRange="€€€"
    ...
    bio="Italy seems to have converged on this small-capacity, smartly furnished restaurant. The food is an ode to Italian gastronomy, showcasing its meat, olive oil, cheese… Classical at lunchtime, more elaborate, and often inspired, at dinner. The Splendide Royal Hotel (formerly Pierre Cardin’s home) offers swish, elegant suites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20du%20Cirque%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Tosca"
  />
);

export default ToscaPAR;
