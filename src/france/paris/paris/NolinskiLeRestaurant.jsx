...
const NolinskiLeRestaurant = () => (
  <RestaurantPage
    restaurantName="Nolinski Le Restaurant"
    address="16 avenue de l'Opéra, Paris, 75001, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33142861010"
    website="https://nolinskiparis-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Avenue de l'Opéra, near the Comédie Française, a chic brasserie whose vintage interior mixes Art Deco and the 1970s, with mirrors, gilding, yellow marble and corduroy upholstering. The culinary is big-boned and Gallic down to its core (pot au feu, poultry and sweetbread vol au vent, veal cutlet with morels)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20avenue%20de%20l'Op%C3%A9ra%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Nolinski Le Restaurant"
  />
);

export default NolinskiLeRestaurant;
