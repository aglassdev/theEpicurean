...
const PierreSangInOberkampf = () => (
  <RestaurantPage
    ...
    website="https://pierresang.com/in-oberkampf/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pierre Sang was a finalist in the 2011 Top Chef French TV show. As amiable as ever, we find him here deftly crafting delicate food designed to be shared and often dotted with Korean influences. The sensibly priced menus change regularly. We recommend taking a seat at the counter overlooking the open kitchen to make the most of the show!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20rue%20Oberkampf%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Pierre Sang in Oberkampf"
  />
);

export default PierreSangInOberkampf;
