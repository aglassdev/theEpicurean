...
const MonsieurBleu = () => (
  <RestaurantPage
    restaurantName="Monsieur Bleu"
    address="20 avenue de New-York, Paris, 75016, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33147209047"
    website="https://monsieurbleu-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a location in Paris, it would be hard to do better than this address... Nestled in the Palais de Tokyo, it is superb with its Art Deco interior in a palette of grey, green and gold, and its terrace looking out over the Seine and the Eiffel Tower. Not to be outdone by the setting, the food is sophisticated and tasty. A very high - profile place!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20avenue%20de%20New-York%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Monsieur Bleu"
  />
);

export default MonsieurBleu;
