...
const Auguste = () => (
  <RestaurantPage
    restaurantName="Auguste"
    address="54 rue de Bourgogne, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33145516109"
    website="https://www.restaurantauguste.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In Gaël Orieux's compact restaurant – seating barely 30 people – the elegant contemporary interior with deceptively sleek lines exudes an unexpected calm. It's a chic and refined place in which to enjoy technically sound modern cuisine: tetragon soup with herbs, frogs' legs and smoked eel; scallops, oyster mushrooms and grape pulp, chestnut broth espresso and black truffle; crispy sweetbreads with peanuts, chanterelles with dried apricots and Jura wine. With the courage of his convictions, Gaël Orieux sources his ingredients from the market and only serves fish that are not endangered (black mullet, meagre, pout). The varied and carefully selected wine list offers the opportunity to try something new, all the more of a boon when wines by the glass come from magnums for superior quality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20rue%20de%20Bourgogne%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Auguste"
  />
);
