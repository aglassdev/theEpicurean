...
const LeBaratin = () => (
  <RestaurantPage
    restaurantName="Le Baratin"
    address="3 rue Jouye-Rouve, Paris, 75020, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33143493970"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/le-baratin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Argentine chef Raquel Carena pretty much invented bistronomy, as many young chefs acknowledge. This stripped-down, retro bistro serves food that is delicate or hearty, but always personal. The blackboard menu makes pleasant reading, the prices are restrained and the wines appealing. Reservations strongly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Jouye-Rouve%2C%20Paris%2C%2075020%2C%20France"
    pageTitle="Le Baratin"
  />
);

export default LeBaratin;
