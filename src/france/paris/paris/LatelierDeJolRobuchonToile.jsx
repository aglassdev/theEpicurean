...
const LatelierDeJolRobuchonToile = () => (
  <RestaurantPage
    restaurantName="L'Atelier de Joël Robuchon - Étoile"
    address="133 avenue des Champs-Élysées, Paris, 75008, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33147237575"
    website="https://atelier-robuchon-etoile.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Beyond its two restaurants in the French capital, L'Atelier de Joël Robuchon is literally making its way around the world. This venture was born a stone's throw from the Arc de Triomphe, on the lower level of the Publicis Drugstore on the Champs Élysées. A red and black colour scheme; a long counter along which diners sit on high stools, with a view of the kitchen team as they work; a hushed and meditative atmosphere. The Robuchon brand represents a contemporary approach to fine dining. The menu allows the customer to choose between small tasting portions or regular portions. A final touch that will please wine lovers: all the wines by the glass are served from magnums...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=133%20avenue%20des%20Champs-%C3%89lys%C3%A9es%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="L'Atelier de Joël Robuchon - Étoile"
  />
);

export default LatelierDeJolRobuchonToile;
