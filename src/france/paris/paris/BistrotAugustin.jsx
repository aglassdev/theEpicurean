...
const BistrotAugustin = () => (
  <RestaurantPage
    restaurantName="Bistrot Augustin"
    address="79 rue Daguerre, Paris, 75014, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33143219229"
    website="https://www.augustin-bistrot.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taken over by Guy Martin in 2020, this bistro still lives by the same values: a cosy setting, a small terrace on rue Daguerre, and lovely market-fresh cooking that is all about the ingredients. Rabbit terrine and red onion compote; sautéed farm-reared quasi of veal, seasonal vegetables with country bacon. Table d'hôte to the rear and an appetising menu-carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79%20rue%20Daguerre%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="Bistrot Augustin"
  />
);

export default BistrotAugustin;
