...
const JeanImbertAuPlazaAthne = () => (
  <RestaurantPage
    restaurantName="Jean Imbert"
    address="25 avenue Montaigne, Paris, 75008, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33153676500"
    website="https://www.dorchestercollection.com/fr/paris/hotel-plaza-athenee/restaurants-bars/jean-imbert-au-plaza-athenee"
    aliases={["Jean Imbert au Plaza Athénée"]}
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Media darling, Jean Imbert, is thriving in this iconic luxury hotel on Avenue Montaigne. In the company of a high-flying kitchen brigade, the “chef to the stars” jubilantly brings a fresh perspective to France’s culinary heritage: “Parisian” langoustines, seabass in a Chambertin sauce, lamb stew and the extravagant “grand dessert”, enthusiastically presented by a duet of pastry chefs… Seated at the majestic marble table d'hôte, surrounded by gilded moulding and chandeliers, how could you not fall under the spell?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20avenue%20Montaigne%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Jean Imbert"
  />
);

export default JeanImbertAuPlazaAthne;
