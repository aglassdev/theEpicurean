...
const PleineTerre = () => (
  <RestaurantPage
    restaurantName="Pleine Terre"
    address="15 rue de Bassano, Paris, 75116, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33981767610"
    website="https://www.restaurant-pleineterre.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a discreet façade, down the few steps leading to the basement, you will find a chef who is passionate about citrus fruits, spices and pepper: he has developed a cuisine that closely follows the seasons and showcases the work of handpicked small-scale producers. An inventive array of dishes, served by a friendly and enthusiastic front-of-house team: a great find...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20de%20Bassano%2C%20Paris%2C%2075116%2C%20France"
    pageTitle="Pleine Terre"
  />
);

export default PleineTerre;
