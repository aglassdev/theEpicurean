...
const LeClarence = () => (
  <RestaurantPage
    restaurantName="Le Clarence"
    address="31 avenue Franklin-D.-Roosevelt, Paris, 75008, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33182821010"
    website="https://www.le-clarence.paris/la-table/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Christophe Pelé has taken over this lavish 1884 private mansion just off the Champs-Élysées, an area he knows well, having worked at Ledoyen, Lasserre and Pierre Gagnaire, and last but not least at Le Royal Monceau – where chef Bruno Cirino (a protégé of Jacques Maximin) introduced him to his very seasonal and vegetable-focused cuisine, a philosophy he later successfully applied at his restaurant La Bigarrade. Today, he continues to deliver, in a luxurious decor that embodies the quintessence of French art de vivre. A big fan of Brittany, he is a true artist when it comes to combining surf and turf elements in uninhibited yet rigorous cuisine featuring bold marriages of flavours. The surprise set menu comes with a savvy series of satellite dishes all on the same theme (eg red mullet w..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20avenue%20Franklin-D.-Roosevelt%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Le Clarence"
  />
);

export default LeClarence;
