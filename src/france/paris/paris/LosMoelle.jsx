...
const LosMoelle = () => (
  <RestaurantPage
    restaurantName="L'Os à Moelle"
    address="3 rue Vasco-de-Gama, Paris, 75015, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33145572727"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/l-os-a-moelle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thierry Faucher is still in charge of L'Os à Moelle, where, in the early 2000s, he secured his position as one of the forerunners of France's bistronomy movement. Aubergine dip, soft-boiled egg and country ham; leg of lamb and vegetable fricassee; bone marrow; soup of the day… It's simple, delicious and indulgent fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Vasco-de-Gama%2C%20Paris%2C%2075015%2C%20France"
    pageTitle="L'Os à Moelle"
  />
);

export default LosMoelle;
