...
const LeChateaubriand = () => (
  <RestaurantPage
    restaurantName="Le Chateaubriand"
    address="129 avenue Parmentier, Paris, 75011, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33143574595"
    website="https://www.lechateaubriand.net"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Basque chef Iñaki Aizpitarte attracts an international clientele of food lovers with his unadulterated French bistro in this institution that wholeheartedly embraces the bistronomy movement, of which he was one of the initiators. The place has retained its original interior decor, the likes of which you would have come across in the 1930s, which it juxtaposes with a neo-retro mix of zinc, slate, high ceilings and narrow tables. Their winning formula is a single set menu with original marriages of flavours. Ingredients and wines are carefully selected from independent producers. Reservations are essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=129%20avenue%20Parmentier%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Le Chateaubriand"
  />
);

export default LeChateaubriand;
