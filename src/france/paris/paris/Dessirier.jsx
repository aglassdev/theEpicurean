...
const Dessirier = () => (
  <RestaurantPage
    restaurantName="Dessirier"
    address="9 place du Maréchal-Juin, Paris, 75017, France"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+33142278214"
    website="https://www.restaurantdessirier.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Contemporary, arty and chic: Dessirier is the Rostang family's flagship restaurant. It attaches a great deal of importance to the fish selection: bouillabaisse and sole meunière are among the signature dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20place%20du%20Mar%C3%A9chal-Juin%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Dessirier"
  />
);

export default Dessirier;
