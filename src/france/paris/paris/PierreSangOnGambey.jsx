...
const PierreSangOnGambey = () => (
  <RestaurantPage
    restaurantName="Pierre Sang on Gambey"
    address="6 rue Gambey, Paris, 75011, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33967319680"
    website="https://pierresang.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is Pierre Sang's second restaurant, the first being in nearby Oberkampf. Both locations are run with the same ethos and have the same concept. The famous chef's commitment to quality ingredients is also present and correct. Care and creativity go into turning produce into innovative, cosmopolitan dishes, with the occasional nod to Korea. The originality does not stop at the food: diners are invited to guess what they have just eaten! An inviting setting in which to indulge in a moment of sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Gambey%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Pierre Sang on Gambey"
  />
);

export default PierreSangOnGambey;
