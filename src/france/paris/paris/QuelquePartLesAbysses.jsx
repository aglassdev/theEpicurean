...
const QuelquePartLesAbysses = () => (
  <RestaurantPage
    restaurantName="Quelque Part"
    address="1 rue Ambroise-Thomas, Paris, 75009, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33183972265"
    website="https://lesabysses.quelquepart.net/"
    aliases={["Quelque part... Les Abysses"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This “somewhere” is the submarine wonderland of Top Chef contestant Florian Barbarot. Like Captain Nemo, he invites diners to explore his subtly creative cuisine in which seafood, seasonal veggies and scrupulously sourced ingredients are inspiringly assembled. Each menu features a different number of courses for an “abyssal immersion”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Ambroise-Thomas%2C%20Paris%2C%2075009%2C%20France"
    pageTitle="Quelque Part"
  />
);

export default QuelquePartLesAbysses;
