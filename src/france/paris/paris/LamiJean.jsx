...
const LamiJean = () => (
  <RestaurantPage
    restaurantName="L'Ami Jean"
    address="27 rue Malar, Paris, 75007, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33147058689"
    website="https://lamijean.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Passionate about fine seasonal produce, Stéphane Jégo serves cuisine that is bursting with generosity and flavours. Dishes with quite some character! Be sure to book...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20Malar%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="L'Ami Jean"
  />
);

export default LamiJean;
