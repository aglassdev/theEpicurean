...
const OsmossiMaisonMavrommatis = () => (
  <RestaurantPage
    restaurantName="Osmossi - Maison Mavrommatis"
    address="70 avenue Paul-Doumer, Paris, 75016, France"
    cuisine="Greek, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+33140507040"
    website="https://www.mavrommatis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a bright, contemporary bistro interior, upstairs from the delicatessen and wine shop, diners can feast on hot and cold mezze, pan-fried octopus with fava from Santorini or the ubiquitous moussaka. It's fresh and it’s tasty: what’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20avenue%20Paul-Doumer%2C%20Paris%2C%2075016%2C%20France"
    pageTitle="Osmossi - Maison Mavrommatis"
  />
);

export default OsmossiMaisonMavrommatis;
