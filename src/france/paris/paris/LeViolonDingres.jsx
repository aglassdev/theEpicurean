...
const LeViolonDingres = () => (
  <RestaurantPage
    restaurantName="Le Violon d'Ingres"
    address="135 rue Saint-Dominique, Paris, 75007, France"
    cuisine="Traditional Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33145551505"
    website="https://www.leviolondingres.paris"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At this luxury neo-brasserie, the duo of Alain Solivérès (the highly experienced former chef of Le Taillevent) and Jimmy Tsaramanana celebrate the South-West of France with impressive technical skill and high-quality ingredients. The sautéed sweetbreads served with a vin jaune sauce and the millefeuille with its light vanilla cream remain two great classics of the house. As for the feel of the place, authenticity and conviviality reign supreme, thanks to a highly professional team. This is a restaurant frequented by bon vivants, and reservations are essential, as tables get snapped up fast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=135%20rue%20Saint-Dominique%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Le Violon d'Ingres"
  />
);

export default LeViolonDingres;
