...
const Nous4 = () => (
  <RestaurantPage
    restaurantName="Nous 4"
    address="3 rue Beccaria, Paris, 75012, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33606706492"
    website="https://www.nous4restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pork in a melt - in - the - mouth crust with lentils and mustard sauce; poached egg with cabbage and bacon cream… you've probably got the picture. Here you can tuck into a no - nonsense, delicious meal that offers great value for money, considering how much you'll enjoy it. The open kitchen means you can also talk to the chef. A really lovely place, the like of which we'd be happy to see more of in Paris...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20Beccaria%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Nous 4"
  />
);

export default Nous4;
