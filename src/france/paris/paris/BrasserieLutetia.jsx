...
const BrasserieLutetia = () => (
  <RestaurantPage
    restaurantName="Brasserie Lutetia"
    address="45 boulevard Raspail, Paris, 75006, France"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33149544692"
    website="https://www.hotellutetia.com/fr/gastronomie-paris/brasserie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tartare of wild sea bass, sole meunière, Burgundy snails with parsley butter: the famous Brasserie Lutetia proudly serves the classics that have made its reputation, as well as some more contemporary creations. Purists and regulars alike can't get enough of the easy-going refined Art Deco atmosphere. Conservatory, mezzanine or patio: take your pick!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20boulevard%20Raspail%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Brasserie Lutetia"
  />
);

export default BrasserieLutetia;
