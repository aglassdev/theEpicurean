...
const SternRistorante = () => (
  <RestaurantPage
    restaurantName="Caffè Stern"
    address="47 passage des Panoramas, Paris, 75002, France"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+33175436310"
    website="https://alajmo.it/fr/pages/homepage-stern-ristorante"
    aliases={["Stern Ristorante"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Passage des Panoramas, the historical Graveur Stern engraving workshop has been turned into this smart trattoria, while retaining its period cachet (carvings, photos and original wood panelling). The menu features well-crafted and decidedly original Italian cuisine, served in generous portions: seasonal risotto; dill tagliolini with spider crab, clams and black olive sauce; Stern pistachio ice cream. Service with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20passage%20des%20Panoramas%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Caffè Stern"
  />
);

export default SternRistorante;
