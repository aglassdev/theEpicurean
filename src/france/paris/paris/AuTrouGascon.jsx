...
const AuTrouGascon = () => (
  <RestaurantPage
    restaurantName="Au Trou Gascon"
    address="40 rue Taine, Paris, 75012, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33188615631"
    website="https://autrougasconparis.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the former HQ (from 1973 to 2023) of Alain Dutournier, who was renowned for his bourgeois cuisine with a focus on the terroir of the South-West, the revamped interior is more casual: open kitchen, vintage furnishings and a cocktail bar. The dishes are as delicious as ever, and some have a Southern French twang: think tortellini with artichokes, vol-au-vent with cuttlefish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20rue%20Taine%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Au Trou Gascon"
  />
);

export default AuTrouGascon;
