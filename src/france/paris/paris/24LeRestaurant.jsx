...
const TwoFourLeRestaurant = () => (
  <RestaurantPage
    restaurantName="24 - Le Restaurant"
    address="24 rue Jean-Mermoz, Paris, 75008, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33142252424"
    website="https://www.24lerestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet street just a stone's throw from the Champs-Elysées, this establishment offers well-crafted, pedigree Gallic cuisine with an occasional personal spin, such as breast of Dombes duckling, chutney of yellow peaches, pine nuts and duckling jus underscored by mulled wine. Cheerful and professional welcome in a stylish setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20rue%20Jean-Mermoz%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="24 - Le Restaurant"
  />
);

export default TwoFourLeRestaurant;
