...
const CharbonKunitoraya = () => (
  <RestaurantPage
    restaurantName="Charbon Kunitoraya"
    address="5 rue Villedo, Paris, 75001, France"
    cuisine="Yakitori, Japanese"
    priceRange="€€€€"
    phoneNumber="+33147030774"
    website="https://kunitoraya.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Outside, the attractive timber façade has a Japanese feel. Inside, you'll find an old zinc counter, Paris Métro-style tiling, mirrors, wood panelling and mouldings, and two large bar tables built of solid wood. In this chic setting with a vintage feel, chef Nomoto – a pioneer of udon restaurants in France – serves up a range of top-notch yakitori, particularly chicken. Cordial, well-paced service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Villedo%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Charbon Kunitoraya"
  />
);

export default CharbonKunitoraya;
