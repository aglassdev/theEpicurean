...
const TwoZeroEiffel = () => (
  <RestaurantPage
    restaurantName="20 Eiffel"
    address="20 rue de Monttessuy, Paris, 75007, France"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33147051420"
    website="https://www.restaurant20eiffel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet street a stone’s throw from the Eiffel Tower, this restaurant offers a understated interior full of light. On the menu, you can choose from a range of updated dishes, prepared by two chefs, all of which place the focus on flavour and taste. For example, a delicious fillet of wild Pollock with squash...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20de%20Monttessuy%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="20 Eiffel"
  />
);

export default TwoZeroEiffel;
