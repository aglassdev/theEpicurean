...
const Dilia = () => (
  <RestaurantPage
    restaurantName="Dilia"
    address="1 rue d'Eupatoria, Paris, 75020, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33953562414"
    website="https://www.dilia.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small-format restaurant opposite Notre-Dame-de-la-Croix, in the heart of the 20th arrondissement, has buckets of charm and a country house feel. Tuscan chef Michele Farnese has good international credentials, as well as experience in French establishments such as Saturne and Thoumieux. With the name Dilia, he pays tribute to his ancestors, Dino and Illia. With a joyous sense of freedom, the chef cooks up his Italian cuisine. Sage takes pride of place alongside pillowy beetroot gnocchi and raw scallop shavings; the pasta is prepared in time-honoured tradition and marries perfectly with the bottarga and garlic bread. While the lunch menu is a good deal, the multi-course dinner menu ups the ante, and is accompanied by an excellent selection of French and Italian wines. Friendly and smili..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20d'Eupatoria%2C%20Paris%2C%2075020%2C%20France"
    pageTitle="Dilia"
  />
);

export default Dilia;
