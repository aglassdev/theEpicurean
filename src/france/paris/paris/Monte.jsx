...
const Monte = () => (
  <RestaurantPage
    restaurantName="Montée"
    address="9 rue Léopold-Robert, Paris, 75014, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33143255763"
    website="https://restaurant-montee.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery is the lair of a talented Japanese chef whose love of French cuisine does not prevent him from respecting his Japanese heritage: pared-back, simple recipes and graphic minimalist plating. Mashed potato and cod with an almond mousse; John Dory cooked on a plancha with mint sauce and fried potatoes; roast rack of veal paired with creamy spinach. All of which is served in an eminently tasteful designer interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20L%C3%A9opold-Robert%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="Montée"
  />
);
