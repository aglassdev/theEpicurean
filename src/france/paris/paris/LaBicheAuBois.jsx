...
const LaBicheAuBois = () => (
  <RestaurantPage
    restaurantName="À La Biche au Bois"
    address="45 avenue Ledru-Rollin, Paris, 75012, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33143433438"
    website="https://alabicheaubois.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an atmospheric interior reminiscent of historic Parisian bistros and two minutes from Lyon railway station, regulars and travellers rub shoulders as they dig into traditional no-nonsense nosh. Country terrines, Burgundy snails and Royan ravioles star alongside duck breast in honey, fillet of beef served with cèpes and foie gras or coq au vin (the house specialty), without forgetting game in season (venison and even Scottish grouse!). The crème caramel to finish is wickedly addictive…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20avenue%20Ledru-Rollin%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="À La Biche au Bois"
  />
);

export default LaBicheAuBois;
