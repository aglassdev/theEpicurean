...
const LeDuc = () => (
  <RestaurantPage
    restaurantName="Le Duc"
    address="243 boulevard Raspail, Paris, 75014, France"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+33143209630"
    website="https://restaurantleduc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite being in the heart of the Left Bank, you would be forgiven for thinking you were in the cabin of a yacht packed with seafaring acolytes… The chef works with first-rate fish and seafood and is a consummate craftsman: tartare of langoustine with black lemon, sole meunière, lobster sautéed with orange, grilled John Dory… All aboard!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=243%20boulevard%20Raspail%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="Le Duc"
  />
);

export default LeDuc;
