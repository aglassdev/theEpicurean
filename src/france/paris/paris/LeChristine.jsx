...
const LeChristine = () => (
  <RestaurantPage
    restaurantName="Le Christine"
    address="1 rue Christine, Paris, 75006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33140517164"
    website="https://lechristine.becsparisiens.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet little street, you will spot the inviting façade of this restaurant, where the conviviality and generosity are first apparent on the (short and appetising) menu, then in the nicely crafted dishes, which always include a vegetarian option. Thank you, Christine, and see you soon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Christine%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Le Christine"
  />
);

export default LeChristine;
