...
const AuxPlumes = () => (
  <RestaurantPage
    restaurantName="Aux Plumes"
    address="45 rue Boulard, Paris, 75014, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33153907622"
    website="https://www.auxplumes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A young Japanese chef with a great track record creates inspired, generous cuisine using the best ingredients in the neighbourhood. Cream of sweet potato soup, cocoa emulsion; lychee and coconut milk blancmange and exotic fruit minestrone – the original dishes are carefully prepared, change on a weekly basis and are delicious every time. At lunchtime, a trilogy of starters at an unbeatable price...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20rue%20Boulard%2C%20Paris%2C%2075014%2C%20France"
    pageTitle="Aux Plumes"
  />
);

export default AuxPlumes;
