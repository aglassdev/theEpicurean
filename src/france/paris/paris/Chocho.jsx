...
const Chocho = () => (
  <RestaurantPage
    restaurantName="Chocho"
    address="54 rue de Paradis, Paris, 75010, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33142282603"
    website="https://chocho.becsparisiens.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this buzzy establishment that is invariably packed to the seams, Franco-American chef Thomas Chisholm, a former Top Chef contestant, celebrates sharing and sustainable fine dining. You can expect ikejime fish, rows of jars and fermentations and agroforestry ingredients… His creative, sometimes playful culinary style is skilfully blended with globetrotting influences: orange glazed sand carrots, cream of sunflower and kumquat preserves; scallops and raw foie gras flanked by a stock of roast celeriac perfumed in soy sauce, lemon grass and galanga…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20rue%20de%20Paradis%2C%20Paris%2C%2075010%2C%20France"
    pageTitle="Chocho"
  />
);

export default Chocho;
