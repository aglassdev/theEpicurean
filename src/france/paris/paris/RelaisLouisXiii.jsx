...
const RelaisLouisXiii = () => (
  <RestaurantPage
    restaurantName="Relais Louis XIII"
    address="8 rue des Grands-Augustins, Paris, 75006, France"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+33143267596"
    website="https://relaislouis13.fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This edifice, steeped in history, stands on the cellars of the former Grands-Augustins convent and it was here on 14 May 1610, an hour after his father King Henry IV had been assassinated, that Louis XIII learned that he was the next king of France… The memory of this rich heritage lingers on in the ornate dining room which sports half-timbers, bare stone, wainscoting, stained-glass and wall hangings, although the profusion of heirlooms is set off by a few cutting-edge details (glazed cellar, modern sculptures). The setting with a sense of occasion is the perfect foil to the food of chef Manuel Martinez, an ardent champion of Gallic culinary classicism. After training at Ledoyen, the Crillon and the Tour d’Argent, the Meilleur Ouvrier de France (Best Craftsman of France) decided to settle ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20des%20Grands-Augustins%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Relais Louis XIII"
  />
);

export default RelaisLouisXiii;
