...
const LeMazenay = () => (
  <RestaurantPage
    restaurantName="Le Mazenay"
    address="46 rue de Montmorency, Paris, 75003, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33642837952"
    website="https://www.lemazenay.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The emphasis here is on good cooking technique, the right jus and fine produce. There is no unnecessary fuss when you feast on wild snails with herbs or a poached farm-reared chicken. But the chef hankers after just one thing – the start of game season! Roasted Scottish grouse, hare à la royale. A place for bon viveurs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20rue%20de%20Montmorency%2C%20Paris%2C%2075003%2C%20France"
    pageTitle="Le Mazenay"
  />
);

export default LeMazenay;
