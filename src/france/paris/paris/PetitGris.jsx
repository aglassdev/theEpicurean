...
const PetitGris = () => (
  <RestaurantPage
    restaurantName="Petit Gris"
    address="67 rue Rennequin, Paris, 75017, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33611346991"
    website="https://www.restaurantpetitgris.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jean-Baptiste Ascione, a former Top Chef contestant, dreamed of opening his own restaurant. He has done so in this cosy space (oak floorboards, sanded wooden tables, bistro chairs), in which first-class country produce and a traditional culinary score take centre stage. Deftly-crafted recipes served in a cheerful setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20rue%20Rennequin%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Petit Gris"
  />
);

export default PetitGris;
