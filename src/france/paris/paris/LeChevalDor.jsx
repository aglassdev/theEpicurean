...
const LeChevalDor = () => (
  <RestaurantPage
    restaurantName="Le Cheval d'Or"
    address="21 rue de la Villette, Paris, 75019, France"
    cuisine="Asian"
    priceRange="€€€"
    phoneNumber="+33745111647"
    website="https://chevaldorparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the buzzy Jourdain district of Paris, a hotspot of gentrification, head to this Golden Horse with your eyes closed. Behind an oriental red façade, you will find a pared-back interior of polished concrete, untreated walls and an open kitchen where you will sample the handiwork of an Australian chef of Philippine origins. Gallic and Chinese gourmet traditions are savvily merged and treated to an inspired new spin to the delight of a trendy, cosmopolitan crowd. Steamed cod, endive braised in ginger, apple and spring onion sauce; croque madame, shrimps and chili pepper oil; tortellini, minced veal, shiitakes and tofu mapo sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20rue%20de%20la%20Villette%2C%20Paris%2C%2075019%2C%20France"
    pageTitle="Le Cheval d'Or"
  />
);

export default LeChevalDor;
