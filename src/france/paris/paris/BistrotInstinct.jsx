...
const BistrotInstinct = () => (
  <RestaurantPage
    restaurantName="Bistrot Instinct"
    address="19 rue de Picardie, Paris, 75003, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33142789306"
    website="https://instinct-paris.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pocket handkerchief contemporary bistro is in the hands of chef Maximilian Wollek and his enthusiastic youthful team. A market-fresh culinary score and updated classics with bistronomic overtones. Everything is homemade, even the cordials used in the unusual cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20de%20Picardie%2C%20Paris%2C%2075003%2C%20France"
    pageTitle="Bistrot Instinct"
  />
);

export default BistrotInstinct;
