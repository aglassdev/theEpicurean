...
const LatelierDeJolRobuchonStgermain = () => (
  <RestaurantPage
    restaurantName="L'Atelier de Joël Robuchon - St-Germain"
    address="5 rue de Montalembert, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33142225656"
    website="https://www.atelier-robuchon-saint-germain.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bathed in a studied semi-darkness, two bars face each other around a central kitchen where the dishes are prepared under the gaze of the guests, seated on high stools at the counter. This chic canteen is a Western version of Japanese teppanyaki and sushi bars, with a menu that can be “tailored” into small portions and plates that boast superlative ingredients. Caviar on a soft-boiled hen’s egg and smoked salmon in puff pastry and the house staples, king crab ravioli, suckling lamb chops, Joël Robuchon's famous mashed potatoes......"
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20de%20Montalembert%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="L'Atelier de Joël Robuchon - St-Germain"
  />
);

export default LatelierDeJolRobuchonStgermain;
