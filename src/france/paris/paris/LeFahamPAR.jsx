...
const LeFahamPAR = () => (
  <RestaurantPage
    restaurantName="Le Faham"
    address="108 rue Cardinet, Paris, 75017, France"
    ...
    bio="The faham is an orchid native to the island of Réunion, famous for its subtle almond scent. Kelly Rangama (2017 Top Chef contestant) chose this flower to symbolise her civil and culinary union with pastry chef Jérôme Devreese and their joint creation: this sleek, elegant restaurant tucked away in the Batignolles district. Here the chef rolls out a culinary patchwork that abounds in vibrancy and delicacy, spicy but always subtle, with an exotic edge that makes all the difference. An example: tandoori-style monkfish, followed by a wickedly decadent poached rhubarb, ginger and mango sorbet and a Fontainebleau mousse – to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=108%20rue%20Cardinet%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Le Faham"
  />
);

export default LeFahamPAR;
