...
const AuxLyonnais = () => (
  <RestaurantPage
    restaurantName="Aux Lyonnais"
    address="32 rue Saint-Marc, Paris, 75002, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33142966504"
    website="https://www.auxlyonnais.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro established in 1890 has a delightfully retro decor and serves delicious cuisine that explores Lyon's gastronomy in all its riches. The terrines, pike-perch quenelles with crayfish, and the chicken liver terrine vie with the specials chalked up on the slate, and the desserts are enough to awaken anyone's sweet tooth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20rue%20Saint-Marc%2C%20Paris%2C%2075002%2C%20France"
    pageTitle="Aux Lyonnais"
  />
);

export default AuxLyonnais;
