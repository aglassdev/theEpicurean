...
const Mensae = () => (
  <RestaurantPage
    restaurantName="Mensae"
    address="23 rue Melingue, Paris, 75019, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33153198098"
    website="https://www.mensae-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cuisine of the moment, full of freshness and with spot-on flavours. Among the classics, on the menu all year round, the frogs' legs, garlic and parsley or the mousse au chocolat praliné are good enough to spark a riot. The decor has the good taste to make itself discreet. The small sidewalk terrace is welcome in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20Melingue%2C%20Paris%2C%2075019%2C%20France"
    pageTitle="Mensae"
  />
);
