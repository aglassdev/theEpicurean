...
const Sagan = () => (
  <RestaurantPage
    restaurantName="Sagan"
    address="8 rue Casimir-Delavigne, Paris, 75006, France"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+33669378219"
    website="https://www.saganparis.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone’s throw from the historic Odéon Theatre, this pocket handkerchief restaurant serves inventive, razor-sharp Japanese food: sashimi of semi-cooked salmon and caviar, miso soup with sake marinated clams. The wine list is a treasure trove of Bordeaux and Burgundies. Served with a smile in a hushed, cosy interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20Casimir-Delavigne%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Sagan"
  />
);
