...
const DoubleDragon = () => (
  <RestaurantPage
    restaurantName="Double Dragon"
    address="52 rue Saint-Maur, Paris, 75011, France"
    cuisine="Asian"
    priceRange="€€"
    phoneNumber="+33171324195"
    website="https://www.doubledragonparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this friendly Asian canteen, sisters Katia and Tatiana Levha offer simple dishes of mixed inspiration (China, Philippines, Thailand etc) in an upgraded street food vein. This is cooking that is full of character, with pronounced flavours, and often deliciously spicy. A fun experience and tasty fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20rue%20Saint-Maur%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Double Dragon"
  />
);
