...
const RestaurantH = () => (
  <RestaurantPage
    ...
    address="13 rue Jean-Beausire, Paris, 75004, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33143488096"
    website="https://www.restauranth.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The H is for Hubert Duchenne, a chef hailing from Normandy, whose CV includes stints working for Akrame Benallal and Jean-François Piège. Behind the discreet, elegant façade, the intimate space done out in a chic yet cosy style accommodates fewer than 20 diners. The dishes are deftly done and always on point, whether razor clams with parsley (their signature dish), pollack with amaranth seeds – puffed and as a risotto or barbecued Jersey beef with creamy carrot and activated charcoal: almost every plate enchants the palate thanks to a remarkable balance of roasted and tangy notes. The chef's inventive and skilfully executed dishes, based on premium seasonal produce, form a single set menu – you're in for a treat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Jean-Beausire%2C%20Paris%2C%2075004%2C%20France"
    pageTitle="Restaurant H"
  />
);

export default RestaurantH;
