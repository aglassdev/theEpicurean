...
const Geolia = () => (
  <RestaurantPage
    restaurantName="Geoélia"
    address="125 rue de la Tour, Paris, 75116, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33145043535"
    website="https://geoelia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an up-market neighbourhood, this street corner restaurant charms courtesy of its bright dining room with contemporary lines, white concrete cladding and pair of majestic Murano chandeliers. Breton chef Camille Saint-M'Leux (formerly of Montreuil’s Villa9Trois) named his venture after his grandparents' sailboat. The cuisine follows the tides and seasons: crab fished in creels and coral roe mayonnaise, line-fished pollock from Roscoff fish auction, blue lobster in a pastry-sealed pot… Graphic plating for dishes in which fish, seafood and vegetables share the limelight. Meat lovers can rest easy as a quick look at the menus and à la carte lineup will reveal (roast venison, calf’s sweetbread, barbecued Jersey beef)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%20rue%20de%20la%20Tour%2C%20Paris%2C%2075116%2C%20France"
    pageTitle="Geoélia"
  />
);

export default Geolia;
