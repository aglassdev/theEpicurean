...
const Rosemarie = () => (
  <RestaurantPage
    restaurantName="Rosemarie"
    address="149 rue de l'Université, Paris, 75007, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33145510371"
    website="https://www.rosemariebistrotparis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cream, butter, zinc-topped counter, imitation leather and egg mayonnaise – a recipe for happiness! This bistro is run by two seasoned professionals, Nina and Philippe Cadeau (formerly at Beurre-Noisette and Christian Constant's restaurant, Cocottes), and named after their mothers. Their expertise has lost none of its lustre: Nina's enthusiasm continues to shine on the restaurant floor and Philippe turns out delicious traditional and seasonal dishes: think devilled eggs, trout marinated in lemon zest, entrecôte and fried potatoes, chocolate tart or vanilla profiteroles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=149%20rue%20de%20l'Universit%C3%A9%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Rosemarie"
  />
);

export default Rosemarie;
