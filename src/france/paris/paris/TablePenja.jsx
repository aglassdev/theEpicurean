...
const TablePenja = () => (
  <RestaurantPage
    restaurantName="Table Penja"
    address="2 rue Sédillot, Paris, 75007, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33145519582"
    website="https://tablepenja.paris"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a successful stint at Le Garde-Temps in Pigalle, Cameroon-born chef Pierre Siewe now runs this restaurant with a modern bistro decor, where the warm interior is subtly reminiscent of Africa. As for the food, this former mentee of Yves Camdeborde seasons his local bistronomy with African spices (djansang, pebe, turmeric and the famous Penja pepper) and ingredients (hibiscus, yam, cocoa etc). This approach lends his dishes a unique personality: the perfectly braised chuck of beef is spiced up with a coffee, caper, red onion and hibiscus mustard condiment; the classic Mont Blanc dessert is accompanied by a green peppercorn ice cream that brings a fruity, invigorating freshness to the dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20S%C3%A9dillot%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Table Penja"
  />
);

export default TablePenja;
