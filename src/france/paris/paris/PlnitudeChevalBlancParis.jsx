...
const PlnitudeChevalBlancParis = () => (
  <RestaurantPage
    restaurantName="Plénitude - Cheval Blanc Paris"
    address="8 quai du Louvre, Paris, 75001, France"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+33179355011"
    website="https://www.chevalblanc.com/fr/maison/paris/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The revamped Samaritaine department store is home to the luxurious Cheval Blanc Hotel, within whose walls lies this restaurant, the haunt of low-profile chef, Arnaud Donckele, who has three stars to his name at La Vague d'Or in St Tropez. Wholly committed, he pops in and out of the kitchen to share his passion with diners. His new spin on classical cuisine takes you on a voyage between Normandy, his place of birth, and the Mediterranean, his home of adoption and the Paris region… It is impossible not to be bowled over by his work, from its delicacy and generosity to the exceptional quality of the ingredients. This virtuoso sauce maker, who can be compared with a perfume “nose” or an oenologist, lavishes phenomenal care and attention over his jus, dressings and sauces which should be tasted..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20quai%20du%20Louvre%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="Plénitude - Cheval Blanc Paris"
  />
);

export default PlnitudeChevalBlancParis;
