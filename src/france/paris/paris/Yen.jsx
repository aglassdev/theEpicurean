...
const Yen = () => (
  <RestaurantPage
    restaurantName="Yen"
    address="22 rue Saint-Benoît, Paris, 75006, France"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+33145441118"
    website="https://www.yen-paris.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stripped-back decor of this eatery will appeal to fans of minimalism. You will taste a festival of Japanese delicacies: sushi, tempura, black cod marinated in miso and grilled, sakura mochi… The house signature is soba (buckwheat noodles) served hot or cold. Authentic fare and slick, seamless service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20rue%20Saint-Beno%C3%AEt%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="Yen"
  />
);
