...
const CafDesMinistres = () => (
  <RestaurantPage
    restaurantName="Café des Ministères"
    address="83 rue de l'Université, Paris, 75007, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33145337334"
    website="https://www.cafedesministeres.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this bistro that is reminiscent of a neighbourhood café is on the lips of every fan of wonderfully rich sauces and authentic French cuisine (especially South-Western fare). The vol-au-vent with sweetbreads, poultry and truffle jus, as well as the stuffed Pontoise cabbage (French champion in 2022) have put this place on the map: book in advance!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%20rue%20de%20l'Universit%C3%A9%2C%20Paris%2C%2075007%2C%20France"
    pageTitle="Café des Ministères"
  />
);

export default CafDesMinistres;
