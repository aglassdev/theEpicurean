...
const Towa = () => (
  <RestaurantPage
    restaurantName="Towa"
    address="75 rue Crozatier, Paris, 75012, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33153170244"
    website="https://www.towarestaurantparis.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese chef Shin Okusa is at the helm of the Towa, close to the bustling Aligre market. A champion of old-school French culinary traditions and a true disciple of Escoffier, he not only whisks up the great classics (French lamb stew, breast of duck in flaky pastry), but also sauces, hot terrines and pies, with superlative skill and flair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75%20rue%20Crozatier%2C%20Paris%2C%2075012%2C%20France"
    pageTitle="Towa"
  />
);
