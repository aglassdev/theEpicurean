...
const PhoTai = () => (
  <RestaurantPage
    restaurantName="Pho Tai"
    address="13 rue Philibert-Lucot, Paris, 75013, France"
    cuisine="Vietnamese"
    priceRange="€"
    phoneNumber="+33145859736"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/pho-tai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a quiet street in the Asian quarter, Mr and Mrs Té keep a watchful eye over their little Vietnamese canteen, which has its fair share of regulars. In a boisterous atmosphere, diners tuck into flavoursome home-style cooking at tightly packed tables: crispy chicken with fresh ginger, bò bún; the phở soup and Vietnamese dumplings (bánh cuốn) deserve a special mention. Very reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20Philibert-Lucot%2C%20Paris%2C%2075013%2C%20France"
    pageTitle="Pho Tai"
  />
);

export default PhoTai;
