...
const OneNineSaintRoch = () => (
  <RestaurantPage
    restaurantName="19 Saint Roch"
    address="19 rue Saint-Roch, Paris, 75001, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33140150089"
    website="https://www.19saint-roch.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pierre Touitou – one of the emblematic chefs of the new Parisian bistronomy – has already made his mark on the trendiest echelons of the capital's restaurant scene (Vivant etc). Black and white floor tiles pave the way to an open kitchen separated off with a stainless steel-topped counter – eat here for a front row view of the action in the kitchen. The chef and his brigade can be seen conjuring up food in a fresh, creative vein. The seasonings and condiments leave nothing to chance – eg the house-made harissa on the ox tongue and spinach pkaila (Jewish Tunisian stew), or the fresh peas with capers, toasted pine nuts and barberry that accompany the bonito. As you would expect, natural wines take pride of place. Pure dining pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20Saint-Roch%2C%20Paris%2C%2075001%2C%20France"
    pageTitle="19 Saint Roch"
  />
);

export default OneNineSaintRoch;
