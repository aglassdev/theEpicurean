...
const Pianovins = () => (
  <RestaurantPage
    restaurantName="Pianovins"
    address="46 rue Trousseau, Paris, 75011, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33981689405"
    website="https://www.pianovins.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this intimate dining room that seats 20 diners at tightly packed tables, two brothers with bags of energy have joined forces: Emmanuel in the open kitchen and Raphaël front of house. The meticulously executed and plated dishes vary every day according to market availability, and always bring a touch of indulgence. Great value for money at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20rue%20Trousseau%2C%20Paris%2C%2075011%2C%20France"
    pageTitle="Pianovins"
  />
);

export default Pianovins;
