...
const Biscotte = () => (
  <RestaurantPage
    restaurantName="Biscotte"
    address="22 rue Desnouettes, Paris, 75015, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33145332222"
    website="https://www.restaurant-biscotte.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pauline and Maximilien, two alumni of the most prestigious establishments (Le Bristol, Lasserre, Arpège), have set up their own place near Porte de Versailles. Convivial bistro interior, large atelier windows separating the kitchen, tasty and studied dishes: all the ingredients are in place for an enjoyable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20rue%20Desnouettes%2C%20Paris%2C%2075015%2C%20France"
    pageTitle="Biscotte"
  />
);

export default Biscotte;
