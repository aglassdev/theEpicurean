...
const Solstice = () => (
  <RestaurantPage
    restaurantName="Solstice"
    address="45 rue Claude-Bernard, Paris, 75005, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33988096352"
    website="https://solsticeparis.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If there are writers' writers, then there are chefs' chefs. A Meilleur Ouvrier de France, a mainstay of the Ferrandi gastronomy school, promoter of culinary design, restaurateur in Tokyo, Éric Trochon is that sort of chef – admired and yet relatively little known. He and his sommelier wife preside over this elegant, intimate-feeling restaurant with a decor that blends Brazilian rosewood furnishings and paintings and ceramics by a Korean artist. The menu also errs towards minimalism, with on-point proposals including an omakase menu. The dishes showcase modern cuisine with Asian touches, such as fillet of beef with eryngii and shimeji mushrooms, gochujang and bitter Korean salad. Two places with a view into the kitchens are available at the counter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20rue%20Claude-Bernard%2C%20Paris%2C%2075005%2C%20France"
    pageTitle="Solstice"
  />
);
