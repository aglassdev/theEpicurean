...
const ShirvanCafMtisse = () => (
  <RestaurantPage
    restaurantName="Shirvan Café Métisse"
    address="5 place de l'Alma, Paris, 75008, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33147230948"
    website="https://www.shirvanrestaurant.com/fr/restaurants/paris/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant near Pont de l'Alma is the brainchild of Akrame Benallal. Starched white linen has given way to designer cutlery and, first and foremost, a menu inspired by the Silk Road from Morocco to India via Azerbaijan. A delicious melting pot seasoned with a wealth of spices, as in the vegetarian tikki or the confit lamb chops with home-made harissa... Efficient service and you can eat at almost any time of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20place%20de%20l'Alma%2C%20Paris%2C%2075008%2C%20France"
    pageTitle="Shirvan Café Métisse"
  />
);

export default ShirvanCafMtisse;
