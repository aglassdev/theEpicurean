...
const LaTableDeMee = () => (
  <RestaurantPage
    restaurantName="La Table de Mee"
    address="6 rue des Ciseaux, Paris, 75006, France"
    cuisine="Korean"
    priceRange="€€"
    phoneNumber="+33143544256"
    website="https://guide.michelin.com/en/ile-de-france/paris/restaurant/la-table-de-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a stripped-back interior dominated by wood (where you can sit at the counter to watch the chef at work at his large plancha), this Korean restaurant celebrates the country's specialities. Spicy flavours and sauces are the order of the day, courtesy of the obligatory kimchi, Korean fried chicken (KFC) and delicious ssams. The mackerel fillets simmered in a soya, chilli and white radish broth is a standout dish. The total capacity is 24 diners: booking strongly recommended!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20des%20Ciseaux%2C%20Paris%2C%2075006%2C%20France"
    pageTitle="La Table de Mee"
  />
);

export default LaTableDeMee;
