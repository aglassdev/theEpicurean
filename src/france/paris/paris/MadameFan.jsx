...
const MadameFan = () => (
  <RestaurantPage
    restaurantName="Madame FAN"
    address="18 rue Bayen, Paris, 75017, France"
    cuisine="Chinese"
    priceRange="€€"
    phoneNumber="+33153817977"
    website="https://www.madame-fan.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant celebrates the delights of Chinese cuisine courtesy of a short menu devised by Chinese-born executive chef. He produces masterful dishes using quality ingredients – raw bluefin tuna, marinated cucumber; Padrón peppers, beef and chicken stuffing; Kung Pao prawns with cashew nuts; chocolate bao, black sesame ice cream... to savour in a contemporary-style interior with a glass-paned roof...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20rue%20Bayen%2C%20Paris%2C%2075017%2C%20France"
    pageTitle="Madame FAN"
  />
);

export default MadameFan;
