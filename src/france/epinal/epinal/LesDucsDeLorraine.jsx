...
const LesDucsDeLorraine = () => (
  <RestaurantPage
    restaurantName="Les Ducs de Lorraine"
    address="5 avenue de Provence, Epinal, 88000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33329295600"
    website="https://www.restaurant-ducsdelorraine.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the heart of the capital of the Vosges, Stéphane Ringer and Rémi Gornet preside over this neo-Tudor style manor, with high ceilings, stained-glass windows, precious panelling and cornices that combine to provide an exceptional backdrop for your meal. The two chefs deliver modern dishes based on top-notch produce – lobster, langoustines, turbot, caviar, sweetbreads – cooked with precision. Generously stocked cheese and dessert trolleys make for quite a finale, while the cellar boasts a strong collection of bordeaux. Terrasse/conservatory with a sliding roof...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20avenue%20de%20Provence%2C%20Epinal%2C%2088000%2C%20France"
    pageTitle="Les Ducs de Lorraine"
  />
);

export default LesDucsDeLorraine;
