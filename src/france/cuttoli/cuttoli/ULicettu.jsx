...
const ULicettu = () => (
  <RestaurantPage
    restaurantName="U Licettu"
    address="Plaine de Cuttoli, Cuttoli, 20167, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33495256157"
    website="https://www.u-licettu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Could this pink-rendered villa, decked in flowers and overlooking the gulf, have found the secret of authentic Corsican food? Whatever the case, you can be certain that you will sample wholehearted, full-bodied dishes made with first-class ingredients in keeping with time-honoured culinary traditions: nothing goes to waste from pig’s trotters to tails, the meat is slowly spit-roasted on the open fire or the lady of the house hovering nearby to check you finish your plate. Beverages included in the menu. Highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaine%20de%20Cuttoli%2C%20Cuttoli%2C%2020167%2C%20France"
    pageTitle="U Licettu"
  />
);

export default ULicettu;
