...
const LaPasserelle = () => (
  <RestaurantPage
    restaurantName="La Passerelle"
    address="113 route du Havre-de-la-Vanlée, Bricqueville-sur-Mer, 50290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33233616551"
    website="https://www.restaurant-la-passerelle.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It was love at first sight when the chef, who hails from Orléans, saw this restaurant located on the edge of Le Havre de la Vanlée, which offers an ideal landscape for walks among the salt meadow sheep. Now well established, it serves contemporary market cuisine that is fresh and tasty, for example the monkfish, chorizo and leek. A pleasant place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=113%20route%20du%20Havre-de-la-Vanl%C3%A9e%2C%20Bricqueville-sur-Mer%2C%2050290%2C%20France"
    pageTitle="La Passerelle"
  />
);

export default LaPasserelle;
