...
const ChteauDuBost = () => (
  <RestaurantPage
    restaurantName="Château du Bost"
    address="27 rue de Beauséjour, Bellerive-sur-Allier, 03700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33470595959"
    website="https://chateau-du-bost.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few minutes from Vichy, in peaceful grounds, this château with towers and a water-filled moat (15C-19C) offers a contemporary and cosy decor, complemented by a beautiful terrace and some comfortable guestrooms. The restaurant has a refined setting and serves tasty seasonal cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20de%20Beaus%C3%A9jour%2C%20Bellerive-sur-Allier%2C%2003700%2C%20France"
    pageTitle="Château du Bost"
  />
);

export default ChteauDuBost;
