...
const DesPetitsPoisSontRouges = () => (
  <RestaurantPage
    restaurantName="Des Petits Pois Sont Rouges"
    address="44 avenue des Pyrénées, Argelès-Gazost, 65400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33562970126"
    website="https://www.hotel-argeles-gazost.com/fr/la-table"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="No need to be a guest at the Miramont Hotel to enjoy the chef's cuisine. He of course pays homage to Pyrenean culinary heritage but doesn't hesitate to make a few welcome innovations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20avenue%20des%20Pyr%C3%A9n%C3%A9es%2C%20Argel%C3%A8s-Gazost%2C%2065400%2C%20France"
    pageTitle="Des Petits Pois Sont Rouges"
  />
);

export default DesPetitsPoisSontRouges;
