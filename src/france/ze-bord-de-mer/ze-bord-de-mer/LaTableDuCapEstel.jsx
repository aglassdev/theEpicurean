...
const LaTableDuCapEstel = () => (
  <RestaurantPage
    restaurantName="La Table du Cap Estel"
    address="1312 avenue Raymond-Poincaré, Èze-Bord-de-Mer, 06360, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33493762929"
    website="https://www.capestel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched atop the rocky cliffside on an enchanting peninsula between Nice and Monaco, this hotel is one of the most secluded and exclusive spots on the Côte d'Azur. Access is via a discreet gate, then a winding path that seems to draw you away from the world. Dining on the terrace here, lulled by the swaying palms of a Mediterranean garden, feels like a rare privilege. Kevin Garcia, former executive chef for Frédéric Anton at Le Jules Verne enhances the blissful experience with his homage to seafood, garden herbs and top-quality locally grown vegetables. His straightforward dishes are forthright in flavour, eschewing ostentation in favour of showcasing remarkable precision and genuine technical flair: raw bonito, sea-sourced condiments, roasted-rice cream and Oscietra caviar; gamberoni praw..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1312%20avenue%20Raymond-Poincar%C3%A9%2C%20%C3%88ze-Bord-de-Mer%2C%2006360%2C%20France"
    pageTitle="La Table du Cap Estel"
  />
);

export default LaTableDuCapEstel;
