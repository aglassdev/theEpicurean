...
const LeChalet = () => (
  <RestaurantPage
    ...
    address="2406 route de Monestier, Gresse-en-Vercors, 38650, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33476343208"
    website="https://hotellechalet.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fortified house during the Middle Ages, and a convent up until 1905, this chalet is now a hotel-restaurant run by the Prayer family, for whom tradition and generosity are the answer to everything. Their big-boned, wholehearted score reads like a vintage cookbook: hare pâté, fillet of trout and crayfish and Dauphiné ravioles, or a melt-in-the-mouth chocolate and vanilla ice cream extravaganza. Cosy rooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2406%20route%20de%20Monestier%2C%20Gresse-en-Vercors%2C%2038650%2C%20France"
    pageTitle="Le Chalet"
  />
);

export default LeChalet;
