...
const LaMaisonPLO = () => (
  <RestaurantPage
    restaurantName="À la Maison"
    address="21 place de l'Europe, Plouguerneau, 29880, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33298017621"
    website="https://guide.michelin.com/en/bretagne/plouguerneau/restaurant/a-la-maison"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This house rustles up wholesome bistro fare that shines the limelight on regional produce. The chef particularly likes devising dishes around a single ingredient, such as pork or lamb. House specialties include black pudding, a 64° egg and Guéméné andouille. Well worth discovering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20place%20de%20l'Europe%2C%20Plouguerneau%2C%2029880%2C%20France"
    pageTitle="À la Maison"
  />
);

export default LaMaisonPLO;
