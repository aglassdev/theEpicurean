...
const LeSaintlaurent = () => (
  <RestaurantPage
    restaurantName="Le Saint-Laurent"
    address="1 quai Bouchacourt, Saint-Laurent-sur-Saône, 01750, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385392919"
    website="https://le-saint-laurent-macon.com/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a prime location on the banks of the Saône, this brasserie by chef Georges Blanc is something of a local institution. The premises may have undergone a major renovation, but the menu still features classic dishes such as frog's legs in a garlic and parsley butter or osso bucco with creamy saffron polenta, as well as Mediterranean-inspired creations. Tables on the attractive veranda afford views of Mâcon and the medieval bridge...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20quai%20Bouchacourt%2C%20Saint-Laurent-sur-Sa%C3%B4ne%2C%2001750%2C%20France"
    pageTitle="Le Saint-Laurent"
  />
);

export default LeSaintlaurent;
