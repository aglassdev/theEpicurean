...
const LesSaisonsGourmandes = () => (
  <RestaurantPage
    restaurantName="Les Saisons Gourmandes"
    address="2 place des Tilleuls, Saint-Pierre-de-Jards, 36260, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33254493767"
    website="https://www.lessaisonsgourmandes.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its beams painted Berrichon blue, this is an extremely appealing spot. You are in for a culinary treat, safe in the hands of a chef who draws inspiration from tradition and premium ingredients, producing dishes such as foie gras poached in Reuilly or hay-steamed pigeon. In fine weather, be sure to reserve a table on the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20des%20Tilleuls%2C%20Saint-Pierre-de-Jards%2C%2036260%2C%20France"
    pageTitle="Les Saisons Gourmandes"
  />
);

export default LesSaisonsGourmandes;
