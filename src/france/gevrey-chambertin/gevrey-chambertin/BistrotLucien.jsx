...
const BistrotLucien = () => (
  <RestaurantPage
    restaurantName="Bistrot Lucien"
    address="La Rôtisserie du Chambertin, 6 rue du Chambertin, Gevrey-Chambertin, 21220, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33380343320"
    website="https://www.rotisserie-chambertin.com/bistrot-lucien/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bare stone walls, bench seating and a superb wooden counter set the scene in this bistro, which is housed in its parent hotel. Expertly crafted burgundy recipes take pride of place on the nostalgic menu: home-cured ham, poached egg in wine, Bresse poultry, profiteroles... Fantastic wine list!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20R%C3%B4tisserie%20du%20Chambertin%2C%206%20rue%20du%20Chambertin%2C%20Gevrey-Chambertin%2C%2021220%2C%20France"
    pageTitle="Bistrot Lucien"
  />
);

export default BistrotLucien;
