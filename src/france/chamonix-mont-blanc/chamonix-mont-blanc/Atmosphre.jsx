...
const Atmosphre = () => (
  <RestaurantPage
    restaurantName="Atmosphère"
    address="123 place Balmat, Chamonix-Mont-Blanc, 74400, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450559797"
    website="https://www.restaurant-atmosphere.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Go up the splendid granite staircase, dripping with flowers and plants, to the entrance of this establishment with atmosphere by the bucketload. The pared-down, alpine interior sports a friendly, casual vibe. Should you be given the choice, ask for a table in the conservatory, which commands a knock-out view of the Arve River and the peaks of Chamonix in the distance! Recipes as Gallic as La Marseillaise, regional specialities and game in season take pride of place on the menu. Splendid wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=123%20place%20Balmat%2C%20Chamonix-Mont-Blanc%2C%2074400%2C%20France"
    pageTitle="Atmosphère"
  />
);

export default Atmosphre;
