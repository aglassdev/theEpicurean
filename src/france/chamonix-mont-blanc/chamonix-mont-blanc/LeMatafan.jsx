...
const LeMatafan = () => (
  <RestaurantPage
    restaurantName="Le Matafan"
    address="62 allée du Majestic, Chamonix-Mont-Blanc, 74400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33450553546"
    website="https://www.hotelmontblancchamonix.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the legendary Mont Blanc hotel, in an elegant contemporary setting with a central fireplace, the cuisine varies between traditional dishes (Lyon sausage with truffles; barbecued beef chuck) and more modern preparations (pigeon, endives, ginger broth). The health-conscious can also opt for their set menu (Menu Bien-Être). Outside tables giving onto the large swimming pool are set up when the weather is fine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20all%C3%A9e%20du%20Majestic%2C%20Chamonix-Mont-Blanc%2C%2074400%2C%20France"
    pageTitle="Le Matafan"
  />
);

export default LeMatafan;
