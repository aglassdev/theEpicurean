...
const AubergeDuBoisPrin = () => (
  <RestaurantPage
    restaurantName="Auberge du Bois Prin"
    address="69 chemin de l'Hermine, Chamonix-Mont-Blanc, 74400, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33450533351"
    website="https://boisprin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a smart, contemporary vibe overlooking the legendary Mont Blanc, Emmanuel Renaut and his team craft an Alpine score with a weakness for produce from the garden and the surrounding meadows. Mouth-watering modern dishes steeped in generous, delicate flavours: tartare of beetroot, celery and horseradish sauce; loin of roast venison, stuffed cabbage, game sauce; citrus fruit soufflé…The view from the terrace is particularly breathtaking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=69%20chemin%20de%20l'Hermine%2C%20Chamonix-Mont-Blanc%2C%2074400%2C%20France"
    pageTitle="Auberge du Bois Prin"
  />
);

export default AubergeDuBoisPrin;
