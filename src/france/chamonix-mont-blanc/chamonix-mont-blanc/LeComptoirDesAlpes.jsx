...
const LeComptoirDesAlpes = () => (
  <RestaurantPage
    restaurantName="Le Comptoir des Alpes"
    address="151 avenue de l'Aiguille-du-Midi, Chamonix-Mont-Blanc, 74400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33450535764"
    website="https://comptoir-des-alpes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a modern hotel, this restaurant reflects the Franco-Italian roots of its chef, Daniele Raimondi. His “Ascension” menu rolls out crisp, legible flavours that refuse to compromise on quality: Carnaroli risotto with gorgonzola; agnolotti of smoked ricotta, pistachio and lemon confit; lamb cooked over embers, broccoli orecchiette and Taggiasche olives. One terrace backs onto the street, while another, quieter, overlooks a peaceful square...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=151%20avenue%20de%20l'Aiguille-du-Midi%2C%20Chamonix-Mont-Blanc%2C%2074400%2C%20France"
    pageTitle="Le Comptoir des Alpes"
  />
);

export default LeComptoirDesAlpes;
