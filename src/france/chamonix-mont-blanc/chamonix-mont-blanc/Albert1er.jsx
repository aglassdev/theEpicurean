...
const Albert1er = () => (
  <RestaurantPage
    ...
    address="Hameau Albert-1er, 38 route du Bouchet, Chamonix-Mont-Blanc, 74400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33450530509"
    website="https://www.hameaualbert.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Since it was founded in 1903, this iconic Chamonix establishment has been run by the same family. Chef Damien Leveau’s regional score (Arctic char and whitefish from Lake Geneva, snails from the Mont Blanc area, locally bred pork and lamb) underscored by produce from the herb garden, such as oxalis, lovage, citrus thyme, savory, lemon balm and sage, is served in a stylish, understated interior. The spruce hamlet is also home to Maison Carrier, which serves authentic regional fare in a former Alpine farmstead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hameau%20Albert-1er%2C%2038%20route%20du%20Bouchet%2C%20Chamonix-Mont-Blanc%2C%2074400%2C%20France"
    pageTitle="Albert 1er"
  />
);

export default Albert1er;
