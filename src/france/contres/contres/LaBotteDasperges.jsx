...
const LaBotteDasperges = () => (
  <RestaurantPage
    restaurantName="La Botte d'Asperges"
    address="52 rue Pierre-Henri-Mauger, Contres, 41700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254795049"
    website="https://www.labottedasperges.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a name that conjures up springtime (it means bunch of asparagus), this restaurant delivers delicious cuisine, showcasing local producers and winegrowers as well as herbs from its pretty garden in aesthetically pleasing dishes. At the helm is a professional couple and a chef with a solid track record, Stéphane Bureau – he loves to pop out into the dining area and share his enthusiasm with diners. The comfortable interior is done out in a contemporary bistro style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20rue%20Pierre-Henri-Mauger%2C%20Contres%2C%2041700%2C%20France"
    pageTitle="La Botte d'Asperges"
  />
);

export default LaBotteDasperges;
