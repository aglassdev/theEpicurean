...
const LePrigord = () => (
  <RestaurantPage
    restaurantName="Le Périgord"
    address="9 avenue de Paris, Donzenac, 19270, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33555857234"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/donzenac/restaurant/le-perigord"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you pay a visit to this restaurant covered in Virginia creeper, be sure to try the calf's brains in gribiche sauce. This is one of the house specialities and highly renowned! This place is rustic in the best sense of the word...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20avenue%20de%20Paris%2C%20Donzenac%2C%2019270%2C%20France"
    pageTitle="Le Périgord"
  />
);

export default LePrigord;
