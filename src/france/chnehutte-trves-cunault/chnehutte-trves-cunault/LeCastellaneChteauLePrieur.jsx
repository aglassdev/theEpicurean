...
const LeCastellaneChteauLePrieur = () => (
  <RestaurantPage
    restaurantName="Le Castellane - Château Le Prieuré"
    address="Route du Comte-de-Castellane, Chênehutte-Trèves-Cunault, 49350, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33241679014"
    website="https://www.prieure.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Castellane, part of the Château du Prieuré, serves modern fare that keeps tabs on the seasons and is predominantly local. You can choose between the Empire-inspired dining room or the terrace overlooking the Loire. Each of the guestrooms is individually appointed and fully in keeping with the historic character of the valley of kings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20du%20Comte-de-Castellane%2C%20Ch%C3%AAnehutte-Tr%C3%A8ves-Cunault%2C%2049350%2C%20France"
    pageTitle="Le Castellane - Château Le Prieuré"
  />
);

export default LeCastellaneChteauLePrieur;
