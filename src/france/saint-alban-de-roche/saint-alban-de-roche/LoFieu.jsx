...
const LoFieu = () => (
  <RestaurantPage
    restaurantName="Lo Fieu"
    address="55 route de Lyon, lieu-dit La Grive, Saint-Alban-de-Roche, 38080, France"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33474934408"
    website="https://www.lemulsion-restaurant.com/fr/lo-fieu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his country-style restaurant with a wood fire (Lo Fieu means fire in the local dialect), Romain Hubert and his friendly young team work hard to keep the traditional cuisine of the Dauphiné region alive. A series of comforting and flavourful dishes are prepared right in front of you: soup from the cauldron with Trept chickpea , fried fish from Lake Bourget, sausage (pork or fish) served with gratin dauphinois, and then there is the trolley packed with appetising desserts. The converted barn, which has been restored in a rustic style and wows with its impressive dimensions, provides the perfect setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20route%20de%20Lyon%2C%20lieu-dit%20La%20Grive%2C%20Saint-Alban-de-Roche%2C%2038080%2C%20France"
    pageTitle="Lo Fieu"
  />
);

export default LoFieu;
