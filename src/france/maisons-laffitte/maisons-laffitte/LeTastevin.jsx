...
const LeTastevin = () => (
  <RestaurantPage
    restaurantName="Le Tastevin"
    address="9 avenue Eglé, Maisons-Laffitte, 78600, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33139621167"
    website="https://www.letastevin-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the edge of the park, this elegantly decorated mansion embodies a distinctly French art of living... and gives expression to its love of fine ingredients! Chef Denis Rivoire is of Italian origin and he certainly knows his stuff; he revisits the classics, adding a few Mediterranean touches. Good wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20avenue%20Egl%C3%A9%2C%20Maisons-Laffitte%2C%2078600%2C%20France"
    pageTitle="Le Tastevin"
  />
);

export default LeTastevin;
