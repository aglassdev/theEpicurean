...
const LaPlancha = () => (
  <RestaurantPage
    restaurantName="La Plancha"
    address="5 avenue de Saint-Germain, Maisons-Laffitte, 78600, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33139120375"
    website="https://laplanchadekiko.eatbu.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20avenue%20de%20Saint-Germain%2C%20Maisons-Laffitte%2C%2078600%2C%20France"
    pageTitle="La Plancha"
  />
);

export default LaPlancha;
