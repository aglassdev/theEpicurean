...
const Lalique = () => (
  <RestaurantPage
    restaurantName="Lalique"
    address="1707 route des Gourgues, Bommes, 33210, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33524228011"
    website="https://www.lafauriepeyragueylalique.com/art-de-la-table/le-restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Château Lafaurie-Peyraguey is the ideal setting for a first-rate meal: the lavish dining area is adorned with (you guessed it!) a Lalique crystal chandelier, and the glass-paned extension commands a fine view of the vineyards. Chef Jérôme Schilling boasts a flawless CV (including Guy Lassausaie, Joël Robuchon, Thierry Marx and Meilleur Ouvrier de France 2023) and describes himself as a cuisinier des vignes (cook of the vines). His dishes inspired by the Sauternes terroir sport names such as Interpretation of the 2011 vintage: langoustines, kalamensi and pollen, or the grape seed: hake confit, bergamot and elderflower. The food is served in magnificent crystalware by Lalique and other fine china tableware, upping the table arts ante to a whole new level. A timeless place, where skilful, pre..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1707%20route%20des%20Gourgues%2C%20Bommes%2C%2033210%2C%20France"
    pageTitle="Lalique"
  />
);

export default Lalique;
