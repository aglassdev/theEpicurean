...
const LaubergeLesSourcesDeCheverny = () => (
  <RestaurantPage
    ...
    pageTitle="L'Auberge - Les Sources de Cheverny"
  />
);

export default LaubergeLesSourcesDeCheverny;
