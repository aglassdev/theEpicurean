...
const LeFavoriLesSourcesDeCheverny = () => (
  <RestaurantPage
    restaurantName="Le Favori - Les Sources de Cheverny"
    address="23 route de Fougère, Cheverny, 41700, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33254442020"
    website="https://www.sources-hotels.com/valdeloire/restaurants/restaurant-le-favori/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the heart of a wooded estate, this venue sets the scene for a culinary experience that is both delicate and daring under the auspices of Pierre Frindel, formerly at Sources de Caudalie. The chef delicately crafts local and less local produce, deploying his consummate skill and subtle creativity. Each dish strikes an accomplished, harmonious balance between tradition and modernity, depicted by a breast of Bresse poultry, melt-in-the-mouth aubergine, smoked caviar and crunchy confit leg, underscored by a saffron jus, or by John Dory in nasturtium oil. Spot-on cooking, elegant plating and a dining room turned towards the countryside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20route%20de%20Foug%C3%A8re%2C%20Cheverny%2C%2041700%2C%20France"
    pageTitle="Le Favori - Les Sources de Cheverny"
  />
);

export default LeFavoriLesSourcesDeCheverny;
