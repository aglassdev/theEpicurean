...
const LaDiligence = () => (
  <RestaurantPage
    restaurantName="La Diligence"
    address="13 rue du Bourg, La Ferté-Saint-Cyr, 41220, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33254879014"
    website="https://hotel-la-diligence.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This nicely restored former coaching inn offers tasty dishes showcasing produce of the local terroir; it also has comfortable guestrooms and a popular summer swimming pool. The welcome is particularly charming. A restaurant that is as friendly as it is stylish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20du%20Bourg%2C%20La%20Fert%C3%A9-Saint-Cyr%2C%2041220%2C%20France"
    pageTitle="La Diligence"
  />
);

export default LaDiligence;
