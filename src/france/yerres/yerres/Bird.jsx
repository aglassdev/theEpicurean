...
const Bird = () => (
  <RestaurantPage
    restaurantName="Bird"
    address="38 rue Charles-de-Gaulle, Yerres, 91330, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33179932881"
    website="https://www.bird-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of this charming borough, on a pedestrian square near the town hall, a pocket-sized restaurant run by a young chef with an impressive cv. Market-inspired menu with the likes of fresh pasta with mussels, calamari and langoustines, or poultry quenelles with freekeh... Scandinavian style dining room, terrace overlooking a fountain. Delicious prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20Charles-de-Gaulle%2C%20Yerres%2C%2091330%2C%20France"
    pageTitle="Bird"
  />
);
