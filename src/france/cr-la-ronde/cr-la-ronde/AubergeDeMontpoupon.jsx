...
const AubergeDeMontpoupon = () => (
  <RestaurantPage
    restaurantName="Auberge de Montpoupon"
    address="Le Moulin Bailly, Céré-la-Ronde, 37460, France"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33970372255"
    website="https://auberge-montpoupon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A friendly inviting inn established at the foot of the castle of Montpoupon. The interior sports a fashionable patchwork of rustic (bare stone and beams) and contemporary details, while the menu takes you on a gourmet tour of the Val de Loire’s succulent produce. Prices that make sense and a terrace with a view of the castle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Moulin%20Bailly%2C%20C%C3%A9r%C3%A9-la-Ronde%2C%2037460%2C%20France"
    pageTitle="Auberge de Montpoupon"
  />
);

export default AubergeDeMontpoupon;
