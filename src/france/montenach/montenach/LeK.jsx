...
const LeK = () => (
  <RestaurantPage
    restaurantName="Le K"
    address="Domaine de la Klauss, 2 impasse du Klaussberg, Montenach, 57480, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33382831975"
    website="https://www.domainedelaklauss.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This imposing stone edifice near France's borders with Germany and Luxembourg has retained its family atmosphere. At Le K, beneath heavy timber rafters and a Treviso crystal chandelier, chef Benoit Potdevin rolls out refined, delicate fare in tune with the zeitgeist. Crab's legs and claws in a refreshing Calamansi vinaigrette, served with caviar; roast scallops, Jerusalem artichoke and a jus of scallop skirt with Moselle whisky; gin-flavoured loin of venison, a medley of carrots and a gutsy juniper-flavoured gravy are just a few examples. There is also a “Market Garden” set menu, while the more informal Le Komptoir serves tapas and wood-fired cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20de%20la%20Klauss%2C%202%20impasse%20du%20Klaussberg%2C%20Montenach%2C%2057480%2C%20France"
    pageTitle="Le K"
  />
);
