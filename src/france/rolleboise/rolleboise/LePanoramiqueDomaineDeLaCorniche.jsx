...
const LePanoramiqueDomaineDeLaCorniche = () => (
  <RestaurantPage
    restaurantName="Le Panoramique - Domaine de la Corniche"
    address="5 route de la Corniche, Rolleboise, 78270, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33130932000"
    website="https://www.domainedelacorniche.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This charming hotel perched on a chalk cliff was originally commissioned in 1908 by King Leopold II of Belgium so that he could entertain his lover, Blanche de Vaughan, but it is now a magnet for foodies. Sourcing local produce is central to the estate’s outlook: scallops from the Bay of the Seine, farm-reared lamb from nearby breeders and fresh fruit and vegetables from local growers. The result is recipes oozing in fresh, crisp, wholesome flavours. When the weather is fine, alfresco dining on the terrace gazing down over the meanders of the Seine is heavenly. On the other side of the street, Le 20 du Domaine serves simpler fare, ideal for a gourmet snack...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20route%20de%20la%20Corniche%2C%20Rolleboise%2C%2078270%2C%20France"
    pageTitle="Le Panoramique - Domaine de la Corniche"
  />
);

export default LePanoramiqueDomaineDeLaCorniche;
