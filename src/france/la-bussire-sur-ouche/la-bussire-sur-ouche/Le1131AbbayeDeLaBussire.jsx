...
const Le1131AbbayeDeLaBussire = () => (
  <RestaurantPage
    restaurantName="Le 1131 - Abbaye de la Bussière"
    address="Route départementale 33, La Bussière-sur-Ouche, 21360, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33380490229"
    website="https://www.abbayedelabussiere.fr/fr/restaurant-1131.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You simply couldn't dream up a more inspiring location than this 12C Cistercian abbey! Beneath an impressive rib-vaulted ceiling, a beautiful tribute is paid to Burgundy's terroir in dishes incorporating snails, frogs' legs, lake and river fish, blackcurrants, and honey from the abbey's flowers. Stretch your legs in the 7ha grounds or book a stay in one of the luxurious guestrooms. At lunch, simpler cuisine at Le Bistrot des Moines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20d%C3%A9partementale%2033%2C%20La%20Bussi%C3%A8re-sur-Ouche%2C%2021360%2C%20France"
    pageTitle="Le 1131 - Abbaye de la Bussière"
  />
);

export default Le1131AbbayeDeLaBussire;
