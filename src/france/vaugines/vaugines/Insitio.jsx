...
const Insitio = () => (
  <RestaurantPage
    restaurantName="Insitio"
    address="33 place de la Mairie, Vaugines, 84160, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490771108"
    website="https://www.insitiorestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arkhé (or arche) means both beginning, origin and principle – the Italian-born chef from Milan hasn’t forgotten his Greek philosophy classes! The menu changes weekly but you may taste “surprise” egg with courgettes and verbena; saddle of rabbit with artichokes and fresh mint followed by roast apricot with lavender honey and vanilla ice cream. Flanked by a shaded terrace overlooking the square of this delightful village in which a fountain plays, the location could not be more idyllic, and, who knows, maybe give us time to ponder the origin of taste…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20place%20de%20la%20Mairie%2C%20Vaugines%2C%2084160%2C%20France"
    pageTitle="Insitio"
  />
);

export default Insitio;
