...
const CafLouise = () => (
  <RestaurantPage
    restaurantName="Café Louise"
    address="10 place de l'Ancien-Hôtel-de-Ville, Périgueux, 24000, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+33553089385"
    website="https://guide.michelin.com/en/nouvelle-aquitaine/prigueux/restaurant/cafe-louise"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The idea was to unite Italian cuisine and the dishes of Périgord's terroir – and Maryse Benoit-Gonin and her husband have done just that in this cosy bistro. The generous, lovingly prepared dishes combine the best of both worlds: potato gnocchi with Périgord walnut oil; guinea fowl and pancetta terrine with foie gras; Périgord beef meatball alla milanese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20place%20de%20l'Ancien-H%C3%B4tel-de-Ville%2C%20P%C3%A9rigueux%2C%2024000%2C%20France"
    pageTitle="Café Louise"
  />
);

export default CafLouise;
