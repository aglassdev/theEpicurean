...
const LeQuai = () => (
  <RestaurantPage
    restaurantName="Le Quai"
    address="20 quai de Verdun, Tournus, 71700, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33385303972"
    website="http://www.lequaitournus.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the banks of the Saône, this quayside brasserie boasts a very pleasant terrace right beside the river. In charge of proceedings is chef Valéry Meulien, who was trained by Jean Ducloux and Paul Bocuse, and later earned a Michelin star himself. His dishes focus on the region's classics, including pâté croûte, ham terrine with parsley, calf's head, and sweetbreads with morel cream. The flavoursome red wine sauce sprinkled with chopped parsley that accompanies the œufs en meurette is proof that the chef has by no means lost his touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20quai%20de%20Verdun%2C%20Tournus%2C%2071700%2C%20France"
    pageTitle="Le Quai"
  />
);

export default LeQuai;
