...
const LeVoyageDernestine = () => (
  <RestaurantPage
    restaurantName="Le Voyage d'Ernestine"
    address="182 Grand-Rue, Alvignac, 46500, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565117620"
    website="https://www.le-voyage-ernestine.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Between Rocamadour and Padirac, this fabulous family-run restaurant is a treat for foodies! A team of three (twins – a brother and sister – plus her partner) take their guests on a culinary journey showcasing local produce: lamb from Ferme Bouscarel (a family farm), vegetables from Tauriac, and trout from the small-scale fish farm, Le Gouffre du Blagour. A butcher and charcutier by trade, the brother is an expert when it comes to cuts of meat. As for this widely travelled couple, they punctuate their dishes with international touches: za'atar, black lemon and even a mayonnaise with spicy Korean ssamjang. Don't hesitate to book a table at this restaurant with its finger on the pulse!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=182%20Grand-Rue%2C%20Alvignac%2C%2046500%2C%20France"
    pageTitle="Le Voyage d'Ernestine"
  />
);

export default LeVoyageDernestine;
