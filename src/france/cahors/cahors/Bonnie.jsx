...
const Bonnie = () => (
  <RestaurantPage
    restaurantName="Bonnie"
    address="27 place Jean-Jacques-Chapou, Cahors, 46000, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33624477420"
    website="https://www.bonnierestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Is there anything France's talented female chefs can't do? Charlotte Bauduret – Bonnie is her maiden name – brings together her two passions at this establishment: cooking (modern, vibrant, indulgent, rooted in tradition but elevated with personal touches) and the applied arts. She herself painted the large floral frescoes on the walls and created the restaurant's entire visual identity. Her partner, meanwhile, provides enthusiastic service and dispenses expert advice on wine pairings. On the menu: asparagus roll with pine nuts and guanciale; cod with kombu and tarragon-infused pea mousseline; broad-bean gnocchi in a creamy artichoke and parmesan sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20place%20Jean-Jacques-Chapou%2C%20Cahors%2C%2046000%2C%20France"
    pageTitle="Bonnie"
  />
);
