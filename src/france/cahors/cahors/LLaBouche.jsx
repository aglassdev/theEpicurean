...
const LLaBouche = () => (
  <RestaurantPage
    ...
    address="56 allées Fénelon, Cahors, 46000, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33565356569"
    website="https://www.loalabouche-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the head of this pleasant restaurant is a foodie couple who travelled to faraway lands and seas before dropping anchor in Cahors. Jean - François concocts gourmet dishes such as: salmon marinated in fennel or wild seabass, pan - fried chard and Lautrec pink garlic cromesquis. Enough to make your mouth water!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20all%C3%A9es%20F%C3%A9nelon%2C%20Cahors%2C%2046000%2C%20France"
    pageTitle="L'Ô à la Bouche"
  />
);

export default LLaBouche;
