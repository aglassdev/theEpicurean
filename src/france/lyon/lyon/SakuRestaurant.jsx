...
const SakuRestaurant = () => (
  <RestaurantPage
    restaurantName="Saku Restaurant"
    address="27 rue Rachais, Lyon, 69007, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478694531"
    website="https://www.sakurestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Saku is the nickname of the chef of this establishment tucked away behind a nondescript façade. He and his wife, both of whom are Japanese, prepare jubilant Gallic cuisine in keeping with today’s tastebuds. The produce is fresh, the dishes are meticulously prepared, at common-sense prices, and the service is friendly; an enjoyable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20Rachais%2C%20Lyon%2C%2069007%2C%20France"
    pageTitle="Saku Restaurant"
  />
);

export default SakuRestaurant;
