...
const DanielEtDeniseCrqui = () => (
  <RestaurantPage
    restaurantName="Daniel et Denise Créqui"
    address="156 rue de Créqui, Lyon, 69003, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33478606653"
    website="https://danieletdenise.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Joseph Viola, Best Craftsman of France, reigns over this dyed-in-the-wool, patina-aged bolthole, oozing in authenticity. Patriotic line-up of Gallic recipes, high-flying technique (calf’s head, quenelle of pike) founded on superlative ingredients with an eye on the seasons. His signature dish is a “porkpie” of sweetbread and foie gras – to die for!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=156%20rue%20de%20Cr%C3%A9qui%2C%20Lyon%2C%2069003%2C%20France"
    pageTitle="Daniel et Denise Créqui"
  />
);

export default DanielEtDeniseCrqui;
