...
const LeGrandRfectoire = () => (
  <RestaurantPage
    restaurantName="Le Grand Réfectoire"
    address="3 cour Saint-Henri, Grand Hôtel-Dieu, Lyon, 69002, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33472418496"
    website="https://legrandrefectoire.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the grandiose Hôtel Dieu, beneath the hundred-year-old vaults of the nuns’ former refectory, the menu of this huge brasserie is signed by Marcel Ravin (2*-chef of Monaco’s Blue Bay). The modern food is sprinkled with exotic West Indian influences. The swish rooftop bar (L’Officine) draws city slickers like bees to honey, as does the exquisite patio in the inner courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20cour%20Saint-Henri%2C%20Grand%20H%C3%B4tel-Dieu%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Le Grand Réfectoire"
  />
);

export default LeGrandRfectoire;
