...
const CulinaHortus = () => (
  <RestaurantPage
    restaurantName="Culina Hortus"
    address="38 rue de l'Arbre-Sec, Lyon, 69001, France"
    cuisine="Vegetarian"
    priceRange="€€€"
    phoneNumber="+33469847108"
    website="https://www.culinahortus.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This vegetarian restaurant offers beautifully crafted dishes that are unabashedly creative in a tasting set menu made with seasonal ingredients. The food is paired with a concise organic and biodynamic wine list, to enjoy in a snug, modern decor of wood, concrete, adobe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20rue%20de%20l'Arbre-Sec%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Culina Hortus"
  />
);

export default CulinaHortus;
