...
const MaisonLa = () => (
  <RestaurantPage
    restaurantName="Maison Léa"
    address="11 quai des Célestins, Lyon, 69002, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33478420133"
    website="https://lamerelea.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This culinary landmark on the Saône embankment enjoys a fine view of the Fourvière and St-Jean districts. Hearty Lyon specialities still feature prominently in two good value-for-money set menus and a well-crafted à la carte menu. Simpler fare at the next-door Bouchon Léa, the historic cradle of Mère Léa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20quai%20des%20C%C3%A9lestins%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Maison Léa"
  />
);

export default MaisonLa;
