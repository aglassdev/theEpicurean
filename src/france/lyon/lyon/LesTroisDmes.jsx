...
const LesTroisDmes = () => (
  <RestaurantPage
    restaurantName="Les Trois Dômes"
    address="Sofitel Lyon Bellecour, 20 quai du Docteur-Gailleton, Lyon, 69002, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33472412097"
    website="https://www.les-3-domes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In addition to knockout views over the city, the rooftop restaurant of the Sofitel Lyon Bellecour serves pared-down cuisine in a contemporary brasserie vein (tartare of seabream and langoustine, semi-smoked confit of centre-cut salmon, faux-filet of Black Angus, baba of seasonal fruit). The chef is also keen on fish and seafood, exemplified by scallops, butternut and sweet chestnuts or thinly sliced John Dory in a seaweed butter and parsnips à la royale (butter, cream, eggs)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sofitel%20Lyon%20Bellecour%2C%2020%20quai%20du%20Docteur-Gailleton%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Les Trois Dômes"
  />
);

export default LesTroisDmes;
