...
const LeNeuvimeArt = () => (
  <RestaurantPage
    ...
    priceRange="€€€€"
    phoneNumber="+33472741274"
    website="https://www.leneuviemeart.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It was in the kitchens of Paul Bocuse and Régis Marcon, among others, that Christophe Roure learned the ropes. He holds three professional qualifications (in cookery, charcuterie and pastry-making, no less!) and was named Meilleur Ouvrier de France in 2007. Based in Lyon since 2014, he showcases his qualities as a chef day in, day out: subtle inventiveness, precision in his marriages of flavours, and of course an impeccable choice of ingredients. For example, his shellfish and miller mushroom ragoût is a marvel of balance and finesse, in which the lemongrass-scented hollandaise sauce teases out the seafood flavours and undergrowth notes of the mushroom. To be savoured with all of one's senses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=173%20rue%20Cuvier%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Le Neuvième Art"
  />
);

export default LeNeuvimeArt;
