...
const LaSommelire = () => (
  <RestaurantPage
    restaurantName="La Sommelière"
    address="6 rue Mourguet, Lyon, 69005, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33478798645"
    website="https://www.la-sommeliere.net/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20rue%20Mourguet%2C%20Lyon%2C%2069005%2C%20France"
    pageTitle="La Sommelière"
  />
);

export default LaSommelire;
