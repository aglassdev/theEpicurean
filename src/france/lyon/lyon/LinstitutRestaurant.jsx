...
const LinstitutRestaurant = () => (
  <RestaurantPage
    restaurantName="L'Institut Restaurant"
    address="Le Royal, 20 place Bellecour, Lyon, 69002, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33428316906"
    website="https://www.linstitut-restaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Place Bellecour, this training restaurant feels nothing like a school! In a contemporary decor designed by Pierre - Yves Rochon, with open kitchens giving onto the restaurant, the students deliver a high standard of service. The dishes are extremely well made and deserve a high mark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Royal%2C%2020%20place%20Bellecour%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="L'Institut Restaurant"
  />
);

export default LinstitutRestaurant;
