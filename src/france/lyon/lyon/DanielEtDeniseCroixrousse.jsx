...
const DanielEtDeniseCroixrousse = () => (
  <RestaurantPage
    restaurantName="Daniel et Denise Croix-Rousse"
    address="8 rue de Cuire, Lyon, 69004, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33478282744"
    website="https://danieletdenise.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Daniel and Denise Croix - Rousse – the third in the series, after locations on rue de Créqui and in the St Jean quarter – is enjoying the same success as its older siblings. Fill up on hearty Lyon cuisine in a traditional bouchon (tavern) setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20rue%20de%20Cuire%2C%20Lyon%2C%2069004%2C%20France"
    pageTitle="Daniel et Denise Croix-Rousse"
  />
);

export default DanielEtDeniseCroixrousse;
