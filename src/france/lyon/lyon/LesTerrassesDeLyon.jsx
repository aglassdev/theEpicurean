...
const LesTerrassesDeLyon = () => (
  <RestaurantPage
    restaurantName="Les Terrasses de Lyon"
    address="Villa Florentine, 25 montée Saint-Barthélémy, Lyon, 69005, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33472565656"
    website="https://www.villaflorentine.com/fr/restaurant.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the famous Fourvière hillside, this former Renaissance convent now houses a restaurant with a panoramic glazed dining room that commands a splendid view over the rooftops of historic Lyon and St Jean Cathedral. The talented chef puts a regional spin on Gallic traditions: ravioles of rigotte cheese, free-range squab sautéed in Bresse butter, rump steak from the Auvergne mountains and a frothy whipped béarnaise sauce… All of which is served in a stylish setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Villa%20Florentine%2C%2025%20mont%C3%A9e%20Saint-Barth%C3%A9l%C3%A9my%2C%20Lyon%2C%2069005%2C%20France"
    pageTitle="Les Terrasses de Lyon"
  />
);

export default LesTerrassesDeLyon;
