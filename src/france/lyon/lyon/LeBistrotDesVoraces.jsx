...
const LeBistrotDesVoraces = () => (
  <RestaurantPage
    restaurantName="Le Bistrot des Voraces"
    address="13 rue d'Austerlitz, Lyon, 69004, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33472077186"
    website="https://www.bistrotdesvoraces.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Do you just have a healthy appetite or are you downright starving? Either way, this bistro in the Croix-Rousse district will sate you. Youthful Cédric Blin honed his skills in top establishments like Les Crayères (Reims), before going solo here. Genuinely eater-friendly, almost bargain prices – not to be missed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20rue%20d'Austerlitz%2C%20Lyon%2C%2069004%2C%20France"
    pageTitle="Le Bistrot des Voraces"
  />
);

export default LeBistrotDesVoraces;
