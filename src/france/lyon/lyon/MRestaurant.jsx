...
const MRestaurant = () => (
  <RestaurantPage
    ...
    address="47 avenue Maréchal-Foch, Lyon, 69006, France"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+33478895519"
    website="https://www.mrestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cocktail of vitamins! Julien Gautier’s cheerful establishment adds a whiff of exuberance to Lyon’s well-heeled, tree-lined Avenue Foch. The smart interior sports a muted blue and flashy orange colour scheme, felt grey designer armchairs, linen tablecloths, a bar and a wine cellar encircled by a conservatory… The similarly charismatic service is as smooth as a silky béarnaise sauce. In the kitchen, the veteran and talented chef, formerly of Léon of Lyon, rustles up an appetising, market-sourced menu, combining flawless technique and know-how in a bid to pamper our tastebuds with delicate flavours tailored to modern appetites. The honey-flavoured madeleines served with a fromage blanc sorbet are awesome!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20avenue%20Mar%C3%A9chal-Foch%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="M Restaurant"
  />
);
