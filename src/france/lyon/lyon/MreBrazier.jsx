...
const MreBrazier = () => (
  <RestaurantPage
    ...
    address="12 rue Royale, Lyon, 69001, France"
    ...
    bio="Eugénie Brazier (1895-1977), an exceptional chef who inspired an entire branch of French cuisine, obtained three stars in two different establishments. It is in her Lyon restaurant, on rue Royale, that Mathieu Viannay gives his take on the Brazier legend. In a magnificent hybrid decor, 1930s stained glass windows and mouldings are blended with Saarinen Tulip chairs (a bold design move!) and the chef pays a vibrant tribute to the iconic dishes once served on the premises (Bresse chicken with truffles, crispy pike bread, a stunning Grand Marnier soufflé), infusing them with his talent and novel ideas. Be sure to try the lunch menu, which represents the best value for money. When it comes to dessert, pastry chef Rodolphe Tronc, who has worked for Pierre Gagnaire among others, takes no prisone..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20rue%20Royale%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Mère Brazier"
  />
);

export default MreBrazier;
