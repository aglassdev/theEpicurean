...
const LeKitchen = () => (
  <RestaurantPage
    restaurantName="Le Kitchen"
    address="34 rue Chevreul, Lyon, 69007, France"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+33603364275"
    website="https://www.lekitchenlyon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the student area of two of the city's universities (Lumière and Jean Moulin), Le Kitchen is thriving. The interior is a delightful marriage of Art Deco and Scandinavian elements – one of the owners was born in Stockholm. Her pastry chef partner stocks the pastry display case with mouth-watering treats (to eat in or take away). Note that they open for breakfast and afternoon tea, but not for dinner. The dishes are delicate and indulgent, made with organic produce from the region, especially when it comes to vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20rue%20Chevreul%2C%20Lyon%2C%2069007%2C%20France"
    pageTitle="Le Kitchen"
  />
);

export default LeKitchen;
