...
const LeJeanMoulin = () => (
  <RestaurantPage
    restaurantName="Le Jean Moulin"
    address="45 rue de Sèze, Lyon, 69006, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478373797"
    website="https://lejeanmoulin-lyon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tables are set up on either side of this elongated dining space divided by a glazed wine cellar. The industrial loft-inspired designer decor is the perfect foil to Grégoire Baratier's contemporary cuisine. The menu changes regularly, but here are two examples to give you an idea of the market-fresh cooking served here: a delicate, crispy tartlet with Burgundy snails, creamy mushrooms and parsley pesto; and a moist cake made from Ardèche chestnuts, with a few meringues, candied clementine and a pear and cardamom sorbet. Fresh, well-crafted cuisine, with the occasional nod to Lyon's culinary heritage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20rue%20de%20S%C3%A8ze%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Le Jean Moulin"
  />
);

export default LeJeanMoulin;
