...
const LeSully = () => (
  <RestaurantPage
    restaurantName="Le Sully"
    address="20 rue Sully, Lyon, 69006, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33489410797"
    website="https://www.lesullylyon.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small bistro, opened by Julien Gautier (owner of neighbouring M Restaurant) in a modernised bouchon vein, tantalises diners with dishes such as chicken liver gâteau, veal liver en persillade (with parsley and garlic) and calf's head with sauce ravigote. It is tasty, well made and you will be going back for more!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20rue%20Sully%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Le Sully"
  />
);

export default LeSully;
