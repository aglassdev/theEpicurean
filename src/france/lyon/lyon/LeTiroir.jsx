...
const LeTiroir = () => (
  <RestaurantPage
    restaurantName="Le Tiroir"
    address="20 grande rue de Vaise, Lyon, 69009, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478647596"
    website="https://restaurant-letiroir.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This irresistibly endearing eatery in the working-class district of Vaise is appointed in a trendy bistro vibe. The bouncy, youthful team rustles up food that slaloms between mussels in a curry dressing with sweet potato powder and a more patriotic Gallic repertory (beef tartare, foie gras). The menus and carte are regularly renewed. Excellent value for money and pleasure, including in the evenings, hence the loyal crowd of regulars...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20grande%20rue%20de%20Vaise%2C%20Lyon%2C%2069009%2C%20France"
    pageTitle="Le Tiroir"
  />
);

export default LeTiroir;
