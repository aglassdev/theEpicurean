...
const BrutalLYO = () => (
  <RestaurantPage
    restaurantName="Brutal"
    address="3 rue des Remparts-d'Ainay, Lyon, 69002, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33980758052"
    website="https://www.brutal.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On a peaceful street corner in Lyon's Presqu'île neighbourhood, this neo-bistro has stylish credentials: a counter with a few seats, raw concrete pillars, an open kitchen behind an industrial-style glass partition, dim lighting, and electronic music playing softly. Chef Alban Joriot (Têtedoie, Le Neuvième Art, L'Établi) turns out seasonal dishes featuring clever flavour combinations, executed with precision and bags of character. Think white radish marinated in chilli, house-made pita, tempura vegetables; stone bass stuffed with wild garlic, braised sucrine lettuce, smoked tarama. There is a simpler set menu at lunchtime; more ambitious cuisine in the evening. A top-quality restaurant with a laid-back, trendy vibe: brutal by name, refined by nature!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20des%20Remparts-d'Ainay%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Brutal"
  />
);

export default BrutalLYO;
