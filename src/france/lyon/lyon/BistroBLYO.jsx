...
const BistroBLYO = () => (
  <RestaurantPage
    restaurantName="Bistro B"
    address="90 rue Duguesclin, Lyon, 69006, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478891221"
    website="https://bistro-b.eatbu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This friendly neo-bistro in Lyon's 6th arrondissement offers a traditional menu in the zeitgeist with the odd globetrotting influence: tataki of beef and miso, celeriac marinated in walnut vinegar; leg of guinea fowl, truffle-flavoured mashed potatoes and mushrooms; hake with bok choy cabbage, seasonal veg and curry sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=90%20rue%20Duguesclin%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Bistro B"
  />
);

export default BistroBLYO;
