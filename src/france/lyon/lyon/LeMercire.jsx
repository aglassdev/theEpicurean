...
const LeMercire = () => (
  <RestaurantPage
    restaurantName="Le Mercière"
    address="56 rue Mercière, Lyon, 69002, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33478376735"
    website="https://lemerciere.eatbu.com/?lang=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the neighbourhood of Les Cordeliers, this bouchon founded by Jean-Louis Manoa is a master class in traditional Lyonnais cuisine: saucisson chaud lyonnais (sausage), œuf meurette (eggs in a red wine sauce), quenelle de brochet (pike quenelle) or string-drawn andouillette from renowned producer Bobosse. Everything is made in-house, in a spirit of generosity and in time-honoured tradition, whetting the appetites of diners – locals and tourists alike – who are seated cheek by jowl in an inviting atmosphere. Behind the alluring red façade is a double dining room separated by a covered pedestrian passageway – reminiscent of those you find in Paris...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20rue%20Merci%C3%A8re%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Le Mercière"
  />
);

export default LeMercire;
