...
const LaMeunire = () => (
  <RestaurantPage
    restaurantName="La Meunière"
    address="11 rue Neuve, Lyon, 69001, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33478286291"
    website="https://www.lameuniere.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 1921 in the Presqu'île area, this bouchon with an authentic retro setting hasn't aged a bit. The menu features generous, popular Lyonnais cuisine, with specialities such as tablier de sapeur with gribiche sauce, house-made escargot quenelles, kid goat sweetbreads, calf's head, pink praline flan pâtissier. The colourful front-of-house team brings character to this buzzing spot, where locals and tourists in search of delicious food and authenticity rub shoulders...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Neuve%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="La Meunière"
  />
);

export default LaMeunire;
