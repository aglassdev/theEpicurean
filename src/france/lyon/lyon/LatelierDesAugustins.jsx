...
const LatelierDesAugustins = () => (
  <RestaurantPage
    restaurantName="L'Atelier des Augustins"
    address="17 rue Hippolyte-Flandrin, Lyon, 69001, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33472008801"
    website="https://latelierdesaugustins.com/fr/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After stints in the kitchens of top establishments and the French embassies of London and Bamako, Nicolas Guilloton has turned his ‘workshop’ into a stylish, contemporary venue. The African masks decorating the spacious dining area are a nod to the chef's time in Mali. With Thomas Belval, his steadfast right-hand man, he delights diners with surprise menus that showcase his flair for balanced flavours and his commitment to locally sourced ingredients. The resulting repertory is original, high-flying, filled with flavour and demonstrates a savvy style when it comes to veggies. The lunchtime menu is a steal. The wine cellar reflects a genuine quest for eco-responsible producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20Hippolyte-Flandrin%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="L'Atelier des Augustins"
  />
);

export default LatelierDesAugustins;
