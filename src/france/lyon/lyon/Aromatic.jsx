...
const Aromatic = () => (
  <RestaurantPage
    restaurantName="Aromatic"
    address="15 rue du Chariot-d'Or, Lyon, 69004, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478237361"
    website="https://aromaticrestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here in the neighbourhood of La Croix-Rousse, Frédéric Taghavi serves up modern and inventive recipes that add a new twist to culinary traditions, as well as drawing on international influences: scallops from Saint-Brieuc Bay, sweet potato and beurre blanc with mango vinegar; Ibérico Bellota pork cheek, foie gras jus and roasted celeriac; Vosges quail thigh in pastilla, hummus and watercress coulis...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20rue%20du%20Chariot-d'Or%2C%20Lyon%2C%2069004%2C%20France"
    pageTitle="Aromatic"
  />
);
