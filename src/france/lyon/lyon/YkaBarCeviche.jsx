...
const YkaBarCeviche = () => (
  <RestaurantPage
    restaurantName="Yka bar & ceviche"
    address="112 boulevard des Belges, Lyon, 69006, France"
    cuisine="Peruvian"
    priceRange="€€"
    phoneNumber="+33478244971"
    website="https://www.restaurant-miraflores.com/yka/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The casual sibling of the Franco-Peruvian star-rated gastronomic Miraflores, Yka is the perfect venue for afterwork socialising in the Brotteaux district. Relax in the warm contemporary vibe (the colourful mural depicts Peruvians from the Cusco region), while sipping a pisco cocktail and nibbling on warm flaky pastry empanadas stuffed with beef and green peas or a ceviche from the wide range on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%20boulevard%20des%20Belges%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Yka bar & ceviche"
  />
);

export default YkaBarCeviche;
