...
const LeCochonQuiBoit = () => (
  <RestaurantPage
    restaurantName="Le Cochon qui Boit"
    address="23 rue Royale, Lyon, 69001, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478272337"
    website="https://www.lecochonquiboit.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two former colleagues from Têtedoie have joined forces at The Drinking Pig! Savour tasty meat dishes (farm-reared guinea fowl from the Dombes, fillet roasted whole and the leg confit, chestnut and chard) and try out clever combinations (a chocolate ganache served hot with sweet woodruff ice cream). The well-sourced local produce is cooked just right: organic fruit and vegetables, Monts du Lyonnais escargots, veal from the Ain, chocolate from a master chocolatier in Voiron. Choose from small-batch wines for the perfect accompaniment, and enjoy in a warm and friendly atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20rue%20Royale%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Le Cochon qui Boit"
  />
);

export default LeCochonQuiBoit;
