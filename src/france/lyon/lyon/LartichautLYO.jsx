...
const LartichautLYO = () => (
  <RestaurantPage
    ...
    address="Hôtel de l'Abbaye, 20 rue de l'Abbaye-d'Ainay, Lyon, 69002, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478056902"
    website="https://hotelabbayelyon.com/restaurant-artichaut/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a presbytery converted into a charming hotel, this delightful cosy restaurant serves delicious contemporary cuisine that is aligned with the seasons: cep cream and Ardèche chestnut chunks; meunière-style sturgeon fillet, matelote sauce. The chef's modern cuisine is simple and well executed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20de%20l'Abbaye%2C%2020%20rue%20de%20l'Abbaye-d'Ainay%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="L'Artichaut"
  />
);

export default LartichautLYO;
