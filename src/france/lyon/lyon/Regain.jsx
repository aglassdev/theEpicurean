...
const Regain = () => (
  <RestaurantPage
    ...
    address="3 rue d'Algérie, Lyon, 69001, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33981106508"
    website="https://www.regainrestaurant.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Near the Saône embankment, a youthful team crafts appetising market-fresh fare that respects the seasons (mackerel, ginger, avocado and radishes; whiting in quenelle and poached, cauliflower; tagliatelle of rice, orange and coriander). The lunchtime menu offers a concise choice of dishes, while more extensive tasting menus set the scene in the evenings. The bright airy interior sports an artfully distressed industrial vibe and a ubiquitous open kitchen. The expert sommelière can be relied upon to ply you with insightful tips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20d'Alg%C3%A9rie%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Regain"
  />
);
