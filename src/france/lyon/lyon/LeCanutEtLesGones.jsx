...
const LeCanutEtLesGones = () => (
  <RestaurantPage
    restaurantName="Le Canut et les Gones"
    address="29 rue Belfort, Lyon, 69004, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478291723"
    website="https://lecanutetlesgones.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This authentic neighbourhood institution, decked in an understated façade, has been going strong for over 30 years in a relatively little-known part of Croix Rousse. A warm vibe with a retro feel sets the scene courtesy of a Formica bar, vintage wallpaper and a quirky collection of old clocks and other paraphernalia. Chef Junzo Matsuno deftly crafts polished traditional Gallic fare, to which he may add the odd low-key Japanese twist, together with a strong focus on veggies (which he grows himself). The lunch menu is a steal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Belfort%2C%20Lyon%2C%2069004%2C%20France"
    pageTitle="Le Canut et les Gones"
  />
);

export default LeCanutEtLesGones;
