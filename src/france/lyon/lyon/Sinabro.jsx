...
const Sinabro = () => (
  <RestaurantPage
    restaurantName="Sinabro"
    address="126 rue de Sèze, Lyon, 69006, France"
    cuisine="Korean"
    priceRange="€"
    phoneNumber="+33478527434"
    website="https://www.sinabro.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the mood for bibimbap and authentic Korean cuisine? Then this bistro is the right place for you! On the programme: a concise menu, splendid meat, meticulously sourced by a MOF, slick, smiling service, and, of course, healthy, flavoursome food – right down to the desserts and all made from scratch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=126%20rue%20de%20S%C3%A8ze%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Sinabro"
  />
);
