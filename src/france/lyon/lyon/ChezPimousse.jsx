...
const ChezPimousse = () => (
  <RestaurantPage
    restaurantName="Chez Pimousse"
    address="27 quai Saint-Vincent, Lyon, 69001, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33982477360"
    website="https://www.chezpimousse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pierre-Michaël Martin, otherwise known as Pimousse, has set up shop on Quai Saint-Vincent, overlooking Vieux Lyon and the River Saône. The light-filled dining room is reminiscent of a country villa, with its old wooden tables, classic bistro chairs, dried grasses and wooden bar. He greets regulars with a smile, occasionally even pitching in with the service. He wins diners over with his meticulously crafted dishes and surprise menus, based on impeccably fresh top-notch produce. Think John Dory fillet, peas and asparagus with pickled berries and a creamy smoked pike roe sauce. In fine weather, don't miss the lovely terrace beneath the plane trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20quai%20Saint-Vincent%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Chez Pimousse"
  />
);

export default ChezPimousse;
