...
const LePrsident = () => (
  <RestaurantPage
    restaurantName="Le Président"
    address="11 avenue de Grande-Bretagne, Lyon, 69006, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33478945117"
    website="https://restaurantlepresident.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Lyon institution, run by Christophe Marguin, draws its inspiration from fine classic cuisine, which it serves in a modernised form: macaroni stuffed with poultry liver and truffle, poultry jus and Etrez cream; veal sweetbreads meunière, glazed carrots etc. Le Président refers to Édouard Herriot, then mayor of Lyon, who used to come and have coffee here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20avenue%20de%20Grande-Bretagne%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="Le Président"
  />
);

export default LePrsident;
