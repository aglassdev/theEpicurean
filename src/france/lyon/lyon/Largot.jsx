...
const Largot = () => (
  <RestaurantPage
    restaurantName="L'Argot"
    address="132 rue Bugeaud, Lyon, 69006, France"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+33478245788"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/lyon/restaurant/l-argot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant doubles as a butcher’s shop in the Brotteaux district. Customers first choose their cut of meat from the refrigerated display counter: beef from Limousin, Galicia, Aubrac and lamb and veal from Auvergne, served with a tasty side dish of the day. Good, wholesome, no-nonsense food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=132%20rue%20Bugeaud%2C%20Lyon%2C%2069006%2C%20France"
    pageTitle="L'Argot"
  />
);

export default Largot;
