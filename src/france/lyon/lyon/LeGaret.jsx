...
const LeGaret = () => (
  <RestaurantPage
    restaurantName="Le Garet"
    address="7 rue du Garet, Lyon, 69001, France"
    cuisine="Lyonnaise, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33478281694"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/lyon/restaurant/le-garet"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This veritable institution is well known among aficionados of Lyonnais cuisine. Calf’s head, tripe, dumplings and andouillette sausages are served in a convivial atmosphere and in a typical setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20du%20Garet%2C%20Lyon%2C%2069001%2C%20France"
    pageTitle="Le Garet"
  />
);

export default LeGaret;
