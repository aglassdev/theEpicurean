...
const DanielEtDeniseSaintjean = () => (
  <RestaurantPage
    restaurantName="Daniel et Denise Saint-Jean"
    address="36 rue Tramassac, Lyon, 69005, France"
    cuisine="Lyonnaise"
    priceRange="€€"
    phoneNumber="+33478422462"
    website="https://danieletdenise.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw from Cathédrale St Jean, this Old Town bouchon is run by chef Joseph Viola (Meilleur Ouvrier de France in 2004), already known for his Daniel et Denise restaurants in the 3rd and 4th arrondissements. On the menu here, expect traditional Lyon cuisine that will have fans of the genre smacking their lips: pike quenelle with Nantua sauce; gratin of andouillette with calf's ruffle, leek and whole-grain mustard. A top-quality bouchon!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20rue%20Tramassac%2C%20Lyon%2C%2069005%2C%20France"
    pageTitle="Daniel et Denise Saint-Jean"
  />
);

export default DanielEtDeniseSaintjean;
