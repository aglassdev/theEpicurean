...
const Fujiyama55 = () => (
  <RestaurantPage
    restaurantName="Fujiyama 55"
    address="40 avenue Jean-Jaurès, Lyon, 69007, France"
    cuisine="Ramen"
    priceRange="€"
    phoneNumber="+33652955562"
    website="https://www.fujiyama55-ramen.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Japanese DJ based in Lyon wanted to replicate a Japanese ramen institution in France. In this utilitarian-style space in the Guillotière neighbourhood, he has joined forces with his compatriot, originally a musician, trained in the exacting art of ramen. Everything is made in house, including gyoza and desserts, and the ingredients are local if not Asian (such as farmhouse pork). Fine sake selection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20avenue%20Jean-Jaur%C3%A8s%2C%20Lyon%2C%2069007%2C%20France"
    pageTitle="Fujiyama 55"
  />
);

export default Fujiyama55;
