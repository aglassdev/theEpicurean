...
const Veronatuti = () => (
  <RestaurantPage
    restaurantName="Veronatuti"
    address="122 rue Montesquieu, Lyon, 69007, France"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber=""
    website="https://veronatuti.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122%20rue%20Montesquieu%2C%20Lyon%2C%2069007%2C%20France"
    pageTitle="Veronatuti"
  />
);

export default Veronatuti;
