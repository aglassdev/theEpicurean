...
const LeMuse = () => (
  <RestaurantPage
    restaurantName="Le Musée"
    address="2 rue des Forces, Lyon, 69002, France"
    cuisine="Lyonnaise"
    priceRange="€"
    phoneNumber="+33478377154"
    website="https://guide.michelin.com/en/auvergne-rhone-alpes/lyon/restaurant/le-musee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A sincere and authentic bouchon replete with checked tablecloths, closely packed tables and a buzzy vibe. The colourful young chef, Luc, frequently pops out to chat with guests, when he’s not conjuring up textbook recipes with consummate flair, such as pistachio sausage in brioche pastry or tablier de sapeur (offal)… 100% patriotic line-up...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20des%20Forces%2C%20Lyon%2C%2069002%2C%20France"
    pageTitle="Le Musée"
  />
);

export default LeMuse;
