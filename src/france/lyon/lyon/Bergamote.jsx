...
const Bergamote = () => (
  <RestaurantPage
    restaurantName="Bergamote"
    address="123 rue de Gerland, Lyon, 69007, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33478726432"
    website="https://restaurant-bergamote.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistronomic bijou is tucked away in the heart of a district in the throes of renovation. In a cosy, nature-inspired interior, youthful Maxime Pujol rolls out his technical skills as he conjures up seasonal dishes, rich in crisp flavours and beautifully presented – all of which at eater friendly prices at lunchtime. More ambitious score in the evening with a surprise menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=123%20rue%20de%20Gerland%2C%20Lyon%2C%2069007%2C%20France"
    pageTitle="Bergamote"
  />
);

export default Bergamote;
