...
const Le5mePch = () => (
  <RestaurantPage
    restaurantName="Le 5ème Péché"
    address="16 rue de la Fraternité, Collioure, 66190, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33468980976"
    website="https://guide.michelin.com/en/occitanie/collioure/restaurant/le-5eme-peche"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant in Collioure's old town is run by a chef from Tokyo, who is passionate about French food and wine. Here, Japan meets Catalonia in fusion cuisine that stars ultra-fresh fish. A prime example is the rockfish soup with coconut milk, braised ox cheek with banyuls and prawns. Remember to book well in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20rue%20de%20la%20Fraternit%C3%A9%2C%20Collioure%2C%2066190%2C%20France"
    pageTitle="Le 5ème Péché"
  />
);

export default Le5mePch;
