...
const MammaLesRochesBrunes = () => (
  <RestaurantPage
    restaurantName="Mamma - Les Roches Brunes"
    address="15 route de Port-Vendres, Collioure, 66190, France"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33411300755"
    website="https://hotel-lesrochesbrunes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Clinging to a rocky outcrop, Les Roches Brunes is a feast for the eye: the hotel overlooks the sea and offers a breathtaking view of the Château royal de Collioure opposite. In the bohemian-chic restaurant, the gourmet score celebrates local produce. You will taste creative, hearty Catalan recipes with a weakness for seafood: Palamos prawns, mushrooms and a coffee emulsion; arroz seco, baby squid and blue crab stock; fillet of dentex cooked on a plancha served with a seafood suquet (sort of Catalan fish stew)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20route%20de%20Port-Vendres%2C%20Collioure%2C%2066190%2C%20France"
    pageTitle="Mamma - Les Roches Brunes"
  />
);

export default MammaLesRochesBrunes;
