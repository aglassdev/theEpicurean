...
const GrandCafOccitan = () => (
  <RestaurantPage
    restaurantName="Grand Café Occitan"
    address="7 rue de l'Occitanie, Félines-Minervois, 34210, France"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+33430166272"
    website="https://www.grandcafeoccitan.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a Minervois wine village, this former café is now a bistro-cum-wine bar, owned by neighbouring Château Maris. With its terrace shaded by a reed canopy and its mismatched furniture, the place has all the makings of an arty guinguette. French-English chef Tristram Bowden and Ana Dias, his Lisbon-born sister in law, have devised a short menu featuring seasonal local ingredients, sometimes with a subtle British touch: beef tongue remoulade, pork loin confit with braised courgettes, almond and cherry tart etc. The wine list – Ana's domain – includes a selection of organic and biodynamic wines from the Languedoc region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20de%20l'Occitanie%2C%20F%C3%A9lines-Minervois%2C%2034210%2C%20France"
    pageTitle="Grand Café Occitan"
  />
);

export default GrandCafOccitan;
