...
const CdricBurtin = () => (
  <RestaurantPage
    restaurantName="Cédric Burtin"
    address="Chemin de Martorez, Saint-Rémy, 71100, France"
    ...
    bio="Welcome to this tranquil 19C watermill, by a millstream. It is flanked by a cottage garden, whose sole purpose is to supply the restaurant’s kitchen. After growing up in the Charolais countryside, chef Cédric Burtin did stints in Lyon restaurants operated by world-class chefs of the ilk of Paul Bocuse and Pierre Orsi. Today, his own restaurant enjoys a fine reputation in the region amongst the locals and a clientele from further afield. This subtle chef’s inventive hallmark and his flair for allowing fresh ingredients to shout their name, thanks to virtuoso technique and mouth-watering plating, are second to none...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Martorez%2C%20Saint-R%C3%A9my%2C%2071100%2C%20France"
    pageTitle="Cédric Burtin"
  />
);

export default CdricBurtin;
