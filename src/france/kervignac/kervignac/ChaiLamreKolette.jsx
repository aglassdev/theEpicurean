...
const ChaiLamreKolette = () => (
  <RestaurantPage
    restaurantName="Chai l'amère Kolette"
    address="Parc d'activités de Kernours, Kervignac, 56700, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33297362874"
    website="https://www.chai-lamere-kolette.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Between Hennebont and Port-Louis, this house, set in a small commercial district, is definitely worth a visit. In the kitchen, visible from the airy, tastefully appointed dining room, the chef concocts market-fresh recipes, whilst adding distinctive personal touches...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Parc%20d'activit%C3%A9s%20de%20Kernours%2C%20Kervignac%2C%2056700%2C%20France"
    pageTitle="Chai l'amère Kolette"
  />
);

export default ChaiLamreKolette;
