...
const LinattenduDomaineDeLocgunol = () => (
  <RestaurantPage
    restaurantName="L'Inattendu - Domaine de Locguénolé"
    address="Route de Port-Louis, Le Hingair, Kervignac, 56700, France"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33297767676"
    website="https://www.domaine-locguenole.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The decadently revamped Locguénolé Estate features a 19C château and an 18C Brittany manor house set in several hundred acres of wooded grounds that are also home to a “farmyard” (chickens, goats, ducks and geese) together with a kitchen garden, orchard and beehives that supply the restaurant. The dining area, reminiscent of the heyday of the East India Company, unfolds beneath an industrial-vibe conservatory structure dotted in greenery. In this classy setting, you will taste the spot-on, delicate handiwork of youthful chef Yann Maget (MOF 2023 with stints in top establishments under his belt). Produce from Brittany takes pride of place and kari gosse curry spice, black pudding, razor clams and andouille often feature in his cooking. Top-drawer ingredients crafted with talent and flair in..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Port-Louis%2C%20Le%20Hingair%2C%20Kervignac%2C%2056700%2C%20France"
    pageTitle="L'Inattendu - Domaine de Locguénolé"
  />
);

export default LinattenduDomaineDeLocgunol;
