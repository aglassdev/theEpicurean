...
const LaMaisonAlyetteDomaineDeLocgunol = () => (
  <RestaurantPage
    restaurantName="La Maison Alyette - Domaine de Locguénolé"
    ...
    pageTitle="La Maison Alyette - Domaine de Locguénolé"
  />
);

export default LaMaisonAlyetteDomaineDeLocgunol;
