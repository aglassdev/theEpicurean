...
const LeCercle = () => (
  <RestaurantPage
    restaurantName="Le Cercle"
    address="374 rue Nationale, Nœux-les-Mines, 62290, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33321616565"
    website="https://www.hotel-lamaisonrouge.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chic but not chichi, this hotel restaurant charms with its deftly crafted cuisine and delicious dishes. Chef Loïc Constant has been delighting diners for over 15 years, thanks to quality ingredients, a sure hand and a touch of generosity. Tuck into a simple yet irresistible carpaccio of sea bass with cayenne pepper, before indulging in divine house-made profiteroles. The attentive and efficient service perfectly rounds off the experience, as you dine in the presence of stars of the silver screen, whose portraits hang on the walls in silver frames...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=374%20rue%20Nationale%2C%20N%C5%93ux-les-Mines%2C%2062290%2C%20France"
    pageTitle="Le Cercle"
  />
);
