...
const RestaurantDuDauphin = () => (
  <RestaurantPage
    restaurantName="Restaurant du Dauphin"
    address="3 rue d'Huisne, La Ferté-Bernard, 72400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33243930039"
    website="https://www.restaurant-du-dauphin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the old town, at the foot of the Porte St Julien, this restaurant in a pretty 16C building serves cuisine for the modern palate. The chefs incorporate a smattering of exotic touches, but always have a handful of classics up their sleeve. The chicken supreme with quince, accompanied by mashed potatoes with walnuts and an amaretto-infused carcass jus is a good example. As for dessert, it is a pleasure to find a vacherin, a rum baba or a moelleux – always a failsafe option! Fine selection of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20rue%20d'Huisne%2C%20La%20Fert%C3%A9-Bernard%2C%2072400%2C%20France"
    pageTitle="Restaurant du Dauphin"
  />
);

export default RestaurantDuDauphin;
