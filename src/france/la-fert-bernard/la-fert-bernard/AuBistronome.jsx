...
const AuBistronome = () => (
  <RestaurantPage
    restaurantName="Au Bistronome"
    address="11 rue Bourgneuf, La Ferté-Bernard, 72400, France"
    cuisine="Modern Cuisine, Grills"
    priceRange="€€€"
    phoneNumber="+33243932158"
    website="https://www.aubistronome.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The luminous, high - ceilinged interior is decorated in the manner of a contemporary bistro. The same concept extends to the menu, without forgetting tradition and a distinct fondness for charcoal - fired preparations – rib of beef, steak, andouillette, tuna and sole, all of which are cooked directly in the dining room. Simple and generous...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Bourgneuf%2C%20La%20Fert%C3%A9-Bernard%2C%2072400%2C%20France"
    pageTitle="Au Bistronome"
  />
);

export default AuBistronome;
