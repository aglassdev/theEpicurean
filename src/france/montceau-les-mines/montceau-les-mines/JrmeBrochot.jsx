...
const JrmeBrochot = () => (
  <RestaurantPage
    restaurantName="Jérôme Brochot"
    address="7 place Beaubernard, Montceau-les-Mines, 71300, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33385679530"
    website="https://www.jeromebrochot.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jérôme Brochot concocts a set menu made with market-fresh produce that changes on a weekly basis and comprises several courses. He works with excellent produce: green asparagus, lobster, turbot etc. They offer a cookery class on Sunday mornings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20place%20Beaubernard%2C%20Montceau-les-Mines%2C%2071300%2C%20France"
    pageTitle="Jérôme Brochot"
  />
);

export default JrmeBrochot;
