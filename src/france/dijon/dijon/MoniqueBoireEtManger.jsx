...
const MoniqueBoireEtManger = () => (
  <RestaurantPage
    restaurantName="Monique, boire et manger"
    address="33 rue Amiral-Roussin, Dijon, 21000, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33380499936"
    website="https://www.moniqueboireetmanger.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What would Monique, the grandmother of chef Clara Reydet, have made of this charming bistro where seasonal vegetables are the star attraction? Only positive things, for sure! Clara cooks without inhibitions, draws on various influences and wins everyone over with her black pudding cream, scorched leeks, apple and sunflower-seed relish, or gnocchi with confit butternut squash, blanquette sauce and carrot pesto. This fusion cuisine with (not completely) vegetarian leanings is to be enjoyed in the simple, spruce space with lots of wood. Small terrace on the pedestrianised street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20rue%20Amiral-Roussin%2C%20Dijon%2C%2021000%2C%20France"
    pageTitle="Monique, boire et manger"
  />
);

export default MoniqueBoireEtManger;
