...
const WilliamFrachot = () => (
  <RestaurantPage
    restaurantName="William Frachot"
    address="Hostellerie du Chapeau Rouge, 5 rue Michelet, Dijon, 21000, France"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+33380508888"
    website="https://www.chapeau-rouge.fr/fr/restaurant-gastronomique-dijon"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This 19C former coaching inn bang in the heart of historic Dijon is the HQ of one of Burgundy’s most talented chefs. A local lad and son of restaurateurs, William Frachot, who is something of a globetrotter (England, Quebec), devises stripped-back dishes in his own image: serious and applied, juggling international flavours and regional produce. He adds just the right dose of inventiveness and energy, illustrated by his new take on eggs meurette and his steadfast commitment to freshwater fish (perch, black bass, pike, zander) depicted by brook trout, zander and river fish soup. Meals are served in a distinctive interior featuring light wood cladding, grape vine motifs and mustard yellow swivel Shark chairs - each design choice is a nod to Burgundy's heritage. Inspired and accomplished cuis..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hostellerie%20du%20Chapeau%20Rouge%2C%205%20rue%20Michelet%2C%20Dijon%2C%2021000%2C%20France"
    pageTitle="William Frachot"
  />
);

export default WilliamFrachot;
