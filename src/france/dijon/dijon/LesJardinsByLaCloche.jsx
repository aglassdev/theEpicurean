...
const LesJardinsByLaCloche = () => (
  <RestaurantPage
    restaurantName="Les Jardins by La Cloche"
    address="Grand Hôtel La Cloche, 14 place Darcy, Dijon, 21000, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33380301232"
    website="https://www.hotel-lacloche.fr/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this contemporary setting, part of the dining area stretches out into a veranda with a curved floor plan and a view of the garden of this property. The chef's modern cuisine is rooted in Burgundy's terroir and enhanced by occasional Asian touches. The desserts, meanwhile, get back to basics with well-crafted creations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand%20H%C3%B4tel%20La%20Cloche%2C%2014%20place%20Darcy%2C%20Dijon%2C%2021000%2C%20France"
    pageTitle="Les Jardins by La Cloche"
  />
);

export default LesJardinsByLaCloche;
