...
const Dames = () => (
  <RestaurantPage
    restaurantName="DAMES"
    address="23c rue de Rennes, Dol-de-Bretagne, 35120, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33299480614"
    website="https://www.restaurant-dames.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once a transport café between Saint-Malo and Mont-Saint-Michel, this establishment has been transformed by Marine Hervouet (trained by Alain Passard and Bruno Verjus) and Pascaline Albicini (taught by Robuchon and Etchebest). The premises have been renovated in a bucolic style characterised by exposed stone and contemporary wooden furniture and exude the warmth of a family home. The menu, focused on carefully selected local produce, is exceedingly high calibre. With flambéed tomato compote and a tomato caramel sauce, the vegetable agnolotti impresses with its aromatic depth. The audacious desserts – crispy choux pastry puff garnished with smoked aubergine, sorrel ice cream and hot caramel – hit the mark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23c%20rue%20de%20Rennes%2C%20Dol-de-Bretagne%2C%2035120%2C%20France"
    pageTitle="DAMES"
  />
);
