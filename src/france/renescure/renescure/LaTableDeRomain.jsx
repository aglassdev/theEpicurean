...
const LaTableDeRomain = () => (
  <RestaurantPage
    restaurantName="La Table de Romain"
    address="1 rue Gaston-Robbe, Renescure, 59173, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33967352360"
    website="https://tablederomain.kazeo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This village restaurant with typical local architecture is located in the heart of this market town. It is the HQ of a chef who proposes a set menu at an unbeatable price during the week, and more elaborate dishes at the weekend, when some premium ingredients are deployed. Menu and produce regularly adapted. To enjoy in a chic and convivial interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20Gaston-Robbe%2C%20Renescure%2C%2059173%2C%20France"
    pageTitle="La Table de Romain"
  />
);

export default LaTableDeRomain;
