...
const LeBonAccueil = () => (
  <RestaurantPage
    restaurantName="Le Bon Accueil"
    address="1 chemin de la Grande-Source, Malbuisson, 25160, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33381693058"
    website="https://www.le-bon-accueil.fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This aptly named establishment (a warm welcome does await!) is an excellent option in the heart of the Haut-Doubs. For four generations, this inviting and comfortable chalet that is typical of the region has been practising the art of Jura-style hospitality. St Point Lake is across the road, Le Suchet mountain and Switzerland just beyond. Here, they put their heart and soul into providing good food that is an ode to the region. Chef Marc Faivre worked at Georges Blanc, Pierre Gagnaire and Maison Lameloise before returning to his homeland, where his fine and tasty cuisine delights diners: trout with blue cheese or absinthe, free-range chicken, morels and Jura vin jaune sauce (of course!) or roast pigeon, duck foie gras and artichoke...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20chemin%20de%20la%20Grande-Source%2C%20Malbuisson%2C%2025160%2C%20France"
    pageTitle="Le Bon Accueil"
  />
);

export default LeBonAccueil;
