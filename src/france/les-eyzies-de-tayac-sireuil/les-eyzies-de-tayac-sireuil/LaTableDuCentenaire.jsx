...
const LaTableDuCentenaire = () => (
  <RestaurantPage
    restaurantName="La Table du Centenaire"
    address="2 avenue du Cingle, Les Eyzies-de-Tayac-Sireuil, 24620, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33553066868"
    website="https://www.hotelducentenaire.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Previously an oyster farmer working in the Bassin d'Arcachon, chef Mathieu Métifet draws his inspiration from the Périgord terroir, weaving in fish and seafood elements to create generous, personal cuisine, of which his signature dish is a good example: Le Centenaire's unmissable razor clams with a morel cream and home-smoked magret de canard. Hand-picked small-scale local producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20avenue%20du%20Cingle%2C%20Les%20Eyzies-de-Tayac-Sireuil%2C%2024620%2C%20France"
    pageTitle="La Table du Centenaire"
  />
);

export default LaTableDuCentenaire;
