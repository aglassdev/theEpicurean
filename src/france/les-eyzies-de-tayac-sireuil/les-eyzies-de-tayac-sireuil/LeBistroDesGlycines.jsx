...
const LeBistroDesGlycines = () => (
  <RestaurantPage
    restaurantName="Le Bistro des Glycines"
    address="4 avenue de Laugerie, Les Eyzies-de-Tayac-Sireuil, 24620, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33553069707"
    website="https://www.les-glycines-dordogne.com/fr/hotel-les-eyzies"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the undeniable bonuses of this hotel is its excellent bistro! The dining room-conservatory serves (lunchtime only) sensibly priced menus in tune with the zeitgeist, such as gravlax of Eyzies trout with a smoked cream cheese sauce or shoulder of lamb, confit and smoked in a casserole dish. Flavour, generosity and respect for the seasons set the tone for chef Pascal Lombard’s creative and enticing culinary score – we’ll be back for more!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20avenue%20de%20Laugerie%2C%20Les%20Eyzies-de-Tayac-Sireuil%2C%2024620%2C%20France"
    pageTitle="Le Bistro des Glycines"
  />
);

export default LeBistroDesGlycines;
