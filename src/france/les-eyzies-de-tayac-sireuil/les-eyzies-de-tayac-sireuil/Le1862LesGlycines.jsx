...
const Le1862LesGlycines = () => (
  <RestaurantPage
    restaurantName="Le 1862 - Les Glycines"
    ...
    pageTitle="Le 1862 - Les Glycines"
  />
);

export default Le1862LesGlycines;
