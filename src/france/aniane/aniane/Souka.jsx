...
const Souka = () => (
  <RestaurantPage
    restaurantName="SouKa"
    address="36 boulevard Saint-Jean, Aniane, 34150, France"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+33467574483"
    website="https://www.soukarestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this tiny village in the heart of the Terrasses du Larzac vineyards, SouKa (root in Occitan) focuses on market ingredients and local producers. The playful chef enjoys conjuring up surprises, such as the mystery lunch and evening menu, whose ingredients you’re asked to guess! The fine local tipples can be purchased from the wine shop on the premises...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20boulevard%20Saint-Jean%2C%20Aniane%2C%2034150%2C%20France"
    pageTitle="SouKa"
  />
);

export default Souka;
