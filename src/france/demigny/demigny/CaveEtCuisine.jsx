...
const CaveEtCuisine = () => (
  <RestaurantPage
    restaurantName="Cave et Cuisine"
    address="1 cour du Wauxhall, Demigny, 71150, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33681519571"
    website="https://cave-et-cuisine.eatbu.com/?lang=fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A town house with blue shutters next to the church, a wine cellar with over 1 000 labels, a chef who is following in her parents' footsteps. An undeniable talent in the kitchen, she combines classics (eggs in a red wine sauce, ham terrine with parsley etc), contemporary dishes (salmon gravlax) and specialities such as roast pigeon and sweetbreads. To be savoured in a refined bistro decor, where smiling service is the order of the day and the wine recommendations are on point...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20cour%20du%20Wauxhall%2C%20Demigny%2C%2071150%2C%20France"
    pageTitle="Cave et Cuisine"
  />
);

export default CaveEtCuisine;
