...
const Lunisens = () => (
  <RestaurantPage
    restaurantName="L'Unisens"
    address="250 route de Barjac, Vagnas, 07150, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33475940104"
    website="https://www.lunisens.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern building just outside the village of Vagnas harks back to traditional Provençal architecture. In its spacious interior, which is done out in a contemporary style and has an open kitchen, sample the cuisine of Tarik Mezri-Charmasson, who ticks all the boxes, remaining true to the seasons and letting the ingredients speak for themselves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=250%20route%20de%20Barjac%2C%20Vagnas%2C%2007150%2C%20France"
    pageTitle="L'Unisens"
  />
);

export default Lunisens;
