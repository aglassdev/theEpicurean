...
const LaTableDuLion = () => (
  <RestaurantPage
    restaurantName="La Table du Lion"
    address="71 rue Saint-Jean, Bayeux, 14400, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33231920690"
    website="https://www.liondor-bayeux.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Le Lion d'Or, the chef works his magic with produce sourced in Normandy that he embellishes with Asian flavours. An unexpected culinary marriage inspired by his travels in Asia, particularly Japan and Thailand. Add to this, flawless culinary technique and seasoning and you will be roaring with pleasure!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71%20rue%20Saint-Jean%2C%20Bayeux%2C%2014400%2C%20France"
    pageTitle="La Table du Lion"
  />
);

export default LaTableDuLion;
