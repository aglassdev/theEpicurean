...
const Le1720ChteauDeSully = () => (
  <RestaurantPage
    restaurantName="Le 1720 - Château de Sully"
    address="Route de Port-en-Bessin, Bayeux, 14400, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33231222948"
    website="https://www.chateau-de-sully.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Grandiose is the term that springs to mind when describing this 18C château, set in landscaped grounds planted with Lebanese cedars and sequoias. Take a seat in one of the plush dining rooms or in the bright conservatory to savour the chef’s predominantly Normandy-focused cuisine: vegetables, cheeses, foie gras and, of course, line-caught fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Port-en-Bessin%2C%20Bayeux%2C%2014400%2C%20France"
    pageTitle="Le 1720 - Château de Sully"
  />
);

export default Le1720ChteauDeSully;
