...
const LeMoulinDePoustagnacq = () => (
  <RestaurantPage
    restaurantName="Le Moulin de Poustagnacq"
    address="Chemin de Poustagnacq, Saint-Paul-lès-Dax, 40990, France"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+33558913103"
    website="https://poustagnacq.fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you like eating by the water, this old mill is the stuff of dreams! The chef prepares fresh ingredients and cooks up traditional cuisine with plenty of appealing regional flair: sole meunière, braised calf sweetbreads with morel sauce, fillet of beef, and chips cooked in goose fat. In fine weather, sit on the terrace overlooking the lake. Bucolic atmosphere guaranteed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Poustagnacq%2C%20Saint-Paul-l%C3%A8s-Dax%2C%2040990%2C%20France"
    pageTitle="Le Moulin de Poustagnacq"
  />
);

export default LeMoulinDePoustagnacq;
