...
const LaTableDeLours = () => (
  <RestaurantPage
    restaurantName="La Table de l'Ours"
    address="Les Barmes de l'Ours, 100 montée de Bellevarde, Val-d'Isère, 73150, France"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+33479413700"
    website="https://www.hotellesbarmes.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This fine dining establishment is part of a luxurious hotel, which feels like a plush chalet. On the edge of the famous ski run, Face de Bellevarde, the restaurant is chic and elegant with a wealth of wood, exposed stone and mirrors. Passionate about his craft, conscientious chef Antoine Gras shows the utmost respect for the ingredients. These he showcases in flavoursome dishes that don't mess around. The combinations are spot on: just-seared langoustine, julienne vegetables, chilled vinaigrette with grated carrots; whitefish from Lake Geneva, sorrel, silky gourd purée with juniper berries. The enthusiasm of the youthful front-of-house team is contagious, and that also goes for the sommelier, an ambassador of Savoie wines. Le Coin Savoyard and La Rôtisserie are the hotel's more laid-back e..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Les%20Barmes%20de%20l'Ours%2C%20100%20mont%C3%A9e%20de%20Bellevarde%2C%20Val-d'Is%C3%A8re%2C%2073150%2C%20France"
    pageTitle="La Table de l'Ours"
  />
);

export default LaTableDeLours;
