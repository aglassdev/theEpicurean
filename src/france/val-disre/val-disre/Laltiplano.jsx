...
const Laltiplano = () => (
  <RestaurantPage
    restaurantName="L'Altiplano"
    address="Le K2 Chogori, 143 avenue du Prariond, Val-d'Isère, 73150, France"
    cuisine="Peruvian"
    priceRange="€€€€"
    phoneNumber="+33479042020"
    website="https://lek2chogori.com/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We may be in the Alps, but this place fêtes an entirely different mountain range – the Andes! The culinary offering here is inspired by Peruvian history and cuisine: think barbecued specialities, condiments, dishes for sharing etc. Be transported to Peru, without even leaving this chic, intimate and friendly setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20K2%20Chogori%2C%20143%20avenue%20du%20Prariond%2C%20Val-d'Is%C3%A8re%2C%2073150%2C%20France"
    pageTitle="L'Altiplano"
  />
);

export default Laltiplano;
