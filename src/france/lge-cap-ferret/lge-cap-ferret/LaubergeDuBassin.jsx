...
const LaubergeDuBassin = () => (
  <RestaurantPage
    restaurantName="L'Auberge du Bassin"
    address="38 avenue du Général-de-Gaulle, Lège-Cap-Ferret, 33950, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33556607022"
    website="https://www.aubergedubassin.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A keen traveller, chef Mélanie Serre (who previously worked with the late Joël Robuchon) has set up shop in Cap Ferret, at the start of the peninsula – facing out to sea (at high tide) or seagrass beds and samphire plants (at low tide). Her indulgent menu is eclectic, with many nods to bistro or even classic French cuisine. Her perfectly executed recipes are often given an appealingly creative twist: she makes a mean pâté en croûte, devilled eggs with leek vinaigrette, stuffed cabbage, beef Wellington, rum baba… There's a good wine cellar with bottles to suit all budgets, from modest natural wines to top-tier labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20avenue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20L%C3%A8ge-Cap-Ferret%2C%2033950%2C%20France"
    pageTitle="L'Auberge du Bassin"
  />
);

export default LaubergeDuBassin;
