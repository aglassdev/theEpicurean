...
const LaMaisonDeCelou = () => (
  <RestaurantPage
    restaurantName="La Maison de Celou"
    address="5 rue Saint-Jouin, Châteauneuf-de-Gadagne, 84470, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33490160861"
    website="https://www.lamaisondecelou84.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Clinging to the ramparts of this historical village, the delightful Maison embodies the art de vivre of Provence. The chef crafts bright, flavoursome dishes, such as a supreme of free-range poultry, Roman-style gnocchi and meatballs in jus. The decadent desserts are fiendishly tempting. Superlative sweeping view over Mt Ventoux and the Luberon mountain range from the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20Saint-Jouin%2C%20Ch%C3%A2teauneuf-de-Gadagne%2C%2084470%2C%20France"
    pageTitle="La Maison de Celou"
  />
);

export default LaMaisonDeCelou;
