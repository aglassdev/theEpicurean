...
const AubergeLagneau = () => (
  <RestaurantPage
    restaurantName="Auberge à l'Agneau"
    address="11 rue Principale, Roppenheim, 67480, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33388864008"
    website="https://www.auberge-agneau.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run institution dating from 1902 is located in a handsome 17C half-timbered building. It is a great place to indulge in hearty food: in the kitchen, dishes simmer under the watchful eye of the chef, who loves his region. Stand-out dishes include local and meat specialties. Expect unpretentious, generous and authentic fare, served in an inviting setting… plus a warm welcome!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20Principale%2C%20Roppenheim%2C%2067480%2C%20France"
    pageTitle="Auberge à l'Agneau"
  />
);

export default AubergeLagneau;
