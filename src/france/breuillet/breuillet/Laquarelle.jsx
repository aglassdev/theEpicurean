...
const Laquarelle = () => (
  <RestaurantPage
    restaurantName="L'Aquarelle"
    address="71A route du Montil, Breuillet, 17920, France"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+33546221138"
    website="https://www.laquarelle.net/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This impressive cubist structure is just the ticket for a gourmet interlude in the heart of the Royan countryside. Chef Xavier Taffart is the son of an oyster farmer, so he knows a thing or two about oysters. His occasionally playful dishes are a testament to his inspired creativity and he works only with the finest local ingredients. A fan of surf ‘n turf combinations, he doesn't shy away from daring pairings: brill cooked at 57°C, curry of Swiss chard leaves and green olives; suckling lamb cooked several ways, turnips/razor clams, a leafy jus and chickpea seasoning… Clean designer lines set the scene in the large panoramic restaurant, including in the tableware, which features contemporary porcelain by an artisan from Poitiers and knives by a cutler from La Rochelle. This eye for detail ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71A%20route%20du%20Montil%2C%20Breuillet%2C%2017920%2C%20France"
    pageTitle="L'Aquarelle"
  />
);

export default Laquarelle;
