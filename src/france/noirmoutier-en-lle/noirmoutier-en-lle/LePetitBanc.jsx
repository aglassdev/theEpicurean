...
const LePetitBanc = () => (
  <RestaurantPage
    restaurantName="Le Petit Banc"
    address="7 rue des Douves, Noirmoutier-en-l'Île, 85330, France"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+33228109321"
    website="https://guide.michelin.com/en/pays-de-la-loire/noirmoutier-en-lile/restaurant/le-petit-banc"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20rue%20des%20Douves%2C%20Noirmoutier-en-l'%C3%8Ele%2C%2085330%2C%20France"
    pageTitle="Le Petit Banc"
  />
);

export default LePetitBanc;
