...
const LaGare = () => (
  <RestaurantPage
    restaurantName="La Gare"
    address="2 rue Soppe, Guewenheim, 68116, France"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+33389825129"
    website="https://www.restaurantdelagare-guewenheim.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A very contemporary local institution (since 1874)! It has a perfect combination of elegance, vitality and conviviality, offering a brasserie for those in a hurry or carefully-prepared modern cuisine in a conservatory setting... Goat’s cheese and vegetable terrine, or thick veal chop with morel mushrooms and gnocchi, all accompanied by one of the finest wine lists in the country...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20Soppe%2C%20Guewenheim%2C%2068116%2C%20France"
    pageTitle="La Gare"
  />
);

export default LaGare;
