...
const LeClosDeLaFontaine = () => (
  <RestaurantPage
    restaurantName="Le Clos de la Fontaine"
    address="9 rue du Général-de-Gaulle, Guingamp, 22200, France"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+33296213363"
    website="https://guide.michelin.com/en/bretagne/guingamp/restaurant/le-clos-de-la-fontaine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming rustic-style interior (tablecloths, English crockery), friendly service and skilfully executed cuisine: Stéphane Ollivier and his wife Corinne certainly know how to receive guests. The generous dishes are made with plenty of good local ingredients (eg scallops, oysters, Breton cheeses) and include tasty local specialties, such as roast duck breast strips with cider and tarragon sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20rue%20du%20G%C3%A9n%C3%A9ral-de-Gaulle%2C%20Guingamp%2C%2022200%2C%20France"
    pageTitle="Le Clos de la Fontaine"
  />
);

export default LeClosDeLaFontaine;
