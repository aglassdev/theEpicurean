...
const LeWauthierByCagna = () => (
  <RestaurantPage
    restaurantName="Le Wauthier by Cagna"
    address="31 rue Wauthier, Saint-Germain-en-Laye, 78100, France"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+33139731084"
    website="https://www.restaurant-wauthier-by-cagna.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely restaurant located in Saint - Germain - en - Laye also boasts a chic bistro interior and attentive service. Dishes are prepared using quality market ingredients and will please a modern palate. Try dishes like: Piedmont risotto with lobster and beurre blanc, braised sweetbread escalopes, celeric mousseline and Albufera sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20rue%20Wauthier%2C%20Saint-Germain-en-Laye%2C%2078100%2C%20France"
    pageTitle="Le Wauthier by Cagna"
  />
);

export default LeWauthierByCagna;
