...
const LaVerdoyante = () => (
  <RestaurantPage
    restaurantName="La Verdoyante"
    address="866 chemin vicinal Coste-Brigade, Gassin, 83580, France"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+33494561623"
    website="https://www.la-verdoyante.fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Standing among the vines, this former rustic farmhouse enjoys a fine panoramic view... But La Verdoyante would be nothing without the enthusiasm of the couple who hold the reins. In the stylish interior or on the charming terrace, diners savour delicious Provençal cuisine that smacks of the garigue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=866%20chemin%20vicinal%20Coste-Brigade%2C%20Gassin%2C%2083580%2C%20France"
    pageTitle="La Verdoyante"
  />
);

export default LaVerdoyante;
