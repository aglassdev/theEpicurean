...
const Loris = () => (
  <RestaurantPage
    restaurantName="Loris"
    address="125 Porto Arabia Drive, The Pearl, Doha, Qatar"
    cuisine="Lebanese"
    priceRange="﷼﷼﷼"
    phoneNumber="+97450034441"
    website="https://www.instagram.com/loris_qa/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s a pure Lebanese experience at this eatery located on The Pearl. Everything from the plush décor to the food alludes to the country located to the east of the Mediterranean. The flavours are all authentic, almost as if grandma was cooking up the dish. Of course, the dishes are made for sharing, with silky hummus and tasty kebab with cherry being the most popular choices. Aish el Saraya is a notable dessert that you mustn’t skip. After dinner, take a stroll on the walkway nearby to take in the city vistas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%20Porto%20Arabia%20Drive%2C%20The%20Pearl%2C%20Doha%2C%20Qatar"
    pageTitle="Loris"
  />
);
