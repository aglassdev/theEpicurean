...
const SaltRoad = () => (
  <RestaurantPage
    restaurantName="Salt Road"
    address="Andaz Doha Hotel, 23 Diplomatic Street, Zone 61, West Bay, Doha, Qatar"
    cuisine="Traditional Cuisine"
    priceRange="﷼﷼﷼﷼"
    phoneNumber="+97444524044"
    website="https://www.hyattrestaurants.com/en/doha/restaurant/the-salt-road-doha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, the owners hail from South Africa as does the cuisine of their restaurant located in the Andaz Doha hotel. The space has shelves stacked with salt from around the world, as it’s used for curing and pickling, which is how they used to preserve food back in the day. The menu has a variety of sharing options – the 5 cured brisket is delicious as are the Josper roasted mushrooms – but the steaks are particularly notable here. If you’re unsure what to order, the well-informed team’s advice is a good guide. Try some of their South African wines, offered by the glass or bottle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Andaz%20Doha%20Hotel%2C%2023%20Diplomatic%20Street%2C%20Zone%2061%2C%20West%20Bay%2C%20Doha%2C%20Qatar"
    pageTitle="Salt Road"
  />
);

export default SaltRoad;
