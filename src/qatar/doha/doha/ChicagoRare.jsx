...
const ChicagoRare = () => (
  <RestaurantPage
    restaurantName="Chicago Rare"
    address="127 Porto Arabia Drive, The Pearl-Qatar, Four Seasons The Pearl-Qatar, Doha, Qatar"
    cuisine="Steakhouse"
    priceRange="﷼﷼﷼"
    phoneNumber="+97441443000"
    website="https://www.chicagoraredoha.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re craving a steak with all the trimmings, a glossy lamb shank, enormous crab legs or a fine lump crab cake then this restaurant within the Four Seasons Hotel is where to come. The Josper oven and grill are used to great effect and desserts also go all in, with the likes of ‘Campfire Alaska’; you’ll certainly leave feeling comfortably satisfied. Live jazz adds to the Chicago atmosphere, while the team channel the Blues Brothers in their look and zip around the room providing attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20Porto%20Arabia%20Drive%2C%20The%20Pearl-Qatar%2C%20Four%20Seasons%20The%20Pearl-Qatar%2C%20Doha%2C%20Qatar"
    pageTitle="Chicago Rare"
  />
);

export default ChicagoRare;
