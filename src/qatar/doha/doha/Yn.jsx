...
const Yn = () => (
  <RestaurantPage
    restaurantName="yūn"
    address="44th Floor, Waldorf Astoria Doha, Al Shaghya Street, West Bay, Doha, Qatar"
    cuisine="Cantonese"
    priceRange="﷼﷼﷼"
    phoneNumber="+97440089000"
    website="https://www.hilton.com/en/hotels/dohnzwa-waldorf-astoria-doha-west-bay/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take the elevator to the 44th floor of the Waldorf Astoria Doha to this opulent Chinese restaurant with its jaw-dropping views. We suggest you start off at the bar and opt for a creative mocktail made using a range of teas before heading to dinner. The Cantonese and Taishanese menu is suitably authentic. Chef Victor hails from Chengdu and has around 20 years of professional experience. All the classics are here; ensure you kick off your meal with the 'Premium selection' of dim sum, followed by their speciality 'Forbidden City' roast duck served two ways and be sure to save room for dessert. The welcome is fulsome and genuine, the service smooth and engaging...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44th%20Floor%2C%20Waldorf%20Astoria%20Doha%2C%20Al%20Shaghya%20Street%2C%20West%20Bay%2C%20Doha%2C%20Qatar"
    pageTitle="yūn"
  />
);
