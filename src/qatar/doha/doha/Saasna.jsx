...
const Saasna = () => (
  <RestaurantPage
    restaurantName="Saasna"
    address="Barahat Msheireb Street, Sikkat Al Maiz, Doha, Qatar"
    cuisine="Middle Eastern"
    priceRange="﷼﷼"
    phoneNumber="+97455197131"
    website="https://www.instagram.com/saasnaqatar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dream of the late Sheikha Ahmed Al Meer – author of 'The Art of Qatari Cooking' – lives on through the proud and caring team who run this restaurant and who are determined to continue her desire to preserve and celebrate the country’s culinary past and to bring it into the 21st century. The traditional cooking is fresh and full of flavour; start your visit with a samosa or the Saasna salad, then the majboos for main course; the wonderful date ice cream is a great way to finish. They have a terrific range of freshly ground seasonings and spices for you to purchase to replicate the flavours at home!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Barahat%20Msheireb%20Street%2C%20Sikkat%20Al%20Maiz%2C%20Doha%2C%20Qatar"
    pageTitle="Saasna"
  />
);

export default Saasna;
