...
const SawaBySanad = () => (
  <RestaurantPage
    restaurantName="SAWA by Sanad"
    address="Mohammed Bin Jassim Street, Msheireb, Doha, Qatar"
    cuisine="Middle Eastern"
    priceRange="﷼﷼﷼"
    phoneNumber="+97441427000"
    website="https://sanaddoha.com/en/sawa-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The first floor of a private members’ club in Doha’s rejuvenated downtown plays host to this impressively chic dining room. The menu offers a showcase of contemporary Levantine dishes, many of which are perfect for sharing. The kitchen takes things up a notch in the evening, including some dishes served from the trolley for an extra dash of theatre. You don’t need to be a member to eat here, but you’ll be tempted to join up after you’ve experienced the caring service and delicious food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mohammed%20Bin%20Jassim%20Street%2C%20Msheireb%2C%20Doha%2C%20Qatar"
    pageTitle="SAWA by Sanad"
  />
);

export default SawaBySanad;
