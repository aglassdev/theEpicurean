...
const Isaan = () => (
  <RestaurantPage
    restaurantName="Isaan"
    address="Grand Hyatt Doha Hotel & Villas, West Bay Lagoon Street, Doha, Qatar"
    cuisine="Thai"
    priceRange="﷼﷼"
    phoneNumber="+97444481250"
    website="https://www.hyattrestaurants.com/en/doha/restaurant/isaan-doha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting in a corner of the Grand Hyatt Hotel’s cavernous ground floor, this large open-plan restaurant boasts three on-view kitchens all producing authentic Thai cooking. Thailand’s influence extends to the décor too, with teak parquet floors and a Thai boat. Dishes are vibrant and flavoursome, with all regions of Thailand covered and ingredients flown in specially. If you’re not sure of your spicing level, ask the warm and friendly service team for recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand%20Hyatt%20Doha%20Hotel%20%26%20Villas%2C%20West%20Bay%20Lagoon%20Street%2C%20Doha%2C%20Qatar"
    pageTitle="Isaan"
  />
);

export default Isaan;
