...
const MuruDOH = () => (
  <RestaurantPage
    restaurantName="MURU"
    address="5th Floor, Waldorf Astoria Doha, Al Shaghya Street, West Bay, Doha, Qatar"
    cuisine="Contemporary"
    priceRange="﷼﷼﷼﷼"
    phoneNumber="+97440089229"
    website="https://www.hilton.com/en/hotels/dohnzwa-waldorf-astoria-doha-west-bay/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s plenty of panache and no little swagger to this large Mauro Colagreco restaurant on the fifth floor of the Waldorf Astoria. The self-styled ‘elemental cooking’ is centred around fire, water, earth and air, with the four elements also providing the different themes for the interior design – a table somewhere between ‘Fire’ and ‘Water’ is the best spot. The global menu offers everything from ceviches and tiraditos to grilled and wood-fired dishes that provide a fusion of exhilarating flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5th%20Floor%2C%20Waldorf%20Astoria%20Doha%2C%20Al%20Shaghya%20Street%2C%20West%20Bay%2C%20Doha%2C%20Qatar"
    pageTitle="MURU"
  />
);

export default MuruDOH;
