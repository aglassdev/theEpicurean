...
const MrMrsHawker = () => (
  <RestaurantPage
    restaurantName="Mr & Mrs Hawker"
    address="3rd Floor, Andaz Doha Hotel, 23 Diplomatic Street, Zone 61, West Bay, Doha, Qatar"
    cuisine="Singaporean"
    priceRange="﷼﷼"
    phoneNumber="+97444524062"
    website="https://www.hyattrestaurants.com/en/doha/restaurant/mr-and-mrs-hawker"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you come here to rekindle your memories of Singapore or just to experience something a little different, this restaurant delivers on the famed Hawker street food. Wherever you sit in the spacious interior dotted with subtle Asian touches, the focus is firmly on the chefs at work in the lively open kitchen. The menu is headed up 'From the Garden City', 'From the Pot', 'From the Wok' and 'From the Hawker Street.’ Expect all the vibrant Singaporean classics, from chilli crab to mango sago pudding, all carefully prepared. Ensure you let them know your spice tolerance, as they don’t hold back...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3rd%20Floor%2C%20Andaz%20Doha%20Hotel%2C%2023%20Diplomatic%20Street%2C%20Zone%2061%2C%20West%20Bay%2C%20Doha%2C%20Qatar"
    pageTitle="Mr & Mrs Hawker"
  />
);

export default MrMrsHawker;
