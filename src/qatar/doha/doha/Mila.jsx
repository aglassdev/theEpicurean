...
const Mila = () => (
  <RestaurantPage
    restaurantName="Mila"
    address="1st Floor, Rosewood Hotel, Marina District, Building 11, Street 309, Zone 69, Lusail, Doha, Qatar"
    cuisine="Middle Eastern"
    priceRange="﷼﷼"
    phoneNumber="+97440303333"
    website="https://www.rosewoodhotels.com/en/doha/dining/mila"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Head to the first floor of the Rosewood Hotel, walk past the enclosed glass wine cellar and enjoy being greeted by the tasty aromas from the ovens in the centre of the restaurant. Before taking a seat, head to the semi-open kitchen to say a quick hello to smiley chef Marc. The menu here is a mix of Mediterranean and Levantine sharing dishes, such as the memorable courgetti wafer with feta, and is inspired by recipes from the chef’s parents. Don’t miss out on the freshly baked breads served warm and paired with tasty hummus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1st%20Floor%2C%20Rosewood%20Hotel%2C%20Marina%20District%2C%20Building%2011%2C%20Street%20309%2C%20Zone%2069%2C%20Lusail%2C%20Doha%2C%20Qatar"
    pageTitle="Mila"
  />
);
