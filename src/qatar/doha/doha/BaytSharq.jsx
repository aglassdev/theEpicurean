...
const BaytSharq = () => (
  <RestaurantPage
    restaurantName="Bayt Sharq"
    address="Al Doha Gardens, Al-Sharq Street, Doha, Qatar"
    cuisine="Middle Eastern"
    priceRange="﷼"
    phoneNumber="+97477704589"
    website="https://www.instagram.com/baytsharq.qa/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This characterful, restored Al Khulaifi house is around 100 years old and even has its own little museum; if you want a glimpse of Old Doha, this is where to come. It’s located just off the Corniche and offers a variety of seating options: in the restaurant or on its veranda, in the gardens or even in a cabin. The classic and authentic Qatari dishes are brimming with flavour and generosity, from mutabbel or majboos to delicious saffron mahalabia; whatever you choose, the only certainty is that you won’t leave hungry!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Al%20Doha%20Gardens%2C%20Al-Sharq%20Street%2C%20Doha%2C%20Qatar"
    pageTitle="Bayt Sharq"
  />
);

export default BaytSharq;
