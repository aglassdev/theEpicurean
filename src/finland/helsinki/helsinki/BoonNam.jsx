...
const BoonNam = () => (
  <RestaurantPage
    restaurantName="Boon Nam"
    address="Lönnrotinkatu 4, Helsinki, 00120, Finland"
    cuisine="Thai"
    priceRange="€€"
    phoneNumber="+358201555919"
    website="https://www.boonnam.fi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fun, intimate restaurant in the basement of the Hotel St George; the perfect place for a night out with friends. The fragrant dishes cover all the regions of Thailand and are good for sharing. Unsure what to order? Then go for one of the set menus, which also include good vegetarian options. A range of cocktails will help to keep you in the party mood, including some specially made to go with dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L%C3%B6nnrotinkatu%204%2C%20Helsinki%2C%2000120%2C%20Finland"
    pageTitle="Boon Nam"
  />
);

export default BoonNam;
