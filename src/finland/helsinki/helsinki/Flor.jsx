...
const Flor = () => (
  <RestaurantPage
    restaurantName="Flor"
    address="Iso Roobertinkatu 16, Helsinki, 00120, Finland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+358442479697"
    website="https://www.restaurantflor.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set opposite bigger sister and Green Star awarded Natura, Flor (meaning flower), is a relaxed restaurant-cum-wine-bar built by local craftspeople using primarily Finnish wood and decorated using natural, compostable clay paint. Located on a busy pedestrianised street, it’s the perfect spot to escape the hustle and bustle thanks to its menu of appealing, freshly crafted dishes that are swiftly prepared. Choose from the à la carte or a surprise menu comprising bread, three starters to share, a main, a side and a dessert, with dishes including the likes of organic salmon with citrus-bouillabaisse sauce and honey pomelo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Iso%20Roobertinkatu%2016%2C%20Helsinki%2C%2000120%2C%20Finland"
    pageTitle="Flor"
  />
);
