...
const BistroBardot = () => (
  <RestaurantPage
    restaurantName="Bistro Bardot"
    address="Kluuvikatu 1, Helsinki, 00100, Finland"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+358105823550"
    website="https://www.bardot.fi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Exposed brick and pipework give this two-roomed brasserie a rustic, slightly retro feel that chimes perfectly with its buoyant atmosphere. It’s a deservedly busy place, named after actress Brigitte Bardot and taking a similarly French outlook on culinary matters too. The extensive à la carte offers all manner of classic brasserie staples, from steak au poivre to tarte Tatin, while the 'menu du jour' provides a simpler, good value selection. The wine list has some appealing French favourites and the friendly team serve the large numbers with ease...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kluuvikatu%201%2C%20Helsinki%2C%2000100%2C%20Finland"
    pageTitle="Bistro Bardot"
  />
);

export default BistroBardot;
