...
const Gaijin = () => (
  <RestaurantPage
    ...
    cuisine="Asian"
    priceRange="€€€"
    phoneNumber="+358103229386"
    website="https://www.gaijin.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gaijin comes with dark, contemporary décor, a buzzing atmosphere, attentive service and an emphasis on sharing. Its experienced owners offer boldly flavoured, skilfully presented modern takes on Japanese, Korean and Northern Chinese recipes. The tasting menus are a great way to sample the different cuisines...."
