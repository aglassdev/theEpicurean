...
const LeAnkka = () => (
  <RestaurantPage
    restaurantName="Le Ankka"
    address="Huvilakatu 28, Helsinki, 00150, Finland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+358400959440"
    website="https://www.leankka.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny little restaurant's natural buzz is enhanced by the presence of an open kitchen that feels like it's fully part of the room, while a racing green and matt black colour scheme contribute to the décor’s moody feel. Throughout the cooking, there is a desire to pair Finnish produce with classical French techniques and flavours – exemplified by the use of ‘almond potatoes’ from Lapland to make a vichyssoise. The wine list is made up of mostly natural and organic choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Huvilakatu%2028%2C%20Helsinki%2C%2000150%2C%20Finland"
    pageTitle="Le Ankka"
  />
);

export default LeAnkka;
