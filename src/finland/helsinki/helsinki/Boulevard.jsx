...
const Boulevard = () => (
  <RestaurantPage
    ...
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+358103229387"
    website="https://boulevard.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The welcome is warm, the room elegant, and the food heartening and eminently satisfying. The passion and experience of the two chef-owners is evident in all areas of this likeable restaurant. The quality of the fish and shellfish really comes through, thanks to the classic techniques used by the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bulevardi%206%2C%20Helsinki%2C%2000120%2C%20Finland"
    pageTitle="Boulevard"
  />
);
