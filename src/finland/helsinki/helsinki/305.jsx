...
const 305 = () => (
  <RestaurantPage
    restaurantName="305"
    address="Toinen linja 3, Helsinki, 00530, Finland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+358503401589"
    website="https://www.ravintola305.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friendly service, sensible prices and plenty of buzz in the air – this is the kind of neighbourhood spot we’d all love to have at the end of our street. It’s located in the north of the city, inside a substantial three-storey building dating back to the 19th Century. The unfussy dishes are a great example of Nordic bistronomy: rustic, satisfying and filled with bold, balanced flavours – whether that be fresh herbs adding vibrancy to a burbot dish, or tart lingonberries cutting through the sweetness of meringue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Toinen%20linja%203%2C%20Helsinki%2C%2000530%2C%20Finland"
    pageTitle="305"
  />
);
