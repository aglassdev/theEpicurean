...
const Savoy = () => (
  <RestaurantPage
    restaurantName="Savoy"
    address="Eteläesplanadi 14, Helsinki, 00130, Finland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+358961285300"
    website="https://savoyhelsinki.fi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This local institution’s refurbishment has restored much of its original charm and its 8th floor setting boasts superb views over Esplanade Park. Sophisticated classic dishes have a Finnish-French slant and a modern edge, with the occasional Russian touch. The wine matches are first class...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Etel%C3%A4esplanadi%2014%2C%20Helsinki%2C%2000130%2C%20Finland"
    pageTitle="Savoy"
  />
);
