...
const CafSavoy = () => (
  <RestaurantPage
    restaurantName="Café Savoy"
    address="Eteläesplanadi 14, Helsinki, 00 130, Finland"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+358961285301"
    website="https://cafesavoy.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the same building as the iconic Restaurant Savoy, on the city’s central esplanade, this well-run brasserie is spacious, airy and deservedly busy. The cooking is classical with a southern French influence, so expect to find the likes of salade Niçoise and ratatouille on the menu. The chefs prepare their good quality ingredients with care, resulting in authentic and flavoursome dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Etel%C3%A4esplanadi%2014%2C%20Helsinki%2C%2000%20130%2C%20Finland"
    pageTitle="Café Savoy"
  />
);

export default CafSavoy;
