...
const Kuurna = () => (
  <RestaurantPage
    restaurantName="Kuurna"
    address="Meritullinkatu 6, Helsinki, 00170, Finland"
    cuisine="Finnish"
    priceRange="€€"
    phoneNumber="+358447554555"
    website="https://www.kuurna.fi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small, family-run bistro in the peaceful Kruununhaka neighbourhood is a hit with the locals, who come here to enjoy flavoursome Finnish dishes crafted from regional ingredients. Square black tables are spread over two dimly lit rooms – where empty wine bottles act as vases – and you’ll be warmly welcomed in by Laura, Tom and the whole team. The menu changes every three weeks, in line with the latest seasonal produce available, and is often supplemented by daily specials that are chalked up on the blackboard. If it’s on the menu, the peanut swiss roll with potato skin ice cream is a must-try!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Meritullinkatu%206%2C%20Helsinki%2C%2000170%2C%20Finland"
    pageTitle="Kuurna"
  />
);

export default Kuurna;
