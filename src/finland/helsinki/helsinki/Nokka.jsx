...
const Nokka = () => (
  <RestaurantPage
    restaurantName="Nokka"
    address="Kanavaranta 7f, Helsinki, 00160, Finland"
    cuisine="Modern Cuisine, Finnish"
    priceRange="€€€"
    phoneNumber="+358961285600"
    website="https://nokkahelsinki.fi"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="A huge anchor and propeller mark out this harbourside warehouse and, inside, three high-ceilinged rooms juxtapose brick with varnished wood. An on-view kitchen allows you to watch wonderful, sustainably sourced ingredients being prepared in a rustic style. There is a strongly Finnish heart to the cooking, which includes classic dishes like freshly made blini topped with crème fraîche, pickled red onions and vendace roe. Friendly, professional service adds to the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kanavaranta%207f%2C%20Helsinki%2C%2000160%2C%20Finland"
    pageTitle="Nokka"
  />
);

export default Nokka;
