...
const Vinkkeli = () => (
  <RestaurantPage
    restaurantName="Vinkkeli"
    address="Pieni Roobertinkatu 8, Helsinki, 00130, Finland"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+358291800222"
    website="https://www.ravintolavinkkeli.fi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming, deservedly popular restaurant is smartly laid out and run by a delightful team, whose attentive and personable service will make you want to become a regular. The honest, well-judged cooking is a pleasing mix of the modern and the traditional...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pieni%20Roobertinkatu%208%2C%20Helsinki%2C%2000130%2C%20Finland"
    pageTitle="Vinkkeli"
  />
);

export default Vinkkeli;
