...
const GlenEllenStar = () => (
  <RestaurantPage
    restaurantName="Glen Ellen Star"
    address="13648 Arnold Dr., Glen Ellen, 95442, USA"
    cuisine="Californian, Pizza"
    priceRange="$$"
    phoneNumber="+17073431384"
    website="https://glenellenstar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The setting is charmingly quaint, but don’t be fooled—this humble cottage boasts a serious culinary operation that draws in crowds rain or shine. The cozy space hinges around a wood-burning oven, which in turn serves as the springboard for a compact menu of compelling, inventive Californian cuisine overseen by Chef Ari Weiswasser. Biodynamic produce sourced from nearby Glentucky Family Farm is a mainstay, from wholesome, vibrantly fresh salads, to lightly charred, smoke-kissed roasted vegetables like sugar snap peas with truffle-chili cashew crunch. More substantial fare ranges from seasonal pizza and pasta, to whole roasted branzino and brick chicken—all of it worthy of attention. So, too, are house-made ice creams in flavors like vanilla maple bourbon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13648%20Arnold%20Dr.%2C%20Glen%20Ellen%2C%2095442%2C%20USA"
    pageTitle="Glen Ellen Star"
  />
);

export default GlenEllenStar;
