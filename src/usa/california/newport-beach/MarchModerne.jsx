...
const MarchModerne = () => (
  <RestaurantPage
    restaurantName="Marché Moderne"
    address="7862 E. Pacific Coast Hwy., Newport Beach, 92657, USA"
    cuisine="French, French Contemporary"
    priceRange="$$$"
    phoneNumber="+17144347900"
    website="https://www.marchemoderne.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chefs/owners Florent and Amelia Marneau deliver modern dishes with hints of French classics. This is a stunning, elegant and sumptuous establishment that feels and tastes familiar yet original. The cooking follows suit from the glassed-in kitchen with soft globe lighting to the fire engine-red Berkel that's ready to slice their superb charcuterie. The classics, from coq au vin to the poached Maine lobster tail flambéed in Courvoisier and paired with a quenelle of scallop, are perfectly on point. End with a cheese plate or a traditional baba au rum. Handcrafted cocktails mirror the bounty of the seasons and may feature a host of aged spirits or enjoy the well-priced wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7862%20E.%20Pacific%20Coast%20Hwy.%2C%20Newport%20Beach%2C%2092657%2C%20USA"
    pageTitle="Marché Moderne"
  />
);

export default MarchModerne;
