...
const pageTitle = "Newport Beach";

const restaurants = [
  {
    name: "Bello by Sandro Nardone",
    cuisine: "Italian, Contemporary",
    price: "$$$",
    path: "/usa/california/newport-beach/BelloBySandroNardone",
    image: "/images/bellobysandronardone1.png"
  },
  {
    name: "Fable & Spirit",
    cuisine: "Californian, American",
    price: "$$",
    path: "/usa/california/newport-beach/FableSpirit",
    image: "/images/fablespirit1.png"
  },
  {
    name: "Marché Moderne",
    cuisine: "French, French Contemporary",
    price: "$$$",
    path: "/usa/california/newport-beach/MarchModerne",
    image: "/images/marchmoderne1.png"
  },
  {
    name: "Sushi ii",
    cuisine: "Japanese, Sushi",
    price: "$$$$",
    path: "/usa/california/newport-beach/SushiIi",
    image: "/images/sushiii1.png"
  }
];
