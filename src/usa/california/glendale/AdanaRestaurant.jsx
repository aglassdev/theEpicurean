...
const AdanaRestaurant = () => (
  <RestaurantPage
    restaurantName="Adana Restaurant"
    address="6918 San Fernando Rd., Glendale, 91201, USA"
    cuisine="Middle Eastern"
    priceRange="$$"
    phoneNumber="+18188436237"
    website="https://adanamenu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed.Come with a group and order with abandon. The food here is so good that it will be hard to hold back. This dining room manages to be both modest and ornate, filled with large round tables covered in purple linen, alongside walls of gold-framed photos and murals. The vibe is so open and friendly that you might see cheese plates being enthusiastically shared among neighboring diners. The cooking is as honest as the servers, who are happy to direct you on how to order best. Dolmeh and chicken kebabs with stewed sour cherries and an irresistible yogurt sauce are the kind of dishes one can imagine eating every day of the week. Fattoush made with crunchy vegetables, verdolagas and dressed in a lemony dressing sprinkled with sumac spells of garden goodn..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6918%20San%20Fernando%20Rd.%2C%20Glendale%2C%2091201%2C%20USA"
    pageTitle="Adana Restaurant"
  />
);

export default AdanaRestaurant;
