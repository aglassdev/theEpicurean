...
const TacosOscar = () => (
  <RestaurantPage
    restaurantName="Tacos Oscar"
    address="420 40th St., Oakland, 94609, USA"
    cuisine="Mexican, Contemporary"
    priceRange="$"
    phoneNumber=""
    website="https://www.tacososcar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's a courtyard of bright-painted shipping containers, complete with café lights strung overhead and heat lamps for chilly nights, but this quirky-cute space doles out impressive tacos. The menu is scrawled in chalk on the door of one of the containers, and while it sounds simple—tacos and tostadas—it changes often. Meat, such as the braised pork shoulder topped with an avo-tomatillo salsa and chicharrónes, is a staple; but clever vegan versions, like the charred broccoli with soy-cashew cheese, give proteins a run for their money. Equally ingenious is the smoky baba ghanoush tostada with charred sweet peppers and romano beans.Arrive when doors open to beat the lines and snag a spot at the back. Then go ahead and sip on that beer with a smile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=420%2040th%20St.%2C%20Oakland%2C%2094609%2C%20USA"
    pageTitle="Tacos Oscar"
  />
);

export default TacosOscar;
