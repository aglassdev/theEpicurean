...
const HornBarbecue = () => (
  <RestaurantPage
    restaurantName="Horn Barbecue"
    address="464 8th St., Oakland, 94607, USA"
    cuisine="Barbecue"
    priceRange="$$"
    ...
    bio="Arrive early to this local sensation from Matt Horn as there is bound to be a wait. It's well worth your time though, as the chef's West Coast Barbecue complete with inspiration is nothing less than rich, delicious, and decadent. Set along a commercial stretch and within an industrial structure, this cool, warehouse-style space features such decorative accents as a mural of an angry steer, kitchen-facing counter (with a menu right above it), and sleek wood banquettes.Employing his family's cooking traditions and all manner of meat-smoking, the chef turns out trays of brisket, pulled pork, and sausages—all unfussy yet irresistible. Sides of Granny’s potatoes and pit beans are a must; while banana pudding is likely the best way to finish the affair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=464%208th%20St.%2C%20Oakland%2C%2094607%2C%20USA"
    pageTitle="Horn Barbecue"
  />
);

export default HornBarbecue;
