...
const MariscosJalisco = () => (
  <RestaurantPage
    restaurantName="Mariscos Jalisco"
    address="753 E. Holt Ave., Pomona, 91767, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+19096346808"
    website="https://www.mariscosjalisco.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When Raul Ortega started his taco truck in Boyle Heights back in 2001, he probably had no idea just how hard the city would fall for him. Today his Jalisco-inspired tacos have become a rite of passage, and he now runs a number of trucks around town, not to mention this modest but cherished spot in Pomona.The menu is the same everywhere, limited to tostadas piled with various lime-kissed ceviches. Inside tip: opt for his signature fried shrimp taco tinged with spicy salsa and creamy avocado slices. It's an unequaled version, complete with a crunchy shell that collapses like tempura, as well as a rich and savory filling. First-time customers start with a single order, while regulars get right to business with a whole plate of them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=753%20E.%20Holt%20Ave.%2C%20Pomona%2C%2091767%2C%20USA"
    pageTitle="Mariscos Jalisco"
  />
);

export default MariscosJalisco;
