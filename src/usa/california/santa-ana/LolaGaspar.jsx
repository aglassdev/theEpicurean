...
const LolaGaspar = () => (
  <RestaurantPage
    restaurantName="Lola Gaspar"
    address="211 W. 2nd St., Santa Ana, 92701, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+17149721172"
    website="https://www.lolagasparsantaana.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=211%20W.%202nd%20St.%2C%20Santa%20Ana%2C%2092701%2C%20USA"
    pageTitle="Lola Gaspar"
  />
);

export default LolaGaspar;
