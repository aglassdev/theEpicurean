...
const VillageSake = () => (
  <RestaurantPage
    restaurantName="Village Sake"
    address="19 Bolinas Rd., Fairfax, 94930, USA"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber="+14155215790"
    website="https://www.villagesake.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set along a bustling stretch, Village Sake is a mighty hot and mod izakaya delivering authentic goods in the heart of quaint Fairfax. All the classic small plates are in full force here: crisp and creamy takoyaki (octopus croquettes), okonomiyaki, tataki (made with silky smoked hamachi) and coconut mochi cake complete with cardamom gelato. If you must have sushi, there’s a small selection of excellent nigiri, too—make sure to sample the shima aji and kinmedai.The look of the room suggests Tokyo, with closely spaced tables, an array of wood accents (including a live-edge wood counter) as well as a friendly staff, many of them Japanese natives. This is a popular spot that doesn’t take reservations, so expect long lines, especially on weekends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Bolinas%20Rd.%2C%20Fairfax%2C%2094930%2C%20USA"
    pageTitle="Village Sake"
  />
);

export default VillageSake;
