...
const TheLark = () => (
  <RestaurantPage
    restaurantName="The Lark"
    address="131 Anacapa St., Santa Barbara, 93101, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+18052840370"
    website="https://www.thelarksb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former fish market is located in the Funk Zone arts district, just a stone’s throw from the oceanfront. The vibrant dining room has become one of the trendiest places in town, largely thanks to the urban scene it fashions through an edgy décor and vintage lighting. Service remains cool and laid-back as ever, while also taking very good care of each guest.Meals are served as large, family-style portions that are meant to be shared and spotlight the central coast’s finest ingredients. Well-mastered original creations may unveil blistered shishito peppers and roasted eggplant with cilantro yogurt, sweet and sour pickles as well as duck-fat breadcrumbs.The wine selection is a smart representation of the best of Santa Barbara’s producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=131%20Anacapa%20St.%2C%20Santa%20Barbara%2C%2093101%2C%20USA"
    pageTitle="The Lark"
  />
);

export default TheLark;
