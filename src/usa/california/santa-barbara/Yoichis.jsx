...
const Yoichis = () => (
  <RestaurantPage
    restaurantName="Yoichi’s"
    address="230 E. Victoria St., Santa Barbara, 93101, USA"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+18059626627"
    website="https://www.yoichis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quaint little house run by a husband-wife team just happens to be one of the area's favorite spots for traditional Japanese dining. This should be no surprise, as Chef Yoichi Kawabata’s background includes cooking at Nobu Tokyo. The dining room is quiet and serene, filled with white walls and dark wood tables—there is no sushi counter. Service is both friendly and informative.The seven-course menu respects all the rules of kaiseki dining, using top seasonal ingredients and pristine, top-class fish. Meals begin with an array of four appetizers (zenzai) including delectable Wagyu beef that has been grilled and glazed in a sansho pepper sauce. Then grilled duck breast may be prepared with perfect tenderness in sweet soy sauce with green peppers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=230%20E.%20Victoria%20St.%2C%20Santa%20Barbara%2C%2093101%2C%20USA"
    pageTitle="Yoichi’s"
  />
);

export default Yoichis;
