...
const SamaSamaKitchen = () => (
  <RestaurantPage
    restaurantName="Sama Sama Kitchen"
    address="1208 State St., Santa Barbara, 93101, USA"
    cuisine="Asian"
    priceRange="$$"
    phoneNumber="+18059654566"
    website="https://samasamakitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery in the heart of downtown is not only good fun but also good for the wallet. Here, the Chefs/partners bring their disparate expertise—one is a barbecue aficionado from Nashville, the other is Indonesian, and together they turn out a menu of thoroughly pleasing Southeast Asian food. Attractions include a well-spiced rendition of green papaya salad, mixing aromatic herbs, chilies and peanuts. Bao can be ordered fried or steamed, which yields a pillowy soft bun to be filled with crunchy fried chicken in a tangy sauce.The interior is appealingly simple, but the back patio is a hidden gem, filled with string lights and communal tables that can be booked for parties. Weekday happy hour simply means steep discounts on a variety of food and drinks...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1208%20State%20St.%2C%20Santa%20Barbara%2C%2093101%2C%20USA"
    pageTitle="Sama Sama Kitchen"
  />
);

export default SamaSamaKitchen;
