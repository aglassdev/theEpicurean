...
const AllSpice = () => (
  <RestaurantPage
    restaurantName="All Spice"
    address="1602 S. El Camino Real, San Mateo, 94402, USA"
    cuisine="International, American Contemporary"
    priceRange="$$$$"
    phoneNumber="+16506274303"
    website="https://www.allspicerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Like a bracelet glittering with different jewels, All Spice is home to a bevy of vibrant dining rooms, made extra colorful with artwork and sparkling chandeliers. It’s a delightful blend of old-school charm and contemporary verve that appeals to a sophisticated crowd. They’re usually here to catch up with friends or celebrate a birthday.This kitchen offers a variety of creative selections on both the three- and five-course tasting menus, which spin to highlight the seasons. Chilled butternut squash soup in a shot glass makes a soigné amuse-bouche and is a delicious way to start a meal. Then a brick-shaped, perfectly cooked strip loin is accompanied by baby zucchini, pearl onions, confit mushrooms and smoked kale sauce for added enrichment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1602%20S.%20El%20Camino%20Real%2C%20San%20Mateo%2C%2094402%2C%20USA"
    pageTitle="All Spice"
  />
);

export default AllSpice;
