...
const HanaRe = () => (
  <RestaurantPage
    restaurantName="Hana re"
    address="2930 Bristol St., Costa Mesa, 92626, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+17145452800"
    website="https://www.hanaresushi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in the back corner of a Costa Mesa shopping mall, this intimate ten-seat counter offers a relaxing retreat from the outside world. Chef Atsushi Yokoyama skillfully oversees a leisurely omakase, beginning with variety of composed dishes such as chawanmushi with blue shrimp and smoked trout roe, perhaps followed by such delicacies as hairy crab dressed with tangy tosazu gelee, or tender braised abalone with leek puree and Hokkaido uni. Nigiri forms the final portion of the savory menu, continuing the theme of simply prepared, excellent quality seafood. To finish, a delicate almond panna cotta with seasonal fruit. A compelling variety of sake options adds an additional appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2930%20Bristol%20St.%2C%20Costa%20Mesa%2C%2092626%2C%20USA"
    pageTitle="Hana re"
  />
);

export default HanaRe;
