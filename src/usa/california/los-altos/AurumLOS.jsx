...
const AurumLOS = () => (
  <RestaurantPage
    ...
    address="132 State St., Los Altos, 94022, USA"
    cuisine="Indian, Classic Cuisine"
    priceRange="$$$"
    phoneNumber="+16503835221"
    website="https://www.aurumca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enter this gem only to be enveloped in an orbit of colors and textures. From the bright walls and eclectic glass details, to fresh flowers and leather seats, this sleek Indian welcomes all and sundry. Thanks to the collab between Chef Manish Tyagi and owner Anupam Bhatia, the menu is an homage to the nation's forgotten recipes. Every dish is elegantly composed and flavors are infinitely varied. Diners who get to feast on The Feast will be privy to a three-course spread. Carnivores, however, will savor lamb skewers with roasted spices; while pescataraians won't be able to resist the Malvani fish curry. Earthy mushrooms strike a wonderful contrast against sweet English peas.Out of the way desserts like tapioca kheer are quite simply out of this world...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=132%20State%20St.%2C%20Los%20Altos%2C%2094022%2C%20USA"
    pageTitle="Aurum"
  />
);

export default AurumLOS;
