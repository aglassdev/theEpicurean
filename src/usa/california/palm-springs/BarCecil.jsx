...
const BarCecil = () => (
  <RestaurantPage
    restaurantName="Bar Cecil"
    address="1555 S. Palm Canyon Dr., Ste. H-104, Palm Springs, 92264, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+14423323800"
    website="https://barcecil.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With sumptuous design that straddles garish and chic, boasting walls splashed with an impressive private collection of modern art (including pieces by Calder and Warhol) here you'll find a visual feast—as well as the hottest table in town. Reservations book weeks in advance, so if you're seeking a spur-of-the-moment meal, your best bet is to arrive before doors open and put your name down for a coveted bar seat. A precisely made martini is practically de rigueur; one particularly pricy option has a caviar-topped deviled egg for a garnish. It would be easy to spend a small fortune here on items like roasted king crab legs or Ossetra with blini, but hearty American fare, like a signature burger dressed up with melted Comté, is still very much in fashion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1555%20S.%20Palm%20Canyon%20Dr.%2C%20Ste.%20H-104%2C%20Palm%20Springs%2C%2092264%2C%20USA"
    pageTitle="Bar Cecil"
  />
);

export default BarCecil;
