...
const Pastabar = () => (
  <RestaurantPage
    ...
    address="16101 Ventura Blvd., Ste. 250, Encino, 91436, USA"
    cuisine="Contemporary, American"
    priceRange="$$$$"
    phoneNumber="+18182081805"
    website="https://www.pastabarla.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A stylishly modern space hidden inside an unassuming strip mall, this hip concept's tasting menu is one for the books. Offered in a well-appointed front bar, drinks and a snack kick things off, and the staff is wonderfully engaging as they serve a host of delectable, hyper-local items. The eclectic cuisine travels beyond the borders of Italian tradition, offering up such creations as a raviolo filled with king crab, fermented pineapple, and macadamia nuts, or perfectly chewy cavatelli with Iberico pork, chile pasilla mixe, and earthy mole. Australian lamb loin features a merguez sausage made from its belly meat, matched with cherries, cipollini, and dusky rose-hued pasta filled with braised lamb neck. Desserts, like a bone marrow custard filled with blackberry granita and crisp meringue, a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16101%20Ventura%20Blvd.%2C%20Ste.%20250%2C%20Encino%2C%2091436%2C%20USA"
    pageTitle="Pasta|Bar"
  />
);

export default Pastabar;
