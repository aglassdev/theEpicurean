...
const EthelsFancy = () => (
  <RestaurantPage
    restaurantName="Ethel's Fancy"
    address="550 Waverley St., Palo Alto, 94301, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+16505614860"
    website="https://www.ethelsfancypa.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Honoring the shared name of his mother and grandmother, Chef/owner Scott Nishiyama has taken off his fine-dining toque to don more casual garb at this Palo Alto charmer, and thankfully he hasn't missed a stitch. Appropriately, the space has a rustic-meets-elegant vibe, mirrored in eclectic, down-to-earth Californian cuisine that showcases peak-season ingredients prepared with care and refinement. A small menu, geared towards sharing, exemplifies this creative ethos with dishes like a beautifully fried katsu-style cutlet of swordfish matched with spiced kumquats and tangy Dijonnaise. Intriguing desserts like a hojicha tapioca pudding topped with a rice cracker bark are hard to resist, and the friendly, professional service sweetens the pot even further...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=550%20Waverley%20St.%2C%20Palo%20Alto%2C%2094301%2C%20USA"
    pageTitle="Ethel's Fancy"
  />
);

export default EthelsFancy;
