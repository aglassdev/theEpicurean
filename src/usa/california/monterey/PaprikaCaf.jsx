...
const PaprikaCaf = () => (
  <RestaurantPage
    restaurantName="Paprika Café"
    address="309 Lighthouse Ave., Monterey, 93940, USA"
    cuisine="Mediterranean Cuisine, Greek"
    priceRange="$"
    phoneNumber="+18313757452"
    website="https://www.paprikacafe-monterey.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny spot is the perfect sojourn before or after a visit to the Monterey Bay Aquarium, thanks to its delectable and affordable Mediterranean food and friendly service. A diminutive and humble place, it has only six tables, but the chef/owner provides a warm welcome, recommending favorite items before he goes to work in the tiny back kitchen.Vegans and vegetarians will delight in the ample menu featuring flaky spanakopita, smoky baba ghanoush and vibrant tabbouleh with a perfect zip from fresh lemon. The tahini that accompanies the crisp, golden falafel is luscious, and a classic Greek salad is refreshingly satisfying. Don’t fill up completely though, as the homemade baklava, which just so happens to be vegan, is sure to sate and is available packaged to go...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=309%20Lighthouse%20Ave.%2C%20Monterey%2C%2093940%2C%20USA"
    pageTitle="Paprika Café"
  />
);

export default PaprikaCaf;
