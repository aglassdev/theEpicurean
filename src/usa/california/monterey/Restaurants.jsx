...
const restaurants = [
  {
    ...
    price: "$$$$",
    path: "/usa/california/monterey/CoastalKitchen",
    image: "/images/coastalkitchen1.png"
  },
  {
    name: "Montrio Bistro",
    cuisine: "Contemporary",
    price: "$$$",
    path: "/usa/california/monterey/MontrioBistro",
    image: "/images/montriobistro1.png"
  },
  {
    name: "Paprika Café",
    cuisine: "Mediterranean Cuisine, Greek",
    price: "$",
    path: "/usa/california/monterey/PaprikaCaf",
    image: "/images/paprikacaf1.png"
  },
  {
    name: "Stokes Adobe",
    cuisine: "Contemporary",
    price: "$$$",
    path: "/usa/california/monterey/StokesAdobe",
    image: "/images/stokesadobe1.png"
  },
  {
    name: "The Sardine Factory",
    cuisine: "Seafood, American",
    price: "$$$$",
    path: "/usa/california/monterey/TheSardineFactory",
    image: "/images/thesardinefactory1.png"
  }
];
