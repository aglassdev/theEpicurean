...
const Grange = () => (
  <RestaurantPage
    restaurantName="Grange"
    address="926 J St., Sacramento, 95814, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+19164924450"
    website="https://www.grangerestaurantandbar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Citizen Hotel is primo for those with business on their minds, but that doesn’t mean it’s all just corporate here downtown. In fact, Grange, tucked inside the hotel, is proof positive that business and pleasure mix with fine results. High ceilings and an arched shelf stacked with liquor instantly draw the eye, while wood tables lined with orange leather banquettes balance style and comfort. If visiting midday, opt for the Power Lunch and enjoy three courses for a palatable price.The menu shares a farm-focused sensibility with rustic creations. Mojo pork loin spread with calabrese bomba on toasted bread is simple and tasty, not unlike the dependably creamy broccoli-arugula soup. Hazelnut cake with strawberry and chocolate ends things on a sweet note...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=926%20J%20St.%2C%20Sacramento%2C%2095814%2C%20USA"
    pageTitle="Grange"
  />
);
