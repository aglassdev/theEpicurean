...
const KinThai = () => (
  <RestaurantPage
    restaurantName="Kin Thai"
    address="1050 20th St., Ste. 180, Sacramento, 95811, USA"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+19166198144"
    website="https://www.kinthaieatery.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sisters and co-owners Napis Lindley and Napak Kongsitthanakor have brought the vibrant, punchy flavors of Thai street food to this modern converted warehouse space in Midtown. The menu spans a wide array of regional specialties, running the gamut of flavors from sweet and sour to funky and hot—and diners seeking heat will get their wish with a request of “Thai spicy.” Approachable favorites like pad Thai (served wrapped in a thin egg crepe) and flaky potato-filled curry puffs share space with lesser-known delicacies like clay-pot shrimp and Isaan sausage. Sweets like mango sticky rice and roti with condensed milk hit their marks, but a Thai tea slushy (topped with brown sugar boba or grass jelly) is especially worthwhile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1050%2020th%20St.%2C%20Ste.%20180%2C%20Sacramento%2C%2095811%2C%20USA"
    pageTitle="Kin Thai"
  />
);

export default KinThai;
