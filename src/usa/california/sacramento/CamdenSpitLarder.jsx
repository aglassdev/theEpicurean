...
const CamdenSpitLarder = () => (
  <RestaurantPage
    restaurantName="Camden Spit & Larder"
    address="555 Capitol Mall, Sacramento, 95814, USA"
    cuisine="Gastropub"
    priceRange="$$$"
    phoneNumber="+19166198897"
    website="https://www.camdenspitandlarder.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Downtown Sacramento meets sexy uptown London at this foodie haven, where Chef Oliver Ridgeway applies his formidable British culinary know-how to farm-fresh Californian ingredients. Inside, the striking dining room features glossy floor-to-ceiling windows; a polished, forever-bustling bar; as well as a lovely outdoor dining area overlooking Capitol Mall.As the name informs, spit-roasted meats take center stage here. A decadent evening feast might begin with an airy popover before settling into more substantial dishes. Don’t miss the incredibly tender prime rib, paired with crispy golden potato rösti, fermented horseradish, sour cream and peppery watercress. Classic English desserts, like the scrumptious Banoffee pie, are perfect for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=555%20Capitol%20Mall%2C%20Sacramento%2C%2095814%2C%20USA"
    pageTitle="Camden Spit & Larder"
  />
);

export default CamdenSpitLarder;
