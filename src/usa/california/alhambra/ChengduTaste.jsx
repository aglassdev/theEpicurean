...
const ChengduTaste = () => (
  <RestaurantPage
    restaurantName="Chengdu Taste"
    address="828 W. Valley Blvd., Alhambra, 91803, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$"
    phoneNumber="+16265882284"
    website="https://www.fetail.com/storev2/shop?store_id=23"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Some Sichuan kitchens temper their heat levels depending on what they think the customer can handle. Not this one. This long-standing veteran has never been one to hold anyone’s hand and their widespread success has not at all cooled their approach. Expect nothing less than the full-throttle Sichuan experience where tongue-numbing, lip-tingling dishes arrive coated in heavy spices, garnished with sliced chilis and, often, doused in fire-engine red chili oil. Toothpick lamb is the house signature, but the crispy-crusted beef is a formidable rival. Fish with mom’s preserved chili sauce is unapologetically sinus-clearing. Even vegetables like the arden lettuce are a powerhouse of stir-fried garlic excellence. Swing by for lunch to avoid the lines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=828%20W.%20Valley%20Blvd.%2C%20Alhambra%2C%2091803%2C%20USA"
    pageTitle="Chengdu Taste"
  />
);

export default ChengduTaste;
