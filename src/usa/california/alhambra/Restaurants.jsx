...
const restaurants = [
  {
    ...
    price: "$$",
    path: "/usa/california/alhambra/ChengduTaste",
    image: "/images/chengdutaste1.png"
  },
  {
    name: "Henry's Cuisine",
    cuisine: "Chinese, Cantonese",
    price: "$$$",
    path: "/usa/california/alhambra/HenrysCuisine",
    image: "/images/henryscuisine1.png"
  },
  {
    name: "Ipoh Kopitiam",
    cuisine: "Malaysian",
    price: "$$",
    path: "/usa/california/alhambra/IpohKopitiam",
    image: "/images/ipohkopitiam1.png"
  },
  {
    name: "Jiang Nan Spring",
    cuisine: "Chinese, Shanghainese",
    price: "$$",
    path: "/usa/california/alhambra/JiangNanSpring",
    image: "/images/jiangnanspring1.png"
  },
  {
    name: "Lunasia Dim Sum House",
    cuisine: "Chinese, Dim Sum",
    price: "$$",
    path: "/usa/california/alhambra/LunasiaDimSumHouse",
    image: "/images/lunasiadimsumhouse1.png"
  },
  {
    name: "Sichuan Impression",
    cuisine: "Chinese, Sichuan",
    price: "$$",
    path: "/usa/california/alhambra/SichuanImpression",
    image: "/images/sichuanimpression1.png"
  }
];
