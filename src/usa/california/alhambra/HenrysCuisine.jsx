...
const HenrysCuisine = () => (
  <RestaurantPage
    restaurantName="Henry's Cuisine"
    address="301 E. Valley Blvd., Alhambra, 91801, USA"
    cuisine="Chinese, Cantonese"
    priceRange="$$$"
    phoneNumber="+16265761288"
    website="https://www.henryscuisine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an unremarkable building that nearly blends in with the rest of the street, Henry’s has quietly but confidently satisfied an ever-dwindling demand for homestyle Cantonese cooking since 2015. With a scarlet-red lobster as their logo, shells painted silver and gold and hung on the wall, and large groups huddled around platters of it, there isn’t much guessing as to what the signature is here. Come for dinner to unlock the menu’s full breadth of specialties. Highlights include delicately fried shrimp with salted egg as well as a striking deep-fried salted pig’s feet, its skin as crisp and crunchy as a chip. Vegetables are a must but ask what’s in season. We’re partial to the soothing, quiet bitterness of mustard greens with garlic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=301%20E.%20Valley%20Blvd.%2C%20Alhambra%2C%2091801%2C%20USA"
    pageTitle="Henry's Cuisine"
  />
);

export default HenrysCuisine;
