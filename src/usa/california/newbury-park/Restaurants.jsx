...
const pageTitle = "Newbury Park";

const restaurants = [
  {
    name: "Cedro Italian Restaurant",
    cuisine: "Italian",
    price: "$$",
    path: "/usa/california/newbury-park/CedroItalianRestaurant",
    image: "/images/cedroitalianrestaurant1.png"
  }
];
