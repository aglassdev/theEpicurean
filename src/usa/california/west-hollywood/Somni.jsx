...
const Somni = () => (
  <RestaurantPage
    restaurantName="Somni"
    address="9045 Nemo St., West Hollywood, 90069, USA"
    ...
    bio="Chef Aitor Zabala and his dedicated team have awakened Somni, Catalan for dream, from a long sleep and have fashioned this revamped iteration as a distinctly personal and unique dining experience. Tucked away just off Santa Monica Avenue, the dining room's soothing, creamy palette with light wood and glass is marked by a colorful bull's head from the original spot, hinting at the Spanish-inflected cuisine. A procession of small bites is meticulously arranged and endlessly creative, sating diners with an abundance of rich flavors and textural interplay (think mussel escabeche, gazpacho, or the iconic shiso tartare tempura). All the while, the kitchen and service teams are in lockstep as they create and serve these arresting dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9045%20Nemo%20St.%2C%20West%20Hollywood%2C%2090069%2C%20USA"
    pageTitle="Somni"
  />
);

export default Somni;
