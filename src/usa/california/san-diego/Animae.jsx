...
const Animae = () => (
  <RestaurantPage
    restaurantName="Animae"
    address="969 Pacific Hwy., San Diego, 92101, USA"
    cuisine="Asian"
    priceRange="$$$"
    phoneNumber="+16194321225"
    website="https://www.animaesd.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's smack dab in the heart of San Diego's power scene, located on the ground floor of the Pacific Gate by Bosa in the Embarcadero Marina, so it comes as no surprise that Animae is sexy and scene-y. This bastion of glamour attracts a who's who of trendy diners who come here largely to be seen—attention seekers should ask for the cushy round booths in the center of it all. Luxe details abound, with thick velvet curtains and art deco elegance, but the Asian fusion plates are on pace with the setting and most dishes are meant to be shared. The coal-fired octopus skewer with shishito peppers, basil aïoli and bacon is a reliable pick, while the chef's rendition of glazed black cod with tatsoi , sunflower dashi and shimeji mushrooms is a total crowd-pleaser...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=969%20Pacific%20Hwy.%2C%20San%20Diego%2C%2092101%2C%20USA"
    pageTitle="Animae"
  />
);
