...
const HiddenFish = () => (
  <RestaurantPage
    restaurantName="Hidden Fish"
    address="4764 Convoy St., San Diego, 92111, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$"
    phoneNumber="+18582105056"
    website="https://www.hiddenfishsushi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll be on the clock at this tiny sushi spot, where the omakase is priced at a straightforward dollar per minute—50 for 12 nigiri, or 90 for 18. But despite such punctuality, you will savor every bite here. In fact, you’ll find yourself slowing down to savor each and every creation from the talented chefs. However, seats here are hard to come by so be sure to reserve ahead of time or risk serious FOMO.Like other top-tier sushiyas, this one sources from across the globe: Peruvian scallops, Santa Barbara uni, and of course, plenty of Japanese species. A chalkboard menu keeps diners apprised of the current lineup, and for those who are still peckish after their tasting, there’s a bonus menu of handrolls and special seasonal nigiri for further sampling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4764%20Convoy%20St.%2C%20San%20Diego%2C%2092111%2C%20USA"
    pageTitle="Hidden Fish"
  />
);

export default HiddenFish;
