...
const SiamoNapoli = () => (
  <RestaurantPage
    restaurantName="Siamo Napoli"
    address="3959 30th St., San Diego, 92104, USA"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+16193106981"
    website="https://www.siamonapolisd.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Flavio Piromallo has another hit on his hands with this hip North Park District spot. In keeping with its trendy surrounds, the décor sports an industrial-chic look with concrete floors, exposed pipes and a massive photographic elegy to Sophia Loren. Laid-back, cool service completes the experience. The modern affect belies its classic Southern Italian cooking. Neapolitan-style pizza is a favorite, and the homemade pastas have terrific flavor—ravioli con manzana is a delicious signature. Mandorle al Caffé, a spongy almond cake with a layer of espresso custard surrounded by a duo of white and black chocolate sauce, is a decadent way to end a satisfying meal. Lunchtime leans quiet, but come for dinner for a lively and entertaining scene...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3959%2030th%20St.%2C%20San%20Diego%2C%2092104%2C%20USA"
    pageTitle="Siamo Napoli"
  />
);

export default SiamoNapoli;
