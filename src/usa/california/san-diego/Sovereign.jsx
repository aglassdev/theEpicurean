...
const Sovereign = () => (
  <RestaurantPage
    restaurantName="Sovereign"
    address="1460 J St., San Diego, 92101, USA"
    cuisine="Thai, Lao"
    priceRange="$"
    phoneNumber="+16193105837"
    website="https://www.sovereignsandiego.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brother and sister team—Uthan Dejcomrunkul and Jumi Pitiwartarlai—have made it their mission to bring the authentic flavors of the Isaan region of Northeastern Thailand to San Diego, and this East Village outpost clearly succeeds. You'll be hard-pressed to make a wrong choice on the  menu, whose small assortment of dishes are each made with unmistakable pride.Diners might start with spicy fermented pork sausage (nicely paired with a side of purple sticky rice and an ice-cold Singha); then move on to a spin on khao soi, or coconut curry noodles, given extra heft thanks to a crispy leg of duck confit subbing in for the typical chicken. Finish on a sweet note with house-made taro ice cream, served over coconut sticky rice sprinkled with toasted flakes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1460%20J%20St.%2C%20San%20Diego%2C%2092101%2C%20USA"
    pageTitle="Sovereign"
  />
);
