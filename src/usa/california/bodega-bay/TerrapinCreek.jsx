...
const TerrapinCreek = () => (
  <RestaurantPage
    restaurantName="Terrapin Creek"
    address="1580 Eastshore Rd., Bodega Bay, 94923, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+17078752700"
    website="https://www.terrapincreekcafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether it’s the ochre walls, the bold artwork or the fireplace, Terrapin Creek emits palpable warmth. Liya Lin and Andrew Truong, partners and co-chefs, have created an alluring sanctum where everyone feels like a regular, whether you’re a resident or simply here to spot the migrating whales.The menu is concise, so expect a spectrum of bites that may include grilled Monterey sardines set over shaved radishes and cabbage dressed in a refreshing lime-curry vinaigrette. Pasta is made in house, so dig your fork into those torch-shaped curls with crumbled merguez, chopped spinach, feta cheese, mint and sweet English peas in a spicy tomato-based broth. For dessert, a chocolate cake with cream cheese frosting is bested with a heavenly caramel sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1580%20Eastshore%20Rd.%2C%20Bodega%20Bay%2C%2094923%2C%20USA"
    pageTitle="Terrapin Creek"
  />
);

export default TerrapinCreek;
