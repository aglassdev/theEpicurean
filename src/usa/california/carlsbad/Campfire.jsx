...
const Campfire = () => (
  <RestaurantPage
    restaurantName="Campfire"
    address="2725 State St., Carlsbad, 92008, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+17606375121"
    website="https://www.thisiscampfire.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a midcentury Quonset hut enlivened with eclectic outdoorsy decorations, this rough-and-tumble counterpart to more glamorous nearby Jeune et Jolie has plenty of fun with its theme, down to the teepee on the patio. The centerpiece is a custom-built 12-foot wood-burning hearth, which lends an appropriate note of smoke to many of the kitchen’s offerings, from vegetables like crispy roasted broccoli with a tangy chermoula sauce, or grilled octopus with Jimmy Nardello peppers. Meatier options like slow-cooked brisket or a hefty tomahawk steak for two will sate even the burliest appetites. A nearly obligatory end to this glamping experience is the DIY s’mores, served with a small pile of red-hot coals for toasting fluffy house-made marshmallows...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2725%20State%20St.%2C%20Carlsbad%2C%2092008%2C%20USA"
    pageTitle="Campfire"
  />
);
