...
const BoonvilleHotelRestaurant = () => (
  <RestaurantPage
    restaurantName="Boonville Hotel & Restaurant"
    address="14050 Hwy. 128, Boonville, 95415, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+17078952210"
    website="https://www.boonvillehotel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Unless you’re already staying at the hotel, dinner here means driving along the lonely, hairpin-turning, and mountainous course of Highway 128 until you reach the quaint town of Boonville. But what a happy place it is, thanks to the talents of Chef Perry Hoffman, who prepares simple but arresting plates highlighting product sourced from their own vegetable garden and local farms. A recent menu showcased roasted sunchokes tossed with a rosemary vinaigrette; braised pork set in a pool of red floriani polenta made ultra-creamy with Pecorino Romano and parmesan; as well as a decadent chocolate brownie with cardamom ice cream.This is food that’s easy to eat—again and again. Opening hours change with the season and the menu daily, so check the website before making the drive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14050%20Hwy.%20128%2C%20Boonville%2C%2095415%2C%20USA"
    pageTitle="Boonville Hotel & Restaurant"
  />
);

export default BoonvilleHotelRestaurant;
