...
const pageTitle = "Boonville";

const restaurants = [
  {
    name: "Boonville Hotel & Restaurant",
    cuisine: "American",
    price: "$$$",
    path: "/usa/california/boonville/BoonvilleHotelRestaurant",
    image: "/images/boonvillehotelrestaurant1.png"
  }
];
