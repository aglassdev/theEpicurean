...
const Yafa = () => (
  <RestaurantPage
    restaurantName="Yafa"
    address="Junipero St., Carmel-by-the-Sea, 93923, USA"
    cuisine="Mediterranean Cuisine, Middle Eastern"
    priceRange="$$"
    phoneNumber="+18316249232"
    website="https://www.yafarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This clear hit among locals has even spread to tourists—everyone comes back time and again. The owners bring hospitality to a new level, thanks to a jovial greeting and warm farewells that may involve a hug from the owner.The smell of roasting meats entices passersby with the promise of their excellent kebabs, like deliciously charred yet tender chicken skewered with tomatoes. The Aleppo kafta, combining ground beef and lamb, is richly seasoned and perfectly paired with a side of zippy tzatziki. Be sure to begin any meal with an enormous plate of their mezze, heaped with minty cucumber and tomato salad, hummus as well as a sundried tomato- and feta-dip for scooping up with warm and fluffy pita.Weekends bring a host of live music performances...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Junipero%20St.%2C%20Carmel-by-the-Sea%2C%2093923%2C%20USA"
    pageTitle="Yafa"
  />
);
