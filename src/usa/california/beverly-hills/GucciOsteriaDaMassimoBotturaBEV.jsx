...
const GucciOsteriaDaMassimoBotturaBEV = () => (
  <RestaurantPage
    restaurantName="Gucci Osteria da Massimo Bottura"
    address="347 N. Rodeo Dr., Beverly Hills, 90210, USA"
    cuisine="Italian, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14246007490"
    website="https://www.gucciosteria.com/en/beverlyhills"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Massimo Bottura has put the talented Mattia Agazzi in charge of this kitchen housed within the Gucci boutique on Rodeo Drive, and the results are very impressive indeed. This is cooking that is at once whimsical and grounded. Seafood salad arrives perfectly warm and tender, dressed with lemon, olive oil and shaved radish; while risotto is camouflaged as pizza with tomato, stracciatella and burnt caper dust evoking the taste of a charred crust. Thumb-sized tortellini, filled with the classic mortadella, veal and prosciutto mixture, sits pretty in a glossy pool of Parmigiano Reggiano-enriched sauce.The meal ends with a concise choice of desserts, including the colorfully named A Bunch of Flowers, with a scoop of chamomile ice cream on green apple sauce with candied lemon peel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=347%20N.%20Rodeo%20Dr.%2C%20Beverly%20Hills%2C%2090210%2C%20USA"
    pageTitle="Gucci Osteria da Massimo Bottura"
  />
);

export default GucciOsteriaDaMassimoBotturaBEV;
