...
const PlumedHorse = () => (
  <RestaurantPage
    ...
    address="14555 Big Basin Way, Saratoga, 95070, USA"
    cuisine="Contemporary, American Contemporary"
    priceRange="$$$$"
    phoneNumber="+14088674711"
    website="https://plumedhorse.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="There has been a Plumed Horse in this spot since 1952, though this decade-old iteration is by far the best. The décor exudes warmth, and the setting is elegant, yet comfortable.This inventive kitchen turns out upscale modern cooking. Duck consommé, poured tableside and enhanced with meaty mushrooms and a bright English pea flan, is as impressive to the eye as it is to the palate, while locally sourced abalone is finished with XO sauce for a pop of flavor. The decadent black pepper- and parmesan-soufflé with an uni petal is of the dive-right-in variety.Almond cake with cocoa-nib mousse and orange foam is decadent, but wait for the rows of chocolates from Chocolaterie by Angelica, wheeled over in a glass-domed cart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14555%20Big%20Basin%20Way%2C%20Saratoga%2C%2095070%2C%20USA"
    pageTitle="Plumed Horse"
  />
);

export default PlumedHorse;
