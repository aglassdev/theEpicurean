...
const Leyou = () => (
  <RestaurantPage
    restaurantName="LeYou"
    address="1100 N. First St., Ste. C., San Jose, 95112, USA"
    cuisine="Ethiopian, American"
    priceRange="$$"
    phoneNumber="+14083202620"
    website="https://www.leyouethiopian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="LeYou is an ode to contemporary Ethiopia, where the dining room is filled with tall, leafy greenery, tables are topped with burlap coffee bags tucked under thick glass, and artwork adorns the walls. Dynamic chef/co-owner Aida Taye offers a lighter, unique approach to Ethiopian cuisine, as in a kifto that substitutes lean tuna for beef. Kick off the meal with kategna, an injera toasted to a crisp, doused with chili powder and served with a sour-cream/yogurt dip. A vegetable platter includes gomen, or chopped collard greens; atakilt, a tender stew of cabbage, potatoes and carrots; fossolia, or green beans stewed with carrots, turmeric, tomato and onions; and azifa selat'a, refreshing green lentils tossed in lemon juice and hot mustard vinaigrette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1100%20N.%20First%20St.%2C%20Ste.%20C.%2C%20San%20Jose%2C%2095112%2C%20USA"
    pageTitle="LeYou"
  />
);

export default Leyou;
