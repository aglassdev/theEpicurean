...
const Himitsu = () => (
  <RestaurantPage
    restaurantName="Himitsu"
    address="1030 Torrey Pines Rd. G, La Jolla, 92037, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$"
    phoneNumber="+18582634463"
    website="https://himitsusd.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Irasshaimase! is the greeting commonly heard upon entering this cozy little sushiya. You’ll want to plan ahead to snag one of the eight coveted seats at the pristine counter, but it’s well worth the forethought, as these friendly chefs take great pride in discussing the quality of their fish and the techniques used to prepare your meal. It’s also a front row seat to their admirable knife skills.Such affability extends to the dining room, where servers flash big smiles and loads of greenery as well as natural wood come together to create a truly serene effect. Omakase is the way to go, but there are à la carte options as well—from appetizers, soups, sashimi and maki (sporting soft, well-seasoned rice) to specialty plates and daily fish specials...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1030%20Torrey%20Pines%20Rd.%20G%2C%20La%20Jolla%2C%2092037%2C%20USA"
    pageTitle="Himitsu"
  />
);

export default Himitsu;
