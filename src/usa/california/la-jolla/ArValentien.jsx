...
const ArValentien = () => (
  <RestaurantPage
    restaurantName="A.R. Valentien"
    address="11480 N. Torrey Pines Rd., La Jolla, 92037, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+18587776635"
    website="https://www.lodgetorreypines.com/ar-valentien"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Every element of this setting seems to exude a California-casual meets country-club vibe. Inside, choose from one of the Craftsman post-and-beam dining rooms, warm with amber lanterns and stained-glass light fixtures; or simply head outside to dine on the patio overlooking the pool and 18th hole of Torrey Pines Golf Course. The city's unending growing season means that there is a boundless harvest of local ingredients to inspire this kitchen. Begin with Dungeness crab flan surrounded by watercress, Belgian endive and roasted grapes, drizzled with tangy balsamic dressing. Then, indulge in elevated comfort foods like chicken under a brick, set over Tuscan kale and cannellini beans in tomato sauce. The brûléed lemon sabayon tart is above par and pure joy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11480%20N.%20Torrey%20Pines%20Rd.%2C%20La%20Jolla%2C%2092037%2C%20USA"
    pageTitle="A.R. Valentien"
  />
);

export default ArValentien;
