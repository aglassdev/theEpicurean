...
const OxAnchor = () => (
  <RestaurantPage
    restaurantName="Ox + Anchor"
    address="877 Palm St., San Luis Obispo, 93401, USA"
    cuisine="Steakhouse"
    priceRange="$$$$"
    phoneNumber="+18052349968"
    website="https://oxandanchor.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Ryan Fancher's modern steakhouse is on the grounds of Hotel San Luis Obispo, in a separate building connected by a walkway. The hotel's contemporary Southwest vibe lives on in the restaurant. Design details, like butterscotch leather banquettes, a stacked brick wall divider, and teal-blue tiles, enhance the X factor. Staff are well-informed, so let them steer you through the menu. Start with such comfort fare as savory goat cheese croquettes with sweet lavender honey before embarking on the main event—charred steaks and sides of creamed spinach topped with onion rings.On the same property and from the same chef, Piadina is worth a visit—for its Cal-Ital menu and that hotel classic club sandwich turned on its head with fried chicken and B&B pickles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=877%20Palm%20St.%2C%20San%20Luis%20Obispo%2C%2093401%2C%20USA"
    pageTitle="Ox + Anchor"
  />
);

export default OxAnchor;
