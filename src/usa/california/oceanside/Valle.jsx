...
const Valle = () => (
  <RestaurantPage
    restaurantName="Valle"
    address="222 N. Pacific St., Oceanside, 92056, USA"
    cuisine="Mexican, Contemporary"
    priceRange="$$$$"
    phoneNumber="+18667238906"
    website="https://valleoceanside.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Celebrated chef Roberto Alcocer brings his refined, modern expression of Mexican cuisine stateside at this elegant space in the Mission Pacific Hotel, overlooking the scenic Oceanside Pier. The name is a nod to the Valle de Guadalupe in Baja California, Mexico’s premier viticultural region, and the source of a plethora of interesting options on the wine list. Diners can enjoy an eight-course tasting in the dining room or a chef’s table experience in the kitchen. Dishes strike a winning balance between tradition and creativity, as in a tetela made with heirloom corn masa and hoja santa, filled with juicy chanterelle mushrooms and creamy goat cheese, and paired with a complex salsa of morita chiles—at once earthy and bright...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=222%20N.%20Pacific%20St.%2C%20Oceanside%2C%2092056%2C%20USA"
    pageTitle="Valle"
  />
);
