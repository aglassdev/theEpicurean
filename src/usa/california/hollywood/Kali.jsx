...
const Kali = () => (
  <RestaurantPage
    restaurantName="Kali"
    address="5722 Melrose Ave., Hollywood, 90038, USA"
    cuisine="Steakhouse, Californian"
    priceRange="$$$$"
    phoneNumber="+13238714160"
    website="https://www.kalirestaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This contemporary California restaurant from Chef/co-owner Kevin Meehan feels fresh with its wood and white cushioned seating, and walls accented with blue-and-white paintings. It's a perfect setting for a kitchen with a mission to deliver wholly organic and sustainable cuisine. Expect to see locally sourced and grown vegetables, seafood, and some dry-aged proteins on the à la carte or tasting menus. Discover delightful dishes such as salt-roasted celery with sabayon and grapes, offering a flavorful mix of sweet and savory. Rotating based on the freshest finds at the farmers' market, a salad of vegetables and fruit is a bright beginning before a crispy shell tucked with beef tartare. Meringue gelato with sugar-cured egg yolk grated on top is the perfect finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5722%20Melrose%20Ave.%2C%20Hollywood%2C%2090038%2C%20USA"
    pageTitle="Kali"
  />
);
