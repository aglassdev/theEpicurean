...
const TonysSeafood = () => (
  <RestaurantPage
    restaurantName="Tony's Seafood"
    address="18863 Shoreline Hwy., Marshall, 94940, USA"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+14156631107"
    website="https://hogislandoysters.com/restaurants/tonysseafood/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18863%20Shoreline%20Hwy.%2C%20Marshall%2C%2094940%2C%20USA"
    pageTitle="Tony's Seafood"
  />
);

export default TonysSeafood;
