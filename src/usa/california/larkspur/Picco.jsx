...
const Picco = () => (
  <RestaurantPage
    restaurantName="Picco"
    address="320 Magnolia Ave., Larkspur, 94939, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+14159240300"
    website="https://www.restaurantpicco.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Picco is Italian for “summit,” and this charming Larkspur hilltop home has long been a beacon among Marin County diners. Chef/owner Bruce Hill is a true local-food devotee: his Italian-influenced fare heaps on Marin ingredients like the fresh turnips that dot his silky-smooth duck tortelli, or the Meyer lemon yogurt and beets that sit atop a nourishing kale salad. The “Marin Mondays” menu is a particular steal.The precise staff moves ably through the busy dining room, carrying bowls of creamy risotto made on the half-hour. With a high ceiling and exposed brick walls, the vibe is graceful but never fussy, making this the perfect setting for couples and groups of friends who congregate here.Also check out Pizzeria Picco next door...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=320%20Magnolia%20Ave.%2C%20Larkspur%2C%2094939%2C%20USA"
    pageTitle="Picco"
  />
);
