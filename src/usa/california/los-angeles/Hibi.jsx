...
const Hibi = () => (
  <RestaurantPage
    restaurantName="hibi"
    address="3121 W. Olympic Blvd., Ste. 103, Los Angeles, 90006, USA"
    cuisine="Japanese Contemporary, Korean"
    priceRange="$$$$"
    phoneNumber="+12136747244"
    website="https://www.madebyhibi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="hibi may have started life as a casual concept but it's shifted gears and is firmly planted in the fine dining scene. The intimate space shares a sleek, minimalist design with gray walls, tables and chairs fitted with black leather.While this restaurant has changed concept to now feature a new chef and menu every season, expect to see some underlying Korean and Japanese influence with dishes like sliced red abalone grilled over binchotan, served with barley risotto, fermented scallions, and gamtae seaweed or their Korean-influenced tiramisu with ssuk mascarpone cream and crumble with azuki beans...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3121%20W.%20Olympic%20Blvd.%2C%20Ste.%20103%2C%20Los%20Angeles%2C%2090006%2C%20USA"
    pageTitle="hibi"
  />
);
