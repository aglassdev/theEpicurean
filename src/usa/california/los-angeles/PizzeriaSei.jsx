...
const PizzeriaSei = () => (
  <RestaurantPage
    restaurantName="Pizzeria Sei"
    address="8781 W. Pico Blvd., Los Angeles, 90035, USA"
    cuisine="Pizza, Contemporary"
    priceRange="$$"
    phoneNumber="+14242799800"
    website="https://www.pizzeriasei.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thick or thin. Sauced or left bare. Traditional or irreverent. Pizza is the shape-shifter of the culinary world, with seemingly endless variations and an insatiable appetite for the newest iteration. Enter Pizzeria Sei, where individual pies are made with a Japan-meets-Italy flair. A handful of diners perch at the counter to watch the chefs hard at work prepping these savory treats. Wondering where the Japanese comes into play? It's the cornicione—with its trademark puffy pinch with a mochi-like chew. White pies are more offbeat, as in the Bismarck topped with a poached egg, while red pies lean more Italian. The Margherita is a go-to, topped with simple tomato, basil, fior di latte and olive oil, then cooked in a gas- and wood-fired oven...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8781%20W.%20Pico%20Blvd.%2C%20Los%20Angeles%2C%2090035%2C%20USA"
    pageTitle="Pizzeria Sei"
  />
);

export default PizzeriaSei;
