...
const Redbird = () => (
  <RestaurantPage
    restaurantName="Redbird"
    address="114 E. 2nd St., Los Angeles, 90012, USA"
    cuisine="Contemporary, Californian"
    priceRange="$$$"
    phoneNumber="+12137881191"
    website="https://redbird.la/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This airy stunner, which occupies a former church in the heart of Downtown, flaunts an impressive open ceiling allowing diners to stargaze—and that’s not even counting the occasional celebrity sighting. The boisterous atmosphere is beloved by the trendy patrons, who can be seen swapping small plates from perches at the two circular bars and eclectic sofa-stuffed lounge. On the global menu, creative dishes sit side-by-side with more traditional treats like John Dory in a leek fondue strewn with pan-seared gnocchi and mushrooms. Save room for clever desserts like their Meyer lemon tart with blueberry frozen yogurt or opt for another cocktail from the extensive list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=114%20E.%202nd%20St.%2C%20Los%20Angeles%2C%2090012%2C%20USA"
    pageTitle="Redbird"
  />
);
