...
const DamaLOS = () => (
  <RestaurantPage
    restaurantName="Dama"
    address="612 E. 11th St., Los Angeles, 90015, USA"
    ...
    bio="Sultry, colorful and complete with a breezy Caribbean vibe, folks flock here to tuck into satisfying food. While starters like whipped white beans with crispy pork, cotija and pickled pearl onions are captivating, delve deeper into such unlikely items as a Latin take on panzanella, featuring tomatoes and garlic confit. And while a dry-aged ribeye is hard to beat on its own, it’s especially good in build-your-own tacos with pickled sweet peppers and salsa verde.Dama's feisty flavors play well off its chic old-Havana-style dining room, with plush leather sofas, massive wicker fans spinning overhead and colorful tile underfoot. The jaunty front patio is filled with plenty of greenery, while the glam central bar busily blends tropical cocktails to order...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=612%20E.%2011th%20St.%2C%20Los%20Angeles%2C%2090015%2C%20USA"
    pageTitle="Dama"
  />
);

export default DamaLOS;
