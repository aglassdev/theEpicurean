...
const SushiKaneyoshi = () => (
  <RestaurantPage
    restaurantName="Sushi Kaneyoshi"
    address="250 E. 1st St., B1, Los Angeles, 90012, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+12132772388"
    website="https://www.kaneyoshi.us/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="There's tucked away and then there's Sushi Kaneyoshi. This clandestine (read: frustratingly difficult to find) sushi counter is in the most unexpected of places, but step inside this serene, minimalist showpiece and be transported to Japan. Great care is taken with every detail, whether it's the quality of ingredients or the artful plating—some of the pottery is even handmade by Chef Yoshiyuki Inoue. Highlights include stunning seared ocean perch tucked between a sheet of crisp nori; West Coast oyster braised in soy and served warm; and slightly smoked prawns coated in a lush egg yolk and soy sauce. The nigiri is excellent and tempura is also part of this experience where nothing is overlooked, even a bowl of simple-seeming miso soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=250%20E.%201st%20St.%2C%20B1%2C%20Los%20Angeles%2C%2090012%2C%20USA"
    pageTitle="Sushi Kaneyoshi"
  />
);

export default SushiKaneyoshi;
