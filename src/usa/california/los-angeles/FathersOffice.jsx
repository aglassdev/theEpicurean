...
const FathersOffice = () => (
  <RestaurantPage
    ...
    address="3229 Helms Ave., Los Angeles, 90034, USA"
    cuisine="Gastropub"
    priceRange="$$"
    ...
    bio="This may appear to be a counter-service, first-come first-serve sort of joint for grabbing a bite, but Chef Sang Yoon has turned this—and the humble burger—into so much more. Made with dry-aged beef, caramelized onions and bacon compote, the elevated wares found in this kitchen are treasured as one of the country’s first (and perhaps finest) craft burgers. Order the signature  Office burger with a side of sweet potato fries. The market-driven menu goes on to include items that one would not expect from a pub—think arancini with marinara sauce, fontina cheese and fennel; or even grilled skewers of deliciously spiced Sonoma lamb. Just know this: it's no changes to dishes whatsoever, no reservations, no ketchup and no exceptions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3229%20Helms%20Ave.%2C%20Los%20Angeles%2C%2090034%2C%20USA"
    pageTitle="Father’s Office"
  />
);

export default FathersOffice;
