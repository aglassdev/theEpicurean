...
const Tomat = () => (
  <RestaurantPage
    restaurantName="Tomat"
    address="6261 W. 87th St., Los Angeles, 90045, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+12135486188"
    website="https://www.tomat.la/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Working with local farmers and suppliers to highlight seasonality along with California's bounty, Tomat features all-day dining, but it's in the evenings when the cooking turns more serious. The design feels as farm fresh as the ingredients, with red-orange leather seat cushions set against a pale green backsplash. Kick things off with their barbari bread with roasted tomato powder-dusted butter before savoring appetizers like charred seasonal vegetables over a smooth ajo blanco. Main dishes are meant for sharing, and the half Liberty Farms duck is a perfect choice. Deftly cooked with crispy skin, it's enhanced with a pomegranate and walnut mole. Sticky toffee pudding with a butterscotch sauce and a scoop of burnt milk gelato is the perfect finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6261%20W.%2087th%20St.%2C%20Los%20Angeles%2C%2090045%2C%20USA"
    pageTitle="Tomat"
  />
);
