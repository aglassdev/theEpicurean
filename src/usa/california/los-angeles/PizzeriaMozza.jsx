...
const PizzeriaMozza = () => (
  <RestaurantPage
    restaurantName="Pizzeria Mozza"
    address="641 N. Highland Ave., Los Angeles, 90036, USA"
    cuisine="Pizza, Italian"
    priceRange="$$"
    phoneNumber="+13232970101"
    website="https://pizzeriamozza.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mozza is at its essence a pizzeria, but so much more than a mere neighborhood haunt. Why, you might ask? It boasts the presence of Co-owner Nancy Silverton, whose culinary pedigree has foodies flocking to this Hollywood hottie. Adding to that, its sunny-yellow exterior and orange canopy set a Mediterranean scene.Make your way into this bright room donning bare wood tables and skylights. Pizzas are far above average, beginning with that unmistakable cornicione—perfect spots of char that rim the crust and bring the flavor. Toppings are just as fanciful, highlighting goat cheese, leeks and bacon; or maybe squash blossom with burrata. Come dessert, Pastry Chef Dahlia Narvaez works her magic with scrumptious treats, like Meyer lemon and kumquat crostata...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=641%20N.%20Highland%20Ave.%2C%20Los%20Angeles%2C%2090036%2C%20USA"
    pageTitle="Pizzeria Mozza"
  />
);

export default PizzeriaMozza;
