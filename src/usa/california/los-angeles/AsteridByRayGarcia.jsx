...
const AsteridByRayGarcia = () => (
  <RestaurantPage
    restaurantName="asterid by Ray Garcia"
    address="141 S. Grand Ave., Los Angeles, 90012, USA"
    cuisine="Californian, Contemporary"
    priceRange="$$$"
    phoneNumber="+12139723535"
    website="https://www.asteridla.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed. Tucked within Frank Gehry’s iconic Walt Disney Concert Hall, asterid by Ray Garcia has an enviable location, but the restaurant is as stunning as its surroundings, with floor-to-ceiling windows bringing the outdoors in. The evolving menu draws from seasonal local produce and Latin American, Asian and European influences with Chef Garcia's distinctive Angeleño point of view. Begin with a refreshing aguachile, where firm cubes of hiramasa are paired perfectly with melon, cucumber and fiery serrano chili. Then, a terra-cotta pot arrives brimming with shredded braised oxtail and beans atop a masa-based spaetzle. The deconstructed strawberry shortcake with hibiscus-flavored angel food cake and strawberry ice cream ends things on a sweet note...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=141%20S.%20Grand%20Ave.%2C%20Los%20Angeles%2C%2090012%2C%20USA"
    pageTitle="asterid by Ray Garcia"
  />
);

export default AsteridByRayGarcia;
