...
const PijjaPalace = () => (
  <RestaurantPage
    restaurantName="Pijja Palace"
    address="2711 Sunset Blvd., Los Angeles, 90026, USA"
    ...
    bio="“Indian Sports Bar” is not a phrase you hear often, if at all, and so it’s no surprise that this quirky hotspot at the base of a Comfort Inn defies labels. True to its name, large flatscreen TVs showing the day’s game hang on every wall, and people do indeed come here to cheer on their team. The food is equally original, riffing on classic bar dishes but elevating them with astute seasoning and careful preparation. Onion rings are coated in dosa batter. Wings are marinated in cilantro-mint chutney. Rigatoni comes tossed in a creamy tomato masala that evokes a vodka tomato sauce. There are even thin, crisp pizzas. Don’t let the casualness of the space lull you into thinking that reservations are easy. A long line takes shape before doors open...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2711%20Sunset%20Blvd.%2C%20Los%20Angeles%2C%2090026%2C%20USA"
    pageTitle="Pijja Palace"
  />
);

export default PijjaPalace;
