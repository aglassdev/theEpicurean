...
const ElfCafe = () => (
  <RestaurantPage
    restaurantName="Elf Cafe"
    address="2135 W. Sunset Blvd., Los Angeles, 90026, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+12134846829"
    website="https://www.elfcafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are no elves running the show at this intimate spot but with just three people staffing the kitchen throughout service, they're certainly working like Santa's helpers. It's a wine bar, so expect a nice selection of bottles, but there's also cider and beer, as well as non-alcoholic offerings. Originally fully vegetarian, Elf Cafe has tweaked its Mediterranean-minded menu to now include animal proteins. Case in point? The lamb skewers, marinated and seared to a crisp crust. Paired with a refreshing yogurt sauce and onions hit with sumac, it's skillfull and satisfying. For a vegetable-focused plate, consider the maitake, grilled over a wood fire, topped with chimichurri, and served over a smashed potato with a ramekin of ají verde for dipping. Craving something sweet? Warm date cake wit..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2135%20W.%20Sunset%20Blvd.%2C%20Los%20Angeles%2C%2090026%2C%20USA"
    pageTitle="Elf Cafe"
  />
);

export default ElfCafe;
