...
const Tsubaki = () => (
  <RestaurantPage
    restaurantName="Tsubaki"
    address="1356 Allison Ave., Los Angeles, 90026, USA"
    cuisine="Japanese, Izakaya"
    priceRange="$$"
    phoneNumber="+12139004900"
    website="https://tsubakila.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="First things first: Tsubaki is not a sushiya. Barring a lovely plate of sashimi (kanpachi), the menu at this delicious Japanese gem is comprised of classic izakaya food. Think fluffy whipped miso tofu, topped with marinated cherry tomatoes and pickled scallion kimchi; Salmon Creek Farm pork shumai with braised bacon dashi; and tender grilled chicken “oysters” kicked up with yuzu kosho. Dishes are meant to be shared and paired with beer or sake. Beverage lovers will thrill to the excellent selection of local craft and distilled sake—and they’ll also get to choose their own cups to enjoy these sips.Reservations and use of the restaurant’s valet are highly recommended, especially in the summer when nearby Dodger Stadium is stormed with traffic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1356%20Allison%20Ave.%2C%20Los%20Angeles%2C%2090026%2C%20USA"
    pageTitle="Tsubaki"
  />
);
