...
const LiusCafe = () => (
  <RestaurantPage
    restaurantName="Liu's Cafe"
    address="3915 1/2 W. 6th St., Los Angeles, 90020, USA"
    cuisine="Chinese, Taiwanese"
    priceRange="$"
    phoneNumber="+12135683686"
    website="https://www.liuscafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Liu's Cafe is just the sort of casual spot you'll come to again and again. Arrive early, as seats fill quickly, then order at the wood counter, where you'll get a sneak peek into the bustling kitchen. You'll also spy their selection of pastries, which definitely shouldn't be overlooked. Order the house-made pork wontons for a tender, tasty treat, and be sure to get the extra egg noodles to soak up that wonderfully kicky chili oil. Braised pork belly rice is another dish of pure comfort, and no matter what you have, everything is complemented by a pot of tea, such as the milk oolong. Finally, the pastries grab attention from the very beginning and closing out with a dessert like the citrus curd tart with shaved fennel salad is everything you want it to be...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3915%201%2F2%20W.%206th%20St.%2C%20Los%20Angeles%2C%2090020%2C%20USA"
    pageTitle="Liu's Cafe"
  />
);

export default LiusCafe;
