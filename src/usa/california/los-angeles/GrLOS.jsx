...
const GrLOS = () => (
  <RestaurantPage
    restaurantName="Grá"
    address="1524 Pizarro St., Los Angeles, 90026, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber=""
    website="https://xn--gr-nia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's a welcoming vibe at this hip spot where the focus is on natural fermentation with sourdough pizza, seasonal pickled vegetables, and fermented drinks such as tepache. Grá has indoor and covered patio seating, but all eyes will be on the cooks preparing pizzas in their wood-fired oven. It's all about the thin and crispy sourdough crust with high quality toppings. Classics like pepperoni will always rule, but hard hitters like stracciatella and prosciutto with basil and a drizzle of coffee-infused honey are worth noting. While pizza is certainly the scene stealer, don't ignore their salads or appetizers, including grilled maitake with pickled green peppercorn and agretti in a flavor-packed broth. For dessert, go for the soy-sauce caramel sundae or chocolate tart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1524%20Pizarro%20St.%2C%20Los%20Angeles%2C%2090026%2C%20USA"
    pageTitle="Grá"
  />
);

export default GrLOS;
