...
const SweetRice = () => (
  <RestaurantPage
    restaurantName="Sweet Rice"
    address="1630 W. Redondo Beach Blvd., Gardena, 90247, USA"
    cuisine="Thai"
    priceRange="$"
    phoneNumber="+14243442054"
    website="https://guide.michelin.com/en/california/gardena/restaurant/sweet-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked into a back corner of Pacific Square Shopping Center, this exciting haven specializes in authentic Thai breakfasts and desserts. The playful menu also proffers hearty soups and noodle dishes, so it's hard to go wrong, but first-timers might want to start with jok—congee bubbling with tender pork meatballs, loads of fresh ginger and an egg that cooks gently n the molten rice. Desserts—even post-breakfast—are an absolute delight; and if the mango sticky rice is available, jump on it.The space is casual, with counter service, a welcoming vibe, and friendly servers. While the décor may be simple and modern, the bright white walls are accented by pops of turquoise and red—and large paper lantern light fixtures are suspended above each table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1630%20W.%20Redondo%20Beach%20Blvd.%2C%20Gardena%2C%2090247%2C%20USA"
    pageTitle="Sweet Rice"
  />
);

export default SweetRice;
