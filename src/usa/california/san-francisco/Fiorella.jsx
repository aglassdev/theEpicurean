...
const Fiorella = () => (
  <RestaurantPage
    restaurantName="Fiorella"
    address="2339 Clement St., San Francisco, 94121, USA"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+14153403049"
    website="https://www.fiorella-sf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the foggy Outer Richmond, this casual neighborhood pizzeria is as hot as its wood-fired oven. Local families come in droves to share a pie or plate of pasta in the compact dining room, set amidst funky wallpaper depicting a bevy of Bay Area landmarks and legendary locals. The chewy, blistered crusts are loaded with flavor, whether in a classic Margherita or salami pie with provolone and red chili. Throw in a seasonal salad, a pile of chicken wings tossed in a Calabrian chili-honey glaze, and a glass of Italian wine from the compact list. Save room for the warm almond and Meyer lemon ricotta cake, which gets toasted alongside other pies in the oven.Two other locations, in Russian Hill and The Sunset District, are just as popular as the original...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2339%20Clement%20St.%2C%20San%20Francisco%2C%2094121%2C%20USA"
    pageTitle="Fiorella"
  />
);
