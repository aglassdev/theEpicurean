...
const Robin = () => (
  <RestaurantPage
    restaurantName="Robin"
    address="620 Gough St., San Francisco, 94102, USA"
    cuisine="Japanese, Californian"
    priceRange="$$$$"
    phoneNumber="+14154486023"
    website="https://www.robinomakase.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Trust is the name of the game at Robin, a hip sushi-focused destination, where no menu is ever presented. Instead, guests happily submit themselves to the very capable skills of Chef Adam Tortosa and eagerly await his modern take on omakase. This kitchen’s decadent vision includes lots of elite ingredients like A5 Wagyu beef and caviar, though the staff will kindly ask what your budget is (or if you have allergies). The upscale space is a mix of posh and street cool—think graffiti-esque bathrooms and hip-hop beats. Young sushi chefs are the focal point of the room, working fastidiously with tweezers, torches and gel in front of a bright backdrop.A small, carefully curated list of beer, sake and wine pairs nicely with the food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=620%20Gough%20St.%2C%20San%20Francisco%2C%2094102%2C%20USA"
    pageTitle="Robin"
  />
);
