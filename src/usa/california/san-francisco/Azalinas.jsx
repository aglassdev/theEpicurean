...
const Azalinas = () => (
  <RestaurantPage
    restaurantName="Azalina’s"
    address="499 Ellis St., San Francisco, 94102, USA"
    cuisine="Malaysian, Californian"
    priceRange="$$$"
    phoneNumber="+15106198785"
    website="https://www.azalinas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Azalina Eusope continues to make her mark as an ambassador for Malaysian cuisine in this cleverly designed space that calls to mind a tropical hideaway ensconced in the rough-and-tumble Tenderloin.The menu is a frequently changing seasonal prix fixe with dishes that offer her own interpretation of flavors she grew up with— think California meets Penang. Quality ingredients and creativity are hallmarks, seen in a dish of economy noodles with fermented chili paste, topped with barbecued quail and toasted hazelnuts, or steelhead trout baked in banana leaves. Her pastry training is evident in a complex dessert of pandan custard with water chestnut and coconut granita, served with a take on kuih kasturi, a mung bean fritter filled with jackfruit and sweet red bean...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=499%20Ellis%20St.%2C%20San%20Francisco%2C%2094102%2C%20USA"
    pageTitle="Azalina’s"
  />
);

export default Azalinas;
