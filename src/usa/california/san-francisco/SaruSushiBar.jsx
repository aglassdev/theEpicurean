...
const SaruSushiBar = () => (
  <RestaurantPage
    restaurantName="Saru Sushi Bar"
    address="3856 24th St., San Francisco, CA, 94114, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$"
    phoneNumber="+14154004510"
    website="https://akaisarusf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hilly Noe Valley is the perfect setting for this jewel of a sushi restaurant, so make your way inside to discover a bustling (read: energetic) vibe. The menu is thoroughly Japanese with a few Californian touches—think grilled shishito peppers tossed with crunchy daikon in a ponzu dressing.Begin with the signature tempura-fried seaweed cracker topped with spicy tuna and avocado. Then, perfectly sized tasting spoons of seared ankimo with scallions, as well as halibut tartare with yuzu make for delightful quick bites. Though rolls are available, regulars opt for the nigiri, which might include kampachi, baby snapper and snow crab. Several omakase (including an all-salmon variation) are also on offer. Since Saru doesn't take reservations, arrive early to avoid a line...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3856%2024th%20St.%2C%20San%20Francisco%2C%20CA%2C%2094114%2C%20USA"
    pageTitle="Saru Sushi Bar"
  />
);

export default SaruSushiBar;
