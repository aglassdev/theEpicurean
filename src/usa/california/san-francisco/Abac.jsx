...
const Abac = () => (
  <RestaurantPage
    restaurantName="Abacá"
    address="2700 Jones St., San Francisco, 94133, USA"
    cuisine="Filipino, Californian"
    priceRange="$$"
    phoneNumber="+14154860788"
    website="https://www.restaurantabaca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Francis Ang, together with wife and co-owner Dian, sowed the seeds for this ode to Filipino cooking when they founded acclaimed pop-up, Pinoy Heritage. Born of a desire to more deeply connect with their culinary roots, their delicious explorations now have a permanent home in the lush Kimpton Alton Hotel.The sunny space pales next to the vibrant cuisine, which uses traditional flavors and techniques as a jumping-off point for creative, colorful dishes. Pork features heavily, as in juicy skewers of longganisa with cane vinegar and puffed rice, but a bounty of NorCal produce gets its due as well. Chef Ang gets to show off his pastry chops with one-of-a-kind desserts, not to mention the baked goods, available in the morning at the in-house panaderia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2700%20Jones%20St.%2C%20San%20Francisco%2C%2094133%2C%20USA"
    pageTitle="Abacá"
  />
);
