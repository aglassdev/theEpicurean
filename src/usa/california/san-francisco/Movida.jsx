...
const Movida = () => (
  <RestaurantPage
    restaurantName="Movida"
    address="555 2nd St., San Francisco, 94107, USA"
    cuisine="Mexican, Persian"
    priceRange="$$"
    phoneNumber="+14152126672"
    website="https://www.movidalounge.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just steps away from Oracle Park, this swanky restaurant-meets-lounge, complete with elevated DJ booth, is unique in more ways than one. Beyond the stylish space and earnest hospitality, the special draw here is a small menu that cleverly combines Mexican and Persian cuisines with surprisingly compelling results. Try halibut in a jade-green aguachile that combines tomatillo and green plum, offering a vivid, nuanced flavor; singular tostadas made with a crispy base of golden brown tahdig, topped with luscious beef birria accented with sumac; or a fried poblano filled with a savory mixture of rice, spiced lamb and queso Oaxaca. Drinks boast unusual savory combinations like mezcal with carrot juice and chiles, making for excellent accompaniments...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=555%202nd%20St.%2C%20San%20Francisco%2C%2094107%2C%20USA"
    pageTitle="Movida"
  />
);
