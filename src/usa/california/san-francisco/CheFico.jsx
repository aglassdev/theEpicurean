...
const CheFico = () => (
  <RestaurantPage
    restaurantName="Che Fico"
    address="838 Divisadero St., San Francisco, 94117, USA"
    cuisine="Italian, Californian"
    priceRange="$$$"
    phoneNumber="+14154166959"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=838%20Divisadero%20St.%2C%20San%20Francisco%2C%2094117%2C%20USA"
    pageTitle="Che Fico"
  />
);

export default CheFico;
