...
const PaletteTeaHouse = () => (
  <RestaurantPage
    restaurantName="Palette Tea House"
    address="900 N. Point St., Ste. B201A, San Francisco, 94109, USA"
    cuisine="Chinese, Dim Sum"
    priceRange="$$"
    phoneNumber="+14153478888"
    website="https://paletteteahouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This buzzy dim sum restaurant may call the heart of Ghirardelli Square home, but it is hardly a spot just for tourists. The gorgeous, exotic space is fitted out with colorful light fixtures splashed with Chinese characters, delicate tiled murals, and flickering candle tea warmers.More substantial dishes like Ibérico pork char siu with compressed green apple and cognac glaze also merit attentionThe dim sum here is small (think a few pieces per order), but the menu is so ambitious you’ll see it as a great excuse to sample more food. Pork and duck puffs crafted into cute little black swans are Instagram-ready; and may be tailed by durian bao, tender squid ink dumplings with crunchy jicama and pork, or slippery rice crêpes filled with crispy soft-shell crab...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=900%20N.%20Point%20St.%2C%20Ste.%20B201A%2C%20San%20Francisco%2C%2094109%2C%20USA"
    pageTitle="Palette Tea House"
  />
);

export default PaletteTeaHouse;
