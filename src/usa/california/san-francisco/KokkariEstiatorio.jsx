...
const KokkariEstiatorio = () => (
  <RestaurantPage
    restaurantName="Kokkari Estiatorio"
    address="200 Jackson St., San Francisco, 94111, USA"
    cuisine="Greek"
    priceRange="$$$"
    phoneNumber="+14159810983"
    website="https://kokkari.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zeus himself would be satisfied after a soul-warming meal at this Greek favorite, which serves up San Francisco-chic with a side of old-world taverna hospitality. Once you’re seated at the bar or settled near one of its toasty fireplaces, the thoughtful staff will cater to your every whim.The intoxicating scent of caramelizing meats and lemon will certainly whet your appetite for what's to come. Kokkari's menu leans heavily on the wood grill and rotisserie, which turns out such simple delights as bizelosalata—spring peas topped with olive oil, feta, and scallions—followed by the eternally classic chicken souvlaki. For dessert, go for the galaktoboureko, or semolina custard, rolled in crisp filo and matched with pistachio ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20Jackson%20St.%2C%20San%20Francisco%2C%2094111%2C%20USA"
    pageTitle="Kokkari Estiatorio"
  />
);

export default KokkariEstiatorio;
