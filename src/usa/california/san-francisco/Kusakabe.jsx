...
const Kusakabe = () => (
  <RestaurantPage
    restaurantName="Kusakabe"
    address="584 Washington St., San Francisco, 94111, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+14157570155"
    website="https://kusakabe-sf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Serene with warm lighting and clean lines, distinctive creativity is the motto of this sushi-focused operation. Inside, a stunning counter crafted from a piece of live-edge elm, oyster-hued leather chairs and a ceiling of wood slats complete the Japanese-chic look.While the preparation of their nightly omakase might seem like a production line by employing myriad cooking techniques, the kitchen ensures that every bite is memorable. Begin with warm kelp tea, before embarking on a sashimi parade of bluefin slices served with a yuzu-onion-sesame sauce. Then, savor softshell crab soup in a corn and sweet miso broth before a top rendition of sushi yields Santa Barbara sea urchin atop Hokkaido scallop and snapper with cured egg yolk shavings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=584%20Washington%20St.%2C%20San%20Francisco%2C%2094111%2C%20USA"
    pageTitle="Kusakabe"
  />
);
