...
const Tiya = () => (
  <RestaurantPage
    restaurantName="Tiya"
    address="3213 Scott St., San Francisco, 94123, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$$"
    phoneNumber="+14154008500"
    website="https://www.tiyasf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the edge of Cow Hollow, seasonal produce like squash blossoms, artichokes, and ramps bring a Californian edge to an intriguing contemporary take on Indian cuisine. Both à la carte and tasting options give equal billing to winners like a keema-style jackfruit with crunchy potato, or an eggless take on a bhurji roll, made with paneer and crispy kataifi. The elegant room adds an additional layer of sophistication, down to a well-appointed bar, which offers unique cocktails named in honor of San Francisco neighborhoods...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3213%20Scott%20St.%2C%20San%20Francisco%2C%2094123%2C%20USA"
    pageTitle="Tiya"
  />
);
