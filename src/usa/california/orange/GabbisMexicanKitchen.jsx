...
const GabbisMexicanKitchen = () => (
  <RestaurantPage
    restaurantName="Gabbi’s Mexican Kitchen"
    address="141 S. Glassell St., Orange, 92866, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+17146333038"
    website="https://gabbismexicankitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cooks here understand the essence of regional Mexican cuisine, so trust in their skills and do not be disillusioned by the menu line that reads substitutions are graciously declined.” Many of these dishes offer a spin on traditional items, as in the citrus-tinged achiote pork that tops creamy black beans and puffed corn tortillas in panuchos de Yucatán. Tacos are a signature for good reason; and the Puebla with spicy sausage, carne asada, smoked applewood bacon, and morita salsa delivers just the right level of piquancy.This special haven also makes the most of its idyllic setting, amid a score of antique shops with an open front that spills onto the street. Thanks to backlit shelves lined with tequila bottles, the vibe inside is warm and inviting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=141%20S.%20Glassell%20St.%2C%20Orange%2C%2092866%2C%20USA"
    pageTitle="Gabbi’s Mexican Kitchen"
  />
);

export default GabbisMexicanKitchen;
