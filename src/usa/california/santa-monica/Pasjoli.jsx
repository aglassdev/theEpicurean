...
const Pasjoli = () => (
  <RestaurantPage
    restaurantName="Pasjoli"
    address="2732 Main St., Santa Monica, 90405, USA"
    cuisine="French, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14243300020"
    website="https://www.pasjoli.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Dave Beran’s Santa Monica bistro is irresistibly charming, a breezy space buzzing with activity and accented with wood beams, exposed brick and gleaming white kitchen tile. Brioche with chicken liver mousse and shallot truffle jam or bay scallops with green garlic beurre blanc reflect an unapologetically French approach. There are a number of dishes intended for two, and the pressed duck is the pinnacle of luxury. Should there be room to spare, chocolate soufflé paired with vanilla ice cream or a strawberry tart with whipped cream make for a sweet sendoff. No time for a full meal? Take to the elegant marble bar for Champagne, Osetra caviar and blinis...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2732%20Main%20St.%2C%20Santa%20Monica%2C%2090405%2C%20USA"
    pageTitle="Pasjoli"
  />
);

export default Pasjoli;
