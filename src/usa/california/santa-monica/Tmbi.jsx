...
const Tmbi = () => (
  <RestaurantPage
    restaurantName="Tūmbi"
    address="115 Santa Monica Blvd., Santa Monica, 90401, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$"
    phoneNumber="+13108297200"
    website="https://tumbicraftindian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a block from the bustle of the Santa Monica Promenade, Tumbi feels worlds away, offering Indian cooking in an industrial-chic setting. All of their proteins benefit from being prepared in a clay tandoor, which adds to their complexity, and of course there's butter chicken and palak paneer to satisfy Western palates. Make sure to get a dosa, also available stuffed, as in the masala dosa with a filling of mashed potatoes that are spiced and mixed with onion and cashew nuts. Desserts are especially unique—envision deconstructed carrot halwa and a dessert dosa served with creamy Nutella...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Santa%20Monica%20Blvd.%2C%20Santa%20Monica%2C%2090401%2C%20USA"
    pageTitle="Tūmbi"
  />
);
