...
const Mlisse = () => (
  <RestaurantPage
    restaurantName="Mélisse"
    address="1104 Wilshire Blvd., Santa Monica, 90401, USA"
    cuisine="Modern French"
    priceRange="$$$$"
    phoneNumber="+13103950881"
    website="https://www.citrinandmelisse.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Since opening in 1999, Chef Josiah Citrin’s flagship has been a Santa Monica mainstay. Through its many evolutions, the restaurant has sought to offer a certain kind of fine dining experience that will never go out of style. Slip in through a discreet side entrance to enter the enclosed space that combines a vibe-y underground feel with classic luxury. One can expect the finest cutlery and plates, gorgeous presentations, plenty of tableside saucing, and a level of French decadence that borders on gratuitous. The results are indulgent. Truffles, wagyu, uni, and crab weave their way across intricate canapés and courses, ending with a signature finale of dry-aged duck “Rouennaise” that features a rich sauce made with the help of an antique silver press...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1104%20Wilshire%20Blvd.%2C%20Santa%20Monica%2C%2090401%2C%20USA"
    pageTitle="Mélisse"
  />
);

export default Mlisse;
