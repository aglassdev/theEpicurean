...
const pageTitle = "Laguna Beach";

const restaurants = [
  {
    name: "Oliver's Osteria",
    cuisine: "Italian, Regional Cuisine",
    price: "$$$",
    path: "/usa/california/laguna-beach/OliversOsteria",
    image: "/images/oliversosteria1.png"
  },
  {
    name: "R|O-Rebel Omakase",
    cuisine: "Japanese, Sushi",
    price: "$$$$",
    path: "/usa/california/laguna-beach/RorebelOmakase",
    image: "/images/rorebelomakase1.png"
  },
  {
    name: "Selanne Steak Tavern",
    cuisine: "Steakhouse, American Contemporary",
    price: "$$$$",
    path: "/usa/california/laguna-beach/SelanneSteakTavern",
    image: "/images/selannesteaktavern1.png"
  }
];
