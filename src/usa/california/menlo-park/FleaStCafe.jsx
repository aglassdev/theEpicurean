...
const FleaStCafe = () => (
  <RestaurantPage
    restaurantName="Flea St. Cafe"
    address="3607 Alameda de las Pulgas, Menlo Park, 94025, USA"
    cuisine="Contemporary, Californian"
    priceRange="$$$"
    phoneNumber="+16508541226"
    website="https://www.cooleatz.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This classic “café” retains the feeling of being in a house, with dining areas distributed throughout. Interesting artwork adorns each of these rooms, simply adding to the sense of intimacy, not unlike the warm and inviting front bar area, filled with friendly banter and soft tunes.The team ensures that each item from this kitchen is well conceived and adheres to California’s farm-to-table ethos. Everything on this seasonally driven menu strives to emphasize freshness, starting with the warm and buttery biscuits that welcome you to your table. Don't miss the shell bean soup featuring a braised tomato broth complete with summery flavors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3607%20Alameda%20de%20las%20Pulgas%2C%20Menlo%20Park%2C%2094025%2C%20USA"
    pageTitle="Flea St. Cafe"
  />
);

export default FleaStCafe;
