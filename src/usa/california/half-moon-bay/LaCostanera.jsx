...
const LaCostanera = () => (
  <RestaurantPage
    restaurantName="La Costanera"
    address="260 Capistrano Rd., Half Moon Bay, 94019, USA"
    cuisine="Peruvian, Latin American"
    priceRange="$$$"
    phoneNumber="+16507281600"
    website="https://lacostanerarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Where else can you stroll in after a day at the beach and get a delicious Peruvian meal? La Costanera, nestled within the darling coastal town of Half Moon Bay, of course! Traditional and modern art abound, but it's the boldly flavored plates from Chef Carlos Altamirano and his team that garner attention. Palta rellena, which fills half an avocado with roasted chicken chicharrones and lime-infused mayonnaise, is a fun and light-hearted interpretation of the dish. Cebice pescado marinated in aji rocoto leche de tigre is both tangy and kicky, while arroz con mariscos is a savory and satisfying dish tucked with plenty of seafood. Be sure to sample the creative cocktails. Alternatively, try a delicious and refreshing chicha morada...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=260%20Capistrano%20Rd.%2C%20Half%20Moon%20Bay%2C%2094019%2C%20USA"
    pageTitle="La Costanera"
  />
);

export default LaCostanera;
