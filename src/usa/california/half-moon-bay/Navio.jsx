...
const Navio = () => (
  <RestaurantPage
    restaurantName="Navio"
    address="1 Miramontes Point Rd., Half Moon Bay, 94019, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+16507127000"
    website="https://www.naviohalfmoonbay.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled inside the luxe Ritz-Carlton, Half Moon Bay, Navio is blessed with a classic northern California setting. Golden sunsets are ripe for romantics, but you’re almost as likely to find families with young children here. The real draw, however, is the thoughtful globally inflected cuisine, overseen by Chef Francisco Simón. Plates offer an easygoing sense of luxury with classic underpinnings, as in cured Mt. Lassen trout with ponzu gelée and a smoked crème fraîche sauce, or beef tenderloin with morel mushrooms, sunchokes, and nutty Palo Cortado sherry. Desserts present a bolder, more inventive face, like a striking construction of Brazilian chocolate fermented with passionfruit and paired with fresh mango and Thai tea-flavored ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Miramontes%20Point%20Rd.%2C%20Half%20Moon%20Bay%2C%2094019%2C%20USA"
    pageTitle="Navio"
  />
);
