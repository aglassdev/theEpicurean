...
const PeasantsFeast = () => (
  <RestaurantPage
    restaurantName="peasants FEAST"
    address="487 Atterdag Rd., Solvang, 93463, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+18056864555"
    website="https://www.peasantsfeast.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It may seem impossible to be even more charming than its Solvang surroundings, but peasants FEAST doubles down, and delivers. This daytime-only café from Michael and Sarah Cherney  spotlights the seasons on its sandwich-driven menu. There's nothing ho-hum about what's between the bread here. Instead, the cooking is all heart and the selections show off a unique creativity (cue the pastrami smoked salmon sandwich). A cup of soup is the ideal partner—the carrot soup finished with Calabrian chili oil is a gratifying choice. Specials always deserve a glance, since items like the delectable beet greens grilled cheese appear daily. Dashing off to the next winery? Pop across the street to peasants DELI for picnic-ready rations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=487%20Atterdag%20Rd.%2C%20Solvang%2C%2093463%2C%20USA"
    pageTitle="peasants FEAST"
  />
);

export default PeasantsFeast;
