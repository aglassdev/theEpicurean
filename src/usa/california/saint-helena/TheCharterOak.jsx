...
const TheCharterOak = () => (
  <RestaurantPage
    restaurantName="The Charter Oak"
    address="1050 Charter Oak Ave., Saint Helena, 94574, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+17073026996"
    website="https://www.thecharteroak.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Christopher Kostow’s casual-cool retreat continues to be a well-regarded and rightly applauded Napa mainstay. With soaring ceilings and a hulking hearth, the beautifully restored dining room is an apposite setting for the chef's California cooking.Much of the featured produce comes from their own farm, and a whole bounty is on full display in a simple bowl of just-plucked veggies, best matched with a fermented soy dip. Kurobuta pork ribs; chicken with preserved lemon; sweet potato with brown butter and herbs—nearly everything from mains to sides bears traces of the flames and are best enjoyed as a group. A recent starter of aged Wagyu beef tartare with ember mayo and milk bread may just be one of the finest versions we’ve seen yet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1050%20Charter%20Oak%20Ave.%2C%20Saint%20Helena%2C%2094574%2C%20USA"
    pageTitle="The Charter Oak"
  />
);

export default TheCharterOak;
