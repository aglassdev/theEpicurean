...
const LinizioARD = () => (
  <RestaurantPage
    restaurantName="L'inizio"
    address="698 Saw Mill River Rd., Ardsley, 10502, USA"
    cuisine="Italian, Italian-American"
    priceRange="$$$"
    phoneNumber="+19146935400"
    website="https://www.liniziony.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Husband and wife team, Scott and Pastry Chef Heather Fratangelo, are the brains behind this lovely Italian spot. Simple and demure from the outside, there's something special about this dining room that's perceptible instantly upon entry. Smiling servers guide you to a simple yet comfortable table, framed by bistro seats. Bright unframed paintings adorn the walls, while shelves are lined with canning jars.The menu's chosen language may be Italian but it never strays too far from its American roots. Start with a summer salad of cantaloupe, stone fruit and feta, before indulging in such fine pastas as bucatini with cherry tomatoes, roasted garlic and Parmigiana. Thanks to the ace pastry chef, desserts—like the elaborate cookie board—are not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=698%20Saw%20Mill%20River%20Rd.%2C%20Ardsley%2C%2010502%2C%20USA"
    pageTitle="L'inizio"
  />
);

export default LinizioARD;
