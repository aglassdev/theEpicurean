...
const Chalong = () => (
  <RestaurantPage
    ...
    address="749 9th Ave., New York, 10019, USA"
    cuisine="Thai, Southern Thai"
    priceRange="$$$"
    phoneNumber="+12124666456"
    website="https://www.chalongnyc.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=749%209th%20Ave.%2C%20New%20York%2C%2010019%2C%20USA"
    pageTitle="Chalong"
  />
);

export default Chalong;
