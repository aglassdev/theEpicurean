...
const LeB = () => (
  <RestaurantPage
    restaurantName="Le B"
    address="283 W. 12th St., New York, 10014, USA"
    cuisine="Classic French, Asian"
    priceRange="$$$$"
    phoneNumber="+12126752808"
    website="https://lebnyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Angie Mar presents a celebration of haute French cuisine married with her Chinese heritage in this luxurious Greenwich Village location. The intimate and opulent space glimmers in sapphire hues and velvet banquettes, while white tablecloths and jacketed staff set the tone for a celebratory night out or an intimate date. Le B is her passionate celebration of classic French cuisine. The gorgeous terrine of pork and duck, draped in pistachio and garnished with kumquat confit is always a fine start. From there, choose your own decadent adventure of lobster blanquette, poached foie gras or pig's trotter. Rich sauce work, like Madeira-spike pork jus for the chou farcie with rabbit or Sauternes and tarragon cream to dress the seafood wellington, is a distinctive touch. Additionally, tasting ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=283%20W.%2012th%20St.%2C%20New%20York%2C%2010014%2C%20USA"
    pageTitle="Le B"
  />
);
