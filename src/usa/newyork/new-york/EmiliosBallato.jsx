...
const EmiliosBallato = () => (
  <RestaurantPage
    restaurantName="Emilio's Ballato"
    address="55 E. Houston St., New York, 10012, USA"
    cuisine="Italian-American, Italian"
    priceRange="$$$"
    phoneNumber="+12122748881"
    website="https://ballatos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This unassuming Houston St. standard is an unsung hero, even if many walk past Emilio’s gold- and red-etched window and write it off as some run-of-the-mill red-sauce joint. Step inside the narrow, weathered space, where co-owners Emilio Vitolo, Sr and son, Chef Mario Emilio Vitolo, offer each guest a personal welcome and a genuine Italian-American experience. The menu is filled with pasta classics like Roman cacio e pepe, tossed with sharp pecorino and freshly ground black pepper. Signature specialties include pollo Emilio, a delicately breaded chicken cutlet draped in lemon-caper sauce; and clams oreganata speckled with garlicky breadcrumbs. Crisp cannoli shells filled with vanilla- and cinnamon-tinged ricotta cream rival any other version found from Palermo to Siracusa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20E.%20Houston%20St.%2C%20New%20York%2C%2010012%2C%20USA"
    pageTitle="Emilio's Ballato"
  />
);

export default EmiliosBallato;
