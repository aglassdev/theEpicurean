...
const Joomak = () => (
  <RestaurantPage
    restaurantName="Joomak"
    address="401 West St., New York, 10014, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+16465744126"
    website="https://www.joomaknyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden away on the second floor of a ritzy residential hotel in the West Village is this jewel box of a dining room. With just a handful of tables, the modern setting feels like a luxurious living room, one fit with a fireplace, marble accents, and finely suited servers. Chef Jiho Kim offers a contemporary tasting menu that has touches of whimsy. Playful riffs on an everything bagel with salmon or a tuna smashburger are interwoven with refined stunners like dill custard with white asparagus and Meyer lemon beurre blanc. From scallops to king crab, it must be said that the quality of seafood is notably high. Desserts are a particular strength. Intimate, confident, and relaxed, dinner here is an experience to savor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=401%20West%20St.%2C%20New%20York%2C%2010014%2C%20USA"
    pageTitle="Joomak"
  />
);

export default Joomak;
