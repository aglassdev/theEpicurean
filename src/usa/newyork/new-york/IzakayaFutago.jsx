...
const IzakayaFutago = () => (
  <RestaurantPage
    restaurantName="Izakaya Futago"
    address="211 E. 43rd St., New York, NY, 10017, USA"
    cuisine="Japanese, Soba"
    priceRange="$$"
    phoneNumber="+12123778947"
    website="https://www.izakaya-futago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is a packed lunchtime operation where business folks gather and quickly fill the popular space for homemade soba. Dinnertime brings a mellower vibe, and a crowd of beer- and sake-sipping patrons ordering plates of spicy fried chicken and yakitori. Appetizers may include a salad of assorted pickles and simmered daikon in a sweet ginger dressing. Skip over the fried seafood in favor of the soba totto gozen set, which includes the wonderful noodles in fragrant dashi; or try one of the many delicious dons topped with sea urchin and salmon roe or soy-marinated tuna, grated yam and egg...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=211%20E.%2043rd%20St.%2C%20New%20York%2C%20NY%2C%2010017%2C%20USA"
    pageTitle="Izakaya Futago"
  />
);

export default IzakayaFutago;
