...
const Kochi = () => (
  <RestaurantPage
    ...
    address="652 Tenth Ave., New York, 10036, USA"
    cuisine="Korean, Contemporary"
    priceRange="$$$$"
    phoneNumber="+16464787308"
    website="https://kochinyc.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The idea that tasting menus are hours-long and showy is far from true here, where an open kitchen is the obvious centerpiece. From here, a young team blitzes out an array of impressive grilled bites meant to be eaten with your hands—Kochi is Korean for skewer, after all.Chef Sungchul Shim taps into his Korean roots and fine-dining pedigree to create a solid but playful menu. A bowl of finely diced raw steelhead trout is topped with pickled cherry tomatoes and cucumber with a tomato and basil foam, then Iberico pork is done three ways, from char siu and ssamjang to skewered with pickled apple. Blackberry lime sorbet with a Calpico and smoked vanilla oil foam and mezcal-soaked blackberries is the last hurrah...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=652%20Tenth%20Ave.%2C%20New%20York%2C%2010036%2C%20USA"
    pageTitle="Kochi"
  />
);
