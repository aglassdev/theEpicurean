...
const Persepolis = () => (
  <RestaurantPage
    restaurantName="Persepolis"
    address="1407 Second Ave., New York, 10021, USA"
    cuisine="Persian"
    priceRange="$$"
    phoneNumber="+12125351100"
    website="https://www.persepolisnewyork.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Silky-smooth spreads, homemade yogurt, grilled meats and fragrantly spiced stews have solidified Persepolis’ reputation as one of the city’s finest Persian restaurants. Linen-draped tables, spacious banquettes and big windows facing Second Avenue fashion a look that inspires dressing up (or not). Service is always gracious, if at times too earnest.The kitchen shines with its eggplant halim, a creamy, steaming roasted eggplant and onion dip with tender lentils and a dollop of yogurt on top. A kebab duo of saffron-tinged chicken and grilled beef are both succulent successes, served with basmati rice flecked with sour cherries. For dessert, try the tart-sweet Persian lemon ice studded with bits of rice noodles and doused in a deep red cherry syrup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1407%20Second%20Ave.%2C%20New%20York%2C%2010021%2C%20USA"
    pageTitle="Persepolis"
  />
);

export default Persepolis;
