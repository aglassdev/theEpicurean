...
const LaDevozioneTheOval = () => (
  <RestaurantPage
    restaurantName="La Devozione: The Oval"
    address="428 W. 16th St., New York, 10011, USA"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+16467200215"
    website="https://www.ladevozionenyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This international outpost from Italy's 110-year-old, family-run Pastificio Di Martino, is a multi-concept space nestled within the Chelsea Market. The restaurant houses a pasta shop along with two dining spaces, including The Oval. It is aptly named, as the 30-seat counter awaits diners who will twirl their forks through a pasta tasting menu. It's all shapes, styles, and sizes, and it's far from dainty, with plate after plate of pasta. The manicotti is filled with sole and served with a bracing butter and caper sauce. Enjoy the penne served with rabbit confit and artichokes, and finish with a refreshing Mojito-inspired dessert with granita and grapefruit foam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=428%20W.%2016th%20St.%2C%20New%20York%2C%2010011%2C%20USA"
    pageTitle="La Devozione: The Oval"
  />
);

export default LaDevozioneTheOval;
