...
const LaTteDor = () => (
  <RestaurantPage
    restaurantName="La Tête d’Or"
    address="318 Park Ave. S., New York, 10010, USA"
    cuisine="Steakhouse, American"
    priceRange="$$$$"
    phoneNumber="+12125979155"
    website="https://www.latetedorbydaniel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glamorous and grand, this Flatiron looker is a reminder of what steakhouses can be in their most satisfying and beautiful form. Thank Chef Daniel Boulud, who brings his signature French flair to this classic genre. Start in the bar, a striking stage with leather-paneled walls and smart cocktails, before heading to the table. The setting is expansive with soaring ceilings, walnut floors, and servers positioned like turrets, ready to swoop in at any moment. Indeed, this is a room where deals get done. Caesar salads made tableside and prime rib sliced on roving trolleys up the charm on a menu that covers all the bases with dry-aged steaks, prime seafood, and ice cream sundaes. Expense accounts will take to the top-shelf Bordeaux and private dining rooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=318%20Park%20Ave.%20S.%2C%20New%20York%2C%2010010%2C%20USA"
    pageTitle="La Tête d’Or"
  />
);

export default LaTteDor;
