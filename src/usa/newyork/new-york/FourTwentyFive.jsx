...
const FourTwentyFive = () => (
  <RestaurantPage
    restaurantName="Four Twenty Five"
    address="425 Park Ave., New York, 10022, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+12127516921"
    website="https://www.425parkrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jonathan Benno and Jean-Georges Vongerichten are behind this elegant restaurant named for the address of the sleek building it's located within. Flooded with natural light, it's stunning yet understated.The menu pulls influences from all over, hopscotching across Italy and France to Asia. Dishes, like the foie gras plated with blood orange compote and served alongside warm, spiced madeleines, have a grand flair while featuring earnest cooking. Even a plate of asparagus is elevated, thanks to creamy avocado slices and a punchy vinaigrette. The meal concludes with a teardrop-shaped chocolate tart that delivers on every level with black cardamom crémeux, tonka whipped ganache, and buckwheat caramel sided by marzipan ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=425%20Park%20Ave.%2C%20New%20York%2C%2010022%2C%20USA"
    pageTitle="Four Twenty Five"
  />
);

export default FourTwentyFive;
