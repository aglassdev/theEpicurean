...
const PeppercornStation = () => (
  <RestaurantPage
    restaurantName="Peppercorn Station"
    address="66 W. 39th St., New York, 10018, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$"
    phoneNumber="+16464905444"
    website="https://www.peppercornstation.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This particular stretch that runs along the southern edge of Bryant Park sports an unusual number of Sichuan restaurants. Among them, Peppercorn Station is easy to spot, standing out with its cheery, brightly lit interior. The menu runs a decent length and offers a comfortable collection of favorites designed for sharing. Fish fillet with pickled cabbage is a must-order with its golden, numbing broth, as is the mapo tofu that’s been turbo-charged with fermented black beans. Sliced pork belly with garlic-chili sauce is a classic starter. Far from aggressive, this efficient kitchen is fairly even keeled when it comes to chilis and spice levels, and seasons just enough to nudge the sinuses. The restaurant has a second location in Jersey City...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20W.%2039th%20St.%2C%20New%20York%2C%2010018%2C%20USA"
    pageTitle="Peppercorn Station"
  />
);

export default PeppercornStation;
