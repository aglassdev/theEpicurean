...
const Melbas = () => (
  <RestaurantPage
    restaurantName="Melba's"
    address="300 W. 114th St., New York, 10026, USA"
    cuisine="Southern, American"
    priceRange="$$"
    phoneNumber="+12128647777"
    website="https://www.melbasrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its colorful spirit and lineup of Southern classics, this comfortable spot—as charming and lovely as its namesake owner, born-and-bred Harlemite Melba Wilson—is a perfect reflection of the neighborhood’s flavor, culture, and past. It’s a place to gather and relax over good food and drinks, from Auntie B’s mini-burgers slathered with a smoky-sweet sauce to a golden-brown fruit cobbler that’s nothing short of heaven on a plate. Equally enticing is the Southern fried chicken—darkly bronzed, sweet, and salty when paired with Melba’s iconic eggnog waffles. Expect other surprises like spring rolls stuffed with black-eyed peas, collards, and cheddar cheese, as well as a healthy-minded grilled vegetable Napoleon with buffalo mozzarella...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=300%20W.%20114th%20St.%2C%20New%20York%2C%2010026%2C%20USA"
    pageTitle="Melba's"
  />
);

export default Melbas;
