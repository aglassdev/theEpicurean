...
const KebabAurSharab = () => (
  <RestaurantPage
    restaurantName="Kebab aur Sharab"
    address="247 W. 72nd St., New York, 10023, USA"
    cuisine="Indian, Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+12125405247"
    website="https://kebabaursharab.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the deep, rich colors and a sea-blue tiled wall to the intricate woodwork and wicker seating, this Upper West Side spot is especially transporting. A versatile menu offers snacks, small plates, and main courses, all designed for sharing (though you may want to keep them to yourself). Do as the name suggests and order a kebab—the baby goat one is exceptional. Finely minced goat is formed around a skewer held together by thread, which is then unspooled tableside to deliver the juicy meat with just a whisper of spices and a hint of smokiness. Tandoori cooked curry patta prawns finished with mango chutney and crispy fried curry leaves is another highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=247%20W.%2072nd%20St.%2C%20New%20York%2C%2010023%2C%20USA"
    pageTitle="Kebab aur Sharab"
  />
);

export default KebabAurSharab;
