...
const CaviarRusse = () => (
  <RestaurantPage
    ...
    address="538 Madison Ave., New York, 10022, USA"
    cuisine="Contemporary, Seafood"
    priceRange="$$$$"
    phoneNumber="+12129805908"
    website="https://caviarrusse.com/pages/new-york-about"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a name like Cavar Russe, there’s no ambiguity about what sort of experience is on offer: a parade of luxury ingredients with eye-watering prices to match. Diners are led up a marble staircase at this posh jewel box, where views looking out over Madison Avenue below feel classically New York Offerings of the namesake range from a relatively attainable dollop of Pacific Sturgeon to 500-gram tins of Osetra that cost more than first-class tickets to the Caspian Sea. The French-inflected menu, available as either a prix fixe or à la carte, straddles classic and contemporary, as in fresh pasta agnolotti stuffed with chestnuts, dressed with black trumpet mushrooms and gilded by Périgord black truffle and foam. Dover sole is elegantly plated, stuffed with fish mousse, and draped with a refine..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=538%20Madison%20Ave.%2C%20New%20York%2C%2010022%2C%20USA"
    pageTitle="Caviar Russe"
  />
);

export default CaviarRusse;
