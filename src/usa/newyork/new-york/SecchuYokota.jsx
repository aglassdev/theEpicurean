...
const SecchuYokota = () => (
  <RestaurantPage
    restaurantName="Secchu Yokota"
    address="199 E. 3rd St., New York, 10009, USA"
    cuisine="Japanese, Tempura"
    priceRange="$$$$"
    phoneNumber="+12127771124"
    website="https://www.secchuyokota.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot flies under the radar somewhat, and that’s just the way their loyal fan base likes it. Those who understand the fine art of tempura know how pristine the quality is here, where diners are treated to a mouthwatering omakase featuring succulent red shrimp, Japanese eggplant, and lightly battered anago. You probably won’t need it, but lemon, wasabi salt and seaweed salt are provided as enhancements. The man to thank for these treats is Chef Yokota, who takes his craft (and business) seriously, putting his clients first. Dining here is an intimate and deeply personal experience that highlights ingredients sourced mostly from Japan. As a bonus, his tempura is typically bookended by unique dishes that display his French culinary training...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=199%20E.%203rd%20St.%2C%20New%20York%2C%2010009%2C%20USA"
    pageTitle="Secchu Yokota"
  />
);

export default SecchuYokota;
