...
const NamiNori = () => (
  <RestaurantPage
    ...
    address="33 Carmine St., New York, 10014, USA"
    cuisine="Japanese, Creative"
    priceRange="$"
    phoneNumber="+16469984588"
    website="https://naminori.us/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern and minimalist spot emanates with an impressive level of warmth. Beyond its entrance, find a few blonde-wood benches donning gray-blue pillows, and two U-shaped counters where temaki, or hand rolls, are front and center, along with other items like a vegetable miso soup with fried tofu and shishito. Hungry diners will revel in the chef's set, which may uncover such delectable combos as salmon, onion cream, and tomato in toasted nori. Topped with scallions, chopped toro on wasabi rice is hard to resist; not unlike the broiled crab with spicy mayo that arrives in a nori shell studded with rice crackers for a delightfully inventive treat. Vegan options are equally tempting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20Carmine%20St.%2C%20New%20York%2C%2010014%2C%20USA"
    pageTitle="Nami Nori"
  />
);

export default NamiNori;
