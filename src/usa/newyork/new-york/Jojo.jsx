...
const Jojo = () => (
  <RestaurantPage
    restaurantName="JoJo"
    address="160 E. 64th St., New York, 10065, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+12122235656"
    website="https://www.jojorestaurantnyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Jean-Georges Vongerichten runs a restaurant empire today that spans the globe, but his journey started here back in 1991. A few years ago, the space underwent a refresh, and now this cozy, two-story townhouse is a contemporary respite for the area’s moneyed residents. The menu isn’t particularly groundbreaking—think roast chicken, seared salmon, and Maine lobster—but you’ll certainly find seasonality, quality product, and astute cooking in good supply. Recent highlights include warm asparagus with vegetable vinaigrette as well as rack of lamb with braised artichokes and peas. For dessert, try something new like the sour cherry pie or indulge in a bit of nostalgia with the likes of molten chocolate cake with vanilla ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=160%20E.%2064th%20St.%2C%20New%20York%2C%2010065%2C%20USA"
    pageTitle="JoJo"
  />
);
