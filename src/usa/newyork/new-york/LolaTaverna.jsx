...
const LolaTaverna = () => (
  <RestaurantPage
    restaurantName="Lola Taverna"
    address="210 Sixth Ave., New York, 10014, USA"
    cuisine="Greek, Mediterranean Cuisine"
    priceRange="$$$"
    phoneNumber="+12129949821"
    website="https://www.lolataverna.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tavern has quickly become the it spot in SoHo, where one is almost guaranteed to see a line of fashion-forward diners waiting for a chance to tuck into their famously tender and delicious lamb chops. Inside, it's tight but nobody seems to mind. The dining room's white stucco walls and windows set a warm and welcoming vibe. This is not your average Greek restaurant serving the tired old clichés. Instead, the chef infuses a hint of whimsy into each dish and delivers on flavor and quality. Some standouts include spanakopita spring rolls, chicken gyro bao buns, and moussaka with lamb or vegetarian options. Come Sunday for the well-priced supper and half-price wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=210%20Sixth%20Ave.%2C%20New%20York%2C%2010014%2C%20USA"
    pageTitle="Lola Taverna"
  />
);

export default LolaTaverna;
