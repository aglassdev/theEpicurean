...
const Semma = () => (
  <RestaurantPage
    ...
    address="60 Greenwich Ave., New York, 10011, USA"
    cuisine="Indian, Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+12123738900"
    website="https://www.semma.nyc/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Vijay Kumar runs the show at Semma, where regional south Indian cuisine is on full display. This is authentic Indian cooking that doesn't pander to American expectations, and if some of the dishes are unfamiliar, lean on the staff who know their stuff and are eager to share. One bite in and you'll quickly learn that this cooking is all heart. Dishes are spicy, but the heat is used as elegantly as it is liberally. Start with the mulaikattiya thaniyam, the chef's childhood snack that bursts with flavor. The gunpowder dosa, a classic rice and lentil crepe filled with potato masala, is on every table for a reason. Attu kari sukka is falling-apart tender lamb in a dark brown curry redolent of warm spices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%20Greenwich%20Ave.%2C%20New%20York%2C%2010011%2C%20USA"
    pageTitle="Semma"
  />
);
