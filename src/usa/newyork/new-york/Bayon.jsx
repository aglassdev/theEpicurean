...
const Bayon = () => (
  <RestaurantPage
    restaurantName="Bayon"
    address="408 E. 64th St., New York, 10065, USA"
    cuisine="Cambodian"
    priceRange="$"
    phoneNumber="+16464764709"
    website="https://www.bayonnyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Husband-and-wife owners Minh and Mandy Truong offer an elegant peek into traditional Cambodian flavors at their Upper East Side restaurant, where a comprehensive a la carte menu offers a wide selection of everything from Khmer noodles and fried rice to Siem Reap specials, along with sections dedicated entirely to duck and fish. Top picks include chive dumplings, fried to a golden crisp and served with a ginger soy sauce, and nyoam, or thick rice noodles, tossed with a red curry sauce made with ground fish, cucumbers, long beans, and bean sprouts. Don't miss the banh chao crepe, a half-round golden crepe filled with ground shrimp, chicken, and a variety of vegetables and spices, that's intended for stuffing into lettuce wraps for a delicious treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=408%20E.%2064th%20St.%2C%20New%20York%2C%2010065%2C%20USA"
    pageTitle="Bayon"
  />
);
