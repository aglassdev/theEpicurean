...
const YellowRose = () => (
  <RestaurantPage
    restaurantName="Yellow Rose"
    address="102 Third Ave., New York, 10003, USA"
    cuisine="Tex-Mex"
    priceRange="$$"
    phoneNumber="+12125298880"
    website="https://www.yellowrosenyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sorry Texas, this yellow rose belongs to the bustling East Village and announces its arrival via a striped awning and bright green sign. Inside, it's quaint and vintage in every way. Amidst this setting of weathered wood and stained-glass chandeliers, diners can be found devouring Tex-Mex food with a focus on tacos and inspired cocktails. Flour tortillas are made in house daily and feature in a myriad of deliciously dressed-down creations—from the shredded chicken verde and barbacoa taco with avocado, cilantro, and spring onion to the heartier carne guisada. Skirt steak and pepper quesadilla is a sumptuous mainstay, but those with sweets on their mind should go straight for the nostalgic Texas sheet cake with candied pecans.-..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=102%20Third%20Ave.%2C%20New%20York%2C%2010003%2C%20USA"
    pageTitle="Yellow Rose"
  />
);
