...
const Cmodo = () => (
  <RestaurantPage
    restaurantName="Cómodo"
    address="23 Lexington Ave., New York, 10010, USA"
    cuisine="Latin American, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+12124751924"
    website="https://comodonyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Felipe Donnelly and Chef/co-owner Tamy Rofe have resurrected their much-loved SoHo spot, now at the Freehand Hotel. This iteration is wooing patrons with its warm interior and tempting dishes blending Latin American influences from Brazil to Mexico.Kick things off with a zesty-delicious trout ceviche tostada, vibrant thanks to leche de tigre marinade. Next, braised leeks in beurre blanc with guajillo chile oil are meltingly tender, while ajiaco soup is a comforting bowl of Colombian potato sided by shredded chicken, capers, fresh avocado chunks, and a habanero sauce. Bone-in achiote chicken over green Calasparra rice with brown butter mustard is lush, creamy and packed with flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Lexington%20Ave.%2C%20New%20York%2C%2010010%2C%20USA"
    pageTitle="Cómodo"
  />
);

export default Cmodo;
