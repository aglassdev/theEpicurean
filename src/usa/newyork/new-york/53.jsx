...
const FiveThree = () => (
  <RestaurantPage
    restaurantName="53"
    address="53 W. 53rd St., New York, 10019, USA"
    cuisine="Asian, Contemporary"
    priceRange="$$$$"
    phoneNumber="+16465353994"
    website="https://53-nyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is only fitting that this newcomer dazzles with all the style and smarts of the next-door Museum of Modern Art. The bar and lounge upstairs are but a tease of what’s hiding below: A glowing, expansive dining room with sweeping wood patterns, sleek banquettes and a long bar that never slows down. Courtesy of the Altamarea Group, this Pan-Asian restaurant delivers familiar Chinese and Singaporean favorites with fantastic precision. Soup dumplings imbued with black truffle, kung pao quail with snap peas and hearty clay pots packed with crispy rice are easy favorites. Dessert is another point of pride here – we’re partial to the housemade ice creams and sorbet. The polished service team rounds out an experience that feels distinctly New York...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20W.%2053rd%20St.%2C%20New%20York%2C%2010019%2C%20USA"
    pageTitle="53"
  />
);
