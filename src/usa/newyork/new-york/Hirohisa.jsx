...
const Hirohisa = () => (
  <RestaurantPage
    restaurantName="Hirohisa"
    address="73 Thompson St., New York, 10012, USA"
    cuisine="Japanese, Classic Cuisine"
    priceRange="$$$$"
    phoneNumber="+12129251613"
    website="https://www.hirohisa.nyc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s nothing like a discreet entrance to raise expectations—and Hirohisa is nicely concealed on Thompson Street. When you do find it, you enter into a stylish and beautifully understated room. The menu is structured as a kaiseki experience. Two things will quickly become clear: the ingredients are exceptional, and the team's technical skills are considerable. This is food that is as rewarding to eat as it is restorative. Standouts include mushroom zosui, a comforting bowl with a base of rice topped with a multitude of earthy mushrooms. The meal concludes with a satisfying pot of rice enhanced with snow crab, ikura, and crab roe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20Thompson%20St.%2C%20New%20York%2C%2010012%2C%20USA"
    pageTitle="Hirohisa"
  />
);

export default Hirohisa;
