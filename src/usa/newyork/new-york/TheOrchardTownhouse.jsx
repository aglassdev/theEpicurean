...
const TheOrchardTownhouse = () => (
  <RestaurantPage
    restaurantName="The Orchard Townhouse"
    address="242 Tenth Ave., New York, 10001, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+16469705670"
    website="https://www.theorchardtownhouse.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Orchard Townhouse is an all-day spot that expertly balances trendy looks with an endearing atmosphere. This downtown bistro is the perfect place to catch up with a friend, but it's equally welcoming for solo diners who want to enjoy a leisurely meal. Every bit the neighborhood gem, it's also so much more than that, with earnest cooking and originality coming from this kitchen. Echoing the look and feel, the menu spotlights contemporary bistro fare with snacks and salads, sandwiches at lunch and main dishes served all day, with the likes of spicy crab spaghetti with roasted tomato, pickled chili and breadcrumbs or a delicious rendition of chicken Milanese. The radish pakora with cucumber-herb yogurt dipping sauce is always a good idea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=242%20Tenth%20Ave.%2C%20New%20York%2C%2010001%2C%20USA"
    pageTitle="The Orchard Townhouse"
  />
);

export default TheOrchardTownhouse;
