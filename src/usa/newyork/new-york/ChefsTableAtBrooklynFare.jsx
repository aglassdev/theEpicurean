...
const ChefsTableAtBrooklynFare = () => (
  <RestaurantPage
    restaurantName="Chef's Table at Brooklyn Fare"
    address="431 W. 37th St., New York, 10018, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+17182430050"
    website="https://www.brooklynfare.com/chefs-table/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This famed address hidden in the back corner of a Hell’s Kitchen grocery store has entered a new era under Chefs Max Natmessnig and Marco Prins. The room is a box of luxury and sparkles as bright as ever under the spotlights, with most guests seated at a glossy walnut counter that wraps around a brigade of cooks who have nowhere to hide. The team works quickly, sending out a volley of delicate tarts and bites that showcase skill and refinement. Highlights have included a beach glass oyster atop a vibrant bright green aguachile and a single scallop topped with caviar in a vin jaune sauce. All the while, an excellent service team keeps close watch from all corners of the room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=431%20W.%2037th%20St.%2C%20New%20York%2C%2010018%2C%20USA"
    pageTitle="Chef's Table at Brooklyn Fare"
  />
);

export default ChefsTableAtBrooklynFare;
