...
const CasaDani = () => (
  <RestaurantPage
    restaurantName="Casa Dani"
    address="448 W. 33rd St., New York, 10001, USA"
    cuisine="Spanish, Seafood"
    priceRange="$$$$"
    phoneNumber="+12127850352"
    website="https://www.casadanirestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is nothing homey about Chef Dani Garcia’s sprawling new casa, located in the sparkling Citizens food hall in Manhattan West. A buzzy lounge opens into a packed two-story dining room that is full-on glamour with ceilings that reach for the sky, a glassed-in open kitchen, beautiful fabric and texture at every corner and a professional clientele that likes to eat well and look good doing it. Big groups like to swing for the pricey paella, but we suggest building a meal around a wide range of small dishes, starting with any one of the fantastic preparations of tuna. Shrimp tucked with a basil leaf and fried until perfectly crispy are even better with smoky aioli, but don't miss a wedge of still-warm, burnt Basque cheesecake, served tableside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=448%20W.%2033rd%20St.%2C%20New%20York%2C%2010001%2C%20USA"
    pageTitle="Casa Dani"
  />
);

export default CasaDani;
