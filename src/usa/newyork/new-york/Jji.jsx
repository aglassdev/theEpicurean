...
const Jji = () => (
  <RestaurantPage
    restaurantName="Jōji"
    address="1 Vanderbilt Ave., New York, 10017, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+12125979025"
    website="https://www.jojiny.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hidden away in a corner of Grand Central, at the base of the ritzy One Vanderbilt building, Jōji presents a disarming oasis of calm and sophistication amidst the hustle and bustle. The meal begins with small plates that blend Japanese flavors with seasonal elements, as in a sashimi of buri with green apple, ginger, and yuzu zest, followed by nigiri featuring a blend of Koshihikari and Nanatsuboshi rice, carefully vinegared to showcase the flavor of the fish. The variety of excellent seafood, largely sourced from Toyosu Market, is impressive, and even devoted sybarites will leave satisfied. Expect an abundance of luxury ingredients (and commensurate pricing), like a lightly cooked langoustine layered with creamy petals of uni, or a delicate, silky chawanmushi topped with golden Osetra...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Vanderbilt%20Ave.%2C%20New%20York%2C%2010017%2C%20USA"
    pageTitle="Jōji"
  />
);
