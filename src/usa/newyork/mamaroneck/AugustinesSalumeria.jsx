...
const AugustinesSalumeria = () => (
  <RestaurantPage
    restaurantName="Augustine’s Salumeria"
    address="213 Halstead Ave., Mamaroneck, 10543, USA"
    cuisine="Contemporary, Italian"
    priceRange="$$$"
    phoneNumber="+19143156541"
    website="https://augustinesny.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef and co-owner Marc Taxiera takes full advantage of the proximity to Westchester's top farmers and fish at Augustine's Salumeria, a full-fledged restaurant with a part-time counter proffering charcuterie and cheese. The space is laidback and modern, with a comfortable neighborhood vibe. There's plenty on this Italian-leaning locavore menu but the kitchen also offers a handful of nightly specials that will make choosing one oh-so-difficult. Mafalda never misses with its slow-stewed, grass-fed Longhorn beef resting over pasta topped with a goat milk ricotta. Sourced locally, the pork chop, paired with a pecan and onion ash, is wonderfully moist and grilled to perfection. End with something light and sweet like the cannoli made from freshly pressed pizzelle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=213%20Halstead%20Ave.%2C%20Mamaroneck%2C%2010543%2C%20USA"
    pageTitle="Augustine’s Salumeria"
  />
);

export default AugustinesSalumeria;
