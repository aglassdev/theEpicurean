...
const VertFrais = () => (
  <RestaurantPage
    ...
    address="43-10 Crescent St., Queens, 11101, USA"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber="+16468229258"
    website="https://vertfrais.squarespace.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sunny, white-walled café in Long Island City does not look like a serious restaurant. It looks like the kind of place where you’d grab a coffee with friends or pull out your laptop at a communal table. But with the backing of Kanoyama’s long-standing chef, the kitchen is not to be underestimated. The classic shio ramen is a must, the broth fragrant and deep with smoky, charred slices of cha-shu and crunchy bamboo shoots. Thin slivers of sushi-grade salmon laced over a mound of warm rice with scallions and topped with poppy ikura are also a source of easy comfort. Dessert is all but bound to set social media feeds on fire: Fluffy, tall, jiggly souffle pancakes that are light as air, none too sweet, and impossible not to finish in a few big bites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43-10%20Crescent%20St.%2C%20Queens%2C%2011101%2C%20USA"
    pageTitle="Vert Frais"
  />
);

export default VertFrais;
