...
const pageTitle = "The Bronx";

const restaurants = [
  {
    name: "Archie's Tap & Table",
    cuisine: "American, Contemporary",
    price: "$$",
    path: "/usa/newyork/bronx/ArchiesTapTable",
    image: "/images/archiestaptable1.png"
  },
  {
    name: "Çka Ka Qëllu",
    cuisine: "Balkan, Country cooking",
    price: "$$",
    path: "/usa/newyork/bronx/KaKaQllu",
    image: "/images/kakaqllu1.png"
  },
  {
    name: "Patricia’s",
    cuisine: "Italian-American, Italian",
    price: "$$$",
    path: "/usa/newyork/bronx/Patricias",
    image: "/images/patricias1.png"
  },
  {
    name: "Seis Vecinos",
    cuisine: "Latin American, Regional Cuisine",
    price: "$$",
    path: "/usa/newyork/bronx/SeisVecinos",
    image: "/images/seisvecinos1.png"
  },
  {
    name: "Tobalá",
    cuisine: "Mexican, Regional Cuisine",
    price: "$$$",
    path: "/usa/newyork/bronx/Tobal",
    image: "/images/tobal1.png"
  },
  {
    name: "Tra Di Noi",
    cuisine: "Italian, Italian-American",
    price: "$$",
    path: "/usa/newyork/bronx/TraDiNoi",
    image: "/images/tradinoi1.png"
  }
];
