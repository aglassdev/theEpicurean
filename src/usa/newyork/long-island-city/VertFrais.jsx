...
const VertFrais = () => (
  <RestaurantPage
    ...
    address="43-10 Crescent St., Long Island City, NY, 11101, USA"
    cuisine="Japanese"
    priceRange="$$"
    ...
    bio="This sunny, white-walled café in Long Island City feels more like a relaxed neighborhood hangout than a destination dining room, with communal tables and an easygoing daytime energy. Backed by the longstanding chef of Kanoyama, the kitchen delivers well-executed Japanese comfort food rather than high drama. The classic shio ramen is a reliable choice, built on a clean, lightly fatty broth and topped with nicely charred slices of cha-shu, while warm rice bowls layered with tender pork or sushi-grade salmon offer simple, satisfying appeal. Desserts lean playful and crowd-pleasing, with tall, jiggly soufflé pancakes that are light, airy and easy to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43-10%20Crescent%20St.%2C%20Long%20Island%20City%2C%20NY%2C%2011101%2C%20USA"
