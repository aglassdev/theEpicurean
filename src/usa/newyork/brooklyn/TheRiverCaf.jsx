...
const TheRiverCaf = () => (
  <RestaurantPage
    ...
    address="1 Water St., Brooklyn, 11201, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+17185225200"
    website="https://rivercafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its stunning location in the shadow of the Brooklyn Bridge, complete with an eye-popping view of the Manhattan skyline, a visit to this landmark calls for dressing up (in fact, jackets are still required for gentlemen). While the atmosphere and service are formal by today’s standards, the professional waitstaff operate with such poise that the experience exudes an old-school charm, rather than feeling starchy. The setting makes this a perpetual favorite for romantic couples, and the ample prix fixe menu includes dishes such as Pacific blue shrimp over a bed of whipped corn hominy and a tableside pour of smoked shrimp jus, as well as Dover sole in a Burgundy truffle sauce. To finish, the hazelnut soufflé seals the deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Water%20St.%2C%20Brooklyn%2C%2011201%2C%20USA"
    pageTitle="The River Café"
  />
);

export default TheRiverCaf;
