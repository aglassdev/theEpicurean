...
const CafeMado = () => (
  <RestaurantPage
    restaurantName="Cafe Mado"
    address="791 Washington Ave., Brooklyn, 11238, USA"
    cuisine="American Contemporary"
    priceRange="$"
    phoneNumber="+13476278298"
    website="https://www.cafemadonyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At first glance, it may seem like your typical neighborhood all-day café, but there’s more than meets the eye at Café Mado from Chef/owner Nico Russell. This Prospect Heights café bustles with a coffee shop up front and a skylit atrium with a small bar and dining room. It is here where they sell house-baked bread, breakfast sandwiches, elegant small plates, and handmade pasta by day before shifting to a more refined dinner service by night. Begin with pissaladière, a warm, round loaf topped with anchovies, caramelized red onions, and olive spread or kick things off with a seasonal small plate like summer melon with lime granita and habanada before tucking into a plate of pasta, like pici with pesto Genovese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=791%20Washington%20Ave.%2C%20Brooklyn%2C%2011238%2C%20USA"
    pageTitle="Cafe Mado"
  />
);

export default CafeMado;
