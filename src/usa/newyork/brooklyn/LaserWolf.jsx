...
const LaserWolf = () => (
  <RestaurantPage
    ...
    address="97 Wythe Ave., Brooklyn, 11249, USA"
    cuisine="Middle Eastern, Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+17182157150"
    website="https://www.laserwolfbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Guests of Williamsburg's hip Hoxton Hotel who seek to sip a cocktail while enjoying a stunning sunset over Manhattan need to just hop on the elevator and head to the rooftop to reach Laser Wolf. Of course, scoring a reservation at this hot spot is not as easy. Michael Solomonov's and Steve Cook's skewer house is especially buzzy, where lights are strung overhead and trendy music and a bustling open kitchen add to the vibe.  The menu is festive and focused. It all begins with salatim including the likes of  babaghanoush, mushrooms with Swiss chard and sour cherry, pickles, gigante beans with harissa and more. Meat and vegetable skewers are next, with lamb kofta a winning choice. Finally, brown sugar soft-serve ice cream rounds out the satisfying meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=97%20Wythe%20Ave.%2C%20Brooklyn%2C%2011249%2C%20USA"
    pageTitle="Laser Wolf"
  />
);

export default LaserWolf;
