...
const Fausto = () => (
  <RestaurantPage
    restaurantName="Fausto"
    address="348 Flatbush Ave., Brooklyn, 11238, USA"
    cuisine="Italian, American"
    priceRange="$$$"
    phoneNumber="+19179091427"
    website="https://www.faustobrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sleek and upscale restaurant serves consistently delicious Italian-influenced food courtesy of Chef/owner Erin Shambura, but its overall ethos is guided by restaurateur (and sommelier), Joe Campanale. The dimly lit space and open hearth lend a warmth to the space that is perfect for date night or an evening out with friends. Meanwhile, the kitchen showcases a distinctive take on Southern regional fare. Pasta is a showstopper, as in tagliatelle with lamb ragu and saffron. Snack on a bowl of roasted and raw cauliflower with Romanesco and an anchovy caper vinaigrette, then forge ahead with main dishes like steelhead trout and roasted chicken. Braised pork shank atop Tuscan beans is a rich and savory dish that melts in your mouth. To finish, gelato or sorbet are the ideal conclusion to a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=348%20Flatbush%20Ave.%2C%20Brooklyn%2C%2011238%2C%20USA"
    pageTitle="Fausto"
  />
);
