...
const SaintJulivertFisherie = () => (
  <RestaurantPage
    restaurantName="Saint Julivert Fisherie"
    address="264 Clinton St., Brooklyn, 11201, USA"
    cuisine="Seafood, Spanish"
    priceRange="$$$"
    phoneNumber="+13479873710"
    website="https://www.saintjulivertbk.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-time neighborhood favorite comes courtesy of Chefs Alex Raij and Eder Montero, who also run next-door La Vara. The narrow space does not at all match the kitchen’s outsized talents and imaginative plates, which put seafood front and center. Consider starting with a plate of tempura-battered delicata squash with black garlic-infused labneh or golden-brown fried hamachi and shrimp boudin with Thai chili mayo before diving into the likes of Ibérico pork steak. Tamarind-glazed and grilled, it's served over a bed of coconut creamed spinach and okra and sided by a bowl of roasted potatoes with sauce choron.A generous selection of regional wines highlights small producers to match the cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=264%20Clinton%20St.%2C%20Brooklyn%2C%2011201%2C%20USA"
    pageTitle="Saint Julivert Fisherie"
  />
);

export default SaintJulivertFisherie;
