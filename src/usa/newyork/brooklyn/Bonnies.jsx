...
const Bonnies = () => (
  <RestaurantPage
    restaurantName="Bonnie's"
    address="398 Manhattan Ave., Brooklyn, 11211, USA"
    cuisine="Cantonese, American"
    priceRange="$$$"
    phoneNumber="+19148753709"
    website="https://www.bonniesbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located within earshot of the BQE’s rumble in east Williamsburg in a nondescript corner, Bonnie's is an absolute discovery. Inside, the look is retro Hong Kong diner through and through but Chef Calvin Eng plates Cantonese regional cuisine with modern interpretations. Yeung yu sang choi bao is a wonder, stuffed with shrimp, green mustard and lettuces, then crisped and presented whole. The salt and pepper shrimp is tossed with melted red onions and is ideal for sharing. Don't sleep on the classic Hong Kong street food like cheung fun, with tender, seared rice noodles tossed with shrimp and scallop X.O. sauce and bits of cured pork. The creativity extends through dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=398%20Manhattan%20Ave.%2C%20Brooklyn%2C%2011211%2C%20USA"
    pageTitle="Bonnie's"
  />
);

export default Bonnies;
