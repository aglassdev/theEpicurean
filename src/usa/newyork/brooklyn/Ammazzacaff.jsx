...
const Ammazzacaff = () => (
  <RestaurantPage
    restaurantName="Ammazzacaffè"
    address="702 Grand St., Brooklyn, 11211, USA"
    cuisine="Italian, Contemporary"
    priceRange="$$$"
    phoneNumber="+19292502875"
    website="https://www.ammazzacaffe.nyc"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quintessential Italian gem on Grand Street is bound to surprise the moment you enter. The large and welcoming space draws you in thanks to an impressive wood bar, sleek dining tables and a handsome penny-tiled floor. Both the tables and light olive-tinged walls are dressed minimally—the former with wildflowers and the latter with beautifully framed photos. The garden outside will transport you to a trattoria in Umbria—on a dime. The well-edited menu spins to the season but start with a spiedini (skewer) or dish for the table to share. Do not miss their expertly prepared pasta dishes like ondine, with shrimp in a kicky tomato sauce, then follow it up with an entree like the grilled branzino with cauliflower pieces, roasted grapes, wilted spinach, almond puree, and verjus. Tiramisu is a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=702%20Grand%20St.%2C%20Brooklyn%2C%2011211%2C%20USA"
    pageTitle="Ammazzacaffè"
  />
);

export default Ammazzacaff;
