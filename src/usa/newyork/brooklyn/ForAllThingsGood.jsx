...
const ForAllThingsGood = () => (
  <RestaurantPage
    restaurantName="For All Things Good"
    address="343 Franklin Ave., Brooklyn, 11238, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+19292044154"
    website="https://www.forallthingsgoodbk.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Say good morning (or good afternoon) to this charming café that can crank out more than iced lattes or shots of double espresso. With a kitchen so small you could cook and wash dishes at the same time, these owners have high ambitions. Heirloom corn sourced from various villages in Mexico is a real point of pride here, and it appears in several incarnations. Triangle-shaped tetelas are stuffed with black beans and wrapped in hoja santa leaves; while crispy tlayuditas are toppled with hen of the wood mushrooms and salsa macha. A taco special might uncover avocado, salsa verde, and a runny egg. Soft, hearty tlacoyos stuffed with pinto beans arrive crowned with a mountain of avocado...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=343%20Franklin%20Ave.%2C%20Brooklyn%2C%2011238%2C%20USA"
    pageTitle="For All Things Good"
  />
);

export default ForAllThingsGood;
