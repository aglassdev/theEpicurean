...
const Popina = () => (
  <RestaurantPage
    ...
    address="127 Columbia St., Brooklyn, 11231, USA"
    cuisine="Italian, Southern"
    priceRange="$$$"
    phoneNumber="+17182221901"
    website="https://www.popinanyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Exuding Brooklyn charm while managing to be romantic and family-friendly at once, this intimate and cozy space is ideal for a variety of nights out. Inside, the space is homey and scattered with patrons perusing the limited yet tempting menu. The adept kitchen turns out dishes blending Italian and Roman cuisine with the flavors of the American South, such as pappardelle with tender, braised ham hock, sliced shishito peppers, and collards finished with Grana Padano. Other highlights include hot chicken Milanese with gem lettuce and ranch dressing; sea bass with bonito and chanterelles, and hangar steak with cabbage and carrots. The concise yet thoroughly crafted wine selection honors top producers and back vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20Columbia%20St.%2C%20Brooklyn%2C%2011231%2C%20USA"
    pageTitle="Popina"
  />
);

export default Popina;
