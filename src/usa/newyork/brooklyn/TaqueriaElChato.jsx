...
const TaqueriaElChato = () => (
  <RestaurantPage
    restaurantName="Taqueria El Chato"
    address="620 Manhattan Ave., Brooklyn, 11222, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/new-york-state/brooklyn/restaurant/taqueria-el-chato"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="t's a simple space with a sprinkling of seats and counter space, but you're not here for ambience. You're here to eat well, and this concise menu of deftly executed tacos, vampiras, and quesadillas certainly delivers. Choose from delicious items like corn tacos with shredded al pastor layered with red salsa and sweet pineapple or a deeply flavorful, aromatic chorizo with raw onion and cilantro. Another can't miss? The vampira, a single fried tortilla with cheese and salsa verde topped with a mound of velvety beef lengua and a riot of fresh toppings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=620%20Manhattan%20Ave.%2C%20Brooklyn%2C%2011222%2C%20USA"
    pageTitle="Taqueria El Chato"
  />
);

export default TaqueriaElChato;
