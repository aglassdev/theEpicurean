...
const Daphnes = () => (
  <RestaurantPage
    restaurantName="Daphne's"
    address="299 Halsey St., Brooklyn, 11216, USA"
    cuisine="Italian-American, Contemporary"
    priceRange="$$"
    phoneNumber="+13473658680"
    website="https://www.daphnesbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on the corner of Halsey and Throop in Bed-Stuy, Daphne's sparkles ever so subtly thanks to a front window covered with strands of tiny, twinkling silver beads. But it's not just the exterior that invites curiosity; this refined, contemporary Italian-American restaurant dazzles with its tightly edited menu, too. From shareable plates and house-made pasta to entrees, there is something tempting at every turn. Do not miss the delicious golden-brown focaccia with anchovy butter or grilled mortadella over a bed of house-made giardiniera. Then, mustard green pesto stars in a dish of radiatore pasta, while a grilled pork chop with slow-cooked greens, pancetta, and cicerchia beans is especially flavorful and tender...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=299%20Halsey%20St.%2C%20Brooklyn%2C%2011216%2C%20USA"
    pageTitle="Daphne's"
  />
);

export default Daphnes;
