...
const Vedge = () => (
  <RestaurantPage
    restaurantName="Vedge"
    address="1221 Locust St., Philadelphia, PA, 19107, USA"
    cuisine="Vegan, Vegetarian"
    priceRange="$$$"
    phoneNumber="+12153207500"
    website="https://www.vedgerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stalwart of the city’s dining scene since 2011, Vedge is the creation of husband-and-wife team Richard Landau and Kate Jacoby and is housed in a charming Center City brownstone. It’s not unlike stepping into someone’s house; but someone who clearly has taste and considerable means as it’s a surprisingly large and elegant space divided up into different rooms. The vegan menu offers plenty of choice, with dishes designed for sharing. Judicious use of international flavors ensures the seasonal, plant-based dishes have a vibrancy and vitality that makes them as satisfying as they are memorable. The dan dan noodles with black vinegar-glazed trumpet mushrooms is just one of the standout dishes. Add in seasonal cocktails, warm and flattering lighting, and charming, helpful service and you have ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1221%20Locust%20St.%2C%20Philadelphia%2C%20PA%2C%2019107%2C%20USA"
    pageTitle="Vedge"
  />
);
