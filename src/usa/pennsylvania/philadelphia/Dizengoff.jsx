...
const Dizengoff = () => (
  <RestaurantPage
    restaurantName="Dizengoff"
    address="1625 Sansom St., Philadelphia, PA, 19103, USA"
    cuisine="Israeli"
    priceRange="$$"
    phoneNumber="+12158678181"
    website="https://www.dizengoffphilly.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The colorful, casual sibling to Zahav and Laser Wolf does a roaring trade in downtown Philadelphia — and rightly so. There’s no need to wrangle for reservations or arrive before doors open to grab a seat. Instead, one could wander in off the street to find a vibrant café awash in bright colors and dangling greenery. The food too is much of the same; hummus with brown butter, crispy garlic and urfa is a classic start and comes with fresh-baked pita bread. Chicken schnitzel with sumac onions is a solid follow-up, as is the pita stuffed with fried eggplant and egg. Heartier appetites should look to the za’atar chicken, which is roasted properly and served with green tahini, rice and a cucumber salad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1625%20Sansom%20St.%2C%20Philadelphia%2C%20PA%2C%2019103%2C%20USA"
    pageTitle="Dizengoff"
  />
);

export default Dizengoff;
