...
const RoyalSushiIzakaya = () => (
  <RestaurantPage
    restaurantName="Royal Sushi & Izakaya"
    address="780 S. 2nd St., Philadelphia, PA, 19147, USA"
    cuisine="Japanese, Izakaya"
    priceRange="$$"
    phoneNumber="+12679099002"
    website="https://royalizakaya.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Many izakayas buckle under the weight and scale of their own menus, struggling to balance variety with quality. This isn’t one of those places. People dash to the door of this windowless, walk-in only hangout hoping to find an empty booth or a spare seat at the bar. Find a range of fried, steamed, seared and raw dishes. Think hamachi turbocharged with ponzu, cucumbers fortified with miso and buckwheat, and cod grilled until the skin is crisp as a chip. There’s more, like fried chicken thigh sandos or grand chirashi bowls festooned with Japanese fish, caviar and Ikura. All of it is carefully sourced, handled and seasoned in a relaxed setting. Longtime regulars have their sights on the exclusive omakase counter hidden away in the back...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=780%20S.%202nd%20St.%2C%20Philadelphia%2C%20PA%2C%2019147%2C%20USA"
    pageTitle="Royal Sushi & Izakaya"
  />
);

export default RoyalSushiIzakaya;
