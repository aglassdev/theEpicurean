...
const Hiroki = () => (
  <RestaurantPage
    restaurantName="Hiroki"
    address="1355 N. Front St., Philadelphia, PA, 19122, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+12154223222"
    website="https://hirokisan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kyoto-born Executive Chef Hiroki Fujiyama was inspired by the machiya of his hometown when creating this stylish and discreet Fishtown spot. From the understated façade to the custom-designed furnishings, it feels authentic but also contemporary; just be sure to book a place at the 12-seater counter rather than at one of the tables. The omakase is also a blend of the modern and the traditional. You can expect around 20 courses, starting with delicate snacks like firefly squid and Japanese snow crab, followed by grilled black cod and red miso wagyu. The nigiri is sized quite small, which means you’re able to enjoy around 10 pieces without filling up; the toppings get stronger as it progresses, with highlights that include snapper and scallop. The good-value sake pairing offers a great chanc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1355%20N.%20Front%20St.%2C%20Philadelphia%2C%20PA%2C%2019122%2C%20USA"
    pageTitle="Hiroki"
  />
);
