...
const Sally = () => (
  <RestaurantPage
    restaurantName="Sally"
    address="2229 Spruce St., Philadelphia, PA, 19103, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+12677737178"
    website="https://www.sallyphl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pizza is a bit of a religion in Philly and while everyone has their favorite slice, head to this cute spot for wood-fired, naturally leavened sourdough pizzas. Sally has a hip vibe, where a heart-shaped accent lamp hangs from the ceiling and exposed brick walls and wine bottles lining the windows lend charm to the space. It's the kind of place that works for families, couples and friends—all here for a pie as well as a lineup of small plates and natural wines. Start with a plate of meatballs to kick off the meal in classic style before pizza with a perfectly thin crust that stays crisp even under pressure from generous toppings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2229%20Spruce%20St.%2C%20Philadelphia%2C%20PA%2C%2019103%2C%20USA"
    pageTitle="Sally"
  />
);
