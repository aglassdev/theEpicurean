...
const Forsythia = () => (
  <RestaurantPage
    ...
    address="233 Chestnut St., Philadelphia, PA, 19106, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+12156449395"
    website="https://www.forsythiaphilly.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For an unabashed, full-steam-ahead celebration of French cooking, look to Chef Christopher Kearse at this relaxed, modern bistro. Cute tile flooring, globe lights and simple tables set the stage for tempura frog legs with saffron aioli, escargot with Pernod-almond butter and yellow corn vichyssoise with crab. Some opt for a seat at the bar in the front for snacks and a drink or two. Open since 2019, the dining room further in offers clear views of the open kitchen, which shows a fine hand with the likes of dry-aged duck and halibut poached in olive oil. To finish, think chocolate mousse or peach and apricot mille-feuille...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=233%20Chestnut%20St.%2C%20Philadelphia%2C%20PA%2C%2019106%2C%20USA"
    pageTitle="Forsythia"
  />
);
