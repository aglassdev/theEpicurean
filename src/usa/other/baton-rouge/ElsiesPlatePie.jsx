...
const ElsiesPlatePie = () => (
  <RestaurantPage
    restaurantName="Elsie's Plate & Pie"
    address="3145 Government St., Baton Rouge, LA, 70806, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+12256365157"
    website="https://elsiespies.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Paul Chauvin Dupré has created an homage to his grandmother with Elsie's Plate & Pie. It's quite casual, with a welcoming and friendly vibe, and it's often crowded, so you'll likely need to wait for a table or sit at the full-service bar. They have a number of offerings but make sure to try their pies—both sweet and savory. Chicken pot pie with peppers in a tasso cream sauce is served in a cast iron skillet for a homey touch and a taste of home, but don't even think about skipping out before enjoying dessert. Can't decide which one to order? Opt for a flight with four varieties...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3145%20Government%20St.%2C%20Baton%20Rouge%2C%20LA%2C%2070806%2C%20USA"
    pageTitle="Elsie's Plate & Pie"
  />
);

export default ElsiesPlatePie;
