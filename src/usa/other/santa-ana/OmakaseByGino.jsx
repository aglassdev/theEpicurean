...
const OmakaseByGino = () => (
  <RestaurantPage
    restaurantName="Omakase by Gino"
    address="304 N. Main St., Santa Ana, 92701, USA"
    cuisine="Japanese, Contemporary"
    priceRange="$$$$"
    phoneNumber="+16572316008"
    website="https://guide.michelin.com/en/california/us-santa-ana/restaurant/omakase-by-gino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Omakase by Gino is nestled amid a sleepy section of downtown Santa Ana but inside, this sushi den is firing on all cylinders. Distressed wood and exposed brick lend a tavern feel while decorative touches are decidedly Japanese. Chef Gino Choi brings palpable joy to this spot with his friendly but focused manner, and the food is just as smile-inducing. Imagine the likes of yuzu cream tucked with a ribbon of crisp Asian pear filled with house-cured ikura or a beautiful fillet of tuna sliced, hit with a flame and set atop an elegant swoosh of garlic and shishito pepper miso. Thick udon noodles are tucked with lobes of creamy uni and a thatch of Italian black summer truffles for a supremely enjoyable (woodsy) bite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=304%20N.%20Main%20St.%2C%20Santa%20Ana%2C%2092701%2C%20USA"
    pageTitle="Omakase by Gino"
  />
);

export default OmakaseByGino;
