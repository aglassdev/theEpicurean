...
const JcHoldway = () => (
  <RestaurantPage
    restaurantName="J.C. Holdway"
    address="501 Union Ave., Knoxville, TN, 37902, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+18653129050"
    website="https://www.jcholdway.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the heart of downtown Knoxville, J.C. Holdway has an appealing contemporary look laced with industrial and vintage elements. Wood floors, exposed ductwork and an open kitchen lend a relaxed sophistication to this restaurant named for Chef Joseph Lenn's late uncle. Tennessee ingredients steal the spotlight in Southern-leaning American dishes like buttermilk biscuits slathered with strawberry jam and topped with braised pork belly and pickle slices. Pasta is a highlight, especially the house-made tagliatelle tossed in a smoky Bolognese made from local favorite Benton's bacon. Finally, a classic pb&j is reworked for dessert as a peanut butter tart tucked with mousse and a layer of strawberry gelee...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=501%20Union%20Ave.%2C%20Knoxville%2C%20TN%2C%2037902%2C%20USA"
    pageTitle="J.C. Holdway"
  />
);

export default JcHoldway;
