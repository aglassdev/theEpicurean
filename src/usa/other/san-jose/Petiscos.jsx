...
const Petiscos = () => (
  <RestaurantPage
    restaurantName="Petiscos"
    address="399 S. 1st St., San Jose, 95113, USA"
    cuisine="Portuguese, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+14083202884"
    website="https://petiscosadega.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Petiscos are as much a cultural reference as they are a small snack accompanied by drinks. They're fun and approachable—designed to be shared among good friends and family—so it goes without saying that this spot, complete with a bar, knows how to welcome guests. Authentically prepared dishes highlight the flavors of Portugal and feature imported ingredients. The rustic, home-style cooking includes favorites such as broa, a traditional cornbread, and lupini beans, codfish croquettes and a tender octopus salad that is a meal unto itself. Slivers of braised pig ears are tossed with a lively citrus and herb dressing and perfectly paired with cilantro and parsley, and the golden-brown grilled sardines are a pleasure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=399%20S.%201st%20St.%2C%20San%20Jose%2C%2095113%2C%20USA"
    pageTitle="Petiscos"
  />
);
