...
const LunaMexicanKitchen = () => (
  <RestaurantPage
    restaurantName="Luna Mexican Kitchen"
    address="1495 The Alameda, San Jose, 95126, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+14083202654"
    website="https://www.lunamexicankitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner Jo Lerma-Lopez’s love for food is clear in every morsel that emerges from this kitchen. The name, which means “moon” in Spanish, is also used as an acronym to reflect the team's ethos of “L(local) U(unrefined) N(natural) A(authentic)” cooking. Dishes are decidedly highbrow, thanks to such special ingredients as Rancho Gordo beans, Mary’s free-range chicken, and everything else made from scratch—chorizo, chicken stock, and sauces galore. Pescatarians revel in coctel de camarones and cod ceviche; while chile relleno picadillo has carnivores returning for more.The vibrant cantina flaunts a full-service bar and open-air patio. Having earned its stripes as a neighborhood darling, it's no wonder that a second sibling is in full swing in Campbell...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1495%20The%20Alameda%2C%20San%20Jose%2C%2095126%2C%20USA"
    pageTitle="Luna Mexican Kitchen"
  />
);

export default LunaMexicanKitchen;
