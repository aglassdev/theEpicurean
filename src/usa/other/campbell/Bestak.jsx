...
const Bestak = () => (
  <RestaurantPage
    restaurantName="Be.Stéak.Ă"
    address="1887 S. Bascom Ave., Campbell, 95008, USA"
    cuisine="Steakhouse, Contemporary"
    priceRange="$$$"
    phoneNumber="+14089632092"
    website="https://www.besteaka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An elegant ambience complements an elevated menu of exceptional steaks and an array of dishes at Chef Jeffrey Stout's newest restaurant, BE.STÉAK.Ӑ, located a minute's walk from his other very popular spot, Orchard City Kitchen. Here, the menu meanders through the Mediterranean before focusing on high-quality and well-prepared steaks and sides. Kicky clams casino substitutes pepperoni for bacon, while rigatoni all'amatriciana delivers another spicy hit, but really, you're here for the meat. Good thing too, since bacon-wrapped filet in a horseradish crema with king oyster mushrooms and finished with a meaty demi-glaze is first rate.  The Sunday Supper menu, featuring four courses for the whole table, is a draw for families and groups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1887%20S.%20Bascom%20Ave.%2C%20Campbell%2C%2095008%2C%20USA"
    pageTitle="Be.Stéak.Ă"
  />
);

export default Bestak;
