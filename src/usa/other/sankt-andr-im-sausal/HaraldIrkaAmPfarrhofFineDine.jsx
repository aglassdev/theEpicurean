...
const HaraldIrkaAmPfarrhofFineDine = () => (
  <RestaurantPage
    restaurantName="Harald Irka am Pfarrhof - Fine Dine"
    address="Im Sausal 1a, Sankt Andrä im Sausal, 8444, Austria"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+436603944628"
    website="https://www.ampfarrhof.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The setting could not be more charming! This wonderful historical rectory, whose foundation walls date back to the 13C, nestles in a tranquil spot overlooked by the parish church. Your dedicated hosts, Lisa Gasser and Harald Irka, run this culinary gem together with their outstanding little team. In the kitchen, the owner and his sous-chef Jan Gollinger strike a beautiful balance and demonstrate precise craftsmanship. The cleverly devised dishes feature contrasts that might be subtle or bold, skilfully combining regional and international ingredients – for example, pike-perch, scallops, courgette, bouillabaisse or Pyrenean lamb, beans, spiced crackers, spinach cream. The surprise menu, which can be booked online as an individual or combination ticket (with wine pairings), is available in a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Im%20Sausal%201a%2C%20Sankt%20Andr%C3%A4%20im%20Sausal%2C%208444%2C%20Austria"
    pageTitle="Harald Irka am Pfarrhof - Fine Dine"
  />
);

export default HaraldIrkaAmPfarrhofFineDine;
