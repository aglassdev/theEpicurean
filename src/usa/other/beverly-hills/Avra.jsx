...
const Avra = () => (
  <RestaurantPage
    restaurantName="Avra"
    address="233 N. Beverly Dr., Beverly Hills, 90210, USA"
    cuisine="Greek, Seafood"
    priceRange="$$$$"
    phoneNumber="+13107340841"
    website="https://theavragroup.com/avra-beverly-hills"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The laid-back luxury of the Greek islands has arrived, thanks to this cavernous beauty that has stolen the hearts of all and sundry. There's a breezy elegance inside; add on a menu of clean and classic flavors and you’ll instantly get the drift. Pull up a chair and be greeted by olives, radishes, and hummus to snack on while perusing the menu. Seafood is supreme, although the Greek salad keeps its promise of crunch and punch. Diners may then select their catch and have it cooked to specification—behold the wonderfully crisp and fleshy St. Pierre (John Dory). Tuna sashimi is a bliss-filled bite, while roasted red pepper with barrel-aged feta proves that vegetables aren't an afterthought. Galactoboureco with orange-lemon syrup is a transporting finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=233%20N.%20Beverly%20Dr.%2C%20Beverly%20Hills%2C%2090210%2C%20USA"
    pageTitle="Avra"
  />
);
