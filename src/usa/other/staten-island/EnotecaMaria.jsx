...
const EnotecaMaria = () => (
  <RestaurantPage
    restaurantName="Enoteca Maria"
    address="27 Hyatt St., Staten Island, 10301, USA"
    cuisine="Italian, International"
    priceRange="$$"
    phoneNumber="+17184472777"
    website="https://www.enotecamaria.com/wp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enoteca Maria is just blocks from St. George Terminal and brought to you by Joe Scaravella, whose cookbook, Nonna’s House, has been earning him (and this tiny gem) much applause. This is the kind of place where the phone is always ringing and it's perpetually packed with guests eager to sample the cooking, which changes nightly depending on which nonnas are cooking. There is a clear adoration for these stars of the show. Expect soul-soothing dishes like Nonna Zoraida from Paraguay's traditional vori vori, a dish of chicken soup with cheese and cornmeal dumplings, shredded chicken, and vegetables. Meanwhile, if Nonna Yumi from Japan is in the kitchen, you'll find a Hokkaido kombu seaweed salad with house-made yuzu-ginger vinaigrette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20Hyatt%20St.%2C%20Staten%20Island%2C%2010301%2C%20USA"
    pageTitle="Enoteca Maria"
  />
);

export default EnotecaMaria;
