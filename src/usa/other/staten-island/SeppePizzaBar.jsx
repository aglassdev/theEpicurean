...
const SeppePizzaBar = () => (
  <RestaurantPage
    restaurantName="Seppe Pizza Bar"
    address="3 Navy Pier Ct., Staten Island, 10304, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+17187273773"
    website="https://www.seppepizzabar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the breezes blowing off the water to the natural light flooding its contemporary-chic space, this Navy Pier dining retreat is a breath of fresh air.First things first—peruse the cocktail menu, where savory and spicy drinks are a welcome alternative to too-sweet swizzles. Order a house spritz or a Negroni, then settle in to review the sprawling menu. Start with one of their fantastic pizzas with beautiful crispy bottoms, such as the unusually delicious Morty pizza, finished with a layer of pistachio-based pesto with mozzarella, and garnished with burrata and slices of mortadella. And while there are so many shareable plates, be sure to save room for their baked wings with a perfect char, or decadent pastas, like the cacio e pepe, both of which deliver on flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Navy%20Pier%20Ct.%2C%20Staten%20Island%2C%2010304%2C%20USA"
    pageTitle="Seppe Pizza Bar"
  />
);

export default SeppePizzaBar;
