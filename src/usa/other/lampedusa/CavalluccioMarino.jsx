...
const CavalluccioMarino = () => (
  <RestaurantPage
    restaurantName="Cavalluccio Marino"
    address="contrada Cala Croce 3, Lampedusa, 92031, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393382755249"
    website="https://www.hotelcavallucciomarino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Imaginative cuisine in a long - established family restaurant, which is constantly updated by each generation. Situated away from the town centre, yet easily accessible, the restaurant boasts an enviable seafront location. Excellent selection of local and international wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Cala%20Croce%203%2C%20Lampedusa%2C%2092031%2C%20Italy"
    pageTitle="Cavalluccio Marino"
  />
);

export default CavalluccioMarino;
