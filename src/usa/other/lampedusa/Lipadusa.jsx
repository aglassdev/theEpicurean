...
const Lipadusa = () => (
  <RestaurantPage
    restaurantName="Lipadusa"
    address="via Bonfiglio 16, Lampedusa, 92010, Italy"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390922970267"
    website="https://guide.michelin.com/en/sicilia/lampedusa/restaurant/lipadusa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of the village, a classic very simple atmosphere for this family run establishment with typical gastronomic dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bonfiglio%2016%2C%20Lampedusa%2C%2092010%2C%20Italy"
    pageTitle="Lipadusa"
  />
);

export default Lipadusa;
