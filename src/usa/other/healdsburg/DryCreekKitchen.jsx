...
const DryCreekKitchen = () => (
  <RestaurantPage
    restaurantName="Dry Creek Kitchen"
    address="317 Healdsburg Ave., Healdsburg, 95448, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+17074310330"
    website="https://drycreekkitchen.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=317%20Healdsburg%20Ave.%2C%20Healdsburg%2C%2095448%2C%20USA"
    pageTitle="Dry Creek Kitchen"
  />
);

export default DryCreekKitchen;
