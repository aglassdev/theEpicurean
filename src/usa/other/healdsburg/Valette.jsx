...
const Valette = () => (
  <RestaurantPage
    restaurantName="Valette"
    address="344 Center St., Healdsburg, 95448, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+17074730946"
    website="https://www.valettehealdsburg.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the former Zin space, this contemporary darling is actually a full-circle comeback for Chef Dustin Valette and his brother/General Manager Aaron Garzini, whose grandfather owned the building in the 1940s. Its current look offers plenty of charm, thanks to dandelion-like light fixtures, concrete walls and horseshoe-shaped banquettes. The bill of fare is modern American with a few French twists. Scallops arrive beneath squid ink puff pastry, into which a server pours caviar-flecked champagne-beurre blanc. Then, Peking-spiced duck breast set atop hearty forbidden rice is taken to the next level with a touch of tamarind sauce. For an appetizing end, dig into the smooth block of chocolate mousse with a luscious salted caramel center...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=344%20Center%20St.%2C%20Healdsburg%2C%2095448%2C%20USA"
    pageTitle="Valette"
  />
);

export default Valette;
