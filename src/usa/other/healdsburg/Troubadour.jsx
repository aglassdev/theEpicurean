...
const Troubadour = () => (
  <RestaurantPage
    ...
    address="381 Healdsburg Ave., Healdsburg, 95448, USA"
    cuisine="French, Californian"
    priceRange="$$$$"
    phoneNumber="+17077563972"
    website="https://www.troubadourhbg.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owners Melissa Yanc and Sean McGaughey worked together at SingleThread (as a baker and sous-chef, respectively), but the married couple left fine dining to forge their own path—though they haven’t strayed too far. This winsome little spot is a sandwich shop and bakery by day (the pair also run popular nearby Quail and Condor), but the creative itch led them to offer an intriguing prix fixe menu at night, interpreting classic French cuisine through a contemporary California lens. Served on gorgeous antique plates that look as though they might have been pillaged from the tomb of Escoffier, the likes of asparagus chartreuse with trout roe and halibut à la Normande with lobster mousseline are especially becoming, and the charming service doesn’t hurt either...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=381%20Healdsburg%20Ave.%2C%20Healdsburg%2C%2095448%2C%20USA"
    pageTitle="Troubadour"
  />
);
