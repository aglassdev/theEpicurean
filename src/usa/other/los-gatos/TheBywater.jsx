...
const TheBywater = () => (
  <RestaurantPage
    restaurantName="The Bywater"
    address="532 N. Santa Cruz Ave., Los Gatos, 95030, USA"
    cuisine="Southern, Creole"
    priceRange="$$"
    phoneNumber="+14085609639"
    website="https://www.thebywaterca.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner David Kinch writes a love letter to the city where he first learned to cook) at this New Orleans-inspired restaurant that feels a bit like a weekend party in the Big Easy. With its zinc bar, pressed ceilings, and open kitchen stacked with bottles of hot sauce, it might just fool you into thinking you’re in the heart of Louisiana—right down to the zydeco and jazz tunes on the stereo.This is a spot so beloved that locals (some even with kids in tow) know to arrive early to sample the special and spicy andouille-flecked gumbo z’herbes; oyster po’boys with white chile sauce; golden-brown hushpuppies; and other Cajun and Creole classics. Dessert pundits will delight in the rich and aromatic chocolate-pecan chess pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=532%20N.%20Santa%20Cruz%20Ave.%2C%20Los%20Gatos%2C%2095030%2C%20USA"
    pageTitle="The Bywater"
  />
);

export default TheBywater;
