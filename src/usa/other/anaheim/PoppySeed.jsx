...
const PoppySeed = () => (
  <RestaurantPage
    restaurantName="Poppy & Seed"
    address="350 S. Anaheim Blvd., Anaheim, 92805, USA"
    cuisine="Southern, American"
    priceRange="$$$"
    phoneNumber="+17146037130"
    website="https://www.poppyandseedoc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/co-owner Michael Reed and co-owner Kwini Reed are behind this gorgeous perch in the Anaheim Packing District. Poppy & Seed epitomizes the SoCal lifestyle with a lounge and bar nestled inside a greenhouse, and outdoor dining surrounded by citrus trees, herbs and flowers. As the setting hints, the focus is on organic, sustainable and locally grown (as well as raised or caught) ingredients. Settle in at sunset or under the stars to enjoy dishes such as creamy Anson Mills grits topped with gravy and plump tail-on shrimp. Charred eggplant puree and pickled sea beans lend a bite to steak tartare, while fried Brussels sprouts are sweet and salty thanks to bacon jam and pomegranate. Juicy strawberries and roasted beets make an earthy-sweet combination that could pull double duty as dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=350%20S.%20Anaheim%20Blvd.%2C%20Anaheim%2C%2092805%2C%20USA"
    pageTitle="Poppy & Seed"
  />
);
