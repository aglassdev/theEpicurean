...
const Aioli = () => (
  <RestaurantPage
    restaurantName="aioli"
    address="7434 S. Dixie Hwy., West Palm Beach, 33405, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+15613667741"
    website="https://aioliwpb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This West Palm Beach spot originally opened in 2014 but since then it's leveled up with an in-house bakery and an open kitchen. The interior isn't fussy, but the all-day dining menu sure does tempt with its array of baked goods and breakfast sandwiches in the morning and soup, salads, and sandwiches at lunch. There's even a sampling of dinner options that are ready to go home and reheat. The menu is updated regularly and there are always specials but if they have the black bean and tomatillo soup, it's a worthy order. The red-tinted broth is loaded with flavor; sided by two slices of house-made sourdough, it's a satisfying meal. The roasted veggie sandwich spread with goat cheese on ciabatta is another winner, but don't leave without a sweet like the bold and bright lemon loaf...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7434%20S.%20Dixie%20Hwy.%2C%20West%20Palm%20Beach%2C%2033405%2C%20USA"
    pageTitle="aioli"
  />
);
