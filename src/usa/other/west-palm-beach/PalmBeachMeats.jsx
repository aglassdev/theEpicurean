...
const PalmBeachMeats = () => (
  <RestaurantPage
    restaurantName="Palm Beach Meats"
    address="4812 S. Dixie Hwy., West Palm Beach, 33405, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+15616237471"
    website="https://palmbeachmeats.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to the heart of West Palm Beach in a contemporary space that's part gourmet market/retailer and part restaurant, Eric and Meghan San Pedro's spot is, no surprise, all about meat. However, it's not just any meat, it's exclusively wagyu, sourced from Japan, Australia, and the U.S. That said, the space is more casual than might be expected with wood tables and caramel leather chairs, plus a tongue-in-cheek Nice to Meat You sign. The small menu spans everything from the ever-popular wagyu burger and cheesesteak to a fried wagyu bologna sandwich. It may be compact, but it's creative, with Filipino-leaning dishes (wagyu lumpia and wagyu tapa over garlic rice with a fried egg and atchara), a wagyu burrito with tots, and even a Nutella brownie made with beef tallow to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4812%20S.%20Dixie%20Hwy.%2C%20West%20Palm%20Beach%2C%2033405%2C%20USA"
    pageTitle="Palm Beach Meats"
  />
);

export default PalmBeachMeats;
