...
const MoodyTongueSushi = () => (
  <RestaurantPage
    restaurantName="Moody Tongue Sushi"
    address="600 Okeechobee Blvd., West Palm Beach, 33401, USA"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+15614949650"
    website="https://www.moodytongue.com/location/moody-tongue-sushi-west-palm-beach/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If beer and omakase seem like odd bedfellows, you obviously haven't been to Moody Tongue Sushi. Located in the Hilton West Palm Beach (check in is even in the lobby), the space has a high-end sushi den vibe complete with dim lighting and rich, dark colors.As for the sushi, it's ambitious yet approachable and leans Western in style (think plenty of garnishes and sauces) with some Floridian flair thrown in for good measure. Madai finished with orange zest is perfectly paired with their Orange Blossom Belgian Blonde, while kinmedai is given a bold kick thanks to torched miso. You won't soon forget that crispy hand roll tucked with torched wagyu and delicate croutons fried in beef tallow—it's excellent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=600%20Okeechobee%20Blvd.%2C%20West%20Palm%20Beach%2C%2033401%2C%20USA"
    pageTitle="Moody Tongue Sushi"
  />
);

export default MoodyTongueSushi;
