...
const GirlTheGoatLosAngeles = () => (
  <RestaurantPage
    restaurantName="Girl & the Goat Los Angeles"
    address="555-3 Mateo St., Los Angeles, 90013, USA"
    cuisine="Contemporary, American"
    priceRange="$$$"
    phoneNumber="+12137994628"
    website="https://girlandthegoat.com/los-angeles/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Stephanie Izard's West Coast offshoot of her wildly popular Chicago original has made its home in downtown LA's Arts District among Spotify's podcast production campus. It's boho chic to a tee with an airy look, soothing linen-color design palette and loads of natural light and potted greenery.Perpetually full and lively, everyone comes here for a good time. Patrons at the bar sip colorful drinks decorated with marigold blossoms while perusing the eclectic menu with the chef's trademark style (read: free-roaming with global inspiration and gutsy flavors). Savory dishes, like roasted oysters and goat curry, feed the evening crowds while über-popular Sunday brunch lures diners with items like the potato crepe, a whimsical riff on the Vietnamese banh xeo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=555-3%20Mateo%20St.%2C%20Los%20Angeles%2C%2090013%2C%20USA"
    pageTitle="Girl & the Goat Los Angeles"
  />
);

export default GirlTheGoatLosAngeles;
