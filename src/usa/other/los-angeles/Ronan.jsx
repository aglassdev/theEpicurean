...
const Ronan = () => (
  <RestaurantPage
    restaurantName="Ronan"
    address="7315 Melrose Ave., Los Angeles, 90046, USA"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+13239175100"
    website="https://www.ronanla.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aim for the two-story floral mural to find this Italian favorite with a dive bar-feel and plenty of LA style. Sit in the lovely patio, or head inside to the black marble bar. Other options include booths as well as an attractive communal table crafted from a varnished wood slab. Diners can expect to see pizza dough stretched, blenders whirring and the wood-fired oven crackling, all of which contribute to Ronan's swank allure.Come for their hand-stretched Neopolitan pizza, as well as their shared plates using seasonal produce and ingredients, with appetizers like their spring arancini with pastrami-spiced maitake with English peas and garlic, or their charred broccolini with their house blend of za'atar, fresh mint, and a Meyer lemon aïoli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7315%20Melrose%20Ave.%2C%20Los%20Angeles%2C%2090046%2C%20USA"
    pageTitle="Ronan"
  />
);

export default Ronan;
