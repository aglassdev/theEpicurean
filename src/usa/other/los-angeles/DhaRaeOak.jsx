...
const DhaRaeOak = () => (
  <RestaurantPage
    restaurantName="Dha Rae Oak"
    address="1106 S. Western Ave., Los Angeles, 90006, USA"
    cuisine="Korean, Duck Specialities"
    priceRange="$$"
    phoneNumber="+13237332474"
    website="https://guide.michelin.com/en/california/us-los-angeles/restaurant/dha-rae-oak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s all about the duck—whole roasted in a clay pot—at this dining delight. And, since the very best things take time, seat-of-the-pants types must know that this platter requires a bit of of planning: order at least a day in advance. However, upon entering this Koreatown gem, one may look forward to being rewarded with a generously portioned dish to dream about for weeks. Stuffed with chestnuts, sweet potatoes, rice and herbs, then wrapped and roasted for hours, the bronzed beauty is plated before your eyes. A spicy dipping sauce and light broth with greens elevates the preparation to epic heights. There's no better way to enjoy this festive feast than with a group, but walk-ins can savor the signature smoked treat, as it's available at all hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1106%20S.%20Western%20Ave.%2C%20Los%20Angeles%2C%2090006%2C%20USA"
    pageTitle="Dha Rae Oak"
  />
);

export default DhaRaeOak;
