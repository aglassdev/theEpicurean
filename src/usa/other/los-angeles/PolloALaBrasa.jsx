...
const PolloALaBrasa = () => (
  <RestaurantPage
    restaurantName="Pollo a la Brasa"
    address="764 S. Western Ave., Los Angeles, 90005, USA"
    cuisine="Peruvian"
    priceRange="$"
    phoneNumber="+12133871531"
    website="https://guide.michelin.com/en/california/us-los-angeles/restaurant/pollo-a-la-brasa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Peruvian in Koreatown? You bet, at least at this family-owned and run spot that has been at it for more than thirty years. Expect a casual neighborhood restaurant that's a touch warm on the inside from the heat of the live-fire cooking. All of the chicken is cooked over a wood fire that you can smell a block away and delivers smoky meat with a crispy skin that's marinated with their family secret. While there are a few options on the menu, make sure that you order the chicken by itself, or choose from their sides, but don't skip their twice-fried French fries and consider ordering a second container of their spicy green aji sauce.The wait times can be a bit long, so call ahead for take-out or wait patiently...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=764%20S.%20Western%20Ave.%2C%20Los%20Angeles%2C%2090005%2C%20USA"
    pageTitle="Pollo a la Brasa"
  />
);

export default PolloALaBrasa;
