...
const OrsaWinston = () => (
  <RestaurantPage
    restaurantName="Orsa & Winston"
    address="122 W. 4th St., Los Angeles, 90013, USA"
    cuisine="Contemporary, Asian"
    priceRange="$$$$"
    phoneNumber="+12136870300"
    website="https://www.orsaandwinston.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A counter and open kitchen showcase the culinary pyrotechnics of Chef Josef Centeno; and the deeply robust prix-fixe flaunts all the fireworks—think peak-season ingredients infused with wide-ranging flavors.The pescatarian menu is inspired by the culinary traditions of Japan and Italy. For starters, thin slices of tuna, flash-seared with sesame seeds and paired with pluots, citrus, and dill aioli, is both bright and balanced. Snapper is cooked impeccably, with crisp golden-brown skin on a bed of sweet corn polenta. Squid ink spaghetti twirled with morsels of Maine lobster, wilted fava greens, peas, toasted pine nuts, and roasted momotaro tomato or the signature satsuki porridge with its moat of parmesan cream and rich Santa Barbara uni are standouts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122%20W.%204th%20St.%2C%20Los%20Angeles%2C%2090013%2C%20USA"
    pageTitle="Orsa & Winston"
  />
);

export default OrsaWinston;
