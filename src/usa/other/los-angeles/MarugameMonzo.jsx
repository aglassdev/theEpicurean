...
const MarugameMonzo = () => (
  <RestaurantPage
    restaurantName="Marugame Monzo"
    address="329 E. 1st St., Los Angeles, 90012, USA"
    cuisine="Japanese, Udon"
    priceRange="$$"
    phoneNumber="+12133469762"
    website="https://www.monrestaurantgroup.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This LA spot is appropriately named, as Marugame is a Japanese town where udon is revered. Here, diners are even privy to these large discs of dough being rolled out, stretched, and cut into deliciously chewy strands. The space is simple, clean, and welcoming, as evident by the groups of friends and families with tots in tow. Come early to put your name down, especially on the weekends, because everyone is here to indulge in these savory and slurp-worthy bowls. One fine example is the mushroom udon infused with miso for an umami-rich base. Other items include the uni and miso carbonara and the crispy-and-creamy agedashi eggplant, along with hot and cold udon choices, bonus toppings, and cold Asahi on tap...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=329%20E.%201st%20St.%2C%20Los%20Angeles%2C%2090012%2C%20USA"
    pageTitle="Marugame Monzo"
  />
);

export default MarugameMonzo;
