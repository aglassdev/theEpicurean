...
const AngeliniOsteria = () => (
  <RestaurantPage
    restaurantName="Angelini Osteria"
    address="7313 Beverly Blvd., Los Angeles, 90036, USA"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+13232970070"
    website="https://www.angelinibeverly.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The delicious cooking at this humble osteria has been drawing crowds for more than two decades—and in a city that rolls out the red carpet for the hottest new thing, that’s no small feat. This simple, authentic charmer is the real deal, right down to the red scarf-bedecked chef in the kitchen as well as those regulars sipping and supping on Italian wines and fresh pasta in the dining room.Though the service brigade leans old school, their generous spirit defies the gruff stereotype. Menu favorites include expertly grilled calamari, linguini with sea urchin and a perfectly authentic tiramisu for dessert. On your way out, be sure to pop into the café next door for a jar or two of Chef Gino Angelini’s sauce and bring the goodness home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7313%20Beverly%20Blvd.%2C%20Los%20Angeles%2C%2090036%2C%20USA"
    pageTitle="Angelini Osteria"
  />
);

export default AngeliniOsteria;
