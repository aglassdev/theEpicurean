...
const YunomiHandroll = () => (
  <RestaurantPage
    restaurantName="Yunomi Handroll"
    address="806 E. 3rd St., Los Angeles, 90013, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$"
    phoneNumber="+12139887076"
    website="https://www.yunomihandroll.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef David Movsisian's Yunomi Handroll is located on a stretch of East 3rd Street that has become a hotbed of terrific restaurants and nightlife, and this cool, inviting spot is certainly keeping up with its neighbors. Inside, it's moody and dark with a pared-down design while the counter is the heartbeat of the operation. It's always buzzing—likely due to its unique offerings. There's nothing cookie cutter about this experience where you'll savor the likes of crispy Brussel sprouts with sweet soy sauce, sesame seeds and Ichimi pepper or rock shrimp tempura tossed in spicy mayo seasoned with shichimi togarashi. A signature for a reason, the Yunomi special handroll marries spicy albacore, shrimp tempura, crunchy onions and truffle soy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=806%20E.%203rd%20St.%2C%20Los%20Angeles%2C%2090013%2C%20USA"
    pageTitle="Yunomi Handroll"
  />
);

export default YunomiHandroll;
