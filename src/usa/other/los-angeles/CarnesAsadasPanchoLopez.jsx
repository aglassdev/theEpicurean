...
const CarnesAsadasPanchoLopez = () => (
  <RestaurantPage
    restaurantName="Carnes Asadas Pancho Lopez"
    address="3328 Pasadena Ave., Los Angeles, 90031, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+16265604842"
    website="https://mypanchito.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Humble doesn’t even begin to describe this open-air restaurant, which has no walls and is seemingly built out of corrugated metal. But what comes out of the kitchen is anything but simple. In quiet Lincoln Heights, find a limited menu that excels in tender, stewed meats and soulful soups. The chef mines the memories of his hometown of Jalisco with carne en su jugo, a superb, meaty soup made from tomatillos, bacon, pinto beans and beef. Birria en consommé is another warming, brothy hit, packing in more delicacy and nuance than the typical effort. There must be tacos, of course, and tortillas are properly made in-house. We’re partial to the barbacoa doused in a fiery tomato salsa. All the while, a small staff welcomes you with infectious enthusiasm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3328%20Pasadena%20Ave.%2C%20Los%20Angeles%2C%2090031%2C%20USA"
    pageTitle="Carnes Asadas Pancho Lopez"
  />
);

export default CarnesAsadasPanchoLopez;
