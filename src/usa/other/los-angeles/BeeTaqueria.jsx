...
const BeeTaqueria = () => (
  <RestaurantPage
    restaurantName="Bee Taqueria"
    address="5754 W. Adams Blvd., Los Angeles, 90016, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+13234529575"
    website="https://guide.michelin.com/en/california/us-los-angeles/restaurant/bee-taqueria"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed.This casual taqueria with serious focus and creative style arrives courtesy of the talented Chef Alex Carrasco (of Scratch Bar and Osteria Mozza fame). Its setting is simple but sweet, with a string of café lights, handful of covered tables, as well as an open-air courtyard outfitted with picnic tables and a blazing fire pit.Tacos, ceviche and tostadas reign supreme on the menu, which draws culinary inspiration from the chef's childhood in Mexico City. Don’t miss the special tender chicken tacos—starring red mole made from bougainvillea and garnished with purple spinach and shaved red onion. If interested in sampling the full scope of this team's talents, opt for the $50 omakase—a taco-heavy tour of flavor combos pulled from...you guessed it...Me..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5754%20W.%20Adams%20Blvd.%2C%20Los%20Angeles%2C%2090016%2C%20USA"
    pageTitle="Bee Taqueria"
  />
);

export default BeeTaqueria;
