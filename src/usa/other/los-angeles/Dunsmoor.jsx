...
const Dunsmoor = () => (
  <RestaurantPage
    restaurantName="Dunsmoor"
    address="3501 Eagle Rock Blvd., Los Angeles, 90065, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber=""
