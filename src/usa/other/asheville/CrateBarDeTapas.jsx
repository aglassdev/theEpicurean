...
const CrateBarDeTapas = () => (
  <RestaurantPage
    restaurantName="Cúrate Bar de Tapas"
    address="13 Biltmore Ave., Asheville, NC, 28801, USA"
    cuisine="Spanish"
    priceRange="$$"
    phoneNumber="+18282392946"
    website="https://curatetapasbar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Spanish-inspired tapas bar lives inside a renovated 1920s bus depot and serves up a menu rooted in tradition—think charcuterie, croquettes, patatas bravas and shareable large plates like mussels and grilled meats. They also have a jamonarea with around six different types of cured meats available. Cozy yet refined. this spot in downtown Asheville makes you want to order a bottle of wine and settle in while snacking on a tabla de quesos, a board with a selection of Spanish cheeses, and curate sobrasada, a pimenton-spiced, spreadable, cured sausage sided by goat cheese and honey with a baguette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20Biltmore%20Ave.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Cúrate Bar de Tapas"
  />
);

export default CrateBarDeTapas;
