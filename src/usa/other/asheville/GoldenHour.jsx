...
const GoldenHour = () => (
  <RestaurantPage
    restaurantName="Golden Hour"
    address="The Radical Asheville, Tapestry Collection by Hilton, 95 Roberts St., Asheville, NC, 28801, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+18284071800"
    website="https://www.goldenhouravl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located at the Radical hotel in Asheville's River Arts District, this red brick structure was originally built in 1923 and was previously a breakfast cereal factory. The space is done up in dark painted exposed brick walls decorated with murals, large windows with views of the French Broad river, tall ceilings, exposed air ducts and an open kitchen.Wood-fired is the dominant feature of this kitchen. Small plates include smoked fish dip accompanied by crunchy seasonal vegetables and house-made matzo; North Carolina crab beignets with Old Bay-seasoned powdered sugar for dusting, or a Girl's Dinner board of cheeses, local meats and pickles. A wood-grilled half chicken or slow-roasted lamb with pita are tempting and comforting large plates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Radical%20Asheville%2C%20Tapestry%20Collection%20by%20Hilton%2C%2095%20Roberts%20St.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Golden Hour"
  />
);
