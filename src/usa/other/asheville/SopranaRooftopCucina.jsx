...
const SopranaRooftopCucina = () => (
  <RestaurantPage
    restaurantName="Soprana Rooftop Cucina"
    address="Embassy Suites Hotel, 192 Haywood St., Asheville, NC, 28801, USA"
    cuisine="Pizza, Italian"
    priceRange="$$"
    phoneNumber="+18283337006"
    website="https://sopranarooftop.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Soprana may be located on the seventh floor of the Embassy Suites hotel, but this is no workhorse hotel dining room. Instead, it has its own distinct character. The large rooftop space is done up with glazed white ceramic tile, dark green accent walls and a glassed-in kitchen. There’s a wrap-around terrace and the hotel’s location commands a great view of the expanse of the Blue Ridge mountains beyond.Pizza is the main event here; prepared in a brick oven and topped with an array of house-made and artisanal embellishments. The Asheville, for instance, has a light, tender and chewy crust and is topped with a generous amount of thinly sliced crisped pepperoni and drizzle of spiced local honey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Embassy%20Suites%20Hotel%2C%20192%20Haywood%20St.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Soprana Rooftop Cucina"
  />
);

export default SopranaRooftopCucina;
