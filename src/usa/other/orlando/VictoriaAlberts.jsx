...
const VictoriaAlberts = () => (
  <RestaurantPage
    restaurantName="Victoria & Albert's"
    address="4401 Floridian Way, Orlando, 32830, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+14079395277"
    website="https://disneyworld.disney.go.com/dining/victoria-and-alberts-overview/"
    tags={[]}
    awards={[
    ...
    pageTitle="Victoria & Albert's"
  />
);

export default VictoriaAlberts;
