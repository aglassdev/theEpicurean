...
const SearSea = () => (
  <RestaurantPage
    restaurantName="Sear + Sea"
    address="14900 Chelonia Pkwy., Orlando, 32821, USA"
    cuisine="Steakhouse"
    priceRange="$$$$"
    phoneNumber="+14077890999"
    website="https://www.marriott.com/hotels/hotel-information/restaurant/mcojb-jw-marriott-orlando-bonnet-creek-resort-and-spa/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This surf and turf retreat lives in the JW Marriott Bonnet Creek. The drive up to the property is dramatic enough; valet services and a McLaren parked out front merely add to the luxury factor.  Make your way through the sleek lobby and past the rowdy bar to arrive at this well-designed space, featuring white marble tables, nooks in neutral hues and an outdoor section with flaming heaters.The menu is as classic as it gets, with twists on locally sourced meats and seafood. A wood-fired grill is responsible for churning out top-grade steaks with chimichurri or béarnaise; while Alaskan King crab may be matched with dill and onion dip. Sides, like potato purée or polenta laced with goat cheese, are almost as decadent as a dessert of s’mores bread pudding.-..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14900%20Chelonia%20Pkwy.%2C%20Orlando%2C%2032821%2C%20USA"
    pageTitle="Sear + Sea"
  />
);

export default SearSea;
