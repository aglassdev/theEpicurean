...
const YhSeafoodClubhouse = () => (
  <RestaurantPage
    restaurantName="YH Seafood Clubhouse"
    address="8081 Turkey Lake Rd., Orlando, 32819, USA"
    cuisine="Chinese, Cantonese"
    priceRange="$$"
    phoneNumber="+14074404979"
    website="https://yhseafoodclubhouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The strip mall environs belie the sweeping elegance of YH Seafood Clubhouse, where several dining spaces beckon guests with a refined tone. There is a full menu from the kitchen, along with an entire page devoted to Cantonese dishes, but the comprehensive selection of dim sum is of particular note. Rather than roaming carts, dishes are ordered, then arrive piping hot. From siu mai and egg tarts to pineapple pork buns, all of the classics are excellent. Sticky pork dumplings are a surprising delight with their crispy-sweet exterior and mochi-like, savory ground pork interior. Served warm, they're a memorable bite. Of course, the best way to enjoy this spot is to come with a group and order with abandon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8081%20Turkey%20Lake%20Rd.%2C%20Orlando%2C%2032819%2C%20USA"
    pageTitle="YH Seafood Clubhouse"
  />
);

export default YhSeafoodClubhouse;
