...
const ZAsian = () => (
  <RestaurantPage
    restaurantName="Z Asian"
    address="1830 E. Colonial Dr., Ste. B, Orlando, 32803, USA"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+14076016024"
    website="https://eatzasian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simple on the outside, this casual gem is beloved for its distinctively bold dishes and thoughtful design. As you enter, you'll notice their name emblazoned on a black wall. Other stylish details include hanging lanterns, ceiling fans and artwork throughout. The aura is Southeast Asian, not unlike the focused Vietnamese cooking.Dishes are flavorful, bursting with nuance and balance. Behold the simple yet sublime dia nho like sautéed bok choy with crispy garlic; and bánh xèo, fried crêpe with shrimp, thinly sliced pork and a tangy fish sauce. Phở tái brings nostalgia to the forefront with that classic beef broth, afloat with rice noodles, eye of round steak and scallions. Donning a host of aromatics (bean sprouts, lime and jalapeño), it is a riot of flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1830%20E.%20Colonial%20Dr.%2C%20Ste.%20B%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Z Asian"
  />
);

export default ZAsian;
