...
const Nami = () => (
  <RestaurantPage
    restaurantName="Nami"
    address="6004 Artist Ave., Orlando, 32827, USA"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+14073954857"
    website="https://www.namilakenona.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set within the Lake Nona Wave Hotel, Nami makes a splash with its lofted ceilings and sexy vibe. There are two distinct dining experiences here: a dining room spotlighting contemporary Japanese cuisine (think skewers and maki) and a chef's counter tasting menu presenting a creative interpretation of Japanese cuisine. On the tasting, discover the likes of citrus-cured buri with yuzu-cured flying fish roe or a decadent riff on a corndog with caviar and triple cream Brie enhanced bechamel. Beef and broccoli, that Chinese-American staple, is given the luxe treatment with grilled wagyu and broccoli served four ways. À la carte standouts include barbecue unagi over rice and the dojima roll, a tender sponge cake roulade filled with whipped cream and glazed with mango gel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6004%20Artist%20Ave.%2C%20Orlando%2C%2032827%2C%20USA"
    pageTitle="Nami"
  />
);
