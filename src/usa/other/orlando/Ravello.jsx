...
const Ravello = () => (
  <RestaurantPage
    restaurantName="Ravello"
    address="10100 Dream Tree Blvd., Orlando, 32836, USA"
    cuisine="Italian"
    priceRange="$$$"
