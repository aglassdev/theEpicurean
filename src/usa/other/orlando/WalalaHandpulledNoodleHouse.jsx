...
const WalalaHandpulledNoodleHouse = () => (
  <RestaurantPage
    restaurantName="Walala Hand-Pulled Noodle House"
    address="5062 W. Colonial Dr., #120, Orlando, 32808, USA"
    cuisine="Chinese"
    priceRange="$$"
    phoneNumber="+14072865478"
    website="https://walalaasiannoodlehouse.toast.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's not just a name at this spot run by a father-daughter duo—it's a promise. It's all about Lanzhou-style hand-pulled noodles here, where counter seats face a glass-enclosed kitchen displaying bubbling broths and noodles being pulled. A massive bowl of savory, clear broth tangled with noodles and tender beef shank is a house classic; add Chinese pickles for an extra pop of flavor. Sub beef short rib for the shank and you'll discover another signature dish or opt for the dry-style noodles with ground pork and peanuts. While you're here for the noodles, there are plenty of other tempting options, including pan-fried dumplings and buns, and if you're lucky, Chinese fried dough with warm soy milk for dipping...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5062%20W.%20Colonial%20Dr.%2C%20%23120%2C%20Orlando%2C%2032808%2C%20USA"
    pageTitle="Walala Hand-Pulled Noodle House"
  />
);

export default WalalaHandpulledNoodleHouse;
