...
const ToriTori = () => (
  <RestaurantPage
    restaurantName="Tori Tori"
    address="720 N. Mills Ave., Orlando, 32803, USA"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber=""
    website="https://www.toritoripub.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded by Sean “Sonny” Nguyen, this Mills District concept is a classic izakaya offering bar bites, yakitori, as well as sake and creative libations. Unlike its sibling (Domu), this menu is varied and the trendy space is especially cutting-edge. Its name is painted on the side of the building and there's parking behind the restaurant. If that doesn't draw crowds from afar, the eclectic vibe and focused dishes certainly will. Start with skewers before moving on to grilled lamb chops, elevated with a mint-yogurt sauce, cherry tomatoes and diced cucumbers. A mound of fragrant fried rice may then show up mixed with sweet crab, notes of savory garlic and lemon essence.Reservations are not accepted, so arrive early or risk waiting in line...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=720%20N.%20Mills%20Ave.%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Tori Tori"
  />
);

export default ToriTori;
