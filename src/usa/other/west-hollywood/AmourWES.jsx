...
const AmourWES = () => (
  <RestaurantPage
    ...
    address="8715 Beverly Blvd., West Hollywood, 90048, USA"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+14244316717"
    website="https://www.amourweho.love/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Indoors or out? It's the eternal question in Los Angeles, but even more difficult to decide at Amour. Banquettes and booths beckon on the patio, while the dining room, accessed through a library stacked with vintage books, is loaded with charm down to the very last candlestick. Multicourse tasting menus are on offer or order à la carte from a menu that blends French and Asian influences, as in chawanmushi with Perigord truffles and trout roe. New Caledonia blue prawn carpaccio and a French-style omelet with a quenelle of caviar and Comté foam are just two of the well-executed dishes. Wagyu sided by crispy matchstick potatoes is given a hint of sweetness courtesy of a swirl of beet puree, while millefeuille with dulce de leche brings it all home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8715%20Beverly%20Blvd.%2C%20West%20Hollywood%2C%2090048%2C%20USA"
    pageTitle="Amour"
  />
);

export default AmourWES;
