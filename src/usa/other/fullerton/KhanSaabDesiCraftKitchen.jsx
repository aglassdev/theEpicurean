...
const KhanSaabDesiCraftKitchen = () => (
  <RestaurantPage
    restaurantName="Khan Saab Desi Craft Kitchen"
    address="229 E. Commonwealth Ave., Ste. A, Fullerton, 92832, USA"
    cuisine="Pakistani, Indian"
    priceRange="$$"
    phoneNumber="+17148531081"
    website="https://www.khansaaboc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This South Asian gem makes a splash on this quiet stretch that teems with Mex-American eateries and markets aplenty. Originally from Pakistan, Chef Imran Ali Mookhi displays a certain deftness with spices, flavors and in his handling of red meat. Chicken, fish and vegetarian items are on offer, but there's no denying that beef is king on this menu.The décor is bright, neat and hip. A bar in the back pours craft mocktails that pair swimmingly with such memorable items as beef (sirloin) kebabs with mustard oil, yogurt and garlic. Signature dishes like Khan biryani and chicken Karahi score high on flavor and texture. Australian Wagyu and Tomahawk steak will thrill carnivores; while seasonal vegetables have locavores returning for more...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=229%20E.%20Commonwealth%20Ave.%2C%20Ste.%20A%2C%20Fullerton%2C%2092832%2C%20USA"
    pageTitle="Khan Saab Desi Craft Kitchen"
  />
);

export default KhanSaabDesiCraftKitchen;
