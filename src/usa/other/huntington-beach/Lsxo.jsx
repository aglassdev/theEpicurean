...
const Lsxo = () => (
  <RestaurantPage
    restaurantName="LSXO"
    address="21010 Pacific Coast Hwy., Huntington Beach, 92648, USA"
    cuisine="Vietnamese, Contemporary"
    priceRange="$$$"
    phoneNumber="+17143740083"
    website="https://www.lsxohb.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Across from beautiful Huntington Beach, find this not-so-secret speakeasy tucked inside its parent restaurant, Bluegold, where it's difficult to avoid staring at the Pacific views. But the difference is palpable—LSXO is a bit cooler, louder and has a more defined personality. There are so many terrific dishes on offer that it's hard to go wrong and helpful servers will always steer you in the right direction. Don't miss the savory pork, shrimp and crab dumplings served alongside an incendiary, peanut-loaded black vinegar dressing. Then, a big steaming bowl of cháo loaded with crab, salted cod, white fish and egg whites, is silky and delicious.Getting a seat here can be tough, but good food makes this so much more than just a scene...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21010%20Pacific%20Coast%20Hwy.%2C%20Huntington%20Beach%2C%2092648%2C%20USA"
    pageTitle="LSXO"
  />
);
