...
const SaltSmokehouse = () => (
  <RestaurantPage
    restaurantName="Salt Smokehouse"
    address="1300 Meridian St., D-104, Huntsville, AL, 35801, USA"
    cuisine="Barbecue, Fusion"
    priceRange="$"
    phoneNumber="+12562613360"
    website="https://saltssmokehouse.toast.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the sparkling Lincoln Mill district, this family-owned barbecue spot is out to satisfy. High ceilings, white walls and ample seating make for a Spartan vibe. The menu, by contrast, is full of personality, as it pulls global inspiration from all over, starting with a roster of hearty appetizers like brisket fritters with chihuahua cheese or fried soft-shell crab bao sliders. Sandwiches and burgers also tempt, but for the purists among us, stick with the fundamentals. A fatty slice of prime-grade smoked brisket cooked overnight cuts like custard and doesn’t need a lick of sauce. Soft, tender pulled pork is another winning order, along with creative sides like ginger serrano coleslaw or fried Brussel sprouts with hot honey and yuzu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1300%20Meridian%20St.%2C%20D-104%2C%20Huntsville%2C%20AL%2C%2035801%2C%20USA"
    pageTitle="Salt Smokehouse"
  />
);

export default SaltSmokehouse;
