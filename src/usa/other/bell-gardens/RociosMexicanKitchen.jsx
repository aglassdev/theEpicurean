...
const RociosMexicanKitchen = () => (
  <RestaurantPage
    restaurantName="Rocio's Mexican Kitchen"
    address="7891 Garfield Ave., Bell Gardens, 90201, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$"
    phoneNumber="+15626597800"
    website="https://rocios-mexican-kitchen.restaurants-world.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mexican restaurants are lucky if they can pull off one good mole sauce. Chef Rocio Camacho offers more than 10 great ones in this humble Bell Gardens outpost that has little in the way of décor. Indeed, they don’t call her the The Goddess of Mole for nothing. From the dark-as-night Oaxaqueno to the spicy-sweet manchamanteles to the vibrant verde, moles here are layered, sophisticated efforts that come paired with your choice of chicken, fish, shrimp, steak or even a massive chile relleno. On a menu that covers a lot of territory, stick to this signature dish, which arrives overly generous in size. Otherwise, a warm basket of chips laced with a handful of sauces and a plate of zucchini blossom empanadas will position you well for the main event...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7891%20Garfield%20Ave.%2C%20Bell%20Gardens%2C%2090201%2C%20USA"
    pageTitle="Rocio's Mexican Kitchen"
  />
);

export default RociosMexicanKitchen;
