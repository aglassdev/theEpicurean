...
const ZhiWeiCafe = () => (
  <RestaurantPage
    restaurantName="Zhi Wei Cafe"
    address="104 South St., Boston, MA, 02111, USA"
    cuisine="Chinese"
    priceRange="$"
    phoneNumber="+18572770937"
    website="https://www.zhiweicafeboston.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On a quiet street in the Leather District, this friendly Chinese restaurant specializes in Lanzhou-style hand-pulled noodles. A constant whack and thud rings out from the kitchen, as chefs make the noodles all throughout the day. The signature beef noodle soup delivers handsomely with a deep, soulful broth, tender slices of beef and daikon, and a slick layer of chili oil for bittersweet heat. Stir-fried noodles are also worth an order...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=104%20South%20St.%2C%20Boston%2C%20MA%2C%2002111%2C%20USA"
    pageTitle="Zhi Wei Cafe"
  />
);

export default ZhiWeiCafe;
