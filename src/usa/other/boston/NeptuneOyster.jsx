...
const NeptuneOyster = () => (
  <RestaurantPage
    ...
    cuisine="Seafood"
    priceRange="$$$"
    phoneNumber="+16177423474"
    website="https://www.neptuneoyster.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the North End, Neptune Oyster features a dark blue facade with a large window revealing oysters displayed on a bed of crushed ice overseen by a blue aproned shucker in perpetual motion. The cozy setting is just short of boisterous, but it's charming. The narrow interior has mosaic tiled flooring, a slender white marble winding along the side of the room, and a red leather banquette on the opposite wall. The day's oysters are presented on a small card, and on the wood-framed, wall-mounted mirror.Keep it simple, as in some briny bivalves, a New England-style fritto misto sandwich on locally baked brioche and a nice bottle of wine picked from the thoughtfully curated list highlighting labels from European coastal regions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=63%20Salem%20St.%2C%20%231%2C%20Boston%2C%20MA%2C%2002113%2C%20USA"
    pageTitle="Neptune Oyster"
  />
);

export default NeptuneOyster;
