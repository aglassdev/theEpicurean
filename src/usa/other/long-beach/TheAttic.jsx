...
const TheAttic = () => (
  <RestaurantPage
    ...
    address="3441 E. Broadway, Long Beach, CA, 90803, USA"
    cuisine="Southern"
    priceRange="$$"
    phoneNumber="+15624330153"
    website="https://www.theatticonbroadway.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner Steve Massis and Chef Cameron Slaugh are responsible for this Craftsman-style house in bustling Long Beach. The bungalow façade gives way to a front porch and fittingly homey interior, featuring a collection of rooms. In the first, there's a brick fireplace and herringbone-style floors; another, set to the left, highlights floral wallpaper and black-and-white tiles.These plates are gorgeous and decidedly Southern, but not without a twist or two, as in bubble and squeak or roasted cauliflower with cracked oats. Fried chicken and biscuits are at the heart of the carte, along with gumbo and fried green tomatoes. Peach salad is a nice way to start, especially if you plan to end over powdered sugar beignets with strawberry compote...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3441%20E.%20Broadway%2C%20Long%20Beach%2C%20CA%2C%2090803%2C%20USA"
    pageTitle="The Attic"
  />
);

export default TheAttic;
