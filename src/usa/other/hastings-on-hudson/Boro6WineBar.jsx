...
const Boro6WineBar = () => (
  <RestaurantPage
    restaurantName="Boro6 Wine Bar"
    address="549 Warburton Ave., Hastings-on-Hudson, 10706, USA"
    cuisine="Contemporary, Italian"
    priceRange="$$"
    phoneNumber="+19142319200"
    website="https://www.boro6winebar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Westchester is clearly upping its culinary game and attracting real talent. Case in point: this gleaming gem of a spot, headed by Paul DiBari. A citywide mover and shaker, he is spearheading this contemporary, focused kitchen and stellar beverage selection.Find a seat at the marble bar and watch the magic unfold. Soft jazz fills the air, as highly civilized servers deliver your fare. Hand-cut maltagliati with ricotta, tomatoes and basil; brasato di spalla di manzo braised in red wine with mascarpone polenta; or rillettes de cochon with pork confit are just some of the feats. The blood orange-olive oil cake is a rich finale; teas from Bel­locq Tea Atelier are less decadent but dazzling all the same...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=549%20Warburton%20Ave.%2C%20Hastings-on-Hudson%2C%2010706%2C%20USA"
    pageTitle="Boro6 Wine Bar"
  />
);

export default Boro6WineBar;
