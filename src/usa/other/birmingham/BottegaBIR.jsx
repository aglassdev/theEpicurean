...
const BottegaBIR = () => (
  <RestaurantPage
    ...
    address="2240 Highland Ave. S., Birmingham, AL, 35205, USA"
    cuisine="Italian, Southern"
    priceRange="$$$"
    phoneNumber="+12059391000"
    website="https://bottegarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a good reason why reservations are sparse at Frank and Pardis Stitt’s long-standing Bottega. The historic, neo-classical Beaux-Arts building stands out in Birmingham's Southside neighborhood, and eager, sharply dressed guests wait outside for doors to open. Some find seats at the bar; others settle into an elegantly cut dining room fit with dark wood walls and high ceilings. Prepared with confidence, the menu paints broad strokes with its Italian-Mediterranean bent. Think parmesan souffle, wobbly and just set, or sweet potato gnocchi with rock shrimp. Wherever you sit, warm, polished servers ensure a welcoming experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2240%20Highland%20Ave.%20S.%2C%20Birmingham%2C%20AL%2C%2035205%2C%20USA"
    pageTitle="Bottega"
  />
);

export default BottegaBIR;
