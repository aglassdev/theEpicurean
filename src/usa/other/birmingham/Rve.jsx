...
const Rve = () => (
  <RestaurantPage
    restaurantName="Rêve"
    address="1821 2nd Ave. N., Ste. 176, Birmingham, AL, 35293, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+12055934154"
    website="https://www.reve-hautepaysan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a discreet corner of Birmingham’s Pizitz Food Hall, Chef Jacob Stull runs this modern dining room decorated in handsome blues and whites. Some walk-ins snag a seat at the bar and order à la carte. Others settle into the booths for a much more involved, French-inspired tasting menu. Brioche-crusted salmon with lemon beurre blanc is classic in style while the prime ribeye marinated in banana vadouvan miso shows a more adventurous side. While some moments have more style than substance, the kitchen’s penchant for risk-taking is noteworthy. An upbeat playlist, along with relaxed, attentive service, makes for a welcome, starch-less experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1821%202nd%20Ave.%20N.%2C%20Ste.%20176%2C%20Birmingham%2C%20AL%2C%2035293%2C%20USA"
    pageTitle="Rêve"
  />
);
