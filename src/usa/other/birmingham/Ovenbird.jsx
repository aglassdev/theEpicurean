...
const Ovenbird = () => (
  <RestaurantPage
    restaurantName="OvenBird"
    address="2810 3rd Ave. S., Birmingham, AL, 35233, USA"
    cuisine="Spanish, Latin American"
    priceRange="$$"
    phoneNumber="+12059576686"
    website="https://www.ovenbirdrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the parking lot, you can smell the sweet smoke that billows out of the restaurant’s two roaring, wood-burning ovens. In what feels like a backyard oasis fit with a spacious patio, find a hazy, sun-lit dining room where Chef Chris Hastings pulls inspiration from Spain and Latin America. Much of the food is cooked in cast-iron skillets. From Spanish omelets dotted with chorizo vinaigrette to charred empanadas to finely-seared scallops set in ajo blanco sauce, the tapas-style menu does not shy away from flavor and is fully designed for sharing. For dessert, spiced molasses crème brûlée makes for a sweet send-off...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2810%203rd%20Ave.%20S.%2C%20Birmingham%2C%20AL%2C%2035233%2C%20USA"
    pageTitle="OvenBird"
  />
);

export default Ovenbird;
