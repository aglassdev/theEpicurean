...
const CurrentCharcoalGrill = () => (
  <RestaurantPage
    restaurantName="Current Charcoal Grill"
    address="1625 2nd Ave. S., Birmingham, AL, 35233, USA"
    cuisine="Asian, Fusion"
    priceRange="$$$"
    phoneNumber="+12058291625"
    website="https://www.currentcharcoalgrill.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Could these ceilings be any higher? In this expansive warehouse, find dark hardwood floors, oversized booths and banquettes, and near-endless counter seating looking straight into the kitchen. This serious, larger-than-life operation by Chefs Adam Evans and Luke Joseph pulls inspiration from across Asia and prepares its best dishes on the hot grill. Find Thai, Korean and Chinese flavors in the likes of shrimp and chicken wontons, red snapper with charred sticky rice, Iberico pork with nam prik and crushed peanuts, and short rib bo ssam. Cocktails pull from a similar range of flavors. Portions are generous so you’ll need friends if you have any intention of making it to dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1625%202nd%20Ave.%20S.%2C%20Birmingham%2C%20AL%2C%2035233%2C%20USA"
    pageTitle="Current Charcoal Grill"
  />
);

export default CurrentCharcoalGrill;
