...
const OneSevenEightNineWAS = () => (
  <RestaurantPage
    restaurantName="1789"
    address="1226 36th St. NW, Washington, 20007, USA"
    ...
    bio="Few restaurants embody this neighborhood more aptly than 1789, named for the year Georgetown University was founded. A de-facto reservation for students and their visiting parents, this historic Federal period townhouse is a quaint labyrinth of six dining rooms spread across three floors. Each is imbued with a sense of history and pedigree—and all under the watchful gaze of veteran servers who are effortlessly in control.The kitchen team is adept, talented, and successfully keeps pace. Dishes lean on classic French and American flavors. Recent highlights included a warm vichyssoise with leeks, morels, and watercress pesto; rack of lamb with a lemon gremolata and roasted cipollini onions with fava beans; and, to finish, an apple Paris-Brest with buttermilk ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1226%2036th%20St.%20NW%2C%20Washington%2C%2020007%2C%20USA"
    pageTitle="1789"
  />
);

export default OneSevenEightNineWAS;
