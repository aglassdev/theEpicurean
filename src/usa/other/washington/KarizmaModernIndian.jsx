...
const KarizmaModernIndian = () => (
  <RestaurantPage
    restaurantName="Karizma Modern Indian"
    address="611 I St. NW, Washington, DC, 20001, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$"
    phoneNumber="+12028980393"
    website="https://www.karmamodernindian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's now one address with two distinctive concepts at this Penn Quarter restaurant, though all eyes should be on Karizma, in the main dining space, where fans of the original restaurant will find all of their favorites (book separately for a tasting menu at Karma, located in a smaller, separate room). Don't overlook the imaginative drinks, both spirit-based and alcohol-free, like the Tiger's Tail made with blood orange, turmeric and chili water. Expect authentic, traditional cooking that reflects the range of Indian cuisine. Naan here is a cut above the norm, as in the wild mushroom with a hint of truffle. The use of top ingredients shines through in the elegant, rich and flavorful paneer lajawab...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=611%20I%20St.%20NW%2C%20Washington%2C%20DC%2C%2020001%2C%20USA"
    pageTitle="Karizma Modern Indian"
  />
);

export default KarizmaModernIndian;
