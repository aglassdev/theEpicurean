...
const TokiUnderground = () => (
  <RestaurantPage
    restaurantName="Toki Underground"
    address="1234 H St. NE, Washington, 20002, USA"
    cuisine="Japanese, Ramen"
    priceRange="$"
    phoneNumber="+12023883086"
    website="https://www.tokiunderground.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll go up the stairs, not down to Toki Underground, which shares the same front door as The Pug Bar. Once inside, notice raw wood beams, walls plastered with stickers and scribble, as well as dangling Christmas lights. No longer requiring a queue, it's strictly reservations only here, where counter seats turn quickly and you have slightly more than one hour to slurp to your heart's content. Fried chicken steamed buns, delicately fried enoki mushrooms, or pork dumplings are a good way to start things off, but it's really all about ramen. There are five selections, all freshly made and bursting with flavor. Go big and add extras to pump up your bowl but whatever you do, end your meal with a light yuzu custard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1234%20H%20St.%20NE%2C%20Washington%2C%2020002%2C%20USA"
    pageTitle="Toki Underground"
  />
);

export default TokiUnderground;
