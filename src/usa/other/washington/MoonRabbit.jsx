...
const MoonRabbit = () => (
  <RestaurantPage
    restaurantName="Moon Rabbit"
    address="927 F St. NW, Washington, 20002, USA"
    cuisine="Vietnamese"
    priceRange="$$$"
    phoneNumber="+12025251446"
    website="https://www.moonrabbitdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kevin Tien's highly popular Moon Rabbit hopped across town to a bright and contemporary space on F Street. The crowd's all here for Chef Tien's creative cooking, a mash-up of his Cajun Louisiana and Vietnamese roots. There's a real flair seen in reimagined classics like mochi beignets with freshwater eel. Solid ingredients and the twists on tradition hit all the right notes, as in the fried quail filled with duck sausage served over crispy tomato rice with clementine mustard. Dessert is equally memorable, especially the vegan pandan panna cotta tucked with Okinawa seaweed and surrounded by chocolate cookie crumble. It's a surprising balance of sweet and savory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=927%20F%20St.%20NW%2C%20Washington%2C%2020002%2C%20USA"
    pageTitle="Moon Rabbit"
  />
);
