...
const Maketto = () => (
  <RestaurantPage
    restaurantName="Maketto"
    address="1351 H St. NE, Washington, 20002, USA"
    cuisine="Asian"
    priceRange="$$"
    phoneNumber="+12028389972"
    website="https://maketto1351.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Credit to chef-owner Erik Bruner-Yang and his team for keeping it fresh, as it were. On ever-changing H Street, this long-favored restaurant at first looks like a clothing store with its glittering display cases lined with chic merch. More impressive, though, is what’s on the menu: A diverse, ambitious, and consistently satisfying roster of dishes inspired by flavors from across Asia. Everything here is designed to share, starting with Cantonese-style shrimp dumplings dressed in Cambodian fish sauce and garnished with dill. What’s next? A Thai-spicy riff on pork laab with bone marrow? An imposing boulder of crispy fried chicken laced in five-spice caramel? There are no rules, no borders, in this house, and diners wouldn’t want it any other way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1351%20H%20St.%20NE%2C%20Washington%2C%2020002%2C%20USA"
    pageTitle="Maketto"
  />
);

export default Maketto;
