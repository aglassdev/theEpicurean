...
const LaTejana = () => (
  <RestaurantPage
    restaurantName="La Tejana"
    address="3211 Mt. Pleasant St. NW, Washington, 20010, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+12026218509"
    website="https://www.latejanadc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There isn’t a morning that can’t be made or a long night that can’t be undone thanks to Ana-Maria Jaramillo and Gus May. Once a pop-up, their cooking has found a home wedged in a strip of restaurants in Mt. Pleasant. Quick and efficient, this simple counter serves just coffee and a handful of tacos mined from a time living in Texas. Their breakfast tacos offer a singular kind of satisfaction, each one made with a superb flour tortilla kept warm in tightly wrapped foil. Fillings include soft scrambled eggs, creamy pinto beans, queso and meats like bacon, chorizo and even brisket. These are uncomplicated, unfussy bundles of joy that don’t take reservations or require any other kind of long-term planning. The team is working on expanding upstairs soon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3211%20Mt.%20Pleasant%20St.%20NW%2C%20Washington%2C%2020010%2C%20USA"
    pageTitle="La Tejana"
  />
);

export default LaTejana;
