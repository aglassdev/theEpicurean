...
const SevenReasons = () => (
  <RestaurantPage
    restaurantName="Seven Reasons"
    address="931 H St. NW, Washington, 20001, USA"
    cuisine="Latin American"
    priceRange="$$$$"
    phoneNumber="+12024178563"
    website="https://www.sevenreasonsdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are more than seven reasons to visit this gorgeous bi-level restaurant and good looks are certainly one. The food also makes a splash, thanks to an ambitious menu of dishes from Venezuela, Peru and the Caribbean, prepared in the bright, open kitchen. Their creations are generously portioned and pack a punch. Patacón piña colada reveals slices of fried green plantains topped with pickled pineapple, shredded coconut and a variety of sauces like cilantro mojo and caper mayo. Garnished with purple leafy vegetables, the dish is a burst of color and flavor. Save room for the delicious desserts like the cacao and Laurel dark chocolate basil crumble with milk chocolate cremeux, bay leaves ice cream and quinoa tuile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=931%20H%20St.%20NW%2C%20Washington%2C%2020001%2C%20USA"
    pageTitle="Seven Reasons"
  />
);
