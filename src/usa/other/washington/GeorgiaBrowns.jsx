...
const GeorgiaBrowns = () => (
  <RestaurantPage
    restaurantName="Georgia Brown’s"
    address="950 15th St. NW, Washington, 20005, USA"
    cuisine="Southern, American"
    priceRange="$$$"
    phoneNumber="+12023934499"
    website="https://www.gbrowns.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This revered dining fixture draws a diverse crowd—from locals and politicos to celebrities and tourists. Everyone is here for the classic Southern cooking that is likely to conjure up many a nostalgic memory. Light walls, bronze accents and tropical greenery give the place a bright and fresh feel, but clearly it's all about the food, with a menu that reads like a delicious lesson in history and culture.Start off with the fried chicken livers accompanied by a mustard-soy emulsion. Then tuck into a steaming and fragrant bowl of Carolina gumbo floating with chicken, andouille, okra and shrimp. Cap it all off with a thick wedge of red velvet cake. If you're thinking Low Country cooking in the heart of the Capitol, you're starting to get the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=950%2015th%20St.%20NW%2C%20Washington%2C%2020005%2C%20USA"
    pageTitle="Georgia Brown’s"
  />
);

export default GeorgiaBrowns;
