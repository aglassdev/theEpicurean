...
const TheRedHen = () => (
  <RestaurantPage
    restaurantName="The Red Hen"
    address="1822 1st St. NW, Washington, 20001, USA"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+12025253021"
    website="https://theredhendc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll want to wake up with the rooster to score a reservation at this rustic Italian gem as it’s always packed. Walk-ins can snag a seat at the three-sided bar that anchors the room, decked out in full country charm with exposed brick walls, reclaimed timber, and beamed ceilings. What’s so special, you ask? The food, of course! Order the arancini di primavera, or crispy risotto fritters with asparagus in a Béarnaise aioli. Pastas are spot on, like the crowd-favorite mezzi rigatoni with a garlicky, fennel sausage ragu finished with a healthy dusting of pecorino romano. Entrées like grilled short rib or scallops with pickled chili aïoli are also exquisite, but don't skip dessert, especially the sticky toffee pudding with eggnog gelato...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1822%201st%20St.%20NW%2C%20Washington%2C%2020001%2C%20USA"
    pageTitle="The Red Hen"
  />
);

export default TheRedHen;
