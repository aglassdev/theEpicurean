...
const DearSushiAtLoveMakoto = () => (
  <RestaurantPage
    restaurantName="Dear Sushi at Love, Makoto"
    address="200 Massachusetts Ave., NW, Ste.150, Washington, 20001, USA"
    cuisine="Sushi, Japanese Contemporary"
    priceRange="$$$"
    phoneNumber="+12029927730"
    website="https://www.lovemakoto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Are you ready for the toughest decision of your night? At Chef Makoto Okuwa's Love, Makoto, three unique concepts await under one very beautiful roof. You can't go wrong with any of the choices, but Dear Sushi is certainly a winner. This is omakase and à la carte minus the sticker shock, but the price point isn't the only thing that delights diners. Opening snacks, handrolls, nigiri prepared in traditional and new ways—it's all here and it's all delectable. Tokoroten noodles in tomato water hit with sudachi, ginger and topped with fragrant shiso flowers, make for a refreshing treat, and nigiri highlights include akami with burnt negi miso and foie gras, or hamachi with smoked ponzu and chili paste. However, it's the ichigo, or strawberry, served over a cookie base, that seals the deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20Massachusetts%20Ave.%2C%20NW%2C%20Ste.150%2C%20Washington%2C%2020001%2C%20USA"
    pageTitle="Dear Sushi at Love, Makoto"
  />
);

export default DearSushiAtLoveMakoto;
