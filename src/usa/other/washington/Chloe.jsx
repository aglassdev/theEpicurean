...
const Chloe = () => (
  <RestaurantPage
    ...
    address="1331 4th St. SE, Washington, 20003, USA"
    cuisine="International, American"
    priceRange="$$$"
    phoneNumber="+12023137007"
    website="https://restaurantchloe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked into the trendy Navy Yard district, Chloe’s menu is eclectic, deeply personalized and reflects Chef Haidar Karoum's diverse resume. The shareable plates menu gathers ingredients from across the globe, presenting them in original and consistently delicious ways.Kick off with the likes of hamachi crudo augmented by fish sauce, Thai chilies and thin slabs of avocado; or spiced veal hummus topped with buttered almond slivers and accompanied by fresh-baked naan. For something more hearty, there's penne with a pork ragù that's imbued with a Spanish-style soffrito and loads of domestic pecorino. Close with a cheese plate or salted pecan-oatmeal cookies—and worry about your waistline later...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1331%204th%20St.%20SE%2C%20Washington%2C%2020003%2C%20USA"
    pageTitle="Chloe"
  />
);
