...
const ResidentsCafeBar = () => (
  <RestaurantPage
    restaurantName="Residents Cafe & Bar"
    address="1306 18th St. NW, Washington, 20036, USA"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+12023734748"
    website="https://www.residentsdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A large greenery-donning patio out front greets diners to this cafe, set within a black-painted row house. The space, spread over two levels, is thoroughly charming, thanks to a bar lined with mid-century modern stools, exposed brick and plush seats. Edison bulbs and white hexagon floor tiles simply enhance the vintage vibe. The menu underscores an array of contemporary plates with Middle Eastern and European elements. Imagine Turkish eggs at brunch; smoked heirloom baby carrots with harissa and pistachio dukkah; and chicken schnitzel with a salad of romaine hearts, charred corn and tomatoes in a herb dressing at night. A classic and perfect Basque cake dusted with ras el hanout is matched only by a Caribbean coffee cocktail with aged rum...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1306%2018th%20St.%20NW%2C%20Washington%2C%2020036%2C%20USA"
    pageTitle="Residents Cafe & Bar"
  />
);

export default ResidentsCafeBar;
