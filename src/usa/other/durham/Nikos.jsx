...
const Nikos = () => (
  <RestaurantPage
    restaurantName="Nikos"
    address="905 W. Main St., Unit 21B, Durham, NC, 27701, USA"
    cuisine="Greek"
    priceRange="$$"
    phoneNumber="+19199080189"
    website="https://www.nikosdurham.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nikos, named for the owner's father, is set within a restored red-brick tobacco storage warehouse dating to the early 1900s. The interior plays up that rustic industrial heritage and blends it with a simple sophistication, sharing a modern tavern appeal. As for the food, expect all of the Greek and Mediterranean classics, including spanakopita and octopus carpaccio to begin. Come with family or friends to tuck into the meze grand platter, add a glass of crisp Greek wine and you might just be convinced you're basking in the sun on a Greek island. Meanwhile, baklava and honey semolina cake round out the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=905%20W.%20Main%20St.%2C%20Unit%2021B%2C%20Durham%2C%20NC%2C%2027701%2C%20USA"
    pageTitle="Nikos"
  />
);
