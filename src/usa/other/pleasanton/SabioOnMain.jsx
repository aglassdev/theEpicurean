...
const SabioOnMain = () => (
  <RestaurantPage
    restaurantName="Sabio on Main"
    address="501 Main St., Pleasanton, 94566, USA"
    cuisine="Californian, Contemporary"
    priceRange="$$$"
    phoneNumber="+19258003090"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=501%20Main%20St.%2C%20Pleasanton%2C%2094566%2C%20USA"
    pageTitle="Sabio on Main"
  />
);

export default SabioOnMain;
