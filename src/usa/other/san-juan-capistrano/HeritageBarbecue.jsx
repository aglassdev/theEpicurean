...
const HeritageBarbecue = () => (
  <RestaurantPage
    restaurantName="Heritage Barbecue"
    address="31721 Camino Capistrano, San Juan Capistrano, 92675, USA"
    cuisine="Barbecue, Regional Cuisine"
    priceRange="$$"
    phoneNumber=""
    website="https://www.heritagecraftbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Barbecue is a veritable religion in America, and chefs in this realm have a near cultish way of doing things. With that in mind, consider this SJC bijou, packed to the gills with focused diners and trays of smoky meat.Punctuality is of the essence as everyone is here, early and eager, for Chef/owner Daniel Castillo's food. His creations draw inspiration from central Texas, so when that sweet scent of California white oak gets going, find yourself transported on a riotous journey, starting with slices of glistening brisket—correctly charred and deliciously rich. Add on a side of chili with more brisket along with a cheddar-jalapeño biscuit and never look back again. Don't forget to save room for desserts like banana pudding or pineapple upside down cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31721%20Camino%20Capistrano%2C%20San%20Juan%20Capistrano%2C%2092675%2C%20USA"
    pageTitle="Heritage Barbecue"
  />
);

export default HeritageBarbecue;
