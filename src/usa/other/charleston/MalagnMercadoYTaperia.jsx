...
const MalagnMercadoYTaperia = () => (
  <RestaurantPage
    restaurantName="Malagón Mercado y Taperia"
    address="33 Spring St., Charleston, SC, 29403, USA"
    cuisine="Spanish"
    priceRange="$$"
    phoneNumber="+18439260475"
    website="https://www.malagonchs.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20Spring%20St.%2C%20Charleston%2C%20SC%2C%2029403%2C%20USA"
    pageTitle="Malagón Mercado y Taperia"
  />
);

export default MalagnMercadoYTaperia;
