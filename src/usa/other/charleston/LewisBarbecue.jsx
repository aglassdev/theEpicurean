...
const LewisBarbecue = () => (
  <RestaurantPage
    restaurantName="Lewis Barbecue"
    address="464 N. Nassau St., Charleston, SC, 29403, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+18438059500"
    website="http://lewisbarbecue.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=464%20N.%20Nassau%20St.%2C%20Charleston%2C%20SC%2C%2029403%2C%20USA"
    pageTitle="Lewis Barbecue"
  />
);

export default LewisBarbecue;
