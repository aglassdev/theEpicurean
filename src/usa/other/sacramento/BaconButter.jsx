...
const BaconButter = () => (
  <RestaurantPage
    restaurantName="Bacon & Butter"
    address="5913 Broadway, Sacramento, 95820, USA"
    cuisine="American"
    priceRange="$"
    phoneNumber="+19163464445"
    website="https://baconandbuttersac.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If the name doesn’t have you salivating yet, the dishes being ferried to and fro by the bustling staff certainly will. Bacon & Butter lures diners and lots of them—you’ll see lasting queues late into the morning—thanks to its promise of good old-fashioned American breakfast and brunch.From flapjacks and crisped potatoes to super-sized cinnamon rolls, this kitchen’s goods taste like Sunday morning at your Mom’s, including all the noise and nagging. The absolute don’t miss however is the biscuit sandwich, featuring egg, cheese, bacon and caramelized onion layered atop fluffy, flaky biscuits and then smothered with bacon gravy for a “wet,” messy and all-out delicious dish. Everything here is big enough for two, but who wants to share when it’s this good?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5913%20Broadway%2C%20Sacramento%2C%2095820%2C%20USA"
    pageTitle="Bacon & Butter"
  />
);

export default BaconButter;
