...
const Hawks = () => (
  <RestaurantPage
    restaurantName="Hawks"
    address="1525 Alhambra Blvd., Sacramento, 95816, USA"
    cuisine="American, Contemporary"
    priceRange="$$"
    phoneNumber="+19165884440"
    website="https://www.hawkspublichouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’re likely to find a stable of regulars occupying the handsome zinc bar at this lively, new-school “public house.” Once you’ve settled in, it won’t take long to realize why. An array of carefully crafted spins on classic cocktails is sure to stimulate your taste buds, while the friendly staff sets the room’s casual mood. The straightforward menu reflects the seasons, offering a small selection of familiar plates heightened with a touch of oomph. Tomato soup, for instance, is augmented with tangy goat cheese sformato and a crisp, buttery slice of sourdough; just as a signature burger is decked out with fried mortadella. House-made pastas are yet another high point.Simple sweets will satisfy in a pinch, but dessert drinks are a worthy indulgence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1525%20Alhambra%20Blvd.%2C%20Sacramento%2C%2095816%2C%20USA"
    pageTitle="Hawks"
  />
);
