...
const AvaMediterraegean = () => (
  <RestaurantPage
    restaurantName="AVA MediterrAegean"
    address="290 S. Park Ave., Winter Park, 32789, USA"
    cuisine="Greek"
    priceRange="$$$$"
    phoneNumber="+14077949896"
    website="https://www.avamediterraegean.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sleek modern Mediterranean dazzler is smack in the center of the ever-charming Winter Park. It's a bit of a scene, so dress up for shared plates and a family-style menu with a focus on the Cycladic region. It's best enjoyed as a duo or a group, especially with their tempting selection of  mezze, appetizers, salads and raw options—and that's just to start. Don't skip the crispy eggplant zucchini with its alternating stack of paper-thin slices. Move on to seafood-focused main dishes but save plenty of room for their baklava. It's a knockout modernized rendition of the traditional phyllo and spiced nut mixture, served here with walnuts and pistachios dressed in honey with ample spice and a round of pistachio ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=290%20S.%20Park%20Ave.%2C%20Winter%20Park%2C%2032789%2C%20USA"
    pageTitle="AVA MediterrAegean"
  />
);

export default AvaMediterraegean;
