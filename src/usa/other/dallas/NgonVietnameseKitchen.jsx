...
const NgonVietnameseKitchen = () => (
  <RestaurantPage
    restaurantName="Ngon Vietnamese Kitchen"
    address="1907 Greenville Ave., Dallas, 75206, USA"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+14692507183"
    website="https://www.ngonvietkitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ngon Vietnamese Kitchen isn't just another restaurant. It's much more personal than that for owner Carol Nguyen, who wanted to share the vibrancy of her homeland's cooking with Dallas diners. From the design, with its rustic wood booths and raised tables ideal for groups, to the décor, with representations of the famous conical hats (non la) on the walls, it's clear Nguyen has put her heart and soul into this spot in the lively lower Greenville area. That same effort is seen on the menu, which was largely inspired by the street vendors of Hanoi where she grew up. Choose from a wide range of authentic dishes, including nourishing phở, flavor-packed spring rolls, and delicately spiced curries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1907%20Greenville%20Ave.%2C%20Dallas%2C%2075206%2C%20USA"
    pageTitle="Ngon Vietnamese Kitchen"
  />
);

export default NgonVietnameseKitchen;
