...
const KnoxBistro = () => (
  <RestaurantPage
    restaurantName="Knox Bistro"
    address="3230 Knox St., Dallas, 75205, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+14692504007"
    website="https://knoxbistro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s an experienced team of French émigrés behind this bright and breezy bistro and it shows in all departments. This may be a French bistro—and one that’s a perfect fit for sophisticated Knox Street—but it doesn’t overdo the Gallic decoration. Instead, it concentrates on offering authentic and satisfying classics that’ll have you dreaming of weekends in Montmartre in no time. Lunch sees a simpler menu but one that includes a fine rillettes de poisson and a selection of oysters. At dinner all the French bistro favorites appear, like lapin à la moutarde or canard à l'orange; and for dessert, the kitchen really shows its skills with a textbook Paris-Brest that you won’t want to share with anyone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3230%20Knox%20St.%2C%20Dallas%2C%2075205%2C%20USA"
    pageTitle="Knox Bistro"
  />
);

export default KnoxBistro;
