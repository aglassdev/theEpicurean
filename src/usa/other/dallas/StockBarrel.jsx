...
const StockBarrel = () => (
  <RestaurantPage
    restaurantName="Stock & Barrel"
    address="316 W. Davis St., Dallas, 75208, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+12148880150"
    website="https://stockandbarreldallas.com/home/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the charming Bishop Arts area, Jon Stevens's Stock & Barrel is the perfect neighborhood spot. With an industrial chic design, open kitchen, and convivial bar counter, this restaurant is consistently packed with locals, all here for the inviting ambience. Whether you sit at the bar or in a booth, the friendly staff will ensure an enjoyable time. Expect American and Texas favorites that have been given a twist, as in deviled eggs with pickled rhubarb, meatloaf made with wagyu beef, or a bread pudding from croissants. Flavors are big and bold. Don't miss their caramelized Brussels sprouts charred with chili and cilantro. The wine list features a nice selection of by-the-glass offerings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=316%20W.%20Davis%20St.%2C%20Dallas%2C%2075208%2C%20USA"
    pageTitle="Stock & Barrel"
  />
);

export default StockBarrel;
