...
const SushiKozy = () => (
  <RestaurantPage
    restaurantName="Sushi Kozy"
    address="2000 Ross Ave., Ste. 150, Dallas, TX, 75201, USA"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+12144522777"
    website="https://sushikozy.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="More elegant than cozy, this omakase-only spot from Chef Paul Ko offers a contemporary blend of kaiseki and sushi in a stylishly modern setting. The spacious room features an assortment of tables, but seats at the cypress wood counter are preferred for the optimal experience. The meal begins with composed bites featuring international flavors, like a crisp phyllo pastry of duck confit, maple and pistachio, or a kombu-cured sea bass crudo paired with tarragon, yuzu kosho and apple. The assortment of nigiri is largely distinguished by subtlety, as in kanpachi topped with a shiso relish, or tender anago dusted with sansho pepper...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2000%20Ross%20Ave.%2C%20Ste.%20150%2C%20Dallas%2C%20TX%2C%2075201%2C%20USA"
    pageTitle="Sushi Kozy"
  />
);

export default SushiKozy;
