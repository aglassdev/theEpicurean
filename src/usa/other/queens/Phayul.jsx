...
const Phayul = () => (
  <RestaurantPage
    restaurantName="Phayul"
    address="37-59 74th St., Queens, 11372, USA"
    cuisine="Tibetan"
    priceRange="$$"
    phoneNumber="+17184241869"
    website="https://guide.michelin.com/en/new-york-state/queens/restaurant/phayul"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Momos are a point of pride for this Tibetan mainstay located in the center of vibrant Roosevelt Avenue. Large, generously filled and properly soupy, these dumplings are a treat steamed and even more so when fried. You could make a meal out of them, but then you’d be missing out on other specialties like fried lamb ribs seasoned with salt and pepper, stacked upon each other, and tossed with sautéed peppers. Steaming bowls of soup filled with noodles and comforting broths balance out sliced beef stir fried with tons of chili and large cubes of laphing. There’s more chili oil and a particularly ferocious hot sauce on the table for fearless spice hounds. Newcomers to this cuisine will appreciate a glossy menu with pages of clear photos of each dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37-59%2074th%20St.%2C%20Queens%2C%2011372%2C%20USA"
    pageTitle="Phayul"
  />
);

export default Phayul;
