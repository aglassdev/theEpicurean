...
const BaoHaus = () => (
  <RestaurantPage
    restaurantName="Bao Haus"
    address="2F, 62-9 Seojeon-ro 38 beon-gil, Busanjin-gu, Busan, 47294, South Korea"
    cuisine="Taiwanese"
    priceRange="₩"
    phoneNumber="+821048881041"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/bao-haus"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When Chef Choi Haeng-rak opened Bao Haus here in his hometown of Busan, his extensive overseas training at last found a place to flourish. His restaurant offers simple and casual Taiwanese-style dishes. By lowering the threshold for fine cuisine, the chef ushers diners into the familiar yet exotic world of the different variations of Chinese cuisine. The menu features dishes loaded with inherent flavors and executed with Chef Choi’s novel twists, including bao (Taiwanese steamed buns), lu rou fan (Taiwanese braised pork rice bowl), mapo tofu, and deep-fried eggplant. Since the eatery is housed in a compact space, the wait can be long without a reservation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2062-9%20Seojeon-ro%2038%20beon-gil%2C%20Busanjin-gu%2C%20Busan%2C%2047294%2C%20South%20Korea"
    pageTitle="Bao Haus"
  />
);

export default BaoHaus;
