...
const ShunsaiKubo = () => (
  <RestaurantPage
    restaurantName="Shunsai Kubo"
    address="17 Yangdal-ro 4 beon-gil, Buk-gu, Busan, 46517, South Korea"
    cuisine="Unagi / Freshwater Eel, Japanese"
    priceRange="₩"
    phoneNumber="+82513652959"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/shunsai-kubo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Shunsai Kubo is a hitsumabushi (Nagoya-style grilled eel) restaurant helmed by Chef Lee Jae-wook. Trained in Japan, the chef is continually striving to raise the bar on the flavor and quality of his signature dish made only with live Japanese eels (Anguilla japonica). The rich aroma of the eels, rubbed with a special sauce and carefully grilled, creates a delightful gastronomic harmony with the rice cooked to just the right texture. The restaurant serves a hitsumabushi menu for children, a considerate gesture that caters to families. Shunsai Kubo also offers authentic light bar snacks for long-time regulars with fond memories of its former Japanese kappo cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Yangdal-ro%204%20beon-gil%2C%20Buk-gu%2C%20Busan%2C%2046517%2C%20South%20Korea"
    pageTitle="Shunsai Kubo"
  />
);

export default ShunsaiKubo;
