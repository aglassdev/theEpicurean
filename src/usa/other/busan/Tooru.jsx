...
const Tooru = () => (
  <RestaurantPage
    restaurantName="Tooru"
    address="38-1 Dongseong-ro 49 beon-gil, Busanjin-gu, Busan, 47304, South Korea"
    cuisine="Japanese"
    priceRange="₩₩"
    phoneNumber="+821072526012"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/tooru"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef crafts the omakase around daily-sourced seafood, highlighting a spectrum of nuanced flavours. Staying true to the seasonality central to Japanese cuisine, he incorporates Korean ingredients at their peak. Local seafood takes centre stage in dishes rooted in simple, authentic recipes. Among the chef’s signatures are somen dishes, served either in the surinagashi style or with sauces made from seasonal ingredients. Despite its compact size, the bar-centred layout creates a comfortable, relaxed atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38-1%20Dongseong-ro%2049%20beon-gil%2C%20Busanjin-gu%2C%20Busan%2C%2047304%2C%20South%20Korea"
    pageTitle="Tooru"
  />
);

export default Tooru;
