...
const Matsuzaki = () => (
  <RestaurantPage
    restaurantName="Matsuzaki"
    address="10 Suyeong-ro 582beon-gil, Suyeong-gu, Busan, 48297, South Korea"
    cuisine="Japanese"
    priceRange="₩₩"
    phoneNumber="+821094334065"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/matsuzaki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This intimate restaurant offers authentic kaiseki omakase by the chef who trained at a renowned culinary institute. The petite yet cosy space is decorated with fine tableware and glassware, along with paintings by the chef’s mother. The meal opens with a flavourful soup, followed by a beautifully composed hassun of seasonal bites, and concludes with a nabemono of freshly cooked rice, vegetables, and fish—Japanese cuisine that remains faithful to its fundamentals...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Suyeong-ro%20582beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048297%2C%20South%20Korea"
    pageTitle="Matsuzaki"
  />
);

export default Matsuzaki;
