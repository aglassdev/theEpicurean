...
const ZeroBase = () => (
  <RestaurantPage
    restaurantName="Zero Base"
    address="2F, 17 Millak-ro 33 beon-gil, Suyeong-gu, Busan, 48285, South Korea"
    cuisine="Japanese"
    priceRange="₩₩₩"
    phoneNumber="+827088030318"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/zero-base"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zero Base is a new Japanese restaurant by Chef Yu Byeong-chan, who previously ran the izakaya Yoo No Woo with a stellar reputation. The chef’s unrelenting thirst for classy Japanese cuisine, which had never been fully quenched at his former spot, drove him to present his newly evolved cuisine at this up-and-coming eatery. His solid culinary skills turn ingredients into sumptuous variations on a classic theme, in a way that accentuates his sensibilities. The eatery pays special attention to selecting the freshest of seasonal ingredients. And it simply makes sense. The delicate juxtaposition between Zero Base’s contemporary décor and classic cuisine conjures up an exclusive vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2017%20Millak-ro%2033%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048285%2C%20South%20Korea"
    pageTitle="Zero Base"
  />
);
