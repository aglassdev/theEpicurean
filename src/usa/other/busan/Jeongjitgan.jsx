...
const Jeongjitgan = () => (
  <RestaurantPage
    restaurantName="Jeongjitgan"
    address="6 Bibong-ro, Saha-gu, Busan, 49419, South Korea"
    cuisine="Dwaeji-gukbap"
    priceRange="₩"
    phoneNumber="+82512932900"
    website="https://busangukbap.modoo.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jeongjitgan is the Gyeongsang-do dialect word for kitchen. Opened in 2011, Jeongjitgan specializes in Busan-style dwejigukbap, or pork soup. The rich, milky broth, which is reminiscent of a clean, savory beef bone broth is prepared fresh daily. Diners can choose the toppings they like from thinly sliced, tender meat, offal, and sundae. Suyuk made from pork shoulder, and makguksu, or cold buckwheat noodles, are also signature dishes. Jeongjitgan is open 24 hours, which means that it's always the perfect time to visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Bibong-ro%2C%20Saha-gu%2C%20Busan%2C%2049419%2C%20South%20Korea"
    pageTitle="Jeongjitgan"
  />
);

export default Jeongjitgan;
