...
const Yongkangzzie = () => (
  <RestaurantPage
    restaurantName="Yongkangzzie"
    address="10 Gwanganhaebyeon-ro 277 beon-gil, Suyeong-gu, Busan, 48287, South Korea"
    cuisine="Noodles, Taiwanese"
    priceRange="₩"
    phoneNumber="+82517586011"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/yongkangzzie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated near Gwangalli Beach at the beginning of an alley leading to Millak Golmok Market, Yongkangzzie is a Taiwanese spot best known for its beef noodle soup. The consistent design concepts that permeate both exterior and interior spaces, as well as the detailed décor, have done a remarkable job of reproducing a vibe that evokes Taiwan. The warmth of the signature soup goes well with the eatery’s casual and exotic ambiance. The broth, which offers up subtle sour flavors and umami, and the thick, pleasantly textured noodles make this iconic soup a comforting choice in any season. In addition to this signature dish, Yongkangzzie serves other noodle and side dishes that are guaranteed to please the palate. Please note that the restaurant has no parking lot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Gwanganhaebyeon-ro%20277%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048287%2C%20South%20Korea"
    pageTitle="Yongkangzzie"
  />
);

export default Yongkangzzie;
