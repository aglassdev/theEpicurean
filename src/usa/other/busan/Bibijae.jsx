...
const Bibijae = () => (
  <RestaurantPage
    restaurantName="Bibijae"
    address="45 Namcheonbada-ro 10 beon-gil, Suyeong-gu, Busan, 48314, South Korea"
    cuisine="Bibimbap"
    priceRange="₩"
    phoneNumber="+827082871035"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/bibijae"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bibimbap is a versatile Korean dish with flavors that can drastically change depending on the ingredients. Bibijae offers bibimbap dishes made with creative combinations of ingredients and flavors. Diners can not only enjoy classic bibimbap but also enjoy creative twists with seasonal ingedients. There’s more - for those who prefer piping hot bibimbap, all dishes can be upgraded to a hot stone bowl. It is exciting to see what new flavor profiles Bibijae adds to the humble bibimbap...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Namcheonbada-ro%2010%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048314%2C%20South%20Korea"
    pageTitle="Bibijae"
  />
);

export default Bibijae;
