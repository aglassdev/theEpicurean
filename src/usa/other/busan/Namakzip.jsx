...
const Namakzip = () => (
  <RestaurantPage
    restaurantName="Namakzip"
    address="#1068 A, W square, 145 Bunpo-ro, Nam-gu, Busan, 48515, South Korea"
    cuisine="Dwaeji-gukbap"
    priceRange="₩"
    phoneNumber="+82517464882"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/namakzip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Busan offers a wide variety of dwaeji-gukbap (pork and rice soup), befitting its position as the origin of this dish. Every restaurant adds its own twist to the soup’s broth while staying true to its authentic flavors. At Namakzip, the meat broth features a higher proportion of vegetable broth, so it tastes light and clean rather than heavy. In addition to this iconic soup, the menu includes kalguksu (hand-cut noodle soup) with meat; kalguksu with fresh noodles, both featuring meat broth from dwaeji-gukbap; boiled pork slices; and grilled pork belly. For those wishing to enjoy, amidst a modern dining space, a satisfying dwaeji-gukbap with a minimal aftertaste, Namakzip is the way to go...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%231068%20A%2C%20W%20square%2C%20145%20Bunpo-ro%2C%20Nam-gu%2C%20Busan%2C%2048515%2C%20South%20Korea"
    pageTitle="Namakzip"
  />
);

export default Namakzip;
