...
const Songheonjip = () => (
  <RestaurantPage
    restaurantName="Songheonjip"
    address="18 Millak-ro 19 beon-gil, Suyeong-gu, Busan, 48285, South Korea"
    cuisine="Korean"
    priceRange="₩"
    phoneNumber="+82517114648"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/songheonjip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With successful businesses built around traditional liquor and noodle soup, the owner-chef now ventures into tteokgalbi at Songheonjip. Thick, charcoal-grilled patties are smoky and juicy, served with rice, delicate banchan, and a rich doenjang jjigae. Set in a renovated two-storey house, the restaurant evokes the cosy atmosphere of a 1990s home. Dishes are served on low tables for a homey yet hearty dining experience. Shoe-off required when entering the room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Millak-ro%2019%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048285%2C%20South%20Korea"
    pageTitle="Songheonjip"
  />
);

export default Songheonjip;
