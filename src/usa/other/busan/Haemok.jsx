...
const Haemok = () => (
  <RestaurantPage
    restaurantName="Haemok"
    address="8 Gunam-ro 24 beon-gil, Haeundae-gu, Busan, 48094, South Korea"
    cuisine="Japanese"
    priceRange="₩₩"
    phoneNumber="+82517463730"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/haemok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popular among both tourists and local regulars, Haemok offers accessible Japanese fare. Its blue fence and inexplicably exotic edifice create a vibe that makes this spot stand out in the neighborhood. Its wood-based décor and tatami floor also add to the exotic ambiance. Haemok’s menu includes a few selections of Japanese rice bowls, sashimi, tempura, and tataki dishes. But its signature item is unarguably hitsumabushi (Nagoya-style grilled eel). Coated with umami-rich sauce, the eel features bottomless flavor and is a perfect accompaniment to the rice cooked to perfection. And just so you know, Haemok also has outposts in Seoul...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Gunam-ro%2024%20beon-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048094%2C%20South%20Korea"
    pageTitle="Haemok"
  />
);

export default Haemok;
