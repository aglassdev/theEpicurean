...
const Ltang = () => (
  <RestaurantPage
    restaurantName="L'étang"
    address="22 Seongji-ro, Busanjin-gu, Busan, 47123, South Korea"
    cuisine="French"
    priceRange="₩₩"
    phoneNumber="+82518073636"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/l-etang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'étang is a French bistro located on one of the main roads in Yeonji-dong. Here, the owner-chef Jung Dong-won does everything single-handedly, from preparing the ingredients to cooking and serving. By revamping its menu every season to reflect seasonal ingredients, L'étang incorporates the flavors of the season into its French cuisine characterized by adherence to culinary basics and traditions as well as fresh and mild flavors. Since the bar counter facing the kitchen features limited seating, reservations are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20Seongji-ro%2C%20Busanjin-gu%2C%20Busan%2C%2047123%2C%20South%20Korea"
    pageTitle="L'étang"
  />
);

export default Ltang;
