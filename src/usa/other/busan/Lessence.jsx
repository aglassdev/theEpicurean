...
const Lessence = () => (
  <RestaurantPage
    ...
    address="3F, 17 Gwangnam-ro 22 beon-gil, Suyeong-gu, Busan, 48307, South Korea"
    cuisine="French"
    priceRange="₩₩"
    phoneNumber="+821095857050"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/l-essence"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'Essence is a French restaurant set in a quiet alley near Namcheon Station. Here, Chef Jeon Ji-seong combines seasonal local ingredients with vibrant sauces to present French cuisine offering an outstanding balance of taste and aroma. Sometimes, the chef uses fermented ingredients, such as pickled vegetables and salted seafood, to add verve to his dishes, providing diners with the fun of spotting Korean flavors hidden amidst his delicate French cuisine. Though L'Essence usually offers only an a la carte menu, customers can enjoy its multi-course meal with a reservation at least a day in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2017%20Gwangnam-ro%2022%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048307%2C%20South%20Korea"
    pageTitle="L'Essence"
  />
);

export default Lessence;
