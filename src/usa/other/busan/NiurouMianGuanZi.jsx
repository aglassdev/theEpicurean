...
const NiurouMianGuanZi = () => (
  <RestaurantPage
    restaurantName="Niurou mian guan zi"
    address="25-4 Suyeong-ro 388 beon-gil, Suyeong-gu, Busan, 48311, South Korea"
    cuisine="Taiwanese"
    priceRange="₩"
    phoneNumber="+82516230251"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/niurou-mian-guan-zi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A long line under a yellow awning makes spotting this bustling Taiwanese eatery a breeze. Its streamlined menu features homely yet delectable dishes, including pleasantly spicy Taiwan-style braised beef noodle soup, wonton soup, Taiwanese cold noodles, and spicy wonton in chili oil. The signature braised beef noodle soup features large chunks of beef, bok choy, pickled leaf mustard, and some chili oil for a spicy twist. And a bowl of this particular soup will make you sweat even in the depths of winter. When paired with sweet-flavored mango beer, it’s a match made in heaven...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25-4%20Suyeong-ro%20388%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048311%2C%20South%20Korea"
    pageTitle="Niurou mian guan zi"
  />
);

export default NiurouMianGuanZi;
