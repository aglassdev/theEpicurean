...
const KumsuBokguk = () => (
  <RestaurantPage
    restaurantName="Kumsu Bokguk"
    address="23 Jungdong 1-ro 43 beon-gil, Haeundae-gu, Busan, 48095, South Korea"
    cuisine="Fugu / Pufferfish"
    priceRange="₩₩"
    phoneNumber="+82517423600"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/kumsu-bokguk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kumsu Bokguk in Haeundae District is the head restaurant of a chain that has many outposts in Seoul and Busan. For more than 50 years since 1970, and across multiple generations, this eatery has delighted seafood lovers as a specialized puffer fish restaurant. It offers four types of puffer fish. Brown-backed puffer is chewy and has a nutty flavor. Globe puffer is large and often made into a spicy stew. Yellowfin puffer is sweet, so it is usually steamed or boiled. Ocellate puffer is the largest variety of the fish. Its firm texture makes the fish more suitable to be served raw. Safety is the first priority at this head restaurant as demonstrated by the hiring of dozens of chefs, all licensed to prepare puffer fish. So why not rest assured and visit this time-tested establishment for a gas..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Jungdong%201-ro%2043%20beon-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048095%2C%20South%20Korea"
    pageTitle="Kumsu Bokguk"
  />
);

export default KumsuBokguk;
