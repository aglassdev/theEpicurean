...
const GoodMorningHongkong = () => (
  <RestaurantPage
    restaurantName="Good morning Hongkong"
    address="19 Seojeon-ro 47 beon-gil, Busanjin-gu, Busan, 47247, South Korea"
    cuisine="Chinese"
    priceRange="₩"
    phoneNumber="+821064443724"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/good-morning-hongkong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you pine for Hong Kong cuisine and want to experience a uniquely Hong Kong vibe, this diner deserves your full attention as it is inspired by cha chaan teng, or a Hong Kong-style café. The owner says he opened this joint merely out of his love for Hong Kong. It serves less-than-authentic Hong Kong dishes, slightly modified to suit the Korean palate. Still, their flavors and visuals are no less spectacular than those of the local Hong Kong cuisine. Signatures include pleasantly spicy tomato noodle soup with plenty of tomato and ham; bread generously glazed with condensed milk and syrup; sweet nai cha (milk tea); and dong ning cha (iced lemon tea). The diner’s Hong Kong-style visuals are a plus!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Seojeon-ro%2047%20beon-gil%2C%20Busanjin-gu%2C%20Busan%2C%2047247%2C%20South%20Korea"
    pageTitle="Good morning Hongkong"
  />
);

export default GoodMorningHongkong;
