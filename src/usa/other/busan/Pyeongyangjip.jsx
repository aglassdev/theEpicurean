...
const Pyeongyangjip = () => (
  <RestaurantPage
    restaurantName="Pyeongyangjip"
    address="21 Geumgok-daero 20beon-gil, Buk-gu, Busan, 46547, South Korea"
    cuisine="Mandu"
    priceRange="₩"
    phoneNumber="+82513315445"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/pyeongyangjip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pyeongyangjip serves North Korean-style mandu and nokdujeon. The house-made dumplings, filled with kimchi, glass noodles, tofu, and vegetables, are encased in silky wrappers and served with a clear broth of beef brisket and shank. The nokdujeon, made from mung beans finely milled on a stone metdol, is airy and crispy, accented by crunchy bean sprouts. Prepared by the owner and family in this intimate, spotless space, the mandu-guk here is sure to warm the heart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Geumgok-daero%2020beon-gil%2C%20Buk-gu%2C%20Busan%2C%2046547%2C%20South%20Korea"
    pageTitle="Pyeongyangjip"
  />
);

export default Pyeongyangjip;
