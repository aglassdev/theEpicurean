...
const Chaoran = () => (
  <RestaurantPage
    restaurantName="Chaoran"
    address="5F Signiel, 30 Dalmaji-gil, Haeundae-gu, Busan, 48099, South Korea"
    cuisine="Chinese, Cantonese"
    priceRange="₩₩₩₩"
    phoneNumber="+82519221250"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/chaoran"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the fifth floor of Signiel Busan, Chaoran serves authentic Cantonese cuisine – more precisely its Hong Kong variety, which is based on the former yet characterized by the harmony of new flavors resulting from the city’s culturally diverse geographical contexts. Take, for example, the dim sum: It consists of a gamut of splendid and scrumptious dishes, including har gow (shrimp dumplings), characterized by skin colored with squid ink and topped with gold leaf; a vegetable dumpling filled with truffle, other mushrooms, and asparagus; and a seafood dumpling stuffed with dried scallops in XO sauce and decorated with flying fish roe. Pork Barbeque with Honey Sauce and Crispy Pork Belly, the signature dishes, boast juicy meat and crispy skin accompanied by mild flavors conjured up by ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%20Signiel%2C%2030%20Dalmaji-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048099%2C%20South%20Korea"
    pageTitle="Chaoran"
  />
);

export default Chaoran;
