...
const OneZeroZeroOnePyeongnaeng = () => (
  <RestaurantPage
    restaurantName="100.1.Pyeongnaeng"
    address="29 Namcheonbada-ro 10 beon-gil, Suyeong-gu, Busan, 48314, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+82516255515"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/100-1-pyeongnaeng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="100.1.Pyeongnaeng was a naengmyeon restaurant that ran for exactly 100 days and grabbed the attention of foodies in the latter half of 2023. With a strong passion for cold noodle flavors, Kwak Dong-hoon officially opened the Pyongyang-style naengmyeon restaurant on March 3, 2024. Kwak developed his own Pyongyang naengmyeon recipe after touring naengmyeon restaurants all over Korean in search for the bowl of noodles. A single sip of the delicate, subtle broth is all you need to see the restaurant's mastery in crafting naengmyeon. They also offer various Korean dishes like bulgogi, eobokjaengban, and mandu, which perfectly compliment any occasion that calls for alcoholic beverages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Namcheonbada-ro%2010%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048314%2C%20South%20Korea"
    pageTitle="100.1.Pyeongnaeng"
  />
);

export default OneZeroZeroOnePyeongnaeng;
