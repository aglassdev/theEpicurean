...
const ChefGon = () => (
  <RestaurantPage
    restaurantName="Chef Gon"
    address="12 Junggu-ro 23 beon-gil, Jung-gu, Busan, 48978, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+821045856607"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/chef-gon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in an alley near Jagalchi Market, this joint is run by a former hotel chef with years of experience. Every morning, the chef visits the market to buy fresh ingredients, with which he prepares the day’s seasonal menu. For this reason, the restaurant’s course meal is called “Jagalchi Chef’s Course Special.” Diners sitting near the kitchen can watch the chef in action while listening to his explanations about the ingredients. In addition to seafood offerings, the menu features a wide range of meat and a la carte dishes, as well as a well-balanced wine list, all of which await your indulgence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Junggu-ro%2023%20beon-gil%2C%20Jung-gu%2C%20Busan%2C%2048978%2C%20South%20Korea"
    pageTitle="Chef Gon"
  />
);

export default ChefGon;
