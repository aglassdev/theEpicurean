...
const Damiok = () => (
  <RestaurantPage
    restaurantName="Damiok"
    address="#103, 15 Bokji-ro, Busanjin-gu, Busan, 47328, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+821077045318"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/damiok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Quietly nestled in Gaegeum-dong, Damiok specializes in Pyeongyang cold buckwheat noodles. As its name suggests, the establishment focuses on presenting refreshingly light and clean flavors. The broth tastes pure and non-greasy, without unpleasant flavors, as it is made only from simmered beef, pork, and chicken. The noodles are housemade, and you have the added option of selecting 100 percent buckwheat noodles, which taste nuttier and may titillate more adventurous palates. In addition to the signature dish, Damiok offers beef bone soup and Pyeongyang-style beef hot pot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%23103%2C%2015%20Bokji-ro%2C%20Busanjin-gu%2C%20Busan%2C%2047328%2C%20South%20Korea"
    pageTitle="Damiok"
  />
);

export default Damiok;
