...
const ChaAeJeonHalmaeKalguksu = () => (
  <RestaurantPage
    restaurantName="Cha Ae Jeon Halmae Kalguksu"
    address="70 Gwajeong-ro 191 beonga-gil, Yeonje-gu, Busan, 47558, South Korea"
    cuisine="Kalguksu"
    priceRange="₩"
    phoneNumber="+82517519639"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/cha-ae-jeon-halmae-kalguksu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1982, this establishment has faithfully and unwaveringly continued to serve local customers with the simple yet hearty dish of kalguksu (hand-cut noodle soup). Though this humble dish can be found anywhere, the eatery’s variant has distinctive old-fashioned charm derived from its unpretentiousness. The broth is not thick, but mild and light. And instead of serving kimchi as a side dish, it is offered in the form of a uniquely spicy garnish mixed with onion. It is these and other intricacies that give this joint’s menu a singular flair. For an optimal dining experience, first, enjoy the mild broth and noodles in their natural state. Then, add in the garnish for a pleasant spiciness that slowly builds up. The menu features several varieties of kalguksu, including Halmae Kalguksu, the r..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20Gwajeong-ro%20191%20beonga-gil%2C%20Yeonje-gu%2C%20Busan%2C%2047558%2C%20South%20Korea"
    pageTitle="Cha Ae Jeon Halmae Kalguksu"
  />
);

export default ChaAeJeonHalmaeKalguksu;
