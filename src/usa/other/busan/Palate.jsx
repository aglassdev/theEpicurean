...
const Palate = () => (
  <RestaurantPage
    restaurantName="Palate"
    address="3F, 154 Dalmaji-gil 65 beon-gil, Haeundae-gu, Busan, 48576, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+82516262364"
    website="https://www.palatebusan.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Palate offers contemporary French cuisine that is free-spirited and adventurous in style. Its sensuous fare is based on the culinary diversity experienced by Chef Kim Jae-hoon. Ever since he boldly opened this diner in Busan, his hometown, the chef has been taking up diverse epicurean challenges while injecting freshness into the restaurant’s concept. This progressive aspect of Palate is well reflected in the cuisine it serves today. When it comes to dining, Busan has much respect for the old and traditional. This urban dining landscape makes one wonder how the chef’s ever-evolving culinary experiments will translate into gastronomic revolutions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20154%20Dalmaji-gil%2065%20beon-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048576%2C%20South%20Korea"
    pageTitle="Palate"
  />
);
