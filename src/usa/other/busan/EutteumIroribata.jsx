...
const EutteumIroribata = () => (
  <RestaurantPage
    restaurantName="Eutteum Iroribata"
    address="20 Suyeong-ro 408 beon-gil, Suyeong-gu, Busan, 48308, South Korea"
    cuisine="Japanese"
    priceRange="₩₩"
    phoneNumber="+821066402884"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/eutteum-iroribata"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located near Namcheon station, this Japanese diner specializes in omakase dining prepared using irori (traditional Japanese hearth). Though not as authentic as the ones in old Japanese houses, the irori here is faithful to its role as kitchen equipment. The visual and aromatic appeal of grilling seasonal fish skewers, arranged in a row in front of the irori, adds to the diner’s culinary delight. An embodiment of Chef Jung Eu-tteum’s experience with Japanese cuisine and his personal gastronomic affinities, the eatery is a perfect haven to relish a diverse array of grilled fish. Clay pot rice and other dishes served during the omakase course boast a range of refined flavors that often characterize Japanese cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Suyeong-ro%20408%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048308%2C%20South%20Korea"
    pageTitle="Eutteum Iroribata"
  />
);

export default EutteumIroribata;
