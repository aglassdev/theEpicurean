...
const Arp = () => (
  <RestaurantPage
    restaurantName="ARP"
    address="35 Taejong-ro 99 beon-gil, Yeongdo-gu, Busan, 49035, South Korea"
    cuisine="Vegan"
    priceRange="₩"
    phoneNumber="+821055881368"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/arp"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="ARP offers a 100 percent vegan menu. An acronym formed from the phrase “Around Plants,” the eatery’s name symbolizes the positive, ethical kitchen table of the round Earth and the unlimited possibilities inherent in veggie cuisine. Here, customers can enjoy a diverse range of non-meat dishes paired with housemade wine made of rice. And these offerings immediately debunk the common misconception that vegan food is not delicious. For instance, the signature bracken pasta features dried bracken and mushrooms for a maximally chewy texture and pleasant nutty flavors. The vegan cheese, though made from coconut oil, tastes exactly like cheddar cheese. Come and relish the gastronomic charm of ARP’s delectable non-animal-based fare in this elegantly designed space...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Taejong-ro%2099%20beon-gil%2C%20Yeongdo-gu%2C%20Busan%2C%2049035%2C%20South%20Korea"
    pageTitle="ARP"
  />
);
