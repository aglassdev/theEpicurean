...
const Moemiljip = () => (
  <RestaurantPage
    restaurantName="Moemiljip"
    address="2F, Orange Plaza, 23 Marine city 3-ro, Haeundae-gu, Busan, 48118, South Korea"
    cuisine="Memil-guksu"
    priceRange="₩"
    phoneNumber="+82517449944"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/moemiljip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Using 100% Korean buckwheat and milling the noodles in-house, this restaurant invites you to appreciate the pure flavour and chewy texture of freshly made buckwheat noodles. While the bibim buckwheat noodles focus on a spicy bite, the perilla-oil and cold buckwheat noodles showcase the delicate aroma of buckwheat that the restaurant aims to highlight. The bouncy, tender slices of boiled pork also pair well with the noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Orange%20Plaza%2C%2023%20Marine%20city%203-ro%2C%20Haeundae-gu%2C%20Busan%2C%2048118%2C%20South%20Korea"
    pageTitle="Moemiljip"
  />
);

export default Moemiljip;
