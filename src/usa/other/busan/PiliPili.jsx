...
const PiliPili = () => (
  <RestaurantPage
    restaurantName="PILI PILI"
    address="54 Muhak-ro 33 beon-gil, Suyeong-gu, Busan, 48268, South Korea"
    cuisine="Thai"
    priceRange="₩"
    phoneNumber="+821079974143"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/pili-pili"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a stroll around Gwangan-dong, and you’ll come across a restaurant whose exterior and interior design will make you ask yourself whether you are in Busan or Thailand. Piri Piri is a Thai-style dining bar that serves Thai cuisine and exotic cocktails. Its hip vibes, music resonating from a turntable, and generous servings of authentic Thai dishes evoke a magical feeling of traveling in that exotic country. So why not come and indulge in the visual feast of the spectacular Poo Pad Phong Curry (stir-fried crab in curry powder) while imbibing a Thai highball?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20Muhak-ro%2033%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048268%2C%20South%20Korea"
    pageTitle="PILI PILI"
  />
);

export default PiliPili;
