...
const HapcheonGukbapjip = () => (
  <RestaurantPage
    restaurantName="Hapcheon Gukbapjip"
    address="235 Yongho-ro, Nam-gu, Busan, 48593, South Korea"
    cuisine="Dwaeji-gukbap, Korean"
    priceRange="₩"
    phoneNumber="+82516284898"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/hapcheon-gukbapjip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dwaeji-gukbap (pork and rice soup), the representative culinary delight of Busan, has continued to evolve with changing times and dietary trends. Amid this evolution, the variant served at Hapcheon Gukbapjip has long adhered to the original recipe, delighting customers with its time-tested flavors. Here, pork is repeatedly covered with broth and drained right before it is included in the soup and served. This technique eliminates unpleasant zests while enhancing the meat’s rich flavor. The clear broth, on the other hand, is brimming with umami and clean flavors; they will be etched in your memory and reverberate every now and then. Another signature item, boiled pork slices, is often unavailable due to limited daily portions, so arrive early. Solo diners are advised to avoid peak lunch hou..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=235%20Yongho-ro%2C%20Nam-gu%2C%20Busan%2C%2048593%2C%20South%20Korea"
    pageTitle="Hapcheon Gukbapjip"
  />
);

export default HapcheonGukbapjip;
