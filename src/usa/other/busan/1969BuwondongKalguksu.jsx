...
const 1969BuwondongKalguksu = () => (
  <RestaurantPage
    restaurantName="1969 Buwondong Kalguksu"
    address="3 Gudeok-ro 22 beon-gil, Jung-gu, Busan, 48954, South Korea"
    cuisine="Kalguksu"
    priceRange="₩"
    phoneNumber="+82512429909"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/1969-buwondong-kalguksu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After several relocations, the restaurant continues to serve diners the same traditional flavours. The menu is extremely simple yet highly focused, offering only kalguksu and mandu. The kalguksu is a must-try: house-made noodles with a firm, chewy texture paired with a clear, deeply savoury broth. For spicy lovers, the bibim kalguksu captures distinctly bold and tangy Busan-style flavours. A larger portion can be requested at no extra cost...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Gudeok-ro%2022%20beon-gil%2C%20Jung-gu%2C%20Busan%2C%2048954%2C%20South%20Korea"
    pageTitle="1969 Buwondong Kalguksu"
  />
);

export default 1969BuwondongKalguksu;
