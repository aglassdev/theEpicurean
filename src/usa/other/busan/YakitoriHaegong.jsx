...
const YakitoriHaegong = () => (
  <RestaurantPage
    restaurantName="Yakitori Haegong"
    address="30-5 Millakbondong-ro 19 beon-gil, Suyoeng-gu, Busan, 48290, South Korea"
    cuisine="Yakitori"
    priceRange="₩₩"
    phoneNumber="+82517588333"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/yakitori-haegong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In an alley of a quiet residential neighborhood is a pink building with an unexpected tiny little sign that reads “Haegong.” This Japanese eatery specializes in yakitori (grilled chicken skewers) made with native Korean chicken. As part of the relocation to its present location in October 2022, some upgrades were made to its space to ensure a more sophisticated dining experience. Grilled hagfish, another gem of this establishment, is not a dish to miss, with each mouthful piece brimming with juice, oceanic minerality, and delightfully firm texture. Yakitori Haegong is a rare gem in Busan to savor yakitori in a serene vibe accentuated by its refined interior décor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30-5%20Millakbondong-ro%2019%20beon-gil%2C%20Suyoeng-gu%2C%20Busan%2C%2048290%2C%20South%20Korea"
    pageTitle="Yakitori Haegong"
  />
);

export default YakitoriHaegong;
