...
const Sogonggan = () => (
  <RestaurantPage
    restaurantName="Sogonggan"
    address="4F, 47 Haeundaehaebyon-ro 298 beon-gil, Haeundae-gu, Busan, 48099, South Korea"
    cuisine="Korean Contemporary"
    priceRange="₩₩"
    phoneNumber="+821051919002"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/sogonggan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sogonggan is a double entendre that can be read as “a small space” or “a space dealing with beef.” Its thoughtfully crafted menu is rooted in Korean cuisine. The chef spent many years perfecting his Western cuisine before making the switch to its Korean counterpart. He says the switching has made cooking more enjoyable and comforting as if he were finally wearing a tailored suit. Indeed, his sense of happiness is genuinely reflected in the fare. With Sogonggan’s elegant plating, original dishes, and refined Korean menu lineup, such as beef bone soup simmered in-house for 48 hours and pot rice, the “small space” moniker is unquestionably a misnomer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%2047%20Haeundaehaebyon-ro%20298%20beon-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048099%2C%20South%20Korea"
    pageTitle="Sogonggan"
  />
);

export default Sogonggan;
