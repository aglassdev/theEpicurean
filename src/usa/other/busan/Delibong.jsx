...
const Delibong = () => (
  <RestaurantPage
    restaurantName="Delibong"
    address="#110 Noblesse square, 25 Singeum-ro, Yeonje-gu, Busan, 47560, South Korea"
    cuisine="French"
    priceRange="₩₩"
    phoneNumber=""
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/delibong"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%23110%20Noblesse%20square%2C%2025%20Singeum-ro%2C%20Yeonje-gu%2C%20Busan%2C%2047560%2C%20South%20Korea"
    pageTitle="Delibong"
  />
);

export default Delibong;
