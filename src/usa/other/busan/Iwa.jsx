...
const Iwa = () => (
  <RestaurantPage
    restaurantName="Iwa"
    address="2F, 13 Haeundaehaebyeon-ro 209 beon-gil, Haeundae-gu, Busan, 48093, South Korea"
    cuisine="Japanese"
    priceRange="₩₩"
    phoneNumber="+821085433356"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/iwa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef, who holds a patent for the aging of fish, prepares aged ingredients with clear intent. Such meticulous preparation, combined with diverse selections, produces stable flavors and gastronomic delights. Depending on the ingredients available and the chef’s tactics, the proportion of sushi, sashimi, and other Japanese dishes in the omakase can vary. All fish here are aged at least four days, and the chef carefully selects an optimal aging period for each fish based on its type, characteristics, and conditions. At Iwa, customers can enjoy at one sitting a wide variety of Japanese dishes, each prepared with aged ingredients with full-bodied flavors. And reasonable prices make this culinary feast all the more special...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2013%20Haeundaehaebyeon-ro%20209%20beon-gil%2C%20Haeundae-gu%2C%20Busan%2C%2048093%2C%20South%20Korea"
    pageTitle="Iwa"
  />
);
