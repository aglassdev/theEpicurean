...
const Ramsey = () => (
  <RestaurantPage
    restaurantName="Ramsey"
    address="3F, 38 Gwanganhaebyeon-ro 284 beon-gil, Suyeong-gu, Busan, 48285, South Korea"
    cuisine="French"
    priceRange="₩₩₩"
    phoneNumber="+821094063135"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/ramsey"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Helmed by Chef Lee Gyu-jin, Ramsey pushes the boundaries of its classic French cuisine through inventive use of ingredients. Located in Millak-dong, the highly competitive dining battleground where eateries of diverse varieties keep popping up, this bistro is set apart from the pack with its alluring French fare. From the amuse-bouche, which combines diverse flavors to create culinary variations on a theme, to fantastic fish and meat dishes that highlight the chef’s seasoned cooking skills, Ramsey is well-versed in every element of a French course meal and focuses on fare that makes good use of sauce flavors. Come and enjoy a cozy meal at Ramsey accompanied by attentive and discreet service while relishing its inviting vibe to the fullest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2038%20Gwanganhaebyeon-ro%20284%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048285%2C%20South%20Korea"
    pageTitle="Ramsey"
  />
);
