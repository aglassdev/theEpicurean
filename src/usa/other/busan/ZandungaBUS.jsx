...
const ZandungaBUS = () => (
  <RestaurantPage
    ...
    address="41 Dongcheon-ro 108 beon-gil, Busanjin-gu, Busan, 47247, South Korea"
    cuisine="Mexican"
    priceRange="₩"
    phoneNumber="+8250713999208"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/zandunga-1243638"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a quiet alley, this spot combines an industrial, chic interior with lively music for a relaxed, inviting atmosphere. Inspired by his passion for Mexican cuisine, the chef started this restaurant. Everything from tortillas to fillings and sauces is made in-house. Fresh tortillas are prepared every morning, with colourful variations crafted from different corn varieties. The pork taco is a must-try. Warm, attentive service completes the dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41%20Dongcheon-ro%20108%20beon-gil%2C%20Busanjin-gu%2C%20Busan%2C%2047247%2C%20South%20Korea"
    pageTitle="Zandunga"
  />
);

export default ZandungaBUS;
