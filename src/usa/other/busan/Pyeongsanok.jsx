...
const Pyeongsanok = () => (
  <RestaurantPage
    restaurantName="Pyeongsanok"
    address="26 Choryangjung-ro, Dong-gu, Busan, 48818, South Korea"
    cuisine="Korean"
    priceRange="₩"
    phoneNumber="+82514686255"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/pyeongsanok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pyeongsanok, a family-run restaurant with over a century of history, continues to be celebrated for its steadfast dedication to tradition. It possesses the charm of a neighbourhood eatery with a nostalgic warmth. The menu is simple—suyuk and noodles, with yeolmu noodles as a summer addition. The suyuk, made from carefully selected Korean pork with a balanced fat-to-lean ratio, is slowly simmered to achieve a tender texture and clean, delicate flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Choryangjung-ro%2C%20Dong-gu%2C%20Busan%2C%2048818%2C%20South%20Korea"
    pageTitle="Pyeongsanok"
  />
);

export default Pyeongsanok;
