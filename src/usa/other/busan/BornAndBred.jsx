...
const BornAndBred = () => (
  <RestaurantPage
    ...
    address="B1F Paradise Hotel, 296 Haeundaehaebyeon-ro, Haeundae-gu, Busan, 48099, South Korea"
    cuisine="Steakhouse"
    priceRange="₩₩₩₩"
    phoneNumber="+82517492400"
    website="http://www.bamdb.co.kr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Premium-grade hanwoo is now served in Busan. Only top-grade female cattle (1++BMS9 grade) are hand-picked daily by highly experienced staff, aged and trimmed to a perfect thickness to create a multi-faceted flavor profile. Born and Bred also offers an omakase-style experience where diners can taste 15 to 19 different cuts of charcoal-grilled beef. The menu is filled with creative dishes like beef sashimi and beef tacos. Make sure you arrive ready to indulge yourself...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%20Paradise%20Hotel%2C%20296%20Haeundaehaebyeon-ro%2C%20Haeundae-gu%2C%20Busan%2C%2048099%2C%20South%20Korea"
    pageTitle="Born and Bred"
  />
);

export default BornAndBred;
