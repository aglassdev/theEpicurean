...
const BudaMyeonoak = () => (
  <RestaurantPage
    restaurantName="Buda Myeonoak"
    address="2F, 36 Jungdong 1-ro, Haeundae-gu, Busan, 48095, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+82517468872"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/buda-myeonoak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For those familiar with Buda Milmyeon in Banyeo-dong, the name Buda Myeonoak may ring a bell. Relocated to the present location near Haeundae Beach in 2021, this noodle haven offers Pyeongyang cold buckwheat noodles made out of 100% buckwheat flour. Unexpectedly resilient, the pure noodles reveal additional nutty flavor with each bite. The broth, made from Korean beef and mixed with vegetable broth, is earthy and mild yet full of umami. When topped with your choice of garnishes that are served separately, such as sweet and sour radish, winter cabbage, and cucumber, the noodles are sensationally addictive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2036%20Jungdong%201-ro%2C%20Haeundae-gu%2C%20Busan%2C%2048095%2C%20South%20Korea"
    pageTitle="Buda Myeonoak"
  />
);

export default BudaMyeonoak;
