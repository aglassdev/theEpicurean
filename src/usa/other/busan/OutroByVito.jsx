...
const OutroByVito = () => (
  <RestaurantPage
    restaurantName="Outro by Vito"
    address="18 Millakbondong-ro 19 beon-gil, Suyeong-gu, Busan, 48087, South Korea"
    cuisine="European"
    priceRange="₩₩"
    phoneNumber="+82517587123"
    website="https://vito.kr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With the new name Outro by Vito, the restaurant relocated from a location in the Haeridan-gil area to this spot near Gwangalli Beach. Not only did this fine purveyor of natural wine and cuisine change its name, but it also revamped its exterior and décor with a touch of contemporary elegance. Regardless, its pasta dishes, the quintessential offerings, have remained the same – only with enhanced flavors. The diner’s housemade pasta now features higher flour content and undergoes fermentation. The glutinous texture and impeccable pairing with the sauce make the pasta even more appetizing. In addition to a diverse array of pasta dishes, the menu features salads, meat, and various other scrumptious dishes. Come on down and savor your meal with a chef-recommended natural wine replete with a cul..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Millakbondong-ro%2019%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048087%2C%20South%20Korea"
    pageTitle="Outro by Vito"
  />
);

export default OutroByVito;
