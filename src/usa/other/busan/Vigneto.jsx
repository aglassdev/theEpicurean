...
const Vigneto = () => (
  <RestaurantPage
    restaurantName="Vigneto"
    address="55 Suyeong-ro 522 beon-gil, Suyeong-gu, Busan, 48299, South Korea"
    cuisine="Italian"
    priceRange="₩"
    phoneNumber="+821029818078"
    website="https://www.vignetobusan.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="[Temporarily closed]Vigneto is the very first restaurant by an owner-chef couple who settled in Busan after studying Italian cuisine at ALMA, the renowned culinary school in Italy. The building is both their home and restaurant, with the wooden ceiling and furniture in the interior creating a cozy and warm vibe. An Italian wine bar, Vigneto combines authentic Italian cuisine with a rare Italian natural wine pairing. In particular, its pastas and hams, all housemade, boast exceptional textures and flavors. For foodies who seek to revel in food and wine amidst Vigneto’s snug ambiance, we recommend reservations (which are set at 30-minute intervals)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Suyeong-ro%20522%20beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048299%2C%20South%20Korea"
    pageTitle="Vigneto"
  />
);
