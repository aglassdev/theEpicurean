...
const Torafuguga = () => (
  <RestaurantPage
    restaurantName="Torafuguga"
    address="480 Jwadongsunhwan-ro, Haeundae-gu, Busan, 48103, South Korea"
    cuisine="Fugu / Pufferfish"
    priceRange="₩₩"
    phoneNumber="+82517435432"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/torafuguga"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on a boulevard near Jungdong Intersection in the Haeundae District, Torafuguga stands out with its quaint wooden exterior and a small aquarium with live torafuku (tiger puffer) at the front. The eatery has no sign except for a small calligraphy of its name penned by the owner-chef Jung Seung-hun himself. Yet, these visual elements are enough to let you know that it’s a specialist puffer fish restaurant. Here, the chef’s precise hand movements bring out the variegated flavors of tiger puffer and deliver them, nonstop, to customers at the tables. Torafuguga’s Japanese-style puffer fish course features a wide array of faithful dishes that are parboiled, served raw in slices, fried, made into a soup, or crafted into a porridge. There are many restaurants that handle puffer fish, but fe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=480%20Jwadongsunhwan-ro%2C%20Haeundae-gu%2C%20Busan%2C%2048103%2C%20South%20Korea"
    pageTitle="Torafuguga"
  />
);

export default Torafuguga;
