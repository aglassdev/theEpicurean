...
const MeerokSuper = () => (
  <RestaurantPage
    restaurantName="Meerok Super"
    address="46 Millakbondong-ro 31beon-gil, Suyeong-gu, Busan, 48288, South Korea"
    cuisine="Asian"
    priceRange="₩₩"
    phoneNumber="+8250713713318"
    website="https://guide.michelin.com/en/busan-region/busan_1025838/restaurant/meerok-super"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Meerok Super is a small six-seat restaurant that serves outsize creativity. The vegetables grown in the on-site vegetable patch, aged fish and meat, and seasonal ingredients are transformed into the day’s tasting menu. The grilled meat course, cooked over charcoal for aroma, texture, and juiciness, and served with rice, creates a seamless transition from Western to Korean flavours. Expect to be delighted by unexpected yet harmonious flavour combinations that change daily...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20Millakbondong-ro%2031beon-gil%2C%20Suyeong-gu%2C%20Busan%2C%2048288%2C%20South%20Korea"
    pageTitle="Meerok Super"
  />
);

export default MeerokSuper;
