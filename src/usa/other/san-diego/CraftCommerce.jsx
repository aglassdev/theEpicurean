...
const CraftCommerce = () => (
  <RestaurantPage
    restaurantName="Craft & Commerce"
    address="675 W. Beech St., San Diego, 92101, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+16192692202"
    website="https://craft-commerce.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Channel your best Ernest Hemingway before entering this place, designed to the hilt and a feast for the eyes with its library-meets-hunting lodge look. From its mounted trophies to the taxidermy specimens on loan from the Natural History Museum, this may not be the wisest pick for your PETA-supporting pal, but it definitely appeals to the trendy set.The kitchen dishes out contemporary comfort food with glimmers of Asian influences. The menu is packed with hearty selections. Dig in to a dish of plump mussels in a thick red Thai coconut curry studded with pan-seared fennel slices, roasted garlic slivers and fried spicy chorizo. Bone marrow with Fresno chili relish and toasted milk bread or confit duck leg tacos up the ante...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=675%20W.%20Beech%20St.%2C%20San%20Diego%2C%2092101%2C%20USA"
    pageTitle="Craft & Commerce"
  />
);

export default CraftCommerce;
