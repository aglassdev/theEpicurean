...
const GreatMaple = () => (
  <RestaurantPage
    restaurantName="Great Maple"
    address="1451 Washington St., San Diego, 92103, USA"
    cuisine="American"
    priceRange="$"
    phoneNumber="+16192552282"
    website="https://thegreatmaple.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take the classic 50s diner, add a little swagger and you get Great Maple. It is one of four outlets statewide, but this particular location is always buzzing. Be warned though as parking and counter seats are coveted, so plan ahead.Three-course chef dinners on Mondays; burger and beer nights on Wednesdays; and prime rib Fridays are popular, but it’s also great at brunch. Fruity Pebbles pancakes, lolliwaffles on a stick and maple-bacon donuts are sweet-tooth satisfiers. Late night? Sip a Bloody Mary and tuck in to the brisket popover, a fluffy base with tender smoked meat, poached eggs and béarnaise that will cure what ails you. Seasonal dessert pies are all the rage—including the Valencia orange cream with a pistachio- and brown butter-shortbread crust...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1451%20Washington%20St.%2C%20San%20Diego%2C%2092103%2C%20USA"
    pageTitle="Great Maple"
  />
);

export default GreatMaple;
