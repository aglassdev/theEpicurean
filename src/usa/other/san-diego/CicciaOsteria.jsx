...
const CicciaOsteria = () => (
  <RestaurantPage
    restaurantName="Ciccia Osteria"
    address="2233 Logan Ave., San Diego, 92113, USA"
    cuisine="Italian, Milanese"
    priceRange="$$"
    phoneNumber="+16196744069"
    website="https://cicciasandiego.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a converted home in the heart of Barrio Logan, this adorable osteria is a true family operation—Francesca Penoncelli, who hails from Turin, leads the kitchen with her husband Mario, a Milan native, and both share duties serving tables. The quaint former living room now hosts a deli counter (where your bill will be settled) but tables in the welcoming, tree-lined courtyard are most coveted.Despite their limited space, the kitchen team turns out an impressive menu, with more than a dozen handmade pastas (three of them gluten-free). As a freebie, you’ll get to sample the feather-light focaccia with a spicy, savory mascarpone-ricotta dip, but the decadently cheesy mushroom flan and delicate olive-flecked tuna tartare are well worth their modest prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2233%20Logan%20Ave.%2C%20San%20Diego%2C%2092113%2C%20USA"
    pageTitle="Ciccia Osteria"
  />
);

export default CicciaOsteria;
