...
const HerbWood = () => (
  <RestaurantPage
    restaurantName="Herb & Wood"
    address="2210 Kettner Blvd., San Diego, 92101, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+16199558495"
    website="https://www.herbandwood.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment enjoys a loyal following. The multilevel former warehouse could lean cavernous, but its barrel-vaulted ceilings and funky artwork exude a distinct Parisian bohemian warmth. The whole place is set aglow and everyone, including the staff, wants to be here. Its wide-ranging menu runs the gamut—from rustic, wood-fired dishes including grilled trumpet mushrooms and pizzas, to more refined plates like venison over buttermilk polenta. The PB&C, a chocolate-whiskey cake with peanut butter mousse and rich milk chocolate gelato, absolutely hits the spot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2210%20Kettner%20Blvd.%2C%20San%20Diego%2C%2092101%2C%20USA"
    pageTitle="Herb & Wood"
  />
);

export default HerbWood;
