...
const RestaurantConstance = () => (
  <RestaurantPage
    restaurantName="Restaurant Constance"
    address="2200 Thrift Rd., Charlotte, NC, 28208, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+19805491999"
    website="https://restaurantconstance.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Sam Diminich named this Wesley Heights restaurant for his daughter, though his strong-but-subtle affection for local farmers and producers rings true. While you won't find them name-checking growers, you will find a natural look and feel from the dining room to the plates themselves. This is a kitchen with a global mindset, where you'll find dishes as diverse as pork belly dumplings with shiso, collard greens and chili jam alongside pan-roasted scallops from the Outer Banks topped with prosciutto and set over couscous tossed with vegetables. Like the dumplings, the jalapeño cornbread waffles have been on the menu since the very beginning with good reason. Savor variety for a better price by choosing their three-course offering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2200%20Thrift%20Rd.%2C%20Charlotte%2C%20NC%2C%2028208%2C%20USA"
    pageTitle="Restaurant Constance"
  />
);

export default RestaurantConstance;
