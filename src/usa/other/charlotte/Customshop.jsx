...
const Customshop = () => (
  <RestaurantPage
    restaurantName="Customshop"
    address="1601 Elizabeth Ave., Charlotte, NC, 28204, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+17043333396"
    website="https://www.customshopfood.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Befitting its status as a fixture of the charming Elizabeth neighborhood, Customshop offers a lively, convivial atmosphere. Chef Andrés Kaifer oversees a modern menu that blends together Latin and Italian influences with seasonal North Carolina produce in dishes that are both inventive and approachable. A hamachi crudo with parmesan leche de tigre illustrates the point beautifully with its blend of vibrant acidity and savory depth, and carefully crafted pastas like casarecce with chorizo, local mushrooms and sungold tomato broth put any doubts to rest. Eminently quaffable cocktails and a thoughtful, food-friendly wine list certainly are a bonus, especially when combined with the friendly, helpful service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1601%20Elizabeth%20Ave.%2C%20Charlotte%2C%20NC%2C%2028204%2C%20USA"
    pageTitle="Customshop"
  />
);
