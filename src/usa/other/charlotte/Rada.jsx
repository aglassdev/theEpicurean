...
const Rada = () => (
  <RestaurantPage
    restaurantName="Rada"
    address="2820 Selwyn Ave., Ste 180, Charlotte, NC, 28209, USA"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="$$$"
    phoneNumber="+17047339512"
    website="https://www.radaclt.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its sleek, understated design and metropolitan vibe, Rada might just be the hippest spot in town, but fortunately its cool trappings are accompanied by genuinely warm hospitality and crowd-pleasing cuisine. Before turning to food, whet your appetite with one of their impeccable martinis, like the San Sebastian, enlivened with Basque pepper brine. The compact, broadly Mediterranean menu is well-suited to sharing, with frequently changing options that might include small bites like eggplant escabeche or a meatball with zingy harissa, as well as more substantial fare like buttery Dover sole meuniere accented with sherry. The theme of stylish simplicity continues to the desserts, as in a sweet-savory Brillat-Savarin cheese tart with whipped honey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2820%20Selwyn%20Ave.%2C%20Ste%20180%2C%20Charlotte%2C%20NC%2C%2028209%2C%20USA"
    pageTitle="Rada"
  />
);
