...
const Bouchon = () => (
  <RestaurantPage
    restaurantName="Bouchon"
    address="6534 Washington St., Yountville, 94599, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+17079448037"
    website="https://www.thomaskeller.com/bouchonyountville"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While it may be set smack dab in the midst of quaint Yountville, Thomas Keller's take on the lively French bistro paints a scene that may as well be straight out of Paris. Picture red velvet booths, marble tables, polished brass, and that iconic tiled floor. Then throw in a buzzy scene dominated by bon vivants, a next-door bakery that ensures bread here reigns supreme, and the result is spot on.The kitchen keeps the mood upbeat thanks to a litany of well-crafted plates. Start by slathering butter onto a hunk of pain d'epi, before moving on to crispy roasted chicken over corn with bacon lardons and oyster mushrooms. Seasonal bites, like the rustic tomato, are worth a second look; while desserts like a lemon tart exude all things luxe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6534%20Washington%20St.%2C%20Yountville%2C%2094599%2C%20USA"
    pageTitle="Bouchon"
  />
);
