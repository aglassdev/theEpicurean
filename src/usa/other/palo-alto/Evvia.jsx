...
const Evvia = () => (
  <RestaurantPage
    restaurantName="Evvia"
    address="420 Emerson St., Palo Alto, 94301, USA"
    cuisine="Greek, Californian"
    priceRange="$$$"
    phoneNumber="+16503260983"
    website="https://evvia.net/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=420%20Emerson%20St.%2C%20Palo%20Alto%2C%2094301%2C%20USA"
    pageTitle="Evvia"
  />
);

export default Evvia;
