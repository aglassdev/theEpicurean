...
const SanHoWon = () => (
  <RestaurantPage
    ...
    address="2170 Bryant St., San Francisco, 94110, USA"
    cuisine="Korean, Contemporary"
    priceRange="$$$"
    phoneNumber="+14158684479"
    website="https://www.sanhowon.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Reservations are difficult to come by at this spot where the prodigious talents of heavy-hitter Chefs Corey Lee and Jeong-In Hwang are on display. Once you've found your way inside, it's safe to expect something special here, where a modern minimalist design is the perfect backdrop for a vibrant and upbeat crowd. The kitchen's assiduously refined technique deftly combines traditional Korean tastes with a sense of novelty, using impeccable ingredients to make for dishes of surpassing depth and purity of flavor, whether it be the humble kimchi or a rarefied cut of beef. The menu includes some typical barbecue items, as well as dishes rooted in home cooking such as pork jowl and aged kimchi jjigae served with soy pickled ramp...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2170%20Bryant%20St.%2C%20San%20Francisco%2C%2094110%2C%20USA"
    pageTitle="San Ho Won"
  />
);

export default SanHoWon;
