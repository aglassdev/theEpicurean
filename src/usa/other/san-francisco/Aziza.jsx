...
const Aziza = () => (
  <RestaurantPage
    restaurantName="Aziza"
    address="5800 Geary Blvd., San Francisco, 94121, USA"
    cuisine="Moroccan, Middle Eastern"
    priceRange="$$$"
    phoneNumber="+14156824196"
    website="https://www.azizasf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After shuttering his beloved Aziza in 2016, Chef Mourad Lahlou has finally made a triumphant return with this freshly minted spot. Dressed up with pale hues and a colorful bar, this remarkable menu offers a fresh take on the chef's signature Moroccan fare. As for the staff? They are (as always) gracious and well-informed. Chef Lahlou is famous for weaving California staples into dishes with stunning results. Loyalists will be happy to know the iconic specialty, Basteeya, remains—with golden phyllo wrapped around a delicious mix of shredded chicken and spiced almonds. Other staples include the slow-roasted, bone-in chicken thigh, served with crisped potato, olives, and house-made curry. Match it with buttery couscous for an utterly memorable meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5800%20Geary%20Blvd.%2C%20San%20Francisco%2C%2094121%2C%20USA"
    pageTitle="Aziza"
  />
);

export default Aziza;
