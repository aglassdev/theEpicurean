...
const SichuanHome = () => (
  <RestaurantPage
    restaurantName="Sichuan Home"
    address="5037 Geary Blvd., San Francisco, 94118, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$"
    phoneNumber="+14152213288"
    website="https://sichuan-home.menu-world.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the brightest offerings on Geary Boulevard, Sichuan Home lures diners far and wide. Its spotless dining room is a vision of varnished wood panels and mirrors, with plexiglass-topped tables for easy chili oil clean-up and menus that feature tempting photos of each item. A sampling of the wide-ranging Sichuan cuisine should include the tender lamb chops with a crunchy cumin crust or the pot of Chef's special fish stew heated tableside and served simmering with flavor. For dessert, velvety mango pudding, topped with grapefruit sorbet and fresh pineapple, is a tropical treat.Need a little guidance? The friendly staff's recommendations are always on point and they're also especially accommodating to families with young children...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5037%20Geary%20Blvd.%2C%20San%20Francisco%2C%2094118%2C%20USA"
    pageTitle="Sichuan Home"
  />
);

export default SichuanHome;
