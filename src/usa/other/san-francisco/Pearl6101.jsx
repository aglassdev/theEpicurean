...
const Pearl6101 = () => (
  <RestaurantPage
    restaurantName="Pearl 6101"
    address="6101 California St., San Francisco, 94121, USA"
    cuisine="Mediterranean Cuisine, Californian"
    priceRange="$$"
    phoneNumber="+14155929777"
    website="https://www.pearl6101.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot in a retro drugstore packs in the crowds young and old—not unlike neighboring sister, Pizzetta 211. The big and airy space is designed for all-day dining —whether that may be coffee and wood-fired bagels during the day, or a substantial dinner (and cocktail) later. The kitchen turns out a Cal-Mediterranean menu heavy on seafood and pastas, like rustic handkerchiefs in a velvety white Bolognese sauce. Carnivores can get down on a grilled bone-in pork chop, accompanied by gently charred broccolini and nectarines. And that San Francisco must—brunch—is brilliantly executed here, with enticing eggs in purgatory or Dutch baby pancakes with fresh fruit and whipped crème fraîche...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6101%20California%20St.%2C%20San%20Francisco%2C%2094121%2C%20USA"
    pageTitle="Pearl 6101"
  />
);

export default Pearl6101;
