...
const Itria = () => (
  <RestaurantPage
    restaurantName="Itria"
    address="3266 24th St., San Francisco, 94110, USA"
    cuisine="Italian, Contemporary"
    priceRange="$$"
    phoneNumber="+14158749821"
    website="https://itriasf.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Though its name comes from an obscure ancient Syrian word for pasta, this welcoming, easygoing retreat draws in a lively crowd with Italian cooking that's appealingly modern. Chef Daniel Evers employs a confidently uncomplicated approach, bringing a light touch to classic flavors and allowing simplicity to shine.The first half of the streamlined menu highlights buoyantly fresh seafood in the form of crudo, as in dayboat scallops accented with preserved lemon and sea beans. To follow, house-made pastas that show a skillful hand, like wavy mafaldine matched with pecorino and egg; or artfully stuffed cappelletti with winter squash. An affogato of fior di latte gelato and brown butter crisp makes for a fittingly unfussy finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3266%2024th%20St.%2C%20San%20Francisco%2C%2094110%2C%20USA"
    pageTitle="Itria"
  />
);

export default Itria;
