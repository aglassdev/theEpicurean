...
const MerchantRoots = () => (
  <RestaurantPage
    restaurantName="Merchant Roots"
    address="1148 Mission St., San Francisco, 94103, USA"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+14085298451"
    website="https://www.merchantroots.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Plan ahead to secure tickets to this intimate den, where there are just a handful of seats and dinner is served only four nights a week. Dining here is a singular experience—though simple, the room flaunts an impressive fiber piece from a local artisan, custom-made tableware, and other hand-hewn furnishings.Chef Ryan Shelton arranges each of his meticulously-planned menus (which change seasonally) around a central theme, as in spring flowers or fall mushrooms. You might be enchanted by an alpine cauliflower meadow, featuring tiny crunchy florets with date hummus, before entering a fungi-laden forest. The latter is laden with canapés, including an oyster mushroom jambalaya encased in a maltose sphere--it's a feast for the eyes as well as the palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1148%20Mission%20St.%2C%20San%20Francisco%2C%2094103%2C%20USA"
    pageTitle="Merchant Roots"
  />
);

export default MerchantRoots;
