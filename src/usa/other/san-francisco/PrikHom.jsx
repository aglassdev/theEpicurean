...
const PrikHom = () => (
  <RestaurantPage
    restaurantName="Prik Hom"
    address="3226 Geary Blvd., San Francisco, 94118, USA"
    cuisine="Thai, Californian"
    priceRange="$$"
    phoneNumber="+14156890652"
    website="https://www.prikhomsf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mood is relaxed at this quiet neighborhood newcomer, but the compact menu offers an excitingly fresh, vibrant take on Thai cuisine. It is owned by siblings Tanya and Jim Suwanpanya, the latter of whom runs the kitchen and applies finesse learned in fine-dining kitchens in Bangkok to approachable versions of both familiar and lesser-known dishes. The name translates to fragrant chili, and aroma is part and parcel of the cooking, from complex hand-pounded curry pastes, to a bright, herbaceous salad of crunchy lotus stem. Even a signature dessert of coconut ice cream topped with candied palm seeds and pandan-flavored rice crisps is finished with a plume of fragrant smoke from a traditional Thai incense candle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3226%20Geary%20Blvd.%2C%20San%20Francisco%2C%2094118%2C%20USA"
    pageTitle="Prik Hom"
  />
);

export default PrikHom;
