...
const CafJacqueline = () => (
  <RestaurantPage
    restaurantName="Café Jacqueline"
    address="1454 Grant Ave., San Francisco, 94133, USA"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+14159815565"
    website="https://guide.michelin.com/en/california/san-francisco/restaurant/cafe-jacqueline"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Café Jacqueline is a restaurant from another time, but for those who appreciate its eccentricities, it’s a total treasure. Savory and sweet soufflés big enough for two make up the entirety of the menu, but getting one requires endurance.Reservations are by phone only, though the staff rarely answers, and tuxedo-clad servers don’t so much serve as they do command—handling tables in a direct but never offensive manner. They are also unapologetic about just how long this candlelight dinner will take: three hours, for most, as every towering soufflé is made by the grand dame herself, who’s been whipping egg whites for nearly 40 years. From broccoli and brie to Grand Marnier and chocolate, dinner here is a special affair unmatched in its romanticism...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1454%20Grant%20Ave.%2C%20San%20Francisco%2C%2094133%2C%20USA"
    pageTitle="Café Jacqueline"
  />
);

export default CafJacqueline;
