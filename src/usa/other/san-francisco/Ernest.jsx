...
const Ernest = () => (
  <RestaurantPage
    restaurantName="Ernest"
    address="1890 Bryant St., Ste. 100, San Francisco, 94110, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+14158292961"
    website="https://www.ernestsf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once you’ve managed to make your way inside (the entrance is around the block from the address, at the corner of Florida & Mariposa), you’ll meet no additional difficulty in finding fun at this unorthodox Mission hotspot. Chef Brandon Rice’s hip, irreverent cooking style sets the vibe, exemplified in fancy-meets-comforting combos like kaluga caviar with crème fraîche and tater tots. A small, eclectic menu spans raw bar items like crudos and oysters, plus a handful of snacks and more substantial mains, all featuring top-notch seasonal products. To try nearly everything, let the kitchen take the reins in the form of a family-style fixed menu. Reservations are snapped up quickly, but the bar is open for walk-ins—the better to sample a terrific cocktail program...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1890%20Bryant%20St.%2C%20Ste.%20100%2C%20San%20Francisco%2C%2094110%2C%20USA"
    pageTitle="Ernest"
  />
);
