...
const Ssal = () => (
  <RestaurantPage
    restaurantName="Ssal"
    address="2226 Polk St., San Francisco, 94109, USA"
    cuisine="Korean, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14158142704"
    website="https://ssalsf.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hyunyoung and Junsoo Bae have ample fine dining experience but were inspired to strike out on their own to fill what they saw as a void in San Francisco's Korean restaurant scene. The result is this tasting menu that draws upon familiar flavors but sets itself apart with a sense of refined simplicity.Pop a golden puff of sweet potato pancake with a dollop of kaluga caviar straight into your mouth for a delicious bite. Then, scallop mousseline with smoked sable fish wrapped in savoy cabbage is enhanced with a beurre blanc ramped up with Kimpo Yeaju. Finally, a bowl filled with a fluffy pile of bingsu tucked with Madagascar vanilla ice cream and toasted puffed rice is the ideal ending...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2226%20Polk%20St.%2C%20San%20Francisco%2C%2094109%2C%20USA"
    pageTitle="Ssal"
  />
);
