...
const Octavia = () => (
  <RestaurantPage
    restaurantName="Octavia"
    address="1701 Octavia St., San Francisco, 94109, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+14154087507"
    website="https://www.octavia-sf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked among the Victorians that line its picture-perfect street in Lower Pac Heights, locals count themselves lucky to claim this charming, elegant dame as their neighborhood spot—though they may still need to plan ahead to score a table.Chef/owner Melissa Perello's signature brand of simple-yet-elevated cooking shows creative touches while celebrating excellent local ingredients. A meal might progress from impeccably crispy fried artichokes to silky hand-made fettucine with morels, followed by juicy quail with grapefruit and spinach, each showcasing spectacular local products in their best light. Don’t skip the baked goods: house-made levain is excellent, as are seasonal desserts like a bay leaf panna cotta with rhubarb granita and tarragon crumble...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1701%20Octavia%20St.%2C%20San%20Francisco%2C%2094109%2C%20USA"
    pageTitle="Octavia"
  />
);
