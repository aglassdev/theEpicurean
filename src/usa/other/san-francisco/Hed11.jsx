...
const Hed11 = () => (
  <RestaurantPage
    restaurantName="Hed 11"
    address="1800 Sutter St., San Francisco, 94115, USA"
    cuisine="Thai, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14158496809"
    website="https://hedeleven.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched in a swanky space at the corner of the Kimpton Hotel Enso, this ambitious Thai project from Chef Piriya Saint Boonprasan and owner Naruephon Billie Wannajaro gives a hint to its concept right in the name: an 11-course menu that celebrates regional Thai flavors with a contemporary style. The price point doesn’t lend itself to dining on a budget, but despite its variety, the meal won’t over-tax your schedule, with most of the courses arriving together as a sort of miniature banquet for the main. Sweet and savory are blended throughout the menu, whether in bites like a coconut pancake with lime and caviar, a take on khanom jeen sao nam with seared scallop paired with chilled rice noodles, tangy pineapple, and garlic, or even a Thai-style cheesecake with crispy fried onions and passion..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1800%20Sutter%20St.%2C%20San%20Francisco%2C%2094115%2C%20USA"
    pageTitle="Hed 11"
  />
);

export default Hed11;
