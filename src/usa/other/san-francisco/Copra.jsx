...
const Copra = () => (
  <RestaurantPage
    restaurantName="Copra"
    address="1700 Fillmore St., San Francisco, 94115, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$$"
    phoneNumber="+14158730795"
    website="https://www.coprarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Srijith Gopinathan’s return to San Francisco’s dining scene is a love letter to the cuisine of his home state of Kerala, on the southwestern coast of India—even the name refers to the dried coconut meat common in the cooking there. The swanky space is lush and well-lit, seemingly tailor-made to draw in influencers, though certain rustic dishes, like a shell-on Konkan crab curry featuring a sticky sauce made with tamarind, dried chiles and shallot, make dressy attire a risky, albeit delicious, proposition. The sizable menu is geared towards sharing, though the modest portions encourage enthusiastic ordering, from a “palette” of assorted brightly flavored chutneys with pappadom, to a seriously aromatic fried chicken dish inspired by a favorite street food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1700%20Fillmore%20St.%2C%20San%20Francisco%2C%2094115%2C%20USA"
    pageTitle="Copra"
  />
);

export default Copra;
