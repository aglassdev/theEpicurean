...
const LazyBear = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+14158749921"
    website="https://www.lazybearsf.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This dining spot is firmly rooted as part of San Franciso's dining landscape. The nightly tasting menu is served in a swanky, bi-level warehouse decked out like a mogul's hunting lodge. The menu has a sweeping creative scope, drawing on both nostalgia and current culinary trends with a confident swagger.Highlights include a trio of oysters, each gussied up in a different fashion: raw with pickled ramp foam and rhubarb; broiled à la Rockefeller, in a creamy green garlic glaçage; or fried with a spicy XO chili oil and tangy ranch. Bold flavors presented with flair are a common thread, like in a buttery A5 Wagyu ribeye paired with a sweet-and-savory oxtail and sour cherry tart, perfect lattice crust, and all...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3416%2019th%20St.%2C%20San%20Francisco%2C%2094110%2C%20USA"
    pageTitle="Lazy Bear"
  />
);

export default LazyBear;
