...
const Folk = () => (
  <RestaurantPage
    restaurantName="Folk"
    address="823 Meridian St., Nashville, TN, 37207, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+16156102595"
    website="https://www.goodasfolk.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This East Nashville restaurant from Chef/owner Philip Krajeck is the more casual sibling of Rolf & Daughters. Warm wood paneled walls and plenty of light lend an inviting ambience to this dining room. Chef Krajeck's contemporary menu is driven by local, seasonal produce. Items shift often but you'll always discover simple-but-satisfying plates with items like stracciatella dressed with olive oil and topped with fresh peaches or main dishes like bluefin tartare or chicken Milanese. Naturally leavened pizzas topped seasonally minded items (perhaps a summery treat of fresh sweet corn) are always a good bet. Then, round it all out with something sweet like focaccia ice cream set with rhubarb jam and whey caramel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=823%20Meridian%20St.%2C%20Nashville%2C%20TN%2C%2037207%2C%20USA"
    pageTitle="Folk"
  />
);
