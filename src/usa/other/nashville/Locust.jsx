...
const Locust = () => (
  <RestaurantPage
    restaurantName="Locust"
    address="2305 12th Ave. S., Nashville, TN, 37204, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber=""
    website="https://www.locustnashville.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Reservations here are scarce — and for good reason. Laidback, quirky and full of charm, Chef Trevor Moran's compact, Japanese-influenced hotspot is a beehive of energy. There’s a simple elegance and a clear attention to detail in every dish, all designed for sharing. Beef tartare hand rolls, a house classic, always delight. From there, explore seafood like Maine diver scallops with shaved green apple. A Japanese omelet with Jonah crab is simple but spot on. Don't skip dessert. The ever-changing iterations of their kakigori may present a sculpted block of the finest, powdery shaved ice dressed, decorated and flavored with everything from passion fruit cream to caramelized honeycomb to raspberry...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2305%2012th%20Ave.%20S.%2C%20Nashville%2C%20TN%2C%2037204%2C%20USA"
    pageTitle="Locust"
  />
);
