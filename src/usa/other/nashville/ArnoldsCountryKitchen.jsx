...
const ArnoldsCountryKitchen = () => (
  <RestaurantPage
    restaurantName="Arnold's Country Kitchen"
    address="605 8th Ave. S., Nashville, TN, 37203, USA"
    cuisine="Southern"
    priceRange="$"
    phoneNumber="+16152564455"
    website="https://www.arnoldscountrykitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ask a local where they'd go for a classic meat and three and you'll likely hear the same name again and again. Arnold's Country Kitchen is a bit of an institution. Opened in 1982 by Jack and Rose Arnold and now run by their son, Kahlil, this is Southern cooking to its core. Grab a tray and be sure to consult the specials chalked up on the board. Peruse the proteins, perhaps pork chop or brisket, and then select from a bevy of sides like turnip greens studded with cubes of tender, smoky pork. There's nothing fussy or fancy about it, but this is flavorful food that draws in crowds who flock here for a stick-to-your-ribs, down-home comfort meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=605%208th%20Ave.%20S.%2C%20Nashville%2C%20TN%2C%2037203%2C%20USA"
    pageTitle="Arnold's Country Kitchen"
  />
);

export default ArnoldsCountryKitchen;
