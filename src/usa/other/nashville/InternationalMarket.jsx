...
const InternationalMarket = () => (
  <RestaurantPage
    restaurantName="International Market"
    address="2013 Belmont Blvd., Nashville, TN, 37212, USA"
    ...
    bio="Patti Myint opened the original iteration of International Market in 1975. In 2022, her children, Anna and Arnold, relaunched the restaurant with two of the original cooks from the original restaurant. You'll still find the original's steam table specials with fried rice and curry offerings at lunch, as well as well-executed Thai classics like phad see ew and drunken noodles alongside newer items from Chef Arnold. In the evenings, it all shifts to a full-service restaurant with a cocktail and wine program. The menu features a bevy of creative Thai dishes ranging from fried trout laab and locally sourced Thai-style fried chicken to a coconut custard banana brûlée pudding...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2013%20Belmont%20Blvd.%2C%20Nashville%2C%20TN%2C%2037212%2C%20USA"
    pageTitle="International Market"
  />
);
