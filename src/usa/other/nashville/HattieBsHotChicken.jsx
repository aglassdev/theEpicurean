...
const HattieBsHotChicken = () => (
  <RestaurantPage
    restaurantName="Hattie B’s Hot Chicken"
    address="112 19th Ave. S., Nashville, TN, 37203, USA"
    cuisine="Southern, Regional Cuisine"
    priceRange="$"
    phoneNumber="+16158025700"
    website="https://www.hattieb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: Temporarily closedNashville is synonymous with hot chicken and if you want a true taste, head to Hattie B's. It's a pretty simple promise at this family-run concept. Step up to the counter and decide if it's a bones or no bones day with dark or white meat or tenders and sandwiches. Then comes the all-important decision—how hot? Southern kicks it off with no heat and then reaches increasingly hotter in five tiers. Not sure which level you want? Order the tenders with three heat levels in one dish. Sides are classic Southern staples like green beans and pimento mac and cheese, plus fried pickles and loaded fries. If you've gone a bit overboard, cool your tongue with peach cobbler topped with vanilla ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%2019th%20Ave.%20S.%2C%20Nashville%2C%20TN%2C%2037203%2C%20USA"
    pageTitle="Hattie B’s Hot Chicken"
  />
);

export default HattieBsHotChicken;
