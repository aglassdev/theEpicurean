...
const IggysNAS = () => (
  <RestaurantPage
    ...
    address="609 Merritt Ave., Ste. 101, Nashville, TN, 37203, USA"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+16156459949"
    website="https://www.iggysnashville.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Curious what this spot from brothers Ryan and Matthew Poli is all about? Take one look at the mural outside and you'll soon realize. This Wedgewood-Houston restaurant with a sleek, modern industrial look (and a glass-enclosed pasta room!) is all about Italian food.The concise menu keeps things simple with a few small plates like crispy arancini in warm goat cheese fondue or Village Bakery brioche stuffed with whipped cream cheese before a tempting array of house-made pastas like little shells with Maine peekytoe crab in a sea urchin butter. Soft serve sundaes are nonnegotiable. Lemon huckleberry with cubes of brown butter cake, lemon curd and huckleberry sauce over vanilla ice cream is a sure thing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=609%20Merritt%20Ave.%2C%20Ste.%20101%2C%20Nashville%2C%20TN%2C%2037203%2C%20USA"
    pageTitle="iggy's"
  />
);

export default IggysNAS;
