...
const Kisser = () => (
  <RestaurantPage
    restaurantName="Kisser"
    address="747 Douglas Ave., Ste. 105B, Nashville, TN, 37207, USA"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber=""
    ...
    bio="Married couple Brian Lea and Leina Horii are behind this popular restaurant that fills quickly and doesn't accept reservations. It's all about Japanese comfort food, with a nod to a kissaten, or a cozy tea shop. Their menu is concise and designed for sharing. This a team who cares about the details, and from ingredient quality to execution, it's all done with a simplified finesse. Don't miss the onigiri with three triangles of rice with different fillings, including shredded snow crab and avocado, cod roe and a curry with kabocha squash. Larger dishes include grilled yellowtail collar with a vibrant ponzu sauce or chilled ramen salad for a seasonal twist on a standby. For dessert, you won't go wrong with miso crème brûlée or yuzu parfait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=747%20Douglas%20Ave.%2C%20Ste.%20105B%2C%20Nashville%2C%20TN%2C%2037207%2C%20USA"
    pageTitle="Kisser"
  />
);
