...
const Moca = () => (
  <RestaurantPage
    restaurantName="Moëca"
    address="1 Shepard St., Cambridge, MA, 02138, USA"
    cuisine="Seafood"
    priceRange="$$$$"
    phoneNumber="+16179450040"
    website="https://www.moecarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The hum of contented diners, judicious lighting, a confident service team and a sophisticated feel to the room all reassure you the moment you enter that you’ve chosen the right spot, especially if it’s date night. Sharing is the key when it comes to the menu, where fish and shellfish are given center stage in an appealing collection of dishes, big and small. The seafood is responsibly sourced, and the flavors are global, whether that’s tamarind sauce with buttermilk-fried monkfish, or 'nduja with tuna. If you’re after some pasta, don’t look further than deliciously creamy spaghetti with Maine lobster...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Shepard%20St.%2C%20Cambridge%2C%20MA%2C%2002138%2C%20USA"
    pageTitle="Moëca"
  />
);
