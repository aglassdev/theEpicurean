...
const Pammys = () => (
  <RestaurantPage
    ...
    address="928 Massachusetts Ave., Cambridge, MA, 02139, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$$"
    phoneNumber="+16179451761"
    website="https://www.pammyscambridge.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef and owners Chris and Pam Willis run this utterly charming operation in Cambridge. With its inviting space outfitted with salvaged finds, personable service and enticing Mediterranean menu; it's the perfect neighborhood restaurant. The prix-fixe menu offers tempting flexibility and is designed to be a three-course meal bearing product-focused, Mediterranean inspiration. Baccala enriched with mascarpone and served with boquerones, dried sour cherries and puntarelle presents a riotous combination of flavors, while squid ink-tinted gnocchi are impressively light and tender. Dessert is additional; order the chocolate cake with sesame ice cream, or finish with a shot of the house-made Meyer lemon limoncello...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=928%20Massachusetts%20Ave.%2C%20Cambridge%2C%20MA%2C%2002139%2C%20USA"
    pageTitle="Pammy's"
  />
);

export default Pammys;
