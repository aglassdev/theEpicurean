...
const FunkyElephant = () => (
  <RestaurantPage
    restaurantName="Funky Elephant"
    address="1313 9th St., Berkeley, 94710, USA"
    cuisine="Thai"
    priceRange="$"
    phoneNumber="+15103564855"
    website="https://www.funkyelephantthai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Look completely past the strip mall location and head into this storefront for some of the more nuanced Thai cooking around. Pop music and colorful plastic tablecloths create a leisurely, relaxed mood. This kitchen is helmed by an ex-Hawker Fare chef, so expect spice blends and house-made curry pastes at the base of each dish.The menu is small but mighty, with items that exude a playful spirit. Nowhere is this clearer than in the “party wings,” which sound like a good time but in fact have great depth of flavor. Nam kao todd is coated in a house-made red curry paste, fried until crispy, hit with fish sauce and layered with tendrils of pork skin and crumbles of fermented pork for a vibrant taste with just the right amount of heat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1313%209th%20St.%2C%20Berkeley%2C%2094710%2C%20USA"
    pageTitle="Funky Elephant"
  />
);

export default FunkyElephant;
