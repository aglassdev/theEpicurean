...
const ChezPanisse = () => (
  <RestaurantPage
    ...
    address="1517 Shattuck Ave., Berkeley, 94709, USA"
    cuisine="Californian"
    priceRange="$$$$"
    phoneNumber="+15105485525"
    website="https://www.chezpanisse.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alice Waters’ high temple to locavorism continues to flourish as the Bay Area’s icon of Californian cuisine. The bright-eyed team of chefs here work their magic in a gleaming open kitchen that is set at the very back of the dining room, dominated by an aromatic wood-burning oven.Downstairs in the main restaurant, diners are privy to a rotating four-course fixed menu; upstairs, in the café, à la carte offerings are served. No two menus are alike, but rest assured the dishes will feature only the finest peak-season produce—from fresh peas, asparagus and black truffle in a spring risotto, to sweet corn and squash blossoms served with a summer preparation of pork loin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1517%20Shattuck%20Ave.%2C%20Berkeley%2C%2094709%2C%20USA"
    pageTitle="Chez Panisse"
  />
);

export default ChezPanisse;
