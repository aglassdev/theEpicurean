...
const StreetToKitchen = () => (
  <RestaurantPage
    restaurantName="Street to Kitchen"
    address="3401 Harrisburg Blvd., Houston, 77003, USA"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+12815013435"
    website="https://streettokitchen.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once housed in a squat room connected to a gas station at the foot of a highway, this knockout Thai restaurant has moved just down the street. Still, you’ll probably need reservations. Chef Benchawan Jabthong Painter and her husband have rightfully won over the hearts and appetites of the city with fearless, fiery cooking. Start with the papaya salad, but be warned: This opening act, even at medium spice level, takes no prisoners. There must also be pad see ew, which is a masterclass in charred noodle excellence. The house-made curries are deeply flavored; the green one is notable. All the while, the spacious room bounces along to Thai hip hop blaring overhead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3401%20Harrisburg%20Blvd.%2C%20Houston%2C%2077003%2C%20USA"
    pageTitle="Street to Kitchen"
  />
);

export default StreetToKitchen;
