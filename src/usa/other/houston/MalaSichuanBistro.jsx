...
const MalaSichuanBistro = () => (
  <RestaurantPage
    restaurantName="Mala Sichuan Bistro"
    address="9348 Bellaire Blvd., Houston, 77036, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$"
    phoneNumber="+17139951889"
    website="https://www.malasichuan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From Katy to Sugarland to Montrose, this Sichuan restaurant has spread its wings across the Houston area and beyond. The story begins at the original location, which opened in 2011 in Bellaire’s Chinatown. Whereas many Sichuan restaurants submerge everything in pools of chili oil, this kitchen takes a more measured approach. And true to its name, dishes boast a distinct thread of tangy bitterness and tongue-numbing heat but never so much that you’ll sweat. Highlights include silky cubes of tofu sitting in a mala bean curd sauce, firm filets of white fish blanketed in garlic, ginger and red chili powder, and chewy, house-made wheat noodles tossed in a peanut-based vinaigrette. A particularly descriptive menu helps decode dishes to first timers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9348%20Bellaire%20Blvd.%2C%20Houston%2C%2077036%2C%20USA"
    pageTitle="Mala Sichuan Bistro"
  />
);

export default MalaSichuanBistro;
