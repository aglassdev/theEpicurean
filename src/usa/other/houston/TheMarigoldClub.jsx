...
const TheMarigoldClub = () => (
  <RestaurantPage
    restaurantName="The Marigold Club"
    address="2531 Kuester St., Houston, TX, 77006, USA"
    cuisine="European, French Contemporary"
    priceRange="$$$$"
    phoneNumber="+18327811901"
    website="https://themarigoldclub.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sleek spot in Montrose mixes Mayfair elegance with Houston’s vibrant energy. Elegant yet approachable, it's a stylish space for dressing up for dinner or sharing oysters and caviar at the bar. A player piano adds to the ambience.Chef Austin Waiter puts a British twist and a fresh spin on a French-inspired menu. From seafood towers and miniature gougères piped with chicken liver mousse to duck Wellington, the offerings lean decadent. Veal cuscinetto, a bone-in chop stuffed with prosciutto and Comté, is topped with vermouth figs and set over a mostarda sauce for an especially refined dish, while braised leeks in sauce gribiche make for a worthy side. For dessert, the baba-misu is an intriguing riff on two classics...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2531%20Kuester%20St.%2C%20Houston%2C%20TX%2C%2077006%2C%20USA"
    pageTitle="The Marigold Club"
  />
);

export default TheMarigoldClub;
