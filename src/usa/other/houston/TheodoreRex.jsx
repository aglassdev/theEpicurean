...
const TheodoreRex = () => (
  <RestaurantPage
    restaurantName="Theodore Rex"
    address="1302 Nance St., Unit A, Houston, 77002, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+18328308592"
    website="https://trexhouston.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the shadow of downtown Houston right off Highway 10 is Justin Yu’s wedge of a restaurant. There’s little else in the area, but the red stop sign at the intersection is, poignantly enough, also at the front door. Counter seating is practically shoulder to shoulder, but it is a prime perch for taking in all that this welcoming restaurant has to offer. The cuisine is hard to pin down but know that everything looks simpler than it really is and is seasoned far better than you could have imagined. It's also all intended for sharing. Highlights include fried bread with tomato fondant and Gulf redfish crusted in toast and served with a fermented green garlic-green pea puree. Don’t leave without trying the warm, brûléed butter cake smeared with strawberry jam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1302%20Nance%20St.%2C%20Unit%20A%2C%20Houston%2C%2077002%2C%20USA"
    pageTitle="Theodore Rex"
  />
);

export default TheodoreRex;
