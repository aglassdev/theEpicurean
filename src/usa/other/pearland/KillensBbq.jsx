...
const KillensBbq = () => (
  <RestaurantPage
    restaurantName="Killen's BBQ"
    address="3613 Broadway St., Pearland, 77581, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+12814852272"
    website="https://www.killensbarbecue.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the quiet city of Pearland, native Texan Ronnie Killen barbecues like few others in the Lone Star state. Everyone waits patiently before doors open at 11 a.m., when the crowd moves fast through, what used to be, the city’s first school cafeteria. Sourcing from Snake River Farms, Killen offers a first-class beef rib smoked just out back that is a silken delight and sings of smoke, salt, fat, and pepper. You could cut it with a spoon. And regardless of what your doctor says, order those melting cubes of pork belly burnt ends tossed in a pepper jelly sauce. Brussels sprouts and collards sopping in potlikker offer some reprieve from the meat. First timers won’t have room for dessert, but veterans never lose sight of the crème brûlée bread pudding...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3613%20Broadway%20St.%2C%20Pearland%2C%2077581%2C%20USA"
    pageTitle="Killen's BBQ"
  />
);

export default KillensBbq;
