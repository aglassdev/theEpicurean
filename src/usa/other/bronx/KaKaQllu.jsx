...
const KaKaQllu = () => (
  <RestaurantPage
    restaurantName="Çka Ka Qëllu"
    address="2321 Hughes Ave., Bronx, 10458, USA"
    cuisine="Balkan, Country cooking"
    priceRange="$$"
    phoneNumber="+17189336194"
    website="https://ckakaqellu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Albanian presence in the Bronx has steadily grown since the 1990’s, with residential pockets taking root in various neighborhoods throughout. Now, lucky us, comes the delicious food of the motherland—most recently, the hard-to-pronounce-but-so-worth-a-visit, Çka Ka Qëllu.Located next to the rear entrance of the Arthur Avenue Retail Market, this dining room is a celebration of all things Albanian—picture glass cases full of intricate regional garb and ornate frames with sepia-toned photos. The food is simple, comforting, and filling—think burek, a golden-brown phyllo pastry stuffed with soft cheese, and sarma, or cabbage rolls filled with ground veal, rice, and vegetables. The brumat, featuring a number of Albanian specialties, makes for a great introductory course...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2321%20Hughes%20Ave.%2C%20Bronx%2C%2010458%2C%20USA"
    pageTitle="Çka Ka Qëllu"
  />
);

export default KaKaQllu;
