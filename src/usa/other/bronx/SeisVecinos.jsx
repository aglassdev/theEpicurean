...
const SeisVecinos = () => (
  <RestaurantPage
    restaurantName="Seis Vecinos"
    address="640 Prospect Ave., Bronx, 10455, USA"
    cuisine="Latin American, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+17186848604"
    website="https://www.seisvecinos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting on a prominent corner at the base of an ornate yet classic NYC building is this now-well ensconced restaurant. The interior is sunny and welcoming with a gracious staff to boot; the menu is melting pot Central America featuring papusas from El Salvador, baleadas from Honduras, and fajitas from Mexico. Guacamole made tableside in a molcajete is a great way to begin the meal before a main dish like enchiladas made with tender corn tortillas stuffed with shredded, seasoned chicken, topped with a smoky red sauce, crema, and queso.Breakfast delivers hearty offerings such as picaditas verdes with carne al gusto or huevos revueltos con verduras y casamiento...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=640%20Prospect%20Ave.%2C%20Bronx%2C%2010455%2C%20USA"
    pageTitle="Seis Vecinos"
  />
);

export default SeisVecinos;
