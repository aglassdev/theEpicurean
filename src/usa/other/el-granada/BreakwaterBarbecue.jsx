...
const BreakwaterBarbecue = () => (
  <RestaurantPage
    restaurantName="Breakwater Barbecue"
    address="10151 Cabrillo Hwy., El Granada, 94018, USA"
    cuisine="Barbecue, American"
    priceRange="$$"
    phoneNumber="+16507135303"
    website="https://www.breakwaterbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just about ten minutes north of Half Moon Bay in the charming seaside town of El Granada, Breakwater Barbecue is an all-American spot tucked inside a historic railroad station. Inside, you'll find a coastal cowboy aesthetic, with a friendly, laid-back vibe to match. A signature burger has many admirers, but it's the Texas Trinity that serves as the crowning culinary achievement here: an assortment of lovingly slow-smoked brisket, pork ribs, and spicy sausage links (made with pork and beef), served with pickles, thick-cut bread, and a choice of sides. To accompany, Merle's potato salad and beans and greens are good choices, but a sausage-and-brisket chili braised in smoked pork stock offers its own appeal, especially matched with a miniature cornbread loaf...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10151%20Cabrillo%20Hwy.%2C%20El%20Granada%2C%2094018%2C%20USA"
    pageTitle="Breakwater Barbecue"
  />
);

export default BreakwaterBarbecue;
