...
const Saltwater = () => (
  <RestaurantPage
    restaurantName="Saltwater"
    address="12781 Sir Francis Drake Blvd., Inverness, 94937, USA"
    cuisine="Seafood"
    priceRange="$$$"
    phoneNumber="+14156691244"
    website="https://www.saltwateroysterdepot.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you love oysters, this coastal-chic spot will have you as happy as a clam. Nearly half its menu features these ultra-fresh bivalves plucked straight from nearby Tomales Bay—whether raw, broiled with chili-garlic butter or simmered in a creamy leek stew. If oysters aren't your thing, there’s also plenty of other local seafood to choose from, including crisp-skinned steelhead trout or risotto with clams and uni. Carnivores can opt for a roasted pork chop with collard greens.Set in a country-style house, Saltwater is a small town hot spot that attracts casual couples of all ages for local beer and wine on tap. The menu changes often to reflect the best of its markets, so be sure to pounce on such dishes as spicy gingerbread cake before they vanish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12781%20Sir%20Francis%20Drake%20Blvd.%2C%20Inverness%2C%2094937%2C%20USA"
    pageTitle="Saltwater"
  />
);
