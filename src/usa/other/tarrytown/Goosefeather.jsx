...
const Goosefeather = () => (
  <RestaurantPage
    restaurantName="Goosefeather"
    address="49 E. Sunnyside Ln., Tarrytown, 10591, USA"
    cuisine="Cantonese, Asian"
    priceRange="$$$"
    phoneNumber="+19148295454"
    website="https://www.goosefeatherny.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This destination-worthy dining room is coveted for its idyllic setting of sprawling estate grounds with a carriage house, cottage, and two historic, freshly minted mansions. Nestled within these luxurious surrounds is Goosefeather, where guests are greeted by well-appointed nooks, all blending old-fashioned charm with new-world elements.The menu is surprisingly unforgettable as conceived by Dale Talde. Known for his craft with Hong Kong-style food, the talented chef infuses these staples with a modern, seasonal twist. Kung pao chicken wings with a buttermilk dill ranch dip gives a familiar favorite a new lease on life. Bao, with a salty-sweet crispy shrimp filling mixed with cool daikon and cabbage, is an absolute must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49%20E.%20Sunnyside%20Ln.%2C%20Tarrytown%2C%2010591%2C%20USA"
    pageTitle="Goosefeather"
  />
);

export default Goosefeather;
