...
const MintPremiumFoods = () => (
  <RestaurantPage
    restaurantName="Mint Premium Foods"
    address="19 Main St., Tarrytown, 10591, USA"
    cuisine="Mediterranean Cuisine, Gastropub"
    priceRange="$$$"
    phoneNumber="+19147036511"
    website="https://www.mintpremiumfoods.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Both a gourmet market and full-service restaurant, this premium haven resides on a charming block in the equally charming Tarrytown. Up front, a retail area teems with food from around the world. Further along the deep and narrow space, find exposed brick walls, antique artifacts and a smattering of tables.The semi-open kitchen turns out a menu that meanders around the Mediterranean, resulting in hearty seafood, savory steaks and charcuterie aplenty. Sip on a beer from their large selection and nibble on grilled dates stuffed with creamy goat cheese and prosciutto as you peruse the menu, taking note of the especially tempting burgers on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Main%20St.%2C%20Tarrytown%2C%2010591%2C%20USA"
    pageTitle="Mint Premium Foods"
  />
);

export default MintPremiumFoods;
