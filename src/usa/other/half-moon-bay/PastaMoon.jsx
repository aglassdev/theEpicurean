...
const PastaMoon = () => (
  <RestaurantPage
    restaurantName="Pasta Moon"
    address="845 Main St., Half Moon Bay, 94019, USA"
    cuisine="Italian, Californian"
    priceRange="$$$"
    phoneNumber="+16507265125"
    website="https://www.pastamoon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of Half Moon Bay’s most popular restaurants, Pasta Moon is always packed to the gills with locals and tourists filling up on massive portions of hearty Italian-American fare. With its vaulted ceilings, open kitchen and multiple dining rooms, including one with views of the Pilarcitos Creek and lush garden, it's a hit among all ages.Recognized by Slow Food U.S.A., expect artisanal products like the house-made pastas that steal the show, with tempting options like the spaghetti with a luscious puttanesca sauce brimming with seafood and just a hint of heat. Thin-crust pizza Margherita with its garlic-kissed tomato sauce is a delight, but oh that mascarpone cheese cake with a chocolate cookie crust. It's bound to send you over the moon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=845%20Main%20St.%2C%20Half%20Moon%20Bay%2C%2094019%2C%20USA"
    pageTitle="Pasta Moon"
  />
);

export default PastaMoon;
