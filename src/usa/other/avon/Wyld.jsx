...
const Wyld = () => (
  <RestaurantPage
    restaurantName="WYLD"
    address="130 Daybreak Ridge Rd., Avon, 81620, USA"
    cuisine="American, Contemporary"
    priceRange="$$$"
    phoneNumber="+19703431168"
    website="https://www.ritzcarlton.com/en/hotels/whrrz-the-ritz-carlton-bachelor-gulch/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled inside The Ritz-Carlton, Bachelor Gulch, this sophisticated restaurant is far from wild. Instead, it's the very picture of rustic refinement right down to the large windows framing postcard-perfect views of Beaver Creek. Settle in to this laid-back luxe spot and share stories of the day's alpine adventures over likeable dishes like salsa macha atop a crisp tostada with avocado aioli and slices of albacore. Earthy red and yellow beets rest over a creamy, tart tzatziki sprinkled with toasted pumpernickel breadcrumbs in a refreshing first course. Heartier entrees, like chicken under a brick with roasted carrots, parsnips and celery root puree, are especially satisfying after epic days filled with skiing or hiking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=130%20Daybreak%20Ridge%20Rd.%2C%20Avon%2C%2081620%2C%20USA"
    pageTitle="WYLD"
  />
);
