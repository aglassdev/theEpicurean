...
const SmokenAshBbq = () => (
  <RestaurantPage
    restaurantName="Smoke'N Ash BBQ"
    address="5904 S. Cooper St., Ste. 110, Arlington, 76017, USA"
    cuisine="Barbecue, Ethiopian"
    priceRange="$$"
    phoneNumber="+18173859975"
    website="https://www.smokenashbbq.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Husband and wife Patrick and Fasicka Hicks started like many other barbecue spots with a trailer smoker and weekend pop-ups, but that's where most of the similarities end. This casual Arlington spot with booth and table seating and a welcoming ambience bills its barbecue as Tex-Ethiopian. There are some typical Texan classics, but it's their barbecue seared with awaze, an Ethiopian-spice sauce, that truly stands out. Sold by the half-pound, platters are the way to go if you want to sample more of the offerings like skillfully smoked brisket and tender pulled lamb. They have the classic sides like mac and cheese and potato salad, but try something different like their collard greens, fried okra, or Ethiopian lentil stews...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5904%20S.%20Cooper%20St.%2C%20Ste.%20110%2C%20Arlington%2C%2076017%2C%20USA"
    pageTitle="Smoke'N Ash BBQ"
  />
);

export default SmokenAshBbq;
