...
const ChugsDiner = () => (
  <RestaurantPage
    restaurantName="Chug's Diner"
    address="3444 Main Hwy., Ste. 21, Miami, 33133, USA"
    cuisine="Cuban"
    priceRange="$$"
    phoneNumber="+17863532940"
    website="https://chugsdiner.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What started out as a small café has grown overnight into this full-scale, Coconut Grove essential. All credit is due to Chef Michael Beltran who runs this terrific Cuban diner, fitted with dangling greenery and cozy booths. Truly, if this kitchen were a car, it would break the speed limit, as the team hurries about—opening early, closing late and cooking with panache.One could make a meal out of the oxtail ajiaco alone, a satisfying Colombian stew that cures all ills. But then you wouldn’t have room for the several towering sandwiches, served on fluffy Cuban bread. No meal is complete without at least one of their guava- and cream-cheese pastelitos. Their warm, flaky pastry alone will guarantee a return visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3444%20Main%20Hwy.%2C%20Ste.%2021%2C%20Miami%2C%2033133%2C%20USA"
    pageTitle="Chug's Diner"
  />
);

export default ChugsDiner;
