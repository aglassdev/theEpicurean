...
const Recoveco = () => (
  <RestaurantPage
    restaurantName="Recoveco"
    address="6000 S.W. 74th St., Ste. 1, Miami, 33143, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+13052041811"
    website="https://recovecorestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This South Miami restaurant from Chefs Maria Teresa Gallina and Nicolas Martinez may be diminutive but there's plenty of personality packed into this small space. The menu echoes that tiny-but-mighty sentiment with a concise format that shifts often, particularly with the seasons. Small and large plates are approachable but far from standard. The chicken liver mousse displays their signature flair, with house-made speculaas cookies made with peppercorn and cardamom piped with ribbons of velvety mousse and a starfruit jam. Roasted dry-aged chicken is a signature, though, if on offer, the wagyu ribeye in a banana au poivre is a nice choice. For dessert, sapodilla sticky toffee pudding is a sweet closer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6000%20S.W.%2074th%20St.%2C%20Ste.%201%2C%20Miami%2C%2033143%2C%20USA"
    pageTitle="Recoveco"
  />
);

export default Recoveco;
