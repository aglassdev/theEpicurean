...
const Bachour = () => (
  <RestaurantPage
    restaurantName="Bachour"
    address="2020 Salzedo St., Miami, 33134, USA"
    cuisine="Contemporary, Bakery"
    priceRange="$$"
    phoneNumber="+13052030552"
    website="https://www.antoniobachour.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to the workshop of Chef Antonio Bachour, a talented baker whose brightly colored tarts and elaborate pastries take center stage in this industrial setting. Open since 2019, an arch of roses marks the entrance to this busy daytime spot. Once inside, a perch at the counter in the back offers diners a front-row view of the glass-enclosed bakery. Seating aside, a simple lunch of ham croquettes, crab tostones, or a salad is the best way to start before going all-in on a dazzling array of sweets. Think mango-passion fruit macarons, flaky croissants striped with vibrant green bands of pistachio, indulgent Parisian flans, and other ornate creations that resemble oranges and raspberries. Don’t worry about overordering – these treats travel well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2020%20Salzedo%20St.%2C%20Miami%2C%2033134%2C%20USA"
    pageTitle="Bachour"
  />
);

export default Bachour;
