...
const SunnysSteakhouse = () => (
  <RestaurantPage
    restaurantName="Sunny’s Steakhouse"
    address="7357 N.W. Miami Ct., Miami, 33150, USA"
    cuisine="Steakhouse"
    priceRange="$$$$"
    phoneNumber=""
    website="https://sunnysmia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Little River hot spot effortlessly blends a chic old-meets-new Florida look and feel, and it's always buzzing with an equally good-looking crowd. As for the food, think classic American steakhouse with added luxury and a few local nods (stone crab claws). Pasta and several main dishes with plenty of swagger are appealing but it would be a sin to skip the steak. Selections range from shareable cuts to those sized for individuals, and though flavorful enough on their own, sauces like pineapple hot sauce and a rich bone marrow vinaigrette are a nice surprise. Russet potatoes fried in chicken schmaltz for a cross between smashed and roasted are a perfect side but save room for the decadent kouign-amann ice cream sandwich...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7357%20N.W.%20Miami%20Ct.%2C%20Miami%2C%2033150%2C%20USA"
    pageTitle="Sunny’s Steakhouse"
  />
);

export default SunnysSteakhouse;
