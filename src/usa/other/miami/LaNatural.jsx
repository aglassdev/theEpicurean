...
const LaNatural = () => (
  <RestaurantPage
    restaurantName="La Natural"
    address="7289 N.W. 2nd Ave., Miami, 33150, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+13054190377"
    website="https://www.lanaturalmiami.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You wouldn’t think to make reservations for a pizza place in Little River, but think again. The crowds can be relentless at this popular hangout, which feels rather like an underground party by way of concrete floors and dim lighting.Creative toppings like za’atar and Sichuan peppercorns sing on stunning, picture-perfect pies zealously charred in a wood-burning oven hiding behind the bar. We’re partial to the classic burrata and basil pie, which arrives puffy and pillowy thanks to the signature crust that's cold-fermented for 48 hours. An astute selection of starters (try the papaya with kumquat) and one of the city’s longest lists for natural wines only add to the appeal of this essential pizzeria. A personable staff keeps a close watch on every table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7289%20N.W.%202nd%20Ave.%2C%20Miami%2C%2033150%2C%20USA"
    pageTitle="La Natural"
  />
);

export default LaNatural;
