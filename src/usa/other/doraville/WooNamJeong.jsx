...
const WooNamJeong = () => (
  <RestaurantPage
    restaurantName="Woo Nam Jeong"
    address="5953 Buford Hwy. NE, Doraville, GA, 30340, USA"
    cuisine="Korean"
    priceRange="$$"
    phoneNumber="+16785300844"
    website="https://stonebowlhouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Anchoring the corner of a shopping center along Buford Highway, this busy spot features an expansive Korean menu. With so many options, it may be difficult to pick just one but start with a seafood or kimchi pancake or their seared mandu and you won't go wrong. Then, plenty of specialties tempt but you're here for one in particular: the house specialty stone bowl bibimbap. Take a peek at the neighboring tables and nearly everyone is tucking into one of these signature dishes. Bulgogi, or tender beef, is the classic order, and it arrives in the stone bowl sizzling long after it is set atop the table. Rice that has been crisped sits at the base, with beef, vegetables, and a sunny side up egg on top for a delicious one-pot dish that will make you a regular in no time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5953%20Buford%20Hwy.%20NE%2C%20Doraville%2C%20GA%2C%2030340%2C%20USA"
    pageTitle="Woo Nam Jeong"
  />
);

export default WooNamJeong;
