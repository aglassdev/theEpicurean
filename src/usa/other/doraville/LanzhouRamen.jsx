...
const LanzhouRamen = () => (
  <RestaurantPage
    restaurantName="LanZhou Ramen"
    address="5231 Buford Hwy. NE, Doraville, GA, 30340, USA"
    cuisine="Chinese, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+16786912175"
    website="https://lanzhouramenatlanta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on Buford Highway in a busy shopping center, LanZhou is both the name of a Chinese city and a type of hand-pulled noodle that just so happens to be this spot's main attraction. Those delicious noodles are available in hearty soups with a variety of proteins, and also come broth-less. From there, broad Sichuan-leaning dishes tempt diners. Fried pot stickers sport a beautiful crispy, lacy base and delight with a savory goodness. Roast duck hand-pulled noodle soup is pure, unadulterated satisfaction, slurp by glorious slurp. Served in a massive bowl bobbing with bouncy noodles, baby bok choy, roast bone-in duck and scallions, it's loaded with flavor and will certainly cure whatever ails you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5231%20Buford%20Hwy.%20NE%2C%20Doraville%2C%20GA%2C%2030340%2C%20USA"
    pageTitle="LanZhou Ramen"
  />
);

export default LanzhouRamen;
