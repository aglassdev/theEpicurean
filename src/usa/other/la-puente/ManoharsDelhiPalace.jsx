...
const ManoharsDelhiPalace = () => (
  <RestaurantPage
    restaurantName="Manohar’s Delhi Palace"
    address="581 Azusa Way, La Puente, 91744, USA"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+16269640343"
    website="https://www.mdelhipalace.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=581%20Azusa%20Way%2C%20La%20Puente%2C%2091744%2C%20USA"
    pageTitle="Manohar’s Delhi Palace"
  />
);

export default ManoharsDelhiPalace;
