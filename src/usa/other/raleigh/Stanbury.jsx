...
const Stanbury = () => (
  <RestaurantPage
    restaurantName="Stanbury"
    address="938 N. Blount St., Raleigh, NC, 27604, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+19199774321"
    website="https://www.stanburyraleigh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in the sleepy Mordecai neighborhood in a former grocery store, Stanbury is a favorite with the locals. They don't take reservations, so you'll need to arrive early when they open around 4:30 pm or wait with a drink in hand on their decked terrace. The menu is as eclectic as the place itself (think hunting lodge with taxidermy). You'll find everything from European to Mexican dishes on this menu, including a roasted marrow with parsley and capers that feels straight out of London. While the menu leans international, North Carolina seasonal produce is always the centerpiece. You'll want to try a bit of everything, and sharing is encouraged in this fun spot that brims with energy. You'll leave wishing they had a branch in your neighborhood too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=938%20N.%20Blount%20St.%2C%20Raleigh%2C%20NC%2C%2027604%2C%20USA"
    pageTitle="Stanbury"
  />
);

export default Stanbury;
