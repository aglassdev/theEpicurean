...
const Jolie = () => (
  <RestaurantPage
    restaurantName="Jolie"
    address="620 N. Person St., Raleigh, NC, 27604, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+19198037221"
    website="https://restaurantjolie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting right next door to one of his other restaurants, Crawford and Son, Chef Scott Crawford has created his version of a classic French bistro in Historic Oakwood at Jolie. Inspired by family trips to Paris and named after his daughter, the menu blends French classics with more modern interpretations, marrying punchy flavors with clear respect for traditional techniques. Steak tartare and French onion soup are two signatures not to be skipped, as is the delicious rum-soaked baba. The wine list is strictly French; stop by and get a glass of bubbles from their champagne window out front or sip a glass on the semi-covered, first-floor roof terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=620%20N.%20Person%20St.%2C%20Raleigh%2C%20NC%2C%2027604%2C%20USA"
    pageTitle="Jolie"
  />
);
