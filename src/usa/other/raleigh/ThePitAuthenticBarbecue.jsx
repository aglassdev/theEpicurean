...
const ThePitAuthenticBarbecue = () => (
  <RestaurantPage
    restaurantName="The Pit Authentic Barbecue"
    address="328 W. Davie St., Raleigh, NC, 27601, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+19198904500"
    website="https://www.thepit-raleigh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You'll certainly smell the smoke from around the block before you even spot this former warehouse in the aptly named Warehouse district. From that first whiff, it's clear that North Carolina barbecue is the name of the game here, and this spot offers more than your average bbq joint. Start with freshly cooked cornbread with a seasonal, flavored butter and some fried green tomatoes. The chopped BBQ pork is the mainstay, of course, but with ribs, smoked sausages, catfish and shrimp, decision-making isn't easy. Order one of the combos with a choice of sides, but don't fill up too much, as you'll want a slice of their carrot cake. Draft beers and a U.S.-focused wine list are a nice addition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=328%20W.%20Davie%20St.%2C%20Raleigh%2C%20NC%2C%2027601%2C%20USA"
    pageTitle="The Pit Authentic Barbecue"
  />
);

export default ThePitAuthenticBarbecue;
