...
const Farmstead = () => (
  <RestaurantPage
    restaurantName="Farmstead"
    address="738 Main St., Saint Helena, 94574, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+17079634555"
    website="https://www.longmeadowranch.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a down-home (but still Napa-chic) alternative to the Cal-Ital wine country grind, follow your nose to this Long Meadow Ranch-owned farmhouse, whose intoxicating smoker is parked right in the front yard. The cathedral ceiling, old-school country music and boisterous locals give Farmstead a permanent buzz; for quieter dining, hit the front terrace.Dishes are laden with ranch-grown products utilized in outstanding preparations like a summery salad of heirloom tomatoes and creamy burrata with salsa verde. The bone-in heritage porkchop with apple chutney on a bed of creamy jalapeno grits and grilled broccolini is spot-on. Take the farm-fresh flavor with you—on weekends the restaurant's stands are brimming with produce, beef and honey for purchase...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=738%20Main%20St.%2C%20Saint%20Helena%2C%2094574%2C%20USA"
    pageTitle="Farmstead"
  />
);

export default Farmstead;
