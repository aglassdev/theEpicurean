...
const Evelyns = () => (
  <RestaurantPage
    restaurantName="Evelyn's"
    address="525 N. Fort Lauderdale Beach Blvd., Fort Lauderdale, 33304, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$$"
    phoneNumber="+17543363100"
    website="https://www.evelynsfortlauderdale.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="All-day dining in hotels isn't typically anything to write home about but you're in for a different experience at Evelyn's inside the Four Seasons Hotel Fort Lauderdale. As might be expected given the location, the look is coastal chic with views extending over the pool and beyond to the Atlantic Ocean. Coastal Floridian influences find their way into dishes with a Levantine focus. Begin with a smattering of spreads or a small plate, then opt for a skewer like the pomegranate-glazed ora king salmon. Large plates like the cider-braised beef tagine are designed for sharing. Dessert is worth saving room for, with a large list of favorites including a pistachio mille feuille that riffs on baklava with delicious results...."
