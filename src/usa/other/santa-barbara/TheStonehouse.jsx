...
const TheStonehouse = () => (
  <RestaurantPage
    restaurantName="The Stonehouse"
    address="900 San Ysidro Ln., Santa Barbara, 93108, USA"
    cuisine="American"
    priceRange="$$$$"
    ...
    bio="San Ysidro Ranch is a dreamy setting for this rustic stone house, punctuated by lush gardens, creekside views, rough-hewn beams and a wood-burning fireplace. In the kitchen, hyper-local regional cooking rules, with many of the herbs, fruits and veggies harvested on the property. Arrive early to walk the grounds before your meal. There is exclusivity in the air, which seems to match the affluent diners and informed servers. Regulars aim for seats on the patio along with simpler bites, like the burger or crab cakes; while others may delve into such finer things as a three-course prix-fixe, starring hamachi sashimi, pan-roasted striped bass, and a signature Meyer-lemon tart.The list of global wines and liquors is far from rote and has everyone smitten...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=900%20San%20Ysidro%20Ln.%2C%20Santa%20Barbara%2C%2093108%2C%20USA"
    pageTitle="The Stonehouse"
  />
);

export default TheStonehouse;
