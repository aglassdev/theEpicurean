...
const BibiJi = () => (
  <RestaurantPage
    restaurantName="Bibi Ji"
    address="1213 State St. B., Santa Barbara, 93101, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$"
    phoneNumber="+18055606845"
    website="https://bibijisb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With their name emblazoned in pink, this trendy Indian from co-owners Alejandro Medina and noted sommelier Rajat Parr makes quite the splash. Inside, the space is small but well appointed, with vaulted ceilings and chandeliers; the patio outside is a verdant, summertime delight. Harnessing the best of land and sea, these dishes are born for sharing. Behold such inventive bites as crispy cauliflower tossed with chili-garlic sauce and finished with sesame. Barra kebab highlights intensely spiced tandoor lamb chops with mint chutney; while vegetables like baingan bharta (eggplant with ginger) are a heady treat. The cooking is strong and flavors well executed. No wonder, dessert is an afterthought.A list of natural wines merely augments the focused carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1213%20State%20St.%20B.%2C%20Santa%20Barbara%2C%2093101%2C%20USA"
    pageTitle="Bibi Ji"
  />
);

export default BibiJi;
