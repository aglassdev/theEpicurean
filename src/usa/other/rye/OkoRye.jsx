...
const OkoRye = () => (
  <RestaurantPage
    restaurantName="OKO Rye"
    address="29 Purchase St., Rye, 10580, USA"
    cuisine="Asian, Japanese"
    priceRange="$$$"
    phoneNumber="+19144818660"
    website="https://okokitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite all signs, this isn't so much a Japanese haunt as much as it is the chef's own interpretation of the same nation's cuisine. The light-filled space hums with an attractive crowd, including locals who convene—under a lofty ceiling—at the welcoming bar. If that doesn't scream neighborhood jewel, an open kitchen offering creative bites is sure to fill the bill.This contemporary Asian restaurant features everything from nigiri, sashimi and handrolls to tempura and hot dishes. Madeira-miso black cod as well as crab-and-pork dumplings are favorites; but those who choose the omakase may enjoy petite bites such as cedar-smoked black cod with crispy beets, chutoro with sweet onion dashi or red king crab with chili butter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Purchase%20St.%2C%20Rye%2C%2010580%2C%20USA"
    pageTitle="OKO Rye"
  />
);

export default OkoRye;
