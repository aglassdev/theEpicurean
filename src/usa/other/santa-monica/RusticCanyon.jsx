...
const RusticCanyon = () => (
  <RestaurantPage
    restaurantName="Rustic Canyon"
    address="1119 Wilshire Blvd., Santa Monica, 90401, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+13103937050"
    website="https://rusticcanyonrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A sense of community and warm hospitality pervade this beloved Santa Monica institution—it feels like your favorite neighborhood spot, even if you’ve traveled miles to dine here. The menu of shareable plates overseen by Chef/owner Jeremy Fox is market-driven even by California standards, a fact that’s proudly advertised with the inclusion of a bevy of local farmers’ names. A prime example is Zuckerman's delta asparagus, plating the vibrant green stalks in alternating layers over a sauce gribiche with grated lemon zest and chicken skin crackling. The quality of the produce is exceptional, and the cooking is simple and hearty, as in poached Mt. Lassen trout atop a bed of sauerkraut in a Riesling wine sauce mixed with smoked trout roe and finely cut chives...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1119%20Wilshire%20Blvd.%2C%20Santa%20Monica%2C%2090401%2C%20USA"
    pageTitle="Rustic Canyon"
  />
);

export default RusticCanyon;
