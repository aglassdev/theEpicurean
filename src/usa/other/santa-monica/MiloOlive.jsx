...
const MiloOlive = () => (
  <RestaurantPage
    restaurantName="Milo + Olive"
    address="2723 Wilshire Blvd., Santa Monica, 90403, USA"
    cuisine="Farm to table, Italian"
    priceRange="$$$"
    phoneNumber="+13104536776"
    website="https://www.miloandolive.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name is as cute as a button, but the wood-fired pizzas turned out of this kitchen are serious business. This cheery establishment shines the spotlight perfectly blistered pies, homemade pastas and an outstanding pound cake that may just end up being the highlight of your meal—also wood-fired and finished with honey and whipped cream.A seat at the counter offers a bird’s eye view as the chefs roll out paper-thin pizza crusts, lacing them with tomato sauce, creamy mozzarella and a flutter of sea salt. Tender gnocchi made with brown butter and dyed orange from garnet yam may then arrive tossed with charred radicchio, hazelnuts, and cranberries (most of the organic fruits, vegetables and herbs are from the Santa Monica Farmers’ Market). Weekend brunch is a hit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2723%20Wilshire%20Blvd.%2C%20Santa%20Monica%2C%2090403%2C%20USA"
    pageTitle="Milo + Olive"
  />
);

export default MiloOlive;
