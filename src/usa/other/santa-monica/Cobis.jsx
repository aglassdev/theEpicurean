...
const Cobis = () => (
  <RestaurantPage
    restaurantName="Cobi's"
    address="2104 Main St., Santa Monica, 90405, USA"
    cuisine="Asian"
    priceRange="$$"
    phoneNumber="+14242385195"
    website="https://www.cobis.la/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The pink building with green trim is the first sign that Cobi's will charm you, and then there's the dining room, where frilly, floral touches (Pink wallpaper! Mismatched tables and chairs!) and a patio with more flowers set the scene for a lively atmosphere. Discover Thai and Malaysian delights along with other influences on this broad Southeast Asian menu. Start with dumplings, satay or curry puffs, those crispy triangular shells filled with curried split peas and potatoes sided by pickled onion and tamarind ketchup. From there, pick a curry or a wood-grilled main dish such as grilled prawns in a ginger and yellow bean sauce. You won't go wrong with scallops on the half shell or butter chicken with tomato masala, while prix fixe options include a smattering of dishes selected by the chef..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2104%20Main%20St.%2C%20Santa%20Monica%2C%2090405%2C%20USA"
    pageTitle="Cobi's"
  />
);
