...
const Seline = () => (
  <RestaurantPage
    restaurantName="Seline"
    address="3110 Main St., Ste. 132, Santa Monica, 90405, USA"
    cuisine="Californian, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14247448811"
    website="https://www.selinerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You might not expect to be served ice cream in the middle of savory courses, but at Chef Dave Beran's Seline, surprises are par for the course. This ambitious tasting menu dances between sweet and savory, and delivers on drama. Begin with a cup of mushroom tea before enjoying the likes of roasted leeks with foamy eucalyptus sauce and a banana leaf puree, or dry-aged beef tartare with celery root and a savory granola. The hot mushroom salad steamed in a squash is plated tableside for a bit of drama. Squab served in two parts plates roasted breast with a fennel sausage-stuffed leg for the opener, followed by smoked chocolate and squab liver truffle with strawberry sauce. The chef's signature golden osetra caviar served atop hazelnuts and a coffee anglaise is the ultimate ending...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3110%20Main%20St.%2C%20Ste.%20132%2C%20Santa%20Monica%2C%2090405%2C%20USA"
    pageTitle="Seline"
  />
);
