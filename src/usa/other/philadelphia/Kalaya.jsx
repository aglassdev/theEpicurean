...
const Kalaya = () => (
  <RestaurantPage
    restaurantName="Kalaya"
    address="4 W. Palmer St., Philadelphia, PA, 19125, USA"
    cuisine="Thai"
    priceRange="$$$"
    ...
    bio="First established in South Philly and now blossoming in Fishtown, Kalaya is the creation of Chutatip Nok Suntaranon. Named after her mother, the restaurant is a celebration of Southern Thai cuisine and of her formative years spent in the coastal province of Trang. You can expect authentic levels of heat, homemade pastes and quality ingredients, in dishes whose flavors are deep and satisfying. Start with Gui chai – a crispy rice cake with sweet soy sauce that shows the Chinese influence in the south. Turmeric features in dishes like pla tod kamin (wok-fried barramundi), while prawns and pork are two other specialties of Trang and feature here in a number of dishes; caramelized pork belly with tamarind is a favorite of many. The large, bright room comes complete with palm trees and modern ar..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20W.%20Palmer%20St.%2C%20Philadelphia%2C%20PA%2C%2019125%2C%20USA"
    pageTitle="Kalaya"
  />
);

export default Kalaya;
