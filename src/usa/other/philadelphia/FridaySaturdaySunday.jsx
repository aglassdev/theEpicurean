...
const FridaySaturdaySunday = () => (
  <RestaurantPage
    restaurantName="Friday Saturday Sunday"
    address="261 S. 21st St., Philadelphia, PA, 19103, USA"
    cuisine="American Contemporary"
    priceRange="$$$$"
    phoneNumber="+12155464232"
    website="https://www.fridaysaturdaysunday.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="And Wednesday and Thursday. Chef Chad Williams and his wife Hanna, both Philadelphia natives, took over this veritable institution in 2016 and then pivoted to offering a set multicourse menu. It works well, as it allows the chef to provide a balanced, varied and consistent experience to all. Thanks to skilled technique, just the right amount of innovation and an innate understanding of the luxury ingredients he uses, his dishes fill the mouth with flavor and succulence. His delicious crispy sweetbreads will convert any skeptic; quail with pâte plays with texture, and the New York strip is a lesson in expert seasoning. Expect an atmosphere as spirited and enjoyable as the food; there’s also a great cocktail bar on the first floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=261%20S.%2021st%20St.%2C%20Philadelphia%2C%20PA%2C%2019103%2C%20USA"
    pageTitle="Friday Saturday Sunday"
  />
);

export default FridaySaturdaySunday;
