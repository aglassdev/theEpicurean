...
const RiverTwice = () => (
  <RestaurantPage
    restaurantName="River Twice"
    address="1601 E. Passyunk Ave., Philadelphia, PA, 19148, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+12674573698"
    website="https://www.rivertwicerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Texan Chef-Owner Randy Rucker has called Philadelphia home since 2019 and it’s proved to be a very successful marriage. His corner restaurant is an understated space that’s not without charm, with floor-to-ceiling windows making the most of its appealing location. The small tables come with drawers for your cutlery, but it’s really a seat at the counter you want if you’d like to watch the chefs in action. On offer is a multicourse monthly-changing set menu with a distinct seafood bias – but there are always additional courses you can add on, some of which have a distinctly luxurious feel, like chawanmushi with Ossetra caviar. As that dish suggests, the main influences applied to the quality local ingredients are mostly French and Japanese, so wild halibut comes with shellfish emulsion, and..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1601%20E.%20Passyunk%20Ave.%2C%20Philadelphia%2C%20PA%2C%2019148%2C%20USA"
    pageTitle="River Twice"
  />
);

export default RiverTwice;
