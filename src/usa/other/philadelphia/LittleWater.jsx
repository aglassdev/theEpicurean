...
const LittleWater = () => (
  <RestaurantPage
    restaurantName="Little Water"
    address="261 S. 20th St., Philadelphia, PA, 19103, USA"
    cuisine="Seafood, American"
    priceRange="$$$"
    phoneNumber="+12153373343"
    website="https://www.littlewaterphl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This airy, seafood-inspired restaurant from husband-and-wife team Chef Randy and Amanda Rucker immediately charms with its pressed tin ceiling, globe lights and well-worn wood flooring. The menu is tight, starting with a raw bar of oysters, shrimp cocktail and scallops. Seafood gumbo arrives with lobster, crab and Carolina gold rice, and Caesar salads are showered in nori and toasted benne. Heartier fare like fried oyster BLTs and applewood-smoked steelhead trout show care, quality and sophistication. A seat at the raw bar in the back offers an up-close view of chefs in action...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=261%20S.%2020th%20St.%2C%20Philadelphia%2C%20PA%2C%2019103%2C%20USA"
    pageTitle="Little Water"
  />
);

export default LittleWater;
