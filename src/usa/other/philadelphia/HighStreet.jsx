...
const HighStreet = () => (
  <RestaurantPage
    restaurantName="High Street"
    address="101 S. 9th St. Door 1, Philadelphia, PA, 19107, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+12156250988"
    website="https://highstreetonmarket.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Franklin Building plays host to this modern American restaurant founded by Ellen Yin. It’s quite an operation, as besides the main restaurant there’s also a bakery next door if you want to take something home, along with a private dining space at the back for that big celebration. Furthermore, they hold classes for anyone who wants to learn how to bake or make pizza. Robustly flavored and generously sized dishes are the mainstay of the kitchen, which is visible through the glass walls. At lunch, most customers come in for a hoagie or a sandwich, while at dinner the menu expands to include a variety of pasta dishes and pizzas, all of which show a level of care, commitment and originality, so you can try a pizza with escargot and provolone, or black bucatini with braised squid. Service c..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101%20S.%209th%20St.%20Door%201%2C%20Philadelphia%2C%20PA%2C%2019107%2C%20USA"
    pageTitle="High Street"
  />
);
