...
const GustoHandcraftedPastaPizza = () => (
  <RestaurantPage
    restaurantName="Gusto Handcrafted Pasta & Pizza"
    address="1901 Fremont Blvd., Seaside, 93955, USA"
    cuisine="Italian-American"
    priceRange="$$"
    phoneNumber="+18318995825"
    website="https://www.gusto1901ca.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The surroundings may not be glamorous (Monterey airport is just a skip away), but this family-run establishment is a popular venue for large groups—and the proof is in the pasta. Gauging from the sizable menu of saucy, generously portioned Italian-American staples, no one is likely to leave their table hungry. Delightfully al dente house-made pastas are sure to banish any associations with mushy chain restaurant versions, and even hearty, rustic dishes like eggplant parmigiana get an extra touch of care. The from-scratch approach extends to the mozzarella, which is certainly worth sampling, whether as an antipasto or a topping for an array of thin-crust pizzas.Desserts, like cannoli with sweet mascarpone and ricotta, will tick the nostalgia box...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1901%20Fremont%20Blvd.%2C%20Seaside%2C%2093955%2C%20USA"
    pageTitle="Gusto Handcrafted Pasta & Pizza"
  />
);

export default GustoHandcraftedPastaPizza;
