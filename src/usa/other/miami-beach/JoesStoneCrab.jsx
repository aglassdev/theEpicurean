...
const JoesStoneCrab = () => (
  <RestaurantPage
    ...
    address="11 Washington Ave., Miami Beach, 33139, USA"
    cuisine="Seafood"
    priceRange="$$$"
    phoneNumber="+13056730365"
    website="https://www.joesstonecrab.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When Joe Weiss opened his lunch counter in 1913, Miami Beach didn’t even have paved roads, and customers had to take the ferry to cross over. One century later, as high-rises and shopping districts blossomed all around, this restaurant has endured as one of the city’s prime attractions. Celebrities, politicians and locals alike make a beeline to this crustacean hot spot, now open year-round. And if the dedicated parking lot across the street is any clue, waits for a table here can get lengthy.Boiled, chilled and served with a signature mustard sauce, this seasonal specialty is also sustainable since crabs can regenerate their claws in around two years. End the meal with a refreshing, tart slice of key lime pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20Washington%20Ave.%2C%20Miami%20Beach%2C%2033139%2C%20USA"
    pageTitle="Joe's Stone Crab"
  />
);

export default JoesStoneCrab;
