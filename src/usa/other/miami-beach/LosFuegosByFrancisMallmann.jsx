...
const LosFuegosByFrancisMallmann = () => (
  <RestaurantPage
    restaurantName="Los Fuegos by Francis Mallmann"
    address="3201 Collins Ave., Miami Beach, 33140, USA"
    cuisine="Argentinian, Steakhouse"
    priceRange="$$$$"
    phoneNumber="+17866555600"
    website="https://www.faena.com/miami-beach/dining/los-fuegos-by-francis-mallmann"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Theatrical” barely begins to describe the scale and style of Francis Mallman’s restaurant set inside the FAENA Hotel. Much like the hotel itself, the director of Moulin Rouge is responsible for such décor elements as leopard-print booths, striking red-cushioned seats and flashes of gold that appear on everything from the bar to the carpet.Known for open-fire cooking, Chef Mallman is not outmatched by the room’s design, delivering an asado experience that rivals the city’s best steakhouses. Beets buried under coals for eight hours and festooned with pistachio yogurt and garlic chips are a must, followed by big proteins like Australian filet that's grilled, coated in breadcrumbs and fried.The bustling bar at the end of the room draws a stylish crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3201%20Collins%20Ave.%2C%20Miami%20Beach%2C%2033140%2C%20USA"
    pageTitle="Los Fuegos by Francis Mallmann"
  />
);

export default LosFuegosByFrancisMallmann;
