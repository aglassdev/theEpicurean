...
const Perle = () => (
  <RestaurantPage
    restaurantName="Perle"
    address="43 E. Union St., Pasadena, 91103, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+16264608819"
    website="https://www.perlerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quaint French bistro feels right at home in downtown Pasadena. The cozy space draws in anybody walking by, thanks to vintage frames, sturdy Mahogany tables, and a coffered wood ceiling. Whereas many restaurants are content to merely look like a French bistro, in this one Chef Dean Yasharian has the chops to cook like one too.There is no need to reinvent the wheel and he knows it, carefully preparing such sleek, straight-shot Parisian classics as Burgundy snails glistening in herbed butter; silky-smooth pork pâté wrapped in pastry; and duck à l’orange with celery root purée. Dessert is essential:  the airy Gran Marnier soufflé with crème fraîche ice cream and indulgent apple tarte Tartin are exactly the kind of sweet comforts worth returning for...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20E.%20Union%20St.%2C%20Pasadena%2C%2091103%2C%20USA"
    pageTitle="Perle"
  />
);

export default Perle;
