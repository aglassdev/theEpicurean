...
const AgnesPAS = () => (
  <RestaurantPage
    ...
    address="40 W. Green St., Pasadena, 91105, USA"
    cuisine="American, Californian"
    priceRange="$$$"
    phoneNumber="+16263893839"
    website="https://www.agnesla.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Maybe it's because you enter through Vanessa and Thomas Tilaka Kalb's cheesery, where you can pull up a chair for an appetizer and a glass of wine, or maybe it's the appealing menu, but Agnes is especially inviting. Start with a cheese board or tinned fish to share, then snack on items like fried cheese curds with dill ranch dressing and honey mustard pickles. Salads show off their fondness for local products; house-made pastas are satisfying; but it's the live-fire hearth that draws all eyes. You'll never go wrong with a plate of fried chicken with sambal hot honey sauce and house-made pickles, though. There's always room for a sweet treat, especially the Thai banana split with roasted bananas and pandan and Thai tea ice creams...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20W.%20Green%20St.%2C%20Pasadena%2C%2091105%2C%20USA"
    pageTitle="Agnes"
  />
);

export default AgnesPAS;
