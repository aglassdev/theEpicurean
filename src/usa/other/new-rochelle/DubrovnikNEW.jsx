...
const DubrovnikNEW = () => (
  <RestaurantPage
    ...
    address="721 Main St., New Rochelle, NY, 10801, USA"
    cuisine="Croatian, Seafood"
    priceRange="$$"
    phoneNumber="+19146373777"
    website="https://www.dubrovnikny.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled along New Rochelle's more commercial streets, Dubrovnik is a real find—with the added bonus of live Croatian music on certain nights. Diners come from near and far to feast on their items from the wood-burning oven. Equally appealing is the interior design. Next door to the owner’s cabinetry business, everything here is custom-made. Attention to detail isn’t just a hallmark of their décor though; the menu follows close at hand, offering the likes of shatteringly crisp spring rolls filled with tender beef and vegetables and served with a spiced tartar sauce. Or try something cooked on their wood-fired grill like branzino served with smoky vegetables and broccoli rabe risotto, before savoring palačinke (crêpes with peach jam)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=721%20Main%20St.%2C%20New%20Rochelle%2C%20NY%2C%2010801%2C%20USA"
    pageTitle="Dubrovnik"
  />
);

export default DubrovnikNEW;
