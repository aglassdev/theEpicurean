...
const Insalatas = () => (
  <RestaurantPage
    restaurantName="Insalata's"
    address="120 Sir Francis Drake Blvd., San Anselmo, 94960, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+14154577700"
    website="https://insalatas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="San Anselmo restaurateur, Chef Heidi Krahling honors her late father, Italo Insalata, at this crowd-pleasing Marin hangout. The zucca-orange stucco exterior alludes to the Mediterranean air within. Insalata’s upscale setting is framed by lemon-yellow walls hung with grand depictions of nature’s bounty, setting the scene for an array of fresh and flavorful cuisine to come.Sparked by Middle Eastern flavors, the kitchen's specialties include velvety smooth potato-leek soup made brilliantly green from watercress purée. Also sample grilled lamb skewers drizzled with cumin-yogurt atop crunchy salad and flatbread. The takeout area in the back is stocked with salads, sides and sandwiches made with house-baked bread. Boxed lunches are a fun, tasty convenience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=120%20Sir%20Francis%20Drake%20Blvd.%2C%20San%20Anselmo%2C%2094960%2C%20USA"
    pageTitle="Insalata's"
  />
);

export default Insalatas;
