...
const Valley = () => (
  <RestaurantPage
    restaurantName="Valley"
    address="487 1st St. W., Sonoma, 95476, USA"
    cuisine="Californian"
    priceRange="$$"
    phoneNumber="+17079348403"
    website="https://www.valleybarandbottle.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Sonoma Plaza lucked out with this little wine bar that is sure to be a gamechanger for the area. Its vibe is come-as-you-are; and the tiny menu is a revolving door of fresh ingredients prepared with little fuss. The affordable wine list is a veritable call to adventure, highlighting organic and biodynamic favorites from the nooks and crannies of California and beyond.It wouldn’t be so unreasonable to eat here either. From soft-boiled eggs finished with a savory XO sauce to duck breast tortillas served with house-made hoisin that is best in class, everything is better shared. For dessert, olive oil cake with yogurt and orange-citrus marmalade is yet another illustration of how this team under-promises but over-delivers in the most welcome of ways...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=487%201st%20St.%20W.%2C%20Sonoma%2C%2095476%2C%20USA"
    pageTitle="Valley"
  />
);
