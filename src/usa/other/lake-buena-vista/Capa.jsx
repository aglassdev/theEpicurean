...
const Capa = () => (
  <RestaurantPage
    restaurantName="Capa"
    address="Four Seasons Resort Orlando at Walt Disney World® Resort, 10100 Dream Tree Blvd., Lake Buena Vista, FL, 32836, USA"
    cuisine="Steakhouse, Spanish"
    priceRange="$$$$"
    phoneNumber="+14073137777"
    website="http://www.capasteakhouse.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Calling Capa a steakhouse sells it a bit short. Set high on the 17th floor of the Four Seasons Orlando, the restaurant trades in scale and spectacle, with sweeping views and a menu that draws broadly from Spanish-inspired traditions. The offering is expansive, spanning tapas, grilled meats and desserts, with dishes like gambas heavy with garlic and paprika, sherry-braised mushrooms brightened by dried cherry, and a substantial bone-in ribeye cooked to order. In desserts like the gazpacho de melon, green apple sorbet, saffron meringue and candied celery come together in a clean, refreshing finish. Capa remains a comfortable, polished destination for a celebratory meal, best appreciated for its setting and variety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Resort%20Orlando%20at%20Walt%20Disney%20World%C2%AE%20Resort%2C%2010100%20Dream%20Tree%20Blvd.%2C%20Lake%20Buena%20Vista%2C%20FL%2C%2032836%2C%20USA"
    pageTitle="Capa"
  />
);
