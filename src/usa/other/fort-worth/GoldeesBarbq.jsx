...
const GoldeesBarbq = () => (
  <RestaurantPage
    restaurantName="Goldee’s Bar-B•Q"
    address="4645 Dick Price Rd., Fort Worth, TX, 76140, USA"
    ...
    bio="Founded by a youthful and creative cohort, Goldee's is the name on the lips of every barbecue aficionado seeking out great brisket (among other items) in the Fort Worth area. Open just a few days a week from late morning until afternoon, one must go when the getting is this good; and it's absolutely worth the hours-long wait in the Texas sun.The brisket here, premium Black Angus beef, is cooked low and slow using post oak sourced from nearby. The meat is meltingly tender with a rich, clean flavor and needs nothing else; however, stuck between slices of homemade bread with a dab of the sweet/tart mustardy sauce is a delightful way to go. Turkey, ribs (beef and pork), and sausage round out the proteins, which can be sided by potato salad or zesty cabbage and kale slaw...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4645%20Dick%20Price%20Rd.%2C%20Fort%20Worth%2C%20TX%2C%2076140%2C%20USA"
    pageTitle="Goldee’s Bar-B•Q"
  />
);

export default GoldeesBarbq;
