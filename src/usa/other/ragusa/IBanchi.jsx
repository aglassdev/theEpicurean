...
const IBanchi = () => (
  <RestaurantPage
    restaurantName="I Banchi"
    address="via Orfanotrofio 39, Ragusa, 97100, Italy"
    cuisine="Sicilian, Contemporary"
    priceRange="€€"
    phoneNumber="+390932655000"
    website="https://www.ibanchiragusa.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a palazzo full of history – the building was a synagogue before the 1693 earthquake and has retained its ritual bath in its charming room of mirrors – this restaurant bears the imprint of renowned chef Ciccio Sultano, holder of two Michelin stars at the nearby Duomo restaurant. The cuisine is eclectic yet with a Sicilian focus, plus the wine list is complemented by a choice of interesting cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Orfanotrofio%2039%2C%20Ragusa%2C%2097100%2C%20Italy"
    pageTitle="I Banchi"
  />
);

export default IBanchi;
