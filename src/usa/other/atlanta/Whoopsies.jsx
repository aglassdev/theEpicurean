...
const Whoopsies = () => (
  <RestaurantPage
    restaurantName="Whoopsie's"
    address="1 Moreland Ave. SE, Ste. C, Atlanta, 30316, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+14042541279"
    website="https://www.whoopsiesatl.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Make no mistake— Whoopsie's is a fun, quirky spot where you'll yearn to be a regular. If you do, you won't be bored, as their menu is a constantly evolving mix of cold dishes, hot dishes that also work well as sides, and a daily changing protein (think prime rib one day and roasted chicken thighs with golden-brown skin another), plus a sandwich of the day. You won't leave hungry, as the portions are generous, and the cooking is humble but well executed. Kick things off with the Southern snack tray, served on a plastic cafeteria tray with the various compartments filled with a collection of Southern Classics like pimento cheese spread, chow chow, pickled veggies, and pork terrine. One dessert is offered daily. If it's the pecan pie, it's a fitting finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Moreland%20Ave.%20SE%2C%20Ste.%20C%2C%20Atlanta%2C%2030316%2C%20USA"
    pageTitle="Whoopsie's"
  />
);

export default Whoopsies;
