...
const TalatMarket = () => (
  <RestaurantPage
    restaurantName="Talat Market"
    address="112 Ormond St. SE, Atlanta, 30315, USA"
    cuisine="Thai"
    priceRange="$$$"
    phoneNumber="+14042576255"
    website="https://talatmarketatl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Summerhill neighborhood, Talat Market is equal parts industrial and vintage, with colorful design elements adding a decorate punch. This trendy no-reservations spot from Chefs/owners Parnass Savang and Rod Lassiter is all about traditional Thai flavors, utilizing the best of Georgia produce, and the bar echoes that ethos. The menu begins with a section devoted to oysters and crudo, then progresses into small plates like crispy rice salad and som tum. Yum phonlamai is a refreshing fruit salad tossed with sesame dressing—perfect for chasing the spicier dishes. Other plates like gaaeng kiew wan, a crab and pork curry, deliver subtle flavors, and curries, many using house-pressed coconut milk, are always a good idea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%20Ormond%20St.%20SE%2C%20Atlanta%2C%2030315%2C%20USA"
    pageTitle="Talat Market"
  />
);

export default TalatMarket;
