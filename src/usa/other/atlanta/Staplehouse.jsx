...
const Staplehouse = () => (
  <RestaurantPage
    restaurantName="Staplehouse"
    address="541 Edgewood Ave., Atlanta, 30312, USA"
    cuisine="American Contemporary"
    priceRange="$$$$"
    phoneNumber="+14045245005"
    website="https://www.staplehouse.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Open two nights a week for dinner (Friday-Saturday) and located in the Old Fourth Ward, Staplehouse promises a convivial evening of conversation and talented cooking. An open kitchen, exposed brick, and a high ceiling lend a rustic/industrial vibe to this charmingly attended-to place.Here, a contemporary tasting menu flips the script with a hearty, far-from-fussy offering where you may discover a cabbage course that sings with character and flavor. A thick slice of grilled sirloin steak with a crispy morel mushroom is sided by a wedge of grilled gem lettuce with tiny florets of sprouting cauliflower. Finally, a citrus tart with honeycomb candy is spot on...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=541%20Edgewood%20Ave.%2C%20Atlanta%2C%2030312%2C%20USA"
    pageTitle="Staplehouse"
  />
);

export default Staplehouse;
