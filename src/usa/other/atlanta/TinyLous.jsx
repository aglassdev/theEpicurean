...
const TinyLous = () => (
  <RestaurantPage
    restaurantName="Tiny Lou's"
    address="789 Ponce De Leon Ave. NE, Atlanta, 30306, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+14704850085"
    website="https://www.tinylous.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named for the popular 1950s dancer in the Clermont Motor Hotel’s “Gypsy Room,” Tiny Lou's is tucked inside the hip Hotel Clermont. Look for the pink neon sign, then descend the stairs to the trendy space set with a moody tone and French vibes. French classics mingle with American comfort food on a menu that showcases Georgian ingredients and a bit of Southern style. The cooking is approachable and earnest, as in wild striped bass with skin that's been crisped to perfection. Served with asparagus, it's the kind of plate where every component is well-executed. The desserts are also a must, with varied takes of the crépe cake and blondie always on the menu, and others always changing. If that means you need to order a few, then so be it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=789%20Ponce%20De%20Leon%20Ave.%20NE%2C%20Atlanta%2C%2030306%2C%20USA"
    pageTitle="Tiny Lou's"
  />
);

export default TinyLous;
