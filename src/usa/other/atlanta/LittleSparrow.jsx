...
const LittleSparrow = () => (
  <RestaurantPage
    restaurantName="Little Sparrow"
    address="1198 Howell Mill Rd., Atlanta, 30318, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+14043552252"
    website="https://www.littlesparrowatl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We'll forgive you if you're looking through rose-colored glasses after a meal here. After all, Little Sparrow was singer Édith Piaf's nickname, and this très French bistro hits all the right notes from its design to its dishes. The menu, though compact, features all the favorites albeit with a little Southern flair. Meals begin with a warm baguette and delicious butter before moving on to a fragrant and hearty onion soup and beef tartare. Entrées run the gamut from pork belly to chicken schnitzel with a mound of seasonal greens. Of course, there must be fries, and these house-made delights are thick cut and triple fried, accompanied by aïoli, Bearnaise sauce, or Raclette cheese service. End with a traditional chocolate soufflé or opt for a unique soft serve sundae...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1198%20Howell%20Mill%20Rd.%2C%20Atlanta%2C%2030318%2C%20USA"
    pageTitle="Little Sparrow"
  />
);

export default LittleSparrow;
