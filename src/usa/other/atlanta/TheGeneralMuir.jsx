...
const TheGeneralMuir = () => (
  <RestaurantPage
    restaurantName="The General Muir"
    address="1540 Avenue Pl., Ste. B-230, Atlanta, 30329, USA"
    cuisine="Deli, American"
    priceRange="$$$"
    phoneNumber="+16789279131"
    website="https://www.thegeneralmuir.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The General Muir is a looker; light filled and clean with a comfortable retro-chic style. The walls are adorned with black-and-white photos from another era—yet another reminder that this style of food has a deep history. Both a market and a sit-down restaurant, it's the kind of place you'd see every few blocks in New York but not as often in Atlanta. Come as you are for a bowl of matzoh ball soup with its flavorful broth that cures all ails. The Lower East Side platter comprises a bagel, a schmear of cream cheese and thin shavings of that inimitable smoked Nova with its unmistakably buttery texture. Finally, if the cases lined with cakes didn't tempt you already, don't miss the oh-so-classically creamy and rich cheesecake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1540%20Avenue%20Pl.%2C%20Ste.%20B-230%2C%20Atlanta%2C%2030329%2C%20USA"
    pageTitle="The General Muir"
  />
);

export default TheGeneralMuir;
