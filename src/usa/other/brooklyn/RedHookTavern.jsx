...
const RedHookTavern = () => (
  <RestaurantPage
    restaurantName="Red Hook Tavern"
    address="329 Van Brunt St., Brooklyn, 11231, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+19179666094"
    website="https://www.redhooktavern.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the team behind Hometown BBQ arrives this cozy, quaint, and vintage American tavern. Guests enter to arrive at an expansive bar complete with a brass footrest. Exposed brick, frosted-glass light fixtures, and floral wallpaper are also on display, not to mention closely packed tables with a ledge for votive candles and wine bottles.Start things off with a house spritz or a sip from the eclectic wine or cocktail list. The menu is small and focused; the cooking classic and comforting. But first, start things off with such familiar items as a dry-aged burger enrobed by melted American cheese and served with cottage fries to French onion soup with that trademark bubbly and dark golden cheese top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=329%20Van%20Brunt%20St.%2C%20Brooklyn%2C%2011231%2C%20USA"
    pageTitle="Red Hook Tavern"
  />
);

export default RedHookTavern;
