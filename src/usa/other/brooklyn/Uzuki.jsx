...
const Uzuki = () => (
  <RestaurantPage
    restaurantName="Uzuki"
    address="95 Guernsey St., Brooklyn, 11222, USA"
    cuisine="Japanese, Soba"
    priceRange="$$$$"
    phoneNumber="+19175633888"
    website="https://www.uzuki-ny.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=95%20Guernsey%20St.%2C%20Brooklyn%2C%2011222%2C%20USA"
    pageTitle="Uzuki"
  />
);

export default Uzuki;
