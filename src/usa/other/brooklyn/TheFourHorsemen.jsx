...
const TheFourHorsemen = () => (
  <RestaurantPage
    restaurantName="The Four Horsemen"
    address="295 Grand St., Brooklyn, 11211, USA"
    cuisine="American, Californian"
    priceRange="$$$$"
    phoneNumber="+17185994900"
    website="https://www.fourhorsemenbk.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Reservations are required or be ready to queue at this eternally cool Williamsburg wine bar part-owned by LCD Soundsystem frontman, James Murphy. Four Horseman's wine list is eclectic and laser-focused on varietals, and Chef Nick Curtola's succinct and seasonally changing menu rarely misses.Start with the veal sweetbread skewers with soy-cured egg yolk. Or the crisp chickpea crepe, woven with pieces of squash blossoms that lures you in with a layer of glistening lardon. Fried skate wing comes to you deep golden and impossibly crisp, and the Berkshire pork is tender with a hint of cider glaze. Let the sociable staff talk you into closing over a silky crème caramel topped with deeply toasted crispy bits of soba...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=295%20Grand%20St.%2C%20Brooklyn%2C%2011211%2C%20USA"
    pageTitle="The Four Horsemen"
  />
);

export default TheFourHorsemen;
