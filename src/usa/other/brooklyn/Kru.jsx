...
const Kru = () => (
  <RestaurantPage
    restaurantName="KRU"
    address="190 N. 14th St., Brooklyn, 11249, USA"
    ...
    bio="Husband-and-wife Chefs Ohm Suansilphong and Kiki Supap are behind KRU, which is Thai for guru. Indeed, you will get a lesson in traditional Thai dishes albeit ones that have been spruced up in a decidedly contemporary way. Sleek and airy, the interior is equally of-the-moment with exposed brick walls and ductwork along with cement tiled floors. First up? Braised beef shank and tripe in a rich, flavorful broth with pork cracklings, bean sprouts, and Chinese broccoli with a nice balance of sour and spicy. Then, red curry-rubbed branzino over steamed egg and Napa cabbage is served on a banana leaf with white rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=190%20N.%2014th%20St.%2C%20Brooklyn%2C%2011249%2C%20USA"
    pageTitle="KRU"
  />
);
