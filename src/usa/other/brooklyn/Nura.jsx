...
const Nura = () => (
  <RestaurantPage
    restaurantName="Nura"
    address="46 Norman Ave., Brooklyn, 11211, USA"
    cuisine="Fusion"
    priceRange="$$$"
    phoneNumber="+13476721222"
    website="https://www.nurabk.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on a windswept, wide artery in Greenpoint with retrofitted warehouses and new gleaming residential towers, this former auto-body shop really revs its stuff.Chef Tajeh Porter's menu is deliciously informed by co-owner Michelle Lobo-Hawley's Indian heritage. From coriander garlic naan to maple sweet crumbly corn bread, the fresh bread basket is a marvel, but when coupled with spiced carrot and white bean spread or hummus flavored with smoky blistered poblano, it's a meal unto itself. Have some discipline, though, since you'll want some bread to sop up the electrifying sweet-smoky mezcal- and Urfa pepper-infused sauce accompanying the prawns. Finish with roasted sunchoke ice cream with candied cocoa nibs, crushed cookie and a flourish of flamed black cardamom...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20Norman%20Ave.%2C%20Brooklyn%2C%2011211%2C%20USA"
    pageTitle="Nura"
  />
);
