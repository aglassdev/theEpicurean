...
const RoseMarie = () => (
  <RestaurantPage
    restaurantName="Rose Marie"
    address="524 Lorimer St., Brooklyn, NY, 11211, USA"
    cuisine="American Contemporary"
    priceRange="$$"
    phoneNumber="+13472234594"
    website="https://www.rosemarienyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rose Marie is the free-spirited little sister to Yellow Rose, the beloved Tex Mex spot in the East Village from Chef Dave Rizo and Krystiana Rizo. This Williamsburg offshoot has a more freeform groove, along with a rustic charm. Meanwhile, the menu leans contemporary American with a few Southern flourishes. It's the kind of place you'll want to drop in for a cocktail and a snack, or stay for a satisfying dinner, choosing from items such as sprouting cauliflower salad, saltine-crusted fish with Carolina Gold rice, steak tartare. A patty melt with griddled onions, Vermont cheddar, bacon and pickled green tomato and an order of crispy potatoes with mayo might just be the perfect order...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=524%20Lorimer%20St.%2C%20Brooklyn%2C%20NY%2C%2011211%2C%20USA"
    pageTitle="Rose Marie"
  />
);
