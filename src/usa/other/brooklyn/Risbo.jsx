...
const Risbo = () => (
  <RestaurantPage
    restaurantName="Risbo"
    address="701 Flatbush Ave., Brooklyn, 11225, USA"
    cuisine="American, Grills"
    priceRange="$$"
    phoneNumber="+13474259116"
    website="https://www.risbobk.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner Boris Ginet's all-day cafe is a perfect spot to visit before or after a visit to Prospect Park, just a stone's throw away. And while its whitewashed walls lined with artistic photos, industrial-chic cement floors and a glorious garden patio hint at its Brooklyn locale, the anchor here is the open-air, Parisian-style rotisserie, churning out a host of delectably roasted items.This menu highlights everything from bowls and platters to seasonal soups, vegetables and grains. The roasted chicken is a must. Marinated for 72 hours with a host of spices, it's a signature. The Risbo platter is another house special, underscoring the likes of well-seasoned roasted pork served with hummus, a spicy cabbage salad and plantains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=701%20Flatbush%20Ave.%2C%20Brooklyn%2C%2011225%2C%20USA"
    pageTitle="Risbo"
  />
);
