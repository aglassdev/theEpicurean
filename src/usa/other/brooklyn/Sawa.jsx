...
const Sawa = () => (
  <RestaurantPage
    restaurantName="Sawa"
    address="75 5th Ave, Brooklyn, 11217, USA"
    cuisine="Middle Eastern, Lebanese"
    priceRange="$$"
    phoneNumber="+19174006182"
    website="https://www.sawa.nyc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Siblings Samaya Boueri Ziade and George Boueri have partnered on their first restaurant, Sawa, which just so happens to mean together in Arabic. This lively spot lures a crowd: by the time they unlock the doors, the line is already long. Everyone is here for the convivial ambience and the standout Middle Eastern food from Chef Soroosh Golbabae. This is a menu thick with options, with labneh and hummus with wagyu beef cheeks kicking things off before a round of mezze like tabbouleh, fried meat pies, and kibbeh nayeh. Don't miss the rakkakat, or akkawi and halloumi cheese wrapped in filo and fried to a golden crisp. Grilled Australian lamb chop with garlic labneh and a generous coating of urfa bibir is a smoky, savory main dish. Finish with the pistachio mafroukeh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75%205th%20Ave%2C%20Brooklyn%2C%2011217%2C%20USA"
    pageTitle="Sawa"
  />
);
