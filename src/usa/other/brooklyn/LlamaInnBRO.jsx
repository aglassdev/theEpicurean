...
const LlamaInnBRO = () => (
  <RestaurantPage
    restaurantName="Llama Inn"
    address="50 Withers St., Brooklyn, 11211, USA"
    cuisine="Peruvian, Fusion"
    priceRange="$$"
    phoneNumber="+17183873434"
    website="https://www.llamainnnyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Upbeat, modern and cool, Llama Inn pays respect to all styles of Peruvian cooking but with the technical flair of Chef Erik Ramirez who has trained in New York’s top restaurants. The result is always fresh, fun and spontaneous cuisine that elevates Peruvian food. Begin your meal with one of the variations of ceviche, ranging from seafood to vegetarian styles. The asparagus is punctuated with a bracing potato leek leche de tigre. Next up is the crispy and cheesy jalapeño tequenos. The pork collar escabeche rounds out the meal or if you're eating with a crowd go for the decadant lomo saltado. Finish with a slice of their key lime pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20Withers%20St.%2C%20Brooklyn%2C%2011211%2C%20USA"
    pageTitle="Llama Inn"
  />
);

export default LlamaInnBRO;
