...
const Pierozek = () => (
  <RestaurantPage
    restaurantName="Pierozek"
    address="592 Manhattan Ave., Brooklyn, 11222, USA"
    cuisine="Polish, Dumplings"
    priceRange="$$"
    phoneNumber="+17185763866"
    website="https://www.pierozekbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alexandra Siwiec and Radek Kucharski are behind this casual spot in the heart of a historically Polish neighborhood in Greenpoint. There is a service station displaying Bolesławiec pottery, which is also the vessel of choice for their assorted food. Pierogi is their specialty—consider delicate parcels filled with jalapeño, mashed potato, and bacon—but don't sleep on their other Polish favorites including hearty borscht and golabki (cabbage stuffed with pork, rice, and topped with tomato-basil sauce). The savory and smoky kielbasa stands on its own, though whole grain mustard seals the deal. Raspberry and sweet cheese pierogi makes a sweet counterpart to the savory options but be sure to accompany each bite with a shot from their concise selection of Polish liquors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=592%20Manhattan%20Ave.%2C%20Brooklyn%2C%2011222%2C%20USA"
    pageTitle="Pierozek"
  />
);

export default Pierozek;
