...
const Tong = () => (
  <RestaurantPage
    restaurantName="Tong"
    address="321 Starr St., Brooklyn, 11237, USA"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+17183660586"
    website="https://www.tongbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the first questions a server here will ask is whether you like spicy food. Answer truthfully because this Thai kitchen does not hold back when it comes to those fiery chilies, which seem to find their way into every corner of the menu. It’s all part of the allure at this sleek dining room, built out of concrete warehouse floors and rustic metal walls accented with flecks of gold.The space is indeed a welcome hangout, where friends can crowd their table with a host of small plates, or kub klaem. Highlights like fried banana blossoms with cucumber relish, or crispy rice with fermented pork sausage and shallots deliver a whirl of textures and sharp flavors. The thinly sliced grilled pork jowl and warming khao soi win over many fans...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=321%20Starr%20St.%2C%20Brooklyn%2C%2011237%2C%20USA"
    pageTitle="Tong"
  />
);
