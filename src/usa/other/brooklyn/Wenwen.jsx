...
const Wenwen = () => (
  <RestaurantPage
    restaurantName="Wenwen"
    address="1025 Manhattan Ave., Brooklyn, 11222, USA"
    cuisine="Taiwanese, Asian"
    priceRange="$$$"
    phoneNumber="+16469015644"
    website="https://wenwenbrooklyn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Eric Sze and partner Andy Chuang bring the vibrant flavors of Taiwanese cooking to Greenpoint with Wenwen. The façade is unmissable with its tall and narrow wood-framed windows allowing for a full view of the clean, airy interior. Menu highlights include the sacha hot honey popcorn chicken garnished with Taiwan dust, a sugar-spice combination that ratchets up the flavor, as well as whole striped bass stuffed with fish paste and glistening in a pool of black sugar-yuzu vinaigrette and fermented black beans. The 16-hour oxtail broth and tender braised beef share the spotlight in the beef noodle soup that nourishes body and soul...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1025%20Manhattan%20Ave.%2C%20Brooklyn%2C%2011222%2C%20USA"
    pageTitle="Wenwen"
  />
);

export default Wenwen;
