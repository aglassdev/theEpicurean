...
const AproposRestaurantAtTheAbbeyInn = () => (
  <RestaurantPage
    restaurantName="Apropos Restaurant at The Abbey Inn"
    address="900 Fort Hill Rd., Peekskill, 10566, USA"
    cuisine="American, Contemporary"
    priceRange="$$$$"
    phoneNumber="+19147393546"
    website="https://www.theabbeyinn.com/dine/apropos-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Sisters of Saint Mary's certainly didn't eat like this, but if you take a one-hour train ride from Grand Central to Peekskill's Apropros Restaurant at The Abbey Inn, you will. This 120-year-old abbey perched high above the Hudson River has been painstakingly restored and transformed into a lovely inn and restaurant. The grounds, and the views, are worth the trip alone but the wine cellar boasting an impressive collection and the farm-to-table kitchen are equally rewarding. The menu leans traditional, with dishes ranging from rich lamb ragù atop tangles of thick pappardelle to grilled petite filet of beef finished with a textbook green peppercorn sauce. Pannacotta flavored with moscato and finished with an apricot and chili preserve is a lovely send-off...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=900%20Fort%20Hill%20Rd.%2C%20Peekskill%2C%2010566%2C%20USA"
    pageTitle="Apropos Restaurant at The Abbey Inn"
  />
);

export default AproposRestaurantAtTheAbbeyInn;
