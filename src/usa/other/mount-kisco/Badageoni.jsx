...
const Badageoni = () => (
  <RestaurantPage
    restaurantName="Badageoni"
    address="26 E. Main St., Mount Kisco, 10549, USA"
    cuisine="Central Asian, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+19148641666"
    website="https://www.badageoni.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mount Kisco locals are rejoicing at the arrival of this impossibly delicious Georgian kitchen as well as the new culinary dialect that accompanies it. This is a simple, welcoming dining room with a trestle-like ceiling, soft Edison light bulbs and dark wood bar. Pkhali rolls kick things off, where eggplant is stuffed with zucchini, peppers and topped with pomegranate seeds—the latter an ideal counterpoint to the rich ingredients. Mini khinkali (beef, veal and pork dumplings in a yogurt sauce) are in fact bold and hearty, and no meal is complete without them. The chakapuli with lamb alongside sour plums and white wine-kissed broth, is fragrant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20E.%20Main%20St.%2C%20Mount%20Kisco%2C%2010549%2C%20USA"
    pageTitle="Badageoni"
  />
);

export default Badageoni;
