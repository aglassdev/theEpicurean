...
const StreetlightTaco = () => (
  <RestaurantPage
    restaurantName="Streetlight Taco"
    address="4004 Henderson Blvd., Tampa, 33629, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+18132179158"
    website="https://www.streetlighttaco.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This South Tampa taqueria certainly ups the style quotient on the typical taqueria. From the black-painted, exposed ductwork to the tables lacquered with Mexican comics to the open kitchen, this fast casual spot delivers on contemporary flair, and the food isn't pulling any punches, either. Heirloom corn is nixtamalized in house for a menu featuring tacos, tostadas, salsas, sides and more. Don't skip the Sunday snack tostada, an equal parts sweet-and-savory delight with two blue corn tostadas layered with cream cheese with lump crab, diced sweet mango and a mango habanero sauce. The Japanese eggplant taco with an heirloom bean puree and a chile onza salsa has just the right amount of kick. There's a full bar, but a strawberry horchata goes down perfectly, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4004%20Henderson%20Blvd.%2C%20Tampa%2C%2033629%2C%20USA"
    pageTitle="Streetlight Taco"
  />
);

export default StreetlightTaco;
