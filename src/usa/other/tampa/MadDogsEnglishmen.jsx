...
const MadDogsEnglishmen = () => (
  <RestaurantPage
    restaurantName="Mad Dogs & Englishmen"
    address="4914 S. MacDill Ave., Tampa, 33611, USA"
    cuisine="Gastropub"
    priceRange="$$$"
    phoneNumber="+18138323037"
    website="https://maddogs.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mad Dogs & Englishmen isn't exactly new—the previous iteration down the street opened in 1991—but this new standalone space is bigger and better with a proper English pub style. Inside is a warren of small rooms, along with a bar and a large conservatory that opens up on nice days. In classic style, the walls are appropriately loaded with all manner of British paraphernalia, and the food follows suit, with a litany of traditional offerings including a weekly Sunday roast. Tuck into a puff pastry-wrapped sausage with a tangy curry-Dijon mayo. Shepherd's pie is a must in any pub, but here it's made with tender lamb. Topped with mashed potatoes and finished with breadcrumbs, it's a solid if slightly unique take on a classic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4914%20S.%20MacDill%20Ave.%2C%20Tampa%2C%2033611%2C%20USA"
    pageTitle="Mad Dogs & Englishmen"
  />
);

export default MadDogsEnglishmen;
