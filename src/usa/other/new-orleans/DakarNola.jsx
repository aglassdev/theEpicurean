...
const DakarNola = () => (
  <RestaurantPage
    restaurantName="Dakar NOLA"
    address="3814 Magazine St., New Orleans, LA, 70115, USA"
    cuisine="African, Senegalese"
    priceRange="$$$$"
    phoneNumber="+15044939396"
    website="https://www.dakarnola.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With roots in Harlem and Senegal, Chef Serigne Mbaye cooks from the heart and draws on flavors from across West Africa. Once a pop-up supper club, the restaurant has found a home along Magazine Street in a cottage in Uptown. Two seatings a night flow at a leisurely pace in a dining room fit with modern light fixtures, dark wood tones, and African artifacts. The tasting menu is rather steep in cost but certainly yields pleasant compositions like a finely spiced soup of okra, fish broth, and crab or Gulf fish with jollof rice, sauteed sweet potato greens, and a peppy tamarind broth. Local pottery and a host of farms supply the restaurant. Meanwhile, co-owner Dr. Afua Richardson is a steady presence and brings sincere warmth to the young service team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3814%20Magazine%20St.%2C%20New%20Orleans%2C%20LA%2C%2070115%2C%20USA"
    pageTitle="Dakar NOLA"
  />
);

export default DakarNola;
