...
const WillieMaesNola = () => (
  <RestaurantPage
    restaurantName="Willie Mae's Nola"
    address="898 Baronne St., New Orleans, LA, 70113, USA"
    cuisine="Southern"
    priceRange="$$"
    phoneNumber="+15043548194"
    website="https://williemaesnola.com/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the realm of fried chicken excellence, few do it better than the Seaton family. With history dating back to 1957, this institution has found a way to maintain quality and spirit while moving ahead with expansion and even relocation. The sunny, spacious dining room in downtown is miles from the original in Treme, but the fried chicken is as superb as ever. The menu offers more, but first timers need to stay focused. A cup of finely spiced gumbo with shrimp and blue crab is the only start you need before the main event. Sides like butter beans and rice or spiced cabbage round out a hearty meal that is visceral and rewarding in all the right ways...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=898%20Baronne%20St.%2C%20New%20Orleans%2C%20LA%2C%2070113%2C%20USA"
    pageTitle="Willie Mae's Nola"
  />
);

export default WillieMaesNola;
