...
const CompreLapin = () => (
  <RestaurantPage
    restaurantName="Compère Lapin"
    address="The Old No. 77 Hotel & Chandlery, 535 Tchoupitoulas St., New Orleans, LA, 70130, USA"
    cuisine="Contemporary, Southern"
    priceRange="$$$"
    phoneNumber="+15045992119"
    website="http://www.comperelapin.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Warehouse Arts District, Chef Nina Compton's Compère Lapin has been welcoming guests for more than a decade. It's nestled inside The Old No. 77 Hotel & Chandlery, a former coffee warehouse, and features a timeless rustic vibe with exposed brick walls, mosaic tiled flooring, dim lighting and an inviting bar.The concise menu weaves together Chef Compton's Caribbean heritage with the flavors of New Orleans and her experience working in kitchens in Florida. Hushpuppies are flavored with jalapeño, scallion and a cilantro crema; fried chicken is dressed with jerk honey butter and coconut grits; and curried goat is paired with sweet potato gnocchi. A warm service team ensures that everyone feels well cared for here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Old%20No.%2077%20Hotel%20%26%20Chandlery%2C%20535%20Tchoupitoulas%20St.%2C%20New%20Orleans%2C%20LA%2C%2070130%2C%20USA"
    pageTitle="Compère Lapin"
  />
);

export default CompreLapin;
