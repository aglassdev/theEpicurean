...
const MollysRiseShine = () => (
  <RestaurantPage
    restaurantName="Molly's Rise & Shine"
    address="2368 Magazine St., New Orleans, LA, 70130, USA"
    cuisine="American, Regional Cuisine"
    priceRange="$"
    phoneNumber="+15043021896"
    website="https://mollysriseandshine.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Breakfast is definitely the most important meal of the day at Molly's Rise & Shine. In fact, it's the only thing on the menu at this Garden District restaurant where Formica tabletops and vinyl chairs set a vintage scene. As for the food, think over-the-top renditions of American nostalgic cuisine with a twist. There's everything from yogurt and granola to loaded grits and biscuits and gravy on this menu. but don't miss the Grand Slam McMuffin, an upscale riff on the fast-food favorite with a sage pork sausage patty, hashbrown, griddled onions and gooey American cheese. It might not get more Southern than Scotty's collard greens over grits but it's given an international bent with salsa macha, poached eggs and peanut salad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2368%20Magazine%20St.%2C%20New%20Orleans%2C%20LA%2C%2070130%2C%20USA"
    pageTitle="Molly's Rise & Shine"
  />
);

export default MollysRiseShine;
