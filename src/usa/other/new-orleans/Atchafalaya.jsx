...
const Atchafalaya = () => (
  <RestaurantPage
    restaurantName="Atchafalaya"
    address="901 Louisiana Ave., New Orleans, LA, 70115, USA"
    cuisine="Southern, Creole"
    priceRange="$$"
    phoneNumber="+15048919626"
    website="https://www.atchafalayarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Always bustling, Atchafalaya is a popular neighborhood destination from owners Rachael Jaffe and Tony Tocco. Locals and tourists alike flock here for a taste of Chef Christopher Lynch's contemporary take on Creole cuisine. It's a buzzy space, but once these plates hit the table, all eyes are on the food. Fried green tomatoes, a tried-and-true Southern favorite, are reworked here with a topping of butter-poached Florida rock shrimp, remoulade, smoked trout roe and Crystal hot sauce. Then, Louisiana blue lump crab is fried until golden brown, topped with a poached egg and hollandaise over a bed of wilted spinach with shrimp sauce Américaine in a crab cake Benedict. House boudin is smoky and savory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=901%20Louisiana%20Ave.%2C%20New%20Orleans%2C%20LA%2C%2070115%2C%20USA"
    pageTitle="Atchafalaya"
  />
);

export default Atchafalaya;
