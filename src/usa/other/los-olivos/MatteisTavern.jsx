...
const MatteisTavern = () => (
  <RestaurantPage
    restaurantName="Mattei's Tavern"
    address="2350 Railway Ave., Los Olivos, 93441, USA"
    cuisine="American"
    priceRange="$$$$"
    phoneNumber="+18053353237"
    website="https://aubergeresorts.com/matteistavern/dine/tavern/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once a popular stagecoach stop in the late 1880s, then an infamous hangout during Prohibition, Mattei's Tavern has now been reimagined courtesy of Auberge Resorts. Nestled just outside the charming town of Los Olivos, this place simultaneously reeks of history while feeling decidedly modern. The kitchen delivers on a shared plates, Californian menu that benefits from an on-site garden and live fire cooking. Begin with the braised abalone finished with abalone liver mousse over mushroom confit in white miso butter. Main dishes are large, but be sure to sample wood-fired sides like grilled wedges of cabbage over a tomato stew with spiced chickpea and salsa macha. Finally, a dark chocolate soufflé with crème anglaise and butterscotch is never a bad idea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2350%20Railway%20Ave.%2C%20Los%20Olivos%2C%2093441%2C%20USA"
    pageTitle="Mattei's Tavern"
  />
);

export default MatteisTavern;
