...
const January = () => (
  <RestaurantPage
    restaurantName="January"
    address="Southall Farm & Inn, 2200 Osage Loop, Franklin, TN, 37064, USA"
    cuisine="American"
    priceRange="$$$$"
    phoneNumber="+16152822000"
    website="https://www.januarytn.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="The refined rustic style of Southall Farm & Inn, set on a sprawling estate a few miles outside of Franklin, is the perfect setting for this ambitious restaurant. Dramatic vaulted, beamed ceilings, herringbone wood floors and wood furnishings epitomize a modern take on farmhouse chic at January. Andrew Klamar and Nate Leonard spearhead this seed-to-fork concept where ingredients, some of which are grown on the property or sourced from nearby farms, are treated with the ultimate respect. At first glance, the menu reads like elevated comfort food but there's so much more going on in plates like a hominy soufflé layered with steamed Gulf shrimp and roasted beech mushrooms or Bear Creek Farm pork coppa steak wood-fire grilled with a sweet black garlic and sorghum glaze...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Southall%20Farm%20%26%20Inn%2C%202200%20Osage%20Loop%2C%20Franklin%2C%20TN%2C%2037064%2C%20USA"
    pageTitle="January"
  />
);
