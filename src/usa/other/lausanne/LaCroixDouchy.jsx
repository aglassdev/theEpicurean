...
const LaCroixDouchy = () => (
  <RestaurantPage
    restaurantName="La Croix d'Ouchy"
    address="Avenue d'Ouchy 43, Lausanne, 1006, Switzerland"
    cuisine="Mediterranean Cuisine"
    priceRange="€"
    phoneNumber="+41216162233"
    website="https://restaurant-croix-d-ouchy.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant boasts a loyal following of regulars in Lausanne, attracted here by cuisine that features superb traditional flavours alongside a few pasta dishes with an Italian touch, in a classic setting with plenty of character. Prior booking essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20d'Ouchy%2043%2C%20Lausanne%2C%201006%2C%20Switzerland"
    pageTitle="La Croix d'Ouchy"
  />
);

export default LaCroixDouchy;
