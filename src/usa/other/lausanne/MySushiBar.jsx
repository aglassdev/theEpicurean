...
const MySushiBar = () => (
  <RestaurantPage
    restaurantName="Myò Sushi Bar"
    address="Allée Ernest–Ansermet 1, Lausanne, 1003, Switzerland"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+41213232288"
    website="https://www.myo.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the Esplanade de Montbenon park, opposite the courthouse, this Japanese restaurant will win you over with its peaceful setting and quality cuisine. In summer, the terrace boasts a breathtaking view of the lake. Comfortably perched on a high stool, you can savour a variety of authentic Japanese dishes, including delicate sushi, tasty teppanyaki, beef tartare with wasabi, and a refined take on soba noodles. This is a popular place, so booking your spot at the counter is strongly advised...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=All%C3%A9e%20Ernest%E2%80%93Ansermet%201%2C%20Lausanne%2C%201003%2C%20Switzerland"
    pageTitle="Myò Sushi Bar"
  />
);

export default MySushiBar;
