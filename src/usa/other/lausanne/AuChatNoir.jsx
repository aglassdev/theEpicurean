...
const AuChatNoir = () => (
  <RestaurantPage
    restaurantName="Au Chat Noir"
    address="Rue Beau-Séjour 27, Lausanne, 1003, Switzerland"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+41213129585"
    website="https://guide.michelin.com/en/vaud/lausanne/restaurant/au-chat-noir"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this lively, welcoming restaurant close to the theatre, guests will be tempted by delicious dishes (such as oxtail parmentier – something of a speciality here), a menu of market-inspired specials (on this particular day, a delicious cep fondant as a starter), classic and rather fine flavours. In short, Au Chat Noir is the type of bistro you'd be happy to come across more often. Be sure to book!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Beau-S%C3%A9jour%2027%2C%20Lausanne%2C%201003%2C%20Switzerland"
    pageTitle="Au Chat Noir"
  />
);

export default AuChatNoir;
