...
const PicBeaurivagePalace = () => (
  <RestaurantPage
    restaurantName="Pic Beau-Rivage Palace"
    address="Place du Port 17, Lausanne, 1006, Switzerland"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+41216133339"
    website="https://www.brp.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After nearly a year's refurbishment, French chef Anne-Sophie Pic's luxurious Lausanne establishment now welcomes diners in an elegant and modern leather-clad interior overlooking the lake. This exquisite new setting is a perfect match for the light, expressive and almost ethereal creations of chef Jordan Theurillat. Once past the entrance to the restaurant, there is a table-bar where excellent mocktails and a lineup of appetisers are prepared, drawing on produce from the garden in particular. Dishes such as the ‘venison chop marinated and smoked with juniper berry and imperator root, flanked by end-of-summer tomato confit with mace’ are emblematic of this refined and daring vision of cuisine, paired with a strong regional slant. The evening menu comes in 7 or 8 courses, while the lunchtime..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Port%2017%2C%20Lausanne%2C%201006%2C%20Switzerland"
    pageTitle="Pic Beau-Rivage Palace"
  />
);

export default PicBeaurivagePalace;
