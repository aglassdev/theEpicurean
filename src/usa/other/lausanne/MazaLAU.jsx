...
const MazaLAU = () => (
  <RestaurantPage
    restaurantName="Maza"
    address="29 rue Marterey, Lausanne, 1005, Switzerland"
    cuisine="Fusion, International"
    priceRange="€€"
    phoneNumber="+41216160909"
    website="https://www.maza-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Maza, the food tells a tale of travel and love between Robin and Julien Burnier, a cosmopolitan couple with stints in Japan, America and France. Together they sign a vibrant, indulgent score that involves dishes to share of European, Asian and Oriental influences, like tartare of trout on polenta chips or ginger-laced tataki of rump steak. Meticulously sourced local produce, well curated wine cellar and a pleasant patio in a pedestrian neighbourhood – bookings essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20rue%20Marterey%2C%20Lausanne%2C%201005%2C%20Switzerland"
    pageTitle="Maza"
  />
);

export default MazaLAU;
