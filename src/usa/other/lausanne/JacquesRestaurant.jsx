...
const JacquesRestaurant = () => (
  <RestaurantPage
    restaurantName="Jacques Restaurant"
    address="Rue de la Barre 5, Lausanne, 1005, Switzerland"
    cuisine="French Contemporary, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+41215448875"
    website="https://www.jacques-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the opera house is chef Jacques Allisson's bistronomy restaurant. His modern, creative and tasteful take on French cuisine is a hit, and the place is very popular. The atmosphere is relaxed, the service friendly and attentive. At lunchtime there is a business lunch; in the evening there are two set menus as well as à la carte dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Barre%205%2C%20Lausanne%2C%201005%2C%20Switzerland"
    pageTitle="Jacques Restaurant"
  />
);

export default JacquesRestaurant;
