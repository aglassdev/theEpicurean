...
const LeBerceauDesSens = () => (
  <RestaurantPage
    restaurantName="Le Berceau des Sens"
    address="Route de Berne 301, Lausanne, 1000, Switzerland"
    cuisine="Modern French, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+41217851221"
    website="https://www.berceau-des-sens.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Lausanne's EHL Hospitality Business School can be proud of this top-notch restaurant. A crack team of chefs (several Meilleurs Ouvriers de France are on the teaching faculty) work with the students to orchestrate a series of dishes that abound with coherent flavours, bringing their classroom learnings to the table! The dishes, which are perfectly poised between classic and modern, demonstrate a mastery of technical skill. From start to finish, each bite is bliss, and the setting also enhances the experience: the bright interior has a superb view of the surrounding mountains. Hats off!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Berne%20301%2C%20Lausanne%2C%201000%2C%20Switzerland"
    pageTitle="Le Berceau des Sens"
  />
);

export default LeBerceauDesSens;
