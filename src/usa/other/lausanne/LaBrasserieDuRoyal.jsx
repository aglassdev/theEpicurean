...
const LaBrasserieDuRoyal = () => (
  <RestaurantPage
    restaurantName="La Brasserie du Royal"
    address="Avenue d'Ouchy 40, Lausanne, 1006, Switzerland"
    cuisine="Classic French"
    priceRange="€€€"
    phoneNumber="+41216148888"
    website="https://www.royalsavoy.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Royal Savoy hotel was one of the favoured haunts of the Spanish court. The brasserie’s culinary focus is highly enticing menu that features dishes such as pâté royal en croûte, goose foie gras, and a mousseline of crayfish from Lake Geneva, as well as seasonal recipes such as hare à la Royale. A truly chic experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20d'Ouchy%2040%2C%20Lausanne%2C%201006%2C%20Switzerland"
    pageTitle="La Brasserie du Royal"
  />
);

export default LaBrasserieDuRoyal;
