...
const TastyPlace = () => (
  <RestaurantPage
    ...
    address="1625 El Camino Real, Millbrae, 94030, USA"
    cuisine="Chinese, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+16508722338"
    website="https://tastyplaceca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you like dumplings and noodles—and plenty of them—Tasty Place is your kind of place. Hot or cold, steamed or pan-fried, solo or in soup, this cornucopia of carbs is made entirely by hand, a process diners can watch unfold in a glassed-in room adjacent to the kitchen. It’s likely you’ll find yourself with some time to do so, as waits can get long at peak hours.As with many Chinese eateries, the menu is overly vast, spanning from Sichuan to Cantonese. The happiest diners stick to dough-based items, like tender chicken dumplings with sweet corn, or chewy handmade cold noodles topped with ground pork, mung bean sprouts, green onion and chilies. Pork dumplings with fermented cabbage are ferociously good—equal parts juicy, tangy and toothsome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1625%20El%20Camino%20Real%2C%20Millbrae%2C%2094030%2C%20USA"
    pageTitle="Tasty Place"
  />
);

export default TastyPlace;
