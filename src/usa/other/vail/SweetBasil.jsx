...
const SweetBasil = () => (
  <RestaurantPage
    ...
    address="193 Gore Creek Dr., Vail, 81657, USA"
    cuisine="Fusion"
    priceRange="$$$$"
    phoneNumber="+19704760125"
    website="https://www.sweetbasilvail.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 1977, this legendary local establishment has a long and storied history, and it remains as popular now as ever, whether for lunch, après-ski drinks at the bar or dinner. The menu is eclectic, freely borrowing and blending flavors from across the globe, as in tempura-fried mahi mahi tacos with peanut salsa macha, bone marrow pho with scallop, or a miso black garlic-glazed halibut with fondant potatoes. Desserts are whimsical, but seriously good, for example the indulgently named “if you like piña coladas,” which features caramelized pineapple compote, passion fruit pâte de fruit and a crunchy coconut crumble. Carefully mixed cocktails and a compelling wine list round out the abundant appeal of this approachable yet elevated favorite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=193%20Gore%20Creek%20Dr.%2C%20Vail%2C%2081657%2C%20USA"
    pageTitle="Sweet Basil"
  />
);

export default SweetBasil;
