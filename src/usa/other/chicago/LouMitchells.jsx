...
const LouMitchells = () => (
  <RestaurantPage
    restaurantName="Lou Mitchell's"
    address="565 W. Jackson Blvd., Chicago, 60661, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+13129393111"
    website="https://www.loumitchells.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Strategically set near Union Station, this beloved diner has stood the test of time. Open since 1923, locals and visitors alike have scooched into booths and sat at the bar for homey comfort food that never promises to be more than what it is. Eggs, waffles, and pancakes come prepared in a dizzying number of ways. There are all sorts of salads and sandwiches; try the La Conga Delight (cheese, bacon, tomato) or the hearty open-faced Reuben on homemade rye and served with a hot stack of thick-cut steak fries. Servers roam the floor with hot coffee and complimentary donut holes. Especially after a long night, such simple pleasures go a long way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=565%20W.%20Jackson%20Blvd.%2C%20Chicago%2C%2060661%2C%20USA"
    pageTitle="Lou Mitchell's"
  />
);

export default LouMitchells;
