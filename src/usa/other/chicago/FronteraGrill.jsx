...
const FronteraGrill = () => (
  <RestaurantPage
    ...
    address="445 N. Clark St., Chicago, 60654, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+13126611434"
    website="https://www.fronteragrill.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This linchpin in Rick Bayless’ empire is decidedly unique in its homage to regional Mexican cuisine and displays a cult-like devotion to local product. From the table-shaken margaritas and the molés to the warm, uplifting music, you'll likely feel you're in Mexico. The menu is ever-changing but begin with the classic Frontera ceviche, a vibrant and refreshing blend of Pacific albacore, lime, tomato, olive and cilantro. Don't miss the specialties, highlighting the flavors of Guerrero on the Pacific Coast, along with sides like roasted cauliflower with poblano crema and melted cheese. Do save room for the chocolate pecan pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=445%20N.%20Clark%20St.%2C%20Chicago%2C%2060654%2C%20USA"
    pageTitle="Frontera Grill"
  />
);

export default FronteraGrill;
