...
const PizzaFriendlyPizza = () => (
  <RestaurantPage
    restaurantName="Pizza Friendly Pizza"
    address="1039 N. Western Ave., Chicago, 60622, USA"
    cuisine="Pizza, American"
    priceRange="$$"
    phoneNumber="+17733952483"
    website="https://www.pizzafriendlypizza.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Secreted away in one of the many alleyways in Ukranian Village and amidst scores of other venues, this is an alfresco dinning delight. Takeaway is the other alternative, when the weather isn't right. Regardless, the space is especially unique, thanks to a few garden tables and trestles with hanging plants.Chef Noah Sandoval is involved with this project and his talent is clearly under the spotlight, as evidenced by the delicious pan pizzas, salads, and sandwiches. Don't miss out on a pizza square with soppressata, Castelvetrano olives, and maitake mushrooms. A sandwich, featuring perfectly charred rapini, Taleggio, Agrumato, and Calabrian chili, is yet another taste-bud tease. Cool things down with a Pizzaberry tonic and bottle of bubbly Topo Chico...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1039%20N.%20Western%20Ave.%2C%20Chicago%2C%2060622%2C%20USA"
    pageTitle="Pizza Friendly Pizza"
  />
);

export default PizzaFriendlyPizza;
