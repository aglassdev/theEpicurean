...
const Giant = () => (
  <RestaurantPage
    restaurantName="Giant"
    address="3209 W. Armitage Ave., Chicago, 60647, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+17732520997"
    website="https://www.giantrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brought to you by Jason Vincent, this fabulous and friendly restaurant is the epitome of Chicago. Its menu is a listing of familiar dishes (think onion rings, crab salad and baby back ribs), albeit drummed up with unique accents reflecting the chef’s distinctive style. The petite space is simple and lovely, with a modern-rustic décor and genuinely cozy neighborhood vibe. A chef’s counter in the back offers an up-close-and-personal kitchen experience.Kick things off with the excellent Jonah crab salad, served with soft waffle-cut potato fritters and freshly made cocktail sauce. Then move on to the “pici with chew,” where thick strands of noodles are cooked to a conservative al dente, and tossed with smoky bacon, chopped jalapeños and breadcrumbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3209%20W.%20Armitage%20Ave.%2C%20Chicago%2C%2060647%2C%20USA"
    pageTitle="Giant"
  />
);
