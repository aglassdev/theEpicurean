...
const Mfk = () => (
  <RestaurantPage
    restaurantName="mfk."
    address="432 W. Diversey Pkwy., Chicago, 60614, USA"
    cuisine="Spanish, Fusion"
    priceRange="$$"
    phoneNumber="+17738572540"
    website="https://www.mfkrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“First we eat, then we do everything else,” said M.F.K. Fisher, the food writer who serves as both the inspiration and namesake for this local darling. Thanks to large windows, whitewashed brick walls and silver-and-white tilework, the subterranean space manages to evoke a breezy oasis. Organized from small to large plates, the thoughtfully composed, Iberian-inspired menu follows suit.  Simple, flavorful dishes, like warm boquerónes, croquettes with Montamoré cheese, or crostini with butter, lemon, and a single anchovy are tempting before main dishes like seared scallops with persimmon gazpacho or sides like roasted parsnips with mole amarillo. A crumbly slice of Basque cake and a cortado end the meal on a high note...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=432%20W.%20Diversey%20Pkwy.%2C%20Chicago%2C%2060614%2C%20USA"
    pageTitle="mfk."
  />
);
