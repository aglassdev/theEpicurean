...
const ChilamBalam = () => (
  <RestaurantPage
    restaurantName="Chilam Balam"
    address="3023 N. Broadway, Chicago, 60657, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+17732966901"
    website="https://www.chilambalamchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cozy subterranean space feels like an undiscovered hideaway, but the secret is offcially out. Though waits can be long, the helpful staff always goes the extra mile to steer guests through a rotating menu of complex shared plates.Familiar favorites and seasonal specials make for a festive spread of adventurous, yet universally pleasing dishes, like roasted plantains set over a layer of cottage cheese and topped with salsa macha (made from sesame seeds and peppery dressed watercress). Achiote-marinated beef empanadas with a habanero-spiced pineapple tatemada salsa show an in-depth understanding of flavors; while peanut butter empanadas—primed for dipping in Oaxacan chocolate sauce and dulce de leche—take a childhood delight to new heights...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3023%20N.%20Broadway%2C%20Chicago%2C%2060657%2C%20USA"
    pageTitle="Chilam Balam"
  />
);

export default ChilamBalam;
