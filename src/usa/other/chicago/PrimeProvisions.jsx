...
const PrimeProvisions = () => (
  <RestaurantPage
    restaurantName="Prime & Provisions"
    address="222 N. LaSalle St., Chicago, 60601, USA"
    cuisine="Steakhouse"
    priceRange="$$$"
    ...
    bio="Though it would also feel at home in Las Vegas, this glitzy oversized steakhouse fits right in with its swanky Chicago riverfront neighbors. The polished, masculine interior makes its priorities clear from the get-go, showcasing a two-story wine tower and a peek into the dry-aging room under bold, barrel-vaulted ceilings and chandeliers.House-flared, thick-cut bacon seasoned with black pepper, Michigan maple syrup, and dark chocolate starts things off on a decadent note, tailed by a dry-aged NY strip with black pepper crust served with mushrooms and mashed potatoes. Save room for a slice of apple pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=222%20N.%20LaSalle%20St.%2C%20Chicago%2C%2060601%2C%20USA"
    pageTitle="Prime & Provisions"
  />
);

export default PrimeProvisions;
