...
const Elske = () => (
  <RestaurantPage
    restaurantName="Elske"
    address="1350 W. Randolph Ave., Chicago, 60607, USA"
    cuisine="Contemporary, American Contemporary"
    priceRange="$$$$"
    phoneNumber="+13127331314"
    website="https://www.elskerestaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Year after year, Chefs David and Anna Posey hit their marks with this Danish oasis. A marvelous patio seamlessly flows into an airy dining room that fills up quickly — and for good reason. In choosing between the set tasting and the a la carte, there is no wrong answer. Both journeys capture the spirit of what makes this restaurant special by showing a respect for the seasons, delightful originality, and a stylish flair that never comes at the cost of flavor. Past highlights include lamb tartare on rye, duck liver tart with salted tamp, and yeasted chickpea pancakes with smoked trout. The signature dessert is a sunflower seed parfait with sour honey and licorice. Juice pairings and esoteric wines round out the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1350%20W.%20Randolph%20Ave.%2C%20Chicago%2C%2060607%2C%20USA"
    pageTitle="Elske"
  />
);

export default Elske;
