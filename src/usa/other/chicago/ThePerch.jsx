...
const ThePerch = () => (
  <RestaurantPage
    restaurantName="The Perch"
    address="1932 W. Division St., Chicago, 60622, USA"
    cuisine="American, Gastropub"
    priceRange="$$$"
    phoneNumber="+17734862739"
    website="https://www.perchchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A whitewashed façade and verdant planters welcome diners to this warm and intimate dining room. In contrast, the interior feels more industrial, by way of large steel vats of beer, for which this bijou is clearly beloved. Other furnishings include a long, welcoming bar lined with green tiles and an array of seats.This is cooking that's certainly both excellent and exciting. Taste the splendor behind the top-shelf ingredients in a seared tuna salad with crunchy greens, sweet mango and soft avocado. Share a plate of potato-bacon croquettes to begin, then tuck into a grilled NY strip accompanied by an arugula salad. There are more than a handful of beers on draft, and tastings ensure decision making is a cinch. Don't miss a slice of their banana cream pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1932%20W.%20Division%20St.%2C%20Chicago%2C%2060622%2C%20USA"
    pageTitle="The Perch"
  />
);

export default ThePerch;
