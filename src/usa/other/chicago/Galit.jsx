...
const Galit = () => (
  <RestaurantPage
    restaurantName="Galit"
    address="2429 N. Lincoln Ave., Chicago, 60614, USA"
    cuisine="Middle Eastern, Mediterranean Cuisine"
    priceRange="$$$$"
    phoneNumber="+17733608755"
    website="https://www.galitrestaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Its exterior is unassuming, but one step inside the hot spot and you'll be smitten by its lively vibe, warm hospitality and seductive aromas. Chef Zach Engel brings his experience to bear on this personal brand of modern Middle Eastern cuisine. His prix-fixe allows diners to make their own selections from a range of options. A generous first course kicks things off: Creamy hummus with brisket and salatim (spreads and pickles) accompanied by just-cooked, flame-kissed pita. Even familiar favorites like crackling-crisp falafel with mango labneh offer surprising depth. The team’s impressive intentionality extends to its beverage program, as esoteric wines from Armenia, Lebanon, Palestine, and Israel tell their own stories and make for beautiful pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2429%20N.%20Lincoln%20Ave.%2C%20Chicago%2C%2060614%2C%20USA"
    pageTitle="Galit"
  />
);

export default Galit;
