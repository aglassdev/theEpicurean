...
const Anelya = () => (
  <RestaurantPage
    restaurantName="Anelya"
    address="3472 N. Elston Ave., Chicago, 60618, USA"
    cuisine="Eastern European"
    priceRange="$$"
    phoneNumber="+17736922192"
    website="https://www.anelyarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named for his grandmother, Chefs Johnny Clark and Beverly Kim bring the flavors of Eastern Europe to Avondale. Throw back a shot of horseradish-infused vodka or sip a glass of Balkan wine in the bar before moving to the cozy dining room.The menu takes a product-focused approach to traditional specialties. An array of hors d'ouevres is displayed on the zakusky cart loaded with the likes of sunflower seed hummus, tart roe tarts, and carrot salad. Green borsch is enhanced with dill and nettles, stocked with boiled egg and slices of fingerling potato, while the freshly baked, butter-glazed, challah-like pampushky bread is a perfect pairing with the soup. Stuffed cabbage, or holubtsi, features finely ground locally raised beef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3472%20N.%20Elston%20Ave.%2C%20Chicago%2C%2060618%2C%20USA"
    pageTitle="Anelya"
  />
);

export default Anelya;
