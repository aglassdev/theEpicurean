...
const TiedHouse = () => (
  <RestaurantPage
    restaurantName="Tied House"
    address="3157 N. Southport Ave., Chicago, 60657, USA"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+17736974632"
    website="https://www.schubastiedhouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It might come as a surprise that this sleek, good-looker shares the same owners as next-door Schubas Tavern. And like a tavern, its menu paints broad strokes to appeal to a wide range. Start off with a smoked trout and artichoke dip served with house-made salt and vinegar chips before tucking in to the butternut squash schnitzel. Baked, breaded and fried butternut squash served over spaetzle tossed in brown butter with sauerkraut, hazelnuts and cranberries is a delicious riff on the classic. . Of course, this kitchen can do so much more and flexes its culinary muscles in other dishes, like fried sweet potato with salsa macha and cumin yogurt or a winning Spanish mackerel set on coconut-braised garbanzo beans and garnished with fistfuls of parsley and mint...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3157%20N.%20Southport%20Ave.%2C%20Chicago%2C%2060657%2C%20USA"
    pageTitle="Tied House"
  />
);

export default TiedHouse;
