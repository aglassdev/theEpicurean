...
const NorthPond = () => (
  <RestaurantPage
    restaurantName="North Pond"
    address="2610 N. Cannon Dr., Chicago, 60614, USA"
    cuisine="Contemporary, American"
    priceRange="$$$$"
    phoneNumber="+17734775845"
    website="https://northpondrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Lincoln Park, find this comfortable dining room that originally started out as a warming shelter for park ice skaters. Rustic exposed brick and views across that gorgeous eponymous pond with the city skyline just beyond set the stage for Chef Cesar Murillo, who cooks with the seasons and layers on global inflections that lean Latin and Asian. The tasting menu is approachable in length and variety, showcasing a creative range from tuna tartare with chicharron to agnolotti with maple-sunflower cream. One course even featured tomatoes and herbs grown from the restaurant’s very own rooftop garden. For the main course, look forward to wagyu, usually grilled and adorned with clever touches like buttermilk cream and shiso sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2610%20N.%20Cannon%20Dr.%2C%20Chicago%2C%2060614%2C%20USA"
    pageTitle="North Pond"
  />
);

export default NorthPond;
