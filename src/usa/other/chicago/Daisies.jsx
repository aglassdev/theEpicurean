...
const Daisies = () => (
  <RestaurantPage
    restaurantName="Daisies"
    address="2375 Milwaukee Ave., Chicago, 60647, USA"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+17736979443"
    website="https://www.daisieschicago.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="With the flick of a switch, Logan Square’s beloved pasta restaurant has found a new home just down Milwaukee Avenue. The move is a serious upgrade into a space nearly four times its original footprint. Flooded with sunlight, fitted with a comfortable bar and sporting a private dining room, the restaurant has no shortage of space. And much to everyone’s delight, house-made pastas like pappardelle with mushroom ragu or rigatoni with pork ragu and fermented tomato remain prime attractions. Onion dip with house-made ruffles is still on the menu and still a must-order. A bakery in the back gives this team even more room to play with sweets, and diners can choose between a dazzling selection of pastries, ice creams and sorbet at the meal’s end...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2375%20Milwaukee%20Ave.%2C%20Chicago%2C%2060647%2C%20USA"
    pageTitle="Daisies"
  />
);
