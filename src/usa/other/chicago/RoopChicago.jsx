...
const RoopChicago = () => (
  <RestaurantPage
    restaurantName="ROOP Chicago"
    address="736 W. Randolph St., Chicago, 60661, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$$"
    phoneNumber="+13122672323"
    website="https://www.roopchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bright and beautiful setting, located at the edge of the crowded dining strip of West Randolph, is spread over two floors and outfitted with deep blue velvet seats. Libations poured here have their own flavor matrix—study them if you must but rest assured that all are great.Similarly, the menu is dotted with Indian classics enhanced by such cutting-edge flavors as seen in the deep-fried cauliflower koliwada, accompanied by tempered yogurt and a rice mousse with peanut thecha. Follow this up with hearty beef short rib curry stocked with carrots and marrow kofta. Classic palates will relish the wonderfully creamy dal coupled with a plain naan for scooping, while a baked semolina cake with milk ice cream and pistachios will have sweet teeth swooning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=736%20W.%20Randolph%20St.%2C%20Chicago%2C%2060661%2C%20USA"
    pageTitle="ROOP Chicago"
  />
);

export default RoopChicago;
