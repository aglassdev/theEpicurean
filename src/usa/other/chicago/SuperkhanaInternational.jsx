...
const SuperkhanaInternational = () => (
  <RestaurantPage
    restaurantName="Superkhana International"
    address="3059 W. Diversey Ave., Chicago, 60647, USA"
    cuisine="Indian, Fusion"
    priceRange="$$"
    phoneNumber="+17736619028"
    website="https://www.superkhanachicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After five years of pop-ups and multiple kitchen pivots, this friendly restaurant has managed to stay both flexible and fun, which is also how we’d describe the cooking. Indian flavors are mixed and mashed in traditional and unconventional ways, as apparent in naan—a prominent menu fixture—topped with salted jalapeños and mozzarella, or reimagined as a calzone stuffed with butter chicken, brushed with ghee and finished with Maldon salt. It’s not all bread—fiery Kerala crab curry with flaky parotta and a vibrant chana chaat with tamarind and spice are equally impressive.A take-out window offering playful sandwiches during lunchtime is a boon for pedestrians. Exposed white brick, a long handsome bar and smooth warehouse floors make for an airy vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3059%20W.%20Diversey%20Ave.%2C%20Chicago%2C%2060647%2C%20USA"
    pageTitle="Superkhana International"
  />
);

export default SuperkhanaInternational;
