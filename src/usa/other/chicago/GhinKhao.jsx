...
const GhinKhao = () => (
  <RestaurantPage
    restaurantName="Ghin Khao"
    address="2128 W. Cermak Rd., Chicago, 60608, USA"
    cuisine="Thai"
    priceRange="$"
    phoneNumber="+17735654487"
    website="https://www.ghinkhaochicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name is Thai for “eat rice,” and you’ll want plenty of it to mop up every last bite of this kitchen's perfectly spicy, salty, sweet and tangy Northern Thai dishes. Operated by chef siblings, Nova and Kami Sasi, this is a fun, lively spot, with graffiti-like signage, hip-hop in the background, and colorful murals bedecking the walls. Every item is perfectly balanced, from the crunchy and subtly spiced fishcakes with cucumber-herb salad to the glorious nam khao tod, featuring crispy rice with ground chicken, pork skin, plenty of fresh ginger, cilantro and green onion.As a bonus, it’s also BYOB, so bring along a crew of friends with a couple of six-packs, and you'll be able to conquer most of the small menu—along with a few specials listed on the board...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2128%20W.%20Cermak%20Rd.%2C%20Chicago%2C%2060608%2C%20USA"
    pageTitle="Ghin Khao"
  />
);

export default GhinKhao;
