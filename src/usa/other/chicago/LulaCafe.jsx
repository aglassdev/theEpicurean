...
const LulaCafe = () => (
  <RestaurantPage
    restaurantName="Lula Cafe"
    address="2537 N. Kedzie Ave., Chicago, 60647, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+17734899554"
    website="https://www.lulacafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This neighborhood gem is just as it’s always been and regardless of whether you're squeezed into the main dining room with friends or seated solo at the spacious bar in the adjacent space, the charm of this mainstay endures. The evolving menu focuses on fresh, seasonal, and original fare, keeping it slammed from morning to night. The potato 'nduja tart with cheddar and caramelized onions is spot on, as is the house-made spaghetti tossed with seasoned pancetta and a sweet and spicy chili bean “salsa rosa. Finish over a tall slice of double-layered carrot cake, complete with crème anglaise and a luxurious spoonful of strawberry preserves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2537%20N.%20Kedzie%20Ave.%2C%20Chicago%2C%2060647%2C%20USA"
    pageTitle="Lula Cafe"
  />
);

export default LulaCafe;
