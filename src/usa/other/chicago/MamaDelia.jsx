...
const MamaDelia = () => (
  <RestaurantPage
    restaurantName="Mama Delia"
    address="1721 W. Division St., Chicago, 60622, USA"
    cuisine="Spanish, Spanish Contemporary"
    priceRange="$$"
    phoneNumber="+13124871236"
    website="https://www.mamadelia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hot mama greets diners with a marble bar along with an enticing cabinet display of premium conservas, oils, and spices. A series of top cocktails and sherries merely add to the allure. Set towards the back, the dining room is a visual masterpiece, thanks to plush red banquettes, vintage rugs, bright Moorish tiles, and wrought-iron chandeliers.The kitchen is focused on cooking that is both ingenious and satisfying, as in the tacos de oreja filled with fried pig's ears with piquant morcilla kimchi and salsa brava; or pulpo canario, served with confit baby potatoes and chicharrón-infused olive oil. Albeit traditional, desserts like the tarta de Santiago (almond-flour cake with apple sorbet) deliver singular twists and turns...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1721%20W.%20Division%20St.%2C%20Chicago%2C%2060622%2C%20USA"
    pageTitle="Mama Delia"
  />
);

export default MamaDelia;
