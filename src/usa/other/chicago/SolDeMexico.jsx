...
const SolDeMexico = () => (
  <RestaurantPage
    restaurantName="Sol de Mexico"
    address="3018 N. Cicero Ave., Chicago, 60641, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+17732824119"
    website="https://soldemexicochicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Far more authentic than the average chips-and-salsa joint, Sol de Mexico brightens the scene and palate with a lively atmosphere (cue the mariachi music) and delectable house specialties. Walls painted in tropical pinks, blues and oranges are a cheerful canvas for Dia de los Muertos artifacts. To sample the kitchen’s skill, start with sopes surtidos “xilonen”—four molded masa cups with a variety of fillings like caramelized plantains doused in sour cream, or tender black beans topped with crumbly house-made chorizo. Then, move on to the pollo en mole manchamanteles, which translates to “tablecloth stainer.” Rich and slightly bitter with a comforting nuttiness, the aptly named mahogany sauce begs to be sopped up with freshly made tortillas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3018%20N.%20Cicero%20Ave.%2C%20Chicago%2C%2060641%2C%20USA"
    pageTitle="Sol de Mexico"
  />
);

export default SolDeMexico;
