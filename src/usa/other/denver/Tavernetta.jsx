...
const Tavernetta = () => (
  <RestaurantPage
    restaurantName="Tavernetta"
    address="1889 16th St., Denver, 80202, USA"
    cuisine="Italian, Contemporary"
    priceRange="$$"
    phoneNumber="+17206051889"
    website="https://www.tavernettadenver.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tavernetta is an absolute stunner. Every detail has been considered and designed to encourage lingering and relaxing in this unique and beautiful space. The Italian menu nods to more well-known dishes from multiple regions, and the plates are refreshingly uncluttered. The classics are prepared with obvious care, as in a crostini primavera with a sourdough base layered with creamy stracciatella, heritage English peas and lovely spring greens. Crisp and fresh, it's simple but spot on. Spaghetti all'amatriciana is loaded with guanciale, tomato and pecorino romano for a wonderfully savory dish. To finish, tiramisu is a classic for a reason.Come at lunch for a delicious two-course deal, then spring for a dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1889%2016th%20St.%2C%20Denver%2C%2080202%2C%20USA"
    pageTitle="Tavernetta"
  />
);

export default Tavernetta;
