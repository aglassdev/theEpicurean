...
const MercantileDiningAndProvision = () => (
  <RestaurantPage
    restaurantName="Mercantile"
    address="1701 Wynkoop St., Ste. 115, Denver, CO, 80202, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+17204603733"
    website="https://www.mercantiledenver.com/"
    aliases={["Mercantile Dining and Provision"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They may have their own entrance, but it's worth the walk through Union Station to arrive at this handsome spot complete with wood floors and tables, tufted leather banquettes and a soothing palette of brown and blue. The elevated take on American cuisine is inflected with global touches with plenty of appeaing choices. There's even a lunch prix fixe with two courses (plus the option to add a wine pairing if you’re in the mood). Go for the roasted broccoli Caesar, followed up by the fried chicken banh mi for a treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1701%20Wynkoop%20St.%2C%20Ste.%20115%2C%20Denver%2C%20CO%2C%2080202%2C%20USA"
    pageTitle="Mercantile"
  />
);

export default MercantileDiningAndProvision;
