...
const KawaNi = () => (
  <RestaurantPage
    restaurantName="Kawa Ni"
    address="1900 W. 32nd Ave., Denver, 80211, USA"
    cuisine="Japanese, Contemporary"
    priceRange="$$"
    phoneNumber="+13034552984"
    website="https://kawanidenver.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a brick building that was once a firehouse, this unconventional izakaya from Chef Bill Taibe offers approachable Japanese cooking by way of Connecticut (home of the original location). To match the freewheeling cuisine, the vibe is lively and relaxed, with an ample bar reserved for walk-ins that offers an ideal spot to nibble while tippling an assortment of sakes and cocktails. The menu has a bit of everything, from creative shareable plates like a scallop crudo with grapefruit, ginger, and dill, or a kung pao chicken karaage; more substantial dishes of noodles, as in a carbonara-like bowl of kimchi udon with pork belly, egg yolk, and pecorino, are plenty satisfying as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1900%20W.%2032nd%20Ave.%2C%20Denver%2C%2080211%2C%20USA"
    pageTitle="Kawa Ni"
  />
);

export default KawaNi;
