...
const Noisette = () => (
  <RestaurantPage
    restaurantName="Noisette"
    address="3254 Navajo St., Ste. 100, Denver, 80211, USA"
    cuisine="French, Contemporary"
    priceRange="$$$"
    phoneNumber="+17207698103"
    website="https://www.noisettedenver.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chefs Tim Lu and Lillian Cho earned their chops in some of New York's top restaurants but thankfully chose Denver to open their own place. Sophisticated and spacious with a separate patisserie up front, the dining room is elegant, but the real draw is the precisely crafted dishes bound by tradition while reflecting a creative approach. Foie gras au torchon with a light coating of Björn's lavender honey and a Port reduction is served with a buttery brioche for a classic take. Next, a lush beef entrecôte enthralls with tender meat topped with petals of sweet roasted pearl onions and a Bordelaise sauce that offers indulgence in every last bite. End on a sweet note with tarte tropézienne aux fraises, a light-as-air brioche filled with diplomat cream and strawberry jam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3254%20Navajo%20St.%2C%20Ste.%20100%2C%20Denver%2C%2080211%2C%20USA"
    pageTitle="Noisette"
  />
);

export default Noisette;
