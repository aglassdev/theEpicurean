...
const BrasserieBrixton = () => (
  <RestaurantPage
    restaurantName="Brasserie Brixton"
    address="3701 N. Williams St., Denver, 80205, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+13035930951"
    website="https://www.brasseriebrixton.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owners of this cozy spot in North Denver drew its inspiration from their love of the casual bistros and wine bars of Montreal, resulting in a certain approachable charm that makes it a neighborhood restaurant par excellence. It also comes through both in the rustic aesthetic, and moreover in the small menu of staples like steak frites with creamy pepper sauce, rib-sticking chicken fricassee with Boursin pomme purée, and comforting French onion soup, alongside more inventive items like blood sausage fried wontons with tamari vinaigrette. There's also an excellent burger. Well-crafted cocktails and a compact but thoughtful list of thirst-quenching natural wines round out the roster...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3701%20N.%20Williams%20St.%2C%20Denver%2C%2080205%2C%20USA"
    pageTitle="Brasserie Brixton"
  />
);

export default BrasserieBrixton;
