...
const MisterOso = () => (
  <RestaurantPage
    restaurantName="Mister Oso"
    address="3163 Larimer St., Denver, 80205, USA"
    cuisine="Latin American"
    priceRange="$$"
    phoneNumber="+17208640312"
    website="https://www.misterosodenver.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's laid-back and lively at Mister Oso, a small but stylish spot with a creative menu and clever cooking. Chef/owner Blake Edmunds has a hit on his hands, with a second location opening in recent years. While tacos may be the main event, this isn't your typical taqueria menu. Instead, discover ceviches, salads and dishes bearing Latin American and international influences. Everything is served family style. Pick up a tortilla and start building a delicious treat, as in the smoked lamb cheek tacos with pickled red onion and grilled shishito peppers that's finished with a bright and zesty avocado salsa. Coconut rice, served in a piping hot cast iron dish, bridges sweet and savory thanks to pickled shaved peppers and thin, shaved red onion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3163%20Larimer%20St.%2C%20Denver%2C%2080205%2C%20USA"
    pageTitle="Mister Oso"
  />
);

export default MisterOso;
