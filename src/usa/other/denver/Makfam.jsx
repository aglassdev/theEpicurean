...
const Makfam = () => (
  <RestaurantPage
    restaurantName="MAKfam"
    address="39 W. 1st Ave., Denver, 80223, USA"
    cuisine="Chinese"
    priceRange="$"
    phoneNumber="+17209825011"
    website="https://www.makfam.co/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What began as a pop-up back in NYC, where owners and married couple Doris Yuen and Kenneth Wan first met, and then became a stall in a Denver food hall, is now at last a full-service restaurant. The winsome, colorful space and the compact menu both celebrate the pair's Chinese American roots, both having been raised by immigrant families who worked in restaurants. Fried crab and cheese wontons and hand-shaped chicken and chive potstickers are inspired by Chinatown favorites and takeout staples, made with particular care and big flavor. Chicken wings with a spicy, tingly málà seasoning are favorites with good reason, and larger dishes, like the familiar-yet-inventive corned beef fried rice or spicy garlic butter rice cakes, impress as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20W.%201st%20Ave.%2C%20Denver%2C%2080223%2C%20USA"
    pageTitle="MAKfam"
  />
);

export default Makfam;
