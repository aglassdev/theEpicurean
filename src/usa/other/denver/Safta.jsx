...
const Safta = () => (
  <RestaurantPage
    restaurantName="Safta"
    address="3330 Brighton Blvd., Ste. 201, Denver, 80216, USA"
    cuisine="Israeli"
    priceRange="$$$"
    phoneNumber="+17204082444"
    website="https://www.eatwithsafta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Safta may mean grandmother in Hebrew, but there's nothing old school about this restaurant, Chef Alon Shaya's first outside Louisiana. Instead, this hot spot is located in the trendy Source Hotel. At first glance, it looks like you’re walking toward a coffee counter (and you are), but it wraps around to the restaurant and the kitchen. It's all airy and upbeat, just like the Israeli menu that lists many favorites but feels original and interesting. There must be hummus, of course, but here it's given a fresh take with roasted chanterelle mushrooms and chermoula butter served with freshly baked pita. Next up is a selection of salatim, or pickles and spreads, followed by a panoply of dishes ranging from harissa chicken, duck matzo ball soup, and short rib-stuffed cabbage to pomegranate lamb s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3330%20Brighton%20Blvd.%2C%20Ste.%20201%2C%20Denver%2C%2080216%2C%20USA"
    pageTitle="Safta"
  />
);

export default Safta;
