...
const MarcosCoalfired = () => (
  <RestaurantPage
    restaurantName="Marco's Coal-Fired"
    address="2129 Larimer St., Denver, 80205, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+13032967000"
    website="https://www.marcoscfp.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the shadow of Coors Field, Marco's takes pride in being the only spot in Colorado to be certified by the Associazione Verace Pizza Napoletana—a stamp of approval from the Italian birthplace of this beloved foodstuff. The crust alone makes a strong case, made with flavorful, hand-stretched dough, expertly fired in a traditional oven, with beautifully blistered, flame-kissed edges, but the quality of the toppings impresses as well, from San Marzano tomatoes, to prosciutto di parma, to aged pecorino. No substitutions are allowed on the Neapolitan pies, but non-traditional offerings will give guests plenty of room to play. Though the menu does have other offerings, as in salad and lasagna, pizza should rightfully hold the center of attention...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2129%20Larimer%20St.%2C%20Denver%2C%2080205%2C%20USA"
    pageTitle="Marco's Coal-Fired"
  />
);

export default MarcosCoalfired;
