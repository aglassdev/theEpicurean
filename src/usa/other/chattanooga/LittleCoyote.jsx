...
const LittleCoyote = () => (
  <RestaurantPage
    restaurantName="Little Coyote"
    address="3950 Tennessee Ave., Chattanooga, TN, 37409, USA"
    cuisine="Tex-Mex"
    priceRange="$$"
    phoneNumber="+14238007483"
    website="https://littlecoyote.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You could come to this St. Elmo spot for its view of Lookout Mountain alone, but then you'd miss out on some seriously good Tex-Mex cooking. Erik and Amanda Niel's Little Coyote is all about smoked meats, house-made corn tortillas and tempting cocktails. Familiar favorites like fajitas and queso make an appearance, and since it's all intended for sharing, order with abandon. Consider kicking off the meal with a stuffed avocado, made vegetarian or with brisket or tender, smoky carnitas. Then tuck into a tostada layered with braised oxtail. Finished with a fried egg and cactus chow chow, it's far from standard. The dinner menu spans more smoked meats including chicken and beef ribs. End with house-made ice cream, especially the goat cheese and vanilla with masa crumbles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3950%20Tennessee%20Ave.%2C%20Chattanooga%2C%20TN%2C%2037409%2C%20USA"
    pageTitle="Little Coyote"
  />
);

export default LittleCoyote;
