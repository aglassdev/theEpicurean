...
const SeraCoastalCuisine = () => (
  <RestaurantPage
    restaurantName="Serẽa Coastal Cuisine"
    address="1500 Orange Ave., Coronado, 92118, USA"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="$$$$"
    phoneNumber="+16194356611"
    website="https://sereasandiego.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1500%20Orange%20Ave.%2C%20Coronado%2C%2092118%2C%20USA"
    pageTitle="Serẽa Coastal Cuisine"
  />
);

export default SeraCoastalCuisine;
