...
const BoulderDushanbeTeaHouse = () => (
  <RestaurantPage
    restaurantName="Boulder Dushanbe Tea House"
    address="1770 13th St., Boulder, 80302, USA"
    cuisine="Eastern European"
    priceRange="$$$"
    phoneNumber="+13034424993"
    website="https://www.boulderteahouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hand-built gift from Dushanbe, Boulder's sister city in Tajikistan, offers a respite from quotidian life. Walk through the front garden and you'll be instantly transported to a zen-filled, magical space. If the bucolic setting doesn't lower your blood pressure, the stunning interior that transports you to a faraway culture will. As the name suggests, tea is the raison d'être here, and the selection is comprehensive. From apple strudel and samosas to feijoada and plov (a buttery rice dish studded with chickpeas, dried fruit and grilled beef), the menu reads like a world explorer's diary. Naturally, tea time and afternoon tea are reason alone to visit, and the dessert selection is particularly tempting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1770%2013th%20St.%2C%20Boulder%2C%2080302%2C%20USA"
    pageTitle="Boulder Dushanbe Tea House"
  />
);

export default BoulderDushanbeTeaHouse;
