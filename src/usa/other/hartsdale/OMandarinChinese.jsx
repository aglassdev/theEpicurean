...
const OMandarinChinese = () => (
  <RestaurantPage
    restaurantName="O Mandarin Chinese"
    address="361 N. Central Ave., Hartsdale, 10530, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$$"
    phoneNumber="+19144379168"
    website="https://www.omandarin.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its stark exterior does not hint at the warm vibe or enticing bites, bound to tempt even the most stoic eater here. One glance around this buzzy and well-appointed dining room proves that it is cherished by multi-generational groups. The setting paints an intriguing picture, thanks to sleek, intricately carved wooden panels, tables, chairs and vivid artwork. Semi-private booths are ingeniously lit, and most popular.The menu boasts a litany of delightful appetizers, like tender soup dumplings. Classics—like garlic-pepper shrimp with leeks and celery—are prepared with exacting technique and deliver wonderful flavor. Available as half or whole (depending on your party's size), slow-cooked Beijing duck is a sensory thrill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=361%20N.%20Central%20Ave.%2C%20Hartsdale%2C%2010530%2C%20USA"
    pageTitle="O Mandarin Chinese"
  />
);

export default OMandarinChinese;
