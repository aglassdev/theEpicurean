...
const PigInAPickle = () => (
  <RestaurantPage
    restaurantName="Pig in a Pickle"
    address="341 Corte Madera Town Centre, Corte Madera, 94925, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+14158913265"
    website="https://www.piginapickle.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=341%20Corte%20Madera%20Town%20Centre%2C%20Corte%20Madera%2C%2094925%2C%20USA"
    pageTitle="Pig in a Pickle"
  />
);

export default PigInAPickle;
