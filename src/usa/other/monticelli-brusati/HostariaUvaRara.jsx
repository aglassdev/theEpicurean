...
const HostariaUvaRara = () => (
  <RestaurantPage
    restaurantName="Hostaria Uva Rara"
    address="via Foina 42, Monticelli Brusati, 25040, Italy"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390306852643"
    website="https://www.hostariauvarara.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An ancient farmhouse dating back to the 15th century; the characteristic vaulting of the ceilings is in stone; furnishings are in excellent taste and professional management guarantees full enjoyment of some fine local recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Foina%2042%2C%20Monticelli%20Brusati%2C%2025040%2C%20Italy"
    pageTitle="Hostaria Uva Rara"
  />
);

export default HostariaUvaRara;
