...
const AmorYTacos = () => (
  <RestaurantPage
    restaurantName="Amor y Tacos"
    address="13333 South St., Cerritos, 90703, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+15628602667"
    website="https://amorytacos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yet another in the wave of Mexican-American LA chefs transforming the cuisine, Thomas Ortega brings his fine-dining drill to bear on this vibrant offering in his native Cerritos. Here he fuses his specific style of the city’s Mexican cuisine, like handmade tortillas and spicy salsas, with an American twist. Look for that Coca-Cola glaze on his pork belly or the sprinkle of Doritos on chilaquiles, not to mention such luxurious accents as truffles.It’s hard to miss with any of Chef Ortega's tacos, which range from crisp beer-battered cod with smoky salsa de arbol to tender, charred al pastor. Can't decide? Order the tour de tacos for an overview of the flavors the kitchen has to offer. Fried “calamari famoso” is the ideal partner for a spicy michelada...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13333%20South%20St.%2C%20Cerritos%2C%2090703%2C%20USA"
    pageTitle="Amor y Tacos"
  />
);

export default AmorYTacos;
