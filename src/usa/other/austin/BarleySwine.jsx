...
const BarleySwine = () => (
  <RestaurantPage
    restaurantName="Barley Swine"
    address="6555 Burnet Rd., Ste. 400, Austin, 78757, USA"
    cuisine="Contemporary, American"
    priceRange="$$$$"
    phoneNumber="+15123948150"
    website="https://barleyswine.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The room is decidedly casual, and diners are welcome to come as they are, but there's no mistaking the passion of this kitchen. Chef/owner Bryce Gilmore makes deft use of local ingredients with a distinctly Southwestern palette of flavors that draws from Mexican and Southern traditions, while maintaining a contemporary, global sophistication. The tasting menu is carefully attuned to the seasons, and refinement is balanced with a sense of whimsy. A tiny everything bagel with a creamy smoked radish spread and cucumber infused with dill hot sauce might come as a first bite, and a flawlessly seared Muscovy duck breast might be matched with a buttery puree of popped corn and an earthy/sweet nixtamalized peach.From dishes bought at Goodwill and growing produce onsite to collecting rainwater for ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6555%20Burnet%20Rd.%2C%20Ste.%20400%2C%20Austin%2C%2078757%2C%20USA"
    pageTitle="Barley Swine"
  />
);

export default BarleySwine;
