...
const CraftOmakase = () => (
  <RestaurantPage
    restaurantName="Craft Omakase"
    address="4400 N. Lamar Blvd., Ste. 102, Austin, 78756, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+15128878889"
    website="https://craftomakase.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Discreetly tucked away in Rosedale, Craft Omakase has a lounge up front with a dining room and counter in back. It is here where guests wisely place their faith in the hands of Chefs Charlie Wang and Nguyen Nguyen who dole out an impressive procession of nigiri and other bites. Their creative omakase doesn't shy away from embellishment, yet it's done with restraint and allows the fish to shine. An abundance of product hails from Japan, and the fish is skillfully handled. Preparations like an aguachile of pink shrimp with sweet potato or crudo of hamachi with yuzu-honey sauce are delightful stops in a line-up that may reveal ocean trout sprinkled with a furikake made with its crisped skin; shima aji with shiso and ume; or sea scallop dressed with ponzu and lemon zest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4400%20N.%20Lamar%20Blvd.%2C%20Ste.%20102%2C%20Austin%2C%2078756%2C%20USA"
    pageTitle="Craft Omakase"
  />
);

export default CraftOmakase;
