...
const Discada = () => (
  <RestaurantPage
    restaurantName="Discada"
    address="1700 E. Cesar Chavez St., Austin, 78702, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$"
    phoneNumber="+15129205473"
    website="https://www.discadatx.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Head to East Austin to find this stationary food truck where they only have one thing on their mind—discada. It may be the easiest order you've ever made, as there is no menu posted and the only decision you'll need to make is how many taquitos you want. As for the food, it's all in the name. Discada is a Northern Mexican style of cooking with different cuts of beef and pork cooked together with aromatic vegetables. Their version also adds bacon, onion, and roasted poblano peppers, all cooked down and served taquito style in single layers of yellow corn tortillas. Topped with a pulverized pineapple slaw and served with fresh salsa on the side, it's a delicious style not often seen. Elote and soft drinks round out the hyper-focused offerings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1700%20E.%20Cesar%20Chavez%20St.%2C%20Austin%2C%2078702%2C%20USA"
    pageTitle="Discada"
  />
);

export default Discada;
