...
const LecheDeTigre = () => (
  <RestaurantPage
    restaurantName="Leche de Tigre"
    address="318 E. Cevallos St., San Antonio, 78204, USA"
    cuisine="Peruvian"
    priceRange="$$"
    phoneNumber="+12102655933"
    website="https://lechedetigretx.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A ceviche bar, a cocktail menu full of pisco sours, and a cute patio? What’s not to like? This colorful hotspot is buzzing for good reason. Driven by a trio of brothers and their time spent growing up in Peru, this little bungalow emphasizes seafood dressed up in bright, zippy, punchy flavors. Striped bass with ginger leche de tigre thrives with the clever addition of plantains and huacatay oil. Scallops set in a sharp parmesan leche de tigre are paired with capers and garlic chips. Tostadas come piled high with yellowfin tuna tossed with Nikkei ponzu and showered with crispy leeks. Break from the sea with lomo saltado, a bold effort thanks to an umami-packed sauce that coats seared beef tenderloin, crispy-fried potatoes, and charred scallions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=318%20E.%20Cevallos%20St.%2C%20San%20Antonio%2C%2078204%2C%20USA"
    pageTitle="Leche de Tigre"
  />
);

export default LecheDeTigre;
