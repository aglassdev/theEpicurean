...
const Ladino = () => (
  <RestaurantPage
    restaurantName="Ladino"
    address="200 E. Grayson St. #100, San Antonio, 78215, USA"
    cuisine="Mediterranean Cuisine, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+12103256007"
    website="https://ladinosatx.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming San Antonio restaurant is a gem in the Pearl District. With an expansive terrace seating overlooking a verdant courtyard, the kitchen delivers creative, boldly seasoned dishes from across the Mediterranean. A wood-burning oven cranks out hot rounds of sourdough pita to pair with the likes of fire-roasted corn with labneh and sivri pepper or summer squash with grape-leaf chermoula. Seasonal fare figures prominently, and even Romano beans with fermented tomatoes pack far more flavor than you’d expect. Another must-order: Beef and lamb dumplings coated in a sauce of yogurt and smoked chili. Thoughtful cocktails like the green schug margarita add to the charm of this inspired restaurant that is never short on flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20E.%20Grayson%20St.%20%23100%2C%20San%20Antonio%2C%2078215%2C%20USA"
    pageTitle="Ladino"
  />
);
