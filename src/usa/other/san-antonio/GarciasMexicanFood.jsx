...
const GarciasMexicanFood = () => (
  <RestaurantPage
    restaurantName="Garcia's Mexican Food"
    address="842 Fredericksburg Rd., San Antonio, 78201, USA"
    cuisine="Tex-Mex"
    priceRange="$"
    phoneNumber="+12107355686"
    website="https://guide.michelin.com/en/texas/san-antonio_2958156/restaurant/garcia-s-mexican-food"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open since 1962, this venerable institution from the Garcia family remains a vibrant, proud part of the city’s dining fabric. At all hours, the squat building has people waiting outside waiting for a table and ready to dig into classic Tex-Mex cooking. The menu is expansive, and one could spend weeks trying to cover it. There are those who come to order eggs over easy, douse them in salsa, and scoop them up in warm flour tortillas. And then there are heartier appetites who launch right into the deluxe dinner, which features enchiladas, a tamale, chili con carne, and a hard-shell taco. Should you also tack on a brisket taco? Of course you should. Adding to the convivial charm of the diner setting is a staff that’s all smiles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=842%20Fredericksburg%20Rd.%2C%20San%20Antonio%2C%2078201%2C%20USA"
    pageTitle="Garcia's Mexican Food"
  />
);

export default GarciasMexicanFood;
