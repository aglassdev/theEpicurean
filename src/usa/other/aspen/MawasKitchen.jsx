...
const MawasKitchen = () => (
  <RestaurantPage
    restaurantName="Mawa's Kitchen"
    address="305 Aspen Airport Business Center, Ste. F, Aspen, 81611, USA"
    cuisine="Contemporary, American"
    priceRange="$$$"
    phoneNumber="+19707107096"
    website="https://www.mawaskitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mawa's Kitchen may not be the easiest to find with its tucked-away entrance, but stay the course because it's worth visiting this welcoming spot. Light colors, tasteful artwork and bare tables set with wildflower-filled vases create a mood-boosting vibe inside, while the outdoor terrace is a breezy perch. The food is equally appealing (think new-world meets old-world). Owner Mawa McQueen, who hails from the Côte d’Ivoire, delivers extraordinary quality with everyday value, such as black-eyed pea hummus served with pickled, charred and smoked vegetables and bread. The African chicken and seafood gumbo is boldly spiced and finger-licking good, but don't fill up because you'll want dessert—especially a wedge of that dreamy cheesecake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=305%20Aspen%20Airport%20Business%20Center%2C%20Ste.%20F%2C%20Aspen%2C%2081611%2C%20USA"
    pageTitle="Mawa's Kitchen"
  />
);

export default MawasKitchen;
