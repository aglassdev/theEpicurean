...
const TintaYCafe = () => (
  <RestaurantPage
    restaurantName="Tinta y Cafe"
    address="1315 Ponce De Leon Blvd., Coral Gables, 33134, USA"
    cuisine="Cuban, Regional Cuisine"
    priceRange="$"
    phoneNumber="+13052850101"
    website="https://www.tintaycafe.co/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Coral Gables is home to this original operation, happily christened with a name that translates to ink and coffee. Unsurprisingly, there are artfully arranged bookshelves that line its glass façade, while the interior design most certainly resembles that of a coffee shop. Grab a table either inside or out under a cluster of palm trees and settle in for a litany of Cuban delicacies, including pastelito de carne, pastelito de guava, and of course, cafe con leche.The furniture is mid-century modern, but the sandwich-focused menu is as classic and comforting as ever. Deep-fried croquetas are not to be missed; and the pavo real with turkey and cream cheese is nothing if not satisfying. Our allegiance, however, is with the patria (their take on the Cubano with pork, ham, mustard, and pickles.)..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1315%20Ponce%20De%20Leon%20Blvd.%2C%20Coral%20Gables%2C%2033134%2C%20USA"
    pageTitle="Tinta y Cafe"
  />
);

export default TintaYCafe;
