...
const WoodTavern = () => (
  <RestaurantPage
    restaurantName="Wood Tavern"
    address="6317 College Ave., Oakland, 94618, USA"
    cuisine="American"
    priceRange="$$"
    ...
    bio="There’s always a crowd at this neighborhood standby, where friends, families, and chic couples congregate for drinks at the copper-topped bar. Flanked by organic groceries, indie bookstores and antique shops, its environs speak of peace, weaving a bohemian spell that captivates both regulars and rookies alike.Seasonal Californian cooking with an Italian bent dominates this tavern's menu, and a butcher block of well-prepared charcuterie--like herb-flecked rabbit terrine wrapped in prosciutto--is a prudent way to start your meal. A touch of Calabrian chili adds welcoming heat to the combo of morels, Italian sausage, and sweet corn that sauce a bowl of al dente bucatini. For dessert, warm bread pudding with a coffee-chocolate sauce is utterly devourable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6317%20College%20Ave.%2C%20Oakland%2C%2094618%2C%20USA"
    pageTitle="Wood Tavern"
  />
);

export default WoodTavern;
