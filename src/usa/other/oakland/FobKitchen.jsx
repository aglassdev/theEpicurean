...
const FobKitchen = () => (
  <RestaurantPage
    restaurantName="FOB Kitchen"
    address="5179 Telegraph Ave., Oakland, 94609, USA"
    cuisine="Filipino, Contemporary"
    priceRange="$$"
    phoneNumber="+15108174169"
    website="https://www.fobkitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Janice Dulce is behind this popular Filipino restaurant that began as a pop-up. Tucked into the Temescal neighborhood, the space may be diminutive but it is ingeniously designed—with whimsical wallpaper and a relaxed, island vibe. Cozy up to the bar while you wait—a situation made infinitely more bearable with a stirring cocktail in hand. The menu is loaded with keepers, but keep your options open for tantalizing specials, like sweet and sour sinigang with pork, eggplant and daikon; or Janice’s Ribs, slow-roasted with coffee, coconut beer and banana ketchup. Suman, a steamed rice cake in a banana leaf, is then served with coconut crumble, coconut sauce and mango for a none-too-sweet treat.Weekends are brunch only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5179%20Telegraph%20Ave.%2C%20Oakland%2C%2094609%2C%20USA"
    pageTitle="FOB Kitchen"
  />
);

export default FobKitchen;
