...
const Pomet = () => (
  <RestaurantPage
    restaurantName="Pomet"
    address="4029 Piedmont Ave., Oakland, 94611, USA"
    cuisine="Californian"
    priceRange="$$$"
    phoneNumber="+15104502541"
    website="https://pomet-oakland.com/"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4029%20Piedmont%20Ave.%2C%20Oakland%2C%2094611%2C%20USA"
    pageTitle="Pomet"
  />
);

export default Pomet;
