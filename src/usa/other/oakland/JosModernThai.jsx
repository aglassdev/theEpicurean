...
const JosModernThai = () => (
  <RestaurantPage
    restaurantName="Jo's Modern Thai"
    address="3725 MacArthur Blvd., Oakland, 94619, USA"
    cuisine="Thai, Californian"
    priceRange="$$"
    phoneNumber="+15104793167"
    website="https://josmodernthai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The path to this Laurel District hotspot began when owner Kao Saelee, an Oakland native with Thai roots, first introduced his wife, Jo, to the cuisine, and it’s precisely that spirit of cultural exchange you’ll find embodied here. The menu displays the bold, balanced flavors typical of Thai cuisine, but isn’t overly concerned with hewing to tradition. That creative, irreverent approach is exemplified in dishes like a signature take on drunken noodles, which features smoky barbecue brisket, or a pork burger seasoned to resemble the complex herbaceous flavors of laab. Diners with delicate palates, fret not: the kitchen offers varying levels of spice. Choose from the unique, mouthwatering cocktail list to round out the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3725%20MacArthur%20Blvd.%2C%20Oakland%2C%2094619%2C%20USA"
    pageTitle="Jo's Modern Thai"
  />
);

export default JosModernThai;
