...
const TeniEastKitchen = () => (
  <RestaurantPage
    restaurantName="Teni East Kitchen"
    address="4015 Broadway, Oakland, 94611, USA"
    cuisine="Burmese"
    priceRange="$"
    ...
    bio="Burmese food with a California spin is on the menu at Chef/owner Tiyo Shibabaw’s cheery spot in Temescal, where the tea leaf salads come with kale and there’s plenty of flaky, golden roti bread to go around. Everything is affordable here, but the lunchtime specials are an especially good deal: a hot and flavorful entrée (like spicy coconut curry chicken with rice noodles) and a fresh salad—go for the pea shoots topped with radishes and fried garlic in a turmeric dressing.Bright and airy, with exposed wooden beams on the ceiling, Teni draws a crowd of hipsters of all ages. Its dining room can certainly fill up fast at prime hours, but it’s worth the wait for food that’s fresh, flavorful, unfussy and generously portioned...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4015%20Broadway%2C%20Oakland%2C%2094611%2C%20USA"
    pageTitle="Teni East Kitchen"
  />
);

export default TeniEastKitchen;
