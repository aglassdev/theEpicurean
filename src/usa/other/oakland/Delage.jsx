...
const Delage = () => (
  <RestaurantPage
    restaurantName="Delage"
    address="536 9th St., Oakland, 94607, USA"
    cuisine="Japanese"
    priceRange="$$$"
    phoneNumber="+15108232050"
    website="https://delage-oakland.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The word is out about this tiny, omakase-only Japanese gem, located adjacent to Swan’s Market in Old Oakland. It’s a simple, casual space with a small counter and handful of tables, but it also provides a fine spotlight for a mixture of high-quality nigiri and kaiseki dishes.Meals typically run about eight courses, with seasonal starters like a grilled apricot and mizuna salad; salmon sashimi adorned with a slice of Saturn peach; or garlic shoots enhancing seared Miyazaki beef.Excellent nigiri, from tuna to mackerel to fluke, arrive at intervals alongside other captivating items, like seared duck breast with moro miso or scallops with shiso and umeboshi. The only downside is that reservations can be a challenge—so be sure to plan well ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=536%209th%20St.%2C%20Oakland%2C%2094607%2C%20USA"
    pageTitle="Delage"
  />
);
