...
const Millennium = () => (
  <RestaurantPage
    restaurantName="Millennium"
    address="5912 College Ave., Oakland, 94618, USA"
    cuisine="Vegan"
    priceRange="$$"
    phoneNumber="+15107359459"
    website="https://www.millenniumrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After more than 20 years in San Francisco, this vegan paradise relocated to Oakland, where it’s continuing to put out some of the most unique, delicious plant-based cuisine in the country. This rustic-chic space is laid-back and unfussy, with lots of dark wood, a patio for alfresco dining and a crowd of young families and professionals attended by welcoming servers.While dedicated vegans are sure to swoon, even hardcore carnivores might reconsider the lifestyle after a dose of Chef/owner Eric Tucker’s culinary creativity, showcased best on a five-course “Taste of Millennium” menu. Roasted pumpkin tamales with pumpkin seed pastor and cashew nut crema are knockouts, as are the crunchy king trumpet fritters with chili-persimmon jam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5912%20College%20Ave.%2C%20Oakland%2C%2094618%2C%20USA"
    pageTitle="Millennium"
  />
);
