...
const MarketRestaurantBar = () => (
  <RestaurantPage
    restaurantName="MARKET Restaurant + Bar"
    address="3702 Via De La Valle, Del Mar, 92014, USA"
    cuisine="International"
    priceRange="$$$"
    phoneNumber="+18585230007"
    website="https://marketdelmar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner Carl Schroeder is a La Jolla native with an encyclopedic knowledge of the region’s bounty. He’s been celebrating every locally sourced ingredient for over a decade now in this kitchen, and his repertoire of creative cooking continues to draw patrons for both special occasions as well as date night. The dark and seductive décor manages to be elegant without a hint of pretense, but one glance at the parking lot and you know that this spot is favored by a moneyed lot.Sushi is well-loved here, but it would be a shame to miss the chef’s creative and internationally influenced dishes. For instance, blue cheese soufflé with anise-orange marmalade shows off a European bent, while miso-glazed cod with shrimp dumplings is resoundingly Asian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3702%20Via%20De%20La%20Valle%2C%20Del%20Mar%2C%2092014%2C%20USA"
    pageTitle="MARKET Restaurant + Bar"
  />
);

export default MarketRestaurantBar;
