...
const ChezTj = () => (
  <RestaurantPage
    ...
    address="938 Villa St., Mountain View, 94041, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+16509647466"
    website="https://www.cheztj.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fittingly located inside a quaint 19th-century Victorian, this doyenne of Mountain View fine dining offers a certain old-school sophistication. The menu, offered as a full degustation (with an abbreviated option available on Wednesdays and Thursdays) offers an assortment of local produce, together with luxury ingredients both domestic and imported, brought together in a contemporary French style. A meal might progress from lightly seared bonito with capers to smoked and grilled American wagyu with black garlic, culminating in a “Paris-Brest” with coconut Chantilly and calamansi. The wine list is nothing short of legendary, spanning from blue chips to bargain gems, and even the by-the-glass selection has treasures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=938%20Villa%20St.%2C%20Mountain%20View%2C%2094041%2C%20USA"
    pageTitle="Chez TJ"
  />
);

export default ChezTj;
