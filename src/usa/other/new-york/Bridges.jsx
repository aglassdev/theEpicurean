...
const Bridges = () => (
  <RestaurantPage
    ...
    address="9 Chatham Sq., New York, 10038, USA"
    ...
    bio="The talented Sam Lawrence is off to an impressive start with this welcome restaurant in the heart of Chinatown. The warm, amber-toned dining room possesses the ease and comfort of a bistro, while the kitchen cooks with noteworthy levels of drive and ambition. The tight menu is sparse on words and doesn’t fit neatly into the box of any one cuisine but know that inspiration and originality are in proper supply. A smooth sea urchin custard topped with shrimp tartare segues nicely into perfectly grilled sweetbreads that rival the very best in town. Finish with fireworks: Velvety-smooth vin jaune gelato matched with passionfruit is an unexpected thriller that, much like the restaurant, has all the makings of a classic. Service is both relaxed and attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Chatham%20Sq.%2C%20New%20York%2C%2010038%2C%20USA"
    pageTitle="Bridges"
  />
);
