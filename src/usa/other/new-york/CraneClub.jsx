...
const CraneClub = () => (
  <RestaurantPage
    restaurantName="Crane Club"
    address="85 10th Ave., New York, 10011, USA"
    cuisine="Steakhouse"
    priceRange="$$$$"
    phoneNumber="+12129702200"
    website="https://taogroup.com/venues/crane-club-restaurant-new-york/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With the backing of the global Tao Group Hospitality, Chef Melissa Rodriguez brings her refined touch to this ritzy steakhouse. A handsome bar leads into a sweeping dining room with banquettes galore and matching dark scarlet curtains that reach for the sky. Dinner begins with an impressive selection of breads, followed by must-order pastas like the squash tortellini. A custom-designed grill sears steaks from edge to edge and chars a lengthy roster of vegetable sides as well. Generously portioned desserts, like the banana farro layer cake with guava jam or the apple croissant crumble with malted oat gelato, set a new standard for steakhouse sweets. All the while, a fantastic wine list, smart cocktails, and suave servers keep dinner moving at a smooth pace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%2010th%20Ave.%2C%20New%20York%2C%2010011%2C%20USA"
    pageTitle="Crane Club"
  />
);

export default CraneClub;
