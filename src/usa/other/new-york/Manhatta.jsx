...
const Manhatta = () => (
  <RestaurantPage
    restaurantName="Manhatta"
    address="28 Liberty St., New York, 10005, USA"
    cuisine="Contemporary, American"
    priceRange="$$$$"
    phoneNumber="+12122305788"
    website="https://www.manhattarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Great views and good food rarely go hand in hand, but this stylish spot breaks that trend. Set in an iconic skyscraper and set some 60 floors up with Manhattan laid out before you, these views truly do not disappoint. The best seats in the house are those closest to the windows, though those with a view of the open kitchen are a close second. Chef Justin Bogle and his team have injected new life into the kitchen with global ingredients and ambitiously creative compositions that make excellent use of seasonal ingredients. Oysters Manhatta with uni and Champagne sabayon is a luxurious start, while the skin-on, seared, dry-aged duck with persimmon, endive and a side of white Japanese sweet potato puree is a standout...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20Liberty%20St.%2C%20New%20York%2C%2010005%2C%20USA"
    pageTitle="Manhatta"
  />
);

export default Manhatta;
