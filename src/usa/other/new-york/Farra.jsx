...
const Farra = () => (
  <RestaurantPage
    restaurantName="Farra"
    address="71 Worth St., New York, 10013, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber=""
    website="https://www.farranyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The word “Farra” has several meanings, all of which would be appropriate for this sleek retreat. Attractive, fun, and a bona fide party, Farra is a full-fledged restaurant that promises to garner a cultish following. With no charcuterie, cheese plates, or paninis in sight, diners can rest assured of savory, sumptuous cooking.Sharing the same wine cellar (and former sous chef) with next-door Atera, the team shows similar levels of hospitality, attention to detail, and creativity. Maybe you’ve had salmon tartare before, but was it mixed with potato chips for crunch and served with nori? We've all had ravioli, but what about the crown-shaped corona ripiena? Stuffed with lobster, ricotta, and set in a dashi broth, this course is in a league of its own...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71%20Worth%20St.%2C%20New%20York%2C%2010013%2C%20USA"
    pageTitle="Farra"
  />
);

export default Farra;
