...
const LePavillonNEW = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+12126621000"
    website="https://lepavillonnyc.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It may have a classic-sounding name, but Le Pavillon resides in one of the city's newest skyscrapers. The elegant dining room, with its soaring ceilings, plate glass and warm palette, makes the well-heeled feel right at home. You'll rub shoulders with many at the bar, a prized perch crowned by a dramatic blown glass chandelier. Chef Daniel Boulud and co-executive chef Will Nacev skillfully prepare a contemporary, globally inflected carte dominated by seafood and vegetable-focused items. Spaghetti alla chitarra may be twirled with Meyer lemon butter sauce and crowned with Kaluga caviar; while various preparations are produce-focused, as in a roasted cauliflower with locally grown Aleppo pepper muhammara and heirloom beans...."
    ...
    pageTitle="Le Pavillon"
  />
);

export default LePavillonNEW;
