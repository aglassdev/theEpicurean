...
const EssentialByChristophe = () => (
  <RestaurantPage
    restaurantName="Essential by Christophe"
    address="103 W. 77th St., New York, 10024, USA"
    cuisine="French Contemporary, Contemporary"
    priceRange="$$$$"
    phoneNumber="+16464787928"
    website="https://www.essentialbychristophe.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Push past the heavy iron doors to this modern restaurant tucked at the base of a classic townhouse. Supple leather, brass touches and various shades of beige comprise the contemporary, elegant space, where a buzzy bar and a welcoming dining room await. Chef Christophe Bellanca's dishes echo a simple elegance, evidenced by plump white asparagus on a fragrant bergamot-flavored crème with a refreshing herb vinaigrette and paper-thin slices of watermelon radish. French technique is married with Asian flavors in a dish of three blue prawns with genmaicha tuille, and braised black sea bass with shiitake chutney, razor clams and a turmeric emulsion is memorable. For a light ending, the orange soufflé is bright and fragrant, especially when served with green cardamom ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=103%20W.%2077th%20St.%2C%20New%20York%2C%2010024%2C%20USA"
    pageTitle="Essential by Christophe"
  />
);

export default EssentialByChristophe;
