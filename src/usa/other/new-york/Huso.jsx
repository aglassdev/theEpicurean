...
const Huso = () => (
  <RestaurantPage
    restaurantName="Huso"
    address="323A Greenwich St., New York, NY, 10013, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+19178911837"
    website="https://husony.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Those who recall Chef Buddha Lo’s cozy back room on the Upper East Side will take delight in its stunning reincarnation. Like before, the entrance is a caviar shop and further in, find a restaurant that is fully realized with all the bells and whistles. Flowing white drapes, big windows and generously spaced tables cut an elegant, sophisticated figure in cool TriBeCa. Refined and polished, the tasting menu deploys caviar in a sensible manner alongside a host of finely calibrated sauces. Ora King salmon with cream and croutons makes for an astute start, as well as one particularly clever foie gras and brioche preparation. Big spenders can jump for the luxury supplements, but such expense is not essential to see the full talents of this kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=323A%20Greenwich%20St.%2C%20New%20York%2C%20NY%2C%2010013%2C%20USA"
    pageTitle="Huso"
  />
);
