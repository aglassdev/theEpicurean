...
const MissMamiesSpoonbreadToo = () => (
  <RestaurantPage
    restaurantName="Miss Mamie's Spoonbread Too"
    address="366 W. 110th St., New York, 10025, USA"
    cuisine="Southern, American"
    priceRange="$$"
    phoneNumber="+12128656744"
    website="https://spoonbreadinc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come to Miss Mamie’s and plan to indulge, Southern style. The kitchen embraces such tried-and-true classics as baked turkey wings, homemade meatloaf, Louisiana catfish, Southern-fried chicken sided by candied yams and collard greens, and a creamy red velvet cake for dessert. Grab a fresh-squeezed lemonade and dive into the sampler, stocked with deep-fried shrimp, fall-off-the-bone beef short ribs, fried chicken, and sides of cornbread stuffing and hoppin' John. Desserts are made in house, so a slice of peach cobbler or wedge of sweet potato pie are mandatory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=366%20W.%20110th%20St.%2C%20New%20York%2C%2010025%2C%20USA"
    pageTitle="Miss Mamie's Spoonbread Too"
  />
);

export default MissMamiesSpoonbreadToo;
