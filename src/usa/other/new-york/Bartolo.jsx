...
const Bartolo = () => (
  <RestaurantPage
    restaurantName="Bartolo"
    address="310 W. 4th St., New York, NY, 10014, USA"
    cuisine="Spanish"
    priceRange="$$$"
    phoneNumber="+16464944970"
    website="https://www.bartolonyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Oozing with style and class, this little West Village hideout feels like a secret. A cozy front bar, thick wood-beams across the low ceiling and handsome banquettes strike an intimate, amber-hued mood. Rich, hearty Spanish cooking is front and center, so you’ll want to share everything. Start with cristal bread lined with butter and topped with anchovies or, for something lighter, ajo blanco with honeydew sorbet. Larger plates are well-suited to serious appetites: Grilled Iberian pork, oxtails braised in red wine, and roasted suckling pig and lamb. A lengthy cocktail list and sharply dressed servers keep the night moving along...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=310%20W.%204th%20St.%2C%20New%20York%2C%20NY%2C%2010014%2C%20USA"
    pageTitle="Bartolo"
  />
);

export default Bartolo;
