...
const TheGrillNEW = () => (
  <RestaurantPage
    ...
    address="99 E. 52nd St., New York, 10022, USA"
    cuisine="American, American Contemporary"
    priceRange="$$$$"
    phoneNumber="+12123759001"
    website="https://thegrillnewyork.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once the power crowd’s club of choice for dining and dishing, this stallion in the former Four Seasons (now run by Major Food Group) belongs to a rarefied crowd of iconic NYC addresses. After undergoing a stylish makeover, this incarnation is once again the favored watering hole of the well-heeled. The Grill is a grandiose scene, with flashy service to match (tableside presentations are plentiful). Over in the kitchen it's all-American, with a menu of beloved classics. Crab cakes topped with pan-fried potatoes are a highlight; while crispy duck is especially indulgent, featuring shatteringly crunchy skin and silky fat gushing with flavor.For dessert, a chiffon cake layered with lemon curd and frosted with buttercream tastes of the good times gone by...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20E.%2052nd%20St.%2C%20New%20York%2C%2010022%2C%20USA"
    pageTitle="The Grill"
  />
);

export default TheGrillNEW;
