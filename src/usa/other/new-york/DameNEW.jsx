...
const DameNEW = () => (
  <RestaurantPage
    restaurantName="Dame"
    address="87 MacDougal St., New York, NY, 10012, USA"
    cuisine="Seafood, Contemporary"
    priceRange="$$$"
    phoneNumber="+19293677370"
    website="https://www.damenewyork.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=87%20MacDougal%20St.%2C%20New%20York%2C%20NY%2C%2010012%2C%20USA"
    pageTitle="Dame"
  />
);

export default DameNEW;
