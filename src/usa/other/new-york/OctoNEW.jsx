...
const OctoNEW = () => (
  <RestaurantPage
    restaurantName="Octo"
    address="1 E. 33rd St., New York, 10016, USA"
    cuisine="Asian Contemporary, Fusion"
    priceRange="$$"
    phoneNumber="+16468337864"
    website="https://www.octo.nyc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They may be behind New York's oldest Korean barbecue restaurant, but Steve and Christina Jang aren't resting on any laurels. Chef Segeun Song leads the charge on the à la carte menu that channels a distinctive Korean-Chinese fusion cuisine. A tempting array of dishes includes noodles, rice, and lunch specials. Reserve ahead for their Peking black duck or tuck into signature dishes like beef tangsuyuk or cumin pork back ribs. Of course, one glance at the special dumpling workshop and it's clear they must be ordered.  Pork and Thai chili soup dumplings with a dot of caviar are one way to go, but there's also the delicious spicy poached dumplings in a black vinegar sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20E.%2033rd%20St.%2C%20New%20York%2C%2010016%2C%20USA"
    pageTitle="Octo"
  />
);

export default OctoNEW;
