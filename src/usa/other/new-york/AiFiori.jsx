...
const AiFiori = () => (
  <RestaurantPage
    ...
    address="400 Fifth Ave., New York, 10018, USA"
    cuisine="Italian, French"
    priceRange="$$$$"
    phoneNumber="+12126138660"
    website="https://aifiorinyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled within the Langham Hotel with walls of windows overlooking Fifth Avenue, Ai Fiori is a frequent perch for the expense account crowd. The handsome marble bar and lounge is ideal for a post-work cocktail, while large florals, leather chairs, and square columns lure larger groups into the formal dining room. Service is gracious, linens are thick, and every last detail is lovely from lunch until dinner. An Italian menu boasting touches of flair is pleasantly matched to the space. Think Hiramasa crudo cleverly dressed with a creamy sunflower seed sauce or a uniquely shaped sagne pasta arranged with lusciously braised rabbit, fresh mint, and crushed Castelvetrano olives...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=400%20Fifth%20Ave.%2C%20New%20York%2C%2010018%2C%20USA"
    pageTitle="Ai Fiori"
  />
);

export default AiFiori;
