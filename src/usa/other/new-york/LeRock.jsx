...
const LeRock = () => (
  <RestaurantPage
    restaurantName="Le Rock"
    address="45 Rockefeller Plaza, New York, 10111, USA"
    cuisine="Contemporary, French"
    priceRange="$$$$"
    phoneNumber="+13322588734"
    website="https://www.lerocknyc.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="No stranger to crowds, the team behind Frenchette has quickly found its footing on the ground floor of bustling Rockefeller Center. Dim lighting blankets this elegant, Art-Deco space where a large bar up front mixes and stirs at a fast clip. They have good reason to be speedy: This is one of the more refined restaurants to open in the area in years, and the crowds have caught on immediately. In line with a French brasserie, the menu offers familiar trappings: seafood platters, hearty pâtés, classic sauces like bearnaise and brown butter, duck confit lentils, and, of course, delicious profiteroles smothered in buckwheat honey fudge. Adding to the fun is a welcome bit of tableside showmanship for dishes like leeks vinaigrette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Rockefeller%20Plaza%2C%20New%20York%2C%2010111%2C%20USA"
    pageTitle="Le Rock"
  />
);

export default LeRock;
