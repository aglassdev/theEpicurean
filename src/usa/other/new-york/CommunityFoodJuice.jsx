...
const CommunityFoodJuice = () => (
  <RestaurantPage
    restaurantName="Community Food & Juice"
    address="2893 Broadway, New York, 10025, USA"
    cuisine="American, Contemporary"
    priceRange="$$"
    phoneNumber="+12126652800"
    website="https://www.communityrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As part of Columbia University’s sprawl, this address is a godsend for students, faculty and locals from morning to night. Although it’s spacious with plenty of outdoor options, the popular spot doesn’t accept reservations—and has the lines to prove it. They turn out joyful fare, and the weekday blueberry pancake special is just one reason why this place gets so much love. For lunch, a kale salad with artichoke hearts, pickled carrots and crispy chickpeas is anything but rote. Come dinnertime, the fish or steak of the day might reveal pan-seared mahi mahi with roasted cauliflower and black truffle beurre blanc, or grilled strip steak brushed with teriyaki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2893%20Broadway%2C%20New%20York%2C%2010025%2C%20USA"
    pageTitle="Community Food & Juice"
  />
);

export default CommunityFoodJuice;
