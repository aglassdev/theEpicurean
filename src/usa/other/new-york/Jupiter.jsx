...
const Jupiter = () => (
  <RestaurantPage
    restaurantName="Jupiter"
    address="20 W. 50th St., New York, 10020, USA"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+12122070060"
    website="https://www.jupiterrestaurant.nyc/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20W.%2050th%20St.%2C%20New%20York%2C%2010020%2C%20USA"
    pageTitle="Jupiter"
  />
);
