...
const LaDong = () => (
  <RestaurantPage
    restaurantName="La Dong"
    address="11 E. 17th St., New York, 10003, USA"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+19172890019"
    website="https://www.ladongnyc.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20E.%2017th%20St.%2C%20New%20York%2C%2010003%2C%20USA"
    pageTitle="La Dong"
  />
);

export default LaDong;
