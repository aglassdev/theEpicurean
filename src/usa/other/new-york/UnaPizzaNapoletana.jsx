...
const UnaPizzaNapoletana = () => (
  <RestaurantPage
    restaurantName="Una Pizza Napoletana"
    address="175 Orchard St., New York, 10002, USA"
    cuisine="Pizza"
    priceRange="$$"
    phoneNumber="+16464764457"
    website="https://unapizza.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After rallying crowds on both coasts of the country, pizza maestro Anthony Mangieri is in full command of this airy, black-and white-tiled hall lined with canned tomatoes and eager diners. He is serious about his craft and is the only one tending to the wood-burning oven, which yields glorious Neapolitan-style pies with fluffy edges, papery crusts and minimal toppings that hardly go beyond bubbly gumdrops of mozzarella di bufala and sweet tomato sauce. Indeed, this is a team that cannot be bothered with anything else besides pizza. There is a short list of starters, and dessert is limited to sorbet or gelato. Reservations are tough to score, so walk-ins should aim to arrive early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=175%20Orchard%20St.%2C%20New%20York%2C%2010002%2C%20USA"
    pageTitle="Una Pizza Napoletana"
  />
);

export default UnaPizzaNapoletana;
