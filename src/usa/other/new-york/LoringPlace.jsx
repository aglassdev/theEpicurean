...
const LoringPlace = () => (
  <RestaurantPage
    restaurantName="Loring Place"
    address="21 W. 8th St., New York, 10011, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+12123881831"
    website="https://www.loringplacenyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the Bronx street that his father grew up on, Loring Place is where Chef Dan Kluger serves up delicious, stylistic, and locally sourced Californian cuisine to a downtown crowd. And yet, none of this comes as a surprise as the chef has showcased his talents for years and been the recipient of much acclaim in the city. His skillfully made, vegetable-centric American fare served here is unique and spirited, beginning with wood-grilled broccoli salad with orange, pistachios, and mint. The wood-oven pizzas, made with house-milled whole wheat flour, are a hit at any time. The generously sized room is uncluttered and mid-century chic, with bright orange window frames and boldly striped banquettes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20W.%208th%20St.%2C%20New%20York%2C%2010011%2C%20USA"
    pageTitle="Loring Place"
  />
);

export default LoringPlace;
