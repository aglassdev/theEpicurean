...
const ChezFifi = () => (
  <RestaurantPage
    restaurantName="Chez Fifi"
    address="140 E. 74th St., New York, 10021, USA"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber=""
    website="https://www.chezfifinyc.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=140%20E.%2074th%20St.%2C%20New%20York%2C%2010021%2C%20USA"
    pageTitle="Chez Fifi"
  />
);

export default ChezFifi;
