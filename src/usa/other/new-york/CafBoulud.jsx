...
const CafBoulud = () => (
  <RestaurantPage
    ...
    address="100 E. 63rd St., New York, 10065, USA"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+12127722600"
    website="https://www.cafeboulud.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A new and improved Café Boulud from Daniel Boulud has been beautifully reborn on the storied corner of 63rd street and Park Avenue with Executive Chef Romain Paumier at the helm. The setting is appropriately posh and exudes Art Deco vibes.Enjoy this unique prix fixe menu which highlights four inspirations: classic French cuisine; La Saison; vegetarian farmers' market dishes; and Le Voyage, offering an international focus. Choose one style of menu or handpick for a multicourse meal that is on-point with sharp execution and a soigné presentation. The array of impressive cooking here includes the likes of the signature black sea bass wrapped in crispy potatoes and sauced with a red wine reduction; seared scallops with Champagne beurre blanc; or lobster ravioli dressed with a vivid lobster bis..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20E.%2063rd%20St.%2C%20New%20York%2C%2010065%2C%20USA"
    pageTitle="Café Boulud"
  />
);

export default CafBoulud;
