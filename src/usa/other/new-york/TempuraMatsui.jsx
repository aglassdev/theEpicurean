...
const TempuraMatsui = () => (
  <RestaurantPage
    ...
    address="222 E. 39th St., New York, 10016, USA"
    cuisine="Japanese, Tempura"
    priceRange="$$$$"
    phoneNumber="+12129868885"
    website="https://www.tempuramatsui.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Tempura Matsui skillfully demonstrates why tempura is a celebrated Japanese cuisine type in its own right. The prized seats are at the counter, especially if you want to see the master at work.The chef uses a mix of sesame and cottonseed oils and the batter is used sparingly. You’ll start with a seasonal soup including seared scallop with wheat cake, before having some beautifully arranged sashimi. Then, the main event begins in the traditional way with crispy shrimp legs. Dishes turned out of this kitchen usually vary according to the seasons, but could include the likes of wonderfully tender squid, succulent Hokkaido scallop, tender cauliflower, as well as snow crab wrapped in shiso leaf. Be sure to end with tencha, with its mellow and deeply flavorful broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=222%20E.%2039th%20St.%2C%20New%20York%2C%2010016%2C%20USA"
    pageTitle="Tempura Matsui"
  />
);

export default TempuraMatsui;
