...
const HyderabadiZaiqa = () => (
  <RestaurantPage
    restaurantName="Hyderabadi Zaiqa"
    address="366 W. 52nd St., New York, 10019, USA"
    cuisine="Indian"
    priceRange="$"
    phoneNumber="+16469520066"
    website="https://hyderabadizaiqa.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=366%20W.%2052nd%20St.%2C%20New%20York%2C%2010019%2C%20USA"
    pageTitle="Hyderabadi Zaiqa"
  />
);

export default HyderabadiZaiqa;
