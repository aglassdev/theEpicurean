...
const Hangawi = () => (
  <RestaurantPage
    restaurantName="HanGawi"
    address="12 E. 32nd St., New York, 10016, USA"
    cuisine="Korean, Vegetarian"
    priceRange="$$"
    phoneNumber="+12122130077"
    website="https://hangawirestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beyond an ordinary façade lies this serene, shoes-off retreat with traditional low tables, Korean artifacts and meditative music. While wine and beer are available, a pot of royal green tea from Mt. Jilee is a more apt pairing considering the soothing setting.HanGawi is a soft-spoken, vegetarian-only restaurant that cares about what you eat and how you feel. The ssam bap offers a fun DIY experience with a long platter of fillings. Dark leafy lettuce and thin, herbaceous sesame leaves are topped with creamy slices of avocado, crunchy bean sprouts, pickled daikon, carrot, cucumber, radish and three rice options—white, brown and a nutty, purple-tinged multigrain. Topped with miso ssam sauce, each bite is a fresh burst of uplifting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20E.%2032nd%20St.%2C%20New%20York%2C%2010016%2C%20USA"
    pageTitle="HanGawi"
  />
);

export default Hangawi;
