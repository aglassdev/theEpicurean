...
const Crevette = () => (
  <RestaurantPage
    restaurantName="Crevette"
    address="10 Downing St., New York, 10014, USA"
    cuisine="Seafood, Spanish"
    priceRange="$$$"
    phoneNumber="+16463974073"
    website="https://www.crevettenyc.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Downing%20St.%2C%20New%20York%2C%2010014%2C%20USA"
    pageTitle="Crevette"
  />
);

export default Crevette;
