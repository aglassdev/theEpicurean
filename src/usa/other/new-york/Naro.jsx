...
const Naro = () => (
  <RestaurantPage
    restaurantName="Naro"
    address="610 Fifth Ave., New York, 10012, USA"
    cuisine="Korean"
    priceRange="$$$$"
    phoneNumber="+12122020206"
    website="https://www.naronyc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The group behind Atomix and Atoboy continue to show no signs of slowing down with their latest opening in bustling Rockefeller Center. Named after South Korea’s first successful rocket to space, the restaurant offers a more traditional view of Korean cuisine dating back to the Joseon dynasty. Choose between two tasting menus, one of which is vegetarian, and expect familiar dishes like mandu, bibimbap and shrimp pancake to be reimagined and refined, usually with mild-mannered flavors and always with high-quality ingredients. The boisterous room itself is enclosed in glass, in full view of people milling around the concourse, and is a rather sterile mix of white walls, white tablecloths, white booths and hard warehouse floors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=610%20Fifth%20Ave.%2C%20New%20York%2C%2010012%2C%20USA"
    pageTitle="Naro"
  />
);
