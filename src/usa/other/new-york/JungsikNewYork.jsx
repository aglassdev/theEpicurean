...
const JungsikNewYork = () => (
  <RestaurantPage
    restaurantName="Jungsik New York"
    address="2 Harrison St., New York, 10013, USA"
    cuisine="Korean, Contemporary"
    priceRange="$$$$"
    phoneNumber="+12122190900"
    website="https://www.jungsik.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Cool and polished, this dining room bears that perfectly downtown nexus of low-key yet elegant; with its dark and light color scheme and intimate proportions. Chef/owner Mr. Yim Jung Sik and Executive Chef Daeik Kim's Korean meal starts like many do, with an array of banchan; however, the presentation here is unlike any other; and it's just that creativity that makes dining here so distinctive. From there, the tasting menu unfolds to reveals delights such as slivers of raw striped jack with white kimchi and chilled fish bone broth; gorgeously crisped octopus with gochujang aioli; and dry-aged Arctic char in a pool of kimchi and red curry sauce. This is cooking that is highly original, impeccably executed, and enormously satisfying; a meal that makes you involuntarily nod to yourself while ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Harrison%20St.%2C%20New%20York%2C%2010013%2C%20USA"
    pageTitle="Jungsik New York"
  />
);

export default JungsikNewYork;
