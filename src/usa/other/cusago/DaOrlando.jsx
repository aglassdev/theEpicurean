...
const DaOrlando = () => (
  <RestaurantPage
    restaurantName="Da Orlando"
    address="piazza Soncino 19, Cusago, 20090, Italy"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+390290390318"
    website="https://www.daorlando.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simply arriving in Cusago near Milan, where the imposing castle dominates the attractive centre, puts you in a good mood. At Da Orlando, the menu is equally balanced between top-quality fish dishes such as the “bollita di mare” and meat-based dishes that will delight food-lovers, such as snails with trumpet mushrooms and duck breast with ginger. Two elegant dining rooms are the perfect setting for a romantic evening, while the attractive outdoor space comes into its own in summer. A good restaurant with over 40 years of history...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Soncino%2019%2C%20Cusago%2C%2020090%2C%20Italy"
    pageTitle="Da Orlando"
  />
);

export default DaOrlando;
