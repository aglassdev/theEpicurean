...
const StageKitchenBar = () => (
  <RestaurantPage
    restaurantName="Stage Kitchen & Bar"
    address="2000 PGA Blvd., Ste. 5502, Palm Beach Gardens, FL, 33408, USA"
    cuisine="International"
    priceRange="$$$"
    phoneNumber="+15614083685"
    website="https://www.stagekitchenandbar.com/location/stage-pga/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a saying that all the world's a stage, and at this Palm Beach Gardens restaurant, it's certainly true that all the world is on the menu. This large, contemporary restaurant in a shopping center is full of surprises. Chef Pushkar Marathe oversees an eclectic menu that isn't bound by any one cuisine. His Indian roots appear throughout, while other dishes are inspired by his travels. Butter chicken is a nod to his Indian roots while duck confit egg rolls, shrimp and grits, and a burger show off his wide-reaching inspiration. No matter the selection, it's all good and there's something for every mood, just one of the reasons it's usually packed. Breads like the flaky paratha are a treat, as is the sticky toffee date cake for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2000%20PGA%20Blvd.%2C%20Ste.%205502%2C%20Palm%20Beach%20Gardens%2C%20FL%2C%2033408%2C%20USA"
    pageTitle="Stage Kitchen & Bar"
  />
);

export default StageKitchenBar;
