...
const OsteriaPadrePio = () => (
  <RestaurantPage
    restaurantName="Osteria Padre Pio"
    address="97 Lake St., West Harrison, 10604, USA"
    cuisine="Italian, Campanian"
    priceRange="$$$"
    phoneNumber="+19143808704"
    website="https://www.osteriapadrepio.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=97%20Lake%20St.%2C%20West%20Harrison%2C%2010604%2C%20USA"
    pageTitle="Osteria Padre Pio"
  />
);

export default OsteriaPadrePio;
