...
const Mooncusser = () => (
  <RestaurantPage
    restaurantName="Mooncusser"
    address="304 Stuart St., Boston, MA, 02116, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+16179175193"
    website="https://www.mooncusserboston.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a colorful bar downstairs and a well-measured tasting menu upstairs, this two-part operation stands tall like a wedge of cake in the heart of Back Bay. Arched windows overlooking Columbus Avenue set the scene for this pleasant dining room where Chef Carl Dooley cycles through dishes with notable frequency. Know that no one cuisine calls this global kitchen, and inspiration can swing from the Mediterranean to Asia with seafood as a regular feature. Think house-made saffron mafalde, Mahi Mahi carpaccio with fish sauce caramel, or cod cheek pozole. Wine lovers will delight in an astute bottle list as well as a kindly priced pairing. All the while, relaxed service ensures a setting that is anything but stuffy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=304%20Stuart%20St.%2C%20Boston%2C%20MA%2C%2002116%2C%20USA"
    pageTitle="Mooncusser"
  />
);

export default Mooncusser;
