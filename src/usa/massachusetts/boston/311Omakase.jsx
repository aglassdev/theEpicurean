...
const 311Omakase = () => (
  <RestaurantPage
    restaurantName="311 Omakase"
    address="605 Tremont St., Boston, MA, 02118, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+17818310311"
    website="https://311boston.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located on the ground floor of a South End rowhouse, this intimate chef's counter is the vision of Chef Wei Fa Chen. Pale walls and light wood provide a blank canvas to show off the chef's seasonal selection of ceramic platters (from Kyoto and Asheville), custom-made tatami coasters and thoughtfully crafted cuisine.The chef's omakase features impressive nigiri showcasing high-quality product, much of it imported from Japan; and the range of fish could include fluke, striped beakfish and goldeneye snapper. Cooked items precede the sushi and highlight a particular cooking method, such as delicately crunchy fried longtooth grouper with ponzu sauce or a simmered bowlful of amadai and abalone in dashi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=605%20Tremont%20St.%2C%20Boston%2C%20MA%2C%2002118%2C%20USA"
    pageTitle="311 Omakase"
  />
);

export default 311Omakase;
