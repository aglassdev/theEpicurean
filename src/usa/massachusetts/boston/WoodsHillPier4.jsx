...
const WoodsHillPier4 = () => (
  <RestaurantPage
    restaurantName="Woods Hill Pier 4"
    address="300 Pier 4 Blvd., Boston, MA, 02210, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+16179814577"
    website="https://www.woodshillpier4.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When the sun is out and the garage doors are up, it can feel as if the entire city is angling for a prime table here in the Boston Seaport District. Sitting right on the harbor and armed with a wrap-around patio, this bustling restaurant is not content to rely solely on its good looks. Chef Charlie Foster and his team deliver a hearty, global cuisine, with many ingredients sourced from their own farm in New Hampshire. Start with a Thai-inspired striped bass crudo or the signature smoked ham hock croquettes lashed in a honey and Aleppo gastrique. Grilled pork loin or perhaps smoked lamb shoulder and a side of charred broccoli finished in a cheddar and smoked garlic aioli make for a proper feast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=300%20Pier%204%20Blvd.%2C%20Boston%2C%20MA%2C%2002210%2C%20USA"
    pageTitle="Woods Hill Pier 4"
  />
);

export default WoodsHillPier4;
