...
const UrbanHearth = () => (
  <RestaurantPage
    restaurantName="Urban Hearth"
    address="2263 Massachusetts Ave., Cambridge, MA, 02140, USA"
    cuisine="American Contemporary"
    priceRange="$$$"
    phoneNumber="+16176827295"
    website="https://www.urbanhearth.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Urban Hearth has just a sprinkling of tables and a four-seat bar that's reserved for guests enjoying the multicourse tasting menu but it's worth making an effort to snag a seat here. Chef Erin Miller leans into a farm to table approach, with seasonal elements and foraged ingredients worked into dishes that showcase the best of New England. This is a kitchen that takes its time delivering fresh, well-prepared plates like an heirloom tomato salad with whipped goat cheese and black sesame togarashi crisps or fazzoletti pasta tucked with broccolini and tossed in a saffron sauce with ricotta and hyssop chermoula. Finally, a scoop of pineapple gelato set over roasted peaches with crumbles of cornmeal biscotti makes for a refreshing dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2263%20Massachusetts%20Ave.%2C%20Cambridge%2C%20MA%2C%2002140%2C%20USA"
    pageTitle="Urban Hearth"
  />
);

export default UrbanHearth;
