...
const AndrewMichaelItalianKitchen = () => (
  <RestaurantPage
    restaurantName="Andrew Michael Italian Kitchen"
    address="712 W. Brookhaven Cir., Memphis, TN, 38117, USA"
    cuisine="Italian-American"
    priceRange="$$$"
    phoneNumber="+19013473569"
    website="https://andrewmichaelitaliankitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 2008, the flagship restaurant from Chefs Andy Ticer and Michael Hudman remains one the city’s most enticing efforts. Divided into several small rooms, the cozy house in Brookhaven Circle celebrates Italian cooking with Southern influences. Appetizers and pastas are the strongest features, starting with the signature house breakfast of pork belly, pork rinds, polenta, and a runny egg. For a lighter beginning, swing for the tuna tartare with sundried tomatoes or tender squid stuffed with Barese sausage and set in a sharp puttanesca sauce. Mafaldi coated in a rich bianco veal ragu is as gratifying as potato gnocchi tossed in a garlicky spring pesto...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=712%20W.%20Brookhaven%20Cir.%2C%20Memphis%2C%20TN%2C%2038117%2C%20USA"
    pageTitle="Andrew Michael Italian Kitchen"
  />
);

export default AndrewMichaelItalianKitchen;
