...
const FeliciaSuzannes = () => (
  <RestaurantPage
    restaurantName="Felicia Suzanne's"
    address="383 S. Main St., Memphis, TN, 38103, USA"
    cuisine="American, Southern"
    priceRange="$$$"
    phoneNumber="+19016237883"
    website="https://www.feliciasuzanne.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Scarlet-red banquettes, a long marble bar and checkered tile cut a striking, seductive figure in downtown Memphis. This is a restaurant whose identity is never in question thanks to veteran Chef Felicia Suzanne, now situated in a swanky new dining room where she sources quality ingredients and honors Southern traditions with class and elegance. Plucky Gulf shrimp set with tasso ham sauce and jalapeño cornbread is a superb signature and a reflection of this kitchen at its very best. Other hits on this finely curated menu include buttermilk fried quail with greens and spiced honey as well as fried green tomatoes with Creole remoulade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=383%20S.%20Main%20St.%2C%20Memphis%2C%20TN%2C%2038103%2C%20USA"
    pageTitle="Felicia Suzanne's"
  />
);

export default FeliciaSuzannes;
