...
const Peninsula = () => (
  <RestaurantPage
    restaurantName="Peninsula"
    address="1035 W. Eastland Ave., Nashville, TN, 37206, USA"
    cuisine="Spanish"
    priceRange="$$$"
    phoneNumber="+16159241906"
    website="https://peninsulanashville.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At first glance, it might be easy to dismiss this rambunctious restaurant set at the base of a nondescript apartment building in East Nashville. But don’t be fooled: You’ll be convinced otherwise at first bite. Broadly focused on the Iberian Peninsula, the cooking is creative and pulls influences from around the globe for its tapas-style dishes. Buckle up for plates powered by character that take unexpected twists and turns, as in a bold opener of endive, fried and covered in a koji foam with a burnt onion powder, or a clever beet starter paired with roasted garlic. The smart cooking continues all the way through to dessert, where mochi doughnuts covered in bright red marzipan make for an enticing finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1035%20W.%20Eastland%20Ave.%2C%20Nashville%2C%20TN%2C%2037206%2C%20USA"
    pageTitle="Peninsula"
  />
);
