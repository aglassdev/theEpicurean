...
const RolfAndDaughters = () => (
  <RestaurantPage
    restaurantName="Rolf and Daughters"
    address="700 Taylor St., Nashville, TN, 37208, USA"
    cuisine="American Contemporary"
    priceRange="$$$"
    phoneNumber="+16158669897"
    website="https://www.rolfanddaughters.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner Philip Krajeck's Germantown restaurant lures a well-heeled crowd of locals who flock here for great food, done well. His cooking is earnest and approachable, with a seasonal and contemporary mindset. This is a menu where you'll want everything; luckily, it's all designed for sharing. The house-made pasta program turns out impressive work in plates that speak to the season, from fresh spaghetti tinted green from the inclusion of tomato leaves to a corn agnolotti tucked with sweet corn in a beurre blanc. Main dishes like chicken or pork t-bone lean into the refined comfort appeal. A very simple dessert of house-made vanilla bean ice cream with a mashed amaretti cookie topped with a poached peach is a perfect send-off...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=700%20Taylor%20St.%2C%20Nashville%2C%20TN%2C%2037208%2C%20USA"
    pageTitle="Rolf and Daughters"
  />
);

export default RolfAndDaughters;
