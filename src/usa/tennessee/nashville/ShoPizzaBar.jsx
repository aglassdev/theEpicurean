...
const ShoPizzaBar = () => (
  <RestaurantPage
    restaurantName="Sho Pizza Bar"
    address="1309 McGavock Pk., Nashville, TN, 37216, USA"
    cuisine="Pizza, Contemporary"
    priceRange="$$"
    phoneNumber="+16156498915"
    website="https://www.shopizzabar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The curious name of Chef Sean Brock's pizza restaurant is derived from the Japanese word “shokunin,” which represents a person’s full commitment to every detail of a craft. This is indeed a thoughtful approach to Neapolitan-style pizza, but with its own distinct personality. It starts with the dough, slowly cold fermented, then baked in a wood-fired oven, resulting in a light, tender, utterly appealing crust.The fresh-looking Riverside Village space boasts a sunny vibe with concrete flooring, pale walls, light wood furnishings and pops of blue, which include a matte tiled, domed pizza oven made in Italy. The glass-walled prep area displays the makers and provenance of the cheeses, cured meats, vegetables and even the firewood used here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1309%20McGavock%20Pk.%2C%20Nashville%2C%20TN%2C%2037216%2C%20USA"
    pageTitle="Sho Pizza Bar"
  />
);

export default ShoPizzaBar;
