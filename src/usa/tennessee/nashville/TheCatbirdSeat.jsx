...
const TheCatbirdSeat = () => (
  <RestaurantPage
    restaurantName="The Catbird Seat"
    address="700 8th Ave. S., 5th Fl., Nashville, TN, 37203, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+16158108200"
    website="https://www.thecatbirdseatrestaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Many chefs have carried the Catbird banner since the restaurant’s founding in 2011. Today, husband-and-wife chef duo Andy Doubrava and Tiffani Ortiz usher in the next chapter of this prized, U-shaped counter situated on the top floor of the Bill Voorhees Building. In a room where cooks have nowhere to hide, expect a youthful, frenetic tasting menu that highlights locality, seasonality and preservation with a wide range of ingredients. Smoking and grilling, oils and purees, granitas and powders – the flavors and techniques involved are extensive. Courses are built around an array of stimulating small bites that have previously included the likes of stuffed chicken wings, grilled mushrooms with celeriac, and Kennebec potatoes with whipped gouda...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=700%208th%20Ave.%20S.%2C%205th%20Fl.%2C%20Nashville%2C%20TN%2C%2037203%2C%20USA"
    pageTitle="The Catbird Seat"
  />
);

export default TheCatbirdSeat;
