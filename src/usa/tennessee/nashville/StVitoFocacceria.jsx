...
const StVitoFocacceria = () => (
  <RestaurantPage
    restaurantName="St. Vito Focacceria"
    address="605 Mansion St., Nashville, TN, 37203, USA"
    cuisine="Sicilian, Pizza"
    priceRange="$$"
    phoneNumber="+18706232406"
    website="https://www.stvitonashville.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Memphis-born but Sicilian to his core, Chef Michael Hanna opened St. Vito’s in the Gulch with one mission in mind: to bring his version of sfincione, a Sicilian street food, to Nashville. It's far from your average slice of pizza. Instead, imagine focaccia studded with fontina and then topped with breadcrumbs and pecorino. It's all on display in the exposed kitchen where you can watch the chefs fold the dough. There are four varieties, such as spicy tomato with burrata or roasted potato cream, and the toppings are generous on this hearty and satisfying treat. A small menu shares several salads and one pasta dish, but you're really here for one thing. Oh, and maybe a house-made tiramisu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=605%20Mansion%20St.%2C%20Nashville%2C%20TN%2C%2037203%2C%20USA"
    pageTitle="St. Vito Focacceria"
  />
);

export default StVitoFocacceria;
