...
const RedheadedStranger = () => (
  <RestaurantPage
    restaurantName="Redheaded Stranger"
    address="305 Arrington St., Nashville, TN, 37207, USA"
    cuisine="Tex-Mex"
    priceRange="$"
    phoneNumber="+16155448226"
    website="https://redheadedstrangertacos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is typically a line out the door at this Cleveland Park spot. Named for a Willie Nelson song and album, the vibe is laidback and slightly quirky (think diner style with chili pepper lights strung above). It's a small spot but great care is taken with everything from house-made hot sauces to tortillas. Watch the chef making those terrific flour tortillas in the main dining room or sit outside on the patio to savor Chef Bryan Lee Weaver's Tex-Mex menu. Tacos run the gamut from simple (bacon, egg and cheese) to creative (poblano with whipped feta and crispy rice). Main dishes include a burrito and a green chili cheeseburger, and the menu includes a section devoted to crunch wraps (the pork green chili version is a glorious, messy delight)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=305%20Arrington%20St.%2C%20Nashville%2C%20TN%2C%2037207%2C%20USA"
    pageTitle="Redheaded Stranger"
  />
);

export default RedheadedStranger;
