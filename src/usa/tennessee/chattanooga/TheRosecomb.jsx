...
const TheRosecomb = () => (
  <RestaurantPage
    restaurantName="The Rosecomb"
    address="921 Barton Ave., Chattanooga, TN, 37405, USA"
    cuisine="American"
    priceRange="$$"
    phoneNumber="+14235419314"
    website="https://www.rosecombbar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a charming 1920s cottage just above downtown Chattanooga, The Rosecomb isn't just adorable, it's fun and a little bit funky too. Chloe Wright and Ryan Smith have fashioned a likable spot with loads of character, where the menu looks to Appalachia for inspiration and the bar program is strong. Expect quirky, creative cooking. Kilt greens panzanella with root vegetables topped with cornbread croutons and bacon vinaigrette offers a bold, Southern-inflected take on a classic bread salad, while a slow-cooked pulled chicken sandwich with crunchy slaw and diced pepperoncini is just plain delicious. Banana pudding layered with Nilla wafers is a nostalgia-laced treat but no meal is complete with a cocktail (preferably enjoyed from the patio in the garden)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=921%20Barton%20Ave.%2C%20Chattanooga%2C%20TN%2C%2037405%2C%20USA"
    pageTitle="The Rosecomb"
  />
);

export default TheRosecomb;
