...
const TheAnchorage = () => (
  <RestaurantPage
    restaurantName="The Anchorage"
    address="586 Perry Ave., Greenville, SC, 29611, USA"
    cuisine="American Contemporary"
    priceRange="$$$"
    phoneNumber="+18642193082"
    website="https://www.theanchoragerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy wine, head for The Anchorage. The front doubles as a shop, where you can peruse the collection to take a bottle home or if one strikes your fancy, they'll open it for you on the spot. Of course, The Anchorage isn't just about wine. Their concise menu teases just under ten different dishes, as well as a reasonably priced tasting menu. Catch a glimpse of the team in action in the semi-open kitchen, where locally sourced ingredients are woven into dishes like hand-rolled rigatoni with basil pesto and meatballs, plus fennel and black king mushrooms, or steak over a bed of Carolina Gold rice with red peas, okra and a smoked tomato glace. TB&J, or black tahini butter and strawberry jam tucked between sliced brown butter cake, is a real treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=586%20Perry%20Ave.%2C%20Greenville%2C%20SC%2C%2029611%2C%20USA"
    pageTitle="The Anchorage"
  />
);

export default TheAnchorage;
