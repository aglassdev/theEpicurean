...
const Fig = () => (
  <RestaurantPage
    restaurantName="Fig"
    address="232 Meeting St., Charleston, SC, 29401, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+18438055900"
    website="http://eatatfig.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Charleston favorite has been at it for more than two decades, but judging by the demand, you’d think they had just opened. Reservations are a hot ticket, and crowds hoping to grab a walk-in seat line up before the front door opens. Despite its age, the food feels anything but dated. This is a kitchen that knows itself, its position in the South and its place in the Lowcountry. Seafood is a strength, and the Lowcountry bourride made with fish stock, tomatoes and saffron is an absolute must-order. There is so much more to enjoy such as Lady Edison country ham with compressed Asian pears and brown butter, tomato tarte tatin or entrees like grey triggerfish with sauce vierge, chantarelle mushrooms and baby sweet corn. End on a sweet note with sorghum pudding or tarte Normande...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=232%20Meeting%20St.%2C%20Charleston%2C%20SC%2C%2029401%2C%20USA"
    pageTitle="Fig"
  />
);
