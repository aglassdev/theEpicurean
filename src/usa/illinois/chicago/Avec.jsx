...
const Avec = () => (
  <RestaurantPage
    restaurantName="avec"
    address="615 W. Randolph St., Chicago, 60661, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+13123772002"
    website="https://www.avecrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This West Randolph mainstay has been a smash hit for more than two decades – and for good reason. All day long, fans crowd the long counter and close-knit tables that stretch down the length of a restaurant encased head to toe in wood planks. The Mediterranean menu runs with the seasons, and it’s no trouble finding favor in the bold, colorful plates that come out of this smooth-running kitchen. Dishes like roasted asparagus with za’atar buttermilk or chickpea hummus with oyster mushrooms arrive crowned with all manner of vibrant herbs, sauces, and crunchy garnishes. Generously portioned salads and tartines feature prominently at lunch. A second, more spacious location in River North is better suited for larger groups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=615%20W.%20Randolph%20St.%2C%20Chicago%2C%2060661%2C%20USA"
    pageTitle="avec"
  />
);
