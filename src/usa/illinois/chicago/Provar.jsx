...
const Provar = () => (
  <RestaurantPage
    restaurantName="Provaré"
    address="1523 W. Chicago Ave., Chicago, 60642, USA"
    cuisine="Fusion, Creole"
    priceRange="$$$"
    phoneNumber="+13129880943"
    website="https://www.provarechicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef and co-owner Jourdan Higgs is pushing boundaries at his new restaurant—a small and intimate gem, where Creole and Italian cuisines converge. This dining room makes its debut with a burst of color, weathered wood, as well as an array of neatly arranged tables. And let's not forget the playlist, which is perfectly aligned with the saucy and spicy fare. On the menu, the chef pays homage to his Sicilian grandfather and the results are just full of surprises. Our experience involved crabby fries; shatteringly crisp calamari tucked with jalapeños and banana peppers; and trenette pasta tossed with cognac-splashed shrimp scampi. These dishes are primed for sharing so come with a crew and, of course, an appetite to boot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1523%20W.%20Chicago%20Ave.%2C%20Chicago%2C%2060642%2C%20USA"
    pageTitle="Provaré"
  />
);

export default Provar;
