...
const TheDuckInn = () => (
  <RestaurantPage
    restaurantName="The Duck Inn"
    address="2701 S. Eleanor St., Chicago, 60608, USA"
    cuisine="Gastropub, American Contemporary"
    priceRange="$$"
    phoneNumber="+13127248811"
    website="https://www.theduckinnchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Head to the Bridgeport warehouses, where this stylish, modern tavern—helmed by Executive Chef Kevin Hickey—feels like a diamond in the rough. Then make your way past the buzzy bar (pouring heady cocktails) to a semi-open kitchen, which is in full view of the decorous dining room, featuring wood tables and mid-century modern seats.The cuisine may be coined as working-class fine dining, but there is nothing lowbrow about this menu, which unveils a focused but diverse selection of small plates and mains. Japanese barbecue sauce and sesame seeds are the crowning touch to duck wings, while foie gras mousse with celery fronds and brioche is a study in fine flavors and textures. Of course, regulars know to save room for the Chicago-style duck fat dog...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2701%20S.%20Eleanor%20St.%2C%20Chicago%2C%2060608%2C%20USA"
    pageTitle="The Duck Inn"
  />
);

export default TheDuckInn;
