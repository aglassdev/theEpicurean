...
const Creepies = () => (
  <RestaurantPage
    restaurantName="Creepies"
    address="1360 W. Randolph St., Chicago, IL, 60607, USA"
    cuisine="French, American"
    priceRange="$$$"
    phoneNumber="+13125792727"
    website="https://www.creepieschicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don't let the name fool you; there's nothing remotely creepy about this charming neighborhood restaurant next door to Chef David and Anna Posey's Elske. They've taken style notes from the classic bistro with stone and wood walls lined with art, black-and-white checkered tile floors and a mix of banquettes and tables, while the menu pulls from French cooking with some Midwestern flair thrown in for good measure. It's a concise offering, with dishes like Parisian gnocchi in creamy gruyere sauce with crispy ham and a drizzle of egg yolk or steamed halibut with sauce homard and dumplings. The simple but well-executed theme continues to dessert, with raspberry sherbet meringue cake or baguette soft serve with chocolate and brown butter crumbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1360%20W.%20Randolph%20St.%2C%20Chicago%2C%20IL%2C%2060607%2C%20USA"
    pageTitle="Creepies"
  />
);

export default Creepies;
