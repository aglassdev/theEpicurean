...
const Sky = () => (
  <RestaurantPage
    restaurantName="S.K.Y."
    address="2300 N. Lincoln Park W., Chicago, 60614, USA"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+13128461077"
    website="https://www.skyrestaurantchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thanks to their ambitious Asian-accented cooking, S.K.Y.'s moniker could easily double as its descriptor. Make your way inside this versatile restaurant to discover a setting that's textbook industrial-chic—a large dining room decked out with metal beams, exposed brick, and distressed walls. The kitchen is open and always humming.The slightly motley menu features everything from cornbread madeleines to foie gras-bibimbap, so this is just the sort of place to bring a friend or group in order to sample more of the eclectic food. Speaking of, embark on a tour of their greatest hits, which may include seared Scottish salmon with cauliflower caponata and white shrimp ceviche. The maitake mushroom salad scattered with goat cheese is revered for good reason...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2300%20N.%20Lincoln%20Park%20W.%2C%20Chicago%2C%2060614%2C%20USA"
    pageTitle="S.K.Y."
  />
);
