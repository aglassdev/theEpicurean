...
const Warlord = () => (
  <RestaurantPage
    restaurantName="Warlord"
    address="3198 N. Milwaukee Ave., Chicago, 60618, USA"
    cuisine="American Contemporary"
    priceRange="$$$$"
    phoneNumber=""
    website="https://warlordchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The word is out on Warlord, where eager diners line up before it's even open to snag a seat at this first-come, first-serve spot. Chefs Emily Kraszyk, John Lupton, and Trevor Fleming cook over a live-fire grill in an open kitchen, and the most desirable seats are at the chefs' counter. Settle in to feast on the likes of foie gras ganache with grilled hearth bread accompanied by salty-sweet honey butter, whipped foie, and rhubarb dressed with a beetroot reduction. Lacquered, dry-aged duck rests above the grill for a slower cook, but the tender meat is worth the extra time. Even dessert hits the flames, with butter cake grilled to a nicely crisp exterior before being topped with butterscotch amazake cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3198%20N.%20Milwaukee%20Ave.%2C%20Chicago%2C%2060618%2C%20USA"
    pageTitle="Warlord"
  />
);
