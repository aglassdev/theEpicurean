...
const Haisous = () => (
  <RestaurantPage
    restaurantName="HaiSous"
    address="1800 S. Carpenter Ave., Chicago, 60608, USA"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+13127021303"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1800%20S.%20Carpenter%20Ave.%2C%20Chicago%2C%2060608%2C%20USA"
    pageTitle="HaiSous"
  />
);

export default Haisous;
