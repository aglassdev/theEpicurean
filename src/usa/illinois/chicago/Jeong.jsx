...
const Jeong = () => (
  <RestaurantPage
    restaurantName="Jeong"
    address="1460 W. Chicago Ave., Chicago, 60647, USA"
    cuisine="Korean, Contemporary"
    priceRange="$$$$"
    phoneNumber="+13128775016"
    website="https://jeongchicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sleek operation arrives courtesy of two passionate young chefs, Dave Park and wife Jen Tran. In this kitchen, they aim to impart complex and authentic Korean flavors to a myriad of sophisticated diners. All this transpires in an elegant, intimate and ultra-modern setting—and the result is foodie date-night perfection.Chef Dave Park spins gorgeous, high quality ingredients into incredibly inventive dishes, combining excellent products with a deft hand. A delicate disk of salmon tartare, for example, is topped with doenjang yuzu gastrique, miniature quenelles of crème fraiche, and crunchy rice crackers that are full of nutty flavor; while an earthy kimchi truffle emulsion is paired with an accurately cooked bavette of beef and sunchoke croquette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1460%20W.%20Chicago%20Ave.%2C%20Chicago%2C%2060647%2C%20USA"
    pageTitle="Jeong"
  />
);
