...
const AllaVita = () => (
  <RestaurantPage
    restaurantName="Alla Vita"
    address="564 W. Randolph St., Chicago, 60661, USA"
    cuisine="Italian, Italian-American"
    priceRange="$$$"
    phoneNumber="+13126670104"
    website="https://www.allavitachicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Boka Restaurant Group is no stranger to quality, which you’ll find in spades in this gorgeous room decorated with crystal pendants, hand-painted tile floors, and an amber-tinted sculpture floating overhead. Freshly made pasta, puffy-edged pizzas, and shareable entrées satisfy a range of cravings. There’s the crowd favorite rigatoni alla vodka—at once sweet, creamy, and toothsome—as well as a confident half chicken, roasted and served with grilled lemon. Come lunch time, a long, rustic stone bar is a prime perch where fellow diners happily dig into some of the most satisfying sandwiches in town. You can linger over a bottle of wine or dash in and out for a quick bite. The professional staff will keep everything sailing smoothly either way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=564%20W.%20Randolph%20St.%2C%20Chicago%2C%2060661%2C%20USA"
    pageTitle="Alla Vita"
  />
);

export default AllaVita;
