...
const HugosFrogBarFishHouse = () => (
  <RestaurantPage
    restaurantName="Hugo’s Frog Bar & Fish House"
    address="1024 N. Rush St., Chicago, 60611, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+13126400999"
    website="https://www.hugosfrogbar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a sprawling setting adjacent to big brother Gibson’s, Hugo’s always seems packed. The vast dining room sets white linen-topped tables amid dark polished wood and pale walls decorated with a mounted swordfish, fish prints, and model ships. Hugo’s bar draws its own crowd with abundant counter seating. The menu focuses on a selection of fish, steaks, and chops, supplemented by stone crab claws, oysters, crab cakes, chowders, and sautéed frog’s legs. Family-style sides—creamed spinach or roasted Brussels sprouts in Bourbon maple butter—are a worthy addition.With generous portions all around, you'll need a football team to share a slice of the Muddy Bottom Pie, or just a handful of pals to savor other decadent desserts like the apple pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1024%20N.%20Rush%20St.%2C%20Chicago%2C%2060611%2C%20USA"
    pageTitle="Hugo’s Frog Bar & Fish House"
  />
);

export default HugosFrogBarFishHouse;
