...
const YaoYao = () => (
  <RestaurantPage
    restaurantName="Yao Yao"
    address="230 W. Cermak Rd., Chicago, 60616, USA"
    cuisine="Chinese, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+13129294279"
    website="https://www.yaoyaochicago.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Score one of the front tables for a view of the glass-enclosed kitchen, though the wood-crafted banquette is ideal for settling in. Yao Yao pickled fish is the signature dish here, and it comes in three sizes (extra-large feeds up to six people!). Fiery and potent, this plate delivers a one-two punch with a funky seafood quality and the sharp tang of sour greens. Choose the two flavored pickled for a taste of Yao Yao pickled fish and boiled beef in a spicy Szechuan sauce. Wontons in chili oil are a no-brainer, and tere are also a slew of sides, ranging from celtuce and dry bean curd skin to seaweed knot and konjac noodles to round out the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=230%20W.%20Cermak%20Rd.%2C%20Chicago%2C%2060616%2C%20USA"
    pageTitle="Yao Yao"
  />
);
