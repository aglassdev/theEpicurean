...
const HelenBIR = () => (
  <RestaurantPage
    ...
    address="2013 2nd Ave. N., Birmingham, AL, 35203, USA"
    cuisine="American Contemporary"
    priceRange="$$$"
    phoneNumber="+12054387000"
    website="https://www.helenbham.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Rob McDaniel and his wife Emily built this downtown Birmingham restaurant as an homage to Rob's maternal grandmother who gathered her family for meals that she cooked over her indoor grill. Here at Helen, many of the dishes feature grilled elements.The menu is concise and showcases plates with Southern and international flair. Warm angel biscuits served warm alongside a quenelle of whipped cane syrup butter will soothe your soul. Enjoy a bowl of comfort with braised Peruvian lima beans in a golden broth with coal-roasted rapini and garlic chili oil. Cobia is beautifully seared on the plancha for a simple-but-satisfying dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2013%202nd%20Ave.%20N.%2C%20Birmingham%2C%20AL%2C%2035203%2C%20USA"
    pageTitle="Helen"
  />
);

export default HelenBIR;
