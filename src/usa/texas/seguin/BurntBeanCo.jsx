...
const BurntBeanCo = () => (
  <RestaurantPage
    restaurantName="Burnt Bean Co."
    address="108 S. Austin St., Seguin, 78155, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber=""
