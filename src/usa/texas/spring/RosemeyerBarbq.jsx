...
const RosemeyerBarbq = () => (
  <RestaurantPage
    restaurantName="Rosemeyer Bar-B-Q"
    address="2111 Riley Fuzzell Rd., Spring, 77386, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+12812050625"
    website="https://rosemeyerbbq.square.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Imagine: a single trailer in Spring parked on the side of the highway next door to a gas station with a sign out front. The setup is as classic as the trailer’s origins. Childhood friends Jordan Rosemeyer and Ben Maxwell started out cooking for fun on weekends, but before long found themselves running this humble operation. There’s no dining room in sight but there are picnic tables. Most importantly, there is great barbecue – and a lot of it. Beautifully smoked brisket takes top billing, but tender pork ribs and snappy, jalapeno-cheese sausages are must-orders as well. Daily specials are another point of pride so keep a close eye on the restaurant’s social media...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2111%20Riley%20Fuzzell%20Rd.%2C%20Spring%2C%2077386%2C%20USA"
    pageTitle="Rosemeyer Bar-B-Q"
  />
);

export default RosemeyerBarbq;
