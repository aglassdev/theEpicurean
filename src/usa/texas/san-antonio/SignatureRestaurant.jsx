...
const SignatureRestaurant = () => (
  <RestaurantPage
    restaurantName="Signature"
    address="16401 La Cantera Pkwy, San Antonio, 78256, USA"
    cuisine="American"
    priceRange="$$$$"
    phoneNumber="+12102470176"
    website="https://www.signaturerestaurant.com/"
    aliases={["Signature Restaurant"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a warm and inviting appeal about Signature Restaurant, set within La Cantera Resort & Spa. Seafood dominates the menu, though there are plenty of other choices, including venison, pork, and beef. If the large menu and comprehensive wine list have you stumped, the attentive staff will keep you on track. Begin with an appetizer such as the Spanish octopus, grilled to a tender and crispy finish, served over an avocado puree and sided by confit potatoes, Spanish chorizo, and a salsa verde. Next, consider the venison, deftly cooked and accompanied by a cherry jus, baby carrots, and potato pave. End the meal on a high note with their warm torta di ricotta with candied almonds, blueberries, and yuzu buttermilk ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16401%20La%20Cantera%20Pkwy%2C%20San%20Antonio%2C%2078256%2C%20USA"
    pageTitle="Signature"
  />
);
