...
const ReeseBrosBarbecue = () => (
  <RestaurantPage
    restaurantName="Reese Bros Barbecue"
    address="906 Hoefgen Ave., San Antonio, TX, 78210, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+15129259205"
    website="https://www.reesebrosbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot near the stadium is only open Thursday through Saturday, and the line is long, even when you come early, but it's worth queuing up for a taste of brothers Elliott and Nick Reese's barbecue. They're turning out Texas-style meat and while brisket is their focus, don't sleep on the queso fundido sausage or smoked turkey breast. It's not all traditional, though, as they substitute house-made flour tortillas and salsa for the typical white bread, and their sides are given an interesting spin. Poblano mac and cheese, or beans with peppers, onions and okra, anyone? Round it all out with a slice of piña colada cobbler for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=906%20Hoefgen%20Ave.%2C%20San%20Antonio%2C%20TX%2C%2078210%2C%20USA"
    pageTitle="Reese Bros Barbecue"
  />
);

export default ReeseBrosBarbecue;
