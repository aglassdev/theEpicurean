...
const restaurants = [
  {
    ...
    cuisine: "Italian",
    price: "$$",
    path: "/usa/texas/dallas/Barsottis",
  ...
  },
  {
    ...
    cuisine: "Barbecue",
    price: "$$",
    path: "/usa/texas/dallas/CattleackBarbeque",
    image: "/images/cattleackbarbeque1.png"
  },
  {
    name: "Crown Block",
    cuisine: "American Contemporary, Meats and Seafood",
    price: "$$$$",
    path: "/usa/texas/dallas/CrownBlock",
    image: "/images/crownblock1.png"
  },
  {
    name: "El Carlos Elegante",
    cuisine: "Mexican, Contemporary",
    price: "$$$$",
    path: "/usa/texas/dallas/ElCarlosElegante",
    image: "/images/elcarloselegante1.png"
  },
  {
    name: "Fearing's",
    cuisine: "American, Regional Cuisine",
    price: "$$$$",
    path: "/usa/texas/dallas/Fearings",
  ...
  },
  {
    ...
    cuisine: "French",
    price: "$$$",
    path: "/usa/texas/dallas/KnoxBistro",
    image: "/images/knoxbistro1.png"
  },
  {
    name: "Lucia",
    cuisine: "Italian",
    price: "$$$",
    path: "/usa/texas/dallas/Lucia",
  ...
  },
  {
    ...
    price: "$$$",
    path: "/usa/texas/dallas/MercatBistro",
    image: "/images/mercatbistro1.png"
  },
  {
    name: "Mister Charles",
    cuisine: "Contemporary, American",
    price: "$$$$",
    path: "/usa/texas/dallas/MisterCharles",
    image: "/images/mistercharles1.png"
  },
  {
    name: "Monarch",
    cuisine: "Italian-American",
    price: "$$$$",
    path: "/usa/texas/dallas/Monarch",
  ...
  },
  {
    ...
    price: "$$",
    path: "/usa/texas/dallas/MtHaiBa",
    image: "/images/mthaiba1.png"
  },
  {
    name: "Ngon Vietnamese Kitchen",
    cuisine: "Vietnamese",
    price: "$$",
    path: "/usa/texas/dallas/NgonVietnameseKitchen",
    image: "/images/ngonvietnamesekitchen1.png"
  },
  {
    name: "nonna",
    cuisine: "Italian",
    price: "$$$",
    path: "/usa/texas/dallas/Nonna",
  ...
  },
  {
    ...
    price: "$$$",
    path: "/usa/texas/dallas/QuarterAcre",
    image: "/images/quarteracre1.png"
  },
  {
    name: "Rye",
    cuisine: "Contemporary",
    price: "$$$$",
    path: "/usa/texas/dallas/Rye",
  ...
  },
  {
    ...
    cuisine: "Steakhouse",
    price: "$$$$",
    path: "/usa/texas/dallas/Stillwells",
  ...
  },
  {
    ...
    cuisine: "American",
    price: "$$$",
    path: "/usa/texas/dallas/StockBarrel",
    image: "/images/stockbarrel1.png"
  },
  {
    name: "Tatsu Dallas",
    cuisine: "Japanese, Sushi",
    price: "$$$$",
    path: "/usa/texas/dallas/TatsuDallas",
    image: "/images/tatsudallas1.png"
  },
  {
    name: "Tei-An",
    cuisine: "Japanese, Soba",
    price: "$$$$",
    path: "/usa/texas/dallas/Teian",
    image: "/images/teian1.png"
  },
  {
    name: "Written By The Seasons",
    cuisine: "American Contemporary",
    price: "$$$",
    path: "/usa/texas/dallas/WrittenByTheSeasons",
    image: "/images/writtenbytheseasons1.png"
  }
];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        position: 'relative',
        overflow: 'hidden',
        backgroundImage: 'url("https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Downtown_Dallas_Sunset_2013.jpg/1280px-Downtown_Dallas_Sunset_2013.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'
      }}>
