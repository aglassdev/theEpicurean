...
const MtHaiBa = () => (
  <RestaurantPage
    restaurantName="Một Hai Ba"
    address="6047 Lewis St., Dallas, 75206, USA"
    cuisine="Fusion, Vietnamese"
    priceRange="$$"
    phoneNumber="+19726387468"
    website="https://www.mothaibadallas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You could easily drive right by this standalone building tucked behind an auto repair shop, but one bite of Chef Peja Krstic's cooking and you won't soon forget the address. Inside, wood floors and exposed brick add charm to this narrow space where Serbian-born Krstic turns out contemporary cuisine with Vietnamese and French influences and decidedly Texan touches. The mashup is especially intriguing, offering an interesting journey with dishes such as steamed bao filled with beef brisket and a shallot marmalade, or crispy tempura squash blossoms filled with pork and shrimp with nuoc cham vinaigrette. For dessert, savor the coconut lemongrass panna cotta with orange marmalade and chocolate peanut crumble...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6047%20Lewis%20St.%2C%20Dallas%2C%2075206%2C%20USA"
    pageTitle="Một Hai Ba"
  />
);

export default MtHaiBa;
