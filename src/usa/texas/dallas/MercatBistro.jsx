...
const MercatBistro = () => (
  <RestaurantPage
    restaurantName="Mercat Bistro"
    address="2501 N. Harwood St., Ste. 225, Dallas, 75201, USA"
    cuisine="French, American"
    priceRange="$$$"
    phoneNumber="+12149530917"
    website="https://www.mercatbistro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are occasions for trends and then there are times when tradition reigns, and that's exactly where Mercat Bistro comes in. This amiable restaurant delivers the classic French bistro experience from its wood floors, marble-topped tables, and round-backed chairs to its extensive menu showcasing all of the hits. Discover a litany of favorites, ranging from escargots in parsley butter and French onion soup to moules frites and pot au crème. Come at lunch to indulge in sandwiches like the croque monsieur. In true bistro fashion, nothing is too precious, but it's all comforting and delicious. The service is welcoming and attends to the mix of business diners and locals with skill but be sure to secure a seat in the room with the open kitchen to enjoy a livelier vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2501%20N.%20Harwood%20St.%2C%20Ste.%20225%2C%20Dallas%2C%2075201%2C%20USA"
    pageTitle="Mercat Bistro"
  />
);

export default MercatBistro;
