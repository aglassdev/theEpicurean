...
const Josephines = () => (
  <RestaurantPage
    restaurantName="Josephine's"
    address="318 Gray St., Houston, TX, 77002, USA"
    cuisine="Seafood, Southern"
    priceRange="$$"
    phoneNumber="+17135278988"
    website="https://josephinesgulfcoasttradition.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's located in Houston's Midtown, but this restaurant run by Chef Lucas is all about the Gulf Coast. Booths and tables welcome everyone from families and couples on dates to solo diners at this laidback spot. The menu leans into Southern comfort with a seafood-forward approach—think raw oysters, po’boys, shrimp and grits, plus some fun nods like fried chicken on a stick and a Mississippi hot catfish sandwich. Biscuits served with seasonal jam and whipped butter are a must. Daily catch rotates but a recent redfish served over a bed of creamy corn hit the spot, as does the blue crab rice bowl with Carolina Gold rice and crab fat aioli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=318%20Gray%20St.%2C%20Houston%2C%20TX%2C%2077002%2C%20USA"
    pageTitle="Josephine's"
  />
);

export default Josephines;
