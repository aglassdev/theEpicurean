...
const Neo = () => (
  <RestaurantPage
    restaurantName="Neo"
    address="1711 Indiana St., Houston, TX, 77008, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+18325986222"
    website="https://www.glasscypress.com/explore/neo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closedBorn out of the pandemic, this intimate sushi counter sports an unusual location inside of a couture clothing store in Montrose. The unlikely setting has only a precious few seats in the hands of friendly chefs who honor the traditions of Japanese omakase on their own terms. Focused and measured, they carefully prepare the sushi rice and meticulously slice fish at the start of the meal. Their style is not strictly traditional, and the tasting features a variety of fun flourishes. Think uni risotto or nigiri dabbed with black garlic or kumquats. The quality of seafood is noteworthy, with much of it flown in from Japan and dry-aged for weeks in fridges in the back. At this time, boozy beverages are limited...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1711%20Indiana%20St.%2C%20Houston%2C%20TX%2C%2077008%2C%20USA"
    pageTitle="Neo"
  />
);
