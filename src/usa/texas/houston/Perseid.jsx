...
const Perseid = () => (
  <RestaurantPage
    restaurantName="Perseid"
    address="4110 Loretto Dr., Houston, TX, 77006, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+18328440057"
    website="https://www.bunkhousehotels.com/hotel-saint-augustine/eat-drink/perseid"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With light streaming in from all sides, this cheery, French-inspired bistro is a cut above your typical hotel restaurant. A collaboration between Chef Aaron Bludorn and the boutique Hotel Saint Augustine, the stand-alone dining room is painted head to toe in sunflower yellow with tall windows and a spacious patio to boot. Expect familiar favorites prepared with refinement like smoked salmon dip with everything bagel seasoning and house-fried potato chips or steelhead trout with Romano beans and sauce almondine. Roast duck breast, serious steaks, and an endlessly tempting dessert selection round out the offerings. Matching the tenor of the room, attentive servers keep guests at ease. As an added bonus, breakfast is offered all week as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4110%20Loretto%20Dr.%2C%20Houston%2C%20TX%2C%2077006%2C%20USA"
    pageTitle="Perseid"
  />
);

export default Perseid;
