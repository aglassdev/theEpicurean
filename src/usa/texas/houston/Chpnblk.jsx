...
const Chpnblk = () => (
  <RestaurantPage
    restaurantName="ChòpnBlọk"
    address="507 Westheimer Rd., Houston, TX, 77006, USA"
    cuisine="African"
    priceRange="$$"
    phoneNumber="+18329624500"
    website="https://chopnblok.co/reservations"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Growing up in Houston as the child of Nigerian immigrants, Chef/owner Ope Amosu always wanted to showcase Nigerian and West African cuisine. Enter ChòpnBlọk, a small stand inside of The Post. It's casual but stylish, showcasing traditional African decor complemented by books and vinyls.Jollof rice, coconut curry and rice bowls steal the spotlight, and whether it's rice with peanut stew, jollof jambalaya or rice with stewed plantains, West African flavors are at the forefront. The golden bowl is a delicious blend of smoky jollof jambalaya, motherland curry, yaji vegetables and stewed plantains with chicken or shrimp. Polo club suya, or grilled beef skewers dusted with yaji peanut pepper spice, are tender, nutty and spicy. Don't sleep on the plantain bread in crème anglaise..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=507%20Westheimer%20Rd.%2C%20Houston%2C%20TX%2C%2077006%2C%20USA"
    pageTitle="ChòpnBlọk"
  />
);

export default Chpnblk;
