...
const Musaafer = () => (
  <RestaurantPage
    restaurantName="Musaafer"
    address="5115 Westheimer Rd., Ste. C-3500, Houston, 77056, USA"
    cuisine="Indian, Contemporary"
    priceRange="$$$$"
    phoneNumber="+17132428087"
    website="https://www.musaaferhouston.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dinner in a shopping mall doesn’t sound promising, unless you’re headed to Musaafer. The sheer scale of this grand hall, with its arches, towering windows, labyrinth-like layout, and elaborate patterns, feels like a palace of its own. The setting is as thrilling as the cooking. A large, deep-fried orb of onion xuixo arrives dusted in no fewer than 24 spices, filled with potato and onion, and served with tamarind and mint chutney. Plucky prawns are cooked in an elegant sauce of coriander, coconut milk, and curry leaves. Dal, a familiar favorite, is cooked for 72 hours with tomato, butter, and smoked chili. The attention to detail and careful spicing is evident at every turn, and the final result is one of both high style and utterly gratifying substance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5115%20Westheimer%20Rd.%2C%20Ste.%20C-3500%2C%20Houston%2C%2077056%2C%20USA"
    pageTitle="Musaafer"
  />
);

export default Musaafer;
