...
const Baso = () => (
  <RestaurantPage
    restaurantName="Baso"
    address="633 W. 19th St., #A, Houston, 77008, USA"
    cuisine="American, Contemporary"
    priceRange="$$$$"
    phoneNumber="+19793499051"
    website="https://basohtx.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bring friends to this underground party of a restaurant in the Heights. Heavy beats boom through the austere, concrete dining room fit with moody lighting and a long open kitchen armed with a glowing hearth. Yes, this is where the cool people eat. The tight menu leans into live-fire cooking and pulls ideas from all over: Tataki-style albacore tuna with barley and fried chicken skin, a hands-on Caesar salad, and serious cuts of heritage pork, ribeyes, and wagyu. Sharing really is the best way forward here. The signature Basque cheesecake, topped off with caviar if desired, is a notably indulgent way to finish this big meal, but don’t underestimate a wonderfully smooth scoop of ice cream either...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=633%20W.%2019th%20St.%2C%20%23A%2C%20Houston%2C%2077008%2C%20USA"
    pageTitle="Baso"
  />
);
