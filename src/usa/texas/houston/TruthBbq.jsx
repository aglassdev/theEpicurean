...
const TruthBbq = () => (
  <RestaurantPage
    restaurantName="Truth BBQ"
    address="110 S. Heights Blvd., Houston, 77007, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+18328350001"
    website="https://www.truthbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the acclaimed original location in Brenham is little more than a roadside shack, this Houston Heights sequel from owner and pitmaster Leonard Botello IV is a gleaming model of modern efficiency. Fortunately, the cooking still has plenty of soul: the brisket is expectedly solid, while smoked pork ribs and house-made sausages are a cut above. Surprisingly, sides like collards, beans and corn pudding—or even the more rarified tater tot casserole with crisp fried onions— might even be the highlight, offering the flavorful, rib-sticking quality of lovingly homemade dishes. If, somehow, you manage not to fill up on the tantalizing savory options, those with an implacable sweet tooth can tip the scales with hefty slices of house-made cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=110%20S.%20Heights%20Blvd.%2C%20Houston%2C%2077007%2C%20USA"
    pageTitle="Truth BBQ"
  />
);

export default TruthBbq;
