...
const Bludorn = () => (
  <RestaurantPage
    restaurantName="Bludorn"
    address="807 Taft St., Houston, 77019, USA"
    cuisine="American, Contemporary"
    priceRange="$$$"
    phoneNumber="+17139990146"
    website="https://www.bludornrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Aaron Bludorn and his wife Victoria are the minds behind this buzzy dining room fitted with cushy, royal blue booths, handsome wood chairs, and a gleaming open kitchen. There is something for everyone on this broad menu that pulls inspiration from all corners, swinging from seafood towers to cioppino with branzino, blue crab, and shrimp. Order the side of Brussels sprouts, served in a cast iron pan and tossed with thinly sliced green apple, toasted walnuts, and diced bacon. Bludorn follows the seasons closely, and his servers follow their guests even closer. Dinner must close with a sizeable baked Alaska, made with a range of sorbets and ice creams like pistachio, raspberry, and gianduja all covered in meringue and lit on fire. It is as entertaining as it is satisfying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=807%20Taft%20St.%2C%20Houston%2C%2077019%2C%20USA"
    pageTitle="Bludorn"
  />
);

export default Bludorn;
