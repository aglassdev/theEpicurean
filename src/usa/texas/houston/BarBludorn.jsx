...
const BarBludorn = () => (
  <RestaurantPage
    restaurantName="Bar Bludorn"
    address="9061 Gaylord Dr., Houston, TX, 77024, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+18322718264"
    website="https://www.barbludorn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="How many beignets is too many? In what feels like an easygoing tavern, these light pillows land on the table warm, filled with ricotta cheese, and topped with thin slivers of Benton’s ham. One could nearly make a meal out of them. Such is the appeal of this confident neighborhood spot from the ever-busy Chef Aaron Bludorn. Wrapped in dark wood lit under keen spotlights, the dining room has clear views of a gleaming open kitchen. Just as service is both approachable and attentive, the menu too deals in hearty, comfort fare that’s short on fuss and long on flavor. From pasta to steaks, everything is designed for sharing, especially the golden-fried half chicken. To finish, desserts like warm devil’s food cake with salted caramel are indulgent affairs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9061%20Gaylord%20Dr.%2C%20Houston%2C%20TX%2C%2077024%2C%20USA"
    pageTitle="Bar Bludorn"
  />
);

export default BarBludorn;
