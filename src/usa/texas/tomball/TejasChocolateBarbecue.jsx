...
const TejasChocolateBarbecue = () => (
  <RestaurantPage
    restaurantName="Tejas Chocolate + Barbecue"
    address="200 N. Elm St., Tomball, 77375, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+12812291011"
    website="https://www.tejaschocolate.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="North of Houston in the city of Tomball, Scott Moore Jr. might be the only chocolatier to become a pitmaster. This wasn’t his plan when he launched a bean-to-bar operation in 2015, but now it is the main reason why customers from all over line up on the porch of this quirky house before doors open. Flintstone-sized beef ribs with salt and pepper barks and melting threads of fat are a notable daily special (Friday only). Other highlights include snappy chile relleno sausages and lovely slices of USDA prime beef brisket, all of which emerge from barbecue pits parked under a shed next to a mountain of chopped wood. Sides are fairly standard, except for the excellent carrot soufflé, which straddles a fine, delicious line between sweet and savory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20N.%20Elm%20St.%2C%20Tomball%2C%2077375%2C%20USA"
    pageTitle="Tejas Chocolate + Barbecue"
  />
);

export default TejasChocolateBarbecue;
