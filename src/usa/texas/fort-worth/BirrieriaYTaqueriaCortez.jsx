...
const BirrieriaYTaqueriaCortez = () => (
  <RestaurantPage
    restaurantName="Birrieria y Taqueria Cortez"
    address="2220 E. Rosedale St., Fort Worth, 76105, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+18176000127"
    website="https://guide.michelin.com/en/texas/fort-worth_2954653/restaurant/birrieria-y-taqueria-cortez"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rogelio Cortez Jr. first earned a steady following with a food truck before opening this brick-and-mortar location where music keeps things lively, and the vibe is casual and inviting. The name says it all, as their specialty lies in their wonderfully tender and flavorful birria. It's not just the highlight—it's the only protein offered—but it's served in a number of tempting ways from tacos and flautas to tortas, burritos, and quesadillas. Order their corn tortilla tacos, stuffed with a generous amount of birria and accompanied by onion, cilantro, and lime, or choose their quesatacos, or two corn tortillas filled with mozzarella cheese and birria meat that is crisped at the edges...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2220%20E.%20Rosedale%20St.%2C%20Fort%20Worth%2C%2076105%2C%20USA"
    pageTitle="Birrieria y Taqueria Cortez"
  />
);

export default BirrieriaYTaqueriaCortez;
