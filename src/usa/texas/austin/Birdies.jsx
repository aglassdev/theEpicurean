...
const Birdies = () => (
  <RestaurantPage
    restaurantName="Birdie's"
    address="2944 E. 12th St., Austin, 78702, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber=""
    website="https://www.birdiesaustin.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This East Austin darling from Chef Tracy Malechek-Ezekiel and partner Arjav Ezekiel looks and feels like the quintessential neighborhood place but one glance at the line out the door and it's clear Birdie's is also a destination for visitors. Be prepared for a wait to order at their counter, then find a seat indoors or out on the shaded patio.Everyone is here for a taste of their unfussy but well-executed, contemporary American cooking. Begin with a few small bites like the crispy polenta or the chilled tomato and peach soup with fried sourdough croutons. Pasta, like the house-made tortiglioni in a sauce of slightly sweet Sungold tomatoes, is a must, and nothing beats a gooey chocolate chip cookie with house-made soft serve...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2944%20E.%2012th%20St.%2C%20Austin%2C%2078702%2C%20USA"
    pageTitle="Birdie's"
  />
);
