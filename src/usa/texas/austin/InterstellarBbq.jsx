...
const InterstellarBbq = () => (
  <RestaurantPage
    restaurantName="InterStellar BBQ"
    address="12233 Ranch Rd. 620 N., Ste. 105, Austin, 78750, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+15123826248"
    website="https://www.theinterstellarbbq.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The mark of a good place is when a line starts forming before they've even opened, and at InterStellar BBQ, it's long before they've swung open the door. Everyone is here for a taste of pitmaster John Bates's barbecue, done low and slow over post oak. Brisket with a simple salt, pepper, and garlic rub, is outstanding but it doesn't end there. Peach tea-glazed pork belly is meltingly tender; the beer-brined tipsy turkey is moist and delicious; and there are three sausages on offer, including kielbasa. You can't go wrong with any of the enticing side dishes like the Frito pie, though the smoked scalloped potatoes with a golden-brown crust and the poblano creamed corn are standouts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12233%20Ranch%20Rd.%20620%20N.%2C%20Ste.%20105%2C%20Austin%2C%2078750%2C%20USA"
    pageTitle="InterStellar BBQ"
  />
);

export default InterstellarBbq;
