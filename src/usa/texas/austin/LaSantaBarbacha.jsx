...
const LaSantaBarbacha = () => (
  <RestaurantPage
    restaurantName="La Santa Barbacha"
    address="2806 Manor Rd., Austin, 78722, USA"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+17377085737"
    website="https://guide.michelin.com/en/texas/austin_2958315/restaurant/la-santa-barbacha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This East Austin eatery isn't your average roadside trailer. Run by the Landaverde siblings, this spot elevates the typical experience with a platform and picnic tables shaded by greenery and a battalion of fans. The food is equally leveled up, with a focus on barbacoa (even the name is a play on it). From the very first bite, it's clear that this meat is special. Get it in breakfast tacos or in that Austin staple, migas tacos, with scrambled eggs, chips, shredded cheese, and sliced avocado. It's also available on its own or in a quesabarbacha, a beet-red tortilla folded with barbacoa, cilantro, and onion, along with gooey cheese. It's decadent, with a good balance of flavor aided by their house-made salsa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2806%20Manor%20Rd.%2C%20Austin%2C%2078722%2C%20USA"
    pageTitle="La Santa Barbacha"
  />
);

export default LaSantaBarbacha;
