...
const Toshokan = () => (
  <RestaurantPage
    restaurantName="Toshokan"
    address="807 E. 4th St., Austin, 78702, USA"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber=""
    ...
    bio="Omakase counters can often be a hushed affair but Toshokan strays from the pack. Their location inside Holey Moley, an adult recreation center home to indoor mini golf and a bar with tiki drinks, is the first sign to expect something slightly irreverent. Discover this counter helmed by Chef Saine Wong hidden behind a wall lined with books. Inside, the small, soundproof boîte has room for just a handful of guests.It's far from traditional nigiri; instead find whimsically embellished, playful pieces, as in a spicy margarita-inspired Japanese hamachi topped with finely diced jalapeno, grated lime zest, and sea salt; or the wagyu embellished with grated egg yolk evoking steak and eggs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=807%20E.%204th%20St.%2C%20Austin%2C%2078702%2C%20USA"
    pageTitle="Toshokan"
  />
);

export default Toshokan;
