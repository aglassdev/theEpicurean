...
const VeracruzFondaBar = () => (
  <RestaurantPage
    restaurantName="Veracruz Fonda & Bar"
    address="1905 Aldrich St., Austin, 78723, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+17373184896"
    website="https://veracruzfonda.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sisters Reyna and Maritza Vazquez are well known for their bright blue Veracruz All Natural juice and taco trucks, and this brick-and-mortar spot in Mueller builds off their success (the decor even incorporates their recognizable blue color). The menu spotlights what they're known for—tacos—and adds in antojitos and a few larger plates here. Blue corn tortillas are made in house and are delicious folded around queso fresco and crispy epazote, or a cochinita taco with tender braised pork, fried plantain, and red onion habanero lime escabeche. Conchas are the perfect sweet treat, and here they offer pecan and lime versions as well as the more typical chocolate and vanilla...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1905%20Aldrich%20St.%2C%20Austin%2C%2078723%2C%20USA"
    pageTitle="Veracruz Fonda & Bar"
  />
);

export default VeracruzFondaBar;
