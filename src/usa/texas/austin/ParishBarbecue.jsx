...
const ParishBarbecue = () => (
  <RestaurantPage
    restaurantName="Parish Barbecue"
    address="3220 Manor Rd., Austin, TX, 78723, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+15125961913"
    website="https://parishbarbecue.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Holden Fulco, who spent time at Franklin, Interstellar and other well-known places, is the force behind this barbecue spot in a stationary trailer that's located behind Batch Craft Beer & Kolaches. It's a simple set-up outdoors with picnic tables, and there are plenty of seats indoors too. Discover a bit of Creole on this central Texas-style barbecue menu, where spice rubs are enhanced with Cajun spices, Tabasco works its way into glazes and meat offerings include the usual suspects like tender brisket alongside ham, pulled duck, and a snappy boudin. Like any good barbecue spot worth its salt, the sides are especially tempting, with everything from pimento mac & cheese topped with crumbled Zapp's potato chips; crawfish cornbread stuffing; and Creole tomato salad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3220%20Manor%20Rd.%2C%20Austin%2C%20TX%2C%2078723%2C%20USA"
    pageTitle="Parish Barbecue"
  />
);

export default ParishBarbecue;
