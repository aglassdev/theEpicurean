...
const NixtaTaqueria = () => (
  <RestaurantPage
    restaurantName="Nixta Taqueria"
    address="2512 E. 12th St., Austin, 78702, USA"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+15127668023"
    website="https://www.nixtataqueria.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come as you are, and come early, to this East Austin taqueria from owners and partners Chef Edgar Rico and Sara Mardanbigi. It's a bit scrappy but rewards its visitors with spot-on Mexican-focused cooking. As the name suggests, the menu is all about nixtamalized corn of heirloom varietals. Everything is made in house and the menu presents a great mix of contrasts, featuring dishes employing ancient methods alongside updated items like duck fat refried beans. The duck carnitas taco, served on a thick tortilla made from heirloom pink corn, is impressive, while the carrot tostada is a study in care and composure with charred carrots, whipped herb ricotta, and salsa macha. Finish with something bold and sweet like a blueberry, basil, and ricotta paleta...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2512%20E.%2012th%20St.%2C%20Austin%2C%2078702%2C%20USA"
    pageTitle="Nixta Taqueria"
  />
);

export default NixtaTaqueria;
