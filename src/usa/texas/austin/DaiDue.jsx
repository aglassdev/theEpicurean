...
const DaiDue = () => (
  <RestaurantPage
    restaurantName="Dai Due"
    address="2406 Manor Rd., Austin, 78722, USA"
    cuisine="American, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+15125240688"
    website="https://www.daidue.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Texans are known around the world for their inimitable hometown pride, but Chef/owner Jesse Griffiths takes his affection for the Lone Star state to another level at Dai Due, where nearly everything, from produce and meat to olive oil and wine, is sourced from Texas. Brunch is available but it's the evenings when this place shines. Walk past the entrance filled with tempting baked goods and prepared meats to find a rustic back room perfect for hosting the supper club-style service. Skilled butchers tackle everything from wild boar and antelope to goat, and Chef Janie Ramirez's plates are impressively offbeat. Hits include the cold meat board with antelope salami and wild boar and dill pickle terrine, as well as the smoked pork Porterhouse chop with sauerkraut, Bavarian mustard, and chutney..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2406%20Manor%20Rd.%2C%20Austin%2C%2078722%2C%20USA"
    pageTitle="Dai Due"
  />
);

export default DaiDue;
