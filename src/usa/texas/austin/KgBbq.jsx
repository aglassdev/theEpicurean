...
const KgBbq = () => (
  <RestaurantPage
    restaurantName="KG BBQ"
    address="3108 Manor Rd., Austin, 78723, USA"
    cuisine="Barbecue, Egyptian"
    priceRange="$$"
    phoneNumber="+17372948598"
    website="https://www.kgbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Barbecue is ubiquitous in Texas, but there's something deliciously different about KG BBQ. It's all due to owner Kareem El-Ghayesh. Raised in Cairo, he left behind a career in finance to move here to smoke meat, and Austin is very happy he did. His food truck is located next to Oddwood Brewing, and there's always a line for this food that marries Middle Eastern twists with Texan barbecue tradition. From rubs and sauces that use sumac, cinnamon, and pomegranate to Mediterranean sausage with green olives, sun dried tomatoes, and feta cheese, the mashup is marvelous. Don't skip the boneless chicken thighs marinated in honey, thyme, and sumac and accompanied by a yogurt sauce. End on a sweet note like the rice pudding with pistachio butter and mascarpone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3108%20Manor%20Rd.%2C%20Austin%2C%2078723%2C%20USA"
    pageTitle="KG BBQ"
  />
);

export default KgBbq;
