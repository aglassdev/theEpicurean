...
const HongKongFoodStreet = () => (
  <RestaurantPage
    restaurantName="Hong Kong Food Street"
    address="23015 Colonial Pkwy., Ste. a101, Katy, TX, 77449, USA"
    cuisine="Chinese"
    priceRange="$$"
    phoneNumber="+18322128128"
    website="https://www.hkfstx.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Congee with abalone and chicken. Pork and shrimp wontons in a clear, light broth. Portuguese egg tarts. In a non-descript shopping center in Katy, this family-owned restaurant brings a taste of Hong Kong to Houston. The modern dining room features sleek light fixtures and handsome private dining rooms fit with lazy susans. And unlike some restaurants that compile an endless book of options, the kitchen here keeps things tight with a relatively curated selection of classics. Nothing is rushed or thrown together, and food arrives piping hot. Beautifully fried shrimp with candied walnuts is an indulgent throwback. Shrimp and tofu fritters delight as well. On weekends, be sure to ask about any seafood specials...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23015%20Colonial%20Pkwy.%2C%20Ste.%20a101%2C%20Katy%2C%20TX%2C%2077449%2C%20USA"
    pageTitle="Hong Kong Food Street"
  />
);

export default HongKongFoodStreet;
