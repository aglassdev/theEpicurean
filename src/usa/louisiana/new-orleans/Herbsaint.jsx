...
const Herbsaint = () => (
  <RestaurantPage
    restaurantName="Herbsaint"
    address="701 St. Charles Ave., New Orleans, LA, 70130, USA"
    cuisine="Contemporary, Southern"
    priceRange="$$$"
    phoneNumber="+15045244114"
    website="https://herbsaint.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant has been weathering storms and going strong for more than two decades. Pull up a chair inside this dining room overlooking St. Charles Street and you'll soon see why. The food is a skilled blend of Cajun and Creole undertones laced with French and Italian inspiration, but there's no need to classify it, just enjoy it. The house-made spaghetti is a perennial favorite but there are so many winning dishes, including a refreshing jumbo lump crab with watermelon and their take on the classic duck confit: Muscovy duck leg confit with dirty rice and citrus gastrique. It's a signature for a reason. Don't miss the comforting finale of vanilla pot de creme with local blackberries and cornmeal madeleines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=701%20St.%20Charles%20Ave.%2C%20New%20Orleans%2C%20LA%2C%2070130%2C%20USA"
    pageTitle="Herbsaint"
  />
);

export default Herbsaint;
