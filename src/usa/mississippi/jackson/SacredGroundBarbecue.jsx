...
const SacredGroundBarbecue = () => (
  <RestaurantPage
    restaurantName="Sacred Ground Barbecue"
    address="1052 Pocahontas Rd., Jackson, MS, 39206, USA"
    cuisine="Barbecue, American"
    priceRange="$$"
    phoneNumber="+16019009769"
    website="https://www.sacredgroundbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting on the other side of the train tracks along an empty stretch of highway in Pocahontas, find this impressive salute to Texas-style barbecue. Sure, the menu has burgers, loaded potatoes, and even some delicious smoked chicken wings, but don’t let anything distract you from the excellent meats sold by the half pound. Melting slices of brisket sport dark-red edges and impressively charred barks. Pork butt arrives soft and smoky and sings with the Carolina-inspired mustard sauce. Sides like cold smoked corn salad and green beans hold their own. An expansive patio with plenty of seating makes this a particularly prime spot for families...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1052%20Pocahontas%20Rd.%2C%20Jackson%2C%20MS%2C%2039206%2C%20USA"
    pageTitle="Sacred Ground Barbecue"
  />
);

export default SacredGroundBarbecue;
