...
const TableASH = () => (
  <RestaurantPage
    ...
    address="18 N. Lexington Ave., Asheville, NC, 28801, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+18282548980"
    website="https://tableasheville.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Husband-and-wife duo Jacob and Alicia Sessoms are behind this simple, seasonal and thoughtful restaurant in downtown Asheville. Table looks and feels welcoming, with plenty of places to sit both indoors and out, and a staff that exudes Southern charm. The New American menu is well-edited, with small plates like roasted vegetables, steak tartare and fresh bread, and larger mains like chicken, steak and house-made pasta (ricotta cavatelli in a rabbit sugo is spot on). The “easy” section includes bar snack standbys like wings, a fried chicken sandwich, and a messy-delicious burger with house-made queso served with shoestring French fries. Flan Parisian is the perfect way to end a meal here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20N.%20Lexington%20Ave.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Table"
  />
);

export default TableASH;
