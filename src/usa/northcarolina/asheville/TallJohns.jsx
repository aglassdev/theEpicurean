...
const TallJohns = () => (
  <RestaurantPage
    restaurantName="Tall John's"
    address="152 Montford Ave., Asheville, NC, 28801, USA"
    cuisine="American Contemporary"
    priceRange="$$"
    phoneNumber="+18287825514"
    website="https://www.talljohns.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tall John's is the quintessential neighborhood spot with a classic American menu and an ambience that makes it just right for everyone on any given night. It may be welcoming and laidback, but there is a clear emphasis on quality ingredients here, where house-made sauces are just one hint at the kitchen's skill.The menu leans into the name, with small and medium plates like olives, salads and tartare, and tall plates offerings hearty mains like steak, chicken and duck. Of course, nothing beats a classic order of Caesar salad with house-made croutons and a cheeseburger slathered with house-made dijonnaise and layered with sweet pickles and griddled onions. Shoestring fries on the side clinch the deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=152%20Montford%20Ave.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Tall John's"
  />
);

export default TallJohns;
