...
const TheAdmiral = () => (
  <RestaurantPage
    restaurantName="The Admiral"
    address="400 Haywood Rd., Asheville, NC, 28806, USA"
    cuisine="American Contemporary"
    priceRange="$$$"
    phoneNumber="+18282522541"
    website="https://www.theadmiralasheville.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Admiral leads the charge with a vintage diner meets modern bistro vibe. Their American cuisine displays playful, creative twists on a menu that mixes small and medium plates with a few classic steak and sauce options, as well as rotating “blue plate” specials like fried chicken, schnitzel and fish and chips. Noteworthy orders include blanched snap peas atop a creamy, charred spring onion pesto with pickled turnips. Tossed in a yuzu vinaigrette and finished with sesame seeds, it's a bright opener. Then, tuck into rack of lamb over a lemony couscous with sauteed leeks and asparagus. The whipped spread with fromage blanc cheese, lovage and pistachios will have you swooping up every last bit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=400%20Haywood%20Rd.%2C%20Asheville%2C%20NC%2C%2028806%2C%20USA"
    pageTitle="The Admiral"
  />
);

export default TheAdmiral;
