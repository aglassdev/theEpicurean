...
const AllDayDarling = () => (
  <RestaurantPage
    restaurantName="All Day Darling"
    address="102 Montford Ave., Asheville, NC, 28801, USA"
    cuisine="American"
    priceRange="$"
    phoneNumber="+18285053701"
    website="https://www.alldaydarlingavl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery in historic Montford is a quintessential neighborhood gathering place. Packed with colorful chairs and tables, it's a casual, come-as-you-are spot that's just right for picking up to-go orders as it is for settling in for a meal with friends. Chef Jacob Sessoms leans into the cozy, market-focused vibe with a menu built around breakfast and lunch favorites. It all begins with “The Wake Up” section full of egg sandwiches, frittatas and shakshuka, before transitioning to “Open and Closed” with picks like burgers, biscuit fried chicken sandwiches and avocado toast. Sides include everything from lentil fritters to gloriously crisp tater tots, and there’s a chalkboard near the register announcing the daily specials...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=102%20Montford%20Ave.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="All Day Darling"
  />
);

export default AllDayDarling;
