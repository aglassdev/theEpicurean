...
const UkiahJapaneseSmokehouse = () => (
  <RestaurantPage
    restaurantName="Ukiah Japanese Smokehouse"
    address="121 Biltmore Ave., Asheville, NC, 28801, USA"
    cuisine="Japanese, Barbecue"
    priceRange="$$$"
    phoneNumber="+18284707480"
    website="https://ukiahrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ukiah Japanese Smokehouse is located in downtown Asheville, with a white stucco exterior, ample outdoor seating and an exterior stone fireplace. Inside, the room has a rustic look and boasts an open kitchen. Headed by Chef Michael Lewis, the menu offers an array of small plates such as fried items, grilled skewers, sashimi, dumplings and buns, as well as smoked meats. The large bar at the center of the room is a convivial meeting place pouring creative cocktails (the Ukiah Oldie is fittingly infused with smoke) and local craft brews are on draft. Those unsure of what to order or without family or friends in tow should be sure to opt for the tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20Biltmore%20Ave.%2C%20Asheville%2C%20NC%2C%2028801%2C%20USA"
    pageTitle="Ukiah Japanese Smokehouse"
  />
);

export default UkiahJapaneseSmokehouse;
