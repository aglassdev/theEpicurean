...
const Herons = () => (
  <RestaurantPage
    restaurantName="Herons"
    address="The Umstead Hotel & Spa, 100 Woodland Pond Dr., Cary, NC, 27513, USA"
    cuisine="Modern Cuisine"
    priceRange="$$$$"
    phoneNumber="+19194474200"
    website="https://www.theumstead.com/dining/herons"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Need a getaway but have limited time? Herons offers the experience of a country escape without the commute. Set within The Umstead Hotel and Spa on three acres of woodland, this restaurant is a showpiece for their nearby farm's produce. Try several dishes or opt for the chef's surprise five- course menu to relish fresh and vibrant plates crafted with care by Chef Steven Devereaux Greene. His South Carolina roots are best seen in dishes like shrimp and grits, and dessert is impressive, especially the appealing blackberry panna cotta with fresh poached blackberries and crème fraîche.Be sure to consult the extensive, globally minded wine list. The restaurant has even developed several wines in close collaboration with the vineyards...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Umstead%20Hotel%20%26%20Spa%2C%20100%20Woodland%20Pond%20Dr.%2C%20Cary%2C%20NC%2C%2027513%2C%20USA"
    pageTitle="Herons"
  />
);
