...
const Brodeto = () => (
  <RestaurantPage
    restaurantName="Brodeto"
    address="2201 Iron Works Dr., Ste. 137, Raleigh, NC, 27604, USA"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+19196150388"
    website="https://brodeto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brodeto occupies the ground floor of the former Raleigh Iron Works (RIW), now home to a hub of eateries, retail outlets and offices. The name, a nod to a fish stew found along the Adriatic coast, is the first hint that this restaurant takes its inspiration from the cuisines of Italy and Croatia. From crudo and must-have pasta dishes to wood-fired fish and meat to peka, a Croatian slow-cooked, fire-grilled dish with octopus and potatoes, and of course, the namesake brodeto, this menu is packed with appealing choices. You won't go wrong with any of the selections, but be sure to consult the wine list, where no region of Italy is neglected and special growers and vintages are highlighted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2201%20Iron%20Works%20Dr.%2C%20Ste.%20137%2C%20Raleigh%2C%20NC%2C%2027604%2C%20USA"
    pageTitle="Brodeto"
  />
);

export default Brodeto;
