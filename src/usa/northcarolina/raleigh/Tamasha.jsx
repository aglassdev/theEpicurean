...
const Tamasha = () => (
  <RestaurantPage
    ...
    address="4200 Six Forks Rd., Ste. 130, Raleigh, NC, 27609, USA"
    cuisine="Indian"
    priceRange="$$$"
    phoneNumber="+19199007015"
    website="https://tamashanc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tamasha in Hindi translates as grand performance, and this North Hills restaurant certainly makes a visit here feel like a special occasion. Rather like the striking modern interior, the cooking is contemporary with subtle creativity and vibrancy. The kitchen takes high-quality, local ingredients and turns them into dishes made with traditional Indian techniques and flavors. Some dishes lean classic, others share a fusion influence, as in the Kerala pork belly bao. There is plenty to like in dishes like steamed yellowtail snapper in a coconut curry. For dessert, North meets South honors the chef's journey from northwest India to the South with ghewar biscuits sandwiched with coconut cream and a dusting of hibiscus and rose powder...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4200%20Six%20Forks%20Rd.%2C%20Ste.%20130%2C%20Raleigh%2C%20NC%2C%2027609%2C%20USA"
    pageTitle="Tamasha"
  />
);
