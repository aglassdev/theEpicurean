...
const MalaPata = () => (
  <RestaurantPage
    restaurantName="Mala Pata"
    address="2431 Crabtree Blvd., Ste. 102, Raleigh, NC, 27604, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+19193228252"
    website="https://malapatanc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mala Pata brings a taste of Mexico to Gateway Plaza. This upbeat spot has a lively vibe that spills over to the cocktail bar next door. Plan to start or end your evening with a mezcal mule or pisco sour.As for the food, Mala Pata takes ingredients quite seriously, importing corn from Oaxaca and grinding it in house to make their own tortillas, tostadas and chips. Sip a cocktail and order one of the botanas (snacks) like guacamole or Colombian bunuelos. Of course, tacos are a must and include fish and meat varieties. Whole market fish and beef to share are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2431%20Crabtree%20Blvd.%2C%20Ste.%20102%2C%20Raleigh%2C%20NC%2C%2027604%2C%20USA"
    pageTitle="Mala Pata"
  />
);

export default MalaPata;
