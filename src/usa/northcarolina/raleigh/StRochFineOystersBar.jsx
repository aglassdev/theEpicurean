...
const StRochFineOystersBar = () => (
  <RestaurantPage
    restaurantName="St. Roch Fine Oysters + Bar"
    address="223 S. Wilmington St., Raleigh, NC, 27601, USA"
    cuisine="Seafood"
    priceRange="$$$"
    phoneNumber="+19193220359"
    website="https://www.strochraleigh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a former clothing store in downtown Raleigh, this oyster bar and bistro retains some of its original features while sharing a new spirit. Chef/owner Sunny Gerhart's Louisiana roots inspire and inform the menu where, as should be expected, oysters play a big role. Find the resident shucker behind the counter prying open the daily selection from North Carolina and beyond. Not a fan of raw oysters? They're available fried, too, so be sure to start with a selection of these briny jewels. It's all about seafood here, where a Carolina calabash keeps things local, and their barbecue shrimp and grits is a weekend brunch signature. Finish with a plate of sugar-coated beignets in true Southern style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=223%20S.%20Wilmington%20St.%2C%20Raleigh%2C%20NC%2C%2027601%2C%20USA"
    pageTitle="St. Roch Fine Oysters + Bar"
  />
);

export default StRochFineOystersBar;
