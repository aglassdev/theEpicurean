...
const PrimeBarbecue = () => (
  <RestaurantPage
    restaurantName="Prime Barbecue"
    address="403 Knightdale Station Run, Knightdale, NC, 27545, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+19193738067"
    website="https://prime-bbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pitmaster Christopher Prieto relocated from his native Texas to North Carolina, setting up Prime Barbecue just outside Raleigh in Knightdale. You'll need to arrive early, be prepared to wait and know that once they've run out of food, they'll close for the day. Expect all of the classics, including brisket and ribs plus pulled pork, all sold by their weight or ordered as a meat and 2 with two scrumptious side dishes. Keep an eye out for their daily specials, especially on Saturday when they serve their chopped whole hog lechon. You won't be hungry, but a slice of pie or a banana pudding never hurt anyone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=403%20Knightdale%20Station%20Run%2C%20Knightdale%2C%20NC%2C%2027545%2C%20USA"
    pageTitle="Prime Barbecue"
  />
);

export default PrimeBarbecue;
