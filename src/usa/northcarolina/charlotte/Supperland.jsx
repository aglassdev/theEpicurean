...
const Supperland = () => (
  <RestaurantPage
    restaurantName="Supperland"
    address="1212 The Plaza, Charlotte, NC, 28205, USA"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+17048177514"
    website="https://supper.land/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You'll know you're in the right place when you smell the heady scent of smoke as you approach this Plaza Midwood restaurant. A former church, it's undergone an extensive restoration resulting in this stylish space. In case the oversized range fueled by wood didn't give it away, this is Southern barbecue-style cooking through and through. Expect prime meat and fish to be cooked over the glowing embers, while imaginative sides are equally worthy of attention. It's all served family style, and sharing is the name of the game here. While you're sharing, order their seasonal sundae with a spoon for all...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1212%20The%20Plaza%2C%20Charlotte%2C%20NC%2C%2028205%2C%20USA"
    pageTitle="Supperland"
  />
);

export default Supperland;
