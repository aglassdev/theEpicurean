...
const ChefsCounterAtMaass = () => (
  <RestaurantPage
    restaurantName="Chef's Counter at MAASS"
    address="525 N. Fort Lauderdale Beach Blvd., Fort Lauderdale, 33304, USA"
    cuisine="Contemporary, American"
    priceRange="$$$$"
    phoneNumber="+19542560000"
    website="https://www.maassftl.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Chef's Counter enjoys a prime spot inside the MAASS dining room at the Four Seasons Fort Lauderdale, and this stylish perch facing the large, open kitchen offers a distinctive dining experience. Chef Ryan Ratino's tasting menu, in the hands of Chef David Brito, is a beautiful tribute to contemporary cooking with French techniques, Japanese ingredients, and a few Florida highlights. Ingredients take center stage in courses like the single seared diver scallop over a truffle puree. Designed as an upmarket riff on chicken noodle soup, it's finished with a velvety broth. A delicate bowl of koshihikari rice cooked in a donabe with maitake mushroom and a Comté foam is excellent from start to finish. Finally, kakigori with candied nuts and fresh raspberries is a delightful conclusion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=525%20N.%20Fort%20Lauderdale%20Beach%20Blvd.%2C%20Fort%20Lauderdale%2C%2033304%2C%20USA"
    pageTitle="Chef's Counter at MAASS"
  />
);

export default ChefsCounterAtMaass;
