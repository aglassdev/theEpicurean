...
const HiyakawaMiami = () => (
  <RestaurantPage
    restaurantName="Hiyakawa Miami"
    address="2700 N. Miami Ave., #5, Miami, 33127, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$"
    phoneNumber="+13053332417"
    website="https://www.hiyakawamiami.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Is there a dining room cooler than Hiyakawa Miami? Probably not. Modern art hangs throughout the space that is art itself, with the counter and tables under an arch of backlit, undulating wood slats. This intimate stage glows at the bottom of an apartment building in trendy Wynwood.Top-quality seafood flown in from Japan and beyond meets creative flourishes like cured egg yolk and Okinawa salt. A multicourse omakase is available at the counter and in the dining room, and the a la carte offers a range of items in addition to nigiri, sashimi, and maki. Don't sleep on the Sakana Kara Age, or fried fish fillets sprinkled with seaweed salt and resting in a fish broth, but it's the lamb chops, doubling as performance art thanks to a bed of burning rosemary, that make a lasting impression...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2700%20N.%20Miami%20Ave.%2C%20%235%2C%20Miami%2C%2033127%2C%20USA"
    pageTitle="Hiyakawa Miami"
  />
);

export default HiyakawaMiami;
