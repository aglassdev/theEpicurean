...
const GrandCentral = () => (
  <RestaurantPage
    restaurantName="Grand Central"
    address="7919 Biscayne Blvd., Miami, 33138, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+13054563088"
    website="https://www.grand-central.miami/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed.This narrow nook of a restaurant by Chef Nuno Grullon hides in plain sight along Biscayne Boulevard. The unassuming location runs in stark contrast to what’s happening in this friendly dining room set with white tablecloths and a bar that stretches the length of the room. Warm buttermilk biscuits garnished with thyme are a welcome start, followed by an eclectic roster of bistro dishes that show wonderful levels of care and thought. Pan-fried baby artichokes are a delightful pairing with pancetta hollandaise. Chicken pot pie gets a makeover with heritage chicken and black truffles, and there’s even a lavish duck pithivier finished with cranberry demi. Dessert hits all the right notes with a proper chocolate ganache cake that is all too easy to fin..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7919%20Biscayne%20Blvd.%2C%20Miami%2C%2033138%2C%20USA"
    pageTitle="Grand Central"
  />
);
