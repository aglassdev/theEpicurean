...
const HometownBarbecueMiami = () => (
  <RestaurantPage
    restaurantName="Hometown Barbecue Miami"
    address="1200 N.W. 22nd St., #100, Miami, 33142, USA"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+13053964551"
    website="https://hometownbbqmiami.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From Austin, Texas to Brooklyn, New York, Pitmaster Bill Durney brings his signature barbecue to Magic City. Just like the original location, Durney has built this warehouse-chic space amidst a sea of industry in the Miami Produce Center, where trucks and moving pallets roam the streets. The sheer scale of the space—open kitchen on one side, a long bar on the other, tables in between and a patio just beyond—is something to behold.A hulking beef rib crusted with salt and black pepper, as well as melting, charred slices of brisket are essential orders that have few equals outside of Texas. Satisfying sides, like Frito pie, plancha broccoli and charred summer corn, round out the meal. The food here arrives almost as quickly as it’s ordered, so come hungry...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1200%20N.W.%2022nd%20St.%2C%20%23100%2C%20Miami%2C%2033142%2C%20USA"
    pageTitle="Hometown Barbecue Miami"
  />
);

export default HometownBarbecueMiami;
