...
const MandolinAegeanBistro = () => (
  <RestaurantPage
    restaurantName="Mandolin Aegean Bistro"
    address="4312 N.E. 2nd Ave., Miami, 33137, USA"
    cuisine="Mediterranean Cuisine, Turkish"
    priceRange="$$"
    phoneNumber="+13057499140"
    website="https://www.mandolinrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded by Ahmet Erkaya and Anastasia Koutsioukis, this charming bistro welcomes diners with a blue door and whitewashed façade. The space features wood tables, lacquered chairs and an outdoor bar, although the focus is on its courtyard dining area, enhanced with mature trees, orchids and electric fans. This mezze-heavy menu may unveil a creamy slab of baked feta with diced tomato, smoked chili flakes and Turkish peppers. Slices of house-baked bread, stuffed into small brown paper bags, accompany the excellent small plates. Salads, a grilled catch-of-the-day sandwich and larger items, like moussaka, are equally beloved.A wedge of honey pie with a salted shortbread crust is highly recommended, and pairs delightfully with that Turkish coffee...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4312%20N.E.%202nd%20Ave.%2C%20Miami%2C%2033137%2C%20USA"
    pageTitle="Mandolin Aegean Bistro"
  />
);

export default MandolinAegeanBistro;
