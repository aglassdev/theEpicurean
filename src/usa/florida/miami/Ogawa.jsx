...
const Ogawa = () => (
  <RestaurantPage
    restaurantName="Ogawa"
    address="7223 N.W. 2nd Ave., Miami, 33150, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber=""
    website="https://www.ogawamiami.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a nod to the Little River neighborhood that it calls home, Ogawa translates to small river. Chef/co-owner Masayuki Komatsu commands a presence with an omakase that stuns with a series of enticing cooked dishes and a procession of focused and skillful nigiri. From baby sea eels with a soy-cured quail egg and bigfin reef squid in a shiso-miso sauce to baby snow crab and Japanese-style herring roe, this appetizer of four bites is the first sign that this isn't your typical sushi counter. Then, lotus root, wild yam and langoustine tempura is sided by a thick sauce made from roasted langoustine shells. After the cooked dishes, nigiri comes next with bright and balanced kisu, creamy ebodai, squid topped with osetra caviar and anago dusted with sansho pepper exemplifying the chef's skill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7223%20N.W.%202nd%20Ave.%2C%20Miami%2C%2033150%2C%20USA"
    pageTitle="Ogawa"
  />
);

export default Ogawa;
