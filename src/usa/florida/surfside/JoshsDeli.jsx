...
const JoshsDeli = () => (
  <RestaurantPage
    restaurantName="Josh's Deli"
    address="9517 Harding Ave., Surfside, 33154, USA"
    cuisine="Deli"
    priceRange="$"
    phoneNumber="+13053978494"
    website="https://Joshsdeli.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Josh Marcus is the namesake behind this Surfside deli. Nestled on a busy street and flanked by tables out on the sidewalk, the interior—albeit small—is quaint and laid-back, featuring a counter with views of the open kitchen. The compact menu is a veritable tome of interesting and original takes on deli classics. Meat and fish are cured in house, but make no mistake, the team doesn't take themselves too seriously. Jewban is a playful, Jewish-inspired version of the Cuban; and starters, like latkes, arrive topped with spicy tuna and sriracha-cream cheese. From there, expect a few platters, pancakes done in various ways and meat-focused sandwiches—corned beef, anyone?Service can be a bit hit or miss but with food this good, nobody minds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9517%20Harding%20Ave.%2C%20Surfside%2C%2033154%2C%20USA"
    pageTitle="Josh's Deli"
  />
);

export default JoshsDeli;
