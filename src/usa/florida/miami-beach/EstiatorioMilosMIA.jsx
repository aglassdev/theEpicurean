...
const EstiatorioMilosMIA = () => (
  <RestaurantPage
    restaurantName="Estiatorio Milos"
    address="730 1st St., Miami Beach, 33139, USA"
    cuisine="Greek"
    priceRange="$$$"
    phoneNumber="+13056046800"
    website="https://www.estiatoriomilos.com/restaurant/miami/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Greek God has been a beacon of seafood excellence for the glamorous diners of South Beach since opening its doors in 2012. Some don’t even need a menu and prefer to order based on a guided tour to the back, where all manner of fish and crustaceans gleam on packed ice.With fresh seafood arriving multiple times a week, the kitchen tends to keep preparations simple. Sashimi of any type is a good first step, though we’re partial to the bigeye tuna with yuzu kosho and dill. Thin slices of fried zucchini and eggplant mounded around creamy tzatziki are also worth an order. Grilled whole fish baked in salt, and large lobsters round out the feast, though big spenders should inquire about deep-sea prawns for a pricey but precious seafood luxury...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=730%201st%20St.%2C%20Miami%20Beach%2C%2033139%2C%20USA"
    pageTitle="Estiatorio Milos"
  />
);

export default EstiatorioMilosMIA;
