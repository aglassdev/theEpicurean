...
const ChuanFu = () => (
  <RestaurantPage
    restaurantName="Chuan Fu"
    address="1035 N. Orlando Ave., Ste. 105, Winter Park, 32789, USA"
    cuisine="Chinese, Sichuan"
    priceRange="$$"
    phoneNumber="+13219723606"
    website="https://www.chuanfuorlando.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sleek Winter Park spot is elegant and polished but never feels stuffy thanks to warm service that shows genuine consideration for each guest. The large Szechuan menu features many of the classics served in a traditional family-style manner, and the solid cooking shows its skill with layered flavors and bold takes. First, tuck into the cucumber salad, with its punch of soy and garlic, before settling into the Chongqing chicken with its chili and peanut garnish. A bowl of flaky white fish in a savory broth loaded with vegetables, pickled cabbage and glass noodles is further proof that heat and spice are balanced nicely here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1035%20N.%20Orlando%20Ave.%2C%20Ste.%20105%2C%20Winter%20Park%2C%2032789%2C%20USA"
    pageTitle="Chuan Fu"
  />
);

export default ChuanFu;
