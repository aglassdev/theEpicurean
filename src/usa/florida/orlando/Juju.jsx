...
const Juju = () => (
  <RestaurantPage
    restaurantName="Juju"
    address="700 Maguire Blvd., Orlando, 32803, USA"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+14077784813"
    website="https://susuruorl.com/juju-restaurant"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=700%20Maguire%20Blvd.%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Juju"
  />
);
