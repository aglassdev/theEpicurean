...
const Domu = () => (
  <RestaurantPage
    restaurantName="Domu"
    address="3201 Corrine Dr., #100, Orlando, 32803, USA"
    cuisine="Ramen, Japanese"
    priceRange="$$"
    phoneNumber="+14079601228"
    website="https://domufl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enter Chef/owner Sean Sonny Nguyen's trendy ramen haven and you'll find two rooms dressed with concrete floors, a marble bar and wood panels set aglow by a starburst light fixture. The second room cradles the bulk of the crowd. As the name illustrates, this chef makes his culinary dreams come true by dint of a classic-meets-creative menu. Beyond the small plates lies the star item—ramen. Creations, like the Ritchie Rich and Curry, are full of bold, memorable flavors and certainly worth a slurp. Tokyo ramen with shoyu chicken broth, fried chicken thigh and duck fat is a sensory feat. Couple it with blistered shishitos for a delicious touch—and bit of crunch.It's all in the family here as sib Tori Tori flaunts a similarly creative izakaya menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3201%20Corrine%20Dr.%2C%20%23100%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Domu"
  />
);
