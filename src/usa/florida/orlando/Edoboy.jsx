...
const Edoboy = () => (
  <RestaurantPage
    restaurantName="Edoboy"
    address="728 N. Thornton Ave., Orlando, 32803, USA"
    cuisine="Sushi"
    priceRange="$$$"
    phoneNumber=""
    ...
    bio="From the same team behind Tori Tori and Domu, this casual concept delivers something sleek and simple—a standing sushi counter. It's not a gimmick, it's designed to be fast and fun, and it's a perfect place to bring friends. Be sure to arrive promptly, since you're given a set time slot and you'll be whisked into the space at the start of yours. Once there you'll select a dozen pieces from the selection of nigiri, seared nigiri and hand rolls. Some of the best bites include a sweet Hokkaido scallop finished with briny uni from Tasmania; seared sea bream with uni butter, lemon and sea salt; and spicy Faroe Island salmon with edo sauce, cucumber and fried garlic rolled in crispy nori. Dinner is rounded out with miso soup made in house from the bones and trimmings of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=728%20N.%20Thornton%20Ave.%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Edoboy"
  />
);

export default Edoboy;
