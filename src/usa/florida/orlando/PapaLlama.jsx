...
const PapaLlama = () => (
  <RestaurantPage
    restaurantName="Papa Llama"
    address="2840 Curry Ford Rd., Orlando, 32806, USA"
    cuisine="Peruvian, Contemporary"
    priceRange="$$$$"
    phoneNumber=""
    website="https://www.papallamaorl.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2840%20Curry%20Ford%20Rd.%2C%20Orlando%2C%2032806%2C%20USA"
    pageTitle="Papa Llama"
  />
);

export default PapaLlama;
