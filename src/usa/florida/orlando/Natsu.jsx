...
const Natsu = () => (
  <RestaurantPage
    restaurantName="Natsu"
    address="777 N. Orange Ave., Ste. C, Orlando, 32801, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+14072865744"
    website="https://www.natsuomakase.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At Natsu, there are just two seatings a night at this omakase, where an intimate counter dominates a spartan-styled room. Meals begin with four dishes from the kitchen, including chawanmushi and truffle kampachi, served with crispy potato straws and a yuzu truffle vinaigrette for an unexpected flavor combination that is especially memorable. The sushi is impressive and doesn't gild the lily, as in skin-on barracuda with a dynamic char or soy-marinated salmon that finishes ever-so-sweetly. Supremely buttery toro needs no flourish and is melt-in-your-mouth tender. It all rounds out with a hand roll and ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=777%20N.%20Orange%20Ave.%2C%20Ste.%20C%2C%20Orlando%2C%2032801%2C%20USA"
    pageTitle="Natsu"
  />
);
