...
const BlackRoosterTaqueria = () => (
  <RestaurantPage
    restaurantName="Black Rooster Taqueria"
    address="1323 N. Mills Ave., Orlando, 32803, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+14076010994"
    website="https://www.blackroostertaqueria.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Mills area dining den is brought to you by husband and wife team, John and Juliana Calloway. The space is compact and industrial with a smattering of local artwork and refurbished furniture, including sleek tables crafted by the chef himself. Colorful booths and a striking black rooster painted on the wall put patrons in the mood for correspondingly vibrant and eclectic taqueria food.Farm to taco is their ethos, and every item packs a wallop of flavor peppered with creativity. A recent favorite included the slow-roasted pork achiote taco, crowned with pickled onion, cilantro and spicy habanero salsa. The smoked greens taco—with ricotta, shiitake mushrooms and crispy onions—has vegetarians coming in droves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1323%20N.%20Mills%20Ave.%2C%20Orlando%2C%2032803%2C%20USA"
    pageTitle="Black Rooster Taqueria"
  />
);

export default BlackRoosterTaqueria;
