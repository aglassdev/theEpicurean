...
const Citricos = () => (
  <RestaurantPage
    restaurantName="Cítricos"
    address="4401 Floridian Way, Orlando, 32830, USA"
    cuisine="American, Regional Cuisine"
    priceRange="$$$$"
    phoneNumber="+14079393463"
    website="https://disneyworld.disney.go.com/dining/grand-floridian-resort-and-spa/citricos/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on the second floor of the Grand Floridian Hotel, Citricos brings to life a gloriously contemporary vibe and décor elements that are a subtle nod to Mary Poppins. The menu is coastal American, as evidenced by the use of seafood, citrus and tropical fruit. The team has a refined cooking style, replete with balanced flavors and technical prowess.While the carte is seasonal, expect the likes of corn bisque whimsically arranged with pickled fennel and popcorn. Crispy smoked duck is finished with salt and gently set atop a tangle of tagliatelle with celeriac purée. Up next might be guava-braised short ribs with cheddar grits and poblano sauce, leaving you full to the brim. Save room for at least one exquisite dessert—like an orange blossom flan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4401%20Floridian%20Way%2C%20Orlando%2C%2032830%2C%20USA"
    pageTitle="Cítricos"
  />
);
