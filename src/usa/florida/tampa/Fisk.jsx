...
const Fisk = () => (
  <RestaurantPage
    restaurantName="Fisk"
    address="1202 N. Franklin St., Tampa, 33602, USA"
    cuisine="Scandinavian, Seafood"
    priceRange="$$$"
    phoneNumber="+18132848276"
    website="https://www.fiskebbe.com/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a glimpse into the excellence that awaits at Ebbe, snag a seat at this relaxed, handsome bar concept which shares the same front door and kitchen. Seafood with Swedish and global touches forms the heart of a menu that offers both a concise tasting as well as easy à la carte ordering. You might consider making a meal out of lighter bites, starting with Alaskan smoked salmon prepared as an éclair or, perhaps, crab salad with pink grapefruit and grilled avocado. Meatballs and schnitzel are tempting entrees, but do not miss the fish soup. Made with excellent stock, fennel, and just a touch of cream, it is a comforting masterclass in balance and finesse. Those who really love rum will find a friend in the boozy baba au rhum...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1202%20N.%20Franklin%20St.%2C%20Tampa%2C%2033602%2C%20USA"
    pageTitle="Fisk"
  />
);
