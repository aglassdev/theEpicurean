...
const Predalina = () => (
  <RestaurantPage
    restaurantName="Predalina"
    address="1001 E. Cumberland Ave., Tampa, 33602, USA"
    cuisine="Mediterranean Cuisine"
    priceRange="$$$"
    phoneNumber="+18133443442"
    website="https://predalina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Channelside District of downtown Tampa, siblings Blake Casper and Allison Casper Adams founded Predalina as an homage to their great-grandmother's coastal heritage (she was born in Brazil, raised in Portugal and finally settled in Rhode Island).The large menu is a nod to the Mediterranean, beginning with a wide variety of mezzes (the blistered cauliflower surrounded by whipped tahini is a winner). Lunch offers a nice mix of sandwiches and salads, while dinner is squarely focused on entrées and pastas. The tomato calamarata looks every bit the calamari it's named for, and dressed with a chunky, herb-laced tomato sauce and delicious kefalograviera, or Greek sheep's milk cheese, it's a satisfying dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1001%20E.%20Cumberland%20Ave.%2C%20Tampa%2C%2033602%2C%20USA"
    pageTitle="Predalina"
  />
);

export default Predalina;
