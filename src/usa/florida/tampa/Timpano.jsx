...
const Timpano = () => (
  <RestaurantPage
    restaurantName="Timpano"
    address="1610 W. Swann Ave., Tampa, 33606, USA"
    cuisine="Italian-American"
    priceRange="$$"
    phoneNumber="+18132545870"
    website="https://www.timpanohydepark.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a chic redesign, this longtime Hyde Park Village staple stands out even in its stylish surrounds. The verdant space calls to mind the tropics and a clubby playlist adds an air of youthfulness, but this is solid cooking rooted in classic Italian American sensibilities.A well-appointed bar pours enticing quaffs like a frozen blood orange negroni, which also makes for a winning aperitivo. Red-sauce staples, like sausage-stuffed mushrooms and fried calamari are deftly prepared, and tailed by house pastas given their proper due. A raviolo filled with spinach, ricotta and molten egg yolk is dressed with frisée and a bit of balsamic; and, forgiving the pun, a “parm to table” bucatini al pesto prepared tableside in a wheel of Parmigiano is sure to please...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1610%20W.%20Swann%20Ave.%2C%20Tampa%2C%2033606%2C%20USA"
    pageTitle="Timpano"
  />
);

export default Timpano;
