...
const Wildflower = () => (
  <RestaurantPage
    restaurantName="Wildflower"
    address="3638 Navajo St., Denver, CO, 80211, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+17203727999"
    website="https://www.wildflower-lohi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked inside the Gravity Haus hotel in the LoHi district, step past two sets of doors to find this moody-eclectic spot with a vintage vibe and a contemporary, plant-forward menu. Whether you order a la carte or choose a customizable tasting menu, expect bold and creative dishes with plenty of personality and character. Take the butternut squash soup that's far from a typical bowl. Here, butter-poached Dungeness crab takes center stage in a bowl with a ginger and pepita crumble and sunchoke chips, plus a tableside pour of soup. Salmon is sided by a crispy fennel cake with sunchoke puree and roasted fennel slices for a beautiful, tempting plate. Dessert impresses with honey semifreddo, Marsala foam, toasted oats and honeycomb brittle for a distinctive finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3638%20Navajo%20St.%2C%20Denver%2C%20CO%2C%2080211%2C%20USA"
    pageTitle="Wildflower"
  />
);
