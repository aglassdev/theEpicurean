...
const LaDiablaPozoleYMezcal = () => (
  <RestaurantPage
    restaurantName="La Diabla Pozole y Mezcal"
    address="2233 Larimer St., Denver, 80205, USA"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+17208274158"
    website="https://www.ladiabladenver.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2233%20Larimer%20St.%2C%20Denver%2C%2080205%2C%20USA"
    pageTitle="La Diabla Pozole y Mezcal"
  />
);

export default LaDiablaPozoleYMezcal;
