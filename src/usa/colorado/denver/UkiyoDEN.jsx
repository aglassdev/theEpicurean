...
const UkiyoDEN = () => (
  <RestaurantPage
    ...
    address="1317 14th St., Ste. 0, Denver, CO, 80202, USA"
    cuisine="Japanese, Fusion"
    priceRange="$$$$"
    phoneNumber="+17209491345"
    website="https://ukiyoomakase.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked in the basement of a restaurant and only accessible through an unmarked alleyway door, Ukiyo has a classic speakeasy feel. With just two seatings nightly, this secretive spot serves a multicourse tasting menu rooted in Japanese technique but layered with bold influences from Southeast Asian and Peruvian cuisines. Global influences are seen in starters like focaccia bread with tom yum butter and dishes like raw black seabass with Peruvian pepper sauce atop a shiso leaf. Nigiri is at once traditional (think otoro with scallion and ginger) and iconoclastic (minced chicken with lemongrass and lime leaf), and while the menu shifts often, apple pie, a rose-like arrangement of roasted apples over a macadamia nut crumble with a scoop of uni ice cream, was a recent highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1317%2014th%20St.%2C%20Ste.%200%2C%20Denver%2C%20CO%2C%2080202%2C%20USA"
    pageTitle="Ukiyo"
  />
);

export default UkiyoDEN;
