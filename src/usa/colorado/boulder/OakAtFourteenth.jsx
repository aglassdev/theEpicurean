...
const OakAtFourteenth = () => (
  <RestaurantPage
    restaurantName="Oak at Fourteenth"
    address="1400 Pearl St., Boulder, 80302, USA"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+13034443622"
    website="https://www.oakatfourteenth.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Smack dab in the heart of charming downtown Boulder, Oak at Fourteenth invites guests to settle in to a space where light wood floors, white walls and a minimalist design aesthetic set a modern tone. The kitchen echoes the contemporary mindset with a hearty menu focused on meat, but with equal care shown to vegetarian dishes. To begin, a vibrant disc of beet tartare is served with mustard ice cream and a beet-colored rice cracker for a dramatic start. Rotisserie chicken with a green apple and celery root slaw is a go-to, but save room for a slice of their peanut butter tart. With its thick cookie crust, thin layer of cherry gelee and a quenelle of celery sorbet balanced on chopped peanuts, it's a nod to that childhood classic: ants on a log...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1400%20Pearl%20St.%2C%20Boulder%2C%2080302%2C%20USA"
    pageTitle="Oak at Fourteenth"
  />
);

export default OakAtFourteenth;
