...
const ProspectASP = () => (
  <RestaurantPage
    restaurantName="Prospect"
    address="Hotel Jerome, Auberge Collection, 330 E. Main St., Aspen, CO, 81611, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+19704297610"
    website="https://auberge.com/hotel-jerome/dine/prospect/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the swanky, thoroughly photogenic Hotel Jerome, Prospect offers its own breezy take on Aspen dining. The colorful, eclectic space provides the setting for seasonal cuisine that utilizes ingredients from local producers three meals a day, with approachable à la carte offerings. Breakfast highlights American classics like a bagel with cream cheese and house-smoked salmon, or chicken-fried steak, while lunch and dinner lean Mediterranean, with the likes of lumache pasta with pesto and stracciatella cheese, or Colorado lamb loin with caponata and babaganoush. A well-appointed bar provides an assortment of libations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Jerome%2C%20Auberge%20Collection%2C%20330%20E.%20Main%20St.%2C%20Aspen%2C%20CO%2C%2081611%2C%20USA"
    pageTitle="Prospect"
  />
);

export default ProspectASP;
