...
const SplendidoAtTheChateau = () => (
  <RestaurantPage
    restaurantName="Splendido at the Chateau"
    address="17 Chateau Ln., Beaver Creek, 81620, USA"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+19708458808"
    website="https://splendidorestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You might think the name lays things on a bit thick, but the setting is as grand and as comfortable as could be hoped for, and the warm, attentive service is sure to make you feel like royalty. Looking beyond the glamorous environs, you'll find a thoughtful menu overseen by longtime chef Brian Ackerman, which straddles the line between creative and classic, seen in a pomegranate-marinated rack of Colorado lamb. Dover sole, pan-seared before being adroitly filleted tableside and served with brown butter beurre blanc, is a menu staple for good reason. End with an airy soufflé, or opt for something a bit more nostalgic, like a chocolate and peanut butter pave...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Chateau%20Ln.%2C%20Beaver%20Creek%2C%2081620%2C%20USA"
    pageTitle="Splendido at the Chateau"
  />
);

export default SplendidoAtTheChateau;
