...
const MirabelleBEA = () => (
  <RestaurantPage
    ...
    address="55 Village Rd., Beaver Creek, 81620, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+19709497728"
    website="https://mirabelle1.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just past the entrance to the Beaver Creek Resort, in a picturesque turn-of-the-century ranch house (built by homesteaders in 1898), this local staple is the residence of longtime Chef Daniel Joly and his family, which helps to explain its homey, inviting charm. Chef Joly brings his European training to bear on comforting classics like lobster bisque, as well as indulgences like seared foie gras with caramelized peaches and Speculoos crumble; an order of frites with Dijon-spiked mayonnaise, a nod to his Belgian roots, is also a must. Portions are generous, but saving room for dessert should be considered non-negotiable, considering such offerings as a delicate, panna cotta-like roasted apricot posset with hazelnut crumble and rosemary tuile...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Village%20Rd.%2C%20Beaver%20Creek%2C%2081620%2C%20USA"
    pageTitle="Mirabelle"
  />
);

export default MirabelleBEA;
