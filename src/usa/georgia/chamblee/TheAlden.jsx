...
const TheAlden = () => (
  <RestaurantPage
    restaurantName="The Alden"
    address="5070 Peachtree Blvd., Ste. B-140, Chamblee, 30341, USA"
    cuisine="American, Contemporary"
    priceRange="$$$$"
    phoneNumber="+16783956982"
    website="https://thealdenrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Warm, attentive service and a sexy, upscale dining room make The Alden a natural choice for a night out. It's the kind of place where plush leather banquettes invite guests to linger a bit longer. Atlanta native Chef Jared Hucks is running the show, and his vision internationally inspired cooking is unique. Some dishes might not read regional, but local ingredients and flair ensure pride of place. Case in point? The deliciously gamey knobs of lamb bathed in a white gravy with pink peppercorns. Hot and sour red snapper is Asian inspired but locally sourced, resulting in an elegant but approachable dish. Finish with ruby red grapefruit curd over tandoori shortbread crumbs sided by a scoop of vanilla gelato with beet-hibiscus sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5070%20Peachtree%20Blvd.%2C%20Ste.%20B-140%2C%20Chamblee%2C%2030341%2C%20USA"
    pageTitle="The Alden"
  />
);

export default TheAlden;
