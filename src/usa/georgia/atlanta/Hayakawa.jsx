...
const Hayakawa = () => (
  <RestaurantPage
    restaurantName="Hayakawa"
    address="1055 Howell Mill Rd., Atlanta, 30318, USA"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+17709860010"
    website="https://www.hayakawaatl.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A local legend for his Japanese cuisine on Buford Highway, Chef Atsushi Hayakawa has begun a new chapter in West Midtown. Located in a sparkling office structure, the slick lair hosts a mere handful of diners per seating. His stage is a backdrop of dark-streaked stone and a silken wood counter; and the use of a microphone to banter with guests amplifies Hayakawa's buoyant personality.Rotating with the seasons and changing weekly, the meal is a procession of small courses and hews toward the structure of kaiseki. After items such as an appetizer trio with clear fish soup, scallop sashimi with miso-mustard sauce and simmered monkfish, it's time for sushi. The chef crafts nigiri from imported fish that needs little embellishment and is amply sized in the tradition of Hokkaido style in deferen..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1055%20Howell%20Mill%20Rd.%2C%20Atlanta%2C%2030318%2C%20USA"
    pageTitle="Hayakawa"
  />
);

export default Hayakawa;
