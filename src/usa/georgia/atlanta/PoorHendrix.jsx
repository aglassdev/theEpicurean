...
const PoorHendrix = () => (
  <RestaurantPage
    restaurantName="Poor Hendrix"
    address="2371 Hosea L. Williams Dr. NE, Atlanta, 30317, USA"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+14045498756"
    website="https://www.poorhendrix.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While it looks like your average corner restaurant, Poor Hendrix is so much more. It's all about the vibe at this intimate, slightly quirky spot. It’s first come first serve, and the menu changes daily with new specials that you'll want to check out (seared trout over couscous, perhaps?). Expect contemporary, updated bar food with Southern and Asian elements. Don't expect a fuss, since they don't take themselves too seriously. You'll feast on dishes like shrimp skewers dusted with a barbecue rub and served with a white Alabama-style barbecue sauce, and refreshing cold spicy peanut noodles with just the right kick. Even their cocktails hit the spot and fit perfectly at the bar, in the dining room or on their back patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2371%20Hosea%20L.%20Williams%20Dr.%20NE%2C%20Atlanta%2C%2030317%2C%20USA"
    pageTitle="Poor Hendrix"
  />
);

export default PoorHendrix;
