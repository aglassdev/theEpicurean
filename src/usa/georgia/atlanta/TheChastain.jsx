...
const TheChastain = () => (
  <RestaurantPage
    restaurantName="The Chastain"
    address="4320 Powers Ferry Rd., Atlanta, 30342, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+14042576416"
    website="https://thechastainatl.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on the verdant edges of Chastain Park and surrounded by trees, this restaurant feels like a modern oasis with charming details (think butterscotch leather booths, exposed brick elements and gas lamps). The setting is stunning, reminding one of a restored carriage house, but Chef Christopher Grossman's seasonally focused American menu with Southern nods is a solid match.  Wondering what to order? You won't go wrong with the beer-battered Dover Sole with sauce gribiche and arugula fennel salad. Mac and cheese is a perfect side, and don't skip dessert, especially the apple-pecan frangipane tart with orange blossom cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4320%20Powers%20Ferry%20Rd.%2C%20Atlanta%2C%2030342%2C%20USA"
    pageTitle="The Chastain"
  />
);

export default TheChastain;
