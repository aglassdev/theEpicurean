...
const HanIlKwan = () => (
  <RestaurantPage
    restaurantName="Han Il Kwan"
    address="5458 Buford Hwy. NE, Atlanta, 30340, USA"
    cuisine="Korean"
    priceRange="$$"
    phoneNumber="+17704573217"
    website="https://www.hanilkwanatl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on Buford Highway in Doraville, the setting stands out with its standalone structure and pagoda roof. The large dining area is bright and well maintained, and offers a variety of seating areas including a section with tabletop grills. Tiled flooring, wood furnishings and a beamed roof produce a pleasant arena.The menu covers the delights of Korean cuisine, from appetizers like haemul-pajeon, the crispy pancake studded with vegetables and seafood; to stimulating stews like the kimchi jjigae served bubbling hot with strips of pork belly and cubes of soft tofu. And then there's barbecue, with an array of sliced and marinated certified Angus beef on offer; or one can choose the vegetable platter option. Come hungry or bring a crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5458%20Buford%20Hwy.%20NE%2C%20Atlanta%2C%2030340%2C%20USA"
    pageTitle="Han Il Kwan"
  />
);

export default HanIlKwan;
