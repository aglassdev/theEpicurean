...
const Boccalupo = () => (
  <RestaurantPage
    restaurantName="BoccaLupo"
    address="753 Edgewood Ave. NE, Atlanta, 30307, USA"
    cuisine="Italian-American"
    priceRange="$$$"
    phoneNumber="+14045772332"
    website="http://boccalupoatl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What's not to love about a place that doesn't take itself too seriously yet cares deeply about their food? Chef/owner Bruce Logue is at the helm of this cute and casual spot  where smart cooking and modern takes on Italian-American classics lure a steady stream of regulars. It's comfort food at its best (think Southern fried chicken parm with pasta and creamy collards). Order a la carte or tuck in to a four-course tasting menu, with pasta tagging along on the savory courses. Fresh, local produce stars in many of the dishes like garganelli pasta with seared scallops and sugar snap peas in a tomato water sauce. Quirky cocktails, such as What are you, the police? are conversation starters (it's a gin-based milk punch clarified with Greek yogurt)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=753%20Edgewood%20Ave.%20NE%2C%20Atlanta%2C%2030307%2C%20USA"
    pageTitle="BoccaLupo"
  />
);

export default Boccalupo;
