...
const Fishmonger = () => (
  <RestaurantPage
    restaurantName="Fishmonger"
    address="674 N. Highland Ave. NE, Atlanta, 30306, USA"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+16787059358"
    website="https://fishmongergroup.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's part fish market, part casual restaurant here, where a single communal table and stools lined up at the windows await guests. Order at the back counter from a compact, seafood-focused menu listing oysters, crudos, sandwiches and soups. This is not your typical fried fish shack, though, and many of the dishes have a Southern slant to them. Peel and eat shrimp is a good standby, while tuna melts level up. Specials are always a good bet, but the house staple—the blackened grouper sandwich—is a winner. A thick piece of generously spiced, blackened grouper is draped over a buttered, toasted seeded bun with Florida sauce, pickled peppers, ripe tomato and lettuce for something far from fussy but totally spot on. Gumbo is flavorful and hearty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=674%20N.%20Highland%20Ave.%20NE%2C%20Atlanta%2C%2030306%2C%20USA"
    pageTitle="Fishmonger"
  />
);
