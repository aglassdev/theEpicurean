...
const LuckyStar = () => (
  <RestaurantPage
    restaurantName="Lucky Star"
    address="1050 Howell Mill Rd., Ste. 110, Atlanta, GA, 30318, USA"
    cuisine="Taiwanese, Taiwanese contemporary"
    priceRange="$"
    phoneNumber="+16789946016"
    website="https://www.luckystaratl.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lucky Star, located inside the lobby of Atlanta’s Star Metals office complex, is a two-in-one concept kitted out with green velvet couches and a stylish appeal. By day, it's a café pouring coffee and serving pastries and Taiwanese fare. Then, when the sun goes down, it flips into a cocktail bar with a focused à la carte menu. Breakfast sandwiches, noodles, French toast and house-made pastries make appearances on the brunch menu, while oyster omelets and rice bowls, along with a small but fun dessert section that includes mochi “dumplings” and a strawberry cheesecake cookie, show up throughout the day. A house-made scallion pancake stuffed with braised beef shank is a tasty treat any time of day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1050%20Howell%20Mill%20Rd.%2C%20Ste.%20110%2C%20Atlanta%2C%20GA%2C%2030318%2C%20USA"
    pageTitle="Lucky Star"
  />
);
