...
const ChaiPani = () => (
  <RestaurantPage
    restaurantName="Chai Pani"
    address="406 W. Ponce De Leon Ave., Decatur, 30030, USA"
    cuisine="Indian, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+14043784032"
    website="https://www.chaipani.com/decatur"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Decatur's Chai Pani is a festive place, where strings of lights and colorful artwork keep things high spirited, and the kitchen looks to locally sourced ingredients to create the seasonally minded South Asian dishes. The versatile menu is detailed with enticing descriptions that may just to convince you to try one more dish, and there are plenty of options for family-style dining. Whether dining a deux or with a group, enjoy the likes of butter chicken, that deliciously rich staple of boneless chicken in a tomato-cream butter sauce, or fried okra, with its ever so easy to eat lightly seasoned shards. Gobi pepper fry, a popular hybrid Chinese and Indian dish, is given a unique slant here with battered cauliflower that's both tart and spicy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=406%20W.%20Ponce%20De%20Leon%20Ave.%2C%20Decatur%2C%2030030%2C%20USA"
    pageTitle="Chai Pani"
  />
);

export default ChaiPani;
