...
const Micheles = () => (
  <RestaurantPage
    restaurantName="Michele's"
    address="1201 K St. NW, Washington, 20005, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+12027580895"
    website="https://www.michelesdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It would be a mistake to write off Chef Matt Baker’s brasserie, named after the chef’s late mother and inspired by his upbringing in Houston and New Orleans, as just another hotel restaurant. Instead, this spot in the Eaton Hotel, tempts with American dishes punctuated with French touches. Appetizers range from NOLA-style roasted oysters and beef tartare to crispy chicken wings, while handhelds like smashburgers and Nashville hot chicken are standbys. A large bowl filled with pozole is a cure for a cold winter's night, while pan-seared crab cakes with Old Bay remoulade and a side salad makes a nice meal. Main dishes dial up the comfort with offerings like roasted half chicken and crawfish linguine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1201%20K%20St.%20NW%2C%20Washington%2C%2020005%2C%20USA"
    pageTitle="Michele's"
  />
);

export default Micheles;
