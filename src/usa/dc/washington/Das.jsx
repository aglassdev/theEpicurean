...
const Das = () => (
  <RestaurantPage
    restaurantName="Das"
    address="1201 28th St. NW, Washington, 20007, USA"
    cuisine="Ethiopian, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+12023334710"
    website="https://www.dasethiopian.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled inside a classic Georgetown townhouse, Das is a haven of soothing colors and lush fabrics. Great care has gone into its styling, and the warm, generous spirit of the staff ensures that the entire experience is every bit as pleasant and refined.The impressive menu runs the gamut from traditional Ethiopian cuisine to dishes that have the potential to take even the most seasoned and ambitious palate by surprise. Vegetarians have plenty of options, though the flaxseed telba wat, a puree of roasted flaxseeds cooked in a spicy sauce, is a winner. For a meal that won’t disappoint, order the chicken and beef combination sampler, then use the delicious injera to dig into mouthful after flavorful mouthful of surprisingly varied textures and degrees of heat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1201%2028th%20St.%20NW%2C%20Washington%2C%2020007%2C%20USA"
    pageTitle="Das"
  />
);
