...
const PattyOsCafeBakery = () => (
  <RestaurantPage
    restaurantName="Patty O's Cafe & Bakery"
    address="389 Main St., Washington, DC, 22747, USA"
    cuisine="European"
    priceRange="$$$"
    phoneNumber="+15406753801"
    website="https://www.pattyoscafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is casual as done by the meticulous chef Patrick O'Connell (of the Inn at Little Washington) whose latest project is a cafe and bakery located in a converted 1950s garage. The setting now sports a white-painted brick exterior and al fresco dining; while inside it's all country chic with an inviting marble bar counter, cozy wood tables, beamed ceiling and walls enhanced with still life canvases - all warmed by a stone-fronted fireplace.The menu offers broad appeal and all of it is executed with finesse. A sandwich of shaved Champagne-brined ham and Comté cheese on a pillowy onion roll is a lovely midday meal; while Julia Child's beef Bourguignon is a tempting option come dinnertime. Treat yourself anytime with sweets from the bakery, like the wedge of bourbon chocolate pecan pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=389%20Main%20St.%2C%20Washington%2C%20DC%2C%2022747%2C%20USA"
    pageTitle="Patty O's Cafe & Bakery"
  />
);

export default PattyOsCafeBakery;
