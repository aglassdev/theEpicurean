...
const Lashukran = () => (
  <RestaurantPage
    restaurantName="La'Shukran"
    address="417 Morse St. NE, Washington, DC, 20002, USA"
    ...
    bio="La' Shukran feels like a discovery, as you'll need to walk down an alley, look for a green door and climb the stairs to arrive at this cool spot with a funky, retro vibe. It's definitely a hot spot for drinks, but the Levantine cuisine designed for sharing is far from second place.From escargot and sweetbreads to labneh with Maryland crab, summer peppers and corn in green harissa, some dishes lean less traditional, while others, like haswei, or fried rice with seven-spice lamb, seem simple but are spot on. Every table needs an order of their soujek dumplings. Filled with beef and lamb shoulder and resting in a vibrant smoked corn and tomato brodo with urfa chili crunch and toum, it's easy to see why reservations are snapped up so quickly here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=417%20Morse%20St.%20NE%2C%20Washington%2C%20DC%2C%2020002%2C%20USA"
    pageTitle="La'Shukran"
  />
);

export default Lashukran;
