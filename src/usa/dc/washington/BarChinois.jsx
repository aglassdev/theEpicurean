...
const BarChinois = () => (
  <RestaurantPage
    restaurantName="Bar Chinois"
    address="455 I St. NW, Washington, 20001, USA"
    cuisine="Asian, Dim Sum"
    priceRange="$$"
    phoneNumber="+12028516250"
    website="https://www.barchinoisdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Swanky French wine bar meets delectable Asian bites at Bar Chinois. The space is eternally lively and the menu, with dim sum aplenty, is enticing.While this may be a bar first (thrilling cocktails include a martini with pickled pearl onions, pickled shiitake mushrooms, plus kombu and bonito flakes), the kitchen takes its cooking seriously, offering a lineup of mouthwatering plates. Imagine half moon-shaped ginger chicken dumplings with a honey dip; shrimp toast batter-fried with sesame seeds; or Beijing pork dumplings with Berkshire pork and Chinese chives. The Lion's Head meatball, starring oven-braised pork au jus, water chestnuts, and Shaoxing rice wine, is as regal as its title, and bears an almost apocryphal lightness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=455%20I%20St.%20NW%2C%20Washington%2C%2020001%2C%20USA"
    pageTitle="Bar Chinois"
  />
);

export default BarChinois;
