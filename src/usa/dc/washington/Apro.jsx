...
const Apro = () => (
  <RestaurantPage
    restaurantName="Apéro"
    address="2622 P St. NW, Washington, 20007, USA"
    cuisine="French, Contemporary"
    priceRange="$$$$"
    phoneNumber="+12025251682"
    website="https://www.aperodc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dining at Apéro feels like landing upon an intimate and chic dining secret. This welcome boîte boasts a windowed façade delicately draped with sheer curtains; inside, discover midnight-blue walls, gold accents and an ultra-plush Persian rug. A secret garden in the back is the place for a tête-à-tête. Champagne and caviar is the menu's mission, and owner/sommelier Elli Benchimol and team nail it. Caviar at all price points is offered with a host of accoutrements, like chopped egg, capers and chives, as well as batons of crunchy waffles. Rest assured though as the carte flaunts a whole range of French classics, including an exquisitely seasoned lobster bisque bobbing with croutons, tailed by deviled eggs mixed with sweet potato, bacon and crystals of brown sugar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2622%20P%20St.%20NW%2C%20Washington%2C%2020007%2C%20USA"
    pageTitle="Apéro"
  />
);
