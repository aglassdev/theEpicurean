...
const RoosterOwl = () => (
  <RestaurantPage
    ...
    priceRange="$$$"
    phoneNumber="+12029159004"
    website="https://www.roosterowl.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A talented husband-and-wife duo is behind this appealingly contemporary, hipster hot spot. The setting is the perfect match for its modern, edgy cuisine, which meanders from the Middle East and Mediterranean all the way to Asia.There is unabashed creativity unleashed in such dishes as ricotta gnudi along with a frothy sour cream soubise and lemon beurre. Baby carrots with labneh and cashew pesto are an alluring side dish, while the pistachio olive oil cake with goat cheese mousse, blackberry and candied pistachio will leave a lasting impression. Since you get to mix and match menu items, the bar follows suit and tailors wine options to guests' selections...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2436%2014th%20St.%20NW%2C%20Washington%2C%20DC%2C%2020009%2C%20USA"
    pageTitle="Rooster & Owl"
  />
);

export default RoosterOwl;
