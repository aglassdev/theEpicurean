...
const TheDabney = () => (
  <RestaurantPage
    ...
    address="122 Blagden Alley NW, Washington, DC, 20001, USA"
    cuisine="American, Contemporary"
    priceRange="$$$$"
    phoneNumber="+12022402660"
    website="https://thedabney.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Dabney exudes charming, contemporary farmhouse vibes with its exposed brick, light walls, and dark wood, and the look is completed by a slickly arranged open kitchen complete with a wood-fired hearth. Chef/owner Jeremiah Langhorne serves up the flavors of the Mid-Atlantic with a hint of a Southern accent and the tasting menu is a deeper, more committed expression of the team's talents. Begin with bite-sized snacks including their pie crust tart with pickled blueberries, granola crumble, and cheese fondue or their Madeira compressed melon. Then, hearth-roasted vegetables are served over a bed of farro salad with whipped ricotta, herbs from their rooftop garden, and finished with a pour of a basil sauce. American wagyu cap grilled over coals is accompanied by eggplant prepared three ways..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122%20Blagden%20Alley%20NW%2C%20Washington%2C%20DC%2C%2020001%2C%20USA"
