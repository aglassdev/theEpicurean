...
const TheImperial = () => (
  <RestaurantPage
    restaurantName="The Imperial"
    address="2001 18th St. NW, Washington, 20009, USA"
    cuisine="American"
    priceRange="$$$"
    phoneNumber="+12022990334"
    website="https://www.imperialdc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bright and bold spot boasts a concise menu with strong American inflections. Enter to discover two colorful dining rooms on either side of the space, as well as a buzzing bar in the back. Spread across a few floors (that culminate in a rooftop bar as your reward for the climb), details like textured metal, marble tables, and artfully lit bottles enhance the convivial vibe.The menu is divvied into mostly raw, vegetables, meats, and larger dishes. Regardless of your pick, these plates are well-executed and show a creative spirit. Start with such sea treats as blackened blue crab claws served with Alabama white sauce, then segue into land by way of the beef Wellington, which sports a golden pastry, braised leeks, and veal jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2001%2018th%20St.%20NW%2C%20Washington%2C%2020009%2C%20USA"
    pageTitle="The Imperial"
  />
);

export default TheImperial;
