...
const LaosInTown = () => (
  <RestaurantPage
    restaurantName="Laos in Town"
    address="250 K St. NE, Washington, 20002, USA"
    cuisine="South East Asian, Lao"
    priceRange="$$"
    phoneNumber="+12028646687"
    website="https://www.laosintown.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flavors and heat of Southeast Asian are on full display at this Northeast DC eatery. Though the menu spans much of the country, Laos’ menu—sporting a section devoted entirely to vegans—still manages to be original, offering ingredients that are rarely found in similar restaurants. It also promises—and delivers on—dishes marked “phet (or spicy).Generous slices of sausage with savory herbs are served with crunchy green papaya, peanuts and fiery green chili; while the chef’s signature papaya salad arrives with bright green beans, Laos pork loaf and a mellow fermented fish sauce. Don’t miss the unique orm, a tender chicken-and-dill curry, imbued with Asian eggplant, cabbage, scallions and more green beans. An extensive cocktail list is an added bonus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=250%20K%20St.%20NE%2C%20Washington%2C%2020002%2C%20USA"
    pageTitle="Laos in Town"
  />
);

export default LaosInTown;
