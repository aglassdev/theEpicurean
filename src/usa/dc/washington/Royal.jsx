...
const Royal = () => (
  <RestaurantPage
    restaurantName="Royal"
    address="501 Florida Ave. NW, Washington, 20001, USA"
    cuisine="Latin American"
    priceRange="$$"
    phoneNumber="+12023327777"
    website="https://www.theroyaldc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This airy, quaint, and relaxed all-day spot likes to keep things low-maintenance. The price point too is agreeably lower than its fussier competitors, and the Latin American food is decidedly scrumptious. No wonder, it's a legitimate local favorite.Breakfast is a must, especially if the messy, eggy arepa is on offer. Served wrapped in a white pouch, it resembles a present crafted from seared masa and filled with a fried egg, tomato, cotjia, and avocado. At dinner, hungry fans head to the intimate second-level space—complete with original details—to try their hand at tender pork empanadas laced with aji and the heavenly scent of garlic. The masa “gnocchi” is a rare treat, tossed with braised beef, maitake mushrooms, and loads of herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=501%20Florida%20Ave.%20NW%2C%20Washington%2C%2020001%2C%20USA"
    pageTitle="Royal"
  />
);
