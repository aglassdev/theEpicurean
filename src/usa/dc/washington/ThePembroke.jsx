...
const ThePembroke = () => (
  <RestaurantPage
    restaurantName="The Pembroke"
    address="1500 New Hampshire Ave. NW, Washington, 20036, USA"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+12024484302"
    website="https://thepembrokedc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This seductive dining room took a cool few million to create, but it is utterly chic and wholly Parisian. Pretty patio-facing marble tables, salmon-hued chairs, tufted banquettes, and greenery create the feeling of dining in a terrarium. Over in the kitchen, the chefs don't cling to any one trend. Imagine a melange of plates like prawn cocktail, lobster bisque, handmade pastas, as well as mains like Dover sole meunière or veal Milanese and you'll start to get their drift. Mediterranean flavors also find their way into dishes like octopus fricassee with black olives and lamb tagine with couscous. Close with a simple yet irresistible lemon tart.Set inside the Dupont Circle Hotel, this smart spot radiates much joy thanks to its genial vibe and solid food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1500%20New%20Hampshire%20Ave.%20NW%2C%20Washington%2C%2020036%2C%20USA"
    pageTitle="The Pembroke"
  />
);

export default ThePembroke;
