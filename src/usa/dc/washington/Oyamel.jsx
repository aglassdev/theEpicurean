...
const Oyamel = () => (
  <RestaurantPage
    ...
    address="401 7th St. NW, Washington, 20004, USA"
    cuisine="Mexican"
    priceRange="$$"
    ...
    bio="This well-liked mainstay of DC Mexican cuisine comes courtesy of Spanish Chef Jose Andres, whose typical dedication to flavorful cooking and high-quality ingredients still draws brisk business. Snag a seat at the entertaining ceviche bar and sip thirst-quenching drinks while snacking on small plates.The kitchen's dedication to technique and ingredients is clear, with a particular penchant for regionally inflected Mexican cuisine like huevos enfrijoladas, crispy chilaquiles, and gorditas topped with Hudson Valley duck confit. Don’t miss the tarasca estilo pátzcuaro though, an otherworldly black bean soup with avocado leaves, swirls of crema, and crumbled cotija. A special hora feliz menu makes the early evening hours very happy indeed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=401%207th%20St.%20NW%2C%20Washington%2C%2020004%2C%20USA"
    pageTitle="Oyamel"
  />
);

export default Oyamel;
