...
const Zoltners = () => (
  <RestaurantPage
    restaurantName="Zoltners"
    address="Kroņauce, Tērvete, 3730, Latvia"
    cuisine="European"
    priceRange="€€"
    phoneNumber="+37127331109"
    website="https://zoltners.lv/en/story/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You'll find the Zoltners Brewery in the heart of the glorious Zemgale countryside, along with this slick, modern restaurant and an attractively restored period house that’s now a small hotel boasting modern bedrooms; make a weekend of it by dining, staying the night and visiting the Tērvete Nature Park. Menus showcase local produce in an appealing mix of flavoursome northern European dishes, and the simple starters go perfectly with their home-brewed beers and local spirits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kro%C5%86auce%2C%20T%C4%93rvete%2C%203730%2C%20Latvia"
    pageTitle="Zoltners"
  />
);

export default Zoltners;
