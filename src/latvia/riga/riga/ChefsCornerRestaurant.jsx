...
const ChefsCornerRestaurant = () => (
  <RestaurantPage
    restaurantName="Chef's Corner Restaurant"
    address="Jeruzalemes iela 5, Riga, 1010, Latvia"
    cuisine="Modern Cuisine, Meats and Grills"
    priceRange="€€€"
    phoneNumber="+37127001101"
    website="https://chefscorner.lv"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A friendly team welcome you into this chic city centre brasserie, where you’ll do well to start with a cocktail while choosing from the classic brasserie-style menu. There's plenty to choose from, but the emphasis is on steaks from the Netherlands, the UK and the USA, with those to share proving a particularly popular choice. Other options include everything from tartares, burrata and oysters to burgers, pastas and game – with some seasonal options thrown in – making this spot a hit with locals and visitors alike...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jeruzalemes%20iela%205%2C%20Riga%2C%201010%2C%20Latvia"
    pageTitle="Chef's Corner Restaurant"
  />
);

export default ChefsCornerRestaurant;
