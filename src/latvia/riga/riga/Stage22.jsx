...
const Stage22 = () => (
  <RestaurantPage
    restaurantName="Stage22"
    address="Aspazijas bulvāris 22, Riga, 1050, Latvia"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+37167670122"
    website="https://www.kempinski.com/en/grand-hotel-kempinski-riga/restaurants-bars/stage22"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on the top floor of the Grand Hotel Kempinski Riga, this sumptuous restaurant affords superb views out over the park and the city skyline. Start with a drink in the chic cocktail bar or out on the lovely narrow terrace, then settle into plush chairs to enjoy your evening. This is an ideal place for celebrating and you will be looked after with consummate ease by the professional team. The wide-ranging Asian menu includes the likes of spicy tuna roll and Argentinian beef fillet with shallot cream, while the crispy vegetable tempura with dashi sauce is not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aspazijas%20bulv%C4%81ris%2022%2C%20Riga%2C%201050%2C%20Latvia"
    pageTitle="Stage22"
  />
);
