...
const Tutano = () => (
  <RestaurantPage
    restaurantName="Tuétano"
    address="John Lennon 26, Mérida, 06800, Spain"
    cuisine="Meats and Grills, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34924830716"
    website="https://tuetano.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=John%20Lennon%2026%2C%20M%C3%A9rida%2C%2006800%2C%20Spain"
    pageTitle="Tuétano"
  />
);

export default Tutano;
