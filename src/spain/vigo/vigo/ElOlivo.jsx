...
const ElOlivo = () => (
  <RestaurantPage
    restaurantName="El Olivo"
    address="Rúa Oliva 2, Vigo, 36202, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34886251085"
    website="https://www.palaciodelaoliva.com/restaurante-el-olivo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of the “casco vello”, just a few steps from the Concatedral - Basílica de Santa María de Vigo, this restaurant stands out for its setting in an old renovated manor house that dates back to Templar times and is now a multi-purpose venue that includes a terrace, event spaces, a luxurious cocktail bar etc, plus a mix of tradition (note the stone walls) and design. The cuisine here bears the signature of chef Pepe Solla whose focus is on greater simplicity and individual ingredients compared to his award-winning one-Michelin-star Solla restaurant. His Josper oven takes centre stage as showcased by his standout grilled fish dishes, including his Josper-grilled John Dory. The chef’s table in the kitchen enables guests to watch the chefs at work at close quarters!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R%C3%BAa%20Oliva%202%2C%20Vigo%2C%2036202%2C%20Spain"
    pageTitle="El Olivo"
  />
);

export default ElOlivo;
