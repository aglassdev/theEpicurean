...
const BevirByLopesan = () => (
  <RestaurantPage
    restaurantName="Bevir by Lopesan"
    address="Mar Mediterráneo 1, Meloneras, 35100, Spain"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+34928128107"
    website="https://restaurantebevir.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After enjoying such resounding success in the capital of Gran Canaria, this restaurant is embarking on a new venture in the luxurious Lopesan Costa Meloneras Resort & Spa hotel. The goal? To offer diners an even more hedonistic culinary experience. The restaurant is found in an interior courtyard with large windows overlooking it, opting for a minimalist aesthetic and with chef José Luis Espino at the helm, a man loyal to Canarian produce who tries to define his cuisine under the concept ‘Where the vegetable garden meets the sea’, always paying homage to local flavours and the importance of making the most of natural ingredients. You will find two tasting menus, with a modern twist, which seek to pay tribute to Benito Pérez Galdós's most famous characters and celebrate this distinguished C..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mar%20Mediterr%C3%A1neo%201%2C%20Meloneras%2C%2035100%2C%20Spain"
    pageTitle="Bevir by Lopesan"
  />
);

export default BevirByLopesan;
