...
const LaEncomienda = () => (
  <RestaurantPage
    restaurantName="La Encomienda"
    address="Alameda 34, Villanueva de San Carlos, 13379, Spain"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+34926879169"
    website="https://www.laencomiendarestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a timeless La Mancha feel occupies an old cheese-making factory. Run by women, it focuses on seasonal, regional cuisine full of home-cooked flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alameda%2034%2C%20Villanueva%20de%20San%20Carlos%2C%2013379%2C%20Spain"
    pageTitle="La Encomienda"
  />
);

export default LaEncomienda;
