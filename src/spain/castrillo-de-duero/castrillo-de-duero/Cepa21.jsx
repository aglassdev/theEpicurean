...
const Cepa21 = () => (
  <RestaurantPage
    restaurantName="Cepa 21"
    address="Carretera N 122, Castrillo de Duero, 47318, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34983484084"
    website="https://www.cepa21restaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bright, contemporary restaurant on the first floor of the bodega of the same name, one of the best known in the Ribera del Duero wine region. Here, in a dining room boasting stunning views of the surrounding vineyards, savour cuisine with a contemporary touch on two tasting menus, both of which pay plenty of attention to presentation and the use of seasonal ingredients. Wine tours (prior booking required) and shopping in the on-site boutique add to the experience here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20N%20122%2C%20Castrillo%20de%20Duero%2C%2047318%2C%20Spain"
    pageTitle="Cepa 21"
  />
);

export default Cepa21;
