...
const LaHermosaDeAlba = () => (
  <RestaurantPage
    restaurantName="La Hermosa de Alba"
    address="Tetuán 34, Santander, 39004, Spain"
    cuisine="Fusion"
    priceRange="€€"
    phoneNumber="+34942809108"
    website="https://guide.michelin.com/en/cantabria/santander/restaurant/la-hermosa-de-alba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with a fun, modern feel that is enjoying considerable success in the city. The menu here is contemporary in style with elements of fusion cooking and dishes designed for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tetu%C3%A1n%2034%2C%20Santander%2C%2039004%2C%20Spain"
    pageTitle="La Hermosa de Alba"
  />
);

export default LaHermosaDeAlba;
