...
const AsadorLechazoAranda = () => (
  <RestaurantPage
    restaurantName="Asador Lechazo Aranda"
    address="Tetuán 15, Santander, 39004, Spain"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+34942214823"
    website="https://www.instagram.com/asadorlechazoaranda/?hl=es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant boasts an attractive Castilian decor and a menu featuring traditional cuisine, including the occasional seafood dish, top-quality meat and delicious roasts cooked in a wood-fired oven. Roast lamb is the house speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tetu%C3%A1n%2015%2C%20Santander%2C%2039004%2C%20Spain"
    pageTitle="Asador Lechazo Aranda"
  />
);

export default AsadorLechazoAranda;
