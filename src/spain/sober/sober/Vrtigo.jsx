...
const Vrtigo = () => (
  <RestaurantPage
    restaurantName="Vértigo"
    address="Doade, Sober, 27424, Spain"
    cuisine="Contemporary, Farm to table"
    priceRange="€€€"
    phoneNumber="+34621235978"
    website="https://www.restaurantevertigo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on top of one of the hills that act as a balcony above the canyons of the Sil River and surrounded by stunning vineyards (the latter, planted on steep terraces, are truly worthy of the term “heroic viticulture”), this restaurant (part of the Regina Viarum wine estate) is a superb dining option, providing the icing on the cake for any visit to the spectacular Ribeira Sacra area. The cuisine here, under the direction of award-winning chef Rafa Centeno (from the renowned Maruja Limón restaurant in Vigo) and run day-to-day by chef Claudia Pinto, is presented on two contemporary-style tasting menus that are built around ingredients from the area, crisp flavours and highly delicate presentation. The dishes you’ll find on the menu include free-range eggs, cauliflower and smoked eel; grill..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Doade%2C%20Sober%2C%2027424%2C%20Spain"
    pageTitle="Vértigo"
  />
);

export default Vrtigo;
