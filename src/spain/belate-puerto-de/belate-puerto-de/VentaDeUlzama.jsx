...
const VentaDeUlzama = () => (
  <RestaurantPage
    restaurantName="Venta de Ulzama"
    address="Carretera NA 1210, Belate (Puerto de), 31797, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34948305138"
    website="https://www.ventadeulzama.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best dining and accommodation options in the Ulzama valley, this tranquil family-run business with over a century of history behind it is guaranteed to please its guests. It occupies a typical mountain-style property in a delightful natural setting, with the unusual sight of a deer farm next door! It features an attractive bar, a room with an open fireplace, a classically furnished dining room with a profusion of wood, plus a traditional menu accompanied by a good selection of suggestions that change according to the availability of seasonal ingredients (vegetables, mushrooms, grilled fish, game etc). The views from the dining room and terrace are superb!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20NA%201210%2C%20Belate%20(Puerto%20de)%2C%2031797%2C%20Spain"
    pageTitle="Venta de Ulzama"
  />
);

export default VentaDeUlzama;
