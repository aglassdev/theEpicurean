...
const EsPortal = () => (
  <RestaurantPage
    restaurantName="Es Portal"
    address="Carretera de Torroella de Montgrí 17, Pals, 17256, Spain"
    cuisine="Catalan, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+34972636596"
    website="https://www.esportalhotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant occupies an impressive Empordà-style farmhouse that dates back to the 16C. It features attractive grounds and rustic-style dining rooms which provide a backdrop for seasonal cuisine that takes full advantage of local products. The cosy guestrooms are an added bonus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20de%20Torroella%20de%20Montgr%C3%AD%2017%2C%20Pals%2C%2017256%2C%20Spain"
    pageTitle="Es Portal"
  />
);
