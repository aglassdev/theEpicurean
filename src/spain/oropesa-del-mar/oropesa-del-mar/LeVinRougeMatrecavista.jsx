...
const LeVinRougeMatrecavista = () => (
  <RestaurantPage
    restaurantName="Le Vin Rouge Maître-Cavista"
    address="Plaza Constitución 4, Oropesa del Mar, 12594, Spain"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+34722328281"
    website="https://levinrouge.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that focuses on a reinterpreted version of French and Central European cooking via a concise à la carte along with interesting wine pairing options. Don’t miss the Apfelstrudel!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20Constituci%C3%B3n%204%2C%20Oropesa%20del%20Mar%2C%2012594%2C%20Spain"
    pageTitle="Le Vin Rouge Maître-Cavista"
  />
);

export default LeVinRougeMatrecavista;
