...
const Tabaiba = () => (
  <RestaurantPage
    restaurantName="Tabaiba"
    address="Portugal 79, Las Palmas de Gran Canaria, 35010, Spain"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+34928027055"
    website="https://tabaibarestaurante.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located just a few metres from Las Canteras beach and taking its name from a native flower, Tabaiba enjoys surprising its guests with what it describes as its “evolutionary Canary Island cuisine”. In this small contemporary space, chef Abraham Ortega (who, along with his team, is usually seen sporting his typical sombrero), offers guests his highly personal and entertaining cuisine that takes seemingly humble Canarian cooking to new heights thanks to his superb technique and seasonal ingredients sourced from each of the islands. He also adds touches of sentimentality, such as the tribute to his grandmother in the sequence entitled “Chickpeas-Egg Yolk-Pork Belly”. His cuisine is exclusively served on two tasting menus (Tabaiba and Experiencia), featuring elaborate dishes (we thoroughly enjo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Portugal%2079%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035010%2C%20Spain"
    pageTitle="Tabaiba"
  />
);

export default Tabaiba;
