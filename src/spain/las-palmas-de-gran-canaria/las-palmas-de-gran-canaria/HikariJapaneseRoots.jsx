...
const HikariJapaneseRoots = () => (
  <RestaurantPage
    restaurantName="Hikari Japanese Roots"
    address="Buenos Aires 16, Las Palmas de Gran Canaria, 35002, Spain"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+34828708968"
    website="https://guide.michelin.com/en/canarias/las-palmas-de-gran-canaria/restaurant/hikari-japanese-roots"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located just a few minutes’ walk from the San Telmo park, this small Japanese-inspired eatery has a dining counter for just nine guests (the best option in our view) and several tables, where experienced chef David Rivero takes us by the hand on a journey across the best flavours found in Japanese cuisine. He does this via a single surprise Omakase menu (with an extra main course option available for a supplement) that he explains in detail to every guest at the same time, hence his requirement for customers to be punctual. Because of the restaurant’s success, we recommend booking in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Buenos%20Aires%2016%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035002%2C%20Spain"
    pageTitle="Hikari Japanese Roots"
  />
);

export default HikariJapaneseRoots;
