...
const Verode = () => (
  <RestaurantPage
    restaurantName="Verode"
    address="Lepanto 23, Las Palmas de Gran Canaria, 35010, Spain"
    cuisine="Regional Cuisine, Fusion"
    priceRange="€€"
    phoneNumber="+34928073895"
    website="https://www.veroderestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Halfway between Plaza del Pilar and the magnificent Las Canteras beach, this curious establishment, a kind of bistro inspired by the different landscapes of the Canary Islands (taking its name from a plant endemic to the islands), is a more informal approach from acclaimed chef Abraham Ortega (Tabaiba, with a Michelin star). Here he sets his creativity to one side in favour of good regional cuisine, brought up to date with light touches of fusion. On the menu, which is designed for sharing (half portions are available at the bar and on the terrace), we particularly liked the combination of grilled octopus, corn and green mojo sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lepanto%2023%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035010%2C%20Spain"
    pageTitle="Verode"
  />
);

export default Verode;
