...
const ElSanto = () => (
  <RestaurantPage
    ...
    address="Escritor Benito Pérez Galdós 23, Las Palmas de Gran Canaria, 35002, Spain"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34928283366"
    website="https://www.elsantorestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="El Santo boasts an excellent location in the Triana district, a part of the old town with a special beauty and character that result from its original occupation by residents who settled here mainly from Andalucía. The restaurant features a pleasantly surprising decor that combines the stone walls of this restored property with attractive tropical details. To this backdrop, guests can savour bold cuisine that showcases typical Canary island recipes, with a fusion of Mexican cooking visible in some dishes. Don’t miss the black “papa arrugada” potatoes with mojo “snow” and mole mojo!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Escritor%20Benito%20P%C3%A9rez%20Gald%C3%B3s%2023%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035002%2C%20Spain"
    pageTitle="El Santo"
  />
);

export default ElSanto;
