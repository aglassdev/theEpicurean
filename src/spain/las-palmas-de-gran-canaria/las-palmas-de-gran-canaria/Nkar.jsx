...
const Nkar = () => (
  <RestaurantPage
    restaurantName="Nákar"
    address="Fernando Guanarteme 10, Las Palmas de Gran Canaria, 35007, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34673625976"
    website="https://www.restaurantenakar.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located close to Las Canteras beach, Nákar boasts a minimalist contemporary decor that provides the backdrop for an updated take on traditional cuisine with a nod to recipes from the Basque Country and Navarra. The à la carte, which includes interesting dishes such as goat taco and an array of savoury rices, is complemented by a 7-course tasting menu entitled Nákar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fernando%20Guanarteme%2010%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035007%2C%20Spain"
    pageTitle="Nákar"
  />
);
