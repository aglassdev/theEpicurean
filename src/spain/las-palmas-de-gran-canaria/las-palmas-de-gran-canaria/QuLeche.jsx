...
const QuLeche = () => (
  <RestaurantPage
    restaurantName="Qué Leche"
    address="Torres 22, Las Palmas de Gran Canaria, 35002, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34607917803"
    website="https://www.restaurantequeleche.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If, as well as enjoying a meal, you are keen to be part of a gastronomic experience, this restaurant is well worth a visit! Although not overly spacious, this pleasant and informal restaurant is enthusiastically run by Jennise Ferrari, a Venezuelan chef who settled in Las Palmas in 2013. Here, she showcases fusion cuisine that is based around local ingredients, with the added aim of creating attractive dishes inspired by places a little further afield (Mexico, Asia, Japan etc). Many of the speciality dishes are perfect for sharing: we can highly recommend the duck magret, Cuban-style rice nigiri and Venezuelan pabellón criollo (with Wagyu beef), the unique rabbit EscaViche, sea bass aguachile and other delightful dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Torres%2022%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035002%2C%20Spain"
    pageTitle="Qué Leche"
  />
);

export default QuLeche;
