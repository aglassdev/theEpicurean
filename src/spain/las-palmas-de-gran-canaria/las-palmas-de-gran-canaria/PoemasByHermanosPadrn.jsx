...
const PoemasByHermanosPadrn = () => (
  <RestaurantPage
    restaurantName="Poemas by Hermanos Padrón"
    address="León y Castillo 227, Las Palmas de Gran Canaria, 35005, Spain"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+34928243041"
    website="https://www.restaurantepoemas.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A dazzling dining experience both in terms of the elegant setting and the gastronomic cuisine on offer in the exclusive and historic Santa Catalina hotel, a Royal Hideaway Hotel, in the heart of Las Palmas de Gran Canaria. At the helm you’ll find chef Adrián García, from nearby Arucas, who has been superbly trained by the Padrón brothers (Juan Carlos and Jonathan) and who recreates the flavoursome cuisine of these award-winning chefs along with all of their renowned creativity. This dining space, which has its own separate entrance next to the hotel piano-bar (where a pianist provides the musical backdrop), boasts a refined and classical interior design with a profusion of wood that comes as a pleasant surprise. The Poemas tasting menu (on which we particularly enjoyed the impressively pre..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%C3%B3n%20y%20Castillo%20227%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035005%2C%20Spain"
    pageTitle="Poemas by Hermanos Padrón"
  />
);

export default PoemasByHermanosPadrn;
