...
const Deliciosamarta = () => (
  <RestaurantPage
    restaurantName="Deliciosamarta"
    address="Escritor Benito Pérez Galdós 33, Las Palmas de Gran Canaria, 35002, Spain"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+34676377032"
    website="https://guide.michelin.com/en/canarias/las-palmas-de-gran-canaria/restaurant/deliciosamarta"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with plenty of personality and an appealing decor along an attractive pedestrian street in the city’s Triana district. Its cuisine is equally impressive, featuring market-inspired cooking with a modern touch and influences from the Canary Islands that is only available à la carte. We recommend booking ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Escritor%20Benito%20P%C3%A9rez%20Gald%C3%B3s%2033%2C%20Las%20Palmas%20de%20Gran%20Canaria%2C%2035002%2C%20Spain"
    pageTitle="Deliciosamarta"
  />
);

export default Deliciosamarta;
