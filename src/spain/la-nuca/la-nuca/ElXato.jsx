...
const ElXato = () => (
  <RestaurantPage
    restaurantName="El Xato"
    address="Avenida l'Esglèsia 3, la Nucía, 03530, Spain"
    cuisine="Creative, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34965870931"
    website="https://elxato.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A family-run restaurant with over 100 years of history, dating back to the simple wine cellar that first opened in 1915. Over time it became a tapas bar and now, run by the fourth generation, it is the most prestigious restaurant in the Marina Baixa area, where the staff do everything possible to ensure that diners “arrive as guests but leave as friends”. Chef Cristina Figueira, who is ably supported by her husband Francisco Cano (in charge of the dining room and wine cellar), began her training in the kitchens of El Xato under the watchful eye of her mother-in-law, Esperanza Fuster. Here, she demonstrates an inexhaustible spirit which has resulted in her becoming one of the most outstanding cooks in the region thanks to her mastery of Alicante cuisine and her creative vision closely linke..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20l'Esgl%C3%A8sia%203%2C%20la%20Nuc%C3%ADa%2C%2003530%2C%20Spain"
    pageTitle="El Xato"
  />
);

export default ElXato;
