...
const ElPescador = () => (
  <RestaurantPage
    restaurantName="El Pescador"
    address="Tolombreo de Arriba s/n, Cudillero, 33150, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34985590937"
    website="https://www.hotelrestauranteelpescador.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family - run restaurant offering a very extensive menu including a variety of Asturian dishes and above all local fish and seafood (hake, monkfish, bream etc)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tolombreo%20de%20Arriba%20s%2Fn%2C%20Cudillero%2C%2033150%2C%20Spain"
    pageTitle="El Pescador"
  />
);

export default ElPescador;
