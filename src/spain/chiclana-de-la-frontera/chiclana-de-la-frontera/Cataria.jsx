...
const Cataria = () => (
  <RestaurantPage
    restaurantName="Cataria"
    address="Av. Amilcar Barca, 14, Chiclana de la Frontera, 11139, Spain"
    cuisine="Seafood, Grills"
    priceRange="€€€"
    phoneNumber="+34664150752"
    website="https://www.restaurantecataria.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Amilcar%20Barca%2C%2014%2C%20Chiclana%20de%20la%20Frontera%2C%2011139%2C%20Spain"
    pageTitle="Cataria"
  />
);

export default Cataria;
