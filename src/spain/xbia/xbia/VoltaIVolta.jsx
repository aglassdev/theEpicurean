...
const VoltaIVolta = () => (
  <RestaurantPage
    restaurantName="Volta i Volta"
    address="Santa Teresa 3, Xàbia, 03730, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€"
    phoneNumber="+34965042823"
    website="https://www.voltaivoltarestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a two-storey building in the old town! It retains attractive aesthetic details of the original old house and offers tasty seasonal Mediterranean cuisine, with contemporary dishes such as aubergine, cured tuna belly capers and caper berries, the delicious pan-fried John Dory with tomato confit, Kalamata olives and grilled cos lettuce, or their stuffed quail, baked noodles and truffle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Santa%20Teresa%203%2C%20X%C3%A0bia%2C%2003730%2C%20Spain"
    pageTitle="Volta i Volta"
  />
);

export default VoltaIVolta;
