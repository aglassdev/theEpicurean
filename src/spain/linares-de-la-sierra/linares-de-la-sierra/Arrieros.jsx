...
const Arrieros = () => (
  <RestaurantPage
    restaurantName="Arrieros"
    address="Arrieros 2, Linares de la Sierra, 21207, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34959463717"
    website="https://www.restaurantearrieros.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A great option if you’re visiting the Sierra de Aracena, its nature reserve, or Linares de la Sierra, a beautiful town of attractive cobbled streets. Run and owned by a married couple, Arrieros occupies a typical whitewashed mountain property with a welcoming rustic interior that features an attractive fireplace, wood ceilings and rustic-contemporary furnishings with an eye for tasteful detail. The chef’s emphasis here is on an updated take on regional-style cooking in which Iberian pork takes centre stage, with a particular focus on offal. This focus is showcased on the two tasting menus (Ruta de Jabugo and La Dehesa). Signature dishes include Iberian pork tongue, pork “castañetas” with curry and mashed potato, and the famous tomato soup, Arrieros’ version of the Andalucian “poleá”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arrieros%202%2C%20Linares%20de%20la%20Sierra%2C%2021207%2C%20Spain"
    pageTitle="Arrieros"
  />
);

export default Arrieros;
