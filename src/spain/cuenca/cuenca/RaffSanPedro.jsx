...
const RaffSanPedro = () => (
  <RestaurantPage
    restaurantName="Raff San Pedro"
    address="San Pedro 58, Cuenca, 16001, Spain"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34969690855"
    website="https://www.raffsanpedro.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the Leonor de Aquitania hotel, where it occupies the former stables of an aristocratic stone mansion. Updated traditional cuisine and interesting set menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Pedro%2058%2C%20Cuenca%2C%2016001%2C%20Spain"
    pageTitle="Raff San Pedro"
  />
);

export default RaffSanPedro;
