...
const CasasColgadasRestaurante = () => (
  <RestaurantPage
    ...
    pageTitle="Casas Colgadas Restaurante"
  />
);

export default CasasColgadasRestaurante;
