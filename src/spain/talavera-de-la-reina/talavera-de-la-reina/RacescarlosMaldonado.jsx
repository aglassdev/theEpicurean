...
const RacescarlosMaldonado = () => (
  <RestaurantPage
    restaurantName="Raíces-Carlos Maldonado"
    address="Ronda de Canillo 3, Talavera de la Reina, 45600, Spain"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+34671422115"
    website="https://raicescarlosmaldonado.es/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Carlos Maldonado knows no limits and it is this which characterises his cooking, which is firmly steeped in the flavours and ingredients of La Mancha but which is also open to influences from around the world, as witnessed by the twinning between his beloved Talavera de la Reina and Puebla (Mexico). The restaurant, which could almost pass unnoticed because of its discreet façade, boasts a classic-contemporary decor in varying tones of white, plus an adjoining dining room with curtains hanging from the ceiling that add a more intimate feel to the tables. His tasting menus (Básico and Hechos de Barro) feature daring, highly technical dishes starting with a selection of snacks (calamari rolls, smoked partridge breast and caviar tartlet, partridge “bonbon”, vegetables and Toledana sauce, ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ronda%20de%20Canillo%203%2C%20Talavera%20de%20la%20Reina%2C%2045600%2C%20Spain"
    pageTitle="Raíces-Carlos Maldonado"
  />
);

export default RacescarlosMaldonado;
