...
const CasaRubn = () => (
  <RestaurantPage
    restaurantName="Casa Rubén"
    address="Carretera de Bielsa km 63 Hospital de Tella, Tella, 22364, Spain"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+34660154700"
    website="https://www.restauranteordesa.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If the idea of a fine-dining break appeals to you, this restaurant in the Aragonese Pyrenees is a interesting and surprising option, despite its somewhat remote location on the edge of the spectacular Parque Nacional de Ordesa y Monte Perdido. Located along the banks of the Cinca and Yaga rivers, it features a dining room crowned by a large stone vaulted ceiling that dates back to 1593. Communication with guests is key for the duo of Rubén Coronas and Cristina Romero (the former in the kitchen, the latter front of house) who show real passion for their work and a true sense of gratitude which they demonstrate through a desire to engage with their customers. Their cuisine, showcased on a single tasting menu entitled Sueño (Dream), offers traditional cooking that has been impressively brough..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20de%20Bielsa%20km%2063%20Hospital%20de%20Tella%2C%20Tella%2C%2022364%2C%20Spain"
    pageTitle="Casa Rubén"
  />
);

export default CasaRubn;
