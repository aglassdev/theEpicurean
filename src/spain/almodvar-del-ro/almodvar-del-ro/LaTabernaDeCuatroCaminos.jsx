...
const LaTabernaDeCuatroCaminos = () => (
  <RestaurantPage
    restaurantName="La Taberna de Cuatro Caminos"
    address="Antonio Machado 24, Almodóvar del Río, 14720, Spain"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34957635550"
    website="https://www.latabernadecuatrocaminos.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that has already enjoyed success in the town under the name La Taberna (the owners also have another eatery in Córdoba called La Taberna de Almodóvar) and has reopened its doors as La Taberna de Cuatro Caminos. Simple terrace, a bar boasting a touch of local colour, plus three dining rooms, all of which are traditional in feel but feature unusual Andalucian detail in their decor. Tasty, regionally inspired cooking with a focus on substantial yet attractively presented local dishes and popular specialities that include its famous croquettes, along with Mazamorra de Almodóvar and Salmorejo Cordobés...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Antonio%20Machado%2024%2C%20Almod%C3%B3var%20del%20R%C3%ADo%2C%2014720%2C%20Spain"
    pageTitle="La Taberna de Cuatro Caminos"
  />
);

export default LaTabernaDeCuatroCaminos;
