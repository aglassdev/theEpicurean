...
const PacoEspinosa = () => (
  <RestaurantPage
    restaurantName="Paco Espinosa"
    address="Paseo Obregón 16, Valladolid, 47009, Spain"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+34983330988"
    website="https://guide.michelin.com/en/castilla-y-leon/valladolid/restaurant/paco-espinosa"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Obreg%C3%B3n%2016%2C%20Valladolid%2C%2047009%2C%20Spain"
    pageTitle="Paco Espinosa"
  />
);

export default PacoEspinosa;
