...
const Llantn = () => (
  <RestaurantPage
    restaurantName="Llantén"
    address="Encina 11, Valladolid, 47153, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34983244227"
    website="https://restaurantellanten.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re celebrating a special occasion and are on the lookout for a restaurant with plenty of charm, look no further than this eatery located in the “Pinar de Antequera”, a residential development on the outskirts of Valladolid, which continues to surprise thanks to its landscaped surroundings and feel of a Menorcan farmhouse – the latter enhanced by the welcoming open fireplaces that provide the perfect ambience for a romantic candlelit supper. Here, the honest, traditional cuisine has been given an impressive modern makeover, including highly memorable dishes such as goat with alioli, beef tripe, 70-day-aged Sanabresa T-bone, as well as Albufera rice dishes that never fail to hit the mark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Encina%2011%2C%20Valladolid%2C%2047153%2C%20Spain"
    pageTitle="Llantén"
  />
);

export default Llantn;
