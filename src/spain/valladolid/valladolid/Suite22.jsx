...
const Suite22 = () => (
  <RestaurantPage
    restaurantName="Suite 22"
    address="Fray Luis de León 22, Valladolid, 47002, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34983201534"
    website="https://www.suite22restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Suite 22 occupies the former stables of the Palacio del Marqués de Castromonte in the heart of the city, where its welcoming barrel-vaulted dining room, bringing together past and present, comes as a pleasant surprise. Chef Emilio Martín's approach, with a contemporary seasonal menu, several set menus, and the option of sharing dishes, reflects a modern yet invariably self-taught and personal style of cooking, with well-balanced flavours that seek to break away from established norms. The chef, who considers Iberian pork to be one of his preferred ingredients, also likes to incorporate nods to French (Paté crouté) and Asian cuisine (Chipirones kimchee). Don't miss his famous Corchifrito pincho!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fray%20Luis%20de%20Le%C3%B3n%2022%2C%20Valladolid%2C%2047002%2C%20Spain"
    pageTitle="Suite 22"
  />
);

export default Suite22;
