...
const LaTrbede = () => (
  <RestaurantPage
    restaurantName="La Trébede"
    address="Paraje Canal de Hornos, Pobladura del Valle, 49780, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34633723364"
    website="https://www.latrebede.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, on the outskirts of this small village in Zamora province, young chef Pablo González has taken over the reins of this simple yet characterful restaurant with a gabled roof and a decor of agricultural implements. In the semi-visible kitchen, the focus is on an updated take on traditional cooking typified by standout dishes such as the crispy shrimp omelette with a slightly sweet touch thanks to the addition of a hint of quince, and the confit of pig’s ear cooked at low temperature, with a dried tomato and mussel salsa brava. While you’re in the area, we also recommend visiting the highly original Museo Grand Central, a museum displaying models of battleships, naval vessels and trains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paraje%20Canal%20de%20Hornos%2C%20Pobladura%20del%20Valle%2C%2049780%2C%20Spain"
    pageTitle="La Trébede"
  />
);

export default LaTrbede;
