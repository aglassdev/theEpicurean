...
const CanSimoneta = () => (
  <RestaurantPage
    restaurantName="Can Simoneta"
    address="Carretera Artà-Canyamel, Canyamel, 07580, Spain"
    ...
    bio="A restaurant with a spectacular location on a cliff boasting superb views. Surprising cuisine that combines the flavours of Mexico and Mallorca. The set menus here are a good option...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20Art%C3%A0-Canyamel%2C%20Canyamel%2C%2007580%2C%20Spain"
    pageTitle="Can Simoneta"
  />
);

export default CanSimoneta;
