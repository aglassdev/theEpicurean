...
const CanSimonetaGastronmic = () => (
  <RestaurantPage
    restaurantName="Can Simoneta Gastronòmic"
    address="Carretera Artà-Canyamel, Canyamel, 07589, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34971816110"
    website="https://www.cansimoneta.com/es/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A spectacular location within the Can Simoneta hotel, situated on a cliff with magnificent views of the Mediterranean. Chef David Moreno’s cuisine surprises with its culinary dialogue that plays with Mexican and Mallorcan flavours under a concept they call ‘Mexiterranean’. What's on offer? A tasting menu, called Origen, which is constantly evolving...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20Art%C3%A0-Canyamel%2C%20Canyamel%2C%2007589%2C%20Spain"
    pageTitle="Can Simoneta Gastronòmic"
  />
);

export default CanSimonetaGastronmic;
