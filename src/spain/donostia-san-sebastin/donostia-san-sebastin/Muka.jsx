...
const Muka = () => (
  <RestaurantPage
    restaurantName="Muka"
    address="Avenida de la Zurriola 1, Donostia / San Sebastián, 20002, Spain"
    cuisine="Grills"
    priceRange="€€"
    phoneNumber="+34943003162"
    website="https://www.muka.eus"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20la%20Zurriola%201%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020002%2C%20Spain"
    pageTitle="Muka"
  />
);
