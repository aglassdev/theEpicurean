...
const Rekondo = () => (
  <RestaurantPage
    restaurantName="Rekondo"
    address="Paseo de Igueldo 57, Donostia / San Sebastián, 20008, Spain"
    cuisine="Basque"
    priceRange="€€€"
    phoneNumber="+34943212907"
    website="https://www.rekondo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A rustic property along the road up to Mt Igueldo with a history dating back over six decades and a classic-contemporary interior that comes as a pleasant surprise. The focus in the kitchen is on Basque cuisine that is respectful of tradition while at the same time constantly evolving and always based around seasonality. Signature dishes here, such as the baked crab and hake fillets in a parsley sauce, stand alongside more contemporary and elaborate options – we particularly enjoyed the artichokes stuffed with a hollandaise sauce, grilled foie gras, winter truffle and a red wine jus). The extensive wine list includes some truly delightful labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20de%20Igueldo%2057%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020008%2C%20Spain"
    pageTitle="Rekondo"
  />
);

export default Rekondo;
