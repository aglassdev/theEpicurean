...
const SaTaula = () => (
  <RestaurantPage
    restaurantName="Sa Taula"
    address="Segundo Ispizua 27, Donostia / San Sebastián, 20001, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34625277490"
    website="https://guide.michelin.com/en/pais-vasco/es-donostia-san-sebastian/restaurant/sa-taula"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Eating at this diminutive restaurant, in the heart of the Gros district, is like being welcomed to the home of a good friend, such is the warm welcome and the glass of Cava almost imperceptibly placed in your hand on arrival. The two owner-chefs, Carlos and Manel, cook, chat, serve and wash the dishes, seemingly at the same time, and in a highly relaxed atmosphere given that they only attend to a maximum ten guests per sitting, all eating together. They work with a single surprise menu, usually based around ingredients sourced from small-scale local producers. Drinks are included in the price...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Segundo%20Ispizua%2027%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020001%2C%20Spain"
    pageTitle="Sa Taula"
  />
);

export default SaTaula;
