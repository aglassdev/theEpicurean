...
const SukaldeanAitorSantamaria = () => (
  <RestaurantPage
    restaurantName="Sukaldean Aitor Santamaria"
    address="San Martín 45, Donostia / San Sebastián, 20007, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34943563902"
    website="https://www.sukaldeanaitorsantamaria.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this highly original setting in the Hotel Zenit Convento de San Martín, several different gastronomic options are available in a single space, including a sushi bar and an area dedicated exclusively to cheese-lovers! The contemporary à la carte combines Basque and Asian recipes, including local sausages, grilled dishes, and traditional sushi (the latter described as “Euskal Sushi” (Basque Sushi). This is complemented by three tasting menus (Clásico, Akelena and Historias del Queso)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Mart%C3%ADn%2045%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020007%2C%20Spain"
    pageTitle="Sukaldean Aitor Santamaria"
  />
);

export default SukaldeanAitorSantamaria;
