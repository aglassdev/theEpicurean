...
const BodegnAlejandro = () => (
  <RestaurantPage
    restaurantName="Bodegón Alejandro"
    address="Fermín Calbetón 4, Donostia / San Sebastián, 20003, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34943427158"
    website="https://www.bodegonalejandro.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for somewhere to eat in the old town that epitomises Basque values and traditional cooking, the Bodegón Alejandro is the place for you, thanks to its focus on authentic local cuisine. In the simply furnished, rustic yet contemporary interior, choose between a varied à la carte of seasonal dishes (fried anchovies, Donostia-style supreme of cod with pil-pil and crab, Iberian pork loin with mashed potatoes etc) and an impressive tasting menu. Make sure you leave space for dessert as the warm pistachio soufflé with lemon sorbet is absolutely delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ferm%C3%ADn%20Calbet%C3%B3n%204%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020003%2C%20Spain"
    pageTitle="Bodegón Alejandro"
  />
);

export default BodegnAlejandro;
