...
const MiradorDeUla = () => (
  <RestaurantPage
    restaurantName="Mirador de Ulía"
    address="Paseo de Ulía 193, Donostia / San Sebastián, 20013, Spain"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+34943272707"
    website="https://www.miradordeulia.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A special restaurant, particularly given its outstanding views of the city and Zurriola beach that will definitely grab your attention. Located at the top of Monte Ulía, it is run by chef Rubén Trincado, the third generation of the family, who has his own style yet with a culinary legacy rooted in tradition. His creatively inspired cuisine plays with native Guipúzcoa ingredients such as hake, but also focuses on dishes from the world’s “blue zones” where people live longer than anywhere else on the planet. He works with just two tasting menus: Vínculo (vegetarian) and Arraigo, both with a wine-pairing option...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20de%20Ul%C3%ADa%20193%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020013%2C%20Spain"
    pageTitle="Mirador de Ulía"
  />
);

export default MiradorDeUla;
