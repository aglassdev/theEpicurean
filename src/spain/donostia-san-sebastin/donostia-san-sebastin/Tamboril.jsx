...
const Tamboril = () => (
  <RestaurantPage
    restaurantName="Tamboril"
    address="Pescadería 2, Donostia / San Sebastián, 20003, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34943423507"
    website="https://guide.michelin.com/en/pais-vasco/es-donostia-san-sebastian/restaurant/tamboril"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of the old town, Tamboril is run by the family that owns the legendary Ganbara. The bar is teeming with traditional pintxos, with a special mention for the mushrooms!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pescader%C3%ADa%202%2C%20Donostia%20%2F%20San%20Sebasti%C3%A1n%2C%2020003%2C%20Spain"
    pageTitle="Tamboril"
  />
);

export default Tamboril;
