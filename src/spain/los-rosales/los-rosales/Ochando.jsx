...
const Ochando = () => (
  <RestaurantPage
    restaurantName="Ochando"
    address="Sevilla 78, Los Rosales, 41330, Spain"
    cuisine="Contemporary"
    priceRange="€"
    phoneNumber="+34613231617"
    website="https://ochandorestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Los Rosales, a district on the outskirts of the town of Tocina in the province of Seville, has made its mark on the region’s culinary map thanks to a couple who decided to return to their roots having worked in prestigious restaurants such as Atrio, Casa Marcial, Bardal, etc. In this unpretentiously furnished eatery run by Juan Carlos Ochando (in the kitchen) and Elena Pérez (front of house), the contemporary cuisine on offer is firmly focused on two tasting menus (Ochando and El Gran Ochando) and seasonal ingredients, with half-plates available with some dishes. We especially enjoyed the white prawn tartare with cashew nut ajoblanco and aniseed oil, the delicious red mullet bouillabaisse, and, for dessert, the original and deconstructed take on a piña colada featuring different textures a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sevilla%2078%2C%20Los%20Rosales%2C%2041330%2C%20Spain"
    pageTitle="Ochando"
  />
);

export default Ochando;
