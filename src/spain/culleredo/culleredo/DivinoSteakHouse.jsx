...
const DivinoSteakHouse = () => (
  <RestaurantPage
    restaurantName="Divino Steak House"
    address="Ramón Cabanillas, Culleredo, 15670, Spain"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+34881914412"
    website="https://divinosteakhouse.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ram%C3%B3n%20Cabanillas%2C%20Culleredo%2C%2015670%2C%20Spain"
    pageTitle="Divino Steak House"
  />
);

export default DivinoSteakHouse;
