...
const Agustina = () => (
  <RestaurantPage
    restaurantName="Agustina"
    address="Plaza del Concejo, Cazalla de la Sierra, 41370, Spain"
    cuisine="Contemporary, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34954883255"
    website="https://guide.michelin.com/en/andalucia/cazalla-de-la-sierra/restaurant/agustina"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20del%20Concejo%2C%20Cazalla%20de%20la%20Sierra%2C%2041370%2C%20Spain"
    pageTitle="Agustina"
  />
);
