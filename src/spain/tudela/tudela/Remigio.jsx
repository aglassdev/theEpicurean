...
const Remigio = () => (
  <RestaurantPage
    restaurantName="Remigio"
    address="Gaztambide-Carrera 4, Tudela, 31500, Spain"
    cuisine="Regional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+34948820850"
    website="https://www.hotelremigio.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A renovated house with plenty of history that in the past has hosted guests such as the famous Spanish poet Gustavo Adolfo Bécquer. Here, the updated take on regional cuisine is showcased on an à la carte and several set menus, with a strong focus on vegetables and farm produce – for over 20 years the restaurant has sourced ingredients from the famous Mejana de Tudela area on the banks of the Ebro river. It also features a gastronomic dining space called Choko del Remigio, with a focus on local, seasonally inspired cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gaztambide-Carrera%204%2C%20Tudela%2C%2031500%2C%20Spain"
    pageTitle="Remigio"
  />
);
