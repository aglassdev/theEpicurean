...
const Fmu = () => (
  <RestaurantPage
    restaurantName="Fūmu"
    address="Marqués de San Esteban 5, Gijón, 33206, Spain"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+34985079594"
    website="https://www.fumuomakase.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marqu%C3%A9s%20de%20San%20Esteban%205%2C%20Gij%C3%B3n%2C%2033206%2C%20Spain"
    pageTitle="Fūmu"
  />
);
