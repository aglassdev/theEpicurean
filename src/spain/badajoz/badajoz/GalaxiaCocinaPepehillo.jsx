...
const GalaxiaCocinaPepehillo = () => (
  <RestaurantPage
    restaurantName="Galaxia Cocina Pepehillo"
    address="Avenida Miguel Celdrán Matute 6, Badajoz, 06005, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34924258211"
    website="https://guide.michelin.com/en/extremadura/badajoz/restaurant/galaxia-cocina-pepehillo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A long-standing restaurant (it opened its doors in 1982) that wows with its renovated and original interior design and its extensive menu brimming with traditional flavours, particularly mouthwatering when it comes to fish and seafood, but without neglecting Extremadura's meats and cold cuts. Unmissable dishes? The Revuelto Pepehillo, the Sevillian hake, the tasty oxtail stew......"
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Miguel%20Celdr%C3%A1n%20Matute%206%2C%20Badajoz%2C%2006005%2C%20Spain"
    pageTitle="Galaxia Cocina Pepehillo"
  />
);

export default GalaxiaCocinaPepehillo;
