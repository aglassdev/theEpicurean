...
const Drmo = () => (
  <RestaurantPage
    restaurantName="Drómo"
    address="Antonio Martínez Virel 2, 1ª Planta, Badajoz, 06011, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34645613214"
    website="https://dromobadajoz.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Found on the first floor of a small shopping centre called Reina Mercedes (in the modern neighbourhood of Valdepasillas) and under the name Drómo, which has been retained from the previous establishment, lies a subtle nod to the life of Juan Manuel Salgado, the chef-owner. His cuisine embraces ‘informal haute cuisine’ and seeks to create an intimate experience, something you can enjoy more intensely if you sit at the bar, where you can observe every detail of his work. The elegant offering, typical of contemporary cuisine that draws on traditional Extremaduran recipes and childhood memories (pringá, puchero, cachuela, and Iberian pork), is available exclusively through two tasting menus (Drómo and Gran Viaje). A standout dish? We found his tartare of pork shoulder, pistachio and caviar par..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Antonio%20Mart%C3%ADnez%20Virel%202%2C%201%C2%AA%20Planta%2C%20Badajoz%2C%2006011%2C%20Spain"
    pageTitle="Drómo"
  />
);
