...
const TierraYVino = () => (
  <RestaurantPage
    restaurantName="Tierra y Vino"
    address="Constitución 12, Samaniego, 01307, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€€"
    phoneNumber="+34955660000"
    website="https://www.palaciodesamaniego.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tierra y Vino is part of the 18C Palacio de Samaniego, now converted into a luxury boutique hotel. Here, Portuguese-born chef Bruno Coelho offers his guests an à la carte that is constantly evolving and centred around locally sourced seasonal ingredients and dishes with added Galician and French culinary touches, alongside an interesting tasting menu (Edmond) that can be accompanied by two different wine pairings. The restaurant also houses a collection of works of art belonging to Baroness Ariane de Rothschild...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Constituci%C3%B3n%2012%2C%20Samaniego%2C%2001307%2C%20Spain"
    pageTitle="Tierra y Vino"
  />
);

export default TierraYVino;
