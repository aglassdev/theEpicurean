...
const SilboGomero = () => (
  <RestaurantPage
    restaurantName="Silbo Gomero"
    address="Volcán Elena 9, San Cristóbal de la Laguna, 38108, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34922310355"
    website="https://guide.michelin.com/en/canarias/san-cristobal-de-la-laguna/restaurant/tasca-silbo-gomero"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mojo is a traditional Canary Island sauce that can be used in various ways and chef Braulio Simancas is a specialist when it comes to using this iconic salsa to bring enhanced flavour to some of his dishes. Named after the whistling language once used on the island of La Gomera, this unpretentious restaurant located next to a shopping centre that is close to the Pabellón de Deportes de Tenerife Santiago Martín sports complex showcases cuisine with its roots in the Canary Islands, albeit with a modern, light and delicate touch and impeccable technique. The unique cheeses on the menu are personally matured by the chef. Standout dishes include meat cooked in a traditional marinade, the “escaldón” of fish and Gomeran gofio, and, for dessert, the “frangollo” with raisin jam and sweet wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Volc%C3%A1n%20Elena%209%2C%20San%20Crist%C3%B3bal%20de%20la%20Laguna%2C%2038108%2C%20Spain"
    pageTitle="Silbo Gomero"
  />
);

export default SilboGomero;
