...
const Quimera = () => (
  <RestaurantPage
    restaurantName="Quimera"
    address="Avinguda de la Mediterrània 22, La Savina, 07870, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34971322279"
    website="https://www.quimerarestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Watching the sun set as its dips below the surface of the sea is a privilege enjoyed almost daily on the terrace at Quimera. In this pleasant and attractive restaurant beneath the Hostal La Savina, enjoy contemporary Mediterranean cuisine that is both delicate and consistent and which also flies the flag for the island’s sustainability and its native ingredients. This explains the focus on produce from La Savina’s own kitchen garden, as well as superb fish from the island’s waters, and locally sourced meat. The perfect dinner venue!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avinguda%20de%20la%20Mediterr%C3%A0nia%2022%2C%20La%20Savina%2C%2007870%2C%20Spain"
    pageTitle="Quimera"
  />
);

export default Quimera;
