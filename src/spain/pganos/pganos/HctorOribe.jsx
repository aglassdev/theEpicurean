...
const HctorOribe = () => (
  <RestaurantPage
    restaurantName="Héctor Oribe"
    address="Gasteiz 8, Páganos, 01309, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34945600715"
    website="https://www.hectororibe.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gasteiz%208%2C%20P%C3%A1ganos%2C%2001309%2C%20Spain"
    pageTitle="Héctor Oribe"
  />
);

export default HctorOribe;
