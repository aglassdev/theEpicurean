...
const 539PlatsForts = () => (
  <RestaurantPage
    restaurantName="539, Plats Forts"
    address="Carrer de Les Escoles Pies 45, Puigcerdà, 17520, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34647592839"
    website="https://guide.michelin.com/en/catalunya/puigcerda_1439578/restaurant/539-plats-forts"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this simple restaurant, everything revolves around the Japanese-inspired counter and the figure of experienced Martín Comamala, who has worked in kitchens around the world (both in Latin America and Europe) and who takes on the role of chef d’orchestre here, taking care of absolutely everything. As he works on his own, he cooks, takes care of guests, explains his dishes and even purchases the superb ingredients he works with from the fish auction in Blanes and directly from local farmers and breeders. His cuisine has a strong Mediterranean influence and is showcased in three tasting menus (8 Pases, 11 Pases y Experiencia completa), all of which are constantly changing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carrer%20de%20Les%20Escoles%20Pies%2045%2C%20Puigcerd%C3%A0%2C%2017520%2C%20Spain"
    pageTitle="539, Plats Forts"
  />
);

export default 539PlatsForts;
