...
const EsCranc = () => (
  <RestaurantPage
    restaurantName="Es Cranc"
    address="Escoles 31, Fornells, 07748, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34971376442"
    website="http://www.escranc.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with a simple rustic Menorcan atmosphere located in a building with whitewashed walls. Here you will find traditional cuisine specialising in rice dishes and stews, always focused on seafood and high-quality ingredients (don't miss their famous lobster stew). Interesting fact: For some of the more finger-licking dishes, they put a bib on you so that you don't stain your clothes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Escoles%2031%2C%20Fornells%2C%2007748%2C%20Spain"
    pageTitle="Es Cranc"
  />
);

export default EsCranc;
