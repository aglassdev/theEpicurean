...
const Anhelo = () => (
  <RestaurantPage
    restaurantName="Anhelo"
    address="Maestro Ripollés 6, Castelló de la Plana, 12003, Spain"
    cuisine="Farm to table, Contemporary"
    priceRange="€€"
    phoneNumber="+34624610258"
    website="https://www.anhelorestaurant.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The heart and soul of this small eatery in the centre of town is owner-chef Cristian Granero, who began his career in the restaurant business as a baker and pastry chef, both of which served as a good apprenticeship before he headed to the kitchen stoves. His cuisine, the aim of which, in his own words, is to “wake up the senses and connect with the emotions”, is based around three menus: D'Uixó, Sentidos and Anhelo. The restaurant also boasts a kitchen that is visible to guests seated at one of its five tables. Because of these restricted numbers, it’s well worth booking ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maestro%20Ripoll%C3%A9s%206%2C%20Castell%C3%B3%20de%20la%20Plana%2C%2012003%2C%20Spain"
    pageTitle="Anhelo"
  />
);

export default Anhelo;
