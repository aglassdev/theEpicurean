...
const IzakayaTascaJaponesa = () => (
  <RestaurantPage
    restaurantName="IZAKAYA Tasca Japonesa"
    address="Temprado 2, Castelló de la Plana, 12002, Spain"
    cuisine="Japanese, Fusion"
    priceRange="€"
    phoneNumber="+34656285566"
    website="https://www.izakayacs.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If a total immersion in popular Japanese cuisine sounds appealing, this small, modest and informal “tasca”-style eatery (with space for just 16 guests) will fit the bill, thanks to its pure Japanese cuisine featuring including powerful and intense flavours. Chef Sergio Ortega enjoys explaining each dish to his customers as well as relating interesting anecdotes from his many trips to Japan (mainly Tokyo). He offers a single surprise tasting menu that changes daily, with more of a focus on hot dishes (ramen, gyoza, edemame, stews etc) than on rice and raw fish. Before serving each course, he claps his hands twice to the cry of “ofrenda’” a traditional ritual in which gifts are given to the gods, spirits or divine mortals, known as “kami” (in this case, the “gods” in question are the guests!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Temprado%202%2C%20Castell%C3%B3%20de%20la%20Plana%2C%2012002%2C%20Spain"
    pageTitle="IZAKAYA Tasca Japonesa"
  />
);

export default IzakayaTascaJaponesa;
