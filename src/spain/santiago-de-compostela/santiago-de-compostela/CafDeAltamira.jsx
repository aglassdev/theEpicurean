...
const CafDeAltamira = () => (
  <RestaurantPage
    restaurantName="Café de Altamira"
    address="Ameas 9, Santiago de Compostela, 15704, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34981558592"
    website="https://www.cafedealtamira.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its strapline, “the flavour of the market”, says it all! This friendly restaurant in the Pazo de Altamira hotel (with its own entrance and independent management) comes as a pleasant surprise with its decor of light bulbs hanging from the ceiling, unusual bottle racks and colourful tableware by Sargadelos, all of which create a rustic yet vintage feel. At its large tables designed for sharing, discover pleasantly updated traditional cooking with plenty of personality and a philosophy that showcases the flavours of Galician cuisine (we particularly enjoyed the lightly roasted mackerel with “ajoblanco” and cherry-ponzu tomato) both on the à la carte and its enticing tasting menus (Ameas and Altamira). The restaurant’s location right next to the busy food market also ensures that its ingredie..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ameas%209%2C%20Santiago%20de%20Compostela%2C%2015704%2C%20Spain"
    pageTitle="Café de Altamira"
  />
);

export default CafDeAltamira;
