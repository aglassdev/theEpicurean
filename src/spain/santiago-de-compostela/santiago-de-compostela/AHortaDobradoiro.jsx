...
const AHortaDobradoiro = () => (
  <RestaurantPage
    restaurantName="A Horta d'Obradoiro"
    address="Hortas 16, Santiago de Compostela, 15705, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34881031375"
    website="https://ahortadoobradoiro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This impressively unique restaurant serves interesting cuisine while at the same time showcasing a part of Santiago’s rich history. Run by two chefs, it occupies a house dating back to 1690 which was once home to musicians from the nearby cathedral. It features a combination of contemporary and regional decor, a wine bar made from old beams, colourful details that are reminiscent of old beach huts, a conservatory-style room, plus a garden with a vegetable plot which is a real luxury in this part of the city. Carefully prepared and beautifully presented seasonal cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hortas%2016%2C%20Santiago%20de%20Compostela%2C%2015705%2C%20Spain"
    pageTitle="A Horta d'Obradoiro"
  />
);

export default AHortaDobradoiro;
