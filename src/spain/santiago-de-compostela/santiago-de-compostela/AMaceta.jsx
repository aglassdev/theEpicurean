...
const AMaceta = () => (
  <RestaurantPage
    restaurantName="A Maceta"
    address="San Pedro 120, Santiago de Compostela, 15703, Spain"
    cuisine="Fusion"
    priceRange="€€"
    phoneNumber="+34981589600"
    website="https://www.amaceta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is situated on the Rúa de San Pedro, the road into the city taken by pilgrims arriving via the Camino Francés, the Camino del Norte or the Camino Primitivo. Here, on the ground floor of an unpretentious stone building with a relaxed, rustic-contemporary ambience, Jorge Gago creates fusion cuisine that combines traditional and Asian recipes (leeks, stracciatella di bufala and almonds, mackerel sashimi and, for dessert, the hazelnut millefeuille). Additional bonuses here are the pleasant patio-terrace – the perfect setting for a relaxed meal or drink – and the extensive wine list featuring an impressive choice of sparkling wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Pedro%20120%2C%20Santiago%20de%20Compostela%2C%2015703%2C%20Spain"
    pageTitle="A Maceta"
  />
);

export default AMaceta;
