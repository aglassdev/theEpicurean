...
const MarDeEsteiro = () => (
  <RestaurantPage
    restaurantName="Mar de Esteiro"
    address="Lugar Ponte Sionlla, Santiago de Compostela, 15884, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34981888057"
    website="https://www.mardeesteiro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best places for top-quality fish and seafood in Santiago. The success of this restaurant situated about 6km from Santiago is undoubtedly down to its superb ingredients, although the building itself is unique – the restaurant occupies an imposing renovated house which is a listed cultural monument. It also boasts an attractive garden with a summer terrace, a private bar and a number of contemporary-style dining rooms occupying what were once the bedrooms. Make sure you try the main speciality here (lobster with rice) as well as some of its popular stews (gurnard, brill, turbot, lobster with broad beans, plus spider crab in season)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lugar%20Ponte%20Sionlla%2C%20Santiago%20de%20Compostela%2C%2015884%2C%20Spain"
    pageTitle="Mar de Esteiro"
  />
);

export default MarDeEsteiro;
