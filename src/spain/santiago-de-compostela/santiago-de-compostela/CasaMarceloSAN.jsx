...
const CasaMarceloSAN = () => (
  <RestaurantPage
    restaurantName="Casa Marcelo"
    address="Hortas 1, Santiago de Compostela, 15705, Spain"
    cuisine="Fusion"
    priceRange="€€€"
    phoneNumber="+34981558580"
    website="https://www.casamarcelo.net"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located just a few metres from the cathedral, Casa Marcelo is the reward for many pilgrims when they complete the legendary Camino de Santiago and is worthy recompense (some would even say it is a religious experience in itself!) for all their exertions. This cosmopolitan setting, in which the chefs interact with guests, features a large central table with a convivial ambience (a nod to the friendly spirit of the Galician people), a counter to one side, a kitchen that is part of the dining room and, to the rear, a pleasant terrace full of vegetation, where you’ll also find a bright and colourful glass-fronted dining room. All you need to do here is choose the number of dishes you wish to eat (four or eight) and allow chef Marcelo Tejedor to prepare a surprise tasting menu for you. His cuis..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hortas%201%2C%20Santiago%20de%20Compostela%2C%2015705%2C%20Spain"
    pageTitle="Casa Marcelo"
  />
);

export default CasaMarceloSAN;
