...
const TorralbencMenorca = () => (
  <RestaurantPage
    restaurantName="Torralbenc Menorca"
    address="Carretera Maó-Cala en Porter, Cala en Porter, 07730, Spain"
    cuisine="Farm to table"
    priceRange="€€€€"
    phoneNumber="+34971377211"
    website="https://www.torralbenc.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant, where the cuisine is overseen by renowned chef Gorka Txapartegui (Alameda restaurant in Hondarribia), occupies a farmhouse surrounded by vineyards and boasting a tranquil terrace, all of which comes as a pleasant surprise. It also provides the dining service for the hotel of the same name (awarded one Michelin key) and will delight guests with its tranquil terraces, contemporary European and internationally inspired cuisine, and a constant nod to local flavours and native ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20Ma%C3%B3-Cala%20en%20Porter%2C%20Cala%20en%20Porter%2C%2007730%2C%20Spain"
    pageTitle="Torralbenc Menorca"
  />
);

export default TorralbencMenorca;
