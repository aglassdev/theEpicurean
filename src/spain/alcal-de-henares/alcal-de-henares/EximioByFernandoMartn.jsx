...
const EximioByFernandoMartn = () => (
  <RestaurantPage
    restaurantName="Eximio by Fernando Martín"
    address="Victoria 2, Alcalá de Henares, 28802, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34915138980"
    website="https://www.restauranteeximio.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re visiting Alcalá de Henares, the birthplace of the famous writer Miguel de Cervantes, make sure you dine at this restaurant located just a few metres from Alcalá’s “Catedral Magistral” (the restaurant’s name, meaning “eminent” in English, is a nod to the “magistral” status of the cathedral). It is run by a chef who has learnt his trade in some of Spain’s leading restaurants such as at Martín Berasategui in Lasarte-Oria. His updated take on traditional cuisine is showcased on an à la carte, a good-value lunchtime menu (Monday to Friday), as well as on a more elaborate tasting-style menu that changes with the seasons. In the chef’s own words, his aim is to “ensure that every guest who walks through the door has a different gastronomic experience”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Victoria%202%2C%20Alcal%C3%A1%20de%20Henares%2C%2028802%2C%20Spain"
    pageTitle="Eximio by Fernando Martín"
  />
);

export default EximioByFernandoMartn;
