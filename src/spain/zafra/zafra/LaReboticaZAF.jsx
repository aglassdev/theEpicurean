...
const LaReboticaZAF = () => (
  <RestaurantPage
    ...
    address="Botica 12, Zafra, 06300, Spain"
    cuisine="Traditional Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34924554289"
    website="https://www.lareboticazafra.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Botica%2012%2C%20Zafra%2C%2006300%2C%20Spain"
    pageTitle="La Rebotica"
  />
);

export default LaReboticaZAF;
