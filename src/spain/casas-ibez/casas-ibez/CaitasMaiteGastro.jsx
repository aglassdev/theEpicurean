...
const CaitasMaiteGastro = () => (
  <RestaurantPage
    restaurantName="Cañitas Maite Gastro"
    address="Tomás Pérez Úbeda 6, Casas-Ibáñez, 02200, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34967461054"
    website="https://hotelcanitasmaite.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by two local chefs who offer two different menus: “De Barra”, based around contemporary tapas, and “De Producto”, offering modern dishes that showcase the La Mancha region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tom%C3%A1s%20P%C3%A9rez%20%C3%9Abeda%206%2C%20Casas-Ib%C3%A1%C3%B1ez%2C%2002200%2C%20Spain"
    pageTitle="Cañitas Maite Gastro"
  />
);

export default CaitasMaiteGastro;
