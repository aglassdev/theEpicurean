...
const LaMoreraDePabloEster = () => (
  <RestaurantPage
    restaurantName="La Morera de Pablo & Ester"
    address="Berenguer de Palou 10, Salou, 43840, Spain"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+34977385763"
    website="https://guide.michelin.com/en/catalunya/salou/restaurant/la-morera-de-pablo-y-ester"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a convenient location near the Plaça de la Pau, away from the tourist crowds, this restaurant boasts a completely glass-fronted dining room complemented by an attractive outdoor terrace in the shade of a large mulberry tree. The modern, fun and traditionally based menu includes short explanations and sketches of the dishes, which are always meticulously presented. A tasting menu is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Berenguer%20de%20Palou%2010%2C%20Salou%2C%2043840%2C%20Spain"
    pageTitle="La Morera de Pablo & Ester"
  />
);

export default LaMoreraDePabloEster;
