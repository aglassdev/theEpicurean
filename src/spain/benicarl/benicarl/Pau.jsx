...
const Pau = () => (
  <RestaurantPage
    restaurantName="Pau"
    address="Avenida Marqués de Benicarló 11, Benicarló, 12580, Spain"
    cuisine="Rice Dishes, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34622118576"
    website="https://www.paurestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with a modern, relaxed Mediterranean feel where equality is very much to the fore, with the owner-chef often keeping an eye on the dining room and explaining dishes to guests. Although Pau’s delicious rice dishes are particularly renowned, everything is delicious here thanks to a focus on cooking that showcases local products with an added hint of creativity. Choose from three well-crafted menus at lunchtime (including one executive-style menu) and two in the evening, the latter with the option of choosing dishes from the à la carte. The pleasant musical ambience completes the picture here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Marqu%C3%A9s%20de%20Benicarl%C3%B3%2011%2C%20Benicarl%C3%B3%2C%2012580%2C%20Spain"
    pageTitle="Pau"
  />
);
