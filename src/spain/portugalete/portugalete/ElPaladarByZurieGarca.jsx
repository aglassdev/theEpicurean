...
const ElPaladarByZurieGarca = () => (
  <RestaurantPage
    restaurantName="El Paladar by Zuriñe García"
    address="María Díaz de Haro 2, Portugalete, 48920, Spain"
    cuisine="Basque"
    priceRange="€€€"
    phoneNumber="+34944014800"
    website="https://www.puentecolganteboutiquehotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Basque cuisine has found a new home in the Puente Colgante Boutique Hotel, a property designed in a delightful Spanish colonial style. The cuisine here is overseen by chef Zuriñe García, who has already enjoyed considerable success at the legendary Andra Mari in Galdakao. Here, he showcases traditional cuisine deeply rooted in the culinary traditions of Vizcaya that showcases his elegant personal touches alongside top-quality ingredients. The à la carte is complemented by two tasting menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mar%C3%ADa%20D%C3%ADaz%20de%20Haro%202%2C%20Portugalete%2C%2048920%2C%20Spain"
    pageTitle="El Paladar by Zuriñe García"
  />
);

export default ElPaladarByZurieGarca;
