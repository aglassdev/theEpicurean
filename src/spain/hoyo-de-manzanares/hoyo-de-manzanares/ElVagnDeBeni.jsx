...
const ElVagnDeBeni = () => (
  <RestaurantPage
    restaurantName="El Vagón de Beni"
    address="San Macario 6, Hoyo de Manzanares, 28240, Spain"
    cuisine="Traditional Cuisine, Spanish"
    priceRange="€€"
    phoneNumber="+34918566812"
    website="https://www.elvagondebeni.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Your imagination will carry you back in time in this charming restaurant, located in the centre of Hoyo de Manzanares just a few steps from the Plaza Mayor, where it recreates the ambience of an old railway station complete with beautiful vintage train carriages. Extraordinary and delightful in equal measure, its two restored antique carriages (one called Vagón 1931, the other Vagón Alfonso XIII) provide the dining venue, alongside tables that are even laid out on the platform. The cuisine, an impressive updated take on traditional roots, is showcased on an à la carte and several menus: Ejecutivo (lunchtime, Tuesday to Friday only), Gastronómico, and the Degustación tasting option. A perfect setting for a romantic dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Macario%206%2C%20Hoyo%20de%20Manzanares%2C%2028240%2C%20Spain"
    pageTitle="El Vagón de Beni"
  />
);

export default ElVagnDeBeni;
