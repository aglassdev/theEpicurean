...
const MasRomeu = () => (
  <RestaurantPage
    restaurantName="Mas Romeu"
    address="Av. Mas Romeu, 3, Lloret de Mar, 17310, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34972367963"
    website="https://www.masromeu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A little away from the centre but with a pleasant tree - shaded terrace. This family - run restaurant offers several set menus alongside an extensive à la carte with sections devoted to grilled meats, fish, seafood, stews and house specialities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Mas%20Romeu%2C%203%2C%20Lloret%20de%20Mar%2C%2017310%2C%20Spain"
    pageTitle="Mas Romeu"
  />
);

export default MasRomeu;
