...
const VillaXarahiz = () => (
  <RestaurantPage
    restaurantName="Villa Xarahiz"
    address="Carretera EX 203, Jaraíz de la Vera, 10400, Spain"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+34927665150"
    website="https://www.villaxarahiz.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run restaurant with rooms available for those guests keen to explore the beautiful La Vera region. It is run by two siblings, Pilar and Víctor, who have taken over the reins here with both enthusiasm and dedication. Choose from two menus – a set daily option and a more seasonal offering, the latter changing three times a year. These feature Iberian meats, suckling pig, young local goat, and the famous Grandma Fidela’s “migas”, which are renowned throughout the local area. Víctor is also a lover of rum, hence the choice of over 100 different labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20EX%20203%2C%20Jara%C3%ADz%20de%20la%20Vera%2C%2010400%2C%20Spain"
    pageTitle="Villa Xarahiz"
  />
);

export default VillaXarahiz;
