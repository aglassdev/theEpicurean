...
const ElAlberoTOL = () => (
  <RestaurantPage
    ...
    address="de la Diputación 6, Toledo, 45004, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34925254069"
    website="https://elalberorestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant, located away from the main tourist area of the city and with many years of history under its belt, is enjoying a second “golden age” in the hands of young owner-chef Ismael Suleiman, who has brought a new lease of life and a more gastronomic feel to the cuisine. The overall feel here is that of a neighbourly and informal bistro with a single dining room plus a pavement terrace. The cooking is traditional in style, featuring seasonal ingredients and meticulous presentation, with a strong focus on delicious stews such as Toledo-style partridge stew with white beans, and stuffed oxtail with red wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=de%20la%20Diputaci%C3%B3n%206%2C%20Toledo%2C%2045004%2C%20Spain"
    pageTitle="El Albero"
  />
);

export default ElAlberoTOL;
