...
const VitucoGourmet = () => (
  <RestaurantPage
    restaurantName="Vituco Gourmet"
    address="Susana Llaneras 18, Alacant, 03001, Spain"
    cuisine="Peruvian"
    priceRange="€"
    phoneNumber="+34722528506"
    website="https://vitucogourmet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bright, stone-walled restaurant in the heart of Alacant is the dream come true of chef Javier Beltri, who named the restaurant after his father (Victor Beltri, known to his family as Vituco). After training at Le Cordon Bleu, the Basque Culinary Center and various prestigious restaurants, here he seeks to offer us an itinerant proposal that flutters between the Mediterranean and Peru (especially surprising in the rice dishes, seasoned with products from this South American country). Interesting dishes? The Ensaladilla with soy mayonnaise and aji amarillo, the Anticucho a la brasa, the Arroz de cerdo con aji panca y cebolla morada (pork rice with aji panca and red onion)......"
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Susana%20Llaneras%2018%2C%20Alacant%2C%2003001%2C%20Spain"
    pageTitle="Vituco Gourmet"
  />
);

export default VitucoGourmet;
