...
const SaJambina = () => (
  <RestaurantPage
    restaurantName="Sa Jambina"
    address="Boffil i Codina 21, Calella de Palafrugell, 17210, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34872583008"
    website="https://www.restaurantsajambina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run establishment, whose name harks back to an old fishing tool similar to the nansa, is a great place to eat in this town, as it is located just one row back from the nearby beaches of Les Barques and Malaspina. The kitchen serves up updated traditional seafood cuisine with a few international touches, always highlighting the quality of fresh Mediterranean produce, cooked with great care. Top picks from its menu, which is based on market availability and includes daily specials, include the shrimp tartare and the fish of the day, baked or salt-crusted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boffil%20i%20Codina%2021%2C%20Calella%20de%20Palafrugell%2C%2017210%2C%20Spain"
    pageTitle="Sa Jambina"
  />
);

export default SaJambina;
