...
const VtricTavernaGastronmica = () => (
  <RestaurantPage
    restaurantName="VÍTRIC Taverna Gastronòmica"
    address="Santa Anna 24, Reus, 43201, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34977433673"
    website="https://vitricrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this quiet pedestrian street we came across this young chef who, having worked in several leading restaurants, returned to his roots to go it alone. In this restaurant that defines itself as a gastronomic taberna, you’ll find an open kitchen at the entrance with a bright dining room to the rear. The contemporary Catalan cuisine here is showcased on an à la carte that includes plates for sharing, an impressive daily menu plus a separate tasting-style option. We can recommend the twice-cooked eggs with parmentier and grilled liver… not forgetting the local vermouth!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Santa%20Anna%2024%2C%20Reus%2C%2043201%2C%20Spain"
    pageTitle="VÍTRIC Taverna Gastronòmica"
  />
);

export default VtricTavernaGastronmica;
