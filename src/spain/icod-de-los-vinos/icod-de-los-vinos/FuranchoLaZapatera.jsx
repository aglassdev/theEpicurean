...
const FuranchoLaZapatera = () => (
  <RestaurantPage
    restaurantName="Furancho La Zapatería"
    address="Paseo Canarina 18, Icod de los Vinos, 38430, Spain"
    cuisine="Galician"
    priceRange="€"
    phoneNumber="+34672692226"
    website="https://guide.michelin.com/en/canarias/icod-de-los-vinos/restaurant/furancho-la-zapateria"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Galician restaurant on Tenerife that, despite its simple decor, is highly original. Behind its colourful façade, which recreates the glass frontage of an old shoe shop, the friendly couple running it (Emma is in the kitchen; Alberto in the dining room) focus on an unusual combination of Galician and Canary Island products, the former brought in fresh from Fisterra (La Coruña) every other day by the owner’s brother. Highlights on the menu here include the octopus empanadas, the entrecôte of Galician veal, grilled scallops, and mussels with a mojo sauce that are a must. Only cash payment accepted!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Canarina%2018%2C%20Icod%20de%20los%20Vinos%2C%2038430%2C%20Spain"
    pageTitle="Furancho La Zapatería"
  />
);

export default FuranchoLaZapatera;
