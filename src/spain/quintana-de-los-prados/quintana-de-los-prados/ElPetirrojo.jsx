...
const ElPetirrojo = () => (
  <RestaurantPage
    restaurantName="El Petirrojo"
    address="Lugar de Quintana de los Prados 44, Quintana de los Prados, 09569, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34630123831"
    website="https://guide.michelin.com/en/castilla-y-leon/quintana-de-los-prados/restaurant/el-petirrojo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming restaurant occupying a stone house with a well-maintained small garden and a rustic interior featuring plenty of attention to detail. The culinary focus from the pleasant couple that owns El Petirrojo is on traditional Basque-influenced cuisine specialising in cod dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lugar%20de%20Quintana%20de%20los%20Prados%2044%2C%20Quintana%20de%20los%20Prados%2C%2009569%2C%20Spain"
    pageTitle="El Petirrojo"
  />
);

export default ElPetirrojo;
