...
const EntreDosMons = () => (
  <RestaurantPage
    restaurantName="Entre dos Mons"
    address="Tauler i Servià 21, Palamós, 17230, Spain"
    cuisine="Peruvian"
    priceRange="€€"
    phoneNumber="+34671519018"
    website="https://www.entredosmons.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tauler%20i%20Servi%C3%A0%2021%2C%20Palam%C3%B3s%2C%2017230%2C%20Spain"
    pageTitle="Entre dos Mons"
  />
);

export default EntreDosMons;
