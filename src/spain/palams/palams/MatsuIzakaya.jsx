...
const MatsuIzakaya = () => (
  <RestaurantPage
    restaurantName="Matsu Izakaya"
    address="Industria 4, Palamós, 17230, Spain"
    cuisine="Japanese Contemporary"
    priceRange="€€"
    phoneNumber="+34872200511"
    website="https://guide.michelin.com/en/catalunya/palamos/restaurant/matsu-izakaya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple “izakaya” is run by two young partners from the Dominican Republic who have embarked upon their first solo venture following several years working in restaurants in Barcelona. Thankfully, it has had a positive impression on locals thanks to their friendly approach and the varied selection of Japanese-inspired cuisine on offer, featuring an array of modern touches and dishes teeming with flavour. Here, you’ll also find the usual nigiri and sashimi, but almost everyone veers towards the crispy shiso starter with burrata stracciatella, truffled honey and Iberian pork jowl, the varied choice of sushi rolls, and ending with a dish or two cooked on the robata grill, such as the superb Katshu Sando, a fusion between the popular smoked pork chops from the Dominican Republic and tonkats..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Industria%204%2C%20Palam%C3%B3s%2C%2017230%2C%20Spain"
    pageTitle="Matsu Izakaya"
  />
);

export default MatsuIzakaya;
