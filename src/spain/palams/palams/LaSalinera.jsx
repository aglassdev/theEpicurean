...
const LaSalinera = () => (
  <RestaurantPage
    restaurantName="La Salinera"
    address="Avenida Onze de Setembre 93, Palamós, 17230, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34972316474"
    website="https://guide.michelin.com/en/catalunya/palamos/restaurant/la-salinera"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The impressive endeavours of Josep in the kitchen and Montse in the dining room sum up the philosophy of this restaurant, which is easy to find thanks to its location close to the port in Palamós. This is without doubt a restaurant with its own personality and character as it occupies a building that was once a salting factory. The pleasant air-conditioned terrace by the entrance leads to a welcoming modern interior with live seafood tanks and two dining rooms with attractive barrel-vaulted ceilings that come as a pleasant surprise. The Mediterranean-inspired cuisine is heavily influenced by fish and seafood sourced on the Costa Brava...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Onze%20de%20Setembre%2093%2C%20Palam%C3%B3s%2C%2017230%2C%20Spain"
    pageTitle="La Salinera"
  />
);

export default LaSalinera;
