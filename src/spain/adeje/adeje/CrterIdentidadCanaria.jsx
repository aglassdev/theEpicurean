...
const CrterIdentidadCanaria = () => (
  <RestaurantPage
    restaurantName="Cráter - Identidad Canaria"
    address="Alcojora s/n, Adeje, 38660, Spain"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+34922980950"
    website="https://www.barcelo.com/es-es/royal-hideaway-corales-villas/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under that striking term from the volcanic lexicon (Crater), this restaurant, which brings the gourmet offering of the luxurious Royal Hideaway Corales Villas to life, aims to be a showcase for the history, gastronomy and culture of the Canary Islands. The restaurant, located on the first floor of the hotel, features an open kitchen and a pleasant terrace overlooking the golf courses, with the ocean as a backdrop. Tenerife-born chef Eduardo Domínguez proposes a menu of delicate dishes that seek to promote Canary Island cuisine from a creative perspective, dedicating each season to one of the eight islands. On this occasion, everything revolves around La Palma, the so-called Isla Bonita, through two tasting menus: La Danza del Minué and La Danza de los Enanos (you will find dishes like El e..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alcojora%20s%2Fn%2C%20Adeje%2C%2038660%2C%20Spain"
    pageTitle="Cráter - Identidad Canaria"
  />
);

export default CrterIdentidadCanaria;
