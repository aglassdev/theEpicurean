...
const MesnOctavio = () => (
  <RestaurantPage
    restaurantName="Mesón Octavio"
    address="Severo Ochoa 6, Ciudad Real, 13005, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34926256050"
    website="https://mesonoctavio.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s very rare to come across a restaurant such as this one where every mouthful reminds us of our mothers’ and grandmothers’ cooking! Impressively run by three siblings (Aurora, Belén and José), its focus is on traditional La Mancha dishes teeming with flavour and with a strong emphasis on game (venison, red-legged partridge, wild boar etc) and beef from the Sierra de San Vicente. Highlights on the à la carte, which pays tribute to the female members of this family, include dishes teeming with character such as the “pisto manchego”, the fried breadcrumb and egg-based “migas del pastor & Huevos de gallina feliz”, the popular wild boar meatballs, and the innovative “El Barquero cod...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Severo%20Ochoa%206%2C%20Ciudad%20Real%2C%2013005%2C%20Spain"
    pageTitle="Mesón Octavio"
  />
);

export default MesnOctavio;
