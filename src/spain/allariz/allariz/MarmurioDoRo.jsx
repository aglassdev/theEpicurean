...
const MarmurioDoRo = () => (
  <RestaurantPage
    restaurantName="Marmurio do Río"
    address="Rúa Do Cárcere 7, Allariz, 32660, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34988891204"
    website="https://marmuriodorio.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A unique restaurant occupying the stone house that was once home to the century-old Casa Fandiño restaurant. Today, the name, which translates as the “murmur of the river” in Galician, pays a discreet tribute to the poem Dark Shadow by the renowned Galician poet Rosalía de Castro. The first thing that strikes you here is the meticulous, rustic-contemporary interior decor, which is almost an extension of the charm found in the streets of Allariz. Madrid-born chef Luis Moreno, who previously enjoyed success at the Montia restaurant in San Lorenzo del Escorial, created this project in the town where he always spent his summers. Dining options are based around two tasting menus: one short option entitled “Río” and a second longer one called Marmurio. The chef works with small-scale producers f..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R%C3%BAa%20Do%20C%C3%A1rcere%207%2C%20Allariz%2C%2032660%2C%20Spain"
    pageTitle="Marmurio do Río"
  />
);

export default MarmurioDoRo;
