...
const Akase = () => (
  <RestaurantPage
    restaurantName="Akase"
    address="Fernando Viola, Edificio Málaga, local 8, Jerez de la Frontera, 11404, Spain"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+34674395074"
    website="https://www.akaserestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Akase, where the restaurant describes what it offers as “market-inspired cuisine with a Japanese soul”, the focus is on ingredients sourced from in and around Cádiz in order to create surprising Japanese cuisine that is guaranteed to please guests’ palates. Chef Jaime Mena’s cooking, with its emphasis on show-cooking for a maximum of 10 covers per service, is showcased on a single tasting menu (Daimyo) that starts with several Cádiz dishes prepared with techniques from the Far East, and continues (through a selection of nigiris) with typical fish sourced from different towns along the local coast (Chipiona, Rota, Barbate, Chiclana, Conil etc). When it comes to dessert, the emphasis is on classic Japanese dishes which provide an opportunity to explore the bodegas and vineyards of Jerez a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fernando%20Viola%2C%20Edificio%20M%C3%A1laga%2C%20local%208%2C%20Jerez%20de%20la%20Frontera%2C%2011404%2C%20Spain"
    pageTitle="Akase"
  />
);

export default Akase;
