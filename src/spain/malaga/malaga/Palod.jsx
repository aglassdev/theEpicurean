...
const Palod = () => (
  <RestaurantPage
    restaurantName="Palodú"
    address="Sebastián Souvirón 7-9, Malaga, 29005, Spain"
    cuisine="Contemporary, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34951777101"
    website="https://www.palodurestaurante.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant, just a few steps from the legendary Atarazanas market, is one of those restaurants you’ll love visiting thanks to its constant desire to improve. The couple in charge of the kitchen (Cristina Cánovas and Diego Aguilar), both of whom have trained in leading restaurants, have used the initials of their first names to come up with the concept of “Dual Cuisine” (this sense of duality can also be seen in Palodú’s dining rooms – one, with an open kitchen, decorated in black tones, the other dominated by the colour white). Their cooking is focused on two tasting menus called Alcazul and Palodú, both based around seasonal dishes and accompanied by a wine-pairing option. The intensely flavoured “sequence” of “red mullet - gazpachuelo – potato” served together is particul..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sebasti%C3%A1n%20Souvir%C3%B3n%207-9%2C%20Malaga%2C%2029005%2C%20Spain"
    pageTitle="Palodú"
  />
);

export default Palod;
