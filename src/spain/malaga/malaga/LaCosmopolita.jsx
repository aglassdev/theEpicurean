...
const LaCosmopolita = () => (
  <RestaurantPage
    restaurantName="La Cosmopolita"
    address="José Denís Belgrano 3, Malaga, 29015, Spain"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+34952215827"
    website="https://lacosmopolita.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of the old town, this restaurant is striking for its rustic and vintage-style decor. Fun, market-inspired cuisine centred on Andalucian ingredients with an exotic touch. Pleasant terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jos%C3%A9%20Den%C3%ADs%20Belgrano%203%2C%20Malaga%2C%2029015%2C%20Spain"
    pageTitle="La Cosmopolita"
  />
);

export default LaCosmopolita;
