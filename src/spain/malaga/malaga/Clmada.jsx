...
const Clmada = () => (
  <RestaurantPage
    restaurantName="Clómada"
    address="Méndez Núñez 12, Malaga, 29007, Spain"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+34627507095"
    website="https://www.clomadarestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fancy a distinctly-feminine international experience? Here you can have one, as the Ecuadorian chef Claudine Paulson, well accompanied by a team that is made up entirely of women, brings to the table the different flavours that she has come to know around the world during her time as a professional tennis player (she was the number one tennis player in Ecuador), a career that she combined with her hotel and catering studies. Within the proposal, with numerous international influences that evoke her nomadic lifestyle, dishes such as the fish ceviche or the crispy sea bass stand out. The logo and the striking lamps play with the symbolism of hot air balloons!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%A9ndez%20N%C3%BA%C3%B1ez%2012%2C%20Malaga%2C%2029007%2C%20Spain"
    pageTitle="Clómada"
  />
);

export default Clmada;
