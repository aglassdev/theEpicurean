...
const Beluga = () => (
  <RestaurantPage
    restaurantName="Beluga"
    address="Plaza de las Flores 3, Malaga, 29005, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34952214253"
    website="https://www.belugamalaga.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a central square, run by a couple who are committed to what they call 'meridian cuisine', representing the southern Mediterranean culture, with dishes of great delicacy and flavour with no shortage of technical details. The menu, with a tasty and comprehensive selection of rice dishes (Shell-free rice with monkfish and white prawns, Alicante-style rice cooked in fish stock, served with wild-caught fish, Rice with Angus beef cheek and chickpeas...) which can be enjoyed individually, is rounded out with two tasting menus (Meridiano Cero and Virazón). We recommend booking, especially if you want to eat on their pleasant terrace!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20las%20Flores%203%2C%20Malaga%2C%2029005%2C%20Spain"
    pageTitle="Beluga"
  />
);
