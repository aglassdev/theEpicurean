...
const Casanita = () => (
  <RestaurantPage
    restaurantName="Casanita"
    address="Fonoll Marí 101, es Pujols, 07871, Spain"
    cuisine="Italian Contemporary, Seafood"
    priceRange="€€"
    phoneNumber="+34971321968"
    website="https://guide.michelin.com/en/islas-baleares/es-pujols/restaurant/casanita"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a chalet-style building, Casanita’s traditional atmosphere provides the backdrop for an à la carte with its roots in Italian cooking, daily specials posted on the blackboard, and well-prepared fresh fish of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fonoll%20Mar%C3%AD%20101%2C%20es%20Pujols%2C%2007871%2C%20Spain"
    pageTitle="Casanita"
  />
);
