...
const CaNaPilar = () => (
  <RestaurantPage
    restaurantName="Ca na Pilar"
    address="Avenida de la Mar 1, Es Migjorn Gran, 07749, Spain"
    cuisine="Contemporary, Farm to table"
    priceRange="€€"
    phoneNumber="+34971370212"
    website="https://www.canapilar.com/es/inicio"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20la%20Mar%201%2C%20Es%20Migjorn%20Gran%2C%2007749%2C%20Spain"
    pageTitle="Ca na Pilar"
  />
);

export default CaNaPilar;
