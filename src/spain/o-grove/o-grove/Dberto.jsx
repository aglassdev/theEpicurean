...
const Dberto = () => (
  <RestaurantPage
    restaurantName="D'Berto"
    address="Teniente Domínguez 84, O Grove, 36980, Spain"
    cuisine="Seafood, Galician"
    priceRange="€€€€"
    phoneNumber="+34986733447"
    website="https://www.dberto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At D’Berto, you’ll experience the full potential and expression of the local estuary’s produce. For those for whom scale is of little importance, this is definitely the place, where you can enjoy a truly surprising array of fish and seafood accompanied by excellent service. Perfectly cooked grilled dishes and stews are more important here than technique, though the latter is certainly not lacking. Options include an array of shellfish and several classic dishes such as the pan-fried lobster and the spider crab...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Teniente%20Dom%C3%ADnguez%2084%2C%20O%20Grove%2C%2036980%2C%20Spain"
    pageTitle="D'Berto"
  />
);

export default Dberto;
