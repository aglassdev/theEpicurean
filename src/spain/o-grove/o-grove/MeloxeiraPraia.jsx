...
const MeloxeiraPraia = () => (
  <RestaurantPage
    restaurantName="Meloxeira Praia"
    address="Carretera San Vicente Do Mar 1100, O Grove, 36989, Spain"
    cuisine="Contemporary, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34886161389"
    website="https://restaurante.covermanager.com/meloxeira-praia/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The beach reference in the restaurant name doesn’t disappoint, given the stunning location of this gourmet “chiringuito” between the beaches of Seixeliño and Area da Cruz. Attractively furnished, it boasts superb sea views including the island of Ons on the horizon. Its cuisine, which can be enjoyed in the glass-fronted dining room or on its delightful terraces, focuses on traditional cooking with a modern touch, including some dishes cooked on the on the open grill, plus a section of the menu dedicated to rice and fideuá options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20San%20Vicente%20Do%20Mar%201100%2C%20O%20Grove%2C%2036989%2C%20Spain"
    pageTitle="Meloxeira Praia"
  />
);

export default MeloxeiraPraia;
