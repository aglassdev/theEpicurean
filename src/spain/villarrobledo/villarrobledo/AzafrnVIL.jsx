...
const AzafrnVIL = () => (
  <RestaurantPage
    ...
    address="Avenida Reyes Católicos 71, Villarrobledo, 02600, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34967145298"
    website="https://www.azafranvillarrobledo.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Reyes%20Cat%C3%B3licos%2071%2C%20Villarrobledo%2C%2002600%2C%20Spain"
    pageTitle="Azafrán"
  />
);

export default AzafrnVIL;
