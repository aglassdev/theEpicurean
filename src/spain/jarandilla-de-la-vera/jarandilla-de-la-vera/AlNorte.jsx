...
const AlNorte = () => (
  <RestaurantPage
    restaurantName="Al Norte"
    address="Avenida Soledad Vega Ortiz 125, Jarandilla de la Vera, 10450, Spain"
    cuisine="Contemporary, Fusion"
    priceRange="€"
    phoneNumber="+34666320632"
    website="https://guide.michelin.com/en/extremadura/jarandilla-de-la-vera/restaurant/al-norte"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A colourful yet unassuming eatery with a kitchen adjoining the dining room. The chef, who has worked in several leading restaurants and has a strong focus on presentation, showcases his talents via a traditionally inspired menu which is particularly designed for sharing. It features modern, fusion-inspired influences that take the palate on a journey around the world through dishes such as tomato “torrija” with smoked sardine, veal cheeks with papaya etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Soledad%20Vega%20Ortiz%20125%2C%20Jarandilla%20de%20la%20Vera%2C%2010450%2C%20Spain"
    pageTitle="Al Norte"
  />
);

export default AlNorte;
