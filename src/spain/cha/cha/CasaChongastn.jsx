...
const CasaChongastn = () => (
  <RestaurantPage
    restaurantName="Casa Chongastán"
    address="Carretera s/n, Chía, 22465, Spain"
    cuisine="Seasonal Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34974553200"
    website="https://chongastan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy eating high-quality meat, you won’t want to pass up this opportunity. The restaurant occupies an attractive Alpine-style building, however its most interesting feature is that the same family runs the restaurant as well as a farm that breeds native cattle. Here, you can savour delicious homemade stews, wild mushrooms in season, as well as exquisite grilled meats produced from its own cattle, and game. Its veal is famous for having the perfect level of fat between its muscle fibres...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20s%2Fn%2C%20Ch%C3%ADa%2C%2022465%2C%20Spain"
    pageTitle="Casa Chongastán"
  />
);

export default CasaChongastn;
