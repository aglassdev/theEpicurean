...
const LaFundicin = () => (
  <RestaurantPage
    restaurantName="La Fundición"
    address="Plazuela de la Calandria 1, San Ildefonso o La Granja, 40100, Spain"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34921472406"
    website="https://lafundicionrestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of La Granja, opposite the post office and just a few minutes' walk from both the Royal Palace and its beautiful gardens. Its name (translation, The Foundry) is not a trivial detail, as it is located inside a building with a long history that provided both the Royal Palace and the old hospital with its plumbing. Today, after some great interior design work, it is set out with several spaces of unique ruggedness: the bar, the main dining room where the forge used to be, the terrace-patio of the infirmary... What does it offer? À la carte service (we particularly liked the oxtail ravioli and foie gras sauce) and two set menus featuring updated traditional cuisine, one à la carte and a larger one called XL...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plazuela%20de%20la%20Calandria%201%2C%20San%20Ildefonso%20o%20La%20Granja%2C%2040100%2C%20Spain"
    pageTitle="La Fundición"
  />
);

export default LaFundicin;
