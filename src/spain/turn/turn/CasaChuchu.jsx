...
const CasaChuchu = () => (
  <RestaurantPage
    restaurantName="Casa Chuchu"
    address="El Parque, Turón, 33610, Spain"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34985430226"
    website="https://www.casachuchu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If the prospect of eating in a typical Asturian “chigre” (cider bar) appeals to you, this unpretentious and authentic restaurant, located just a few kilometres from Mieres in the small parish of Turón and run by the third generation of the family, is a good option. Here, you can enjoy home-style cooking with lots of flavour, including slow-cooked stews, with a focus on high-quality ingredients. Everything is delicious but we can particularly recommend starting with its famous ham croquettes and making sure you save space for dessert – you’ll adore the cream-filled millefeuille!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=El%20Parque%2C%20Tur%C3%B3n%2C%2033610%2C%20Spain"
    pageTitle="Casa Chuchu"
  />
);

export default CasaChuchu;
