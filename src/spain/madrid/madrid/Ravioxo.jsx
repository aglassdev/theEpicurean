...
const Ravioxo = () => (
  <RestaurantPage
    restaurantName="RavioXO"
    address="Plaza de Manuel Gómez Moreno 5, Madrid, 28020, Spain"
    cuisine="Creative, Dumplings"
    priceRange="€€€€"
    phoneNumber="+34917648992"
    website="https://www.ravioxo.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the words of chef Dabiz Muñoz, RavioXO is “the luxury of eating time”, a perfect metaphor to express his informal, handcrafted cuisine which is fully centred on the world of pasta, with all the dough, fillings and sauces made individually. In this extensive restaurant, the beautiful interior design by the Lázaro Rosa-Violán studio provides the backdrop for chef Daniel Villoria, Dabiz Muñoz’s right-hand man. The cuisine, consisting of à la carte dining and a tasting menu (Festival 360º), reflects fusion cuisine that covers almost all of Asia as a result of the chef’s travels and features sauces and exotic ingredients alike (yozu kosho, Korean tempura, spider crab from Singapore, umeboshi, Gochujang pasta etc) alongside those from closer to home. Standout dishes, which are designed for sh..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20Manuel%20G%C3%B3mez%20Moreno%205%2C%20Madrid%2C%2028020%2C%20Spain"
    pageTitle="RavioXO"
  />
);

export default Ravioxo;
