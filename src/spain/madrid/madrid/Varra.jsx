...
const Varra = () => (
  <RestaurantPage
    restaurantName="Varra"
    address="Hermosilla 7, Madrid, 28001, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34616123421"
    website="https://www.varrarestaurante.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hermosilla%207%2C%20Madrid%2C%2028001%2C%20Spain"
    pageTitle="Varra"
  />
);

export default Varra;
