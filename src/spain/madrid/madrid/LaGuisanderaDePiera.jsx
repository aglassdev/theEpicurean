...
const LaGuisanderaDePiera = () => (
  <RestaurantPage
    restaurantName="La Guisandera de Piñera"
    address="Rosario Pino 12, Madrid, 28020, Spain"
    cuisine="Asturian"
    priceRange="€€"
    phoneNumber="+34914251425"
    website="https://www.laguisanderadepinera.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that offers traditional Asturian cuisine, including delicious stews and other famous dishes from this region of Northern Spain such as “arroz con pitu de caleya” (a type of chicken paella), La Guisandera’s signature fabada stew, and arroz con leche...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rosario%20Pino%2012%2C%20Madrid%2C%2028020%2C%20Spain"
    pageTitle="La Guisandera de Piñera"
  />
);

export default LaGuisanderaDePiera;
