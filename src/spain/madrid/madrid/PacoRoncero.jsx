...
const PacoRoncero = () => (
  <RestaurantPage
    restaurantName="Paco Roncero"
    address="Alcalá 15, Madrid, 28014, Spain"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+34915321275"
    website="https://www.pacoroncerorestaurante.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Paco Roncero, who is always pursuing new goals in line with his ‘never stop moving’ spirit, awaits you in a truly unique space, boasting an elegant, avant-garde aesthetic... on the top floor of a 19th-century building! Here, where there is also a spectacular terrace, you can enjoy a culinary experience in the form of three menus, all with wine pairing options: Esencia (more affordable and available Thursday and Friday lunchtime), Madrid, and, finally, the Gran Madrid. The chef, who has an unwavering enthusiasm for olive oil, demonstrates his full creativity and imagination in his starters (his Filipino of foie gras with white chocolate is particularly noteworthy), and focuses his menu on traditional Madrid cuisine, paying homage to the Spanish capital's bars (we loved his version of t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alcal%C3%A1%2015%2C%20Madrid%2C%2028014%2C%20Spain"
    pageTitle="Paco Roncero"
  />
);

export default PacoRoncero;
