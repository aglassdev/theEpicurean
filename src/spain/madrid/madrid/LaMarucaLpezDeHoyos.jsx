...
const LaMarucaLpezDeHoyos = () => (
  <RestaurantPage
    restaurantName="La Maruca - López de Hoyos"
    address="López de Hoyos 42, Madrid, 28001, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34915631485"
    website="https://www.restaurantelamaruca.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In keeping with the focus in its sister restaurants along the city’s Castellana and Velázquez streets, the region of Cantabria takes complete centre-stage here. The standout features in this spacious, contemporary eatery with its large windows looking out onto the street are the welcoming terrace to the rear and an unwavering focus on time-honoured Cantabrian cooking. The latter is based around quality ingredients and simply prepared dishes that retain a strong emphasis on detail. Specialities include anchovies, Santander-style fried squid, brandade fritters, stews (mountain stew and Lebaniego stew from the town of Liébana), and Cachopo, a typical dish combining steak, ham and cheese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L%C3%B3pez%20de%20Hoyos%2042%2C%20Madrid%2C%2028001%2C%20Spain"
    pageTitle="La Maruca - López de Hoyos"
  />
);

export default LaMarucaLpezDeHoyos;
