...
const Inpulso = () => (
  <RestaurantPage
    restaurantName="In-Pulso"
    address="Ariel 15, Madrid, 28045, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34911620320"
    website="https://www.inpulsorestaurante.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ariel%2015%2C%20Madrid%2C%2028045%2C%20Spain"
    pageTitle="In-Pulso"
  />
);

export default Inpulso;
