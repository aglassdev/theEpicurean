...
const SushiBarHannah = () => (
  <RestaurantPage
    restaurantName="Sushi Bar Hannah"
    address="Marqués de Villamagna 2, Madrid, 28001, Spain"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+34911049687"
    website="https://www.sushibarhannah.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the discreet façade of the Sushi Bar Hannah, located in a narrow street next to the luxurious Rosewood Villa Magna hotel, you’ll find a Japanese restaurant home to the full mystique of the Orient. Its soups, pickles, sashimis, nigiris, makis, tempuras, as well as its steamed and charcoal-grilled dishes, are part of the varied culinary repertoire of London chef Janek Flemyng, who creates technically adept cuisine that is fully respectful of tradition. This is complemented by two highly interesting tasting menus (both of which need to be booked a minimum of 24hr ahead): the Kaiseki menu, with its strong focus on meticulous detail; and the Omakase, which places more emphasis on seasonal fish and seafood. We recommend sitting at the bar counter, where you’ll be able to best appreciate t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marqu%C3%A9s%20de%20Villamagna%202%2C%20Madrid%2C%2028001%2C%20Spain"
    pageTitle="Sushi Bar Hannah"
  />
);

export default SushiBarHannah;
