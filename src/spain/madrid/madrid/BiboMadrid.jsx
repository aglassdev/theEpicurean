...
const BiboMadrid = () => (
  <RestaurantPage
    restaurantName="BiBo Madrid"
    address="Paseo de la Castellana 52, Madrid, 28046, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34918052556"
    website="https://grupodanigarcia.com/bibo/madrid/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are keen to embark on a culinary journey to explore a magical gastronomic world of cosmopolitan cuisine at its finest, you don’t even need to leave Spain’s capital! This restaurant, decorated by the famous interior designer Lázaro Rosa-Violán, will surprise all and sundry with its fun aesthetic, dominated by some 7 000 light bulbs (that take us on a journey to the brilliance of the Málaga fair) and even an aerostatic globe! From a purely gourmet viewpoint, the contemporary, globally inspired cuisine (but with its roots in Andalucia), bears the hallmark of award-winning Marbella chef Dani García. The food here is very much designed for sharing in an informal atmosphere as a couple or with friends, and includes dishes such as foie gras and goat’s cheese millefeuille, almadraba-caught ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20de%20la%20Castellana%2052%2C%20Madrid%2C%2028046%2C%20Spain"
    pageTitle="BiBo Madrid"
  />
);

export default BiboMadrid;
