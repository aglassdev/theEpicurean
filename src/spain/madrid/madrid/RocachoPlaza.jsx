...
const RocachoPlaza = () => (
  <RestaurantPage
    restaurantName="Rocacho Plaza"
    address="Plaza del Marqués de Salamanca 9, Madrid, 28006, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34919148444"
    website="https://rocachoplaza.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of the city’s Salamanca district, Rocacho Plaza boasts a pleasant terrace and a menu that focuses on grilled dishes. Among its choice of meats, the selection from El Capricho, the famous farm in Jiménez de Jamuz in the province of León, are a real draw, including its premium “Selección José Gordón” ox chop and its beef chop aged for 90 days. It also offers market-inspired dishes, recipes featuring seasonal vegetables, superb grilled fish, and rice and fideuá options. It also occasionally hosts full-day food events such as those dedicated to the delicious oxtail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20del%20Marqu%C3%A9s%20de%20Salamanca%209%2C%20Madrid%2C%2028006%2C%20Spain"
    pageTitle="Rocacho Plaza"
  />
);

export default RocachoPlaza;
