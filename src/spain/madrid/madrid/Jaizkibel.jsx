...
const Jaizkibel = () => (
  <RestaurantPage
    restaurantName="Jaizkibel"
    address="Albasanz 67, Madrid, 28037, Spain"
    cuisine="Basque"
    priceRange="€€"
    phoneNumber="+34913041641"
    website="https://jaizkibelartesanoscocineros.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Albasanz%2067%2C%20Madrid%2C%2028037%2C%20Spain"
    pageTitle="Jaizkibel"
  />
);

export default Jaizkibel;
