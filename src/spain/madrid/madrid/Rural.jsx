...
const Rural = () => (
  <RestaurantPage
    restaurantName="Rural"
    address="Marqués de Cubas 8, Madrid, 28014, Spain"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+34915429836"
    website="https://www.restauranterural.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Are you familiar yet with Rafa Zafra’s new venture? The renowned chef in charge of Estimar, with restaurants in both Barcelona and Madrid (the latter just a few metres away from Rural), has teamed up with chef Alberto Pacheco to leave the sea (the leitmotif of his other businesses) behind him in order to focus on the land. In the dining rooms, with their subdued lighting and urban-style interior design, the cooking is focused on a choice of different meats (beef, ox, pork, lamb, poultry, game). This is showcased via premium Joselito cured hams, escabeches, sausages, delicious barbecued pinchos and specialities cooked on the Josper grill, the Basque parrilla, or in the traditional Castilian oven. An impressive and varied wine cellar completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marqu%C3%A9s%20de%20Cubas%208%2C%20Madrid%2C%2028014%2C%20Spain"
    pageTitle="Rural"
  />
);
