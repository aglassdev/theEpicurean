...
const RubaiyatMadrid = () => (
  <RestaurantPage
    restaurantName="Rubaiyat Madrid"
    address="Juan Ramón Jiménez 37, Madrid, 28036, Spain"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+34913591000"
    website="https://www.gruporubaiyat.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Discover the authentic flavours of São Paulo in this restaurant where you can order the typical “feijoada” (minimum of two guests) or its extensive selection of meats. Fantastic terrace featuring trees and plenty of greenery!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Juan%20Ram%C3%B3n%20Jim%C3%A9nez%2037%2C%20Madrid%2C%2028036%2C%20Spain"
    pageTitle="Rubaiyat Madrid"
  />
);

export default RubaiyatMadrid;
