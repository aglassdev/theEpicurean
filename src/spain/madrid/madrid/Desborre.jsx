...
const Desborre = () => (
  <RestaurantPage
    restaurantName="Desborre"
    address="De la Unión 8, Madrid, 28013, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34680840984"
    website="https://www.desborre.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Offering dishes such as soufflé crackling, chicken in citrus escabeche, and “green chromatic in different textures”, this restaurant in the Austrias district very close to the royal palace is the fiefdom of Rioja-born chef Lucía Grávalos. Here, she showcases her permanent commitment to the land, organic ingredients, free-grazing livestock and sustainable fishing... as well as her rekindling of memories of her grandmother Ana Mari’s recipes and her passion for vegetables, which are always sourced and prepared in strict alignment with her culinary focus. The rustic-contemporary ambience is that of a stylish bistro, with a surprising display counter of fermented products (kombuchas, kefirs, shrubs etc) by the entrance. The contemporary-inspired à la carte is complemented by two interesting ta..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=De%20la%20Uni%C3%B3n%208%2C%20Madrid%2C%2028013%2C%20Spain"
    pageTitle="Desborre"
  />
);

export default Desborre;
