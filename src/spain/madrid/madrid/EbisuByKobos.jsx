...
const EbisuByKobos = () => (
  <RestaurantPage
    restaurantName="Ebisu by Kobos"
    address="Luciente 14, Madrid, 28005, Spain"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber=""
    website="https://ebisubykobos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef José Kobos Cortés says that “we eat every day but to smile while we do so is something else altogether”. Here, just a few metres from the Cebada market (in the La Latina district), he has created his Japanese-inspired cuisine (he spent a year working in Japan under the baton of culinary maestro Norihito Endo) around solid technique and the seasons. In this unpretentious restaurant, where everything revolves around a small sushi bar, he conjures up a single Omakase menu that normally starts with a green tea to welcome you (and which is then constantly refilled). Before starting the tasting experience itself, the chef shows us the cuts of fish he will be working with and which he combines with his superb and perfectly balanced rice. A dining experience that is well worth the effort!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Luciente%2014%2C%20Madrid%2C%2028005%2C%20Spain"
    pageTitle="Ebisu by Kobos"
  />
);

export default EbisuByKobos;
