...
const ElPedruscoDeAldealcorvo = () => (
  <RestaurantPage
    restaurantName="El Pedrusco de Aldealcorvo"
    address="Juan de Austria 27, Madrid, 28010, Spain"
    cuisine="Castilian"
    priceRange="€€"
    phoneNumber="+34914468833"
    website="https://guide.michelin.com/en/comunidad-de-madrid/madrid/restaurant/el-pedrusco-de-aldealcorvo"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Juan%20de%20Austria%2027%2C%20Madrid%2C%2028010%2C%20Spain"
    pageTitle="El Pedrusco de Aldealcorvo"
  />
);

export default ElPedruscoDeAldealcorvo;
