...
const LeBistromanAtelier = () => (
  <RestaurantPage
    restaurantName="Le Bistroman Atelier"
    address="Amnistía 10, Madrid, 28013, Spain"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+34914472713"
    website="https://lebistroman.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take your palate on a culinary voyage to France in this attractive bistro with an open-view kitchen at the entrance and a welcoming interior which will delight guests with its combination of classic and rustic decor. Enjoy authentic Gallic flavours on both the à la carte and the gastronomic tasting menu. When in season, don’t miss the delicious snails with a classic persillade!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amnist%C3%ADa%2010%2C%20Madrid%2C%2028013%2C%20Spain"
    pageTitle="Le Bistroman Atelier"
  />
);

export default LeBistromanAtelier;
