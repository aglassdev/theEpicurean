...
const ContrastesByDiegoFerreira = () => (
  <RestaurantPage
    restaurantName="Contrastes by Diego Ferreira"
    address="Jorge Juan 56, Madrid, 28001, Spain"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+34919295835"
    website="https://restaurantecontrastes.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jorge%20Juan%2056%2C%20Madrid%2C%2028001%2C%20Spain"
    pageTitle="Contrastes by Diego Ferreira"
  />
);

export default ContrastesByDiegoFerreira;
