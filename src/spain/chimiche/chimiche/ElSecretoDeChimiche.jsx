...
const ElSecretoDeChimiche = () => (
  <RestaurantPage
    restaurantName="El Secreto de Chimiche"
    address="Carretera General del Sur 4, Chimiche, 38594, Spain"
    cuisine="Traditional Cuisine, Meats and Grills"
    priceRange="€€"
    phoneNumber="+34922777279"
    website="https://www.elsecretodechimiche.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you were to describe this restaurant located away from the tourist trail as a hidden jewel, you wouldn’t be far wrong. In its roadside location, the somewhat unassuming façade conceals an attractively renovated, rustic-style interior with a pleasant bar, plus a dining space on several floors featuring cosy nooks and crannies and pretty terraces. Here, the chef focuses on traditional cuisine full of flavour with its roots in the very essence of cooking from the Canary Islands, plus numerous dishes cooked on the wood-fired grill, such as the roasted baby goat. There’s also a good selection of matured meats and Canary Island wines!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20General%20del%20Sur%204%2C%20Chimiche%2C%2038594%2C%20Spain"
    pageTitle="El Secreto de Chimiche"
  />
);

export default ElSecretoDeChimiche;
