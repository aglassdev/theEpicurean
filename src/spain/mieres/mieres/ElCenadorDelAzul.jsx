...
const ElCenadorDelAzul = () => (
  <RestaurantPage
    restaurantName="El Cenador del Azul"
    address="Aller 51, Mieres, 33600, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34985461814"
    website="https://guide.michelin.com/en/principado-de-asturias/mieres/restaurant/el-cenador-del-azul"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that is both classic and contemporary in style where attention to detail is key in every aspect of its unassuming but superb service, which it considers an art form. The à la carte, which is impressively complemented by a set menu at lunchtime, is traditional in feel, but combines contemporary touches and hints of fusion that are reflected in starters and mains alike, including the “pitu de caleya” free-range chicken – a mainstay of Asturian cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aller%2051%2C%20Mieres%2C%2033600%2C%20Spain"
    pageTitle="El Cenador del Azul"
  />
);

export default ElCenadorDelAzul;
