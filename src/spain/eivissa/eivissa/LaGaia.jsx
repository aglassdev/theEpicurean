...
const LaGaia = () => (
  <RestaurantPage
    restaurantName="La Gaia"
    address="Paseo Juan Carlos I 17, Eivissa, 07800, Spain"
    cuisine="Fusion, International"
    priceRange="€€€€"
    phoneNumber="+34971806806"
    website="https://lagaiaibiza.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Here, in the gourmet restaurant of the luxurious Ibiza Gran Hotel, take your palate on an evolutionary journey of discovery as part of a truly exclusive experience that is an astute symbiosis of “sincerity, integrity and creativity” along with a certain sophistication. At La Gaia, chef Óscar Molina showcases Mediterranean cuisine via a highly creative approach that uses the best seasonal Ibizan ingredients with added hints of fusion. His dishes are full of contrast and environmental awareness and are centred on an “à la carte” and two tasting menus: Illa, offering a journey across the chef’s most iconic creations; and the daring Horitzó, on which culinary technique and imagination take centre stage, while at the same time always shining a light on the best ingredients from the island. Duri..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Juan%20Carlos%20I%2017%2C%20Eivissa%2C%2007800%2C%20Spain"
    pageTitle="La Gaia"
  />
);

export default LaGaia;
