...
const Nila = () => (
  <RestaurantPage
    restaurantName="Nila"
    address="Iglesia 2, El Sauzal, 38360, Spain"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+34654063005"
    website="https://www.instagram.com/nila_el_sauzal/profilecard/?igsh=dmQ4Zm12NndmcG44"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of El Sauzal, next to the San Pedro Apóstol church, this pleasant family-run restaurant occupies a property where you’ll find a relaxed ambience, lots of personality and an interior that is striking for its vintage decor (wood, a female mannequin, rock and roll memorabilia, ceramic crockery made by the owners etc) and charming terrace. The à la carte, which usually changes every week, is highly varied and adapts to what is available in the market, so don’t be surprised to find dishes such as amberjack sashimi, sea bass ceviche, squid lasagne, Nilo’s truffled eggs etc on the menu... all designed with sharing in mind...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Iglesia%202%2C%20El%20Sauzal%2C%2038360%2C%20Spain"
    pageTitle="Nila"
  />
);
