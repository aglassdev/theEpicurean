...
const CaLesteve = () => (
  <RestaurantPage
    restaurantName="Ca l'Esteve"
    address="Carretera Martorell-Terrassa C 243c, Castellbisbal, 08755, Spain"
    cuisine="Catalan"
    priceRange="€€"
    phoneNumber="+34937755690"
    website="https://www.restaurantcalesteve.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fourth-generation, family-run restaurant occupying a large stone house. The traditional Catalan menu is enhanced by several daily specials. Impressive choice of rice and grilled dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20Martorell-Terrassa%20C%20243c%2C%20Castellbisbal%2C%2008755%2C%20Spain"
    pageTitle="Ca l'Esteve"
  />
);

export default CaLesteve;
