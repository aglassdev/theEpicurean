...
const AdrinQuetglas = () => (
  <RestaurantPage
    restaurantName="Adrián Quetglas"
    address="Paseo de Mallorca 20, Palma, 07012, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34971781119"
    website="https://www.adrianquetglas.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that is as original as it is stylish, usually full and always meets with expectations. Located in the heart of Palma, overlooking the bed of the Torrent de Sa Riera canal, it boasts a welcoming, bistro-style ambience with attractive bonuses such as a vertical garden and a pleasant vibe created by the jazz music playing in the background. The owner-chef’s goal is to democratise haute cuisine and showcase cooking full of nuances and variations (including from his native Buenos Aires) with a strong focus on Mediterranean flavours and unequivocal influences from his time working in London, Paris and even Moscow. Choose between the 5- and 8-course tasting menus, both with a wine-pairing option (for a supplement you can also add in options such as pigeon, caviar and a cheese course)..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20de%20Mallorca%2020%2C%20Palma%2C%2007012%2C%20Spain"
    pageTitle="Adrián Quetglas"
  />
);

export default AdrinQuetglas;
