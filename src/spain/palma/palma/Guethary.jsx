...
const Guethary = () => (
  <RestaurantPage
    restaurantName="Guethary"
    address="Carrer de Marbella 36, Palma, 07610, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+34671709729"
    website="https://www.guethary.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, with a name that pays tribute to the famous Elkano restaurant in Guetaria, is located within the walls of the Iberostar Selection Playa de Palma hotel. In its sophisticated dining room, with its predominant white colour scheme, chef Aitor Arregui creates cuisine similar to that showcased in his award-winning restaurant in the province of Guipúzcoa, with grilled fish and seafood from Mallorcan waters the undoubted starts of the show. The à la carte, featuring standout dishes such as John Dory and the option of half-plates for some choices, is well supported by two enticing tasting menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carrer%20de%20Marbella%2036%2C%20Palma%2C%2007610%2C%20Spain"
    pageTitle="Guethary"
  />
);

export default Guethary;
