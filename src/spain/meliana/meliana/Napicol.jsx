...
const Napicol = () => (
  <RestaurantPage
    restaurantName="Napicol"
    address="San Isidro 28, Meliana, 46133, Spain"
    cuisine="Rice Dishes, Farm to table"
    priceRange="€€"
    phoneNumber="+34961119110"
    website="https://www.napicol.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a small village just a few kilometres north of Valencia, Napicol is run by a family heavily involved in the business and is one of those restaurants where agriculture is very much part of its DNA. You won’t find any set menus here; instead, chef Chemo Rausell conjures up cuisine that includes plenty of dishes that do not feature on the à la carte and which change with the seasons (the restaurant is next to an organic garden that provides many of his day-to-day ingredients). He also cooks delicious rice dishes to order and organises food-themed days dedicated to traditional recipes. A delightful terrace-garden and a well-curated wine cellar, featuring a selection of champagnes from small-scale producers, add to its appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Isidro%2028%2C%20Meliana%2C%2046133%2C%20Spain"
    pageTitle="Napicol"
  />
);

export default Napicol;
