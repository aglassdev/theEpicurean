...
const LaFortaleza = () => (
  <RestaurantPage
    restaurantName="La Fortaleza"
    address="Carretera d'Enderrocat, Cala Blava, 07609, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34971747878"
    website="https://www.caprocat.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An elegant, unique and very special restaurant that is a must on the island. It offers two creative menus that showcase the best of Mallorcan cuisine accompanied by superb views from the rooftop terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20d'Enderrocat%2C%20Cala%20Blava%2C%2007609%2C%20Spain"
    pageTitle="La Fortaleza"
  />
);
