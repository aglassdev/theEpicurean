...
const Vidocq = () => (
  <RestaurantPage
    restaurantName="Vidocq"
    address="Avenida Huesca, Sallent de Gállego, 22640, Spain"
    cuisine="Contemporary, Fusion"
    priceRange="€€€"
    phoneNumber="+34974490472"
    website="https://www.restaurantevidocq.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the Frenchman considered to be the world’s first private detective way back in the early 19C, Vidocq is a superb option for those who prefer not to venture too far from the nearby ski slopes. The contemporary, fusion-style cuisine here toys continually with flavour, incorporating interesting Asian nuances (particularly from Thai cooking) into typical Aragonese mountain recipes (the vast majority of its ingredients are sourced from small-scale local producers). A single seasonal set menu (Huellas) is the mainstay here, inviting guests on an evocative gastronomic journey though this region. Don't miss his unique Cheesecake!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Huesca%2C%20Sallent%20de%20G%C3%A1llego%2C%2022640%2C%20Spain"
    pageTitle="Vidocq"
  />
);

export default Vidocq;
