...
const CambiumPirineos = () => (
  <RestaurantPage
    restaurantName="Cambium Pirineos"
    address="Plaza del Valle de Tena 7, Sallent de Gállego, 22640, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34974488219"
    website="https://www.cambiumrestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the centre of the village, Cambium, which is Latin for “change” and is also the word to describe one of the outer layers of a tree trunk, is keen for guests to discover the flavours of the Aragonese Pyrenees from a different perspective. In its pleasant, rustic-style dining rooms, featuring a profusion of wood and views of both the village and its impressive surrounding mountains, choose between an à la carte option or two seasonal menus on request (Olla Tensina y Summum) with dishes such as marinated Oliván trout and IGP Aragón veal, which connect us with the culinary traditions of this part of the Alto Gállego region. An impressive array of D.O. Somontano wines completes the picture!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20del%20Valle%20de%20Tena%207%2C%20Sallent%20de%20G%C3%A1llego%2C%2022640%2C%20Spain"
    pageTitle="Cambium Pirineos"
  />
);

export default CambiumPirineos;
