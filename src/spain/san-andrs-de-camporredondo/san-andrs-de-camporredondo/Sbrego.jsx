...
const Sbrego = () => (
  <RestaurantPage
    restaurantName="Sábrego"
    address="O Cotiño, San Andrés de Camporredondo, 32415, Spain"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34988491809"
    website="https://sabregorestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stone-built bodega complex is located in a panoramic setting surrounded by vineyards in the heart of the D.O. Ribeiro wine region. Its updated take on traditional cooking highlights a creative touch and is centred on the very best Galician meat and the freshest fish sourced daily. Half a dozen attractive guestrooms are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=O%20Coti%C3%B1o%2C%20San%20Andr%C3%A9s%20de%20Camporredondo%2C%2032415%2C%20Spain"
    pageTitle="Sábrego"
  />
);

export default Sbrego;
