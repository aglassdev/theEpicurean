...
const ElRinconcico = () => (
  <RestaurantPage
    restaurantName="El Rinconcico"
    address="Santa Lucía 4, Mora de Rubielos, 44400, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34978806063"
    website="https://www.elrinconcico.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant located in one of Spain’s main gastronomic regions - the Gúdar-Javalambre area is the main producer of the famous black Teruel truffle! Located alongside the River Mora, El Rinconcico features a popular and contemporary gastro-bar with a few tables on the ground floor, and the main dining room upstairs. Here, you can enjoy updated traditional cuisine that makes plentiful use of local ingredients from Teruel province and is enhanced by a few Peruvian touches from the chef’s homeland. We can recommend the delicious Ternasco D.O. de Aragón lamb as well as the popular “potaje de garbanzos de Miguel”, a chickpea stew created in honour of the founder of the restaurant over 30 years ago. The somewhat visually deceptive “Havana morcilla cigar” also impressed us!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Santa%20Luc%C3%ADa%204%2C%20Mora%20de%20Rubielos%2C%2044400%2C%20Spain"
    pageTitle="El Rinconcico"
  />
);

export default ElRinconcico;
