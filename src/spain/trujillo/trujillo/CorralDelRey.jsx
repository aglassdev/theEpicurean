...
const CorralDelRey = () => (
  <RestaurantPage
    restaurantName="Corral del Rey"
    address="Corral del Rey 2, Trujillo, 10200, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34689190935"
    website="https://guide.michelin.com/en/extremadura/es-trujillo/restaurant/corral-del-rey"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Corral del Rey’s strong suits are its dishes roasted in the oven and red meats cooked on the grill, although its tasting menu is also a triumph! Idyllic terrace adjoining Trujillo’s magnificent Plaza Mayor!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corral%20del%20Rey%202%2C%20Trujillo%2C%2010200%2C%20Spain"
    pageTitle="Corral del Rey"
  />
);

export default CorralDelRey;
