...
const AureumByPicualia = () => (
  <RestaurantPage
    restaurantName="Aureum by Picualia"
    address="Autovía A4 Madrid-Cádiz KM. 298, Bailén, 23710, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34623303993"
    website="https://www.restauranteaureum.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re tempted by a dining experience that revolves around extra-virgin olive oil, then Aureum, located inside the Picualia olive oil cooperative, could be the place. In addition to educational tours, tastings and other olive oil-related activities for visitors, you’ll also find a wine bodega next door to this attractive restaurant. The two chefs at the helm, Paco Simón and Toña López de la Huerta, clearly demonstrate that olive oil is the star of the show here, with a strong nod to local tradition both on the à la carte and their two tasting menus (Labora Oliva and Fenologicum). We particularly enjoyed the trout from Coto Ríos cooked on the Josper grill and served with mayonnaise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Autov%C3%ADa%20A4%20Madrid-C%C3%A1diz%20KM.%20298%2C%20Bail%C3%A9n%2C%2023710%2C%20Spain"
    pageTitle="Aureum by Picualia"
  />
);

export default AureumByPicualia;
