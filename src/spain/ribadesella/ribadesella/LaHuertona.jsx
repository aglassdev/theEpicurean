...
const LaHuertona = () => (
  <RestaurantPage
    restaurantName="La Huertona"
    address="Carretera de Junco, Ribadesella, 33560, Spain"
    cuisine="Seafood, Grills"
    priceRange="€€€"
    phoneNumber="+34985860553"
    website="https://restaurantelahuertona.com/es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy dining with a view, La Huertona could be the place. Located a stone’s throw from the mouth of the Sella river, this delightful restaurant with a rustic ambience features dining rooms with superb vistas of green meadows and cows grazing from its idyllic setting. Options here include a concise à la carte of market-inspired options on which grilled dishes take centre stage, with a strong focus on fish and seafood sourced from local auctions, and an extensive tasting menu that needs to be pre-booked. We loved the freshly prepared “salpicón” of Ribadesella lobster and the locally caught fish cooked on the holm oak grill. Seasonal eel dishes are also a must here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20de%20Junco%2C%20Ribadesella%2C%2033560%2C%20Spain"
    pageTitle="La Huertona"
  />
);

export default LaHuertona;
