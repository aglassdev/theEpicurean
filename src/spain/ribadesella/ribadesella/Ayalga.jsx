...
const Ayalga = () => (
  <RestaurantPage
    restaurantName="Ayalga"
    address="Dionisio Ruisánchez 6, Ribadesella, 33560, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34696529819"
    website="https://www.ayalgavillarosario.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="There are few places in Ribadesella with as much personality as the Villa Rosario hotel – the iconic Spanish colonial-style property dating back to 1914 that overlooks Playa de Santa Marina and is home to this restaurant. Featuring a glass-fronted terrace with splendid views of the Cantabrian Sea, Ayalga’s kitchen is run by chef Israel Moreno, a team player who, instead of considering himself to be the captain of the ship, sees himself as part of the crew on every watch. Options here include a concise, contemporary-inspired à la carte and two interesting tasting menus (Sabores de la Tierrina and Experiencia Ayalga), all of which feature dishes with a rare harmony, highly skilled technical detail, and superb flavours from the best local ingredients (in addition to newly created dishes such ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dionisio%20Ruis%C3%A1nchez%206%2C%20Ribadesella%2C%2033560%2C%20Spain"
    pageTitle="Ayalga"
  />
);

export default Ayalga;
