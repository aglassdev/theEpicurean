...
const Brandal = () => (
  <RestaurantPage
    restaurantName="Brandal"
    address="N-550, Padrón, 15917, Spain"
    cuisine="Galician"
    priceRange="€€€"
    phoneNumber="+34981811312"
    website="https://restaurantebrandal.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=N-550%2C%20Padr%C3%B3n%2C%2015917%2C%20Spain"
    pageTitle="Brandal"
  />
);
