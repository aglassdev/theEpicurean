...
const Shibui = () => (
  <RestaurantPage
    restaurantName="Shibui"
    address="Paseo Milicias de Garachico 1, Santa Cruz de Tenerife, 38002, Spain"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+34922148502"
    website="https://shibuitenerife.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Japanese restaurant occupies the space that was formerly the Kazan and can be viewed as a reinvention of the latter. And although chef Gerardo Cruz is at the helm, the award-winning David Arauz (Zuara Sushi, Madrid) still oversees the cuisine here. The word “shibui” refers to the Japanese aesthetic of beauty and minimalism, and as such the aim here is to see beauty in everything around us, including its imperfections, from a respectful and mature standpoint. The à la carte is complemented by the excellent Shibui menu as well as an Omakase-style option that takes guests on a journey of gastronomic discovery. Whatever you choose, as you take a seat at the bar you will develop an even greater appreciation of the Japanese mystique of each dish. The team mainly works with the freshest qual..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Milicias%20de%20Garachico%201%2C%20Santa%20Cruz%20de%20Tenerife%2C%2038002%2C%20Spain"
    pageTitle="Shibui"
  />
);
