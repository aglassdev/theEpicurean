...
const Atrio = () => (
  <RestaurantPage
    restaurantName="Atrio"
    address="Plaza San Mateo 1, Cáceres, 10003, Spain"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+34927242928"
    website="https://atriocaceres.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A temple of Spanish gastronomy that should be on the bucket list of every food-lover. Atrio exudes elegance, enthusiasm and sincerity, matched by impeccable service to enhance the dining experience to the full. For guests keen to stay over, the superb guestrooms available at the hotel-restaurant are complemented by the eleven highly luxurious suites at the Casa Palacio Paredes Saavedra, barely 30 metres away. Cáceres-born chef Toño Pérez is at the helm, conjuring up creative cuisine of the highest technical level on a single yet extensive tasting menu that the kitchen adapts in line with your preferences. On it, we find the full flavours of Iberian pork (his famous “happy pig”) and the Extremadura region, paying full respect to the DNA of local traditions by showcasing the myriad nuances o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20San%20Mateo%201%2C%20C%C3%A1ceres%2C%2010003%2C%20Spain"
    pageTitle="Atrio"
  />
);
