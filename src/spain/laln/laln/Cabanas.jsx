...
const Cabanas = () => (
  <RestaurantPage
    restaurantName="Cabanas"
    address="Pintor Laxeiro 3, Lalín, 36500, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34986782317"
    website="https://www.restaurantecabanas.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cuisine emanating from the Cabanas’ kitchens is a modern take on traditional dishes, enhanced by a variety of seasonal dishes and game. Make sure you try Lalín’s famous cocido gallego, a typical Galician stew...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pintor%20Laxeiro%203%2C%20Lal%C3%ADn%2C%2036500%2C%20Spain"
    pageTitle="Cabanas"
  />
);
