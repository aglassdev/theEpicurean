...
const ArrelsByMargaColl = () => (
  <RestaurantPage
    restaurantName="Arrels by Marga Coll"
    address="Paseo Illetes 7, Ses Illetes, 07184, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+34971402511"
    website="https://www.restaurantearrels.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant offering lovingly prepared, honest cuisine. In the dining room, with its large windows overlooking the sea, enjoy highly personal Mallorcan cooking created using seasonal, market - fresh ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Illetes%207%2C%20Ses%20Illetes%2C%2007184%2C%20Spain"
    pageTitle="Arrels by Marga Coll"
  />
);

export default ArrelsByMargaColl;
