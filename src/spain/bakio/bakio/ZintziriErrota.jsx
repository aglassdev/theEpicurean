...
const ZintziriErrota = () => (
  <RestaurantPage
    restaurantName="Zintziri Errota"
    address="Barrio Arzalde 3, Bakio, 48130, Spain"
    cuisine="Traditional Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+34946193223"
    website="https://www.zintzirierrota.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Barrio%20Arzalde%203%2C%20Bakio%2C%2048130%2C%20Spain"
    pageTitle="Zintziri Errota"
  />
);

export default ZintziriErrota;
