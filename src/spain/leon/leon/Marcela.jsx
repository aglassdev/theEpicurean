...
const Marcela = () => (
  <RestaurantPage
    restaurantName="Marcela"
    address="Plaza de San Marcelo 9, Leon, 24003, Spain"
    cuisine="Farm to table, Meats and Seafood"
    priceRange="€€"
    phoneNumber="+34987799544"
    website="https://www.marcelabrasayvinos.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Marcela boasts an outstanding location just a few metres from the Museo Casa Botines Gaudí. It features two dining spaces: an informal tapas option on the ground floor and a more sophisticated dining room upstairs - between the two is a striking glass floor adorned with a water feature. The cuisine here is based around ingredients of the highest quality and includes a tasting menu and impressive daily recommendations. Thanks to its collaboration with the city’s auditorium, live music concerts are often held here on Fridays and Saturdays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20San%20Marcelo%209%2C%20Leon%2C%2024003%2C%20Spain"
    pageTitle="Marcela"
  />
);
