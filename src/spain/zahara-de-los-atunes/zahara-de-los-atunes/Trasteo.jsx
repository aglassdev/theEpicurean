...
const Trasteo = () => (
  <RestaurantPage
    restaurantName="Trasteo"
    address="María Luisa 24, Zahara de los Atunes, 11393, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34956439478"
    website="https://guide.michelin.com/en/andalucia/zahara-de-los-atunes/restaurant/trasteo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A gastro-bar with a pleasant and informal feel enhanced by the decor of unusual recycled objects and furniture! The well-prepared cuisine here is contemporary in style, fresh and light and served in full and half portions. We recommend the mini-Vietnamese-style shrimp omelettes and the spicy “caldereta” stew with white prawns and egg...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mar%C3%ADa%20Luisa%2024%2C%20Zahara%20de%20los%20Atunes%2C%2011393%2C%20Spain"
    pageTitle="Trasteo"
  />
);

export default Trasteo;
