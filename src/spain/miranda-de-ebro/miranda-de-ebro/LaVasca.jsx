...
const LaVasca = () => (
  <RestaurantPage
    restaurantName="La Vasca"
    address="Olmo 3, Miranda de Ebro, 09200, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34947311301"
    website="https://www.restaurantelavasca.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A gastronomic institution in the city that opened its doors in 1926 and has now been run by three generations of the same family. Located on the first floor of a 19C building, it features a classic-contemporary dining room which is accessed via a staircase lined with old photos of the restaurant and its founder, Ángela Bilbao, who came here from a village in Vizcaya province with her husband, a native of Burgos, and set up the original “casa de comidas”. Here, you can enjoy time-honoured cooking that features game, wild mushrooms in season, traditional offal dishes, cod, roast baby lamb etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Olmo%203%2C%20Miranda%20de%20Ebro%2C%2009200%2C%20Spain"
    pageTitle="La Vasca"
  />
);

export default LaVasca;
