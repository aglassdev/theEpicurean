...
const AlexCoolClub = () => (
  <RestaurantPage
    restaurantName="Alex Cool Club"
    address="Juan Ramón Jiménez 46, Miranda de Ebro, 09200, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34947092279"
    website="https://guide.michelin.com/en/castilla-y-leon/miranda-de-ebro/restaurant/alex-cool-club"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with its urban and industrial atmosphere, dominated by the pink and grey tones of concrete, should be seen as the low-cost version of the award-winning Alejandro Serrano restaurant. Its kitchen, which integrates exposed steel into the décor as it is completely open to the dining room, offers a fun and informal proposal, reinterpreting the dishes of its big brother in a more casual way. The menu, with dishes such as ceviche-style prawn carpaccio and an open-face omelette with cod kokotxas, is rounded out with an economical daily set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Juan%20Ram%C3%B3n%20Jim%C3%A9nez%2046%2C%20Miranda%20de%20Ebro%2C%2009200%2C%20Spain"
    pageTitle="Alex Cool Club"
  />
);

export default AlexCoolClub;
