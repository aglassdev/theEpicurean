...
const Estimar = () => (
  <RestaurantPage
    restaurantName="Estimar"
    address="Sant Antoni dels Sombrerers 3, Barcelona, 08003, Spain"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+34932689197"
    website="https://www.restaurante-estimar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An intimate restaurant that is somewhat tucked away but which has received many plaudits thanks to the passion for the sea shown by the Gotanegra family and chef Rafa Zafra. Grilled dishes and high-quality products are to the fore here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sant%20Antoni%20dels%20Sombrerers%203%2C%20Barcelona%2C%2008003%2C%20Spain"
    pageTitle="Estimar"
  />
);
