...
const Brabo = () => (
  <RestaurantPage
    restaurantName="Brabo"
    address="Séneca 28, Barcelona, 08006, Spain"
    cuisine="Grills"
    priceRange="€€€"
    phoneNumber="+34931247745"
    website="https://braborestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you consider yourself an avid carnivore, don't miss this simple, contemporary steakhouse – an attractive “sanctuary of fire” where grilled meats are the undeniable stars of the show. Despite this, you’ll also find top-quality grilled fish and vegetables. The menu, created by the duo of chefs Rafa Panatieri and Jorge Sastre (they also run a popular gourmet pizzeria), usually starts with homemade sausages (wild boar mortadella, matured beef loin, country pâté, etc) is designed to be enjoyed with others (the Friesian beef T-bone steak is perfect for sharing), and is complemented by different side dishes. Interestingly, they enjoy working with the Gascón breed of pig (these are black, like Iberian pigs, but of French origin and few in number). The Experiencia Brabo tasting menu is also an o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=S%C3%A9neca%2028%2C%20Barcelona%2C%2008006%2C%20Spain"
    pageTitle="Brabo"
  />
);

export default Brabo;
