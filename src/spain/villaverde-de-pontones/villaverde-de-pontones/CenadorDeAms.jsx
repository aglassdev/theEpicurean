...
const CenadorDeAms = () => (
  <RestaurantPage
    restaurantName="Cenador de Amós"
    address="Plaza del Sol, Villaverde de Pontones, 39793, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34942508243"
    website="https://www.cenadordeamos.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Discover the secrets hidden in the Casa-Palacio Mazarrasa (1756), a mecca for foodies that certainly makes an impression and continues to evolve! The culinary experience begins with welcome drinks and appetisers in the glass-paned pavilion or on the terrace, and culminates in elegant dining spaces with a rustic yet modern feel. Always sporting his trademark cap, chef Jesús Sánchez runs the restaurant with the invaluable support of wife Marián Martínez, who is in charge of the front of house. He remains consistently loyal to local ingredients, seasonality and to a firm commitment to sustainability via his surprise Desde La Raíz menu, a heartfelt tribute to his natural surroundings, the sea, his Cantabrian identity and its history, and all the painstaking research that has gone into every bi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20del%20Sol%2C%20Villaverde%20de%20Pontones%2C%2039793%2C%20Spain"
    pageTitle="Cenador de Amós"
  />
);

export default CenadorDeAms;
