...
const CookingAlmadraba = () => (
  <RestaurantPage
    restaurantName="Cooking Almadraba"
    address="Plaza de Blas Infante, Conil de la Frontera, 11140, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34956926340"
    website="https://linktr.ee/cookingalmadraba"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20Blas%20Infante%2C%20Conil%20de%20la%20Frontera%2C%2011140%2C%20Spain"
    pageTitle="Cooking Almadraba"
  />
);

export default CookingAlmadraba;
