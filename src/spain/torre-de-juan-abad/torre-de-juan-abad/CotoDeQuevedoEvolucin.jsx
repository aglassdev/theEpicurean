...
const CotoDeQuevedoEvolucin = () => (
  <RestaurantPage
    restaurantName="Coto de Quevedo Evolución"
    address="Paraje Tejeras Viejas, Torre de Juan Abad, 13344, Spain"
    cuisine="Traditional Cuisine, Contemporary"
    priceRange="€€€"
    phoneNumber="+34649842901"
    website="https://www.cotodequevedo.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If you enjoy cuisine rooted in the local terroir, this restaurant, part of the rural hotel of the same name and located 1km southeast of Torre de Juan Abad, will definitely appeal, thanks to surroundings which provide it with its inspiration. The “gastronomic” dining space (there is a second more traditional dining room called Origen) features lots of natural light and pleasant vistas of the La Mancha countryside. Chef José Antonio Medina’s cuisine, which starts with two series of appetisers (first by the room with the open fire, and then at the bar, where they are served by the chef himself), showcases the best local ingredients and the full flavours of local Campo de Montiel cooking, including a particular focus on game (partridge, wild boar, venison, rabbit etc) – its undisputed hallmar..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paraje%20Tejeras%20Viejas%2C%20Torre%20de%20Juan%20Abad%2C%2013344%2C%20Spain"
    pageTitle="Coto de Quevedo Evolución"
  />
);

export default CotoDeQuevedoEvolucin;
