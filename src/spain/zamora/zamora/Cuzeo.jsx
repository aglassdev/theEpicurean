...
const Cuzeo = () => (
  <RestaurantPage
    restaurantName="Cuzeo"
    address="Rúa de los Francos 6, Zamora, 49001, Spain"
    cuisine="Regional Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+34980509886"
    website="https://cuzeo.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R%C3%BAa%20de%20los%20Francos%206%2C%20Zamora%2C%2049001%2C%20Spain"
    pageTitle="Cuzeo"
  />
);

export default Cuzeo;
