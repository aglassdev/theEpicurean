...
const ElQuintoSabor = () => (
  <RestaurantPage
    restaurantName="El Quinto Sabor"
    address="Avenida de Quitapesares 17, Villaviciosa de Odón, 28670, Spain"
    cuisine="Creative, Spanish"
    priceRange="€€"
    phoneNumber="+34910283878"
    website="https://r5s.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with a somewhat surprising location surrounded by industrials units, occupying a building with a strong sustainable focus. The exciting cuisine here, centred around four tasting menus, showcases impressive technique and a penchant for flavour and presentation. Some of its dishes include fresh spirulina, a microalgae renowned for its high concentration of nutrients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20Quitapesares%2017%2C%20Villaviciosa%20de%20Od%C3%B3n%2C%2028670%2C%20Spain"
    pageTitle="El Quinto Sabor"
  />
);

export default ElQuintoSabor;
