...
const CasaOsmunda = () => (
  <RestaurantPage
    restaurantName="Casa Osmunda"
    address="Subida la Concepción 2, San Pedro de Breña Alta, 38710, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34922412635"
    website="https://casaosmunda.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this attractive Spanish colonial-style house located at a crossroads, enjoy traditionally inspired Canary Island cuisine with a modern touch, including seasonal dishes that do not feature on the à la carte (the fresh fish here is particularly impressive). It is said that “life is better by sharing”, hence the focus on this philosophy in many of the starters on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Subida%20la%20Concepci%C3%B3n%202%2C%20San%20Pedro%20de%20Bre%C3%B1a%20Alta%2C%2038710%2C%20Spain"
    pageTitle="Casa Osmunda"
  />
);

export default CasaOsmunda;
