...
const Waman = () => (
  <RestaurantPage
    restaurantName="Waman"
    address="Avenida Madariaga 5, Bilbao, 48014, Spain"
    cuisine="Peruvian"
    priceRange="€€"
    phoneNumber="+34688858217"
    website="https://www.wamanrestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Peruvian cooking and Basque ingredients are to the fore in this restaurant located very close to the university campus in the relaxed Deusto district of the city. Here, chef Gabriel Huaman showcases plenty of personality and highly refined textures in dishes that honour his roots and his time spent working with the great Eneko Atxa. At this restaurant with a meticulous contemporary decor, they like to say that the cuisine at Waman will take you on a journey from the peaks of the Andes to the water of the Biscay coast without leaving your table. The culinary experience can be enjoyed by choosing between two menus: Inti and Pachamama. Dishes you won’t want to miss thanks to their flavour and stylish presentation include the octopus with olives and a dessert entitled Chocolate and Lucuma (a f..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Madariaga%205%2C%20Bilbao%2C%2048014%2C%20Spain"
    pageTitle="Waman"
  />
);

export default Waman;
