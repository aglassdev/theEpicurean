...
const OlaMartnBerasategui = () => (
  <RestaurantPage
    restaurantName="Ola Martín Berasategui"
    address="De la Ribera 13, Bilbao, 48005, Spain"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34944652066"
    website="https://taykohotels.com/bilbao/gastronomia/ola-restaurante/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located alongside the river, inside of the Tayko hotel. The aesthetics here are almost as impressive as the cuisine, which sees it proudly vaunting its open brickwork and concrete beams to highlight the fact that it was the first building to be constructed using these materials in the city’s historic quarter. The restaurant exudes personality and is keen to immerse guests in a sensory journey via the story of chef Martín Berasategui, enabling them to discover his vision and his particular sense of culinary excellence through the hands of his disciple Raúl Cabrera (known to everyone as Pintxo). The latter faithfully reproduces his mentor’s dishes with great passion, and with a continual emphasis on cuisine that showcases their ingredients and flavours. These are highlighted in exquisite rec..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=De%20la%20Ribera%2013%2C%20Bilbao%2C%2048005%2C%20Spain"
    pageTitle="Ola Martín Berasategui"
  />
);

export default OlaMartnBerasategui;
