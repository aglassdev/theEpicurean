...
const EnekoBasque = () => (
  <RestaurantPage
    restaurantName="Eneko Basque"
    address="Gran Vía Don Diego López de Haro 4, Bilbao, 48001, Spain"
    cuisine="Basque"
    priceRange="€€"
    phoneNumber="+34946056753"
    website="https://bilbao.nkoeneko.com/es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this modern restaurant that stands out for its terrace (on the 7th floor of the Radisson Collection Hotel), chef Eneko Atxa conjures up cuisine that combines traditional Basque cooking and the occasional contemporary touch. The concise à la carte is well complemented by three tasting menus: Bilbao, Bizkaia, and Vegetariano (a children’s menu is also available). If you’re keen to try one of the restaurant’s signature dishes, make sure you order the egg yolk with “estofado de trigo”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gran%20V%C3%ADa%20Don%20Diego%20L%C3%B3pez%20de%20Haro%204%2C%20Bilbao%2C%2048001%2C%20Spain"
    pageTitle="Eneko Basque"
  />
);

export default EnekoBasque;
