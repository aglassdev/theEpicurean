...
const Seo = () => (
  <RestaurantPage
    restaurantName="Óseo"
    address="Plaza del Pare Antoni Ramón Pasqual 9, es Secar de la Real, 07010, Spain"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34971239778"
    website="https://oseorestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a residential area in the north of Palma de Mallorca, this is one of those places that won't leave you indifferent, as its young chef seeks to surprise us with a modern and personal project, with a Mediterranean-Mallorcan base that showcases seasonal products. Its small menu (we particularly liked the combination of lamb, smoked aubergine and sheep's milk) is complemented by the Óseo menu, which enhances the experience. Something that sets them apart? If you've already tried the menu but want to come back, let them know in advance, and they'll prepare another one with different dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20del%20Pare%20Antoni%20Ram%C3%B3n%20Pasqual%209%2C%20es%20Secar%20de%20la%20Real%2C%2007010%2C%20Spain"
    pageTitle="Óseo"
  />
);
