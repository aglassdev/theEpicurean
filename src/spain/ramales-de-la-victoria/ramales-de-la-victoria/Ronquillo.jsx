...
const Ronquillo = () => (
  <RestaurantPage
    restaurantName="Ronquillo"
    address="Menéndez Pelayo 2, Ramales de la Victoria, 39800, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34942646055"
    website="https://www.restauranteronquilloramales.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with a delightfully rustic ambience that includes a profusion of exposed stone and wood, which provides the backdrop for traditionally inspired cuisine that includes a skilful contemporary touch and revolves around the sourcing of the best zero-mile ingredients. The family at the helm takes care of the meticulous service and the beautiful presentation of dishes featuring on the à la carte and three tasting menus: Cullavera, Cueva del Mirón and Cueva Covalanas. All the soups and stews we tried here, such as the pinto beans with venison, were superb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Men%C3%A9ndez%20Pelayo%202%2C%20Ramales%20de%20la%20Victoria%2C%2039800%2C%20Spain"
    pageTitle="Ronquillo"
  />
);

export default Ronquillo;
