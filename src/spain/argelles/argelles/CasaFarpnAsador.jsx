...
const CasaFarpnAsador = () => (
  <RestaurantPage
    restaurantName="Casa Farpón Asador"
    address="La Revuelta del Coche, Argüelles, 33188, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+34985740913"
    website="https://www.elasadordeabel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A classic address that has had a new lease of life under the reins of chef Javier Álvarez, who has made the move here from the now-closed Casa Farpón de Mamorana. It has retained its rustic ‘asador’ appearance with the open grill visible from the dining room, where the market-inspired menu is focused around various hearty dishes (the Argüelles stew with “compango”, a mix of different meats, is outstanding), daily specials (such as filled potatoes, the thick Asturian “pote” soup, and Verdina beans with spider crab), fresh, traditionally caught fish from Rula, Trasacar red meats, plus an impressive tasting menu. The extensive cellar features a selection of Asturian wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=La%20Revuelta%20del%20Coche%2C%20Arg%C3%BCelles%2C%2033188%2C%20Spain"
    pageTitle="Casa Farpón Asador"
  />
);

export default CasaFarpnAsador;
