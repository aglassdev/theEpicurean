...
const Castillera = () => (
  <RestaurantPage
    restaurantName="Castillería"
    address="Pago de Santa Lucía, Vejer de la Frontera, 11150, Spain"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+34956451497"
    website="https://www.restaurantecastilleria.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Found in the northwest of Vejer, in the rural hamlet known as Pago de Santa Lucía, captivating with its charming terrace design, surprisingly well-integrated into nature and with a glassed-fronted kitchen. Here the grilled meats are the undisputed protagonists, with a good display and fantastic pieces of beef (Retinta de La Janda, Avileña, Rubia gallega, Frisona, Pularda leonesa...) catalogued by age, although there are also interesting pork and lamb options. A unique restaurant to visit as a couple!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pago%20de%20Santa%20Luc%C3%ADa%2C%20Vejer%20de%20la%20Frontera%2C%2011150%2C%20Spain"
    pageTitle="Castillería"
  />
);

export default Castillera;
