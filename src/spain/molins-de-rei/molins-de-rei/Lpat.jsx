...
const Lpat = () => (
  <RestaurantPage
    restaurantName="L'Àpat"
    address="Del Carril 38, Molins de Rei, 08750, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34936680558"
    website="https://www.restaurantlapat.cat/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An efficiently managed family-run restaurant offering a good traditional menu that includes classic dishes such as sautéed Astorga chickpeas with garlic and butifarra sausage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Del%20Carril%2038%2C%20Molins%20de%20Rei%2C%2008750%2C%20Spain"
    pageTitle="L'Àpat"
  />
);
