...
const Sotavento = () => (
  <RestaurantPage
    restaurantName="Sotavento"
    address="Avenida de Miramar 16, San Vicente de la Barquera, 39540, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34942715024"
    website="https://guide.michelin.com/en/cantabria/san-vicente-de-la-barquera/restaurant/sotavento"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small eatery, run by an attentive couple who delight guests with their friendly service, champions traditional cuisine that celebrates local produce, with excellent starters that reveal the bounty of the sea (scallops, sea urchins, and grilled octopus tentacles), wild fish from the fish market (usually large cuts) and two delicious rice dishes, one with lobster and the other with clams (the latter only available on prior request). Given its success and limited seating, we recommend booking in advance!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20Miramar%2016%2C%20San%20Vicente%20de%20la%20Barquera%2C%2039540%2C%20Spain"
    pageTitle="Sotavento"
  />
);

export default Sotavento;
