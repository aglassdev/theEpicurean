...
const LasRedes = () => (
  <RestaurantPage
    restaurantName="Las Redes"
    address="Avenida de los Soportales 24, San Vicente de la Barquera, 39540, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34942712542"
    website="https://restaurantelasredes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run restaurant well situated along the main street running through this small town, where the focus is on sourcing the freshest possible ingredients from the local auction. Traditional à la carte featuring fish, seafood and a few savoury rice dishes. Pleasant terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20los%20Soportales%2024%2C%20San%20Vicente%20de%20la%20Barquera%2C%2039540%2C%20Spain"
    pageTitle="Las Redes"
  />
);

export default LasRedes;
