...
const Augusto = () => (
  <RestaurantPage
    restaurantName="Augusto"
    address="Mercado 1, San Vicente de la Barquera, 39540, Spain"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+34942712040"
    website="https://www.restauranteaugusto.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This longstanding family-run restaurant, located just in front of the local market, boasts a striking nautical decor that provides the backdrop for traditional cuisine that, in perfect harmony with the area’s maritime heritage, champions the highest-quality fish and seafood (priced by weight). This includes seafood stews (“mariscadas”) for sharing and excellent rice options. We can also highly recommend the fried squid (“rabas de calamar”), the legendary “arroz con bogavante” (rice with lobster), a dish for which the family were pioneers, and when it comes to dessert, the delicious cream millefeuille...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mercado%201%2C%20San%20Vicente%20de%20la%20Barquera%2C%2039540%2C%20Spain"
    pageTitle="Augusto"
  />
);
