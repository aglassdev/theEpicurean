...
const CalTrav = () => (
  <RestaurantPage
    restaurantName="Cal Travé"
    address="Carretera d'Andorra 56, Solivella, 43412, Spain"
    cuisine="Catalan, Grills"
    priceRange="€€"
    phoneNumber="+34977892165"
    website="https://sanstrave.com/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This impressively run family restaurant boasts a delightful decorative backdrop of antique objects (large wall clocks, wind instruments, coffee grinders etc) plus an open grill at the far end of the dining room. The traditionally focused Catalan cuisine on offer here features excellent stews, aged meats and plenty of grilled options (we particularly enjoyed the grilled duck breast). A selection of the restaurant’s own still and sparkling wines are also sold here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20d'Andorra%2056%2C%20Solivella%2C%2043412%2C%20Spain"
    pageTitle="Cal Travé"
  />
);

export default CalTrav;
