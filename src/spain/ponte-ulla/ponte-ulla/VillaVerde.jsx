...
const VillaVerde = () => (
  <RestaurantPage
    restaurantName="Villa Verde"
    address="Lugar de Figueiredo 10, Ponte Ulla, 15885, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34981512652"
    website="http://www.villa-verde.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a privileged setting in a part of Galicia famous for its vineyards and magnificent country houses. The aristocratic feel of this area is also reflected in this restaurant occupying a delightful stone property whose origins date back to the 18C. Nowadays, it boasts an attractive wine cellar home to a traditional “lagar” wine trough, a rustic dining room with a typical “lareira” fireplace, plus a dining room with an elegant, classic decor. The traditional home-style cooking here is enhanced by seasonal ingredients, with wild mushrooms, angler fish and veal particularly popular. The baked hake with sea urchin is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lugar%20de%20Figueiredo%2010%2C%20Ponte%20Ulla%2C%2015885%2C%20Spain"
    pageTitle="Villa Verde"
  />
);
