...
const Vinum = () => (
  <RestaurantPage
    restaurantName="Vinum"
    address="Mas d’en Bruno, Torroja del Priorat, 43737, Spain"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+34877676070"
    website="https://www.masdenbruno.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A complete surprise inside the isolated Gran Hotel Mas d'en Bruno, which occupies a restored farmhouse dating back to 1797 and surrounded by vineyards in the heart of the Priorat wine region. To the backdrop of a contemporary decor and open-view kitchen behind a large window, the seasonal cuisine on offer aims to recreate the flavours of inland Cataluña from a more modern perspective and with a focus on meticulous presentation. This is showcased on the à la carte and the option of three tasting menus (one of which is vegetarian). It is well worth eating on the terrace, with its views of the surrounding mountains and the vineyards of the Clos de l'Obac estate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mas%20d%E2%80%99en%20Bruno%2C%20Torroja%20del%20Priorat%2C%2043737%2C%20Spain"
    pageTitle="Vinum"
  />
);
