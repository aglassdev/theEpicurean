...
const TonyGarcaEspacioGastronmico = () => (
  <RestaurantPage
    restaurantName="Tony García Espacio Gastronómico"
    address="Avenida del Mediterráneo 281, Almería, 04009, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34673380270"
    website="https://www.tonygarciaespaciogastronomico.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20del%20Mediterr%C3%A1neo%20281%2C%20Almer%C3%ADa%2C%2004009%2C%20Spain"
    pageTitle="Tony García Espacio Gastronómico"
  />
);

export default TonyGarcaEspacioGastronmico;
