...
const MolinoDeUrdniz = () => (
  <RestaurantPage
    restaurantName="Molino de Urdániz"
    ...
    pageTitle="Molino de Urdániz"
  />
);

export default MolinoDeUrdniz;
