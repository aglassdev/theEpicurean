...
const Solla = () => (
  <RestaurantPage
    restaurantName="Solla"
    address="Avenida Sineiro 7, San Salvador de Poio, 36005, Spain"
    cuisine="Creative, Seafood"
    priceRange="€€€€"
    phoneNumber="+34986872884"
    website="https://www.restaurantesolla.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Pepe Solla almost grew up in the kitchen and has hospitality coursing through his veins, hence the beginning of a life in which he began to be part of the restaurant’s history and vice-versa”. The chef, whose love for cooking came from his father (who was awarded a Michelin star at Casa Solla in 1980), has brought the restaurant more up to date, running the family business to the highest standard while continuing to evolve, in particular thanks to his obsession with flavour, and a focus on creative cooking inspired by the culinary traditions of Galicia. On his maritime-inspired Trasmallo and Piobardeira menus (named after techniques used in fishing) we thoroughly enjoyed dishes entitled “spider crab, spider crab” and “sea urchin, codium”, with options separated into different sections (Fós..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Sineiro%207%2C%20San%20Salvador%20de%20Poio%2C%2036005%2C%20Spain"
    pageTitle="Solla"
  />
);

export default Solla;
