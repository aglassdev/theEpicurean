...
const Geyumar = () => (
  <RestaurantPage
    restaurantName="Güeyu-Mar"
    address="Playa de Vega 84, La Vega, 33560, Spain"
    cuisine="Grills, Seafood"
    priceRange="€€€"
    phoneNumber="+34985860863"
    website="https://gueyumar.es/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Playa%20de%20Vega%2084%2C%20La%20Vega%2C%2033560%2C%20Spain"
    pageTitle="Güeyu-Mar"
  />
);

export default Geyumar;
