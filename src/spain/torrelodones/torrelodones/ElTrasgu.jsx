...
const ElTrasgu = () => (
  <RestaurantPage
    restaurantName="El Trasgu"
    address="Cudillero 2, Torrelodones, 28250, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34620859161"
    website="https://www.eltrasgurestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="El Trasgu occupies an elegant chalet-style property featuring a bar and three classic-cum-contemporary dining rooms. The traditional à la carte offers a selection of stews, rice dishes and seafood. The superb terrace is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cudillero%202%2C%20Torrelodones%2C%2028250%2C%20Spain"
    pageTitle="El Trasgu"
  />
);

export default ElTrasgu;
