...
const Gaudium = () => (
  <RestaurantPage
    restaurantName="Gaudium"
    address="Cup 2, Altafulla, 43893, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34977651557"
    website="https://restaurantgaudium.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re visiting this attractive medieval town, book a table here! This restaurant, part of the Gran Claustre Boutique Hotel, but with its own identity and entrance, is a good place to stop thanks to its attractive combination of design and modernity, as well as an attractive glass-fronted wine cellar and open-view kitchen. In the latter, chef Jaume Drudis champions traditional seasonal cooking with a strong focus on detail and presentation, with a nod and a wink to French cuisine. There are à la carte options and several set menus: Ambigú (3 courses, weekday lunches), Seasonal Experience (5 courses), Sea Experience (5 courses) and Sensory Experience (8 courses)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cup%202%2C%20Altafulla%2C%2043893%2C%20Spain"
    pageTitle="Gaudium"
  />
);

export default Gaudium;
