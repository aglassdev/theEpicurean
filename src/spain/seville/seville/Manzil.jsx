...
const Manzil = () => (
  <RestaurantPage
    restaurantName="Manzil"
    address="Alfonso XII 13, Seville, 41001, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34854745906"
    website="https://www.restaurantemanzil.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily closed due to relocation) This centrally located restaurant boasts an open kitchen and a striking decor featuring large images of animals and vegetables painted on the walls. The dining experience, which begins with appetisers at the counter in the kitchen before continuing at your table, reflects the full personality and passion of the chef (who has worked in several renowned restaurants and who has represented Spain at the prestigious Bocuse d´Or competition) for Andalucian cuisine. His cooking is highlighted on two extensive menus (Morada and Manzil) featuring an array of small plates, superb textures and impressive pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alfonso%20XII%2013%2C%20Seville%2C%2041001%2C%20Spain"
    pageTitle="Manzil"
  />
);
