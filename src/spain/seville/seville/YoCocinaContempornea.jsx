...
const YoCocinaContempornea = () => (
  <RestaurantPage
    restaurantName="Yo, Cocina Contemporánea"
    address="Bailén 34, Seville, 41001, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34604950877"
    website="https://restauranteyo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For elaborate cooking with a difference, we recommend heading to this restaurant in Seville that serves cuisine direct from the Sardinian capital, Cagliari, in Italy. Through this new venture, Chef Stefano Deidda, who had already enjoyed considerable gastronomic success on the island, is seeking to develop a much more relaxed and personal project in a city that he and his partner (Eva Urru) have fallen in love with. His creative and contemporary cuisine, which is only showcased on two tasting menus (Esencial and Esencia), is both delicate and teeming with Andalucian and Gallic nuances. One dish that came as a particular surprise was the delicious and creamy onion and cheese ravioli with onion soup and white wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bail%C3%A9n%2034%2C%20Seville%2C%2041001%2C%20Spain"
    pageTitle="Yo, Cocina Contemporánea"
  />
);

export default YoCocinaContempornea;
