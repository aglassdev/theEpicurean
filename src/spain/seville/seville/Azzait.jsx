...
const Azzait = () => (
  <RestaurantPage
    restaurantName="Az-Zait"
    address="Plaza de San Lorenzo 1, Seville, 41002, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34954906475"
    website="http://www.azzait.es"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20San%20Lorenzo%201%2C%20Seville%2C%2041002%2C%20Spain"
    pageTitle="Az-Zait"
  />
);

export default Azzait;
