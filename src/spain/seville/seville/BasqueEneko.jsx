...
const BasqueEneko = () => (
  <RestaurantPage
    restaurantName="Basque Eneko"
    address="Plaza de la Magdalena 1, Seville, 41001, Spain"
    cuisine="Basque"
    priceRange="€€€"
    phoneNumber="+34955121033"
    website="https://www.enekoatxaseville.com/es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Discover the contemporary Basque cuisine of award-winning chef Eneko Atxa, who has transported his creative cooking to Seville. Occupying the ground floor of the Radisson Collection Hotel, Magdalena Plaza Sevilla, this restaurant showcase the chef’s more conceptual style of cooking, which includes options for sharing and an array of grilled dishes (smoked Iberian pork, matured beef chop etc). The à la carte is complemented by two tasting menus (Labur and Luze), both with the option of adding a wine pairing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20la%20Magdalena%201%2C%20Seville%2C%2041001%2C%20Spain"
    pageTitle="Basque Eneko"
  />
);

export default BasqueEneko;
