...
const Alenda = () => (
  <RestaurantPage
    restaurantName="Alenda"
    address="Castiello de Selorio 23-A, Villaviciosa, 33316, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34676517632"
    website="https://alendarestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This delightful rural property, run in friendly fashion by Iñaki Gómez in the kitchen and Lola Palacio front of house, is located in a very small village and is a way of life for this couple who work tirelessly to run the business and cultivate their vegetable garden located next to the restaurant. They put a huge amount of enthusiasm and professionalism into their work which is showcased on three exclusive menus (Castiello, Rodiles and Alenda, the latter an Asturian term that could be translated as “taking time to breathe”) where tradition and authentic Asturian flavours take centre stage. Prominence is given to fish sourced daily from the neighbouring fish auctions in Lastres and Tazones, as well to superb cuts of Asturian meat, all of which are prepared in contemporary style with fine t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Castiello%20de%20Selorio%2023-A%2C%20Villaviciosa%2C%2033316%2C%20Spain"
    pageTitle="Alenda"
  />
);

export default Alenda;
