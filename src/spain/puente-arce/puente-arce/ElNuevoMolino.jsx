...
const ElNuevoMolino = () => (
  <RestaurantPage
    restaurantName="El Nuevo Molino"
    address="Barrio Monseñor 18, Puente Arce, 39478, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34942575055"
    website="https://elnuevomolino.es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re on the lookout for a restaurant with plenty of charm, make sure you book a table at El Nuevo Molino! This delightful restaurant on the banks of the River Pas will delight guests with its setting in an 18C water mill adorned with mill wheels, as well as its garden, home to a deconsecrated chapel and a large old granary. Nowadays, the latter provides a relaxed bistro-style setting for the daily Le Hórreo menu. In the attractive, rustically inspired dining rooms in the main building, chef José Antonio González conjures up traditional Cantabrian cuisine, bringing local recipes right up to date, using many ingredients grown in his own vegetable garden and reviving the authentic flavours of the region. The à la carte, featuring half-“ración” options and fish sourced daily at auction, i..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Barrio%20Monse%C3%B1or%2018%2C%20Puente%20Arce%2C%2039478%2C%20Spain"
    pageTitle="El Nuevo Molino"
  />
);

export default ElNuevoMolino;
