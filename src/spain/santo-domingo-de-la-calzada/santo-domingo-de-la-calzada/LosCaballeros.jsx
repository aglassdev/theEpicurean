...
const LosCaballeros = () => (
  <RestaurantPage
    restaurantName="Los Caballeros"
    address="Mayor 58, Santo Domingo de la Calzada, 26250, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34941342789"
    website="https://www.restauranteloscaballeros.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Los Caballeros occupies a historic building just behind the cathedral. In the rustically styled dining choose from a regional à la carte menu featuring an impressive array of soups, stews and cod dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mayor%2058%2C%20Santo%20Domingo%20de%20la%20Calzada%2C%2026250%2C%20Spain"
    pageTitle="Los Caballeros"
  />
);

export default LosCaballeros;
