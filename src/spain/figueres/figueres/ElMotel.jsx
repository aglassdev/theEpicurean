...
const ElMotel = () => (
  <RestaurantPage
    restaurantName="El Motel"
    address="Avenida Salvador Dalí 170, Figueres, 17600, Spain"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34972500562"
    website="https://www.elmotelrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run restaurant with lots of history that first opened its doors in 1961; as a result, both the classic decor and the service seem as though they are from a different era. The à la carte featuring a mix of traditional Catalan and international dishes is complemented by a menu (“Sabores de temporada”) that focuses on seasonal flavours. Don’t miss the cheese trolley!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Salvador%20Dal%C3%AD%20170%2C%20Figueres%2C%2017600%2C%20Spain"
    pageTitle="El Motel"
  />
);

export default ElMotel;
