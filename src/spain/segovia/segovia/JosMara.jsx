...
const JosMara = () => (
  <RestaurantPage
    restaurantName="José María"
    address="Cronista Lecea 11, Segovia, 40001, Spain"
    cuisine="Traditional Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34921461111"
    website="https://www.restaurantejosemaria.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sense of space and attractive Castilian-style decor in this “asador”-style restaurant come as a pleasant surprise in what is one of the city’s classic dining institutions. Without a shadow of a doubt, the signature dish here is the traditionally cooked roast suckling pig reared on the family farm (Agrocorte Gourmet). The extensive, traditionally inspired à la carte, is also enhanced by seasonal dishes (pumpkin, leeks, and game such as wild boar and venison) and complemented by the Nuestra Cocina Segoviana tasting menu, with the icing on the cake provided by the superbly innovative Pago de Carraovejas wines from the Ribera del Duero region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cronista%20Lecea%2011%2C%20Segovia%2C%2040001%2C%20Spain"
    pageTitle="José María"
  />
);

export default JosMara;
