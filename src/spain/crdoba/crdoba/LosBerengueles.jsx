...
const LosBerengueles = () => (
  <RestaurantPage
    restaurantName="Los Berengueles"
    address="Conde de Torres Cabrera 7, Córdoba, 14001, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34957472828"
    website="https://guide.michelin.com/en/andalucia/cordoba/restaurant/los-berengueles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Los Berengueles occupies the former house of the Marquesa de Valdeloro. It is a building with solid Andalucian roots as witnessed by its azulejo decoration and timeless beauty. Traditional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Conde%20de%20Torres%20Cabrera%207%2C%20C%C3%B3rdoba%2C%2014001%2C%20Spain"
    pageTitle="Los Berengueles"
  />
);

export default LosBerengueles;
