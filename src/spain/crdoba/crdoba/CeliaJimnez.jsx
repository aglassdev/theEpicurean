...
const CeliaJimnez = () => (
  <RestaurantPage
    restaurantName="Celia Jiménez"
    address="Escritora María Goyri, Córdoba, 14005, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34957049855"
    website="https://celiajimenez.com/es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is located in Andalucia’s largest sports complex. The chef – widely respected in the world of gastronomy – conjures up Andalucian cuisine brought up - to - date with contemporary cooking techniques and presentation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Escritora%20Mar%C3%ADa%20Goyri%2C%20C%C3%B3rdoba%2C%2014005%2C%20Spain"
    pageTitle="Celia Jiménez"
  />
);

export default CeliaJimnez;
