...
const Godai = () => (
  <RestaurantPage
    restaurantName="Godai"
    address="Vía de Circunvalación, Ciutadella de Menorca, 07769, Spain"
    cuisine="Japanese Contemporary"
    priceRange="€€€€"
    phoneNumber="+34971384188"
    website="https://www.godaimenorca.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located within the Suites del Lago hotel (Lago Resort Menorca), where award-winning chef Julián Mármol conjures up exquisite Japanese-Menorcan cuisine. The terrace and views of the marina add to its appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=V%C3%ADa%20de%20Circunvalaci%C3%B3n%2C%20Ciutadella%20de%20Menorca%2C%2007769%2C%20Spain"
    pageTitle="Godai"
  />
);

export default Godai;
