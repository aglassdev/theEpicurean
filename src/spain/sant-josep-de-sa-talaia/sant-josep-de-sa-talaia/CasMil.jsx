...
const CasMil = () => (
  <RestaurantPage
    restaurantName="Ca's Milà"
    address="Playa de Cala Tarida, Sant Josep de sa Talaia, 07829, Spain"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+34971806193"
    website="https://www.restaurantecasmila.com/es/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant in which to savour the flavours, aromas and sea views to the full. Along with its simplicity, Ca's Milà stands out for its homely atmosphere, attentive service and its location right by the beach, practically clinging to the cliff, along with charming terraces and romantic views. Its traditional Ibizan cuisine specialises in fish (mainly cooked à la plancha or on the grill) and rice dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Playa%20de%20Cala%20Tarida%2C%20Sant%20Josep%20de%20sa%20Talaia%2C%2007829%2C%20Spain"
    pageTitle="Ca's Milà"
  />
);

export default CasMil;
