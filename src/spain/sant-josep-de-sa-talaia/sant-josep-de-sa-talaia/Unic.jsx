...
const Unic = () => (
  <RestaurantPage
    restaurantName="Unic"
    address="Les Begònies 18, Sant Josep de sa Talaia, 07817, Spain"
    cuisine="Innovative"
    priceRange="€€€"
    phoneNumber="+34971393573"
    website="https://www.unicrestaurantibiza.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Part of the modern Migjorn Ibiza hotel (located in the area around the Playa d’en Bossa), Unic impresses guests with its setting inside two glass cubes as well as its stylish decor. Here, French chef David Grussaute offers two tasting menus (Unic and La Xanga, with sections entitled Prelude, From the Sea, Surf & Turf, From the Land, and A Moment of Sweetness) that always champion locally sourced ingredients which enable him to showcase the culinary essence of both the island and the Mediterranean in close collaboration with small-scale producers, breeders and the local fishing community. All his dishes feature marked, intense flavours and highly delicate sauces, although if we had to highlight one dish that will remain in the memory, it would be the “Pityuses, island of pines” dessert, whi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Les%20Beg%C3%B2nies%2018%2C%20Sant%20Josep%20de%20sa%20Talaia%2C%2007817%2C%20Spain"
    pageTitle="Unic"
  />
);
