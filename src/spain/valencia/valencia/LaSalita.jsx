...
const LaSalita = () => (
  <RestaurantPage
    restaurantName="La Salita"
    address="Pere III El Gran 11, Valencia, 46005, Spain"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34963817516"
    website="https://www.anarkiagroup.com/inicio/la-salita"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A superb example of how perseverance, effort and solid values in the face of fresh challenges helps you to grow professionally. This restaurant, occupying an impressive mansion in the city’s Ruzafa district that has been decorated with plenty of charm and personality, stands out for its different dining options. In addition to the main dining room upstairs, it also boasts a pretty garden, two attractive tables in front of the kitchen and a particularly pleasant terrace where guests can enjoy aperitifs, a meal or a relaxing post-dinner drink. Chef Begoña Rodrigo showcases her talents on several tasting menus (La Gaira, La Vianda, the ovo-lacto vegetarian La Burria, and La Salita) which demonstrate her interest in working with vinegars, pickles, citrus fruit and highly original vegetarian ch..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pere%20III%20El%20Gran%2011%2C%20Valencia%2C%2046005%2C%20Spain"
    pageTitle="La Salita"
  />
);

export default LaSalita;
