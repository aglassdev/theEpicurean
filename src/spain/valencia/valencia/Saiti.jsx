...
const Saiti = () => (
  <RestaurantPage
    restaurantName="Saiti"
    address="Reina Doña Germana 4, Valencia, 46005, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34960054124"
    website="https://www.saiti.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive restaurant with a bistro ambience and rustic-contemporary decor. On its menus (L'Eixample, Na Germana and Lo Rat Penat), all of which are available with a wine pairing, chef Vicente Patiño takes us on a gastronomic journey via Mediterranean cooking that is rooted in tradition but approached from a more modern perspective. Dishes on the menu here range from the local “all I pebre” of white prawns and cacao, to blue crab, and signature dishes such as the celery meringue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reina%20Do%C3%B1a%20Germana%204%2C%20Valencia%2C%2046005%2C%20Spain"
    pageTitle="Saiti"
  />
);

export default Saiti;
