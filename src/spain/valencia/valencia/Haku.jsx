...
const Haku = () => (
  <RestaurantPage
    restaurantName="Haku"
    address="Gran Vía del Marqués del Turia 62, Valencia, 46005, Spain"
    cuisine="Japanese Contemporary"
    priceRange="€€€"
    phoneNumber="+34628869525"
    website="https://www.hakuvalencia.es"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy fusion cuisine, this Japanese restaurant is a must as it takes its relationship with the Mediterranean one step further thanks to the unique blend of Japanese-Italian cooking that comes courtesy of young chef Bo Jimmy Zhu, who hails from the town of Asti in Italy’s Piedmont region. His dishes are based around the Omakase philosophy which only works with the very best market-inspired ingredients. These are served at the bar (there is also a private space with a more exclusive ambience) and are centred around three enticing menus: Taibo, Bohan and Honbo. The superb nigiris here are prepared with a 50:50 mix of traditional vinegar and Modena balsamic vinegar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gran%20V%C3%ADa%20del%20Marqu%C3%A9s%20del%20Turia%2062%2C%20Valencia%2C%2046005%2C%20Spain"
    pageTitle="Haku"
  />
);
