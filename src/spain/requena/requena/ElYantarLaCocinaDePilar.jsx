...
const ElYantarLaCocinaDePilar = () => (
  <RestaurantPage
    restaurantName="El Yantar La Cocina de Pilar"
    address="Plaza de Albornoz 8, Requena, 46340, Spain"
    cuisine="Fusion, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+34695143207"
    website="https://www.restauranteelyantar.com/el-yantar-la-cocina-de-pilar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sharing a building with the La Villa hotel, this restaurant boasts a meticulous dining room at street level as well as a cave-like dining room excavated out of the rock that is accessed via a narrow flight of steps. Its main courses are centred around traditional cooking and are preceded by somewhat bolder starters with a nod to the fusion cuisine of Asia and the Americas. Note the excellent choice of Utiel-Requena wines!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20Albornoz%208%2C%20Requena%2C%2046340%2C%20Spain"
    pageTitle="El Yantar La Cocina de Pilar"
  />
);

export default ElYantarLaCocinaDePilar;
