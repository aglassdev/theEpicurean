...
const Mare = () => (
  <RestaurantPage
    restaurantName="Mare"
    address="Plaza de la Candelaria 12, Cadiz, 11005, Spain"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+34628688030"
    website="https://www.marerestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Are you looking for a tasty and meticulous cuisine with Andalusian heritage? In this restaurant, overlooking the central Plaza de Candelaria, you will find it. Chef Juan Viu, who describes himself as a ‘guisandero’ (stew maker) and explains all his preparations in detail, seeks to pay his personal tribute to traditional cuisine, to a mother's cooking and the best seafood. The proposal, subject to a unique surprise tasting menu that changes almost daily, depending on both seasonal products and those purchased in nearby fish markets (Conil, Vejer de la Frontera, Chiclana, etc.), brings the classic Cadiz recipe book to the table from a modern perspective, giving all the prominence to the family flavours of his childhood and traditional seafood stews. An iconic ever-present dish? El Atún en To..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20de%20la%20Candelaria%2012%2C%20Cadiz%2C%2011005%2C%20Spain"
    pageTitle="Mare"
  />
);
