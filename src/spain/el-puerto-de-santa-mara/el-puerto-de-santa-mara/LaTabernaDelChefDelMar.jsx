...
const LaTabernaDelChefDelMar = () => (
  <RestaurantPage
    restaurantName="La Taberna del Chef del Mar"
    address="Puerto Escondido 6, El Puerto de Santa María, 11500, Spain"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+34956112093"
    website="https://latabernadelchefdelmar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It was at Aponiente in El Puerto de Santa María that chef Ángel León made his culinary name! His creative cuisine extols the full virtues of the sea here through dishes inherited from Aponiente, alongside an array of “medias raciones”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Puerto%20Escondido%206%2C%20El%20Puerto%20de%20Santa%20Mar%C3%ADa%2C%2011500%2C%20Spain"
    pageTitle="La Taberna del Chef del Mar"
  />
);

export default LaTabernaDelChefDelMar;
