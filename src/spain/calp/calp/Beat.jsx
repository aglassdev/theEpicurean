...
const Beat = () => (
  <RestaurantPage
    restaurantName="Beat"
    address="Urbanización Marisol Park 1A, Calp, 03710, Spain"
    cuisine="French Contemporary, International"
    priceRange="€€€€"
    phoneNumber="+34965875700"
    website="https://www.ar-hotels.com/restaurantes-calpe/beat.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Beat reflects the culinary pulse  of The Cook Book hotel right from the outset, quickening the heartbeat from the very first bite of your appetisers.This bright restaurant, with its dominant white decor, reflects the true essence of the Mediterranean, providing the backdrop for what promises to be a stunning dining experience, marked by faultless ingredients and a harmony that sees flavours working together to their mutual benefit. Valencia-born chef José Manuel Miguel, the only chef to have been awarded a Michelin star in both France and Spain, continues his quest for excellence, steering what he offers towards his menus (including one that is vegetarian) without neglecting an impressive à la carte. All feature contemporary dishes that combine the vitality of the Mediterranean with the fi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Urbanizaci%C3%B3n%20Marisol%20Park%201A%2C%20Calp%2C%2003710%2C%20Spain"
    pageTitle="Beat"
  />
);
