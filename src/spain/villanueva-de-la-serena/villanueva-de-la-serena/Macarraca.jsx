...
const Macarraca = () => (
  <RestaurantPage
    restaurantName="Macarraca"
    address="Navegante Juan Patiño 78, Villanueva de la Serena, 06700, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34613095291"
    website="https://macarraca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under this intriguing name, which is a celebration of an almost forgotten dish from Extremadura, this simple restaurant attempts to revive traditional regional flavours from a modern perspective. The young duo at the helm, Josemi Martínez and Mercedes Rincón, are embarking on their own personal project here after working in some of the finest establishments, some even outside Spain. Both chefs, who throughout their careers have always been ambassadors for the products of their home region, uphold traditional Extremaduran recipes using modern techniques and the best local seasonal produce, bringing them to our palates through their à la carte menu and two tasting menus (Corto and Festival). Standout dishes? Don't miss the unique grilled Extremaduran ensaimada, the boneless Verato-Retinto ki..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Navegante%20Juan%20Pati%C3%B1o%2078%2C%20Villanueva%20de%20la%20Serena%2C%2006700%2C%20Spain"
    pageTitle="Macarraca"
  />
);

export default Macarraca;
