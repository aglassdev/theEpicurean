...
const PortPetit = () => (
  <RestaurantPage
    restaurantName="Port Petit"
    address="Avenida Cala Llonga, Cala d'Or, 07660, Spain"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+34971643039"
    website="https://www.portpetit.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive restaurant with a pleasant terrace offering delightful views of the marina. A mix of Mediterranean and international cuisine with French influence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Cala%20Llonga%2C%20Cala%20d'Or%2C%2007660%2C%20Spain"
    pageTitle="Port Petit"
  />
);

export default PortPetit;
