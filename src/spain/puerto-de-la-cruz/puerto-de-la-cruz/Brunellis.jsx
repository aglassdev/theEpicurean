...
const Brunellis = () => (
  <RestaurantPage
    restaurantName="Brunelli's"
    address="Bencomo 42, Puerto de la Cruz, 38400, Spain"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+34922062600"
    website="https://brunellis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A splendid steakhouse located close to the entrance to the Loro Parque zoo. This family-run restaurant is a must on the island for meat-lovers given its choice of top-quality meat, with the advantage of many being aged on the premises. Make sure you try Brunelli's steak tartare, its signature speciality, or one of its superb cuts of grilled meat (Uruguayan beef entrecôte, Nebraskas Black Angus T-Bone, German Simmental ribeye, Chateaubriand and Spanish Tomahawk), many of which are sold by weight and designed for two people to share. The particularly impressive picture window here overlooks the sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bencomo%2042%2C%20Puerto%20de%20la%20Cruz%2C%2038400%2C%20Spain"
    pageTitle="Brunelli's"
  />
);

export default Brunellis;
