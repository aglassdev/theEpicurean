...
const ElTallerSeveDaz = () => (
  <RestaurantPage
    restaurantName="El Taller Seve Díaz"
    address="San Felipe 32, Puerto de la Cruz, 38400, Spain"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+34822257538"
    website="https://www.eltallersevediaz.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Felipe%2032%2C%20Puerto%20de%20la%20Cruz%2C%2038400%2C%20Spain"
    pageTitle="El Taller Seve Díaz"
  />
);

export default ElTallerSeveDaz;
