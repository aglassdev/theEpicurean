...
const CuinaSantPau = () => (
  <RestaurantPage
    restaurantName="Cuina Sant Pau"
    address="Nou 10, Sant Pol de Mar, 08395, Spain"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+34937600950"
    website="https://www.cuina-santpau.cat"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This iconic restaurant, which held three Michelin stars for many years, has adopted a new, much more informal bistro format featuring numerous images and mementoes that highlight the career of legendary chef Carme Ruscalleda. Her son Raül Balam Ruscalleda and Brazilian chef Murilo Rodrigues Alves are now in charge, offering a contemporary, Catalan-influenced menu that includes unpretentious dishes, Brazilian touches and a nod to the history of the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nou%2010%2C%20Sant%20Pol%20de%20Mar%2C%2008395%2C%20Spain"
    pageTitle="Cuina Sant Pau"
  />
);

export default CuinaSantPau;
