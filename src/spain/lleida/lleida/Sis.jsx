...
const Sis = () => (
  <RestaurantPage
    restaurantName="Sisè"
    address="Avinguda de l'Estudi General 27, Lleida, 25001, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34973821719"
    website="https://guide.michelin.com/en/catalunya/lleida/restaurant/sise"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sisè is situated in the district of Cappont, a residential area to the south of the city, where it is run in a very informal manner by Àngel Esteve, a young Lleida-born chef who has returned to his roots to open his own business (the name is his own small homage to his grandparents) having worked away in a number of leading restaurants. His cuisine, the main inspiration for which derives from the open grill, is showcased on an updated take on traditional cuisine, to which he adds interesting smoke-influenced touches (a superb example is the grilled cod with celery). The kitchen opens onto the dining room and features a counter perfect for watching the preparation of each dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avinguda%20de%20l'Estudi%20General%2027%2C%20Lleida%2C%2025001%2C%20Spain"
    pageTitle="Sisè"
  />
);
