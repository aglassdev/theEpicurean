...
const CaLenric = () => (
  <RestaurantPage
    restaurantName="Ca l'Enric"
    address="Carretera Camprodón N 260, La Vall de Bianya, 17813, Spain"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+34972290015"
    website="https://www.restaurantcalenric.cat/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Juncà siblings (with Jordi and Isabel in the kitchen and Joan in the role of sommelier and front of house manager), along with the highly valued contribution of their children, focus on the history of the property and its personality, while continuing to extol the virtues of the wooded landscapes of the Vall de Bianya. The “hostal” that first stood here in the late 19C has given way to this superb gastronomic restaurant with a contemporary look and interesting contrasts between modern design and the materials that connect us with our surroundings (stone, wood, leather etc). The à la carte and set menus (Memories in Evolution and Discovering the Valley) open the door to creative cuisine that embraces traditional Catalan cooking while at the same time showcasing seasonal native ingredien..."
    ...
    pageTitle="Ca l'Enric"
  />
);

export default CaLenric;
