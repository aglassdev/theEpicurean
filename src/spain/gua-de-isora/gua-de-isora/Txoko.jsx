...
const Txoko = () => (
  <RestaurantPage
    ...
    bio="This restaurant has the feel of a modern Basque “txoko” (gastronomic society) and, in a nod to chef Martín Berasategui’s origins, offers cooking that is very “casual” in style. The glass-fronted terrace can be completely opened in the summer months...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20TF%2047%2C%20Gu%C3%ADa%20de%20Isora%2C%2038687%2C%20Spain"
    pageTitle="Txoko"
  />
);

export default Txoko;
