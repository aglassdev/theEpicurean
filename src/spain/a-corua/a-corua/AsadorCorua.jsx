...
const AsadorCorua = () => (
  <RestaurantPage
    restaurantName="Asador Coruña"
    address="Alcalde José Crespo López Mora 4, A Coruña, 15008, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34981240157"
    website="http://asadorcoruna.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant in which maximum respect is paid to the quality of ingredients. A classic - cum - traditional dining room with a profusion of wood, decorative stonework and an open - view kitchen. Excellent Galician meats grilled over a wood fire, as well as delicious fish dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alcalde%20Jos%C3%A9%20Crespo%20L%C3%B3pez%20Mora%204%2C%20A%20Coru%C3%B1a%2C%2015008%2C%20Spain"
    pageTitle="Asador Coruña"
  />
);

export default AsadorCorua;
