...
const Culuca = () => (
  <RestaurantPage
    restaurantName="Culuca"
    address="Avenida Arteixo 10, A Coruña, 15004, Spain"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+34981978898"
    website="https://culuca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A spacious, modern and centrally located gastro - bar with a young and informal atmosphere. Enjoy tapas and raciones that mix the traditional with the creative...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Arteixo%2010%2C%20A%20Coru%C3%B1a%2C%2015004%2C%20Spain"
    pageTitle="Culuca"
  />
);

export default Culuca;
