...
const Salitre = () => (
  <RestaurantPage
    restaurantName="Salitre"
    address="Paseo Marítimo Alcalde Francisco Vázquez 25, A Coruña, 15002, Spain"
    cuisine="Galician, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34981923253"
    website="https://www.salitrecoruna.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Salitre’s menu is based around Galician products with a penchant for traditional flavours. On the à la carte we recommend the delicious fish stew (“caldeirada de pescado”) and any of its savoury rice dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paseo%20Mar%C3%ADtimo%20Alcalde%20Francisco%20V%C3%A1zquez%2025%2C%20A%20Coru%C3%B1a%2C%2015002%2C%20Spain"
    pageTitle="Salitre"
  />
);

export default Salitre;
