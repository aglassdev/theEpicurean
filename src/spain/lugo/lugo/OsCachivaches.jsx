...
const OsCachivaches = () => (
  <RestaurantPage
    restaurantName="Os Cachivaches"
    address="Campos Novos 26, Lugo, 27002, Spain"
    cuisine="Traditional Cuisine, Rice Dishes"
    priceRange="€€"
    phoneNumber="+34982220099"
    website="https://www.oscachivaches.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Campos%20Novos%2026%2C%20Lugo%2C%2027002%2C%20Spain"
    pageTitle="Os Cachivaches"
  />
);

export default OsCachivaches;
