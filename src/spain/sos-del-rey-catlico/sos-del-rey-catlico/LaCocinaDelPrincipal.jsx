...
const LaCocinaDelPrincipal = () => (
  <RestaurantPage
    restaurantName="La Cocina del Principal"
    address="Fernando El Católico 13, Sos del Rey Católico, 50680, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+34948888348"
    website="https://www.lacocinadelprincipal.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of the historic quarter, this restaurant occupies a charming building which provides the backdrop for a traditionally inspired à la carte featuring numerous grilled dishes. The terrace with beautiful views is an added bonus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fernando%20El%20Cat%C3%B3lico%2013%2C%20Sos%20del%20Rey%20Cat%C3%B3lico%2C%2050680%2C%20Spain"
    pageTitle="La Cocina del Principal"
  />
);

export default LaCocinaDelPrincipal;
