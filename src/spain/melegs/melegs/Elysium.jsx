...
const Elysium = () => (
  <RestaurantPage
    restaurantName="Elysium"
    address="Al Virillas de Rondan, 16, Melegís, 18658, Spain"
    cuisine="Contemporary, Creative"
    priceRange="€€€€"
    phoneNumber="+34689509792"
    website="https://www.elysiumlecrin.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Valle de Lecrín, housed in a restored mansion overlooking the beautiful surroundings of Melegís in Granada, this restaurant adds a gourmet touch to the elegant boutique hotel of the same name. The couple at the helm, with chef Michael Sandoval (an American with Mexican roots) in the kitchen and Dutch-born Jasmijn Saft managing the front of house, have travelled halfway around the world through their work, but... fate brought them here to make their dreams come true! Michael, who sees the kitchen as his personal creative escape, trained under famous chef Thomas Keller, who has several Michelin-starred restaurants in the United States. What will you find here? Everything revolves around two tasting menus, a short one (only at lunchtime) and a long one, with a very internation..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Al%20Virillas%20de%20Rondan%2C%2016%2C%20Meleg%C3%ADs%2C%2018658%2C%20Spain"
    pageTitle="Elysium"
  />
);
