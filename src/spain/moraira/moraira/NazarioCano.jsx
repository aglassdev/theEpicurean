...
const NazarioCano = () => (
  <RestaurantPage
    restaurantName="Nazario Cano"
    address="Moncayo 20, Moraira, 03724, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+34613486597"
    website="https://www.ritualdeterra.com/es/nazario-cano/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a room by the entrance of the Ritual de Terra Moraira Resort & Spa hotel, the restaurant stands out as an exclusive area with independent access. In its cosy interior, dominated by earth tones and with a quaint ceiling decoration featuring circular figures hanging in different shapes, Chef Nazario Cano champions an extremely contemporary and personal cuisine with Mediterranean roots, with constant nods to local produce from the Marina Alta, respect for the natural cycles and traditional flavours, both on the à la carte menu and in his tasting menus (Terra, Ritual and Nazario Cano). Standout dishes? We were very surprised by the lemon foie gras shortbread with butter brioche, the interplay of flavours in the intriguing razor clam macaroni carbonara, and the firm, tasty texture of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Moncayo%2020%2C%20Moraira%2C%2003724%2C%20Spain"
    pageTitle="Nazario Cano"
  />
);

export default NazarioCano;
