...
const HikaByRobertoRuiz = () => (
  <RestaurantPage
    restaurantName="Hika by Roberto Ruiz"
    address="Barrio de Otelarre 40, Villabona, 20150, Spain"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+34943142709"
    website="http://wwwhikabodega.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Do you like wine tourism? If so, you can't miss this modern txacoli winery (also called Hika) and the restaurant inside, with large windows to enjoy the views of the vineyards and mountains. The chef Roberto Ruiz, who always covers his head with a typical txapela (beret), offers us through his menu and his tasting menu a traditional cuisine, with Basque roots, with specialities such as Tolosa beans, Stuffed baby squid in their own ink, José Juan Castillo style, Txangurro a la Donostiarra (spider crab)... Interesting facts: The appetizers exalt the products of his garden and the stews are prepared in an economical kitchen, with wood and charcoal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Barrio%20de%20Otelarre%2040%2C%20Villabona%2C%2020150%2C%20Spain"
    pageTitle="Hika by Roberto Ruiz"
  />
);

export default HikaByRobertoRuiz;
