...
const Belllloc = () => (
  <RestaurantPage
    restaurantName="Bell-Lloc"
    address="Carretera Sant Feliu a Girona, Santa Cristina d'Aro, 17246, Spain"
    cuisine="Catalan"
    priceRange="€€"
    phoneNumber="+34872200115"
    website="https://www.restaurantbell-lloc.com/ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bell-Lloc occupies an old farmhouse with a marked rustic ambience, the origins of which date back to the 17C. Traditional Catalan cooking that is simple yet delicious, including dishes cooked on the grill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carretera%20Sant%20Feliu%20a%20Girona%2C%20Santa%20Cristina%20d'Aro%2C%2017246%2C%20Spain"
    pageTitle="Bell-Lloc"
  />
);

export default Belllloc;
