...
const CanBoqueta = () => (
  <RestaurantPage
    restaurantName="Ca´n Boqueta"
    address="Avenida de la Gran Via 43, Sóller, 07100, Spain"
    cuisine="Regional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34971638398"
    website="https://www.canboqueta.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the centre of Sóller, one of Mallorca’s most picturesque towns, and easily accessible from Palma, including via the island’s historic train with its traditional wooden carriages. The restaurant occupies a typical Mallorcan house with an impeccable rustic decor and a particularly attractive rear patio with fine views of the valley and its famous orange groves. To this backdrop, owner-chef Xisco Martorell offers guests his updated and innovative take on Mallorcan cuisine that can be enjoyed on two tasting menus – a simpler offering at lunchtime with a more elaborate option in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20de%20la%20Gran%20Via%2043%2C%20S%C3%B3ller%2C%2007100%2C%20Spain"
    pageTitle="Ca´n Boqueta"
  />
);

export default CanBoqueta;
