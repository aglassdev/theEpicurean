...
const Pinea = () => (
  <RestaurantPage
    restaurantName="Pinea"
    address="Parras 10, Ayora, 46620, Spain"
    cuisine="Contemporary, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+34962191340"
    website="https://www.pinearestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy restaurant with a Nordic feel is run by two chefs (Kiko in the kitchen and Elisabet in charge of front of house) who also happen to be a couple. Their fresh, regional cuisine features interesting contemporary and international touches and a close bond with the ingredients of each season – they like nothing better than heading out into the countryside to forage for herbs and mushrooms! The à la carte, which always includes a selection of rice dishes, including the traditional Catalan “rossejat”, and “gazpacho” (a La Mancha option in which the gazpacho is prepared as a rice dish), is complemented by a daily menu and another more gastronomic tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Parras%2010%2C%20Ayora%2C%2046620%2C%20Spain"
    pageTitle="Pinea"
  />
);

export default Pinea;
