...
const BagJAN = () => (
  <RestaurantPage
    restaurantName="Bagá"
    address="Reja de la Capilla 3, Jaén, 23001, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+34953047450"
    website="https://www.bagagastronomico.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="By adhering to the motto “Sentir Jaén” (Feel Jaén), clearly visible in the diminutive kitchen, this culinary jewel located next to the San Ildefonso basilica continues to realise its dream, in so doing become a must for experienced foodies. Despite its compact size, this restaurant, which takes its name from the blossom of the olive tree, boasts impressive designer detail in its decor and reflects chef Pedro Sánchez’s passion for seasonal local ingredients. This is showcased on a single tasting menu that clearly demonstrates his immense creative talent and a desire to promote the gastronomic bounty of his local area. His dishes are generally understated and feature few ingredients, as seen in his consommé of “carrueco” (a locally grown pumpkin), the exquisite “quisquilla” shrimp from Motri..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reja%20de%20la%20Capilla%203%2C%20Ja%C3%A9n%2C%2023001%2C%20Spain"
    pageTitle="Bagá"
  />
);

export default BagJAN;
