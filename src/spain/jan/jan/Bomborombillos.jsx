...
const Bomborombillos = () => (
  <RestaurantPage
    restaurantName="Bomborombillos"
    address="Pintor Carmelo Palomino 12, Jaén, 23004, Spain"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+34691941918"
    website="https://www.bomborombillos.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A location with a rustic-contemporary feel next to the central Plaza de Los Jardinillos, that started life as a bar. Now a charming restaurant, it offers an enticing selection of tapas, sharing platters, à la carte dishes and a tasting menu that showcases ingredients and flavours from the region. We recommend booking a table via their website!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pintor%20Carmelo%20Palomino%2012%2C%20Ja%C3%A9n%2C%2023004%2C%20Spain"
    pageTitle="Bomborombillos"
  />
);

export default Bomborombillos;
