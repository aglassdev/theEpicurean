...
const Mangasverdes = () => (
  <RestaurantPage
    restaurantName="MangasVerdes"
    address="Bernabé Soriano 28, Jaén, 23001, Spain"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+34953089495"
    website="https://www.restaurantemangasverdes.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A somewhat atypical gastro-bar located closed to the city’s cathedral. The à la carte features a choice of contemporary and fusion dishes and is complemented by a tasting menu and an impressive choice of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bernab%C3%A9%20Soriano%2028%2C%20Ja%C3%A9n%2C%2023001%2C%20Spain"
    pageTitle="MangasVerdes"
  />
);

export default Mangasverdes;
