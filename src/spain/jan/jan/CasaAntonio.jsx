...
const CasaAntonio = () => (
  <RestaurantPage
    ...
    bio="Situated in a quiet district not far from the town’s main shopping district, this restaurant boasts a terrace, tapas bar and several dining rooms with a contemporary feel. The extensive à la carte here features updated dishes with their roots in traditional and regional cuisine, while it’s always worth having a look at the daily specials and the set menu (La Comanda del Chef). The curious Ponche dessert, which is described as a “receta de mi abuela” (my grandmother’s recipe), is a reinterpretation of a typical peach punch recipe from Jaén!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ferm%C3%ADn%20Palma%203%2C%20Ja%C3%A9n%2C%2023008%2C%20Spain"
    pageTitle="Casa Antonio"
  />
);

export default CasaAntonio;
