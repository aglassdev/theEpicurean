...
const PementaRosa = () => (
  <RestaurantPage
    restaurantName="Pementa Rosa"
    address="Reus 1, Carballo, 15100, Spain"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+34981757757"
    website="https://guide.michelin.com/en/galicia/carballo/restaurant/pementa-rosa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the centre of Carballo, this friendly, family-run restaurant continues to attract new customers daily! Chef Rocío Martínez was keen to spice up the dining options in the local Bergantiños region (“pementa” is the Galician word for “pepper”) with her updated take on traditional and regional cuisine with a touch of fusion, but always focusing on Galicia’s superb seasonal ingredients and paying homage to the gastronomic heritage of the Costa da Morte along with a strong emphasis on detail. A private dining room is also available for those requiring more privacy. Dishes that appear on the menu include albacore tuna with pepper, lime and coriander foam, and “kikos”; rice with monkfish and cockles; and “filloa”-filled pastry with rice pudding and rum and raisin ice-cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reus%201%2C%20Carballo%2C%2015100%2C%20Spain"
    pageTitle="Pementa Rosa"
  />
);

export default PementaRosa;
