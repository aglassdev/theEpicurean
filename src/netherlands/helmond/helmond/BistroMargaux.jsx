...
const BistroMargaux = () => (
  <RestaurantPage
    restaurantName="Bistro Margaux"
    address="Aarle-Rixtelseweg 107‭, ‬Helmond, 5707‭ ‬GK, Netherlands"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+31492798020"
    website="https://bistromargaux.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Djailany van de Laarschot’s ambition is clear: to celebrate life à la française, and to bring his vision to life he has transformed a former estaminet into this charming, ever-buzzing bistro. The extensive menu embraces French culinary tradition – think foie gras pâté with brioche to start, followed by juicy rotisserie poussin and, finally, an indulgent crêpe Suzette. Traditional flavours are served up with abundant generosity in a heartwarming feast for any foodie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aarle-Rixtelseweg%20107%E2%80%AD%2C%20%E2%80%ACHelmond%2C%205707%E2%80%AD%20%E2%80%ACGK%2C%20Netherlands"
    pageTitle="Bistro Margaux"
  />
);

export default BistroMargaux;
