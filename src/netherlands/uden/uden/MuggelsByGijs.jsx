...
const MuggelsByGijs = () => (
  <RestaurantPage
    restaurantName="Muggels by Gijs"
    address="Boekelsedijk 17, Uden, 5404 NK, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31413260101"
    website="https://www.muggels.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the outskirts of Uden, this restaurant is accommodated in a quaint thatched-roof farmhouse. It features a snug interior with wooden ceiling beams and rustic-style decor, plus an outdoor terrace overlooking the surrounding fields. Having spent years honing his skills at De Lindehof in Nuenen, Gijs Hoevenaars has struck out on his own in this delightful setting. From classic tournedos Rossini to Mediterranean and Asian-inspired dishes, the chef displays proficiency across the board. Take, for example, his tuna sashimi, which he perks up with soy, citrus and pickled vegetables. The à la carte menu is pretty extensive, so deciding will not be easy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boekelsedijk%2017%2C%20Uden%2C%205404%20NK%2C%20Netherlands"
    pageTitle="Muggels by Gijs"
  />
);

export default MuggelsByGijs;
