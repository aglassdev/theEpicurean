...
const HoogHolten = () => (
  <RestaurantPage
    restaurantName="Hoog Holten"
    address="Forthaarsweg 7, Holten, 7451 JS, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31548361306"
    website="https://hoogholten.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hoog Holten steals your heart before you have even taken your seat. The drive to this romantic spot introduces you to the splendour of the Salland countryside. Eating on the terrace, which has a hunting lodge ambiance, is highly recommended! Lunchtime features a simple à la carte selection, but in the evening, the chef takes classic dishes to new heights with innovative ideas, in a set menu that changes daily. For example, he serves duck breast with an orange-infused jus, and he adds candied kumquat to al dente vegetables for a tangy twist. Consider an overnight stay for a more immersive experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Forthaarsweg%207%2C%20Holten%2C%207451%20JS%2C%20Netherlands"
    pageTitle="Hoog Holten"
  />
);

export default HoogHolten;
