...
const DeSwarteRuijter = () => (
  <RestaurantPage
    restaurantName="De Swarte Ruijter"
    address="Holterbergweg 7, Holten, 7451 JL, Netherlands"
    cuisine="Modern Cuisine, Modern French"
    priceRange="€€€"
    phoneNumber="+31548596660"
    website="https://swarteruijter.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nature takes centre stage at De Swarte Ruijter. Located on the Holterberg, this charming thatched house boasts stunning views of the nearby pine forest and seamlessly incorporates natural elements into its interior design. Erik de Mönnink draws inspiration from the beautiful surroundings, which fuel his creativity every day. His unconventional cuisine showcases locally sourced produce such as mushrooms, venison and nagelhout (air-dried veal). This chef knows how to captivate his diners, creating fascinating dishes featuring playful contrasts in texture. His daring combinations are sometimes quite astonishing. Think freshly caught North Sea crab encased in a jelly of the same crustacean and then deep-fried. Textures of mango and apple provide an exquisite sweetness. The dish is then finishe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Holterbergweg%207%2C%20Holten%2C%207451%20JL%2C%20Netherlands"
    pageTitle="De Swarte Ruijter"
  />
);

export default DeSwarteRuijter;
