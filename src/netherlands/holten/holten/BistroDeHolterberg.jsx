...
const BistroDeHolterberg = () => (
  <RestaurantPage
    restaurantName="Bistro de Holterberg"
    address="Forthaarsweg 1, Holten, 7451 JS, Netherlands"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+31548363849"
    website="https://www.bistrodeholterberg.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Experience the charms of each season in this cosy bistro, whether it's winter by the large open fireplace or summer on the stunning terrace, offering an awe-inspiring vista of the Salland Ridge National Park. The extensive set menu features authentic French dishes that each showcase one or two bold flavours. Crispy fried sea bass fillet, langoustine sauce and boiled fresh vegetables: unadulterated flavours at their best...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Forthaarsweg%201%2C%20Holten%2C%207451%20JS%2C%20Netherlands"
    pageTitle="Bistro de Holterberg"
  />
);

export default BistroDeHolterberg;
