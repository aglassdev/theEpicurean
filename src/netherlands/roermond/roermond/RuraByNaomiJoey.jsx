...
const RuraByNaomiJoey = () => (
  <RestaurantPage
    restaurantName="Rura by Naomi & Joey"
    address="Luifelstraat 32, Roermond, 6041 EK, Netherlands"
    cuisine="Modern French, Asian Influences"
    priceRange="€€"
    phoneNumber="+31475700111"
    website="https://www.ruraroermond.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Naomi & Joey embrace the concept of casual fine dining in their cosy restaurant, where the atmosphere is intimate and laid back. The meticulous detail and thoughtful preparation of each dish stands out. Chef Joey loves to transform his ingredients; rich sauces and influences from around the globe add punch. Vegetables play a central role in his cooking, with both a vegetarian and a meat-and-fish set menu available. A prime example of his ingenuity is a dish featuring toasted brioche topped with ratatouille, in addition to both white and green asparagus, pommes soufflées and a buttermilk and lavas oil sauce. The couple's enthusiasm is nothing short of contagious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Luifelstraat%2032%2C%20Roermond%2C%206041%20EK%2C%20Netherlands"
    pageTitle="Rura by Naomi & Joey"
  />
);

export default RuraByNaomiJoey;
