...
const DeKnip = () => (
  <RestaurantPage
    restaurantName="De Knip"
    address="Kniplaan 22, Voorschoten, 2251 AK, Netherlands"
    cuisine="Modern Cuisine, French Contemporary"
    priceRange="€€"
    phoneNumber="+31715612573"
    website="https://www.restaurantdeknip.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tables on the sunny terrace and in the conservatory are much in demand at this long-established restaurant. The view of the shimmering Vliet canal is breathtaking! Marcel van Teijlingen's culinary creations are a testament to his attention to detail and refined palate, both in their presentation and their flavour profiles. He likes to add playful touches to his dishes, which are classic in their foundations. Think celeriac mousse finished with onion and a ponzu oil, adding vibrancy to a rich millefeuille of celeriac and oxtail. The old and the new join forces at De Knip...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kniplaan%2022%2C%20Voorschoten%2C%202251%20AK%2C%20Netherlands"
    pageTitle="De Knip"
  />
);

export default DeKnip;
