...
const Notable = () => (
  <RestaurantPage
    restaurantName="Notable"
    address="Plein de Valk 13, Echt, 6101 DM, Netherlands"
    cuisine="Seasonal Cuisine, Modern French"
    priceRange="€€€"
    phoneNumber=""
    website="https://restaurantnotable.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hold off on visiting the bar and brewery – also housed in this former roof tile factory – and head straight to the upstairs area to discover the brainchild of chef Vital Awick and sommelier Adriaan Visser. The open kitchen, completely surrounded by a marble dining counter, draws the eye. Start by browsing the European-leaning wine list, which includes a fine selection by the glass. As for the food, you will see how the chef puts his own stamp on each dish, using a particular spice or international influence. For example, textures of blood orange are paired with a punchy beurre blanc with capers to beautifully complement a perfectly cooked piece of skrei and the bitterness of chicory. This kitchen champions à la minute cooking and exciting combinations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plein%20de%20Valk%2013%2C%20Echt%2C%206101%20DM%2C%20Netherlands"
    pageTitle="Notable"
  />
);
