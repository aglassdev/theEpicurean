...
const Rotonde = () => (
  <RestaurantPage
    restaurantName="Rotonde"
    address="Goudsesingel 230, Rotterdam, 3011 KE, Netherlands"
    cuisine="Vegetarian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31649397269"
    website="https://restaurantrotonde.nl/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="They pick up their vegetables in an electric van. The aim is to utilise every part of their produce, which is grown with respect for nature and the seasons. All of their wines are biodynamic or natural. This vintage-style restaurant is deeply committed to sustainability and is always looking for ways to do better (visit their website to learn more). This vision is brought to life in creative, intriguing and entirely vegetarian dishes that are incredibly flavoursome, sophisticated and full of surprises. Think bell pepper confit and an XO sauce made from mushrooms to elevate a sapid leek stalk. A spot by the open kitchen is a must if you want to watch the chefs tame the flames of their wood-fired barbecue!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Goudsesingel%20230%2C%20Rotterdam%2C%203011%20KE%2C%20Netherlands"
    pageTitle="Rotonde"
  />
);

export default Rotonde;
