...
const FgFranoisGeurds = () => (
  <RestaurantPage
    restaurantName="FG - François Geurds"
    address="Katshoek 37B, Rotterdam, 3032 AE, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31104250520"
    website="https://www.fgrestaurant.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Striving for nothing less than perfection, François Geurds has created a trendy urban restaurant that is immediately captivating. Luxurious porcelain custom-made for specific dishes, and an impressive collection of knives and trolleys – at FG, they do not shy away from the spectacular. The private dining room even features an upside-down garden! Chef Geurds loves to work with premium ingredients such as Wagyu A5 and truffle, but he has no hesitation in letting a potato take centre stage. His dishes are thought-provoking and characterised by meticulous attention to detail and original ideas. His sauces are wonderfully complex. For example, he slices raw tuna fillet and alternates it with slices of grilled pineapple. Toasted black sesame seeds and a pineapple juice ceviche with a dash of lem..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Katshoek%2037B%2C%20Rotterdam%2C%203032%20AE%2C%20Netherlands"
    pageTitle="FG - François Geurds"
  />
);

export default FgFranoisGeurds;
