...
const Fitzgerald = () => (
  <RestaurantPage
    restaurantName="Fitzgerald"
    address="Gelderseplein 49, Rotterdam, 3011 WZ, Netherlands"
    cuisine="Modern French, International"
    priceRange="€€€"
    phoneNumber="+31102687010"
    website="https://www.restaurantfitzgerald.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Too much of anything is bad, but too much Champagne is just right. This quote by F. Scott Fitzgerald could well have been written about this vibrant restaurant. One can't help but be won over by the Italian marble, the blend of modern and vintage design elements, the large glass windows, the charming courtyard and the chic bar serving delicious snacks and cocktails. Then there's the impressive wine list, featuring both established classics and exciting new finds. Michael Verhagen likes to give those great wines a run for their money by juxtaposing them with modern French cuisine. The sauces showcase his classical culinary knowhow, and he builds his dishes on this foundation. For example, he serves Anjou pigeon, roasted on the bone and seasoned with vadouvan, its rump succulently braised, a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gelderseplein%2049%2C%20Rotterdam%2C%203011%20WZ%2C%20Netherlands"
    pageTitle="Fitzgerald"
  />
);
