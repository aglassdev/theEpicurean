...
const Zeezout = () => (
  <RestaurantPage
    restaurantName="Zeezout"
    address="Westerkade 11b, Rotterdam, 3016 CL, Netherlands"
    cuisine="Seafood, French"
    priceRange="€€€"
    phoneNumber="+31104365049"
    website="https://restaurantzeezout.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Whether smoked or marinated, prepared in tempura or ravioli, encased in a salt crust or served as tartare – one thing is clear at Patrick 't Hart's kitchen: only the finest seafood makes the cut. His solid expertise in classic cuisine gives him the freedom to explore various techniques – always focused on elevating the sea's rich bounty to perfection. The authentic flavours of the produce shine through in original creations. The chef's fish dishes include influences from around the world – enhanced by the brininess of nori, the sweet and sour nuances of sambai,and the bright freshness of a tom kha kai emulsion. His playful garnishes bring the plate to life, but sometimes he goes all out with an intense shellfish jus and fish cooked on the bone. Creative flair is perfectly balanced with tim..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Westerkade%2011b%2C%20Rotterdam%2C%203016%20CL%2C%20Netherlands"
    pageTitle="Zeezout"
  />
);

export default Zeezout;
