...
const TheMilln = () => (
  <RestaurantPage
    restaurantName="The Millèn"
    address="Weena 686, Rotterdam, 3012 CN, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31104302333"
    website="https://restaurantthemillen.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Millennium Tower is a Rotterdam landmark and, thanks to this vintage-chic restaurant, also a destination for foodies. The open kitchen and the view of the central station afforded by the floor-to-ceiling windows are the standout features of the space. But it is chef Wim Severein's expertise and inventive spirit that really steal the show. His cooking style is clean and accessible, and his use of spices adds international flair and a distinctive personality – uncompromising and bursting with flavour. For example, he cooks farm-raised pigeon until medium-rare, carves it with meticulous precision and serves it with various textures of parsley root for earthy nuances. He finishes the dish with a coffee-infused pigeon jus and a sprinkle of crushed hazelnuts. Less really is more here! The so..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weena%20686%2C%20Rotterdam%2C%203012%20CN%2C%20Netherlands"
    pageTitle="The Millèn"
  />
);

export default TheMilln;
