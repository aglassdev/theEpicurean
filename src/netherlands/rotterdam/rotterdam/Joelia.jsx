...
const Joelia = () => (
  <RestaurantPage
    restaurantName="Joelia"
    address="Coolsingel 5, Rotterdam, 3012 AA, Netherlands"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+31107108034"
    website="https://www.joelia.eu/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Joelia's charm permeates every nook and cranny of this restaurant. As you enter, you'll be instantly smitten with the eclectic decor, a captivating fusion of vintage and contemporary design. This space exudes a certain American grandeur, and the open kitchen and the impressive wine collection on show add to the atmosphere. Maître d' Pieter Timmer and chef Sofiane Bons inject a youthful energy into proceedings, including the menu. The passionate chef honours his French roots with meticulously crafted sauces and dishes. He adds pep and intensity by drawing inspiration from far-flung places, especially Asia. Red mullet, for instance, is barbecued to perfection, yielding a wonderfully crispy crust. To elevate the dish, the chef uses the fish bones to create a vibrant sauce packed with characte..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Coolsingel%205%2C%20Rotterdam%2C%203012%20AA%2C%20Netherlands"
    pageTitle="Joelia"
  />
);

export default Joelia;
