...
const Raedthuys = () => (
  <RestaurantPage
    restaurantName="Raedthuys"
    address="Raadhuisstraat 14, Doetinchem, 7001 EW, Netherlands"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+31314360704"
    website="https://hetraedthuys.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its own bakery, patisserie and even a smokehouse, Marion Thus's bustling restaurant, once a café, is a place where nearly everything is made from scratch. Her enticing à la carte and set menus include plenty of vegetarian options. The chef's trademark generosity, rooted in tradition, shines through in dishes such as perfectly pink fillet of Gaasterland herb-fed pork with rösti, al dente vegetables, a mousseline sauce infused with ras-el-hanout and a sauce enriched with Gerardus Tripel beer. There's no holding back when it comes to bringing bold flavours to your plate. Be sure to peruse the beer list and treat yourself to something on tap...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Raadhuisstraat%2014%2C%20Doetinchem%2C%207001%20EW%2C%20Netherlands"
    pageTitle="Raedthuys"
  />
);

export default Raedthuys;
