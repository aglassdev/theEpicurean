...
const OrangerieDePol = () => (
  <RestaurantPage
    restaurantName="Orangerie De Pol"
    address="Hulleweg 2, Doetinchem, 7004 GG, Netherlands"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31314317629"
    website="https://www.orangeriedepol.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners feel at one with the surrounding nature in this light-filled wood-framed orangery. In this unique setting, your charming hostess Marjolein and chef Mark express their love for Achterhoek. Outstanding locally sourced ingredients, fresh picks from their own kitchen garden and intense sauces are showcased in a surprise menu that is very much in step with the times. This regional bounty is enhanced by international nuances. A case in point is the kingfish, marinated in rhubarb broth, paired with a silken yuzu sorbet and an aromatic tomato and soy vinaigrette – a dish that speaks volumes about the chef's technical precision and feel for the seasons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hulleweg%202%2C%20Doetinchem%2C%207004%20GG%2C%20Netherlands"
    pageTitle="Orangerie De Pol"
  />
);

export default OrangerieDePol;
