...
const Bisque = () => (
  <RestaurantPage
    restaurantName="Bisque"
    address="Verlengde Hereweg 46, Groningen, 9722 AE, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31502802058"
    website="https://www.restaurantbisque.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Bisque, everything is perfectly balanced: the understated luxury of the interior, the precision of the cuisine and the warmth of Sabrina, who welcomes every guest with ease. At the back, chef Niels Schievink runs his kitchen with a steady hand. Understated in style, precise in execution. A dish featuring langoustine immediately reveals his signature style: a perfectly cooked tail combined with carrot, yuzu and a soft bisque with subtle citrus nuances. And whether you finish with a classic soufflé or his own interpretation of tiramisu, this less-is-more approach to French cuisine and celebration of beautiful produce will stay with you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Verlengde%20Hereweg%2046%2C%20Groningen%2C%209722%20AE%2C%20Netherlands"
    pageTitle="Bisque"
  />
);
