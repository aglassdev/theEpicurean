...
const ViveLaVie = () => (
  <RestaurantPage
    restaurantName="Vive La Vie"
    address="Oosterstraat 39, Groningen, 9711 NP, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31508503970"
    website="https://www.vivelaviegroningen.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This retro-style building with a warm ambience is the perfect place for a special meal. Chef Jeroen Sportel prepares complex and creative dishes, regularly taking inspiration from Asian cuisine and offering just one surprise menu which is highly influenced by the passing seasons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oosterstraat%2039%2C%20Groningen%2C%209711%20NP%2C%20Netherlands"
    pageTitle="Vive La Vie"
  />
);

export default ViveLaVie;
