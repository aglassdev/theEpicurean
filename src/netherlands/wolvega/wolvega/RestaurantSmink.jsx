...
const RestaurantSmink = () => (
  <RestaurantPage
    restaurantName="Restaurant Smink"
    address="Van Harenstraat 37, Wolvega, 8471 JC, Netherlands"
    cuisine="Creative, Modern French"
    priceRange="€€€"
    phoneNumber="+31561728729"
    website="https://www.jansmink.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Built in 1625, the national monument Huize Lindenoord has kept its historical character intact. Inside, the gorgeous ornate ceilings adorned with chandeliers and graceful curves harmonise beautifully with the modern upscale decor of this restaurant. The surrounding parkland and garden lend this sumptuous setting an added air of distinction. Jan Smink, a proud farmer's son and true Frisian at heart, proves himself to be a charismatic chef who dares to push boundaries. His culinary style is thoughtful, bold and exciting. Backed by great technical prowess, he artfully dances with textures, temperatures and flavours. Think velvety potato mousseline with chives, topped with a few earthy sautéed morels. This is accompanied by mushrooms in a vibrant marinade and al dente white asparagus crowned w..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Harenstraat%2037%2C%20Wolvega%2C%208471%20JC%2C%20Netherlands"
    pageTitle="Restaurant Smink"
  />
);

export default RestaurantSmink;
