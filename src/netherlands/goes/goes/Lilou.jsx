...
const Lilou = () => (
  <RestaurantPage
    restaurantName="Lilou"
    address="Magdalenastraat 11, Goes, 4461 AL, Netherlands"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+31113215335"
    website="https://lilougoes.nl/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Magdalenastraat%2011%2C%20Goes%2C%204461%20AL%2C%20Netherlands"
    pageTitle="Lilou"
  />
);

export default Lilou;
