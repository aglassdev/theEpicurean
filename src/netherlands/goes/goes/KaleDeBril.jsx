...
const KaleDeBril = () => (
  <RestaurantPage
    restaurantName="Kale & de Bril"
    address="Piet Heinstraat 3A, Goes, 4461 GL, Netherlands"
    cuisine="Farm to table, Country cooking"
    priceRange="€€€"
    phoneNumber="+31113853485"
    website="https://www.kalebril.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Be careful not to walk right past this unassuming building – you'd be missing out. Chef-patron duo Marc (the bald one or Kale in Dutch!) and Niek (the one with glasses – de Bril in Dutch) immediately set a relaxed, welcoming tone. Zeeland produce (also from the lobster tank) and vegetables prepared in a multitude of ways are showcased in creative dishes. For example, scallops are combined with various salsify and pear creations, as well as a lobster salpicon and a vanilla-infused broth. In both the set menu and the lobster menu, the seasons and the Zeeland terroir are the stars of the show...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Piet%20Heinstraat%203A%2C%20Goes%2C%204461%20GL%2C%20Netherlands"
    pageTitle="Kale & de Bril"
  />
);

export default KaleDeBril;
