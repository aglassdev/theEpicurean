...
const DeKluizenaer = () => (
  <RestaurantPage
    restaurantName="De Kluizenaer"
    address="Grote Markt 12, Goes, 4461 AJ, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31113820382"
    website="https://www.kluizenaer.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former savings bank has been converted into a restaurant with a touch of industrial decor, with large drawings providing a bit of fun. The internationally seasoned chef brings punchy flavours to the plate to present his own vision of gastronomy. His cuisine is resolutely contemporary, involving robust taste combinations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grote%20Markt%2012%2C%20Goes%2C%204461%20AJ%2C%20Netherlands"
    pageTitle="De Kluizenaer"
  />
);

export default DeKluizenaer;
