...
const LucieCocina = () => (
  <RestaurantPage
    restaurantName="Lucie Cocina"
    address="Kleine Berg 34b, Eindhoven, 5611 JV, Netherlands"
    cuisine="Spanish Contemporary, Creative"
    priceRange="€€"
    phoneNumber="+31404100163"
    website="https://www.lucie-cocina.bar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lucie Cocina boasts a hip, lively atmosphere that captures the essence of an authentic tapas bar. From the moment you step inside, you will be won over by the decor with its vintage-style globe chandeliers, floral-patterned mosaic floor and bar stools at the counter where the seafood is displayed. The menu features an irresistible array of options, from traditional ham croquettes and tortillas to more inventive tapas creations. How about steamed zamburiñas with antiboise, finely chopped jalapeño and a hollandaise foam? Or rather braised veal cheeks with mojo rojo and deep-fried potato cubes? The fantastic value for money means you can sample a wide variety of dishes without breaking the bank. ¡Buen provecho!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kleine%20Berg%2034b%2C%20Eindhoven%2C%205611%20JV%2C%20Netherlands"
    pageTitle="Lucie Cocina"
  />
);

export default LucieCocina;
