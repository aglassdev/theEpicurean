...
const Zarzo = () => (
  <RestaurantPage
    restaurantName="Zarzo"
    address="Bleekweg 7, Eindhoven, 5611 EZ, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31402117700"
    website="https://zarzo.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Adrian Zarzo Habraken is a man who knows what his customers want. The funky vibe of his lounge-style restaurant is the gateway to his culinary world. You can see the chefs in action in the open kitchen, and a visit to the impressive wine room is an experience in itself. Brace yourself for chef Zarzo's bold fusion of traditional Spanish recipes and progressive ideas. This is complex cuisine, but the focus lies squarely on the flavours. Perfectly fried on the skin, red mullet is combined with braised lacinato kale and fennel, fennel foam and his take on the Catalan suquet fish soup, à la bouillabaisse, with crispy prawn. This is a dish with spirit! His quest for novelty is captivating, as seen in his delectable dessert featuring a unique combination of mushrooms and chicory. Both Zarzo's win..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bleekweg%207%2C%20Eindhoven%2C%205611%20EZ%2C%20Netherlands"
    pageTitle="Zarzo"
  />
);

export default Zarzo;
