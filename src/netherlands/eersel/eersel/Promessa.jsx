...
const Promessa = () => (
  <RestaurantPage
    restaurantName="Promessa"
    address="Markt 3, Eersel, 5521 AJ, Netherlands"
    cuisine="World Cuisine"
    priceRange="€€"
    phoneNumber="+31497530510"
    website="https://www.promessa.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With Food is art as their motto, the chefs at this trendy and laid-back restaurant treat their plates like canvases, placing a strong emphasis on aesthetics. But fear not: these visually stunning dishes are also packed with flavour. Koen van den Kerkhof's creativity draws on the culinary traditions of the Netherlands, France and more far-flung locations, with his limitless imagination reflected in a wide-ranging menu. Diners enjoy dishes such as albacore tuna poppadom, classically prepared pheasant breast with a rich veal jus, succulent beef rendang, or spaghetti aglio e olio. They have the art of indulgence down to a T!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markt%203%2C%20Eersel%2C%205521%20AJ%2C%20Netherlands"
    pageTitle="Promessa"
  />
);
