...
const DeWitteGans = () => (
  <RestaurantPage
    restaurantName="De Witte Gans"
    address="Heinoseweg 30, Dalfsen, 7722 JP, Netherlands"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+31529430515"
    website="https://www.wittegans.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic restaurant is a favourite pit stop for walkers, cyclists and food lovers. The terrace is one of its main draws; another is the superb Bib Gourmand-awarded menu, which features local produce, nods to the East, and vegetarian options. The creative chef works his ingredients hard and prides himself on the presentation of his dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Heinoseweg%2030%2C%20Dalfsen%2C%207722%20JP%2C%20Netherlands"
    pageTitle="De Witte Gans"
  />
);

export default DeWitteGans;
