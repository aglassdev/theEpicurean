...
const DeHerbergVanSmallingerland = () => (
  <RestaurantPage
    restaurantName="De Herberg van Smallingerland"
    address="Muldersplein 2, Rottevalle, 9221 SP, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31512342064"
    website="https://www.herbergvansmallingerland.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dating back to 1791, this charming inn is full of character and extremely popular. Tables in the gorgeous courtyard garden are in high demand, as are the guestrooms. With a special emphasis on vegetables, Chef Freddy and son Jurmen showcase Frisian cuisine at its best. For instance, they will draw on the distinct flavours of beetroot, cherries and capers to give a fillet of red mullet a special twist. The menu at de Herberg is full of surprises!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Muldersplein%202%2C%20Rottevalle%2C%209221%20SP%2C%20Netherlands"
    pageTitle="De Herberg van Smallingerland"
  />
);

export default DeHerbergVanSmallingerland;
