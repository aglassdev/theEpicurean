...
const Meliefste = () => (
  <RestaurantPage
    restaurantName="Meliefste"
    address="Wolphaartsdijkseveer 1, Wolphaartsdijk, 4471 ND, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31113581326"
    website="https://www.restaurantmeliefste.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thijs Meliefste is a name synonymous with excellence. His restaurant is located in a picturesque setting, with a gorgeous terrace overlooking a marina on Veerse Meer lagoon. The decor in the intimate dining space is rather understated and evokes a sense of tranquillity. The glass-walled kitchen reveals a serene scene of food preparation. But think of it as the calm before the storm, because the arrival of the appetisers at your table brings a burst of intense sophistication. Chef Meliefste's cooking style is characterised by intricate details and a wide range of techniques. The natural bounty of Zeeland's soil and waters are his source of inspiration. His creativity shines through in his intricate dishes, each bite sparking your curiosity. Our inspectors were bowled over by his take on pal..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wolphaartsdijkseveer%201%2C%20Wolphaartsdijk%2C%204471%20ND%2C%20Netherlands"
    pageTitle="Meliefste"
  />
);

export default Meliefste;
