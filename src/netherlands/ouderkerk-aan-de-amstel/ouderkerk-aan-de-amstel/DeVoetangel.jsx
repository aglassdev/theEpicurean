...
const DeVoetangel = () => (
  <RestaurantPage
    restaurantName="De Voetangel"
    address="Rondehoep Oost 3, Ouderkerk aan de Amstel, 1191 KA, Netherlands"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+31204961373"
    website="https://www.voetangel.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy family restaurant rises up out of the Ronde Hoep polder, from where it enjoys magnificent views across pastureland and streams. The chefs here veer more towards the traditional, although modern dishes are starting to creep into their cuisine. Organic, vegetarian and international options give the menu extra appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rondehoep%20Oost%203%2C%20Ouderkerk%20aan%20de%20Amstel%2C%201191%20KA%2C%20Netherlands"
    pageTitle="De Voetangel"
  />
);

export default DeVoetangel;
