...
const Odille = () => (
  <RestaurantPage
    restaurantName="Odille"
    address="Markt 14, Sint-Oedenrode, 5492 AB, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31413786352"
    website="https://odille.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Everything here revolves around the open kitchen, which is done out in black. Serenity and elegance abound at Odille, with artworks by Daisy Boman dotted throughout. Hostess Lotte Bloem and chef Casimir Evens invite you into their world, where time stands still for a moment as Brabantian generosity meets international finesse.The kitchen is a creative playground where bold flavours are expertly combined. The chef presents the Bresse pigeon at your table, showcasing the bird before it is roasted on the carcass. The finished dish arrives a little later: perfectly medium-rare fillets, a spicy broccoletto cream, bay leaf oil and crunchy vegetable garnishes. A full-bodied pigeon jus infused with summer savoury elevates this indulgent combination of classic and vegetal flavours. This chef brings..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markt%2014%2C%20Sint-Oedenrode%2C%205492%20AB%2C%20Netherlands"
    pageTitle="Odille"
  />
);

export default Odille;
