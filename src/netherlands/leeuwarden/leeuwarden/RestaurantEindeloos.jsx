...
const RestaurantEindeloos = () => (
  <RestaurantPage
    restaurantName="Restaurant Eindeloos"
    address="Korfmakersstraat 17, Leeuwarden, 8911 LA, Netherlands"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+31582130835"
    website="https://www.restauranteindeloos.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The biggest draws of this warm and welcoming restaurant are Willem Schaafsma's culinary prowess and the exquisite pairings dreamt up by his sommelier. Here, you can savour dishes made with top-quality ingredients that are sourced as locally and sustainably as possible – and all at excellent value for money. A firm favourite!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Korfmakersstraat%2017%2C%20Leeuwarden%2C%208911%20LA%2C%20Netherlands"
    pageTitle="Restaurant Eindeloos"
  />
);

export default RestaurantEindeloos;
