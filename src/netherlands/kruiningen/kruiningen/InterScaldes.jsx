...
const InterScaldes = () => (
  <RestaurantPage
    restaurantName="Inter Scaldes"
    address="Zandweg 2, Kruiningen, 4416 NA, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31113381753"
    website="https://www.interscaldes.nl"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="To say that Sanne and Jeroen Achtien have breathed new life into this institution would be an understatement. The beautiful manor has undergone a drastic makeover that has resulted in a luxurious and trendy space with a lounge feel – the curved seats create a sense of intimacy. The light and airy extension looks out onto the magnificent garden. After the appetisers, you can take a walk past the kitchen to see the impressive team in action and enjoy an additional dish. Chef Achtien draws on his Frisian heritage, the finest ingredients from his Zeeland surroundings and the experience he gained in Switzerland. His creative cooking is grounded in expertise, occasionally complex and highly exuberant. His care and respect for his ingredients shines through in the rich terrine crafted from the le..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zandweg%202%2C%20Kruiningen%2C%204416%20NA%2C%20Netherlands"
    pageTitle="Inter Scaldes"
  />
);

export default InterScaldes;
