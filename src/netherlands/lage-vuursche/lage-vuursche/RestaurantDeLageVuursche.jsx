...
const RestaurantDeLageVuursche = () => (
  <RestaurantPage
    restaurantName="Restaurant De Lage Vuursche"
    address="Dorpsstraat 2, Lage Vuursche, 3749 AD, Netherlands"
    cuisine="Classic Cuisine, French"
    priceRange="€€"
    phoneNumber="+31356668351"
    website="https://www.vuursche.nl/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsstraat%202%2C%20Lage%20Vuursche%2C%203749%20AD%2C%20Netherlands"
    pageTitle="Restaurant De Lage Vuursche"
  />
);

export default RestaurantDeLageVuursche;
