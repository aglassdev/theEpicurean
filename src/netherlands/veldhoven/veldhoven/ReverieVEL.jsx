...
const ReverieVEL = () => (
  <RestaurantPage
    restaurantName="Reverie"
    address="Dorpstraat 1, Veldhoven, 5504 HA, Netherlands"
    cuisine="Modern Cuisine, Indonesian"
    priceRange="€€€"
    phoneNumber="+31402547257"
    website="https://www.restaurantreverie.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="United by a shared passion, Stuart and Luca, who met at hotel school, have turned their dream into reality with this sleek, intimate and rather minimalist restaurant. The bonsai tree in the middle of the dining space is a nod to the Far Eastern-inspired cuisine they serve. In the evening, they propose two set menus: Taste of Reverie and Indonesian Menu. Drawing on classic French foundations, they add the sweetness and piquancy of Asian seasonings. The perfectly pan-seared duck fillet is accompanied, for instance, by an intense duck jus infused with the heat and slight sweetness of finely chopped chilli. A pumpkin cream married with ginger brings out the umami flavours. A vibrant and ambitious place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpstraat%201%2C%20Veldhoven%2C%205504%20HA%2C%20Netherlands"
    pageTitle="Reverie"
  />
);

export default ReverieVEL;
