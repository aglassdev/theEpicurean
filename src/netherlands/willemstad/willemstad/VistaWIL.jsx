...
const VistaWIL = () => (
  <RestaurantPage
    ...
    address="Havenhoofd 2, Willemstad, 4797 SR, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31168852212"
    website="https://www.vistawillemstad.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The view from this elegant pavilion, taking in the Hollands Diep River and the marina, is so enchanting it's almost impossible to describe. The dancing waves, visible through the expansive glass windows, create a mesmerising effect. Henrie van der Heijden marries classic cooking techniques with international influences, adding a vibrant and lively touch. Thanks to the small portions, you can decide which horizons to explore in your set menu. Savour the flavours of France with an unctuous chicken, pata negra and foie gras terrine… Or embark on an Asian culinary voyage and tuck into tender red mullet and poached lobster tail elevated by a fragrant green curry lobster sauce. Chef Van der Heijden adds his distinctive contemporary flair to these beautifully balanced and incredibly delicious dis..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Havenhoofd%202%2C%20Willemstad%2C%204797%20SR%2C%20Netherlands"
    pageTitle="Vista"
  />
);

export default VistaWIL;
