...
const Ledeboer = () => (
  <RestaurantPage
    restaurantName="Ledeboer"
    address="Wierdensestraat 2, Almelo, 7607 GH, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31546745781"
    website="https://www.restaurantledeboer.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Until 1994 this stately building housed a bank. Today retro and industrial features complement one another beautifully at this trendy restaurant offering quick snacks as well as larger meals, with the top choices on the set menu. The chef produces modern combinations with a sophisticated twist. At Ledeboer, taste reigns supreme...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wierdensestraat%202%2C%20Almelo%2C%207607%20GH%2C%20Netherlands"
    pageTitle="Ledeboer"
  />
);

export default Ledeboer;
