...
const DeBeejekurf = () => (
  <RestaurantPage
    restaurantName="De Beejekurf"
    address="Paterslaan 15, Venray, 5801 AS, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31478581869"
    website="https://www.debeejekurf.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="De Beejekurf manages to blend a cosy, inviting atmosphere with sophisticated elegance. Hostess Hanneke's warm welcome and attentive service make dinners feel at ease right away. Chef Mathijs Jacobs allows his local suppliers to dictate what goes into his set menu. His creativity knows no bounds, yet his dishes, although made with an eye for detail, are remarkably straightforward. For example, he transforms poached veal tenderloin with its exquisite jus and sweetbreads into an interesting concoction with aubergine, a hollandaise sauce espuma, potato mousseline and truffle. This is cuisine that packs a punch!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paterslaan%2015%2C%20Venray%2C%205801%20AS%2C%20Netherlands"
    pageTitle="De Beejekurf"
  />
);

export default DeBeejekurf;
