...
const Broederenklooster = () => (
  <RestaurantPage
    restaurantName="Broederenklooster"
    address="Rozengracht 3, Zutphen, 7201 JL, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31575783910"
    website="https://www.broederenklooster.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The authenticity of this former monastery (1293) has been preserved in every detail. Where once the friars used to take their meals, you can now enjoy a luxurious dining experience in a historical setting. The ultra-modern open kitchen immediately catches the eye. Niels van Dooijeweert brings a penchant for bold flavours and contemporary techniques to French dishes. Succulent pan-seared sea bream with a brunoise of tomato, papaya, onion and pak choi, in a curry sauce finished with lemon oil – this is the kind of cooking that draws so many diners; exceptional ingredients take the spotlight. The lovely guestrooms are perfect for a good night's rest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rozengracht%203%2C%20Zutphen%2C%207201%20JL%2C%20Netherlands"
    pageTitle="Broederenklooster"
  />
);

export default Broederenklooster;
