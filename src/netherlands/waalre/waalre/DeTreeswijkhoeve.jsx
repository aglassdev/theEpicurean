...
const DeTreeswijkhoeve = () => (
  <RestaurantPage
    restaurantName="De Treeswijkhoeve"
    address="Valkenswaardseweg 14, Waalre, 5582 VB, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31402215593"
    website="https://www.treeswijkhoeve.nl/nl"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dick Middelweerd's cuisine defies categorisation. He is a chef who embraces daring combinations and contrasts. His creativity is boundless, yet always grounded in a deep respect for tradition. Drawing on Asian influences, he seeks out umami notes and extra depth. Kick off your meal with crispy-seared calf sweetbreads with a coffee glaze, accompanied by a rich veal jus infused with Oloroso sherry and finished with an ethereal coffee foam and winter truffle. And why not finish with a miso crème brûlée with toasted rice ice cream and various textures of green apple with sake? It's all possible here. The chef harmonises local and global flavours, which the sommelier masterfully complements with his wine pairings. His exquisite selection of Australian wines is well worth exploring. The decor of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Valkenswaardseweg%2014%2C%20Waalre%2C%205582%20VB%2C%20Netherlands"
    pageTitle="De Treeswijkhoeve"
  />
);

export default DeTreeswijkhoeve;
