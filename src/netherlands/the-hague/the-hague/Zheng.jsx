...
const Zheng = () => (
  <RestaurantPage
    restaurantName="Zheng"
    address="Prinsestraat 33, The Hague, 2513 CA, Netherlands"
    cuisine="Fusion"
    priceRange="€€€"
    phoneNumber="+31703620828"
    website="https://www.restaurantzheng.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zheng takes you back to the banquets of Imperial China. Through a parade of small dishes, often served on three plates, you will discover the traditions of the four main branches of Chinese cuisine. The succulent Peking duck, with its crispy skin, is deservedly a signature dish – it is heavenly when paired with hoisin sauce and the house-made sambal! The typical tableware and objets d'art (also for sale) add to this unique dining experience. Subtle cuisine which nonetheless offers a wealth of flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Prinsestraat%2033%2C%20The%20Hague%2C%202513%20CA%2C%20Netherlands"
    pageTitle="Zheng"
  />
);
