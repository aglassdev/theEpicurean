...
const Wox = () => (
  <RestaurantPage
    restaurantName="Wox"
    address="Lange Voorhout 51, The Hague, 2514 EC, Netherlands"
    cuisine="Asian Influences, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31703653754"
    website="https://www.wox.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name gives you an inkling of the ambience here and the interior confirms it: this flashy brasserie is an ultra trendy venue. Fashionable Franco-Asian dishes feature on the menu, as well as phenomenal wines with a good selection available by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Voorhout%2051%2C%20The%20Hague%2C%202514%20EC%2C%20Netherlands"
    pageTitle="Wox"
  />
);
