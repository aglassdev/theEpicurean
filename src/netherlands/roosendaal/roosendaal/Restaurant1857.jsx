...
const Restaurant1857 = () => (
  <RestaurantPage
    restaurantName="Restaurant 1857"
    address="Molenstraat 18, Roosendaal, 4701 JS, Netherlands"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+31165850809"
    website="https://restaurant1857.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Restaurant 1857 prides itself on being chic but by no means stuffy. A narrow street leads to this former coach house – the old horse trough is still in the open kitchen! – that exudes an elegant combination of authentic charm and contemporary sophistication. Joke, your charming hostess, is also the talented pastry chef behind the restaurant's fabulous desserts.Joey van Heesbeen's creative dishes are technically impressive, visually striking and at times complex. He likes to experiment with bold flavours and the umami-rich nuances of Asian cuisine. In his unique take on beef Wellington, he incorporates miso mustard and a powder made from dried vegetable scraps. He pairs briefly seared langoustine, with a creamy shellfish-based XO sauce. Langoustine mayonnaise, yuzu gel and salty caviar add ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Molenstraat%2018%2C%20Roosendaal%2C%204701%20JS%2C%20Netherlands"
    pageTitle="Restaurant 1857"
  />
);

export default Restaurant1857;
