...
const TRaedthuys = () => (
  <RestaurantPage
    restaurantName="'t Raedthuys"
    address="Rijksweg 51, Duiven, 6921 AC, Netherlands"
    cuisine="Modern French, Classic French"
    priceRange="€€€"
    phoneNumber="+31316268808"
    website="https://www.raedthuys-duiven.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Striking contemporary art adorns the walls inside this historical property dating back to 1863 – at 't Raedthuys, art and dining go hand in hand. The modern decor beautifully preserves the building's authentic character. A window to the kitchen allows you to see the chefs and their team at work. On sunny days, the terrace at the front is the perfect spot for a romantic dinner for two. Prepare to be delighted as hostess Anouska Lamers and sommelier Karina van der Kolk introduce you to their unique collection of imported wines, which pair beautifully with the culinary creations of Tom Lamers and Hans den Engelsen. These chefs are traditionalists, who excel at classic dishes such as tournedos Rossini. They have a masterful ability to cook a leg of Dutch lamb to perfection, ensuring it is juic..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rijksweg%2051%2C%20Duiven%2C%206921%20AC%2C%20Netherlands"
    pageTitle="'t Raedthuys"
  />
);

export default TRaedthuys;
