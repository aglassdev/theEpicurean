...
const IjsselRestobar = () => (
  <RestaurantPage
    restaurantName="IJssel Restobar"
    address="Worp 2, Deventer, 7419 AD, Netherlands"
    cuisine="Modern French, French Contemporary"
    priceRange="€€"
    phoneNumber="+31570667081"
    website="https://www.ijsselrestobar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the Pillows hotel, this stylish restaurant encapsulates the best of Deventer. Seating options include a lovely conservatory and a terrace overlooking the River IJssel – the perfect place from which to take in the city's skyline. Wouter van Leeuwen creates a menu that's simply irresistible. Timeless classics such as steak tartare are accompanied by contemporary creations that draw on international influences and feature playful textures. For instance, he serves a combination of North Sea crab, leek and carrot with an espuma and powdered tomato. Foodies are sure to be delighted by the wide range of options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Worp%202%2C%20Deventer%2C%207419%20AD%2C%20Netherlands"
    pageTitle="IJssel Restobar"
  />
);

export default IjsselRestobar;
