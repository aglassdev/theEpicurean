...
const DeGieserWildeman = () => (
  <RestaurantPage
    restaurantName="De Gieser Wildeman"
    address="Botersloot 1, Noordeloos, 4225 PR, Netherlands"
    cuisine="Classic French, Creative French"
    priceRange="€€€"
    phoneNumber="+31183582501"
    website="https://degieserwildeman.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Picture the scene: you are sitting under the thatched roof of a converted farmhouse, surrounded by stylish interior design and pleasing decorative features, looking through the conservatory out onto the beautiful garden and the river. A delightful setting for a culinary escapade! With his mastery of classic culinary techniques, René Tichelaar is not to be outdone by the surroundings.He picks up creative ideas here and there and has a good feel for the current zeitgeist, but the basis of this cuisine lets tradition speak for itself. This is evident, for instance, in the Mediterranean garnishes that give a nice piece of lamb from the Pyrenees the necessary depth of flavour. Or how about scallop ravioli combined with the salty nuances of caviar, the generosity of a beurre blanc sauce and the ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Botersloot%201%2C%20Noordeloos%2C%204225%20PR%2C%20Netherlands"
    pageTitle="De Gieser Wildeman"
  />
);

export default DeGieserWildeman;
