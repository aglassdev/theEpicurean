...
const Pikaar = () => (
  <RestaurantPage
    restaurantName="Pikaar"
    address="Vrijthof 27, Hilvarenbeek, 5081 CB, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31137370144"
    website="https://www.restaurantpikaar.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="From the moment the exquisite amuse-bouches are served, Cas Pikaar's talent is plain to see. This young chef fuses classic craftsmanship with unbridled creativity – he even won our Young Chef Award in 2020. The chef's jacket he received then is still on display in his inviting, chic restaurant: a place where originality and youthful enthusiasm converge. Chef Pikaar's culinary skill is beyond question; his Anjou pigeon, for instance, is cooked to perfection. The slices of meat melt in the mouth, the confit legs and the heart are deliciously intense, the creaminess of the liver is full of depth – a true labour of love! He is more playful with the garnishes, with a variety of vinaigrettes and expertly balanced spices. He also likes to put his own spin on classics such as tournedos Rossini, fo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vrijthof%2027%2C%20Hilvarenbeek%2C%205081%20CB%2C%20Netherlands"
    pageTitle="Pikaar"
  />
);

export default Pikaar;
