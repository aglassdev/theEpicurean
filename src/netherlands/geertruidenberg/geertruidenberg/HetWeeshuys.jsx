...
const HetWeeshuys = () => (
  <RestaurantPage
    restaurantName="Het Weeshuys"
    address="Markt 52, Geertruidenberg, 4931 BT, Netherlands"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+31162513698"
    website="https://www.weeshuys.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Striking murals with a culinary theme give this orphanage chapel (1310) real individuality. The vibrant decor indoors is certainly a sight to behold, but there is also a courtyard terrace that is idyllic in fine weather. Opt for the lunch set menu or simply let the chef surprise you with inspired and delicate creations such as choucroute and prawns with an Asian twist, or a new take on wild boar terrine – a feast for the senses is guaranteed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markt%2052%2C%20Geertruidenberg%2C%204931%20BT%2C%20Netherlands"
    pageTitle="Het Weeshuys"
  />
);

export default HetWeeshuys;
