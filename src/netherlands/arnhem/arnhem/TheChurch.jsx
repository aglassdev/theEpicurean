...
const TheChurch = () => (
  <RestaurantPage
    restaurantName="The Church"
    address="Ir J.P. Van Muijlwijkstraat 19A, Arnhem, 6828 BP, Netherlands"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+31262148800"
    website="https://the-church.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its stained-glass windows, sculptures, murals and old pews, this Lutheran church has been beautifully preserved. The juxtaposition of modern opulence with the venue's rich past is truly inspired. Take in the spectacle of the open kitchen while enjoying a meal prepared right before your eyes. Nestled in the church's rafters, there are a few cosy guestrooms. But first, it's time to let yourself be spoiled by Bart Leussink, a chef who embraces creativity and boldness in his cooking. For instance, he elevates lamb neck with a crispy herb crust and lamb fillet with a vibrant sweet-and-sour cucumber garnish and a rich lamb jus. The chef has a penchant for fish and seafood dishes, into which he likes weave zesty flavours. An extraordinary experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ir%20J.P.%20Van%20Muijlwijkstraat%2019A%2C%20Arnhem%2C%206828%20BP%2C%20Netherlands"
    pageTitle="The Church"
  />
);
