...
const TheGreenRose = () => (
  <RestaurantPage
    restaurantName="The Green Rose"
    address="Koningstraat 50, Arnhem, 6811 DH, Netherlands"
    cuisine="Organic, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+31263518927"
    website="https://www.thegreenrose.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jin Hu lives according to the rhythm of the micro-seasons and lets nature determine his creativity. Local artisans inspire him, and he uses every part of his own livestock. This close connection and respect for his environment are the common thread running through his French/Asian fusion dishes. Pure. Intense. For example, the chef surrounds al dente leeks with a delicate cream made from the vegetable, salty cockles from the North Sea with chives and a butter sauce with yuzu for a delicate freshness. Surprises lurk in every dish here, as they do in the special selection of natural wines and speciality beers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Koningstraat%2050%2C%20Arnhem%2C%206811%20DH%2C%20Netherlands"
    pageTitle="The Green Rose"
  />
);

export default TheGreenRose;
