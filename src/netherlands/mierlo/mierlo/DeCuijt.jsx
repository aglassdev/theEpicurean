...
const DeCuijt = () => (
  <RestaurantPage
    restaurantName="De Cuijt"
    address="Burgemeester Termeerstraat 50, Mierlo, 5731 SE, Netherlands"
    cuisine="Creative French, World Cuisine"
    priceRange="€€€€"
    phoneNumber="+31492661323"
    website="https://www.restaurant-decuijt.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="De Cuijt is the heartwarming joint venture of chefs Yuki and Koen. Since 1914, this has been a favourite spot for those who enjoy sharing life's pleasures, and today the couple is elevating that experience to new heights. The bright interior exudes a calm, zen-inspired atmosphere, and the terrace feels cosy and inviting. In the kitchen both chefs' styles are united in dishes rooted in French cuisine, enhanced with creative touches and subtle Korean influences. Their technical finesse and focus on sauces create character. Exceedingly tender pork cheeks and creamy leek hearts, for example, reveal all their depth in combination with an elegant peppercorn sauce with a hint of Armagnac. This exceptional duo presents a menu brimming with personality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burgemeester%20Termeerstraat%2050%2C%20Mierlo%2C%205731%20SE%2C%20Netherlands"
    pageTitle="De Cuijt"
  />
);

export default DeCuijt;
