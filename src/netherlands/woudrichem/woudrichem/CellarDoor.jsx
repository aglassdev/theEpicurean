...
const CellarDoor = () => (
  <RestaurantPage
    restaurantName="Cellar Door"
    address="Hoogstraat 47, Woudrichem, 4285 AG, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31642112993"
    website="https://www.restaurantcellardoor.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Woudrichem's old town hall has been tastefully rejuvenated. Behind the brick façade, a stylish and spacious-feeling restaurant awaits. Paulina, your charming hostess, and chef Kalai both have experience of working at top-flight establishments, and it shows in everything they do. Nothing is left to chance here; a great deal of thought goes into the presentation of the dishes, for instance. The chef lets his creativity speak for itself in a single set menu. For example, he elevates tender venison fillet with roasted beetroot, coffee-infused celeriac, fried chicory with miso and an exquisite game jus, in which pickled cherries provide a vibrant kick. The ambition is palpable at Cellar Door...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hoogstraat%2047%2C%20Woudrichem%2C%204285%20AG%2C%20Netherlands"
    pageTitle="Cellar Door"
  />
);
