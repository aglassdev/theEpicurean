...
const KruidenJasmijn = () => (
  <RestaurantPage
    restaurantName="Kruiden & Jasmijn"
    address="Kerkstraat 43, Woudrichem, 4285 BA, Netherlands"
    cuisine="Farm to table, French Contemporary"
    priceRange="€€€"
    phoneNumber="+31183310242"
    website="https://www.kruidenenjasmijn.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located just inside the historical city walls, this is an elegantly appointed restaurant featuring modern art and imposing chandeliers. The terrace exudes tranquillity, and the attentive service creates a warm and welcoming atmosphere. A passionate advocate for local produce, chef Patrick de Rade especially loves Eastern Scheldt lobster when it is in season. He also regularly harvests fruit and vegetables from his garden. Sourced from a friendly local farmer, red cabbage adds a touch of sweetness to his venison fillet, perfectly complementing the sweet-and-sour pickled red beets. His rich sauces are testament to his culinary expertise and generosity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kerkstraat%2043%2C%20Woudrichem%2C%204285%20BA%2C%20Netherlands"
    pageTitle="Kruiden & Jasmijn"
  />
);

export default KruidenJasmijn;
