...
const HetOudeGemeentehuis = () => (
  <RestaurantPage
    restaurantName="Het Oude Gemeentehuis"
    address="Herenstraat 47, Rhenen, 3911 JB, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31317740294"
    website="https://www.restauranthetoudegemeentehuis.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once the town hall, this is the ideal place for convivial dining. Original features provide a striking contrast with the modern design and warm colours. Indulgence is the name of the game when it comes to the food. Whether you opt for the rich lobster bisque, the sea bass with the rich beurre blanc or their contemporary take on tiramisu, you will be bowled over by the skill and charm of hosts Niels Minkman and Janneke Eerbeek...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herenstraat%2047%2C%20Rhenen%2C%203911%20JB%2C%20Netherlands"
    pageTitle="Het Oude Gemeentehuis"
  />
);

export default HetOudeGemeentehuis;
