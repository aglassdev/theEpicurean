...
const Tribeca = () => (
  <RestaurantPage
    restaurantName="Tribeca"
    address="Jan Deckersstraat 7, Heeze, 5591 HN, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31402263232"
    website="https://restaurant-tribeca.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The brainchild of hostess Claudia and chef Jan Sobecki, Tribeca is housed in a stately villa that exudes elegance. Booking a table in the kitchen room, where you can watch the chefs at work, is definitely recommended. In the summer, the terrace overlooking the colourful garden makes for an enchanting setting in which to explore the chef's culinary world. He strips it right back in his dishes. His eye for detail lies in the depth of the flavours. This is a cuisine that is at once light and rich, courtesy of a blend of classical flair and international influences. The combination of pillowy gnocchi, basil oil, slivers of sun-dried tomato and a parmesan espuma transports you back to Italian holidays past and demonstrates his profound understanding of his flavours. The chef excels at using reg..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jan%20Deckersstraat%207%2C%20Heeze%2C%205591%20HN%2C%20Netherlands"
    pageTitle="Tribeca"
  />
);
