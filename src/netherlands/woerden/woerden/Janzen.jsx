...
const Janzen = () => (
  <RestaurantPage
    restaurantName="JanZen"
    address="Rietveld 130, Woerden, 3443 XE, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31348688001"
    website="https://www.restaurantjanzen.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a lovely, meticulously refurbished Art Deco building surrounded by polders, JanZen is a place where you can unwind and dine in good company. Hostess Natasja provides attentive service; chef Jeroen's dishes are beautifully presented and packed with exciting flavours. Order à la carte, or opt for the surprise menu to explore his intricate creations. Think sea bass remoulade with vibrant cucumber and radish garnishes, as well as a clear tomato broth – a true delight for both the eye and the palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rietveld%20130%2C%20Woerden%2C%203443%20XE%2C%20Netherlands"
    pageTitle="JanZen"
  />
);

export default Janzen;
