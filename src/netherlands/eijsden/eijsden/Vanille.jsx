...
const Vanille = () => (
  <RestaurantPage
    restaurantName="Vanille"
    address="Diepstraat 1, Eijsden, 6245 BJ, Netherlands"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+31434093554"
    website="https://www.restaurantvanille.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Crousens are writing a new chapter in the story of this beloved culinary landmark. The period tiled floor and elegant decor are still as charming as ever. With her radiant smile and attentive service, hostess Veronique sets the tone, and chef Jules demonstrates a seamless fusion of classical cooking and influences from around the globe in his set menus. Using a savory foam of asparagus, bumbu and tom kha kai in an original take on asperges à la flamande, the chef brings liveliness to langoustine and pork belly in cuisine that is both refined and inspired. No wonder Vanille is a favourite with the people of Limburg!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Diepstraat%201%2C%20Eijsden%2C%206245%20BJ%2C%20Netherlands"
    pageTitle="Vanille"
  />
);
