...
const NoletsVistro = () => (
  <RestaurantPage
    restaurantName="Nolet's Vistro"
    address="Burgemeester Sinkelaan 6, Yerseke, 4401 AL, Netherlands"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+31113572101"
    website="https://www.vistro.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zeeland oysters, grilled lobster and smoked eel from the Eastern Scheldt are just a few of the reasons why you’ll want to book a table in this charming bistro. Here, you won’t find any unnecessary fuss, just pure cuisine based around superb ingredients of the freshest quality. A generous spirit is also part of the Nolet’s Vistro DNA!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burgemeester%20Sinkelaan%206%2C%20Yerseke%2C%204401%20AL%2C%20Netherlands"
    pageTitle="Nolet's Vistro"
  />
);

export default NoletsVistro;
