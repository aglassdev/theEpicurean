...
const Oesterput14 = () => (
  <RestaurantPage
    restaurantName="Oesterput 14"
    address="Havendijk 21, Yerseke, 4401 NS, Netherlands"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+31113760500"
    website="https://www.oesterput14.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The oyster tanks and the Eastern Scheldt reveal all their secrets in this sparkling establishment, which is the height of contemporary cuisine. Fish-lovers are well placed here for mouthwatering sea delicacies delivered fresh and unadulterated to the plate. Those who opt for a delicious piece of meat will also find tailored dishes on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Havendijk%2021%2C%20Yerseke%2C%204401%20NS%2C%20Netherlands"
    pageTitle="Oesterput 14"
  />
);

export default Oesterput14;
