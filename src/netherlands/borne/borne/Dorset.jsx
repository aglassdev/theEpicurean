...
const Dorset = () => (
  <RestaurantPage
    restaurantName="Dorset"
    address="Grotestraat 167, Borne, 7622 GE, Netherlands"
    cuisine="Farm to table, Modern French"
    priceRange="€€€"
    phoneNumber="+31742661925"
    website="https://www.dorset.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kitty and Willem have been welcoming guests with open arms since 2000. The charming couple have created an intimate and trendy restaurant with a pleasant lounge atmosphere and verdant terrace. Chef Davy Roord has a passion for local produce but equally enjoys working with exotic seasonings. His cooking is exuberant, at times creative, and it always has a fresh edge. For example, he pairs lamb from the region with textures of beetroot, celeriac and mustard, creating earthy-sweet, grilled, spicy and tangy nuances. The accompanying jus is artfully finished with red wine. Diner satisfaction is the priority here, when it comes to both the food and the wine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grotestraat%20167%2C%20Borne%2C%207622%20GE%2C%20Netherlands"
    pageTitle="Dorset"
  />
);
