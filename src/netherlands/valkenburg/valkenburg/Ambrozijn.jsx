...
const Ambrozijn = () => (
  <RestaurantPage
    restaurantName="Ambrozijn"
    address="Plenkertstraat 45, Valkenburg, 6301 GL, Netherlands"
    cuisine="Modern Cuisine, Creative French"
    priceRange="€€€€"
    phoneNumber="+31432003068"
    website="https://www.restaurantambrozijn.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Previously a church, Irenekerk (1891) is now a restaurant. Here, design reigns supreme, with a stylish blend of soft and raw materials. The newly built roof truss immediately catches the eye, as do the rugged black walls. Downstairs, the chef's table encircles the completely open kitchen; on the upper floor, there is a magnificent bar built in the shape of an organ. This place is all the more exceptional because of the way Sven Nijenhuis draws on French cooking styles and innovative techniques. With exquisite sauces and precisely judged seasonings, he makes his mark. Think slow-cooked pork cheeks with glazed aubergine, mayonnaise finished with Thai basil, subtly spicy baba ganoush and a veal jus elevated with fenugreek. Simply divine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plenkertstraat%2045%2C%20Valkenburg%2C%206301%20GL%2C%20Netherlands"
    pageTitle="Ambrozijn"
  />
);

export default Ambrozijn;
