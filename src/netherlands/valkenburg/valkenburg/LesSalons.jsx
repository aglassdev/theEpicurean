...
const LesSalons = () => (
  <RestaurantPage
    restaurantName="Les Salons"
    address="Joseph Corneli Allée 1, Valkenburg, 6301 KK, Netherlands"
    cuisine="Farm to table, Modern French"
    priceRange="€€€"
    phoneNumber="+31436088888"
    website="https://www.oostwegelcollection.nl/chateau-st-gerlach/restaurants/les-salons/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Belle Époque allure of Les Salons is a feast for the eyes. The character of this old castle, the art and murals in the three historic rooms, the modern furniture, the terrace overlooking the meticulously trimmed gardens... Wow! (Psst: be sure to ask about the story behind the bullet hole in the two-way mirror). The chefs give French tradition a contemporary twist. Here, they understand the importance of rich sauces and playful nuances to bring the plate to life, such as that braised halibut fillet with a light mushroom emulsion and crispy parsnips, given just enough vibrancy by grating lemon zest over them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Joseph%20Corneli%20All%C3%A9e%201%2C%20Valkenburg%2C%206301%20KK%2C%20Netherlands"
    pageTitle="Les Salons"
  />
);

export default LesSalons;
