...
const TPakhuus = () => (
  <RestaurantPage
    restaurantName="'t Pakhuus"
    address="Haven 8, Oudeschild, 1792 AE, Netherlands"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+31222313581"
    website="https://pakhuus.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant's designer decor is delightful, with a moss-clad wall that brings a touch of nature into the dining room. However, the ultimate appeal of this historical warehouse is its view of the harbour and the shrimp boats. Fish and seafood are the speciality of the house – the centrepiece is the fish tank, which is replenished daily. Think fresh Wadden oysters or scallops, enhanced by Asian flavours such as ponzu, ginger and pimento. Of course, the menu also features other local delicacies, such as Texel lamb. To cap it all off, why not spend the night in one of the designer suites?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Haven%208%2C%20Oudeschild%2C%201792%20AE%2C%20Netherlands"
    pageTitle="'t Pakhuus"
  />
);

export default TPakhuus;
