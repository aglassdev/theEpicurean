...
const Monarh = () => (
  <RestaurantPage
    restaurantName="Monarh"
    address="Bredaseweg 204-08, Tilburg, 5038 NK, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31135365805"
    website="https://www.monarh.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Monarh embraces the character of this monastery, which dates back over 125 years, with a private dining space set beneath vaulted ceilings and surrounded by exposed brickwork. The interior of this romantic restaurant, meanwhile, is sleek and stylish, clearly designed with a keen eye for aesthetics. Paul Kappé delivers visually stunning dishes that reflect his precise and detail-oriented approach. He has a true talent for elegant plating. Beauty goes hand in hand with bold flavours. The chef showcases time-honoured cooking techniques and elaborate garnishes. Smoking, glazing, bright gels… One taste impression quickly follows another. Halibut sautéed in beurre noisette, perfectly translucent at its core, is elevated by a light and frothy but intensely flavoursome beurre blanc. Textures of ca..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bredaseweg%20204-08%2C%20Tilburg%2C%205038%20NK%2C%20Netherlands"
    pageTitle="Monarh"
  />
);

export default Monarh;
