...
const TeKoopInTilburg = () => (
  <RestaurantPage
    restaurantName="Te Koop in Tilburg"
    address="Jan Pieterszoon Coenstraat 71, Tilburg, 5018 CP, Netherlands"
    cuisine="International, French Contemporary"
    priceRange="€€"
    phoneNumber="+31135771137"
    website="https://www.tekoopintilburg.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Crispy fried soft shell crab with broccoli and couscous, tomato tartare with a Manchego foam and herb oil, or beef bavette steak with veal jus infused with cloves and cardamom… Located just outside Tilburg city centre, this cosy neighbourhood restaurant with a warm and welcoming decor has it all. The chef, who enjoys tapping into international flavours and makes sure to cater to vegetarians, showcases his cuisine in an appealing choice of courses from which diners compile their own set menu. What's not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jan%20Pieterszoon%20Coenstraat%2071%2C%20Tilburg%2C%205018%20CP%2C%20Netherlands"
    pageTitle="Te Koop in Tilburg"
  />
);

export default TeKoopInTilburg;
