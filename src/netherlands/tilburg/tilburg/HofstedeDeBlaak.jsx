...
const HofstedeDeBlaak = () => (
  <RestaurantPage
    restaurantName="Hofstede de Blaak"
    address="Dussenpad 1, Tilburg, 5032 WL, Netherlands"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+31134638899"
    website="https://hofstededeblaak.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The charm of this authentic English country house (1907), the classic half-timbering and elegant details, the peaceful surroundings – it is hard not to be moved by this setting. The chef loves working with fine ingredients and accentuates their finesse with contemporary seasonings. He is fond of combining diverse flavours to create elegant nuances. Be sure to try the excellent set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dussenpad%201%2C%20Tilburg%2C%205032%20WL%2C%20Netherlands"
    pageTitle="Hofstede de Blaak"
  />
);

export default HofstedeDeBlaak;
