...
const Spandershoeve = () => (
  <RestaurantPage
    restaurantName="Spandershoeve"
    address="Bussumergrintweg 46, Hilversum, 1217 BS, Netherlands"
    cuisine="Indonesian"
    priceRange="€€"
    phoneNumber="+31356211130"
    website="https://www.spandershoeve.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spandershoeve has been showcasing traditional Indonesian cuisine since 1972. Anita Boerenkamp was the first chef in the Netherlands to put a sophisticated spin on the famous rijsttafel. Her confident take on the fiery and intricate blend of spices was remarkable. She taught Timo, her grandson, all he knows – how to roast goat until it is succulent, how to employ soy sauce to powerful effect, and how to add texture with raw and fried onions. This welcoming neighbourhood restaurant is the perfect introduction to Indonesian generosity and hospitality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bussumergrintweg%2046%2C%20Hilversum%2C%201217%20BS%2C%20Netherlands"
    pageTitle="Spandershoeve"
  />
);

export default Spandershoeve;
