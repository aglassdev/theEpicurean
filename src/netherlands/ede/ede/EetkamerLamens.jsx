...
const EetkamerLamens = () => (
  <RestaurantPage
    restaurantName="Eetkamer Lamens"
    address="Nieuwe Stationsstraat 4, Ede, 6711 AG, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31318784587"
    website="https://eetkamerlamens.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spacious brasserie has a subtle industrial aesthetic, but its atmosphere is nonetheless thoroughly warm and welcoming. In fine weather, the inviting terrace beckons. On the enticing menu, familiar favourites such as steak tartare feature alongside Mediterranean, South American and Asian dishes. Whether through subtle heat, a refreshing lift of acidity or a full-bodied sauce, the chefs set themselves apart. A shining example is chicken breast from the Josper charcoal oven, topped with a fragrant bumbu Bali, brightened by sambal and a finely balanced sweet-and-sour salad of peanut, carrot and apple. The freedom to compose your own set menu from the à la carte options adds further appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwe%20Stationsstraat%204%2C%20Ede%2C%206711%20AG%2C%20Netherlands"
    pageTitle="Eetkamer Lamens"
  />
);

export default EetkamerLamens;
