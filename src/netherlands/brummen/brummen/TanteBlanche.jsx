...
const TanteBlanche = () => (
  <RestaurantPage
    restaurantName="Tante Blanche"
    address="Arnhemsestraat 22, Brummen, 6971 AR, Netherlands"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31575769109"
    website="https://www.tanteblanche.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chic, on trend and cheerful, Tante Blanche is a truly inviting space – the terrace out front is always delightful. Chef Charles Ek's surprise menu (vegetarian version available) pays homage to his aunt's cherished recipes. His cuisine is thoroughly contemporary, with a judicious touch of freshness and heat. For example, puffed quinoa-crusted langoustine is beautifully paired with a curry and lemongrass sauce, shellfish oil and mayonnaise, and vadouvan-spiced carrot. Trust the friendly waitstaff to guide you through the thoughtfully curated wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arnhemsestraat%2022%2C%20Brummen%2C%206971%20AR%2C%20Netherlands"
    pageTitle="Tante Blanche"
  />
);

export default TanteBlanche;
