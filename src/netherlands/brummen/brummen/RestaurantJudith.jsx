...
const RestaurantJudith = () => (
  <RestaurantPage
    restaurantName="Restaurant Judith"
    address="Eerbeekseweg 6, Brummen, 6971 LB, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31575569999"
    website="https://restaurantjudith.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kasteel Engelburg is a gem of a castle estate that boasts charming guestrooms and top-tier golf facilities. First, make your way to the 19C greenhouse, where you can take in the views of the peaceful natural surroundings. The chefs cook with reverence for classic techniques and a penchant for freshness and bright flavours. They work with the finest ingredients and know how to elevate them with exuberant sauces seasoned, for example, with the perfect amount of curry. This cuisine is sophisticated and, at times, delicate. Be sure to explore the selection of South African wines; after dinner, an impressive whisky collection awaits you in the lounge...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Eerbeekseweg%206%2C%20Brummen%2C%206971%20LB%2C%20Netherlands"
    pageTitle="Restaurant Judith"
  />
);

export default RestaurantJudith;
