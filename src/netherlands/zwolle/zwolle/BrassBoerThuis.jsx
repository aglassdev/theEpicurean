...
const BrassBoerThuis = () => (
  <RestaurantPage
    restaurantName="Brass Boer Thuis"
    address="Nieuwe Markt 21, Zwolle, 8011 PG, Netherlands"
    cuisine="Regional Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31387920110"
    website="https://www.brassboer.com/thuis/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Many restaurants may claim to have the kind of atmosphere in which diners feel at home, but here it really is the case. This place is located on the charming Nieuwe Markt and has a terrace that overlooks the square. Inside, driftwood and drying herbs hang from the ceiling, and the large wine wall gives the contemporary decor individuality. This is a cosy setting, and diners clearly come to have a good time. Jonnie and Thérèse Boer have built up a kitchen team that loves working with produce from Zwolle, often cooks on the wood fire and manages to create dishes that are original but not overly complex. Our inspectors were bowled over by a combination of wonderfully crispy veal sweetbreads with a subtly sweet glaze, both raw and deep-fried shrimps, crunchy vegetable accoutrements and an exqu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwe%20Markt%2021%2C%20Zwolle%2C%208011%20PG%2C%20Netherlands"
    pageTitle="Brass Boer Thuis"
  />
);

export default BrassBoerThuis;
