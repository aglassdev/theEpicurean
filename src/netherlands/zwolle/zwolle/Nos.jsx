...
const Nos = () => (
  <RestaurantPage
    restaurantName="NOÏS"
    address="Oude Vismarkt 10, Zwolle, 8011 TB, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31383031843"
    website="https://restaurant-nois.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Laura is a warm and welcoming host, and she knows the outstanding wine list like the back of her hand. Her recommendations are absolutely spot on! If you like surprises, chef Vincent is your man. There's no written menu here; your options are presented verbally only, and your trust is rewarded with imaginative, plant-forward cuisine. Whether he's imbuing various textures of celeriac with zingy flavours, or putting pork belly centre stage in an Asian-inspired dish with a bay leaf cream sauce, his elaborate culinary creations are full of flair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oude%20Vismarkt%2010%2C%20Zwolle%2C%208011%20TB%2C%20Netherlands"
    pageTitle="NOÏS"
  />
);
