...
const Oo = () => (
  <RestaurantPage
    restaurantName="O&O"
    address="Dorpsstraat 138, Sint Willebrord, 4711 EL, Netherlands"
    cuisine="Asian, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+31165383249"
    website="https://restaurantoeno.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Danny and Helena Tsang opened their restaurant Nieuw Hong Kong in Sint Willebrord in 1982. It may have been just another Chinese eatery at first, but the owners' ambitions evolved over time and they set their sights on showcasing the true finesse of Asian cuisine. And they have been successful in their quest: today, they invite diners to embark on a culinary voyage from Japan via Hong Kong and China to Thailand, Malaysia and Singapore. Chef Danny's cooking style fuses tradition with creativity. Sweet, sour, zesty and umami flavours are precisely balanced in subtle combinations. He creates exciting dishes in which exotic seasonings meet French techniques for an extra layer of sophistication. East and West become one here. The chef's expertise is evident in his house-made gochujang, his Sich..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsstraat%20138%2C%20Sint%20Willebrord%2C%204711%20EL%2C%20Netherlands"
    pageTitle="O&O"
  />
);
