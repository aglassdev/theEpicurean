...
const Brut172 = () => (
  <RestaurantPage
    restaurantName="Brut172"
    address="Reijmerstokkerdorpsstraat 143, Reijmerstok, 6274 NK, Netherlands"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+31432041056"
    website="https://www.brut172.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hans van Wolde has set up shop in the heart of the quiet Limburg countryside, having transformed a farmstead into an architectural gem. Diners are led through the different spaces, from the aperitif lounge to the cosy salon to the kitchen itself. The place has the feel of a luxurious chalet; the upscale modern design is extraordinary. This is art rather than architecture! Hans van Wolde takes you into his world, where you momentarily lose track of time. It is certainly worth considering the wonderful accommodation options in the lodges and mansion. But back to the food, which is made with top-quality ingredients and features deep, complex sauces. Hans van Wolde's culinary creations are playful and expressive, just like his character. Succulent pan-seared fillets of North Sea sole, for inst..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reijmerstokkerdorpsstraat%20143%2C%20Reijmerstok%2C%206274%20NK%2C%20Netherlands"
    pageTitle="Brut172"
  />
);

export default Brut172;
