...
const DeWatermolen = () => (
  <RestaurantPage
    restaurantName="De Watermolen"
    address="H. Avelinghstraat 154, Velp, 6881 VW, Netherlands"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+31263619002"
    website="https://www.de-watermolen.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This watermill, which is over 600 years old, is without a doubt the star attraction of this charming restaurant. Both the warm and welcoming interior and the secluded terrace are popular. Ramon Klaassen takes great pride in his work, which you cannot fail to notice during his interactions with diners. His unique take on classic dishes never disappoints. For example he rolls up soft-boiled duck ham and fills it with a rich poultry mousse. Playful garnishes such as an onion chutney with nuts and reduced balsamic vinegar add that little something extra. The set menu (with options) is a hit – even for those who do not eat meat or fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H.%20Avelinghstraat%20154%2C%20Velp%2C%206881%20VW%2C%20Netherlands"
    pageTitle="De Watermolen"
  />
);

export default DeWatermolen;
