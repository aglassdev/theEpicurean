...
const BistroRefter = () => (
  <RestaurantPage
    restaurantName="Bistro Refter"
    address="Regnerus Praediniusstraat 3, Winsum, 9951 CA, Netherlands"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+31595202023"
    website="https://www.bistrorefter.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Roelfien Steen and Cor Klevering's cosy bistro is a firm favourite. Don't expect creative excesses here, just authentic classic fare cooked up by an experienced chef; he draws much of his inspiration from French cuisine but also likes to express his love for Mediterranean flavours. This is the kind of place where you can feast on an intense bouillabaisse and a choice cut of meat with a bearnaise sauce prepared in time-honoured tradition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Regnerus%20Praediniusstraat%203%2C%20Winsum%2C%209951%20CA%2C%20Netherlands"
    pageTitle="Bistro Refter"
  />
);

export default BistroRefter;
