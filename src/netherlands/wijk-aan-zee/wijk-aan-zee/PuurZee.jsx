...
const PuurZee = () => (
  <RestaurantPage
    restaurantName="Puur Zee"
    address="Van Ogtropweg 2, Wijk aan Zee, 1949 BA, Netherlands"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+31251374304"
    website="https://puurzee.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Master chef Imko Binnerts knows how to bring out pure seafood flavours, and how to combine them into a delicious meal. His interesting cuisine is cleverly presented, while the modern combination of flavours is as elegant as the decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Ogtropweg%202%2C%20Wijk%20aan%20Zee%2C%201949%20BA%2C%20Netherlands"
    pageTitle="Puur Zee"
  />
);

export default PuurZee;
