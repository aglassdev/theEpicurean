...
const Maeve = () => (
  <RestaurantPage
    restaurantName="Maeve"
    address="Kromme Nieuwegracht 18, Utrecht, 3512 HH, Netherlands"
    cuisine="Creative French, French Contemporary"
    priceRange="€€€"
    phoneNumber="+31302006767"
    website="https://www.restaurantmaeve.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Tommy and maître d' Vera take you on a compelling culinary voyage in this characterful and stylishly designed building. She woos diners with her personable manner, he with his expressive homage to the terroir. Sourced as locally as possible, vegetables play an essential role here, lending depth to the dishes. This is a chef who cooks his ingredients to perfection, shows a light touch with fresh acidic flavours and has fun with temperatures and textures.Veal sweetbreads are briefly fried and then brushed with a reduced veal gravy. A fine brunoise of various vegetables provides a pleasing bite. Tender onion stuffed with Thai basil, strips of white onion and black truffle provide subtle aromatic touches. An excellent sauce based on veal gravy with citrus makes for a fine base. This is a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kromme%20Nieuwegracht%2018%2C%20Utrecht%2C%203512%20HH%2C%20Netherlands"
    pageTitle="Maeve"
  />
);

export default Maeve;
