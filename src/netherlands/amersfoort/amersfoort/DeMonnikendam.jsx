...
const DeMonnikendam = () => (
  <RestaurantPage
    restaurantName="De Monnikendam"
    address="Plantsoen-Oost 2, Amersfoort, 3811 HH, Netherlands"
    cuisine="French Contemporary, International"
    priceRange="€€"
    phoneNumber="+31334656690"
    website="https://www.demonnikendam.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Originally part of Amersfoort's second city wall, Monnickendam is a watergate dating back to the early 15C. Today, this piece of history has been repurposed to create a unique culinary destination. There are intimate dining spaces within the towers and a waterside terrace affording wonderful views. Thanks to the enthusiasm of hostess Kristel and chef Richard, this establishment has made a name for itself. With each course, the tasting menu seamlessly navigates between the familiar and the exotic: Think hamachi accompanied by a tangy ponzu, or lamb saddle with a crispy crust and a lamb jus infused with rosemary, thyme and wild garlic oil. A memorable dining experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plantsoen-Oost%202%2C%20Amersfoort%2C%203811%20HH%2C%20Netherlands"
    pageTitle="De Monnikendam"
  />
);

export default DeMonnikendam;
