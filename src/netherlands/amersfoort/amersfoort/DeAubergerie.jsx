...
const DeAubergerie = () => (
  <RestaurantPage
    restaurantName="De Aubergerie"
    address="Kamp 88, Amersfoort, 3811 AT, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31334756096"
    website="https://www.deaubergerie.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sweets that used to be sold in this establishment dating back to the 1700s have given way to delicacies such as lobster and Venus clams. This new direction is reflected in the artistic photographs hanging on the walls of this cosy, intimate-feeling restaurant. Chef Han showcases his ingredients in cutting-edge dishes drawing on solid French foundations and with the odd creative flourish. Take, for instance, his succulent marbré of goose breast and rillette, with the sweet earthiness of textures of beetroot, combined with vibrant pickled mustard seeds and punchy creamed rocket. The friendly atmosphere of De Aubergerie also comes down to the personal service of your hostess Ingrid...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kamp%2088%2C%20Amersfoort%2C%203811%20AT%2C%20Netherlands"
    pageTitle="De Aubergerie"
  />
);

export default DeAubergerie;
