...
const Mei = () => (
  <RestaurantPage
    restaurantName="MEI"
    address="Krommestraat 49, Amersfoort, 3811 CB, Netherlands"
    cuisine="Organic, Farm to table"
    priceRange="€€€"
    phoneNumber="+31334610222"
    website="https://www.mei-amersfoort.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Marco Blok is an enthusiastic champion of sustainable development. His menu and restaurant have been treated to a makeover, in particular the splendid counter. This seasoned chef crafts subtle dishes in which the wide diversity offered by vegetables is exploited to its full. He plays with fermentation, acidity, fruity flavours and slow cooking… Subtly balanced guest star appearances of local meat and fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Krommestraat%2049%2C%20Amersfoort%2C%203811%20CB%2C%20Netherlands"
    pageTitle="MEI"
  />
);
