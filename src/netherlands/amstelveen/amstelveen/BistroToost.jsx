...
const BistroToost = () => (
  <RestaurantPage
    restaurantName="Bistro Toost"
    address="Dorpsstraat 90, Amstelveen, 1182 JH, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31202141007"
    website="https://bistrotoost.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Toost is a welcoming and vibrant bistro – the dried leaves hanging from the ceiling lend the setting a distinctively Mediterranean feel. Opting for a seat at the long bar is always a good idea. Diners order à la carte, choosing from a variety of typical dishes in smaller portions. Crab remoulade with crispy toast, crunchy vegetables and a mustard vinaigrette, or hand-cut steak tartare seasoned with capers and served with fresh chips and mayonnaise – these familiar dishes, with the occasional Asian twist, are the secret to the success of this charming bistro. Don't forget to make a reservation!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsstraat%2090%2C%20Amstelveen%2C%201182%20JH%2C%20Netherlands"
    pageTitle="Bistro Toost"
  />
);

export default BistroToost;
