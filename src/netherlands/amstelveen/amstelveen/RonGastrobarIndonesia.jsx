...
const RonGastrobarIndonesia = () => (
  <RestaurantPage
    restaurantName="Ron Gastrobar Indonesia"
    address="Amstelzijde 51, Amstelveen, 1184 TZ, Netherlands"
    cuisine="Indonesian"
    priceRange="€€"
    phoneNumber="+31203052760"
    website="https://rongastrobar.nl/restaurants/ron-gastrobar-indonesia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Top chef Ron Blaauw has a nose for a winning concept, as proven by this typical Indonesian restaurant with its bustling terrace by the River Amstel. The flavours are distinctively Asian, but he and his colleague Agus Hermawan also add their own twists for that extra fragrance and depth. The rijsttafel options Agus (15 dishes) and Tim (12 dishes) provide the perfect opportunity to share all kinds of delicious treats, such as satay kambing and udang peteh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amstelzijde%2051%2C%20Amstelveen%2C%201184%20TZ%2C%20Netherlands"
    pageTitle="Ron Gastrobar Indonesia"
  />
);

export default RonGastrobarIndonesia;
