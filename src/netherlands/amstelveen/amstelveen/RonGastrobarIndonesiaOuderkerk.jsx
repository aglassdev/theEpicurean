...
const RonGastrobarIndonesiaOuderkerk = () => (
  <RestaurantPage
    restaurantName="Ron Gastrobar Indonesia Ouderkerk"
    ...
    pageTitle="Ron Gastrobar Indonesia Ouderkerk"
  />
);

export default RonGastrobarIndonesiaOuderkerk;
