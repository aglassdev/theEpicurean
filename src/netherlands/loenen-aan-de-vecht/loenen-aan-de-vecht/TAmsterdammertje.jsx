...
const TAmsterdammertje = () => (
  <RestaurantPage
    restaurantName="'t Amsterdammertje"
    address="Rijksstraatweg 119, Loenen aan de Vecht, 3632 AB, Netherlands"
    cuisine="Creative, Fusion"
    priceRange="€€€"
    phoneNumber="+31294234848"
    website="https://www.restaurantamsterdammertje.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This converted farmhouse is the place to come for an upbeat dining experience in a vibrant and trendy setting. Great music plays in the background, large chandeliers hang from the ceiling, modern art adorns the wall… This is a restaurant with a hip vibe. Working in an attractive open kitchen, André Gerrits's creativity befits the setting. His cuisine has panache and knows no limits.In his international creations he gives pride of place to vegetables from his own garden, along with other gems of Dutch produce. Finishing off a foamy oyster beurre blanc with sereh lemongrass, enhancing a pumpkin gravy by adding kimchi made from vegetables… These culinary creations are playful and lighthearted, but it is the strong flavours that always win over diners. And you can rest assured that Chef Gerrit..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rijksstraatweg%20119%2C%20Loenen%20aan%20de%20Vecht%2C%203632%20AB%2C%20Netherlands"
    pageTitle="'t Amsterdammertje"
  />
);

export default TAmsterdammertje;
