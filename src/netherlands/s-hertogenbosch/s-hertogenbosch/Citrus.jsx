...
const Citrus = () => (
  <RestaurantPage
    restaurantName="Citrus"
    address="Lange Putstraat 7a, 's-Hertogenbosch, 5211 KN, Netherlands"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+31736892082"
    website="https://www.restaurantcitrus.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Paul Hermes and Jill van Orsouw treat their guests like friends in their intimate, convivial restaurant. The chef, who can be seen at work on his “podium” to the rear of the dining room, likes to bring his carefully prepared dishes to the table himself. He prepares dishes which are full of different textures and flavours, showcasing exciting ideas and delighting guests with his rich cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Putstraat%207a%2C%20's-Hertogenbosch%2C%205211%20KN%2C%20Netherlands"
    pageTitle="Citrus"
  />
);
