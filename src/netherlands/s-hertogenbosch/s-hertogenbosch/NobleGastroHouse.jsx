...
const NobleGastroHouse = () => (
  <RestaurantPage
    restaurantName="Noble Gastro House"
    address="Wilhelminaplein 1, 's-Hertogenbosch, 5211 CG, Netherlands"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+31736132331"
    website="https://www.noblegastrohouse.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Noble Gastro House is both inviting and sleek, and a seat at the bar is perfect for watching the kitchen team up close. This is the kind of place where anything goes. Whether you're in the market for a quick bite or a multi-course dinner, you call the shots here! The set menu features a variety of interesting dishes, many of which can be ordered as either half or full portions. Monkfish fillet with an exquisite verjus beurre blanc, or al dente asparagus with morels that have been tossed in veal jus, accompanied by a buttery sauce with the subtle tartness of rhubarb: the familiar and the daring go hand in hand here. Drawing on a wealth of experience, the chefs delight in creating dishes with both high-end and everyday ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wilhelminaplein%201%2C%20's-Hertogenbosch%2C%205211%20CG%2C%20Netherlands"
    pageTitle="Noble Gastro House"
  />
);

export default NobleGastroHouse;
