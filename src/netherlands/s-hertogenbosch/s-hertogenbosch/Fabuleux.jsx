...
const Fabuleux = () => (
  <RestaurantPage
    restaurantName="Fabuleux"
    address="Verwersstraat 23, 's-Hertogenbosch, 5211 HT, Netherlands"
    cuisine="Classic Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31737410011"
    website="https://www.restaurantfabuleux.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fabuleux is a trendy restaurant with a classic decor in its front dining room and a more intimate ambience to the rear. On arrival, your gaze is immediately drawn to the striking wine “library”, from which host Paul van Gestel selects the best bottles. Chef Busio creates updated and beautifully presented dishes which are full of classic flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Verwersstraat%2023%2C%20's-Hertogenbosch%2C%205211%20HT%2C%20Netherlands"
    pageTitle="Fabuleux"
  />
);

export default Fabuleux;
