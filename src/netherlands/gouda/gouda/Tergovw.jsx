...
const Tergovw = () => (
  <RestaurantPage
    restaurantName="Ter:Govw"
    address="Oosthaven 23A, Gouda, 2801 PC, Netherlands"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31182524884"
    website="https://www.restauranttergovw.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Let's first clarify the meaning of Ter:Govw – it refers to Tergouw, which is the city of Gouda's historical name. This warm and welcoming restaurant is located close to the city centre, by a canal. The chefs present a set menu that, from amuse-bouche to dessert, resonates with today's culinary zeitgeist. This translates to a reverence for the classics combined with an appreciation for zesty flavours and Asian seasonings. The menu could open with a creative take on tuna nigiri, paired with a leek-infused beurre blanc, followed by succulent tournedos Rossini encircled by a glossy Madeira jus. As for what to drink, simply rely on the fine wine pairings recommended by the house...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oosthaven%2023A%2C%20Gouda%2C%202801%20PC%2C%20Netherlands"
    pageTitle="Ter:Govw"
  />
);

export default Tergovw;
