...
const ApiciusCAS = () => (
  <RestaurantPage
    restaurantName="Apicius"
    address="Van der Mijleweg 16, Castricum, 1901 KD, Netherlands"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+31251676760"
    website="https://www.apicius.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Apicius is the culinary triumph of chef Thorvald and host Gaylord de Winter. The brothers have consistently held at least one MICHELIN star every year since 2003. Good taste is in their DNA, and their expertise shines through in the tiniest details – from the perfectly chosen Burgundy to pair with a fish dish, to the velvety pistachio ice cream complementing an exotic dessert. Chef Thorvald has a true knack for the classics. Exceptional ingredients are the foundation of his cuisine. He keeps fish preparation simple and straightforward: he sears it skin-side down – just long enough – and elevates it with refined finishing touches and a sauce that adds depth. For example, succulent sea bass gets a touch of acidity from a foam made from house-made pickles. Appealing presentations add a fresh ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20der%20Mijleweg%2016%2C%20Castricum%2C%201901%20KD%2C%20Netherlands"
    pageTitle="Apicius"
  />
);

export default ApiciusCAS;
