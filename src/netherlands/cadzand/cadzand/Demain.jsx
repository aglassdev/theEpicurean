...
const Demain = () => (
  <RestaurantPage
    restaurantName="Demain"
    address="Boulevard de Wielingen 49, Cadzand, 4506 JK, Netherlands"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+31850609864"
    website="https://demain.restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The magnificent view of the dunes and the North Sea are an integral part of your dining experience at Demain. On the second floor of Strandhotel Cadzand, clean lines and a harmonious blend of wood tones lend the restaurant area a warm and inviting feel. Romée and her team provide charming and attentive service; Dani Hoefnagels and his crew whisk you away on a culinary voyage from Zeeland to the Mediterranean.Before being seated, diners are invited into the kitchen for some amuse-bouches. The passion and skill that go into this operation are immediately apparent. Think super-fresh Dutch hamachi with a smoked eel mayonnaise, an intense herb coulis and a burst of freshness provided by caviar lime, apple gel and chopped kiwi. One of the chef's signature dishes is pan-seared langoustine with a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boulevard%20de%20Wielingen%2049%2C%20Cadzand%2C%204506%20JK%2C%20Netherlands"
    pageTitle="Demain"
  />
);
