...
const Cline = () => (
  <RestaurantPage
    restaurantName="Céline"
    address="Fort Jutphaas 3, Nieuwegein, 3439 LX, Netherlands"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+31306031708"
    website="https://www.restaurantceline.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The austere appearance of Fort Jutphaas is in marked contrast to the restaurant it houses, which boasts an intimate atmosphere with subdued lighting and cosy terrace. Chef Rick works principally with Dutch produce, such as Dutch yellowtail, which he likes to season with subtle Asian flavours. This is original and modern cuisine, in which vegetables take pride of place. In fact, why not opt for the appealing vegetarian set menu?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fort%20Jutphaas%203%2C%20Nieuwegein%2C%203439%20LX%2C%20Netherlands"
    pageTitle="Céline"
  />
);
