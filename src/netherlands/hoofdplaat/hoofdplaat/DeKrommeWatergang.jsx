...
const DeKrommeWatergang = () => (
  <RestaurantPage
    restaurantName="De Kromme Watergang"
    address="Slijkplaat 6, Hoofdplaat, 4513 KK, Netherlands"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31117348696"
    website="https://www.krommewatergang.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With the Eastern Scheldt and North Sea serving as primary suppliers, and De Zilte Hof vegetable garden across the street providing the chefs with vegetables, fruit and herbs, De Kromme Watergang takes full advantage of the bountiful ingredients Zeelandic Flanders has to offer. That ambassadorial role is also reflected in the respect they have for the produce, which is evident in their nose-to-tail approach. Open since 1993, this beloved restaurant now mostly sees Tom Vinke at the helm of the open kitchen, as he gradually takes over from his father, Edwin.Here, produce is king, elevated by the chef's carefully considered garnishes and spicy exotic seasonings. For instance, he poaches ling from bycatch in butter and barbecues it briefly. He then serves it up with a foamy jus with dill, crunc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Slijkplaat%206%2C%20Hoofdplaat%2C%204513%20KK%2C%20Netherlands"
    pageTitle="De Kromme Watergang"
  />
);

export default DeKrommeWatergang;
