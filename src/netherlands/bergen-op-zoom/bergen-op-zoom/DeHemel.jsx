...
const DeHemel = () => (
  <RestaurantPage
    restaurantName="De Hemel"
    address="Moeregrebstraat 35, Bergen op Zoom, 4611 JB, Netherlands"
    cuisine="Modern French, Home Cooking"
    priceRange="€€"
    phoneNumber="+31164210108"
    website="https://www.dehemelboz.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy an intimate dinner in a romantic dining room, or on the rear terrace in fine weather, and choose from a selection of tasty dishes prepared in French style, with a nod to modern cuisine. A delightful dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Moeregrebstraat%2035%2C%20Bergen%20op%20Zoom%2C%204611%20JB%2C%20Netherlands"
    pageTitle="De Hemel"
  />
);

export default DeHemel;
