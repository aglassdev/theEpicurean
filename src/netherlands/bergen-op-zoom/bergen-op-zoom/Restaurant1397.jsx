...
const Restaurant1397 = () => (
  <RestaurantPage
    restaurantName="Restaurant 1397"
    address="Grote Markt 38, Bergen op Zoom, 4611 NT, Netherlands"
    cuisine="French Contemporary"
    priceRange="€€€"
    phoneNumber="+31164252050"
    website="https://www.hoteldedraak.nl/nl/restaurant-1397"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hotel de Draak's restaurant takes you on a journey back to 1397, taking in the Dutch Golden Age before looking to the future. The decor subtly incorporates all manner of dragons, ubiquitous touches of gold, high ceilings and large windows – this is a 21C take on historical grandeur! Treat yourself to a drink in the chic aperitif lounge before chef Torben Bouterse starts working his magic. Classic dishes are enhanced by a predilection for vegetables, nods to Zeeland cuisine and inspirations from around the globe. Take, for example, his teppanyaki scallops with a velvety Jerusalem artichoke cream, lent a hit of umami by a delicate white wine jus infused with koji. Diners delight in such a masterful and spontaneous approach to textures and flavour pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grote%20Markt%2038%2C%20Bergen%20op%20Zoom%2C%204611%20NT%2C%20Netherlands"
    pageTitle="Restaurant 1397"
  />
);

export default Restaurant1397;
