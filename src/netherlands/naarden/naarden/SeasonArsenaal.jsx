...
const SeasonArsenaal = () => (
  <RestaurantPage
    restaurantName="SEAson - Arsenaal"
    address="Kooltjesbuurt 1, Naarden, 1411 RZ, Netherlands"
    cuisine="Seafood, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+31352122222"
    website="https://www.season-arsenaal.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Originally erected in 1688 as a military barracks, this building was converted many years later by renowned interior designer Jan des Bouverie. Today, the place is chic and inviting, and the terrace is a real draw on sunny days. Dennis Koopmans specialises in seafood, but does cater to meat eaters as well. If you're looking for a plateau de fruits de mer or the freshest of seasonal fish, it doesn't get much better than this. Think pan-fried red mullet and a rich shellfish bisque, with finely chopped fennel providing a hint of zesty flavour, complemented by salty samphire and crispy croutons. As the name suggests, this restaurant is a celebration of the finest and freshest seasonal produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kooltjesbuurt%201%2C%20Naarden%2C%201411%20RZ%2C%20Netherlands"
    pageTitle="SEAson - Arsenaal"
  />
);

export default SeasonArsenaal;
