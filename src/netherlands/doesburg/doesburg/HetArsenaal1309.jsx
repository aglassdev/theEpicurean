...
const HetArsenaal1309 = () => (
  <RestaurantPage
    restaurantName="Het Arsenaal 1309"
    address="Kloostertuin 10, Doesburg, 6981 CC, Netherlands"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+31313475863"
    website="https://www.hetarsenaal1309.nl/restaurant-het-arsenaal-1309"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kloostertuin%2010%2C%20Doesburg%2C%206981%20CC%2C%20Netherlands"
    pageTitle="Het Arsenaal 1309"
  />
);

export default HetArsenaal1309;
