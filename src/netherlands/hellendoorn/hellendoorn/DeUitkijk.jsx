...
const DeUitkijk = () => (
  <RestaurantPage
    restaurantName="De Uitkijk"
    address="Hellendoornsebergweg 8, Hellendoorn, 7447 PA, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31548654117"
    website="https://www.landgoeddeuitkijk.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its magnificent natural setting, a lavender-filled terrace with a southern feel, and a restaurant with a country estate atmosphere, De Uitkijk offers a winning combination. Guests can watch the seasons change on the plate, with herbs from the chef's own garden. The elaborate dishes here are full of fresh flavour and boast lots of variety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hellendoornsebergweg%208%2C%20Hellendoorn%2C%207447%20PA%2C%20Netherlands"
    pageTitle="De Uitkijk"
  />
);

export default DeUitkijk;
