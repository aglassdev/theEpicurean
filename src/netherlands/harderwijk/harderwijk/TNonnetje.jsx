...
const TNonnetje = () => (
  <RestaurantPage
    restaurantName="'t Nonnetje"
    address="Vischmarkt 38, Harderwijk, 3841 BG, Netherlands"
    cuisine="Creative, Modern French"
    priceRange="€€€€"
    phoneNumber="+31341415848"
    website="https://www.hetnonnetje.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Host Robert-Jan Nijland and chef Michel van der Kroft prove that one plus one can make three. What was once a fisherman's cottage is now one of the country's top restaurants. The decor is cosy and charming, featuring stylish clean lines, lots of glass and a dominant black aesthetic. Having been given free rein to do his own thing, the chef has come up with a unique culinary style. He can execute the classic Escoffier recipes just as well as anyone. His foie gras and smoked eel terrine served with aged balsamic vinegar and beetroot in various textures is sublime. His ravioli with Queijo da Serra da Estrela sheep's cheese is a classic of the house. He alternates his remarkable signature dishes with creations such as steamed skrei topped with melting lardo, various textures of cabbage, a vibr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vischmarkt%2038%2C%20Harderwijk%2C%203841%20BG%2C%20Netherlands"
    pageTitle="'t Nonnetje"
  />
);

export default TNonnetje;
