...
const ZoutCitroen = () => (
  <RestaurantPage
    restaurantName="Zout & Citroen"
    address="Ridderstraat 86, Oosterhout, 4902 AC, Netherlands"
    cuisine="Creative, World Cuisine"
    priceRange="€€€"
    phoneNumber="+31162450806"
    website="https://www.zoutencitroen.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Bram Helleman has a knack for elevating everyday ingredients, such as salt and lemon, and his unique combinations and preparations, create dishes with deep flavours and nuances. For instance, he uses miso mayonnaise to give his steak tartare a unusual twist. He seasons pike-perch with tandoori spices without losing the delicate flavour of the fish. These are the creative details that make his colourful dishes stand out. From the very first amuse-bouche, chef Helleman showcases his exuberant vision, which draws on influences from around the globe. With his controlled use of piquancy and oriental spices,he creates dishes that are both flavourful and intriguing. We definitely recommend his signature dish, Nectar & Ambrosia, which is a combination of foie gras, apricot, honey and truffle. To h..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ridderstraat%2086%2C%20Oosterhout%2C%204902%20AC%2C%20Netherlands"
    pageTitle="Zout & Citroen"
  />
);

export default ZoutCitroen;
