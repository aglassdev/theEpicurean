...
const WijnhuisDeBlauweCamer = () => (
  <RestaurantPage
    restaurantName="Wijnhuis De Blauwe Camer"
    address="Kloosterdreef 3, Oosterhout, 4901 PH, Netherlands"
    cuisine="French Contemporary, Creative French"
    priceRange="€€€"
    phoneNumber="+31162464673"
    website="https://www.wijnhuisdeblauwecamer.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The medieval site of St Catherine's Valley convent is an oasis of charm. The coach house has been turned into a modern restaurant, bathed in natural light and with a rustic vibe. There is also a kitchen garden and several hectares of vineyards (hence the wine barrels at the entrance). The food has just as much character as the site. Home-grown vegetables, influences from around the globe and spicy/subtly acidic details skilfully combined to create expressive dishes. Highly impressive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kloosterdreef%203%2C%20Oosterhout%2C%204901%20PH%2C%20Netherlands"
    pageTitle="Wijnhuis De Blauwe Camer"
  />
);

export default WijnhuisDeBlauweCamer;
