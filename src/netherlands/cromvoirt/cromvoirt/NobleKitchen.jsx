...
const NobleKitchen = () => (
  <RestaurantPage
    restaurantName="Noble Kitchen"
    address="Deutersestraat 39B, Cromvoirt, 5266 AW, Netherlands"
    cuisine="Modern Cuisine, Sushi"
    priceRange="€€€"
    phoneNumber="+31732034888"
    website="https://noblekitchen.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Are those UFOs on Bernardus golf course? It may look like that, but this futuristic building actually houses a beautifully designed restaurant that exudes casual luxury. The terrace overlooking the golfing greens is simply divine! Each description of the dishes on the extensive menu is more tempting than the last. You will want to try everything! Edwin Kats and his team incorporate a nod to various Asian cuisines in their dishes. Start off with a few amuse-bouches and some fabulous sushi, then continue, for instance, with succulent grilled sole elevated by orange salt and a kimchi-infused beurre blanc. Also, be sure to sample the high-quality meat – such as Wagyu A5 steak – served straight from the Robata grill. This is sophisticated and intriguing food, with subtle Eastern touches and int..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Deutersestraat%2039B%2C%20Cromvoirt%2C%205266%20AW%2C%20Netherlands"
    pageTitle="Noble Kitchen"
  />
);

export default NobleKitchen;
