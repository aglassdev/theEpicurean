...
const RestaurantDeBurgemeester = () => (
  <RestaurantPage
    restaurantName="Restaurant De Burgemeester"
    address="Raadhuisstraat 17, Linschoten, 3461 CW, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31348414040"
    website="https://www.deburgemeester.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Anne and Sander Spruijt have set up shop in the former town hall of picturesque Linschoten. The characterful building has retained its original charm and been enhanced with elegant additions. One look at the large glass-walled wine room makes it clear you have come to the right place to sample some first-rate labels. From the warm welcome to the post-dinner coffee and confectionery, you can look forward to genuine hospitality at De Burgemeester. Sander Spruijt is a technically proficient chef who loves to showcase his culinary skills – from marinating and smoking beetroots to dry-ageing beef in butter and herbs, he is a master of his craft, expertly combining textures and bold flavours. Take his succulent pike-perch, topped with a brunoise of Reypenaer cheese and a Jerusalem artichoke crea..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Raadhuisstraat%2017%2C%20Linschoten%2C%203461%20CW%2C%20Netherlands"
    pageTitle="Restaurant De Burgemeester"
  />
);

export default RestaurantDeBurgemeester;
