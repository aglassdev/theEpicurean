...
const DeLindeboomNewStyle = () => (
  <RestaurantPage
    restaurantName="De Lindeboom New Style"
    address="Burg. Janssenstraat 13, Beek, 6191 JB, Netherlands"
    cuisine="French Contemporary, International"
    priceRange="€€"
    phoneNumber="+31464371237"
    website="https://www.delindeboom.info/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's hard to resist the style of De Lindeboom on account of the charm of the building (1765), the terrace laid out at the foot of the church tower and the appealing sense of warm Limburg hospitality. And then there is the generous cuisine with which chef Jan Willem Punt has made a name for himself. He seeks inspiration in the fresh flavours of the Mediterranean and draws on international influences, but also delivers a traditional sole dish as well as various vegetarian options. Take his okonomiyaki – Japanese pancake made with spring onion and shiitake, served with sweet-and-sour pickled cucumber, tempura lotus root, Japanese mayonnaise and seaweed. This is a chef who has all it takes to delight diners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burg.%20Janssenstraat%2013%2C%20Beek%2C%206191%20JB%2C%20Netherlands"
    pageTitle="De Lindeboom New Style"
  />
);

export default DeLindeboomNewStyle;
