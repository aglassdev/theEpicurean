...
const DeGoedeGooier = () => (
  <RestaurantPage
    restaurantName="De Goede Gooier"
    address="Crailoseweg 151, Blaricum, 1261 AA, Netherlands"
    cuisine="French, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31356919304"
    website="https://www.degoedegooier.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The thatched roof and trendy yet welcoming interior are a draw in their own right. However, it's the pergola and the gorgeous terrace overlooking the heathland that steals the show. The kitchen is run by a highly skilled chef who produces French cuisine with the utmost respect. The sole meunière and pan-fried foie gras do not disappoint with their robust flavours, but the chef also has some surprises up his sleeve, such as a swordfish carpaccio finished with a spicy harissa vinaigrette. There is an appealing lunch menu, an extensive dinner menu, and they are open every day for both lunch and dinner: a firm favourite!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Crailoseweg%20151%2C%20Blaricum%2C%201261%20AA%2C%20Netherlands"
    pageTitle="De Goede Gooier"
  />
);

export default DeGoedeGooier;
