...
const DeMoerbei = () => (
  <RestaurantPage
    restaurantName="De Moerbei"
    address="Dorpsstraat 5a, Warmond, 2361 AK, Netherlands"
    cuisine="Farm to table, Modern French"
    priceRange="€€€"
    phoneNumber="+31715156898"
    website="https://www.demoerbeiwarmond.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Michael Corpel and sommelier Frank de Haas are writing a new chapter in the illustrious story of De Moerbei. In 1996, this old farmhouse was transformed into a stylish restaurant exuding elegance. From its early days to the present day, the ambition of this place has remained unchanged: to delight guests with top-quality produce, be it wine or North Sea sole. Chef Corpel takes inspiration from techniques and ingredients from all over the world, while resolutely forging his own culinary path. His meticulously crafted dishes draw on local produce, enhanced here and there by exotic touches, to showcase his love for the North Sea and the intensity of classic sauces. Turbot fried in beurre noisette, for example, is given a lift by infusing the beurre blanc with dashi and incorporating drop..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsstraat%205a%2C%20Warmond%2C%202361%20AK%2C%20Netherlands"
    pageTitle="De Moerbei"
  />
);

export default DeMoerbei;
