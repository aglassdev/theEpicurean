...
const DeNederlanden = () => (
  <RestaurantPage
    restaurantName="De Nederlanden"
    address="Duinkerken 3, Vreeland, 3633 EM, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31294232326"
    website="https://www.nederlanden.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="De Nederlanden bears its name well. The decor, the charming service and the culinary style lend this former country hotel a quintessentially Dutch atmosphere. This building has plenty of character, combining historical charm with contemporary sleekness. From your table you can either watch the chefs at work in the open kitchen or take in the delightful view of the River Vecht and the drawbridge.It is clear from the menu that Wilco Berends loves his terroir. When it comes to produce such as lamb, eel and cheese, rest assured that the chef will serve you the very best the region has to offer. Be sure to try his oyster dishes – a speciality and a great start to your meal! What follows is the result of a blend of classic expertise and contemporary playful creativity. A shining example is the s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Duinkerken%203%2C%20Vreeland%2C%203633%20EM%2C%20Netherlands"
    pageTitle="De Nederlanden"
  />
);

export default DeNederlanden;
