...
const HetSluishuys = () => (
  <RestaurantPage
    restaurantName="Het Sluishuys"
    address="Arkersluisweg 31, Nijkerk, 3861 NG, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31333002946"
    website="https://restauranthetsluishuys.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hand-cut steak tartare with fine acidity, turbot à la meunière with a beurre blanc cooked in time-honoured tradition and ravioli stuffed with oxtail: these are the kind of classic dishes for which Erik Hendriksen is renowned. At this warm and welcoming restaurant, in an idyllic location by an old lock and close to a small harbour, familiar flavours are given the attention they deserve...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arkersluisweg%2031%2C%20Nijkerk%2C%203861%20NG%2C%20Netherlands"
    pageTitle="Het Sluishuys"
  />
);

export default HetSluishuys;
