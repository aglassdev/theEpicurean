...
const DeSalentein = () => (
  <RestaurantPage
    restaurantName="De Salentein"
    address="Putterstraatweg 7, Nijkerk, 3862 RA, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31332475201"
    website="https://www.landgoeddesalentein.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Argentina and Uruguay are the main sources of inspiration for the elegant De Salentein. Not only does the menu feature the traditional cuisines of those countries, with dishes such as chimichurri and empanadas, but the restaurant even raises its own beef cattle and has its own winery in Argentina. Led by chef Rik Jansma, the kitchen team elevates robust South American flavours with a touch of sophistication. The distinctive aromas of a sea bass ceviche, for instance, are enhanced with a leche del tigre vinaigrette. Cooked to perfection over flames, the picanha is paired with a rich brown sauce. For something a little more down-to-earth, head to Bodega Portillo, housed in the same building. A Latin American adventure awaits!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Putterstraatweg%207%2C%20Nijkerk%2C%203862%20RA%2C%20Netherlands"
    pageTitle="De Salentein"
  />
);

export default DeSalentein;
