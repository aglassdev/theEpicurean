...
const Merlet = () => (
  <RestaurantPage
    restaurantName="Merlet"
    address="Duinweg 15, Schoorl, 1871 AC, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31725093644"
    website="https://www.merlet.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Merlet’s unique decor includes stunning features such as a dining room adorned with gold leaf, a moss wall behind the cosy fireplace, 3D effects and a glass wall filled with coloured sand shaped like dunes. The interior reflects the surrounding countryside, making this a fascinating setting in which to enjoy a meal.The chef likes to work with luxury ingredients which stimulate his creativity, whether he’s preparing fresh langoustine or seasonal Jerusalem artichokes. This is a chef who thinks things through, is keen to experiment and likes to combine generosity with finesse, creating complex and harmonious dishes such as perfectly cooked sweetbreads served with different vegetables and a rich jus. An intriguing dining experience from start to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Duinweg%2015%2C%20Schoorl%2C%201871%20AC%2C%20Netherlands"
    pageTitle="Merlet"
  />
);

export default Merlet;
