...
const Ode = () => (
  <RestaurantPage
    restaurantName="Ode"
    address="Markt 38, Dokkum, 9101 LS, Netherlands"
    cuisine="Country cooking"
    priceRange="€€€€"
    phoneNumber="+31519235508"
    website="https://restaurantode.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Get ready for an ode to Friesland rooted in Dutch Cuisine principles – typically 80% plant-based and 20% animal-based. A fully open kitchen with marble worktops forms the centrepiece of the elegant black-and-white interior. On this culinary stage, Liudger van der Meer and team give free rein to their creativity. A penchant for fermented flavours meets the odd international influence and meticulous preparation. An array of asparagus textures – including a vinaigrette made from the vegetable blended with pine nuts oil – pair beautifully with an eel fillet, an asparagus tube filled with a crayfish farce, saffron and marinated stem lettuce. This is a playful ode to the riches of the local terroir, presented in a compelling multi-course set menu. Take the opportunity to get to know this tranqui..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markt%2038%2C%20Dokkum%2C%209101%20LS%2C%20Netherlands"
    pageTitle="Ode"
  />
);
