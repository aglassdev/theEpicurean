...
const Witlof = () => (
  <RestaurantPage
    restaurantName="Witlof"
    address="Lage Markt 79, Nijmegen, 6511 VK, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31243224060"
    website="https://restaurantwitlof.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The view of the Waal River, the ever-cheerful hostess, glimpses of the chef at work as you pass by the kitchen on your way to use the facilities, plus the moss-covered wall and numerous paintings of fish all contribute to the welcoming atmosphere at this cosy establishment. Jurgen Eikholt lovingly prepares classic cuisine with his trademark sophisticated, often Asian-inspired touches. One example is his use of mirin in a hollandaise sauce to lend salmon and al dente vegetables a rich, subtly sweet note. Witlof only serves surprise menus, and they are definitely worthy of your confidence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lage%20Markt%2079%2C%20Nijmegen%2C%206511%20VK%2C%20Netherlands"
    pageTitle="Witlof"
  />
);

export default Witlof;
