...
const Groenewoud = () => (
  <RestaurantPage
    restaurantName="Groenewoud"
    address="Groesbeekseweg 227, Nijmegen, 6523 NW, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31243224969"
    website="https://www.restaurantgroenewoud.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few authentic decorative features remind us that despite its comfortable and even trendy feel we are in Nijmegen's second-oldest café, built in 1763! The seasoned chef presents a modern take on French cuisine, marked by generosity and moments of surprising finesse. Think jalapeño worked into a cucumber foam to give prawn tartare a spicy kick, or green beans lightly dusted with sumac in a dish featuring steak with an oxtail and red wine sauce. The familiar and the inventive go hand in hand here. At Groenewoud, the value for money is fantastic, and you can drop in any time of day for a full set menu or a single dish. What's not to love?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Groesbeekseweg%20227%2C%20Nijmegen%2C%206523%20NW%2C%20Netherlands"
    pageTitle="Groenewoud"
  />
);

export default Groenewoud;
