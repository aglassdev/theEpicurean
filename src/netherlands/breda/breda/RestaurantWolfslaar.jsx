...
const RestaurantWolfslaar = () => (
  <RestaurantPage
    restaurantName="Restaurant Wolfslaar"
    address="Wolfslaardreef 100, Breda, 4834 SP, Netherlands"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+31762014975"
    website="https://www.restaurantwolfslaar.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Wolfslaar experience begins as soon as you drive onto the magnificent estate. As you approach the former coach house, you will be struck by the natural beauty of your surroundings, which you can enjoy to the full on the terrace. The chic and elegant interior exudes a warmth that comes courtesy of luxury materials such as walnut and marble. In this enchanting setting, Maarten Camps takes you on an exciting adventure, in which each ingredient is thoughtfully prepared in a multitude of ways. He throws in Asian flavours to add depth to his creative process, for instance seasoning hand-cut beef tartare with the perfect amount of soy sauce and XO sauce, combining it with a fresh and sweet tartare of North Sea crab, oyster juice, yuzu gel and pickled celery. The sauces whipped up by chef Camp..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wolfslaardreef%20100%2C%20Breda%2C%204834%20SP%2C%20Netherlands"
    pageTitle="Restaurant Wolfslaar"
  />
);

export default RestaurantWolfslaar;
