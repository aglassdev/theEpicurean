...
const Ml = () => (
  <RestaurantPage
    restaurantName="ML"
    address="Klokhuisplein 5, Haarlem, 2011 HK, Netherlands"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+31235123910"
    website="https://www.mlinhaarlem.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="ML is a firm favourite for many a foodie. Mark and Liane Gratama's restaurant is housed in an imposing listed building in the heart of Haarlem. The modern decor blends vintage elements with chic design. The Chef’s Bar, next to the open kitchen, is the place to be if you want to watch the enthusiastic Mark Gratama at work. Each dish is a creative masterpiece, playfully combining a delightful variety of textures. His unique ingredient combinations demonstrate his willingness to experiment and push culinary boundaries. For example, he incorporates a hint of seaweed into a blueberry-based dessert and a zesty verjus sorbet. With meticulous precision, he unites the disparate flavours of seared langoustine and hearty beef sausage into a perfectly balanced dish. The finishing touch of an exquisite..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Klokhuisplein%205%2C%20Haarlem%2C%202011%20HK%2C%20Netherlands"
    pageTitle="ML"
  />
);
