...
const ManoRestaurant = () => (
  <RestaurantPage
    restaurantName="MANO Restaurant"
    address="Bakenessergracht 109, Haarlem, 2011 JV, Netherlands"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+31232025931"
    website="https://mano-restaurant.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hermanos Daniël and Kevin have been best friends since childhood. In their elegant little establishment, which has preserved the charm of this corner building, they showcase their combined experience. The food is contemporary, featuring intense sauces, an interplay of fresh and zingy flavours, and multiple international influences. Here, technically crafted creations and vigorous creativity go mano a mano...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bakenessergracht%20109%2C%20Haarlem%2C%202011%20JV%2C%20Netherlands"
    pageTitle="MANO Restaurant"
  />
);

export default ManoRestaurant;
