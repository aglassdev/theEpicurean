...
const BosqDEN = () => (
  <RestaurantPage
    restaurantName="Bosq"
    address="Bakkenweg 16, Den Hoorn, 1797 RJ, Netherlands"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+31222315541"
    website="https://www.bosq.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this restaurant is inspired by the Spanish word bosque (forest). This warm and welcoming spot stands on the edge of the National Park, affording stunning views of the lush landscape – the terrace is a real highlight! Robin Koeken combines finest local produce from Texel with Mediterranean flair and Asian nuances. His penchant for umami and barbecue notes shines through in dishes such as succulent pan-seared turbot with briny shellfish from the Wadden Sea, sweet tomatoes and a beurre blanc made with fish fumet and a judicious splash of soy sauce. His cuisine packs a punch and, thanks to the smaller-sized portions, you can sample it extensively...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bakkenweg%2016%2C%20Den%20Hoorn%2C%201797%20RJ%2C%20Netherlands"
    pageTitle="Bosq"
  />
);

export default BosqDEN;
