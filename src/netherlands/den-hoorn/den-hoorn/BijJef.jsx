...
const BijJef = () => (
  <RestaurantPage
    restaurantName="Bij Jef"
    address="Herenstraat 34, Den Hoorn, 1797 AJ, Netherlands"
    cuisine="Regional Cuisine, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31222319623"
    website="https://www.bijjef.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As soon as you step into Bij Jef, you are struck by a sense of peace and space. The minimalist interior has been specifically designed as a setting in which guests can enjoy Texel's bounty of produce – the local suckling lamb is world famous and, needless to say, also a firm fixture here. But Jef Schuur draws much more from his surroundings. Salty herbs, crustaceans and shellfish… the list goes on. Chef Schuur puts his terroir first – be sure to take a look around the impressive vegetable garden behind the restaurant – and he showcases it elegantly in contemporary-style dishes. His innovative creations often feature invigorating sweet and sour nuances. This is a chef who likes to surprise. Sauces are key: think a rich lamb jus and herb-infused oil to pair with crispy slow-roasted lamb neck..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herenstraat%2034%2C%20Den%20Hoorn%2C%201797%20AJ%2C%20Netherlands"
    pageTitle="Bij Jef"
  />
);

export default BijJef;
