...
const HendrikVanMaurick = () => (
  <RestaurantPage
    restaurantName="Hendrik van Maurick"
    address="Maurick 3, Vught, 5261 NA, Netherlands"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+31732048028"
    website="https://www.kasteel-maurick.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A visit to this medieval castle (1257) is an experience in itself. The wooded surroundings, the drawbridge, the courtyard… This is a truly romantic setting, further elevated by a gorgeous terrace overlooking the moat. Inside, all that historical character meets with modern comfort. The imposing fireplace and the portrait of the knight Van Maurick holding a smartphone immediately catch the eye. The menu may seem classical at first glance, but it features inventive dishes in which Dutch produce is given a French twist. Think North Sea crab salad with cucumber sorbet and jus, celery oil, pickled daikon and wakame. This is sophisticated, vibrant and ambitious cuisine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maurick%203%2C%20Vught%2C%205261%20NA%2C%20Netherlands"
    pageTitle="Hendrik van Maurick"
  />
);

export default HendrikVanMaurick;
