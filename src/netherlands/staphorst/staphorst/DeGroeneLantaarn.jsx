...
const DeGroeneLantaarn = () => (
  <RestaurantPage
    restaurantName="De Groene Lantaarn"
    address="Gemeenteweg 364, Staphorst, 7951 PG, Netherlands"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+31522463116"
    website="https://www.degroenelantaarn.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A dynamic duo with bags of personality, hostess Cindy Borger and chef Jarno Eggen are making their mark on the Dutch culinary landscape. They have revamped the interior of this stately building with a unique contemporary decor, incorporating the chef's own skateboards and colourful artwork. The rear terrace overlooking the vegetable garden and the windmill is simply idyllic. The chef has the freedom here to express his creative vision. The fact that he has the flour for his bread ground in that very mill is a detail that speaks volumes. Indeed, respect for the produce, which is often locally sourced, is at the heart of everything they do here. He has a knack for combining unexpected flavours and exotic seasonings, always striking the perfect balance. The chef cooks locally sourced venison ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gemeenteweg%20364%2C%20Staphorst%2C%207951%20PG%2C%20Netherlands"
    pageTitle="De Groene Lantaarn"
  />
);

export default DeGroeneLantaarn;
