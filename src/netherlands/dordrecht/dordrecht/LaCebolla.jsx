...
const LaCebolla = () => (
  <RestaurantPage
    restaurantName="La Cebolla"
    address="Nieuwstraat 60, Dordrecht, 3311 XR, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31786213772"
    website="https://www.lacebolla.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cees Timmerman is a connoisseur of fine ingredients, which he prefers to source locally, but he also embraces influences from the Mediterranean and places further afield. This is reflected in the tempting and extensive menu featuring both small plates and more elaborate dishes. His style is defined by his knack for reimagining familiar recipes, eg elevating a (whole!) turbotin with the typical sweet-and-spicy nuances of Indonesian fare, or a new take on cheesecake, paired with a refined Granny Smith sorbet and crunchy granola. This welcoming restaurant on the first floor of De Witt cinema invites you to savour authentic flavours in a laid-back atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwstraat%2060%2C%20Dordrecht%2C%203311%20XR%2C%20Netherlands"
    pageTitle="La Cebolla"
  />
);

export default LaCebolla;
