...
const BijErik = () => (
  <RestaurantPage
    restaurantName="Bij Erik"
    address="Sluisplein 11, Leidschendam, 2266 AV, Netherlands"
    cuisine="Modern French, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+31703010451"
    website="https://bijerik.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wood, metal and leather create an intimate feel, although a table on the terrace is also a good choice: the view of the lock and windmill is magnificent. Erik Tas will have diners' mouths watering with fresh combinations in which stocks and sauces lead to wonderful harmonies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sluisplein%2011%2C%20Leidschendam%2C%202266%20AV%2C%20Netherlands"
    pageTitle="Bij Erik"
  />
);

export default BijErik;
