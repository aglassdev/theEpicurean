...
const Flavours = () => (
  <RestaurantPage
    restaurantName="Flavours"
    address="Hoogstraat 28, Weert, 6001 EV, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31495451022"
    website="https://restaurantflavours.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sweet. Bitter. Salty. Sour. Umami. These five flavours are the basis of every cuisine, but what Ron Lemmens creates with them can certainly be described as unique. His precise cuissons and the depth of his sauces are testament to his expertise. His ability to bring in international influences to produce exciting creations speaks to his knowledge of flavours.For example, he pan-fries cod to perfection and harmoniously combines it with sauerkraut, cream of Jerusalem artichoke, roasted capers and lovage and, most importantly, a jus made from cod in an intensely flavoured beurre blanc. Chef Lemmens does not go in for gratuitous surprises, but resolutely opts for robust flavours. He delighted us with his langoustines, crispy pork belly and carrot with the exotic nuances of ginger, tandoori and ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hoogstraat%2028%2C%20Weert%2C%206001%20EV%2C%20Netherlands"
    pageTitle="Flavours"
  />
);
