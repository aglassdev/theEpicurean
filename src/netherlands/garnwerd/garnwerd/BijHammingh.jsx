...
const BijHammingh = () => (
  <RestaurantPage
    restaurantName="Bij Hammingh"
    address="Hunzeweg 32, Garnwerd, 9893 PC, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+31623949453"
    website="https://www.bijhammingh.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is impossible to resist the authentic charm of this former ferry house, from the terrace of which you can fully appreciate the lovely views across the canal and drawbridge. Inside, you can sense the building’s rich heritage, where the chef focuses on regional delicacies that showcase modern techniques and natural finesse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hunzeweg%2032%2C%20Garnwerd%2C%209893%20PC%2C%20Netherlands"
    pageTitle="Bij Hammingh"
  />
);

export default BijHammingh;
