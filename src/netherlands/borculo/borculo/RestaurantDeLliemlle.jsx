...
const RestaurantDeLliemlle = () => (
  <RestaurantPage
    restaurantName="Restaurant De Olliemölle"
    address="Lange Molenstraat 17, Borculo, 7271 BJ, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31545276556"
    website="https://www.olliemolle.nl/"
    aliases={["Restaurant De Ölliemölle"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Picture the scene: a table by the water, with water lilies floating nearby and an old-fashioned water wheel turning occasionally. Could it be more romantic? Rest assured that De Olliemölle is every bit as enchanting inside. Roel Sieverink has a soft spot for French cuisine and loves serving lobster straight from his lobster tank. The bisque here is full-bodied and spicy, the foie gras terrine is juicy and the veal jus with crispy sweetbreads is deliciously intense. The chef adds the odd modern twist to his classic dishes, introducing brighter flavours while maintaining the rich, hearty taste that his cuisine is known for...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Molenstraat%2017%2C%20Borculo%2C%207271%20BJ%2C%20Netherlands"
    pageTitle="Restaurant De Olliemölle"
  />
);

export default RestaurantDeLliemlle;
