...
const HuisjeJames = () => (
  <RestaurantPage
    restaurantName="Huisje James"
    address="Van Golsteinlaan 20, Ugchelen, 7339 GT, Netherlands"
    cuisine="Seasonal Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31555382470"
    website="https://www.huisjejames.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start your meal with an aperitif by the fireplace of this former workshop, after which you will be guided to the villa. The thatched roof, the intimate ambience and beautiful art give this restaurant a cosy feel. The surprise menu features classic favourites alongside contemporary surprises, all made from regional ingredients, including home-grown produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Golsteinlaan%2020%2C%20Ugchelen%2C%207339%20GT%2C%20Netherlands"
    pageTitle="Huisje James"
  />
);

export default HuisjeJames;
