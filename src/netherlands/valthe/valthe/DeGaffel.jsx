...
const DeGaffel = () => (
  <RestaurantPage
    restaurantName="De Gaffel"
    address="Odoornerweg 1, Valthe, 7872 PA, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31591513536"
    website="https://www.restaurantdegaffel.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="De Gaffel creates a wonderful dining experience under the old Saxon farm's thatched roof and around the open hearth, which fills the rustic interior with a homely feel. Outside, the chef grows his own vegetables, working with top-quality ingredients, accentuated with contemporary techniques...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Odoornerweg%201%2C%20Valthe%2C%207872%20PA%2C%20Netherlands"
    pageTitle="De Gaffel"
  />
);

export default DeGaffel;
