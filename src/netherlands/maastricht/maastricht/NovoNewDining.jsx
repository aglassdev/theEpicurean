...
const NovoNewDining = () => (
  <RestaurantPage
    restaurantName="NOVO New Dining"
    address="Aan de Brikkenbouw 4F, Maastricht, 6211 XT, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+31432041169"
    website="https://www.novo-dining.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rodny Welters has created his own little world on the fifth floor of this factory building in Maastricht's Sphinxkwartier. Rugged surfaces meet stylish upholstery here in a tasteful symbiosis. All eyes are on the open kitchen, where chef Welters lets his cooking do the talking; his culinary creations draw inspiration from around the globe, underpinned by exquisite sauces. With dishes such as haddock à la meunière with a tandoori velouté or fried scampi with a red curry and coconut milk sauce, the Experience set menu certainly lives up to its name...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aan%20de%20Brikkenbouw%204F%2C%20Maastricht%2C%206211%20XT%2C%20Netherlands"
    pageTitle="NOVO New Dining"
  />
);

export default NovoNewDining;
