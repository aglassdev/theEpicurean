...
const CafSjiek = () => (
  <RestaurantPage
    restaurantName="Café Sjiek"
    address="Sint Pieterstraat 13, Maastricht, 6211 JM, Netherlands"
    cuisine="Traditional Cuisine, Classic French"
    priceRange="€€"
    phoneNumber="+31433210158"
    website="https://www.cafesjiek.nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Café Sjiek has been a second home to Maastricht's foodies since 1982. They come for the lively atmosphere, the gorgeous terrace and the chance to have a cosy chat with fellow diners sitting at the counter. The cuisine is distinctly French with a Limburg twist – reflected not just in the flavours but in the menu's playful nods to regional dialect. Think crab cocktail with avocado and jalapeño foam, a sumptuous vol-au-vent with cave-grown mushrooms, or crispy mille-feuille with crème pâtissière and raspberry: this cuisine is familiar, comforting and addictive. It doesn't get more indulgent than this! Be sure to arrive early as reservations are not accepted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sint%20Pieterstraat%2013%2C%20Maastricht%2C%206211%20JM%2C%20Netherlands"
    pageTitle="Café Sjiek"
  />
);

export default CafSjiek;
