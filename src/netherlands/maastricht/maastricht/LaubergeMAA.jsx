...
const LaubergeMAA = () => (
  <RestaurantPage
    ...
    address="Von Dopfflaan 10, Maastricht, 6213 NG, Netherlands"
    cuisine="Classic Cuisine, French"
    priceRange="€€"
    phoneNumber="+31433251359"
    website="https://www.oostwegelcollection.nl/chateau-neercanne/restaurants/lauberge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come for lunch beneath the vaults of Château Neercanne's old chapel – you cannot fail to be impressed by this charming historical setting that has been given a stylish makeover. The terrace affords spectacular views. The chef serves up his own modern spin on classic dishes, with a focus on quality. Delicious produce is sourced from the region and their own kitchen garden. Cod poached in butter with a delicate white wine sauce, a traditionally prepared rich tarte Tatin: food lovers will be in seventh heaven...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Von%20Dopfflaan%2010%2C%20Maastricht%2C%206213%20NG%2C%20Netherlands"
    pageTitle="L'Auberge"
  />
);

export default LaubergeMAA;
