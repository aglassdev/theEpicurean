...
const PrixDeRome = () => (
  <RestaurantPage
    restaurantName="Prix de Rome"
    address="Susserweg 1, Maastricht, 6213 NE, Netherlands"
    cuisine="Contemporary, Modern French"
    priceRange="€€"
    phoneNumber="+31438080233"
    website="https://www.prix-de-rome.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As far as Maastricht foodies are concerned, all roads lead to Prix de Rome. Inside this impressive building just outside the city centre, a cosy interior awaits, in which exposed beams are seamlessly integrated into the modern design of the place. The view into the open kitchen at the back is a nice touch, and the terrace is a must on sunny days. Chef Wouter alternates between inventive, elaborately prepared creations and more ingredient-led dishes. For example, he pairs lobster with the exotic nuances of mango and a tom kha kai sauce, then he serves up medium-rare saddle of venison with a robust game sauce. Familiar flavours and innovative ideas go hand in hand in the outstanding set menu!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Susserweg%201%2C%20Maastricht%2C%206213%20NE%2C%20Netherlands"
    pageTitle="Prix de Rome"
  />
);

export default PrixDeRome;
