...
const Haricot = () => (
  <RestaurantPage
    restaurantName="Haricot."
    address="Rechtstraat 88A, Maastricht, 6211 EL, Netherlands"
    cuisine="Modern Cuisine, Modern French"
    priceRange="€€€"
    phoneNumber="+31433272233"
    website="https://haricotmaastricht.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Haricot is a venture started by three friends. Having worked together at De Librije, they have now set up shop in the heart of Maastricht. In a cosy wood-panelled restaurant with a French feel, diners are served a single set menu in which the chefs demonstrate their mastery of the art of omission. Their dishes are accessible but incorporate contrasts and vibrant twists. Our inspectors were particularly taken with the pearly white skrei ballotine with sautéed and marinated oyster mushroom and deep-fried kale, finished with a spicy beurre blanc emulsion for added character. A real treat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rechtstraat%2088A%2C%20Maastricht%2C%206211%20EL%2C%20Netherlands"
    pageTitle="Haricot."
  />
);

export default Haricot;
