...
const AlmaBodega = () => (
  <RestaurantPage
    restaurantName="Alma Bodega"
    address="De Lind 45A, Oisterwijk, 5061 HT, Netherlands"
    cuisine="Seasonal Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+31132032004"
    website="https://www.alma.nl/bodega"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The more down-to-earth little brother of MICHELIN-starred Alma has its own personality. Chic marble and stylish design give this laid-back restaurant flair. You can drop in any time of day to indulge in a fresh take on familiar flavours. The menu features a variety of dishes that will tempt your taste buds, including gyoza, köfte, pâté en croûte, perfectly done entrecôte with a delicious veal jus, rum baba and more. The skilfully prepared and generously flavoured dishes never fail to impress. The wine list always includes some exciting finds. Be sure to make your reservation in good time to avoid disappointment!..."
    ...
    pageTitle="Alma Bodega"
  />
);

export default AlmaBodega;
