...
const AlmaOIS = () => (
  <RestaurantPage
    restaurantName="Alma"
    address="De Lind 45a, Oisterwijk, 5061 HT, Netherlands"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+31132032004"
    website="https://www.alma.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A potted history of the location that now houses Alma: it was once home to De Swaen, the restaurant where renowned chef Cas Spijkers, among others, was awarded one and then two MICHELIN stars. Today, Wouter van Laarhoven is upholding the restaurant's tradition of excellence. On the ground floor you will find the Bib Gourmand-awarded Alma Bodega, and fine dining restaurant Alma is on the first floor – a modern and elegant establishment with a fabulous terrace overlooking De Lind. Chef Van Laarhoven puts his heart and soul (alma in Spanish) into his dishes, combining inventiveness with technical skill. Authentic finesse lends a sense of coherence, while playful ideas breathe life into the dishes. In Mexico, for example, he got the idea of incorporating chicatana ants into beurre blanc, addin..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=De%20Lind%2045a%2C%20Oisterwijk%2C%205061%20HT%2C%20Netherlands"
    pageTitle="Alma"
  />
);

export default AlmaOIS;
