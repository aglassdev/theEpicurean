...
const DeSchansByMikeWes = () => (
  <RestaurantPage
    restaurantName="De Schans by Mike & Wes"
    address="Willeskop 87, Montfoort, 3417 MC, Netherlands"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+31348562309"
    website="https://restaurantdeschans.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When they took over De Schans, Mike and Wes, respectively sommelier and chef, added a trendier, more relaxed vibe, whilst retaining the establishment’s commitment to fine food and wine. The chef crafts dishes in tune with the zeitgeist using cutting-edge culinary techniques to create a subtle blend of textures and unexpected flavours. The set menu is definitely worth sampling!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Willeskop%2087%2C%20Montfoort%2C%203417%20MC%2C%20Netherlands"
    pageTitle="De Schans by Mike & Wes"
  />
);

export default DeSchansByMikeWes;
