...
const PietersRestaurant = () => (
  <RestaurantPage
    restaurantName="Pieters Restaurant"
    address="Hoofdstraat 73, Bergambacht, 2861 AL, Netherlands"
    cuisine="Modern French, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+31182355750"
    website="https://www.pietersrestaurant.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dining at Pieter and Paula's cheerful restaurant feels a bit like coming home. The welcoming interior is the perfect setting for culinary indulgence, and the hospitality truly comes from the heart. Chef Pieter brings a wealth of experience and a keen intuition to his cooking. No frills – just pure classical finesse, expertly executed and spiced up with a dash of playful originality. For instance, he drizzles a succulent fillet of sea bass with a light white wine sauce with a little oyster liquor added to give it a gentle tang. An intense fish broth and spiced focaccia make this hearty dish complete. This cuisine is down to earth and features harmonious combinations and top-quality ingredients – you might even be tempted to lick your plate clean! The range of French and Italian wines certai..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hoofdstraat%2073%2C%20Bergambacht%2C%202861%20AL%2C%20Netherlands"
    pageTitle="Pieters Restaurant"
  />
);

export default PietersRestaurant;
