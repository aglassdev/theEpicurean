...
const Pouwe = () => (
  <RestaurantPage
    restaurantName="Pouwe"
    address="Bovenstraat 4, Hoeven, 4741 AV, Netherlands"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+31165854008"
    website="https://www.restaurantpouwe.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Walter and Vivian Pouwe bring flavours from around the globe to the sleepy town of Hoeven. In their modern lounge-style restaurant, ingredients such as yuzu, tandoori spices and vadouvan are incorporated into creative dishes that pack a punch. For instance, bavette steak really comes into its own in a Mediterranean concoction featuring an interplay with pesto and aubergine caviar. Be sure to sample the enticing cheese trolley – an unconventional selection of international cheeses that the chef presents with great enthusiasm. A Bib Gourmand restaurant with a cosmopolitan twist!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bovenstraat%204%2C%20Hoeven%2C%204741%20AV%2C%20Netherlands"
    pageTitle="Pouwe"
  />
);

export default Pouwe;
