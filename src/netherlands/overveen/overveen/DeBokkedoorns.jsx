...
const DeBokkedoorns = () => (
  <RestaurantPage
    restaurantName="De Bokkedoorns"
    address="Zeeweg 53, Overveen, 2051 EB, Netherlands"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+31235263600"
    website="https://www.bokkedoorns.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A veritable culinary institution, De Bokkedoorns was established in 1961 and has held on to its two MICHELIN stars for the past 30 years. Owner Pascal Beeren, who represents the third generation of this family to run the restaurant, likes to personally give his diners a warm welcome. Modern luxury meets plush comfort in this inviting space, where stunning views of the surrounding natural beauty evoke a sense of serenity. Roy Eijkelkamp is also a stalwart of the restaurant, having worked here under the tutelage of Lucas Rive, who taught him the art of bringing intensity and depth to sauces – remember to save some bread so you can mop up every last drop! This chef champions a minimalist cooking style, creating unfussy dishes by preparing the finest ingredients in time-honoured tradition. Sli..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zeeweg%2053%2C%20Overveen%2C%202051%20EB%2C%20Netherlands"
    pageTitle="De Bokkedoorns"
  />
);

export default DeBokkedoorns;
