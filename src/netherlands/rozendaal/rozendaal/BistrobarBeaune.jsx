...
const BistrobarBeaune = () => (
  <RestaurantPage
    restaurantName="Bistrobar Beaune"
    address="Beekhuizenseweg 1, Rozendaal, 6891 CZ, Netherlands"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+31267200922"
    website="https://www.bistrobarbeaune.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The magnificent Rosendael Castle houses this fashionable upscale bistro that affords views over the delightful surrounding grounds. This is a seriously cool bistro bar! The wide-ranging menu proposes a range of appealing entrées served in modest portions that diners will find hard to resist. Vegetarian options, a classic cod dish, meat specialities, the house version of an eclair for dessert… You'll be spoilt for choice!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beekhuizenseweg%201%2C%20Rozendaal%2C%206891%20CZ%2C%20Netherlands"
    pageTitle="Bistrobar Beaune"
  />
);

export default BistrobarBeaune;
