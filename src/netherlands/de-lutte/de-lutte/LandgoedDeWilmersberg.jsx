...
const LandgoedDeWilmersberg = () => (
  <RestaurantPage
    restaurantName="Landgoed de Wilmersberg"
    address="Rhododendronlaan 7, De Lutte, 7587 NL, Netherlands"
    cuisine="Modern Cuisine, Organic"
    priceRange="€€"
    phoneNumber="+31541585555"
    website="https://www.wilmersberg.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Landgoed de Wilmersberg nature takes centre stage, beginning with a wonderful view of the landscape of Twente, both on the terrace and in the charming dining room. The chef makes vegetables the focus in his modern dishes. He is bold enough to present the occasional challenging combination, always applying the correct techniques...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rhododendronlaan%207%2C%20De%20Lutte%2C%207587%20NL%2C%20Netherlands"
    pageTitle="Landgoed de Wilmersberg"
  />
);

export default LandgoedDeWilmersberg;
