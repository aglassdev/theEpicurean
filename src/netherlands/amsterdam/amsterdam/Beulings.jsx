...
const Beulings = () => (
  <RestaurantPage
    restaurantName="Beulings"
    address="Beulingstraat 9, Amsterdam, 1017 BA, Netherlands"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+31203206100"
    website="https://www.beulings.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beulings is a little gem full of atmosphere. Lisja offers guests a warm welcome, and is also in charge of the excellent wines, while Bas and his team create delicious meals in the open kitchen. They put a lot of effort into the preparation of their dishes, which are full of versatile textures and carefully thought-out flavours. A delightful experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beulingstraat%209%2C%20Amsterdam%2C%201017%20BA%2C%20Netherlands"
    pageTitle="Beulings"
  />
);

export default Beulings;
