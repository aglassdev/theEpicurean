...
const Bougainville = () => (
  <RestaurantPage
    restaurantName="Bougainville"
    address="Dam 27, Amsterdam, 1012 JS, Netherlands"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+31202182180"
    website="https://restaurantbougainville.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Bougainville is Hotel TwentySeven's upscale restaurant. Warm fabrics, luxurious design and bronze tones come together in a setting that is intimate and romantic. The contrast with the features of this historical building is indeed something to behold, and the magnificent view of Dam Square is equally remarkable. Tim Golsteijn's cuisine is in keeping with the sophisticated surroundings. He marries flavours from East and West with a creativity all his own. For this chef, technical skill and culinary instinct go hand in hand. He effortlessly balances the intensity of ingredients such as Thai green curry and za'atar with delicate French aromas. Chef Golsteijn does not shy away from daring combinations, but always ensures that the flavours enhance each other. For instance, he bastes succulent p..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dam%2027%2C%20Amsterdam%2C%201012%20JS%2C%20Netherlands"
    pageTitle="Bougainville"
  />
);

export default Bougainville;
