...
const Spectrum = () => (
  <RestaurantPage
    restaurantName="Spectrum"
    address="Herengracht 542, Amsterdam, 1017 CG, Netherlands"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+31207184635"
    website="https://www.restaurantspectrum.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sidney Schutte produces an astonishing range of flavours. At De Librije, he developed his own inventive culinary style, and at Amber (in Hong Kong) he mastered the sophisticated techniques particular to Asian cuisine. His food looks as spectacular as it tastes – exciting and colourful with a unique interplay of textures. First-class Dutch produce and international seasonings come together here in complex dishes. The technically gifted chef does not shy away from contrasts, and he is certainly an innovator rather than an imitator! This goes for his vegetarian set menu as well as his fish and meat creations. The vibrant red wine and magnolia reduction, for instance, creates a burst of fruity and tangy flavours to complement a perfectly cooked lobster medallion and scallops; the cream of blac..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herengracht%20542%2C%20Amsterdam%2C%201017%20CG%2C%20Netherlands"
    pageTitle="Spectrum"
  />
);
