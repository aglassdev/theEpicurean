...
const BrasserieVanBaerle = () => (
  <RestaurantPage
    restaurantName="Brasserie van Baerle"
    address="Van Baerlestraat 158, Amsterdam, 1071 BG, Netherlands"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+31206791532"
    website="https://brasserievanbaerle.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is no getting around it: wine is part of the core business of this elegant, ever-inviting luxury brasserie. The impressive selection of wines by the glass and extensive drinks menu will impress even the most seasoned connoisseur. Classics from the brasserie repertoire are served up here with great attention to detail and a sense of generosity. The steak tartare is a real crowd pleaser...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Baerlestraat%20158%2C%20Amsterdam%2C%201071%20BG%2C%20Netherlands"
    pageTitle="Brasserie van Baerle"
  />
);

export default BrasserieVanBaerle;
