...
const KaagmanKortekaas = () => (
  <RestaurantPage
    restaurantName="Kaagman & Kortekaas"
    address="Sint Nicolaasstraat 43, Amsterdam, 1012 NJ, Netherlands"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+31202336544"
    website="https://kaagmanenkortekaas.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Giel Kaagman and Bram Kortekaas have clearly chosen to focus on quality in their lively bistro, where the chef enjoys working with vegetables, wild game and fish, transforming these ingredients into exciting dishes which are striking for their contrasting flavours. Both the menu, which changes regularly, and the wine list are full of surprises!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sint%20Nicolaasstraat%2043%2C%20Amsterdam%2C%201012%20NJ%2C%20Netherlands"
    pageTitle="Kaagman & Kortekaas"
  />
);

export default KaagmanKortekaas;
