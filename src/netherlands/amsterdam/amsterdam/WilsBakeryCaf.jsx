...
const WilsBakeryCaf = () => (
  <RestaurantPage
    restaurantName="Wils Bakery Café"
    address="Stadionplein 24, Amsterdam, 1076 CM, Netherlands"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+31202366521"
    website="https://www.wilsbakerycafe.nl/wbchome"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this spacious establishment in Amsterdam's Move building, the bakery and bistro flow seamlessly into one another. While bread dough is kneaded on one side, the open kitchen a little further on provides liveliness and rhythm. The interior is warm and contemporary, with wooden tables, soft benches and vintage accents. The kitchen combines French classics with global influences. For example, beef tartare is given extra depth by the addition of soy, miso and herring roe. Maitake mushrooms, Jerusalem artichokes and a powerful sauce made from porcini mushrooms add character to sea bass. At the informal Wils Bakery Café, you will find an inspired, refined cuisine. And all this for excellent value for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stadionplein%2024%2C%20Amsterdam%2C%201076%20CM%2C%20Netherlands"
    pageTitle="Wils Bakery Café"
  />
);

export default WilsBakeryCaf;
