...
const RonGastrobar = () => (
  <RestaurantPage
    restaurantName="Ron Gastrobar"
    address="Sophialaan 55, Amsterdam, 1075 BP, Netherlands"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+31204961943"
    website="https://rongastrobar.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Ron Blaauw can safely be called a culinary mastermind. In 2013, the popular chef transformed his two-Michelin-star restaurant into this accessible gastrobar and immediately made it a success. The establishment is urban, colourful and hip. Even a visit to the toilet is an experience here – football commentary can be heard in the men's room, while the ladies are treated to jokes. Chef Blaauw has created different vibes in which you can discover his relaxed gastronomy. There is no room for frills in this gastrobar, but all the more for original combinations and distinctive flavours. Here you can enjoy inventive simplicity. Smart, refined, distinctive. Think, for example, of a rosé-cooked pigeon fillet “en croûte” with a slice of goose liver, accompanied by grilled spring onion and a sauce bas..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sophialaan%2055%2C%20Amsterdam%2C%201075%20BP%2C%20Netherlands"
    pageTitle="Ron Gastrobar"
  />
);

export default RonGastrobar;
