...
const TheWhiteRoomByJacobJanBoerma = () => (
  <RestaurantPage
    restaurantName="The White Room by Jacob Jan Boerma"
    address="Dam 9, Amsterdam, 1012 JS, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+31205549454"
    website="https://www.restaurantthewhiteroom.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Contemporary design and classical elegance merge harmoniously in this dining space, which dates back to 1885 and is part of the Anantara Grand Hotel Krasnapolsky Amsterdam. The touches of gold in the decor create a sense of luxury. One can almost imagine an Austrian princess walking in at any moment. In this exclusive setting, the talented chef takes you on what will at times be a real adventure. You will immediately notice the use of fresh citrus, exotic spices and produce grown on Dutch soil. Expect vibrant, occasionally daring flavours. The young chef incorporates all this into imaginative dishes that showcase his technical prowess. Just like his team, he likes to come to the table to talk you through his creations. Think perfectly pink-roasted dry-aged lamb accompanied by a patiently r..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dam%209%2C%20Amsterdam%2C%201012%20JS%2C%20Netherlands"
    pageTitle="The White Room by Jacob Jan Boerma"
  />
);

export default TheWhiteRoomByJacobJanBoerma;
