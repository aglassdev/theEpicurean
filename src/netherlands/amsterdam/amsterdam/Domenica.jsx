...
const Domenica = () => (
  <RestaurantPage
    restaurantName="Domenica"
    address="Noordermarkt 7, Amsterdam, 1015 MV, Netherlands"
    cuisine="Mediterranean Cuisine, Italian"
    priceRange="€€€"
    phoneNumber="+31207746720"
    website="https://www.restaurantdomenica.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Domenica is the place to come to experience the bustling Jordaan neighbourhood. Whether you are dining outside on the terrace or inside at the bar of this modern bistro, there is always a lively atmosphere here. Authentic Italian seasonal dishes are served up with great skill and a proper sense of generosity. Think octopus with crispy skin and tender meat served alongside robust bell pepper and broccoletti. Owner Flavio pays tribute to his heritage with every vibrant plate. Be sure to check out his French and Italian wine selections too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Noordermarkt%207%2C%20Amsterdam%2C%201015%20MV%2C%20Netherlands"
    pageTitle="Domenica"
  />
);
