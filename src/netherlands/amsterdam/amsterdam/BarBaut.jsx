...
const BarBaut = () => (
  <RestaurantPage
    restaurantName="Bar BAUT"
    address="Stadionweg 320, Amsterdam, 1076 PK, Netherlands"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+31202103321"
    website="https://barbaut.amsterdam/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its Banksy-style frescoes, trendy, intimate interior and delightfully relaxed ambience, Bar BAUT is a must in Amsterdam, where guests can choose from the enticing à la carte featuring international ingredients cooked in contemporary style. Enjoy intense flavours, well-prepared produce and original ideas – plus excellent value for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stadionweg%20320%2C%20Amsterdam%2C%201076%20PK%2C%20Netherlands"
    pageTitle="Bar BAUT"
  />
);

export default BarBaut;
