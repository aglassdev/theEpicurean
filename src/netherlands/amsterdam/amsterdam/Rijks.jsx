...
const Rijks = () => (
  <RestaurantPage
    restaurantName="RIJKS®"
    address="Museumstraat 2, Amsterdam, 1077 XX, Netherlands"
    cuisine="Creative, Modern French"
    priceRange="€€€€"
    phoneNumber="+31206747555"
    website="https://www.rijksrestaurant.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Joris Bijdendijk has put the Rijksmuseum's gem of a restaurant on the map with his highly personal culinary approach, working predominantly with homegrown vegetables spiced with the exotic influences that characterise Dutch cuisine. He whisks his diners away on a unique culinary adventure. Having been completely revamped and done out in natural materials, the interior has a warm feel and creates an even more immersive experience. RIJKS® is a reflection of the bustling city of Amsterdam. The sophistication of the well-considered dishes is immediately striking. With one mind-blowing idea after another, this is captivating and intriguing cuisine. Take his signature dish, which features a millefeuille made of slivers of beetroot, which is beautifully earthy and slightly sweet, finished with a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Museumstraat%202%2C%20Amsterdam%2C%201077%20XX%2C%20Netherlands"
    pageTitle="RIJKS®"
  />
);
