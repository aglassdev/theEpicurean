...
const WolfAtelier = () => (
  <RestaurantPage
    restaurantName="Wolf Atelier"
    address="Westerdoksplein 20, Amsterdam, 1013 AZ, Netherlands"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+31203446402"
    website="https://www.wolfatelier.nl/nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Michael Wolf likes to experiment with sophisticated flavours and surprising ideas, giving diners the opportunity to test them out and then refining them to retain their best features. He is just as happy to cook up a turnip-based vegetarian take on Beef Wellington as he is to concoct surf and turf combinations that put a new spin on familiar flavours. The name Atelier is therefore particularly appropriate in this trendy, industrial-style restaurant, which is located on an old railway bridge with a beautiful view of the IJ...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Westerdoksplein%2020%2C%20Amsterdam%2C%201013%20AZ%2C%20Netherlands"
    pageTitle="Wolf Atelier"
  />
);

export default WolfAtelier;
