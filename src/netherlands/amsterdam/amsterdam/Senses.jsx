...
const Senses = () => (
  <RestaurantPage
    restaurantName="Senses"
    address="Vijzelstraat 45, Amsterdam, 1017 HE, Netherlands"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+31205306266"
    website="https://www.sensesrestaurant.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Indulge your palate at Senses, where the cuisine brims with vibrant Asian flavours, invigorating acidity, and showcases a mastery of both classic and new techniques. Prepare to be captivated by the imaginative and daring flavours. The enthusiastic team behind this graceful restaurant leaves nothing to chance. The sophisticated atmosphere and fine wines are the icing on the cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vijzelstraat%2045%2C%20Amsterdam%2C%201017%20HE%2C%20Netherlands"
    pageTitle="Senses"
  />
);
