...
const FaPekelhaaring = () => (
  <RestaurantPage
    restaurantName="Fa. Pekelhaaring"
    address="Van Woustraat 127, Amsterdam, 1074 AH, Netherlands"
    cuisine="Farm to table, Italian"
    priceRange="€€"
    phoneNumber="+31206790460"
    website="https://www.pekelhaaring.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to the urban canteen of many Amsterdammers. Behind the façade of this corner building lies an eclectic and characterful interior full of art and a relaxed atmosphere. The cuisine has Italian flair, but cannot be pigeonholed. Think of it more as a creative mix with Dutch influences. Like the al dente tagliatelle with creamy venison stew, rich in flavour and beautifully balanced by the addition of gremolata. Or an entrecôte that has been given the full smoky flavour of the Big Green Egg, accompanied by Parmesan cheese and rocket. Fa. Pekelhaaring stands for simplicity with substance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Woustraat%20127%2C%20Amsterdam%2C%201074%20AH%2C%20Netherlands"
    pageTitle="Fa. Pekelhaaring"
  />
);

export default FaPekelhaaring;
