...
const Arles = () => (
  <RestaurantPage
    restaurantName="Arles"
    address="Govert Flinckstraat 251, Amsterdam, 1073 BX, Netherlands"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+31206798240"
    website="https://www.arles-amsterdam.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arles brings Provence to Amsterdam. The prints on the walls of this bustling little bistro hark back to the hometown of the chef, who also shares his love of jazz music here (get a table in the dining room at the front if you prefer a quieter space). His culinary style is neo-bistro – a fresh take on the familiar flavours of French cuisine. Think the earthy flavour of beef cheeks cooked in red wine with buttery carrots or a new take on rice pudding. The set menu changes monthly and offers unbeatable value for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Govert%20Flinckstraat%20251%2C%20Amsterdam%2C%201073%20BX%2C%20Netherlands"
    pageTitle="Arles"
  />
);

export default Arles;
