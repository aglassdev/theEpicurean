...
const R21 = () => (
  <RestaurantPage
    restaurantName="R21"
    address="Peperstraat 23, Amsterdam, 1011 TJ, Netherlands"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+31207300066"
    website="https://www.r21.amsterdam"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start off with an aperitif at the marble counter, before being greeted by the chefs in the kitchen on your way to one of the dining areas, all of which exude a certain Scandinavian elegance. Having long worked with Sergio Herman, Orlando David has developed a vibrant style of cooking. Take, for example, his asparagus, briefly seared to lend it extra flavour, pepped up with wild garlic flowers, and served with a beurre blanc made from fermented asparagus and wild garlic oil to round off the dish with refinement. The sommelier has a keen understanding of the cuisine and complements it with judicious wine pairings. R21 delivers an exciting and creative culinary experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Peperstraat%2023%2C%20Amsterdam%2C%201011%20TJ%2C%20Netherlands"
    pageTitle="R21"
  />
);
