...
const Wils = () => (
  <RestaurantPage
    restaurantName="Wils"
    address="Stadionplein 26, Amsterdam, 1076 CM, Netherlands"
    cuisine="World Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+31202366522"
    website="https://www.restaurantwils.nl/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stadionplein%2026%2C%20Amsterdam%2C%201076%20CM%2C%20Netherlands"
    pageTitle="Wils"
  />
);
