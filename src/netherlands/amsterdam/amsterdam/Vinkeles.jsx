...
const Vinkeles = () => (
  <RestaurantPage
    restaurantName="Vinkeles"
    address="Keizersgracht 384, Amsterdam, 1016 GB, Netherlands"
    cuisine="Creative, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+31205302010"
    website="https://www.vinkeles.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Jurgen van der Zalm has made the kitchen at Vinkeles his own. Having spent years here as a sous-chef, honing his classic culinary skills, he now charts his own course, without breaking with the house style: premium-quality ingredients and complex sauces are still the name of the game. For instance, he glazes ultra-fresh turbot with garlic and pairs it with textures of artichoke, mustard seeds and a potato millefeuille. What truly takes the dish to the next level is the smoked lime sauce underpinned by a robust fish fumet. Chef Van der Zalm is a master saucier, who combines a playful approach to international influences, bold innovation and a respect for tradition in his highly personal creations. In what was once the bakery of this 18C Roman Catholic almshouse, the original wood and stone ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Keizersgracht%20384%2C%20Amsterdam%2C%201016%20GB%2C%20Netherlands"
    pageTitle="Vinkeles"
  />
);

export default Vinkeles;
