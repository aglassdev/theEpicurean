...
const Scheepskameel = () => (
  <RestaurantPage
    restaurantName="Scheepskameel"
    address="Kattenburgerstraat 7, gebouw 24, Amsterdam, 1018 JA, Netherlands"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+31203379680"
    website="https://scheepskameel.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Scheepskameel is a lively, relaxed establishment, providing honest, straightforward food. Everything here starts with top-quality ingredients, prepared without fuss and beautifully seasoned. The wine list is comprised entirely of German wines and accompanies the food perfectly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kattenburgerstraat%207%2C%20gebouw%2024%2C%20Amsterdam%2C%201018%20JA%2C%20Netherlands"
    pageTitle="Scheepskameel"
  />
);

export default Scheepskameel;
