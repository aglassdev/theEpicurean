...
const Cue = () => (
  <RestaurantPage
    restaurantName="CUE"
    address="Utrechtsestraat 30A, Amsterdam, 1017 VN, Netherlands"
    cuisine="Creative, Farm to table"
    priceRange="€€€€"
    phoneNumber="+31202051332"
    website="https://www.cue-amsterdam.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="George Kataras is a chef with a style all of his own. He creatively combines smoky nuances from the grill and barbecue, vibrant fermented flavours and a distinctive Nordic-style subtlety. Three to four elements are all he needs to create surprising dishes. Think succulent barbecued dry-aged sea bass topped with powdered Sichuan pepper, bergamot zest and a rich sauce based on fermented asparagus and the fish's bones. The set menu – you choose between a short or long version – is an immersive experience complemented by outstanding pairings courtesy of a sommelier with a penchant for natural wines. The vintage feel of the setting carries through to the listening bar in the cellar – enjoy a cocktail and some light bites as the DJ provides the musical backdrop...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Utrechtsestraat%2030A%2C%20Amsterdam%2C%201017%20VN%2C%20Netherlands"
    pageTitle="CUE"
  />
);
