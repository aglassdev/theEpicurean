...
const DeMark = () => (
  <RestaurantPage
    restaurantName="De Mark"
    address="Durgerdammerdijk 73, Amsterdam, 1026 CB, Netherlands"
    cuisine="Creative French"
    priceRange="€€"
    phoneNumber="+31202184463"
    website="https://www.restaurantdemark.com/nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Leave your car outside Durgerdam and embrace the charm of this dike village as you walk to De Mark. From the terrace, you have an exceptional view over the water – simply breathtaking! The attractive interior is done out in natural tones and makes the most of the character of the building. Dinner here is a cosy affair. Each dish revolves around three main ingredients, cooked over the wood fire. Think textures of onion – from crisp and crunchy to sweet and grilled – elevated with a Zaandam mustard ice cream. The experienced chefs offer a fresh perspective on natural flavours. If you really want to explore the extensive wine list, luxurious guestrooms are available on the first floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Durgerdammerdijk%2073%2C%20Amsterdam%2C%201026%20CB%2C%20Netherlands"
    pageTitle="De Mark"
  />
);
