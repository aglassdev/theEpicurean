...
const Watergang = () => (
  <RestaurantPage
    restaurantName="Watergang"
    address="Weteringstraat 41, Amsterdam, 1017 SM, Netherlands"
    cuisine="European Contemporary"
    priceRange="€€"
    phoneNumber="+31638678170"
    website="https://restaurantwatergang.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely little restaurant with space for just 30 guests boasts a genuine warmth and intimacy. The chefs here create a surprise five-course menu that changes each month and is particularly inspired by French and Italian cuisine. The classic comfort food on offer here, featuring the occasional original twist, is highly satisfying!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weteringstraat%2041%2C%20Amsterdam%2C%201017%20SM%2C%20Netherlands"
    pageTitle="Watergang"
  />
);

export default Watergang;
