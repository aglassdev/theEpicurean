...
const Escobar = () => (
  <RestaurantPage
    ...
    address="Spuiplein 15, Breskens, 4511 AN, Netherlands"
    cuisine="Mediterranean Cuisine, Spanish"
    priceRange="€€"
    phoneNumber="+31117851059"
    website="https://www.escobarbreskens.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This colourful restaurant has a real holiday feel, with its lively Spanish ambience and friendly, enthusiastic staff. The menu features a wide selection of dishes, from well-known tapas to more unusual and less conventional options. An excellent restaurant in which to enjoy a Spanish meal with friends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Spuiplein%2015%2C%20Breskens%2C%204511%20AN%2C%20Netherlands"
    pageTitle="Escobar"
  />
);
