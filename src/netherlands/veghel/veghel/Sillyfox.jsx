...
const Sillyfox = () => (
  <RestaurantPage
    restaurantName="Sillyfox"
    address="Verlengde Noordkade 10, Veghel, 5462 EC, Netherlands"
    cuisine="Modern Cuisine, Asian Influences"
    priceRange="€€€"
    phoneNumber="+31413782182"
    website="https://www.sillyfox.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located at the top of a converted grain-processing plant, this delightful space combines a raw, industrial aesthetic with modern design elements. It also boasts a roof terrace affording panoramic views of the surrounding landscape. With years of experience, Joppe Sprinkhuizen meticulously crafts each dish, blending timeless French cooking techniques with international influences. For example, the entrecôte, cooked rare, is served with a bitterbal (Dutch meatball) filled with rendang, alongside beans cooked in red curry and lemongrass, plus a peanut cream and a red berry cream providing sweet and fruity nuances. The set menus are fantastic, although an appealing à la carte selection is also available in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Verlengde%20Noordkade%2010%2C%20Veghel%2C%205462%20EC%2C%20Netherlands"
    pageTitle="Sillyfox"
  />
);

export default Sillyfox;
