...
const InDeOudeStempel = () => (
  <RestaurantPage
    restaurantName="In de Oude Stempel"
    address="Kaaistraat 19, Steenbergen, 4651 BL, Netherlands"
    cuisine="Country cooking, Creative"
    priceRange="€€€"
    phoneNumber="+31167567381"
    website="https://indeoudestempel.nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this former post office, stamps and letters have made way for the on-trend cuisine of Mark van Loon. This is a chef who doesn't hesitate to play with textures or bring bold combinations to the table. His creativity is complemented by his prowess in the art of making sauces – think a rich game jus to accompany the venison fillet. For something more low key, head to Puur, the brasserie next door...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kaaistraat%2019%2C%20Steenbergen%2C%204651%20BL%2C%20Netherlands"
    pageTitle="In de Oude Stempel"
  />
);

export default InDeOudeStempel;
