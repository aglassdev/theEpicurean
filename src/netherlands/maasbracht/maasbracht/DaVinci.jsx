...
const DaVinci = () => (
  <RestaurantPage
    restaurantName="Da Vinci"
    address="Havenstraat 27, Maasbracht, 6051 CS, Netherlands"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+31475465979"
    website="https://www.restaurantdavinci.nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Margo Reuten is a trailblazer in the Dutch culinary world. She has held at least one MICHELIN Star since 1999 and is the only female chef with this accolade in the Guide. Time and again, she impresses with her keen eye for detail, generosity and choice of ingredients, which she works meticulously, drawing on a wealth of technical expertise. The beautiful presentation of the dishes instantly makes your mouth water. Her cooking style is contemporary but also embraces classic sauces. Her experience is beyond question, yet she continually pushes herself to explore new techniques with which she keeps diners on their toes. For example, she pairs North Sea turbot with a watercress-infused vinaigrette made with a mild vinegar and serves it alongside succulent lobster tempura and a curry mayonnaise..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Havenstraat%2027%2C%20Maasbracht%2C%206051%20CS%2C%20Netherlands"
    pageTitle="Da Vinci"
  />
);
