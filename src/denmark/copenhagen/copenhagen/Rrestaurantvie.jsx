...
const Rrestaurantvie = () => (
  <RestaurantPage
    restaurantName="Restaurant VIE"
    address="Århusgade 128E, Copenhagen, 2150, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4560157510"
    website="https://restaurantvie.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to the imposing UN campus, you’ll find a new red-brick development and, within it, this contemporary bistro with concrete walls, exposed ducting and an industrial feel. The cooking has a direct, no-frills approach, with generously proportioned dishes paying great attention to seasoning and cooking times. You might find onion bread with Iberico ham; kalix roe with sour cream, herbs and potato bread; or an indulgent take on a kro dessert – almond cake with salted caramel and vanilla ice cream. Glass-fronted coolers line the room, giving a clue as to the range offered on the top-notch wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%85rhusgade%20128E%2C%20Copenhagen%2C%202150%2C%20Denmark"
    pageTitle="Restaurant VIE"
  />
);

export default Rrestaurantvie;
