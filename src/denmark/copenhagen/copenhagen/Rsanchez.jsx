...
const Rsanchez = () => (
  <RestaurantPage
    restaurantName="Sanchez"
    address="Istedgade 60, Copenhagen, 1650 K, Denmark"
    cuisine="Mexican"
    priceRange="€€"
    phoneNumber="+4531116640"
    website="https://lovesanchez.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Sanchez in question is Rosio – a former Head Pastry Chef at Noma – and she certainly knows how to put the fun in dining out with this lively neighbourhood spot. Bringing the bold, powerful flavours of her Mexican heritage and presenting them in a small plates concept – accompanied, of course, by a margarita or maybe the mezcal pairing – has proved the perfect recipe for success. The ‘Favourite Servings’, made up of five dishes selected by the kitchen team, is a hit – and there’s always the option to pop in on your way past just for tacos and snacks...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Istedgade%2060%2C%20Copenhagen%2C%201650%20K%2C%20Denmark"
    pageTitle="Sanchez"
  />
);

export default Rsanchez;
