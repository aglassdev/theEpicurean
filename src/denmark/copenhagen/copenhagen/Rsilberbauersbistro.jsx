...
const Rsilberbauersbistro = () => (
  <RestaurantPage
    restaurantName="Silberbauers Bistro"
    address="Jægersborggade 40, Copenhagen, 2200 N, Denmark"
    cuisine="French"
    priceRange="€"
    phoneNumber="+4536966593"
    website="https://www.silberbauers.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While its name may not instantly conjure up images of the Eiffel Tower, Silberbauers Bistro brings a small slice of Paris to Copenhagen’s streets. Whitewashed walls, small tables and menus chalked up on blackboards contribute to the characterful French bistro feel – and the menu follows suit, with its selection of generously proportioned, great value, classic Gallic dishes. Interesting seafood combinations and recipes from Provence take the lead, but you’ll find everything here, from saucisse de Toulouse to crêpes suzette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=J%C3%A6gersborggade%2040%2C%20Copenhagen%2C%202200%20N%2C%20Denmark"
    pageTitle="Silberbauers Bistro"
  />
);

export default Rsilberbauersbistro;
