...
const Ranarki = () => (
  <RestaurantPage
    restaurantName="Anarki"
    address="Vodroffsvej 47, Copenhagen, 1900 Frederiksberg C, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+4522131134"
    website="https://www.restaurant-anarki.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone’s throw from Peblinge Sø Lake sits this unfussy, proudly run neighbourhood restaurant, whose name, ‘anarchy’, is a nod to its ethos. The regularly evolving menu of sharing plates embraces produce, techniques and seasonings from around the world, taking good quality ingredients and crafting them into bold, rustic dishes that burst with flavour. This mindset extends to the drinks too, with both the wines and the spirits originating from far-flung destinations and providing plenty of interest. Prices are kept reasonable which may, in part, help to explain the lively atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vodroffsvej%2047%2C%20Copenhagen%2C%201900%20Frederiksberg%20C%2C%20Denmark"
    pageTitle="Anarki"
  />
);

export default Ranarki;
