...
const Rbobe = () => (
  <RestaurantPage
    restaurantName="Bobe"
    address="Gråbrødretorv 11, Copenhagen, 1154, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+4531516350"
    website="https://www.restaurantbobe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a cobbled city centre square stands this attractive townhouse that's now in the hands of Danish celebrity chef, Bo Bech. His simply decorated contemporary bistro offers reasonable pricing and plenty of flexibility on an extensive à la carte menu. There's strong cooking and great produce across the board, but those with a sweet tooth should keep their eye out for the cheesecake with smoked maple syrup. A wine bar in the basement provides ample opportunity to extend your visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gr%C3%A5br%C3%B8dretorv%2011%2C%20Copenhagen%2C%201154%2C%20Denmark"
    pageTitle="Bobe"
  />
);

export default Rbobe;
