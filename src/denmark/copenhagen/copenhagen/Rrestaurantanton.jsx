...
const Rrestaurantanton = () => (
  <RestaurantPage
    restaurantName="Restaurant Anton"
    address="3 Store Strandstræde, Copenhagen, 1255, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4553880850"
    website="https://www.restaurant-anton.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from Nyhavn’s picturesque canals sits Restaurant Anton, an impressive 18th-century building that was once an exclusive confectionery store. A restaurant since 1915, it’s now run by the owners behind Marv & Ben, and its appealingly retro dining room still boasts its original murals, along with blue-and-white-tiled tables and Royal Copenhagen tableware. The modern Danish cooking comprises largely of smørrebrød with a twist at lunchtime – such as herring with sour cream, egg, onion compote and tomato – while dinner sees the likes of fried turbot with sunchokes and a gooseberry vinaigrette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Store%20Strandstr%C3%A6de%2C%20Copenhagen%2C%201255%2C%20Denmark"
    pageTitle="Restaurant Anton"
  />
);

export default Rrestaurantanton;
