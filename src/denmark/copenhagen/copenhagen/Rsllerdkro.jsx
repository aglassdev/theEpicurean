...
const Rsllerdkro = () => (
  <RestaurantPage
    restaurantName="Søllerød Kro"
    address="Søllerødvej 35, Holte, Copenhagen, 2840, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4545802505"
    website="https://www.soelleroed-kro.dk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A characterful 17C thatched inn by a pond in a picturesque village, with a delightful courtyard terrace and three elegant, intimate rooms. In keeping with the surroundings, cooking has a classical heart but is presented in a modern style. Dishes have deceptive depth and the wine list is a tome of beauty...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=S%C3%B8ller%C3%B8dvej%2035%2C%20Holte%2C%20Copenhagen%2C%202840%2C%20Denmark"
    pageTitle="Søllerød Kro"
  />
);

export default Rsllerdkro;
