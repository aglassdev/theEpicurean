...
const Rpaesno = () => (
  <RestaurantPage
    restaurantName="Paesàno"
    address="Jægersborggade 41, Copenhagen, 2200, Denmark"
    cuisine="Italian"
    priceRange="€"
    phoneNumber="+4553777192"
    website="https://paesanocph.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Down a charming cobbled street in the trendy Nørrebro neighbourhood, where you will find a number of artisan food producers, lies this thoroughly fun restaurant run by a Neapolitan Chef. The short Italian menu is supplemented by blackboard specials and might include ‘cucina povera’ style dishes like 'pasta e piselli' and ‘soffrito napoletano’ – a ragu made using 'the best parts of the pig'. Whatever it is you choose, you can bet it will be colourful, packed with flavour and excellent value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=J%C3%A6gersborggade%2041%2C%20Copenhagen%2C%202200%2C%20Denmark"
    pageTitle="Paesàno"
  />
);

export default Rpaesno;
