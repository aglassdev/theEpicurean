...
const Rnorrlyst = () => (
  <RestaurantPage
    restaurantName="Norrlyst"
    address="Kompagnistrædet 18, Copenhagen, 1208, Denmark"
    cuisine="Danish"
    priceRange="€"
    phoneNumber="+4561429581"
    website="https://www.norrlyst.dk/restaurantnorrlyst"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’ve been wandering Strøget – one of Europe’s longest shopping streets – you’ll do well to stop off at this intimate basement bistro: a cosy neighbourhood spot with a bubbly atmosphere and a laid-back feel. At lunchtime it’s all about smørrebrød and schnapps, aquavit or local beer, while in the evening they serve a set four-course menu. Local ingredients lead the way, with some produced organically or biodynamically, and all freshly picked or caught. You might find ‘fish of the day’ royale with trout roe or duck breast with smoked marrow, cherries and black trumpet mushrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kompagnistr%C3%A6det%2018%2C%20Copenhagen%2C%201208%2C%20Denmark"
    pageTitle="Norrlyst"
  />
);

export default Rnorrlyst;
