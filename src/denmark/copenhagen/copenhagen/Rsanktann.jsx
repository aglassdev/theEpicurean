...
const Rsanktann = () => (
  <RestaurantPage
    restaurantName="Sankt Annæ"
    address="Sankt Annæ Plads 12, Copenhagen, 1250 K, Denmark"
    cuisine="Smørrebrød"
    priceRange="€€"
    phoneNumber="+4533125497"
    website="https://restaurantsanktannae.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive terraced building with a traditional, rather quaint interior. There's a seasonal à la carte and a daily blackboard menu: prices can vary so check before ordering. The lobster and shrimp – fresh from local fjords – are a hit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sankt%20Ann%C3%A6%20Plads%2012%2C%20Copenhagen%2C%201250%20K%2C%20Denmark"
    pageTitle="Sankt Annæ"
  />
);

export default Rsanktann;
