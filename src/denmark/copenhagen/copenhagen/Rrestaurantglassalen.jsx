...
const Rrestaurantglassalen = () => (
  <RestaurantPage
    restaurantName="Restaurant Glassalen"
    address="Tivoli, Vesterbrogade 3, Copenhagen, 1620, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4592925800"
    website="https://formelfamily.dk/glassalen/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You have to pay the theme park admission fee to gain entry to this restaurant hidden within the walls of Tivoli Gardens, so be sure to build in some time for a wander around either before or after your meal. Set within a beautifully restored glasshouse, it’s light, bright and has something of a fairytale feel, and boasts a lovely terrace looking out over the lake. During the day there's a selection of smørrebrød and a three-course lunch, while dinner steps things up-a gear with a seasonal tasting menu and an à la carte of modern Danish dishes such as whole fried sole with mussels and gooseberry sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tivoli%2C%20Vesterbrogade%203%2C%20Copenhagen%2C%201620%2C%20Denmark"
    pageTitle="Restaurant Glassalen"
  />
);

export default Rrestaurantglassalen;
