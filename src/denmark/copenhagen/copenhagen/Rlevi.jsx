...
const Rlevi = () => (
  <RestaurantPage
    ...
    priceRange="€€€"
    phoneNumber="+4570160060"
    website="https://www.restaurantlevi.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese and Italian cuisine join forces at this stylish restaurant near Rosenborg Castle Gardens. Expect to find Italian ingredients mixed into recognisable Japanese dishes and vice versa, such as salsiccia gyozas or spaghettoni with yuzu miso. The ambitious, high quality dishes are served by the friendly, attentive team in a strikingly designed room with high ceilings, bare tables and a large glass front...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ny%20%C3%98stergade%2024%2C%20Copenhagen%2C%201101%2C%20Denmark"
    pageTitle="Levi"
  />
);

export default Rlevi;
