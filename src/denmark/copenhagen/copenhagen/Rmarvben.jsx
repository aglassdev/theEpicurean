...
const Rmarvben = () => (
  <RestaurantPage
    restaurantName="Marv & Ben"
    address="Snaregade 4, Copenhagen, 1205 K, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+4523810291"
    website="https://www.marvogben.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start your evening with a walk along the Slotsholmen Canal, before heading for this lively little restaurant on one of Copenhagen’s oldest streets. Bright paintings and street art style murals of pinecones, seaweed and coral adorn the walls of three dimly lit rooms, and the young team bring plenty of enthusiasm to match the vibe. Unfussy modern dishes display purity, depth of flavour and finesse. Six options are offered each evening – try them all via the ‘Six Favourites’ menu or build your own meal from the à la carte – with dishes like 'pork-celeriac-parsley' accompanied by a delicious poultry jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Snaregade%204%2C%20Copenhagen%2C%201205%20K%2C%20Denmark"
    pageTitle="Marv & Ben"
  />
);

export default Rmarvben;
