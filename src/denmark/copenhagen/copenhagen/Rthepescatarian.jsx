...
const Rthepescatarian = () => (
  <RestaurantPage
    restaurantName="The Pescatarian"
    address="Amaliegade 49, Copenhagen, 1256 K, Denmark"
    cuisine="Creative, Contemporary"
    priceRange="€€"
    phoneNumber="+4530638322"
    website="https://thepescatarian.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dine in one of three rooms at this buzzing, minimalist restaurant that, unsurprisingly, features plenty of freshly caught seafood. Choose from the fish-based tasting menu or a vegetarian version, both offered in either 4 or 6 courses. The chef prepares modern dishes with all the typical Danish hallmarks, including preservation techniques and a lightness of touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Amaliegade%2049%2C%20Copenhagen%2C%201256%20K%2C%20Denmark"
    pageTitle="The Pescatarian"
  />
);

export default Rthepescatarian;
