...
const Rmark = () => (
  <RestaurantPage
    ...
    priceRange="€"
    phoneNumber="+4531396614"
    website="https://restaurantmark.dk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Axeltorv%203%2C%20Copenhagen%2C%201609%2C%20Denmark"
    pageTitle="Mark"
  />
);

export default Rmark;
