...
const Rkappoand = () => (
  <RestaurantPage
    restaurantName="Kappo Andō"
    address="Øster Farimagsgade 93, Copenhagen, 2100, Denmark"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+4529829746"
    website="https://www.kappoando.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kappo Andō was 10 years in the making, but the wait paid off. It occupies a corner site just outside the city centre and is divided into two different areas, with seats available at a dark wood counter, as well as at regular tables in a second room. The décor is a perfect fit for the contemporary Japanese cooking, where flavoursome dishes are underpinned by quality ingredients. The 'yakitori of the day' allows you to enjoy the smoky flavours of meat cooked over binchotan charcoal and they also open twice a month for ‘Yakitori Sunday’. An extensive sake selection adds to the whole experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%98ster%20Farimagsgade%2093%2C%20Copenhagen%2C%202100%2C%20Denmark"
    pageTitle="Kappo Andō"
  />
);

export default Rkappoand;
