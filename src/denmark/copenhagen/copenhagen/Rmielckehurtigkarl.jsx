...
const Rmielckehurtigkarl = () => (
  <RestaurantPage
    restaurantName="Mielcke & Hurtigkarl"
    address="Runddel 1, Copenhagen, 2000 C, Denmark"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+4538348436"
    website="https://www.mhcph.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a delightful spot in Frederiksberg Gardens, its walls painted with garden scenes, is this charming 1744 orangery with a fire-lit terrace. Dishes come from around the globe, with Asian influences to the fore – and an amazing array of herbs from the gardens...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Runddel%201%2C%20Copenhagen%2C%202000%20C%2C%20Denmark"
    pageTitle="Mielcke & Hurtigkarl"
  />
);

export default Rmielckehurtigkarl;
