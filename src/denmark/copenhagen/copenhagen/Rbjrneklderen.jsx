...
const Rbjrneklderen = () => (
  <RestaurantPage
    restaurantName="Bjørnekælderen"
    address="Frederiksberg Allé 55, Copenhagen, 1820, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+4547774747"
    website="https://www.bjoernekaelderen.dk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ‘Bear’s Basement’ has been a restaurant for over 130 years, and references to the furry creatures are legion in this cosy, characterful eatery. Smørrebrød are served at lunch, with more substantial dishes in the evening, and the carefully crafted plates have flavour, imagination and a modern touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Frederiksberg%20All%C3%A9%2055%2C%20Copenhagen%2C%201820%2C%20Denmark"
    pageTitle="Bjørnekælderen"
  />
);

export default Rbjrneklderen;
