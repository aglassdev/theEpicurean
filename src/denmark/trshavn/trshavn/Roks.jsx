...
const Roks = () => (
  <RestaurantPage
    restaurantName="ROKS"
    address="Gongin 5, Tórshavn, 100, Denmark"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+298411411"
    website="https://www.roks.fo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sister to Ræst is set in an ancient, turf-roofed building and has a rustic inner, a laid-back ambience and chatty staff. The set menus reflect the bounty from the surrounding waters, from local sea-urchins to langoustines and Greenlandic snow crab. All these dishes are cooked with great precision to unlock their natural flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gongin%205%2C%20T%C3%B3rshavn%2C%20100%2C%20Denmark"
    pageTitle="ROKS"
  />
);
