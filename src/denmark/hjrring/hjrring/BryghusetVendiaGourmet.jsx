...
const BryghusetVendiaGourmet = () => (
  <RestaurantPage
    restaurantName="Bryghuset Vendia - Gourmet"
    address="Markedsgade 9, Hjørring, 9800, Denmark"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+4598922229"
    website="https://www.bryghusetvendia.dk/en/gourmet/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A microbrewery plays host to a stylish brasserie and this tiny gourmet restaurant, which consists of just three tables. It serves an 11 course themed surprise menu of creative, elaborately presented dishes designed to stimulate the taste buds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markedsgade%209%2C%20Hj%C3%B8rring%2C%209800%2C%20Denmark"
    pageTitle="Bryghuset Vendia - Gourmet"
  />
);

export default BryghusetVendiaGourmet;
