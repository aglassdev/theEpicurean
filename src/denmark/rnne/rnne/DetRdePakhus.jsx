...
const DetRdePakhus = () => (
  <RestaurantPage
    restaurantName="Det Røde Pakhus"
    address="Snellemark 30, Rønne, Rønne, 3700, Denmark"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+4564635026"
    website="https://www.roedepakhus.dk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two experienced owners bring their knowledge together at this modern, wood-furnished restaurant set in the centre of Bornholm’s capital. The chef is passionate about good produce and skilfully prepares local ingredients to create refined, imaginative dishes. Desserts are a highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Snellemark%2030%2C%20R%C3%B8nne%2C%20R%C3%B8nne%2C%203700%2C%20Denmark"
    pageTitle="Det Røde Pakhus"
  />
);

export default DetRdePakhus;
