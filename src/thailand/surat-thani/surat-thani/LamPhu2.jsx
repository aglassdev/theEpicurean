...
const LamPhu2 = () => (
  <RestaurantPage
    restaurantName="Lam Phu 2"
    address="23/1 Mu 3, Pak Nam Road, Bang Kung, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+6677285113"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/lam-phu-2"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Watch the fishing boats on Tapi River while enjoying a bright and airy setting and local seafood cooked southern style. The oyster omelette is gorgeous with a crispy egg base, spot-on seasoning and fresh local oysters; it goes well with steamed rice. The tender stir-fried squid with salted eggs is packed with flavour and flanked by an impressively creamy sauce. With over 100 seats, there is ample room for large groups to enjoy the scenic view...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%2F1%20Mu%203%2C%20Pak%20Nam%20Road%2C%20Bang%20Kung%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Lam Phu 2"
  />
);

export default LamPhu2;
