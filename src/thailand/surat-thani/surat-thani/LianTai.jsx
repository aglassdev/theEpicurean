...
const LianTai = () => (
  <RestaurantPage
    restaurantName="Lian Tai"
    address="70 Chonkasem Road, Talat, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6677275646"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/lian-tai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lian Tai specialises in deep-fried doughnuts. The family uses the original fermented dough recipe concocted by their father more than 5 decades ago. Cooked to a crisp, outer golden-brown with a soft, puffy inside, the Patongo is irresistible when dipped in rich sweet pandan custard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20Chonkasem%20Road%2C%20Talat%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Lian Tai"
  />
);

export default LianTai;
