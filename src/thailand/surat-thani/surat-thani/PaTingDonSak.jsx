...
const PaTingDonSak = () => (
  <RestaurantPage
    restaurantName="Pa Ting (Don Sak)"
    address="1/8 Mu 5, Don Sak, Surat Thani, 84220, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66639826959"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/pa-ting"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in 1967, Pa Ting is run by the founder’s daughter. The restaurant is a basic, open-air building overlooking Don Sak River, serving seafood cooked according to local recipes. The spicy salad with salted Kulao fish bursts with flavoursome Thai herbs. The crab curry with seablite leaves enjoys the natural umami of freshly caught seafood, enhanced with spicy in-house curry paste. Plenty of parking at the front...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%2F8%20Mu%205%2C%20Don%20Sak%2C%20Surat%20Thani%2C%2084220%2C%20Thailand"
    pageTitle="Pa Ting (Don Sak)"
  />
);

export default PaTingDonSak;
