...
const DearPhangan = () => (
  <RestaurantPage
    restaurantName="Dear Phangan"
    address="13/9 Mu 4, Ko Pha-ngan, Surat Thani, 84280, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66891143302"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/dear-phangan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Surrounded by a small garden of papaya, banana, tamarind and fresh herbs, this tranquil open-air eatery feels a world away from full-moon clichés. Booking is essential, as the chef prepares only the exact number of portions each day. The blind menu changes with fresh finds from the local market and pier, alongside seasonal fruits and edible flowers grown in the garden. Highlights include crisp yet juicy deep-fried fermented catfish, while the squid stir-fried with ink and shrimp paste shows off just how fresh the ingredients are...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%2F9%20Mu%204%2C%20Ko%20Pha-ngan%2C%20Surat%20Thani%2C%2084280%2C%20Thailand"
    pageTitle="Dear Phangan"
  />
);

export default DearPhangan;
