...
const YokKheng = () => (
  <RestaurantPage
    restaurantName="Yok Kheng"
    address="5/2 Tonpo Road, Talat, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6677282285"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/yok-kheng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Consummately crafted regional specialties are the highlight here, particularly long tong, a Surat Thani delicacy. It features succulent dry noodles in a pink sweet and sour sauce with tender portions of pig’s blood, skin and meat. Leave room for the delectable mango with sticky rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%2F2%20Tonpo%20Road%2C%20Talat%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Yok Kheng"
  />
);

export default YokKheng;
