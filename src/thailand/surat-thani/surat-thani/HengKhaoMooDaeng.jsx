...
const HengKhaoMooDaeng = () => (
  <RestaurantPage
    restaurantName="Heng Khao Moo Daeng"
    address="428/1 Namueang Road, Talat, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+66980748573"
    website="https://www.facebook.com/share/16guThUVFB/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple eatery is always bustling at lunchtime with queues for both dine-in and takeout. The owner's inviting and chatty demeanour sets the scene. His signature barbeque pork comes with crispy pork and sweet sausage inside and a large portion only costs 40 baht...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=428%2F1%20Namueang%20Road%2C%20Talat%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Heng Khao Moo Daeng"
  />
);

export default HengKhaoMooDaeng;
