...
const Nampetch = () => (
  <RestaurantPage
    restaurantName="Nampetch"
    address="61/1 Mu 1, Bangnaimai Road, Mueang, Surat Thani, 84000, Thailand"
    cuisine="Southern Thai, Thai"
    priceRange="฿฿"
    phoneNumber="+66972956395"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/nampetch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this relaxed spot in a traditional Thai house 20 minutes from town, the cordial service makes you feel like you are at a friend's place. The chef-owner shops each morning, picking mostly local produce; pastes are pounded fresh, and every dish is cooked à la minute so second orders take time. Lon is favoured over chilli paste, and the tamarind-scented kung phat sauce makham perfectly balances sweet and sour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%2F1%20Mu%201%2C%20Bangnaimai%20Road%2C%20Mueang%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Nampetch"
  />
);

export default Nampetch;
