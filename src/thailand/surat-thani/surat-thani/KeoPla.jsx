...
const KeoPla = () => (
  <RestaurantPage
    restaurantName="Keo Pla"
    address="560/4 Na Mueang Road, Talat, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6677282022"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/keo-pla"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This locally renowned noodle shop first opened in 1959. The homemade fish dumplings with celery and fish balls packed with umami invariably attract long queues. The soup strikes just the right balance of sweet and savoury with a herbal aroma. Hearty, generous portions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=560%2F4%20Na%20Mueang%20Road%2C%20Talat%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Keo Pla"
  />
);

export default KeoPla;
