...
const KhaoPhraRamLongSongLaoOhw = () => (
  <RestaurantPage
    restaurantName="Khao Phra Ram Long Song Lao Ohw"
    address="22 2 Witeetad Road, Talat, Mueang Surat Thani, Surat Thani, 84000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66815382875"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/suraasdrthaanii_2719394/restaurant/khao-phra-ram-long-song-lao-ohw"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a legacy spanning 6 decades, locals flock here for the exquisite satay pork and renowned phra ram long song, an ancient Siamese delicacy. It features tender sliced pork in a curry sauce that masterfully balances rich gutsy paste with creamy coconut milk...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%202%20Witeetad%20Road%2C%20Talat%2C%20Mueang%20Surat%20Thani%2C%20Surat%20Thani%2C%2084000%2C%20Thailand"
    pageTitle="Khao Phra Ram Long Song Lao Ohw"
  />
);

export default KhaoPhraRamLongSongLaoOhw;
