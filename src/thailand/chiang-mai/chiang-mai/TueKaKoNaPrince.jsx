...
const TueKaKoNaPrince = () => (
  <RestaurantPage
    restaurantName="Tue Ka Ko Na Prince"
    address="Kaeonawarat Road, Wat Ket, Mueang Chiang Mai, Chiang Mai, 50000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66910725891"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/tue-ka-ko-na-prince"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Tue Ka Ko – or taro fritter – place has been open for over 20 years opposite The Prince Royal's College, hence the name “Tue Ka Ko Na Prince. Savoury and sweet, their version of the Chiang Mai snack is perfected textured and served with peanut sauce. Deep-fried tofu is also sold...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kaeonawarat%20Road%2C%20Wat%20Ket%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050000%2C%20Thailand"
    pageTitle="Tue Ka Ko Na Prince"
  />
);

export default TueKaKoNaPrince;
