...
const PoondangKaengron = () => (
  <RestaurantPage
    restaurantName="Poondang Kaengron"
    address="24 Mu 2, Pa Bong, Saraphi, Chiang Mai, 50140, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66802871666"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/poondang-kaengron"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosy spot in a charming old wooden house with a warm, down-to-earth feel; clay pots, textured walls and rustic furnishings lend regional charm. The unfussy vibe suits the menu of Thai dishes with a few Northern touches. The stir-fried and deep-fried dishes stand out, especially the addictive fried tiny shrimp with chilli and salt – light, crisp and well-seasoned. With quality ingredients and shareable portions, it is ideal for a laid-back meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Mu%202%2C%20Pa%20Bong%2C%20Saraphi%2C%20Chiang%20Mai%2C%2050140%2C%20Thailand"
    pageTitle="Poondang Kaengron"
  />
);

export default PoondangKaengron;
