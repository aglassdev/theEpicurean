...
const KruaLawngKhao = () => (
  <RestaurantPage
    restaurantName="Krua Lawng Khao"
    address="18 Mu 2, Soi Sukhaphiban Mae Rim, Ban Duang Di 1, Rim Tai, Mae Rim, Chiang Mai, 50180, Thailand"
    cuisine="Northern Thai"
    priceRange="฿"
    phoneNumber="+66834763421"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/krua-lawng-khao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Food and atmosphere are well-matched at this chill Northern Thai restaurant in Mae Rim. It’s in a two-storey wooden pavilion with regular tables downstairs and cushioned floor seating upstairs; both options offer relaxing rice field views and refreshing breezes. The food here is equally fresh, as well as flavourful and easy on the wallet; the Northern Thai spicy pork salad and the Northern Thai hot and spicy soup with fish and morning glory are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Mu%202%2C%20Soi%20Sukhaphiban%20Mae%20Rim%2C%20Ban%20Duang%20Di%201%2C%20Rim%20Tai%2C%20Mae%20Rim%2C%20Chiang%20Mai%2C%2050180%2C%20Thailand"
    pageTitle="Krua Lawng Khao"
  />
);

export default KruaLawngKhao;
