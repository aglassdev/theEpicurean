...
const Aeeen = () => (
  <RestaurantPage
    restaurantName="Aeeen"
    address="4/13 Mu 5, Suthep Road, Suthep, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Vegetarian"
    priceRange="฿฿"
    phoneNumber="+66979437039"
    website="https://www.neoshokudo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aeeen goes the sound of Ken’s unique laughter, according to wife Yuki. Under the concept of Neo Shojin Ryori, the Japanese couple craft their plant-based menu using seasonal ingredients. The dining areas span two floors of a cute wooden house that feels like rural Japan. Lines of jars contain the fermented ingredients they use in the food. We recommend the perfectly judged soymilk udon noodles and refreshing mango with ginger and honey drink...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%2F13%20Mu%205%2C%20Suthep%20Road%2C%20Suthep%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Aeeen"
  />
);

export default Aeeen;
