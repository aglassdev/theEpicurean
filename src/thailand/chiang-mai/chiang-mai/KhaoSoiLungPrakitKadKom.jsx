...
const KhaoSoiLungPrakitKadKom = () => (
  <RestaurantPage
    restaurantName="Khao Soi Lung Prakit Kad Kom"
    address="53 Suriyawongse Road, Hai Ya, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66832099441"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/khao-soi-lung-prakit-kad-kom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place has been serving Northern Thai-style curry noodle soup for over 40 years. Their signature dish is Khao Soi with beef, which features a savoury curry broth and soft, eggy noodles. Don’t forget to squeeze the lemon over your noodles and pair them with side dishes to enhance the flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Suriyawongse%20Road%2C%20Hai%20Ya%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Khao Soi Lung Prakit Kad Kom"
  />
);

export default KhaoSoiLungPrakitKadKom;
