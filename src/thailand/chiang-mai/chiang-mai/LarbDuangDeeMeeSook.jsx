...
const LarbDuangDeeMeeSook = () => (
  <RestaurantPage
    restaurantName="Larb Duang Dee Mee Sook"
    address="74 Soi Ban Huai Sai, Mu 4, Suthep, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+66808894595"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/larb-duang-dee-mee-sook"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its simple, rustic look, this quaint eatery specialises in northern larb dishes, paired with a local chaeo dipping sauce with the aroma of toasted sticky rice. The spicy, sour and fragrant beef soup is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20Soi%20Ban%20Huai%20Sai%2C%20Mu%204%2C%20Suthep%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Larb Duang Dee Mee Sook"
  />
);

export default LarbDuangDeeMeeSook;
