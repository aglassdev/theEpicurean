...
const NavanNavan = () => (
  <RestaurantPage
    restaurantName="NAVAN NAVAN"
    address="55 Mu 7, San Pong, Mae Rim, Chiang Mai, 50180, Thailand"
    cuisine="Creative"
    priceRange="฿฿฿"
    phoneNumber="+66656645391"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/navan-navan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Surrounded by rice fields, this stand-alone cement building affords a clear view of the open kitchen. The chef draws on various cuisines and uses a charcoal grill to cook local ingredients. His unpretentious style promotes healthy eating, and each dish highlights the natural flavours of the ingredients. Arrive before sunset to see the beautiful garden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Mu%207%2C%20San%20Pong%2C%20Mae%20Rim%2C%20Chiang%20Mai%2C%2050180%2C%20Thailand"
    pageTitle="NAVAN NAVAN"
  />
);

export default NavanNavan;
