...
const GoNengWichayanon = () => (
  <RestaurantPage
    restaurantName="Go Neng (Wichayanon)"
    address="77 Wichayanon Road, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66946376333"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/go-neng-wichayanon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Go Neng has been serving deep-fried dough sticks for almost four decades. No matter what shape they take – crocodile, dinosaur, dragon or elephant – each one boasts the same puffy perfection and crispy texture. Other bites, such as the deep-fried bun and fried whole-wheat dough are also great...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%20Wichayanon%20Road%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Go Neng (Wichayanon)"
  />
);

export default GoNengWichayanon;
