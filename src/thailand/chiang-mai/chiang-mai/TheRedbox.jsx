...
const TheRedbox = () => (
  <RestaurantPage
    restaurantName="The Redbox"
    address="6 Soi Jannsaap, Huai Kaeo Road, Chang Phueak, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+66929794542"
    website="https://www.restaurantredbox.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With business acumen and cooking techniques gleaned from their travels, Chef Dan and partner Pimmada offer modern Thai with Malaysian and Brunei influences. They import select ingredients like salted eggs from Chaiya, and Gula Melaka (Malaysian palm sugar) to create treats like Siam Ruby, a signature dessert. We recommend the signature creation cocktail with a complexity of flavours before your unforgettable meal. Seating is limited so bookings are essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Soi%20Jannsaap%2C%20Huai%20Kaeo%20Road%2C%20Chang%20Phueak%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="The Redbox"
  />
);

export default TheRedbox;
