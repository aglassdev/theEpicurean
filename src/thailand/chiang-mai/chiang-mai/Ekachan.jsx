...
const Ekachan = () => (
  <RestaurantPage
    restaurantName="Ekachan"
    address="95 Charoenprathet Road, Chang Khlan, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66979626445"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/ekachan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This new restaurant in the heart of old Chiang Mai is run by a local chef who embraces the slow food concept, using ingredients from around the country. The fried rice with sweet shrimp is nicely cooked with sweet shrimp paste and tasty condiments, including fresh chilli, shallots and mango. The spicy beef turmeric curry is a standout, with an intense mix of herbs and spices. If you’re looking for the spice bomb, they can add fresh Thai chillies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=95%20Charoenprathet%20Road%2C%20Chang%20Khlan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Ekachan"
  />
);

export default Ekachan;
