...
const Kang = () => (
  <RestaurantPage
    restaurantName="Kang"
    address="Jing Jai Market, 46 Atsadathon Road, Pa Tan, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="South East Asian"
    priceRange="฿฿"
    phoneNumber="+66652418555"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/kang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 2023, Kang is a fresh addition to Jing Jai Market. It offers a cosy retreat with a laid-back approach to dining, plus a menu that's ideal for sharing the highlights of Indonesian, Malaysian and Thai cuisine with friends. We suggest opting for their signature Nasi Lemak, or one of the bold, aromatic curries. All dishes are made to order, so diners may need to have a little patience while waiting for their delicious meals...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jing%20Jai%20Market%2C%2046%20Atsadathon%20Road%2C%20Pa%20Tan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Kang"
  />
);
