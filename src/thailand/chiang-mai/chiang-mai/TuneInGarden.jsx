...
const TuneInGarden = () => (
  <RestaurantPage
    restaurantName="Tune In Garden"
    address="139 Mu 3, Pong Yaeng, Mae Rim, Chiang Mai, 50180, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66871852951"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/tune-in-garden"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is owned by the late National Artist of Thailand and his wife. She cooks delicious homestyle fare drawn from a cookbook she wrote based on her mother-in-law’s recipes. First-timers are served a fixed-price menu; returners can order from the cookbook. Roasted pork ribs with cabbage and fermented pork with fermented bean curd relish stand out. Booking is required...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139%20Mu%203%2C%20Pong%20Yaeng%2C%20Mae%20Rim%2C%20Chiang%20Mai%2C%2050180%2C%20Thailand"
    pageTitle="Tune In Garden"
  />
);

export default TuneInGarden;
