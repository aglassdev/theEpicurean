...
const RotiPaDay = () => (
  <RestaurantPage
    restaurantName="Roti Pa Day"
    address="In front of Wat Mahawan, Thapae Road Soi 4, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66810219496"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/rotee-pa-day"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="First-timers should order the plain crispy roti with condensed milk to start. The roti dough here is uniquely made without eggs, but slowly cooked to a crispy-chewy perfection in coconut oil. Choose from 20 toppings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=In%20front%20of%20Wat%20Mahawan%2C%20Thapae%20Road%20Soi%204%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Roti Pa Day"
  />
);

export default RotiPaDay;
