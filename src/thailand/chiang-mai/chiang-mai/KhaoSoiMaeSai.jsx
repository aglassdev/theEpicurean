...
const KhaoSoiMaeSai = () => (
  <RestaurantPage
    restaurantName="Khao Soi Mae Sai"
    address="29/1 Ratchaphruek Road, Chang Phueak, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6653213284"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/khao-soi-mae-sai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop serves the famous Khao Soi, featuring rich and slightly spicy curry notes. You can choose your preferred meat toppings, and the portions are so delicate that you might find yourself wanting another round!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%2F1%20Ratchaphruek%20Road%2C%20Chang%20Phueak%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Khao Soi Mae Sai"
  />
);

export default KhaoSoiMaeSai;
