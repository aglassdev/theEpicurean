...
const LaabTonYangSanPhiSuea = () => (
  <RestaurantPage
    restaurantName="Laab Ton Yang (San Phi Suea)"
    address="199/330 Mu 9, San Phi Suea, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Northern Thai"
    priceRange="฿"
    phoneNumber="+66894339786"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/laab-ton-yang-san-phi-suea"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A solid choice for no-fuss Northern Thai food, this laid-back restaurant serves rustic, traditional dishes in small sharing portions. Highlights include the well-balanced kaeng om and boldly flavoured lap nuea, available with pork, beef or fish – raw or cooked – all prepared in classic Northern style. In an open-air setting with a relaxed local vibe, the place fills up with Thai diners at peak times. Service is friendly, with staff often speaking Northern Thai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=199%2F330%20Mu%209%2C%20San%20Phi%20Suea%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Laab Ton Yang (San Phi Suea)"
  />
);

export default LaabTonYangSanPhiSuea;
