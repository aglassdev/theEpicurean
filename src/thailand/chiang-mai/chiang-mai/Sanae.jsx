...
const Sanae = () => (
  <RestaurantPage
    restaurantName="Sanae"
    address="62 Wangsingkham Road, Pa Tan, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66948248866"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/sanae-thai-cuisine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This halal kitchen next to the Ping River is one for beef fans. With indoor and outdoor dining, the big outdoor kitchen cooks a creative à la carte menu with balanced flavours. The beef fat rice topped with egg yolk has a smoky flavour. The spicy Thai soup with beef shank is packed with spice aroma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20Wangsingkham%20Road%2C%20Pa%20Tan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Sanae"
  />
);
