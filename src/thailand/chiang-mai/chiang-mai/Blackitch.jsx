...
const Blackitch = () => (
  <RestaurantPage
    restaurantName="Blackitch"
    address="27/1 Nimmanahaeminda Soi 7 Road, Suthep, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Asian Contemporary, Creative"
    priceRange="฿฿฿"
    phoneNumber="+66936956454"
    website="https://www.blackitch.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden in the city centre in plain sight, this second floor 16-seater is decorated with stone, wood and local blue fabrics in a minimalist style. The creative chef, Phanuphol Bulsuwan, honed his skills under his restaurateur grandmother. He constantly adapts his 10-course meal using Thailand’s seasonal ingredients, uniting Thai, Japanese and Chinese influences. He also ferments kitchen scraps to season his dishes and brews beers and sake for food pairing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%2F1%20Nimmanahaeminda%20Soi%207%20Road%2C%20Suthep%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Blackitch"
  />
);

export default Blackitch;
