...
const ThanaOcha = () => (
  <RestaurantPage
    restaurantName="Thana Ocha"
    address="29 Ratchawong Road, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6653232423"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/thana-ocha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Every day at lunch long lines form in front of this decades-old shop selling Hakka-style noodles. House-made Hakka stuffed tofu, fish sausage and crispy wontons find their way into every dish including tom yum noodles and the classic Yentafo. The latter is highly recommended, with a well-seasoned soup made from fermented bean curd and fresh chilli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Ratchawong%20Road%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Thana Ocha"
  />
);

export default ThanaOcha;
