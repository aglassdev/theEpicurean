...
const Gongkham = () => (
  <RestaurantPage
    restaurantName="Gongkham"
    address="259/22-23 Mu 1, Rim Tai, Mae Rim, Chiang Mai, 50180, Thailand"
    cuisine="Northern Thai"
    priceRange="฿"
    phoneNumber="+66840405515"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/gongkham"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Around 30 minutes from downtown Chiang Mai, this Lanna-style wooden house with a warm, relaxed vibe offers a peaceful escape that feels like dining at a local friend's home. Outdoor seating without air conditioning is ideal for enjoying the cool air. The menu sticks to local classics, from Kaeng Khae and Nam Prik Noom with deep-fried pork liver to Cho Phak Kat. Cooked to order, the dishes are simply presented, allowing the Northern Thai flavours to shine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=259%2F22-23%20Mu%201%2C%20Rim%20Tai%2C%20Mae%20Rim%2C%20Chiang%20Mai%2C%2050180%2C%20Thailand"
    pageTitle="Gongkham"
  />
);

export default Gongkham;
