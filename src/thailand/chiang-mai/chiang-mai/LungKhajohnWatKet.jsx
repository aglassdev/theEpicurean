...
const LungKhajohnWatKet = () => (
  <RestaurantPage
    restaurantName="Lung Khajohn Wat Ket"
    address="109 Charoen Rajd Road, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+6653243157"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/lung-khajohn-wat-ket"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For decades, this place has been serving distinctive Khao Kriab Pak Moh, or steamed rice skin dumplings, opposite Wat Ket Karam. These contain a tasty salty-sweet filling wrapped in a coconut-infused rice flour sheet and a side of coconut cream. Tapioca balls with sweet pork are also offered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=109%20Charoen%20Rajd%20Road%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050000%2C%20Thailand"
    pageTitle="Lung Khajohn Wat Ket"
  />
);

export default LungKhajohnWatKet;
