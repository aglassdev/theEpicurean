...
const TubPing = () => (
  <RestaurantPage
    restaurantName="Tub Ping"
    address="4/9 Mu 3, Pa Daet, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Thai contemporary, Thai"
    priceRange="฿฿"
    phoneNumber="+66959750838"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/tub-ping"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming restaurant by the Ping River blends traditional and modern design, with warm wooden decor, brick walls and high ceilings. Woven crafts add a Northern Thai touch. Passionate about Western cuisine, the owner-chef fuses Thai ingredients with European techniques. Standouts include penne with Thai sour pork sausage in pesto and red curry with crispy duck confit and lychee. For an optimum experience, sit out on the riverside terrace and take in the view...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%2F9%20Mu%203%2C%20Pa%20Daet%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Tub Ping"
  />
);

export default TubPing;
