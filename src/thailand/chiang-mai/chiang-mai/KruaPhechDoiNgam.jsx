...
const KruaPhechDoiNgam = () => (
  <RestaurantPage
    restaurantName="Krua Phech Doi Ngam"
    address="267/1 Mu 2, Mahidol Road, Pa Daet, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+6653204517"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/krua-phech-doi-ngam-krua-mueang-classic"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular open-air eatery serves well-sized northern Thai favourites at fair prices. Kang Liang, the peppery curry paste in spicy mixed vegetables goes well with the prawns’ natural sweetness; while the local fish marinated in herbs and spices is grilled in a bamboo tube until soft, with a smoky aroma. Do check the blackboard for specials of the day, which often focus on seasonal dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=267%2F1%20Mu%202%2C%20Mahidol%20Road%2C%20Pa%20Daet%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Krua Phech Doi Ngam"
  />
);

export default KruaPhechDoiNgam;
