...
const Talung = () => (
  <RestaurantPage
    restaurantName="Talung"
    address="8 Chotana Road Soi 12, Chang Phueak, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Southern Thai"
    priceRange="฿฿"
    phoneNumber="+66835784948"
    website="https://www.facebook.com/share/1HRZx3CfWZ/?mibextid=wwXIfr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having recently relocated to this ground floor eatery under a residential apartment, Talung is simply decorated with air conditioning, a lively bar and serves Southern Thai. It’s a small family business, the staff are friendly and attentive, and help each other from kitchen to table. The stir-fried squid with squid ink has a rich, well-seasoned sauce and herbal scent. The stir-fried prawns come with a homemade southern Thai shrimp paste and young bitter beans...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Chotana%20Road%20Soi%2012%2C%20Chang%20Phueak%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Talung"
  />
);

export default Talung;
