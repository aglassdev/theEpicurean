...
const NamNgiaoYong = () => (
  <RestaurantPage
    restaurantName="Nam Ngiao Yong"
    address="Unit 19, Siri Wattana Market, 193 Chang Phueak Road, Chang Phueak, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66956616959"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/nam-ngiao-yong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple stall with limited seating draws crowds with its two flavoursome dishes. The khanom chin nam ngiao with tangy tomato broth and pork ribs, and khanom chin with red curry chicken with coconut milk and fish balls make it well worth coming to Siri Watthana Market...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%2019%2C%20Siri%20Wattana%20Market%2C%20193%20Chang%20Phueak%20Road%2C%20Chang%20Phueak%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Nam Ngiao Yong"
  />
);

export default NamNgiaoYong;
