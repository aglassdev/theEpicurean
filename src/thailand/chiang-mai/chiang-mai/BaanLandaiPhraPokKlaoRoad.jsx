...
const BaanLandaiPhraPokKlaoRoad = () => (
  <RestaurantPage
    restaurantName="Baan Landai (Phra Pok Klao Road)"
    address="252/13 Phra Pok Klao Road, Si Phum, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66658484464"
    website="https://www.baan-landai.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don’t let the slightly unkempt exterior keep you from visiting Chef Landai’s restaurant. The interior exudes charm with its eclectic décor and a window into the kitchen, where chefs whip up pan-Thai dishes like flavourful pork ribs with red wine sauce. The portions are suitable for sharing with friends, and don’t forget to save room for their traditional Thai desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=252%2F13%20Phra%20Pok%20Klao%20Road%2C%20Si%20Phum%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Baan Landai (Phra Pok Klao Road)"
  />
);

export default BaanLandaiPhraPokKlaoRoad;
