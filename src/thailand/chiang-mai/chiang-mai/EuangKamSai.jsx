...
const EuangKamSai = () => (
  <RestaurantPage
    restaurantName="Euang Kam Sai"
    address="185/3 Wua Lai Road, Hai Ya, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+66951450296"
    website="https://www.euangkamsai.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Eung Kham Sai has been run by the same family for over a century and is still serving up classic Northern Thai recipes handed down the generations. The modest space has traditional decor; large windows frame the view outside. Try the freshly made khao bai, rice wrapped around a pork, fish or beef filling, or the spicy Northern-style curry, made from scratch with local beef brisket and exuding fruity acidity. Some ingredients come from local farms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=185%2F3%20Wua%20Lai%20Road%2C%20Hai%20Ya%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Euang Kam Sai"
  />
);

export default EuangKamSai;
