...
const KitiPanit = () => (
  <RestaurantPage
    restaurantName="Kiti Panit"
    address="19 Tha Phae Road, Chang Khlan, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+66801917996"
    website="https://www.kitipanit.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Turning their great-great-grandparents’ 1880s mansion into a restaurant, Kiti Panit’s owners decided to create an updated take on traditional Lanna cuisine. The results include intense and complex Hang Le, or northern Thai curry, and savoury grilled chicken salad with coriander. Also recommended are the signature Khao Mao Gorn Rad Gati, or unripe rice with coconut milk, and the creative seasonal desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Tha%20Phae%20Road%2C%20Chang%20Khlan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Kiti Panit"
  />
);

export default KitiPanit;
