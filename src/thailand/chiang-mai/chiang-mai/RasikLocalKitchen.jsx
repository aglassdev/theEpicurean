...
const RasikLocalKitchen = () => (
  <RestaurantPage
    restaurantName="Rasik Local Kitchen"
    address="44/3 Sridonchai Road, Chang Khlan, Mueang Chiang Mai, Chiang Mai, 50100, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿"
    phoneNumber="+66832696632"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/rasik-local-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chef's table experience showcases seasonal flavours and beloved Thai classics. The talented chef interacts with guests from the open kitchen and uses traditional cooking methods, such as a charcoal stove, to add depth to the dishes. The mild red curry with grilled pork and damask rose looks simple but the authentic taste of homemade Thai curry paste hides inside. The sliced pork is tender and the curry texture is smooth with a rich but balanced flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%2F3%20Sridonchai%20Road%2C%20Chang%20Khlan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050100%2C%20Thailand"
    pageTitle="Rasik Local Kitchen"
  />
);

export default RasikLocalKitchen;
