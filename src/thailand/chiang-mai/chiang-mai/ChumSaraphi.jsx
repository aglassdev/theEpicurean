...
const ChumSaraphi = () => (
  <RestaurantPage
    restaurantName="Chum (Saraphi)"
    address="1/1 Mu 7, Tha Wang Tan, Saraphi, Chiang Mai, 50140, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+6653106530"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/chum-saraphi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chum serves Northern Thai cuisine cooked from the recipes of the family's grandmother. The colourful restaurant is simply decorated with red and yellow walls and brightly coloured parasols of Northern Thai design hanging from the ceilings. The stir-fried pork and liver is well cooked, and packed with Thai herbs, wild pepper and coriander. The mixed Northern Thai starter uses a tasty young chili relish with the scent of green chili that isn’t too spicy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%2F1%20Mu%207%2C%20Tha%20Wang%20Tan%2C%20Saraphi%2C%20Chiang%20Mai%2C%2050140%2C%20Thailand"
    pageTitle="Chum (Saraphi)"
  />
);

export default ChumSaraphi;
