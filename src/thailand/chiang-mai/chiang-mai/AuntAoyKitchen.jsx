...
const AuntAoyKitchen = () => (
  <RestaurantPage
    restaurantName="Aunt Aoy Kitchen"
    address="377 2 Chiang Rai Road, Suthep, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66817160938"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/aunt-aoy-kitchen-1202594"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The décor is simple, with a display of photos and messages on post-it notes from customers gone by. Aunt Aoy spent much of her career cooking in hotel kitchens. Her expertise is realised in the fluffy yet crispy Chef Omelette with stir-fried minced pork, salted egg and pork crackling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=377%202%20Chiang%20Rai%20Road%2C%20Suthep%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Aunt Aoy Kitchen"
  />
);

export default AuntAoyKitchen;
