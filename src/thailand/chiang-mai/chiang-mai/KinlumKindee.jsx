...
const KinlumKindee = () => (
  <RestaurantPage
    restaurantName="Kinlum Kindee"
    address="172 Mu 3, Mueang Len, San Sai, Chiang Mai, 50210, Thailand"
    cuisine="Northern Thai"
    priceRange="฿฿"
    phoneNumber="+66826563941"
    website="http://www.kinlumkindee.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Truth in advertising may be rare, but Kin Lum Kin Dee, which means “to eat delicious food and eat well” in Lanna, allows Northern Thai food lovers to do just that. Formerly downtown, the restaurant is now in a quiet pavilion in San Sai surrounded by gardens, trees, and fields. Dishes are marked by authentic flavours and fresh ingredients, with some from the garden. Grilled field crab innards with egg yolks and northern Thai herb soup with pork are must-tries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=172%20Mu%203%2C%20Mueang%20Len%2C%20San%20Sai%2C%20Chiang%20Mai%2C%2050210%2C%20Thailand"
    pageTitle="Kinlum Kindee"
  />
);

export default KinlumKindee;
