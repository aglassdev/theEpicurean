...
const Chawee = () => (
  <RestaurantPage
    restaurantName="CHAWEE"
    address="84/20 Chang Phueak, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66843249363"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/chawee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chawee, named after the chef-owner's grandmother, offers an intimate, personalised dining experience, as Thai music plays softly in the inviting space with sage-green walls and vintage touches. Dishes draw on childhood memories or old recipes, in a menu that changes monthly, depending on the season and availability of local ingredients. With fragrant lychee and coconut in a harmonious mix, the spicy lychee salad refreshes the palate with its natural sweet-and-sour balance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=84%2F20%20Chang%20Phueak%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="CHAWEE"
  />
);

export default Chawee;
