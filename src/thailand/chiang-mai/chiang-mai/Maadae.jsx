...
const Maadae = () => (
  <RestaurantPage
    restaurantName="Maadae"
    address="86-88 Thapae Road, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66926690514"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/maadae-slow-fish-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Meaning ‘come’ in the Southern language, ‘Maadae’ invites you to enjoy delightful seafood in a welcoming atmosphere. Supporting local Chumphon fishermen and sourcing seasonal organic produce, their menu rotates with fresh ingredients. The evening selection offers diverse options, including superb freshly grilled seafood paired with a spicy sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=86-88%20Thapae%20Road%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Maadae"
  />
);

export default Maadae;
