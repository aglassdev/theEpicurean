...
const SaiyutAndDoctorSaiKitchen = () => (
  <RestaurantPage
    restaurantName="Saiyut and Doctor Sai Kitchen"
    address="32 Chotana Road Soi 12, Pa Tan, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66815301172"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/saiyut-and-doctor-sai-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2004, Doctor Sai has been serving pan-Thai dishes, including royal fare, following recipes from her mother, Saiyud, a former cooking instructor, in a setting reminiscent of dining at home. Start with an elegant appetiser like fried prawns and peanuts in an egg net, flower dumplings, or deep-fried pork wrapped in egg noodles. By dessert – try the sweet potato in syrup – you’ll guess this home, with its warm service, belongs to a royal from a bygone era...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20Chotana%20Road%20Soi%2012%2C%20Pa%20Tan%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Saiyut and Doctor Sai Kitchen"
  />
);

export default SaiyutAndDoctorSaiKitchen;
