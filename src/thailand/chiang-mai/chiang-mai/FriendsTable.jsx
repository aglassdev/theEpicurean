...
const FriendsTable = () => (
  <RestaurantPage
    restaurantName="Friend's Table"
    address="125 Mu 6, Hang Dong, Chiang Mai, 50230, Thailand"
    cuisine="Creative"
    priceRange="฿฿฿"
    phoneNumber="+66815303037"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/friend-s-table"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friend's Table follows a chef's table concept in the glass-enclosed dining wing of the owner's home. Diners can chat with the chefs at work in this stylish interior, dimly lit with a red hue. Collaborating on each dish, the duo of chefs strive for perfection: the food is refined, creatively presented, and packed with flavour, possessing an intensity that is true to the Asian palate. Be sure to be punctual; dinner will start at 7 pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%20Mu%206%2C%20Hang%20Dong%2C%20Chiang%20Mai%2C%2050230%2C%20Thailand"
    pageTitle="Friend's Table"
  />
);
