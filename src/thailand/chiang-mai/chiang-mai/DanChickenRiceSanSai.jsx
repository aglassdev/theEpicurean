...
const DanChickenRiceSanSai = () => (
  <RestaurantPage
    restaurantName="Dan Chicken Rice (San Sai)"
    address="45 Mu 3, Old San Sai Road, San Sai Noi, San Sai, Chiang Mai, 50210, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66810221128"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/dan-chicken-rice-san-sai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years this local favourite has been serving tasty, wallet-friendly chicken rice, first in Sam-Yaek Market in San Sai and now at this larger branch on Old San Sai Road. Show up early, both to beat the crowds and because the food invariably runs out before closing time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Mu%203%2C%20Old%20San%20Sai%20Road%2C%20San%20Sai%20Noi%2C%20San%20Sai%2C%20Chiang%20Mai%2C%2050210%2C%20Thailand"
    pageTitle="Dan Chicken Rice (San Sai)"
  />
);

export default DanChickenRiceSanSai;
