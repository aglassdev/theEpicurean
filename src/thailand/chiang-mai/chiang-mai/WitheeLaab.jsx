...
const WitheeLaab = () => (
  <RestaurantPage
    restaurantName="Withee Laab"
    address="94-120 Charoen Muang Road, Wat Ket, Mueang Chiang Mai, Chiang Mai, 50000, Thailand"
    cuisine="Northern Thai"
    priceRange="฿"
    phoneNumber="+66931922596"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/withee-laab"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming wooden building down a narrow alley has been serving delicious laab for years. The spicy minced buffalo meat and zesty cooked minced pork are sure to impress. With surprisingly affordable prices, this is a gem worth seeking out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=94-120%20Charoen%20Muang%20Road%2C%20Wat%20Ket%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050000%2C%20Thailand"
    pageTitle="Withee Laab"
  />
);

export default WitheeLaab;
