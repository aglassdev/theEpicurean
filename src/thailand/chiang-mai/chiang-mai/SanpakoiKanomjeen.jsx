...
const SanpakoiKanomjeen = () => (
  <RestaurantPage
    restaurantName="Sanpakoi Kanomjeen"
    address="Thongkam Market, 11 Soi Thasatoi, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66613018000"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/sanpakoi-kanomjeen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in 1977 and a local favourite at Thongkam Market, this spot offers tasty and affordable Kanomjeen (fresh rice vermicelli) with various curries. Try the Nam-Lo, a mix of spicy pork and chicken curry sauces. If noodles aren’t your thing, swap them for rice. Not only are the street food dishes here delicious, but they’re great value too – especially when you consider that side vegetables are unlimited...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Thongkam%20Market%2C%2011%20Soi%20Thasatoi%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050000%2C%20Thailand"
    pageTitle="Sanpakoi Kanomjeen"
  />
);

export default SanpakoiKanomjeen;
