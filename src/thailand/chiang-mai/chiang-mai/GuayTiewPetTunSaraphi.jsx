...
const GuayTiewPetTunSaraphi = () => (
  <RestaurantPage
    restaurantName="Guay Tiew Pet Tun Saraphi"
    address="80 Mu 3, Liap Thang Rotfai Road, Saraphi, Chiang Mai, 50140, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66914822850"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/guay-tiew-pet-tun-saraphi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a break and make tracks to this wallet-friendly shop that’s mastered braised duck. The duck noodles use the family’s secret blend of spices, while the roasted duck has succulent meat and crispy skin, moistened by the duck's own jus. Northern-Thai and other dishes are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20Mu%203%2C%20Liap%20Thang%20Rotfai%20Road%2C%20Saraphi%2C%20Chiang%20Mai%2C%2050140%2C%20Thailand"
    pageTitle="Guay Tiew Pet Tun Saraphi"
  />
);

export default GuayTiewPetTunSaraphi;
