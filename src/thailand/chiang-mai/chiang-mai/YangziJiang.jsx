...
const YangziJiang = () => (
  <RestaurantPage
    restaurantName="Yangzi Jiang"
    address="10 Nimmanahaeminda Road Soi 5, Suthep, Mueang Chiang Mai, Chiang Mai, 50200, Thailand"
    cuisine="Chinese"
    priceRange="฿฿฿"
    phoneNumber="+6653225313"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/yangzi-jiang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After years working in various hotels and living for over a decade in Thailand, chef Chan went back to his Hong Kong roots to open this simply decorated Chinese restaurant inside a contemporary Lanna house in trendy Nimmanahaeminda. His cooking is fresh, clean and well-executed; the menu includes a variety of house-made dim sum alongside dishes like Chinese stir-fried prawns and a stand-out crispy pork belly. Advanced booking is highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Nimmanahaeminda%20Road%20Soi%205%2C%20Suthep%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050200%2C%20Thailand"
    pageTitle="Yangzi Jiang"
  />
);

export default YangziJiang;
