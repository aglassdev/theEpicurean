...
const GuayJubChangMoiTatMai = () => (
  <RestaurantPage
    restaurantName="Guay Jub Chang Moi Tat Mai"
    address="99/11-12 Chang Moi Tat Mai Road, Chang Moi, Mueang Chiang Mai, Chiang Mai, 50300, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6653251451"
    website="https://guide.michelin.com/en/chiang-mai-region/chiang-mai/restaurant/guay-jub-chang-moi-tat-mai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place specialises in Guay Jub with Sai Ua sausage, served in a unique peppery broth, featuring with crispy pork and pork liver. They also offer another delightful dish: fresh spring rolls, topped with sliced omelette and aromatic sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%2F11-12%20Chang%20Moi%20Tat%20Mai%20Road%2C%20Chang%20Moi%2C%20Mueang%20Chiang%20Mai%2C%20Chiang%20Mai%2C%2050300%2C%20Thailand"
    pageTitle="Guay Jub Chang Moi Tat Mai"
  />
);

export default GuayJubChangMoiTatMai;
