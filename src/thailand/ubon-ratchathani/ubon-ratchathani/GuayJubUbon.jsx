...
const GuayJubUbon = () => (
  <RestaurantPage
    restaurantName="Guay Jub Ubon"
    address="7 Phrommathep Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66870740499"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/guay-jub-ubon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 70 years, this little gem has maintained strict quality control, carefully selecting offal from more than 10kg of offcuts each day. Their specialty is guay jub rice noodles with pork offal in a dark five-spice soup. They also serve delectable egg noodle and wonton soups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Phrommathep%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Guay Jub Ubon"
  />
);

export default GuayJubUbon;
