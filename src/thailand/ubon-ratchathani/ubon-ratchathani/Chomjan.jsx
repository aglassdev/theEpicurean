...
const Chomjan = () => (
  <RestaurantPage
    restaurantName="Chomjan"
    address="119/1 Mu 8, Niwatwithi Road, Kham Nam Chaep, Warin Chamrap, Ubon Ratchathani, 34190, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66844771999"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/chomjan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the banks of the Mun River, next to a 100-year-old bridge, sits Chomjan, popular with locals and non-locals enjoying penetrating sunsets, a fresh river breeze and live music across different themed dining areas. It caters for everyone, serving classic Thai, Isan and international dishes and fresh local fish. The deep-fried snakehead fish with stir-fried eggplant is recommended; the juicy giant catfish with fresh herbal soup is also delightful...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=119%2F1%20Mu%208%2C%20Niwatwithi%20Road%2C%20Kham%20Nam%20Chaep%2C%20Warin%20Chamrap%2C%20Ubon%20Ratchathani%2C%2034190%2C%20Thailand"
    pageTitle="Chomjan"
  />
);

export default Chomjan;
