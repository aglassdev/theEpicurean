...
const AgaveUBO = () => (
  <RestaurantPage
    ...
    address="153 Phalorangrit Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Vietnamese"
    priceRange="฿฿"
    phoneNumber="+6645900241"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/agave"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner, an agave plant enthusiast, has adorned this cosy space with agave plants throughout. Vietnamese home cooking, enhanced with local Isan spices, fills the air, accompanied by instrumental music in the high-ceilinged room. All ingredients are homemade, offering a choice of pork or fish sausage for the namneung. Don't miss the standout sticky rice waffle served with sun-dried pork, infused with local Isan flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=153%20Phalorangrit%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Agave"
  />
);

export default AgaveUBO;
