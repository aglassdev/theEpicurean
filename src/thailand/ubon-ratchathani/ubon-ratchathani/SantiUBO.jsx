...
const SantiUBO = () => (
  <RestaurantPage
    ...
    address="101-107 Chawala Nok Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿฿"
    phoneNumber="+6645240233"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/santi-pochana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners can sit inside or roadside in this simple, open-air restaurant. Thai-Chinese is the fare and dishes are prepared at the front. The sound of the wok and sight of the flames make an impressive spectacle. The stir-fried minced pork with olives is a must for its smoky, intense flavours. The deep-fried seabass with sweet fish sauce takes a little longer to prepare but the result is a fantastically crispy skin that goes well with the homemade spicy sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101-107%20Chawala%20Nok%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Santi"
  />
);

export default SantiUBO;
