...
const SamchaiCoffeeThepyothiRoad = () => (
  <RestaurantPage
    restaurantName="Samchai Coffee (Thepyothi Road)"
    address="168/4 Thepyothi Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6645245998"
    website="https://www.samchai-group.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu boasts a tasty dried shredded pork and a range of sausages. A highlight is the Indochina pan-fried egg served with a side sandwich. The eggs are cooked sunny side up with margarine, then topped with sweet and salty Chinese sausage and peppery Vietnamese sausage slices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=168%2F4%20Thepyothi%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Samchai Coffee (Thepyothi Road)"
  />
);

export default SamchaiCoffeeThepyothiRoad;
