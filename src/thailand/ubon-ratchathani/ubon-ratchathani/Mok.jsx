...
const Mok = () => (
  <RestaurantPage
    restaurantName="Mok"
    address="115 Phrommarat Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66952924622"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/mok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stepping into this two-storey house feels like visiting a friend's welcoming home, with a snug dining room and a plant-filled terrace. Adapted from grandma's Thai and Isan recipes, they offer a variety of menus suited for modern tastes. Don't miss the herb-infused seabass with fermented fish sauce and the unique fermented fish paired with pineapple relish and fresh veggies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Phrommarat%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Mok"
  />
);
