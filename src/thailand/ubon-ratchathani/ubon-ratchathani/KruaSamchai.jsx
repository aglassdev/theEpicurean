...
const KruaSamchai = () => (
  <RestaurantPage
    restaurantName="Krua Samchai"
    address="282/1 Phalochai Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Isan"
    priceRange="฿฿"
    phoneNumber="+6645209118"
    website="https://www.samchai-group.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two roosters stand guard at the entrance. Krua Samchai is famous for serving iconic Isan food befitting of the region. Fresh fish from the Mekong and Mun rivers is cooked using the chef's secret mix of herbs and spices that produces a powerful aroma. The grilled chicken has a crispy golden skin from the charcoal flame but retains its juicy meat. The Isan-style spicy fish maw and bamboo shoot soup uses tiliacora juice to perfection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=282%2F1%20Phalochai%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Krua Samchai"
  />
);

export default KruaSamchai;
