...
const PakMorRobot = () => (
  <RestaurantPage
    restaurantName="Pak Mor Robot"
    address="82 Benchama Road, Nai Mueang, Mueang Ubon Ratchathani, Ubon Ratchathani, 34000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66867109768"
    website="https://guide.michelin.com/en/ubon-ratchathani-province/ubon-ratchathani/restaurant/pak-mor-robot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef owner of Pak Mor Robot has satisfied the tummies of locals for over 30 years. She prepares a variety of Vietnamese dumplings in a steamer at the front of this neat little outlet. The signature, her own invention, is the incredibly tasty Vietnamese dumpling with fried eggs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20Benchama%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Ubon%20Ratchathani%2C%20Ubon%20Ratchathani%2C%2034000%2C%20Thailand"
    pageTitle="Pak Mor Robot"
  />
);

export default PakMorRobot;
