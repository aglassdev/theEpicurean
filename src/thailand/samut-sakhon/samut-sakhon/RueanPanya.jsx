...
const RueanPanya = () => (
  <RestaurantPage
    restaurantName="Ruean Panya"
    address="1300/600 Soi Ekkachai 13, Norarat Uthit Road, Maha Chai, Mueang Samut Sakhon, Samut Sakhon, 74000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6634424707"
    website="https://guide.michelin.com/en/samut-sakhon-region/samut-sakhon/restaurant/ruean-panya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open since 1995, this family-run restaurant – which blends food and art – is a hidden gem. Spread across four houses, it has a relaxed vibe that gives the impression of dining at a friend's, while painting-filled interiors add a gallery feel. Owner Prunhnee does all the cooking herself; her attention to detail and the complexity of flavours make her dishes memorable. Local seafood is a feature, and their signature mud crab coconut dip or ‘Lhon Pu’ is a must-have...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1300%2F600%20Soi%20Ekkachai%2013%2C%20Norarat%20Uthit%20Road%2C%20Maha%20Chai%2C%20Mueang%20Samut%20Sakhon%2C%20Samut%20Sakhon%2C%2074000%2C%20Thailand"
    pageTitle="Ruean Panya"
  />
);

export default RueanPanya;
