...
const YiouiNoodles = () => (
  <RestaurantPage
    restaurantName="Yi-Oui Noodles"
    address="6/11 Phang-Nga 3025 Rural Road, Thai Mueang, Phang-Nga, 82120, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6676571790"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/yi-oui-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aunty Oui has been delighting locals with the intense flavour of her noodle soups since 1971. Each table is laden with a basket of soft-boiled eggs; diners are welcome to finish as many as they can manage. The pork rib soup is a highlight and a Thai dessert rounds off the meal nicely...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%2F11%20Phang-Nga%203025%20Rural%20Road%2C%20Thai%20Mueang%2C%20Phang-Nga%2C%2082120%2C%20Thailand"
    pageTitle="Yi-Oui Noodles"
  />
);

export default YiouiNoodles;
