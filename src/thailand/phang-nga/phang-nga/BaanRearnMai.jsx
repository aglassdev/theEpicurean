...
const BaanRearnMai = () => (
  <RestaurantPage
    restaurantName="Baan Rearn Mai"
    address="Ban Khok Kloi - Na Tai, Khok Kloi, Takua Thung, Phang-Nga, 82140, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66878190581"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/baan-rearn-mai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Operating for 25 years, this small eatery offers an à la carte menu focused on seafood. The freshly prepared meals are light, allowing the natural umami of the seafood to shine. In addition to their signature yellow curry crab, the steamed sea bass with soy sauce is a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ban%20Khok%20Kloi%20-%20Na%20Tai%2C%20Khok%20Kloi%2C%20Takua%20Thung%2C%20Phang-Nga%2C%2082140%2C%20Thailand"
    pageTitle="Baan Rearn Mai"
  />
);

export default BaanRearnMai;
