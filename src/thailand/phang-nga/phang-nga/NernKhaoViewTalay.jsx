...
const NernKhaoViewTalay = () => (
  <RestaurantPage
    restaurantName="Nern Khao View Talay"
    address="18/6 Mu 10, Soi Namtok Wat Khao, Khok Kloi, Takua Thung, Phang-Nga, 82140, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6676582182"
    website="https://www.nernkhaoviewtalay.rnanagrand.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nern Khao View Talay offers stunning views of mountains and sea from up high on a hill. Serving Thai and southern cuisine, the stir-fried pork with shrimp paste is a highlight. The aromatic paste mixes nicely with herbal notes and deep-fried shallot, while the thick sour curry soup with shrimp has a deep orange colour, tasty acacia omelette and plump shrimps. What about tackling that steep slope? There’s a shuttle service from the car park at the foot of the hill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%2F6%20Mu%2010%2C%20Soi%20Namtok%20Wat%20Khao%2C%20Khok%20Kloi%2C%20Takua%20Thung%2C%20Phang-Nga%2C%2082140%2C%20Thailand"
    pageTitle="Nern Khao View Talay"
  />
);

export default NernKhaoViewTalay;
