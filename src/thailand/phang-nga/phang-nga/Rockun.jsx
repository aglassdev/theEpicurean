...
const Rockun = () => (
  <RestaurantPage
    restaurantName="Rock-Un"
    address="85 Si Mueang Road, Takua Pa, Phang-Nga, 82110, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66878959604"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/rock-un"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The signature pork leg, which is stewed for 6 hours, has a spicy, charcoal flavour – the tasty recipe comes from the chef-owner’s Chinese great grandfather. Photos of visiting royals confirm its prestige; one of the most popular places among the Sino-Portuguese buildings of the old town...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20Si%20Mueang%20Road%2C%20Takua%20Pa%2C%20Phang-Nga%2C%2082110%2C%20Thailand"
    pageTitle="Rock-Un"
  />
);

export default Rockun;
