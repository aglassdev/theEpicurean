...
const KhanomJeenBaanBangKan = () => (
  <RestaurantPage
    restaurantName="Khanom Jeen Baan Bang Kan"
    address="21/3 Mu 4, Mueang Phang-nga-Takua Pa Road, Thung Kha Ngok, Mueang Phang-nga, Phang-Nga, 82000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66895887820"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/khanom-jeen-baan-bang-kan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years, locals have enjoyed this shop’s Khanom Jeen, or rice noodles, which are served with a choice of three curries and more than 20 types of fresh or pickled veggies. Noodles are unlimited, but save room for the refreshing cendol in coconut milk. Closed Thursday and Friday...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%2F3%20Mu%204%2C%20Mueang%20Phang-nga-Takua%20Pa%20Road%2C%20Thung%20Kha%20Ngok%2C%20Mueang%20Phang-nga%2C%20Phang-Nga%2C%2082000%2C%20Thailand"
    pageTitle="Khanom Jeen Baan Bang Kan"
  />
);

export default KhanomJeenBaanBangKan;
