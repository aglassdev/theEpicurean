...
const KhanomChinPaSon = () => (
  <RestaurantPage
    restaurantName="Khanom Chin Pa Son"
    address="3 Borirak Bamrung Road, Thai Chang, Mueang Phang-nga, Phang-Nga, 82000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66865939658"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/khanom-chin-pa-son"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Across from a Chinese shrine, this self-service buffet has been drawing devotees for over 30 years with its tasty khanom chin and four curry options to mix and match. Pick from a wide range of condiments, fresh vegetables, boiled egg and crispy anchovies. Lunchtime is always busy, so arrive early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Borirak%20Bamrung%20Road%2C%20Thai%20Chang%2C%20Mueang%20Phang-nga%2C%20Phang-Nga%2C%2082000%2C%20Thailand"
    pageTitle="Khanom Chin Pa Son"
  />
);

export default KhanomChinPaSon;
