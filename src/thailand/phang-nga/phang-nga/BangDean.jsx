...
const BangDean = () => (
  <RestaurantPage
    restaurantName="Bang Dean"
    address="16/10 Mu 1, Phet Kasem Road, Bang Nai Si, Takua Pa, Phang-Nga, 82110, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66833927196"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/bang-dean"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nearby the Takua Pa Government Office, this street food place serves Thai-Muslim dishes, including excellent chicken biryani, plus crispy rotis paired with savoury curries or sweet condensed milk and banana. Open for breakfast through late lunch, it closes when the food runs out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%2F10%20Mu%201%2C%20Phet%20Kasem%20Road%2C%20Bang%20Nai%20Si%2C%20Takua%20Pa%2C%20Phang-Nga%2C%2082110%2C%20Thailand"
    pageTitle="Bang Dean"
  />
);

export default BangDean;
