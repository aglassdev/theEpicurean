...
const KruaLuangTen = () => (
  <RestaurantPage
    restaurantName="Krua Luang Ten"
    address="160 Mu 2, Phet Kasem Road, Khuekkhak, Takua Pa, Phang-Nga, 82190, Thailand"
    cuisine="Southern Thai"
    priceRange="฿"
    phoneNumber="+66907164182"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/krua-luang-ten"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Krua Luang Ten makes for an unusual setting with its tables arranged on sand-covered floors. Check the whiteboard for the specials, which often feature the catch of the day and seasonal ingredients. The dishes masterfully balance robust Southern Thai flavours for authentic spiciness, and the complimentary vegetables come with tai pla sauce. N.B. The restaurant is closed on the 10th, 20th, and 30th of the month...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=160%20Mu%202%2C%20Phet%20Kasem%20Road%2C%20Khuekkhak%2C%20Takua%20Pa%2C%20Phang-Nga%2C%2082190%2C%20Thailand"
    pageTitle="Krua Luang Ten"
  />
);

export default KruaLuangTen;
