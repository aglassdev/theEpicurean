...
const ThianLengBakKutTeh = () => (
  <RestaurantPage
    restaurantName="Thian Leng Bak Kut Teh"
    address="35 Mu 4, Phet Kasem Road, Khok Kloi, Takua Thung, Phang-Nga, 82140, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+66812739465"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/thian-leng-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Using heavenly recipes from Kedah, Malaysian Bak Kut Teh is a divine pork rib soup with Chinese herbs, served in a clay pot. The succulent slow-cooked meat simply slips off the bone. The chef is so confident about its tastiness, there’s a money-back guarantee for those who disagree!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Mu%204%2C%20Phet%20Kasem%20Road%2C%20Khok%20Kloi%2C%20Takua%20Thung%2C%20Phang-Nga%2C%2082140%2C%20Thailand"
    pageTitle="Thian Leng Bak Kut Teh"
  />
);

export default ThianLengBakKutTeh;
