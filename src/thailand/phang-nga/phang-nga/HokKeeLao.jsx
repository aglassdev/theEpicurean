...
const HokKeeLao = () => (
  <RestaurantPage
    restaurantName="Hok Kee Lao"
    address="19 Senarat Road, Bang Nai Si, Takua Pa, Phang-Nga, 82110, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿฿"
    phoneNumber="+6676421938"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/hok-kee-lao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 40 years, this heritage restaurant has been serving up delicious Thai, Chinese, and Southern flavours. It's an ideal spot for family gatherings, offering a warm and inviting atmosphere. The menu includes Chinese favourites such as nicely moist chicken pae sa flavoured with seasoned soy sauce and paired with morning glory. If you are lucky, try the fried tofu with minced pork and shrimp...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Senarat%20Road%2C%20Bang%20Nai%20Si%2C%20Takua%20Pa%2C%20Phang-Nga%2C%2082110%2C%20Thailand"
    pageTitle="Hok Kee Lao"
  />
);

export default HokKeeLao;
