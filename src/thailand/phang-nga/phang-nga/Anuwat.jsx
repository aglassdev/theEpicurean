...
const Anuwat = () => (
  <RestaurantPage
    restaurantName="Anuwat"
    address="201 Mu 4, Phet Kasem Road, Thai Mueang, Phang-Nga, 82120, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66835269648"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/anuwat-photchana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There may be a big sign out front, but it’s the aromatic pork that’s been luring in the locals for more than 40 years. The grilled pork, BBQ pork and crispy pork belly are well marinated and grilled till succulent. Try any or all — plus steamed chicken — on a single plate served with rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=201%20Mu%204%2C%20Phet%20Kasem%20Road%2C%20Thai%20Mueang%2C%20Phang-Nga%2C%2082120%2C%20Thailand"
    pageTitle="Anuwat"
  />
);

export default Anuwat;
