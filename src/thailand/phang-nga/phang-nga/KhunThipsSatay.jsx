...
const KhunThipsSatay = () => (
  <RestaurantPage
    restaurantName="Khun Thip's Satay"
    address="184 Phet Kasem Road, Thai Chang, Mueang Phang-nga, Phang-Nga, 82000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66866915966"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/khun-thip-s-satay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Serving satay, and only satay, since 1975 – it’s now Phang-Nga’s iconic food. The 2-day marinated sauce smothers charcoal-grilled chicken, pork, pork intestine or shrimp. Our favourite is the tender pork satay with coconut aroma, rich peanut flavour and fresh cucumber relish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=184%20Phet%20Kasem%20Road%2C%20Thai%20Chang%2C%20Mueang%20Phang-nga%2C%20Phang-Nga%2C%2082000%2C%20Thailand"
    pageTitle="Khun Thip's Satay"
  />
);

export default KhunThipsSatay;
