...
const KhokKloiTomYamNoodlesWithEggs = () => (
  <RestaurantPage
    restaurantName="Khok Kloi Tom Yam Noodles with Eggs"
    address="6/10 Phet Kasem Road, Khok Kloi, Takua Thung, Phang-Nga, 82140, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66630235361"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/khok-kloi-bami-tom-yam-khai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Their fresh tom yum noodles are accompanied by piquant spicy and sour flavours; dry or in an intense broth. They’re known for impressively sized portions at reasonable prices. The soft minced pork and healthy liver have a beautiful scent of fresh lime juice and chilli in a sweet broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%2F10%20Phet%20Kasem%20Road%2C%20Khok%20Kloi%2C%20Takua%20Thung%2C%20Phang-Nga%2C%2082140%2C%20Thailand"
    pageTitle="Khok Kloi Tom Yam Noodles with Eggs"
  />
);

export default KhokKloiTomYamNoodlesWithEggs;
