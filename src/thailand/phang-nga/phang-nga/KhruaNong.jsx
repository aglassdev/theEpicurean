...
const KhruaNong = () => (
  <RestaurantPage
    restaurantName="Khrua Nong"
    address="132/8 Phet Kasem Road, Bang Nai Si, Takua Pa, Phang-Nga, 82110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6676424497"
    website="https://guide.michelin.com/en/th-phang-nga-region/th-phang-nga/restaurant/khrua-nong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The husband-and-wife team go to market every day to select fresh, local ingredients and seafood and offer a wide selection of Thai dishes. Check the blackboard for the specials which change every day, but the crispy softshell crab with a peppery chilli sauce is unmissable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=132%2F8%20Phet%20Kasem%20Road%2C%20Bang%20Nai%20Si%2C%20Takua%20Pa%2C%20Phang-Nga%2C%2082110%2C%20Thailand"
    pageTitle="Khrua Nong"
  />
);

export default KhruaNong;
