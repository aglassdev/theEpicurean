...
const Janhom = () => (
  <RestaurantPage
    restaurantName="Janhom"
    address="273/4 Soi Ramkhamhaeng 21, Ramkhamhaeng Road, Wang Thonglang, Bangkok, 10310, Thailand"
    cuisine="Southern Thai"
    priceRange="฿"
    phoneNumber="+6623191128"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/janhom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aunty Paew has been serving intense southern Thai cuisine for over 20 years, using daily fresh ingredients to inform a changing menu. The chef makes her own curry paste, and signature dishes include Kaeng Tai Pla fish curry and stir-fried sataw beans with shrimp and aromatic shrimp paste. The deep-fried frog with turmeric is another standout. Chilled watermelon refreshes the palate after this fiery feast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=273%2F4%20Soi%20Ramkhamhaeng%2021%2C%20Ramkhamhaeng%20Road%2C%20Wang%20Thonglang%2C%20Bangkok%2C%2010310%2C%20Thailand"
    pageTitle="Janhom"
  />
);

export default Janhom;
