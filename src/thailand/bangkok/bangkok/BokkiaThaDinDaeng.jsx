...
const BokkiaThaDinDaeng = () => (
  <RestaurantPage
    restaurantName="Bokkia Tha Din Daeng"
    address="323 Tha Din Daeng Road, Somdet Chao Phraya, Khlong San, Bangkok, 10600, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66817512659"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/bokkia-tha-din-daeng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a small market stall, this family-run dessert shop is famous for its sweet Bokkia. It's a unique treat: egg noodles, topped with crushed ice and syrup, which is amazingly refreshing and not too sweet. The condimental options are also good quality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=323%20Tha%20Din%20Daeng%20Road%2C%20Somdet%20Chao%20Phraya%2C%20Khlong%20San%2C%20Bangkok%2C%2010600%2C%20Thailand"
    pageTitle="Bokkia Tha Din Daeng"
  />
);

export default BokkiaThaDinDaeng;
