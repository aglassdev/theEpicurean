...
const NoNameNoodle = () => (
  <RestaurantPage
    restaurantName="No Name Noodle"
    address="1F, Room P2, 1/2 Soi Athakravi 1, Sukhumvit 26 Road, Khlong Tan, Khlong Toei, Bangkok, 10110, Thailand"
    cuisine="Noodles"
    priceRange="฿฿"
    phoneNumber="+66820595417"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/no-name-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Those lucky enough to secure a spot are treated to signature noodle dishes, Shio Soba and Shoyu Tsuke Soba, each with over 30 ingredients. The seasonal noodle and rice bowls use a fermented blend of three types of shoyu for deep umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Room%20P2%2C%201%2F2%20Soi%20Athakravi%201%2C%20Sukhumvit%2026%20Road%2C%20Khlong%20Tan%2C%20Khlong%20Toei%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="No Name Noodle"
  />
);

export default NoNameNoodle;
