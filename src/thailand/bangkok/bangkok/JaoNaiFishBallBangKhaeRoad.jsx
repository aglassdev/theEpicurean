...
const JaoNaiFishBallBangKhaeRoad = () => (
  <RestaurantPage
    restaurantName="Jao Nai Fish Ball (Bang Khae Road)"
    address="103/14 Bang Khae Road, Bang Khae, Bangkok, 10160, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66989294099"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jao-nai-fish-ball"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a vintage townhouse, this popular street food joint serves up savory fish ball noodle soup. Expect fresh, made-to-order meals that might require a wait due to the frequent bustle. However, the wait pays off with homemade seafood like fish balls, fish dumplings, and fish cakes, all enhancing the soup's umami taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=103%2F14%20Bang%20Khae%20Road%2C%20Bang%20Khae%2C%20Bangkok%2C%2010160%2C%20Thailand"
    pageTitle="Jao Nai Fish Ball (Bang Khae Road)"
  />
);

export default JaoNaiFishBallBangKhaeRoad;
