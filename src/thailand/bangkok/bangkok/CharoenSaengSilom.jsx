...
const CharoenSaengSilom = () => (
  <RestaurantPage
    restaurantName="Charoen Saeng Silom"
    address="492/6 Soi Charoen Krung 49, Silom Road, Suriyawong, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+6622344602"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/charoen-saeng-silom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stewed in a rich, aromatic gravy with Chinese herbs, the soft, caramelised pork tantalises the tastebuds, and is a Bangkok favourite. The recipe, created by the owner’s grandfather in 1959, was adapted by her father. It’s served with a homemade spicy sauce and pickles and is great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=492%2F6%20Soi%20Charoen%20Krung%2049%2C%20Silom%20Road%2C%20Suriyawong%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Charoen Saeng Silom"
  />
);

export default CharoenSaengSilom;
