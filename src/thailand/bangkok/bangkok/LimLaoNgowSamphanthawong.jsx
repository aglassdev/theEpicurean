...
const LimLaoNgowSamphanthawong = () => (
  <RestaurantPage
    restaurantName="Lim Lao Ngow (Samphanthawong)"
    address="299-301 Song Sawat Road, Samphanthawong, Bangkok, 10100, Thailand"
    cuisine="Street Food, Noodles"
    priceRange="฿"
    phoneNumber="+66816404750"
    website="https://www.limlaongoworiginal.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After 60 years in business, the family boasts multiple branches, but the original, in Chinatown, is our pick. The bouncy fish ball concept definitely lives up to its name. Made from fresh fish and no flour, they’re served with Chinese noodles and wontons, and leave a joyful aftertaste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=299-301%20Song%20Sawat%20Road%2C%20Samphanthawong%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Lim Lao Ngow (Samphanthawong)"
  />
);

export default LimLaoNgowSamphanthawong;
