...
const SushiMasato = () => (
  <RestaurantPage
    ...
    cuisine="Sushi"
    priceRange="฿฿฿฿"
    phoneNumber="+66972341370"
    website="https://www.sushimasato.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Japanese seas provide a rich bounty of seasonal delights: spring offers an abundance of fresh shellfish, while winter brings the indulgence of rich, fatty fish. At Sushi Masato, guests enjoy this premium seasonal produce flown in daily from Tokyo's renowned Toyosu Market. The experience is elevated by Chef Masato's exceptional techniques, perfected over his years in Japan and New York. You may request to be served by Chef Masato when making a reservation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%2F22%20Soi%20Sukhumvit%2031%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Sushi Masato"
  />
);

export default SushiMasato;
