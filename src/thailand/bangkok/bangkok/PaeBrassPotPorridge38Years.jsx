...
const PaeBrassPotPorridge38Years = () => (
  <RestaurantPage
    restaurantName="Pae Brass Pot Porridge 38 Years"
    address="320 Pracha Rat Sai 1 Road, Bang Sue, Bangkok, 10800, Thailand"
    cuisine="Congee"
    priceRange="฿"
    phoneNumber="+6625868852"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/pae-jok-38-years"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don't let the name mislead you – 38 is a nod to the founder's lucky number. This porridge hotspot has been simmering since 1962, serving up porridge in its signature brass pots for three generations. Our favourite is the mixed rice porridge option...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=320%20Pracha%20Rat%20Sai%201%20Road%2C%20Bang%20Sue%2C%20Bangkok%2C%2010800%2C%20Thailand"
    pageTitle="Pae Brass Pot Porridge 38 Years"
  />
);

export default PaeBrassPotPorridge38Years;
