...
const Margo = () => (
  <RestaurantPage
    restaurantName="Margo"
    address="303 Soi Naradhiwas Rajanagarindra 10 Lane 20, Thung Wat Don, Sathon, Bangkok, 10120, Thailand"
    cuisine="French"
    priceRange="฿฿฿"
    phoneNumber="+66829829259"
    website="https://www.margobkk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Warm wood, geometric patterns and an open kitchen set the tone for a modern bistro, and the buzzy dining room adds to the charm. Chef Wilfrid Hocquet brings polished French classics to this lively, design-forward space, which opened in July 2025. The compact menu follows the French seasons and includes house-made delights such as Kurobuta pork terrine, beef tomato farcie and Paris ham pithiviers. It's best to book ahead – Margo is already drawing crowds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=303%20Soi%20Naradhiwas%20Rajanagarindra%2010%20Lane%2020%2C%20Thung%20Wat%20Don%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Margo"
  />
);
