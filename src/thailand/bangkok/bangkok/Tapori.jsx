...
const Tapori = () => (
  <RestaurantPage
    restaurantName="Tapori"
    address="22/2 Soi Sukhumvit 47, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Indian"
    priceRange="฿฿฿"
    phoneNumber="+66645693798"
    website="https://www.taporibkk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tapori is a chic and intimate Indian dining spot with warm lighting, modern yet subtly traditional decor and a cosy feel. A 200‐year‐old wooden door from Rajasthan welcomes guests into a space adorned with Warli, Bastar and Pichwai art. Inspired by India's 28 states, the chef-owner reworks the classics, fusing bold spices with innovation. For dessert, try their unique take on Benami Kheer. A hidden bar serves cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%2F2%20Soi%20Sukhumvit%2047%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Tapori"
  />
);

export default Tapori;
