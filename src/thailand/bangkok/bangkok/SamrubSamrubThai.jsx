...
const SamrubSamrubThai = () => (
  <RestaurantPage
    restaurantName="Samrub Samrub Thai"
    address="39/11 Soi Yommarat, Si Lom, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+66996517292"
    website="https://www.samrubsamrubthai.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This white, 4-storey renovated house in Si Lom hosts an intimate dining experience. The menu changes bi-monthly as chef Prin Polsuk, well-known on the scene for his work at Nahm and Sala Rim Naam, is inspired by new discoveries and seasonal changes. Delving into rare cookbooks, he reproduces ancient Thai recipes that trace the ages, and crafts a complex amalgamation of aromas to serve a truly original tasting menu. Bookings are only through social media...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%2F11%20Soi%20Yommarat%2C%20Si%20Lom%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Samrub Samrub Thai"
  />
);

export default SamrubSamrubThai;
