...
const TempuraKanda = () => (
  <RestaurantPage
    restaurantName="Tempura Kanda"
    address="1F, Eight Thonglor Building 88/36, Sukhumvit 55 Road, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Tempura"
    priceRange="฿฿฿฿"
    phoneNumber="+66909974991"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/tempura-kanda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This was one of the first omakase restaurants in the city, which means you’re placing your order in the hands of an experienced chef – in this case one with a mastery of tempura. Seasonal Japanese ingredients are imported, then carefully cooked. The batter is light and crispy, while the filling retains the produce’s natural flavours. The interior décor sticks to a simple approach, with a marble-topped counter adding some charm. Booking is essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Eight%20Thonglor%20Building%2088%2F36%2C%20Sukhumvit%2055%20Road%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Tempura Kanda"
  />
);

export default TempuraKanda;
