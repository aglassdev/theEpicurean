...
const Jamn = () => (
  <RestaurantPage
    restaurantName="Jamn"
    address="8 Soi Chan 43 Yaek 41, Bang Khlo, Bang Kho Laem, Bangkok, 10120, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+66969544292"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jamn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jamn offers a private dining experience in a family home. The menu is customised to your preferences or features typical Thai dishes. Their family set menu includes an appetiser, dessert, and a main course presented in the Thai samrap style with five dishes for sharing. We recommend starting with the crispy shrimp paste rice with sweet tiny shrimp and sour mango. A minimum charge per table is required...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Soi%20Chan%2043%20Yaek%2041%2C%20Bang%20Khlo%2C%20Bang%20Kho%20Laem%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Jamn"
  />
);
