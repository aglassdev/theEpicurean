...
const LumaBAN = () => (
  <RestaurantPage
    restaurantName="Luma"
    address="113/9-10 Soi Sukhumvit 55, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Spanish"
    priceRange="฿฿฿"
    phoneNumber="+66996141158"
    website="https://www.lumabkk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Keen amateur cooks should ask for a seat at the L-shaped counter if they want a full view of a busy kitchen in action; if you’re coming in a larger group then request a table on the mezzanine floor. Spanish food in all its colour and vitality is celebrated here, from assorted tapas to classics like paella and suckling pig. All the dishes are generously sized and most are for sharing, so tend towards under-ordering unless you want plenty to take home with you. Start with Gilda, the classic Basque pintxo, and some jamón ibérico while you browse the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=113%2F9-10%20Soi%20Sukhumvit%2055%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Luma"
  />
);

export default LumaBAN;
