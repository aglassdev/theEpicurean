...
const Scarlett = () => (
  <RestaurantPage
    restaurantName="Scarlett"
    address="37F, Pullman Hotel G, 188 Silom Road, Suriyawong, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Grills"
    priceRange="฿฿฿"
    phoneNumber="+66968607990"
    website="https://www.randblab.com/scarlett-bangkok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on the top floor of the trendy Pullman Hotel, Scarlett offers a fashionable and lively spot to enjoy a creative cocktail and dine while the lights of Bangkok twinkle below. Alongside a list of classic French dishes, prime Australian steaks are broiled on the chargrill – the focal point of the lively open kitchen. Allow the knowledgeable staff to help you choose from the comprehensive list of reasonably priced wines. Desserts are a highlight so save room for something sweet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37F%2C%20Pullman%20Hotel%20G%2C%20188%20Silom%20Road%2C%20Suriyawong%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Scarlett"
  />
);
