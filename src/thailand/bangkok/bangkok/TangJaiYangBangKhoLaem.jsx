...
const TangJaiYangBangKhoLaem = () => (
  <RestaurantPage
    restaurantName="Tang Jai Yang (Bang Kho Laem)"
    address="171 Chan Road, Wat Phraya Krai, Bang Kho Laem, Bangkok, 10120, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+66805444645"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/tang-jai-yang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tang Jai Yang’s chef started cooking char siu, or Cantonese-style barbecue pork, for family and friends before selling it online. There, it went viral, so he opened this understated place. Since almost every dish on the menu contains the succulent pork, you can’t really go wrong...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=171%20Chan%20Road%2C%20Wat%20Phraya%20Krai%2C%20Bang%20Kho%20Laem%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Tang Jai Yang (Bang Kho Laem)"
  />
);

export default TangJaiYangBangKhoLaem;
