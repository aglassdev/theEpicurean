...
const CteByMauroColagreco = () => (
  <RestaurantPage
    restaurantName="Côte by Mauro Colagreco"
    address="2F, Capella Bangkok, 300/2 Charoenkrung Road, Yan Nawa, Sathon, Bangkok, 10120, Thailand"
    cuisine="Modern Cuisine"
    priceRange="฿฿฿฿"
    phoneNumber="+6620983888"
    website="https://www.capellahotels.com/en/capella-bangkok/dining/cote-by-mauro-colagreco"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Côte brings the essence of Riviera-inspired cuisine to Bangkok, embracing Mediterranean, French and Italian influences. The dishes are skilfully crafted and presented using modern techniques by Italian chef Davide Garavaglia, who worked at Colagreco's principal restaurant for years. The culinary team revels in surprising guests at each course, curating seasonal menus based on the finest produce available that day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Capella%20Bangkok%2C%20300%2F2%20Charoenkrung%20Road%2C%20Yan%20Nawa%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Côte by Mauro Colagreco"
  />
);

export default CteByMauroColagreco;
