...
const DuetByDavidToutain = () => (
  <RestaurantPage
    restaurantName="Duet by David Toutain"
    address="7F, The Ritz-Carlton, Bangkok, 189 Witthayu Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Modern Cuisine"
    priceRange="฿฿฿฿"
    phoneNumber="+6621807798"
    website="https://www.ritzcarlton.com/en/hotels/bkkrb-the-ritz-carlton-bangkok/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this elegant space, set within a serene glasshouse on the seventh floor of The Ritz-Carlton, lush greenery blends with a striking wooden ceiling carved with nature-inspired motifs. Chef David Toutain presents a seasonal tasting menu that is creative, delicate and distinctly plant-forward, with clever touches that balance land and sea. The zero-proof drink pairing is a smart choice, enhancing flavours without overwhelming the delicate nuances of the food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%20The%20Ritz-Carlton%2C%20Bangkok%2C%20189%20Witthayu%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Duet by David Toutain"
  />
);

export default DuetByDavidToutain;
