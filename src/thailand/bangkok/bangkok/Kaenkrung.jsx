...
const Kaenkrung = () => (
  <RestaurantPage
    restaurantName="KAENKRUNG"
    address="521/11 Arunamarin Road, Bangkok Noi, Bangkok, 10700, Thailand"
    cuisine="Thai, Isan"
    priceRange="฿฿"
    phoneNumber="+66873244619"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/kaenkrung"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its soft lighting and Northeastern-inspired decor featuring woven lampshades and wall art, KaenKrung exudes a warm atmosphere. The chef-owners present contemporary Isan flavours from Khon Kaen in a menu of well-balanced Thai and Isan dishes. Made with local ingredients, the signature Hao Dong, comprising grilled pork tossed in a fragrant herb and spice mix, delivers bold, spicy, smoky notes with a refined finish. Perfect for those who love strong, punchy flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=521%2F11%20Arunamarin%20Road%2C%20Bangkok%20Noi%2C%20Bangkok%2C%2010700%2C%20Thailand"
    pageTitle="KAENKRUNG"
  />
);

export default Kaenkrung;
