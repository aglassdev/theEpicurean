...
const PhraNakhon = () => (
  <RestaurantPage
    restaurantName="Phra Nakhon"
    address="Lower Lobby, Capella Bangkok, 300/2 Charoenkrung Road, Yan Nawa, Sathon, Bangkok, 10120, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+6620983817"
    website="https://www.capellahotels.com/en/capella-bangkok/dining/phra-nakhon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Phra Nakhon offers Thai à la carte and tasting menus with seasonal changes in a charming, modern venue with stunning views of the river. Chef Kannika has extensive experience in luxury hotels in the region; her cooking here focuses on southern Thai dishes and she carefully selects the seafood for freshness and quality. The wok-fried roasted pork belly with crispy chilli and garlic seasoning, and crab and betel-leaf curry with vermicelli noodles stand out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lower%20Lobby%2C%20Capella%20Bangkok%2C%20300%2F2%20Charoenkrung%20Road%2C%20Yan%20Nawa%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Phra Nakhon"
  />
);

export default PhraNakhon;
