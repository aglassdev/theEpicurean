...
const Nt = () => (
  <RestaurantPage
    restaurantName="ÎNT"
    address="Rooftop F, Best Western Sukhumvit 20, 17 Soi Sukhumvit 20, Sukhumvit Road, Khlong Toei, Bangkok, 10110, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+66932569995"
    website="http://www.restaurantintbkk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ascend to this rooftop restaurant to soak up an ambiance of elegant earthy tones blended with a subtle blue hue, all set against the warmth of an open kitchen. The tasting menu reflects Chef Patin 'Knock' Promsawadi and his team's unique, artistic approach to simplicity. Using French culinary techniques, he strikes a masterful balance between Thai and French ingredients to produce contemporary dishes that capture the essence of Thai cuisine. Advance booking necessary!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rooftop%20F%2C%20Best%20Western%20Sukhumvit%2020%2C%2017%20Soi%20Sukhumvit%2020%2C%20Sukhumvit%20Road%2C%20Khlong%20Toei%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="ÎNT"
  />
);
