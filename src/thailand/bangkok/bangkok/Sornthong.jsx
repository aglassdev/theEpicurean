...
const Sornthong = () => (
  <RestaurantPage
    restaurantName="Sornthong"
    address="2829-31 Rama 4 Road, Khlong Toei, Bangkok, 10110, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+6622580118"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sornthong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For quality seafood that won’t burn a hole in your pocket, look no further than Sornthong. Easily identified by the crowds dining beneath a large yellow sign in Thai and Chinese, this family-run shop has done a booming trade in prime fresh fish for more than 20 years. Ingredients are taken from tanks outside the restaurant, then cooked under the watchful eye of Mr. Chai – fried oysters with creamy eggs and a sweet-sour-spicy chilli sauce are a must-try. Away from the sea, keep an eye out for the well-marinated grilled pork satay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2829-31%20Rama%204%20Road%2C%20Khlong%20Toei%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Sornthong"
  />
);

export default Sornthong;
