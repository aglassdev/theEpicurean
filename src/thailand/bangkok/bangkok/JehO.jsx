...
const JehO = () => (
  <RestaurantPage
    restaurantName="Jeh O"
    address="113 Soi Charat Mueang, Rong Mueang, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66641185888"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jay-oh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jeh O might be known for her Mama Noodles Tom Yum, but her menu contains numerous other top-notch dishes. Many, including her delicious fried tofu with crispy garlic, boiled rice with duck, and signature crispy pork, are popular Thai favourites. Though the staff only speaks Thai, there’s an English picture menu for non-Thai speakers. Outside the shop, an eager crowd waits up to two hours for tables; to get in faster, arrive just before opening or near closing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=113%20Soi%20Charat%20Mueang%2C%20Rong%20Mueang%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Jeh O"
  />
);
