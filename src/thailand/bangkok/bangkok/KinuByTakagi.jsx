...
const KinuByTakagi = () => (
  <RestaurantPage
    restaurantName="Kinu by Takagi"
    address="2F, Mandarin Oriental Hotel, 48 Soi Charoen Krung 40, Charoen Krung Road, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Japanese"
    priceRange="฿฿฿฿"
    phoneNumber="+6626599000"
    website="https://www.mandarinoriental.com/en/bangkok/chao-phraya-river/dine/kinu-by-takagi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden behind sliding wooden doors, Kinu's décor combines Japanese and Thai influences, featuring teakwood crosshatch flooring and a mix of Japanese and northern Thai ceramics. Chef Takagi excels in Kyoto-style Kaiseki, highlighting the natural flavours of top Japanese ingredients. The bar offers an excellent sake collection, and a matcha tea ceremony marks the end of your visit. Additionally, welcome drinks are served in a Japanese-style Minka area...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Mandarin%20Oriental%20Hotel%2C%2048%20Soi%20Charoen%20Krung%2040%2C%20Charoen%20Krung%20Road%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Kinu by Takagi"
  />
);

export default KinuByTakagi;
