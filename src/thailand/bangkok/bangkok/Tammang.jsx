...
const Tammang = () => (
  <RestaurantPage
    restaurantName="Tammang"
    address="380-382 Rama 2 Road, Bang Mot, Chom Thong, Bangkok, 10150, Thailand"
    cuisine="Vegan, Vegetarian"
    priceRange="฿"
    phoneNumber="+66651916626"
    website="https://www.tammang.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This casual eatery serves up a plant‐based take on authentic Isan and Thai cuisine. From the open kitchen, the sound of the pestle and mortar resounds, as som tum is crafted. The à la carte menu includes vegan/vegetarian options and seasonal specials, in which the richness of the original is retained by replacing fish sauce with fermented soybeans. The cuisine showcases bold traditional flavours, and spice levels can be tailored to guests' preferences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=380-382%20Rama%202%20Road%2C%20Bang%20Mot%2C%20Chom%20Thong%2C%20Bangkok%2C%2010150%2C%20Thailand"
    pageTitle="Tammang"
  />
);

export default Tammang;
