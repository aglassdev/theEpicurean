...
const KorChunHuad = () => (
  <RestaurantPage
    restaurantName="Kor Chun Huad"
    address="864 Soi Somdet Phrachao Taksin 34, Bukkhalo, Thon Buri, Bangkok, 10600, Thailand"
    cuisine="Thai-Chinese, Thai"
    priceRange="฿฿"
    phoneNumber="+6624682383"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/koa-chun-huad"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For more than five decades, Koa Chun Huad has been attracting throngs of locals. Named after the chef-owner who has worked in many a kitchen in Chinatown, it serves classic Thai-Chinese dishes at appealingly low prices. The highlights are the boiled pork slices, perfectly complemented by a soybean sauce, and the intense stewed pork with sweet-salty five spice gravy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=864%20Soi%20Somdet%20Phrachao%20Taksin%2034%2C%20Bukkhalo%2C%20Thon%20Buri%2C%20Bangkok%2C%2010600%2C%20Thailand"
    pageTitle="Kor Chun Huad"
  />
);

export default KorChunHuad;
