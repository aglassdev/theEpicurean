...
const OneZeroZeroMahaseth = () => (
  <RestaurantPage
    restaurantName="100 Mahaseth"
    address="100 Mahaseth Road, Si Phraya, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Isan"
    priceRange="฿฿"
    phoneNumber="+6622350023"
    website="https://www.100mahaseth.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This nose-to-tail inspired offal restaurant serves elevated Isan fare made from quality locally sourced ingredients. The chef takes great care to balance the flavours and present attractive plates. The Isan complementary set includes somtam, crispy pork skin with Thai chimichurri and chaeo sauce. The hot and sour soup with baby pork ribs and chamuang leaves has lovely acidity with a hint of shrimp paste. Check the blackboard for Thai aged steak specials...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20Mahaseth%20Road%2C%20Si%20Phraya%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="100 Mahaseth"
  />
);

export default OneZeroZeroMahaseth;
