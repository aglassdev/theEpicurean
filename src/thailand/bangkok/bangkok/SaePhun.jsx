...
const SaePhun = () => (
  <RestaurantPage
    restaurantName="Sae Phun"
    address="112 Mahannop Road, Sao Chingcha, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66619947171"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sae-phun"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened since 1926, it has been relocated. This small shop is now run by the third generation. The owner has been cooking with her grandfather's recipes for many years. The signature dish chicken stew is juicy with chicken and rich in sauce. It can be paired with rice or deep fried egg noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%20Mahannop%20Road%2C%20Sao%20Chingcha%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Sae Phun"
  />
);

export default SaePhun;
