...
const ThienDuong = () => (
  <RestaurantPage
    restaurantName="Thien Duong"
    address="Baan Dusit Thani, 116 Saladaeng Road, Si Lom, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Vietnamese"
    priceRange="฿฿"
    phoneNumber="+6622009009"
    website="https://www.baandusitthani.com/thien-duong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thien Duong is a showcase of Vietnamese classical design; the antique artworks, mustard-coloured walls, rose-pink granite tables, shiny black floor tiles and exposed ceiling are an interior design lover’s paradise. The menu of Vietnamese dishes includes plenty of clean and fresh-tasting vegetables, with one eye often on health and wellness. The grilled lamb rack with mint-tamarind sauce is worth ordering, delivering a great balance of flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baan%20Dusit%20Thani%2C%20116%20Saladaeng%20Road%2C%20Si%20Lom%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Thien Duong"
  />
);

export default ThienDuong;
