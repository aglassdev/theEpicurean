...
const Re = () => (
  <RestaurantPage
    restaurantName="Ōre"
    address="11/31 Sathu Pradit Road, Chong Nonsi, Yan Nawa, Bangkok, 10120, Thailand"
    cuisine="Creative"
    priceRange="฿฿฿฿"
    phoneNumber="+66615607996"
    website="https://www.orerestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a minimalist design of wood, fabric and natural tones, Ōre promises an intimate culinary journey centred on Thai ingredients with select imports. The chef extols the flavour-enhancing properties of the mineral water that he gets shipped in from a spring near Sai Yok Waterfall to use in his cooking. His creative dishes highlight natural flavours and aromas that deepen throughout the meal, making for an unforgettable dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%2F31%20Sathu%20Pradit%20Road%2C%20Chong%20Nonsi%2C%20Yan%20Nawa%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Ōre"
  />
);
