...
const ThaiNiyom = () => (
  <RestaurantPage
    restaurantName="Thai Niyom"
    address="Mahatun Plaza, 888/28-29 Phloen Chit Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6620441010"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/thai-niyom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden in the shadow of skyscrapers is this gem of a restaurant, which got its start serving family recipes, but now offers an array of Thai cuisine from Chiang Mai to Hat Yai. It is a great place to sample delicious Thai cooking from every region on the same table. Quality ingredients are sourced locally and turned into dishes like the recommended Phuket stir-fried pork belly with shrimp paste and the Chiang Mai Combo, a Northern Thai-style appetiser plate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mahatun%20Plaza%2C%20888%2F28-29%20Phloen%20Chit%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Thai Niyom"
  />
);

export default ThaiNiyom;
