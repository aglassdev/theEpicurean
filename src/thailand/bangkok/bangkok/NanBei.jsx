...
const NanBei = () => (
  <RestaurantPage
    restaurantName="Nan Bei"
    address="19F, Rosewood Hotel, 1041/38 Phloen Chit Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Chinese"
    priceRange="฿฿฿"
    phoneNumber="+6620800080"
    website="https://www.rosewoodhotels.com/en/bangkok/dining/nan-bei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nan Bei means ‘south’ and ‘north’ so it’s no surprise to discover that this restaurant specialises in China’s southern and northern regions, from where the recipes come and ingredients are flown in. It sits on the 19th floor of the Rosewood Hotel, offering fabulous views of Bangkok while you dine. Braised abalone and braised pork belly shouldn’t be missed, though the prized item is Peking duck. Sit at the counter to see the chefs at work or to watch the birds being roasted over lychee wood. Lunchtime dim sum is also worth exploring...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19F%2C%20Rosewood%20Hotel%2C%201041%2F38%20Phloen%20Chit%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Nan Bei"
  />
);

export default NanBei;
