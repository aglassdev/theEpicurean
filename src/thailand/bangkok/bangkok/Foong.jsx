...
const Foong = () => (
  <RestaurantPage
    restaurantName="Foong"
    address="53 Soi Thong Lo 19, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66989248111"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/foong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Foong is a trendy local spot serving seasonal Thai set menus that change monthly. The homely yet skilfully executed cuisine focuses on familiar flavours and quality ingredients. Each family-style dining experience features around 10 shared plates – from nam prik, spicy salads, stir-fried and deep-fried dishes, and curries to hearty soups – finishing with a simple Thai dessert. Bookings are by reservation only, with a minimum of four guests required...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Soi%20Thong%20Lo%2019%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Foong"
  />
);

export default Foong;
