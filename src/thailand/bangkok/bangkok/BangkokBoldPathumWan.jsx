...
const BangkokBoldPathumWan = () => (
  <RestaurantPage
    restaurantName="Bangkok Bold (Pathum Wan)"
    address="LGF, Central Embassy, 1031 Phloen Chit Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66914244292"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/bangkok-bold-kitchen-central-embassy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Word-of-mouth inspired Chef Nhoi to take the leap from cooking studio in the old town to opening a restaurant in the city centre. Her aim is to preserve the heritage of Thai taste that’s ‘basic and bold’ with creative twists. Check out the unique stir-fried pork and shrimp, hummingbird flowers, fish sauce and scrambled eggs. And the spicy salted beef in coconut cream is tender with balanced flavours, enlivened by fresh shallots and bird's eye chillies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=LGF%2C%20Central%20Embassy%2C%201031%20Phloen%20Chit%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Bangkok Bold (Pathum Wan)"
  />
);

export default BangkokBoldPathumWan;
