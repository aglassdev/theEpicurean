...
const JayJiaYentafo = () => (
  <RestaurantPage
    restaurantName="Jay Jia Yentafo"
    address="564 Rama 4 Road, Maha Phruettharam, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66959535038"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jay-jia-yentafo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For 30+ years, office workers have been making a beeline to Jay Jia Yentafo for their eponymous pink-noodle soup and legendary homemade shrimp balls. The soup packs a knockout combination of shrimp, fish, fish sticks and fried wontons and explodes in sour and spicy notes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=564%20Rama%204%20Road%2C%20Maha%20Phruettharam%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Jay Jia Yentafo"
  />
);

export default JayJiaYentafo;
