...
const ChimBySiamWisdom = () => (
  <RestaurantPage
    restaurantName="Chim by Siam Wisdom"
    address="315 Soi Ongkharak 13, Thanon Nakhon Chai Si, Dusit, Bangkok, 10110, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿฿"
    phoneNumber="+66616476362"
    website="https://www.chimbysiamwisdombkk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Thanintorn 'Noom' Chantharawan's passionate take on traditional Thai cuisine balances domestic with international and classic with contemporary in dishes that use first-rate ingredients from around Thailand. The Thai food in 4 Regions” set, presents a dazzling array of flavours. The setting, a vintage wooden house decorated with abundant greenery, invites you to relax and savour your meal. Booking is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=315%20Soi%20Ongkharak%2013%2C%20Thanon%20Nakhon%20Chai%20Si%2C%20Dusit%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Chim by Siam Wisdom"
  />
);

export default ChimBySiamWisdom;
