...
const ElectricSheep = () => (
  <RestaurantPage
    restaurantName="ELECTRIC SHEEP"
    address="4F The Warehouse, 867 Charoenkrung Road, Talat Noi, Samphanthawong, Bangkok, 10100, Thailand"
    cuisine="Mediterranean Cuisine, Creative"
    priceRange="฿฿฿"
    phoneNumber="+66655150650"
    website="https://www.electricsheepbkk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fourth-floor hideaway with an edgy, industrial feel delivers serious cooking with a commitment to mindful gastronomy and zero waste. Even the decor and plates are made from recycled materials. Chefs Amerigo Tito Sesti and Yoan Martin craft a sharp Mediterranean-inspired menu, using only Thai ingredients, many grown on the rooftop. Dishes such as mackerel with smoked fermented chilli boast clever, clean flavours. Go à la carte or try the playful Chef's Cuts menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%20The%20Warehouse%2C%20867%20Charoenkrung%20Road%2C%20Talat%20Noi%2C%20Samphanthawong%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="ELECTRIC SHEEP"
  />
);

export default ElectricSheep;
