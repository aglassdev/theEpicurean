...
const SanyodBangRak = () => (
  <RestaurantPage
    restaurantName="Sanyod (Bang Rak)"
    address="89 Soi Charat Wiang, Si Lom, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Chinese"
    priceRange="฿฿"
    phoneNumber="+6622347968"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sanyod-sathon-bang-rak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a history spanning more than half a century, what started as a food stall located in a small alley has since grown into a popular and bustling neighbourhood restaurant. They specialise in Cantonese cuisine, and their roast duck and signature sauces are highly recommended, especially paired with Cantonese-style noodles. The menu also features a deliciously tender clay pot-braised beef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=89%20Soi%20Charat%20Wiang%2C%20Si%20Lom%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Sanyod (Bang Rak)"
  />
);

export default SanyodBangRak;
