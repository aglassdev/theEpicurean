...
const SartoriaByPauloAiraudo = () => (
  <RestaurantPage
    restaurantName="Sartoria by Paulo Airaudo"
    ...
    pageTitle="Sartoria by Paulo Airaudo"
  />
);

export default SartoriaByPauloAiraudo;
