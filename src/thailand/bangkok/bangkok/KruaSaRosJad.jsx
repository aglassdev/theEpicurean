...
const KruaSaRosJad = () => (
  <RestaurantPage
    restaurantName="Krua Sa Ros Jad"
    address="112/1 Soi Vibhavadi 44, Vibhavadi Rangsit Road, Lat Yao, Chatuchak, Bangkok, 10900, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66985031450"
    website="https://facebook.com/Kruasarosjad"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Krua Sa Ros Jad combines the owner's mother's name and a Thai phrase meaning intense flavour – an apt description of the boldly seasoned food made with fresh ingredients. Try the deep-fried fish in Choo Chee sauce, the robust, well-spiced flavour of which pairs well with the hot Tom Yum chicken soup with young tamarind leaves. The restaurant boasts a unique collection of Buddha statues and antique European ceramics, as the owner is an avid collector...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112%2F1%20Soi%20Vibhavadi%2044%2C%20Vibhavadi%20Rangsit%20Road%2C%20Lat%20Yao%2C%20Chatuchak%2C%20Bangkok%2C%2010900%2C%20Thailand"
    pageTitle="Krua Sa Ros Jad"
  />
);

export default KruaSaRosJad;
