...
const PorPochaya = () => (
  <RestaurantPage
    restaurantName="Por. Pochaya"
    address="654-656 Wisut Kasat Road, Ban Phan Thom, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+6622824363"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/por-pochaya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over half a century, unwavering quality and rare dishes have kept loyal fans visiting this traditional Thai-Chinese spot, which is now run by the third generation of the same family. Among the top-sellers are crab omelette and stir-fried beef with cumin leaves. Crowds are to be expected, so make sure you book to avoid disappointment. It’s closed on weekends and holidays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=654-656%20Wisut%20Kasat%20Road%2C%20Ban%20Phan%20Thom%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Por. Pochaya"
  />
);

export default PorPochaya;
