...
const Maze = () => (
  <RestaurantPage
    restaurantName="Maze"
    address="114/3 Set Siri Road, Sam Sen Nai, Phaya Thai, Bangkok, 10400, Thailand"
    cuisine="European"
    priceRange="฿฿"
    phoneNumber="+66922951915"
    website="https://aboutme.style/mazedining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 2020 by chef May Thongthong, this fine dining restaurant serves two set menus: Northern Thai Creations and Seasonal Creative. The first explores Chef May’s Lanna heritage, while the second plays with European techniques and flavours. The contemporary décor and lighting set the stage for the well-presented dishes. The main dining room includes an open-bar kitchen and counter seating. Above it, a private room seats 10...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=114%2F3%20Set%20Siri%20Road%2C%20Sam%20Sen%20Nai%2C%20Phaya%20Thai%2C%20Bangkok%2C%2010400%2C%20Thailand"
    pageTitle="Maze"
  />
);
