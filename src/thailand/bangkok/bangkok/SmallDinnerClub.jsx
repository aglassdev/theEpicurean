...
const SmallDinnerClub = () => (
  <RestaurantPage
    restaurantName="Small Dinner Club"
    address="1109 Charoen Krung Road, Si Phraya, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Innovative"
    priceRange="฿฿฿฿"
    phoneNumber="+66839929669"
    website="https://www.smalldinnerclub.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a 2-storey house in the historic town, Small Dinner Club exudes mystery and charm. The dimly lit interior sports a striking black colour scheme. In his own words, Chef Sareen “pulls apart, questions and reimagines Thai cuisine”. Unafraid of challenging conventions, he includes savoury ingredients in sweet recipes and sweet ingredients, like seasonal fruit, in savoury dishes, resulting in intelligently crafted and artistically presented Thai food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1109%20Charoen%20Krung%20Road%2C%20Si%20Phraya%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Small Dinner Club"
  />
);

export default SmallDinnerClub;
