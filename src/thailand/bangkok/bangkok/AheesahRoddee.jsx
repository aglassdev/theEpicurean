...
const AheesahRoddee = () => (
  <RestaurantPage
    restaurantName="Aheesah Roddee"
    address="103-105 Tani Road, Talat Yot, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Asian"
    priceRange="฿"
    phoneNumber="+66813070654"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/aheesah-roddee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Helmed by the son of Indonesian migrants, it has been serving aromatic Indonesian-inspired fare since 1975. The menu features tasty dishes such as chicken or beef biryani and satay. We recommend pairing the beautifully spiced chicken biryani with the hot and sour beef soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=103-105%20Tani%20Road%2C%20Talat%20Yot%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Aheesah Roddee"
  />
);

export default AheesahRoddee;
