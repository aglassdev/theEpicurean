...
const SanehJaan = () => (
  <RestaurantPage
    restaurantName="Saneh Jaan"
    address="Sindhorn Tower, 130-132 Wireless Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+66625343394"
    website="https://www.sanehjaan.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thai cuisine evolves here while honouring tradition. The menu offers classics and vintage recipes, including those favoured by the royal family. Standouts include sweet and sour crispy rice noodles with river prawns and flavoursome massaman curry with slow-cooked Kamphaeng Saen beef. Begin in the bar with signature cocktails made using Thai liqueurs and herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sindhorn%20Tower%2C%20130-132%20Wireless%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Saneh Jaan"
  />
);

export default SanehJaan;
