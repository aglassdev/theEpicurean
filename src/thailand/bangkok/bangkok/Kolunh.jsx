...
const Kolunh = () => (
  <RestaurantPage
    restaurantName="Kolun.h"
    address="110/1 Mahannop Road, Sao Chingcha, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66890102123"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/kolun-h"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Renowned for Hainanese-style rice noodles, Kolun.h has been serving locals since 1997. The signature dish comes with rich or clear broth, braised pork, radish and crispy pork belly. Don't miss the peppery-flavoured goat meat in an aromatic herb soup. Expect long queues at peak times...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=110%2F1%20Mahannop%20Road%2C%20Sao%20Chingcha%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Kolun.h"
  />
);

export default Kolunh;
