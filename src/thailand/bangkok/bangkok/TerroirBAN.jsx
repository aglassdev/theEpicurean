...
const TerroirBAN = () => (
  <RestaurantPage
    ...
    address="Acmen Complex, 13-15 Ekkamai Road, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Creative"
    priceRange="฿฿฿"
    phoneNumber="+66614942448"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/terroir-1209811"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Hao believes that the land, climate, and farmers are pivotal in produce quality. This belief echoes in his eatery sourcing 90% of ingredients from Northern Thailand, named meaning 'soil' in French. The restaurant delivers exceptional Franco-Japanese fusion, creatively blending two cuisines. Impressive flavour pairings, notably rich, smoky broths, shine consistently. An outstanding wine selection completes the splendid dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Acmen%20Complex%2C%2013-15%20Ekkamai%20Road%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Terroir"
  />
);

export default TerroirBAN;
