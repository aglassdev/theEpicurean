...
const SawangNoodles = () => (
  <RestaurantPage
    restaurantName="Sawang Noodles"
    address="264 Si Phraya Road, Maha Phruettharam, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6622361772"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sawang-bami-kam-pu-si-phraya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the place to enjoy crab noodles in Bangkok. The sweet, giant crab claw meat pairs well with sticky egg noodles and shrimp dumplings. Be sure to try their signature noodles with extra soup and barbecued pork on the side...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=264%20Si%20Phraya%20Road%2C%20Maha%20Phruettharam%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Sawang Noodles"
  />
);

export default SawangNoodles;
