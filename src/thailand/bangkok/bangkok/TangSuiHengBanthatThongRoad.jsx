...
const TangSuiHengBanthatThongRoad = () => (
  <RestaurantPage
    restaurantName="Tang Sui Heng (Banthat Thong Road)"
    address="649 Banthat Thong Road, Wang Mai, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66819939766"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/tung-sui-heng-pochana-stadium-one"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This iconic family-run shop has been packed with locals for more than 50 years. These days, the family’s second generation runs it, but the founder’s talent for cooking dishes like the signature claypot stewed duck with intestines, blood jelly, and feet clearly runs in the family...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=649%20Banthat%20Thong%20Road%2C%20Wang%20Mai%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Tang Sui Heng (Banthat Thong Road)"
  />
);

export default TangSuiHengBanthatThongRoad;
