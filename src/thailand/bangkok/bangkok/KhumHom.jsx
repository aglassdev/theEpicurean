...
const KhumHom = () => (
  <RestaurantPage
    restaurantName="Khum Hom"
    address="Movenpick BDMS Wellness Resort Bangkok, 2 Wireless Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai contemporary, Thai"
    priceRange="฿฿"
    phoneNumber="+6626663333"
    website="https://www.khumhomrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Khum Hom gives Thai cuisine a modern, health-conscious twist, with every dish showing a calorie count and nutrition details, certified by a nutritionist. Rotating every six months, the menu reflects all regions of Thailand while keeping flavours approachable and adjustable to preference. There is also a vegetarian menu. Soft beige tones, wood panelling and a curved green banquette by the windows create a bright space ideal for families or relaxed gatherings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Movenpick%20BDMS%20Wellness%20Resort%20Bangkok%2C%202%20Wireless%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Khum Hom"
  />
);

export default KhumHom;
