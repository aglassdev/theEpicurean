...
const GuayJubMrJo = () => (
  <RestaurantPage
    restaurantName="Guay Jub Mr. Jo"
    address="86 Soi Chan 44, Wat Phraya Krai, Bang Kho Laem, Bangkok, 10120, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6622133007"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/guay-jub-mr-joe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From early morning until late afternoon, locals flock to the small room at the front and large dining area at the rear. Enjoy guay jub as an entrée or in a sweet, peppery rice noodle broth; rich layers of soft pork are encased in a crispy skin. Can be ordered with or without pork offal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=86%20Soi%20Chan%2044%2C%20Wat%20Phraya%20Krai%2C%20Bang%20Kho%20Laem%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Guay Jub Mr. Jo"
  />
);

export default GuayJubMrJo;
