...
const JaideeShrimp = () => (
  <RestaurantPage
    restaurantName="Jaidee Shrimp"
    address="222/388 Ruam Mit Phatthana Road, Tha Raeng, Bang Khen, Bangkok, 10220, Thailand"
    cuisine="Thai, Southern Thai"
    priceRange="฿฿"
    phoneNumber="+6629482712"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jaidee-shrimp"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This casual eatery, which opened nearly two decades ago, is all about its signature shrimp dishes. Shrimp paired with bold Thai flavours and Southern influences delight fans of the crustacean. Diners can savour classics such as pad thai, alongside rich curries and flavourful soups. The shrimp comes from Jaidee Shrimp’s own farm in Surat Thani province, ensuring exceptional freshness and quality. With no red meat on the menu, the restaurant offers a wide array of fresh seafood, including squid, mantis shrimp and fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=222%2F388%20Ruam%20Mit%20Phatthana%20Road%2C%20Tha%20Raeng%2C%20Bang%20Khen%2C%20Bangkok%2C%2010220%2C%20Thailand"
    pageTitle="Jaidee Shrimp"
  />
);

export default JaideeShrimp;
