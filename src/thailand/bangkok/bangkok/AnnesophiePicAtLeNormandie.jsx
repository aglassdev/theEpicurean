...
const AnnesophiePicAtLeNormandie = () => (
  <RestaurantPage
    restaurantName="Anne-Sophie Pic at Le Normandie"
    ...
    pageTitle="Anne-Sophie Pic at Le Normandie"
  />
);

export default AnnesophiePicAtLeNormandie;
