...
const SomsakPuObCharoenRat = () => (
  <RestaurantPage
    restaurantName="Somsak Pu Ob (Charoen Rat)"
    address="199-205 Soi Charoen Rat 1, Khlong San, Bangkok, 10600, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66814000542"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/somsak-pu-ob-charoen-rat"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cart serves some of the best steamed crabs or prawns on glass noodles at wallet-friendly prices. Make sure you stir the noodles to soak up the tasty juices. It has a few branches, but this is where it all started. Come early or the wait will be long...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=199-205%20Soi%20Charoen%20Rat%201%2C%20Khlong%20San%2C%20Bangkok%2C%2010600%2C%20Thailand"
    pageTitle="Somsak Pu Ob (Charoen Rat)"
  />
);

export default SomsakPuObCharoenRat;
