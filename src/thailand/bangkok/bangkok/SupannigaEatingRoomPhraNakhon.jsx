...
const SupannigaEatingRoomPhraNakhon = () => (
  <RestaurantPage
    restaurantName="Supanniga Eating Room (Phra Nakhon)"
    address="392/25-26 Maha Rat Road, Phra Borom Maha Ratchawang, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66922539251"
    website="https://www.supannigaeatingroom.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The homestyle Thai food at this casual restaurant comes with postcard-worthy views of the Chao Phraya River and iconic Wat Arun. Whether you’re sharing lunch with friends after touring the nearby Grand Palace or enjoying a romantic meal at sunset, try a flavoursome signature dish. The recipes come from the owner’s grandmother; standouts include fried Chinese cabbage and braised pork belly with herbs and cowa leaves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=392%2F25-26%20Maha%20Rat%20Road%2C%20Phra%20Borom%20Maha%20Ratchawang%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Supanniga Eating Room (Phra Nakhon)"
  />
);

export default SupannigaEatingRoomPhraNakhon;
