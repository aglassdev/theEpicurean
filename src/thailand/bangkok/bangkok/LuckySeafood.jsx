...
const LuckySeafood = () => (
  <RestaurantPage
    restaurantName="Lucky Seafood"
    address="28/1 Phran Nok-Phutthamonthon 4 Road, Bang Phrom, Taling Chan, Bangkok, 10170, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66949651881"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/lucky-seafood"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This gem of a place serves fresh seafood with Thai flavours, featuring house-made curry and chilli paste. Order in advance or call to check availability. Try the stir-fried crab with bird's eye chilli or the non-spicy stir-fried squid with curry powder...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%2F1%20Phran%20Nok-Phutthamonthon%204%20Road%2C%20Bang%20Phrom%2C%20Taling%20Chan%2C%20Bangkok%2C%2010170%2C%20Thailand"
    pageTitle="Lucky Seafood"
  />
);

export default LuckySeafood;
