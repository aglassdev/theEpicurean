...
const WatsanaKhaoManGai = () => (
  <RestaurantPage
    restaurantName="Watsana Khao Man Gai"
    address="9/275 Phuttha Bucha Road, Bang Mot, Chom Thong, Bangkok, 10150, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66877116456"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/watsana-khao-man-gai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite several moves from its original location, this shophouse has kept its customers so expect queues for its famous chicken rice and the recent addition of noodles. Quality ingredients and consistent cooking are the secret of its success...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%2F275%20Phuttha%20Bucha%20Road%2C%20Bang%20Mot%2C%20Chom%20Thong%2C%20Bangkok%2C%2010150%2C%20Thailand"
    pageTitle="Watsana Khao Man Gai"
  />
);

export default WatsanaKhaoManGai;
