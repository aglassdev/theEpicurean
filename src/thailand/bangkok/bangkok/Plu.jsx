...
const Plu = () => (
  <RestaurantPage
    restaurantName="Plu"
    address="3 Soi Phra Phinit, Suan Phlu Road, Thung Maha Mek, Sathon, Bangkok, 10120, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66626422222"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/plu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Water Library’s Plu offers outstanding food, a cosy ambience, and great service in an Art Deco-adorned colonial house. Among the beautifully presented authentic pan-Thailand dishes is the signature braised pork belly and soft-boiled eggs in five-spiced soup; the pork belly is tender and juicy, the deep-fried tofu absorbs the aromatic broth, and the soft-boiled eggs only enhance the flavour and texture. Start with one of the restaurant’s signature cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Soi%20Phra%20Phinit%2C%20Suan%20Phlu%20Road%2C%20Thung%20Maha%20Mek%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Plu"
  />
);
