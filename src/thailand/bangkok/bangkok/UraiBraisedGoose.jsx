...
const UraiBraisedGoose = () => (
  <RestaurantPage
    restaurantName="Urai Braised Goose"
    address="935 Song Wat Road, Chakkrawat, Samphanthawong, Bangkok, 10100, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6622214413"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/urai-braised-goose"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For six decades, this family-run business has been braising tender goose with aromatic spices. The menu counts just two items but several size options. The goose has soft meat and thin skin; intestines are available on Wednesdays and Saturdays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=935%20Song%20Wat%20Road%2C%20Chakkrawat%2C%20Samphanthawong%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Urai Braised Goose"
  />
);

export default UraiBraisedGoose;
