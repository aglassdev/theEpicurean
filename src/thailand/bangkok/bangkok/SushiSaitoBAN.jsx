...
const SushiSaitoBAN = () => (
  <RestaurantPage
    ...
    address="Four Seasons Private Residences, 300 Charoen Krung Road, Yan Nawa, Sathon, Bangkok, 10120, Thailand"
    cuisine="Sushi"
    priceRange="฿฿฿฿"
    phoneNumber="+66855500791"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sushi-saito-1208794"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Four Seasons Private Residences by the Chao Phraya River, Sushi Saito is the sister branch of the renowned Tokyo restaurant by Chef Takashi Saito. Specialising in Edomae-style sushi, it showcases chef Maruyama’s skills and Edo-period techniques. The restaurant embraces classic Japanese décor, featuring an atrium with a drinks bar and a dining area with a Hinoki cypress counter-table around an open kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Private%20Residences%2C%20300%20Charoen%20Krung%20Road%2C%20Yan%20Nawa%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Sushi Saito"
  />
);

export default SushiSaitoBAN;
