...
const JayFai = () => (
  <RestaurantPage
    ...
    priceRange="฿฿"
    phoneNumber="+6622239384"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jay-fai"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Jay Fai has long been a street food icon, and for good reason — the begoggled chef’s signature crispy, golden-brown crab omelettes are simply unparalleled. If you’re looking for another reason to love the local legend, then also try her excellent stir-fried noodles with seafood and gravy. This is a deservedly popular spot and they don’t take bookings, so be sure to arrive early and be prepared to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=327%20Maha%20Chai%20Road%2C%20Samran%20Rat%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Jay Fai"
  />
);

export default JayFai;
