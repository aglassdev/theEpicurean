...
const KinKubKoi = () => (
  <RestaurantPage
    restaurantName="Kin Kub Koi"
    address="83/3 Phuttha Monthon Sai 2 Road, Sala Thammasop, Thawi Watthana, Bangkok, 10170, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66898149424"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/kin-kub-koi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef-owner here knows seafood. Not only does her family run a wholesale seafood business, but she also ran the previous incarnation of this place in Samut Sakhon for years before moving it here. The results are skilfully cooked dishes made from choice seafood, like standouts grilled river prawns and stir-fried crab with bitter beans and shrimp paste. Two dining zones (with and without AC) are available; both face a leafy courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%2F3%20Phuttha%20Monthon%20Sai%202%20Road%2C%20Sala%20Thammasop%2C%20Thawi%20Watthana%2C%20Bangkok%2C%2010170%2C%20Thailand"
    pageTitle="Kin Kub Koi"
  />
);

export default KinKubKoi;
