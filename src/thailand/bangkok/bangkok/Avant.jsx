...
const Avant = () => (
  <RestaurantPage
    restaurantName="AVANT"
    address="30F, Kimpton Maa-Lai Bangkok, 78 Soi Ton Son, Lumphini, Pathum Wan, Bangkok, 10300, Thailand"
    cuisine="Modern Cuisine"
    priceRange="฿฿฿฿"
    phoneNumber="+66824664962"
    website="https://www.kimptonmaalaibangkok.com/bangkok-restaurants/avant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Singaporean chef is renowned for his culinary approach that combines traditional and modern techniques with meticulous attention to detail. His introduction to each course reveals his enduring passion for his craft. Seated at the L-shaped counter, diners can soak up the dynamic energy of the kitchen. The city view adds another dimension to this memorable culinary experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30F%2C%20Kimpton%20Maa-Lai%20Bangkok%2C%2078%20Soi%20Ton%20Son%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010300%2C%20Thailand"
    pageTitle="AVANT"
  />
);
