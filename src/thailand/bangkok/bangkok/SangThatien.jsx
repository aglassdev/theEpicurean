...
const SangThatien = () => (
  <RestaurantPage
    restaurantName="Sang Thatien"
    address="75 Maha Rat Road, Phra Borom Maha Ratchawang, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+66621696591"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/sang-tha-tien"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Formerly an ice factory, this small eatery retains some of the interior structure and incorporates vintage décor in a dining room decorated with basic wooden furniture and collectibles. The chef embraces seasonal Thai ingredients, especially fruit, to produce unique, signature dishes in a home-cooking style, such as strawberry salad with shrimp paste and caramelised pork and spicy plum mango salad. The crab meat with fresh herbs and spicy sauce is unmissable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75%20Maha%20Rat%20Road%2C%20Phra%20Borom%20Maha%20Ratchawang%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Sang Thatien"
  />
);

export default SangThatien;
