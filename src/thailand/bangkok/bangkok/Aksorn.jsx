...
const Aksorn = () => (
  <RestaurantPage
    restaurantName="Aksorn"
    address="5F, Central: The Original Store, 1266 Charoenkrung Road, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+6621168662"
    website="https://www.aksornbkk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Inspired by old Thai cookbooks, David Thompson revisits the culinary lives of different chefs. See the action in the open kitchen from the dining area or opt for the outdoor terrace to take in the city and street. The highlight dish features smoked kingfish relish with wild ginger. Try the refreshing Watsana, a non-alcoholic drink that perfectly balances sour notes with the sweetness of watermelon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Central%3A%20The%20Original%20Store%2C%201266%20Charoenkrung%20Road%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Aksorn"
  />
);

export default Aksorn;
