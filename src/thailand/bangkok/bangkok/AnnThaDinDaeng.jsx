...
const AnnThaDinDaeng = () => (
  <RestaurantPage
    restaurantName="Ann Tha Din Daeng"
    address="167 Tha Din Daeng Road, Khlong San, Bangkok, 10600, Thailand"
    cuisine="Seafood, Thai"
    priceRange="฿฿"
    phoneNumber="+66816950597"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/ann-tha-din-daeng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over two decades, this restaurant has been serving seafood here in Little China Town, an area whose streets are lined by vendors. The array of mouthwatering dishes on offer captures local savour. The popular stir-fried prawn with salt and pepper boasts a blend of savoury and slightly salty flavours. The clams with sweet chilli paste and Thai basil is another standout dish – the paste adds a hint of sweetness that complements the Thai basil aroma perfectly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=167%20Tha%20Din%20Daeng%20Road%2C%20Khlong%20San%2C%20Bangkok%2C%2010600%2C%20Thailand"
    pageTitle="Ann Tha Din Daeng"
  />
);

export default AnnThaDinDaeng;
