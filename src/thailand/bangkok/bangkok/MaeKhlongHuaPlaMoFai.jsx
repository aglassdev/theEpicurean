...
const MaeKhlongHuaPlaMoFai = () => (
  <RestaurantPage
    restaurantName="Mae Khlong Hua Pla Mo Fai"
    address="198 Phran Nok-Phutthamonthon Sai 4 Road, Bang Phrom, Taling Chan, Bangkok, 10170, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66970289093"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/mae-khlong-hua-pla-mo-fai-1195212"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simple in its design with a white pavilion and modest dining tables, the restaurant has a small garden with some outdoor seating. The owners are hands-on, preparing every dish with care. The stir-fried crab has a naturally sweet meat and wok-fried aroma, and is served with glass noodles, spicy chilli and crunchy mimosa. The large butterfly-cut river fish is nicely char-grilled. The grilled river prawns, meanwhile, are clearly the people’s favourite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=198%20Phran%20Nok-Phutthamonthon%20Sai%204%20Road%2C%20Bang%20Phrom%2C%20Taling%20Chan%2C%20Bangkok%2C%2010170%2C%20Thailand"
    pageTitle="Mae Khlong Hua Pla Mo Fai"
  />
);

export default MaeKhlongHuaPlaMoFai;
