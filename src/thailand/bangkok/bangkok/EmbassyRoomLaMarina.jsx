...
const EmbassyRoomLaMarina = () => (
  <RestaurantPage
    restaurantName="Embassy Room La Marina"
    address="9F, Park Hyatt Hotel, 88 Wireless Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Spanish"
    priceRange="฿฿฿"
    phoneNumber="+6620117431"
    website="https://www.hyatt.com/en-US/hotel/thailand/park-hyatt-bangkok/bkkph/dining/embassy-room"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Embassy Room offers authentic Catalan cuisine with à la carte options and tasting menus. The chefs are happy to personalise dishes to cater to dietary needs. The Bomba rice dishes are perfect for rice lovers, while the private room is ideal for intimate gatherings. The outdoor seating boasts views of the sky garden. For Spanish wine aficionados, the wine list features over 100 labels from seven regions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9F%2C%20Park%20Hyatt%20Hotel%2C%2088%20Wireless%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Embassy Room La Marina"
  />
);

export default EmbassyRoomLaMarina;
