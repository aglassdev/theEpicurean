...
const PhatKaolaoBeef = () => (
  <RestaurantPage
    restaurantName="Phat Kaolao Beef"
    address="29 Ratchaphruek Road, Bang Waek, Phasi Charoen, Bangkok, 10160, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66947925173"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/phat-kaolao-beef"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Phat rewards beef devotees who find this spot that showcases slow-braised cuts – from Kobe-style brisket to melt-in-your-mouth tendon. Blanched in an aromatic clear broth, the liver is silky perfection. The rich beef curry is sublime. N.B. They close on the 1st and 16th of each month...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Ratchaphruek%20Road%2C%20Bang%20Waek%2C%20Phasi%20Charoen%2C%20Bangkok%2C%2010160%2C%20Thailand"
    pageTitle="Phat Kaolao Beef"
  />
);

export default PhatKaolaoBeef;
