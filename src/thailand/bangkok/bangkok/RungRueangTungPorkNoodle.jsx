...
const RungRueangTungPorkNoodle = () => (
  <RestaurantPage
    restaurantName="Rung Rueang Tung Pork Noodle"
    address="10/3 Soi Sukhumvit 26, Khlong Tan, Khlong Toei, Bangkok, 10110, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6622586746"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/guay-tiew-mu-rung-rueang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Depending on your appetite, choose between a small or large portion of clear minced pork soup and perfectly flavoured tom yum broth. Each steaming bowl is topped with homemade fish balls and, if you so fancy, crispy fish skin. The minced pork balls are also a highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%2F3%20Soi%20Sukhumvit%2026%2C%20Khlong%20Tan%2C%20Khlong%20Toei%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Rung Rueang Tung Pork Noodle"
  />
);

export default RungRueangTungPorkNoodle;
