...
const LeNormandie = () => (
  <RestaurantPage
    restaurantName="Le Normandie"
    address="5F, Mandarin Oriental, Bangkok, 48 Soi Charoen Krung 40, Charoen Krung Road, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="French Contemporary"
    priceRange="฿฿฿฿"
    phoneNumber="+6626599000"
    website="https://www.mandarinoriental.com/en/bangkok/chao-phraya-river/dine/le-normandie"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Set in an elegant space adorned with handcrafted chandeliers and breathtaking river views, Le Normandie has been Bangkok's premier destination for haute cuisine for over 60 years. Now led by a renowned British chef who began his career in New York, the restaurant continues to impress. Innovative techniques and a modern interpretation of classic French dishes ensure the sophisticated dining experience lives on...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Mandarin%20Oriental%2C%20Bangkok%2C%2048%20Soi%20Charoen%20Krung%2040%2C%20Charoen%20Krung%20Road%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Le Normandie"
  />
);

export default LeNormandie;
