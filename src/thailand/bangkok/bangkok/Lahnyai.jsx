...
const Lahnyai = () => (
  <RestaurantPage
    restaurantName="Lahnyai"
    address="31 Soi Suan Phlu 2, Thung Maha Mek, Sathon, Bangkok, 10120, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿฿"
    phoneNumber="+66622425966"
    website="https://www.lahnyai.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Initially conceived as a tribute to the owner's grandmother, Lahnyai showcases modern interpretations of royal Thai cuisine sourced from the cremation cookbooks of princesses from 1987 to 1992. The refined dining room delivers an intimate ambiance with velvet walls and Jacquard-covered furniture. Infusing a contemporary twist into historical recipes, dishes satisfy with tried-and-tested flavours, like a great massaman curry that strikes a fine balance between spice and sweetness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20Soi%20Suan%20Phlu%202%2C%20Thung%20Maha%20Mek%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Lahnyai"
  />
);

export default Lahnyai;
