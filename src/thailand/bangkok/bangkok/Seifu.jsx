...
const Seifu = () => (
  <RestaurantPage
    restaurantName="Seifu"
    address="4F, Kissuisen, Bangkok Marriott Hotel The Surawongse, 262 Surawong Road, Si Phraya, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="Japanese"
    priceRange="฿฿฿฿"
    phoneNumber="+6620885666"
    website="https://www.kissuisenbangkok.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the fourth floor of Kissuisen at the Marriott, this intimate restaurant has two rooms, each seating nine. Veteran chef Yuichi Mitsui and chef Kazutomo Matayoshi extend the typical kaiseki omakase menu to include sushi and more, deploying an array of techniques. Thai produce – fresh crab meat and spring water sourced from Ayutthaya for the soups – meets Japanese finesse, and illustrations by Mitsui appear on the menus. Two sittings daily; book well ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Kissuisen%2C%20Bangkok%20Marriott%20Hotel%20The%20Surawongse%2C%20262%20Surawong%20Road%2C%20Si%20Phraya%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Seifu"
  />
);

export default Seifu;
