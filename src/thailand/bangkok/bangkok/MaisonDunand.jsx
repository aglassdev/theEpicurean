...
const MaisonDunand = () => (
  <RestaurantPage
    restaurantName="Maison Dunand"
    address="55 Soi Sathon 10, Si Lom, Bang Rak, Bangkok, 10500, Thailand"
    cuisine="French Contemporary"
    priceRange="฿฿฿฿"
    phoneNumber="+66656390515"
    website="https://www.maisondunand.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Following his successful time as Head Chef of Le Normandie, Arnaud Dunand Sauthier’s next venture was opening his own place. Here he welcomes you into a home designed like the Alpine chalets of the Savoie region in France, where he grew up. The French contemporary tasting menu is inspired by his alpine origins, childhood trips to Brittany and his glittering international culinary journey. Expect too an excellent wine cellar with good representation for Alsace and Savoie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Soi%20Sathon%2010%2C%20Si%20Lom%2C%20Bang%20Rak%2C%20Bangkok%2C%2010500%2C%20Thailand"
    pageTitle="Maison Dunand"
  />
);

export default MaisonDunand;
