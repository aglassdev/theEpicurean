...
const Delia = () => (
  <RestaurantPage
    restaurantName="Delia"
    address="306 Santiphap Road, Pom Prap, Pom Prap Sattru Phai, Bangkok, 10100, Thailand"
    cuisine="Mexican"
    priceRange="฿฿"
    phoneNumber="+66922836494"
    website="https://baandelia.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Delia, a fresh addition to Bangkok's food scene, gives authentic Mexican flavours a contemporary twist. Greeted with a cheerful Hola!, diners experience traditional techniques fused with quality Thai ingredients. Handmade tortillas, house‐fermented elements and bold, flame‐cooked dishes such as tostada with roasted cauliflower cream and taco de pastor – celebrate both heritage and innovation. Their unique spin on tamal de piña y umeshu rounds off the meal perfectly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=306%20Santiphap%20Road%2C%20Pom%20Prap%2C%20Pom%20Prap%20Sattru%20Phai%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Delia"
  />
);
