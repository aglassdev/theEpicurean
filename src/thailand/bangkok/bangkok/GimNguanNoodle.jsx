...
const GimNguanNoodle = () => (
  <RestaurantPage
    restaurantName="Gim Nguan Noodle"
    address="75/70 Soi Chom Thong 16, Chom Thong Road, Bang Kho, Chom Thong, Bangkok, 10150, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66861212345"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/grim-nguan-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hidden gem, tucked away in a Bangkok alley since 1999, excels in fish ball noodle soup. They offer fresh, umami-rich fish balls, al dente noodles, and a savoury, aromatic broth. Optional toppings like cheese and poached egg, along with large servings and ample condiments, provide great taste and value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75%2F70%20Soi%20Chom%20Thong%2016%2C%20Chom%20Thong%20Road%2C%20Bang%20Kho%2C%20Chom%20Thong%2C%20Bangkok%2C%2010150%2C%20Thailand"
    pageTitle="Gim Nguan Noodle"
  />
);

export default GimNguanNoodle;
