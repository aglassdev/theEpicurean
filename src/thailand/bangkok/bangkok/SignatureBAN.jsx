...
const SignatureBAN = () => (
  <RestaurantPage
    ...
    address="11F, VIE Hotel Bangkok - MGallery Collection, 117/39-40 Phayathai Road, Thanon Phetchaburi, Ratchathewi, Bangkok, 10400, Thailand"
    cuisine="French"
    priceRange="฿฿฿฿"
    phoneNumber="+66659509742"
    website="https://www.signaturebangkok.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Veteran Chef Thierry Drapeau expands on his ‘cuisine of the soil’ philosophy he first explored in his native Loire Valley. The art-deco dining room has floor-to-ceiling windows and velvet curtains that open to reveal his stage – an open kitchen. Here, he achieves classic French flavours using imported herbs and edible flowers that evoke their terroir. The Flower Bouquet set menus rotate with the seasons, are great value and matched by excellent service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11F%2C%20VIE%20Hotel%20Bangkok%20-%20MGallery%20Collection%2C%20117%2F39-40%20Phayathai%20Road%2C%20Thanon%20Phetchaburi%2C%20Ratchathewi%2C%20Bangkok%2C%2010400%2C%20Thailand"
    pageTitle="Signature"
  />
);

export default SignatureBAN;
