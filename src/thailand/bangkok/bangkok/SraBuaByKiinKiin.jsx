...
const SraBuaByKiinKiin = () => (
  <RestaurantPage
    restaurantName="Sra Bua by Kiin Kiin"
    address="GF, Siam Kempinski Hotel, 991/9 Rama 1 Road, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+6621629000"
    website="https://www.srabuabykiinkiin.com/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inspired by its sister restaurant, Copenhagen's Kiin Kiin, Sra Bua is one of Bangkok’s original purveyors of modern, innovative Thai cuisine. À la carte and tasting menus are available, with their dishes – from street food starter to dessert – proving creative and original, yet respectful of traditional Thai flavours. Premium international ingredients are used throughout, while both alcoholic and non-alcoholic pairings are available to complete the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Siam%20Kempinski%20Hotel%2C%20991%2F9%20Rama%201%20Road%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Sra Bua by Kiin Kiin"
  />
);

export default SraBuaByKiinKiin;
