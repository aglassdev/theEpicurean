...
const BaanTepa = () => (
  <RestaurantPage
    restaurantName="Baan Tepa"
    address="561 Ramkhamhaeng Road, Hua Mak, Bang Kapi, Bangkok, 10240, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿฿"
    phoneNumber="+66986969074"
    website="https://www.baantepabkk.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Chudaree 'Tam' Debhakam brings the farm-to-table concept to life with her detailed, contemporary Thai tasting menu. Seasonal and sustainable ingredients, some sourced from her own backyard, highlight a culinary journey through Thailand. The dishes present bold flavours and delicate spices, crafted by a charming team within an elegant villa setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=561%20Ramkhamhaeng%20Road%2C%20Hua%20Mak%2C%20Bang%20Kapi%2C%20Bangkok%2C%2010240%2C%20Thailand"
    pageTitle="Baan Tepa"
  />
);

export default BaanTepa;
