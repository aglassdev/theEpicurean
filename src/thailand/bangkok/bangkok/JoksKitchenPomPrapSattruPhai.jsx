...
const JoksKitchenPomPrapSattruPhai = () => (
  <RestaurantPage
    restaurantName="Jok's Kitchen (Pom Prap Sattru Phai)"
    address="23 Soi Charoen Krung 21, Phlapphla Chai Road, Pom Prap, Pom Prap Sattru Phai, Bangkok, 10100, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿฿฿"
    phoneNumber="+66819199468"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/jok-s-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the debate between quality and quantity, this Thai-Chinese spot hidden in a wet market sides with quality. Starting with a single table, it has since expanded to five. The skilled chef, whose family has sold crabs for over 80 years, sources quality ingredients to create an Omakase set menu which he cooks chef’s table-style. The shrimp wonton, deep-fried snow fish with soy sauce and stir-fried kale with salted halibut are recommended. Booking is mandatory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Soi%20Charoen%20Krung%2021%2C%20Phlapphla%20Chai%20Road%2C%20Pom%20Prap%2C%20Pom%20Prap%20Sattru%20Phai%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Jok's Kitchen (Pom Prap Sattru Phai)"
  />
);

export default JoksKitchenPomPrapSattruPhai;
