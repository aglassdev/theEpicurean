...
const ThaiTham = () => (
  <RestaurantPage
    restaurantName="Thai Tham"
    address="28/1 Phraeng Phuthon Road, San Chao Pho Suea, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6622217612"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/thai-tham"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This well-loved little shop has been passed down the generations for over a century. They specialise in offal, and their signature dish showcases stewed pig's brain, which is prepared fresh each morning by octogenarian owner Sudjit Suranan. Try the starter of Chinese liver sausage, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%2F1%20Phraeng%20Phuthon%20Road%2C%20San%20Chao%20Pho%20Suea%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="Thai Tham"
  />
);

export default ThaiTham;
