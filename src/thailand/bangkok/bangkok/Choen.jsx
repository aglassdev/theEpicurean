...
const Choen = () => (
  <RestaurantPage
    restaurantName="Choen"
    address="122-124, Soi Pradu, Pom Prap, Pom Prap Sattru Phai, Bangkok, 10100, Thailand"
    cuisine="Thai, Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+66638933663"
    website="https://www.choenrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wood, not gas, powers the flame of this discreet Thai counter and the chef's quest to deliver traditional flavours across a satisfying Thai tasting menu. The results are impressive, showcasing fine control over heat and a clear understanding of layering Thai flavours. Small-farm produce and seasonal fruit lend each bite a fresh natural sweetness and acidity. Dinner starts at 7pm sharp, closing with rice and soup to ensure guests return home utterly sated...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122-124%2C%20Soi%20Pradu%2C%20Pom%20Prap%2C%20Pom%20Prap%20Sattru%20Phai%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Choen"
  />
);

export default Choen;
