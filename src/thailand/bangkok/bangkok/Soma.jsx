...
const Soma = () => (
  <RestaurantPage
    restaurantName="Soma"
    address="Siam Patumwan House, 414 Phaya Thai Road, Wang Mai, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66953722644"
    website="https://www.somabangkok.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three celebrated chefs breathe life into traditional Thai cuisine, creatively drawing on ingredients and ideas from around the country. Begin with the grilled skirt steak in a kailan salad with Regency, then move on to a soulful soup, crunchy stir-fry, aromatic curry or catch of the day. And save room for dessert! Friendly, clued-up staff guide you through the dining experience in a relaxed, buzzy space that is smartly styled for a convivial meal with friends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Siam%20Patumwan%20House%2C%20414%20Phaya%20Thai%20Road%2C%20Wang%20Mai%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Soma"
  />
);
