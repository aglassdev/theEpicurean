...
const ViaEmilia = () => (
  <RestaurantPage
    restaurantName="Via Emilia"
    address="1040 Soi Naradhiwas Rajanagarindra 17 Lane 5, Thung Maha Mek, Sathon, Bangkok, 10120, Thailand"
    cuisine="Italian"
    priceRange="฿฿"
    phoneNumber="+66931388373"
    website="https://www.viaemiliabangkok.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 2021, Via Emilia brings the soul of Emilia‐Romagna to Bangkok, with authentic home‐style Italian fare. Occupying what was once an old house, the restaurant is adorned with hand‐painted murals echoing Roman architecture. The handmade pastas, freshly baked pizza and classics such as tagliatelle al ragù go down a treat with Italian wines from a well-curated selection; seasonal menus are another option. This pet‐friendly eatery is ideal for both casual meals and intimate gatherings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1040%20Soi%20Naradhiwas%20Rajanagarindra%2017%20Lane%205%2C%20Thung%20Maha%20Mek%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Via Emilia"
  />
);

export default ViaEmilia;
