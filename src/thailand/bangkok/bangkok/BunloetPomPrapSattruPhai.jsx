...
const BunloetPomPrapSattruPhai = () => (
  <RestaurantPage
    restaurantName="Bunloet (Pom Prap Sattru Phai)"
    address="360 Soi Nakhon Sawan 8, Nakhon Sawan Road, Wat Sommanat, Pom Prap Sattru Phai, Bangkok, 10100, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66626249269"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/bunloet"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This enduring street food stall is renowned for its egg noodles with grilled pork, prepared using an unchanged recipe for over 40 years. The secret lies in marinating pork rump slices for four hours in a mix of soy sauce, sugar, salt, and pepper before grilling over charcoal. The well-cooked noodles have a soft, sticky texture, served in a flavourful pork bone broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=360%20Soi%20Nakhon%20Sawan%208%2C%20Nakhon%20Sawan%20Road%2C%20Wat%20Sommanat%2C%20Pom%20Prap%20Sattru%20Phai%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Bunloet (Pom Prap Sattru Phai)"
  />
);

export default BunloetPomPrapSattruPhai;
