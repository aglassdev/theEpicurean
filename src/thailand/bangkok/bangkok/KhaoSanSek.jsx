...
const KhaoSanSek = () => (
  <RestaurantPage
    restaurantName="Khao San Sek"
    address="1121-1123 Song Wat Road, Samphanthawong, Samphanthawong, Bangkok, 10100, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66970169824"
    website="https://www.khaosansek.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within a tall and slender multi-storey townhouse, exposed wooden beams, soft lighting and intimate rooms foster cosy refinement, with each floor offering something distinct and inviting. The five Thai essential ingredients – fish sauce, palm sugar, chilli, rice and coconut – anchor a build-your-own menu with three portion sizes for each dish, or you can opt for a curated set menu. During the meal, a khao pracham wan (daily rice) is served, which changes from day to day. If you’re lucky, you might get beautifully aromatic Phaya Luem Kaeng sticky rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1121-1123%20Song%20Wat%20Road%2C%20Samphanthawong%2C%20Samphanthawong%2C%20Bangkok%2C%2010100%2C%20Thailand"
    pageTitle="Khao San Sek"
  />
);

export default KhaoSanSek;
