...
const RoyalOsha = () => (
  <RestaurantPage
    restaurantName="Royal Osha"
    address="99 Wireless Road, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+6622566555"
    website="https://www.royalosha.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A majestic twist on its sister restaurant in San Francisco, Royal Osha aims to engage the senses with enticing flavours, aromas, textures, sights and sounds. The setting is a sleek, modern dining room decorated with Thai art. Start with a cocktail inspired by Ramakien characters, before enjoying dishes like the excellent tom yum kung mae nam (spicy, sour soup with river prawns infused with Thai herbs) and the (seasonal) chilled rice served with accompaniments...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Wireless%20Road%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Royal Osha"
  />
);

export default RoyalOsha;
