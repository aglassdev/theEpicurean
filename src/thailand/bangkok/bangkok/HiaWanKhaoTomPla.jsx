...
const HiaWanKhaoTomPla = () => (
  <RestaurantPage
    restaurantName="Hia Wan Khao Tom Pla"
    address="816 Chan Road, Thung Wat Don, Sathon, Bangkok, 10120, Thailand"
    cuisine="Small eats, Congee"
    priceRange="฿฿"
    phoneNumber="+6622110829"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/hia-wan-khao-tom-pla"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Entirely focused on top-drawer seafood, this eatery offers a wide range of dishes. The soft-boiled rice with silver pomfret comes with a juicy fillet and fresh, clear soup. The baked mung bean noodles with prawns feature sticky mung bean noodles, underscored by a spicy-sour Thai seafood sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=816%20Chan%20Road%2C%20Thung%20Wat%20Don%2C%20Sathon%2C%20Bangkok%2C%2010120%2C%20Thailand"
    pageTitle="Hia Wan Khao Tom Pla"
  />
);

export default HiaWanKhaoTomPla;
