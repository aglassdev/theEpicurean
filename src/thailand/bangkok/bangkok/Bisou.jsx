...
const Bisou = () => (
  <RestaurantPage
    restaurantName="Bisou"
    address="68 Soi Langsuan 9, Lumphini, Pathum Wan, Bangkok, 10330, Thailand"
    cuisine="Modern Cuisine"
    priceRange="฿฿"
    phoneNumber="+66960255858"
    website="https://www.bisoubangkok.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Antoine Darquin and sommelier Théo Lavergne bring a fresh, fashionable Parisian flair to Bangkok's dining scene. Bisou delivers sexy simplicity through modern French cuisine, prioritising premium ingredients. The stylish yet relaxed space features enchanting lights, a spiral staircase and wall art. The dishes and rare wines contribute to a unique local experience influenced by the latest trends from Paris...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20Soi%20Langsuan%209%2C%20Lumphini%2C%20Pathum%20Wan%2C%20Bangkok%2C%2010330%2C%20Thailand"
    pageTitle="Bisou"
  />
);

export default Bisou;
