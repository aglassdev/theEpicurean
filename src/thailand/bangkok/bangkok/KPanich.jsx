...
const KPanich = () => (
  <RestaurantPage
    restaurantName="K. Panich"
    address="431-433 Tanao Road, Sao Chingcha, Phra Nakhon, Bangkok, 10200, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+6622213554"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/k-panich"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This iconic family-run eatery serves delectable mango sticky rice made to a recipe that has been handed down the generations for 80 years. Their preparation is masterful: the flavour of the steamed sweetened sticky rice is enhanced by the richness of coconut milk...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=431-433%20Tanao%20Road%2C%20Sao%20Chingcha%2C%20Phra%20Nakhon%2C%20Bangkok%2C%2010200%2C%20Thailand"
    pageTitle="K. Panich"
  />
);

export default KPanich;
