...
const Sorn = () => (
  <RestaurantPage
    ...
    priceRange="฿฿฿฿"
    phoneNumber="+66990811119"
    website="https://www.sornfinesouthern.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Immerse yourself in the food culture of Southern Thailand, with the exquisite cooking of self-taught Chef-Owner Supaksorn Jongsiri. Blending tradition with modernity, refinement with evolution, his perfectly paced menu offers an array of exhilarating flavours, all of which are in perfect harmony. Whether Tapi River prawns, Phuket lobster or Andaman squid, the ingredients will be truly stunning. The whole experience will more than make up for the very thorough process involved in securing a table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20Soi%20Sukhumvit%2026%2C%20Khlong%20Tan%2C%20Khlong%20Toei%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Sorn"
  />
);
