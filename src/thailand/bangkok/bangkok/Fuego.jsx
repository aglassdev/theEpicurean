...
const Fuego = () => (
  <RestaurantPage
    ...
    address="2F, The Taste Thonglor, Thong Lo Soi 11, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Spanish Contemporary"
    priceRange="฿฿฿"
    phoneNumber="+66644535621"
    website="https://guide.michelin.com/en/bangkok-region/bangkok/restaurant/fuego"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Helmed by a Spanish chef with a passion for Japanese cuisine, Fuego boldly blends these two culinary traditions. From your seat in this intimate setting, watch premium-quality Spanish and Japanese ingredients being meticulously crafted in the open kitchen. Don't miss the signature paella. Another standout is the tapas, complemented by Japanese whisky and sake. The velvety, multidimensional miso cheesecake is the perfect ending...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Taste%20Thonglor%2C%20Thong%20Lo%20Soi%2011%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Fuego"
  />
);
