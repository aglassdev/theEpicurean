...
const WahLokBAN = () => (
  <RestaurantPage
    restaurantName="Wah Lok"
    address="2F, Carlton Hotel Bangkok Sukhumvit, 491 Sukhumvit Road, Khlong Tan Nuea, Vadhana, Bangkok, 10110, Thailand"
    cuisine="Cantonese"
    priceRange="฿฿"
    phoneNumber="+6620907888"
    website="https://www.carltonhotel.co.th/dining/wah-lok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Singaporean institution for over 3 decades, Wah Lok boasts a strong following, several awards, and this sibling outside Singapore. The plush carpeted dining room sports high ceilings and a stylish mix of modern and classic details. The food is artistically plated and made with premium imports such as Boston lobster, which is consummately braised and enhanced with ginger and spring onion. Book in advance, especially for the expertly crafted dim sum lunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Carlton%20Hotel%20Bangkok%20Sukhumvit%2C%20491%20Sukhumvit%20Road%2C%20Khlong%20Tan%20Nuea%2C%20Vadhana%2C%20Bangkok%2C%2010110%2C%20Thailand"
    pageTitle="Wah Lok"
  />
);

export default WahLokBAN;
