...
const OneChun = () => (
  <RestaurantPage
    restaurantName="One Chun"
    address="48/1 Thep Krasatti Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Southern Thai"
    priceRange="฿฿"
    phoneNumber="+6676355909"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/one-chun"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Merging the owner's fashion design flair and passion for fine fare, One Chun offers a vintage-toned dining experience in a 19C building. Diners still enjoy the family recipes, which have been passed down the generations. Among the specialties is a spicy yet refreshing dish with boiled shrimp and shrimp paste, perfectly balancing the salty and sour notes. Be sure to try Mu Hong for its bold flavours and soft, tender pork belly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%2F1%20Thep%20Krasatti%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="One Chun"
  />
);

export default OneChun;
