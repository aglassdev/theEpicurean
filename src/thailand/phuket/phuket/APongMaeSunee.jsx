...
const APongMaeSunee = () => (
  <RestaurantPage
    restaurantName="A Pong Mae Sunee"
    address="99 Soi Soon Uthit, Yaowarat Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66867437557"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/a-pong-mae-sunee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over five years, Sunee’s street food stall has been renowned for its Khanom A Pong—delicious coconut crepes. Cooked in mini woks over charcoal, the crepes are unique for their light, crispy shell and soft centre—a perfect balance of sweetness and creamy coconut. Be sure to arrive early at this beloved stall to experience these irresistible snacks...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Soi%20Soon%20Uthit%2C%20Yaowarat%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="A Pong Mae Sunee"
  />
);

export default APongMaeSunee;
