...
const JongjitKitchen = () => (
  <RestaurantPage
    restaurantName="Jongjit Kitchen"
    address="9/1 Mu 4, Wichit Songkhram Road, Kathu, Phuket, 83120, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+6676321357"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/jongjit-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Southern recipes, affordable prices and down-to-earth hospitality – this is why locals pack out this family-run business at lunch and dinner. Their family recipes pack great intensity. The Phuketian stir-fried pork rump with salt is lovely, with tender meat and lip-smacking pork skin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%2F1%20Mu%204%2C%20Wichit%20Songkhram%20Road%2C%20Kathu%2C%20Phuket%2C%2083120%2C%20Thailand"
    pageTitle="Jongjit Kitchen"
  />
);

export default JongjitKitchen;
