...
const TonMayom = () => (
  <RestaurantPage
    restaurantName="Ton Mayom"
    address="23/17 Mu 6, Thep Krasattri Road, Ratsada, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Southern Thai"
    priceRange="฿"
    phoneNumber="+66944292265"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/ton-mayom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Mayom (star gooseberry) is a local tree located at the front of this outlet that offers a shady setting. They serve fried local fish with an aromatic curry and Southern Thai sour curry soup with seabass and young coconut shoots. The signatures are delicious and a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%2F17%20Mu%206%2C%20Thep%20Krasattri%20Road%2C%20Ratsada%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Ton Mayom"
  />
);

export default TonMayom;
