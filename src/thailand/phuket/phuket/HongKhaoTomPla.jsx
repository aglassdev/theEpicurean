...
const HongKhaoTomPla = () => (
  <RestaurantPage
    restaurantName="Hong Khao Tom Pla"
    address="5 Kra Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6686277807"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/hong-khao-tom-pla"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is always a queue in front of this small shop. The mainstay on the menu is seafood. Dishes are carefully prepared by the owner, and the fresh prawns are a must. Check the whiteboard for the daily catch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Kra%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Hong Khao Tom Pla"
  />
);

export default HongKhaoTomPla;
