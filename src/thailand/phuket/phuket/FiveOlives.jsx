...
const FiveOlives = () => (
  <RestaurantPage
    restaurantName="Five Olives"
    address="2/1 Pasak-Koktanod Road, Cherngtalay, Thalang, Phuket, 83110, Thailand"
    cuisine="Italian, Pizza"
    priceRange="฿฿"
    phoneNumber="+66826294944"
    website="https://www.fiveolives.co"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Thai chef-owner draws superb flavour from a wood-fired oven, turning out Neapolitan pies with puffy, char-flecked Canotto rims and airy bases. The menu ranges from homemade pasta and creamy risotto to prime grilled meats, seafood and crisp salads, including green bowls. The braised seabass with clams is light, fresh and aromatic. Dine in the cool, air-conditioned room or on the leafy terrace; both suit laid-back gatherings among friends or family...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%2F1%20Pasak-Koktanod%20Road%2C%20Cherngtalay%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Five Olives"
  />
);

export default FiveOlives;
