...
const TiffinByLaSala = () => (
  <RestaurantPage
    restaurantName="Tiffin by La Sala"
    address="Anantara Mai Khao Phuket Villas, 888 Mu 3, Mai Khao, Thalang, Phuket, 83110, Thailand"
    cuisine="Indian"
    priceRange="฿฿"
    phoneNumber="+6676336100"
    website="https://www.anantara.com/en/mai-khao-phuket/restaurants/tiffin-by-la-sala"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Al fresco dining by a tranquil lagoon is the big draw at this restaurant located in Anantara Mai Khao Villas. The chef, from Maharashtra, takes diners on a journey through authentic Indian cuisine via an extensive à la carte featuring curries, a tiffin chaat platter and dishes from the tandoor oven. The cooking is flavoursome and well-spiced, with their signature lamb vindaloo a stand-out and the freshly baked naan well worth trying. Indoor dining with a view of the open kitchen is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Anantara%20Mai%20Khao%20Phuket%20Villas%2C%20888%20Mu%203%2C%20Mai%20Khao%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Tiffin by La Sala"
  />
);

export default TiffinByLaSala;
