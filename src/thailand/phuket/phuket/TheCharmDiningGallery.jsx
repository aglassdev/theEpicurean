...
const TheCharmDiningGallery = () => (
  <RestaurantPage
    restaurantName="The Charm Dining Gallery"
    address="93 Dibuk Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Southern Thai"
    priceRange="฿฿"
    phoneNumber="+6676530199"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/the-charm"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having grown up working in his family's food business, Chef Buriphat always wanted to do something special with their recipes. Over the last few years, he has realised that vision, impressing diners with his honest interpretation of traditional Southern Thai-Peranakan cuisine. Check out the delicious stir-fried pork belly with herbs and sweet dark soy sauce, and be sure to try the pork rib soup with tofu and salted fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=93%20Dibuk%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="The Charm Dining Gallery"
  />
);

export default TheCharmDiningGallery;
