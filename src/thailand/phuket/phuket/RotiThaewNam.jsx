...
const RotiThaewNam = () => (
  <RestaurantPage
    restaurantName="Roti Thaew Nam"
    address="6 Thep Krasattri Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6676210061"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/roti-taew-nam"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Soft, crispy, non-oily roti emerge from a huge charcoal pan. At this 70-year-old Halal breakfast spot, they're shaped, fried and served in the blink of an eye and served with tender beef or chicken curry. The sweeter roti with banana and egg has no added sugar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Thep%20Krasattri%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Roti Thaew Nam"
  />
);

export default RotiThaewNam;
