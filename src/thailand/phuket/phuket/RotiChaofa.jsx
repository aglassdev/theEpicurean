...
const RotiChaofa = () => (
  <RestaurantPage
    restaurantName="Roti Chaofa"
    address="44 Chaofa Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6676221771"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/roti-chaofa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 35 years, the locals have flocked to Roti Chaofa for Thai-Muslim breakfasts, curries and Thai-style chicken biryani. The crisp, golden-brown rotis with a fluffy inner, are nicely salted and enjoyed with sweets or savouries. The tangy, juicy Beef Massaman curry is delightful...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Chaofa%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Roti Chaofa"
  />
);

export default RotiChaofa;
