...
const KhaoTomThanonDiBuk = () => (
  <RestaurantPage
    restaurantName="Khao Tom Thanon Di Buk"
    address="185/11 Phang-Nga Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Noodles and Congee"
    priceRange="฿"
    phoneNumber="+6676215731"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/khao-tom-thanon-di-buk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run gem serves comforting classics, from aromatic Khao Tom porridge to a secret-recipe Chinese brown soup with various toppings. Weekend specials include braised pork ribs and chicken with fermented soybeans. Adding a twist, they serve sandwiches filled with distinctly flavoured kaya. The perfect balance of casual dining and unique culinary delights is complemented by charming local Thai-Chinese decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=185%2F11%20Phang-Nga%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Khao Tom Thanon Di Buk"
  />
);

export default KhaoTomThanonDiBuk;
