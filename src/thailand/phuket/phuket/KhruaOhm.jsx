...
const KhruaOhm = () => (
  <RestaurantPage
    restaurantName="Khrua Ohm"
    address="2/99 Mu 2, Wichit Songkhram Road, Kathu, Phuket, 83120, Thailand"
    cuisine="Southern Thai"
    priceRange="฿฿"
    phoneNumber="+6676631523"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/khrua-ohm"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a decade as a musician with a side gig of cooking for bandmates, these days Somphop finds himself enjoying daily walks through the market for fresh catches of the day and hand-cutting them for various southern Thai dishes served at his small, casual restaurant. Braised fish in salted soybean sauce; prawns with salted eggs and acacia; and wok-fried pork featuring the tender, succulent ‘armpit cut’ between the picnic shoulder and belly are not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%2F99%20Mu%202%2C%20Wichit%20Songkhram%20Road%2C%20Kathu%2C%20Phuket%2C%2083120%2C%20Thailand"
    pageTitle="Khrua Ohm"
  />
);

export default KhruaOhm;
