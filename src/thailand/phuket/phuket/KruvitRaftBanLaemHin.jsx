...
const KruvitRaftBanLaemHin = () => (
  <RestaurantPage
    restaurantName="Kruvit Raft (Ban Laem Hin)"
    address="98/7 Ko Maphrao, Mu 6, Ko Kaeo, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66866870892"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/kruvit-raft-ban-laem-hin"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=98%2F7%20Ko%20Maphrao%2C%20Mu%206%2C%20Ko%20Kaeo%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Kruvit Raft (Ban Laem Hin)"
  />
);

export default KruvitRaftBanLaemHin;
