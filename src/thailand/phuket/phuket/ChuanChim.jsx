...
const ChuanChim = () => (
  <RestaurantPage
    restaurantName="Chuan Chim"
    address="37/3 Montri Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6676215825"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/chuan-chim"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the oldest food shops in Phuket, now run by the second generation, offers the freshest seafood, all prepared à la minute. The chef's impressive wok skills shine through in every dish, with highlights like the aromatic Tom Yam seafood soup and deep-fried squid with garlic and pepper...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%2F3%20Montri%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Chuan Chim"
  />
);

export default ChuanChim;
