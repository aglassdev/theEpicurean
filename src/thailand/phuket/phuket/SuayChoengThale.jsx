...
const SuayChoengThale = () => (
  <RestaurantPage
    restaurantName="Suay (Choeng Thale)"
    address="Baan Wana Park, 177/99 Mu 4, Si Sunthon Road, Choeng Thale, Thalang, Phuket, 83110, Thailand"
    cuisine="Thai contemporary"
    priceRange="฿฿฿"
    phoneNumber="+66933391890"
    website="https://www.suayrestaurant.com/suay-cherngtalay"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baan%20Wana%20Park%2C%20177%2F99%20Mu%204%2C%20Si%20Sunthon%20Road%2C%20Choeng%20Thale%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Suay (Choeng Thale)"
  />
);

export default SuayChoengThale;
