...
const LarmeByTheSea = () => (
  <RestaurantPage
    restaurantName="L'Arôme by the Sea"
    address="247/5 Phrabaramee Road, Pa Tong, Kathu, Phuket, 83150, Thailand"
    cuisine="French Contemporary, Creative"
    priceRange="฿฿฿฿"
    phoneNumber="+66652392111"
    website="https://www.laromegroup.com/laromebythesea"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start with a refreshing cocktail and enjoy the sea breeze on the rooftop before descending to the main dining room for stunning ocean views and the 'Vue sur la Mer' tasting menu. The seafood is of high quality, but the roasted pigeon with eggplant is also a standout. Meanwhile, the creamy foie gras and langoustine showcase the chef's culinary skills...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=247%2F5%20Phrabaramee%20Road%2C%20Pa%20Tong%2C%20Kathu%2C%20Phuket%2C%2083150%2C%20Thailand"
    pageTitle="L'Arôme by the Sea"
  />
);

export default LarmeByTheSea;
