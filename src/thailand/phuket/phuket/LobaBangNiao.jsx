...
const LobaBangNiao = () => (
  <RestaurantPage
    restaurantName="Loba Bang Niao"
    address="18/61 Mae Luan Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6676234693"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/loba-bang-niao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Loba was a traditional snack for Fujian Chinese in Phuket and this shop has remained consistent since day one. The semi-crispy pork offal and aromatic spices of the mixed loba blend well with a sweet chilli and crushed peanut sauce. The 4 deep-fried dishes are also mouth-watering treats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%2F61%20Mae%20Luan%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Loba Bang Niao"
  />
);

export default LobaBangNiao;
