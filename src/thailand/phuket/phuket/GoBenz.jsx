...
const GoBenz = () => (
  <RestaurantPage
    restaurantName="Go Benz"
    address="163 Krabi Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Asian"
    priceRange="฿"
    phoneNumber="+66840607799"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/go-benz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The constantly busy Go Benz has been serving popular dishes, including their speciality pork with peppery broth and rolled rice noodles, for over 20 years – and it’s easy to see why it’s quite such a popular spot. Many of the dishes often sell out, like the fragrant dry boiled rice with crispy pork and tender pork offal. Also well worth ordering is the crispy pork with sweet soy sauce, which is seasoned wonderfully and has a lovely charcoal-grilled crust...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=163%20Krabi%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Go Benz"
  />
);

export default GoBenz;
