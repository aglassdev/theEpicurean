...
const SangKaSri = () => (
  <RestaurantPage
    restaurantName="Sang Ka Sri"
    address="262/8 Yaowarat Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66896458586"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/sang-ka-sri"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This outlet with a red-brown zinc roof offers a menu of both individual and sharing dishes, with nicely balanced flavours. Despite its humble guise, Sang Ka Sri attracts a crowd, so be prepared to wait for a table before enjoying the fresh squid with herbs and tangy dressing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=262%2F8%20Yaowarat%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Sang Ka Sri"
  />
);

export default SangKaSri;
