...
const KruaBaanPlatong = () => (
  <RestaurantPage
    restaurantName="Krua Baan Platong"
    address="167/1 Mu 5, Thepkrasattri Road, Si Sunthon, Thalang, Phuket, 83110, Thailand"
    cuisine="Southern Thai"
    priceRange="฿"
    phoneNumber="+66629622563"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/krua-baan-platong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Popular with Thai celebrities and prominent politicians, this eatery tucked away in a tiny alley in Thalang deserves its excellent reputation. The chefs source quality local ingredients to produce intensely flavoured dishes that encapsulate the essence of Phuket. Highlights include stir-fried banana stalk with plump shrimps and shrimp paste, and melt-in-your-mouth steamed pork belly with their signature southern Thai budu dipping sauce. Booking and ordering in advance are a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=167%2F1%20Mu%205%2C%20Thepkrasattri%20Road%2C%20Si%20Sunthon%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Krua Baan Platong"
  />
);

export default KruaBaanPlatong;
