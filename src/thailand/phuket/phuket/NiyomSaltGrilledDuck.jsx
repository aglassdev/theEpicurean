...
const NiyomSaltGrilledDuck = () => (
  <RestaurantPage
    restaurantName="Niyom Salt Grilled Duck"
    address="5/19 Mu 3, Chao Fah Tawan Tok Road, Wichit, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Grills"
    priceRange="฿"
    phoneNumber="+66872824719"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/niyom-salt-grilled-duck"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This unassuming gem serves around 30-40 juicy, tender charcoal-roasted ducks every day. Order a half or whole bird and savour the wholesome flavour and crispy skin fresh off the stove with either spicy-sour or tamarind sauce for dipping. Grilled chicken is sometimes an option, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%2F19%20Mu%203%2C%20Chao%20Fah%20Tawan%20Tok%20Road%2C%20Wichit%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Niyom Salt Grilled Duck"
  />
);

export default NiyomSaltGrilledDuck;
