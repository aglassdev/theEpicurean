...
const LaGaetana = () => (
  <RestaurantPage
    restaurantName="La Gaetana"
    address="352 Phuket Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Italian"
    priceRange="฿฿"
    phoneNumber="+66813971227"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/la-gaetana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It may be tiny, with 6 tables, but La Gaetana, decorated like an Italian house in warm colours, provides a warm welcome and is big on charm. They import most ingredients from Italy and make the sourdough, pasta, gelato and limoncello in-house. Chef Gianni cooks the fettucine with tomato sauce and crab meat using his family recipe from Campania. The menu is largely influenced by such southern classics. As Gianni takes a summer holiday each year, call ahead first...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=352%20Phuket%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="La Gaetana"
  />
);

export default LaGaetana;
