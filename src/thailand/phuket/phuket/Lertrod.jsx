...
const Lertrod = () => (
  <RestaurantPage
    restaurantName="Lertrod"
    address="17/7 Nai Yang Road, Sakhu, Thalang, Phuket, 83110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66903232321"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/lertrod"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Across from the airport, this bright air-conditioned restaurant flies under the radar but lands simple, satisfying central and southern Thai fare. The skilled chef sources quality ingredients from local farmers and fishermen. The deep-fried seabass with fish sauce never disappoints. For the spicy southern-Thai sour curry, choose from pickled bamboo, coconut shoots or pineapple. The photo-filled menu, written in Thai, English and Chinese, makes it easy for everyone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%2F7%20Nai%20Yang%20Road%2C%20Sakhu%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Lertrod"
  />
);

export default Lertrod;
