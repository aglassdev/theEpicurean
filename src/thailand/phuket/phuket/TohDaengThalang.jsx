...
const TohDaengThalang = () => (
  <RestaurantPage
    restaurantName="Toh Daeng (Thalang)"
    address="GF, Baan Ar-jor, 102 Thep Kasattri Road, Mai Khao, Thalang, Phuket, 83110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66624598889"
    website="https://www.baanarjor.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Baan%20Ar-jor%2C%20102%20Thep%20Kasattri%20Road%2C%20Mai%20Khao%2C%20Thalang%2C%20Phuket%2C%2083110%2C%20Thailand"
    pageTitle="Toh Daeng (Thalang)"
  />
);

export default TohDaengThalang;
