...
const Jadjan = () => (
  <RestaurantPage
    restaurantName="Jadjan"
    address="4/27 Sakdidet Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66898681954"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/jadjan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Suthee, a former 5-star hotel chef, uses expertise to produce simple southern Thai fare that’s packed with flavour. The crab meat curry with betel leaves and southern Thai sour curry with fresh local fish and pineapple get our nod of approval...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%2F27%20Sakdidet%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Jadjan"
  />
);

export default Jadjan;
