...
const OTaoBangNiao = () => (
  <RestaurantPage
    restaurantName="O Tao Bang Niao"
    address="362 Phuket Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66915154949"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/o-tao-bang-niao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1982, this family-run spot has been serving flavoursome O Tao, a stir-fried dish found only in Phuket. Made with seafood and battered taro, O Tao is cooked over a charcoal flame and boasts a combination of soft, gooey and crispy textures. They are well-balanced here, and the smoky aroma from the charcoal also helps to elevate the dish. Other options available include a fried crispy seafood omelette that is well worth ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=362%20Phuket%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="O Tao Bang Niao"
  />
);

export default OTaoBangNiao;
