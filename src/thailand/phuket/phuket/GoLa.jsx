...
const GoLa = () => (
  <RestaurantPage
    restaurantName="Go La"
    address="11 Kra Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+6676630409"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/go-la"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In its third generation of family ownership, this is one of Phuket’s best Hokkien-style fried noodle joints. Its charm is conjured up by a concoction of special flavours, the sounds of the wok and charcoal smells. Order the yellow hokkien noodles with an extra egg for a creamier texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20Kra%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Go La"
  />
);
