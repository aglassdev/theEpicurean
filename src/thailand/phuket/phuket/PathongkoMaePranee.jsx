...
const PathongkoMaePranee = () => (
  <RestaurantPage
    restaurantName="Pathongko Mae Pranee"
    address="57 Wirat Hong Yok 3 Road, Wichit, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Street Food, Pa Thong Ko"
    priceRange="฿"
    phoneNumber="+66873868894"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/pathongko-mae-pranee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Customers with a sweet tooth and fans of deep-fried goodness line up here from 6am to get their daily fix. The deep-fried Patongko (dough sticks) and salapao are freshly prepared; the crunchy fries are golden-brown. It’s all very tasty; even without the dipping sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20Wirat%20Hong%20Yok%203%20Road%2C%20Wichit%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Pathongko Mae Pranee"
  />
);

export default PathongkoMaePranee;
