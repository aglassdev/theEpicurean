...
const OChaRot = () => (
  <RestaurantPage
    restaurantName="O Cha Rot"
    address="72/1 Yaowarat Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6676213347"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/o-cha-rot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Old Phuket Town, a red sign sits above the white façade; its Thai name in gold lettering declares: Delicious. The plump beef balls are packed with flavour; beef slices tender; bone broth fragrant; and the soft noodles are perfectly cooked. Arrive early for lunch before it runs out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=72%2F1%20Yaowarat%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="O Cha Rot"
  />
);

export default OChaRot;
