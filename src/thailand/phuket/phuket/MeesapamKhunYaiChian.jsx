...
const MeesapamKhunYaiChian = () => (
  <RestaurantPage
    restaurantName="Meesapam Khun Yai Chian"
    address="56/8, 65/24 Mu 1, Thep Krasatti Road, Ko Kaeo, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿฿"
    phoneNumber="+6676377595"
    website="https://www.meesapam.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Grandma Chian opened this Hokkien restaurant in 1952. Her great-great grandchildren have stayed loyal to her recipes and proudly exhibit her cooking utensils. Serving Phuket favourites, the Mee Sapam, stir-fried Hokkien noodles with seafood, is great. The stir-fried oysters with crispy egg roll are beautifully crafted with beansprouts, kale and a tasty chilli sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%2F8%2C%2065%2F24%20Mu%201%2C%20Thep%20Krasatti%20Road%2C%20Ko%20Kaeo%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Meesapam Khun Yai Chian"
  />
);

export default MeesapamKhunYaiChian;
