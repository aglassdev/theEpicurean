...
const Gorjan = () => (
  <RestaurantPage
    restaurantName="Gorjan"
    address="161 Kra Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66872701964"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/gorjan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you're near Gorjan Bridge, consider this simple family-run eatery. Every dish is rife with rich flavours, and many are created from their own recipes. The owner is poised to cook your food to order, which ensures a personalised dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=161%20Kra%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Gorjan"
  />
);

export default Gorjan;
