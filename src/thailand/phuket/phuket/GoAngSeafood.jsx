...
const GoAngSeafood = () => (
  <RestaurantPage
    restaurantName="Go Ang Seafood"
    address="226 Mu 2, Phuket Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Seafood"
    priceRange="฿฿฿"
    phoneNumber="+6676221460"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/go-ang-seafood"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=226%20Mu%202%2C%20Phuket%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Go Ang Seafood"
  />
);

export default GoAngSeafood;
