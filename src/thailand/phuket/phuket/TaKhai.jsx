...
const TaKhai = () => (
  <RestaurantPage
    restaurantName="Ta Khai"
    address="Rosewood Phuket, 88/28, 88/30-33 Muen-Ngoen Road, Pa Tong, Kathu, Phuket, 83150, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+6676356888"
    website="https://www.rosewoodhotels.com/en/phuket/dining/ta-khai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ta Khai means ‘fishing net’, and here diners can choose live seafood from the restaurant’s tank before a chef scoops it up and cooks it. Dishes, including the deep-fried white snapper with fish sauce, are flavoursome, with spicing slightly toned down if you wish, while two set menus offer a variety of items to try. Ask for a table on the lovely terrace for a panoramic view of the bay and cityscape beyond – or for something different, book a BBQ sala...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rosewood%20Phuket%2C%2088%2F28%2C%2088%2F30-33%20Muen-Ngoen%20Road%2C%20Pa%20Tong%2C%20Kathu%2C%20Phuket%2C%2083150%2C%20Thailand"
    pageTitle="Ta Khai"
  />
);

export default TaKhai;
