...
const Sizzle = () => (
  <RestaurantPage
    restaurantName="Sizzle"
    address="Avista Hideaway Phuket Patong - MGallery, 39/9 Muen-Ngern Road, Pa Tong Beach, Pa Tong, Kathu, Phuket, 83150, Thailand"
    cuisine="European"
    priceRange="฿฿฿฿"
    phoneNumber="+66958340453"
    website="https://www.sizzlerooftopphuket.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sunsets lend an amber glow to this rooftop restaurant with wooden accents, where the Andaman Sea meets rolling hills. The kitchen keeps things simple yet shows confidence, with crispy ibérico croquettes that arrive piping hot, then a precisely charred steak or deftly grilled seafood that delivers clean, bold flavours. Finish with their warm sticky toffee pudding oozing caramel. Prices may sit above the norm but feel fair given the quality and the setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avista%20Hideaway%20Phuket%20Patong%20-%20MGallery%2C%2039%2F9%20Muen-Ngern%20Road%2C%20Pa%20Tong%20Beach%2C%20Pa%20Tong%2C%20Kathu%2C%20Phuket%2C%2083150%2C%20Thailand"
    pageTitle="Sizzle"
  />
);
