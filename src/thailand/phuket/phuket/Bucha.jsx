...
const Bucha = () => (
  <RestaurantPage
    restaurantName="Bucha"
    address="26/156 Chao Fah Tawan Ok Road, Chalong, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Southern Thai"
    priceRange="฿฿"
    phoneNumber="+66611765562"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/bucha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Southern Thai soul surges through this gallery-like space, its wooden tables framed by soft light and glinting ranks of Buddha images and Luang Pu Thuat amulets. House-made curry pastes drive dishes that roar with the spicy and mildly sour hallmarks of the South. Highlights include yellow curry, fresh herb salads and crisp local fish draped in pungent budu sauce. As portions are generous and meant for sharing, gather your friends and taste a variety of dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%2F156%20Chao%20Fah%20Tawan%20Ok%20Road%2C%20Chalong%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Bucha"
  />
);
