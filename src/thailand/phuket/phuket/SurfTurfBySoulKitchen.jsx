...
const SurfTurfBySoulKitchen = () => (
  <RestaurantPage
    restaurantName="Surf & Turf by Soul Kitchen"
    address="115 Phangnga Road, Talat Yai, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="European Contemporary"
    priceRange="฿฿"
    phoneNumber="+66972177434"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/surf-turf-by-soul-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu changes every month in this intriguing restaurant. Regular options range from home-made pastas to a signature seafood dish, plus specials that are cleverly curated to showcase Chef Tom's latest culinary creations. The chef artfully prepares his dishes, blending quality ingredients to tantalise the taste buds. And thanks to the ever-changing selection of handpicked wines, there's always something different to sip with your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Phangnga%20Road%2C%20Talat%20Yai%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Surf & Turf by Soul Kitchen"
  />
);

export default SurfTurfBySoulKitchen;
