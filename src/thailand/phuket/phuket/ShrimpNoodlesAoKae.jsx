...
const ShrimpNoodlesAoKae = () => (
  <RestaurantPage
    restaurantName="Shrimp Noodles Ao Kae"
    address="76 Phoonphol Road, Talat Nuea, Mueang Phuket, Phuket, 83000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6676210084"
    website="https://guide.michelin.com/en/phuket-region/phuket/restaurant/shrimp-noodles-ao-kae"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It has been crafting meticulous shrimp noodle bowls for over a decade. Tom yum and original shrimp flavour noodles, available as wet and dry options, come with the perfect number of condiments. Pork wontons are the standout! For intense flavour, try the dry tom yum noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=76%20Phoonphol%20Road%2C%20Talat%20Nuea%2C%20Mueang%20Phuket%2C%20Phuket%2C%2083000%2C%20Thailand"
    pageTitle="Shrimp Noodles Ao Kae"
  />
);

export default ShrimpNoodlesAoKae;
