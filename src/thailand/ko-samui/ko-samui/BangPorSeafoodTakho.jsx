...
const BangPorSeafoodTakho = () => (
  <RestaurantPage
    restaurantName="Bang Por Seafood Takho"
    address="56/4 Mu 6, Maenam, Ko Samui, 84320, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66855759999"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/koh-samui_7770005/restaurant/bang-por-seafood-takho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bang Por boasts an experienced kitchen team composed of local chefs who have worked here for many years. This simple beach-front restaurant is depicted by holiday vibes and Southern Thai seafood fare. The spicy stir-fried squid with herbs is cooked in a spicy curry paste and the grilled fish is sprinkled with mixed Thai herbs. The house shrimp paste is packed with aromatic plants and coconut chili and grilled before serving, hence the pungent aroma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%2F4%20Mu%206%2C%20Maenam%2C%20Ko%20Samui%2C%2084320%2C%20Thailand"
    pageTitle="Bang Por Seafood Takho"
  />
);

export default BangPorSeafoodTakho;
