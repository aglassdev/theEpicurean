...
const KruaChaoBaan = () => (
  <RestaurantPage
    restaurantName="Krua Chao Baan"
    address="438/18 Mu 1, Maret, Ko Samui, 84310, Thailand"
    cuisine="Seafood, Southern Thai"
    priceRange="฿฿"
    phoneNumber="+66878937766"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/koh-samui_7770005/restaurant/krua-chao-baan-samui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Krua Chao Baan means local kitchen, which aptly describes the vibe of this eatery specialised in Southern Thai food. The signature omelette is simple: crispy, not oily, with mixed seafood and well-seasoned minced pork. The stir-fried squid with pineapple, a local recipe only found on the island, is depicted by joyful sweet, sour and peppery notes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=438%2F18%20Mu%201%2C%20Maret%2C%20Ko%20Samui%2C%2084310%2C%20Thailand"
    pageTitle="Krua Chao Baan"
  />
);

export default KruaChaoBaan;
