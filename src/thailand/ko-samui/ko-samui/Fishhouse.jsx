...
const Fishhouse = () => (
  <RestaurantPage
    restaurantName="FishHouse"
    address="Kimpton Kitalay Samui, 10/79 Mu 5, Bo Phut, Ko Samui, 84320, Thailand"
    cuisine="European"
    priceRange="฿฿฿"
    phoneNumber="+6677951900"
    website="https://www.kimptonkitalaysamui.com/koh-samui-restaurants/fish-house-restaurant-and-bar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set inside the Kimpton Kitalay resort, FishHouse crafts à la carte European recipes using the freshest local ingredients. Take a seat on the deck overlooking the beach and enjoy the sea breeze and the lively atmosphere by the pool where sunbathers sip cocktails. Start with ceviche, bursting with fresh tropical passionfruit flavours and perfectly marinated diced seabass. The Black Paella with squid and squid ink is ideal to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kimpton%20Kitalay%20Samui%2C%2010%2F79%20Mu%205%2C%20Bo%20Phut%2C%20Ko%20Samui%2C%2084320%2C%20Thailand"
    pageTitle="FishHouse"
  />
);
