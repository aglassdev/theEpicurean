...
const KohThaiKitchen = () => (
  <RestaurantPage
    restaurantName="Koh Thai Kitchen"
    address="Four Seasons Resort Koh Samui, 219 Mu 5, Ang Thong, Ko Samui, 84140, Thailand"
    cuisine="Thai"
    priceRange="฿฿฿"
    phoneNumber="+6677243000"
    website="https://www.fourseasons.com/kohsamui/dining/restaurants/koh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Koh Thai Kitchen is located on a hilltop within the Four Seasons Hotel. The restaurant's alfresco dining areas sport a rustic style. Diners can enjoy southern and central Thai dishes made with premium ingredients such as local seafood, Australian lamb and Wagyu beef. All of which while breathing in the fresh air as you admire the drop-dead vista of sprawling jungle and blue sea dotted with nearby islands, as you snap the dramatic Instagram-perfect sunsets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Resort%20Koh%20Samui%2C%20219%20Mu%205%2C%20Ang%20Thong%2C%20Ko%20Samui%2C%2084140%2C%20Thailand"
    pageTitle="Koh Thai Kitchen"
  />
);

export default KohThaiKitchen;
