...
const BaanSuanLungKhai = () => (
  <RestaurantPage
    restaurantName="Baan Suan Lung Khai"
    address="18/18 Mu 4, Taling Ngam, Ko Samui, 84140, Thailand"
    cuisine="Seafood, Southern Thai"
    priceRange="฿฿"
    phoneNumber="+66814162244"
    website="https://guide.michelin.com/en/cchanghwad-suraasdrthaanii/koh-samui_7770005/restaurant/baan-suan-lung-khai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Uncle Khai’s garden house, located on the chef-owner’s coconut plantation, is a labour of love. He sources seafood from his friends, local fishermen, and serves local and Southern Thai cuisine using the freshest ingredients of the day. Diners, who must book a day in advance, can enjoy fresh oysters and grilled seafood on the alfresco wooden-decked veranda with an open kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%2F18%20Mu%204%2C%20Taling%20Ngam%2C%20Ko%20Samui%2C%2084140%2C%20Thailand"
    pageTitle="Baan Suan Lung Khai"
  />
);

export default BaanSuanLungKhai;
