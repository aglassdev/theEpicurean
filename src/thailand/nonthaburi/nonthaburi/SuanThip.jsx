...
const SuanThip = () => (
  <RestaurantPage
    restaurantName="Suan Thip"
    address="17/9 Mu 7, Sukhaprachasan 2 Road, Bang Phut, Pak Kret, Nonthaburi, 11120, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6625833748"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/suan-thip"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The lush riverside gardens, pavilion and ponds feel a world away from the bustle of Bangkok’s streets. Suan Thip serves refined royal Thai cuisine in an idyllic setting for weddings. The delectable stir-fried crispy catfish with curry, dry curry paste and kaffir lime chiffonade strikes the perfect balance of textures, spices and a citrus aroma. The betal leaf wraps offer another pleasurable gift of flavours with pink lotus petals and a superb Miang Kum sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%2F9%20Mu%207%2C%20Sukhaprachasan%202%20Road%2C%20Bang%20Phut%2C%20Pak%20Kret%2C%20Nonthaburi%2C%2011120%2C%20Thailand"
    pageTitle="Suan Thip"
  />
);

export default SuanThip;
