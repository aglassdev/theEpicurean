...
const Dhabkwan = () => (
  <RestaurantPage
    restaurantName="Dhabkwan"
    address="Dhabkwan Resort, 178, 180, 182, 184 Nonthaburi Road, Suan Yai, Mueang Nonthaburi, Nonthaburi, 11000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6629691200"
    website="https://www.dhabkwan.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a teak house in the middle of Dhabkwan Resort, this traditional Thai restaurant opens onto a tranquil lotus pond and inviting gardens. The atmosphere perfectly matches the authentic Thai menu, which includes hard-to-find dishes like Miang Kam with lotus petals and santol curry with roasted pork. Making it even more authentic, meals are served on Benjarong porcelain. Dhabkwan also offers Thai cookery classes and is available for events...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dhabkwan%20Resort%2C%20178%2C%20180%2C%20182%2C%20184%20Nonthaburi%20Road%2C%20Suan%20Yai%2C%20Mueang%20Nonthaburi%2C%20Nonthaburi%2C%2011000%2C%20Thailand"
    pageTitle="Dhabkwan"
  />
);

export default Dhabkwan;
