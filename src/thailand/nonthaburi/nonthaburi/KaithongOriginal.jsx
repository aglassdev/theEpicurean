...
const KaithongOriginal = () => (
  <RestaurantPage
    restaurantName="Kaithong Original"
    address="164/13-15 Soi Chaeng Watthana-Pak Kret 33, Chaeng Watthana Road, Bang Phut, Pak Kret, Nonthaburi, 11120, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿฿"
    phoneNumber="+6629817771"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/golden-chicken-mueang-thong-thani"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run establishment is renowned for its traditional recipes, serving fresh meat and seafood flavours in simple yet refined and lightly seasoned dishes. Catering to different tastes, the stir-fried liver with garlic is made with either pork or chicken liver. The inviting, comfortable space can also accommodate larger groups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=164%2F13-15%20Soi%20Chaeng%20Watthana-Pak%20Kret%2033%2C%20Chaeng%20Watthana%20Road%2C%20Bang%20Phut%2C%20Pak%20Kret%2C%20Nonthaburi%2C%2011120%2C%20Thailand"
    pageTitle="Kaithong Original"
  />
);

export default KaithongOriginal;
