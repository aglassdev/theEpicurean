...
const Banya = () => (
  <RestaurantPage
    restaurantName="Banya"
    address="317 Tiwanon Road, Talat Khwan, Mueang Nonthaburi, Nonthaburi, 11000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6625910315"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/banya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Banya, or ‘Grandma’s house’ in Thai, embodies this maternal spirit. The menu, conceived by acclaimed culinary teacher Rachadapa Amatayakul, comprises typical Thai fare, some rarer recipes and their famous homely signature – Khao Chae. Also popular is the homemade spotted knifefish with green curry; the tender fish is an umami pleasure in an intense mix of herbs broiled in rich Thai curry. No wonder this place is always crowded with locals and foreigners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=317%20Tiwanon%20Road%2C%20Talat%20Khwan%2C%20Mueang%20Nonthaburi%2C%20Nonthaburi%2C%2011000%2C%20Thailand"
    pageTitle="Banya"
  />
);
