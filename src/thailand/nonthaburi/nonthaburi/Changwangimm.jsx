...
const Changwangimm = () => (
  <RestaurantPage
    restaurantName="Chang-Wang-Imm"
    address="44 Mu 4, Soi Wat Bang Chak, Bang Tanai, Pak Kret, Nonthaburi, 11120, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66855259242"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/chang-wang-imm"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Down by the banks of the Chao Phraya, enjoy affordable yet tasty Thai cuisine with relaxing river views from a charming 1950s house. Everything here is vintage, from the old-fashioned décor to the classic cooking techniques and flavours. The traditional Thai curry with pork, shrimp paste and basil is highly recommended. Book table #52 for remarkable private views from the upper deck. Live music adds to the ambience at the weekend...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Mu%204%2C%20Soi%20Wat%20Bang%20Chak%2C%20Bang%20Tanai%2C%20Pak%20Kret%2C%20Nonthaburi%2C%2011120%2C%20Thailand"
    pageTitle="Chang-Wang-Imm"
  />
);

export default Changwangimm;
