...
const FriedBananaRama5BangKruaiSaiNoiRoad = () => (
  <RestaurantPage
    restaurantName="Fried Banana Rama 5 (Bang Kruai - Sai Noi Road)"
    address="116 Bang Kruai - Sai Noi Road, Bang Si Thong, Bang Kruai, Nonthaburi, 11130, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66838185566"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/fried-banana-rama-5"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot is best known for its deep-fried bananas. Coated in crispy batter made from coconut and white sesame, they exude a rich coconut aroma. The sweet potato balls are another standout. Be prepared for queues during peak hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=116%20Bang%20Kruai%20-%20Sai%20Noi%20Road%2C%20Bang%20Si%20Thong%2C%20Bang%20Kruai%2C%20Nonthaburi%2C%2011130%2C%20Thailand"
    pageTitle="Fried Banana Rama 5 (Bang Kruai - Sai Noi Road)"
  />
);

export default FriedBananaRama5BangKruaiSaiNoiRoad;
