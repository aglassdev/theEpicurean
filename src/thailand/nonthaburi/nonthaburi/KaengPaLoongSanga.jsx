...
const KaengPaLoongSanga = () => (
  <RestaurantPage
    restaurantName="Kaeng Pa Loong Sa-Nga"
    address="285/162-3 Soi Ngam Wong Wan 23 Lane 11, Bang Khen, Mueang Nonthaburi, Nonthaburi, 11000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6629529992"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/kaeng-pa-loong-sa-nga"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by the same family for over 20 years, this restaurant is something of a hidden gem for spice-lovers. Their signature dish, jungle curry soup with hand-minced fish, provides suitably lip-smacking flavours using ingredients like red chilli, fingerroot and turkey berry. An outdoor area embraces nature, with curved tree trunk tables and an arboretum. Herbs and spices from the forest are used as seasoning, often with game meats – the succulent stir-fried deer with cumin leaves is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=285%2F162-3%20Soi%20Ngam%20Wong%20Wan%2023%20Lane%2011%2C%20Bang%20Khen%2C%20Mueang%20Nonthaburi%2C%20Nonthaburi%2C%2011000%2C%20Thailand"
    pageTitle="Kaeng Pa Loong Sa-Nga"
  />
);

export default KaengPaLoongSanga;
