...
const Sann = () => (
  <RestaurantPage
    restaurantName="SANN"
    address="32 Mu 10, Bang Yai-Bang Khu Lat Road, Bang Len, Bang Yai, Nonthaburi, 11140, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66661376749"
    website="https://guide.michelin.com/en/nonthaburi-region/nonthaburi/restaurant/sann"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This homely spot celebrates seldom-seen Phetchaburi traditions, favouring meat over fish and using prime local produce in time-honoured recipes. The palm-shoot curry, simmered in freshly pressed coconut milk and crowned with smoky grilled pork, whispers sweetness beneath its mellow heat. River prawn, flash-fried and dusted with sea salt, stays springy yet yielding, its coriander-garlic crunch begging for jasmine rice. An honest taste of central Thailand...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20Mu%2010%2C%20Bang%20Yai-Bang%20Khu%20Lat%20Road%2C%20Bang%20Len%2C%20Bang%20Yai%2C%20Nonthaburi%2C%2011140%2C%20Thailand"
    pageTitle="SANN"
  />
);
