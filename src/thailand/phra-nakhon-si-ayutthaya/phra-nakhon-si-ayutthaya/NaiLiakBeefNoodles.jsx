...
const NaiLiakBeefNoodles = () => (
  <RestaurantPage
    restaurantName="Nai Liak Beef Noodles"
    address="6/7 Pa Maphrao Road, Ho Rattanachai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66816286538"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/nai-liak-beef-noodles"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%2F7%20Pa%20Maphrao%20Road%2C%20Ho%20Rattanachai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Nai Liak Beef Noodles"
  />
);

export default NaiLiakBeefNoodles;
