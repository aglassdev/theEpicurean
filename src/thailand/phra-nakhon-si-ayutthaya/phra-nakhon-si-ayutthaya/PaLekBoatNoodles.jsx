...
const PaLekBoatNoodles = () => (
  <RestaurantPage
    restaurantName="Pa Lek Boat Noodles"
    address="Bang-Ain Road, Tha Wasukri, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66898047418"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/pa-lek-boat-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This third-generation family-run street food joint has been offering tasty boat noodles for over five decades. Their experience shines through in the delicious broth, well-balanced in flavours. Try their pork or beef boat noodles for great value, or consider the recommended dry tom yum-style egg noodles with pork. The friendly owners' hospitality attracts a bustling lunch crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bang-Ain%20Road%2C%20Tha%20Wasukri%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Pa Lek Boat Noodles"
  />
);

export default PaLekBoatNoodles;
