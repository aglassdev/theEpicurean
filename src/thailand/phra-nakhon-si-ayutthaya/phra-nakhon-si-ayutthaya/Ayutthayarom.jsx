...
const Ayutthayarom = () => (
  <RestaurantPage
    restaurantName="Ayutthayarom"
    address="1/1 Mu 7, Ban Pom, Phra Nakhon Si Ayutthaya, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66929354264"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/ayutthayarom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a pleasant, cool, and shady location, the riverside offers seating in small Thai pavilions and boasts views of a golden pagoda. The space is decorated in traditional Thai style, in keeping with the cuisine, which features intense local flavours. Try the sour soup with fresh chilli and squid, and the aromatic, flavoursome fried river fish in chu chi curry. Round off your meal with classic Thai desserts made with fresh coconut milk...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%2F1%20Mu%207%2C%20Ban%20Pom%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Ayutthayarom"
  />
);

export default Ayutthayarom;
