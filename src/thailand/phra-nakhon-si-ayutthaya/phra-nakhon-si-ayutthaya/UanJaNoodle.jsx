...
const UanJaNoodle = () => (
  <RestaurantPage
    restaurantName="Uan Ja Noodle"
    address="45 U Thong Road, Ho Rattanachai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6635252166"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/uan-ja-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A popular lunch spot for over half a century, they sell a prolific 100kg of meatballs a day. The buoyant balls playfully float in the noodle soup and the condiments are homemade, including a spicy, sour chili vinegar sauce. Fresh-cooked or slow-cooked beef options are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20U%20Thong%20Road%2C%20Ho%20Rattanachai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Uan Ja Noodle"
  />
);

export default UanJaNoodle;
