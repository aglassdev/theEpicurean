...
const PratunamBaanKoNoodles = () => (
  <RestaurantPage
    restaurantName="Pratunam Baan Ko Noodles"
    address="22 Mu 5, Ban Ko, Bang Sai, Phra Nakhon Si Ayutthaya, 13190, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66810637814"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/pratunam-baan-ko-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set beside a peaceful canal, the crowds flock here for their speciality: beef noodles. The noodles come with offal, beef balls, spare ribs and tender beef slices. The soup is also superb, with a meaty aroma. It’s so popular, the chef prepares 25-30 kg of fresh offal every day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20Mu%205%2C%20Ban%20Ko%2C%20Bang%20Sai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013190%2C%20Thailand"
    pageTitle="Pratunam Baan Ko Noodles"
  />
);

export default PratunamBaanKoNoodles;
