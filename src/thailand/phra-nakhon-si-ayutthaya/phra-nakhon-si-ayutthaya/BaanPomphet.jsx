...
const BaanPomphet = () => (
  <RestaurantPage
    restaurantName="Baan Pomphet"
    address="13/5 U Thong Road, Ho Rattanachai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66813414595"
    website="https://www.baanpomphet.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Thai restaurant next to Pom Phet (Diamond Fortress) is in the distinctive-looking boutique hotel of the same name. Inside, the stylish dining room is fitted with large windows that frame a view of the restaurant’s deck and the Chao Phraya. Sourcing ingredients from the river and local farms, the chef creates flavourful dishes like standouts grilled river prawns and boiled freshwater snails in red curry soup. Book ahead for a riverside table at dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%2F5%20U%20Thong%20Road%2C%20Ho%20Rattanachai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Baan Pomphet"
  />
);

export default BaanPomphet;
