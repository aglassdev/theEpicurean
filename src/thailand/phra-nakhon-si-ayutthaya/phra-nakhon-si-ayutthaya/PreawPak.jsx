...
const PreawPak = () => (
  <RestaurantPage
    restaurantName="Preaw Pak"
    address="6/6 Mu 4, Ammarit, Phak Hai, Phra Nakhon Si Ayutthaya, 13120, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66863910136"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/preaw-pak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Preaw Pak specialises in freshwater fish, with a menu focused on fresh catches and local seasonal produce. From the riverside location you can see fishermen at work. The chef's skill is evident in his perfectly cooked dishes, which showcase traditional local flavours. Highlights include deep-fried river prawns with stir-fried garlic and chilli, and fresh snakehead fish in clear tom yum soup made with dry and fresh chilli. The level of spice can be adjusted to taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%2F6%20Mu%204%2C%20Ammarit%2C%20Phak%20Hai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013120%2C%20Thailand"
    pageTitle="Preaw Pak"
  />
);

export default PreawPak;
