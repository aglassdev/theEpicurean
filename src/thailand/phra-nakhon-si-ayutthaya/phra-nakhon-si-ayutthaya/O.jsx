...
const O = () => (
  <RestaurantPage
    restaurantName="O"
    address="252/21 Soi Wilai Sena, Prasoet Som Road, Sena, Phra Nakhon Si Ayutthaya, 13110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66819467737"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/o-pochana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in Sena district's old market, this charming wooden house backs onto the River Noi. The relaxed atmosphere and delicious food make it a local favourite, with popular dishes like stir-fried river prawns with salt and pepper, and deep-fried fish with fish sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=252%2F21%20Soi%20Wilai%20Sena%2C%20Prasoet%20Som%20Road%2C%20Sena%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013110%2C%20Thailand"
    pageTitle="O"
  />
);
