...
const RuanThaiKungPao = () => (
  <RestaurantPage
    restaurantName="Ruan Thai Kung Pao"
    address="1/2 Mu 4, Soi Thetsaban 10, Ratchakhram, Bang Sai, Phra Nakhon Si Ayutthaya, 13290, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66898870871"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/ruanthai-kungpao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This riverside restaurant is a great place to stop for lunch after paying respects at Wat Choeng Len. Diners gather here for some of the finest fresh produce from the river, including grilled prawns and deep-fried sheatfish. The aromatic green curry with clown featherback fish balls is another highlight. Advance ordering of the huge river prawns – expertly cooked over charcoal – is highly recommended, as they are both popular and in limited supply...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%2F2%20Mu%204%2C%20Soi%20Thetsaban%2010%2C%20Ratchakhram%2C%20Bang%20Sai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013290%2C%20Thailand"
    pageTitle="Ruan Thai Kung Pao"
  />
);

export default RuanThaiKungPao;
