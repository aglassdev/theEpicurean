...
const KinLookdeaw = () => (
  <RestaurantPage
    restaurantName="Kin Lookdeaw"
    address="35 Mu 9, Tha Chao Sanuk, Tha Ruea, Phra Nakhon Si Ayutthaya, 13130, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6635760480"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/kin-lookdeaw"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of the restaurant encourages guests to ‘focus on eating’ at this quaint house with an open-air pavilion overlooking a serene pond. The chefs, veterans in the kitchen, prepare simple Thai dishes and make their own chilli paste from scratch. The regular pounding of the pestle in the mortar reverberates through nature’s own soundtrack. Try the stir-fried crispy fish with aromatic ginger and salted eggs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Mu%209%2C%20Tha%20Chao%20Sanuk%2C%20Tha%20Ruea%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013130%2C%20Thailand"
    pageTitle="Kin Lookdeaw"
  />
);

export default KinLookdeaw;
