...
const PranomShreddedChickenNoodlesThaWasukri = () => (
  <RestaurantPage
    restaurantName="Pranom Shredded Chicken Noodles (Tha Wasukri)"
    address="47/9 Mu 4, Tha Wasukri, Phra Nakhon Si Ayuthaya, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66945428535"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/pranom-shredded-chicken-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On Ayutthaya-Ang Thong Road, near Wat Phanom Yong, the shredded chicken noodle soup needs no extra seasoning. The tom yum broth is perfectly balanced; chicken is tender, while slow-cooked chicken feet are an option. Available for breakfast and lunch only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%2F9%20Mu%204%2C%20Tha%20Wasukri%2C%20Phra%20Nakhon%20Si%20Ayuthaya%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Pranom Shredded Chicken Noodles (Tha Wasukri)"
  />
);

export default PranomShreddedChickenNoodlesThaWasukri;
