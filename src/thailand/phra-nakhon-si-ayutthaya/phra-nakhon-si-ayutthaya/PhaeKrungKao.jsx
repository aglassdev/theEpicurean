...
const PhaeKrungKao = () => (
  <RestaurantPage
    restaurantName="Phae Krung Kao"
    address="4/1 U Thong Road, Ho Rattanachai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6635241555"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/phae-krung-kao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This well-known restaurant, whose name means ‘raft at the old city of Ayutthaya’, started selling food on the river in 1966. It has since moved into a traditional Thai house, where diners can enjoy flavoursome Central Thai cuisine; local ingredients are used in dishes like their signature green curry with fish balls. The huge river prawns are charcoal-grilled by the restaurant’s entrance, creating a wonderful smoky aroma for everyone who visits. Sit on the terrace for a river view...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%2F1%20U%20Thong%20Road%2C%20Ho%20Rattanachai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Phae Krung Kao"
  />
);

export default PhaeKrungKao;
