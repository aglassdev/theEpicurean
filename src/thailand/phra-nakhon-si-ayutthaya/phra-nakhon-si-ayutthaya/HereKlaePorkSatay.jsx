...
const HereKlaePorkSatay = () => (
  <RestaurantPage
    restaurantName="Here Klae Pork Satay"
    address="Pamaprao Road, Ho Rattanachai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66817809067"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/here-kae-pork-satay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the third-generation grill master, this humble shophouse boasts a history spanning over nine decades and remains one of Ayutthaya’s most cherished spots for charcoal-grilled pork satay. The skewered meat is meticulously marinated, offering an aromatic blend of nine spices. Don't miss the pork offal – it pairs perfectly with the accompanying peanut sauce. Please note: takeaways only, and cash is the accepted payment method...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pamaprao%20Road%2C%20Ho%20Rattanachai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Here Klae Pork Satay"
  />
);

export default HereKlaePorkSatay;
