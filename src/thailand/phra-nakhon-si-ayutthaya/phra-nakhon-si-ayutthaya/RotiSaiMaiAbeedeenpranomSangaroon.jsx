...
const RotiSaiMaiAbeedeenpranomSangaroon = () => (
  <RestaurantPage
    restaurantName="Roti Sai Mai Abeedeen-Pranom Sangaroon"
    address="32/1 Mu 4, U Thong Road, Pratu Chai, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66890059948"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/roti-sai-mai-abeedeen-pranom-sangaroon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Over 70 years have passed, but this renowned spot opposite Phra Nakhon Si Ayutthaya Hospital still serves the same perfect rotis with candy floss, made by the same family. Their specialty, the green pandan roti, is known for its delightful gooeyness. As popular as ever, be prepared to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%2F1%20Mu%204%2C%20U%20Thong%20Road%2C%20Pratu%20Chai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Roti Sai Mai Abeedeen-Pranom Sangaroon"
  />
);

export default RotiSaiMaiAbeedeenpranomSangaroon;
