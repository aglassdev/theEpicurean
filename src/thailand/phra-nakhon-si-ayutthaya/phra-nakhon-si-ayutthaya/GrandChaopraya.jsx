...
const GrandChaopraya = () => (
  <RestaurantPage
    restaurantName="Grand Chaopraya"
    address="42/1 Ban Run, Phra Nakhon Si Ayutthaya, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66819421666"
    website="https://www.grandchaopraya.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%2F1%20Ban%20Run%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Grand Chaopraya"
  />
);

export default GrandChaopraya;
