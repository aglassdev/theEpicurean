...
const NaiKhlongBoatNoodles = () => (
  <RestaurantPage
    restaurantName="Nai Khlong Boat Noodles"
    address="40 Soi Ayothaya 4/3, Phai Ling, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66846650864"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/nai-khlong-boat-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop beside a canal exudes charm, with its simple wooden shelves and tables. Highlights include the boat noodles in a well-balanced broth and the richly flavoured dry beef soup with tender slices and slow-cooked meat, lifted by roasted peanut aroma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20Soi%20Ayothaya%204%2F3%2C%20Phai%20Ling%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Nai Khlong Boat Noodles"
  />
);

export default NaiKhlongBoatNoodles;
