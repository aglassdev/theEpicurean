...
const KhanomMhoKaengMaeYaiPhaiLing = () => (
  <RestaurantPage
    restaurantName="Khanom Mho Kaeng Mae Yai (Phai Ling)"
    address="65 Mu 7, Phai Ling, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66803083711"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/khanom-mho-kaeng-mae-yai-phai-ling"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy shop bathed in natural light serves 50 to 70 types of authentic Thai desserts. They freshly squeeze coconut milk each morning for rich flavours and aromas. As well as the signature khanom mo kaeng (silky Thai custard), you can sample sweet sorghum, thua paep or piak pun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=65%20Mu%207%2C%20Phai%20Ling%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Khanom Mho Kaeng Mae Yai (Phai Ling)"
  />
);

export default KhanomMhoKaengMaeYaiPhaiLing;
