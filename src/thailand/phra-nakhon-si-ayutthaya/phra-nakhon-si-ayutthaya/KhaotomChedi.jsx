...
const KhaotomChedi = () => (
  <RestaurantPage
    restaurantName="Khaotom Chedi"
    address="254/14 Rochana Road, Phai Ling, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66819844089"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/khaotom-chedi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular late-night spot is known for its fresh ingredients and flavourful dishes. The chef-owner warmly welcomes guests and takes orders with a smile. The menu changes daily, depending on the ingredients available. Enjoy dining outdoors with a view of Sam Pluem Temple's chedi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=254%2F14%20Rochana%20Road%2C%20Phai%20Ling%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Khaotom Chedi"
  />
);

export default KhaotomChedi;
