...
const Ukhao = () => (
  <RestaurantPage
    restaurantName="U-Khao"
    address="99 Mu 2, Khanon Luang, Bang Pa-in, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66627939993"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/u-khao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="U-Khao, or ‘land of plenty’, has 2 dining areas smartly decorated in white and blue. The menu serves up the nostalgic flavours of the owner’s childhood, as it’s based on her mother’s Thai recipes. They use traditional cooking methods presented with a modern aesthetic. The old-school style egg stew with pork belly is a flavoursome, intense stew with juicy meat. The grilled shrimp relish with vegetables is also highly recommended for its spicy relish and smoky aroma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Mu%202%2C%20Khanon%20Luang%2C%20Bang%20Pa-in%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="U-Khao"
  />
);

export default Ukhao;
