...
const BaanTonSai = () => (
  <RestaurantPage
    restaurantName="Baan Ton Sai"
    address="189/49 Mu 8, Pratu Chai, Phra Nakhon Si Ayutthaya, Phra Nakhon Si Ayutthaya, 13000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6635323969"
    website="https://guide.michelin.com/en/phra-nakhon-si-syutthaya-region/phra-nakhon-si-ayutthaya/restaurant/baan-ton-sai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant's vibrant colours stand out from afar. In the backyard, a banyan tree provides pleasant shade. The menu features straightforward and unpretentious seafood, pork and chicken dishes. Expect large servings of seafood that make the mouth water at wallet-friendly prices. We recommend trying their rat na noodles. Closing times may vary, so it's best to arrive early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=189%2F49%20Mu%208%2C%20Pratu%20Chai%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%20Phra%20Nakhon%20Si%20Ayutthaya%2C%2013000%2C%20Thailand"
    pageTitle="Baan Ton Sai"
  />
);

export default BaanTonSai;
