...
const BaanChikPorkNoodles = () => (
  <RestaurantPage
    restaurantName="Baan Chik Pork Noodles"
    address="89/3-4 Naresoun Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6642245298"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/baan-chik-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery has thrived in a traditional shophouse for over 30 years. Choose between the original flavour and tasty tom yum with its fresh lime and roasted peanut aroma, served with or without soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=89%2F3-4%20Naresoun%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Baan Chik Pork Noodles"
  />
);

export default BaanChikPorkNoodles;
