...
const PadThaiBuaDang = () => (
  <RestaurantPage
    restaurantName="Pad Thai Bua Dang"
    address="7/27 Soi Assawin, Posri Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66966457895"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/pad-thai-bua-dang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modest roadside shop is known among locals for its pad thai with prawns, not overly sweet and full of wok aroma. They offer variations with seafood, meat, or other toppings. Indoor seating is air-conditioned, service is friendly, and an English menu is available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%2F27%20Soi%20Assawin%2C%20Posri%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Pad Thai Bua Dang"
  />
);

export default PadThaiBuaDang;
