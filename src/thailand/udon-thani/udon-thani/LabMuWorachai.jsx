...
const LabMuWorachai = () => (
  <RestaurantPage
    restaurantName="Lab Mu Worachai"
    address="26/3 Posri Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Isan"
    priceRange="฿฿"
    phoneNumber="+6642247955"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/lab-mu-worachai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pork reigns supreme at this traditional Isan eatery, which may be renowned for its namesake Lab Mu – minced pork, skin and liver – but the flavourful Somtum Lao is another standout. Lunchtime can get hectic, but service is swift. The sharing sets of four to six dishes are perfect for groups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%2F3%20Posri%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Lab Mu Worachai"
  />
);

export default LabMuWorachai;
