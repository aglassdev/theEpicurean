...
const PengDuckNoodles = () => (
  <RestaurantPage
    restaurantName="Peng Duck Noodles"
    address="439 Nong Tao Lek Road, Ban Lueam, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66643965989"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/peng-duck-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The strength of this shop is its locally sourced free-range meat. The tender braised duck noodles, including neck, wing and thigh, are highlights. Their slow-cooked pork is equally exceptional. Try the duck rice with a smooth blood jelly and five spices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=439%20Nong%20Tao%20Lek%20Road%2C%20Ban%20Lueam%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Peng Duck Noodles"
  />
);

export default PengDuckNoodles;
