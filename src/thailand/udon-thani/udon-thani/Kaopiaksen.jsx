...
const Kaopiaksen = () => (
  <RestaurantPage
    restaurantName="Kao.Piak.Sen"
    address="20/20 Sri Suk Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Vietnamese"
    priceRange="฿"
    phoneNumber="+66817392247"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/khao-piak-udon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Formerly a street food stall, the owners have upped the quality of the menu and the dining experience. Kao Piak’s stylish restaurant seamlessly blends timeless and contemporary styles, drawing inspiration from Vietnam’s architectural heritage. Their signature aromatic pork broth is simmered for 8 hours yielding exquisitely tender meat. Don't miss out on the grilled lemongrass-marinated pork kebabs and Vietnamese sausage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%2F20%20Sri%20Suk%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Kao.Piak.Sen"
  />
);

export default Kaopiaksen;
