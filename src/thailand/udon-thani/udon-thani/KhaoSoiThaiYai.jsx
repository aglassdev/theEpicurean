...
const KhaoSoiThaiYai = () => (
  <RestaurantPage
    restaurantName="Khao Soi Thai Yai"
    address="331/4 Mu 5, Promprakai Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Northern Thai"
    priceRange="฿"
    phoneNumber="+66811177733"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/khao-soi-thai-yai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The original owners moved to Isan more than 20 years ago and brought the flavours of Northern Thailand with them. The owner doesn't compromise on quality, ensuring the spices are well utilised to produce bold, balanced and authentic flavours. Khao Soi is the speciality here. For groups, order the Northern Thai set – the homemade sausage won't disappoint. Round off your meal with a refreshing dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=331%2F4%20Mu%205%2C%20Promprakai%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Khao Soi Thai Yai"
  />
);

export default KhaoSoiThaiYai;
