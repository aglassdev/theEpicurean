...
const SomTumJaeKaiAsavamitRoad = () => (
  <RestaurantPage
    restaurantName="Som Tum Jae Kai (Asavamit Road)"
    address="230/28 Asavamit Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+66873732128"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/som-tum-jae-kai-1st-branch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-operated lunch spot has been a popular haunt for half a century. The dishes get their distinctive flavour from their home-made fermented fish sauce. This tasty addition elevates favourites such as mixed som tum with pork crackling and fermented sausage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=230%2F28%20Asavamit%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Som Tum Jae Kai (Asavamit Road)"
  />
);

export default SomTumJaeKaiAsavamitRoad;
