...
const KruaKhunNid = () => (
  <RestaurantPage
    restaurantName="Krua Khun Nid"
    address="64 Soi Nonnivet 1, Udon Dussadi Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+6642222126"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/krua-khun-nid"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over four decades this restaurant has been a mainstay for locals. Focusing on freshwater fish and meat, it serves large sharing portions. Seasonal options and occasional fish specials accompany enduring classics, such as the flavourful deep-fried Pla Som, or snakehead fish in flavoursome tom yum soup. The friendly staff are happy to share their recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64%20Soi%20Nonnivet%201%2C%20Udon%20Dussadi%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Krua Khun Nid"
  />
);

export default KruaKhunNid;
