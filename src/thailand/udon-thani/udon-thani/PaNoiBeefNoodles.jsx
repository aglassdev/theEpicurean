...
const PaNoiBeefNoodles = () => (
  <RestaurantPage
    restaurantName="Pa Noi Beef Noodles"
    address="57/8 Sisuttha Road, Mak Khaeng, Mueang Udon Thani, Udon Thani, 41000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66895753193"
    website="https://guide.michelin.com/en/udon-thani-region/udon-thani/restaurant/pa-noi-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The aroma of beef noodle soup greets diners at this popular eatery. The distinctive tamarind chilli paste pairs perfectly with deep-fried chicken skin or mixed into the noodles. The boat noodles with rich flavours are also a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%2F8%20Sisuttha%20Road%2C%20Mak%20Khaeng%2C%20Mueang%20Udon%20Thani%2C%20Udon%20Thani%2C%2041000%2C%20Thailand"
    pageTitle="Pa Noi Beef Noodles"
  />
);

export default PaNoiBeefNoodles;
