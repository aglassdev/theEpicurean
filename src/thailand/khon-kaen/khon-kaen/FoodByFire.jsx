...
const FoodByFire = () => (
  <RestaurantPage
    restaurantName="Food by Fire"
    address="27F, Ad Lib Hotel, 999 Sri Chant Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Barbecue, Grills"
    priceRange="฿฿฿"
    phoneNumber="+6643100555"
    website="https://www.adlibhotels.co/khon-kaen/dining/#food-by-fire"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its striking tiger mural on a deep red wall and U-shaped counter around an open kitchen, this Isan grillhouse celebrates northeastern produce in bold, contemporary style. Fire and fermentation anchor a steak and grill menu that is packed with local flavours, thanks to close ties with farmers and home-grown herbs. We highly recommend the Khon Kaen chocolate-fed beef, served with a spicy red-wine sauce, house-made papaya kimchi and an eggplant dip...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27F%2C%20Ad%20Lib%20Hotel%2C%20999%20Sri%20Chant%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Food by Fire"
  />
);

export default FoodByFire;
