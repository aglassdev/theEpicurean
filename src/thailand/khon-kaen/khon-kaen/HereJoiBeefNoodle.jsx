...
const HereJoiBeefNoodle = () => (
  <RestaurantPage
    restaurantName="Here Joi Beef Noodle"
    address="127 Mu 20, Kasikon Thung Sang Road, Sila, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66832887406"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/here-joi-beef-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open for almost 4 decades, the shop is named after the owner's father, Joi, who created the menu. The beef noodle soup has juicy slices, tender beef balls and offal. The aromatic soup broth is slow-cooked daily with beef bones. The smoky beef satay skewers are chargrilled and juicy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=127%20Mu%2020%2C%20Kasikon%20Thung%20Sang%20Road%2C%20Sila%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Here Joi Beef Noodle"
  />
);

export default HereJoiBeefNoodle;
