...
const LengYentafo = () => (
  <RestaurantPage
    restaurantName="Leng Yentafo"
    address="Klang Mueang Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66865801259"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/leng-yentafo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When Mr. Leng left Bangkok’s Chinatown for Khon Kaen in 1984, he brought a secret recipe for Yentafo, or pink noodle soup, and set up shop. His signature dish, which features toothsome noodles, fresh fishballs, shrimp balls and fish wontons, and a tasty broth, continues to delight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Klang%20Mueang%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Leng Yentafo"
  />
);

export default LengYentafo;
