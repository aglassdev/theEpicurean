...
const KhunJaengGuayTiewPakMorKaoWang = () => (
  <RestaurantPage
    restaurantName="Khun Jaeng Guay Tiew Pak Mor Kao Wang"
    address="246/4 Lang Mueang Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66850001668"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/khun-jaeng-guay-tiew-pak-mor-kao-wang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop peddles perfect rice dumplings and tapioca balls – a skill passed on by the chef's mother, who plied her trade in Bangkok for 30 years. The tangy tom yum soup with egg is a must and the garlic chive dumplings are exceptional...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=246%2F4%20Lang%20Mueang%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Khun Jaeng Guay Tiew Pak Mor Kao Wang"
  />
);

export default KhunJaengGuayTiewPakMorKaoWang;
