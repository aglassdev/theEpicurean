...
const KaoLaoSiangJi = () => (
  <RestaurantPage
    restaurantName="Kao Lao Siang Ji"
    address="1/1 Sathityutitham Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66813931999"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/kao-lao-siang-jee-lueat-moo-jao-kao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Started 50 years ago in a hawker stall by the owner’s grandfather, this shop continues to serve delicious pork blood and offal soup following the founder’s recipe. Pork balls make a tasty addition; organs can be added or subtracted. Also recommended are the deep-fried shrimp wontons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%2F1%20Sathityutitham%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Kao Lao Siang Ji"
  />
);

export default KaoLaoSiangJi;
