...
const Song24Nor = () => (
  <RestaurantPage
    restaurantName="Song 24 Nor"
    address="76/4 Nikorn Samran Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+6643224402"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/song-24-nor"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu at this boiled rice spot boasts over 200 items, but the sour soup with deep-fried snakehead fish is a must. Like other dishes, it’s fresh, well-cooked and wallet friendly. Seating is available at two dining areas across the street from each other; closing time is midnight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=76%2F4%20Nikorn%20Samran%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Song 24 Nor"
  />
);

export default Song24Nor;
