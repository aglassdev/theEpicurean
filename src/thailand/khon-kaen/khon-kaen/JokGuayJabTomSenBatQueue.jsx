...
const JokGuayJabTomSenBatQueue = () => (
  <RestaurantPage
    restaurantName="Jok Guay Jab Tom Sen Bat Queue"
    address="123/20 Namueang Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66866465056"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/jok-guay-jab-tom-sen-bat-queue"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eatery has been serving rice porridge, Vietnamese noodles with pork rib soup, and glass noodles with chicken feet for 30 years. Try adding chả lụa ham and soft-boiled egg for extra indulgence. Eat in to avoid the takeaway queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=123%2F20%20Namueang%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Jok Guay Jab Tom Sen Bat Queue"
  />
);

export default JokGuayJabTomSenBatQueue;
