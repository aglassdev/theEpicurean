...
const Prasit = () => (
  <RestaurantPage
    restaurantName="Prasit"
    address="44/4 Ammart Road, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+6643239740"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/prasit-pochana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The inviting smell of charcoal-grilled sausages wafts from the kitchen at the front of this shophouse restaurant. This family-run business has been serving traditional Isan pork and beef dishes since 1972, in line with their motto: ‘using the best cuts of beef to create flavoursome Isan dishes.’ Dishes like their fried sun-dried beef slices, pork sausages and sliced beef shank in spicy and sour soup live up to the ideal, are reasonably priced and served with a smile. Don't forget to call and reserve the grilled beef tongue in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%2F4%20Ammart%20Road%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Prasit"
  />
);

export default Prasit;
