...
const Vacca = () => (
  <RestaurantPage
    restaurantName="Vacca"
    address="99 Mu 20, Airport Road, Sila, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Italian"
    priceRange="฿฿"
    phoneNumber="+66910804444"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/vacca-italian-by-fabio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Italian chef-owner Fabio Colautti's restaurant near Khon Kaen Airport offers authentic Italian flavours with homemade pasta, wood-fired pizzas, and grilled meats. Opened in 2015, it boasts a classic Italian ambience with a cosy white interior, a large wine cellar, and an open kitchen. Highlights include the Vacca pizza and the grilled Wagyu rib-eye...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Mu%2020%2C%20Airport%20Road%2C%20Sila%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Vacca"
  />
);

export default Vacca;
