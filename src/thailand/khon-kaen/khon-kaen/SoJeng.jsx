...
const SoJeng = () => (
  <RestaurantPage
    restaurantName="So Jeng"
    address="599/3-4 Mu 2, Chaeng Sanit Road, Nai Mueang, Ban Phai, Khon Kaen, 40110, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+6643274031"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/so-jeng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With more than 40 years of history, this eatery is now run by the second generation. Locals still frequent it for delicious, budget-friendly meals and cheerful service. The highlights here are the lap dishes and the spicy clear soup with beef and beef offal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=599%2F3-4%20Mu%202%2C%20Chaeng%20Sanit%20Road%2C%20Nai%20Mueang%2C%20Ban%20Phai%2C%20Khon%20Kaen%2C%2040110%2C%20Thailand"
    pageTitle="So Jeng"
  />
);

export default SoJeng;
