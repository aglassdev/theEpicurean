...
const GuangTangNoodles = () => (
  <RestaurantPage
    restaurantName="Guang Tang Noodles"
    address="18/15 Pimpasut Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66863758860"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/guang-tang-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The history of this egg noodle soup spot stretches back more than 70 years to the owner’s grandfather. Today, it still satisfies — especially the noodle soup with wontons and barbecue pork (the noodles and wontons are homemade) and the deep-fried noodles with gravy and pork or beef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%2F15%20Pimpasut%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Guang Tang Noodles"
  />
);

export default GuangTangNoodles;
