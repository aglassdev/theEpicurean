...
const BaanHeng = () => (
  <RestaurantPage
    restaurantName="Baan Heng"
    address="54/2 Klang Mueang Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+66926262236"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/baan-heng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Baan Heng was born out of a souvenir and grocery shop the owners’ grandparents started in 1957 called Heng Nguan Hiang. It sold products like homemade Chinese sausage, pork floss and pork jerky. Now, the restaurant serves Thai-Chinese breakfast fare, like their signature Baan Heng sandwich and baked rice with sweet pork sausage in a remodelled wood-themed design that exudes old-school vibes. Add a classic hot Thai black coffee or milk tea for the full effect...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%2F2%20Klang%20Mueang%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Baan Heng"
  />
);

export default BaanHeng;
