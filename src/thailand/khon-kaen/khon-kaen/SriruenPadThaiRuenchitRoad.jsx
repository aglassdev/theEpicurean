...
const SriruenPadThaiRuenchitRoad = () => (
  <RestaurantPage
    restaurantName="Sriruen Pad Thai (Ruenchit Road)"
    address="48 Ruenchit Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66813693297"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/sriruen-pad-thai-reunrom-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Sriruen handcrafts exceptional Pad Thai, just as she has done for over 30 years. Originally from Phitsanulok, she serves noodles notable for their bold flavour, imparted by duck eggs. Savour this tasty dish with either thin rice or glass noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20Ruenchit%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Sriruen Pad Thai (Ruenchit Road)"
  />
);

export default SriruenPadThaiRuenchitRoad;
