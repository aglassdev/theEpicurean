...
const KhonKaenGrilledPorkNeck = () => (
  <RestaurantPage
    restaurantName="Khon Kaen Grilled Pork Neck"
    address="77/4 Klang Mueang Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66943649955"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/khon-kaen-grilled-pork-neck"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This grilled pork spot is among the most popular street places in Khon Kaen, and its grilled pork neck with rice is the reason why. The tender, sweet and salty marinated meat perfectly matches the accompanying spicy tamarind sauce. Also recommended are the spicy salad and soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%2F4%20Klang%20Mueang%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Khon Kaen Grilled Pork Neck"
  />
);

export default KhonKaenGrilledPorkNeck;
