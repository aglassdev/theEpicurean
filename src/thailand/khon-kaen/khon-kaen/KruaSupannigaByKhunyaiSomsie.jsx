...
const KruaSupannigaByKhunyaiSomsie = () => (
  <RestaurantPage
    restaurantName="Krua Supanniga by Khunyai Somsie"
    address="Supanniga Home, 130/9 Phothisan Road, Phra Lap, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66634241665"
    website="https://www.secret-retreats.com/tables/krua-supanniga-by-khun-yai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the Supanniga flower, this cute shop offers delightful dishes blending flavours from the eastern seaboard and Isan cuisine. Grandma's recipes inspire the food here. Don't miss the must-order chamuang pork—a juicy stewed pork infused with Chamuang leaf's slightly sour flavour. The restaurant provides indoor and outdoor seating, including shaded tables in the tree house...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Supanniga%20Home%2C%20130%2F9%20Phothisan%20Road%2C%20Phra%20Lap%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Krua Supanniga by Khunyai Somsie"
  />
);

export default KruaSupannigaByKhunyaiSomsie;
