...
const KaiYangRabeabKhaoSuanKwang = () => (
  <RestaurantPage
    restaurantName="Kai Yang Rabeab (Khao Suan Kwang)"
    address="99 Mittraphap Road, Kham Muang, Khao Suan Kwang, Khon Kaen, 40280, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+66816624884"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/kai-yang-rabeab-khao-suan-kwang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Throw a stick in Khon Kaen and you’ll likely hit a street food place serving grilled chicken and Isan dishes. You’d be lucky if you landed on this one. Its secret is tender, juicy chicken from three local breeds. A second downtown branch offers the same menu minus grilled offal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Mittraphap%20Road%2C%20Kham%20Muang%2C%20Khao%20Suan%20Kwang%2C%20Khon%20Kaen%2C%2040280%2C%20Thailand"
    pageTitle="Kai Yang Rabeab (Khao Suan Kwang)"
  />
);

export default KaiYangRabeabKhaoSuanKwang;
