...
const KapraoEJae = () => (
  <RestaurantPage
    restaurantName="Kaprao E Jae"
    address="2 Mu 7, Baan Sri Than, Nai Meuang, Meuang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66991716868"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/kaprao-e-jae"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kaprao E Jae serves an impressively consistent and flavoursome pad kaprao – a classic featuring holy basil stir fried with either shrimp, squid, beef, Isan sausage, pork offal or even duck. Each aromatic dish is served with a fierce mix of garlic and fresh and dried chillies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Mu%207%2C%20Baan%20Sri%20Than%2C%20Nai%20Meuang%2C%20Meuang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Kaprao E Jae"
  />
);

export default KapraoEJae;
