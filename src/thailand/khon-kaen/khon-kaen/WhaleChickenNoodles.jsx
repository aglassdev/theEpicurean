...
const WhaleChickenNoodles = () => (
  <RestaurantPage
    restaurantName="Whale Chicken Noodles"
    address="156 Sri Chant Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66841647424"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/whale-chicken-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The secret to the popularity of this eatery is its tender chicken and flavoursome broth – made with chicken bones and vegetables, it has a rich, meaty and naturally sweet flavour. Enjoy the breeze as you dine on the sidewalk, just like a local...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=156%20Sri%20Chant%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Whale Chicken Noodles"
  />
);

export default WhaleChickenNoodles;
