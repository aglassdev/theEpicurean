...
const PhoThaBo = () => (
  <RestaurantPage
    restaurantName="Pho Tha Bo"
    address="3/12 Si Nuan Road, Nai Mueang, Mueang Khon Kaen, Khon Kaen, 40000, Thailand"
    cuisine="Vietnamese, Thai and Vietnamese"
    priceRange="฿"
    phoneNumber="+66815442599"
    website="https://guide.michelin.com/en/khon-kaen-region/khon-kaen/restaurant/pho-tha-bo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run shop serves their own phở noodle soup recipe and other Vietnamese favourites, including fresh and fried spring rolls, doi huyet (blood sausage) and tiết canh (raw blood pudding served with cooked minced pork meat and offal). The pork sausage and beef balls are homemade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%2F12%20Si%20Nuan%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Khon%20Kaen%2C%20Khon%20Kaen%2C%2040000%2C%20Thailand"
    pageTitle="Pho Tha Bo"
  />
);

export default PhoThaBo;
