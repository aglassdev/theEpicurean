...
const KruaSuwimol = () => (
  <RestaurantPage
    restaurantName="Krua Suwimol"
    address="1229 9 Mittraphap Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Thai-Chinese"
    priceRange="฿"
    phoneNumber="+6644353576"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/krua-suwimol"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple, open-air restaurant serves Thai-Chinese fare. The food is distinctive for its simply cooking techniques yet quality dishes with extra-fresh ingredients and intense flavours. They offer a fantastic range, including several seafood and made-to-order options. Deep-fried chicken thigh with fish sauce and stir-fried spicy seafood are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1229%209%20Mittraphap%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Krua Suwimol"
  />
);

export default KruaSuwimol;
