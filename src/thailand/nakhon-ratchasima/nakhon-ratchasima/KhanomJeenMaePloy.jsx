...
const KhanomJeenMaePloy = () => (
  <RestaurantPage
    restaurantName="Khanom Jeen Mae Ploy"
    address="7/1 Mu 6, Siriratchathani Road, Muen Wai, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+6644271964"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/khanom-jeen-mae-ploy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The secret to Mae Ploy’s bouncy yet gooey noodles is the fermented rice flour from Ban Pra Dok. There’s a creamy, peppery spicy fish curry with coconut cream, a red chicken curry with offal, and a sweet, nutty peanut curry. The spicy fish curry has a lovely, aromatic fermented taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%2F1%20Mu%206%2C%20Siriratchathani%20Road%2C%20Muen%20Wai%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Khanom Jeen Mae Ploy"
  />
);

export default KhanomJeenMaePloy;
