...
const NinasCafeRestaurant = () => (
  <RestaurantPage
    restaurantName="Nina's Cafe & Restaurant"
    address="59/1 Mu 6, Thanaratch Road, Nong Nam Daeng, Pak Chong, Nakhon Ratchasima, 30450, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66818395445"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/nina-s-cafe-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nina’s homely restaurant, surrounded by greenery, has two dining areas. The inside is decorated with vintage furniture, chandeliers, standing lamps and a classic clock, while diners in the garden can enjoy nature’s shade. The dishes are well seasoned and many of the vegetables and herbs Nina uses, such as betel leaves, coriander and basil, are grown on-site. The fried pumpkin coated with salted egg sauce and the deep-fried sea bass with chilli and salt are both divine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%2F1%20Mu%206%2C%20Thanaratch%20Road%2C%20Nong%20Nam%20Daeng%2C%20Pak%20Chong%2C%20Nakhon%20Ratchasima%2C%2030450%2C%20Thailand"
    pageTitle="Nina's Cafe & Restaurant"
  />
);

export default NinasCafeRestaurant;
