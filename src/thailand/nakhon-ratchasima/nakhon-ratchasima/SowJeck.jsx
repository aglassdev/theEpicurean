...
const SowJeck = () => (
  <RestaurantPage
    restaurantName="Sow Jeck"
    address="183/8 Maharat Road, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66644953655"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/sow-jeck-pochana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef-owner Anuwat Thiemkreangkrai's 12-year-old stall stands out with its fresh, light MSG-free seafood dishes. His passion shines through in stir-fries that bring out the natural essence of the fresh catch, such as celery with seabass and the beautifully balanced seafood with Thai basil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=183%2F8%20Maharat%20Road%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Sow Jeck"
  />
);

export default SowJeck;
