...
const RadnaSuanmak = () => (
  <RestaurantPage
    restaurantName="Radna Suanmak"
    address="140 Chomsurangyat Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Noodles, Rice Dishes"
    priceRange="฿"
    phoneNumber="+66845096589"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/radna-suanmak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In over 30 years serving the community, this humble noodle spot has won local awards and built up a dedicated following. Expect a wait for their lovingly prepared dishes, which include deep-fried fish with thick noodles, and flavoursome crispy noodle stir-fry with holy basil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=140%20Chomsurangyat%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Radna Suanmak"
  />
);

export default RadnaSuanmak;
