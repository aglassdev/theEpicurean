...
const KhanomJeenYaiPao = () => (
  <RestaurantPage
    restaurantName="Khanom Jeen Yai Pao"
    address="Unit B20, Mae Kim Heng Market, Phoklang Road, Nai Meuang, Meuang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66890902914"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/khanom-jeen-yai-pao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This market stall serves khanom chin – soft, slightly chewy noodles paired with fragrant curries. Top choices include chicken red curry and Nam Ya Pradok, a coconut-based fish curry made with fingerroot and a touch of fermented fish, which is a local recipe from Ban Pradok and a true regional highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%20B20%2C%20Mae%20Kim%20Heng%20Market%2C%20Phoklang%20Road%2C%20Nai%20Meuang%2C%20Meuang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Khanom Jeen Yai Pao"
  />
);

export default KhanomJeenYaiPao;
