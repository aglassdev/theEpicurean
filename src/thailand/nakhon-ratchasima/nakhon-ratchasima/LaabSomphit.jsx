...
const LaabSomphit = () => (
  <RestaurantPage
    restaurantName="Laab Somphit"
    address="169 Chan Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+6644245026"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/lab-somphit"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 50 years, Granny Somphit has been crafting flavourful Isan cuisine daily, balancing local spices with Thai herbs. Fresh offal cuts and the signature Isan spicy calf beef salad, seasoned with smoky rice powder for crispness, stand out. The homemade beef sausage and fermented meats are also notable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=169%20Chan%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Laab Somphit"
  />
);

export default LaabSomphit;
