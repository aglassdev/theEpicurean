...
const YommaratOchaYommaratRoad = () => (
  <RestaurantPage
    restaurantName="Yommarat O-Cha (Yommarat Road)"
    address="9-11 Yommarat Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6644342151"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/yommarat-o-cha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The standout dish at this local favourite is the yentafo soup with fish balls, soy sauce and tofu. The flavour is pleasantly sweet and sour but this isn’t the spicy yentafo tomyum common in Bangkok. The soup is cooked fresh using a vibrant mix of condiments. Dry and wet options are available and all the great toppings are homemade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9-11%20Yommarat%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Yommarat O-Cha (Yommarat Road)"
  />
);

export default YommaratOchaYommaratRoad;
