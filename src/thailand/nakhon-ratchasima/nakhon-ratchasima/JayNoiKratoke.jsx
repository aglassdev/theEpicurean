...
const JayNoiKratoke = () => (
  <RestaurantPage
    restaurantName="Jay Noi Kratoke"
    address="115 Pibool La-lad Road, Nong Phai Lom, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66815919798"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/jay-noi-kratoke"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This three-storey house with simple décor is family run and in its second generation. Jay Noi's house special of hao-dong is a popular local treat using sliced pork and spicy Isan sauce, chilli and roasted rice. The four pad mee Korat is also recommended. Its sticky rice noodles are fresh and go really well with the sweet and sour sauce, fresh bean sprouts and chives. You can order the homemade curry puff for take away, with a variety of optional sides...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Pibool%20La-lad%20Road%2C%20Nong%20Phai%20Lom%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Jay Noi Kratoke"
  />
);

export default JayNoiKratoke;
