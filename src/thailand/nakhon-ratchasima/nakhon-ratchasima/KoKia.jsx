...
const KoKia = () => (
  <RestaurantPage
    restaurantName="Ko Kia"
    address="602 Mu 10, Khok Kruat, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30280, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66818171115"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/ko-kia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years, Ko Kia has been drawing the lunchtime crowds for its boat noodles. The bold, aromatic pork and beef broths are enriched with a touch of blood for depth, but the beef stands out. The clear soup is lighter, but full of flavour and the natural sweetness of daikon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=602%20Mu%2010%2C%20Khok%20Kruat%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030280%2C%20Thailand"
    pageTitle="Ko Kia"
  />
);

export default KoKia;
