...
const PaPleungMheeKratok = () => (
  <RestaurantPage
    restaurantName="Pa Pleung Mhee Kratok"
    address="1 Mu 8, Chok Chai, Nakhon Ratchasima, 30190, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66862469684"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/pa-pleung-mhee-kratok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Locals flock to Auntie Pleung's for Korat's quintessential noodle dish, Pad Mhee Kratok, served in its purest form – with a soft yet chewy noodle texture that requires no additional seasoning. Her tiny district shop also whips up award-winning spins on Pad Thai and papaya salad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Mu%208%2C%20Chok%20Chai%2C%20Nakhon%20Ratchasima%2C%2030190%2C%20Thailand"
    pageTitle="Pa Pleung Mhee Kratok"
  />
);

export default PaPleungMheeKratok;
