...
const KaiYangSaengThai = () => (
  <RestaurantPage
    restaurantName="Kai Yang Saeng Thai"
    address="126 Ratchadamnoen Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Grills"
    priceRange="฿"
    phoneNumber="+66858456604"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/kai-yang-saeng-thai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this rotisserie stall, they have spent over 50 years perfecting their signature dish of chicken (farmed or domestic) marinated in a secret peppery, herbal blend before it hits the spit. Juicy and tender, with a thin skin, the meat comes served with a sweet chilli dipping sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=126%20Ratchadamnoen%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Kai Yang Saeng Thai"
  />
);

export default KaiYangSaengThai;
