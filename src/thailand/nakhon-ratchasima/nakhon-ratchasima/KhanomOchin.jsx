...
const KhanomOchin = () => (
  <RestaurantPage
    restaurantName="Khanom Ochin"
    address="91 Jomsurangyat Road, Nai Mueang, Mueang Nakhon Ratchasima, Nakhon Ratchasima, 30000, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66626842484"
    website="https://guide.michelin.com/en/nakhon-ratchasima-region/nakhon-ratchasima/restaurant/khanom-ochin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ochin is named after the owner's favourite Japanese film. This second-generation stall only serves takeaway – a range of homemade deep-fried buns presented on a trolley at the front. Their signature is the crispy bun which contains glass noodles, tasty seasoning and vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=91%20Jomsurangyat%20Road%2C%20Nai%20Mueang%2C%20Mueang%20Nakhon%20Ratchasima%2C%20Nakhon%20Ratchasima%2C%2030000%2C%20Thailand"
    pageTitle="Khanom Ochin"
  />
);

export default KhanomOchin;
