...
const KlaiLib = () => (
  <RestaurantPage
    restaurantName="Klai Lib"
    address="126 Bangsaenlang Road, Saen Suk, Mueang Chon Buri, Chon Buri, 20130, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66877409111"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/klai-lib"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Attracting younger diners, this eatery has a reputation for fresh, affordable Thai seafood of uncompromising quality. The generous portions with sweet seasonings are good for sharing; the deep-fried mackerel with fish sauce is a must for its crispy skin and tender meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=126%20Bangsaenlang%20Road%2C%20Saen%20Suk%2C%20Mueang%20Chon%20Buri%2C%20Chon%20Buri%2C%2020130%2C%20Thailand"
    pageTitle="Klai Lib"
  />
);

export default KlaiLib;
