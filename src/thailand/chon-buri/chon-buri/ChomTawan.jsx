...
const ChomTawan = () => (
  <RestaurantPage
    restaurantName="Chom Tawan"
    address="79 Mu 3, Assadang Road, Tha Thewawong, Ko Sichang, Chon Buri, 20120, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66925351170"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/chom-tawan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite its rustic-looking exterior, Chom Tawan has a certain charm, and prices are reasonable, especially considering the freshness and quality of the seafood. The delicious stir-fried squid with minced pork filling and garlic is tempting, but also ask about the special of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79%20Mu%203%2C%20Assadang%20Road%2C%20Tha%20Thewawong%2C%20Ko%20Sichang%2C%20Chon%20Buri%2C%2020120%2C%20Thailand"
    pageTitle="Chom Tawan"
  />
);

export default ChomTawan;
