...
const KruaLaewTaeRrom = () => (
  <RestaurantPage
    restaurantName="Krua Laew Tae R-Rom"
    address="17/62 Mu 6, Paniad Chang Road, Pattaya, Na Kluea, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66909871101"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/krua-laew-tae-r-rom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a limited menu, the kitchen excels in seafood, Thai food and home-made curries with bold, rich flavours. The crab, shrimp, clams and fish are served ultra-fresh at reasonable prices, with rare catches often appearing on the menu. The restaurant doesn't open if the line-catch on that day is not successful. Booking a week in advance is necessary...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%2F62%20Mu%206%2C%20Paniad%20Chang%20Road%2C%20Pattaya%2C%20Na%20Kluea%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Krua Laew Tae R-Rom"
  />
);

export default KruaLaewTaeRrom;
