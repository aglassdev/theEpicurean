...
const MaePongSri = () => (
  <RestaurantPage
    restaurantName="Mae Pong Sri"
    address="42/99 Mu 9, Sukhumvit Road, Pattaya, Nong Prue, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66800598915"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/mae-pong-sri"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The go-to spot in Pattaya for pork offal soup with boiled sweet leaf bush, this eatery draws inspiration from Thai cuisine nationwide to offer a plethora of quick street food dishes. From the many noodle and rice options, the stir-fried glass noodles with seafood stand out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%2F99%20Mu%209%2C%20Sukhumvit%20Road%2C%20Pattaya%2C%20Nong%20Prue%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Mae Pong Sri"
  />
);

export default MaePongSri;
