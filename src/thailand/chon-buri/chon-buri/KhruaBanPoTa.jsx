...
const KhruaBanPoTa = () => (
  <RestaurantPage
    restaurantName="Khrua Ban Po Ta"
    address="23 Soi Pattaya Tai 8, Pattaya, Nong Prue, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Seafood"
    priceRange="฿฿"
    phoneNumber="+66930242684"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/khrua-ban-po-ta"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The breezy, spacious dining room surrounded by vines and plants makes for a relaxing and laidback coastal ambience. The seafood-based menu features shrimp, squid and crab options cooked several ways. The stir-fried squid with black ink sauce is a showstopper, but diners also enjoy shelling the stir-fried whole crab with curry powder. The sweet local seasoning enhances the food's natural umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Soi%20Pattaya%20Tai%208%2C%20Pattaya%2C%20Nong%20Prue%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Khrua Ban Po Ta"
  />
);

export default KhruaBanPoTa;
