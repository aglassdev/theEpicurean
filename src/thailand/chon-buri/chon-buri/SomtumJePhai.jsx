...
const SomtumJePhai = () => (
  <RestaurantPage
    restaurantName="Somtum Je Phai"
    address="321/26 Mu 12, Jomtien Beach Road, Pattaya, Nong Prue, Bang Lamung, Chon Buri, 20260, Thailand"
    cuisine="Isan"
    priceRange="฿"
    phoneNumber="+66818647860"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/somtum-je-phai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This authentic Isan eatery under a PVC tent grills chicken, meat, and pork over charcoal with traditional flair. The owner's passion is palpable as she communicates animatedly with her team. The meat is well-executed and retains its juiciness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=321%2F26%20Mu%2012%2C%20Jomtien%20Beach%20Road%2C%20Pattaya%2C%20Nong%20Prue%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020260%2C%20Thailand"
    pageTitle="Somtum Je Phai"
  />
);

export default SomtumJePhai;
