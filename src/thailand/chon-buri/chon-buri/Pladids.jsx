...
const Pladids = () => (
  <RestaurantPage
    restaurantName="Pladids"
    address="60/57 Mu 4, Soi Marp Pra Chan Lang 1, Pattaya, Pong, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66844556145"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/pladids"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop serves a Thai samrap (set menu) including jasmine rice cooked with Thai wild almond. The menu has a home-style, local quality, and interesting seasonal options. Each dish boasts complex yet balanced flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%2F57%20Mu%204%2C%20Soi%20Marp%20Pra%20Chan%20Lang%201%2C%20Pattaya%2C%20Pong%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Pladids"
  />
);

export default Pladids;
