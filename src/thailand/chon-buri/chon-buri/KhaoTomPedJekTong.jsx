...
const KhaoTomPedJekTong = () => (
  <RestaurantPage
    restaurantName="Khao Tom Ped Jek Tong"
    address="421/1 Vachira Prakarn Road, Makham Yong, Mueang Chon Buri, Chon Buri, 20000, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66834218331"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/khao-tom-ped-jek-tong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a taste of long-established local fare, this eight-decade-old gem that holds itself to exacting standards of cleanliness is a must. Tender braised duck meat with savoury gravy is the signature, best enjoyed with rice; fans of spicy food will relish the house-made dipping condiments...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=421%2F1%20Vachira%20Prakarn%20Road%2C%20Makham%20Yong%2C%20Mueang%20Chon%20Buri%2C%20Chon%20Buri%2C%2020000%2C%20Thailand"
    pageTitle="Khao Tom Ped Jek Tong"
  />
);

export default KhaoTomPedJekTong;
