...
const NeonBoatNoodles = () => (
  <RestaurantPage
    restaurantName="Neon Boat Noodles"
    address="395/7 Pattaya, Nong Prue, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66929353932"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/neon-boat-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional boat noodles are served here with various toppings in a bold and savoury soup. We also recommend the spicy boiled pork and pork condiments, which have an intensely flavoured sauce and the aroma of fried garlic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=395%2F7%20Pattaya%2C%20Nong%20Prue%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Neon Boat Noodles"
  />
);

export default NeonBoatNoodles;
