...
const LungShallKitchen = () => (
  <RestaurantPage
    restaurantName="Lung Shall Kitchen"
    address="50 Mu 7, Nongmaikean Road, Pattaya, Nong Prue, Bang Lamung, Chon Buri, 20150, Thailand"
    cuisine="Thai"
    priceRange="฿"
    phoneNumber="+66860891692"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/lung-shall-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simplicity and quality go hand in hand at this hidden gem with an intimate atmosphere. Experience food in its most authentic form thanks to skilfully prepared fresh ingredients. The bold yet nuanced stir-fried black squid ink delivers an intense, textured exploration of the sea's flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20Mu%207%2C%20Nongmaikean%20Road%2C%20Pattaya%2C%20Nong%20Prue%2C%20Bang%20Lamung%2C%20Chon%20Buri%2C%2020150%2C%20Thailand"
    pageTitle="Lung Shall Kitchen"
  />
);

export default LungShallKitchen;
