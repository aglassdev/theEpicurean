...
const LaCucina = () => (
  <RestaurantPage
    ...
    address="Andaz Pattaya Jomtien Beach 345 Mu 3, Na Chom Thian, Sattahip, Chon Buri, 20250, Thailand"
    cuisine="Italian"
    priceRange="฿฿"
    phoneNumber="+6638221234"
    website="https://www.hyatt.com/andaz/th-TH/utpaz-hyatt-andaz-pattaya-jomtien-beach/dining/la-cucina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Off the beaten tourist path, La Cucina offers an escape to a lush, tropical garden setting, where blue and white tiled floors, French windows and bossa nova tunes foster a relaxed atmosphere. This restaurant helmed by local chefs and an affable service team has an enticing Italian menu. Handmade pizzas are the stand-out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Andaz%20Pattaya%20Jomtien%20Beach%20345%20Mu%203%2C%20Na%20Chom%20Thian%2C%20Sattahip%2C%20Chon%20Buri%2C%2020250%2C%20Thailand"
    pageTitle="La Cucina"
  />
);

export default LaCucina;
