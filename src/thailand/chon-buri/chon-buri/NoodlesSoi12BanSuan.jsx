...
const NoodlesSoi12BanSuan = () => (
  <RestaurantPage
    restaurantName="Noodles Soi 12 (Ban Suan)"
    address="44/8-9 Mu 6, Soi Ban Suan-Setthakit 30, Ban Suan, Mueang Chon Buri, Chon Buri, 20000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+66659099919"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/noodles-soi-12-ban-suan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its wooden furniture and rustic charm, this is a delightful spot for an early breakfast or lunch. The real star here is the soup with aromatic dried squid and pork ribs imparting rich flavour. Each tasty spoonful is testament to the traditional recipe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%2F8-9%20Mu%206%2C%20Soi%20Ban%20Suan-Setthakit%2030%2C%20Ban%20Suan%2C%20Mueang%20Chon%20Buri%2C%20Chon%20Buri%2C%2020000%2C%20Thailand"
    pageTitle="Noodles Soi 12 (Ban Suan)"
  />
);

export default NoodlesSoi12BanSuan;
