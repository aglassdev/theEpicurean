...
const KhaoLamMaeKhaiToonKlao = () => (
  <RestaurantPage
    restaurantName="Khao Lam Mae Khai Toon Klao"
    address="357 Sukhumvit Road, Saen Suk, Mueang Chon Buri, Chon Buri, 20130, Thailand"
    cuisine="Street Food"
    priceRange="฿"
    phoneNumber="+66865128498"
    website="https://guide.michelin.com/en/chon-buri-region/chon-buri_2758557/restaurant/khao-lam-mae-khai-toon-klao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 60 years, this dessert stall has served classic sweetened sticky rice in the traditional way – cooked in bamboo with fresh coconut milk. Choose from original white or aromatic black sticky rice, garnished with taro, black beans, or ginkgo nuts; available in three portion sizes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=357%20Sukhumvit%20Road%2C%20Saen%20Suk%2C%20Mueang%20Chon%20Buri%2C%20Chon%20Buri%2C%2020130%2C%20Thailand"
    pageTitle="Khao Lam Mae Khai Toon Klao"
  />
);

export default KhaoLamMaeKhaiToonKlao;
