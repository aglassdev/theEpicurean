...
const SomchaiGoTaeBangLen = () => (
  <RestaurantPage
    restaurantName="Somchai Go Tae (Bang Len)"
    address="18/13 Mu 1, Bang Phasi, Bang Len, Nakhon Pathom, 73130, Thailand"
    cuisine="Thai-Chinese, Thai"
    priceRange="฿฿"
    phoneNumber="+6634995634"
    website="https://guide.michelin.com/en/nakhon-pathom-region/nakhon-pathom/restaurant/somchai-ped-palo-go-tae-bang-len"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Go Tae, the owner of this Thai-Chinese restaurant, got his start almost 80 years ago selling stewed duck noodle soup on a boat, before heading to dry land to open this place. Inside the three-storey building (topped with a giant rooftop duck statue), the simple dining room has a roasting and stewing station. The menu features old-school Thai-Chinese fare, including the recommended stewed duck and live river prawn cooked to your preference...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%2F13%20Mu%201%2C%20Bang%20Phasi%2C%20Bang%20Len%2C%20Nakhon%20Pathom%2C%2073130%2C%20Thailand"
    pageTitle="Somchai Go Tae (Bang Len)"
  />
);

export default SomchaiGoTaeBangLen;
