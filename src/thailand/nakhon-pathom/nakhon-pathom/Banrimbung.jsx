...
const Banrimbung = () => (
  <RestaurantPage
    restaurantName="Banrimbung"
    address="372/21 Mu 2, Nong Din Daeng, Mueang Nakhon Pathom, Nakhon Pathom, 73000, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+66818573643"
    website="https://guide.michelin.com/en/nakhon-pathom-region/nakhon-pathom/restaurant/banrimbung"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Serving family-style Thai cuisine on a large pond in Nakhon Pathom since 2001, the spacious restaurant offers waterside seating in five distinct seating areas with live music during dinner. Everything on the menu is fresh, with the fish and seafood kept alive until cooked. Two highlights are stir-fried prawns with shrimp oil and fried seabass with fish sauce and spicy green mango salad. The restaurant is family-friendly, with a kids’ zone in the garden for young diners to enjoy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=372%2F21%20Mu%202%2C%20Nong%20Din%20Daeng%2C%20Mueang%20Nakhon%20Pathom%2C%20Nakhon%20Pathom%2C%2073000%2C%20Thailand"
    pageTitle="Banrimbung"
  />
);

export default Banrimbung;
