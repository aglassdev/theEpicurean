...
const NaiHoChickenRice = () => (
  <RestaurantPage
    restaurantName="Nai Ho Chicken Rice"
    address="88/14 Mu 4, Sisa Thong, Nakhon Chai Si, Nakhon Pathom, 73120, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66817767329"
    website="https://guide.michelin.com/en/nakhon-pathom-region/nakhon-pathom/restaurant/nai-ho-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Singaporean chef, Ah Ho, cooks locally raised chickens using his family’s recipes. The chicken has a succulent meat, thin skin, light soya and sesame sauce, chicken broth and aromatic rice. The chicken offal sells out early every day. Don’t be surprised if the queue takes 1-2 hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=88%2F14%20Mu%204%2C%20Sisa%20Thong%2C%20Nakhon%20Chai%20Si%2C%20Nakhon%20Pathom%2C%2073120%2C%20Thailand"
    pageTitle="Nai Ho Chicken Rice"
  />
);

export default NaiHoChickenRice;
