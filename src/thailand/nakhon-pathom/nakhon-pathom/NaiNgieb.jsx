...
const NaiNgieb = () => (
  <RestaurantPage
    restaurantName="Nai Ngieb"
    address="125/21 Mu 6, Phutthamonthon Sai 4 Road, Salaya, Phutthamonthon, Nakhon Pathom, 73170, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6624410655"
    website="https://guide.michelin.com/en/nakhon-pathom-region/nakhon-pathom/restaurant/nai-ngieb-phutthamonthon-sai-4"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best eateries in the area for noodle soup lovers, where the bouncy, MSG-free fish balls are made the traditional way from mackerel, yellowtail amberjack and wolf herring. The tom yum soup stands out; and the fish noodles are perfect for low-carb dieters as they go well with any soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%2F21%20Mu%206%2C%20Phutthamonthon%20Sai%204%20Road%2C%20Salaya%2C%20Phutthamonthon%2C%20Nakhon%20Pathom%2C%2073170%2C%20Thailand"
    pageTitle="Nai Ngieb"
  />
);

export default NaiNgieb;
