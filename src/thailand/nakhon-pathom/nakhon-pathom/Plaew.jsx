...
const Plaew = () => (
  <RestaurantPage
    restaurantName="Plaew"
    address="Soi 5, Mu 1, Nakhon Pathom, Mueang Nakhon Pathom, Nakhon Pathom, 73000, Thailand"
    cuisine="Noodles"
    priceRange="฿"
    phoneNumber="+6634267325"
    website="https://guide.michelin.com/en/nakhon-pathom-region/nakhon-pathom/restaurant/plaew-nakhon-pathom"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This no-frills outlet is popular with locals for its tom yum noodles and homemade pork balls. They use premium ingredients and jumbo-size seafood. Also check out the homemade fish cakes, with a curry-flavoured spice, served with deep-fried crispy basil and a sweet and sour sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Soi%205%2C%20Mu%201%2C%20Nakhon%20Pathom%2C%20Mueang%20Nakhon%20Pathom%2C%20Nakhon%20Pathom%2C%2073000%2C%20Thailand"
    pageTitle="Plaew"
  />
);

export default Plaew;
