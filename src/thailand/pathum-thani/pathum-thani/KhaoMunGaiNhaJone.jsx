...
const KhaoMunGaiNhaJone = () => (
  <RestaurantPage
    restaurantName="Khao Mun Gai Nha Jone"
    address="179/17 Mu 1, Mu Ban Rueansuk 1, Lam Phak Kut, Thanyaburi, Pathum Thani, 12110, Thailand"
    cuisine="Small eats"
    priceRange="฿"
    phoneNumber="+66955029057"
    website="https://guide.michelin.com/en/pathum-thani-region/pathum-thani/restaurant/khao-mun-gai-nha-jone"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's a real buzz about this perpetually busy shop that is worth the drive from Bangkok. The delicious chicken is tender and juicy, served simply with sauces that add a real kick. Opening times are limited as they often sell out within a few hours – a testament to the quality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=179%2F17%20Mu%201%2C%20Mu%20Ban%20Rueansuk%201%2C%20Lam%20Phak%20Kut%2C%20Thanyaburi%2C%20Pathum%20Thani%2C%2012110%2C%20Thailand"
    pageTitle="Khao Mun Gai Nha Jone"
  />
);

export default KhaoMunGaiNhaJone;
