...
const MorakotKitchen = () => (
  <RestaurantPage
    restaurantName="Morakot Kitchen"
    address="28 Mu 4, Rangsit - Nakhon Nayok Road, Rangsit, Thanyaburi, Pathum Thani, 12110, Thailand"
    cuisine="Thai"
    priceRange="฿฿"
    phoneNumber="+6629047955"
    website="https://guide.michelin.com/en/pathum-thani-region/pathum-thani/restaurant/morakot-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 120 years, this no-frills kitchen in a wooden house on a main road has been dishing up intensely flavourful, comforting Thai fare. Don't miss the fish cake, made from authentic spotted featherback fish and heavenly spiced, served with the sweet house-special dipping sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20Mu%204%2C%20Rangsit%20-%20Nakhon%20Nayok%20Road%2C%20Rangsit%2C%20Thanyaburi%2C%20Pathum%20Thani%2C%2012110%2C%20Thailand"
    pageTitle="Morakot Kitchen"
  />
);

export default MorakotKitchen;
