...
const OterijaDebeluh = () => (
  <RestaurantPage
    restaurantName="Ošterija Debeluh"
    address="Trg izgnancev 7, Brezice, 8250, Slovenia"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+38674961070"
    website="https://www.debeluh.si/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in inland Slovenia, just a few kilometres from the border with Croatia, this is one of the most interesting restaurants in the region. Here, highly experienced owner-chef Jure Tomič has created an excellent network of suppliers from all over Slovenia. His meat and fish dishes are prepared with a modern, precise and technical touch that is unfussy and focuses on bringing out the full flavour of his ingredients. Traditional recipes and ingredients are reinterpreted with a personal twist: examples are the plum extract served with duck and the sweet “butter, honey and milk” dish that takes the ingredients of a typical local dessert and creates something new and original. The chef’s specialities include his Cake Debeluh, a beef tartare with meat macerated in a cold nutmeg broth, goose ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Trg%20izgnancev%207%2C%20Brezice%2C%208250%2C%20Slovenia"
    pageTitle="Ošterija Debeluh"
  />
);

export default OterijaDebeluh;
