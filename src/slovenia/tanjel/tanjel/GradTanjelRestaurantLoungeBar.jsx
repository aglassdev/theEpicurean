...
const GradTanjelRestaurantLoungeBar = () => (
  <RestaurantPage
    restaurantName="Grad Štanjel Restaurant & Lounge Bar"
    address="Štanjel 1a, Štanjel, 6222, Slovenia"
    cuisine="Regional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+38651437374"
    website="https://gradstanjel.si/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you don’t have the opportunity to stay in Štanjel (something that we highly recommend so that you can immerse yourself in the atmosphere of this charming medieval village), we suggest arriving at this restaurant at least an hour before your meal in order to enjoy a stroll through the narrow streets to the Fabiani Gardens, which boast fine views of the surrounding mountains. You might like to start your meal with a local aperitif – a glass of Teran wine produced using traditional methods by the Jazbec winery would be the perfect choice. Whether you have lunch or dinner here, the cuisine is regional in flavour, featuring many typical ingredients from the Karst area. If it’s on the menu, don’t miss the restaurant’s own cured ham which is truly exceptional. The wine list is concise yet care..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C5%A0tanjel%201a%2C%20%C5%A0tanjel%2C%206222%2C%20Slovenia"
    pageTitle="Grad Štanjel Restaurant & Lounge Bar"
  />
);

export default GradTanjelRestaurantLoungeBar;
