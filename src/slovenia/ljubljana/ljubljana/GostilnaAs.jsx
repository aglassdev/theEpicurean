...
const GostilnaAs = () => (
  <RestaurantPage
    restaurantName="Gostilna AS"
    address="Čopova ulica 5a, Ljubljana, 1000, Slovenia"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+38614258822"
    website="http://www.gostilnaas.si/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a few steps from the iconic Triple Bridge over the Ljubljanica River, you can choose between a dining room with a classic vaulted ceiling or, on milder days, a charming outdoor space surrounded by greenery, offering views of the castle. The menu stays true to tradition, featuring a wide selection of Slovenian meats −  primarily grilled − along with fresh Adriatic fish and homemade pasta...."
    ...
    pageTitle="Gostilna AS"
  />
);

export default GostilnaAs;
