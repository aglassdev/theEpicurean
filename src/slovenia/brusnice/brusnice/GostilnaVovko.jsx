...
const GostilnaVovko = () => (
  <RestaurantPage
    restaurantName="Gostilna Vovko"
    address="Ratež 48, Brusnice, 8321, Slovenia"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+38673085603"
    website="https://gostilna-vovko.si/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Comprising a bar, wine bar, restaurant and hotel, the Gostilna Vovko is a family-run business with more than 50 years of history behind it, where the traditionally furnished dining room includes a charming wood-fired stove. The cuisine is just as you would expect – authentic and regional, including dishes such as delicious local trout tartare served with horseradish and herbs, and thick, meaty pork chops which are perfect accompanied by a glass of velvety and intensely flavoured 2019 Modra Frankinja wine. The wine list pays tribute to regional labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rate%C5%BE%2048%2C%20Brusnice%2C%208321%2C%20Slovenia"
    pageTitle="Gostilna Vovko"
  />
);

export default GostilnaVovko;
