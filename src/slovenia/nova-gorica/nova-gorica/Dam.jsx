...
const Dam = () => (
  <RestaurantPage
    restaurantName="Dam"
    address="Ulica Vinka Vodopivca 24, Nova Gorica, 5000, Slovenia"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+38653331147"
    website="https://www.damhotel.si"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ulica%20Vinka%20Vodopivca%2024%2C%20Nova%20Gorica%2C%205000%2C%20Slovenia"
    pageTitle="Dam"
  />
);
