...
const Milka = () => (
  <RestaurantPage
    ...
    address="Vršiška cesta 45, Kranjska Gora, 4280, Slovenia"
    cuisine="Creative, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+38659779590"
    website="https://www.hotelmilka.si/restaurant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated near the Austrian and Italian borders, Milka boasts a superb location overlooking a crystal-clear lake surrounded by mountains. The restaurant offers a fine gastronomic synthesis of its region, skilfully interpreted and prepared by chef David Žefran, who makes full use of local ingredients. The surprise menu flows naturally and features ingredients that follow the seasons. The chefs themselves bring their dishes to the dining room, providing detailed and enthusiastic descriptions of each course. Although dishes are prepared with a modern touch, the character of the region shines through, especially in the choice of ingredients. Dishes include delicious salmon from the Danube accompanied by black radish and elderflower, a glazed brioche with fermented butter, and venison served wit..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vr%C5%A1i%C5%A1ka%20cesta%2045%2C%20Kranjska%20Gora%2C%204280%2C%20Slovenia"
    pageTitle="Milka"
  />
);
