...
const Respaceoldmill = () => (
  <RestaurantPage
    restaurantName="Espace Old Mill"
    address="7 chemin Caleb-Tree, Stanbridge East, J0J 2H0, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+14502482888"
    website="https://www.espaceoldmill.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the Brome-Missisquoi wine route, a red-brick building dating from 1849 is home to the project of Jean-Martin Fortier, a celebrated and passionate market gardener. Adjacent to a vast garden planted with over 40 varieties of vegetables and to a carbon-neutral greenhouse, the restaurant is helmed by Chef Éric Gendron, formerly of acclaimed Montreal restaurants. The restaurant presents a single set menu which celebrates local ingredients: melt-in-your-mouth beets with yogurt, jalapeño pepper and marigold flowers; barbecue-braised cabbage, beurre blanc, salad, and brassica leaves. Both modern and deeply rooted in the terroir, the cuisine celebrates local produce, prioritizing freshness and sustainability in every dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20chemin%20Caleb-Tree%2C%20Stanbridge%20East%2C%20J0J%202H0%2C%20Canada"
    pageTitle="Espace Old Mill"
  />
);

export default Respaceoldmill;
