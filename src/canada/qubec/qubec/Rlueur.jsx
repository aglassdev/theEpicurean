...
const Rlueur = () => (
  <RestaurantPage
    restaurantName="lueur"
    address="117 rue Dalhousie, Québec, G1K 4C5, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+14186924555"
    website="https://laurieraphael.com/lueur/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located next to the Vézina family's flagship restaurant, this bar-kitchen takes a totally different approach. The tone is set by the large counter, frescoes, and neon lights on the ceiling and walls, a small open kitchen and a loud and lively musical backdrop. The concise menu reinvents familiar dishes and ingredients by giving them a contemporary twist. Think raw tuna with plum and ginger, tender filet mignon with a delicious foie gras sauce, and a commendable floating island accompanied by parsnip chips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=117%20rue%20Dalhousie%2C%20Qu%C3%A9bec%2C%20G1K%204C5%2C%20Canada"
    pageTitle="lueur"
  />
);

export default Rlueur;
