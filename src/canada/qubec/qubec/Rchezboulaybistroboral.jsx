...
const Rchezboulaybistroboral = () => (
  <RestaurantPage
    restaurantName="Chez Boulay - Bistro Boréal"
    address="1110 rue Saint-Jean, Québec, G1R 1S4, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+14183808166"
    website="https://www.chezboulay.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment has an inviting, contemporary bistro decor, combining wood, brick, and hardwood floors. Two seasoned chefs work in tandem: the famous Jean-Luc Boulay (a judge on Canadian TV's Les Chefs!) and French chef Arnaud Marchand. The name of the restaurant gives a good indication of what to expect: French-influenced bistro cuisine made with spices and ingredients sourced from the boreal forest. Tuna from the Gaspé Peninsula is served as rillettes and accompanied by a delicious gribiche sauce; the 36-hour beef cheek —a signature dish that has been prepared in different guises over time— is paired with a Choron sauce. The longer dinner menu includes more complex dishes, such as char carpaccio with salted herbs, cattail hearts, and an oyster emulsion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1110%20rue%20Saint-Jean%2C%20Qu%C3%A9bec%2C%20G1R%201S4%2C%20Canada"
    pageTitle="Chez Boulay - Bistro Boréal"
  />
);

export default Rchezboulaybistroboral;
