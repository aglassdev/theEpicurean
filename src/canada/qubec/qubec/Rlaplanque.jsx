...
const Rlaplanque = () => (
  <RestaurantPage
    restaurantName="La Planque"
    address="1027 3e Avenue, Québec, G1L 2X3, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+14189148780"
    website="https://www.laplanquerestaurant.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1027%203e%20Avenue%2C%20Qu%C3%A9bec%2C%20G1L%202X3%2C%20Canada"
    pageTitle="La Planque"
  />
);

export default Rlaplanque;
