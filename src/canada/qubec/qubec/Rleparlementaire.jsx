...
const Rleparlementaire = () => (
  <RestaurantPage
    restaurantName="Le Parlementaire"
    address="1150 avenue Honoré-Mercier, Québec, G1A 1A3, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+14186436640"
    website="https://www.assnat.qc.ca/visiteurs/restaurants/restaurant-parlementaire"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of the National Assembly of Québec is on the first floor of this historical building, accessed via a superb solid wood staircase. Surrounded by some 20 columns, the large dining room done out in a traditional style is impressive. In the kitchen, Chef Sébastien Laframboise exclusively uses local ingredients from Québec (honey from the rooftop beehives, vegetables from the establishment's urban garden). The result is modern cuisine, sometimes with hints of Asia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1150%20avenue%20Honor%C3%A9-Mercier%2C%20Qu%C3%A9bec%2C%20G1A%201A3%2C%20Canada"
    pageTitle="Le Parlementaire"
  />
);

export default Rleparlementaire;
