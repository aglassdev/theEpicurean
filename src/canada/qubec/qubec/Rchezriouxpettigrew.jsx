...
const Rchezriouxpettigrew = () => (
  <RestaurantPage
    restaurantName="Chez Rioux & Pettigrew"
    address="160 rue Saint-Paul, Québec, G1K 3W1, Canada"
    cuisine="Traditional Cuisine"
    priceRange="$$$"
    phoneNumber="+14186944448"
    website="https://www.chezriouxetpettigrew.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within spitting distance of the Old Port, this restaurant still displays old photos of former owners, Mr. Rioux and Mr. Pettigrew, who occupied the premises in the late 19th century. The rustic decor (wooden floorboards, exposed brick, and stone walls, plus antique preserve tins on the shelves) exudes an appealing, vintage vibe. Chef-owner Dominic Jacques treats his guests to hearty fare that, although in a traditional vein, is not without its creative moments. In the evening, the restaurant serves more extensive menus in which Québec's terroir is the star of the show (think beef carpaccio seared with pepper and boreal spices, horseradish sour cream, and Massawippi oat damari reduction)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=160%20rue%20Saint-Paul%2C%20Qu%C3%A9bec%2C%20G1K%203W1%2C%20Canada"
    pageTitle="Chez Rioux & Pettigrew"
  />
);

export default Rchezriouxpettigrew;
