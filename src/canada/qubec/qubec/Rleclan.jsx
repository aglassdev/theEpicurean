...
const Rleclan = () => (
  <RestaurantPage
    restaurantName="Le Clan"
    address="44 rue des Jardins, Québec, G1R 3Z1, Canada"
    cuisine="Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+14186920333"
    website="https://www.restaurantleclan.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Catalan chef Stéphane Modat has set up shop in this historical house in Old Québec. Above its glass-fronted kitchen on the ground floor, it has dining rooms decorated with hunting and fishing trophies (in keeping with the chef's passions). The tasting menu celebrates ingredients from Québec: fish, game, and red meat make up a menu inspired by quintessential boreal traditions. His candied Arctic char on a bed of smoked salmon, seal tataki, seaweed salad, and fish roe suvalik pays homage to the fishermen of Salluit, the northernmost village in Québec. The meat dishes hold their own, with buffalo cappelletti and chanterelles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20rue%20des%20Jardins%2C%20Qu%C3%A9bec%2C%20G1R%203Z1%2C%20Canada"
    pageTitle="Le Clan"
  />
);

export default Rleclan;
