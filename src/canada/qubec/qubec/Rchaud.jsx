...
const Rchaud = () => (
  <RestaurantPage
    restaurantName="Échaudé"
    address="73 rue du Sault-au-Matelot, Québec, G1K 3Y9, Canada"
    cuisine="French"
    priceRange="$$"
    phoneNumber="+14186921299"
    website="https://echaude.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Lower Town, near the Old Port and Bassin Louise, this traditional French restaurant established in 1984 continues to uphold a commitment to quality and a spirit of conviviality. Taken over by its employees some 10 years ago, it remains true to its origins. In the elegant dining room with white tablecloths and mirrors, ponder which glass of wine to choose from the 20 or so listed. The evening à la carte menu highlights French classics: Wagyu beef tartare, halibut with Nantes butter, or magret de canard with Choron sauce. The simplier lunch menu offers a good value for money. The service is attentive and cordial...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20rue%20du%20Sault-au-Matelot%2C%20Qu%C3%A9bec%2C%20G1K%203Y9%2C%20Canada"
    pageTitle="Échaudé"
  />
);

export default Rchaud;
