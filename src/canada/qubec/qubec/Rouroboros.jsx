...
const Rouroboros = () => (
  <RestaurantPage
    restaurantName="Ouroboros"
    address="135 rue Saint-Joseph Est, Québec, G1K 3A8, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+14186142325"
    website="https://guide.michelin.com/en/quebec/quebec_2434166/restaurant/ouroboros"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name Ouroboros, like the mythological snake that symbolizes an eternal circle, reflects the way this restaurant works: from market to plate (and even composting), their approach forms a perfect cycle. The cozy bistro has comfortable seating at tables and a counter, and a concise menu that prioritizes fresh seasonal and regional ingredients, such as delicious pork gyozas served with a stout beer sauce, flavorsome chicken, Jerusalem artichokes and salsify, and an excellent apple strudel. There is no wine list here; ask owner Daniel for recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=135%20rue%20Saint-Joseph%20Est%2C%20Qu%C3%A9bec%2C%20G1K%203A8%2C%20Canada"
    pageTitle="Ouroboros"
  />
);

export default Rouroboros;
