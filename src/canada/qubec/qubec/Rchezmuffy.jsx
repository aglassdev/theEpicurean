...
const Rchezmuffy = () => (
  <RestaurantPage
    restaurantName="Chez Muffy"
    address="10 rue Saint-Antoine, Québec, G1K 4C9, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$$"
    phoneNumber="+14186921022"
    website="https://www.saint-antoine.com/chez-muffy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a prime location in Old Québec, a short distance from the Petit Champlain neighborhood, the St Lawrence River, and the Musée de la Civilisation, this hotel restaurant has a unique asset: a biodynamic farm located just a few kilometers away. Some 30 fruits, vegetables, aromatic herbs, and wild plants are harvested there, before ending up on their plates, in chef's creations. The experience is enhanced by an excellent wine list comprising more than 700 different labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20rue%20Saint-Antoine%2C%20Qu%C3%A9bec%2C%20G1K%204C9%2C%20Canada"
    pageTitle="Chez Muffy"
  />
);

export default Rchezmuffy;
