...
const Rkebecclubpriv = () => (
  <RestaurantPage
    restaurantName="Kebec Club Privé"
    address="767 rue Saint-Joseph Est, Québec, G1K 3C6, Canada"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+18193422030"
    website="https://www.kebecclubprive.ca/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Cassandre and Pierre-Olivier are a gifted young couple. Originally from France and Quebec, respectively, they met at restaurant Laurie Raphaël. They went on to transform this hairdressing salon with an industrial vibe into a unique table d'hôte. The concept: to welcome 10 guests at a fixed time, in a friendly atmosphere, around a majestic central table. Their cuisine, strictly Québécois, showcases local ingredients with delicate simplicity. The dishes are a testament to precise cooking, whether of the cod marinated in smoked oil, scallops in a herring bone jus or roasted quail breast. Herbs – fresh or dried – and smoky notes underpin every dish. This is an artisanal endeavour, in which the ingredients reign supreme without unnecessary frills. For a perfect evening, opt for the wine pairing..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=767%20rue%20Saint-Joseph%20Est%2C%20Qu%C3%A9bec%2C%20G1K%203C6%2C%20Canada"
    pageTitle="Kebec Club Privé"
  />
);

export default Rkebecclubpriv;
