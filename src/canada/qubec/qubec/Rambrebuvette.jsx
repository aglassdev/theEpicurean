...
const Rambrebuvette = () => (
  <RestaurantPage
    restaurantName="Ambre Buvette"
    address="2860 chemin des Quatre-Bourgeois, Québec, G1V 1Y3, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15819824067"
    website="https://www.ambre-buvette.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in Sainte-Foy, at a remove from the historical centre, this restaurant wins you over with its laid-back and inviting atmosphere. The setting is simple, but the welcome is warm. The restaurant showcases ingredients from Quebec's terroir. The indulgent, meticulously prepared cuisine can be enjoyed in the form of a tasting menu consisting of a dozen small plates to share: Gaspé Peninsula lobster ravioli and cauliflower with a fragrant bisque, house-made beer sausages and Migneron de Charlevoix cheese aligot, or Paris-Brest made according to time-honoured tradition. A 100% Quebec wine list rounds off this gourmet experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2860%20chemin%20des%20Quatre-Bourgeois%2C%20Qu%C3%A9bec%2C%20G1V%201Y3%2C%20Canada"
    pageTitle="Ambre Buvette"
  />
);

export default Rambrebuvette;
