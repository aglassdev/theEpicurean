...
const Rmelba = () => (
  <RestaurantPage
    restaurantName="Melba"
    address="398 rue Saint-Vallier Ouest, Québec, G1K 1K6, Canada"
    cuisine="Modern Cuisine, French"
    priceRange="$$"
    phoneNumber="+14186143042"
    website="https://www.restaurantmelba.ca"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tuck into an authentic slice of gourmet France here. The menu of meticulously prepared bistro cuisine features small plates such as shrimp barbajuans, liver mousse, ravioli with basil, or scallops with squash bouillabaisse. The desserts are pure indulgence: think Calvados baba with caramelized apples and vanilla ice cream. The upscale decor has a contemporary feel, and the service is attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=398%20rue%20Saint-Vallier%20Ouest%2C%20Qu%C3%A9bec%2C%20G1K%201K6%2C%20Canada"
    pageTitle="Melba"
  />
);

export default Rmelba;
