...
const Rhonizakaya = () => (
  <RestaurantPage
    restaurantName="Honō Izakaya"
    address="670 rue Saint-Joseph Est, Québec, G1K 3B9, Canada"
    cuisine="Japanese, Izakaya"
    priceRange="$$"
    phoneNumber="+14185242888"
    website="https://izakaya.honorestos.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Honō Izakaya – honō means flame in Japanese – the grill reigns supreme. In a minimalist interior softened by pale wood, diners enjoy Japanese cuisine at wallet-friendly prices. Here, they don't serve sushi, but tataki, sashimi and tempura… and a fine selection of yakitori, the house speciality: miso-marinated salmon, house-made chicken sausage and confit duck heart. Presented on small plates for sharing, the dishes stand out for the quality and perfect cooking of the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=670%20rue%20Saint-Joseph%20Est%2C%20Qu%C3%A9bec%2C%20G1K%203B9%2C%20Canada"
    pageTitle="Honō Izakaya"
  />
);

export default Rhonizakaya;
