...
const Ryokatoyokabai = () => (
  <RestaurantPage
    restaurantName="Yokato Yokabai"
    address="4185 rue Drolet, Montréal, H2W 2L5, Canada"
    cuisine="Ramen"
    priceRange="$"
    phoneNumber="+15142829991"
    website="https://yoka.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ramen served at this modest shop is among the most popular in the city, on account of the carefully simmered broths and meticulously crafted noodles. The establishment doesn't take reservations, so there is often a wait, but your patience will be amply rewarded. Diners indicate their choice of items on a paper menu, opting for the broth of their choice—creamy and intensely flavorful tonkotsu (pork bone) being a favorite—as well as toppings such as pork chashu, pickled egg, or bamboo shoots...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4185%20rue%20Drolet%2C%20Montr%C3%A9al%2C%20H2W%202L5%2C%20Canada"
    pageTitle="Yokato Yokabai"
  />
);

export default Ryokatoyokabai;
