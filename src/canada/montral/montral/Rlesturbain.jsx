...
const Rlesturbain = () => (
  <RestaurantPage
    restaurantName="Le St-Urbain"
    address="96 rue Fleury Ouest, Montréal, H3L 1T2, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15145047700"
    website="https://www.lesturbain.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nothing quite beats a good neighborhood restaurant, and this renowned place in the Ahuntsic district is a perfect example. The direct view of the chefs in the kitchen and the natural light streaming through the large bay window make for an atmosphere that is both lively and welcoming. One whole wall is devoted to a large menu written in chalk: the attractive selection of seasonal dishes is a real pleasure to read. The kitchen does not take the matter of flavor lightly, with each dish confidently celebrating just that—Arctic char with carrots or venison with celery root are perfect examples...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=96%20rue%20Fleury%20Ouest%2C%20Montr%C3%A9al%2C%20H3L%201T2%2C%20Canada"
    pageTitle="Le St-Urbain"
  />
);

export default Rlesturbain;
