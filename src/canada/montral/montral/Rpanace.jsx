...
const Rpanace = () => (
  <RestaurantPage
    restaurantName="Panacée"
    address="1701 rue Atateken, Montréal, H2L 3L4, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15143791701"
    website="https://www.restaurantpanacee.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Panacée, or panacea, is a universal remedy to cure all ills, something akin to what the cuisine of Chef Catherine Couvet Desrosiers is accomplishing. She works behind a circular counter, welcoming some 20 guests per service, convivial atmosphere guaranteed, thanks to the good-humored staff, too. The contemporary fare is prepared using seasonal ingredients only, and these are enhanced with beautiful tangy vinaigrettes and fermented vegetables. Produce is carefully selected, for example bluefin tuna from Prince Edward Island, served with a medley of carrots; barbecued pork loin, accompanied by its jus gras pan sauce; and Beurrasse, a creamy local goat's milk cheese, served with a poached pear and a salted almond sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1701%20rue%20Atateken%2C%20Montr%C3%A9al%2C%20H2L%203L4%2C%20Canada"
    pageTitle="Panacée"
  />
);

export default Rpanace;
