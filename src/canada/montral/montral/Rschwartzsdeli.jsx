...
const Rschwartzsdeli = () => (
  <RestaurantPage
    restaurantName="Schwartz's Deli"
    address="3895 boulevard Saint-Laurent, Montréal, H2W 1X9, Canada"
    cuisine="Regional Cuisine"
    priceRange="$"
    phoneNumber="+15148424813"
    website="https://schwartzsdeli.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is as quintessentially Montreal as Notre-Dame Basilica or Mont Royal. As soon as you cross the threshold, you are immersed in history: covering an entire wall, photos, illustrations, and articles chart the existence of this institution, which will celebrate its centenary in 2028. To avoid the queues, aim for off-peak times, sit at the counter, or share a table. Needless to say, the menu includes steak, entrecôte, chicken, and foie gras, but it is the famous smoked meat that is the main draw. Their recipe sees beef brisket marinated in the house's own spice blend, smoked, steamed, thinly sliced, and served on rye bread smeared with mustard. If you want to stick with tradition, wash it all down with a cherry soda...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3895%20boulevard%20Saint-Laurent%2C%20Montr%C3%A9al%2C%20H2W%201X9%2C%20Canada"
    pageTitle="Schwartz's Deli"
  />
);

export default Rschwartzsdeli;
