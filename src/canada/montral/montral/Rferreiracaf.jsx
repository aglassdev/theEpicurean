...
const Rferreiracaf = () => (
  <RestaurantPage
    restaurantName="Ferreira Café"
    address="1446 rue Peel, Montréal, H3A 1S8, Canada"
    cuisine="Portuguese, Seafood"
    priceRange="$$$"
    phoneNumber="+15148480988"
    website="https://ferreiracafe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant's warm, elegant decor blends Portuguese influences with a cosmopolitan New York City vibe. The large bar and counter decorated with azulejos contrasts harmoniously with the chic, casual woodwork. In the kitchen, Natalia Machado Villaverde elevates fish and seafood in her delicious dishes, including sardine fillets roasted with fleur de sel or creamy seafood rice with scallops, prawns, squid, mussels, and clams. The wine list is impressive with its 400 references, predominantly Portuguese, and a remarkable selection of ports and rare spirits from all over the world, including some very fine Burgundy wines. Attentive service, upbeat music, and excellent value for the money seal the deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1446%20rue%20Peel%2C%20Montr%C3%A9al%2C%20H3A%201S8%2C%20Canada"
    pageTitle="Ferreira Café"
  />
);

export default Rferreiracaf;
