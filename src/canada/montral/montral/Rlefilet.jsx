...
const Rlefilet = () => (
  <RestaurantPage
    restaurantName="Le Filet"
    address="219 avenue du Mont-Royal Ouest, Montréal, H2T 2T2, Canada"
    cuisine="Seafood"
    priceRange="$$$"
    phoneNumber="+15143606060"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=219%20avenue%20du%20Mont-Royal%20Ouest%2C%20Montr%C3%A9al%2C%20H2T%202T2%2C%20Canada"
    pageTitle="Le Filet"
  />
);

export default Rlefilet;
