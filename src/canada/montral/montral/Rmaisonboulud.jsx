...
const Rmaisonboulud = () => (
  <RestaurantPage
    ...
    address="Ritz-Carlton Montréal, 1228 rue Sherbrooke Ouest, Montréal, H3G 1H6, Canada"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+15148424224"
    website="https://www.maisonboulud.com/montreal/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this restaurant ensconced in the refined setting of The Ritz-Carlton Hotel, the Midas touch of Chef Daniel Boulud is unmistakable. The menu brings a touch of New York temerity to contemporary French dishes. From rib roast steak to pâté en croûte, chicken supreme or foie gras, there is something for everyone. As for the backdrop, gravitate towards the ambience that appeals to you: close to the kitchen to watch the chefs at work, by the fireplace, in the bright conservatory, or, on sunny days, on the garden terrace—allowing you to forget, if only for the duration of your meal, that you are in the heart of the city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ritz-Carlton%20Montr%C3%A9al%2C%201228%20rue%20Sherbrooke%20Ouest%2C%20Montr%C3%A9al%2C%20H3G%201H6%2C%20Canada"
    pageTitle="Maison Boulud"
  />
);

export default Rmaisonboulud;
