...
const Rrestaurantdelithq = () => (
  <RestaurantPage
    restaurantName="Restaurant de l'ITHQ"
    address="3535 rue Saint-Denis, Montréal, H2X 3P1, Canada"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="$$"
    phoneNumber="+15142825155"
    website="https://www.ithq.qc.ca/restaurants-et-bar/restaurant-de-lithq/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As part of the Institut de tourisme et d'hôtellerie du Québec, a hospitality industry school, the ITHQ restaurant is underpinned by a unique educational approach. Students and professionals work together, both front of house and in the kitchen, under the watchful eye of the instructors. In this bright and serene dining room overlooking Square Saint-Louis, the menu highlights local ingredients, including fish from the Gaspé Peninsula, bison from Lanaudière, and honey from the Laurentian Mountains. Based on the technical principles of French cuisine, the dishes evolve with the seasons: smoked char, semi-cooked and enhanced by a chorizo broth; braised beef tongue, bone marrow broth, root vegetables, and gribiche sauce. Dessert brings with it a surprise: crêpes Suzette flambéed tableside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3535%20rue%20Saint-Denis%2C%20Montr%C3%A9al%2C%20H2X%203P1%2C%20Canada"
    pageTitle="Restaurant de l'ITHQ"
  />
);

export default Rrestaurantdelithq;
