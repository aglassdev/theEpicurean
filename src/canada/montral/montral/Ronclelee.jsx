...
const Ronclelee = () => (
  <RestaurantPage
    restaurantName="Oncle Lee"
    address="222 avenue Laurier Ouest, Montréal, H2T 2N8, Canada"
    cuisine="Chinese, Modern Cuisine"
    priceRange="$$"
    phoneNumber="+15144193737"
    website="https://www.restaurantonclelee.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant and trendy little place is run by Chef Anderson Lee, who offers diners a window onto his well-honed take on contemporary Chinese cuisine, inflected with a typically Montreal touch. Great care goes into cooking staples such as sesame noodles and garlic fried rice; sweet and sour eggplant is finished with crunchy peanuts and bacon. Other creations show even more personality—think steamed oysters with fermented black bean sauce or beef tartare with doubanjiang. The quality of the ingredients is impeccable, and the flavors are always on point. The ingenious cocktails provide another outlet for the same creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=222%20avenue%20Laurier%20Ouest%2C%20Montr%C3%A9al%2C%20H2T%202N8%2C%20Canada"
    pageTitle="Oncle Lee"
  />
);

export default Ronclelee;
