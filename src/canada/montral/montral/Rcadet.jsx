...
const Rcadet = () => (
  <RestaurantPage
    ...
    address="1431 boulevard Saint-Laurent, Montréal, H2X 2S8, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+15149031631"
    website="https://www.restaurantcadet.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1431%20boulevard%20Saint-Laurent%2C%20Montr%C3%A9al%2C%20H2X%202S8%2C%20Canada"
    pageTitle="Cadet"
  />
);

export default Rcadet;
