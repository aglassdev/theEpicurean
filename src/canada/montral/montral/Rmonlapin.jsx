...
const Rmonlapin = () => (
  <RestaurantPage
    restaurantName="Mon Lapin"
    address="150 rue Saint-Zotique Est, Montréal, H2S 1K8, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15143794550"
    website="https://vinmonlapin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in Little Italy, this top-flight wine bar is an absolute cornerstone of the Montreal scene. At the helm, Vanya Filipovic and Marc-Olivier Frappier, ardent lovers of food and wine, run this establishment which exudes a singular energy. Reservations open 30 days in advance and are snapped up in the blink of an eye. The name pays tribute to Jura wine producer Jean-François Ganevat, famous for calling all his friends mon lapin (my rabbit). The concise menu lists around 15 dishes for sharing, all made with fine products: meats matured on the premises, ultra-fresh fish, house-made pasta, and delicious sorbets. The wine cellar is made up of bottles from small producers, with a lot of natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=150%20rue%20Saint-Zotique%20Est%2C%20Montr%C3%A9al%2C%20H2S%201K8%2C%20Canada"
    pageTitle="Mon Lapin"
  />
);

export default Rmonlapin;
