...
const Rfoxy = () => (
  <RestaurantPage
    restaurantName="Foxy"
    address="1638 rue Notre-Dame Ouest, Montréal, H3J 1M1, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15149257007"
    website="https://www.foxy.restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In what was once an industrial area that is now gentrified, this place brilliantly captures the art de vivre in today's Montreal: hand-picked eco-responsible ingredients, wood-fired cuisine designed for sharing, plus service from a motivated front-of-house staff who are both cool and professional. The bespoke decor combines simplicity and warmth with unpretentious elegance. Here, the focus is firmly on fire, the central element of this instinctive modern cuisine, in which local produce sets the tone. The dishes, often plant-based and with Mediterranean influences, lend themselves to sharing as in maitake mushrooms glazed with maple and black garlic, gently chargrilled Arctic char, and grass-fed Angus beef with shallots and aioli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1638%20rue%20Notre-Dame%20Ouest%2C%20Montr%C3%A9al%2C%20H3J%201M1%2C%20Canada"
    pageTitle="Foxy"
  />
);

export default Rfoxy;
