...
const Rlemousso = () => (
  <RestaurantPage
    restaurantName="Le Mousso"
    address="1025 rue Ontario Est, Montréal, H2L 1P8, Canada"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+14383847410"
    website="https://lemousso.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal at this extraordinary restaurant is a fine dining spectacular—centered on a single tasting menu of around 10 small plates, the experience lasts almost four hours. The dishes for the 30 or so guests are plated simultaneously, then brought out by the chefs themselves. As each course is served, a description of the dish is presented aloud to the whole room, to the enthusiastic cheers of the entire team. The dehydrated tuna and tomato rose in a tomato water broth with horseradish, cut with chamomile oil and decorated with marigold flowers was a highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1025%20rue%20Ontario%20Est%2C%20Montr%C3%A9al%2C%20H2L%201P8%2C%20Canada"
    pageTitle="Le Mousso"
  />
);

export default Rlemousso;
