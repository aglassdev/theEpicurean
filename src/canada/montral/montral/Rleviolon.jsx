...
const Rleviolon = () => (
  <RestaurantPage
    restaurantName="Le Violon"
    address="4720 rue Marquette, Montréal, H2J 3Y6, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+15142091181"
    website="https://le-violon.ca"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le Violon is a finely tuned instrument! A quartet of partners compose a delicious culinary melody that unfolds within an elegant decor, decorated with premium materials and bathed in natural light. The contemporary score borrows from both the English-speaking world and the French: bluefin tuna, tomato, and olive oil in the style of a gourmet pan con tomate; fish & chips revisited with monkfish in a gribiche sauce; beef cheek bordelaise and its Joël Robuchon-style potato purée; and, for dessert, carrot cake with cream cheese icing and butterscotch sauce. The concise menu comprises a dozen dishes, supplemented by a few specials inspired by the market, which your server will talk you through. Reservation mandatory; hip young clientele...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4720%20rue%20Marquette%2C%20Montr%C3%A9al%2C%20H2J%203Y6%2C%20Canada"
    pageTitle="Le Violon"
  />
);

export default Rleviolon;
