...
const 7Enoteca = () => (
  <RestaurantPage
    restaurantName="7 Enoteca"
    address="216 Lakeshore Rd. E., Oakville, L6J 7N9, Canada"
    cuisine="Italian, Pizza"
    priceRange="$$"
    phoneNumber="+19058424777"
    website="https://sevenenoteca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A neighborhood essential through and through, this slick pizzeria in downtown Oakville cooks as good as it looks. Handsome banquettes snake through a dining room where every table feels like its own corner. Much of the credit belongs to Chef Rafael Covarrubias, who also runs the ambitious restaurant Hexagon across the lawn. Here, find a cool warren where pasta and pizza feature top-quality ingredients prepared with precision. A verdant salad or a bright tuna crudo with capers and gnocco fritto is a lovely start before moving into the likes of trecce pasta with crab. Cooked in wood-burning ovens, pizzas arrive with blistered, puffy edges and crisp bottoms. Winning combinations include ‘nduja with heirloom tomatoes, basil and stracciatella...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=216%20Lakeshore%20Rd.%20E.%2C%20Oakville%2C%20L6J%207N9%2C%20Canada"
    pageTitle="7 Enoteca"
  />
);

export default 7Enoteca;
