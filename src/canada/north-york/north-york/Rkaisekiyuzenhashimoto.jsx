...
const Rkaisekiyuzenhashimoto = () => (
  <RestaurantPage
    restaurantName="Kaiseki Yu-zen Hashimoto"
    address="6 Sakura Way, North York, M3C 1Z5, Canada"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+14164447100"
    website="https://www.kaiseki.ca/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It may be connected to the Canadian Japanese Cultural Center but it’s not until you walk through the labyrinthine passages of this restaurant that you feel you’ve been transported to Japan. This is the very opposite of the see-and-be-seen culture: all guests have their own private room so it’s the perfect choice for that intimate dinner, family celebration or important business deal.Chef Masaki Hashimoto's traditional kaiseki eight-course menu showcases the seasons while celebrating Japanese ingredients. From beautiful sashimi - which could be line-caught sea bream – through to grilled cutlass fish and steamed jackfish, and from delicate soup to grilled Miyazaki wagyu: all the dishes are beautiful to behold, balanced, delicate and rewarding. The Shizouka musk melon will leave you wondering..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Sakura%20Way%2C%20North%20York%2C%20M3C%201Z5%2C%20Canada"
    pageTitle="Kaiseki Yu-zen Hashimoto"
  />
);

export default Rkaisekiyuzenhashimoto;
