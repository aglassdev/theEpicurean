...
const Rpark = () => (
  <RestaurantPage
    restaurantName="Park"
    address="378 avenue Victoria, Westmount, H3Z 2N4, Canada"
    cuisine="Fusion, Asian"
    priceRange="$$$$"
    phoneNumber="+15147507534"
    website="https://www.parkresto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Westmount, Chef-owner Antonio Park serves up vibrant and balanced Japanese/South American fusion cuisine. To the sound of 80s pop, diners tuck into dishes such as precisely cooked suzuki accompanied by fragrant chimichurri and maitake mushrooms, or a selection of tuna sushi with specialty condiments: bluefin tuna with daikon steeped in yuzu, marinated jalapeño albacore, longfin tuna with ginger flower... This is an extensive and mouthwatering menu, that is also available as an omakase experience in the evening, for a culinary voyage with stopovers in Japan and Argentina...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=378%20avenue%20Victoria%2C%20Westmount%2C%20H3Z%202N4%2C%20Canada"
    pageTitle="Park"
  />
);

export default Rpark;
