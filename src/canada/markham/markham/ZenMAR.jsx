...
const ZenMAR = () => (
  <RestaurantPage
    restaurantName="Zen"
    address="7634 Woodbine Ave., Markham, L3R 2N2, Canada"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+19056047211"
    website="https://zenjapaneserestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Value is something of a tricky term when it comes to sushi, which can cost almost as much as a ticket to Japan these days. But in an unassuming Markham strip center dominated by an auto repair shop, those looking to scratch the omakase itch without breaking the bank are in for a treat. The space is true to its name, a calming, tasteful blend of wood slats and attractive lighting with a chef’s counter as well as tables further back. Fish from Japan arrives multiple times a week; the rice is warm and finely vinegared; and chefs work with precision and diligence. They keep the toppings fairly traditional, limited mostly to a keen swipe of soy. Recent highlights include scallops and Murasaki uni from Hokkaido as well as some of the best nori in town...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7634%20Woodbine%20Ave.%2C%20Markham%2C%20L3R%202N2%2C%20Canada"
    pageTitle="Zen"
  />
);

export default ZenMAR;
