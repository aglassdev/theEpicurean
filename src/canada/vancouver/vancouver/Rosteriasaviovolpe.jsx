...
const Rosteriasaviovolpe = () => (
  <RestaurantPage
    restaurantName="Osteria Savio Volpe"
    address="615 Kingsway, Vancouver, V5T 3K5, Canada"
    cuisine="Italian, Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+16044280072"
    website="https://www.saviovolpe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Clean and contemporary, with white marble and modern light fixtures, Osteria Savio Volpe could easily fit right in on a street in Milan, Naples or Rome. Simple materials, including red-and-brown tiles and a muted palette, set a modern tone for cuisine that takes inspiration from the regions of Italy while balancing authenticity and expectations. Dig in to warm and tender garlic knots studded with black pepper and a thatch of grated pecorino. Sop up every last dot of the piquant marinara—it's worth the additional charge. Thinly sliced beef carpaccio is plated in traditional fashion, then topped with a flavorful leek-accented aioli, and creste di gallo is an ideal pasta for the richly flavored lamb ragu with zippy sage and pecorino...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=615%20Kingsway%2C%20Vancouver%2C%20V5T%203K5%2C%20Canada"
    pageTitle="Osteria Savio Volpe"
  />
);

export default Rosteriasaviovolpe;
