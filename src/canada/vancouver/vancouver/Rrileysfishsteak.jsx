...
const Rrileysfishsteak = () => (
  <RestaurantPage
    restaurantName="Riley's Fish & Steak"
    address="200 Burrard St., Vancouver, V6C 3L6, Canada"
    cuisine="Steakhouse, Seafood"
    priceRange="$$$$"
    phoneNumber="+16046298800"
    website="https://www.rileysrestaurant.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of downtown's waterfront, Riley's Fish & Steak lures guests with stunning views and a polished nautically informed interior that pours on the glamour. Don't let the high rollers and spendy tourists turn you off; the staff's warmth and the kitchen's precise techniques will charm you in no time. Dishes that may seem tried-and-true are far from ho-hum. Take the Louie salad, for instance, with Baby Gem lettuce bested with beautiful lump crab, crunchy onion rings, creamy avocado and Thousand Island dressing—it's refreshing and satisfying. Then, fish and chips is surprisingly light yet savory, thanks to the ultra-crisp batter. Charred broccolini with an herbaceous and citrus-forward gremolata is a virtuous side dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20Burrard%20St.%2C%20Vancouver%2C%20V6C%203L6%2C%20Canada"
    pageTitle="Riley's Fish & Steak"
  />
);

export default Rrileysfishsteak;
