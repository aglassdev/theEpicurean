...
const Rchefschoicechinesecuisine = () => (
  <RestaurantPage
    restaurantName="Chef's Choice Chinese Cuisine"
    address="955 W. Broadway, Vancouver, V5Z 1K3, Canada"
    cuisine="Cantonese, Chinese"
    priceRange="$$$"
    phoneNumber="+16045581198"
    website="https://chefschoice1198.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Copper and wood panels lend a handsome appeal to the dining room but make no mistake: Chef's Choice Chinese Cuisine deals in spectacular food. The kitchen offers dishes that are unique and classic, including many not often seen on other menus. Peruse the kitchen specialties to discover dishes like Chinese wine-marinated crispy duck tongues and kidneys. Few things beat a warm bowl of congee with dried oyster, salty pork and preserved egg. Minced pork and seafood soup dumplings are steamed pockets of soul-soothing and savory broth, but it's the signature marinated chicken with thick and fragrant black truffle sauce that lives up to the hype...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=955%20W.%20Broadway%2C%20Vancouver%2C%20V5Z%201K3%2C%20Canada"
    pageTitle="Chef's Choice Chinese Cuisine"
  />
);

export default Rchefschoicechinesecuisine;
