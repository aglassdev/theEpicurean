...
const Rfolke = () => (
  <RestaurantPage
    restaurantName="Folke"
    address="2585 W. Broadway, Vancouver, V6K 2E9, Canada"
    cuisine="Vegan, North American"
    priceRange="$$$$"
    phoneNumber="+12364556556"
    website="https://www.folkerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friends Colin Uyeda and Pricilla Deo have brought bright, delicious plant-based fare to Kitsilano with Folke. A wall of wine greets guests at the entrance to this small-but-sophisticated spot where deep blue walls are adorned with original seaweed pressings and dried grasses complement the tranquil, coastal ambience. The fully open kitchen turns out impressive items. Don't skip the irresistible bread served with kale butter sprinkled with sesame seeds. A main dish of tender yet crunchy cabbage resting in a silky mole made from potatoes has terrifically tangy and smoky notes. In addition to the selection on display, the Folke team features a small selection of natural wine and locally produced ciders, as well as non-alcoholic libations to pair with your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2585%20W.%20Broadway%2C%20Vancouver%2C%20V6K%202E9%2C%20Canada"
    pageTitle="Folke"
  />
);

export default Rfolke;
