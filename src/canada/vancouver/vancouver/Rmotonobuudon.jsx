...
const Rmotonobuudon = () => (
  <RestaurantPage
    restaurantName="Motonobu Udon"
    address="3501 E. Hastings St., Vancouver, V5K 0E5, Canada"
    cuisine="Udon, Japanese"
    priceRange="$$"
    phoneNumber="+16042931889"
    website="https://motonobuudon.ca"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's worth frequenting this spot, where a simple, light-flooded dining room buzzes with tables full of diners slurping bowls of noodles and savoring sides. As the name hints, it's all about udon here, where the noodles are handmade and cut fresh to order. Traditional varieties are available hot or cold, served with tempura bits and fresh green onions or with mentsyu sauce and tempura egg. Specialty bowls, such as the spicy tanton with braised pork belly, Shanghai bok choy in a spiced chicken and dashi broth, are equally enticing. Peruse the add-ons and you may find yourself topping your bowl with piles of tempura treats, and inari and pressed sushi round out the menu. Don't see something you want? Ask, as the accommodating staff aims to please...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3501%20E.%20Hastings%20St.%2C%20Vancouver%2C%20V5K%200E5%2C%20Canada"
    pageTitle="Motonobu Udon"
  />
);

export default Rmotonobuudon;
