...
const Roctopusgarden = () => (
  <RestaurantPage
    restaurantName="Octopus Garden"
    address="1995 Cornwall Ave., Vancouver, V6J 1C9, Canada"
    cuisine="Japanese, Sushi"
    priceRange="$$$$"
    phoneNumber="+16047348971"
    website="https://www.octopusgarden-canada.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1995%20Cornwall%20Ave.%2C%20Vancouver%2C%20V6J%201C9%2C%20Canada"
    pageTitle="Octopus Garden"
  />
);

export default Roctopusgarden;
