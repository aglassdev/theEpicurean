...
const Rbaobei = () => (
  <RestaurantPage
    restaurantName="Bao Bei"
    address="163 Keefer St., Vancouver, V6A 1X3, Canada"
    cuisine="Chinese, Taiwanese"
    priceRange="$$$"
    phoneNumber="+16046880876"
    website="https://www.bao-bei.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bao Bei may mean precious, but there's nothing twee about this brasserie located at the edge of Vancouver's old Chinatown. Instead, Chef Joël Watanabe shows off his playful, creative cooking style, delivering food that's inventive and fun. Far from traditional, these unique takes on classic Chinese cuisine are crafted from top-notch ingredients. Take the kick ass fried rice, their savory and a tad sweet version of the ubiquitous standard. This dish punches above its weight with an ingenious blend of prawns, bitter melon, masala-preserved mushrooms and papadam. Mantou buns filled with braised pork, hoisin, pickled ginger and miso-serrano aioli are positively irresistible, and even seemingly simple plates, like braised pea shoots with garlic, bring the flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=163%20Keefer%20St.%2C%20Vancouver%2C%20V6A%201X3%2C%20Canada"
    pageTitle="Bao Bei"
  />
);

export default Rbaobei;
