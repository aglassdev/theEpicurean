...
const Rbonjourvietnambistro = () => (
  <RestaurantPage
    restaurantName="Bonjour Vietnam Bistro"
    address="3944 Fraser St., Vancouver, V5V 4E4, Canada"
    cuisine="Vietnamese, Vegetarian"
    priceRange="$$$"
    phoneNumber="+16048793633"
    website="https://www.bonjourvietnambistro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With looks somewhere between a tropical greenhouse and a nightclub, plus a cool, clubby atmosphere, this lively, colorful boîte could just as well be in West Hollywood as Vancouver. Some of the plant life is artificial, but rest assured the homey Vietnamese fare is the real deal. A hip, fashion-forward clientele is drawn in by the cooking, but the energetic vibe and disarmingly sweet service can’t hurt. You might start with grilled skewers, like a pork sausage shaped around a lemongrass stalk, or a pepper-crusted beef carpaccio topped with fragrant herbs, crispy garlic and shallot—but save room for the soul-warming bowls of pho (a short rib version is noteworthy) and bun bo hue. Each item has a vegetarian counterpart, so there’s no shortage of options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3944%20Fraser%20St.%2C%20Vancouver%2C%20V5V%204E4%2C%20Canada"
    pageTitle="Bonjour Vietnam Bistro"
  />
);

export default Rbonjourvietnambistro;
