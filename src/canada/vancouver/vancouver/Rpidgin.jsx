...
const Rpidgin = () => (
  <RestaurantPage
    restaurantName="PiDGiN"
    address="350 Carrall St., Vancouver, V6B 2J3, Canada"
    cuisine="Contemporary, North American"
    priceRange="$$$$"
    phoneNumber="+16046209400"
    website="https://www.pidginvancouver.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are many reasons why Vancouver is considered a culinary destination, and PiDGin certainly has something to do with that. Inside, stirring artwork from local artists, soft industrial lighting and wood banquettes set a city-chic tone. This menu is distinctive. Playful, even irreverent, the kitchen is clearly having fun surprising diners with unusual combinations that not only work, but they wow. Signature dishes, like the Korean rice cakes cooked in an umami-rich gochujang bolognese with crunchy, spiced hazelnuts, make a nightly appearance. Other dishes include refreshing tuna tartare with nori puree and salty ikura, accompanied by taro root crisps...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=350%20Carrall%20St.%2C%20Vancouver%2C%20V6B%202J3%2C%20Canada"
    pageTitle="PiDGiN"
  />
);

export default Rpidgin;
