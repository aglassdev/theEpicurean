...
const Ophela = () => (
  <RestaurantPage
    restaurantName="Ophelía"
    address="165 W. 2nd Ave., Vancouver, V5Y 0L8, Canada"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$$"
    phoneNumber="+16048005253"
    website="https://www.opheliakitchen.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stunning murals, colorful carvings...Ophelía is quite literally a bright spot in Vancouver's Olympic Village. It's always packed, so make a reservation. Of course, if you didn't plan ahead, a bevy of special margaritas will help you pass the time. Chef/co-owner Francisco Higareda prepares traditional pan-regional Mexican fare just as his mother, Ophelia, did. Corn-crusted octopus sided by cilantro rice, braised kale and zucchini is bested with a Oaxacan mole blanco that's rich and creamy. A trio of tacos rewards diners with delectable ingredients piled high atop locally made tortillas. End things with that ultimate classic—tres leches cake.Weather permitting, the outdoor patio is the spot to while away the night...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=165%20W.%202nd%20Ave.%2C%20Vancouver%2C%20V5Y%200L8%2C%20Canada"
    pageTitle="Ophelía"
  />
);

export default Ophela;
