...
const Rbotanist = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+16046955500"
    website="https://www.botanistrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glide through the elegant lobby and up the sweeping staircase of the Fairmont Pacific Rim to arrive at Botanist, where dressing up is de rigueur. Headed by the passionate Chef Hector Laguna, the kitchen takes great pride in sourcing the best local product, whether it's wild, locally caught seafood or produce from the Fraser Valley. Every dish on this modern Canadian menu is delightful, but some of the standouts include hand-cut tagliatelle bathed in a mushroom sauce and crowned with wild mushroom ragout. Pan-seared striploin is perfectly cooked, resting alongside a tender cabbage roulade stuffed with lush beef tongue, Chinese broccoli and spicy XO sauce. To finish, desserts are impressive; especially when faced with the refreshing lemon syrup-soaked cake dressed with Meyer lemon curd and b..."
