...
const Rfannybayoysterbar = () => (
  <RestaurantPage
    restaurantName="Fanny Bay Oyster Bar"
    address="762 Cambie St., Vancouver, V6B 2P2, Canada"
    cuisine="Seafood, North American"
    priceRange="$$$"
    phoneNumber="+17783799510"
    website="https://www.fannybayoysters.com/location/oyster-bar--shellfish-market"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It doesn't get much more tide to table than Fanny Bay Oyster Bar. Tucked on a quiet street within walking distance from the city's stadiums, this hot spot gets crowded, especially on game days, and for good reason. This menu features some of the best shellfish and seafood-driven entrees around. Should your shucking skills be slightly rusty, they'll gladly offer a primer. Whether perched at the bar or settled in at a table, raw bar items should be top of mind. Prefer cooked items? The grilled oysters, served hot and bubbly, shellacked with Creole butter and a fresh herb-flavored gremolata, will float your boat. Then, tuck in to intensely rich sablefish collar, served crisped alongside with hot-sweet peppadew puree and grilled shishito peppers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=762%20Cambie%20St.%2C%20Vancouver%2C%20V6B%202P2%2C%20Canada"
    pageTitle="Fanny Bay Oyster Bar"
  />
);

export default Rfannybayoysterbar;
