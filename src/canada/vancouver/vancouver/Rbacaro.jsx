...
const Rbacaro = () => (
  <RestaurantPage
    restaurantName="Bacaro"
    address="1029 W. Cordova St., Vancouver, V6C 0B9, Canada"
    cuisine="Italian, Venetian"
    priceRange="$$$"
    phoneNumber="+16046879887"
    website="https://www.bacarovancouver.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From its marble-clad entrance to its modern furnishings and bright colors, bacaro bridges cool elegance and simplicity, and blends right in with the upscale lobby of the Fairmont Pacific Rim. The address may be Vancouver, but this spot is decidedly Venetian with its menu leaning toward the art of cicchetti, or small bites enjoyed on the go while quaffing a glass of wine. Some of the best  include sardines in saor, and fusilloni, enrobed in a veal and pork ragu with chanterelles and red wine-braised snails, is nothing short of divine. Capesante, or seared scallops in a cannellini bean stew crowned by fish-stuffed cabbage and a baci-baci sauce, is a Venetian kiss...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1029%20W.%20Cordova%20St.%2C%20Vancouver%2C%20V6C%200B9%2C%20Canada"
    pageTitle="Bacaro"
  />
);

export default Rbacaro;
