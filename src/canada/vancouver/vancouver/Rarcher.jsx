...
const Rarcher = () => (
  <RestaurantPage
    restaurantName="Archer"
    address="1152 Alberni St., Vancouver, V6E 1A5, Canada"
    cuisine="Contemporary, North American"
    priceRange="$$$$"
    phoneNumber="+17787376218"
    website="https://www.archerdining.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled alongside high-end retailers in the posh shopping district, Archer fits right in. It's sexy and sultry here, where natural materials are abundant, white-washed walls are adorned with contemporary art, and dark wood tables are set with leather-covered chairs. Dining solo? The bar in back is the perfect perch.The kitchen gives local and seasonal ingredients the royal treatment in classic preparations like seared sablefish served with snow crab yuzu butter and crab chowder. In addition to offering a prix fixe, à la carte offerings include lush items such as creamy uni and ribbons of lardo atop toasted brioche, and a tenderloin cooked to perfection accompanied by pomme paillasson. Go for broke and add Hokkaido scallop for a luxe touch. Chocolate semifreddo makes a nice ending...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1152%20Alberni%20St.%2C%20Vancouver%2C%20V6E%201A5%2C%20Canada"
    pageTitle="Archer"
  />
);

export default Rarcher;
