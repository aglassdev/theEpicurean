...
const Rhawksworthrestaurant = () => (
  <RestaurantPage
    restaurantName="Hawksworth Restaurant"
    address="801 W. Georgia St., Vancouver, V6C 1P7, Canada"
    ...
    pageTitle="Hawksworth Restaurant"
  />
);

export default Rhawksworthrestaurant;
