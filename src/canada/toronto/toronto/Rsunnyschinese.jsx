...
const Rsunnyschinese = () => (
  <RestaurantPage
    restaurantName="Sunnys Chinese"
    address="60 Kensington Ave., Toronto, M5T 2K1, Canada"
    cuisine="Chinese"
    priceRange="$$"
    phoneNumber="+14378335798"
    website="https://www.sunnyschinese.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%20Kensington%20Ave.%2C%20Toronto%2C%20M5T%202K1%2C%20Canada"
    pageTitle="Sunnys Chinese"
  />
);

export default Rsunnyschinese;
