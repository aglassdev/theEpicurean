...
const RickyOlivia = () => (
  <RestaurantPage
    restaurantName="Ricky + Olivia"
    address="996 Queen St. E, Toronto, M4M 1K1, Canada"
    cuisine="Creative"
    priceRange="$$"
    phoneNumber="+16479656697"
    website="https://www.rickyandolivia.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=996%20Queen%20St.%20E%2C%20Toronto%2C%20M4M%201K1%2C%20Canada"
    pageTitle="Ricky + Olivia"
  />
);

export default RickyOlivia;
