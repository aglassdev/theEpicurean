...
const Rcherrystreetbarbque = () => (
  <RestaurantPage
    restaurantName="Cherry Street Bar-B-Que"
    address="275 Cherry St., Toronto, M5A 3L3, Canada"
    cuisine="Barbecue"
    priceRange="$$"
    phoneNumber="+14164615111"
    website="https://www.cherrystbbq.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its red neon sign shines like a beacon, as this 1920 building – which was once a bank – now sits proudly isolated in the middle of a massive waterfront construction project, but step inside and you immediately feel cocooned in its warm-heartedness. It was pitmaster Lawrence La Pianta who brought the barbecue traditions of the American South to Hogtown; after years of competing and judging with the Kansas City Barbeque Society circuit, he knows his way around a broad range of tastes ranging from Texas-style brisket to St. Louis-style ribs. Lightly charred wings and snappy, finely spiced sausage links are sleeper hits. Everything is smoked on the patio inside a redesigned shipping container. Stopping by on a weekend? Be aware that meats are likely to sell out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=275%20Cherry%20St.%2C%20Toronto%2C%20M5A%203L3%2C%20Canada"
    pageTitle="Cherry Street Bar-B-Que"
  />
);

export default Rcherrystreetbarbque;
