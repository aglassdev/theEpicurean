...
const Rjacobscosteakhouse = () => (
  <RestaurantPage
    restaurantName="Jacobs & Co. Steakhouse"
    address="81 Bay St., 4th Floor, Toronto, M5J 0E7, Canada"
    cuisine="Steakhouse, Contemporary"
    priceRange="$$$$"
    phoneNumber="+14163660200"
    website="https://jacobssteakhouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jacobs & Co., now located in CIBC Square, is a smart, sleek and airy space with a contemporary design, a place where bookmatched veneer-paneled walls blend with banquette seating and a marble-topped cocktail bar grooves to the tunes of a live pianist.  Special touches abound; aged white cheddar popovers with roasted garlic and oregano butter arrive shortly after arrival, and they'll send you home with coffee cake muffins. With a range of fish and seafood from the raw bar and an unrivaled selection of steaks, there's plenty to like here. Don't know what to order? Opt for the chefs tasting with a range of striploins from Canada, Australia and Japan. The wine list is an oenophile's dream with strong selections from Burgundy and Italy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20Bay%20St.%2C%204th%20Floor%2C%20Toronto%2C%20M5J%200E7%2C%20Canada"
    pageTitle="Jacobs & Co. Steakhouse"
  />
);

export default Rjacobscosteakhouse;
