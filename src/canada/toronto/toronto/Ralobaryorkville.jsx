...
const Ralobaryorkville = () => (
  <RestaurantPage
    restaurantName="Alobar Yorkville"
    address="57A-162 Cumberland St., Toronto, M5R 1A8, Canada"
    cuisine="French, Seafood"
    priceRange="$$$$"
    phoneNumber="+14169611222"
    website="https://thealobar.com/alobar-yorkville/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The warm and flattering lighting, the low ceiling, and the curved banquettes all make you think you’ve walked into a cocktail bar rather than a destination restaurant. But that noisy buzz of contentment you hear on arrival is a testament to the food, which hits the spot just as well as the skillfully made cocktails. Seafood is a big deal here, whether scallops or bream, but meats too, such as Creekstone striploin and Iberico pork chop, demonstrate that the kitchen knows its way around a charcoal grill. Those familiar with the Alo Food Group’s other restaurants will recognize classics like the wedge salad, Dover sole, and the banana cream pie holding court in this dining room as well. A second location downtown offers a near identical menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57A-162%20Cumberland%20St.%2C%20Toronto%2C%20M5R%201A8%2C%20Canada"
    pageTitle="Alobar Yorkville"
  />
);

export default Ralobaryorkville;
