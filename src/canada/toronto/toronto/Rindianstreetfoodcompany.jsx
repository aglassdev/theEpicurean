...
const Rindianstreetfoodcompany = () => (
  <RestaurantPage
    restaurantName="Indian Street Food Company"
    address="1701 Bayview Ave., Toronto, M4G 3C1, Canada"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+14163223270"
    website="https://www.indianstreetfoodco.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Found in Leaside along a packed row of shops on Bayview Avenue, this neighborhood stalwart delivers a tight menu of street food favorites and regional curries from various corners of India. The dining room is wrapped in reclaimed wood panels and colorful murals, and cushy tables with white cloth invite further lingering. Over-ordering is easy, but friendly servers are quick to offer guidance. Deep-fried cauliflower finished in a sweet chili glaze is a kitchen specialty, but savory chaats, arriving lashed in refreshing chutneys, are worth an order. Order the thalis to see the breadth of this kitchen’s talent in one large, oversized platter featuring delicately spiced lamb curry, rich dhal makhani and a superb south Indian vegetable curry...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1701%20Bayview%20Ave.%2C%20Toronto%2C%20M4G%203C1%2C%20Canada"
    pageTitle="Indian Street Food Company"
  />
);

export default Rindianstreetfoodcompany;
