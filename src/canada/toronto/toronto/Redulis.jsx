...
const Redulis = () => (
  <RestaurantPage
    restaurantName="Edulis"
    address="169 Niagara St., Toronto, M5V 1C9, Canada"
    cuisine="Mediterranean Cuisine"
    priceRange="$$$$"
    phoneNumber="+14167034222"
    website="https://www.edulisrestaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sweet can carry a slightly disparaging edge, but there’s something quite endearing about this quaint little house, with its warm, yellow-toned interior brimming with assorted bric-a-brac. The dedication of the husband-and-wife chef-owners and their staff is unmistakable, fostering a pervading atmosphere of warm, easygoing hospitality. The set multicourse menu (paid for in full at the time of booking) is largely inspired by the Mediterranean, and in particular Spain, focusing on excellent seafood complemented by seasonal flavors and indulgent sauces. Take, for example, Québec snow crab with fennel and rich mousseline, or John Dory with white asparagus, porcini, and Amontillado Sherry sauce. Excellent house-cured sausages, cheese, and dessert are available as add-ons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=169%20Niagara%20St.%2C%20Toronto%2C%20M5V%201C9%2C%20Canada"
    pageTitle="Edulis"
  />
);

export default Redulis;
