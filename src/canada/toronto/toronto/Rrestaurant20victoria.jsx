...
const Rrestaurant20victoria = () => (
  <RestaurantPage
    restaurantName="Restaurant 20 Victoria"
    address="20 Victoria St., Unit 100, Toronto, M5C 2A1, Canada"
    cuisine="Contemporary, Seafood"
    priceRange="$$$$"
    phoneNumber="+14168046066"
    website="https://www.exploretock.com/restaurant20victoria"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On a quiet stretch of downtown Toronto, Chef Julie Hyde is making her talents known in this tiny-but-mighty restaurant. Top-notch local produce, pristine seafood and refined sauce work make for a delicious trifecta on a tasting menu that boasts originality in spades. Highlights included Iberico pork chop with bagna vert sauce, frisee salad finished with fried shallot, and a rhubarb strawberry jam and white chocolate ganache in a beautiful pâte à choux. The dimly lit dining room is elegantly easy-going, as Hyde and her small team work with laser-like focus from a kitchen that’s simultaneously always in use and always pristine. Service mirrors the kitchen’s unpretentious approach, offering a warm, jovial sense of hospitality that doesn’t miss a beat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Victoria%20St.%2C%20Unit%20100%2C%20Toronto%2C%20M5C%202A1%2C%20Canada"
    pageTitle="Restaurant 20 Victoria"
  />
);

export default Rrestaurant20victoria;
