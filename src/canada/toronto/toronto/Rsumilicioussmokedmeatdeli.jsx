...
const Rsumilicioussmokedmeatdeli = () => (
  <RestaurantPage
    restaurantName="SumiLicious Smoked Meat & Deli"
    address="5631 Steeles Ave., #5, Toronto, M1V 5P6, Canada"
    cuisine="Deli"
    priceRange="$"
    phoneNumber="+16473478899"
    website="https://sumilicious.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a non-descript Scarborough shopping center, Sumith Fernando’s smoked meat is something of a rite of passage. Fernando spent nearly two decades learning his craft at Schwartz's in Montreal before settling on his own recipe. His halal brisket is marinated in a secret spice blend for days, smoked for hours until tender and finally finished in a steamer. He opened in 2018 and has been behind the counter ever since, building sandwiches out of thinly sliced, peppery brisket piled high on soft, spongy rye smeared with yellow mustard. Against the advice of any physician, complete your order at this no-frills deli with poutine—fries topped with Quebec cheese curds and submerged in gravy. Ask for extra napkins, you'll need them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5631%20Steeles%20Ave.%2C%20%235%2C%20Toronto%2C%20M1V%205P6%2C%20Canada"
    pageTitle="SumiLicious Smoked Meat & Deli"
  />
);

export default Rsumilicioussmokedmeatdeli;
