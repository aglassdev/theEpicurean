...
const Rsomtumjinda = () => (
  <RestaurantPage
    ...
    address="76 Gerrard St. E., Toronto, M5G 2A7, Canada"
    cuisine="Thai"
    priceRange="$"
    phoneNumber="+14163517576"
    website="https://somtumjinda.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, somtum is the specialty here and it’s made Isan-style with fermented fish paste for that extra tang. Tom Puu Nam Pla is classic Isan somtum, with the addition of salted crab along with the papaya, garlic, chili and tomato. You can stipulate your desired heat, but be aware that the scale here goes up to 11. Kor Moo Yang – grilled, succulent pork jowl – is another house specialty that’s fast become one of its biggest sellers and is well worth ordering. What this simple basement restaurant may lack in comfort, it more than makes up for in color. There’s a family connection to the original Som Tum Jinda in Thailand and, while it doesn’t serve any alcohol, it offers a wide variety of drinks from the next-door café...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=76%20Gerrard%20St.%20E.%2C%20Toronto%2C%20M5G%202A7%2C%20Canada"
    pageTitle="Som Tum Jinda"
  />
);

export default Rsomtumjinda;
