...
const Rdilse = () => (
  <RestaurantPage
    ...
    address="335 Roncesvalles Ave., Toronto, M6R 2M8, Canada"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+14165324141"
    website="https://www.dilse.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dil Se is set along the village's main thoroughfare in Toronto's Roncy neighborhood. Effort has gone into the decor here, with linen-draped tables and walls accented by colorful fabrics.Chef/owner Mani Panwar offers highly enjoyable, well-prepared northern Indian cuisine.Paneer lababdar, a Chef's special, is a Mughlai-style specialty featuring soft cubes of fresh cow's milk cheese simmered in a creamy, highly flavorful, orange-hued sauce enriched with cashews. Neatly presented in a metal bowl, vegetable biryani is fluffy and hot with a bright flavor courtesy of chilies, herbs and dried spices. Among the tandoor offerings, choose the lamb seek kebab, which comes with a zesty red chutney that leans tart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=335%20Roncesvalles%20Ave.%2C%20Toronto%2C%20M6R%202M8%2C%20Canada"
    pageTitle="Dil Se"
  />
);

export default Rdilse;
