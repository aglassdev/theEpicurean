...
const TheCottageCheese = () => (
  <RestaurantPage
    restaurantName="The Cottage Cheese"
    address="64 Oxford St., Toronto, M5T 1P1, Canada"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+16473688633"
    website="https://thecottagecheese.ca/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Kensington Market stands this cheery little dining room wrapped in large windows and flush with sunlight. Named after the owner’s favorite food (paneer), the restaurant takes its sunny disposition to heart and offers refreshing takes on an extensive range of familiar Indian classics and flavors. Prepared with finesse and refinement and seasoned to exacting standards, chaats, claypots, and curries are designed for sharing. Recent highlights include a strikingly vibrant butter chicken as well as a deep-toned coastal fish curry. Naan arrives crisp and garlic-flecked, but you’ll need rice too to sop up every bit of sauce. All the while, friendly servers are happy to explain dishes and make suggestions at great length...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64%20Oxford%20St.%2C%20Toronto%2C%20M5T%201P1%2C%20Canada"
    pageTitle="The Cottage Cheese"
  />
);

export default TheCottageCheese;
