...
const Linnys = () => (
  <RestaurantPage
    restaurantName="Linny's"
    address="176 Ossington Ave., Toronto, M6J 2Z7, Canada"
    cuisine="Steakhouse, American Contemporary"
    priceRange="$$$$"
    phoneNumber="+16473901836"
    website="https://linnysrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Linny's is the latest addition to David Schwartz's growing collection of popular spots (which also includes Sunnys Chinese and Mimi Chinese). Named after his mom, Linda, and designed with Jack Lipson, this restaurant blends old-school steakhouse energy with subtle deli touches. Prices skew high but the atmosphere is perfect for special occasions.The menu is a hit list of comfort classics with a twist like the challah service sided by bowls of pickles, house-made sauerkraut and whipped cheese with berry jam or a Caesar salad that substitutes crispy chicken skin for the typical crouton. Steaks, fish and other proteins like roast chicken and lamb neck are solid, while caramelized apple cake with a tableside pour of chantilly cream is the perfect send-off...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=176%20Ossington%20Ave.%2C%20Toronto%2C%20M6J%202Z7%2C%20Canada"
    pageTitle="Linny's"
  />
);

export default Linnys;
