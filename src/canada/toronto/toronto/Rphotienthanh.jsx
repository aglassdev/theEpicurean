...
const Rphotienthanh = () => (
  <RestaurantPage
    restaurantName="Pho Tien Thanh"
    address="57 Ossington Ave., Toronto, M6J 2Y9, Canada"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+14165886997"
    website="https://photienthanh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot set off busy Queen Street may not bother with frills or fuss but this place fills early with patrons willing to wait in line. They're here for the food—classic Vietnamese dishes including pho and other specialties—that is delivered from stove to tabletop in no time. Attractive presentations and a clear attention to detail with quality ingredients make the experience all the more pleasing. Hearty bowls of Pho are the way to go; the rare beef variations are especially impressive. Big steaming bowls may be the signature, but the menu does offer many other dishes that are worth exploring.It's cash-only on the weekends, while debit cards are accepted during the week...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20Ossington%20Ave.%2C%20Toronto%2C%20M6J%202Y9%2C%20Canada"
    pageTitle="Pho Tien Thanh"
  />
);

export default Rphotienthanh;
