...
const Rnorthernsmokes = () => (
  <RestaurantPage
    restaurantName="Northern Smokes"
    address="371 Old Kingston Rd., Unit 12, Scarborough, M1C 1B7, Canada"
    cuisine="Barbecue, American"
    priceRange="$$"
    phoneNumber="+14162848448"
    website="https://northernsmokes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's a ride from downtown to get to this spot in Scarborough tucked inside a simple strip mall, but the smoky aroma will beckon you inside. Imran Ali opened Northern Smokes in 2019 with the simple promise of traditional barbecued meats and sides. A custom reverse-flow wood stick-burning smoker and seasoned split hard wood infuse the fully halal meat with delicious flavor. Order as a multi-meat plate, as a sandwich, or by the pound, and with everything from tender, Montreal-style brisket and Korean-style short ribs in a sweet marinade to chicken, there's plenty to be had. Sides are a terrific complement to the meaty delights, and just in case you forgot that you weren't in the American South, maple-smoked beans will remind you exactly where you are...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=371%20Old%20Kingston%20Rd.%2C%20Unit%2012%2C%20Scarborough%2C%20M1C%201B7%2C%20Canada"
    pageTitle="Northern Smokes"
  />
);

export default Rnorthernsmokes;
