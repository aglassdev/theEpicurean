...
const Rvinpolisson = () => (
  <RestaurantPage
    restaurantName="Vin Polisson"
    address="197 King Ouest, Sherbrooke, J1H 1P4, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+18197912442"
    website="https://www.vinpolisson.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pocket-sized restaurant and wine bar with a minimalist decor has a few tables and two counters, one of which provides a front-row view of the micro-kitchen. Chef Isabelle Charest sources ingredients locally to deliver fresh, intuitive cuisine that showcases seasonal produce and vegetables. Passionate about food and wine pairings, she curates a selection of natural wines, mostly from Québec and Nordic climes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=197%20King%20Ouest%2C%20Sherbrooke%2C%20J1H%201P4%2C%20Canada"
    pageTitle="Vin Polisson"
  />
);

export default Rvinpolisson;
