...
const Rmyranel = () => (
  <RestaurantPage
    restaurantName="Myranel"
    address="241 chemin du Roy, Deschambault, G0A 1S0, Canada"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+14182866691"
    website="https://myranel.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a charming village on the banks of the St. Lawrence, Myranel is surrounded by picturesque shops (antique dealers, bakery, and a renowned chocolate shop). This delightful late 19th-century house, complete with lovely original ceiling beams, is home to this Biosphere-certified restaurant run by a young couple. Chef Mathieu Janes, a strong believer in eating local, works exclusively with small-scale producers, sourcing the majority of his ingredients from Portneuf County (except coffee, some citrus fruits, and fish). The set menu, which changes every two months or so, comes in two versions; one is vegetarian. The chef likes to go off the beaten track, as with his aligot potatoes with a Quebecois twist, or to create surprises with daring sweet and sour combinations (duck, red cabbage, radic..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=241%20chemin%20du%20Roy%2C%20Deschambault%2C%20G0A%201S0%2C%20Canada"
    pageTitle="Myranel"
  />
);

export default Rmyranel;
