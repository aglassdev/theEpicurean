...
const MamaFatmaMIS = () => (
  <RestaurantPage
    restaurantName="Mama Fatma"
    address="6970 Financial Dr., Mississauga, L5N 8J4, Canada"
    cuisine="Turkish"
    priceRange="$$"
    phoneNumber="+19058326868"
    website="https://mamafatma.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On name alone, you can bet that nobody leaves this restaurant hungry. Kebabs charred over glowing coals, meats spinning on a spit, and fluffy, dome-like rounds of pita cooked in a wood-burning oven are served here in abundance. Such is the appeal of this local favorite that has fed families well for years. In fact, it’s not uncommon to see large groups huddled around a feast that covers every corner of the table. Tiny poached beef dumplings coated in a garlicky yogurt sauce (kayseri mantısı) could be a meal of their own. Flatbreads topped with everything from tomatoes to ground beef add to the carb-loading. The menu is lengthy, but servers are quick to make suggestions. There’s rarely room for dessert, but there’s always a place for hot tea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6970%20Financial%20Dr.%2C%20Mississauga%2C%20L5N%208J4%2C%20Canada"
    pageTitle="Mama Fatma"
  />
);

export default MamaFatmaMIS;
