...
const BrasserieColetteTimRaueCON = () => (
  <RestaurantPage
    restaurantName="Brasserie Colette Tim Raue"
    address="Brotlaube 2A, Constance, 78462, Germany"
    cuisine="French, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+4975311285100"
    website="https://www.brasseriecolette.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is MICHELIN-starred chef Tim Raue's take on a French brasserie.As at the Colette brasseries in Berlin and Munich, there is a small à la carte selection, as well as three set menus: one comprising Colette classics, one devised by Tim Raue himself and a vegan menu. The highlight here is the first-floor terrace overlooking the pedestrian area – but seating is limited, so you'd be well advised to book!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brotlaube%202A%2C%20Constance%2C%2078462%2C%20Germany"
    pageTitle="Brasserie Colette Tim Raue"
  />
);

export default BrasserieColetteTimRaueCON;
