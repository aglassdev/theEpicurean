...
const Papageno = () => (
  <RestaurantPage
    restaurantName="Papageno"
    address="Untere Laube 47, Constance, 78462, Germany"
    cuisine="Classic Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+497531368660"
    website="https://www.restaurant-papageno.net"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone's throw away from the small border crossing at Tägerwilen, Patrick Stier (previously of Papageno at the old location) serves up classic cuisine with Mediterranean influences. Cosy interior with wood panelling and modern details. The vine-clad terrace beneath the pergola is delightful...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untere%20Laube%2047%2C%20Constance%2C%2078462%2C%20Germany"
    pageTitle="Papageno"
  />
);

export default Papageno;
