...
const Clbo = () => (
  <RestaurantPage
    restaurantName="Cølbo"
    address="Rathausstraße 15, Klingenberg am Main, 63911, Germany"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+4993729279800"
    website="https://www.colbo-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Armed with an impressive CV, chef-patron Moritz Techet presents a modern, creative concept. Diners are treated to a surprise menu comprising 10 smaller or larger courses, each one technically polished and precisely executed. The dishes are pared down to the essentials and based on select, predominantly regional ingredients. The kitchen team maintain the restaurant's herb garden, forage for mushrooms and berries, and employ fermentation and preservation techniques. The emphasis is on vegetarian cuisine. The charming and dedicated waitstaff are led by Jansý Frederiksberg, assisted by the chefs, who personally elaborate on their creations. Both the wine pairing and the non-alcoholic beverages match the menu beautifully. The minimalist, clean-lined interior design is extremely chic. Places are..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rathausstra%C3%9Fe%2015%2C%20Klingenberg%20am%20Main%2C%2063911%2C%20Germany"
    pageTitle="Cølbo"
  />
);
