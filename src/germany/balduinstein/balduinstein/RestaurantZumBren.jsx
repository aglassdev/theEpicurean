...
const RestaurantZumBren = () => (
  <RestaurantPage
    restaurantName="Restaurant zum Bären"
    address="Bahnhofstraße 24, Balduinstein, 65558, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+496432800780"
    website="https://www.landhotel-zum-baeren.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Buggle family has been running this traditional restaurant in the idyllic Lahn Valley since 1827. With chef Joachim Buggle, the eighth generation is now at the helm and his concept is impressive. He has dedicated himself to culinary classics, serving flavour-intensive, pleasantly pared-back dishes prepared without fuss or frills. Examples from the menu include dishes such as braised veal shank with root vegetables, leek, and potato and cheese purée, or fillet of line-caught sea bass with stuffed courgette, wild garlic risotto and a crustacean foam. The restaurant, with its delightful country-house style interior, has a pleasant and cosy atmosphere, while the Weinstube exudes a slightly more rustic feel. And then they have another ace up their sleeve in the form of a wonderful terrace i..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofstra%C3%9Fe%2024%2C%20Balduinstein%2C%2065558%2C%20Germany"
    pageTitle="Restaurant zum Bären"
  />
);

export default RestaurantZumBren;
