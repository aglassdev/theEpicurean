...
const Mittermeier = () => (
  <RestaurantPage
    restaurantName="Mittermeier"
    address="Vorm Würzburger Tor 7, Rothenburg ob der Tauber, 91541, Germany"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€€"
    phoneNumber="+49986194540"
    website="https://www.villamittermeier.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Diners walk past the open kitchen into the trendy dining space, where attentive service comes courtesy of a friendly and dedicated front-of-house team. The cuisine is modern and seasonal, with many ingredients sourced from regional producers. Dishes such as ravioli, Parmigiano Reggiano and green olive or guinea fowl, chanterelles and lovage demonstrate a pleasing sense of clarity and coherence with delightful contrasts and perfectly balanced flavours. The small cards providing information about the dishes are a nice idea. Create your own menu by choosing five, seven or nine courses. The staff will be happy to recommend wines from their Tauberhase range. Tip: tasteful hotel accommodation at Villa Mittermeier...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vorm%20W%C3%BCrzburger%20Tor%207%2C%20Rothenburg%20ob%20der%20Tauber%2C%2091541%2C%20Germany"
    pageTitle="Mittermeier"
  />
);

export default Mittermeier;
