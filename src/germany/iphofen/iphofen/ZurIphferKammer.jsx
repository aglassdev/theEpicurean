...
const ZurIphferKammer = () => (
  <RestaurantPage
    restaurantName="Zur Iphöfer Kammer"
    address="Marktplatz 24, Iphofen, 97346, Germany"
    cuisine="Farm to table, International"
    priceRange="€€"
    phoneNumber="+4993238772677"
    website="https://www.kammer-iphofen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small historic restaurant is located on the market square at Iphofen, a pretty wine-growing town. The delicious fare, which includes dishes such as red mullet with ratatouille and breast of guinea fowl with risotto and girolles, can be sampled in the cosy dining room or outside on the lovely terrace. Excellent wines from the Wirsching vineyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktplatz%2024%2C%20Iphofen%2C%2097346%2C%20Germany"
    pageTitle="Zur Iphöfer Kammer"
  />
);

export default ZurIphferKammer;
