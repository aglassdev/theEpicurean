...
const BrasserieCuvillis = () => (
  <RestaurantPage
    restaurantName="Brasserie Cuvilliés"
    address="Kardinal-Faulhaber-Straße 1, Munich, 80333, Germany"
    cuisine="Alpine, International"
    priceRange="€€€"
    phoneNumber="+49898000198710"
    website="https://www.rosewoodhotels.com/de/munich/dining/brasserie-cuvillies"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brasserie fare inspired by Bavarian-Alpine cuisine is the order of the day at the restaurant of the Rosewood Munich hotel. Classic, modern and traditional elements come together here. In the evening, dishes such as bouillabaisse or chicken from Landshut with corn, spinach and a pepper foam grace the menu; at lunchtime, tempting options include Cuvilliés Burger or quark pizokel. Wiener schnitzel is a mainstay on the menu. The daily-changing lunch menu with a choice of dishes is also worth perusing. The space has a chic brasserie feel and an open kitchen that can be seen from the dining area. Qu'ils mangent de la Brioche by ceramic artist Angelika Maria Stiegler also draws the eye. In addition, there is the inviting Bar Montez, the winter garden for afternoon tea and the Palaishof terrace. T..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kardinal-Faulhaber-Stra%C3%9Fe%201%2C%20Munich%2C%2080333%2C%20Germany"
    pageTitle="Brasserie Cuvilliés"
  />
);

export default BrasserieCuvillis;
