...
const Martinelli = () => (
  <RestaurantPage
    ...
    address="Wilhelm-Dieß-Weg 2, Munich, 81927, Germany"
    cuisine="Italian, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+4989931416"
    website="https://www.ristorantemartinelli.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for Italian hospitality and the food that goes with it, Martinelli offers seasonal, modern cuisine including dishes such as pecorino ravioli with walnut and balsamic vinegar or saddle of venison with quince. And to whet your appetite, there’s always a plate of air-dried ham and some delicious bread...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wilhelm-Die%C3%9F-Weg%202%2C%20Munich%2C%2081927%2C%20Germany"
    pageTitle="Martinelli"
  />
);

export default Martinelli;
