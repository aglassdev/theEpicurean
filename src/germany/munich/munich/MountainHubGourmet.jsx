...
const MountainHubGourmet = () => (
  <RestaurantPage
    restaurantName="Mountain Hub Gourmet"
    address="Terminalstraße Mitte 20, Munich, 85356, Germany"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+498997824500"
    website="https://mountainhub.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Terminalstra%C3%9Fe%20Mitte%2020%2C%20Munich%2C%2085356%2C%20Germany"
    pageTitle="Mountain Hub Gourmet"
  />
);

export default MountainHubGourmet;
