...
const TheCloudByKfer = () => (
  <RestaurantPage
    restaurantName="THE CLOUD by Käfer"
    address="Am Olympiapark 1, Munich, 80809, Germany"
    cuisine="International, Contemporary"
    priceRange="€€€€"
    phoneNumber=""
    website="https://thecloud.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Jens Madsen serves up his extraordinary concept of Culinary Nomadism, in which local ingredients meet global influences, at the equally special – and architecturally impressive – BMW Welt. For a year at a time, the spotlight is shone on a specific region of the world, its culinary traditions and techniques, spices etc. Each season brings with it change and progression – like a cloud moving through the sky. Inspired by his own trip to Africa, the chef takes you on a voyage of discovery of the flavours of East and South Africa. Top-quality produce goes into a tasting menu made up of eight elaborate courses promising a unique and immersive experience. In addition to wine, there are truly fantastic alcohol-free pairings. Extremely professional service is provided by a well-staffed front-o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Olympiapark%201%2C%20Munich%2C%2080809%2C%20Germany"
    pageTitle="THE CLOUD by Käfer"
  />
);

export default TheCloudByKfer;
