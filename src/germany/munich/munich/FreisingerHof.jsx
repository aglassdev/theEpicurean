...
const FreisingerHof = () => (
  <RestaurantPage
    restaurantName="Freisinger Hof"
    address="Oberföhringer Straße 189, Munich, 81925, Germany"
    cuisine="Traditional Cuisine, International"
    priceRange="€€"
    phoneNumber="+4989189082400"
    website="https://www.freisinger-hof.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is easy to see why this charming inn dating from 1875 is always busy. It boasts a stylish interior, a lively atmosphere and delicious food. There are classics from Bavaria and Austria – the focus is on beef but there is also Backhendl (breaded fried chicken). If you're lucky, you'll be able to try the fabulous creamy veal goulash at lunchtime. Quick and helpful service. You can have a comfortable stay in one of the well-maintained guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oberf%C3%B6hringer%20Stra%C3%9Fe%20189%2C%20Munich%2C%2081925%2C%20Germany"
    pageTitle="Freisinger Hof"
  />
);

export default FreisingerHof;
