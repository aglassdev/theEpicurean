...
const BerghotelWiedenerEck = () => (
  <RestaurantPage
    restaurantName="Berghotel Wiedener Eck"
    address="Oberwieden 15, Wieden, 79695, Germany"
    cuisine="Country cooking, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4976739090"
    website="https://wiedener-eck.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Marie and Lorenz Wissler represent the fourth generation of their family to run Berghotel Wiedener Eck, which enjoys an idyllic location at over 1 000m above sea level – the view of the valley is stunning! For overnight stays, there are attractive, cosy guestrooms, and the restaurant is brimming with traditional Black Forest charm, interspersed with modern touches. In the restaurant, you can look forward to friendly and courteous service, as well as regional cuisine and dishes that draw on the culinary traditions of France and the Mediterranean, all made from fresh high-quality ingredients – the chef even hunts his own game. In the evenings, there is a set menu that changes every day, plus the seasonal Wiedener Eck Menü. You can also order the individual courses of both à la carte. Tip: Th..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oberwieden%2015%2C%20Wieden%2C%2079695%2C%20Germany"
    pageTitle="Berghotel Wiedener Eck"
  />
);

export default BerghotelWiedenerEck;
