...
const MundartRestaurant = () => (
  <RestaurantPage
    restaurantName="mundart Restaurant"
    address="Weedengasse 8, Saulheim, 55291, Germany"
    cuisine="Classic Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+4967329322966"
    website="https://www.mundart-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Swabian-born Markus Hebestreit’s restaurant has an attractive, modern, country-style decor and charming interior courtyard. It is located in a pretty, old village house in this little wine-growing town. The fresh and tasty food includes dishes such as braised ox cheeks and tuna fish carpaccio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weedengasse%208%2C%20Saulheim%2C%2055291%2C%20Germany"
    pageTitle="mundart Restaurant"
  />
);

export default MundartRestaurant;
