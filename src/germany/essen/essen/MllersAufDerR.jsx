...
const MllersAufDerR = () => (
  <RestaurantPage
    restaurantName="Müllers auf der Rü"
    address="Rüttenscheider Straße 62, Essen, 45130, Germany"
    cuisine="Seasonal Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+4920179937701"
    website="https://www.nelson-mueller.de/pages/mullers-auf-der-ru"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nelson Müller's fine dining restaurant, Schote, may have moved to Bergisch Gladbach, but this cherished Essen-based establishment at Rüttenscheider Stern U-Bahn station has stayed put. This is a market hall-style brasserie integrated into a shopping arcade. Sitting at high tables, diners tuck into delicious dishes ranging from currywurst to turbot, prepared in the centrally positioned open kitchen. Friendly service. Tip for motorists: public multi-storey car park around the corner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R%C3%BCttenscheider%20Stra%C3%9Fe%2062%2C%20Essen%2C%2045130%2C%20Germany"
    pageTitle="Müllers auf der Rü"
  />
);

export default MllersAufDerR;
