...
const KettnersKamota = () => (
  <RestaurantPage
    restaurantName="Kettner's Kamota"
    address="Hufergasse 23, Essen, 45239, Germany"
    cuisine="Creative, Alsatian"
    priceRange="€€€€"
    phoneNumber="+4920172044700"
    website="https://kettnerskamota.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hufergasse%2023%2C%20Essen%2C%2045239%2C%20Germany"
    pageTitle="Kettner's Kamota"
  />
);

export default KettnersKamota;
