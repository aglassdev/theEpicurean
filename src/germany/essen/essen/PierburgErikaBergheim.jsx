...
const PierburgErikaBergheim = () => (
  <RestaurantPage
    restaurantName="Pierburg - Erika Bergheim"
    address="Schmachtenbergstraße 184, Essen, 45219, Germany"
    cuisine="Farm to table, International"
    priceRange="€€€"
    phoneNumber="+4920545907"
    website="https://pierburg-essen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the rural outskirts of Essen, Pierburg has been welcoming diners since 1901. With many years of experience in the top league of gastronomy under her belt, Erika Bergheim is now at the helm, cooking up internationally and seasonally inspired dishes. You can choose from the à la carte selection, named Pierburg Karte, or opt for the Selection E.B. set menu – the individual courses can be ordered à la carte, too. There is also an extensive, well-curated wine list. Friendly service and a tasteful contemporary setting, with certain tables affording a glimpse into the kitchen. Gorgeous terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schmachtenbergstra%C3%9Fe%20184%2C%20Essen%2C%2045219%2C%20Germany"
    pageTitle="Pierburg - Erika Bergheim"
  />
);

export default PierburgErikaBergheim;
