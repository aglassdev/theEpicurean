...
const LandgasthausZumKreuz = () => (
  <RestaurantPage
    restaurantName="Landgasthaus zum Kreuz"
    address="Untertal 7, Biberach, 77781, Germany"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+497835426420"
    website="https://www.kreuz-prinzbach.de/home.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Everything about this place is an appealing mix of regional and modern influences – from the cosy dining area to the food and the attractive, comfortable rooms in the Speicher guesthouse next door. The menu features classics and seasonal dishes – the Mini-Versucherle, for instance, are intriguing. In summer, make the most of this delightful countryside location by dining on the fabulous terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untertal%207%2C%20Biberach%2C%2077781%2C%20Germany"
    pageTitle="Landgasthaus zum Kreuz"
  />
);

export default LandgasthausZumKreuz;
