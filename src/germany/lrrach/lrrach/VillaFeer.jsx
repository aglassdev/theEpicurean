...
const VillaFeer = () => (
  <RestaurantPage
    restaurantName="Villa Feer"
    address="Beim Haagensteg 1, Lörrach, 79541, Germany"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4976215791077"
    website="https://www.villa-feer.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner Kathrin Bucher has been running this restaurant in an attractive old villa near Lörrach exhibition centre since 2012. Dine in the cosy, bright interior or, in summer, out on the wonderful terrace. They serve lunch only: until 3pm you can order the set menu or from a small menu compiled from favourite dishes of the last decade. After that, there are desserts and ice creams/sorbets until 5pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beim%20Haagensteg%201%2C%20L%C3%B6rrach%2C%2079541%2C%20Germany"
    pageTitle="Villa Feer"
  />
);

export default VillaFeer;
