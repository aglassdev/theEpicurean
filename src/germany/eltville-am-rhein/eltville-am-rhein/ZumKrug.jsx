...
const ZumKrug = () => (
  <RestaurantPage
    restaurantName="Zum Krug"
    address="Hauptstraße 34, Eltville am Rhein, 65347, Germany"
    cuisine="Seasonal Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+49672399680"
    website="https://www.zum-krug-rheingau.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place has a long history that stretches back to 1720, and the Laufer family has now been at the helm for three generations. Behind the gorgeous historical façade, the cosy dining spaces exude traditional charm. Theregional and international cuisine takes its cue from the seasons, and the menu includes dishes such as a Sauerbraten (marinated pot roast) of organic pasture-fed beef with potato dumplings and cranberries. The friendly and professional waitstaff will be happy to recommend fine Rheingau wines from the estate to accompany your meal. Delightful courtyard terrace. Smart guestrooms – some are especially modern...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2034%2C%20Eltville%20am%20Rhein%2C%2065347%2C%20Germany"
    pageTitle="Zum Krug"
  />
);

export default ZumKrug;
