...
const Weinklang = () => (
  <RestaurantPage
    restaurantName="[w]einklang"
    address="Johannisstraße 130, Nuremberg, 90402, Germany"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+4991191947480"
    website="https://www.weinklang.co/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the northwest of Nuremberg, this chic little restaurant boasts a wonderfully cosy atmosphere. Here, owner and chef de cuisine Tomas Spanu, who has Sardinian-French heritage, serves a set menu comprising four or five courses – pleasingly streamlined and ingredient focused. Also available as a vegetarian menu option. The friendly and attentive service is the icing on the cake. You will want to keep coming back for more!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Johannisstra%C3%9Fe%20130%2C%20Nuremberg%2C%2090402%2C%20Germany"
    pageTitle="[w]einklang"
  />
);

export default Weinklang;
