...
const Waidwerk = () => (
  <RestaurantPage
    restaurantName="Waidwerk"
    address="Winterstraße 15, Nuremberg, 90431, Germany"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€€"
    phoneNumber="+49911612032"
    website="https://www.waidwerk-restaurant.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Winterstra%C3%9Fe%2015%2C%20Nuremberg%2C%2090431%2C%20Germany"
    pageTitle="Waidwerk"
  />
);

export default Waidwerk;
