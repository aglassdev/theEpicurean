...
const ZweisinnMeiersBistro = () => (
  <RestaurantPage
    restaurantName="ZweiSinn Meiers | Bistro"
    address="Äußere Sulzbacher Straße 118, Nuremberg, 90491, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4991192300823"
    website="https://www.meierszweisinn.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are looking for a really nice bistro in Nuremberg, this is the place! A pleasant, cultivated atmosphere, friendly service and good food await you here. At lunchtime, the reasonably priced daily special is always in demand. The fine dining restaurant located to the rear is very popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%84u%C3%9Fere%20Sulzbacher%20Stra%C3%9Fe%20118%2C%20Nuremberg%2C%2090491%2C%20Germany"
    pageTitle="ZweiSinn Meiers | Bistro"
  />
);

export default ZweisinnMeiersBistro;
