...
const ZweisinnMeiersFineDining = () => (
  <RestaurantPage
    restaurantName="ZweiSinn Meiers | Fine Dining"
    ...
    pageTitle="ZweiSinn Meiers | Fine Dining"
  />
);

export default ZweisinnMeiersFineDining;
