...
const PizarroFineDining = () => (
  <RestaurantPage
    restaurantName="Pizarro Fine Dining"
    address="Frankfurter Str. 13, Groß-Gerau, 64521, Germany"
    cuisine="Peruvian, International"
    priceRange="€€€€"
    phoneNumber="+491777447204"
    website="https://restaurant-pizarro.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy little restaurant is tastefully done out and has a laid-back feel. Modern artwork and wine racks add a touch of decorative flair, and the sleek open kitchen is a real focal point. In the kitchen, Julio Pizarro calls the shots; his creative cooking skilfully incorporates his Peruvian roots and many years' experience in international hospitality. This intriguing fusion is showcased in the Roots of Peru set menu, which presents an abundance of components and flavours. The meal commences at the same time for everyone, with each course served to all tables synchronously – you should plan around three hours for the whole experience. Julio Pizarro runs the restaurant with Marcel Dörflinger-Oster – their warm personalities and professionalism shine through as they guide you through your ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Frankfurter%20Str.%2013%2C%20Gro%C3%9F-Gerau%2C%2064521%2C%20Germany"
    pageTitle="Pizarro Fine Dining"
  />
);

export default PizarroFineDining;
