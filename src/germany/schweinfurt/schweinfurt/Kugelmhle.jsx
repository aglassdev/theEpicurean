...
const Kugelmhle = () => (
  <RestaurantPage
    restaurantName="Kugelmühle"
    address="Georg-Schäfer-Straße 30, Schweinfurt, 97421, Germany"
    cuisine="Classic French, Farm to table"
    priceRange="€€"
    phoneNumber="+499721914702"
    website="https://restaurant-kugelmuehle.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Max Matreux has been at the helm of this minimalist-style restaurant in the side wing of a factory since 2001. He is a strong advocate for sustainability, as is apparent in his classic cuisine, which features seasonal and regional ingredients. A three- to five-course set menu is proposed, as well as an à la carte selection. Tip: Ask about the Bib Gourmand set menu. Friendly and well-trained waitstaff...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Georg-Sch%C3%A4fer-Stra%C3%9Fe%2030%2C%20Schweinfurt%2C%2097421%2C%20Germany"
    pageTitle="Kugelmühle"
  />
);

export default Kugelmhle;
