...
const DieKrone = () => (
  <RestaurantPage
    ...
    address="Hauptstraße 30, Staufen im Breisgau, 79219, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+4976335840"
    website="https://www.die-krone-staufen.de/restaurant.php"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Volker Lahn continues the family tradition in the kitchen at Die Krone. The cosy Baden setting of the dining rooms is matched by good local Baden cooking. The seasonal fare is available in the form of a set menu or à la carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2030%2C%20Staufen%20im%20Breisgau%2C%2079219%2C%20Germany"
    pageTitle="Die Krone"
  />
);

export default DieKrone;
