...
const Ambiente = () => (
  <RestaurantPage
    restaurantName="Ambiente"
    address="Ballrechterstraße 8, Staufen im Breisgau, 79219, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+497633802442"
    website="https://restaurant-ambiente.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mathias and Melanie Luiz’s restaurant is in a small industrial area. He cooks with a Mediterranean note, which is also reflected in the bright, warm colours of the interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ballrechterstra%C3%9Fe%208%2C%20Staufen%20im%20Breisgau%2C%2079219%2C%20Germany"
    pageTitle="Ambiente"
  />
);
