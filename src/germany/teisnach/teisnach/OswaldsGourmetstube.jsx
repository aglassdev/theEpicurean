...
const OswaldsGourmetstube = () => (
  <RestaurantPage
    restaurantName="Oswald's Gourmetstube"
    address="Am Platzl 2, Teisnach, 94244, Germany"
    cuisine="Modern French, Contemporary"
    priceRange="€€€€"
    phoneNumber="+49992384100"
    website="https://www.hotel-oswald.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The culinary centrepiece at Hotel Oswald! This elegant fine dining restaurant is situated in the basement of the Landromantik Wellnesshotel Oswald located in Kaikenried, a Bavarian Forest village with a population of some 550 people. Thomas Gerber has been chef here since 2014, after holding a number of positions in renowned kitchens. His modern-inspired set menu comprises four to eight courses; classic in their foundations, the dishes are crafted with the utmost precision. The wonderfully fresh, perfectly glazed John Dory is a prime example of the subtlety with which he showcases top ingredients – covered with plenty of sliced Périgord truffle, the fish is accompanied by a light and airy celeriac purée and an intense Madeira sauce with a fine, perfectly harmonious sweetness. Choose a bott..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Platzl%202%2C%20Teisnach%2C%2094244%2C%20Germany"
    pageTitle="Oswald's Gourmetstube"
  />
);

export default OswaldsGourmetstube;
