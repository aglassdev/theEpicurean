...
const Krietsch = () => (
  <RestaurantPage
    restaurantName="Krietsch"
    address="Münstergasse 2, Schwäbisch Gmünd, 73525, Germany"
    cuisine="Farm to table, Country cooking"
    priceRange="€€"
    phoneNumber="+49717130003"
    website="https://restaurant-krietsch.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place used to be called Fuggerei – its name may have changed but it continues to be a great restaurant. At Krietsch, the cuisine is seasonal with a connection to the region, but it also draws on international influences. At lunchtime there are daily specials. Diners can sit inside, beneath the period vaulted ceiling, or out on the gorgeous terrace. Great location for a visit to the cathedral, which is just to the rear of the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BCnstergasse%202%2C%20Schw%C3%A4bisch%20Gm%C3%BCnd%2C%2073525%2C%20Germany"
    pageTitle="Krietsch"
  />
);

export default Krietsch;
