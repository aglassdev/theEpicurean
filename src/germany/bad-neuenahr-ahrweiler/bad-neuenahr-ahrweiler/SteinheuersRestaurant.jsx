...
const SteinheuersRestaurant = () => (
  <RestaurantPage
    restaurantName="Steinheuers Restaurant"
    ...
    bio="For years the dedicated Steinheuer family has been serving excellent food in a welcoming atmosphere; it's no wonder diners (many of them regulars) keep coming back for more. One draw is the opulent and elegant dining space, another is the superb pair of set menus prepared by Christian Binder, son-in-law of patron Hans Stefan Steinheuer. Pleasingly pared-back classic cuisine in which the outstanding main ingredient is accompanied by a few salient components. For example, the perfectly tender, top-quality skate comes with crispy caper berries, a tangy, intense lemon gel, savoury char caviar and leek straw, served on a slightly creamy sauce with a nice acidic note. Gabriele Steinheuer and daughter Désirée – a trained sommelier – head up the charming and competent front-of-house team. You can ..."
    ...
    pageTitle="Steinheuers Restaurant"
  />
);

export default SteinheuersRestaurant;
