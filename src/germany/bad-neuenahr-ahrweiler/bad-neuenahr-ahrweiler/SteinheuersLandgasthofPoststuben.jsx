...
const SteinheuersLandgasthofPoststuben = () => (
  <RestaurantPage
    restaurantName="Steinheuers Landgasthof Poststuben"
    address="Landskroner Straße 110, Bad Neuenahr-Ahrweiler, 53474, Germany"
    cuisine="Country cooking, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+49264194860"
    website="https://www.steinheuers.de/landgasthof-poststuben/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="By no means a lesser version of Steinheuer, this is a restaurant in its own right where everything is cooked fresh. Taking its cue from the seasons, the menu features regional classics and international dishes. The same well-stocked wine list is presented here as in the fine dining restaurant. Dine in the cosy interior, or head out to the delightful leafy terrace. For overnight stays, there are double rooms available in the main building, as well as a comfortable guesthouse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Landskroner%20Stra%C3%9Fe%20110%2C%20Bad%20Neuenahr-Ahrweiler%2C%2053474%2C%20Germany"
    pageTitle="Steinheuers Landgasthof Poststuben"
  />
);

export default SteinheuersLandgasthofPoststuben;
