...
const LandhausZumRssle = () => (
  <RestaurantPage
    restaurantName="Landhaus Zum Rössle"
    address="Zeilwiesen 5, Schwäbisch Hall, 74523, Germany"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+497912593"
    website="https://www.roessle-veinau.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Family tradition since 1780! Here the hospitality extended to diners is just as important as the tasty cuisine made from regional produce. Besides classic dishes, a surprise menu is also served. In summer the garden is a delight! There is a fantastic barn venue for parties. You can also stay overnight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zeilwiesen%205%2C%20Schw%C3%A4bisch%20Hall%2C%2074523%2C%20Germany"
    pageTitle="Landhaus Zum Rössle"
  />
);

export default LandhausZumRssle;
