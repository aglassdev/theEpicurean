...
const RebersPflug = () => (
  <RestaurantPage
    restaurantName="Rebers Pflug"
    address="Weckriedener Straße 2, Schwäbisch Hall, 74523, Germany"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+49791931230"
    website="https://www.rebers-pflug.de/startseite.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As soon as you enter the restaurant, you will pass the open kitchen, which is sure to whet your appetite. The menu is really wide-ranging, from regional classics such as Tafelspitz (beef boiled in broth) or Rostbraten (roast beef), to the set menu (Pflüg-Genießer-Menü) comprising three to six courses – these might include cod slices in saffron mussel broth, fennel kimchi, salted lemon and Duroc lardo. There is also a three- or four-course vegetarian tasting menu. And then there are the prized steaks! Naturally, chef-patron Hans-Harald Reber gets his excellent meat from his trusted butcher, who happens to be a second cousin of his. You can soak up the friendly and pleasantly informal atmosphere, safe in the knowledge you will be looked after attentively by the proficient front-of-house team..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weckriedener%20Stra%C3%9Fe%202%2C%20Schw%C3%A4bisch%20Hall%2C%2074523%2C%20Germany"
    pageTitle="Rebers Pflug"
  />
);

export default RebersPflug;
