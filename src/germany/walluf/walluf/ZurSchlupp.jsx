...
const ZurSchlupp = () => (
  <RestaurantPage
    restaurantName="Zur Schlupp"
    address="Hauptstraße 25, Walluf, 65396, Germany"
    cuisine="Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+49612372638"
    website="https://gasthauszurschlupp.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Ehrhardt family are passionate about their charming little restaurant, in a building dating back to 1608. The atmosphere is cosy, the cuisine fresh and in tune with the seasons – why not sample one of the fine wines from the region? Just don't forget to reserve. Our tip: the interior courtyard is a romantic spot in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2025%2C%20Walluf%2C%2065396%2C%20Germany"
    pageTitle="Zur Schlupp"
  />
);

export default ZurSchlupp;
