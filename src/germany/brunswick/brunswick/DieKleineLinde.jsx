...
const DieKleineLinde = () => (
  <RestaurantPage
    restaurantName="die kleine Linde"
    address="Humboldtstraße 27, Brunswick, 38106, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+4917662264460"
    website="https://diekleinelinde.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This compact restaurant started out in autumn 2024 as a pop-up serving dishes à la carte. Today, it opens its doors in the evenings to present modern and creative cuisine in the form of two exciting five- or seven-course set menus: Eine Rundreise and the vegetarian Botanischer Garten. At the helm in the kitchen, Valentin Thesing (previously at Aqua in Wolfsburg) crafts dishes such as egg, beetroot, spinach and pork jowl, carrot, carrot blossom honey – expect expression, finesse and a perfect balance of flavours, complemented by robust sauces and stocks. The restaurant is housed in the stately, lovingly renovated Jugendstil building of the Lindenhof. Historical details such as high ceilings and striking pillars, wood panelling, charming old windows and lovely herringbone hardwood flooring h..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Humboldtstra%C3%9Fe%2027%2C%20Brunswick%2C%2038106%2C%20Germany"
    pageTitle="die kleine Linde"
  />
);

export default DieKleineLinde;
