...
const Zucker = () => (
  <RestaurantPage
    restaurantName="Zucker"
    address="Frankfurter Straße 2, Brunswick, 38122, Germany"
    cuisine="Farm to table, Contemporary"
    priceRange="€€"
    phoneNumber="+49531281980"
    website="https://www.zucker-restaurant.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Frankfurter%20Stra%C3%9Fe%202%2C%20Brunswick%2C%2038122%2C%20Germany"
    pageTitle="Zucker"
  />
);

export default Zucker;
