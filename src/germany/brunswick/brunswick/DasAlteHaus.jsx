...
const DasAlteHaus = () => (
  <RestaurantPage
    restaurantName="Das Alte Haus"
    address="Alte Knochenhauerstraße 11, Brunswick, 38100, Germany"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+495316180100"
    website="https://www.altehaus.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enrico Dunkel and his small restaurant have been a well-established part of the city's culinary landscape for years. His cooking style is ambitious, creative and draws on international influences. The set menu can comprise five, six or seven courses. Choose your accompaniment from the extensive selection of fine German wines. There is also a pairing menu. The interior is modern yet cosy. In summer, the pretty terrace beckons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alte%20Knochenhauerstra%C3%9Fe%2011%2C%20Brunswick%2C%2038100%2C%20Germany"
    pageTitle="Das Alte Haus"
  />
);

export default DasAlteHaus;
