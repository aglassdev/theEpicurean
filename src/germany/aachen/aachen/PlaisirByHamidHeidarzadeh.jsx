...
const PlaisirByHamidHeidarzadeh = () => (
  <RestaurantPage
    restaurantName="plaisir by Hamid Heidarzadeh"
    address="Schlossstraße 16, Aachen, 52066, Germany"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+4924189464514"
    website="https://www.plaisiraachen.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The minimalist, elegant look immediately catches the eye, with its gorgeous terrazzo flooring, clean-lined, pared-back design in black and white, and high ceilings with stunning mouldings. Chef Hamid Heidarzadeh blends classic foundations and modern elements to interesting effect, incorporating subtle Asian and Mediterranean influences. Two set menus are available in a three- or five-course format – one vegetarian (Pflanzenfresser/-innen), one with meat (Fleischfresser/-innen). The names belie finely tuned and precisely crafted dishes with full-bodied taste profiles, such as the boldly seasoned tartare of Balfego tuna with hints of spiciness courtesy of jalapeno cream, and beautiful layers of acidity thanks to the vinegar mayonnaise, as well as the freshness of subtly sweet grapefruit ice ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlossstra%C3%9Fe%2016%2C%20Aachen%2C%2052066%2C%20Germany"
    pageTitle="plaisir by Hamid Heidarzadeh"
  />
);

export default PlaisirByHamidHeidarzadeh;
