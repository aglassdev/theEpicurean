...
const LandgasthofHirschen = () => (
  <RestaurantPage
    restaurantName="Landgasthof Hirschen"
    address="Wutachstraße 19, Hüfingen, 78183, Germany"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+49770799050"
    website="https://www.hirschen-mundelfingen.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dedication of chef Verena Martin and her team is palpable. In a charming setting diners enjoy cordial service and good food that is made primarily with produce from the region and draws inspiration from the seasons. The kitchen staff put their heart and soul into their work – the motto here is ä weng eppis Feins, or a little something fine in the local dialect. Tip: Unser badisches Menü or Unser großes Menü (for two or more people)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wutachstra%C3%9Fe%2019%2C%20H%C3%BCfingen%2C%2078183%2C%20Germany"
    pageTitle="Landgasthof Hirschen"
  />
);

export default LandgasthofHirschen;
