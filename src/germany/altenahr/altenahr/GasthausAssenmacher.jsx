...
const GasthausAssenmacher = () => (
  <RestaurantPage
    restaurantName="Gasthaus Assenmacher"
    address="Brückenstraße 12, Altenahr, 53505, Germany"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+4926431848"
    website="https://assenmacher-altenahr.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's clear that Christian and Christa Storch put their heart and soul into running this place. The chef-patron wins over diners with his modern take on classic cuisine. Eschewing any gimmickry, he lays the focus squarely on quality produce and flavour. The lady of the house manages the friendly and attentive waitstaff. Pleasant little terrace to the rear of the building. Decent accommodation options at the hotel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Br%C3%BCckenstra%C3%9Fe%2012%2C%20Altenahr%2C%2053505%2C%20Germany"
    pageTitle="Gasthaus Assenmacher"
  />
);

export default GasthausAssenmacher;
