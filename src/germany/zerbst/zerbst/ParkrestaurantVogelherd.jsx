...
const ParkrestaurantVogelherd = () => (
  <RestaurantPage
    restaurantName="Park-Restaurant Vogelherd"
    address="Lindauer Straße 78, Zerbst, 39264, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+493923780444"
    website="https://guide.michelin.com/en/sachsen-anhalt/zerbst/restaurant/park-restaurant-vogelherd"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Quality restaurant in a former manor house famous for its good seasonal cuisine. You can also dine on the attractive terrace alongside a small pond...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lindauer%20Stra%C3%9Fe%2078%2C%20Zerbst%2C%2039264%2C%20Germany"
    pageTitle="Park-Restaurant Vogelherd"
  />
);

export default ParkrestaurantVogelherd;
