...
const Rebstock = () => (
  <RestaurantPage
    restaurantName="Rebstock"
    address="Halbgütle 30, Durbach, 77770, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+497814820"
    website="https://www.rebstock-durbach.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rebstock offers comfortable, country-style dining rooms, attentive service and good regional fare including snail soup, pike dumplings and venison ragout. In summer the idyllic terrace offers views of the surrounding parkland and the Black Forest, while another attraction is the large selection of home-made cakes and pastries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Halbg%C3%BCtle%2030%2C%20Durbach%2C%2077770%2C%20Germany"
    pageTitle="Rebstock"
  />
);

export default Rebstock;
