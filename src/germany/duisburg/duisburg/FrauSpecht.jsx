...
const FrauSpecht = () => (
  <RestaurantPage
    restaurantName="Frau Specht"
    address="Hohe Straße 19, Duisburg, 47051, Germany"
    cuisine="Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+491727935547"
    website="https://frauspecht-weinbar.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dinner is ready is the slogan here. You ring the doorbell before being escorted into this somewhat hidden little restaurant with a modern, minimalist decor. You are shown to your table in a pleasantly intimate living room-style interior – with a small open kitchen and just a handful of tables, it makes for a private atmosphere. The service comes with a personal touch: your cordial hostess, Yvonne Specht, after whom the restaurant is named, will also recommend just the right wines from the extensive list of top-draw international labels. In the kitchen, head chef Dirk Brendel cooks up an ambitious seven-course surprise menu in the evening, further embellishing it with a variety of additional small dishes. The menu is devised based on the season and the availability of the ingredients. The c..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hohe%20Stra%C3%9Fe%2019%2C%20Duisburg%2C%2047051%2C%20Germany"
    pageTitle="Frau Specht"
  />
);

export default FrauSpecht;
