...
const KppersmhleRestaurant = () => (
  <RestaurantPage
    restaurantName="Küppersmühle Restaurant"
    address="Philosophenweg 49, Duisburg, 47051, Germany"
    cuisine="Modern Cuisine, International"
    priceRange="€€€"
    phoneNumber="+492035188880"
    website="https://kueppersmuehle-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fantastic location with an old industrial atmosphere, view of the inner harbour, and terrace right next to the water. This urban-style interior is the backdrop for modern cuisine with classic and international influences, served as fresh and precisely cooked dishes. Slightly simpler menu at lunchtime. Küppersmühle Museum of Modern Art next door is worth a visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Philosophenweg%2049%2C%20Duisburg%2C%2047051%2C%20Germany"
    pageTitle="Küppersmühle Restaurant"
  />
);

export default KppersmhleRestaurant;
