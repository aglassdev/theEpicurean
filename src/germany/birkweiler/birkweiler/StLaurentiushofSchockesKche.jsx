...
const StLaurentiushofSchockesKche = () => (
  <RestaurantPage
    restaurantName="St. Laurentiushof - Schockes Küche"
    address="Hauptstraße 21, Birkweiler, 76831, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+4963459199431"
    website="https://schockes-laurentiushof.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2021%2C%20Birkweiler%2C%2076831%2C%20Germany"
    pageTitle="St. Laurentiushof - Schockes Küche"
  />
);

export default StLaurentiushofSchockesKche;
