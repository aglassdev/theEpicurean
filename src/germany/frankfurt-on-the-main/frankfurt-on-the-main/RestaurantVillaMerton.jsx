...
const RestaurantVillaMerton = () => (
  <RestaurantPage
    restaurantName="Restaurant Villa Merton"
    ...
    pageTitle="Restaurant Villa Merton"
  />
);

export default RestaurantVillaMerton;
