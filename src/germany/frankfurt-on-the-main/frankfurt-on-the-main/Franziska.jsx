...
const Franziska = () => (
  <RestaurantPage
    restaurantName="Franziska"
    address="Hainer Weg 72, Frankfurt on the Main, 60599, Germany"
    cuisine="Seasonal Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+496966377640"
    website="https://www.mook-group.de/franziska"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It takes 40 seconds in the lift up to the top of the Henninger Turm. As well as its magnificent views over the Frankfurt skyline, this restaurant proposes Progressive German Vintage Cuisine. The name is a tribute to the great-aunt of the Mook Group founder. Cocktails in the Barrel Bar. Terrace one floor down. Online bookings only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hainer%20Weg%2072%2C%20Frankfurt%20on%20the%20Main%2C%2060599%2C%20Germany"
    pageTitle="Franziska"
  />
);

export default Franziska;
