...
const BistroVillaMerton = () => (
  <RestaurantPage
    restaurantName="Bistro Villa Merton"
    address="Am Leonhardsbrunn 12, Frankfurt on the Main, 60487, Germany"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+4969703033"
    website="https://restaurant-villa-merton.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located just outside Frankfurt, north of the Palmengarten, Bistro Villa Merton is a lovely alternative to the fine dining restaurant. While the latter welcomes diners in the evening, the bistro is only open at lunchtime. In the spruce villa built in neo-Baroque style, you can take a seat in an inviting decor done out with an elegant touch to enjoy high-quality regional and international cuisine infused with seasonal influences. An appealing lunchtime set menu is on offer, as well as several à la carte options. The appetising dishes include breast and leg of guinea fowl and classics such as Wiener schnitzel made with veal. Excellent wine recommendations are to be had from the friendly and knowledgeable front-of-house team. Tip: There is a fantastic selection of champagnes. The terrace is al..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Leonhardsbrunn%2012%2C%20Frankfurt%20on%20the%20Main%2C%2060487%2C%20Germany"
    pageTitle="Bistro Villa Merton"
  />
);

export default BistroVillaMerton;
