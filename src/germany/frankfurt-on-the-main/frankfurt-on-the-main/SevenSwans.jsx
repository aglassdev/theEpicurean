...
const SevenSwans = () => (
  <RestaurantPage
    restaurantName="Seven Swans"
    address="Mainkai 4, Frankfurt on the Main, 60311, Germany"
    cuisine="Vegan, Creative"
    priceRange="€€€€"
    phoneNumber="+496921996226"
    website="https://www.sevenswans.de/"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mainkai%204%2C%20Frankfurt%20on%20the%20Main%2C%2060311%2C%20Germany"
    pageTitle="Seven Swans"
  />
);

export default SevenSwans;
