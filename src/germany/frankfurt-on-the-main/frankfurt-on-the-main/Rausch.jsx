...
const Rausch = () => (
  <RestaurantPage
    restaurantName="RAUSCH"
    address="Reuterweg 57, Frankfurt on the Main, 60323, Germany"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+496966817701"
    website="https://rauschrauschrausch.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jochim Busch has established RAUSCH on the premises that used to house Gustav, the restaurant in which he made a name for himself with his MICHELIN-starred cuisine. Here, he serves up accessible modern food. The bold dishes are notable for their contrasting flavours, always judiciously pared back, and the ingredients are of excellent quality. This approach is evident, for instance, in the super-fresh and tender raw marinated white prawns accompanied by an aromatic buttermilk emulsion enriched with crisp salted cucumber brunoise and the citrus aromas of grand fir tree. The chef serves up a four- or five-course set menu, with two additional dishes to choose from. From some tables in the chic and minimalist space, the open kitchen is visible. Service is laid-back and attentive, with staff alw..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reuterweg%2057%2C%20Frankfurt%20on%20the%20Main%2C%2060323%2C%20Germany"
    pageTitle="RAUSCH"
  />
);

export default Rausch;
