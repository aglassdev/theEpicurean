...
const Lafleur = () => (
  <RestaurantPage
    restaurantName="Lafleur"
    address="Palmengartenstraße 11, Frankfurt on the Main, 60325, Germany"
    cuisine="Modern French, Creative"
    priceRange="€€€€"
    phoneNumber="+496990029100"
    website="https://www.restaurant-lafleur.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Andreas Krolik has been synonymous with fantastic vegan cuisine for years. Here in the Palmenhaus, adjacent to the Palmengarten, the chef creatively combines top-notch ingredients by virtue of extremely precise craftsmanship. His style is modern, yet rooted in classic culinary tradition. For example, the happy marriage of John Dory and Norwegian scallops, with a nutty macadamia crunch, sweet and sour pointed cabbage, firm pumpkin and the exotic touch of a curry-lemongrass sauce, is delicious. In the evening, two set menus are served: Grands Produits with meat and fish, and Ethical Vegan Cuisine a testament to the chef's passion for plant-based cuisine. At lunchtime, there are two appealing set menus, dubbed Casual and Casual Green, each with three or four courses. Service comes courtesy of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Palmengartenstra%C3%9Fe%2011%2C%20Frankfurt%20on%20the%20Main%2C%2060325%2C%20Germany"
    pageTitle="Lafleur"
  />
);

export default Lafleur;
