...
const FrankfurterBotschaft = () => (
  <RestaurantPage
    restaurantName="Frankfurter Botschaft"
    address="Westhafenplatz 6, Frankfurt on the Main, 60327, Germany"
    cuisine="International, Asian Influences"
    priceRange="€€"
    phoneNumber="+496915342522"
    website="https://www.frankfurterbotschaft.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A really cool location - the spot directly on the Westhafen makes the terrace a real highlight! But it's also pleasant to sit in the smartly decorated interior; windows on all sides mean you also have a view of the water from here. The food is international. Furthermore, they also offer valet parking - it's best to put in your request when you make your reservation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Westhafenplatz%206%2C%20Frankfurt%20on%20the%20Main%2C%2060327%2C%20Germany"
    pageTitle="Frankfurter Botschaft"
  />
);

export default FrankfurterBotschaft;
