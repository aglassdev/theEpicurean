...
const MasaJapaneseCuisine = () => (
  <RestaurantPage
    restaurantName="Masa Japanese Cuisine"
    address="Hanauer Landstraße 131, Frankfurt on the Main, 60314, Germany"
    cuisine="Japanese, Japanese Contemporary"
    priceRange="€€€€"
    phoneNumber="+496960666247"
    website="https://masa-frankfurt.de"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A hotspot for Japanese cuisine is hidden away in this unassuming town house in Frankfurt's Ostend neighbourhood. Having recently expanded his skill set and his knowledge of the Japanese culinary arts in both of Yoshizumi Nagaya's Düsseldorf restaurants, Masaru Oae now proposes two omakase menus composed of seven or nine courses – one with fish/meat, one vegetarian. The quality of the ingredients is second to none. Dishes such as scallops, kale, dashi butter sauce, as well as the excellent sushi, successfully draw on both classic and modern Japanese cuisine, while remaining open to the odd European influence. The aesthetics of the food have a major part to play too, as demonstrated by the elaborately decorated medley of starters. In an unpretentious and pared-back setting that evokes the Fa..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hanauer%20Landstra%C3%9Fe%20131%2C%20Frankfurt%20on%20the%20Main%2C%2060314%2C%20Germany"
    pageTitle="Masa Japanese Cuisine"
  />
);

export default MasaJapaneseCuisine;
