...
const ChristiansRestaurantGasthofGrainer = () => (
  <RestaurantPage
    restaurantName="Christian's Restaurant - Gasthof Grainer"
    address="Dorfstraße 1, Kirchdorf, 83527, Germany"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+4980728510"
    website="https://christians-restaurant.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Grainer family has run this stately historical inn since the 16C. Christian F Grainer and his wife Christiane have established an upscale and tastefully designed space, combining classic style with understated modern accents. Your charming and cordial hostess puts her heart and soul into providing first-class service with a very personal touch. The chef-patron's cooking is rooted in classical French tradition, though he occasionally incorporates culinary impressions from his travels. A case in point is his pairing of Simmental beef fillet, stuffed morels, red wine sauce and celeriac purée with a spicy tom yum soup with Gillardeau oysters. Top-quality ingredients are showcased in a surprise menu. Christiane Grainer is also a sommelier and has plenty of excellent wine recommendations at ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstra%C3%9Fe%201%2C%20Kirchdorf%2C%2083527%2C%20Germany"
    pageTitle="Christian's Restaurant - Gasthof Grainer"
  />
);

export default ChristiansRestaurantGasthofGrainer;
