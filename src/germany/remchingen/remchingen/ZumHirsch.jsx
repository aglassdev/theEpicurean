...
const ZumHirsch = () => (
  <RestaurantPage
    restaurantName="Zum Hirsch"
    address="Hauptstraße 23, Remchingen, 75196, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+49723279636"
    website="https://www.hirsch-remchingen.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming half-timbered inn dates back to 1688. In winter you can sit in the pretty room dominated by the fireplace, in summer on the attractive terrace. On the menu, for example, roasted & braised venison from local hunting in venison pepper jus with celery, mole & apricot. At lunchtime there is reasonably priced three-course Eat & Talk set menu. Guestrooms for a pleasant overnight stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2023%2C%20Remchingen%2C%2075196%2C%20Germany"
    pageTitle="Zum Hirsch"
  />
);

export default ZumHirsch;
