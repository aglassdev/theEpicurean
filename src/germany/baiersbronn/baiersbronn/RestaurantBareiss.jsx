...
const RestaurantBareiss = () => (
  <RestaurantPage
    restaurantName="Restaurant Bareiss"
    ...
    pageTitle="Restaurant Bareiss"
  />
);

export default RestaurantBareiss;
