...
const Schwarzwaldstube = () => (
  <RestaurantPage
    restaurantName="Schwarzwaldstube"
    ...
    pageTitle="Schwarzwaldstube"
  />
);

export default Schwarzwaldstube;
