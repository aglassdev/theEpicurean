...
const GutshausKubbelkow = () => (
  <RestaurantPage
    restaurantName="Gutshaus Kubbelkow"
    address="Im Dorfe 8, Klein Kubbelkow, 18528, Germany"
    cuisine="International"
    priceRange="€€€"
    phoneNumber="+4938388227777"
    website="https://www.kubbelkow.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its smart façade and stylish dining rooms, this listed manor house set in wonderfully peaceful grounds has lost nothing of its 1908 charm. It serves fresh, ambitious cuisine including lagoon-fished zander with jellied bouillabaisse broth and pan-fried asparagus. The idyllic location makes the tasteful upmarket guestrooms dotted with antique furniture all the more inviting, as does the excellent breakfast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Im%20Dorfe%208%2C%20Klein%20Kubbelkow%2C%2018528%2C%20Germany"
    pageTitle="Gutshaus Kubbelkow"
  />
);

export default GutshausKubbelkow;
