...
const LandgasthofZumMller = () => (
  <RestaurantPage
    restaurantName="Landgasthof zum Müller"
    address="Passauer Straße 16, Ruderting, 94161, Germany"
    cuisine="Regional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+4985091224"
    website="https://www.landgasthofzummueller.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At their established country inn, Ingrid and Markus Buchner serve fresh regional and seasonal cuisine with international and Mediterranean influences – responsible for this is chef Marcel von Winckelmann. The service is friendly and cordial, the rustic-style restaurant rooms are inviting, and the leafy terrace with its small open barn (Salettl) is delightful. They have modern rural-style guestrooms, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Passauer%20Stra%C3%9Fe%2016%2C%20Ruderting%2C%2094161%2C%20Germany"
    pageTitle="Landgasthof zum Müller"
  />
);

export default LandgasthofZumMller;
