...
const SushiLounge = () => (
  <RestaurantPage
    ...
    cuisine="Sushi"
    priceRange="€€€"
    phoneNumber="+4961318015477"
    website="https://favorite-mainz.de/sushi-lounge/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The latest culinary hotspot at FAVORITE Parkhotel is a restaurant within a restaurant! Sushi lounge is located inside the hotel's Weinbar. Only sushi and sashimi are on the menu in this compact space, and everything is made with the finest produce – something for which FAVORITE Restaurant also has a reputation. Must-try nigiri: otoro for melt-in-your-mouth richness, scallops for pristine freshness or unagi for bold umami...."
    ...
    pageTitle="sushi Lounge"
  />
);

export default SushiLounge;
