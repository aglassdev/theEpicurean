...
const DieBurgFineDining = () => (
  <RestaurantPage
    restaurantName="die burg - fine dining"
    address="Burgring 6, Donaueschingen, 78166, Germany"
    cuisine="Farm to table, Country cooking"
    priceRange="€€€"
    phoneNumber="+4977117510050"
    website="https://www.burg-aasen.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Grom brothers run their restaurant in the centre of this small town. As part of the highly professional front-of-house team, sommelier Niklas provides astute recommendations from the impressive wine list. Meanwhile, Jason presides in the kitchen, cooking up ambitious modern dishes. There is a choice of two set menus: burg and the vegetarian gartenliebe, with all courses also available individually. Tempting dishes include creamy Parmigiano Reggiano ravioli with grilled leek and rum-soaked raisins. Classics such as Zwiebelrostbraten (steak with onions and gravy) and Wiener schnitzel can be ordered à la carte. The charcoal-grilled dry-aged cuts of meat from the neighbouring Leimgrabenhof farm are also highly recommended. Characterised by premium materials and chic, minimalist design, the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burgring%206%2C%20Donaueschingen%2C%2078166%2C%20Germany"
    pageTitle="die burg - fine dining"
  />
);

export default DieBurgFineDining;
