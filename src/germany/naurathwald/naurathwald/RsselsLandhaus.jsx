...
const RsselsLandhaus = () => (
  <RestaurantPage
    restaurantName="Rüssel's Landhaus"
    address="Büdlicherbrück 1, Naurath/Wald, 54426, Germany"
    cuisine="Creative, Farm to table"
    priceRange="€€€€"
    phoneNumber="+49650991400"
    website="https://www.ruessels-landhaus.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The charm of this country house makes itself felt as you approach via a small bridge – it is safe to say the character of the idyllic old mill has been successfully preserved! Ruth and Harald Rüssel clearly put their heart and soul into running their hotel and restaurant. The chef-patron and his talented kitchen team propose a five- to seven-course set menu. Diners are won over by the quality of the ingredients, which they prefer to source from local producers; they even hunt their own game. The classical foundations of the cuisine always shine through, but are elegantly complemented by creative flourishes that never come across as fussy or unnecessary. Try out the surprising wine pairings – they tend to recommend fine Moselle wines. Head to the terrace to sit by a small lake! They also ha..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B%C3%BCdlicherbr%C3%BCck%201%2C%20Naurath%2FWald%2C%2054426%2C%20Germany"
    pageTitle="Rüssel's Landhaus"
  />
);

export default RsselsLandhaus;
