...
const RsselsHasenpfeffer = () => (
  <RestaurantPage
    restaurantName="Rüssel's Hasenpfeffer"
    ...
    pageTitle="Rüssel's Hasenpfeffer"
  />
);

export default RsselsHasenpfeffer;
