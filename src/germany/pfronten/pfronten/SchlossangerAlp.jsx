...
const SchlossangerAlp = () => (
  <RestaurantPage
    restaurantName="Schlossanger Alp"
    ...
    pageTitle="Schlossanger Alp"
  />
);

export default SchlossangerAlp;
