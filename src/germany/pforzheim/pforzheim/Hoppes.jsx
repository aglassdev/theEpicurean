...
const Hoppes = () => (
  <RestaurantPage
    restaurantName="Hoppe's"
    address="Weiherstraße 15, Pforzheim, 75173, Germany"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+497231105776"
    website="http://www.hoppes-pforzheim.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The atmosphere is welcoming and lively, and the food is great – it's no wonder that people come back again and again. The menu features dishes from Alsace and Baden, with mouthwatering options such as coq au vin à la chef, beef sirloin served with roasted onions and spaetzle, or Baden-style pike dumplings. They also do Flammkuchen. There is outdoor seating to the front of the building...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weiherstra%C3%9Fe%2015%2C%20Pforzheim%2C%2075173%2C%20Germany"
    pageTitle="Hoppe's"
  />
);

export default Hoppes;
