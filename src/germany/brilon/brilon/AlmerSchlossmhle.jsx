...
const AlmerSchlossmhle = () => (
  <RestaurantPage
    restaurantName="Almer Schlossmühle"
    address="Schlossstraße 13, Brilon, 59929, Germany"
    cuisine="Seasonal Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+4929649451430"
    website="https://www.almer-schlossmuehle.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This carefully converted old mill next to the little Schloss Alme is a highly appealing restaurant that abounds with rustic charm. The delicious food features seasonal dishes from the regional repertoire as well as classic fare from the chef's native Austria. Head for the lovely terrace in fine weather. There are also guestrooms for an overnight stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlossstra%C3%9Fe%2013%2C%20Brilon%2C%2059929%2C%20Germany"
    pageTitle="Almer Schlossmühle"
  />
);

export default AlmerSchlossmhle;
