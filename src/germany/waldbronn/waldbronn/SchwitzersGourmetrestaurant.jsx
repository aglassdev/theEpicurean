...
const SchwitzersGourmetrestaurant = () => (
  <RestaurantPage
    restaurantName="Schwitzer's Gourmet-Restaurant"
    ...
    pageTitle="Schwitzer's Gourmet-Restaurant"
  />
);

export default SchwitzersGourmetrestaurant;
