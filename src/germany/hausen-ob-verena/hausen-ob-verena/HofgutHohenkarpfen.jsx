...
const HofgutHohenkarpfen = () => (
  <RestaurantPage
    restaurantName="Hofgut Hohenkarpfen"
    address="Hohenkarpfen 1, Hausen ob Verena, 78595, Germany"
    cuisine="International, Farm to table"
    priceRange="€€€"
    phoneNumber="+4974249450"
    website="https://www.hohenkarpfen.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hohenkarpfen%201%2C%20Hausen%20ob%20Verena%2C%2078595%2C%20Germany"
    pageTitle="Hofgut Hohenkarpfen"
  />
);

export default HofgutHohenkarpfen;
