...
const EsszimmerImOberschwbischenHof = () => (
  <RestaurantPage
    restaurantName="Esszimmer im Oberschwäbischen Hof"
    address="Hauptstrasse 9, Schwendi, 88477, Germany"
