...
const SetteFeinbistro = () => (
  <RestaurantPage
    restaurantName="Sette Feinbistro"
    address="Marktstraße 7, Elmshorn, 25335, Germany"
    cuisine="International, Farm to table"
    priceRange="€€"
    phoneNumber="+494121262939"
    website="https://www.sette-feinbistro.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Somewhat tucked away in the pedestrian precinct, this gem has been run with great dedication by the Tegge family for many years. The name Feinbistro encompasses both a delicatessen and a restaurant serving Mediterranean and regional cuisine. Breakfast is also available. Don't forget to purchase delicacies such as jam, cheese and wine etc from the shop to enjoy at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktstra%C3%9Fe%207%2C%20Elmshorn%2C%2025335%2C%20Germany"
    pageTitle="Sette Feinbistro"
  />
);

export default SetteFeinbistro;
