...
const Falconera = () => (
  <RestaurantPage
    restaurantName="Falconera"
    address="Zum Mühlental 1, Öhningen, 78337, Germany"
    cuisine="Classic French, Farm to table"
    priceRange="€€€"
    phoneNumber="+4977352340"
    website="https://falconera.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zum%20M%C3%BChlental%201%2C%20%C3%96hningen%2C%2078337%2C%20Germany"
    pageTitle="Falconera"
  />
);

export default Falconera;
