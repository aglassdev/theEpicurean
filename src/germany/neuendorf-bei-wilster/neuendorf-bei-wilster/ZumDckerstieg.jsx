...
const ZumDckerstieg = () => (
  <RestaurantPage
    restaurantName="Zum Dückerstieg"
    address="Dückerstieg 7, Neuendorf bei Wilster, 25554, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+49482392929"
    website="https://www.dueckerstieg.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pretty and cosy restaurant with rural flair, serving seasonal and regional cuisine. Here, you can look forward to flavoursome dishes that pack a punch. The extensive menu features mouthwatering options such as pan-seared char fillet on asparagus and potato ragout, the classic cold roast beef with remoulade, pan-fried potatoes and salad, or the smoked braised meat and medium-rare rump of Holstein beef on a bed of potato and root vegetables. Be sure to save some room for dessert, too. Steeped in tradition, this family-run business – now in its fourth generation – also has attractive, comfortable guestrooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D%C3%BCckerstieg%207%2C%20Neuendorf%20bei%20Wilster%2C%2025554%2C%20Germany"
    pageTitle="Zum Dückerstieg"
  />
);

export default ZumDckerstieg;
