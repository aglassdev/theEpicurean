...
const ImSchiffchen = () => (
  <RestaurantPage
    restaurantName="Im Schiffchen"
    address="Kaiserswerther Markt 9, Düsseldorf, 40489, Germany"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+49211401050"
    website="https://im-schiffchen.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If we're talking about Michelin-starred cuisine in a beautiful Baroque brick building on Kaiserswerther Markt, we can only be talking about Jean-Claude Bourgueil's Im Schiffchen. At the helm since 1977, he is without a doubt the doyen of Düsseldorf's fine dining scene. Together with his tried-and-trusted kitchen team, Bourgueil delivers creative French cuisine. Whether it be lobster, game or Wagyu beef, the produce is of the finest quality. To complete the picture, there's the impressive selection of wines, the attentive and well-trained wait staff and the gorgeous decor – this ground-floor restaurant has a tasteful maritime look...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kaiserswerther%20Markt%209%2C%20D%C3%BCsseldorf%2C%2040489%2C%20Germany"
    pageTitle="Im Schiffchen"
  />
);

export default ImSchiffchen;
