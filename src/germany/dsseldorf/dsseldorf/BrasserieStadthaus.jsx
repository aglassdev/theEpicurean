...
const BrasserieStadthaus = () => (
  <RestaurantPage
    restaurantName="Brasserie Stadthaus"
    address="Mühlenstraße 31, Düsseldorf, 40213, Germany"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+4921116092815"
    website="https://brasserie-stadthaus.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive brasserie with its striking high coffered ceiling and pretty interior courtyard promises a genuine French dining experience. Try the tourte de queue de boeuf (oxtail pie) or the seafood platter followed by the tarte au citron. All the wines are French...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BChlenstra%C3%9Fe%2031%2C%20D%C3%BCsseldorf%2C%2040213%2C%20Germany"
    pageTitle="Brasserie Stadthaus"
  />
);

export default BrasserieStadthaus;
