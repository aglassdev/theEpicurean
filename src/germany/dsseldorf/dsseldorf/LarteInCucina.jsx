...
const LarteInCucina = () => (
  <RestaurantPage
    restaurantName="L'arte in cucina"
    address="Gerricusplatz 6, Düsseldorf, 40625, Germany"
    cuisine="Italian, Tuscan"
    priceRange="€€€"
    phoneNumber="+4921152039590"
    website="https://www.arteincucina.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant opposite the Basilika St. Margareta is a rare example of an authentic Italian ristorante, where the cuisine of Tuscany is served with love and culinary flair. Specialities from the chef's Tuscan homeland such as gnudi (a kind of gnocchi) or Il Coniglio (rabbit). The pasta is house-made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gerricusplatz%206%2C%20D%C3%BCsseldorf%2C%2040625%2C%20Germany"
    pageTitle="L'arte in cucina"
  />
);

export default LarteInCucina;
