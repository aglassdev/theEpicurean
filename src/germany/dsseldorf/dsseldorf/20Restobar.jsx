...
const TwoZeroRestobar = () => (
  <RestaurantPage
    restaurantName="20° RESTOBAR"
    address="Mutter-Ey-Platz 3, Neubrückstraße, Düsseldorf, 40213, Germany"
    cuisine="Spanish Contemporary"
    priceRange="€€"
    phoneNumber="+491728902320"
    website="https://www.20grad.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern, unpretentious restaurant with a terrace, bar and lovely inner courtyard is located in the centre of town. In a pleasantly lively atmosphere, you can enjoy Spanish-Mediterranean cuisine: in addition to fish, meat, rice and potato dishes, you will of course also find tapas, croquetas and the like. In keeping with the Mediterranean concept, the name refers to the average water temperature around the island of Mallorca...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mutter-Ey-Platz%203%2C%20Neubr%C3%BCckstra%C3%9Fe%2C%20D%C3%BCsseldorf%2C%2040213%2C%20Germany"
    pageTitle="20° RESTOBAR"
  />
);

export default TwoZeroRestobar;
