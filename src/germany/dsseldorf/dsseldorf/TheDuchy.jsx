...
const TheDuchy = () => (
  <RestaurantPage
    restaurantName="The Duchy"
    address="Königsallee 11, Düsseldorf, 40212, Germany"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+4921116090500"
    website="https://www.theduchy-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the first floor of the luxurious Breidenbacher Hof, overlooking Heinrich-Heine-Allee, this is an elegant brasserie. The cuisine is a broad mix, from sashimi and ceviche to beef tartare or ravioli, not to mention the steaks. They set great store by the origin of their ingredients, working with regional producers – and they keep their own chickens and cows. Decent wine selection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=K%C3%B6nigsallee%2011%2C%20D%C3%BCsseldorf%2C%2040212%2C%20Germany"
    pageTitle="The Duchy"
  />
);

export default TheDuchy;
