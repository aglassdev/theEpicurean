...
const Staudis = () => (
  <RestaurantPage
    restaurantName="Staudi's"
    address="Münsterstraße 115, Düsseldorf, 40476, Germany"
    cuisine="Contemporary, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+4921115875065"
    website="https://www.staudisrestaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once a butcher's, now a really pretty little restaurant with a bistro feel. Decorative relics of the past such as tiled floors and stained glass in the ceiling make for a charming interior. Diners also enjoy cordial service and modern, seasonal dishes, served in the form of a four-, five-, or six-course tasting menu. A vegetarian alternative is available, too. Then there is the supplementary tapas menu, served from June to September. In good weather, you can make the most of the lovely terrace laid out in front of the restaurant. The Stube can be booked as a separate room for private events (Nov-Mar)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BCnsterstra%C3%9Fe%20115%2C%20D%C3%BCsseldorf%2C%2040476%2C%20Germany"
    pageTitle="Staudi's"
  />
);

export default Staudis;
