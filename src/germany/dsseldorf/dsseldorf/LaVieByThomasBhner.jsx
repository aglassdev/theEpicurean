...
const LaVieByThomasBhner = () => (
  <RestaurantPage
    restaurantName="LA VIE by thomas bühner"
    address="Schlüterstraße 1, Düsseldorf, 40235, Germany"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+4915172385555"
    website="https://laviebythomasbuehner.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="None other than Thomas Bühner – who for years has been at the forefront of Germany's gastronomy scene with his restaurant La Vie in Osnabrück – has now opened his new LA VIE on the urban METRO Campus in Düsseldorf. Here, too, he has called on the services of head chef Timo Fritsche. Twin evening set menus – one omnivore, the other vegan – combine top-quality regional ingredients with French and Asian influences. Signature dishes such as cod with saffron broth enjoy an encore on the menu. Lunch is also available at the weekend. The tasteful and swish interior designed by the architectural firm Kitzig Design Studios combines elegant simplicity with a soothing colour palette of warm hues – the large-windowed kitchen, neatly integrated into the restaurant room, draws the eye. A second La Vie b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schl%C3%BCterstra%C3%9Fe%201%2C%20D%C3%BCsseldorf%2C%2040235%2C%20Germany"
    pageTitle="LA VIE by thomas bühner"
  />
);

export default LaVieByThomasBhner;
