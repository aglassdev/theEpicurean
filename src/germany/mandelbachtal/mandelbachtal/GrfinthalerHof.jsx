...
const GrfinthalerHof = () => (
  <RestaurantPage
    restaurantName="Gräfinthaler Hof"
    address="Gräfinthal 6, Mandelbachtal, 66399, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+49680491100"
    website="https://www.graefinthaler-hof.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this somewhat more remote part of the Bliesgau region, you will feel most welcome in this gorgeous location that was once home to a monastery complex dating back to the 13C. Inside, an elegant atmosphere prevails; outside, there is a charming terrace shaded by trees. Ambitious dishes are created with terrific ingredients – the roast dry-aged pork chop (matured on the bone for 21 days), with sage, Serrano ham, market vegetables and potato fritters, for example, is a wonderful meat option. There are two set menus – one meat, one vegetarian – or you can dine à la carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gr%C3%A4finthal%206%2C%20Mandelbachtal%2C%2066399%2C%20Germany"
    pageTitle="Gräfinthaler Hof"
  />
);

export default GrfinthalerHof;
