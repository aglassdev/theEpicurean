...
const ZumGoldenenAnker = () => (
  <RestaurantPage
    restaurantName="Zum Goldenen Anker"
    address="Hauptstraße 16, Eggenstein-Leopoldshafen, 76344, Germany"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+49721706029"
    website="https://hotel-anker-eggenstein.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not only does this 18C hotel offer a comfortable stay (opt for one of the newer guestrooms), it is also a popular modern take on a rural restaurant. Diners are waited on by a friendly front-of-house team in an attractive modern setting with a rustic touch. The food is flavoursome, fresh and seasonal. The main courses are also available in smaller portions. In summer, make a beeline for the gorgeous terrace to the rear of the building...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2016%2C%20Eggenstein-Leopoldshafen%2C%2076344%2C%20Germany"
    pageTitle="Zum Goldenen Anker"
  />
);

export default ZumGoldenenAnker;
