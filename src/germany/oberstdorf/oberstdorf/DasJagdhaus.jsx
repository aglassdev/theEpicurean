...
const DasJagdhaus = () => (
  <RestaurantPage
    restaurantName="Das Jagdhaus"
    address="Ludwigstraße 13, Oberstdorf, 87561, Germany"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+498322987380"
    website="https://www.das-jagdhaus.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Built in 1856, this charming timber house with three dining areas is a really pleasant alternative to the other restaurants run by the Bolkart-Fetz family in Oberstdorf. Only ingredients sourced from within Germany – and preferably from the region – go into the dishes on the traditional menu, including some excellent game options. As well as the three- or four-course Prinzregentenmenü, there is a range of à la carte dishes to choose from. Very nice selection of wines. Head for the lovely beer garden shaded by chestnut trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ludwigstra%C3%9Fe%2013%2C%20Oberstdorf%2C%2087561%2C%20Germany"
    pageTitle="Das Jagdhaus"
  />
);

export default DasJagdhaus;
