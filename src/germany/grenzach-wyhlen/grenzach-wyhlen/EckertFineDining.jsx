...
const EckertFineDining = () => (
  <RestaurantPage
    restaurantName="Eckert | Fine Dining"
    address="Basler Straße 20, Grenzach-Wyhlen, 79639, Germany"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+49762491720"
    website="https://www.eckert-grenzach.de"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Basler%20Stra%C3%9Fe%2020%2C%20Grenzach-Wyhlen%2C%2079639%2C%20Germany"
    pageTitle="Eckert | Fine Dining"
  />
);

export default EckertFineDining;
