...
const Heiligenstein = () => (
  <RestaurantPage
    restaurantName="Heiligenstein"
    address="Heiligensteinstraße 19a, Baden-Baden, 76534, Germany"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+49722396140"
    website="https://hotel-heiligenstein.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here to enjoy classic seasonal cuisine in a tasteful, modern setting. High-quality, fresh ingredients are prepared in an agreeably straightforward way that brings out their flavour. Then there's the excellent wine list featuring over 400 different bottles. Pretty terrace. The hotel boasts a peaceful location and lovely, cosy guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Heiligensteinstra%C3%9Fe%2019a%2C%20Baden-Baden%2C%2076534%2C%20Germany"
    pageTitle="Heiligenstein"
  />
);

export default Heiligenstein;
