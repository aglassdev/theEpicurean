...
const HeinzlerAmSee = () => (
  <RestaurantPage
    restaurantName="Heinzler am See"
    address="Strandbadstraße 3, Immenstaad am Bodensee, 88090, Germany"
    cuisine="Country cooking, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+49754593190"
    website="https://www.heinzleramsee.de/de/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you are in the mood for regional comfort food or something more international, the Heinzler brothers have got it covered. Their wide-ranging menu includes Swabian Zwiebelrostbraten (fried beef and onions in gravy), Arctic char and whitefish fillets, and yellowfin tuna sashimi. There is also an appealing selection of barbecue dishes with a choice of side dishes and sauces. You can choose to dine in the cosy Jagdstube (hunting lounge) with its winning blend of traditional charm and modern design, or the lovely Panorama-Restaurant, whose large windows afford stunning views. Not forgetting the fabulous terrace almost touching the water! The waitstaff are personable and attentive – service is clearly a serious matter here. Tasteful and comfortable guestrooms available at the hotel, whic..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Strandbadstra%C3%9Fe%203%2C%20Immenstaad%20am%20Bodensee%2C%2088090%2C%20Germany"
    pageTitle="Heinzler am See"
  />
);

export default HeinzlerAmSee;
