...
const Caraleon = () => (
  <RestaurantPage
    restaurantName="CARALEON"
    address="Halbinselstraße 70, Wasserburg am Bodensee, 88142, Germany"
    cuisine="International, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+4983829800"
    website="https://caraleon.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tastefully designed restaurant is housed in the small boutique hotel of the same name, which enjoys a fabulous location in the Wasserburger Bucht and boasts stunning lake views. It specialises in modern European cuisine infused with authentic Peruvian influences. There is a small selection of à la carte options as well as a five-course set menu (by advance booking only) – the chefs themselves serve the dishes, adding a distinctive personal touch. The 300 labels on offer showcase wines from Bordeaux to Slovakia. Alternatively, there is a good range of non-alcoholic drinks to accompany your food. Every Sunday from 12pm to 6.30pm is Family & Friends, when à la carte classics are served, such as parihuela (Peruvian bouillabaisse), Wiener schnitzel or Kaiserschmarrn (shredded pancakes). Ti..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Halbinselstra%C3%9Fe%2070%2C%20Wasserburg%20am%20Bodensee%2C%2088142%2C%20Germany"
    pageTitle="CARALEON"
  />
);

export default Caraleon;
