...
const SchlossNiederweis = () => (
  <RestaurantPage
    restaurantName="Schloss Niederweis"
    address="Hauptstraße 9, Niederweis, 54668, Germany"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+4965689696450"
    website="https://schloss-niederweis.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tasteful restaurant is housed in the converted corn barn of a magnificent Baroque castle dating from 1751. The decor is a fascinating blend of rustic cachet and modern design – the open truss roof is striking and the two historical carriages on the wall are certainly eye-catching! Sample the flavoursome dishes à la carte or as a set menu, washed down by your choice from the terrific wine list that includes rare finds, including by the glass. Charming garden, a banquet hall and a registry office. On a practical note: easy parking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%209%2C%20Niederweis%2C%2054668%2C%20Germany"
    pageTitle="Schloss Niederweis"
  />
);

export default SchlossNiederweis;
