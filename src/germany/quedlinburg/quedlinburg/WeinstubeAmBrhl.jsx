...
const WeinstubeAmBrhl = () => (
  <RestaurantPage
    restaurantName="Weinstube am Brühl"
    address="Billungstraße 11, Quedlinburg, 06484, Germany"
    cuisine="International, Farm to table"
    priceRange="€€€"
    phoneNumber="+49394696180"
    website="https://www.hotelambruehl.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These former stables have been converted into a delightful restaurant, in which terracotta tiles, warm colours and an old brick ceiling lend a real country feel. The international cuisine on offer follows the seasons closely. The six-course Weinstuben-Menü (with vegan/vegetarian alternatives) comes with optional wine pairings. À la carte dining is also possible. Attentive service comes courtesy of a friendly and adept front-of-house team. Tip: Summer barbecue evenings (Jun-Aug) – booking recommended. Charming and elegant guestrooms are available in the Hotel Am Brühl...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Billungstra%C3%9Fe%2011%2C%20Quedlinburg%2C%2006484%2C%20Germany"
    pageTitle="Weinstube am Brühl"
  />
);

export default WeinstubeAmBrhl;
