...
const Westphalenhof = () => (
  <RestaurantPage
    restaurantName="Westphalenhof"
    address="Dorfaue 43, Hoyerswerda, 02977, Germany"
    cuisine="International, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+493571913944"
    website="https://www.westphalenhof.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish and sophisticated restaurant is somewhat tucked away in a residential area. Here, the Westphal brothers – one is the chef, the other the sommelier – delight diners with delicious food and excellent wine recommendations. The menu features international dishes that take their cue from the seasons, such as confit halibut fillet in nut butter, potato scales, cauliflower cream, dried tomatoes and Sardinian pasta. The walk-in wine cellar accommodates 120 different labels. The restaurant is also open for lunch on Saturdays and Sundays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfaue%2043%2C%20Hoyerswerda%2C%2002977%2C%20Germany"
    pageTitle="Westphalenhof"
  />
);

export default Westphalenhof;
