...
const OmaWilmaHeimatkche = () => (
  <RestaurantPage
    restaurantName="Oma Wilma Heimatküche"
    address="Gurtstig 32, Keitum, 25980, Germany"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4946518860066"
    website="https://omawilma.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This historical thatched-roof house in the heart of Keitum has bags of charm. Inside, diners enjoy an appealing modern take on Frisian decor; outside the gorgeous garden terrace beckons. The friendly front-of-house team provides pleasingly informal but professional service. The concept is dubbed Heimatküche – an ambitious blend of traditional and modern styles. A shorter menu is served at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gurtstig%2032%2C%20Keitum%2C%2025980%2C%20Germany"
    pageTitle="Oma Wilma Heimatküche"
  />
);

export default OmaWilmaHeimatkche;
