...
const BurgNideggenBrockelSchlimbach = () => (
  <RestaurantPage
    restaurantName="Burg Nideggen - Brockel Schlimbach"
    ...
    pageTitle="Burg Nideggen - Brockel Schlimbach"
  />
);

export default BurgNideggenBrockelSchlimbach;
