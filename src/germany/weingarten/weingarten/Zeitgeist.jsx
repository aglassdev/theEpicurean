...
const Zeitgeist = () => (
  <RestaurantPage
    restaurantName="zeit|geist"
    address="Marktplatz 7, Weingarten, 76356, Germany"
    cuisine="French Contemporary, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+49724470370"
    website="https://www.walksches-haus.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The centuries-old Walk'sche Haus in the heart of Weingarten abounds with charm. Outside it's the pretty half-timbered façade that catches the eye; inside, the combination of sleek modern design and a touch of rusticity makes for a particularly pleasing ambience. Sebastian Syrbe cooks up modern dishes based on classical foundations, such as onsen egg, soy, spinach, nut butter or suckling pig, beetroot, horseradish, chives. You can choose à la carte or opt for a surprise menu comprising four, six or eight courses. Tip: In summer, be sure to get a spot on the gorgeous terrace overlooking the Walzbach stream! For a more wallet-friendly alternative, head to stil|bruch. There are also pleasant guestrooms, should you wish to stay the night here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktplatz%207%2C%20Weingarten%2C%2076356%2C%20Germany"
    pageTitle="zeit|geist"
  />
);
