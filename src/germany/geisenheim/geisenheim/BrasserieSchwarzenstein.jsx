...
const BrasserieSchwarzenstein = () => (
  <RestaurantPage
    restaurantName="BRASSERIE Schwarzenstein"
    address="Rosengasse 32, Geisenheim, 65366, Germany"
    cuisine="French Contemporary"
    priceRange="€€€"
    phoneNumber="+49672299500"
    website="https://www.burg-schwarzenstein.de/unsere-restaurants-brasserie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this chic brasserie in a glass-paned pavilion at Burg Schwarzenstein, you can savour a wonderful view (also magnificent from the terrace!) and market-fresh French cuisine – from starters such as escargots de vigne en cocotte to meat and fish dishes such as choucroute Schwarzenstein or sole meunière, and, for dessert, île flottante. You also have the option of oysters and caviar. The well-stocked wine list homes in on German and French labels. Tip: For the optimum experience, consider staying overnight – there are lovely individually styled guestrooms distributed across the Parkresidenz, Burghotel and Guesthouse...."
    ...
    pageTitle="BRASSERIE Schwarzenstein"
  />
);

export default BrasserieSchwarzenstein;
