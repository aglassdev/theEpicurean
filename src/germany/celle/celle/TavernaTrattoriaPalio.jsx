...
const TavernaTrattoriaPalio = () => (
  <RestaurantPage
    restaurantName="Taverna & Trattoria Palio"
    address="Hannoversche Straße 55, Celle, 29221, Germany"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+4951412010"
    website="https://www.althoffcollection.com/de/althoff-hotel-fuerstenhof-celle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Palio offers fresh Italian fare from the open kitchen in a relaxed trattoria-style atmosphere – you simply have to try one of the pasta dishes! The seasonal set menus are also interesting. There’s also a lovely terrace in the shade of some old chestnut trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hannoversche%20Stra%C3%9Fe%2055%2C%20Celle%2C%2029221%2C%20Germany"
    pageTitle="Taverna & Trattoria Palio"
  />
);

export default TavernaTrattoriaPalio;
