...
const ZurKrone = () => (
  <RestaurantPage
    ...
    address="Miltenberger Straße 1, Großheubach, 63920, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+4993712663"
    website="https://gasthauskrone.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of the village you will find this charming restaurant with its comfortable dining rooms. Ralf Restel serves simple, flavoursome regional fare with international influences. Try the boiled rump of beef with herb sauce and pan-fried potatoes or the breast of corn-fed chicken with stir-fried vegetables and curry sauce. In summer the best tables are those outside on the quiet leafy terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Miltenberger%20Stra%C3%9Fe%201%2C%20Gro%C3%9Fheubach%2C%2063920%2C%20Germany"
    pageTitle="Zur Krone"
  />
);

export default ZurKrone;
