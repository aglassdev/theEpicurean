...
const LeTemple = () => (
  <RestaurantPage
    restaurantName="Le temple"
    address="Saarstraße 2, Neuhütten, 54422, Germany"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+4965037669"
    website="https://www.le-temple.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Christiane Detemple-Schäfer and Oliver Schäfer form an absolute dream team and have been working here since 1992. Their impressive dedication to the task has made Le temple a permanent fixture on the fine dining scene – not only in tiny Neuhütten, but also among the MICHELIN-starred restaurants in Rhineland-Palatinate. They serve up elaborate classic cuisine with the best seasonal ingredients. Numerous ingredients are skilfully combined to create complex, very precise and delicately crafted dishes. The five- to seven-course set menu starts with amuse-bouches that set the tone nicely. The tasteful, elegant ambience would not be out of place in a big city, plus they have a cigar lounge. If you would like to spend a night surrounded by the beautiful landscape of the Hunsrück, you can book one..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Saarstra%C3%9Fe%202%2C%20Neuh%C3%BCtten%2C%2054422%2C%20Germany"
    pageTitle="Le temple"
  />
);

export default LeTemple;
