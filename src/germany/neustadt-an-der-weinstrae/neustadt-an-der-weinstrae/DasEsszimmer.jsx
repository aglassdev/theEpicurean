...
const DasEsszimmer = () => (
  <RestaurantPage
    restaurantName="Das Esszimmer"
    address="Hintergasse 38, Neustadt an der Weinstraße, 67433, Germany"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+496321354996"
    website="https://www.esszimmer-neustadt.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A lovely restaurant in the Old Town: the welcoming, sleek and modern setting is bound to appeal, and the atmosphere is pleasantly intimate, the service is attentive and well trained. You can watch Italian/Mediterranean dishes being prepared in the open kitchen. Look out for the speciality days. On Thursdays: tasting menu only. The terrace in front of the house is also a pleasant place to sit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hintergasse%2038%2C%20Neustadt%20an%20der%20Weinstra%C3%9Fe%2C%2067433%2C%20Germany"
    pageTitle="Das Esszimmer"
  />
);

export default DasEsszimmer;
