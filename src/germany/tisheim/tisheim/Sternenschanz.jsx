...
const Sternenschanz = () => (
  <RestaurantPage
    restaurantName="Sternenschanz"
    address="Gottlob-Linck-Straße 2, Ötisheim, 75443, Germany"
    cuisine="Home Cooking, Country cooking"
    priceRange="€€"
    phoneNumber="+4970416667"
    website="https://www.sternenschanz.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fun dining experience! The Linck family put their heart and soul into running this delightful restaurant. Diners can look forward to friendly service and the chance to eat really well without breaking the bank. The menu focuses on Swabian fare and home-style cooking, with dishes such as Flädlesuppe (pancake soup) and creamy veal goulash. No wonder there are so many regulars! In summer, the gorgeous garden terrace beckons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gottlob-Linck-Stra%C3%9Fe%202%2C%20%C3%96tisheim%2C%2075443%2C%20Germany"
    pageTitle="Sternenschanz"
  />
);

export default Sternenschanz;
