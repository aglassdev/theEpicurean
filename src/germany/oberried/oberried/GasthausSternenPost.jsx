...
const GasthausSternenPost = () => (
  <RestaurantPage
    restaurantName="Gasthaus Sternen Post"
    address="Hauptstraße 30, Oberried, 79254, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+497661989849"
    website="https://www.gasthaus-sternen-post.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautifully restored 1875 restaurant is a fine example of the dedication of its owner. Diners sit in comfortable rooms complete with tiled ovens to sample delicious dishes such as venison stew with spaetzle (a Swabian pasta speciality) and red cabbage or apple fritters with vanilla sauce. Overnight accommodation comes in the form of lovely country house-style rooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2030%2C%20Oberried%2C%2079254%2C%20Germany"
    pageTitle="Gasthaus Sternen Post"
  />
);

export default GasthausSternenPost;
