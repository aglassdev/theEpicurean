...
const ObereMhle = () => (
  <RestaurantPage
    restaurantName="Obere Mühle"
    address="Ostrachstraße 40, Bad Hindelang, 87541, Germany"
    cuisine="Regional Cuisine, Bavarian"
    priceRange="€€€"
    phoneNumber="+4983242857"
    website="https://www.obere-muehle.de/gasthaus/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the outside, the carefully restored centuries-old farmhouse is really inviting; inside, wonderfully quaint rooms featuring rustic wood panelling ooze regional charm. The cuisine, too, is rooted in the Allgäu region, but with the occasional foray into the Mediterranean. The menu ranges from offal to various meats cooked on the charcoal grill, from locally farmed fresh fish to pasta and delicious desserts. Their commitment to sustainability is plain to see, not least in the quality and provenance of the ingredients. In addition to the appealing à la carte selection, there is also a daily menu. The food is accompanied by good wines. Friendly, attentive service ensures a pleasant, family atmosphere. The restaurant also has its own organic cheese dairy. Tip: Bad Hindelang's local history m..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ostrachstra%C3%9Fe%2040%2C%20Bad%20Hindelang%2C%2087541%2C%20Germany"
    pageTitle="Obere Mühle"
  />
);

export default ObereMhle;
