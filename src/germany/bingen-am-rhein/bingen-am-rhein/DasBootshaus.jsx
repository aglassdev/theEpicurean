...
const DasBootshaus = () => (
  <RestaurantPage
    restaurantName="Das Bootshaus"
    address="Hafenstraße 47a, Bingen am Rhein, 55411, Germany"
    cuisine="Contemporary, Farm to table"
    priceRange="€€"
    phoneNumber="+49672135010"
    website="https://www.paparheinhotel.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of the Papa Rhein lifestyle hotel combines a tasteful maritime vintage look with good, fresh cuisine, offering dishes such as cod in a potato crust with balsamic mixed vegetables and lentils and pesto. There is a wonderful view of the Rhine and the surrounding vineyards – in summer guests can enjoy sitting out on the delightful terrace!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hafenstra%C3%9Fe%2047a%2C%20Bingen%20am%20Rhein%2C%2055411%2C%20Germany"
    pageTitle="Das Bootshaus"
  />
);

export default DasBootshaus;
