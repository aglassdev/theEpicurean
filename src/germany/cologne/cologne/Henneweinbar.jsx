...
const Henneweinbar = () => (
  <RestaurantPage
    restaurantName="HENNE.Weinbar"
    address="Pfeilstraße 31, Cologne, 50672, Germany"
    cuisine="International, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+4922134662647"
    website="https://www.henne-weinbar.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the heart of the old town, Hendrik (Henne) Olfen's appealing bistro-style restaurant has a pleasantly laid-back atmosphere – and it's really popular! Likewise, the excellent food, which represents great value for money, goes down just as well! There is a simple menu at lunchtime and, in the evening, a range of modern, seasonal tapas-style plates that are ideal for sharing. Decent wine list. Delightful little courtyard terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pfeilstra%C3%9Fe%2031%2C%20Cologne%2C%2050672%2C%20Germany"
    pageTitle="HENNE.Weinbar"
  />
);

export default Henneweinbar;
