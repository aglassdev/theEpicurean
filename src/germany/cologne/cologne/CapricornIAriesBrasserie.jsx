...
const CapricornIAriesBrasserie = () => (
  <RestaurantPage
    restaurantName="Capricorn [ i ] Aries Brasserie"
    address="Alteburgerstraße 31, Cologne, 50678, Germany"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+492213975710"
    website="https://www.capricorniaries.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a neighbourhood with a unique character, this appealing, laid-back restaurant has plenty of regulars. Welcoming and lively, it's everything a brasserie should be. The menu, too, is down-to-earth, including mouthwatering options – house-made venison ham, brasserie classics such as steak-frites and vegetarian dishes. Tip: Take a punt on the moderately priced surprise menu. Friendly and professional service. Pavement terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alteburgerstra%C3%9Fe%2031%2C%20Cologne%2C%2050678%2C%20Germany"
    pageTitle="Capricorn [ i ] Aries Brasserie"
  />
);

export default CapricornIAriesBrasserie;
