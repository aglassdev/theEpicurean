...
const Alfredo = () => (
  <RestaurantPage
    restaurantName="Alfredo"
    address="Tunisstraße 3, Cologne, 50667, Germany"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+492212577380"
    website="https://www.ristorante-alfredo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are looking for authentic Italian cuisine in Cologne, Roberto Carturan is your man. His father, Alfredo, laid the foundations for upscale Italian cuisine in 1973, and the second generation of the Carturan family has cultivated a straightforward and minimalist style of cooking. The chef himself is responsible for the friendly, informal and elegant atmosphere: he likes to spend time with his guests and talk them through the dishes. Besides cooking, Roberto Carturan has another talent: he is a trained singer – on Friday evenings there's the musical culinary soirée: a five-course menu with a bout of singing as the finale! One practical tip: Parking is available in the Opern Passagen shopping centre located behind the restaurant. You might also take the opportunity to see the original 47..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tunisstra%C3%9Fe%203%2C%20Cologne%2C%2050667%2C%20Germany"
    pageTitle="Alfredo"
  />
);
