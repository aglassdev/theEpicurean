...
const ZenJapaneseRestaurant = () => (
  <RestaurantPage
    restaurantName="ZEN Japanese Restaurant"
    address="Bachemer Straße 233, Cologne, 50935, Germany"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+4922139909986"
    website="https://www.restaurant-zen.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bachemer%20Stra%C3%9Fe%20233%2C%20Cologne%2C%2050935%2C%20Germany"
    pageTitle="ZEN Japanese Restaurant"
  />
);

export default ZenJapaneseRestaurant;
