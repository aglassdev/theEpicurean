...
const Gastraum = () => (
  <RestaurantPage
    restaurantName="Gastraum"
    address="Bernhardstraße 14, Trier, 54295, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4965133066"
    website="https://www.hotel-villa-huegel.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern extension of the attractive Villa Hügel (1914) has a sleek and elegant feel. The ceiling-to-floor windows afford an impressive view of Trier, and the terrace is a particularly sought-after spot in this regard! Savour fresh, contemporary dishes made from good-quality ingredients and washed down with regional wines. The young team in charge of serving you are charming and professional. Cosy guestrooms and a lovely relaxation suite await overnight guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bernhardstra%C3%9Fe%2014%2C%20Trier%2C%2054295%2C%20Germany"
    pageTitle="Gastraum"
  />
);

export default Gastraum;
