...
const BeckersWeinhaus = () => (
  <RestaurantPage
    restaurantName="BECKER'S Weinhaus"
    ...
    pageTitle="BECKER'S Weinhaus"
  />
);

export default BeckersWeinhaus;
