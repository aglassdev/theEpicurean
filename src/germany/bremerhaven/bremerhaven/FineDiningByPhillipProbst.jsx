...
const FineDiningByPhillipProbst = () => (
  <RestaurantPage
    restaurantName="Fine Dining by Phillip Probst"
    address="Columbusstraße 67, Bremerhaven, 27568, Germany"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+49471902240"
    website="https://www.liberty-bremerhaven.com/gastro/mulberry-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in The Liberty hotel, this is a tastefully modern fine dining restaurant with floor-to-ceiling windows that afford a view of the small harbour. There is also a gorgeous terrace. Chef Phillip Probst and his team use excellent ingredients to create an interesting set menu comprising four to eight courses. The dishes are contemporary, yet classical in their foundations, and the wonderfully intense sauces deserve a mention. Shining examples are the cauliflower polonaise (served with an exquisite beurre blanc enhanced with Imperial caviar) and the beetroot with barbecued eel. The fairly priced wine list is another highlight. The well-drilled front-of-house team are friendly and attentive – they really pull out all the stops! Part of the same business, the restaurant next door, Mulberry ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Columbusstra%C3%9Fe%2067%2C%20Bremerhaven%2C%2027568%2C%20Germany"
    pageTitle="Fine Dining by Phillip Probst"
  />
);

export default FineDiningByPhillipProbst;
