...
const PhilippSoldan = () => (
  <RestaurantPage
    restaurantName="Philipp Soldan"
    address="Marktplatz 2, Frankenberg, 35066, Germany"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+4964517500"
    website="https://sonne-frankenberg.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The three lovingly restored historical houses in the middle of the charming old town are really something to behold. Here, the tasteful Hotel Sonne has various catering options, including this restaurant. The fine dining restaurant in the basement of the centuries-old Stadtweinhaus is chic, modern and pleasantly laid back. (If you are not coming from the hotel, you get to the restaurant via Untermarkt.) In the open kitchen, Erik Arnecke oversees the preparation of a creative five-course set menu. Dishes such as North Sea plaice with Irish rock oyster, bacon emulsion and watercress cream are brimming with harmoniously combined flavours. Upgrades include Japanese Wagyu beef and an international selection of cheeses. There is a good choice of wines. Tip for fine dining novices: come on a Sund..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktplatz%202%2C%20Frankenberg%2C%2035066%2C%20Germany"
    pageTitle="Philipp Soldan"
  />
);

export default PhilippSoldan;
