...
const HmmerlesRestaurant = () => (
  <RestaurantPage
    restaurantName="Hämmerle's Restaurant"
    ...
    pageTitle="Hämmerle's Restaurant"
  />
);

export default HmmerlesRestaurant;
