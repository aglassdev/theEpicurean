...
const IchWeiEinHausAmSee = () => (
  <RestaurantPage
    restaurantName="Ich weiß ein Haus am See"
    address="Paradiesweg 3, Krakow am See, 18292, Germany"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+493845723273"
    website="https://www.hausamsee.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Somewhere between Berlin and Rostock, in the middle of nowhere, you will find this small hotel on a secluded lake. The location is idyllic – the name of the road, Paradiesweg, is apt. But it's not just a cosy place to spend the night: food-wise you'll also get your money's worth. Raik Zeigner, head chef since 2005, bowls diners over with classic cuisine, which has always had a solid reputation. For his four-course set menu, which changes every evening, select ingredients are used. Take, for example, the steamed char or the saddle of venison with chanterelles. In this elegant restaurant with its country-house flair, your cordial hosts Petra and Adi König work with palpable enthusiasm to create a welcoming atmosphere. The owner – virtually a walking wine encyclopaedia – unfailingly recommend..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paradiesweg%203%2C%20Krakow%20am%20See%2C%2018292%2C%20Germany"
    pageTitle="Ich weiß ein Haus am See"
  />
);

export default IchWeiEinHausAmSee;
