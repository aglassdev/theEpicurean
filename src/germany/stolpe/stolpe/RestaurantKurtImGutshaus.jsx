...
const RestaurantKurtImGutshaus = () => (
  <RestaurantPage
    restaurantName="Restaurant Kurt im Gutshaus"
    address="Peenstraße 33, Stolpe, 17391, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+49397215500"
    website="https://www.gutshaus-stolpe.de/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A truly idyllic location. A cobblestone drive meanders through the stunning estate to the lovingly restored historical manor that houses this restaurant. Inside, contemporary design elements have been seamlessly incorporated into the classically elegant decor. The terrace overlooking the grounds is glorious in summer! Expect clearly structured modern cuisine notable for their finesse and pleasing contrasts. Chef Mehmet Kaan Verdo works primarily with regional ingredients sourced within a 100km radius, drawing on his Turkish-Italian roots and skilfully incorporating classic French techniques and seasonal nuances. There are two set menus: Nachbarschaft (Neighbourhood) and the vegetarian Ackerland (Farmland). Each comes in four to six courses, featuring dishes such as lamb shoulder with radic..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Peenstra%C3%9Fe%2033%2C%20Stolpe%2C%2017391%2C%20Germany"
    pageTitle="Restaurant Kurt im Gutshaus"
  />
);

export default RestaurantKurtImGutshaus;
