...
const Brunnenstuben = () => (
  <RestaurantPage
    restaurantName="Brunnenstuben"
    address="Quellenstraße 14, Waiblingen, 71334, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+4971519441227"
    website="https://brunnenstuben.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Don’t be put off by the somewhat unprepossessing exterior at Brunnenstuben because the food is excellent! Petra and Thorsten Beyer – she running the kitchen, he managing the friendly and professional front-of-house team – serve flavoursome Swabian fare including an excellent Zwiebelrostbraten (roast beef with onions)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quellenstra%C3%9Fe%2014%2C%20Waiblingen%2C%2071334%2C%20Germany"
    pageTitle="Brunnenstuben"
  />
);

export default Brunnenstuben;
