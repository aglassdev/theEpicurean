...
const GasthofWidmann = () => (
  <RestaurantPage
    restaurantName="Gasthof Widmann"
    address="Bergstraße 4, Maisach, 82216, Germany"
    cuisine="Seasonal Cuisine, International"
    priceRange="€€€"
    phoneNumber="+498135485"
    website="https://guide.michelin.com/en/bayern/maisach/restaurant/gasthof-widmann"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can clearly taste the enthusiasm that goes into preparing the food here. Seasonal and international dishes are served alongside regional fare, in a six-course set menu. A friendly front-of-house team presides over the two cosy dining rooms. Wed. - Sat. you are welcome from 6 pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bergstra%C3%9Fe%204%2C%20Maisach%2C%2082216%2C%20Germany"
    pageTitle="Gasthof Widmann"
  />
);

export default GasthofWidmann;
