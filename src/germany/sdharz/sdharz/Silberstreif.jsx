...
const Silberstreif = () => (
  <RestaurantPage
    restaurantName="Silberstreif"
    address="Schindelbruch 1, Südharz, 06536, Germany"
    cuisine="Regional Cuisine, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+49346548080"
    website="https://www.silberstreif-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Naturresort & Spa Schindelbruch features an ambitious restaurant concept called Silberstreif (Silver Lining), named after the 2022 butterfly of the year. Head chef Eric Jadischke and the young team rustle up contemporary cuisine inspired by the Harz region and its seasons. Some of the ingredients come from the garden that was planted with the restaurant's needs in mind. There is a five- to seven-course set menu, with corresponding wine or non-alcoholic pairings on request. Service is friendly and attentive. You might be interested to know that the dishes are served on Ritter von Kempski collection porcelain, designed by MEISSEN exclusively for this restaurant. The impressive pieces by artist Johann Elias Ridinger draw the eye with their hunting and forest motifs – a nod to the restaura..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schindelbruch%201%2C%20S%C3%BCdharz%2C%2006536%2C%20Germany"
    pageTitle="Silberstreif"
  />
);

export default Silberstreif;
