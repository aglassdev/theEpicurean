...
const LaBoucheEtElPato = () => (
  <RestaurantPage
    restaurantName="La Bouche et El Pato"
    address="Buschstraße 9, Schwerin, 19053, Germany"
    cuisine="International, Mediterranean Cuisine"
    priceRange="€"
    phoneNumber="+4938539456092"
    website="https://www.bistrolabouche.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro with a friendly, cosy atmosphere is located in the middle of the city – the cathedral is just a stone's throw away. La Bouche is on the ground floor and El Pato is on the first floor, but diners enjoy the same international and Mediterranean dishes and friendly service on both levels. Lovely terrace in the pedestrian zone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Buschstra%C3%9Fe%209%2C%20Schwerin%2C%2019053%2C%20Germany"
    pageTitle="La Bouche et El Pato"
  />
);

export default LaBoucheEtElPato;
