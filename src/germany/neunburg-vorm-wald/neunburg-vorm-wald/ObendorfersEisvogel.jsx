...
const ObendorfersEisvogel = () => (
  <RestaurantPage
    restaurantName="Obendorfers Eisvogel"
    ...
    pageTitle="Obendorfers Eisvogel"
  />
);

export default ObendorfersEisvogel;
