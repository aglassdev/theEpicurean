...
const RotesRoss = () => (
  <RestaurantPage
    restaurantName="Rotes Ross"
    address="Würzburger Straße 3, Marktbergel, 91613, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+499843936600"
    website="https://www.rotes-ross-marktbergel.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are a fan of fresh and seasonal regional cuisine, the Bogner family's restaurant will be right up your street. This place is cosy and the service comes courtesy of friendly and well-drilled waitstaff managed by the lady of the house. As for the wine, the focus is also on the region. In summer, the leafy courtyard terrace is in great demand. You can also spend the night in one of the well-kept, comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=W%C3%BCrzburger%20Stra%C3%9Fe%203%2C%20Marktbergel%2C%2091613%2C%20Germany"
    pageTitle="Rotes Ross"
  />
);

export default RotesRoss;
