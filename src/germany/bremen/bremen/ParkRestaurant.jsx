...
const ParkRestaurant = () => (
  <RestaurantPage
    restaurantName="Park Restaurant"
    address="Im Bürgerpark 1, Bremen, 28209, Germany"
    cuisine="Contemporary, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+494213408513"
    website="https://www.hommage-hotels.com/parkhotel-bremen/kulinarik/park-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located at Parkhotel Bremen, this restaurant occupies an elegant conservatory overlooking the Bürgerpark and the lake (Hollersee). Frank Seyfried, previously at Gotthardt's in Koblenz, runs the kitchen, serving up a contemporary take on classic cuisine. Create your own three- to six-course set menu from a tempting array of dishes. The good food is complemented by friendly and adept service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Im%20B%C3%BCrgerpark%201%2C%20Bremen%2C%2028209%2C%20Germany"
    pageTitle="Park Restaurant"
  />
);

export default ParkRestaurant;
