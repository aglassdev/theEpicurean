...
const FeilmeiersLandleben = () => (
  <RestaurantPage
    restaurantName="Feilmeiers Landleben"
    address="Schwarzhöring 14, Windorf, 94575, Germany"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+4985418293"
    website="https://www.feilmeiers-landleben.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy and modern restaurant knows how to makes diners feel welcome. For Johann (who goes by Hans) Feilmeier, his country life cooking reflects both a love of his native region and a sense of duty. He cooks regionally and seasonally inspired food. Choose from one of the different set menus or order à la carte. Extremely charming and cordial service - matching wine advice included. Tip: the home-made jams!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schwarzh%C3%B6ring%2014%2C%20Windorf%2C%2094575%2C%20Germany"
    pageTitle="Feilmeiers Landleben"
  />
);

export default FeilmeiersLandleben;
