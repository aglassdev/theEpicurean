...
const Ostseelounge = () => (
  <RestaurantPage
    restaurantName="Ostseelounge"
    address="Birkenallee 20, Dierhagen, 18347, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+49382265010"
    website="https://www.strandhotel-duenenmeer.de/kulinarik"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since the move from Strandhotel Fischland into its partner hotel, Strandhotel Dünenmeer, the Ostseelounge's duo of chefs, André Baiersdorf and Matthias Stolze, propose two concepts to diners: In the fine dining area, the five- to seven-course set menu is accompanied by a view of the dunes and the sea (complete with romantic sunsets!); in the casual fine dining area, which includes a Chef's Table, the three-course set menu can be enjoyed against the backdrop of the open kitchen. The modern and seasonal cuisine has classic French foundations. Excellent ingredients go into creating dishes such as Danish langoustine, cauliflower, yuzu, baby leek or supreme of quail, colourful bean cassoulet, truffle. The service is friendly and attentive; the chic, bright interior is complemented by a lovely t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Birkenallee%2020%2C%20Dierhagen%2C%2018347%2C%20Germany"
    pageTitle="Ostseelounge"
  />
);

export default Ostseelounge;
