...
const AlpenknigEsslust = () => (
  <RestaurantPage
    restaurantName="Alpenkönig - Esslust"
    address="Kalzhofer Straße 25, Oberstaufen, 87534, Germany"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+49838693450"
    website="https://www.hotel-alpenkoenig.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners take their seats in a lovely, upscale dining space comprising areas that range in style from traditional charm to modern chic. A cordial and professional front-of-house team serves fresh regional cuisine that draws on the seasons and Mediterranean influences. You can go à la carte or choose dishes for the three or four courses of your own set menu. There is also an appealing wine list. The restaurant is located in the attractive Alpenkönig hotel, which has inviting guestrooms and modern wellness facilities, set in the gorgeous Allgäu landscape...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kalzhofer%20Stra%C3%9Fe%2025%2C%20Oberstaufen%2C%2087534%2C%20Germany"
    pageTitle="Alpenkönig - Esslust"
  />
);

export default AlpenknigEsslust;
