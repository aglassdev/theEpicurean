...
const AlteBerfahrt = () => (
  <RestaurantPage
    restaurantName="Alte Überfahrt"
    address="Fischerstraße 48b, Werder, 14542, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+4933277313336"
    website="https://www.alte-ueberfahrt.de/"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fischerstra%C3%9Fe%2048b%2C%20Werder%2C%2014542%2C%20Germany"
    pageTitle="Alte Überfahrt"
  />
);

export default AlteBerfahrt;
