...
const KaltwassersWohnzimmer = () => (
  <RestaurantPage
    restaurantName="Kaltwassers Wohnzimmer"
    address="Obergasse 15, Zwingenberg, 64673, Germany"
    cuisine="Modern Cuisine, Country cooking"
    priceRange="€€€"
    phoneNumber="+4962511058640"
    website="https://www.kaltwasserswohnzimmer.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wohnzimmer offers a cosy living room feel with some charming nostalgic touches inside and a designer atrium with view of the glazed kitchens in the interior courtyard. The modern regional cuisine uses fresh quality produce and includes dishes such as Wels catfish served with mashed potatoes and apples, kohlrabi and Ahle Worscht sausage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Obergasse%2015%2C%20Zwingenberg%2C%2064673%2C%20Germany"
    pageTitle="Kaltwassers Wohnzimmer"
  />
);

export default KaltwassersWohnzimmer;
