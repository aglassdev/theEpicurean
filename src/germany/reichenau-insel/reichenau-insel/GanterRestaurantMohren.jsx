...
const GanterRestaurantMohren = () => (
  <RestaurantPage
    restaurantName="Ganter Restaurant Mohren"
    address="Pirminstraße 141, Reichenau Insel, 78479, Germany"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4975349944607"
    website="https://www.mohren-bodensee.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you opt for a cosy-rustic or a chic-modern interior, the food on offer here is fresh and regional with international influences. Try the char with pearl barley, herbs, almonds and madras curry spices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pirminstra%C3%9Fe%20141%2C%20Reichenau%20Insel%2C%2078479%2C%20Germany"
    pageTitle="Ganter Restaurant Mohren"
  />
);

export default GanterRestaurantMohren;
