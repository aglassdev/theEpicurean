...
const OsteriaLaFenice = () => (
  <RestaurantPage
    restaurantName="Osteria La Fenice"
    address="Nordersteinstraße 6, Cuxhaven, 27472, Germany"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+4947216984151"
    website="https://www.osterialafenice-cuxhaven.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A slice of Italy in Cuxhaven! Behind a rather unassuming façade on a busy shopping street, a truly welcoming osteria ambiance awaits – the decor features decorative wine racks, closely spaced marble tables and even a Vespa! Not to forget the authentic Italian cuisine made with high-quality, fresh ingredients – the sourdough bread and pasta are both made in-house. The wine list showcases Italian labels. Tip: Italian food items can be purchased to take home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nordersteinstra%C3%9Fe%206%2C%20Cuxhaven%2C%2027472%2C%20Germany"
    pageTitle="Osteria La Fenice"
  />
);

export default OsteriaLaFenice;
