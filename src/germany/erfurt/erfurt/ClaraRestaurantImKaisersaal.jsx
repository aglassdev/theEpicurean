...
const ClaraRestaurantImKaisersaal = () => (
  <RestaurantPage
    restaurantName="Clara - Restaurant im Kaisersaal"
    address="Futterstraße 15, Erfurt, 99084, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+493615688207"
    website="https://www.restaurant-clara.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Futterstra%C3%9Fe%2015%2C%20Erfurt%2C%2099084%2C%20Germany"
    pageTitle="Clara - Restaurant im Kaisersaal"
  />
);

export default ClaraRestaurantImKaisersaal;
