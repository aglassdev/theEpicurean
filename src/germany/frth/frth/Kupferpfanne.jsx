...
const Kupferpfanne = () => (
  <RestaurantPage
    restaurantName="Kupferpfanne"
    address="Königstraße 85, Fürth, 90762, Germany"
    cuisine="Classic Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+49911771277"
    website="https://www.ew-kupferpfanne.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Erwin Weidenhiller's restaurant, in a central location opposite the town hall, has been a classic on Fürth's food scene for decades. In the comfortable and elegant interior, they serve classic cuisine with seasonal and international-Mediterranean influences, made with good-quality produce. Tip: the reasonably priced lunch menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=K%C3%B6nigstra%C3%9Fe%2085%2C%20F%C3%BCrth%2C%2090762%2C%20Germany"
    pageTitle="Kupferpfanne"
  />
);

export default Kupferpfanne;
