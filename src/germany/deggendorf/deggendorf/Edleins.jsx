...
const Edleins = () => (
  <RestaurantPage
    restaurantName="edl.eins"
    address="Edlmairstraße 1, Deggendorf, 94469, Germany"
    cuisine="Modern Cuisine, French"
    priceRange="€€€€"
    phoneNumber="+4999134477201"
    website="https://www.edleins.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Edlmairstra%C3%9Fe%201%2C%20Deggendorf%2C%2094469%2C%20Germany"
    pageTitle="edl.eins"
  />
);

export default Edleins;
