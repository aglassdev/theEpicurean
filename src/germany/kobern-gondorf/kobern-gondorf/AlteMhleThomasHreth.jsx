...
const AlteMhleThomasHreth = () => (
  <RestaurantPage
    restaurantName="Alte Mühle Thomas Höreth"
    address="Mühlental 17, Kobern-Gondorf, 56330, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+4926076474"
    website="https://altemuehlehoereth.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With this individual and thoroughly charming establishment the Höreth family have created a wonderful retreat. The guest lounges are lovingly decorated and the inner courtyard is idyllic. This is a real gem of a place, which also has its own wine estate. Slightly higher up, charming rooms are available for guests to stay the night...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BChlental%2017%2C%20Kobern-Gondorf%2C%2056330%2C%20Germany"
    pageTitle="Alte Mühle Thomas Höreth"
  />
);

export default AlteMhleThomasHreth;
