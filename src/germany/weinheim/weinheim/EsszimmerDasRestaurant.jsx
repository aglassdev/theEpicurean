...
const EsszimmerDasRestaurant = () => (
  <RestaurantPage
    restaurantName="esszimmer das Restaurant"
    address="Alte Postgasse 53, Weinheim, 69469, Germany"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+4962018776787"
    website="https://esszimmer-weinheim.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Old floorboards, beautiful bare wooden tables and eclectic decoration make for a really comfortable atmosphere, almost as if you were in your own dining room. The cuisine is creative and made with high-quality and carefully sourced ingredients, many from the region - top for example Hamachi from Völklingen. There is a set menu comprising four to seven courses – including appetisers, a breadboard and salad, plus a petit four to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alte%20Postgasse%2053%2C%20Weinheim%2C%2069469%2C%20Germany"
    pageTitle="esszimmer das Restaurant"
  />
);

export default EsszimmerDasRestaurant;
