...
const FiveSensesByMarioAliberti = () => (
  <RestaurantPage
    restaurantName="5 SEN:SES by Mario Aliberti"
    address="Blumenstraße 19, Karlsruhe, 76133, Germany"
    cuisine="International, Italian"
    priceRange="€€€"
    phoneNumber="+4972120628"
    website="https://mario-aliberti.de/pages/5-sen-ses"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fine addition to Karlsruhe's culinary scene. Chef-patron Mario Aliberti fuses Italian cuisine with international – especially Asian – and regional influences. A wide range of dishes is available: Lunchtime features four different moderately priced set menus (individual courses can also be ordered separately), along with additional à la carte options. In the evening, the array of options includes the Fine Dining Menu, the Italian Menu and the Menü Sharing, as well as an extensive à la carte selection. You can also order whole fish and different cuts of meat. There really is something for everyone's taste! The well-stocked wine list is worth a look, too. The interior is modern and inviting, with a distinct lounge feel. In summer, head for the quiet terrace laid out right in front of the re..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blumenstra%C3%9Fe%2019%2C%20Karlsruhe%2C%2076133%2C%20Germany"
    pageTitle="5 SEN:SES by Mario Aliberti"
  />
);

export default FiveSensesByMarioAliberti;
