...
const Schlosskeller = () => (
  <RestaurantPage
    restaurantName="Schlosskeller"
    address="Schwöbber 9, Aerzen, 31855, Germany"
    cuisine="Farm to table, International"
    priceRange="€€"
    phoneNumber="+49515470600"
    website="https://www.schlosshotel-muenchhausen.com/restaurants/schlosskeller/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When it comes to the setting, the lovingly decorated vaulted cellar is really cosy, and the terrace by the castle pond is fantastic! The seasonal cuisine is in a regional vein, ranging from classic Wiener schnitzel to roasted fillet of sea bass with a rosehip foam. They are also open at lunchtime, which is excellent news...."
    ...
    pageTitle="Schlosskeller"
  />
);

export default Schlosskeller;
