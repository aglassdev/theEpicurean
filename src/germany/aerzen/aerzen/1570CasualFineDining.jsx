...
const 1570CasualFineDining = () => (
  <RestaurantPage
    restaurantName="1570 - CASUAL FINE DINING"
    address="Schwöbber 9, Aerzen, 31855, Germany"
    cuisine="Contemporary, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+49515470600"
    website="https://www.schlosshotel-muenchhausen.com/restaurants/1570-casual-fine-dining/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dine like royalty in a castle setting! Could you ask for more splendid surroundings than those of the historical Schlosshotel Münchhausen, a stately home dating back to 1570, in which to savour modern dishes inspired by French culinary tradition – served as a four- or five-course set menu as well as à la carte. The whole experience is rounded off by genial, highly adept service and an elegant setting, to which moulded ceilings, chandeliers and hardwood floors lend their historical charm. Thanks to the wonderful location with the park and golf course, as well as the tastefully designed guestrooms, patrons find plenty of reasons to linger...."
    ...
    pageTitle="1570 - CASUAL FINE DINING"
  />
);

export default 1570CasualFineDining;
