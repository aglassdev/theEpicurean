...
const Hilmar = () => (
  <RestaurantPage
    restaurantName="HILMAR"
    address="Schwöbber 9, Aerzen, 31855, Germany"
    cuisine="Contemporary, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+49515470600"
    website="https://www.schlosshotel-muenchhausen.com/restaurants/gourmet-restaurant-hilmar/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dine like royalty in a castle setting! Could you ask for more splendid surroundings than those of the historical Schlosshotel Münchhausen, a stately home dating from 1570, in which to savour modern dishes inspired by French culinary tradition. Stephan Krogmann, previously head chef at Gutshaus Stolpe, showcases excellent ingredients in his set menu, which comprises five pleasingly pared-down and precisely crafted courses. Take, for example, the Breton-coast monkfish roasted on the bone. The various amuse-bouches are also exquisite. The whole experience is rounded off by friendly, highly adept service and an elegant setting, to which moulded ceilings, chandeliers and parquet flooring lend their historical charm. Thanks to the wonderful location with the park and golf course, as well as the ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schw%C3%B6bber%209%2C%20Aerzen%2C%2031855%2C%20Germany"
    pageTitle="HILMAR"
  />
);

export default Hilmar;
