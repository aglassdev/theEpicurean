...
const GasthausSternen = () => (
  <RestaurantPage
    restaurantName="Gasthaus Sternen"
    address="Bohlinger Dorfstraße 12, Singen, 78224, Germany"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+4977313194199"
    website="https://www.sternenbohlingen.de/gasthaus"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The juxtaposition of Gasthaus Sternen, with its traditional half-timbered façade, and the adjoining modern Aparthotel makes for an eye-catching architectural ensemble, the setting for this inviting contemporary restaurant. Chef-patron Peter Bogdanovic presents an ambitious take on seasonal regional cuisine in the form of creative and visually appealing dishes. Options such as smoked eel from Lake Constance with kohlrabi, crème fraîche, wasabi and apple sorbet, or braised Black Angus beef shoulder with root vegetables, red wine caramelised onions and polenta can be ordered à la carte. Alternatively, take a punt on the Schmackofaz Sternen set menu. Thanks to the location right by the Aach River, the terrace is a particularly popular spot in summer. Tip: House-made spice blends and herb oil a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bohlinger%20Dorfstra%C3%9Fe%2012%2C%20Singen%2C%2078224%2C%20Germany"
    pageTitle="Gasthaus Sternen"
  />
);

export default GasthausSternen;
