...
const VierJahreszeitenRestaurantImhof = () => (
  <RestaurantPage
    restaurantName="Vier Jahreszeiten Restaurant Imhof"
    address="Dietenheimer Straße 63, Illertissen, 89257, Germany"
    cuisine="Farm to table, Country cooking"
    priceRange="€€"
    phoneNumber="+4973039059600"
    website="https://www.vier-jahreszeiten-illertissen.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You will certainly eat well at Andreas Imhof's restaurant. The cuisine is shaped by regional influences and stands out for its craftsmanship and flavour. Ingredients are selected with seasonality in mind. Diners can choose between a well-curated à la carte selection and a three-course set menu. Dishes made with Allgäu heifer, for example, are popular. The bright and inviting interior has a sleek, modern design; outside, the beer garden is presided over by an impressive lime tree. Tip: A budget-friendly lunch special is served daily...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dietenheimer%20Stra%C3%9Fe%2063%2C%20Illertissen%2C%2089257%2C%20Germany"
    pageTitle="Vier Jahreszeiten Restaurant Imhof"
  />
);

export default VierJahreszeitenRestaurantImhof;
