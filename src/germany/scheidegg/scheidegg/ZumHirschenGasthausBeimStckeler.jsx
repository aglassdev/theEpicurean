...
const ZumHirschenGasthausBeimStckeler = () => (
  <RestaurantPage
    restaurantName="ZUM HIRSCHEN beim stöckeler"
    address="Kirchstraße 1, Scheidegg, 88175, Germany"
    cuisine="Country cooking, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4983812119"
    website="https://www.zumhirschenscheidegg.de/"
    aliases={["Zum Hirschen & Gasthaus beim Stöckeler"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run restaurant is firmly established in the village and surrounding area. The cosy, rustic dining rooms and pretty terrace in the shadow of the church making an ideal setting for its seasonal, regional cuisine. There is also a good selection of gluten-free dishes. The matching wines are offered. Overnight guests can look forward to pretty, modern Alpine rooms and a good breakfast – taken on the balcony terrace perhaps?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kirchstra%C3%9Fe%201%2C%20Scheidegg%2C%2088175%2C%20Germany"
    pageTitle="ZUM HIRSCHEN beim stöckeler"
  />
);

export default ZumHirschenGasthausBeimStckeler;
