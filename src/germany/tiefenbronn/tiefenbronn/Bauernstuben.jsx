...
const Bauernstuben = () => (
  <RestaurantPage
    restaurantName="Bauernstuben"
    address="Franz-Josef-Gall-Straße 13, Tiefenbronn, 75233, Germany"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+49723495450"
    website="https://www.ochsen-post.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy rustic-style restaurant is housed in the venerable Ochsen Post. The menu features the traditional cuisines of Baden and Swabia, as well as internationally influenced dishes. Along with Maultaschen, Zwiebelrostbraten (fried beef and onions in gravy) and steaks, there are also less conventional options such as sour kidney or tripe soup. Diners can also look forward to a delightful terrace, attentive service and a well-curated wine list that includes a number of rare gems. Tip: You can purchase their wonderful bread to take home, and some meat dishes are also available for takeaway. Lovely guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Franz-Josef-Gall-Stra%C3%9Fe%2013%2C%20Tiefenbronn%2C%2075233%2C%20Germany"
    pageTitle="Bauernstuben"
  />
);

export default Bauernstuben;
