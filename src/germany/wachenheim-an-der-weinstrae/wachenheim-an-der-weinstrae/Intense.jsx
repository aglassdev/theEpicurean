...
const Intense = () => (
  <RestaurantPage
    restaurantName="Intense"
    address="Weinstraße 31, Wachenheim an der Weinstraße, 67157, Germany"
    cuisine="Fusion, Creative"
    priceRange="€€€€"
    phoneNumber="+4963226004994"
    website="https://www.restaurant-inten.se/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the centre of Wachenheim, opposite the church, Kirche St Georg, Bettina and Benjamin Peifer present their exciting concept! After welcome drinks and appetisers in Gud Stubb (the former vicarage), you are introduced to their culinary philosophy in the pantry; you then take a seat in the minimalist, urban-style restaurant area, either at the counter with a direct view into the kitchen – a special experience – or at one of the small tables or in a koshitsu (a separate nook). A special fusion of the cuisines of the Palatinate and Japan is served. Think izakaya- style pigeon: juicy, grilled pigeon breast breaded with crunchy sesame seeds, and a skewer of very tasty, tender minced pigeon meat. Fire plays a major role, producing wonderful roasted flavours! Top tip: Try the deliciously sweet, i..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weinstra%C3%9Fe%2031%2C%20Wachenheim%20an%20der%20Weinstra%C3%9Fe%2C%2067157%2C%20Germany"
    pageTitle="Intense"
  />
);
