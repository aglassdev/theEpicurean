...
const ZurLindeSTU = () => (
  <RestaurantPage
    ...
    address="Sigmaringer Straße 49, Stuttgart, 70567, Germany"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+497117199590"
    website="https://www.linde-stuttgart.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Trautwein brothers run this former coaching inn with great dedication. Some 300 years old, it features a charming blend of historical and modern decor. The menu includes Swabian classics such as Gaisburger Marsch (traditional beef stew), Maultaschen and Zwiebelrostbraten (beef and onions in gravy), alongside seasonal dishes such as pink-roasted lamb rump with beans done two ways and polenta with herbs, as well as vegetarian options. A lovely leafy terrace lies to the rear of the building. A rustic vaulted cellar can be booked for private functions. Tip: The shop sells soups, sauces, Maultaschen and spaetzle to take away...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sigmaringer%20Stra%C3%9Fe%2049%2C%20Stuttgart%2C%2070567%2C%20Germany"
    pageTitle="Zur Linde"
  />
);

export default ZurLindeSTU;
