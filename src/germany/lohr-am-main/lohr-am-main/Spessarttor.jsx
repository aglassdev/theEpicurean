...
const Spessarttor = () => (
  <RestaurantPage
    restaurantName="Spessarttor"
    address="Wombacher Straße 140, Lohr am Main, 97816, Germany"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€"
    phoneNumber="+49935287330"
    website="https://www.hotel-spessarttor.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established family business is a well-run affair, with diners settling into the cosy dining rooms to enjoy regional fare. On the menu, tasty dishes such as roast venison with red cabbage and dumplings will whet your appetite. You can stay overnight in the inn or in the guesthouse located 300m away...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wombacher%20Stra%C3%9Fe%20140%2C%20Lohr%20am%20Main%2C%2097816%2C%20Germany"
    pageTitle="Spessarttor"
  />
);

export default Spessarttor;
