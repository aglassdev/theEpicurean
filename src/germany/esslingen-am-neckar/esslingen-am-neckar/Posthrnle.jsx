...
const Posthrnle = () => (
  <RestaurantPage
    restaurantName="Posthörnle"
    address="Pliensaustraße 56, Esslingen am Neckar, 73728, Germany"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+4971150629131"
    website="https://posthoernle.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This casual, minimalist-style little restaurant is housed in one of the oldest taverns in the town. It serves fresh, seasonal cuisine with dishes ranging from venison rissoles with black mustard to pan-fried zander with oranges and chicory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pliensaustra%C3%9Fe%2056%2C%20Esslingen%20am%20Neckar%2C%2073728%2C%20Germany"
    pageTitle="Posthörnle"
  />
);

export default Posthrnle;
