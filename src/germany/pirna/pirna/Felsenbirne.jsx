...
const Felsenbirne = () => (
  <RestaurantPage
    restaurantName="Felsenbirne"
    address="Lange Straße 34, Pirna, 01796, Germany"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+4935017599791"
    website="https://www.felsenbirne-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a friendly atmosphere and a sleek modern interior is located on a cobbled street in the pretty old town, not far from the Elbe. Chef-patron Felix Mikulla uses seasonal ingredients – his dishes are fresh and delicious, as well as good value. The menu also includes vegetarian and vegan options. In summer, diners can make the most of the terrace in the inner courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Stra%C3%9Fe%2034%2C%20Pirna%2C%2001796%2C%20Germany"
    pageTitle="Felsenbirne"
  />
);

export default Felsenbirne;
