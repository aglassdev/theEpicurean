...
const Michaelis = () => (
  <RestaurantPage
    restaurantName="Michaelis"
    address="Paul-Gruner-Straße 44, Leipzig, 04107, Germany"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+4934126780"
    website="https://www.michaelis-leipzig.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tasty and fresh food is served in this refined restaurant in a restored building from the Wilhelminian period, which also houses the comfortable hotel of the same name. The menu is seasonal – there are various set menus (one of which is vegetarian) and a sophisticated à la carte selection. Friendly and attentive service. In summer, the terrace behind the house is very appealing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paul-Gruner-Stra%C3%9Fe%2044%2C%20Leipzig%2C%2004107%2C%20Germany"
    pageTitle="Michaelis"
  />
);

export default Michaelis;
