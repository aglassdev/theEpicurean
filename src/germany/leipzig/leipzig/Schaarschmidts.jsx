...
const Schaarschmidts = () => (
  <RestaurantPage
    restaurantName="Schaarschmidt's"
    address="Coppistraße 32, Leipzig, 04157, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+493419120517"
    website="https://schaarschmidts.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This building on a corner plot with a gorgeous leafy façade is home to a cosy restaurant that is run with great dedication. Its many regulars come in droves to enjoy specialities of Saxon cuisine – the beef roulade is a firm favourite! The friendly waitstaff will gladly talk you through the options on the menu. Head for the lovely small terrace planted with trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Coppistra%C3%9Fe%2032%2C%20Leipzig%2C%2004157%2C%20Germany"
    pageTitle="Schaarschmidt's"
  />
);

export default Schaarschmidts;
