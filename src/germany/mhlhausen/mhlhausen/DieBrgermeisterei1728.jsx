...
const DieBrgermeisterei1728 = () => (
  <RestaurantPage
    restaurantName="Die Bürgermeisterei 1728"
    address="Untermarkt 13, Mühlhausen, 99974, Germany"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+4915209121728"
    website="https://die-buergermeisterei.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A location steeped in history in which to enjoy a meal! The lovingly restored building, which gives directly onto the market square, was once the mayor's residence and dates back to 1728. The elegant fusion of modern style and historical details lends the place atmosphere. The evening menu is ambitious, fresh and full of flavour, with appetising options such as beef bourgignon, dried fig crumble and potato-parsnip mash. The small selection of seasonal dishes is also proposed in the form of set menus, one of which is vegetarian. In summer, make the most of the secluded terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untermarkt%2013%2C%20M%C3%BChlhausen%2C%2099974%2C%20Germany"
    pageTitle="Die Bürgermeisterei 1728"
  />
);

export default DieBrgermeisterei1728;
