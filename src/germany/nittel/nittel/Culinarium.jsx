...
const Culinarium = () => (
  <RestaurantPage
    restaurantName="Culinarium"
    address="Weinstraße 5, Nittel, 54453, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+49658491450"
    website="https://www.culinarium-nittel.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chic, pared-back restaurant with a lovely terrace area is located in the Weingut Matthias Dostert, a winery that also offers cosy guestrooms. Chef Walter Curman draws on his considerable craftsmanship to meticulously create flavoursome dishes. The classics on the menu hint at his Austrian origins – try the appetising Kaspressknödel (pressed cheese dumplings) or Alt Wiener Kaiserschmarrn (Viennese pancake)!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weinstra%C3%9Fe%205%2C%20Nittel%2C%2054453%2C%20Germany"
    pageTitle="Culinarium"
  />
);

export default Culinarium;
