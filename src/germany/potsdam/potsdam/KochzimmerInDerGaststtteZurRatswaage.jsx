...
const KochzimmerInDerGaststtteZurRatswaage = () => (
  <RestaurantPage
    restaurantName="kochZIMMER in der Gaststätte zur Ratswaage"
    address="Am Neuen Markt 10, Potsdam, 14467, Germany"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€€"
    phoneNumber="+4933120090666"
    website="https://www.restaurant-kochzimmer.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The 18C Ratswaage is exceedingly stylish! On the outside you have the historical façade, and on the inside a minimalist interior with chic details such as silver-grey walls, 1950s-style chandeliers and burnt-orange designer chairs. Here, the Frankenhäuser family and their team promise a culinary style dubbed new Prussian cuisine. Head chef Nico Werner, previously sous chef, presides in the kitchen, working with the very best produce, preferably sourced from Brandenburg producers. There is a six-course set menu (upgrade available); for the vegetarian set menu, specify when booking. Wed-Fri, the special kochZIMMER Stars (aperitif and drinks included) is available by prior reservation. Be sure to consult owner Jörg Frankenhäuser when it comes to selecting your wine! Tip for summer: Try to get..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Neuen%20Markt%2010%2C%20Potsdam%2C%2014467%2C%20Germany"
    pageTitle="kochZIMMER in der Gaststätte zur Ratswaage"
  />
);

export default KochzimmerInDerGaststtteZurRatswaage;
