...
const NightingaleThaiCuisineBar = () => (
  <RestaurantPage
    restaurantName="Nightingale Thai Cuisine & Bar"
    address="Augsburger Straße 19, Dachau, 85221, Germany"
    cuisine="Thai, International"
    priceRange="€€"
    phoneNumber="+4915117092009"
    website="https://nightingale-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having spent years in the bustling metropolis of Bangkok, Dominik and May Carqueville are bringing a slice of the Far East to Dachau. Born and raised in Thailand, the chef has an innate talent for working with authentic Thai flavours. She skilfully incorporates contemporary influences and locally-sourced ingredients into the traditional cuisine of her homeland. Using only the freshest ingredients, she crafts dishes such as Ma Hor (caramelised minced pork with peanuts, pineapple, coriander and chilli) or pan-seared sea bass fillet in a choo chee curry sauce with kaffir lime leaves. Dishes can also be ordered to share. The trendy and chic setting is a combination of restaurant and bar – the latter serves cocktails, beer, wine and house-made soft drinks, as well as finger food. The name Night..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Augsburger%20Stra%C3%9Fe%2019%2C%20Dachau%2C%2085221%2C%20Germany"
    pageTitle="Nightingale Thai Cuisine & Bar"
  />
);

export default NightingaleThaiCuisineBar;
