...
const KaminUndBauernstube = () => (
  <RestaurantPage
    restaurantName="Kamin- und Bauernstube"
    ...
    pageTitle="Kamin- und Bauernstube"
  />
);

export default KaminUndBauernstube;
