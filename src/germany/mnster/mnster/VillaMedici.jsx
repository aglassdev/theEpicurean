...
const VillaMedici = () => (
  <RestaurantPage
    restaurantName="Villa Medici"
    address="Prozessionsweg 402, Münster, 48155, Germany"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+4925134218"
    website="https://villa-medici-muenster.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spruce villa enjoys a delightful location in a quiet residential area on the outskirts of the city. Diners here are pampered with friendly service, Mediterranean flavours and Italian wines in a chic and inviting atmosphere. In addition to à la carte options, there are daily specials and a tasting menu. A charming terrace is laid out to the side. Plus, there are five attractive guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Prozessionsweg%20402%2C%20M%C3%BCnster%2C%2048155%2C%20Germany"
    pageTitle="Villa Medici"
  />
);

export default VillaMedici;
