...
const VonRhemen = () => (
  <RestaurantPage
    restaurantName="von Rhemen"
    address="Steinfurter Straße 374, Münster, 48159, Germany"
    cuisine="Classic French"
    priceRange="€€€"
    phoneNumber="+49251144270"
    website="https://schloss-wilkinghege.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of the stylish Schloss Wilkinghege hotel is set in an elegant, high-ceilinged room with fine mouldings and bags of historical charm. The classical cuisine makes the most of seasonal ingredients, with diners able to choose between à la carte dishes, the Schlossmenü and vegetarian set menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Steinfurter%20Stra%C3%9Fe%20374%2C%20M%C3%BCnster%2C%2048159%2C%20Germany"
    pageTitle="von Rhemen"
  />
);

export default VonRhemen;
