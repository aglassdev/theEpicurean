...
const CoeurDartichaut = () => (
  <RestaurantPage
    restaurantName="Coeur D'Artichaut"
    address="Alter Fischmarkt 11A, Münster, 48143, Germany"
    cuisine="Modern French, Creative"
    priceRange="€€€€"
    phoneNumber="+4925139582823"
    website="https://www.coeur-dartichaut.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Somewhat tucked away in a courtyard (where there is a fabulous terrace in summer) and just a stone's throw from the cathedral, this appealing casual fine dining restaurant awaits. Almost reminiscent of a stage in a theatre, the stylish dining area features a striking ceiling with densely packed pendant lights and an eye-catching open kitchen. Here, French-born Frédéric Morel draws on his Breton roots and incorporates influences from his adopted home in Northern Germany and adds a touch of modern creativity – his sauces and stocks are outstanding! When selecting his high-quality ingredients, he is mindful of the seasons and the region in which they are sourced. The Morel's Tasting set menu, which changes every month, is composed of six or eight courses. A four-course version is available on..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alter%20Fischmarkt%2011A%2C%20M%C3%BCnster%2C%2048143%2C%20Germany"
    pageTitle="Coeur D'Artichaut"
  />
);

export default CoeurDartichaut;
