...
const BokRestaurantBrustOderKeule = () => (
  <RestaurantPage
    restaurantName="BOK Restaurant Brust oder Keule"
    address="Melchersstraße 32, Münster, 48149, Germany"
    cuisine="Farm to table, Creative"
    priceRange="€€€"
    phoneNumber="+492519179656"
    website="https://www.brustoderkeule.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A few steps lead down to the attractive, minimalist-style restaurant on the ground floor of this smart corner-plot building. Laurin Kux presides in the kitchen, cooking up modern cuisine with seasonal influences. Dana, the chef's wife, is the woman behind the excellent and elaborate patisserie. The set menus are dubbed Flora (vegetarian) and Fauna and are available in four- to seven-course versions. The Schnuppermenü (Tue-Thu) is a lovely idea, too, offering as it does the option of a three-course meal comprising dishes taken from the full Flora/Fauna set menu. The ambitious house-made non-alcoholic drinks accompaniment is also recommended. The friendly and professional waitstaff provide astute wine recommendations. Pleasant little terrace in front of the building. Tip: At the bar, you can..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Melchersstra%C3%9Fe%2032%2C%20M%C3%BCnster%2C%2048149%2C%20Germany"
    pageTitle="BOK Restaurant Brust oder Keule"
  />
);

export default BokRestaurantBrustOderKeule;
