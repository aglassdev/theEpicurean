...
const KnipsersHalbstck = () => (
  <RestaurantPage
    restaurantName="Knipsers Halbstück"
    address="Hollergasse 2, Bissersheim, 67281, Germany"
    cuisine="Classic Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+4963599459211"
    website="https://halbstueck.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Knipsers, a well-known Laumersheim winemaking family, opened Halbstück back in 2014 as a Weinstube. Now it is Alsace native Christian Rubert – also known from Karlbacher, a restaurant in Großkarlbach – who is in charge in the kitchen. Influences from his homeland are evident in his dishes, which pair beautifully with the finest wines from Weingut Knisper. The appealing dinner menu includes French classics such as bouillabaisse, and halibut in lobster sauce. Or feel free to choose from the daily specials. At lunchtime, there is a three- to five-course menu. Laura Rubert ensures that guests receive a warm welcome in this cosy atmosphere. Lovely courtyard. Tip: They also offer interesting culinary events and wine tastings (for 10 people or more). In addition, rooms can be booked for weddi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hollergasse%202%2C%20Bissersheim%2C%2067281%2C%20Germany"
    pageTitle="Knipsers Halbstück"
  />
);

export default KnipsersHalbstck;
