...
const TanteAnna = () => (
  <RestaurantPage
    restaurantName="Tante Anna"
    address="Hauptstraße 58, Sprockhövel, 45549, Germany"
    cuisine="Modern Cuisine, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+49232479612"
    website="http://www.tanteanna-restaurant.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tastefully designed restaurant has an incredibly cosy atmosphere – the charming decor makes the space feel almost like a living room. International cuisine is served both indoors and out on the lovely terrace. Friendly service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2058%2C%20Sprockh%C3%B6vel%2C%2045549%2C%20Germany"
    pageTitle="Tante Anna"
  />
);

export default TanteAnna;
