...
const Habbels = () => (
  <RestaurantPage
    restaurantName="Habbel's"
    address="Gevelsberger Straße 127, Sprockhövel, 45549, Germany"
    cuisine="International, Farm to table"
    priceRange="€€"
    phoneNumber="+492339914312"
    website="https://habbel-restaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Habbel’s offers a fine-dining experience beyond compare. International dishes such as tuna carpaccio coated in wasabi-sesame seeds and saddle of lamb in thyme foam with grilled vegetables feature on the menu, while the wine list offers around 1, 000 wines and spirits from the Habbel in-house distillery, including a 1977-vintage whisky!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gevelsberger%20Stra%C3%9Fe%20127%2C%20Sprockh%C3%B6vel%2C%2045549%2C%20Germany"
    pageTitle="Habbel's"
  />
);

export default Habbels;
