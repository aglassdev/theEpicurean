...
const Hardthaus = () => (
  <RestaurantPage
    restaurantName="Hardthaus"
    address="Marktplatz 31, Kraiburg am Inn, 84559, Germany"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+49863873067"
    website="https://hardthaus.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this listed building, you are immersed in the charming ambience of what used to be a shop selling goods from the colonies. The floor-to-ceiling dark wooden shelves lining the walls, laden with all manner of decorative items, and the rustic old floorboards are striking. Fuss-free yet flavoursome dishes are served in generous portions at the elegantly set, bare wooden tables. The cuisine embraces international influences, with dishes on the menu such as creamy spicy king prawn with pea shoots and mango, or crown of Scottish lamb with a potato and olive oil purée, wild broccoli and a thyme jus. In summer, the terrace on the market square comes into its own. The 600-year-old vaulted cellar is a fantastic venue, especially for private functions. The pretty little boutique hotel opposite boas..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktplatz%2031%2C%20Kraiburg%20am%20Inn%2C%2084559%2C%20Germany"
    pageTitle="Hardthaus"
  />
);

export default Hardthaus;
