...
const SaxlersRestaurant = () => (
  <RestaurantPage
    restaurantName="Saxlers Restaurant"
    address="Uferallee 9, Zeltingen, 54492, Germany"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+496532680"
    website="https://www.hotel-stephanus.de/weinhotel.html"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Uferallee%209%2C%20Zeltingen%2C%2054492%2C%20Germany"
    pageTitle="Saxlers Restaurant"
  />
);

export default SaxlersRestaurant;
