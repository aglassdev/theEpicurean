...
const Maroots = () => (
  <RestaurantPage
    restaurantName="Ma'Roots"
    address="Sonnengasse 14A, Forstinning, 85661, Germany"
    cuisine="Seasonal Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+49812149499"
    website="https://ma-roots.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This centuries-old farmhouse with a timber façade exudes a rustic charm that has also been preserved inside. Here in the cosy and quaint converted Hofkücherl, diners tuck into the ambitious modern cuisine of Manuela Holzbauer and chef-patron Manuel Faltermeier. This revolves around Bavaria and the seasons and is served in the form of the three- to six-course Frühlingserwachen Menü (conventional or vegetarian), which changes every three weeks, and the four-course R90 set menu, made entirely with ingredients from within a 90km radius. The sustainable philosophy is evident in the choice of produce. Preserving and fermenting also play a role, which is reflected in various decorative preserving jars filled with fruit, vegetables, roots etc. The cordial Melanie Wimmer not only provides service b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sonnengasse%2014A%2C%20Forstinning%2C%2085661%2C%20Germany"
    pageTitle="Ma'Roots"
  />
);

export default Maroots;
