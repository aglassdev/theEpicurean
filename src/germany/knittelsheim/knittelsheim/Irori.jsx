...
const Irori = () => (
  <RestaurantPage
    restaurantName="irori"
    address="Hauptstraße 15a, Knittelsheim, 76879, Germany"
    cuisine="Creative, Japanese Contemporary"
    priceRange="€€€€"
    phoneNumber="+491752437801"
    website="https://irori.restaurant/irori-im-isenhof/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The charming old Isenhof, a gorgeous half-timbered house dating from the 17C, is the new home of Max Goldberg's irori fine dining concept, with which he previously made a name for himself in Neustadt an der Weinstraße. He skilfully combines regional ingredients and Japanese influences in his own unique way. The set menu on offer comprises nine courses – guests should plan for around four hours. A vegetarian version of the set menu is available if requested in advance. Kerstin Bauer, who presides in the cosy dining space as host and sommelier, will guide you through the evening and provide you with expert explanations of the dishes and wines. Should you wish to prolong your stay after your meal, there are two guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2015a%2C%20Knittelsheim%2C%2076879%2C%20Germany"
    pageTitle="irori"
  />
);

export default Irori;
