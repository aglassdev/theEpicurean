...
const Puricelli = () => (
  <RestaurantPage
    restaurantName="Puricelli"
    address="Burgweg 24, Trechtingshausen, 55413, Germany"
    cuisine="Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+4967216117"
    website="https://www.burg-reichenstein.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The location in the old castle ruins is glorious, and the view of the Rhine is spectacular – best enjoyed from the terrace. Inside, floor-to-ceiling windows frame the scenery beautifully. The kitchen takes its cue from the changing seasons and region, showcasing produce such as organic veal and venison from Oberheimbach, salmon trout from the Wisper Valley, zander from Lake Laach and vegetables and herbs from the castle's own garden. Alongside an excellent à la carte selection, there’s a choice of two set menus – one larger, one smaller. The wine list highlights local estates, including the castle’s own wine from its surrounding slopes. Burg Reichenstein hotel offers attractive, individually decorated guestrooms. Tip: Regular events are held here. A visit to the castle museum is definitely..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burgweg%2024%2C%20Trechtingshausen%2C%2055413%2C%20Germany"
    pageTitle="Puricelli"
  />
);

export default Puricelli;
