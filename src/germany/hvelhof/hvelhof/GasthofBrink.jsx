...
const GasthofBrink = () => (
  <RestaurantPage
    restaurantName="Gasthof Brink"
    address="Allee 38, Hövelhof, 33161, Germany"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+4952573223"
    website="https://guide.michelin.com/en/nordrhein-westfalen/hvelhof/restaurant/gasthof-brink"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A place with charm! The traditional style that is cultivated here will evoke childhood memories for many diners. Family-run since 1880, the restaurant serves classic French cuisine that is down to earth and delicious. The pleasant setting has an elegant feel. The house-made pâtés and terrines are just as popular as the saddle of veal with Béarnaise sauce or the sole meunière...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Allee%2038%2C%20H%C3%B6velhof%2C%2033161%2C%20Germany"
    pageTitle="Gasthof Brink"
  />
);

export default GasthofBrink;
