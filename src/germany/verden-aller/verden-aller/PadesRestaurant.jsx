...
const PadesRestaurant = () => (
  <RestaurantPage
    restaurantName="Pades Restaurant"
    address="Grüne Straße 15, Verden (Aller), 27283, Germany"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+4942313060"
    website="https://www.pades.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wolfgang Pade offers a constantly changing menu, which is based on the availability of produce and relies on regional producers. Please note that there are only two service times: 5.45pm and 8.15pm – so make your reservation in good time! The garden terrace behind the pretty patrician house is magnificent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gr%C3%BCne%20Stra%C3%9Fe%2015%2C%20Verden%20(Aller)%2C%2027283%2C%20Germany"
    pageTitle="Pades Restaurant"
  />
);

export default PadesRestaurant;
