...
const StubnInDerFrasdorferHtte = () => (
  <RestaurantPage
    restaurantName="STUBN in der Frasdorfer Hütte"
    address="Zellboden, Frasdorf, 83112, Germany"
    cuisine="Alpine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber=""
    website="https://www.stubn.co"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This exclusive mountain-top location, surrounded by woods and meadows, really is the stuff of dreams. What was once a hiking lodge is now a cosy restaurant serving modern Alpine cuisine that can only be reached on foot (50 minutes from the Lederstube car park) or by booking a shuttle bus. Diners seated at the front can see the chefs at work in the open kitchen, grilling top-quality produce over an open fire. A shining example is the super-fresh Chiemsee pike-perch with bold roasted aromas, accompanied by an intensely flavoursome Jerusalem artichoke puree and crunchy rapini – a delightfully accessible combination. You can choose à la carte from a short list of options or have a surprise menu put together for you. The evening menu is also available at lunchtime, if requested in advance. The ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zellboden%2C%20Frasdorf%2C%2083112%2C%20Germany"
    pageTitle="STUBN in der Frasdorfer Hütte"
  />
);

export default StubnInDerFrasdorferHtte;
