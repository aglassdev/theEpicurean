...
const Bahnhfle = () => (
  <RestaurantPage
    restaurantName="Bahnhöfle"
    address="Bahnhofstraße 16, Gundelfingen, 79194, Germany"
    cuisine="Classic French, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+497615899949"
    website="https://bahnhoefle-gundelfingen.eatbu.com/?lang=en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The friendly host cooks French and international dishes. Prettily decorated by his wife, the restaurant radiates country charm. Lovely terrace at the front...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofstra%C3%9Fe%2016%2C%20Gundelfingen%2C%2079194%2C%20Germany"
    pageTitle="Bahnhöfle"
  />
);

export default Bahnhfle;
