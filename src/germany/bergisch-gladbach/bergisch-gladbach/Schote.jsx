...
const Schote = () => (
  <RestaurantPage
    restaurantName="Schote"
    address="Diepeschrather Weg 80, Bergisch Gladbach, 51469, Germany"
    cuisine="International, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+492202271170"
    website="https://www.diepeschrather-muehle.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After Nelson Müller and his entire team moved from Essen to Bergisch Gladbach, the likeable restaurateur and celebrity chef now offers his fine dining cuisine at the Diepeschrather Mühle, a former mill set in beautiful natural surroundings. They serve a modern, seasonal set menu comprising five or seven courses – the delicious tapas are a great way to start the meal. The vegetarian version of the set menu, dubbed No Meat No Fish, needs to be booked two days in advance. You can also opt into the wine pairings. Here at the new location, there is also an alternative restaurant: Müllers in der Mühle brasserie. For a really chic overnight stay, this gorgeous property also houses an exquisite boutique hotel with tasteful, modern guestrooms and suites, as well as an attractive wellness and spa ar..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Diepeschrather%20Weg%2080%2C%20Bergisch%20Gladbach%2C%2051469%2C%20Germany"
    pageTitle="Schote"
  />
);

export default Schote;
