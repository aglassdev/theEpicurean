...
const Luise = () => (
  <RestaurantPage
    restaurantName="LUISE"
    address="Luisenhöhestraße 14, Horben, 79289, Germany"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+49761137330"
    website="https://www.luisenhoehe-hotel.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The beautiful landscape here is perfectly complemented by the elliptical shape of Luisenhöhe hotel, which gracefully blends into its surroundings. Inside, too, modern design and high-quality natural materials make for an attractive decor that pays homage to the region – both in the guestrooms and the restaurant. The latter has a pleasantly laid-back feel, and a large glass façade looks out onto the terrace and beyond to the Black Forest and the Schauinsland mountain. Prepared in the open kitchen, the vegetarian set menu comprises four courses such as ancient grains salad with chard and sweet potato, or carrot with physalis and madras curry – meat, fish and even shellfish are available as add-ons. The excellent wine list features a good selection of German and international labels. The futu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Luisenh%C3%B6hestra%C3%9Fe%2014%2C%20Horben%2C%2079289%2C%20Germany"
    pageTitle="LUISE"
  />
);

export default Luise;
