...
const RousselsRestaurantLaBonneAdresse = () => (
  <RestaurantPage
    restaurantName="Roussel's Restaurant La Bonne Adresse"
    address="Am Ring 37, Bernkastel-Kues, 54470, Germany"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+49653197260"
    website="https://roussel.de/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thierry Roussel and Jane Kölchens run this place with dedication. The elegant restaurant exudes cosiness, and the extremely friendly service, directed by your hostess, also contributes to the pleasant atmosphere. At beautifully laid tables, upscale classic cuisine is served in the form of set menus (one vegetarian) or à la carte. They are also happy to share their wine recommendations, including some from their own production. Plus: guestrooms where you will feel right at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Ring%2037%2C%20Bernkastel-Kues%2C%2054470%2C%20Germany"
    pageTitle="Roussel's Restaurant La Bonne Adresse"
  />
);

export default RousselsRestaurantLaBonneAdresse;
