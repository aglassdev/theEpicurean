...
const ChevalBlanc = () => (
  <RestaurantPage
    restaurantName="Cheval Blanc"
    address="Am Kirchberg 1, Illschwang, 92278, Germany"
    cuisine="Classic Cuisine, Modern French"
    priceRange="€€€€"
    ...
    pageTitle="Cheval Blanc"
  />
);

export default ChevalBlanc;
