...
const Chiemgauhof = () => (
  <RestaurantPage
    restaurantName="Chiemgauhof"
    address="Julius-Exter-Promenade 21, Übersee, 83236, Germany"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+4986423179800"
    website="https://www.chiemgauhof.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of the exclusive Chiemgau Lakeside Retreat, an offshoot of the nearby Resort Das Achental in Grassau, draws you in with its enticing location right on Chiemsee. In fine weather, the lake view is best enjoyed from the terrace, but thanks to the floor-to-ceiling windows, you won't be deprived even if you dine inside. The decor in the dining rooms, which can be separated off by means of a glass partition, is an attractive blend of traditional regional elements such as warm wood and a stylish classic tiled stove and modern sleek lines. This combination is also reflected in the cuisine: Maximilian Müller remains true to the region while also drawing on modern influences – for example, marinated lake trout from Müllnerhof fish farm, coriander, celery, verjus, or classics such as b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Julius-Exter-Promenade%2021%2C%20%C3%9Cbersee%2C%2083236%2C%20Germany"
    pageTitle="Chiemgauhof"
  />
);

export default Chiemgauhof;
