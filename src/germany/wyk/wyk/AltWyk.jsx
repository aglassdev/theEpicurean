...
const AltWyk = () => (
  <RestaurantPage
    restaurantName="Alt Wyk"
    address="Große Straße 4, Wyk, 25938, Germany"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+4946813212"
    website="https://www.alt-wyk.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gro%C3%9Fe%20Stra%C3%9Fe%204%2C%20Wyk%2C%2025938%2C%20Germany"
    pageTitle="Alt Wyk"
  />
);

export default AltWyk;
