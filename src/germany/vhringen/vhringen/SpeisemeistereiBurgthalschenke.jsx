...
const SpeisemeistereiBurgthalschenke = () => (
  <RestaurantPage
    restaurantName="Speisemeisterei Burgthalschenke"
    address="Untere Hauptstraße 4, Vöhringen, 89269, Germany"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4973065265"
    website="https://speisemeisterei-burgthalschenke.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Großhammer family has been renowned for its good cooking for years! Diners can choose between the set menu or classic dishes. The cuisine follows the seasons, with ingredients being sourced in the local area. Laid out over three levels, the restaurant also has a lovely terrace. On a practical note: large car park...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untere%20Hauptstra%C3%9Fe%204%2C%20V%C3%B6hringen%2C%2089269%2C%20Germany"
    pageTitle="Speisemeisterei Burgthalschenke"
  />
);

export default SpeisemeistereiBurgthalschenke;
