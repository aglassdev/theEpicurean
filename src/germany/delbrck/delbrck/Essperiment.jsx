...
const Essperiment = () => (
  <RestaurantPage
    restaurantName="ESSperiment"
    address="Schöninger Straße 74, Delbrück, 33129, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4952509956377"
    website="https://www.restaurant-essperiment.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This relaxed modern restaurant with its lovely terrace offers a bistro menu at lunchtimes and fine dining in the evenings. The food is fresh and flavoursome. Try the saddle of venison with muesli, black salsify, pear and layered potato cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sch%C3%B6ninger%20Stra%C3%9Fe%2074%2C%20Delbr%C3%BCck%2C%2033129%2C%20Germany"
    pageTitle="ESSperiment"
  />
);

export default Essperiment;
