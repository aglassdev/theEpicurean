...
const LeFrankenberg = () => (
  <RestaurantPage
    restaurantName="Le Frankenberg"
    address="Schloß Frankenberg 1, Weigenheim, 97215, Germany"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+49933997140"
    website="https://www.schloss-frankenberg.de"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlo%C3%9F%20Frankenberg%201%2C%20Weigenheim%2C%2097215%2C%20Germany"
    pageTitle="Le Frankenberg"
  />
);

export default LeFrankenberg;
