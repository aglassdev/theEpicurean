...
const DuttersStube = () => (
  <RestaurantPage
    restaurantName="Dutters Stube"
    address="Winterstraße 28, Endingen am Kaiserstuhl, 79346, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+4976421786"
    website="https://www.dutters-stube.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Dutter family have been running this charming 16C inn for four generations, and the seasonal and regional cuisine served here is a hit. Their Stubenrestaurant is more sophisticated (the set menu is popular); the Dorfwirtschaft serves simpler fare, such as flammkuchen and rump steak. As an alternative to the terrace, there is the pretty summerhouse. Chef Arthur Dutter is a member of the charity Deutsche Fußballköche (German football chefs)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Winterstra%C3%9Fe%2028%2C%20Endingen%20am%20Kaiserstuhl%2C%2079346%2C%20Germany"
    pageTitle="Dutters Stube"
  />
);

export default DuttersStube;
