...
const MerklesRestaurant = () => (
  <RestaurantPage
    restaurantName="Merkles Restaurant"
    address="Hauptstraße 2, Endingen am Kaiserstuhl, 79346, Germany"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+4976427900"
    website="https://www.merkles-restaurant.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It is safe to say that Thomas Merkle made the right decision when, together with his wife, he took over his parents' business and continued the tradition of hospitality that has been cultivated here for over 30 years. Born in Endingen, he proudly showcases his affinity with his homeland by opting for regional ingredients, but also introduces a dash of cosmopolitan flair to his well-thought-out dishes with flavours from far-flung lands. Top-quality produce, accomplished service and an appealing array of wines by the glass. The chef and his kitchen team also like to show their faces in the dining room – contact with the guests is important to them! This historical vicarage with a sleek and elegant interior makes for a pleasant setting. Good to know: Delicious treats in the form of house-made..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%202%2C%20Endingen%20am%20Kaiserstuhl%2C%2079346%2C%20Germany"
    pageTitle="Merkles Restaurant"
  />
);

export default MerklesRestaurant;
