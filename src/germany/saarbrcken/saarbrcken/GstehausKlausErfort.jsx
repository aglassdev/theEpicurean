...
const GstehausKlausErfort = () => (
  <RestaurantPage
    restaurantName="GästeHaus Klaus Erfort"
    address="Mainzer Straße 95, Saarbrücken, 66121, Germany"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+496819582682"
    website="https://www.gaestehaus-erfort.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Klaus Erfort's restaurant in this stylish white villa remains a beacon of French cuisine – a place to indulge in the great classics! Uncompromising in his choice of ingredients, he creates dishes that are harmoniously balanced, the flavours teased out with finesse. Behind deceptively simple-sounding names such as lamb, aubergine, jus, elaborate details are abundant. The excellent quality Limousin lamb is shown off to its best advantage in a trio of dishes: fillet of loin gratinated with herbs and cooked until pink in the middle; juicy, intensely flavoured pork chops; and aromatic, braised and crispy gratinated belly – accompanied by a fantastic lamb jus with a lovely sheen, deep colour and full flavour, as well as a finely spiced aubergine caviar. This scene of sophistication is completed ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mainzer%20Stra%C3%9Fe%2095%2C%20Saarbr%C3%BCcken%2C%2066121%2C%20Germany"
    pageTitle="GästeHaus Klaus Erfort"
  />
);

export default GstehausKlausErfort;
