...
const AuLac51 = () => (
  <RestaurantPage
    restaurantName="au lac 51"
    address="Seestraße 51, Rottach-Egern, 83700, Germany"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+498022660257"
    website="https://www.aulac51.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The location on the promenade is fabulous – in summer, tables on the terrace overlooking the lake are in great demand! But you can also take in the vista from indoors – the window seats in this cosy modern restaurant are popular, too. Featuring a diverse range of options, from classic favourites to Mediterranean and Asian-inspired dishes, the menu has something for everyone. Friendly and adept service...."
