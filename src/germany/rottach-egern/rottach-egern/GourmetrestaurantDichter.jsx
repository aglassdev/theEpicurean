...
const GourmetrestaurantDichter = () => (
  <RestaurantPage
    ...
    pageTitle="Gourmetrestaurant Dichter"
  />
);

export default GourmetrestaurantDichter;
