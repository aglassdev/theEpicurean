...
const Fhrhtte14 = () => (
  <RestaurantPage
    restaurantName="Fährhütte 14"
    address="Weißachdamm 50, Rottach-Egern, 83700, Germany"
    cuisine="International, Farm to table"
    priceRange="€€"
    phoneNumber="+498022188220"
    website="https://www.althoffcollection.com/de/althoff-seehotel-ueberfahrt/restaurants-und-bar/faehrhuette-14"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, an offshoot of Überfahrt, enjoys an idyllic lakeside location. The modern decor has a touch of rustic maritime flair while the service is friendly and accomplished. International and seasonal dishes. You will also have the opportunity to rent a deckchair on the beach! N.B. the restaurant is not accessible by car – getting there involves a 300m walk...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wei%C3%9Fachdamm%2050%2C%20Rottach-Egern%2C%2083700%2C%20Germany"
    pageTitle="Fährhütte 14"
  />
);

export default Fhrhtte14;
