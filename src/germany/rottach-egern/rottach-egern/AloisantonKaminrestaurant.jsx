...
const AloisantonKaminrestaurant = () => (
  <RestaurantPage
    restaurantName="Alois-Anton Kaminrestaurant"
    address="Aribostraße 19, Rottach-Egern, 83700, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€€"
    phoneNumber="+498022666502"
    website="https://www.egerner-hoefe.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A good alternative to the fine dining restaurant of the Park-Hotel Egerner Höfe. The choice is yours: dine in the cosy Bavarian-style dining rooms dubbed Alois and Anton or in the more upmarket Kaminrestaurant. Just as charming is the terrace, which is sheltered from the wind and has a view of the pastures and mountains. Either way, you can enjoy cordial service and regional and seasonal dishes in a pleasantly laid-back atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aribostra%C3%9Fe%2019%2C%20Rottach-Egern%2C%2083700%2C%20Germany"
    pageTitle="Alois-Anton Kaminrestaurant"
  />
);

export default AloisantonKaminrestaurant;
