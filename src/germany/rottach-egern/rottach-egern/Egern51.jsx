...
const Egern51 = () => (
  <RestaurantPage
    restaurantName="EGERN 51"
    address="Seestraße 51, Rottach-Egern, 83700, Germany"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+498022660257"
    website="https://www.egern51.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The location on the promenade is fabulous – in summer, tables on the terrace overlooking Egerner Bucht (Egern Bay) are in great demand! But you can also take in the vista from indoors – the window seats in this cosy modern restaurant are popular, too. The kitchen draws its inspiration from Euro-Asian cuisine. Featuring a diverse range of options, from classic favourites to Mediterranean and Asian-influenced dishes, the menu has something for everyone. Friendly and adept service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestra%C3%9Fe%2051%2C%20Rottach-Egern%2C%2083700%2C%20Germany"
    pageTitle="EGERN 51"
  />
);

export default Egern51;
