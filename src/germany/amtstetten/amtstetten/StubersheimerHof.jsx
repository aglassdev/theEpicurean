...
const StubersheimerHof = () => (
  <RestaurantPage
    restaurantName="Stubersheimer Hof"
    address="Bräunisheimer Straße 1, Amtstetten, 73340, Germany"
    cuisine="Classic Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+4973314429970"
    website="https://www.stubersheimer-hof.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The tasteful decor of this lovingly restored old farmhouse exudes rural charm. In the pleasant dining area with its attractive wooden flooring, diners are treated to a friendly welcome and delicious regional fare prepared by the junior chef. In summer, there's no better place to dine than in the charming courtyard. And if you're looking for a place to stay overnight, the family-run business also has lovely guestrooms available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Br%C3%A4unisheimer%20Stra%C3%9Fe%201%2C%20Amtstetten%2C%2073340%2C%20Germany"
    pageTitle="Stubersheimer Hof"
  />
);

export default StubersheimerHof;
