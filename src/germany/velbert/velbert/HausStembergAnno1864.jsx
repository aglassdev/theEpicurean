...
const HausStembergAnno1864 = () => (
  <RestaurantPage
    restaurantName="Haus Stemberg"
    address="Kuhlendahler Straße 295, Velbert, 42553, Germany"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4920535649"
    website="https://haus-stemberg.de/"
    aliases={["Haus Stemberg ANNO 1864"]}
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kuhlendahler%20Stra%C3%9Fe%20295%2C%20Velbert%2C%2042553%2C%20Germany"
    pageTitle="Haus Stemberg"
  />
);

export default HausStembergAnno1864;
