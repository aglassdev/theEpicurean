...
const Alexxanders = () => (
  <RestaurantPage
    restaurantName="alexxanders"
    address="Ludwig-Kirsch-Straße 9, Chemnitz, 09130, Germany"
    cuisine="International, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+493714311111"
    website="https://www.alexxanders.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a residential area, this restaurant boasts a stylish interior and a courtyard terrace with a beautifully landscaped little garden. The flavoursome dishes draw inspiration from around the globe and incorporate Mediterranean and seasonal influences. Why not enjoy an aperitif at the bar before your meal? The wine list is also worth a look. Guestrooms with modern interior design are available in the hotel of the same name...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ludwig-Kirsch-Stra%C3%9Fe%209%2C%20Chemnitz%2C%2009130%2C%20Germany"
    pageTitle="alexxanders"
  />
);

export default Alexxanders;
