...
const Anetseder = () => (
  <RestaurantPage
    restaurantName="Anetseder"
    address="Lindenstraße 15, Hauzenberg, 94051, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+4985861314"
    website="https://www.anetseder-wirtshauskultur.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional German public house culture is alive and well here, and at the same time they tap into the zeitgeist. The lovely dining space has a high ceiling and a trendy, modern feel and the waitstaff are friendly. They serve fresh and tasty food, with seasonal ingredients, preferably from the region, taking pride of place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lindenstra%C3%9Fe%2015%2C%20Hauzenberg%2C%2094051%2C%20Germany"
    pageTitle="Anetseder"
  />
);

export default Anetseder;
