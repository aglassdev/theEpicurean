...
const LandgasthausGidibauerhof = () => (
  <RestaurantPage
    restaurantName="Landgasthaus Gidibauer-Hof"
    address="Grub 7, Hauzenberg, 94051, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€"
    phoneNumber="+49858696440"
    website="https://www.gidibauer.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You eat well here, and furthermore the regional cuisine comes at very fair prices. The home-reared beef, for example, is sure to whet the appetite. The ambience is friendly, cosy and rustic. The converted cowshed is a great venue for parties. In the hotel of the same name, the guestrooms are furnished with natural wood furniture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grub%207%2C%20Hauzenberg%2C%2094051%2C%20Germany"
    pageTitle="Landgasthaus Gidibauer-Hof"
  />
);

export default LandgasthausGidibauerhof;
