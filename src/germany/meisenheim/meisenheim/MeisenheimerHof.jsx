...
const MeisenheimerHof = () => (
  <RestaurantPage
    restaurantName="Meisenheimer Hof"
    address="Obergasse 33, Meisenheim, 55590, Germany"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+4967531237780"
    website="https://www.meisenheimer-hof.de/startseite/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Obergasse%2033%2C%20Meisenheim%2C%2055590%2C%20Germany"
    pageTitle="Meisenheimer Hof"
  />
);

export default MeisenheimerHof;
