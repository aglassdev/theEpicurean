...
const SteinbuckStube = () => (
  <RestaurantPage
    restaurantName="Steinbuck Stube"
    address="Talstraße 2, Vogtsburg im Kaiserstuhl, 79235, Germany"
    cuisine="Classic Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+497662911210"
    website="https://steinbuck-stube.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of town is this pretty, lavishly restored 400-year-old house. You can sit in the cosy, tastefully decorated restaurant, in the modern wine bar or on the terrace that adjoins the two. There, you will be served seasonal and Mediterranean-influenced classic dishes, accompanied exclusively by regional wines. There are also guestrooms for a pleasant overnight stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Talstra%C3%9Fe%202%2C%20Vogtsburg%20im%20Kaiserstuhl%2C%2079235%2C%20Germany"
    pageTitle="Steinbuck Stube"
  />
);

export default SteinbuckStube;
