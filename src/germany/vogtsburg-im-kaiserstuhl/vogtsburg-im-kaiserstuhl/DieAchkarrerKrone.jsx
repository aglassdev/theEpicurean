...
const DieAchkarrerKrone = () => (
  <RestaurantPage
    restaurantName="Die Achkarrer Krone"
    address="Schlossbergstraße 15, Vogtsburg im Kaiserstuhl, 79235, Germany"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+49766293130"
    website="https://www.hotel-krone-achkarren.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The culinary tradition at Zur Krone dates back to 1561. Today you can look forward to a plate of calf’s kidney, tripe or oxtail stew, and in summer, a delicious sausage salad. The Baden cuisine and wines can be enjoyed in the cosy dining room or on the terrace. Comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlossbergstra%C3%9Fe%2015%2C%20Vogtsburg%20im%20Kaiserstuhl%2C%2079235%2C%20Germany"
    pageTitle="Die Achkarrer Krone"
  />
);

export default DieAchkarrerKrone;
