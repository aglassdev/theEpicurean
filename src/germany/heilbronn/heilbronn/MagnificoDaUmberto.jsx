...
const MagnificoDaUmberto = () => (
  <RestaurantPage
    restaurantName="Magnifico da Umberto"
    address="Im Zukunftspark 10, Heilbronn, 74076, Germany"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+49713174564140"
    website="https://wtz-magnifico.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Umberto Scuccia is a well-known figure in Heilbronn. Here on the 12th floor of the WTZ Tower he runs an upmarket, minimalist-style restaurant offering both pleasantly pared-down Italian cuisine with the accent on top-quality produce and a wonderful view of the city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Im%20Zukunftspark%2010%2C%20Heilbronn%2C%2074076%2C%20Germany"
    pageTitle="Magnifico da Umberto"
  />
);

export default MagnificoDaUmberto;
