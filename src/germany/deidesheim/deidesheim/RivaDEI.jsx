...
const RivaDEI = () => (
  <RestaurantPage
    restaurantName="riva"
    address="Weinstraße 12, Deidesheim, 67146, Germany"
    cuisine="International, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+496326700077"
    website="https://www.kaisergarten-deidesheim.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in Kaisergarten Hotel – the sister establishment of Ketschauer Hof, also located in central Deidesheim – this restaurant has a sleek interior done out in light natural tones. In this setting, pleasingly laid-back, friendly and professional waitstaff serve up delicious international and Mediterranean cuisine. The menu also features barbecued meats prepared on the Big Green Egg, along with options for fans of pizza. The selection of wines from the hotel group's own vineyards is excellent. RIVA Bar-Lounge is the perfect spot for a cocktail. The terrace overlooking the garden is delightful in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weinstra%C3%9Fe%2012%2C%20Deidesheim%2C%2067146%2C%20Germany"
    pageTitle="riva"
  />
);

export default RivaDEI;
