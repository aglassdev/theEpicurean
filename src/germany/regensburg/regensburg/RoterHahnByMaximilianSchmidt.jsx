...
const RoterHahnByMaximilianSchmidt = () => (
  <RestaurantPage
    restaurantName="ROTER HAHN by Maximilian Schmidt"
    address="Rote-Hahnen-Gasse 10, Regensburg, 93047, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+49941595090"
    website="https://www.roter-hahn.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This townhouse in the heart of Regensburg has a long history behind it. It has been an inn for centuries, with the earliest written record of it dating back to the 13C. Maximilian Schmidt now represents the third generation of the family to take the helm. In a pleasingly informal atmosphere, they serve up modern cuisine marked by the chef's refreshingly individual flair. International influences are seamlessly woven in, achieving fantastic results in dishes such as lahmacun with pulled piglet's tail, and Korean-style fried veal sweetbreads with gochujang. The regional sturgeon from Marco is also exceptional, and comes accompanied by a velvety burnt cream and pine oil sauce, along with delicately sour pickled white asparagus. You can opt for a three-, five- or eight-course dinner. A shorter..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rote-Hahnen-Gasse%2010%2C%20Regensburg%2C%2093047%2C%20Germany"
    pageTitle="ROTER HAHN by Maximilian Schmidt"
  />
);

export default RoterHahnByMaximilianSchmidt;
