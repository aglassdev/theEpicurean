...
const ScheidelsRestaurantZumKranz = () => (
  <RestaurantPage
    restaurantName="Scheidels Restaurant zum Kranz"
    address="Offenburger Straße 18, Kenzingen, 79341, Germany"
    cuisine="Classic Cuisine, Home Cooking"
    priceRange="€€"
    phoneNumber="+4976446855"
    website="https://www.scheidels-kranz.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Conscious of their long family history (the restaurant is now run by the seventh generation), the owners here are committed to maintaining their traditions yet the food remains resolutely down-to-earth. Charming historic ambience, plus warm and welcoming staff. Simple, tasty dishes take pride of place, inspired by regional and seasonal produce. A vegetarian menu is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Offenburger%20Stra%C3%9Fe%2018%2C%20Kenzingen%2C%2079341%2C%20Germany"
    pageTitle="Scheidels Restaurant zum Kranz"
  />
);

export default ScheidelsRestaurantZumKranz;
