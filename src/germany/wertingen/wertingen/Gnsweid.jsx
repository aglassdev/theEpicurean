...
const Gnsweid = () => (
  <RestaurantPage
    restaurantName="Gänsweid"
    address="Gänsweid 1, Wertingen, 86637, Germany"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+498272642132"
    website="https://www.gaensweid.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this carefully restored former garage, it is a case of ‘olive oil not engine oil’! Enjoy your meal in a relaxed atmosphere where you can watch the cooks preparing their fresh mixture of Swabian and Mediterranean dishes in the kitchen. Simple, good value menu only at lunchtimes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=G%C3%A4nsweid%201%2C%20Wertingen%2C%2086637%2C%20Germany"
    pageTitle="Gänsweid"
  />
);

export default Gnsweid;
