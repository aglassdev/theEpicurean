...
const GoldenPhoenix = () => (
  <RestaurantPage
    restaurantName="Golden Phoenix"
    address="Brandenburgische Straße 21, Berlin, 10707, Germany"
    cuisine="Chinese, French"
    priceRange="€€€"
    phoneNumber="+4915164625945"
    website="https://www.goldenphoenix.berlin"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brandenburgische%20Stra%C3%9Fe%2021%2C%20Berlin%2C%2010707%2C%20Germany"
    pageTitle="Golden Phoenix"
  />
);

export default GoldenPhoenix;
