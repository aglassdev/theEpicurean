...
const Facil = () => (
  <RestaurantPage
    ...
    address="Potsdamer Straße 3, Berlin, 10785, Germany"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+4930590051234"
    website="https://facil.de/de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A real oasis of calm in the middle of Berlin! Up here on the fifth floor of The Mandala Hotel, diners can sit on the pleasant little terrace amid the chestnut trees and fountain – you can truly escape the hustle and bustle of the city! Even inside this chic, light and airy rooftop garden restaurant you almost feel like you're outdoors thanks to the all-round floor-to-ceiling windows. Beautiful bamboo plants give a nod to Asia. On top of the location, Facil also boasts incredible food courtesy of Michael Kempf (culinary director) and Joachim Gerner (head chef). Imbued with a healthy dose of creativity, the five- to eight-course set menu showcases fantastic ingredients and their flavours. Asian and Mediterranean influences are also skilfully incorporated. Take, for example, the charcoal-gril..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Potsdamer%20Stra%C3%9Fe%203%2C%20Berlin%2C%2010785%2C%20Germany"
    pageTitle="FACIL"
  />
);
