...
const KurpfalzWeinstuben = () => (
  <RestaurantPage
    restaurantName="Kurpfalz Weinstuben"
    address="Wilmersdorfer Straße 93, Berlin, 10629, Germany"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+49308836664"
    website="https://kurpfalz-weinstuben.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A typical Palatinate wine tavern in the middle of Berlin? At Adenauerplatz near Ku'damm, you will find this traditional bar tucked away in a courtyard. In cosy, rustic rooms you can enjoy home-style cooking and regional classics, along with 50 wines served by the glass and 800 on the wine list. Short menu of the day at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wilmersdorfer%20Stra%C3%9Fe%2093%2C%20Berlin%2C%2010629%2C%20Germany"
    pageTitle="Kurpfalz Weinstuben"
  />
);

export default KurpfalzWeinstuben;
