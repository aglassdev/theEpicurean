...
const KleinesMeer = () => (
  <RestaurantPage
    restaurantName="Kleines Meer"
    address="Alter Markt 7, Waren, 17192, Germany"
    cuisine="Farm to table, German"
    priceRange="€€"
    phoneNumber="+493991648200"
    website="https://www.restaurant-kleinesmeer.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Laid out over two levels, this convivial restaurant has exposed roof timbering that lends a pleasant airy atmosphere. Lake Müritz is just in front of the building, making the terrace with its small lounge area a popular spot with guests. Made from good-quality ingredients, the cuisine here is regional and seasonal; there are also vegetarian options. The hotel of the same name has well-kept guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alter%20Markt%207%2C%20Waren%2C%2017192%2C%20Germany"
    pageTitle="Kleines Meer"
  />
);

export default KleinesMeer;
