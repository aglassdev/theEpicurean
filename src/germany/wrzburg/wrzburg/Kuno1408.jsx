...
const Kuno1408 = () => (
  <RestaurantPage
    restaurantName="KUNO 1408"
    address="Neubaustraße 7, Würzburg, 97070, Germany"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+4993130931408"
    website="https://www.restaurant-kuno.de/main/index.php"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This really lovely restaurant located in the centre of the Baroque city has a long tradition dating back to 1408. Kuno von Rebstock is said to have been one of the first owners of the Zum Rebstock estate at that time – hence the name. Today, diners can look forward to the ingredient-led cuisine of chef duo Robin Hofmann and Patrick Grieshaber. Creative modern dishes such as pike ceviche with carrot, egg and parmesan are served as part of a four- to six-course set menu by a well-drilled yet friendly and relaxed front-of-house team who give excellent advice on wine pairings. The restaurant itself is also pleasing on the eye, with its modern, elegant interior done out in warm and earthy tones and furnished with chic armchairs, and designer lamps. For overnight stays, the Hotel Rebstock propos..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Neubaustra%C3%9Fe%207%2C%20W%C3%BCrzburg%2C%2097070%2C%20Germany"
    pageTitle="KUNO 1408"
  />
);

export default Kuno1408;
