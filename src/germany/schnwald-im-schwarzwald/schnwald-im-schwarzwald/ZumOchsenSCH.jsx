...
const ZumOchsenSCH = () => (
  <RestaurantPage
    ...
    address="Ludwig-Uhland-Straße 18, Schönwald im Schwarzwald, 78141, Germany"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+497722866480"
    website="https://www.ochsen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The atmosphere is really cosy in this restaurant, which is charmingly done out in the traditional style typical of the region. The kitchen serves up flavoursome, ambitious dishes with a regional and seasonal focus, as well as the occasional international twist. For overnight guests, this long-standing family-run establishment offers comfortable guestrooms and a spa with a range of facilities and treatments and a swimming pool...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ludwig-Uhland-Stra%C3%9Fe%2018%2C%20Sch%C3%B6nwald%20im%20Schwarzwald%2C%2078141%2C%20Germany"
    pageTitle="Zum Ochsen"
  />
);

export default ZumOchsenSCH;
