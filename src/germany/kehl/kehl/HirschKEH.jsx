...
const HirschKEH = () => (
  <RestaurantPage
    ...
    address="Gerbereistraße 20, Kehl, 77694, Germany"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+49785199160"
    website="https://www.hirsch-kork.de/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gerbereistra%C3%9Fe%2020%2C%20Kehl%2C%2077694%2C%20Germany"
    pageTitle="Hirsch"
  />
);

export default HirschKEH;
