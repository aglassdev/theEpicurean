...
const Bodendorfs = () => (
  <RestaurantPage
    restaurantName="BODENDORF'S"
    address="Boy-Nielsen-Straße 10, Tinnum, 25980, Germany"
    cuisine="Modern French, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+49465188990"
    website="https://www.landhaus-stricker.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boy-Nielsen-Stra%C3%9Fe%2010%2C%20Tinnum%2C%2025980%2C%20Germany"
    pageTitle="BODENDORF'S"
  />
);

export default Bodendorfs;
