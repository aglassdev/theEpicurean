...
const ColombiRestaurantZirbelstube = () => (
  <RestaurantPage
    restaurantName="Colombi Restaurant Zirbelstube"
    address="Rotteckring 16, Freiburg im Breisgau, 79098, Germany"
    cuisine="Classic French, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+4976121060"
    website="https://www.colombi.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="One of the great classics of South Baden gastronomy is located in the internationally renowned Colombi Hotel and, in Sven Usinger, boasts a chef with experience of Michelin-starred kitchens. French classics are showcased here, prepared with feeling and finesse, and excellent ingredients. There is a set menu with four, five or six courses which you can also choose à la carte. In addition, there is the elegant yet inviting atmosphere of the Zirbelstube with its beautiful wood panelling (which inspired its name). Sit back and relax in the comfortable Falkenstube, which oozes traditional charm. The wine list is excellent!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rotteckring%2016%2C%20Freiburg%20im%20Breisgau%2C%2079098%2C%20Germany"
    pageTitle="Colombi Restaurant Zirbelstube"
  />
);

export default ColombiRestaurantZirbelstube;
