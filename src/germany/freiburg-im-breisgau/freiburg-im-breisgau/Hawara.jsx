...
const Hawara = () => (
  <RestaurantPage
    restaurantName="Hawara"
    address="Dreikönigstraße 8, Freiburg im Breisgau, 79102, Germany"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+4976175784"
    website="https://www.hawara-restaurant.de/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nicolai Heuer and Yannik Spielmann are living out their sustainable culinary philosophy in this pleasingly unpretentious restaurant. Using ingredients from their own garden in St Georgen and from organic producers in the region, they devise a set menu that changes with the seasons – a vegetarian version is also available. Mains such as smoked catfish, organic potatoes, physalis, and exciting desserts such as ice cream made from roasted potato peel, pear Hélène hit the spot with their interesting contrasts and full-bodied flavours. Wednesday is Bistro night, when a smaller menu and an à la carte selection are served. The space is cosy and has a trendy decor featuring attractive individual decorative details that lend it character. There is an inviting, secluded terrace in front of the house..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dreik%C3%B6nigstra%C3%9Fe%208%2C%20Freiburg%20im%20Breisgau%2C%2079102%2C%20Germany"
    pageTitle="Hawara"
  />
);

export default Hawara;
