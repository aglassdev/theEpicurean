...
const KuroMori = () => (
  <RestaurantPage
    restaurantName="Kuro Mori"
    address="Grünwälderstraße 2, Freiburg im Breisgau, 79098, Germany"
    cuisine="Asian Influences, Contemporary"
    priceRange="€€"
    phoneNumber="+4976138848226"
    website="https://www.kuro-mori.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Black Forest meets Asia is the motto of this cool, stylish restaurant located in Freiburg's beautiful old town. Kuro mori is Japanese for black forest. Here, modern dishes are conjured up from high-quality ingredients in an open kitchen. There is currently a reduced daily offer of dishes with a surprise set menu. In addition, only online reservations are currently possible - please be prepared for flexible opening hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gr%C3%BCnw%C3%A4lderstra%C3%9Fe%202%2C%20Freiburg%20im%20Breisgau%2C%2079098%2C%20Germany"
    pageTitle="Kuro Mori"
  />
);

export default KuroMori;
