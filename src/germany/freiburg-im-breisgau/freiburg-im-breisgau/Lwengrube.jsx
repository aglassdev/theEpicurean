...
const Lwengrube = () => (
  <RestaurantPage
    restaurantName="Löwengrube"
    address="Konviktstraße 12, Freiburg im Breisgau, 79098, Germany"
    cuisine="Farm to table, Contemporary"
    priceRange="€€€"
    phoneNumber="+4976176991188"
    website="https://www.restaurant-loewengrube.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former wine tavern in the heart of the old town has been given a new lease of life. The traditional character of this historic building has been successfully mixed with modern elements. The food offering takes the form of internationally inspired cuisine made with regional produce. It is a real treat to sit on the sheltered terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Konviktstra%C3%9Fe%2012%2C%20Freiburg%20im%20Breisgau%2C%2079098%2C%20Germany"
    pageTitle="Löwengrube"
  />
);

export default Lwengrube;
