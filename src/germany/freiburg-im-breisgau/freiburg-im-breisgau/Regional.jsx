...
const Regional = () => (
  <RestaurantPage
    restaurantName="Regional"
    address="St.-Erentrudis-Straße 12, Freiburg im Breisgau, 79112, Germany"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+4976644070"
    website="https://www.schlossreinach.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After being refurbished and rejuvenated, Regional has moved into the former Herrehus of Schloss Reinach. The name says it all: to create their tasty, punchy dishes, almost exclusively Baden and Black Forest produce is used, and the majority of it is also organic. It's a joy to sit on the patio terrace!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=St.-Erentrudis-Stra%C3%9Fe%2012%2C%20Freiburg%20im%20Breisgau%2C%2079112%2C%20Germany"
    pageTitle="Regional"
  />
);
