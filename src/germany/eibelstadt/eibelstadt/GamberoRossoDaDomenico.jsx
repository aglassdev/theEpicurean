...
const GamberoRossoDaDomenico = () => (
  <RestaurantPage
    restaurantName="Gambero Rosso da Domenico"
    address="Mühle 2, Eibelstadt, 97246, Germany"
    cuisine="Italian, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4993039843782"
    website="https://gambero-rosso.eu/site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Domenico Cannizzaro has been on a mission to showcase Italian cuisine in Franconia for well over 20 years, and has run this restaurant at the small marina with his wife, Teresa, since 2012. Here, they live and breathe hospitality, serving two set menus, Domenico and Teresuzza, which each comprise three or four courses – it's also possible to mix and match. Astute wine recommendations come courtesy of the chef-patron himself. Gorgeous terrace overlooking the Main River...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BChle%202%2C%20Eibelstadt%2C%2097246%2C%20Germany"
    pageTitle="Gambero Rosso da Domenico"
  />
);

export default GamberoRossoDaDomenico;
