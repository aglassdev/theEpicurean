...
const LandgasthofZumKaffelstein = () => (
  <RestaurantPage
    ...
    pageTitle="Landgasthof zum Kaffelstein"
  />
);

export default LandgasthofZumKaffelstein;
