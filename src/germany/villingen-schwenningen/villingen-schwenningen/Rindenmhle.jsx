...
const Rindenmhle = () => (
  <RestaurantPage
    restaurantName="Rindenmühle"
    address="Am Kneippbad 9, Villingen-Schwenningen, 78052, Germany"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+49772188680"
    website="https://www.rindenmuehle.de/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a seat in the elegant yet cosy, country-style interior – or, in summer, out on the beautiful garden terrace – and choose from a seasonal menu. Vegetarians are also catered for. For overnight guests there are cosy contemporary guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Kneippbad%209%2C%20Villingen-Schwenningen%2C%2078052%2C%20Germany"
    pageTitle="Rindenmühle"
  />
);

export default Rindenmhle;
