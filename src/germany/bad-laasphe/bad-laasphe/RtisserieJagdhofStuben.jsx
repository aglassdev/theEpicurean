...
const RtisserieJagdhofStuben = () => (
  <RestaurantPage
    restaurantName="Rôtisserie Jagdhof Stuben"
    address="Glashütter Straße 20, Bad Laasphe, 57334, Germany"
    cuisine="Traditional Cuisine, Meats and Grills"
    priceRange="€€"
    phoneNumber="+4927543990"
    website="https://www.jagdhof-glashuette.de"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cosiness and rustic charm of the Rôtisserie at the upscale Jagdhof Glashütte hotel are almost unparalleled – a wealth of wood panelling and beams, a roaring fireplace and the decorative remnants of what was perhaps the original kitchen all play their part. Factor in the amiable owner, Edmund Dornhöfer, and the attentive front-of-house team, too. Chef Petar Popovic delivers a wide range of classics. Excellent recommendations include Petar's bouillabaisse and the char-grilled veal chop with fresh chanterelles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Glash%C3%BCtter%20Stra%C3%9Fe%2020%2C%20Bad%20Laasphe%2C%2057334%2C%20Germany"
    pageTitle="Rôtisserie Jagdhof Stuben"
  />
);

export default RtisserieJagdhofStuben;
