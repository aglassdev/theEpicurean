...
const VillaHammerschmiede = () => (
  <RestaurantPage
    restaurantName="Villa Hammerschmiede"
    address="Hauptstraße 162, Pfinztal, 76327, Germany"
    cuisine="Classic Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+4972406010"
    website="https://villa-hammerschmiede.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether seated in one of the comfortable dining areas or the light and airy pavilion, you can look forward to cuisine that is ambitious, classic and regional, ranging from the intriguing Villa Lunch set menu to the Feinschmecker-Menü in the evenings. Options include turbot fillet fried in olive oil accompanied by Hokkaido pumpkin and dried apricot relish with walnut. Delightful terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%20162%2C%20Pfinztal%2C%2076327%2C%20Germany"
    pageTitle="Villa Hammerschmiede"
  />
);

export default VillaHammerschmiede;
