...
const ReisersZehnthof = () => (
  <RestaurantPage
    restaurantName="REISERS Zehnthof"
    address="Langgasse 33, Nordheim am Main, 97334, Germany"
    cuisine="Regional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+4993811702"
    website="https://www.der-reiser.de/zehnthof-nordheim/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The listed 400 year-old Zehnthof is located in the middle of the picturesque wine village. Inside, you eat in cosy, rustic-style dining rooms replete with historic charm; outside the pleasant terrace tables are set up in the wonderful courtyard with two shady plane trees. Both the food and wine list have a regional bent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Langgasse%2033%2C%20Nordheim%20am%20Main%2C%2097334%2C%20Germany"
    pageTitle="REISERS Zehnthof"
  />
);

export default ReisersZehnthof;
