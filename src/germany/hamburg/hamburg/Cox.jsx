...
const Cox = () => (
  <RestaurantPage
    restaurantName="Cox"
    address="Lange Reihe 68, Hamburg, 20099, Germany"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+4940249422"
    website="https://www.restaurant-cox.de/cox_home_de.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pleasant and laid-back – a bistro in the best sense of the word. A diverse cohort of diners enjoys dishes such as lamb fillets with pesto fried in brik pastry with ratatouille and fried capers. The service is friendly and attentive. Popular and inexpensive lunch offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Reihe%2068%2C%20Hamburg%2C%2020099%2C%20Germany"
    pageTitle="Cox"
  />
);
