...
const Tschebull = () => (
  <RestaurantPage
    restaurantName="Tschebull"
    address="Mönckebergstraße 7, Hamburg, 20095, Germany"
    cuisine="Austrian, International"
    priceRange="€€€"
    phoneNumber="+494032964796"
    website="https://www.tschebull.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the first floor of this exclusive shopping arcade the nods to Austria are everywhere: in the decoration -cowbells and edelweiss motifs on the ceiling, mountain panorama mural - and in the dishes, in the guise of classics such as Carinthian Kasnudeln, Wiener Schnitzel and apricot strudel. Beisl, serving Austrian tapas is more casual...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%B6nckebergstra%C3%9Fe%207%2C%20Hamburg%2C%2020095%2C%20Germany"
    pageTitle="Tschebull"
  />
);

export default Tschebull;
