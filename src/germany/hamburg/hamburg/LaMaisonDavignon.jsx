...
const LaMaisonDavignon = () => (
  <RestaurantPage
    restaurantName="La Maison d'Avignon"
    address="Arnoldstraße 2, Hamburg, 22765, Germany"
    cuisine="French, Provençal"
    priceRange="€€€"
    phoneNumber="+494028806512"
    website="https://www.lamaisonavignon.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once the sommelier at Petit Amour on Spritzenplatz, Mathias Mercier has now realised his dream and opened his own restaurant just a short distance away. In a relaxed setting, diners are offered a small à la carte selection; if they wish, they can create a small set menu comprising three to six courses from the individual dishes. Alternatively, they can opt for the nine-course tasting menu – the value for money is excellent. The cuisine clearly draws on the chef-patron's southern French roots, featuring delicacies such as fougasse with a superb anchoïade (anchovy sauce) and pralines infused with lavender or pastis. A standout dish is the sea bass with peach, verbena and navy beans. The wine list includes some rare gems at reasonable prices. Friendly and attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arnoldstra%C3%9Fe%202%2C%20Hamburg%2C%2022765%2C%20Germany"
    pageTitle="La Maison d'Avignon"
  />
);

export default LaMaisonDavignon;
