...
const ZurFlottbekerSchmiede = () => (
  <RestaurantPage
    restaurantName="Zur Flottbeker Schmiede"
    address="Baron-Voght-Straße 79, Hamburg, 20038, Germany"
    cuisine="Portuguese, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+494020918236"
    website="https://zurflottbekerschmiede.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Experience a slice of Portugal in Hamburg! The setting, a heritage-protected historical forge, exudes traditional German charm with its authentic decor and period open fireplace. It makes for a pleasantly laid-back atmosphere in which to tuck into delicious freshly made, fuss-free tapas. The chef-patron serves up genuine Portuguese cuisine but incorporates international influences. Try, for example, her barbecued calamari, marinade, garlic or roasted miso cauliflower, white bean purée, coriander chimichurri. The well-curated wine list is dedicated to Portuguese labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baron-Voght-Stra%C3%9Fe%2079%2C%20Hamburg%2C%2020038%2C%20Germany"
    pageTitle="Zur Flottbeker Schmiede"
  />
);

export default ZurFlottbekerSchmiede;
