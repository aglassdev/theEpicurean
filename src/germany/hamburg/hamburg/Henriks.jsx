...
const Henriks = () => (
  <RestaurantPage
    restaurantName="Henriks"
    address="Tesdorpfstraße 8, Hamburg, 20148, Germany"
    cuisine="International"
    priceRange="€€€"
    phoneNumber="+4940288084280"
    website="https://www.henriks.cc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Some ambitious cooking goes on in this elegantly designed restaurant, where the menu includes Asian, Mediterranean and regional cuisine with dishes ranging from Wiener Schnitzel to lobster. There’s a good selection of wines to accompany the food, plus a popular spacious terrace and lounge...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tesdorpfstra%C3%9Fe%208%2C%20Hamburg%2C%2020148%2C%20Germany"
    pageTitle="Henriks"
  />
);

export default Henriks;
