...
const Lakeside = () => (
  <RestaurantPage
    restaurantName="Lakeside"
    address="Fontenay 10, Hamburg, 20354, Germany"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+494060566050"
    website="https://www.thefontenay.com/restaurants-bar/lakeside-restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Come out of the lift on the seventh floor of the imposing The Fontenay hotel and you will find yourself in an airy, light-filled space. The bold interior design in elegant white is upscale and luxurious but still feels casual. The view over the city and the Outer Alster is simply sensational! Julian Stowasser's unique cooking style shines through in his modern seven-course set menu. He skilfully blends premium ingredients with an elegant restraint, as seen in the impeccably fresh, beautifully fragrant langoustine from the Faroe Islands, served with silky sour cream and a vibrant piel de sapo melon sauce. The entire experience is complemented by an outstanding front-of-house team led by Michel Buder, who stands out as a warm, professional and confident host. Astute wine recommendations come..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fontenay%2010%2C%20Hamburg%2C%2020354%2C%20Germany"
    pageTitle="Lakeside"
  />
);
