...
const CloudsHeavensBarKitchen = () => (
  <RestaurantPage
    restaurantName="Clouds - Heaven's Bar & Kitchen"
    address="Reeperbahn 1, Hamburg, 20359, Germany"
    cuisine="International, Meats and Grills"
    priceRange="€€€"
    phoneNumber="+494030993280"
    website="https://www.clouds-hamburg.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just 50 seconds in the lift and you are up on the 23rd floor, from which the view is simply magnificent. Modern cuisine is served in an urban-style interior: enquire about the extensive selection of meats; vegetarians are also catered for. In addition, there's a good bar serving a snack menu from 5pm. In summer, weather permitting, head to the 24th-floor Heaven's Nest for drinks and light bites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reeperbahn%201%2C%20Hamburg%2C%2020359%2C%20Germany"
    pageTitle="Clouds - Heaven's Bar & Kitchen"
  />
);

export default CloudsHeavensBarKitchen;
