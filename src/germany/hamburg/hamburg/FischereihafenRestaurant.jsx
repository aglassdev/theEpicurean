...
const FischereihafenRestaurant = () => (
  <RestaurantPage
    restaurantName="Fischereihafen Restaurant"
    address="Große Elbstraße 143, Hamburg, 22767, Germany"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+4940381816"
    website="https://www.fischereihafenrestaurant.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is and remains an institution – something of a home from home for Hamburg's fish lovers, young and old! A constant stream of international customers comes and goes from lunchtime to evening. In an elegant setting boasting traditional Hanseatic decor and a view of the harbour, quality fish from the fish market is served at the height of freshness. Classic dishes include turbot or lobster in different variations, but the menu also includes Asian and Mediterranean-influenced options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gro%C3%9Fe%20Elbstra%C3%9Fe%20143%2C%20Hamburg%2C%2022767%2C%20Germany"
    pageTitle="Fischereihafen Restaurant"
  />
);

export default FischereihafenRestaurant;
