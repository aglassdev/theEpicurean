...
const NikkeiNine = () => (
  <RestaurantPage
    restaurantName="NIKKEI NINE"
    address="Neuer Jungfernstieg 9, Hamburg, 20354, Germany"
    cuisine="Japanese, Peruvian"
    priceRange="€€€"
    phoneNumber="+494034943399"
    website="https://nikkei-nine.de/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You should not hesitate to make a reservation at this culinary hotspot in Hamburg. Located in the luxurious Fairmont Hotel Vier Jahreszeiten, the restaurant has a stylish and elegant ambience, courtesy of an interior done out in dark wood, cream and gold tones. On the menu: Japanese-international fusion cuisine. The service is very friendly and attentive. They also have a cool bar...."
    ...
    pageTitle="NIKKEI NINE"
  />
);

export default NikkeiNine;
