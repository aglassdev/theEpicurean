...
const Haebel = () => (
  <RestaurantPage
    restaurantName="haebel"
    address="Paul-Roosen-Straße 31, Hamburg, 22767, Germany"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+4915786864585"
    website="https://www.haebel.hamburg/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This tiny 16-seat restaurant is tucked away in a quintessential St Pauli neighbourhood, surrounded by vibrant street life and graffiti. The space has an urban feel and features simple yet stylish interior design, large windows looking out onto the street and an open kitchen. An appealing carte blanche concept is proposed in the form of two set menus: Fauna (omnivore) and Flora (vegetarian). Dishes such as mushrooms, pearl onion and lovage, or quail meatloaf dispense with unnecessary frills and showmanship. This cuisine is modern and pleasingly pared down. Some of the culinary creations are rather daring with bold flavours. The service comes courtesy of a friendly front-of-house team, who are informal and cordial in their approach – the chefs get in on the act when it comes to serving the d..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paul-Roosen-Stra%C3%9Fe%2031%2C%20Hamburg%2C%2022767%2C%20Germany"
    pageTitle="haebel"
  />
);

export default Haebel;
