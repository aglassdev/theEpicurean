...
const CarlsBrasserieAnDerElbphilharmonie = () => (
  <RestaurantPage
    restaurantName="CARLS Brasserie an der Elbphilharmonie"
    address="Am Kaiserkai 69, Hamburg, 20457, Germany"
    cuisine="German"
    priceRange="€€"
    phoneNumber="+4940300322400"
    website="https://carls-brasserie.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you take in the view of the Elbe River and the Elbphilharmonie concert hall, you can soak up the lively and casual yet elegant brasserie atmosphere and enjoy sophisticated North German cuisine such as fish stew or whole sole. The unique location means that window seats are in demand. And in summer, diners make a beeline for the terrace. The bistro next door serves bowls and tartines. A wine bar is also part of the premises...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Kaiserkai%2069%2C%20Hamburg%2C%2020457%2C%20Germany"
    pageTitle="CARLS Brasserie an der Elbphilharmonie"
  />
);

export default CarlsBrasserieAnDerElbphilharmonie;
