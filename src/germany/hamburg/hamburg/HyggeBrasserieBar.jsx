...
const HyggeBrasserieBar = () => (
  <RestaurantPage
    restaurantName="HYGGE Brasserie & Bar"
    address="Baron-Voght-Straße 179, Hamburg, 22607, Germany"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+494082274160"
    website="https://www.hygge-hamburg.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hip place is named after the concept of hygge. In Danish and Norwegian, this describes a feeling of cosy wellbeing and comfortable conviviality – very fitting for the atmosphere conjured up in this pretty half-timbered house, which used to be a stable for polo horses. Allying rustic timber elements and modern design, the interior is chic and stylish, with the central fireplace as the focal point. The atmosphere is pleasantly lively. Unfussy seasonal dishes make up the HYGGE set menu and surprise menu; alternatively go à la carte – there are great vegetarian options, too. Or why not order a selection of plates for everyone in your party to tuck into? Appealing wine list. The trendy bar lounge is also popular, as is the charming terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baron-Voght-Stra%C3%9Fe%20179%2C%20Hamburg%2C%2022607%2C%20Germany"
    pageTitle="HYGGE Brasserie & Bar"
  />
);

export default HyggeBrasserieBar;
