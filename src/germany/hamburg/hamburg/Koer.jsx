...
const Koer = () => (
  <RestaurantPage
    restaurantName="Koer"
    address="Maria-Louisen-Straße 3, Hamburg, 22301, Germany"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+4915168503238"
    website="https://www.koer-hamburg.de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A brilliant combination of restaurant and bar! Their modern, market-fresh cuisine is served in the form of creative dishes, such as smoked sardine and razor clams from the Dutch coast with grilled peppers, capers and pickled coriander seeds. We recommend opting for the surprise menu, but there is also an à la carte selection that includes bar snacks – it is well worth trying their own creations from the cocktail list. Good to know: Alcohol-free beverage pairings are available for the set menu. A pleasantly lively and fun atmosphere reigns in this chic restaurant. The name is derived from the Low German phrase in de Köör gahn (to make a choice) and refers to the establishment's dual concept...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maria-Louisen-Stra%C3%9Fe%203%2C%20Hamburg%2C%2022301%2C%20Germany"
    pageTitle="Koer"
  />
);
