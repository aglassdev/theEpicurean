...
const Flix = () => (
  <RestaurantPage
    restaurantName="Félix"
    address="Rupertistraße 26, Hamburg, 22609, Germany"
    cuisine="French, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+494053751921"
    website="https://www.felix-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The trip out of Hamburg city centre to the well-to-do Hochkamp neighbourhood is well worth it, as the many locals who regularly dine here will confirm. Fitting seamlessly into the villa-studded neighbourhood, this elegant little bistro boasts an upscale modern interior. The service is warm and professional. From some tables, diners can see through the glass partition into the kitchen. Félix Bechtolf – after whom the establishment is named – and his team craft classic French dishes including plenty of fish and seafood. The quality of the ingredients and meticulous preparation never fail to impress. Order à la carte or opt for the three-course set menu, which changes every week. The well-curated wine list features premium French labels. Open for lunch on Saturdays. Tip: In fine weather, take..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rupertistra%C3%9Fe%2026%2C%20Hamburg%2C%2022609%2C%20Germany"
    pageTitle="Félix"
  />
);
