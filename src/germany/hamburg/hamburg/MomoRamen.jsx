...
const MomoRamen = () => (
  <RestaurantPage
    restaurantName="Momo Ramen"
    address="Margaretenstraße 58, Hamburg, 20357, Germany"
    cuisine="Ramen"
    priceRange="€"
    phoneNumber="+494057226024"
    website="https://wolfgangpuck.com/dining/cut-singapore"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fancy some Japanese ramen? Then look no further! This hip and laid-back spot serves fresh house-made noodles. The aromatic dishes draw on regional ingredients and dispense with any additives. Reduced menu at lunchtime. An amusing detail: the toilets are wallpapered with Japanese newspapers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Margaretenstra%C3%9Fe%2058%2C%20Hamburg%2C%2020357%2C%20Germany"
    pageTitle="Momo Ramen"
  />
);

export default MomoRamen;
