...
const StrauchsFalco = () => (
  <RestaurantPage
    restaurantName="STRAUCHS FALCO"
    address="Koreastraße 2, Hamburg, 20457, Germany"
    cuisine="International, Meats and Grills"
    priceRange="€€€"
    phoneNumber="+4940226161511"
    website="https://falco-hamburg.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This smart and stylish restaurant is next to the Maritime Museum. Situated in the Elbarkaden in the middle of HafenCity, it also boasts an appealing terrace. The menu features a variety of cuisines from around the globe, including specialities from the barbecue, Mediterranean dishes, such as fish and shellfish soup, German classics like Labskaus (meat stew) and Wiener schnitzel, as well as pasta. Additionally, there is the Bar & Deli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Koreastra%C3%9Fe%202%2C%20Hamburg%2C%2020457%2C%20Germany"
    pageTitle="STRAUCHS FALCO"
  />
);

export default StrauchsFalco;
