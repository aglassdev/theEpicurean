...
const ButchersAmericanSteakhouse = () => (
  <RestaurantPage
    restaurantName="Butcher's american steakhouse"
    address="Milchstraße 19, Hamburg, 20148, Germany"
    cuisine="Meats and Grills, American"
    priceRange="€€€"
    phoneNumber="+4940446082"
    website="https://www.butchers-steakhouse.de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Butcher's american steakhouse you can enjoy fine Nebraska beef that the chef presents to the table personally. The cosy restaurant is dominated by dark wood and warm colours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Milchstra%C3%9Fe%2019%2C%20Hamburg%2C%2020148%2C%20Germany"
    pageTitle="Butcher's american steakhouse"
  />
);

export default ButchersAmericanSteakhouse;
