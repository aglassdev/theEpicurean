...
const TheEatery = () => (
  <RestaurantPage
    ...
    priceRange="€€"
    phoneNumber="+420603945236"
    website="https://www.theeatery.cz/cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The 10min tram ride (line 6) from the city centre is definitely worth it! Contemporary Czech cuisine bursting with flavour and aroma goes at very wallet-friendly prices here. Done out in an industrial style, the place has a trendy and minimalist feel – the open kitchen fits perfectly into the picture. The service runs like clockwork, courtesy of a friendly and professional team. At lunchtime, the choice on the menu is smaller than in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=U%20Uranie%20954%2F18%2C%20Prague%2C%20170%2000%2C%20Czechia"
    pageTitle="The Eatery"
  />
);

export default TheEatery;
