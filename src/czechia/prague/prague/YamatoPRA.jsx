...
const YamatoPRA = () => (
  <RestaurantPage
    ...
    address="U Kanálky 14, Prague, 120 00, Czechia"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+420222212617"
    website="https://yamato.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant tucked away in the basement of a residential building is done out in a bright and minimalist modern style. As the name suggests, the cuisine is Japanese. In addition to classic hot dishes, there is a good selection of sushi and sashimi. To go with your food, there is sake and whisky from Japan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=U%20Kan%C3%A1lky%2014%2C%20Prague%2C%20120%2000%2C%20Czechia"
    pageTitle="Yamato"
  />
);

export default YamatoPRA;
