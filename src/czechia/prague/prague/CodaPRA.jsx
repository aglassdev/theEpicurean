...
const CodaPRA = () => (
  <RestaurantPage
    restaurantName="Coda"
    address="Tržiště 9, Prague, 11000, Czechia"
    cuisine="Czech, Contemporary"
    priceRange="€€€"
    phoneNumber="+420225334761"
    website="https://www.codarestaurant.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Classic elegance is the name of the game here. The restaurant is located in the hall of the Aria Hotel Prague – herringbone floorboards, chandeliers and interesting objets d'art contribute to the stylish atmosphere. With its magnificent view over Prague, the roof terrace is a huge draw in summer! The restaurant serves refined Czech cuisine, a signature dish being their kulajda – a mushroom soup with a poached egg...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tr%C5%BEi%C5%A1t%C4%9B%209%2C%20Prague%2C%2011000%2C%20Czechia"
    pageTitle="Coda"
  />
);

export default CodaPRA;
