...
const AntricoteSteakhouse = () => (
  <RestaurantPage
    restaurantName="Antricote Steakhouse"
    address="Břehová 274/5, Prague, 11000, Czechia"
    cuisine="Grills, Meats and Grills"
    priceRange="€€€"
    phoneNumber="+420774042558"
    website="https://antricote.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a short walk from the Vltava in Prague's Old Town, this is the place for steak lovers. The decor is trendy and urban with an industrial edge. In the open kitchen, the focal point is the wood-fired grill on which premium cuts of meat are cooked to perfection. These are accompanied by an array of side dishes and sauces. To kick off, there is also a tempting selection of appetisers. Tip for motorists: Old Town Parking is convenient...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B%C5%99ehov%C3%A1%20274%2F5%2C%20Prague%2C%2011000%2C%20Czechia"
    pageTitle="Antricote Steakhouse"
  />
);

export default AntricoteSteakhouse;
