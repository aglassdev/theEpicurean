...
const UMatje = () => (
  <RestaurantPage
    restaurantName="U Matěje"
    address="U Matěje 152/1, Prague, 16000, Czechia"
    cuisine="Czech, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+420602154865"
    website="https://www.umateje1.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a pleasant residential neighbourhood not far from the zoo, this is an inviting restaurant in which an abundance of rustic wood finishings and decorative details such as numerous old photographs, striking pendant lamps and ceiling fans create a charming atmosphere. The food is a modern take on traditional Czech cuisine, eschewing unnecessary frills. Fresh, high-quality ingredients are prepared with precision to create delicious dishes such as carp fries with dill mayonnaise and coleslaw, stuffed goose stomachs and hearts with paprika and sour cream, or pulled goose meat with sauerkraut and potato pancakes. The reasonable prices are also something to smile about. In summer, the terrace with its mature trees is delightful! Friendly and attentive service. The restaurant STŮL in the ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=U%20Mat%C4%9Bje%20152%2F1%2C%20Prague%2C%2016000%2C%20Czechia"
    pageTitle="U Matěje"
  />
);

export default UMatje;
