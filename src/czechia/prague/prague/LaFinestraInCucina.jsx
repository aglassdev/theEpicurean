...
const LaFinestraInCucina = () => (
  <RestaurantPage
    restaurantName="La Finestra in Cucina"
    address="Platnérská 13, Prague, 110 00, Czechia"
    cuisine="Italian"
    priceRange="€"
    phoneNumber="+420222325325"
    website="https://lafinestra.lacollezione.cz/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in Prague's Old Town, this is a great establishment for top-notch Italian food. Made with select ingredients and clear craftsmanship, dishes such as calamari fritti, brasato al Barolo or spaghetti alla carbonara are sure to impress. Also of note is the fine selection of aged meats cooked on the grill. The tasteful decor teamed with red-brick vaulted ceilings is also inviting – and you can see into the kitchen through a window...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Platn%C3%A9rsk%C3%A1%2013%2C%20Prague%2C%20110%2000%2C%20Czechia"
    pageTitle="La Finestra in Cucina"
  />
);

export default LaFinestraInCucina;
