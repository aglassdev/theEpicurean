...
const 420Restaurant = () => (
  <RestaurantPage
    restaurantName="420 Restaurant"
    address="Staroměstské Náměstí 480/24, Prague, 11000, Czechia"
    cuisine="Contemporary, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+420722420099"
    website="https://www.420restaurant.cz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Talk about an amazing location! Right outside the door, the centuries-old town hall with its famous astronomical clock dating back to 1410 captures everyone's attention – tables on the terrace are naturally coveted. Inside, the scene is no less arresting: This gorgeous building in the heart of the old town feels almost like a sacred space. With its soaring ceiling and period architecture, the restaurant is reminiscent of a church nave. Striking details such as a distinctive glass roof, phenomenal wall decor and sleek modern furnishings create compelling contrasts. In the open kitchen in the entrance, the chefs prepare contemporary dishes with classic foundations and influenced by regional traditions. Think pike-perch with semolina porridge, or Escoffier veal schnitzel with truffle sauce. T..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Starom%C4%9Bstsk%C3%A9%20N%C3%A1m%C4%9Bst%C3%AD%20480%2F24%2C%20Prague%2C%2011000%2C%20Czechia"
    pageTitle="420 Restaurant"
  />
);

export default 420Restaurant;
