...
const GrandCru = () => (
  <RestaurantPage
    restaurantName="Grand Cru"
    address="Lodecká 4, Prague, 110 00, Czechia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+420775044076"
    website="https://www.grand-cru.cz/index.php/cs/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Access to this elegant modern restaurant is via a cobbled courtyard. Inside, a warm colour scheme creates a pleasant atmosphere, and the front area features a light and airy winter garden. The classic cuisine with a Mediterranean touch is made with ingredients of the highest quality; example dishes include lobster soup or sea bass with white wine sauce. There are also different grilled dishes every day. Plus they have good wine recommendations up their sleeve...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lodeck%C3%A1%204%2C%20Prague%2C%20110%2000%2C%20Czechia"
    pageTitle="Grand Cru"
  />
);
