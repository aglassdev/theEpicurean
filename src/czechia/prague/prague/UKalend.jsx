...
const UKalend = () => (
  <RestaurantPage
    restaurantName="U Kalendů"
    address="Rašínovo Nábřeží 383/58, Prague, 10100, Czechia"
    cuisine="Czech"
    priceRange="€€"
    phoneNumber="+420732947574"
    website="https://www.ukalendu.ambi.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place is popular, and with good reason. The small menu is packed with regional classics – the hearty Czech dishes, including braised hare leg, pork cheeks and duck gizzards, as well as delicious desserts such as sweet yeast dumplings, are a real treat. And then there is the wonderful bread and fine pastries from the adjoining bakery! The select ingredients are not only beautifully prepared in terms of flavour and craftsmanship, but you also get a sense of the heart and soul that goes into the dishes. The decor is simple, with a slightly rustic feel. In the space at the front, the kitchen is visible through a window, and from your table in the area to the rear, you can see into the open bakery. The restaurant is just a few minutes from the centre, and only the street separates it from ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ra%C5%A1%C3%ADnovo%20N%C3%A1b%C5%99e%C5%BE%C3%AD%20383%2F58%2C%20Prague%2C%2010100%2C%20Czechia"
    pageTitle="U Kalendů"
  />
);

export default UKalend;
