...
const Aromi = () => (
  <RestaurantPage
    restaurantName="Aromi"
    address="Námĕstí Míru 6, Prague, 120 00, Czechia"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+420222713222"
    website="https://aromi.lacollezione.cz/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant is accommodated in a spruce historical house. The elegant modern interior, high ceilings and large, floor-to-ceiling windows make for a pleasing, airy feel. The open kitchen in the middle turns out contemporary Italian dishes – highlights include the fish and meat cooked on the oven grill. The excellent pasta is also a tempting option. Attentive and experienced service rounds off your dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=N%C3%A1m%C4%95st%C3%AD%20M%C3%ADru%206%2C%20Prague%2C%20120%2000%2C%20Czechia"
    pageTitle="Aromi"
  />
);
