...
const LaVerandaPRA = () => (
  <RestaurantPage
    restaurantName="La Veranda"
    address="Elišky Krásnohorské 2/10, Prague, 110 00, Czechia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+420224814733"
    website="https://www.laveranda.cz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this restaurant with the flair of an Italian country house and decorative shelves full of cookbooks, small tables make for a friendly, elegant ambience. The modern european cuisine is served à la carte or as a set menu. The front-of-house team provides attentive, competent service, and there is a good selection of wines to choose from...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Eli%C5%A1ky%20Kr%C3%A1snohorsk%C3%A9%202%2F10%2C%20Prague%2C%20110%2000%2C%20Czechia"
    pageTitle="La Veranda"
  />
);

export default LaVerandaPRA;
