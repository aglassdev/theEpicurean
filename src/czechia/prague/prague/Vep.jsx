...
const Vep = () => (
  <RestaurantPage
    restaurantName="Výčep"
    address="Korunní 1304/92, Prague, 101 00, Czechia"
    cuisine="Czech, Contemporary"
    priceRange="€"
    phoneNumber="+420720120100"
    website="https://vycepkorunni.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pub-style place is loud and lively. Both the ambience and cuisine present as an unpretentious, modern interpretation of a traditional inn. Seated on a long bench at small wooden tables, diners tuck into this contemporary take on Czech cuisine and it is quite simply a delightful experience. Dishes such as potato dumplings filled with braised wild boar, red cabbage and bacon sauce are packed with flavour and full of soul – you can tell this is a team that knows what it is doing. The food pairs well with a glass of wine or a good beer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Korunn%C3%AD%201304%2F92%2C%20Prague%2C%20101%2000%2C%20Czechia"
    pageTitle="Výčep"
  />
);
