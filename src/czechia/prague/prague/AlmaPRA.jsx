...
const AlmaPRA = () => (
  <RestaurantPage
    restaurantName="Alma"
    address="V Jirchářích 8, Prague, 11000, Czechia"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+420601150800"
    website="https://www.almaprague.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot has all the makings of a favorite restaurant! The modern dining concept is reflected in the relaxed atmosphere and the trendy, urban interior complete with open kitchen and bar, as well as on the menu. The fantastic selection features mouthwatering options such as dry-aged beef and plenty of vegetarian dishes. The kitchen team works closely with local suppliers including KRO Bakery in Vršovice, which provides excellent sourdough bread. In addition to a well-curated wine list, there is a wonderful range of cocktails – with or without alcohol. Delightful courtyard terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=V%20Jirch%C3%A1%C5%99%C3%ADch%208%2C%20Prague%2C%2011000%2C%20Czechia"
    pageTitle="Alma"
  />
);

export default AlmaPRA;
