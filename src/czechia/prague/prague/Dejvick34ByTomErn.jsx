...
const Dejvick34ByTomErn = () => (
  <RestaurantPage
    restaurantName="Dejvická 34"
    address="Dejvická 34, Prague, 16000, Czech Republic"
    cuisine="Italian, Czech"
    priceRange="€€"
    phoneNumber="+420607277123"
    website="https://www.dejvicka34.cz/cz/restaurace"
    aliases={["Dejvická 34 by Tomáš Černý"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This somewhat labyrinthine restaurant has a pleasant, modern bistro atmosphere and serves both Czech and Italian cuisine. Quality ingredients and a lot of energy go into the flavourful dishes. The chef has a particular penchant for stews and pasta. Tip: One of the tables is located right in front of the kitchen and promises interesting glimpses of the team in action...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dejvick%C3%A1%2034%2C%20Prague%2C%2016000%2C%20Czechia"
    pageTitle="Dejvická 34"
  />
);

export default Dejvick34ByTomErn;
