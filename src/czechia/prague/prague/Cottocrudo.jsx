...
const Cottocrudo = () => (
  <RestaurantPage
    restaurantName="CottoCrudo"
    address="Veleslavínova 1098/2A, Prague, 110 00, Czechia"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+420221426880"
    website="https://www.fourseasons.com/prague/dining/restaurants/cottocrudo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are many reasons to visit this restaurant in the elegant Four Seasons Hotel: the charming location by the Vltava River, the chic ambience, the beautiful large bar and the terrace overlooking the river… And, of course, the Italian cuisine with a modern twist. Dishes such as vitello tonnato, house-made pasta, fresh sea bass or duck breast show off the exquisite quality of the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Veleslav%C3%ADnova%201098%2F2A%2C%20Prague%2C%20110%2000%2C%20Czechia"
    pageTitle="CottoCrudo"
  />
);

export default Cottocrudo;
