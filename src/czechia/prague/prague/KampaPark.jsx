...
const KampaPark = () => (
  <RestaurantPage
    restaurantName="Kampa Park"
    address="Na Kampe 8b, Malá Strana, Prague, 118 00, Czechia"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+420296826112"
    website="https://kampapark.com/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kampa Park is stunningly located by the water’s edge, next to Charles Bridge. Choose from several dining areas: the best spots are the Winter Garden and the riverside terrace. The décor is contemporary, as is the interesting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Na%20Kampe%208b%2C%20Mal%C3%A1%20Strana%2C%20Prague%2C%20118%2000%2C%20Czechia"
    pageTitle="Kampa Park"
  />
);

export default KampaPark;
