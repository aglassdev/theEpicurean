...
const CasaDeCarli = () => (
  <RestaurantPage
    restaurantName="Casa De Carli"
    address="Vězeňská 5, Prague, 11 000, Czechia"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+420224816688"
    website="https://www.casadecarli.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Matteo De Carli and his wife Lenka Hermanová have been running their restaurant since 2012 after several stops around the world. The beautiful interior is straightforward and modern, with an open show kitchen and a walk-in wine fridge worth seeing as well as a wine fridge wall. Flavoursome cooking has a subtle North Italian bias, and the breads, pastas and ice creams are homemade. Make sure to consider the daily specials - the turbot in puff pastry crust, for exapmle, is a delight! Or let patron and chef Matteo surprise you with a 5-, 6- or 7-course tasting menu. In front of the house there are tables on the cobbled street. Tip: chef's table for max. 8 people in the basement - here the chef cooks right in front of you in a private setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=V%C4%9Bze%C5%88sk%C3%A1%205%2C%20Prague%2C%2011%20000%2C%20Czechia"
    pageTitle="Casa De Carli"
  />
);

export default CasaDeCarli;
