...
const MarieB = () => (
  <RestaurantPage
    restaurantName="Marie B"
    address="Dlouhá 37, Prague, 11000, Czechia"
    cuisine="Modern Cuisine, Czech"
    priceRange="€€€"
    phoneNumber="+420737595913"
    website="https://www.marieb.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a 14C townhouse, the restaurant is accessed through a covered courtyard entrance. Behind a somewhat shabby-looking front door covered in graffiti, a minimalist and trendy interior with an urban feel awaits. Beneath a rustic old vaulted ceiling, diners sit at a counter forming a U-shape around the open kitchen, they can watch the action up close. There are also two modern light installations by Berlin artist Anselm Reyle that draw your attention. Another interesting detail is the cookery book dating back to 1894, on display behind glass – it was written by chef Marie B Svobodová, after whom the restaurant is named. Comprising four courses, the carte blanche menu features creative modern dishes rooted in Czech culinary tradition. The nicely curated wine list places the emphasis on Mor..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dlouh%C3%A1%2037%2C%20Prague%2C%2011000%2C%20Czechia"
    pageTitle="Marie B"
  />
);

export default MarieB;
