...
const VZtii = () => (
  <RestaurantPage
    ...
    bio="This modern city centre restaurant is a popular spot. Its name means ‘timeless’ and with its clever blend of modern Czech and international dishes, it looks set to stand up to its name. In the open kitchen selected products are used. You can dine à la carte or in the form of a set menu, accompanied by the matching wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Liliov%C3%A1%201%2C%20Betl%C3%A9msk%C3%A9%20N%C3%A1m.%2C%20Prague%2C%20110%2000%2C%20Czechia"
    pageTitle="V Zátiši"
  />
);

export default VZtii;
