...
const Salabka = () => (
  <RestaurantPage
    restaurantName="Salabka"
    address="K Bohnicím 849/2a, Prague, 171 00, Czechia"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+420778019002"
    website="https://www.salabka.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the outskirts of the city, this restaurant is located in a vineyard with a wine-growing tradition dating back to the 13C. A combination of exposed old wooden beams, quarry stone walls and sleek modern furnishings creates an atmospheric setting. The view of the vines is best enjoyed from the tables at the windows on the first floor, which is actually a gallery constructed under the open gable roof. In summer, tables on the terrace are coveted. Meticulously prepared with great technical precision, the dishes are visually stunning and often feature produce from trusted farmers. Tip: Book a wine tasting or tour of the estate. For overnight stays there are six cosy, tastefully furnished apartments...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=K%20Bohnic%C3%ADm%20849%2F2a%2C%20Prague%2C%20171%2000%2C%20Czechia"
    pageTitle="Salabka"
  />
);

export default Salabka;
