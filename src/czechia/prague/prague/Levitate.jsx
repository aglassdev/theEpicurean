...
const Levitate = () => (
  <RestaurantPage
    restaurantName="LEVITATE"
    address="Vinohradská 1228/47, Prague, 12000, Czechia"
    cuisine="Asian Influences, Scandinavian"
    priceRange="€€€€"
    phoneNumber="+420724516996"
    website="https://www.levitate.cz"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Featuring an interesting combination of Nordic techniques, predominantly Czech ingredients and Asian spices from the owner's homeland, the cuisine here is rather unique. The resulting dishes are full of finesse and pleasing contrasts - served in 12 or 18 courses. The location itself is something special: unassuming from the outside, it has a surprisingly chic interior. Upon arrival, diners are first led to the bar in the cellar for aperitifs and nibbles – a distinctive blend of exposed old brickwork and modern design makes for an atmospheric setting. Once in the tastefully furnished main room, you have the choice to be seated at the long private table or one of the smaller round tables. You can also pay a flying visit to the chef in the Living Room and indulge in a few small dishes. Excell..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vinohradsk%C3%A1%201228%2F47%2C%20Prague%2C%2012000%2C%20Czechia"
    pageTitle="LEVITATE"
  />
);
