...
const Chapelle = () => (
  <RestaurantPage
    restaurantName="Chapelle"
    address="Budějovická 2440, Písek, 39701, Czechia"
    cuisine="Modern Cuisine, International"
    priceRange="€€"
    phoneNumber="+420606040045"
    website="https://chapelle.cz/cs/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its chic design, clean lines, light wood and palette of natural hues, this restaurant is blessed with good looks. If you are lucky, you will be seated at a table with a front-row view of the chefs preparing the dishes in the open kitchen. The modern cuisine has international and Czech influences. Attentive and cordial service. Hotel U Kapličky located in the same building has attractive guestrooms for an overnight stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bud%C4%9Bjovick%C3%A1%202440%2C%20P%C3%ADsek%2C%2039701%2C%20Czechia"
    pageTitle="Chapelle"
  />
);
