...
const PavillonSteakHouse = () => (
  <RestaurantPage
    restaurantName="Pavillon Steak House"
    address="Jezuitská 13, Brno, 60200, Czechia"
    cuisine="Steakhouse"
    priceRange="€€€"
    phoneNumber="+420541213497"
    website="https://pavillonsteakhouse.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant boasts a gorgeous location in a small park near the centre. Sleek and chic design, high ceilings and large windows make for an airy atmosphere. As the name suggests, the focus here is on meat and different steaks. You choose the size and how you would like it cooked – the kitchen takes care of the rest. There is a variety of side dishes and sauces to accompany the meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jezuitsk%C3%A1%2013%2C%20Brno%2C%2060200%2C%20Czechia"
    pageTitle="Pavillon Steak House"
  />
);

export default PavillonSteakHouse;
