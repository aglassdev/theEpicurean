...
const Valoria = () => (
  <RestaurantPage
    restaurantName="Valoria"
    address="Bohunická 2, Brno, 61900, Czechia"
    cuisine="International, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+420543250462"
    website="https://valoria.cz/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant is a little way out of the city centre, but the journey south of Brno is worth it. They serve international cuisine with traditional, French, Mediterranean and Far Eastern influences. Chef Michal Černý and his team prepare both à la carte dishes and a seven-course tasting menu. Fresh ingredients go into flavoursome dishes such as Spicy Thai soup, shrimp, oyster fungus or Mushroom risotto, Pecorino mousse, rocket salad and Confit of veal cheek, dill velouté, Carlsbad dumplings. When it comes to wine, the spotlight is on the Czech region of Moravia; the additional rum menu is also of interest. Friendly and attentive service is provided by a dedicated front-of-house team in the attractive contemporary interior. In summer diners are seated comfortably on the covered terrace. The..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bohunick%C3%A1%202%2C%20Brno%2C%2061900%2C%20Czechia"
    pageTitle="Valoria"
  />
);
