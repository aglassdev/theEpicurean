...
const UTpna = () => (
  <RestaurantPage
    restaurantName="U Štěpána"
    address="Vojetice 9, Petrovice, 34201, Czechia"
    cuisine="Czech, Beef"
    priceRange="€€"
    phoneNumber="+420376588196"
    website="https://www.ustepana.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant may be a little off the beaten track, but it's well worth coming here for the regional cuisine. Quality ingredients are skilfully prepared to impart plenty of flavour. The restaurant rears its own cattle, hence the focus on beef – delicious dishes include beef tongue with celeriac purée and horseradish foam, or beef ribs with coleslaw and bread. The interior has a charmingly rustic quality; in summer, dine out on the terrace, which is surrounded by greenery. Should you wish to soak up this rural idyll a little longer, there is also a campsite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vojetice%209%2C%20Petrovice%2C%2034201%2C%20Czechia"
    pageTitle="U Štěpána"
  />
);

export default UTpna;
