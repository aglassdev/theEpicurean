...
const NaSpilce = () => (
  <RestaurantPage
    restaurantName="Na Spilce"
    address="U Prazdroje 64/7, Pilsen, 30100, Czechia"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+420724617355"
    website="https://www.naspilce.cz/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=U%20Prazdroje%2064%2F7%2C%20Pilsen%2C%2030100%2C%20Czechia"
    pageTitle="Na Spilce"
  />
);

export default NaSpilce;
