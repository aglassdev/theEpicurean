...
const MalDvorana = () => (
  <RestaurantPage
    restaurantName="Malá Dvorana"
    address="Mírové Náměstí 2, Karlovy Vary, 36001, Czechia"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+420353109631"
    website="https://www.pupp.cz/mala-dvorana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a side wing of the historical Grandhotel Pupp, this restaurant is accommodated in a magnificent hall. Elaborate mouldings on the ceiling and walls and an imposing crystal chandelier are a stylish throwback to bygone days; decorated with gold leaf, the modern glass bar in the middle of the room is also noteworthy. The contemporary dishes include pan-fried mackerel, sliced beetroot, leek mousse, honey, or chicken ballotine, Jerusalem artichoke, sautéed kale, chicken demi-glace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%ADrov%C3%A9%20N%C3%A1m%C4%9Bst%C3%AD%202%2C%20Karlovy%20Vary%2C%2036001%2C%20Czechia"
    pageTitle="Malá Dvorana"
  />
);

export default MalDvorana;
