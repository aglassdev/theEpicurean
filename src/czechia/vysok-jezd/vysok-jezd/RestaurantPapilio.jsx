...
const RestaurantPapilio = () => (
  <RestaurantPage
    restaurantName="Restaurant Papilio"
    address="Tyršova náves 1, Vysoký Újezd, 26716, Czechia"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+420724132013"
    website="https://restaurant-papilio.cz/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This elegant restaurant done out all in white and with a beautiful high groin-vaulted ceiling is truly chic – you would never guess this space was once the château's stables. In the open kitchen, Jan Knedla and his team prepare a set menu comprising six, eight or 10 courses; at lunchtime a six-course option is available. Inspired by the chef's childhood, the dishes lean towards regional ingredients and are presented in a modern and creative style. Seats at the Chef's Table promise interesting glimpses of the action. Service is friendly and professional; the chefs mostly serve the dishes themselves and explain the idea behind them. They offer a very well-stocked wine list and the wines are presented charmingly and with profound knowledge. Also recommendable: national or international wine b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tyr%C5%A1ova%20n%C3%A1ves%201%2C%20Vysok%C3%BD%20%C3%9Ajezd%2C%2026716%2C%20Czechia"
    pageTitle="Restaurant Papilio"
  />
);

export default RestaurantPapilio;
