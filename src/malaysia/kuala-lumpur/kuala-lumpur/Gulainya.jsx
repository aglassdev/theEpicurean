...
const Gulainya = () => (
  <RestaurantPage
    restaurantName="Gulainya"
    address="44-G, Plaza Damansara, Jalan Medan Setia 2, Bukit Damansara, Kuala Lumpur, 50490, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60143927868"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/gulainya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Plaza Damansara offers no end of dining options, but this Peranakan joint stands out with the owner’s family recipes that have been polished and updated. No-frills home-style dishes are made with the freshest local produce and the sauces are made by the owner himself. Try his creamy basil boneless chicken, boasting juicy, velvety meat in a creamy sauce loaded with fresh herbal notes. Alfresco dining on balmy nights...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44-G%2C%20Plaza%20Damansara%2C%20Jalan%20Medan%20Setia%202%2C%20Bukit%20Damansara%2C%20Kuala%20Lumpur%2C%2050490%2C%20Malaysia"
    pageTitle="Gulainya"
  />
);

export default Gulainya;
