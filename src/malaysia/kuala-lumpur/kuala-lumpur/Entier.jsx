...
const Entier = () => (
  <RestaurantPage
    restaurantName="Entier"
    address="Level 41, Alila Bangsar, 58 Jalan Ang Seng, Brickfields, Kuala Lumpur, 50470, Malaysia"
    cuisine="French Contemporary"
    priceRange="$$$"
    phoneNumber="+60162630596"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/entier"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The airy, minimalist room atop a sky-scraping hotel tower commands breathtaking cityscapes and is the epitome of casual elegance. The Japanese chef honed his skills in prestigious European kitchens before taking the helm here. The deftly crafted French menu sports subtle Japanese twists. Order à la carte dishes or go for the Chef's Degustation menu for dinner. Though the menu changes quarterly, the must-try beef, dry-aged in house, is a firm fixture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%2041%2C%20Alila%20Bangsar%2C%2058%20Jalan%20Ang%20Seng%2C%20Brickfields%2C%20Kuala%20Lumpur%2C%2050470%2C%20Malaysia"
    pageTitle="Entier"
  />
);
