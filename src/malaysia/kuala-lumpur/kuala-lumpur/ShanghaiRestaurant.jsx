...
const ShanghaiRestaurant = () => (
  <RestaurantPage
    restaurantName="Shanghai Restaurant"
    address="1F, JW Marriott, 183 Jalan Bukit Bintang, Bukit Bintang, Kuala Lumpur, 55100, Malaysia"
    cuisine="Shanghainese"
    priceRange="$$$"
    phoneNumber="+60186230069"
    website="https://www.marriott.com/en-us/dining/restaurant-bar/kuldt-jw-marriott-hotel-kuala-lumpur/87669-shanghai.mi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business since 1999, the restaurant was updated in 2021 and now sports a bright, modern interior. The veteran chef traditionally crafts Shanghainese classics, and his xiao long bao is a must-try – soupy pork filling enrobed in paper-thin, meticulously pleated skin. Stir-fried flat glass noodles with shredded pork and preserved vegetable boasts remarkable wok hei, and the salted potherb mustard greens impart briny umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20JW%20Marriott%2C%20183%20Jalan%20Bukit%20Bintang%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Shanghai Restaurant"
  />
);

export default ShanghaiRestaurant;
