...
const JalanIpohClaypotChickenRice = () => (
  <RestaurantPage
    restaurantName="Jalan Ipoh Claypot Chicken Rice"
    address="Lot 1224, 7 Jalan Batu Ambar, Taman Kok Lian, Kuala Lumpur, 51200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60123323620"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/jalan-ipoh-claypot-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 30 years, this stall has been selling chicken rice cooked to order over charcoal in claypots. The dish comes with Cantonese pork sausage and ginger, and has a crispy crust at the bottom. You can add salted fish, which imparts extra aroma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lot%201224%2C%207%20Jalan%20Batu%20Ambar%2C%20Taman%20Kok%20Lian%2C%20Kuala%20Lumpur%2C%2051200%2C%20Malaysia"
    pageTitle="Jalan Ipoh Claypot Chicken Rice"
  />
);

export default JalanIpohClaypotChickenRice;
