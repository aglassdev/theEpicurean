...
const TeochewLaoEr = () => (
  <RestaurantPage
    restaurantName="Teochew Lao Er"
    address="6 Jalan Brunei, Pudu, Kuala Lumpur, 55100, Malaysia"
    cuisine="Teochew"
    priceRange="$$"
    phoneNumber="+60122141077"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/teochew-lao-er"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 1984, Lao Er started out as a street stall. In 2011, the third generation opened a restaurant and established itself as a household name in Pudu district. Teochew classics are given a slight tweak to cater to the local palate. The signature dish, meat marinated in spiced soy, is a great hit – try the assorted platter. Teochew congee with pomfret, mackerel, and traditional kueh are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Jalan%20Brunei%2C%20Pudu%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Teochew Lao Er"
  />
);

export default TeochewLaoEr;
