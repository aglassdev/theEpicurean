...
const LiYen = () => (
  <RestaurantPage
    restaurantName="Li Yen"
    address="2F, The Ritz-Carlton, 168 Jalan Imbi, Bukit Bintang, Kuala Lumpur, 55100, Malaysia"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+60186230038"
    website="https://www.marriott.com/en-us/dining/restaurant-bar/kulrz-the-ritz-carlton-kuala-lumpur/86180-li-yen.mi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Embroidered wall panelling, a semi-circular velvet banquette, and mirrors in bronze frames prime diners for a luxury dining experience. On the menu, classic Cantonese takes centre stage – think dim sum, honey-glazed BBQ Iberico pork, and roast goose. Also check out the chef’s recommendations on the first page, often featuring one hero ingredient prepared in a myriad of ways. Most items are available in different portion sizes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Ritz-Carlton%2C%20168%20Jalan%20Imbi%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Li Yen"
  />
);

export default LiYen;
