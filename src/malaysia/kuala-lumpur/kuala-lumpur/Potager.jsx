...
const Potager = () => (
  <RestaurantPage
    restaurantName="Potager"
    address="P11, Bamboo Hills, off DUKE, Taman Bamboo, Segambut, Kuala Lumpur, 51200, Malaysia"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+60126233152"
    website="https://potagerkl.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Fukuoka native, the chef worked in Europe for years before opening this place – an oasis set in lush greenery outside the city centre. At dinner, the tasting menus include five or nine courses, meticulously crafted with classic French techniques and using local ingredients. With an array of harmonious textures, the corn dish is inspired by the chef's visit to Cameron Highlands, encapsulating his culinary vision and childhood memories...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=P11%2C%20Bamboo%20Hills%2C%20off%20DUKE%2C%20Taman%20Bamboo%2C%20Segambut%2C%20Kuala%20Lumpur%2C%2051200%2C%20Malaysia"
    pageTitle="Potager"
  />
);
