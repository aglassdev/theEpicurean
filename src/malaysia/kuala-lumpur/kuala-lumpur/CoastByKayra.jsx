...
const CoastByKayra = () => (
  <RestaurantPage
    restaurantName="Coast by Kayra"
    address="Lot G03-G05, GF, The Starhill, 181 Jalan Bukit Bintang, Bukit Bintang, Kuala Lumpur, 55100, Malaysia"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+60172157264"
    website="https://coast.kayra.com.my/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sister establishment of Kayra stays true to its sea-to-plate ethos, and the turquoise accents in the décor are a nod to the ocean theme. The kitchen excels at reimagining the traditional dishes of Kerala in sophisticated ways. Quality seafood and produce are sourced locally to support small farms and fishermen. The must-try Kerala fish curry is based on a family recipe, with raw mango and yoghurt for acidity. Order naan to mop up the tangy sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lot%20G03-G05%2C%20GF%2C%20The%20Starhill%2C%20181%20Jalan%20Bukit%20Bintang%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Coast by Kayra"
  />
);

export default CoastByKayra;
