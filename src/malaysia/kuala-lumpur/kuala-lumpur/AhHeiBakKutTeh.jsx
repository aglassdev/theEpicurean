...
const AhHeiBakKutTeh = () => (
  <RestaurantPage
    restaurantName="Ah Hei Bak Kut Teh"
    address="33A Medan Imbi, Pudu, Kuala Lumpur, 55100, Malaysia"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+60128391911"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/ah-hei-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 30-year-old shop makes its own bak kut teh daily at 5 am with a blend of 16 Chinese herbs. The soup may look a bit on the dark side, but it boasts not only aromas and flavours, but also health benefits. In addition to the typical spareribs, you may choose other pork cuts, such as tripe, intestine or belly. Or, you may add mushrooms or deep-fried tofu skin to the health tonic served in claypot. Side dishes of fish or veggies are also good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33A%20Medan%20Imbi%2C%20Pudu%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Ah Hei Bak Kut Teh"
  />
);

export default AhHeiBakKutTeh;
