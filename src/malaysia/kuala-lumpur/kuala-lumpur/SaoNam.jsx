...
const SaoNam = () => (
  <RestaurantPage
    restaurantName="Sao Nam"
    address="25 Tengkat Tong Shin, Bukit Bintang, Kuala Lumpur, 50200, Malaysia"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+60321441225"
    website="https://www.saonam.com.my/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a yellow façade and colourful interior, Sao Nam ticks all the boxes for a fun-filled meal. The Vietnamese kitchen team deliver specialities from across their home country, including some showing strong French influences. Their iconic phở bò (beef noodle soup) packs a tasty punch and features a broth that takes over 10 hours to make. The mangosteen and prawn salad tantalises the taste buds with big flavours and contrasting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Tengkat%20Tong%20Shin%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2050200%2C%20Malaysia"
    pageTitle="Sao Nam"
  />
);
