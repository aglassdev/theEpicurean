...
const CongkakBukitBintang = () => (
  <RestaurantPage
    restaurantName="Congkak (Bukit Bintang)"
    address="24 Jalan Beremi, Bukit Bintang, Kuala Lumpur, 50200, Malaysia"
    cuisine="Malaysian"
    priceRange="$$"
    phoneNumber="+60192897008"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/congkak-bukit-bintang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after a traditional Malaysian game, Congkak is located in residential Jalan Beremi, not far from the city’s bustling central district. The restaurant is an expression of national pride and identity serving what visitors would deem as exotic, but are classics for locals. The most popular dish, the nasi ambeng platter, offers a multitude of textures and combinations of spicy, sweet and savoury flavours that go nicely with sambal. Different serving size is available to suit for your party size...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Jalan%20Beremi%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2050200%2C%20Malaysia"
    pageTitle="Congkak (Bukit Bintang)"
  />
);

export default CongkakBukitBintang;
