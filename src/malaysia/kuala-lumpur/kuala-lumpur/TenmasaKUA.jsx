...
const TenmasaKUA = () => (
  <RestaurantPage
    restaurantName="Tenmasa"
    address="Unit 3.3 (annexe), 2F, Tower 1, Platinum Park, 11 Persiaran KLCC, Kuala Lumpur, 50088, Malaysia"
    cuisine="Tempura"
    priceRange="$$$"
    phoneNumber="+60321817732"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/tenmasa-1205097"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Watch the chefs work their magic from the 10-seater counter but be sure to book in advance. The omakase menus include dishes ranging from appetisers to tempura and seasonal specials made with top-notch Japanese produce. Seafood and vegetables are lightly battered on the spot and deep fried in a blend of sesame and rice bran oil for an ethereal, crisp crust. The signature dish comprises fresh, sweet uni from Hokkaido on a tempura shiso leaf...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%203.3%20(annexe)%2C%202F%2C%20Tower%201%2C%20Platinum%20Park%2C%2011%20Persiaran%20KLCC%2C%20Kuala%20Lumpur%2C%2050088%2C%20Malaysia"
    pageTitle="Tenmasa"
  />
);

export default TenmasaKUA;
