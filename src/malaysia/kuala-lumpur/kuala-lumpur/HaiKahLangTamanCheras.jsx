...
const HaiKahLangTamanCheras = () => (
  <RestaurantPage
    restaurantName="Hai Kah Lang (Taman Cheras)"
    address="44 Jalan Kaskas 2, Taman Cheras, Kuala Lumpur, 56100, Malaysia"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+601151299813"
    website="https://haikahlang.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Jalan%20Kaskas%202%2C%20Taman%20Cheras%2C%20Kuala%20Lumpur%2C%2056100%2C%20Malaysia"
    pageTitle="Hai Kah Lang (Taman Cheras)"
  />
);

export default HaiKahLangTamanCheras;
