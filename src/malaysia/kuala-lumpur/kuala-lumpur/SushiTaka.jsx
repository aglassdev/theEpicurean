...
const SushiTaka = () => (
  <RestaurantPage
    restaurantName="Sushi Taka"
    address="3A, The St. Regis, 6 Jalan Stesen Sentral 2, Kuala Lumpur Sentral, Kuala Lumpur, 50470, Malaysia"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+60327276688"
    website="https://taka-ushi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2016, this upmarket sushi-ya in a prestigious hotel has been prized for their authentic sushi made with the freshest and most seasonal fish flown in from Japan. The Japanese chef is specific about every detail, including the sushi rice from a town in Niigata. To experience his culinary vision in full glory, opt for the omakase menu with 10 nigiri sushi, appetisers and sashimi. Oenophiles should check out the well-curated sake list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3A%2C%20The%20St.%20Regis%2C%206%20Jalan%20Stesen%20Sentral%202%2C%20Kuala%20Lumpur%20Sentral%2C%20Kuala%20Lumpur%2C%2050470%2C%20Malaysia"
    pageTitle="Sushi Taka"
  />
);

export default SushiTaka;
