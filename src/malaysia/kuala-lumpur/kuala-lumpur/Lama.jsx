...
const Lama = () => (
  <RestaurantPage
    restaurantName="Lama"
    address="Lot 12, 257 Jalan Ayer Jerneh, Taman Ayer Panas, Kuala Lumpur, 53200, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60196893969"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/lama"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The two-storey restaurant doubles as a museum to display the owner’s antique collection. The father-and-daughter team serves authentic Nyonya home-style dishes, many of which are meant to be shared. Try their pie tee, or crispy pastry cups filled with finely diced vegetables, fried onions and shrimps dressed in a homemade chilli sauce. With unlimited free refills, pandan lemongrass tea is the perfect drink to quench the heat of the food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lot%2012%2C%20257%20Jalan%20Ayer%20Jerneh%2C%20Taman%20Ayer%20Panas%2C%20Kuala%20Lumpur%2C%2053200%2C%20Malaysia"
    pageTitle="Lama"
  />
);
