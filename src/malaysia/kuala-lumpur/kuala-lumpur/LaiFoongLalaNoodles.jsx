...
const LaiFoongLalaNoodles = () => (
  <RestaurantPage
    restaurantName="Lai Foong Lala Noodles"
    address="99 Jalan Sultan, Kuala Lumpur City Centre, Kuala Lumpur, 50000, Malaysia"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+60320222011"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/lai-fong-lala-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What began as a street stall 10 years ago that shot to local fame now occupies two shop floors on the street corner. Red lanterns adorn the ceilings, and large photos cover the walls like wallpaper. Chinese vintage gadgets, like an abacus, decorate the interior. Lala means “clams” in Malay, and a bowl of flavoursome lala bihun with prawns is a must. The broth, meanwhile, is aromatic with Chinese yellow wine and ginger. Portions are generous...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=99%20Jalan%20Sultan%2C%20Kuala%20Lumpur%20City%20Centre%2C%20Kuala%20Lumpur%2C%2050000%2C%20Malaysia"
    pageTitle="Lai Foong Lala Noodles"
  />
);

export default LaiFoongLalaNoodles;
