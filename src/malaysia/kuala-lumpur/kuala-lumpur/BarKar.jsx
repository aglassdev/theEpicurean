...
const BarKar = () => (
  <RestaurantPage
    restaurantName="Bar Kar"
    address="Suites G-06, GF, G Tower, 199 Jalan Tun Razak, Kampung Baru, Kuala Lumpur, 50400, Malaysia"
    cuisine="Barbecue"
    priceRange="$$$"
    phoneNumber="+601122773131"
    website="https://www.barkarkl.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two chefs, who previously worked in Penang, opened this restaurant in 2023 specialising in house-aged meats and seafood cooked over a wood-fired grill. Diners are greeted by an arched entrance and a striking corridor lined with logs for the fire. The 18-seat arc-shaped counter with a view of the open kitchen is the best place to sit. Signatures include oysters cooked on the spot in flaming chicken fat in a flambadou, boasting rich, smoky aromas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Suites%20G-06%2C%20GF%2C%20G%20Tower%2C%20199%20Jalan%20Tun%20Razak%2C%20Kampung%20Baru%2C%20Kuala%20Lumpur%2C%2050400%2C%20Malaysia"
    pageTitle="Bar Kar"
  />
);

export default BarKar;
