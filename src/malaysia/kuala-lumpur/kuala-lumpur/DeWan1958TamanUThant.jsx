...
const DeWan1958TamanUThant = () => (
  <RestaurantPage
    restaurantName="De. Wan 1958 (Taman U Thant)"
    address="Level 2-2, The LINC KL, 360 Jalan Tun Razak, Taman U Thant, Kuala Lumpur, 50400, Malaysia"
    cuisine="Malaysian"
    priceRange="$$$"
    phoneNumber="+60329359375"
    website="https://dewan.space"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sunny and cheerful like the local celebrity Chef Wan, the room is inviting and bustling. Similarly, the food is guaranteed to lift your spirits with big tropical flavours. Whet your appetite with pomelo salad with crispy prawn cheeks in kerabu lime dressing and a hint of fish sauce. For mains, go for bakar bakar, BBQ meat or seafood that comes with your choice of the chef’s mouth-watering sauces. Portion sizes are big enough for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%202-2%2C%20The%20LINC%20KL%2C%20360%20Jalan%20Tun%20Razak%2C%20Taman%20U%20Thant%2C%20Kuala%20Lumpur%2C%2050400%2C%20Malaysia"
    pageTitle="De. Wan 1958 (Taman U Thant)"
  />
);

export default DeWan1958TamanUThant;
