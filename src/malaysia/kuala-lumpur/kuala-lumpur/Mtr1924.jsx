...
const Mtr1924 = () => (
  <RestaurantPage
    ...
    address="69 Jalan Thambipillay, Brickfields, Kuala Lumpur, 50470, Malaysia"
    cuisine="Indian Vegetarian"
    priceRange="$"
    phoneNumber="+60322764924"
    website="https://mtr1924malaysia.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This international chain, which began almost 100 years ago, now has branches all over the world. This outpost has been a popular dining spot among the locals since 2017. Idli is a soft, fluffy steamed cake made out of fermented rice batter, paired with green chutney and lentil sambar. Masala dosa, or crispy crepe with potato curry, packs a real kick. Uddin vada, or black lentil fritter, is also a good choice. Check out the daily specials and mini meals for combos...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=69%20Jalan%20Thambipillay%2C%20Brickfields%2C%20Kuala%20Lumpur%2C%2050470%2C%20Malaysia"
    pageTitle="MTR 1924"
  />
);

export default Mtr1924;
