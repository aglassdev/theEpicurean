...
const MarinisOn57 = () => (
  <RestaurantPage
    restaurantName="Marini's on 57"
    address="57F, Menara 3 Petronas, Persiaran KLCC, Kuala Lumpur City Centre, Kuala Lumpur, 50088, Malaysia"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+60323866030"
    website="https://marinisgroup.com/marinis-on-57"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this iconic rooftop venue, diners enjoy superb sunsets and panoramic cityscapes through floor to ceiling windows. Besides the à la carte menu, there are several tasting menus that offer a knockout selection of Italian dishes, featuring innovative elements, choice cuts of imported beef and artisan pasta. The intriguing tiramisu, which comes in a tin of caviar, is made with coffee caviar (rather than fish eggs!)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57F%2C%20Menara%203%20Petronas%2C%20Persiaran%20KLCC%2C%20Kuala%20Lumpur%20City%20Centre%2C%20Kuala%20Lumpur%2C%2050088%2C%20Malaysia"
    pageTitle="Marini's on 57"
  />
);

export default MarinisOn57;
