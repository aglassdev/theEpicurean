...
const WongMeiKee = () => (
  <RestaurantPage
    restaurantName="Wong Mei Kee"
    address="30 Jalan Nyonya, off Jalan Pudu, Pudu, Kuala Lumpur, 55100, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60321452512"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/wong-mei-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open for just a few hours a day, this stall attracts foodies in droves with its coveted siew yok – roast pork with crackling skin and succulent meat. Arrive early and wait for the pork to come out of the oven at noon sharp...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20Jalan%20Nyonya%2C%20off%20Jalan%20Pudu%2C%20Pudu%2C%20Kuala%20Lumpur%2C%2055100%2C%20Malaysia"
    pageTitle="Wong Mei Kee"
  />
);

export default WongMeiKee;
