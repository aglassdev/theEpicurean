...
const TanglinBukitDamansara = () => (
  <RestaurantPage
    restaurantName="Tanglin (Bukit Damansara)"
    address="57G, Jalan Medan Setia 1, Bukit Damansara, Kuala Lumpur, 50490, Malaysia"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+60192832233"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/tanglin-bukit-damansara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in 1948, the family-owned Tanglin is now run by the second generation and the two-storey establishment is well known for its nasi lemak. This delicious family recipe is paired with either sotong (squid), daging (meat) or ayam goreng (fried chicken). Its fragrant rice has the right mix of coconut milk and its sambal tumis, the right level of spiciness. Whether dining in or taking away, the queues are long. Generous portions and prices that make sense...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57G%2C%20Jalan%20Medan%20Setia%201%2C%20Bukit%20Damansara%2C%20Kuala%20Lumpur%2C%2050490%2C%20Malaysia"
    pageTitle="Tanglin (Bukit Damansara)"
  />
);

export default TanglinBukitDamansara;
