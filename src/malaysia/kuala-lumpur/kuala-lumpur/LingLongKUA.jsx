...
const LingLongKUA = () => (
  <RestaurantPage
    ...
    address="L2-04, Block E, The Five@KPD, 49 Jalan Dungun, Bukit Damansara, Kuala Lumpur, 50490, Malaysia"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+60105568912"
    website="https://www.linglong.com.my"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Born into a Chinese family of chefs and formally trained in Gallic cuisine, the head chef strives to add a French spin to Chinese gourmet classics. The tasting menu embodies his culinary vision – crispy duck is aged for seven days making it juicy and tender; the must-try botan ebi dressed in fermented Chinese tofu sauce is marvellously ingenious. The chef occasionally pops out of the kitchen to serve the food himself and chat with diners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L2-04%2C%20Block%20E%2C%20The%20Five%40KPD%2C%2049%20Jalan%20Dungun%2C%20Bukit%20Damansara%2C%20Kuala%20Lumpur%2C%2050490%2C%20Malaysia"
    pageTitle="Ling Long"
  />
);

export default LingLongKUA;
