...
const HingKeeBakuteh121JalanKepong = () => (
  <RestaurantPage
    restaurantName="Hing Kee Bakuteh (121 Jalan Kepong)"
    address="121 Jalan Kepong, Taman Usahawan, Kuala Lumpur, 52100, Malaysia"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+60125233599"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/hing-kee-bakuteh-jalan-kepong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just as bak kut teh is Malaysia's iconic dish and soul food, this restaurant also has a place in the hearts of locals. It’s particularly popular for lunch. The bak kut teh soup has a characteristic mild flavour that’s well-balanced with a subtle use of herbs and light, sweet flavours. The dry, spicy version has a richer, thicker consistency. The four shop houses that line the boulevard offer plenty of seating and absorb the noise and energy of the street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20Jalan%20Kepong%2C%20Taman%20Usahawan%2C%20Kuala%20Lumpur%2C%2052100%2C%20Malaysia"
    pageTitle="Hing Kee Bakuteh (121 Jalan Kepong)"
  />
);

export default HingKeeBakuteh121JalanKepong;
