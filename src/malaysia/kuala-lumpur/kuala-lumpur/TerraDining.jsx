...
const TerraDining = () => (
  <RestaurantPage
    restaurantName="Terra Dining"
    address="91 Jalan Aminuddin Baki, Taman Tun Dr Ismail, Kuala Lumpur, 60000, Malaysia"
    cuisine="Malaysian, Contemporary"
    priceRange="$$$"
    phoneNumber="+601170727777"
    website="https://www.terra-dining.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Self-taught Chef Chong uses Malaysian produce to imbue his French-leaning 11-course tasting menu with local colour and flavour. His lobster bisque is made with smoky Tahal oil based on asam laksa; his beurre blanc incorporates a creamy curry with turmeric and coconut milk à la masak lemak. Equally inspiring, his curated tea pairings complement the food by flavour bridging. Ask the chef for the tea tasting notes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=91%20Jalan%20Aminuddin%20Baki%2C%20Taman%20Tun%20Dr%20Ismail%2C%20Kuala%20Lumpur%2C%2060000%2C%20Malaysia"
    pageTitle="Terra Dining"
  />
);

export default TerraDining;
