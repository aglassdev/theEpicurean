...
const Bl = () => (
  <RestaurantPage
    ...
    priceRange="$$$"
    phoneNumber="+60102838869"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/bol"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having cooked together since they were young, Singaporean chef-owner and hotel designer, Kian Liew, and partner, Patrick, opened their brainchild in 2022 and have already earned the support of many regulars. Only set menus are available, including one that is entirely seasonal and one for vegans. The focus is on Nyonya style cuisine with Singaporean and Malaysian twists, using a healthy mix of herbs and spices to create a succulent range of flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Jalan%20Sin%20Chew%20Kee%2C%20Bukit%20Bintang%2C%20Kuala%20Lumpur%2C%2050150%2C%20Malaysia"
    pageTitle="Bōl"
  />
);
