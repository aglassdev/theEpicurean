...
const LaSuisse = () => (
  <RestaurantPage
    restaurantName="La Suisse"
    address="17, Lorong Rahim Kajai 13, Taman Tun Dr Ismail, Kuala Lumpur, 60000, Malaysia"
    cuisine="European"
    priceRange="$$"
    phoneNumber="+60377336996"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/la-suisse"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since their opening in 1992, husband-and-wife team Chef Mike Yap and Claudia have maintained alpine levels of excellence. Through their unwavering passion and hard work, they’ve created a restaurant with modern charms and old-fashioned styles that exudes genuine warmth – it’s like being invited into a family home for a meal. The heartwarming menu includes cheesy favourites like raclette and malakow, classic beef dishes and a veal that evokes waves of nostalgia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%2C%20Lorong%20Rahim%20Kajai%2013%2C%20Taman%20Tun%20Dr%20Ismail%2C%20Kuala%20Lumpur%2C%2060000%2C%20Malaysia"
    pageTitle="La Suisse"
  />
);

export default LaSuisse;
