...
const RotiByDtandoor = () => (
  <RestaurantPage
    restaurantName="Roti by d'Tandoor"
    address="82 Jalan Damai, off Jalan Ampang, Kampung Datuk Keramat, Kuala Lumpur, 55000, Malaysia"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+601169692020"
    website="https://dtandoor.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A North Indian brand, d'Tandoor opened in Malaysia in 1990 and has since spread to other countries around the world. Located in a residential area, they offer a hearty range of fine Indian cuisine, featuring a consummate blend of herbs and spices. Highlights include well-seasoned butter chicken masala and soft, chewy naan bread, while Kulfi ice-cream – available in a variety of flavours – adds a final flourish to the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20Jalan%20Damai%2C%20off%20Jalan%20Ampang%2C%20Kampung%20Datuk%20Keramat%2C%20Kuala%20Lumpur%2C%2055000%2C%20Malaysia"
    pageTitle="Roti by d'Tandoor"
  />
);

export default RotiByDtandoor;
