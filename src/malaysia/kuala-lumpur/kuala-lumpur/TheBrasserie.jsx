...
const TheBrasserie = () => (
  <RestaurantPage
    restaurantName="The Brasserie"
    address="2F, The St. Regis, 6 Jalan Stesen Sentral 2, Kuala Lumpur Sentral, Kuala Lumpur, 50470, Malaysia"
    cuisine="French Contemporary"
    priceRange="$$$"
    phoneNumber="+60327276666"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/the-brasserie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef draws on his experience working with some of the biggest names across Europe and Asia to create modern French cuisine with Mediterranean and Asian influences. All dishes are as pleasing to the eye as to the palate. Pithivier de Louise with layers of beef, foie gras and chicken mousse in buttery flaky pastry is perfect for two. Alongside à la carte and vegetarian options, they serve a five- to seven-course tasting menu for the full experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20St.%20Regis%2C%206%20Jalan%20Stesen%20Sentral%202%2C%20Kuala%20Lumpur%20Sentral%2C%20Kuala%20Lumpur%2C%2050470%2C%20Malaysia"
    pageTitle="The Brasserie"
  />
);

export default TheBrasserie;
