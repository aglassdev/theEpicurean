...
const Bidou = () => (
  <RestaurantPage
    restaurantName="Bidou"
    address="9 Jalan Setiakasih 5, Bukit Damansara, Kuala Lumpur, 50490, Malaysia"
    cuisine="French"
    priceRange="$$$"
    phoneNumber="+60122786720"
    website="https://www.bidou.my"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Unlike Dewakan that focuses on innovation, chef Darren Teoh opened Bidou to revisit the nouvelle cuisine movement. The 3- or 4-course set menu offers a choice of dishes, which may include threadfin and scallop mousse baked en croûte, in a nod to the recipe of culinary pioneer, Paul Bocuse. The pastry crust is shaped like a fish and a tangy Choron sauce complements the juicy flesh. Also check out the wine list with over 30 by-the-glass choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Jalan%20Setiakasih%205%2C%20Bukit%20Damansara%2C%20Kuala%20Lumpur%2C%2050490%2C%20Malaysia"
    pageTitle="Bidou"
  />
);
