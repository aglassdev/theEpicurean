...
const AnakBabaBrickfields = () => (
  <RestaurantPage
    restaurantName="Anak Baba (Brickfields)"
    address="159 Jalan Sultan Abdul Samad, Brickfields, Kuala Lumpur, 50470, Malaysia"
    cuisine="Malaysian, Peranakan"
    priceRange="$"
    phoneNumber="+60320220038"
    website="https://guide.michelin.com/en/kuala-lumpur-region/kuala-lumpur/restaurant/anak-baba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2018, this cosy little gem tucked inside the Little India has been serving authentic Southern Peranakan cuisine that melds Indo-Malay flavours with Chinese influences. The must-try nasi lemak with ayam goreng kunyit is the quintessential national comfort food – coconut milk lends a subtle sweetness to the rice, in stark contrast with the juicy fried chicken, fiery sambal and crisp water spinach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=159%20Jalan%20Sultan%20Abdul%20Samad%2C%20Brickfields%2C%20Kuala%20Lumpur%2C%2050470%2C%20Malaysia"
    pageTitle="Anak Baba (Brickfields)"
  />
);

export default AnakBabaBrickfields;
