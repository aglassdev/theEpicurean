...
const NasiAyamHainanCheeMengJalanKelangLama = () => (
  <RestaurantPage
    restaurantName="Nasi Ayam Hainan Chee Meng (Jalan Kelang Lama)"
    address="Sub Lot-A1, Batu 4 1/4, Jalan Kelang Lama, Kuala Lumpur, 58000, Malaysia"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+60379727551"
    website="https://www.cheemeng.com.my"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-owned business has been a mainstay of the local dining scene since 1965 and is now run by the second and third generations. As its name suggests, it specialises in Hainan chicken rice – choose between the steamed and fried varieties. For solo diners, the set menu offers great value, with peanut soup, flavoursome rice cooked in chicken fat and stock, and your choice of chicken cuts. The other chicken dishes are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sub%20Lot-A1%2C%20Batu%204%201%2F4%2C%20Jalan%20Kelang%20Lama%2C%20Kuala%20Lumpur%2C%2058000%2C%20Malaysia"
    pageTitle="Nasi Ayam Hainan Chee Meng (Jalan Kelang Lama)"
  />
);

export default NasiAyamHainanCheeMengJalanKelangLama;
