...
const Marble8 = () => (
  <RestaurantPage
    restaurantName="Marble 8"
    address="56F, Menara 3 Petronas, Persiaran KLCC, Kuala Lumpur City Centre, Kuala Lumpur, 50088, Malaysia"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+60323866030"
    website="https://marinisgroup.com/marble-8/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It takes a few lift rides to get to Marble 8, but as soon as you set foot in the dining room, you know it’s all worthwhile. The stunning skyline with the Twin Towers in the foreground is the perfect backdrop for a sumptuous meal featuring top-quality halal-certified Wagyu and Angus beef straight from Australia. Premium cuts are dry- or wet-aged for at least 21 days for deep flavours and tender texture, and then grilled to perfection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56F%2C%20Menara%203%20Petronas%2C%20Persiaran%20KLCC%2C%20Kuala%20Lumpur%20City%20Centre%2C%20Kuala%20Lumpur%2C%2050088%2C%20Malaysia"
    pageTitle="Marble 8"
  />
);

export default Marble8;
