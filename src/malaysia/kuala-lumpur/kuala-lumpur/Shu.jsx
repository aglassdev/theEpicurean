...
const Shu = () => (
  <RestaurantPage
    restaurantName="Shu"
    address="8F, Annexed Block, Menara IMC, 8 Jalan Sultan Ismail, Kuala Lumpur, 50250, Malaysia"
    cuisine="Innovative"
    priceRange="$$$"
    phoneNumber="+601127696838"
    website="https://www.restaurantshu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Wong named the restaurant after his mother and revisits his Chinese roots and childhood food memories. The single tasting menu is inspired by Chinese diaspora cooking while featuring a new take on familiar flavours with seasonal produce and modern European techniques. His version of drunken prawn is raw akaebi marinated in Shaoxing wine, drizzled in umami-laden Huadiao beurre blanc and topped with ikura and tender squid cubes for added layers of texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8F%2C%20Annexed%20Block%2C%20Menara%20IMC%2C%208%20Jalan%20Sultan%20Ismail%2C%20Kuala%20Lumpur%2C%2050250%2C%20Malaysia"
    pageTitle="Shu"
  />
);
