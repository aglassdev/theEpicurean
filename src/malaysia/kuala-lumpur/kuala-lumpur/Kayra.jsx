...
const Kayra = () => (
  <RestaurantPage
    restaurantName="Kayra"
    address="F-8, 1F, Bangsar Village 1, Jalan Telawi 1, Bangsar, Kuala Lumpur, 59100, Malaysia"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+60172157382"
    website="https://kayra.com.my"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the culinary heart of southwest India, and productive capital of peppers and spices since ancient times, Kerala has had a profound influence on the dishes here. Kayra builds on Kerala’s venerable traditions, serving contemporary recipes with a rich mix of spices – central to the cuisine's identity – and modern aesthetics. Beef features prominently here. Prices are reasonable and the industrial interior with brick design gives a modern and simple impression...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=F-8%2C%201F%2C%20Bangsar%20Village%201%2C%20Jalan%20Telawi%201%2C%20Bangsar%2C%20Kuala%20Lumpur%2C%2059100%2C%20Malaysia"
    pageTitle="Kayra"
  />
);

export default Kayra;
