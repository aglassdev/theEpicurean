...
const BmCathayPancake = () => (
  <RestaurantPage
    restaurantName="BM Cathay Pancake"
    address="8 Jalan Aston, Bukit Mertajam, Seberang Perai, 14000, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164111381"
    website="https://guide.michelin.com/en/pulau-pinang/seberang-perai/restaurant/bm-cathay-pancake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1962, this cart outside Cathay Food Court has been serving only one dish – Apam Balik, or chargrilled pancake with sugar peanut filling. Made on the spot and served piping hot, it’s crispy on the outside, chewy on the inside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Jalan%20Aston%2C%20Bukit%20Mertajam%2C%20Seberang%20Perai%2C%2014000%2C%20Malaysia"
    pageTitle="BM Cathay Pancake"
  />
);

export default BmCathayPancake;
