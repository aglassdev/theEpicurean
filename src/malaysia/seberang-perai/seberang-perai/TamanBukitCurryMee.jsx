...
const TamanBukitCurryMee = () => (
  <RestaurantPage
    restaurantName="Taman Bukit Curry Mee"
    address="Jalan Bukit Kecil, Taman Bukit, Bukit Mertajam, Seberang Perai, 14000, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124861852"
    website="https://guide.michelin.com/en/pulau-pinang/seberang-perai/restaurant/taman-bukit-curry-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall has been selling curry mee for almost 40 years and is prized for the creamy soup made with coconut milk and spicy curry paste. The half-cooked cockles in the soup taste briny-sweet and burst with juices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jalan%20Bukit%20Kecil%2C%20Taman%20Bukit%2C%20Bukit%20Mertajam%2C%20Seberang%20Perai%2C%2014000%2C%20Malaysia"
    pageTitle="Taman Bukit Curry Mee"
  />
);

export default TamanBukitCurryMee;
