...
const Neighbourwood = () => (
  <RestaurantPage
    restaurantName="Neighbourwood"
    address="3427 Jalan Kulim, Taman Bukit Mas, Bukit Mertajam, Seberang Perai, 14000, Malaysia"
    cuisine="European Contemporary"
    priceRange="$$"
    phoneNumber="+60129030862"
    website="https://guide.michelin.com/en/pulau-pinang/seberang-perai/restaurant/neighbourwood"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner lives nearby and opened this cosy spot for his neighbours to enjoy European fare with Asian influences alongside some chargrilled items. The menu changes every six weeks to keep it fresh, but three dishes great for sharing always remain – half roast chicken au jus, Berkshire pork loin, and fish en papillote. For starters, try fish croquettes, and round it out with their homemade desserts. Consider buying their sourdough bread to take home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3427%20Jalan%20Kulim%2C%20Taman%20Bukit%20Mas%2C%20Bukit%20Mertajam%2C%20Seberang%20Perai%2C%2014000%2C%20Malaysia"
    pageTitle="Neighbourwood"
  />
);

export default Neighbourwood;
