...
const BmYamRice = () => (
  <RestaurantPage
    restaurantName="BM Yam Rice"
    address="7 Jalan Murthy, Bukit Mertajam, Seberang Perai, 14000, Malaysia"
    cuisine="Teochew"
    priceRange="$"
    phoneNumber="+60125646104"
    website="https://guide.michelin.com/en/pulau-pinang/seberang-perai/restaurant/bm-yam-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since opening its doors in 2006, this shop has been serving the owner’s family recipe. They pride themselves with their yam rice with pork soup – you can choose to have pork offal in the soup or not. The yam rice is nicely cooked, with strong shrimp flavour. The pork broth is briny-sweet and the pickled mustard green gives it a tangy depth. The offal is cooked to the perfect texture while the pork balls are peppery and flavoursome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Jalan%20Murthy%2C%20Bukit%20Mertajam%2C%20Seberang%20Perai%2C%2014000%2C%20Malaysia"
    pageTitle="BM Yam Rice"
  />
);

export default BmYamRice;
