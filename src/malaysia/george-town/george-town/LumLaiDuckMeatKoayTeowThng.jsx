...
const LumLaiDuckMeatKoayTeowThng = () => (
  <RestaurantPage
    restaurantName="Lum Lai Duck Meat Koay Teow Th'ng"
    address="Pasar Lebuh Cecil, 24 Lebuh Cecil, George Town, 10300, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124336680"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/lum-lai-duck-meat-koay-teow-th-ng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For 40+ years, they have been making their kway teow soup the same way – with duck, pork and fish cake. The broth bursts with umami, the duck is silky, and fried garlic and shallot bits add aroma. Expect to queue at peak hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pasar%20Lebuh%20Cecil%2C%2024%20Lebuh%20Cecil%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Lum Lai Duck Meat Koay Teow Th'ng"
  />
);

export default LumLaiDuckMeatKoayTeowThng;
