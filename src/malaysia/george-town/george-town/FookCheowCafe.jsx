...
const FookCheowCafe = () => (
  <RestaurantPage
    restaurantName="Fook Cheow Cafe"
    address="122I Jalan Hutton, George Town, 10050, Malaysia"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+60164543281"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/fook-cheow-cafe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on a street corner, the signage is inconspicuous, but its popularity with locals mean that it can’t be missed. This simple eatery has been open for some 30 years, but only in the mornings, which makes it just the ticket to sample the local breakfast. The signature dish, koay teow th'ng, is rice noodle soup with fish balls, deep-fried garlic, shredded chicken and lettuce. The tasty soup broth is made from hen and pork bones...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122I%20Jalan%20Hutton%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Fook Cheow Cafe"
  />
);

export default FookCheowCafe;
