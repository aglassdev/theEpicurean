...
const GohThewChikHainanChickenRice = () => (
  <RestaurantPage
    restaurantName="Goh Thew Chik Hainan Chicken Rice"
    address="338A-338B Lebuh Chulia, George Town, 10200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/goh-thew-chik-hainan-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop with over 70 years of history serves not just Hainan-style chicken but also grilled chicken with chicken oil rice. The tangy chilli sauce made in-house cuts through the richness of the silky, juicy meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=338A-338B%20Lebuh%20Chulia%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Goh Thew Chik Hainan Chicken Rice"
  />
);

export default GohThewChikHainanChickenRice;
