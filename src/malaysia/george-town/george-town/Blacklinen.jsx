...
const Blacklinen = () => (
  <RestaurantPage
    restaurantName="Blacklinen"
    address="Level 9, The Millen, 55 Jalan Sultan Ahmad Shah, George Town, 10050, Malaysia"
    cuisine="Barbecue"
    priceRange="$$$"
    phoneNumber="+60194917168"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/blacklinen"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%209%2C%20The%20Millen%2C%2055%20Jalan%20Sultan%20Ahmad%20Shah%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Blacklinen"
  />
);

export default Blacklinen;
