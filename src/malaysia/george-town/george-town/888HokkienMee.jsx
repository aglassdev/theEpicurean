...
const 888HokkienMee = () => (
  <RestaurantPage
    restaurantName="888 Hokkien Mee"
    address="67-A Lebuh Presgrave, George Town, 10300, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/888-hokkien-mee-lebuh-presgrave"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For 30 years, this small outlet has been serving Hokkien-style noodles in prawn soup. The soup has a beautiful rich red colour and sweet umami flavour. Add a little textural variety to your bowl with tasty options such as braised pork ribs or roasted pork – both highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67-A%20Lebuh%20Presgrave%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="888 Hokkien Mee"
  />
);

export default 888HokkienMee;
