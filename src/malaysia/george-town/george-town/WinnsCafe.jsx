...
const WinnsCafe = () => (
  <RestaurantPage
    restaurantName="Winn's Cafe"
    address="38 Jalan Cantonment, George Town, 10350, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60194511631"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/winn-s-cafe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by a husband-wife team, Winn’s Cafe is situated in a detached house with dining rooms spread over two storeys, the upper floor of which exhibits work by local artists. The menu features Peranakan classics, such as otak otak fish cake seasoned with coconut milk and local herbs grown in their backyard and boasts silky smooth texture. Asam tumis stingray seduces with bouncy, flavoursome meat and a rich, complex sauce made with nine herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20Jalan%20Cantonment%2C%20George%20Town%2C%2010350%2C%20Malaysia"
    pageTitle="Winn's Cafe"
  />
);

export default WinnsCafe;
