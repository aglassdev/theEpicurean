...
const IvysNyonyaCuisine = () => (
  <RestaurantPage
    restaurantName="Ivy's Nyonya Cuisine"
    address="100-104 Jalan Kedah, George Town, 10050, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60134337878"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/ivy-s-nyonya-cuisine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple restaurant has been run by a husband-wife team for over 15 years; Ivy helms the kitchen while her husband waits on the tables. Following a change of venue in 2024, the room is now bigger and better, but you can rest assured - the menu hasn’t changed one bit. Check out the sharing set menus that include their best-selling Peranakan dishes, like Kapitan chicken curry and Joo Hoo Char – spicy stir-fried mixed veggies in chili paste. Reservations recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100-104%20Jalan%20Kedah%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Ivy's Nyonya Cuisine"
  />
);

export default IvysNyonyaCuisine;
