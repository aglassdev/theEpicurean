...
const AirItamDuckRice = () => (
  <RestaurantPage
    restaurantName="Air Itam Duck Rice"
    address="Air Itam Wet Market, Jalan Pasar, George Town, 11500, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164308669"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/air-itam-duck-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are many shops in Penang selling roasted duck, but this stall's tender braised duck is packed with flavour, including soy sauce, anise and cinnamon. They also serve braised pork belly, pork intestines, egg and bean curd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Air%20Itam%20Wet%20Market%2C%20Jalan%20Pasar%2C%20George%20Town%2C%2011500%2C%20Malaysia"
    pageTitle="Air Itam Duck Rice"
  />
);

export default AirItamDuckRice;
