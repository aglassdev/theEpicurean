...
const KebayaDiningRoom = () => (
  <RestaurantPage
    restaurantName="Kebaya Dining Room"
    address="14A Lorang Stewart, George Town, 10200, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+6042642333"
    website="https://kebaya.com.my"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14A%20Lorang%20Stewart%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Kebaya Dining Room"
  />
);

export default KebayaDiningRoom;
