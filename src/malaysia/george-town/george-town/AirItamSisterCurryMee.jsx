...
const AirItamSisterCurryMee = () => (
  <RestaurantPage
    restaurantName="Air Itam Sister Curry Mee"
    address="612 T, Jalan Air Itam Pekan Ayer Itam, George Town, 11500, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124108152"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/air-itam-sister-curry-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop in a market serves Penang-style curry mee at friendly prices. The mee is cooked over charcoal, in a well-balanced soup with spices, chilli paste and coconut milk; tofu puffs and spring squid add contrasting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=612%20T%2C%20Jalan%20Air%20Itam%20Pekan%20Ayer%20Itam%2C%20George%20Town%2C%2011500%2C%20Malaysia"
    pageTitle="Air Itam Sister Curry Mee"
  />
);

export default AirItamSisterCurryMee;
