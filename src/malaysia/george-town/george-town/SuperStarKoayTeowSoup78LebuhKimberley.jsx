...
const SuperStarKoayTeowSoup78LebuhKimberley = () => (
  <RestaurantPage
    restaurantName="Super Star Koay Teow Soup (78 Lebuh Kimberley)"
    address="78 Lebuh Kimberley, George Town, 10100, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164555165"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/super-star-koay-teow-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular food cart dates back to 1960 and is now run by the third-generation owner. Koay teow soup with chicken, pork, fish balls and pork liver is the must-try. The chicken feet braised in spiced soy marinade are simply divine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=78%20Lebuh%20Kimberley%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Super Star Koay Teow Soup (78 Lebuh Kimberley)"
  />
);

export default SuperStarKoayTeowSoup78LebuhKimberley;
