...
const LuckyHole = () => (
  <RestaurantPage
    restaurantName="Lucky Hole"
    address="23N Lebuh Pantai, George Town, 10200, Malaysia"
    cuisine="Innovative"
    priceRange="$$"
    phoneNumber="+60124353134"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/lucky-hole"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once a factory, this space furnished in retro industrial style fizzes with energy – not only because of the sizzling charcoal grill in the open kitchen, but also the fun, passionate service team. Chargrilled meats, seafood, and vegetables are the main event; the wild-caught giant shrimps with crispy garlic crumbles and chilli oil are a very popular choice. The warm banana cake with Baileys ice cream presents interesting contrasts in temperature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23N%20Lebuh%20Pantai%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Lucky Hole"
  />
);

export default LuckyHole;
