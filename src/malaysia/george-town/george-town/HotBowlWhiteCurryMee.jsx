...
const HotBowlWhiteCurryMee = () => (
  <RestaurantPage
    restaurantName="Hot Bowl White Curry Mee"
    address="58C Jalan Rangoon, George Town, 10400, Malaysia"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+6042273168"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/hot-bowl-white-curry-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="White curry mee is served in a coconut milk-based broth with a bowl of curry paste on the side so that you can adjust the heat to your liking. The curry paste is available for sale by the bottle; it takes two hours to hand-stir the spices with dried shrimps and chillies. Optionally, pair your mee with deboned steamed chicken, spiced loh bak or Teochew guang jiang. The clear broth noodle soup with chicken meatballs is also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58C%20Jalan%20Rangoon%2C%20George%20Town%2C%2010400%2C%20Malaysia"
    pageTitle="Hot Bowl White Curry Mee"
  />
);

export default HotBowlWhiteCurryMee;
