...
const KotaDineCoffeeFortCornwallis = () => (
  <RestaurantPage
    restaurantName="Kota Dine & Coffee (Fort Cornwallis)"
    address="Fort Cornwallis, Jalan Tun Syed Sheh Barakbah, George Town, 10200, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+6043714929"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/kota-dine-coffee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It feels relaxing to sit in the glass-clad room drenched in natural light and furnished in faux-industrial style. In terms of food, they serve a neo-Nyonya menu with a strong East-meets-West concept. On top of Peranakan classics like otak-otak, Western influences are manifested in more adventurous creations such as laksa capellini. Even the desserts take a surprise twist, as in teh-ramisu that uses tea instead of coffee...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fort%20Cornwallis%2C%20Jalan%20Tun%20Syed%20Sheh%20Barakbah%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Kota Dine & Coffee (Fort Cornwallis)"
  />
);

export default KotaDineCoffeeFortCornwallis;
