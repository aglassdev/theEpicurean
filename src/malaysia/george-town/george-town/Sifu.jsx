...
const Sifu = () => (
  <RestaurantPage
    restaurantName="Sifu"
    address="154 Jalan Pintal Tali, George Town, 10100, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60124106688"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/sifu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The kitchen is helmed by a lady in her 70s, who has been cooking for decades. The menu boasts some 40 à la carte items, covering the greatest hits of traditional Peranakan cuisine. One of the culinary highlights is bouncy asam prawn drizzled in a dark brown sauce loaded with tamarind sweet and sour notes. Mang kuang char, or sautéed shredded yam bean with dried squid and mushrooms, is sweet in taste and crisp in texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=154%20Jalan%20Pintal%20Tali%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Sifu"
  />
);
