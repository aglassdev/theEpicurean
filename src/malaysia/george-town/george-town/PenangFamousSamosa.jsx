...
const PenangFamousSamosa = () => (
  <RestaurantPage
    restaurantName="Penang Famous Samosa"
    address="45 Lebuh Queen, George Town, 10200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164775786"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/penang-famous-samosa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall in Little India serves a delicious range of samosas, including mutton, chicken, sardine, egg and vegetable. Encased in a crispy shell, the flavoursome fillings are moderately spicy. Prices are fair, too, so no wonder customers are prepared to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Lebuh%20Queen%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Penang Famous Samosa"
  />
);

export default PenangFamousSamosa;
