...
const BibiksKitchen = () => (
  <RestaurantPage
    restaurantName="Bibik's Kitchen"
    address="73 Jalan Sri Bahari, George Town, 10050, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60126697488"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/bibik-s-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Bibik” is an honorific used to address older Peranakan women, and the room is aptly decorated with classic Nyonya motifs. Naturally, the menu showcases the owner’s heirloom Peranakan recipes that are slightly less spicy than their counterparts elsewhere. Dishes come in three sizes – try their jiu hu char (stir-fried yam bean with shredded cuttlefish), and loh bak (deep-fried five-spice pork rolls)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20Jalan%20Sri%20Bahari%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Bibik's Kitchen"
  />
);

export default BibiksKitchen;
