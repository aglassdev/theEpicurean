...
const RichardRivalee = () => (
  <RestaurantPage
    restaurantName="Richard Rivalee"
    address="62 & 64 Lorong Macalister, George Town, 10400, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+6042274888"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/richard-rivalee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fashion designer Richard Rivalee shares his passion for Nyonya culture and Peranakan food in this smart vintage joint, whose knickknacks and heritage premises are a nod to the Baba-Nyonya culture. Deceptively simple, homespun dishes are finessed with spot-on seasoning and loads of punch. Otak-otak, or savoury fish egg custard, combines a velvety texture with just the right amount of heat. To reduce food waste, most items are available in two portion sizes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20%26%2064%20Lorong%20Macalister%2C%20George%20Town%2C%2010400%2C%20Malaysia"
    pageTitle="Richard Rivalee"
  />
);

export default RichardRivalee;
