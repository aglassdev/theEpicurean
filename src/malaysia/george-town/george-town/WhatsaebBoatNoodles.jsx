...
const WhatsaebBoatNoodles = () => (
  <RestaurantPage
    restaurantName="WhatSaeb Boat Noodles"
    address="173 Lebuh Carnarvon, George Town, 10100, Malaysia"
    cuisine="Thai"
    priceRange="$"
    phoneNumber="+60175556133"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/whatsaeb-boat-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here to get your fix for boat noodles. The owner hires a kitchen team from Thailand to make sure it’s made properly. There are many toppings and noodles to choose from, but pork rice noodle soup with extra pork cracklings will be your best bet. In addition to the noodle soup, the menu also features an array of Thai classics, such as curry, som tum salads and desserts. On weekends, make sure to try their mango sticky rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=173%20Lebuh%20Carnarvon%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="WhatSaeb Boat Noodles"
  />
);

export default WhatsaebBoatNoodles;
