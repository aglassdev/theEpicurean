...
const JitSengHongKongRoastedDuckRice = () => (
  <RestaurantPage
    restaurantName="Jit Seng Hong Kong Roasted Duck Rice"
    address="246 Lebuh Carnarvon, George Town, 10450, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164561019"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/jit-seng-hong-kong-roasted-duck-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef-owner started his own business after years as a chef in a larger restaurant. Open for three hours a day, the shop is famous for his roasted duck with deep-red skin and juicy meat, for which customers are prepared to queue. The roasted pork belly and char siew are tasty extras...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=246%20Lebuh%20Carnarvon%2C%20George%20Town%2C%2010450%2C%20Malaysia"
    pageTitle="Jit Seng Hong Kong Roasted Duck Rice"
  />
);

export default JitSengHongKongRoastedDuckRice;
