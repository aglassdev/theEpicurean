...
const BaoTeckTeaHouse = () => (
  <RestaurantPage
    restaurantName="Bao Teck Tea House"
    address="25 Lebuh Melayu, George Town, 10300, Malaysia"
    cuisine="Dim Sum"
    priceRange="$$"
    phoneNumber="+6042631100"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/bao-teck-tea-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the place to go for an authentic yum cha experience and tasty Cantonese dim sum. The room has historic appeal, with details worth appreciating such as the patterned tile flooring and the moss garden. But it’s the dim sum that sets it apart – try steamed har gow dumplings made with local shrimp, and the deep-fried yam puffs in airy honeycomb crust. The owner also runs a bakery, and their Chinese baked goods are excellent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Lebuh%20Melayu%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Bao Teck Tea House"
  />
);

export default BaoTeckTeaHouse;
