...
const AhBoyKoayTeowThng = () => (
  <RestaurantPage
    restaurantName="Ah Boy Koay Teow Th'ng"
    address="1 Lebuh Clarke, George Town, 10050, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164426453"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/ah-boy-koay-teow-th-ng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This friendly family-run shop, now in the second generation, specialises in koay teow th'ng, served in soup or dry. The broth is made from chicken and pork bones. The springy tendon balls have a nice ginger flavour. A tasty option is the braised chicken with bean sprouts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Lebuh%20Clarke%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Ah Boy Koay Teow Th'ng"
  />
);

export default AhBoyKoayTeowThng;
