...
const AwesomeCharKoayTeow = () => (
  <RestaurantPage
    restaurantName="Awesome Char Koay Teow"
    address="New KK99 Cafe, 99 Jalan Lembah Permai, Tanjung Bungah, George Town, 11200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124826118"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/awesome-char-koay-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family business is now run by the third generation. Each aromatic plate of koay teow is fried to order and exudes wok hei. It tastes even better with a dab of chilli sauce. Optionally, add an over-easy egg or cheese on top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=New%20KK99%20Cafe%2C%2099%20Jalan%20Lembah%20Permai%2C%20Tanjung%20Bungah%2C%20George%20Town%2C%2011200%2C%20Malaysia"
    pageTitle="Awesome Char Koay Teow"
  />
);

export default AwesomeCharKoayTeow;
