...
const BridgeStreetPrawnNoodle = () => (
  <RestaurantPage
    restaurantName="Bridge Street Prawn Noodle"
    address="533 Lebuh Pantai, George Town, 10300, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60105662217"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/bridge-street-prawn-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come here for the famous prawn mee: choose between yellow and rice noodles, then pick the soup – the spicy prawn broth is loaded with deep flavours. Finally, consider ordering add-ons such as braised pork spareribs or fish balls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=533%20Lebuh%20Pantai%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Bridge Street Prawn Noodle"
  />
);

export default BridgeStreetPrawnNoodle;
