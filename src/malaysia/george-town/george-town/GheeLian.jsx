...
const GheeLian = () => (
  <RestaurantPage
    ...
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124508595"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/ghee-lian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They serve three noodle dishes: the signature green tom yum, noodle soup and fried noodles. The fresh green tom yum hits the right balance of sour and spicy. The fried fish topping has a crispy outer layer and a succulent centre; the large prawns have a moreish umami flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lot%20No.%2039%2C%20MBPP%20Kompleks%20Makanan%20Medan%20Renong%20Padang%20Kota%20Lama%2C%204%20Jalan%20Tun%20Syed%20Sheh%20Barakhbah%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Ghee Lian"
  />
);

export default GheeLian;
