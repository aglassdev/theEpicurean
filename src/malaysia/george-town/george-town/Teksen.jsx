...
const Teksen = () => (
  <RestaurantPage
    restaurantName="Teksen"
    address="18 & 20 Lebuh Carnarvon, George Town, 10100, Malaysia"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+60129815117"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/teksen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chinese couplets on the wall and red tablecloths lend the clean, simple space a festive vibe. Open since 1965, this no-frills joint has won the hearts of foodies, with well-made traditional Cantonese fare and fusion creations with a local twist. The deep-fried house-made tofu with dried local anchovies is a must – it's simply seasoned with soy sauce, but the umami is irresistible. Ask about the double-boiled soup of the day, which never disappoints...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20%26%2020%20Lebuh%20Carnarvon%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Teksen"
  />
);

export default Teksen;
