...
const AuntieGaikLeansOldSchoolEatery = () => (
  <RestaurantPage
    restaurantName="Auntie Gaik Lean's Old School Eatery"
    address="1 Lebuh Bishop, George Town, 10200, Malaysia"
    cuisine="Peranakan"
    priceRange="$$"
    phoneNumber="+60174344398"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/auntie-gaik-lean-s-old-school-eatery"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Memorabilia in show windows and a 60s soundtrack exude the charm of a bygone era. Chef Gaik Lean has been guarding her secret recipes for decades and she makes no compromises in terms of food quality. Many items are made from scratch, including her heavenly pie tee and gulai tumis that uses over eight ingredients in the curry paste, such as fresh saffron. Also try nasi ulam, an old-time recipe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Lebuh%20Bishop%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Auntie Gaik Lean's Old School Eatery"
  />
);

export default AuntieGaikLeansOldSchoolEatery;
