...
const Sardaarji = () => (
  <RestaurantPage
    restaurantName="Sardaarji"
    address="6 Lebuh China, George Town, 10200, Malaysia"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+6042637069"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/sardaarji"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Colourful drapes make for a cheerful aesthetic, and Indian music create a vibrant ambiance. This restaurant in Little India serves authentic Northern Indian dishes, such as fish amritsari – this red snapper in a thick, spicy curry with balanced flavours is a must! The palak paneer seduces with creamy spinach with a hint of cumin that complements the milky cheese. Round off your meal with the popular sweet gulab jamun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Lebuh%20China%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Sardaarji"
  />
);

export default Sardaarji;
