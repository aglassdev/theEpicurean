...
const BaliHaiSeafoodMarket = () => (
  <RestaurantPage
    restaurantName="Bali Hai Seafood Market"
    address="90 Persiaran Gurney, George Town, 10250, Malaysia"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+6042281272"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/bali-hai-seafood-market"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bali Hai has been feeding seafood lovers with the freshest critters and best quality fish for over ten years. Pick your own catch at the live fish tank by the entrance. Specify the way you want them cooked – in Teochew, Nyonya or even Thai style. The must-try “cereal prawns” are tossed in butter and milky oat powder that forms a crispy crust. Stir-fried crab with salted egg yolks that strikes a balance between umami and saltiness is not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=90%20Persiaran%20Gurney%2C%20George%20Town%2C%2010250%2C%20Malaysia"
    pageTitle="Bali Hai Seafood Market"
  />
);

export default BaliHaiSeafoodMarket;
