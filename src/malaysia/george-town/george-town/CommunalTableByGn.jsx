...
const CommunalTableByGn = () => (
  <RestaurantPage
    restaurantName="Communal Table by Gēn"
    address="68 Lebuh Presgrave, George Town, 10300, Malaysia"
    cuisine="Malaysian"
    priceRange="$$"
    phoneNumber="+60125783323"
    website="https://www.gencommunaltable.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This casual, relaxing place sports an open kitchen, a long counter table and floor-to-ceiling windows. At dinner, it serves a small à la carte menu of modern dishes made with local ingredients, melding Peranakan and Malaysian cuisines. The signature aged duck breast in a steamed bun appeals to the palate with its crispy skin and a secret sauce. Homemade gelato sees some interesting local twists, with flavours like nutmeg harumanis; and hor ka sai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20Lebuh%20Presgrave%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Communal Table by Gēn"
  />
);

export default CommunalTableByGn;
