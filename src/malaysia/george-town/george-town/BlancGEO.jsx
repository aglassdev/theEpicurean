...
const BlancGEO = () => (
  <RestaurantPage
    restaurantName="Blanc"
    address="Macalister Mansion, 228 Jalan Macalister, George Town, 10400, Malaysia"
    cuisine="European Contemporary"
    priceRange="$$$"
    phoneNumber="+6042283888"
    website="https://www.restaurantblanc.com.my"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Macalister%20Mansion%2C%20228%20Jalan%20Macalister%2C%20George%20Town%2C%2010400%2C%20Malaysia"
    pageTitle="Blanc"
  />
);

export default BlancGEO;
