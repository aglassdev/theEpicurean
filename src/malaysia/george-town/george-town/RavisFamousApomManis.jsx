...
const RavisFamousApomManis = () => (
  <RestaurantPage
    restaurantName="Ravi's Famous Apom Manis"
    address="319 Jalan Burma, George Town, 10350, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124707019"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/ravi-s-famous-apom-manis"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1920, this stall has been selling its famous apom: their crispy crêpes with a soft, puffy centre cooked in claypot over charcoal are fluffier and more coconutty than most. Come early – they tend to sell out by 9:30am...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=319%20Jalan%20Burma%2C%20George%20Town%2C%2010350%2C%20Malaysia"
    pageTitle="Ravi's Famous Apom Manis"
  />
);

export default RavisFamousApomManis;
