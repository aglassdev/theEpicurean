...
const PittStreetKoayTeowSoup = () => (
  <RestaurantPage
    restaurantName="Pitt Street Koay Teow Soup"
    address="183 Lebuh Carnarvon, George Town, 10100, Malaysia"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+60174793208"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/pitt-street-koay-teow-soup"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The shop has been selling Penangese’ favourite fish ball soup for over 60 years and has been in this current spot since 2009. Fish balls are made daily in-house using flavoursome sea eel meat that complement their pork broth. Order “extra minced pork and fish ball” – minced pork refers to the flat pork balls – and top it with lots of crispy garlic bits. Homemade cakes and tarts end a meal perfectly, or take them home to enjoy later...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=183%20Lebuh%20Carnarvon%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Pitt Street Koay Teow Soup"
  />
);

export default PittStreetKoayTeowSoup;
