...
const RasaRasa = () => (
  <RestaurantPage
    ...
    cuisine="Peranakan"
    priceRange="$"
    phoneNumber="+60124422570"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/rasa-rasa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Potted plants are set nicely against a background of exposed brick walls and industrial accents here. On top of the short à la carte menu, the Nyonya combo set built around pandan nasi lemak with your choice of toppings is especially popular. The rice is plated on a banana leaf and topped with mildly hot homemade sambal. Another speciality is Siam bihun – turmeric rice vermicelli with shredded omelette and sauces. Round out the meal with tub tim krob...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=59%20Gat%20Lebuh%20Chulia%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Rasa Rasa"
  />
);

export default RasaRasa;
