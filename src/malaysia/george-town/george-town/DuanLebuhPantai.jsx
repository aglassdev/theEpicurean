...
const DuanLebuhPantai = () => (
  <RestaurantPage
    restaurantName="Du-An (Lebuh Pantai)"
    address="251 Lebuh Pantai, George Town, 10300, Malaysia"
    cuisine="Malaysian"
    priceRange="$$"
    phoneNumber="+60103725353"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/du-an-lebuh-pantai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The faux cement wall works well with the warm wood furniture in this casual, relaxing restaurant, which is all about traditional Malaysian cooking: think nasi lemak, rendang beef, laksa, satay etc. Their skin-on mutton curry is a particular standout with its melty texture, big aromas and spot-on seasoning, hitting a sweet spot on the spice-o-meter. All ingredients are certified halal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=251%20Lebuh%20Pantai%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Du-An (Lebuh Pantai)"
  />
);

export default DuanLebuhPantai;
