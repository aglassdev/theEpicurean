...
const PenangRoadFamousLaksa = () => (
  <RestaurantPage
    restaurantName="Penang Road Famous Laksa"
    address="5 Lebuh Keng Kwee, George Town, 10100, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164460543"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/penang-road-famous-laksa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This famous laksa shop serves lai fun noodles in a sardine broth with exceptional depth and flavours alongside an array of condiments. For those with bigger appetites, order char koay teow with duck egg to go with the laksa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Lebuh%20Keng%20Kwee%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Penang Road Famous Laksa"
  />
);

export default PenangRoadFamousLaksa;
