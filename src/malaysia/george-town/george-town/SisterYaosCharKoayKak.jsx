...
const SisterYaosCharKoayKak = () => (
  <RestaurantPage
    restaurantName="Sister Yao’s Char Koay Kak"
    address="96 Lorong Macalister, George Town, 11400, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164206438"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/sister-yao-s-char-koay-kak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three sisters inherited their father's life's work, which he began in 1963, selling char koay kak, a snack from their ancestral home of Teochew. The rice cakes are fried with nice wok hei, the right amount of soya sauce, bean sprouts, egg and spiciness; with optional hot sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=96%20Lorong%20Macalister%2C%20George%20Town%2C%2011400%2C%20Malaysia"
    pageTitle="Sister Yao’s Char Koay Kak"
  />
);

export default SisterYaosCharKoayKak;
