...
const Curioscity = () => (
  <RestaurantPage
    restaurantName="Curios-City"
    address="164A-B Lebuh Victoria, George Town, 10300, Malaysia"
    cuisine="Innovative"
    priceRange="$$$"
    phoneNumber="+60142105236"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/curios-city"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You need to look hard to find this place – there is no sign and the exterior looks barren. The stunning, moody interior is furnished in wabi-sabi style with lots of greenery, giving it a cosy and stylish ambience. The chef creates dishes underpinned by European techniques and punctuated by Malaysian twists. He offers three set menus that change every two months. Try the seven-course set to experience his vision in full glory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=164A-B%20Lebuh%20Victoria%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Curios-City"
  />
);

export default Curioscity;
