...
const MohTengPheowNyonyaKoay = () => (
  <RestaurantPage
    restaurantName="Moh Teng Pheow Nyonya Koay"
    address="Jalan Masjid, off Lebuh Chulia, George Town, 10200, Malaysia"
    cuisine="Small eats"
    priceRange="$"
    phoneNumber="+60124152677"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/moh-teng-pheow-nyonya-koay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop specialises in Nyonya kueh – an array of cakes, dumplings, puddings and pastries that can be sweet or savoury, and steamed, deep-fried or baked. All their treats are made just as they were back in 1933, when the owner's father opened a kueh factory. In addition to kueh lapis, kueh talam, ang koo and Nyonya chang, they also serve a few Nyonya dishes. Enjoy your meal beneath a glass roof and Penang-style umbrellas in the converted patio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jalan%20Masjid%2C%20off%20Lebuh%20Chulia%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Moh Teng Pheow Nyonya Koay"
  />
);

export default MohTengPheowNyonyaKoay;
