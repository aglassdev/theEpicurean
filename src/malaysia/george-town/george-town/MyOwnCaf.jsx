...
const MyOwnCaf = () => (
  <RestaurantPage
    restaurantName="My Own Café"
    address="2 Lebuh Cannon, George Town, 10200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164851050"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/my-own-cafe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming family-run shop serves Penang asam laksa, Nyonya laksa and fried spring rolls. The light and refreshing red soup of the signature asam laksa strikes the right balance of sour and spicy and is nicely topped off with mint and pineapple. The spring rolls, stuffed with vegetable filling, taste equally good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Lebuh%20Cannon%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="My Own Café"
  />
);

export default MyOwnCaf;
