...
const WanDaoTouAssamLaksa = () => (
  <RestaurantPage
    restaurantName="Wan Dao Tou Assam Laksa"
    address="1 Jalan Gottlieb, George Town, 10350, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164806558"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/wan-dao-tou-assam-laksa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The third-generation owner makes his famous laksa noodle soup according to his grandparents’ recipe dating back 50 years ago. The soup strikes a fine balance between sweetness, sourness and spiciness, while the cucumber, shallot and pineapple cut through the heat nicely. The starter platter is also worth-trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Jalan%20Gottlieb%2C%20George%20Town%2C%2010350%2C%20Malaysia"
    pageTitle="Wan Dao Tou Assam Laksa"
  />
);

export default WanDaoTouAssamLaksa;
