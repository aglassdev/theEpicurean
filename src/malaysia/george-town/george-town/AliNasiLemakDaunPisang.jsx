...
const AliNasiLemakDaunPisang = () => (
  <RestaurantPage
    restaurantName="Ali Nasi Lemak Daun Pisang"
    address="Sri Weld Food Court, 19 Lebuh Pantai, George Town, 10300, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60164070717"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/ali-nasi-lemak-daun-pisang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This halal stall only sells nasi lemak: the national dish of coconut milk rice wrapped in banana leaf, topped with sambal and one of the six toppings. Try anchovies with a hard-boiled egg. And go easy on the fiery sambal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sri%20Weld%20Food%20Court%2C%2019%20Lebuh%20Pantai%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="Ali Nasi Lemak Daun Pisang"
  />
);

export default AliNasiLemakDaunPisang;
