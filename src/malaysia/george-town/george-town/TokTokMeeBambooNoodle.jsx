...
const TokTokMeeBambooNoodle = () => (
  <RestaurantPage
    restaurantName="Tok Tok Mee Bamboo Noodle"
    address="37 Lebuh Campbell, George Town, 10100, Malaysia"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+6042619875"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/tok-tok-mee-bamboo-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Tok Tok” is an onomatopoeia of the sound made by a chef when kneading noodle dough with a bamboo pole, a tradition still practised at the entrance of this shop. Cantonese wonton noodle soup is a must-try for its bouncy noodles and flavoursome shrimp filling. Blanched noodles tossed with dried shrimp roe, and Cantonese barbecue meats are also popular. Also try their Chinese pastry – both BBQ pork pie and pandan kaya dumplings are terrific...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20Lebuh%20Campbell%2C%20George%20Town%2C%2010100%2C%20Malaysia"
    pageTitle="Tok Tok Mee Bamboo Noodle"
  />
);

export default TokTokMeeBambooNoodle;
