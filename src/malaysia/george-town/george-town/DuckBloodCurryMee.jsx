...
const DuckBloodCurryMee = () => (
  <RestaurantPage
    restaurantName="Duck Blood Curry Mee"
    address="223B Jalan Burma, George Town, 10050, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60124382149"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/duck-blood-curry-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden in a Malaysian-style café, this shop serves mee in a savoury-sweet white curry base made with coconut milk that is freshly prepared every day. Among the various toppings offered, roasted pork is phenomenal. Make sure you try the homemade chilli sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=223B%20Jalan%20Burma%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Duck Blood Curry Mee"
  />
);

export default DuckBloodCurryMee;
