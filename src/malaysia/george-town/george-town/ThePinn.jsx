...
const ThePinn = () => (
  <RestaurantPage
    restaurantName="The Pinn"
    address="58 Pengkalan Weld, George Town, 10300, Malaysia"
    cuisine="Small eats"
    priceRange="$"
    phoneNumber="+60127614316"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/the-pinn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Pinn moved to this spot opposite Lee Jetty in 2023. Like the room, the menu is small but powerful, offering Malaysian-Chinese dishes, dumplings and even some Taiwanese and Indonesian titbits. Homemade mackerel fish balls are their speciality and you can order noodles on top to make it a complete meal. The food tends to be slightly on the sweet side to suit local tastebuds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20Pengkalan%20Weld%2C%20George%20Town%2C%2010300%2C%20Malaysia"
    pageTitle="The Pinn"
  />
);

export default ThePinn;
