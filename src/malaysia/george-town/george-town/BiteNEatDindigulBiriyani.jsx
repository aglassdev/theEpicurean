...
const BiteNEatDindigulBiriyani = () => (
  <RestaurantPage
    restaurantName="Bite N Eat Dindigul Biriyani"
    address="43 Lebuh Penang, George Town, 10200, Malaysia"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+6042614532"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/bite-n-eat-dindigul-biriyani"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2014, this shop has been serving authentic Indian fare from all over the country. Its namesake signature biriyani is a must-try - pair with kongu nadu kozhi fry, or spicy dry-fried chicken with grated coconut, a Southern Indian speciality rich in tangy flavours. Also check the blackboard at the door for daily specials. Round off with house-made sweets or masala tea. Certain items are only served after 4 pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20Lebuh%20Penang%2C%20George%20Town%2C%2010200%2C%20Malaysia"
    pageTitle="Bite N Eat Dindigul Biriyani"
  />
);

export default BiteNEatDindigulBiriyani;
