...
const Laksalicious = () => (
  <RestaurantPage
    restaurantName="Laksalicious"
    address="117-117A Jalan Hutton, George Town, 10050, Malaysia"
    cuisine="Malaysian"
    priceRange="$"
    phoneNumber="+6042299178"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/laksalicious"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a caricature of the owner on its sign and a mural deconstructing its signature items, Laksalicious is a cheerful little gem bubbling with character. As its name suggests, laksa is the main event here – choose between Nyonya assam laksa with sour, spicy fish broth or Nyonya laksa lemak with rich, creamy coconut milk broth. Prawn crackers add texture and flavours. Crispy prawn fritters, nasi ulam and gula melacca cendol are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=117-117A%20Jalan%20Hutton%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Laksalicious"
  />
);

export default Laksalicious;
