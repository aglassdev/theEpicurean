...
const GreenHousePrawnMeeLohMee223JalanBurma = () => (
  <RestaurantPage
    restaurantName="Green House Prawn Mee & Loh Mee (223 Jalan Burma)"
    address="223 Jalan Burma, George Town, 10050, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/green-house-prawn-mee-loh-mee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 30 years, the regulars have been returning for its Hokkien prawn mee, loh mee, or a mix of both. The red prawn soup made with pork bones and prawn shells boasts deep umami. Twelve additional toppings are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=223%20Jalan%20Burma%2C%20George%20Town%2C%2010050%2C%20Malaysia"
    pageTitle="Green House Prawn Mee & Loh Mee (223 Jalan Burma)"
  />
);

export default GreenHousePrawnMeeLohMee223JalanBurma;
