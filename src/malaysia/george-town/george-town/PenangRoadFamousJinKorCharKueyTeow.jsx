...
const PenangRoadFamousJinKorCharKueyTeow = () => (
  <RestaurantPage
    restaurantName="Penang Road Famous Jin Kor Char Kuey Teow"
    address="Joo Hooi Cafe, 475 Jalan Penang, George Town, 10000, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+60149033561"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/penang-road-famous-jin-kor-char-kuey-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stall has been around for almost 40 years. Kuey Teow is made to order, topped with shrimps, blood clams, pork sausage and bean sprouts, boasting lovely wok hei. For added punch, opt for duck egg and extra chilli sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Joo%20Hooi%20Cafe%2C%20475%20Jalan%20Penang%2C%20George%20Town%2C%2010000%2C%20Malaysia"
    pageTitle="Penang Road Famous Jin Kor Char Kuey Teow"
  />
);

export default PenangRoadFamousJinKorCharKueyTeow;
