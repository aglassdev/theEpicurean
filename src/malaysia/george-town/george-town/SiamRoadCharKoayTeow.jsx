...
const SiamRoadCharKoayTeow = () => (
  <RestaurantPage
    restaurantName="Siam Road Char Koay Teow"
    address="82 Jalan Siam, George Town, 10400, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/siam-road-char-koay-teow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open for half days, this small store draws long queues – mostly tourists and young customers. They serve just one dish: stir-fried koay teow. The wok-fried flat rice noodles emit a charcoal aroma, are well seasoned and come with quality ingredients that can be spiced to taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20Jalan%20Siam%2C%20George%20Town%2C%2010400%2C%20Malaysia"
    pageTitle="Siam Road Char Koay Teow"
  />
);

export default SiamRoadCharKoayTeow;
