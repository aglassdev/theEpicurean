...
const FattyLohChickenRice = () => (
  <RestaurantPage
    restaurantName="Fatty Loh Chicken Rice"
    address="21 Jalan Fettes, Tanjung Bungah, George Town, 11200, Malaysia"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+6048990888"
    website="https://guide.michelin.com/en/pulau-pinang/my-george-town/restaurant/fatty-loh-chicken-rice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Into the third generation, this shop famous for Hainanese chicken rice also serves other Southeast Asian favourites. Chicken that boasts springy skin and velvety flesh can be ordered in halves or standard portions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Jalan%20Fettes%2C%20Tanjung%20Bungah%2C%20George%20Town%2C%2011200%2C%20Malaysia"
    pageTitle="Fatty Loh Chicken Rice"
  />
);

export default FattyLohChickenRice;
