...
const Verdieinkehr = () => (
  <RestaurantPage
    restaurantName="Verdi-Einkehr"
    address="Pachmayrstraße 137, Linz, 4040, Austria"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43732733005"
    website="https://verdi.at/einkehr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the second restaurant run by the Lukas family, and here, too, the cooking can be described as ambitious. The modern, seasonal cuisine has a regional bent and also draws on international influences – for instance, tuna mango, miso, lime or braised veal cheeks chanterelles, creamed potato, Barolo red wine. As for the division of labour, owner Erich Lukas and his son Philipp work their magic in the kitchen, while maître d' Helga and her dedicated front-of-house team provide cordial service. Finally, there is the gorgeous location on a leafy estate at the edge of a forest overlooking Linz – in summer, you can take in stunning views from the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pachmayrstra%C3%9Fe%20137%2C%20Linz%2C%204040%2C%20Austria"
    pageTitle="Verdi-Einkehr"
  />
);

export default Verdieinkehr;
