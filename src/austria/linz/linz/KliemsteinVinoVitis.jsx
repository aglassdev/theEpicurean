...
const KliemsteinVinoVitis = () => (
  <RestaurantPage
    restaurantName="Kliemstein Vino Vitis"
    address="Obere Donaulände 15, Linz, 4020, Austria"
    cuisine="Classic Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+43732997079"
    website="https://www.kliemstein-linz.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You could easily miss the entrance leading into this small restaurant housed in the Salzamt, with its beautiful, brightly lit vaulted ceiling and sophisticated ambience. Michael A Müller – a highly accomplished trained chef and restaurateur – has dedicated many years to this establishment. The owner enjoys interacting with guests and recommending the perfect wine from his extensive cellar of over 1 200 labels and 50 000 bottles. And he has found a congenial right-hand man in chef Andreas Zika. Diners choose from three surprise menus: the shorter Theater Menu, the Bistro Menu and the Gourmet Menu. The latter features such shining examples as sashimi of yellowfin tuna, shiso, ginger-kefir broth and saddle of venison, gremolata breadcrumbs, Chinese artichoke – dishes showcasing highly intense..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Obere%20Donaul%C3%A4nde%2015%2C%20Linz%2C%204020%2C%20Austria"
    pageTitle="Kliemstein Vino Vitis"
  />
);

export default KliemsteinVinoVitis;
