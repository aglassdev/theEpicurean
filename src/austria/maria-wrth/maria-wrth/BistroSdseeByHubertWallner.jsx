...
const BistroSdseeByHubertWallner = () => (
  <RestaurantPage
    restaurantName="Bistro Südsee by Hubert Wallner"
    address="Süduferstraße 258, Maria Wörth, 9082, Austria"
    cuisine="Regional European"
    priceRange="€€"
    phoneNumber="+436644181400"
    website="https://sued-see.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, on the southern shore of Wörthersee, you could almost fancy yourself in the South Pacific. This beach restaurant enjoys a gorgeous lakeside location, where the reeds sway to the beat of the trendy background music. Relaxed bistro atmosphere, friendly down-to-earth service and good food including regional classics such as house-made Carinthian Kasnudeln (cheese dumplings) and Mediterranean specialities like freshly made pasta or fish dishes. How about a nice cocktail to top it off?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=S%C3%BCduferstra%C3%9Fe%20258%2C%20Maria%20W%C3%B6rth%2C%209082%2C%20Austria"
    pageTitle="Bistro Südsee by Hubert Wallner"
  />
);

export default BistroSdseeByHubertWallner;
