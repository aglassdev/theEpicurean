...
const GasthausCsencsits = () => (
  <RestaurantPage
    restaurantName="Gasthaus Csencsits"
    address="Harmisch 13, Kohfidisch, 7512, Austria"
    cuisine="Contemporary, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43336677220"
    website="https://csencsits.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a good reason why so many diners are drawn to this tranquil, rural village nestled among forests and meadows right by the Hungarian border. Jürgen and Melanie Csencsits run an upscale restaurant that maintains an inviting, laid-back feel. In a kitchen centred on an old wood-fired oven that is core to their culinary philosophy, the chef-patron and his team prepare a seasonal five- to seven-course set menu. Based on produce from the surrounding area, the cuisine mirrors the chef's strong connection to his Pannonian heritage. The charming proprietress manages the service team, who recommend excellent wine pairings by the glass. The extensive wine list is also well worth exploring. Delightful covered wooden terrace. Tip: Ask about their popular Buschenschank evenings, on which good, s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Harmisch%2013%2C%20Kohfidisch%2C%207512%2C%20Austria"
    pageTitle="Gasthaus Csencsits"
  />
);

export default GasthausCsencsits;
