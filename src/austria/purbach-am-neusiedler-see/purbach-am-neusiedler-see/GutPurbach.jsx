...
const GutPurbach = () => (
  <RestaurantPage
    restaurantName="Gut Purbach"
    address="Hauptgasse 64, Purbach am Neusiedler See, 7083, Austria"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43268356086"
    website="https://www.gutpurbach.at/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautifully restored 16C farmhouse first became an inn in 1860. Today, it is a modern restaurant serving delicious regional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptgasse%2064%2C%20Purbach%20am%20Neusiedler%20See%2C%207083%2C%20Austria"
    pageTitle="Gut Purbach"
  />
);

export default GutPurbach;
