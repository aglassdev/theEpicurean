...
const AlpinGourmetStube = () => (
  <RestaurantPage
    restaurantName="Alpin Gourmet Stube"
    address="Sankt Jakober Dorfstraße 35, Sankt Anton am Arlberg, 6580, Austria"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+4354463285"
    website="https://www.hotel-gletscherblick.at/de/genuss/alpin-gourmet-stube/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located in the quiet St Jakob district, the Jehle-Kathrein family's establishment is warm and welcoming. That goes for both the hotel, Gletscherblick, and the tastefully decorated, elegant little Alpine-style fine dining restaurant. Choose between the set menu of the day and the fine dining set menu, in which chef Paul Markovics presents a variety of flavours and interesting contrasts. He also places a strong emphasis on the region when it comes to his choice of ingredients. For example, he combines perfectly medium-rare fried and finely seasoned Tyrolean venison loin (of excellent quality!) with the smoothness of an intensely flavourful porcini purée, the rich nutty taste of a creamy, airy pistachio hollandaise and the fruity notes of dried peach. Astute wine recommendations – the selecti..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sankt%20Jakober%20Dorfstra%C3%9Fe%2035%2C%20Sankt%20Anton%20am%20Arlberg%2C%206580%2C%20Austria"
    pageTitle="Alpin Gourmet Stube"
  />
);

export default AlpinGourmetStube;
