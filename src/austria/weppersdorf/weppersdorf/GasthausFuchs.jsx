...
const GasthausFuchs = () => (
  <RestaurantPage
    restaurantName="Gasthaus Fuchs"
    address="Hauptstraße 33, Weppersdorf, 7331, Austria"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+4326182250"
    website="https://www.gasthaus-fuchs.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After completing stints at renowned establishments, Thomas Fuchs has brought a breath of fresh air to his parents' restaurant in the middle of this Burgenland village. His delicious dishes range from classics such as schnitzel, Tafelspitz (beef boiled in broth) and the like to salmon trout fillet, chervil root, fregola or goose liver, fig, chocolate, Buchtel (sweet yeast buns). In addition to an à la carte selection, there is also a three- to six-course tasting menu in the evening and a smaller set menu at lunchtime. The well-kept dining area (divided into rooms – some with a rustic touch, some more modern) is complemented by a pleasant terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%2033%2C%20Weppersdorf%2C%207331%2C%20Austria"
    pageTitle="Gasthaus Fuchs"
  />
);

export default GasthausFuchs;
