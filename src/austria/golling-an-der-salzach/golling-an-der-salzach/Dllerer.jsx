...
const Dllerer = () => (
  <RestaurantPage
    ...
    bio="There is something unique about Andreas Döllerer's cuisine. For some 20 years, his Alpine style has been his passion. In what he dubs his Alpine Cuisine, he uses only excellent ingredients from the region. Building on classical foundations, he skilfully works in contrasts and textures to cook up innovative dishes such as Gletscherrübe 23: dried, rehydrated and baked beetroot with a beetroot and black elder marinade and beetroot ice cream, served with soufflé-style Semmelkren (horseradish sauce) and a subtly spicy horseradish velouté, accompanied by tender Romanesco lettuce with a delicate elderflower vinaigrette. Excellent wine recommendations from Master Sommelier Alexander Koblinger – the vaulted wine cellar is home to over 3 700 different labels. Dishes are served in the elegant restaur..."
