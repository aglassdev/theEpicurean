...
const DllerersWirtshaus = () => (
  <RestaurantPage
    restaurantName="Döllerers Wirtshaus"
    address="Markt 56, Golling an der Salzach, 5440, Austria"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+43624442200"
    website="https://www.doellerer.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place has a long culinary tradition to its name, dating back to 1909. The Döllerer family's inn is located in the town centre, not far from the parish church and the castle. The atmosphere is pleasantly lively and with a cosy, rustic charm. Food is served by friendly waitstaff in two dining spaces with historical vaulted ceilings or on the terrace to the rear of the building. The menu features mouthwatering dishes such as sturgeon with Piedmont hazelnuts or Rauris venison ragout, not forgetting the signature dessert Schwarzbeernock'n (blueberry dumplings) with sour cream ice cream. Delicatessen goods are also available for purchase, including meat products, cheese specialities and delicacies such as jams, Alpine spices, mustard etc. Overnight accommodation available at the adjoining H..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Markt%2056%2C%20Golling%20an%20der%20Salzach%2C%205440%2C%20Austria"
    pageTitle="Döllerers Wirtshaus"
  />
);

export default DllerersWirtshaus;
