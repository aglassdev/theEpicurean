...
const GrndlersGourmetStberl = () => (
  <RestaurantPage
    restaurantName="Gründler's Gourmet Stüberl"
    address="Seestraße 35, Achenkirch, 6215, Austria"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+4352466800"
    website="https://www.kulinarikhotel-alpin.at/gourmet-stueberl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A family business run with great warmth and commitment, where everyone pitches in. A father-and-son team is in charge of the kitchen, serving up a contemporary take on classic dishes in a four- to six-course set menu. Dishes such as female duck breast with celeriac, pickled plum and crispy cannelloni are rooted in French culinary tradition and showcase in-season and regional ingredients. However, there are also internationally influenced dishes, such as Alpine prawn with razor clam, pumpkin, yuzu and samphire. Gourmet Stüberl is a separate space in the restaurant area of Kulinarik Hotel Alpin. The decor is inviting and upscale, the atmosphere pleasantly intimate and the waitstaff charming and adept – you might even be served by one of the chefs. The wine list features a decent selection of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestra%C3%9Fe%2035%2C%20Achenkirch%2C%206215%2C%20Austria"
    pageTitle="Gründler's Gourmet Stüberl"
  />
);

export default GrndlersGourmetStberl;
