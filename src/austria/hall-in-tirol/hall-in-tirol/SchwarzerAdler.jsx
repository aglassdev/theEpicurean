...
const SchwarzerAdler = () => (
  <RestaurantPage
    restaurantName="Schwarzer Adler"
    address="Eugenstrasse 3, Hall in Tirol, 6060, Austria"
    cuisine="European Contemporary"
    priceRange="€€€€"
    phoneNumber="+43522325122"
    website="https://www.schwarzeradler-hall.tirol/restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Johannes Nuding needs no introduction, having previously conjured up three-star cuisine at London's Sketch – The Lecture Room & Library. His clearly structured dishes showcase his talent for harmoniously combining ingredients, spices, textures and flavours. A shining example is his wonderfully tender char from the Passeier Valley (fantastic quality!) elegantly prepared with a hint of green curry, served with a rich, perfectly reduced beurre blanc and a sweet-and-sour marmalade of orange and grapefruit, as well as bitter salad leaves for a slightly tart finish. Given the quality of the six-course set menu (with an optional extra course), it's hard to believe they have a kitchen staff of just three! The lady of the house presides over the dining room with warmth and finesse. Located in ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Eugenstrasse%203%2C%20Hall%20in%20Tirol%2C%206060%2C%20Austria"
    pageTitle="Schwarzer Adler"
  />
);

export default SchwarzerAdler;
