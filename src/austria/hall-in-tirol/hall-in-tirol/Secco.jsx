...
const Secco = () => (
  <RestaurantPage
    restaurantName="Secco"
    address="Eugenstraße 3, Hall in Tirol, 6060, Austria"
    cuisine="Regional Cuisine, Asian Influences"
    priceRange="€€"
    phoneNumber="+436649183507"
    website="https://www.schwarzeradler-hall.tirol/secco/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Compact, intimate and colourful, this pleasant bistro set in a picturesque cobbled lane in the old town offers a relaxed alternative to the Schwarzer Adler restaurant. You immediately get a sense that the team supporting chef-patron Johannes Nuding enjoy their work! At lunchtime, there is a two- or three-course set menu with a choice of dishes; from 4pm an interesting selection of simple options is served, ranging from onion soup to quiche and Thai curry to a stove-top fish dish or baked guinea fowl. Friendly service, in which the owners participate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Eugenstra%C3%9Fe%203%2C%20Hall%20in%20Tirol%2C%206060%2C%20Austria"
    pageTitle="Secco"
  />
);

export default Secco;
