...
const GasthausZumFrhlichenArbeiter = () => (
  <RestaurantPage
    restaurantName="Zum fröhlichen Arbeiter"
    address="Quergasse 98, Apetlon, 7143, Austria"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+4321752218"
    website="https://www.froehlicherarbeiter.at/"
    aliases={["Gasthaus Zum fröhlichen Arbeiter"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spruce family-run inn has been welcoming diners for 100 years. Owner and head chef Hannes Tschida showcases his love for the Seewinkel region through dishes incorporating plenty of local ingredients. The wide-ranging à la carte options include Grammelknödel (potato dumplings stuffed with greaves), beef goulash, trout ceviche, dry-aged steak and Lake Neusiedl catfish. There is also a four- to six-course surprise menu. To complement the bold flavours of the cuisine, an impressive wine list dominated by Austrian labels is available. The restaurant itself has two indoor dining spaces: one oozing traditional charm, the other more modern with a conservatory feel. The friendly and attentive service is appreciated by regulars and newcomers alike...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quergasse%2098%2C%20Apetlon%2C%207143%2C%20Austria"
    pageTitle="Zum fröhlichen Arbeiter"
  />
);

export default GasthausZumFrhlichenArbeiter;
