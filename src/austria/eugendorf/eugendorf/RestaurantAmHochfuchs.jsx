...
const RestaurantAmHochfuchs = () => (
  <RestaurantPage
    restaurantName="Restaurant am Hochfuchs"
    address="Bergweg 2, Eugendorf, 5301, Austria"
    cuisine="Austrian, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+4362258589"
    website="https://www.hochfuchs.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional – innovative – down-to-earth – modern is the motto of Margit and Michael Oberreiter. It is also an apt description of the modern-inspired Austrian and regional fare served here, which ranges from Backhendl (breaded fried chicken) with potato and cucumber salad and lingonberries to sheatfish fillet with lardo, chamomile butter broth, blini and wild broccoli. The four-course Michaels Menü comes highly recommended, but the extensive à la carte selection of traditional dishes and tavern classics is also tempting. And on Sundays and public holidays diners can tuck into Sunday roast – oven-fresh roast pork with bread dumplings and cabbage salad. The wine list boasts a solid selection of Austrian labels. Friendly and attentive service is provided in an attractive space that blends mod..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bergweg%202%2C%20Eugendorf%2C%205301%2C%20Austria"
    pageTitle="Restaurant am Hochfuchs"
  />
);

export default RestaurantAmHochfuchs;
