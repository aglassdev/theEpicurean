...
const IceQ = () => (
  <RestaurantPage
    restaurantName="ice Q"
    address="Dorfstraße 115, Sölden, 6450, Austria"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+436649609368"
    website="https://www.iceq.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beyond its sleek design, this large glass cube delights with a spectacular panoramic view of the mountains. The restaurant is located on the ground floor and proposes a modern tasting menu (vegetarian version available) as well as an à la carte selection of more classic dishes such as beef consommé, Wiener schnitzel and rib-eye steak. The service is friendly and attentive. Alternatively, tapas are served in the lounge on the top floor. Diners can also head outside to the lovely terraces. When it comes to wine, the PINO 3000 is attention worthy – it is aged at this altitude, over 3 000m above sea level! The well-curated wine list includes a decent selection of picks available by the glass. This incredible site also served as a filming location for the James Bond film Spectre. 007 Elements c..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstra%C3%9Fe%20115%2C%20S%C3%B6lden%2C%206450%2C%20Austria"
    pageTitle="ice Q"
  />
);
