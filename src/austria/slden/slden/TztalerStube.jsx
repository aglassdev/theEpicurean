...
const TztalerStube = () => (
  <RestaurantPage
    restaurantName="Ötztaler Stube"
    address="Auweg 3, Sölden, 6450, Austria"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+43525422600"
    website="https://www.central-soelden.com/kulinarik/gourmet-und-wein/oetztaler-stube.html"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Auweg%203%2C%20S%C3%B6lden%2C%206450%2C%20Austria"
    pageTitle="Ötztaler Stube"
  />
);

export default TztalerStube;
