...
const BergfriedChefsTable = () => (
  <RestaurantPage
    restaurantName="Bergfried - Chefs Table"
    address="Lanersbach 483, Tux, 6293, Austria"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+43528787239"
    website="https://www.bergfried.at/kulinarik/chefs-table-tastingmenue.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You're right in the thick of it here! From the high tables in this stylish little space, you can watch the kitchen buzz with activity – there's never a dull moment! A distinctive aspect of the proceedings is the way the individual dishes are presented: with a proper explanation and background music that is occasionally rather loud. For his nine-course surprise menu, chef Sebastian Stock likes to work with locally sourced ingredients to create clearly structured modern dishes brimming with intensity and flavour. Franz Stock curates superb wine pairings to complement the food. The service is essentially a family affair, and the dedication of the team is palpable. All of this promises you an entertaining, thoroughly enjoyable evening and a truly memorable experience! The best place for an ape..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lanersbach%20483%2C%20Tux%2C%206293%2C%20Austria"
    pageTitle="Bergfried - Chefs Table"
  />
);

export default BergfriedChefsTable;
