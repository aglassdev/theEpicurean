...
const GutOberstockstall = () => (
  <RestaurantPage
    restaurantName="Gut Oberstockstall"
    address="Ringstraße 1, Kirchberg am Wagram, 3470, Austria"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+4322792335"
    website="https://www.gut-oberstockstall.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Prepare to enjoy wonderful food in a stunning historical setting. This centuries-old estate boasts over 150 years of family tradition, now upheld by brothers Fritz and Matthias Salomon. In the kitchen, they use predominantly organic and Demeter-certified ingredients, some grown on their own land. Dishes that take their cue from the region and the changing seasons are served as set menus (conventional or vegetarian) or à la carte. One example that really showcases the quality and flavour is the duck breast cooked pink and roasted duck knuckle, parsnip, red cabbage, semolina, cavolo nero. The restaurant boasts a charming interior, but in summer there's no better place to dine than on the idyllic terrace in the courtyard. The attentive and friendly front-of-house team is led by maître d' Matt..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ringstra%C3%9Fe%201%2C%20Kirchberg%20am%20Wagram%2C%203470%2C%20Austria"
    pageTitle="Gut Oberstockstall"
  />
);

export default GutOberstockstall;
