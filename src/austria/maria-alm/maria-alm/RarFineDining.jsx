...
const RarFineDining = () => (
  <RestaurantPage
    restaurantName="RAR Fine Dining"
    address="Hochkönigstraße 27, Maria Alm, 5761, Austria"
    cuisine="Alpine, Asian"
    priceRange="€€€€"
    phoneNumber="+4365847447"
    website="https://www.hochkoenigin.com/de/kulinarik/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following stints at renowned establishments (including Bobby Bräuer's ‘EssZimmer’ at BMW Welt in Munich), Maximilian Reuter has found the ideal setting to pursue his ambitions as chef at the fine dining restaurant of die HOCHKÖNIGIN hotel. His culinary vision comes to life in his two set menus: Asian Alpin and the entirely vegan Asian Green – both available in five or seven courses. Combining Alpine tradition with Asian flavours, the dishes are made using a wide range of regional ingredients, including herbs from their kitchen garden and organic beef from its own farm. The kitchen team present each course themselves, which brings a personal touch and makes your dining experience even more special. Another draw is the intimate atmosphere – the cosy little space with its vaulted ceiling and ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hochk%C3%B6nigstra%C3%9Fe%2027%2C%20Maria%20Alm%2C%205761%2C%20Austria"
    pageTitle="RAR Fine Dining"
  />
);

export default RarFineDining;
