...
const GasthofAdlerKRU = () => (
  <RestaurantPage
    restaurantName="Gasthof Adler"
    address="Dorf 5, Krumbach, 6942, Austria"
    cuisine="Seasonal Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+4355138156"
    website="https://adler-krumbach.at/wordpress/kueche-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pretty inn, established in 1852, embodies the true spirit of hospitality – and has been doing so for seven generations. The old timber chalet has had a lovely contemporary extension added, without any of its historical character being lost along the way. Whether in the cosy parlours or out in the gorgeous Kastaniengarten, diners tuck into flavoursome seasonal cuisine in a regional vein. Fruit, vegetables, salads and herbs come from the own garden, meat from the own farm, game from the nature park... Cordial and professional service. Food items made in-house can also be purchased to enjoy at home. Well-appointed guestrooms and a holiday flat can be booked for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorf%205%2C%20Krumbach%2C%206942%2C%20Austria"
    pageTitle="Gasthof Adler"
  />
);

export default GasthofAdlerKRU;
