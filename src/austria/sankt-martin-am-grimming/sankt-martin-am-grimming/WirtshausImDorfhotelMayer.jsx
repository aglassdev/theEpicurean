...
const WirtshausImDorfhotelMayer = () => (
  <RestaurantPage
    restaurantName="Wirtshaus im Dorfhotel Mayer"
    address="Sankt Martin am Grimming 9-12, Sankt Martin am Grimming, 8954, Austria"
    cuisine="Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4336842203"
    website="https://www.mayer-grimming.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place has kept it in the family since 1854. Now the seventh generation, embodied by daughter Lisa Mayer, is at the helm. This certified sommelier takes care of matters front of house; behind the scenes, her husband Stefan Ell-Mayer is responsible for the food. He cooks up a seasonal à la carte selection, which changes every two to three weeks. Without overwhelming diners with choice, it still promises something for everyone, from traditional beef soup or beef tartare to coq au vin with Zehentmoarhof Riesling, young vegetables, Brandteigkrapferl (traditional Austrian pastries), or golden trout, buttermilk, beurre blanc, cauliflower, pistachio, saffron. Those who prefer something a little more modern and creative could take a punt on the four- to six-course surprise menu. They also offe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sankt%20Martin%20am%20Grimming%209-12%2C%20Sankt%20Martin%20am%20Grimming%2C%208954%2C%20Austria"
    pageTitle="Wirtshaus im Dorfhotel Mayer"
  />
);

export default WirtshausImDorfhotelMayer;
