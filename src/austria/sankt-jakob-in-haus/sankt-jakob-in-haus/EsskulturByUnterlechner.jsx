...
const EsskulturByUnterlechner = () => (
  <RestaurantPage
    restaurantName="Esskultur by Unterlechner"
    address="Reith 23, Sankt Jakob in Haus, 6392, Austria"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+43535488291"
    website="https://www.unterlechner.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this small adults only boutique hotel, you will find cosy guestrooms and an attractive restaurant with pale wood furnishings. Owners Christian and Nadja Unterlechner put their heart and soul into making you feel at home – it is clear that good service and a rapport with guests are top priorities here. They serve a three- to six-course set menu packed with sophisticated fare that draws on classical culinary foundations and regional ingredients. The food is served on crockery they produce themselves – pottery is one of the owner's passions, wine is another. You can enjoy the judiciously selected pairings or choose from the interesting wine list yourself...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reith%2023%2C%20Sankt%20Jakob%20in%20Haus%2C%206392%2C%20Austria"
    pageTitle="Esskultur by Unterlechner"
  />
);

export default EsskulturByUnterlechner;
