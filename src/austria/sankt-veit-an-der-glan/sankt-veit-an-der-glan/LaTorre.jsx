...
const LaTorre = () => (
  <RestaurantPage
    restaurantName="La Torre"
    address="Grabenstraße 39, Sankt Veit an der Glan, 9300, Austria"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+43421239250"
    website="https://www.latorre.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The keep of the medieval St Veit fortress is a truly remarkable setting. Nestled within the historic walls and surrounded by greenery, the small terrace is a particular highlight. This restaurant is run by husband-and-wife team Rosemarie and Ammar Trabelsi, who create a welcoming atmosphere with a personal touch. The Sicilian presides front-of-house and has charm in his blood. His dapper, old-school style is anything but stuffy. She is in charge of the kitchen and cooks up ambitious Italian and Mediterranean cuisine using select ingredients. Her dishes are pared down to just a few components, allowing their natural flavours to shine through. Turbot with samphire and datterini tomatoes or house-made paccheri with wild prawns, tomatoes and rocket are prime examples. Fish and seafood take cen..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grabenstra%C3%9Fe%2039%2C%20Sankt%20Veit%20an%20der%20Glan%2C%209300%2C%20Austria"
    pageTitle="La Torre"
  />
);
