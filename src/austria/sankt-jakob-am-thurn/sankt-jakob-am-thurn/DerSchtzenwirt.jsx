...
const DerSchtzenwirt = () => (
  <RestaurantPage
    restaurantName="Der Schützenwirt"
    address="Schützenweg 3, Sankt Jakob am Thurn, 5412, Austria"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43662633000"
    website="https://www.der-schuetzenwirt.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 2020, following stints at top-flight establishments, Andrea and Robert Rübsam fulfilled their dream of opening their own restaurant, which is located in a picturesque and tranquil spot some 20min south of Salzburg. Their culinary approach is grounded in seasonality and local sourcing, with 25 regional producers supplying fresh top-notch ingredients. The dishes reflect Austrian tradition, elevated with imaginative twists and influences from around the globe. The menu is written up on a board, featuring options such as Gazpacho andaluz, bell pepper, jalapeño, croutons, Pickled trout, cucumber, sour cream, rapeseed or Braised beef roulade, mashed potato, kohlrabi. The outdoor garden is a particular source of pride – arguably one of the loveliest in the Salzburg area. Warm, attentive and pr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sch%C3%BCtzenweg%203%2C%20Sankt%20Jakob%20am%20Thurn%2C%205412%2C%20Austria"
    pageTitle="Der Schützenwirt"
  />
);

export default DerSchtzenwirt;
