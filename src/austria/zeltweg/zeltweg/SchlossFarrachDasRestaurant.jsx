...
const SchlossFarrachDasRestaurant = () => (
  <RestaurantPage
    restaurantName="Schloss Farrach - Das Restaurant"
    address="Schlossweg 13, Zeltweg, 8740, Austria"
    cuisine="Farm to table, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+43357725257"
    website="https://www.schlossfarrach.at/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind its striking mosaic façade, this 17C castle houses a beautiful restaurant with a cross-vaulted ceiling. There is also a delightful terrace. In the evenings, diners have a choice of two set menus showcasing seasonal and regional specialities; at lunchtime, the options are more limited. Some of the ingredients come from organic farms or the restaurant's own garden. Owner Alexander Stöhr is in charge of the kitchen; his son manages the front-of-house team and expertly recommends wine pairings. Tip: Various cultural events take place on specific dates. This is also a fantastic venue for private functions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlossweg%2013%2C%20Zeltweg%2C%208740%2C%20Austria"
    pageTitle="Schloss Farrach - Das Restaurant"
  />
);

export default SchlossFarrachDasRestaurant;
