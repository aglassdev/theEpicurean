...
const EchtJanAigner = () => (
  <RestaurantPage
    restaurantName="echt JAN AIGNER"
    address="Franz-Josef-Straße 7, Gleisdorf, 8200, Austria"
    cuisine="International, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+436609710390"
    website="https://echt.genusshandwerk.com/janaigner/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in forumKLOSTER, a seminar and events centre, this is a modern and trendy restaurant with artistic decor that would be right at home in a city such as Graz or Vienna. Jan Aigner serves up dishes that draw on international influences and showcase regional and seasonal produce – you can order à la carte or take a punt on the surprise menu. The wine and beverage list is presented in digital form. Friendly and attentive service. There is also a bar and a terrace. Tip for motorists: There is a public car park next door (charges apply until 6pm)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Franz-Josef-Stra%C3%9Fe%207%2C%20Gleisdorf%2C%208200%2C%20Austria"
    pageTitle="echt JAN AIGNER"
  />
);

export default EchtJanAigner;
