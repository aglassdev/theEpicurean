...
const HermannsJagdstube = () => (
  <RestaurantPage
    restaurantName="Hermann's Jagdstube"
    address="Neder 400, See, 6553, Austria"
    cuisine="Regional Cuisine, Beef"
    priceRange="€€€€"
    phoneNumber="+43544120077"
    website="https://www.bergwiesenglueck.at/kulinarik/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The exclusive little restaurant in the luxe chalet hotel Bergwiesenglück promises a very special culinary experience. If you pre-order it, they serve a game-based set menu, comprising eight small courses made using meat solely from animals hunted by the chef himself – the unusual dishes include, for example, black grouse liver, chamois brain, deer bone marrow or deer tongue. The wine list includes regional and international classics. Optionally you can order the wine pairings devised to accompany the set menu. The friendly and laid-back service is infused with a personal touch. Warm wood and clean lines make for a chic and modern Alpine interior. There are just four tables. A floor-to-ceiling glass façade affords a view of the terrace and the mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Neder%20400%2C%20See%2C%206553%2C%20Austria"
    pageTitle="Hermann's Jagdstube"
  />
);

export default HermannsJagdstube;
