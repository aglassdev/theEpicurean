...
const RotesHausRestaurantAmMarktplatz = () => (
  <RestaurantPage
    restaurantName="Rotes Haus - Restaurant am Marktplatz"
    address="Marktplatz 13, Dornbirn, 6850, Austria"
    cuisine="Austrian"
    priceRange="€€"
    phoneNumber="+43557231555"
    website="https://www.roteshaus-restaurant-am-marktplatz.at/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktplatz%2013%2C%20Dornbirn%2C%206850%2C%20Austria"
    pageTitle="Rotes Haus - Restaurant am Marktplatz"
  />
);

export default RotesHausRestaurantAmMarktplatz;
