...
const GeschwisterRauchWirtshaus = () => (
  <RestaurantPage
    restaurantName="Geschwister Rauch - Wirtshaus"
    ...
    pageTitle="Geschwister Rauch - Wirtshaus"
  />
);

export default GeschwisterRauchWirtshaus;
