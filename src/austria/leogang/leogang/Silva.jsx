...
const Silva = () => (
  <RestaurantPage
    restaurantName="Silva"
    address="Hütten 2, Leogang, 5771, Austria"
    cuisine="Modern Cuisine, Classic French"
    priceRange="€€€€"
    phoneNumber="+4365838561"
    website="https://www.silva.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What must be one of the smallest fine dining restaurants in the country awaits you at Naturhotel Forsthofgut. With space for just 10 diners and its stylish interior design, the place has an air of exclusivity. Michael Helfrich is in charge of the kitchen and serves up interesting modern dishes that showcase the flavours of the forest. The menu takes its cue from the changing seasons – fermentation and smoking also play a role. There are two set menus to choose from: Wald (Forest) and the vegetarian Wiese (Meadow). All courses are also available à la carte for maximum flexibility. Service is pleasingly individualised and personal, and the excellent beverage pairings (with or without alcohol) are elegantly presented at your table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%BCtten%202%2C%20Leogang%2C%205771%2C%20Austria"
    pageTitle="Silva"
  />
);
