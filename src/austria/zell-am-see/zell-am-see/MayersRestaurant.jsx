...
const MayersRestaurant = () => (
  <RestaurantPage
    restaurantName="MAYER's Restaurant"
    address="Hofmannsthalstraße 10, Zell am See, 5700, Austria"
    cuisine="Classic Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+436542729110"
    website="http://www.mayers-restaurant.at"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The location of this restaurant is rather exceptional, housed as it is in beautiful parkland. The building adjoins Schloss Prielau, which was first mentioned in a document dating back to 1425. Anette and Andreas Mayer have been putting their heart and soul into this place for over 20 years. The chef-patron blends classic and creative cuisine, using top-notch ingredients such as Tauern beef, the exceptional quality of which is showcased in five variations: beef tea, tartare, shoulder, fillet and BBQ tongue. Opt for a set menu with fish and meat or a vegetarian/vegan version. In an original touch, your senses are stimulated with house-made aromatic essences at the beginning and end of the meal. The stylish setting is complemented by a skilled service team led by the genial proprietress, whos..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hofmannsthalstra%C3%9Fe%2010%2C%20Zell%20am%20See%2C%205700%2C%20Austria"
    pageTitle="MAYER's Restaurant"
  />
);

export default MayersRestaurant;
