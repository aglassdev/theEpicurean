...
const Brunnauer = () => (
  <RestaurantPage
    restaurantName="Brunnauer"
    address="Fürstenallee 5, Salzburg, 5020, Austria"
    cuisine="French, Country cooking"
    priceRange="€€€"
    phoneNumber="+43662251010"
    website="https://www.restaurant-brunnauer.at/de/startseite/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the lovely historical setting of Villa Ceconi, Sybille and Richard Brunnauer's restaurant is the place to experience fantastic Austrian-style hospitality and cuisine. The dishes draw on French and international influences but give pride of place to the region and the seasons. Shining examples are the Styrian Alpine prawns with Marchfeld asparagus and creamed peas, or Tauern lamb with potato and leek mash and wild cauliflower. There are also vegan options. Everything is freshly prepared using premium ingredients. The themed speciality weeks are worth seeking out – from Veal Offal Specialities and Fish & Shellfish to Truffle Specialities, seasonal classics take centre stage. Well-curated wine list. Tip: reasonably priced lunch set menu. The stylish modern interior is also attractive and t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=F%C3%BCrstenallee%205%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Brunnauer"
  />
);

export default Brunnauer;
