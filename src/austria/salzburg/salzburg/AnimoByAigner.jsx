...
const AnimoByAigner = () => (
  <RestaurantPage
    restaurantName="Animo by Aigner"
    address="Nonntaler Hauptstraße 55, Salzburg, 5020, Austria"
    cuisine="Mediterranean Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+43662834017"
    website="https://www.animobyaigner.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having worked together at Hangar 7, Elisabeth (Lizzy) and Jakob Aigner have now opened their own place here, introducing a charming new concept to the area. While he presides front-of-house, providing friendly and attentive service and astute wine recommendations, she prepares Mediterranean fare in the kitchen. Made from the finest ingredients, her dishes are flavoursome and unfussy – the offerings are written up on a blackboard. The terrace is delightful in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nonntaler%20Hauptstra%C3%9Fe%2055%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Animo by Aigner"
  />
);

export default AnimoByAigner;
