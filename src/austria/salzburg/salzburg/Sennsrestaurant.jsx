...
const Sennsrestaurant = () => (
  <RestaurantPage
    restaurantName="SENNS.Restaurant"
    address="Söllheimerstrasse 16, Salzburg, 5020, Austria"
    cuisine="Creative, International"
    priceRange="€€€€"
    phoneNumber="+436644540232"
    website="https://www.senns.restaurant/de"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Gusswerk – once a bell foundry – is an impressive location for a restaurant. Details of the old industrial architecture have been skilfully combined with chic, stylish modern furnishings. The centrepiece is the open kitchen, allowing you to watch the team led by Andreas Senn and head chef Christian Geisler at work. The cuisine is presented in the form of The 5 Senses of Taste, a set menu that abounds with creativity and well-thought-out details, finely balanced textures and bold flavours, from the five savoury appetisers to dishes such as Chilean sea bass, ajoblanco, tomato, Amalfi lemon, to the five sweet treats served at the end of the meal. It goes without saying that the quality of the ingredients is second to none. The service is top-notch, as are the wine recommendations. Ever wonder..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=S%C3%B6llheimerstrasse%2016%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="SENNS.Restaurant"
  />
);

export default Sennsrestaurant;
