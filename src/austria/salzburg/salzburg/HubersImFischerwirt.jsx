...
const HubersImFischerwirt = () => (
  <RestaurantPage
    restaurantName="Huber's im Fischerwirt"
    address="Peter-Pfenninger-Straße 8, Salzburg, 5020, Austria"
    cuisine="Austrian, International"
    priceRange="€€€€"
    phoneNumber="+43662424059"
    website="https://www.fischerwirt-liefering.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="People have been flocking to Andrea and Harald Huber's Fischerwirt for years – and with good reason. This is hospitality at its finest. In the charming and elegant indoor area or out on the cosy little terrace, diners are attended to by a thoroughly affable team managed by your cordial hostess. And, of course, there is the delicious food – seasonal specialities from the region and traditional classics are served throughout the day. The extensive menu has something for everyone – from braised Borettana onion with crosne and charred leek to Backhenderl (breaded fried chicken) and Kalbsrahmbeuschel (veal lights ragout), every dish looks tempting. Be sure not to miss out on the wonderful desserts such as Topfenknödel (curd dumplings) or Heidelbeer-Datschi (blueberry cake). Tip: The four- to se..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Peter-Pfenninger-Stra%C3%9Fe%208%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Huber's im Fischerwirt"
  />
);

export default HubersImFischerwirt;
