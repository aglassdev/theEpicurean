...
const GasthofAuerhahn = () => (
  <RestaurantPage
    restaurantName="Gasthof Auerhahn"
    address="Bahnhofstraße 15, Salzburg, 5020, Austria"
    cuisine="Country cooking, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43662451052"
    website="https://auerhahn-salzburg.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run with great dedication, this friendly, family-owned restaurant is located at a slight remove from the city centre, close to the train station, but it's well worth making the detour for the excellent food. The cuisine is regional, seasonal and pleasingly down-to-earth. Their appealing range of dishes includes venison ragout with bread dumplings and chanterelles, as well as delicious desserts such as Topfenknödel (curd dumplings). Order à la carte or opt for the set menu, which comprises three to five courses – a vegetarian version is also available. Dine in the inviting interior or out on the charming terrace to the rear of the building. The adjoining hotel has well-appointed guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofstra%C3%9Fe%2015%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Gasthof Auerhahn"
  />
);

export default GasthofAuerhahn;
