...
const ZumBuberlGut = () => (
  <RestaurantPage
    restaurantName="Zum Buberl Gut"
    address="Gneiser Straße 31, Salzburg, 5020, Austria"
    cuisine="Traditional Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+43662826866"
    website="https://www.buberlgut.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="More than just a pretty face, this gorgeous 17C country estate, located on the outskirts of the city, is also a delightful setting for a delicious meal. The cosy interior marries classic elegance with charming regional touches, creating a welcoming atmosphere. In the summer, the lovely garden beckons. The cuisine is a flavoursome blend of Austrian and Mediterranean influences. The wine list, too, is definitely worth a look. Tip: Come at lunchtime for the small, moderately priced menu available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gneiser%20Stra%C3%9Fe%2031%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Zum Buberl Gut"
  />
);

export default ZumBuberlGut;
