...
const MeisslSchadnSAL = () => (
  <RestaurantPage
    restaurantName="Meissl & Schadn"
    address="Getreidegasse 50, Salzburg, 5020, Austria"
    cuisine="Austrian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+4366290302"
    website="https://meisslundschadn.at/meissl-schadn-salzburg/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The schnitzel reigns supreme at this restaurant in the heart of the old town. Even from the outside you can peer into the open kitchen and see the house speciality, Wiener schnitzel, being prepared. The rest of the menu is worth perusing too, with other Austrian classics such as Tafelspitz, Esterházy lentils, or goose (when in season). And be sure to save room for dessert – traditional treats like Salzburger Nockerlor classic apple strudel are too good to miss! Highlights also include a nicely curated wine list and professional service that's both warm and attentive. The setting has its own appeal: inside, stylish details across two floors create a welcoming brasserie feel, and outside, the inviting terrace opens directly onto the iconic Getreidegasse. Tip: Leave your car in the multi-stor..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Getreidegasse%2050%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Meissl & Schadn"
  />
);

export default MeisslSchadnSAL;
