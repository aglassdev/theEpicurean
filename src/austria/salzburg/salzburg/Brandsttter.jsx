...
const Brandsttter = () => (
  <RestaurantPage
    restaurantName="Brandstätter"
    address="Münchner Bundesstraße 69, Salzburg, 5020, Austria"
    cuisine="Country cooking, International"
    priceRange="€€€"
    phoneNumber="+43662434535"
    website="https://www.hotel-brandstaetter.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A real Salzburg institution! The atmosphere in the various dining areas is perfect for a cosy dinner, but in the summer, you might prefer to sit out on the gorgeous terrace. Traditional Austrian fare dominates the menu – be sure to try the wonderful creamy veal goulash with dumplings! For those who prefer something a little more upscale, there are options such as sole and beef fillet. The service comes courtesy of an attentive and well-drilled front-of-house team. Comfortably furnished guestrooms are available for overnight stays. Good to know: You can buy house-made jams to take home. Practical for motorists: There is a large car park right in front of the building...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BCnchner%20Bundesstra%C3%9Fe%2069%2C%20Salzburg%2C%205020%2C%20Austria"
    pageTitle="Brandstätter"
  />
);

export default Brandsttter;
