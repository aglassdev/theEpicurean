...
const KruterreichByVitusWinkler = () => (
  <RestaurantPage
    ...
    pageTitle="Kräuterreich by Vitus Winkler"
  />
);

export default KruterreichByVitusWinkler;
