...
const WirtshausByVitusWinkler = () => (
  <RestaurantPage
    restaurantName="Wirtshaus by Vitus Winkler"
    address="Kirchweg 2, Sankt Veit im Pongau, 5621, Austria"
    cuisine="Austrian, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+4364154323"
    website="https://www.sonnhof-vituswinkler.at/de/kulinarik/restaurant-wirtshaus/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern Alpine tavern is a wonderful alternative to the fine dining restaurant here at Hotel Sonnenhof. Windows between the two dining areas foster a nice and airy feel and mean there is a view of the magnificent mountain landscape from almost every table. The tastefully designed upscale interior with a hint of rusticity is the perfect setting in which to enjoy a contemporary take on Wirtshausküche (tavern cuisine) based on select, mostly regional ingredients. Think Alpine fish soup – paprika fish soup, Alpine prawns, fennel agnolotti or Pongauer Fleischkrapfen (meat and sauerkraut dumplings), coleslaw, bacon chips, chives. Go à la carte or choose a three- to five-course set menu. Wine lovers will appreciate the wine list from the hotel's fine dining restaurant, Kräuterreich. The whole..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kirchweg%202%2C%20Sankt%20Veit%20im%20Pongau%2C%205621%2C%20Austria"
    pageTitle="Wirtshaus by Vitus Winkler"
  />
);

export default WirtshausByVitusWinkler;
