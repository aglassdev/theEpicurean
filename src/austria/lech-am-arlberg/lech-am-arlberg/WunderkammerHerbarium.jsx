...
const WunderkammerHerbarium = () => (
  <RestaurantPage
    restaurantName="Wunderkammer - Herbarium"
    address="Tannberg 59, Lech am Arlberg, 6764, Austria"
    cuisine="Austrian, International"
    priceRange="€€€"
    phoneNumber="+4355833500"
    website="https://www.almhof.at/restaurant/wunderkammer/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located near the Schlegelkopf piste, the luxurious Almhof Schneider hotel, built in 1929, is home to this fine dining restaurant, which is only open during the winter. At lunchtime and in the evening, you can enjoy Austrian cuisine with international influences: the menu includes Fiaker goulash, Wagyu steak, Riesling Beuschel (offal ragout) with bread dumplings and, for dessert, Kaiserschmarrn (shredded pancake). The wine list, comprising over 1 200 labels, is superb. Meals are served in two tastefully decorated dining spaces: Wunderkammer, designed by artist Paul Renner, and Herbarium, featuring beautiful woodcuts by Christian Thanhäuser...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tannberg%2059%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Wunderkammer - Herbarium"
  />
);

export default WunderkammerHerbarium;
