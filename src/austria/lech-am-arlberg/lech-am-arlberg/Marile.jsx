...
const Marile = () => (
  <RestaurantPage
    restaurantName="Marile"
    address="Dorf 161, Lech am Arlberg, 6764, Austria"
    cuisine="Contemporary, Austrian"
    priceRange="€€€"
    phoneNumber="+4355832635"
    website="https://derberghof.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the lovely Hotel Berghof, this compact wood-panelled restaurant is rustic and cosy, yet stylish. Alpine tradition meets modern sophistication in contemporary Austrian cuisine with an international twist. Think dashi egg custard with Oscietra caviar, pearl onions and onion tea, or Alpine char with tarragon beurre blanc, pumpkin seed mole, celeriac and kohlrabi. There is also an impressive wine list dominated by Austrian labels but including options from elsewhere in the Old World and beyond. Attentive service is provided by a friendly and professional front-of-house team. Don't miss the opportunity to have a drink in the fantastic bar – this is where it all began in the 1950s. At lunchtime and in the afternoon, the hotel restaurant is open, with a small menu of daily specials and ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorf%20161%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Marile"
  />
);

export default Marile;
