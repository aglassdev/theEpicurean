...
const Severins = () => (
  <RestaurantPage
    restaurantName="Severin*s"
    address="Stubenbach 273, Lech am Arlberg, 6764, Austria"
    cuisine="Classic Cuisine, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+435583339070"
    website="https://www.severins-lech.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Alpine Retreat is a luxurious little hotel, and this is its restaurant. Blending modern design and Alpine charm, its chic interior has a rather intimate and private feel to it. Tuck into dishes such as horseradish fagottini with celeriac and parsley, or gently cooked char from Zug with cauliflower done two ways and a vegetable jus. Tip: Don't miss out on your chance to try Kaiserschmarrn (shredded pancake)! In the evening, you can opt for a set menu or order à la carte; at lunchtime, there is a separate à la carte menu. The good food is complemented by an excellent selection of wines. Friendly, attentive and professional service. N.B. Open in winter only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stubenbach%20273%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Severin*s"
  />
);

export default Severins;
