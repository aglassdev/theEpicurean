...
const JgerstubeWalserstube = () => (
  <RestaurantPage
    restaurantName="Jägerstube & Walserstube"
    address="Tannberg 228, Lech am Arlberg, 6764, Austria"
    cuisine="Modern Cuisine, Asian"
    priceRange="€€€€"
    phoneNumber="+4355832104"
    website="https://www.monzabon.at/genussurlaub/kulinarik"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Temporarily closed.In the small fine dining restaurant of Hotel Jagdhaus Monzabon, Michael Broger and his team deliver interesting modern cuisine that is big on flavour. Guests will also enjoy the charming service and expert wine recommendations that come courtesy of junior chef and sommelier Tobias Schneider – who also happens to be a sake sommelier. The food, which delves into the region and uses many ingredients from local suppliers, is also decidedly cosmopolitan. From an appealing selection of dishes – for example, Buddha – red Carabinero prawn, macadamia, Buddha's hand lemon & crustacean bisque or Teriyaki venison, morel, pointed cabbage, praline from the leg & kohlrabi – you can put together a four- to six- course menu of your own. An alternative is the chef's 4-course tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tannberg%20228%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Jägerstube & Walserstube"
  />
);

export default JgerstubeWalserstube;
