...
const Pfeffermhle = () => (
  <RestaurantPage
    restaurantName="Pfeffermühle"
    address="Dorf 138, Lech am Arlberg, 6764, Austria"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+43558325250"
    website="https://www.pfefferkorn-lech.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you want to savour classic French-influenced cuisine without having to commit to a set menu, the lovely, cosy restaurant of Hotel Pfefferkorn is just the place for you. The à la carte menu lives up to the establishment's name, incorporating a unique touch of exoticism with one of 13 peppers in each dish. Think carabineros prawn with fruity curry, pickled golden beet, tomato, ginger, and Indian mountain pepper, or pigeon à la royale with pear, parsnip, fried onion, and smoked Malabar pepper. There is no reason to worry that the food will be excessively spicy – chef Christian Wild has a light touch with the pepper, so it enhances the flavour without overpowering it. Diners can also look forward to very friendly service and a fine selection of wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorf%20138%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Pfeffermühle"
  />
);

export default Pfeffermhle;
