...
const RoteWandChefsTable = () => (
  <RestaurantPage
    restaurantName="Rote Wand Chef's Table"
    address="Zug 5, Lech am Arlberg, 6764, Austria"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+43558334350"
    website="https://www.rotewand.com/gourmet/rote-wand-chefs-table/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the exclusive Rote Wand Gourmet Hotel – formerly a modest inn in Zug's old schoolhouse – guests are treated to a very special culinary experience. After an aperitif and a selection of appetisers in the little parlour downstairs, you proceed upstairs to a chic dining area in which warm wood meets sleek design; there you take a seat on one of the comfortable bar chairs arranged around a horseshoe counter. A special atmosphere reigns here, and this is due in no small part to the well-coordinated, charming and laid-back service team. Julian Stieger, who comes from Upper Austria, brings his highly unique and modern style to the table: his dishes are very modern, complex yet devoid of unnecessary frills. For example, his delicious Blutwurstbrot is a fine-crumbed, moist bread topped with an ap..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zug%205%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Rote Wand Chef's Table"
  />
);

export default RoteWandChefsTable;
