...
const Fux = () => (
  <RestaurantPage
    restaurantName="Fux"
    address="Omesberg 587, Lech am Arlberg, 6764, Austria"
    cuisine="Fusion, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+4355832992"
    website="https://www.fux-mi.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chic restaurant is very much at home in Lech. Behind the large glass-paned façade a tastefully designed space with a modern feel awaits. The open kitchen certainly plays its part – you can watch the chefs from almost anywhere. The cuisine is a fusion of Asian and European – a style to which they have been committed for years. The wine list absolutely deserves a mention, being one of the finest in the country – the Champagne and Burgundy selection leaves nothing to be desired. The bar area is also inviting – ideal for an aperitif or a nightcap...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Omesberg%20587%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Fux"
  />
);
