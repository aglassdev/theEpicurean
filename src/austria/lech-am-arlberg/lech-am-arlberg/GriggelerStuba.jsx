...
const GriggelerStuba = () => (
  <RestaurantPage
    restaurantName="Griggeler Stuba"
    address="Oberlech 568, Lech am Arlberg, 6764, Austria"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+4355833140"
    website="https://www.burgvitalresort.com/de/kulinarik/griggeler-stuba/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The cosy restaurant proposes regional cuisine enhanced by judicious use of a variety of herbs. A preponderance of wood and appealing little details create a harmonious decor that is infused with Alpine charm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oberlech%20568%2C%20Lech%20am%20Arlberg%2C%206764%2C%20Austria"
    pageTitle="Griggeler Stuba"
  />
);

export default GriggelerStuba;
