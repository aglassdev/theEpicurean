...
const LilliJojo = () => (
  <RestaurantPage
    restaurantName="Lilli & Jojo"
    address="Sulztal an der Weinstraße 22, Gamlitz, 8451, Austria"
    cuisine="Farm to table, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+436763943503"
    website="https://www.lilliundjojo.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lilli Kollar and Joachim Gradwohl (Lilli & Jojo) have created something really wonderful here. Along with its fabulous elevated location surrounded by vineyards, their restaurant boasts a delightfully cosy atmosphere and very friendly service. In summer, you should definitely opt for a table on the idyllic terrace if possible. Joachim Gradwohl is a renowned chef, who crafts seasonal dishes, showcasing locally sourced ingredients. To complement your food, there is a nicely curated selection of fine wines from the region and beyond. Tip: Not only are there some fantastic hiking trails in the area, but also some excellent wineries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sulztal%20an%20der%20Weinstra%C3%9Fe%2022%2C%20Gamlitz%2C%208451%2C%20Austria"
    pageTitle="Lilli & Jojo"
  />
);

export default LilliJojo;
