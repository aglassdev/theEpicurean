...
const Weinkehr = () => (
  <RestaurantPage
    restaurantName="Weinkehr"
    address="Kirchengasse 145, Gamlitz, 8462, Austria"
    cuisine="Austrian"
    priceRange="€€"
    phoneNumber="+436641905496"
    website="https://www.weinkehr.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A dedicated duo of owners await you in this inviting, simple and modern restaurant in the heart of Gamlitz. While Philipp Marko stands for genuine hospitality and wine expertise, chef Lukas Fürk focuses on the product in his ‘comfort food’. The ingredients are mainly sourced locally. The food is cooked fresh and with care, skilfully crafted. Fine examples include ‘homemade crackling dumplings with paprika-flavoured Welschriesling cabbage’ and ‘Weinkehr goulash with handmade Kaiser roll’. The ‘Esskultur’ – a small sourdough bread with whipped butter and smoked bacon – is a truly delicious treat. You can choose à la carte or let yourself be surprised with a 5-course menu (only per table). At lunchtime, there is an attractive three-course lunch menu. The wine list offers a very good regional ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kirchengasse%20145%2C%20Gamlitz%2C%208462%2C%20Austria"
    pageTitle="Weinkehr"
  />
);

export default Weinkehr;
