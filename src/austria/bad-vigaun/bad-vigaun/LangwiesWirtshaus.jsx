...
const LangwiesWirtshaus = () => (
  <RestaurantPage
    restaurantName="Langwies Wirtshaus"
    address="Langwies 22, Bad Vigaun, 5424, Austria"
    cuisine="Seasonal Cuisine, Austrian"
    priceRange="€€"
    phoneNumber="+4362458956"
    website="https://www.langwies.at/de/wirtshaus"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A self-proclaimed lodge hotel for gourmets, Langwies Wirtshaus combines several facilities under one roof: a restaurant, a spa hotel, a conference centre and long-stay apartments. The menu features a contemporary selection of regional classics, steaks and seasonal dishes, as well as vegan and vegetarian options. There are several attractive dining spaces – for example, you can book a table in the cosy, spruce-panelled bay room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Langwies%2022%2C%20Bad%20Vigaun%2C%205424%2C%20Austria"
    pageTitle="Langwies Wirtshaus"
  />
);

export default LangwiesWirtshaus;
