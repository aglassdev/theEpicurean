...
const Humbachstube = () => (
  <RestaurantPage
    restaurantName="Humbachstube"
    address="Unterwestegg 17, Riezlern, 6991, Austria"
    cuisine="Classic Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+4355175234"
    website="https://alpenhof-jaeger.at/restaurant#c"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Alpenhof Jäger hotel's restaurant may be small but what it lacks in size it makes up for in atmosphere! With plenty of wood, a tiled stove and pretty decorations, the cosy and homely Humbachstube is completely in keeping with the rustic charm of the 380-year-old regional-style building in which it is located. In the kitchen, Florian Jäger and his father Martin cook with market produce, creating dishes based on the classic repertoire, such as sirloin of local mountain lamb roasted with aromatics, fresh spinach leaves and potato and Parmesan gnocchi. The wine list is all about Austria's own production. Diners will enjoy friendly, attentive service with a real family touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unterwestegg%2017%2C%20Riezlern%2C%206991%2C%20Austria"
    pageTitle="Humbachstube"
  />
);

export default Humbachstube;
