...
const BrSchafWirtschaft = () => (
  <RestaurantPage
    restaurantName="Bär & Schaf Wirtschaft"
    address="2.-Mai-Straße 18, Völkermarkt, 9100, Austria"
    cuisine="Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+436602100498"
    website="https://www.baerundschafwirtschaft.at/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="What started as a pop-up has now become a permanent fixture in the historical Gasthaus zum Prinz Johann. The proprietor duo, Martin Nuart and Philipp Medved, offer their guests a very personal dining experience. Philipp manages things front-of-house with delightful ease, friendliness, and proficiency, while Martin heads up the sustainability-focused kitchen. His intriguing plant-forward set menu showcases select seasonal ingredients from his family's own farm or neighbouring agricultural producers. In terms of wine, Austria takes centre stage, and is accompanied by offerings from Slovenia and Italy. The setting is wonderfully inviting – with lovely old floorboards, simple wooden benches and chairs and decorative contemporary artwork, the historical charm of the centuries-old inn has been r..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2.-Mai-Stra%C3%9Fe%2018%2C%20V%C3%B6lkermarkt%2C%209100%2C%20Austria"
    pageTitle="Bär & Schaf Wirtschaft"
  />
);

export default BrSchafWirtschaft;
