...
const Stockerwirt = () => (
  <RestaurantPage
    restaurantName="Stockerwirt"
    address="Rohrberg 36, Sulz im Wienerwald, 2392, Austria"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+4322388259"
    website="http://www.stockerwirt.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beyond its fine cooking, this place puts major emphasis on wine. Curated by sommelier Bernhard Weidinger, the remarkable wine list comprises 2 700 labels to pair with dishes such as fried porcini with tartare sauce, or wels catfish from Gut Dornau fish farm with bacon beurre blanc, artichokes, potato-Parmesan-parsley root mousseline and cherry tomatoes. The selection of Austrian wines is outstanding, and the international range is equally strong. Many wines are available by the glass. Service is warm, attentive and highly professional. The interior design blends modern shapes with natural colours and materials. The terrace overlooks a garden complete with a pond and mature apple and walnut trees – an idyllic setting. Another highlight is the private room, or Weinwerkstatt, where up to 20 d..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rohrberg%2036%2C%20Sulz%20im%20Wienerwald%2C%202392%2C%20Austria"
    pageTitle="Stockerwirt"
  />
);

export default Stockerwirt;
