...
const HeurigenhofBrndlmayer = () => (
  <RestaurantPage
    restaurantName="Heurigenhof Bründlmayer"
    address="Walterstr. 14, Langenlois, 3550, Austria"
    cuisine="Classic French, Contemporary"
    priceRange="€€€€"
    phoneNumber="+4327342883"
    website="http://www.heurigenhof.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a handsome Renaissance building in the heart of this tranquil wine-growing town, chef Matthias Schütz presents classic French cuisine with modern accents. High-quality ingredients go into flavoursome dishes such as lake trout with kohlrabi, buttermilk, macadamia nut and chives, or turbot with artichoke, tatsoi, vadouvan, salted lemon and jus corsé. The outstanding wine list features over 500 labels from Europe and overseas. Naturally, the Bründlmayer estate is also well represented, and its wines are frequently recommended by the glass. The service team is friendly, attentive and professional. The restaurant spans four interconnected rooms, one of which boasts a splendid historical stone vault and an open fireplace that brings welcome cosiness in winter. In summer, the idyllic courtyard..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Walterstr.%2014%2C%20Langenlois%2C%203550%2C%20Austria"
    pageTitle="Heurigenhof Bründlmayer"
  />
);

export default HeurigenhofBrndlmayer;
