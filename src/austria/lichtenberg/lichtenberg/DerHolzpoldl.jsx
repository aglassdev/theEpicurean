...
const DerHolzpoldl = () => (
  <RestaurantPage
    restaurantName="Der Holzpoldl"
    address="Am Holzpoldlgut 2, Lichtenberg, 4040, Austria"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+4372396225"
    website="https://www.manuelgrabner.at/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Holzpoldlgut%202%2C%20Lichtenberg%2C%204040%2C%20Austria"
    pageTitle="Der Holzpoldl"
  />
);

export default DerHolzpoldl;
