...
const BrasserieLeonis = () => (
  <RestaurantPage
    restaurantName="Brasserie Leonis"
    address="Silvrettastraße 8, Schruns, 6780, Austria"
    cuisine="French, Austrian"
    priceRange="€€€"
    phoneNumber="+4355567141"
    website="https://www.loewen-hotel.com/kulinarik/brasserie-leonis/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in Löwen Hotel Montafon, this brasserie exudes elegance. Warm wood brings an Alpine touch to the clean lines, premium materials, tasteful colour scheme and bold floral decorations. You can also dine at high tables in the bar area, and the terrace is delightful in summer. The menu features classics such as Wiener schnitzel, as well as steaks from the Japanese Yakiniku charcoal grill, plus recommendations from chef Janine Wieland, such as quail coq au vin. The friendly and well-trained front-of-house team is led by sommelier Fabienne Hammer, who gladly assists with wine recommendations – the well-curated wine list is dominated by Austrian labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Silvrettastra%C3%9Fe%208%2C%20Schruns%2C%206780%2C%20Austria"
    pageTitle="Brasserie Leonis"
  />
);

export default BrasserieLeonis;
