...
const Lieperts = () => (
  <RestaurantPage
    restaurantName="Lieperts"
    address="Arnfelser Straße 2, Leutschach an der Weinstraße, 8452, Austria"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+436641418116"
    website="https://www.lieperts.at"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This establishment is officially named Lieperts Café, Dinner, Rooms, which accurately reflects its offerings: You can come for a wonderful breakfast Fri-Sun, then later in the day, a selection of appealing snacks and drinks are available. Owner and eponym Manuel Liepert serves up fine dining cuisine Mon-Tue and Fri-Sat (reservations required). This comes in the form of a five- to seven-course surprise menu preluded by a number of delectable amuse-bouches. Dishes such as chicken, papaya, peanut and sweet potato or pan-seared pike-perch, beurre blanc, green strawberry and mushrooms showcase a contemporary approach with regional and international influences. Maître d' Lisa Kürbisch provides interesting recommendations from the wine impressive list dominated by labels from the region. There ar..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arnfelser%20Stra%C3%9Fe%202%2C%20Leutschach%20an%20der%20Weinstra%C3%9Fe%2C%208452%2C%20Austria"
    pageTitle="Lieperts"
  />
);

export default Lieperts;
