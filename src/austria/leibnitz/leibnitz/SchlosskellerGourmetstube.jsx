...
const SchlosskellerGourmetstube = () => (
  <RestaurantPage
    restaurantName="Schlosskeller Gourmetstube"
    ...
    pageTitle="Schlosskeller Gourmetstube"
  />
);

export default SchlosskellerGourmetstube;
