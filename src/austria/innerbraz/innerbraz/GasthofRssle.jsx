...
const GasthofRssle = () => (
  <RestaurantPage
    restaurantName="Gasthof Rössle"
    address="Arlbergstraße 61, Innerbraz, 6751, Austria"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+435552281050"
    website="https://www.roesslebraz.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Currently at the helm of this restaurant, once an inn (dating back to 1775), is Valentin Bargehr, the third generation of the family. On the first floor of this building next to the parish church, Pfarrkirche St Nikolaus, diners are welcomed in a number of inviting dining spaces (some wood-panelled), or outside on the pretty terrace shaded by trees. The menu features delicious regional cuisine made from seasonal, almost exclusively local ingredients. In addition to à la carte dishes such as Rössle fish soup or roast chicken, mixed salad, lingonberries, parsley potatoes, there is also a choice of two lovely three-course set menus, one of which is vegetarian. These include mouthwatering veal cheeks, chanterelles and noodles or pumpkin capuns and grilled vegetables, respectively. While Valent..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arlbergstra%C3%9Fe%2061%2C%20Innerbraz%2C%206751%2C%20Austria"
    pageTitle="Gasthof Rössle"
  />
);

export default GasthofRssle;
