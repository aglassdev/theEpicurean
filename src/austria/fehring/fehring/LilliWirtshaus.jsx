...
const LilliWirtshaus = () => (
  <RestaurantPage
    restaurantName="Lilli Wirtshaus"
    ...
    pageTitle="Lilli Wirtshaus"
  />
);

export default LilliWirtshaus;
