...
const LuckysRestaurantHausAmHang = () => (
  <RestaurantPage
    restaurantName="Luckys Restaurant Haus am Hang"
    address="Mondsee-Bundesstraße 10, Sankt Gilgen, 5340, Austria"
    cuisine="International, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+436644435701"
    website="https://www.haus-am-hang.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The place to be is a pretty apt way to describe this restaurant from which you can take in a wonderful view of the lake (Wolfgang See), Sankt Gilgen and the surrounding mountains. As you can imagine, the sophisticated terrace is coveted in summer… and then there is the good food added into the mix. Susanne and Lucas Bocsa have been putting their heart and soul into their role as hosts for many years and, over time, have established a chic restaurant where Lucas Bocsa cooks up flavoursome dishes, both classic and international. With the two set menus, Luckys and Luckys All Around the World, you can also dip in and go à la carte. The glass wine cabinet in the entrance area whets your appetite for a good glass of wine off the bat. The friendly and professional service team is headed up by the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mondsee-Bundesstra%C3%9Fe%2010%2C%20Sankt%20Gilgen%2C%205340%2C%20Austria"
    pageTitle="Luckys Restaurant Haus am Hang"
  />
);

export default LuckysRestaurantHausAmHang;
