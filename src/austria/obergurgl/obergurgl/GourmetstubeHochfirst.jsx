...
const GourmetstubeHochfirst = () => (
  <RestaurantPage
    restaurantName="Gourmetstube Hochfirst"
    address="Gurglerstraße 123, Obergurgl, 6456, Austria"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+43525663250"
    website="https://www.hochfirst.com/kulinarik/gourmetstube/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small fine dining restaurant in the luxe Hochfirst, a chic Alpine hotel, has an elegant yet refreshingly relaxed atmosphere. Seating up to 16 diners at beautifully laid tables, the cosy space has large windows overlooking the ski slope. You are free to choose the number of courses you would like from the set menu. The cuisine is contemporary, rich in flavour and full of character, with dishes such as Gurgler Ramen – smoked trout with oxtail, hand-made spaetzle, soft-poached egg and mushroom essence, or saddle of fawn, coffee jus and black salsify. Service comes courtesy of attentive and adept waitstaff, who can also provide wine recommendations. Well-curated and comprehensive, the wine list stands out especially for its appealing selection and range of vintages from Austria, France an..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gurglerstra%C3%9Fe%20123%2C%20Obergurgl%2C%206456%2C%20Austria"
    pageTitle="Gourmetstube Hochfirst"
  />
);

export default GourmetstubeHochfirst;
