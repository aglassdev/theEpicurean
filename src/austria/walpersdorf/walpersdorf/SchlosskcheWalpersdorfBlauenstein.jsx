...
const SchlosskcheWalpersdorfBlauenstein = () => (
  <RestaurantPage
    restaurantName="Schlossküche Walpersdorf Blauenstein"
    address="Schlossstraße 2, Walpersdorf, 3131, Austria"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+4369919307883"
    website="https://www.blauenstein.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant lies within Walpersdorf Castle, whose origins date back to 1571. The name Schlossküche is a nod to the fact that you dine in a historical kitchen… which has its own unique charm. Notable details include the original oven in the middle of the room and the vaulted ceiling with exposed ventilation pipes. The adjoining rooms are also cosy; the terrace with a view onto the manicured green spaces is delightful. As for the food, this is market-fresh fare influenced by regional home-style cooking. Dishes such as Waldviertel Tafelspitz (boiled pasture-raised beef), creamed spinach, roast potatoes, apple horseradish, chive sauce show how much local produce is valued here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schlossstra%C3%9Fe%202%2C%20Walpersdorf%2C%203131%2C%20Austria"
    pageTitle="Schlossküche Walpersdorf Blauenstein"
  />
);

export default SchlosskcheWalpersdorfBlauenstein;
