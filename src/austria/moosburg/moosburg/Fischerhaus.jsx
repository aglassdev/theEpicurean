...
const Fischerhaus = () => (
  <RestaurantPage
    restaurantName="fischerhaus"
    address="Pörtschacherstraße 44, Moosburg, 9062, Austria"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+43427283315"
    website="https://fischerhaus-moosburg.at/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely country house is located just a stone's throw from Wörthersee. The restaurant boasts a chic, elegant interior, as well as a delightful terrace. The menu features a diverse range of dishes prepared with the finest ingredients, covering everything from Austrian classics and Asian cuisine to truffles and caviar. Regulars and newcomers alike are treated with the same warmth and professionalism by the friendly staff...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=P%C3%B6rtschacherstra%C3%9Fe%2044%2C%20Moosburg%2C%209062%2C%20Austria"
    pageTitle="fischerhaus"
  />
);

export default Fischerhaus;
