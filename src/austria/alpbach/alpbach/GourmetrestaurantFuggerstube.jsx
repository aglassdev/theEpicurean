...
const GourmetrestaurantFuggerstube = () => (
  <RestaurantPage
    restaurantName="Fuggerstube"
    address="Alpbach 166, Alpbach, 6236, Austria"
    cuisine="Seasonal Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+4353365227"
    website="https://www.boeglerhof.at/"
    aliases={["Gourmetrestaurant Fuggerstube"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The historical Fuggerstube – dating back to the 15C – is a real gem of a place. The beautiful wood panelling and the old stove cultivate a cosy atmosphere and old-world charm. There are just four tables, at which diners tuck into a seasonal set menu packed with regional ingredients. The wine pairings recommended to go with each course are excellent, and the wine cellar has quite a few bottles from which to choose. The restaurant is located in Der Böglerhof, a wellness hotel that has expanded over the years...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alpbach%20166%2C%20Alpbach%2C%206236%2C%20Austria"
    pageTitle="Fuggerstube"
  />
);

export default GourmetrestaurantFuggerstube;
