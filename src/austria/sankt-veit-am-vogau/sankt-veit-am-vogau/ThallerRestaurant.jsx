...
const ThallerRestaurant = () => (
  <RestaurantPage
    restaurantName="Thaller - Restaurant"
    ...
    pageTitle="Thaller - Restaurant"
  />
);

export default ThallerRestaurant;
