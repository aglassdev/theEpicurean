...
const PastamaraBarConCucina = () => (
  <RestaurantPage
    restaurantName="Pastamara - Bar con Cucina"
    address="Schubertring 5, Vienna, 1010, Austria"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+43131188150"
    website="https://www.pastamara.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the luxurious Ritz-Carlton Hotel you will find this modern restaurant with its large bar. A pleasantly relaxed and elegant atmosphere reigns, and the experienced staff are very friendly. Traditional Sicilian cuisine with a modern touch. Interesting: ‘Negroni Experience’ - a classic with a creative twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schubertring%205%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Pastamara - Bar con Cucina"
  />
);

export default PastamaraBarConCucina;
