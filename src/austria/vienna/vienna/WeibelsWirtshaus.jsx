...
const WeibelsWirtshaus = () => (
  <RestaurantPage
    restaurantName="Weibel's Wirtshaus"
    address="Kumpfgasse 2, Vienna, 1010, Austria"
    cuisine="Austrian"
    priceRange="€"
    phoneNumber="+4315123986"
    website="http://www.weibel.at"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a few minutes’ walk from St Stephen’s Cathedral, Weibel’s Wirtshaus is the archetypal Viennese restaurant – warm and friendly, rustic and snug! It also has a charming garden in the small alleyway. The food is traditional and Viennese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kumpfgasse%202%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Weibel's Wirtshaus"
  />
);

export default WeibelsWirtshaus;
