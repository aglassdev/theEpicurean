...
const Edvard = () => (
  <RestaurantPage
    restaurantName="Edvard"
    address="Schottenring 24, Vienna, 1010, Austria"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+43123610008082"
    website="https://www.edvard-restaurant.com/en/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schottenring%2024%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Edvard"
  />
);
