...
const SilvioNickolGourmetRestaurant = () => (
  <RestaurantPage
    restaurantName="Silvio Nickol Gourmet Restaurant"
    address="Coburgbastei 4, Vienna, 1010, Austria"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+43151818130"
    website="https://www.palais-coburg.com/kulinarik/silvio-nickol/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The exclusive Palais Coburg houses one of Vienna's premier dining destinations, a culinary hotspot for many years running. Executive chef Silvio Nickol and head chef Florian Daube present exceptionally creative cuisine featuring meticulously composed combinations of outstanding ingredients. Their distinctive style leaves a lasting impression – for example, in the wonderfully al dente white asparagus topped with crispy baby prawns and basil, or the rich, aromatic langoustine served with a shellfish-infused hollandaise and a citrus butter foam providing a delightful contrast. The Genussreise set menu comprises eight courses – a ninth can be added if desired. The knowledgeable staff expertly guide you through the menu and wine pairings – and with a jaw-dropping 60 000 bottles stored in six wi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Coburgbastei%204%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Silvio Nickol Gourmet Restaurant"
  />
);

export default SilvioNickolGourmetRestaurant;
