...
const GlasswingByAlexandruSimon = () => (
  <RestaurantPage
    restaurantName="Glasswing by Alexandru Simon"
    address="Kärntner Ring 8, Vienna, 1010, Austria"
    cuisine="Contemporary, Modern French"
    priceRange="€€€€"
    phoneNumber="+4312212212"
    website="https://www.glasswing-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Alexandru Simon and his team present thoughtfully composed dishes rooted in classic French culinary tradition, meticulously prepared yet never overwrought, and balanced perfectly in flavour. Carefully selected ingredients are given space for their aromas to unfold fully. The regularly changing seven-course set menu features memorable creations such as tortelloni with Swiss chard, sea urchin bisque, hoshigaki and XO sauce, or celery with dulce de leche, coffee and pickled quince – each course enhanced by the astutely curated wine pairings courtesy of maître d' and sommelier Max Populorum and his team. The interior is tasteful, modern and elegant, with designer chairs, gorgeous hardwood floors, original oil paintings and a striking crystal chandelier. Many tables afford views into the o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=K%C3%A4rntner%20Ring%208%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Glasswing by Alexandru Simon"
  />
);

export default GlasswingByAlexandruSimon;
