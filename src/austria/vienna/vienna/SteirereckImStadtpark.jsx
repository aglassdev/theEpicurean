...
const SteirereckImStadtpark = () => (
  <RestaurantPage
    restaurantName="Steirereck im Stadtpark"
    address="Am Heumarkt 2a, Vienna, 1030, Austria"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+4317133168"
    website="https://www.steirereck.at/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The architecture is the first thing you notice! Located in the Stadtpark, the building has a futuristic feel. The interior is bright and airy, featuring clean lines and elegant modern design; you can look into the kitchen through the pass. The clever division of the space into different wings creates a calm and relaxed atmosphere. The exceptional politeness and utmost professionalism of the service team ensure that you feel welcome and comfortable from the moment you arrive. Special mention goes to Birgit Reitbauer, an exemplary hostess, and sommelier René Antrag, for his superb wine recommendations – the perfect complement to Heinz Reitbauer and Michael Bauböck's distinctive, creative and often surprising cuisine. At lunchtime and in the evening, a six- or seven-course set menu is propose..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Am%20Heumarkt%202a%2C%20Vienna%2C%201030%2C%20Austria"
    pageTitle="Steirereck im Stadtpark"
  />
);

export default SteirereckImStadtpark;
