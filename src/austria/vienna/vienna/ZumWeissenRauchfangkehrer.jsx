...
const ZumWeissenRauchfangkehrer = () => (
  <RestaurantPage
    restaurantName="Zum weissen Rauchfangkehrer"
    address="Weihburggasse 4, Vienna, 1010, Austria"
    cuisine="Austrian"
    priceRange="€€"
    phoneNumber="+4315123471"
    website="https://www.weisser-rauchfangkehrer.at/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy restaurant is divided into four traditionally decorated rooms – in one of them, gentle piano music provides the soundtrack to your evening meal. Delicious Austrian cuisine is the order of the day, including house specialities such as Rauchfangkehrers Wiener Schnitzel. The wine list is exclusively Austrian and organised according to grape variety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weihburggasse%204%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Zum weissen Rauchfangkehrer"
  />
);

export default ZumWeissenRauchfangkehrer;
