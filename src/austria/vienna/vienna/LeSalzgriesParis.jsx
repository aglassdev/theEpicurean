...
const LeSalzgriesParis = () => (
  <RestaurantPage
    restaurantName="Le Salzgries Paris"
    address="Marc-Aurel-Straße 6, Vienna, 1010, Austria"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+4315334030"
    website="https://www.le-salzgries.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A slice of Paris in Vienna? Mais, oui! This lively brasserie with a distinctly chic feel has become an institution in the city and – in no small part thanks to patron and chef Denis König – brings to life the concepts of bistronomie and savoir-vivre. If you are a fan of fresh seafood, then you've come to the right place: just order the plateau de fruits de mer! The beef tartare is another fine example of the French classics served here. In the evening, you can also choose an even more refined and creative five-course set menu. An exclusively French wine selection and charming service contribute to that Parisian feeling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marc-Aurel-Stra%C3%9Fe%206%2C%20Vienna%2C%201010%2C%20Austria"
    pageTitle="Le Salzgries Paris"
  />
);

export default LeSalzgriesParis;
