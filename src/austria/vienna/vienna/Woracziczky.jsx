...
const Woracziczky = () => (
  <RestaurantPage
    restaurantName="Woracziczky"
    address="Spengergasse 52, Vienna, 1050, Austria"
    cuisine="Austrian"
    priceRange="€"
    phoneNumber="+4369911229530"
    website="http://www.woracziczky.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners are given a warm welcome In this pleasingly informal inn (pronounced Vorashitsky). Both its laid-back atmosphere and Viennese cuisine are a hit, with house specialities such as beef tartare with avocado, or Tafelspitz (boiled veal) served with a creamy chanterelle sauce. The reasonably priced lunchtime set menu, which changes daily, is especially popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Spengergasse%2052%2C%20Vienna%2C%201050%2C%20Austria"
    pageTitle="Woracziczky"
  />
);

export default Woracziczky;
