...
const GamskogelhtteFineDiningByStefanLastin = () => (
  <RestaurantPage
    restaurantName="Gamskogelhütte Fine Dining by Stefan Lastin"
    address="Gamskogel, Rennweg am Katschberg, 9863, Austria"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+436643376678"
    website="https://www.gamskogelhuette.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting a fabulous location at 1 850m above sea level, this small fine dining restaurant is a place where you can truly unwind. In a cosy Alpine-style space featuring rustic wood and charming natural stone, diners sit at elegantly set tables to savour an ambitious three- to six-course set menu complemented by elaborate amuse-bouches to start and sweet treats to finish. Interesting well-matched wine pairings are available, and the list itself includes some rare gems worth sampling. Service is exceptionally friendly and attentive – chef Stefan Lastin presents his dishes personally, and proprietor Peter Aschbacher takes genuine pleasure in interacting with his diners. N.B. In summer, you can drive up the somewhat arduous mountain road yourself, or alternatively take the bus or walk. In winte..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gamskogel%2C%20Rennweg%20am%20Katschberg%2C%209863%2C%20Austria"
    pageTitle="Gamskogelhütte Fine Dining by Stefan Lastin"
  />
);

export default GamskogelhtteFineDiningByStefanLastin;
