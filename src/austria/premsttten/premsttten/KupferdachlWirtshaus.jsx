...
const KupferdachlWirtshaus = () => (
  <RestaurantPage
    restaurantName="Kupferdachl - Wirtshaus"
    address="Hauptstraße 275, Premstätten, 8141, Austria"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+433136523670"
    website="https://kupferdachl.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brother-and-sister team Lisa and Daniel Edelsbrunner are continuing their parents' commitment to Kupferdachl – she in service, he in the kitchen. Based on traditional Austrian recipes, the cuisine takes its cue from the region and the seasons, mindful of the provenance and quality of the ingredients. Aromatic dishes such as oven-baked pumpkin with Nuart sheep's cheese, walnut and chickweed, or Tafelspitz (prime boiled beef) from Chianinahof farm in Dobl with roasted apples, chive sauce and apple and horseradish sauce are served à la carte or as a set menu. At lunchtime (Wed-Fri), there is also a moderately priced daily special. The well-curated wine list includes a fine selection of regional and Austrian labels, as well as organic and biodynamic wines. The lovely covered terrace overlooks ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstra%C3%9Fe%20275%2C%20Premst%C3%A4tten%2C%208141%2C%20Austria"
    pageTitle="Kupferdachl - Wirtshaus"
  />
);

export default KupferdachlWirtshaus;
