...
const WirtshausHrnlingen = () => (
  <RestaurantPage
    restaurantName="Wirtshaus Hörnlingen"
    ...
    pageTitle="Wirtshaus Hörnlingen"
  />
);

export default WirtshausHrnlingen;
