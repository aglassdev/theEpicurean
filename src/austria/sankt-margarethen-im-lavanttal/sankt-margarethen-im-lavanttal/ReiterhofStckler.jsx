...
const ReiterhofStckler = () => (
  <RestaurantPage
    restaurantName="Reiterhof Stückler"
    address="Reiterhofstraße 38, Sankt Margarethen im Lavanttal, 9412, Austria"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+436601421878"
    website="https://reiterhof-stueckler.at/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Temporarily closed.This modern and spacious restaurant enjoys a unique location inside an equestrian centre. Situated on the first floor, it has an appealing decor characterised by an abundance of wood, clean lines and warm tones, but it is the living ceiling that really catches the eye. The windows on all sides afford magnificent views of the surrounding villages, meadows and mountains as well as the on-site riding grounds. Head chef Ralph Kollnitzer and his team propose delicious regional dishes as well as their Gourmetmenü – a creative fine dining set menu of four to six courses (pre-order only)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reiterhofstra%C3%9Fe%2038%2C%20Sankt%20Margarethen%20im%20Lavanttal%2C%209412%2C%20Austria"
    pageTitle="Reiterhof Stückler"
  />
);

export default ReiterhofStckler;
