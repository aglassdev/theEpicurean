...
const LukasKapeller = () => (
  <RestaurantPage
    restaurantName="Lukas Kapeller"
    address="Damberggasse 27, Steyr, 4400, Austria"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+436763047477"
    website="https://www.lukas-kapeller.at/restaurant/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Damberggasse%2027%2C%20Steyr%2C%204400%2C%20Austria"
    pageTitle="Lukas Kapeller"
  />
);

export default LukasKapeller;
