...
const XingWangSeafoodRongtingHuiSiming = () => (
  <RestaurantPage
    restaurantName="Xing Wang Seafood · Rongting Hui (Siming)"
    address="Shop 017, 4F, Xinghe COCOPark, 81-89 Zhanhong Road, Siming, Xiamen, China Mainland"
    cuisine="Seafood"
    priceRange="¥¥¥"
    phoneNumber="+865926026858"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/xing-wang-seafood-rongting-hui-siming"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The seafood chain started out as a fishmonger’s back in 1994. It began running a roadside food stall in 2016 and rebranded itself in 2023 with this upmarket flagship in a shopping mall. Live fish tanks are showcased next to a museum-like display of 100+ taxidermy crustaceans. Pick your favourite seafood from the tanks and specify how you want it cooked. The menu also offers other Minnan specialities to accompany your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20017%2C%204F%2C%20Xinghe%20COCOPark%2C%2081-89%20Zhanhong%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Xing Wang Seafood · Rongting Hui (Siming)"
  />
);

export default XingWangSeafoodRongtingHuiSiming;
