...
const XiangMoJinNianSiming = () => (
  <RestaurantPage
    restaurantName="Xiang Mo Jin Nian"
    address="224-103 Lvling Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8613159207777"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/xiang-mo-jin-nian-siming"
    aliases={["Xiang Mo Jin Nian (Siming)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its façade may be nondescript but its open-air kitchen provides quite a spectacle. Minnan-style soups are slow-cooked over heated sand on clay stoves for three to four hours so need to be pre-ordered; the availability of some soups is limited. Signatures include Muscovy duck soup with mud crab, which combines seafood umami with meaty flavours, and braised soft-shelled tortoise seasoned with ginger and green Sichuan peppercorns...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=224-103%20Lvling%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Xiang Mo Jin Nian"
  />
);

export default XiangMoJinNianSiming;
