...
const SiXiaLiHuli = () => (
  <RestaurantPage
    restaurantName="Si Xia Li (Huli)"
    address="2F, Building B3, G Art Park, 566 Jinbian Road, Huli, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+865922932600"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/si-xia-li-huli"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef-owner has almost 30 years' experience under his belt, with notable stints in various hotel restaurants. Respecting traditions while re-inventing Minnan cuisine by incorporating Western techniques and creative touches, he has come up with a menu that is familiar and fresh at the same time. Try his oyster omelette, in which umami meets the crispness of water chestnut and celery. The slow-cooked pork belly with shiitake is another treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Building%20B3%2C%20G%20Art%20Park%2C%20566%20Jinbian%20Road%2C%20Huli%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Si Xia Li (Huli)"
  />
);

export default SiXiaLiHuli;
