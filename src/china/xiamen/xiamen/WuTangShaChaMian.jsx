...
const WuTangShaChaMian = () => (
  <RestaurantPage
    restaurantName="Wu Tang Sha Cha Mian"
    address="76 Minzu Road, Siming, Xiamen, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+865922041658"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/wu-tang-sha-cha-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With decades of history to its name, this noodle shop is always busy. There is just one thing on the menu – sha cha noodles – but over 20 different toppings to choose from: an array of seafood, including plump razor clams and creamy oysters, and pork offal – even pork heart and pork tripe – are solid options. Less garlicky than its counterparts, its broth is made from toasted, not fried, peanuts to accentuate nuttiness and umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=76%20Minzu%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Wu Tang Sha Cha Mian"
  />
);

export default WuTangShaChaMian;
