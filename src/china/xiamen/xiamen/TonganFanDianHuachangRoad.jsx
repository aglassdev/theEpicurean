...
const TonganFanDianHuachangRoad = () => (
  <RestaurantPage
    restaurantName="Tong'an Fan Dian (Huachang Road)"
    address="A103, Zone A, Southeast World, 125 Huachang Road, Huli, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+865925966766"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/tong-an-fan-dian-huachang-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in 2003, this restaurant was named after Tongan, the cradle of Xiamen culture. The space is bright and airy, with a wall of oyster shell collage as a focal point. Formerly a fisherman, the owner is picky about his fish. Try the boneless giant mottled eel in claypot – the rich sauce complements the oily fish nicely. The quintessential Tongan classic of seared pork belly with dried oysters, chestnuts and shiitake is also recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=A103%2C%20Zone%20A%2C%20Southeast%20World%2C%20125%20Huachang%20Road%2C%20Huli%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Tong'an Fan Dian (Huachang Road)"
  />
);

export default TonganFanDianHuachangRoad;
