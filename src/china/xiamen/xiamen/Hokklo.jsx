...
const Hokklo = () => (
  <RestaurantPage
    restaurantName="Hokklo"
    address="6F, Waldorf Astoria Hotel, 1 Lianhua North Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+865925373333"
    website="https://www.hilton.com/en/hotels/xmnwawa-waldorf-astoria-xiamen/dining/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="“Hokklo” means hospitable in Fujian, in keeping with the welcoming space furnished in elegant East-meets-West style. Hailing from the Minnan region, the head chef champions a refined modern take on traditional Fujian cooking. Signatures include steamed wine-scented yellow croaker, mud crab braised in aged wine with dried longans, and Hakka-style braised He Tian chicken claypot with salt and wine. Peruse the seasonal offerings and extensive wine list, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%20Waldorf%20Astoria%20Hotel%2C%201%20Lianhua%20North%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Hokklo"
  />
);

export default Hokklo;
