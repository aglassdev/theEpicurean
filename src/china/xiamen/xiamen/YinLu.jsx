...
const YinLu = () => (
  <RestaurantPage
    restaurantName="Yin Lu"
    address="Building 66, Gulong Inhabitancy Park, Shangzhong East 2nd Road, Huli, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+865925517566"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/yin-lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This household name opened its doors in 1996 and moved to this historic villa in 2009. The kitchen specialises in Xiamen classics and the menu is concise yet appetising. Don’t miss the ubiquitous double-boiled Muscovy duck soup with crab, whose robust meaty flavour melds with seafood umami. It is best enjoyed with Xiamen rice noodles that suck up the goodness. Other favourites include oyster omelette and deep-fried five-spice rolls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%2066%2C%20Gulong%20Inhabitancy%20Park%2C%20Shangzhong%20East%202nd%20Road%2C%20Huli%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Yin Lu"
  />
);

export default YinLu;
