...
const FuYuDaTongYaRouZhou = () => (
  <RestaurantPage
    restaurantName="Fu Yu Da Tong Ya Rou Zhou"
    address="166 Kaihe Road, Siming, Xiamen, China Mainland"
    cuisine="Congee"
    priceRange="¥"
    phoneNumber="+865922398761"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/fu-yu-da-tong-ya-rou-zhou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This neighbourhood duck congee shop opened its doors in 1983. Locals come in droves 24-7 for a bowl of comforting porridge that warms the heart and soul. Those overwhelmed by the 20-plus toppings available can opt for one of the popular combos – ‘signature’ with duck meat and offal; ‘seafood’ with duck, oysters, and squid; or the ‘classic’ with duck, pork liver and marinated egg. Always order a deep-fried dough stick to mop up the broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=166%20Kaihe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Fu Yu Da Tong Ya Rou Zhou"
  />
);

export default FuYuDaTongYaRouZhou;
