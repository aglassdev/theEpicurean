...
const MingYueXiaMianXiaheRoad = () => (
  <RestaurantPage
    restaurantName="Ming Yue Xia Mian (Xiahe Road)"
    address="180-101 Xiahe Road, Siming, Xiamen, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+865922028139"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/ming-yue-xia-mian-xiahe-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the old town, this noodle shop with over 20 years of history is always bustling with diners who come for its prawn noodles. Hundreds of prawn heads are used to make the umami-laden broth with orange oil from the tomalley floating on top. Grated garlic adds depth and aromas. In addition to shelled prawns, the noodles are topped with prawn balls, lean pork, char siu, pork intestine and bean sprouts. The prawn ball soup is also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=180-101%20Xiahe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Ming Yue Xia Mian (Xiahe Road)"
  />
);

export default MingYueXiaMianXiaheRoad;
