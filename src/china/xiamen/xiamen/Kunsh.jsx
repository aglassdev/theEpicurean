...
const Kunsh = () => (
  <RestaurantPage
    restaurantName="Kunshō"
    address="Shop 213, 2F, Paragon, 1 Lianhua North Road, Siming, Xiamen, China Mainland"
    cuisine="Innovative"
    priceRange="¥¥¥¥"
    phoneNumber="+8617850518887"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/kunsho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is Argentinian chef Agustin Balbi's first joint venture in Fujian. With a clever play on light and shadow, the space melds the modern and the classic. His tasting menu is an ensemble of ingenious creations made with quality local ingredients and underpinned by European and Japanese techniques. Tuna tartare with garlic mayo, paprika foam and puffed rice is topped with 10-year-old caviar. His hearty signature caldoso rice is a homage to his grandma...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20213%2C%202F%2C%20Paragon%2C%201%20Lianhua%20North%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Kunshō"
  />
);

export default Kunsh;
