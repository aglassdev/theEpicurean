...
const FleursEtFestin = () => (
  <RestaurantPage
    restaurantName="Fleurs Et Festin"
    address="16 Liaohua Road, Siming, Xiamen, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥"
    phoneNumber="+865926080068"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/fleurs-et-festin"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A three-storey historic building is home to this Chaoshan restaurant. The ground floor sports several tables, while private rooms on the upper floors require a minimum spend. The kitchen team of Chaoshan natives excels in authentic dishes made with fresh produce. Braised goose web in spiced marinade is flavoursome and gelatinous in texture and the local green lobster with taro-scented wax gourd hits the spot every time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Liaohua%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Fleurs Et Festin"
  />
);

export default FleursEtFestin;
