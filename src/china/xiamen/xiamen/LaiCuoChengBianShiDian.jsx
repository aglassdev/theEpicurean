...
const LaiCuoChengBianShiDian = () => (
  <RestaurantPage
    restaurantName="Lai Cuo Cheng Bian Shi Dian"
    address="8 Dayuan Road, Siming, Xiamen, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+865922053368"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/lai-cuo-cheng-bian-shi-dian"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Dayuan%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Lai Cuo Cheng Bian Shi Dian"
  />
);

export default LaiCuoChengBianShiDian;
