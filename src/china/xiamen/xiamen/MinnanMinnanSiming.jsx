...
const MinnanMinnanSiming = () => (
  <RestaurantPage
    restaurantName="Minnan Minnan (Siming)"
    address="Shop 328, 3F, The Mixc, 99 Hubin East Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+865922177789"
    website="http://www.lvdaohotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened by a restaurant group based in the city of Shishi some 30 years ago, this branch has stood the test of time. The kitchen team, trained in the Shishi flagship, is overseen by a Minnan master chef. The interesting menu includes a host of Minnan classics, plus regional small bites. Watch the chefs making the signature scallion buns behind a glass partition. The mackerel fish ball soup with pork tripe and pickled mustard greens is also a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20328%2C%203F%2C%20The%20Mixc%2C%2099%20Hubin%20East%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Minnan Minnan (Siming)"
  />
);

export default MinnanMinnanSiming;
