...
const YanyuJiaheRoad = () => (
  <RestaurantPage
    restaurantName="Yanyu (Jiahe Road)"
    address="2F, Building A, Xinjing Center, 21 Jiahe Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+865928066917"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/yanyu-jiahe-road"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="For 10-plus years, this flagship establishment has been packed with loyal patrons. The modern stylish interior showcases top-notch dried seafood which is used in the famous Fujian Buddha jumps over the wall dish, but you can also enjoy other first-rate dishes without breaking the bank. Try Minnan prawn noodles in orange coloured tomalley soup or made to order black mochi packed with black sesame aroma. The seasonal menu is also worth exploring...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Building%20A%2C%20Xinjing%20Center%2C%2021%20Jiahe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Yanyu (Jiahe Road)"
  />
);

export default YanyuJiaheRoad;
