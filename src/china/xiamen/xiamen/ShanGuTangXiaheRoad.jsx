...
const ShanGuTangXiaheRoad = () => (
  <RestaurantPage
    restaurantName="Shan Gu Tang"
    address="386-119 Xiahe Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥"
    phoneNumber="+865928818111"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/shan-gu-tang"
    aliases={["Shan Gu Tang (Xiahe Road)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its bright red sign may be hard to miss but it's the lingering herbal aromas that draw in customers from near and far. The owner used to run a Chinese clinic and opened Shan Gu Tang to serve food with medicinal value. The small menu is dominated by herbal soups, alongside blanched items, marinated meats and seasoned taro rice. Try the free-range chicken soup with russula mushrooms, or pork intestine soup with lotus seeds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=386-119%20Xiahe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Shan Gu Tang"
  />
);

export default ShanGuTangXiaheRoad;
