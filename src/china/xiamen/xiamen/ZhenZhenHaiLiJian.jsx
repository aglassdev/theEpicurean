...
const ZhenZhenHaiLiJian = () => (
  <RestaurantPage
    restaurantName="Zhen Zhen Hai Li Jian"
    address="184 Xiahe Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥"
    phoneNumber="+8615305022290"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/zhen-zhen-hai-li-jian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zhen Zhen runs the whole place alone: she's the owner, server and chef. She's picky about seafood, having it delivered a few times daily to ensure freshness. The well-made dishes at bargain prices have secured a loyal fan base. The menu comprises 20 items, mostly small plates, such as braised pork rice, and shrimp ball soup. Her oyster omelette is packed with plump oysters and garlic sprouts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=184%20Xiahe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Zhen Zhen Hai Li Jian"
  />
);

export default ZhenZhenHaiLiJian;
