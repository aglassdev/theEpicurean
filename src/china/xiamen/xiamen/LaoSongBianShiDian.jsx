...
const LaoSongBianShiDian = () => (
  <RestaurantPage
    restaurantName="Lao Song Bian Shi Dian"
    address="202-101 Xiahe Road, Siming, Xiamen, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+865922988692"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/lao-song-bian-shi-dian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This spot, a household name in Xiaman, has been serving mini pork wontons – bian shi – for over 30 years. Generations of Xiamenese have grown up eating their wonton soup, blanched noodles tossed in peanut sauce, as well as hand-shredded pork with the tendon attached. For the signature bian shi, choose between the regular flour wrapper and the minced pork and starch variety. The former is soft and velvety, the latter bouncy and translucent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=202-101%20Xiahe%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Lao Song Bian Shi Dian"
  />
);

export default LaoSongBianShiDian;
