...
const ChenXianSenShaChaMian = () => (
  <RestaurantPage
    restaurantName="Chen Xian Sen Sha Cha Mian"
    address="131-3 Jiageng Road, Jimei, Xiamen, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613599519699"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/chen-xian-sen-sha-cha-mian"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=131-3%20Jiageng%20Road%2C%20Jimei%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Chen Xian Sen Sha Cha Mian"
  />
);

export default ChenXianSenShaChaMian;
