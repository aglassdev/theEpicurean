...
const YueHuaShaChaMian = () => (
  <RestaurantPage
    restaurantName="Yue Hua Sha Cha Mian"
    address="78 Zhenbang Road, Siming, Xiamen, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+865922984332"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/yue-hua-sha-cha-mian"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=78%20Zhenbang%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Yue Hua Sha Cha Mian"
  />
);

export default YueHuaShaChaMian;
