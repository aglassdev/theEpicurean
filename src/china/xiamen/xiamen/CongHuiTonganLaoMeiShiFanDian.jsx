...
const CongHuiTonganLaoMeiShiFanDian = () => (
  <RestaurantPage
    restaurantName="Cong Hui Tongan Lao Mei Shi Fan Dian"
    address="3-102 Dayuan Road, Siming, Xiamen, China Mainland"
    cuisine="Fujian"
    priceRange="¥"
    phoneNumber="+865922912731"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/cong-hui-tongan-lao-mei-shi-fan-dian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the third address of the household name since it opened in 1999. It has built a loyal following thanks to its authentic Tong'an home-style cooking. The flavoursome, melt-in-the-mouth Tong'an braised pork belly exudes aromas of garlic, dried shrimps, shiitake, chestnuts and lotus seeds. The pork kidney dressed in coriander sauce boasts a crisp, springy texture. You can order à la carte, or the set menus cater to your party size flexibly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-102%20Dayuan%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="Cong Hui Tongan Lao Mei Shi Fan Dian"
  />
);

export default CongHuiTonganLaoMeiShiFanDian;
