...
const AXiXiaMian = () => (
  <RestaurantPage
    restaurantName="A Xi Xia Mian"
    address="11 Dayuan Road, Siming, Xiamen, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613950059774"
    website="https://guide.michelin.com/en/fujian-province/xiamen_1031934/restaurant/a-xi-xia-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For almost a century, this shop in the old town has been making prawn noodles the traditional way. The broth derives deep umami from the shells and heads of whiskered velvet shrimps, which are toasted, pounded and slow cooked for 4 hours. Order extra toppings to make it a feast. Their giant fish ball soup is equally stunning – a fist-sized fish ball made with white eel and stuffed with juicy pork filling is served in a milky pork bone broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20Dayuan%20Road%2C%20Siming%2C%20Xiamen%2C%20China%20Mainland"
    pageTitle="A Xi Xia Mian"
  />
);

export default AXiXiaMian;
