...
const ChaoShangChaoChaoyang = () => (
  <RestaurantPage
    restaurantName="Chao Shang Chao (Chaoyang)"
    address="L406B, 4F, CP Center, 20 Jinhe East Road, Chaoyang, Beijing, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+861085962666"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/chao-shang-chao"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Upon arrival at this upmarket restaurant, diners step into a hallway lined with steeply priced dried fish maws. With years of experience in Hong Kong and Shanghai, Chef Cheung has revamped the menu with his new takes on Chaozhou classics – dishes such as braised eel wrapped in lotus leaf with dried tangerine peel and plum sauce show precision and finesse. Besides the vast wine list, the tea menu also brims with options that will tickle your fancy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L406B%2C%204F%2C%20CP%20Center%2C%2020%20Jinhe%20East%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Chao Shang Chao (Chaoyang)"
  />
);

export default ChaoShangChaoChaoyang;
