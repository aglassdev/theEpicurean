...
const FuChunJu = () => (
  <RestaurantPage
    restaurantName="Fu Chun Ju"
    address="3F, The Puxuan Hotel, 1 Wangfujing Street, Dongcheng, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861052806418"
    website="https://thepuxuan.com/en/beijing-wangfujing-luxury-hotel-dining/cantonese-cuisine-fu-chun-ju-restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Designed by the German architect Ole Scheeren, this dining room seamlessly blends pared-down modernism with hutong tradition. Imagine circular booths that create an array of semi-private spaces. The experienced head chef from Hong Kong showcases his solid and astute skills in signature dishes like the roast pigeon. The revamped menu includes many items that are available in individual portion sizes, so diners may sample the length and breadth of his repertoire...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20The%20Puxuan%20Hotel%2C%201%20Wangfujing%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Fu Chun Ju"
  />
);

export default FuChunJu;
