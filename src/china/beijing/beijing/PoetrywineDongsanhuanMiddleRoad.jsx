...
const PoetrywineDongsanhuanMiddleRoad = () => (
  <RestaurantPage
    restaurantName="Poetry‧Wine (Dongsanhuan Middle Road)"
    address="61 Dongsanhuan Middle Road, Chaoyang, Beijing, China Mainland"
    cuisine="Beijing Cuisine"
    priceRange="¥¥"
    phoneNumber="+861087774188"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/poetry%E2%80%A7wine"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The bamboo bush, jade ornaments, ink paintings and cut flowers may prime your brain for a hefty price tag, but a meal in this modern restaurant doesn’t break the bank. Its signature braised fish head is juicy and tender, nicely braised in an aromatic brown sauce. Roast duck uses 40-day-old birds that are chargrilled to perfection and plated gorgeously. Always save room for the creamed yam and osmanthus sweet soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=61%20Dongsanhuan%20Middle%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Poetry‧Wine (Dongsanhuan Middle Road)"
  />
);

export default PoetrywineDongsanhuanMiddleRoad;
