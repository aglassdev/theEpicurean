...
const BaoBaoHao = () => (
  <RestaurantPage
    restaurantName="Bao Bao Hao"
    address="Building 12A, Chaoyangmen North Street, Chaoyang, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+861085637848"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/bao-bao-hao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dome awnings, faux stained glass and vintage photos conjure up the golden age of Xiguan, Guangzhou's former trading hub. Since 2000, the place has been jam-packed with diners coming for its famous sizzling claypot dishes. All ingredients are seared to order in claypots over scorching heat to achieve smoky wok hei. With its juicy, flavoursome meat and intoxicating aromas, the sand ginger chicken is a particular standout...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%2012A%2C%20Chaoyangmen%20North%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Bao Bao Hao"
  />
);

export default BaoBaoHao;
