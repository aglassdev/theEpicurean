...
const BistroStrongChaoyanggongyuanRoad = () => (
  <RestaurantPage
    restaurantName="Bistro Strong (Chaoyanggongyuan Road)"
    address="M175, SOLANA, 6 Chaoyanggongyuan Road, Chaoyang, Beijing, China Mainland"
    cuisine="Meats and Grills"
    priceRange="¥¥"
    phoneNumber="+8618610953870"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/bistro-strong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bistro specialising in lamb dishes has a small menu featuring different cuts from Mongolia, all aged in the house. Here, lamb is prepared in a myriad of ways: mini lamb pie is made with porcini, truffle oil and parmesan in a vol-au-vent, while lamb skewer uses dry-aged hind leg meat alternated with fat. You may even order a lamb chop on the barbecue. Signature cocktails that call for air-dried lamb or lamb ricotta are also ingenious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M175%2C%20SOLANA%2C%206%20Chaoyanggongyuan%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Bistro Strong (Chaoyanggongyuan Road)"
  />
);

export default BistroStrongChaoyanggongyuanRoad;
