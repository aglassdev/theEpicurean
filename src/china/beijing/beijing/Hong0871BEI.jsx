...
const Hong0871BEI = () => (
  <RestaurantPage
    restaurantName="Hong 0871"
    address="Building 6, E9 Zone Innovation Works, Shuangshu North Road, Chaoyang, Beijing, China Mainland"
    cuisine="Yunnanese"
    priceRange="¥¥"
    phoneNumber="+861065724306"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/hong-0871-1203720"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in an industrial park, Hong 0871 is a bit out of the way. But that doesn’t stop gastronomes from making a trip there for their refined Yunnanese food deeply rooted in traditions but updated with creative twists. Most ingredients are shipped from Yunnan and the menu changes regularly. But try stewed pig skin with red bean and preserved vegetable when it’s available: gelatinous pig skin soaking up the flavourful sauces is truly decadent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%206%2C%20E9%20Zone%20Innovation%20Works%2C%20Shuangshu%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Hong 0871"
  />
);

export default Hong0871BEI;
