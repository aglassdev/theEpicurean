...
const TanBEI = () => (
  <RestaurantPage
    restaurantName="Tan"
    address="Building E1, Langyuan Station, 53 Banjieta Road, Chaoyang, Beijing, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+8615701037418"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/tan-1218718"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%20E1%2C%20Langyuan%20Station%2C%2053%20Banjieta%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Tan"
  />
);

export default TanBEI;
