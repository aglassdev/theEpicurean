...
const QuLangYuan = () => (
  <RestaurantPage
    restaurantName="Qu Lang Yuan"
    address="25 Dongsi 11th Alley, Dongcheng, Beijing, China Mainland"
    cuisine="Innovative"
    priceRange="¥¥¥"
    phoneNumber="+861084038229"
    website="https://www.qulangyuan.cn"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Dongsi%2011th%20Alley%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Qu Lang Yuan"
  />
);

export default QuLangYuan;
