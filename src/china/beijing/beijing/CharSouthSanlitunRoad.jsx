...
const CharSouthSanlitunRoad = () => (
  <RestaurantPage
    restaurantName="Char (South Sanlitun Road)"
    address="3F, InterContinental Sanlitun Hotel, Topwin Mall, 1 South Sanlitun Road, Chaoyang, Beijing, China Mainland"
    cuisine="Steakhouse"
    priceRange="¥¥¥"
    phoneNumber="+861085160065"
    website="https://www.ihg.com/intercontinental/hotels/gb/en/beijing/peghe/hoteldetail/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After passing through a red neon tunnel, diners are greeted by a copper cow sculpture that sets the scene for a beef-focused feast against panoramic views of the bustling Sanlitun area. Larger steak cuts for sharing, such as David Blackmore’s Australian Wagyu, Porterhouse and Tomahawk steaks, are portioned on individual plates tableside. The signature array of salt and mustard is equally impressive. Ask for a table on the terrace for the ultimate alfresco experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20InterContinental%20Sanlitun%20Hotel%2C%20Topwin%20Mall%2C%201%20South%20Sanlitun%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Char (South Sanlitun Road)"
  />
);

export default CharSouthSanlitunRoad;
