...
const Lamdre = () => (
  <RestaurantPage
    restaurantName="Lamdre"
    address="Room 04, 1F, Block 14, Courtyard 4, Gongti North Road, Chaoyang, Beijing, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥¥¥"
    phoneNumber="+861085978888"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/lamdre"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A pitched roof skylight illuminates the main room naturally; the private rooms and balcony also feel cosy. Chef Dai, former head chef of a renowned vegetarian restaurant, serves a season-driven tasting menu. His famous tofu is steeped in a matsutake and wakame broth and seasoned with soy sauce house-brewed with rice, kombu, honey and shiitake. Choose between the two wine pairing options with natural, organic, sustainable and biodynamic varieties...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Room%2004%2C%201F%2C%20Block%2014%2C%20Courtyard%204%2C%20Gongti%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Lamdre"
  />
);

export default Lamdre;
