...
const BadAssLambHotPotMaizidianWestStreet = () => (
  <RestaurantPage
    restaurantName="Bad Ass Lamb Hot Pot (Maizidian West Street)"
    address="39 Maizidian West Street, Chaoyang, Beijing, China Mainland"
    cuisine="Hotpot"
    priceRange="¥¥"
    phoneNumber="+861065006268"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/bad-ass-lamb-hot-pot-maizidian-west-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant offers a smorgasbord of 15 cuts of lamb, and despite its name, dishes offered here are anything but bad. While you may see hand-sliced lamb on almost every table, lamb shin tastes less greasy and more velvety after being swished for seconds in a broth of your choice. The blanched head is also a nice surprise with thin slices of juicy meat seasoned with cumin. Malabar spinach and kelp are delicious and provide a healthy dose of dietary fibre...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Maizidian%20West%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Bad Ass Lamb Hot Pot (Maizidian West Street)"
  />
);

export default BadAssLambHotPotMaizidianWestStreet;
