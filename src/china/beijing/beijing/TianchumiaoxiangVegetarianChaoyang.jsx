...
const TianchumiaoxiangVegetarianChaoyang = () => (
  <RestaurantPage
    restaurantName="Tianchumiaoxiang Vegetarian (Chaoyang)"
    address="0260, Section D, 2F, Chaowai SOHO, Chaowai Street, Chaoyang, Beijing, 100020, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥"
    phoneNumber="+861059001088"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/tianchumiaoxiang-vegetarian-chaoyang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After converting to veganism and going on to become a monk, the founder of this chain experienced improvements to his life. This inspired him to serve tasty vegetarian dishes eschewing eggs, alcohol and alliums in his restaurants. In the Kung Pao monkey head mushroom, the meat-like texture is harnessed in sweet and sour sauce with peanuts and bamboo shoots. No wonder it has been the restaurant's signature dish since the flagship opened in 2003!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=0260%2C%20Section%20D%2C%202F%2C%20Chaowai%20SOHO%2C%20Chaowai%20Street%2C%20Chaoyang%2C%20Beijing%2C%20100020%2C%20China%20Mainland"
    pageTitle="Tianchumiaoxiang Vegetarian (Chaoyang)"
  />
);

export default TianchumiaoxiangVegetarianChaoyang;
