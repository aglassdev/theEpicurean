...
const MaisonFlo = () => (
  <RestaurantPage
    restaurantName="Maison Flo"
    address="18 Xiaoyun Road, Chaoyang, Beijing, China Mainland"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+861065955135"
    website="https://www.flo.cn/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s out of the way and you need a taxi to get here. But when you see the vast patio and grand dining room styled after the archetypal Parisian brasserie circa 1900s, its suburban address will make sense instantly. On the menu, French classics take precedence – escargots, steak tartare, confit de canard, baba au rhum – though their seafood platter is also popular. Charming table service makes dishes like côte de bœuf and crêpes Suzette stand out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Xiaoyun%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Maison Flo"
  />
);

export default MaisonFlo;
