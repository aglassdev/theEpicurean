...
const LBodhiGuanghuaRoad = () => (
  <RestaurantPage
    restaurantName="L. Bodhi (Guanghua Road)"
    address="No. 202, Building F, Sunshine 100 International Department, 2 Guanghua Road, Chaoyang, Beijing, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥¥¥"
    phoneNumber="+8613552686209"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/l-bodhi-guanghua-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This branch of the chain restaurant serves three different nine-course vegan sets at various price points. Emphasising holistic well-being, both physical and emotional, the mindfully designed sets cover amuse-bouches, appetisers, hot mains, hot pot, salad, staple starch and dessert. No sign of greasy or heavily processed food here! Instead, organic produce is treated with a light touch so the natural flavours shine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20202%2C%20Building%20F%2C%20Sunshine%20100%20International%20Department%2C%202%20Guanghua%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="L. Bodhi (Guanghua Road)"
  />
);

export default LBodhiGuanghuaRoad;
