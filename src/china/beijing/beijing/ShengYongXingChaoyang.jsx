...
const ShengYongXingChaoyang = () => (
  <RestaurantPage
    restaurantName="Sheng Yong Xing (Chaoyang)"
    address="5 Xindong Road, Chaoyang, Beijing, China Mainland"
    cuisine="Beijing Cuisine"
    priceRange="¥¥¥"
    phoneNumber="+861064640968"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/sheng-yong-xing-chaoyang"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It’s all about the signature roast duck here; yours will even come with a ‘birth certificate’ proving it is 45 days old. Grilled in a stone oven over jujube wood, it boasts crispy skin and delicious, juicy meat; order caviar to go with it if you fancy a splurge. Other dishes include sautéed springy prawns from Bohai Sea with shrimp roe, which are packed in serious umami. Also check out the very reasonably priced wine list. The restaurant boasts a bright, open feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Xindong%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Sheng Yong Xing (Chaoyang)"
  />
);

export default ShengYongXingChaoyang;
