...
const LeiGardenJinbaoTower = () => (
  <RestaurantPage
    restaurantName="Lei Garden (Jinbao Tower)"
    address="3F, Jinbao Tower, 89 Jinbao Street, Dongcheng, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861085221212"
    website="https://leigarden.hk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Lei Garden hails from Hong Kong and specialises in traditional Cantonese fare. The décor feels festive and joyous. Most ingredients are sourced from their own farm to ensure quality and freshness. The signature roasted pork belly boasts alternate layers of fat and meat, with crispy skin and juicy flesh. Slow-cooked and double-boiled soups are also recommended. Sago and pomelo in mango purée is the perfect end to the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Jinbao%20Tower%2C%2089%20Jinbao%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Lei Garden (Jinbao Tower)"
  />
);

export default LeiGardenJinbaoTower;
