...
const JiaChaoyang = () => (
  <RestaurantPage
    restaurantName="Jia (Chaoyang)"
    address="1F, Nuo Hotel, 2A Jiangtai Road, Chaoyang, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861059268281"
    website="https://www.nuohotel.com/en/beijing/beijing-jiangtai/restaurants/jia/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chandeliers add visual appeal to the high-ceilinged room with ink murals and carved wood windows. The menu is predominantly Cantonese, borrowing occasionally from other provinces. The Cantonese kitchen team delivers authentic flavours in signatures such as sautéed grouper fillet with green chilli and wild rice stems. The slow-boiled soup menu on daily rotation is also worth checking out. At lunchtime, try the tofu skin roll with shrimp filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Nuo%20Hotel%2C%202A%20Jiangtai%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Jia (Chaoyang)"
  />
);

export default JiaChaoyang;
