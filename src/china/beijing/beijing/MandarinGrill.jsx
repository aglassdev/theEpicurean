...
const MandarinGrill = () => (
  <RestaurantPage
    restaurantName="Mandarin Grill"
    address="5F, Mandarin Oriental Wangfujing, 269 Wangfujing Street, Dongcheng, Beijing, China Mainland"
    cuisine="Meats and Grills"
    priceRange="¥¥¥¥"
    phoneNumber="+861085098810"
    website="https://www.mandarinoriental.com/en/beijing/wangfujing/dine/mandarin-grill"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The beautiful dining room mimics a ‘brasserie de luxe’ of yesteryear. Tufted leather banquettes, polished wood details and crisp white linen promise a marvellous meal; consistently impeccable service is yet another highlight of the space. Choose from the classic grill menu with steaks from U.S. and Australia. An apéritif or digestif on the terrace that affords unrivalled views of the Forbidden City’s skyline and eaves makes for a wonderful experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Mandarin%20Oriental%20Wangfujing%2C%20269%20Wangfujing%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Mandarin Grill"
  />
);

export default MandarinGrill;
