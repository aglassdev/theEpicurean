...
const PangMeiNoodlesXiangerHutong = () => (
  <RestaurantPage
    restaurantName="Pang Mei Noodles (Xiang'er Hutong)"
    address="Xiang'er Hutong, 69 Dongsi North Street, Dongcheng, Beijing, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8615801504172"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/pang-mei-noodles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Beijing, this is the first outlet of the popular brand specialising in Chongqing-style noodles and snacks. The fiery beef noodle soup is the signature here – choose between two sizes and four levels of spiciness. Deep-fried pork with mint leaves and pork brain in ma la sauce are also recommended. Round it out with ice jelly and rice balls in brown sugar syrup to soothe the burn. Reservations are not accepted, so expect a long wait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Xiang'er%20Hutong%2C%2069%20Dongsi%20North%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Pang Mei Noodles (Xiang'er Hutong)"
  />
);

export default PangMeiNoodlesXiangerHutong;
