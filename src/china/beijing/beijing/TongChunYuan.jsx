...
const TongChunYuan = () => (
  <RestaurantPage
    restaurantName="Tong Chun Yuan"
    address="Shiyue Building, 14A Xinjiekouwai Street, Xicheng, Beijing, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥"
    phoneNumber="+861062003502"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/tong-chun-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in 1930, this state-owned restaurant specialises in Jiangzhe cooking, especially river fish cooked in myriad ways. Diners pick their own catch from the huge live fish tanks. The menu also features roast duck and regional cuisines. The Zhenjiang pork trotter aspic has the perfect ratio of fatty and lean meat; the stir-fried swamp eel in brown sauce is flavoursome and velvety. Reservations are only accepted for bookings before noon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shiyue%20Building%2C%2014A%20Xinjiekouwai%20Street%2C%20Xicheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Tong Chun Yuan"
  />
);

export default TongChunYuan;
