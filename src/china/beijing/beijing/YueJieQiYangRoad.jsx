...
const YueJieQiYangRoad = () => (
  <RestaurantPage
    restaurantName="Yue Jie (Qi Yang Road)"
    address="Shop 204, 2F, Radiance Edifice, 2 Qiyang Road, Chaoyang, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861064398088"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/yue-jie-qi-yang-road"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20204%2C%202F%2C%20Radiance%20Edifice%2C%202%20Qiyang%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Yue Jie (Qi Yang Road)"
  />
);

export default YueJieQiYangRoad;
