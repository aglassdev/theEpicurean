...
const Nishiki = () => (
  <RestaurantPage
    restaurantName="Nishiki"
    address="L303, 3F, CP Center, 20 Jinhe East Road, Chaoyang, Beijing, China Mainland"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+8665006676"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/nishiki-1203710"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After the success of Andō in Hong Kong, Argentinian chef Agustin Balbi took up the role of consultant for Nishiki. The season-driven menu is essentially Japanese with hints of European influences. The four set menus feature 10-plus courses made with the freshest catch and top-tier produce from around the world. Wine pairings are available, sometimes with rare finds. Besides private rooms of various sizes, the six counter seats are much sought after...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L303%2C%203F%2C%20CP%20Center%2C%2020%20Jinhe%20East%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Nishiki"
  />
);
