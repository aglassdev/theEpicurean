...
const LuShangLu = () => (
  <RestaurantPage
    restaurantName="Lu Shang Lu"
    address="2A01-2A03 / 2A05-2A13, 2F, Sunshine Financial Center, No.1 Tower, 33 Jinghui Street, Chaoyang, Beijing, China Mainland"
    cuisine="Shandong"
    priceRange="¥¥¥¥"
    phoneNumber="+861087185556"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/lu-shang-lu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Shandong cooking is the speciality here, especially Confucius cuisine, with sea cucumber and live seafood shipped daily from Jiaodong peninsula. The chef from Yantai knows the food from his home province inside out and is clearly proud to serve his specialities. Try his roast 45-day-old duck served with caviar, prawn crackers and Shandong pancakes, combining the characteristics of both Beijingese and Shandong cooking. The room is bright and airy, but also consider booking a room for more privacy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2A01-2A03%20%2F%202A05-2A13%2C%202F%2C%20Sunshine%20Financial%20Center%2C%20No.1%20Tower%2C%2033%20Jinghui%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Lu Shang Lu"
  />
);

export default LuShangLu;
