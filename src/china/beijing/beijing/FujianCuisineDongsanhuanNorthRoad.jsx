...
const FujianCuisineDongsanhuanNorthRoad = () => (
  <RestaurantPage
    restaurantName="Fujian Cuisine (Dongsanhuan North Road)"
    address="110-111, Kaidexingmao, 26A Dongsanhuan North Road, Chaoyang, Beijing, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8618513040592"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/fujian-cuisine-dongsanhuan-north-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner and chefs who hail from Xiamen insist on using produce and seafood from their home province to create authentic Fujian dishes, especially country recipes that were the staple diet of the commoners in olden days. Steamed red crab on sticky rice seduces with seafood umami and briny-sweet roe, while the ginger duck is an heirloom recipe passed down for generations, made with Muscovy duck for exceptional depth. Also try the creamy mashed taro dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=110-111%2C%20Kaidexingmao%2C%2026A%20Dongsanhuan%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Fujian Cuisine (Dongsanhuan North Road)"
  />
);

export default FujianCuisineDongsanhuanNorthRoad;
