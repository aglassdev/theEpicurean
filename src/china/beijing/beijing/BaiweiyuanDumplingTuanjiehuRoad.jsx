...
const BaiweiyuanDumplingTuanjiehuRoad = () => (
  <RestaurantPage
    restaurantName="Baiweiyuan Dumpling"
    address="52 Tuanjiehu Road, Chaoyang, Beijing, China Mainland"
    cuisine="Dumplings"
    priceRange="¥"
    phoneNumber="+8618210039279"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/baiweiyuan-dumpling"
    aliases={["Baiweiyuan Dumpling (Tuanjiehu Road)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over a decade, this shop has been serving dumpling soup, steamed dumplings and potstickers that are stuffed and cooked à la minute – so expect slower service than at your average dumpling joint. Signature Baiwei dumplings come with meat, shrimp and veggie fillings; ovo-vegetarians may opt for the egg-and-tomato variety. Try the cold appetisers such as thinly sliced soy-braised pork trotter with the perfect ratio of skin, fat and lean meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20Tuanjiehu%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Baiweiyuan Dumpling"
  />
);

export default BaiweiyuanDumplingTuanjiehuRoad;
