...
const RongPao = () => (
  <RestaurantPage
    restaurantName="Rong Pao"
    address="2F, The Ritz-Carlton Hotel, 83A Jianguo Road, Chaoyang, Beijing, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+861066166636"
    website="http://www.xinrongji.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This brand under the Xin Rong Ji group specialises in Sichuan fare, in particular cuisine from Yibin, the home city of the chef. He doesn't hold back on the use of fiery chillies and even makes his own cured bacon in-house. River fish and quick-fried dishes are the biggest draw. With its deep fiery heat, the plateau loach hot pot with green Sichuan peppercorns on the vine is a hit. The quick-fried pork liver and kidney is another must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Ritz-Carlton%20Hotel%2C%2083A%20Jianguo%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Rong Pao"
  />
);

export default RongPao;
