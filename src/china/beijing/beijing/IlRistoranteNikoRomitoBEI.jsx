...
const IlRistoranteNikoRomitoBEI = () => (
  <RestaurantPage
    restaurantName="Il Ristorante - Niko Romito"
    address="1F, Bvlgari Hotel, Building 2, Courtyard 8, Xinyuan South Road, Chaoyang, Beijing, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+861085558585"
    website="https://www.bulgarihotels.com/en_US/beijing/dining/il-ristorante-niko-romito"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This dining concept by Milanese chef Niko Romito is the epitome of Italian luxe. Lit by Murano glass chandeliers and clad in marble, warm wood and leather, the high-ceilinged space overlooks a manicured garden. Classic recipes are given a subtle, modern twist that adds sophistication and depth. Start your meal with vitello tonnato – the thinly sliced veal in a tangy tuna sauce is a classic antipasto, reworked to cater to the modern palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Bvlgari%20Hotel%2C%20Building%202%2C%20Courtyard%208%2C%20Xinyuan%20South%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Il Ristorante - Niko Romito"
  />
);

export default IlRistoranteNikoRomitoBEI;
