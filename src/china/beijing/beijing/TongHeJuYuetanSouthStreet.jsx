...
const TongHeJuYuetanSouthStreet = () => (
  <RestaurantPage
    restaurantName="Tong He Ju (Yuetan South Street)"
    address="71A Yuetan South Street, Sanlihe, Xicheng, Beijing, China Mainland"
    cuisine="Shandong"
    priceRange="¥¥"
    phoneNumber="+861068522917"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/tong-he-ju-yuetan-south-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in 1822, Tong He Ju is one of the oldest Shandong restaurants in Beijing and was heralded the first of the ‘Big Eight’ eateries. The signboard itself is a historic relic, featuring handwriting by Emperor Puyi’s younger brother. Specialities such as braised cuttlefish roe in a spicy-sour glaze; cod fillet in distillers grain sauce; and san bu zhan, an egg yolk pudding fried with mung bean flour and sugar, all adhere strictly to old-time recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71A%20Yuetan%20South%20Street%2C%20Sanlihe%2C%20Xicheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Tong He Ju (Yuetan South Street)"
  />
);

export default TongHeJuYuetanSouthStreet;
