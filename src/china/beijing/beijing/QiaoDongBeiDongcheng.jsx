...
const QiaoDongBeiDongcheng = () => (
  <RestaurantPage
    restaurantName="Qiao Dong Bei (Dongcheng)"
    address="No. 01-03, Office Tower C2, Podium, The Malls At Oriental Plaza, 1 East Chang'an Avenue, Dongcheng, Beijing, 100738, China Mainland"
    cuisine="Dongbei"
    priceRange="¥¥"
    phoneNumber="+861053607287"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/qiao-dong-bei"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2001-03%2C%20Office%20Tower%20C2%2C%20Podium%2C%20The%20Malls%20At%20Oriental%20Plaza%2C%201%20East%20Chang'an%20Avenue%2C%20Dongcheng%2C%20Beijing%2C%20100738%2C%20China%20Mainland"
    pageTitle="Qiao Dong Bei (Dongcheng)"
  />
);

export default QiaoDongBeiDongcheng;
