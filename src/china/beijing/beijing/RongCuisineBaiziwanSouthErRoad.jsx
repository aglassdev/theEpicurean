...
const RongCuisineBaiziwanSouthErRoad = () => (
  <RestaurantPage
    restaurantName="Rong Cuisine (Baiziwan South Er Road)"
    address="77 Baiziwan South Er Road, Chaoyang, Beijing, China Mainland"
    cuisine="Taizhou"
    priceRange="¥¥"
    phoneNumber="+861067711725"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/rong-cuisine-baiziwan-south-er-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A budget-friendly spinoff of the decidedly upmarket Xin Rong Ji, this offshoot lets diners enjoy certain premium dishes at a fraction of its flagship’s prices. The open kitchen imparts a bustling, down-to-earth vibe which complements the simple, seafaring-themed room. Unlike other Rong Cuisine siblings, this eatery serves a larger menu with more choices in single servings. In addition to its famous yellow croaker, try sautéed squid with wild rice stems and salted potherb mustard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%20Baiziwan%20South%20Er%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Rong Cuisine (Baiziwan South Er Road)"
  />
);

export default RongCuisineBaiziwanSouthErRoad;
