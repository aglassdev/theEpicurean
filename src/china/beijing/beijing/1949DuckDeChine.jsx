...
const OneNineFourNineDuckDeChine = () => (
  <RestaurantPage
    restaurantName="1949 - Duck de Chine"
    address="98 Jinbao Street, Dongcheng, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861065212221"
    website="https://www.elite-concepts.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you set foot in this courtyard house-turned-restaurant, it’s hard to miss the life-size terracotta soldiers, painted beams and red pillars . All of these decorative elements impart a majestic feel befitting its imperial speciality – Peking duck – served to the banging of a gong. While a crossbreed between Cherry Valley and local white duck is roasting over date wood, tease your appetite with deep-fried king oyster mushrooms and mustard duck web...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=98%20Jinbao%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="1949 - Duck de Chine"
  />
);

export default OneNineFourNineDuckDeChine;
