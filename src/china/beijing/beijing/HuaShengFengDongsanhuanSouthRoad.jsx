...
const HuaShengFengDongsanhuanSouthRoad = () => (
  <RestaurantPage
    restaurantName="Hua Sheng Feng (Dongsanhuan South Road)"
    address="13-3 Dongsanhuan South Road, Chaoyang, Beijing, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥"
    phoneNumber="+861087771008"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/hua-sheng-feng-dongsanhuan-south-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Wenzhou native opened this joint over 10 years ago to serve authentic dishes from his hometown. Without complicated preparations and fancy plating, the food appeals with absolute freshness. Pick your favourite seafood from the live fish tanks by the entrance and ask for the best way to have them cooked. The mud snails in scallion oil taste crisp and velvety; the gingery pork tripe soup with egg omelette hits the spot without being too spicy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13-3%20Dongsanhuan%20South%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Hua Sheng Feng (Dongsanhuan South Road)"
  />
);

export default HuaShengFengDongsanhuanSouthRoad;
