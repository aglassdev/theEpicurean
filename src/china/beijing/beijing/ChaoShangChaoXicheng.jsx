...
const ChaoShangChaoXicheng = () => (
  <RestaurantPage
    restaurantName="Chao Shang Chao (Xicheng)"
    address="Basement Level, Winland IFC, 7 Jinrong Street, Xicheng, Beijing, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+861066091266"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/chao-shang-chao-xicheng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This upmarket Chaozhou restaurant is another gem in the F&B chain. Hailing from Chaozhou, Chef Gu has been cooking professionally for over 30 years. His menu is based on tradition but pervaded by a sense of creativity. The boneless pigeon stuffed with bird's nest in matsutake broth delivers amazing layers of textures. Shaobing flatbread baked in a clay oven and stuffed with pig's trotter meat, coriander, pickles and green pepper is a solid backup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Basement%20Level%2C%20Winland%20IFC%2C%207%20Jinrong%20Street%2C%20Xicheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Chao Shang Chao (Xicheng)"
  />
);

export default ChaoShangChaoXicheng;
