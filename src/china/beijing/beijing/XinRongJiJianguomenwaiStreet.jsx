...
const XinRongJiJianguomenwaiStreet = () => (
  <RestaurantPage
    restaurantName="Xin Rong Ji (Jianguomenwai Street)"
    address="5F, Tower A, Yintai Centre, 2 Jianguomenwai Street, Chaoyang, Beijing, China Mainland"
    cuisine="Taizhou"
    priceRange="¥¥¥"
    phoneNumber="+861085171789"
    website="http://www.xinrongji.cc"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Having started life as a small shop selling seafood dishes, this chain now has branches in most large cities in China. At the heart of the CBD lies its second outpost boasting butler service for diners – reserve a table ahead and pre-order the freshest seafood flown in from Taizhou every day. Besides the famous wild-caught yellow croaker and fried hairtail, also try blanched baby octopus, braised radish slices, and bean noodles in sea anemone soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Tower%20A%2C%20Yintai%20Centre%2C%202%20Jianguomenwai%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Xin Rong Ji (Jianguomenwai Street)"
  />
);

export default XinRongJiJianguomenwaiStreet;
