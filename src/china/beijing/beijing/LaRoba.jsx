...
const LaRoba = () => (
  <RestaurantPage
    restaurantName="La Roba"
    address="Building 7, Zaojun West Lane, Zaojunmiao Road, Haidian, Beijing, China Mainland"
    cuisine="Yunnanese"
    priceRange="¥¥"
    phoneNumber="+861062120281"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/la-roba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner has paid tribute to his ethnic roots by naming his restaurant, La Roba, after a subgroup of the Nuosu tribe in Yunnan. The exotic ethnic flair is manifest on every level from the decor and artwork to the waiters’ outfits and background music. The menu features all Yunnan’s classic dishes, such as the deliciously chewy millefeuille pea flour pancake. The Dali-style fish braised in pickled papaya is tart, fruity and appetising. Expect to queue at peak periods...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%207%2C%20Zaojun%20West%20Lane%2C%20Zaojunmiao%20Road%2C%20Haidian%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="La Roba"
  />
);

export default LaRoba;
