...
const InLoveGongtiEastRoad = () => (
  <RestaurantPage
    restaurantName="In Love (Gongti East Road)"
    address="Next to East 2 Gate, Workers' Sports Complex, Gongrentiyuchang East Road, Chaoyang, Beijing, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥¥"
    phoneNumber="+861053520033"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/in-love-gongti-east-road"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This is a Hunanese restaurant, but its décor easily passes for a modern bistro with sleek furniture and a muted palette, punctuated by lime green banquettes. The same degree of eclecticism is at work on the menu, as the Hunanese chef puts a new spin on the classics. Steamed fish head with pickled chilli duo uses bighead carp shipped daily from Qiandao Lake in Zhejiang. Pre-order this dish alongside others when booking a table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Next%20to%20East%202%20Gate%2C%20Workers'%20Sports%20Complex%2C%20Gongrentiyuchang%20East%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="In Love (Gongti East Road)"
  />
);

export default InLoveGongtiEastRoad;
