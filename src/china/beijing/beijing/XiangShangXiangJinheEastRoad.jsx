...
const XiangShangXiangJinheEastRoad = () => (
  <RestaurantPage
    restaurantName="Xiang Shang Xiang (Jinhe East Road)"
    address="L301A-L302A, 3F, CP Center, 20 Jinhe East Road, Chaoyang, Beijing, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥¥"
    phoneNumber="+861085972666"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/xiang-shang-xiang-jinhe-east-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chain now runs a few establishments in Beijing and Chengdu, but the story started in 2021 at this very first outlet. A veteran with 20-plus years of experience under his belt, Chef Peng revamps the menu every now and then to keep it fresh. He presents a good-value set menu featuring 24 different chilli peppers – heaven for spicy food lovers. The butler, tea master and sommelier go the extra mile to deliver thoughtful, meticulous service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L301A-L302A%2C%203F%2C%20CP%20Center%2C%2020%20Jinhe%20East%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Xiang Shang Xiang (Jinhe East Road)"
  />
);

export default XiangShangXiangJinheEastRoad;
