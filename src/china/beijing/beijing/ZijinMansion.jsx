...
const ZijinMansion = () => (
  <RestaurantPage
    restaurantName="Zijin Mansion"
    address="3F, Waldorf Astoria Hotel, 5-15 Jinyu Hutong, Dongcheng, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861085208989"
    website="https://www.hilton.com/en/hotels/bjswawa-waldorf-astoria-beijing/dining/zijin-mansion/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Though its name means purple and gold, this cosy dining room is clad in hand-embroidered orange fabric on a bird theme. The menu features a fine mix of Cantonese classics and bold creations, thanks to the head chef’s globetrotting background. The must-try goldfish shrimp dumplings taste as good as they look. Lotus root puff pastry with turnip filling is flaky, flavourful and exquisitely crafted. Wine buffs should check out the cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Waldorf%20Astoria%20Hotel%2C%205-15%20Jinyu%20Hutong%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Zijin Mansion"
  />
);

export default ZijinMansion;
