...
const Zhong = () => (
  <RestaurantPage
    restaurantName="Zhong"
    address="37 Gulou West Street, Xicheng, Beijing, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+8613260019619"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/zhong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked inside a converted courtyard house, this tiny gem with seven tables has just a small sign on its door. Chef Zhong from Yangzhou is also your waiter and host. He opened this restaurant in 2020 to showcase his hometown’s delicacies. Try the wine lees-marinated cold appetiser platter with green soybeans, shrimps, duck tongues and abalone – addictively aromatic and refreshing. Sautéed shredded swamp eel boasts a bouncy, velvety texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20Gulou%20West%20Street%2C%20Xicheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Zhong"
  />
);

export default Zhong;
