...
const YanGardenByChefFei = () => (
  <RestaurantPage
    restaurantName="Yan Garden by Chef Fei"
    address="No. 12, Caochang 9th Alley, Dongcheng, Beijing, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+861085928897"
    website="https://www.mandarinoriental.com/en/beijing/qianmen/dine/yan-garden-by-chef-fei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in an alley, this restaurant converted from a historical siheyuan has a restored courtyard where customers can dine under a century-old toon tree. A Chaoshan native, Chef Fei sources the best ingredients from his hometown to turn them into refined culinary gems. The fish maw sautéed tableside with dried shrimps, crabmeat, chopped chillies, dried radish and XO sauce boasts layers of flavours. Try the boneless marinated goose web too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2012%2C%20Caochang%209th%20Alley%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Yan Garden by Chef Fei"
  />
);

export default YanGardenByChefFei;
