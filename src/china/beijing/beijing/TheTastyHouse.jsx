...
const TheTastyHouse = () => (
  <RestaurantPage
    restaurantName="The Tasty House"
    address="Block 21, 4 Gongrentiyuchang North Road, Chaoyang, Beijing, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+8613683114225"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/the-tasty-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in Jing Yard, a tree-lined recreational complex in a converted heritage factory site, this elegant restaurant is a subtle nod to the building's industrial past. Thanks to a skylight on the gable wall and glass doors, the space is flooded with natural light. The large menu is dominated by Jiangnan cuisine, with signature dishes from Guangdong, Chaozhou and Sichuan. Try the crispy Peking duck roasted over jujube wood. There are five private rooms. Be sure to book ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Block%2021%2C%204%20Gongrentiyuchang%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="The Tasty House"
  />
);

export default TheTastyHouse;
