...
const TheBeijingKitchenJianguoRoad = () => (
  <RestaurantPage
    restaurantName="The Beijing Kitchen (Jianguo Road)"
    address="D6007, 6F, SKP Beijing, 87 Jianguo Road, Chaoyang, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+861065307905"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/the-beijing-kitchen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With over 20 years of experience, this owner-chef from Hong Kong samples what his team makes daily to keep improving the quality. While he is most proud of his Cantonese barbecue (crispy deep-fried squab, in particular), double-steamed soups, dim sum, and original creations such as steamed tofu with shrimps and goji leaves also impress. And of course, nothing ends a Cantonese meal better than a serving of sago and pomelo in mango purée...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D6007%2C%206F%2C%20SKP%20Beijing%2C%2087%20Jianguo%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="The Beijing Kitchen (Jianguo Road)"
  />
);

export default TheBeijingKitchenJianguoRoad;
