...
const LesMorilles = () => (
  <RestaurantPage
    restaurantName="Les Morilles"
    address="1F, Sunflower Tower, 37 Maizidian Street, Chaoyang, Beijing, China Mainland"
    cuisine="French Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+861065063110"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/les-morilles"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Sunflower%20Tower%2C%2037%20Maizidian%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Les Morilles"
  />
);

export default LesMorilles;
