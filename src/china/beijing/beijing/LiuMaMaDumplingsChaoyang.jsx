...
const LiuMaMaDumplingsChaoyang = () => (
  <RestaurantPage
    restaurantName="Liu Ma Ma Dumplings (Chaoyang)"
    address="Buidling 3818, 798 Art District, 2 Jiuxianqiao Road, Chaoyang, Beijing, China Mainland"
    cuisine="Dumplings"
    priceRange="¥"
    phoneNumber="+8615953551403"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/liu-ma-ma-dumplings-chaoyang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the entrance is tucked away in an alley, it's hard to miss the giant dumpling held in a pair of chopsticks sticking out of the wall. Through a window, diners can see the chefs making dumplings with house-made wrapping. Those filled with seafood from Jiaodong Peninsula are the most popular – try the Spanish mackerel and chive dumplings packed with juicy, tender filling. Other seasonal fillings include kelp, dried shrimps and shepherd's purse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Buidling%203818%2C%20798%20Art%20District%2C%202%20Jiuxianqiao%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Liu Ma Ma Dumplings (Chaoyang)"
  />
);

export default LiuMaMaDumplingsChaoyang;
