...
const TheHouseOfDynasties = () => (
  <RestaurantPage
    restaurantName="The House of Dynasties"
    address="4F, Rosewood Hotel, Jing Guang Centre, Hujialou, 1 Chaoyangmenwai Street, Chaoyang, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+861065360066"
    website="https://www.rosewoodhotels.com/en/beijing/dining/the-house-of-dynasties"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Inspired by Dream of the Red Chamber, an 18C Chinese novel, the decor embodies that era's charm. With well-honed skills, the Cantonese chef from Zhanjiang reinvents his hometown favourites, presenting specialities such as double-boiled duck and fish maw soup, jackfruit wood roast pork, and jackfruit puff pastry. Zhanjiang-style sautéed lobster is jazzed up by sand ginger and black beans for a deep caramelised flavour and a mild kick...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Rosewood%20Hotel%2C%20Jing%20Guang%20Centre%2C%20Hujialou%2C%201%20Chaoyangmenwai%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="The House of Dynasties"
  />
);

export default TheHouseOfDynasties;
