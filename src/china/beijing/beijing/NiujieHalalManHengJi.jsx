...
const NiujieHalalManHengJi = () => (
  <RestaurantPage
    restaurantName="Niujie Halal Man Heng Ji"
    address="14 Ping'anli West Street, Xicheng, Beijing, China Mainland"
    cuisine="Hotpot"
    priceRange="¥¥"
    phoneNumber="+861066126825"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/niujie-halal-man-heng-ji"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Ping'anli%20West%20Street%2C%20Xicheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Niujie Halal Man Heng Ji"
  />
);

export default NiujieHalalManHengJi;
