...
const ForumBEI = () => (
  <RestaurantPage
    ...
    address="2F, Empark Prime Hotel, 2 Wangfujing Street, Dongcheng, Beijing, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+8615210082027"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/forum-1203613"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Forum has long been an institution of deluxe Cantonese fare in Hong Kong. Its first outpost in Beijing is helmed by Chef Lee who perfected his skills throughout his career of over 30 years. The menu offers many of the same dishes as its Hong Kong flagship, such as sauteed lobster with crab meat and pigeon egg that boasts velvety texture and briny-sweetness. The signature fried rice packs rich wok hei whereas braised abalones are not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Empark%20Prime%20Hotel%2C%202%20Wangfujing%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Forum"
  />
);

export default ForumBEI;
