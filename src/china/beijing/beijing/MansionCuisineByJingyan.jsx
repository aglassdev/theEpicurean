...
const MansionCuisineByJingyan = () => (
  <RestaurantPage
    restaurantName="Mansion Cuisine by Jingyan"
    address="22 Jianchang Hutong, Dongcheng, Beijing, China Mainland"
    cuisine="Beijing Cuisine"
    priceRange="¥¥¥¥"
    phoneNumber="+861086632999"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/jing-yan-by-chef-duan"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The high-ceilinged courtyard mansion was remodelled in 2013 to house this classy restaurant. In a similar vein, traditional Beijing dishes have been given a modern and eclectic makeover. Peking duck is served three ways that feature caviar, black truffle or carved into 108 slices the traditional way, boasting crispy skin and juicy flesh. Most dishes are made to order, some with tableside service. The sea cucumber with Peking style pork sauce is phenomenal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22%20Jianchang%20Hutong%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Mansion Cuisine by Jingyan"
  />
);

export default MansionCuisineByJingyan;
