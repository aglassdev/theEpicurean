...
const FortuneLongBeijingBeanSauceNoodlesEastXinglongStreet = () => (
  <RestaurantPage
    restaurantName="Fortune Long Beijing Bean Sauce Noodles (East Xinglong Street)"
    address="56 East Xinglong Street, Dongcheng, Beijing, 100062, China Mainland"
    cuisine="Beijing Cuisine"
    priceRange="¥"
    phoneNumber="+861067056705"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/fortune-long-beijing-bean-sauce-noodles-east-xinglong-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1994, this restaurant has been synonymous with authentic zhajiangmian. It moved to this three-storey location over ten years ago and is always jam-packed. Once you step in the shop, you can’t miss the two caldrons of rich and flavoursome soybean sauce made fresh every day, to be served on the side with house-made noodles. Beijing snacks such as fried pork balls, and blanched ox tripe in sesame sauce are other solid options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20East%20Xinglong%20Street%2C%20Dongcheng%2C%20Beijing%2C%20100062%2C%20China%20Mainland"
    pageTitle="Fortune Long Beijing Bean Sauce Noodles (East Xinglong Street)"
  />
);

export default FortuneLongBeijingBeanSauceNoodlesEastXinglongStreet;
