...
const HritageEast = () => (
  <RestaurantPage
    restaurantName="Héritage East"
    address="1F, Block 66, 1 Zhongguancun South Street, Haidian, Beijing, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+8615801665010"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/heritage-east"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Exquisite artwork and elaborate wainscoting set the scene for a dining experience that is the epitome of stylish, even down to the hand-painted tableware. The restaurant prefers to customise menus to diners’ tastes ahead of time, but à la carte choices also abound. Top notch ingredients are deftly crafted with spot-on seasoning and outstanding wok hei. During the mushroom season, try the sautéed lurid bolete with wrinkly chillies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Block%2066%2C%201%20Zhongguancun%20South%20Street%2C%20Haidian%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Héritage East"
  />
);

export default HritageEast;
