...
const AmicoBj = () => (
  <RestaurantPage
    restaurantName="Amico BJ"
    address="Shop 109, 1F, Pacific Century Place, 2A Gongrentiyuchang North Road, Chaoyang, Beijing, China Mainland"
    cuisine="European Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+861085306951"
    website="https://amicobj-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Exposed, unfinished flakeboard in an upmarket restaurant? The passionate owner-chef has used the construction material to great effects in this intimate and stylish dining room. Omakase menus offer six to eight creative courses firmly rooted in Italian traditions, but with Japanese twists. The chef’s highly original recipes fare well with precise judgment and astute handling. The eight counter seats are the most prized spots to watch the alchemy unfold...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20109%2C%201F%2C%20Pacific%20Century%20Place%2C%202A%20Gongrentiyuchang%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Amico BJ"
  />
);

export default AmicoBj;
