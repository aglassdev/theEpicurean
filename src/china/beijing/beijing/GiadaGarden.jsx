...
const GiadaGarden = () => (
  <RestaurantPage
    restaurantName="Giada Garden"
    address="3F, China World Hotel, 1 Jianguomenwai Street, Chaoyang, Beijing, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+861065057671"
    website="https://www.shangri-la.com/beijing/chinaworld/dining/restaurants/giada-garden/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In line with the image of the fashion brand, the airy, elegant space exudes feminine sensibility with a pale colour scheme and warm neutrals. For a full-on experience, order the set menu and go for classics like veal Milanese or their house-made pastas. The array of freshly baked Italian bread on offer is also amazing and a wide range of quality Italian wines are available by the glass. Service is formal and precise, but not too uptight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20China%20World%20Hotel%2C%201%20Jianguomenwai%20Street%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Giada Garden"
  />
);

export default GiadaGarden;
