...
const HongFanQieYuyuantanSouthRoad = () => (
  <RestaurantPage
    restaurantName="Hong Fan Qie (Yuyuantan South Road)"
    address="36 Cui Wei South Lane, Yuyuantan South Road, Haidian, Beijing, China Mainland"
    cuisine="Hubei"
    priceRange="¥¥"
    phoneNumber="+861068215512"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/hong-fan-qie-yuyuantan-south-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flagship establishment of the chain has been around for over 30 years. The kitchen team of Hubei natives is picky about its ingredients, most of which are shipped daily from their home province to ensure freshness. The menu changes according to the 24 solar terms in the Chinese calendar and stars the best seasonal produce. Long-snout catfish with tomato boasts silky flesh and a tangy, mildly spicy sauce. Sautéed young lotus seeds are sweet and crispy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20Cui%20Wei%20South%20Lane%2C%20Yuyuantan%20South%20Road%2C%20Haidian%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Hong Fan Qie (Yuyuantan South Road)"
  />
);

export default HongFanQieYuyuantanSouthRoad;
