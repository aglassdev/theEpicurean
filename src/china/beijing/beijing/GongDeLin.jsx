...
const GongDeLin = () => (
  <RestaurantPage
    restaurantName="Gong De Lin"
    address="2 Qianmen East Street, Dongcheng, Beijing, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+861067020867"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/gong-de-lin"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Qianmen%20East%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Gong De Lin"
  />
);

export default GongDeLin;
