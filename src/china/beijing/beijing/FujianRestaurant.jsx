...
const FujianRestaurant = () => (
  <RestaurantPage
    restaurantName="Fujian Restaurant"
    address="6F, Xiamenair Jianianhua Hotel, 16 Lize Road, Fengtai, Beijing, 100073, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+8615313016661"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/fujian-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the décor to the food, this restaurant celebrates Fujian culture. In the absence of a main dining area, diners need to book one of the 13 private rooms and pre-order a set menu. To ensure authenticity, the all-Fujianese kitchen team insists on most ingredients being flown in daily from their home province. Signatures include braised eel with red mushrooms, pork cheek braised with dried squid, and sliced clam blanched in chicken stock...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%20Xiamenair%20Jianianhua%20Hotel%2C%2016%20Lize%20Road%2C%20Fengtai%2C%20Beijing%2C%20100073%2C%20China%20Mainland"
    pageTitle="Fujian Restaurant"
  />
);

export default FujianRestaurant;
