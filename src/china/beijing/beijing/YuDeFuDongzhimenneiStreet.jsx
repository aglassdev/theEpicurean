...
const YuDeFuDongzhimenneiStreet = () => (
  <RestaurantPage
    restaurantName="Yu De Fu (Dongzhimennei Street)"
    address="264 Dongzhimennei Street, Dongcheng, Beijing, China Mainland"
    cuisine="Hotpot"
    priceRange="¥¥"
    phoneNumber="+861084026223"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/yu-de-fu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This owner was once responsible for some of the nation’s most acclaimed banquets and now his protégés run this tiny gem with only six tables. It prides itself on the four special cuts of Mongolian sheep, to be blanched in a copper steamboat heated by red-hot charcoal. Hand-sliced lamb is tender and flavourful, while those averse to mutton may order such rare cuts of beef as the aorta. In addition to hotpot, the menu also flaunts other worthy options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=264%20Dongzhimennei%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Yu De Fu (Dongzhimennei Street)"
  />
);

export default YuDeFuDongzhimenneiStreet;
