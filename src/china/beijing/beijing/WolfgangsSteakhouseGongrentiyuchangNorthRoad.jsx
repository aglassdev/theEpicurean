...
const WolfgangsSteakhouseGongrentiyuchangNorthRoad = () => (
  <RestaurantPage
    restaurantName="Wolfgang's Steakhouse (Gongrentiyuchang North Road)"
    address="1F, Space 8, Pacific Century Place, 2A Gongrentiyuchang North Road, Chaoyang, Beijing, China Mainland"
    cuisine="Steakhouse"
    priceRange="¥¥¥¥"
    phoneNumber="+861065924946"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/wolfgang-s-steakhouse"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This outpost of the namesake institution in New York City is furnished in classic American-style with burgundy leather chairs and dim, warm lighting. The menu and recipes are essentially the same as its Manhattan flagship, where the chefs and manager were trained to ensure the same standard of service across the board. USDA prime Angus steaks are dry-aged for at least 28 days and its signature crab cake will send your palate into overdrive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Space%208%2C%20Pacific%20Century%20Place%2C%202A%20Gongrentiyuchang%20North%20Road%2C%20Chaoyang%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Wolfgang's Steakhouse (Gongrentiyuchang North Road)"
  />
);

export default WolfgangsSteakhouseGongrentiyuchangNorthRoad;
