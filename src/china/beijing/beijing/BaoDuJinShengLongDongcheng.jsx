...
const BaoDuJinShengLongDongcheng = () => (
  <RestaurantPage
    restaurantName="Bao Du Jin Sheng Long (Dongcheng)"
    address="13 Hepingli East Street, Dongcheng, Beijing, China Mainland"
    cuisine="Hotpot"
    priceRange="¥¥"
    phoneNumber="+8613161198656"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/bao-du-jin-sheng-long"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tripe is enjoyed the world over, but not everyone cares about this offal enough to patent a recipe, as the owner here has done. His signature dish, tripe 13 ways, uses four types of beef tripe and nine kinds of lamb tripe (including the most prized cut: lamb's rumen core) served with a secret-recipe dip. Try the charcoal-burning hot pot with eight halal lamb cuts and ask for the half cloud cut with half-fatty meat and a milky aftertaste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20Hepingli%20East%20Street%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="Bao Du Jin Sheng Long (Dongcheng)"
  />
);

export default BaoDuJinShengLongDongcheng;
