...
const No69FangzhuanchangZhajiangmianFangzhuanchangHutong = () => (
  <RestaurantPage
    restaurantName="No. 69 Fangzhuanchang Zhajiangmian (Fangzhuanchang Hutong)"
    address="1 Fangzhuanchang Hutong, Dongcheng, Beijing, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613691150449"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/no-69-fangzhuanchang-zhajiangmian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ordering food at this neighbourhood joint is a no-brainer. There is only one thing on the menu – zhajiangmian. But diners come in hordes from the moment the place opens till it closes. These lovely, chewy noodles are dressed with the exceptionally deep and aromatic soybean pork sauce and topped with condiments such as shredded cucumber, radish and leafy greens. Feel free to garnish with pickled garlic and cumin chilli sauce for extra kick...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Fangzhuanchang%20Hutong%2C%20Dongcheng%2C%20Beijing%2C%20China%20Mainland"
    pageTitle="No. 69 Fangzhuanchang Zhajiangmian (Fangzhuanchang Hutong)"
  />
);

export default No69FangzhuanchangZhajiangmianFangzhuanchangHutong;
