...
const TheGeorg = () => (
  <RestaurantPage
    restaurantName="The Georg"
    address="95 Donghuamen Street, Dongcheng, Beijing, 100006, China Mainland"
    cuisine="European Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+8618618337710"
    website="https://guide.michelin.com/en/beijing-municipality/beijing/restaurant/the-georg"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The three-storey complex with an art gallery, a main dining room and a space for private banquets boasts pristine white walls dotted with artworks and greenery. It serves simple fare like smørrebrød (open sandwiches) for lunch; there is a single tasting menu at dinner. Pickled, smoked and cured ingredients are used aptly to show Nordic influences, without being overpowering. Meat and seafood sourced globally are complemented by seasonal produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=95%20Donghuamen%20Street%2C%20Dongcheng%2C%20Beijing%2C%20100006%2C%20China%20Mainland"
    pageTitle="The Georg"
  />
);

export default TheGeorg;
