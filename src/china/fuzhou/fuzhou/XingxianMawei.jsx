...
const XingxianMawei = () => (
  <RestaurantPage
    restaurantName="Xingxian (Mawei)"
    address="66 Qingzhou Road, Mawei District, Fuzhou, China Mainland"
    cuisine="Seafood"
    priceRange="¥¥"
    phoneNumber="+8659183796868"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/xingxian-mawei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the first restaurant of the chain which opened its doors in 1995. Diners make their choice from live fish tanks, but the restaurant also offers a splendid lineup of traditional Fujian fare. Lychee pork, Fuzhou’s own sweet and sour pork, is half-fatty pork coated in starch, deep-fried till crispy, and tossed in a sweet and sour glaze. Puxian lor mee is prized for its wide range of toppings that deliver layers of flavours and textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20Qingzhou%20Road%2C%20Mawei%20District%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Xingxian (Mawei)"
  />
);

export default XingxianMawei;
