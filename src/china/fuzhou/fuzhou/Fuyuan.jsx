...
const Fuyuan = () => (
  <RestaurantPage
    restaurantName="Fuyuan"
    address="No.40, Huaqiao Xincun, Xierhuan North Road, Gulou, Fuzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659187999999"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/fuyuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pink villa is a private-room-only restaurant specialising in the cuisine of Fuqing City, Fujian, with clear Putian-style culinary influences. Seafood like razor clam and shrimp is the house signature. The crispy Fuqing oyster fritter brims with cabbage, oysters, razor clams and pork. Pickled bamboo shoot gives razor clam soup a kick and the bivalves coated in sweet potato starch stay plump and juicy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.40%2C%20Huaqiao%20Xincun%2C%20Xierhuan%20North%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Fuyuan"
  />
);

export default Fuyuan;
