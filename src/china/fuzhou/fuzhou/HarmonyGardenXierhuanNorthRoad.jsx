...
const HarmonyGardenXierhuanNorthRoad = () => (
  <RestaurantPage
    restaurantName="Harmony Garden (Xierhuan North Road)"
    address="No.32, Huaqiao Xincun, Xierhuan North Road, Gulou, Fuzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659183737867"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/harmony-garden-xierhuan-north-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With nine private rooms in a two-storey villa, Harmony Garden offers warm, friendly service and Fujian cooking with creative twists. The owner used to run a tea leaf business, which explains the antique tea ware and tea leaves on sale. Signatures include stir-fried sliced conch in red yeast rice wine lees, which marries lingering aromas and a crisp texture. Drunken pork ribs are deep-fried before being tossed in a tangy wine vinegar glaze...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.32%2C%20Huaqiao%20Xincun%2C%20Xierhuan%20North%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Harmony Garden (Xierhuan North Road)"
  />
);

export default HarmonyGardenXierhuanNorthRoad;
