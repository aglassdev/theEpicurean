...
const Origin = () => (
  <RestaurantPage
    ...
    address="83 Guanjing Road, Cangshan, Fuzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8615396092856"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/origin-1219033"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestling at the foot of a hill, this historical mansion dates from the Ming Dynasty. The owner restored it in 2018, turning it into a restaurant-cum-gallery space. The chef imbues traditional Fujian recipes with a modern edge. Try his line-caught squid in Sichuan red oil – the squid is tender, but bouncy in texture, and loaded with umami. Private rooms only; book one and order a menu tailored to your budget and taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83%20Guanjing%20Road%2C%20Cangshan%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Origin"
  />
);
