...
const WenruNo9 = () => (
  <RestaurantPage
    restaurantName="Wenru No.9"
    address="56 Wenru Lane, Tonghu Road, Gulou, Fuzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659188567888"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/wenru-no-9"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The restaurant is located in a historic area where many famous scholars lived during the North Song Dynasty. The interior sports original architectural details, while the menu pays homage to traditional Fujian food culture. The head chef has been cooking professionally for over 30 years; his sliced conch in red vinasse sauce accentuates the briny-sweet taste of the sea snail. Hand-pounded rice cake is the perfect companion to any seafood dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20Wenru%20Lane%2C%20Tonghu%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Wenru No.9"
  />
);

export default WenruNo9;
