...
const ShangXing = () => (
  <RestaurantPage
    restaurantName="Shang Xing"
    address="41-3 Beierhuan Middle Road, Gulou, Fuzhou, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥"
    phoneNumber="+8659183282777"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/shang-xing"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This architectural behemoth dripping in charm boasts a striking entrance and a cathedral ceiling in the dining room. A live fish tank showcases the freshest catch shipped from Chaoshan daily. Other fish and produce are displayed over a bed of ice, in wet market style. The Chaoshan chefs pride themselves on authentic recipes like braised meat in a spiced soy marinade. Also try the blanched yellowtail scad served cold with a bean sauce on the side...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=41-3%20Beierhuan%20Middle%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Shang Xing"
  />
);

export default ShangXing;
