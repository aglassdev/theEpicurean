...
const LinYiNenMingPaiZhuXueHua = () => (
  <RestaurantPage
    restaurantName="Lin Yi Nen Ming Pai Zhu Xue Hua"
    address="79-7 Xuejun Road, Taijiang, Fuzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613705938763"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/lin-yi-nen-ming-pai-zhu-xue-hua"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded by Lin Yi Nen over 40 years ago, this no-frills shop has moved many times, but always within the same neighbourhood. Its bestseller is old-time comfort food – pork blood curd soup with noodles or rice vermicelli. The noodles are toothsome and velvety and toppings, like pork offal and pork blood curd, are served in separate dishes. The spongy pork blood curd soaks up the flavoursome clear broth and every bite bursts with umami...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=79-7%20Xuejun%20Road%2C%20Taijiang%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Lin Yi Nen Ming Pai Zhu Xue Hua"
  />
);

export default LinYiNenMingPaiZhuXueHua;
