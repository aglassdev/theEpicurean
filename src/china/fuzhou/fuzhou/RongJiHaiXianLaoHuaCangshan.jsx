...
const RongJiHaiXianLaoHuaCangshan = () => (
  <RestaurantPage
    restaurantName="Rong Ji Hai Xian Lao Hua (Cangshan)"
    address="161 Liaoyuan Road, Cangshan, Fuzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8619996808510"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/rong-ji-hai-xian-lao-hua-cangshan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lao hua, or Fujian-style noodle soup, is usually considered frugal eats. This shop, however, champions a novel lao hua that uses luxury seafood such as live abalone and razor clam. The modern, cosy room is also worlds apart from your average lao hua stall. Just indicate your favourite toppings and noodles to the server. The kitchen team will then cook them to perfection. Also try pork head meat dressed in Sichuan pepper sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=161%20Liaoyuan%20Road%2C%20Cangshan%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Rong Ji Hai Xian Lao Hua (Cangshan)"
  />
);

export default RongJiHaiXianLaoHuaCangshan;
