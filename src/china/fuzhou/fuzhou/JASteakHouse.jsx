...
const JASteakHouse = () => (
  <RestaurantPage
    restaurantName="J & A Steak House"
    address="Shop 48, 1F, Building F, Rong Qiao Bund One, Hengjiang Road, Cangshan, Fuzhou, China Mainland"
    cuisine="Steakhouse"
    priceRange="¥¥¥"
    phoneNumber="+8659183729829"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/j-a-steak-house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Fuzhou native himself, the owner-chef worked in a famous steakhouse in New York for decades before opening his own business. This branch, decorated in a bold, ‘masculine’ style with a touch of class, was opened in 2022. The star of the show is juicy, tender 28-day dry-aged steaks grilled to your preferred doneness. Those dry-aged for 42 days need pre-ordering. You will also find dry-aged sea fish and European fare on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%2048%2C%201F%2C%20Building%20F%2C%20Rong%20Qiao%20Bund%20One%2C%20Hengjiang%20Road%2C%20Cangshan%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="J & A Steak House"
  />
);

export default JASteakHouse;
