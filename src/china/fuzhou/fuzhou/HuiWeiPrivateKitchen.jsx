...
const HuiWeiPrivateKitchen = () => (
  <RestaurantPage
    restaurantName="Hui Wei Private Kitchen"
    address="15-1 Tongjiang Road, Cangshan, Fuzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8618059103610"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/hui-wei-private-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The spacious room has a live fish tank and display fridges at the entrance. The founder hails from Songxi County in northern Fujian, and the menu features specialities and snacks from there. The Lan Gu-style smoked yellow croaker impresses with its delicate flesh and subtle smokiness; chilli sauce further accentuates the umami. The traditional snack radish puff is crispy and golden, creating a stark contrast with the soft, juicy radish chilli filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15-1%20Tongjiang%20Road%2C%20Cangshan%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Hui Wei Private Kitchen"
  />
);

export default HuiWeiPrivateKitchen;
