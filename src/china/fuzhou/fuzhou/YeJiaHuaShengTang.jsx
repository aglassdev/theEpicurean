...
const YeJiaHuaShengTang = () => (
  <RestaurantPage
    restaurantName="Ye Jia Hua Sheng Tang"
    address="51 Shijing Lane, Gulou, Fuzhou, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+8613860638810"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/ye-jia-hua-sheng-tang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny shop in an alley has been around for decades. Without bells and whistles, it has earned a loyal following with its rustic traditional Fuzhou sweets. The concise menu stars a lineup of all-time favourites. Simmered in a claypot for nine hours, the peanut soup is a creamy and nutty delight. Taro paste pleasantly surprises with small chunks of starchy taro which adds to the texture. The lotus root cake and sweet sticky rice are also worth a try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Shijing%20Lane%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Ye Jia Hua Sheng Tang"
  />
);

export default YeJiaHuaShengTang;
