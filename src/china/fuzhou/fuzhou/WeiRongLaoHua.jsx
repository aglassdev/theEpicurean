...
const WeiRongLaoHua = () => (
  <RestaurantPage
    restaurantName="Wei Rong Lao Hua"
    address="26 Fuer Road, Gulou, Fuzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613805060712"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/wei-rong-lao-hua"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the most beloved lao hua noodle shops in Fuzhou, Wei Rong is jam-packed with noodle lovers day and night. Pick your noodles and toppings – the seafood, meats and offal are all fresh and top-notch. The pork broth is loaded with meaty flavours; the best way to enjoy the broth is to dip in a deep-fried dough stick for added crispness. Open from morning till late, this is the place to come for a noodle fix almost any time of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Fuer%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Wei Rong Lao Hua"
  />
);

export default WeiRongLaoHua;
