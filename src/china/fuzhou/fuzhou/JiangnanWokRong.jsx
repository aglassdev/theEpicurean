...
const JiangnanWokRong = () => (
  <RestaurantPage
    restaurantName="Jiangnan Wok ‧ Rong"
    address="2F, Shangri-La Hotel, 9 Xinquan South Road, Gulou, Fuzhou, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥¥"
    phoneNumber="+8659187988888"
    website="https://www.shangri-la.com/fuzhou/shangrila/dining/restaurants/jiangnan-wok-rong/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The interior sports a tasteful green colour scheme with plant motifs and fish scale tiles for a style poised between Jiangnan and Fuzhou. In the same vein, the menu features authentic Huaiyang classics alongside Fujian produce and Minnan twists. Braised yellow croaker ‘lion’s head’ meatball impresses with rich silky texture and deep umami. Consider pre-ordering the ginger eight-treasure duck. Each of the 12 private rooms is equipped with tea serving facilities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Shangri-La%20Hotel%2C%209%20Xinquan%20South%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Jiangnan Wok ‧ Rong"
  />
);

export default JiangnanWokRong;
