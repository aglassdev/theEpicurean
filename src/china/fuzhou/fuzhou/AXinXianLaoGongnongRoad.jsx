...
const AXinXianLaoGongnongRoad = () => (
  <RestaurantPage
    restaurantName="A Xin Xian Lao (Gongnong Road)"
    address="9 Gongnong Road, Cangshan, Fuzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613635232996"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/a-xin-xian-lao-gongnong-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This no-frills shop is famous for lao hua, or Fujian-style noodle soup. First, pick your noodles from the 18 choices, then choose your toppings from dozens of options, ranging from offal and blood curd to oyster and squid. Made fresh daily, their MSG-free pork bone broth boasts depth and umami. Feel free to sprinkle scallion, coriander, pickles and fried garlic on top. Beef brisket fat dressed in a mildly spicy sauce is also a good choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Gongnong%20Road%2C%20Cangshan%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="A Xin Xian Lao (Gongnong Road)"
  />
);

export default AXinXianLaoGongnongRoad;
