...
const GuanZhongWangShiGulou = () => (
  <RestaurantPage
    restaurantName="Guan Zhong Wang Shi"
    address="105, Building 4, Fujian Screen Culture Creative Industry Park, 81 Liuhe Road, Gulou, Fuzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8659183725535"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/guan-zhong-wang-shi"
    aliases={["Guan Zhong Wang Shi (Gulou)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner from Xi’an couldn’t find any restaurant serving authentic cooking from his hometown, so he opened his own! The spartan room is clean and rustic. The kitchen team from Shaanxi deftly pull noodles by hand. The signature biangbiang noodle – there is only one long noodle in a bowl – is toothsome and expertly crafted. The aromatic spiced oil dressing clings nicely to the noodle, while cabbage, bean sprouts and chives provide crisp textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=105%2C%20Building%204%2C%20Fujian%20Screen%20Culture%20Creative%20Industry%20Park%2C%2081%20Liuhe%20Road%2C%20Gulou%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Guan Zhong Wang Shi"
  />
);

export default GuanZhongWangShiGulou;
