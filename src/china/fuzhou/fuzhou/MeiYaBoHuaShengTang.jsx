...
const MeiYaBoHuaShengTang = () => (
  <RestaurantPage
    restaurantName="Mei Ya Bo Hua Sheng Tang"
    address="182 Lao Yaozhou Street, Taijiang, Fuzhou, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+8613705080687"
    website="https://guide.michelin.com/en/fujian-province/fuzhou_1026814/restaurant/mei-ya-bo-hua-sheng-tang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 1937, Grandpa Chen started hawking his sweet peanut soup with a bamboo pole on his shoulder. Today, his grandchildren make the rustic sweets just as he did, but serve them in a neat cosy room at affordable prices. The peanut soup tastes divine, hot or chilled, as melt-in-the-mouth peanuts impart a lingering nuttiness. Taro paste is also well crafted and sports a velvety texture and robust flavour. The toasted sesame topping is to die for…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=182%20Lao%20Yaozhou%20Street%2C%20Taijiang%2C%20Fuzhou%2C%20China%20Mainland"
    pageTitle="Mei Ya Bo Hua Sheng Tang"
  />
);

export default MeiYaBoHuaShengTang;
