...
const YongFuHongkou = () => (
  <RestaurantPage
    restaurantName="Yong Fu (Hongkou)"
    address="56F, East Tower, Raffles City The Bund, 1089 Dongdaming Road, Hongkou, Shanghai, China Mainland"
    cuisine="Ningbo"
    priceRange="¥¥¥¥"
    phoneNumber="+862166867777"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yong-fu-hongkou"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The swanky room overlooking the Pudong skyline and Huangpu River boasts marble walls and exquisite chandeliers. Half of the menu features Ningbo classics, while the other half presents novelty dishes made with ingredients from all over China. Live seafood is shipped daily from Zhejiang Province in the small hours to ensure freshness. Try stir-fried white crabmeat, sautéed cattail with shrimp roe, and sticky rice balls with black sesame filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56F%2C%20East%20Tower%2C%20Raffles%20City%20The%20Bund%2C%201089%20Dongdaming%20Road%2C%20Hongkou%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yong Fu (Hongkou)"
  />
);

export default YongFuHongkou;
