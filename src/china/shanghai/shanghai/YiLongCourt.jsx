...
const YiLongCourt = () => (
  <RestaurantPage
    restaurantName="Yi Long Court"
    address="2F, The Peninsula Hotel, Bund 32, 32 Zhongshan Dong Yi Road, Huangpu, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+862123276742"
    website="https://www.peninsula.com/en/shanghai/hotel-fine-dining/yi-long-court-chinese-restaurant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This flagship restaurant of The Peninsula, though decorated in the style of 1930s Shanghai, serves an unmistakably Cantonese menu with an abundance of excellent choices. The kitchen masters authentic Cantonese flavours underpinned by culinary traditions and classical skills. The Cantonese barbecue never disappoints, and there is a dim sum lunch set for solo diners. The deep-fried pork dumplings entice with a blistered crust and pork-mushroom filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Peninsula%20Hotel%2C%20Bund%2032%2C%2032%20Zhongshan%20Dong%20Yi%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yi Long Court"
  />
);

export default YiLongCourt;
