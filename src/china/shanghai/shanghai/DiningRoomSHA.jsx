...
const DiningRoomSHA = () => (
  <RestaurantPage
    restaurantName="Dining Room"
    address="87F, Park Hyatt, 100 Century Avenue, Pudong, Shanghai, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+862168881234"
    website="https://www.hyatt.com/en-US/hotel/china/park-hyatt-shanghai/shaph"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This high-ceilinged room with full-length windows affords panoramic river views, while the home-style furniture, warm lighting and booth seating make for a cosy feel. On the menu, Jiangzhe classics meet creative recipes that are rarely found elsewhere, such as steamed belt fish with fermented grains. Nicely pleated xiao long bao with umami-loaded soupy filling are simply unmissable – as are the appetisers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=87F%2C%20Park%20Hyatt%2C%20100%20Century%20Avenue%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Dining Room"
  />
);

export default DiningRoomSHA;
