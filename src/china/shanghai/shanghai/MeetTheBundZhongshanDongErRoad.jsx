...
const MeetTheBundZhongshanDongErRoad = () => (
  <RestaurantPage
    restaurantName="Meet the Bund (Zhongshan Dong Er Road)"
    address="S301, 3F, South Mall, The Bund Finance Center, 600 Zhongshan Dong Er Road, Huangpu, Shanghai, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+862163777668"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/meet-the-bund"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Brass ceiling panels and chandeliers lend a touch of nostalgic elegance to the otherwise modern room. For an experience authentic, Fujianese is the mainstay of the menu, with all of the kitchen team hailing from the province. Try the umami-laden duck essence made the traditional way: a whole duck is steamed for hours and the juices collected with no water added. Check out the tea menu, which has a wealth of nice choices from Fujian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=S301%2C%203F%2C%20South%20Mall%2C%20The%20Bund%20Finance%20Center%2C%20600%20Zhongshan%20Dong%20Er%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Meet the Bund (Zhongshan Dong Er Road)"
  />
);

export default MeetTheBundZhongshanDongErRoad;
