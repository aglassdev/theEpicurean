...
const GongDeLinWestNanjingRoad = () => (
  <RestaurantPage
    restaurantName="Gong De Lin (West Nanjing Road)"
    address="445 West Nanjing Road, Huangpu, Shanghai, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+862163270218"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/gong-de-lin-jingan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you see that sweet and sour pork and fried shredded eel are on the menu you may doubt if the food is truly vegan but fear not – all the mock-meat and fish is made with either veggies, soy product or mushrooms. This institution of Shanghainese vegan cooking has been serving plant-based dishes in disguise since 1922. Its annexed shop now sells cake and snacks freshly made in-house, such as the tasty mugwort rice dumplings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=445%20West%20Nanjing%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Gong De Lin (West Nanjing Road)"
  />
);

export default GongDeLinWestNanjingRoad;
