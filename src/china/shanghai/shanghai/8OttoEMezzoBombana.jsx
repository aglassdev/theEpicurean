...
const EightOttoEMezzoBombana = () => (
  <RestaurantPage
    restaurantName="8 ½ Otto e Mezzo Bombana"
    address="6-7F, Associate Mission Building, 169 Yuanmingyuan Road, Huangpu, Shanghai, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+862160872890"
    website="https://www.ottoemezzobombana.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The third restaurant under the aegis of chef Umberto Bombana comes with a glitzy cocktail bar and a balcony with jaw-dropping views. But the glass-clad wine cellar with amazing selections – both by the glass and by the bottle – also catches the eye. The kitchen excels at well-judged Italian classics, complemented by a seafood-heavy tasting menu that showcases the ocean's finest flavours alongside handmade pasta and bread that are simply unmissable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-7F%2C%20Associate%20Mission%20Building%2C%20169%20Yuanmingyuan%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="8 ½ Otto e Mezzo Bombana"
  />
);

export default EightOttoEMezzoBombana;
