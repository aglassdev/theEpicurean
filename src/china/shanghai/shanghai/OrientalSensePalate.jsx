...
const OrientalSensePalate = () => (
  <RestaurantPage
    restaurantName="Oriental Sense & Palate"
    address="57 Sinan Road, Huangpu, Shanghai, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+862154641319"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/oriental-sense-palate"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57%20Sinan%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Oriental Sense & Palate"
  />
);

export default OrientalSensePalate;
