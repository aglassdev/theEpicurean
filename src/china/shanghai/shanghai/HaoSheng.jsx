...
const HaoSheng = () => (
  <RestaurantPage
    restaurantName="Hao Sheng"
    address="156 Guangyuan Road, Xuhui, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥"
    phoneNumber="+8613901823035"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/hao-sheng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The decor is not much to write home about, but authentic home-style Shanghainese fare – sautéed river shrimps, blanched pork liver – keeps the regulars coming. The drunken chicken steeped in warm Shaoxing wine has silky flesh and an intoxicating aroma. The chef doesn't offer an à la carte menu, but chooses for you according to your budget, allergies, preference and what's fresh. There are just a few tables and one private room, so book well ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=156%20Guangyuan%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Hao Sheng"
  />
);

export default HaoSheng;
