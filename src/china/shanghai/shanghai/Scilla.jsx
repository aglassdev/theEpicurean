...
const Scilla = () => (
  <RestaurantPage
    restaurantName="Scilla"
    address="504 Panyu Road, Changning, Shanghai, China Mainland"
    cuisine="Mediterranean Cuisine"
    priceRange="¥¥¥¥"
    phoneNumber="+862160730258"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/scilla"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Scilla is a blue-flowered Mediterranean plant, a nod to the fact that this restaurant focuses on the region's food, but with a twist – local ingredients, especially seafood, are given the Mediterranean treatment, for a unique fusion cuisine. The signature BBQ Taizhou yellow croaker with bouillabaisse and rouille boasts crispy skin, rich broth and creamy sauce. The underground wine cellar carries some rare finds from the Mediterranean coast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=504%20Panyu%20Road%2C%20Changning%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Scilla"
  />
);
