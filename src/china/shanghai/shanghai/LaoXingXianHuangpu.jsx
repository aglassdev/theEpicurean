...
const LaoXingXianHuangpu = () => (
  <RestaurantPage
    restaurantName="Lao Xing Xian (Huangpu)"
    address="5F, Parkson, 918 Middle Huaihai Road, Huangpu, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥"
    phoneNumber="+8613681653751"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/lao-xing-xian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Xian, or umami, is the fifth core flavour of food; it also means “fresh” in Chinese. At Lao Xing Xian, the owner aims to serve the freshest seafood, caught by his own fleet in the East China Sea that is deftly crafted with a knockout umami kick. The fish is neatly displayed for diners to choose – beltfish and yellow croaker taste best when steamed plain. Braised wild rice paddy eel is lightly seasoned to accentuate its natural flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Parkson%2C%20918%20Middle%20Huaihai%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lao Xing Xian (Huangpu)"
  />
);

export default LaoXingXianHuangpu;
