...
const TeaCultureEastBeijingRoad = () => (
  <RestaurantPage
    restaurantName="Tea Culture (East Beijing Road)"
    address="L201A, 2F, Yi Feng Galleria, 99 East Beijing Road, Huangpu, Shanghai, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥¥"
    phoneNumber="+862163330383"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/tea-culture-east-beijing-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can tell from the name that this restaurant is serious about the national beverage – professional tea masters brew the perfect cup, using top quality loose leaves and natural spring water. As for the food, the Guangdong chef displays his skills in a predominantly Huaiyang-inspired menu with some Jiangzhe and Cantonese dishes. The classic Buddha Jumps over the Wall is reworked with head of silver carp from Qiandao Lake (two portion sizes available)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L201A%2C%202F%2C%20Yi%20Feng%20Galleria%2C%2099%20East%20Beijing%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Tea Culture (East Beijing Road)"
  />
);

export default TeaCultureEastBeijingRoad;
