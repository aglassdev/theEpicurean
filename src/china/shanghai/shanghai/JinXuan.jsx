...
const JinXuan = () => (
  <RestaurantPage
    restaurantName="Jin Xuan"
    address="53F, The Ritz-Carlton Pudong, 8 Century Avenue, Pudong, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+862120201717"
    website="https://www.ritzcarlton.com/en/hotels/shasz-the-ritz-carlton-shanghai-pudong/dining/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Next to the iconic Oriental Pearl Tower, this elegant dining room is perched on an upper floor of a sky-scraping hotel, commanding panoramic views of the Huangpu River and Pudong skyline. The menu covers much ground in Cantonese cuisine, including rare imported ingredients from Australian black cod to New Zealand lobster. The dim sum platter features an assortment of three crowd pleasers. The well-curated wine list has excellent choices by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53F%2C%20The%20Ritz-Carlton%20Pudong%2C%208%20Century%20Avenue%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Jin Xuan"
  />
);

export default JinXuan;
