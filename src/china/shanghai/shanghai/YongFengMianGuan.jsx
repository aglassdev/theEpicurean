...
const YongFengMianGuan = () => (
  <RestaurantPage
    restaurantName="Yong Feng Mian Guan"
    address="320 Hankou Road, Huangpu, Shanghai, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862131615653"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yong-feng-mian-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the second generation, this family-run halal noodle shop has been around since 1962. Forced to close due to urban renewal, many regretted the demise of the original venue. Recently re-opened in a new spot, the original kitchen team proudly delivers its distinctive culinary score. The signature red-braised lamb noodles are served in curry beef stock or tossed in scallion oil. Either way, order an over-easy egg so the yolk spills over the noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=320%20Hankou%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yong Feng Mian Guan"
  />
);

export default YongFengMianGuan;
