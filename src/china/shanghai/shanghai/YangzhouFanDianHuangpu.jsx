...
const YangzhouFanDianHuangpu = () => (
  <RestaurantPage
    restaurantName="Yangzhou Fan Dian (Huangpu)"
    address="345 Middle Fujian Road, Huangpu, Shanghai, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+862163225266"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yangzhou-fan-dian-huangpu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This senior member of the Shanghai dining scene is as busy as ever, especially after a facelift in 2017 that added a private room. The dining room is decorated with paintings and wood carvings, while the floor-to-ceiling window on the second floor frames the gorgeous city views. As always, it serves authentic Huai Yang food, impeccably made and reasonably priced. Must-tries include shredded tofu in soup and braised pork balls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=345%20Middle%20Fujian%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yangzhou Fan Dian (Huangpu)"
  />
);

export default YangzhouFanDianHuangpu;
