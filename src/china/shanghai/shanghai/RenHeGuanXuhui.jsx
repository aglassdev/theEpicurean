...
const RenHeGuanXuhui = () => (
  <RestaurantPage
    restaurantName="Ren He Guan (Xuhui)"
    address="407 Zhaojiabang Road, Xuhui, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥"
    phoneNumber="+862164030731"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/ren-he-guan-zhaojiabang-road"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dim yellow lights, 1930s memorabilia, golden oldies performed by singers dressed in qipao… but, surprisingly, the ambiance doesn't steal the show. It's the first-rate Shanghainese fare at bargain prices that keeps the place packed. One highlight of the fish-focused menu is crab, as the owner picks the best from his own farm; the crabmeat and roe on rice is a must. Fried shredded eel with water bamboo affords a nice contrast of textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=407%20Zhaojiabang%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Ren He Guan (Xuhui)"
  />
);

export default RenHeGuanXuhui;
