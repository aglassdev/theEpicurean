...
const QiaoAiLaiLaiXiaoLongHuangpu = () => (
  <RestaurantPage
    restaurantName="Qiao Ai Lai Lai Xiao Long (Huangpu)"
    address="506 Tianjin Road, Huangpu, Shanghai, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+862163520230"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/qiao-ai-lai-lai-xiao-long-huangpu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple little shop tucked away in a bustling alley has been packed with hungry diners ever since it opened its doors 20 years ago. The chefs are always busy in the kitchen making xiao long bao, the crab roe variety being the most popular. Brace yourself for an even bigger crowd in hairy crab season, when wontons, spring rolls and soups are generously loaded with crabmeat and roe. The classic soupy pork buns are another must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=506%20Tianjin%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Qiao Ai Lai Lai Xiao Long (Huangpu)"
  />
);

export default QiaoAiLaiLaiXiaoLongHuangpu;
