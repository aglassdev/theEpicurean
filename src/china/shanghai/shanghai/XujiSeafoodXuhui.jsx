...
const XujiSeafoodXuhui = () => (
  <RestaurantPage
    restaurantName="Xuji Seafood (Xuhui)"
    address="500 Zhaojiabang Road, Xuhui, Shanghai, China Mainland"
    cuisine="Seafood"
    priceRange="¥¥¥"
    phoneNumber="+862162887098"
    website="http://www.xjseafood.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1999, the Hunan brand has been expanding its footprint across the nation, and this multi-storey branch is its Shanghai flagship. Thanks to close ties with fishermen and farms, locally and globally, it secures sources for the best-quality and freshest seafood. Try the live scallops from the East China Sea blanched at your table in a boiling, milky sea perch stock. Xuji glass noodles in a casserole are the Hunan speciality you can't miss...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=500%20Zhaojiabang%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Xuji Seafood (Xuhui)"
  />
);

export default XujiSeafoodXuhui;
