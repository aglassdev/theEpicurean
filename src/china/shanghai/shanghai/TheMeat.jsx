...
const TheMeat = () => (
  <RestaurantPage
    restaurantName="The Meat"
    address="2F, Kerry Hotel Pudong, 1388 Huamu Road, Pudong, Shanghai, China Mainland"
    cuisine="Steakhouse"
    priceRange="¥¥¥"
    phoneNumber="+862161698886"
    website="https://www.shangri-la.com/shanghai/kerryhotelpudong/dining/restaurants/the-meat/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The gloriously blunt name chosen by this hotel restaurant says it all. The beef – mostly Australian, is served in a characteristic steakhouse vibe, sporting antlers and booth seating. On your way in, you will see the room where the beef is aged for 25 to 31 days. The signature dish is New York pressed steak: Aussie Tajima Wagyu sirloin smothered in melted Raclette cheese, served with bourbon whisky sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Kerry%20Hotel%20Pudong%2C%201388%20Huamu%20Road%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="The Meat"
  />
);
