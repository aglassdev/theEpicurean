...
const YongYiTing = () => (
  <RestaurantPage
    restaurantName="Yong Yi Ting"
    address="LG Level, Mandarin Oriental Pudong, 111 South Pudong Road, Pudong, Shanghai, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+862120829978"
    website="https://www.mandarinoriental.com/en/shanghai/pudong"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After renovation, the restaurant reopened in an elegant space styled to evoke Jiangnan's water towns, divided into zones by perforated screens mimicking Suzhou's gardens and sheer curtains with ink strokes. Jiangzhe classics are given a refined, creative spin, with signatures such as Hangzhou-style minced fish ball with green peas (pre-order only). At lunch, try dim sum such as Qiandaohu rice flour dumplings and four-colour dumplings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=LG%20Level%2C%20Mandarin%20Oriental%20Pudong%2C%20111%20South%20Pudong%20Road%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yong Yi Ting"
  />
);

export default YongYiTing;
