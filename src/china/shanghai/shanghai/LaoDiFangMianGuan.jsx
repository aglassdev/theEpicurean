...
const LaoDiFangMianGuan = () => (
  <RestaurantPage
    restaurantName="Lao Di Fang Mian Guan"
    address="107 Sinan Road, Huangpu, Shanghai, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8618717922234"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/lao-di-fang-mian-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business for over 30 years, this noodle shop has recently moved to this new location. Rest assured that the menu and flavours remain the same and all noodles are served with toppings cooked à la minute. Try the toothsome cuttlefish noodles with pickled cabbage for a lovely crunch, complemented by seafood umami. Local favourites such as braised pork belly in spiced dark soy, and tofu skin-wrapped pork are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=107%20Sinan%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lao Di Fang Mian Guan"
  />
);

export default LaoDiFangMianGuan;
