...
const DaHuChunMiddleSichuanRoad = () => (
  <RestaurantPage
    restaurantName="Da Hu Chun (Middle Sichuan Road)"
    address="136 Middle Sichuan Road, Huangpu, Shanghai, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+862163130155"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/da-hu-chun-middle-sichuan-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Queues for the array of pan-fried buns boasting a crisp base and juicy filling stretch down the street. In addition to the typical pork variety, try the version with shrimp, or crabmeat and roe. Their mini wontons and meat-filled Shaobing are popular, too. The original shop, now with several branches across the Magic City, opened here in 1932; it moved and subsequently returned to the same street. You can also buy uncooked dim sum to take home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=136%20Middle%20Sichuan%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Da Hu Chun (Middle Sichuan Road)"
  />
);

export default DaHuChunMiddleSichuanRoad;
