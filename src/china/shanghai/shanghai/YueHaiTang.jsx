...
const YueHaiTang = () => (
  <RestaurantPage
    restaurantName="Yue Hai Tang"
    address="Vi Park, 161 Haowen Road, Minhang, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862158587977"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yue-hai-tang"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Yue Hai Tang is the brainchild of an experienced chef who has worked in some of the most prestigious kitchens of Shanghai. His team, which has been with him for a long time, rustles up a wickedly enticing Cantonese barbecue. Besides the main menu, you will also see seasonal offerings and a selection of painstakingly crafted dishes, such as lobster and crab meat in pastry. The wine list boasts over 500 choices. Booking and pre-ordering dishes is recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vi%20Park%2C%20161%20Haowen%20Road%2C%20Minhang%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yue Hai Tang"
  />
);

export default YueHaiTang;
