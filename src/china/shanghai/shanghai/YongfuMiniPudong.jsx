...
const YongfuMiniPudong = () => (
  <RestaurantPage
    restaurantName="YongFu Mini (Pudong)"
    address="Shop 910, 9F, L+Mall, 899 South Pudong Road, Pudong, Shanghai, China Mainland"
    cuisine="Ningbo"
    priceRange="¥¥"
    phoneNumber="+862150812795"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yongfu-mini"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A spin-off from Yong Fu, this restaurant serves only seafood caught in the East China Sea the same day, such as Miiuy croaker and hairtail, but at a lower price point. The must-try signature '18 chops' – raw crabs marinated in spiced soy and wine – is only available from November to April. Other Ningbo favourites like Shaoxing wine chicken and grilled cabbage are also well executed. Reservations aren’t taken so arrive early to beat the crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20910%2C%209F%2C%20L%2BMall%2C%20899%20South%20Pudong%20Road%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="YongFu Mini (Pudong)"
  />
);

export default YongfuMiniPudong;
