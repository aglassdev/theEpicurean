...
const DaVittorioSHA = () => (
  <RestaurantPage
    restaurantName="Da Vittorio"
    address="3F, N3 Building, The Bund Finance Centre, 600 Zhongshan Dong Er Road, Huangpu, Shanghai, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+862163302198"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/da-vittorio-570570"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Da Vittorio family have been serving seafood in Brusaporto in Italy for over 50 years and now they have brought that dining experience to Shanghai by relocating some team members and equipment here. Signature dishes on the à la carte menu include warm steamed fish salad and the curiously named Egg 'à la egg' with caviar; meat dishes like pigeon and lamb loin are also recommended. Be sure you save room for their tiramisu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20N3%20Building%2C%20The%20Bund%20Finance%20Centre%2C%20600%20Zhongshan%20Dong%20Er%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Da Vittorio"
  />
);

export default DaVittorioSHA;
