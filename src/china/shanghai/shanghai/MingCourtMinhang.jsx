...
const MingCourtMinhang = () => (
  <RestaurantPage
    restaurantName="Ming Court"
    address="Level B1, Cordis Hotel, 333 Shenhong Road, Minhang, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862152639618"
    website="https://www.cordishotels.com/en/shanghai-hongqiao/dine/ming-court/"
    aliases={["Ming Court (Minhang)","Ming Court (Shanghai)"]}
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Weary travellers will find this airy dining room near Hongqiao airport a veritable haven. As well as serving the same classics as its namesake sister branch in Hong Kong, the experienced Shanghainese chef also imbues Cantonese dim sum with unique Shanghainese touches. Honey-glazed chai siu pork, and tofu skin beggar’s purses are both pieces de resistance here. Don’t forget to save some room for baked-to-order puff pastry egg tarts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%20B1%2C%20Cordis%20Hotel%2C%20333%20Shenhong%20Road%2C%20Minhang%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Ming Court"
  />
);

export default MingCourtMinhang;
