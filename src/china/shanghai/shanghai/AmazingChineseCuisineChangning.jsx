...
const AmazingChineseCuisineChangning = () => (
  <RestaurantPage
    restaurantName="Amazing Chinese Cuisine (Changning)"
    address="B5 Villa, 1665 Hongqiao Road, Changning, Shanghai, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+862162625677"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/amazing-chinese-cuisine-changning"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="High-end Chaozhou cuisine characterises the menu, with over 200 items ranging from the classics to the creative – many made with ingredients specially sourced from Chaoshan region. Some signature dishes, such as chilled crab Chaozhou-style and marinated raw mantis shrimps, have to be pre-ordered. Crispy sea cucumber that takes days to prepare is another highlight. With just five private rooms in this villa, getting a table can be a challenge...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B5%20Villa%2C%201665%20Hongqiao%20Road%2C%20Changning%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Amazing Chinese Cuisine (Changning)"
  />
);

export default AmazingChineseCuisineChangning;
