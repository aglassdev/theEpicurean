...
const LaoZhengXing = () => (
  <RestaurantPage
    restaurantName="Lao Zheng Xing"
    address="556 Fuzhou Road, Huangpu, Shanghai, China Mainland"
    ...
    bio="Known locally and internationally since its inception in 1862, Lao Zheng Xing is reputedly the oldest Shanghainese restaurant in the city and was responsible for creating a number of classic dishes. It moved to its current location in 1997, which gave it considerably more space as it now occupies several floors. Come with friends to enjoy signature dishes like fried river shrimps, eight treasures in spicy sauce and braised sea cucumber...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=556%20Fuzhou%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lao Zheng Xing"
  />
);

export default LaoZhengXing;
