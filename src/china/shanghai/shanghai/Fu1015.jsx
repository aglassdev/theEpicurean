...
const Fu1015 = () => (
  <RestaurantPage
    restaurantName="Fu 1015"
    address="1015 Yuyuan Road, Changning, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥¥¥"
    phoneNumber="+862152379778"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/fu-1015"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="All 10 private rooms in the historical villa boast old Shanghai flair, but the food is both traditional and creative. One set menu focuses on Shanghainese classics; the other features seasonal favourites. Specialities include sautéed river shrimps with crabmeat and crab roe. For dessert, classic palates will relish the minced date cake or cashew seaweed puff pastry, whereas neophiles might like to try the soy ice cream with a deep-fried dough stick...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1015%20Yuyuan%20Road%2C%20Changning%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Fu 1015"
  />
);

export default Fu1015;
