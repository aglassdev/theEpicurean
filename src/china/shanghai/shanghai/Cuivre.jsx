...
const Cuivre = () => (
  <RestaurantPage
    restaurantName="Cuivre"
    address="1502 Middle Huaihai Road, Xuhui, Shanghai, China Mainland"
    cuisine="French Contemporary"
    priceRange="¥¥"
    phoneNumber="+862164374219"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/cuivre"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Echoing its name, this welcoming bistro in the French Concession amusingly features copper trimming on its walls and dinnerware. The kitchen excels in reinventing bistro classics with modern techniques and subtle Asian twists. L’agneau, or rack of lamb, is nicely charred on the outside and juicy on the inside. Round off with baba Zacapa. The wine list offers vintages from French small-batch wineries, alongside affordable new world choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1502%20Middle%20Huaihai%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Cuivre"
  />
);

export default Cuivre;
