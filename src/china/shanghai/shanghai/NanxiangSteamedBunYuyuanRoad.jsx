...
const NanxiangSteamedBunYuyuanRoad = () => (
  <RestaurantPage
    restaurantName="Nanxiang Steamed Bun (Yuyuan Road)"
    address="85 Yuyuan Road, City God Temple, Huangpu, Shanghai, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+862163554206"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/nanxiang-steamed-bun-city-god-temple"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A household name, founded in 1900; its handmade xiao long bao with paper-thin skin and juicy pork filling still attract a constant queue at the door. Along with the regular buns, try also those with seasonal fillings, or the oversized ‘super’ buns served with a straw for sucking up the soup. Refurbished in 2018, the dining room is modern and airy. Book a private room with friends or be prepared to wait in line...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=85%20Yuyuan%20Road%2C%20City%20God%20Temple%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Nanxiang Steamed Bun (Yuyuan Road)"
  />
);

export default NanxiangSteamedBunYuyuanRoad;
