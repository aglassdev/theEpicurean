...
const JingmeiWuxiNoodlesJingan = () => (
  <RestaurantPage
    restaurantName="Jingmei Wuxi Noodles (Jingan)"
    address="128 Yanping Road, Jingan, Shanghai, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8619102181275"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/jing-mei-wu-xi-si-fang-mian-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As well as noodles, this unstuffy stall serves Wuxi dishes and dim sum. Must-tries include noodle soup or scallion oil-dressed noodles with Wuxi-style pork ribs braised in soy paste – the fall-off-the-bone ribs are loaded in flavour. “Three-white” big wontons with white fish, white shrimp and whitebait filling burst with rich umami, while Sichuan pepper in the dip adds contrast. Dim sum like xiao long bao and yu lan cake are worth the wait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=128%20Yanping%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Jingmei Wuxi Noodles (Jingan)"
  />
);

export default JingmeiWuxiNoodlesJingan;
