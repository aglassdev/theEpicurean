...
const YongXing = () => (
  <RestaurantPage
    restaurantName="Yong Xing"
    address="No. 1, Lane 626, Middle Fuxing Road, Huangpu, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥"
    phoneNumber="+862164733780"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/yong-xing"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cozy little gem is hidden in a tiny alley and its non-descript façade makes it even harder to find. An archway, fireplace and red-brick wallpaper - reminiscent of someone’s home from a by-gone era - set the tone for the warm welcoming service. Yong Xing serves delicious home-style Chinese food at wallet-friendly prices and is hugely popular among locals. Try steamed perch with shredded ginger in Jiangdong style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201%2C%20Lane%20626%2C%20Middle%20Fuxing%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Yong Xing"
  />
);

export default YongXing;
