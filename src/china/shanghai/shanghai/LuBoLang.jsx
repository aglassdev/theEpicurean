...
const LuBoLang = () => (
  <RestaurantPage
    restaurantName="Lu Bo Lang"
    address="115 Yuyuan Old Street, City God Temple, Huangpu, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥"
    phoneNumber="+862163280602"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/lu-bo-lang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a makeover in 2019, the room now boasts wavy silvery panels on the ceiling and recessed lights emitting a subtle green glow. Despite the update in décor, the menu stays the same so expect food that is as tasty and reasonably priced. Shanghainese dim sum is still the key draw - turnip pastry, osmanthus glutinous rice cake and ‘eyebrow’ pastry are the must-try items. Private rooms on the 2nd and 3rd floors can cater to parties of various sizes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Yuyuan%20Old%20Street%2C%20City%20God%20Temple%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lu Bo Lang"
  />
);

export default LuBoLang;
