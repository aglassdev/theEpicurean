...
const Shanghai = () => (
  <RestaurantPage
    restaurantName="Shanghai"
    address="2F, Central Hotel, 555 Jiujiang Road, Huangpu, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥¥"
    phoneNumber="+862153965000"
    website="https://www.wbh-sh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on the second floor of the Central Hotel is this sister restaurant to the famed hairy crab restaurant, Wang Bao He. You’ll find this speciality here in season but it’s equally known for its authentic Shanghainese cooking. Their classic dishes use quality ingredients and are prepared with care. One highlight is the house-manufactured yellow rice wine, which you can buy to take home with you, along with various other ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Central%20Hotel%2C%20555%20Jiujiang%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Shanghai"
  />
);
