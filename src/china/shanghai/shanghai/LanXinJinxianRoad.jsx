...
const LanXinJinxianRoad = () => (
  <RestaurantPage
    restaurantName="Lan Xin (Jinxian Road)"
    address="130 Jinxian Road, Huangpu, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥"
    phoneNumber="+862162533554"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/lan-xin-jinxian-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a plethora of places to eat on Jinxian Road but one worth searching out is little Lan Xin. It’s a popular place with a diverse clientele – just be ready to join the queue, which usually snakes down the street. It was once a residential home and the modest look matches with the traditional, homely style of Shanghainese food on offer. The braised pork; braised duck with brown sauce; and yellow croaker in sweet vinegar sauce are all good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=130%20Jinxian%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lan Xin (Jinxian Road)"
  />
);

export default LanXinJinxianRoad;
