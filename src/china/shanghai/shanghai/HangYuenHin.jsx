...
const HangYuenHin = () => (
  <RestaurantPage
    restaurantName="Hang Yuen Hin"
    address="Xujiahui Park, 290 Wanping Road, Xuhui, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862164729778"
    website="https://hyhgroup.cn/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant opened in the lungs of the city and the lush greenery outside the windows works magic with the décor to make a relaxing ambiance. The chef has worked in both Guangzhou and Hong Kong, putting his know-how to good use in the authentic Cantonese dishes that are also low in salt and oil. Signature dishes include almond-crusted fried shrimp rolls, and crispy pigeon. Dim sum with family and friends is also a delight here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Xujiahui%20Park%2C%20290%20Wanping%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Hang Yuen Hin"
  />
);

export default HangYuenHin;
