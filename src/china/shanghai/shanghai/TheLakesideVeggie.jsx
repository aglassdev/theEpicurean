...
const TheLakesideVeggie = () => (
  <RestaurantPage
    restaurantName="The Lakeside Veggie"
    address="L2-016-017, Sunny Walk, 230 Ruiping Road, Xuhui, Shanghai, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+862133567008"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/the-lakeside-veggie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The brand started on the banks of West Lake, Hangzhou, hence the name. This outpost near Longhua Temple is especially popular among worshippers. The room is furnished in a modern style, with a show kitchen where diners can see the chefs making dim sum. Try their matsutake soup dumplings, with three mushrooms enrobed in translucent skin. Seared tofu is loaded with smoky peppery flavours. The desserts and drinks are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L2-016-017%2C%20Sunny%20Walk%2C%20230%20Ruiping%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="The Lakeside Veggie"
  />
);

export default TheLakesideVeggie;
