...
const LegendTasteJingan = () => (
  <RestaurantPage
    restaurantName="Legend Taste (Jingan)"
    address="1025 Kangding Road, Jingan, Shanghai, China Mainland"
    cuisine="Yunnanese"
    priceRange="¥¥"
    phoneNumber="+862152289961"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/legend-taste-jingan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The no-frills space is dotted with photos of Yunnan and blue tie-dyed tablecloths; the style of service is equally simple. The team use mushrooms and herbs extensively in cooking inspired by ethnic Dai tradition. Slow-cooked for at least five hours, the flavoursome beef broth warms the heart and soul. In mushroom season, don't miss dishes such as sautéed porcini and chanterelles with green chilli. Try the rice noodles with savoury tofu pudding, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1025%20Kangding%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Legend Taste (Jingan)"
  />
);

export default LegendTasteJingan;
