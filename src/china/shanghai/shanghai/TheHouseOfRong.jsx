...
const TheHouseOfRong = () => (
  <RestaurantPage
    restaurantName="The House of Rong"
    address="170 Nanyang Road, Jingan, Shanghai, China Mainland"
    cuisine="Taizhou"
    priceRange="¥¥¥¥"
    phoneNumber="+862162891717"
    website="http://www.xinrongji.cc"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A historical mansion once belonging to architect IM Pei's family is now home to the Shanghai flagship of this upmarket dining group. Adorned by Pei's original drawings and traditional architectural motifs in the Suzhou style, the space befits the class of the brand. The seafood-focused menu can be customised to your party's liking, delivering an array of flavours with top-notch ingredients mostly from Taizhou, such as wild-caught yellow croaker...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=170%20Nanyang%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="The House of Rong"
  />
);

export default TheHouseOfRong;
