...
const SeventhSon = () => (
  <RestaurantPage
    restaurantName="Seventh Son"
    address="R2-01, 2F, Fungseng Commercial Center, 500 Weihai Road, Jingan, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862162663969"
    website="https://www.seventhson.hk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Hong Kong based chain opened this comfortable, traditionally decorated branch in 2014 and it’s been attracting a loyal fan base ever since. It delivers a traditional Cantonese menu, with the technical skills of the chef evident in dishes that range from dried seafood and soups to roast meats and stir-fries. At lunch they offer over 30 varieties of dim sum. Sautéed ‘osmanthus’ egg with crabmeat and shredded shrimp is the must-try speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R2-01%2C%202F%2C%20Fungseng%20Commercial%20Center%2C%20500%20Weihai%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Seventh Son"
  />
);

export default SeventhSon;
