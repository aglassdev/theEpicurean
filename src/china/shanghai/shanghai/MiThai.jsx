...
const MiThai = () => (
  <RestaurantPage
    restaurantName="Mi Thai"
    address="2F, 195 Anfu Road, Xuhui, Shanghai, China Mainland"
    cuisine="Thai"
    priceRange="¥¥"
    phoneNumber="+862154039209"
    website="https://www.mithai.com.cn/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a neighbourhood well stocked with cool cafés and stylish boutiques comes this popular, pared-down Thai restaurant. It’s split between two rooms: one has an open kitchen; the other, an attractive timbered ceiling. The Thai chef keeps things fairly traditional so expect all the classics, from tom yum soup to green curry; but look out too for the deep fried shrimp patty or seafood yellow curry. The set lunch menu is great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20195%20Anfu%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Mi Thai"
  />
);
