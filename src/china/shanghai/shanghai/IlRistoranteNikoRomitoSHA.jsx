...
const IlRistoranteNikoRomitoSHA = () => (
  <RestaurantPage
    restaurantName="Il Ristorante - Niko Romito"
    address="47F, Bvlgari Hotel, Lane 108, North Shanxi Road, Jingan, Shanghai, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+862136067788"
    website="https://www.bulgarihotels.com/en_US/shanghai/dining/il-ristorante-niko-romito"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Stunning vistas of the Pudong skyline, crystal chandeliers and semi-circular leather booths impart style and a sense of grandeur. The menu here, as at the Dubai and Beijing outlets, comprises creations supervised by celebrity chef Niko Romito and underpinned by well-honed skills to reflect seasonality. Handmade pasta is the must-try – the lobster linguine bursts with seafood umami. Be sure to save room for the creamy gelato di ricotta di bufala...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47F%2C%20Bvlgari%20Hotel%2C%20Lane%20108%2C%20North%20Shanxi%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Il Ristorante - Niko Romito"
  />
);

export default IlRistoranteNikoRomitoSHA;
