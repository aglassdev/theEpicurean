...
const WangLu = () => (
  <RestaurantPage
    restaurantName="Wang Lu"
    address="01-02, 3F, New Bund 31 Mall, No.15, Lane 666, West Haiyang Road, Pudong, Shanghai, China Mainland"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+862158883331"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/wang-lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The room sports a modern Chinese vibe, dotted with framed orange scarves and table mats in matching equestrian motifs. To suit the local palate, the kitchen dials down the heat slightly, but the food still packs an authentic Jiangxi kick. Rich, flavoursome double-steamed soft-shelled tortoise with fish maw is served according to a ritual that symbolises good fortune. Jiangxi-style three-cup chicken boasts firm flesh and perfect caramelisation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=01-02%2C%203F%2C%20New%20Bund%2031%20Mall%2C%20No.15%2C%20Lane%20666%2C%20West%20Haiyang%20Road%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Wang Lu"
  />
);

export default WangLu;
