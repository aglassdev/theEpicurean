...
const LuStyleHuangpu = () => (
  <RestaurantPage
    restaurantName="Lu Style (Huangpu)"
    address="Room 207, 2F, Uni Elite, Lane 838, South Huangpi Road, Huangpu, Shanghai, China Mainland"
    cuisine="Shandong"
    priceRange="¥¥¥"
    phoneNumber="+862153099977"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/lu-style-1203592"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The head chef is a Shandong native, who started his career at the age of 18 as an army chef. The menu features the freshest catch from Bohai Sea – shipped in daily – and the chef fine-tunes his recipes according to the season. The Jiaodong cold appetiser platter includes four kinds of seafood with different seasonings. Live or dried sea cucumber is braised in a scallion sauce with corn smut, a mushroom believed to have health benefits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Room%20207%2C%202F%2C%20Uni%20Elite%2C%20Lane%20838%2C%20South%20Huangpi%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lu Style (Huangpu)"
  />
);

export default LuStyleHuangpu;
