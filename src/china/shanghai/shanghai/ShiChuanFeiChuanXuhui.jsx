...
const ShiChuanFeiChuanXuhui = () => (
  <RestaurantPage
    restaurantName="Shi Chuan Fei Chuan (Xuhui)"
    address="Shop 603, 6F, iapm, 999 Middle Huaihai Road, Xuhui, Shanghai, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862158888637"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/shi-chuan-fei-chuan-xuhui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The kitchen reimagines Sichuan cooking using top-notch produce from around the world, finessed by exquisite plating. Duck and pork tripe soup with pickled radish delivers unsurpassed umami alongside tang and tartness. Fluffy hand-made pork buns burst with the addictive aromas of spiced chilli oil. Cool down your palate with house-made bingfen: transparent jelly noodles made from shoofly seeds in brown sugar syrup. Booking recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20603%2C%206F%2C%20iapm%2C%20999%20Middle%20Huaihai%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Shi Chuan Fei Chuan (Xuhui)"
  />
);

export default ShiChuanFeiChuanXuhui;
