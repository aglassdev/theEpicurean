...
const NanXingYuan = () => (
  <RestaurantPage
    restaurantName="Nan Xing Yuan"
    address="Building 12, 1728 Middle Huaihai Road, Xuhui, Shanghai, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥¥"
    phoneNumber="+862164380838"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/nan-xing-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Helmed by a team of Sichuan chefs, this restaurant takes a deposit upon booking and serves only tailored menus, which diners pre-order. A typical menu builds a progression of flavours with classics such as napa cabbage in chicken consommé, and sautéed shredded pork with green chilli. Authentic dishes are meticulously prepared to showcase the 24 flavour profiles of Sichuanese cooking. Only private rooms are available, and reservations are a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%2012%2C%201728%20Middle%20Huaihai%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Nan Xing Yuan"
  />
);

export default NanXingYuan;
