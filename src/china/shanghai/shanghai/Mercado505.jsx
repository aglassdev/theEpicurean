...
const Mercado505 = () => (
  <RestaurantPage
    restaurantName="Mercado 505"
    address="505 North Wulumuqi Road, Jingan, Shanghai, China Mainland"
    cuisine="Spanish"
    priceRange="¥¥¥"
    phoneNumber="+862162488505"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/mercado-505"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Judging by its name, this restaurant on a corner strives to create the buzzing vibe of a market; judging by the blue and white stripes on its sign, it has a nautical theme. Yes and yes. Imported seafood such as live oysters, scampi, carabinero shrimp and baby eel are deftly prepared in myriad ways. The signature Spanish seafood stew loaded with umami has to be pre-ordered. You can enjoy alfresco dining on a sunny day or reserve a private room for groups...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=505%20North%20Wulumuqi%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Mercado 505"
  />
);

export default Mercado505;
