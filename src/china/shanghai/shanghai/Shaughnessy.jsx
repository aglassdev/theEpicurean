...
const Shaughnessy = () => (
  <RestaurantPage
    restaurantName="Shaughnessy"
    address="No.2201-2202, 22F, East Huaihai International Mansion, 45-49 East Huaihai Road, Huangpu, Shanghai, China Mainland"
    cuisine="Steakhouse"
    priceRange="¥¥¥"
    phoneNumber="+862160296789"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/shaughnessy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sitting atop a skyscraper, this American-style steakhouse commands vistas of the Bund and the Huangpu skyline. The menu stars premium cuts of suitably marbled Black Angus beef, all dry-aged in-house for 28 to 180 days. The steaks are artfully carved tableside and served with pan jus. If you’re not a red meat fan, you could opt for the aged squab which is something of a rarity. For more privacy, consider booking your own room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.2201-2202%2C%2022F%2C%20East%20Huaihai%20International%20Mansion%2C%2045-49%20East%20Huaihai%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Shaughnessy"
  />
);

export default Shaughnessy;
