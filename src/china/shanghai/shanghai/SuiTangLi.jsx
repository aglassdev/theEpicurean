...
const SuiTangLi = () => (
  <RestaurantPage
    restaurantName="Sui Tang Li"
    address="2F, The Middle House Residences, 366 Shimen Yi Road, Jingan, Shanghai, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+862132168068"
    website="https://www.thehousecollective.com/en/the-middle-house/restaurants-and-bars/sui-tang-li/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern, sun-drenched hotel restaurant is known for its host of regional dim sum with a creative twist, such as xiao long bao with marbled skin, and novelty bites made with Iberico ham and beetroot juice. The Yunnan duck tagine with Sichuan pepper boasts delicate flesh and a garlicky kick; the accompanying house-made duck dumplings are simply divine. Wine and literature lovers should check out the poetic wine list with rhyming verses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Middle%20House%20Residences%2C%20366%20Shimen%20Yi%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Sui Tang Li"
  />
);

export default SuiTangLi;
