...
const LeiGardenPudong = () => (
  <RestaurantPage
    restaurantName="Lei Garden (Pudong)"
    address="L3-17 & 18, IFC Mall, 8 Century Avenue, Pudong, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862151061688"
    website="https://leigarden.hk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Reservations are a must, as this branch of the chain is always packed with diners craving good quality Cantonese cuisine. At lunchtime, customers come in droves for the expertly crafted dim sum and soups. The dinner menu offers premium dishes such as seafood and abalone. Those wishing to avoid making too much of a dent in their wallets can opt for seasonal stir-fries, casseroles or the set menus for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L3-17%20%26%2018%2C%20IFC%20Mall%2C%208%20Century%20Avenue%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Lei Garden (Pudong)"
  />
);

export default LeiGardenPudong;
