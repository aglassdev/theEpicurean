...
const Sole = () => (
  <RestaurantPage
    restaurantName="Sole"
    address="Shop 109, Shanghai Centre, 1376 West Nanjing Road, Jingan, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862162682888"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/sole"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sole opened its doors in 2023 with an all-Cantonese kitchen team. The head chef's glorious career spans 20-plus years and he excels at Cantonese classics – dim sum, Cantonese barbecue, seafood, double-boiled soups and stir-fries. The long menu also offers painstakingly made items such as deep-fried egg custard with chicken testicle. The scallop dumpling with crab roe stands out for its translucent skin, perfect pleats and rich buttery filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20109%2C%20Shanghai%20Centre%2C%201376%20West%20Nanjing%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Sole"
  />
);
