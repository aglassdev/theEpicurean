...
const OneZeroTwoHouse = () => (
  <RestaurantPage
    restaurantName="102 House"
    address="5F, The House of Roosevelt, Bund 27, 27 Zhongshan Dong Yi Road, Huangpu, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+862163733122"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/102-house"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The story of 102 House started in a residential home in Foshan, Guangdong. The kitchen is helmed by a chef with around 20 years of experience. For diners to experience the quintessence of traditional Cantonese banquets, various set menus are offered. Items change seasonally, but his signature sweet and sour pork is always available, featuring the cut between loin and belly for the perfect texture, alongside house-made fruit vinegar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20The%20House%20of%20Roosevelt%2C%20Bund%2027%2C%2027%20Zhongshan%20Dong%20Yi%20Road%2C%20Huangpu%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="102 House"
  />
);

export default OneZeroTwoHouse;
