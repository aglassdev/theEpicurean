...
const GastroEstheticsAtDadong = () => (
  <RestaurantPage
    restaurantName="Gastro Esthetics at DaDong"
    address="5F, Park Place, 1601 West Nanjing Road, Jingan, Shanghai, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+862132532299"
    website="http://www.dadongdadong.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The design of the room is a nod to Van Gogh's Almond Blossom; teal cushions and brass trims echo the sky blue background and pinkish flowers of the painting. Peking duck is still the signature here – 45-day-old birds, or 22-day-old ducklings are grilled to perfection and carved tableside. The crispy skin and succulent meat are simply divine. The braised sea cucumber in a gelatinous scallion sauce is another must-try. The city view is a plus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Park%20Place%2C%201601%20West%20Nanjing%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Gastro Esthetics at DaDong"
  />
);

export default GastroEstheticsAtDadong;
