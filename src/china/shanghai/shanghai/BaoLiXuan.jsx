...
const BaoLiXuan = () => (
  <RestaurantPage
    restaurantName="Bao Li Xuan"
    address="3F, Chamber of Commerce Shanghai, Lane 108, North Shanxi Road, Jingan, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+862136067788"
    website="https://www.bulgarihotels.com/en_US/shanghai/dining/chinese-fine-dining-restaurant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Bvlgari Hotel's Chinese restaurant is nestled in an adjacent century-old building, complete with six private rooms inspired by Bvlgari jewellery. Solid skills and precision mark dishes such as soy-marinated chicken with silky flesh and a hint of Chinese rose wine aromas. Hand-crafted dim sum are the main event – the flaky, airy puff pastry is particularly well done. Try the whole abalone or char siu pork pastry for a full-flavoured bite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Chamber%20of%20Commerce%20Shanghai%2C%20Lane%20108%2C%20North%20Shanxi%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Bao Li Xuan"
  />
);

export default BaoLiXuan;
