...
const LeComptoirDePierreGagnaire = () => (
  <RestaurantPage
    restaurantName="Le Comptoir de Pierre Gagnaire"
    address="Capella, Jian Ye Li, 480 West Jianguo Road, Xuhui, Shanghai, China Mainland"
    cuisine="French"
    priceRange="¥¥¥¥"
    phoneNumber="+862154669928"
    website="https://capellahotels.com/en/capella-shanghai/dining/le-comptoir-de-pierre-gagnaire"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="An appealing, remodelled Shanghai villa – part of the Capella Hotel – is the setting for this outpost from the famed French chef. Start with an aperitif at the chic bar before taking a table overlooking the central courtyard. Refined French dishes are delivered by an experienced team which cleverly incorporates subtle Shanghainese influences. Signatures include blue lobster fricassee and cocotte of frogs Poulette; be sure to leave room for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Capella%2C%20Jian%20Ye%20Li%2C%20480%20West%20Jianguo%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Le Comptoir de Pierre Gagnaire"
  />
);

export default LeComptoirDePierreGagnaire;
