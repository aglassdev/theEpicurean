...
const MoosePudong = () => (
  <RestaurantPage
    restaurantName="Moose (Pudong)"
    address="9F, L+Mall, 899 South Pudong Road, Pudong, Shanghai, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+862158775707"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/moose-pudong"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Moose has three Shanghai branches, all run by the same team. This Pudong one is geared towards the general public, with a Huaiyang-centric menu featuring some painstakingly made delicacies. From Anhui province, the head chef champions the pagoda version of braised pork belly in brown sauce, which shows exquisite knife work. The sautéed river shrimps are a light but umami-loaded option. Ask servers about the seasonal menu and catch of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9F%2C%20L%2BMall%2C%20899%20South%20Pudong%20Road%2C%20Pudong%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Moose (Pudong)"
  />
);

export default MoosePudong;
