...
const HoHungKee = () => (
  <RestaurantPage
    ...
    address="L324, South Building, HKRI Taikoo Hui, 288 Shimen Yi Road, Jingan, Shanghai, China Mainland"
    cuisine="Noodles and Congee"
    priceRange="¥¥"
    phoneNumber="+862152188019"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/ho-hung-kee-570572"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a noodle shop, the Chinese-inspired faux-industrial decor is lavish – brushed brass ring pendant lamps and black wrought-iron arches perforated with floral motifs. The menu is almost the same as at its Hong Kong counterparts. The must-order shrimp wonton noodle soup comes with springy noodles and crisp sweet shrimps enrobed in a translucent skin. Or try the char siu pork puff pastry with spot-on seasoning and fine noodles with a generous covering of shrimp roe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L324%2C%20South%20Building%2C%20HKRI%20Taikoo%20Hui%2C%20288%20Shimen%20Yi%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Ho Hung Kee"
  />
);

export default HoHungKee;
