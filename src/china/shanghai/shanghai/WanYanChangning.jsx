...
const WanYanChangning = () => (
  <RestaurantPage
    restaurantName="Wan Yan (Changning)"
    address="Inside Jin Jiang Cypress Hotel, Block 8, 2419 Hungqiao Road, Changning, Shanghai, China Mainland"
    cuisine="Hui Cuisine"
    priceRange="¥¥¥"
    phoneNumber="+862162095177"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/wan-yan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brace yourself for nostalgia aplenty: velvet tufted chairs, walls covered in vintage blue bricks, art pieces from around the world…Most ingredients are shipped from Anhui, including mouldy tofu – a speciality you can’t miss. Wine-scented fermented mandarin fish is another classic slightly adapted to suit the local palate. The Anhui-style braised pork trotter in soybean paste is cooked in a 30-year-old marinade for exceptional depth and layered flavours. On top of the à la carte menu, you can also have one tailored in advanced...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inside%20Jin%20Jiang%20Cypress%20Hotel%2C%20Block%208%2C%202419%20Hungqiao%20Road%2C%20Changning%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Wan Yan (Changning)"
  />
);

export default WanYanChangning;
