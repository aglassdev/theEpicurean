...
const MooseChangning = () => (
  <RestaurantPage
    restaurantName="Moose (Changning)"
    address="No.1, Lane 119, Xinhua Road, Changning, Shanghai, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+862162055058"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/moose-changning"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Antique furniture and oil paintings complement the refurbished century-old mansion, whose all-white interior exudes modern European charm. The head chef has over 30 years' experience; Peking duck and Jiangzhe classics are his strong suit. His signature braised lion's head pork balls are prepared differently according to the season – with longsnout catfish and bird's nest from May to July, with crabmeat and roe in stock from August to October...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.1%2C%20Lane%20119%2C%20Xinhua%20Road%2C%20Changning%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Moose (Changning)"
  />
);

export default MooseChangning;
