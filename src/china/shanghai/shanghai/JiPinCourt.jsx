...
const JiPinCourt = () => (
  <RestaurantPage
    restaurantName="Ji Pin Court"
    address="3F, 55 South Wulumuqi Road, Xuhui, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862164699969"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/ji-pin-court"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2055%20South%20Wulumuqi%20Road%2C%20Xuhui%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Ji Pin Court"
  />
);

export default JiPinCourt;
