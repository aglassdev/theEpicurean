...
const ZhouSheMinhang = () => (
  <RestaurantPage
    restaurantName="Zhou She (Minhang)"
    address="Shop 116, Hongqiao Lihpao Plaza, No.16-101, Lane 318, Suhong Road, Minhang, Shanghai, China Mainland"
    cuisine="Shanghainese"
    priceRange="¥¥¥"
    phoneNumber="+862134636976"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/zhou-she-minhang"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In Hongqiao district, near a train station and airport, this restaurant is a popular choice among travellers. The head chef is a Shanghai native, who respects traditions, while exploring other Chinese regional flavours. His menu is heavily based on Shanghainese cuisine, with occasional Cantonese and Huaiyang dishes. Try his marinated pigeon with green Sichuan peppercorns and silky meat, and the umami-rich sautéed shredded fish with chive sprouts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20116%2C%20Hongqiao%20Lihpao%20Plaza%2C%20No.16-101%2C%20Lane%20318%2C%20Suhong%20Road%2C%20Minhang%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Zhou She (Minhang)"
  />
);

export default ZhouSheMinhang;
