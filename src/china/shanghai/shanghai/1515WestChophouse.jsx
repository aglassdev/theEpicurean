...
const OneFiveOneFiveWestChophouse = () => (
  <RestaurantPage
    ...
    bio="They’ve certainly nailed the classic American look at this nicely styled chophouse. Start with a cocktail in the masculine, wood panelled bar before passing by the inviting bakery into the restaurant. All the favourite steakhouse dishes are here, from Caesar salad mixed at the table to steak tartare and cheesecake. However, it’s the grill that takes centre stage – the various cuts of dry-aged Australian beef are chargrilled to perfection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Jing%20An%20Shangri-La%20Hotel%2C%201218%20Middle%20Yan'an%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="1515 West Chophouse"
  />
);

export default OneFiveOneFiveWestChophouse;
