...
const TouZao = () => (
  <RestaurantPage
    restaurantName="Tou Zao"
    address="Shop 211, East Wing, Shanghai Centre, 1376 West Nanjing Road, Jingan, Shanghai, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+8619121337327"
    website="https://guide.michelin.com/en/shanghai-municipality/shanghai/restaurant/tou-zao"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Unlike the typical bustling Chinese joint, Tou Zao offers the serenity and intimate service of a sushiya. But the single prix-fixe menu, featuring hot entrées and dim sum, is unmistakably Cantonese. The sautéed lobster with scallion trio has addictive aromas and springy flesh. Spring rolls and Cantonese puff pastries are made tableside, baked à la minute and served piping hot. Deft control of heat and remarkable wok hei are the hallmarks of the food here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20211%2C%20East%20Wing%2C%20Shanghai%20Centre%2C%201376%20West%20Nanjing%20Road%2C%20Jingan%2C%20Shanghai%2C%20China%20Mainland"
    pageTitle="Tou Zao"
  />
);

export default TouZao;
