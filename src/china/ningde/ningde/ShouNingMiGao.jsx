...
const ShouNingMiGao = () => (
  <RestaurantPage
    restaurantName="Shou Ning Mi Gao"
    address="103D, Building 4, 6 Quchitang Road, Jiaocheng, Ningde, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+8613685085073"
    website="https://guide.michelin.com/en/fujian-province/ningde/restaurant/shou-ning-mi-gao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny gem run by a married couple has won the hearts of locals courtesy of their mi gao – steamed rice noodle rolls with a choice of filling like ground pork and veggies. Ask for an extra ladle of spiced soy marinade for additional flavour and depth. Also recommended is the plain mi gao without filling. Fuding pork slices in sour spicy soup are made with hand-chopped pork and boast bouncy texture. Expect to share a table at mealtimes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=103D%2C%20Building%204%2C%206%20Quchitang%20Road%2C%20Jiaocheng%2C%20Ningde%2C%20China%20Mainland"
    pageTitle="Shou Ning Mi Gao"
  />
);

export default ShouNingMiGao;
