...
const HuYuZhongWuQuBianRou = () => (
  <RestaurantPage
    restaurantName="Hu Yu Zhong Wu Qu Bian Rou"
    address="101D-102D, Building 8, 31 Mindong Middle Road, Jiaocheng, Ningde, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+8613073911892"
    website="https://guide.michelin.com/en/fujian-province/ningde/restaurant/hu-yu-zhong-wu-qu-bian-rou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years, this shop has been a landmark of the Wuqu food scene. Since it moved to Ningde, the owner continues to craft everything in Wuqu style. Their bian rou dumplings are tossed in sauce or served in broth, boasting bouncy pork filling and paper-thin translucent skin. Dried cuttlefish and pork rib soup is packed in umami, while slippery taro noodles dressed in soy sauce and pickles seduce with savoury depth and tangy acidity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101D-102D%2C%20Building%208%2C%2031%20Mindong%20Middle%20Road%2C%20Jiaocheng%2C%20Ningde%2C%20China%20Mainland"
    pageTitle="Hu Yu Zhong Wu Qu Bian Rou"
  />
);

export default HuYuZhongWuQuBianRou;
