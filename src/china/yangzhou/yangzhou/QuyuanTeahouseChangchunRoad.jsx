...
const QuyuanTeahouseChangchunRoad = () => (
  <RestaurantPage
    restaurantName="Quyuan Teahouse (Changchun Road)"
    address="Inside Yangzhou State Guesthouse, 1 Changchun Road, Hanjiang, Yangzhou, China Mainland"
    cuisine="Huaiyang, Dim Sum"
    priceRange="¥¥"
    phoneNumber="+8651487291777"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/quyuan-teahouse-changchun-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Legend has it that Emperor Qianlong visited the private residence of a salt trader in the 18C, naming it Quyuan, meaning intriguing garden. Nestled in lush greenery by Lake Shouxi, it is now a teahouse that is famous for its Huaiyang fare, especially the dim sum breakfast. Try the Yangzhou wonder duo – millefeuille lard cake and emerald shaomai – and the five-gem buns. Arrive early to beat the crowds, or be ready to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inside%20Yangzhou%20State%20Guesthouse%2C%201%20Changchun%20Road%2C%20Hanjiang%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Quyuan Teahouse (Changchun Road)"
  />
);

export default QuyuanTeahouseChangchunRoad;
