...
const CaiGenXiangXiaoGuan = () => (
  <RestaurantPage
    restaurantName="Cai Gen Xiang Xiao Guan"
    address="26 Yuandong Street, Guangling, Yangzhou, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥"
    phoneNumber="+8615952736877"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/cai-gen-xiang-xiao-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-standing restaurant in Yangzhou enjoys a stellar reputation among foodies from near and far for its Huaiyang cuisine. It has moved many times over the decades, before settling in this nondescript alley in 2023. Home-style classics are its strong suit, such as blanched shredded dried tofu in a savoury sauce drizzled with sesame oil. The sautéed pork intestine is loaded with wok hei and the meat is tender while the sauce is mildly tart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Yuandong%20Street%2C%20Guangling%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Cai Gen Xiang Xiao Guan"
  />
);

export default CaiGenXiangXiaoGuan;
