...
const YangzhouYan38ChangchunRoad = () => (
  <RestaurantPage
    restaurantName="Yangzhou Yan (38 Changchun Road)"
    address="38 Changchun Road, Hanjiang, Yangzhou, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+8651482282777"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/yangzhou-yan-38-changchun-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This grand place with imposing architecture is perched on the shore of Slender West Lake, its traditional Chinese motifs evoking poetic elegance. Intricate knife skills are evident in the Yangzhou classic of shredded dried tofu dressed in sesame oil and sauces. Braised silver carp head is another crowd-pleaser (pre-order at least a day in advance). Live pipa and Chinese zither performances offer culture enthusiasts an immersive experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20Changchun%20Road%2C%20Hanjiang%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Yangzhou Yan (38 Changchun Road)"
  />
);

export default YangzhouYan38ChangchunRoad;
