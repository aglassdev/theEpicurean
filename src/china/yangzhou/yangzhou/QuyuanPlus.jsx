...
const QuyuanPlus = () => (
  <RestaurantPage
    restaurantName="Quyuan Plus"
    address="Inside Yangzhou State Guesthouse,1 Changchun Road, Hanjiang, Yangzhou, China Mainland"
    cuisine="Huaiyang, Cantonese"
    priceRange="¥¥"
    phoneNumber="+8651487535777"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/quyuan-plus"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This secluded place with its own miniature Jiangnan garden and water features exudes a serene, otherworldly feel. The menu is short but sweet, presenting all-time Huaiyang favourites alongside contemporary creations. Intoxicatingly aromatic Huadiao drunken crab is loaded with buttery roe and tomalley. The rice paddy eel sautéed tableside and simply seasoned with ground pepper and soy sauce is big on flavours. A tailor-made menu is available on request...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inside%20Yangzhou%20State%20Guesthouse%2C1%20Changchun%20Road%2C%20Hanjiang%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Quyuan Plus"
  />
);

export default QuyuanPlus;
