...
const LiuSheJi = () => (
  <RestaurantPage
    restaurantName="Liu She Ji"
    address="7-12 Siwangting Road, Guangling, Yangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8651487109090"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/liu-she-ji"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years, this homely noodle joint tucked away in an alley has been building a loyal following for its flavoursome slow-boiled broth, handmade jumping noodles kneaded with a bamboo pole, and an array of toppings cooked à la minute. The blanched noodles topped with shrimps, crabmeat and roe are pricier, but worth every penny – a dash of vinegar cuts through the crab's richness and accentuates the shrimps' sweetness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-12%20Siwangting%20Road%2C%20Guangling%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Liu She Ji"
  />
);

export default LiuSheJi;
