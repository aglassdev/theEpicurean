...
const YiYuanSiwangtingRoad = () => (
  <RestaurantPage
    restaurantName="Yi Yuan (Siwangting Road)"
    address="2-3F, Yiyuan Hotel, 1 Siwangting Road, Guangling, Yangzhou, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+8651487187777"
    website="https://guide.michelin.com/en/jiang-su/yangzhou_1032329/restaurant/yi-yuan-siwangting-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Next to Siwang Pavilion in the city centre, Yi Yuan has ample floor space for the biggest of banquets, and tables are plentiful – meaning customers often don't have to wait for a table. Better still, portions are generous and prices affordable. The authentic Yangzhou dim sum served at breakfast are particularly popular. Try the steamed dumplings with various fillings, and hand-shredded dried tofu dressed in shrimp roe soy sauce and sesame oil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-3F%2C%20Yiyuan%20Hotel%2C%201%20Siwangting%20Road%2C%20Guangling%2C%20Yangzhou%2C%20China%20Mainland"
    pageTitle="Yi Yuan (Siwangting Road)"
  />
);

export default YiYuanSiwangtingRoad;
