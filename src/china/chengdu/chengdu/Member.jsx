...
const Member = () => (
  <RestaurantPage
    restaurantName="Member"
    address="No. 26, 100 Qinglongzheng Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/member"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open only from 10am to 2pm, this neighbourhood joint on a quiet street is inspired by the 1980s with ceiling fans, a mint green fridge, wooden benches and other knick-knacks that open the floodgates of nostalgia. Similarly, the concise menu stars old-time local favourites, such as steamed rice dressed in lard and spiced soy. String bean noodles are another must-try – al dente noodles tossed in a spicy sauce, topped with ground pork and string beans...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2026%2C%20100%20Qinglongzheng%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Member"
  />
);
