...
const SilverCottage = () => (
  <RestaurantPage
    restaurantName="Silver Cottage"
    address="Luke Island, Section 1, South Tianfu Avenue, Shuangliu, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥¥"
    phoneNumber="+862863286688"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/silver-cottage"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Luke%20Island%2C%20Section%201%2C%20South%20Tianfu%20Avenue%2C%20Shuangliu%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Silver Cottage"
  />
);

export default SilverCottage;
