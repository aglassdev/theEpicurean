...
const Wanyan = () => (
  <RestaurantPage
    restaurantName="Wanyan"
    address="No. 101, Building 20, Tiexiang Temple Riverfront, 88 Tiexiangsi Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+8617711353184"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/wanyan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The culinary score offers novel twists on Sichuanese cooking. The dishes taste authentic, but also explore dimensions that differ from typical Sichuanese fare. The plating is minimalistic and contemporary. Try kung pao bird’s nest inspired by the 24 taste profiles of Sichuanese cuisine – velvety bird’s nest enrobed in a crunchy shell of kung pao sauce. White ferula mushroom and abalone are laced in Sichuan pepper oil loaded in numbing goodness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20101%2C%20Building%2020%2C%20Tiexiang%20Temple%20Riverfront%2C%2088%20Tiexiangsi%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Wanyan"
  />
);

export default Wanyan;
