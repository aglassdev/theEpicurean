...
const LaoChengduYiChengXianSanYangMian = () => (
  <RestaurantPage
    restaurantName="Lao Chengdu Yi Cheng Xian San Yang Mian"
    address="No. 6-8, 46 Guojielou Street, Qingyang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862887320715"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/lao-chengdu-san-yang-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This ‘hole in the wall’ may lack bells and whistles, but it’s popular with locals. Soup and tossed noodles are divided into 3 trifectas, namely the ‘old’, ‘new’ and ‘more’. Blanched noodles tossed in spicy meat sauce with diced string beans in the ‘old’ category is the most popular item. Feel free to order wontons with chopped chillies on the side. And nothing cools your mouth better than a bowl of tofu dessert with red bean soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%206-8%2C%2046%20Guojielou%20Street%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Lao Chengdu Yi Cheng Xian San Yang Mian"
  />
);

export default LaoChengduYiChengXianSanYangMian;
