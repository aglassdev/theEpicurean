...
const ShudidangguiWuhou = () => (
  <RestaurantPage
    restaurantName="Shudidanggui (Wuhou)"
    address="No. 25, 34 Shiwuzhong Street, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+8618081880107"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/shudidanggui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after two Chinese herbs, the concept of a therapeutic diet is at the core of this establishment. Diners are greeted by an herbal tea sweetened with stevia, and the menu is built around Chinese medicines. The signature beef noodle soup is infused with dang gui, believed to improve blood circulation, making it a lunch time favourite for many. Yellow croaker with galangal and patchouli is also popular. Some dishes require pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2025%2C%2034%20Shiwuzhong%20Street%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Shudidanggui (Wuhou)"
  />
);

export default ShudidangguiWuhou;
