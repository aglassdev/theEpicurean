...
const MasKitchenJinjiang = () => (
  <RestaurantPage
    restaurantName="Ma's Kitchen (Jinjiang)"
    address="1 East Kangshi Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862864231923"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/ma-s-kitchen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This popular eatery in the bustling Taikoo Li area started out as a stall in Weishan in 1923. Light years from its humble beginnings, this outpost of the chain in Chengdu features a vintage hipster interior and Sichuan classics on the menu. Besides their signature duck blood curd with pork offal and sliced eel, also try the crispy fen zheng rou – pork coated in seasoned rice flour, steamed and then deep-fried. Expect to see a queue from the moment it opens...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20East%20Kangshi%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Ma's Kitchen (Jinjiang)"
  />
);

export default MasKitchenJinjiang;
