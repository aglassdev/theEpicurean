...
const TheBridge = () => (
  <RestaurantPage
    ...
    address="66 Binjiang East Road, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862884446888"
    website="http://www.thebridge.com.cn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on Anshun Bridge, mentioned by Marco Polo in the 13C, The Bridge is celebrity chef André Chiang’s debut dining venture in mainland China. The score reveals his modern take on Sichuanese fare, delivering refined touches and mindful plating. There are over 10 different pickles to choose from, each imparting a different flavour. Also try the famous street snack, stuffed pancake with novel fillings like tiramisu and durian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20Binjiang%20East%20Road%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
