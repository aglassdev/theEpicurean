...
const HokkienCuisine = () => (
  <RestaurantPage
    restaurantName="Hokkien Cuisine"
    address="No. 326, 3F, North Tower, Chinese Financial Center, 33 Jiaozi Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+862860116969"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/hokkien-cuisine"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The elegant room with full-length windows feels airy and bright. In addition to booth seats, there are alsoprivate rooms for parties. The Fujian-born kitchen team ensures the authenticity of each dish. The must-try lychee meatballs are deep-fried pork stuffed with chopped water chestnuts for crunchiness. Scallion aromas and pleasing textures depict the Quanzhou speciality, crispy tofu skin rolls with a five-spice pork filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20326%2C%203F%2C%20North%20Tower%2C%20Chinese%20Financial%20Center%2C%2033%20Jiaozi%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Hokkien Cuisine"
  />
);

export default HokkienCuisine;
