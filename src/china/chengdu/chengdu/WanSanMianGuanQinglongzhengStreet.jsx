...
const WanSanMianGuanQinglongzhengStreet = () => (
  <RestaurantPage
    restaurantName="Wan San Mian Guan (Qinglongzheng Street)"
    address="No. 1, 131 Qinglongzheng Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8618123234325"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/wan-san-mian-guan-jinjiang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner hails from Yibin County, Sichuan. He opened this shop to serve authentic Yibin-style Ranmian noodles tossed in a chilli paste with ground peanuts, scallion, bean sprouts and sesames. For toppings, choose between the aromatic chilli ground beef or the hearty braised ginger duck. Those who prefer their noodles more toothsome may opt for the thick ribbon variety. On top of that, dried meats and sausages are also offered at dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201%2C%20131%20Qinglongzheng%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Wan San Mian Guan (Qinglongzheng Street)"
  />
);

export default WanSanMianGuanQinglongzhengStreet;
