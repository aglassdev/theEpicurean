...
const LiXuan = () => (
  <RestaurantPage
    restaurantName="Li Xuan"
    address="26F, The Ritz-Carlton Hotel, 269 Shuncheng Avenue, Qingyang, Chengdu, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862883599207"
    website="https://www.ritzcarlton.com/en/hotels/cturz-the-ritz-carlton-chengdu/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Li Xuan specialises in refined Cantonese cooking underpinned by solid techniques and shrewd judgment. The chef team's strong suits include double-boiled soups, barbecued meats, stir-fries and sweets. Yellow croaker soup with fish maw shows layers of textures and flavours; wok-fried Australian Wagyu beef cubes are juicy and tender, while the chanterelles add a lovely chew. The city views are also fantastic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26F%2C%20The%20Ritz-Carlton%20Hotel%2C%20269%20Shuncheng%20Avenue%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Li Xuan"
  />
);

export default LiXuan;
