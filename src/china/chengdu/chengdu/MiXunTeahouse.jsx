...
const MiXunTeahouse = () => (
  <RestaurantPage
    restaurantName="Mi Xun Teahouse"
    address="The Temple House, 81 Bitieshi Street, Jinjiang, Chengdu, 610021, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+862862974193"
    website="https://www.thehousecollective.com/sc/the-temple-house/restaurants-and-bars/mi-xun-teahouse"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestled in a quiet hotel next to Daci Temple, this restaurant is an oasis of calm. The courtyard house exudes historical charm, with the open kitchen lending an airy feel. Hand-picked local produce is used to create light, refined and inspired vegetarian dishes, such as vegan mapo tofu with chanterelles. There is also a set menu that supports small local farms near panda habitats, featuring ingredients like Mianyang porcini and Ya'an radish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Temple%20House%2C%2081%20Bitieshi%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20610021%2C%20China%20Mainland"
    pageTitle="Mi Xun Teahouse"
  />
);

export default MiXunTeahouse;
