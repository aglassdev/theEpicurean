...
const TheRiverHouse = () => (
  <RestaurantPage
    ...
    address="21F, Minshan Hotel, No. 55, Section 2, Renmin South Road, Jinjiang, Chengdu, China Mainland"
    cuisine="European"
    priceRange="¥¥¥"
    phoneNumber="+862885587927"
    website="http://minshanguest.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Knockout nightscapes, romantic live music and thoughtful touches make this restaurant a popular spot for marriage proposals. The food is classic European, but features unmistakably local ingredients. The velvety steamed wild-caught yellow croaker is steeped in a rich fish stock seasoned with Puning bean sauce. Also try the peach iron Buddha tea sorbet for a floral-fruity treat. In addition to the á la carte selection, the set menus offer great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21F%2C%20Minshan%20Hotel%2C%20No.%2055%2C%20Section%202%2C%20Renmin%20South%20Road%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="The River House"
  />
);

export default TheRiverHouse;
