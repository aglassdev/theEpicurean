...
const SilverPot = () => (
  <RestaurantPage
    restaurantName="Silver Pot"
    address="No. 532, 5F, M6, ICP Office Building, 300 Jiaozi Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862865777598"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/silver-pot"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The owner’s collection of souvenirs from her trips around the world gives this spacious dining room an endearing quirkiness. Her wanderlust also translates into her quest for quality ingredients from around the globe, to be cooked in an authentic Sichuanese style. Roast pigeon smoked with Sichuan pepper leaves is simply unmissable. Cold appetisers like lamp-shadow sliced grass carp are also well made. You can opt for half portion for some dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20532%2C%205F%2C%20M6%2C%20ICP%20Office%20Building%2C%20300%20Jiaozi%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Silver Pot"
  />
);

export default SilverPot;
