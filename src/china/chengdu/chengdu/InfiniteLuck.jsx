...
const InfiniteLuck = () => (
  <RestaurantPage
    restaurantName="Infinite Luck"
    address="50F, Waldorf Astoria Hotel, 1199 North Section of Tianfu Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862868706052"
    website="https://www.hilton.com/en/hotels/ctuwawa-waldorf-astoria-chengdu/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef is a Chengdu native with over three decades of experience. His menu is a roll call of the most iconic recipes from the province, showcasing unique local produce and varied flavour profiles. Pre-order delicacies like tea-smoked duck with crispy skin and flavoursome meat. The classic mapo tofu is creatively paired with house-made rice jelly, delivering interesting textures. Round off with bird’s nest ice jelly sweet soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50F%2C%20Waldorf%20Astoria%20Hotel%2C%201199%20North%20Section%20of%20Tianfu%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Infinite Luck"
  />
);

export default InfiniteLuck;
