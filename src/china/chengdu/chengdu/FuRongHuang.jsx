...
const FuRongHuang = () => (
  <RestaurantPage
    restaurantName="Fu Rong Huang"
    address="3F, 66-16 Guanghuacun Street, Qingyang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862887346868"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/fu-rong-huang"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Privacy is a priority here and the tables are separated by wooden slatted partitions - private rooms also available. The veteran kitchen team specialises in traditional Sichuanese dishes, many of which require painstaking execution. The sautéed pork liver with chilli is perfectly cooked with just the right amount of numbing heat. The classic cold appetiser, fu qi fei pian or sliced beef offal in chili oil, is springy, flavourful and addictive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2066-16%20Guanghuacun%20Street%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Fu Rong Huang"
  />
);

export default FuRongHuang;
