...
const PrivateCollectionSeeJoy = () => (
  <RestaurantPage
    restaurantName="Private Collection · See Joy"
    address="No. 2, Block 3, Jade Lane, Crland Plaza, 8 Liuli Road, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+8619983499909"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/private-collection-see-joy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zigong is famous for its thriving salt industry that brought wealth and an extravagant food culture to the city. This kitchen skilfully melds Zigong cooking with Huaiyang and Cantonese elements: the slow-cooked spicy ox tongue is both soft and toothsome; the time-honoured recipe of braised yak hoof in roasted chilli sauce is best enjoyed with plain noodle soup. Reservations are mandatory and menus can be tailored to diners' budgets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%202%2C%20Block%203%2C%20Jade%20Lane%2C%20Crland%20Plaza%2C%208%20Liuli%20Road%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Private Collection · See Joy"
  />
);

export default PrivateCollectionSeeJoy;
