...
const YuZhiLanCHE = () => (
  <RestaurantPage
    restaurantName="Yu Zhi Lan"
    address="No. 1, 24 Changfa Street, Qingyang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥¥"
    phoneNumber="+862862491966"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/yu-zhi-lan-1196150"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This low-key private dining concept can dispense with signage. The owner-chef Lan Guijun is a local legend who raised Sichuanese cooking to the level of haute cuisine, so foodies always find their way here. The quaint rustic room is dotted with ceramic art and pottery made by the chef himself. The dishes of the elaborate, multi-course set menus depend on market availability, but you can specify food allergies when booking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201%2C%2024%20Changfa%20Street%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Yu Zhi Lan"
  />
);

export default YuZhiLanCHE;
