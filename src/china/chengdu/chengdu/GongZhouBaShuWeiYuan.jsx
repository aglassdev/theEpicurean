...
const GongZhouBaShuWeiYuan = () => (
  <RestaurantPage
    restaurantName="Gong Zhou · Ba Shu Wei Yuan"
    address="No. 6, 64 Junlong Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥"
    phoneNumber="+862884439898"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/gong-zhou-ba-shu-wei-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gong Zhou was the ancient name of Chongqing, the home municipality of the owner and kitchen team. Since opening in a residential area next to Taikoo-li shopping hub in 1998, it has kept its fans coming back for its Chongqing dishes, such as auspicious home-style fish – blanched grass carp dressed in a tangy sauce made with spicy bean sauce, pickled chilli and ginger. Try the pork ribs coated in spiced ground rice, stuffed in pork tripe and steamed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%206%2C%2064%20Junlong%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Gong Zhou · Ba Shu Wei Yuan"
  />
);

export default GongZhouBaShuWeiYuan;
