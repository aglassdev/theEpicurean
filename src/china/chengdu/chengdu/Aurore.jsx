...
const Aurore = () => (
  <RestaurantPage
    restaurantName="Aurore"
    address="2F, No. 9, Yulin 8th Alley, Wuhou, Chengdu, China Mainland"
    cuisine="Innovative"
    priceRange="¥¥¥"
    phoneNumber="+8613882270213"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/aurore"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This unobtrusive dining room with an open kitchen is hidden behind its sibling restaurant. The local chef leads a young kitchen team as they invent novel culinary gems that are rooted in Sichuanese traditions, but finessed with Western techniques. The single tasting menu showcases the freshest local produce prepared in a myriad of ways – pan-fried, deep-fried, steamed, grilled… The experience is varied and satisfying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20No.%209%2C%20Yulin%208th%20Alley%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Aurore"
  />
);

export default Aurore;
