...
const TingYuan399Jinjiang = () => (
  <RestaurantPage
    restaurantName="Ting Yuan 399 (Jinjiang)"
    address="399 Jingjusi, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862884552579"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/ting-yuan-399"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While some guests may sip tea and play mahjong in the peaceful Chinese garden by a busy road, discerning food lovers flock here for the river fish dishes. Plump swamp eels from inland rivers are poached in a flavourful spiced broth and drizzled with sizzling hot oil at the table, making their flesh tender and juicy, but with a crispy chew. Stir-fried pork liver and kidney with bird’s eye chilli and pickled chilli is another firm favourite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=399%20Jingjusi%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Ting Yuan 399 (Jinjiang)"
  />
);

export default TingYuan399Jinjiang;
