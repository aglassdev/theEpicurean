...
const ChinaSamiteHotPotWuhouciStreet = () => (
  <RestaurantPage
    restaurantName="China Samite - Hot Pot (Wuhouci Street)"
    address="No. 94, 19 Wuhouci Street, Wuhou, Chengdu, China Mainland"
    cuisine="Hotpot"
    priceRange="¥¥"
    phoneNumber="+8618081109421"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/china-samite-hot-pot-wuhouci-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This two-storey flagship of the hot pot chain may look quaint on the outside, but the roomy interior sports a modern Sichuanese vibe. The classic spicy beef fat soup base is undoubtedly the star of the show – aromatic, spicy, numbing and rich at the same time. Baby goose intestines need just 15 seconds in the boiling broth to acquire a crisp texture. Round off with old-school sweet, iced jelly soup, the perfect antidote to cool tingling tastebuds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2094%2C%2019%20Wuhouci%20Street%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="China Samite - Hot Pot (Wuhouci Street)"
  />
);

export default ChinaSamiteHotPotWuhouciStreet;
