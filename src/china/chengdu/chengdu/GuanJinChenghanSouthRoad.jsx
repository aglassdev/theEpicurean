...
const GuanJinChenghanSouthRoad = () => (
  <RestaurantPage
    restaurantName="Guan Jin (Chenghan South Road)"
    address="4F, Block 5, Think Zone, 19 Chenghan South Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862884313737"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/guan-jin-wuhou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a recent renovation, the main dining room is bright and airy and private rooms can cater to different party sizes. The signature braised fish in spicy bean sauce is made with the river fish of your choice, like longsnout catfish, marble goby or topmouth culter. The rabbit cubes in guaiwei sauce are skin-on, boasting a silky texture and a fine balance between savoury, sweet and sour notes, alongside aromas and numbing spiciness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Block%205%2C%20Think%20Zone%2C%2019%20Chenghan%20South%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Guan Jin (Chenghan South Road)"
  />
);

export default GuanJinChenghanSouthRoad;
