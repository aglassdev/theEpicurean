...
const ChaimenGongGuanTongzilinEastRoad = () => (
  <RestaurantPage
    restaurantName="Chaimen Gong Guan (Tongzilin East Road)"
    address="10 Tongzilin East Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862885159911"
    website="http://www.chaimencanyin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 2012, this restaurant opened its doors on a main drag teeming with dining options. In the modern space, the four-person booths are the tables of choice. The predominantly Sichuanese menu features an array of sea and freshwater fish, such as spicy and sour braised marble goby with pickled string beans and radish. Plump for the starter of seared beef strips with dried tangerine peel – a mild, sweet aftertaste balances the heat of chilli and red oil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Tongzilin%20East%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Chaimen Gong Guan (Tongzilin East Road)"
  />
);

export default ChaimenGongGuanTongzilinEastRoad;
