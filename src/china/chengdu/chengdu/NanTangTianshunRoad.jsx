...
const NanTangTianshunRoad = () => (
  <RestaurantPage
    restaurantName="Nan Tang (Tianshun Road)"
    address="2F, North Tower, Interaxx Plaza, 151 Tianshun Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862865358899"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/nan-tang-tianshun-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cultural dining concept spreads across several elegant rooms dotted with pierced carvings and calligraphy reliefs. The Chinese stacking food box motif symbolises culinary heritage. Various ingredients are prepared in traditional Sichuanese ways to great effect, examples being the crispy-skinned pigeon enhanced by Sichuan pepper, or the velvety fish tofu shaped like a crescent moon, with a veil of bamboo fungus and covered in a consommé...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20North%20Tower%2C%20Interaxx%20Plaza%2C%20151%20Tianshun%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Nan Tang (Tianshun Road)"
  />
);

export default NanTangTianshunRoad;
