...
const NantangWang = () => (
  <RestaurantPage
    restaurantName="Nantang Wang"
    address="No. 301-303, 3F, Chinese Financial Center, 33 Jiaozi Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862887789969"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/nantang-wang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Established in the Chinese Financial Centre, this stylish restaurant aptly sports a textured wall inspired by Jiaozi, the first paper money in Chinese history unearthed in Chengdu. A pre-dinner carbonated Sichuan pepper drink teases the palate, before the novel Sichuan menu unfolds with refined dishes, some of which in individual portions. The rice paddy eel with chillies tastes fatty and authentic, while liangfen noodles dressed in a spicy sauce whet the appetite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20301-303%2C%203F%2C%20Chinese%20Financial%20Center%2C%2033%20Jiaozi%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Nantang Wang"
  />
);

export default NantangWang;
