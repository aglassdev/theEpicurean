...
const XueTaoInTheYard = () => (
  <RestaurantPage
    restaurantName="Xue Tao · In the Yard"
    address="Xingfu West Road, Xingfu Mei Lin, Sanshengxiang, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862884778488"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/xue-tao-in-the-yard"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after a poet from the Tang Dynasty, this branch of the chain opened in 2018 in a scenic area famous for its flowering plum trees. Two rustically styled buildings are connected by lush greenery. The menu features Sichuan home cooking and river fish, such as yellowhead catfish prepared in a myriad of ways. But most diners prefer it simmered in a spicy, tangy broth perfumed with green Sichuan pepper and Chinese patchouli. Reservations recommended at weekends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Xingfu%20West%20Road%2C%20Xingfu%20Mei%20Lin%2C%20Sanshengxiang%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Xue Tao · In the Yard"
  />
);

export default XueTaoInTheYard;
