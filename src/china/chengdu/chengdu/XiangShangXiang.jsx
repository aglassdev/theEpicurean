...
const XiangShangXiang = () => (
  <RestaurantPage
    restaurantName="Xiang Shang Xiang"
    address="E2003, 2F, East Pavilion, SKP, 2001 North Section of Tianfu Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥"
    phoneNumber="+862860831298"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/xiang-shang-xiang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Hunanese brand manager and kitchen team strive to re-create specialities from their home province as authentically as possible. The must-try fish head steamed with five different chillies flown in from Hunan mesmerises with a complex depth of spiciness, remarkable umami and punchy tartness. The 18-second stir-fried Xiangxi yellow beef uses the clod cut, rife with meaty flavour, in conjunction with chillies and aromatics for a real kick...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=E2003%2C%202F%2C%20East%20Pavilion%2C%20SKP%2C%202001%20North%20Section%20of%20Tianfu%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Xiang Shang Xiang"
  />
);

export default XiangShangXiang;
