...
const WuYueGong = () => (
  <RestaurantPage
    restaurantName="Wu Yue Gong"
    address="Inside CD Courtyard, 28 Wuyuegong Street, Qingyang, Chengdu, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥"
    phoneNumber="+862863048969"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/wu-yue-gong"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside a historic courtyard house-turned hotel, this private dining concept opened its doors in 2018. It only accepts reservations for parties of 2 to 10 diners and menus are tailor-made according to guests’ preferences. Novel Sichuanese fusion dishes are underpinned by solid skills and exquisite plating, complemented by Cantonese, Guanfu, Huaiyang and even Western items. Try kung pao prawns and chargrilled beef ribs in black pepper sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inside%20CD%20Courtyard%2C%2028%20Wuyuegong%20Street%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Wu Yue Gong"
  />
);

export default WuYueGong;
