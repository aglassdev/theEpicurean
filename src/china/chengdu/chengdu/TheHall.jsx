...
const TheHall = () => (
  <RestaurantPage
    restaurantName="The Hall"
    address="Canton Hall, Taikoo Li, 8 Zhongshamao Street, Jinjiang, Chengdu, China Mainland"
    cuisine="European Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+862886116567"
    website="https://unmi.group/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first Louis Vuitton restaurant in China stars Italian chef Leonardo Zambrino at the helm. Stints in prestigious kitchens in Asia and Europe have helped shape his vision – sophisticated European cuisine paired with Sichuanese flavour profiles. The tasting menus are seasonal, alongside a few à la carte dishes. The room nestles in a circa 1730s heritage building, complete with original brick walls, perforated wood windows and a courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Canton%20Hall%2C%20Taikoo%20Li%2C%208%20Zhongshamao%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="The Hall"
  />
);
