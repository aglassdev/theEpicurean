...
const ChengduRestaurant = () => (
  <RestaurantPage
    restaurantName="Chengdu Restaurant"
    address="2F, North Building, Shangshan International, No. 46-1, Section 4, Renmin South Road, Wuhou, Chengdu, China Mainland"
    cuisine="Cantonese, Sichuan"
    priceRange="¥¥¥¥"
    phoneNumber="+862883389691"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/chengdu-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The hanging lamps are a nod to the Golden Sun Bird, an ancient artefact unearthed in Chengdu, while the back-lit, perforated brass wall is evocative of basket weaving. The head chef from Guangdong built the menu on traditional Cantonese lines, spicing it up with Sichuanese touches and deftly incorporating produce from all over the world. Some seafood dishes require pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20North%20Building%2C%20Shangshan%20International%2C%20No.%2046-1%2C%20Section%204%2C%20Renmin%20South%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Chengdu Restaurant"
  />
);

export default ChengduRestaurant;
