...
const YongleRestaurantWuhou = () => (
  <RestaurantPage
    restaurantName="Yongle Restaurant (Wuhou)"
    address="36 Xiaojiahe Middle Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥"
    phoneNumber="+862885123321"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/yongle-restaurant-wuhou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can't miss this shop – just look for the red lanterns, perforated wood windows… and the queue. Since 1985, it's been serving home-style Sichuanese dishes made the traditional way: stir-frying, steaming and shuizhu. The braised eel with eggplant has contrasting textures and the savvy use of Chinese patchouli elevates it to the next level. For non-spicy food lovers, the sticky rice pork ribs and meatball soup are both great choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20Xiaojiahe%20Middle%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Yongle Restaurant (Wuhou)"
  />
);

export default YongleRestaurantWuhou;
