...
const YangboyingChuanTongZaJiangMian = () => (
  <RestaurantPage
    restaurantName="Yangboying Chuan Tong Za Jiang Mian"
    address="No. 13, 19 Tongsi Road, Qingyang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613678143880"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/yangboying-za-jiang-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef, who used to work in a famous restaurant, uses traditional techniques to make noodle soups and assorted toppings, each boasting a substantially different taste profile. Noodles dressed in minced pork sauce with sesame paste, red chilli oil and Sichuan pepper are a regional classic exuding intoxicating aromas. Those who prefer less heat opt for dumplings in seafood soup. All noodles come in three portion sizes to suit a range of appetites. Alfresco seating only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2013%2C%2019%20Tongsi%20Road%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Yangboying Chuan Tong Za Jiang Mian"
  />
);

export default YangboyingChuanTongZaJiangMian;
