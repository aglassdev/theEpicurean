...
const TongFuShe = () => (
  <RestaurantPage
    restaurantName="Tong Fu She"
    address="29 Jiaochangba West Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+8613568885545"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/tong-fu-she"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hole-in-the-wall eatery in a residential district may be stuck in the 1990s, but its delicious Sichuan home cooking transcends time. It prides itself on eel dishes – wild onion eel is a seasonal delicacy; Tongfu eel is spicy and aromatic, whereas red-braised eel imparts a mild zing. You can expect heirloom recipes rarely found elsewhere like pork liver curd soup with bamboo fungus and potsticker duck squares, but which must be pre-ordered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Jiaochangba%20West%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Tong Fu She"
  />
);

export default TongFuShe;
