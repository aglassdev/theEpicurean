...
const RongrongBeidaPugaimian = () => (
  <RestaurantPage
    restaurantName="Rongrong Beida Pugaimian"
    address="No. 2-4, Section 2, Jiefang Road, Jinniu, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8619828726617"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/rongrong-beida-pugaimian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Famous for its flat noodle soup, this eatery inevitably attracts long queues. Diners can see four chefs pulling a piece of dough to make the signature noodles – thin, soft, but with a lovely chew. The choice of toppings is relatively concise, but spicy and mild versions are available. Try the spicy beef with a hint of sweetness, or for a milder option, order the stewed free-range chicken loaded with shiitake aromas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%202-4%2C%20Section%202%2C%20Jiefang%20Road%2C%20Jinniu%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Rongrong Beida Pugaimian"
  />
);

export default RongrongBeidaPugaimian;
