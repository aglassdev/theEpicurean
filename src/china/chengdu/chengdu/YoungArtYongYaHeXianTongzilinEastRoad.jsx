...
const YoungArtYongYaHeXianTongzilinEastRoad = () => (
  <RestaurantPage
    restaurantName="Young Art · Yong Ya He Xian (Tongzilin East Road)"
    address="No. 1, 1 Tongzilin East Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862885199019"
    website="http://www.yangyayy.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As the chain’s flagship, this restaurant showcases live river fish such as long snout catfish, cavefish, and yellow head catfish cooked in Sichuanese style or in hot pots; the owner even acquired a fish farm to ensure their quality. The signature duo hot pot broth features a spicy base made with chicken, pork bones, chillies and pickles, and a tangy tomato base of Xinjiangese tomatoes. House-pickled bamboo shoots from Mount Tianmu are a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201%2C%201%20Tongzilin%20East%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Young Art · Yong Ya He Xian (Tongzilin East Road)"
  />
);

export default YoungArtYongYaHeXianTongzilinEastRoad;
