...
const Datenbank = () => (
  <RestaurantPage
    restaurantName="Datenbank"
    address="28 East Zijing Road, Wuhou, Chengdu, China Mainland"
    cuisine="Innovative"
    priceRange="¥¥¥"
    phoneNumber="+8619382167004"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/datenbank"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name may conjure up racks of servers with flickering lights, but you can expect a cavern-like interior with chunky, handmade stoneware to match. The “data” here refers to the deconstruction and re-assembly of taste memories by the young kitchen team, who melds eclectic influences from around the world with expressive, cutting-edge techniques. Mapo tofu is a popular staple on the menu, with tableside service that feels interactive and ceremonial...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20East%20Zijing%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Datenbank"
  />
);
