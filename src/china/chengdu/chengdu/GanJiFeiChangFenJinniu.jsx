...
const GanJiFeiChangFenJinniu = () => (
  <RestaurantPage
    restaurantName="Gan Ji Fei Chang Fen (Jinniu)"
    address="No. 1-3, 18 Ma'an North Road, Jinniu, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8615108271877"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/gan-ji-fei-chang-fen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With over 30 years of history, this tiny gem is no secret to locals in search of a bowl of hearty glass noodle soup with braised pork intestines. The toothsome, springy noodles are made in-house. Choose between mala spicy soup and rich white broth. Optionally, order intestine knots on top for an extra layer of texture. And don't miss the piping hot guokui – crispy flatbread with pork and Sichuan pepper filling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201-3%2C%2018%20Ma'an%20North%20Road%2C%20Jinniu%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Gan Ji Fei Chang Fen (Jinniu)"
  />
);

export default GanJiFeiChangFenJinniu;
