...
const ZhuanZhuanHuiLianhuaSouthRoad = () => (
  <RestaurantPage
    restaurantName="Zhuan Zhuan Hui (Lianhua South Road)"
    address="27 Lianhua South Road, Jinjiang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862884511000"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/zhuan-zhuan-hui-lianhua-south-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite its hard-to-find entrance, this flagship of the chain has earned solid fandom among locals with its no-frills, home-style Sichuanese cooking that is frugally priced. Instead of an eye-watering kick, expect a mild heat that caters to a broader palate. Specialities from the Leshan area, like tofu pudding and marinated fatty pork intestine, are best sellers. The latter is slow cooked in spiced soy before being sautéed with garlic and celtuce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20Lianhua%20South%20Road%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Zhuan Zhuan Hui (Lianhua South Road)"
  />
);

export default ZhuanZhuanHuiLianhuaSouthRoad;
