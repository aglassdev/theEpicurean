...
const Tivano = () => (
  <RestaurantPage
    restaurantName="Tivano"
    address="LG1 Level, The Temple House, 81 Bitieshi Street, Jinjiang, Chengdu, 610021, China Mainland"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+862862974190"
    website="https://www.thehousecollective.com/en/the-temple-house/restaurants-and-bars/tivano/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a floor-to-ceiling wine wall as the centrepiece, the room is elegantly furnished but without feeling too formal. Diners’ eyes are also drawn to the glitzy bar by the entrance and the semi-open kitchen where pizzas are baked and food is prepared. Apart from the traditional Italian varieties, pizzas also come in Sichaunese twists and in smaller portions. House-made pasta dishes are not to be missed. Round out the meal with torrone semifreddo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=LG1%20Level%2C%20The%20Temple%20House%2C%2081%20Bitieshi%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20610021%2C%20China%20Mainland"
    pageTitle="Tivano"
  />
);

export default Tivano;
