...
const ZengNiuRouQingyang = () => (
  <RestaurantPage
    restaurantName="Zeng Niu Rou (Qingyang)"
    address="No. 16, 17 Jinfeng Road, Qingyang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥"
    phoneNumber="+862881716928"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/zeng-niu-rou-qingyang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Abutting the Jinsha archaeological site, this family-run joint opened its doors in 2006. After a recent renovation, the room feels modern and cosy. It’s famous for tasty beef dishes at sensible price points – the beef is steamed, grilled, double-boiled, stewed and sautéed with Sichuanese condiments that appeal to the local palate. The steamed beef coated in spiced rice flour and slow-cooked tomato oxtail soup impress courtesy of big, bold flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%2016%2C%2017%20Jinfeng%20Road%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Zeng Niu Rou (Qingyang)"
  />
);

export default ZengNiuRouQingyang;
