...
const XinRongJiCHE = () => (
  <RestaurantPage
    restaurantName="Xin Rong Ji"
    address="No. 501, 5F, Chinese Financial Center, 33 Jiaozi Avenue, Wuhou, Chengdu, China Mainland"
    cuisine="Taizhou"
    priceRange="¥¥¥¥"
    phoneNumber="+862868102828"
    website="https://www.xinrongji.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This branch of the upmarket chain is furnished in a lavish but understated manner, and commands lovely views of the Twin Towers. The menu boasts the brand's signature luxury seafood lineup, but the Taizhou recipes jazzed up with local touches steal the show. Try the sea anemone glass noodles with house-made pickles – the slippery noodles soak up the tart, spicy broth. Spicy braised pork intestine with Qiantong dried tofu impresses with nice textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%20501%2C%205F%2C%20Chinese%20Financial%20Center%2C%2033%20Jiaozi%20Avenue%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Xin Rong Ji"
  />
);

export default XinRongJiCHE;
