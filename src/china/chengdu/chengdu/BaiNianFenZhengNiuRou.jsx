...
const BaiNianFenZhengNiuRou = () => (
  <RestaurantPage
    restaurantName="Bai Nian Fen Zheng Niu Rou"
    address="No. 5, 33 Zhimin Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥"
    phoneNumber="+8613693466931"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/bai-nian-fen-zheng-niu-rou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal in this joint tucked away in a courtyard is just the ticket to soak up the authentic charm of historic Chengdu. Their signature steamed beef coated in spiced rice flour strikes a balance between fiery heat and aroma. The tender beef is dotted with tendon that imparts a lovely chew. Braised spring chicken is heavily perfumed in ginger and garlic and boasts silky, juicy meat and deep flavours. Also try sautéed swamp eel with springy texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%205%2C%2033%20Zhimin%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Bai Nian Fen Zheng Niu Rou"
  />
);

export default BaiNianFenZhengNiuRou;
