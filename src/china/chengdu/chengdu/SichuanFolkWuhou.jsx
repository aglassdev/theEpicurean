...
const SichuanFolkWuhou = () => (
  <RestaurantPage
    restaurantName="Sichuan Folk"
    address="2-3F, 63 Shenxianshu South Road, Wuhou, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862885511888"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/sichuan-folk-shenxianshu-south-road"
    aliases={["Sichuan Folk (Wuhou)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The entrance, which is framed by two memorial arches with a pond in its centre, leads into a traditionally appointed dining room. It stages a show of Sichuan ‘face changing’ opera every evening at 7pm for a cultural-culinary experience. The menu is mostly Sichuanese, with an emphasis on Chongqing snacks and nibbles. Try stewed yellowhead catfish in peppery stock with scallion which is silky and flavoursome. Portions are big enough for sharing, so bring your mates!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-3F%2C%2063%20Shenxianshu%20South%20Road%2C%20Wuhou%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Sichuan Folk"
  />
);

export default SichuanFolkWuhou;
