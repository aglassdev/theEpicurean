...
const ChenMapoTofuQinghuaRoad = () => (
  <RestaurantPage
    restaurantName="Chen Mapo Tofu (Qinghua Road)"
    address="No.10-12, 10 Qinghua Road, Qingyang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥"
    phoneNumber="+862887317216"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/chen-mapo-tofu-qinghua-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mapo tofu is a world-famous Sichuanese classic dating back to the Qing Dynasty. Word has it that this century-old shop is the true original source of this numbing, spicy dish, invented by Lady Chen. Silky tofu, ground beef and spices are cooked in a stone pot that stays hot for a long time, perfect with a bowl of steamed rice. Zhong dumplings and lotus leaf-wrapped steamed pork in spiced rice flour are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.10-12%2C%2010%20Qinghua%20Road%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Chen Mapo Tofu (Qinghua Road)"
  />
);

export default ChenMapoTofuQinghuaRoad;
