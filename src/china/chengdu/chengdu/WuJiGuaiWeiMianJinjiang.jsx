...
const WuJiGuaiWeiMianJinjiang = () => (
  <RestaurantPage
    restaurantName="Wu Ji Guai Wei Mian (Jinjiang)"
    address="108-11, Section 5, Yi Huan East Road, Jinjiang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862886757438"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/wu-ji-guai-wei-mian-jinjiang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 1989, the founder started his first noodle shop just down the road. After several moves, he is back in his old neighbourhood once again. In his 70s, he still makes his own pork sauce like the old days, although the shop is now run by his son. His signature ‘weird taste’ noodles are dressed in a shiitake pork sauce that is mildly hot, sweet and numbing. Beef noodles in a spicy bean sauce include diced bamboo shoots for a lovely crunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=108-11%2C%20Section%205%2C%20Yi%20Huan%20East%20Road%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Wu Ji Guai Wei Mian (Jinjiang)"
  />
);

export default WuJiGuaiWeiMianJinjiang;
