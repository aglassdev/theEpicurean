...
const ChanyueVegetarian = () => (
  <RestaurantPage
    restaurantName="Chanyue Vegetarian"
    address="19F, Tower C, Master, No. 48, Section 4, Renmin South Road, Wuhou, Chengdu, 610000, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+862883331820"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/chanyue-vegetarian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bamboo blinds, wooden furniture, elegant plants and sheer curtains impart serenity. The set menu changes every 15 days to reflect the 24 solar terms in the Chinese calendar; even the house-fermented vinaigrette used is different. Seasoned with ginger, garlic and chilli, the food is mostly Sichuan-style, with vegan items craftily disguised as meat and fish – bovine bolete as pork liver, bamboo fungus as beef tripe, konjac as squid...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19F%2C%20Tower%20C%2C%20Master%2C%20No.%2048%2C%20Section%204%2C%20Renmin%20South%20Road%2C%20Wuhou%2C%20Chengdu%2C%20610000%2C%20China%20Mainland"
    pageTitle="Chanyue Vegetarian"
  />
);

export default ChanyueVegetarian;
