...
const QieFangXiang = () => (
  <RestaurantPage
    restaurantName="Qie Fang Xiang"
    address="Origin Zone, 9-13 Qunyi Road, Qingyang, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862885566886"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/qie-fang-xiang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Right in the busy city centre, this elegant restaurant comes with a terrace that offers a tranquil refuge from the hustle and bustle. The wood-rich interior is equally serene, boasting stylised Chinese motifs. The kitchen excels in home-style Sichuanese favourites and street food, from the incredibly silky Xipu silver carp perfumed with garlic, to seafood-laced, braised pork balls stuffed with salted egg yolks, drizzled in a rich, sticky gravy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Origin%20Zone%2C%209-13%20Qunyi%20Road%2C%20Qingyang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Qie Fang Xiang"
  />
);

export default QieFangXiang;
