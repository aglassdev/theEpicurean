...
const ZhuJiZhiMianPuJinjiang = () => (
  <RestaurantPage
    restaurantName="Zhu Ji Zhi Mian Pu (Jinjiang)"
    address="194 Yixinqiao South Street, Jinjiang, Chengdu, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8618581851965"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/zhu-ji-zhi-mian-pu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Surrounded by furniture shops, this noodle place has a retro feel to it. Wooden tables and bamboo chairs add to the overall rustic flair. The noodles are made fresh in-house, which explains their incredibly silky, bouncy texture. Zha jiang mian is the must-try here: blanched noodles are topped with a soybean-based ground pork sauce that is robust, savoury and mildly spicy. If you enjoy their noodles, you can buy some raw to take home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=194%20Yixinqiao%20South%20Street%2C%20Jinjiang%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Zhu Ji Zhi Mian Pu (Jinjiang)"
  />
);

export default ZhuJiZhiMianPuJinjiang;
