...
const FangXiangJing = () => (
  <RestaurantPage
    restaurantName="Fang Xiang Jing"
    address="No. 1, Courtyard 5, China Railway Ludao Art City, 16 Majia Garden Road, Jinniu, Chengdu, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+862864601181"
    website="https://guide.michelin.com/en/chengdu-municipality/chengdu/restaurant/fang-xiang-jing"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Set in a delicate stone garden, this restaurant in a quaint building offers private dining rooms only. The kitchen team painstakingly and faithfully revives nostalgic Sichuanese recipes. For example, the cabbage in chicken consommé takes hours to prepare and boasts a rich, crystal clear broth with exceptional depth. Contrasting textures and a tingling sensation depict the mapo tofu with diced beef and fish snout. Delicate service adds to the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%201%2C%20Courtyard%205%2C%20China%20Railway%20Ludao%20Art%20City%2C%2016%20Majia%20Garden%20Road%2C%20Jinniu%2C%20Chengdu%2C%20China%20Mainland"
    pageTitle="Fang Xiang Jing"
  />
);

export default FangXiangJing;
