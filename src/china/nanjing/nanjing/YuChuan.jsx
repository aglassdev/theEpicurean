...
const YuChuan = () => (
  <RestaurantPage
    restaurantName="Yu Chuan"
    address="1913 Art District, 129 Hongwu North Road, Xuanwu, Nanjing, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥¥"
    phoneNumber="+8615261880767"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/yu-chuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This century-old mansion, decorated with wainscoting, a coffered ceiling and 1950s chairs, is located in an art community. While not a prima facie setting for a Chinese restaurant, the kitchen team of Sichuan natives cooks up authentic fare from their home province with aplomb and modern twists. Here, mapo tofu is made with tender, flavoursome diced marbled beef, as opposed to ground beef. The handmade ice jelly adds a flourish to the end of the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1913%20Art%20District%2C%20129%20Hongwu%20North%20Road%2C%20Xuanwu%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Yu Chuan"
  />
);

export default YuChuan;
