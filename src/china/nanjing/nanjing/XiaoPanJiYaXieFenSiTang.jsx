...
const XiaoPanJiYaXieFenSiTang = () => (
  <RestaurantPage
    restaurantName="Xiao Pan Ji Ya Xie Fen Si Tang"
    address="1F, Longtai Building, 198 Zhongshan East Road, Qinhuai, Nanjing, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8618112936358"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/xiao-pan-ji-ya-xie-fen-si-tang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Initially a cold appetiser shop in Hongmiao District, this place moved several times before settling in the bustling city centre. The signature duck blood curd glass noodle soup comes with a choice of different duck cuts and offal. If in doubt, go for the version with a bit of everything. The duck broth is deeply flavoured, the meat moist and silky. Classic palates will also relish the roast duck with crispy skin and juicy, marinated flesh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Longtai%20Building%2C%20198%20Zhongshan%20East%20Road%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Xiao Pan Ji Ya Xie Fen Si Tang"
  />
);

export default XiaoPanJiYaXieFenSiTang;
