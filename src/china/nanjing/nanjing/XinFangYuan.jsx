...
const XinFangYuan = () => (
  <RestaurantPage
    restaurantName="Xin Fang Yuan"
    address="Room 108, 57 Tangzi Street, Qinhuai, Nanjing, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥"
    phoneNumber="+862586591901"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/xin-fang-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the third-generation owner, this family business opened its doors in 1959. The decor is no great shakes, but authentic old-time Nanjing flavours, generous portions and wallet-friendly prices have won it acclaim. Be sure to try their hand-made egg-coated beef potstickers – juicy, aromatic and nicely caramelised, they are a must! The white silver carp head soup in claypot with tofu and wood ear fungus boasts contrasting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Room%20108%2C%2057%20Tangzi%20Street%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Xin Fang Yuan"
  />
);

export default XinFangYuan;
