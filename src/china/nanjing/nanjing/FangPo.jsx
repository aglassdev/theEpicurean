...
const FangPo = () => (
  <RestaurantPage
    restaurantName="Fang Po"
    address="50 Wangfu Street, Qinhuai, Nanjing, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+862584204310"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/fang-po"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since the 1970s, the owner has been treating customers to iconic Nanjing-style small bites at this no-frills shop. Black rice balls, the favourite breakfast for many, comprise black sticky rice with bilberry leaves and stuffed with meat. End on a sweet note with baby taro in osmanthus sweet soup thickened by lotus root starch. Glutinous rice balls in red bean soup with wine lees, and peppery beef broth are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20Wangfu%20Street%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Fang Po"
  />
);

export default FangPo;
