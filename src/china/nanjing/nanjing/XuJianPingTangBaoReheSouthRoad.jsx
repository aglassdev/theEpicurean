...
const XuJianPingTangBaoReheSouthRoad = () => (
  <RestaurantPage
    restaurantName="Xu Jian Ping Tang Bao (Rehe South Road)"
    address="37-2 Rehe South Road, Gulou, Nanjing, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+8618251840468"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/xu-jian-ping-tang-bao-rehe-south-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner's father was a chef at Jiming Restaurant, an iconic Nanjing establishment. Having inherited his skill for making authentic Suzhou-style soup dumplings, she opened this no-frills shop in a residential neighbourhood in 2012. On the concise menu, the handmade soup dumplings with thin skin and juicy, mildly sweet pork filling are the main event. Regulars also opt for pork wonton soup. Closes at 2pm. Arrive early to avoid disappointment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37-2%20Rehe%20South%20Road%2C%20Gulou%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Xu Jian Ping Tang Bao (Rehe South Road)"
  />
);

export default XuJianPingTangBaoReheSouthRoad;
