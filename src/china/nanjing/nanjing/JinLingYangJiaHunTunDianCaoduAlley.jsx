...
const JinLingYangJiaHunTunDianCaoduAlley = () => (
  <RestaurantPage
    restaurantName="Jin Ling Yang Jia Hun Tun Dian (Caodu Alley)"
    address="1-1 Caodu Alley, Qinhuai, Nanjing, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+8613951934723"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/jin-ling-yang-jia-hun-tun-dian-caodu-alley"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 30 years, this place has been packed with wonton soup lovers throughout the day. The room has seen better days, but regulars clearly don't consider that a deal breaker. Wontons are wrapped on the spot, cooked à la minute and jazzed up by chopped chives. It's worth paying extra to add duck blood curd, intestine or liver to your wonton soup, which goes well with flatbread in either the sweet or savoury variety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-1%20Caodu%20Alley%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Jin Ling Yang Jia Hun Tun Dian (Caodu Alley)"
  />
);

export default JinLingYangJiaHunTunDianCaoduAlley;
