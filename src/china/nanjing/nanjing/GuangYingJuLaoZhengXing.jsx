...
const GuangYingJuLaoZhengXing = () => (
  <RestaurantPage
    restaurantName="Guang Ying Ju • Lao Zheng Xing"
    address="102 Daming Road, Qinhuai, Nanjing, China Mainland"
    cuisine="Jiangsu Cuisine"
    priceRange="¥¥"
    phoneNumber="+8613770609038"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/guang-ying-ju-%E2%80%A2-lao-zheng-xing"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over three decades, this local darling has been serving traditional Nanjing cuisine, including painstakingly crafted recipes that are hard to come by these days. In the hand-written vintage menu, you will find classics like Sichuan pepper-scented crispy skin duck and Dun Sheng Qiao – rice paddy eel that is deboned, pounded and deep-fried, before being poached in a meat broth with dried bamboo shoot. The generous portions are ideal for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=102%20Daming%20Road%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Guang Ying Ju • Lao Zheng Xing"
  />
);

export default GuangYingJuLaoZhengXing;
