...
const LongyinShanfangJiangning = () => (
  <RestaurantPage
    restaurantName="Longyin Shanfang (Jiangning)"
    address="Villa No. 9, Qinglong Mountain Villa, 888 Shenfeng Road, Jiangning, Nanjing, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥¥"
    phoneNumber="+862552292877"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/longyin-shanfang-jiangning"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This nature-inspired restaurant in an idyllic setting truly blurs the boundary between nature and culture. Jaw-dropping views can be enjoyed from the main room as well as all private rooms. Depending on the season, there are several set menus, which may include specialities such as peony-shaped tofu in consommé that highlights the ingredients' natural flavours. Cultural elements from tea-making to incense rituals make for a fun-filled experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Villa%20No.%209%2C%20Qinglong%20Mountain%20Villa%2C%20888%20Shenfeng%20Road%2C%20Jiangning%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Longyin Shanfang (Jiangning)"
  />
);

export default LongyinShanfangJiangning;
