...
const SanBaiWanBaoYingChangYuMian = () => (
  <RestaurantPage
    restaurantName="San Bai Wan Bao Ying Chang Yu Mian"
    address="119-2 Bancang Street, Xuanwu, Nanjing, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8617712410226"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/san-bai-wan-bao-ying-chang-yu-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner couple opened this shop in 2012 to serve rice paddy eel noodles, a speciality from their home county of Baoying, Yangzhou. The fried version is the most popular choice: boasting velvety eel, bouncy noodles and smoky wok hei. It is served with a bowl of eel bone soup. For the soup varieties, choose between milky eel soup and clear broth topped with sautéed eel in a thick glaze. Add pork balls, pork aspic or cracklings for something extra...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=119-2%20Bancang%20Street%2C%20Xuanwu%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="San Bai Wan Bao Ying Chang Yu Mian"
  />
);

export default SanBaiWanBaoYingChangYuMian;
