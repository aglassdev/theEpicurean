...
const JiangnanWokYun = () => (
  <RestaurantPage
    restaurantName="Jiangnan Wok · Yun"
    address="42F, Shangri-La, 329 Zhongyang Road, Gulou, Nanjing, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥¥¥"
    phoneNumber="+8617751001196"
    website="https://www.shangri-la.com/cn/nanjing/shangrila/dining/restaurants/jiangnan-wok-yun/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Highly experienced when it comes to Huaiyang cuisine, Chef Hou is best known for his refined, contemporary take on traditional favourites, with an emphasis on exquisite knifework and locally sourced produce in season. The braised eight-treasure pigeon with abalone – his spin on the classic duck recipe – is a cornucopia of gourmet ingredients with a rich, luscious glaze. Private rooms come with their own balconies that afford superb views...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42F%2C%20Shangri-La%2C%20329%20Zhongyang%20Road%2C%20Gulou%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Jiangnan Wok · Yun"
  />
);

export default JiangnanWokYun;
