...
const LiJiQingZhenGuan = () => (
  <RestaurantPage
    restaurantName="Li Ji Qing Zhen Guan"
    address="1 Dading Alley, Qinhuai, Nanjing, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+862552257736"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/li-ji-qing-zhen-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This century-old halal joint always has them queuing up for its piping hot beef potstickers – perfectly shaped crescents with juicy filling and browned, crispy bases. The beef xiao long bao are plump, delicate dumplings generously stuffed with soupy, gingery beef; just be careful the scalding soup doesn't squirt out. Beef wonton soup and an array of cold appetisers are also served. Chefs working behind the glass wall provide lively entertainment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Dading%20Alley%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Li Ji Qing Zhen Guan"
  />
);

export default LiJiQingZhenGuan;
