...
const YuanSpaceFeast = () => (
  <RestaurantPage
    restaurantName="Yuan Space & Feast"
    address="Building No. 7, 1 Sifangcheng, Ten Dynasties Cultural Park, Xuanwu, Nanjing, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+862557795117"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/yuan-space-feast"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a cultural park, this restaurant has a stately presence. The chef-owner, a Jiangsu native, is classically trained in Huaiyang cooking. He excels at refined Huaiyang dishes that are influenced by other Chinese cuisines. The braised meatball is a refined version of the classic lion's head pork balls, which is tender and juicy, thanks to the perfect ratio of lean and fat meat. His braised dried abalone is also a must try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%20No.%207%2C%201%20Sifangcheng%2C%20Ten%20Dynasties%20Cultural%20Park%2C%20Xuanwu%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Yuan Space & Feast"
  />
);

export default YuanSpaceFeast;
