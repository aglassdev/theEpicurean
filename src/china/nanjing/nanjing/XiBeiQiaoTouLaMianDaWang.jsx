...
const XiBeiQiaoTouLaMianDaWang = () => (
  <RestaurantPage
    restaurantName="Xi Bei Qiao Tou La Mian Da Wang"
    address="18 Dingjiaqiao, Gulou, Nanjing, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862583226585"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/xi-bei-qiao-tou-la-mian-da-wang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sign may say ramen king but this shop is routinely packed with fans of beef potstickers – just queue at the machine to order yours, then present the ticket to collect them. These potstickers have crispy golden bottoms and a soupy filling redolent of scallion. Those in the know dip them in vinegar and chilli oil for an extra kick. The menu also includes staples typically served in halal noodle shops, such as lamb dishes and cold appetisers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Dingjiaqiao%2C%20Gulou%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Xi Bei Qiao Tou La Mian Da Wang"
  />
);

export default XiBeiQiaoTouLaMianDaWang;
