...
const PinWeiJiangNan = () => (
  <RestaurantPage
    restaurantName="Pin Wei Jiang Nan"
    address="50F, Golden Eagle World G Hotel, 888 Yingtian Street, Jianye, Nanjing, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥¥"
    phoneNumber="+862584718888"
    website="https://www.jinyinghotels.com/Home/FoodIntro?HotelId=1#a2"
    tags={[]}
    awards={[
    ...
    pageTitle="Pin Wei Jiang Nan"
  />
);

export default PinWeiJiangNan;
