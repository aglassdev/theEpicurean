...
const QiangYeFanDianChangbaiStreet = () => (
  <RestaurantPage
    restaurantName="Qiang Ye Fan Dian (Changbai Street)"
    address="636 Changbai Street, Qinhuai, Nanjing, China Mainland"
    cuisine="Cantonese, Jiangsu Cuisine"
    priceRange="¥¥"
    phoneNumber="+862584459099"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/qiang-ye-fan-dian-changbai-street"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=636%20Changbai%20Street%2C%20Qinhuai%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Qiang Ye Fan Dian (Changbai Street)"
  />
);

export default QiangYeFanDianChangbaiStreet;
