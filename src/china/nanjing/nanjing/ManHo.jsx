...
const ManHo = () => (
  <RestaurantPage
    restaurantName="Man Ho"
    address="27F, Marriott Nanjing South Hotel, 1519 Shuanglong Avenue, Jiangning, Nanjing, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+862584993777"
    website="https://guide.michelin.com/en/jiang-su/nanjing_1029511/restaurant/man-ho-1216552"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched atop a hotel tower, the restaurant commands 270° views of the city and the lake; the room is adorned with modern, stylised Chinese motifs. The menu showcases creative Huaiyang cooking with a unique touch – the classic braised pigeon stuffed with bird's nest is now doused in a black truffle sauce. Thanks to his extensive experience, the head chef's meticulous skills are indisputable. Call to ask about items that need to be pre-ordered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27F%2C%20Marriott%20Nanjing%20South%20Hotel%2C%201519%20Shuanglong%20Avenue%2C%20Jiangning%2C%20Nanjing%2C%20China%20Mainland"
    pageTitle="Man Ho"
  />
);

export default ManHo;
