...
const MmAmis = () => (
  <RestaurantPage
    restaurantName="Mâm Amis"
    address="Shop A & B, GF, Fu Fai Commercial Centre, 27 Hillier Street, Sheung Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Vietnamese"
    priceRange="$$"
    phoneNumber="+85228933309"
    website="https://mamamishk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The smart wood panelled front contrasts sharply with the distressed walls, vintage lamps and hanging greenery inside. Vietnamese chefs are keen on bringing authentic Vietnamese food to Hong Kong, with chargrilled items and phở among the highlights. Try the chargrilled river prawns that boast bouncy, briny-sweet flesh and exceptional smokiness. Phở comes in generous portions with a flavour-packed soup base...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20A%20%26%20B%2C%20GF%2C%20Fu%20Fai%20Commercial%20Centre%2C%2027%20Hillier%20Street%2C%20Sheung%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Mâm Amis"
  />
);

export default MmAmis;
