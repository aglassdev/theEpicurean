...
const TimHoWanShamShuiPo = () => (
  <RestaurantPage
    restaurantName="Tim Ho Wan (Sham Shui Po)"
    address="9-11 Fuk Wing Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Dim Sum"
    priceRange="$"
    phoneNumber="+85227881226"
    website="https://www.timhowan.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the early branches of the chain, it offers over 20 dim sum on the menu, all skilfully made and attractively priced. Some items rotate every two to three months to keep them fresh. Don’t miss their shrimp dumplings, baked buns with barbecue pork filling or steamed tofu with scallops. The spruce interior takes up two floors and the unflappable team operates seamlessly and swiftly, keeping waiting times down to a minimum...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9-11%20Fuk%20Wing%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Tim Ho Wan (Sham Shui Po)"
  />
);

export default TimHoWanShamShuiPo;
