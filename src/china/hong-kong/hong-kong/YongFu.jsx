...
const YongFu = () => (
  <RestaurantPage
    ...
    address="Shop 2 at GF & 1F, Golden Star Building, 20-24 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Ningbo"
    priceRange="$$$$"
    phoneNumber="+85228817899"
    website="https://yongfuhk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first outpost of this Shanghai-based brand in Hong Kong features wave-like crystal chandeliers and dangling glass fish in a nod to its fish-centric menu. Fish from the East China Sea is shipped here daily, and local produce is used to create authentic Ningbo fare. Most of the hallmark dishes from the parent branch are available, including some of their most complex recipes. Try raw mud crab marinated in wine, ginger and coriander that boosts the briny sweet meat and flanked by intoxicating rich crab roe. Preorder to avoid disappointment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%202%20at%20GF%20%26%201F%2C%20Golden%20Star%20Building%2C%2020-24%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yong Fu"
  />
);

export default YongFu;
