...
const YuanIsHereWesternDistrict = () => (
  <RestaurantPage
    restaurantName="Yuan is Here (Western District)"
    address="31 North Street, Western District, Hong Kong, Hong Kong SAR China"
    cuisine="Taiwanese"
    priceRange="$"
    phoneNumber="+85235792460"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/yuan-is-here-western-district"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Decorated with memorabilia and buzzing with night market vibes, this street food shop is the brainchild of its Taiwan-born owner. Some ingredients are imported direct from his hometown to ensure that every bite is as authentic as possible. The signature minced braised pork rice boasts depth and a melty texture, while the traditionally-made double egg oyster omelette is both chewy and eggy at the same time. Round off with taro ball sweet soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20North%20Street%2C%20Western%20District%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yuan is Here (Western District)"
  />
);

export default YuanIsHereWesternDistrict;
