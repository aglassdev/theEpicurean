...
const ArtTaste = () => (
  <RestaurantPage
    restaurantName="Art & Taste"
    address="Shop A, GF, Carfield Commercial Building, 75-77 Wyndham Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Taiwanese"
    priceRange="$$"
    phoneNumber="+85227298228"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/art-taste"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After the restaurant What to Eat shuttered in 2024, one of the owners opened Art & Taste on the same spot and with the same kitchen team – they deserve praise for the well-made Taiwanese classics and small bites. For their signature braised beef noodle soup, choose between ribs, tendon, shank and a mix of tendon and shank. The broth imparts a robust flavour to the bouncy textured noodles. Don't miss the cheese and egg crêpe – another highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20A%2C%20GF%2C%20Carfield%20Commercial%20Building%2C%2075-77%20Wyndham%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Art & Taste"
  />
);

export default ArtTaste;
