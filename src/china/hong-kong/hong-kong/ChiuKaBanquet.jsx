...
const ChiuKaBanquet = () => (
  <RestaurantPage
    restaurantName="Chiu Ka Banquet"
    address="8F, Champion Building, 287-291 Des Voeux Road Central, Sheung Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Chiu Chow"
    priceRange="$$"
    phoneNumber="+85228052393"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/chiu-ka-banquet"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The traditionally furnished room, which used to be a private club, now specialises in home-style cooking from Chiuchow. Pork tripe soup with salted mustard greens and peppercorns is creamy and rich. Braised goose in spiced soy marinade impresses with a robust meaty flavour and subtle herbal warmth and the buttery, velvety goose liver is a must. Ask about the catch of the day and consider pre-ordering dried seafood like abalone and fish maw...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8F%2C%20Champion%20Building%2C%20287-291%20Des%20Voeux%20Road%20Central%2C%20Sheung%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Chiu Ka Banquet"
  />
);

export default ChiuKaBanquet;
