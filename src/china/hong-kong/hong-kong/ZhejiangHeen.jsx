...
const ZhejiangHeen = () => (
  <RestaurantPage
    restaurantName="Zhejiang Heen"
    address="1-3F, ZJ 300, 300-306 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Zhejiang"
    priceRange="$$"
    phoneNumber="+85228779011"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/zhejiang-heen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Run by a group of Hongkongers of Zhejiang descent, this traditionally furnished restaurant boasts universal appeal. On the menu, Zhejiang delicacies rub shoulders with Shanghainese specialities. Make sure you pre-order ‘snatched tiger tails’ – seared swamp eel in a brown sauce that reveal exquisite knife work and a springy texture. Also check out the seasonal dishes and excellent buns and pastries. Friendly, unobtrusive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3F%2C%20ZJ%20300%2C%20300-306%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Zhejiang Heen"
  />
);

export default ZhejiangHeen;
