...
const TastyCentral = () => (
  <RestaurantPage
    restaurantName="Tasty (Central)"
    address="Shop 3016-3018, 3F, IFC Mall, 1 Harbour View Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles and Congee"
    priceRange="$$"
    phoneNumber="+85222950101"
    website="https://www.tasty.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Be prepared to queue and share a table because over 1,000 customers a day, many of whom work in IFC, crowd into this joint. They mostly come for the trademark shrimp wonton, congee or the much-loved fried ribbon rice noodles with beef. Dim sum are also recommended from the vast selection on offer, like deep-fried dace balls with bits of dried shrimps and dried tangerine peel. The latest revamp has given a more contemporary spin to the interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%203016-3018%2C%203F%2C%20IFC%20Mall%2C%201%20Harbour%20View%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Tasty (Central)"
  />
);

export default TastyCentral;
