...
const HoKeeDessertToKwaWan = () => (
  <RestaurantPage
    restaurantName="Ho Kee Dessert (To Kwa Wan)"
    address="Shop 111 & 122, GF, I-Feng Mansions, 237A To Kwa Wan Road, To Kwa Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85291951017"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ho-kee-dessert-to-kwa-wan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The staple in Mong Kok for over 30 years moved to this location in 2020. Rest assured their traditional sweet soups like black sesame paste, and glutinous rice balls in ginger syrup taste as good as ever...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20111%20%26%20122%2C%20GF%2C%20I-Feng%20Mansions%2C%20237A%20To%20Kwa%20Wan%20Road%2C%20To%20Kwa%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ho Kee Dessert (To Kwa Wan)"
  />
);

export default HoKeeDessertToKwaWan;
