...
const LaiChingHeen = () => (
  <RestaurantPage
    restaurantName="Lai Ching Heen"
    address="GF, Regent, 18 Salisbury Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85223132313"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/lai-ching-heen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Remodelled and renamed Lai Ching Heen in 2022, the main dining room can now be accessed straight from the hotel lobby. In addition to the updated décor, expansive harbour views and Hong Kong’s skyline with its electric glow remain a joy to behold. Onto the menu, all-time favourites like stuffed crab shell with crabmeat, and crispy Lung Kong chicken are still offered. Don’t miss the dim sum lunch with exquisitely crafted bite-sized morsels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Regent%2C%2018%20Salisbury%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Lai Ching Heen"
  />
);

export default LaiChingHeen;
