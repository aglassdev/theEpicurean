...
const NewPunjabClub = () => (
  <RestaurantPage
    restaurantName="New Punjab Club"
    address="GF, World Wide Commercial Building, 34 Wyndham Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Indian, Pakistani"
    priceRange="$$$"
    phoneNumber="+85223681223"
    website="https://newpunjabclub.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As the name suggests, it is the state of Punjab in India’s northwest that provides the inspiration behind the menu here. As this state also borders Pakistan you can expect specialities from that country too. Dishes from the tandoor feature prominently, including a delicious goat seekh kebab; also try the keema pau made with mutton and, of course, their signature is butter chicken or ‘Mughal Room Makhani’, along with laccha paratha. The retro, colonial feel of the room is juxtaposed with some striking contemporary artwork...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20World%20Wide%20Commercial%20Building%2C%2034%20Wyndham%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="New Punjab Club"
  />
);

export default NewPunjabClub;
