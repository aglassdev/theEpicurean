...
const ShangPalaceHON = () => (
  <RestaurantPage
    restaurantName="Shang Palace"
    address="Lower Level 1, Kowloon Shangri-La Hotel, 64 Mody Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85227338754"
    website="https://www.shangri-la.com/hongkong/kowloonshangrila/dining/restaurants/shang-palace/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This elegant restaurant has been a reliable favourite for Cantonese classics for over 40 years. Chandeliers and Sung-style paintings create a stunning backdrop for the refined cooking, prepared meticulously by the seasoned chef. Seafood is cooked in myriad ways, so it never gets tired. Leopard coral grouper can be steamed with ginger and scallion, shredded pork and mushrooms, or deboned and sautéed with dried tangerine peel and olive-pickled mustard leaves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lower%20Level%201%2C%20Kowloon%20Shangri-La%20Hotel%2C%2064%20Mody%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Shang Palace"
  />
);

export default ShangPalaceHON;
