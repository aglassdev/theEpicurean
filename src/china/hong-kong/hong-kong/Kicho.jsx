...
const Kicho = () => (
  <RestaurantPage
    restaurantName="Kicho"
    address="Shop 2B, 1F, Manning House, 48 Queen's Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Yakitori"
    priceRange="$$$"
    phoneNumber="+85226338933"
    website="https://www.kicho-ushidoki.com.hk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This outpost of Tokyo’s famous yakitori kappo restaurant also champions a farm-to-table concept, sourcing free-range kuro-Satsuma chicken exclusively from a farm in Kagoshima. The breed is known for the even marbling and firm texture of its meat. The omakase dinner menu includes 10+ courses featuring various cuts of the chicken, mostly skewered and chargrilled. The chicken neck seduces with smoky aromas and bouncy, juicy, oily flesh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%202B%2C%201F%2C%20Manning%20House%2C%2048%20Queen's%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Kicho"
  />
);

export default Kicho;
