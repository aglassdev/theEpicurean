...
const CarnaByDarioCecchini = () => (
  <RestaurantPage
    restaurantName="Carna by Dario Cecchini"
    address="39F, Mondrian, 8A Hart Avenue, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+85235500339"
    website="https://mondrianhotels.com/hong-kong/dining/carna/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The swanky room creates a Tuscan vibe with gracious arches and exquisite stained glass. It also commands breathtaking harbour views visible from almost every table. The Italian steakhouse, brainchild of the famous butcher Dario Cecchini, champions a nose-to-tail concept with a focus on beef from Italy, Australia, the U.S., Japan and Ireland. Premium U.S. Wagyu steaks stand out in particular. The Italian wine list practically covers the entire country...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39F%2C%20Mondrian%2C%208A%20Hart%20Avenue%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Carna by Dario Cecchini"
  />
);

export default CarnaByDarioCecchini;
