...
const TsimChaiKeeWellingtonStreet = () => (
  <RestaurantPage
    restaurantName="Tsim Chai Kee (Wellington Street)"
    address="98 Wellington Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85228506471"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/tsim-chai-kee-wellington-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The long lunchtime queue happens for a reason – the noodles here are bouncy and the broth is flavoursome. Only three toppings are offered – springy dace balls, wontons generously filled with pork and shrimps, and sliced beef with a robust meaty flavour and tender texture. You can even choose a combination of any two or all three toppings. Expect to share a table with strangers when it’s busy or eat outside of peak times to beat the crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=98%20Wellington%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Tsim Chai Kee (Wellington Street)"
  />
);

export default TsimChaiKeeWellingtonStreet;
