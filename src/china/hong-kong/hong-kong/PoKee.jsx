...
const PoKee = () => (
  <RestaurantPage
    restaurantName="Po Kee"
    address="425P Queen's Road West, Western District, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese Roast Meats"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/po-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="How far would you go for a bowl of Lai Fan noodles with roast duck leg? Every morning loyal fans line up at the door before this shop opens – that’s how good it is. A fixture in the neighbourhood for over 40 years, Po Kee is hugely popular among locals for its roast meats freshly grilled in the factory behind the shop. Time your visit as roast pork tends to run out before 2 pm and the goose before 4 pm; or you can pre-order to avoid disappointment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=425P%20Queen's%20Road%20West%2C%20Western%20District%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Po Kee"
  />
);
