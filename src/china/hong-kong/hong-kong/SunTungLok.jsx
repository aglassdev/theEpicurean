...
const SunTungLok = () => (
  <RestaurantPage
    restaurantName="Sun Tung Lok"
    address="Shop 401, L4, FoodLoft, Mira Place One, 132 Nathan Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85221521417"
    website="https://www.suntunglok.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Synonymous with top-quality Cantonese cooking, Sun Tung Lok spares no effort to ensure that every item on the menu is as good as it could be. The experienced team is famous for its deft way with gourmet dried seafood, such as abalone. A number of set menus are available featuring the chef’s innovative creations and imported produce, while the à la carte menu caters more to the local palate. Try the crispy suckling pig stuffed with ‘bouncy’ minced shrimp...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20401%2C%20L4%2C%20FoodLoft%2C%20Mira%20Place%20One%2C%20132%20Nathan%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sun Tung Lok"
  />
);

export default SunTungLok;
