...
const Jeanpierre = () => (
  <RestaurantPage
    restaurantName="Jean-Pierre"
    address="9 Bridges Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="French"
    priceRange="$$"
    phoneNumber="+85221546101"
    website="https://www.jean-pierre.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal at this bistro transports you back to Paris in the Belle Époque. Art Nouveau motifs, scarlet velvet upholstery and flickering candle flame embody the joie de vivre of the last century. The menu is equally classic: expect the likes of beef tartare, duck confit and onion soup gratinée, served in silver platters and country-style bone china. In Poulet de Simone, local three-yellow chicken is stuffed with button mushrooms and roasted until golden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Bridges%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Jean-Pierre"
  />
);

export default Jeanpierre;
