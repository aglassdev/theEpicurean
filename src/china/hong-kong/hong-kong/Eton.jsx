...
const Eton = () => (
  <RestaurantPage
    restaurantName="Eton"
    address="1-2F, European Asian Bank Building, 749 Nathan Road, Mong Kok, Hong Kong, Hong Kong SAR China"
    cuisine="Shun Tak"
    priceRange="$$"
    phoneNumber="+85223815261"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/eton"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 2019, the long-standing household name Fung Shing closed its doors as the owner-chef retired. A regular customer and the staff then got together to re-open it as Eton in 2020. The room was renovated and about 80% of the kitchen and service teams returned. The menu is largely the same; dim sum, crispy fried chicken, deep-fried shrimp toast, scrambled egg white with milk in Daliang style, and Shun Tak fish tripe thick soup are still recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2F%2C%20European%20Asian%20Bank%20Building%2C%20749%20Nathan%20Road%2C%20Mong%20Kok%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Eton"
  />
);
