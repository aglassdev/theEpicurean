...
const FatBoy = () => (
  <RestaurantPage
    restaurantName="Fat Boy"
    address="3 Hau Fook Street, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85262553872"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/fat-boy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hong Kong-style snacks including octopus, pork liver & turkey gizzard marinated in soy sauce. Sweet sauce and mustard add to the flavour. The combo set offers great value with three signature items...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Hau%20Fook%20Street%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Fat Boy"
  />
);
