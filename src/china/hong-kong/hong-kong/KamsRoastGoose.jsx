...
const KamsRoastGoose = () => (
  <RestaurantPage
    restaurantName="Kam's Roast Goose"
    address="GF, Po Wah Commercial Center, 226 Hennessy Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese Roast Meats"
    priceRange="$$"
    phoneNumber="+85225201110"
    website="https://www.krg.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="For over 70 years, the Kams have been famous for their roast goose and this shop was opened by the third generation. But the goose extravaganza doesn’t stop at their juicy roast goose with crispy skin. Try also their silky, melty goose blood pudding or the decadent blanched noodles tossed in goose fat. Other Cantonese barbecue dishes glistening in the window are also worth trying. With only 30 seats, don’t be surprised to see a queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Po%20Wah%20Commercial%20Center%2C%20226%20Hennessy%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Kam's Roast Goose"
  />
);

export default KamsRoastGoose;
