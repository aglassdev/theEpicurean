...
const SangKeeFoodsWesternDistrict = () => (
  <RestaurantPage
    restaurantName="Sang Kee Foods (Western District)"
    address="263 Queen'S Road West, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85225474035"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/sang-kee-foods-western-district"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come to this place with a nose-to-tail concept for Chiuchow-style marinated goose. Made with grain-fed goose from Chiuchow, it boasts a firm texture and meaty flavour. Try the goose blood curd, web, wing, liver, intestine and gizzard, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=263%20Queen'S%20Road%20West%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sang Kee Foods (Western District)"
  />
);

export default SangKeeFoodsWesternDistrict;
