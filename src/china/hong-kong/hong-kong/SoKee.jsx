...
const SoKee = () => (
  <RestaurantPage
    restaurantName="So Kee"
    address="Shop 15, GF, Block A, Ho Shun Yee Building, 9 Fung Yau Street East, Yuen Long, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85290729135"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/so-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s just one item on the menu – double-steamed egg white custard with milk, boasting a silky runny centre under a firmer crust. Order the chilled ones if you’re in a rush, or wait patiently as the hot ones are made to order...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%2015%2C%20GF%2C%20Block%20A%2C%20Ho%20Shun%20Yee%20Building%2C%209%20Fung%20Yau%20Street%20East%2C%20Yuen%20Long%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="So Kee"
  />
);

export default SoKee;
