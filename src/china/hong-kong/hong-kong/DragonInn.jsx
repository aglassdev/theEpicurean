...
const DragonInn = () => (
  <RestaurantPage
    restaurantName="Dragon Inn"
    address="12 Tsing Ha Lane, Castle Peak Road, Tuen Mun, Hong Kong, Hong Kong SAR China"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+85224506366"
    website="https://www.1939dragoninn.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Tsing%20Ha%20Lane%2C%20Castle%20Peak%20Road%2C%20Tuen%20Mun%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Dragon Inn"
  />
);

export default DragonInn;
