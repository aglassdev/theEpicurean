...
const Owls = () => (
  <RestaurantPage
    restaurantName="Owl's"
    address="GF, 32 Mody Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85261995176"
    website="https://www.owlschouxcream.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll need to wait as the homemade choux pastries are filled on order with cream and custard of different flavours but, rest assured, the wait is worth it. Check out the occasional limited time offers. Take-out only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2032%20Mody%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Owl's"
  />
);
