...
const EngKeeNoodleShop = () => (
  <RestaurantPage
    restaurantName="Eng Kee Noodle Shop"
    address="GF, 32 High Street, Sai Ying Pun, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85225407950"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/eng-kee-noodle-shop"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run shop is always jam-packed with hungry locals craving Cantonese noodle soup. No matter for dine-in or take-out, expect a reasonable wait. It prides itself on its signature beef brisket – braised one night ahead and steeped in a spiced marinade overnight for silky tenderness and deep flavours. Their oven-grilled char siu is made with pork shoulder and pork neck and has a juicy, springy texture thanks to the fine marbling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2032%20High%20Street%2C%20Sai%20Ying%20Pun%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Eng Kee Noodle Shop"
  />
);

export default EngKeeNoodleShop;
