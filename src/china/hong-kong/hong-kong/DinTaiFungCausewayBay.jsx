...
const DinTaiFungCausewayBay = () => (
  <RestaurantPage
    restaurantName="Din Tai Fung (Causeway Bay)"
    address="Shop G3-G11, GF, 68 Yee Woo Street, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Shanghainese"
    priceRange="$$"
    phoneNumber="+85231608998"
    website="https://www.dintaifung.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The xiao long bao are good enough to justify the long queues – so worry not. Alongside the traditional soupy pork filling, they also come in novelty versions such as black truffle and angled luffa with shrimps. Ingredients are sourced from the same suppliers as its Taiwan flagship and the same kitchen team here delivers food in consistently high quality. Other standouts include double-boiled chicken soup and braised beef brisket noodle soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20G3-G11%2C%20GF%2C%2068%20Yee%20Woo%20Street%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Din Tai Fung (Causeway Bay)"
  />
);

export default DinTaiFungCausewayBay;
