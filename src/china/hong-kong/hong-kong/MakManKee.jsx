...
const MakManKee = () => (
  <RestaurantPage
    restaurantName="Mak Man Kee"
    address="51 Parkes Street, Jordan, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85227365561"
    website="https://www.mmk.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="No one is here for the no-frills interior, typical of any noodle shop in Hong Kong. This 60-year-old establishment is all about Cantonese wonton soup noodles – firm and bouncy prawns, visible through the paper-thin translucent skin, with springy duck egg noodles swimming in a flavourful broth. The noodles taste equally great when simply tossed in oyster sauce or shrimp roe, the latter also available as a pre-packaged condiment to go...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Parkes%20Street%2C%20Jordan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Mak Man Kee"
  />
);

export default MakManKee;
