...
const XinRongJiHON = () => (
  <RestaurantPage
    ...
    address="GF & 1F, China Overseas Building, 139 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Taizhou"
    priceRange="$$$$"
    phoneNumber="+85234623518"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/xin-rong-ji"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Taizhou cuisine emphasises the natural flavours of ingredients, so dishes are only sparingly seasoned with aromatics. Braised wild-caught yellow croaker from the East China Sea is the must-try signature here; other recommendations include deep-fried conger eel and braised radish. Seasonal offerings include regional specialities like lamb offal which is rarely found in Hong Kong. Certain items require pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%20%26%201F%2C%20China%20Overseas%20Building%2C%20139%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Xin Rong Ji"
  />
);

export default XinRongJiHON;
