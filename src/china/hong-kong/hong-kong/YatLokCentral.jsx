...
const YatLokCentral = () => (
  <RestaurantPage
    restaurantName="Yat Lok (Central)"
    address="GF, Conwell House, 34-38 Stanley Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese Roast Meats"
    priceRange="$$"
    phoneNumber="+85225243882"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/yat-lok"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Founded in 1957, this family business has been running at this spot since 2011. The unmissable, glistening roast geese are marinated with a secret recipe and go through over 20 preparatory steps before being chargrilled to perfection. You can order the goose by the quarter, best enjoyed with a bowl of lai fun noodles in clear broth with a drizzle of goose fat. Char siu, roast pork belly and soy-marinated chicken are also good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Conwell%20House%2C%2034-38%20Stanley%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yat Lok (Central)"
  />
);

export default YatLokCentral;
