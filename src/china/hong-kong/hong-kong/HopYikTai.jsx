...
const HopYikTai = () => (
  <RestaurantPage
    restaurantName="Hop Yik Tai"
    address="121 Kweilin Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85227200239"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/hop-yik-tai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu at this always busy shop features Hong Kong-style snacks like fish balls, pork skin and braised radish. The hugely popular rice rolls are silky-smooth, with a hint of richness from the lard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20Kweilin%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hop Yik Tai"
  />
);

export default HopYikTai;
