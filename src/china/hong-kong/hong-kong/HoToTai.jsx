...
const HoToTai = () => (
  <RestaurantPage
    restaurantName="Ho To Tai"
    address="67 Fau Tsoi Street, Yuen Long, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85224762495"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ho-to-tai-yuen-long"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional shops that make their own noodles from scratch are hard to come by. Founded in 1946, this household name is among the remaining few. Though the nostalgic two-storey shop draws a crowd with its signature wonton soup, zhajiang noodles and beef brisket noodle soup are also popular. Try braised white radish with shrimp roe for the deep umami and briny-sweetness. The owner also runs a dried noodle factory with retail outlets all over town...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20Fau%20Tsoi%20Street%2C%20Yuen%20Long%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ho To Tai"
  />
);

export default HoToTai;
