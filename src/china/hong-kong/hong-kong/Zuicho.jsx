...
const Zuicho = () => (
  <RestaurantPage
    ...
    address="GF, The Mercer Central, 29 Jervois Street, Sheung Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+85221561883"
    website="https://zuicho-kappo.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The head chef worked in some top-notch restaurants in Tokyo for years and imports all his ingredients from Japan. The highlight is Satsuma beef fillet with confit egg yolk – the beef melts in your mouth while the egg yolk imparts silky richness. You can order an omakase or a tasting menu at lunchtime, but only two omakase Kappo menus, which change monthly, are served at dinner. Seating is limited and booking mandatory. Ask for sake pairing recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20The%20Mercer%20Central%2C%2029%20Jervois%20Street%2C%20Sheung%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Zuicho"
  />
);
