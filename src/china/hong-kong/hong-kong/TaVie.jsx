...
const TaVie = () => (
  <RestaurantPage
    restaurantName="Ta Vie"
    address="2F, The Pottinger Hotel, 21 Stanley Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+85226686488"
    website="https://www.tavie.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The mantra of chef Hideaki Sato is “pure, simple and seasonal”. His passion for cooking and his experimental approach on food combinations are evidenced by his original and extraordinary creations made with top-notch ingredients mostly from his native Japan. The tasting menu is highly season-driven; sourdough and cultured butter made daily in-house are simply addictive. The wine list features interesting Asian vintages as well as sake and adds to the memorable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20The%20Pottinger%20Hotel%2C%2021%20Stanley%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ta Vie"
  />
);

export default TaVie;
