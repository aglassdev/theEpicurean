...
const SushiTakeshi = () => (
  <RestaurantPage
    restaurantName="Sushi Takeshi"
    address="GF, The Mira, 118-130 Nathan Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85293919392"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/sushi-takeshi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kin’s stints at famous sushi-ya in Hong Kong and Japan explain his exceptional sushi making skills and artistry. According to the oiliness of each fish, he pairs it with rice dressed in one of his two vinegar blends. A single omakase menu is served, composed entirely of ingredients flown in from Japan, such as umami-laden kuruma prawn that is perfectly cooked and boasts bouncy, juicy flesh. The lunchtime menu is a bargain. By reservation only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20The%20Mira%2C%20118-130%20Nathan%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sushi Takeshi"
  />
);

export default SushiTakeshi;
