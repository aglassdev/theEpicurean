...
const Beanmountain = () => (
  <RestaurantPage
    restaurantName="Beanmountain"
    address="GF, 1 Canal Road East, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85298418881"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/beanmountain"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 20 years, sugar fiends have been getting their fix of Chinese-style sweets here – from traditional crowd-pleasers such as put chai ko and Hakka tea cake made with stinkvine to novelty treats like mango sticky rice ball...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%201%20Canal%20Road%20East%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Beanmountain"
  />
);

export default Beanmountain;
