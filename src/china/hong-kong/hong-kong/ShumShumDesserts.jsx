...
const ShumShumDesserts = () => (
  <RestaurantPage
    restaurantName="Shum Shum Desserts"
    address="Shop C, GF, 46 Kweilin Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85252134579"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/shum-shum-desserts"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Classic Hongkongese and Taiwanese sweet soups on offer here include creamy coconut soup – a silky delight on its own but even better with chewy taro or sweet potato balls. Try also purple glutinous rice soup with elastic jelly cubes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20C%2C%20GF%2C%2046%20Kweilin%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Shum Shum Desserts"
  />
);

export default ShumShumDesserts;
