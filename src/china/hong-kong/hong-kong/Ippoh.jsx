...
const Ippoh = () => (
  <RestaurantPage
    restaurantName="Ippoh"
    address="39 Aberdeen Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Tempura"
    priceRange="$$$"
    phoneNumber="+85224680641"
    website="https://www.ippoh.com/hongkong.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now run by the fifth generation, this family business rooted in Osaka still strictly follows the traditional rules of making tempura. The owner-chef insists on battering and frying every morsel himself without delegating his duty. Seafood is flown in daily from Osaka and Toyosu fish market and they use flavourless safflower oil, so as not to overpower the ingredients’ natural tastes. The sauce is made to a secret recipe. Omakase is the best way to go. Bookings are essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Aberdeen%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ippoh"
  />
);

export default Ippoh;
