...
const ChuenKeeSeafoodHoiPongStreet = () => (
  <RestaurantPage
    restaurantName="Chuen Kee Seafood (Hoi Pong Street)"
    address="53 Hoi Pong Street, Sai Kung, Hong Kong, Hong Kong SAR China"
    cuisine="Seafood"
    priceRange="$$"
    phoneNumber="+85227911195"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/chuen-kee-seafood"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two family-run restaurants just a few minutes’ walk from each other have been in business since the 80s; choose the one by the quay for the rooftop terrace and harbour views. A wide array of seafood is available from adjacent fishmongers: cuttlefish, crab, lobster, molluscs, shrimps…Select your meal from the tank and ask the servers the best ways to cook it. Abalone and mantis shrimp in peppered salt are the smash hits not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Hoi%20Pong%20Street%2C%20Sai%20Kung%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Chuen Kee Seafood (Hoi Pong Street)"
  />
);

export default ChuenKeeSeafoodHoiPongStreet;
