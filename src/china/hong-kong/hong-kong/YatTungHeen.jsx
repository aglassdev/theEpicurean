...
const YatTungHeen = () => (
  <RestaurantPage
    restaurantName="Yat Tung Heen"
    address="B2F, Eaton Hotel, 380 Nathan Road, Jordan, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85227101093"
    website="https://www.yattungheen.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The dining room boasts dark wainscoting and moody lighting, making a refreshing break with its former conventional decor. Since 1990, the kitchen team has been crafting traditional but refined Cantonese fare that highlights the ingredient’s natural flavour. Dim sum, barbecued meats and stir fries are hugely popular. On top of the main menu, also check out seasonal offerings and slow-boiled soup of the day for its specific health benefits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B2F%2C%20Eaton%20Hotel%2C%20380%20Nathan%20Road%2C%20Jordan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yat Tung Heen"
  />
);

export default YatTungHeen;
