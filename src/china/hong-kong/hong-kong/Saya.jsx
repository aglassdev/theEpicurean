...
const Saya = () => (
  <RestaurantPage
    restaurantName="Saya"
    address="Shop G701, GF, Square Mile II, 18 Ka Shin Street, Tai Kok Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Thai"
    priceRange="$$"
    phoneNumber="+85295558452"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/saya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A turquoise colour scheme, rattan furniture and wall coverings impart a retro tropical vibe. The menu is dominated by Isan cuisine from Northeast Thailand, intelligently crafted by a Thai kitchen team. Laab Moo Isan tastes tangy and spicy; diced pig ears add crunchy texture to the ground pork salad. Aroma-laden khao soy features coconut milk curry and chargrilled chicken. The generous portions make it a great spot for friendly get-togethers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20G701%2C%20GF%2C%20Square%20Mile%20II%2C%2018%20Ka%20Shin%20Street%2C%20Tai%20Kok%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Saya"
  />
);
