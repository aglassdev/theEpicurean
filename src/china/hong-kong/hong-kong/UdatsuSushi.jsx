...
const UdatsuSushi = () => (
  <RestaurantPage
    restaurantName="Udatsu Sushi"
    address="GF, Stable Block, FWD House 1881, 2A Canton Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85257294188"
    website="https://udatsu-sushi.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At a counter made out of an ancient cypress tree that only seats 12, this sushi-ya endeavours to offer a global experience, including jazz playing softly in the background. The first overseas outpost of its Tokyo namesake is helmed by chef Nakamura, a protégé of chef Udatsu. The single omakase menu showcases quality ingredients, mostly from Japan, alongside some local fish and veggies. Rice is dressed in one of two vinegars depending on the fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Stable%20Block%2C%20FWD%20House%201881%2C%202A%20Canton%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Udatsu Sushi"
  />
);

export default UdatsuSushi;
