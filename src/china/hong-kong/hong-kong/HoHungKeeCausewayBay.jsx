...
const HoHungKeeCausewayBay = () => (
  <RestaurantPage
    restaurantName="Ho Hung Kee (Causeway Bay)"
    address="Shop 1204-1205, 12F, Hysan Place, 500 Hennessy Road, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles and Congee"
    priceRange="$$"
    phoneNumber="+85225776028"
    website="https://www.tasty.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="No discussion about Hong Kong’s historic noodle shops would be complete without mentioning Ho Hung Kee, which originally opened in Wan Chai in the 1940s and is famed for its springy wonton noodles and fresh, sweet soup. More elements have been added here at its new address – dim sum and some Cantonese dishes are now served too. For the interior, they’ve adopted a more contemporary, Western style aesthetic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%201204-1205%2C%2012F%2C%20Hysan%20Place%2C%20500%20Hennessy%20Road%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ho Hung Kee (Causeway Bay)"
  />
);

export default HoHungKeeCausewayBay;
