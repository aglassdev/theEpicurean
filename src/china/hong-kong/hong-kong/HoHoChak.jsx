...
const HoHoChak = () => (
  <RestaurantPage
    restaurantName="Ho Ho Chak"
    address="9F, Nathan Hill, 38 Hillwood Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Chiu Chow"
    priceRange="$$"
    phoneNumber="+85290722887"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ho-ho-chak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The apt moniker of this Chiu Chow restaurant is Ho Ho Chak, which means ‘delicious’ in Teochew dialect. The three brothers who run the joint also wholesale seafood and fruit, so they have reliable access to the best ingredients. The signature steamed pork patty with mud crab is loaded with buttery roe while the pork is springy and finely textured. Fried omelette with dried radish and ground pork is browned on the outside and custardy on the inside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9F%2C%20Nathan%20Hill%2C%2038%20Hillwood%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ho Ho Chak"
  />
);

export default HoHoChak;
