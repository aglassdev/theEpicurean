...
const Jija = () => (
  <RestaurantPage
    restaurantName="Jija"
    address="15F, Kimpton Hotel, 11 Middle Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$"
    phoneNumber="+85235018555"
    website="https://www.jijarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Jija’ is the Cantonese equivalent of a gabfest, where people connect and have fun. Chef Vicky Lau has appointed this sea-view room in dark wood, chrome trims and soft lighting. The menu rolls out authentic Guizhou and Yunnan fare, pepped up with modern, creative touches. House-made pickles, cured meats and cheese rub shoulders with fresh produce from both provinces to showcase intense flavours and nuanced textures. Check out their selection of Yunnanese teas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15F%2C%20Kimpton%20Hotel%2C%2011%20Middle%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Jija"
  />
);
