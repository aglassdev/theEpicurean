...
const TeppanyakiMiharaGoten = () => (
  <RestaurantPage
    restaurantName="Teppanyaki Mihara Goten"
    address="3F, Cubus, 1 Hoi Ping Road, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Teppanyaki"
    priceRange="$$$"
    phoneNumber="+85253943689"
    website="https://www.csccollective.com/venues/Teppanyaki-Mihara-GOTEN"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After moving from Tsueng Kwan O to bustling Causeway Bay, this 14-seater is hidden behind a sukiyaki joint and a cocktail bar. As always, chef Mihara champions a kappo-style teppanyaki experience using the freshest produce flown in from Japan. In addition to teppanyaki staples such as seafood and beef, his tasting menus include less commonly seen griddle items – silky, umami-laden chawanmushi, and donabe with foie gras, crab, fish or eel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Cubus%2C%201%20Hoi%20Ping%20Road%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Teppanyaki Mihara Goten"
  />
);

export default TeppanyakiMiharaGoten;
