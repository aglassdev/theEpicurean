...
const Wing = () => (
  <RestaurantPage
    restaurantName="Wing"
    address="29F, The Wellington, 198 Wellington Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+85227110063"
    website="https://wingrestaurant.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The second venture from owner-chef Vicky Cheng who runs the well-acclaimed Vea upstairs, Wing is named after his Chinese name, meaning eternity. The tasting menu features contemporary Chinese courses made with mostly local ingredients but underpinned by European techniques. He reinterprets classic recipes and familiar flavours with creative twists and playful food combinations. Online reservations open at midnight for up to 28 days ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29F%2C%20The%20Wellington%2C%20198%20Wellington%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Wing"
  />
);
