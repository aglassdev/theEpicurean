...
const SushiSaito = () => (
  <RestaurantPage
    ...
    address="45F, Four Seasons Hotel, 8 Finance Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85225270811"
    website="https://globallink.com.hk/our-brands/sushi-saito"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Supervised and managed by famed Chef Takashi Saito, the team masterfully crafts Edomae-style sushi using the best seasonal seafood. Rice from Akita and Nagano is cooked in spring water from Kagoshima and dressed in a special vinegar blend. But before you get to taste these divine creations at the cypress counter, you must first get a seat, which are always hard to come by – the reservation hotline only works during specific days and times...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45F%2C%20Four%20Seasons%20Hotel%2C%208%20Finance%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sushi Saito"
  />
);

export default SushiSaito;
