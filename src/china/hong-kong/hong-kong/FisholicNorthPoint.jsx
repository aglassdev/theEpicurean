...
const FisholicNorthPoint = () => (
  <RestaurantPage
    restaurantName="Fisholic (North Point)"
    address="Shop 14, GF, Victor Court, 14-28 Wang On Road, North Point, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85235904930"
    website="https://www.fisholic.hk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Famous for snacks and noodles made with fish, this stall sells playful items like deep-fried minced fish in the guise of French fries, or fish skin nachos. Fishotto, where minced fish is shaped like rice grains, is also good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%2014%2C%20GF%2C%20Victor%20Court%2C%2014-28%20Wang%20On%20Road%2C%20North%20Point%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Fisholic (North Point)"
  />
);

export default FisholicNorthPoint;
