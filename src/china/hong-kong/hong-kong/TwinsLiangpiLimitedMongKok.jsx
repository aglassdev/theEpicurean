...
const TwinsLiangpiLimitedMongKok = () => (
  <RestaurantPage
    restaurantName="Twins Liangpi Limited (Mong Kok)"
    address="GF, 99 Hak Po Street, Mong Kok, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85293610304"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/twins-liangpi-limited-prince-edward"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now with a dine-in option, the shop has moved to Mong Kok. Glass noodles dressed in a secret blend of chilli vinegar are topped with shredded cucumber, coriander, peas and ground peanuts. Choose your preferred level of spiciness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2099%20Hak%20Po%20Street%2C%20Mong%20Kok%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Twins Liangpi Limited (Mong Kok)"
  />
);

export default TwinsLiangpiLimitedMongKok;
