...
const ToscaDiAngelo = () => (
  <RestaurantPage
    restaurantName="Tosca di Angelo"
    address="102F, The Ritz-Carlton, International Commerce Centre, 1 Austin Road West, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+85222632270"
    website="https://www.toscadiangelo.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Sicilian chef champions dishes that may look deceptively unfussy on the plate, but their obvious refinement makes them especially delicious. His signatures include house-made pasta and blue lobster dishes, while his modern take on rum babà is quite something. The set menu comprises seasonal and signature dishes, making it the best way to sample all specialities. Did I mention its sweeping views from the 102nd floor?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=102F%2C%20The%20Ritz-Carlton%2C%20International%20Commerce%20Centre%2C%201%20Austin%20Road%20West%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Tosca di Angelo"
  />
);

export default ToscaDiAngelo;
