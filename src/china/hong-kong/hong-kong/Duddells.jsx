...
const Duddells = () => (
  <RestaurantPage
    restaurantName="Duddell's"
    address="3F, 1 Duddell Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85225259191"
    website="https://www.duddells.co/home/en"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Duddell’s is as much about art as it is about food. It is the venue of regular art shows and screenings, as well as traditional Cantonese fare using luxury ingredients. Certain dishes need pre-ordering, such as the crispy skin chicken over which the chef ladles hot oil 300+ times to make the paper-thin skin crispy and the meat silky. Osmanthus scrambled eggs with bean sprouts, crabmeat and shrimp are fluffy and aromatic, imparting fine wok hei...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%201%20Duddell%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Duddell's"
  />
);

export default Duddells;
