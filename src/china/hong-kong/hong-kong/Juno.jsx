...
const Juno = () => (
  <RestaurantPage
    restaurantName="Juno"
    address="GF, 88 Wing Lok Street, Sheung Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+85227035188"
    website="https://www.juno.hk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mint green façade with brushed brass trimming leads into a bright interior decked in wood, marble and travertine. Hailing from Barcelona, Spain, chef Jordi Vallés Claverol crafts a concise Mediterranean-inspired menu reminiscent of sunny southern Europe. Start your journey with house-made rosemary focaccia, best enjoyed with small sharing plates like charcoal peperonata. The baked Cote d’Azur seabass with crisp skin and juicy flesh is another must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2088%20Wing%20Lok%20Street%2C%20Sheung%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Juno"
  />
);
