...
const Gaddis = () => (
  <RestaurantPage
    restaurantName="Gaddi's"
    address="1F, The Peninsula Hotel, Salisbury Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+85226966763"
    ...
    bio="Once the famed hotel's grand ballroom, Gaddi's is known for its authentic, lavish decor, warm, meticulous service and impeccably crafted dishes. With chef Anne-Sophie Nicolas at the helm – its first female chef since it opened in 1953 – the legendary institution is ushering in a new era. Expect legacy recipes jazzed up with creative twists. The pan-seared Norwegian langoustine, cooked to perfection and boasting intense umami, is the must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20The%20Peninsula%20Hotel%2C%20Salisbury%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Gaddi's"
  />
);

export default Gaddis;
