...
const KiTsui = () => (
  <RestaurantPage
    restaurantName="Ki Tsui"
    address="135 Fa Yuen Street, Mong Kok, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85223941727"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/kei-tsui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite the small size, this shop offers a wide array of Cantonese traditional puddings and pastries like Xiaofeng cake and walnut cookies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=135%20Fa%20Yuen%20Street%2C%20Mong%20Kok%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ki Tsui"
  />
);

export default KiTsui;
