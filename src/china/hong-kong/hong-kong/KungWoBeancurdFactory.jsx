...
const KungWoBeancurdFactory = () => (
  <RestaurantPage
    restaurantName="Kung Wo Beancurd Factory"
    address="118 Pei Ho Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85223866871"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/kung-wo-tofu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1893, this much-loved shop has been making its own tofu that exudes a deep, rich soy aroma. The tofu pudding is a must-try. With murals that depict tofu being made, the room is styled to attract a younger crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=118%20Pei%20Ho%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Kung Wo Beancurd Factory"
  />
);

export default KungWoBeancurdFactory;
