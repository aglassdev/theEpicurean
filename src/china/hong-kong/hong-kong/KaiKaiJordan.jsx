...
const KaiKaiJordan = () => (
  <RestaurantPage
    restaurantName="Kai Kai (Jordan)"
    address="29 Ning Po Street, Jordan, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85223843862"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/kai-kai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These traditional Chinese sweet soups, such as tofu skin soup with ginkgo and Job's tears, or black sesame soup, are rife with flavour. Some can be combined for two flavours in one bowl. Long queues – come armed with patience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Ning%20Po%20Street%2C%20Jordan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Kai Kai (Jordan)"
  />
);

export default KaiKaiJordan;
