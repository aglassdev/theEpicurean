...
const YShanghaiTsimShaTsui = () => (
  <RestaurantPage
    restaurantName="Yè Shanghai (Tsim Sha Tsui)"
    address="702, 7F, K11 Musea, 18 Salisbury Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Shanghainese"
    priceRange="$$"
    phoneNumber="+85223763322"
    website="https://www.elite-concepts.com/home/main/en"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It may have moved to a swanky mall in 2020, but this household name in Shanghainese food has been on the radar of gastronomes for over two decades. The room is spread across two floors with a modern take on 1930s Shanghai charm. Apart from drunken chicken, and stir-fried river shrimps, try also their cold appetiser sliced pork dressed in garlic sauce – the paper-thin pork is springy in texture, and its richness is balanced by garlic and soy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=702%2C%207F%2C%20K11%20Musea%2C%2018%20Salisbury%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yè Shanghai (Tsim Sha Tsui)"
  />
);

export default YShanghaiTsimShaTsui;
