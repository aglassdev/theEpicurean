...
const TwistBuckle = () => (
  <RestaurantPage
    ...
    address="29-31 Chatham Road South, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85246473280"
    website="https://twistandbuckle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two young South Americans opened this shop specialising in churros. Besides the traditional version with cinnamon sugar, also try them glazed, in dips like dulce de leche and salted caramel, or even in sundaes with ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29-31%20Chatham%20Road%20South%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Twist & Buckle"
  />
);

export default TwistBuckle;
