...
const BaYi = () => (
  <RestaurantPage
    restaurantName="Ba Yi"
    address="43 Water Street, Sai Ying Pun, Hong Kong, Hong Kong SAR China"
    cuisine="Xinjiang"
    priceRange="$$"
    phoneNumber="+85224849981"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ba-yi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite being somewhat out of the way, lamb-lovers gather here in numbers for items such as stewed lamb and mutton skewers, prepared by the Xinjiangese kitchen team. The signature roasted lamb leg is big enough to share between two and needs pre-ordering. Besides lamb, it’s also worth trying the chicken stew with potato and chilli, as well as the Ketik yoghurt drink. The dining room still features the map of the Silk Road on a stretched canvas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20Water%20Street%2C%20Sai%20Ying%20Pun%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ba Yi"
  />
);
