...
const MakKeeMayKaMansion = () => (
  <RestaurantPage
    restaurantName="Mak Kee (May Ka Mansion)"
    address="Shop 1, May Ka Mansion, 21 Fort Street, North Point, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85228877851"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/mak-kee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop serves Shanghainese delicacies made fresh daily, such as pot-stickers, pan-fried pork buns and sour and hot noodle soup. Scallion pancakes are available from 3pm until they run out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%201%2C%20May%20Ka%20Mansion%2C%2021%20Fort%20Street%2C%20North%20Point%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Mak Kee (May Ka Mansion)"
  />
);

export default MakKeeMayKaMansion;
