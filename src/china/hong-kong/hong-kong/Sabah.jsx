...
const Sabah = () => (
  <RestaurantPage
    restaurantName="Sabah"
    address="Shop 1, GF, Pao Woo Mansion, 177-179 Wan Chai Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Malaysian"
    priceRange="$$"
    phoneNumber="+85259222218"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/sabah"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sabah, a staple of Wan Chai’s restaurant scene for 18 years, shuttered its doors in 2019 before reopening here with the same kitchen team. Both the room and the menu are downsized, but signatures like bak kut teh, beef rendang, and seafood laksa remain, tasting just like before. Boneless Hainan chicken rice boasts bouncy skin and velvety juicy flesh. Even the trio of dips and pearl rice are also hard to find fault with...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%201%2C%20GF%2C%20Pao%20Woo%20Mansion%2C%20177-179%20Wan%20Chai%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sabah"
  />
);
