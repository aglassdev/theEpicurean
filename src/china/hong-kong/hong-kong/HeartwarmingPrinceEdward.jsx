...
const HeartwarmingPrinceEdward = () => (
  <RestaurantPage
    restaurantName="Heartwarming (Prince Edward)"
    address="23 Yu Chau Street, Prince Edward, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85237956565"
    website="https://bt-warm.com.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With black sesame seeds ground non-stop by the two stone mills at the door, you can tell what this shop is famous for – sweet black sesame soup, ice cream, pudding… and black sesame rolls prized for their intense flavour and chewy texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20Yu%20Chau%20Street%2C%20Prince%20Edward%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Heartwarming (Prince Edward)"
  />
);

export default HeartwarmingPrinceEdward;
