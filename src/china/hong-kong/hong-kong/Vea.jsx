...
const Vea = () => (
  <RestaurantPage
    restaurantName="Vea"
    address="30F, The Wellington, 198 Wellington Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+85227118639"
    website="https://vea.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="An imposing counter and an open kitchen dominate the room, commanding the best view of chef Cheng in action. You are definitely in for a stellar experience, thanks to his 8-course tasting menu that rolls out a “Chinese x French” concept. Each course tells a story about Hong Kong’s food culture and his childhood memories, using Chinese and local ingredients finessed by blue-ribbon Gallic technique. Creative cocktail-food pairing suggestions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30F%2C%20The%20Wellington%2C%20198%20Wellington%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Vea"
  />
);
