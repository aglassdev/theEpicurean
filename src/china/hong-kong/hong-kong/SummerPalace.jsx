...
const SummerPalace = () => (
  <RestaurantPage
    ...
    address="5F, Island Shangri-La Hotel, Pacific Place, Supreme Court Road, Admiralty, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85228208552"
    website="https://www.shangri-la.com/hongkong/islandshangrila/dining/restaurants/summer-palace/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This long-standing name has long been synonymous with quality food, so it’s hard to get a table, especially at lunch. The room exudes a timeless grace with décor inspired by the palace in Beijing. The menu is a roll-call of Cantonese classics – don’t miss their double-boiled soups and dim sum. Besides signatures like braised pig’s trotters with sand ginger, and braised Yoshihama abalone in oyster sauce, also ask about their seasonal offerings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Island%20Shangri-La%20Hotel%2C%20Pacific%20Place%2C%20Supreme%20Court%20Road%2C%20Admiralty%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Summer Palace"
  />
);

export default SummerPalace;
