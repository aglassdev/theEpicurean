...
const KwanKeeBambooNoodles = () => (
  <RestaurantPage
    restaurantName="Kwan Kee Bamboo Noodles"
    address="Shop E, 1 Wing Lung Street, Cheung Sha Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85234849126"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/kwan-kee-bamboo-noodles-cheung-sha-wan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s inside a local market but easy to spot, thanks to the big yellow sign. Watch the kitchen at work through the glass wall as noodles are made the traditional way – with the chef seesawing on a bamboo pole to painstakingly knead the egg-rich dough for that stringy texture. Secret techniques are deployed to remove the soapy taste of lye and accentuate the eggy flavour. Don’t miss the signature noodles tossed in shrimp roe and oyster sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20E%2C%201%20Wing%20Lung%20Street%2C%20Cheung%20Sha%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Kwan Kee Bamboo Noodles"
  />
);

export default KwanKeeBambooNoodles;
