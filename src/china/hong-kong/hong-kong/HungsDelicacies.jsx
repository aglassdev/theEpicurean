...
const HungsDelicacies = () => (
  <RestaurantPage
    restaurantName="Hung's Delicacies"
    address="Shop B01, Lower Level, Tower 535, 535 Jaffe Road, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Chiu Chow"
    priceRange="$$"
    phoneNumber="+85228310188"
    website="https://www.hungsdelicacies.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Hung, who has enjoyed a career spanning 50+ years, started the brand in 2003, since when it has moved several times. As always, Chiuchow cuisine, especially marinated meat and offal, is the main event. Marinated goose boasts robust meaty flavour and delicate seasoning. Hung’s signature fried rice seduces with pronounced wok hei; goose meat, XO sauce and sakura shrimps add to the complex, alluring depth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20B01%2C%20Lower%20Level%2C%20Tower%20535%2C%20535%20Jaffe%20Road%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hung's Delicacies"
  />
);

export default HungsDelicacies;
