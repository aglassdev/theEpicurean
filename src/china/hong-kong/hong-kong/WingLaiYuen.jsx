...
const WingLaiYuen = () => (
  <RestaurantPage
    restaurantName="Wing Lai Yuen"
    address="Shop 102-105, 1F, Gourmet Place, Whampoa Plaza, Site 8, Whampoa Garden, 7 Tak On Street, Hung Hom, Hong Kong, Hong Kong SAR China"
    cuisine="Shanghainese, Sichuan"
    priceRange="$$"
    phoneNumber="+85223206430"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/wing-lai-yuen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Originally a run-down shop in a squatter village, this eatery moved here in 2000. But one thing has never changed – the food is as delicious and affordably priced as ever. The signature Dan Dan noodles come in two versions: one with ground pork and one without, and can be paired with a spicy or mild broth. Whole mandarin fish is prepared in Sichuan Shuizhu style or in a sweet and sour sauce. The portions are big enough for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20102-105%2C%201F%2C%20Gourmet%20Place%2C%20Whampoa%20Plaza%2C%20Site%208%2C%20Whampoa%20Garden%2C%207%20Tak%20On%20Street%2C%20Hung%20Hom%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Wing Lai Yuen"
  />
);

export default WingLaiYuen;
