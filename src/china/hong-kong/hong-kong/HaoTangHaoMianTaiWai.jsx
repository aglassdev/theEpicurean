...
const HaoTangHaoMianTaiWai = () => (
  <RestaurantPage
    restaurantName="Hao Tang Hao Mian (Tai Wai)"
    address="GF, 20 Chik Chuen Street, Tai Wai, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$$"
    phoneNumber="+85228135077"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/hao-tang-hao-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An owner-chef with over 20 years of experience in French cooking opened this 20-seater specialising in just 12 noodle soup items, each with a specific soup base and topping. The signature flat noodles in beef soup with Sichuanese beef cheek and French-style braised oxtail takes two days to make, involving eclectic techniques. The dessert menu is equally impressive – try the all-natural sorbets made in-house with fresh fruits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2020%20Chik%20Chuen%20Street%2C%20Tai%20Wai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hao Tang Hao Mian (Tai Wai)"
  />
);

export default HaoTangHaoMianTaiWai;
