...
const SeventhSonWanChai = () => (
  <RestaurantPage
    restaurantName="Seventh Son (Wan Chai)"
    address="3F, The Wharney Hotel, 57-73 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85228922888"
    website="https://www.seventhson.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name refers to the owner – the seventh son who learned his culinary skills from his father from the age of 14. The must-try barbecue meats include roast suckling pig which is smoky and rich. The skills of the kitchen team are manifest in traditional dishes like deep-fried egg custard with chicken kidney, and steamed beef patty with dried tangerine peel. The smart room comes complete with teak floors, gold accents and warm lighting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20The%20Wharney%20Hotel%2C%2057-73%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Seventh Son (Wan Chai)"
  />
);

export default SeventhSonWanChai;
