...
const YingJeeClub = () => (
  <RestaurantPage
    restaurantName="Ying Jee Club"
    address="Shop G05, 107-108, GF & 1F, Nexxus Building, 41 Connaught Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85228016882"
    website="https://yingjeeclub.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Rather than gimmicky promotions, the owner prefers to devote his energy and resources into sourcing quality ingredients and honing the chefs’ skills. The tasteful, modern room adorned with marble tables, velvet seats and metallic trim primes the diners for Cantonese classics with a delicate twist. Crispy salted chicken is silky and tender; sautéed lobster with sea whelk, water chestnut and crispy conpoy delivers umami and interesting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20G05%2C%20107-108%2C%20GF%20%26%201F%2C%20Nexxus%20Building%2C%2041%20Connaught%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ying Jee Club"
  />
);

export default YingJeeClub;
