...
const YuCausewayBay = () => (
  <RestaurantPage
    restaurantName="Yuè (Causeway Bay)"
    address="Shop 1301, Food Forum, Time Square, 1 Matheson Street, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85228383968"
    website="https://lubuds.com/yue-times-square-causeway-bay"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having worked in some prestigious kitchens in Japan and Macau for over 40 years, the chef designed a menu of refined Cantonese dishes using top-notch ingredients from around the world, such as Alaskan king crab, Japanese chillies and Taiwanese bird’s-nest fern. The classic sweet and sour pork is given a new spin with aged vinegar and dried plums, plus an option of plant-based ‘meat’. Private rooms in various sizes are perfect for parties...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%201301%2C%20Food%20Forum%2C%20Time%20Square%2C%201%20Matheson%20Street%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Yuè (Causeway Bay)"
  />
);

export default YuCausewayBay;
