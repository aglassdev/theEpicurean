...
const BananaBoy = () => (
  <RestaurantPage
    restaurantName="Banana Boy"
    address="Shop 18, GF, Shun Fung Building, 5-7 Fung Yau Street North, Yuen Long, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/banana-boy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its à la minute banana roti has been reputed for its crispy skin and tender filling since 2019. The shop reopened in 2024 in this spot, with Nutella, Ovaltine, pork floss with mozzarella and new flavours in the menu. It's always busy, so expect to queue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%2018%2C%20GF%2C%20Shun%20Fung%20Building%2C%205-7%20Fung%20Yau%20Street%20North%2C%20Yuen%20Long%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Banana Boy"
  />
);

export default BananaBoy;
