...
const Forum = () => (
  <RestaurantPage
    restaurantName="Forum"
    address="1F, Sino Plaza, 255-257 Gloucester Road, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$$"
    phoneNumber="+85228698282"
    website="http://www.forumrestaurant1977.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Co-founder and chef of this upmarket spot, the late Yeung Koon-yat – aka the abalone king – created the iconic Ah Yat braised abalone decades ago. To this day, it remains the speciality that attracts food-loving crowds from near and far. As well as the tender and flavourful abalone, classics such as pan-seared leopard coral grouper fillet and baked stuffed crab shell are nicely made. The extensive wine list showcases boutique wineries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Sino%20Plaza%2C%20255-257%20Gloucester%20Road%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Forum"
  />
);
