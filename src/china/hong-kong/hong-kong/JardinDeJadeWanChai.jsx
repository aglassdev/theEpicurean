...
const JardinDeJadeWanChai = () => (
  <RestaurantPage
    restaurantName="Jardin de Jade (Wan Chai)"
    address="G3-4, GF, Sun Hung Kai Centre, 30 Harbour Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Shanghainese"
    priceRange="$$"
    phoneNumber="+85235280228"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/jardin-de-jade-wan-chai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The first Hong Kong venture of the renowned Shanghai restaurant group is certainly not lacking in grandeur, with its double-height ceiling and striking chandelier. Shanghainese classics and dim sum are made the traditional way but with updated presentation. The xiao long bao with beautifully pleated paper-thin skin, soupy filling and spot-on seasoning is the jewel in the crown. The seasonal menu covers regional specialities from beyond Shanghai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=G3-4%2C%20GF%2C%20Sun%20Hung%20Kai%20Centre%2C%2030%20Harbour%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Jardin de Jade (Wan Chai)"
  />
);

export default JardinDeJadeWanChai;
