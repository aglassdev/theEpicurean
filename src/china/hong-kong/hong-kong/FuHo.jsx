...
const FuHo = () => (
  <RestaurantPage
    restaurantName="Fu Ho"
    address="Shop 402, 4F, FoodLoft, Mira Place One, 132 Nathan Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85227362228"
    website="https://www.fuho.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thanks to his considerable experience and skilfully executed dishes, the head chef has been enticing diners back here for over a decade. Named after the owner, the signature Ah Yung abalone is slowly braised in a secret sauce for up to 20 hours. Fried hump-head garoupa served in a claypot is perfumed with ginger, garlic, scallion and cilantro and boasts bouncy skin and crisp tasty meat. The dining room feels elegant and relaxing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20402%2C%204F%2C%20FoodLoft%2C%20Mira%20Place%20One%2C%20132%20Nathan%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Fu Ho"
  />
);
