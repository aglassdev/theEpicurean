...
const EightOneHalfOttoEMezzoBombana = () => (
  <RestaurantPage
    restaurantName="8 1/2 Otto e Mezzo - Bombana"
    address="Shop 202, 2F, Alexandra House, 18 Chater Road, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+85225378859"
    website="https://www.ottoemezzobombana.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Owner-chef Umberto Bombana’s restaurant, which oozes Italian charm and passion from every pore, is named after one of the chef’s favourite Fellini films. The classical Italian lineup stars first-class ingredients, like lamb from Aveyron, scallops from Hokkaido and Wagyu beef from Australia. The pasta course is always a highlight – scampi risotto and trenette with sea urchin are just two of the standouts. The delightful service makes everyone feel special...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20202%2C%202F%2C%20Alexandra%20House%2C%2018%20Chater%20Road%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="8 1/2 Otto e Mezzo - Bombana"
  />
);

export default EightOneHalfOttoEMezzoBombana;
