...
const KeungKee = () => (
  <RestaurantPage
    restaurantName="Keung Kee"
    address="406 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85225725207"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/keung-kee-1198877"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glutinous rice with preserved meat is the must-try with plump, bouncy rice. Feel free to order an extra of cured Cantonese pork sausage or duck liver sausage. Wok-fried rice rolls and pork bone congee are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=406%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Keung Kee"
  />
);

export default KeungKee;
