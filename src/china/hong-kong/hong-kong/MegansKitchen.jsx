...
const MegansKitchen = () => (
  <RestaurantPage
    restaurantName="Megan's Kitchen"
    address="5F, Lucky Centre, 165-171 Wan Chai Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85228668305"
    website="https://meganskitchen.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu offers many Cantonese dishes, but steamed minced beef patty with dried mandarin peel, and Yu Xiang eggplant in claypot stand out in particular. Better still, all mains come with complimentary rice, soup and dessert. Their famous hot pots spoil diners with an array of soup bases and good quality ingredients. Those who prefer a little privacy will appreciate the booth seating with sliding screens as dividers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Lucky%20Centre%2C%20165-171%20Wan%20Chai%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Megan's Kitchen"
  />
);

export default MegansKitchen;
