...
const MrsFongChineseDesserts = () => (
  <RestaurantPage
    restaurantName="Mrs. Fong Chinese Desserts"
    address="198 Temple Street, Jordan, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85256285486"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/mrs-fong-chinese-desserts"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This busy family-run shop moved here in 2022. Over 10 Chinese sweets are made from scratch daily, such as red bean cake or put-chai cake. Black sesame roll is especially prized for its soft-springy texture and deep flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=198%20Temple%20Street%2C%20Jordan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Mrs. Fong Chinese Desserts"
  />
);

export default MrsFongChineseDesserts;
