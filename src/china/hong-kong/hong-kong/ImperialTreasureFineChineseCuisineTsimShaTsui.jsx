...
const ImperialTreasureFineChineseCuisineTsimShaTsui = () => (
  <RestaurantPage
    restaurantName="Imperial Treasure Fine Chinese Cuisine (Tsim Sha Tsui)"
    address="10F, One Peking, 1 Peking Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85226139800"
    website="https://www.imperialtreasure.com/hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Finding success in Singapore and Shanghai, Imperial Treasure opened its first Hong Kong branch in this sky-scrapping landmark, with panoramic views of the harbour. The stylish dining room is embellished with subtle Chinese touches, such as the ceramic Koi carps and calligraphy. A fish tank in the kitchen ensures live seafood is available every day. Poached garoupa in fish soup with crispy rice and stir fried crab in pepper are worth a try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%20One%20Peking%2C%201%20Peking%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Imperial Treasure Fine Chinese Cuisine (Tsim Sha Tsui)"
  />
);

export default ImperialTreasureFineChineseCuisineTsimShaTsui;
