...
const LauSumKeeFukWingStreet = () => (
  <RestaurantPage
    restaurantName="Lau Sum Kee (Fuk Wing Street)"
    address="82 Fuk Wing Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles"
    priceRange="$"
    phoneNumber="+85223863583"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/lau-sum-kee-fuk-wing-street"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1956, this branch (and the original shop around the corner) has been packed with customers buzzing in and out. The third-generation family business still kneads noodle dough with a bamboo pole, like it used to be done, for that springy texture. Wontons are made on the spot with whole prawns and pork; even the crunchy radish pickles are homemade. Wonton noodles are a must; you can choose one or two more toppings if you like...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20Fuk%20Wing%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Lau Sum Kee (Fuk Wing Street)"
  />
);

export default LauSumKeeFukWingStreet;
