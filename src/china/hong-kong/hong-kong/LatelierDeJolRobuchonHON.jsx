...
const LatelierDeJolRobuchonHON = () => (
  <RestaurantPage
    restaurantName="L'Atelier de Joël Robuchon"
    address="Shops 403-410, 4F, Landmark Atrium, 15 Queen's Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+85221669000"
    website="https://www.robuchon.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the wake of a recent refurbishment, this outpost of the global brand is bigger and better. The main dining room exudes timeless elegance, while counter seats offer a fascinating insight into the action. Gallic cuisine sets the scene of the score with top-notch produce sourced from all over the world. Start with the beetroot tart, followed by blue lobster with their signature mashed potato. For a final slather of indulgence, make your pick from the iconic dessert trolley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shops%20403-410%2C%204F%2C%20Landmark%20Atrium%2C%2015%20Queen's%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="L'Atelier de Joël Robuchon"
  />
);

export default LatelierDeJolRobuchonHON;
