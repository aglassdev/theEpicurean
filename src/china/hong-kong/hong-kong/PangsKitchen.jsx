...
const PangsKitchen = () => (
  <RestaurantPage
    restaurantName="Pang's Kitchen"
    address="25 Yik Yam Street, Happy Valley, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85228385462"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/pang-s-kitchen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A household name in the neighbourhood since 2001, this restaurant wins many hearts with its traditional, often painstakingly made Cantonese cooking. This family business, now into the second generation, still impresses with its consistently well-made dishes. The signature baked fish tripe omelette in an earthenware casserole features Cantonese pork sausage that adds richness and wine aromas. Try the snake soup, and stir-fried sticky rice, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Yik%20Yam%20Street%2C%20Happy%20Valley%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Pang's Kitchen"
  />
);

export default PangsKitchen;
