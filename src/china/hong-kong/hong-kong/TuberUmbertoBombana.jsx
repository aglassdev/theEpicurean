...
const TuberUmbertoBombana = () => (
  <RestaurantPage
    restaurantName="Tuber Umberto Bombana"
    address="Shop 113A, 1F, K11 Musea, 18 Salisbury Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+85221334743"
    website="https://www.octavo.com.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This dining concept by the eponymous chef is dedicated to the black and white treasure of gastronomy; its name also refers to the genus to which truffles belong. The head chef, who worked under Chef Bombana for over 20 years, demonstrates dexterous handling of seasonal ingredients from around the world, including jumbo carabinero prawns from Spain. The tasting menu offers a choice of dishes from starter to dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20113A%2C%201F%2C%20K11%20Musea%2C%2018%20Salisbury%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Tuber Umberto Bombana"
  />
);

export default TuberUmbertoBombana;
