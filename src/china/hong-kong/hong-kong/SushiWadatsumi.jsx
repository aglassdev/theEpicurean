...
const SushiWadatsumi = () => (
  <RestaurantPage
    restaurantName="Sushi Wadatsumi"
    address="607, 6F, K11 Musea, 18 Salisbury Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85226190199"
    website="https://sushi-wadatsumi.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The longstanding sushi fixture in Sheung Wan moved to this shopping mall in 2021 and has assumed a bigger footprint. The kitchen team delivers a single menu of great value and rest assured that the fish, mostly wild-caught in Japan, is as good as ever. Yamagata sushi rice is dressed in a special blend of red vinegar for optimal acidity. If you’re lucky, you may even get to taste the live baby cuttlefish which are only available for two weeks each year...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=607%2C%206F%2C%20K11%20Musea%2C%2018%20Salisbury%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sushi Wadatsumi"
  />
);

export default SushiWadatsumi;
