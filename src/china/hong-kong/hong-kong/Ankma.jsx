...
const Ankma = () => (
  <RestaurantPage
    restaurantName="Ankôma"
    address="5F, Kam Lung Commercial Centre, 2 Hart Avenue, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="European Contemporary"
    priceRange="$$$"
    phoneNumber="+85229811688"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ankoma"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This compact joint offers two seating areas – the counter overlooking an open kitchen serves a 10-course season-driven tasting menu that melds Japanese flavours with European techniques; the terrace serves upmarket steakhouse favourites like Wagyu sandwich, caviar with blinis, and truffle fries. Butter-aged lobster seared on a lava stone is velvety and flavoursome. Roast three-yellow chicken in a vin jaune sauce is ideal to share and worth pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Kam%20Lung%20Commercial%20Centre%2C%202%20Hart%20Avenue%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ankôma"
  />
);

export default Ankma;
