...
const Sp = () => (
  <RestaurantPage
    restaurantName="Sếp"
    address="19F, High Block, H Code, 45 Pottinger Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Vietnamese"
    priceRange="$$$"
    phoneNumber="+85221165433"
    website="https://www.sep-hk.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The executive chef spent seven years working in Vietnam where he fell in love with wood-fired cooking. He was keen to introduce the concept to Hong Kong audience when he returned home. His project Sếp specialises in modern Indochine Vietnamese fare using a wood-fired grill in the open kitchen. Menus with 8 or 10 courses feature must-tries like Hoi An poulet made with dry-aged local three-yellow chicken, and bún bò Huế with premium black angus beef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19F%2C%20High%20Block%2C%20H%20Code%2C%2045%20Pottinger%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Sếp"
  />
);
