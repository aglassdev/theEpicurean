...
const FookLamMoonWanChai = () => (
  <RestaurantPage
    restaurantName="Fook Lam Moon (Wan Chai)"
    address="35-45 Johnston Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85228660663"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/fook-lam-moon-wan-chai"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With 70+ years of glorious history, Fook Lam Moon is held dear by its faithful regulars as an institution in classic Cantonese cuisine. A stable kitchen team ensures the food is consistently good, be it exquisite dim sum or other traditional offerings. Standouts such as live seafood cooked various ways, deep-fried crispy chicken, baked stuffed crab shell, and gourmet soup in whole winter melon, are true delights. Some dishes need pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35-45%20Johnston%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Fook Lam Moon (Wan Chai)"
  />
);

export default FookLamMoonWanChai;
