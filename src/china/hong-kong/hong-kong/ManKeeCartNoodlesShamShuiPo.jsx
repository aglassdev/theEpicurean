...
const ManKeeCartNoodlesShamShuiPo = () => (
  <RestaurantPage
    restaurantName="Man Kee Cart Noodle"
    address="121 Fuk Wing Street, Sham Shui Po, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85290595104"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/man-kei-cart-noodles"
    aliases={["Man Kee Cart Noodles (Sham Shui Po)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The number of topping choices can be overwhelming, but Chinese chive dumplings and Swiss chicken wings are especially good. Fancy a spicy kick? Try the house-made chilli sauce over your noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=121%20Fuk%20Wing%20Street%2C%20Sham%20Shui%20Po%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Man Kee Cart Noodle"
  />
);

export default ManKeeCartNoodlesShamShuiPo;
