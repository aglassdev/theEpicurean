...
const UncleQuek = () => (
  <RestaurantPage
    restaurantName="Uncle Quek"
    address="6F, 8 Lyndhurst Terrace, Central, Hong Kong, Hong Kong SAR China"
    cuisine="South East Asian"
    priceRange="$$"
    phoneNumber="+85295216179"
    website="https://www.solsticehongkong.com/uncle-quek"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Another dining concept overseen by chef Barry Quek of Whey fame, Uncle Quek impresses with creative home-style Southeast Asian fare inspired by the chef's childhood memories. His signature lobster laksa, served in a shrimp broth with tomalley, spices and coconut milk, boasts addictively complex flavours. Crispy and aromatic, the cereal-crusted fried chicken is a variation on the famous Singaporean shrimp recipe. The lunch sets are great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%208%20Lyndhurst%20Terrace%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Uncle Quek"
  />
);

export default UncleQuek;
