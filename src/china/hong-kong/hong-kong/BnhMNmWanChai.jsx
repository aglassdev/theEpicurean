...
const BnhMNmWanChai = () => (
  <RestaurantPage
    restaurantName="Bánh Mì Nếm (Wan Chai)"
    address="GF, 247-249 Queen's Road East, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85298991247"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/banh-mi-nem"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This takeout-only shop specialises in Vietnamese sandwiches, alongside rice noodles and coffee. The signature bánh mì dặc biệt features Vietnamese char siu, sausage and pâté in a baguette. Pickled radish and chilli add extra zing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20247-249%20Queen's%20Road%20East%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Bánh Mì Nếm (Wan Chai)"
  />
);

export default BnhMNmWanChai;
