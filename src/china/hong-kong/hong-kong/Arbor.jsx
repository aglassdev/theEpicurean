...
const Arbor = () => (
  <RestaurantPage
    restaurantName="Arbor"
    address="25F, H Queen's, 80 Queen's Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$$$"
    phoneNumber="+85231858388"
    website="https://www.arbor-hk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Japanese and Nordic cuisines enjoy a natural affinity as they both boast a subtractive form of cooking that focuses on subtle, natural flavours. Through precise execution and the insistence on using top quality ingredients, the two come together in the form of balanced and intriguing set menus at this understatedly stylish restaurant. The chef’s Finnish background is reflected in the lingonberries that accompany the pigeon and the horseradish that accentuates the scallop and peas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25F%2C%20H%20Queen's%2C%2080%20Queen's%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Arbor"
  />
);
