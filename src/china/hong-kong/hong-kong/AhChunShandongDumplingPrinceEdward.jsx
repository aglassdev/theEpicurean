...
const AhChunShandongDumplingPrinceEdward = () => (
  <RestaurantPage
    restaurantName="Ah Chun Shandong Dumpling"
    address="60 Lai Chi Kok Road, Prince Edward, Hong Kong, Hong Kong SAR China"
    cuisine="Dumplings"
    priceRange="$"
    phoneNumber="+85227899611"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/ah-chun-shandong-dumpling"
    aliases={["Ah Chun Shandong Dumpling (Prince Edward)"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The shop has a traditional feel to it. Green wooden window frames on the wall are reminiscent of old-time Hong Kong. Dumplings are handmade daily and only the freshest ingredients are used in the fillings. Try their most-ordered item lamb and Peking scallion dumplings. Or surprise yourself with the specialty, such as mackerel dumplings and cuttlefish dumplings. Shandong roast lamb and meat pie are also recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%20Lai%20Chi%20Kok%20Road%2C%20Prince%20Edward%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Ah Chun Shandong Dumpling"
  />
);

export default AhChunShandongDumplingPrinceEdward;
