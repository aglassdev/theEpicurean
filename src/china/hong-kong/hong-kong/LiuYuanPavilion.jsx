...
const LiuYuanPavilion = () => (
  <RestaurantPage
    restaurantName="Liu Yuan Pavilion"
    address="3F, The Broadway, 54-62 Lockhart Road, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Shanghainese"
    priceRange="$$"
    phoneNumber="+85228042000"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/liu-yuan-pavilion"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With its authentic Shanghainese cooking and Shanghainese-speaking clientele, it’s tempting to think you’re in Shanghai. The dining room impresses with understated elegance and the booth seats offering more privacy are especially prized. Specialities include drunken squab whose velvety meat and springy skin exude an intoxicating winey aroma. Stir-fried shrimps, braised pig knuckle and braised ‘lion head’ meatballs are also not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20The%20Broadway%2C%2054-62%20Lockhart%20Road%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Liu Yuan Pavilion"
  />
);

export default LiuYuanPavilion;
