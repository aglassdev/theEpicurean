...
const CheungHingKeeTsimShaTsui = () => (
  <RestaurantPage
    restaurantName="Cheung Hing Kee (Tsim Sha Tsui)"
    address="GF, 48 Lock Road, Tsim Sha Tsui, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85298442149"
    website="https://www.chkspb.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Besides the typical sheng jian bao with soupy pork filling, this shop serves varieties such as shrimp, mala pork, truffle, crabmeat and roe. The buns are springy, brimming with filling, and crispy on the bottom...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2048%20Lock%20Road%2C%20Tsim%20Sha%20Tsui%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Cheung Hing Kee (Tsim Sha Tsui)"
  />
);

export default CheungHingKeeTsimShaTsui;
