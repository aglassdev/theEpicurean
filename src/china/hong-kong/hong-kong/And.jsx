...
const And = () => (
  <RestaurantPage
    restaurantName="Andō"
    address="1F, Somptueux Central, 52-54 Wellington Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Innovative"
    priceRange="$$$"
    phoneNumber="+85291618697"
    website="https://www.andohk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Born in Argentina but having honed his skills in Japan, chef-founder Agustin Balbi opened Andō to realise his culinary vision from his unique vantage point. His tasting menu takes diners on a personal journey by fusing his ancestral roots with strong Japanese influences. Don't miss the signature caldoso rice, dubbed Sin Lola – a homage to his grandma. The sommelier works closely with the chef, and his wine flight offers some inspired choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Somptueux%20Central%2C%2052-54%20Wellington%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Andō"
  />
);
