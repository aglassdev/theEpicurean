...
const CristalRoomByAnnesophiePic = () => (
  <RestaurantPage
    restaurantName="Cristal Room by Anne-Sophie Pic"
    address="44F, Forty-Five, Gloucester Tower, Landmark, 15 Queen's Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+85235018580"
    website="https://cristalroombyasp.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In keeping with its moniker, literally, the opulent space seduces with sparkles, mirrored panels and jaw-dropping city views. The celebrity chef's second venture in Asia greets diners with an oversize crystal chandelier. The six- or eight-course tasting menu, consists of chef’s signature dishes, is deeply rooted in French traditions, with subtle Japanese twists in terms of produce and condiments – delicate and exciting at the same time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44F%2C%20Forty-Five%2C%20Gloucester%20Tower%2C%20Landmark%2C%2015%20Queen's%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Cristal Room by Anne-Sophie Pic"
  />
);

export default CristalRoomByAnnesophiePic;
