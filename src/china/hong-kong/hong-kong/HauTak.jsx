...
const HauTak = () => (
  <RestaurantPage
    restaurantName="Hau Tak"
    address="454-456 Lockhart Road, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85223355328"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/hau-tak"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spanning several floors in a commercial building, this restaurant has several private rooms for banquets and parties. Cantonese classics are the menu mainstays – from dim sum and barbecue to painstaking recipes rarely found elsewhere. Pre-order pipa bird's nest: a patty of crabmeat and bird's nest bound by egg white then steamed and pan fried. The sautéed sliced conch and chicken with honey-glazed Yunnan ham, an umami extravaganza, is another highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=454-456%20Lockhart%20Road%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hau Tak"
  />
);

export default HauTak;
