...
const ManWah = () => (
  <RestaurantPage
    restaurantName="Man Wah"
    address="25F, Mandarin Oriental Hotel, 5 Connaught Road Central, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85228254003"
    website="https://www.mandarinoriental.com/en/hong-kong/victoria-harbour/dine/man-wah"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This elegant, neo-Chinese chic room boasts a royal blue theme which works well with the wood-rich details and bird cage chandeliers. The menu sees traditional Cantonese dishes underpinned by skilful preparation and a dash of originality. Duck feet bundled with duck liver, duck meat and char siu is an old-time dim sum that has become quite scarce these days - pre-order at least one day ahead. The wine list includes many Asian tipples. The sommelier also offers blind tasting flights...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25F%2C%20Mandarin%20Oriental%20Hotel%2C%205%20Connaught%20Road%20Central%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Man Wah"
  />
);
