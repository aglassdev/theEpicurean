...
const TempleStreetBeefOffal = () => (
  <RestaurantPage
    restaurantName="Temple Street Beef Offal"
    address="18 Arthur Street, Yau Ma Tei, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/temple-street-beef-offal"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-standing shop is popular with locals. Tripe, intestine, pancreas or lung can be ordered individually or as an assortment, on a skewer or in a bowl. The offal soaks up the broth nicely, with three sauces on the side...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Arthur%20Street%2C%20Yau%20Ma%20Tei%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Temple Street Beef Offal"
  />
);

export default TempleStreetBeefOffal;
