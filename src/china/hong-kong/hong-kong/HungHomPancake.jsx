...
const HungHomPancake = () => (
  <RestaurantPage
    restaurantName="Hung Hom Pancake"
    address="Shop 2, Polly Court, Taku Street, Hung Hom, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/hung-hom-pancake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 40 years, this neighbourhood shop has provided the childhood memories of many. Pancakes, waffles and egg waffles are all made to order. Tricolour egg waffles in plain, chocolate and matcha flavours particularly stand out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%202%2C%20Polly%20Court%2C%20Taku%20Street%2C%20Hung%20Hom%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hung Hom Pancake"
  />
);

export default HungHomPancake;
