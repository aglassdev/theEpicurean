...
const Roganic = () => (
  <RestaurantPage
    restaurantName="Roganic"
    address="Shop No. 402 & 403, 4F, Lee Garden One, 33 Hysan Avenue, Causeway Bay, Hong Kong, Hong Kong SAR China"
    cuisine="European Contemporary"
    priceRange="$$$"
    phoneNumber="+85228178383"
    website="https://www.roganic.com.hk"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This offshoot of its London namesake by British chef Simon Rogan moved here in 2025. As opposed to the tasting menus offered in the former venue, a new sharing-style set menu allows guests to dine flexibly and creatively. As always, the modern British score celebrates local sustainable produce and champions a farm-to-table zero-waste concept. Four types of libation pairings cater to both wine buffs and teetotallers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20No.%20402%20%26%20403%2C%204F%2C%20Lee%20Garden%20One%2C%2033%20Hysan%20Avenue%2C%20Causeway%20Bay%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Roganic"
  />
);

export default Roganic;
