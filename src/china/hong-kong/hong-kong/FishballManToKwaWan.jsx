...
const FishballManToKwaWan = () => (
  <RestaurantPage
    restaurantName="Fishball Man (To Kwa Wan)"
    address="GF, 50 Tin Kwong Road, To Kwa Wan, Hong Kong, Hong Kong SAR China"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85297273347"
    website="https://guide.michelin.com/en/hong-kong-region/hong-kong/restaurant/fishball-man-to-kwa-wan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Though local snacks like shaomai and cheong fun are offered, its eponymous speciality remains the most popular. Besides the spicy variety, the springy and flavourful white fish balls drizzled in chilli oil are unmissable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2050%20Tin%20Kwong%20Road%2C%20To%20Kwa%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Fishball Man (To Kwa Wan)"
  />
);

export default FishballManToKwaWan;
