...
const RacinesHON = () => (
  <RestaurantPage
    ...
    address="GF, 22 Upper Station Street, Sheung Wan, Hong Kong, Hong Kong SAR China"
    cuisine="French Contemporary"
    priceRange="$$$"
    phoneNumber="+85264071925"
    website="https://www.racineshk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Two owner-chefs from Southern France revisit their culinary roots at Racines, literally “roots” in French. Classic heirloom recipes are given a modern makeover and are meticulously crafted with seasonal produce from their home country and Hong Kong. From homemade sourdough with smoked butter to petits-fours in a vintage biscuit tin, every course of the 5- or 7-course menu is a tour de force, weaving a story of terroir, family and friendship...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2022%20Upper%20Station%20Street%2C%20Sheung%20Wan%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Racines"
  />
);

export default RacinesHON;
