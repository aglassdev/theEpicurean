...
const ManHoAdmiralty = () => (
  <RestaurantPage
    restaurantName="Man Ho (Admiralty)"
    address="3F, JW Marriott Hotel, Pacific Place, 88 Queensway, Admiralty, Hong Kong, Hong Kong SAR China"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85228108366"
    website="https://www.marriott.com/en-us/dining/restaurant-bar/hkgdt-jw-marriott-hotel-hong-kong/5308052-man-ho-chinese-restaurant.mi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The sophisticated interior inspired by a Chinese garden features cascading glass chandeliers shaped like morning glory, marble moon gates and camellia enamel art. The young but seasoned head chef takes a creative approach to classics, such as Cantonese barbecue, dim sum and seafood. Try the fish soup with fish maw, shrimp cake and bamboo pith – the rich, flavoursome broth is made with three kinds of fish. Certain items need to be pre-ordered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20JW%20Marriott%20Hotel%2C%20Pacific%20Place%2C%2088%20Queensway%2C%20Admiralty%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Man Ho (Admiralty)"
  />
);

export default ManHoAdmiralty;
