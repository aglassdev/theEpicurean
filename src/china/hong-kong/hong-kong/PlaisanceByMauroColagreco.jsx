...
const PlaisanceByMauroColagreco = () => (
  <RestaurantPage
    restaurantName="Plaisance by Mauro Colagreco"
    address="1F, 1 Duddell Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+85231562600"
    website="https://plaisancehk.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Mother of pearl trimmings, shades of turquoise and a sculpted whirlpool of metallic fish set the ocean scene. The seafood-led menu delivers spellbinding dishes that showcase the best ingredients from around the world alongside local vegetables, all finessed with solid French technique and a healthy dose of creativity. House-made sauces are one of the highlights, as is the extensive wine list. The open kitchen puts on an entertaining show...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%201%20Duddell%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Plaisance by Mauro Colagreco"
  />
);

export default PlaisanceByMauroColagreco;
