...
const HansikGoo = () => (
  <RestaurantPage
    restaurantName="Hansik Goo"
    address="1F, The Wellington, 198 Wellington Street, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Korean"
    priceRange="$$$$"
    phoneNumber="+85227988768"
    website="https://www.hansikgoo.hk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hansik means Korean cuisine and goo refers to chef Mingoo Kang. But shikgoo also denotes family, which aligns with his home-style food designed for sharing. In the single 10-course tasting menu, with add-on options, specialities such as abalone wrapped dumpling, chicken roulade with ginseng rice, and pyeonyuk with buckwheat noodles exemplify the chef's creative, upscale spin on the classics. Perfect with makgeolli or the signature wine pairing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20The%20Wellington%2C%20198%20Wellington%20Street%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Hansik Goo"
  />
);

export default HansikGoo;
