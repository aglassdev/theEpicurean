...
const Testina = () => (
  <RestaurantPage
    restaurantName="Testina"
    address="3F, 8 Lyndhurst Terrace, Central, Hong Kong, Hong Kong SAR China"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+85227980668"
    website="https://www.testina.hk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aptly named after its signature pig’s head dish, Testina is the collaboration between the Milanese trattoria Trippa Milano and a local hospitality group. Championing a nose-to-tail philosophy, the kitchen team serves every part of an animal to great effect. Besides pig’s head, expect to see tripe, bone marrow and veal tongue on the menu. For an authentic taste of Trippa Milano’s cooking, try homemade tagliatelle with duck ragù...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%208%20Lyndhurst%20Terrace%2C%20Central%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Testina"
  />
);
