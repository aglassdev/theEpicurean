...
const TrustyCongeeKingWanChai = () => (
  <RestaurantPage
    restaurantName="Trusty Congee King (Wan Chai)"
    address="7 Heard Street, Wan Chai, Hong Kong, Hong Kong SAR China"
    cuisine="Noodles and Congee"
    priceRange="$"
    phoneNumber="+85228823268"
    website="https://www.taihing.com/?route=brands-detail&id=3"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, you can really trust the quality of the food served in this long-standing congee shop. The menu has become more varied in recent years, with congee, noodles and snack sets available. All congee is cooked in fish broth for an extra dimension of flavour. Standouts include pork liver and scallop congee, sticky rice dumpling with salted egg yolk and pork, and poached grass carp skin. The bright dining room is kept spick and span...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Heard%20Street%2C%20Wan%20Chai%2C%20Hong%20Kong%2C%20Hong%20Kong%20SAR%20China"
    pageTitle="Trusty Congee King (Wan Chai)"
  />
);

export default TrustyCongeeKingWanChai;
