...
const WaiTouNiuRouMeilingRoad = () => (
  <RestaurantPage
    restaurantName="Wai Tou Niu Rou (Meiling Road)"
    address="472-476 Meiling Road, Jinjiang, Quanzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥"
    phoneNumber="+8615392152777"
    website="https://guide.michelin.com/en/fujian-province/quanzhou_1030272/restaurant/wai-tou-niu-rou-meiling-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Famous for its beef dishes, this shop was named after the owner, whose moniker means wryneck. His signature braised beef rib exudes curry flavour and a hint of Chinese herbs. The fork-tender meat goes well with the buttery seasoned rice. Another highlight is the double-boiled oxtail – the meat is slow cooked until gelatinous; infused with Indian mulberry root, the broth tastes mildly sweet. Certain items tend to sell out fast, so come early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=472-476%20Meiling%20Road%2C%20Jinjiang%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Wai Tou Niu Rou (Meiling Road)"
  />
);

export default WaiTouNiuRouMeilingRoad;
