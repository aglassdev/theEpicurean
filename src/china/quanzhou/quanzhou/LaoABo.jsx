...
const LaoABo = () => (
  <RestaurantPage
    restaurantName="Lao A Bo"
    address="600-1 Chengbei Road, Fengze, Quanzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659528882889"
    website="https://guide.michelin.com/en/fujian-province/quanzhou_1030272/restaurant/lao-a-bo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 10 years, regulars have been flocking here to sample ingredients that are rarely found elsewhere. The owner used to be a food distributer and has always been picky about his seafood. Adventurous eaters may try wild-caught mudskippers braised with shallots and black beans for springy meat. Gigantic sea snails and swimmer crabs are also exceptional and can be paired with home-style staples like braised pork rice, tofu in sa cha sauce or blood curd soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=600-1%20Chengbei%20Road%2C%20Fengze%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Lao A Bo"
  />
);

export default LaoABo;
