...
const LuoJiMianXianHu = () => (
  <RestaurantPage
    restaurantName="Luo Ji Mian Xian Hu"
    address="56 Xianhou Road, Licheng, Quanzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613636916313"
    website="https://guide.michelin.com/en/fujian-province/quanzhou_1030272/restaurant/luo-ji-mian-xian-hu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="By the fading sign and vintage enamelware, it’s not hard to believe this noodle shop opened its doors 40 years ago. It focuses on mee sua gou – a wheat vermicelli soup of porridge consistency. Feel free to jazz it up with toppings like vinegar pork, pork intestine or oyster. Suck up the broth with a fried dough stick. Sautéed pork liver is another must-try: lightly coated in sweet potato starch, the liver has a burnt crust and a juicy centre...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20Xianhou%20Road%2C%20Licheng%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Luo Ji Mian Xian Hu"
  />
);

export default LuoJiMianXianHu;
