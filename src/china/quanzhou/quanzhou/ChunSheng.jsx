...
const ChunSheng = () => (
  <RestaurantPage
    restaurantName="Chun Sheng"
    address="125 Bei Huan Shuang Nei Road, Jinjiang, Quanzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659585858169"
    website="https://guide.michelin.com/en/fujian-province/quanzhou_1030272/restaurant/chun-sheng"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Away from the city centre, this joint serving home-style Fujian cooking has earned acclaim from locals for over two decades. Like its numerous counterparts, there isn’t a menu – just pick your seafood and meat from the fish tank and chiller, then ask the server for the best way to prepare them. With tender meat and rich aromas, ginger duck stew is a best-seller. Fried green lobster in peppered salt stands out with bouncy meat and crisp flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%20Bei%20Huan%20Shuang%20Nei%20Road%2C%20Jinjiang%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Chun Sheng"
  />
);

export default ChunSheng;
