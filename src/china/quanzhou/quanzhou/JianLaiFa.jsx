...
const JianLaiFa = () => (
  <RestaurantPage
    restaurantName="Jian Lai Fa"
    address="104-106 Nanjun North Road, Licheng, Quanzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659522286285"
    website="https://guide.michelin.com/en/fujian-province/quanzhou_1030272/restaurant/jian-lai-fa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jian Lai Fa started out as a snack stall back in 1984. Now in its third generation, it has grown into a restaurant that is spread over two storeys. The kitchen team strives to re-create authentic home-style Minnan cooking with a nostalgic tang. Their signature braised duck in rice wine with ginger and salt boasts tender meat that falls off the bone. Other star dishes include marine fish braised in soy and scallion and razor clam in peppered salt...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=104-106%20Nanjun%20North%20Road%2C%20Licheng%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Jian Lai Fa"
  />
);

export default JianLaiFa;
