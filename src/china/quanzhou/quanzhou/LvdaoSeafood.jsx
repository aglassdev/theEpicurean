...
const LvdaoSeafood = () => (
  <RestaurantPage
    restaurantName="Lvdao Seafood"
    address="447-451 Jiu'er Road, Shishi, Quanzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥"
    phoneNumber="+8659588888899"
    website="http://www.lvdaohotel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 1989, Lvdao opened its doors with only six tables. Nowadays, it has turned into a leading F&B chain in Shishi and this flagship establishment now spans two floors. Though it specialises in Fujian fare, especially seafood, there are some Cantonese options on the menu. Try the umami-laden swimmer crab – the locals prefer it steamed with black sticky rice or taro balls. Round off with custard-filled buns, best enjoyed with sweet peanut soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=447-451%20Jiu'er%20Road%2C%20Shishi%2C%20Quanzhou%2C%20China%20Mainland"
    pageTitle="Lvdao Seafood"
  />
);

export default LvdaoSeafood;
