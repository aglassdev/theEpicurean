...
const TaozuiGuan = () => (
  <RestaurantPage
    restaurantName="Taozui Guan"
    address="Building 10, Zone B, Zhujiang Party Pier Beer Culture & Art Zone, 118 Modisha Street, Haizhu, Guangzhou, 510200, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥"
    phoneNumber="+8618929930268"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/taozui-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Showcasing a ceramic theme, this restaurant doubles as a cultural hub for art making and exhibitions. The interior resembles an elegant tea house, whereas the food shows international influences and creative touches—emphasising MSG-free, healthful recipes. The signature surfer fish with pickled cabbage is cooked tableside, as the server pours scalding broth onto the raw fish. Tofu and sea urchin in claypot melds and balances all the great flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%2010%2C%20Zone%20B%2C%20Zhujiang%20Party%20Pier%20Beer%20Culture%20%26%20Art%20Zone%2C%20118%20Modisha%20Street%2C%20Haizhu%2C%20Guangzhou%2C%20510200%2C%20China%20Mainland"
    pageTitle="Taozui Guan"
  />
);

export default TaozuiGuan;
