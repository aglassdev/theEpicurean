...
const HunanCuisine = () => (
  <RestaurantPage
    restaurantName="Hunan Cuisine"
    address="2842-39 East Xingang Road, Haizhu, Guangzhou, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥"
    phoneNumber="+8615360610582"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/hunan-cuisine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This design-forward restaurant is located within an industrial park of remodelled factory buildings. Aptly, the décor exudes an industrial chic that complements the origami art hung from the ceiling. Trained as a designer, the owner took care of the décor and furnishings, whereas the Hunanese chef recreates classics from his home province. Dongting fish head, wotou cornbread and sweet fried dumplings are cooked with acumen and dexterity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2842-39%20East%20Xingang%20Road%2C%20Haizhu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Hunan Cuisine"
  />
);

export default HunanCuisine;
