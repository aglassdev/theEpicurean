...
const FlavorsOfChina = () => (
  <RestaurantPage
    restaurantName="Flavors of China"
    ...
    pageTitle="Flavors of China"
  />
);

export default FlavorsOfChina;
