...
const GuoFanJiaYan = () => (
  <RestaurantPage
    restaurantName="Guo Fan Jia Yan"
    address="2F, 123 TangAn Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥¥"
    phoneNumber="+8615360862761"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/guo-fan-jia-yan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A must-try for spicy food lovers. Named after famous statesman Zeng Guofan of Qing Dynasty, the room pays tribute to him with his literary and calligraphic works. The menu also focusses on dishes and seasonal ingredients from Hunan province, where Zeng hailed from. The signature softshell turtle is either braised in sauces or blanched in stock, best ordered ahead of time. Also try the braised pork belly, a recipe from Shuangfeng County...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20123%20TangAn%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Guo Fan Jia Yan"
  />
);

export default GuoFanJiaYan;
