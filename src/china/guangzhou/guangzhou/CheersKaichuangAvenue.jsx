...
const CheersKaichuangAvenue = () => (
  <RestaurantPage
    restaurantName="Cheers (Kaichuang Avenue)"
    address="2F, A4 Building, Zhitai Plaza, Kaichuang Avenue, Guangzhou, China Mainland"
    cuisine="Hunanese"
    priceRange="¥¥"
    phoneNumber="+862082299869"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/cheers-huangpu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The main dining room on the bottom floor evokes relaxed vibes with sheer curtains and rattan chairs while the upper level houses private rooms exclusively. The private rooms serve a special menu with keenly sought-after Hunanese ingredients in limited quantity. Try ice-chilled crisp lotus root from Dongting Lake, or Cantonese-style braised sea cucumber with premium chilies from Zhangshu Port. Pre-order these dishes to avoid disappointment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20A4%20Building%2C%20Zhitai%20Plaza%2C%20Kaichuang%20Avenue%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Cheers (Kaichuang Avenue)"
  />
);

export default CheersKaichuangAvenue;
