...
const SongGUA = () => (
  <RestaurantPage
    restaurantName="Song"
    address="Shop 417, 4F, G.T. Land Plaza Winter, 16 Zhujiang East Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862087412345"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/song"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Christened after the dynasty and a nod to the owner's name, this award-winning place has pillars covered with stainless steel bricks and gigantic glass-feathered wings hung from the mirrored ceiling that lend an eerie sense of space. Standouts on the predominantly Sichuanese menu include spicy boiled tiger grouper, jujube wood-roasted 42-day Peking duck, and spicy crab. Try the Sichuan street food, too – such as stuffed pancake, and Zhong's dumplings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20417%2C%204F%2C%20G.T.%20Land%20Plaza%20Winter%2C%2016%20Zhujiang%20East%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Song"
  />
);

export default SongGUA;
