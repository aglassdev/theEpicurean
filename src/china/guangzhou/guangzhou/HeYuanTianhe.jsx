...
const HeYuanTianhe = () => (
  <RestaurantPage
    restaurantName="He Yuan (Tianhe)"
    address="Level 3 and 3M, IMP, 68 Huacheng Avenue, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862083063668"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/he-yuan-tianhe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This kitchen serves well-executed Cantonese dishes with an emphasis on various breeds of abalone – Japanese, South African, Australian and Middle Eastern. All dim sum is made on the spot, but for those seeking more heat in their food, there are Sichuanese chefs to satisfy your cravings. The palatial dining room houses 60 tables for banquets. For smaller parties, 17 private rooms are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%203%20and%203M%2C%20IMP%2C%2068%20Huacheng%20Avenue%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="He Yuan (Tianhe)"
  />
);

export default HeYuanTianhe;
