...
const DrXusWellbeingBranchTianhe = () => (
  <RestaurantPage
    restaurantName="Dr. Xu's Wellbeing Branch (Tianhe)"
    address="7F, Concord Center, 57 Linjiang Avenue, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862038078889"
    website="https://www.nanhaiyucun.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founder Dr. Xu is a postdoc in Chinese medicine and the restaurant doubles as a museum showcasing his collection of antiques and rare herbs. Diners appreciate the tonic effects of double-boiled soups, such as the abalone liver soup with wild tangerine, which imparts citrus tartness. Most dishes combine natural health-boosters and seasonal ingredients from around the world, especially live seafood. Pre-order your favourites; ask for a table by the window...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%20Concord%20Center%2C%2057%20Linjiang%20Avenue%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Dr. Xu's Wellbeing Branch (Tianhe)"
  />
);

export default DrXusWellbeingBranchTianhe;
