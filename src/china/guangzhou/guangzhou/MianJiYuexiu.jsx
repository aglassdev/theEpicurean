...
const MianJiYuexiu = () => (
  <RestaurantPage
    restaurantName="Mian Ji (Yuexiu)"
    address="224 Dezheng Middle Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥"
    phoneNumber="+8613760808158"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/mian-ji-yuexiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1985, this tiny gem has been specialising in double-boiled soups. The menu boasts some 20 health tonics that are grouped by medicinal properties – some nourish the lungs; others boost energy levels. Those slow-cooked in whole coconuts are especially loved by customers, like the coconut chicken soup that imparts sweet aromas. Steamed rice with pork patty and pickled mustard greens entices with briny umami and juicy, silky pork...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=224%20Dezheng%20Middle%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Mian Ji (Yuexiu)"
  />
);

export default MianJiYuexiu;
