...
const FaSingGardenJinsuiRoadGUA = () => (
  <RestaurantPage
    restaurantName="Fa Sing Garden (Jinsui Road)"
    address="5F, Grand Mercure, 62 Jinsui Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862086888182"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/fa-sing-garden-jinsui-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2018, Fa Sing Garden has been serving home-style Cantonese fare to hotel guests and other foodies. The brightly lit space boasts a tasteful decor, and there are a number of private rooms of various sizes. Along with signature dishes such as double-steamed chicken, lotus root starch pancakes, and soy-marinated chitterlings, the fried pork ribs in Worcestershire sauce are a must – the tangy sauce perfectly complements the tender, juicy meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Grand%20Mercure%2C%2062%20Jinsui%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Fa Sing Garden (Jinsui Road)"
  />
);

export default FaSingGardenJinsuiRoadGUA;
