...
const TasteSoarDaTouHui = () => (
  <RestaurantPage
    restaurantName="Taste Soar × Da Tou Hui"
    address="2F, 20 Haiwen Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862038098816"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/taste-soar-%C3%97-da-tou-hui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The collaborative effort of two local restaurant brands focuses on local flavours and myriad techniques to make Cantonese food even better. Many diners come for the soups, which are double-boiled for at least four hours – expect deep umami but little grease. The steamed fish jaw with pickled young ginger and sweet soybean paste, and deep-fried chitterlings are also popular. Most seafood dishes are not on the menu – ask the server what is available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2020%20Haiwen%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Taste Soar × Da Tou Hui"
  />
);

export default TasteSoarDaTouHui;
