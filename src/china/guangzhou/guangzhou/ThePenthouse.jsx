...
const ThePenthouse = () => (
  <RestaurantPage
    restaurantName="The Penthouse"
    address="23 & 25F, South Tower, Grand Hyatt Hotel, 12 Zhujiang West Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862083961234"
    website="https://www.hyatt.com/en-US/hotel/china/grand-hyatt-guangzhou/guagh/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The executive chef has years of experience in hotel kitchens and his short but sweet menu embodies the quintessence of Cantonese cooking. Think barbecue meats, seafood, stir-fries and dim sum at lunch. Certain dishes, such as honey-glazed char siu, are available in limited quantity and should be pre-ordered. Round it out with the silky egg custard in walnut milk. Ask for a table by the windows for the lovely cityscape. Reservations recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23%20%26%2025F%2C%20South%20Tower%2C%20Grand%20Hyatt%20Hotel%2C%2012%20Zhujiang%20West%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="The Penthouse"
  />
);
