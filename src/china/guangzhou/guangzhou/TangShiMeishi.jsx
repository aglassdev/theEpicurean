...
const TangShiMeishi = () => (
  <RestaurantPage
    restaurantName="Tang Shi Meishi"
    address="717 Longjin East Road, Liwan, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+8613560189334"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tang-shi-meishi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a popular district for late night supper, this shop is open well into the dark hours and always jammed with hungry diners. The signature Taishan swamp eel rice comes in two sizes, both with generous portions of eel despite the humble price tags. The fish is flavoursome; the chewy rice grains are easily separated and dressed evenly with sauces. Claypot dishes and home-style stir-fries are also worth a try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=717%20Longjin%20East%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tang Shi Meishi"
  />
);

export default TangShiMeishi;
