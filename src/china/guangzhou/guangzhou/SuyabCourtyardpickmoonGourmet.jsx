...
const SuyabCourtyardpickmoonGourmet = () => (
  <RestaurantPage
    restaurantName="Suyab Courtyard・Pickmoon Gourmet"
    address="348 Yingbin Road, Panyu, Guangzhou, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+8613802945901"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/suyab-courtyard%E3%83%BBpickmoon-gourmet"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=348%20Yingbin%20Road%2C%20Panyu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Suyab Courtyard・Pickmoon Gourmet"
  />
);

export default SuyabCourtyardpickmoonGourmet;
