...
const LaoXiguanLaifenWenmingRoad = () => (
  <RestaurantPage
    restaurantName="Lao Xiguan Laifen (Wenming Road)"
    address="216 Wenming Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862083811437"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/lao-xiguan-laifen-wenming-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, Laifen noodle soup is the main item sold at this rustic shop, and is served alongside ingredients such as barbecue pork, beef balls or octopus. The creamy rice soup has hints of mushroom and dried shrimp flavours. Water caltrop, consisting of rice noodles shaped like bite-size buffalo nuts topped with shredded egg, preserved cabbage, cracklings and peanuts, is an old-time dish that is hard to find elsewhere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=216%20Wenming%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Lao Xiguan Laifen (Wenming Road)"
  />
);

export default LaoXiguanLaifenWenmingRoad;
