...
const ChaoJiClaypotRiceLiwan = () => (
  <RestaurantPage
    restaurantName="Chao Ji Claypot Rice (Liwan)"
    address="723 Longjin East Road, Liwan, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥"
    phoneNumber="+8615913153842"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/chao-ji-claypot-rice-liwan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Time is of the essence when it comes to cooking claypot rice. In this popular two-storey joint, both the rice and soups are made to order, so expect to wait for at least 15-20 minutes, longer at peak hours. The rice is perfectly cooked, soft but toothsome with a crispy golden crust. Choose from an array of toppings: pork liver, chicken, pork patty, preserved pork and sausage, raw or fried eggs…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=723%20Longjin%20East%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Chao Ji Claypot Rice (Liwan)"
  />
);

export default ChaoJiClaypotRiceLiwan;
