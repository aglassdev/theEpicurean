...
const Tongtown = () => (
  <RestaurantPage
    restaurantName="Tongtown"
    address="4F, R&F Center, 10 Huaxia Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+8618188800638"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tongtown"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional Cantonese fare gets a hip, fresh update at this eatery. As you enter, two stations grab your attention – ho fun rice noodles are made at one, roast goose at the other. As you can imagine, these are the must-tries! The noodles can be fried with sliced beef, served plain with a dip or dressed in a flavoursome roast goose jus. For larger parties, consider pre-ordering the roast goose stuffed with gourmet dried seafood...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20R%26F%20Center%2C%2010%20Huaxia%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tongtown"
  />
);

export default Tongtown;
