...
const FourSeasonsPavilionRn = () => (
  <RestaurantPage
    restaurantName="Four Seasons Pavilion · Rùn"
    address="2F, 9 South Door, Hall 3, Liu Hua Exhibition and Trade Center, 117 Liuhua Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥"
    phoneNumber="+862083521891"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/four-seasons-pavilion-duck-yuexiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dining room had a facelift in 2022 and now boasts modern décor with Beijingese motifs. For more privacy, consider booking one of their well-appointed individual rooms. Helmed by a Beijingese kitchen team, it prides itself on Peking duck — sliced tableside and served with an array of condiments and toppings. Besides traditional Beijingese cooking, novelty dishes that reinvent Cantonese flavours in unexpected manners are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%209%20South%20Door%2C%20Hall%203%2C%20Liu%20Hua%20Exhibition%20and%20Trade%20Center%2C%20117%20Liuhua%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Four Seasons Pavilion · Rùn"
  />
);

export default FourSeasonsPavilionRn;
