...
const HuiChengDunheRoad = () => (
  <RestaurantPage
    restaurantName="Hui Cheng (Dunhe Road)"
    address="H 101, Yeo’s Park, Dunhe Road, Haizhu, Guangzhou, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥"
    phoneNumber="+862084298263"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/hui-cheng-dunhe-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A far cry from its humble beginnings as a street stall, this elegant restaurant in a cultural park prides itself on the freshest catch from Chaoshan, the owner's home area. There is no printed menu; diners choose from the ingredients on full display. Start with the signature pork trotter in a spiced soy-based marinade for its gelatinous skin and exceptional depth. Sour plums cut through the oily richness of the steamed fourfinger threadfin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%20101%2C%20Yeo%E2%80%99s%20Park%2C%20Dunhe%20Road%2C%20Haizhu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Hui Cheng (Dunhe Road)"
  />
);

export default HuiChengDunheRoad;
