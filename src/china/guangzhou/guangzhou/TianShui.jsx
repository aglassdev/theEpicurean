...
const TianShui = () => (
  <RestaurantPage
    restaurantName="Tian Shui"
    address="A249-A251, 2F, Oriental Landmark, 68 Wende North Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+8618028007776"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tian-shui-yuexiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This brand advocates a natural and mindful diet with hand-picked ingredients, slick plating and thoughtful combinations. There is just one menu available at lunch and dinner – the 24-solar-term set – and it changes every month to showcase peak-season ingredients from local sources. Seasoning is kept to a bare minimum to highlight natural flavours. The wood-rich interior adheres to an earthy palette for a serene, unmistakably Asian vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=A249-A251%2C%202F%2C%20Oriental%20Landmark%2C%2068%20Wende%20North%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tian Shui"
  />
);

export default TianShui;
