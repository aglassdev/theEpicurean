...
const SongYuan = () => (
  <RestaurantPage
    restaurantName="Song Yuan"
    address="A101-201, LYK Park, 14-1 Hedong Road, Liwan, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+8618922399021"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/song-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rows of stoneware pots on charcoal stoves not only look spectacular, but their contents also smell heavenly. It is precisely these slow-boiled soups that draw diners day and night. Each pot takes four hours to make and they tend to sell out early. The chef, who has been crafting Cantonese fare for over 20 years, also makes a mean Cantonese barbecue, as well as stir-fries and claypot dishes. Try the live seafood from the fish tank, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=A101-201%2C%20LYK%20Park%2C%2014-1%20Hedong%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Song Yuan"
  />
);

export default SongYuan;
