...
const LeiGardenYuexiu = () => (
  <RestaurantPage
    restaurantName="Lei Garden (Yuexiu)"
    address="4F, Yi An Plaza, 33 Jianshe Sixth Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862083633268"
    website="https://leigarden.hk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This outpost of the Hong Kong-based chain is well known among locals and tourists for its nicely made traditional Cantonese fare, such as crispy roast pork belly, and slow-boiled or double-boiled soups. Kick off your meal with chilled jellyfish salad; the mildly tangy black vinegar accentuates the lovely crunch. Save room for the grand finale – a double dessert whammy of sweet almond milk and steamed sticky rice jujube cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Yi%20An%20Plaza%2C%2033%20Jianshe%20Sixth%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Lei Garden (Yuexiu)"
  />
);

export default LeiGardenYuexiu;
