...
const HuiXingYuan = () => (
  <RestaurantPage
    restaurantName="Hui Xing Yuan"
    address="177 Xiaobei Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862083555740"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/hui-xing-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This three-storey building is the brand's first outlet, dating back to 1981. Known for traditional Cantonese food at bargain prices, the restaurant prides itself on meticulous cooking techniques and attention to detail. Their speciality of steamed chicken uses only free-range birds from Qingyuan for their firm, silky flesh and fine, springy skin. The goose intestines blanched in soy sauce are also impeccably made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=177%20Xiaobei%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Hui Xing Yuan"
  />
);

export default HuiXingYuan;
