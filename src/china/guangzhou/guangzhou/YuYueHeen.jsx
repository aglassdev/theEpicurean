...
const YuYueHeen = () => (
  <RestaurantPage
    restaurantName="Yu Yue Heen"
    address="71F, Four Seasons Hotel, 5 Zhujiang West Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥¥"
    phoneNumber="+862088833371"
    website="https://www.fourseasons.com/guangzhou/dining/restaurants/yu_yue_heen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The head chef, who hails from Guangdong, has been cooking professionally since the age of 15 and has extensive experience at hotels in Shanghai and Nanjing. Each dish embodies the utmost finesse and attention to detail. The range of dim sum at lunch is dazzling – especially the deep-fried taro dumplings with shrimp and chicken filling. His signature crispy-skin chicken, made with birds from Qingyuan, boasts robust flavours and a velvety texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71F%2C%20Four%20Seasons%20Hotel%2C%205%20Zhujiang%20West%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Yu Yue Heen"
  />
);

export default YuYueHeen;
