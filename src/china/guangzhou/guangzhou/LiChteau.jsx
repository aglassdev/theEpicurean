...
const LiChteau = () => (
  <RestaurantPage
    restaurantName="Li Château"
    address="Basement 1 level, 228 Tianhe Road, Tianhe, Guangzhou, China Mainland"
    cuisine="European"
    priceRange="¥¥¥"
    phoneNumber="+8615626258471"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/li-chateau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The romantic and dimly lit dining space is done out in European style, but Lingnan motifs and old-time Guanxi scenes are featured for an eclectic effect. Popular items on the menu include beef tenderloin Wellington with a red wine sauce and the black truffle risotto with pan-seared foie gras. The monthly changing tasting menu keeps things fresh for regulars...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Basement%201%20level%2C%20228%20Tianhe%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Li Château"
  />
);

export default LiChteau;
