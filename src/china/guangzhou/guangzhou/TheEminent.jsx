...
const TheEminent = () => (
  <RestaurantPage
    restaurantName="The Eminent"
    address="L4, Four Seas Bay, Four Seas City, 388 Hanxi East Avenue, Panyu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862039998583"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/the-eminent"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This dining concept consists of 19 generously sized private rooms, all tastefully furnished in Southeast-Asian style. The menu showcases the greatest hits of Cantonese fare, such as double-boiled soups and barbecued dishes. But Chef Wen also sources the season's best produce countrywide, now and then adding novel offerings to his repertoire. Try his sweet and sour pork with a tangy wampee glaze, and the velvety steamed pigeon with hairy fig root...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L4%2C%20Four%20Seas%20Bay%2C%20Four%20Seas%20City%2C%20388%20Hanxi%20East%20Avenue%2C%20Panyu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="The Eminent"
  />
);

export default TheEminent;
