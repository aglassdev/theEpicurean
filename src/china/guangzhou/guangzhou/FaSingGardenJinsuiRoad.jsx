...
const FaSingGardenJinsuiRoad = () => (
  <RestaurantPage
    ...
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/huacheng-yuan"
    tags={[]}
    awards={[
...
export default FaSingGardenJinsuiRoad;
