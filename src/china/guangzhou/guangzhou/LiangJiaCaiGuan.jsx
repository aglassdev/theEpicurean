...
const LiangJiaCaiGuan = () => (
  <RestaurantPage
    restaurantName="Liang Jia Cai Guan"
    address="683 Nanhua East Road, Haizhu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥"
    phoneNumber="+862083338268"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/liang-jia-cai-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its facade may not be grand, but regulars don’t come for the glitz.. Originally a food stall in Changdi Road over 40 years ago, it has moved to a three-story building in the old town of Haizhu district, but the chefs, the menu and the affordable food haven’t changed one bit. Specialities include deep-fried marinated pork intestine served with a homemade tomato dip, and plain steamed Qingyuan chicken...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=683%20Nanhua%20East%20Road%2C%20Haizhu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Liang Jia Cai Guan"
  />
);

export default LiangJiaCaiGuan;
