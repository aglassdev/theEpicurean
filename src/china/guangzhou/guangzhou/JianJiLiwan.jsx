...
const JianJiLiwan = () => (
  <RestaurantPage
    restaurantName="Jian Ji (Liwan)"
    address="299-303 Changshou East Road, Liwan, Guangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862081888486"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/jian-ji"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 50 years, this shop has attracted a faithful following not only for its house-made E-fu, but also its freshly made egg noodles. The soft and springy E-fu has a faint egg aroma. For toppings, choose between beef brisket, zhajiang, pork hock or intestine. The flavourful broth made with dace, pork bones, shrimp roe and dried shrimp pairs perfectly with the noodles. Congee and lai fun noodles are served in the morning only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=299-303%20Changshou%20East%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Jian Ji (Liwan)"
  />
);

export default JianJiLiwan;
