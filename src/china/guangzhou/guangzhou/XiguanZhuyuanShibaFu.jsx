...
const XiguanZhuyuanShibaFu = () => (
  <RestaurantPage
    restaurantName="Xiguan Zhuyuan (Shiba Fu)"
    address="107 Shiba Fu South Road, Liwan, Guangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+862081396653"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/xiguan-zhuyuan-shiba-fu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Still going strong after 30+ years, this branch may lack the views of its Lizhiwan counterpart, but the food tastes just as good. Springy duck egg noodles are made in its Lizhiwan factory, blanched à la minute and tossed either in shrimp roe or in a flavourful broth made with dried plaice, pork bones and dried shrimp. Don't miss the beef offal soup – the thinly sliced organ meats are rid of any odd taste and boast velvety textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=107%20Shiba%20Fu%20South%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Xiguan Zhuyuan (Shiba Fu)"
  />
);

export default XiguanZhuyuanShibaFu;
