...
const ImperialTreasureFineChineseCuisine = () => (
  <RestaurantPage
    restaurantName="Imperial Treasure Fine Chinese Cuisine"
    address="L514B, 5F, IGC Mall, 222 Xingmin Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862038856382"
    website="https://www.imperialtreasure.com.cn/china/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As in other branches of this Singapore-based chain, the kitchen team never fails to deliver quality dishes thanks to inspired insights and honed skills. The must-try black pepper mud crab exudes an intoxicating aroma and seafood flavour, while double-boiled fish maw soup with shark bones warms the heart and soul. Their dim sum lunch is to die for – deftly crafted translucent rice noodle rolls and tofu skin rolls stuffed with shrimps and chives...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L514B%2C%205F%2C%20IGC%20Mall%2C%20222%20Xingmin%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Imperial Treasure Fine Chinese Cuisine"
  />
);

export default ImperialTreasureFineChineseCuisine;
