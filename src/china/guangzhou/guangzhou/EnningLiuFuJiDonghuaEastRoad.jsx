...
const EnningLiuFuJiDonghuaEastRoad = () => (
  <RestaurantPage
    restaurantName="Enning Liu Fu Ji (Donghua East Road)"
    address="547 Donghua East Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613802965498"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/enning-liu-fu-ji-donghua-east-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the 1940s, the founder opened a shop on Enning Street that made noodles with duck eggs and flour only. Nowadays, his successors honour this heritage and make everything like in the olden days. In the signature shrimp wonton noodle soup, bite-sized wonton packed with springy shrimps come in a clear broth flavoured with dried plaice, dried shrimps and yellow chives. The blanched noodles tossed in lard, another must-try, are simple but addictive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=547%20Donghua%20East%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Enning Liu Fu Ji (Donghua East Road)"
  />
);

export default EnningLiuFuJiDonghuaEastRoad;
