...
const DelightfulHouse = () => (
  <RestaurantPage
    restaurantName="Delightful House"
    address="153 Hanxi Avenue Middle, Panyu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862084627888"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/delightful-house"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=153%20Hanxi%20Avenue%20Middle%2C%20Panyu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Delightful House"
  />
);

export default DelightfulHouse;
