...
const RongYiFaNiuZaDianShishuRoad = () => (
  <RestaurantPage
    restaurantName="Rong Yi Fa Niu Za Dian (Shishu Road)"
    address="56 Shishu Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥"
    phoneNumber="+862081871630"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/rong-yi-fa-niu-za-dian-shishu-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 40 years, the owner has been insisting on shopping for fresh beef offal daily, painstakingly preparing and braising it in a rich stock made from scratch with beef and lamb bones. His beef bone marrow boasts a creamy texture and is a perfect match with the house-made radish pickles. Beef tripe tip is another premium cut, available only after 11am. As well as beef offal, also try wonton noodle soup, braised beef brisket and tendon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56%20Shishu%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Rong Yi Fa Niu Za Dian (Shishu Road)"
  />
);

export default RongYiFaNiuZaDianShishuRoad;
