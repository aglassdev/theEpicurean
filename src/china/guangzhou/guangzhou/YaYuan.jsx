...
const YaYuan = () => (
  <RestaurantPage
    restaurantName="Ya Yuan"
    address="14 Chaotian Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862083355808"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/ya-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The three-storey room is furnished with orange tables and leather chairs that evoke 1980s nostalgia. For over three decades, Ya Yuan has been feeding hungry locals with classic home-style dishes such as slow-boiled soups and claypot rice. With its velvety flesh and gelatinous skin, the poached Qingyuan chicken dressed in scallion oil is addictively aromatic. Even the post-meal complimentary mung bean or red bean sweet soups are made with care...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Chaotian%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Ya Yuan"
  />
);

export default YaYuan;
