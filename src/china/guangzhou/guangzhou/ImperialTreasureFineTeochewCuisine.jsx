...
const ImperialTreasureFineTeochewCuisine = () => (
  <RestaurantPage
    restaurantName="Imperial Treasure Fine Teochew Cuisine"
    address="L307, 3F, Taikoo Hui, 383 Tianhe Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥"
    phoneNumber="+862038682388"
    website="https://www.imperialtreasure.com.cn/china/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Singapore-based chain opened its first outpost here in 2019. The head chef from Hong Kong ensures that Chaozhou traditions are respected in the kitchen, while adding a refined touch to his repertoire. The fried tofu skin roll in sweet and sour sauce is filled with ground pork, water chestnuts, shiitake and dried shrimps, delivering a variety of textures. The pork tripe soup with salted mustard greens and peppercorns warms the heart and soul...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L307%2C%203F%2C%20Taikoo%20Hui%2C%20383%20Tianhe%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Imperial Treasure Fine Teochew Cuisine"
  />
);

export default ImperialTreasureFineTeochewCuisine;
