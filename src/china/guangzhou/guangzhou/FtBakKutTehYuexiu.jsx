...
const FtBakKutTehYuexiu = () => (
  <RestaurantPage
    restaurantName="FT · Bak Kut Teh (Yuexiu)"
    address="Wonderful Life Mansion, 36-48 Wenming Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="South East Asian"
    priceRange="¥"
    phoneNumber="+862038615036"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/ft-bak-kut-teh"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can't miss the long queue at the door, but that doesn't put avid foodies off coming here. Available in both Singaporean and Malaysian styles, bak kut teh is simmered for three hours with pork ribs, garlic, white peppercorns and herbs until the meat falls off the bone. You will even find Thai and Vietnamese classics on the menu – the sautéed Chinese violet buds in Vietnamese fermented shrimp paste taste floral and pungent at the same time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wonderful%20Life%20Mansion%2C%2036-48%20Wenming%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="FT · Bak Kut Teh (Yuexiu)"
  />
);

export default FtBakKutTehYuexiu;
