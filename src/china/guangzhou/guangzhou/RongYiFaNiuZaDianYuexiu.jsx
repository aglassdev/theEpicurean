...
const RongYiFaNiuZaDianYuexiu = () => (
  <RestaurantPage
    restaurantName="Rong Yi Fa Niu Za Dian (Yuexiu)"
    ...
    pageTitle="Rong Yi Fa Niu Za Dian (Yuexiu)"
  />
);

export default RongYiFaNiuZaDianYuexiu;
