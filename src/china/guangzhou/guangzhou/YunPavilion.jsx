...
const YunPavilion = () => (
  <RestaurantPage
    restaurantName="Yun Pavilion"
    address="5F, Conrad Hotel, 222 Xingmin Road, Zhujiang New Town, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+862037056586"
    website="https://www.hilton.com/en/hotels/canxwci-conrad-guangzhou/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lavish interior is inspired by the eight categories of Chinese musical instruments, while the Longquan celadon teacups add a touch of refinement. The experienced kitchen team focuses on traditional Cantonese fare, spiced up by the clever use of gourmet ingredients, such as the signature deep-fried honeycomb taro puff stuffed with seared scallop. In addition, the menu includes regional specialties that cater to all tastes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20Conrad%20Hotel%2C%20222%20Xingmin%20Road%2C%20Zhujiang%20New%20Town%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Yun Pavilion"
  />
);

export default YunPavilion;
