...
const TungFookSuperiorCuisine = () => (
  <RestaurantPage
    restaurantName="Tung Fook Superior Cuisine"
    address="Room 104, 20 Haiming Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+8613380018223"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tung-fook-superior-cuisine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The novel industrial façade grabs the eyeballs with fluted glass, metal frames and a glowing entrance. Classic Cantonese fare dominates the concise but appetising menu; check out the blackboard for catch of the day and seasonal specials. Most of the top-notch seafood and fish is wild-caught, but meat dishes like thinly sliced beef sirloin blanched in pickled cabbage broth or pan seared pork nose tendons in black bean sauce deserve as much attention...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Room%20104%2C%2020%20Haiming%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tung Fook Superior Cuisine"
  />
);

export default TungFookSuperiorCuisine;
