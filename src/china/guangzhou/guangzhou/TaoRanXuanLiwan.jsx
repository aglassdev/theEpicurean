...
const TaoRanXuanLiwan = () => (
  <RestaurantPage
    restaurantName="Tao Ran Xuan (Liwan)"
    address="50 Shamian South Street, Liwan, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862081202828"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tao-ran-xuan-liwan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ubiquitous Chinese interior and live zither music playing at night may seem incongruous given the European exterior, but the authentic Cantonese food with regional offerings is so good you will probably choose to gloss over the oxymoron. Early risers come for an authentic dim sum brekky – don’t miss their shrimp dumplings, and thousand-year egg puff pastry with young ginger. Baked No.1 chicken with sand ginger boasts springy skin and silky meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50%20Shamian%20South%20Street%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tao Ran Xuan (Liwan)"
  />
);

export default TaoRanXuanLiwan;
