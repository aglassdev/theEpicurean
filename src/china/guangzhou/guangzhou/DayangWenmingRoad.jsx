...
const DayangWenmingRoad = () => (
  <RestaurantPage
    restaurantName="Dayang (Wenming Road)"
    address="160-1 Wenming Road, Yuexiu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥"
    phoneNumber="+862083327931"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/dayang-wenming-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1983, Dayang has been synonymous with double-boiled soups, which dominate its menu. Three stacks of steel steamers in the corner turn out tasty health tonics every couple hours and you never know in advance exactly what will be available. In the top-selling silkie chicken soup in whole coconut, meaty and nutty flavours mingle. The quail soup is also popular. Adventurous eaters might like to try the turtle jelly with milk and honey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=160-1%20Wenming%20Road%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Dayang (Wenming Road)"
  />
);

export default DayangWenmingRoad;
