...
const TheAttic = () => (
  <RestaurantPage
    ...
    address="A3-103, T.I.T Smart Zone, Yuan Cun, Tianhe, Guangzhou, China Mainland"
    cuisine="European Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+8615322001440"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/the-attic-1208124"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At The Attic, located in a historical cotton mill turned science park, they believe it takes time for flavours to develop in food. The young kitchen team excels in lengthy and painstaking processes such as meat aging and sauce fermentation. Most items are made from scratch in-house, including hand-spun ice cream, charcuterie, bread and butter. The menu changes according to the season and features mostly produce from China. The desserts are worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=A3-103%2C%20T.I.T%20Smart%20Zone%2C%20Yuan%20Cun%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="The Attic"
  />
);
