...
const TongJi = () => (
  <RestaurantPage
    restaurantName="Tong Ji"
    address="3 Fuguangli, Changshou East Road, Liwan, Guangzhou, China Mainland"
    cuisine="Noodles and Congee"
    priceRange="¥"
    phoneNumber="+862081867395"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/tong-ji"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in an alley, this two-storey, no-frills joint has been around for over 30 years. You're not here for the ambience, but for the poached chicken – only free-range pullets (that have not yet laid an egg) are used, for their springy skin, oily richness, silky flesh and robust flavour. The creamy chicken congee is loaded with juicy, velvety meat. Seasoned with soy sauce, the stir-fried ribbon rice noodles with beef seduces with smoky wok hei...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Fuguangli%2C%20Changshou%20East%20Road%2C%20Liwan%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Tong Ji"
  />
);
