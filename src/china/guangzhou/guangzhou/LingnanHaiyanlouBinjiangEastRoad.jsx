...
const LingnanHaiyanlouBinjiangEastRoad = () => (
  <RestaurantPage
    restaurantName="Lingnan Haiyanlou (Binjiang East Road)"
    address="2-3F, Jiangpan Huating, 1040 Binjiang East Road, Haizhu, Guangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥"
    phoneNumber="+862034305888"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/hai-yan-lou-binjiang-east-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The two chefs previously worked in the kitchens of a prestigious hotel, and their skills are unquestionable – which is why it's so hard to get a table here. Try the premium trio, which used to be reserved for state banquets: buttery foie gras, squab with crispy skin and the tanginess of plum, and springy goose webs and wings in white marinade. Meat is barbecued daily in limited servings. Go with a group to enjoy the generous portions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-3F%2C%20Jiangpan%20Huating%2C%201040%20Binjiang%20East%20Road%2C%20Haizhu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Lingnan Haiyanlou (Binjiang East Road)"
  />
);

export default LingnanHaiyanlouBinjiangEastRoad;
