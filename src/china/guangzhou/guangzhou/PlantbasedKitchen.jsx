...
const PlantbasedKitchen = () => (
  <RestaurantPage
    restaurantName="Plant-Based Kitchen"
    address="Shop 201, 2F, One St, 11-17 Xinsheng Road, Tianhe, Guangzhou, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥¥"
    phoneNumber="+8618144853101"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/plant-based-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Without the escort of a waiter, you would never spot the unobtrusive (sign-free) entrance to this eatery. Once seated at the counter overlooking the open kitchen, diners admire as the 14-course vegan tasting menu is unfolded. The chef excels at crafting the same ingredient with varying textures, flavours and temperatures. Nori roll stuffed with water bamboo, lotus root, water chestnut and watershield affords lovely textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20201%2C%202F%2C%20One%20St%2C%2011-17%20Xinsheng%20Road%2C%20Tianhe%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Plant-Based Kitchen"
  />
);

export default PlantbasedKitchen;
