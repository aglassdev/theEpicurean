...
const EaseYuexiu = () => (
  <RestaurantPage
    restaurantName="Ease (Yuexiu)"
    address="112A, 1F, Newspaper Printing Service Building, 289 Art Park, 289 Guangzhou Middle Avenue, Yuexiu, Guangzhou, China Mainland"
    cuisine="Sichuan"
    priceRange="¥¥"
    phoneNumber="+862037630289"
    website="https://guide.michelin.com/en/guangdong-province/guangzhou/restaurant/ease-yuexiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a printing plant-turned-cultural park, the two-storey restaurant boasts an airy, high-ceilinged dining room. Faux-industrial elements work well with wood and bamboo accents for a relaxed ambience. The menu features simple dishes with Sichuanese touches, such as the must-try poached fish with peppercorns on the vine – layered flavours contrast nicely with the velvety fish. Friendly service and sensible prices are also reasons to visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=112A%2C%201F%2C%20Newspaper%20Printing%20Service%20Building%2C%20289%20Art%20Park%2C%20289%20Guangzhou%20Middle%20Avenue%2C%20Yuexiu%2C%20Guangzhou%2C%20China%20Mainland"
    pageTitle="Ease (Yuexiu)"
  />
);

export default EaseYuexiu;
