...
const WuZiMianGuan = () => (
  <RestaurantPage
    restaurantName="Wu Zi Mian Guan"
    address="116 Huansha Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8618334375200"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/wu-zi-mian-guan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After opening in 2017, Wu Zi shot to fame, becoming the best-known noodle shop in the area. Classic Hangzhou-style noodles are either served in soup or tossed in sauces with various toppings – prepared to the exacting standards of the owner, a chef by profession. The pork kidney and liver are nicely browned while retaining their succulence and a lovely chewiness. Another must-try classic topping: shrimps and eel sautéed with onion, mushrooms and dried tofu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=116%20Huansha%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Wu Zi Mian Guan"
  />
);

export default WuZiMianGuan;
