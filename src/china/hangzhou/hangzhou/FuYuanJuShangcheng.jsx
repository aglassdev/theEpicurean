...
const FuYuanJuShangcheng = () => (
  <RestaurantPage
    restaurantName="Fu Yuan Ju (Shangcheng)"
    address="35 Hefang Street, Shangcheng, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657187038018"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/fu-yuan-ju-shangcheng"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Hefang%20Street%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Fu Yuan Ju (Shangcheng)"
  />
);

export default FuYuanJuShangcheng;
