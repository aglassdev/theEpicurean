...
const WildYeast = () => (
  <RestaurantPage
    restaurantName="Wild Yeast"
    address="304-305, 3F, Zonia Tide Ginza, 2077 Binsheng Road, Binjiang, Hangzhou, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+8617799836669"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/wild-yeast"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Every table in the softly lit room commands a view of the open kitchen. The head chef hailing from Taizhou designed the set and à la carte menus to highlight the natural flavours of the best seafood shipped from his hometown. Besides the famous yellow croaker braised in fish stock, also try the fried crab in curry sa cha sauce over pan-fried rice cake in autumn. The extensive wine list covers thousands of labels, mostly from Burgundy in France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=304-305%2C%203F%2C%20Zonia%20Tide%20Ginza%2C%202077%20Binsheng%20Road%2C%20Binjiang%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Wild Yeast"
  />
);

export default WildYeast;
