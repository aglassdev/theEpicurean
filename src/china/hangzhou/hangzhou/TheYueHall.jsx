...
const TheYueHall = () => (
  <RestaurantPage
    restaurantName="The Yue Hall"
    address="58F, Sky Habitat, T1 Raffles City, 228 Xinye Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+8657188370188"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/the-yue-hall"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the 58th floor of a skyscraper, this tiny gem with just eight tables affords lovely views of the bustling financial centre. Modernised Chinese motifs are juxtaposed with a futuristic electric glow. Under the supervision of an experienced chef from Hong Kong, the kitchen turns out umami-packed double-boiled soups, such as the whelk and dried scallop soup with matsutake mushrooms. The live seafood, such as fish and crab, tastes divine even when simply steamed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58F%2C%20Sky%20Habitat%2C%20T1%20Raffles%20City%2C%20228%20Xinye%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="The Yue Hall"
  />
);

export default TheYueHall;
