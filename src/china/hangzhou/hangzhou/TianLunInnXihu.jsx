...
const TianLunInnXihu = () => (
  <RestaurantPage
    restaurantName="Tian Lun Inn (Xihu)"
    address="1F, Building No. 7, Ecological Cluster, 550 Xixi Road, Xihu, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥¥"
    phoneNumber="+8657181060001"
    website="https://www.tianluninn.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Synonymous with delicious crab dishes, Tian Lun Inn serves different species of this crustacean depending on the season, with its multicourse all-crab meals being the most renowned. With firm, plump flesh and rich, creamy roe, hairy crabs from Taihu Lake are extremely popular year round. The crab roe pastry takes 45 minutes to prepare, but it's well worth the wait. Try local specialities such as West Lake beef soup or West Lake vinegar fish, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Building%20No.%207%2C%20Ecological%20Cluster%2C%20550%20Xixi%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Tian Lun Inn (Xihu)"
  />
);

export default TianLunInnXihu;
