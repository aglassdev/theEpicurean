...
const RuYuan = () => (
  <RestaurantPage
    restaurantName="Ru Yuan"
    address="11 Yuquan Road, Xihu, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥¥¥"
    phoneNumber="+8657187079088"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/ru-yuan"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Ru Yuan stands amid lush vegetation. Though the menu seems to feature familiar dishes like Xihu fish in vinegar sauce or sautéed shrimps with Longjing tea leaves, each one has been extensively fine-tuned and tweaked. The chef’s personal character shines through in the meticulous details. The gold medal braised pork exudes winey aromas; the pork is sliced thinly and shaped into a pagoda for perfect texture and exquisite plating...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20Yuquan%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Ru Yuan"
  />
);
