...
const ABingBaoShanMian = () => (
  <RestaurantPage
    restaurantName="A Bing Bao Shan Mian"
    address="21 Zhonghe Middle Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8613336149088"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/a-bing-bao-shan-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Experienced chef-owner A Bing honed his skills in a famous noodle shop in town before opening this joint over 40 years ago. Having moved to the current address in recent years, it remains a firm favourite with many locals. Its signature fried eel noodle soup has impressively springy noodles and crispy, meaty eel chunks. Try his semi noodle soup, too – noodles dressed sparingly in a thick broth, for a flavour-forward experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Zhonghe%20Middle%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="A Bing Bao Shan Mian"
  />
);

export default ABingBaoShanMian;
