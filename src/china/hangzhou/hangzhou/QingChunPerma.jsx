...
const QingChunPerma = () => (
  <RestaurantPage
    restaurantName="Qing Chun Perma"
    address="181 Baileqiao, Xihu, Hangzhou, China Mainland"
    cuisine="Vegetarian"
    priceRange="¥¥"
    phoneNumber="+8657187975777"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/qing-chun-perma"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a serene garden near Lingyin Temple, this restaurant serves vegetarian dishes that draw on Chinese traditions, as well as Southeast Asian flavours. Most ingredients are organic, including naturally grown grains and rice. In the bright, airy space with an open kitchen, try the delicious, silky smooth hazelnut-brown rice milk. Fresh dim sum are hand-made to order, such as organic dark rye wonton drizzled with house-made chilli sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=181%20Baileqiao%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Qing Chun Perma"
  />
);

export default QingChunPerma;
