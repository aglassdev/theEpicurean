...
const DatouYingshiXiaoguan = () => (
  <RestaurantPage
    restaurantName="Datou Yingshi Xiaoguan"
    address="101, Building 7, 45 Tiaozhouwan, Shangcheng, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657186063509"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/datou-yingshi-xiaoguan"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101%2C%20Building%207%2C%2045%20Tiaozhouwan%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Datou Yingshi Xiaoguan"
  />
);

export default DatouYingshiXiaoguan;
