...
const JiangNanYuGe = () => (
  <RestaurantPage
    restaurantName="Jiang Nan Yu Ge"
    address="49-53 Shiwukui Alley, Shangcheng, Hangzhou, China Mainland"
    cuisine="Ningbo"
    priceRange="¥¥¥"
    phoneNumber="+8657189969261"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/jiang-nan-yu-ge"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a historical back street, this place teleports diners to a bygone era. The rustic-style interior is quirky, with bottles of yellow wine, including its own brand, placed on the floor. The kitchen team tailors menus to diners' budgets and the fish-heavy Ningbo fare is rife with bold flavours and umami. Try the steamed crab on pork ribs with distillers grains. With only two tables for two in the main room, it makes sense to book a private room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49-53%20Shiwukui%20Alley%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Jiang Nan Yu Ge"
  />
);

export default JiangNanYuGe;
