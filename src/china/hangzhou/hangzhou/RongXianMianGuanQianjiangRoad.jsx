...
const RongXianMianGuanQianjiangRoad = () => (
  <RestaurantPage
    restaurantName="Rong Xian Mian Guan (Qianjiang Road)"
    address="629 Qianjiang Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8615058100830"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/rong-xian-mian-guan-qianjiang-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This shop with over 20 years of history moved to this location a few years ago. Its signature sliced fish noodle soup with pickled cabbage isn't commonly found in Hangzhou-style noodle shops: thin slices of lean snakehead fish is briefly blanched in a fish bone stock with spices and pickled cabbage. Traditional noodles such as pian er chuan and ban chuan are best enjoyed with marinated meats such as chicken feet, duck's head or meatballs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=629%20Qianjiang%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Rong Xian Mian Guan (Qianjiang Road)"
  />
);

export default RongXianMianGuanQianjiangRoad;
