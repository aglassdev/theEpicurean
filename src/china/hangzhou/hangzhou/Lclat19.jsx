...
const Lclat19 = () => (
  <RestaurantPage
    restaurantName="L'éclat 19"
    address="Inside Vallie Hotel, 85-3 Zhijiang Road, Xihu, Hangzhou, China Mainland"
    cuisine="French Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+8657186767979"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/l-eclat-19"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="L’éclat 19 is nestled in a wooded valley on the southern shore of West Lake. The journey to the place itself is quite an experience. Open for dinner only, it offers two tasting menus that keep pace with the seasons, both signed by chef Olivier Elzer. Gallic classics are given refined Chinese twists – the bread is served with butter infused with the Chinese Moutai liquor. Top notch ingredients are sourced globally; creative sauces deliver layered flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inside%20Vallie%20Hotel%2C%2085-3%20Zhijiang%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="L'éclat 19"
  />
);

export default Lclat19;
