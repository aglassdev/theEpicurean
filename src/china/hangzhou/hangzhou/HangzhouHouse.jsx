...
const HangzhouHouse = () => (
  <RestaurantPage
    restaurantName="Hangzhou House"
    address="Building EX4, Amandayun, 22 Fayun Lane, Xihu Street, Xihu, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥¥"
    phoneNumber="+8657187973776"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hangzhou-house"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Close to Lingyin Temple and Amanfayun resort, this rustic-style restaurant has a serene vibe. On the menu, classic Jiangzhe dishes get a refined makeover with some creative and surprising combinations. The signature double-boiled deboned chicken with termite mushrooms is loaded with deep flavours. The signature rice cake in chopped crab sauce is another standout. House-brewed fruit wines, such as bayberry, plum and lychee, are also worth a try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%20EX4%2C%20Amandayun%2C%2022%20Fayun%20Lane%2C%20Xihu%20Street%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hangzhou House"
  />
);

export default HangzhouHouse;
