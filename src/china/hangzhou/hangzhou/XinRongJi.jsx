...
const XinRongJi = () => (
  <RestaurantPage
    ...
    address="No. 5, Dazhongxiuqi Village, west area of Xixi National Wetland Park, Tianmushan Road, Yuhang, Hangzhou, China Mainland"
    cuisine="Taizhou"
    priceRange="¥¥¥"
    phoneNumber="+8657188863777"
    website="http://www.xinrongji.cc"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The restaurant’s location outside the city centre – in Xixi National Wetland Park – doesn’t deter diners! The lush surroundings, charming garden, understated decor and quality food make the trip worthwhile. Taizhou classics like deep-fried hairtail and braised giant yellow croaker are a must. Surprisingly, the kitchen is also well-versed in Hangzhou cooking, such as soft, chewy braised pork intestine, jazzed up with a dash of spiciness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.%205%2C%20Dazhongxiuqi%20Village%2C%20west%20area%20of%20Xixi%20National%20Wetland%20Park%2C%20Tianmushan%20Road%2C%20Yuhang%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Xin Rong Ji"
  />
);

export default XinRongJi;
