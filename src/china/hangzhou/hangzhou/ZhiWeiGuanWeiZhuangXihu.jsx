...
const ZhiWeiGuanWeiZhuangXihu = () => (
  <RestaurantPage
    restaurantName="Zhi Wei Guan • Wei Zhuang (Xihu)"
    address="10-12 Yanggong Causeway, Xihu, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657187970568"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/zhi-wei-guan-%E2%80%A2-wei-zhuang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in the lakeside Hongli Villa complex in a picturesque setting, this restaurant is the city's pioneer in garden dining. The kitchen team excels in the new Hangzhou cuisine – rooted in tradition but updated with Western techniques. The signature gold medal braised pork has a melt-in-the-mouth texture, its fine slices modelled into a pagoda. Lotus flower pastries are exquisitely crafted, with purple sweet potato filling in a flaky crust...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10-12%20Yanggong%20Causeway%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Zhi Wei Guan • Wei Zhuang (Xihu)"
  />
);

export default ZhiWeiGuanWeiZhuangXihu;
