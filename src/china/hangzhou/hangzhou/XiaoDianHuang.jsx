...
const XiaoDianHuang = () => (
  <RestaurantPage
    restaurantName="Xiao Dian Huang"
    address="205-207, 2F, Building 8, Greenland Central Plaza, Daguan Road, Gongshu, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥"
    phoneNumber="+8615088786097"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/xiao-dian-huang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner, who hails from Shaoxing, insists on driving back to his hometown every other day to source the freshest ingredients for his restaurant – which explains why the menu is handwritten on a white board and different every day. That said, the must-try stinky tofu is a permanent fixture: made with 20-plus-year-old fermenting brine from his family, it has rich deep flavours that complement the lamb brain it is steamed with. Try the river fish, too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=205-207%2C%202F%2C%20Building%208%2C%20Greenland%20Central%20Plaza%2C%20Daguan%20Road%2C%20Gongshu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Xiao Dian Huang"
  />
);

export default XiaoDianHuang;
