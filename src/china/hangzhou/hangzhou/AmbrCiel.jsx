...
const AmbrCiel = () => (
  <RestaurantPage
    restaurantName="Ambré Ciel"
    address="1F, Meifan Plaza Proya, 588 Xixi Road, Xihu, Hangzhou, China Mainland"
    cuisine="Innovative"
    priceRange="¥¥¥¥"
    phoneNumber="+8619357558063"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/ambre-ciel"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After honing his skills in a number of prestigious kitchens, chef Alan Yu took on this atmospheric restaurant in 2022. The six tables are enclosed by heavily textured stone walls that afford much privacy. There is one private room for ten diners, with multimedia projections for an immersive experience. They serve a single tasting menu at lunch and dinner, with courses rooted in French tradition and boosted by subtle Chinese twists...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Meifan%20Plaza%20Proya%2C%20588%20Xixi%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Ambré Ciel"
  />
);

export default AmbrCiel;
