...
const HangsDelicacyXihu = () => (
  <RestaurantPage
    restaurantName="Hang's Delicacy (Xihu)"
    address="92 Zhijiang Road, Xihu, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657187620571"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hang-s-delicacy"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the bank of Qiantang River, at the foot of Liuhe Pagoda, this airy, bright and sleekly furnished restaurant is a bit out of the way, but locals come in droves nonetheless. Authentic home-style Hangzhou dishes, such as steamed mud crab on a minced pork patty, are served alongside more novel creations. Portion sizes are generous; come in a larger party to get to sample a wider variety of dishes. Reservations not accepted. Visit early to beat the crowd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=92%20Zhijiang%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hang's Delicacy (Xihu)"
  />
);

export default HangsDelicacyXihu;
