...
const Shuiyang = () => (
  <RestaurantPage
    restaurantName="Shuiyang"
    address="Xianghu Xiaoyao Manor, 256 Yuewang Road, Xiaoshan, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥¥"
    phoneNumber="+8657182352226"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/shuiyang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Xiaoyao Manor hotel opened in Xianghu Lake Resort in 2020. This F&B outlet is set in an idyllic landscape, boasts gorgeous views and serves authentic Hangzhou, Zhejiang dishes, as well as Xiaoshan farmhouse cooking. Made-to-order fish head à la Qiandao Lake can be prepared in various ways and is great for sharing. The peasant-style steamed stinky duo is quite unique and worth trying. The perfect spot to eat as part of your Xianghu Lake itinerary...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Xianghu%20Xiaoyao%20Manor%2C%20256%20Yuewang%20Road%2C%20Xiaoshan%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Shuiyang"
  />
);

export default Shuiyang;
