...
const PanFangChunZhongshanSouthRoad = () => (
  <RestaurantPage
    restaurantName="Pan Fang Chun (Zhongshan South Road)"
    address="479-481 Zhongshan South Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+8615168325020"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/fang-chun-jian-jiao-zhongshan-south-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A favourite spot for breakfast among locals, Pan Fang Chun specialises in potstickers – with a nicely charred, paper-thin crust and juicy pork filling, they taste even better dipped in chilli sauce and vinegar. Cut through the richness with a bowl of sweet soymilk. For a lighter option, try the bite-size wonton soup with laver and scallions. Expect to queue at the door for service, and they close before 1pm, so come early to avoid disappointment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=479-481%20Zhongshan%20South%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Pan Fang Chun (Zhongshan South Road)"
  />
);

export default PanFangChunZhongshanSouthRoad;
