...
const DeMingFanDian = () => (
  <RestaurantPage
    restaurantName="De Ming Fan Dian"
    address="36 Huyu Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657186080573"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/de-ming-fan-dian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The down-to-earth joint is nestled in a residential neighbourhood. At the entrance of the dining room, dishes are neatly displayed – leafy greens, meat stews in clay pots and of course, the river fish that the restaurant is most famous for. Fried eel in bean sauce is loaded with scallion and garlic aromas. Braised pork intestine is tender and flavoursome, even better with their secret dip. Try also their house-made wines infused with herbs or fruits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20Huyu%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="De Ming Fan Dian"
  />
);

export default DeMingFanDian;
