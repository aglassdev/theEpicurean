...
const LaLune = () => (
  <RestaurantPage
    restaurantName="La Lune"
    address="L628, 6F, The Mixc, 701 Fuchun Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Chinese Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+8657189701688"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/la-lune"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The high-ceilinged room is lavishly furnished with elegant chandeliers, ceiling fans and elaborate trims. The kitchen team excels in fusion Chinese cooking that creatively mixes and matches influences and techniques from various regional cuisines. Thinly sliced air-dried mackerel steeped in a special briny-sweet sauce is loaded with umami. The slow-cooked veal in a truffle sauce literally melts in your mouth. The curated tea list is intriguing!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L628%2C%206F%2C%20The%20Mixc%2C%20701%20Fuchun%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="La Lune"
  />
);
