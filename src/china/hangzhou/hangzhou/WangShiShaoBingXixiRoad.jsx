...
const WangShiShaoBingXixiRoad = () => (
  <RestaurantPage
    restaurantName="Wang Shi Shao Bing (Xixi Road)"
    address="60 Xixi Road, Xihu, Hangzhou, China Mainland"
    cuisine="Small eats"
    priceRange="¥"
    phoneNumber="+8613588839198"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/wang-shi-shao-bing"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small shop front would be easy to miss, were it not for the queue waiting to order shaobing flatbread and youtiao dough sticks. Right by the entrance the chefs can be seen busily making both items by hand; served piping hot, they are well loved for their fluffy and crispy texture. Locals typically order soymilk or tofu pudding to go with these fried treats, but you can also opt for sticky rice balls with the filling of your choice. Bargain prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%20Xixi%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Wang Shi Shao Bing (Xixi Road)"
  />
);

export default WangShiShaoBingXixiRoad;
