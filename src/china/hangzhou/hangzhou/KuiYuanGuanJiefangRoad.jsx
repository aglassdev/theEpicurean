...
const KuiYuanGuanJiefangRoad = () => (
  <RestaurantPage
    restaurantName="Kui Yuan Guan (Jiefang Road)"
    address="154 Jiefang Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥"
    phoneNumber="+8657187029012"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/kui-yuan-guan-jiefang-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A household name for its Hangzhou-style noodles, Kui Yuan Guan also doubles up as a museum that charts life in the city dating back to 1867. Countless inscriptions by historical big shots hint at its importance. For noodles, head to the ground floor; the sliced pork noodles impress with their al dente texture and robust flavours. Classic Zhejiang fare, such as Ningbo shredded eel or fish balls with a trio of vegetables, is served on the second floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=154%20Jiefang%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Kui Yuan Guan (Jiefang Road)"
  />
);

export default KuiYuanGuanJiefangRoad;
