...
const HuiXinXiaoChiDian = () => (
  <RestaurantPage
    restaurantName="Hui Xin Xiao Chi Dian"
    address="83-1 Deyuan Road, Gongshu, Hangzhou, China Mainland"
    cuisine="Dim Sum"
    priceRange="¥"
    phoneNumber="+8657186036127"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hui-xin-xiao-chi-dian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny shop frequented by locals is always jam-packed at lunchtime. With tasty offerings at bargain prices, it's not hard to see why! The menu features just two dishes – wonton and shao mai – but they come with an array of fillings and can be served in soup or tossed in sauces. For example, shao mai with juicy pork and diced bamboo shoot wrapped in paper-thin skin. The oversized wonton with salted egg yolk and pork filling is beautifully folded...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=83-1%20Deyuan%20Road%2C%20Gongshu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hui Xin Xiao Chi Dian"
  />
);

export default HuiXinXiaoChiDian;
