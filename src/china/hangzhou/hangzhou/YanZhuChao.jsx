...
const YanZhuChao = () => (
  <RestaurantPage
    restaurantName="Yan Zhu Chao"
    address="2-3F, Block C, Zhongying Xinghai, 30 Zhongchuang Road, Binjiang, Hangzhou, China Mainland"
    cuisine="Chao Zhou"
    priceRange="¥¥¥¥"
    phoneNumber="+8657186672188"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/yan-zhu-chao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The room sports cultural motifs from the Chaoshan region, including a miniature replica of Guangji Bridge, an icon of Chaozhou. Walk-in diners will be seated in the main dining room and served an à la carte menu. Private rooms must be booked in advance, with a tailored menu. The signature marinated “gelato” raw mud crab boasts creamy roe that melts in the mouth. Also try the double-boiled silkie chicken soup with deer tendon and ginseng...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-3F%2C%20Block%20C%2C%20Zhongying%20Xinghai%2C%2030%20Zhongchuang%20Road%2C%20Binjiang%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Yan Zhu Chao"
  />
);

export default YanZhuChao;
