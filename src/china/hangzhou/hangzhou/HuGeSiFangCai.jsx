...
const HuGeSiFangCai = () => (
  <RestaurantPage
    restaurantName="Hu Ge Si Fang Cai"
    address="44 Tiaozhouwan, Shangcheng, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657156583600"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hu-ge-si-fang-cai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Next to a cultural park, this restaurant stands in serene, lush nature. The interior, too, is pleasing, with its retro water town decor. On the menu, Hangzhou classics take centre stage; river fish stands out in particular. The slaughtered-to-order river eel is steamed with preserved mustard greens and has oily flesh and deep umami. The fresh local vegetables and traditional staples such as Hangzhou style tossed noodles and sticky rice cake are also worth trying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Tiaozhouwan%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hu Ge Si Fang Cai"
  />
);

export default HuGeSiFangCai;
