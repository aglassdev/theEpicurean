...
const KingsChoiceHuyuRoad = () => (
  <RestaurantPage
    restaurantName="King's Choice (Huyu Road)"
    address="36-7 Huyu Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8613588856170"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/king-s-choice"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a residential neighbourhood, King’s Choice is known for its authentic Hangzhou cooking, generous portions and wallet-friendly prices. Most dishes are cooked à la minute and boast exceptional wok hei. The signature deep-fried stinky tofu is crispy on the outside and silky on the inside, with chilli sauce on the side to accentuate its unique flavours. The deep-fried wingette in salted egg yolk sauce is also sinfully delicious. Come early to avoid a long wait...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36-7%20Huyu%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="King's Choice (Huyu Road)"
  />
);

export default KingsChoiceHuyuRoad;
