...
const LiAn = () => (
  <RestaurantPage
    restaurantName="Li' An"
    address="50F, Conrad Hotel, 228 Xinye Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+8657156966666"
    website="https://conrad.hilton.com.cn/zh-cn/hotel/hangzhou/conrad-hangzhou-hghfrci/dining3115.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Atop a skyscraper hotel, this elegant place commands breath-taking views of the Qiantang River. The decor is inspired by the East-meets-West Art Deco style of China around the 1920s. Cantonese classics are broadly covered – from soups and barbecue meats, to stir-fries with plenty of wok hei, plus a few innovative Zhejiang dishes. Don’t miss the crispy skin chicken. The sautéed fish bladder with pickled mustard greens goes well with an alcoholic drink...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=50F%2C%20Conrad%20Hotel%2C%20228%20Xinye%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Li' An"
  />
);
