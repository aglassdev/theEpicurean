...
const HotwoodsXihu = () => (
  <RestaurantPage
    restaurantName="Hotwoods (Xihu)"
    address="1F, Building 27, Xixi Yihao, Ziyun Street, Xihu, Hangzhou, China Mainland"
    cuisine="Latin American"
    priceRange="¥¥"
    phoneNumber="+8617706409133"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hotwoods"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bustling spot serves barbecue in Texan, Brazilian and Argentinian styles. With a wood-fired smokery and ovens on site, the place exudes intoxicating smells. Try slow-smoked beef brisket, either grain-fed from the U.S. or grass-fed from New Zealand: the former is richer, the latter leaner. Pronounced smoky notes complement the beef perfectly. Grilled pineapple in banana walnut sauce for dessert cuts through the richness. The wine list is worth exploring...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Building%2027%2C%20Xixi%20Yihao%2C%20Ziyun%20Street%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hotwoods (Xihu)"
  />
);

export default HotwoodsXihu;
