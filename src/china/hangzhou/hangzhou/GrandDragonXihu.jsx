...
const GrandDragonXihu = () => (
  <RestaurantPage
    restaurantName="Grand Dragon (Xihu)"
    address="1F, The Dragon, 120 Shuguang Road, Xihu, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥¥"
    phoneNumber="+8657187998833"
    website="http://www.dragon-hotel.com/en-US/GourmetRestaurant/RestaurantList?hotelId=8c860cde-4465-458d-a650-0b596e54265c"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established hotel restaurant is famous for its gorgeous garden views, elegant vibe and upmarket menu. Authentic Zhejiang cooking takes centre stage, alongside new creations melding Cantonese cooking techniques. Classics such as sautéed river shrimps with Longjing tea, and crispy eel with shrimps are revisited, the latter as fried eel pieces stuffed with minced shrimp in a sweet and sour glaze. Private dining rooms of various sizes are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20The%20Dragon%2C%20120%20Shuguang%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Grand Dragon (Xihu)"
  />
);

export default GrandDragonXihu;
