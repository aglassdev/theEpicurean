...
const QingTao = () => (
  <RestaurantPage
    restaurantName="Qing Tao"
    address="226-1 Siyanjing, Hupao Road, Xihu, Hangzhou, China Mainland"
    cuisine="Zhejiang"
    priceRange="¥¥"
    phoneNumber="+8657187997997"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/qing-tao"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner with almost 30 years of cooking under his belt still gets hands on in the kitchen at times. Check the blackboard for no-frills, wok hei-laden dishes, most of which star local, seasonal produce. The sautéed pork kidney is crisp in texture and mildly hot in flavour. Soft and chewy, the sautéed rice cake is the staple of choice. House-made pork sausage and rice wine brewed by the owner’s father are some of the unique items available only here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=226-1%20Siyanjing%2C%20Hupao%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Qing Tao"
  />
);

export default QingTao;
