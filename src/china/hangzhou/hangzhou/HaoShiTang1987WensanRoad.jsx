...
const HaoShiTang1987WensanRoad = () => (
  <RestaurantPage
    restaurantName="Hao Shi Tang 1987 (Wensan Road)"
    address="No.001, 1F, Building B, WSOO, 500 Wensan Road, Xihu, Hangzhou, China Mainland"
    cuisine="Hang Zhou"
    priceRange="¥¥"
    phoneNumber="+8657189990078"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/hao-shi-tang-1987-wensan-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sign says ‘1987’ because that is when the owner became a professional chef. Known for authentic Hangzhou cooking at bargain prices, this neighbourhood joint does not have a paper menu. Pick your own river fish and veggies, and specify how you want them cooked or check out the blackboard for specials. Sweet and sour pork ribs boast a crisp crust covered in a punchy sauce. Finish with sweet glutinous rice wine with osmanthus aroma made from house-made distillers’ grains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=No.001%2C%201F%2C%20Building%20B%2C%20WSOO%2C%20500%20Wensan%20Road%2C%20Xihu%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Hao Shi Tang 1987 (Wensan Road)"
  />
);

export default HaoShiTang1987WensanRoad;
