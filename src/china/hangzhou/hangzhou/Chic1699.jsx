...
const Chic1699 = () => (
  <RestaurantPage
    ...
    address="L698, 6F, The Mixc, 701 Fuchun Road, Shangcheng, Hangzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+8657188131699"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/chic-1699-1209672"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dimly lit space on two levels feels modern and chic, with its mix of bare concrete, glass, and metal structures. The food, meanwhile, is very much in keeping with Fujian tradition. Seafood from the province features heavily on the menu, alongside other Fujian produce. Signatures include honey-glazed grilled river eel with crispy skin and oily, velvety flesh. The raw oysters from Xiamen Harbour dressed in speciality sauce are zesty and summery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L698%2C%206F%2C%20The%20Mixc%2C%20701%20Fuchun%20Road%2C%20Shangcheng%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Chic 1699"
  />
);

export default Chic1699;
