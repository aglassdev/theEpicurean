...
const FortuneGarden = () => (
  <RestaurantPage
    restaurantName="Fortune Garden"
    address="504-506, 5F, Phase 2, Star Avenue, 1766 Wentao Road, Binjiang, Hangzhou, China Mainland"
    cuisine="Cantonese"
    priceRange="¥¥¥"
    phoneNumber="+8657186077996"
    website="https://guide.michelin.com/en/zhe-jiang/hangzhou_1027184/restaurant/fortune-garden"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern, cosy restaurant sits on the top floor of a shopping mall. The menu showcases the best of Cantonese cooking with sophistication, astuteness and precision. Their dim sum lunch is a must, as are the barbecued meats. The honey-glazed cha siu pork, for instance, boasts the perfect ratio of fat and lean meat, as well as smoky and crispy charred edges. Plum sauce on the side cuts through the richness. Book ahead for private rooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=504-506%2C%205F%2C%20Phase%202%2C%20Star%20Avenue%2C%201766%20Wentao%20Road%2C%20Binjiang%2C%20Hangzhou%2C%20China%20Mainland"
    pageTitle="Fortune Garden"
  />
);

export default FortuneGarden;
