...
const YuMianTang = () => (
  <RestaurantPage
    restaurantName="Yu Mian Tang"
    address="73-77 Nanxin Road, Gusu, Suzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8651268705018"
    website="https://www.swymt.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The brand, dating back to 1876, was reopened on the same spot in 2019 by a descendant of the founder. The traditional Chinese façade is chic and striking; the room decorated with lanterns boasts canal views. The custom-made noodles work well with broth jazzed up by dried scallops. In summer, the shrimp-trio noodles are the must-try – springy shrimps with shrimp roe and tomalley make for an umami extravaganza. In winter, try the crab roe version...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73-77%20Nanxin%20Road%2C%20Gusu%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Yu Mian Tang"
  />
);

export default YuMianTang;
