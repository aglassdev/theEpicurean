...
const YangzhouYanQuYuan = () => (
  <RestaurantPage
    restaurantName="Yangzhou Yan · Qu Yuan"
    address="2F, Podium, Building No.8, One Sino Finance Plaza, 6 Lingyan Road, Huqiu, Suzhou, China Mainland"
    cuisine="Huaiyang"
    priceRange="¥¥"
    phoneNumber="+8651269585877"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/yangzhou-yan-qu-yuan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Most of the kitchen team hails from Yangzhou, so it is no surprise that the elegantly appointed restaurant specialises in Yangzhou cuisine. Handmade dim sum is the must-try. Served piping hot, the soup dumpling with crabmeat and crab roe filling is wrapped in wafer-thin dough and meticulously pleated by hand. Enjoy the soup with a straw before biting into the plump dumpling. Other traditional Yangzhou dishes are also worth checking out. Bookings recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Podium%2C%20Building%20No.8%2C%20One%20Sino%20Finance%20Plaza%2C%206%20Lingyan%20Road%2C%20Huqiu%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Yangzhou Yan · Qu Yuan"
  />
);

export default YangzhouYanQuYuan;
