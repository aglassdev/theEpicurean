...
const BanLanHuqiu = () => (
  <RestaurantPage
    restaurantName="Ban Lan (Huqiu)"
    address="3F, Podium, Building No.8, One Sino Finance Plaza, 6 Lingyan Road, Huqiu, Suzhou, China Mainland"
    cuisine="Fujian"
    priceRange="¥¥¥"
    phoneNumber="+8651262626006"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/ban-lan-huqiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, traditional Fujian recipes get an update with an emphasis on lighter seasoning and natural flavours. Both the owner and the chef hail from Fujian, and only the best produce in season, mostly shipped straight from their home province, makes it onto the table. There are a number of set menus to choose from and they may feature signatures such as ginger duck stew, or peanut sweet soup with taro paste and bird's nest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Podium%2C%20Building%20No.8%2C%20One%20Sino%20Finance%20Plaza%2C%206%20Lingyan%20Road%2C%20Huqiu%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Ban Lan (Huqiu)"
  />
);

export default BanLanHuqiu;
