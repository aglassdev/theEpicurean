...
const XinJunFengCaiGuanTaijianlane = () => (
  <RestaurantPage
    restaurantName="Xin Jun Feng Cai Guan (Taijianlane)"
    address="2F, 9 Taijianlane, Gusu, Suzhou, China Mainland"
    cuisine="Jiangsu Cuisine"
    priceRange="¥¥¥"
    phoneNumber="+8651265219940"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/xin-jun-feng-cai-guan-taijianlane"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Suzhou's bustling shopping hub, this household name dates back to 1904. For over 20 years, this branch has been serving traditional Suzhou fare and seasonal delicacies to hungry shoppers. The Chinese sleeper fillet in wine lees sauce has silky but firm flesh and its robust flavour works well with the aromas of wine. Boasting bright colour, a creamy texture and lingering umami, the sautéed crabmeat and roe is freshly picked on the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%209%20Taijianlane%2C%20Gusu%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Xin Jun Feng Cai Guan (Taijianlane)"
  />
);

export default XinJunFengCaiGuanTaijianlane;
