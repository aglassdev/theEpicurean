...
const ZhuoYanzhuoMian = () => (
  <RestaurantPage
    restaurantName="Zhuo Yan·Zhuo Mian"
    address="Building 19, Ligongdi Phase 4, Suzhou Industrial Park, Suzhou, China Mainland"
    cuisine="Jiangzhe, Cantonese"
    priceRange="¥¥"
    phoneNumber="+8651266153588"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/zhuo-yan-zhuo-mian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the name – a nod to Suzhou's famous Zhuozheng Garden – an eclectic decor melds traditional Chinese and bold modern aesthetics. At lunchtime, it's all about Suzhou noodles: the soy-based broth is packed with deep flavours, thanks to the condensed base of chicken and pork bone. At dinner, prix-fixe menus, tailored in advance, feature cuisine that fuses Jiangzhe, Suzhou and Cantonese styles, and may include the signature crispy-skin squab...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%2019%2C%20Ligongdi%20Phase%204%2C%20Suzhou%20Industrial%20Park%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Zhuo Yan·Zhuo Mian"
  />
);

export default ZhuoYanzhuoMian;
