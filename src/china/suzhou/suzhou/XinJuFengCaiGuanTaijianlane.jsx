...
const XinJuFengCaiGuanTaijianlane = () => (
  <RestaurantPage
    restaurantName="Xin Ju Feng Cai Guan (Taijianlane)"
    ...
    pageTitle="Xin Ju Feng Cai Guan (Taijianlane)"
  />
);

export default XinJuFengCaiGuanTaijianlane;
