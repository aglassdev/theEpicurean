...
const SuChengJiaYanLigongdiRoad = () => (
  <RestaurantPage
    restaurantName="Su Cheng Jia Yan (Ligongdi Road)"
    address="43-45, Ligongdi Phase 1, Ligongdi Road, Suzhou Industrial Park, Suzhou, China Mainland"
    cuisine="Jiangsu Cuisine"
    priceRange="¥¥"
    phoneNumber="+8651262875088"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/su-cheng-jia-yan-ligongdi-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on the shore of Jinji Lake, this restaurant champions a modern take on Suzhou cuisine that shows restraint in the use of oil and seasoning. Prices are reasonable considering the scenic setting and remarkable food quality. The signature lion's head meatball soup is made with Berkshire pork, longsnout catfish and water chestnuts, delivering a bouncy texture and crunch. Reservations are only accepted for private rooms and the lakeside terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43-45%2C%20Ligongdi%20Phase%201%2C%20Ligongdi%20Road%2C%20Suzhou%20Industrial%20Park%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Su Cheng Jia Yan (Ligongdi Road)"
  />
);

export default SuChengJiaYanLigongdiRoad;
