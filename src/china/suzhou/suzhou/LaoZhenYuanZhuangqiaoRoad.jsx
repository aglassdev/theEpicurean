...
const LaoZhenYuanZhuangqiaoRoad = () => (
  <RestaurantPage
    restaurantName="Lao Zhen Yuan (Zhuangqiao Road)"
    address="168 Zhuangqiao Road, Wujiang, Suzhou, China Mainland"
    cuisine="Jiangsu Cuisine"
    priceRange="¥¥"
    phoneNumber="+8651263739177"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/lao-zhen-yuan-zhuangqiao-road"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in the late Qing Dynasty and defunct for almost a century, the brand got a reboot in 2016 and moved to the old town in 2023. Set between canals and historical streets, it serves refined Suzhou classics, especially lake fish from nearby Taihu and meticulous ancient recipes. First-timers should check out the eight signature dishes, including sautéed shredded fish, nesting intestines and Xichang wontons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=168%20Zhuangqiao%20Road%2C%20Wujiang%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Lao Zhen Yuan (Zhuangqiao Road)"
  />
);

export default LaoZhenYuanZhuangqiaoRoad;
