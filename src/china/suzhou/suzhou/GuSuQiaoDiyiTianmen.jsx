...
const GuSuQiaoDiyiTianmen = () => (
  <RestaurantPage
    restaurantName="Gu Su Qiao (Diyi Tianmen)"
    address="12 Diyi Tianmen, Guanqian Street, Gusu, Suzhou, China Mainland"
    cuisine="Noodles"
    priceRange="¥"
    phoneNumber="+8651266016667"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/gu-su-qiao-diyi-tianmen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional Jiangnan motifs are updated and juxtaposed with modern calligraphy in this simple, elegant restaurant in the old town. The menu showcases Suzhou noodles, with almost 50 different toppings to choose from – try the crab roe noodles in autumn and winter. Those struggling to make up their mind can order one of the popular combos. The four-appetiser platter and dim sum such as xiao long bao and pan-fried pork buns are also well made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Diyi%20Tianmen%2C%20Guanqian%20Street%2C%20Gusu%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Gu Su Qiao (Diyi Tianmen)"
  />
);

export default GuSuQiaoDiyiTianmen;
