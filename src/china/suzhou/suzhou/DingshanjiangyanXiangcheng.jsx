...
const DingshanjiangyanXiangcheng = () => (
  <RestaurantPage
    restaurantName="Dingshan·Jiangyan (Xiangcheng)"
    address="33F, East Hall, Tiancheng Times, 58 Qinglonggang Road, Xiangcheng, Suzhou, China Mainland"
    cuisine="Jiangsu Cuisine"
    priceRange="¥¥¥"
    phoneNumber="+8651265630333"
    website="https://guide.michelin.com/en/jiang-su/suzhou_1031079/restaurant/dingshan-jiangyan-xiangcheng"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The panoramic lake views from this light-filled space atop an office tower are lovely to behold. But they don't outshine the refined Suzhou cooking that showcases the best local produce in season. The signature Suzhou claypot rice with braised pork and green garlic features young bamboo shoots in spring and chestnuts in autumn. House-made chilli sauce with beef and dried fish adds a kick; the scorched rice at the bottom imparts smoky crispness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33F%2C%20East%20Hall%2C%20Tiancheng%20Times%2C%2058%20Qinglonggang%20Road%2C%20Xiangcheng%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Dingshan·Jiangyan (Xiangcheng)"
  />
);

export default DingshanjiangyanXiangcheng;
