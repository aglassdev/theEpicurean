...
const Xiu = () => (
  <RestaurantPage
    restaurantName="Xiu"
    address="1F, InterContinental, 288 Wangdun Road, Suzhou Industrial Park, Suzhou, China Mainland"
    cuisine="Jiangzhe"
    priceRange="¥¥¥"
    phoneNumber="+8651262858888"
    website="https://www.ihg.com/intercontinental/hotels/gb/en/suzhou/suzha/hoteldetail?msockid=0df796b1a8916e441d6083b2a9516ff3"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Xiu is the Chinese word for embroidery, an art form for which Suzhou is famous. It makes sense that silk upholstery adorns the room, a feature that exudes elegance. The menu is made up of Jiangzhe dishes and a few Sichuan and Cantonese choices. Seasonal ingredients are shipped from all over the country, astutely prepared and perfectly seasoned. The deep-fried squirrel mandarin fish in sweet and sour sauce looks as good as it tastes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20InterContinental%2C%20288%20Wangdun%20Road%2C%20Suzhou%20Industrial%20Park%2C%20Suzhou%2C%20China%20Mainland"
    pageTitle="Xiu"
  />
);
