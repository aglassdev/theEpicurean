...
const TheBucksHead = () => (
  <RestaurantPage
    restaurantName="The Bucks Head"
    address="77-79 Main Street, Dundrum, BT33 0LU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+442843751868"
    website="https://thebucksheaddundrum.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Alex Greene’s first job was at this historic pub and now he has returned to his hometown to run the lovely village inn with his partner Bronagh McCormick. He arrives back in Dundrum with plenty of experience, borne out in pared-back, accessible and hugely enjoyable dishes based on a bounty of Northern Irish produce, from Kilkeel crab to Mourne Spring lamb – the seafood chowder is a particular highlight. The pub itself is charming, as is the service led by Bronagh...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77-79%20Main%20Street%2C%20Dundrum%2C%20BT33%200LU%2C%20United%20Kingdom"
    pageTitle="The Bucks Head"
  />
);

export default TheBucksHead;
