...
const Noble = () => (
  <RestaurantPage
    restaurantName="Noble"
    address="27a Church Road, Holywood, BT18 9BU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+442890425655"
    website="https://nobleholywood.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden away in the centre of town is this compact little restaurant where the service is warm and genuine, and a happy buzz fills the air. Snacks are served in the bar downstairs, while the upstairs is home to the full à la carte of excellent value dishes. Boldly flavoured elements like confit garlic pepperonata enliven the unfussy cooking, whose visual simplicity belies its delicious intensity. Be sure to check out the daily specials on the blackboard and, for dessert, don’t miss the chocolate délice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27a%20Church%20Road%2C%20Holywood%2C%20BT18%209BU%2C%20United%20Kingdom"
    pageTitle="Noble"
  />
);
