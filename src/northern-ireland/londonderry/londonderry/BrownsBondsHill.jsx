...
const BrownsBondsHill = () => (
  <RestaurantPage
    restaurantName="Browns Bonds Hill"
    address="1 Bonds Hill, Waterside, Londonderry, BT47 6DW, United Kingdom"
    cuisine="Modern British"
    priceRange="£"
    phoneNumber="+442871345180"
    website="https://www.brownsbondshill.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flagship of the Browns group sits on the east bank of the River Foyle and comes with a plush lounge and an intimate, art deco style dining room. The artful modern cooking is elaborate in its techniques and combinations and represents good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Bonds%20Hill%2C%20Waterside%2C%20Londonderry%2C%20BT47%206DW%2C%20United%20Kingdom"
    pageTitle="Browns Bonds Hill"
  />
);

export default BrownsBondsHill;
