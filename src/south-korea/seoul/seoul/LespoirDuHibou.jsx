...
const LespoirDuHibou = () => (
  <RestaurantPage
    restaurantName="L'Espoir du Hibou"
    address="16 Dosan-daero 59-gil, Gangnam-gu, Seoul, 06016, South Korea"
    cuisine="French"
    priceRange="₩₩₩"
    phoneNumber="+8225176034"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/l-espoir-du-hibou"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="All of the elements at this bistro — from the food to the décor to the outdoor patio — fall into place to create an ambience that is immediately charming and oh so French! Consistency has been key to L’Espoir du Hibou’s longevity, not least when it comes to food. Chef Lim Ki-hak makes traditional French charcuterie like terrines and pâtés from scratch. The onion soup is outstanding, as is the classic duck confit. Terrace dining is a must during the warmer months...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Dosan-daero%2059-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006016%2C%20South%20Korea"
    pageTitle="L'Espoir du Hibou"
  />
);

export default LespoirDuHibou;
