...
const Seoryung = () => (
  <RestaurantPage
    restaurantName="Seoryung"
    address="10 Sowol-ro, Jung-gu, Seoul, 04527, South Korea"
    cuisine="Memil-guksu"
    priceRange="₩"
    phoneNumber="+8223188766"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/seoryung"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The couple, Lee Gyeong-hee and Jeong Jong-mun’s Seoryung, began its journey in Hongcheon, moved via Ganghwa, and finally settled in Namdaemun, Seoul. The restaurant has drawn foodies, especially those who appreciate noodle dishes, wherever it relocated. After putting down roots in Seoul, they secured more tables, created a comfortable dining space, and expanded their connection with customers by preparing noodles and broths with dedication and authenticity. All of their noodles are made purely from buckwheat which is lovingly sourced and prepared by noodle master chef Jeong. This is the secret to the fragrant buckwheat flavor that shines through in all their variations of noodle dishes, like the Seoryung noodles, bibim noodles, and perilla oil noodles. The mandu and jeyuk, made from the mo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Sowol-ro%2C%20Jung-gu%2C%20Seoul%2C%2004527%2C%20South%20Korea"
    pageTitle="Seoryung"
  />
);

export default Seoryung;
