...
const GomtangLab = () => (
  <RestaurantPage
    restaurantName="Gomtang Lab"
    address="153 Dosan-daero, Gangnam-gu, Seoul, 06037, South Korea"
    cuisine="Gomtang"
    priceRange="₩"
    phoneNumber="+8225174656"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/gomtang-lab"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=153%20Dosan-daero%2C%20Gangnam-gu%2C%20Seoul%2C%2006037%2C%20South%20Korea"
    pageTitle="Gomtang Lab"
  />
);

export default GomtangLab;
