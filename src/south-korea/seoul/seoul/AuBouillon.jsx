...
const AuBouillon = () => (
  <RestaurantPage
    restaurantName="Au Bouillon"
    address="29-1 Dokseodang-ro 51-gil, Seongdong-gu, Seoul, 04718, South Korea"
    cuisine="French"
    priceRange="₩₩"
    phoneNumber="+82264011048"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/au-bouillon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden in a quaint, tiny alley that's surrounded by apartment complexes in Geumho-dong, this French restaurant greets patrons with classic objets d'art and other fixings. However, the vibe here is different from the surrounding neighborhood, and thanks to an equally striking carte of familiar French fare, diners can expect nothing less than exceptional culinary enjoyment. The menu closely reflects the chef’s desire to offer well-crafted French cuisine at reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29-1%20Dokseodang-ro%2051-gil%2C%20Seongdong-gu%2C%20Seoul%2C%2004718%2C%20South%20Korea"
    pageTitle="Au Bouillon"
  />
);

export default AuBouillon;
