...
const Vinho = () => (
  <RestaurantPage
    restaurantName="VINHO"
    address="#162 Wellstone Bldg, 38 Hakdong-ro 43-gil, Gangnam-gu, Seoul, 06059, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩₩"
    phoneNumber="+821096772302"
    website="https://www.restaurantvinho.kr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Co-helmed by Chef Jeon Seong-bin and Sommelier Kim Jin-ho, Vinho features expansive window walls and an open kitchen fronted by an elongated counter. This spatial harmony creates a lively communal wine-and-dine ambiance. The vast wine list, coupled with careful service and food pairing, as well as deep-flavored sauces that exquisitely complement seasonal ingredients, makes the eatery a perfect venue to savor the pinnacle of contemporary cuisine. Its yellowtail tartare, which features dices of yellowtail mixed with sourdough crumbs and poached eggs and then wrapped with slightly grilled romaine, is served with a sauce featuring katsuobushi cream, parsley oil and lemon juice. The sweet and nutty flavor of the sauce provides the ideal accompaniment to the yellowtail’s fresh flavors. Vinho del..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%23162%20Wellstone%20Bldg%2C%2038%20Hakdong-ro%2043-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006059%2C%20South%20Korea"
    pageTitle="VINHO"
  />
);
