...
const 3rdSamgyetang = () => (
  <RestaurantPage
    restaurantName="3rd Samgyetang"
    address="56-3 Banpo-daero 28-gil, Seocho-gu, Seoul, 06646, South Korea"
    cuisine="Samgyetang"
    priceRange="₩"
    phoneNumber="+8250714652294"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/3rd-samgyetang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now in its third generation after opening in 1973, 3rd Samgyetang is well-regarded among Seocho locals for its restorative soup. The signature samgyetang features a rich broth of over 40 ingredients, topped with mung bean and pine nut purées, and mugwort paste. The grains give the broth a satisfying body, and the meat from young chickens falls effortlessly off the bone. Spoon some glutinous rice into the broth, add a pinch of glasswort salt, and enjoy the bowl of cosy porridge. Arrive early to avoid long lines during peak hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56-3%20Banpo-daero%2028-gil%2C%20Seocho-gu%2C%20Seoul%2C%2006646%2C%20South%20Korea"
    pageTitle="3rd Samgyetang"
  />
);

export default 3rdSamgyetang;
