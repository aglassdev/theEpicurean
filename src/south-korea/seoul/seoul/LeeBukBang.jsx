...
const LeeBukBang = () => (
  <RestaurantPage
    restaurantName="Lee Buk Bang"
    address="2F, 16 Mapo-daero 1-gil, Mapo-gu, Seoul, 04165, South Korea"
    cuisine="Korean"
    priceRange="₩₩"
    phoneNumber="+8227202345"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/lee-buk-bang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, Lee Buk Bang is where one can enjoy meals from the leebuk, or North Korean, region. In this setting, blood sausage and other diverse North Korean dishes with a modern flair offer a valuable dining experience to patrons. However, this spot's signature is blood sausage dishes made from the chef’s family recipes. His creativity shines in an array of dishes, from traditional to those featuring ingenious new ingredients. Also noteworthy is his effort to create familiar yet refined cuisine that combines family culinary traditions with his culinary experience. The countertops, made from old crossbeams and doors once used in century-old traditional Korean houses, add to the venue’s traditional vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2016%20Mapo-daero%201-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004165%2C%20South%20Korea"
    pageTitle="Lee Buk Bang"
  />
);

export default LeeBukBang;
