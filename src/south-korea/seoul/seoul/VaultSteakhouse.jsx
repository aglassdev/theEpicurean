...
const VaultSteakhouse = () => (
  <RestaurantPage
    restaurantName="Vault Steakhouse"
    address="2F, 22 Apgujeong-ro 72-gil, Gangnam-gu, Seoul, 06015, South Korea"
    cuisine="Steakhouse"
    priceRange="₩₩₩₩"
    phoneNumber="+8225449235"
    website="https://www.vaultsteakhouse.co.kr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dimly lit masculine décor and a comprehensive whiskey collection with nearly 400 bottles to choose from make Vault+82 one of the most sought-after whiskey bars in Seoul. Right above it is the American-style Vault Steakhouse where premium USDA-approved American beef free of antibiotics and hormones is dry-aged for 14 and 28 days. Available cuts include T-bone, L-bone, bone-in ribeye, filet mignon, New York strip and boneless ribeye...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2022%20Apgujeong-ro%2072-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006015%2C%20South%20Korea"
    pageTitle="Vault Steakhouse"
  />
);

export default VaultSteakhouse;
