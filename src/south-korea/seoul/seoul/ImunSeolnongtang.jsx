...
const ImunSeolnongtang = () => (
  <RestaurantPage
    restaurantName="Imun Seolnongtang"
    address="38-13 Ujeongguk-ro, Jongno-gu, Seoul, 03149, South Korea"
    cuisine="Seolleongtang"
    priceRange="₩"
    phoneNumber="+8227336526"
    website="https://imun.modoo.at/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Still going strong after more than 100 years of being in business, Imun Seolnongtang was the first eatery in Korea to officially register for a restaurant license when it opened in 1904. To this day, it honors the tradition of boiling ox bones for 17 hours until the broth turns rich and opaque. Other cuts of beef are later added to the intensely flavorful broth, served with a generous portion of sliced beef and soft wheat noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38-13%20Ujeongguk-ro%2C%20Jongno-gu%2C%20Seoul%2C%2003149%2C%20South%20Korea"
    pageTitle="Imun Seolnongtang"
  />
);

export default ImunSeolnongtang;
