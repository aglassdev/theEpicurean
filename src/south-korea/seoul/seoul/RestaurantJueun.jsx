...
const RestaurantJueun = () => (
  <RestaurantPage
    restaurantName="Restaurant Jueun"
    ...
    pageTitle="Restaurant Jueun"
  />
);

export default RestaurantJueun;
