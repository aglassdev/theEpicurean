...
const TohLim = () => (
  <RestaurantPage
    restaurantName="Toh Lim"
    address="37F Lotte Hotel, 30 Eulji-ro, Jung-gu, Seoul, 04533, South Korea"
    cuisine="Chinese"
    priceRange="₩₩₩₩"
    phoneNumber="+8223177101"
    website="https://www.lottehotel.com/seoul-hotel/ko/dining/restaurant-toh-lim.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on the 37th floor of the Lotte Hotel, Toh Lim offers a state-of-the-art Chinese fine dining experience. The restaurant is acclaimed for its expert handling of ingredients, whose natural flavors shine through in the individual dishes.  Led by a highly respected veteran of Korea’s culinary industry, the team serves up a wide array of Chinese, with a special focus on Cantonese-style cuisine. Private rooms are available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37F%20Lotte%20Hotel%2C%2030%20Eulji-ro%2C%20Jung-gu%2C%20Seoul%2C%2004533%2C%20South%20Korea"
    pageTitle="Toh Lim"
  />
);

export default TohLim;
