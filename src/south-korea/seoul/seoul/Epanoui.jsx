...
const Epanoui = () => (
  <RestaurantPage
    restaurantName="Epanoui"
    address="3F, 33 Seolleung-ro 146-gil, Gangnam-gu, Seoul, 06064, South Korea"
    cuisine="French"
    priceRange="₩₩₩"
    phoneNumber="+8225482020"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/epanoui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As if to prove its etymological origin, Épanoui (which means “Flourished“ in French) adorns its walls with novel artists’ paintings every three months, thereby imbuing this nice little back alley establishment in Cheongdam-dong with a gallery-like ambience befitting its sensitive, beautifully crafted French cuisine. The kitchen team's signature dishes include lobster ravioli in a mellow champagne-vanilla sauce; and foie gras marbré surrounded by crunchy bread crumbs. Perhaps as a nod to the restaurant’s artwork, the presentations are also delicate and vibrant. Chef Kwon Ji-hun’s pursuit of balanced flavors and elevated plating will delight your eyes and your palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2033%20Seolleung-ro%20146-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006064%2C%20South%20Korea"
    pageTitle="Epanoui"
  />
);

export default Epanoui;
