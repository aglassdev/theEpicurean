...
const HyunUdon = () => (
  <RestaurantPage
    restaurantName="Hyun Udon"
    address="53 Nonhyeon-ro 149-gil, Gangnam-gu, Seoul, 06039, South Korea"
    cuisine="Udon"
    priceRange="₩"
    phoneNumber="+8225153622"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/hyun-udon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Park Sang-hyeon is a well-respected master of the udon craft. At his Nonhyeon-dong location, Park continues to serve up bowls of thick, silky-smooth, home-made udon noodles with their characteristic firmness and elasticity. If you're unsure of what to order, go for his signature tempura bukkake udon. The plump bouncy noodles and the freshly fried light crispy tempura make for a delicious mouthful when dipped in the umami-rich tsuyu sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Nonhyeon-ro%20149-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006039%2C%20South%20Korea"
    pageTitle="Hyun Udon"
  />
);

export default HyunUdon;
