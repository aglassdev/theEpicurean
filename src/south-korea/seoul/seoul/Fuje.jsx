...
const Fuje = () => (
  <RestaurantPage
    restaurantName="Fuje"
    address="2F, 21 Nonhyeon-ro 24-gil, Gangnam-gu, Seoul, 06302, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+827048374997"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/fuje"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fuje presents contemporary cuisine rooted in French cookery, crafted with seasonal ingredients and homegrown vegetables and herbs. The menu reflects the chef’s desire to create trustworthy dishes. One standout dish features lightly blanched geoduck served with rice cooked in a clam broth; the flavour of the broth perfectly accompanies the sweet aroma and the great texture of the geoduck. The subtle oak aroma from the grill further enhances the dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2021%20Nonhyeon-ro%2024-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006302%2C%20South%20Korea"
    pageTitle="Fuje"
  />
);
