...
const OneDegreeNorth = () => (
  <RestaurantPage
    restaurantName="One Degree North"
    address="8 Hakdong-ro 43-gil, Gangnam-gu, Seoul, 06061, South Korea"
    cuisine="Asian, Singaporean"
    priceRange="₩"
    phoneNumber="+827043338884"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/one-degree-north"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="'One Degree North refers to the latitude of Singapore. And true to its name, it serves popular Singaporean dishes and Asian style barbecue. The chef even imported the Apollo oven straight from Singapore to recreate the local flavors. The signature Cantonese style crispy roast pork, which strikes a perfect balance between the light and crispy skin and moist meat underneath, tastes authentically Singaporean. Another highlight is the incredibly popular and iconic Singaporean chicken rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8%20Hakdong-ro%2043-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006061%2C%20South%20Korea"
    pageTitle="One Degree North"
  />
);

export default OneDegreeNorth;
