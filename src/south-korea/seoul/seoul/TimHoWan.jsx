...
const TimHoWan = () => (
  <RestaurantPage
    ...
    address="30 Bongeunsa-ro 86-gil, Gangnam-gu, Seoul, 06165, South Korea"
    cuisine="Dim Sum"
    priceRange="₩"
    phoneNumber="+82262073082"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/tim-ho-wan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tim Ho Wan has played a major role in making Hong Kong-style dim sum popular in many countries worldwide. The main force behind such growing popularity has been its policy of maintaining the traditional form of Hong Kong dim sum dishes and making them available at affordable prices. This management philosophy has been upheld in its branches in Seoul, making them as authentic as the original. The franchise’s capacious Samseong outpost, which is also the main location in Seoul, can serve up to 110 customers at one time and offers ample parking spaces. It is the perfect place to indulge in a wide variety of traditional dim sum...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30%20Bongeunsa-ro%2086-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006165%2C%20South%20Korea"
    pageTitle="Tim Ho Wan"
  />
);

export default TimHoWan;
