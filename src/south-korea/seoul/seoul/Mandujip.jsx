...
const Mandujip = () => (
  <RestaurantPage
    restaurantName="Mandujip"
    address="338 Apgujeong-ro, Gangnam-gu, Seoul, 06018, South Korea"
    cuisine="Mandu"
    priceRange="₩"
    phoneNumber="+8225443710"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/mandujip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a trendsetting part of the city dominated by state-of-the-art fashion, this restaurant has stood its ground for 30 years with a humble dish that has wooed the palates of countless people — dumpling soup. Mandujip specializes in Pyeongando-style dumplings, filled with minced beef, bean curd, mung bean sprouts, green onions and sesame oil. Each order comes with six large dumplings in a clear, flavorful beef broth made with chunks of brisket...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=338%20Apgujeong-ro%2C%20Gangnam-gu%2C%20Seoul%2C%2006018%2C%20South%20Korea"
    pageTitle="Mandujip"
  />
);

export default Mandujip;
