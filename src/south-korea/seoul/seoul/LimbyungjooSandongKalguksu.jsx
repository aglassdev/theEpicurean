...
const LimbyungjooSandongKalguksu = () => (
  <RestaurantPage
    restaurantName="Limbyungjoo Sandong Kalguksu"
    address="65 Gangnam-daero 37-gil, Seocho-gu, Seoul, 06734, South Korea"
    cuisine="Kalguksu"
    priceRange="₩"
    phoneNumber="+82234737972"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/limbyungjoo-sandong-kalguksu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1988, this restaurant has been proving that a humble bowl of noodle soup can be truly memorable when done right. The pleasant texture of their hand-cut noodles, prepared daily from scratch, and immensely comforting broth, served piping hot and packed with flavor from the clams in all their naturally sweet glory, are stellar. Other favorites include Pyeongyang jumbo sized dumplings and noodles in cold soybean soup. Simple but warm service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=65%20Gangnam-daero%2037-gil%2C%20Seocho-gu%2C%20Seoul%2C%2006734%2C%20South%20Korea"
    pageTitle="Limbyungjoo Sandong Kalguksu"
  />
);

export default LimbyungjooSandongKalguksu;
