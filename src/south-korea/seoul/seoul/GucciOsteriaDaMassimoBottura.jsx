...
const GucciOsteriaDaMassimoBottura = () => (
  <RestaurantPage
    restaurantName="Gucci Osteria da Massimo Bottura"
    address="6F, 223 Itaewon-ro, Yongsan-gu, Seoul, 04349, South Korea"
    cuisine="Italian Contemporary"
    priceRange="₩₩₩"
    phoneNumber="+8227951119"
    website="https://www.gucciosteria.com/ko/seoul"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="[Temporarily closed]Gucci Osteria was launched in Florence, Italy through a partnership between the chef Massimo Bottura and Gucci. The establishment’s third global branch after ones in Los Angeles and Tokyo has opened in Seoul. Its signature dishes include Seoul Garden Salad, inspired by Korea’s four distinct seasons; tortellini with rich-flavored, 24-month-aged Parmigiano Reggiano cream; and an Emilia Burger served in a petite pink box. The interior spaces colored in Gucci's signature green evoke a splendid verdant garden. Coupled with an assortment of cutlery and furniture that is both unique and classy, this fine diner’s authentic vibes bring out the indelible tastes of its cuisine to the fullest. A visit to the terrace is highly recommended as it offers a gorgeous view of Seoul’s city..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%20223%20Itaewon-ro%2C%20Yongsan-gu%2C%20Seoul%2C%2004349%2C%20South%20Korea"
    pageTitle="Gucci Osteria da Massimo Bottura"
  />
);

export default GucciOsteriaDaMassimoBottura;
