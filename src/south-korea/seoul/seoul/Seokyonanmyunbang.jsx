...
const Seokyonanmyunbang = () => (
  <RestaurantPage
    restaurantName="Seokyonanmyunbang"
    address="16 Donggyo-ro 12-gil, Mapo-gu, Seoul, 04029, South Korea"
    cuisine="Noodles"
    priceRange="₩"
    phoneNumber="+821095160934"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/seokyonanmyunbang"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Donggyo-ro%2012-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004029%2C%20South%20Korea"
    pageTitle="Seokyonanmyunbang"
  />
);

export default Seokyonanmyunbang;
