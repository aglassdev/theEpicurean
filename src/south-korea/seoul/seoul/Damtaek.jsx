...
const Damtaek = () => (
  <RestaurantPage
    restaurantName="Damtaek"
    address="34 World Cup-ro 8-gil, Mapo-gu, Seoul, 04035, South Korea"
    cuisine="Ramen"
    priceRange="₩"
    phoneNumber="+8223360974"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/damtaek"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20World%20Cup-ro%208-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004035%2C%20South%20Korea"
    pageTitle="Damtaek"
  />
);

export default Damtaek;
