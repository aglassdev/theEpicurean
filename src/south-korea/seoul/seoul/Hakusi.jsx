...
const Hakusi = () => (
  <RestaurantPage
    restaurantName="Hakusi"
    address="2F, 8-4 Eonju-ro 157-gil, Gangnam-gu, Seoul, South Korea"
    cuisine="Japanese"
    priceRange="₩₩₩₩"
    phoneNumber="+821073166212"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/hakusi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Charcoal, fire and paper – these are the three themes Chef Choi Seong-hun seeks to convey in Hakusi’s captivating culinary narrative. The triumphant result is a testament to his masterful storytelling. Beginning at the entrance and extending all the way to the dining area, an arresting visual tableau of black and red imbues the space with personality, punctuated by white elements that exude a sense of harmony and stability. This vivid vitality is also manifest in the establishment’s distinctive cuisine that reflects the chef’s vast culinary experience. In every dish, the allure of seasonal ingredients is brought to life in vivid detail, with distinct flavors and aromas, which transcend the boundaries between modern and classic cuisine, figuring prominently...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%208-4%20Eonju-ro%20157-gil%2C%20Gangnam-gu%2C%20Seoul%2C%20South%20Korea"
    pageTitle="Hakusi"
  />
);

export default Hakusi;
