...
const SeoulDining = () => (
  <RestaurantPage
    restaurantName="Seoul Dining"
    address="2F Designhouse, 272 Dongho-ro, Jung-gu, Seoul, 04617, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+82263256321"
    website="https://www.seoul-dining.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A culinary journey that captures the essence of Seoul? The fare at this destination sprang from the chef’s own question of 'Is there a way to bring the unique gastronomic experience that Seoul embodies to restaurant patrons? Based on this philosophy, the establishment combines seasonal ingredients with a great deal of creativity to bring brilliant, one-of-a-kind dishes to the table. Adding to its appeal is the use of ingredients and sauces that deliver a wide variety of flavors, a gesture that reflects the co-existence of diverse food cultures in Seoul. The contemporary and vibrant dining space also creates a sense of harmony worthy of its buoyant dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%20Designhouse%2C%20272%20Dongho-ro%2C%20Jung-gu%2C%20Seoul%2C%2004617%2C%20South%20Korea"
    pageTitle="Seoul Dining"
  />
);

export default SeoulDining;
