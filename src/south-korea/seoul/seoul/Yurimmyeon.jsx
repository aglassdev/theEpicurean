...
const Yurimmyeon = () => (
  <RestaurantPage
    restaurantName="Yurimmyeon"
    address="139-1 Seosomun-ro, Jung-gu, Seoul, 04515, South Korea"
    cuisine="Memil-guksu"
    priceRange="₩"
    phoneNumber="+8227550659"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/yurimmyeon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 50 years, this family-run eatery has been serving bowls of noodles to those seeking comforting nourishment. The fresh buckwheat noodles, one of its bestsellers, are made from scratch, daily, using premium salt from Bigeumdo Island in Sinan County, and buckwheat flour from Bongpyeong. Topped with seasoned vegetables, thin strips of egg garnish, and a dollop of sweet and spicy sauce, a bowl of these noodles makes for a satisfying meal. Garak-guksu, wheat noodles in piping hot broth, comes with a generous serving of fishcake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139-1%20Seosomun-ro%2C%20Jung-gu%2C%20Seoul%2C%2004515%2C%20South%20Korea"
    pageTitle="Yurimmyeon"
  />
);

export default Yurimmyeon;
