...
const Subaru = () => (
  <RestaurantPage
    restaurantName="Subaru"
    address="7 Bangbae-jungangno 21-gil, Seocho-gu, Seoul, 06560, South Korea"
    cuisine="Soba"
    priceRange="₩"
    phoneNumber="+8225964882"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/subaru"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kang Yeong-cheol has for long studied and developed the soba-making craft, with the sole aspiration to serve the same outstanding soba as can be tasted in the birthplace of the dish, The chef spent many years in Japan, where he became enamored with the pure taste of soba; and it is this love that propelled him on his culinary journey. In Subaru, soba for the day’s meals are freshly made in the traditional Edo-period way. He sticks to the classic ni-hachi-style version, which consists of two parts wheat and eight parts buckwheat. The signature dishes include zaru soba, which boasts a clean and pure taste; soba with umami-rich duck meat and green onion; as well as soba with perilla oil. Additionally, diners can enjoy foot-kneaded udon noodles, crafted in-house for a satisfyingly chewy t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Bangbae-jungangno%2021-gil%2C%20Seocho-gu%2C%20Seoul%2C%2006560%2C%20South%20Korea"
    pageTitle="Subaru"
  />
);
