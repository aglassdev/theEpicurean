...
const Kyodaiya = () => (
  <RestaurantPage
    restaurantName="Kyodaiya"
    address="39 Seongji-gil, Mapo-gu, Seoul, 04083, South Korea"
    cuisine="Udon"
    priceRange="₩"
    phoneNumber="+82226542645"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/kyodaiya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When one can hear the dull tap of a blade against a wooden board every time a customer places an order, it’s a telltale sign that the chefs are serious about their craft. At Kyodaiya, that craft is Sanuki udon. The thick noodles are always cut to order to preserve their characteristic elasticity and smoothness until the very last minute. In addition to the classic kake udon, flavored with dried and smoked sardines and seasoned with light soy sauce, the chef brothers also offer classics like tempura udon and chilled bukkake udon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Seongji-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004083%2C%20South%20Korea"
    pageTitle="Kyodaiya"
  />
);

export default Kyodaiya;
