...
const Mugunghwa = () => (
  <RestaurantPage
    restaurantName="Mugunghwa"
    address="38F Lotte Hotel, 30 Eulji-ro, Jung-gu, Seoul, 04533, South Korea"
    cuisine="Korean"
    priceRange="₩₩₩₩"
    phoneNumber="+8223177061"
    website="https://www.lottehotel.com/seoul-hotel/ko/dining/restaurant-mugunghwa.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mugunghwa at Lotte Hotel offers a refined take on classic Korean cuisine, paired with sweeping city views from its top-floor location. Embracing the philosophy that “food is medicine,” the restaurant crafts dishes using seasonal ingredients to deliver flavors that are both comforting and complex. Highlights include burdock gangjeong with coastal hog fennel sauce, imjasutang in an autumn olive and sesame broth, and haesamjeung with sea cucumber and black garlic sauce. With a focus on traditional ingredients, natural seasonings, and fermented elements, Mugunghwa presents a distinctly Korean, health-conscious dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38F%20Lotte%20Hotel%2C%2030%20Eulji-ro%2C%20Jung-gu%2C%20Seoul%2C%2004533%2C%20South%20Korea"
    pageTitle="Mugunghwa"
  />
);

export default Mugunghwa;
