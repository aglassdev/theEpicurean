...
const Tutoiement = () => (
  <RestaurantPage
    restaurantName="Tutoiement"
    address="20 Gwangnaru-ro 11-gil, Seongdong-gu, Seoul, 04801, South Korea"
    cuisine="French"
    priceRange="₩₩₩₩"
    phoneNumber="+8224999056"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/tutoiement"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name Tutoiement means to speak in a friendly, informal way, reflecting Chef Kim Do-hyeon's desire to connect casually with his diners through food. Diners can enjoy their meal in a calm, welcoming setting with attentive, friendly service. Interestingly, contrary to the chef's preference for a casual dining experience, the precisely cooked, sophisticated French cuisine stimulates the olfactory and gustatory senses, drawing focus to the food. The chef skillfully expresses the subtle flavors, textures, and nuances of each ingredient, and plates the food in ways that best showcases the harmony between the food and accompanying sauces. At Tutoiement, Chef Kim shows his diners that his culinary journey is not about paying homage to or imitating others but instead about creating a memorable d..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Gwangnaru-ro%2011-gil%2C%20Seongdong-gu%2C%20Seoul%2C%2004801%2C%20South%20Korea"
    pageTitle="Tutoiement"
  />
);

export default Tutoiement;
