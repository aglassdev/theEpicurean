...
const Mukjung = () => (
  <RestaurantPage
    restaurantName="Mukjung"
    address="17 Teogye-ro 48-gil, Jung-gu, Seoul, 04619, South Korea"
    cuisine="Korean"
    priceRange="₩₩"
    phoneNumber="+821083506743"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/mukjung"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Korean-American chef Austin Kang prepares his own fermented foods and jang in-house, guided by the Korean belief that food is medicine. Traditional Korean dishes are presented with contemporary flair, including a flourless pyogo mushroom and shrimp jeon with myeolchi-jeot aioli. The meltingly tender slow-cooked chicken is served with citrus- and herb-scented rice, pairing well with the banchan. Be sure to order the main dish a day in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Teogye-ro%2048-gil%2C%20Jung-gu%2C%20Seoul%2C%2004619%2C%20South%20Korea"
    pageTitle="Mukjung"
  />
);

export default Mukjung;
