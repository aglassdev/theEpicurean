...
const KushiKawa = () => (
  <RestaurantPage
    restaurantName="Kushi Kawa"
    address="37 Nonhyeon-ro 24-gil, Gangnam-gu, Seoul, 06300, South Korea"
    cuisine="Kushiage"
    priceRange="₩₩"
    phoneNumber="+8225790538"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/kushi-kawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner Yoon Seok-hyeon's inspiration to open Kushikawa stems from his sojourn in Japan where he became a connoisseur of popular Japanese dishes including kushikatsu (deep-fried skewered meat and vegetables). The omakase course at Kushikawa consists of 12 to 14 different types of deep-fried skewers prepared with seafood, meat and vegetables. Running a restaurant on his home turf where he grew up, Yoon tries to appeal to the local palate, and nothing brings him greater joy than the joyful expressions on his customers' beaming faces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37%20Nonhyeon-ro%2024-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006300%2C%20South%20Korea"
    pageTitle="Kushi Kawa"
  />
);

export default KushiKawa;
