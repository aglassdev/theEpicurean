...
const Bongsanok = () => (
  <RestaurantPage
    restaurantName="Bongsanok"
    address="5-6 Banpo-daero 8-gil, Seocho-gu, Seoul, 06716, South Korea"
    cuisine="Mandu"
    priceRange="₩"
    phoneNumber="+8225252282"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/bongsanok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mandutguk, or Korean dumpling soup, is a dish that is deeply rooted in the day-to-day lives of Koreans. Owner Yoon Young-sook became acquainted with Hwanghaedo-style dumpling soup through her mother-in-law, a native of Sariwon, which is north of the border. To emulate the pure taste of the original dumpling filling, Yoon says she follows her recipe to the tee and feels very proud when she hears customers say her dumplings remind them of their own grandmother's...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-6%20Banpo-daero%208-gil%2C%20Seocho-gu%2C%20Seoul%2C%2006716%2C%20South%20Korea"
    pageTitle="Bongsanok"
  />
);

export default Bongsanok;
