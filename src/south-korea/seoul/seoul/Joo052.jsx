...
const Joo052 = () => (
  <RestaurantPage
    restaurantName="Joo052"
    address="26 Gosanja-ro 14-gil, Seongdong-gu, Seoul, 04750, South Korea"
    cuisine="Korean"
    priceRange="₩₩"
    phoneNumber="+82222810343"
    website="https://joo052.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Joo052 is a portmanteau of “Joo” (alcohol) and “052,” the area code of the region the chefs live in. It’s a Korean gastropub brimming with culinary ideas as playful as the restaurant’s name. Employing diverse fermented pastes and fermentation techniques, the basis of most Korean cuisine, the chef duo offers unique dishes that are household names yet prepared with exceptional care and attention to detail to draw out unforgettable flavors. On top of this, the varied menu selections tend to go well together, making it easy to enjoy multiple items at once. These allures make Joo052 a perfect place to experience the exquisite harmony between Korean food and Korean alcohol...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Gosanja-ro%2014-gil%2C%20Seongdong-gu%2C%20Seoul%2C%2004750%2C%20South%20Korea"
    pageTitle="Joo052"
  />
);

export default Joo052;
