...
const SamcheongdongSujebi = () => (
  <RestaurantPage
    restaurantName="Samcheongdong Sujebi"
    address="101-1 Samcheong-ro, Jongno-gu, Seoul, 03049, South Korea"
    cuisine="Sujebi"
    priceRange="₩"
    phoneNumber="+8227352965"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/samcheongdong-sujebi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This local haunt has been an integral part of Samcheong-dong’s history since 1982. The signature dish here is sujebi — rustic hand-pulled dough soup served in a savory anchovy broth. The restaurant is also known for its potato pancakes, made with grated potatoes that are pan-fried until crispy on the outside and pleasantly chewy on the inside. Avoid the lunch rush if you don’t want to stand in line, but be warned — the restaurant is always busy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101-1%20Samcheong-ro%2C%20Jongno-gu%2C%20Seoul%2C%2003049%2C%20South%20Korea"
    pageTitle="Samcheongdong Sujebi"
  />
);

export default SamcheongdongSujebi;
