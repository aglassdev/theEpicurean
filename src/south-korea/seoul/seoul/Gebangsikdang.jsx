...
const Gebangsikdang = () => (
  <RestaurantPage
    restaurantName="Gebangsikdang"
    address="17 Seolleung-ro 131-gil, Gangnam-gu, Seoul, 06060, South Korea"
    cuisine="Gejang"
    priceRange="₩"
    phoneNumber="+821084791107"
    website="https://www.gebangsikdang.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Seolleung-ro%20131-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006060%2C%20South%20Korea"
    pageTitle="Gebangsikdang"
  />
);

export default Gebangsikdang;
