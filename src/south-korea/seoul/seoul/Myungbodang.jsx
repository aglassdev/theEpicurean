...
const Myungbodang = () => (
  <RestaurantPage
    restaurantName="Myungbodang"
    address="3F, 13-12 Seolleung-ro 158-gil, Gangnam-gu, Seoul, 06014, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩₩₩"
    phoneNumber="+8225115046"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/myungbodang"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Drawing from her experience at a top New York restaurant, Chef Hyeon-ju Lim develops a creative approach to Nu-American French cuisine. Known for her bold ingredient choices and keen sense of composition, Chef Lim delivers dishes that highlight the character of each element. The signature Truffle features a crisp shell filled with fermented mushroom and truffle cream—rich and refined. The meal concludes with a distinctive chocolate foam, offering a memorable finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2013-12%20Seolleung-ro%20158-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006014%2C%20South%20Korea"
    pageTitle="Myungbodang"
  />
);

export default Myungbodang;
