...
const SushiMatsumotoSEO = () => (
  <RestaurantPage
    restaurantName="Sushi Matsumoto"
    address="24 Dosan-daero 75-gil, Gangnam-gu, Seoul, 06015, South Korea"
    cuisine="Sushi"
    priceRange="₩₩₩₩"
    phoneNumber="+8225434334"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/sushi-matsumoto-1195338"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Matsumoto Mizuho is renowned for replicating authenticityin local settings. Rather than chasing after gastronomictrends, this sushiya strives to faithfully reproduce the authenticsushi of mainland Japan amidst the Korean milieu. Such effortsare unmistakable—from the composition and arrangement ofshari (rice) and neta (fish topping) to the knowledgeable serviceprovided. The impressive line of tsumami (appetizers) andthe progression of nigiri sushi —reflecting the natural cadenceof flavors — remain the main culinary appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Dosan-daero%2075-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006015%2C%20South%20Korea"
    pageTitle="Sushi Matsumoto"
  />
);

export default SushiMatsumotoSEO;
