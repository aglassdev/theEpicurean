...
const NampoMyeonok = () => (
  <RestaurantPage
    restaurantName="Nampo Myeonok"
    address="24 Eulji-ro 3-gil, Jung-gu, Seoul, 04522, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+8227773131"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/nampo-myeonok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a small alley among densely populated office buildings that sees a constant stream of foot traffic, the main building of this long-standing institution recently underwent a major facelift. A longtime favorite among patrons of all ages for its authentic Pyeongyang cold buckwheat noodles and beef hot pot, Nampo Myeonok continues to charm with its consistently good food and friendly service. Chair seating and floor seating are both available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Eulji-ro%203-gil%2C%20Jung-gu%2C%20Seoul%2C%2004522%2C%20South%20Korea"
    pageTitle="Nampo Myeonok"
  />
);

export default NampoMyeonok;
