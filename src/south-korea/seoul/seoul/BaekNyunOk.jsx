...
const BaekNyunOk = () => (
  <RestaurantPage
    restaurantName="Baek Nyun Ok"
    address="2407 Nambusunhwan-ro, Seocho-gu, Seoul, 06719, South Korea"
    cuisine="Dubu"
    priceRange="₩"
    phoneNumber="+8225232860"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/baecnyunok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located across the main road from Seoul Arts Center, Baek Nyun Ok has been attracting loyal patrons, including local performers and musicians in droves, since 1992. This humble institution specializes in fresh homemade bean curd, which is the central ingredient in a variety of dishes offered. These include plain soft bean curd and soft bean curd stew with nutty perilla seeds. The interior is simply decorated and offers both table and floor seating...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2407%20Nambusunhwan-ro%2C%20Seocho-gu%2C%20Seoul%2C%2006719%2C%20South%20Korea"
    pageTitle="Baek Nyun Ok"
  />
);

export default BaekNyunOk;
