...
const SamwonGarden = () => (
  <RestaurantPage
    ...
    address="835 Eonju-ro, Gangnam-gu, Seoul, 06023, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩"
    phoneNumber="+8225483030"
    website="https://www.samwongarden.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the cultural landscape of Korean barbeque, Samwon Garden has long enjoyed fame based on its intricate balance between comfort and haute cuisine. It is where diverse cuts of prime Korean beef meet the seasoned grilling skills of its staff, a synergy that creates a delightful and comfortable gastronomic experience. What’s more, a gorgeously landscaped outdoor garden, coupled with high ceilings and glass walls infused with the Korean aesthetics of empty space, adds a sense of openness to this gracious dining. Its various private dining rooms cater to a variety of communal dining needs. For several decades, Samwon Garden has transformed Korean barbeque culture while carrying on the country’s culinary tradition. Visit this culinary landmark and enjoy a meal loaded with great traditional flav..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=835%20Eonju-ro%2C%20Gangnam-gu%2C%20Seoul%2C%2006023%2C%20South%20Korea"
    pageTitle="Samwon Garden"
  />
);

export default SamwonGarden;
