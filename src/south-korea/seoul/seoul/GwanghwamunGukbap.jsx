...
const GwanghwamunGukbap = () => (
  <RestaurantPage
    restaurantName="Gwanghwamun Gukbap"
    address="53 Sejong-daero 21-gil, Jung-gu, Seoul, 04519, South Korea"
    cuisine="Dwaeji-gukbap"
    priceRange="₩"
    phoneNumber="+8227385688"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/gwanghwamun-gukbap"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gwanghwamun Gukbap, run by Chef Park Chan-il, offers a clean, mellow take on dwaeji gukbap using black pig pork. The mild broth, tender slices of pork, and a generous topping of chives create a well-balanced and aromatic bowl. Served with freshly cooked rice and crisp kkakdugi, it becomes a hearty, satisfying meal. A smaller portion is available for children, making it family-friendly. Located in a busy office district, expect long queues during weekday lunch hours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=53%20Sejong-daero%2021-gil%2C%20Jung-gu%2C%20Seoul%2C%2004519%2C%20South%20Korea"
    pageTitle="Gwanghwamun Gukbap"
  />
);

export default GwanghwamunGukbap;
