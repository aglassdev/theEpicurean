...
const Okdongsik = () => (
  <RestaurantPage
    ...
    address="44-10 Yanghwa-ro 7-gil, Mapo-gu, Seoul, 04035, South Korea"
    cuisine="Dwaeji-gukbap"
    priceRange="₩"
    phoneNumber="+821055719915"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/okdongsik"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Okdongsik has defined its own refined take on dwaeji gukbap, offering a light, clean broth reminiscent of gomtang. Made from the ham and foreleg of native Korean black pigs raised on Jirisan Mountain, the broth is subtle yet elegant in flavor. Using the toryeom method—repeatedly pouring hot broth over the rice—each grain comes alive, enhancing the dish's depth. Paper-thin slices of pork complement the house dipping sauce beautifully. Paired with delicately crafted kimchi dumplings, it’s a comforting and elevated experience. With just 10 seats and only 100 bowls served daily, Okdongsik is quietly exceptional...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44-10%20Yanghwa-ro%207-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004035%2C%20South%20Korea"
    pageTitle="Okdongsik"
  />
);

export default Okdongsik;
