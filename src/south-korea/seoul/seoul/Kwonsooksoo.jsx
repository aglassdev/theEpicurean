...
const Kwonsooksoo = () => (
  <RestaurantPage
    restaurantName="Kwonsooksoo"
    address="4F, 37 Apgujeong-ro 80-gil, Gangnam-gu, Seoul, 06016, South Korea"
    cuisine="Korean"
    priceRange="₩₩₩₩"
    phoneNumber="+8225426268"
    website="https://www.kwonsooksoo.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Kwon Woo-joong’s homage to tradition is evident in every facet of Kwonsooksoo, even in the name itself (sooksoo is an archaic term for professional cook). Inspired by time-honored methods of cooking, Kwon digs deep into his own roots. He tirelessly scours the country for rare finds that best represent each of the seasons and transforms even the most mundane ingredients into something special. What the diners get to experience is passion on a plate, coupled with a good dose of ingenuity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%2037%20Apgujeong-ro%2080-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006016%2C%20South%20Korea"
    pageTitle="Kwonsooksoo"
  />
);

export default Kwonsooksoo;
