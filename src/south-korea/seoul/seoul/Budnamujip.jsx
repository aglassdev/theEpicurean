...
const Budnamujip = () => (
  <RestaurantPage
    restaurantName="Budnamujip"
    address="434 Hyoryeong-ro, Seocho-gu, Seoul, 06729, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩"
    phoneNumber="+82234734167"
    website="https://www.budnamujip.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1977, this family-style restaurant has garnered an appreciative following of barbecue lovers, often seeing three generations of loyal patrons from one family frequenting the shop. A popular locality for residents south of the river, it specializes in various cuts of meat exclusively from the cow including ribs, sirloin and tripe. The rich flavors of the exceptionally tender meat is enhanced simply with quality bay salt...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=434%20Hyoryeong-ro%2C%20Seocho-gu%2C%20Seoul%2C%2006729%2C%20South%20Korea"
    pageTitle="Budnamujip"
  />
);

export default Budnamujip;
