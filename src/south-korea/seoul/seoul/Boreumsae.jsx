...
const Boreumsae = () => (
  <RestaurantPage
    restaurantName="Boreumsae"
    address="36 Teheran-ro 81-gil, Gangnam-gu, Seoul, 06167, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩"
    phoneNumber="+8225699967"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/boreumsae"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beef restaurants are ubiquitous all over Korea, but this spot which opened in late 2015, offers something prized and uncommon: Jeju black cattle. Choose from a wide range of cuts including sirloin, tenderloin, chuck tail flap, outside skirt steak, brisket and two types of raw beef dishes: tartare and sashimi. The prime meat is flown in directly from the family-operated farm. Private rooms are available on the second floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36%20Teheran-ro%2081-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006167%2C%20South%20Korea"
    pageTitle="Boreumsae"
  />
);

export default Boreumsae;
