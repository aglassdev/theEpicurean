...
const KyoyangSiksa = () => (
  <RestaurantPage
    restaurantName="Kyoyang Siksa"
    address="238 Itaewon-ro, Yongsan-gu, Seoul, 04400, South Korea"
    cuisine="Barbecue"
    priceRange="₩"
    phoneNumber="+821076014041"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/gyoyang-siksa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sapporo-style lamb barbecue is the name of the game at Kyoyang Siksa, which specializes in tender young lamb less than 10 months old. Flown in from Australia, this meat is juicy and tender and the menu offers three cuts: French rack, ribs, and loin steak. These may be grilled tableside by the staff. Other solid dishes include soup curry with grilled vegetables and aromatic garlic rice served with small sheets of laver to wrap it in. Seating is limited, so be sure to book ahead...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=238%20Itaewon-ro%2C%20Yongsan-gu%2C%20Seoul%2C%2004400%2C%20South%20Korea"
    pageTitle="Kyoyang Siksa"
  />
);

export default KyoyangSiksa;
