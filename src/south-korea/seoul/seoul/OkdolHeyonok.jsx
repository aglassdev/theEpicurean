...
const OkdolHeyonok = () => (
  <RestaurantPage
    restaurantName="Okdol Heyonok"
    address="26-1 Ogeum-ro 36-gil, Songpa-gu, Seoul, 05700, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+8224044824"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/okdol-heyonok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taste the deeply savory broth and the nutty flavor of the noodles made from 100% buckwheat that intensifies the more you chew at Okdol Hyeonok. The restaurant is fairly new, but it has gained a solid following among Pyongyang naengmyeon connoisseurs. Some of their most popular dishes are mandu with a nuttiness that comes from plenty of tofu in the filling, eobok jaengban, and gajami shikhye. You can also have your favorite wine with your meal for a corkage fee. Enjoy the mild flavors with incredible depth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26-1%20Ogeum-ro%2036-gil%2C%20Songpa-gu%2C%20Seoul%2C%2005700%2C%20South%20Korea"
    pageTitle="Okdol Heyonok"
  />
);

export default OkdolHeyonok;
