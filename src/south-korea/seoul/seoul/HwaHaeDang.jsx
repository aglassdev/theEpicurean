...
const HwaHaeDang = () => (
  <RestaurantPage
    restaurantName="Hwa Hae Dang"
    address="15 Gukhoe-daero 62-gil, Yeongdeungpo-gu, Seoul, 07236, South Korea"
    cuisine="Gejang"
    priceRange="₩₩"
    phoneNumber="+8227854422"
    website="https://www.hwahaedang.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the first Seoul branch of the acclaimed Taean County restaurant, located on the west coast of Korea. The name of the restaurant, which translates into “Flower crab house” specializes in soy sauce marinated blue crab, prized for its sweet flesh. Each spring, when local crabs are in season, they are caught and flash frozen to be used throughout the year. The crabs are prepared in Taean and sent to Seoul. The seafood side dishes are also good...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Gukhoe-daero%2062-gil%2C%20Yeongdeungpo-gu%2C%20Seoul%2C%2007236%2C%20South%20Korea"
    pageTitle="Hwa Hae Dang"
  />
);

export default HwaHaeDang;
