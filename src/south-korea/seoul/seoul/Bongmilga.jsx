...
const Bongmilga = () => (
  <RestaurantPage
    restaurantName="Bongmilga"
    address="664 Seolleung-ro, Gangnam-gu, Seoul, 06088, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+8225462305"
    website="https://mbongmilga80ngq.zaemit.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is a relative newcomer to Seoul’s Pyeongyang cold buckwheat noodle scene but Chef Kwon Hee-seung’s passion for serving authentic bowls of cold buckwheat noodles more than makes up for its short history. Kwon begins each day by preparing the broth for the cold noodles, using cuts from local beef such as brisket, flank and round. He also throws in some medicinal herbs for good measure. Kwon’s noodles are made of 80% buckwheat flour, 20% sweet potato starch and are thicker than the versions served at most of its competitors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=664%20Seolleung-ro%2C%20Gangnam-gu%2C%20Seoul%2C%2006088%2C%20South%20Korea"
    pageTitle="Bongmilga"
  />
);

export default Bongmilga;
