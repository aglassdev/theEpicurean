...
const ChezSimon = () => (
  <RestaurantPage
    restaurantName="Chez Simon"
    address="66 #B, Hoenamu-ro, Yongsan-gu, Seoul, 04003, South Korea"
    cuisine="French"
    priceRange="₩₩"
    phoneNumber="+8227301045"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/chez-simon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chez Simon, This French bistro has been growing at a steady pace. The couple who runs this eatery closes its doors every year for a certain period, so that they can travel around the world to discover new ingredients. It is this unrelenting dedication to cuisine and humility that has marked the success, even though the chefs have had no professional culinary training. This French kitchen offers only course meals, featuring plain, simple dishes that are the culmination of authentic recipes and fresh, carefully curated ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20%23B%2C%20Hoenamu-ro%2C%20Yongsan-gu%2C%20Seoul%2C%2004003%2C%20South%20Korea"
    pageTitle="Chez Simon"
  />
);

export default ChezSimon;
