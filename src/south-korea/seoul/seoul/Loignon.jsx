...
const Loignon = () => (
  <RestaurantPage
    restaurantName="L'OIGNON"
    address="13-4, Apgujoeng-ro 4-gil, Gangnam-gu, Seoul, 06028, South Korea"
    cuisine="French"
    priceRange="₩₩₩"
    phoneNumber="+821090339187"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/l-oignon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled in a quiet alley within the ultra-trendy Garosu-gil district, L'Oignon, which means “the onion” in French, is a French-based pescatarian restaurant that offers dishes made only with vegetables, fish, eggs and dairy products. With a steadfast dedication to the principles of ecological harmony and compassionate treatment of animals, the chef opened this eatery with the intention of imparting to patrons the wholesome sustenance he himself reveres. The kitchen uses vegetable broth with mushrooms as a substitute for rich meat broth and creates the texture of its cakes using cauliflower and pecorino cheese instead of flour. Yet, the umami flavors and textures produced through these novel means are as deep and as luscious as those concocted by conventional recipes. If the allure of a plan..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13-4%2C%20Apgujoeng-ro%204-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006028%2C%20South%20Korea"
    pageTitle="L'OIGNON"
  />
);

export default Loignon;
