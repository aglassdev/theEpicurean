...
const Niuroumianguan = () => (
  <RestaurantPage
    restaurantName="Niuroumianguan"
    address="75-2 Cheonggyecheon-ro, Jongno-gu, Seoul, 03190, South Korea"
    cuisine="Noodles"
    priceRange="₩"
    phoneNumber="+827042135678"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/niroumianguan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Niroumianguan features a memorable juxtaposition of clean white and vibrant rust colors in its décor. Chinese beef noodle soup, a popular delicacy across the Greater China region, is commonly known to have originated from Taiwan, but its real origin is Lanzhou in mainland China. As the chef learned the recipe from a noodle joint in China’s Shandong Province, his restaurant serves up fare that is slightly different from the classic Taiwanese style. Add plenty of cilantro to the mildly sweet broth, complete with a clean yet rich taste; or a dab of chili sauce to give your dish deeper flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=75-2%20Cheonggyecheon-ro%2C%20Jongno-gu%2C%20Seoul%2C%2003190%2C%20South%20Korea"
    pageTitle="Niuroumianguan"
  />
);

export default Niuroumianguan;
