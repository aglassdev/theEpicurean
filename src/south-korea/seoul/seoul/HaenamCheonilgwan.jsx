...
const HaenamCheonilgwan = () => (
  <RestaurantPage
    restaurantName="Haenam Cheonilgwan"
    address="36-1 Banpo-daero 39-gil, Seocho-gu, Seoul, 06578, South Korea"
    cuisine="Korean"
    priceRange="₩₩"
    phoneNumber="+8225687775"
    website="https://haenamcheonilgwan.kr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Namdo cuisine, the cuisine of South Jeolla Province, occupies an eminent position in the diverse Korean culinary landscape. Haenam Cheonilgwan is a singular undertaking as it has steadfastly safeguarded Namdo cuisine through the generations. It branched out from Cheonil Sikdang, a Haenam-based diner with a proud history, and is headed by CEO Lee Hwa-young, a relative of the original founder. The asset that distinguishes Lee’s establishment from typical diners run by chefs is its tried-and-true flavors and recipes evolved and accumulated through the everyday vignettes she shares with her family. Korean cuisine has modernized to meet changing times, yet this food haven still strives to preserve the menus, recipes, and ingredients used when traditional ingredients were aplenty. Among the méla..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36-1%20Banpo-daero%2039-gil%2C%20Seocho-gu%2C%20Seoul%2C%2006578%2C%20South%20Korea"
    pageTitle="Haenam Cheonilgwan"
  />
);

export default HaenamCheonilgwan;
