...
const MimiMyeonga = () => (
  <RestaurantPage
    restaurantName="Mimi Myeonga"
    address="29 Gangnam-daero 160-gil, Gangnam-gu, Seoul, 06028, South Korea"
    cuisine="Noodles"
    priceRange="₩"
    phoneNumber="+827042335466"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/mimi-myeonga"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mimi Myeonga is a local favorite, sought after by lovers of buckwheat noodles. Made in-house with an unconventional ratio of only three parts buckwheat, Chef Jang Seung-woo’s noodles have an undeniably chewy texture, while still maintaining the subtle nutty fragrance of buckwheat. There is something for everyone on the menu; in addition to the basic zaru soba, customers can choose from a list of soba dishes that are served hot or cold, featuring different broths and toppings that always hit the spot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Gangnam-daero%20160-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006028%2C%20South%20Korea"
    pageTitle="Mimi Myeonga"
  />
);

export default MimiMyeonga;
