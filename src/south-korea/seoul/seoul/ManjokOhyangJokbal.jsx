...
const ManjokOhyangJokbal = () => (
  <RestaurantPage
    restaurantName="Manjok Ohyang Jokbal"
    address="134-7 Seosomun-ro, Jung-gu, Seoul, 04514, South Korea"
    cuisine="Jokbal"
    priceRange="₩"
    phoneNumber="+8227534755"
    website="https://www.manjok.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Manjok Oyhang Jokbal, the beloved Korean braised pig's feet dish is impeccably crafted with the utmost dedication and care to hygiene and quality. The restaurant, armed with a systematic central distribution system, offers consistent quality at all of its franchised locations. Here, the popular pork dish can be enjoyed warm until the very last piece, thanks to the specially designed hotplates installed into the tables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=134-7%20Seosomun-ro%2C%20Jung-gu%2C%20Seoul%2C%2004514%2C%20South%20Korea"
    pageTitle="Manjok Ohyang Jokbal"
  />
);

export default ManjokOhyangJokbal;
