...
const Stay = () => (
  <RestaurantPage
    restaurantName="STAY"
    address="81F Lotteworld Tower, 300 Olympic-ro, Songpa-gu, Seoul, 05551, South Korea"
    cuisine="French"
    priceRange="₩₩₩₩"
    phoneNumber="+82232131231"
    website="https://www.lottehotel.com/seoul-signiel/ko/dining/restaurant-stay-modern.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on the 81st floor of Signiel Seoul Hotel, STAY takes ‘dining with a view’ to a whole new level with its sweeping vistas of the metropolis. STAY is celebrated Chef Yannick Alléno’s modern casual French restaurant, a youthful and vibrant space accented with yellow and gold. The live Pastry Library is its signature feature that offers a tantalizing assortment of sweets and confections that guests can help themselves to...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81F%20Lotteworld%20Tower%2C%20300%20Olympic-ro%2C%20Songpa-gu%2C%20Seoul%2C%2005551%2C%20South%20Korea"
    pageTitle="STAY"
  />
);
