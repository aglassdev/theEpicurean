...
const Wooga = () => (
  <RestaurantPage
    ...
    address="B1F, 22 Dosan-daero 49-gil, Gangnam-gu, Seoul, 06019, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩₩"
    phoneNumber="+82262722223"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/wooga"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wooga was originally born in Hoengseong, the beef capital of Korea. The restaurant is known for preparing the choicest quality local beef in its unique style: dry aged and well done. Chef Heo Se-byeong has been experimenting tirelessly with beef under the slogan meat science to maximize the characteristics of this meat such as tenderness, juiciness and flavor. Don’t miss out on another perennial favorite: a stew made with soybean paste fermented over long stages by the chef’s own mom...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%2022%20Dosan-daero%2049-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006019%2C%20South%20Korea"
    pageTitle="Wooga"
  />
);

export default Wooga;
