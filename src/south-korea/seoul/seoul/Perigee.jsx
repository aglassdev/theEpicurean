...
const Perigee = () => (
  <RestaurantPage
    restaurantName="PERIGEE"
    address="6-5 Bongeunsa-ro 68-gil, Gangnam-gu, Seoul, 06153, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+821065508912"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/perigee"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perigee means the point in the orbit of a satellite at which it is closest to the Earth. The restaurant was named in the hope of bringing diners closer to food and wine. The restaurant, which is run by chef couple Shin Ga-young and Lim Hong-keun, serves pasta that is all made fresh in-house. Diners can enjoy different types of pastas with textures and shapes rarely found in Korea, such as cavatelli, andarinos, and pici. Experience familiar yet unique combinations like vongole with pici, and lobster pasta with andarinos...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-5%20Bongeunsa-ro%2068-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006153%2C%20South%20Korea"
    pageTitle="PERIGEE"
  />
);

export default Perigee;
