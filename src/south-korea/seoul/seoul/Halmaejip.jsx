...
const Halmaejip = () => (
  <RestaurantPage
    restaurantName="Halmaejip"
    address="1-5 Sajik-ro 12-gil, Jongno-gu, Seoul, 03169, South Korea"
    cuisine="Korean"
    priceRange="₩"
    phoneNumber="+8227352608"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/halmaejip"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The original matriarch who opened this restaurant is still the heart and soul of the kitchen which has been dishing up legendary pork backbone stew and boiled pig’s feet since 1975. Chili powder is the only spicy agent used to add the pleasant kick to the taste. It’s a common sight to see Mrs. Mun, walking around showing her patrons how to eat her food “the right way. ”..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5%20Sajik-ro%2012-gil%2C%20Jongno-gu%2C%20Seoul%2C%2003169%2C%20South%20Korea"
    pageTitle="Halmaejip"
  />
);

export default Halmaejip;
