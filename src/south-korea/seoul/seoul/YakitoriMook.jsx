...
const YakitoriMook = () => (
  <RestaurantPage
    restaurantName="Yakitori Mook"
    address="165-1 Seongmisan-ro, Mapo-gu, Seoul, 03980, South Korea"
    cuisine="Yakitori"
    priceRange="₩"
    phoneNumber="+827088353433"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/yakitori-mook"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This yakitori specialist is nestled in a quiet corner in Yeonnam-dong. Make your way inside to discover an elongated counter, open kitchen and, at its center, Chef Kim Byoung-mook busy concentrating on grilling yakitori skewers over a charcoal as well as a straw fire. This visually arresting image of the chef, standing under the intense lights that also illuminate the grill, is reminiscent of an actor delivering a monologue on stage. The restaurant's motto is plain and simple, “We prepare fresh purebred Korean chicken every day and grill our skewers over the highest-grade Japanese Binchotan charcoal and serve them immediately to our patrons.”..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=165-1%20Seongmisan-ro%2C%20Mapo-gu%2C%20Seoul%2C%2003980%2C%20South%20Korea"
    pageTitle="Yakitori Mook"
  />
);

export default YakitoriMook;
