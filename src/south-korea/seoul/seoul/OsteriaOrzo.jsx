...
const OsteriaOrzo = () => (
  <RestaurantPage
    restaurantName="Osteria Orzo"
    address="2F, 47 Hannam-daero 20-gil, Yongsan-gu, Seoul, 04419, South Korea"
    cuisine="Italian"
    priceRange="₩₩"
    phoneNumber="+8223220801"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/osteria-orzo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Osteria Orzo continues to offer an authentic taste of a casual and cozy Italian osteria at its Hannam-dong location. Signature offerings on the menu include the white ragù pasta which features home-made fresh pasta drenched in rich meat sauce with mascarpone cheese and truffles. The spicy tagliatelle and the seafood tartare are also among the restaurant's all-time favorites. Reserve a table across from the open kitchen and watch the chefs in action...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2047%20Hannam-daero%2020-gil%2C%20Yongsan-gu%2C%20Seoul%2C%2004419%2C%20South%20Korea"
    pageTitle="Osteria Orzo"
  />
);

export default OsteriaOrzo;
