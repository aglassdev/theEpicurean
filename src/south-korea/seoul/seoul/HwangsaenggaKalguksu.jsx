...
const HwangsaenggaKalguksu = () => (
  <RestaurantPage
    restaurantName="Hwangsaengga Kalguksu"
    address="78 Bukchon-ro 5-gil, Jongno-gu, Seoul, 03053, South Korea"
    cuisine="Kalguksu"
    priceRange="₩"
    phoneNumber="+8227396334"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/hwangsaengga-kalguksu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="No matter what time of day, always expect to see a line outside this beloved establishment, known for their humble noodle soup and dumplings. Originally called Bukchon Kalguksu when it opened in 2001, it changed its name in 2014, but that hasn’t stopped the regulars from coming time and again for its freshly made dumplings and silky-soft noodles served in a rich ox bone broth. Boiled beef slices and noodles in cold soybean soup are also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=78%20Bukchon-ro%205-gil%2C%20Jongno-gu%2C%20Seoul%2C%2003053%2C%20South%20Korea"
    pageTitle="Hwangsaengga Kalguksu"
  />
);

export default HwangsaenggaKalguksu;
