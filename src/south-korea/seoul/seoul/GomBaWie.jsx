...
const GomBaWie = () => (
  <RestaurantPage
    restaurantName="Gom Ba Wie"
    address="10 Yeongdong-daero 115-gil, Gangnam-gu, Seoul, 06087, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩"
    phoneNumber="+8225110068"
    website="https://www.gbw.co.kr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Grilled tripe and large intestines reign supreme at Gom Ba Wie, which has seen three decades of customers hooked on their buttery, pleasantly chewy goodness. The original location and the new location stand back to back, offering a glimpse of the restaurant’s past and present. If beef intestines aren't your cup of tea, the restaurant also offers other cuts like ribeye, short ribs and brisket. All meats are grilled over wood charcoal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Yeongdong-daero%20115-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006087%2C%20South%20Korea"
    pageTitle="Gom Ba Wie"
  />
);

export default GomBaWie;
