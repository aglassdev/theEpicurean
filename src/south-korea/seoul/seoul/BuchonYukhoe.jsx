...
const BuchonYukhoe = () => (
  <RestaurantPage
    restaurantName="Buchon Yukhoe"
    address="200-12 Jong-ro, Jongno-gu, Seoul, 03195, South Korea"
    cuisine="Yukhoe"
    priceRange="₩"
    phoneNumber="+82222671831"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/buchon-yukhoe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a corner of the well-established raw beef alley of Gwangjang Market, Buchon Yukhoe has been in business since 1965, originally started as Buchon Sikdang selling short rib soup. The founding matriarch’s original Jeollado Province-style raw beef, seasoned with red chili paste, gave way to the more popular Seoul-style in the 1980s, seasoned with sesame oil and eaten with matchstick pears. Try the raw beef bibimbap for a more substantial meal. Locally sourced beef is delivered to the restaurant each morning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200-12%20Jong-ro%2C%20Jongno-gu%2C%20Seoul%2C%2003195%2C%20South%20Korea"
    pageTitle="Buchon Yukhoe"
  />
);

export default BuchonYukhoe;
