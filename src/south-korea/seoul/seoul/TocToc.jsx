...
const TocToc = () => (
  <RestaurantPage
    restaurantName="Toc Toc"
    address="3F, 41 Hakdong-ro 97-gil, Gangnam-gu, Seoul, 06072, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩"
    phoneNumber="+8225423030"
    website="https://www.restauranttoctoc.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kim Dae-chun’s unwavering dedication to culinary excellence and his insistence on using only the finest ingredients are clearly reflected in the cuisine of Toc Toc. The term “Toconomy”—a blend of Toc Toc and Gastronomy—embodies his culinary philosophy. Chef Kim emphasizes precision in technique to bring out the pure, natural flavors of each ingredient, highlighting his deep respect for the value of quality produce. His distinctive dishes are a testament to the care and creativity infused into every plate. In addition to his course menus, Toc Toc offers a thoughtfully curated selection of à la carte dishes, allowing guests to experience the full spectrum of flavors the restaurant has to offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2041%20Hakdong-ro%2097-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006072%2C%20South%20Korea"
    pageTitle="Toc Toc"
  />
);

export default TocToc;
