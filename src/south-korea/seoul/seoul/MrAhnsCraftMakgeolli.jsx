...
const MrAhnsCraftMakgeolli = () => (
  <RestaurantPage
    restaurantName="Mr. Ahn's Craft Makgeolli"
    address="3 Hoenamu-ro, Yongsan-gu, Seoul, 04343, South Korea"
    cuisine="Korean"
    priceRange="₩₩"
    phoneNumber="+821099655112"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/mr-ahn-s-craft-makgeolli-1192580"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mr. Ahn's Craft Makgeolli is a most befitting venue for the Korean term banju, or alcohol accompanying a meal. What distinguishes this gastropub is its avoidance of the stereotypical Korean pubs and expression of the direction they should take—in this age of new Korean cuisine that is traditional yet imbued with a modern touch. At this charming spot, patrons can enjoy seasonally changing menus of savory Korean anju (snacks paired with alcohol), main dishes, as well as a wide selection of traditional liquors that simply get better with time. It’s a perfect place for both light meals and friendly social drinking—a versatile venue that appeals to distinct audiences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Hoenamu-ro%2C%20Yongsan-gu%2C%20Seoul%2C%2004343%2C%20South%20Korea"
    pageTitle="Mr. Ahn's Craft Makgeolli"
  />
);

export default MrAhnsCraftMakgeolli;
