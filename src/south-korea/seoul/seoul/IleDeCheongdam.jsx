...
const IleDeCheongdam = () => (
  <RestaurantPage
    restaurantName="Ile de Cheongdam"
    address="2F, 13 Dosan-daero 59-gil, Gangnam-gu, Seoul, 06016, South Korea"
    cuisine="Contemporary"
    priceRange="₩₩₩₩"
    phoneNumber="+8225454015"
    website="https://www.iledecd.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Meaning “an island within the heart of the city,” Ile de Cheongdam brings together the best of Japanese omakase with Korean beef omakase. Formerly a membership-only venue, it has opened its doors to the public to share its gastronomic delights with a wider audience. From the chef’s pre-dining explanation of ingredients that change daily to the final tea ceremony, where the tea is steeped three times, every course of the omakase showcases the nuanced service of this establishment. Dining at Ile de Cheongdam is by reservation only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2013%20Dosan-daero%2059-gil%2C%20Gangnam-gu%2C%20Seoul%2C%2006016%2C%20South%20Korea"
    pageTitle="Ile de Cheongdam"
  />
);

export default IleDeCheongdam;
