...
const PyeongyangMyeonok = () => (
  <RestaurantPage
    restaurantName="Pyeongyang Myeonok"
    address="207 Jangchungdan-ro, Jung-gu, Seoul, 04615, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+82222677784"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/pyeongyang-myeonok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pyeongyang Myeonok is a historic restaurant in Seoul that has served Pyongyang naengmyeon for three generations. Expect a long wait on a hot summer’s day. The broth is exceptionally clear with an understated meaty flavor; it is clean and mellow, and the fragrant noodles are full of buckwheat flavor. The mandu, that is stuffed full of different ingredients except kimchi, and the thinly sliced suyuk are also fan favorites. Do note that they have been closing every Monday since January 2025...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=207%20Jangchungdan-ro%2C%20Jung-gu%2C%20Seoul%2C%2004615%2C%20South%20Korea"
    pageTitle="Pyeongyang Myeonok"
  />
);

export default PyeongyangMyeonok;
