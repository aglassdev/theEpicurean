...
const SoseoulHannam = () => (
  <RestaurantPage
    restaurantName="Soseoul Hannam"
    address="B1F, 21-18 Hannam-daero 20-gil, Yongsan-gu, Seoul, 04419, South Korea"
    cuisine="Korean"
    priceRange="₩₩₩₩"
    phoneNumber="+8227975995"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/soseoul-hannam"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Inspired by local culinary traditions but dedicated to expressing the modern-day sensibilities of Seoul cuisine, Soseoul Hannam serves up contemporary Korean food using ingredients that are most familiar to the local palate. The chef's creations are an homage to some of the more typical dishes and preparation techniques, including seasoned salads, pan-fried and braised dishes. Kelp chips, rich soybean paste stew, sliced raw fish with gomchwi (Fischer's ragwort) and aged kimchi, and chargrilled webfoot octopus are some of its signature offerings. The restaurant also offers traditional liquor pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%2021-18%20Hannam-daero%2020-gil%2C%20Yongsan-gu%2C%20Seoul%2C%2004419%2C%20South%20Korea"
    pageTitle="Soseoul Hannam"
  />
);

export default SoseoulHannam;
