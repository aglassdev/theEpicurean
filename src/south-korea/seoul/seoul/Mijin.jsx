...
const Mijin = () => (
  <RestaurantPage
    restaurantName="Mijin"
    address="#116-2 le Meilleur Jongno town, 19 Jong-ro, Jongno-gu, Seoul, 03157, South Korea"
    cuisine="Memil-guksu"
    priceRange="₩"
    phoneNumber="+8227306198"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/mijin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of Gwanghwamun, Mijin has been serving Korean-style cold buckwheat noodles since 1952. The restaurant operates a factory in the basement where the dipping sauce and buckwheat noodles are prepared fresh daily. One portion comes with two stacked tray baskets of noodles, a large kettle of chilled sauce and basic side dishes. Dress your dipping sauce to your desire with grated daikon, light wasabi, crispy seasoned laver and chopped green onions that have already been laid out on the table for you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%23116-2%20le%20Meilleur%20Jongno%20town%2C%2019%20Jong-ro%2C%20Jongno-gu%2C%20Seoul%2C%2003157%2C%20South%20Korea"
    pageTitle="Mijin"
  />
);

export default Mijin;
