...
const JinmiPyeongyangNaengmyeon = () => (
  <RestaurantPage
    restaurantName="Jinmi Pyeongyang Naengmyeon"
    address="305-3 Hakdong-ro, Gangnam-gu, Seoul, 06061, South Korea"
    cuisine="Naengmyeon"
    priceRange="₩"
    phoneNumber="+8225153469"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/jinmi-pyungyang-naengmyeon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="According to owner and chef Yim Se-kwon, long time experience in the kitchens of one of the most iconic Pyeongyang cold buckwheat noodle restaurants is the secret to the success of this place. The menu here is what you would expect to see in a typical cold buckwheat noodle restaurant. Other than the noodles, it offers staples such as boiled pork and beef slices, bulgogi, dumplings and Pyeongyang-style beef hot pot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=305-3%20Hakdong-ro%2C%20Gangnam-gu%2C%20Seoul%2C%2006061%2C%20South%20Korea"
    pageTitle="Jinmi Pyeongyang Naengmyeon"
  />
);

export default JinmiPyeongyangNaengmyeon;
