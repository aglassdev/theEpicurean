...
const ByeokjeGalbi = () => (
  <RestaurantPage
    restaurantName="Byeokje Galbi"
    address="1-4 Yangjae-daero 71-gil, Songpa-gu, Seoul, 05639, South Korea"
    cuisine="Barbecue"
    priceRange="₩₩₩"
    phoneNumber="+8224155522"
    website="https://www.bjgalbi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Byeokje Galbi is a local institution that has been serving legendary barbecued beef short ribs since 1986. The restaurant’s attention to quality begins from the breeding of the cows at a local farm in Pocheon. Only the top 1% (BMS No9) are purchased, whole, at a daily auction, after which they are handled by an artisan butcher. The signature dishes are the beautifully marbled short ribs and ribeye grilled over charcoal. From a simple meal of cold buckwheat noodles and soup to an elaborate barbecue feast, Byeokje Galbi caters to all occasions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4%20Yangjae-daero%2071-gil%2C%20Songpa-gu%2C%20Seoul%2C%2005639%2C%20South%20Korea"
    pageTitle="Byeokje Galbi"
  />
);

export default ByeokjeGalbi;
