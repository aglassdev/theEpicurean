...
const HwanggeumKongbat = () => (
  <RestaurantPage
    restaurantName="Hwanggeum Kongbat"
    address="9 Mapo-daero 16-gil, Mapo-gu, Seoul, 04205, South Korea"
    cuisine="Dubu"
    priceRange="₩"
    phoneNumber="+8223132952"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/hwanggeum-kongbat"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hwanggeum Kongbat focuses on nourishing, comforting Korean cuisine, using domestically grown soybeans to craft their house-made tofu. Seasoning is kept light to highlight the natural flavors of each ingredient, resulting in dishes that are gentle yet flavorful. Standouts include jjabak dubu, dubu jorim, dubu jeongol, dubu jeon, and dubu duruchigi, all beautifully paired with house-brewed takju made from just rice, nuruk, and water. While tofu is the star, the menu also features pork bossam, yuk jeon, and various seafood options, offering a well-rounded, soulful dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Mapo-daero%2016-gil%2C%20Mapo-gu%2C%20Seoul%2C%2004205%2C%20South%20Korea"
    pageTitle="Hwanggeum Kongbat"
  />
);

export default HwanggeumKongbat;
