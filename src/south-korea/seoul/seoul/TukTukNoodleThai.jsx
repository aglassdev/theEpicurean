...
const TukTukNoodleThai = () => (
  <RestaurantPage
    restaurantName="Tuk Tuk Noodle Thai"
    address="161-8 Seongmisan-ro, Mapo-gu, Seoul, 03980, South Korea"
    cuisine="Thai"
    priceRange="₩"
    phoneNumber="+827044075130"
    website="https://guide.michelin.com/en/seoul-capital-area/kr-seoul/restaurant/tuktuk-noodle-thai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Authenticity is the name of the game at Tuk Tuk Noodle Thai, a collaborative effort between a local Korean owner and a native Thai chef to bring the real flavors of Thailand to Korea. The components that make up a typically Thai meal — the colors, textures, scents, flavors and the ambience — are present from start to end. If you want to feel the authentic taste and aroma of Thailand, try Thai sausages, or spicy and sour 'larb moo' – stir-fried minced pork. While you are tasting the dishes, the joy of your daily life will increase by a span...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=161-8%20Seongmisan-ro%2C%20Mapo-gu%2C%20Seoul%2C%2003980%2C%20South%20Korea"
    pageTitle="Tuk Tuk Noodle Thai"
  />
);

export default TukTukNoodleThai;
