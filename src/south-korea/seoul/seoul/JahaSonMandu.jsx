...
const JahaSonMandu = () => (
  <RestaurantPage
    restaurantName="Jaha Son Mandu"
    address="12 Baekseokdong-gil, Jongno-gu, Seoul, 03020, South Korea"
    cuisine="Mandu"
    priceRange="₩"
    phoneNumber="+8223792648"
    website="https://www.jahasonmandoo.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Baekseokdong-gil%2C%20Jongno-gu%2C%20Seoul%2C%2003020%2C%20South%20Korea"
    pageTitle="Jaha Son Mandu"
  />
);

export default JahaSonMandu;
