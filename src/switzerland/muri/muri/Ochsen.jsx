...
const Ochsen = () => (
  <RestaurantPage
    restaurantName="Ochsen"
    address="Caspar-Wolf-Weg 1, Muri, 5630, Switzerland"
    cuisine="Creative, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+41562007100"
    website="https://www.ochsenmuri.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located just metres from the monastery, the venerable Ochsen dates back to 1596. In its current iteration with an avant-garde look, it is part of the three-building Hotel Caspar, which has stylishly designed guestrooms. In the open kitchen, regional ingredients go into modern and creative cooking – interesting cuisine that is close to nature, with fire, aromatic woods, smoked and grilled dishes play a central role...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Caspar-Wolf-Weg%201%2C%20Muri%2C%205630%2C%20Switzerland"
    pageTitle="Ochsen"
  />
);

export default Ochsen;
