...
const HygRestaurantBar = () => (
  <RestaurantPage
    restaurantName="HYG Restaurant & Bar"
    address="Seestrasse 60, Weggis, 6353, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+41413921100"
    website="https://hyg.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name HYG is a nod to the Danish word and concept of hygge, which describes the combination of cosiness, conviviality and culinary enjoyment. The motivated young team and trendy, modern decor foster just that relaxed, feel-good atmosphere. Choose between a sharing menu for two or more people and an à la carte menu with dishes such as yellowfin tuna, tomato, daikon, linguine, wild-caught Argentine red shrimp, Amalfi lemon or crispy Alpstein chicken, roasted vegetable cream, smoked almonds. The wine list, which comprises around 500 items, also includes well-known names and great wines. The space is done out with a Nordic-inspired aesthetic that is bright and cheerful, and the service is pleasingly laid-back and professional. Note for motorists: You can park in a public car park a few minu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestrasse%2060%2C%20Weggis%2C%206353%2C%20Switzerland"
    pageTitle="HYG Restaurant & Bar"
  />
);

export default HygRestaurantBar;
