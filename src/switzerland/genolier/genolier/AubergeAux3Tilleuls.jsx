...
const AubergeAux3Tilleuls = () => (
  <RestaurantPage
    restaurantName="Auberge aux 3 Tilleuls"
    address="Place du Village 7, Genolier, 1272, Switzerland"
    cuisine="Contemporary, French"
    priceRange="€€"
    phoneNumber="+41223660531"
    website="https://www.aubergegenolier.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you're passing through Genolier, be sure to stop off at this charming Auberge! Filipe, the young chef here, serves fresh, tasty cuisine infused with contemporary flair: think fillet of turbot grilled skin on, with pesto and crunchy vegetables. An enjoyable mealtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Village%207%2C%20Genolier%2C%201272%2C%20Switzerland"
    pageTitle="Auberge aux 3 Tilleuls"
  />
);

export default AubergeAux3Tilleuls;
