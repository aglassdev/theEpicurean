...
const WirtschaftAmSchlssli = () => (
  <RestaurantPage
    restaurantName="Wirtschaft am Schlössli"
    address="Seestrasse 50, Bottighofen, 8598, Switzerland"
    cuisine="Mediterranean Cuisine, French"
    priceRange="€€€"
    phoneNumber="+41716889092"
    website="https://www.schloessli-bottighofen.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Christian Kuchler from Taverne zum Schäfli in Wilgoltingen is also behind this culinary hotspot here in nearby Bottighofen, in a lovely location by the marina. Under the direction of head chef Monika Huber (formerly sous-chef to Christian Kuchler), the food is ambitious. The menu is divided into France, Italy, Iberian Peninsula and Classics. Your Mediterranean journey ranges from rabbit roulade, raw ham, sage, courgette to scampi, fregola sarda, lemon, pepperoncini and Ibérico pork Alenttejana to tortelloni, tomato, burrata, Taggiasca olive. Accompanied by a well-curated wine list with a fine selection from Switzerland and Europe. Enjoy your meal inside in a relaxed bistro atmosphere or out on the gorgeous terrace on the shores of Lake Constance. Tip: Tapas are also served all day on a sep..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestrasse%2050%2C%20Bottighofen%2C%208598%2C%20Switzerland"
    pageTitle="Wirtschaft am Schlössli"
  />
);

export default WirtschaftAmSchlssli;
