...
const Montrouge = () => (
  <RestaurantPage
    restaurantName="Mont-Rouge"
    address="Route de la Télécabine 19, Haute-Nendaz, 1997, Switzerland"
    cuisine="International"
    priceRange="€€€"
    phoneNumber="+41272881166"
    website="https://www.mont-rouge.ch/fr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The standouts of this alpine chalet-inspired eatery are its warm, stylish atmosphere and its enthusiastic owner chef, who has been hard at work here since 2003. He invites you on a culinary journey, packed with surprises and strewn with forgotten heritage recipes, as he acquaints you with the region’s delicacies: lamb from Val Ferret, veal of the Herens breed, Valais black truffles… Alternatively, head to the small adjoining brasserie and sample its daily specials: poached sole roulade, home-made sauerkraut and champagne-laced beurre blanc… a real treat! Pleasant guestrooms for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20la%20T%C3%A9l%C3%A9cabine%2019%2C%20Haute-Nendaz%2C%201997%2C%20Switzerland"
    pageTitle="Mont-Rouge"
  />
);

export default Montrouge;
