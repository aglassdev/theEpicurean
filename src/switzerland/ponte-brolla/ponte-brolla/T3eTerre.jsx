...
const T3eTerre = () => (
  <RestaurantPage
    restaurantName="t3e terre"
    address="via Vecchia Stazione 2, Ponte Brolla, 6652, Switzerland"
    cuisine="Mediterranean Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+41917432222"
    website="https://3terre.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owned by the Meneganti family, this beautiful house is home to a restaurant with an attractive dining room and stunning terrace that provide the backdrop for delicious Mediterranean cuisine. A charming hotel with welcoming guestrooms (additional rooms are under construction) adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vecchia%20Stazione%202%2C%20Ponte%20Brolla%2C%206652%2C%20Switzerland"
    pageTitle="t3e terre"
  />
);

export default T3eTerre;
