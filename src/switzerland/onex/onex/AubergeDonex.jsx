...
const AubergeDonex = () => (
  <RestaurantPage
    restaurantName="Auberge d'Onex"
    address="Route de Loëx 18, Onex, 1213, Switzerland"
    cuisine="Italian, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+41227923259"
    website="https://guide.michelin.com/en/geneve-region/onex/restaurant/auberge-d-onex"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1977, this inn has been nestled in verdant surroundings in the former clubhouse of Geneva's first golf course. It serves traditional Italian cuisine, including the chef's specialities of penne with vodka and penne alla Norma (a Sicilian dish that pays tribute to the composer Vincenzo Bellini, who was from the island), but also classics such as vitello tonnato. The dessert trolley features Italian specialities and a choice of fresh fruit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Lo%C3%ABx%2018%2C%20Onex%2C%201213%2C%20Switzerland"
    pageTitle="Auberge d'Onex"
  />
);

export default AubergeDonex;
