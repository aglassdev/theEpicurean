...
const VillaAmSeeBySandroLthi = () => (
  <RestaurantPage
    restaurantName="Villa am See by Sandro Lüthi"
    address="Seestrasse 64, Goldach, 9403, Switzerland"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+41714552526"
    website="https://villa-am-see-goldach.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a villa in a beautiful location, this restaurant is run with great dedication by a young couple – Sandro Lüthi (kitchen) and Paulina Soares (service) – and their small, friendly team. Working in tandem in the kitchen, the owner and his chef Robert Fiedler devise two three- to six-course set menus in the evening, one of which is vegetarian, plus à la carte dishes. Expect modern, seasonal and ingredient-led cuisine – predominantly French and Mediterranean in style, complemented by international twists and a dose of creativity. Examples include baked egg, spinach, Parmesan, truffle and kingfish, Granny Smith, green shiso, wasabi. Lunch, too, is a sophisticated affair, based on a sharing concept (dubbed Geteilter Genuss). Accordingly, there is a set menu including starters to share a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestrasse%2064%2C%20Goldach%2C%209403%2C%20Switzerland"
    pageTitle="Villa am See by Sandro Lüthi"
  />
);

export default VillaAmSeeBySandroLthi;
