...
const LeCafSuisse = () => (
  <RestaurantPage
    restaurantName="Le Café Suisse"
    address="Rue Centrale 41, Bex, 1880, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41244633398"
    website="https://www.cafe-suisse.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former village café has morphed into a buzzy, friendly eatery decked in colourful cartoon murals. Youthful Marie Robert, assisted by an almost woman only team, wholeheartedly regales diners with creative, light-hearted dishes that are in tune with the seasons to be washed down with excellent local tipples. Robert has a flair for spontaneously showcasing seasonal ingredients. Examples include a mousseline of seabream enhanced by a whipped beurre blanc or an incredibly powerful and heady duo of blueberry and chocolate. Be bold and opt for her surprise menu – a hit with regulars, it is as playful as it is indulgent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Centrale%2041%2C%20Bex%2C%201880%2C%20Switzerland"
    pageTitle="Le Café Suisse"
  />
);

export default LeCafSuisse;
