...
const LeJardinDesAlpes = () => (
  <RestaurantPage
    restaurantName="Le Jardin des Alpes"
    address="Domaine de Rochegrise 23, Villars-sur-Ollon, 1884, Switzerland"
    cuisine="Mediterranean Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+41244959090"
    website="https://www.royalp.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a new chef and a new concept at this gastronomic restaurant within the walls of the Chalet RoyAlp luxury hotel & spa. In this elegant yet welcoming setting, savour dishes such as snails with herbs and a potato mousse, and fettuccine with parmesan and Alba white truffle sauce, complemented by highly professional service and an impressive wine selection. The terrace is a must in fine weather!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20de%20Rochegrise%2023%2C%20Villars-sur-Ollon%2C%201884%2C%20Switzerland"
    pageTitle="Le Jardin des Alpes"
  />
);

export default LeJardinDesAlpes;
