...
const Edo = () => (
  <RestaurantPage
    ...
    priceRange="€€"
    phoneNumber="+41274817000"
    website="https://edo-tokyo.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming, zen-inspired establishment with a panoramic terrace at the foot of the mountains invites you to sample authentic Japanese fare. In their open kitchen, the brigade painstakingly crafts iconic dishes, such as crispy gyoza, nigiri (fatty tuna, grilled eel, tamago) and perfectly crispy Katsu chicken. Some of the house specials require pre-ordering well ahead, like the Japanese fondue and fresh fish chirashi. The menu also features a lineup of classics among which miso soup or a Japanese rendering of a café gourmand with mochi and matcha-flavoured sweet titbits. The warm, friendly vibe, attentive front-of-house team and exemplary value for money make it an establishment not to be missed, be it to dine in or take away...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20Sierre-Montana%2043%2C%20Crans-Montana%2C%203975%2C%20Switzerland"
    pageTitle="Edo"
  />
);
