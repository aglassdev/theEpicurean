...
const SchotteseppstubeFlickflauder = () => (
  <RestaurantPage
    restaurantName="Schotte-Sepp-Stube / Flickflauder"
    address="Im Park 1, Weissbad, 9057, Switzerland"
    cuisine="Farm to table, International"
    priceRange="€€€"
    phoneNumber="+41717988080"
    website="https://www.hofweissbad.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you choose to dine in the cosy Schotte-Sepp-Stube, the bright Veranda or the contemporary, minimalist-style Flickflauder, you’re guaranteed good-quality, seasonally inspired cuisine and friendly service at this restaurant, which hosts an “Appenzell evening” with a buffet every Wednesday. The à la carte is available to non-resident guests from 8pm onwards...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Im%20Park%201%2C%20Weissbad%2C%209057%2C%20Switzerland"
    pageTitle="Schotte-Sepp-Stube / Flickflauder"
  />
);

export default SchotteseppstubeFlickflauder;
