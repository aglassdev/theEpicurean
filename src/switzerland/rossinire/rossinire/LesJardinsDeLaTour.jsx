...
const LesJardinsDeLaTour = () => (
  <RestaurantPage
    restaurantName="Les Jardins de la Tour"
    address="Rue de la Placette 16, Rossinière, 1658, Switzerland"
    cuisine="French, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+41265585053"
    website="https://www.lesjardinsdelatour.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ludovic Garnier (chef) and Christelle Huguenin (front of house) welcome guests into a deliciously inviting 19C house appointed in a wood-rich, chic rustic vein where a wood-burning stove is lit in winter. Diners choose between one of two menus with three or four courses that aim to highlight fresh, regional produce: seared foie gras with peaches, freshly caught zander and a chocolate mint delight to finish. A snug cocoon with small tables and spot-on service set the scene for a truly relaxing meal. Bookings recommended, particularly if you want to dine alfresco...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Placette%2016%2C%20Rossini%C3%A8re%2C%201658%2C%20Switzerland"
    pageTitle="Les Jardins de la Tour"
  />
);

export default LesJardinsDeLaTour;
