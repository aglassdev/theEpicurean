...
const LandgasthofOchsen = () => (
  <RestaurantPage
    restaurantName="Landgasthof Ochsen"
    address="Dorfplatz 56, Wölflinswil, 5063, Switzerland"
    cuisine="Farm to table, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41628771106"
    website="https://ochsen-woelflinswil.ch/wp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here at this inn dating back to 1288, the food is terrific – the skilful chef clearly pours a lot of love into his cooking. As well as regional dishes and classics, Asian and Mediterranean influences make their way onto the menu. A meal in their Gaststube is a somewhat simpler affair. There is a lovely terrace overlooking the pond, plus a charming smoking lounge. They offer comfortable and functional guestrooms, along with a charging point for electric vehicles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfplatz%2056%2C%20W%C3%B6lflinswil%2C%205063%2C%20Switzerland"
    pageTitle="Landgasthof Ochsen"
  />
);

export default LandgasthofOchsen;
