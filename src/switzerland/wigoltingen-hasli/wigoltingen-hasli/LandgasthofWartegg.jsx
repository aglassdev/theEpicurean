...
const LandgasthofWartegg = () => (
  <RestaurantPage
    restaurantName="Landgasthof Wartegg"
    address="Müllheimerstrasse 3, Wigoltingen / Hasli, 8554, Switzerland"
    cuisine="Classic French, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+41527700808"
    website="https://www.landgasthof-wartegg.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by the Frei family since 1982, this long-standing restaurant with its well-maintained shingle façade serves fresh, flavoursome seasonal fare rooted in classic cuisine and crafted from excellent ingredients. The set lunch is very popular. Tip: There is an especially fine selection of Swiss wines. Diners can choose between rustic cosiness and refined elegance in the various indoor spaces or head for the lovely tree-shaded terrace. Cosy guestrooms are available for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%BCllheimerstrasse%203%2C%20Wigoltingen%20%2F%20Hasli%2C%208554%2C%20Switzerland"
    pageTitle="Landgasthof Wartegg"
  />
);

export default LandgasthofWartegg;
