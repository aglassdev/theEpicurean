...
const GasthofZumGoldenenKreuz = () => (
  <RestaurantPage
    restaurantName="Gasthof zum goldenen Kreuz"
    address="Zürcherstrasse 134, Frauenfeld, 8500, Switzerland"
    cuisine="Farm to table, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41527250110"
    website="https://www.goldeneskreuz.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is steeped in tradition, and much sought after for its excellent seasonal cuisine. The chef's expertise and his knack for preparing select ingredients with real flavour are evident in dishes such as spicy smoked trout tartare with dill mustard and marinated apple and beetroot salad, and braised veal cheek, Bramata polenta and green beans with dried bacon. At lunchtime, you can order à la carte or opt for one of four three-course set menus. In the evening, there is a tasting menu in addition to an à la carte selection. Attentive service comes courtesy of a friendly and well-organised front-of-house team. Goethe himself was a guest here – the pretty Goethe-Stübli is named after him – and the well-preserved painted panelling from the 17C adds rustic charm. The terrace is a del..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Z%C3%BCrcherstrasse%20134%2C%20Frauenfeld%2C%208500%2C%20Switzerland"
    pageTitle="Gasthof zum goldenen Kreuz"
  />
);

export default GasthofZumGoldenenKreuz;
