...
const DuChevalBlanc = () => (
  <RestaurantPage
    restaurantName="Du Cheval Blanc"
    address="Rue de Gruyères 16, Bulle, 1630, Switzerland"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41269186444"
    website="https://www.restaurantduchevalblanc.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The former chef at L'Écu, in Bulle, has turned Du Cheval Blanc into a veritable haven for foodies. In this convivial light-filled restaurant, he delights diners with his well-crafted, unfussy and straightforward take on traditional cuisine, prepared with care and served by a professional team. The real deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20Gruy%C3%A8res%2016%2C%20Bulle%2C%201630%2C%20Switzerland"
    pageTitle="Du Cheval Blanc"
  />
);

export default DuChevalBlanc;
