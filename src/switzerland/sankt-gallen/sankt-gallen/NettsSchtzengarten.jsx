...
const NettsSchtzengarten = () => (
  <RestaurantPage
    restaurantName="Netts Schützengarten"
    address="Sankt Jakob Strasse 35, Sankt Gallen, 9000, Switzerland"
    cuisine="International, Country cooking"
    priceRange="€€"
    phoneNumber="+41712426677"
    website="https://www.netts.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the Schützengarten Brewery building, this trendy restaurant is popular, not least among the locals! The decor here is lovely – rather rustic at the front, more elegant in the area to the rear. The terrace and beer garden are delightfully secluded – the brewing happens next door, so you're often greeted by pleasant malty aroma. Along with Swiss classics such as Züricher Geschnetzeltes (sliced veal served in a cream and mushroom sauce) or beef Stroganoff, the menu includes Asian-inspired dishes and vegetarian options. Tip: In the courtyard, the brewery has a small bottle museum – well worth a short detour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sankt%20Jakob%20Strasse%2035%2C%20Sankt%20Gallen%2C%209000%2C%20Switzerland"
    pageTitle="Netts Schützengarten"
  />
);

export default NettsSchtzengarten;
