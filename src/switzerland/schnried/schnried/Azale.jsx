...
const Azale = () => (
  <RestaurantPage
    restaurantName="Azalée"
    address="Dorfstrasse 14, Schönried, 3778, Switzerland"
    cuisine="Classic French"
    priceRange="€€€"
    phoneNumber="+41337489191"
    website="https://hotelalpenrose.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Von Siebenthal family welcomes you with dedication and genuine hospitality – both at the stylish Boutique-Hotel Alpenrose and in the restaurant. In an elegant traditional setting, diners tuck into classic cuisine with a contemporary twist. You can choose between a vegetarian or a conventional tasting menu, with the option to order individual dishes à la carte – such as porcini ravioli with Alpine cheese, shallots and sun-dried tomatoes, or perch fillet in rice paper with green asparagus, verjuice, sorrel and gnocchi. In summer, a pared-down version of the menu from Sammy's Grill Restaurant & Bar, which is only open in winter, is also available. Exceptionally warm service is provided by the proprietress and her daughter. Stunning terrace overlooking the mountains!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstrasse%2014%2C%20Sch%C3%B6nried%2C%203778%2C%20Switzerland"
    pageTitle="Azalée"
  />
);

export default Azale;
