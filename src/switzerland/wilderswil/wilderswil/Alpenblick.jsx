...
const Alpenblick = () => (
  <RestaurantPage
    restaurantName="Alpenblick"
    address="Oberdorfstrasse 3, Wilderswil, 3812, Switzerland"
    cuisine="Contemporary, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+41338283550"
    website="https://www.hotel-alpenblick.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This quintessential Swiss inn makes for a seriously appealing culinary experience. It is all down to Richard and Yvonne Stöckli, who have been putting their heart and soul into this long-standing establishment since 1980. Friendly and efficient, she heads up the service team in the charming little dining room (judicious wine recommendations from a great selection), while he showcases his skills in the kitchen, conjuring up dishes distinguished by their craftsmanship, quality ingredients and punchy flavours. His interesting modern and seasonal set menu comprises four to seven courses. Delightful garden terrace – ask for one of the seats beneath the old plane tree. Tip: Cheese lovers should try the Nessleren Alpine cheese! The rustic bistro and pretty guestrooms complete this charming pictur..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oberdorfstrasse%203%2C%20Wilderswil%2C%203812%2C%20Switzerland"
    pageTitle="Alpenblick"
  />
);

export default Alpenblick;
