...
const NationalDaSergio = () => (
  <RestaurantPage
    restaurantName="National da Sergio"
    address="Klosterplatz 17, Olten, 4600, Switzerland"
    cuisine="Italian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+41622962277"
    website="https://www.nationalolten.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant and down-to-earth restaurant in the historic old town, right next to Klosterplatz square. The former “Felsenburg” team offers classic Italian cuisine made from top-quality ingredients, including dishes such as Spaghetti Scampi and the classic Piccata Milanese. As you’d expect, Italian wines feature on the wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Klosterplatz%2017%2C%20Olten%2C%204600%2C%20Switzerland"
    pageTitle="National da Sergio"
  />
);

export default NationalDaSergio;
