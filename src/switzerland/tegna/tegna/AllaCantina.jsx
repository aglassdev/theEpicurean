...
const AllaCantina = () => (
  <RestaurantPage
    restaurantName="Alla Cantina"
    address="Piazza Gottardo Zurini 1, Tegna, 6652, Switzerland"
    cuisine="Sicilian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+41917807070"
    website="https://www.ristoranteallacantina.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although all the staff at this beautiful historic restaurant on the village square hail from Sicily, they have been working in Switzerland for years. Here, authentic Sicilian cuisine is served in a rustic and welcoming setting that also provides the backdrop for regular music events: the only concessions to Ticino are the polenta-based dishes. Our inspector particularly recommends the sarde in “Beccafico”(stuffed sardine roulade with breadcrumbs, sultanas, pine nuts and orange peel). There’s also a pleasantly cool and tranquil outdoor space for summer dining, plus four attractive and inviting guestrooms on the top floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Piazza%20Gottardo%20Zurini%201%2C%20Tegna%2C%206652%2C%20Switzerland"
    pageTitle="Alla Cantina"
  />
);

export default AllaCantina;
