...
const TaverneZumSchfli = () => (
  <RestaurantPage
    restaurantName="Taverne zum Schäfli"
    address="Oberdorfstrasse 8, Wigoltingen, 8556, Switzerland"
    cuisine="Creative, Farm to table"
    priceRange="€€€€"
    phoneNumber="+41527631172"
    website="https://schaefli-wigoltingen.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A true culinary beacon in the region, this 300-year-old half-timbered house is wonderfully inviting from the outside. Chef-patron Christian Kuchler is a master of classic cuisine, but he also incorporates carefully balanced creative touches and Asian influences. All the dishes have one thing in common: the finest ingredients, which are showcased through precise technique, their natural flavours allowed to shine without relying on unnecessary flourishes. For example, the perfectly pan-seared hand-dived scallop with its lovely roasted notes harmonises beautifully with the creamy vin jaune foam, delicate little artichoke hearts, butter-soft mussels and lightly sautéed spinach. The set menu and à la carte dishes are equally enticing. The tastefully furnished and cosy lounges offer comfortable ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oberdorfstrasse%208%2C%20Wigoltingen%2C%208556%2C%20Switzerland"
    pageTitle="Taverne zum Schäfli"
  />
);

export default TaverneZumSchfli;
