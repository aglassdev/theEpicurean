...
const WiesnerMysterionWiesnerZauber = () => (
  <RestaurantPage
    restaurantName="Wiesner Mysterion - Wiesner - Zauber"
    ...
    pageTitle="Wiesner Mysterion - Wiesner - Zauber"
  />
);

export default WiesnerMysterionWiesnerZauber;
