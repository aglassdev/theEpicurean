...
const WiesnerMysterionWerkstattKost = () => (
  <RestaurantPage
    restaurantName="Wiesner Mysterion – Werkstatt Kost"
    address="Bramboden 6, Romoos, 6167, Switzerland"
    cuisine="Farm to table, Barbecue"
    priceRange="€€"
    phoneNumber="+41414861241"
    website="https://www.wiesner-mysterion.ch/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Anyone heading to see the Wizard of Entlebuch in Bramboden should be prepared for something special. Like Wiesner – Zauber, Werkstatt – Kost is housed in the Weitsicht hotel. The location is simply magnificent; the terrace is idyllic, boasting one of the loveliest views in the whole region. Stefan Wiesner brings his nature-inspired culinary philosophy to the plate. For his four-course set menu, he sources ingredients from nearby woods and meadows, as well as the on-site garden – and prepares them using fire, embers and smoke. Tip: It's well worth spending the night. That way, you will have the opportunity to go rambling through the breathtaking scenery and to cook your own dinner over an open fire. In the morning, the chef leads a short guided foraging walk for wild herbs, during which som..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bramboden%206%2C%20Romoos%2C%206167%2C%20Switzerland"
    pageTitle="Wiesner Mysterion – Werkstatt Kost"
  />
);

export default WiesnerMysterionWerkstattKost;
