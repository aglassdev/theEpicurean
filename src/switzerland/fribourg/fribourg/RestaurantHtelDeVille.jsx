...
const RestaurantHtelDeVille = () => (
  <RestaurantPage
    restaurantName="Restaurant Hôtel de Ville"
    address="Grand-Rue 6, Fribourg, 1700, Switzerland"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+41263212367"
    website="https://www.restaurant-hotel-de-ville.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a vibrant and upbeat atmosphere is run by a chef who is brimming with energy. He regales diners with delicious and indulgent cuisine that draws on local produce. Daily lunchtime menu inspired by local market fare; fine dining tasting menu in the evening. The opulent interior (a former apartment) is decorated with numerous works of art: paintings, photos, sculptures etc...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand-Rue%206%2C%20Fribourg%2C%201700%2C%20Switzerland"
    pageTitle="Restaurant Hôtel de Ville"
  />
);

export default RestaurantHtelDeVille;
