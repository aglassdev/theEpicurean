...
const LeProlles = () => (
  <RestaurantPage
    restaurantName="Le Pérolles"
    address="Boulevard de Pérolles 1, Fribourg, 1700, Switzerland"
    cuisine="Classic French, Contemporary"
    priceRange="€€€€"
    phoneNumber="+41263474030"
    website="https://www.leperolles.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Pierrot Ayer, who is the darling of the residents of Fribourg, he rolls out his manifold talents in this swish, designer venue. Done up in a snazzy futuristic vein, Le Pérolles, which is in the basement, provides the perfect foil for delicate, well-curated dishes, whose expressive generosity reflects the chef’s personality, particularly in his inspired new takes on Gallic classics: lamb, wild thyme, chard and pimiento. At lunchtime, there is a more accessible 3- or 4-course menu and, in the evenings, there is also a vegetarian version. Splendid cheese trolley. For a “simpler” experience, head for the ground-floor bistro-cum-grocery store, le Petit Pérolles, open from 9.30am, and dig into fresh regional produce in a more casual vibe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boulevard%20de%20P%C3%A9rolles%201%2C%20Fribourg%2C%201700%2C%20Switzerland"
    pageTitle="Le Pérolles"
  />
);

export default LeProlles;
