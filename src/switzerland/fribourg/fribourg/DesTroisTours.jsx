...
const DesTroisTours = () => (
  <RestaurantPage
    restaurantName="Des Trois Tours"
    address="Route de Bourguillon 15, Fribourg, 1722, Switzerland"
    cuisine="French Contemporary, Innovative"
    priceRange="€€€€"
    phoneNumber="+41263223069"
    website="https://www.trois-tours.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In this 19C patrician house near the centre of Fribourg, diners can savour a harmonious set menu comprising five to seven courses. Stripped back to home in on the essentials, the dishes are also pleasing to the eye. The food is served in a stylish, refined and modern atmosphere, and the service is professional. The interesting wine list focuses on Switzerland and France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Bourguillon%2015%2C%20Fribourg%2C%201722%2C%20Switzerland"
    pageTitle="Des Trois Tours"
  />
);

export default DesTroisTours;
