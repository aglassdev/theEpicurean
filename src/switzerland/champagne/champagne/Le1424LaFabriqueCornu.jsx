...
const Le1424LaFabriqueCornu = () => (
  <RestaurantPage
    restaurantName="Le 1424, La Fabrique Cornu"
    address="Chemin de Praz 2, Champagne, 1424, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+41244361227"
    website="https://www.lafabriquecornu.ch/fr/restaurant-le-1424"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Fabrique has many strings to its bow: it is a biscuit-maker, an interactive museum and, on the third floor, it houses this chic, contemporary restaurant with a panoramic view of the Vaud Alps. The ambitious and tasty dishes are made with a wide range of regional and national ingredients and given an international spin. Good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20de%20Praz%202%2C%20Champagne%2C%201424%2C%20Switzerland"
    pageTitle="Le 1424, La Fabrique Cornu"
  />
);

export default Le1424LaFabriqueCornu;
