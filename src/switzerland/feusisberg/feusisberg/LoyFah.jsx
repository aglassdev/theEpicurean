...
const LoyFah = () => (
  <RestaurantPage
    restaurantName="Loy Fah"
    address="Schönfelsstrasse 3, Feusisberg, 8835, Switzerland"
    cuisine="Thai contemporary"
    priceRange="€€€"
    phoneNumber="+41447860000"
    website="https://www.panoramaresort.ch/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chic restaurant on the fourth floor of the tasteful Panorama Resort & Spa boasts a stunning panoramic view over Lake Zurich. Inside, you are served by an extremely friendly and attentive team. The food is a modern take on authentic Thai cuisine, which is also adapted to European palates in terms of spiciness. You can put together your own menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sch%C3%B6nfelsstrasse%203%2C%20Feusisberg%2C%208835%2C%20Switzerland"
    pageTitle="Loy Fah"
  />
);

export default LoyFah;
