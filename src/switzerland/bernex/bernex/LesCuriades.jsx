...
const LesCuriades = () => (
  <RestaurantPage
    restaurantName="Les Curiades"
    address="Vieux-Lully 10, Bernex, 1233, Switzerland"
    cuisine="Regional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+41227574040"
    website="https://www.restaurantlescuriades.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A truly historic restaurant which has been serving food since 1850. The present chef has experience in some of the finest restaurants, and it shows! His cuisine is elegant and refined, including dishes such as chuck beef braised in beer (paying tribute to the chef’s Belgian origins) and a delicious vegetarian menu which is always available. An unqualified success!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vieux-Lully%2010%2C%20Bernex%2C%201233%2C%20Switzerland"
    pageTitle="Les Curiades"
  />
);

export default LesCuriades;
