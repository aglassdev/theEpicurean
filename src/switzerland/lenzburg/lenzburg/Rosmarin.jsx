...
const Rosmarin = () => (
  <RestaurantPage
    restaurantName="Rosmarin"
    address="Eisengasse 32, Lenzburg, 5600, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41793533252"
    website="https://restaurant-rosmarin.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following its relocation within Lenzburg, Rosmarin entices diners with a cool concept: The modern setting allows for up to 12 guests to sit at a counter right by the open kitchen, where chef-patron Philipp Audolensky prepares a creative surprise menu comprising five to seven courses (vegetarian or vegan options are available by prior arrangement). Appetisers and pastries are prepared by Céline Huber. The tartare of premium Bremgarten salmon trout, enhanced with finely chopped kimchi for juiciness and a gentle spicy kick, and finished with a delicate, intensely aromatic chive mayonnaise, is a fine example of how the bold flavours of exceptional ingredients are put centre stage. The restaurant celebrates the region and is committed to sustainability. The chef himself serves the food and reco..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Eisengasse%2032%2C%20Lenzburg%2C%205600%2C%20Switzerland"
    pageTitle="Rosmarin"
  />
);

export default Rosmarin;
