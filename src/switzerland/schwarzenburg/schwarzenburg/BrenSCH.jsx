...
const BrenSCH = () => (
  <RestaurantPage
    ...
    address="Dorfplatz 4, Schwarzenburg, 3150, Switzerland"
    cuisine="Regional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+41317310342"
    website="https://baeren-schwarzenburg.ch/"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfplatz%204%2C%20Schwarzenburg%2C%203150%2C%20Switzerland"
    pageTitle="Bären"
  />
);

export default BrenSCH;
