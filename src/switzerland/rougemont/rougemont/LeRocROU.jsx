...
const LeRocROU = () => (
  <RestaurantPage
    ...
    address="Chemin des Palettes 14, Rougemont, 1659, Switzerland"
    cuisine="Swiss, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+41269210101"
    website="https://www.hotelderougemont.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20des%20Palettes%2014%2C%20Rougemont%2C%201659%2C%20Switzerland"
    pageTitle="Le Roc"
  />
);

export default LeRocROU;
