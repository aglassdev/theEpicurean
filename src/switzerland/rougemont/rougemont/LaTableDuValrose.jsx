...
const LaTableDuValrose = () => (
  <RestaurantPage
    restaurantName="La Table du Valrose"
    ...
    pageTitle="La Table du Valrose"
  />
);

export default LaTableDuValrose;
