...
const MomentBER = () => (
  <RestaurantPage
    ...
    address="Postgasse 49, Berne, 3011, Switzerland"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+41313321020"
    website="https://moment-bern.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the historical heart of Bern, this trendy, modern restaurant spread over two floors serves creative cuisine with a focus on regional and seasonal produce. The Carte Blanche menu offers a choice of two four- to five course set menus, – one completely plant based. A laid-back front-of-house team takes care of the service. There are entrances on both Postgasse and Gerechtigkeitsgasse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Postgasse%2049%2C%20Berne%2C%203011%2C%20Switzerland"
    pageTitle="moment"
  />
);

export default MomentBER;
