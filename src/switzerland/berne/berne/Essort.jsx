...
const Essort = () => (
  <RestaurantPage
    restaurantName="Essort"
    address="Jubiläumstrasse 97, Berne, 3005, Switzerland"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+41313681111"
    website="https://www.essort.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the attractive Kirchenfeld district, this restaurant housed in what was once the US embassy has an inviting atmosphere – the modern interior design features a harmonious combination of clean lines, warm wood finishings and muted tones, complemented by an open kitchen. The terrace to the rear of the building beckons in summer. The commitment of the owners, Sara and Benjamin Jann is palpable – both when it comes to the charming and attentive service from a team who go out of their way to cater to guests' every need, and the delicious food. The latter includes tender Bäggli ragout made from Aaretal Duroc pork with a delicate potato foam, aromatic chive oil and crunchy potato brunoise. In addition to the seasonal six-course set menu in the evening, there is a small lunch menu or a business ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jubil%C3%A4umstrasse%2097%2C%20Berne%2C%203005%2C%20Switzerland"
    pageTitle="Essort"
  />
);

export default Essort;
