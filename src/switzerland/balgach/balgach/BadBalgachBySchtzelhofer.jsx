...
const BadBalgachBySchtzelhofer = () => (
  <RestaurantPage
    restaurantName="Bad Balgach by Schützelhofer"
    address="Hauptstrasse 73, Balgach, 9435, Switzerland"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+41715995959"
    website="https://www.bad-balgach.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="An absolute must for lovers of classic cuisine! Bernd Schützelhofer works only with the best the market has to offer, using these ingredients as the foundation of his expressive, clearly structured dishes. His no-frills, down-to-earth cooking is focused entirely on the flavours, for example: the finely seasoned wild scallops are perfectly fried and translucent, with a beautiful roasted flavour, and served with slightly al dente risotto with a subtle hint of Champagne, as well as crunchy white asparagus slices, tender, sweet peas and shavings of artichoke bottoms. Jackie Pedregal, Bernd Schützelhofer's charming partner, is also part of the team, heading up the attentive and skilful front-of-house team. The ambience in this smart, historical establishment is chic with a modern, elegant touch..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstrasse%2073%2C%20Balgach%2C%209435%2C%20Switzerland"
    pageTitle="Bad Balgach by Schützelhofer"
  />
);

export default BadBalgachBySchtzelhofer;
