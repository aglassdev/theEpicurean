...
const TredecimByMonikaJansUndThomasHuber = () => (
  <RestaurantPage
    restaurantName="Tredecim by Monika Jans und Thomas Huber"
    address="Sihlbrugg 4, Sihlbrugg, 8816, Switzerland"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+41447298333"
    website="https://www.krone-sihlbrugg.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thomas Huber (the 13th generation) and Monika Jans are dedicated to their work in the Krone, an establishment steeped in history. While she is responsible for the cordial and professional service, he takes care of things in the kitchen, preparing seasonal, traditional dishes. They will also prepare a creatively inspired set menu if you order in advance. The cheese trolley selection is fantastic! The wood-panelled interior exudes charm and contributes to the delightful atmosphere. Should you wish to stay overnight, there are attractive individually decorated guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sihlbrugg%204%2C%20Sihlbrugg%2C%208816%2C%20Switzerland"
    pageTitle="Tredecim by Monika Jans und Thomas Huber"
  />
);

export default TredecimByMonikaJansUndThomasHuber;
