...
const OneSixArtbarrestaurant = () => (
  <RestaurantPage
    restaurantName="16 ART-BAR-RESTAURANT"
    address="Mittelgässli 16, Saanen, 3792, Switzerland"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+41337481616"
    website="https://www.16eme.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners will feel right at home in this charming and inviting restaurant. Set in a former bell foundry, the atmosphere is welcoming and delightfully down to earth. The blend of rustic and modern styles is interesting, and the art on the walls is sure to draw the eye. You can look forward to very friendly and attentive service, as well as pared-down and exceedingly flavourful dishes prepared by owner Nik Buchs. Popular choices here include true classics such as entrecôte or veal cutlet. The extensive wine list also includes organic and biodynamic wines. In summer, the terrace is a wonderful place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mittelg%C3%A4ssli%2016%2C%20Saanen%2C%203792%2C%20Switzerland"
    pageTitle="16 ART-BAR-RESTAURANT"
  />
);

export default OneSixArtbarrestaurant;
