...
const ZermattKitchen = () => (
  <RestaurantPage
    restaurantName="Zermatt Kitchen"
    address="Uferweg 1, Zermatt, 3920, Switzerland"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+41766414644"
    website="https://www.zermattkitchen.ch/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Uferweg%201%2C%20Zermatt%2C%203920%2C%20Switzerland"
    pageTitle="Zermatt Kitchen"
  />
);

export default ZermattKitchen;
