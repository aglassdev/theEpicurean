...
const ZumSee = () => (
  <RestaurantPage
    restaurantName="Zum See"
    address="Zum See 24, Zermatt, 3920, Switzerland"
    cuisine="Swiss, International"
    priceRange="€"
    phoneNumber="+41279672045"
    website="https://www.zumsee.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant walk in the mountains leads to this charming restaurant with a romantic terrace. Simple, good cuisine is served...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zum%20See%2024%2C%20Zermatt%2C%203920%2C%20Switzerland"
    pageTitle="Zum See"
  />
);

export default ZumSee;
