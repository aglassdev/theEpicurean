...
const LusiBrasserie = () => (
  <RestaurantPage
    restaurantName="Lusi Brasserie"
    address="Bahnhofstrasse 55, Zermatt, 3920, Switzerland"
    cuisine="French, International"
    priceRange="€€"
    phoneNumber="+41279666600"
    website="https://www.zermatterhof.ch/restaurants-and-bars/lusi-brasserie-and-lounge/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A tip before we get started: In fine weather, be sure to nab a table on the terrace in front of the building, from which you can take in stunning views of the Matterhorn! But the brasserie of the long-established Grand Hotel Zermatterhof also provides a delightful, classically elegant setting with its lovely walnut panelling and partially glass-paned vaulted ceiling. The cuisine is French and draws on international influences. The menu includes Lusi Classics such as calf's head, and traditional dishes such as Wiener schnitzel, steak tartare, burgers and flammkuchen – and there is always an evening special...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofstrasse%2055%2C%20Zermatt%2C%203920%2C%20Switzerland"
    pageTitle="Lusi Brasserie"
  />
);

export default LusiBrasserie;
