...
const ChezVrony = () => (
  <RestaurantPage
    restaurantName="Chez Vrony"
    address="Findeln, Zermatt, 3920, Switzerland"
    cuisine="Regional Cuisine, Swiss"
    priceRange="€€"
    phoneNumber="+41279672552"
    website="https://chezvrony.ch/wordpress/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This chalet perched at 2 100m above sea level right by a ski slope boasts an incredible view of the Matterhorn – unsurprisingly, tables on the terrace are in great demand! Inside, the abundance of wood and attractive decor spread a rustic warmth, and the service team is attentive and charming. The traditional cuisine has a regional twist, and features delicious creations such as mountain goat cheese ravioli with thyme and nut butter, caramelised Valais pear and dried pear purée, or Vrony's organic platter” of dried meats, Alpine cheese and house-made sausage. The restaurant can be reached on foot in around 20min from Sunnegga funicular station, passing through the picturesque little village of Findeln...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Findeln%2C%20Zermatt%2C%203920%2C%20Switzerland"
    pageTitle="Chez Vrony"
  />
);

export default ChezVrony;
