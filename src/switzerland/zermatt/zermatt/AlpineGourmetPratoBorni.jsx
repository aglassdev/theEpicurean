...
const AlpineGourmetPratoBorni = () => (
  <RestaurantPage
    ...
    pageTitle="Alpine Gourmet Prato Borni"
  />
);

export default AlpineGourmetPratoBorni;
