...
const PotatofineFoodRestaurant = () => (
  <RestaurantPage
    restaurantName="Potato-FINE FOOD RESTAURANT"
    address="Bahnhofstrasse 10, Zermatt, 3920, Switzerland"
    cuisine="Modern Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+41279665150"
    website="https://www.potatozermatt.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the evenings, this delightful little restaurant in a lively street (Bahnhofstrasse) promises warm hospitality in a down-to-earth and friendly atmosphere. Flavoursome modern dishes are served in a set menu format – choose between a three- and five-course version, with pescetarian alternatives available in both cases. The top-notch ingredients are locally sourced. The wine list exclusively features Valais labels, and the selection is impressive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofstrasse%2010%2C%20Zermatt%2C%203920%2C%20Switzerland"
    pageTitle="Potato-FINE FOOD RESTAURANT"
  />
);

export default PotatofineFoodRestaurant;
