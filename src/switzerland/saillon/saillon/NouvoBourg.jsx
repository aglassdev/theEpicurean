...
const NouvoBourg = () => (
  <RestaurantPage
    restaurantName="Nouvo Bourg"
    address="Rue du Bourg 25, Saillon, 1913, Switzerland"
    cuisine="French Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+41277441430"
    website="https://www.nouvobourg.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the historical village of Saillon, this laid-back little restaurant oozes modern bistro charm. It also boasts a very pleasant terrace. They serve three ambitious set menus (including a vegetarian one) based on the French classics and accented with modern and creative details. At lunchtime they also serve a short business menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Bourg%2025%2C%20Saillon%2C%201913%2C%20Switzerland"
    pageTitle="Nouvo Bourg"
  />
);

export default NouvoBourg;
