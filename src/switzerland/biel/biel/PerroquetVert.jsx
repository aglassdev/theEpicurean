...
const PerroquetVert = () => (
  <RestaurantPage
    restaurantName="Perroquet Vert"
    address="Zentralstrasse 15, Biel, 2502, Switzerland"
    cuisine="French, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41323222555"
    website="https://www.perroquetvert.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This intimate, lively restaurant on the Place de la Fontaine exudes the Belle Epoque charm of the Parisian brasseries of old. A feel that chimes perfectly with the traditional, French dishes chalked up on the blackboard. Favourites include scallop risotto, entrecôte and tarte tatin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zentralstrasse%2015%2C%20Biel%2C%202502%2C%20Switzerland"
    pageTitle="Perroquet Vert"
  />
);

export default PerroquetVert;
