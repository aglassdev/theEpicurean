...
const MulaniaBrasserie = () => (
  <RestaurantPage
    restaurantName="Mulania Brasserie"
    address="Via Murschetg 15, Laax, 7031, Switzerland"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+41819279191"
    website="https://mulania.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its combination of sleek, contemporary style and rustic ceiling beams, this old Graubünden building provides an attractive setting. Host couple Yvonne Marx and Sascha Meyer have reimagined their place as a brasserie, serving tried-and-tested regional specialities such as capuns (chard rolls) or quark pizokels (buckwheat spaetzle), plus brasserie classics like moules frites or beef bourguignon. Last but not least, there are some delicious seafood options – the chef's first love. Delightful terrace. Open from 3pm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Murschetg%2015%2C%20Laax%2C%207031%2C%20Switzerland"
    pageTitle="Mulania Brasserie"
  />
);

export default MulaniaBrasserie;
