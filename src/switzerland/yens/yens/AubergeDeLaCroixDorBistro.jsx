...
const AubergeDeLaCroixDorBistro = () => (
  <RestaurantPage
    restaurantName="Auberge de la Croix d'Or - Bistro"
    address="Grande-Rue 18, Yens, 1169, Switzerland"
    cuisine="Traditional Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+41218003108"
    website="https://auberge-communale-yens.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Claudia and Olivier Hiernard have combined bistro and restaurant at their charming inn. The delicious bistro fare on the blackboard is now complemented by a market-inspired Menu du Marché, meaning flavoursome dishes are now served in both parts of the establishment. Just don't forget to leave room for dessert! On Friday and Saturday evenings, only a small selection is available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grande-Rue%2018%2C%20Yens%2C%201169%2C%20Switzerland"
    pageTitle="Auberge de la Croix d'Or - Bistro"
  />
);

export default AubergeDeLaCroixDorBistro;
