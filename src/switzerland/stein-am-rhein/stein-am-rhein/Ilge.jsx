...
const Ilge = () => (
  <RestaurantPage
    restaurantName="Ilge"
    address="Rathausplatz 14, Stein am Rhein, 8260, Switzerland"
    cuisine="Classic Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+41527412272"
    website="https://ilgesteinamrhein.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the heart of the historical little town with its picturesque painted façades, this restaurant is housed in an old half-timbered building. The interior design is chic and tasteful, and in fine weather there is a lovely terrace overlooking the pedestrian zone. Serbian-born Zoran Baratovic presides in the kitchen, turning out dishes that draw on classical and Mediterranean influences. We highly recommend the mouthwatering veal shank ravioli. And to accompany your meal, the attentive maître d', who is always on hand, will provide you with a well-curated wine list. Feel free to enquire about magnums of red wine – there are a few stored in the cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rathausplatz%2014%2C%20Stein%20am%20Rhein%2C%208260%2C%20Switzerland"
    pageTitle="Ilge"
  />
);
