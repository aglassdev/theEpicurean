...
const EmotionsByGuyRavet = () => (
  <RestaurantPage
    restaurantName="EMOTIONS by Guy Ravet"
    address="Rue d'Italie 1, Vevey, 1800, Switzerland"
    cuisine="Classic French"
    priceRange="€€€€"
    phoneNumber="+41219250606"
    website="https://www.ghdl.ch/gastronomie/emotions-par-guy-ravet/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The classic elegance of the Grand Hôtel du Lac, designed by architect Ernest Burnat, is the perfect setting for Chef Guy Ravet's ambitious cuisine. The finest ingredients are used with mastery and skill, as in the case of the fillet of wild turbot, seared, with cauliflower mousseline, red onion and mustard seed condiment and beurre blanc with chives...."
    ...
    pageTitle="EMOTIONS by Guy Ravet"
  />
);

export default EmotionsByGuyRavet;
