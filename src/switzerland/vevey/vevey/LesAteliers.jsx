...
const LesAteliers = () => (
  <RestaurantPage
    ...
    bio="After having been deserted for some 25 years, this former metal engineering workshop just behind the railway station has been revived by Jean-Sébastien Ribette and Sahondra Verdan. An off-kilter, smart industrial vibe sets the scene for a two-pronged culinary offer: brasserie fare on one side and a more ambitious menu in the gourmet section. Market availability dictates the score, hence the freshness of the ingredients, both at lunch and at dinner. Examples: tartare of red tuna in ginger and sake; confit of duck, shredded green beans and dressing; savarin of confit of lemon drizzled in limoncello. Friendly, on-the-ball service and excellent tips to try local wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20des%20Deux-Gares%206A%2C%20Vevey%2C%201800%2C%20Switzerland"
    pageTitle="Les Ateliers"
  />
);

export default LesAteliers;
