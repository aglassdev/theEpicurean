...
const AlBraciere = () => (
  <RestaurantPage
    restaurantName="Al Braciere"
    address="Via Livurcio 50, Ronco sopra Ascona, 6622, Switzerland"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+41917919396"
    website="https://www.hotel-elisabetta.ch/Ristorante_it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just above Ascona, about 1km from the town centre, this friendly hotel boasts panoramic views of Lake Maggiore, the surrounding mountains and the island of Brissago. Enjoy modern, carefully prepared cuisine in the comfortable dining room or on the idyllic outdoor terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Livurcio%2050%2C%20Ronco%20sopra%20Ascona%2C%206622%2C%20Switzerland"
    pageTitle="Al Braciere"
  />
);

export default AlBraciere;
