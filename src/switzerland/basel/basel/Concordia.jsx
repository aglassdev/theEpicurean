...
const Concordia = () => (
  <RestaurantPage
    restaurantName="Concordia"
    address="Haltingerstrasse 11, Basel, 4057, Switzerland"
    cuisine="Vegetarian, Creative"
    priceRange="€€€"
    phoneNumber=""
    website="https://restaurantconcordia.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A former pub has been transformed into a relaxed, urban restaurant serving entirely vegetarian cuisine in the form of a menu that is designed for sharing. In the evening, the Kleines Menü comprises 12 dishes in five courses and a Grosses Menü made up of 15 dishes organised into seven courses – ideal for sharing! Delicious dishes such as watermelon sashimi with kimchi broth, fermented radish, ponzu gel and black garlic mayonnaise mean that even non-vegetarians won't miss meat or fish. At lunchtime, choose between a simple, quick lunch, a slightly more sophisticated Business-Lunch and the small evening menu. The atmosphere is inviting: historical elements such as high ceilings and traditional wood panelling have been beautifully combined with modern interior details. Service is provided by a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Haltingerstrasse%2011%2C%20Basel%2C%204057%2C%20Switzerland"
    pageTitle="Concordia"
  />
);
