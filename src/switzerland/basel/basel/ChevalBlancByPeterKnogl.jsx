...
const ChevalBlancByPeterKnogl = () => (
  <RestaurantPage
    ...
    pageTitle="Cheval Blanc by Peter Knogl"
  />
);

export default ChevalBlancByPeterKnogl;
