...
const StuckiTanjaGrandits = () => (
  <RestaurantPage
    restaurantName="Stucki - Tanja Grandits"
    address="Bruderholzallee 42, Basel, 4059, Switzerland"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41613618222"
    website="https://www.tanjagrandits.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name Stucki is a tribute to Tanja Grandits's legendary predecessor, Hans Stucki. The chic ambience that prevails in this historical villa is matched by the stylish service. The charming, efficient and professional international front-of-house team is headed up by Grégory Rohmer, a maître d' with a passion for what he does – there is no stuffiness here. The highly trained sommeliers have an extensive wine cellar from which to draw recommendations. Tanja Grandits presents her inimitable culinary style, characterised by her penchant for subtly incorporating flowers, leaves and colours. By skilfully integrating Asian and Mediterranean influences, she lends her dishes a wonderful harmony and finesse. Her creations never tip into overkill; rather, crisply cooked, aromatic green beans with el..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bruderholzallee%2042%2C%20Basel%2C%204059%2C%20Switzerland"
    pageTitle="Stucki - Tanja Grandits"
  />
);

export default StuckiTanjaGrandits;
