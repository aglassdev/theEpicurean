...
const Eintracht = () => (
  <RestaurantPage
    restaurantName="Eintracht"
    address="Neue Strasse 6, Kestenholz, 4703, Switzerland"
    cuisine="International, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41623932463"
    website="https://www.eintrachtkestenholz.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this restaurant dating back to 1870, the dedicated Meier family have cultivated a sense of tradition while also introducing modern influences. This approach makes itself felt in the bistro and the more elegant restaurant area as well as in the cuisine – from classics such as veal cordon bleu to a gourmet set menu composed of three to five courses. Excellent wine selection. Simple daily specials are also available in the bistro...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Neue%20Strasse%206%2C%20Kestenholz%2C%204703%2C%20Switzerland"
    pageTitle="Eintracht"
  />
);

export default Eintracht;
