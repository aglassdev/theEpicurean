...
const BrasserieDuChteau = () => (
  <RestaurantPage
    restaurantName="Brasserie du Château"
    ...
    pageTitle="Brasserie du Château"
  />
);

export default BrasserieDuChteau;
