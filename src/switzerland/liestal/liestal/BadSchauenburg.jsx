...
const BadSchauenburg = () => (
  <RestaurantPage
    restaurantName="Bad Schauenburg"
    address="Schauenburgerstr. 76, Liestal, 4410, Switzerland"
    cuisine="Classic French"
    priceRange="€€€"
    phoneNumber="+41619062727"
    website="https://badschauenburg.ch/startseite"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you're seated in the Basler Stübli, the Gaststube or the Veranda, the fine dining restaurant of Hotel Bad Schauenburg serves classic French cuisine that takes its cue from the seasons in all its lovely rooms. Some of the produce comes from the hotel's own garden. The highlight in summer is of course the delightful terrace!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schauenburgerstr.%2076%2C%20Liestal%2C%204410%2C%20Switzerland"
    pageTitle="Bad Schauenburg"
  />
);

export default BadSchauenburg;
