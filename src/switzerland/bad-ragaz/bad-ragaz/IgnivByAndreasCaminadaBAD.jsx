...
const IgnivByAndreasCaminadaBAD = () => (
  <RestaurantPage
    restaurantName="IGNIV by Andreas Caminada"
    address="Bernhard-Simon-Strasse 2, Bad Ragaz, 7310, Switzerland"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+41813033021"
    website="https://igniv.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Temporarily closed due to renovation work in the hotel. Expected reopening in December 2026.This stylish restaurant in a historical vaulted room inside the Grand Resort Bad Ragaz showcases a concept that was devised by none other than celebrated chef Andreas Caminada: an elaborate, creative fine dining sharing experience. In keeping with the name (igniv is a Romansh word meaning nest), the focus is on the well-being of guests and the pleasure of communal dining. First-rate ingredients are used to create a very special set menu, each course of which is made up of several small dishes – all designed for sharing. Shored up by a competent sommelier, the charming service team is second to none. The outstanding wine list features top-notch wines, often regional, that are available by the glass. ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bernhard-Simon-Strasse%202%2C%20Bad%20Ragaz%2C%207310%2C%20Switzerland"
    pageTitle="IGNIV by Andreas Caminada"
  />
);

export default IgnivByAndreasCaminadaBAD;
