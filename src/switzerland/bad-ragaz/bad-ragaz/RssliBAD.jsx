...
const RssliBAD = () => (
  <RestaurantPage
    ...
    address="Freihofweg 3, Bad Ragaz, 7310, Switzerland"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+41813023232"
    website="https://roessliragaz.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Rössli is a pleasant restaurant decorated along clean, modern lines in warm colours. Enjoy the smart place settings and friendly service led by the lady of the house and Ueli Kellenberger’s flavoursome, contemporary cuisine. The mouthwatering offerings include open ravioli with spinach, egg, parmesan and beurre noisette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Freihofweg%203%2C%20Bad%20Ragaz%2C%207310%2C%20Switzerland"
    pageTitle="Rössli"
  />
);

export default RssliBAD;
