...
const MaisonWenger = () => (
  <RestaurantPage
    restaurantName="Maison Wenger"
    address="Rue de la Gare 2, Le Noirmont, 2340, Switzerland"
    cuisine="Modern French, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+41329576633"
    website="https://www.maisonwenger.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In his elegant, recently refurbished restaurant, chef Jérémy Desbraux consummately rolls out satisfying wholesome fare that is properly rugged. Rather than fussy or contrived, everything smacks of crisp, legible regional flavours to the delight of discerning foodies. For example, the appetisers and petits fours use Swiss rice and local honey and the bread is made entirely from flour ground by a local mill. Even the table arts are a nod to the region from a bell jar that pays tribute to Tête de moine cheese to a huge watch case bearing the restaurant’s logo in a nod to the local watchmaking tradition. The establishment is also proud of its eye-catching trolleys piled high with enticing aperitifs, after-dinner drinks and cheese, which are, of course, produced by artisans. A warm, professiona..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Gare%202%2C%20Le%20Noirmont%2C%202340%2C%20Switzerland"
    pageTitle="Maison Wenger"
  />
);

export default MaisonWenger;
