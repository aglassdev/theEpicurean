...
const LePatioGEN = () => (
  <RestaurantPage
    ...
    address="Boulevard Helvétique 19, Geneva, 1207, Switzerland"
    cuisine="Creative French, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41227366675"
    website="https://www.lepatio-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Philippe Chevrier (chef at the Domaine de Châteauvieux in Satigny) has opted for an original twin-pronged culinary concept here based around beef and lobster, alongside a selection of traditional French bistro dishes, such as pan-fried frogs’ legs with sweet garlic, and crispy snails with mushrooms. A highly enjoyable dining experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boulevard%20Helv%C3%A9tique%2019%2C%20Geneva%2C%201207%2C%20Switzerland"
    pageTitle="Le Patio"
  />
);

export default LePatioGEN;
