...
const LagapeGEN = () => (
  <RestaurantPage
    restaurantName="L'Agape"
    address="Rue Caroline 11, Geneva, 1227, Switzerland"
    cuisine="Seasonal Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+41223431298"
    website="https://www.lagape.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lovely old-school bistro ticks all the boxes when it comes to good vibes. It has been tastefully refurbished to showcase features such as its original tiling, wooden banquette seating, mirrors on the walls, a large chandelier fashioned out of old copper pans and a small service counter. As for the food, chef Clément Thellier has designed a short, savvy menu that makes your mouth water with its well-crafted and beautifully presented dishes: sweetbreads en barigoule, bacon crisps, split peas with bacon; beef tenderloin, toasted bread, pan-fried foie gras, mini vegetables and potato emulsion; poached and glazed pineapple, toasted pain d'épices and rum ice cream. A lovely dining experience at a reasonable price – not to be sniffed at in Geneva!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Caroline%2011%2C%20Geneva%2C%201227%2C%20Switzerland"
    pageTitle="L'Agape"
  />
);

export default LagapeGEN;
