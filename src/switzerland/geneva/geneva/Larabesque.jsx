...
const Larabesque = () => (
  <RestaurantPage
    restaurantName="L'Arabesque"
    address="Quai Wilson 47, Geneva, 1201, Switzerland"
    cuisine="Lebanese, Middle Eastern"
    priceRange="€€"
    phoneNumber="+41229066763"
    website="https://www.marriott.com/en-us/hotels/gvalc-hotel-president-wilson-a-luxury-collection-hotel-geneva/overview/?EM=DNM_HOTELPRESIDENTWILSON.COM"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Arabesque’s attractive decor of gold mosaics, white leather and black lacquerware conjures up pictures of the mysterious Orient, in particular Lebanon. It provides the perfect foil for a pedigree Mediterranean lineup, including hot and cold mezzes and Kibbeh Labanieh, the chef’s signature dish of meatballs, and Samak mechoui, grilled seabass with a sesame sauce. Excellent range of vegetarian dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quai%20Wilson%2047%2C%20Geneva%2C%201201%2C%20Switzerland"
    pageTitle="L'Arabesque"
  />
);

export default Larabesque;
