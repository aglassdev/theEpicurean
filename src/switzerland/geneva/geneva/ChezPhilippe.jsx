...
const ChezPhilippe = () => (
  <RestaurantPage
    restaurantName="Chez Philippe"
    address="Rue du Rhône 8, Geneva, 1204, Switzerland"
    cuisine="Meats and Grills, International"
    priceRange="€€"
    phoneNumber="+41223161616"
    website="https://www.chezphilippe.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Philippe Chevrier from the Domaine de Châteauvieux is the brains behind this huge restaurant inspired by New York-style steakhouses. Relaxed atmosphere, meats sourced from the renowned Boucherie du Molard, fish caught by small-scale fishermen, dishes cooked over a wood fire, a truly authentic cheesecake and an expansive wine list. A real favourite!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Rh%C3%B4ne%208%2C%20Geneva%2C%201204%2C%20Switzerland"
    pageTitle="Chez Philippe"
  />
);

export default ChezPhilippe;
