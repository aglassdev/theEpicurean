...
const BistrotDuBoeufRouge = () => (
  <RestaurantPage
    restaurantName="Bistrot du Boeuf Rouge"
    address="Rue Dr. Alfred-Vincent 17, Geneva, 1201, Switzerland"
    cuisine="Traditional Cuisine, Lyonnaise"
    priceRange="€€"
    phoneNumber="+41227327537"
    website="https://www.boeufrouge.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is well known in the local area for its simple yet gourmet Lyonnaise specialities: rosette sausage, hot saucisson, pike quenelles, etc. The Farina family's culinary skill is demonstrated on a daily basis, to a backdrop of attractive old-fashioned decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Dr.%20Alfred-Vincent%2017%2C%20Geneva%2C%201201%2C%20Switzerland"
    pageTitle="Bistrot du Boeuf Rouge"
  />
);

export default BistrotDuBoeufRouge;
