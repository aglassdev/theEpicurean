...
const BirdysByAchtienTheNest = () => (
  <RestaurantPage
    restaurantName="Birdy's by Achtien - The Nest"
    ...
    bio="A restaurant within a restaurant. In the middle of Birdy's by Achtien - Sharing Restaurant you will find The Nest. The setting is cheerful, with pleasing floral touches and enjoyable relaxing background music. Diners can also interact directly with the team at work in the open kitchen, which makes for a delightfully interactive atmosphere. Using regional ingredients, chef Christian Vogel creates a modern surprise menu with five courses that change according to the season. The Lostallo salmon owes its wonderful texture to a special cooking technique – truly intriguing. Equally tempting: the delicate, aromatic mountain thyme sorbet with a cucumber and mint granita, served as a refreshing pre-dessert. There is space for 12 guests at this gourmet food bar, and the set menu is served to all of ..."
    ...
    pageTitle="Birdy's by Achtien - The Nest"
  />
);

export default BirdysByAchtienTheNest;
