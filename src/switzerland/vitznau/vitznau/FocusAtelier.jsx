...
const FocusAtelier = () => (
  <RestaurantPage
    restaurantName="focus ATELIER"
    address="Seestrasse 18, Vitznau, 6354, Switzerland"
    cuisine="International, Creative French"
    priceRange="€€€€"
    phoneNumber="+41413996060"
    website="https://www.parkhotel-vitznau.ch"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Patrick Mahler and his team offer a unique culinary experience in the form of an exciting six- or nine-course set menu. Replete with intricate details, it blends classic, Japanese and Scandinavian elements. Amuse-bouches, such as shiitake dashi with a lovely hint of ginger, provide the perfect prelude. Hard to be beaten in terms of intensity and complexity of flavour is the combination of Miéral pigeon and truffle, accompanied by the wonderful depth of pigeon jus, as well as Albufera sauce and white cabbage foam. The signature dish of duck liver ice cream with beetroot and beef tartare also deserves a special mention. The quality of the ingredients is second to none. With over 35 000 bottles and complete vertical collections, the wine cellar is a treasure trove for wine connoisseurs. The s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestrasse%2018%2C%20Vitznau%2C%206354%2C%20Switzerland"
    pageTitle="focus ATELIER"
  />
);

export default FocusAtelier;
