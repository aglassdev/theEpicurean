...
const StivaGrischuna = () => (
  <RestaurantPage
    restaurantName="Stiva Grischuna"
    address="Via Cavardiras 3, Disentis, 7180, Switzerland"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41819475236"
    website="https://www.stivagrischuna.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this traditional Bündnerhaus dating back over 300 years, the wood-panelled rooms abound with charm, and the down-to-earth cooking looks to the region for inspiration. Whether traditional dishes such as capuns and maluns or classics such as Norbert's Stroganoff and cordon bleu – this is simply tasty fare! The prices are also very reasonable. It's best to book. Locals also dine here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Cavardiras%203%2C%20Disentis%2C%207180%2C%20Switzerland"
    pageTitle="Stiva Grischuna"
  />
);

export default StivaGrischuna;
