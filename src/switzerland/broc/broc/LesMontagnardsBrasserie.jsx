...
const LesMontagnardsBrasserie = () => (
  <RestaurantPage
    restaurantName="Les Montagnards - Brasserie"
    ...
    bio="Fine dining is not the only option! Hotel Les Montagnards offers a culinary experience that goes beyond its renowned restaurant Le Sommet. The Brasserie can hold its own! The attractive modern interior featuring warm wood and sleek design is as much of a draw as the friendly service and, last but not least, the good cuisine. Here, the focus is on the region and the changing seasons. One of the house specialities, for example, is stuffed morels with a cream sauce. The pike-perch, fished from local lakes, is another popular choice. Tip: Try to get a window seat, then you can take in the view of Gruyères Castle and the surrounding area while you eat!..."
    ...
    pageTitle="Les Montagnards - Brasserie"
  />
);

export default LesMontagnardsBrasserie;
