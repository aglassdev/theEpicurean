...
const OsteriaCyranoCiboEVino = () => (
  <RestaurantPage
    restaurantName="Osteria Cyrano Cibo e Vino"
    address="corso Enrico Pestalozzi 27, Lugano, 6900, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+41912254444"
    website="https://www.osteriacyrano.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy personalised cuisine full of flavour and prepared with excellent ingredients at this restaurant, which offers a simple menu at lunchtime and a wider choice of dishes in the evening. Delicious recipes and a good balance of meat and fish options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Enrico%20Pestalozzi%2027%2C%20Lugano%2C%206900%2C%20Switzerland"
    pageTitle="Osteria Cyrano Cibo e Vino"
  />
);

export default OsteriaCyranoCiboEVino;
