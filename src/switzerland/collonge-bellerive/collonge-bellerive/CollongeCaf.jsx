...
const CollongeCaf = () => (
  <RestaurantPage
    restaurantName="Collonge Café"
    address="Chemin du Château-de-Bellerive 3, Collonge-Bellerive, 1245, Switzerland"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+41227771245"
    website="https://www.collonge-cafe.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern restaurant boasts a great location next to the historical town hall and has a charming terrace laid out in the garden. The seasonally inspired menu successfully brings together modern Italian and French cuisine, while keeping an open mind when it comes to international influences. Cordial and competent service. Tip: the competitively priced lunch menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20du%20Ch%C3%A2teau-de-Bellerive%203%2C%20Collonge-Bellerive%2C%201245%2C%20Switzerland"
    pageTitle="Collonge Café"
  />
);

export default CollongeCaf;
