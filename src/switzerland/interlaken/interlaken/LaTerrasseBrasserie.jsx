...
const LaTerrasseBrasserie = () => (
  <RestaurantPage
    restaurantName="La Terrasse Brasserie"
    address="Höheweg 41, Interlaken, 3800, Switzerland"
    cuisine="Contemporary, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+41338282602"
    website="https://www.victoria-jungfrau.ch/restaurants-bars/la-terrasse-brasserie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Befitting the elegance that characterises the Victoria Jungfrau Grand Hotel & Spa, which is steeped in tradition, a classically refined atmosphere awaits you here. The location against the impressive backdrop of the mountains is a real draw in itself. In summer, make a beeline for the terrace on the promenade! The menu includes a broad assortment of Arab, Asian, Mediterranean and Swiss dishes – flavoursome food made from high-quality ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B6heweg%2041%2C%20Interlaken%2C%203800%2C%20Switzerland"
    pageTitle="La Terrasse Brasserie"
  />
);

export default LaTerrasseBrasserie;
