...
const SaporiINT = () => (
  <RestaurantPage
    restaurantName="Sapori"
    address="Höheweg 41, Interlaken, 3800, Switzerland"
    cuisine="Italian, Pizza"
    priceRange="€€"
    phoneNumber="+41338282602"
    website="https://www.victoria-jungfrau.ch/restaurants-bars/ristorante-e-pizzeria-sapori/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Worth a visit for its stylish historic interior alone, Sapori promises a wonderful parquet floor and an impressively high painted ceiling complete with stucco work. The Italian menu includes tasty stone-baked pizzas...."
