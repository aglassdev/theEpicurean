...
const LaCroixDorBAL = () => (
  <RestaurantPage
    restaurantName="La Croix d'Or"
    address="Place du Château 1, Ballaigues, 1338, Switzerland"
    cuisine="French, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+41215656970"
    website="https://lacroixdor.ch/en/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of the peaceful village of Ballaigues, near the French-Swiss border, this restaurant is housed in a magnificent edifice, dripping in history. At the helm are two virtuoso French chefs, David Sauvignet and Damien Lanza, who share a passion for good food. Their ambitious take on seasonal Gallic fare is delicate, strewn with subtle Mediterranean influences and crafted with outstanding, mostly local produce. Examples: Mieral pigeon, crispy potato pavé, confit of shallots and green peas; fillets of John Dory, sorrel-laced concentrate of tomato, fried artichokes. Meals are served in a swish interior or on the inviting terrace by a professional yet unstarched front-of-house team. Elegant rooms for overnight stays and a bargain-priced lunchtime menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Ch%C3%A2teau%201%2C%20Ballaigues%2C%201338%2C%20Switzerland"
    pageTitle="La Croix d'Or"
  />
);

export default LaCroixDorBAL;
