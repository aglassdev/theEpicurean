...
const SonneWEN = () => (
  <RestaurantPage
    restaurantName="Sonne"
    address="Scheunenberg 70, Wengi bei Büren, 3251, Switzerland"
    cuisine="Contemporary, International"
    priceRange="€€€€"
    phoneNumber="+41323891545"
    website="https://www.sonne-scheunenberg.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="What a wonderful, endearing place! This charming 19C farmhouse is a true idyll that is perfectly at home in this rural village location – it's well worth the trip out here! The cosy interior and pergola simply make you feel right at home: comfortable, yet stylish and elegant, lovingly decorated with attention to detail. The absolute highlight in summer is the fantastic terrace surrounded by old trees and a view of the countryside! Kurt Mösching's kitchen delivers modernised classics – these are dishes that are sophisticated in terms of flavours and technique and revolve around the excellent ingredients that go into them. Diners can opt for a six- or seven-course seasonal set menu or dishes à la carte. There is also a set menu at lunchtime. Iris Mösching is an ever-present and extremely cha..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Scheunenberg%2070%2C%20Wengi%20bei%20B%C3%BCren%2C%203251%2C%20Switzerland"
    pageTitle="Sonne"
  />
);

export default SonneWEN;
