...
const SonnenbergLeSoir = () => (
  <RestaurantPage
    restaurantName="Sonnenberg le soir"
    address="Zumhofstrasse 258, Kriens, 6010, Switzerland"
    cuisine="French, International"
    priceRange="€€€"
    phoneNumber="+41413206644"
    website="https://sonnenberg.ch/restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="As well as the prospect of the magnificent view of Rigi, Pilatus, Lake Lucerne and Bürgenstock, here you can look forward to Luca Haase's creative set menu, served in the evening. The chef, who previously worked under Peter Knogl at Basel's Trois Rois, cooks up modern French cuisine with Japanese and Mediterranean influences, using excellent ingredients. Choose between the omnivore version of the set menu (Land and Water) and the vegetarian Field and Garden, each comprising three to five courses. Charming and expert service is provided by a front-of-house team headed up by restaurant manager Jessica Meylan. Given the magnificent location, the panoramic terrace is of course the place to be – but floor-to-ceiling windows mean that you can also enjoy the view from inside. The restaurant is pa..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zumhofstrasse%20258%2C%20Kriens%2C%206010%2C%20Switzerland"
    pageTitle="Sonnenberg le soir"
  />
);

export default SonnenbergLeSoir;
