...
const CafDePeney = () => (
  <RestaurantPage
    restaurantName="Café de Peney"
    address="Route d'Aïre-La-Ville 130, Satigny, 1242, Switzerland"
    cuisine="French, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+41227531755"
    website="https://www.cafe-de-peney.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on an arm of the River Rhône, this popular, bustling eatery, decked out in a profusion of nostalgic paraphernalia, calls to mind a vintage picture postcard and also boasts a wisteria-covered terrace. Fine ingredients are consummately and delicately crafted into delicious dishes, examples of which are the flawlessly cooked Black Angus steak or raspberry tartlet with a refreshing raspberry sorbet...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20d'A%C3%AFre-La-Ville%20130%2C%20Satigny%2C%201242%2C%20Switzerland"
    pageTitle="Café de Peney"
  />
);

export default CafDePeney;
