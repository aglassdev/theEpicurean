...
const ObererMnchhof = () => (
  <RestaurantPage
    restaurantName="Oberer Mönchhof"
    address="Alte Landstrasse 98, Kilchberg, 8802, Switzerland"
    cuisine="Farm to table, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+41447154006"
    website="https://www.moenchhof.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dining rooms in this lovely, centuries-old half-timbered building are tastefully and comfortably furnished. Outside a fabulous terrace is laid out under chestnut trees overlooking the lake. The cuisine is seasonal, traditional and international with an additional tasting menu on offer at lunchtime and in the evenings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alte%20Landstrasse%2098%2C%20Kilchberg%2C%208802%2C%20Switzerland"
    pageTitle="Oberer Mönchhof"
  />
);

export default ObererMnchhof;
