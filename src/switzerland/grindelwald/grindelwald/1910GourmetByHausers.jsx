...
const OneNineOneZeroGourmetByHausers = () => (
  <RestaurantPage
    restaurantName="1910 Gourmet by Hausers"
    address="Dorfstrasse 53, Grindelwald, 3818, Switzerland"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+41338889999"
    website="https://www.belvedere-grindelwald.ch/de/restaurant/gourmet-1910/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstrasse%2053%2C%20Grindelwald%2C%203818%2C%20Switzerland"
    pageTitle="1910 Gourmet by Hausers"
  />
);

export default OneNineOneZeroGourmetByHausers;
