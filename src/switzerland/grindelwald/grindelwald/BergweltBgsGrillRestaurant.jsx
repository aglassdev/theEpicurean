...
const BergweltBgsGrillRestaurant = () => (
  <RestaurantPage
    restaurantName="Bergwelt - BG's Grill Restaurant"
    address="Bergwelt 4, Grindelwald, 3818, Switzerland"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+41338548585"
    website="https://www.bergwelt-grindelwald.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Modern chic with an Alpine touch: Done out in warm tones, with lovely hardwood floors, striking designer lamps and an open kitchen complete with an impressive charcoal grill, this restaurant – part of the equally attractive Bergwelt Grindelwald hotel – has a truly unique atmosphere. The cuisine, inspired by the region, is also very appealing. For meat lovers, the fragrant, golden-brown Wiener schnitzel is sure to whet the appetite, and the same goes for the top-quality signature cuts from the barbecue. Vegetarian options are also available. The well-curated wine list predominantly features Swiss and French labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bergwelt%204%2C%20Grindelwald%2C%203818%2C%20Switzerland"
    pageTitle="Bergwelt - BG's Grill Restaurant"
  />
);

export default BergweltBgsGrillRestaurant;
