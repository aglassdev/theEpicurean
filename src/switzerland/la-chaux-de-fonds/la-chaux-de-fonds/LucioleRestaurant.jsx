...
const LucioleRestaurant = () => (
  <RestaurantPage
    restaurantName="Luciole Restaurant"
    address="Rue Daniel-Jeanrichard 19, La Chaux-de-Fonds, 2300, Switzerland"
    cuisine="Regional Cuisine, Vegan"
    priceRange="€€€"
    phoneNumber="+41329140459"
    website="https://www.luciole-restaurant.com/fr"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Luciole is the quintessence of seasonal, spot-on cooking. The exclusively vegetable lineup of this dinky establishment in La Chaux-de-Fonds celebrates produce from the garden and nearby. Entirely ruled by the seasons, they deploy ancestral and modern techniques: fermentation, cryoconcentration, wild herbs and flowers. The menu may skip from tomatoes, rhubarb, peach and basil to absinth-laced grilled green peas or violet-perfumed sweet titbits to finish. An open kitchen, lovely tableware and delightful service set the scene in this eatery run by a nature-loving couple whose commitment to excellence is second to none. Note: maximum of eight guests per service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Daniel-Jeanrichard%2019%2C%20La%20Chaux-de-Fonds%2C%202300%2C%20Switzerland"
    pageTitle="Luciole Restaurant"
  />
);

export default LucioleRestaurant;
