...
const TheMansardRestaurant = () => (
  <RestaurantPage
    restaurantName="The Mansard Restaurant"
    address="Untergstaadstrasse 26, Gstaad, 3780, Switzerland"
    cuisine="International, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+41337484000"
    website="https://www.the-mansard.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on the ground floor of boutique hotel Miiro The Mansard, this restaurant has a modern and elegant brasserie-style interior with an Alpine feel. There is a terrace with a few tables out on the pavement – this is a place to see and be seen. The kitchen serves up seasonal cuisine with international influences, using select ingredients, many sourced from Switzerland. You can also look forward to a well-curated wine list and friendly service. From Wednesday to Friday, there is an affordable lunch menu. Tip: For a cool rooftop bar experience with stunning views, head to the bar The Mansard Rooftop on the fourth floor, which serves drinks, cocktails and a small selection of snacks. Thanks to its central location very close to the Gstaad promenade, the hotel is also an ideal starting point..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untergstaadstrasse%2026%2C%20Gstaad%2C%203780%2C%20Switzerland"
    pageTitle="The Mansard Restaurant"
  />
);

export default TheMansardRestaurant;
