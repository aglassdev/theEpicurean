...
const HirschenERL = () => (
  <RestaurantPage
    ...
    address="Hauptstrasse 125, Erlinsbach, 5015, Switzerland"
    cuisine="Classic Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+41628573333"
    website="https://www.hirschen-erlinsbach.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Classic, seasonal and regional food is the name of the game here. Guests can enjoy fine dining and vegetarian options in the Zeitgeist restaurant, as well as house classics, including the signature dish: chateaubriand. Tip: The chocolate cake with coffee is sensational! Alternatively, you can order burgers, pasta etc in the cosy Hirschenstube. Popular terrace for summer meals, plus comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hauptstrasse%20125%2C%20Erlinsbach%2C%205015%2C%20Switzerland"
    pageTitle="Hirschen"
  />
);

export default HirschenERL;
