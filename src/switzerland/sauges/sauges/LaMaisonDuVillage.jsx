...
const LaMaisonDuVillage = () => (
  <RestaurantPage
    restaurantName="La Maison du Village"
    address="Rue de la Fontanette 41, Sauges, 2024, Switzerland"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+41328353272"
    website="https://maisonduvillage.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its resolutely relaxed ambience, this auberge is far from the traditional image of a high temple of gastronomy. Here, Marc Strebel, a young chef from the Valais, conjures up dishes very much inspired by a return to nature. Superb view of the lake from the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Fontanette%2041%2C%20Sauges%2C%202024%2C%20Switzerland"
    pageTitle="La Maison du Village"
  />
);

export default LaMaisonDuVillage;
