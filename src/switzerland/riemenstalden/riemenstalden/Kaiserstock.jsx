...
const Kaiserstock = () => (
  <RestaurantPage
    restaurantName="Kaiserstock"
    address="Dörfli 2, Riemenstalden, 6452, Switzerland"
    cuisine="Country cooking, International"
    priceRange="€€"
    phoneNumber="+41418201032"
    website="https://www.kaiserstock.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming establishment perched in a small mountain village is your reward after the narrow, steep drive up! The fact that the restaurant has many regular customers is of course mainly down to its tasty traditional cuisine. The dishes are prepared with flair from good, fresh produce from the region. Popular options include stews and ravioli. A four- to seven-course set menu is also available if you pre-book (two days in advance). Seasonal specialities such as venison and chamois or Metzgete (pork platter) are also worth considering. Tip: Soups, sausages, jams and other delicacies can be purchased to take home. There are pleasant rustic-style guestrooms for overnight stays. N.B. Cash only!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=D%C3%B6rfli%202%2C%20Riemenstalden%2C%206452%2C%20Switzerland"
    pageTitle="Kaiserstock"
  />
);

export default Kaiserstock;
