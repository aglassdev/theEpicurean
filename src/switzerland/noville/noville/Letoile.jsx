...
const Letoile = () => (
  <RestaurantPage
    restaurantName="L'Etoile"
    address="Chemin du Battoir 1, Noville, 1845, Switzerland"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+41219601058"
    website="https://www.etoilenoville.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you are seated in the chic bistro, in the winter garden or in the attractive shaded garden, this family-run establishment offers a warm welcome and a friendly atmosphere. The seasonal menu, with dishes prepared to order, features local producers. The thick and creamy crème brûlée, delicately flavoured with orange, is unforgettable. The set lunch menu is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chemin%20du%20Battoir%201%2C%20Noville%2C%201845%2C%20Switzerland"
    pageTitle="L'Etoile"
  />
);

export default Letoile;
