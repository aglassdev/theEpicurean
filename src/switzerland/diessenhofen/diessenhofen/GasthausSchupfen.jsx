...
const GasthausSchupfen = () => (
  <RestaurantPage
    restaurantName="Gasthaus Schupfen"
    address="Steinerstrasse 501, Diessenhofen, 8253, Switzerland"
    cuisine="Traditional Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+41526571042"
    website="https://schupfen.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a history dating back to 1455, this lovely half-timbered house is really something special. In an inviting atmosphere, food is served in three charming rooms and on the idyllic terrace overlooking the Rhine. The menu features Swiss classics such as fillets of perch with tartare sauce or Kalbsgeschnetzeltes Zürcher Art – Zurich veal ragout with rösti, alongside seasonal dishes such as asparagus salad with herb vinaigrette, served with smoked trout and fresh horseradish. If you are looking for a good location for a wedding or event, the premises can also be rented out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Steinerstrasse%20501%2C%20Diessenhofen%2C%208253%2C%20Switzerland"
    pageTitle="Gasthaus Schupfen"
  />
);

export default GasthausSchupfen;
