...
const GasthausImFeld = () => (
  <RestaurantPage
    restaurantName="Gasthaus im Feld"
    address="Dorfstrasse 56, Gurtnellen, 6482, Switzerland"
    cuisine="Swiss, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+41418851909"
    website="http://www.feld.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The journey up to the village of Gurtnellen, at an altitude of 935m, is well worth it! Chef-owner Beat Walker is the fifth generation of his family to run this charming restaurant dating back to the 19C. He is assisted by Roland Gloor, who takes excellent care of diners. Behind the wooden shingle façade that is typical of the region, the atmosphere is inviting, from the Gaststube on the ground floor to the elegant wood-panelled Urnerstube on the first floor. There is also a beautiful terrace with mountain views. At lunchtime, there are à la carte dishes (eg trout with Siiwgagglä (fried potatoes) and Gmiäs (vegetables), or Chalbschopfbäggli (veal chops) with Gschtunggetä Härdepfel (mashed potatoes) and Gmiäs), and in the evening you will be surprised with the Äs set menu (four, five or six ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstrasse%2056%2C%20Gurtnellen%2C%206482%2C%20Switzerland"
    pageTitle="Gasthaus im Feld"
  />
);

export default GasthausImFeld;
