...
const BrasserieLeGogant = () => (
  <RestaurantPage
    restaurantName="Brasserie Le Gogant"
    address="Route de France 8, Le Brassus, 1348, Switzerland"
    cuisine="Seasonal Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+41218450845"
    website="https://www.hoteldeshorlogers.com/de/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Both the restaurant, and the Hôtel des Horlogers in which it is housed, are the epitome of sleek, cutting-edge cool. In addition to an elegant designer interior, guests can savour panoramic vistas of nature through huge picture windows. The seasonal lineup harmoniously blends classical and traditional flavours (succulent stocks and addictive sauces) and is crafted from primarily regional ingredients. An uncluttered decor provides the perfect foil to bold, modern plating and high-quality recipes. If you are dining in a party, don’t hesitate to order the dishes to share, but before that, it would be a crime to skip the delectable gruyere-flavoured malakoffs (fried cheese balls) – ideal with an aperitif. The entire team, from the slick front-of-house staff to the crack white-jacketed brigade,..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20France%208%2C%20Le%20Brassus%2C%201348%2C%20Switzerland"
    pageTitle="Brasserie Le Gogant"
  />
);

export default BrasserieLeGogant;
