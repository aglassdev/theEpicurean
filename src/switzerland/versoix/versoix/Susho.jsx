...
const Susho = () => (
  <RestaurantPage
    restaurantName="SUSHO"
    address="Route de Suisse 17, Versoix, 1290, Switzerland"
    cuisine="Sushi, Ramen"
    priceRange="€€"
    phoneNumber="+41799532021"
    website="http://www.susho.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just outside Geneva, this small sushi joint is frequently packed to the seams. Two young chefs wield their high-precision skills, rolling out impeccable nigiris, lemony hamachi, flambéed salmon. Ten out of ten for their spicy Crispy Shrimp Roll and the rich, comforting Shoyu Ramen. Sheltered terrace, tightly packed tables and a vibrant energy depict this on-the-ball eatery!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Suisse%2017%2C%20Versoix%2C%201290%2C%20Switzerland"
    pageTitle="SUSHO"
  />
);

export default Susho;
