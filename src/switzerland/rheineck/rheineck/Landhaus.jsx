...
const Landhaus = () => (
  <RestaurantPage
    restaurantName="Landhaus"
    address="Appenzellerstrasse 73, Rheineck, 9424, Switzerland"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+41718881260"
    website="https://www.landhaus-rheineck.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 16C farmhouse has been turned into a really charming restaurant boasting a splendid view of Lake Constance. Featuring warm wood finishings and sleek design, the decor embodies a winning combination of the old and the new. Hostess Ariane Cresta provides cordial service in the cosy dining area, while chef-patron Lino Cresta cooks up his modern take on classic cuisine with a regional touch. On the menu, you will find veal cordon bleu, as well as beef tenderloin and brasato with potato, cauliflower, parsnip and XO, or even porcini tortelloni. In the evening, the à la carte selection is complemented by an ambitious three- to five-course set menu (vegetarian version available) and at lunchtime, by daily specials and a Business Lunch deal. In summer, head for the gorgeous terrace. There is a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Appenzellerstrasse%2073%2C%20Rheineck%2C%209424%2C%20Switzerland"
    pageTitle="Landhaus"
  />
);
