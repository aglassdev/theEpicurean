...
const GasthausLwen = () => (
  <RestaurantPage
    restaurantName="Gasthaus Löwen"
    address="Holzhäusernstrasse 2, Menzingen, 6313, Switzerland"
    cuisine="Classic Cuisine, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41417590444"
    website="https://loewen-menzingen.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dating back to the 16C, Löwen is a lovely traditional inn that has been run by Tanja and Franco Körperich since 2019. She takes care of the service in the charming and elegant wood-panelled dining space on the first floor, and Franco is at the helm in the kitchen. Diners sit at elegantly laid tables to savour a surprise menu comprising four to eight courses, with vegetarian options available if pre-ordered. Top-quality ingredients go into classic dishes that draw on modern and international influences. A shining example is the gently barbecued and mildly spiced king prawn, accompanied by lightly sautéed buck's horn plantain and fine baby peas, all complemented by a tom kha gai beurre blanc with a wonderful aroma and texture. The chef-patron makes a point of offering guidance and presenting..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Holzh%C3%A4usernstrasse%202%2C%20Menzingen%2C%206313%2C%20Switzerland"
    pageTitle="Gasthaus Löwen"
  />
);

export default GasthausLwen;
