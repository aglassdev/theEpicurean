...
const ChteauAttisholzBrasserieLaSource = () => (
  <RestaurantPage
    ...
    pageTitle="Château Attisholz - Brasserie la Source"
  />
);

export default ChteauAttisholzBrasserieLaSource;
