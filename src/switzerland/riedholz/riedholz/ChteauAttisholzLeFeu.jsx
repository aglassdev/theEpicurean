...
const ChteauAttisholzLeFeu = () => (
  <RestaurantPage
    restaurantName="Château Attisholz - Le feu"
    address="Attisholzstrasse 3, Riedholz, 4533, Switzerland"
    cuisine="French, Contemporary"
    priceRange="€€€€"
    phoneNumber="+41326230606"
    website="https://www.attisholz.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This is a rather grand establishment located just outside Riedholz. A truly splendid historical property houses the exquisitely elegant and tastefully designed fine dining restaurant Le feu, with the garden and courtyard outside being a draw in themselves. Chef-patron Jörg Slaschek proposes a sophisticated modern-classical set menu, but there is also an à la carte selection. It goes without saying that the Bavarian-born chef uses only select produce. A well-curated selection of European wines makes for the perfect accompaniment to your meal. Overnight accommodation is also available: There are really appealing guestrooms that fit perfectly into the overall picture of sophistication...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Attisholzstrasse%203%2C%20Riedholz%2C%204533%2C%20Switzerland"
    pageTitle="Château Attisholz - Le feu"
  />
);

export default ChteauAttisholzLeFeu;
