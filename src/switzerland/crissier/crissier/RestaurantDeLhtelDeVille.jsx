...
const RestaurantDeLhtelDeVille = () => (
  <RestaurantPage
    ...
    priceRange="€€€€"
    phoneNumber="+41216340505"
    website="https://www.restaurantcrissier.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant, known simply as Crissier by its regulars, boasts a star-studded history. Since Frédy Girardet was first awarded three stars back in 1975, the Crissier has showcased the talents of a stunning cast of virtuoso chefs, among whom Philippe Rochat, Benoît Violier… and now Franck Giovannini. At the head of an impressive kitchen team, the latter continues to roll out Gallic classics of exemplary clarity, rich in big-boned, yet balanced flavours. Lamb in herbs, strikingly fresh red mullet, Nantes duck in a gutsy gravy: the quality of the produce is as outstanding as the consummate cooking. Each dish is a master class of well-judged aromas, textures and precision. The equally exceptional wine list is the work of an inspired young sommelière. In characteristic Swiss fashion, the serv..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20d'Yverdon%201%2C%20Crissier%2C%201023%2C%20Switzerland"
    pageTitle="Restaurant de l'Hôtel de Ville"
  />
);

export default RestaurantDeLhtelDeVille;
