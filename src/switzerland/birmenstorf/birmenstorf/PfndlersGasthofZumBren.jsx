...
const PfndlersGasthofZumBren = () => (
  <RestaurantPage
    restaurantName="Pfändler's Gasthof zum Bären"
    address="Kirchstrasse 7, Birmenstorf, 5413, Switzerland"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+41562014400"
    website="https://www.zumbaeren.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Steeped in over 200 years of history, this building makes for a really delightful setting: Bärenstube and Orangerie are full of charm and attention to detail. The garden is also attractive – a truly idyllic spot! The seasonal food has regional and Mediterranean influences. You will feel right at home in the pretty guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kirchstrasse%207%2C%20Birmenstorf%2C%205413%2C%20Switzerland"
    pageTitle="Pfändler's Gasthof zum Bären"
  />
);

export default PfndlersGasthofZumBren;
