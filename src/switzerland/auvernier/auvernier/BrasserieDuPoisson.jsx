...
const BrasserieDuPoisson = () => (
  <RestaurantPage
    restaurantName="Brasserie du Poisson"
    address="Rue des Epancheurs 1, Auvernier, 2012, Switzerland"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+41327316231"
    website="https://www.lepoisson-auvernier.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary brasserie close to the lake offers unpretentious cuisine. Fish has the starring role (tuna tartare, perch fillets), as well as hearty traditional recipes such as croûte aux morilles (with morel mushrooms) and veal cutlets. A real treat for the taste buds, particularly as everything (including the bread and ice cream) is homemade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20des%20Epancheurs%201%2C%20Auvernier%2C%202012%2C%20Switzerland"
    pageTitle="Brasserie du Poisson"
  />
);

export default BrasserieDuPoisson;
