...
const Chasellas = () => (
  <RestaurantPage
    restaurantName="Chasellas"
    address="Via Suvretta 22, Saint Moritz, 7500, Switzerland"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+41818363636"
    website="https://suvrettahouse.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming restaurant in the Suvretta House hotel at the entrance to the skiing and hiking area has found a winning formula, offering rustic specialities for lunch and more sophisticated dishes in the evening, such as herb-crusted rack of lamb, mashed potatoes, chanterelle-asparagus ragout and baby carrots...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Suvretta%2022%2C%20Saint%20Moritz%2C%207500%2C%20Switzerland"
    pageTitle="Chasellas"
  />
);

export default Chasellas;
