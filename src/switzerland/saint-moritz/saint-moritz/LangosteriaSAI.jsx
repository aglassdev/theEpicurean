...
const LangosteriaSAI = () => (
  <RestaurantPage
    restaurantName="Langosteria"
    address="Via Salastrains 10, Saint Moritz, 7500, Switzerland"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+41818333131"
    website="https://www.langosteria.com/en/langosteria-st-moritz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the new place to see and be seen on the ski slopes overlooking St Moritz. The terrace affords magnificent views, making it a delightful spot in which to savour freshly prepared Italian cuisine. Langoustine, lobster and fish, truffle pizza and pasta are the specialities of this restaurant, which also has locations in Milan, Paris and Paraggi. If you're not skiing, the best way to get here is by taxi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Salastrains%2010%2C%20Saint%20Moritz%2C%207500%2C%20Switzerland"
    pageTitle="Langosteria"
  />
);

export default LangosteriaSAI;
