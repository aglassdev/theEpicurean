...
const DaVittorioStMoritz = () => (
  <RestaurantPage
    restaurantName="Da Vittorio - St. Moritz"
    address="Via Johannes Badrutt 11, Saint Moritz, 7500, Switzerland"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+41818367000"
    website="https://carlton-stmoritz.ch/en/restaurants/da-vittorio-st-moritz"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If you happen to be in St Moritz in the winter season, then take advantage of the opportunity to dine at the stylish yet cosy restaurant of the Carlton Hotel, in its glorious location overlooking the lake. Kick off with an aperitif in the charming lounge, then treat yourself to fuss-free Italian fare. During the winter months, chef Paolo Rota from the flagship restaurant in Brusaporto and his team create precise and effortless dishes that put the produce in the spotlight. Some of the brilliantly prepared specialties from the parent restaurant in Lombardy make an appearance, including, of course, the signature pasta dish, paccheri alla Vittorio. Order à la carte or opt for the Carte Blanche set menu, available in five, seven or 10 courses – with a bit of luck, the petits fours served at the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Johannes%20Badrutt%2011%2C%20Saint%20Moritz%2C%207500%2C%20Switzerland"
    pageTitle="Da Vittorio - St. Moritz"
  />
);

export default DaVittorioStMoritz;
