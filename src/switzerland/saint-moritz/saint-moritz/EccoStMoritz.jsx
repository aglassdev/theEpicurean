...
const EccoStMoritz = () => (
  <RestaurantPage
    restaurantName="Ecco St. Moritz"
    address="Via Maistra 3, Saint Moritz, 7512, Switzerland"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41818366300"
    website="https://giardinohotels.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Winter in the Engadine region promises a host of exciting culinary experiences at the fine dining restaurant of hotel Giardino Mountain here in St Moritz. The cuisine is modern and creative. There is a set menu that comes in four to seven courses, and exceptional ingredients are at the heart of it all. Thanks to the exceedingly dedicated, charming and unflappable front-of-house team, the attentive service matches these high standards...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Maistra%203%2C%20Saint%20Moritz%2C%207512%2C%20Switzerland"
    pageTitle="Ecco St. Moritz"
  />
);

export default EccoStMoritz;
