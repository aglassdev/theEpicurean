...
const HideSeekSAI = () => (
  <RestaurantPage
    ...
    website="https://giardinohotels.ch/giardino/restaurants/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you like to dine in a lively, modern atmosphere, the restaurant of Hotel Giardino Mountain is for you. The decor features a combination of trendy, chic features and rustic wood. Attentive front-of-house team and Mediterranean and Swiss dishes that are aromatic and flavoursome, made with fresh, often regional produce. Lunch is served in the bar-lounge...."
