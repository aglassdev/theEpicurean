...
const LartichautCAR = () => (
  <RestaurantPage
    restaurantName="L'Artichaut"
    address="Quai du Cheval-Blanc 9, Carouge, 1227, Switzerland"
    cuisine="Modern French, Farm to table"
    priceRange="€€"
    phoneNumber="+41223019091"
    website="https://artichaut-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Only the street separates this appealing restaurant from the River Arve. You will feel completely at home here, thanks to both the pleasant bistro atmosphere, including decorative paintings and posters of vintage advertisements, and the French cuisine reinterpreted with seasonal influences. Excellent wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quai%20du%20Cheval-Blanc%209%2C%20Carouge%2C%201227%2C%20Switzerland"
    pageTitle="L'Artichaut"
  />
);

export default LartichautCAR;
