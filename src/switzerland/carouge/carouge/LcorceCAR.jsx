...
const LcorceCAR = () => (
  <RestaurantPage
    restaurantName="L'Écorce"
    address="Rue du Collège 8, Carouge, 1227, Switzerland"
    cuisine="French Contemporary, Farm to table"
    priceRange="€€"
    phoneNumber="+41223002098"
    website="https://lecorce-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this convivial, tastefully furnished restaurant in Carouge’s old town the chef conjures up fresh, aromatic cuisine that combines classic and modern dishes such as mi-cuit tuna with a beetroot and watermelon bouillon and raw and cooked vegetables. Charming service, plus a small summer terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Coll%C3%A8ge%208%2C%20Carouge%2C%201227%2C%20Switzerland"
    pageTitle="L'Écorce"
  />
);

export default LcorceCAR;
