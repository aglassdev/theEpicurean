...
const BistrotDuLionDor = () => (
  <RestaurantPage
    restaurantName="Bistrot du Lion d'Or"
    address="Rue Ancienne 53, Carouge, 1227, Switzerland"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+41223421813"
    website="https://liondorcarouge.ch/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Ancienne%2053%2C%20Carouge%2C%201227%2C%20Switzerland"
    pageTitle="Bistrot du Lion d'Or"
  />
);

export default BistrotDuLionDor;
