...
const RestaurantDeLhtelDeVilleOLL = () => (
  <RestaurantPage
    ...
    bio="In the centre of the village, near the bell tower, this quintessential rural establishment celebrates tradition quietly and simply. Beneath the vaulted ceiling of the dining room (refreshingly cool in summertime), you will taste a seasonal Gallic lineup with a choice of menus and courses. Grégory Halgand conjures up creative dishes such as asparagus, grapefruit and pistachio or Brittany lobster, red beetroot, blackberries and fish bisque. The desserts are the work of Audrey Feutren-Halgand, who also respects the seasons, with delicacies such as a medley of apricots (stewed, jellied and grilled), flanked by a frothy coconut mousse. Audrey is also responsible for the house-made bread. Artwork (paintings and sculptures) graces the interior, and there is a pleasant outdoor patio for a final al..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20l'H%C3%B4tel-de-Ville%203%2C%20Ollon%2C%201867%2C%20Switzerland"
    pageTitle="Restaurant de l'Hôtel de Ville"
  />
);

export default RestaurantDeLhtelDeVilleOLL;
