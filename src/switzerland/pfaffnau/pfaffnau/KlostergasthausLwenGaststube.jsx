...
const KlostergasthausLwenGaststube = () => (
  <RestaurantPage
    restaurantName="Klostergasthaus Löwen - Gaststube"
    address="Untertor 3, Pfaffnau, 4915, Switzerland"
    cuisine="International, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+49625303422"
    website="https://www.klostergasthaus-loewen.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is Pascal Schwarz's second restaurant on the estate of the former 12th century monastery. In addition to the gourmet restaurant, he also has his ‘Gaststube’ in the historic monastery inn in the St. Urban district - also on the first floor. Modern interiors have been attractively integrated into the traditional setting - on the terrace behind the house you can enjoy the good cuisine of Pascal and his team as well as the view of the imposing monastery church, which is well worth a visit. The cuisine is regional, seasonal and international. In the evening, there is a nice selection of dishes ranging from ‘pastrami burgers’ to ‘pink roast duck breast from France’ and ‘vegetarian carbonara-style mushroom risotto’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Untertor%203%2C%20Pfaffnau%2C%204915%2C%20Switzerland"
    pageTitle="Klostergasthaus Löwen - Gaststube"
  />
);

export default KlostergasthausLwenGaststube;
