...
const KlostergasthausLwenNegral = () => (
  <RestaurantPage
    restaurantName="Klostergasthaus Löwen - Negral"
    ...
    pageTitle="Klostergasthaus Löwen - Negral"
  />
);

export default KlostergasthausLwenNegral;
