...
const AubergeDeLaVeveyseBrasserie = () => (
  <RestaurantPage
    restaurantName="Auberge de la Veveyse - Brasserie"
    ...
    bio="A worthy heir to this renowned restaurant, David Tarnowski serves ambitious, refined cuisine that showcases beautifully plated classics and his own personal creations. The creamy risotto with chanterelles and Vaudois sausage deserves a special mention. The pared-back setting is filled with light. Fair prices at lunchtime; bistro vibes in the second space...."
    ...
    pageTitle="Auberge de la Veveyse - Brasserie"
  />
);

export default AubergeDeLaVeveyseBrasserie;
