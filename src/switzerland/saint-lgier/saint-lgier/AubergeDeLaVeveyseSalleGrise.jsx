...
const AubergeDeLaVeveyseSalleGrise = () => (
  <RestaurantPage
    restaurantName="Auberge de la Veveyse - Salle grise"
    address="Route de Châtel-Saint-Denis 212, Saint-Légier, 1806, Switzerland"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+41219436760"
    website="https://www.auberge-de-la-veveyse.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this small space of the Auberge de la Veveyse dedicated to fine dining, owner David Tarnowski offers the best of the market and local produce in the form of several surprise set menus that are not short on finesse: tarragon jelly with lake fish; whitefish from the nearby lakes with tomato; loin of Swiss veal, courgette and a thyme jus…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Route%20de%20Ch%C3%A2tel-Saint-Denis%20212%2C%20Saint-L%C3%A9gier%2C%201806%2C%20Switzerland"
    pageTitle="Auberge de la Veveyse - Salle grise"
  />
);

export default AubergeDeLaVeveyseSalleGrise;
