...
const AubergeCommunale = () => (
  <RestaurantPage
    restaurantName="Auberge Communale"
    address="78 rte des Deux-Villages, Saint-Légier, 1806, Switzerland"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+41219431177"
    website="https://auberge-st-legier.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rather inconspicuous Auberge is located in a small village set slightly above Vevey. Run by the Konrad family, it not only has guestrooms for overnight stays, but also serves really good food! Whether eating in the refined modern space or on the pretty terrace, choose between delicious bistro dishes and the Gastro set menu. It is always tasty and prices remain very competitive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=78%20rte%20des%20Deux-Villages%2C%20Saint-L%C3%A9gier%2C%201806%2C%20Switzerland"
    pageTitle="Auberge Communale"
  />
);

export default AubergeCommunale;
