...
const AubergeDuPrvoux = () => (
  <RestaurantPage
    restaurantName="Auberge du Prévoux"
    address="Le Prévoux 10, Le Locle, 2400, Switzerland"
    cuisine="Classic French"
    priceRange="€"
    phoneNumber="+41329312313"
    website="https://www.aubergeduprevoux.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This inn on the edge of a forest in the heart of the Neuchâtel mountains is well known to food-lovers, who head here to enjoy French cuisine with a focus on the very best products selected by a chef who enjoys working with lake fish and different types of game, in particular. Good value for money in the brasserie at lunchtime, with more ambitious cuisine on offer in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Pr%C3%A9voux%2010%2C%20Le%20Locle%2C%202400%2C%20Switzerland"
    pageTitle="Auberge du Prévoux"
  />
);

export default AubergeDuPrvoux;
