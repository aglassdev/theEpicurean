...
const ChteauDePleujouse = () => (
  <RestaurantPage
    restaurantName="Château de Pleujouse"
    address="Le Château 18, Pleujouse, 2953, Switzerland"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+41324621080"
    website="https://www.chateaudepleujouse.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on a rocky spur, this 10C fortress overlooks the surrounding countryside. A duo of chefs delights diners with organic and regional ingredients; bread, gratins and rice pudding are baked in the bread oven – a truly artisanal approach, which, by drawing on produce from the terroir, takes us back to the feasts of yesteryear! A very warm welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Le%20Ch%C3%A2teau%2018%2C%20Pleujouse%2C%202953%2C%20Switzerland"
    pageTitle="Château de Pleujouse"
  />
);

export default ChteauDePleujouse;
