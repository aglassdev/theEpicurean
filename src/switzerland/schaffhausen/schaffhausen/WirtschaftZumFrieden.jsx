...
const WirtschaftZumFrieden = () => (
  <RestaurantPage
    restaurantName="Wirtschaft zum Frieden"
    address="Herrenacker 13, Schaffhausen, 8200, Switzerland"
    cuisine="Classic Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+41526254767"
    website="https://wirtschaft-frieden.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This centuries-old inn enjoys a prime location right on Marktplatz, and its charming ambiance, redolent of a bygone era, will have you yearning to return. The dedication of your hosts is also infectious. While maître d' Heidi Bischoff graciously attends to diners in the cosy wood-panelled dining areas, chef-patron Fabrice Bischoff cooks up classic, home-style fare using fresh, high-quality ingredients. Some dishes also incorporate a Mediterranean twist. On the menu you will find beef fillet Stroganoff, as well as Swiss salmon steak with accras. A simpler set menu of the day is also available at lunchtime. The verdant terrace is a delightful spot in the summertime!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herrenacker%2013%2C%20Schaffhausen%2C%208200%2C%20Switzerland"
    pageTitle="Wirtschaft zum Frieden"
  />
);

export default WirtschaftZumFrieden;
