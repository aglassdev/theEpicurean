...
const Dchuchi = () => (
  <RestaurantPage
    restaurantName="D'Chuchi"
    address="Brunnengasse 3, Schaffhausen, 8200, Switzerland"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+41526200528"
    website="https://www.dchuchi.ch/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant in a side street in the old town has a charming, down-to-earth and almost intimate atmosphere. It also serves really good food, which owner Jan Schmidlin creates by drawing almost exclusively on regional produce. Shining examples of his delicious modern seasonal fare include veal – saddle, Bäggli, Schupfnudeln (potato dumplings), lettuce, tarragon. There is a four-course set menu and an à la carte selection of dishes. You can also look forward to extremely pleasant, cordial hospitality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brunnengasse%203%2C%20Schaffhausen%2C%208200%2C%20Switzerland"
    pageTitle="D'Chuchi"
  />
);

export default Dchuchi;
