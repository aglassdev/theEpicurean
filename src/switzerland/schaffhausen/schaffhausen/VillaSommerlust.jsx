...
const VillaSommerlust = () => (
  <RestaurantPage
    restaurantName="Villa Sommerlust"
    address="Rheinhaldenstrasse 8, Schaffhausen, 8200, Switzerland"
    cuisine="Innovative, Creative"
    priceRange="€€€"
    phoneNumber="+41525335533"
    website="https://sommerlust.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Led by two young Spanish chefs, Dan Rodriguez-Zaugg and Alejandro Perez Polo, the kitchen team creates highly innovative, exciting and technically complex dishes, such as Swiss Alpine pike-perch ceviche with white soya mayonnaise and jalapeños. The menu showcases a blend of Spanish avant-garde, South American and Asian culinary influences. There is a four- to eight-course set menu with a vegetarian alternative. Options are simpler and more limited at lunchtime, but the evening menu can also be made available upon prior request. Friendly and adept service. The restaurant is housed in a charming villa, just a street away from the Rhine. If you can't get a table on the fabulous garden terrace, the Orangerie is a delightful alternative – with its light and airy atmosphere, it makes you feel al..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rheinhaldenstrasse%208%2C%20Schaffhausen%2C%208200%2C%20Switzerland"
    pageTitle="Villa Sommerlust"
  />
);

export default VillaSommerlust;
