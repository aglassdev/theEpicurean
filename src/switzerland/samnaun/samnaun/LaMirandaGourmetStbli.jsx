...
const LaMirandaGourmetStbli = () => (
  <RestaurantPage
    restaurantName="La Miranda Gourmet Stübli"
    address="Dorfstrasse 30, Samnaun, 7563, Switzerland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+41818619000"
    website="https://www.hotelchasamontana.ch/de/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the wonderfully elegant yet cosy fine dining restaurant of Chasa Montana hotel, chef Bernd Fabian and his team conjure up a surprise menu comprising three to five courses. Each dish celebrates an extraordinary diversity of exceptional and predominantly regional produce, showcasing them in modern and precise dishes. The desserts are equally phenomenal! With its limited number of tables, the restaurant ensures friendly service – the chefs serve and explain the dishes personally, and even the head chef is on hand to engage with diners. The fantastic wine list boasts an impressive range of renowned labels. Your host and sommelier, Daniel Eisner, embodies a passion for wine shared by the whole team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorfstrasse%2030%2C%20Samnaun%2C%207563%2C%20Switzerland"
    pageTitle="La Miranda Gourmet Stübli"
  />
);

export default LaMirandaGourmetStbli;
