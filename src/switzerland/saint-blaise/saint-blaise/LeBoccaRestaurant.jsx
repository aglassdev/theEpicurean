...
const LeBoccaRestaurant = () => (
  <RestaurantPage
    restaurantName="Le Bocca - Restaurant"
    address="Avenue Bachelin 11, Saint-Blaise, 2072, Switzerland"
    cuisine="French Contemporary"
    priceRange="€€€"
    phoneNumber="+41327533680"
    website="https://www.le-bocca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the management of chef Alexandre Luquet and his spouse Ana Ronc, Le Bocca offers a mouthwatering gourmet experience that combines elegance and modernity. Whether you are seated in the bright interior or on the lush alfresco patio, you will sample cosmopolitan contemporary French cuisine focused on outstanding produce. Wild langoustine, sole meunière fished by small boats and Araguani chocolate soufflé bear witness to the establishment’s bold, minimalist signature. Flexible evening menus (3 to 6 courses), well thought out lunchtime menu, a fantastic wine cellar and slick friendly service. The marriage of sophistication and sincerity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Bachelin%2011%2C%20Saint-Blaise%2C%202072%2C%20Switzerland"
    pageTitle="Le Bocca - Restaurant"
  />
);

export default LeBoccaRestaurant;
