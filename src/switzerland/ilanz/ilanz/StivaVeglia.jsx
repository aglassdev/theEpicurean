...
const StivaVeglia = () => (
  <RestaurantPage
    restaurantName="Stiva Veglia"
    address="Miez Vitg 51, Ilanz, 7130, Switzerland"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+41819254121"
    website="https://stiva-veglia.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in an idyllic little village, this lovingly restored Graubünden house dating back to 1761 is replete with Alpine charm. The interior is exceptionally pretty with its wood-panelled rooms that are welcoming and stylish in equal measure. Make a beeline for the terrace in summer. Tino Zimmermann delivers modern regional cuisine. There is a set menu of up to nine courses. A classic of the house is the Schmauser 45-minute egg. A vegetarian menu is also available upon request. Fantastic produce such as Val Lumnezia Arctic char demonstrates a clear connection to the region. Diners are waited on by a dedicated and friendly front-of-house team, with the chefs themselves making an appearance from time to time in order to talk diners through their dishes. Tip: house-made specialities such as ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Miez%20Vitg%2051%2C%20Ilanz%2C%207130%2C%20Switzerland"
    pageTitle="Stiva Veglia"
  />
);

export default StivaVeglia;
