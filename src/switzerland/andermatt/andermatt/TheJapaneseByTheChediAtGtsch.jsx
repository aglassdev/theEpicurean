...
const TheJapaneseByTheChediAtGtsch = () => (
  <RestaurantPage
    restaurantName="The Japanese by The Chedi at Gütsch"
    address="Gotthardstrasse 4, Andermatt, 6490, Switzerland"
    cuisine="Japanese Contemporary, Fusion"
    priceRange="€€€€"
    phoneNumber="+41418887466"
    website="https://www.thechediandermatt.com/de/dining/the-japanese-at-gutsch?_gl=1*1xkyl56*_up*MQ..*_ga*NDcwMjUwNTMzLjE3NDQwMjUzNjE.*_ga_4682T462C6*MTc0NDAyNTM2MC4xLjAuMTc0NDAyNTM2MC4wLjAuMA.."
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="For a chance to savour terrific Japanese cuisine high up in a stunning Alpine setting, head to this restaurant, located 2 344m above sea level, and preferably bag a table on the wonderful terrace set against this grandiose mountain backdrop! Working in tandem, twin brothers Dominik Sato and Fabio Toffolon create classic Japanese cuisine with subtle European influences. Opt for the Omakase Kaiseki Menu (vegetarian version possible), Shidashi Bento or their wonderful selection of sushi, sashimi – and N25 caviar. A children's menu is also available. Smooth service is provided by a friendly and attentive team armed with expert wine and sake recommendations – the range here is excellent. The interior is minimalist yet inviting, and the open kitchen draws the eye. You can reach the restaurant on..."
    ...
    pageTitle="The Japanese by The Chedi at Gütsch"
  />
);

export default TheJapaneseByTheChediAtGtsch;
