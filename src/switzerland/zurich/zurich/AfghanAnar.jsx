...
const AfghanAnar = () => (
  <RestaurantPage
    restaurantName="Afghan Anar"
    address="Fierzgasse 22, Zurich, 8005, Switzerland"
    cuisine="Afghan"
    priceRange="€€"
    phoneNumber="+41442231787"
    website="https://www.afghananar.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take advantage of the rather rare opportunity to discover Afghan cuisine! Here you can sample some of the country's most popular dishes, such as bolani, kabuli pulao or baklava. The atmosphere is laid back and down to earth, which is in part down to the open kitchen and authentic decor. As an alternative to the conventional tables and chairs, you have the option to dine on traditional mats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fierzgasse%2022%2C%20Zurich%2C%208005%2C%20Switzerland"
    pageTitle="Afghan Anar"
  />
);

export default AfghanAnar;
