...
const LaSoupire = () => (
  <RestaurantPage
    restaurantName="La Soupière"
    address="Bahnhofplatz 7, Zurich, 8001, Switzerland"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+41442188842"
    website="https://www.la-soupiere.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sophisticated restaurant on the first floor boasts a stylish interior and professional service. As for the menu, it offers modern variations on classic French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofplatz%207%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="La Soupière"
  />
);

export default LaSoupire;
