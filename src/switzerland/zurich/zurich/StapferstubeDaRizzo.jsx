...
const StapferstubeDaRizzo = () => (
  <RestaurantPage
    restaurantName="Stapferstube da Rizzo"
    address="Culmannstrasse 45, Zurich, 8006, Switzerland"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+41443501100"
    website="https://www.stapferstube.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here at Stapferstube, a well-known Zurich eatery, Italian dishes such as tris di pasta della casa, gamberoni aglio olio peperoncino, and brasato di manzo al Barolo are a hit with diners. In this vibrant and welcoming restaurant, regulars and first-time guests alike are treated to Mediterranean hospitality and a cosy atmosphere. Their quick lunch at a reasonable price is also popular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Culmannstrasse%2045%2C%20Zurich%2C%208006%2C%20Switzerland"
    pageTitle="Stapferstube da Rizzo"
  />
);

export default StapferstubeDaRizzo;
