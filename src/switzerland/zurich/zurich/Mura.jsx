...
const Mura = () => (
  <RestaurantPage
    restaurantName="MURA"
    address="Fröhlichstrasse 39, Zurich, 8008, Switzerland"
    cuisine="Japanese Contemporary"
    priceRange="€€€€"
    phoneNumber="+41443832139"
    website="http://www.mura39.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this restaurant in the heart of the popular Seefeld quarter, contemporary Japanese cuisine is the name of the game. At lunchtime, the deluxe bento boxes are a good option; the evening meal revolves around an omakase menu comprising 11-12 courses. The interior is appealingly minimalist, with clean lines, warm wood tones and Far Eastern decorative touches. The atmosphere is friendly and the service attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fr%C3%B6hlichstrasse%2039%2C%20Zurich%2C%208008%2C%20Switzerland"
    pageTitle="MURA"
  />
);
