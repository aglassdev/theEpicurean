...
const Ameo = () => (
  <RestaurantPage
    restaurantName="AMEO"
    address="Zentralstrasse 36, Zurich, 8003, Switzerland"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+41446200180"
    website="https://www.ameo-restaurant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant certainly lives up to its tagline of fine dining with arts. The creative cuisine takes inspiration from an in-house art exhibition, which changes every quarter. Chef Julien Mühlebach and sommelier Maximilian Dullinger, who met and became friends while working at EquiTable, have joined forces and opened their own intimate dining spot. The decor is deliberately pared down and minimalist, keeping the focus firmly on the food and the art. The surprise tasting menu – four, five or six courses, as well as an optional cheese course – showcases locally sourced ingredients from small-scale producers. Diners can expect precisely crafted dishes that are rife with original combinations, resulting in striking contrasts in flavour and texture. The friendly front-of-house team provides de..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zentralstrasse%2036%2C%20Zurich%2C%208003%2C%20Switzerland"
    pageTitle="AMEO"
  />
);
