...
const LoftFive = () => (
  <RestaurantPage
    restaurantName="LOFT FIVE"
    address="Europaallee 15, Zurich, 8004, Switzerland"
    cuisine="Contemporary, International"
    priceRange="€€€"
    phoneNumber="+41447555050"
    website="https://www.loftfive.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish restaurant stands directly on Europaallee, not far from the railway station (Hauptbahnhof). But it's not only the chic interior and relaxed atmosphere that are inviting – the food is also a definite draw! Flavoursome modern-inspired international cuisine is on the menu. The service is friendly and competent, and there is a good selection of wines and cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Europaallee%2015%2C%20Zurich%2C%208004%2C%20Switzerland"
    pageTitle="LOFT FIVE"
  />
);

export default LoftFive;
