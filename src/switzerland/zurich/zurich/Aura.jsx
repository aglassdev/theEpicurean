...
const Aura = () => (
  <RestaurantPage
    restaurantName="AURA"
    address="Bleicherweg 5, Zurich, 8001, Switzerland"
    cuisine="Meats and Grills, Grills"
    priceRange="€€€"
    phoneNumber="+41444481144"
    website="https://www.aura-zurich.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stylishly urban restaurant, a top-flight events venue, a lounge or a club? AURA is a little bit of each, but above all the place to be for lovers of modern crossover cuisine with a weakness for grilled food – just watch the chefs at work! Located near Paradeplatz in the old stock exchange building...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bleicherweg%205%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="AURA"
  />
);
