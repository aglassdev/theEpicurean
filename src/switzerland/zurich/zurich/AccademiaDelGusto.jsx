...
const AccademiaDelGusto = () => (
  <RestaurantPage
    restaurantName="Accademia del Gusto"
    address="Rotwandstrasse 48, Zurich, 8004, Switzerland"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+41442416243"
    website="https://www.accademiadelgusto.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is a smash hit with its many regulars, which is hardly surprising considering the terrific food and lively and buzzing atmosphere. Over time, various dishes have achieved classic status. While Stefano Piscopo conjures up delectable creations such as home-made pasta (eg veal ravioli with sage butter) or marinated tuna tartare, his charming wife presides front-of-house. The handful of tables on the pavement tend to get snapped up quickly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rotwandstrasse%2048%2C%20Zurich%2C%208004%2C%20Switzerland"
    pageTitle="Accademia del Gusto"
  />
);

export default AccademiaDelGusto;
