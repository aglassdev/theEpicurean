...
const Blooms = () => (
  <RestaurantPage
    restaurantName="blooms"
    address="Kurhausstrasse 65, Zurich, 8000, Switzerland"
    cuisine="Vegan, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+41444566000"
    website="https://www.thedoldergrand.com/restaurant-blooms/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a beautiful terraced garden on the third floor of a modern annexe, this outdoor restaurant is a highlight of The Dolder Grand luxury hotel. It is truly idyllic to sit on the little individual terraces on the edge of the forest, surrounded by vegetable beds, fruit bushes, herbs and blooming flowers. A striking red sculpture by artist Keith Haring stands out against this backdrop of greenery. This intriguing concept is the brainchild of Heiko Nieder, who, alongside a dedicated team led by sous-chef Robin Briner, serves up vegan cuisine with a modern, seasonal twist – think tomato and strawberry salad with peperoncini and pumpkin seeds, or cabbage roulade with herbs and a shallot and caraway jus. Order à la carte, or opt for the Chef's Choice set menu, which comprises four to six cours..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kurhausstrasse%2065%2C%20Zurich%2C%208000%2C%20Switzerland"
    pageTitle="blooms"
  />
);
