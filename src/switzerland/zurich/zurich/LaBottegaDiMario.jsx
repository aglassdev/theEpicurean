...
const LaBottegaDiMario = () => (
  <RestaurantPage
    restaurantName="La Bottega di Mario"
    address="Nüschelerstrasse 6, Zurich, 8001, Switzerland"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+41442271922"
    website="https://www.labottegadimario.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a historical building (1913), La Bottega is a wonderfully inviting and lively ristorante and salumeria under one roof. Guests are spoilt for choice between the tasty dishes, clearly influenced by Ticino tradition, and the superb selection of salami and ham at the counter – here, the friendly mastri salumieri serve up the cold cuts. Tip: Try the house wine, Merlot di Ticino, poured from a six-litre bottle!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=N%C3%BCschelerstrasse%206%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="La Bottega di Mario"
  />
);

export default LaBottegaDiMario;
