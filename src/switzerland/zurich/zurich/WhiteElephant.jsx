...
const WhiteElephant = () => (
  <RestaurantPage
    restaurantName="White Elephant"
    address="Neumühlequai 42, Zurich, 8006, Switzerland"
    cuisine="Thai"
    priceRange="€€"
    phoneNumber="+41443607322"
    website="https://www.whiteelephant.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant at the Zurich Marriott Hotel is a must for fans of authentic Thai cuisine. Made with market fresh produce, the food is authentic and authentically spicy! Whatever you do, don’t miss the curries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Neum%C3%BChlequai%2042%2C%20Zurich%2C%208006%2C%20Switzerland"
    pageTitle="White Elephant"
  />
);
