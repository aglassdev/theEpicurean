...
const Bianchi = () => (
  <RestaurantPage
    restaurantName="Bianchi"
    address="Limmatquai 82, Zurich, 8001, Switzerland"
    cuisine="Seafood, Italian"
    priceRange="€€€"
    phoneNumber="+41442629844"
    website="https://www.bindella.ch/gastronomie/bianchi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A slice of la dolce vita! Located right by the Limmat River, this ristorante boasts a bright and modern interior where excellent service comes courtesy of a cheerful and adept front-of-house team. Made with top-notch produce, the Mediterranean-style fish and seafood dishes here are in high demand. Gorgeous little terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Limmatquai%2082%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="Bianchi"
  />
);
