...
const BrasserieSd = () => (
  <RestaurantPage
    restaurantName="Brasserie Süd"
    address="Bahnhofplatz 15, Zurich, 8001, Switzerland"
    cuisine="Seasonal Cuisine, International"
    priceRange="€€"
    phoneNumber="+41442443215"
    website="https://brasserie-sued.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This place has the potential to become a mecca for foodies! Located directly in the main railway station building, this restaurant is ideal for a meal when you are waiting for a connecting train, but it also attracts business people and locals. Within an attractive historical setting (notably the high ceiling and large arched windows), diners can immerse themselves in a vibrant brasserie atmosphere, or head to the outdoor terrace overlooking Bahnhofstrasse. The cuisine is seasonal and international, and there are daily specials. Complementing the menu is an intriguing wine list highlighting French and Swiss labels and featuring a well-curated selection of wines by the glass. Adept and well-organised service. Tip: Bouillabaisse is served every Friday; brunch at weekends. For top-notch cockt..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bahnhofplatz%2015%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="Brasserie Süd"
  />
);

export default BrasserieSd;
