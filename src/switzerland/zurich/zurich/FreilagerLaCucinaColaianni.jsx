...
const FreilagerLaCucinaColaianni = () => (
  <RestaurantPage
    restaurantName="Freilager La Cucina Colaianni"
    address="Freilagerstrasse 53, Zurich, 8047, Switzerland"
    cuisine="Italian, French"
    priceRange="€€€€"
    phoneNumber="+41444920909"
    website="https://www.restaurant-freilager.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Celebrity chef Antonio Colaianni runs this stylishly designed fine dining restaurant in the Albisrieden neighbourhood with maître d' Marco Però, and it makes for a perfect complement to their Trattoria, which is housed in the same building. Born in Italy, he wows diners with Italian and French dishes, balancing tradition and innovation with finesse. This is beautifully showcased in his five-course menu featuring dishes such as Tonno Rosso – bluefin tuna and king crab, or Tre Volte Manzo – fillet, shoulder and essence of beef with Périgord truffle. Made by his mother Maria, the orecchiette warrant a special mention. He serves these with polpettine and tomato sauce. The chef makes a point of visiting tables personally and usually brings his dishes himself. Open Thu-Sat. Things get underway a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Freilagerstrasse%2053%2C%20Zurich%2C%208047%2C%20Switzerland"
    pageTitle="Freilager La Cucina Colaianni"
  />
);

export default FreilagerLaCucinaColaianni;
