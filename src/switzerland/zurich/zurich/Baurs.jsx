...
const Baurs = () => (
  <RestaurantPage
    restaurantName="Baur's"
    address="Talstrasse 1, Zurich, 8001, Switzerland"
    cuisine="International, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+41442205020"
    website="https://www.bauraulac.ch"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chic, rather imposing deluxe brasserie of the famous Baur au Lac hotel does full justice to the top-notch spirit of gastronomy with which the grand hotel is synonymous. It serves international cuisine firmly rooted in the classics and made with excellent ingredients. The wine list is compiled by one of the best sommeliers in the world...."
