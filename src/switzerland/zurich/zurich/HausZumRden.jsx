...
const HausZumRden = () => (
  <RestaurantPage
    restaurantName="Haus zum Rüden"
    address="Limmatquai 42, Zurich, 8001, Switzerland"
    cuisine="International, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+41442619566"
    website="https://www.haus-zum-rueden.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautiful guild house on the Münsterbrücke bridge, only a stone’s throw from the town hall, dates back to 1348, as does the unique 11m-wide wooden barrel-vaulted ceiling in the Gothic Room. Dishes are based on seasonal ingredients and include classics such as Zurich-style veal and mushroom ragout in a cream sauce. Less expensive menu at lunchtime, plus a selection of dishes available in the modern bar with a terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Limmatquai%2042%2C%20Zurich%2C%208001%2C%20Switzerland"
    pageTitle="Haus zum Rüden"
  />
);

export default HausZumRden;
