...
const Kserei = () => (
  <RestaurantPage
    restaurantName="Käserei"
    address="Crusch Plantaun 217, Brail, 7527, Switzerland"
    cuisine="Cheese, Fondue and Raclette, Swiss"
    priceRange="€€"
    phoneNumber="+41818512000"
    website="https://www.inlain.ch/de/kulinarik/kaeserei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a modern yet rustic feel and a cosy atmosphere is located in the former cowshed of a typical Engadin house. The restaurant still has a focus on cows and dairy products today, serving dishes such as cheese fondues, raclette, capuns and even Chinese fondue. Cheese-making demonstrations are held regularly in the evenings...."
