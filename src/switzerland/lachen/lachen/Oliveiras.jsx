...
const Oliveiras = () => (
  <RestaurantPage
    restaurantName="Oliveiras"
    address="Sagenriet 1, Lachen, 8853, Switzerland"
    cuisine="International, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+41554426949"
    website="https://www.oliveiras.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The friendly Oliveira family runs this establishment, making sure guests feel at home in the harmonious and deliberately informal atmosphere. They are attentively looked after as they tuck into Mediterranean cuisine made from excellent produce. All of this is accompanied by a fantastic selection of wines from the owner's Portuguese homeland...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sagenriet%201%2C%20Lachen%2C%208853%2C%20Switzerland"
    pageTitle="Oliveiras"
  />
);

export default Oliveiras;
