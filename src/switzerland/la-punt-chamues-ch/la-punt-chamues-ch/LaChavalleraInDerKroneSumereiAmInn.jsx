...
const LaChavalleraInDerKroneSumereiAmInn = () => (
  <RestaurantPage
    restaurantName="LA CHAVALLERA in der Krone Säumerei am Inn"
    address="Via Cumünela 2, La Punt-Chamues-ch, 7522, Switzerland"
    cuisine="Modern Cuisine, Alpine"
    priceRange="€€€€"
    phoneNumber="+41818541269"
    website="https://krone-lapunt.ch/de/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the time-honoured Krone, your dedicated hosts – the well-travelled James Baron (previously chef at the MICHELIN-starred Amber in Hong Kong) and his charming wife Natacha – have honed an interesting concept, which has the kitchen produce precise, pared-back dishes made with top-notch ingredients that reflect the restaurant's ties to the region. In addition to the four-, six- or nine-course tasting menu, there is a seasonal à la carte selection. The space is also extremely inviting: Entirely done out in Swiss stone pine, the compact dining space brims with atmosphere, further fuelled by the presence of the attentive staff. An interesting touch: The cutlery is made by a local blacksmith. Modern Alpine-style guestrooms are available for overnight stays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Cum%C3%BCnela%202%2C%20La%20Punt-Chamues-ch%2C%207522%2C%20Switzerland"
    pageTitle="LA CHAVALLERA in der Krone Säumerei am Inn"
  />
);

export default LaChavalleraInDerKroneSumereiAmInn;
