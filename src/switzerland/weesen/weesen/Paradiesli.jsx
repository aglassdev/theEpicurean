...
const Paradiesli = () => (
  <RestaurantPage
    restaurantName="Paradiesli"
    address="Obere Betliserstrasse 12, Weesen, 8872, Switzerland"
    cuisine="Organic, Farm to table"
    priceRange="€€"
    phoneNumber="+41556111179"
    website="https://paradiesli-betlis.ch/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="The journey to the village of Betlis may not be the most straightforward (the road from Weesen is only open for five minutes at a time on the half hour or hour), but the stunning elevated location more than compensates with a view of nearby Lake Walen and the mountain landscape. There is greenery at every turn – on the terrace in particular you feel like you are in a corner of paradise. The interior is attractive and sleek, its wooden decor exuding traditional charm, fostering a pleasingly unpretentious and relaxed atmosphere. Choose between small plates such as pickled vegetables or lettuce leaves, herb quark, popped buckwheat and larger dishes such as pork cheeks (organic, Uelihof), Serviettenknödel (bread dumplings), raw fennel salad. Alternatively there are three versions of the set me..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Obere%20Betliserstrasse%2012%2C%20Weesen%2C%208872%2C%20Switzerland"
    pageTitle="Paradiesli"
  />
);

export default Paradiesli;
