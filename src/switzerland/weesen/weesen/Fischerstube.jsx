...
const Fischerstube = () => (
  <RestaurantPage
    ...
    address="Marktgasse 9, Weesen, 8872, Switzerland"
    cuisine="Seafood, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+41556161608"
    website="https://www.fischerstubeweesen.ch/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this long-established restaurant, Alain Koenig serves up dishes that are pleasingly down-to-earth and packed with flavour. Fish takes centre stage, but there are also a few meat and vegetarian options. You can dine à la carte or opt for one of two set menus: Complet (four courses) and Degustation (three to six courses). The tasteful decor is classically elegant in style, the service attentive and friendly. Decent wine list. Tip: For private dining or celebrations, book the historical vaulted cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Marktgasse%209%2C%20Weesen%2C%208872%2C%20Switzerland"
    pageTitle="Fischerstube"
  />
);

export default Fischerstube;
