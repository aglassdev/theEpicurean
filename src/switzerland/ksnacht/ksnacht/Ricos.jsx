...
const Ricos = () => (
  <RestaurantPage
    ...
    address="Seestrasse 160, Küsnacht, 8700, Switzerland"
    cuisine="Mediterranean Cuisine, French Contemporary"
    priceRange="€€€€"
    phoneNumber="+41449100715"
    website="https://www.ricozandonella.ch/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A restaurant with a special atmosphere! Cosy, colourful and packed with art – a tastefully eclectic blend of styles and highly individual decorative details. In addition, the service is pleasingly laid-back and professional. Classic cuisine with Mediterranean influences is served in the form of a three- to eight-course set menu. To accompany it, choose from the nicely curated wine list, which has a particularly good selection from Switzerland and France. There is a set lunch menu Wed-Fri. In summer, it is pleasant to sit in the small garden behind the restaurant. Tip for anyone looking for a venue for private events: you can book Rico's Privé...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Seestrasse%20160%2C%20K%C3%BCsnacht%2C%208700%2C%20Switzerland"
    pageTitle="RICO'S"
  />
);
