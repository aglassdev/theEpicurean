...
const Ruths = () => (
  <RestaurantPage
    restaurantName="Ruths"
    address="Mäster Johansgatan 11, Malmo, 21121, Sweden"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+4640121318"
    website="https://ruthsmalmo.se/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The open kitchen takes centre stage at this buzzy all-day café/bakery/deli, which has been wholeheartedly embraced by the locals. Lunchtime snacks and salads make room for generously sized, boldly flavoured Mediterranean dishes at dinner. Most of the wines on the concise list are available on-tap...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=M%C3%A4ster%20Johansgatan%2011%2C%20Malmo%2C%2021121%2C%20Sweden"
    pageTitle="Ruths"
  />
);

export default Ruths;
