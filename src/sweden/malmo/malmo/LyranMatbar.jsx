...
const LyranMatbar = () => (
  <RestaurantPage
    restaurantName="Lyran Matbar"
    address="Simrishamnsgatan 36a, Malmo, 214 35, Sweden"
    cuisine="Modern Cuisine, Swedish"
    priceRange="€€"
    phoneNumber="+46763245228"
    website="https://www.lyranmatbar.se"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a pleasingly relaxed air at this small, simply styled restaurant, where the experienced team lead the service with a friendly smile. Upstairs it’s more about drinks, so if you’re here to dine then head down the spiral staircase to the rustic cellar. The well-balanced tasting menus come in Mixed, Pescetarian and Vegetarian versions and are created daily from the best local produce available. All you are presented with is a list of ingredients, which are then turned into modern Swedish creations such as ‘yellow beet, skyr, pistachio, cedrat, fennel pollen, burned butter and sherry’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Simrishamnsgatan%2036a%2C%20Malmo%2C%20214%2035%2C%20Sweden"
    pageTitle="Lyran Matbar"
  />
);

export default LyranMatbar;
