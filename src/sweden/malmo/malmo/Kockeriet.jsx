...
const Kockeriet = () => (
  <RestaurantPage
    restaurantName="Kockeriet"
    address="Norra Vallgatan 28, Malmo, 211 25, Sweden"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+464079606"
    website="https://www.kockeriet.se/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a characterful 17C former grain warehouse, owned by Malmö-born TV chef Tareq Taylor, a young and talented team prepare well-balanced contemporary dishes with great precision. Scandinavian produce is at its heart, with some coming from the kitchen garden. The timbered dining room is relaxed and inviting, the service friendly, and the drinks pairings well-conceived...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Norra%20Vallgatan%2028%2C%20Malmo%2C%20211%2025%2C%20Sweden"
    pageTitle="Kockeriet"
  />
);

export default Kockeriet;
