...
const Vstergatan = () => (
  <RestaurantPage
    restaurantName="Västergatan"
    address="Västergatan 16, Malmo, 211 21, Sweden"
    cuisine="Swedish"
    priceRange="€€"
    phoneNumber="+464079313"
    website="https://www.vastergatan.se"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owned and run by a friendly couple – Olle, who cooks, and Sophie, who looks after the service – this unpretentious city centre bistro has certainly stood the test of time, with 2025 marking its 20th year. This is thanks, in part, to the flavour-packed dishes, where good quality regional ingredients are brought together in harmonious, visually appealing combinations. The four-course set menu changes with the seasons, featuring the likes of cod with blue mussels, beach rose and pink peppercorn, followed by grapefruit with ginger and black lime – wine and juice flights are available to accompany...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=V%C3%A4stergatan%2016%2C%20Malmo%2C%20211%2021%2C%20Sweden"
    pageTitle="Västergatan"
  />
);

export default Vstergatan;
