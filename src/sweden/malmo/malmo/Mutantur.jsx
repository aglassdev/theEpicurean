...
const Mutantur = () => (
  <RestaurantPage
    restaurantName="Mutantur"
    address="Erik Dahlbergsgatan 12-14, Malmo, 211 42, Sweden"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber=""
    website="https://restaurantmutantur.se/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This laid-back, semi-industrial style restaurant comes with exposed brick walls, polished concrete floors, silver ducting and large windows that let in plenty of light. The kitchen counter bends round to become the bar – you can eat here or at the surrounding black tables – and the good value menu offers plenty of options in the form of small plates, allowing you build your meal however you please. Local flavours lead the way, but come with international accents, from oyster with tiger milk, coriander, Swedish vinegar and sweetcorn cream to beef tartare with green tomato, baked yolk and horseradish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Erik%20Dahlbergsgatan%2012-14%2C%20Malmo%2C%20211%2042%2C%20Sweden"
    pageTitle="Mutantur"
  />
);

export default Mutantur;
