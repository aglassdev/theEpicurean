...
const JhMatbar = () => (
  <RestaurantPage
    restaurantName="JH matbar"
    address="Stora Östergatan 34, Ystad, 27134, Sweden"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+4641110810"
    website="https://jhmatbar.se/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You will find this bistro at the southern tip of Sweden, in the centre of a small town with picturesque streets that provided the setting for the Wallander detective TV series. The good value menu offers a wide choice of dishes, with vegetarians and vegans well catered for. Scandinavian produce powers many of the modern dishes, which are prepared and presented with real care...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stora%20%C3%96stergatan%2034%2C%20Ystad%2C%2027134%2C%20Sweden"
    pageTitle="JH matbar"
  />
);

export default JhMatbar;
