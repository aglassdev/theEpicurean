...
const Poppy = () => (
  <RestaurantPage
    restaurantName="Poppy"
    address="Fjärde Långgatan 1, Gothenburg, 413 05, Sweden"
    cuisine="Seasonal Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+4631120214"
    website="https://www.restaurantpoppy.se/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef-Owner Tobias has created a fun little neighbourhood spot here at Poppy, where groups of friends sit shoulder to shoulder at wooden tables in a trendy bistro-style room. It’s a compact place, with room for just 24 diners – including four seats overlooking the kitchen – but that’s all part of its cosy appeal. The five-course tasting menu offers seasonal modern dishes like monkfish 'binchotan' with tomato gel, hazelnut butter emulsion and mussel broth. Unusually, there’s no wine list, just shelves filled with bottles, their prices marked on them in chalk...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fj%C3%A4rde%20L%C3%A5nggatan%201%2C%20Gothenburg%2C%20413%2005%2C%20Sweden"
    pageTitle="Poppy"
  />
);
