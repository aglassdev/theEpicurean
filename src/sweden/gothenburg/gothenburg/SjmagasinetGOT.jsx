...
const SjmagasinetGOT = () => (
  <RestaurantPage
    restaurantName="Sjömagasinet"
    address="Klippans Kulturreservat, Adolf Edelsvärds gata 5, Gothenburg, 414 51, Sweden"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+46317755920"
    website="https://www.sjomagasinet.se"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A charming split-level restaurant in an old 1775 East India Company warehouse; sit on the upper floor to take in the lovely harbour view. Cooking offers a pleasing mix of classic and modern dishes, with seafood kept to the fore. The wine list offers a good selection of top burgundies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Klippans%20Kulturreservat%2C%20Adolf%20Edelsv%C3%A4rds%20gata%205%2C%20Gothenburg%2C%20414%2051%2C%20Sweden"
    pageTitle="Sjömagasinet"
  />
);

export default SjmagasinetGOT;
