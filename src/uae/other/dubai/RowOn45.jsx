...
const RowOn45 = () => (
  <RestaurantPage
    restaurantName="Row on 45"
    address="45th Floor, Tower 2, Grosvenor House Hotel, Al Emreef Street, Dubai Marina, Dubai"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+971568324545"
    website="https://www.rowon45dubai.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This gastronomic venture comes from acclaimed British chef, Jason Atherton. Its name combines the acronym for its “refinement of work” and its location on the 45th floor of The Grosvenor House. A penthouse-like setting with an open kitchen, this intimate culinary experience seats 22 guests and offers a 17-course tasting menu divided into three acts. The dishes feature fine Japanese ingredients prepared with French techniques, such as amebi and bafun uni. The full menu is sophisticated, refined and immaculately presented, delivering well-judged and complex flavours. If you’re going to opt for the four-seater chef’s table, be sure to book well in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45th%20Floor%2C%20Tower%202%2C%20Grosvenor%20House%20Hotel%2C%20Al%20Emreef%20Street%2C%20Dubai%20Marina%2C%20Dubai"
    pageTitle="Row on 45"
  />
);

export default RowOn45;
