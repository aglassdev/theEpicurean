...
const TheSpaniel = () => (
  <RestaurantPage
    restaurantName="The Spaniel"
    address="Bluewaters Island, Dubai"
    cuisine="British Contemporary"
    priceRange="$$$"
    phoneNumber="+97145543728"
    website="https://www.thespanieldxb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set over two floors in Bluewaters Island’s The Wharf mall, this British brasserie is the perfect neighbourhood spot for homesick expats. The menu is full of British classics ranging from beef Wellington to Scotch egg and burnt Cambridge cream, some with a Dubai twist like their Welsh rarebit topped with truffle, all carefully prepared and full of flavour. The restaurant’s upper floor offers a spacious setting with a large bar counter – be sure to try a signature cocktails such as ‘London Calling’ or ‘A Long Night in Soho’. On Sundays, their traditional roast lunches are great for a family outing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bluewaters%20Island%2C%20Dubai"
    pageTitle="The Spaniel"
  />
);

export default TheSpaniel;
