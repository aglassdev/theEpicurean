...
const Revelry = () => (
  <RestaurantPage
    ...
    address="Building 1, Dubai Hills Estate Business Park, Dubai Hills, Dubai"
    cuisine="Indian"
    priceRange="$"
    phoneNumber="+971521432426"
    website="https://revelrydxb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Little sister to avatāra, which is directly next door, this Indian 'tapas bar' is more casual and informal in style, with a particularly good range of cocktails inspired by India’s vastly differing seasons. Inside the L-shaped room, the atmosphere is very relaxed with three TV screens showing sports games, including, unsurprisingly, cricket! The appealingly priced menu comprises a good range of well-crafted, balanced, and gently spiced contemporary Indian dishes, which combine tradition and modernity. Three ‘tapas’ and a main course should do the trick and will arrive when ready. Do leave room for the creative desserts, such as Bailey’s tiramisu with Kahlua rasmalai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Building%201%2C%20Dubai%20Hills%20Estate%20Business%20Park%2C%20Dubai%20Hills%2C%20Dubai"
    pageTitle="Revelry"
  />
);
