...
const IndegoByVineet = () => (
  <RestaurantPage
    restaurantName="Indego by Vineet"
    address="Tower 1, Grosvenor House Hotel, Al Emreef Street, Dubai Marina, Dubai"
    cuisine="Indian"
    priceRange="$$$"
    phoneNumber="+97143176000"
    website="https://www.indegobyvineet.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This brightly decorated, intimate Indian restaurant offers everything from street food inspired snacks to dishes from the griddle, tandoor, grill and stew pot, with plenty of options perfect for sharing. Spicing is delicate and presentation can be playful. Sit on the terrace overlooking the marina...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tower%201%2C%20Grosvenor%20House%20Hotel%2C%20Al%20Emreef%20Street%2C%20Dubai%20Marina%2C%20Dubai"
    pageTitle="Indego by Vineet"
  />
);

export default IndegoByVineet;
