...
const StayByYannickAllno = () => (
  <RestaurantPage
    restaurantName="STAY by Yannick Alléno"
    address="One&Only The Palm Hotel, West Crescent Road, The Palm Jumeirah, Dubai"
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+97144401010"
    ...
    bio="This elegant, high-ceilinged restaurant is exclusively set at the end of the Palm in a colonial-style property, which is breathtakingly opulent in design, with magical tropical gardens and a private dock. Inside, it’s luxurious without being stuffy, and service follows suit, with a team that are attentive and professional yet relaxed and personable. The cuisine is innovative, creative and intriguing, combining French tradition with modern culinary advances to create à la carte dishes and exclusive menus. The combination of flavours is harmonious, and dishes are cohesive, creating an unforgettable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=One%26Only%20The%20Palm%20Hotel%2C%20West%20Crescent%20Road%2C%20The%20Palm%20Jumeirah%2C%20Dubai"
    pageTitle="STAY by Yannick Alléno"
  />
);

export default StayByYannickAllno;
