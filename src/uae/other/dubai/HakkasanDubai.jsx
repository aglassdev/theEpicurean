...
const HakkasanDubai = () => (
  <RestaurantPage
    restaurantName="Hakkasan Dubai"
    address="Atlantis The Palm, Crescent Road, The Palm Jumeriah, Dubai"
    cuisine="Chinese, Contemporary"
    priceRange="$$$$"
    phoneNumber="+97144262626"
    website="https://www.hakkasan.com/dubai"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located within Atlantis the Palm Hotel, the Dubai outpost of this ever-growing global brand delivers all you need for a fun night out. It’s moodily lit, with smooth service, a party soundtrack, and lattice screens for added privacy. The best place to sit is in one of the booths to the side of the lounge and next to the back-lit blue bar. The menu of reimagined Chinese dishes includes all the Hakkasan classics, as well as a few exclusive to Dubai, such as the lychee lobster with yuzu pearl. If it’s spice you’re after, go for the Assam seafood toban. Created using quality ingredients, the accomplished dishes are colourful and vibrant with some punchy flavours. Save room for one of the creative desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Atlantis%20The%20Palm%2C%20Crescent%20Road%2C%20The%20Palm%20Jumeriah%2C%20Dubai"
    pageTitle="Hakkasan Dubai"
  />
);

export default HakkasanDubai;
