...
const TangTown = () => (
  <RestaurantPage
    restaurantName="Tang Town"
    address="BFM 17, Fountain Views, Dubai Mall, Downtown, Dubai"
    cuisine="Chinese"
    priceRange="$$$"
    phoneNumber="+97144312888"
    website="https://tangtownrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Slightly hidden on the mezzanine floor of Dubai Mall’s China Town is this dimly lit Chinese restaurant. An ambient mood encompasses the space, while its menu boasts myriad Cantonese and Sichuan dishes made with prime ingredients, like Wagyu beef and Peking duck paired with caviar – dim sum and freshly baked egg tart are must-tries. Diners can also enjoy Chinese dancing performances in the evening on the small centre stage as they eat. Pro tip: enter through the residence’s door to avoid the busy mall’s foot traffic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=BFM%2017%2C%20Fountain%20Views%2C%20Dubai%20Mall%2C%20Downtown%2C%20Dubai"
    pageTitle="Tang Town"
  />
);

export default TangTown;
