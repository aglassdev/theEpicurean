...
const Rockfish = () => (
  <RestaurantPage
    restaurantName="Rockfish"
    address="Jumeirah Al Naseem Hotel, King Salman bin Abdulaziz Al Saud Street, Umm Suqeim 3, Dubai"
    cuisine="Seafood"
    priceRange="$$$$"
    phoneNumber="+97144323232"
    website="https://www.jumeirah.com/en/dine/dubai/rockfish"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This professionally run seafood restaurant, set in the Jumeirah Hotel, has a terrace overlooking the Burj Al Arab and its surrounding sea, and its light and airy interior has high ceilings, floral displays and a chic, exclusive feel. The concise menu showcases beautifully fresh fish and shellfish in precisely cooked, powerfully flavoured dishes; the Moka Tiramisu is also a must try. The wine list features a good range of Provençal rosé wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jumeirah%20Al%20Naseem%20Hotel%2C%20King%20Salman%20bin%20Abdulaziz%20Al%20Saud%20Street%2C%20Umm%20Suqeim%203%2C%20Dubai"
    pageTitle="Rockfish"
  />
);

export default Rockfish;
