...
const CarnivalByTrsind = () => (
  <RestaurantPage
    restaurantName="Carnival by Trèsind"
    address="Level P5, Burj Daman, 312 Al Sa'ada Street, Za'abeel, DIFC, Dubai"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+971522424262"
    website="https://carnivalbytresind.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fittingly brightly decorated with gilded trees and two huge dining pods. The Indian menu includes various street food inspired choices alongside seasonal themed plates; dishes are confidently cooked and lightly spiced, with the occasional modern touch. Don’t miss the chicken momo with candied onion and garlic, and their aamsutra dessert. Their lunch menu is appealing too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%20P5%2C%20Burj%20Daman%2C%20312%20Al%20Sa'ada%20Street%2C%20Za'abeel%2C%20DIFC%2C%20Dubai"
    pageTitle="Carnival by Trèsind"
  />
);

export default CarnivalByTrsind;
