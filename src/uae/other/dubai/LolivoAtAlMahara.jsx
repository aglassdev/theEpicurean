...
const LolivoAtAlMahara = () => (
  <RestaurantPage
    restaurantName="L’Olivo at Al Mahara"
    address="Burj Al Arab Jumeirah - Jumeirah Street, Dubai"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+971800323232"
    website="https://www.jumeirah.com/en/stay/dubai/burj-al-arab-jumeirah/dining/burj-al-arab-al-mahara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant may be on the ground floor of Burj Al Arab, but thanks to the aquarium around which the tables are wrapped, one is soon transported to another world. The base of the cooking is Italian and the menu includes some of the signature dishes from their mothership in Capri, but the kitchen also puts its own spin on many of the creations. The set menu offers an all-round experience and represents the best value. Service is attentive and charming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burj%20Al%20Arab%20Jumeirah%20-%20Jumeirah%20Street%2C%20Dubai"
    pageTitle="L’Olivo at Al Mahara"
  />
);

export default LolivoAtAlMahara;
