...
const ArianasPersianKitchen = () => (
  <RestaurantPage
    restaurantName="Ariana's Persian Kitchen"
    address="Atlantis The Royal, Crescent Road, The Palm Jumeriah, Dubai"
    cuisine="Persian"
    priceRange="$$$$"
    phoneNumber="+97144262500"
    ...
    pageTitle="Ariana's Persian Kitchen"
  />
);

export default ArianasPersianKitchen;
