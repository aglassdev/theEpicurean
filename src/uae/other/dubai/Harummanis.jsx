...
const Harummanis = () => (
  <RestaurantPage
    restaurantName="Harummanis"
    address="Al Wasl 51, Jumeirah, Jumeirah 1, Dubai"
    cuisine="Asian"
    priceRange="$$"
    phoneNumber="+971565361674"
    website="https://www.harummanissg.com/home-dxb"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the mango, Harummanis is a small but oh so welcoming Malay grill restaurant. It pays homage to the chef’s family’s hawker stall in Singapore, first established in 1992. The eatery’s ultra-sweet team complement the homey experience with their enthusiasm as they take you through the extensive menu. The food, mainly Malay, takes influences from numerous neighbouring countries and boasts perfectly spiced and balanced flavours, such as their delicious six-hour cooked rendang made with 20 spices. Be sure to come in a group as dishes are made for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Al%20Wasl%2051%2C%20Jumeirah%2C%20Jumeirah%201%2C%20Dubai"
    pageTitle="Harummanis"
  />
);

export default Harummanis;
