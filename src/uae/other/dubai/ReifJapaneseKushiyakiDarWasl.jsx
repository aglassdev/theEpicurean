...
const ReifJapaneseKushiyakiDarWasl = () => (
  <RestaurantPage
    restaurantName="REIF Japanese Kushiyaki - Dar Wasl"
    address="Unit 70, Dar Wasl Mall, Al Wasl Road, Dubai"
    ...
    bio="In the residential neighbourhood of Al Wasl, away from the city’s impressive skyscrapers, is a kushiyaki-inspired but friendly restaurant, offering far more than just grilled skewered meats and vegetables. The contemporary Japanese menu also covers a wide range of well-priced snacks, sushi and ramen, like their Tantamen ramen, raw salmon with crispy black rice and Wagyu steamed bun. Be sure to also save room for one of their creative desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%2070%2C%20Dar%20Wasl%20Mall%2C%20Al%20Wasl%20Road%2C%20Dubai"
    pageTitle="REIF Japanese Kushiyaki - Dar Wasl"
  />
);

export default ReifJapaneseKushiyakiDarWasl;
