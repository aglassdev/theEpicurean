...
const IlRistorantenikoRomito = () => (
  <RestaurantPage
    ...
    address="Bulgari Resort Dubai Hotel, Jumeirah Bay Island, Jumeirah 2, Dubai"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+97147775433"
    website="https://www.bulgarihotels.com/en_US/dubai/bars-and-restaurants/il-ristorante-niko-romito"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This uber-cool and stylish restaurant is located within the Bulgari Resort Hotel, and diners are cossetted from the moment they step through the door by the charming Italian team. The sleek, design-led interior boasts an impressive cocktail bar, and the atmosphere is intimate and romantic. The terrace overlooking the marina is the place to be, weather permitting. Experienced Italian chef Giacomo Amicucci cooks assured, sophisticated modern Italian dishes with precision. Many of the top-quality ingredients are flown in from Italy; fish dishes are a highlight, as is the pasta. For the full experience, plump for the ‘Degustazione’ menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bulgari%20Resort%20Dubai%20Hotel%2C%20Jumeirah%20Bay%20Island%2C%20Jumeirah%202%2C%20Dubai"
