...
const LaMarByGastnAcurio = () => (
  <RestaurantPage
    restaurantName="La Mar by Gastón Acurio"
    address="Atlantis The Royal, Crescent Road, The Palm Jumeriah, Dubai"
    cuisine="Peruvian"
    priceRange="$$$$"
    phoneNumber="+97444844098"
    website="https://www.atlantis.com/dubai/dining/la-mar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enthusiastic staff are here to greet you at this first-floor restaurant at the Atlantis The Royal hotel – the views are impressive and the DJ ensures the atmosphere never lets up. The large fish counter is busting with prime seafood and the menu is full of classic Peruvian dishes, from ceviche and tiraditos to anticuchos. A pisco sour will help you make your choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Atlantis%20The%20Royal%2C%20Crescent%20Road%2C%20The%20Palm%20Jumeriah%2C%20Dubai"
    pageTitle="La Mar by Gastón Acurio"
  />
);

export default LaMarByGastnAcurio;
