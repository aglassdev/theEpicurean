...
const SufretMaryam = () => (
  <RestaurantPage
    restaurantName="Sufret Maryam"
    address="Wasl 51 - Jumeirah - Jumeirah 1, Dubai"
    cuisine="Middle Eastern"
    priceRange="$"
    phoneNumber="+971504172272"
    website="https://sufretmaryam.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This second venture from Bait Maryam chef Salam Dakkak is another homage to her mother. Meaning “Maryam’s Dining Table” in Arabic, the restaurant’s homey feel is reflected across the Palestinian art adorning the walls and menu. A plentiful supply of warm, freshly baked breads, including a stellar 48-hour fermented sourdough, and a selection of refined Levantine dishes are generous in flavour and in portions, so sharing is encouraged. Don’t miss the labneh crème brûlée topped with za'atar ice cream and sumac...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wasl%2051%20-%20Jumeirah%20-%20Jumeirah%201%2C%20Dubai"
    pageTitle="Sufret Maryam"
  />
);

export default SufretMaryam;
