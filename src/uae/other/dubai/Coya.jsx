...
const Coya = () => (
  <RestaurantPage
    restaurantName="Coya"
    address="Restaurant Village Four Seasons Resort Jumeirah Beach Road, Jumeirah 2, Dubai"
    cuisine="Peruvian"
    priceRange="$$$$"
    phoneNumber="+97143169600"
    website="https://coyarestaurant.com/restaurants/dubai/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the popular 'Restaurant Village' at the Four Seasons resort, this stylish restaurant brings all the intoxicating atmosphere and vibrant flavours of Latin America to Dubai. Contemporary Peruvian and Nikkei dishes feature intense contrasts of texture and flavour and are great for sharing. Highlights include the wide range of ceviches and their Peruvian take on a pavlova made with sweetcorn meringue paired with mango ice cream and passionfruit yoghurt. The beautiful pisco bar adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Restaurant%20Village%20Four%20Seasons%20Resort%20Jumeirah%20Beach%20Road%2C%20Jumeirah%202%2C%20Dubai"
    pageTitle="Coya"
  />
);
