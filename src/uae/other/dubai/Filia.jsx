...
const Filia = () => (
  <RestaurantPage
    restaurantName="Fi'lia"
    address="70th Floor, SLS Dubai Hotel & Residences, Marasi Drive, Business Bay, Dubai"
    cuisine="Italian, Classic Cuisine"
    priceRange="$$"
    phoneNumber="+97146070770"
    website="https://slshotels.com/dubai/restaurants-and-bars/filia-dubai/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its name means ‘daughter’, highlighting the women leading the way in the kitchen, as well as the culinary knowledge passed down through the generations. Set on the 70th floor, it offers impressive views, while menus list everything from artisan pizza and traditional pastas, like spaghetti carbonara, to sea bass crudo. Save room for their desserts – the pavlova and limone in particular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70th%20Floor%2C%20SLS%20Dubai%20Hotel%20%26%20Residences%2C%20Marasi%20Drive%2C%20Business%20Bay%2C%20Dubai"
    pageTitle="Fi'lia"
  />
);

export default Filia;
