...
const AkiraBack = () => (
  <RestaurantPage
    ...
    address="5th Floor, W Dubai Hotel, West Crescent Road, The Palm Jumeirah, Dubai"
    cuisine="Japanese Contemporary"
    priceRange="$$$$"
    phoneNumber="+97142455800"
    website="https://www.akirabackdubai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on the fifth floor of the colourful W Hotel, this bright, modern restaurant features raised alcoves and a magical terrace with breathtaking views of the city skyline. The professional staff are happy to make recommendations and the creative Japanese cuisine comes with Korean and international flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5th%20Floor%2C%20W%20Dubai%20Hotel%2C%20West%20Crescent%20Road%2C%20The%20Palm%20Jumeirah%2C%20Dubai"
    pageTitle="Akira Back"
  />
);

export default AkiraBack;
