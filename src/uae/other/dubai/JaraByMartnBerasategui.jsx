...
const JaraByMartnBerasategui = () => (
  <RestaurantPage
    restaurantName="JARA by Martín Berasategui"
    address="18th Floor, The Lana, Marasi Drive, Business Bay, Dubai"
    cuisine="Basque"
    priceRange="$$$$"
    phoneNumber="+97145417755"
    website="https://www.dorchestercollection.com/dubai/the-lana/dining/jara-by-martin-berasategui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the 18th floor of The Lana hotel is internationally renowned chef Martín Berasategui’s restaurant, named after his eldest granddaughter. Its décor is modern and luxurious and styled like a brasserie in dark tones. The eatery’s open kitchen is where chefs prepare the Basque dishes on an open fire and on charcoal grills. Start with charcoal-grilled octopus, Galician-style potatoes with paprika, tomato tartare with fresh and dried tomatoes; then enjoy their range of grilled steaks and be sure to order the Basque cheesecake. Opt for a seat on the terrace for uninterrupted views of Downtown Dubai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18th%20Floor%2C%20The%20Lana%2C%20Marasi%20Drive%2C%20Business%20Bay%2C%20Dubai"
    pageTitle="JARA by Martín Berasategui"
  />
);

export default JaraByMartnBerasategui;
