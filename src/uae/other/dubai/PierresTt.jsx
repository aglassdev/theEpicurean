...
const PierresTt = () => (
  <RestaurantPage
    restaurantName="Pierre's TT"
    address="InterContinental Dubai Festival City Hotel, promenade level, Dubai"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+97147011199"
    website="https://www.pierresdubai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Joyfully ostentatious décor, a modern bistro vibe and a delightful setting overlooking Dubai Creek make this a great spot for a night out. Menus showcase Pierre Gagnaire classics, contemporary French fare alongside, pastas, raw crudo, and if you fancy something simpler, a pizza or burger from their 'Casual' menu is worth a try. Desserts are top tier here and be sure to ask for a table on the terrace to enjoy Dubai Festival City’s ‘Imagine’ laser light and fountain show...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=InterContinental%20Dubai%20Festival%20City%20Hotel%2C%20promenade%20level%2C%20Dubai"
    pageTitle="Pierre's TT"
  />
);

export default PierresTt;
