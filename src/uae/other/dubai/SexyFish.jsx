...
const SexyFish = () => (
  <RestaurantPage
    ...
    address="Innovation One, 11th floor, DIFC, Dubai"
    cuisine="Japanese, Asian"
    priceRange="$$$$"
    phoneNumber="+97143819000"
    website="https://sexyfishdubai.me/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s nothing low-key about this striking restaurant. A Damien Hirst octopus welcomes you in the small reception area on the ground floor, before you’re whisked up in a glass lift to a dimly lit restaurant mimicking a seabed and glittered with under-the-sea elements in every corner. Their equally eye-catching dishes take inspiration from Japan and other Asian flavours and are perfect for sharing. Catch a glimpse of the iconic city views on the balcony terrace and their bathroom is definitely worth taking a selfie in!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Innovation%20One%2C%2011th%20floor%2C%20DIFC%2C%20Dubai"
    pageTitle="Sexy Fish"
  />
);

export default SexyFish;
