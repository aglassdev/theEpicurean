...
const Mott32 = () => (
  <RestaurantPage
    restaurantName="Mott 32"
    address="Address Beach Resort, The Walk, Jumeriah Beach Residence, Dubai"
    cuisine="Cantonese"
    priceRange="$$$$"
    phoneNumber="+97142784832"
    website="https://mott32.com/dubai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The 73rd floor of Address Beach Resort was the chosen venue for Dubai’s branch of this ever-expanding chain and the views are predictably stunning. As with all their restaurants, the owners didn’t spare any expense when it came to the decoration – this is a sumptuously furnished spot. The carefully prepared food is largely Cantonese, but applewood roasted Peking duck is a speciality and there are also some Sichuan dishes on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Address%20Beach%20Resort%2C%20The%20Walk%2C%20Jumeriah%20Beach%20Residence%2C%20Dubai"
    pageTitle="Mott 32"
  />
);

export default Mott32;
