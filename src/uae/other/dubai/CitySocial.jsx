...
const CitySocial = () => (
  <RestaurantPage
    ...
    address="43rd Floor, Tower 2, Grosvenor House Hotel, Al Emreef Street, Dubai Marina, Dubai"
    cuisine="Modern Cuisine"
    priceRange="$$$$"
    phoneNumber="+97144022222"
    website="https://www.citysocialdubai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Commanding views from its perch on the 43rd floor of the Grosvenor House hotel are not the only attraction of this branch of the Jason Atherton empire.  The extensive menu offers something for everyone, including pasta dishes and a wide choice of dry-aged steaks which are cooked over charcoal. Kick off your experience with a cocktail on the intimate and elegant outside terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43rd%20Floor%2C%20Tower%202%2C%20Grosvenor%20House%20Hotel%2C%20Al%20Emreef%20Street%2C%20Dubai%20Marina%2C%20Dubai"
    pageTitle="City Social"
  />
);

export default CitySocial;
