...
const LittleMissIndia = () => (
  <RestaurantPage
    restaurantName="Little Miss India"
    address="Fairmont The Palm, Palm Jumeirah, Dubai"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+97144573457"
    website="https://www.fairmont.com/en/hotels/dubai/fairmont-the-palm/dining/little-miss-india.restaurant.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dine in the brightly decorated bar, in the sumptuous dining room or out on the glorious terrace with its views over the water; the setting is romantic and the cheerful staff go out of their way to please. Carefully executed Indian cooking exhibits bold yet balanced spicing; the homemade chutneys are delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fairmont%20The%20Palm%2C%20Palm%20Jumeirah%2C%20Dubai"
    pageTitle="Little Miss India"
  />
);

export default LittleMissIndia;
