...
const TascaByJosAvillez = () => (
  <RestaurantPage
    restaurantName="Tasca by José Avillez"
    address="Mandarin Oriental Jumeira Hotel, 6th Floor, Jumeirah Beach Road, Jumeirah 1, Dubai"
    cuisine="Portuguese"
    priceRange="$$$"
    phoneNumber="+97147772231"
    website="https://www.mandarinoriental.com/dubai/jumeira-beach/fine-dining/restaurants/portugal-cuisine/tasca-by-jose-avillez"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the 6th floor of the chic, beachside Mandarin Oriental Jumeira, is this bustling yet relaxed spot set around an open kitchen, with an infinity pool on its terrace and sea and city views. The attentive service team ensure your dining experience is well-paced and eminently enjoyable. The chef and his team understand the importance of great quality produce and showcase a passion for Portuguese culinary traditions. The resulting vibrant dishes offer Portuguese flavours with a modern edge. The menu offers something for everyone, with plenty of dishes to share; leave room for dessert to taste their freshly baked pastéis de nata!This restaurant is temporarily closed for refurbishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mandarin%20Oriental%20Jumeira%20Hotel%2C%20Jumeirah%20Beach%20Road%2C%20Jumeirah%201%2C%20Dubai"
    pageTitle="Tasca by José Avillez"
  />
);

export default TascaByJosAvillez;
