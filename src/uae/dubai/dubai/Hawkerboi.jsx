...
const Hawkerboi = () => (
  <RestaurantPage
    restaurantName="Hawkerboi"
    address="The Park, Jumeirah Lake Towers, Dubai"
    cuisine="Asian"
    priceRange="$$"
    phoneNumber="+971504275217"
    website="https://eatx.com/hawkerboi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What started as a secret supper club, gathering all the key elements of famous hawker markets, is now a relaxed restaurant in the JLT neighbourhood. A friendly and caring team guide you through the subtleties of the street foods of Singapore, Malaysia, Thailand and Myanmar. Generously sized dishes are made with fresh produce, seasoned with aromatic condiments, spices and a large variety of herbs resulting in a flavour-packed experience. Don’t miss the fish curry – a tribute to the chef’s mother's recipe – and the caramelised pineapple pie with yoghurt ice cream made to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Park%2C%20Jumeirah%20Lake%20Towers%2C%20Dubai"
    pageTitle="Hawkerboi"
  />
);

export default Hawkerboi;
