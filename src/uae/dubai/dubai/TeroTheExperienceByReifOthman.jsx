...
const TeroTheExperienceByReifOthman = () => (
  <RestaurantPage
    ...
    pageTitle="TERO - The Experience by Reif Othman"
  />
);

export default TeroTheExperienceByReifOthman;
