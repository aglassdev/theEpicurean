...
const OrfaliBros = () => (
  <RestaurantPage
    restaurantName="Orfali Bros"
    address="Wasl 51 Mall, Jumeirah 1, Dubai"
    cuisine="Contemporary, Middle Eastern"
    priceRange="$$$"
    phoneNumber="+97142592477"
    website="https://www.orfalibros.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Three Syrian brothers own and run this deservedly popular restaurant: a light and airy space dominated by a striking, two-storey open kitchen. Original, playful small plates are Mediterranean at their core but display global influences. The cooking seamlessly delivers bold, complex and balanced flavours, as well as a lovely contrast of textures. Dishes are made to share – highlights include the playful 'Come with me to Aleppo', the punchy tuna, salsa roja and any of the immaculately-made, beautiful gateaux-based desserts. For the full experience, don't miss the tasting menu. Service is endearing, relaxed and super-friendly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wasl%2051%20Mall%2C%20Jumeirah%201%2C%20Dubai"
    pageTitle="Orfali Bros"
  />
);

export default OrfaliBros;
