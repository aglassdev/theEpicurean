...
const CLaVi = () => (
  <RestaurantPage
    restaurantName="CÉ LA VI"
    address="The Address Sky View Tower 2, Sheikh Mohammed bin Rashid Boulevard, Dubai"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+97145826111"
    website="https://www.celavi.com/en/dubai/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Dubai outpost of this fashionable restaurant group is set on the 54th floor of the Address Sky View Hotel. It comes with a party atmosphere and a bird’s eye view over the city from its super terrace, and service is friendly and professional. Contemporary dishes have influences ranging from a mix of Mediterranean, such as fried calamari and spinach rigatoni, to Japanese classics, such as nigiri and beef kushiyaki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Address%20Sky%20View%20Tower%202%2C%20Sheikh%20Mohammed%20bin%20Rashid%20Boulevard%2C%20Dubai"
    pageTitle="CÉ LA VI"
  />
);

export default CLaVi;
