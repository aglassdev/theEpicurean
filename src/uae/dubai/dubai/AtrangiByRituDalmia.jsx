...
const AtrangiByRituDalmia = () => (
  <RestaurantPage
    restaurantName="Atrangi by Ritu Dalmia"
    address="207, Jumeirah Al Qasr Hotel, Al Safouh First, Dubai"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+971551680802"
    website="https://www.atrangidubai.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=207%2C%20Jumeirah%20Al%20Qasr%20Hotel%2C%20Al%20Safouh%20First%2C%20Dubai"
    pageTitle="Atrangi by Ritu Dalmia"
  />
);

export default AtrangiByRituDalmia;
