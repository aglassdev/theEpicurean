...
const BrasserieBoulud = () => (
  <RestaurantPage
    restaurantName="Brasserie Boulud"
    address="Wafi City, Sheikh Rashid Road, Dubai"
    cuisine="French, Classic Cuisine"
    priceRange="$$"
    phoneNumber="+97142814020"
    website="https://www.sofitel-dubai-theobelisk.com/restaurants-bars/brasserie-boulud/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Creating a little piece of France in Sofitel Dubai The Obelisk is this classically styled brasserie deluxe with its marble flooring, red leather banquettes and art deco touches. In a spacious setting inspired by acclaimed chef Daniel Boulud, the restaurant’s appealing menu offers all the French classics from escargots and canard rôti to tarte Tatin and île flottante. It also has a good value business lunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wafi%20City%2C%20Sheikh%20Rashid%20Road%2C%20Dubai"
    pageTitle="Brasserie Boulud"
  />
);

export default BrasserieBoulud;
