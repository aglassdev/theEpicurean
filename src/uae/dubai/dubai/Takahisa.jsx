...
const Takahisa = () => (
  <RestaurantPage
    restaurantName="TakaHisa"
    address="34JC+67 Banyan Tree - Bluewaters Island - Dubai - United Arab Emirates"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+97145566688"
    website="https://takahisa.ae/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="TakaHisa combines the names of the two head chefs; one specialises in A5 Graded Kobe beef, the other in fish that’s flown in from Toyosu Market. There are tables, booths and counters in this good-looking restaurant at the Banyan Tree Hotel, but if you’re going for the omakase – which is the best way of experiencing both sushi and Kobe – then a counter seat is best. Prices aren’t for the fainthearted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=First%20Floor%2C%20Banyan%20Tree%20Dubai%2C%20Palace%20Tower%2C%20Dubai"
    pageTitle="TakaHisa"
  />
);

export default Takahisa;
