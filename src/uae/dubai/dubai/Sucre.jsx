...
const Sucre = () => (
  <RestaurantPage
    ...
    address="Gate Village 5, DIFC, Dubai"
    cuisine="Latin American"
    priceRange="$$$"
    phoneNumber="+97143400829"
    website="https://sucredubai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You're guaranteed a lively night out at this fashionable spot with its buzzy bar and huge open kitchen. Sharing plates combine Latin American and global influences and the open fire is used to good effect, so expect some bold and punchy flavours. The engaging team further enhance the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gate%20Village%205%2C%20DIFC%2C%20Dubai"
    pageTitle="Sucre"
  />
);
