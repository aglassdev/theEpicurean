...
const OneOneWoodfire = () => (
  <RestaurantPage
    restaurantName="11 Woodfire"
    address="Villa 11, 75B Street, Jumeirah 1, Dubai"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+97144919000"
    website="https://www.11woodfire.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Industrial styling, intimate lighting and a laid-back feel are the hallmarks of this striking modern villa conversion in the residential suburb of Jumeirah – along with the huge open kitchen and grill which gives the restaurant its name. The variety and excellent quality of global ingredients are grilled to perfection over oak, hickory or hay, each of which impart their own distinctive flavour. The talented kitchen has the know-how to keep things simple, enhancing the skilfully cooked dishes subtly with well-judged seasoning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Villa%2011%2C%2075B%20Street%2C%20Jumeirah%201%2C%20Dubai"
    pageTitle="11 Woodfire"
  />
);

export default OneOneWoodfire;
