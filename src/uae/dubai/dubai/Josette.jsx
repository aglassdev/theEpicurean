...
const Josette = () => (
  <RestaurantPage
    ...
    cuisine="French"
    priceRange="$$$$"
    phoneNumber="+97142752522"
    website="https://www.josette.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s glamour galore at this grand French restaurant; come with friends for dinner to really experience it at its best, with its live music and DJ – and there’s even a button on each table to summon the champagne. No expense has been spared in the decoration and the menu is an appealing roll-call of classic French dishes, with everything from escargots to tournedos Rossini...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=ICD%20Brookfield%20Place%2C%20DIFC%2C%20Dubai"
    pageTitle="Josette"
  />
);
