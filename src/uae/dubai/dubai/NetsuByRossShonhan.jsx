...
const NetsuByRossShonhan = () => (
  <RestaurantPage
    restaurantName="Netsu by Ross Shonhan"
    address="Mandarin Oriental Jumeira Hotel, Jumeirah Beach Road, Jumeirah 1, Dubai"
    cuisine="Japanese Contemporary"
    priceRange="$$"
    phoneNumber="+97147772232"
    website="https://www.mandarinoriental.com/dubai/jumeira-beach/fine-dining/restaurants/japanese-cuisine/netsu-by-ross-shonhan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Japanese steakhouse delivers a theatrical culinary experience thanks to the large open kitchen which takes centre stage. The cavernous room is light and airy, and menu highlights include dishes cooked over rice straw on the Warayaki grill. Start with the tuna tataki, followed by a Wagyu steak...."
    ...
    pageTitle="Netsu by Ross Shonhan"
  />
);

export default NetsuByRossShonhan;
