...
const Clap = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+97145693820"
    website="https://www.claprestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Private lifts whisk you up to the 9th floor, where you enter this chic, modern restaurant with a sizeable cocktail bar and a buzzy vibe. The menu is a roll-call of Japanese classics, from sushi, sashimi and shrimp tempura to mains like miso cod. The rooftop terrace with its city views is the place to be...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gate%20Village%2011%2C%20DIFC%2C%20Dubai"
    pageTitle="Clap"
  />
);
