...
const DuoGastrobardubaiHills = () => (
  <RestaurantPage
    restaurantName="DUO Gastrobar-Dubai Hills"
    address="Building 4, Dubai Hills Estate Business Park, Dubai Hills, Dubai"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+971526866249"
    website="https://duodubai.ae/homepage/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Dubai Hills neighbourhood is the outpost of a small restaurant group from St. Petersburg. This contemporary eatery has a light and airy atmosphere, thanks to its sleek blond wood furnishings, cream décor, high ceiling, and buzzy open kitchen. Diners can opt for an appealing breakfast menu, as well as a hearty lunch with a well-priced selection. This place offers a good range of modern, flavourful dishes, where Asian influences and European accents are found in parallel. Their signature dishes are worth trying, especially the oxtail pie with Tallegio. The well-trained staff work smoothly and discreetly to ensure a charming experience...."
    ...
    pageTitle="DUO Gastrobar-Dubai Hills"
  />
);

export default DuoGastrobardubaiHills;
