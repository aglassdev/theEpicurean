...
const AvliByTashas = () => (
  <RestaurantPage
    restaurantName="Avli BY TASHAS"
    address="Unit C01, Gate Village 9, DIFC, Dubai"
    cuisine="Greek"
    priceRange="$$$$"
    phoneNumber="+97143590008"
    website="https://www.avlibytashas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Expectations are exceeded at this bright, dapper-looking restaurant in the DIFC. Its owner is of Greek heritage, and the extensive menu offers authentic, carefully cooked Greek dishes made from quality ingredients. Enjoy mezze, salads and seafood alongside classics such as feta saganaki and lamb youvetsi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%20C01%2C%20Gate%20Village%209%2C%20DIFC%2C%20Dubai"
    pageTitle="Avli BY TASHAS"
  />
);

export default AvliByTashas;
