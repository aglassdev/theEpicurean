...
const Gerbou = () => (
  <RestaurantPage
    restaurantName="Gerbou"
    address="Street 20, Nadd Al Sheba Road, Nad Al Sheba 1, Dubai"
    cuisine="Emirati Cuisine"
    priceRange="$$"
    phoneNumber="+97142226888"
    website="https://www.gerbou.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Emirati hospitality is front and centre of this ‘humble abode’ located in Dubai’s Nad Al Sheba neighbourhood. Everything, from the heritage building in which it’s located to the banquettes blending with camel leather chairs, and from the warm and charming team to the all-encompassing menu of classic dishes, highlights the rich local culture. The authentic and carefully executed dishes, such as mezze, chicken machboos, salads and sandwiches, are ideal for sharing, while the fwala tray is a great way to experience ‘high tea’ the Emirati way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Street%2020%2C%20Nadd%20Al%20Sheba%20Road%2C%20Nad%20Al%20Sheba%201%2C%20Dubai"
    pageTitle="Gerbou"
  />
);

export default Gerbou;
