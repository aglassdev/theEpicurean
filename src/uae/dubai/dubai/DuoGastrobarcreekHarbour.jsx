...
const DuoGastrobarcreekHarbour = () => (
  <RestaurantPage
    restaurantName="DUO Gastrobar-Creek Harbour"
    address="Grand Creek Harbour Residence, Tower 2, Dubai Creek Harbour, Dubai"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+971527567663"
    website="https://creek.duodubai.ae"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled on Dubai Creek Harbour’s promenade is the second branch of this popular restaurant. Overlooking the harbour and the city’s skyline, this bright eatery shares a similar style to the original in Dubai Hills, with bright wood, eye-catching modern elements, a buzzing open kitchen, and a friendly service team. The appealing, well-priced menu offers an array of unfussy, refined comfort food. Particular favourites include a hearty beef cheek with onion gratin and an unmissable homemade lemonade...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand%20Creek%20Harbour%20Residence%2C%20Tower%202%2C%20Dubai%20Creek%20Harbour%2C%20Dubai"
    pageTitle="DUO Gastrobar-Creek Harbour"
  />
);

export default DuoGastrobarcreekHarbour;
