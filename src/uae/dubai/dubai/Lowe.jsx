...
const Lowe = () => (
  <RestaurantPage
    restaurantName="LOWE"
    address="KOA Canvas, Wadi Al Safa 3, Dubai"
    cuisine="Contemporary"
    priceRange="Average price per person $59"
    phoneNumber="971 4 320 1890"
    website="https://www.lowe-dubai.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="An appealing, original restaurant located near Dubai, green oasis, Al Barari. It’s a trendy spot with pared-back style, a relaxed vibe and a sustainable ethos. The impressive open kitchen features a wood oven, a grill and a rotisserie, which play a key role in many of the global dishes. Some plates are perfect for sharing; the whole roasted local sole, curry leaf and caper butter vinaigrette is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=KOA%20Canvas%2C%20Wadi%20Al%20Safa%203%2C%20Dubai"
    pageTitle="LOWE"
  />
);
