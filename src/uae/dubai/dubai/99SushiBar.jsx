...
const NineNineSushiBar = () => (
  <RestaurantPage
    restaurantName="99 Sushi Bar"
    address="Sheikh Mohammed bin Rashid Boulevard, Dubai"
    cuisine="Japanese Contemporary"
    priceRange="$$$$"
    phoneNumber="+97145472241"
    website="https://www.99sushibar.com/en/99-sushi-bar-dubai/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its prime, raised position and smart outdoor terrace lend an element of glamour to this Japanese restaurant. The wide-ranging menu covers all the bases, with plenty of sushi – both modern and traditional – on offer. The robata grill is used to particularly good effect and there’s also a well-priced set lunch for those short on time. The service team are helpful and attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sheikh%20Mohammed%20bin%20Rashid%20Boulevard%2C%20Dubai"
    pageTitle="99 Sushi Bar"
  />
);

export default NineNineSushiBar;
