...
const Hseki = () => (
  <RestaurantPage
    restaurantName="Hōseki"
    address="Bulgari Resort Dubai Hotel, 4th Floor, Jumeirah Bay Island, Jumeirah 2, Dubai"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+97147775433"
    website="https://www.bulgarihotels.com/en_US/dubai/bars-and-restaurants/japanese-restaurant-hoseki"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This little ‘gem’ of a restaurant, set on the fourth floor of the Bulgari Hotel, is elegance personified, with understated, clean-lined décor and stunning views over the Dubai skyline. 18 counter seats make for a comfortable, intimate meal, where sixth-generation sushi master Masahiro Sugiyama and his team show off their considerable knife skills. Taking the individual tastes of their guests into consideration, they blend them with prime ingredients imported from Japan to create a rich omakase experience unique to each diner. This is refined, technically adept and beautifully presented cuisine – and the warm service from staff dressed in traditional kimonos further adds to the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bulgari%20Resort%20Dubai%20Hotel%2C%204th%20Floor%2C%20Jumeirah%20Bay%20Island%2C%20Jumeirah%202%2C%20Dubai"
    pageTitle="Hōseki"
  />
);

export default Hseki;
