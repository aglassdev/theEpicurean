...
const Zuma = () => (
  <RestaurantPage
    ...
    priceRange="$$$"
    phoneNumber="+97144255660"
    website="https://zumarestaurant.com/locations/dubai/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Dubai outpost of this global brand is set over three floors and comes with trendy, contemporary styling, several sushi counters and a lively atmosphere. Super-fresh, high quality ingredients are prepared with dexterity. Flavours are superb and the charming staff provide friendly, efficient service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gate%20Village%206%2C%20DIFC%2C%20Dubai"
    pageTitle="Zuma"
  />
);
