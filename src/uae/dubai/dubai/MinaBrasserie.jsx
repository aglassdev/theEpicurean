...
const MinaBrasserie = () => (
  <RestaurantPage
    restaurantName="Mina Brasserie"
    address="Gate Village, Building 3 - towards DIFC Parking - Trade Centre - DIFC - Dubai - United Arab Emirates"
    cuisine="Mediterranean Cuisine"
    priceRange="$$$$"
    phoneNumber="+97142707960"
    website="https://www.minabrasserie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Michael Mina is a chef best-known in the USA and here at the Four Seasons he now has this brightly decorated and impeccably run brasserie de-luxe as the backdrop for his menu of equally sunny French and Mediterranean classics. From a host of fresh salads to seafood and wood-grilled steaks, there’s something for everyone and all occasions. Look out too for the good value mid-week menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%2C%20Dubai%20International%20Financial%20Center%2C%20Dubai"
    pageTitle="Mina Brasserie"
  />
);

export default MinaBrasserie;
