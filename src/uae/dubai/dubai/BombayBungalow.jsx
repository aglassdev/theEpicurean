...
const BombayBungalow = () => (
  <RestaurantPage
    restaurantName="Bombay Bungalow"
    address="The Beach Mall, Unit 2301, JBR Walk,, Dubai"
    cuisine="Indian"
    priceRange="$"
    phoneNumber="+9718006928779"
    website="https://www.bombaybungalowdxb.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fun, modern Indian restaurant is open from breakfast onwards and is set right by the beach, so you can sit on the terrace and watch the world go by. Choose from street food, kebabs and classic curries: cooking is fresh, authentic and well-priced, and the caring service adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Beach%20Mall%2C%20Unit%202301%2C%20JBR%20Walk%2C%2C%20Dubai"
    pageTitle="Bombay Bungalow"
  />
);

export default BombayBungalow;
