...
const LaVidBodegaNorton = () => (
  <RestaurantPage
    restaurantName="La Vid - Bodega Norton"
    address="Ruta 15, km 23, Mendoza, M5509, Argentina"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+5492613728497"
    website="https://www.norton.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We’re not understating anything when we say that Luján de Cuyo, at the foot of the Andes mountains, is always worth visiting. And once you’re here, the century-old Norton wine estate is a splendid option. The reason? Its wines, obviously, but also the delightful gardens designed by landscape gardener Carlos Thays, an array of interesting wine-focused excursions (tours, tastings, bike trips etc), South America’s largest underground cellar, plus this restaurant, which showcases Mendoza’s local recipes and native ingredients and products (cured trout, marinated pork, river crab, goat’s cheese etc). The chef at the helm, Facundo Di Fabrizio, has revived the full flavours of the local region on two tasting menus (4 and 6 courses) based around an updated take on traditional cuisine and accompani..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ruta%2015%2C%20km%2023%2C%20Mendoza%2C%20M5509%2C%20Argentina"
    pageTitle="La Vid - Bodega Norton"
  />
);

export default LaVidBodegaNorton;
