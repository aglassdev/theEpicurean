...
const LosBocheros = () => (
  <RestaurantPage
    restaurantName="Los Bocheros"
    address="Roque Sáenz Peña 8450, Mendoza, M5549, Argentina"
    cuisine="Traditional Cuisine"
    priceRange="$$"
    phoneNumber="+5492615111125"
    website="https://www.lamadridwines.com/restaurante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the Lamadrid Estate Wines bodega, in the district of Las Compuertas, this restaurant is known for its honest and generous cuisine, and a continual desire to revive the culinary traditions of Mendoza, hence its name, which refers to players of the game “bocce”. The delightful surroundings here take centre stage with picture windows looking out on to the covered terrace and meticulous landscaped garden. On the menu you’ll find charcoal-grilled dishes, select cuts of meat, typical specialities such as the signature Empanada Los Bocheros filled with meat and a mix of fresh herbs, and delicious ribs that that are cooked at low temperature. Combining his work here with other culinary projects elsewhere, renowned chef Lucas Olcese also showcases his cooking on a single 4- or 7-course tast..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Roque%20S%C3%A1enz%20Pe%C3%B1a%208450%2C%20Mendoza%2C%20M5549%2C%20Argentina"
    pageTitle="Los Bocheros"
  />
);

export default LosBocheros;
