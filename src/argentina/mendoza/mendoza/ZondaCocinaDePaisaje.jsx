...
const ZondaCocinaDePaisaje = () => (
  <RestaurantPage
    restaurantName="Zonda Cocina de Paisaje"
    address="San Martín 1745 Bodega Lagarde, Mendoza, M5507, Argentina"
    cuisine="Traditional Cuisine, Creative"
    priceRange="$$$"
    phoneNumber="+5492613023412"
    website="https://www.lagarde.com.ar/experiencias/zonda"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Transplanting raw ingredients from the field to the plate takes on added value when they are grown on your farm, bringing added personality to dishes and enhancing the culinary narrative when it comes to building recipes. The Lagarde winery in Luján de Cuyo is famous for the excellent quality of its wines (DOC Malbec) and for the fact that it has its own organic fruit and vegetable gardens (tomatoes, lettuce, sweet peppers, chard, pomegranates, aromatic herbs etc), in addition to olives and other crops that it supplies to the restaurant. At Zonda Cocina de Paisaje, the goal is to pay homage to cuisine with a local DNA that is simple, honest in concept but then elevated to haute cuisine standard via delicate textures and fine presentation. In its elegant, rustically inspired dining room, wi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=San%20Mart%C3%ADn%201745%20Bodega%20Lagarde%2C%20Mendoza%2C%20M5507%2C%20Argentina"
    pageTitle="Zonda Cocina de Paisaje"
  />
);

export default ZondaCocinaDePaisaje;
