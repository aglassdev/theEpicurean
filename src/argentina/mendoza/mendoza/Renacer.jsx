...
const Renacer = () => (
  <RestaurantPage
    restaurantName="Renacer"
    address="Brandsen 1863, Mendoza, M5507, Argentina"
    cuisine="Argentinian"
    priceRange="$$$"
    phoneNumber="+5492613166555"
    website="https://www.bodegarenacer.com.ar/restaurante"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Patricio Reich, founder of the Renacer winery, has revealed the secret to his wines: “A combination of three key factors – our staff, the unique Mendoza terroir, and our passion for excellence”. Alongside these attributes, it was important not to neglect gastronomy when it came to understanding the bodega’s surroundings, hence the idea of offering a complete experience that allows guests to discover more about the region from every angle. The restaurant itself is located in a separate annexe to the winery and features a pleasant lakeside terrace with romantic views of both the Tuscan-inspired stone tower and the imposing Andes cordillera. A visit here usually starts with a short visit to the bodega, with its steel fermentation tanks and barrel storeroom, and a stroll through the vineyards,..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brandsen%201863%2C%20Mendoza%2C%20M5507%2C%20Argentina"
    pageTitle="Renacer"
  />
);
