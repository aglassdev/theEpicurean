...
const LaVida = () => (
  <RestaurantPage
    ...
    address="Viamonte 5022, Mendoza, M5505, Argentina"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+542615707097"
    website="https://www.susanabalbohotels.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Vida is part of the Susana Balbo Winemaker's House & Spa Suites, a small luxury hotel in Chacras de Coria, a small town 13km from Mendoza, where everything revolves around wine. After the approach along a tree-lined track, the first thing to strike you here is the highly attentive service – you are met at the door and accompanied to the bar, and from there, with a welcome cocktail in hand, there’s an option of exploring this family hacienda before heading to your table to learn about the property’s history and admire its works of art. In the restaurant’s contemporary-style dining room, with its glass-fronted kitchen and exposed beams which add a certain character, choose between two up-to-date menus (seven and fourteen courses designed by chef Flavia Amad Di Leo, who is also in charge o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Viamonte%205022%2C%20Mendoza%2C%20M5505%2C%20Argentina"
    pageTitle="La Vida"
  />
);
