...
const OneEightEightFourFrancisMallmann = () => (
  <RestaurantPage
    restaurantName="1884 Francis Mallmann"
    address="Belgrano 1188, Mendoza, M5500, Argentina"
    cuisine="Traditional Cuisine, Argentinian"
    priceRange="$$$$"
    phoneNumber="+5492617590022"
    website="https://1884restaurante.com.ar"
    tags={[]}
    awards={[
      {"name":"World's 50 Best · No. 7","organization":"The World's 50 Best Restaurants","year":"2003","image":"/images/worlds50best.png"},
    ].filter(Boolean)}
    bio="The idea of creating a restaurant inside a wine cellar is not a new one, but there’s always a pioneering first in every destination. In this case, the honour goes to Francis Mallmann, an Argentinian chef who was keen to develop the concept after an eye-opening trip to the Napa Valley in California. This restaurant, located at the Escorihuela Gascón bodega in the department of Godoy Cruz, was founded in 1884, hence the reference in its name, and features a contemporary dining room, a bar space and a pleasant terrace, where you’ll find the grill, the wood store and the roasting oven. The cuisine is based around a single menu which pays full homage to local and traditional cooking, and features a choice of seven courses (we loved the baked Mendoza-style empanada and the rotola pasta with spin..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Belgrano%201188%2C%20Mendoza%2C%20M5500%2C%20Argentina"
    pageTitle="1884 Francis Mallmann"
  />
);

export default OneEightEightFourFrancisMallmann;
