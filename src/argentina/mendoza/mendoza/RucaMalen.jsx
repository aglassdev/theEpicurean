...
const RucaMalen = () => (
  <RestaurantPage
    restaurantName="Ruca Malen"
    address="Ruta Nacional 7 km. 1059, Bodega Ruca Malen, Mendoza, M5507, Argentina"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+542614541236"
    website="https://www.bodegarucamalen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the Ruca Malen winery, situated in Agrelo (in the department of Luján de Cuyo) just over half an hour to the south of Mendoza, guests can enjoy a dining experience that will live long in the memory. Its eponymous restaurant (the name comes from a Mapuche legend) takes a fresh, immersive look at the world of wine, with both the chef and the young sommelier wandering around the tables to chat with diners. Here, wine takes on major importance and has always been the key to everything, hence the choice of dishes on the 7-course tasting menu which have been deliberately created with the choice of wine pairings in mind (somewhat unusually, on the menu the wine is listed first in capital letters with the accompanying dish written in lowercase). The dishes themselves are highly contemporary, de..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ruta%20Nacional%207%20km.%201059%2C%20Bodega%20Ruca%20Malen%2C%20Mendoza%2C%20M5507%2C%20Argentina"
    pageTitle="Ruca Malen"
  />
);

export default RucaMalen;
