...
const AnnaBistr = () => (
  <RestaurantPage
    restaurantName="Anna Bistró"
    address="Juan B Justo 161, Mendoza, M5500, Argentina"
    cuisine="Traditional Cuisine"
    priceRange="$$"
    phoneNumber="+542614251818"
    website="https://annabistro.com.ar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located close to Mendoza’s railway station in the centre of the city, this welcoming restaurant pleasantly surprised us thanks to its informal bistro-style ambience, its high levels of comfort, including open-brick walls, large industrial “atelier” picture windows and charming terraces, with an abundance of trees and other vegetation. The chef at the helm here, Alejandro Galliski, embodies his culinary philosophy through a clear premise, namely: “If we have to eat to live, let’s make food a pleasure”. To make this idea a reality, he offers guests varied traditional cuisine with strong roots in the Mediterranean, a grounding in local ingredients, and clear French and Italian influences. On his extensive à la carte, standout dishes include a selection of fresh pastas (dishes such as haddock ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Juan%20B%20Justo%20161%2C%20Mendoza%2C%20M5500%2C%20Argentina"
    pageTitle="Anna Bistró"
  />
);

export default AnnaBistr;
