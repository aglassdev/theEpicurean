...
const Abrasado = () => (
  <RestaurantPage
    restaurantName="Abrasado"
    address="Lateral Norte Acceso Este 1360, Mendoza, M5519, Argentina"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+5492616618624"
    website="https://www.instagram.com/abrasadotoneles"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you rely on a restaurant’s list of awards when it comes to booking a table and if the delicious flavour of aged meats brings tears to your eyes, then the Abrasado restaurant (part of the Los Toneles winery not far from the centre of Mendoza - the recipient of various Best of Wine Tourism awards over the years) is the place for you! The dining room, located next to the spaces reserved for tastings and events, boasts a contemporary design and high ceilings, along with a maturing cabinet at the entrance and a bar to the rear with a resident bartender. Although Abrasado offers an extensive à la carte with an impressive array of fresh and aged meats (dry-aged ribeye, T-bone aged in black garlic, fillet steak aged in kombu) designed for sharing, the vast majority of guests opt for its set men..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lateral%20Norte%20Acceso%20Este%201360%2C%20Mendoza%2C%20M5519%2C%20Argentina"
    pageTitle="Abrasado"
  />
);

export default Abrasado;
