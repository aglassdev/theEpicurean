...
const Brindillas = () => (
  <RestaurantPage
    restaurantName="Brindillas"
    address="Guardia Vieja 2898, Mendoza, M5509, Argentina"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+5492615598684"
    website="https://www.brindillas.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated in an uninteresting and not particularly attractive area to the south of Mendoza (Vistalba, in the department of Luján de Cuyo), Brindillas is one of those intimate settings with excellent service that will win over food-lovers. Through dishes such as roasted aubergines with a Romesco sauce and salted anchovies, succulent grilled veal with ground pepper, sweet potato and chard, and caramelised peach with amaretto, a light mascarpone foam and home-made almond ice-cream, chef Mariano Gallego, who has worked with famous Spanish chef Carme Ruscalleda and was at the helm in one of her restaurants (Sant Pau, in Tokio), showcases his imagination and modern approach, which ensures that local ingredients are always to the fore. Choose between two tasting menus (short and long options) that..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Guardia%20Vieja%202898%2C%20Mendoza%2C%20M5509%2C%20Argentina"
    pageTitle="Brindillas"
  />
);

export default Brindillas;
