...
const AnglicaCocinaMaestra = () => (
  <RestaurantPage
    restaurantName="Angélica Cocina Maestra"
    address="Cobos s/n, Mendoza, M5509, Argentina"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+5492615076901"
    website="https://www.catenazapata.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant, the name of which pays homage to the mother of Nicolás Catena Zapata, showcases the authentic flavours of Mendoza from a modern perspective. The dining room, which is as imposingly impressive as the rest of the building, is part of the Catena Zapata winery in Agrelo (in the department of Luján de Cuyo), famous both for the quality of its wines and its design in the shape of a Mayan pyramid. Here, the duo of chefs at the helm, Josefina Diana and Juan Manuel Feijoo, boldly showcase their “Wine First” concept, where every aspect of their cooking revolves around wine, and not the other way round. They invite guests on a personalised tour of the facilities (a stroll through the winery and a glass of vermouth in the distillery room) before they seat you at a table where the focu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cobos%20s%2Fn%2C%20Mendoza%2C%20M5509%2C%20Argentina"
    pageTitle="Angélica Cocina Maestra"
  />
);

export default AnglicaCocinaMaestra;
