...
const CabaaLasLilas = () => (
  <RestaurantPage
    restaurantName="Cabaña Las Lilas"
    address="Avenida Alicia Moreau de Justo 516, Buenos Aires, C1107AAL, Argentina"
    cuisine="Meats and Grills, Barbecue"
    priceRange="$$$"
    phoneNumber="+541143131336"
    website="https://www.restaurantlaslilas.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you ask for advice on the best steakhouse for grilled Argentinian meat in Buenos Aires, this large-scale restaurant in Puerto Madero, featuring lots of private spaces and an open-view grill, is always mentioned. In this pleasant eatery with an elegant air overlooking the river, the undisputed star of the menu is its grilled meat (veal chitterlings, mixed offal, ribeye, Summus Rubaiyat picanha etc) from different breeds of cattle, although it also offers a good choice of cold plates, salads, fish of the day, and an impressive array of side dishes. The restaurant is located just a few metres from the century-old Corbeta ARA Uruguay museum ship and its renown is such that it is not unusual to see famous personalities dining here – past customers have included the likes of tennis player R..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Alicia%20Moreau%20de%20Justo%20516%2C%20Buenos%20Aires%2C%20C1107AAL%2C%20Argentina"
    pageTitle="Cabaña Las Lilas"
  />
);

export default CabaaLasLilas;
