...
const RepblicaDelFuego = () => (
  <RestaurantPage
    restaurantName="República del Fuego"
    address="Juncal 2682, Buenos Aires, C1425AYF, Argentina"
    cuisine="Grills, Argentinian"
    priceRange="$$"
    phoneNumber="+5491134778729"
    website="http://www.republicadelfuego.meitre.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re an inveterate meat-eater, you’ll want to head to the República de Fuego, a restaurant with a young and informal vibe occupying an old restored house in the city’s Recoleta district. In this setting, which has retained the homely feel of the original building and which has preserved several “vintage” features such as the original and delightful flooring, everything revolves around the traditional Argentinian grill. Dishes have a contemporary twist in their presentation and are always based around premium cuts of meat that chef Patricio Pessio prepares with the greatest of care. Highlights on the menu include “knife-cut” meat empanadas, stracciatella with grilled edamame, a delicious skirt steak with a Creole sauce, ribeye with a fresh herb butter, and grilled pears with a mascarpo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Juncal%202682%2C%20Buenos%20Aires%2C%20C1425AYF%2C%20Argentina"
    pageTitle="República del Fuego"
  />
);

export default RepblicaDelFuego;
