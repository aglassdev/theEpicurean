...
const Sottovoce = () => (
  <RestaurantPage
    ...
    address="Avenida del Libertador 1098, Buenos Aires, C1112ABN, Argentina"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+541148076691"
    website="https://www.sottovoce.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aubergine parmigiana, rotolo alla bolognese, black spaghetti with prawns, delicious home-made malfatti pasta filled with ricotta and spinach are just some of the dishes to savour at this corner restaurant opposite the Thays de Recoleta park, which takes its name from the French landscape architect Carlos Thays. Considered to be one of the city’s classic dining venues and one of its best Italian eateries, it is split between two floors, with a small terrace beneath the arches by the entrance. As well as its delicious home-made pasta (made with Candeal durum wheat and eggs), it also offers specialities that are hard to find anywhere else, such as brains alla siciliana. Sottovoce’s menus are decorated with drawings by the late Miguel Brascó, a famous Argentinian writer, humourist, illustrator..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20del%20Libertador%201098%2C%20Buenos%20Aires%2C%20C1112ABN%2C%20Argentina"
    pageTitle="Sottovoce"
  />
);

export default Sottovoce;
