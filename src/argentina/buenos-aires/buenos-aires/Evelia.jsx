...
const Evelia = () => (
  <RestaurantPage
    restaurantName="Evelia"
    address="Campos Salles 1712, Buenos Aires, C1429CEF, Argentina"
    cuisine="Italian, Argentinian"
    priceRange="$$"
    phoneNumber=""
    website="https://www.eveliarestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With dishes on the menu such as potato tortilla and Wagyu bresaola; gnocchi “a la sorrentina” with heritage tomato salsa, mozzarella and basil; and goat’s cheese capelletti with ricotta, saffron and lemon, this restaurant not far from the legendary Estadio Monumental, the home stadium of the Club Atlético River Plate football team, serves an array of globally inspired dishes. This world cuisine comes courtesy of owner-chef Máximo Togni, a successful entrepreneur who lived in the US for several years and who became the chef at the Argentinian embassy in Washington DC. His Italian-Buenos Aires-influenced à la carte is both extensive and attractive, featuring artisanal doughs personalised for each type of top-quality filled pasta, and Milanesa steaks that will live long in the memory, such as..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Campos%20Salles%201712%2C%20Buenos%20Aires%2C%20C1429CEF%2C%20Argentina"
    pageTitle="Evelia"
  />
);

export default Evelia;
