...
const RaggioOsteria = () => (
  <RestaurantPage
    restaurantName="Raggio Osteria"
    address="Gurruchaga 2121, Buenos Aires, C1425FEE, Argentina"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+541130823055"
    website="https://www.instagram.com/raggio.osteria/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gigli pasta with clams and mussels from the Mar del Plata, spaghetti alla Chitarra with a traditional carbonara sauce, conchiglioni alla Puttanesca, and the family’s own recipe for panna cotta are just some of the delights on offer in this contemporary-style restaurant on the ground floor of the Pleno Palermo Soho hotel, not far from the luxuriant Carlos Thays botanical garden, where Italian cuisine is the undoubted star of the show. Chef Sebastián Raggiante, who hails from Bologna (the capital of the northern Italian region of Emilia Romagna), reinterprets recipes from his homeland with an honest approach, with a primary focus on flavour and the use of the best zero-mile Argentinian ingredients. A dish that particularly impressed us was the “brasato di guancia” (cheek stew with tomatoes, ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gurruchaga%202121%2C%20Buenos%20Aires%2C%20C1425FEE%2C%20Argentina"
    pageTitle="Raggio Osteria"
  />
);

export default RaggioOsteria;
