...
const AjoNegroMarDeTapas = () => (
  <RestaurantPage
    restaurantName="Ajo Negro - Mar de Tapas"
    address="Avenida Córdoba 6237, Buenos Aires, C1427BZC, Argentina"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+541126700500"
    website="https://linktr.ee/ajonegrobar?fbclid=PAZXh0bgNhZW0CMTEAAaZPFCL14QEfDQmic1YsSeLg_5T8jNuw3w_GGQWHUWLga4flBvu9YXEdbdI_aem_ni__mgRVamMkAHQvx3DoyA"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We particularly enjoy variety and a sense of personality, hence our attraction to this relaxed industrial-style restaurant where everything revolves around informally, yet meticulously prepared fish, including tapas. Located in the heart of the Colegiales district, the overall feel here is original and fun. The decor features a large steel scaffolding-style bar counter (the tables are similar in design), colourful maritime-inspired murals and, in the centre of the room, a maturing cabinet that aims to add more flavour and new textures to some of the ingredients used here (bass, mullet, bream, bluefish, pollack, palometa etc). One of the most popular and successful starters here is the Pan Bao with panko prawns, wasabi mayo and grape or cucumber pickle, although the fresh fish of the day is..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20C%C3%B3rdoba%206237%2C%20Buenos%20Aires%2C%20C1427BZC%2C%20Argentina"
    pageTitle="Ajo Negro - Mar de Tapas"
  />
);

export default AjoNegroMarDeTapas;
