...
const Kn = () => (
  <RestaurantPage
    restaurantName="Kōnā"
    address="Castañeda 1899, Buenos Aires, C1428BBA, Argentina"
    cuisine="Japanese"
    priceRange="$$$"
    phoneNumber="+5491130514423"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/kona"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This collaboration between Narda Lepes and Inés de los Santos, one of the standout new restaurants of 2023, has been a roaring success. This semicircular wood structure on the corner (hence its name) of Castañeda street is definitely striking and comes with enough discreet Japanese design features to make you feel as though you’re sitting in the Shibuya district of Tokyo. Make sure you start (or finish) with a drink at the bar upstairs, perhaps sipping an “Ash”, its own version of a martini. The open kitchen is fully respectful of the traditions and flavours of Japanese cuisine, so don’t expect any extravagant combinations. The gyozas are a good way to kickstart proceedings, and then we recommended moving on to the Temaki and Nabe sections of the menu: the former come with delicious flavou..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Casta%C3%B1eda%201899%2C%20Buenos%20Aires%2C%20C1428BBA%2C%20Argentina"
    pageTitle="Kōnā"
  />
);
