...
const AFuegoFuerte = () => (
  <RestaurantPage
    restaurantName="A Fuego Fuerte"
    address="Estado De Palestina 1167, Buenos Aires, C1182ADM, Argentina"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+5491165937026"
    website="https://www.afuego-fuerte.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily closed for relocation) If you’re keen to enjoy an experience that makes you feel as though you’re eating in someone’s private house, this is the place for you. Ring the bell and you’ll be led into a large room with space for just 16 guests, each of whom is seated at impressively laid out tables adorned with ornamental crystal glassware. Supper starts at 9pm for everyone and lasts for 3 hours, during which the owner-chef, who makes regular forays into the dining room to chat with guests, conjures up a 17-course tasting menu. His culinary influences are mainly from France and Italy, although theatrical presentation and elaborately constructed dishes are also to the fore. Somewhat disguised beneath this culinary spectacle are high-quality ingredients and dishes such as veal with ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estado%20De%20Palestina%201167%2C%20Buenos%20Aires%2C%20C1182ADM%2C%20Argentina"
    pageTitle="A Fuego Fuerte"
  />
);

export default AFuegoFuerte;
