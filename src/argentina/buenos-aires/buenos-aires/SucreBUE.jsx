...
const SucreBUE = () => (
  <RestaurantPage
    restaurantName="Sucre"
    address="Mariscal Antonio José De Sucre 676, Buenos Aires, C1428DUB, Argentina"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+541147829082"
    website="https://www.sucrerestaurant.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Any mention of Sucre, situated in the section of the Belgrano district closest to the sea and the extensive Regatas lake, cannot be made without referring to Fernado Trocca, a man with an entrepreneurial vision who successfully expanded his business model to other countries (Sucre has Michelin-recommended subsidiaries in London and Dubai). This spacious setting with an urban-industrial vibe, in which the open kitchen, long bar and glass-fronted wine cellar stand out, is aimed at a cosmopolitan clientele in search of new experiences. Its cuisine is always centred around seasonal ingredients, many of which are organic, and includes a good selection of contemporary dishes with an international flair (“fish of the day” tiraditos, wild prawns sautéed in thyme butter, certified grass-fed beef co..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mariscal%20Antonio%20Jos%C3%A9%20De%20Sucre%20676%2C%20Buenos%20Aires%2C%20C1428DUB%2C%20Argentina"
    pageTitle="Sucre"
  />
);

export default SucreBUE;
