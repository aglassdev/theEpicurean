...
const Fervor = () => (
  <RestaurantPage
    restaurantName="Fervor"
    address="Posadas 1519, Buenos Aires, C1112ADA, Argentina"
    cuisine="Meats and Seafood, Grills"
    priceRange="$$$"
    phoneNumber="+541148044944"
    website="https://www.instagram.com/fervorbrasas?igsh=MXA5c3hoenVpNHZicA=="
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You won’t find a more traditional brasserie than this, with its black and white floor tiling, red leather banquettes, and efficient and experienced staff decked out in aprons, bow ties and waistcoats, all of which add to the sensation of being on a movie set – nor is it unusual to see passers-by pressing their noses against the windows here to glimpse the scene inside! If you’re a group of six and like to be the centre of attention, make sure you ask for table 16; but if your preference is to watch proceedings from above, book a table on the mezzanine. Here, everything revolves around fish and meat, with the latter undergoing a dry maturing process on the bone to ensure that cuts and fillets take on as much natural flavour as possible, in so doing enhancing their tenderness. Among the many..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Posadas%201519%2C%20Buenos%20Aires%2C%20C1112ADA%2C%20Argentina"
    pageTitle="Fervor"
  />
);
