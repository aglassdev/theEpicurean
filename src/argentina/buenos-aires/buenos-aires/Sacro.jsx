...
const Sacro = () => (
  <RestaurantPage
    restaurantName="Sacro"
    address="Costa Rica 6038, Buenos Aires, C1414BTN, Argentina"
    cuisine="Vegetarian"
    priceRange="$$"
    phoneNumber="+541139700215"
    website="http://www.sacro.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re on the lookout for a restaurant focusing on “plant -based” cuisine, this eatery on the ground floor of the CasaSur boutique hotel in the Palermo Hollywood is definitely worth considering – a sensation enhanced by its bright façade in different tones of white, featuring striking circular perforations that create contrast and add light. Its elongated layout boasts a modern design, and includes a pleasant terrace teeming with vegetation to the rear. Here, the contemporary à la carte showcases vegetarian dishes made to share which add a strong element of surprise. The aim of its starters (such as the unmissable kimchi-based dumplings with ginger foam and coriander, and the pleasing tartare of tomatoes with crunchy rice, capers and huancaina) and more hearty main courses (we particula..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Costa%20Rica%206038%2C%20Buenos%20Aires%2C%20C1414BTN%2C%20Argentina"
    pageTitle="Sacro"
  />
);

export default Sacro;
