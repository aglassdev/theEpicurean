...
const CasaCavia = () => (
  <RestaurantPage
    restaurantName="Casa Cavia"
    address="Cavia 2985, Buenos Aires, C1425DDA, Argentina"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+541148098600"
    website="https://www.casacavia.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If we were to look for an expression that defines the culinary philosophy of this restaurant occupying an attractive mansion in the Palermo Chico district, it would be “loyalty to local ingredients”. Casa Cavia boasts an elegantly classic interior which combines with the contemporary decor, but what is particularly striking here is the delightful terrace to the rear (embellished with a water feature in the middle) that has become a trendy setting where people come to eat but also to be seen. The chef at the helm, Julieta Caruso, showcases her cuisine on a concise contemporary-style à la carte where vegetables play a predominant role in dishes that are seemingly simply prepared but based around the very best ingredients. Her vegetarian recipes, which take pride of place here, are accompanie..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cavia%202985%2C%20Buenos%20Aires%2C%20C1425DDA%2C%20Argentina"
    pageTitle="Casa Cavia"
  />
);

export default CasaCavia;
