...
const Horta = () => (
  <RestaurantPage
    restaurantName="Horta"
    address="Francisco De Aguirre 1080, Buenos Aires, C1414ASV, Argentina"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+541130837942"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/horta-1217076"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The heart of Villa Crespo, a district that is becoming popular with foodies, is where the duo of Lucas Díaz and Clara Chavarría have set up shop, with the former in the kitchen and the latter front of house. Before opening their own eatery, this couple spent some time in the Algarve in Portugal (hence the name of the restaurant – “horta” is the Portuguese word for “vegetable or market garden”). They define their cuisine as “honest cooking” and this philosophy is clearly demonstrated in the dishes they create: “Every dish that we serve at Horta is an expression of our love for food and a homage to the bounty of nature and its wealth of flavours”. In this modern eatery, dominated by a white colour scheme and with a large round communal table on the small patio-terrace, the cuisine could be d..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Francisco%20De%20Aguirre%201080%2C%20Buenos%20Aires%2C%20C1414ASV%2C%20Argentina"
    pageTitle="Horta"
  />
);
