...
const Marti = () => (
  <RestaurantPage
    restaurantName="Marti"
    address="Rodríguez Peña 1973, Buenos Aires, C1021ABO, Argentina"
    cuisine="Vegetarian, Contemporary"
    priceRange="$$"
    phoneNumber="+541158487663"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/marti"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Germán Martitegui, who is well known thanks to his role as a judge on MasterChef, has given his cuisine a complete makeover, but one which is the complete opposite to the traditional Argentinian taste for meat. This is showcased via his “We do not kill animals” maxim and a 100% vegetarian menu (with vegan options) in this restaurant in the prosperous Recoleta district of the city. This bright and relaxed eatery occupying the former interior garden of a house is always full and comes as a pleasant surprise thanks to its casual atmosphere and discreet street access – the outside gives no inkling of what’s inside! Once you’ve rung the bell, you are escorted to a striking dining room with large picture windows and plenty of vegetation. There are no tables here; instead, you eat at the cen..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rodr%C3%ADguez%20Pe%C3%B1a%201973%2C%20Buenos%20Aires%2C%20C1021ABO%2C%20Argentina"
    pageTitle="Marti"
  />
);
