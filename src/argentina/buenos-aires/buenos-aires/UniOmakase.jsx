...
const UniOmakase = () => (
  <RestaurantPage
    restaurantName="Uni Omakase"
    address="Guatemala 5820, Buenos Aires, C1425BVN, Argentina"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+5491176159486"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/uni-omakase"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Omakase” is a Japanese term that effectively means leaving the menu to the complete discretion of the chef, who will normally source the best ingredients from the market that day. This philosophy is the key tenet in this restaurant located in the residential district of Palermo, now in the hands of chef Damián Shiizu, whose cuisine came as a very pleasant surprise to us. Once you’ve rung the bell at the entrance to confirm your booking, you need to wait until every guest has arrived before entering together and taking seats at the bar counter. The surprise menu here might include dishes such as marinated edemame cooked with soy, superb nigiri (sole, matured pejerrey fish, amberjack, torched squid etc), sashimi, temaki, and a delicious dashi soup. Small cups of sake are served throughout t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Guatemala%205820%2C%20Buenos%20Aires%2C%20C1425BVN%2C%20Argentina"
    pageTitle="Uni Omakase"
  />
);

export default UniOmakase;
