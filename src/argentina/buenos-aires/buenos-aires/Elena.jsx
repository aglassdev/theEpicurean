...
const Elena = () => (
  <RestaurantPage
    restaurantName="Elena"
    address="Posadas 1086/88, Buenos Aires, C1011ABB, Argentina"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+541143211200"
    website="https://www.fourseasons.com/es/buenosaires/dining/restaurants/elena"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If we were to rank the best Argentinian hotel restaurants, Elena, occupying the luxury Four Seasons Hotel Buenos Aires, would definitely figure high up on the list! Aesthetically inspired by the interior of old houses in the San Telmo district famous for its tango venues, it features a private dining room in the wine cellar and a main dining space brightened by a large glass dome, with an open kitchen to one side (note the ageing cabinets full of different cuts of meat). The culinary concept here, in what we would describe as a contemporary steakhouse, is traditional with meat (Angus sirloin, 45-day-aged Angus T-Bone, Argentinian wagyu ribeye etc) cooked on the Josper grill, but you can also order delicious ham and cheeseboards, catches of the day with different garnishes, as well as the o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Posadas%201086%2F88%2C%20Buenos%20Aires%2C%20C1011ABB%2C%20Argentina"
    pageTitle="Elena"
  />
);
