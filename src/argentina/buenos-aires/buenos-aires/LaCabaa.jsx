...
const LaCabaa = () => (
  <RestaurantPage
    restaurantName="La Cabaña"
    address="Avenida Alicia Moreau De Justo 580, Buenos Aires, C1107AAL, Argentina"
    cuisine="Traditional Cuisine"
    priceRange="$$$$"
    phoneNumber="+541143143710"
    website="https://www.lacabana.com.ar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This iconic eatery, where they unashamedly claim to have served “the world’s best meat since 1935”, has had a few locations over the years providing the backdrop for myriad anecdotes, but nowadays finds itself in the heart of the Puerto Madero waterfront district, just a few metres from Dock 4, where the legendary A.R.A. “Uruguay” corvette (now a floating museum) is moored. The restaurant’s interior has an exclusive, elegant feel, and provides the backdrop for traditional Argentinian cuisine where meats cooked on the parrilla grill take centre stage. Despite this focus, you can also enjoy an array of cold appetisers, empanadas, risottos, cannelloni etc. The cuts of meat here (Tomahawk, Rump Cap (Picanya) Wagyu, Dry Aged Ribeye etc) are of the highest quality but they say their speciality i..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Alicia%20Moreau%20De%20Justo%20580%2C%20Buenos%20Aires%2C%20C1107AAL%2C%20Argentina"
    pageTitle="La Cabaña"
  />
);

export default LaCabaa;
