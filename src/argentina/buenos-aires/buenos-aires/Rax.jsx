...
const Rax = () => (
  <RestaurantPage
    restaurantName="Raíx"
    address="Asunción 4405, Buenos Aires, C1419HHC, Argentina"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+541151029003"
    website="https://www.instagram.com/raix.ba?igsh=MXg4M2hlamV6dHhiMg=="
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the quiet Villa Devoto district, popularly known as the “the garden of the city” thanks to its tree-lined streets, you’ll come across this somewhat different restaurant with no little history, given that it occupies the former Bottazzini family bakery that was always hugely popular with locals after it opened its doors in 1903. The building, which has retained its unusual exterior as well as a huge wood counter where guests can eat or have a drink, has also preserved its original industrial feel thanks to the open-brick walls, a large bread oven and items of iron machinery used to knead dough. The cuisine here, including a somewhat surprising section dedicated to bread (it features six different artisanal varieties: Raíx, Telar, Arachí, Sol de Mayo, Luna Cacao and Asadas), is very much ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Asunci%C3%B3n%204405%2C%20Buenos%20Aires%2C%20C1419HHC%2C%20Argentina"
    pageTitle="Raíx"
  />
);
