...
const CorteComedor = () => (
  <RestaurantPage
    restaurantName="Corte Comedor"
    address="Avenida Olazábal 1391, Buenos Aires, C1428DGE, Argentina"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+541147812166"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/corte-comedor"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, in the heart of the Belgrano district, everything revolves around a varied array of top-quality cuts of meat, traceability and the maturing process… which is hardly surprising given the restaurant’s location next door to its own butcher’s shop! The first thing you notice when you walk into the bright and open dining room are the flames and embers from the grill behind the counter. The “asado” croquettes are a good way to start proceedings, along with the Provoleta cheese, although you’ll need someone from your table to help share the huge portion. The sausages here, ranging from merguez to morcilla, are also popular, but the majority of customers come here for one thing: the succulent, tender and delicious cuts of meat. The high ceilings give a sense of space, while the tables and sc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Olaz%C3%A1bal%201391%2C%20Buenos%20Aires%2C%20C1428DGE%2C%20Argentina"
    pageTitle="Corte Comedor"
  />
);

export default CorteComedor;
