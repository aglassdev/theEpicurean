...
const DuhauRestaurantVinoteca = () => (
  <RestaurantPage
    restaurantName="Duhau Restaurant & Vinoteca"
    address="Avenida Alvear 1661, Buenos Aires, C1014AAD, Argentina"
    cuisine="Grills"
    priceRange="$$$$"
    phoneNumber="+541151711340"
    website="http://www.buenosaires.park.hyatt.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fully laden wine shelves and cheese room with its display cabinets exert a Pavlovian effect as you enter this restaurant in the Park Hyatt hotel. The best Argentinian products – the majority of which are cooked on the parrilla grill – are the main attraction here, accompanied by an impressive wine list featuring the country’s most acclaimed wines. There are lots of dishes for sharing, from the grilled rib chops and Atlantic fish to the slow-grilled shoulder of lamb. Everything is abundant here, both in terms of flavour and portions, but make sure you order a side of the delicious and buttery smoked potato purée! The restaurant is popular with a business clientele, no doubt attracted by the good-value-for-money menu, as well as by the more relaxed ambience in the evening. The dining roo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Alvear%201661%2C%20Buenos%20Aires%2C%20C1014AAD%2C%20Argentina"
    pageTitle="Duhau Restaurant & Vinoteca"
  />
);

export default DuhauRestaurantVinoteca;
