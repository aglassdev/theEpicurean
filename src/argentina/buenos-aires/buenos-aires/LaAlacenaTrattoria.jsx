...
const LaAlacenaTrattoria = () => (
  <RestaurantPage
    restaurantName="La Alacena Trattoria"
    address="Gascón 1401, Buenos Aires, C1181ADA, Argentina"
    cuisine="Italian"
    priceRange="$"
    phoneNumber="+541148731988"
    website="https://www.instagram.com/laalacenatrattoria"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When trying to identify a top Italian restaurant, we either come across places which showcase a strong sense of professionalism and elegance that you associate with a fine dining experience, or those with the informal feel of a traditional trattoria, where regional-style home cooking is always to the fore – at La Alacena, it is definitely the latter. Here, owner-chef Julieta Oriolo puts her heart and soul into Italian cooking, in so doing honouring her family roots. On her à la carte, where you’ll find an enticing selection of antipasti and a few dishes worthy of particular mention (such as the exquisite polpette dal sugo), pasta (handmade with durum wheat flour and free-range eggs) plays a leading role, as witnessed by standout dishes such as the veal ravioli with a home-made pâté cream a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gasc%C3%B3n%201401%2C%20Buenos%20Aires%2C%20C1181ADA%2C%20Argentina"
    pageTitle="La Alacena Trattoria"
  />
);

export default LaAlacenaTrattoria;
