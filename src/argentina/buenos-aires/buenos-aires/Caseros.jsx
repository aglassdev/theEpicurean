...
const Caseros = () => (
  <RestaurantPage
    restaurantName="Caseros"
    address="Avenida Caseros 486, Buenos Aires, C1152AAN, Argentina"
    cuisine="Traditional Cuisine, Home Cooking"
    priceRange="$"
    phoneNumber="+541143074729"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/caseros"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Honesty is always appreciated when it comes to choosing a restaurant and this is especially the case in districts such as San Telmo, home to the National History Museum, where the standard of dining options is high and a vast array of cuisine is on offer. In this restaurant with a classic decor featuring retro detail and tables packed close together, the full focus is on home-style cooking showcasing consistent, simply prepared dishes teeming with superb flavours. The impressively large windows here provide plenty of natural light as well as occasionally serving as an external display for products such as scones, muffins, tart, artisanal bread etc, either to take away or to savour in relaxed style on the terrace. The highly traditional à la carte based around Argentinian ingredients is com..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Caseros%20486%2C%20Buenos%20Aires%2C%20C1152AAN%2C%20Argentina"
    pageTitle="Caseros"
  />
);
