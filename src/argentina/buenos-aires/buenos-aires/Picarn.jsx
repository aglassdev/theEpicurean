...
const Picarn = () => (
  <RestaurantPage
    restaurantName="Picarón"
    address="Avenida Dorrego 866, Buenos Aires, C1414CKQ, Argentina"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+541150462352"
    website="https://guide.michelin.com/en/ciudad-autonoma-de-buenos-aires/buenos-aires_777009/restaurant/picaron"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy dishes that come in small portions enabling you to try lots of different options, make a beeline for Picarón, in the Chacarita district, a restaurant with a sign depicting a large bear riding a velocipede, behind which you’ll find a culinary world that is both playful and fun. The colourful façade, complemented by a pavement terrace, leads to a simple bistro-style dining room with an open kitchen behind the bar counter and a glass-fronted wine cellar to one side. The à carte showcased by Maximiliano Rossi, enhanced by an affordable set menu at lunchtime (no bookings so first-come, first served), is centred around contemporary and Argentinian-based small plates which are transformed with touches of fusion, predominantly using recipes from Latin America but also more exotic dish..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Dorrego%20866%2C%20Buenos%20Aires%2C%20C1414CKQ%2C%20Argentina"
    pageTitle="Picarón"
  />
);

export default Picarn;
