...
const Anafe = () => (
  <RestaurantPage
    restaurantName="Anafe"
    address="Virrey Avilés 3216, Buenos Aires, C1426EEH, Argentina"
    cuisine="Contemporary"
    priceRange="$"
    phoneNumber="+541168304427"
    website="https://anafe.com.ar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The story of Mica Najmanovich and Nico Arcucci, who were already harbouring culinary dreams as students, is a tale of great conviction, as both pursued their ambition to work as chefs on their travels to Australia and Barcelona respectively. Their travels enabled them to assimilate cosmopolitan techniques and knowledge to their repertoire through influences from around the world. On their return, they started to work with pop-ups and, from this came a desire to open Anafe. In this simple eatery in the Colegiales district, their message is to “eat well, drink good wine and do both in a relaxed ambience”, hence their focus on global recipes with Asian, Australian, Jewish and Mediterranean influences, in which smoke and the open grill are the core elements in dishes designed for sharing, in k..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Virrey%20Avil%C3%A9s%203216%2C%20Buenos%20Aires%2C%20C1426EEH%2C%20Argentina"
    pageTitle="Anafe"
  />
);

export default Anafe;
