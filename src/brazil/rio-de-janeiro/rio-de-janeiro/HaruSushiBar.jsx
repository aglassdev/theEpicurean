...
const HaruSushiBar = () => (
  <RestaurantPage
    restaurantName="Haru Sushi Bar"
    address="Rua Raimuindo Corrêa, 10, Rio de Janeiro, 22040-042, Brazil"
    cuisine="Japanese"
    priceRange="$"
    phoneNumber="+5521967322668"
    website="https://haruichiban.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner-chef Menandro Rodrigues’ passion for Japanese cuisine provides the impetus for everything that goes on at this welcoming restaurant in Copacabana. On the ground floor, enjoy relaxed serviced at the pavement tables, while on the first floor you’ll find a dining room decorated in Japanese style with an impressive bar counter overlooking the kitchen, as well as tables and chairs laid out in different sections. The chef follows the Japanese “Kaizen” philosophy (which translates as “continuous improvement”) and devotes special attention to its techniques as well as to ingredients sourced directly from local fishermen. His cuisine is served as part of an Omakase menu, and includes options such as sushi, sashimi, and special and traditional “combos”. These are complemented by an extensive a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Raimuindo%20Corr%C3%AAa%2C%2010%2C%20Rio%20de%20Janeiro%2C%2022040-042%2C%20Brazil"
    pageTitle="Haru Sushi Bar"
  />
);

export default HaruSushiBar;
