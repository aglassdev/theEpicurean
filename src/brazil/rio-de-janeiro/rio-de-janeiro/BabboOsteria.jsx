...
const BabboOsteria = () => (
  <RestaurantPage
    restaurantName="Babbo Osteria"
    address="Rua Barão Da Torre, 632, Rio de Janeiro, 22411 002, Brazil"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+5521998086496"
    website="https://guide.michelin.com/en/rio-de-janeiro-region/rio-de-janeiro/restaurant/babbo-osteria"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An outstanding property in a quiet residential section of Ipanema, whose Italian name (“babbo” is a colloquial Italian word for “dad”) provides an insight into the cuisine served here, a fusion of Italian and “carioca” dishes conjured up by chef Elia Schramm. One of the most popular eateries in the area, Babbo Osteria pays homage to the chef's father, and brings childhood memories and family influences to the cooking on offer. One of the dining rooms, decorated with ornaments reminiscent of a traditional Italian “osteria”, provides the backdrop for handmade pasta dishes such as Uova Pepenara (tagliolini served with small cubes of bacon and a creamy soft egg) – the chef's version of the classic carbonara. Main courses include the “filetto”, a medallion served with a delicious pepper sauce a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bar%C3%A3o%20Da%20Torre%2C%20632%2C%20Rio%20de%20Janeiro%2C%2022411%20002%2C%20Brazil"
    pageTitle="Babbo Osteria"
  />
);

export default BabboOsteria;
