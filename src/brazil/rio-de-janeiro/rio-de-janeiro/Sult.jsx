...
const Sult = () => (
  <RestaurantPage
    restaurantName="Sult"
    address="Rua Fernandes Guimarães, 77, Rio de Janeiro, 22290-000, Brazil"
    cuisine="Italian Contemporary"
    priceRange="$$"
    phoneNumber="+552134866777"
    website="https://www.sultrestaurante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sult is the perfect choice if you’re looking for a relaxed restaurant offering excellent value for money. Located close to the Morro de São João hill, it boasts a modern, uncluttered decor plus an impressive open kitchen and bottles of wine with notes from guests written on them as added decoration in the dining room. Under the baton of chef Julia Lottus, the cuisine features dishes that combine a Brazilian identity with the cooking of Italy. An example, and one that delights all his guests, is the fresh fillet of pirarucu fish served with a creamy tucupi and jambu risotto. Having said this, the chef’s signature dish is his classic meat lasagne with a Grana Padano cheese fondue and breadcrumbs, which is simply perfect. An interesting selection of natural, organic and biodynamic wines is al..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Fernandes%20Guimar%C3%A3es%2C%2077%2C%20Rio%20de%20Janeiro%2C%2022290-000%2C%20Brazil"
    pageTitle="Sult"
  />
);
