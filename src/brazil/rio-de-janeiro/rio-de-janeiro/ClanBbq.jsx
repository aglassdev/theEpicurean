...
const ClanBbq = () => (
  <RestaurantPage
    restaurantName="Clan BBQ"
    address="Rua Dias Ferreira, 233 Loja B, Rio de Janeiro, 22431 050, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+5521967136746"
    website="https://clanbbq.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To the backdrop of a neon sign “Não apague o meu fogo” (“Don’t put out my fire”) clearly visible above the door, chefs Pepo Figueiredo and Newton Rique showcase cuisine in which fire plays a key role here, enabling them to prepare fresh ingredients imbued with a special flavour. In this industrial-style ambience with a predominance of raw concrete, a sturdy tree takes centre stage in the middle of the dining room. There’s also the option of sitting at the counter by the grill to watch dishes and cocktails being prepared at close quarters. The menu is of course heavily focused on barbecued meats, although you’ll also find other options such as vegetables, fish and burgers. Dishes you won’t want to miss include the creamy oxtail croquettes and cubes of smoked tongue with aioli. The succulent..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Dias%20Ferreira%2C%20233%20Loja%20B%2C%20Rio%20de%20Janeiro%2C%2022431%20050%2C%20Brazil"
    pageTitle="Clan BBQ"
  />
);

export default ClanBbq;
