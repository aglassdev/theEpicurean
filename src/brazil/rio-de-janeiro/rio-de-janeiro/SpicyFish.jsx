...
const SpicyFish = () => (
  <RestaurantPage
    restaurantName="Spicy Fish"
    address="Rua Maria Quitéria, 99, Rio de Janeiro, 22410-040, Brazil"
    cuisine="Asian Contemporary"
    priceRange="$"
    phoneNumber="+5521997878313"
    website="https://guide.michelin.com/en/rio-de-janeiro-region/rio-de-janeiro/restaurant/spicy-fish"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that is the talk of the town when it comes to Asian cuisine, a reputation enhanced by the magnificent building in which it is situated – a four-storey property featuring a decor of neutral tones, soft lighting and lots of plants which add a touch of freshness to the space. The cuisine created by chef Emerson Kim is a fusion of Japanese and Korean cooking, showcased via well-presented dishes with a unique flavour. The menu is extensive and for those unsure what to order, the chef’s selection includes two portions of nigiri, sashimi and the “house special”. Hot dishes include the reinterpretation of the Bibimbap, the finishing touches to which are always added at the table, and the delicious Kagoshima wagyu beef, known as Hot Stone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Maria%20Quit%C3%A9ria%2C%2099%2C%20Rio%20de%20Janeiro%2C%2022410-040%2C%20Brazil"
    pageTitle="Spicy Fish"
  />
);

export default SpicyFish;
