...
const Izr = () => (
  <RestaurantPage
    restaurantName="Izär"
    address="Rua Barão Da Torre, 538, Rio de Janeiro, 22411-002, Brazil"
    cuisine="Spanish, Rice Dishes"
    priceRange="$$"
    phoneNumber="+5521997257473"
    website="https://guide.michelin.com/en/rio-de-janeiro-region/rio-de-janeiro/restaurant/izar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of Ipanema, a district teeming with dining options, this Spanish-inspired restaurant stands out from the crowd. Here, is presented a menu on which paella is the undoubted star of the show and is available via a range of options. The variety of fish- and seafood-based dishes is also impressive, enhanced by the freshness and quality of the ingredients he uses. The menu spans traditional tapas to generous portions of paella perfect for sharing. The main distinction that sets Izär apart is the completely open kitchen with a bar counter enabling guests to watch as many as seven paellas being prepared at the same time. Alternatively, take a seat at one of the wood tables in the charming dining room crowned by a vaulted ceiling and lighting that recreates the feel of a starli..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bar%C3%A3o%20Da%20Torre%2C%20538%2C%20Rio%20de%20Janeiro%2C%2022411-002%2C%20Brazil"
    pageTitle="Izär"
  />
);
