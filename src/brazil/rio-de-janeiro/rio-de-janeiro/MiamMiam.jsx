...
const MiamMiam = () => (
  <RestaurantPage
    restaurantName="Miam Miam"
    address="Rua General Góis Monteiro 34, Rio de Janeiro, 22290-080, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+5521983664420"
    website="https://www.miammiam.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that opened in Botafogo in 2005 and occupies an old property that belonged to chef Roberta Ciasca's grandmother. After graduating in France, the chef opened this restaurant that encapsulates her origins thanks to the retro furniture, cheerful and colourful decor, exposed brick walls and vintage wooden floors. The menu, which follows the concept of “comfort food”, concentrates on traditional Brazilian recipes which are always meticulously presented and based around the latest techniques, and is divided between Miam Miam’s classic (and most popular) dishes and seasonal options (which change constantly), a tasting menu, plus a midweek “executive” menu. We can particularly recommend the curried chicken and shrimp croquettes, both of which are perfect...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20General%20G%C3%B3is%20Monteiro%2034%2C%20Rio%20de%20Janeiro%2C%2022290-080%2C%20Brazil"
    pageTitle="Miam Miam"
  />
);

export default MiamMiam;
