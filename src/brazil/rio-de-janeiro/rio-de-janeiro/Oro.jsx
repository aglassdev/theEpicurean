...
const Oro = () => (
  <RestaurantPage
    restaurantName="Oro"
    address="Avenida General San Martin 889, Rio de Janeiro, 22441-015, Brazil"
    cuisine="Creative"
    priceRange="$$$$"
    phoneNumber="+552138416859"
    website="https://ororestaurante.com.br/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="One of those restaurants that every food-lover should get to know! The rapport formed between chef Felipe Bronze and sommelier Cecilia Aldaz works wonderfully well as can be witnessed in every single detail. In this charming and elegant restaurant one block from Leblon beach, the cuisine is a fusion of Brazilian roots and cutting-edge technique. This is reflected in the Afetividade and Criatividade menus (with two and four main courses, respectively) which pay homage to the different regions of Brazil. At the counter in front of the kitchen, with seats for just four guests, you can appreciate the synchronised movement of the chefs at work and their preparation of dishes on the grill – the restaurant’s core element. What impressed us first and foremost was the creativity of the starters, in..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20General%20San%20Martin%20889%2C%20Rio%20de%20Janeiro%2C%2022441-015%2C%20Brazil"
    pageTitle="Oro"
  />
);
