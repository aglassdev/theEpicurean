...
const Oteque = () => (
  <RestaurantPage
    restaurantName="Oteque"
    address="Rua Conde de Irajá 581, Rio de Janeiro, 22271-020, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$$$$"
    phoneNumber="+552134865758"
    website="https://www.oteque.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Once you’ve passed the threshold of Oteque’s discreet façade you can leave the hustle and bustle of daily life behind you in this high-ceilinged restaurant where the old and highly contemporary exist alongside each other. The main dining room has an industrial feel about it with its bare, red-brick walls and six large round tables, plus a special dining counter seating just five guests in front of the open kitchen. Famous chef Alberto Landgraf, who is nowadays involved in several international projects, offers a single surprise tasting menu that varies according to the seasons with some dishes substituted daily in line with the availability of the best and freshest ingredients. His trademarks are simplicity and naturalness, qualities that are visible in his championing of Brazilian breeds ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Conde%20de%20Iraj%C3%A1%20581%2C%20Rio%20de%20Janeiro%2C%2022271-020%2C%20Brazil"
    pageTitle="Oteque"
  />
);
