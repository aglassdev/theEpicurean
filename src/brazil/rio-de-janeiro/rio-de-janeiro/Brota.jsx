...
const Brota = () => (
  <RestaurantPage
    restaurantName="Brota"
    address="Rua Conde de Irajá, 98, Rio de Janeiro, 22271-020, Brazil"
    cuisine="Vegetarian"
    priceRange="$$"
    phoneNumber="+5521974060905"
    website="https://www.brota.online/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brota occupies a charming mansion in Botafogo and is surrounded by a well-maintained garden. Inside, the elegant ambience features a contrast between striking red mouldings on the doors and large windows, a wood-inspired decor, an impressive bar, and leafy plants that add a touch of freshness to the setting. The kitchen is run by chef Roberta Ciasca from the renowned Miam Miam. The cuisine here is based around innovative vegan and vegetarian dishes designed for sharing. The menu includes classics such as the superb “brotinha” rice balls filled with tomato, pesto and olives or wasabi cream with chutney and the tapioca cream, served with passion fruit syrup and paçoca bran...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Conde%20de%20Iraj%C3%A1%2C%2098%2C%20Rio%20de%20Janeiro%2C%2022271-020%2C%20Brazil"
    pageTitle="Brota"
  />
);

export default Brota;
