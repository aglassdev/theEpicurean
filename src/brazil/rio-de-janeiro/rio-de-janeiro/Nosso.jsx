...
const Nosso = () => (
  <RestaurantPage
    restaurantName="Nosso"
    address="Rua Maria Quitéria 91, Rio de Janeiro, 22410-040, Brazil"
    cuisine="Contemporary, Fusion"
    priceRange="$$"
    phoneNumber="+5521996190099"
    website="https://www.nossoipanema.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An exclusive restaurant with three completely different floors: on the first, a bar; on the second, a dining space with an intimate ambience for a pleasant supper; and on the third, an outdoor terrace. Here, the relaxed cuisine, which is described by chef Bruno Katz as “contemporary”, features dishes that combine different food cultures from around the world in a creative and harmonious way. One example is the glazed octopus served with fried rice, kewpie mayonnaise, moyashi and nira, which is simply divine and cooked to perfection. Bartender Daniel Estevan elevates his concoctions to another level, combining classic drinks with his experience of the Amazon to create cocktails such as the surprising Tacacá Sour, with its mix of jambu, tucupi, cupuaçu and lemon. An extraordinary experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Maria%20Quit%C3%A9ria%2091%2C%20Rio%20de%20Janeiro%2C%2022410-040%2C%20Brazil"
    pageTitle="Nosso"
  />
);

export default Nosso;
