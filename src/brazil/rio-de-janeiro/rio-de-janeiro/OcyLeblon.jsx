...
const OcyLeblon = () => (
  <RestaurantPage
    restaurantName="OCYÁ Leblon"
    address="Rua Aristides Espínola, 88, Rio de Janeiro, 22440-050, Brazil"
    cuisine="Seafood"
    priceRange="$$"
