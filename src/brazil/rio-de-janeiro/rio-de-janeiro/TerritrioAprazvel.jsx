...
const TerritrioAprazvel = () => (
  <RestaurantPage
    restaurantName="Território Aprazível"
    address="Rua Aprazível 62, Rio de Janeiro, 20241-270, Brazil"
    cuisine="Brazilian"
    priceRange="$$$"
    phoneNumber="+5521967413850"
    website="https://www.aprazivel.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aprazível is a must for those who love a combination of delicious cuisine and nature. This family-run restaurant is located in hills surrounding the city in the Santa Teresa district, with its narrow winding streets and breathtaking views. Here, chef Ana Castilho conjures up a menu featuring organic and biodynamic ingredients from different regions around Brazil, yet without neglecting either creativity or a delicate touch. We can highly recommend the ceviche in a tucupi sauce with plantain chips, plus the delicious free-range “galinhada caipira” chicken, served with sausage from Minas Gerais, braised cabbage, a tasty pepper jelly and “surprise” beans. The restaurant also serves an array of superb drinks, including a vast selection of 100% natural wines as a perfect pairing for this culina..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Apraz%C3%ADvel%2062%2C%20Rio%20de%20Janeiro%2C%2020241-270%2C%20Brazil"
    pageTitle="Território Aprazível"
  />
);

export default TerritrioAprazvel;
