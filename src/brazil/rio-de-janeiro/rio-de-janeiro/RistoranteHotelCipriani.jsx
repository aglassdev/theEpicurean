...
const RistoranteHotelCipriani = () => (
  <RestaurantPage
    restaurantName="Ristorante Hotel Cipriani"
    ...
    pageTitle="Ristorante Hotel Cipriani"
  />
);

export default RistoranteHotelCipriani;
