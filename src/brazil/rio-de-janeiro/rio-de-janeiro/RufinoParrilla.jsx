...
const RufinoParrilla = () => (
  <RestaurantPage
    restaurantName="Rufino Parrilla"
    address="Rua Tubira, 43, Rio de Janeiro, 22441-070, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+552130437888"
    website="https://www.rufinoparrilla.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re keen to experience cooking on an authentic Argentinian parrilla grill without the inconvenience of leaving Leblon, a visit to Rufino is a must. This restaurant, already famous in Buenos Aires, has now opened an outlet in Rio de Janeiro. The menu is prepared by Argentinian chef Agustin Brañas, who brings with him the experience of working in prestigious restaurants outside of the country. In this elegant space, reminiscent of the typical parrilla eateries in neighbouring Argentina, the highlights are undoubtedly the exceptional cuts of meats (such as sirloin, Angus skirt steak, Argentinian Tomahawk, ribeye etc) cooked on the open grill. Desserts include the classic pancake with dulce de leche and banana ice cream. The extensive selection of Argentinian wines is the perfect complem..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Tubira%2C%2043%2C%20Rio%20de%20Janeiro%2C%2022441-070%2C%20Brazil"
    pageTitle="Rufino Parrilla"
  />
);

export default RufinoParrilla;
