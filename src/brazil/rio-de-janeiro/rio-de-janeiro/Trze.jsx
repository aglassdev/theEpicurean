...
const Trze = () => (
  <RestaurantPage
    restaurantName="Térèze"
    address="Rua Felicio dos Santos 15, Rio de Janeiro, 20241-260, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+552133800259"
    website="https://www.santateresahotelrio.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Térèze is the perfect choice if you’re on the lookout for a quiet setting for a romantic supper. It is part of the Santa Teresa Mgalley hotel, a delightful historic property built in 1850 with a sophisticated atmosphere and breathtaking views. The menu is based around a contemporary theme that uses seasonal ingredients, plus a mix of Brazilian and international recipes. Chefs Jérôme Dardillac and Luanna Malheiros conjure up surprising combinations such as the perfectly grilled octopus with a chickpea purée, ratatouille and a delicious rougail sauce. After lunch or dinner, why not prolong the enjoyment with a drink in the delightful surroundings of the charming bar?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Felicio%20dos%20Santos%2015%2C%20Rio%20de%20Janeiro%2C%2020241-260%2C%20Brazil"
    pageTitle="Térèze"
  />
);
