...
const RubaiyatRio = () => (
  <RestaurantPage
    restaurantName="Rubaiyat Rio"
    address="Rua Jardim Botânico 971, Rio de Janeiro, 22470-051, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+552132049999"
    website="https://www.gruporubaiyat.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Jockey Club Brasileiro within the boundaries of the city’s botanical gardens, this restaurant boasts breathtaking views where you can enjoy a meal on the terrace to a picture-postcard backdrop that features the horse-racing track as well as the statue of Christ the Redeemer. Inside, there is a large dining room with a counter that is home to the kitchen, where a large glass window provides views of the churrasco grill. Renowned for its array of premium meats and for managing its own production, the restaurant offers more than ten different cuts, although fish, seafood, rice and a variety of sides also feature on the menu. On Saturdays, don't miss the chance to try the traditional feijoada stew, made with prime cuts of meat, along with milkshakes and an incredible dessert buf..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Jardim%20Bot%C3%A2nico%20971%2C%20Rio%20de%20Janeiro%2C%2022470-051%2C%20Brazil"
    pageTitle="Rubaiyat Rio"
  />
);

export default RubaiyatRio;
