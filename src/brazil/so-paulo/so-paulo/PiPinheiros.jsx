...
const PiPinheiros = () => (
  <RestaurantPage
    restaurantName="Più Pinheiros"
    address="Rua Ferreira de Araújo 314, São Paulo, 05428-000, Brazil"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+551133607718"
    website="https://www.piurestaurante.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a charming small house in the Pinheiros district, Più boasts a pleasant, cosy ambience enhanced by its exposed brick walls, open garden and views of the kitchen and bar. This restaurant was one of the first in the region to offer a unique combination of affordable prices and a fusion between Italian cuisine and high-quality Brazilian ingredients. In the kitchen, run by chef Marcelo Laskani, expect classic dishes such as lasagne bolognese made with green pasta and enhanced with Italian mortadella, and the mouthwatering polpettone gratin stuffed with cheese and topped with a delicate tomato sauce. The chef also surprises guests with innovative dishes such as ravioli stuffed with pear and chilli jam, shimeji and gorgonzola cheese fonduta – an almost indescribable combination!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Ferreira%20de%20Ara%C3%BAjo%20314%2C%20S%C3%A3o%20Paulo%2C%2005428-000%2C%20Brazil"
    pageTitle="Più Pinheiros"
  />
);

export default PiPinheiros;
