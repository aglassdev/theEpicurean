...
const Fit = () => (
  <RestaurantPage
    restaurantName="Fitó"
    address="Rua Cardeal Arcoverde 2773, São Paulo, 05407-004, Brazil"
    cuisine="Brazilian"
    priceRange="$$"
    phoneNumber="+5511996742745"
    website="https://www.fitocozinha.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s not by chance that this restaurant occupies a charming, whitewashed property with blue windows – an external decor that is reminiscent of houses in inland areas of northeast Brazil, a part of the country that provides the inspiration for the cooking here. Under the baton of chef Cafira Foz, the exclusively female team creates cuisine that combines traditional flavours with an international touch. On the menu, there are options such as the authentic “paçoca” (shredded sun-dried beef served with “baião de dois” and plantains), a simple dish yet one full of strong flavours. For dessert, the “pirangi” (whole cashews with apple jam and “requeijão de corte” cheese), showcases genuine Brazilian flavours that will certainly leave their mark. Why not round off the experience with one of Fitó’s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Cardeal%20Arcoverde%202773%2C%20S%C3%A3o%20Paulo%2C%2005407-004%2C%20Brazil"
    pageTitle="Fitó"
  />
);
