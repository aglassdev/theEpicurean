...
const Manioca = () => (
  <RestaurantPage
    restaurantName="Manioca"
    address="Avenida Brigadeiro Faria Lima, 2232 3º andar, São Paulo, 01489-900, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$$"
    phoneNumber="+551129242333"
    website="https://restaurantemanioca.com.br"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Manioca, a name that is a combination of the Maní group’s other eateries (the eponymous Maní, run by famous chef Helena Rizzo, and Padoca), is its more informal offshoot offering comfort food and signature dishes from the group’s flagship restaurant. The day-to-day cuisine comes courtesy of young chef Thais Alves Braga who, having found inspiration in leading restaurants around Brazil, returned home to train up in readiness for the head role here. Manioca is located inside the Iguatemi shopping mall, in an extensive space with high ceilings and lots of natural light through its plant-adorned windows. The menu features a variety of “belisquetes” and burgers cooked in the Josper oven or, if you prefer, the famous PF Manioca (fillet steak served with a poached egg and roasted plantain), one o..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Brigadeiro%20Faria%20Lima%2C%202232%203%C2%BA%20andar%2C%20S%C3%A3o%20Paulo%2C%2001489-900%2C%20Brazil"
    pageTitle="Manioca"
  />
);

export default Manioca;
