...
const TangarJeangeorges = () => (
  <RestaurantPage
    restaurantName="Tangará Jean-Georges"
    address="Rua Deputado Laércio Corte 1501, São Paulo, 05706-290, Brazil"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+551140944040"
    website="https://www.oetkercollection.com/hotels/palacio-tangara/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="There are some occasions when we all want to enjoy a special meal and this restaurant within the confines of the luxury Palácio Tangará hotel, an urban oasis surrounded by tropical vegetation in the heart of the Parque Burle Marx, would be the perfect setting. It is overseen by French chef Jean-Georges Vongerichten who reigns over a culinary empire made up of over forty businesses. Resident chefs Filipe Rizzato and Neusi Machado offer serious international cuisine featuring contemporary dishes that focus first and foremost on delicacy and pure flavours. The menu, with specific sections dedicated to caviar, raw dishes and vegetarian and vegan options (asparagus risotto, Puy lentils etc) is complemented by two tasting menus (one of which is vegetarian). There’s also an exclusive Chef’s Table..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Deputado%20La%C3%A9rcio%20Corte%201501%2C%20S%C3%A3o%20Paulo%2C%2005706-290%2C%20Brazil"
    pageTitle="Tangará Jean-Georges"
  />
);

export default TangarJeangeorges;
