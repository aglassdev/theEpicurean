...
const RyoGastronomia = () => (
  <RestaurantPage
    restaurantName="Ryo Gastronomia"
    address="Rua Pedroso Alvarenga 667, São Paulo, 04531-011, Brazil"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+5511992212525"
    website="https://www.ryogastronomia.com.br/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant has risen like a phoenix with a renovated look that retains its minimalist Japanese essence that connects us with nature. The main focus here is the dining counter (with seating for just eight guests) where the Omakase menu is the star of the show. The counter is complemented by a couple of tables that can serve another 10 customers, and where you can also choose between the tasting and à la carte menus. Chef Edson Yamashita is a master of the Omakase style, showcasing his incredibly precise cutting and slicing skills in front of our eyes (the sushi sequence is a spectacle in itself). The courses are particularly well balanced, and are enhanced with strong technique, a delicate touch and umami flavours that resonate on the palate. Before embarking on the menu, the chef usua..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Pedroso%20Alvarenga%20667%2C%20S%C3%A3o%20Paulo%2C%2004531-011%2C%20Brazil"
    pageTitle="Ryo Gastronomia"
  />
);

export default RyoGastronomia;
