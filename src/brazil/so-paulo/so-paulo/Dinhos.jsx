...
const Dinhos = () => (
  <RestaurantPage
    restaurantName="Dinho's"
    address="Alameda Santos 86, São Paulo, 01418-000, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+551130165333"
    website="https://www.dinhosjardins.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dinho's was opened by Fuad Zegaib (the creator of the strip steak) six decades ago. Nowadays, the restaurant is run by chef Paulo Zegaib, the founder’s son. Occupying a new home on the ground floor of the Hotel Qoya, in the Paraíso section of the city (there’s also a Dinho’s in the Jardins district), it features a spacious, classically furnished main dining room, which is entirely glass-fronted and enclosed by a beautiful vertical garden plus a colourful open kitchen to one side. Renowned for its longevity in this bustling capital city, the restaurant offers superb cuts of beef, as well as feijoada on Thursdays and Saturdays, a buffet of salads and desserts, plus a copious seafood buffet on Fridays...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alameda%20Santos%2086%2C%20S%C3%A3o%20Paulo%2C%2001418-000%2C%20Brazil"
    pageTitle="Dinho's"
  />
);

export default Dinhos;
