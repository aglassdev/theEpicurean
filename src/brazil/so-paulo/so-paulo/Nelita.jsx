...
const Nelita = () => (
  <RestaurantPage
    restaurantName="Nelita"
    address="Rua Ferreira De Araújo, 330, São Paulo, 05428-000, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+551126261496"
    website="https://www.exploretock.com/nelita/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that has developed a strong reputation for itself in the city’s Baixo Pinheiros district. Under the baton of chef Tássia Magalhães, an exclusively female team is in charge of the kitchen, conjuring up innovative dishes with an Italian influence. The wine list, carefully curated by Danyel Steinle, showcases Brazilian wines and an astute blend of the country’s wines with those from elsewhere. To a modern decorative backdrop of exposed brick walls and different ambiences, guests can choose between tables at the entrance, the marble counter in front of the kitchen, or a private room which can also be reserved for groups. The menu includes delicious fresh pastas such as linguine with carrots and roe, alongside the mouthwatering pork with pear and toasted bread. The perfect dining e..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Ferreira%20De%20Ara%C3%BAjo%2C%20330%2C%20S%C3%A3o%20Paulo%2C%2005428-000%2C%20Brazil"
    pageTitle="Nelita"
  />
);

export default Nelita;
