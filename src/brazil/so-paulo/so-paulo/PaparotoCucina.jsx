...
const PaparotoCucina = () => (
  <RestaurantPage
    restaurantName="Paparoto Cucina"
    address="Av. Pres. Juscelino Kubitschek, 2041 - Térreo, São Paulo, 04543-011, Brazil"
    cuisine="Italian, Brazilian"
    priceRange="$$$"
    phoneNumber="+5511932607711"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/paparoto-cucina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the luxury JK Iguatemi complex, this restaurant has a spacious and modern setting with a decor that includes plants and subdued lighting that accentuates the illuminated Italian phrase “Se non ora quando?” (“If not now, when”). Famous chef Dayse Paparoto, who won the first edition of Brazil’s Professional Masterchef, showcases his Italian-inspired menu with an authentic and innovative touch that is based around fresh, top-quality ingredients. The menu features an array of options, such as the excellent egg yolk ravioli with ricotta and spinach, served with a soft egg yolk. Other options include fresh pastas and risottos, although the desserts steal the show here, highlighting the extreme creativity of the chef in dishes such as tiramisu, served with a candy floss tree, which comes ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Pres.%20Juscelino%20Kubitschek%2C%202041%20-%20T%C3%A9rreo%2C%20S%C3%A3o%20Paulo%2C%2004543-011%2C%20Brazil"
    pageTitle="Paparoto Cucina"
  />
);

export default PaparotoCucina;
