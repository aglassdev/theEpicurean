...
const ChezClaudeSoPaulo = () => (
  <RestaurantPage
    restaurantName="Chez Claude São Paulo"
    address="Rua Professor Tamandaré Toledo 25, São Paulo, 04532-020, Brazil"
    cuisine="Modern French"
    priceRange="$$$"
    phoneNumber="+551130714228"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/chez-claude-sao-paulo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the Le Quartier food complex, this space is divided between the Chez Claude restaurant, the Bar du Quartier and the refined Bistrot du Quartier. At the helm, famous chef Claude Troisgros follow the same concept as in Rio de Janeiro. The kitchen, which is completely open in the middle of the room, enables guests to really feel and be part of the lively and vibrant ambience here. The menu is based around French techniques and influences from Brazil and elsewhere in Latin America, resulting in colourful recipes full of flavour and texture. Standout dishes include the superb combination of scallops served with caviar, chuchu and Jataí honey; the duck magret accompanied by pear in wine and blueberry; and for dessert the light and creamy “doce de leite” cheesecake with a Canastra cheese ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Professor%20Tamandar%C3%A9%20Toledo%2025%2C%20S%C3%A3o%20Paulo%2C%2004532-020%2C%20Brazil"
    pageTitle="Chez Claude São Paulo"
  />
);

export default ChezClaudeSoPaulo;
