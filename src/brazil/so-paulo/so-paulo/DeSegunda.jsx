...
const DeSegunda = () => (
  <RestaurantPage
    restaurantName="De Segunda"
    address="Rua Prof. Tamandaré Toledo, 160, São Paulo, 04532-020, Brazil"
    cuisine="Brazilian"
    priceRange="$$"
    phoneNumber="+551130782900"
    website="https://desegundarestaurante.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Young chefs Júlia Tricate and Gabriel Coelho already have impressive CVs, having won TV food competitions and worked in Michelin-starred restaurants such as Noma (Copenhagen) and Oro (Rio de Janeiro). Following on from these incredible experiences, they decided to open their own restaurant with an open kitchen and a discreet decor that helps to channel the complete focus onto their cuisine. Their modern culinary vision is showcased on a creative menu that champions fresh, seasonal ingredients on a tasting menu, à la carte and midweek “executive” menu”. Combinations such as the pork rib cooked for 12 hours and served with a meat glaze hummus and fried onion, and the restaurant’s classic take on hump of beef, here accompanied by a creamy sweet potato and gorgonzola purée, will definitely lea..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Prof.%20Tamandar%C3%A9%20Toledo%2C%20160%2C%20S%C3%A3o%20Paulo%2C%2004532-020%2C%20Brazil"
    pageTitle="De Segunda"
  />
);

export default DeSegunda;
