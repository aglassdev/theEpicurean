...
const Emiliano = () => (
  <RestaurantPage
    restaurantName="Emiliano"
    address="Rua Oscar Freire 384, São Paulo, 01426-000, Brazil"
    cuisine="International"
    priceRange="$$$"
    phoneNumber="+551137282000"
    website="https://emiliano.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the majestic Hotel Emiliano, along the city’s iconic Rua Oscar Freire, with its array of luxury shops and boutiques, this eponymous restaurant is under the baton of chef Viviane Gonçalves (known as Chef Vivi), who focuses on classic cuisine that combines Brazilian flavours and Italian influences. Her concise menu includes dishes ranging from seared scallops with cauliflower cream and leeks to slow-roasted lamb served with yam purée and lamb stock. For dessert, centre stage is taken by the sweet and crunchy combination of banana, peanut and dulce de leche with vanilla sorbet. The classical decor, enhanced by extensive windows and views of a vertical garden, provides the perfect setting for a delightful meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Oscar%20Freire%20384%2C%20S%C3%A3o%20Paulo%2C%2001426-000%2C%20Brazil"
    pageTitle="Emiliano"
  />
);
