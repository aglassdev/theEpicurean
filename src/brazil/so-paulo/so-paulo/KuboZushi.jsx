...
const KuboZushi = () => (
  <RestaurantPage
    restaurantName="Kubo Zushi"
    address="Rua Das Tabocas 158, São Paulo, 05445-020, Brazil"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber="+551138146167"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/kubo-zushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a classic Japanese dining experience that is truly authentic and steers clear of any form of contemporary influence, especially when it comes to sushi and sashimi, this is the perfect restaurant for you. Here, to a backdrop of simple decor in the residential Vila Madalena district, chef Sergio Kubo prepare edomae sushi, a culinary tradition mastered over many years. The high quality of ingredients is clearly evident in dishes such tuna tartare, tartare with salmon roe, and tobiko and quail egg yolk, as well as an array of combinations. The restaurant is divided into three sections, although it is obvious that the sushi bar is the heart and soul of the property, where guests will enjoy watching and admiring the skill of Kubo Zushi’s chefs. There’s even an attractive pl..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Das%20Tabocas%20158%2C%20S%C3%A3o%20Paulo%2C%2005445-020%2C%20Brazil"
    pageTitle="Kubo Zushi"
  />
);

export default KuboZushi;
