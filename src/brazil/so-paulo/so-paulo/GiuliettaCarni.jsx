...
const GiuliettaCarni = () => (
  <RestaurantPage
    restaurantName="Giulietta Carni"
    address="Rua Jerônimo Da Veiga 36, São Paulo, 04536-000, Brazil"
    cuisine="Meats and Grills, Italian"
    priceRange="$$$"
    phoneNumber="+5511975231636"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/giulietta-carni"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in one of the city’s business districts, this attractive restaurant comes as a pleasant surprise thanks to its unusual Italian-churrascaria fusion. It combines an industrial design and glass-fronted, open-view kitchen with an array of kitschy decorative details—note the paintings of animals with their aristocratic poses and clothing. The cooking here is traditionally Italian but with a good dash of creativity, and a focus on dishes cooked on the grill or in the oven, such as the mouthwatering glazed beef rib with a Gran Masala sauce, potato millefeuille and roasted onions. Reservations are highly recommended if you’re planning on having dinner here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Jer%C3%B4nimo%20Da%20Veiga%2036%2C%20S%C3%A3o%20Paulo%2C%2004536-000%2C%20Brazil"
    pageTitle="Giulietta Carni"
  />
);

export default GiuliettaCarni;
