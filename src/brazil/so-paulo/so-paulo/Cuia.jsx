...
const Cuia = () => (
  <RestaurantPage
    restaurantName="Cuia"
    address="Av. Ipiranga, 200 - Loja 48, São Paulo, 01046-010, Brazil"
    cuisine="Creative"
    priceRange="$$"
    phoneNumber="+5511959818555"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/cuia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Renowned chef Bel Coelho is known for her commitment to healthy food, the use of native ingredients and the preservation of Brazil’s varied food cultures. In this casual and welcoming restaurant shared with the Livraria Megafauna bookshop in the iconic Copan building, guests can enjoy all-day dining between the bookshelves, in front of the kitchen or in the open-air dining space, with options varying between toasted sandwiches and “pão de queijo” to “baião de dois” (black-eyed peas with rice). Dishes you won’t want to pass up include the appetising squid tempura with tapioca and caju ponzu, and the mouthwatering “Our Oswaldo Aranha (grilled filet mignon). The chocolate mousse with bacuri compote, cumaru crème anglaise and Brazil nut crumble is the perfect way to round off your meal, accomp..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Ipiranga%2C%20200%20-%20Loja%2048%2C%20S%C3%A3o%20Paulo%2C%2001046-010%2C%20Brazil"
    pageTitle="Cuia"
  />
);
