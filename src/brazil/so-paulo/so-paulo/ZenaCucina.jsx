...
const ZenaCucina = () => (
  <RestaurantPage
    restaurantName="Zena Cucina"
    address="Rua Peixoto Gomide 1901, São Paulo, 01409-002, Brazil"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+551130829362"
    website="https://www.zenacaffe.com.br"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A focal point for lovers of Italian cuisine, with a name that is the Genoese word for the delightful city of Genoa and a decor and cuisine that transport guests to this picturesque city in Northen Italy. In this relaxed, rustic setting, famous chef Carlos Bertolazzi creates Mediterranean-inspired cuisine, including fresh homemade pasta. Standout dishes here include the focaccia (made with extremely fine pasta and generous fillings) and the mandioc gnocchi with an enticing ossobuco ragu, and for dessert the superb cannoli filled with chocolate and oats, and the “doce de leite” with banana. This delightful experience is enhanced by the superb selection of wines and other drinks on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Peixoto%20Gomide%201901%2C%20S%C3%A3o%20Paulo%2C%2001409-002%2C%20Brazil"
    pageTitle="Zena Cucina"
  />
);

export default ZenaCucina;
