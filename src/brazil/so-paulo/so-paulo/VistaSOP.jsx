...
const VistaSOP = () => (
  <RestaurantPage
    ...
    address="Avenida Pedro Álvares Cabral 1301, São Paulo, 04094-050, Brazil"
    cuisine="Brazilian"
    priceRange="$$"
    phoneNumber="+551126583188"
    website="https://vistarestaurante.vistasaopaulo.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying the top floor of the MAC USP (Museu de Arte Contemporânea da Universidade de São Paulo), this restaurant boasts spectacular views of Ibirapuera and a 360° panorama of the city. The kitchen is run by chef Pedro Oliveira, who offers guests a traditional Brazilian dining experience featuring typical ingredients from the country’s five regions, which he prepares in a harmonious and balanced way and is showcased on an “executive”-style format at lunchtime. On Saturdays, pumpkin shrimp with rice and sweet potato chips is the highlight, with crispy pururuca pork making an appearance on Sundays. The star of the show on the dessert menu is Vista’s own irresistible version of the traditional Portuguese dish “toucinho do Céu”, made with pumpkin, egg yolk and almonds. A special menu of start..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Pedro%20%C3%81lvares%20Cabral%201301%2C%20S%C3%A3o%20Paulo%2C%2004094-050%2C%20Brazil"
    pageTitle="Vista"
  />
);

export default VistaSOP;
