...
const FogoDeCho = () => (
  <RestaurantPage
    ...
    address="Rua Augusta 2077, São Paulo, 01413-000, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+551130622223"
    website="https://fogodechao.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Fogo de Chão restaurant is much more than just a place to eat as it represents Brazil’s churrasco tradition that has won admirers in different parts of the world. The origins of this method for cooking meat date back to the gauchos who discovered that skewering pieces of meat on wooden sticks and placing them around a fire transformed a simple cut of meat into a true delicacy. Served as part of “rodizio” all-you-can-eat format, the extensive selection includes beef, lamb and pork, as well as the famous prime rib and dry-aged meats (only available on the à la carte). To accompany the superb choice of meat, there’s also an extensive buffet of salads, rice dishes, carpaccios, cheeses and sausages. In total, there are five Fogo de Chão restaurants in São Paulo, all of which boast a compreh..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Augusta%202077%2C%20S%C3%A3o%20Paulo%2C%2001413-000%2C%20Brazil"
    pageTitle="Fogo de Chão"
  />
);

export default FogoDeCho;
