...
const Nomo = () => (
  <RestaurantPage
    restaurantName="NOMO"
    address="Rua Harmonia 815, São Paulo, 05435-000, Brazil"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+5531991216648"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/nomo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightful restaurant in the Vila Madalena district of the city, featuring a natural plant-covered façade, a glass-fronted dining room and an open kitchen with restrained tones and a simple decor. Here, chef Nando Carneiro creates innovative cuisine with a contemporary touch and a combination of seasonal ingredients. The superb wine selection is the domain of sommelier and front-of-house manager Patrícia Werneck. The cooking at Nomo is out of the ordinary and includes combinations of high-quality ingredients and impressive flavours that come as a pleasant surprise. One of the standout dishes on offer is the braised cabbage and romaine lettuce served with a sweet contrast of muhammara, dukkah and pistachios. Another amazing option is the smoked cupim cut of meat, accompanied by creamy pot..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Harmonia%20815%2C%20S%C3%A3o%20Paulo%2C%2005435-000%2C%20Brazil"
    pageTitle="NOMO"
  />
);
