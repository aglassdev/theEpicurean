...
const Kotori = () => (
  <RestaurantPage
    restaurantName="Kotori"
    address="Rua Cônego Eugênio Leite, 639, São Paulo, 05414-011, Brazil"
    cuisine="Japanese"
    priceRange="$$"
    phoneNumber="+551138910043"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/kotori"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An innovative dining option in the trendy Pinheiros district of the city. The focus here is very much on Japanese culture, with cuisine inspired by yōshoku cooking which reinterprets Western-style dishes to Asian tastes. Chef Thiago Bañares offers just a single menu option, albeit with a cutting-edge touch and one that includes Brazilian ingredients in his dishes. The latter include a selection of hot options, such as the Eryngil mushrooms, which is combined with chicken broth, tucupi and mustard seeds, plus matured fish cooked on the grill. It’s worth saving space at the end of your meal for the “rabanada de shokupan”, a bread dessert served with a milk ice cream and toffee syrup. To round off the experience to the full, choose from the list of classic and creative cocktails, or the inter..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20C%C3%B4nego%20Eug%C3%AAnio%20Leite%2C%20639%2C%20S%C3%A3o%20Paulo%2C%2005414-011%2C%20Brazil"
    pageTitle="Kotori"
  />
);
