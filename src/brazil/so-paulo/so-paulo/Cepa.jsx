...
const Cepa = () => (
  <RestaurantPage
    restaurantName="Cepa"
    address="Praça Dos Omaguás 110, São Paulo, 05419-020, Brazil"
    cuisine="Contemporary, Farm to table"
    priceRange="$$"
    phoneNumber="+551120960687"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/cepa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The new version of Cepa, featuring more comfort and space, is located in the city’s Pinheiros district. Here, chef Lucas Dante conjures up contemporary, seasonal cuisine that enjoys toying with smoking, maturing and fermenting techniques to add even more flavour, while at the same time prioritising the freshness of ingredients and the championing of small-scale producers. By his side is sommelier and front-of-house manager Gabrielli Fleming, who is in charge of sourcing biodynamic and organic wines for the cellar that are always the perfect pairing for your choice of dish. Among the many delicious options on offer, we can highly recommend the simply incredible starter of Wagyu tongue with chicken broth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pra%C3%A7a%20Dos%20Omagu%C3%A1s%20110%2C%20S%C3%A3o%20Paulo%2C%2005419-020%2C%20Brazil"
    pageTitle="Cepa"
  />
);
