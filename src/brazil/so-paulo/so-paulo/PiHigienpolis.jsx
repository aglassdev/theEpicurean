...
const PiHigienpolis = () => (
  <RestaurantPage
    restaurantName="Più Higienópolis"
    address="Avenida Higienópolis 618, São Paulo, 01238-001, Brazil"
    cuisine="Italian, Creative"
    priceRange="$$"
    phoneNumber="+551131987649"
    website="https://www.piurestaurante.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re passionate about Italian cuisine and delicious fresh pasta, you’ve probably already heard of this restaurant, as Più is one of the pioneers of Italian cooking in the Greater São Paulo area. Under the baton of chef Marcelo Laskani, it now has its second outlet in the Shopping Pátio Higienópolis, where the innovative cooking calls upon top-quality Brazilian ingredients. Dishes such as tuna carpaccio stand out for their fresh, light touch, and are raised to an even higher level by a delicious accompaniment of fresh tomato, raspberry vinegar and burrata. No review of Più is complete without mentioning the house speciality, the braised ossobuco which is slow cooked for 12 hours and served with a creamy aligot of manioc with cheese. The superb array of cocktails adds to the experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Higien%C3%B3polis%20618%2C%20S%C3%A3o%20Paulo%2C%2001238-001%2C%20Brazil"
    pageTitle="Più Higienópolis"
  />
);

export default PiHigienpolis;
