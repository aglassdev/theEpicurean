...
const ElTranviaItaimBibi = () => (
  <RestaurantPage
    restaurantName="El Tranvia - Itaim Bibi"
    address="Rua Leopoldo Couto de Magalhães 1372, São Paulo, 03178-200, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+551123613588"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/el-tranvia-itaim-bibi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Those who head to this restaurant should be in no doubt as to its reputation as a culinary institution showcasing the very best flavours of traditional Uruguayan cooking. The beef served here is of exceptional quality and includes numerous choice cuts (beef short ribs, strip loin, sirloin etc) and matured meat options that are enhanced to the full over the flames of the parrilla. You’ll also find fillets of meat of all types and sizes to cater to the many families from every generation who flock here, with the quantity of side dishes depending on the number of guests at the table. The fries and the delicious Uruguayan flan with “dulce de leche” are a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Leopoldo%20Couto%20de%20Magalh%C3%A3es%201372%2C%20S%C3%A3o%20Paulo%2C%2003178-200%2C%20Brazil"
    pageTitle="El Tranvia - Itaim Bibi"
  />
);

export default ElTranviaItaimBibi;
