...
const ChefRouge = () => (
  <RestaurantPage
    restaurantName="Chef Rouge"
    address="Rua Bela Cintra 2238, São Paulo, 01415-002, Brazil"
    cuisine="French"
    priceRange="$$"
    phoneNumber="+551130817539"
    website="https://www.chefrouge.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An authentic French bistro, both in terms of its black façade and red awning and its elegant, welcoming interior. The main dining space is complemented by a charming terrace at the entrance, adorned with two impressive trees and with candlelight in the evening. Some of the tables are also occupied by adorable, large red teddy bears that add to the delightful atmosphere. Understandably, the culinary focus and star of the show is classic French cooking with a contemporary touch that is showcased by top-quality ingredients and delicately prepared dishes. These include the grilled foie gras with figs, served with bitter chocolate, and the classic roast duck breast with orange sauce accompanied by gaufrettes potatoes. The incredible Eclair XXL provides the perfect finale!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bela%20Cintra%202238%2C%20S%C3%A3o%20Paulo%2C%2001415-002%2C%20Brazil"
    pageTitle="Chef Rouge"
  />
);

export default ChefRouge;
