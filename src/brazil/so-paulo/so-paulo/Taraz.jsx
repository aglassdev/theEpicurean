...
const Taraz = () => (
  <RestaurantPage
    restaurantName="TARAZ"
    address="Rua Itapeva, 435, São Paulo, 01332-000, Brazil"
    cuisine="South American"
    priceRange="$$$"
    phoneNumber="+551137970500"
    website="https://www.rosewoodhotels.com/pt/sao-paulo/dining/taraz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the historic and former Condessa Filomena Matarazzo Maternity hospital complex, now converted into the luxury Rosewood São Paulo hotel, where the menu bears the signature of famous chef Felipe Bronze. In this charming space, the cooking is based around that of South America as a whole, with the open grill featuring prominently in a variety of harmonious dishes prepared with ingredients of the highest quality. Why not start with an authentic South American dish such as the excellent combination of tuna ceviche with caramelised peanuts, shiso, sesame, peanut milk and crispy tapioca? Follow this with a Brazilian classic – duck with tucupi (fermented manioc juice), sheep curd and toasted pineapple. For those who prefer to eat alfresco, the terrace is simply charming!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Itapeva%2C%20435%2C%20S%C3%A3o%20Paulo%2C%2001332-000%2C%20Brazil"
    pageTitle="TARAZ"
  />
);

export default Taraz;
