...
const Ecully = () => (
  <RestaurantPage
    restaurantName="Ecully"
    address="Rua Cotoxó 493, São Paulo, 05021-000, Brazil"
    cuisine="International"
    priceRange="$$"
    phoneNumber="+551138533933"
    website="https://www.ecully.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant located on the rear patio of a century-old property has the added and somewhat surprising bonus of a large wine shop. Enthusiastically run by young chefs Juliana and Guilherme (a couple who met in the French town of Écully), it features outdoor tables in the courtyard with its abundant greenery, including a large jabuticabeira tree growing between the tables. In this setting, which is particularly romantic at night when candlelit, the cuisine showcases regional ingredients and combines Brazilian, French and Italian influences through dishes such as the gnocchi au gratin with beef ragout or the delicious suckling pig cooked at low temperature and accompanied by manioc purée, caramelised onion and basil pesto...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Cotox%C3%B3%20493%2C%20S%C3%A3o%20Paulo%2C%2005021-000%2C%20Brazil"
    pageTitle="Ecully"
  />
);

export default Ecully;
