...
const Jac = () => (
  <RestaurantPage
    restaurantName="Jacó"
    address="Rua Fidalga 357, São Paulo, 05416-020, Brazil"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="$$"
    phoneNumber="+5511995014814"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/jaco-1212676"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant definitely impresses thanks to its cuisine and its creativity. In its location in the vibrant Pinheiros area of the city, in a house framed by large windows and with a kitchen which opens out onto the dining room, chef Iago Jacomussi, whose career has seen him work in leading restaurants in Brazil and Europe, conjures up dishes based around seasonal ingredients in recipes that combine traditional Brazilian cooking with European and Asian influences. The concise menu, which is designed for sharing, features options such as raw fish of the day served with avocado cream, a tomato crunch and katsobushi, and pork accompanied by a creamy corn and spiced purée. For dessert, the fried brioche with coffee mousse and sheep's milk ice cream is an excellent choice. In addition, the coc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Fidalga%20357%2C%20S%C3%A3o%20Paulo%2C%2005416-020%2C%20Brazil"
    pageTitle="Jacó"
  />
);
