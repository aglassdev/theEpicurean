...
const LeJardin = () => (
  <RestaurantPage
    ...
    address="Rua Itapeva, 435, São Paulo, 01332-010, Brazil"
    cuisine="International"
    priceRange="$$$"
    phoneNumber="+551137970500"
    website="https://www.rosewoodhotels.com/pt/sao-paulo/dining/le-jardin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An oasis of sophistication and serenity surrounded by nature amid the hustle and bustle of the city. Le Jardin boasts a luxurious ambience in the style of a winter garden in which the decor and atmosphere will leave a lasting impression. This is the perfect space to enjoy at any time of day – for breakfast, which includes an interesting choice of teas and coffees to complement the menu, light snacks or lunch and dinner. The cuisine here is based around classic international fare, and is always showcased by meticulously prepared dishes. One example is the roasted sea bass which is served on a bed of lightly caramelised asparagus and heart of palm and finished with a vermouth emulsion – a combination that will leave a lasting impression on the palate. There’s also a kosher menu (prior bookin..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Itapeva%2C%20435%2C%20S%C3%A3o%20Paulo%2C%2001332-010%2C%20Brazil"
    pageTitle="Le Jardin"
  />
);
