...
const MarenaCucina = () => (
  <RestaurantPage
    restaurantName="Marena Cucina"
    address="Rua Pais De Araújo 138, São Paulo, 04531-090, Brazil"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+5511998614960"
    website="https://marenacucina.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Itaim Bibi, one of São Paulo's most sophisticated districts, you’ll come across this Italian restaurant that oozes personality, both in its warm Mediterranean-inspired decor combining exposed stone and wood, and its unique cuisine. Although it offers an array of pasta and specialities from across the country (Rome, Naples, Tuscany etc), the aim here is to also incorporate the specific flavours of the Puglia region in the “heel of the boot” in the deep south of the country. The cuisine is unpretentious yet delicious, and is showcased in dishes such as artisanally produced Ficchi & Aceto IGP burrata, grilled octopus, and Tagliolini Marena with fresh pasta, prawns, octopus, squid and pomodorini. The mouthwatering prosciuttos here are also a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Pais%20De%20Ara%C3%BAjo%20138%2C%20S%C3%A3o%20Paulo%2C%2004531-090%2C%20Brazil"
    pageTitle="Marena Cucina"
  />
);

export default MarenaCucina;
