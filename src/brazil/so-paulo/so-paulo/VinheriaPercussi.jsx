...
const VinheriaPercussi = () => (
  <RestaurantPage
    restaurantName="Vinheria Percussi"
    address="Rua Bianchi Bertoldi 109, São Paulo, 05422-070, Brazil"
    cuisine="Italian"
    priceRange="$$"
    phoneNumber="+551130884920"
    website="https://www.percussi.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run Italian restaurant that was a trailblazer for enogastronomy (the pairing of food and wine) in Brazil. It first opened as a wine shop in 1985 with the aim of offering good wine and food to go with it. However, with the arrival of chef Silvia Percussi and her brother Lamberto Percussi (restaurant manager and sommelier) the concept was taken to the next level. In this classic, welcoming setting, enjoy excellent cuisine including fresh pasta, which is a particular highlight. Classic dishes that you’ll want to try include the perfectly creamy tonnarelli alla carbonara, the beef ossobuco, served with a divine sauce, and the tiramisu, which is brought to your table on a platter. Why not pair these delicacies with one of the fines wines on the 300-strong wine list and in the award-win..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bianchi%20Bertoldi%20109%2C%20S%C3%A3o%20Paulo%2C%2005422-070%2C%20Brazil"
    pageTitle="Vinheria Percussi"
  />
);

export default VinheriaPercussi;
