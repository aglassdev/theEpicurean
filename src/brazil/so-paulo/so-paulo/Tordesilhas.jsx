...
const Tordesilhas = () => (
  <RestaurantPage
    restaurantName="Tordesilhas"
    address="Alameda Tietê 489, São Paulo, 01417-020, Brazil"
    cuisine="Brazilian"
    priceRange="$"
    phoneNumber="+551131077444"
    website="https://www.tordesilhas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tordesilhas is under the command of chef Mara Salles, who has three decades of experience behind her. The key tenets of her cuisine are a fondness for dishes for sharing and the showcasing of ingredients from the different regions around the country. Located in the charming Jardins district, in a wonderful space that is full of flavor and hospitality. Her cuisine is a journey across the country’s regions, enhanced by dishes with a contemporary touch that are prepared with the utmost care and attention. Options includes à la carte dishes that range from starters such as pirarucu fish balls and shrimp in manioc cream with coconut milk to traditional Moqueca fish stew. On Saturdays, the famous Feijoada features on the menu. We also highly recommend the simply sensational chilli preserves prep..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alameda%20Tiet%C3%AA%20489%2C%20S%C3%A3o%20Paulo%2C%2001417-020%2C%20Brazil"
    pageTitle="Tordesilhas"
  />
);

export default Tordesilhas;
