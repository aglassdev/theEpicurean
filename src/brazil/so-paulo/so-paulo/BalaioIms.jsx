...
const BalaioIms = () => (
  <RestaurantPage
    restaurantName="Balaio IMS"
    address="Avenida Paulista 2424, São Paulo, 01310-300, Brazil"
    cuisine="Brazilian"
    priceRange="$$"
    phoneNumber="+551128429123"
    website="https://balaioims.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If a combination of art and excellent food appeals to you, this restaurant in the Instituto Moreira Salles, recognised as one of the best cultural centres in the city, is definitely the place for you, where you can savour the brilliant cuisine of chef Rodrigo Oliveira. The cooking here is centred around the best ingredients, with everything prepared with faultless skill and professionalism. The aim is to mix the flavours from the diverse cultures across Brazil (a “balaio” is a typically Brazilian “straw basket”), in dishes such as the famous “dadinhos de tapioca”, and Pork Ribs with guava barbecue and kale furikake or the delicious Lasagna caipira made with kale pasta, fresh ricotta and a delicate pumpkin béchamel sauce gives an indication of why this restaurant is always full!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Paulista%202424%2C%20S%C3%A3o%20Paulo%2C%2001310-300%2C%20Brazil"
    pageTitle="Balaio IMS"
  />
);

export default BalaioIms;
