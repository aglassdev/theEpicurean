...
const TerraoNoti = () => (
  <RestaurantPage
    restaurantName="Terraço NOTIÊ"
    address="Rua Formosa 157, São Paulo, 01049-000, Brazil"
    cuisine="Brazilian, Modern Cuisine"
    priceRange="$$$"
    phoneNumber="+551128530373"
    website="https://espacopriceless.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although only recently opened, this restaurant is already being talked about by the city’s foodie community. Located on the rooftop of the Shopping Light building, its design comes as a pleasant surprise as soon as you walk through the door thanks to its decor of yellow tones, glass-fronted kitchen enabling guests to watch the chefs hard at work and, first and foremost, the 18m panel on the ceiling depicting images of nature. At the helm in the kitchen is Paraíba-born chef Onildo Rocha who impresses with his use of typical Brazilian ingredients and combinations that result in intense and striking dishes. His recipes are based around his journeys to different Brazilian regions every season, and are showcased on 5-, 8- and 11-course tasting menus. The name of the restaurant is a fusion betwe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Formosa%20157%2C%20S%C3%A3o%20Paulo%2C%2001049-000%2C%20Brazil"
    pageTitle="Terraço NOTIÊ"
  />
);

export default TerraoNoti;
