...
const Evvai = () => (
  <RestaurantPage
    ...
    priceRange="$$$$"
    phoneNumber="+551130621160"
    website="https://www.evvai.com.br/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It is not always a given to find a restaurant that is fully able to express a chef’s desire and passion for food, life, art and nature, but this is definitely the case at Evvai, where chef Luiz Filipe Souza’s cooking is a successful fusion of Brazilian and Italian influences which result in dishes that are not only visually attractive but also teeming with skill, knowledge and balance. This is showcased on a single tasting menu, Oriundi (symbolising the interchange between cultures), featuring delicate appetisers that fly the flag for both Brazil and Italy. An impressive dish that has been a constant on the menu here in one form or another is “bomba al nero / lardo from the Serra da Bocaina”. Another recipe that stands out is the highly complex Melipona dessert that showcases Melipona hone..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Joaquim%20Antunes%20108%2C%20S%C3%A3o%20Paulo%2C%2005415-000%2C%20Brazil"
    pageTitle="Evvai"
  />
);

export default Evvai;
