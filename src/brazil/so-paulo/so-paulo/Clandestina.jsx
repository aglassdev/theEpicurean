...
const Clandestina = () => (
  <RestaurantPage
    restaurantName="Clandestina"
    address="Rua Girassol 833B, São Paulo, 05433-001, Brazil"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+5511941459589"
    website="https://www.belcoelho.com.br"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Formerly located at a different address, this restaurant run by renowned chef Bel Coelho is back with a bang to enhance the dining options on offer in the charming Vila Madalena neighbourhood of São Paulo. In this attractive small property with a rustic feel and bistro ambience, the chef offers a contemporary take on Brazilian cuisine with an added international touch, and featuring organic ingredients sourced from small-scale local producers. The menu, which is designed for sharing, features light dishes which are meticulously prepared and affordably priced. Top recommendations here include the chilli pepper and shrimp tempura, served with a slightly spicy splash of bacuri fruit sauce, and the unmissable dish that combines maxixe (a type of cucumber) with pork belly glazed with black tucu..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Girassol%20833B%2C%20S%C3%A3o%20Paulo%2C%2005433-001%2C%20Brazil"
    pageTitle="Clandestina"
  />
);
