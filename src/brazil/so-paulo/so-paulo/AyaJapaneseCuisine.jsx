...
const AyaJapaneseCuisine = () => (
  <RestaurantPage
    restaurantName="Aya Japanese Cuisine"
    address="Avenida Pedroso de Morais 141, São Paulo, 05419-000, Brazil"
    cuisine="Japanese"
    priceRange="$$$"
    phoneNumber="+551130979856"
    website="http://www.restauranteaya.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive property with a contemporary ambience and minimalist decor has a good location in a busy part of the city, just a few metres from the famous Avenida Rebouças. It is under the baton of sushi chef Juraci Pereira (better known as “Jura”) who, after working as Jun Sakamoto’s right-hand man for 11 years, decided to open his own venture in collaboration with his business partner Beto Ganme. Downstairs, where guests can sit at the counter to watch the expert hands of the chefs in action, the atmosphere is more intimate, while the upstairs is more modern and cosy. The cuisine includes a special Aya omakase menu, various types of sashimi, sushi (à la carte and combos), makimonos and hot dish options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Pedroso%20de%20Morais%20141%2C%20S%C3%A3o%20Paulo%2C%2005419-000%2C%20Brazil"
    pageTitle="Aya Japanese Cuisine"
  />
);

export default AyaJapaneseCuisine;
