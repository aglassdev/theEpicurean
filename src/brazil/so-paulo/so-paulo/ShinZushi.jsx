...
const ShinZushi = () => (
  <RestaurantPage
    restaurantName="Shin Zushi"
    address="Rua Afonso de Freitas 169, São Paulo, 04006-050, Brazil"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+551138875828"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/shin-zushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you're on the lookout for a Japanese restaurant where you can eat well in the Paraíso district, this is a perfect option, underlined by the fact that most of its clientele have Asian roots. Shin Zushi has a strong family personality as the business was originally created by the father and is currently run by two brothers (Ken and Nobu Mizumoto). The focus here is on classic Japanese cuisine which can be enjoyed at the counter, or at its more traditional tables (there is also the option of a concise menu). We particularly enjoyed the Omakase menu and service at the counter, which was very friendly and relaxed, and featured superb combinations such as the oyster with horse mackerel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Afonso%20de%20Freitas%20169%2C%20S%C3%A3o%20Paulo%2C%2004006-050%2C%20Brazil"
    pageTitle="Shin Zushi"
  />
);

export default ShinZushi;
