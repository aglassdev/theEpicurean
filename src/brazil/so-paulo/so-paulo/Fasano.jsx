...
const Fasano = () => (
  <RestaurantPage
    restaurantName="Fasano"
    address="Rua Vitório Fasano 88, São Paulo, 01414-020, Brazil"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+551138964000"
    website="https://fasano.com.br/gastronomia/fasano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The grand piano at the entrance and the lounge with its high ceiling and skylight take us right back to the New York of the 1940s. A symbol of quality, glamour and fine dining, the Fasano is renowned across Brazil for its classic Italian cuisine, albeit with a modern touch. The menu, designed by chef Luca Gozzani, showcases an extensive array of copious and surprising dishes on which pasta plays a starring role. We can recommend starting with the creamy burrata with Parma ham, followed by a succulent lamb fillet with gnocchi, with a delicious panna cotta as a final flourish – a combination of dishes that will take you on a gastronomic adventure back to Italy. The exceptional service from the front-of-house team makes the experience even more special!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Vit%C3%B3rio%20Fasano%2088%2C%20S%C3%A3o%20Paulo%2C%2001414-020%2C%20Brazil"
    pageTitle="Fasano"
  />
);

export default Fasano;
