...
const JunSakamoto = () => (
  <RestaurantPage
    restaurantName="Jun Sakamoto"
    address="Rua Lisboa 55, São Paulo, 05413-000, Brazil"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+551130886019"
    website="https://www.junsakamoto.com.br"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A highly unusual restaurant that could almost pass unnoticed as it has no external signage to show that it exists! Here, everything revolves around owner-chef Sakamoto, a man with lots of personality who is said to make the best nigiri in São Paulo. If you have the opportunity, we recommend sitting at the sushi bar, where the focus is on two Omakase tasting menus – one prepared by Jun Sakamoto himself, the other by his right-hand man, chef Ryuzo Nishimura (the price of the menu will depend on which of them does the cooking). For those sitting at the bar, the nigiris (such as yellowfin tuna, salmon from Rio de Janeiro with a light citrus glaze, yellowtail from Argentina with confit lemon, sea bass with a shiso glaze, red snapper with a dash of plum preserve and sesame seeds etc) are served ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Lisboa%2055%2C%20S%C3%A3o%20Paulo%2C%2005413-000%2C%20Brazil"
    pageTitle="Jun Sakamoto"
  />
);

export default JunSakamoto;
