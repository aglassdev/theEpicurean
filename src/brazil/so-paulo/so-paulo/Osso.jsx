...
const Osso = () => (
  <RestaurantPage
    restaurantName="Osso"
    address="Rua Bandeira Paulista, 520, São Paulo, 04532-001, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+551131673816"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/osso-1210179"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An address that is much prized by meat-lovers in the Greater São Paulo area. Here, chef Renzo Garibaldi, who is known as the “Master Butcher” in his native Peru, has opened his first culinary venture in Brazil. His cuisine is based around meat sourced from sustainable producers, with the option of dry aged and different maturing times covering an array of different cuts. Beef is the star of the show here, available as ribeye, fillet mignon, picanha and short ribs, alongside special dry-aged pure Wagyu, Vaca Velha and Angus. Dishes such as ceviche, salad, Josper-grilled fish and the rice-based “arroz de costela” also feature on the menu in a modern, elegant space with an extensive and superb wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bandeira%20Paulista%2C%20520%2C%20S%C3%A3o%20Paulo%2C%2004532-001%2C%20Brazil"
    pageTitle="Osso"
  />
);
