...
const Lass = () => (
  <RestaurantPage
    restaurantName="Lassù"
    address="Rua Conselheiro Saraiva 207, São Paulo, 02037-020, Brazil"
    cuisine="Italian Contemporary"
    priceRange="$$$"
    phoneNumber="+5511976276148"
    website="https://gruppotrevisani.com.br/casas/lassu-ristorante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If the idea of an incredible dining experience coupled with breathtaking views appeals to you, Lassù is able to combine both at the same time. With a location on the 28th floor of the lofty Edifício K1 in the Zona Norte district, this restaurant boasts one of the most impressive views of the city, with some tables enjoying a 270° perspective. The ambience here is both refined and elegant, enhanced by subtle lighting and a charming bar on one side of the dining room. The cuisine is a mix of Italian influences and ingredients from Brazil’s different regions. Standout dishes include the unmissable cod brandade served with black olive farofa, and the exquisite “lasagna ristorantino” with black truffle. The space also has the Lassù Rooftop Club, which makes it possible to celebrate exclusive ev..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Conselheiro%20Saraiva%20207%2C%20S%C3%A3o%20Paulo%2C%2002037-020%2C%20Brazil"
    pageTitle="Lassù"
  />
);
