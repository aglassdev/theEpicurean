...
const SalGastronomia = () => (
  <RestaurantPage
    restaurantName="Sal Gastronomia"
    address="Rua Bela Cintra 1958, São Paulo, 01415-006, Brazil"
    cuisine="Contemporary, Brazilian"
    priceRange="$$$"
    phoneNumber="+551135544460"
    website="https://salgastronomia.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are very few Brazilians who are not familiar with chef Henrique Fogaça, who is extremely popular thanks to his role as a judge on MasterChef as well being the lead singer for the hardcore band Oitão. Behind Sal Gastronomia’s unique pirate-inspired logo (a skull with a knife and fork) is a contemporary-style restaurant featuring industrial decorative decor, which provides the backdrop for modern Brazilian cuisine on an à la carte and two tasting menus. The sort of dishes you’ll find here include scallops with a chestnut cream and pupunha heart of palm; fish of the day with a plantain moqueca stew; and beef ribs with cassava purée, watercress pesto and cheese curd...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Bela%20Cintra%201958%2C%20S%C3%A3o%20Paulo%2C%2001415-006%2C%20Brazil"
    pageTitle="Sal Gastronomia"
  />
);

export default SalGastronomia;
