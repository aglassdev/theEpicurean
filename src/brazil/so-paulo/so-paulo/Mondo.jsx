...
const Mondo = () => (
  <RestaurantPage
    restaurantName="Mondo"
    address="Rua Oscar Freire 30, São Paulo, 01426-000, Brazil"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+551130612787"
    website="https://guide.michelin.com/en/sao-paulo-region/sao-paulo/restaurant/mondo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a restaurant where you can enjoy excellent Italian cuisine, this is definitely the right place! Located at the end of the famous Rua Oscar Freire, it boasts an elegant glass façade and a spacious interior, with an open kitchen to the rear. The cooking revolves around classic Italian recipes, including pasta, but without neglecting generous dishes of fish and meat. The menu is teeming with amazing options, including “ravioli al tuorlo”, stuffed with ricotta, spinach and melted parmesan and served with a creamy egg yolk, and “pappardele con ragù d'ossobuco”. If you still have an appetite, we also recommend the majestic “filetto alla rossini”, served with black truffle and potato millefeuille. A midday “mezzogiorno” menu option is also available midweek...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Oscar%20Freire%2030%2C%20S%C3%A3o%20Paulo%2C%2001426-000%2C%20Brazil"
    pageTitle="Mondo"
  />
);
