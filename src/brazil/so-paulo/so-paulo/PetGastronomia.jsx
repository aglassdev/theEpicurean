...
const PetGastronomia = () => (
  <RestaurantPage
    restaurantName="Petí Gastronomia"
    address="Rua Cotoxó 110 - Loja Pintar, São Paulo, 05021-000, Brazil"
    cuisine="Modern Cuisine"
    priceRange="$"
    phoneNumber="+551138730099"
    website="https://www.petirestaurante.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant that will come as something of a surprise given its location inside the Pintar Artistic Materials boutique, in the Pompeia district of the city. Here, you’ll find an unpretentious yet welcoming ambience, plus a glass-fronted patio with an organic garden. Young chef Victor Dimitrow, who gained experience working in leading restaurants in Europe, creates contemporary cuisine which is fragrant, full of taste and highly expressive from fresh and organic ingredients, but without unnecessary frills. The menu is updated every three weeks or so and offers three full options (including cover charge, starter, main course and dessert), a vegetarian version, another that includes the fish of the day, and a fourth with grilled Wagyu beef. These are also complemented by the à la carte. O Pe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Cotox%C3%B3%20110%20-%20Loja%20Pintar%2C%20S%C3%A3o%20Paulo%2C%2005021-000%2C%20Brazil"
    pageTitle="Petí Gastronomia"
  />
);

export default PetGastronomia;
