...
const VarandaGrill = () => (
  <RestaurantPage
    restaurantName="Varanda Grill"
    address="Rua Prudente Correia 432, São Paulo, 01450-030, Brazil"
    cuisine="Meats and Grills"
    priceRange="$$$"
    phoneNumber="+551130396500"
    website="https://www.varandagrill.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This renowned group, with three outlets in São Paulo, not only serves the best and most perfectly cooked meat, it also exclusively uses products from the renowned Intermezzo brand, whose quality is strictly controlled and certified to ensure excellence across the board. The kitchen, under the baton of chef Fabio Lazzarini, offers a wide selection of beef cuts cooked in the Brazilian, Argentinian and American styles, which are considered the best grilling methods worldwide. The menu ranges from the famous Kobe-style beef (considered a global delicacy), rump heart, rib flank, sirloin and porterhouse to the Varanda al Mare, a menu specialising in fish and seafood which, in keeping with the meat on the menu, showcases maximum quality and freshness. Another interesting feature here is the optio..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Prudente%20Correia%20432%2C%20S%C3%A3o%20Paulo%2C%2001450-030%2C%20Brazil"
    pageTitle="Varanda Grill"
  />
);

export default VarandaGrill;
