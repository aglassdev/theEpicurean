...
const Komah = () => (
  <RestaurantPage
    restaurantName="Komah"
    address="Rua Cônego Vicente Miguel Marino 378, São Paulo, 01135-020, Brazil"
    cuisine="Korean"
    priceRange="$$"
    phoneNumber="+551133927072"
    website="https://komahrestaurante.com.br/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Komah restaurant is renowned for its Korean cuisine with a contemporary touch – a combination of traditional recipes, signature dishes and international culinary techniques. The chef here ensures a unique gastronomic experience that challenges the palate through a panoply of flavours, with a full range from spicy to sweet. The concise menu features ten savoury dishes and three desserts, as well as a tasting option created personally by the chef. Dishes include “yukhoe”, a Korean steak tartare with cured egg yolk and Asian pear, “japchae” (sweet potato pasta with assorted vegetables and honey), and “kimchi bokumbap” with omelette, the house's signature dish, featuring rice sautéed with kimchi with a creamy omelette...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20C%C3%B4nego%20Vicente%20Miguel%20Marino%20378%2C%20S%C3%A3o%20Paulo%2C%2001135-020%2C%20Brazil"
    pageTitle="Komah"
  />
);

export default Komah;
