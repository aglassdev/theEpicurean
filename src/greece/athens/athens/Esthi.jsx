...
const Esthi = () => (
  <RestaurantPage
    restaurantName="Esthiō"
    address="7 Dimitrakopoulou, Athens, 11742, Greece"
    cuisine="Balkan"
    priceRange="€€€"
    phoneNumber="+302130452865"
    website="https://esthio.restaurant"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Dimitrakopoulou%2C%20Athens%2C%2011742%2C%20Greece"
    pageTitle="Esthiō"
  />
);

export default Esthi;
