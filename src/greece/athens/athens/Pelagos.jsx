...
const Pelagos = () => (
  <RestaurantPage
    restaurantName="Pelagos"
    address="40 Apollonos Street, Athens, 166 71, Greece"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+302108901190"
    website="https://www.pelagosathens.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If you’re keen to escape the hustle and bustle of Athens, why not consider a visit to the Four Seasons Astir Palace Hotel, a luxury resort located to the south of the Greek capital? At Pelagos, a restaurant that delights guests with its spacious sea-view terrace, enjoy Mediterranean cuisine with an Italian touch and classic French influence. In the kitchen, where talented chef Luca Piscazzi is at the helm, the cooking showcases a successful fusion of solid technique which extracts maximum benefit from local ingredients. The end result is highlighted in an à la carte menu and three tasting menus: Discovery, designed in the winter, when the chef explores the islands in search of ingredients and inspiration to bring life to the menu; Adventure, the most extensive, combining creations from the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20Apollonos%20Street%2C%20Athens%2C%20166%2071%2C%20Greece"
    pageTitle="Pelagos"
  />
);
