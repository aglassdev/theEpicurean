...
const TheZillersRooftopGastronomy = () => (
  <RestaurantPage
    restaurantName="The Zillers Rooftop Gastronomy"
    address="54 Mitropoleos, Athens, 10563, Greece"
    cuisine="Contemporary, Greek"
    priceRange="€€€"
    phoneNumber="+302103222277"
    website="https://thezillersathens.com/rooftop-gastronomy/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant occupies the former family home of the German architect Ernst Zillers, who came to Athens to design some of its public buildings, fell in love with the city and remained here for the rest of his life. The building, which is situated next to the Greek Orthodox cathedral and has now been converted into a hotel (Zillers Boutique Hotel), boasts a rooftop terrace and multi-purpose Roof Garden with fine view of the cathedral and the Acropolis. The Zillers restaurant is only open in the evening and chef Vasilis Roussos offers two tasting menus: Synecdoche and Synthesis, both with creative dishes of traditional Greek influence and touches of international flavour. One standout dish was the Prawn Valley, a refreshing combination of raw prawns with a delicate tomato sauce, bergamot a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20Mitropoleos%2C%20Athens%2C%2010563%2C%20Greece"
    pageTitle="The Zillers Rooftop Gastronomy"
  />
);

export default TheZillersRooftopGastronomy;
