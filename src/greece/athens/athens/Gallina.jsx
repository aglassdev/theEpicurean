...
const Gallina = () => (
  <RestaurantPage
    restaurantName="Gallina"
    address="49 Markou Mpotsari & 59 Falirou, Athens, 11742, Greece"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+302109237425"
    website="https://www.gallina.gr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightful bistro-restaurant that focuses on the quality of its cuisine as well as the connection between art and gastronomy. In this vibrant setting, featuring elegant marble tables and a completely open-view kitchen where you can observe the chefs at work, chef George Rekatsinas combines French and Greek traditions in his elegant and impressively textured cuisine. His dishes include fish, seafood and a varied selection of meats (including an array of matured cuts). A particular highlight on the menu are the raw Greek red prawns from Koilada, served with a hint of freshness and a balanced combination of flavours. The impressive wine list with more than 800 labels from different countries provides the perfect complement to Gallina’s dishes, while a private room on the top floor is availa..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49%20Markou%20Mpotsari%20%26%2059%20Falirou%2C%20Athens%2C%2011742%2C%20Greece"
    pageTitle="Gallina"
  />
);
