...
const TudorHall = () => (
  <RestaurantPage
    restaurantName="Tudor Hall"
    address="3A Vasileos Georgiou A, Athens, 10564, Greece"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+302103330265"
    website="https://www.tudorhall.gr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If the prospect of lunch or dinner on the elegant terrace of a hotel appeals to you, with the added bonus of background piano music and the eternal Acropolis as a backdrop, Tudor Hall is definitely a good option, especially for a romantic candlelit dinner – but make sure you book ahead. Here, on the 7th floor of the King George Hotel, next to the central Syntagma Square, chef Nikos Livadias showcases his contemporary version of Greek cuisine, based on a concise à la carte menu plus a tasting menu. The end result is a superb combination of well-balanced dishes that display strong technical ability, such as the breast of guinea fowl beetroot purée, blackberries, amaranth and praline sauce with juniper. The icing on the cake comes courtesy of the meticulous service provided by head sommelier ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3A%20Vasileos%20Georgiou%20A%2C%20Athens%2C%2010564%2C%20Greece"
    pageTitle="Tudor Hall"
  />
);

export default TudorHall;
