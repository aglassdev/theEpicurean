...
const Botrinis = () => (
  <RestaurantPage
    restaurantName="Botrini's"
    address="24b Vasileos Georgiou B street, Athens, 152 33, Greece"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+302106857323"
    website="https://www.botrinis.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="When you’re thinking about a restaurant for a special occasion, the aim is to enjoy a unique experience. This is precisely the case at Botrini’s, where guests can embark upon a gastronomic journey that tells the chefs’ personal stories which unfold between stunning Greece (Corfu and Thessaly), and romantic Tuscany. Chef Ettore Botrini, who is at the helm of this restaurant, shows himself to be a superb ambassador for cuisine that is a fusion of both countries; while his right-hand man, chef Ilias Ntoukas, dedicates himself to creating dishes that feature natural ingredients and have their roots in traditional cuisine. Occupying a former school on the outskirts of Athens, the restaurant’s interior features an elegant dining room with an open-view kitchen, the option of dining at the chef’s ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24b%20Vasileos%20Georgiou%20B%20street%2C%20Athens%2C%20152%2033%2C%20Greece"
    pageTitle="Botrini's"
  />
);

export default Botrinis;
