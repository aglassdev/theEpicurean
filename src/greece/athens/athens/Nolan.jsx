...
const Nolan = () => (
  <RestaurantPage
    restaurantName="Nolan"
    address="31-33 Voulis Street, Athens, 10557, Greece"
    cuisine="Fusion"
    priceRange="€"
    phoneNumber="+302103243545"
    website="https://www.nolanverse.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This new Nolan 2.0 version of the restaurant has chef Michalis Nourloglou in charge of the kitchen, where he follows the same concept and conjures up a combination of Greek cuisine with other dishes from around the world. The menu here is simple and concise, with options that include sea bream tartare, made with fresh fish of the day and served with dried fruits and a hint of citrus, and the mouthwatering shredded and breaded beef cheeks on a bed of cream along with a topping of truffles. The ambience here exudes relaxed joviality and a light, airy feel thanks to the large windows, and is enhanced by excellent service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31-33%20Voulis%20Street%2C%20Athens%2C%2010557%2C%20Greece"
    pageTitle="Nolan"
  />
);
