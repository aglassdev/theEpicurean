...
const VilaDoPeixe = () => (
  <RestaurantPage
    restaurantName="Vila do Peixe"
    address="Rua Doutor João Abel de Freitas 30-A, Câmara de Lobos, 9300-048, Portugal"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+351291099909"
    website="https://guide.michelin.com/en/ilha-da-madeira/cmara-de-lobos/restaurant/vila-do-peixe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An ideal lunch or dinner option for visitors given its location in the upper section of the old town (opposite the municipal market) and its huge windows boasting superb views of both the bay and the ocean. If you’re looking for authentic maritime-inspired cooking and fresh fish caught the same day you won’t find a better option, as guests can choose the piece of fish they want to eat as if they were in the market; the fish is then weighed in front of you and cooked immediately on the grill. Typical dishes well worth sampling, if available, are the popular limpets and sea snails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Doutor%20Jo%C3%A3o%20Abel%20de%20Freitas%2030-A%2C%20C%C3%A2mara%20de%20Lobos%2C%209300-048%2C%20Portugal"
    pageTitle="Vila do Peixe"
  />
);

export default VilaDoPeixe;
