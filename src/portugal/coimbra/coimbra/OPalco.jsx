...
const OPalco = () => (
  <RestaurantPage
    restaurantName="O Palco"
    address="Avenida Dom Afonso Henriques, Coimbra, 3000-011, Portugal"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+351938451205"
    website="https://www.o-palco.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The goal is to bring everyone involved in this project into the spotlight, from the producers, the products, and the staff, to, of course, the owners — chef Marco Almeida and his partner Ana, who runs the dining room. In this setting, where the ingredients are the stars, attention is focused on the distance to each supplier, listed at the end of every “scene”. The focus on local products is evident in creative dishes well-known in the region, such as the intense suckling pig butter from Bairrada, the Beirão Mocktail appetiser, which bursts to reveal the famous Licor Beirão, or the traditional snails (caracóis), presented in a way that’s sure to please. The experience is split into two tasting menus, Menu Equilíbrio (“Balance”) and Palco Principal (“Main Stage”), the latter organised into A..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Dom%20Afonso%20Henriques%2C%20Coimbra%2C%203000-011%2C%20Portugal"
    pageTitle="O Palco"
  />
);

export default OPalco;
