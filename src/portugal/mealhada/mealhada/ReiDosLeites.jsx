...
const ReiDosLeites = () => (
  <RestaurantPage
    restaurantName="Rei dos Leitões"
    address="Avenida da Restauração 17, Mealhada, 3050 -382, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+351231202093"
    website="https://guide.michelin.com/en/aveiro-region/mealhada/restaurant/rei-dos-leitoes"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a region renowned for its roast suckling pig (as well as the production of sparkling wine), this is one of many restaurants in the area specialising in this popular dish. Occupying a charming house along an avenue in town, this longstanding eatery definitely lives up to its name (The King of Suckling Pig)! The recipe and preparation of the pork follow tradition to the letter and we recommend that you accompany the dish with a glass of excellent local sparkling wine. Fish, matured meats and rice dishes also feature on the menu – all prepared with top-quality ingredients and lots of flavour. A superb wine selection completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20da%20Restaura%C3%A7%C3%A3o%2017%2C%20Mealhada%2C%203050%20-382%2C%20Portugal"
    pageTitle="Rei dos Leitões"
  />
);

export default ReiDosLeites;
