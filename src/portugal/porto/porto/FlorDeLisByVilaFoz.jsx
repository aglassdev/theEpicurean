...
const FlorDeLisByVilaFoz = () => (
  <RestaurantPage
    restaurantName="Flor de Lis by Vila Foz"
    address="Av. De Montevideu, 236, Porto, 4150-516, Portugal"
    cuisine="International, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+351222449702"
    website="https://www.vilafozhotel.pt/pt/restaurante-flor-de-lis"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If the prospect of eating in a 19C mansion overlooking the sea appeals to you, this is definitely the place, where it shares the setting with the one-Michelin-star Vila Foz, albeit with a more informal format. It is overseen by chef Arnaldo Azevedo, who serves meticulously created, sophisticated dishes with an international flavour. Choose between the à la carte and “executive” menus based around seasonal ingredients and lots of detail. When the weather allows, make sure you book a table on the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20De%20Montevideu%2C%20236%2C%20Porto%2C%204150-516%2C%20Portugal"
    pageTitle="Flor de Lis by Vila Foz"
  />
);

export default FlorDeLisByVilaFoz;
