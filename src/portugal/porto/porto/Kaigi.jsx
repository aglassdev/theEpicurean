...
const Kaigi = () => (
  <RestaurantPage
    restaurantName="Kaigi"
    address="Rua De Eugénio De Castro 226, Porto, 4100-225, Portugal"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+351938410124"
    website="https://guide.michelin.com/en/porto-region/porto/restaurant/kaigi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following something of the philosophy of traditional Japanese izakayas, this restaurant, located on the ground floor of a residential building on the outskirts of the historic centre, revolves entirely around a large, U-shaped sushi counter that can seat 16 diners. What is found here? An intriguing Japanese-Portuguese fusion cuisine, offered in an exclusive nine-course tasting menu based on the best ingredients of the day. The atmosphere is welcoming and the flavours are surprising!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20De%20Eug%C3%A9nio%20De%20Castro%20226%2C%20Porto%2C%204100-225%2C%20Portugal"
    pageTitle="Kaigi"
  />
);
