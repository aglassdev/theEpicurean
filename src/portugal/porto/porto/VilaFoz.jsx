...
const VilaFoz = () => (
  <RestaurantPage
    restaurantName="Vila Foz"
    address="Avenida De Montevideu 236, Porto, 4150-516, Portugal"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+351222449700"
    website="https://www.vilafozhotel.pt/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It will surprise you, as it occupies what was once the luxurious events room of the Vila Foz H. & SPA, an evocative 19th-century mansion located opposite Praia do Homem do Leme. Here, surrounded by elegant frames, period goldwork, original lamps and mirrors inspired by grand palatial residences, discover the gourmet cuisine of Chef Arnaldo Azevedo, who through his menus Novo Mundo (entirely vegetarian) and Maresia (more focused on Atlantic products, playing with the tides’ rhythm) champions a contemporary style of cooking that highlights the flavours of Portugal’s fantastic fish and seafood. Curious facts? In what used to be the bar, there is a counter in front of the stoves, where they also offer a far more personal, intimate, and intense option called the “Kitchen Seat” reserved exclusiv..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20De%20Montevideu%20236%2C%20Porto%2C%204150-516%2C%20Portugal"
    pageTitle="Vila Foz"
  />
);

export default VilaFoz;
