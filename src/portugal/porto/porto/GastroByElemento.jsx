...
const GastroByElemento = () => (
  <RestaurantPage
    restaurantName="Gastro by Elemento"
    address="Rua Maria Adelaide Freitas Gonçalves 13, Porto, 4350-109, Portugal"
    cuisine="Contemporary, Grills"
    priceRange="€€€"
    phoneNumber="+351225492399"
    website="https://www.gastroelemento.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Ricardo Dias Ferreira opts for a primordial style of cooking in which fire plays a leading role. Here, everything is prepared on a wood-burning stove and in a wood-fired oven, which impart a special touch and flavour to the dishes. The restaurant exudes an industrial air that includes an elegantly decorated, cosy dining area; however, be sure to try sitting at the counter in front of the kitchen, so you can watch the entire preparation process and inhale the aromas wafting from the stoves. The offering revolves around a single tasting menu, comprising 15 courses that evolves in line with the products available each season. Enjoy the experience with an exclusive wine pairing suggested by the sommelier!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Maria%20Adelaide%20Freitas%20Gon%C3%A7alves%2013%2C%20Porto%2C%204350-109%2C%20Portugal"
    pageTitle="Gastro by Elemento"
  />
);

export default GastroByElemento;
