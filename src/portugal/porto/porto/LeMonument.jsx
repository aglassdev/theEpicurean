...
const LeMonument = () => (
  <RestaurantPage
    restaurantName="Le Monument"
    address="Avenida dos Aliados 151, Porto, 4000-067, Portugal"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+351227662411"
    website="https://www.maison-albar-hotels-le-monumental-palace.com/en/page/monument-hotel-porto.3809.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If you feel like going on a high-flying culinary adventure, you will find a magnificent option here, as the luxurious Le Monumental Palace hotel provides the perfect setting. French chef Julien Montbabut, who already reached Michelin star status in Paris, rethinks his concept to take us on a grand culinary journey through Portugal’s various regions. He revisits each region’s classic recipes from his own perspective and lends a touch of modern cuisine and a deep respect for flavours to dishes based on native ingredients. The experience is presented in two versions: Grande viagem [“Grand Journey”] (7 courses) and Passeio [“Stroll”] (5 courses). Both come with the chef’s signature dish, Sapateira (brown crab), which combines Savora mustard and yuzu, blending sweet, acidic and marine notes in ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20dos%20Aliados%20151%2C%20Porto%2C%204000-067%2C%20Portugal"
    pageTitle="Le Monument"
  />
);

export default LeMonument;
