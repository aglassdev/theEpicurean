...
const CultoAoBacalhau = () => (
  <RestaurantPage
    restaurantName="Culto ao Bacalhau"
    address="Rua Formosa 322 Loja R8 - Mercado do Bolhão, Porto, 4000 248, Portugal"
    cuisine="Portuguese"
    priceRange="€€"
    phoneNumber="+351910729138"
    website="https://www.cultoaobacalhau.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re visiting the beautiful city of Porto and are planning on heading to the historic Bolhão market, make sure you jot down the name of this restaurant! It is located on the upper gallery of this legendary building and, as the name strongly suggests, it is almost completely focused on the world of cod, with bacalhau-related recipes from across Portugal (cod escabeche with mussels, “bacalhau à Brás”, rice with cod and oysters, etc), an influence that even extends to the desserts! One dessert that we particularly loved but which has nothing to do with cod was the spectacular “pão de ló” sponge cake with cream cheese from the Beiras region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Formosa%20322%20Loja%20R8%20-%20Mercado%20do%20Bolh%C3%A3o%2C%20Porto%2C%204000%20248%2C%20Portugal"
    pageTitle="Culto ao Bacalhau"
  />
);

export default CultoAoBacalhau;
