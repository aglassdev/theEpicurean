...
const Mito = () => (
  <RestaurantPage
    restaurantName="Mito"
    address="Rua De José Falcão 183, Porto, 4050 215, Portugal"
    cuisine="Contemporary, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+351222081059"
    website="https://www.mitorestaurante.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located along one of the most vibrant streets in the centre of Porto, this restaurant is definitely something to talk about since its chef Pedro Braga is pulling out all the stops in his first solo venture. Its contemporary look, featuring lights dotted across the ceiling and walls, stands out for its combination of green and wood decor, which combines harmoniously with the charming bar to the rear of the dining room. The menu is an ode to Portuguese cuisine with modern, innovative touches, including fresh fish, aged meats, plus a creative array of cocktails. To start, we recommend Mito’s signature mouthwatering matured ox croquettes with a chouriço mayonnaise, followed by a generously portioned 45-day-aged entrecôte steak. To finish, the Rabanada dessert, made with bananas from Madeira, p..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20De%20Jos%C3%A9%20Falc%C3%A3o%20183%2C%20Porto%2C%204050%20215%2C%20Portugal"
    pageTitle="Mito"
  />
);
