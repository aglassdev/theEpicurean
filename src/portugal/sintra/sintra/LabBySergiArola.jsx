...
const LabBySergiArola = () => (
  <RestaurantPage
    restaurantName="Lab by Sergi Arola"
    address="Estrada da Lagoa Azul, Sintra, 2714-511, Portugal"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+351219249011"
    website="https://www.labbysergiarola.com/en/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Penha Longa Resort is an exclusive complex, both due to its location in the Sintra-Cascais Natural Park and its luxurious facilities… boasting views of a golf course! The experience at Lab by Sergi Arola, featuring a cocktail bar and an impressive glass-walled wine cellar, begins with a variety of appetisers or tapas laid out on a large table shaped like Portugal, taking us on a tour of the country’s flavours (Algarve prawns, Bairrada suckling pig, Serra da Estrela cheese, Trás-os-Montes alheira sausage...). In its modern dining room, boasting an incredible view over the greens, celebrated Spanish chef Sergi Arola presents, via his menus (“In Memory” and “Heritage” as well as a vegetarian option called “The Garden”), highly flavoursome and meticulous signature dishes, often strongly Me..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estrada%20da%20Lagoa%20Azul%2C%20Sintra%2C%202714-511%2C%20Portugal"
    pageTitle="Lab by Sergi Arola"
  />
);

export default LabBySergiArola;
