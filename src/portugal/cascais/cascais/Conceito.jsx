...
const Conceito = () => (
  <RestaurantPage
    restaurantName="Conceito"
    address="Rua Pequena (Urb. do Viso, lote 1, loja A - Bicesse), Cascais, 2645-486, Portugal"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+351936397764"
    website="https://www.oconceito.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a residential district far from the usual foodie areas, this restaurant will definitely come as a pleasant surprise. This stems from the warm welcome on arrival and the special dedication and meticulous approach of chef Daniel Estriga, who has worked in a number of leading restaurants during his career. This is highlighted by his occasional participation in the dining room service, as well as the adding of finishing touches to some of his dishes at your table. Although the kitchen here is open-view and involves guests fully in the cooking process, it is his partner Vanessa (in charge of front of house) who guides guests through their experience. The cuisine is built around the seasonality of ingredients and is split between two surprise menus: Essência (5 courses) and Viagem (7 ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Pequena%20(Urb.%20do%20Viso%2C%20lote%201%2C%20loja%20A%20-%20Bicesse)%2C%20Cascais%2C%202645-486%2C%20Portugal"
    pageTitle="Conceito"
  />
);
