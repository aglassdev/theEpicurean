...
const Izakaya = () => (
  <RestaurantPage
    ...
    address="Rua do Poço Novo, 180, Cascais, 2750-079, Portugal"
    cuisine="Izakaya, Japanese"
    priceRange="€€€"
    phoneNumber="+351214045106"
    website="https://izakayaportugal.pt/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20do%20Po%C3%A7o%20Novo%2C%20180%2C%20Cascais%2C%202750-079%2C%20Portugal"
    pageTitle="Izakaya"
  />
);
