...
const Essencial = () => (
  <RestaurantPage
    restaurantName="Essencial"
    address="Rua da Rosa 176, Lisbon, 1200-390, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+351211573713"
    website="https://essencialrestaurante.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant, set on a side street in the popular Bairro Alto, features a fully open kitchen in the centre of the room and minimalist décor in neutral tones. Drawing from his experiences in international restaurants, Chef André Lança Cordeiro blends French techniques with seasonal Portuguese ingredients. You’ll find dishes brimming with personality, such as the famous pâté en croûte stuffed in various ways, or the lobster & sweetbread vol-au-vent, prepared with barnacles, mussels, codium seaweed, and samphire... The fixed-price menu is complemented by a solid tasting menu. Be sure to check out the wine list — it’s very appealing!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20da%20Rosa%20176%2C%20Lisbon%2C%201200-390%2C%20Portugal"
    pageTitle="Essencial"
  />
);
