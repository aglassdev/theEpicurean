...
const OfcioTascoAtpico = () => (
  <RestaurantPage
    restaurantName="Ofício - Tasco Atípico"
    ...
    pageTitle="Ofício - Tasco Atípico"
  />
);

export default OfcioTascoAtpico;
