...
const Loco = () => (
  <RestaurantPage
    ...
    priceRange="€€€€"
    phoneNumber="+351213951861"
    website="https://www.loco.pt/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In this restaurant, located just a few steps from the 18C Baroque Basílica da Estrela, they are keen to highlight their connection with micro-seasonal ingredients to maximise the flavour of each one and to meet their zero-waste criteria. Loco is full of surprises as soon as you step through the door, starting with the bright, completely open-view kitchen and enhanced by its extensive designer features that reflect its creativity and character. Head chef Alexandre Silva’s culinary philosophy is fully focused on a single surprise tasting menu comprising 16 “moments” or courses, which takes its inspiration from Portuguese tradition, while at the same time constantly evolving from a contemporary perspective. We highly recommend taking a close look at the drinks menu which, as well as featuring..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20dos%20Navegantes%2053%20B%2C%20Lisbon%2C%201200-731%2C%20Portugal"
    pageTitle="Loco"
  />
);
