...
const Pigmeu = () => (
  <RestaurantPage
    restaurantName="Pigmeu"
    address="Rua do 4 De Infantaria 68, Lisbon, 1350-274, Portugal"
    cuisine="Portuguese"
    priceRange="€€"
    phoneNumber="+351218252990"
    website="https://www.pigmeu.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few metres north of the leafy Jardim da Parada, in Lisbon’s Campo de Ourique district, there is a very simple restaurant where… the cooking and character matter far more than comfort! Everything revolves around pork (which partly explains the name of the place), a product that Chef Miguel Azevedo uses in its entirety, from snout to tail. On the menu, you will find the house classics, such as Torresmo do Rissol (crispy pork crackling), Croquetes do Pigmeu (Pigmeu croquettes), and the popular Bifana Porcalhona (a hearty pork sandwich), along with some delicious offal dishes (don’t miss the heart in coriander sauce)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20do%204%20De%20Infantaria%2068%2C%20Lisbon%2C%201350-274%2C%20Portugal"
    pageTitle="Pigmeu"
  />
);

export default Pigmeu;
