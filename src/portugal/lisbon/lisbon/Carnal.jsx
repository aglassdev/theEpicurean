...
const Carnal = () => (
  <RestaurantPage
    restaurantName="Carnal"
    address="Rua da Misericordia 78, Lisbon, 1200 273, Portugal"
    cuisine="Mexican"
    priceRange="€€"
    phoneNumber="+351913463232"
    website="https://www.carnal.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lively, centrally located restaurant quickly gained popularity for being owned by the well-known Chef Ljubomir Stanisic (head of the 100 Maneiras group). It describes itself as a Mexican gastrobar and is one of those casual places that entices your taste buds. The dishes, generally quite well-balanced, are designed for a modern and informal ambience, with subtle nods to Mexican culture, striking the right harmony of flavour and heat in each creation. On the menu, featuring typical antojitos, tostadas, gringas and the famous tacos (don’t miss the tacos al pastor or the cauliflower tacos), you’ll also find bolder or more daring options like guacamole with insects or chicharrón (both dishes include larvae and crickets). Be sure to try one of their tequila cocktails!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20da%20Misericordia%2078%2C%20Lisbon%2C%201200%20273%2C%20Portugal"
    pageTitle="Carnal"
  />
);

export default Carnal;
