...
const OTalho = () => (
  <RestaurantPage
    restaurantName="O Talho"
    address="Rua Carlos Testa 1, Lisbon, 1050-046, Portugal"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+351213154105"
    website="https://www.otalho.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Entering a restaurant through a butcher’s shop (“talho” in Portuguese) provides a clue as to the focus here and is a guarantee that the meat quality will be high and that it comes directly from the source! And it is in this modern yet at the same time informal space that chef Kiko offers his unique cuisine to guests through superb dishes prepared in an exceptional way. Meat-lovers can savour irresistible choices such as picanha from Uruguay, Galician 60-day dry aged T-bone, and A5 Kobe flank, considered one of the world’s best cuts of meat. Meat can also be purchased to be cooked at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Carlos%20Testa%201%2C%20Lisbon%2C%201050-046%2C%20Portugal"
    pageTitle="O Talho"
  />
);

export default OTalho;
