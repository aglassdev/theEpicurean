...
const ZunzumGastrobar = () => (
  <RestaurantPage
    restaurantName="Zunzum Gastrobar"
    address="Avenida Infante D. Henrique. Doca do Jardim do Tabaco, Lisbon, 1100-651, Portugal"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+351915507870"
    website="https://www.zunzum.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this elegant restaurant full of light, set in a modern, fully glazed building near the Lisbon Cruise Terminal (opposite the intriguing Museu do Lactário), the famous Chef Marlene Vieira makes a case for a top-notch contemporary concept, always grounded in the traditional Portuguese culinary repertoire, yet open to inspiration from other cuisines around the globe. It is surprising both due to its interior décor, dominated by white and red tones, and its pleasant terrace overlooking the Tagus. Interesting dishes? Algarve pink prawns with seaweed and lemon butter; Alentejo pork chop with fried polenta and roasted pepper ketchup; creamy shellfish and coriander rice......"
    ...
    pageTitle="Zunzum Gastrobar"
  />
);

export default ZunzumGastrobar;
