...
const Oven = () => (
  <RestaurantPage
    restaurantName="Oven"
    address="Rua Dos Fanqueiros 232, Lisbon, 1100-232, Portugal"
    cuisine="Nepali, Indian"
    priceRange="€€"
    phoneNumber="+351218273826"
    website="https://www.ovenlisboa.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’d like to take your tastebuds on a journey to Asia, Oven is the perfect place. Nepalese chef Hari Chapagain promises to take you on a voyage from India to Nepal through his cooking, to which he adds an innovative and contemporary touch. Many of his dishes are prepared in the “tandoor” oven (which is part of the open kitchen here and gives its name to the restaurant). Dishes he cooks in the oven include the tasty naan bread, as well as delicious grilled ribs of lamb, duck and chicken marinaded in Nepalese herbs and spices. A word of advice: we recommend asking the staff here about the levels of spiciness of each dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Dos%20Fanqueiros%20232%2C%20Lisbon%2C%201100-232%2C%20Portugal"
    pageTitle="Oven"
  />
);
