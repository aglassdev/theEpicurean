...
const SolarDosNunes = () => (
  <RestaurantPage
    restaurantName="Solar dos Nunes"
    address="Rua dos Lusíadas 68-72, Lisbon, 1300-372, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+351213647359"
    website="https://www.solardosnunes.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A renowned family-run restaurant which opened its doors in 1988 and has retained the essence of an old-style eatery serving traditional Portuguese cooking. To a backdrop of typical decor, including photos of famous faces who have eaten here, you’ll find an extensive menu that showcases the flavours of the Alentejo region, including an impressive selection of sausages and cured meats (such as the Jamón Ibérico Joselito Gran Reserva), daily specials, and game dishes in season. Don’t miss the fish soup, the Alentejo-style garlic “açorda” with cod, or “grandma’s dogfish soup”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20dos%20Lus%C3%ADadas%2068-72%2C%20Lisbon%2C%201300-372%2C%20Portugal"
    pageTitle="Solar dos Nunes"
  />
);

export default SolarDosNunes;
