...
const Ceia = () => (
  <RestaurantPage
    restaurantName="Ceia"
    address="Campo De Santa Clara 128, Lisbon, 1100-473, Portugal"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+351964362816"
    website="https://www.silentliving.pt/food/ceia/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a unique dining experience you’ll definitely find it at Ceia, which occupies an 18C building that is part of the Santa Clara 1728 hotel and where minimalism and elegance are key components. Overseen by chef Renato Bonfim, the experience takes place around a table seating 14 guests, who will enjoy sensations akin to dining with friends, albeit with people they don’t yet know! The cuisine comes courtesy of a single 10-course surprise tasting menu entitled “The Garden of Earthly Delights”, prepared using seasonal ingredients harvested from the property’s Herdade do Tempo farm estate. A wine pairing accompanies each journey – all you need to do is choose between alcoholic and non-alcoholic options as the sommelier will take care of the rest!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Campo%20De%20Santa%20Clara%20128%2C%20Lisbon%2C%201100-473%2C%20Portugal"
    pageTitle="Ceia"
  />
);
