...
const Marlene = () => (
  <RestaurantPage
    restaurantName="Marlene,"
    address="Avenida Infante D. Henrique. Doca do Jardim do Tabaco, Lisbon, 1100-651, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+351912626761"
    website="https://www.marlene.pt"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A haute cuisine-style restaurant adjacent to Zunzum Gastrobar, located in a glass-fronted building next to the Lisbon Cruise Terminal (a bonus for parking, with a huge public car park available). The restaurant, with a contemporary feel, surprises visitors with a large open central kitchen, surrounded by a counter that allows you to watch the chefs at work at all times. Chef Marlene Vieira, together with her team, presents a signature approach based on two tasting menus (9 or 12 courses) referencing both Portuguese tradition (we loved her refined blue lobster, green curry and seaweed) and flavours from other latitudes, always accompanying the dishes with cornbread following her grandmother’s old recipe. A curious detail? If you order a meat option, you are presented with a selection of han..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Infante%20D.%20Henrique.%20Doca%20do%20Jardim%20do%20Tabaco%2C%20Lisbon%2C%201100-651%2C%20Portugal"
    pageTitle="Marlene,"
  />
);
