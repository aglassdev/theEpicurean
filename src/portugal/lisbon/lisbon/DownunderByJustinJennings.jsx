...
const DownunderByJustinJennings = () => (
  <RestaurantPage
    restaurantName="Downunder by Justin Jennings"
    address="Rua Dos Industriais 21, Lisbon, 1200-685, Portugal"
    cuisine="Australian Contemporary"
    priceRange="€€"
    phoneNumber="+351214012967"
    website="https://www.downunder.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’ve never eaten crocodile or kangaroo, now is your chance in this unpretentious restaurant run by a young Australian chef who fell in love with Lisbon and set up his own business here. His somewhat unusual cuisine, available on an à la carte and two set menus, shines a light on Australian cuisine and its exotic meats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Dos%20Industriais%2021%2C%20Lisbon%2C%201200-685%2C%20Portugal"
    pageTitle="Downunder by Justin Jennings"
  />
);

export default DownunderByJustinJennings;
