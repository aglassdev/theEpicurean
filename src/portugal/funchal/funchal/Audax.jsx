...
const Audax = () => (
  <RestaurantPage
    restaurantName="Audax"
    address="Rua Imperatriz Dona Amélia, 104, Funchal, 9000-018, Portugal"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+351291147850"
    website="https://guide.michelin.com/en/ilha-da-madeira/funchal/restaurant/audax"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in one of the most dynamic leisure areas of Funchal, where there is plenty of competition and many alternative dining options, this restaurant stands out for its flavourful, tradition-filled offering. Inside, with a modern décor and a fully open kitchen, chef César Vieira offers a contemporary cuisine rooted in the island’s folklore, featuring an executive lunch menu and a more haute cuisine approach in the evening, when you can choose between à la carte or two tasting menus. An enticing dish? Their delicious Poncha and Coastal Prawn, which references the typical Poncha fishermen made with their peanuts, viewed from a contemporary perspective...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Imperatriz%20Dona%20Am%C3%A9lia%2C%20104%2C%20Funchal%2C%209000-018%2C%20Portugal"
    pageTitle="Audax"
  />
);

export default Audax;
