...
const CasalDaPenha = () => (
  <RestaurantPage
    restaurantName="Casal da Penha"
    address="Rua Penha de França - Beco do Ataíde n.1, Funchal, 9000-014, Portugal"
    cuisine="Portuguese"
    priceRange="€€"
    phoneNumber="+351291227674"
    website="https://casaldapenha.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family-run company that champions the charm of simple yet authentic things, always letting the product speak for itself. It is located in the city centre, surrounded by large hotels, and its modest yet well-organised dining room is enhanced by a marvellous rooftop terrace. The father, in charge of the stoves, serves up traditional cuisine featuring many regional specialities, delicious fresh fish of the day, a wide variety of meats, great rice dishes... and even paellas. Don’t miss the grilled limpets served in a skillet, a delicious traditional dish closely linked to the island of Madeira...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Penha%20de%20Fran%C3%A7a%20-%20Beco%20do%20Ata%C3%ADde%20n.1%2C%20Funchal%2C%209000-014%2C%20Portugal"
    pageTitle="Casal da Penha"
  />
);

export default CasalDaPenha;
