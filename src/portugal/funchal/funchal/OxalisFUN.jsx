...
const OxalisFUN = () => (
  <RestaurantPage
    restaurantName="Oxalis"
    address="Rua da Estalagem 23, Funchal, 9060 415, Portugal"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+351291790350"
    website="https://casa-velha.com/dining/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment, located in the Casa Velha do Palheiro hotel a few kilometres from the south coast and Funchal, enchants visitors with its two-plus centuries of history and its setting amid verdant golf courses. With classic-colonial style and a completely open kitchen, Chef Gonçalo Bita Bota proposes modern Portuguese cuisine, raising Madeiran flavours to a higher level. The use of seasonal ingredients from local farmers and fishermen shows a genuine commitment to island produce and is reflected in different menus. A dish that enchanted us? Cured cold-stream trout accompanied by fennel ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20da%20Estalagem%2023%2C%20Funchal%2C%209060%20415%2C%20Portugal"
    pageTitle="Oxalis"
  />
);

export default OxalisFUN;
