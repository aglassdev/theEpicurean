...
const IlGalloDoro = () => (
  <RestaurantPage
    restaurantName="Il Gallo d'Oro"
    address="Estrada Monumental 147, Funchal, 9004-532, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+351291707700"
    website="https://www.portobay.com/en/restaurants/restaurants-madeira/il-gallo-doro"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="They say that Madeira, the “Pearl of the Atlantic,” is paradise on Earth; we cannot guarantee that, but… dining here is like being in Eden! French chef Benoît Sinthon champions a fresh, flavourful, creative cuisine that celebrates local flavours (From Our Seas, Traditions, Homage to the Atlantic, From the Valley to the Mountain...) by reviving old recipes, reinterpreting them with modern techniques, and using products that underpin his commitment to sustainability (many are organic, from the PortoBay garden). They offer two tasting menus: Terroir Experience (which highlights the island’s own ingredients) and Il Gallo d’Oro Top Experience (offered in either 9 or 12 courses). Suggestions? If you want an even more special experience, book the exclusive “Chef’s Table” or dine on the terrace, w..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estrada%20Monumental%20147%2C%20Funchal%2C%209004-532%2C%20Portugal"
    pageTitle="Il Gallo d'Oro"
  />
);

export default IlGalloDoro;
