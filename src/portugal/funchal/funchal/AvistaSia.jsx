...
const AvistaSia = () => (
  <RestaurantPage
    restaurantName="Avista Ásia"
    address="Estrada Monumental,145, Funchal, 9004-532, Portugal"
    cuisine="Fusion, Asian Influences"
    priceRange="€€€"
    phoneNumber="+351291707770"
    website="https://www.portobay.com/pt/restaurantes/restaurantes-madeira/avista-asia/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily Closed) It completes the culinary offering of the luxurious Cliff Bay hotel! This restaurant, located on the upper floor of the likewise mentioned Avista, is firmly committed to Asian fusion cuisine, so you will find typical dishes from Chinese, Japanese and Korean recipes, always with very pronounced flavours, enhanced by nods to both the Mediterranean and the Madeira archipelago itself. It offers great views over Funchal, an à la carte service and several menus (3, 5 and 7 courses, as well as a 7-course premium version)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estrada%20Monumental%2C145%2C%20Funchal%2C%209004-532%2C%20Portugal"
    pageTitle="Avista Ásia"
  />
);

export default AvistaSia;
