...
const William = () => (
  <RestaurantPage
    restaurantName="William"
    address="Estrada Monumental 139, Funchal, 9000-098, Portugal"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+351291717171"
    website="https://www.belmond.com/hotels/europe/portugal/madeira/belmond-reids-palace/william-restaurant"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Are you looking for an exclusive gastronomic venue on the charming island of Madeira? This could be the perfect choice! Located in the luxurious Belmond Reid’s Palace, this restaurant offers one of the most breathtaking views of Funchal’s coastline. Its name pays homage to the legendary William Reid, the Scottish dreamer who began building the hotel more than a century ago. Here, Chef José Diogo Costa – having returned to his native island after working in several prestigious restaurants – offers two tasting menus (William and Discovery) that showcase local ingredients and pair them with modern techniques in a classic, elegant setting. Dishes such as Atlantic fish served with a tasty pumpkin, salsify and vegetarian dashi sauce, or the seductive, crisp duck breast accompanied by couscous an..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estrada%20Monumental%20139%2C%20Funchal%2C%209000-098%2C%20Portugal"
    pageTitle="William"
  />
);
