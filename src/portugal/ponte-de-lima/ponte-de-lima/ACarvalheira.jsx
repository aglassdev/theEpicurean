...
const ACarvalheira = () => (
  <RestaurantPage
    restaurantName="A Carvalheira"
    address="Rua do Eido Velho 73, Ponte de Lima, 4990-620, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+351258742316"
    website="https://www.acarvalheira.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a unique lunch in a special setting, this is a truly outstanding option; indeed, Quinta do Eido Velho captivates with its rustic charm and well-kept gardens. At the helm is Chef Maria Teresa Gomes, who advocates a hearty, flavourful Portuguese cuisine without fuss, meticulously prepared in line with the traditions of the Alto Minho. Don’t miss the roast kid goat, the most iconic dish, and pair it with a red Vinho Verde — they have it here, and it isn’t always easy to find elsewhere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20do%20Eido%20Velho%2073%2C%20Ponte%20de%20Lima%2C%204990-620%2C%20Portugal"
    pageTitle="A Carvalheira"
  />
);

export default ACarvalheira;
