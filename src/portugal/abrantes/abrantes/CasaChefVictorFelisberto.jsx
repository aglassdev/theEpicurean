...
const CasaChefVictorFelisberto = () => (
  <RestaurantPage
    restaurantName="Casa Chef Victor Felisberto"
    address="Rua Francisco Ferreira da Mata 99, Abrantes, 2200-223, Portugal"
    cuisine="Meats and Grills, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+351931737898"
    website="https://casachefvictorfelisberto.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re thinking of trying fried sweetbreads, a chunk of veal, wood-fired slow-cooked chanfana (goat stew), or even confit pork cheeks from black pigs, there’s no better place than Casa do Chef Victor Felisberto. The specialty here is meat, cooked — mostly slowly — in a wood-fired oven, ensuring extremely succulent textures and deeper flavours. Additionally, the restaurant’s incredible signature fondants, as well as the bread baked in the same oven, should not be forgotten. With experience in renowned restaurants, the chef strives to share his interpretation of regional cuisine, blending traditional recipes with genuine flavours and products. His open kitchen and the spacious, light-filled dining room, complemented by a more intimate lounge, set the perfect scene for a memorable visit!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Francisco%20Ferreira%20da%20Mata%2099%2C%20Abrantes%2C%202200-223%2C%20Portugal"
    pageTitle="Casa Chef Victor Felisberto"
  />
);

export default CasaChefVictorFelisberto;
