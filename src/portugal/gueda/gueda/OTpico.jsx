...
const OTpico = () => (
  <RestaurantPage
    restaurantName="O Típico"
    address="Rua Doutor Manuel Alegre 42, Águeda, 3750-139, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+351234625336"
    website="https://guide.michelin.com/en/aveiro-region/gueda/restaurant/o-tipico"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you appreciate authenticity, head to this modest restaurant, situated just a few minutes’ walk from Jardim da Praça do Município and run by a charming couple. The simple façade gives way to a single dining room brimming with tradition, where you’ll find regional details, antique items, eye-catching beer steins... and even some farming tools. Here you’ll find a local clientele and a 100% Portuguese cuisine, with hearty country dishes featuring meats, some fish preparations, tasty stews, rice dishes... and delicious homemade desserts. Do not miss the Migas Lagareiras (a dish based on breadcrumbs and olives) or the remarkably succulent wild game alheira sausage!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Doutor%20Manuel%20Alegre%2042%2C%20%C3%81gueda%2C%203750-139%2C%20Portugal"
    pageTitle="O Típico"
  />
);

export default OTpico;
