...
const Doc = () => (
  <RestaurantPage
    restaurantName="DOC"
    address="Estrada Nacional 222, Folgosa, 5110-214, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+351254858123"
    website="https://www.docrestaurante.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It occupies a modern-style building that stands out due to its riverside location on the Douro and boasts an appealing terrace overlooking the water. This venue combines a superb setting with a cuisine that needs no introduction, since the menu is by the renowned Chef Rui Paula. Here, the chef offers a style of cooking that reflects his Trás-os-Montes roots, drawing on past memories and fused with products from the riverside, delivering intense, surprising flavours. The à la carte offering is supplemented by three tasting menus and a vegetarian section. To round out the experience, there is an extensive wine selection — well worth a look!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Estrada%20Nacional%20222%2C%20Folgosa%2C%205110-214%2C%20Portugal"
    pageTitle="DOC"
  />
);
