...
const PequenoMundo = () => (
  <RestaurantPage
    restaurantName="Pequeno Mundo"
    address="Caminho de Pereiras, Almancil, 8135-907, Portugal"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+351927960423"
    website="https://www.pequeno-mundo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a pleasant, romantic spot with excellent service… this is a must-visit restaurant! Set in a charming Algarvian house, with outdoor courtyards filled with plants and greenery. Inside, it’s divided into different dining rooms, plus a bar area at the entrance, complete with a lovely fireplace. The concept is based on international cuisine, with strong French and Portuguese influences, highlighting the quality of the predominantly local produce. The menu features a 6-course tasting option, vegetarian choices, and off-menu dishes featuring the day’s freshest products. Our recommendations? The prawns with sautéed portobello mushrooms and, for dessert, the crispy red fruits — light and delightful on the palate!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Caminho%20de%20Pereiras%2C%20Almancil%2C%208135-907%2C%20Portugal"
    pageTitle="Pequeno Mundo"
  />
);

export default PequenoMundo;
