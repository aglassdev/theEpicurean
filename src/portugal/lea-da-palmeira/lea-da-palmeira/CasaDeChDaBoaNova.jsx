...
const CasaDeChDaBoaNova = () => (
  <RestaurantPage
    restaurantName="Casa de Chá da Boa Nova"
    address="Avenida da Liberdade, 1681, Leça da Palmeira, 4450-718, Portugal"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+351229940066"
    website="https://www.casadechadaboanova.pt/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Rarely is the concept of “bringing the sea to your table” more apt or authentic than at this restaurant where the waves almost break in the dining room! In this unique and spectacular building (an officially listed national monument) standing on the rocks above the Praia da Boa Nova, chef Rui Paula, ably supported by executive chef Catarina Correia, presents cuisine inspired by a verse (“Hitherto unchartered waters”) by famous Portuguese poet Luís Vaz de Camões in his most celebrated work, The Lusiads. This is showcased on a concise à la carte and a superb tasting menu entitled Cantos, which can be ordered with 6, 12 or 21 dishes. His cuisine, which is centred around the maritime world and which always makes full use of truly exceptional ingredients, includes standout dishes such as Red Pr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20da%20Liberdade%2C%201681%2C%20Le%C3%A7a%20da%20Palmeira%2C%204450-718%2C%20Portugal"
    pageTitle="Casa de Chá da Boa Nova"
  />
);

export default CasaDeChDaBoaNova;
