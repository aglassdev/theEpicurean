...
const Machado = () => (
  <RestaurantPage
    restaurantName="Machado"
    address="Rua Doutor António José de Almeida 467, Nogueira, 4475-456, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+351229410839"
    website="https://guide.michelin.com/en/porto-region/nogueira/restaurant/machado"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Quality and quantity are both guaranteed at this restaurant occupying an old house in a small village close to Maia. Several separate dining rooms, all with a similar rustic decor, simple table settings and lots of typical decorative details hanging from the walls. Here, it is impossible to leave hungry given the copious portions on the traditional home-cooked menu which teems with local flavours. Make sure you try Machado’s house speciality, the Lafões-style roast veal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Doutor%20Ant%C3%B3nio%20Jos%C3%A9%20de%20Almeida%20467%2C%20Nogueira%2C%204475-456%2C%20Portugal"
    pageTitle="Machado"
  />
);
