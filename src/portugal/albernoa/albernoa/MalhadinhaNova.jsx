...
const MalhadinhaNova = () => (
  <RestaurantPage
    restaurantName="Malhadinha Nova"
    address="Herdade da Malhadinha Nova, Albernoa, 7800-601, Portugal"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+351284965432"
    website="https://www.malhadinhanova.pt/pt/hotel/restaurante/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite its access via a long lane, this restaurant surrounded by stunning vineyards is clearly signposted. It occupies the ground floor of a small house which is glass-fronted throughout and boasts breathtaking views. The cuisine here bears the signature of chef Joachim Koerper and is based on Alentejo cooking with hints of international influence. We can highly recommend the local eggs, DOP-certified Malhadinha-reared merino lamb and the honey produced on the estate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herdade%20da%20Malhadinha%20Nova%2C%20Albernoa%2C%207800-601%2C%20Portugal"
    pageTitle="Malhadinha Nova"
  />
);

export default MalhadinhaNova;
