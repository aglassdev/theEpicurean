...
const Vinha = () => (
  <RestaurantPage
    restaurantName="Vinha"
    address="Rua Quinta Fonte da Vinha 383, Vila Nova de Gaia, 4430-487, Portugal"
    cuisine="Portuguese, Creative"
    priceRange="€€€€"
    phoneNumber="+351221154122"
    website="https://www.vinhaboutiquehotel.com/en/tastes"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It is located in the exclusive Vinha Boutique Hotel, a small 16th-century mansion on the banks of the Douro, where sophistication and elegance lie around every corner. In the exquisitely decorated fine-dining restaurant, the menu is by renowned Chef Henrique Sá Pessoa and ably executed by resident Chef Jonathan Seiller. Here, the contemporary concept revolves around seasonal Portuguese produce with international influences, translated into à la carte dishes and a single tasting menu called Identidade (“Identity”), enhanced by two wine pairing options. Standout dishes? We loved both the crab, scallop & caviar dish and the Algarve scarlet prawn with coconut tapioca, sweet potato and curry, a powerful combination of flavours evoking Europe, Asia and the Americas all at once. Cooking times are..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Quinta%20Fonte%20da%20Vinha%20383%2C%20Vila%20Nova%20de%20Gaia%2C%204430-487%2C%20Portugal"
    pageTitle="Vinha"
  />
);
