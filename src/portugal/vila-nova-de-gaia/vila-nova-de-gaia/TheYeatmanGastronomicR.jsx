...
const TheYeatmanGastronomicR = () => (
  <RestaurantPage
    restaurantName="The Yeatman Gastronomic R."
    address="Rua do Choupelo (Santa Marinha), Vila Nova de Gaia, 4400-088, Portugal"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+351220133100"
    website="https://www.the-yeatman-hotel.com/en/food/restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Everyone knows that the city of Porto has a timeless, almost magical charm; what not everyone knows is that one of the best places to take it all in is on the riverside in Vila Nova de Gaia, on the opposite bank of the Douro. Housed in the luxurious Yeatman hotel and its namesake restaurant, Chef Ricardo Costa presents a creative offering that, via a single, ever-evolving tasting menu (kicking off with appetisers in both the bar area and the kitchen), rests on two pillars: the exaltation of traditional Portuguese gastronomy (the 2021 suckling pig dish stands out) and the use of top-quality seasonal products (most of which arrive daily from the ocean). Little details that enhance the experience? It boasts one of the best wine cellars in Portugal, has extremely professional service, and offe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20do%20Choupelo%20(Santa%20Marinha)%2C%20Vila%20Nova%20de%20Gaia%2C%204400-088%2C%20Portugal"
    pageTitle="The Yeatman Gastronomic R."
  />
);

export default TheYeatmanGastronomicR;
