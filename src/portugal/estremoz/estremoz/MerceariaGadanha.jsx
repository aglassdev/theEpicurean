...
const MerceariaGadanha = () => (
  <RestaurantPage
    restaurantName="Mercearia Gadanha"
    address="Largo dos Dragões de Olivença 84, Estremoz, 7100-457, Portugal"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+351268333262"
    website="https://www.merceariagadanha.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This centrally located restaurant with a welcoming feel comes as something of a surprise, as it is accessed via a bar- gourmet shop that has the feel of an authentic grocery store. In the rustic-contemporary dining room, featuring exposed wood beams and even a table for two in the fireplace, choose from an extensive menu combining regionally inspired dishes (crispy prawns, scrambled eggs, different black pork recipes) with those with a more international feel, all of which are prepared with a subtle, modern touch. Cheese, sausages and wine from the Estremoz area are available for purchase in the boutique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Largo%20dos%20Drag%C3%B5es%20de%20Oliven%C3%A7a%2084%2C%20Estremoz%2C%207100-457%2C%20Portugal"
    pageTitle="Mercearia Gadanha"
  />
);

export default MerceariaGadanha;
