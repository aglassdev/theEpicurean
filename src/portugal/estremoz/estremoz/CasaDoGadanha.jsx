...
const CasaDoGadanha = () => (
  <RestaurantPage
    restaurantName="Casa do Gadanha"
    address="Rua da Vasco da Gama 4, Estremoz, 7100-559, Portugal"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+351268249790"
    website="https://www.casadogadanha.pt/restaurante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the historic heart of Estremoz, also known as the “white city” because of its fascinating marbles, this restaurant offers a cosy and intimate ambience, where warm, pure colours create a welcoming atmosphere. From the dining room, it is possible to observe the kitchen in action and see the dishes being crafted, presented in a menu based on sharing plates and two tasting menus (6 and 8 courses). The cuisine on offer ranges from signature dishes and comfort food prepared in a traditional wood oven, with options that change daily...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20da%20Vasco%20da%20Gama%204%2C%20Estremoz%2C%207100-559%2C%20Portugal"
    pageTitle="Casa do Gadanha"
  />
);

export default CasaDoGadanha;
