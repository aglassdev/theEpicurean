...
const VistasMonteRei = () => (
  <RestaurantPage
    restaurantName="Vistas Monte Rei"
    address="Sitio de Pocinho, Vila Nova de Cacela, 8901-907, Portugal"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+351281950950"
    website="https://vistasmonterei.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily closed) We find ourselves in a luxury resort (Monte Rei Golf & Country Club) in the eastern Algarve, where they say the best golf course in Portugal can be found, and which deserves a range of cuisine to match! The elegant dining room, in a classic style with large windows overlooking the surrounding greenery, boasts just a few impeccably set tables, along with one reserved for private dining in the kitchen area. The concept, created by Chef André Simão, is based on a single tasting menu (Do Mar à Serra [“From the Sea to the Mountains”]), with two pairing options, making a concerted effort to work with the region’s raw ingredients and local small-scale producers (Tavira oysters, Vila Real de Santo Antonio muxama [salt-cured tuna], the famed Algarve violet prawn, sourdough brea..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sitio%20de%20Pocinho%2C%20Vila%20Nova%20de%20Cacela%2C%208901-907%2C%20Portugal"
    pageTitle="Vistas Monte Rei"
  />
);

export default VistasMonteRei;
