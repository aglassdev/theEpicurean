...
const RestauranteF = () => (
  <RestaurantPage
    restaurantName="Restaurante F"
    address="Av. Tomás Cabreira - Edificio Falésia, Portimao, 8500-802, Portugal"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+351919115512"
    website="https://www.restaurantef.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Restaurante F is the ideal place for those seeking good food in a relaxed atmosphere with stunning views. Away from the typical seaside eateries, this welcoming spot features a glassed-in terrace that looks out over the iconic Praia da Rocha — perfect for watching the sunset. The menu is inspired by authentic Portuguese cooking, with international influences, where the key feature is the quality of ingredients sourced from local producers. All the dishes are prepared with skill, and the selection features meat, fish, fresh seafood... but be sure not to miss the octopus cataplana with sweet potato, cooked to perfection and packed with flavour. The wine list is dominated by Portuguese wines, which can also be purchased on site...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Tom%C3%A1s%20Cabreira%20-%20Edificio%20Fal%C3%A9sia%2C%20Portimao%2C%208500-802%2C%20Portugal"
    pageTitle="Restaurante F"
  />
);
