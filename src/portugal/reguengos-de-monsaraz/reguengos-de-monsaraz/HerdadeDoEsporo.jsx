...
const HerdadeDoEsporo = () => (
  <RestaurantPage
    restaurantName="Herdade do Esporão"
    address="Herdade do Esporão, Reguengos de Monsaraz, 7200-999, Portugal"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+351266509280"
    website="https://esporao.com/pt/turismo/restaurante-da-herdade-do-esporao"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thanks to top-quality local ingredients, well-defined textures and harmonious flavours, everything is so delicious here that you’ll want to try every dish!This restaurant, situated on a large farm-wine estate surrounded by vineyards, olive groves and even a reservoir, boasts a modern look with hints of Scandinavian design. It is also self-sufficient in vegetables as it has its own market garden that provides all of its organic ingredients. Chef Carlos Teixeira’s constant focus on sustainability results in modern cooking that is based around seasonal ingredients both from the farm estate and the Alentejo. His dishes (textures of corn, “Lucio perca alentejana” (pork and clams) with potatoes, local lamb with rice and a vegetable salad, etc) are presented on a tasting menu (Carta Branca) on wh..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herdade%20do%20Espor%C3%A3o%2C%20Reguengos%20de%20Monsaraz%2C%207200-999%2C%20Portugal"
    pageTitle="Herdade do Esporão"
  />
);

export default HerdadeDoEsporo;
