...
const Mapa = () => (
  <RestaurantPage
    restaurantName="MAPA"
    address="Herdade das Valadas, N4, Montemor-o-Novo, 7050-031, Portugal"
    cuisine="Creative, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+351266242400"
    website="https://www.l-and.com/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It offers great comfort and surprises by virtue of its location in the heart of the Alentejo countryside, in the splendid, modern hotel L’AND Vineyards Relais & Châteaux. Chef David Jesus, who decided to take on this project after stints at major establishments such as the two-Michelin-starred Belcanto (Lisbon), champions a creative cuisine with traditional foundations, drawing on his personal experiences and memories. His offering, mostly enjoyed by the hotel’s guests, is presented in an à la carte format and through two tasting menus: Expedição (Expedition) in 7 moments and Caminhos (“Paths”) served in 11 moments, inspired by the chef’s experiences of Portuguese travels and the flavours of its former colonies. A standout dish? We loved the red mullet from Setúbal, which combines the typi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Herdade%20das%20Valadas%2C%20N4%2C%20Montemor-o-Novo%2C%207050-031%2C%20Portugal"
    pageTitle="MAPA"
  />
);
