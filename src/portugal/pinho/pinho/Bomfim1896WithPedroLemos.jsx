...
const Bomfim1896WithPedroLemos = () => (
  <RestaurantPage
    restaurantName="Bomfim 1896 with Pedro Lemos"
    address="Quinta do Bomfim, Pinhão, 5085-060, Portugal"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+351254730360"
    website="https://pt.symington.com/bomfim1896-pedrolemos"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the Quinta do Bomfim, an estate run by the Symington family since 1896 (hence the name of the restaurant), this project is a partnership with renowned chef Pedro Lemos. Situated on the banks of the River Douro, it boasts a classic and sophisticated ambience, plus a completely open dining room with a view of the kitchen, and superb vistas through the large picture windows. The fireplace and wood-fired oven take centre stage here, alongside cuisine that revisits the flavours of the Douro Valley’s time-honoured kitchens, albeit with a more contemporary vision...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quinta%20do%20Bomfim%2C%20Pinh%C3%A3o%2C%205085-060%2C%20Portugal"
    pageTitle="Bomfim 1896 with Pedro Lemos"
  />
);

export default Bomfim1896WithPedroLemos;
