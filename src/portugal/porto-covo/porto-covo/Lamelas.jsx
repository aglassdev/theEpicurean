...
const Lamelas = () => (
  <RestaurantPage
    restaurantName="Lamelas"
    address="Rua Cândido da Silva 55 A, Porto Covo, 7520-437, Portugal"
    cuisine="Regional European, Contemporary"
    priceRange="€€"
    phoneNumber="+351924060426"
    website="https://lamelasrestaurante.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20C%C3%A2ndido%20da%20Silva%2055%20A%2C%20Porto%20Covo%2C%207520-437%2C%20Portugal"
    pageTitle="Lamelas"
  />
);

export default Lamelas;
