...
const CheckinByLeonelPereira = () => (
  <RestaurantPage
    restaurantName="CHECKin by Leonel Pereira"
    address="Rua do Castelo 7, Faro, 8000-243, Portugal"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+351968070776"
    website="https://checkinfaro.pt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This charming restaurant occupies a former cereal and wine storehouse which has been completely remodelled in Faro’s historic centre. The cooking of chef Leonel Pereira, a native of the Algarve, is based around seasonal ingredients with a strong focus on creativity and flavour. The menu is divided into different sections: Check-in, Cozinhados no Tacho, Momentos Especiais and Check-out. Make sure you try the cheesecake with strawberries, lime, meringue and tangerine peel ice-cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20do%20Castelo%207%2C%20Faro%2C%208000-243%2C%20Portugal"
    pageTitle="CHECKin by Leonel Pereira"
  />
);

export default CheckinByLeonelPereira;
