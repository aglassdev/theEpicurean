...
const Balco = () => (
  <RestaurantPage
    restaurantName="Ó Balcão"
    address="Rua Pedro de Santarém 73, Santarém, 2000-223, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+351918252808"
    website="https://tabernaobalcao.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Ó Balcão is the perfect place for those keen to try new varieties of fish. Rodrigo Castelo is at the helm here – a chef from the Ribatejo province involved in numerous research projects who has found a way to truly showcase ingredients from his home region, with a predominant use of river fish to maintain a balance with the local ecosystem.The restaurant has the feel of an old tavern, with striking tiles that add a contemporary air and provide the backdrop for refined dishes prepared with a delicate touch. The cuisine here has it own distinct identity and is based around fish such as pike, barbel and catfish, some of which are cured in salt. Meat options here include wild boar and wild duck. Dishes on the menu that you won’t to miss include the “coscorão do rio até ao mar” (a crispy pancak..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Pedro%20de%20Santar%C3%A9m%2073%2C%20Santar%C3%A9m%2C%202000-223%2C%20Portugal"
    pageTitle="Ó Balcão"
  />
);

export default Balco;
