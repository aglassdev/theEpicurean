...
const Npern = () => (
  <RestaurantPage
    restaurantName="näperõn"
    address="Rua 25 Abril 113, Odeceixe, 8670-320, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+351916177333"
    website="https://guide.michelin.com/en/faro-region/odeceixe/restaurant/naperon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a restaurant in the small village of Odeceixe that surprises. This charming establishment, run by Chef Hugo Nascimento, is a rewarding discovery for anyone who visits. Located beside the Casas do Moinho, it features thoughtful décor and impressive views for those who like to sit by the pool and admire the windmill — the town’s symbol — as a backdrop. The offer is founded on contemporary Portuguese cuisine, prepared with seasonal produce and a menu updated daily, served in two surprise tasting menus of four and seven courses at the chef’s discretion. It should be noted, however, that the experience is very well conceived and the presentations are exquisite — so you will certainly want to return!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%2025%20Abril%20113%2C%20Odeceixe%2C%208670-320%2C%20Portugal"
    pageTitle="näperõn"
  />
);

export default Npern;
