...
const SolarDoForcado = () => (
  <RestaurantPage
    restaurantName="Solar do Forcado"
    address="Rua Candido dos Reis 14, Portalegre, 7300-129, Portugal"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+351245330866"
    website="https://guide.michelin.com/en/portalegre-region/portalegre/restaurant/solar-do-forcado"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s located on a narrow cobbled street in the historic centre, relatively close to the castle that dominates the city. Its modest façade gives way to a not-too-large but cosy rustic-style space, whose décor revolves around the world of bullfighting. Here, you’ll find traditional cuisine specialising in meats, almost always featuring a dish made from fighting bull in honour of the Forcados, a typical art of Portuguese bullfighting that both the owner and his father practised successfully. Try their famous fighting bull kebab and, if possible... don’t miss the Portuguese stew (cozido) served up on Thursdays!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Candido%20dos%20Reis%2014%2C%20Portalegre%2C%207300-129%2C%20Portugal"
    pageTitle="Solar do Forcado"
  />
);

export default SolarDoForcado;
