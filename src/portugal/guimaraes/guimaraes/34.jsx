...
const ThreeFour = () => (
  <RestaurantPage
    restaurantName="34"
    address="Largo do Toural 23, Guimaraes, 4810 427, Portugal"
    cuisine="International"
    priceRange="€€"
    phoneNumber="+351934249966"
    website="https://guide.michelin.com/en/braga-region/guimares/restaurant/34"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Restaurant 34, in the heart of Guimarães’s historic centre, comes across as the top choice for combining lunch or dinner… with truly marvellous views! If you’re exploring this charming city, book a table on the third floor of this establishment, as it offers stunning views over Largo do Toural and the historic Basilica of St. Peter. The ambience is modern and relaxed, with tasteful wooden hues that blend beautifully with the surrounding greenery. The menu features international dishes, from fresh burrata to Japanese-inspired salmon toro, culminating in refined lamb with chestnut purée or succulent pork ribs. There are plenty of reasons to go and indulge!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Largo%20do%20Toural%2023%2C%20Guimaraes%2C%204810%20427%2C%20Portugal"
    pageTitle="34"
  />
);
