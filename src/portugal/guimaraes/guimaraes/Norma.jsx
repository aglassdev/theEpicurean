...
const Norma = () => (
  <RestaurantPage
    ...
    address="Rua Doutor José Sampaio 35, Guimaraes, 4810 275, Portugal"
    cuisine="Creative, Portuguese"
    priceRange="€€"
    phoneNumber="+351939501461"
    website="https://www.foodbynorma.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in an old building that almost goes unnoticed among its neighbours. This restaurant enjoys privileged views from its terrace, where you can contemplate the Church of São Gualter – an iconic symbol of the city. At the stove is Chef Miguel Marques, who boasts wide experience in renowned restaurants in Zurich, Munich and Portugal, and presents a menu inspired by human Evolution, reflected in dishes that hark back to the past and others that draw on culinary progress. His proposal revolves around a single seven-course tasting menu and an à la carte that changes each season, alongside an interesting selection of Portuguese wines!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Doutor%20Jos%C3%A9%20Sampaio%2035%2C%20Guimaraes%2C%204810%20275%2C%20Portugal"
    pageTitle="Norma"
  />
);
