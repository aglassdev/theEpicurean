...
const Camelo = () => (
  <RestaurantPage
    restaurantName="Camelo"
    address="Rua de Santa Marta 119, Viana do Castelo, 4925-104, Portugal"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+351258839090"
    website="https://camelorestaurantes.com/camelo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run establishment, almost always busy, is located in a town with a long maritime tradition, as many cod-fishing vessels once sailed from here to Newfoundland and Greenland (there’s a space dedicated to the Minho Cod Academy). You’ll find a waiting bar and several dining rooms, all very tastefully decorated, plus a large marquee for banquets and a huge garden patio used for the outdoor seating area. They serve up quality-certified Minho cuisine here, as they keep their own shellfish tank, a lamprey tank, a good meat section and even vegetarian options on the menu. A tip? Don’t miss their famous Bacalhau à Camelo (Camelo style Cod), as well as their lamprey dishes in season (from January onwards)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20de%20Santa%20Marta%20119%2C%20Viana%20do%20Castelo%2C%204925-104%2C%20Portugal"
    pageTitle="Camelo"
  />
);

export default Camelo;
