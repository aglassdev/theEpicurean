...
const Dri = () => (
  <RestaurantPage
    restaurantName="Dóri"
    address="Rua das Companhas - Costa Nova do Prado, Gafanha da Encarnação, 3830-000, Portugal"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+351234369017"
    website="https://guide.michelin.com/en/aveiro-region/gafanha-da-encarnacao_2419914/restaurant/dori"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated between the Aveiro estuary and the Atlantic, on the first floor of a contemporary glass-fronted building offering splendid views, particularly from the terrace. The bar features an enticing display cabinet, while the two dining rooms are bright and functional-contemporary in feel. Although the menu includes delicious meats and a few savoury rice dishes, the speciality here is the wild fish, cooked on the open grill, and the seafood. Don’t leave without trying the fried fish (“fritada de pescado”) or the delicious “ensopado” of turbot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20das%20Companhas%20-%20Costa%20Nova%20do%20Prado%2C%20Gafanha%20da%20Encarna%C3%A7%C3%A3o%2C%203830-000%2C%20Portugal"
    pageTitle="Dóri"
  />
);
