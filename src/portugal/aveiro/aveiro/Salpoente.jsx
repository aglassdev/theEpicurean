...
const Salpoente = () => (
  <RestaurantPage
    restaurantName="Salpoente"
    address="Cais de São Roque 83, Aveiro, 3800-256, Portugal"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+351234382674"
    website="https://salpoente.pt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its wooden construction and reddish hue show that it once operated as one of the many salt warehouses facing the São Roque canal (the only one that still preserves its essence today). This setting, not without sophistication, offers a cuisine based on Portuguese gastronomy, incorporating ingredients from the estuary, presented in a modern format with signature touches. Among them, the smoked eel stands out, served with fresh notes and beetroot emulsion, the sea fish accompanied by bivalves from the estuary, and the classic Portuguese style egg nog presented in various textures. The menu features à la carte choices, a 6-course tasting menu, a vegetarian menu, and the “Nas mãos do chef” (“Chef’s Choice”), as well as an executive menu for weekdays!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cais%20de%20S%C3%A3o%20Roque%2083%2C%20Aveiro%2C%203800-256%2C%20Portugal"
    pageTitle="Salpoente"
  />
);

export default Salpoente;
