...
const Marinheiro = () => (
  <RestaurantPage
    restaurantName="Marinheiro"
    address="Rua Gomes de Amorim 1842, Póvoa de Varzim, 4490-091, Portugal"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+351252682151"
    website="https://guide.michelin.com/en/porto-region/pvoa-de-varzim/restaurant/o-marinheiro215874"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This architecture does not go unnoticed, given that the restaurant is housed in a boat-shaped building! Upon entering, you will see a display packed with fish and seafood well worth admiring. The spacious interior is divided into two floors and boasts décor inspired by the nautical world, with light, sophisticated colours predominant. As is expected from such an establishment, the menu includes dishes such as seafood açorda stew, various rice dishes, grilled fish and Bacalhau à Marinheiro. There are also excellent meat options, like a fine house-style kid goat or an irresistible picanha steak. The priority here is the quality and freshness of the ingredients, along with excellent service — which makes it well worth a visit!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rua%20Gomes%20de%20Amorim%201842%2C%20P%C3%B3voa%20de%20Varzim%2C%204490-091%2C%20Portugal"
    pageTitle="Marinheiro"
  />
);
