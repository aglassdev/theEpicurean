...
const Annwn = () => (
  <RestaurantPage
    restaurantName="ANNWN"
    address="1 Market Square, Narberth, SA67 7AU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+447308313107"
    website="https://www.annwnrestaurant.co.uk"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Folklore, foraging and flavour guide your visit to this sustainable, proudly Welsh restaurant. Sat inside a lovingly converted former bank, there is a real sense of warmth to the place, with the passionate chef recounting stories while serving and bringing round ‘top ups’ of sauces and ingredients as you dine. From the expertly foraged produce to the Preseli Hills lamb, local ingredients bring with them a great burst of flavour. Extend your experience by joining one of their occasional foraging days...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Market%20Square%2C%20Narberth%2C%20SA67%207AU%2C%20United%20Kingdom"
    pageTitle="ANNWN"
  />
);

export default Annwn;
