...
const TheWarwick = () => (
  <RestaurantPage
    restaurantName="The Warwick"
    address="Mallory Court Country House Hotel & Spa, Harbury Lane, Royal Leamington Spa, CV33 9QB, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441926330214"
    website="https://www.mallory.co.uk/the-warwick-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The renowned Mallory Court – a classic English country house combined with a modern spa – is the setting for this wood-panelled restaurant that’s elegant and relaxed in equal measure. The part-Edwardian manor, built in a Lutyens style, also boasts a garden terrace which adds to the appeal in warmer weather. The cooking is ingredient-led, with exacting presentation and bold flavours in dishes like Hilltop Farm hogget with potato terrine, garden beans and salsa verde. The ‘Taste of the Season’ menu is an homage to local, seasonal produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mallory%20Court%20Country%20House%20Hotel%20%26%20Spa%2C%20Harbury%20Lane%2C%20Royal%20Leamington%20Spa%2C%20CV33%209QB%2C%20United%20Kingdom"
    pageTitle="The Warwick"
  />
);

export default TheWarwick;
