...
const Augustus = () => (
  <RestaurantPage
    restaurantName="Augustus"
    address="3 The Courtyard, St. James Street, Taunton, TA1 1JR, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441823324354"
    website="https://www.augustustaunton.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An experienced chef and a bright, breezy team run this welcoming little bistro. Sit in the cosy, intimate dining room or the bright conservatory with sliding glass doors and a retractable roof. Hearty, unfussy cooking mixes French-influenced dishes with updated British classics...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20The%20Courtyard%2C%20St.%20James%20Street%2C%20Taunton%2C%20TA1%201JR%2C%20United%20Kingdom"
    pageTitle="Augustus"
  />
);
