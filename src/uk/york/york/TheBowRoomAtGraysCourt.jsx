...
const TheBowRoomAtGraysCourt = () => (
  <RestaurantPage
    restaurantName="The Bow Room Restaurant"
    address="Chapter House Street, York, YO1 7JH, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441904612613"
    website="https://www.grayscourtyork.com/the-bow-room-restaurant-york/"
    aliases={["The Bow Room at Grays Court"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away by the Minster and bordered by the historic city walls, this beautiful Jacobean house with luxurious bedrooms and a peaceful garden is something of a hidden gem. Enjoy an aperitif in the characterful wood-panelled gallery, then head through to the more modern restaurant with its large bow window. Seasonality, purity and freshness underpin dishes that often use ingredients from their own garden – look out for the poached Yorkshire rhubarb dessert when available. The service team have an affable, natural charm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chapter%20House%20Street%2C%20York%2C%20YO1%207JH%2C%20United%20Kingdom"
    pageTitle="The Bow Room Restaurant"
  />
);

export default TheBowRoomAtGraysCourt;
