...
const GreenIsland = () => (
  <RestaurantPage
    restaurantName="Green Island"
    address="Saint Clement, Green Island, JE2 6LS, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+441534857787"
    website="https://www.greenisland.je"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friendly, personally run restaurant with a terrace and beachside kiosk; the southernmost restaurant in the British Isles. Mediterranean-influenced dishes and seafood specials showcase island produce. Flavours are bold and perfectly judged...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Saint%20Clement%2C%20Green%20Island%2C%20JE2%206LS%2C%20United%20Kingdom"
    pageTitle="Green Island"
  />
);

export default GreenIsland;
