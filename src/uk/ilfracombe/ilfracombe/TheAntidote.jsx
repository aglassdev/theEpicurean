...
const TheAntidote = () => (
  <RestaurantPage
    restaurantName="The Antidote"
    address="20 St James Place, Ilfracombe, EX34 9BJ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441271865339"
    website="https://www.theantidoteilfracombe.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arrive early for a stroll around the harbour before dinner at this sweet, glass-fronted shop conversion where brown paper covered tables contribute to a cool, modish feel. It’s run by a friendly couple with a passion for local produce, so the thoughtfully prepared set menu changes regularly. Well-judged dishes are modern in their make-up and packed with flavour. Bedrooms are contemporary and one even has a small terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20St%20James%20Place%2C%20Ilfracombe%2C%20EX34%209BJ%2C%20United%20Kingdom"
    pageTitle="The Antidote"
  />
);

export default TheAntidote;
