...
const LidoRestaurant = () => (
  <RestaurantPage
    restaurantName="Lido Restaurant"
    address="Oakfield Place, City of Bristol, BS8 2BJ, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+441173323970"
    website="https://www.lidobristol.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Snack on flatbreads and small plates in the poolside bar or head up to the first floor former viewing gallery of this restored Victorian lido, with its retractable floor-to-ceiling doors and daily changing menu. Spanish, Mediterranean and Moorish dishes make good use of the wood-fired oven...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oakfield%20Place%2C%20City%20of%20Bristol%2C%20BS8%202BJ%2C%20United%20Kingdom"
    pageTitle="Lido Restaurant"
  />
);

export default LidoRestaurant;
