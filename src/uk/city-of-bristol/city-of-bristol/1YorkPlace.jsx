...
const OneYorkPlace = () => (
  <RestaurantPage
    restaurantName="1 York Place"
    address="1 York Place, Clifton, City of Bristol, BS8 1AH, United Kingdom"
    cuisine="European"
    priceRange="£££"
    phoneNumber="+441172447775"
    website="https://www.1yorkplace.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Deep within the Georgian lanes of Clifton, lies this neighbourhood bistro with an uncluttered feel. Sit on the ground floor to make the most of the natural light flooding in the large windows, or head down the spiral staircase for a more intimate setting. The date-stamped menu takes a pan-European approach, be it ricotta gnudi from Italy, squid ink bomba rice from Spain or veal schnitzel from Austria. The relaxed service is delivered with a smile and sharing dishes like whole roast chicken add to the conviviality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20York%20Place%2C%20Clifton%2C%20City%20of%20Bristol%2C%20BS8%201AH%2C%20United%20Kingdom"
    pageTitle="1 York Place"
  />
);

export default OneYorkPlace;
