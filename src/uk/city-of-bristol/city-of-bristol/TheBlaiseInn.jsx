...
const TheBlaiseInn = () => (
  <RestaurantPage
    restaurantName="The Blaise Inn"
    address="260 Henbury Road, City of Bristol, BS10 7QR, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441179071115"
    website="https://theblaiseinn.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the suburbs, close to the famous folly of Blaise Castle, this simply decorated village inn serves good value, traditional British dishes cooked with a skilful, modern approach – make sure you save room for dessert! As well as quality ales and a well-chosen wine list, you'll find a pleasant rear courtyard in which to enjoy them. Personable service completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=260%20Henbury%20Road%2C%20City%20of%20Bristol%2C%20BS10%207QR%2C%20United%20Kingdom"
    pageTitle="The Blaise Inn"
  />
);

export default TheBlaiseInn;
