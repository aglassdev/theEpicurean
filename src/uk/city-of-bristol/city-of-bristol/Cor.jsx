...
const Cor = () => (
  <RestaurantPage
    restaurantName="COR"
    address="81 North Street, Bedminster, City of Bristol, BS3 1ES, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441179112986"
    website="https://www.correstaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The epitome of a neighbourhood restaurant, COR is imbued with an air of contagious positivity that is a perfect fit for this buzzy area of Bristol. Its look is somewhere between a Mediterranean restaurant and a tapas bar, with some counter dining and shelves bursting with cookery books and wine. The dishes take on a similarly Mediterranean influence, as evidenced by the option of boquerones or burrata to kick things off. Save some room for pudding, because the crème caramel is a real treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=81%20North%20Street%2C%20Bedminster%2C%20City%20of%20Bristol%2C%20BS3%201ES%2C%20United%20Kingdom"
    pageTitle="COR"
  />
);
