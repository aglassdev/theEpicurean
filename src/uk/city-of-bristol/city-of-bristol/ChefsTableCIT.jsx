...
const ChefsTableCIT = () => (
  <RestaurantPage
    ...
    address="1a Avon Crescent, City of Bristol, BS1 6XQ, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441179300776"
    website="https://www.chefstable.restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the old part of the city close to the famous docks you’ll find this intimate, personally run, 2-room restaurant, with a small front terrace, a warm service team and a buzzing atmosphere. The two menus – most diners plump for the tasting menu – offer original, modern and sometimes intricate dishes, which are aesthetically striking and full of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1a%20Avon%20Crescent%2C%20City%20of%20Bristol%2C%20BS1%206XQ%2C%20United%20Kingdom"
    pageTitle="Chef's Table"
  />
);

export default ChefsTableCIT;
