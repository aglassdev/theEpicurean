...
const Root = () => (
  <RestaurantPage
    ...
    website="https://www.rootbristol.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This busy, welcoming little restaurant occupies five first-floor shipping containers on Wapping Wharf, a thriving neighbourhood with an array of top eateries. Vegetables lead the way here, with the majority of dishes being vegetarian and utilising the best produce from small local suppliers in simple yet flavour-packed sharing plates. Ingredients from carrots to hispi cabbage are elevated with well-balanced and wholly satisfying flavour combinations. There’s a terrific buzz and the service team run their deservedly popular restaurant admirably smoothly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%209%2C%20Cargo%201%2C%20Gaol%20Ferry%20Steps%2C%20Wapping%20Wharf%2C%20City%20of%20Bristol%2C%20BS1%206WP%2C%20United%20Kingdom"
    pageTitle="Root"
  />
);
