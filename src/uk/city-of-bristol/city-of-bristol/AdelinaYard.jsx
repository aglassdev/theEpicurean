...
const AdelinaYard = () => (
  <RestaurantPage
    restaurantName="Adelina Yard"
    address="3 Queen Quay, Welsh Back, City of Bristol, BS1 4SL, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441179256682"
    website="https://www.adelinayard.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The experienced chef-owners named their first restaurant after their old home. Sit at the chef's table to watch all the action or at the far end of the L-shaped room overlooking the quay. Attractively presented, well-balanced modern dishes are sometimes brought to the tables by the chefs themselves...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Queen%20Quay%2C%20Welsh%20Back%2C%20City%20of%20Bristol%2C%20BS1%204SL%2C%20United%20Kingdom"
    pageTitle="Adelina Yard"
  />
);

export default AdelinaYard;
