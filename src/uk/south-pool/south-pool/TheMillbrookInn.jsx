...
const TheMillbrookInn = () => (
  <RestaurantPage
    restaurantName="The Millbrook Inn"
    address="South Pool, TQ7 2RW, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441548531581"
    website="https://millbrookinnsouthpool.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whilst the narrow lane getting here can be a challenge, once you arrive it feels like you’ve discovered a tiny utopia. Situated in the most delightful hamlet, this characterful pub fits in perfectly among the bucolic cottages. The concise menu never overcomplicates things, with honest, ingredient-led dishes that are all the more appealing for their simplicity. Fine produce is at the heart of it all, with lamb and beef coming from the owners’ Fowlescombe Farm 10 miles away – and crab from Salcombe just up the road. You can stay the night in one of their two nearby cottages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=South%20Pool%2C%20TQ7%202RW%2C%20United%20Kingdom"
    pageTitle="The Millbrook Inn"
  />
);

export default TheMillbrookInn;
