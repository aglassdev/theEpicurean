...
const Avery = () => (
  <RestaurantPage
    restaurantName="AVERY"
    address="54 Saint Stephen Street, Edinburgh, EH3 5AL, United Kingdom"
    cuisine="Creative"
    priceRange="££££"
    phoneNumber="+441315634470"
    website="https://www.averyedi.co.uk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="When American chef Rodney Wages visited Edinburgh on holiday, he fell in love with the city so much that he decided to move himself, his family and his restaurant here. And that's how Avery, which once graced the streets of San Francisco, came to be located in a classic Georgian townhouse in Stockbridge. Rodney has wholly embraced his Scottish surroundings, taking the country's bountiful produce and treating it with a Californian lightness, while providing bold, distinct flavours – like Orkney scallop dressed with pineapple jus. The drinks flight combines wine, sake, sherry and, of course, a wee single malt whisky...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20Saint%20Stephen%20Street%2C%20Edinburgh%2C%20EH3%205AL%2C%20United%20Kingdom"
    pageTitle="AVERY"
  />
);
