...
const TheBroughton = () => (
  <RestaurantPage
    restaurantName="The Broughton"
    address="46-48A Broughton Street, Edinburgh, EH1 3SA, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441315566608"
    website="https://www.thebroughtonbar.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A warm, genial atmosphere prevails as soon as you enter this smart dining pub, which is located within walking distance of Calton Hill and bustling Princes Street. You can just pop in for a pint if you wish, but you’d be a fool to miss the appealing, good value cooking. Flavoursome dishes like duck confit terrine and vanilla panna cotta hit the mark for elevated pub food, with a strong wine list on hand to accompany...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46-48A%20Broughton%20Street%2C%20Edinburgh%2C%20EH1%203SA%2C%20United%20Kingdom"
    pageTitle="The Broughton"
  />
);

export default TheBroughton;
