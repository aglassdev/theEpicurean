...
const ThePalmerston = () => (
  <RestaurantPage
    restaurantName="The Palmerston"
    address="1 Palmerston Place, Edinburgh, EH12 5AF, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441312201794"
    website="https://www.thepalmerstonedinburgh.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on a prime corner site in Edinburgh's West End, this former bank is now filled with a different kind of gold. Culinary delights ranging from house-baked breads and pastries to a full menu of unfussy, European-influenced dishes will ensure you leave satisfied, whenever you decide to drop in. A beautiful conversion has left the interior with polished bistro tables and the feel of a smart dining pub, helped out by the local beers and carefully curated wine list. Look out for the dishes to share, such as half a roast chicken with chips and béarnaise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Palmerston%20Place%2C%20Edinburgh%2C%20EH12%205AF%2C%20United%20Kingdom"
    pageTitle="The Palmerston"
  />
);

export default ThePalmerston;
