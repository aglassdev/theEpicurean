...
const Sotto = () => (
  <RestaurantPage
    restaurantName="Sotto"
    address="28-32 Deanhaugh Street, Edinburgh, EH4 1LY, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    phoneNumber="+441313323621"
    website="https://www.sottoedinburgh.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This buzzy wine bar and trattoria is set in the heart of bustling Stockbridge, where you can pop in just for a glass of wine with some olives and salumi around the communal, marble-topped island counter – or choose from the full à la carte of appealingly unfussy Italian dishes. Whether you opt for one of the pastas or the fish of the day, it’s all simple, fresh and wholly enjoyable. The top-notch wine list is almost exclusively Italian, with owner and sommelier James on hand to recommend something to suit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28-32%20Deanhaugh%20Street%2C%20Edinburgh%2C%20EH4%201LY%2C%20United%20Kingdom"
    pageTitle="Sotto"
  />
);

export default Sotto;
