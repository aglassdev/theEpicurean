...
const NumberOne = () => (
  <RestaurantPage
    restaurantName="Number One"
    address="1 Princes Street, Edinburgh, EH2 2EQ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441315576727"
    website="https://www.roccofortehotels.com/hotels-and-resorts/the-balmoral-hotel/dining/number-one/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start your evening with an aperitif in the cosy cocktail bar of this plush restaurant inside the Balmoral Hotel, one of Scotland's most iconic buildings. Red lacquered walls and richly upholstered banquettes lend an air of luxury to the place, as do premium ingredients like N25 caviar and hand-dived Orkney scallops. There is a natural flow to the well-balanced dishes on the 7 course tasting menu, while the professional, well-paced service instantly puts you at ease...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Princes%20Street%2C%20Edinburgh%2C%20EH2%202EQ%2C%20United%20Kingdom"
    pageTitle="Number One"
  />
);
