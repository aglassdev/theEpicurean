...
const Timespirit = () => (
  <RestaurantPage
    restaurantName="TimeSpirit"
    address="The Macallan Estate, Easter Elchies, Aberlour, AB38 9RX, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441340318000"
    website="https://www.themacallan.com/en/experience-the-macallan/distillery/timespirit-dining-experience"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Forming part of The Macallan Estate, this is a beautiful restaurant from top to bottom. It sits on the first floor of the futuristic distillery, with floor-to-ceiling windows affording Speyside views that are just as stunning as the open kitchen, the whisky wall and the wine cellar. There’s immaculate presentation in the cooking too, on a menu overseen by the Roca brothers from the famed El Celler de Can Roca in Girona. Their signature ‘Lactic’ dessert makes an appearance, as do several nods to Scotland. Go for the whisky pairing, as it seems appropriate here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Macallan%20Estate%2C%20Easter%20Elchies%2C%20Aberlour%2C%20AB38%209RX%2C%20United%20Kingdom"
    pageTitle="TimeSpirit"
  />
);

export default Timespirit;
