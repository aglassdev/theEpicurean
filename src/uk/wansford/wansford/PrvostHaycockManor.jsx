...
const PrvostHaycockManor = () => (
  <RestaurantPage
    restaurantName="Prévost @ Haycock Manor"
    address="Haycock Manor, London Road, Wansford, PE8 6JA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441780782223"
    website="https://haycock.co.uk/prevost-haycock/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the orangery of the Haycock Manor Hotel, a lovingly restored former coaching inn, this bright, colourful restaurant sports bird cage chandeliers, pergolas and a faux olive tree. Choose from three set menus of up to 8 courses, which demonstrate the precision of the chefs and a keen understanding of their quality ingredients. Natural flavours are allowed to shine and the sauces and consommés are a real highlight, like a rich, appetisingly glossy duck jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Haycock%20Manor%2C%20London%20Road%2C%20Wansford%2C%20PE8%206JA%2C%20United%20Kingdom"
    pageTitle="Prévost @ Haycock Manor"
  />
);

export default PrvostHaycockManor;
