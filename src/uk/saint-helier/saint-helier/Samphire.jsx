...
const Samphire = () => (
  <RestaurantPage
    restaurantName="Samphire"
    address="7-11 Don Street, Saint Helier, JE2 4TQ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441534725100"
    website="https://www.samphire.je/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This buzzy all-day brasserie deluxe has a striking colour scheme which takes in blue velour banquettes and yellow leather chairs. Cooking adopts a modern approach and there’s a distinct Mediterranean influence. Island ingredients are to the fore and the oysters are something of a feature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-11%20Don%20Street%2C%20Saint%20Helier%2C%20JE2%204TQ%2C%20United%20Kingdom"
    pageTitle="Samphire"
  />
);

export default Samphire;
