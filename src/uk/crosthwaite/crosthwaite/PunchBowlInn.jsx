...
const PunchBowlInn = () => (
  <RestaurantPage
    restaurantName="Punch Bowl Inn"
    address="Crosthwaite, LA8 8HR, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441539568237"
    website="https://www.the-punchbowl.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The picturesque Lyth Valley plays host to this charming 17C inn, which stands beside a pretty church. Sit over a pint of local beer and some homemade pork scratchings in the cosy beamed bar or dine on carefully cooked modern dishes of regional produce. Bedrooms are luxurious – one even has twin baths!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Crosthwaite%2C%20LA8%208HR%2C%20United%20Kingdom"
    pageTitle="Punch Bowl Inn"
  />
);

export default PunchBowlInn;
