...
const TheThreeOaks = () => (
  <RestaurantPage
    restaurantName="The Three Oaks"
    address="Austenwood Lane, Gerrards Cross, SL9 8NL, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441753899016"
    website="https://www.thethreeoaksgx.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a rural-feeling location on the London commuter belt, this appealing, well-run pub comprises several different areas; dine in the brighter room overlooking the terrace and pretty garden, or head straight outside on warmer days. The cooking is satisfying and seasonal, with the chefs skilfully weaving in subtle influences from across East and Southeast Asia, be it miso mushroom parfait, gochujang-glazed squid or Northern Thai red curry soup. The great value set menu, bright young team and well-chosen wine list all enhance the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Austenwood%20Lane%2C%20Gerrards%20Cross%2C%20SL9%208NL%2C%20United%20Kingdom"
    pageTitle="The Three Oaks"
  />
);

export default TheThreeOaks;
