...
const OneEightEightSeven = () => (
  <RestaurantPage
    restaurantName="1887"
    address="The Torridon, Achnasheen, IV22 2EY, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441445791242"
    website="https://www.thetorridon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the banks of Upper Loch Torridon with majestic mountains in the background and manicured gardens outside, this vibrantly decorated restaurant inside The Torridon hotel is in a truly stunning location. The kitchen’s local and sustainable ethos results in superb Highlands produce from hand-dived West Coast scallop to Ross-shire lamb, in dishes that demonstrate a mature ‘less is more’ approach where the accompaniments enhance rather than mask the central ingredients. An extensive global whisky collection adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Torridon%2C%20Achnasheen%2C%20IV22%202EY%2C%20United%20Kingdom"
    pageTitle="1887"
  />
);

export default OneEightEightSeven;
