...
const KentishHare = () => (
  <RestaurantPage
    restaurantName="Kentish Hare"
    address="95 Bidborough Ridge, Royal Tunbridge Wells, Bidborough, TN3 0XB, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441892525709"
    website="https://www.thekentishhare.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the clapboard façade sits a spacious bar with bookshelf wallpaper and a modern extension where you can watch the chefs cooking steaks on two Big Green Eggs. Care is taken both in sourcing and cooking, and dishes are boldly flavoured and well-presented. Simpler dishes are available on the bar menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=95%20Bidborough%20Ridge%2C%20Royal%20Tunbridge%20Wells%2C%20Bidborough%2C%20TN3%200XB%2C%20United%20Kingdom"
    pageTitle="Kentish Hare"
  />
);

export default KentishHare;
