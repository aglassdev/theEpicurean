...
const Coarse = () => (
  <RestaurantPage
    restaurantName="Coarse"
    address="Reform Place, North Road, Durham, DH1 4RZ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441913805776"
    website="https://coarse.restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden away in a small courtyard in the centre of Durham, this warm, cheerily run restaurant is the realisation of a dream for the three friends who crowdfunded its opening. The simple, rustic décor belies the quality of the cooking found within; the set menu of modern British small plates changes seasonally and the kitchen’s skill is clearly evident in the quality of the sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Reform%20Place%2C%20North%20Road%2C%20Durham%2C%20DH1%204RZ%2C%20United%20Kingdom"
    pageTitle="Coarse"
  />
);
