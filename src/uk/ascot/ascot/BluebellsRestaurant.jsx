...
const BluebellsRestaurant = () => (
  <RestaurantPage
    restaurantName="Bluebells Restaurant"
    address="London Road, Ascot, SL5 0PU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441344622722"
    website="https://bluebells-restaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a degree of opulence to this popular restaurant housed inside a whitewashed building. The striking dark green interior features glitzy rose gold panelling and distinctive tiling, ensuring the dining room feels a little bit special. Modern European dishes make use of effective, well-judged flavour combinations and there’s an assured level of technique in the cooking. Sit in the main room overlooking the fire pit or in the airy conservatory, while the smooth service team look after you with aplomb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=London%20Road%2C%20Ascot%2C%20SL5%200PU%2C%20United%20Kingdom"
    pageTitle="Bluebells Restaurant"
  />
);

export default BluebellsRestaurant;
