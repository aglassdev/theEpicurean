...
const Slice = () => (
  <RestaurantPage
    ...
    address="73-75 Eversley Road, Sketty, Swansea, SA2 9DE, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441792290929"
    website="http://www.sliceswansea.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A personal welcome from chef-owners Chris and Adam is just one of the charms of this sweet little restaurant hidden away in the Swansea suburbs. The passion and pride of the team comes across not just in the friendly service, but in the carefully prepared dishes centred around seasonally changing ingredients – whether that be fresh crab with watermelon or pan-fried sea bass with butter-poached lobster. Choose from the concise à la carte or opt for the tasting menu for the full experience, accompanied by a well-priced wine pairing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73-75%20Eversley%20Road%2C%20Sketty%2C%20Swansea%2C%20SA2%209DE%2C%20United%20Kingdom"
    pageTitle="Slice"
  />
);
