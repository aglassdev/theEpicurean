...
const MercadoCentral = () => (
  <RestaurantPage
    restaurantName="Mercado Central"
    address="24 Green Street, Cambridge, CB2 3JX, United Kingdom"
    cuisine="Spanish"
    priceRange="£££"
    phoneNumber="+441223502392"
    website="https://mercadocentral.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located a stone's throw from Trinity College, this brightly decorated townhouse is home to a Spanish restaurant exuding a warm, buzzy vibe – whether you admire the open-flame cooking on the ground floor or sit in the quieter upstairs dining room. Northern Spain has the largest influence on the menu, with Galicia and the Basque Country featuring prominently among dishes built around proudly sourced produce of great quality, such as wonderfully marbled presa Ibérica. Save room to finish with the 'tarta de Santiago'...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=24%20Green%20Street%2C%20Cambridge%2C%20CB2%203JX%2C%20United%20Kingdom"
    pageTitle="Mercado Central"
  />
);

export default MercadoCentral;
