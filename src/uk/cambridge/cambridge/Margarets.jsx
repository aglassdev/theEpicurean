...
const Margarets = () => (
  <RestaurantPage
    restaurantName="Margaret's"
    address="18 Chesterton Road, Cambridge, CB4 3AX, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441223375071"
    website="https://margaretscambridge.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A labour of love from the owners behind Restaurant Twenty-Two – and located right next door – this soothing space comes with plenty of neutral tones, giving it a simple, relaxing elegance. The opening selection of breads, dips and nibbles is a brilliant way to start, featuring highlights such as a beautifully made focaccia and a creamy whipped butter bean dip. Across the menu, the vibrant cooking moves with the seasons and pushes delicious natural flavours to the fore. The wonderful service team are engaging and knowledgeable in equal measure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Chesterton%20Road%2C%20Cambridge%2C%20CB4%203AX%2C%20United%20Kingdom"
    pageTitle="Margaret's"
  />
);

export default Margarets;
