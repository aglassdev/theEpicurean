...
const Vanderlyle = () => (
  <RestaurantPage
    restaurantName="Vanderlyle"
    address="38 - 40 Mill Road, Cambridge, CB1 2AD, United Kingdom"
    cuisine="Vegetarian"
    priceRange="£££"
    phoneNumber="+441223366514"
    website="https://www.vanderlyle-restaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A large, open-plan kitchen takes centre stage at Vanderlyle, which blends shabby chic styling with designer comfort. The well-balanced vegetarian tasting menu shows imagination and creativity, along with a passion for seasonal produce – all evident in dishes like roasted wild mushrooms with Roscoff onion and Bordelaise sauce. The friendly service team run the restaurant well and the wine or juice pairings enhance the experience. It’s a popular spot, so book in plenty of time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20-%2040%20Mill%20Road%2C%20Cambridge%2C%20CB1%202AD%2C%20United%20Kingdom"
    pageTitle="Vanderlyle"
  />
);

export default Vanderlyle;
