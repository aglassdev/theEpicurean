...
const TheThreeHorseshoes = () => (
  <RestaurantPage
    restaurantName="The Three Horseshoes"
    address="74 Church Road, Fordham, CO6 3NJ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441206240195"
    website="https://3hs.pub"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the wooden beams to the antique furniture, there’s a huge amount of character to this spacious pub that sits inside four former cottages. The welcoming feel of the inglenook fireplace is matched by the warmth and pride of the service team as they serve a menu offering something for everyone, from a few pub classics to more inventive dishes. Great care in the cooking allows strong, complementary flavours to shine through, as in a lemon posset dessert with pistachio cream and a great bergamot gel. On a summer’s day, make sure you head straight for the terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=74%20Church%20Road%2C%20Fordham%2C%20CO6%203NJ%2C%20United%20Kingdom"
    pageTitle="The Three Horseshoes"
  />
);

export default TheThreeHorseshoes;
