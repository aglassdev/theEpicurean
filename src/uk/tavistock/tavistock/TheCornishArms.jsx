...
const TheCornishArms = () => (
  <RestaurantPage
    restaurantName="The Cornish Arms"
    address="15 West Street, Tavistock, PL19 8AN, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441822612145"
    website="https://www.thecornisharmstavistock.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It feels like nothing ever changes at The Cornish Arms – and that is meant in the best possible way. This traditional high-street pub continues to serve up proper pints, flavour-packed food and a joyous atmosphere. A mix of locals and tourists, drinkers and diners, are all well looked-after by the gregarious team, while the kitchen does its part with a menu of dishes that combine no-nonsense appeal with detailed and careful execution. The result is dishes like 'The BFG Trifle', where a Black Forest Gateau fuses wonderfully with a fellow staple pudding...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20West%20Street%2C%20Tavistock%2C%20PL19%208AN%2C%20United%20Kingdom"
    pageTitle="The Cornish Arms"
  />
);

export default TheCornishArms;
