...
const EStreetBarGrill = () => (
  <RestaurantPage
    restaurantName="E. STREET Bar & Grill"
    address="New Street, Petworth, GU28 0AS, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+441798345111"
    website="https://estreetbarandgrill.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a 17C red-brick façade lies a light and airy, contemporary brasserie deluxe. Start with a seasonal cocktail then choose from a range of Mediterranean-influenced dishes and meat or fish from the grill; the grass-fed Hampshire steaks are a hit. The courtyard terrace is a great spot come summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=New%20Street%2C%20Petworth%2C%20GU28%200AS%2C%20United%20Kingdom"
    pageTitle="E. STREET Bar & Grill"
  />
);

export default EStreetBarGrill;
