...
const TheGaff = () => (
  <RestaurantPage
    restaurantName="The Gaff"
    address="4 The Courtyard, Lion Street, Abergavenny, NP7 5PE, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441873739310"
    website="https://www.thegaffrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three converted sheds hidden away in the heart of town play host to this bright, airy restaurant with an attractive summer courtyard for alfresco dining. The menu lists an enticing, seasonally changing selection of well-priced small plates and larger sharing dishes. Robust, satisfying flavours abound across the cooking, starting strong with the excellent sourdough and Marmite butter. The team are welcoming and friendly, and their operation also includes a coffee shop and deli on the High Street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20The%20Courtyard%2C%20Lion%20Street%2C%20Abergavenny%2C%20NP7%205PE%2C%20United%20Kingdom"
    pageTitle="The Gaff"
  />
);

export default TheGaff;
