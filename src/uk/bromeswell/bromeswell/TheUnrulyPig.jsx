...
const TheUnrulyPig = () => (
  <RestaurantPage
    restaurantName="The Unruly Pig"
    address="Orford Road, Bromeswell, IP12 2PU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441394460310"
    website="https://www.theunrulypig.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern dining pub is far from unruly, with a formality to the service brought by its owner – a former lawyer – and suited managers. The team's geniality adds a welcome warmth, as do stylish touches like wood panelling and interesting modern art, which are nicely integrated within the classic pub décor. The cooking shows off contemporary techniques and there's a Mediterranean influence to some of the flavoursome dishes, like Ibérico pork or bucatini vongole. The best value is to be found on the set menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Orford%20Road%2C%20Bromeswell%2C%20IP12%202PU%2C%20United%20Kingdom"
    pageTitle="The Unruly Pig"
  />
);

export default TheUnrulyPig;
