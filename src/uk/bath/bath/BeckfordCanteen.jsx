...
const BeckfordCanteen = () => (
  <RestaurantPage
    restaurantName="Beckford Canteen"
    address="11-12 Bartlett Street, Bath, BA1 2QZ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441225338470"
    website="https://www.beckfordcanteen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A former Georgian greenhouse has been transformed into this light, airy restaurant with whitewashed walls, a vaulted ceiling and a feature wall decorated with over 90 green plates. The concise all-day menu comprises a range of sharply executed dishes that showcase the kitchen’s ability to hold back and let their quality produce do the talking – such as the megrim sole with Café de Paris butter. Window counter seats are held back for walk-ins and it’s worth buying some wine from their sister operation, Beckford Bottle Shop, which you can enjoy with your meal for a generous corkage. Service is smooth and attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11-12%20Bartlett%20Street%2C%20Bath%2C%20BA1%202QZ%2C%20United%20Kingdom"
    pageTitle="Beckford Canteen"
  />
);

export default BeckfordCanteen;
