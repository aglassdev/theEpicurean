...
const Robun = () => (
  <RestaurantPage
    ...
    address="4 Princes Buildings, George Street, Bath, BA1 2ED, United Kingdom"
    cuisine="Japanese"
    priceRange="££"
    phoneNumber="+441225433200"
    website="https://www.robun.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This skilfully run Japanese restaurant takes its inspiration from 19C author Kanagaki Robun, who is credited with introducing barbecued food to Japan. The cooking reflects his influence, with dishes from the robata grill forming the central part of a menu that is distinguished by fresh produce and an authentic approach. Excellent sushi and a strikingly presented afternoon tea also stand out on the vast menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20Princes%20Buildings%2C%20George%20Street%2C%20Bath%2C%20BA1%202ED%2C%20United%20Kingdom"
    pageTitle="Robun"
  />
);

export default Robun;
