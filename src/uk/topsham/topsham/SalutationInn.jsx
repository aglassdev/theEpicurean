...
const SalutationInn = () => (
  <RestaurantPage
    restaurantName="Salutation Inn"
    address="68 Fore Street, Topsham, EX3 0HL, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441392873060"
    website="https://salutationtopsham.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This characterful 1720s coaching inn has a surprisingly contemporary interior matched by understated bedrooms. Dinner takes place in the intimate dining room, while lunch and afternoon tea are served in the airy glass-covered historic courtyard – the perfect spot for a sunny afternoon. In the evening, choose between a tasting menu and a seasonally-themed à la carte, where modern dishes are well-judged and nicely balanced. Be sure to pick up some goodies from their deli and wet fish shop on your way out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68%20Fore%20Street%2C%20Topsham%2C%20EX3%200HL%2C%20United%20Kingdom"
    pageTitle="Salutation Inn"
  />
);

export default SalutationInn;
