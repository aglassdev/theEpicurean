...
const HartnettHolderCo = () => (
  <RestaurantPage
    restaurantName="Hartnett Holder & Co"
    address="Lime wood, Beaulieu Road, Lyndhurst, SO43 7FZ, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442380287177"
    website="https://www.limewoodhotel.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lime Wood Hotel, an impressive light stone mansion in the heart of the New Forest, is the home for this lovely restaurant which looks out onto the property's extensive gardens. Take a seat in the glass-roofed bar and kick things off with a cocktail from their extensive list. The rustic cooking leans heavily into the ingredient-led ethos of Italian cuisine, with both Angela Harnett and Luke Holder (who is more often the one in the kitchen) bringing their considerable experience to proceedings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lime%20wood%2C%20Beaulieu%20Road%2C%20Lyndhurst%2C%20SO43%207FZ%2C%20United%20Kingdom"
    pageTitle="Hartnett Holder & Co"
  />
);

export default HartnettHolderCo;
