...
const CaffRojano = () => (
  <RestaurantPage
    restaurantName="Caffè Rojano"
    address="9 Mill Square, Padstow, PL28 8AE, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+441841532093"
    website="https://www.paul-ainsworth.co.uk/cafferojano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s always a lively buzz at this smart brasserie. The glass-enclosed terrace is a great spot and service is some of the friendliest around. An extensive menu keeps Mediterranean influences to the fore and has some playful touches; the ‘whoopsey splunker’ sharing dessert is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Mill%20Square%2C%20Padstow%2C%20PL28%208AE%2C%20United%20Kingdom"
    pageTitle="Caffè Rojano"
  />
);

export default CaffRojano;
