...
const BrynWilliamsAtTheatrClwyd = () => (
  <RestaurantPage
    restaurantName="Bryn Williams at Theatr Clwyd"
    address="Raikes Lane, Mold, CH7 1YA, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441352344101"
    website="https://bwtheatrclwyd.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Another success from the eponymous restaurateur, this modern British brasserie sits on the first floor of the Theatr Clwyd performing arts centre, with floor-to-ceiling windows that offer wonderful views of the Clwydian Range mountains. Welsh produce is the bedrock of the sensibly priced menu, including Williams’ own pedigree Welsh Black beef, which you could find in both crisp, flavoursome croquettes and a beef, onion and mushroom pie to share. The friendly service team run the place smoothly with a welcoming charm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Raikes%20Lane%2C%20Mold%2C%20CH7%201YA%2C%20United%20Kingdom"
    pageTitle="Bryn Williams at Theatr Clwyd"
  />
);

export default BrynWilliamsAtTheatrClwyd;
