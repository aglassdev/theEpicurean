...
const Donia = () => (
  <RestaurantPage
    restaurantName="Donia"
    address="2.14 Top Floor Kingly Court, Carnaby St, Soho, London, W1B 5PW, United Kingdom"
    cuisine="Filipino"
    priceRange="££"
    phoneNumber=""
    website="https://www.doniarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying the site where its neighbours Imad’s Syrian Kitchen and Darjeeling Express both started out, Donia is a hugely likeable Filipino restaurant that’ll have you googling flights to Manila before you know it. The young, Filipino-born owner grew up in the UK so expect to see plenty of homegrown produce along with those sweet and sour flavours. Crisp adobo mushroom croquetas are a must, as are the succulent chicken Inasal and the lechon (suckling pig) served with a lovely liver and peppercorn sauce. Bring friends, ignore the slightly testing acoustics and share the love...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2.14%20Top%20Floor%20Kingly%20Court%2C%20Carnaby%20St%2C%20Soho%2C%20London%2C%20W1B%205PW%2C%20United%20Kingdom"
    pageTitle="Donia"
  />
);

export default Donia;
