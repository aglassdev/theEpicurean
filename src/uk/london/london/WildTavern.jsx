...
const WildTavern = () => (
  <RestaurantPage
    restaurantName="Wild Tavern"
    address="2 Elystan Street, Chelsea, London, SW3 3NS, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442081919885"
    website="https://www.wildtavern.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set overlooking the tiny Chelsea Green, this homely neighbourhood restaurant has the enticing feel of a warm Tuscan trattoria, with its waxed wooden floors and terracotta hues. True to the ethos of Italian cuisine, the dishes are ingredient-led and rely on the natural flavours of the produce – an approach extended to the raw bar of oysters, tartares and carpaccios. Alongside the prime cuts of meat and fish cooked over the grill, there are some terrific homemade pastas you'd be a fool to miss, especially the 'Tavern Tortelli' with Wagyu oxtail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Elystan%20Street%2C%20Chelsea%2C%20London%2C%20SW3%203NS%2C%20United%20Kingdom"
    pageTitle="Wild Tavern"
  />
);

export default WildTavern;
