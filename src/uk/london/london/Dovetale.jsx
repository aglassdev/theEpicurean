...
const Dovetale = () => (
  <RestaurantPage
    restaurantName="Dovetale"
    address="3 Berkeley Street, Mayfair, London, WD1 8DL, United Kingdom"
    cuisine="European"
    priceRange="£££"
    phoneNumber="+442031374983"
    website="https://www.dovetalelondon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Like the hotel in which it sits – 1 Hotel Mayfair – Dovetale makes good use of natural materials and plenty of plants to create a warm, bright environment. It also has a great terrace and a welcoming atmosphere. The menu looks to Europe for its contemporary dishes; go for one to be shared, like the whole roasted 'Somerset Saxon' chicken. If you’re after a bit of nostalgia, you can design your own Knickerbocker Glory for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Berkeley%20Street%2C%20Mayfair%2C%20London%2C%20WD1%208DL%2C%20United%20Kingdom"
    pageTitle="Dovetale"
  />
);

export default Dovetale;
