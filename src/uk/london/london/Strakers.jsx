...
const Strakers = () => (
  <RestaurantPage
    restaurantName="Straker's"
    address="91 Golborne Road, Notting Hill, London, W10 5NL, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442035408727"
    website="https://strakers.london"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is a tale of our times: a chef creates a large fanbase by giving cooking demos on TikTok during lockdown and then opens a small restaurant in Notting Hill so that they can come and experience his cooking first-hand. It’s a very likeable place, with no frills, easy-to-eat cooking that’s modern British by way of Italy; always start by ordering one of the flatbreads – and the sweetbreads are always a good bet too. Low intervention wines are a feature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=91%20Golborne%20Road%2C%20Notting%20Hill%2C%20London%2C%20W10%205NL%2C%20United%20Kingdom"
    pageTitle="Straker's"
  />
);

export default Strakers;
