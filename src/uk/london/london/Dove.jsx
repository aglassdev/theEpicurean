...
const Dove = () => (
  <RestaurantPage
    restaurantName="Dove"
    address="31 Kensington Park Road, Notting Hill, London, W11 2EU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+442070431400"
    website="https://dove.london/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Providing everything you would expect from a Notting Hill neighbourhood restaurant, Dove is the latest project from chef-restaurateur Jackson Boxer, taking over the space he once ran as Orasay. Bright, relaxed and simply decorated, it specialises in seasonal and high-quality produce across a menu that’s ideal for sharing. Dishes vary in size, from whole grilled fish and half a roasted chicken to snacks like fried potato pizzette with bonito, burrata and mortadella. The wine list offers something for everyone, with almost every choice available by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20Kensington%20Park%20Road%2C%20Notting%20Hill%2C%20London%2C%20W11%202EU%2C%20United%20Kingdom"
    pageTitle="Dove"
  />
);
