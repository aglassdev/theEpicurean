...
const Moro = () => (
  <RestaurantPage
    restaurantName="Moro"
    address="34-36 Exmouth Market, Finsbury, London, EC1R 4QE, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+442078338336"
    website="https://moro.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Full of customers and full of life, with service that is engaging and on-the-ball, Moro remains as popular as ever and is the perfect fit for the increasingly busy Exmouth Market. The Moorish menu is full of interesting, flavour-packed dishes, but the wood-roasted options are the ones to go for. The open kitchen adds to the atmosphere of the animated room, and their next-door tapas bar, Morito, is also worth visiting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34-36%20Exmouth%20Market%2C%20Finsbury%2C%20London%2C%20EC1R%204QE%2C%20United%20Kingdom"
    pageTitle="Moro"
  />
);
