...
const Kanishka = () => (
  <RestaurantPage
    restaurantName="Kanishka"
    address="17-19 Maddox Street, Mayfair, London, W1S 2QH, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+442039780978"
    website="https://kanishkarestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Owner Atul Kochhar’s signature style is writ large across the choice of menus at this smart Mayfair restaurant. The Anglo-infused Indian dishes – epitomised by the signature chicken tikka pie – provide plenty of interesting options, alongside a wide selection of traditional recipes from across the Indian regions. There’s a feeling of glamour to the surroundings that would suit a special occasion, with the ground floor the most fun place to sit. The Express Lunch menu is perfect for those looking for something speedy and great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17-19%20Maddox%20Street%2C%20Mayfair%2C%20London%2C%20W1S%202QH%2C%20United%20Kingdom"
    pageTitle="Kanishka"
  />
);

export default Kanishka;
