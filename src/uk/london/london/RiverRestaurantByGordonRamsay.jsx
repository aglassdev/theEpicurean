...
const RiverRestaurantByGordonRamsay = () => (
  <RestaurantPage
    restaurantName="River Restaurant by Gordon Ramsay"
    ...
    pageTitle="River Restaurant by Gordon Ramsay"
  />
);

export default RiverRestaurantByGordonRamsay;
