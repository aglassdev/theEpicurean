...
const Kruk = () => (
  <RestaurantPage
    restaurantName="Kruk"
    address="213 Blenheim Grove Peckham, London, SE15 4QL, United Kingdom"
    cuisine="Thai"
    priceRange="££"
    phoneNumber="+447802704814"
    website="https://krukthai.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enter into this railway-arch restaurant in Peckham Rye and you could convince yourself you’ve been transported to Bangkok. A pair of friends have turned their years of experience in Thai restaurants into an authentic slice of the country, from the bustling atmosphere to fresh, vibrant dishes like fried chicken ‘gai prik’. The chefs don’t hold back on the spice, yet their strong sense of balance ensures the central ingredients are never overwhelmed. Meat-free diners will be particularly delighted that every dish on the menu is matched by a vegetarian equivalent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=213%20Blenheim%20Grove%20Peckham%2C%20London%2C%20SE15%204QL%2C%20United%20Kingdom"
    pageTitle="Kruk"
  />
);
