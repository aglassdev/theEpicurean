...
const TheLanesboroughGrill = () => (
  <RestaurantPage
    restaurantName="The Lanesborough Grill"
    address="Hyde Park Corner, London, SW1X 7TA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+44207595599"
    website="https://www.oetkerhotels.com/hotels/the-lanesborough/restaurants-bars/the-lanesborough-grill/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This ornately decorated restaurant sits at the heart of the Lanesborough Hotel. Its menu moves with the seasons, offering modern British dishes brimming with prime ingredients, and includes lighter options as well as plenty for carnivores. Old school desserts are delivered with a degree of refinement, as befits the surroundings. Weekend dinners come with musical accompaniment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hyde%20Park%20Corner%2C%20London%2C%20SW1X%207TA%2C%20United%20Kingdom"
    pageTitle="The Lanesborough Grill"
  />
);

export default TheLanesboroughGrill;
