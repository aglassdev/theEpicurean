...
const Palomar = () => (
  <RestaurantPage
    ...
    bio="The flavours of Jerusalem have found a home in the heart of London’s theatreland, thanks to this stylish and deservedly popular restaurant. A zinc kitchen counter runs back to an intimate, wood-panelled dining room, which is filled with an almighty bustle. Like the atmosphere, the cooking is inviting and invigorating, with the good value dishes including fabulous fresh breads, superior dips and a range of produce cooked over fire...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20Rupert%20Street%2C%20Soho%2C%20London%2C%20W1D%206DN%2C%20United%20Kingdom"
    pageTitle="Palomar"
  />
);
