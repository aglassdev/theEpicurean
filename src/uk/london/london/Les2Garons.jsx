...
const Les2Garons = () => (
  <RestaurantPage
    restaurantName="Les 2 Garçons"
    address="14 Middle Lane, Crouch End, London, N8 8PL, United Kingdom"
    cuisine="French"
    priceRange="££"
    phoneNumber="+442083479834"
    website="https://www.les2garconsbistro.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The two garçons in question are Robert Reid and JC Slowik, both stalwarts of the London restaurant scene, and their experience is here to see in every element of this immensely likeable French bistro, which is far bigger than their previous place and thus better for coping with demand. Expect all the classics to be found on the menu or blackboard, whether that’s duck confit or escargots; the baba au rhum is not to be missed and the all-French wine list is appealing priced...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Middle%20Lane%2C%20Crouch%20End%2C%20London%2C%20N8%208PL%2C%20United%20Kingdom"
    pageTitle="Les 2 Garçons"
  />
);

export default Les2Garons;
