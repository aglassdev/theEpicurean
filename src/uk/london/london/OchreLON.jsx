...
const OchreLON = () => (
  <RestaurantPage
    ...
    address="The National Gallery, Trafalgar Square, St James’s, London, WC2N 5DN, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+442077472525"
    website="https://www.ochre.london"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the ground floor of The National Gallery's iconic William Wilkins building, this smart, comfortable bistro de-luxe is revolutionising museum dining. The all-day menus offer something for everyone, from a wallet-friendly 'prix fixe' to brunch and afternoon tea. The central dinner à la carte can be ordered in a standard three-course format, or as small and large plates to share. Running throughout are vivid flavours and international touches from schnitzel to korma. You'll get a lovely welcome from the team, who are serious about what they do and run their restaurant well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20National%20Gallery%2C%20Trafalgar%20Square%2C%20St%20James%E2%80%99s%2C%20London%2C%20WC2N%205DN%2C%20United%20Kingdom"
    pageTitle="Ochre"
  />
);

export default OchreLON;
