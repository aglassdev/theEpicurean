...
const Whytes = () => (
  <RestaurantPage
    restaurantName="Whyte's"
    address="Unit 3, 143 Mare Street, Hackney, London, E8 3RH, United Kingdom"
    cuisine="World Cuisine"
    priceRange="£££"
    phoneNumber="+447957779621"
    website="https://www.whytesrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a reputation forged in pop-ups and supper clubs, the self-styled rock ‘n’ roll chef known as 'Whyte Rushen' has success on his hands with his first permanent restaurant, which he opened here in London Fields in 2024. His menu is made up of sharing plates big and small but is also something of a movable feast: it may be Basque-influenced one month, Italian the next – but if there's a whole turbot to share or BBQ ‘finger burners’ on the menu, don’t hesitate to order them. It’s loud, fun and furious – ask for counter seats and join the party...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%203%2C%20143%20Mare%20Street%2C%20Hackney%2C%20London%2C%20E8%203RH%2C%20United%20Kingdom"
    pageTitle="Whyte's"
  />
);

export default Whytes;
