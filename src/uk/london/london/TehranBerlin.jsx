...
const TehranBerlin = () => (
  <RestaurantPage
    restaurantName="Tehran Berlin"
    address="20 Rosebery Avenue, Finsbury, London, EC1R 4SX, United Kingdom"
    cuisine="Persian"
    priceRange="££££"
    phoneNumber=""
    website="https://www.tehranberlin.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is an immeasurably likeable restaurant, where enthusiastic yet softly spoken Chef-Owner Yuma Hashemi – who was born in Tehran and grew up in Berlin – has gradually moved the influences from being French with a hint of Iranian to unashamedly and wholeheartedly celebrating Iranian cuisine. The multi-course surprise menu provides a great opportunity to sample a variety of dishes and this, many of which are inspired by Yuma's family recipes. The cooking, together with the warm service and quirky, characterful interior, ensures everyone has a good night...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Rosebery%20Avenue%2C%20Finsbury%2C%20London%2C%20EC1R%204SX%2C%20United%20Kingdom"
    pageTitle="Tehran Berlin"
  />
);

export default TehranBerlin;
