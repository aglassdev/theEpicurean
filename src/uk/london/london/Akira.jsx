...
const Akira = () => (
  <RestaurantPage
    restaurantName="Akira"
    address="Japan House, 101-111 Kensington High Street, Kensington, London, W8 5SA, United Kingdom"
    cuisine="Japanese"
    priceRange="£££"
    phoneNumber="+442039714646"
    website="https://akira-restaurant.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Japan%20House%2C%20101-111%20Kensington%20High%20Street%2C%20Kensington%2C%20London%2C%20W8%205SA%2C%20United%20Kingdom"
    pageTitle="Akira"
  />
);
