...
const Sumi = () => (
  <RestaurantPage
    restaurantName="Sumi"
    address="157 Westbourne Grove, Notting Hill, London, W11 2RS, United Kingdom"
    cuisine="Japanese"
    priceRange="£££"
    phoneNumber="+442045240880"
    website="https://www.sushisumi.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a plethora of restaurants on Westbourne Grove but few are ever as busy as Sumi. In 2022 this modern Japanese restaurant from Endo Kazutoshi – which he named after his mother – expanded into next door and the new seating quickly filled up. The atmosphere is always lively thanks to the young crowd and the great cocktail list. The menu is not overly long; the robata dishes are the standouts, but just keep half an eye on the bill as it can quickly expand...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=157%20Westbourne%20Grove%2C%20Notting%20Hill%2C%20London%2C%20W11%202RS%2C%20United%20Kingdom"
    pageTitle="Sumi"
  />
);
