...
const LaTrompette = () => (
  <RestaurantPage
    restaurantName="La Trompette"
    address="3-7 Devonshire Road, Chiswick, London, W4 2EU, United Kingdom"
    ...
    bio="The jewel in Chiswick’s culinary crown remains as popular as ever, thanks to its local feel, relaxed atmosphere and, most importantly, its skilled and generous cooking. Largely British ingredients are combined with influences from France and occasionally the wider Mediterranean. So you can expect carefully prepared dishes like Cornish cod with squid ink cavatelli or Devonshire duck breast with potato galette, where the flavours are as assured as they are satisfying. Bright and delightful on a summer’s day and cosy and warm in winter, this is a restaurant for all seasons and all occasions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-7%20Devonshire%20Road%2C%20Chiswick%2C%20London%2C%20W4%202EU%2C%20United%20Kingdom"
    pageTitle="La Trompette"
  />
);

export default LaTrompette;
