...
const TheHolland = () => (
  <RestaurantPage
    restaurantName="The Holland"
    address="25 Earls Court Road, Kensington, London, W8 6EB, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+442045991369"
    website="https://thehollandkensington.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It may have been renamed and rebranded, but this is still a proper neighbourhood pub, with local drinkers in with their dogs, families out for dinner and friends catching up. It’s all very comfy and the relaxed air owes much to the warm and caring staff. The seasonal menu is thoughtfully compiled and the cooking hearty and satisfying; the pork collar is good and, if the almond tart is on the menu, don’t hesitate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Earls%20Court%20Road%2C%20Kensington%2C%20London%2C%20W8%206EB%2C%20United%20Kingdom"
    pageTitle="The Holland"
  />
);

export default TheHolland;
