...
const Bubala = () => (
  <RestaurantPage
    restaurantName="Bubala"
    address="65 Commercial Street, Spitalfields, London, E1 6BD, United Kingdom"
    ...
    bio="Start with a freshly cooked laffa flatbread and one of their delicious dips before feasting on Middle Eastern-inspired vegan and vegetarian sharing plates, which are elevated by their delicate spicing. Wines are mostly unfiltered, natural and orange – and service is charming and attentive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=65%20Commercial%20Street%2C%20Spitalfields%2C%20London%2C%20E1%206BD%2C%20United%20Kingdom"
    pageTitle="Bubala"
  />
);

export default Bubala;
