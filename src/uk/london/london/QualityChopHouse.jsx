...
const QualityChopHouse = () => (
  <RestaurantPage
    restaurantName="Quality Chop House"
    address="91-94 Farringdon Road, Clerkenwell, London, EC1R 3EA, United Kingdom"
    cuisine="Meats and Grills, Traditional British"
    priceRange="£££"
    phoneNumber="+442072781452"
    website="https://thequalitychophouse.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A landmark London restaurant with a history dating back to 1869, this ‘progressive working class caterer’ champions quality British produce, with the focus on steaks and chops, like Belted Galloway rib-eye, Mangalitsa loin and Barnsley chops; just be sure to also order their deliciously crunchy confit potatoes. The booths are the prized seats and the wine list contains lots of gems, more of which are available at their wine bar just next door...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=91-94%20Farringdon%20Road%2C%20Clerkenwell%2C%20London%2C%20EC1R%203EA%2C%20United%20Kingdom"
    pageTitle="Quality Chop House"
  />
);

export default QualityChopHouse;
