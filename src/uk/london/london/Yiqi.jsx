...
const Yiqi = () => (
  <RestaurantPage
    restaurantName="YiQi"
    address="14 Lisle Street, Chinatown, London, WC2H 7BE, United Kingdom"
    cuisine="Asian"
    priceRange="££"
    phoneNumber="+442072872751"
    website="https://www.yiqipanasia.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thailand, Malaysia and Singapore are the three countries that feature most prominently at this relative newcomer to Chinatown, which opened in 2024. Spread over two floors, it’s run by an eager and professional team who provide attentive service and offer helpful advice when you’re leafing through the extensive menu. The highlights of that menu include moreish salt and pepper squid, flavoursome whole grilled silver pomfret, street food style morning glory and succulent charcoal chicken wings – they’re all generous in size, so come with family or friends and share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Lisle%20Street%2C%20Chinatown%2C%20London%2C%20WC2H%207BE%2C%20United%20Kingdom"
    pageTitle="YiQi"
  />
);
