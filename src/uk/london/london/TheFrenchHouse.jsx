...
const TheFrenchHouse = () => (
  <RestaurantPage
    restaurantName="The French House"
    address="49 Dean Street, Soho, London, W1D 5BG, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="£££"
    phoneNumber="+442074372477"
    website="https://www.frenchhousesoho.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This historic Soho watering hole, once a favourite haunt of writers and artists such as Dylan Thomas, Brendan Behan and Francis Bacon, has only seven tables in its oxblood and wood-panelled upstairs restaurant. It’s run in a bohemian style and offers traditional, honest cooking with integrity and flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49%20Dean%20Street%2C%20Soho%2C%20London%2C%20W1D%205BG%2C%20United%20Kingdom"
    pageTitle="The French House"
  />
);

export default TheFrenchHouse;
