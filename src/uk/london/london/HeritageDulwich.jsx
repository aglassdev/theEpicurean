...
const HeritageDulwich = () => (
  <RestaurantPage
    restaurantName="Heritage Dulwich"
    address="101 Rosendale Road, Dulwich, London, SE21 8EZ, United Kingdom"
    cuisine="Indian"
    priceRange="££"
    phoneNumber="+442087614665"
    website="https://www.heritagedulwich.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Heritage’ is key to the cooking at this Indian restaurant in a smart suburban shopping parade, where skilfully prepared dishes are knowledgably balanced, well-spiced and packed with authentic flavours. Dayashankar Sharma – who has led many of London’s best Indian kitchens – cooks alongside his son Anmol...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=101%20Rosendale%20Road%2C%20Dulwich%2C%20London%2C%20SE21%208EZ%2C%20United%20Kingdom"
    pageTitle="Heritage Dulwich"
  />
);

export default HeritageDulwich;
