...
const GiuliaLON = () => (
  <RestaurantPage
    ...
    address="77 Askew Road, Shepherd's Bush, London, W12 9AH, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    phoneNumber="+442087430572"
    website="https://giuliarestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s an authentic, honest feel to this small Italian neighbourhood restaurant. The eponymous owner Giulia can be seen chatting away to guests in her native language and offering great hospitality alongside the cooking. Her partner Endris is in the kitchen following the ethos of pure, ingredient-led cooking with a seasonal focus. Pasta is offered as a separate course, including classic dishes like spaghetti alle vongole. The wine list is sensibly priced and, unsurprisingly, all Italian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%20Askew%20Road%2C%20Shepherd's%20Bush%2C%20London%2C%20W12%209AH%2C%20United%20Kingdom"
    pageTitle="Giulia"
  />
);

export default GiuliaLON;
