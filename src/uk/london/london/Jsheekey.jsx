...
const Jsheekey = () => (
  <RestaurantPage
    restaurantName="J.Sheekey"
    address="28-32 St. Martin's Court, Covent Garden, London, WC2N 4AL, United Kingdom"
    cuisine="Seafood"
    priceRange="£££"
    phoneNumber="+442072402565"
    website="https://j-sheekey.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Festooned with photographs of actors and linked to the theatrical world since opening in the heart of theatreland in 1896, J.Sheekey comes with a sense of exclusive intimacy thanks to soft lighting, wood-panelled walls and banquette seating. This Grand Dame of the West End is a seafood restaurant at heart, with everything from extravagant shellfish platters to their signature fish pie showing off high quality produce and accomplished technique. Despite the fishy bent, there's a strong offering for vegetarians...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28-32%20St.%20Martin's%20Court%2C%20Covent%20Garden%2C%20London%2C%20WC2N%204AL%2C%20United%20Kingdom"
    pageTitle="J.Sheekey"
  />
);

export default Jsheekey;
