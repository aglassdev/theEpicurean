...
const BalaBaya = () => (
  <RestaurantPage
    ...
    address="Arch 25, Old Union Yard Arches, 229 Union Street, Southwark, London, SE1 0LR, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+442080017015"
    website="https://balabaya.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The atmosphere is loud and lively at this infectiously fun restaurant that celebrates the Tunisian and Syrian heritage of its passionate chef-owner, as well as his global travels. The bright, modern interior is inspired by Bauhaus architecture, with the counter being the best place to sit if you want to feel the buzz and watch the chefs as they cook. Dishes are fresh, vibrant and designed for sharing, with the signatures including prawn baklava and 'aubergine mess'...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arch%2025%2C%20Old%20Union%20Yard%20Arches%2C%20229%20Union%20Street%2C%20Southwark%2C%20London%2C%20SE1%200LR%2C%20United%20Kingdom"
    pageTitle="Bala Baya"
  />
);

export default BalaBaya;
