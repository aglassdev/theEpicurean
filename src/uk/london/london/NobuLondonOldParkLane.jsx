...
const NobuLondonOldParkLane = () => (
  <RestaurantPage
    restaurantName="Nobu London"
    address="19 Old Park Lane, Mayfair, London, W1Y 4LB, United Kingdom"
    cuisine="Japanese"
    priceRange="£££"
    phoneNumber="+442074474747"
    website="https://www.noburestaurants.com/london-old-park-lane/home/"
    aliases={["Nobu London Old Park Lane"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are now Nobu restaurants stretching from Dallas to Dubai and Mexico to Melbourne, but this one was Europe’s first when it opened back in 1997. Like seeing a favourite popstar on stage, you can expect all the greatest hits, from seafood toban yaki to rock shrimp tempura and, of course, the dish that’s been copied a thousand times: black cod miso. There’s a decently priced weekday lunch menu and the service is smooth and confident...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20Old%20Park%20Lane%2C%20Mayfair%2C%20London%2C%20W1Y%204LB%2C%20United%20Kingdom"
    pageTitle="Nobu London"
  />
);

export default NobuLondonOldParkLane;
