...
const Arlington = () => (
  <RestaurantPage
    restaurantName="Arlington"
    address="20 Arlington Street, St James's, London, SW1A 1RG, United Kingdom"
    cuisine="European"
    priceRange="£££"
    phoneNumber="+442038561000"
    website="https://www.arlington.london/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The much-missed Le Caprice, a celebrity-laden London icon in the affluent environs of St James’s, has been reborn as Arlington. It has the same charming décor as its predecessor, all black-and-white photographs and ’20s elegance, with the banquettes at the back the best seats in the house. The menu dispenses with anything too trendy and instead keeps things classic and wholly enjoyable – think dressed Dorset crab, chicken Milanese and one of the best fishcakes in London. The service team play their part by running the place with a terrific efficiency...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Arlington%20Street%2C%20St%20James's%2C%20London%2C%20SW1A%201RG%2C%20United%20Kingdom"
    pageTitle="Arlington"
  />
);
