...
const Sollip = () => (
  <RestaurantPage
    restaurantName="Sollip"
    address="Unit 1, 8 Melior Street, Southwark, London, SE1 3QP, United Kingdom"
    cuisine="Creative"
    priceRange="££££"
    phoneNumber="+442073781742"
    website="https://www.sollip.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%201%2C%208%20Melior%20Street%2C%20Southwark%2C%20London%2C%20SE1%203QP%2C%20United%20Kingdom"
    pageTitle="Sollip"
  />
);

export default Sollip;
