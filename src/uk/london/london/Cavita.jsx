...
const Cavita = () => (
  <RestaurantPage
    restaurantName="Cavita"
    address="56-60 Wigmore Street, Marylebone, London, W1U 2RZ, United Kingdom"
    cuisine="Mexican"
    priceRange="£££"
    phoneNumber="+442039281000"
    website="https://www.cavitarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Head to the basement bar for a cocktail before taking a seat in this bright, friendly ground floor restaurant with a view of the chefs at work in the open kitchen. The menu brims with punchy, vibrant Mexican choices, including raw dishes such as hamachi tostadas and street food options like a concise range of tacos. Make sure you bring some friends to make the most of the main course platters to share. There's an enticing brunch offering too, where the mezcal and margaritas are bound to be flowing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56-60%20Wigmore%20Street%2C%20Marylebone%2C%20London%2C%20W1U%202RZ%2C%20United%20Kingdom"
    pageTitle="Cavita"
  />
);

export default Cavita;
