...
const Jos = () => (
  <RestaurantPage
    restaurantName="José"
    address="104 Bermondsey Street, Southwark, London, SE1 3UB, United Kingdom"
    cuisine="Spanish"
    priceRange="££"
    phoneNumber="+442074034902"
    website="https://josepizarro.com/venues/pizarro-restaurant-bermondsey/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Coming with all the rustic, no-frills charm you'd expect of a tapas bar, José was the original London operation from eponymous chef José Pizarro, who has since spread his brand of classic Spanish cooking all over London. His flagship spot features counter seating at the open kitchen alongside high-topped tables, all of which come with a bustling atmosphere thanks to the fact the place is perennially busy. The menu features plenty of Spanish favourites; the Acorn-fed Jamón Ibérico is a must, as is the chocolate pot for dessert. No bookings are taken, so get here early...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=104%20Bermondsey%20Street%2C%20Southwark%2C%20London%2C%20SE1%203UB%2C%20United%20Kingdom"
    pageTitle="José"
  />
);
