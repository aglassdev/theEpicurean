...
const Veeraswamy = () => (
  <RestaurantPage
    restaurantName="Veeraswamy"
    address="Victory House, 99 Regent Street, Mayfair, London, W1B 4RS, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    ...
    bio="London's oldest Indian restaurant may have opened in 1926, but the kitchen continues to produce wonderfully authentic and satisfying dishes after all these years. You can expect to find cuisine from all parts of India, including cleverly enhanced street snacks and stand-out dishes inspired by royal recipes. Top quality British produce is often used, such as Welsh lamb for the Kashmiri rogan josh. The room is awash with colour and is run with charm and obvious pride; ask for a window table overlooking Regent Street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Victory%20House%2C%2099%20Regent%20Street%2C%20Mayfair%2C%20London%2C%20W1B%204RS%2C%20United%20Kingdom"
    pageTitle="Veeraswamy"
  />
);

export default Veeraswamy;
