...
const Lasdun = () => (
  <RestaurantPage
    restaurantName="Lasdun"
    address="National Theatre, Upper Ground, Southwark, London, SE1 9PX, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442074523600"
    website="https://www.lasdunrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside the Brutalist blocks of the National Theatre, lies this buzzy brasserie named after the building’s architect, Denys Lasdun. The sparse modern décor is accompanied by an abundance of exposed concrete, while the cooking has the same seasonal British ethos as the Marksman pub, which comes from the same owners. A good dose of flavour is extracted from the quality produce, while sharing dishes – like chicken, leek and girolles pie – are also on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=National%20Theatre%2C%20Upper%20Ground%2C%20Southwark%2C%20London%2C%20SE1%209PX%2C%20United%20Kingdom"
    pageTitle="Lasdun"
  />
);

export default Lasdun;
