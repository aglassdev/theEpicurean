...
const SsamSsam = () => (
  <RestaurantPage
    restaurantName="ssam ssam"
    address="149 Merton Road, Merton, London, SW19 1ED, United Kingdom"
    cuisine="Korean"
    priceRange="£"
    phoneNumber="+442037718829"
    website="https://ssamssam.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=149%20Merton%20Road%2C%20Merton%2C%20London%2C%20SW19%201ED%2C%20United%20Kingdom"
    pageTitle="ssam ssam"
  />
);

export default SsamSsam;
