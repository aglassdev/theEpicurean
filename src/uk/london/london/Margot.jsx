...
const Margot = () => (
  <RestaurantPage
    ...
    address="45 Great Queen Street, Holborn, London, WC2B 5AA, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442034094777"
    website="https://www.margotrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The service and the surroundings are equally slick at this plush Italian restaurant on the edge of Covent Garden. The menu offers an appealing choice of dishes, from simply prepared fish of the day to veal-based classics like ossobuco and vitello alla Milanese – and top quality ingredients and bold flavours run throughout. Take time to study the well-chosen wine list, which has a strong focus on the regional wines of Italy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Great%20Queen%20Street%2C%20Holborn%2C%20London%2C%20WC2B%205AA%2C%20United%20Kingdom"
    pageTitle="Margot"
  />
);
