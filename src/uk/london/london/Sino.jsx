...
const Sino = () => (
  <RestaurantPage
    restaurantName="Sino"
    address="7 All Saints Road, Notting Hill, London, W11 1HA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber=""
    website="https://sinorestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Many chefs talk about their experiences informing their cooking but here that means so much more, as Ukrainian chef-owner Eugene Korolev has gone from fighting on the front line to opening a restaurant in Notting Hill. His love for Ukraine comes through in every dish; start with the crisp black pudding croquettes before tucking into crayfish with cabbage or beef dumplings in a spicy beef broth – and don’t miss the basket of delicious rye and sourdough breads. The restaurant is cosy, cute and run with genuine warmth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20All%20Saints%20Road%2C%20Notting%20Hill%2C%20London%2C%20W11%201HA%2C%20United%20Kingdom"
    pageTitle="Sino"
  />
);
