...
const Canteen = () => (
  <RestaurantPage
    restaurantName="Canteen"
    address="310 Portobello Road, Notting Hill, London, W10 5TA, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    phoneNumber=""
    website="https://www.instagram.com/canteen.310/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The team behind two of West London’s best pubs, The Pelican and The Hero, appear to be just as adept at opening restaurants. The two chefs are alumni of The River Café and it shows in their no-nonsense, flavour-driven Italian food. The menu is a loosely structured document, but you can use the price as a rough guide to the size of the dish. Highlights include rich ox cheek with polenta and the homemade pasta. There's no bookings, so be prepared for a queue, but the lovely service team handle it well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=310%20Portobello%20Road%2C%20Notting%20Hill%2C%20London%2C%20W10%205TA%2C%20United%20Kingdom"
    pageTitle="Canteen"
  />
);
