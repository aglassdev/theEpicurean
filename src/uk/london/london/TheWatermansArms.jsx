...
const TheWatermansArms = () => (
  <RestaurantPage
    restaurantName="The Waterman's Arms"
    address="375 Lonsdale Road, Barnes, London, SW13 9PY, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442045298970"
    website="https://www.watermansarms.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s something that just feels right as soon as you enter this terrific Thames-side pub. Dating back to the 1850s, it’s got character to spare and a cosy atmosphere being heartily enjoyed by one and all – while the scent of fresh flowers on the tables combines with appetising aromas from the kitchen. Start with a snack, like the homemade Merguez sausage with labneh, before choosing one of the vibrantly flavoured main dishes, including a selection of steaks and fresh fish from the blackboard. The bright and attentive team are the icing on the cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=375%20Lonsdale%20Road%2C%20Barnes%2C%20London%2C%20SW13%209PY%2C%20United%20Kingdom"
    pageTitle="The Waterman's Arms"
  />
);

export default TheWatermansArms;
