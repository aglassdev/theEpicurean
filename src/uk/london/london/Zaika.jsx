...
const Zaika = () => (
  <RestaurantPage
    ...
    address="1 Kensington High Street, Kensington, London, W8 5NP, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+442077956533"
    website="https://zaikaofkensington.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are many original features on display in this wonderfully ornate former banking hall and, while it’s a spacious place, the team look after diners with consummate ease. Authentic cooking methods are used to create dishes from all corners of India; go for the tasting menu to sample the range...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Kensington%20High%20Street%2C%20Kensington%2C%20London%2C%20W8%205NP%2C%20United%20Kingdom"
    pageTitle="Zaika"
  />
);
