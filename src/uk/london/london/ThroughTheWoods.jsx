...
const ThroughTheWoods = () => (
  <RestaurantPage
    restaurantName="Through the Woods"
    address="212 Middle Lane, Crouch End, London, N8 7LA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber=""
    website="https://www.throughthewoods.london/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With seating for just 18 people and a logo rather than a sign outside, it’s clear that understatement and simplicity lie at the core of this cosy and very likeable restaurant. Diners are asked to arrive at 7.30pm as dinner is served to everyone at 8pm; the 4 course, weekly-changing menu offers no choice and you pay when you book. From the tiny open kitchen you can expect nourishing and heartwarming dishes like succulent Blackface lamb with Hasselback potatoes and wonderfully light blood orange & brioche pudding...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=212%20Middle%20Lane%2C%20Crouch%20End%2C%20London%2C%20N8%207LA%2C%20United%20Kingdom"
    pageTitle="Through the Woods"
  />
);

export default ThroughTheWoods;
