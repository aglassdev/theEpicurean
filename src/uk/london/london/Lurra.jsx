...
const Lurra = () => (
  <RestaurantPage
    restaurantName="Lurra"
    address="9 Seymour Place, Marylebone, London, W1H 5BA, United Kingdom"
    cuisine="Basque"
    priceRange="££££"
    phoneNumber="+442077244545"
    website="https://www.lurra.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its name means ‘land’ in Basque and reflects their use of the freshest produce, cooked over a charcoal grill. Choose tasty nibbles or sharing plates like 14 year old Galician beef, whole grilled turbot or slow-cooked shoulder of lamb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Seymour%20Place%2C%20Marylebone%2C%20London%2C%20W1H%205BA%2C%20United%20Kingdom"
    pageTitle="Lurra"
  />
);

export default Lurra;
