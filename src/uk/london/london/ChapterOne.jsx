...
const ChapterOne = () => (
  <RestaurantPage
    ...
    address="Farnborough Common, Locksbottom, Bromley, London, BR6 8NF, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441689854848"
    website="https://chapteronerestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They’ve got a loyal following at this long-standing restaurant that offers an extensive and appealing menu of modern European dishes. The cooking has some light, delicate touches and prime British produce cooked on the Mibrasa grill is a feature, like Cornish monkfish or Angus rib-eye. It’s all delivered inside a property that dates back to the 1930s and there are subtle references to this period in the elegant décor. The service team bring an enthusiastic smile and real care to their work...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Farnborough%20Common%2C%20Locksbottom%2C%20Bromley%2C%20London%2C%20BR6%208NF%2C%20United%20Kingdom"
