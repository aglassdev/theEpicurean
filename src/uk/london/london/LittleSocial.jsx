...
const LittleSocial = () => (
  <RestaurantPage
    restaurantName="Little Social"
    address="5 Pollen Street, Mayfair, London, W1S 1NE, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442078703730"
    website="https://www.littlesocial.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Little Social has a clubby, comforting feel and a smart, stylish look, with on-trend copper, dark wood, and duck egg blue upholstery ensuring it fits in perfectly with its Mayfair surroundings. The seasonal British menu offers something for everyone, and its creative modern dishes are full of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Pollen%20Street%2C%20Mayfair%2C%20London%2C%20W1S%201NE%2C%20United%20Kingdom"
    pageTitle="Little Social"
  />
);

export default LittleSocial;
