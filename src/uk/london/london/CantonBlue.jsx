...
const CantonBlue = () => (
  <RestaurantPage
    restaurantName="Canton Blue"
    address="1 Grosvenor Place, Belgravia, London, SW1X 7HJ, United Kingdom"
    cuisine="Cantonese"
    priceRange="££££"
    phoneNumber="+442081386888"
    website="https://www.peninsula.com/en/london/hotel-fine-dining/canton-blue"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed inside the spectacular Peninsula Hotel, this Cantonese restaurant is part of a brand housed inside their hotels around the world. The London version boasts its own entrance at the side of the hotel and a sumptuous cocktail bar, Little Blue, which is the perfect way to kick off a rather glamorous evening. The restaurant itself is equally stylish, and the extensive menu offers a wide selection of authentic, flavoursome dishes, from finely executed dim sum to Peking duck for two. The interesting wine list includes a selection of Chinese rice wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Grosvenor%20Place%2C%20Belgravia%2C%20London%2C%20SW1X%207HJ%2C%20United%20Kingdom"
    pageTitle="Canton Blue"
  />
);

export default CantonBlue;
