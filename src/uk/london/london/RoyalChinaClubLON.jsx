...
const RoyalChinaClubLON = () => (
  <RestaurantPage
    restaurantName="Royal China Club"
    address="40-42 Baker Street, Marylebone, London, W1U 7AJ, United Kingdom"
    cuisine="Chinese"
    priceRange="£££"
    phoneNumber="+442074863898"
    website="https://www.royalchinagroup.co.uk/royalchinaclub"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Service is fast-paced and to the point, which is understandable considering how busy this restaurant always is. The large menu offers something for everyone and the lunchtime dim sum is very good; at dinner try their more unusual Cantonese dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40-42%20Baker%20Street%2C%20Marylebone%2C%20London%2C%20W1U%207AJ%2C%20United%20Kingdom"
    pageTitle="Royal China Club"
  />
);

export default RoyalChinaClubLON;
