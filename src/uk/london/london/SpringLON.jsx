...
const SpringLON = () => (
  <RestaurantPage
    ...
    address="New Wing, Somerset House, Strand, London, WC2R 1LA, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442030110115"
    website="https://springrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sporting fresh, bright décor that's befitting of its name, Spring occupies an undeniably gorgeous room in the 'New Wing' of Somerset House, that for many years was inhabited by the Inland Revenue. Under the aegis of Chef Skye Gyngell, it serves unfussy, Italian-influenced and ingredient-led food that you feel is doing you good as you eat it. For great value, go for the midweek set lunch or the 'Scratch' menu composed of ingredients that would ordinarily be thrown away and featuring dishes like a bread and butter pudding made using 'yesterday's sourdough'...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=New%20Wing%2C%20Somerset%20House%2C%20Strand%2C%20London%2C%20WC2R%201LA%2C%20United%20Kingdom"
    pageTitle="Spring"
  />
);

export default SpringLON;
