...
const PigAndButcher = () => (
  <RestaurantPage
    restaurantName="Pig and Butcher"
    address="80 Liverpool Road, Islington, London, N1 OQD, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442072268304"
    website="https://thepigandbutcher.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In-house butchered meats reign supreme at this rustic, mid-19th Century pub, which is filled with diners and drinkers alike, all contributing to the lively atmosphere. 'Seasonal' and 'British' are the guiding principles behind produce ranging from Aberdeen Angus to Sutton Hoo chicken. The deeply addictive beef dripping served with the bread is one of the highlights of the experience, but it faces stiff competition from the likes of melt-in-the-mouth braised short rib...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=80%20Liverpool%20Road%2C%20Islington%2C%20London%2C%20N1%20OQD%2C%20United%20Kingdom"
    pageTitle="Pig and Butcher"
  />
);

export default PigAndButcher;
