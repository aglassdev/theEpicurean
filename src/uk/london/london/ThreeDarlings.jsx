...
const ThreeDarlings = () => (
  <RestaurantPage
    restaurantName="Three Darlings"
    address="241B Pavilion Road, Chelsea, London, SW1X 0BP, United Kingdom"
    cuisine="World Cuisine"
    priceRange="£££"
    phoneNumber=""
    website="https://www.threedarlingslondon.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A celebration of Jason and Irha Atherton's three daughters, this casual yet elegant modern bistro fits right in among the affluent streets of Chelsea. An all-day operation offering everything from brunch to late-night cocktails, it’s classic Atherton in its lack of pretension and commitment to quality British ingredients. While the likes of Dingley Dell pork and Orkney scallop are the flavourful driving force, the cooking adopts a grab-bag of influences ranging from schnitzel in one course to sobrasada in another, char siu here to katsu curry there...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=241B%20Pavilion%20Road%2C%20Chelsea%2C%20London%2C%20SW1X%200BP%2C%20United%20Kingdom"
    pageTitle="Three Darlings"
  />
);

export default ThreeDarlings;
