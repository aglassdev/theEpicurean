...
const Julies = () => (
  <RestaurantPage
    restaurantName="Julie's"
    address="135 Portland Road, Holland Park, London, W11 4LW, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442072298331"
    website="https://www.juliesrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Judging by the amount of diners flooding through its doors, the residents of Notting Hill are glad to have this bright bistro de-luxe among their roster of neighbourhood haunts. Inside, it’s an eye-catching place with rich, warming colours and booths that are perfect for date night. The menu offers an appealing range of dishes, from the light (chopped salad of the day) to the luxurious (lobster soufflé). The extensive wine list and cocktails from the trolley will ensure you’re well-refreshed, while the service team are friendly and engaging...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=135%20Portland%20Road%2C%20Holland%20Park%2C%20London%2C%20W11%204LW%2C%20United%20Kingdom"
    pageTitle="Julie's"
  />
);

export default Julies;
