...
const Himi = () => (
  <RestaurantPage
    restaurantName="HIMI"
    address="4 Newburgh Street, Soho, London, W1F 7RF, United Kingdom"
    cuisine="Japanese"
    priceRange="£££"
    phoneNumber="+442030898223"
    website="https://himi.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The husband-and-wife team behind Roji opened this izakaya-style spot in early 2025. It certainly succeeds in creating that happy, tie-loosening after-work vibe, especially if you’re sitting at the counter in front of the animated kitchen; there are also tables available, for those preferring to face each other. Highlights include wonderfully crispy fried chicken (is there anything better with a cold beer?); Inaniwa udon with juicy pink duck; and flavoursome red shrimp from the robata grill, which comes with squid ink...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20Newburgh%20Street%2C%20Soho%2C%20London%2C%20W1F%207RF%2C%20United%20Kingdom"
    pageTitle="HIMI"
  />
);
