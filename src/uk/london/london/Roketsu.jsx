...
const Roketsu = () => (
  <RestaurantPage
    restaurantName="Roketsu"
    address="12 New Quebec Street, Marylebone, London, W1H 7RW, United Kingdom"
    cuisine="Japanese"
    priceRange="££££"
    phoneNumber="+442031491227"
    website="https://www.roketsu.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is temporarily closed for renovation. Chef-Owner Daisuke Hayashi has created a little slice of Kyoto life here in New Quebec Street. His culinary training and background may have been traditional but he’s not averse to introducing the occasional contemporary touch to some elements of his 10 course kaiseki menu. If you want to make your own choices, there's also an à la carte available, along with a set lunch menu on certain days. The charming welcome, attentive service and the counter fashioned from 100-year old hinoki wood will transport you away from the hurly burly of city life...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20New%20Quebec%20Street%2C%20Marylebone%2C%20London%2C%20W1H%207RW%2C%20United%20Kingdom"
    pageTitle="Roketsu"
  />
);

export default Roketsu;
