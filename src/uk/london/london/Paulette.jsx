...
const Paulette = () => (
  <RestaurantPage
    restaurantName="Paulette"
    address="18 Formosa Street, Little Venice, London, W9 1EE, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+442072862715"
    website="https://www.paulettelondon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the grandmother of one of the owners, Paulette is the sort of cosy, traditional French bistro everyone laments as no longer existing. The atmosphere is convivial – you get the feeling most customers walked here – and the menu is hugely appealing; expect everything from escargots and moules marinière to filet de boeuf and chocolate soufflé. Add in a cleverly curated all-French wine list that’s great value, along with a fridge full of produce to buy and take home, and you have the recipe for a very satisfying night out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Formosa%20Street%2C%20Little%20Venice%2C%20London%2C%20W9%201EE%2C%20United%20Kingdom"
    pageTitle="Paulette"
  />
);
