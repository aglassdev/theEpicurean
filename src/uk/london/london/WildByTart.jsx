...
const WildByTart = () => (
  <RestaurantPage
    restaurantName="Wild by Tart"
    address="3-4 Eccleston Yards, Belgravia, London, SW1W 9AZ, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+442038486240"
    website="https://www.wildbytart.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This laid-back brasserie is located in a former power station and coal store; the lofty glass roof ensures it’s light and airy, and the open kitchen gives it a real buzz. Rustic, Mediterranean-influenced dishes are tasty and satisfying, with bold flavours and the occasional Asian touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-4%20Eccleston%20Yards%2C%20Belgravia%2C%20London%2C%20SW1W%209AZ%2C%20United%20Kingdom"
    pageTitle="Wild by Tart"
  />
);

export default WildByTart;
