...
const Bancone = () => (
  <RestaurantPage
    restaurantName="Bancone"
    address="39 William IV Street, Covent Garden, London, WC2N 4DD, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    ...
    bio="It’s all about freshly made pasta and great value at this lively Covent Garden Italian. Start off with antipasti like burrata, prosciutto or grilled artichokes, before moving on to the main event; there’s a range of pastas available, but the best of all might still be the signature ‘silk handkerchiefs’ with walnut butter and confit egg yolk. Sit up at the open kitchen to watch the chefs working their magic – ‘bancone’ is Italian for ‘counter’ after all...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20William%20IV%20Street%2C%20Covent%20Garden%2C%20London%2C%20WC2N%204DD%2C%20United%20Kingdom"
    pageTitle="Bancone"
  />
);

export default Bancone;
