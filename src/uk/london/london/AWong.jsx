...
const AWong = () => (
  <RestaurantPage
    restaurantName="A. Wong"
    address="70 Wilton Road, Victoria, London, SW1V 1DE, United Kingdom"
    cuisine="Chinese"
    priceRange="££££"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70%20Wilton%20Road%2C%20Victoria%2C%20London%2C%20SW1V%201DE%2C%20United%20Kingdom"
    pageTitle="A. Wong"
  />
);

export default AWong;
