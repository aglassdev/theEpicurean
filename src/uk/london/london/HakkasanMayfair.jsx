...
const HakkasanMayfair = () => (
  <RestaurantPage
    restaurantName="Hakkasan Mayfair"
    ...
    bio="This seductive subterranean spot beckons you in through its discreet entrance on Bruton Street, immediately transporting you to somewhere altogether more thrilling. The ground floor is great for lunchtime dim sum, but if you’re here for dinner ask for a table on the lower floor, which has a more energising atmosphere. The extensive menus feature a roll-call of luxury ingredients, from whole native lobster to black truffle roasted duck...."
    ...
    pageTitle="Hakkasan Mayfair"
  />
);

export default HakkasanMayfair;
