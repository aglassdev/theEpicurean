...
const Pippins = () => (
  <RestaurantPage
    restaurantName="Pippin's"
    address="1-15 Templeton Place, Earl's Court, London, SW5 9NB, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442075988700"
    website="https://www.pippinsrestaurant.com/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite being situated inside the Hotel Templeton Garden – which unsurprisingly comes with a large garden ideal for summer dining – there’s a welcome neighbourhood feel to this enthusiastically run restaurant. Its muted green and beige tones give the dining room a relaxing feel, while the menu focuses on British produce in well-crafted, tried-and-tested dishes. If you want to keep things simple go for the refined version of ‘chicken and chips’. The cosy Sprout Bar is ideal for a cocktail before or after eating...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-15%20Templeton%20Place%2C%20Earl's%20Court%2C%20London%2C%20SW5%209NB%2C%20United%20Kingdom"
    pageTitle="Pippin's"
  />
);

export default Pippins;
