...
const Akub = () => (
  <RestaurantPage
    restaurantName="Akub"
    address="27 Uxbridge Street, Notting Hill, London, W8 7TQ, United Kingdom"
    cuisine="International"
    priceRange="££"
    phoneNumber="+442077922472"
    website="https://www.akub-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the flowering thistle that’s also known as 'cardoon', Akub celebrates traditional Palestinian recipes, while simultaneously invigorating them with contemporary twists. The colours and intense flavours are particularly evident in sharing dishes like the ‘crunchy mansaf’, which consists of crispy golden parcels stuffed with rice and tender lamb shoulder. Everything is served in a bright, airy space situated on an equally colourful Notting Hill street. Accompany the food with wine from a list combining French favourites with options from Palestine and Jordan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20Uxbridge%20Street%2C%20Notting%20Hill%2C%20London%2C%20W8%207TQ%2C%20United%20Kingdom"
    pageTitle="Akub"
  />
);
