...
const Brutto = () => (
  <RestaurantPage
    restaurantName="Brutto"
    address="35-37 Greenhill Rents, Clerkenwell, London, EC1M 6BN, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    ...
    bio="You can’t help but have a great time at this wonderfully relaxed trattoria. With its gingham tablecloths and walls filled with a jumble of pictures, it's rather like stepping into nonna's house for a couple of hours. The place is perennially packed and it's easy to see why, with a terrific atmosphere accompanying the hearty, meat-centric dishes that never skimp on flavour, whether it's the dough ball ‘cuddles’ or the pork and fennel sausages. The signature negroni is as terrifically well-priced as the food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35-37%20Greenhill%20Rents%2C%20Clerkenwell%2C%20London%2C%20EC1M%206BN%2C%20United%20Kingdom"
    pageTitle="Brutto"
  />
);
