...
const Quaglinos = () => (
  <RestaurantPage
    restaurantName="Quaglino's"
    address="16 Bury Street, St James’s, London, SW1Y 6AJ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+442079306767"
    website="https://www.quaglinos-restaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This colourful, glamorous restaurant manages to be cavernous and cosy at the same time, with live music and a late night bar adding a certain sultriness to proceedings. The kitchen specialises in contemporary brasserie-style food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Bury%20Street%2C%20St%20James%E2%80%99s%2C%20London%2C%20SW1Y%206AJ%2C%20United%20Kingdom"
    pageTitle="Quaglino's"
  />
);

export default Quaglinos;
