...
const CorenucopiaByClareSmyth = () => (
  <RestaurantPage
    restaurantName="Corenucopia by Clare Smyth"
    address="18-22 Holbein Place, Belgravia, London, SW1W 8NL, United Kingdom"
    cuisine="Traditional British"
    priceRange="££££"
    phoneNumber="+442080165752"
    website="https://www.corenucopia.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With its thick cream carpets, neo-classical mouldings, mahogany tables and velvet upholstery, there’s a plush feel to this elegant restaurant from the renowned Clare Smyth. Her signature purity and precision are on display across a menu of refined and reinvented traditional British and French dishes. ‘Fish and chips’ is in fact Dover sole filled with lobster mousse, while the sherry trifle is a sweet, simple hit of nostalgia. As a side, choose from a wide selection of classic potato recipes, be it boulangère, dauphinoise or hasselback. A chic, cosy private dining room in the basement is perfect for a group of friends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18-22%20Holbein%20Place%2C%20Belgravia%2C%20London%2C%20SW1W%208NL%2C%20United%20Kingdom"
    pageTitle="Corenucopia by Clare Smyth"
  />
);

export default CorenucopiaByClareSmyth;
