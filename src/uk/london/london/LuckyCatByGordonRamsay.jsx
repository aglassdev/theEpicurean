...
const LuckyCatByGordonRamsay = () => (
  <RestaurantPage
    restaurantName="Lucky Cat by Gordon Ramsay"
    address="10 Grosvenor Square, Mayfair, London, W1K 6JP, United Kingdom"
    cuisine="Asian"
    priceRange="£££"
    phoneNumber="+442071070000"
    website="https://www.gordonramsayrestaurants.com/lucky-cat"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gordon Ramsay’s foray into Asian culture is a moody, masculine space in the former Maze, with a chef's table, a striking bar, a banging soundtrack and a fun feel. Accomplished Japanese and Chinese dishes blend British ingredients and are designed for sharing; the bonito fried duck leg bao is a must-try...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Grosvenor%20Square%2C%20Mayfair%2C%20London%2C%20W1K%206JP%2C%20United%20Kingdom"
    pageTitle="Lucky Cat by Gordon Ramsay"
  />
);

export default LuckyCatByGordonRamsay;
