...
const Ibai = () => (
  <RestaurantPage
    restaurantName="Ibai"
    address="90 Bartholomew Close, City of London, London, EC1A 7BN, United Kingdom"
    cuisine="Basque"
    priceRange="£££"
    phoneNumber="+442045973821"
    website="https://ibai.london/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Large, airy and with an industrial-chic vibe that perfectly matches the buzz of its open kitchen, there’s something quite cool about Ibai. Backed by one of the co-owners of Lurra and Donostia, it takes those restaurants’ love of Basque cooking and leans it further towards the region’s French influences. The signature ‘Croque Ibai’ is a prime example and a delicious pintxo to start your meal with. Quality ingredients are used throughout, treated with care and often cooked over fire. Wine enthusiasts will be impressed by the well-stocked cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=90%20Bartholomew%20Close%2C%20City%20of%20London%2C%20London%2C%20EC1A%207BN%2C%20United%20Kingdom"
    pageTitle="Ibai"
  />
);
