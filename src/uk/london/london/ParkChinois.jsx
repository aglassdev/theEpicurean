...
const ParkChinois = () => (
  <RestaurantPage
    restaurantName="Park Chinois"
    address="17 Berkeley Street, Mayfair, London, W1J 8EA, United Kingdom"
    cuisine="Chinese"
    priceRange="££££"
    phoneNumber="+442033278888"
    website="https://parkchinois.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are few more overtly opulent restaurants in London than Park Chinois. This is a place that revels in old-fashioned glamour, with its strikingly rich surroundings immediately making you feel like you're in for a special night out. Start with a bespoke cocktail in the gorgeous bar, before choosing between a range of menus that traverse the length and breadth of China. The midweek set lunch menu offers great value, while those with deep pockets can happily splash out on caviar and the delicious 'duck de chine'...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Berkeley%20Street%2C%20Mayfair%2C%20London%2C%20W1J%208EA%2C%20United%20Kingdom"
    pageTitle="Park Chinois"
  />
);

export default ParkChinois;
