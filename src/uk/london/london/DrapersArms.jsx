...
const DrapersArms = () => (
  <RestaurantPage
    restaurantName="Drapers Arms"
    address="44 Barnsbury Street, Islington, London, N1 1ER, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+442076190348"
    website="https://www.thedrapersarms.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stalwart of London's pub dining scene, Islington continues to be well-served by this imposing neighbourhood local. Not much has changed over the years and it's all the better for it; rustic décor, eager-to-please staff and a relaxed, unpretentious approach ensure the perfect pub atmosphere. The cooking is as hearty and satisfying as ever, but these days the traditionally British (steak & ale pie) sits alongside French influences (braised rabbit leg), courtesy of a Breton-born Chef. The courtyard garden is a great place to enjoy a glass from the superb wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=44%20Barnsbury%20Street%2C%20Islington%2C%20London%2C%20N1%201ER%2C%20United%20Kingdom"
    pageTitle="Drapers Arms"
  />
);

export default DrapersArms;
