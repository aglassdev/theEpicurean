...
const LaPalombe = () => (
  <RestaurantPage
    restaurantName="La Palombe"
    address="267 Kensington High Street, Kensington, London, W8 6NA, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+442076026777"
    website="https://www.lapalombe.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ideally located on Kensington High Street, this inviting bistro beckons you in with its friendly team and enticing menus. The soft pastel décor is studded with references to the colourful owner’s love of shooting, including framed lithographs of wild birds and deer antlers hanging on the ceiling – so it’s no surprise to find plenty of seasonal game on offer. Despite a few hints of tempered creativity, the cooking is classical French at its heart, with the likes of confit duck leg and Paris-Brest among the boldly flavoured dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=267%20Kensington%20High%20Street%2C%20Kensington%2C%20London%2C%20W8%206NA%2C%20United%20Kingdom"
    pageTitle="La Palombe"
  />
);

export default LaPalombe;
