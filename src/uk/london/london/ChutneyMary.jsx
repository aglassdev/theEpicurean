...
const ChutneyMary = () => (
  <RestaurantPage
    restaurantName="Chutney Mary"
    address="73 St James's Street, St James’s, London, SW1A 1PH, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+442076296688"
    website="https://www.chutneymary.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-standing, popular Indian restaurant comes from the same stable as Veeraswamy and Amaya, and its stylish dining room may be the jewel in the group’s crown. A certain luxury is to be expected when Buckingham Palace is just a short walk away, but there’s a relaxed, fashionable feel to the surroundings here too. The appealing menu offers lots of choice and the well-judged, flavourful dishes (mostly from northern India) have been subtly updated, while still respecting the foundations of the cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=73%20St%20James's%20Street%2C%20St%20James%E2%80%99s%2C%20London%2C%20SW1A%201PH%2C%20United%20Kingdom"
    pageTitle="Chutney Mary"
  />
);

export default ChutneyMary;
