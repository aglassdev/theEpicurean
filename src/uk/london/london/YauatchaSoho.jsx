...
const YauatchaSoho = () => (
  <RestaurantPage
    ...
    address="15 Broadwick Street, Soho, London, W1F 0DL, United Kingdom"
    cuisine="Chinese"
    priceRange="£££"
    phoneNumber="+442074948888"
    website="https://yauatcha.com/soho/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ground floor of this lively, contemporary Chinese restaurant features cabinets full of pastries and chocolates – but ask to sit in the more atmospheric basement, with its celestial ceiling lights, tropical fish tanks and glimpses into the busy kitchen. The extensive menu offers something for everyone, and over-ordering is easy to do...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Broadwick%20Street%2C%20Soho%2C%20London%2C%20W1F%200DL%2C%20United%20Kingdom"
    pageTitle="Yauatcha Soho"
  />
);

export default YauatchaSoho;
