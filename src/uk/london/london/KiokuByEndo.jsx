...
const KiokuByEndo = () => (
  <RestaurantPage
    restaurantName="Kioku by Endo"
    address="Raffles London at The OWO, 6th Floor, 2 Whitehall Place, Whitehall, London, SW1A 2BD, United Kingdom"
    cuisine="Japanese Contemporary, Mediterranean Cuisine"
    priceRange="££££"
    phoneNumber="+442033273692"
    website="https://kiokubyendo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy a cocktail or two in the elegant ground-floor bar before heading up to this restaurant at the top of the Raffles hotel inside the spectacular Old War Office. Superb city skyline views await you, while a seat on the terrace is a must in warmer weather. With a name meaning ‘memories’, the menu is inspired by Endo Kazutoshi’s life and career, with dishes that celebrate his Japanese heritage from a selection of nigiri to prime meats and fish cooked on the robata grill. For a special occasion, book the chef’s table or even the private room located in a turret...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Raffles%20London%20at%20The%20OWO%2C%206th%20Floor%2C%202%20Whitehall%20Place%2C%20Whitehall%2C%20London%2C%20SW1A%202BD%2C%20United%20Kingdom"
    pageTitle="Kioku by Endo"
  />
);

export default KiokuByEndo;
