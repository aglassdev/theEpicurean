...
const ImadsSyrianKitchen = () => (
  <RestaurantPage
    restaurantName="Imad's Syrian Kitchen"
    address="2.14-2.16 Kingly Court, Carnaby Street, Soho, London, W1B 5PW, United Kingdom"
    cuisine="Middle Eastern"
    priceRange="££"
    phoneNumber="+442074342448"
    website="https://www.imadssyriankitchen.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Affable Chef-Owner Imad was a restaurateur in Damascus before fleeing and settling in London, and his desire to provide and nourish is the motivating force behind his very likeable restaurant. Its move in 2023 to bigger premises at the top of Kingly Court was testament to its popularity. The appealing, great value menu focuses on Middle Eastern flavours; expect generous sharing dishes and plenty of lamb – the slow-cooked shoulder is particularly good, as is the hummus and falafel. The 'Express' weekday lunch is a steal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2.14-2.16%20Kingly%20Court%2C%20Carnaby%20Street%2C%20Soho%2C%20London%2C%20W1B%205PW%2C%20United%20Kingdom"
    pageTitle="Imad's Syrian Kitchen"
  />
);

export default ImadsSyrianKitchen;
