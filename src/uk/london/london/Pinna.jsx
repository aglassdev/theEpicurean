...
const Pinna = () => (
  <RestaurantPage
    restaurantName="Pinna"
    address="43 Curzon Street, Mayfair, London, W1J 7UF, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442081912782"
    website="https://www.pinnamayfair.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after its Sardinian chef Achille Pinna, this Mayfair Italian delivers a chic, elegant vibe and a lively atmosphere. The cooking is classic Italian to its very core, eschewing fuss or unnecessary invention in favour of traditional recipes. Think simply prepared fresh seafood followed by prime cuts and fish of the day, with stand-out pasta courses sandwiched in between – and it’s hard to overlook tiramisu or cannoli for dessert in a place like this. The welcoming team really know the meaning of good service, with nothing being too much trouble...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43%20Curzon%20Street%2C%20Mayfair%2C%20London%2C%20W1J%207UF%2C%20United%20Kingdom"
    pageTitle="Pinna"
  />
);
