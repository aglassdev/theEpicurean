...
const Planque = () => (
  <RestaurantPage
    restaurantName="Planque"
    address="322-324 Acton Mews, Dalston, London, E8 4EA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442072543414"
    website="https://planque.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set under two railway arches, this boldly styled restaurant is centred around a huge communal table. Listed in size order, the modern British dishes are far more complex than they first appear and show tremendous skill from the kitchen. They are often comprised of three main ingredients, all working in perfect harmony to achieve a great balance of flavours: succulent guinea fowl, for example, might be complemented by earthy Jerusalem artichoke and a hint of bitterness from radicchio. The interesting wine list has an emphasis on small-scale and low-intervention producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=322-324%20Acton%20Mews%2C%20Dalston%2C%20London%2C%20E8%204EA%2C%20United%20Kingdom"
    pageTitle="Planque"
  />
);
