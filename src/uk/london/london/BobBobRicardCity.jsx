...
const BobBobRicardCity = () => (
  <RestaurantPage
    restaurantName="Bob Bob Ricard City"
    address="Level 3, 122 Leadenhall Street, City of London, London, EC3V 4AB, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+442031451000"
    website="https://bobbobricard.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A younger yet bigger sibling to the iconic Soho original, this brasserie with bling sits on the third floor of the financial district's 'Cheesegrater' building. Ostentatious in all the best ways, it's a room dressed to impress with a menu ideal for splashing out and celebrating. An assortment of caviar and oysters sets the tone, before a wide choice of classically luxurious dishes from chicken and champagne pie to a range of steaks cooked on the Josper grill. And don't worry, just like the original, there's a 'Press for Champagne' button here too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%203%2C%20122%20Leadenhall%20Street%2C%20City%20of%20London%2C%20London%2C%20EC3V%204AB%2C%20United%20Kingdom"
    pageTitle="Bob Bob Ricard City"
  />
);

export default BobBobRicardCity;
