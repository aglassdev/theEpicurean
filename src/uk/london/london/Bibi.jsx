...
const Bibi = () => (
  <RestaurantPage
    restaurantName="BiBi"
    address="42 North Audley Street, Mayfair, London, W1K 6ZP, United Kingdom"
    cuisine="Indian"
    priceRange="££££"
    phoneNumber="+442037807310"
    website="https://www.bibirestaurants.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The two evening tasting menus at Chet Sharma's buzzy Mayfair restaurant are named after his grandmothers (bibis), Kamal and Ranjana, and a family influence can be felt right across his interesting Indian cooking. Dishes like Sharmaji's Lahori Chicken – using a recipe passed down from Chet's grandfather – are well-spiced and deliver on flavour, with punchy accompaniments like red pepper pickle used to pep things up. Sitting at the counter will add something to the experience, while the charming service and smooth pacing make everything more enjoyable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%20North%20Audley%20Street%2C%20Mayfair%2C%20London%2C%20W1K%206ZP%2C%20United%20Kingdom"
    pageTitle="BiBi"
  />
);
