...
const TheClarenceTavern = () => (
  <RestaurantPage
    restaurantName="The Clarence Tavern"
    address="102 Stoke Newington Church Street, London, N16 0LA, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+442087121188"
    website="https://www.clarencetavern.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A classic Victorian-era London pub, The Clarence Tavern comes with a real characterful charm, courtesy of its 19th-century architecture fused with more contemporary details. Head past the bar to the part-panelled, part-brick dining area, where the doors open out onto a courtyard terrace. Many of the boldly flavoured dishes come from the pub classics school – like chicken, leek and bacon pie to share – and arrive in pleasingly gutsy portions. Try one of the natural wines and be sure to visit the deli before you leave...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=102%20Stoke%20Newington%20Church%20Street%2C%20London%2C%20N16%200LA%2C%20United%20Kingdom"
    pageTitle="The Clarence Tavern"
  />
);

export default TheClarenceTavern;
