...
const Bellanger = () => (
  <RestaurantPage
    restaurantName="Bellanger"
    address="9 Islington Green, Islington, London, N1 2XH, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+442074996776"
    website="https://bellanger.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With awnings stretching over the pavement and walls festooned with classic posters, Bellanger has the feel of a Parisian grand café. The cooking, however, looks more broadly to the Mediterranean for inspiration; the Italian influences are clear, with dishes such as chicken Milanese sitting alongside the ubiquitous French classics like steak frites. The vibe is very much that of a neighbourhood restaurant, despite a well-organised formality to the service, and the large cocktail bar is perfect for an aperitif...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Islington%20Green%2C%20Islington%2C%20London%2C%20N1%202XH%2C%20United%20Kingdom"
    pageTitle="Bellanger"
  />
);

export default Bellanger;
