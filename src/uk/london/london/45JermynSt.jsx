...
const FourFiveJermynSt = () => (
  <RestaurantPage
    restaurantName="45 Jermyn St"
    address="45 Jermyn Street, St James’s, London, SW1 6DN, United Kingdom"
    cuisine="Traditional British"
    priceRange="£££"
    phoneNumber="+442072054545"
    website="https://45jermynst.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Style and comfort go hand in hand at this bright, contemporary brasserie that delivers the classics with aplomb. The menu is a mix of European and British dishes, with the beef Wellington and lobster spaghetti both finished off at your table, while coupes and floats for dessert bring an old-school touch and pay tribute to its past as Fortnum’s Fountain restaurant. Slick service and the undeniably luxurious surroundings make a visit even more appealing, as does the extensive cocktail menu, which is well worth exploring...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45%20Jermyn%20Street%2C%20St%20James%E2%80%99s%2C%20London%2C%20SW1%206DN%2C%20United%20Kingdom"
    pageTitle="45 Jermyn St"
  />
);

export default FourFiveJermynSt;
