...
const Noiz = () => (
  <RestaurantPage
    restaurantName="Noizé"
    address="39 Whitfield Street, Fitzrovia, London, W1T 2SF, United Kingdom"
    cuisine="Modern French"
    priceRange="£££"
    phoneNumber="+442073231310"
    website="https://www.noize-restaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightfully relaxed French restaurant, personally run by a warm and welcoming owner. The menu features a mix of classic and more modern French food, prepared with love and care. The wine list – with plenty of depth and fair mark-ups – is a highlight, as are the cheeses and desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Whitfield%20Street%2C%20Fitzrovia%2C%20London%2C%20W1T%202SF%2C%20United%20Kingdom"
    pageTitle="Noizé"
  />
);
