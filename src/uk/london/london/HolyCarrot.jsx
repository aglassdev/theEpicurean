...
const HolyCarrot = () => (
  <RestaurantPage
    restaurantName="Holy Carrot"
    address="156 Portobello Road, Notting Hill, London, W11 2EB, United Kingdom"
    cuisine="Vegan"
    priceRange="££"
    phoneNumber="+442045801425"
    website="https://www.holycarrot.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="London’s constantly expanding vegan food scene received another boost when this former pop-up and supper club opened up permanently on Portobello Road. It’s the ideal place for convincing your carnivorous friends of the virtues of plant-based cuisine, as each dish bursts with colour and creativity. The ‘small’ and ‘large’ plates are best shared to sample the broad range of cooking techniques, from barbecued carrot to coal-roasted leeks. The dining room itself – filled with polished concrete and light Mediterranean colours – provides a soothing backdrop that enhances the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=156%20Portobello%20Road%2C%20Notting%20Hill%2C%20London%2C%20W11%202EB%2C%20United%20Kingdom"
    pageTitle="Holy Carrot"
  />
);

export default HolyCarrot;
