...
const ThePem = () => (
  <RestaurantPage
    restaurantName="The Pem"
    address="22-28 Broadway, Whitehall, London, SW1H 0BH, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442033018080"
    website="https://thepemrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the elegant surroundings of the Conrad London St. James Hotel, The Pem is named after suffragette Emily Wilding Davison's nickname. The cooking is largely British in inspiration, using produce like Porthilly oysters and Cotswold venison, in dishes that are contemporary in style and accomplished in technique – such as crisp red mullet with a powerful tomato, red pepper and pine nut sauce. Ask the personable sommelier for recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=22-28%20Broadway%2C%20Whitehall%2C%20London%2C%20SW1H%200BH%2C%20United%20Kingdom"
    pageTitle="The Pem"
  />
);

export default ThePem;
