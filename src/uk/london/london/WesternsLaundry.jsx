...
const WesternsLaundry = () => (
  <RestaurantPage
    restaurantName="Westerns Laundry"
    address="34 Drayton Park, Holloway, London, N5 1PB, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442077003700"
    website="https://www.westernslaundry.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a whole lot to enjoy from the daily blackboard menus at this relaxed, understated operation. Both the décor and the cooking have a rustic edge to them, with the latter British-based, seafood-centric and guided by the seasons. Both individual and communal seating are available to enjoy the flavoursome dishes from, as is the kitchen counter, while the attentive team deal well with the buzz of a permanently busy restaurant. Quality sourdough is provided by their sister operation Jolene and while other dishes may come and go, the rum baba remains a constant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=34%20Drayton%20Park%2C%20Holloway%2C%20London%2C%20N5%201PB%2C%20United%20Kingdom"
    pageTitle="Westerns Laundry"
  />
);

export default WesternsLaundry;
