...
const TheVictoriaLON = () => (
  <RestaurantPage
    restaurantName="The Victoria"
    address="10 West Temple Sheen, Richmond, London, SW14 7RT, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442088764238"
    website="https://victoriasheen.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its Sunday lunches, quiz nights and sensible prices, this remains a proper neighbourhood pub – albeit in a very smart neighbourhood. There's a pleasantly lived-in feel to the place; if you're here to eat, head for the conservatory which overlooks the terrace. The appealing menu mixes steaks and pubby favourites like fish & chips with a good range of Mediterranean-influenced dishes such as grilled sardines with caponata. Do try the apple cake for dessert, which is Polish Chef Damian's take on his mother's recipe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20West%20Temple%20Sheen%2C%20Richmond%2C%20London%2C%20SW14%207RT%2C%20United%20Kingdom"
    pageTitle="The Victoria"
  />
);

export default TheVictoriaLON;
