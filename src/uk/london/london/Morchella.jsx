...
const Morchella = () => (
  <RestaurantPage
    restaurantName="Morchella"
    address="84-86 Rosebery Avenue, Islington, London, EC1R 4QY, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+442079160492"
    website="https://www.morchelladining.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a converted former bank, Morchella sports a small but well-stocked wine bar to one side, offering largely natural and biodynamic options that the wine list describes as either ‘Classic’, ‘Coastal’ or ‘Funky’. On the food side of things, the menu has a Mediterranean slant and is designed for sharing – although if the spaghetti alle vongole is available, you’ll be loath to give any up. Service is bright and breezy, while the great value lunch menu means you can dine without breaking the bank, so to speak...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=84-86%20Rosebery%20Avenue%2C%20Islington%2C%20London%2C%20EC1R%204QY%2C%20United%20Kingdom"
    pageTitle="Morchella"
  />
);

export default Morchella;
