...
const WildHoneyStJames = () => (
  <RestaurantPage
    restaurantName="Wild Honey St James"
    ...
    pageTitle="Wild Honey St James"
  />
);

export default WildHoneyStJames;
