...
const BobBobRicardSoho = () => (
  <RestaurantPage
    restaurantName="Bob Bob Ricard Soho"
    address="1-3 Upper James Street, Soho, London, W1F 9DF, United Kingdom"
    ...
    bio="Any restaurant known for its tableside 'Press for Champagne' buttons is bound to exude a certain glamorous exclusivity. So it is with Bob Bob Ricard, a compact yet nevertheless grand restaurant that's classic to its core and all the more appealing for it; this is the place to come if you're looking to impress a date in the old-school manner. The menu opens with vodka shots at -18° along with a choice of caviars – a clue as to the owner’s nationality – then moves on to a roll-call of well-loved dishes from sole meunière to beef Wellington to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3%20Upper%20James%20Street%2C%20Soho%2C%20London%2C%20W1F%209DF%2C%20United%20Kingdom"
    pageTitle="Bob Bob Ricard Soho"
  />
);

export default BobBobRicardSoho;
