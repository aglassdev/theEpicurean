...
const MimiMeiFairLON = () => (
  <RestaurantPage
    restaurantName="MiMi Mei Fair"
    address="55 Curzon Street, Mayfair, London, W1J 8PG, United Kingdom"
    cuisine="Chinese"
    priceRange="££££"
    phoneNumber="+442039897777"
    website="https://mimimeifair.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An opulent Georgian Townhouse whose décor takes its inspiration from early 20C Chinese interiors. Sit in one of the ground floor booths or in the brighter first floor 'Parlour'. The wide-ranging menu offers classic Chinese dishes; wood-fire roasted Peking Duck is the specialty and sharing is encouraged...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=55%20Curzon%20Street%2C%20Mayfair%2C%20London%2C%20W1J%208PG%2C%20United%20Kingdom"
    pageTitle="MiMi Mei Fair"
  />
);

export default MimiMeiFairLON;
