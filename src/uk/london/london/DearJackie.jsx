...
const DearJackie = () => (
  <RestaurantPage
    restaurantName="Dear Jackie"
    address="20 Broadwick Street, Soho, London, W1F 8HT, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442070474000"
    website="https://www.broadwicksoho.com/dear-jackie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Broadwick Soho is one of the cooler hotels to have opened in recent years and its restaurant is no different. Named after the founder's mother, it's a stylish spot that, while located in the basement, benefits from plenty of pops of colour – from the silks on the wall to the painted plates and Murano glass – more than making up for any natural light deficiency. It’s also an intimate and seductive space, perfect for date night. The Italian fare is ingredient led, with dishes such as scallop with champagne sauce and trout roe proving to be as pretty as they are delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20%20Broadwick%20Street%2C%20Soho%2C%20London%2C%20W1F%208HT%2C%20United%20Kingdom"
    pageTitle="Dear Jackie"
  />
);

export default DearJackie;
