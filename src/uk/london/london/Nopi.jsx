...
const Nopi = () => (
  <RestaurantPage
    restaurantName="Nopi"
    address="21-22 Warwick Street, Soho, London, W1B 5NE, United Kingdom"
    cuisine="World Cuisine"
    priceRange="£££"
    phoneNumber="+442074949584"
    website="https://ottolenghi.co.uk/restaurants/nopi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's not just fans of Yotam Ottolenghi and his cookbooks who have made his Soho restaurant so successful. The menu has something for everyone, featuring an array of flavoursome and colourful dishes, with influences from the Middle East, Mediterranean and across Asia. You can go for your own main course, like sea bass with coconut sauce Véronique, or share a few dishes, such as crispy mushrooms with basil aioli or succulent soy-glazed pork belly with pear mostarda. The room is bright and animated – and if you opt for one of the shared tables downstairs you can watch the kitchen team in action...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21-22%20Warwick%20Street%2C%20Soho%2C%20London%2C%20W1B%205NE%2C%20United%20Kingdom"
    pageTitle="Nopi"
  />
);
