...
const SamsRiverside = () => (
  <RestaurantPage
    restaurantName="Sam's Riverside"
    address="1 Crisp Walk, Hammersmith, London, W6 9DN, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442082371020"
    website="https://samsriverside.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Experienced restaurateur Sam Harrison is behind this modern riverside brasserie beside Hammersmith Bridge. It's an enduringly popular place and you can see why from the appealing, pleasingly varied menu that might incorporate a range of influences but doesn't lose sight of the flavour gained by using quality produce. British ingredients from land and sea are cooked with precision and there's a whole section of the menu for oysters and other shellfish. Stock up on provisions at Sam’s Larder before you leave...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Crisp%20Walk%2C%20Hammersmith%2C%20London%2C%20W6%209DN%2C%20United%20Kingdom"
    pageTitle="Sam's Riverside"
  />
);

export default SamsRiverside;
