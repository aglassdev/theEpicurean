...
const SixFourGoodgeStreet = () => (
  <RestaurantPage
    restaurantName="64 Goodge Street"
    address="64 Goodge Street, Fitzrovia, London, W1T 4NF, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+442037476364"
    website="https://64goodgestreet.co.uk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sister restaurant to Portland and Clipstone, this small bistro deluxe delivers intimate, relaxed surroundings in which to enjoy a menu based around classical French cooking. British Racing Green walls blend with simple polished wood, candle-lit tables and wicker chairs, while the semi-open kitchen brings a livelier atmosphere to one end of the room. Fine ingredients are used to excellent effect in bold, gutsy combinations that deliver simply delicious results; ensure you save room to finish with the greengage Tatin or the textbook Paris-Brest. Wine connoisseurs should look out for the 'Cellar List' and its many gems...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=64%20Goodge%20Street%2C%20Fitzrovia%2C%20London%2C%20W1T%204NF%2C%20United%20Kingdom"
    pageTitle="64 Goodge Street"
  />
);

export default SixFourGoodgeStreet;
