...
const TheGrillAtTheDorchester = () => (
  <RestaurantPage
    restaurantName="The Grill at The Dorchester"
    address="The Dorchester Hotel, 53 Park Lane, Mayfair, London, W1K 1QA, United Kingdom"
    cuisine="British Contemporary"
    priceRange="£££"
    phoneNumber="+442076298888"
    website="https://www.dorchestercollection.com/london/the-dorchester/dining/the-grill-at-the-dorchester"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Grill at The Dorchester Hotel might be carrying a name loaded with history, but that’s no indication of the look or the food. Bright, modern décor and a formal team make you feel cossetted, while the ornate ceiling is something of a talking point. The cooking mixes classical flavours with modern techniques, on a menu that features luxury dishes to share like skate wing, rib-eye steak and 'all the chicken'. The set lunch menu offers value for money and they list some unusual wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Dorchester%20Hotel%2C%2053%20Park%20Lane%2C%20Mayfair%2C%20London%2C%20W1K%201QA%2C%20United%20Kingdom"
    pageTitle="The Grill at The Dorchester"
  />
);

export default TheGrillAtTheDorchester;
