...
const PavyllonLondon = () => (
  <RestaurantPage
    restaurantName="Pavyllon London"
    address="Four Seasons Hotel, Hamilton Place, Mayfair, London, W1J 7DR, United Kingdom"
    cuisine="French Contemporary"
    priceRange="££££"
    phoneNumber="+442073195200"
    website="https://www.pavyllonlondon.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Yannick Alléno's place among the pantheon of great French chefs is assured, and the Four Seasons in Mayfair was the chosen venue for his first foray into the UK’s dining scene. It’s a smart, spacious dining room, with lots of natural light and a focus on comfort – the large open kitchen, which is led by Chef Benjamin Ferra Y Castell, is skirted by a luxurious counter for those wanting a close-up view. The food is underscored by classic French recipes, but influences can range from Italy to North Africa to Japan. Ingredients are naturally from the luxury side of the ledger and set menus are the best way to go...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Four%20Seasons%20Hotel%2C%20Hamilton%20Place%2C%20Mayfair%2C%20London%2C%20W1J%207DR%2C%20United%20Kingdom"
    pageTitle="Pavyllon London"
  />
);

export default PavyllonLondon;
