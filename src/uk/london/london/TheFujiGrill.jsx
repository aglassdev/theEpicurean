...
const TheFujiGrill = () => (
  <RestaurantPage
    restaurantName="The Fuji Grill"
    address="115 Sloane Street, Belgravia, London, SW1X 9PJ, United Kingdom"
    cuisine="Japanese"
    priceRange="££££"
    phoneNumber="+442039886611"
    website="https://www.beaverbrooktownhouse.co.uk/the-fuji-grill-sushi-bar/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The discreetly stylish Beaverbrook Town House is home to this warm, elegant restaurant that’s something of a hidden gem. The framed Japanese prints on the walls and lacquered furniture help make it a lovely place to dine, while there’s plenty to entice on the wide choice of menus, from a full omakase – which should naturally be enjoyed at the counter – to bento box deals and an extensive à la carte featuring skilfully made nigiri. A good sake selection adds to the authentic Japanese appeal – albeit inside an English townhouse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=115%20Sloane%20Street%2C%20Belgravia%2C%20London%2C%20SW1X%209PJ%2C%20United%20Kingdom"
    pageTitle="The Fuji Grill"
  />
);

export default TheFujiGrill;
