...
const CitySocialLON = () => (
  <RestaurantPage
    restaurantName="City Social"
    address="Tower 42, 25 Old Broad Street, City of London, London, EC2N 1HQ, United Kingdom"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="£££"
    phoneNumber="+442078777703"
    website="https://www.citysocial-london.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The buzz from the bar is the first thing you notice at Jason Atherton’s handsome restaurant on the 24th floor of Tower 42. Dark and moody, with a subtle art deco twist, it boasts impressive views of the City skyline. The menu of generous modern European dishes includes multiple cuts of Cumbrian beef cooked on the Josper grill, from rib-eye to sirloin. The wine list offers an appealing mixture of prices and styles, and there are noteworthy cocktails too...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tower%2042%2C%2025%20Old%20Broad%20Street%2C%20City%20of%20London%2C%20London%2C%20EC2N%201HQ%2C%20United%20Kingdom"
    pageTitle="City Social"
  />
);

export default CitySocialLON;
