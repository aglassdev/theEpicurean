...
const LePontDeLaTour = () => (
  <RestaurantPage
    restaurantName="Le Pont de la Tour"
    address="36d Shad Thames, Butlers Wharf, London, SE1 2YE, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+442074038403"
    website="https://www.lepontdelatour.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Few restaurants in London can claim to have a better location than this. For over 30 years, Le Pont de la Tour has been wowing diners with its jaw-dropping views of Tower Bridge, best appreciated from the terrace on a warm summer's day. The restaurant itself, as the name suggests, is thoroughly French at heart: expect confidently executed classics from ratatouille Niçoise to gratin Normande. The carefully chosen wine list offers a broad and interesting selection, of both the classic and the esoteric varieties...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=36d%20Shad%20Thames%2C%20Butlers%20Wharf%2C%20London%2C%20SE1%202YE%2C%20United%20Kingdom"
    pageTitle="Le Pont de la Tour"
  />
);

export default LePontDeLaTour;
