...
const Lima = () => (
  <RestaurantPage
    restaurantName="Lima"
    address="31 Rathbone Place, Fitzrovia, London, W1T 1JH, United Kingdom"
    cuisine="Peruvian"
    priceRange="£££"
    phoneNumber="+442030022640"
    website="https://www.limalondon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lima is one of those restaurants that just makes you feel good about life – and that’s even without the pisco sours. The Peruvian food at this informal, fun place is the ideal antidote to times of austerity: it’s full of punchy, invigorating flavours and fantastically vivid colours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20Rathbone%20Place%2C%20Fitzrovia%2C%20London%2C%20W1T%201JH%2C%20United%20Kingdom"
    pageTitle="Lima"
  />
);
