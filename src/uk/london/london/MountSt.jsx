...
const MountSt = () => (
  <RestaurantPage
    restaurantName="Mount St."
    address="First Floor, 41-43 Mount Street, Mayfair, London, W1K 2RX, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442038409860"
    website="https://mountstrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s nothing anodyne about the art in this particular restaurant, which is hardly a surprise when you discover that art gallery group Hauser & Wirth are behind it. It’s a striking room with a stunning collection of pieces, from Matisse to Man Ray. The menu offers satisfying, classic British dishes like omelette Arnold Bennett and others inspired by the capital, such as ‘Pigeons in Pimlico’. If you’re early, you can always nip into The Audley pub downstairs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=First%20Floor%2C%2041-43%20Mount%20Street%2C%20Mayfair%2C%20London%2C%20W1K%202RX%2C%20United%20Kingdom"
    pageTitle="Mount St."
  />
);

export default MountSt;
