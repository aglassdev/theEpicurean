...
const SixPortlandRoad = () => (
  <RestaurantPage
    restaurantName="Six Portland Road"
    address="6 Portland Road, Holland Park, London, W11 4LA, United Kingdom"
    cuisine="European"
    priceRange="£££"
    phoneNumber="+442072293130"
    website="https://sixportlandroad.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away off Holland Park Avenue, this intimate neighbourhood bistro is sure to become one of your favourite haunts. The concise European menu changes according to the ingredients available and dishes are robust, skilfully constructed and easy-to-eat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Portland%20Road%2C%20Holland%20Park%2C%20London%2C%20W11%204LA%2C%20United%20Kingdom"
    pageTitle="Six Portland Road"
  />
);

export default SixPortlandRoad;
