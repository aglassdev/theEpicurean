...
const Lorne = () => (
  <RestaurantPage
    restaurantName="Lorne"
    address="76 Wilton Road, Victoria, London, SW1V 1DE, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+442033270210"
    website="https://www.lornerestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They keep things honest at this narrow little restaurant and you can see the pay-off: a dining room full of happy customers, who are a mix of locals, tourists and business types. Staff are on the ball and well-versed on the menu, while the classically trained kitchen sends forth reliable and consistently good dishes, like Cornish cod with smoked eel, and chocolate delice with cookie crumble. The lunch and early evening menus are very good value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=76%20Wilton%20Road%2C%20Victoria%2C%20London%2C%20SW1V%201DE%2C%20United%20Kingdom"
    pageTitle="Lorne"
  />
);

export default Lorne;
