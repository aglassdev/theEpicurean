...
const Mountain = () => (
  <RestaurantPage
    restaurantName="Mountain"
    address="16-18 Beak Street, Soho, London, W1F 9RD, United Kingdom"
    cuisine="Spanish"
    priceRange="£££"
    phoneNumber=""
    ...
    bio="It’s all about delicious natural flavours at this fun Soho spot, which comes courtesy of the people behind Brat. It’s a large operation split over two levels; the basement booths can offer intimacy but the ground floor has the buzz around the open kitchen. The lengthy menu includes dishes that are ideal for sharing and vary in size, from snacks like sweet raw red prawns with house-made stracciatella to whole lobster caldereta for up to five people. Open flames and a wood-fired oven add wonderfully smoky flavours and you’ll leave still licking your lips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16-18%20Beak%20Street%2C%20Soho%2C%20London%2C%20W1F%209RD%2C%20United%20Kingdom"
    pageTitle="Mountain"
  />
);
