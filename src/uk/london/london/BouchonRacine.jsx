...
const BouchonRacine = () => (
  <RestaurantPage
    restaurantName="Bouchon Racine"
    address="66 Cowcross Street, Clerkenwell, London, EC1M 6BP, United Kingdom"
    cuisine="French"
    priceRange="££"
    phoneNumber="+442072533368"
    website="https://www.bouchonracine.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Those with fond memories of the original Racine in Knightsbridge rejoiced when chef Henry Harris opened a new version in 2022. Racine Mark II is just a few steps from Farringdon Station, located above the Three Compasses pub. The blackboard menu is a veritable rollcall of classic French bistro dishes, from escargots to rabbit, duck confit to steak tartare. There are so many tempting dishes; just be sure to end with the terrific crème caramel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=66%20Cowcross%20Street%2C%20Clerkenwell%2C%20London%2C%20EC1M%206BP%2C%20United%20Kingdom"
    pageTitle="Bouchon Racine"
  />
);

export default BouchonRacine;
