...
const AquaShard = () => (
  <RestaurantPage
    restaurantName="Aqua Shard"
    address="Level 31, The Shard, 31 St. Thomas Street, Southwark, London, SE1 9RY, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+442030111256"
    website="https://aquashard.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you’re dining in the UK’s tallest building, you expect a good view – and Aqua Shard certainly delivers. Perched 31 floors above ground, which is somehow less than halfway up the building, its huge windows provide a stunning vantage point over the city. The cooking lives up to the surroundings, spotlighting quality ingredients and wisely putting nothing superfluous on the plate – the duck breast with sour cherry sauce will leave you licking your lips. Genial service adds to the enjoyment of a unique experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%2031%2C%20The%20Shard%2C%2031%20St.%20Thomas%20Street%2C%20Southwark%2C%20London%2C%20SE1%209RY%2C%20United%20Kingdom"
    pageTitle="Aqua Shard"
  />
);

export default AquaShard;
