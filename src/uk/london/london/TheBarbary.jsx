...
const TheBarbary = () => (
  <RestaurantPage
    restaurantName="The Barbary"
    address="16 Neal’s Yard, Covent Garden, London, WC2H 9DP, United Kingdom"
    cuisine="North African, Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+442078705659"
    website="https://thebarbary.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fire-centric cooking of our ancestors provides much of the inspiration for this moody yet charming restaurant tucked away in Neal's Yard. All guests cosy up at the zinc-topped counter, gathered round a robata grill and a tandoor clay oven. The smoky treatment is given to ingredients from octopus to cauliflower, while the accompanying flavours are influenced, unsurprisingly, by the former Barbary Coast – so expect the likes of dukkah, harissa and zhoug to make an appearance during your visit. The counter seats just 24, but the compact layout adds to the atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Neal%E2%80%99s%20Yard%2C%20Covent%20Garden%2C%20London%2C%20WC2H%209DP%2C%20United%20Kingdom"
    pageTitle="The Barbary"
  />
);

export default TheBarbary;
