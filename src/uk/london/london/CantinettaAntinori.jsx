...
const CantinettaAntinori = () => (
  <RestaurantPage
    restaurantName="Cantinetta Antinori"
    address="4 Harriet Street, Belgravia, London, SW1X 9JR, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442045801354"
    website="https://cantinetta-antinori.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Antinori family have owned vineyards in Tuscany since the 12C, producing their own world-renowned red wine, as well as having a hand in numerous other estates. It should come as no surprise, then, that the wine list here is something to behold. It’s joined by classic Italian cooking, pairing a notable simplicity with plenty of Tuscan ingredients and rich, hearty flavours. The delicious torta caprese is a wonderful way to round out your visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20Harriet%20Street%2C%20Belgravia%2C%20London%2C%20SW1X%209JR%2C%20United%20Kingdom"
    pageTitle="Cantinetta Antinori"
  />
);

export default CantinettaAntinori;
