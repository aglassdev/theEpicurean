...
const AlainDucasseAtTheDorchester = () => (
  <RestaurantPage
    restaurantName="Alain Ducasse at The Dorchester"
    ...
    pageTitle="Alain Ducasse at The Dorchester"
  />
);
