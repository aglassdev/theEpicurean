...
const Manteca = () => (
  <RestaurantPage
    ...
    address="49-51 Curtain Road, Shoreditch, London, EC2A 3PT, United Kingdom"
    cuisine="Italian"
    priceRange="££"
    ...
    bio="Certain restaurants make you feel like you’ve made the right decision as soon as you walk in the door – and manteca is one of them. It’s always busy, always full of life and always run with a calm confidence that allows everyone to relax. The Italian menu is also something that’ll always excite; its dishes are designed for sharing and every one of them comes with flavour turned up to the max, whether it’s the whole wood-roasted John Dory, the ’nduja steamed mussels, or the malloreddus with pork and fennel ragu. Be sure to check out their in-house pasta workshop and their salumeria...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49-51%20Curtain%20Road%2C%20Shoreditch%2C%20London%2C%20EC2A%203PT%2C%20United%20Kingdom"
    pageTitle="manteca"
  />
);
