...
const SketchTheGallery = () => (
  <RestaurantPage
    restaurantName="Sketch, The Gallery"
    ...
    pageTitle="Sketch, The Gallery"
  />
);

export default SketchTheGallery;
