...
const Krokodilos = () => (
  <RestaurantPage
    restaurantName="Krokodilos"
    address="Lancer Square, 28A Kensington Church Street, Kensington, London, W8 4EP, United Kingdom"
    cuisine="Greek"
    priceRange="£££"
    phoneNumber="+442081912783"
    website="https://www.krokodilos.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lancer%20Square%2C%2028A%20Kensington%20Church%20Street%2C%20Kensington%2C%20London%2C%20W8%204EP%2C%20United%20Kingdom"
    pageTitle="Krokodilos"
  />
);

export default Krokodilos;
