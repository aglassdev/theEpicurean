...
const TheParakeet = () => (
  <RestaurantPage
    restaurantName="The Parakeet"
    address="256 Kentish Town Road, London, NW5 2AA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442045996302"
    website="https://theparakeetpub.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Kentish Town sits this warm and characterful pub, with its roots in the 19th century. The large bar dominates the front area and leads into the equally appealing dining room, complete with open kitchen. Wood-fired grilling is the house speciality and adds an appealing smokiness to much of the menu. Several of the dishes are designed for sharing, like mutton pie or sea bream with piperade; do start with the potato bread with smoked butter and the duck tartlets. There’s also a well-priced selection of great wine by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=256%20Kentish%20Town%20Road%2C%20London%2C%20NW5%202AA%2C%20United%20Kingdom"
    pageTitle="The Parakeet"
  />
);

export default TheParakeet;
