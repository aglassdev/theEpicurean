...
const BombayBustle = () => (
  <RestaurantPage
    restaurantName="Bombay Bustle"
    address="29 Maddox Street, Mayfair, London, W1S 2PA, United Kingdom"
    cuisine="Indian"
    priceRange="££"
    phoneNumber="+442072904470"
    website="https://bombaybustle.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Maddox%20Street%2C%20Mayfair%2C%20London%2C%20W1S%202PA%2C%20United%20Kingdom"
    pageTitle="Bombay Bustle"
  />
);

export default BombayBustle;
