...
const SucreLON = () => (
  <RestaurantPage
    ...
    address="47B Great Marlborough Street, Soho, London, W1F 7JP, United Kingdom"
    cuisine="Latin American, European Contemporary"
    priceRange="£££"
    phoneNumber="+442039883329"
    website="https://www.sucrerestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="20 years after opening in Buenos Aires, Argentinian chef-restaurateur Fernando Trocca opened this buzzy restaurant in an attractive former concert hall in London. Contemporary Latin American inspired dishes are cooked over the open fire of the parrilla. Start with a drink in the moody basement bar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47B%20Great%20Marlborough%20Street%2C%20Soho%2C%20London%2C%20W1F%207JP%2C%20United%20Kingdom"
    pageTitle="Sucre"
  />
);

export default SucreLON;
