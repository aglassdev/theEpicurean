...
const SilverBirch = () => (
  <RestaurantPage
    restaurantName="Silver Birch"
    address="142 Chiswick High Road, Chiswick, London, W4 1PU, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+442081597176"
    website="https://silverbirchchiswick.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Among the numerous eateries on bustling Chiswick High Street, Silver Birch stands out – thanks to its appealing dishes that celebrate the wonderful ingredients we produce in the British Isles, whether that be meaty smoked eel from Devon, sweet scallops from the Isle of Mull, creamy Shetland cod or superb Lancashire fruit. There’s also a good choice of sensibly priced wines by the glass or carafe to accompany these seasonal dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=142%20Chiswick%20High%20Road%2C%20Chiswick%2C%20London%2C%20W4%201PU%2C%20United%20Kingdom"
    pageTitle="Silver Birch"
  />
);

export default SilverBirch;
