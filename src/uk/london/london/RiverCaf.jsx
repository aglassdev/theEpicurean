...
const RiverCaf = () => (
  <RestaurantPage
    restaurantName="River Café"
    address="Thames Wharf, Rainville Road, Hammersmith, London, W6 9HA, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    ...
    bio="It should go without saying, but be sure to ask for a seat on the terrace at this icon of London's Italian restaurant scene. The on-view kitchen with its wood-fired oven dominates the stylish and buzzing riverside room and the menu bursts with authentic Italian flavours which make one’s mouth water in anticipation. The honest, hearty dishes have a rustic Italian simplicity, relying as they do on the quality of their ingredients, whether that be clams, crab or wild sea bass. Arguably the best Italian wine list in London is the icing on the cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Thames%20Wharf%2C%20Rainville%20Road%2C%20Hammersmith%2C%20London%2C%20W6%209HA%2C%20United%20Kingdom"
    pageTitle="River Café"
  />
);

export default RiverCaf;
