...
const NanyangBlossom = () => (
  <RestaurantPage
    restaurantName="Nanyang Blossom"
    address="12 Knightsbridge Green, Knightsbridge, London, SW1X 7QL, United Kingdom"
    cuisine="South East Asian"
    priceRange="£££"
    phoneNumber="+442045293643"
    website="https://nanyangblossom.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Nanyang region encompasses parts of both China and Southeast Asia, so you can expect influences from a variety of countries at this understatedly chic restaurant hidden down a narrow passageway. The array of menus includes a tasting option, an extensive à la carte and set sharing options for more indecisive diners. The dishes show care, craft and vibrancy across the board – but it’s the signature Knightsbridge crispy beef ribs that steal the show. The endearing service adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Knightsbridge%20Green%2C%20Knightsbridge%2C%20London%2C%20SW1X%207QL%2C%20United%20Kingdom"
    pageTitle="Nanyang Blossom"
  />
);

export default NanyangBlossom;
