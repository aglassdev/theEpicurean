...
const TheLavery = () => (
  <RestaurantPage
    restaurantName="The Lavery"
    address="4 Cromwell Place, South Kensington, London, SW7 2JE, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+442080571801"
    website="https://thelavery.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An ideally located restaurant for culture lovers, The Lavery sits on the first floor of a complex of art galleries inside some handsome South Kensington townhouses. Just a stone’s throw away, you’ll find the Victoria & Albert Museum, Science Museum and Natural History Museum. Once you’ve nourished mind and soul, nourish the body with the kitchen’s brand of Mediterranean cuisine fused with British ingredients. Expect the likes of ricotta-filled nettle tortelli with cultured butter and pine nuts, executed with an understated simplicity and no little skill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20Cromwell%20Place%2C%20South%20Kensington%2C%20London%2C%20SW7%202JE%2C%20United%20Kingdom"
    pageTitle="The Lavery"
  />
);

export default TheLavery;
