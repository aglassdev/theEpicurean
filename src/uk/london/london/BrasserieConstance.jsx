...
const BrasserieConstance = () => (
  <RestaurantPage
    restaurantName="Brasserie Constance"
    address="Level 1, Fulham Pier, Stevenage Road, London, SW6 6HH, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+442030025221"
    website="https://brasserieconstance.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s not just supporters of Fulham FC that should welcome this sparkling brasserie situated within one of the stands at their Craven Cottage stadium. Part of the wider Fulham Pier development, the terrace has Thames views and there’s a subtle glitz to the design thanks to mirrored walls and Murano chandeliers. The extensive menu ranges from simple omelettes to large sharing plates such as whole butterflied sea bass, while the kitchen excels with classic dishes like pie and mash. Whatever you choose, the cooking uses quality produce that brings plenty of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Level%201%2C%20Fulham%20Pier%2C%20Stevenage%20Road%2C%20London%2C%20SW6%206HH%2C%20United%20Kingdom"
    pageTitle="Brasserie Constance"
  />
);

export default BrasserieConstance;
