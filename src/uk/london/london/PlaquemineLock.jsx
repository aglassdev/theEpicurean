...
const PlaquemineLock = () => (
  <RestaurantPage
    restaurantName="Plaquemine Lock"
    address="139 Graham Street, Islington, London, N1 8LB, United Kingdom"
    cuisine="Creole, Cajun"
    priceRange="££"
    phoneNumber="+442076881488"
    website="https://plaqlock.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A unique and very colourful pub named after a small city in Louisiana and with a menu centred around Creole and Cajun traditions. Dishes like gumbo with okra, blackened chicken, and crawfish with corn and potatoes are carefully cooked and packed with flavour. Big Easy style cocktails add to the fun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=139%20Graham%20Street%2C%20Islington%2C%20London%2C%20N1%208LB%2C%20United%20Kingdom"
    pageTitle="Plaquemine Lock"
  />
);

export default PlaquemineLock;
