...
const CafSpiceNamast = () => (
  <RestaurantPage
    restaurantName="Café Spice Namasté"
    address="1-2 Lower Dock Walk, Royal Albert Dock, London, E16 2GT, United Kingdom"
    cuisine="Indian"
    priceRange="£"
    phoneNumber="+442074889242"
    website="https://www.cafespice.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef-Owner Cyrus Todiwala is fast approaching national treasure status, while his charming wife Pervin is a welcoming and delightful presence in their colourfully decorated restaurant. Unless you’re a local resident, its location on the ground floor of a modern apartment building in the Docklands development, overlooking the Royal Albert Wharf, involves a journey of some commitment – but it’ll be worth it. Go for the specialities from the couple's respective Goan and Bombay roots, like chicken cafrael and cheese chilli toast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2%20Lower%20Dock%20Walk%2C%20Royal%20Albert%20Dock%2C%20London%2C%20E16%202GT%2C%20United%20Kingdom"
    pageTitle="Café Spice Namasté"
  />
);

export default CafSpiceNamast;
