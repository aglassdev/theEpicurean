...
const ChapelMarketKitchenOysterBarGrill = () => (
  <RestaurantPage
    restaurantName="Chapel Market Kitchen Oyster Bar & Grill"
    address="2 Chapel Market, Islington, London, N1 9EZ, United Kingdom"
    cuisine="Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+442036212023"
    website="https://chapelmarketkitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, this cosy neighbourhood restaurant sits on the same street as Islington's busy and bohemian Chapel Market. It will feel like home for Chef-Owner Maoz Alonim, who spent years running a restaurant in Tel Aviv’s Jaffa Market. Produce from the stalls often finds its way onto the accessible and flexible menu, which offers everything from a strong oyster selection and raw bar to homemade pasta and cuts from the grill. For such a small place, it has a seriously impressive wine list with plenty of choice by the glass and knowledgeable service to match...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Chapel%20Market%2C%20Islington%2C%20London%2C%20N1%209EZ%2C%20United%20Kingdom"
    pageTitle="Chapel Market Kitchen Oyster Bar & Grill"
  />
);

export default ChapelMarketKitchenOysterBarGrill;
