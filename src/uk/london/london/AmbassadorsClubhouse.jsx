...
const AmbassadorsClubhouse = () => (
  <RestaurantPage
    restaurantName="Ambassadors Clubhouse"
    address="25 Heddon Street, Mayfair, London, W1B 4BH, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+442033198100"
    website="https://ambassadorsclubhouse.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s opulence to spare at this lavishly furnished, no-expense-spared restaurant from the team behind Gymkhana. Soft lighting, wood panelling and colourful décor all add to the atmosphere, which takes its cues from the ‘party mansions’ of the former undivided Punjab. Northern India and Pakistan inspire the menu, which provides a showcase for the chefs’ quality produce and abundant technical skill – both of which are evident in the superb mooli methi bream cooked on the sigri stove. Downstairs, in Ambassy, guest DJs curate a late-night rotation of Punjabi and British dance music...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20Heddon%20Street%2C%20Mayfair%2C%20London%2C%20W1B%204BH%2C%20United%20Kingdom"
    pageTitle="Ambassadors Clubhouse"
  />
);

export default AmbassadorsClubhouse;
