...
const RestaurantGordonRamsayHigh = () => (
  <RestaurantPage
    restaurantName="Restaurant Gordon Ramsay High"
    address="60th Floor, 22 Bishopsgate, City of London, London, EC2N 4BQ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+442075921618"
    website="https://www.gordonramsayrestaurants.com/high/bishopsgate/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60th%20Floor%2C%2022%20Bishopsgate%2C%20City%20of%20London%2C%20London%2C%20EC2N%204BQ%2C%20United%20Kingdom"
    pageTitle="Restaurant Gordon Ramsay High"
  />
);

export default RestaurantGordonRamsayHigh;
