...
const Archway = () => (
  <RestaurantPage
    restaurantName="Archway"
    address="Arch 65, Queen's Circus, Wandsworth, London, SW8 4NE, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+442037811102"
    website="https://archwaybattersea.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name suggests, this restaurant is nestled underneath the railway arches close to Battersea Park and the chic Battersea Power Station development. You may hear the rumble of trains overhead, but it’s often replaced by the buzz of diners flocking here to try the rustic Italian cooking with an appealing simplicity. Their focaccia is a stand out, while dishes like charred octopus with paprika romesco sauce put quality ingredients front and centre. The personable, engaging service team will make your visit even more enjoyable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arch%2065%2C%20Queen's%20Circus%2C%20Wandsworth%2C%20London%2C%20SW8%204NE%2C%20United%20Kingdom"
    pageTitle="Archway"
  />
);
