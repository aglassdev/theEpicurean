...
const Pravaas = () => (
  <RestaurantPage
    restaurantName="Pravaas"
    address="3 Glendower Place, South Kensington, London, SW7 3DU, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+442031617641"
    website="https://www.pravaas.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Shilpa Dandekar's Pravaas pulls inspiration from across the varied regions India, while adding her own spin into the bespoke dishes. It’s a simple, contemporary-looking place with clean, elegant design that’s understated enough to keep the food as the star of the show. Enhanced versions of Indian staples like butter chicken are available, but you’ll be well-served going for something different, such as the lamb galouti kebab or the Mangalorean chicken. All the dishes show off a wonderful mix of flavours, finely balanced so nothing dominates the central ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Glendower%20Place%2C%20South%20Kensington%2C%20London%2C%20SW7%203DU%2C%20United%20Kingdom"
    pageTitle="Pravaas"
  />
);

export default Pravaas;
