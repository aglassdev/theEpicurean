...
const ZumaLON = () => (
  <RestaurantPage
    restaurantName="Zuma"
    address="5 Raphael Street, Knightsbridge, London, SW7 1DL, United Kingdom"
    cuisine="Japanese Contemporary"
    priceRange="£££"
    phoneNumber="+442075841010"
    website="https://zumarestaurant.com/locations/london/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zuma may now be a global brand, but this long-standing Knightsbridge restaurant was the originator of its informal, izakaya-inspired Japanese cuisine. Managing to still feel fresh over 20 years after opening, its home to a glamorous clientele who fit right in with the striking surroundings and bustling atmosphere. Sharing is a great way to experience as much of the extensive menu as possible – but if you have to prioritise, make sure you try the array of produce cooked on the robata grill, from tofu to chicken wings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Raphael%20Street%2C%20Knightsbridge%2C%20London%2C%20SW7%201DL%2C%20United%20Kingdom"
    pageTitle="Zuma"
  />
);

export default ZumaLON;
