...
const Fallow = () => (
  <RestaurantPage
    restaurantName="Fallow"
    address="2 St James’s Market, St James’s, London, SW1Y 4RP, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442080171788"
    website="https://www.fallowrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thanks to a combination of interesting food and innovative use of social media, you can be sure that you’ll be walking into a packed and lively restaurant here, whatever the time of day or night. The large, open kitchen counter takes centre stage, while there’s also a heated terrace if you can’t get a table in the main room. The menu offers a large and appealing selection, from snacks to sharing plates, along with vegetarian choices. There’s a discernible nose-to-tail ethos too; do try the smoked cod’s head with Sriracha sauce, a house speciality. The corn ribs are great with a cocktail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20St%20James%E2%80%99s%20Market%2C%20St%20James%E2%80%99s%2C%20London%2C%20SW1Y%204RP%2C%20United%20Kingdom"
    pageTitle="Fallow"
  />
);
