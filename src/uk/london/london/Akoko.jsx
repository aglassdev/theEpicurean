...
const Akoko = () => (
  <RestaurantPage
    ...
    address="21 Berners Street, Fitzrovia, London, W1T3LP, United Kingdom"
    cuisine="African, Creative"
    priceRange="££££"
    phoneNumber="+442073230593"
    website="https://akoko.co.uk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="“We aim to prove that West African cuisine deserves its place in fine dining by highlighting its unique flavours and culinary traditions on its own terms,” says founder Aji Akokomi. With the help of some talented chefs, he is achieving that goal and then some. The kitchen adds a creative spin to recipes from across the region – be it Ghanaian abunuabunu, Senegalese yassa or Nigerian jollof rice – whilst retaining their original flavours and showcasing prime ingredients of superb quality in total harmony. Ask for a spot at the kitchen counter for a ringside seat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Berners%20Street%2C%20Fitzrovia%2C%20London%2C%20W1T3LP%2C%20United%20Kingdom"
    pageTitle="Akoko"
  />
);

export default Akoko;
