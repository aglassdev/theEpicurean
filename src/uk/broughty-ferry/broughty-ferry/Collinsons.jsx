...
const Collinsons = () => (
  <RestaurantPage
    restaurantName="Collinsons"
    address="122-124 Brown Street, Broughty Ferry, DD5 1EN, United Kingdom"
    cuisine="Classic Cuisine"
    priceRange="£££"
    phoneNumber="+441382776000"
    website="https://www.collinsonsrestaurant.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=122-124%20Brown%20Street%2C%20Broughty%20Ferry%2C%20DD5%201EN%2C%20United%20Kingdom"
    pageTitle="Collinsons"
  />
);

export default Collinsons;
