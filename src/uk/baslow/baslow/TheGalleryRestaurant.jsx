...
const TheGalleryRestaurant = () => (
  <RestaurantPage
    restaurantName="The Gallery Restaurant"
    address="The Cavendish Hotel, Church Lane, Baslow, DE45 1SP, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441246582311"
    website="https://cavendishhotelbaslow.co.uk/eat-drink/the-gallery/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Within the grounds of the Peak District’s renowned Chatsworth Estate sits The Cavendish Hotel – and within that is this elegant restaurant where oil paintings fill the walls and there’s a palpable sense of history in the air. Ingredients from the Estate – including juicy, full-flavoured beef – play a key role in the cooking, in dishes that avoid overcrowding the delicious natural flavours of the produce. The breads and desserts are particular highlights, providing excellent bookends to your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Cavendish%20Hotel%2C%20Church%20Lane%2C%20Baslow%2C%20DE45%201SP%2C%20United%20Kingdom"
    pageTitle="The Gallery Restaurant"
  />
);

export default TheGalleryRestaurant;
