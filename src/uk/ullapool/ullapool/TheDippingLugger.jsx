...
const TheDippingLugger = () => (
  <RestaurantPage
    restaurantName="The Dipping Lugger"
    address="4 West Shore Street, Ullapool, IV26 2UR, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441854613344"
    website="https://www.thedippinglugger.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after a sailing vessel, this late 18C former manse sits right on the harbourfront and comes with luxurious bedrooms and a small restaurant with a charming vintage style. The friendly team serve a tasting menu to all tables at the same time and while dishes might appear simple, flavours burst through...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20West%20Shore%20Street%2C%20Ullapool%2C%20IV26%202UR%2C%20United%20Kingdom"
    pageTitle="The Dipping Lugger"
  />
);

export default TheDippingLugger;
