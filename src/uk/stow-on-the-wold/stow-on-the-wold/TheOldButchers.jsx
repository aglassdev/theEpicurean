...
const TheOldButchers = () => (
  <RestaurantPage
    restaurantName="The Old Butchers"
    address="7 Park Street, Stow-on-the-Wold, GL54 1AQ, United Kingdom"
    cuisine="Classic Cuisine"
    priceRange="££"
    phoneNumber="+441451831700"
    website="https://theoldbutchers.squarespace.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over two decades, The Old Butchers has been in the hands of the Robinson family – and they continue to provide first-rate hospitality in this Cotswolds market town. Louise will ensure you feel welcomed and at ease in the quirkily decorated former butcher's shop, while Peter heads up the kitchen. His menu is broad and enticing, with a feature made of the charcoal grill and a heavy helping of seafood, from Cornish scallops with piquant nduja butter to Dover sole meunière with textbook execution. It all adds up to one mightily appealing restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Park%20Street%2C%20Stow-on-the-Wold%2C%20GL54%201AQ%2C%20United%20Kingdom"
    pageTitle="The Old Butchers"
  />
);

export default TheOldButchers;
