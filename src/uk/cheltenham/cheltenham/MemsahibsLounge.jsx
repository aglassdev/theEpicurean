...
const MemsahibsLounge = () => (
  <RestaurantPage
    restaurantName="Memsahib's Lounge"
    address="47-49 Promenade, Cheltenham, GL50 1PJ, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+441242583377"
    website="https://memsahibslounge.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a certain style to this two-roomed basement in a smart Georgian terrace: the colonial-themed bar offers a good range of cocktails, as well as gin and vodka infusions, while the adjoining dining room has a clubby feel, with its charcoal portraits and sepia prints. The Indian dishes are for sharing, although the 'Experience' tasting menu is perhaps the best way to go, and there are also vegetarian and pescatarian versions. They even serve an Indian-themed afternoon tea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47-49%20Promenade%2C%20Cheltenham%2C%20GL50%201PJ%2C%20United%20Kingdom"
    pageTitle="Memsahib's Lounge"
  />
);

export default MemsahibsLounge;
