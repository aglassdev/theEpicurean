...
const BhoomiKitchen = () => (
  <RestaurantPage
    restaurantName="Bhoomi Kitchen"
    address="52 Suffolk Road, Cheltenham, GL50 2AQ, United Kingdom"
    cuisine="Indian"
    priceRange="££"
    phoneNumber="+441242222010"
    website="https://www.bhoomikitchen.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll receive a warm welcome at this sumptuous restaurant, run by the third generation of a family who settled here from India 50 years ago. The menu is mostly southern Indian with some BBQ dishes from the tandoor representing the north. Save room for the indulgent chocolate samosa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=52%20Suffolk%20Road%2C%20Cheltenham%2C%20GL50%202AQ%2C%20United%20Kingdom"
    pageTitle="Bhoomi Kitchen"
  />
);

export default BhoomiKitchen;
