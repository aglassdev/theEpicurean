...
const RestaurantSow = () => (
  <RestaurantPage
    restaurantName="Restaurant Sow"
    address="Pensons Yard, Tenbury Wells, WR15 8RT, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+443316309620"
    website="https://www.restaurantsow.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you settle into your seat inside this beautiful 16th-century barn, you’re struck by what a stunning restaurant setting it is. Situated on the Netherwood Estate, ensure you take a look around its garden before dining, as much of the produce you see will be on your plate a little later. The kitchen is run under the auspices of experienced operator Andrew Sheridan and pairs the local produce with occasional East Asian influences, such as Japanese milk bread. Save yourself the journey home by staying over in one of the luxury bedrooms on the other side of the courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pensons%20Yard%2C%20Tenbury%20Wells%2C%20WR15%208RT%2C%20United%20Kingdom"
    pageTitle="Restaurant Sow"
  />
);

export default RestaurantSow;
