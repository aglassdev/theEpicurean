...
const Sumas = () => (
  <RestaurantPage
    restaurantName="Sumas"
    address="Gorey Hill, Gorey, JE3 6ET, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441534853291"
    website="https://www.sumasrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A well-known restaurant in a whitewashed house, with a smart heated terrace affording lovely harbour views. Modern European dishes feature island produce. The monthly changing lunch and midweek dinner menus represent good value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gorey%20Hill%2C%20Gorey%2C%20JE3%206ET%2C%20United%20Kingdom"
    pageTitle="Sumas"
  />
);
