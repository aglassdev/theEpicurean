...
const BassAndLobster = () => (
  <RestaurantPage
    restaurantName="Bass and Lobster"
    address="Gorey Coast Road, Gorey, JE3 6EU, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441534859590"
    website="https://www.bassandlobster.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A former pub close to the beach houses this substantial bistro, where you’ll find plenty of regulars drawn in by the great value daily set menu. There’s always plenty to choose from here, including numerous daily specials and a good selection of fresh fish – and the faggots are a must-try. You can watch the island meats, vegetables and seafood being prepared through the kitchen window...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gorey%20Coast%20Road%2C%20Gorey%2C%20JE3%206EU%2C%20United%20Kingdom"
    pageTitle="Bass and Lobster"
  />
);

export default BassAndLobster;
