...
const TheYurtAtNicholsons = () => (
  <RestaurantPage
    restaurantName="The Yurt at Nicholsons"
    address="Nicholson Nurseries, The Park, North Aston, OX25 6HL, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441869340342"
    website="https://www.nicholsonsgb.com/yurt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re after something a little different, head to Nicholsons Nursery to have lunch in this lovely yurt – which is fashioned from upcycled materials – or in one of the themed private huts alongside. The generously sized, Mediterranean-influenced cooking is unfussy in style but propelled by bold flavours and excellent technique from the kitchen; cider-cured chalkstream trout with a brilliantly made crab bisque is a wonderful example. The confident, bright and breezy service is a natural fit for a place where you can't help but find yourself smiling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nicholson%20Nurseries%2C%20The%20Park%2C%20North%20Aston%2C%20OX25%206HL%2C%20United%20Kingdom"
    pageTitle="The Yurt at Nicholsons"
  />
);

export default TheYurtAtNicholsons;
