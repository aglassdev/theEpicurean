...
const Sandros = () => (
  <RestaurantPage
    ...
    address="2 Drakes Way, Lyme Regis, DT7 3QP, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441297599801"
    website="https://www.sandroslymeregis.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The kind of heartfelt and enthusiastically run restaurant that guarantees you’ll leave feeling better than when you arrived, Sandro’s is a hometown return for the titular chef, who has taken over the premises his father once ran. In an intimate 16-cover space, he cooks fuss-free and flavour-packed dishes such as spatchcock quail with Montbéliard sausage and coco de Paimpol, while adding occasional touches from his Italian heritage. Sandro’s partner Vicky looks after the service with skill, and they are both relaxed, welcoming hosts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Drakes%20Way%2C%20Lyme%20Regis%2C%20DT7%203QP%2C%20United%20Kingdom"
    pageTitle="Sandro's"
  />
);

export default Sandros;
