...
const TheWildebeest = () => (
  <RestaurantPage
    restaurantName="The Wildebeest"
    address="82 - 86 Norwich Road, Stoke Holy Cross, NR14 8QJ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441508492497"
    website="https://www.thewildebeest.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in the heart of a pretty village and fronted by an attractive terrace, this former pub is now a laid-back restaurant offering satisfying modern cooking at a wallet-friendly price. The menus range from a particularly great value daily selection to an ambitious à la carte and an inventive tasting menu, all exhibiting the kitchen's skilled control of flavour and balance. Dishes like chicken liver parfait and dulche de leche cheesecake might sound straightforward, but they're executed with such aplomb. The friendly service team are eager to please...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=82%20-%2086%20Norwich%20Road%2C%20Stoke%20Holy%20Cross%2C%20NR14%208QJ%2C%20United%20Kingdom"
    pageTitle="The Wildebeest"
  />
);

export default TheWildebeest;
