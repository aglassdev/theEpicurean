...
const TheReindeer = () => (
  <RestaurantPage
    restaurantName="The Reindeer"
    address="Main Street, Hoveringham, NG14 7JR, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441159346071"
    website="https://www.reindeerpub.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Hoveringham%2C%20NG14%207JR%2C%20United%20Kingdom"
    pageTitle="The Reindeer"
  />
);

export default TheReindeer;
