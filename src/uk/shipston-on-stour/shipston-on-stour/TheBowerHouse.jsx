...
const TheBowerHouse = () => (
  <RestaurantPage
    restaurantName="The Bower House"
    address="2-4 Market Place, Shipston-on-Stour, CV36 4AG, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441608663333"
    website="https://bower.house"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An appealing mixture of the vintage and the contemporary lend a certain stylishness to the décor at this smart brasserie occupying two former shops in the heart of a small market town. The attractive dishes are packed with flavour and make the most of quality British produce, as with delicious, sweet Cornish crab turned into a simple, fresh-tasting tartlet. Sit in the larger room with its comfy banquettes and copper-topped tables, then treat yourself to a stay in one of the characterful bedrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4%20Market%20Place%2C%20Shipston-on-Stour%2C%20CV36%204AG%2C%20United%20Kingdom"
    pageTitle="The Bower House"
  />
);

export default TheBowerHouse;
