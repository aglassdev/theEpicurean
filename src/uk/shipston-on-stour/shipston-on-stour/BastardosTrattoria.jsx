...
const BastardosTrattoria = () => (
  <RestaurantPage
    restaurantName="Bastardo's Trattoria"
    address="6 Granville Court, Shipston-on-Stour, CV36 4PP, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber=""
    website="https://www.bastardostrattoria.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right in the centre of this historic market town and encased within glass walls on three sides, this self-described ‘illegitimate trattoria’ is a love letter to straightforward Italian cooking, fused with seasonal British ingredients. In the day, it operates as the coffee shop and bakery Ferment & Flour, before the Italian vibe takes over in the evening. Start with a couple of cicchetti before one of the stand-out homemade pastas, be that casarecce with preserved wild garlic, truffle and parmesan, or well-crafted crab agnolotti. Add in friendly service and you have a winning formula...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Granville%20Court%2C%20Shipston-on-Stour%2C%20CV36%204PP%2C%20United%20Kingdom"
    pageTitle="Bastardo's Trattoria"
  />
);

export default BastardosTrattoria;
