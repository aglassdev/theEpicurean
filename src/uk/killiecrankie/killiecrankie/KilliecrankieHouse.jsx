...
const KilliecrankieHouse = () => (
  <RestaurantPage
    restaurantName="Killiecrankie House"
    address="Pitlochry, Killiecrankie, PH16 5LG, United Kingdom"
    cuisine="Modern Cuisine, Scottish"
    priceRange="££££"
    phoneNumber="+447828106673"
    website="https://www.killiecrankiehouse.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A young couple swapped their city lifestyle for this period country house in the Cairngorms National Park, which they lovingly restored to fuse original and modern features. Arrive at 7pm for drinks before dining on a tasting menu of Scottish classics brought playfully up to date. Bedrooms are sumptuous...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pitlochry%2C%20Killiecrankie%2C%20PH16%205LG%2C%20United%20Kingdom"
    pageTitle="Killiecrankie House"
  />
);

export default KilliecrankieHouse;
