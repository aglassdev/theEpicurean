...
const QueenOfCups = () => (
  <RestaurantPage
    restaurantName="Queen of Cups"
    address="10-12 Northload Street, Glastonbury, BA6 9JJ, United Kingdom"
    cuisine="Middle Eastern, Mediterranean Cuisine"
    priceRange="££"
    phoneNumber="+441458831255"
    website="https://www.queenofcups.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This deliciously different restaurant sits within a rustic 17C inn in the heart of Glastonbury, and comes with numerous seating areas, including a cosy courtyard for sunny days. Menus showcase West Country produce and the resulting Middle Eastern and Mediterranean small plates burst with colour and flavour. Grab a friend, go for the chef’s selection entitled the ‘Queen’s Feast’ and accompany it with the ‘sharing ciders’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10-12%20Northload%20Street%2C%20Glastonbury%2C%20BA6%209JJ%2C%20United%20Kingdom"
    pageTitle="Queen of Cups"
  />
);
