...
const OutlawsNewRoad = () => (
  <RestaurantPage
    restaurantName="Outlaw's New Road"
    address="6 New Road, Port Isaac, PL29 3SB, United Kingdom"
    cuisine="Seafood"
    priceRange="££££"
    phoneNumber="+441208880896"
    website="https://outlaws.co.uk/restaurants/new-road/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="He might not be Cornish by birth but Nathan Outlaw has certainly made Cornwall his home, with this smart yet laid-back offering occupying a great position on the headland. There are few other chefs in the country who understand and execute seafood cookery quite as well; his menus are guided by the daily catch and the refined, pared-back dishes feature classical combinations which keep the focus firmly on the ultra-fresh ingredients. Service strikes the perfect balance of professional yet personable and the signature Porthilly sauce is unmissable. Bedrooms are available in the Guest House across the road...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20New%20Road%2C%20Port%20Isaac%2C%20PL29%203SB%2C%20United%20Kingdom"
    pageTitle="Outlaw's New Road"
  />
);

export default OutlawsNewRoad;
