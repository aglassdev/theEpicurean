...
const TheButchersTapAndGrill = () => (
  <RestaurantPage
    restaurantName="The Butcher's Tap and Grill"
    address="15 Spittal Street, Marlow, SL7 3HJ, United Kingdom"
    cuisine="Meats and Grills"
    priceRange="££"
    phoneNumber="+441628401535"
    website="https://www.thebutcherstapandgrill.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A part of the ever-evolving Tom Kerridge stable, this is one of his busiest spots and it's easy to see why. Friendly and laid-back, it's a 'does what it says on the tin' kind of place where meats of undeniable quality are given pride of place on the menu and on the butcher's shop counter. There are some well-made snacks to whet the appetite, but really this is all about the main event: pop in for a quick burger or stay a while and enjoy the premium cuts cooked to your liking, which might include Aberdeen Angus beef, Blythburgh pork or Suffolk Texel lamb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Spittal%20Street%2C%20Marlow%2C%20SL7%203HJ%2C%20United%20Kingdom"
    pageTitle="The Butcher's Tap and Grill"
  />
);

export default TheButchersTapAndGrill;
