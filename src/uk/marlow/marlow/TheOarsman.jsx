...
const TheOarsman = () => (
  <RestaurantPage
    restaurantName="The Oarsman"
    address="46 Spittal Street, Marlow, SL7 1DB, United Kingdom"
    cuisine="British Contemporary"
    priceRange="££"
    phoneNumber="+441628617755"
    website="https://theoarsman.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spend an hour or two at this lovely pub and you'll leave feeling a good deal happier than when you entered. The impressive kitchen and service teams will ensure you are looked-after and well-fed, inside the charming surroundings of their part-red-brick, part-timbered pub – which also boasts a lovely enclosed terrace. The cooking puts naturally delicious ingredients at the forefront and doesn't shy away from big flavours, like warming nudja with roasted poussin. Look out for the 'Steak Frites Night' and come midweek to make the most of the wallet-friendly pricing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=46%20Spittal%20Street%2C%20Marlow%2C%20SL7%201DB%2C%20United%20Kingdom"
    pageTitle="The Oarsman"
  />
);

export default TheOarsman;
