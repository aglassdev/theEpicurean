...
const StationRoad = () => (
  <RestaurantPage
    restaurantName="Station Road"
    address="The Lovat Hotel, Fort Augustus, PH32 4DU, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441456490000"
    website="https://thelovat.com/dining/station-road/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Their tagline, ‘taste nature’s larder’, says it all at this restaurant housed inside The Lovat Hotel, a lovingly restored country house at the gateway to Loch Ness. From locally foraged ingredients to the best Highland produce, dishes showcase Scottish ingredients in detailed, modern dishes that taste as good as they look. Charming and efficient service adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Lovat%20Hotel%2C%20Fort%20Augustus%2C%20PH32%204DU%2C%20United%20Kingdom"
    pageTitle="Station Road"
  />
);

export default StationRoad;
