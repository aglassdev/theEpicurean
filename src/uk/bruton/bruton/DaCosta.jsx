...
const DaCosta = () => (
  <RestaurantPage
    restaurantName="DA COSTA"
    address="Durslade Farm, Dropping Lane, Bruton, BA10 0NL, United Kingdom"
    cuisine="Italian"
    priceRange="£££"
    phoneNumber="+441749467880"
    website="https://da-costa.co.uk/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Durslade%20Farm%2C%20Dropping%20Lane%2C%20Bruton%2C%20BA10%200NL%2C%20United%20Kingdom"
    pageTitle="DA COSTA"
  />
);

export default DaCosta;
