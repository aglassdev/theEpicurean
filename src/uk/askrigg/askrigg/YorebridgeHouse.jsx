...
const YorebridgeHouse = () => (
  <RestaurantPage
    restaurantName="Yorebridge House"
    address="Bainbridge, Askrigg, DL8 3EE, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441969652060"
    website="https://www.yorebridgehouse.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This romantic restaurant sits within a stylish former schoolmaster’s house in the heart of the Yorkshire Dales, and offers lovely countryside views. Top quality British ingredients feature in attractively presented dishes with a personal twist. Book a bedroom with a riverside terrace and a hot tub...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bainbridge%2C%20Askrigg%2C%20DL8%203EE%2C%20United%20Kingdom"
    pageTitle="Yorebridge House"
  />
);

export default YorebridgeHouse;
