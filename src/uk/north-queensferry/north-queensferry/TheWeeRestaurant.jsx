...
const TheWeeRestaurant = () => (
  <RestaurantPage
    restaurantName="The Wee Restaurant"
    address="17 Main Street, North Queensferry, KY11 1JT, United Kingdom"
    cuisine="Traditional Cuisine, Classic Cuisine"
    priceRange="£££"
    phoneNumber="+441383616263"
    website="https://theweerestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its endearing name gives a clue as to the likeable, friendly vibe at this restaurant in the shadow of the majestic Forth Rail Bridge. Its grey brick walls are enlivened by boldly coloured artwork and, as expected, it’s a small and cosy place. Fresh Scottish ingredients are served in neatly presented, classic combinations; if you get the chance, make sure you try the plump Shetland mussels, which are naturally delicious yet further enhanced by bacon, basil and parmesan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Main%20Street%2C%20North%20Queensferry%2C%20KY11%201JT%2C%20United%20Kingdom"
    pageTitle="The Wee Restaurant"
  />
);

export default TheWeeRestaurant;
