...
const Chapters = () => (
  <RestaurantPage
    restaurantName="CHAPTERS"
    address="Lion Street, Hay-on-Wye, HR3 5AA, United Kingdom"
    cuisine="Creative British"
    priceRange="£££"
    phoneNumber="+447855783799"
    website="https://www.chaptershayonwye.co.uk"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stone-built former meeting room to the adjoining chapel, CHAPTERS exudes an intimate, rustic-cum-vintage style with its parquet flooring, wood panelling and leaded windows. The set menu is dictated by the kitchen's unerring commitment to sustainability; jars of pickles and preserves line the walls, while local and hyper-seasonal ingredients deliver fabulous natural flavours. The whole team's passion for their way of working makes the place even more endearing, and there's also a small shop where you can purchase natural and organic wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lion%20Street%2C%20Hay-on-Wye%2C%20HR3%205AA%2C%20United%20Kingdom"
    pageTitle="CHAPTERS"
  />
);
