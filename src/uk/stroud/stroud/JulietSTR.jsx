...
const JulietSTR = () => (
  <RestaurantPage
    ...
    address="49 London Road, Stroud, GL5 2AD, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441453367019"
    website="https://www.julietrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Imagine dropping a French bistro into the Cotswolds and you’ve got something a lot like Juliet. Combining a buzzy vibe with an enthusiastic and affable team, plus delightful dishes from beyond France’s borders, it’s easy to see why the place is so popular. The menu largely sticks to the classics, providing satisfying versions of time-honoured favourites; keep an eye on the dish of the day, for treats such as cavatelli with lamb ragù. If you’re celebrating, consider booking the private Piano Bar, where a live musician will soundtrack your evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49%20London%20Road%2C%20Stroud%2C%20GL5%202AD%2C%20United%20Kingdom"
    pageTitle="Juliet"
  />
);

export default JulietSTR;
