...
const HomesteadKitchen = () => (
  <RestaurantPage
    restaurantName="Homestead Kitchen"
    address="Prudom House, Goathland, YO22 5AN, United Kingdom"
    cuisine="British Contemporary"
    priceRange="£££"
    phoneNumber="+441947896191"
    website="https://thehomesteadgoathland.com"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="The North York Moors and their produce are the inspiration behind this charming little restaurant housed inside a rural, stone-built former farmhouse. Chef-Owner Peter Neville and his partner Cecily Fearnley show great pride as they enthuse about their sustainable philosophy. Local produce – be it Moorland roe deer, Whitby crab or any number of ingredients from the kitchen garden – is used in hearty dishes that pack a punch when it comes to flavour. Sauces and accompaniments are a particular strength of the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Prudom%20House%2C%20Goathland%2C%20YO22%205AN%2C%20United%20Kingdom"
    pageTitle="Homestead Kitchen"
  />
);

export default HomesteadKitchen;
