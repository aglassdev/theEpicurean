...
const TheWildRabbit = () => (
  <RestaurantPage
    restaurantName="The Wild Rabbit"
    address="Church Street, Kingham, OX7 6YA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441608658389"
    website="https://www.thewildrabbit.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just down the road from the Daylesford Farm Shop is the Bamford family’s stylishly modernised country pub. It's constantly packed with contented diners and it's no wonder why as this is an utterly charming place, looking every inch the quintessential Cotswolds inn. The accomplished cooking offers plenty of appeal, with the natural flavours of the farm’s superb organic ingredients underpinning the menu. The luxurious bedrooms are delightfully understated, if you want to continue your Cotswolds adventure...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Church%20Street%2C%20Kingham%2C%20OX7%206YA%2C%20United%20Kingdom"
    pageTitle="The Wild Rabbit"
  />
);

export default TheWildRabbit;
