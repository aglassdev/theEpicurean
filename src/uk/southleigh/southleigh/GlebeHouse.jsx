...
const GlebeHouse = () => (
  <RestaurantPage
    restaurantName="Glebe House"
    address="Southleigh, EX24 6SD, United Kingdom"
    cuisine="Country cooking"
    priceRange="£££"
    phoneNumber="+441404718276"
    website="https://www.glebehousedevon.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A heartfelt and heartwarming place, Glebe House feels like a sanctuary from our over-busy modern world. Chef-Owner Hugo Guest grew up in this former Georgian vicarage, before returning home and transforming it into a 15-acre smallholding and restaurant. Rustic charm oozes from every corner of the classic country house décor, while the surrounding farmland provides plenty of quality ingredients for the tasting menu – including home-cured meats from their own pigs. Each dish is unfussy and flavoursome, and explained with pride by the chefs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Southleigh%2C%20EX24%206SD%2C%20United%20Kingdom"
    pageTitle="Glebe House"
  />
);

export default GlebeHouse;
