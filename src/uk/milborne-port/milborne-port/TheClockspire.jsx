...
const TheClockspire = () => (
  <RestaurantPage
    restaurantName="The Clockspire"
    address="Gainsborough, Milborne Port, DT9 5BA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441963251458"
    website="https://www.theclockspire.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's a lot of beautiful restaurants around, but Clockspire might be one of the most strikingly attractive spots you'll find. Housed within a converted 19th-century school, its high ceiling and exposed rafters provide plenty of ecclesiastical 'wow factor', while the lavishness of the refurbishment is mightily impressive. As you may expect, the dishes are impeccably presented and the polished cooking makes good use of its British ingredients. The slick service comes with a personal touch that feels as though the team really care about your experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gainsborough%2C%20Milborne%20Port%2C%20DT9%205BA%2C%20United%20Kingdom"
    pageTitle="The Clockspire"
  />
);

export default TheClockspire;
