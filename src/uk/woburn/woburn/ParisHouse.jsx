...
const ParisHouse = () => (
  <RestaurantPage
    restaurantName="Paris House"
    address="Woburn Park, Woburn, MK17 9QP, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441525290692"
    website="https://www.parishouse.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A beautiful mock-Tudor house built in Paris and reassembled in an idyllic parkland location; enjoy a drink on the terrace while watching the deer. The seasonal tasting menu offers sophisticated, artfully presented dishes with creative texture and flavour combinations and subtle Asian influences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Woburn%20Park%2C%20Woburn%2C%20MK17%209QP%2C%20United%20Kingdom"
    pageTitle="Paris House"
  />
);

export default ParisHouse;
