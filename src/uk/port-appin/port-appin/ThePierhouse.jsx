...
const ThePierhouse = () => (
  <RestaurantPage
    restaurantName="The Pierhouse"
    address="Port Appin, PA38 4DE, United Kingdom"
    cuisine="Seafood, Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441631730302"
    website="https://pierhousehotel.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As locations go, it’s hard to beat: find a spot on the terrace to watch the ferry chugging across the loch and stay the night to wake up to the fabulous view. The modern dining room with its bay windows provides a great vantage point too, providing the perfect accompaniment to the seafood-focused cooking. Traditional dishes like Cullen skink and fish pie lead the way, while the sharing platter is the best way to go if you want to taste as much fresh Scottish fish and shellfish as possible...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Port%20Appin%2C%20PA38%204DE%2C%20United%20Kingdom"
    pageTitle="The Pierhouse"
  />
);

export default ThePierhouse;
