...
const GreyhoundInn = () => (
  <RestaurantPage
    restaurantName="Greyhound Inn"
    address="The Street, Pettistree, IP13 0HP, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="££"
    phoneNumber="+441473932168"
    website="http://www.greyhoundpettistree.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A trip to this enthusiastically run country pub feels a little like stepping back in time, in the best possible way. Serving the kind of menu where you could happily eat every dish, the kitchen favours a no-nonsense approach where big, hearty flavours and prime produce lead the way. Great use is made of cooking over fire, in dishes like wood-roasted quail served with a glossy sauce made from its roasting juices. It’s all simply joyous cooking, made even better by the welcoming team and idyllic location in the shadow of this tiny hamlet’s picturesque church...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Street%2C%20Pettistree%2C%20IP13%200HP%2C%20United%20Kingdom"
    pageTitle="Greyhound Inn"
  />
);

export default GreyhoundInn;
