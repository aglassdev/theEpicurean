...
const ThreeSixOnTheQuay = () => (
  <RestaurantPage
    restaurantName="36 on the Quay"
    address="47 South Street, The Quay, Emsworth, PO10 7EG, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441243375592"
    website="https://www.36onthequay.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A quayside cottage plays host to this intimate restaurant, which affords lovely harbour views – and the sheltered terrace is a hit come summer. Modern dishes display a wealth of different flavours and textures, with the desserts being particularly playful. Bedrooms are cosy and stylish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=47%20South%20Street%2C%20The%20Quay%2C%20Emsworth%2C%20PO10%207EG%2C%20United%20Kingdom"
    pageTitle="36 on the Quay"
  />
);

export default ThreeSixOnTheQuay;
