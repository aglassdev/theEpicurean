...
const SeasgairByMichelRouxJr = () => (
  <RestaurantPage
    restaurantName="'Seasgair' by Michel Roux Jr"
    address="Inverlochy Castle, Torlundy, Fort William, PH33 6SN, United Kingdom"
    cuisine="Modern French"
    priceRange="££££"
    phoneNumber="+441397702177"
    website="https://inverlochycastlehotel.com/dining"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Seasgair’ means ‘warm and cosy’ in Gaelic, and diners will certainly feel cosseted in the impressive Inverlochy Castle. The whole experience is like stepping back in time to the country houses of old. Begin with an aperitif in the Grand Hall, accompanied by live music, before taking your seat in one of the elegant dining rooms. A 5 course set menu is served to everyone at the same time with canapés on arrival. Michel Roux Jr’s influence on the menu sees classic French dishes combined with the Scottish ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Inverlochy%20Castle%2C%20Torlundy%2C%20Fort%20William%2C%20PH33%206SN%2C%20United%20Kingdom"
    pageTitle="'Seasgair' by Michel Roux Jr"
  />
);

export default SeasgairByMichelRouxJr;
