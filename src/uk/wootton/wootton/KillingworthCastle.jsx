...
const KillingworthCastle = () => (
  <RestaurantPage
    restaurantName="Killingworth Castle"
    address="Glympton Road, Wootton, OX20 1EJ, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441993811401"
    website="https://www.thekillingworthcastle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's a lovely pub ambience at this attractive 16th-century inn; the crackling fire is perfect for winter, while the landscaped garden comes into its own in summer. The chefs bake their own breads, butcher their own meats and champion local and organic produce across an array of menus that let you tailor your visit depending on the mood and occasion: bargain hunters should go for the great value set lunch; steak lovers should come on Wednesdays; and the tasting menu is there for special occasions. Stay overnight in one of the spacious bedrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Glympton%20Road%2C%20Wootton%2C%20OX20%201EJ%2C%20United%20Kingdom"
    pageTitle="Killingworth Castle"
  />
);

export default KillingworthCastle;
