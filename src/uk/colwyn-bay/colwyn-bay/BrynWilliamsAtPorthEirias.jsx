...
const BrynWilliamsAtPorthEirias = () => (
  <RestaurantPage
    restaurantName="Bryn Williams at Porth Eirias"
    address="The Promenade, Colwyn Bay, LL29 8HH, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441492533700"
    website="https://www.portheirias.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re after a relaxed, friendly environment, this striking beachside brasserie with faux industrial styling, blue leather banquettes and stunning sea views is the place to come. The owner is proud of his Welsh roots and it shows on the menu. Cooking is pleasingly unfussy and local seafood is to the fore...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Promenade%2C%20Colwyn%20Bay%2C%20LL29%208HH%2C%20United%20Kingdom"
    pageTitle="Bryn Williams at Porth Eirias"
  />
);

export default BrynWilliamsAtPorthEirias;
