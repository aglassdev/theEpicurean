...
const Lovage = () => (
  <RestaurantPage
    ...
    address="Bath Street, Bakewell, DE45 1DS, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441629815613"
    website="https://www.restaurantlovage.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of a historic market town, famed for its puddings and tarts, you'll find this cosy restaurant located inside a former stable block. That past occupation makes itself known in the wonderfully rustic décor with wood-panelled walls, exposed brickwork and beamed ceilings. The chatty, informative team are sure to put a smile on your face as they enthusiastically explain the modern dishes made up of quality local ingredients, served as either a tasting menu or an à la carte featuring classic combinations like roasted beetroot with goat's cheese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bath%20Street%2C%20Bakewell%2C%20DE45%201DS%2C%20United%20Kingdom"
    pageTitle="Lovage"
  />
);

export default Lovage;
