...
const CraigMillar16WestEnd = () => (
  <RestaurantPage
    restaurantName="Craig Millar @ 16 West End"
    address="16 West End, St Monans, KY10 2BX, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441333730327"
    website="https://www.16westend.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you love harbourside views, then you'll be delighted by this attractively converted former pub along Fife's famous East Neuk. Most of the tables offer views of the water, while a small terrace is ideal for the summer. As you'd expect in this location, there's some seafood among the high-quality ingredients, which underpin refined, attractively presented dishes which are full of flavour. There's a choice of dishes on the fixed-price lunch menu, with two options for the main course on the dinner tasting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20West%20End%2C%20St%20Monans%2C%20KY10%202BX%2C%20United%20Kingdom"
    pageTitle="Craig Millar @ 16 West End"
  />
);

export default CraigMillar16WestEnd;
