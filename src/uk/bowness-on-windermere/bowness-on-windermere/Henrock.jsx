...
const Henrock = () => (
  <RestaurantPage
    restaurantName="Henrock"
    address="Linthwaite House, Crook Road, Bowness-on-Windermere, LA23 3JA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441539488600"
    website="https://www.henrock.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after a rocky outcrop on Lake Windermere, this elegant restaurant sits inside the charming Linthwaite House hotel and is part of Simon Rogan's ever-evolving empire. The décor is minimal yet cosy, with plain wooden tables and lovely artwork on the walls. Simon's sustainable ethos is evident on the menu, with many ingredients in the colourful dishes coming from his 'Our Farm' estate and other produce – like Cartmel Valley venison – sourced in the local area. Warm, friendly staff enhance the experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Linthwaite%20House%2C%20Crook%20Road%2C%20Bowness-on-Windermere%2C%20LA23%203JA%2C%20United%20Kingdom"
    pageTitle="Henrock"
  />
);

export default Henrock;
