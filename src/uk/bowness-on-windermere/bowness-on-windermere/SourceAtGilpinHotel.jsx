...
const SourceAtGilpinHotel = () => (
  <RestaurantPage
    restaurantName="SOURCE at Gilpin Hotel"
    ...
    pageTitle="SOURCE at Gilpin Hotel"
  />
);

export default SourceAtGilpinHotel;
