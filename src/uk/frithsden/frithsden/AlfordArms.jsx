...
const AlfordArms = () => (
  <RestaurantPage
    restaurantName="Alford Arms"
    address="Frithsden, HP1 3DD, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441442864480"
    website="https://alfordarms.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Frithsden%2C%20HP1%203DD%2C%20United%20Kingdom"
    pageTitle="Alford Arms"
  />
);

export default AlfordArms;
