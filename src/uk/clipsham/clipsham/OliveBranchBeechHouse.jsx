...
const OliveBranchBeechHouse = () => (
  <RestaurantPage
    restaurantName="Olive Branch & Beech House"
    address="Main Street, Clipsham, LE15 7SH, United Kingdom"
    cuisine="Traditional British, Regional Cuisine"
    priceRange="£££"
    phoneNumber="+441780410355"
    website="https://www.theolivebranchpub.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Olive Branch is a picture-postcard village pub, with a fine stone exterior and rustic interior design that boasts the obligatory wooden beams and roaring fire which make country inns so inviting. Its cooking is comfortingly traditional in basis, with well-executed versions of confit duck leg, fish & chips and more hearty classics; local sourcing is key too, with suppliers proudly name-checked and vegetables coming from their garden. Over the road, you'll find Beech House, where guests can stay the night while exploring the surrounding countryside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Clipsham%2C%20LE15%207SH%2C%20United%20Kingdom"
    pageTitle="Olive Branch & Beech House"
  />
);

export default OliveBranchBeechHouse;
