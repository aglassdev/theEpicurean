...
const NewCoastKitchen = () => (
  <RestaurantPage
    restaurantName="New Coast Kitchen"
    address="1 St Mary's Road, Croyde, EX33 1LF, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441271316165"
    website="https://newcoastkitchen.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its relaxed vibe and cheerful service, this is just the kind of restaurant you want to know about when on holiday around the North Devon coast. Head for the terrace out front in good weather – a perfect spot for people watching – or sit inside surrounded by the sleek, modern décor. The adventurous cooking is executed with flair and delivers well-judged combinations of bold flavours, as with the contrast between rich butter sauce and citrus marinated fennel in a wild bass dish. Save room for dessert too, as the confit apple terrine is a highlight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20St%20Mary's%20Road%2C%20Croyde%2C%20EX33%201LF%2C%20United%20Kingdom"
    pageTitle="New Coast Kitchen"
  />
);

export default NewCoastKitchen;
