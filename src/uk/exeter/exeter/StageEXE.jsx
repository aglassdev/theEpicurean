...
const StageEXE = () => (
  <RestaurantPage
    ...
    address="31 Magdalen Road, Exeter, EX2 4TA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441392496700"
    website="https://www.stagerestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fun, trendy spot set up on a budget by an enthusiastic group of young men known as the ‘Taco Boys’. Foraged ingredients and produce from the kitchen garden inform the daily changing, surprise tasting menus, and the original, modern dishes have bold flavours and contrasting textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20Magdalen%20Road%2C%20Exeter%2C%20EX2%204TA%2C%20United%20Kingdom"
    pageTitle="Stage"
  />
);

export default StageEXE;
