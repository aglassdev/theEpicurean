...
const 1887 = () => (
  <RestaurantPage
    restaurantName="1887"
    address="Torridon Hotel, Annat, By Achnasheen, Torridon, IV22 2EY, United Kingdom"
    ...
    bio="Situated on the banks of Upper Loch Torridon with majestic mountains in the background and manicured gardens outside, this vibrantly decorated restaurant inside The Torridon hotel is in a truly stunning location. Exceptional Highlands produce is the bedrock of superbly balanced dishes that could be either classic or original in their make-up: from day-boat John Dory with a sublime roast chicken sauce, to the clever combination of white chocolate and rocket with preserved brambles. An extensive global whisky collection adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Torridon%20Hotel%2C%20Annat%2C%20By%20Achnasheen%2C%20Torridon%2C%20IV22%202EY%2C%20United%20Kingdom"
    pageTitle="1887"
  />
);
