...
const MaisonBleue = () => (
  <RestaurantPage
    ...
    address="30-31 Churchgate Street, Bury St Edmunds, IP33 1RG, United Kingdom"
    cuisine="French"
    priceRange="£££"
    phoneNumber="+441284760623"
    website="https://www.maisonbleue.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A converted 17th-century house plays host to this town centre restaurant that – as the name would suggest – is firmly French at heart. The cooking is classic Gallic in base, with occasional modern and international touches on show. Seafood is a strength, with fine produce like fresh tail of turbot cooked with obvious skill by the kitchen team. Your final course will be a treat too, with desserts like brûlée of pear as well as excellent French cheeses from the trolley – accompanied by some fine wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30-31%20Churchgate%20Street%2C%20Bury%20St%20Edmunds%2C%20IP33%201RG%2C%20United%20Kingdom"
    pageTitle="Maison Bleue"
  />
);

export default MaisonBleue;
