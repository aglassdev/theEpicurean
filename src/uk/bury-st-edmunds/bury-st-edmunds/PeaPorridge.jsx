...
const PeaPorridge = () => (
  <RestaurantPage
    ...
    bio="Tucked away on a residential square, this neighbourhood restaurant is warmly and personally run by a husband and wife team, and the unusual name is a nod to the old town green which once stood out front. The daily changing menu of North African, Middle Eastern and Mediterranean dishes involves a range of ingredients cooked over charcoal. The sourdough flatbread fresh from the oven kicks things off perfectly and the unfussy dishes deliver bold, well-defined flavours which are skilfully executed. The esoteric wine list champions organic and natural wines, while the lunch menu provides great value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28-29%20Cannon%20Street%2C%20Bury%20St%20Edmunds%2C%20IP33%201JR%2C%20United%20Kingdom"
    pageTitle="Pea Porridge"
  />
);

export default PeaPorridge;
