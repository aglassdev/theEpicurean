...
const Lark = () => (
  <RestaurantPage
    restaurantName="Lark"
    address="6A Angel Hill, Bury St Edmunds, IP33 1UZ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441284652244"
    website="https://larkrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small, sweet building overlooks an abbey and a cathedral in the centre of this historic market town. Over the years, it has been a police station, a bus shelter and a florist; now it’s a pared-back restaurant with polished concrete floors and modern art adorning the whitewashed walls. Choose from a great range of modern small plates that deliver satisfying, carefully judged flavours with a definite Mediterranean influence. Dishes could include tempura courgette flower or sopressini cacio e pepe – if you can’t make your mind up, go for the ‘Kitchen Selection’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6A%20Angel%20Hill%2C%20Bury%20St%20Edmunds%2C%20IP33%201UZ%2C%20United%20Kingdom"
    pageTitle="Lark"
  />
);
