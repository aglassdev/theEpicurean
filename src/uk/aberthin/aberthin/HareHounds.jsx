...
const HareHounds = () => (
  <RestaurantPage
    ...
    bio="The chef’s passionate desire to make this 300 year old pub the most seasonal in Wales is laudable. Menus change twice daily and produce is from his 3 acre allotment and family farms – and he also hunts and forages. The cooking is unfussy yet dishes are absolutely bursting with flavour; if you get a chance, don’t miss the buttermilk pudding. A great value 'Saver' menu is available for lunch Thursday to Saturday and early evening on Wednesday and Thursday...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maendy%20Road%2C%20Aberthin%2C%20CF71%207LG%2C%20United%20Kingdom"
    pageTitle="Hare & Hounds"
  />
);

export default HareHounds;
