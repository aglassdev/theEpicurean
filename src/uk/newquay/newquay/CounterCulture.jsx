...
const CounterCulture = () => (
  <RestaurantPage
    restaurantName="Counter Culture"
    address="4, Beach Parade, Beach Road, Newquay, TR7 1ET, United Kingdom"
    cuisine="Sharing, European"
    priceRange="££"
    phoneNumber="+447903091747"
    website="https://counterculturenewquay.co.uk/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%2C%20Beach%20Parade%2C%20Beach%20Road%2C%20Newquay%2C%20TR7%201ET%2C%20United%20Kingdom"
    pageTitle="Counter Culture"
  />
);

export default CounterCulture;
