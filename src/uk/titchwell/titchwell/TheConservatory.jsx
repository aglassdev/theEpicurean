...
const TheConservatory = () => (
  <RestaurantPage
    restaurantName="The Conservatory"
    address="Titchwell, PE31 8BB, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441485210221"
    website="https://titchwellmanor.com/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Titchwell Manor’s formal dining room is a bright, airy space looking out over the walled gardens. Cooking champions local ingredients with seafood from Brancaster Staithe and meat and game from local estates. Unfussy modern classics focus on natural flavours, using a less-is-more approach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Titchwell%2C%20PE31%208BB%2C%20United%20Kingdom"
    pageTitle="The Conservatory"
  />
);

export default TheConservatory;
