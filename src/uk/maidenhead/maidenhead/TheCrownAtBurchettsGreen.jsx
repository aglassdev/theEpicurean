...
const TheCrownAtBurchettsGreen = () => (
  <RestaurantPage
    restaurantName="The Crown Burchetts Green"
    address="Burchetts Green Lane, Burchetts Green, Maidenhead, SL6 6QZ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+447502025837"
    website="https://www.crownburchettsgreen.co.uk"
    aliases={["The Crown at Burchetts Green"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Experienced and capable Chef-Owner Dominic Chapman is at the helm of this charming pub serving food that is befitting of the setting. The rewarding, flavoursome dishes – like the delicious chicken liver and duck parfait with fig chutney – are a perfect match for the warm and comforting surroundings, while the kitchen adopts a seasonal approach to the produce used. For a great value option, go for the fixed-price 'village menu'...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burchetts%20Green%20Lane%2C%20Burchetts%20Green%2C%20Maidenhead%2C%20SL6%206QZ%2C%20United%20Kingdom"
    pageTitle="The Crown Burchetts Green"
  />
);

export default TheCrownAtBurchettsGreen;
