...
const LilyByAidenByrne = () => (
  <RestaurantPage
    restaurantName="LI~LY by Aiden Byrne"
    address="48 King Street, Knutsford, WA16 6DT, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441565760133"
    website="https://www.lilyrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This black-and-white timbered building is reputedly over 400 years old, but you wouldn’t know it from the smart, contemporary interior with a wonderfully bright feel. It’s the latest venture from experienced chef Aiden Byrne, who here offers his brand of detailed, eye-catchingly presented cooking via a tasting menu of technically adept dishes such as cured scallop with golden beetroot and white currant. Byrne delivers some of the dishes himself, at which point you will notice his infectious enthusiasm shining through...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=48%20King%20Street%2C%20Knutsford%2C%20WA16%206DT%2C%20United%20Kingdom"
    pageTitle="LI~LY by Aiden Byrne"
  />
);

export default LilyByAidenByrne;
