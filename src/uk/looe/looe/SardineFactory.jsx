...
const SardineFactory = () => (
  <RestaurantPage
    restaurantName="Sardine Factory"
    address="Quay Road, West Looe, Looe, PL13 2BX, United Kingdom"
    cuisine="Seafood"
    priceRange="££"
    phoneNumber="+441503770262"
    website="https://www.thesardinefactorylooe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A converted sardine factory on the quayside plays host to this laid-back and admirably well-run first floor restaurant which affords views across the harbour to East Looe. The extensive menu champions Cornish seafood across a range of tasty, well-priced dishes that have been prepared with evident care. The cooking is appealingly straightforward, with popular fish and shellfish dishes like moules marinière and crab linguine on the menu. Don't forget to try the fabulous sardines too, of course!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Quay%20Road%2C%20West%20Looe%2C%20Looe%2C%20PL13%202BX%2C%20United%20Kingdom"
    pageTitle="Sardine Factory"
  />
);

export default SardineFactory;
