...
const TheBarleySheaf = () => (
  <RestaurantPage
    restaurantName="The Barley Sheaf"
    address="Gorran Churchtown, PL26 6HN, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441726843330"
    website="https://www.thebarleysheafgorran.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive 18C pub has a deceptively large interior, with a rustic, pine-furnished dining area, a capacious bar and space to dine upstairs too. The well-priced menu lists pub classics alongside more ambitious dishes and much of the produce comes from in and around the Roseland Peninsula...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gorran%20Churchtown%2C%20PL26%206HN%2C%20United%20Kingdom"
    pageTitle="The Barley Sheaf"
  />
);

export default TheBarleySheaf;
