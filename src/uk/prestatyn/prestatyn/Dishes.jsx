...
const Dishes = () => (
  <RestaurantPage
    ...
    address="194 High Street, Prestatyn, LL19 9BW, United Kingdom"
    cuisine="British Contemporary"
    priceRange="£££"
    phoneNumber="+441745771332"
    website="https://www.restaurantdishes.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Andrew Sheridan has returned to his native north Wales to open this stylish restaurant occupying a former cloth shop on the High Street. Take a seat at the counter or a high-topped table and relish the opportunity to delve into a roll-call of terrific Welsh ingredients – be it meaty Menai oysters or caramelised mutton belly from just up the road. Order sharing plates from the à la carte or opt for the chef’s choice if you’re indecisive. A relaxed atmosphere pervades throughout, with both the service team and chefs adept at interacting with their guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=194%20High%20Street%2C%20Prestatyn%2C%20LL19%209BW%2C%20United%20Kingdom"
    pageTitle="Dishes"
  />
);
