...
const RtCafGrill = () => (
  <RestaurantPage
    restaurantName="RT Café Grill"
    address="Royal Maritime House, 17 St. Thomas Street, Ryde, PO33 2DL, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441983526118"
    website="https://www.robertthompson.co.uk/rt-cafe-grill"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Royal%20Maritime%20House%2C%2017%20St.%20Thomas%20Street%2C%20Ryde%2C%20PO33%202DL%2C%20United%20Kingdom"
    pageTitle="RT Café Grill"
  />
);

export default RtCafGrill;
