...
const Restaurant1812 = () => (
  <RestaurantPage
    restaurantName="Restaurant 1812"
    address="1 Staithe Road, Stalham, NR12 9BY, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441692434012"
    website="https://www.restaurant1812.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Right across the road from the water’s edge in the Norfolk Broads, you’ll find this building dating back to 1812 which has had previous lives as a warehouse and a pub; the simple yet stylish interior features the remains of a flint-clad kiln they discovered during the restoration. A set menu brings together a bounty of Norfolk produce, from both local artisans and the owner’s garden, along with mushrooms grown on site. The seasonal dishes show off some subtle, well-judged Japanese influences, while the terrific sourdough bread makes for a great beginning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Staithe%20Road%2C%20Stalham%2C%20NR12%209BY%2C%20United%20Kingdom"
    pageTitle="Restaurant 1812"
  />
);

export default Restaurant1812;
