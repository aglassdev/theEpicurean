...
const WhiteHartAtFyfield = () => (
  <RestaurantPage
    restaurantName="White Hart at Fyfield"
    address="Main Road, Fyfield, OX13 5LW, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441865390585"
    website="https://www.whitehart-fyfield.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a lot to love about this imposing 15th-century chantry house. There’s the three-storey, vaulted dining room for starters, joined by a cosy open-fired bar and a minstrels’ gallery, while outside you’ll find a terrace, a vegetable garden and an outdoor kitchen with wood-fired oven. The cooking is guided by their own seasonal produce, with both British and Mediterranean influences on the flavoursome, carefully prepared dishes. The friendly service team run the restaurant well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Road%2C%20Fyfield%2C%20OX13%205LW%2C%20United%20Kingdom"
    pageTitle="White Hart at Fyfield"
  />
);

export default WhiteHartAtFyfield;
