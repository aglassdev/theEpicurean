...
const KinneucharInn = () => (
  <RestaurantPage
    restaurantName="Kinneuchar Inn"
    address="9-11 Main Street, Kilconquhar, KY9 1LF, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441333340377"
    website="https://www.kinneucharinn.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The maxim ‘less is more’ is rarely so well applied as it is here. East Neuk’s bounteous local larder is showcased on a menu that changes up to twice a day; fresh fish is a highlight, and the specials are just that. This charming 17C village pub has a modish feel – sit in the cosy bar or vaulted dining room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9-11%20Main%20Street%2C%20Kilconquhar%2C%20KY9%201LF%2C%20United%20Kingdom"
    pageTitle="Kinneuchar Inn"
  />
);

export default KinneucharInn;
