...
const Andria = () => (
  <RestaurantPage
    restaurantName="Andria"
    address="5 Lower Street, Dartmouth, TQ6 9AJ, United Kingdom"
    cuisine="Modern Cuisine, European"
    priceRange="££"
    phoneNumber="+441803833222"
    website="https://andriadartmouth.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A grab bag of influences from across the world fuse together to wonderful effect at this popular high-street spot whose precise, well-crafted cooking contrasts with its rustic appearance. Dishes like gnocchi with onion soubise showcase Chef-Owner Luca Berardino's French and Italian heritage, while others look further afield, such as the cleverly thought-out scallops with roe sauce and carrot kimchi. Uniting the menu is a pride in local seafood, particularly from Torbay and Brixham. If you want a special experience, then book the chef's table upstairs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Lower%20Street%2C%20Dartmouth%2C%20TQ6%209AJ%2C%20United%20Kingdom"
    pageTitle="Andria"
  />
);

export default Andria;
