...
const TheShoregate = () => (
  <RestaurantPage
    restaurantName="The Shoregate"
    address="67 High Street North, Crail, KY10 3RA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441333451815"
    website="https://theshoregate.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s been an inn of some kind on this site for well over 100 years, and its current incarnation is surely one of the most appealing. A fine restoration has left it with a chic bistro-style dining room at the front and a characterful, stone-walled bar to the rear – plus four bedrooms upstairs, ideal for exploring Fife’s beautiful East Neuk. Dishes executed with palpable care combine with warm, attentive service to ensure you’ll have a smile on your face – once you’ve made the tricky choice between the likes of asparagus panna cotta and Scrabster cod with curried bisque...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20High%20Street%20North%2C%20Crail%2C%20KY10%203RA%2C%20United%20Kingdom"
    pageTitle="The Shoregate"
  />
);

export default TheShoregate;
