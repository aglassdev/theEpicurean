...
const TheBarringtonBoar = () => (
  <RestaurantPage
    restaurantName="The Barrington Boar"
    address="Main Street, Barrington, TA19 0JB, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441460259281"
    website="https://www.thebarringtonboar.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dating back to the 18C, this lovely stone-built inn sits in a picture postcard village and its back garden and terrace is a real jewel. The chef-owner’s personality, his experience in previous kitchens, and his knowledge of the locale, all inform his appealing menu of modern, balanced dishes that are big on flavour and guaranteed to hit the spot. Four bedrooms occupy what was once the skittle alley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Barrington%2C%20TA19%200JB%2C%20United%20Kingdom"
    pageTitle="The Barrington Boar"
  />
);

export default TheBarringtonBoar;
