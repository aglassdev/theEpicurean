...
const Darleys = () => (
  <RestaurantPage
    restaurantName="Darleys"
    address="Waterfront, Darley Abbey Mill, Darley Abbey, DE22 1DZ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£"
    phoneNumber="+441332364987"
    website="https://darleys.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the old canteen of a 19C silk mill, Darleys offers a great view out over the river and the weir. It’s a stylish place with eye-catching décor; ask for a table on the narrow terrace or one beside the window on the upper level. Appealing dishes are creative and generously proportioned...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Waterfront%2C%20Darley%20Abbey%20Mill%2C%20Darley%20Abbey%2C%20DE22%201DZ%2C%20United%20Kingdom"
    pageTitle="Darleys"
  />
);

export default Darleys;
