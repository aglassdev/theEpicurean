...
const Ashas = () => (
  <RestaurantPage
    ...
    address="Edmund House, 12-22 Newhall Street, Birmingham, B3 3LX, United Kingdom"
    cuisine="Indian"
    priceRange="£££"
    phoneNumber="+441212002767"
    website="https://ashasbirmingham.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Renowned Indian singer, actress and gourmet Asha Bhosle is the eponymous driving force behind a string of international restaurants, including this stylish, passionately run and deservedly packed spot in the heart of Birmingham. The extensive menus cover most parts of the Indian Subcontinent, with tandoori kebabs a speciality and no shortage of vegetarian options. Each dish is cooked with skill and provides serious flavour – such as the superior Muscat gosht, which is a recipe from Asha herself...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Edmund%20House%2C%2012-22%20Newhall%20Street%2C%20Birmingham%2C%20B3%203LX%2C%20United%20Kingdom"
    pageTitle="Asha's"
  />
);

export default Ashas;
