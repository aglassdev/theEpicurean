...
const ChefsTableByJoshBarnes = () => (
  <RestaurantPage
    restaurantName="Chef's Table by Josh Barnes"
    address="Swinton Park, Masham, Swinton, HG4 4JH, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441765680900"
    website="https://www.swintonestate.com/dining/chefs-table-by-josh-barnes/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a bright, airy former stable that doubles as a cookery school within the sprawling Swinton Estate, this restaurant delivers what it promises: an intimate counter dining experience where Chef Josh Barnes and his team cook in front of you and serve their dishes with pride. The place has a country kitchen feel befitting of this grand domain – which also houses a hotel – while the Estate itself provides much of the seasonal produce. The cooking comes with some creative twists, such as using locally foraged mushrooms to add richness to a chocolate mousse. The wine flight, too, contains unusual and intriguing touches...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Swinton%20Park%2C%20Masham%2C%20Swinton%2C%20HG4%204JH%2C%20United%20Kingdom"
    pageTitle="Chef's Table by Josh Barnes"
  />
);

export default ChefsTableByJoshBarnes;
