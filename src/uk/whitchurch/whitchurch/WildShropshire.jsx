...
const WildShropshire = () => (
  <RestaurantPage
    restaurantName="Wild Shropshire"
    address="25-27 Green End, Whitchurch, SY13 1AD, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+447935643806"
    website="https://www.wildshropshire.net"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Self-taught chef James Sherwin’s dream came true when he opened this endearing restaurant that’s the epitome of field-to-fork dining. Micro-seasonal produce is grown on their Wild Shropshire farm before being fashioned into a daily changing surprise menu for a maximum of 14 guests. There’s a Japanese influence throughout the harmoniously flavoured dishes, including ingredients like furikake, koji and yuzu, as well as a sake pairing. The passionate, welcoming team offer lovely, personable service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25-27%20Green%20End%2C%20Whitchurch%2C%20SY13%201AD%2C%20United%20Kingdom"
    pageTitle="Wild Shropshire"
  />
);

export default WildShropshire;
