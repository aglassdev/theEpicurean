...
const TheBrasserieAtSaltmoore = () => (
  <RestaurantPage
    restaurantName="The Brasserie at Saltmoore"
    address="Saltmoore, Sandsend Road, Whitby, YO21 3ST, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441947661661"
    website="https://saltmoore.co.uk/restaurants/brasserie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the extensive Saltmoore hotel and wellness resort, this chic modern brasserie welcomes guests into an elegant dining room of green walls, seersucker upholstery and marble café-style tables. The friendly service team are happy to guide you through the menu, which has a classic British heart and makes a feature of prime meats cooked on the grill. Some seasonal local produce makes an appearance too, like wonderfully pure Whitby crab in an unfussy tartlet, or crème brûlée sweetened with heather honey from the North York Moors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Saltmoore%2C%20Sandsend%20Road%2C%20Whitby%2C%20YO21%203ST%2C%20United%20Kingdom"
    pageTitle="The Brasserie at Saltmoore"
  />
);

export default TheBrasserieAtSaltmoore;
