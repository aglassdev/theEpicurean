...
const BarryFish = () => (
  <RestaurantPage
    restaurantName="Barry Fish"
    address="62 The Shore, Leith, EH6 6RA, United Kingdom"
    cuisine="Seafood"
    priceRange="£££"
    phoneNumber="+441316250000"
    website="https://www.barryfish.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yet another terrific eatery in the foodie haven of Leith, this instantly likeable restaurant unsurprisingly offers a fabulous feast of fish. From whole sole to the signature sea trout pastrami, the cooking is fuss-free and cleanly executed to show off the natural flavours of the ingredients. At lunch, share plates from the ‘Big Snacks’ selection, which at dinnertime become starters to be enjoyed before larger offerings such as a half lobster with smoked fish agnolotti. The team are one of the most welcoming around, so you’re sure to be well looked after...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=62%20The%20Shore%2C%20Leith%2C%20EH6%206RA%2C%20United%20Kingdom"
    pageTitle="Barry Fish"
  />
);

export default BarryFish;
