...
const Fern = () => (
  <RestaurantPage
    restaurantName="Fern"
    address="Pendewey Farm, Stony Lane, Nanstallon, PL31 2QX, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441208226155"
    website="http://www.ferncornwall.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This striking barn conversion is the kind of restaurant where you want to kick back and relax, soak in the calm atmosphere and enjoy the farm-fed dishes at a leisurely pace. In fact, this kind of unhurried, produce-led dining is exactly what their ‘Beyond the Roast’ Sunday menu endorses. Whenever you visit, you can expect a stylish dining room and equally good-looking dishes, such as their take on apple and pear crumble that’s as delicious as it is unconventional. The farm’s cottages are available if you’re looking to stay the night...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pendewey%20Farm%2C%20Stony%20Lane%2C%20Nanstallon%2C%20PL31%202QX%2C%20United%20Kingdom"
    pageTitle="Fern"
  />
);
