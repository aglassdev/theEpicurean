...
const TheFreeCompany = () => (
  <RestaurantPage
    restaurantName="The Free Company"
    address="Cockdurno Farmhouse, Balerno, EH14 7HZ, United Kingdom"
    cuisine="Regional Cuisine"
    priceRange="£££"
    phoneNumber="+447350396948"
    website="https://www.the-free-company.com/restaurant"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the kind of restaurant where you can feel the love and enthusiasm poured into every part of the experience. Two brothers have taken over their dad’s former dairy farm and converted the old milking barn into a stylishly rustic dining space. Embrace the refectory-style communal tables and get to know your fellow diners as you enjoy thoughtfully composed dishes fed by terrific produce from the no-dig farm – such as pressed hogget shoulder with asparagus and radish. The charming service team are as passionate as the kitchen, believing wholeheartedly in their mission...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cockdurno%20Farmhouse%2C%20Balerno%2C%20EH14%207HZ%2C%20United%20Kingdom"
    pageTitle="The Free Company"
  />
);

export default TheFreeCompany;
