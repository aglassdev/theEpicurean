...
const LakeRoadKitchen = () => (
  <RestaurantPage
    restaurantName="Lake Road Kitchen"
    address="Lake Road, Ambleside, LA22 0AD, United Kingdom"
    cuisine="Creative"
    priceRange="££££"
    phoneNumber="+441539422012"
    website="https://www.lakeroadkitchen.co.uk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nordic décor meets the Lake District at this intimate restaurant, where wooden planks line the walls and sheepskins cover the chairs. The Lakes provides much of the top-drawer produce, although the chefs do look further afield, with a few Japanese influences being incorporated, such as in the Ōra King salmon with karebushi, tomato and maple dashi. Dishes often look simple, but are in fact complex, creative and contain impressive depth of flavour – years of culinary experience are evident in every mouthful. Service is smooth, with the detailed dish descriptions delivered with confidence and pride...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lake%20Road%2C%20Ambleside%2C%20LA22%200AD%2C%20United%20Kingdom"
    pageTitle="Lake Road Kitchen"
  />
);

export default LakeRoadKitchen;
