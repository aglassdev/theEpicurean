...
const BeachHouse = () => (
  <RestaurantPage
    restaurantName="Beach House"
    address="Oxwich Beach, Oxwich, SA3 1LS, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441792278277"
    website="https://beachhouseoxwich.co.uk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A former coal store is the setting for this beachside restaurant on the beautiful Gower Peninsula. Head Chef Hywel Griffith was born in north Wales and his passion for the country is palpable; he writes his menus in both English and Welsh, and shows admirable support for the country’s producers. Sophisticated, classical cooking is the focus and dishes are reassuringly recognisable. Contrasts in flavour are well-judged and the various components work together to put the spotlight on the main ingredient. The bara brith soufflé is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oxwich%20Beach%2C%20Oxwich%2C%20SA3%201LS%2C%20United%20Kingdom"
    pageTitle="Beach House"
  />
);
