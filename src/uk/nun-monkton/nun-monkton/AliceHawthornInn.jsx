...
const AliceHawthornInn = () => (
  <RestaurantPage
    restaurantName="Alice Hawthorn Inn"
    address="The Green, Nun Monkton, YO26 8EW, United Kingdom"
    cuisine="Regional Cuisine, Traditional British"
    priceRange="££"
    phoneNumber="+441423330303"
    website="https://www.thealicehawthorn.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This smartly modernised dining pub sits on a large village green where, as well as a duck pond, you’ll find the country’s tallest maypole. Guests are spread across multiple rooms that are all packed with charm, character and the obligatory exposed brickwork and beams. The hearty, well-presented dishes showcase some garden produce and know no borders, meaning you could find dynamite shrimp and sea bass ceviche alongside fish & chips and leek & potato soup. Welcoming service and smart, slightly Scandic-style bedrooms complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Green%2C%20Nun%20Monkton%2C%20YO26%208EW%2C%20United%20Kingdom"
    pageTitle="Alice Hawthorn Inn"
  />
);

export default AliceHawthornInn;
