...
const OxBarn = () => (
  <RestaurantPage
    restaurantName="Ox Barn"
    address="Southrop Manor Estate, Southrop, GL7 3NX, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441367850174"
    website="https://www.thyme.co.uk/eat/ox-barn"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This delightful barn conversion sits in an idyllic rural location in the heart of the Cotswolds, surrounded by Provençal-style gardens; it’s part of the Thyme complex and no expense has been spared in its stunning restoration. Beautifully pared-back, flavour-packed dishes follow a nature-to-plate philosophy, showcasing ingredients from their kitchen gardens and farm in Mediterranean-inspired recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Southrop%20Manor%20Estate%2C%20Southrop%2C%20GL7%203NX%2C%20United%20Kingdom"
    pageTitle="Ox Barn"
  />
);

export default OxBarn;
