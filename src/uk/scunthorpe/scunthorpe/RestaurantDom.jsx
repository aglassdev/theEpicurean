...
const RestaurantDom = () => (
  <RestaurantPage
    restaurantName="Restaurant DOM"
    address="7-9 Robert Street, Scunthorpe, DN15 6LU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441724506816"
    website="https://www.restaurantdom.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Slawomir Mikolajczyk from The Hope & Anchor in South Ferriby has given this town centre spot a top-to-toe refurbishment and it’s a place you’ll quickly fall in love with. The smart, wood-clad interior features shelves bursting with jam, pickles and preserves; in winter you’ll likely find some in your meal, such as pear and beetroot chutney with creamy duck liver parfait. The cooking as a whole is overtly seasonal and strives for a nose-to-tail approach, while Mikolajczyk’s Polish heritage comes into play too, including his grandmother’s sauerkraut recipe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-9%20Robert%20Street%2C%20Scunthorpe%2C%20DN15%206LU%2C%20United%20Kingdom"
    pageTitle="Restaurant DOM"
  />
);
