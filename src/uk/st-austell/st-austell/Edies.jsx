...
const Edies = () => (
  <RestaurantPage
    restaurantName="Edie's"
    address="10 Beach Road, Carlyon Bay, St Austell, PL25 3PH, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441726813888"
    website="https://www.edies.restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's a family affair at this relaxed, friendly restaurant that’s sure to put a smile on your face. Nigel is at the stoves and his wife Kelly is out front, aided by their daughter, the eponymous Edie. Brightly coloured chairs stand out against whitewashed brick walls, the shelves are crammed with cookbooks and there’s a terrific buzz from the open kitchen. Nigel’s experience shows in the unfussy, well-crafted dishes, which deliver appealing and effective flavour combinations with notable clarity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10%20Beach%20Road%2C%20Carlyon%20Bay%2C%20St%20Austell%2C%20PL25%203PH%2C%20United%20Kingdom"
    pageTitle="Edie's"
  />
);

export default Edies;
