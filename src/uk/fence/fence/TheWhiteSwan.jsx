...
const TheWhiteSwan = () => (
  <RestaurantPage
    restaurantName="The White Swan"
    address="300 Wheatley Lane Road, Fence, BB12 9QA, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441282611773"
    website="https://www.whiteswanatfence.co.uk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The pub formerly known as 'The Mucky Duck' remains a traditional place where you’re guaranteed a laid-back atmosphere and a proper pint. Indeed, it is rare to find somewhere this relaxing that serves food quite this good. The set menu allows the kitchen to concentrate on delivering great value cooking from small batches of top-quality local produce. Seasonal dishes like full-flavoured hogget with morels and asparagus are a prime example, showcasing impressive classical technique and providing delicious depth of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=300%20Wheatley%20Lane%20Road%2C%20Fence%2C%20BB12%209QA%2C%20United%20Kingdom"
    pageTitle="The White Swan"
  />
);

export default TheWhiteSwan;
