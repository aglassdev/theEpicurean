...
const TheAbbeyInn = () => (
  <RestaurantPage
    restaurantName="The Abbey Inn"
    address="Byland, YO61 4BD, United Kingdom"
    ...
    bio="There is a simple, homely feel to this pub overlooking the ruins of Byland Abbey, courtesy of its flagstone floor, colourful throws and blazing fires in the winter. The comforting British cooking matches the seasons well, while providing crowd-pleasing menu mainstays like their signature 'Byland Burger'. The owners, who also run The Black Swan in nearby Oldstead, provide much of the superb produce from their own farm. Traditional bedrooms sit upstairs and, in the summer, the garden terrace makes a great spot for a pint...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Byland%2C%20YO61%204BD%2C%20United%20Kingdom"
    pageTitle="The Abbey Inn"
  />
);

export default TheAbbeyInn;
