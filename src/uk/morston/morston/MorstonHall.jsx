...
const MorstonHall = () => (
  <RestaurantPage
    restaurantName="Morston Hall"
    address="The Street, Morston, NR25 7AA, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441263741041"
    website="https://www.morstonhall.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A few bites in and it’s patently obvious that Galton Blackiston is a chef with a deep knowledge and appreciation of great produce. Whether picked from the kitchen garden, foraged from nearby beaches or sourced from the best suppliers across the UK, the ingredients are superb, and are allowed to shine thanks to clean, focused dishes with classical flavour combinations. The conservatory looking out over the garden is the place to sit in the summer months, while those staying the night can choose from contemporary country house bedrooms or more luxurious garden rooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Street%2C%20Morston%2C%20NR25%207AA%2C%20United%20Kingdom"
    pageTitle="Morston Hall"
  />
);

export default MorstonHall;
