...
const SunInn = () => (
  <RestaurantPage
    ...
    address="6 Market Street, Kirkby Lonsdale, LA6 2AU, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441524271965"
    website="https://sun-inn.info"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Market%20Street%2C%20Kirkby%20Lonsdale%2C%20LA6%202AU%2C%20United%20Kingdom"
    pageTitle="Sun Inn"
  />
);

export default SunInn;
