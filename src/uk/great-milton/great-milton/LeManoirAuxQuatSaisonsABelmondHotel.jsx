...
const LeManoirAuxQuatSaisonsABelmondHotel = () => (
  <RestaurantPage
    restaurantName="Le Manoir aux Quat' Saisons, a Belmond Hotel"
    address="Church Road, Great Milton, OX44 7PD, United Kingdom"
    cuisine="French"
    priceRange="££££"
    phoneNumber="+441844278881"
    website="https://www.belmond.com/hotels/europe/uk/oxfordshire/belmond-le-manoir-aux-quat-saisons/dining"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="You cannot help but fall in love with this iconic country house restaurant. As its name suggests, the seasons lead the way: wander the grounds and you’ll discover an amazing array of plants, as well as a 2,500 strong orchard. Raymond Blanc's protégé, Luke Selby, now heads up the kitchen and, while the skilfully executed cooking has a classic French base, it also comes with a light, modern touch. The multi-course set menus are exquisitely balanced; flavours are intense, combinations are sophisticated, and the presentation shows an eye for detail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Church%20Road%2C%20Great%20Milton%2C%20OX44%207PD%2C%20United%20Kingdom"
    pageTitle="Le Manoir aux Quat' Saisons, a Belmond Hotel"
  />
);

export default LeManoirAuxQuatSaisonsABelmondHotel;
