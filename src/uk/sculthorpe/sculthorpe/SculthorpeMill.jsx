...
const SculthorpeMill = () => (
  <RestaurantPage
    restaurantName="Sculthorpe Mill"
    address="Lynn Road, Sculthorpe, NR21 9QG, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441328633001"
    website="https://www.sculthorpemill.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dating all the way back to 1757, this striking former mill looks like it's been taken off the front of a Norfolk picture postcard. Lovingly restored by sisters Siobhan and Caitriona Peyton, it's now a chic dining pub with contemporary bedrooms and a riverside terrace. The cooking doesn't reinvent the wheel, but instead offers well-judged, flavoursome dishes like green gazpacho with Cromer crab. Ensure you save some room for dessert, especially if the terrific Norfolk pear and hazelnut tart is on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lynn%20Road%2C%20Sculthorpe%2C%20NR21%209QG%2C%20United%20Kingdom"
    pageTitle="Sculthorpe Mill"
  />
);

export default SculthorpeMill;
