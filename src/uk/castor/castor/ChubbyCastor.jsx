...
const ChubbyCastor = () => (
  <RestaurantPage
    restaurantName="Chubby Castor"
    address="Fitzwilliam Arms, 34 Peterborough Road, Castor, PE5 7AX, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+442081493777"
    website="https://www.thechubbycastor.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are few more inviting sights in Britain than a proper thatched pub. The Chubby Castor is a fine example, a 400-year-old village inn whose chocolate-box exterior belies its more modern, bright and somewhat glitzy interior design that stretches from a smart lounge into the intimate, linen-laid dining room. The cooking, overseen by experienced chef-owner Adebola Adeshina, is centred around time-honoured recipes that deliver on flavour. For dessert, look out for the wonderful Firetree chocolate with peanuts and caramel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fitzwilliam%20Arms%2C%2034%20Peterborough%20Road%2C%20Castor%2C%20PE5%207AX%2C%20United%20Kingdom"
    pageTitle="Chubby Castor"
  />
);

export default ChubbyCastor;
