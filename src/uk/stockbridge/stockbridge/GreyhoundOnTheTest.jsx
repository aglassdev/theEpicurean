...
const GreyhoundOnTheTest = () => (
  <RestaurantPage
    restaurantName="Greyhound on the Test"
    address="31 High Street, Stockbridge, SO20 6EY, United Kingdom"
    cuisine="British Contemporary"
    priceRange="££"
    phoneNumber="+441264810833"
    website="https://thegreyhoundonthetest.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The picturesque town of Stockbridge plays host to this striking mustard-coloured pub with low beams, elegant décor and a wood-burning stove. The chatty team deliver appealing modern British dishes crafted from local produce. Homely bedrooms and a mile of River Test fishing rights complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20High%20Street%2C%20Stockbridge%2C%20SO20%206EY%2C%20United%20Kingdom"
    pageTitle="Greyhound on the Test"
  />
);

export default GreyhoundOnTheTest;
