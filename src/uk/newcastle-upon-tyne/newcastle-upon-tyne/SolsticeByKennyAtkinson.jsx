...
const SolsticeByKennyAtkinson = () => (
  <RestaurantPage
    restaurantName="SOLSTICE BY KENNY ATKINSON"
    address="5-7 Side, Newcastle Upon Tyne, NE1 3JE, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441912221722"
    website="https://www.solsticencl.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This intimate, personably run restaurant is just around the corner from the eponymous chef-owner’s flagship, House of Tides, and serves a multi-course tasting menu of well-balanced, highly intricate and complex dishes. The kitchen’s skill allows top-drawer ingredients to shine, whether that be scallops or pigeon, and the meal ends on a high with the varied, exquisitely constructed desserts. The chefs present the plates to guests themselves and provide detailed descriptions of their make-up. Go for the wine pairing for the ultimate dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-7%20Side%2C%20Newcastle%20Upon%20Tyne%2C%20NE1%203JE%2C%20United%20Kingdom"
    pageTitle="SOLSTICE BY KENNY ATKINSON"
  />
);

export default SolsticeByKennyAtkinson;
