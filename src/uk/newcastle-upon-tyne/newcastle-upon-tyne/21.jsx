...
const TwoOne = () => (
  <RestaurantPage
    restaurantName="21"
    address="Trinity Gardens, Newcastle Upon Tyne, NE1 2HH, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441912220755"
    website="https://21newcastle.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Start with a gin from the large selection behind the zinc-topped counter then head through to the smart red and black brasserie. Menus offer a comprehensive array of confidently cooked classics; the ‘menu du jour’ is good value...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Trinity%20Gardens%2C%20Newcastle%20Upon%20Tyne%2C%20NE1%202HH%2C%20United%20Kingdom"
    pageTitle="21"
  />
);
