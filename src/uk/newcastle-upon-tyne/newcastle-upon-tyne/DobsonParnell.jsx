...
const DobsonParnell = () => (
  <RestaurantPage
    restaurantName="Dobson & Parnell"
    address="19-21 Queen Street, Newcastle Upon Tyne, NE1 3UG, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441912210904"
    website="https://www.dobsonandparnell.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An iconic address in the city, this elegant restaurant is named after Victorian architects, John Dobson and William Parnell, who were responsible for creating the building in 1863. The menus offer plenty of choice, with the kitchen taking recognisable dishes and bringing them up to date; the fish dishes are particularly good. Do start with a pre-prandial cocktail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19-21%20Queen%20Street%2C%20Newcastle%20Upon%20Tyne%2C%20NE1%203UG%2C%20United%20Kingdom"
    pageTitle="Dobson & Parnell"
  />
);

export default DobsonParnell;
