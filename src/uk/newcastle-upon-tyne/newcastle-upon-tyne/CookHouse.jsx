...
const CookHouse = () => (
  <RestaurantPage
    restaurantName="COOK HOUSE"
    address="Foundry Lane Studios, Foundry Lane, Newcastle Upon Tyne, NE6 1LH, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441912761093"
    website="https://www.cookhouse.org/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After opening a shipping container café, local food blogger Anna Hedworth crowdfunded this stripped-back, industrial-style restaurant with a pleasant terrace and a relaxed feel. Dinner is the main event, with many of the vibrant, fiercely seasonal dishes cooked on the hibachi barbeque...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Foundry%20Lane%20Studios%2C%20Foundry%20Lane%2C%20Newcastle%20Upon%20Tyne%2C%20NE6%201LH%2C%20United%20Kingdom"
    pageTitle="COOK HOUSE"
  />
);
