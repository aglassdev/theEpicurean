...
const Osters = () => (
  <RestaurantPage
    restaurantName="Osters"
    address="125 High Street, Gosforth, Newcastle Upon Tyne, NE3 1HA, United Kingdom"
    cuisine="Seafood"
    priceRange="££"
    phoneNumber="+441918250240"
    website="https://www.osters.co.uk/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=125%20High%20Street%2C%20Gosforth%2C%20Newcastle%20Upon%20Tyne%2C%20NE3%201HA%2C%20United%20Kingdom"
    pageTitle="Osters"
  />
);

export default Osters;
