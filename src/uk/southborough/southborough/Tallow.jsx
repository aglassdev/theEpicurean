...
const Tallow = () => (
  <RestaurantPage
    restaurantName="Tallow"
    address="15a Church Road, Southborough, TN4 0RX, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441892341875"
    website="https://tallowrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You'll get a warm and friendly welcome at this cosy neighbourhood restaurant run by experienced couple Rob and Donna. Situated overlooking the green at Southborough, it's a rustic, homely place with an intimate chef's table counter upstairs if you're looking for a special occasion. Time and care is poured into every well-constructed dish, with each one showcasing the kitchen's strong knowledge of culinary techniques while delivering bold, hearty flavours. Look out for seasonal desserts like sake-marinated Gariguette strawberries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15a%20Church%20Road%2C%20Southborough%2C%20TN4%200RX%2C%20United%20Kingdom"
    pageTitle="Tallow"
  />
);

export default Tallow;
