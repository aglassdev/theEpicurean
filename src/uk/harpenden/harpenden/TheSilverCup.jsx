...
const TheSilverCup = () => (
  <RestaurantPage
    restaurantName="The Silver Cup"
    address="5 St Albans Road, Harpenden, AL5 2JF, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441582713095"
    website="https://www.thesilvercup.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dating all the way back to 1838, this Victorian pub is these days under the stewardship of siblings and Harpenden locals Matthew and Olivia. British racing green banquettes, leaded windows and a copper-topped bar give the place a comforting, traditional feel, while experienced chef Matthew is in the kitchen producing assured modern British dishes based around bold flavours. Regular steak nights make a feature of beef butchered in-house and Sunday lunch is something of an event...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20St%20Albans%20Road%2C%20Harpenden%2C%20AL5%202JF%2C%20United%20Kingdom"
    pageTitle="The Silver Cup"
  />
);

export default TheSilverCup;
