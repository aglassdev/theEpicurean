...
const PignutTheHare = () => (
  <RestaurantPage
    restaurantName="Pignut & The Hare"
    address="Hare inn, Scawton, YO7 2HG, United Kingdom"
    cuisine="Creative"
    priceRange="££££"
    phoneNumber="+441845597769"
    website="https://www.pignutandthehare.co.uk"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hare%20inn%2C%20Scawton%2C%20YO7%202HG%2C%20United%20Kingdom"
    pageTitle="Pignut & The Hare"
  />
);

export default PignutTheHare;
