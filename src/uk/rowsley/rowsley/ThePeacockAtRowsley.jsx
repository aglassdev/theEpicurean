...
const ThePeacockAtRowsley = () => (
  <RestaurantPage
    restaurantName="The Peacock at Rowsley"
    address="Bakewell Road, Rowsley, DE4 2EB, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441629733518"
    website="https://thepeacockatrowsley.com/dine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a prime corner site near the River Derwent, this foliage-clad former manor house is an inviting prospect as soon as you lay eyes on it. Inside, oak ‘Mousey Thompson’ furnishings and antique oil paintings are juxtaposed with modern lighting and contemporary art. The menus offer a broad spectrum, from light lunch bites like sandwiches, salads and ploughman’s, to a full dinner tasting menu with wine pairings – plus afternoon tea and Sunday roasts. Stay overnight in one of the antique-furnished bedrooms, then spend the next day exploring the Peak District...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bakewell%20Road%2C%20Rowsley%2C%20DE4%202EB%2C%20United%20Kingdom"
    pageTitle="The Peacock at Rowsley"
  />
);

export default ThePeacockAtRowsley;
