...
const GingerFox = () => (
  <RestaurantPage
    restaurantName="Ginger Fox"
    address="Muddleswood Road, Albourne, Henfield, BN6 9EA, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441273857888"
    website="https://www.gingermanrestaurants.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the edge of the woods, this long-standing thatched pub is full of character and you can't help but be carried away by the team's cheerful energy. It's run by the Gingerman Group, primarily based in Brighton, with this acting as their country outpost hidden away in the South Downs. Pubby favourites like Welsh rarebit or prawns with Marie Rose sauce are all present and correct, as are dishes with a little more flair; whatever you choose, the kitchen will lavish the same care upon it. The wine list includes some locally grown options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Muddleswood%20Road%2C%20Albourne%2C%20Henfield%2C%20BN6%209EA%2C%20United%20Kingdom"
    pageTitle="Ginger Fox"
  />
);

export default GingerFox;
