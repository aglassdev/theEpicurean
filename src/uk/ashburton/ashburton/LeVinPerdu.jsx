...
const LeVinPerdu = () => (
  <RestaurantPage
    restaurantName="Le Vin Perdu"
    address="11 West Street, Ashburton, TQ13 7DT, United Kingdom"
    cuisine="French"
    priceRange="££"
    phoneNumber="+441626927234"
    website="https://www.levinperdu.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The team behind Emilia, situated just a few doors down, have imparted another gift to the residents of Ashburton with this delightful rustic bistro. Where its sister operation is all-Italian, Le Vin Perdu is full-blooded French in its approach, so don’t be surprised to find the likes of pork terrine or rotisserie chicken on the menu. The décor is understatedly chic, with the bar making a great place for a cocktail or a glass of wine from the blackboard list. If you’re sweet of tooth, the tarte Tatin is a great note to end on...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20West%20Street%2C%20Ashburton%2C%20TQ13%207DT%2C%20United%20Kingdom"
    pageTitle="Le Vin Perdu"
  />
);

export default LeVinPerdu;
