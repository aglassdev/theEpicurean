...
const TheCotleyInn = () => (
  <RestaurantPage
    restaurantName="The Cotley Inn"
    address="Wambrook, TA20 3EN, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+44146062348"
    website="https://www.cotleyinnwambrook.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite being just a 10 minute drive from the centre of Chard, there’s a wonderfully rural feeling that accompanies a visit to this former 17C farmhouse. The inn is nestled in a lush green valley overlooking the Blackdown Hills, with its converted outbuildings turned into bedrooms. The cooking offers dashes of creativity while still delivering satisfying pub dishes like slow-roasted pork belly. They take a local, seasonal and nose-to-tail approach to their ingredients, with animals reared on site and produce grown in the kitchen garden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wambrook%2C%20TA20%203EN%2C%20United%20Kingdom"
    pageTitle="The Cotley Inn"
  />
);

export default TheCotleyInn;
