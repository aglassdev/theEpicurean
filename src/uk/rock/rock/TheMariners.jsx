...
const TheMariners = () => (
  <RestaurantPage
    restaurantName="The Mariners"
    address="Slipway, Rock, PL27 6LD, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441841532796"
    website="https://www.paul-ainsworth.co.uk/the-mariners/about/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the Paul Ainsworth stable, this large and popular pub is the ideal spot for some hearty British food while on your seaside holiday. You can arrive in the picturesque village of Rock via the ferry from Padstow, before grabbing a seat on the terrace which boasts stunning views over the Camel Estuary. The extensive menu is chock full of Cornish produce – be it cheddar, monkfish or mussels – with a seasonal menu sitting alongside 'Mariners Classics' such as shepherd's pie and fish & chips. For dessert, you can't go wrong with a crumble...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Slipway%2C%20Rock%2C%20PL27%206LD%2C%20United%20Kingdom"
    pageTitle="The Mariners"
  />
);

export default TheMariners;
