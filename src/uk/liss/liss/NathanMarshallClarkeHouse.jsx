...
const NathanMarshallClarkeHouse = () => (
  <RestaurantPage
    restaurantName="Nathan Marshall Clarke House"
    address="Clarke House, Farnham Road, Liss, GU33 6JQ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441730779360"
    website="https://nathanmarshallsrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the façade, you wouldn’t guess this was once a courthouse, but inside you’ll find a door leading to what was the judge’s bench. It’s a tiny place with exposed beams and a rustic style and is keenly run by a young couple. Cooking sees a little intricacy added to well-presented, country house style dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Clarke%20House%2C%20Farnham%20Road%2C%20Liss%2C%20GU33%206JQ%2C%20United%20Kingdom"
    pageTitle="Nathan Marshall Clarke House"
  />
);

export default NathanMarshallClarkeHouse;
