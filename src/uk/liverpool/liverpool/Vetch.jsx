...
const Vetch = () => (
  <RestaurantPage
    restaurantName="Vetch"
    address="29a Hope Street, Liverpool, L1 9BP, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441513943073"
    website="https://www.vetchrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on Hope Street alongside numerous other eateries, there’s a homely feel to this personably and knowledgably run restaurant. The décor is all about understatement, with minimalist furnishings and neutral tones. The modern, well-versed cooking successfully incorporates a range of East Asian influences including shokupan milk bread, Korean chicken wings and char siu pork belly. At dinner, it’s a tasting menu affair which shows the full breadth of the cooking, but keep an eye out for the great value offering at lunch and early evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29a%20Hope%20Street%2C%20Liverpool%2C%20L1%209BP%2C%20United%20Kingdom"
    pageTitle="Vetch"
  />
);

export default Vetch;
