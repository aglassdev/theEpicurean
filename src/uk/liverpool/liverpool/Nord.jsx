...
const Nord = () => (
  <RestaurantPage
    restaurantName="NORD"
    address="100 Old Hall Street, Liverpool, L3 9QJ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441515590654"
    website="https://nordrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the heart of the city, this spacious restaurant sports modern décor with an almost futuristic edge thanks to the pod-like booth seating. The menu offers plenty of variety, with a mix of international influences resulting in dishes ranging from tandoori beetroot to cod Kiev and asparagus tagliatelle to a traditional Sunday roast. It’s all carefully executed by the kitchen and doesn’t lack for flavour thanks to judicious seasoning. The cheery and chatty service team add to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=100%20Old%20Hall%20Street%2C%20Liverpool%2C%20L3%209QJ%2C%20United%20Kingdom"
    pageTitle="NORD"
  />
);
