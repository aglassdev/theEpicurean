...
const Belzan = () => (
  <RestaurantPage
    restaurantName="Belzan"
    address="371 Smithdown Road, Liverpool, L15 3JJ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441517338595"
    website="https://www.belzan.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its somewhat unassuming location makes this smart, modern bistro stand out even more. The cooking offers well-judged, interesting combinations, with portions that are as generous as they flavoursome, but while sharing is encouraged, dishes work better on their own; the Guinness rarebit potato is a must. They also offer a good value early dinner menu. The narrow room has a cosy feel, and service is confident and clued-up...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=371%20Smithdown%20Road%2C%20Liverpool%2C%20L15%203JJ%2C%20United%20Kingdom"
    pageTitle="Belzan"
  />
);

export default Belzan;
