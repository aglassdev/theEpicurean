...
const DurhamOx = () => (
  <RestaurantPage
    restaurantName="Durham Ox"
    address="Westway, Crayke, YO61 4TE, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441347821506"
    website="https://thedurhamox.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 300 years this charming pub has stood in a sleepy Yorkshire hamlet. It's a loveable, eclectically decorated place with a thoroughly welcoming feel that extends to the cosy bedrooms. As at any good inn, the fire is roaring in the winter and a lovely courtyard is available for warmer days. The cooking echoes the surroundings in its comforting heartiness, with full-flavoured and uncomplicated dishes spread across an extensive menu and plenty of seasonal specials. Steak and seafood platters are ideal for celebrations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Westway%2C%20Crayke%2C%20YO61%204TE%2C%20United%20Kingdom"
    pageTitle="Durham Ox"
  />
);

export default DurhamOx;
