...
const Benedicts = () => (
  <RestaurantPage
    restaurantName="Benedicts"
    address="9 St Benedicts Street, Norwich, NR2 4PE, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441603926080"
    website="https://restaurantbenedicts.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a bohemian part of the city, the modern bistro vibe perfectly suits this simply decorated restaurant that carries its unfussy ethos through into the cooking. Chef-Owner Richard Bainbridge is proud of his Norfolk roots and an ambassador for the region’s larder, and his understated dishes rely on top quality ingredients to lead the way. They serve a range of menus, varying in length and with vegetarian and, on request, vegan options available. For those looking for a lighter bite, sit outside and order small plates from the Alfresco menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20St%20Benedicts%20Street%2C%20Norwich%2C%20NR2%204PE%2C%20United%20Kingdom"
    pageTitle="Benedicts"
  />
);
