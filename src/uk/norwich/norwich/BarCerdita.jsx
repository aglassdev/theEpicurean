...
const BarCerdita = () => (
  <RestaurantPage
    restaurantName="Bar Cerdita"
    address="67 London Street, Norwich, NR2 1HL, United Kingdom"
    cuisine="Spanish"
    priceRange="££"
    phoneNumber="+441603986376"
    website="https://www.barcerdita.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sister to Italian restaurant Benoli nearby, this compact, rustic-looking spot instead turns its attentions to Spain, with a roster of tapas staples plus daily blackboard specials. Sharing is of course the way to go here, and the well-known dishes pack in all the satisfying flavours you’d expect, from the pan con tomate to a number of pork options and a great tarta de Santiago with olive oil ice cream to finish. It’s all perfect paired with a glass from the concise Spanish wine list or the cocktail of the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=67%20London%20Street%2C%20Norwich%2C%20NR2%201HL%2C%20United%20Kingdom"
    pageTitle="Bar Cerdita"
  />
);

export default BarCerdita;
