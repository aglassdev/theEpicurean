...
const Hearth = () => (
  <RestaurantPage
    restaurantName="Hearth"
    address="10.5 King Street, City of Kingston-upon-Hull, HU1 2JJ, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441482429203"
    website="https://www.hearthfamily.co.uk/about"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by a trio of friends and located among some fine buildings in the old part of town, this buzzy spot operates over two levels. The ground floor houses a bar and bakery, while the upstairs is home to the rustic two-room restaurant. The menu fuses small plates with larger dishes, often coming from the grill – or ‘hearth’ – that takes centre stage in the open kitchen. Start with sourdough from the bakery, then make sure you check the boards for daily specials, as you might get to enjoy delicious seasonal produce like Yorkshire grouse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10.5%20King%20Street%2C%20City%20of%20Kingston-upon-Hull%2C%20HU1%202JJ%2C%20United%20Kingdom"
    pageTitle="Hearth"
  />
);
