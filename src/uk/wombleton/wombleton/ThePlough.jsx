...
const ThePlough = () => (
  <RestaurantPage
    restaurantName="The Plough"
    address="Main Street, Wombleton, YO62 7RW, United Kingdom"
    cuisine="Traditional Cuisine"
    priceRange="£££"
    phoneNumber="+441751431356"
    website="https://www.ploughwombleton.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Richard and Lindsey Johns are experience operators in this part of the world. For their latest project, they’ve taken on this attractive 16th-century inn situated between the Howardian Hills and the North York Moors. There’s plenty of character to the place, from the beamed ceiling to the roaring fire for winter and beer garden for summer. Chef Richard offers hearty dishes that are classically and wholly enjoyable, like a generous pork chop cooked with evident skill. Lindsey looks after every table with a genuine warmth and personal touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Wombleton%2C%20YO62%207RW%2C%20United%20Kingdom"
    pageTitle="The Plough"
  />
);

export default ThePlough;
