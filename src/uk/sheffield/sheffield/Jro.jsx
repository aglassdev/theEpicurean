...
const Jro = () => (
  <RestaurantPage
    restaurantName="JÖRO"
    address="Oughtibridge Mill, Main Road, Wharncliffe Side, Sheffield, S35 0LB, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441142991539"
    website="https://www.jororestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="JÖRO’s relocation to this 300-year-old former mill on the edge of Sheffield has certainly been a labour of love. The fine building has been smartly converted, with bedrooms available and the spacious dining room harbouring an open kitchen. The cooking is pure and occasionally playful, with the quality ingredients treated with respect and understanding. Just take the Silver Hill duck, for example, aged in-house for extra intensity and accompanied by a rich black bean and long pepper sauce. The excellent service is a real team effort, with every person brimming with enthusiasm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oughtibridge%20Mill%2C%20Main%20Road%2C%20Wharncliffe%20Side%2C%20Sheffield%2C%20S35%200LB%2C%20United%20Kingdom"
    pageTitle="JÖRO"
  />
);
