...
const MineFAL = () => (
  <RestaurantPage
    restaurantName="MINE"
    address="4 The Old Brewery Yard, Falmouth, TR11 2BY, United Kingdom"
    cuisine="Farm to table"
    priceRange="££"
    phoneNumber="+441326211073"
    website="https://www.restaurantmine.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden away in an attractive courtyard, this rustic little bistro is well worth the climb up the steep High Street. It’s a cosy, welcoming place, where the informality contributes to a light buzz among the contented diners. An open kitchen allows for a good view of the classic, well-crafted cooking, which takes the form of a concise, regularly changing à la carte which relies on local produce. You'd do well to start with the fabulous crab fritter and end with the honey cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20The%20Old%20Brewery%20Yard%2C%20Falmouth%2C%20TR11%202BY%2C%20United%20Kingdom"
    pageTitle="MINE"
  />
);

export default MineFAL;
