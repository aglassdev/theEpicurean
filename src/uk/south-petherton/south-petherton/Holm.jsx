...
const Holm = () => (
  <RestaurantPage
    restaurantName="Holm"
    address="28 St James Street, South Petherton, TA13 5BW, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441460712470"
    website="https://holmsomerset.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s something special about this former bank, with its impressive architecture and delightful village setting. Seasonal ingredients feature on a range of menus and appealing local drinks accompany. Sit in the spacious dining room with its distressed designer style or bag a spot at the kitchen counter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=28%20St%20James%20Street%2C%20South%20Petherton%2C%20TA13%205BW%2C%20United%20Kingdom"
    pageTitle="Holm"
  />
);
