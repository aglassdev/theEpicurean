...
const TheBull = () => (
  <RestaurantPage
    ...
    address="Sheep Street, Charlbury, OX7 3RR, United Kingdom"
    ...
    bio="The duo behind The Pelican in London have returned home to the Cotswolds to open this 16C pub that oozes character and boasts flagged floors, timbered ceilings, plenty of exposed Cotswold stone and twin open fires. There is a relaxed and intimate feel to the place, and an understated quality to the simple, traditional cooking. Dishes like cured trout with green tomatoes use first-rate ingredients and deliver bags of flavour. Dining here is a hearty, satisfying experience, while bedrooms in The Barn are the icing on the cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sheep%20Street%2C%20Charlbury%2C%20OX7%203RR%2C%20United%20Kingdom"
    pageTitle="The Bull"
  />
);
