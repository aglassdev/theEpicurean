...
const EckingtonManor = () => (
  <RestaurantPage
    restaurantName="Eckington Manor"
    address="Manor Farm, Hammock Road, Eckington, WR10 3BJ, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441386751600"
    website="https://www.eckingtonmanor.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll find this proudly run 13C manor house and its collection of characterfully converted barns located on a 300 acre farm. Attractive modern dishes showcase local ingredients in ambitious combinations – and for those who want to get hands-on there’s a cookery school. Bedrooms are stylish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Manor%20Farm%2C%20Hammock%20Road%2C%20Eckington%2C%20WR10%203BJ%2C%20United%20Kingdom"
    pageTitle="Eckington Manor"
  />
);

export default EckingtonManor;
