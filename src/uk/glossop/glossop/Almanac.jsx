...
const Almanac = () => (
  <RestaurantPage
    restaurantName="Almanac"
    address="54 High Street West, Glossop, SK13 8BH, United Kingdom"
    cuisine="Seasonal Cuisine, Traditional British"
    priceRange="££"
    phoneNumber="+441457371374"
    website="http://www.almanacrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What a terrific little neighbourhood spot this is. A bar and restaurant rolled into one, start your visit with a drink from the concise yet quality wine list or classics-with-a-twist cocktail selection. Then turn your attention to the menu of small plates that showcase the kitchen’s unashamedly traditional approach with the likes of mince on dripping toast. Look out for the ‘Orbs of Joy’ – slow-braised Roscoff onions cooked in rich chicken broth – and save room for dessert, especially if that dessert is custard tart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=54%20High%20Street%20West%2C%20Glossop%2C%20SK13%208BH%2C%20United%20Kingdom"
    pageTitle="Almanac"
  />
);
