...
const TheBonnieBadger = () => (
  <RestaurantPage
    restaurantName="The Bonnie Badger"
    address="Main Street, Gullane, EH31 2AB, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441620621111"
    website="https://bonniebadger.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tom and Michaela Kitchin have created their version of a pub in an old coaching inn dating from 1836. The bar serves pub classics, the dining room offers dishes with a 'nature to plate' philosophy and, in the garden, dishes are cooked on a Big Green Egg. Super comfy bedrooms showcase Scottish designers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Gullane%2C%20EH31%202AB%2C%20United%20Kingdom"
    pageTitle="The Bonnie Badger"
  />
);

export default TheBonnieBadger;
