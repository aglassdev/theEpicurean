...
const FloraTRE = () => (
  <RestaurantPage
    ...
    address="Stableyard, Trelowarren Estate, Trelowarren, TR12 6AF, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber=""
    website="https://www.floranewyard.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arriving here feels like you’ve leapt into the pages of a fairy tale. Buried deep within the Trelowarren Estate (follow their online directions not your GPS), the period conversion draped in twinkling lights is overflowing with rustic charm. The roaring log fire welcomes you in and is matched by the warmth of the wonderful team. Produce from the Estate is at the heart of a menu that delivers a wonderful celebration of the seasons through dishes like roast lamb chop and slow-cooked shoulder. At lunchtimes, visit the simpler café and bakery across the courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stableyard%2C%20Trelowarren%20Estate%2C%20Trelowarren%2C%20TR12%206AF%2C%20United%20Kingdom"
    pageTitle="Flora"
  />
);

export default FloraTRE;
