...
const TheFlintHouse = () => (
  <RestaurantPage
    restaurantName="The Flint House"
    address="13 Hanningtons Lane, Brighton and Hove, BN1 1GS, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441273916333"
    website="https://www.flinthousebrighton.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Brighton’s famous Lanes district plays host to this fashionable brasserie hidden inside a red-brick and flint-stone house that was one home to the city's renowned Hannington's department store. Enjoy a drink on the terrace of the first-floor cocktail bar, then head down to the buzzy main room dominated by an open kitchen and a stainless-steel counter. There's something for everyone among the colourful small plates that take on global influences and burst with freshness and flavour. Many of the good value wines are also offered by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20Hanningtons%20Lane%2C%20Brighton%20and%20Hove%2C%20BN1%201GS%2C%20United%20Kingdom"
    pageTitle="The Flint House"
  />
);

export default TheFlintHouse;
