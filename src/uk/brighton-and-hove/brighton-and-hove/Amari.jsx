...
const Amari = () => (
  <RestaurantPage
    restaurantName="Amari"
    address="15 Baker Street, Brighton and Hove, BN1 4JN, United Kingdom"
    cuisine="Spanish"
    priceRange="££"
    phoneNumber="+441273435992"
    website="https://www.instagram.com/amaribrighton"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Look out for the bright-red exterior that draws you like a beacon to this Spanish-inspired restaurant tucked down a busy side street in the north of the city. The simply decorated setting keeps the focus on the food, with a menu full of dishes that deliver on their promise: the croquetas are creamy, the crudo is refreshing and the suckling pig is prepared with skill. The wine list is expectedly Spanish in its focus, while the selection of sherries is the ideal way to kick off the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Baker%20Street%2C%20Brighton%20and%20Hove%2C%20BN1%204JN%2C%20United%20Kingdom"
    pageTitle="Amari"
  />
);
