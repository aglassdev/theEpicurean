...
const Gingerman = () => (
  <RestaurantPage
    restaurantName="Gingerman"
    address="21a Norfolk Square, Brighton and Hove, BN1 2PD, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441273326688"
    website="https://www.gingermanrestaurants.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flagship of the Gingerman Group is a long-standing neighbourhood restaurant a short way from the sea. It has a slight Scandic look and an intimate feel. Understated modern dishes provide plenty of appeal and have an unforced natural style and good clarity of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21a%20Norfolk%20Square%2C%20Brighton%20and%20Hove%2C%20BN1%202PD%2C%20United%20Kingdom"
    pageTitle="Gingerman"
  />
);
