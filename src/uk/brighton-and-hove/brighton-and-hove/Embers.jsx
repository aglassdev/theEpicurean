...
const Embers = () => (
  <RestaurantPage
    ...
    address="42 Meeting House Lane, Brighton and Hove, BN1 1HB, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+441273869222"
    website="https://embersbrighton.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in the heart of Brighton’s famous Lanes, you’ll find this contemporary bistro with a big, wood-fired heart. Their ethos is all about sharing food with friends around a fire, with a menu that combines small plates like charred broccoli with centrepiece dishes for sharing, such as venison rump or whole sea bass. As you would expect, plenty of smoky flavour comes through in the well-executed, accessible dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%20Meeting%20House%20Lane%2C%20Brighton%20and%20Hove%2C%20BN1%201HB%2C%20United%20Kingdom"
    pageTitle="Embers"
  />
);
