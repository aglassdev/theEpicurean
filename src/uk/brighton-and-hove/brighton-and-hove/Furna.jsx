...
const Furna = () => (
  <RestaurantPage
    restaurantName="Furna"
    address="6 New Road, Brighton and Hove, BN1 1UF, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441273031594"
    website="https://furnarestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish city centre restaurant is the first solo venture for Chef-Owner Dave Mothersill, who has been a fixture of the Brighton food scene for some time and brings an array of techniques to his precisely crafted dishes. The food is largely served by the proud chefs and focuses on seasonal British produce, with a few international influences and a creative edge. A chic mix of vintage and contemporary décor helps to enhance the experience, with counter seating available to make the most of the fully open kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20New%20Road%2C%20Brighton%20and%20Hove%2C%20BN1%201UF%2C%20United%20Kingdom"
    pageTitle="Furna"
  />
);

export default Furna;
