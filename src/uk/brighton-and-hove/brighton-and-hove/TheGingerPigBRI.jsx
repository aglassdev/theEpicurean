...
const TheGingerPigBRI = () => (
  <RestaurantPage
    restaurantName="The Ginger Pig"
    address="3 Hove Street, Brighton and Hove, BN3 2TR, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441273736123"
    website="https://thegingerpigpub.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The whole package is here at The Ginger Pig: an early 20C inn near the seafront; a restaurant offering an extensive choice of British favourites and Mediterranean classics; bespoke cocktails; charming staff who are attentive and on the ball; and, finally, comfy bedrooms upstairs for those wishing to make a night of it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Hove%20Street%2C%20Brighton%20and%20Hove%2C%20BN3%202TR%2C%20United%20Kingdom"
    pageTitle="The Ginger Pig"
  />
);

export default TheGingerPigBRI;
