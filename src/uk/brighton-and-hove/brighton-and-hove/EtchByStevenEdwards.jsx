...
const EtchByStevenEdwards = () => (
  <RestaurantPage
    restaurantName="etch. by Steven Edwards"
    address="216 Church Road, Brighton and Hove, BN3 2DJ, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441273227485"
    website="https://www.etchfood.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive former bank plays host to this lively modern restaurant, where an open kitchen and bar take centre stage in the dining room. Tersely described tasting menus deliver ambitious, technique-driven dishes with bold flavours and intriguing textures; Steven's signatures include a marmite brioche and his take on 'dippy egg'. The wine list offers a good selection from Sussex and cocktails are available in the basement Ink Bar, so-called because the premises was once a tattoo parlour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=216%20Church%20Road%2C%20Brighton%20and%20Hove%2C%20BN3%202DJ%2C%20United%20Kingdom"
    pageTitle="etch. by Steven Edwards"
  />
);

export default EtchByStevenEdwards;
