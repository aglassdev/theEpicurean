...
const AngeethiBySagarMassey = () => (
  <RestaurantPage
    restaurantName="Angeethi by Sagar Massey"
    address="1835 Paisley Road West, Cardonald, G52 3SX, United Kingdom"
    cuisine="Indian"
    priceRange="££"
    phoneNumber="+441418103950"
    website="https://www.angeethi.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An angeethi is a type of grill traditionally used in rural Indian households, and now it lends its name to this charmingly run restaurant in a Glasgow suburb. It’s a simple-looking place where the focus is on the joyously flavoursome food and the warm, caring service. Massey’s menu sticks to traditional, regional Indian dishes which are both well-spiced and generous, such as the ‘Old Delhi Murgh Makhani’, a fabulous version of the classic butter chicken. Ensure you leave some room for dessert, as the ‘Rabdi Faluda’ provides a beautiful balance of flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1835%20Paisley%20Road%20West%2C%20Cardonald%2C%20G52%203SX%2C%20United%20Kingdom"
    pageTitle="Angeethi by Sagar Massey"
  />
);

export default AngeethiBySagarMassey;
