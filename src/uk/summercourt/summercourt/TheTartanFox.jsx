...
const TheTartanFox = () => (
  <RestaurantPage
    restaurantName="The Tartan Fox"
    address="Carvynick Farm, A3058, Summercourt, TR8 5AF, United Kingdom"
    cuisine="British Contemporary"
    priceRange="££"
    phoneNumber="+441637800023"
    website="https://www.tartanfoxpub.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The location in the middle of Cornwall may be a long way from Scotland but, as the name suggests, Adam Handling finds a way to incorporate his Celtic heritage into this stone-built country pub. Another venture in his ever-expanding empire, it’s a sympathetically refitted 17th-century inn located on a popular holiday caravan park. You can expect to find the likes of a haggis Scotch egg and even a deep-fried Mars bar among the extensive menu of generous pubby favourites filled with bold, well-balanced flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carvynick%20Farm%2C%20A3058%2C%20Summercourt%2C%20TR8%205AF%2C%20United%20Kingdom"
    pageTitle="The Tartan Fox"
  />
);

export default TheTartanFox;
