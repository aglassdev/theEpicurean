...
const TheDuckOnThePond = () => (
  <RestaurantPage
    restaurantName="The Duck on the Pond"
    address="South Newington, OX15 4JE, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441295721166"
    website="https://www.theduckonthepond.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Parts of this attractive roadside inn reputedly date back to the 16th Century, providing a lovely setting for cooking based around local ingredients. Several of them come from the owners’ own smallholding and others from nearby producers who are named on the menu – sometimes alongside their distance from the restaurant. These ingredients are fashioned into dishes that burst with flavour and don’t overcomplicate matters, like bright, fresh-tasting roasted cod with mussel sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=South%20Newington%2C%20OX15%204JE%2C%20United%20Kingdom"
    pageTitle="The Duck on the Pond"
  />
);

export default TheDuckOnThePond;
