...
const ManaMAN = () => (
  <RestaurantPage
    ...
    website="https://www.manarestaurant.co.uk/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The personality and experience of chef-owner Simon Martin shine brightly at this stylish, modern restaurant, where every one of the well-spaced tables has a view of the kitchen. British produce leads the way, including plenty of seafood because, as Simon puts it, “we live on an island”. There are many Asian techniques on display and the cooking marries complex flavours with a pure, natural approach, in dishes such as a superb roasted hogget with white miso sabayon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%20Blossom%20Street%2C%20Ancoats%2C%20Manchester%2C%20M4%206BF%2C%20United%20Kingdom"
    pageTitle="mana"
  />
);

export default ManaMAN;
