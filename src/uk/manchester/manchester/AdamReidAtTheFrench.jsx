...
const AdamReidAtTheFrench = () => (
  <RestaurantPage
    restaurantName="Adam Reid at The French"
    address="Midland Hotel, 16 Peter Street, Manchester, M60 2DS, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber=""
    website="https://the-french-manchester.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The famous Midland Hotel hotel was first built to herald the arrival of the Midland Railway in Manchester, and its current restaurant has been created in the Belle Époque style to evoke the luxury of the day. Whilst its name remains in reference to its historical past, today, Chef Adam Reid's multi-course menu is more inspired by his northern roots than it is by France. The richly flavoured, occasionally playful, dishes come with cryptic, concise menu descriptions such as 'Fungi' and 'Fish', but the personable chefs are on hand to explain and finish off each course tableside ...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Midland%20Hotel%2C%2016%20Peter%20Street%2C%20Manchester%2C%20M60%202DS%2C%20United%20Kingdom"
    pageTitle="Adam Reid at The French"
  />
);

export default AdamReidAtTheFrench;
