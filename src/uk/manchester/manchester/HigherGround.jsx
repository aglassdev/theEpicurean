...
const HigherGround = () => (
  <RestaurantPage
    ...
    address="Faulkner House, New York Street, Manchester, M1 4DY, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441612362931"
    website="https://www.highergroundmcr.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What started life as a pop-up in 2020 is now a permanent spot in the heart of the city, owned and run by three friends who also operate wine bar Flawd and a market garden in the Cheshire countryside. The latter provides much of the top-quality produce found on the menu, in dishes that are designed for sharing and packed with flavour. Sit at the large counter to see the chefs putting care and pride into every dish, be it pork and sherry terrine or steamed Cornish hake. The whole team, led by the owners, are charming and cheery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Faulkner%20House%2C%20New%20York%20Street%2C%20Manchester%2C%20M1%204DY%2C%20United%20Kingdom"
    pageTitle="Higher Ground"
  />
);
