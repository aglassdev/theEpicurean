...
const Erst = () => (
  <RestaurantPage
    restaurantName="Erst"
    address="9 Murray Street, Ancoats, Manchester, M4 6HS, United Kingdom"
    cuisine="British Contemporary"
    priceRange="£££"
    phoneNumber="+441618263008"
    website="https://www.erst-mcr.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its open kitchen, sharing plates, faux-industrial design and bounty of natural wines, there's something incredibly current about Erst. It's truly a restaurant for our times, but cooking like this would be a joy in any era. The underlying themes across the menu are great value and bright, punchy flavours; make sure you start with one of the freshly charred flatbreads, which might come topped with sweet Vesuvio tomatoes. The cuttlefish risotto is terrific too, offering impressive depth of flavour. The friendly team provide natural, attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Murray%20Street%2C%20Ancoats%2C%20Manchester%2C%20M4%206HS%2C%20United%20Kingdom"
    pageTitle="Erst"
  />
);
