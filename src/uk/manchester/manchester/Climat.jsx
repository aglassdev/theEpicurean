...
const Climat = () => (
  <RestaurantPage
    restaurantName="Climat"
    address="8th Floor, Blackfriars House, Parsonage, Manchester, M3 2JA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441617102885"
    website="https://restaurantclimat.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You have to be in the know to come across Climat, tucked away on the eighth floor of a city centre office building. You arrive at a dedicated entrance and make your way up to the chic penthouse, where stunning city views await you. An open kitchen is the focus of the room, with its aromas filling the air, and the concise fixed-price menu includes well-executed dishes such as halibut with spinach and sorrel velouté, where the ingredient quality shines through. Wine is a feature with one side of the room acting as a bar and the carefully curated list deftly mixing traditional and modern styles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8th%20Floor%2C%20Blackfriars%20House%2C%20Parsonage%2C%20Manchester%2C%20M3%202JA%2C%20United%20Kingdom"
    pageTitle="Climat"
  />
);
