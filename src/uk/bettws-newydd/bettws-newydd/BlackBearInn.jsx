...
const BlackBearInn = () => (
  <RestaurantPage
    restaurantName="Black Bear Inn"
    address="Clytha Road, Bettws Newydd, NP15 1JN, United Kingdom"
    cuisine="Regional Cuisine"
    priceRange="££"
    phoneNumber="+441873880701"
    website="https://www.theblackbearinn.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's a charmingly rustic feel to this smartly run rural inn close to the Victorian market town of Usk. A white-washed exterior, log-burning stove and wooden beams all add to the appeal, while the chefs do their part with a concise menu of well-executed, classically based cuisine. The fish cookery is a particular highlight, as evidenced by dishes like hake with a terrific butter sauce and capers. Everything is made in-house, including the ice creams and sorbets for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Clytha%20Road%2C%20Bettws%20Newydd%2C%20NP15%201JN%2C%20United%20Kingdom"
    pageTitle="Black Bear Inn"
  />
);

export default BlackBearInn;
