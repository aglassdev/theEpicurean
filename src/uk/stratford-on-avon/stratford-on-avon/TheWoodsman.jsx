...
const TheWoodsman = () => (
  <RestaurantPage
    restaurantName="The Woodsman"
    address="Hotel Indigo, 4 Chapel Street, Stratford-on-Avon, CV37 6HA, United Kingdom"
    cuisine="Meats and Grills"
    priceRange="£££"
    phoneNumber="+441789331535"
    website="https://thewoodsmanrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Even in the dead of winter, you’ll likely find a big crowd and a lively buzz at this well-run restaurant. It’s easy to see why it’s such a busy place, as the attentive service is joined by hearty, satisfying cooking. Dishes often revolve around wood-fired produce, be it skate wing or partridge, and there’s a proper roast dinner served on Sundays. Shakespeare fans have an extra reason to visit, as the famed playwright’s childhood classroom is located just up the road and is open to visitors...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Indigo%2C%204%20Chapel%20Street%2C%20Stratford-on-Avon%2C%20CV37%206HA%2C%20United%20Kingdom"
    pageTitle="The Woodsman"
  />
);

export default TheWoodsman;
