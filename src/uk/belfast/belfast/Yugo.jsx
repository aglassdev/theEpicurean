...
const Yugo = () => (
  <RestaurantPage
    restaurantName="Yugo"
    address="3 Wellington Street, Belfast, BT1 6HT, United Kingdom"
    cuisine="Asian, Fusion"
    priceRange="££"
    phoneNumber="+442890319715"
    website="https://yugobelfast.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind an unassuming façade is this buzzy, industrial-style restaurant, where powerful music plays and a super-friendly team bring the dishes as and when they’re ready. These are good value small plates of Asian fusion cooking; the Iberico pork is a must and there are Asian-influenced cocktails to accompany...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3%20Wellington%20Street%2C%20Belfast%2C%20BT1%206HT%2C%20United%20Kingdom"
    pageTitle="Yugo"
  />
);
