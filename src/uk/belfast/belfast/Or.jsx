...
const Or = () => (
  <RestaurantPage
    restaurantName="Orā"
    address="12 Great Victoria Street, Belfast, BT2 7BA, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££"
    phoneNumber="+442890315565"
    website="https://orabelfast.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s all about sharing at this bright, buzzy tapas-style bar – a fun place which echoes the city’s cosmopolitan vibe. Carefully prepared small plates reflect the owner’s travels and range from arancini to laksa; they’re served as they’re ready, creating anticipation for each one to arrive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Great%20Victoria%20Street%2C%20Belfast%2C%20BT2%207BA%2C%20United%20Kingdom"
    pageTitle="Orā"
  />
);
