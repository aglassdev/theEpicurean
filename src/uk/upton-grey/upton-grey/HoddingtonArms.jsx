...
const HoddingtonArms = () => (
  <RestaurantPage
    restaurantName="Hoddington Arms"
    address="Bidden Road, Upton Grey, RG25 2RL, United Kingdom"
    cuisine="Traditional British"
    priceRange="££"
    phoneNumber="+441256862371"
    website="https://www.hoddingtonarms.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘The Hodd’ is a characterful pub at the heart of the village, and offers a friendly welcome and charm aplenty with its rustic brickwork, exposed timbers and open fires. Understated menu descriptions belie the skill in the experienced chef’s well-crafted dishes. Be sure to save room for pudding!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bidden%20Road%2C%20Upton%20Grey%2C%20RG25%202RL%2C%20United%20Kingdom"
    pageTitle="Hoddington Arms"
  />
);

export default HoddingtonArms;
