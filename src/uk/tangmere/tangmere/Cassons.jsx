...
const Cassons = () => (
  <RestaurantPage
    restaurantName="Cassons"
    address="Arundel Road, Tangmere, PO18 0DU, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441243773294"
    website="https://www.cassonsrestaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Passionately run restaurant with exposed brick, wooden beams and a rustic feel. Boldly flavoured dishes are generously proportioned. Cooking is classically based but employs modern techniques. The regular gourmet evenings are a hit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arundel%20Road%2C%20Tangmere%2C%20PO18%200DU%2C%20United%20Kingdom"
    pageTitle="Cassons"
  />
);

export default Cassons;
