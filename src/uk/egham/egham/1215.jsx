...
const OneTwoOneFive = () => (
  <RestaurantPage
    restaurantName="1215"
    address="Fairmont Windsor Park, Bishopsgate Road, Englefield Green, Egham, TW20 0YL, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441784535555"
    website="https://www.fairmont-windsorpark.com/restaurant/1215-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the date of the signing of the Magna Carta 'down the road' in Runnymede, this elegant restaurant can be found in the slightly labyrinthine Fairmont Windsor Park Hotel. The cooking features prime British ingredients like Suffolk lamb, Torbay crab and vegetables from their own estate; the chefs treat this produce with an unfussy approach, resulting in enjoyably pared-back dishes. The service is smooth and, if you’re dining as a couple, ask for a prime spot in one of the semi-circular booths...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fairmont%20Windsor%20Park%2C%20Bishopsgate%20Road%2C%20Englefield%20Green%2C%20Egham%2C%20TW20%200YL%2C%20United%20Kingdom"
    pageTitle="1215"
  />
);

export default OneTwoOneFive;
