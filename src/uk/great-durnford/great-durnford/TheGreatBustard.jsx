...
const TheGreatBustard = () => (
  <RestaurantPage
    restaurantName="The Great Bustard"
    address="Great Durnford, Great Durnford, SP4 6AY, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441722703582"
    website="https://thegreatbustard.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Immaculate’ is the best way to describe this beautifully restored 19th-century property, located in a pretty village and surrounded by manicured grounds. The pub area is all country warmth and roaring fires, while the restaurant is bright and modern thanks to its floor-to-ceiling windows. The menu aims to please all-comers, with steaks and burgers joined by more elaborate preparations like sea bass with Morteau sausage and girolles. Make the most of the spectacular renovation by staying the night in one of the 10 bedrooms, split between the main house and courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Great%20Durnford%2C%20Great%20Durnford%2C%20SP4%206AY%2C%20United%20Kingdom"
    pageTitle="The Great Bustard"
  />
);

export default TheGreatBustard;
