...
const Scorrybreac = () => (
  <RestaurantPage
    restaurantName="Scorrybreac"
    address="7 Bosville Terrace, Portree, Isle of Skye, IV51 9DG, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+441478612069"
    website="https://www.scorrybreac.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The rugged, rural beauty of the Isle of Skye is a wonderful accompaniment to any meal – and so it is at this sharing plates operation named after the chef's parents' house, where he ran is first pop-up. 'Scorrybreac' also means 'speckled rock', something you can glimpse on the mountains in the distance. The restaurant itself is a small and simply furnished place, with chatty and charming service adding to its appeal. The creative modern cooking makes use of the Skye larder, including meats from the hills and seafood from the harbour below...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20Bosville%20Terrace%2C%20Portree%2C%20Isle%20of%20Skye%2C%20IV51%209DG%2C%20United%20Kingdom"
    pageTitle="Scorrybreac"
  />
);

export default Scorrybreac;
