...
const LochBay = () => (
  <RestaurantPage
    restaurantName="Loch Bay"
    address="1-2 Macleods Terrace, Stein, Waternish, Isle of Skye, IV55 8GA, United Kingdom"
    cuisine="Modern Cuisine, Seafood"
    priceRange="££££"
    phoneNumber="+441470592235"
    website="https://www.lochbay-restaurant.co.uk/"
    aliases={["Loch Bay Restaurant"]}
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2%20Macleods%20Terrace%2C%20Stein%2C%20Waternish%2C%20Isle%20of%20Skye%2C%20IV55%208GA%2C%20United%20Kingdom"
    pageTitle="Loch Bay"
  />
);

export default LochBay;
