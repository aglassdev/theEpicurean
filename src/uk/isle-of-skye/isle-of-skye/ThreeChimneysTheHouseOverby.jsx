...
const ThreeChimneysTheHouseOverby = () => (
  <RestaurantPage
    restaurantName="Three Chimneys & The House Over-By"
    address="Colbost, Dunvegan, Isle of Skye, IV55 8ZT, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+441470511258"
    website="https://www.threechimneys.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The windswept beauty of the Isle of Skye provides a stunning backdrop to this immaculately kept crofter’s cottage at the edge of Loch Dunvegan. Contemporary art hangs on exposed stone walls in the characterful, low-beamed dining rooms. Unsurprisingly in an area with such bountiful produce, the menu keeps its focus local, with seafood from nearby waters among the highlights. Spacious, split-level bedrooms are stylishly understated and the residents’ lounge has a great outlook...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Colbost%2C%20Dunvegan%2C%20Isle%20of%20Skye%2C%20IV55%208ZT%2C%20United%20Kingdom"
    pageTitle="Three Chimneys & The House Over-By"
  />
);

export default ThreeChimneysTheHouseOverby;
