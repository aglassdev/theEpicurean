...
const FelinFachGriffin = () => (
  <RestaurantPage
    restaurantName="Felin Fach Griffin"
    address="Felin Fach, Brecon, LD3 0UB, United Kingdom"
    cuisine="Modern British"
    priceRange="££"
    phoneNumber="+441874620111"
    website="https://www.felinfachgriffin.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on the edge of the Brecon Beacons National Park, warmth and character abound at this traditional pub. Relax on a sofa beside the fire with a pint of local beer, then head for the Library or Snug to dine. The organic kitchen garden provides herbs, fruit and vegetables for simple, unfussy dishes that don’t attempt to reinvent the wheel, but are simply a joy to eat – such as cod and fondant potatoes with beurre blanc. Cosy bedrooms come with good extras and are dog friendly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Felin%20Fach%2C%20Brecon%2C%20LD3%200UB%2C%20United%20Kingdom"
    pageTitle="Felin Fach Griffin"
  />
);

export default FelinFachGriffin;
