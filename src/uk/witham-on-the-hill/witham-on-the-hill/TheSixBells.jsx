...
const TheSixBells = () => (
  <RestaurantPage
    restaurantName="The Six Bells"
    address="Main Street, Witham on The Hill, PE10 0JH, United Kingdom"
    cuisine="Traditional British"
    priceRange="£"
    phoneNumber="+441778590360"
    website="https://www.sixbellswitham.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll receive a warm welcome from the charming team at this bright, characterful village pub. It’s decorated in a personal style with framed maps and menus, and its shelves groan under the weight of cookery books. Dishes are skilfully crafted and chock-full of flavour; choose from sophisticated dishes on the main menu, tempting free-range rotisserie chicken or pizzas cooked in the wood-burning oven. Stylishly appointed bedrooms complete the package; Hayloft is the best...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Witham%20on%20The%20Hill%2C%20PE10%200JH%2C%20United%20Kingdom"
    pageTitle="The Six Bells"
  />
);

export default TheSixBells;
