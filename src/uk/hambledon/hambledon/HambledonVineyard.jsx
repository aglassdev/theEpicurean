...
const HambledonVineyard = () => (
  <RestaurantPage
    restaurantName="Hambledon Vineyard"
    address="East Street, Hambledon, PO7 4RY, United Kingdom"
    cuisine="Modern British"
    priceRange="£££"
    phoneNumber="+442392632358"
    website="https://hambledonvineyard.co.uk/pages/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you settle down to eat at what is reputedly England’s oldest commercial vineyard, the feeling you’ve found your own little slice of paradise washes over you. As you walk up to the beautiful timber-and-glass building through the kitchen garden, you will spot some of the ingredients that you’ll soon be eating. Take your seat with a view of the vines and the glorious South Downs, accompanied by a glass of bubbly from the Hambledon Estate. This idyllic scene is bolstered by fresh, appealing dishes like sea bream with tomato risotto...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=East%20Street%2C%20Hambledon%2C%20PO7%204RY%2C%20United%20Kingdom"
    pageTitle="Hambledon Vineyard"
  />
);

export default HambledonVineyard;
