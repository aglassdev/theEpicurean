...
const Heathcock = () => (
  <RestaurantPage
    restaurantName="Heathcock"
    address="58 Bridge Street, Cardiff, CF5 2EN, United Kingdom"
    cuisine="British Contemporary"
    priceRange="££"
    phoneNumber="+442921152290"
    website="https://heathcockcardiff.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by the same team as The Hare & Hounds in Aberthin, this large neighbourhood pub is the kind of place that quickly becomes your favourite haunt. Simple and rustic in décor, the focus is on the eminently satisfying cooking, which has a strong nose-to-tail ethos resulting in dishes like confit pork belly with homemade black pudding and crispy ham hock. The menu of great value small plates changes daily, while pre-ordering the tasting option will ensure you sample the full range of the kitchen’s talents...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20Bridge%20Street%2C%20Cardiff%2C%20CF5%202EN%2C%20United%20Kingdom"
    pageTitle="Heathcock"
  />
);

export default Heathcock;
