...
const Asador44 = () => (
  <RestaurantPage
    restaurantName="Asador 44"
    address="14 Quay Street, Cardiff, CF10 1EA, United Kingdom"
    cuisine="Spanish, Mediterranean Cuisine"
    priceRange="£££"
    phoneNumber="+442920020039"
    website="https://grupo44.co.uk/asador44/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside Parador 44, a boutique hotel offering a taste of Iberia in the Welsh capital, sits this dark and moody restaurant. It's divided into multiple wood-clad areas, with the best spots overlooking the asador grill or the glass-fronted wine cave. The menu has a focus on cooking over fire, with the likes of squid, celeriac and rump steak getting the charcoal treatment – whichever you choose, ensure you start with the boquerones with yuzu dressing. The wine list is almost exclusively Spanish, with fascinating choices from some little-known producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Quay%20Street%2C%20Cardiff%2C%20CF10%201EA%2C%20United%20Kingdom"
    pageTitle="Asador 44"
  />
);

export default Asador44;
