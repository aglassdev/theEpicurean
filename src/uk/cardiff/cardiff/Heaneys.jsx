...
const Heaneys = () => (
  <RestaurantPage
    restaurantName="Heaneys"
    address="6-10 Romilly Crescent, Cardiff, CF11 9NR, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="£££"
    phoneNumber="+442920341264"
    website="https://www.heaneyscardiff.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arrive early for a cocktail in the bar of well-known Chef Tommy Heaney’s stylishly laid-back suburban restaurant. Dishes are seasonal and modern, with some sophisticated contrasts; the set lunch menu delivers good value while, at dinner, the tasting menu takes centre stage. Next door is Uisce – his no-reservations, small plates restaurant – which showcases herbs and vegetables from the pretty kitchen garden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-10%20Romilly%20Crescent%2C%20Cardiff%2C%20CF11%209NR%2C%20United%20Kingdom"
    pageTitle="Heaneys"
  />
);

export default Heaneys;
