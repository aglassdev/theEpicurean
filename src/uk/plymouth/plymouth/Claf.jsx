...
const Claf = () => (
  <RestaurantPage
    restaurantName="Àclèaf"
    address="Boringdon Hill, Colebrook, Plymouth, PL7 4DP, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber="+441752344455"
    website="https://www.acleaf.co.uk"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The impressive Boringdon Hall Hotel plays host to this cosy, intimate restaurant, which sits under wooden beams within the former minstrels’ gallery. The building itself dates back to the Domesday book and still exudes a historic feel. Prime seasonal ingredients feature in exciting modern dishes which are refined yet restrained and demonstrate great attention to detail. The range of internationally influenced flavours are knowledgably balanced, aptly demonstrated by the cured hamachi with subtle yuzu ponzu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Boringdon%20Hill%2C%20Colebrook%2C%20Plymouth%2C%20PL7%204DP%2C%20United%20Kingdom"
    pageTitle="Àclèaf"
  />
);
