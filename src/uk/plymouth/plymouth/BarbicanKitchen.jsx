...
const BarbicanKitchen = () => (
  <RestaurantPage
    restaurantName="Barbican Kitchen"
    address="Plymouth Gin Distillery, 60 Southside Street, Plymouth, PL1 2LQ, United Kingdom"
    cuisine="International"
    priceRange="££"
    phoneNumber="+441752604448"
    website="https://www.barbicankitchen.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An informal eatery in the Plymouth Gin Distillery (where gin was once distilled for the Navy). Brasserie menus offer a good choice of simply cooked dishes, with classic comfort food to the fore; vegetarians are well catered for...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plymouth%20Gin%20Distillery%2C%2060%20Southside%20Street%2C%20Plymouth%2C%20PL1%202LQ%2C%20United%20Kingdom"
    pageTitle="Barbican Kitchen"
  />
);

export default BarbicanKitchen;
