...
const OneNineOneNineAtTheCottageInTheWood = () => (
  <RestaurantPage
    restaurantName="1919 at The Cottage in the Wood"
    address="Cottage in the Wood Hotel, Holywell Road, Malvern Wells, WR14 4LG, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441684588860"
    website="https://www.cottageinthewood.co.uk/food-drink/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In finer weather, you must aim for a table on the terrace at this restaurant set within the famous The Cottage in the Wood hotel. Built – funnily enough – in 1919, it boasts one of the best panoramic views of the English countryside that you will find. The restaurant itself is a bright, stylish place serving both a tasting menu and an à la carte. A proudly British spirit shines through in the cooking, from the use of Exmoor caviar and Evesham asparagus to a butter sauce flavoured with English sparkling wine. The service is well-paced and the whole experience comes at a sensible price tag...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cottage%20in%20the%20Wood%20Hotel%2C%20Holywell%20Road%2C%20Malvern%20Wells%2C%20WR14%204LG%2C%20United%20Kingdom"
    pageTitle="1919 at The Cottage in the Wood"
  />
);

export default OneNineOneNineAtTheCottageInTheWood;
