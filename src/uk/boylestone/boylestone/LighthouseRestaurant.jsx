...
const LighthouseRestaurant = () => (
  <RestaurantPage
    restaurantName="Lighthouse Restaurant"
    address="New Road, Boylestone, DE6 5AA, United Kingdom"
    cuisine="Modern British"
    priceRange="££££"
    phoneNumber="+441335330658"
    website="https://www.the-lighthouse-restaurant.co.uk"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Lighthouse acts a culinary beacon in the Derbyshire countryside. A sweet, intimate restaurant, it provides a platform for the self-taught chef's ambitious seasonal cooking, which is presented as either a tasting menu or midweek 'Grazing Menu'. The latter offers great value for money and is designed for sharing, providing a shorter, more relaxed dining experience. Whichever menu you enjoy, look out for the fantastic, Thai-inspired coconut and chilli broth. A good selection of keenly priced wines accompanies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=New%20Road%2C%20Boylestone%2C%20DE6%205AA%2C%20United%20Kingdom"
    pageTitle="Lighthouse Restaurant"
  />
);

export default LighthouseRestaurant;
