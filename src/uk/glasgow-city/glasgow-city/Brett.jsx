...
const Brett = () => (
  <RestaurantPage
    restaurantName="Brett"
    address="321 Great Western Road, Glasgow City, G4 9HR, United Kingdom"
    cuisine="Modern British, Grills"
    priceRange="£££"
    phoneNumber="+441414060284"
    website="https://www.brettrestaurant.co.uk/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located along Glasgow's thriving Great Western Road is this small, long-standing restaurant with a compact terrace. The dining room features a large counter wrapped around the kitchen where chefs are busy cooking on the open grills. The menu comprises around 15 simply cooked dishes which showcase the breadth of Scotland’s larder; if you get the chance, the mushroom XO linguine is a must. Natural wines accompany, and there's a relaxed, welcoming feel to the place. The set menu offers the opportunity to dine for less...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=321%20Great%20Western%20Road%2C%20Glasgow%20City%2C%20G4%209HR%2C%20United%20Kingdom"
    pageTitle="Brett"
  />
);
