...
const FallachanKitchen = () => (
  <RestaurantPage
    restaurantName="Fallachan Kitchen"
    address="Arch 15, 8 Eastvale Place, Glasgow City, G3 8QG, United Kingdom"
    cuisine="Modern Cuisine"
    priceRange="££££"
    phoneNumber=""
    website="https://www.fallachandining.co.uk/fallachan-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked underneath a small railway arch near the Kelvingrove neighbourhood, this genially run restaurant is a showcase for Chef Craig Grozier. The rumble of trains overhead only adds to the atmosphere as Craig engages with his small group of guests, all sat around one communal table in front of the open kitchen. The menu changes regularly, such is Craig’s commitment to showcasing the best seasonal Scottish produce, be it Barra scallop or Borders partridge. The punchily flavoured dishes can be paired with a thoughtfully curated wine flight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Arch%2015%2C%208%20Eastvale%20Place%2C%20Glasgow%20City%2C%20G3%208QG%2C%20United%20Kingdom"
    pageTitle="Fallachan Kitchen"
  />
);

export default FallachanKitchen;
