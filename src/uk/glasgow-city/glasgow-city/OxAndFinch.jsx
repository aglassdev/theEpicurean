...
const OxAndFinch = () => (
  <RestaurantPage
    ...
    bio="Now in its second decade, this hugely likeable bistro is becoming something of a Glasgow institution, the first in a small group of restaurants offering brilliant value and a buzzing atmosphere. After a refurbishment in early 2025, it's got a fresh new look and menu, but the ethos remains: Mediterranean dishes that are ideal for sharing, showcasing skilful use of simple ingredients so that their flavours really shine through. The attentive service team run the place like a well-oiled machine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=920%20Sauchiehall%20Street%2C%20Glasgow%20City%2C%20G3%207TF%2C%20United%20Kingdom"
    pageTitle="Ox and Finch"
  />
);

export default OxAndFinch;
