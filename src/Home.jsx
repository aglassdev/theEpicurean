  ...
  const carouselImages = [
    {
      ...
      route: "/denmark/copenhagen/geranium"
    },
    {
        ...
        <div style={{
          ...
          {extendedImages.map((slide, index) => (
            <div
              ...
              onMouseEnter={(e) => slide.route && (e.currentTarget.style.transform = 'scale(1.02)')}
              onMouseLeave={(e) => slide.route && (e.currentTarget.style.transform = 'scale(1)')}
            >
              {/* Text Overlay */}
              <div style={{
                position: 'absolute',
