...
const ChaletGerard = () => (
  <RestaurantPage
    restaurantName="Chalet Gerard"
    address="via Plan de Gralba 37, Selva di Val Gardena, 39048, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€"
    phoneNumber="+390471795274"
    website="https://www.chalet-gerard.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a breathtakingly beautiful natural setting between the Sassolungo peak and the majestic Sella mountains, this restaurant serves simple mountain fare alongside a few more modern dishes, all of which are prepared from typical ingredients from the Alto Adige. Although you can’t book at lunchtime, bookings are required in the evening. Beautiful guestrooms are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Plan%20de%20Gralba%2037%2C%20Selva%20di%20Val%20Gardena%2C%2039048%2C%20Italy"
    pageTitle="Chalet Gerard"
  />
);

export default ChaletGerard;
