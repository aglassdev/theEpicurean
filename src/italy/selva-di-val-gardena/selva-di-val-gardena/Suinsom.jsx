...
const Suinsom = () => (
  <RestaurantPage
    restaurantName="Suinsom"
    address="strada Puez 12, Selva di Val Gardena, 39048, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390471774100"
    website="https://www.tyrolhotel.it/it/ristorante-michelin-suinsom-val-gardena/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The two small pale wood paneled stube are the stage for a gourmet cuisine with a Mediterranean touch and more besides, the charcoal-grilled eel is a striking example, besides being delicious. Among the excellent meats, we recommend the roe deer venison, tender with a rich flavor thanks to its preparation that includes mango, while the Tuscan chef draws on his origins for some first courses, such as pici with lamb ragout and cuttlefish tartar... a truly interesting suggestion! The good wine selection includes various and even international productions on a wine list that is well divided by vine variety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Puez%2012%2C%20Selva%20di%20Val%20Gardena%2C%2039048%2C%20Italy"
    pageTitle="Suinsom"
  />
);

export default Suinsom;
