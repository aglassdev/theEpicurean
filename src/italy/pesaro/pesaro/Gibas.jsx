...
const Gibas = () => (
  <RestaurantPage
    restaurantName="Gibas"
    address="strada Panoramica Adriatica, Pesaro, 61121, Italy"
    cuisine="Seafood, Italian"
    priceRange="€€"
    phoneNumber="+390721405344"
    website="https://www.gibasristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern restaurant stands on the road that heads north from the town. It boasts panoramic views of the sea that can be enjoyed from the deck in summer. Contemporary - style fish dishes dominate the menu...."
