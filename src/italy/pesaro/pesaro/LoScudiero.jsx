...
const LoScudiero = () => (
  <RestaurantPage
    restaurantName="Lo Scudiero"
    address="via Baldassini 2, Pesaro, 61121, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€"
    phoneNumber="+3907211651804"
    website="https://www.ristorantescudiero.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Young, enthusiastic chef Daniele Patti is at the helm at this restaurant housed in the delightful stables of a restored 16C palazzo. Here, he serves a selection of creative dishes, including two tasting menus – the intriguing Vieni in Sicilia con me (inspired by his native Sicily) and the Adriatico  - and an à la carte which focuses on the local region’s abundance of fine ingredients. Wine-enthusiasts can ask to visit the impressive cellar, which also offers a good choice of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Baldassini%202%2C%20Pesaro%2C%2061121%2C%20Italy"
    pageTitle="Lo Scudiero"
  />
);

export default LoScudiero;
