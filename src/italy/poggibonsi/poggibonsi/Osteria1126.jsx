...
const Osteria1126 = () => (
  <RestaurantPage
    restaurantName="Osteria 1126"
    address="località Cinciano 2, Poggibonsi, 53036, Italy"
    cuisine="Tuscan"
    priceRange="€"
    phoneNumber="+390577932240"
    website="https://www.cinciano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Il Borgo di Cianciano is much more than just an osteria: it's also a farm, wine bar, and scattered hotel. The name “Osteria 1126” refers to the year of its founding; in the kitchen, a young couple offers simple, seasonal Tuscan dishes. Don't miss the pappa al pomodoro and the Chianti Classico Riserva, which is elegant and persistent. At the entrance of the borgo, a small aging cellar offers a brief but fascinating visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Cinciano%202%2C%20Poggibonsi%2C%2053036%2C%20Italy"
    pageTitle="Osteria 1126"
  />
);

export default Osteria1126;
