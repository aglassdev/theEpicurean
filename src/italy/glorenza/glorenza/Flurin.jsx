...
const Flurin = () => (
  <RestaurantPage
    restaurantName="Flurin"
    address="Laubengasse 2, Glorenza, 39020, Italy"
    cuisine="Farm to table, Contemporary"
    priceRange="€€"
    phoneNumber="+390473428136"
    website="https://www.flurin.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Flurin occupies an old medieval tower in Glorenza, a small hamlet in the Val Venosta which is surrounded by walls that also date back to the Middle Ages. Furnished in a modern style that contrasts with its old, vaulted ceiling, the restaurant serves contemporary cuisine that enthusiastic owner-chef Thomas Ortler prepares from carefully selected seasonal ingredients from the region. His creative and imaginative recipes include dishes such as duo of Wagyu beef (raised on the property) served with polenta, carrots and spring onions. There’s also a charming small outdoor space which must be booked well in advance in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Laubengasse%202%2C%20Glorenza%2C%2039020%2C%20Italy"
    pageTitle="Flurin"
  />
);

export default Flurin;
