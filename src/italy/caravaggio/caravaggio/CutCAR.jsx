...
const CutCAR = () => (
  <RestaurantPage
    restaurantName="Cut"
    address="via Amilcare Bietti 28, Caravaggio, 24043, Italy"
    cuisine="Italian Contemporary, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+39036352650"
    website="https://www.instagram.com/cutristorante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right in the heart of the Bergamo plain in the small town of Caravaggio, famous for the painter of the same name and for a much-visited pilgrim shrine, this welcoming restaurant boasts a modern decor and vintage furnishings. At lunchtime, it serves a good, competitively priced business menu, while in the evening the more elaborate à la carte features contemporary-style meat and fish dishes (mostly the latter)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Amilcare%20Bietti%2028%2C%20Caravaggio%2C%2024043%2C%20Italy"
    pageTitle="Cut"
  />
);

export default CutCAR;
