...
const IlTiglio = () => (
  <RestaurantPage
    restaurantName="Il Tiglio"
    address="via Isola San Biagio 34, Montemonaco, 63088, Italy"
    cuisine="Contemporary, Cuisine from the Marches"
    priceRange="€€€"
    phoneNumber="+390736856441"
    website="https://www.ristoranteiltiglio.it"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It's quite a journey to reach the slopes at the foot of the Sibillini mountains where chef Enrico Mazzaroni’s restaurant is situated, but the effort to get here is more than compensated by the exquisite cuisine on the menu! Although the chef’s great passion is for regional ingredients such as mushrooms, trout, venison and potatoes (much of which is produced at his own agriturismo), his approach is decidedly creative and his recipes highly original. Balanced flavours are to the fore in dishes such as trout and veal with mushrooms thanks to the chef’s technical expertise, while over the years his presentation has become even more photogenic. A successful mix of experience and youth ensures excellent service, which adds to the enjoyable dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Isola%20San%20Biagio%2034%2C%20Montemonaco%2C%2063088%2C%20Italy"
    pageTitle="Il Tiglio"
  />
);

export default IlTiglio;
