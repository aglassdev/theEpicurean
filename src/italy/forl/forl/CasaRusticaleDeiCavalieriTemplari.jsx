...
const CasaRusticaleDeiCavalieriTemplari = () => (
  <RestaurantPage
    restaurantName="Casa Rusticale dei Cavalieri Templari"
    address="viale Bologna 275, Forlì, 47121, Italy"
    cuisine="Modern Cuisine, Emilian"
    priceRange="€€"
    phoneNumber="+390543701888"
    website="http://www.osteriadeitemplari.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This building, home to the San Bartolo Knights Templar “hospital” until the 13C, now houses an attractive restaurant which continues this old tradition of hospitality. Here, a friendly dining room with a pleasantly rustic yet elegant feel serves as a backdrop for generous, substantial cuisine with a hint of creativity. An outdoor space shaded by a vine-planted pergola completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Bologna%20275%2C%20Forl%C3%AC%2C%2047121%2C%20Italy"
    pageTitle="Casa Rusticale dei Cavalieri Templari"
  />
);

export default CasaRusticaleDeiCavalieriTemplari;
