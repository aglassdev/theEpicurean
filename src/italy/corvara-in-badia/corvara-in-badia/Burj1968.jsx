...
const Burj1968 = () => (
  <RestaurantPage
    restaurantName="Burjè 1968"
    address="str. Burje 11, Corvara in Badia, 39033, Italy"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+390471836043"
    website="https://www.burje1968.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ambitious Italian cuisine including some dishes inspired by French traditions, all creatively prepared with the occasional use of more exotic ingredients. If you’re having problems choosing from the à la carte, why not opt for the 5- or 7- course tasting menu?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=str.%20Burje%2011%2C%20Corvara%20in%20Badia%2C%2039033%2C%20Italy"
    pageTitle="Burjè 1968"
  />
);

export default Burj1968;
