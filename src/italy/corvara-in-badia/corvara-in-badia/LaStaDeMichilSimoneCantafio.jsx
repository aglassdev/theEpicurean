...
const LaStaDeMichilSimoneCantafio = () => (
  <RestaurantPage
    ...
    pageTitle="La Stüa de Michil - Simone Cantafio"
  />
);

export default LaStaDeMichilSimoneCantafio;
