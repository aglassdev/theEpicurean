...
const BistrotLaPerla = () => (
  <RestaurantPage
    restaurantName="Bistrot La Perla"
    address="strada Col Alt 105, Corvara in Badia, 39033, Italy"
    cuisine="Italian, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390471831000"
    website="https://www.laperlacorvara.it/it/mangiare/bistrot-music-club-bar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Take a culinary journey from the north of Italy to the south from the comfort of your table at the Bistrot La Perla, where guests are enthusiastically introduced to the many delightful flavours and ingredients this beautiful country has to offer. Excellent fish specialities also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Col%20Alt%20105%2C%20Corvara%20in%20Badia%2C%2039033%2C%20Italy"
    pageTitle="Bistrot La Perla"
  />
);

export default BistrotLaPerla;
