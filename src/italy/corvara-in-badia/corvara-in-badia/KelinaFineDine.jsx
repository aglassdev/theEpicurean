...
const KelinaFineDine = () => (
  <RestaurantPage
    restaurantName="KELINA Fine Dine"
    address="Strada Lech de Boà s.n., Corvara in Badia, 39033, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+3904711888166"
    website="https://www.boealpinelounge.it/it/kelina-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From Corvara, take the ultra-modern Boè cable-car to this restaurant (accessible also on skis or by foot) which is one of the dining options at the Piz Boè Alpine Lounge (for access, turn right as you exit the cable-car). Open at lunchtime only, KELINA serves unexpectedly gourmet cuisine in a minimalist-style dining room which allows the stunning views of Sassongher, Santa Croce and La Varella to take centre stage through the restaurant’s large floor-to-ceiling windows. The dishes are always modern and creative, combining Alpine ingredients with fresh fish – the red prawns with scampi mayonnaise and sea asparagus sorbet is a good example...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Strada%20Lech%20de%20Bo%C3%A0%20s.n.%2C%20Corvara%20in%20Badia%2C%2039033%2C%20Italy"
    pageTitle="KELINA Fine Dine"
  />
);

export default KelinaFineDine;
