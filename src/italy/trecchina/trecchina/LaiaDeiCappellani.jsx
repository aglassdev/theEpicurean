...
const LaiaDeiCappellani = () => (
  <RestaurantPage
    restaurantName="L'Aia dei Cappellani"
    address="contrada Maurino, Trecchina, 85049, Italy"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390973826937"
    website="https://www.laiadeicappellani.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the dining room there are old photos and equipment from country life, from the terrace the entire valley. Among widespread grasslands and olive trees enjoy fresh produce and home - cooked local dishes. In the dining room there are old photos and equipment from country life, from the terrace the entire valley. Among widespread grasslands and olive trees enjoy fresh produce and home - cooked local dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Maurino%2C%20Trecchina%2C%2085049%2C%20Italy"
    pageTitle="L'Aia dei Cappellani"
  />
);

export default LaiaDeiCappellani;
