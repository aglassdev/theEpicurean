...
const PodereSanFaustino = () => (
  <RestaurantPage
    restaurantName="Podere San Faustino"
    address="via San Faustino 33 (SS Emilia Nord), Fidenza, 43036, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+393891491867"
    website="https://www.poderesanfaustino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Bassa Parmense region, this old farmhouse has retained romantic reminders of bygone days. The menu also has a traditional feel, featuring dishes such as egg tagliolini with a salami, sun - dried tomato and onion sauce, and braised pork cheeks with a fennel carpaccio in an orange marinade. There’s also a good choice of delicious desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Faustino%2033%20(SS%20Emilia%20Nord)%2C%20Fidenza%2C%2043036%2C%20Italy"
    pageTitle="Podere San Faustino"
  />
);

export default PodereSanFaustino;
