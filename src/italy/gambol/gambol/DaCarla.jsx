...
const DaCarla = () => (
  <RestaurantPage
    restaurantName="Da Carla"
    address="via Necchi 3/5, fraz. Molino Isella, Gambolò, 27025, Italy"
    cuisine="Lombardian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390381930006"
    website="https://www.trattoriadacarla.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once a mill, this restaurant still stands next to its old canal which lends the setting a delightful bucolic ambience echoed in the warm, welcoming dining room. Highlights on the menu include risottos, frog’s legs, snails and goose - based dishes, as well as cured meats. Inviting guestrooms complete this delightfully rustic picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Necchi%203%2F5%2C%20fraz.%20Molino%20Isella%2C%20Gambol%C3%B2%2C%2027025%2C%20Italy"
    pageTitle="Da Carla"
  />
);

export default DaCarla;
