...
const AnticoRistorantePagnanelli = () => (
  <RestaurantPage
    restaurantName="Antico Ristorante Pagnanelli"
    address="via Gramsci 4, Castel Gandolfo, 00073, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39069360004"
    website="https://www.pagnanelli.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business since 1882, yet constantly evolving, this restaurant boasts a superb location overlooking the lake. The menu features meat and fish dishes, enhanced by wild herbs. The extensive wine selection is presented on two wine lists. Don’t miss the famous wine cellars built into the rock, plus the small wine museum...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gramsci%204%2C%20Castel%20Gandolfo%2C%2000073%2C%20Italy"
    pageTitle="Antico Ristorante Pagnanelli"
  />
);

export default AnticoRistorantePagnanelli;
