...
const LaPassion = () => (
  <RestaurantPage
    restaurantName="La Passion"
    address="via San Nicolò 5/b, Vandoies di Sopra, Vintl, 39030, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+390472868595"
    website="https://www.lapassion.it/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small, cosy, completely wood - panelled stube has been set up in this residential building. The menus are traditional but inventive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Nicol%C3%B2%205%2Fb%2C%20Vandoies%20di%20Sopra%2C%20Vintl%2C%2039030%2C%20Italy"
    pageTitle="La Passion"
  />
);
