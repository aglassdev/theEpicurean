...
const Bebop = () => (
  <RestaurantPage
    restaurantName="Bebop"
    address="via Riccardo Wagner 3, Palermo, 90139, Italy"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+393295340388"
    website="https://guide.michelin.com/en/sicilia/palermo/restaurant/bebop"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having studied classics, this young self-taught chef decided to follow his true passion, namely cooking. He prepares dishes inspired by Sicilian traditions yet reinterpreted with a personal twist, using the best regional products. The restaurant, situated in the heart of Palermo, is quiet and elegant yet also pleasantly informal in its service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Riccardo%20Wagner%203%2C%20Palermo%2C%2090139%2C%20Italy"
    pageTitle="Bebop"
  />
);
