...
const PalazzoBranciforte = () => (
  <RestaurantPage
    restaurantName="Palazzo Branciforte"
    address="via Bara all'Olivella 2, Palermo, 90133, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39091321748"
    website="https://www.ristorantepalazzobranciforte.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A relaxing oasis in the city centre which offers friendly service from staff who obviously want to ensure that your experience here is memorable. The dishes served are carefully prepared and full of flavour, boasting the occasional modern touch yet also inspired by local traditions. Try the Capricciosa vista mare: toasted black bread with capers and oregano served with red prawn, dried tomato, artichokes, basil and buffalo mozzarella mousse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bara%20all'Olivella%202%2C%20Palermo%2C%2090133%2C%20Italy"
    pageTitle="Palazzo Branciforte"
  />
);

export default PalazzoBranciforte;
