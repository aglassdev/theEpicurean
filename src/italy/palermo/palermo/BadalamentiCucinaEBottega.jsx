...
const BadalamentiCucinaEBottega = () => (
  <RestaurantPage
    restaurantName="Badalamenti Cucina e Bottega"
    address="Viale Galatea 55, Palermo, 90151, Italy"
    cuisine="Sicilian, Seafood"
    priceRange="€€"
    phoneNumber="+39091450213"
    website="http://www.badalamenticucinaebottega.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A historic address, established in the 1950s as a delicatessen selling charcuterie, cheeses and wines, it is now in its third generation and has been given a contemporary makeover. It is still “the shop” where you can buy local delicacies, but it also offers a restaurant service: traditional dishes from land and sea, revisited with taste and personality. The inspector's favourite dish? Cuttlefish ink arancina with red prawn tartare, pea cream and cheese fondue...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Viale%20Galatea%2055%2C%20Palermo%2C%2090151%2C%20Italy"
    pageTitle="Badalamenti Cucina e Bottega"
  />
);

export default BadalamentiCucinaEBottega;
