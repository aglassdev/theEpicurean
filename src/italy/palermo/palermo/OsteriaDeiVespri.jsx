...
const OsteriaDeiVespri = () => (
  <RestaurantPage
    restaurantName="Osteria dei Vespri"
    address="piazza Croce dei Vespri 6, Palermo, 90133, Italy"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+390916171631"
    website="https://www.osteriadeivespri.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the palazzo where the famous ball scene in the “The Leopard” by Luchino Visconti was filmed, this restaurant serves cuisine that moves with the times, featuring modern dishes made from local ingredients, while a friendly welcome from the long-established owners adds to the appeal. Cocktails, tapas and simpler yet equally delicious cuisine is served in the Occhiovivo! Bistrot next door, the name of which refers to a Sicilian saying which means “Be careful!”...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Croce%20dei%20Vespri%206%2C%20Palermo%2C%2090133%2C%20Italy"
    pageTitle="Osteria dei Vespri"
  />
);

export default OsteriaDeiVespri;
