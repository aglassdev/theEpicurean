...
const Miranda = () => (
  <RestaurantPage
    restaurantName="Miranda"
    address="via Cornello 8, Riva di Solto, 24060, Italy"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+39035986021"
    website="https://www.hotelristorantemiranda.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a superb location overlooking Lake Isea, this restaurant boasts superb views of the lake and Monte Isola from its outdoor terrace and dining room alike. The menu features fish (mainly from the sea) and meat dishes with a creative twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cornello%208%2C%20Riva%20di%20Solto%2C%2024060%2C%20Italy"
    pageTitle="Miranda"
  />
);
