...
const AmandusMAN = () => (
  <RestaurantPage
    ...
    address="via statale 125, Mandello del Lario, 23826, Italy"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3903411918026"
    website="https://amandusristorante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Villa Lario Resort, this restaurant directly overlooks the lake and boasts fine views which extend as far as the promontory of Bellagio. The excellent cuisine features a few freshwater fish dishes, as well as plenty of meat and seafood options, on a menu that combines classic recipes with a few more creative specialities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20statale%20125%2C%20Mandello%20del%20Lario%2C%2023826%2C%20Italy"
    pageTitle="Amandus"
  />
);

export default AmandusMAN;
