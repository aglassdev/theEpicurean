...
const AnticaLocandaDellorco = () => (
  <RestaurantPage
    restaurantName="Antica Locanda dell'Orco"
    address="via Ivrea 109, Rivarolo Canavese, 10086, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390124425101"
    website="https://www.locanda-dellorco.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fans of Piedmontese cuisine will find one of its best exponents in this restaurant located at the end of a beautiful porticoed street in the historic centre. Savour some of Italy’s most exciting regional cooking, such as snails, bagna caoda, agnolotti pasta, a few (mainly freshwater) fish dishes, braised and boiled meats, “finanziera” stew and some extraordinary desserts – all prepared in magnificent style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ivrea%20109%2C%20Rivarolo%20Canavese%2C%2010086%2C%20Italy"
    pageTitle="Antica Locanda dell'Orco"
  />
);

export default AnticaLocandaDellorco;
