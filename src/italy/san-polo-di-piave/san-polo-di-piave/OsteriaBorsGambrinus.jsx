...
const OsteriaBorsGambrinus = () => (
  <RestaurantPage
    restaurantName="Osteria Borsò Gambrinus"
    address="via Capitello 18, San Polo di Piave, 31020, Italy"
    cuisine="Venetian, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+390422855043"
    website="https://gambrinus.it/osteria-borso/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="A wine bar-cum-osteria with a warm, rustic decor and a menu offering fish and meat dishes, including specialities such as fried scampi, squid, crayfish and vegetables, all seasoned with olive oil. There’s also a good choice of wines by the glass, with a focus on natural wines...."
    ...
    pageTitle="Osteria Borsò Gambrinus"
  />
);

export default OsteriaBorsGambrinus;
