...
const ScuderieSabaude = () => (
  <RestaurantPage
    restaurantName="Scuderie Sabaude"
    address="via Amedeo di Savoia 5, Pollenzo, 12042, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393391019233"
    website="https://www.scuderiesabaude.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant just a stone’s throw from the Università del Gusto di Pollenzo is accessed via an old courtyard with a beautifully tended garden. Housed in the rustic setting of the former royal stables, the restaurant serves a delicious Piedmontese cuisine, light and impeccably presented. The “Tistot”, a delicious panna cotta, is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Amedeo%20di%20Savoia%205%2C%20Pollenzo%2C%2012042%2C%20Italy"
    pageTitle="Scuderie Sabaude"
  />
);

export default ScuderieSabaude;
