...
const Palazzaccio = () => (
  <RestaurantPage
    restaurantName="Palazzaccio"
    address="via Umberto I 23, Castelbuono, 90013, Italy"
    cuisine="Sicilian, Country cooking"
    priceRange="€€"
    phoneNumber="+390921676289"
    website="https://www.ristorantepalazzaccio.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A simple, almost rustic restaurant in the pedestrianised historic centre of one of the medieval villages that add to the special attraction of the Parco delle Madonie. Here, the owner prepares seasonal cuisine which is firmly anchored in the region, made from ingredients from the surrounding area. The antipasto is always good, and is served as a selection of five or six small bites made from vegetables, cheese and meat, as well as mushrooms. The home-made bread is excellent – the natural leavening process takes almost four days. A good wine selection completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Umberto%20I%2023%2C%20Castelbuono%2C%2090013%2C%20Italy"
    pageTitle="Palazzaccio"
  />
);

export default Palazzaccio;
