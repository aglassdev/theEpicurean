...
const Nangalarruni = () => (
  <RestaurantPage
    restaurantName="Nangalarruni"
    address="Cortile Ventimiglia 5, Castelbuono, 90013, Italy"
    cuisine="Sicilian, Regional Cuisine"
    priceRange="€"
    phoneNumber="+390921671228"
    website="http://www.hostarianangalarruni.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cortile%20Ventimiglia%205%2C%20Castelbuono%2C%2090013%2C%20Italy"
    pageTitle="Nangalarruni"
  />
);

export default Nangalarruni;
