...
const CenereMuseumBistrot = () => (
  <RestaurantPage
    restaurantName="CENERE - Museum & Bistrot"
    address="via Plinio 39, Pompei, 80045, Italy"
    cuisine="Campanian"
    priceRange="€€"
    phoneNumber="+3908119535367"
    website="https://guide.michelin.com/en/campania/pompei/restaurant/cenere-museum-bistrot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fans of Campanian cuisine will be in their element at this restaurant situated opposite the archaeological site. Here, the chef serves traditional regional favourites alongside more creative recipes, often prepared using local specialities such as purple artichoke from Schito, chickpeas from Teano, Provola cheese from Agerola, red sausage from Castelpoto and Black Casertona pork. Of the two dining rooms, the one in the cellar is particularly charming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Plinio%2039%2C%20Pompei%2C%2080045%2C%20Italy"
    pageTitle="CENERE - Museum & Bistrot"
  />
);

export default CenereMuseumBistrot;
