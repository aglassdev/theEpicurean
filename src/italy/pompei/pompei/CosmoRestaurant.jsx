...
const CosmoRestaurant = () => (
  <RestaurantPage
    restaurantName="Cosmo Restaurant"
    address="viale Giuseppe Mazzini 103, Pompei, 80045, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393496053063"
    website="https://www.cosmorestaurantpompei.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the cuisine at Cosmo is influenced by the ingredients and culinary traditions of Campania, this restaurant is also an excellent choice for those in search of more elaborate and creative fare. Top-quality, complex dishes prepared by two young chefs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Giuseppe%20Mazzini%20103%2C%20Pompei%2C%2080045%2C%20Italy"
    pageTitle="Cosmo Restaurant"
  />
);

export default CosmoRestaurant;
