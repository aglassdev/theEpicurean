...
const Capasanta = () => (
  <RestaurantPage
    restaurantName="Capasanta"
    address="Via Carlo Alberto 14, Pompei, 80045, Italy"
    cuisine="Seafood, Contemporary"
    priceRange="€€"
    phoneNumber="+3908118239087"
    website="https://guide.michelin.com/en/campania/pompei/restaurant/capasanta"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Carlo%20Alberto%2014%2C%20Pompei%2C%2080045%2C%20Italy"
    pageTitle="Capasanta"
  />
);

export default Capasanta;
