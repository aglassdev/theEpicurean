...
const IlPrincipe = () => (
  <RestaurantPage
    restaurantName="Il Principe"
    address="via Colle San Bartolomeo 4, Pompei, 80045, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390818505566"
    website="https://www.ilprincipe.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Colle%20San%20Bartolomeo%204%2C%20Pompei%2C%2080045%2C%20Italy"
    pageTitle="Il Principe"
  />
);

export default IlPrincipe;
