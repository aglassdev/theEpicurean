...
const ResidenzaDelLago = () => (
  <RestaurantPage
    restaurantName="Residenza del Lago"
    address="via Roma 48, Candia Canavese, 10010, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390119834885"
    website="https://www.residenzadelago.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting a tranquil, homely atmosphere typical of the region and with a name that pays homage to Lake Candia, this restaurant occupies a mid-18C farmhouse that is now located within the town. Its traditional cuisine includes popular dishes such as potato cake with seared shrimp and artichokes, “tajarin vecchio Piemonte” (pasta with a meat sauce), and beef cheeks cooked in Erbaluce di Caluso wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2048%2C%20Candia%20Canavese%2C%2010010%2C%20Italy"
    pageTitle="Residenza del Lago"
  />
);

export default ResidenzaDelLago;
