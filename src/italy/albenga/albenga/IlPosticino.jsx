...
const IlPosticino = () => (
  <RestaurantPage
    restaurantName="Il Posticino"
    address="Via Mariettina Lengueglia 49, Albenga, 17031, Italy"
    cuisine="Seafood, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+393927754635"
    website="https://guide.michelin.com/en/liguria/albenga/restaurant/il-posticino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A tiny gem in the historic center, just steps from the San Michele towers. A very intimate setting, with a refined yet informal atmosphere. The cuisine? Seafood with a seasonal twist, including standouts such as the surprising Brandapolenta: creamy baccala, crispy polenta, taggiasca olive pâté. Reserving a table – especially for outdoor seating – is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Mariettina%20Lengueglia%2049%2C%20Albenga%2C%2017031%2C%20Italy"
    pageTitle="Il Posticino"
  />
);

export default IlPosticino;
