...
const VescovoMoro = () => (
  <RestaurantPage
    restaurantName="Vescovo Moro"
    address="via Pontida 3, Verona, 37123, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390458035084"
    website="https://www.vescovomoro.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated 50 metres from the basilica of San Zeno (the patron saint of Verona), this restaurant housed in a renovated workshop boasts plenty of outdoor space for summer dining. Here, enjoy eclectic cuisine with an equal balance of Mediterranean and traditional flavours, including an excellent array of raw fish dishes and a small selection of Italian caviar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pontida%203%2C%20Verona%2C%2037123%2C%20Italy"
    pageTitle="Vescovo Moro"
  />
);

export default VescovoMoro;
