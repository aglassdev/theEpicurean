...
const OsteriaLaFontanina = () => (
  <RestaurantPage
    restaurantName="Osteria la Fontanina"
    address="portichetti Fontanelle Santo Stefano 3, Verona, 37129, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+39045913305"
    website="https://www.ristorantelafontanina.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a stone’s throw from the Roman Theatre and Ponte Pietra, Osteria La Fontanina is one of Verona’s oldest restaurants with a history that dates back over 200 years. The restaurant has a “bohemian” feel, with old mirrors, prints, silverware and plants that combine well with the subdued lighting (even at lunchtime) and just about enough space for the small tables. The cuisine showcases Italian and regional flavours, while the impressive wine list focuses on red wine vintages from the Verona region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=portichetti%20Fontanelle%20Santo%20Stefano%203%2C%20Verona%2C%2037129%2C%20Italy"
    pageTitle="Osteria la Fontanina"
  />
);

export default OsteriaLaFontanina;
