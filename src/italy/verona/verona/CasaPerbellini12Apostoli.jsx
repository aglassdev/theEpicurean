...
const CasaPerbellini12Apostoli = () => (
  <RestaurantPage
    restaurantName="Casa Perbellini 12 Apostoli"
    address="vicolo Corticella San Marco 3, Verona, 37121, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390458780860"
    website="https://www.casaperbellini.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Giancarlo Perbellini returns to his origins in this historic restaurant in his native city, where every chef from Verona (and possibly beyond) would like to work. The updated decor gives the restaurant even more appeal, as does the culinary style and philosophy showcased on three tasting menus: “Io e Silva”, which includes decidedly imaginative dishes (such as cooked and raw shellfish with a dash of soya and peppers) and is dedicated to his wife; “Io e Giorgio”, dedicated to his mentor and former restaurant owner, which features more classic recipes; and, last but not least, the completely vegetarian “L'Essenza”. Special mention must be made of the wine list, which includes an extensive selection of French labels, of which both the sommelier and Giancarlo are huge fans. As a final attracti..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vicolo%20Corticella%20San%20Marco%203%2C%20Verona%2C%2037121%2C%20Italy"
    pageTitle="Casa Perbellini 12 Apostoli"
  />
);

export default CasaPerbellini12Apostoli;
