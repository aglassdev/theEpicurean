...
const AlCapitanDellaCittadella = () => (
  <RestaurantPage
    restaurantName="Al Capitan della Cittadella"
    address="piazza Cittadella 7/a, Verona, 37122, Italy"
    cuisine="Seafood, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+39045595157"
    website="https://www.alcapitan.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just outside the town walls, Al Capitan has been one of the most renowned fish restaurants in Verona for over fifteen years. Classic Italian dishes with a contemporary twist added by the owner-chef take pride of place here, with an emphasis on top-quality ingredients. The wine list includes a good selection of French wines, with a particular focus on champagnes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Cittadella%207%2Fa%2C%20Verona%2C%2037122%2C%20Italy"
    pageTitle="Al Capitan della Cittadella"
  />
);

export default AlCapitanDellaCittadella;
