...
const TrattoriaIMasenini = () => (
  <RestaurantPage
    restaurantName="Trattoria I Masenini"
    address="via Roma 34, Verona, 37121, Italy"
    cuisine="Italian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390458065169"
    website="https://trattoriaimasenini.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in an attractive part of Verona right opposite the famous Castelvecchio, this restaurant boasts a relaxing ambience with wood ceilings, classic yet informal furnishings, subtle lighting and soft background music. The menu features regional dishes alongside typical Italian fare, as well as the house speciality – meat kebabs cooked on a skewer. There’s also an outdoor space for alfresco dining in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2034%2C%20Verona%2C%2037121%2C%20Italy"
    pageTitle="Trattoria I Masenini"
  />
);

export default TrattoriaIMasenini;
