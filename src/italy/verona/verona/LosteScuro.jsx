...
const LosteScuro = () => (
  <RestaurantPage
    restaurantName="L'Oste Scuro"
    address="vicolo San Silvestro 10, Verona, 37122, Italy"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39045592650"
    website="https://www.ristoranteostescuro.tv"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nice family trattoria atmosphere in a popular, central fashionable location that stresses the freshness of the proprietor's dishes: fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vicolo%20San%20Silvestro%2010%2C%20Verona%2C%2037122%2C%20Italy"
    pageTitle="L'Oste Scuro"
  />
);

export default LosteScuro;
