...
const LaLoggiaBistr = () => (
  <RestaurantPage
    restaurantName="La Loggia Bistrò"
    address="Corte Sgarzarie 7, Verona, 37121, Italy"
    cuisine="Contemporary, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+390452589762"
    website="https://la-loggia-bistro.business.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Slightly off the beaten track yet still in the town centre, this restaurant boasts a courtyard setting for summer dining plus an intimate interior room with just a few small square tables, subtle lighting and an attractive decor featuring old wine bottles. A far cry from the classic tourist fare often available elsewhere, the cuisine served here is imaginatively presented with a focus on the use of seasonal ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corte%20Sgarzarie%207%2C%20Verona%2C%2037121%2C%20Italy"
    pageTitle="La Loggia Bistrò"
  />
);

export default LaLoggiaBistr;
