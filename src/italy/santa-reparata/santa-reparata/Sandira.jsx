...
const Sandira = () => (
  <RestaurantPage
    restaurantName="S'Andira"
    address="via Orsa Minore 1, Santa Reparata, 07028, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390789754273"
    website="https://www.sandira.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Italian this translates into he who goes, but you will never feel like leaving this place. Located amidst granite boulders sculpted by the wind, juniper trees and the sea that will tantalize your vision and your palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Orsa%20Minore%201%2C%20Santa%20Reparata%2C%2007028%2C%20Italy"
    pageTitle="S'Andira"
  />
);

export default Sandira;
