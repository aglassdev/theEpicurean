...
const Gnocchetto = () => (
  <RestaurantPage
    restaurantName="Gnocchetto"
    address="via Primo Maggio 56, Tavernerio, 22038, Italy"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+39031426133"
    website="https://www.gnocchetto.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established family-run restaurant (opened in 1926) with an updated contemporary decor continues to serve cuisine that is classic and generous in style yet adapted to modern tastes. Individual dishes take pride of place on the menu at lunchtime, although you can also order from the À la carte if you wish. There’s also an outdoor space for summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Primo%20Maggio%2056%2C%20Tavernerio%2C%2022038%2C%20Italy"
    pageTitle="Gnocchetto"
  />
);

export default Gnocchetto;
