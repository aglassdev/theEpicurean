...
const Fre = () => (
  <RestaurantPage
    restaurantName="FRE"
    address="località San Sebastiano 68, Monforte d'Alba, 12065, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390173789269"
    website="https://www.revamonforte.com/it/resort-con-ristorante-langhe"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestled among the vineyards of the Réva resort less than 4km from the delightful village of Monforte d'Alba, you’ll find the FRE restaurant run by chef Francesco Marchese, who offers a perfect combination of sophisticated French techniques and fine ingredients from the Langhe with refined simplicity. For all their sophistication, the dishes are always full of rich flavours – the ravioli del plin with crispy sweetbreads, onion cooked in milk and dehydrated beer yeast is a perfect example. There’s a superb wine list with labels also available by the glass, while more informal fare is served at the Piccolo FRE Bistrot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20San%20Sebastiano%2068%2C%20Monforte%20d'Alba%2C%2012065%2C%20Italy"
    pageTitle="FRE"
  />
);
