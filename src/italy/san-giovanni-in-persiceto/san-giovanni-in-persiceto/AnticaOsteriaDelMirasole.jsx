...
const AnticaOsteriaDelMirasole = () => (
  <RestaurantPage
    restaurantName="Antica Osteria del Mirasole"
    address="via Matteotti 17/a, San Giovanni in Persiceto, 40017, Italy"
    cuisine="Emilian"
    priceRange="€€"
    phoneNumber="+39051821273"
    website="https://www.osteriadelmirasole.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightful restaurant overflowing with memories of the past, where the top-quality cuisine has strong roots in the gastronomic traditions of this region, including a selection of meats cooked over the charcoal grill. Fans of Emilian cuisine will be happy to return to this restaurant time and time again, never tiring of its delicious regional fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Matteotti%2017%2Fa%2C%20San%20Giovanni%20in%20Persiceto%2C%2040017%2C%20Italy"
    pageTitle="Antica Osteria del Mirasole"
  />
);

export default AnticaOsteriaDelMirasole;
