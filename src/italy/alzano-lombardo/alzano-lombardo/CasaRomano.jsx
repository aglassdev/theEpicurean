...
const CasaRomano = () => (
  <RestaurantPage
    restaurantName="Casa Romano"
    address="Via Belvedere, 55, Alzano Lombardo, 24022, Italy"
    cuisine="Seasonal Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+39035515135"
    website="https://casaromanoristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The family restaurant, a fixture on the square for some sixty years and once known for hosting banquets, has been renovated by the younger generation (siblings and cousins) transforming it into an elegant space that is also panoramic thanks to expansive windows overlooking the surrounding landscape. In the kitchen, thirty-year-old Luca Adobati, already shaped by notable experiences both in Italy and abroad, presents colorful, flavorful dishes that follow the seasons, offered through a concise à la carte menu and a seven-course surprise tasting journey. Among the highlights we savored, for example, the amberjack with its aromatic, indulgent mushroom trilogy, and a memorable finale of puff pastry apple, hay gelato, and zabaione. For weekday lunch, a streamlined business lunch option is also ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Belvedere%2C%2055%2C%20Alzano%20Lombardo%2C%2024022%2C%20Italy"
    pageTitle="Casa Romano"
  />
);

export default CasaRomano;
