...
const SalvoCacciatori = () => (
  <RestaurantPage
    restaurantName="Salvo Cacciatori"
    address="via Vieusseux 12, Oneglia, 18100, Italy"
    cuisine="Ligurian, Contemporary"
    priceRange="€€€"
    phoneNumber="+390183293763"
    website="https://ristorantesalvocacciatori.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vieusseux%2012%2C%20Oneglia%2C%2018100%2C%20Italy"
    pageTitle="Salvo Cacciatori"
  />
);

export default SalvoCacciatori;
