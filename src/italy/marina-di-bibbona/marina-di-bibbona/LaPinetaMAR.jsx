...
const LaPinetaMAR = () => (
  <RestaurantPage
    ...
    address="via dei Cavalleggeri Nord 27, Marina di Bibbona, 57020, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390586600016"
    website="https://lapinetadizazzeri.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Cavalleggeri%20Nord%2027%2C%20Marina%20di%20Bibbona%2C%2057020%2C%20Italy"
    pageTitle="La Pineta"
  />
);

export default LaPinetaMAR;
