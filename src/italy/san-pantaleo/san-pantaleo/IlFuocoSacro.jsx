...
const IlFuocoSacro = () => (
  <RestaurantPage
    restaurantName="Il Fuoco Sacro"
    address="strada di Buddeo, San Pantaleo, 07026, Italy"
    cuisine="Italian, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+3907891876441"
    website="https://www.enricobartolini.net/ristorante-fuoco-sacro"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated in the magical, rural and secluded setting of the Petra Segreta resort, surrounded by Mediterranean maquis scrubland, the gourmet Il Fuoco Sacro restaurant overlooks a delightful garden and boasts stunning views of the coast. The founder of this hidden paradise is chef-cum-entrepreneur Luigi Bergeretto, who serves modern, Mediterranean cuisine with a focus on locally sourced ingredients, including the excellent aromatic herbs grown on the hotel farm (which also provides the resort with its vegetables, cheeses and some meat). Last but not least, the menu is overseen by Enrico Bartolini – a 100% guarantee of a fine gourmet experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20di%20Buddeo%2C%20San%20Pantaleo%2C%2007026%2C%20Italy"
    pageTitle="Il Fuoco Sacro"
  />
);

export default IlFuocoSacro;
