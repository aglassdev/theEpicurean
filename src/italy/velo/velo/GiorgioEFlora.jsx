...
const GiorgioEFlora = () => (
  <RestaurantPage
    restaurantName="Giorgio e Flora"
    address="via Baldonò 1, lago di Velo d'Astico, Velo, 36010, Italy"
    cuisine="Venetian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390445713061"
    website="https://www.giorgioeflora.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small chalet - style villa overlooks the valley. It has an attractive, elegant and quiet dining room decorated with a feminine touch and a panoramic outdoor terrace. Modern cuisine from the Veneto takes pride of place on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Baldon%C3%B2%201%2C%20lago%20di%20Velo%20d'Astico%2C%20Velo%2C%2036010%2C%20Italy"
    pageTitle="Giorgio e Flora"
  />
);

export default GiorgioEFlora;
