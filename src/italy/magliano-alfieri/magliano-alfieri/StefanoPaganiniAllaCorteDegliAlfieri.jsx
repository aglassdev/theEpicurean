...
const StefanoPaganiniAllaCorteDegliAlfieri = () => (
  <RestaurantPage
    restaurantName="Stefano Paganini alla Corte degli Alfieri"
    address="piazza Raimondo 2, Magliano Alfieri, 12050, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+39017366244"
    website="https://www.stefanopaganini.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a superb 17C castle, this restaurant has two dining rooms: one is decorated with works by local artists which change throughout the year, while the other, more romantic in feel, is adorned with roses and boasts splendid frescoed ceilings. There’s no choice here, just a tasting menu (although guests can select just a few courses if they wish), but the cuisine is of excellent quality and offers good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Raimondo%202%2C%20Magliano%20Alfieri%2C%2012050%2C%20Italy"
    pageTitle="Stefano Paganini alla Corte degli Alfieri"
  />
);

export default StefanoPaganiniAllaCorteDegliAlfieri;
