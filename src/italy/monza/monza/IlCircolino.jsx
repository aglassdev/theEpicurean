...
const IlCircolino = () => (
  <RestaurantPage
    restaurantName="Il Circolino"
    address="via Anita Garibaldi 4, Monza, 20900, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+390396363374"
    website="https://www.il-circolino.it"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At the entrance there is the cafeteria with the bistro with a dedicated kitchen and a beautiful garden for the summer, while a folding door conceals the contemporary and elegant dining room, where the gourmet meat and fish offerings come in, of which we especially enjoyed – jumping through the various menus as you can do by choosing à la carte – Risotto with Grana Padano Riserva, black garlic with cardamom and red wine sauce (Il Circolino), as well as turbot alla plancha, oyster, fennel and vermouth sauce (Viaje), Black lemon, shiso and kombu seaweed to close on an exotic, fresh and digestive note. In short, an interesting cuisine created by the talented resident chef Lorenzo Sacchi!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Anita%20Garibaldi%204%2C%20Monza%2C%2020900%2C%20Italy"
    pageTitle="Il Circolino"
  />
);

export default IlCircolino;
