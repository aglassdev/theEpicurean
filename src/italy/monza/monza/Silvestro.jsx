...
const Silvestro = () => (
  <RestaurantPage
    restaurantName="Silvestro"
    address="Via Lecco 160, Monza, 20900, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+393895649903"
    website="https://www.ristorantesilvestro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosy, welcoming restaurant with a contemporary feel situated on the edge of Monza’s park. Owner-chef Giuseppe Silvestro is young and talented, with excellent experience in renowned restaurants, and very precise ideas about the type of cuisine he wants to serve here, namely personalised and imaginative dishes inspired by the region and the Mediterranean. We particularly enjoyed the morone fish served with a Piennolo cherry tomato cream and the “mantecato” made with fish scraps...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Lecco%20160%2C%20Monza%2C%2020900%2C%20Italy"
    pageTitle="Silvestro"
  />
);

export default Silvestro;
