...
const LaKucina = () => (
  <RestaurantPage
    restaurantName="La Kucina"
    address="via Giulio De Petra 67, Foggia, 71121, Italy"
    cuisine="Italian Contemporary, Grills"
    priceRange="€€"
    phoneNumber="+390881331274"
    website="https://www.lakucina.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern, welcoming restaurant on the outskirts of town serves contemporary cuisine on a varied menu which also includes simpler options to suit all budgets, especially at lunchtime. In the dining room, a cabinet for ageing meat houses some excellent Iberian hams...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giulio%20De%20Petra%2067%2C%20Foggia%2C%2071121%2C%20Italy"
    pageTitle="La Kucina"
  />
);

export default LaKucina;
