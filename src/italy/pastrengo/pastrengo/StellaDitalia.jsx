...
const StellaDitalia = () => (
  <RestaurantPage
    restaurantName="Stella d'Italia"
    address="piazza Carlo Alberto 25, Pastrengo, 37010, Italy"
    cuisine="Classic Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+390457170034"
    website="https://www.stelladitalia.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Regional specialities, including snails and pike, in a historical establishment, once an inn now an elegant establishment under the management of Signor Umberto...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Carlo%20Alberto%2025%2C%20Pastrengo%2C%2037010%2C%20Italy"
    pageTitle="Stella d'Italia"
  />
);

export default StellaDitalia;
