...
const LangosteriaParaggi = () => (
  <RestaurantPage
    restaurantName="Langosteria Paraggi"
    address="via Paraggi a Mare 1, Paraggi, 16038, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+390185046284"
    website="https://www.langosteria.com/it/langosteria-paraggi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The elegant Milanese style of the famous Langosteria restaurant has been given a maritime and holiday feel in its seasonal sibling which is housed within the Bagni Fiore overlooking the small yet stunning Paraggi bay. Langosteria Paraggi boasts a vintage decor which is at the same time glamorous and up-to-date, views of the beach and the sea, and a menu focusing on delicious fresh fish and seafood such as oysters and shellfish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Paraggi%20a%20Mare%201%2C%20Paraggi%2C%2016038%2C%20Italy"
    pageTitle="Langosteria Paraggi"
  />
);

export default LangosteriaParaggi;
