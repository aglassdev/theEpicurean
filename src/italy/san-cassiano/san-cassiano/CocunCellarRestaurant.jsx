...
const CocunCellarRestaurant = () => (
  <RestaurantPage
    restaurantName="Cocun Cellar Restaurant"
    address="strada Prè de Vì 31, San Cassiano, 39036, Italy"
    cuisine="Contemporary, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390471849445"
    website="https://www.ciasasalares.it/it/ristoranti/cocun-cellar-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this restaurant within the elegant Ciasa Salares hotel, guests dine in a wine cellar with a pleasantly informal and friendly atmosphere. In addition to the excellent cuisine, the fine cheese selection comes highly recommended, as does a visit to the room dedicated entirely to chocolate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Pr%C3%A8%20de%20V%C3%AC%2031%2C%20San%20Cassiano%2C%2039036%2C%20Italy"
    pageTitle="Cocun Cellar Restaurant"
  />
);

export default CocunCellarRestaurant;
