...
const PrincipeDiBelludia = () => (
  <RestaurantPage
    restaurantName="Principe di Belludia"
    address="contrada Belludia sp 51, Noto, 96017, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+3909311842020"
    website="https://ilsancorradodinoto.com/it/esperienza-sicilia/ristorante-gourmet-principe-di-belludia/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Principe di Belludia is the gourmet restaurant at the Il San Corrado di Noto hotel, a luxurious resort in a secluded rural location with two enormous swimming pools. The new executive chef Martin Lazarov showcases his love for Sicily, with a particular attention to vegetables dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Belludia%20sp%2051%2C%20Noto%2C%2096017%2C%20Italy"
    pageTitle="Principe di Belludia"
  />
);

export default PrincipeDiBelludia;
