...
const TaDelKosmo = () => (
  <RestaurantPage
    restaurantName="Téa del Kosmo"
    address="Via Bondi 473/d, Livigno, 23041, Italy"
    cuisine="Creative, Alpine"
    priceRange="€€€€"
    phoneNumber="+393461152048"
    website="https://www.kosmotastethemountain.com/la-tea/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once you’ve left your car in the car park, take the lift to the third floor of this building, where you’ll find the Kosmo Taste the Mountain restaurant – from here, staff will accompany you to the gourmet Téa del Kosmo. “Téa” means chalet in Valtellina dialect and the impression here is of exactly that – a modern chalet with just four tables. When you book online you’ll be given the choice of two tasting menus, both of which showcase Alpine ingredients interpreted with a creative twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Bondi%20473%2Fd%2C%20Livigno%2C%2023041%2C%20Italy"
    pageTitle="Téa del Kosmo"
  />
);

export default TaDelKosmo;
