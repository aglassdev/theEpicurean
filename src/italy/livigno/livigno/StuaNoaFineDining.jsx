...
const StuaNoaFineDining = () => (
  <RestaurantPage
    restaurantName="Stua Noa Fine Dining"
    address="via Plan 114, Livigno, 23041, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+390342990108"
    website="https://www.stuanoa.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Concordia hotel, this restaurant boasts two modern Stube-style dining rooms. At the helm in the kitchen, young chef Andrea Fugnanesi delights guests with his creative cuisine in which local influences are evident, although some of his dishes are more innovative and imaginative in flavour and not always linked to the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Plan%20114%2C%20Livigno%2C%2023041%2C%20Italy"
    pageTitle="Stua Noa Fine Dining"
  />
);

export default StuaNoaFineDining;
