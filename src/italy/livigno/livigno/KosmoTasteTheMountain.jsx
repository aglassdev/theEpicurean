...
const KosmoTasteTheMountain = () => (
  <RestaurantPage
    restaurantName="Kosmo Taste the Mountain"
    address="via Bondi 473/a, Livigno, 23041, Italy"
    cuisine="Alpine, Contemporary"
    priceRange="€€"
    phoneNumber="+393461152048"
    website="https://www.kosmotastethemountain.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone’s throw from the centre and also accessible from the ski slopes in winter, this contemporary, Alpine-style restaurant boasts a spacious dining room and large picture windows. The cuisine reflects the traditions of the Valtellina mountains, with a dedicated space for the charcoal grill and an excellent selection of cheeses. The extensive wine list pays particular attention to mountain wines produced by wineries with a sustainable focus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bondi%20473%2Fa%2C%20Livigno%2C%2023041%2C%20Italy"
    pageTitle="Kosmo Taste the Mountain"
  />
);

export default KosmoTasteTheMountain;
