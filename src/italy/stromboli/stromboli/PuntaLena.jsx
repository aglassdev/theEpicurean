...
const PuntaLena = () => (
  <RestaurantPage
    restaurantName="Punta Lena"
    address="via Monsignor Di Mattina 8, località Ficogrande, Stromboli, 98055, Italy"
    cuisine="Sicilian, Seafood"
    priceRange="€€"
    phoneNumber="+39090986204"
    website="https://www.ristorantepuntalenastromboli.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this restaurant, dine under a pergola with superb views of the sea and Strombolicchio – the perfect setting for any occasion. The menu focuses on fish, including raw and dry-aged fish options. The first courses have a local flavour and are particularly delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Monsignor%20Di%20Mattina%208%2C%20localit%C3%A0%20Ficogrande%2C%20Stromboli%2C%2098055%2C%20Italy"
    pageTitle="Punta Lena"
  />
);

export default PuntaLena;
