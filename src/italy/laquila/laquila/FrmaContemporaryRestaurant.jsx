...
const FrmaContemporaryRestaurant = () => (
  <RestaurantPage
    restaurantName="FØRMA contemporary restaurant"
    address="via Fortebraccio 53, L'Aquila, 67100, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€"
    phoneNumber="+393316880236"
    website="https://www.formarestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a secluded residential district that is part of L’Aquila’s historic centre, this intimate restaurant with an elegantly minimalist ambience is home to skilful owner-chef Simone Ciuffetelli. Having gained experience working abroad, Ciuffetelli showcases local ingredients in his creative, contemporary dishes, with the occasional use of fermented products and a frequent focus on just three ingredients. A good example is his dessert featuring cream and crunchy toasted hazelnuts generously coated with a white-chocolate mousse that is “disguised” as an Italian-style meringue thanks to a sprinkling of liquorice powder...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Fortebraccio%2053%2C%20L'Aquila%2C%2067100%2C%20Italy"
    pageTitle="FØRMA contemporary restaurant"
  />
);

export default FrmaContemporaryRestaurant;
