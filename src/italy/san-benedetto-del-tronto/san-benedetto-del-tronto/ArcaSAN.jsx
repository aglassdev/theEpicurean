...
const ArcaSAN = () => (
  <RestaurantPage
    restaurantName="Arca"
    address="viale Rinascimento 143, San Benedetto del Tronto, 63074, Italy"
    cuisine="Modern Cuisine, Cuisine from Abruzzo"
    priceRange="€€€"
    phoneNumber="+390735488908"
    website="https://www.arcaristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After years of serving fine cuisine in Alba Adriatica, chef Massimiliano Capretta has moved around 15km away to the Hotel Smeraldo. Here, he pays careful attention to the use of organic produce, creating meat and fish dishes that are inspired by local traditions and prepared in a style that is a combination of classic and modern influences. Desserts remain in the capable hands of his sister Dalila, whose millefeuille is one of her standout dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Rinascimento%20143%2C%20San%20Benedetto%20del%20Tronto%2C%2063074%2C%20Italy"
    pageTitle="Arca"
  />
);

export default ArcaSAN;
