...
const OneThreeComuni = () => (
  <RestaurantPage
    restaurantName="13 Comuni"
    address="piazza della Vittoria 31, Velo Veronese, 37030, Italy"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390457835566"
    website="https://www.13comuni.it/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a pretty village square, this restaurant is reached by driving along picturesque mountain roads. Guests come to 13 Comuni to taste typical dishes from the Lessinia region, including lamb and Brogna mutton, as well as chicken, cheese and other delicious local specialities, all of which are rich and full of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Vittoria%2031%2C%20Velo%20Veronese%2C%2037030%2C%20Italy"
    pageTitle="13 Comuni"
  />
);

export default OneThreeComuni;
