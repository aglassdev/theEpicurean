...
const FaraglioniRestaurant = () => (
  <RestaurantPage
    restaurantName="Faraglioni Restaurant"
    address="lungomare dei Ciclopi 115, loc. Aci Trezza, Aci Castello, 95021, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390954192065"
    website="https://www.grandhotelfaraglioni.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated next to the hotel of the same name (a reference to the Faraglioni islands just off the coast here) but with its own entrance, this restaurant overlooks the beautiful Riviera dei Ciclopi. Sicilian ingredients take pride of place here in traditional and creative dishes with a focus on fish and seafood (vegetarian options are also available)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=lungomare%20dei%20Ciclopi%20115%2C%20loc.%20Aci%20Trezza%2C%20Aci%20Castello%2C%2095021%2C%20Italy"
    pageTitle="Faraglioni Restaurant"
  />
);

export default FaraglioniRestaurant;
