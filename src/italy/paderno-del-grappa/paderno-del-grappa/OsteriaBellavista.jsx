...
const OsteriaBellavista = () => (
  <RestaurantPage
    restaurantName="Osteria Bellavista"
    address="via Piovega 30, località Farra, Paderno del Grappa, 31017, Italy"
    cuisine="Italian Contemporary, Country cooking"
    priceRange="€€€"
    phoneNumber="+390423949329"
    website="https://www.osteriabellavista.tv.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An excellent modern inn offering a warm, family welcome. Imaginative yet traditional dishes made from market-fresh ingredients, with a balance of fish and meat dishes featuring on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Piovega%2030%2C%20localit%C3%A0%20Farra%2C%20Paderno%20del%20Grappa%2C%2031017%2C%20Italy"
    pageTitle="Osteria Bellavista"
  />
);

export default OsteriaBellavista;
