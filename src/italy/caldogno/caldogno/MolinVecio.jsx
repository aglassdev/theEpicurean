...
const MolinVecio = () => (
  <RestaurantPage
    restaurantName="Molin Vecio"
    address="via Giaroni 116, Caldogno, 36030, Italy"
    cuisine="Venetian, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+390444585168"
    website="https://www.molinvecio.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the idyllic setting of a 16C mill with a garden and small lake, this restaurant boasts an equally magical dining room with a warm, friendly and traditional feel. Top-quality dishes from the Veneto include a delicious sopressa(the region’s cured ham), Vicenza-style baccalà (cod) with Marano polenta and a soft guancetta served with a superb pendolòn (potato polenta)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giaroni%20116%2C%20Caldogno%2C%2036030%2C%20Italy"
    pageTitle="Molin Vecio"
  />
);

export default MolinVecio;
