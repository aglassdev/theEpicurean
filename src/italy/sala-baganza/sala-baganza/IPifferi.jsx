...
const IPifferi = () => (
  <RestaurantPage
    restaurantName="I Pifferi"
    address="via Zappati 36, Sala Baganza, 43038, Italy"
    cuisine="Emilian"
    priceRange="€"
    phoneNumber="+390521833243"
    website="https://www.ipifferi.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Zappati%2036%2C%20Sala%20Baganza%2C%2043038%2C%20Italy"
    pageTitle="I Pifferi"
  />
);

export default IPifferi;
