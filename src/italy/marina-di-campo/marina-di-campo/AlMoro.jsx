...
const AlMoro = () => (
  <RestaurantPage
    restaurantName="Al Moro"
    address="via Pietri 1277, Marina Di Campo, 57034, Italy"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+393931089999"
    website="https://www.ristorantealmoro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated away from the main tourist area, in a rustic building that is striking for its attractive outdoor space shaded by a wooden gazebo, this restaurant boasts an informal and relaxing atmosphere. The Mediterranean cuisine is full of character and prepared with top-quality ingredients, including a small selection of oysters...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pietri%201277%2C%20Marina%20Di%20Campo%2C%2057034%2C%20Italy"
    pageTitle="Al Moro"
  />
);

export default AlMoro;
