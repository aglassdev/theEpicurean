...
const OsteriaDaiCoghi = () => (
  <RestaurantPage
    restaurantName="Osteria dai Coghi"
    address="via Alcide De Gasperi 9/13, Albarè di Costermano, 37010, Italy"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+393473442158"
    website="https://guide.michelin.com/en/veneto/albare-di-costermano/restaurant/osteria-dai-coghi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This well-kept, welcoming restaurant with a colourful decor and wine bottles adorning the walls serves imaginative dishes with modern combinations – our inspector particularly enjoyed the guinea fowl supreme with smoked black tea, carrots and beluga lentils. The well-chosen wine list features labels from Italy and further afield...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Alcide%20De%20Gasperi%209%2F13%2C%20Albar%C3%A8%20di%20Costermano%2C%2037010%2C%20Italy"
    pageTitle="Osteria dai Coghi"
  />
);

export default OsteriaDaiCoghi;
