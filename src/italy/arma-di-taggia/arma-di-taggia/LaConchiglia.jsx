...
const LaConchiglia = () => (
  <RestaurantPage
    restaurantName="La Conchiglia"
    address="Lungomare 33, Arma di Taggia, 18011, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39018443169"
    website="https://guide.michelin.com/en/liguria/arma-di-taggia/restaurant/la-conchiglia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant with a vaulted ceiling provides the setting for dishes that have by now become classics thanks to their focus on top-quality ingredients. The cuisine is light and simple rather than bold and elaborate, with a focus on bringing out the full flavour of the fish (a few meat dishes are also available). If you’re keen to learn more about Ligurian gastronomic specialities, take time between courses to chat with the friendly owner, who has an impressive knowledge of the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lungomare%2033%2C%20Arma%20di%20Taggia%2C%2018011%2C%20Italy"
    pageTitle="La Conchiglia"
  />
);

export default LaConchiglia;
