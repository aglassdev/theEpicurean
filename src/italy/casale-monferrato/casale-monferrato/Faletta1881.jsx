...
const Faletta1881 = () => (
  <RestaurantPage
    restaurantName="Faletta 1881"
    address="Regione Mandoletta 81, Casale Monferrato, 15033, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€"
    phoneNumber="+390142670068"
    website="https://www.faletta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled amid the wine estates and rolling hills of Monferrato, this historic farmhouse has been carefully restored its enthusiastic owners. The restaurant here serves contemporary dishes inspired by regional and Italian recipes, as well as offering welcoming guestrooms (one or two with their own kitchen), a saltwater swimming pool and the relaxing ambience that comes with this rural setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Regione%20Mandoletta%2081%2C%20Casale%20Monferrato%2C%2015033%2C%20Italy"
    pageTitle="Faletta 1881"
  />
);

export default Faletta1881;
