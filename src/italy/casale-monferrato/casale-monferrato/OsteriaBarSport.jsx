...
const OsteriaBarSport = () => (
  <RestaurantPage
    restaurantName="Osteria Bar Sport"
    address="Strada Alessandria in San Germano 85, Casale Monferrato, 15033, Italy"
    cuisine="Traditional Cuisine, Piedmontese"
    priceRange="€€"
    phoneNumber="+393402385882"
    website="https://osteriabarsport.wordpress.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In what was once a typical sports bar, the friendly owner-chef serves home-style cuisine featuring traditional dishes from Monferrato and further afield. Don’t miss his plin pasta served with a roast meat sauce and a delicate cream of leeks, cotechino sausage and raw Mazara prawns. The atmosphere here is pleasantly informal and relaxed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Strada%20Alessandria%20in%20San%20Germano%2085%2C%20Casale%20Monferrato%2C%2015033%2C%20Italy"
    pageTitle="Osteria Bar Sport"
  />
);

export default OsteriaBarSport;
