...
const IlMolo = () => (
  <RestaurantPage
    ...
    address="via Falcone Borsellino 2, San Leone, 92100, Italy"
    cuisine="Sicilian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390922412095"
    website="https://guide.michelin.com/en/sicilia/san-leone/restaurant/il-molo-430027"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the seafront facing the small tourist harbour of San Leone, this elegant restaurant boasts an attractive summer terrace with a relaxed ambience. Here you can savour a selection of regional fish and meat dishes prepared by the owner-chef with ingredients of the highest quality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Falcone%20Borsellino%202%2C%20San%20Leone%2C%2092100%2C%20Italy"
    pageTitle="Il Molo"
  />
);

export default IlMolo;
