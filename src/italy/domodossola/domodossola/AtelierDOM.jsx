...
const AtelierDOM = () => (
  <RestaurantPage
    ...
    address="piazza Matteotti 36, Domodossola, 28845, Italy"
    cuisine="Country cooking, Contemporary"
    priceRange="€€€"
    phoneNumber="+390324481326"
    website="https://www.eurossola.com/it/atelier-restaurant/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Ossola gastronomic atelier offers a safe harbour for lovers of good food and drink in the town centre. The Bartolucci family's tradition has soared thanks to dynamic chef patron Giorgio and entrepreneurial sister Elisabetta, joined by Katia, whose smile and professionalism are invaluable to guest comfort. In addition to the welcoming service, the cuisine beckons clientele from afar. The evening menu is packed with revisited Ossola citations (among others, gathered in the tasting menu Flavours and Aromas of the Mountains) alongside contemporary Italian culinary nods. In certain occasional dishes you’ll find the fusion of meat and fish, cooked with such skill and experience that the - not easy - balance aligns perfectly. Such is the case with small local veal rolls stuffed with apple and..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Matteotti%2036%2C%20Domodossola%2C%2028845%2C%20Italy"
    pageTitle="Atelier"
  />
);

export default AtelierDOM;
