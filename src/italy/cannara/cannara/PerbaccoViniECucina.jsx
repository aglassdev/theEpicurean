...
const PerbaccoViniECucina = () => (
  <RestaurantPage
    restaurantName="Perbacco - Vini e Cucina"
    address="via Umberto I 14, Cannara, 06033, Italy"
    cuisine="Umbrian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390742720492"
    website="https://guide.michelin.com/en/umbria/cannara/restaurant/perbacco-vini-e-cucina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quiet and elegant restaurant in a small street in the village of Cannara has a stylish yet friendly ambience and serves traditional, local cuisine where onion is a star ingredient in many of the dishes – don’t miss the delicious onion soup with gruyère cheese. If you’re choosing a wine to accompany your meal, we suggest asking enthusiastic owner Ernesto for his astute recommendations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Umberto%20I%2014%2C%20Cannara%2C%2006033%2C%20Italy"
    pageTitle="Perbacco - Vini e Cucina"
  />
);

export default PerbaccoViniECucina;
