...
const IlFalconiere = () => (
  <RestaurantPage
    restaurantName="Il Falconiere"
    address="Località San Martino a Bocena 370, San Martino, 52044, Italy"
    cuisine="Tuscan, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390575612679"
    website="https://www.ilfalconiere.it/it/hotel-toscana-con-ristorante-stellato/ristorante-il-falconiere"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="To get to this exclusive restaurant, you drive through an idyllic landscape of small lanes lined with dry-stone walls and fields belonging to the Baracchi farm estate, of which Il Falconiere and the magnificent hotel of the same name are a part. Many of the ingredients served here, such as wine and olive oil, are produced on the estate and the restaurant’s strong connection with its local landscapes is evident. Specialities such as Chianina beef, local garlic and pici pasta feature in dishes spiced with aromatic herbs and full of the strong flavours of Tuscany...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20San%20Martino%20a%20Bocena%20370%2C%20San%20Martino%2C%2052044%2C%20Italy"
    pageTitle="Il Falconiere"
  />
);

export default IlFalconiere;
