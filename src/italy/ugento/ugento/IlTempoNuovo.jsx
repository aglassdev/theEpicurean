...
const IlTempoNuovo = () => (
  <RestaurantPage
    restaurantName="Il Tempo Nuovo"
    address="via Castello 13, Ugento, 73059, Italy"
    cuisine="Contemporary, Apulian"
    priceRange="€€€"
    phoneNumber="+3908331850721"
    website="https://www.iltemponuovo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now occupied by a charming boutique hotel, the Castello di Ugento is also home to this restaurant where the Puglian chef reinterprets the traditions of Salento in contemporary dishes that feature an array of meat, fish and vegetables. The staff will be more than happy to recommend the best accompaniment to your meal, whether this is a good wine from the plentiful wine list or a delicious cocktail...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castello%2013%2C%20Ugento%2C%2073059%2C%20Italy"
    pageTitle="Il Tempo Nuovo"
  />
);

export default IlTempoNuovo;
