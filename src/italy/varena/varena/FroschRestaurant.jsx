...
const FroschRestaurant = () => (
  <RestaurantPage
    restaurantName="Frosch Restaurant"
    address="via Santi Pietro e Paolo 1, Varena, 38030, Italy"
    cuisine="Contemporary, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+393773941672"
    website="https://www.frosch-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of the small village of Varena (just outside the more famous Cavalese), this romantic and intimate restaurant with modern comforts and a mountain ambience is home to a talented female chef. Her contemporary recipes focus on local produce combined with Mediterranean flavours in some of the fish dishes and international ingredients such as foie gras...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santi%20Pietro%20e%20Paolo%201%2C%20Varena%2C%2038030%2C%20Italy"
    pageTitle="Frosch Restaurant"
  />
);

export default FroschRestaurant;
