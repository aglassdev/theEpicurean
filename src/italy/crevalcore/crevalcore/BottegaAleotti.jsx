...
const BottegaAleotti = () => (
  <RestaurantPage
    restaurantName="Bottega Aleotti"
    address="via Paltrinieri 62, Crevalcore, 40014, Italy"
    cuisine="Italian Contemporary, Emilian"
    priceRange="€€"
    phoneNumber="+39051981651"
    website="https://www.ristorantebottegaaleotti.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a stone’s throw from the splendid Santa Croce church, this charming restaurant should not be missed. The cuisine combines Emilian traditions with fresh, local ingredients, and includes dishes with a more contemporary touch. The excellent bread and home-made pastries add to the overall dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Paltrinieri%2062%2C%20Crevalcore%2C%2040014%2C%20Italy"
    pageTitle="Bottega Aleotti"
  />
);

export default BottegaAleotti;
