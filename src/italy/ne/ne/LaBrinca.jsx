...
const LaBrinca = () => (
  <RestaurantPage
    restaurantName="La Brinca"
    address="via Campo di Ne 58, Ne, 16040, Italy"
    cuisine="Ligurian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390185337480"
    website="https://www.labrinca.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This trattoria run by the Circella family – without doubt one of the best in Italy – has been delighting guests since 1987. The menu features dishes and ingredients that are generous, full of flavour and strongly rooted in the region, including “dishes of the year” which go back to 2010. The superb wine cellar boasts a selection of over 1 000 labels, including some rare bottles, for which sommelier Matteo received Michelin’s Best Sommelier in Italy award in 2021. To sum up, this is the sort of restaurant that everyone would like in their neighbourhood!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Campo%20di%20Ne%2058%2C%20Ne%2C%2016040%2C%20Italy"
    pageTitle="La Brinca"
  />
);

export default LaBrinca;
