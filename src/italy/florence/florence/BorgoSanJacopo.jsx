...
const BorgoSanJacopo = () => (
  <RestaurantPage
    restaurantName="Borgo San Jacopo"
    address="borgo San Jacopo 62 r, Florence, 50125, Italy"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+39055281661"
    website="https://www.lungarnocollection.com/it/borgo-san-jacopo/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=borgo%20San%20Jacopo%2062%20r%2C%20Florence%2C%2050125%2C%20Italy"
    pageTitle="Borgo San Jacopo"
  />
);

export default BorgoSanJacopo;
