...
const IoOsteriaPersonale = () => (
  <RestaurantPage
    restaurantName="Io Osteria Personale"
    address="Borgo San Frediano 167r, Florence, 50124, Italy"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+390559331341"
    website="https://www.io-osteriapersonale.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The young owner of this restaurant has an interesting background – a former vet with a passion for food. He has opened one of the most fascinating restaurants in Florence, serving original dishes to diners looking for a change from more traditional fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Borgo%20San%20Frediano%20167r%2C%20Florence%2C%2050124%2C%20Italy"
    pageTitle="Io Osteria Personale"
  />
);

export default IoOsteriaPersonale;
