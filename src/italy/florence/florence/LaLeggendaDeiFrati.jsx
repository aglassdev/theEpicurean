...
const LaLeggendaDeiFrati = () => (
  <RestaurantPage
    restaurantName="La Leggenda dei Frati"
    address="costa San Giorgio 6/a, Florence, 50125, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390550680545"
    website="https://laleggendadeifrati.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After an uphill approach if you’re arriving here on foot, you come into the Villa Bardini museum complex and from there into this elegant and welcoming restaurant which provides the setting for delicious, creative and modern cuisine. Here, chef Filippo Saporito, never one to rest on his laurels, continues to experiment and perfect his cuisine, which focuses mainly on Italian culinary traditions and a scrupulous selection of top-quality ingredients, preferably from sustainable supply chains (various types of meat, bread and pasta), all showcased on different menus, including a vegetarian option. In summer, enjoy your meal on the romantic terrace surrounded by greenery and the scents of herbs, with a glimpse of Santa Croce church as a backdrop. Although the centre of Florence is not far away..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=costa%20San%20Giorgio%206%2Fa%2C%20Florence%2C%2050125%2C%20Italy"
    pageTitle="La Leggenda dei Frati"
  />
);

export default LaLeggendaDeiFrati;
