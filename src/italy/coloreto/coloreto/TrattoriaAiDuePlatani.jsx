...
const TrattoriaAiDuePlatani = () => (
  <RestaurantPage
    restaurantName="Trattoria Ai Due Platani"
    address="via Budellungo 104/a, Coloreto, 43123, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390521645626"
    website="https://www.aidueplatani.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a country setting just outside the town, this is one of the most famous restaurants in the province, so booking well in advance is highly recommended. Here, you’ll find cuisine with its roots in the region reinterpreted with a touch of creativity, with dishes that are presented in contemporary style. There’s an impressive selection of cured hams and the fresh pasta (including pumpkin or potato tortelli) is legendary, as is the ice-cream with freshly whipped cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Budellungo%20104%2Fa%2C%20Coloreto%2C%2043123%2C%20Italy"
    pageTitle="Trattoria Ai Due Platani"
  />
);

export default TrattoriaAiDuePlatani;
