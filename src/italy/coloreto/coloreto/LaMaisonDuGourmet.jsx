...
const LaMaisonDuGourmet = () => (
  <RestaurantPage
    restaurantName="La Maison du Gourmet"
    address="strada Budellungo 96, Coloreto, 43123, Italy"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390521645310"
    website="https://www.lamaisondugourmet.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a fully renovated old farm in the countryside outside Parma, this gourmet restaurant serves top-quality meat and fish dishes with a focus on creativity rather than local traditions. The starters are particularly delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Budellungo%2096%2C%20Coloreto%2C%2043123%2C%20Italy"
    pageTitle="La Maison du Gourmet"
  />
);

export default LaMaisonDuGourmet;
