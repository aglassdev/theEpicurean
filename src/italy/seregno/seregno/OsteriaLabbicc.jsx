...
const OsteriaLabbicc = () => (
  <RestaurantPage
    restaurantName="Osteria L'Abbiccì"
    address="via Medici da Seregno 29, Seregno, 20831, Italy"
    cuisine="Italian Contemporary, Lombardian"
    priceRange="€€"
    phoneNumber="+390362585115"
    website="https://osterialabbicci.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of Seregno, this modern inn boasts a bright, spacious dining room with an ambience which is both friendly and yet respectful of guests’ privacy. The cuisine is overseen by Davide, who trained with Mauro Elli, the owner-chef of Il Cantuccio in Albavilla. Here, he creates dishes full of character, with a focus on top-quality ingredients and skilful presentation techniques. For a memorable dining experience, the chef’s surprise menu makes an excellent choice. Impressive wine selection and professional service overseen by Gabriele add to the appeal. The business lunch offers excellent value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Medici%20da%20Seregno%2029%2C%20Seregno%2C%2020831%2C%20Italy"
    pageTitle="Osteria L'Abbiccì"
  />
);

export default OsteriaLabbicc;
