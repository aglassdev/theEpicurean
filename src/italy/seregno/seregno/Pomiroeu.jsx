...
const Pomiroeu = () => (
  <RestaurantPage
    restaurantName="Pomiroeu"
    address="via Garibaldi 37, Seregno, 20831, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390362237973"
    website="https://www.pomiroeu.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant, one of the finest in the region, is run by its owner Giancarlo Morelli and celebrated its 30th anniversary in 2023. Situated in the centre of Seregno, the restaurant is intimate and welcoming with walls adorned with beautiful works of contemporary art thanks to the restaurant’s partnership with a local art gallery. The cuisine here is modern yet unfussy and the chef is equally at ease with meat, fish and vegetable dishes. One of the few restaurants around Monza to still offer a cheese course!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Garibaldi%2037%2C%20Seregno%2C%2020831%2C%20Italy"
    pageTitle="Pomiroeu"
  />
);

export default Pomiroeu;
