...
const TavernaDeiCaldora = () => (
  <RestaurantPage
    restaurantName="Taverna dei Caldora"
    address="piazza Umberto I 13, Pacentro, 67030, Italy"
    cuisine="Cuisine from Abruzzo, Meats and Grills"
    priceRange="€"
    phoneNumber="+39086441139"
    website="https://guide.michelin.com/en/abruzzo/pacentro/restaurant/taverna-dei-caldora"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated amid the maze of narrow streets in the old town of Pacentro and occupying the wine cellars of an imposing 16C palazzo, this restaurant celebrates regional cuisine in all its glory in specialities such as spaghetti with saffron and truffles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Umberto%20I%2013%2C%20Pacentro%2C%2067030%2C%20Italy"
    pageTitle="Taverna dei Caldora"
  />
);

export default TavernaDeiCaldora;
