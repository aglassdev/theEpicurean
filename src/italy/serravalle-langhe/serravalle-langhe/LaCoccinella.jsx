...
const LaCoccinella = () => (
  <RestaurantPage
    restaurantName="La Coccinella"
    address="via Provinciale 5, Serravalle Langhe, 12050, Italy"
    cuisine="Piedmontese"
    priceRange="€€"
    phoneNumber="+390173748220"
    website="https://www.trattoriacoccinella.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Three brothers, all of them experts, are the enthusiastic managers of this very fine restaurant. Recent renovation has increased the comfort and popularity of the place. The cuisine is Piedmontese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Provinciale%205%2C%20Serravalle%20Langhe%2C%2012050%2C%20Italy"
    pageTitle="La Coccinella"
  />
);

export default LaCoccinella;
