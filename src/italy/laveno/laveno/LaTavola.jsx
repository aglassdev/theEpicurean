...
const LaTavola = () => (
  <RestaurantPage
    ...
    address="via Fortino 40, Laveno, 21014, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390332667257"
    website="https://ilporticciolo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Il Porticciolo hotel, this restaurant will appeal to anyone who enjoys a lakeside setting. Leave your car in the car park, then take the lift down to the dining room with its windows overlooking the water and views of the opposite shore of Lake Maggiore. The lake also takes pride of place in some of the creative, elaborate and personalised dishes on the two tasting menus created by Riccardo Bassetti, many of which feature freshwater fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Fortino%2040%2C%20Laveno%2C%2021014%2C%20Italy"
    pageTitle="La Tavola"
  />
);

export default LaTavola;
