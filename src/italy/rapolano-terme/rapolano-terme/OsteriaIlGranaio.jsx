...
const OsteriaIlGranaio = () => (
  <RestaurantPage
    restaurantName="Osteria Il Granaio"
    address="via dei Monaci, Rapolano Terme, 53040, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390577726975"
    website="https://osteriailgranaio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although it calls itself an osteria, Il Granaio is really a restaurant. It has elegant brick - arched dining rooms occupying a 17C palazzo in the historic centre of Rapolano. On the menu you will find Tuscan specialities such as pici pasta cooked with various sauces, peppery Tuscan beef stew and a selection of fish dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Monaci%2C%20Rapolano%20Terme%2C%2053040%2C%20Italy"
    pageTitle="Osteria Il Granaio"
  />
);

export default OsteriaIlGranaio;
