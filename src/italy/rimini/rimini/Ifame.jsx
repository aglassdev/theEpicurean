...
const Ifame = () => (
  <RestaurantPage
    restaurantName="i-Fame"
    address="viale Regina Elena 28, Rimini, 47921, Italy"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390541386331"
    website="https://www.i-fame.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightful journey into the future: modern, bright rooms featuring a play of white, mirrors, and glass. The cuisine also looks forward without forgetting the past: the chef from Rimini starts with mostly local ingredients (a lot of Adriatic fish on the menu, but also some meat) to create modern recipes, always rich in flavor and substance. The dessert “i-CLOUD” is very good and refreshing: a cloud of soft and delicious yogurt foam covering a yogurt and vanilla panna cotta, accompanied by various sorbets. The outdoor space with greenery is also attractive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Regina%20Elena%2028%2C%20Rimini%2C%2047921%2C%20Italy"
    pageTitle="i-Fame"
  />
);
