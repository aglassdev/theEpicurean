...
const DaLucio = () => (
  <RestaurantPage
    restaurantName="Da Lucio"
    address="viale Ortigara 80, Rimini, 47921, Italy"
    cuisine="Seafood, Contemporary"
    priceRange="€€€"
    phoneNumber="+3905411612020"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Ortigara%2080%2C%20Rimini%2C%2047921%2C%20Italy"
    pageTitle="Da Lucio"
  />
);

export default DaLucio;
