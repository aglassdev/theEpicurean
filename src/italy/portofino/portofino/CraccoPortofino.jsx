...
const CraccoPortofino = () => (
  <RestaurantPage
    restaurantName="Cracco Portofino"
    address="Molo Umberto I 9, Portofino, 16034, Italy"
    cuisine="Seafood, Contemporary"
    priceRange="€€€€"
    phoneNumber="+3901851636026"
    website="https://www.craccoportofino.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Portofino, the celebrated chef Cracco has installed himself in the building that was once no less than Il Pitosforo, right in front of the small harbour, guaranteeing his lucky guests a view of it, the piazzetta and the enchanting gulf. Through the skill and expertise of executive chef Mattia Pecis, it offers a moderately modern line of cuisine, in two tasting courses - 7 courses or 11 courses - which do not lack beautiful references to Ligurian recipes and ingredients (many vegetables directly from the Fescion Farmer's vegetable garden, a short distance away, in the mountains), with the novelty of the cold room for “maturing” the fish. The charming terrace, open in fine weather from 6.30 p.m. onwards, is the ideal location for aperitifs and dinners in the open air...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Molo%20Umberto%20I%209%2C%20Portofino%2C%2016034%2C%20Italy"
    pageTitle="Cracco Portofino"
  />
);

export default CraccoPortofino;
