...
const DavMare = () => (
  <RestaurantPage
    restaurantName="DaV  Mare"
    address="via Roma 2, Portofino, 16034, Italy"
    cuisine="Italian Contemporary, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+3901852678531"
    website="https://www.davmare.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The classic, wrought-iron outdoor dining space at this restaurant overlooks one of the most romantic little squares in Italy, while the view takes in the promontory dominated by its castle – a picture-postcard view that is famous around the world. The experienced Cerea family from the famous three-starred Michelin Da Vittoria restaurant in Bergamo are at the helm, serving consistently top-quality cuisine whether you’re here for a quick lunch or a gourmet dinner. It’s best to book ahead as the few tables are much in demand!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%202%2C%20Portofino%2C%2016034%2C%20Italy"
    pageTitle="DaV  Mare"
  />
);

export default DavMare;
