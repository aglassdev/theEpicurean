...
const OsteriaALeDueSpade = () => (
  <RestaurantPage
    restaurantName="Osteria a Le Due Spade"
    address="via Don Arcangelo Rizzi 11, Trento, 38122, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390461234343"
    website="https://www.leduespade.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautiful Stube-style restaurant in the city centre has existed since the Council of Trent, with a succession of chefs and owners serving food here ever since the 16C. Still run with skill and expertise today, the restaurant boasts a small, intimate Alpine-style dining room where Trento specialities (char, apple strudel with vanilla ice cream) are served alongside typical Italian fare (risotto with mussel power and parsley pesto). All the dishes are cooked with an imaginative touch, resulting in a perfect balance of tradition and modernity!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Don%20Arcangelo%20Rizzi%2011%2C%20Trento%2C%2038122%2C%20Italy"
    pageTitle="Osteria a Le Due Spade"
  />
);

export default OsteriaALeDueSpade;
