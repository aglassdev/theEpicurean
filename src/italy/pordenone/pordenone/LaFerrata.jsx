...
const LaFerrata = () => (
  <RestaurantPage
    restaurantName="La Ferrata"
    address="via Gorizia 7, Pordenone, 33170, Italy"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+39043420562"
    website="https://guide.michelin.com/en/friuli-venezia-giulia/pordenone/restaurant/la-ferrata"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Copper pots and lids and photos of locomotives adorn the walls of this friendly and welcoming trattoria. Enjoy generous portions of local specialities, including delicious snails cooked in butter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gorizia%207%2C%20Pordenone%2C%2033170%2C%20Italy"
    pageTitle="La Ferrata"
  />
);

export default LaFerrata;
