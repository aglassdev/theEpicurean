...
const AlSorriso = () => (
  <RestaurantPage
    restaurantName="Al Sorriso"
    address="via Roma 18, Soriso, 28010, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+390322983228"
    website="https://www.alsorriso.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2018%2C%20Soriso%2C%2028010%2C%20Italy"
    pageTitle="Al Sorriso"
  />
);

export default AlSorriso;
