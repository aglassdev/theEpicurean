...
const LocandaMariella = () => (
  <RestaurantPage
    restaurantName="Locanda Mariella"
    address="località Fragnolo 29, Calestano, 43030, Italy"
    cuisine="Emilian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+39052552102"
    website="https://locandamariella.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You need to book at least 24hrs in advance at this restaurant by sending an email and your choice of the three menus on offer (traditional, meat or fish). This long-established, legendary restaurant is one of the best trattorias in the province, if not the region. Still run by the same family, it has been delighting guests in this corner of the Apennines since the 1960s...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Fragnolo%2029%2C%20Calestano%2C%2043030%2C%20Italy"
    pageTitle="Locanda Mariella"
  />
);

export default LocandaMariella;
