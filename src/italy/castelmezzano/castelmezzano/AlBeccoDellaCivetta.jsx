...
const AlBeccoDellaCivetta = () => (
  <RestaurantPage
    restaurantName="Al Becco della Civetta"
    address="vico I Maglietta 7, Castelmezzano, 85010, Italy"
    cuisine="Cuisine from Basilicata"
    priceRange="€€"
    phoneNumber="+390971986249"
    website="https://www.beccodellacivetta.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner - chef of this restaurant in a small village nestling in the Lucane Dolomites focuses on regional cuisine, serving dishes inspired by her two muses – her mother and grandmother. Dishes are often announced at your table and specialities include the delicious ficotto (fig wine). Stunning views of the grandiose mountain scenery from the guestrooms, which are quiet and welcoming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vico%20I%20Maglietta%207%2C%20Castelmezzano%2C%2085010%2C%20Italy"
    pageTitle="Al Becco della Civetta"
  />
);

export default AlBeccoDellaCivetta;
