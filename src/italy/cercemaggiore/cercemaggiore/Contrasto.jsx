...
const Contrasto = () => (
  <RestaurantPage
    restaurantName="Contrasto"
    address="via Roma 55, Cercemaggiore, 86012, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+390874799230"
    website="https://contrastoristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lucio Testa, chef-patron, has returned to his native village perched at an altitude of 937 metres, opening this restaurant in a former sheepfold on the outskirts of the village. The perfectly preserved stone façade, several small rooms spread over several levels, exposed beams and contemporary lamps give the ambience a modern touch. His is a creative cuisine, in which traditional Molise recipes are revisited, combining local and seasonal products (often from his own garden) with sauces, dressings and emulsions, learnt from working with French chefs; mulard duck is a favourite, several tasting menus guide the discovery of the territory, and finally, for those who prefer, a la carte choices. Among the wines, we suggest tasting a Tintillia del Molise Rutilia 2019 from Cantine Salvatore...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2055%2C%20Cercemaggiore%2C%2086012%2C%20Italy"
    pageTitle="Contrasto"
  />
);

export default Contrasto;
