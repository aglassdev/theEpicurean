...
const TritaPepe = () => (
  <RestaurantPage
    restaurantName="Trita Pepe"
    address="via Gabriele D'Annunzio 4, Manoppello Scalo, 65024, Italy"
    cuisine="Cuisine from Abruzzo"
    priceRange="€"
    phoneNumber="+390858561510"
    website="https://www.trattoriatritapepe.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the road that passes through Manoppello Scalo, this restaurant with a car park right in front of the building boasts a spacious, simple dining room and is our recommended choice in the region for anyone keen to try typical Abruzzo cuisine. Meat takes pride of place among the main courses (with an exception for salted cod), while menu highlights include excellent fried gnocchi with local salumi and cheese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gabriele%20D'Annunzio%204%2C%20Manoppello%20Scalo%2C%2065024%2C%20Italy"
    pageTitle="Trita Pepe"
  />
);

export default TritaPepe;
