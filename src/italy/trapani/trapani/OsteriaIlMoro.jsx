...
const OsteriaIlMoro = () => (
  <RestaurantPage
    restaurantName="Osteria il Moro"
    address="via Giuseppe Garibaldi 86, Trapani, 91100, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39092323194"
    website="https://www.osteriailmoro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting an attractive outdoor space on Trapani’s main street, Osteria il Moro focuses on dishes that are deeply rooted in Sicilian tradition yet enhanced by original and creative touches, resulting in cuisine that is full of flavour and personality thanks to owner-chef Nicola Bandi. The menu features plenty of fish dishes as well as meat, including beef fillet in a red sauce with spices and wild herbs, and Trapani-style mullet. The impressive wine list includes a good selection of regional labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Garibaldi%2086%2C%20Trapani%2C%2091100%2C%20Italy"
    pageTitle="Osteria il Moro"
  />
);

export default OsteriaIlMoro;
