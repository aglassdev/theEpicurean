...
const LosteriaDelCastellazzo = () => (
  <RestaurantPage
    restaurantName="L'Osteria del Castellazzo"
    address="via Borgo Castellazzo 40, Salsomaggiore Terme, 43039, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+390524578218"
    website="https://www.instagram.com/osteriadelcastellazzo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The determined and enthusiastic young owner of this restaurant graduated with a literature degree before giving in to her passion for food. She swapped her pen for a ladle and now creates delicious local specialities such as braised veal cheeks, alongside dishes from Pïacenza and Mantua, such as pisarei (a type of gnocchi) and sbrisolona cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Borgo%20Castellazzo%2040%2C%20Salsomaggiore%20Terme%2C%2043039%2C%20Italy"
    pageTitle="L'Osteria del Castellazzo"
  />
);

export default LosteriaDelCastellazzo;
