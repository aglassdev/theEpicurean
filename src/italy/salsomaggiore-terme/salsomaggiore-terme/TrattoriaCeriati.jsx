...
const TrattoriaCeriati = () => (
  <RestaurantPage
    restaurantName="Trattoria Ceriati"
    address="Località Cangelasio Ceriati 18, Salsomaggiore Terme, 43039, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390524573654"
    website="https://guide.michelin.com/en/emilia-romagna/salsomaggiore-terme/restaurant/trattoria-ceriati"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in attractive countryside where the plains give way to rolling hills (a perfect destination for a Sunday outing), this simple yet well-kept trattoria serves all the usual traditional local specialities. The typical fresh pasta and the desserts are all home-made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Cangelasio%20Ceriati%2018%2C%20Salsomaggiore%20Terme%2C%2043039%2C%20Italy"
    pageTitle="Trattoria Ceriati"
  />
);

export default TrattoriaCeriati;
