...
const OlonaDaVenanzioDal1922 = () => (
  <RestaurantPage
    restaurantName="Olona - Da Venanzio dal 1922"
    address="via Olona 38, Induno Olona, 21056, Italy"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+390332200333"
    website="https://www.davenanzio.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bastion of regional cuisine for over a century, this restaurant occupies an attractive group of buildings with a large outdoor summer area shaded by a pergola and a charming dining room with a retro feel. Traditional recipes with interesting and personalised twists take centre stage, including superb ravioli del plin with three roasts and a meat sauce – this is Lombardy, after all! Impressive wine list, including wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Olona%2038%2C%20Induno%20Olona%2C%2021056%2C%20Italy"
    pageTitle="Olona - Da Venanzio dal 1922"
  />
);

export default OlonaDaVenanzioDal1922;
