...
const TantrisNOV = () => (
  <RestaurantPage
    ...
    address="corso Risorgimento 384, Novara, 28100, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390321657343"
    website="https://www.tantrisristorante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A single elegant room for a menu that is an invitation to a gastronomic journey with Marta Grassi: at Tantris you’ll find local references, but the offering is essentially creative and freely interprets the products of the region and more besides. Excellent choice of wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Risorgimento%20384%2C%20Novara%2C%2028100%2C%20Italy"
    pageTitle="Tantris"
  />
);

export default TantrisNOV;
