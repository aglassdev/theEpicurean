...
const LaRima = () => (
  <RestaurantPage
    restaurantName="La RiMa"
    address="viale Dante Alighieri 11/c, Novara, 28100, Italy"
    cuisine="Contemporary, Italian Contemporary"
    priceRange="€€"
    phoneNumber="+3903211588260"
    website="https://www.ristorantelarima.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant in the heart of the town serves excellent contemporary cuisine (meat and fish, plus a few vegetarian options). The menu features dishes such as fregola sarda (a type of couscous) with tomato, buffalo mozzarella, friggitelli peppers and fried capers, with a personalised twist added by talented owner-chef Matteo Ridoni...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Dante%20Alighieri%2011%2Fc%2C%20Novara%2C%2028100%2C%20Italy"
    pageTitle="La RiMa"
  />
);

export default LaRima;
