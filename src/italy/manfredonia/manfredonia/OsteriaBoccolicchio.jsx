...
const OsteriaBoccolicchio = () => (
  <RestaurantPage
    restaurantName="Osteria Boccolicchio"
    address="via Arco Boccolicchio 15, Manfredonia, 71043, Italy"
    cuisine="Apulian, Seafood"
    priceRange="€€"
    phoneNumber="+390884090317"
    website="https://guide.michelin.com/en/puglia/manfredonia/restaurant/osteria-boccolicchio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having gained experience in various restaurants throughout Europe, Tespi has now returned home to open this delightful small osteria in the historic centre, just a stone’s throw from the sea. His huge passion for fish is evident from the menu, where fish dishes feature in numerous regionally influenced recipes. The excellent wine cellar includes a good choice of sparkling wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Arco%20Boccolicchio%2015%2C%20Manfredonia%2C%2071043%2C%20Italy"
    pageTitle="Osteria Boccolicchio"
  />
);

export default OsteriaBoccolicchio;
