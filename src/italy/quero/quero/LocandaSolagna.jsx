...
const LocandaSolagna = () => (
  <RestaurantPage
    restaurantName="Locanda Solagna"
    address="piazza I Novembre 2, Quero, 32038, Italy"
    cuisine="Italian Contemporary, Country cooking"
    priceRange="€€"
    phoneNumber="+390439788019"
    website="https://www.locandasolagna.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although this restaurant has been in business since the 1950s, it feels much more modern thanks to its updated appearance. Renowned for its excellent regional cuisine served in the evening, the restaurant pays careful attention to seasonal ingredients. At lunchtime, the ”osteria”-style menu is much simpler. Excellent wine selection...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20I%20Novembre%202%2C%20Quero%2C%2032038%2C%20Italy"
    pageTitle="Locanda Solagna"
  />
);

export default LocandaSolagna;
