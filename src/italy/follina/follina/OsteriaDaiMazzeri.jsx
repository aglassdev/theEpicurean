...
const OsteriaDaiMazzeri = () => (
  <RestaurantPage
    restaurantName="Osteria dai Mazzeri"
    address="via Pallade 18, Follina, 31051, Italy"
    cuisine="Venetian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390438971255"
    website="https://www.osteriadaimazzeri.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Once the town hall of Follina, this building dating from 1704 is now home to a restaurant run by two brothers who serve delicious regional and seasonal cuisine here (in winter, don’t miss the spit-roasted chicken, veal or pork cooked according to local tradition). A beautiful mulberry tree, the old symbol of the village that was once involved in the silk industry, graces the outdoor dining space...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pallade%2018%2C%20Follina%2C%2031051%2C%20Italy"
    pageTitle="Osteria dai Mazzeri"
  />
);

export default OsteriaDaiMazzeri;
