...
const Innesti = () => (
  <RestaurantPage
    restaurantName="Innesti"
    address="via San Pietro 8, Pergine Valsugana, 38057, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+3904611583289"
    website="https://www.innestirestaurant.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Daniele and Elisa are a couple of young restaurateurs who are familiar to us from their time at Blumenstube in Sant'Orsola. Having moved on, they have now opened their own restaurant in Pergine, where both the decor and the cuisine are contemporary-Alpine in style. As in currently in vogue, their dishes are showcased on three tasting menus (short, medium and long) from which dishes can also be chosen à la carte style. All the recipes have a creative feel, demonstrating the chef’s playful approach to his contemporary ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Pietro%208%2C%20Pergine%20Valsugana%2C%2038057%2C%20Italy"
    pageTitle="Innesti"
  />
);

export default Innesti;
