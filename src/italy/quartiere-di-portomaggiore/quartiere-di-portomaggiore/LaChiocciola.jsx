...
const LaChiocciola = () => (
  <RestaurantPage
    restaurantName="La Chiocciola"
    address="via Runco 94/f, Quartiere di Portomaggiore, 44015, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+390532329151"
    website="https://www.locandalachiocciola.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant and an inn in a small country village, it’s the right place if you’re looking for hospitality and you appreciate the regional cuisine, made of snails and frogs, but also fish from the nearby sea. Something for every palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Runco%2094%2Ff%2C%20Quartiere%20di%20Portomaggiore%2C%2044015%2C%20Italy"
    pageTitle="La Chiocciola"
  />
);

export default LaChiocciola;
