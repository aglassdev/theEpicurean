...
const OsteriaOrigano = () => (
  <RestaurantPage
    restaurantName="Osteria Origano"
    address="via Giuseppina Scarciglia 18, Minervino di Lecce, 73020, Italy"
    cuisine="Contemporary, Apulian"
    priceRange="€€€"
    phoneNumber="+3908361905996"
    website="https://guide.michelin.com/en/puglia/minervino-di-lecce_1852995/restaurant/osteria-origano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small wine boutique at the entrance to this osteria in the village centre, displays the restaurant’s own wines, which are the perfect complement to your meal, as well as being available to purchase and take home with you. To the rear, an attractive closed veranda and an outdoor space are the perfect settings for hearty, traditional cuisine which ranges from spit-roasted meats to local salumi and home-made pastas. A few fish options are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppina%20Scarciglia%2018%2C%20Minervino%20di%20Lecce%2C%2073020%2C%20Italy"
    pageTitle="Osteria Origano"
  />
);

export default OsteriaOrigano;
