...
const AiTorchi = () => (
  <RestaurantPage
    restaurantName="Ai Torchi"
    address="via dell'Annunziata 12, Finalborgo, 17024, Italy"
    cuisine="Seafood, Ligurian"
    priceRange="€€€"
    phoneNumber="+39019690531"
    website="https://aitorchi.it/ai-torchi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a 17C olive oil press in the heart of a charming medieval village, this restaurant has retained its old stone mill and wooden press in its vaulted dining room, which provides the backdrop for imaginative fish and seafood dishes prepared using top-quality local ingredients. The delicious Italian-style ceviche is made from the catch of the day, while the Mare Mare mixed fish dish is baked in a casserole with cherry tomatoes, courgettes and bay leaves. If you’re looking for a simpler option, try the I Torchiettibistro on the corner of the same street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dell'Annunziata%2012%2C%20Finalborgo%2C%2017024%2C%20Italy"
    pageTitle="Ai Torchi"
  />
);

export default AiTorchi;
