...
const FelterAlleRose = () => (
  <RestaurantPage
    restaurantName="Felter alle Rose"
    address="via Gasparo Da Salò 33, Salò, 25087, Italy"
    cuisine="Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+39036543220"
    website="https://rosesalo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This historic trattoria has been brought back to life by a local family with years of experience in the hospitality industry and a real commitment to quality. Convenient private parking, an indoor dining room, a closed veranda and a few tables set out in the wine cellar for tastings and aperitifs are just some of the attractions here. The short menu features simple yet carefully made dishes prepared from seasonal ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gasparo%20Da%20Sal%C3%B2%2033%2C%20Sal%C3%B2%2C%2025087%2C%20Italy"
    pageTitle="Felter alle Rose"
  />
);

export default FelterAlleRose;
