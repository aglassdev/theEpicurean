...
const VillaArcadio = () => (
  <RestaurantPage
    restaurantName="Villa Arcadio"
    address="via Palazzina 2, località Villa di Salò, Salò, 25087, Italy"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€€"
    phoneNumber="+39036542281"
    website="https://www.hotelvillaarcadio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The new chef at this restaurant prioritises beautiful presentation in his modern interpretations of Italian dishes, which are even more enjoyable in summer when meals are served outdoors, surrounded by greenery and with fine views of the southern part of Lake Garda and its shoreline...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Palazzina%202%2C%20localit%C3%A0%20Villa%20di%20Sal%C3%B2%2C%20Sal%C3%B2%2C%2025087%2C%20Italy"
    pageTitle="Villa Arcadio"
  />
);

export default VillaArcadio;
