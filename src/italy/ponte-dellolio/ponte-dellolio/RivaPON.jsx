...
const RivaPON = () => (
  <RestaurantPage
    restaurantName="Riva"
    address="via Riva 16, Ponte dell'Olio, 29028, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390523875193"
    website="https://www.ristoranteriva.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a small village with a fascinating crenellated castle, this restaurant is run by a husband and wife team. They offer a refined cuisine that is a balanced blend of local recipes and creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Riva%2016%2C%20Ponte%20dell'Olio%2C%2029028%2C%20Italy"
    pageTitle="Riva"
  />
);

export default RivaPON;
