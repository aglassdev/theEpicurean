...
const AnticaOsteriaLaRampina = () => (
  <RestaurantPage
    restaurantName="Antica Osteria La Rampina"
    address="via Emilia fraz. Rampina 3, ang. via Rocca Brivio, San Giuliano Milanese, 20098, Italy"
    cuisine="Lombardian, Contemporary"
    priceRange="€€€"
    phoneNumber="+39029833273"
    website="https://rampina.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is said that General Radetzky, fleeing from the city during the Five Days of Milan rebellion, camped his troops right in front of La Rampina’s courtyard. Surrounded by nature and full of fascinating history, the restaurant now makes an ideal spot in which to enjoy the various culinary options served by Lino and his young son Luca, which offer a careful balance of local traditional flavour and skilful innovation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Emilia%20fraz.%20Rampina%203%2C%20ang.%20via%20Rocca%20Brivio%2C%20San%20Giuliano%20Milanese%2C%2020098%2C%20Italy"
    pageTitle="Antica Osteria La Rampina"
  />
);

export default AnticaOsteriaLaRampina;
