...
const TavernaDaCiacco = () => (
  <RestaurantPage
    restaurantName="Taverna da Ciacco"
    address="via Dante Alighieri 30/a, San Quirico d'Orcia, 53027, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390577897312"
    website="https://guide.michelin.com/en/toscana/san-quirico-d-orcia/restaurant/taverna-da-ciacco"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the pedestrian historic center, this venue offers a warm welcome in a rustic dining room or at a few tables overlooking the paseo. Family-run, it serves authentic Tuscan flavors prepared traditionally. The handmade pici with cherry tomatoes, olives, and slightly spicy anchovies are an unmissable summer delight!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Dante%20Alighieri%2030%2Fa%2C%20San%20Quirico%20d'Orcia%2C%2053027%2C%20Italy"
    pageTitle="Taverna da Ciacco"
  />
);

export default TavernaDaCiacco;
