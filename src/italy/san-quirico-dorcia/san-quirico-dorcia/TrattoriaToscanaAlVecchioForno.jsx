...
const TrattoriaToscanaAlVecchioForno = () => (
  <RestaurantPage
    restaurantName="Trattoria Toscana al Vecchio Forno"
    address="via Poliziano 18, San Quirico d'Orcia, 53027, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390577897380"
    website="https://www.palazzodelcapitano.com/tuscany/trattoria-toscana/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are looking for a place to eat that is centrally located and has good prices, you have found it. Captivating trattoria atmosphere. Pretty summer garden...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Poliziano%2018%2C%20San%20Quirico%20d'Orcia%2C%2053027%2C%20Italy"
    pageTitle="Trattoria Toscana al Vecchio Forno"
  />
);

export default TrattoriaToscanaAlVecchioForno;
