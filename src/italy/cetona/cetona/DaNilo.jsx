...
const DaNilo = () => (
  <RestaurantPage
    restaurantName="Da Nilo"
    address="piazza Garibaldi 31, Cetona, 53040, Italy"
    cuisine="Tuscan"
    priceRange="€€"
    phoneNumber="+390578239040"
    website="https://www.iltigliodipiazza.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Cetona's square, a well-tended outdoor area among hedges welcomes guests with warmth and smiles. The cuisine is authentically Tuscan and well-crafted. Don’t miss the selection of local cured meats and the classic pici all’aglione, a true must-try!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Garibaldi%2031%2C%20Cetona%2C%2053040%2C%20Italy"
    pageTitle="Da Nilo"
  />
);
