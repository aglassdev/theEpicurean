...
const Bruxaboschi = () => (
  <RestaurantPage
    restaurantName="Bruxaboschi"
    address="via Francesco Mignone 8, San Desiderio, 16133, Italy"
    cuisine="Ligurian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390103450302"
    website="https://www.bruxaboschi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Anticipate a little time and patience tackling a winding progressively less urban road to reach, inland, San Desiderio, where Bruxaboschi has been delighting clients since 1862 under the same familial management. It will be worth it. Rightly renowned, the cuisine pays homage to local traditions (nearly exclusively meat), commencing with an excellent Genoese cima, picagge and pansotti among pastas, and fried rabbit. In season, obligingly, is the unmissable fungi engagement...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Francesco%20Mignone%208%2C%20San%20Desiderio%2C%2016133%2C%20Italy"
    pageTitle="Bruxaboschi"
  />
);

export default Bruxaboschi;
