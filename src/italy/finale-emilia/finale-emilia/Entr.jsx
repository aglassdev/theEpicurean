...
const Entr = () => (
  <RestaurantPage
    restaurantName="Entrà"
    address="via Salde Entrà 60, località Entrà, Finale Emilia, 41034, Italy"
    cuisine="Country cooking"
    priceRange="€"
    phoneNumber="+39053597105"
    website="https://trattoriaentra.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Make sure you use your sat-nav to get to this restaurant as finding the right road through the countryside can be a challenge, although once you’re here you’ll be glad you made the effort. The trattoria occupies a wine shop dating from 1919, from which it has retained a few attractive and nostalgic touches despite its renovation. The cuisine focuses on a few regional dishes which are announced at your table by the owner himself...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Salde%20Entr%C3%A0%2060%2C%20localit%C3%A0%20Entr%C3%A0%2C%20Finale%20Emilia%2C%2041034%2C%20Italy"
    pageTitle="Entrà"
  />
);
