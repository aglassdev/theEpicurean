...
const LeCicale = () => (
  <RestaurantPage
    restaurantName="Le Cicale"
    address="via Pineroli 32, Spinetta Marengo, 15122, Italy"
    cuisine="Seasonal Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+390131216130"
    website="https://www.lecicale.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A grandparents’ home has evolved into a charming bistro-like restaurant, while outdoors, the owner-curated garden beckons a peek. The cuisine is simple and classic, comforting, with certain regional dishes alongside fish courses, while an entire menu page is dedicated to risottos...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pineroli%2032%2C%20Spinetta%20Marengo%2C%2015122%2C%20Italy"
    pageTitle="Le Cicale"
  />
);

export default LeCicale;
