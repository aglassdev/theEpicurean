...
const LaFermata = () => (
  <RestaurantPage
    restaurantName="La Fermata"
    address="strada Bolla 2, Spinetta Marengo, 15122, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€€"
    phoneNumber="+390131617508"
    website="https://www.ristorantelafermata.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the countryside around Alessandria, this 18C farmhouse has a modern, minimalist decor which serves as a backdrop for traditional Piedmontese cuisine with a clever modern twist. The chef offers just the right amount of creativity, with a focus on meat dishes and satisfying, memorable flavours that appeal to the emotions as well as the palate. Adding to the appeal, the elegant and exclusive ambience is the result of careful refurbishment, which has transformed the dining room into a triumph of art and design...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Bolla%202%2C%20Spinetta%20Marengo%2C%2015122%2C%20Italy"
    pageTitle="La Fermata"
  />
);

export default LaFermata;
