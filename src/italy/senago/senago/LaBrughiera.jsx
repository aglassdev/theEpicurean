...
const LaBrughiera = () => (
  <RestaurantPage
    restaurantName="La Brughiera"
    address="via XXIV Maggio 23, Senago, 20030, Italy"
    cuisine="Lombardian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39029982113"
    website="https://www.labrughiera.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old farmhouse in the Groane Regional Park has never lost its warm family atmosphere. The interior is spacious and attractive and the menus are based on traditional and national specialities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXIV%20Maggio%2023%2C%20Senago%2C%2020030%2C%20Italy"
    pageTitle="La Brughiera"
  />
);

export default LaBrughiera;
