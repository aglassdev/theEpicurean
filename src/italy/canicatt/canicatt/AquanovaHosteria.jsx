...
const AquanovaHosteria = () => (
  <RestaurantPage
    restaurantName="Aquanova Hosteria"
    address="Via Monsignor Ficarra 59, Canicattì, 92024, Italy"
    cuisine="Sicilian, Creative"
    priceRange="€€€"
    phoneNumber="+390922629468"
    website="https://aquanovahosteria.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in an old “water house” with origins dating back to the 17C and a large water wheel still visible in the dining room, this restaurant is home to a chef with Albanian origins (who grew up in Italy) who creates fresh, imaginative and seasonal cuisine in colourful dishes that are full of flavour. Sicilian traditions (inland as well as coastal) with a highly personalised twist take centre stage on the à la carte and tasting menus. There’s also a firm focus on vegetables thanks to the restaurant’s own on-site kitchen garden, which is well worth a visit. Also not to be missed is a visit to the delightful wine cellar – a real treasure trove which is home to more than 1 700 labels from across the globe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Monsignor%20Ficarra%2059%2C%20Canicatt%C3%AC%2C%2092024%2C%20Italy"
    pageTitle="Aquanova Hosteria"
  />
);

export default AquanovaHosteria;
