...
const Zam = () => (
  <RestaurantPage
    restaurantName="Zamù"
    address="Viale della Vittoria 208, Canicattì, 92024, Italy"
    cuisine="Sicilian, Contemporary"
    priceRange="€€"
    phoneNumber="+390922856944"
    website="http://www.zamuristorante.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Viale%20della%20Vittoria%20208%2C%20Canicatt%C3%AC%2C%2092024%2C%20Italy"
    pageTitle="Zamù"
  />
);
