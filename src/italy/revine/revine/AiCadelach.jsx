...
const AiCadelach = () => (
  <RestaurantPage
    restaurantName="Ai Cadelach"
    address="via Grava 2, Revine, 31020, Italy"
    cuisine="Venetian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390438523010"
    website="https://cadelach.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy local cuisine in a rustic - style dining room or alongside the swimming pool in summer. The menu focuses on meat dishes (especially grilled meat), such as traditional Fiorentina steak and Alpago lamb. Wine lovers will appreciate the excellent wine cellar kept by Ezio, one of the restaurant owners...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Grava%202%2C%20Revine%2C%2031020%2C%20Italy"
    pageTitle="Ai Cadelach"
  />
);

export default AiCadelach;
