...
const CaDelMoro = () => (
  <RestaurantPage
    restaurantName="Ca' Del Moro"
    address="località Erbin 31, Grezzana, 37023, Italy"
    cuisine="Italian Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+390459814900"
    website="https://www.cadelmoro.wine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the La Collina dei Ciliegi wine estate amid the verdant Valpantena hills, this first-floor restaurant (lift available) is home to two chefs – he is from Calabria, while she is from Puglia. Together they create exciting, modern Mediterranean cuisine using ingredients from their native regions, including their signature dish – homemade spaghetti served with a delicious, well-balanced 'nduja, smoked ricotta and tomato ristretto sauce. Top-quality local ingredients take pride of place, as demonstrated by the Brogna mutton, which is raised on site, barbecued and served with an exquisite caper sauce and seasonal mushroom pie. The concise wine list features labels from the Veneto alongside a few French options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Erbin%2031%2C%20Grezzana%2C%2037023%2C%20Italy"
    pageTitle="Ca' Del Moro"
  />
);

export default CaDelMoro;
