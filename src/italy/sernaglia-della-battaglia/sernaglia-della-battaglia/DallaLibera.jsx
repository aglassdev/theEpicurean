...
const DallaLibera = () => (
  <RestaurantPage
    restaurantName="Dalla Libera"
    address="via Farra 52, Sernaglia della Battaglia, 31020, Italy"
    cuisine="Contemporary, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390438966295"
    website="https://www.trattoriadallalibera.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At this restaurant, an American-style barbecue garden (in summer) and a smart, rustic dining room provide the backdrop for carefully prepared local cuisine with a personalised, gourmet twist, such as the home-made gnocchi served with three different types of tomato. The wine list features top-quality labels from Italy and further afield, including a few vintages that will delight wine-enthusiasts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Farra%2052%2C%20Sernaglia%20della%20Battaglia%2C%2031020%2C%20Italy"
    pageTitle="Dalla Libera"
  />
);

export default DallaLibera;
