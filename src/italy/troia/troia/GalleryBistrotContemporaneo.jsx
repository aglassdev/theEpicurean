...
const GalleryBistrotContemporaneo = () => (
  <RestaurantPage
    restaurantName="Gallery Bistrot Contemporaneo"
    address="via Regina Margherita 3/b, Troia, 71029, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+393423599215"
    website="https://guide.michelin.com/en/puglia/troia_1853841/restaurant/gallery-bistrot-contemporaneo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Modern, tasty and carefully curated cuisine, which is prepared using the best seasonal ingredients. There is also a creative touch to some of the dishes, such as the vitello tonnato in which the meat (Fassona veal from the Piedmont) takes on the appearance of raspberries, or the delicate duck breast served with veal jus. The restaurant offers just 20 seats in a long dining room where the walls and ceiling form a sort of light wood-panelled arch that creates a real sense of movement...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Regina%20Margherita%203%2Fb%2C%20Troia%2C%2071029%2C%20Italy"
    pageTitle="Gallery Bistrot Contemporaneo"
  />
);

export default GalleryBistrotContemporaneo;
