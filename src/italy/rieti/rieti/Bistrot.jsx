...
const Bistrot = () => (
  <RestaurantPage
    ...
    address="piazza San Rufo 25, Rieti, 02100, Italy"
    cuisine="Italian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390746498798"
    website="https://guide.michelin.com/en/lazio/rieti/restaurant/bistrot147741"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking a delightful, quiet little square, this romantic, welcoming restaurant serves traditional local specialities, often with an individual flavour. The menu includes some fish dishes, although the house speciality is the maltagliati pasta served with ‘Bistrot’ sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Rufo%2025%2C%20Rieti%2C%2002100%2C%20Italy"
    pageTitle="Bistrot"
  />
);
