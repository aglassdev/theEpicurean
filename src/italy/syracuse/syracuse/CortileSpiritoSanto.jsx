...
const CortileSpiritoSanto = () => (
  <RestaurantPage
    restaurantName="Cortile Spirito Santo"
    address="via Salomone 21, Ortigia, Syracuse, 96100, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3909311815404"
    website="https://www.cortilespiritosanto.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated near Castel Maniace at the southernmost point of Ortigia, this restaurant is part of the Palazzo Salomone Luxury Suites and is one of the most elegant places to eat in Siracusa, where it serves some of the best Sicilian cuisine on the island. Here, Giuseppe Torrisi prepares creative and technically expert dishes which are typical of Sicily’s Baroque soul and offer a real feast for the senses thanks to their exciting, intense and often unforgettable flavours. We particularly enjoyed the monkfish meunière with fennel and asparagus and the “Made in Sicily” almond tartlet designed in the shape of the island. The extensive wine list offers plenty of choice – you might like to try one of the local labels from Etna or the west coast of Sicily, or perhaps ask expert, knowledgeable sommeli..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Salomone%2021%2C%20Ortigia%2C%20Syracuse%2C%2096100%2C%20Italy"
    pageTitle="Cortile Spirito Santo"
  />
);

export default CortileSpiritoSanto;
