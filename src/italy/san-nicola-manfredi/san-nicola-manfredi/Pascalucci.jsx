...
const Pascalucci = () => (
  <RestaurantPage
    restaurantName="Pascalucci"
    address="via Appia 1, San Nicola Manfredi, 82010, Italy"
    cuisine="Campanian, Seafood"
    priceRange="€"
    phoneNumber="+390824778400"
    website="https://www.pascalucci.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A traditional restaurant serving regional cuisine, as well as skilfully prepared fish dishes made from fresh produce. Specialities include Beneventano beef fillet and octopus in aspic jelly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Appia%201%2C%20San%20Nicola%20Manfredi%2C%2082010%2C%20Italy"
    pageTitle="Pascalucci"
  />
);

export default Pascalucci;
