...
const ISavi = () => (
  <RestaurantPage
    restaurantName="I Savi"
    address="via Spangaro 6, località Peseggia di Scorzè, Scorzè, 30037, Italy"
    cuisine="Seafood, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39041448822"
    website="https://www.isavi.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a small rural hamlet, this restaurant is one of the best in the Venetian hinterland for top-quality fish. Served in welcoming dining rooms, the fish and seafood dishes here are traditional and unfussy in style, and full of natural flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Spangaro%206%2C%20localit%C3%A0%20Peseggia%20di%20Scorz%C3%A8%2C%20Scorz%C3%A8%2C%2030037%2C%20Italy"
    pageTitle="I Savi"
  />
);

export default ISavi;
