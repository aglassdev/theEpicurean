...
const DegliAngeli = () => (
  <RestaurantPage
    restaurantName="Degli Angeli"
    address="località Madonna degli Angeli, Magliano Sabina, 02046, Italy"
    cuisine="Cuisine from Lazio, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39074491377"
    website="https://www.ristorantedegliangeli.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The family that runs this excellent restaurant with views of the surrounding countryside has been doing so with passion and experience for over a century. The menu here focuses on the culinary traditions of Lazio, while the wine and extra-virgin olive oil are also sourced locally. The restaurant is part of a hotel and includes a shop (La Bottega delle Delizie) selling home-made produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Madonna%20degli%20Angeli%2C%20Magliano%20Sabina%2C%2002046%2C%20Italy"
    pageTitle="Degli Angeli"
  />
);

export default DegliAngeli;
