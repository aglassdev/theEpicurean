...
const Aquadulcis = () => (
  <RestaurantPage
    restaurantName="Aquadulcis"
    address="contrada Tenda, Vallo della Lucania, 84078, Italy"
    cuisine="Country cooking, Contemporary"
    priceRange="€€"
    phoneNumber="+393452973811"
    website="https://www.aquadulcis.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following careful restoration, this old mill has been transformed into a gourmet restaurant with just a few tables. Here, skilful young chef Vincenzo Cucolo delights guests with his cuisine – a combination of creative dishes and old recipes focusing on traditional Cilento ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Tenda%2C%20Vallo%20della%20Lucania%2C%2084078%2C%20Italy"
    pageTitle="Aquadulcis"
  />
);

export default Aquadulcis;
