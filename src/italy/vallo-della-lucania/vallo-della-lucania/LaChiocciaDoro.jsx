...
const LaChiocciaDoro = () => (
  <RestaurantPage
    restaurantName="La Chioccia d'Oro"
    address="via Novi 2, loc. Pietra dei Correnti, bivio Novi Velia, Vallo della Lucania, 84078, Italy"
    cuisine="Country cooking, Campanian"
    priceRange="€"
    phoneNumber="+39097470004"
    website="https://www.chiocciadoro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 40 years, La Chioccia d'Oro has been renowned for its delicious, bountiful cuisine inspired by the Cilento region, including excellent pasta dishes (fresh and dried pasta served with tasty sauces) and equally delicious meat-based main courses. The ambience is decidedly unpretentious and the prices are some of the most reasonable you’ll find in Italy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Novi%202%2C%20loc.%20Pietra%20dei%20Correnti%2C%20bivio%20Novi%20Velia%2C%20Vallo%20della%20Lucania%2C%2084078%2C%20Italy"
    pageTitle="La Chioccia d'Oro"
  />
);

export default LaChiocciaDoro;
