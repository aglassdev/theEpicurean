...
const WalterRedaelli = () => (
  <RestaurantPage
    restaurantName="Walter Redaelli"
    address="via XXI Aprile 26, Bettolle, 53040, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390577623447"
    website="https://www.ristoranteredaelli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this old 18C farmhouse with exposed brickwork, roof beams and an impressive fireplace, enjoy delicious Tuscan cuisine prepared from local ingredients, with a particular focus on meat. Specialities on the menu include pappa al pomodoro, home-made pici pasta, and sliced veal. Comfortable chairs add to the cosy and enjoyable dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXI%20Aprile%2026%2C%20Bettolle%2C%2053040%2C%20Italy"
    pageTitle="Walter Redaelli"
  />
);

export default WalterRedaelli;
