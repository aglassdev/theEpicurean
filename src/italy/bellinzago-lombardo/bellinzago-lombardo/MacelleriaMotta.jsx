...
const MacelleriaMotta = () => (
  <RestaurantPage
    restaurantName="Macelleria Motta"
    address="strada Padana Superiore 90, Bellinzago Lombardo, 20060, Italy"
    cuisine="Meats and Grills, Italian"
    priceRange="€€"
    phoneNumber="+390295784123"
    website="https://www.ristorantemacelleriamotta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Motta has established a reputation for quality, especially for its meat which is carefully sourced from farms in the Piedmont region. Some of the excellent options on the menu are aged in a large fridge near the entrance, along with different types of delicious salumi which are produced and cured by the restaurant. Various types of meat feature here – these are cured or cooked using classic methods with the occasional modern touch. Piedmontese beef is one of the highlights, with different cuts grilled on the barbecue or served boiled. Make sure you try the 300g hamburger with Aosta valley Toma cheese, BBQ sauce and caramelised onions served in a sesame-seed bun. Enjoy alfresco dining in a typical Lombardy courtyard in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Padana%20Superiore%2090%2C%20Bellinzago%20Lombardo%2C%2020060%2C%20Italy"
    pageTitle="Macelleria Motta"
  />
);

export default MacelleriaMotta;
