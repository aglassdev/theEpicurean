...
const IoELuna = () => (
  <RestaurantPage
    restaurantName="Io e Luna"
    address="località Montebello 1, Guarene, 12050, Italy"
    cuisine="Regional Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390173611724"
    website="https://www.ioeluna.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This classic-style restaurant serving updated regional cuisine offers views of the surrounding hills from its attractive outdoor terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Montebello%201%2C%20Guarene%2C%2012050%2C%20Italy"
    pageTitle="Io e Luna"
  />
);

export default IoELuna;
