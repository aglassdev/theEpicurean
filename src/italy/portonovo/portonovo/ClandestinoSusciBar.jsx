...
const ClandestinoSusciBar = () => (
  <RestaurantPage
    restaurantName="Clandestino Susci Bar"
    address="Baia di Portonovo, Portonovo, 60020, Italy"
    cuisine="Creative, Seafood"
    priceRange="€€€"
    phoneNumber="+39071801422"
    website="https://www.morenocedroni.it/clandestino/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Built on stilts, the Clandestino is a unique restaurant with a simple yet trendy ambience, which overlooks a beautiful unspoilt beach with views of the sea from all the windows and a distinctly romantic feel at night. Here, Moreno Cedroni focuses on gourmet cuisine at lunchtime as well as in the evening. In addition to two tasting menus (Eros & Susci and Susci Memories), for lunch there’s a small à la carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baia%20di%20Portonovo%2C%20Portonovo%2C%2060020%2C%20Italy"
    pageTitle="Clandestino Susci Bar"
  />
);

export default ClandestinoSusciBar;
