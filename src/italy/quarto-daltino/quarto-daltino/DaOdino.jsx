...
const DaOdino = () => (
  <RestaurantPage
    restaurantName="Da Odino"
    address="via Roma 87, Quarto d'Altino, 30020, Italy"
    cuisine="Seafood, Venetian"
    priceRange="€€"
    phoneNumber="+390422825421"
    website="https://guide.michelin.com/en/veneto/quarto-d-altino/restaurant/da-odino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant has stood on this square for many years, having been built as a “casone” and previously used as a dance hall. Despite its large size, the atmosphere is pleasant and convivial, helped by the staff here who are friendly yet professional. Situated just a stone’s throw from the Park Hotel Junior, a modern hotel under the same ownership, the restaurant specialises in fish and seafood, although you’ll also find meat and vegetarian options on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2087%2C%20Quarto%20d'Altino%2C%2030020%2C%20Italy"
    pageTitle="Da Odino"
  />
);

export default DaOdino;
