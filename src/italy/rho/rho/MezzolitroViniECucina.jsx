...
const MezzolitroViniECucina = () => (
  <RestaurantPage
    restaurantName="Mezzolitro Vini e Cucina"
    address="via Pomè 10, Rho, 20017, Italy"
    cuisine="Cuisine from Abruzzo"
    priceRange="€€"
    phoneNumber="+390291327868"
    website="https://www.mezzolitro.net"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated amid the attractive alleyways in the centre of Rho, this simple yet pleasant and friendly restaurant serves delicious local cuisine. Abruzzo specialities are to the fore, including dishes such as spaghetti alla chitarra with meatballs in sauce, various mutton recipes (grilled on skewers, tartare, steaks etc), lamb and different types of ham...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pom%C3%A8%2010%2C%20Rho%2C%2020017%2C%20Italy"
    pageTitle="Mezzolitro Vini e Cucina"
  />
);

export default MezzolitroViniECucina;
