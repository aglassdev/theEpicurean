...
const LargineAVenc = () => (
  <RestaurantPage
    restaurantName="L'Argine a Vencò"
    address="Località Vencò 15, Dolegna del Collio, 34070, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€€"
    phoneNumber="+393505212804"
    website="https://www.largineavenco.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This perfectly restored old mill is home to a chef who creates original cuisine that demonstrates her connection with her region and showcases ingredients grown in the restaurant’s own kitchen garden, especially the aromatic herbs that are a characteristic feature of many of the dishes served here. Antonia Klugmann’s house stands in attractive unspoilt scenery near the Slovenian border and in the middle of two major wine-producing areas, namely the Colli Orientali del Friuli and the better-known Collio, both of which are well represented on the extensive wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Venc%C3%B2%2015%2C%20Dolegna%20del%20Collio%2C%2034070%2C%20Italy"
    pageTitle="L'Argine a Vencò"
  />
);

export default LargineAVenc;
