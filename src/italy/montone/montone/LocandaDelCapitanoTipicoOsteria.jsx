...
const LocandaDelCapitanoTipicoOsteria = () => (
  <RestaurantPage
    restaurantName="Locanda del Capitano & Tipico Osteria"
    address="via Roma 7, Montone, 06014, Italy"
    cuisine="Umbrian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390759306521"
    website="https://www.ilcapitano.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Locanda del Capitano and the Tipico offer menus showcasing traditional Umbrian dishes (the former serves gourmet cuisine, while the latter offers a simpler menu). The wine list boasts over 400 labels, while the olive oil selection includes the best oils from the region. Our inspector particularly enjoyed the “maritozzo di mazzafegato” (a type of sausage bun) with escarole, caramelised onions and olives...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%207%2C%20Montone%2C%2006014%2C%20Italy"
    pageTitle="Locanda del Capitano & Tipico Osteria"
  />
);

export default LocandaDelCapitanoTipicoOsteria;
