...
const EnsamaPesce = () => (
  <RestaurantPage
    restaurantName="Ensama Pesce"
    address="via Aristide Dondarini 4, Sala Bolognese, 40010, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+39051828634"
    website="https://www.ristorantensama.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A menu which focuses only on fish (from the daily market) which is prepared with a hint of Puglia, the chef’s native region. As soon as guests are seated at their table, they are brought a selection of homemade breads, including taralli bread rings and focaccia. Owner-chef Sabino is the heart and soul of this restaurant, where guests can be sure of a memorable culinary experience!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Aristide%20Dondarini%204%2C%20Sala%20Bolognese%2C%2040010%2C%20Italy"
    pageTitle="Ensama Pesce"
  />
);

export default EnsamaPesce;
