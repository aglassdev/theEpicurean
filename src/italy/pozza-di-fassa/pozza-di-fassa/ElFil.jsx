...
const ElFil = () => (
  <RestaurantPage
    restaurantName="El Filò"
    address="strada Dolomites 103, Pozza di Fassa, 38036, Italy"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390462763210"
    website="https://www.el-filo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following recent refurbishment, El Filò is now even more comfortable than ever, boasting an Alpine-influenced decor that is striking for its contemporary style. The Dolomites and Ladin culinary traditions are still very much to the fore in the cuisine, which is prepared by the excellent owner-chef, although modern touches and influences from outside the region also feature. The wine list offers a fine selection of options from the region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Dolomites%20103%2C%20Pozza%20di%20Fassa%2C%2038036%2C%20Italy"
    pageTitle="El Filò"
  />
);

export default ElFil;
