...
const AnticaTrattoriaCentro = () => (
  <RestaurantPage
    restaurantName="Antica Trattoria Centro"
    address="corso Italia 25, Levanto, 19015, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390187808157"
    website="https://guide.michelin.com/en/liguria/levanto/restaurant/antica-trattoria-centro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of Levanto just a stone’s throw from the sea, this trattoria serving traditional fish and seafood (as well as a few meat options) has been run by the same owners for almost 20 years. Friendly ambience, good service, plus a few tables in a small outdoor space which need to be booked well in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Italia%2025%2C%20Levanto%2C%2019015%2C%20Italy"
    pageTitle="Antica Trattoria Centro"
  />
);

export default AnticaTrattoriaCentro;
