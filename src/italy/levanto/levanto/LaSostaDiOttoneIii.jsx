...
const LaSostaDiOttoneIii = () => (
  <RestaurantPage
    restaurantName="La Sosta di Ottone III"
    address="Località Chiesanuova 39, Levanto, 19015, Italy"
    cuisine="Ligurian"
    priceRange="€€€"
    phoneNumber="+393518860251"
    website="https://www.lasosta.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ask for directions to this restaurant when you make your booking, as you’ll need to leave your vehicle in a private car park at the entrance to the village and then make your way uphill on foot. Situated in one of Liguria’s most typical and picturesque inland villages with views of the sea in the distance, the restaurant offers outdoor dining under a wisteria in fine weather. The menu features a small choice of regional dishes, with the same focus on Liguria evident on the wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Chiesanuova%2039%2C%20Levanto%2C%2019015%2C%20Italy"
    pageTitle="La Sosta di Ottone III"
  />
);

export default LaSostaDiOttoneIii;
