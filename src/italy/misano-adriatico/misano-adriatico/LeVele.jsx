...
const LeVele = () => (
  <RestaurantPage
    restaurantName="Le Vele"
    address="via Litoranea Sud 71, Bagni 70, Misano Adriatico, 47843, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+393492418018"
    website="https://www.ristorantelevele.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern, minimalist - style restaurant is practically on the beach and almost within touching distance of the sea. It specialises in fish dishes with a contemporary flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Litoranea%20Sud%2071%2C%20Bagni%2070%2C%20Misano%20Adriatico%2C%2047843%2C%20Italy"
    pageTitle="Le Vele"
  />
);
