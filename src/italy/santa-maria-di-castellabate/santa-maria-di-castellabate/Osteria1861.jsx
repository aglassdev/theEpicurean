...
const Osteria1861 = () => (
  <RestaurantPage
    restaurantName="Osteria 1861"
    address="via Valentino Izzo 1, Santa Maria di Castellabate, 84048, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+390974961454"
    website="https://www.osteria1861.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Accessed via a narrow alleyway behind the beach, this restaurant housed in an old warehouse once used for smoking cured meats and drying Cilento figs boasts stone-vaulted ceilings, a romantic ambience and a small terrace embellished by beautiful plants. Chef Antoni Tafuri’s cuisine features on various tasting menus (including vegetarian and vegan) and an à la carte and demonstrates careful combinations that aim to showcase his regional ingredients to the full...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Valentino%20Izzo%201%2C%20Santa%20Maria%20di%20Castellabate%2C%2084048%2C%20Italy"
    pageTitle="Osteria 1861"
  />
);

export default Osteria1861;
