...
const Butterfly = () => (
  <RestaurantPage
    restaurantName="Butterfly"
    address="SS 12 del Brennero 192, Marlia, 55012, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+390583307573"
    website="https://www.ristorantebutterfly.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The 19C country house that is home to this charming restaurant is surrounded by its own garden, which can be enjoyed throughout the year thanks to its new glass veranda-style dining room – the veranda opens out into the fresh air in summer and is closed and heated in winter, yet still offers lovely views. The successful partnership of father and son (Fabrizio and Andrea Girasoli) in the kitchen results in an extensive menu featuring meat and fish dishes alike. The culinary techniques in evidence are equally at ease in classic-style dishes (superb langoustine from the Tyrrhenian sea freshly cooked on a lava stone and served with a frothy cocktail sauce, vegetable flowers and fruit) and more creative fare (such as the cocoa cigar stuffed with foie gras, apple and hazelnut – a dish dedicated ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SS%2012%20del%20Brennero%20192%2C%20Marlia%2C%2055012%2C%20Italy"
    pageTitle="Butterfly"
  />
);
