...
const LaRefezione = () => (
  <RestaurantPage
    restaurantName="La Refezione"
    address="via Milano 166, Garbagnate Milanese, 20024, Italy"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+39029958942"
    website="https://www.larefezione.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An imaginative cuisine for the elegant club - house located inside a sports centre; managed by two great enthusiasts of the culinary art. You will receive a hearty welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Milano%20166%2C%20Garbagnate%20Milanese%2C%2020024%2C%20Italy"
    pageTitle="La Refezione"
  />
);

export default LaRefezione;
