...
const IlGrifone = () => (
  <RestaurantPage
    restaurantName="Il Grifone"
    address="via Ca' Masino 611/a - loc. Varignana, Castel San Pietro Terme, 40024, Italy"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+3905119938300"
    website="https://www.palazzodivarignana.com/hospitality/ristoranti-bar/il-grifone/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fine-dining restaurant housed in the 18C Palazzo Bentivoglio Bargellini is part of the luxurious Palazzo di Varignana resort (with which it shares the Il Grifone symbol), the latter also home to a farm producing olive oil, wine and fruit. In the evening, choose between two tasting menus and an à la carte offering a selection of meat and fish dishes on which the modern recipes feature a careful balance of colours and flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ca'%20Masino%20611%2Fa%20-%20loc.%20Varignana%2C%20Castel%20San%20Pietro%20Terme%2C%2040024%2C%20Italy"
    pageTitle="Il Grifone"
  />
);

export default IlGrifone;
