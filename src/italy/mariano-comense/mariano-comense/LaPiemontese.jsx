...
const LaPiemontese = () => (
  <RestaurantPage
    restaurantName="La Piemontese"
    address="via San Martino 48, Mariano Comense, 22066, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€"
    phoneNumber="+390314124745"
    website="https://www.lapiemontesemariano.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The focus at La Piemontese, a simple yet modern restaurant with a convenient car park, is mainly on meat dishes, although game and fresh truffles also feature in season, plus there’s a generous business menu at lunchtime. An enjoyable dining experience that offers good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Martino%2048%2C%20Mariano%20Comense%2C%2022066%2C%20Italy"
    pageTitle="La Piemontese"
  />
);

export default LaPiemontese;
