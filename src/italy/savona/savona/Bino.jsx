...
const Bino = () => (
  <RestaurantPage
    restaurantName="Bino"
    address="via Ambrogio Aonzo 31r, Savona, 17100, Italy"
    cuisine="Country cooking, Contemporary"
    priceRange="€€"
    phoneNumber="+390195281517"
    website="https://guide.michelin.com/en/liguria/savona/restaurant/bino-ricchebuono"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the historic centre near the ceramic museum (some of its pieces are also on display in the restaurant), Bino Ricchebuono boasts an attractive outdoor space in a charming small square. Michelin-starred chef Ricchebuono from Noli is the brains behind this restaurant, which serves fish and meat dishes prepared with a touch of creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ambrogio%20Aonzo%2031r%2C%20Savona%2C%2017100%2C%20Italy"
    pageTitle="Bino"
  />
);
