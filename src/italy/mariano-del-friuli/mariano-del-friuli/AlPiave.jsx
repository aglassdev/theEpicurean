...
const AlPiave = () => (
  <RestaurantPage
    restaurantName="Al Piave"
    address="via Cormons 6 - Fraz. Corona, Mariano del Friuli, 34071, Italy"
    cuisine="Friulian, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+39048169003"
    website="https://www.trattoriaalpiave.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming family - run trattoria comprises of two attractive dining rooms and a beautiful summer garden. It specialises in regional dishes that vary according to the seasons. Guinea fowl cooked with chives is one of the house specialities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cormons%206%20-%20Fraz.%20Corona%2C%20Mariano%20del%20Friuli%2C%2034071%2C%20Italy"
    pageTitle="Al Piave"
  />
);

export default AlPiave;
