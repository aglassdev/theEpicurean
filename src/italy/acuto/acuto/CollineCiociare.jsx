...
const CollineCiociare = () => (
  <RestaurantPage
    restaurantName="Colline Ciociare"
    address="via Prenestina 27, Acuto, 03010, Italy"
    cuisine="Cuisine from Lazio, Creative"
    priceRange="€€€€"
    phoneNumber="+39077556049"
    website="https://guide.michelin.com/en/lazio/acuto/restaurant/colline-ciociare"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Guests who make it to this restaurant situated some 60km from Rome on a road with plenty of winding bends show real commitment, probably because they’ve heard of the culinary delicacies that Salvatore Tassa brings to the table here. There’s a restricted choice but unlimited imagination in dishes which range from traditional Italian classics and recipes from Lazio to bolder, more innovative, fare typical of the culinary world of this chef-cum-poet who eschews all definitions and fashions. At the modern Nù bistro, enjoy some of the chef’s more traditional and long-established recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Prenestina%2027%2C%20Acuto%2C%2003010%2C%20Italy"
    pageTitle="Colline Ciociare"
  />
);

export default CollineCiociare;
