...
const TrattoriaDelVicolo = () => (
  <RestaurantPage
    restaurantName="Trattoria del Vicolo"
    address="vico Ulisse 17, Lipari, 98055, Italy"
    cuisine="Sicilian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390909811066"
    website="https://www.trattoriadelvicolo.info"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the piazza for almost 50 years, this restaurant has been modernised but has nonetheless managed to retain its friendly ambience, especially in the outdoor space facing the narrow alleyway. The owner-chef serves regional specialities reinterpreted with his own individual twist, such as his famous swordfish rolls served in a type of pie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vico%20Ulisse%2017%2C%20Lipari%2C%2098055%2C%20Italy"
    pageTitle="Trattoria del Vicolo"
  />
);

export default TrattoriaDelVicolo;
