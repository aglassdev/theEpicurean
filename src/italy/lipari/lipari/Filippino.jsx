...
const Filippino = () => (
  <RestaurantPage
    restaurantName="Filippino"
    address="piazza Municipio, Lipari, 98055, Italy"
    cuisine="Seafood, Sicilian"
    priceRange="€€"
    phoneNumber="+390909811002"
    website="https://www.filippino.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 1910, this historic restaurant with an attractive shaded outdoor pergola serves an extensive array of delicious local fish prepared in traditional recipes. Enjoy a selection of typical Sicilian specialities prepared by the Bernardi family, including the highly recommended “Nonno Filippino” fish soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Municipio%2C%20Lipari%2C%2098055%2C%20Italy"
    pageTitle="Filippino"
  />
);

export default Filippino;
