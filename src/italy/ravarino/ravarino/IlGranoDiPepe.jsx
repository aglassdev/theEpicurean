...
const IlGranoDiPepe = () => (
  <RestaurantPage
    restaurantName="Il Grano di Pepe"
    address="via Roma 178/a, Ravarino, 41017, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+393913172377"
    website="https://ilgranodipepe.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While you’re trying to decide between the tasting menu and the à la carte at this restaurant, you can tuck into its excellent bread, including the “sfincione” – a type of tomato-flavoured focaccia from Palermo which makes the journey here worthwhile on its own! If fish is your preference, we recommend the “Palermo and Marseille” fish stew, an intense dish full of bold and delicious flavours. Minimalist decor and a friendly welcome from chef Rino Duca complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%20178%2Fa%2C%20Ravarino%2C%2041017%2C%20Italy"
    pageTitle="Il Grano di Pepe"
  />
);

export default IlGranoDiPepe;
