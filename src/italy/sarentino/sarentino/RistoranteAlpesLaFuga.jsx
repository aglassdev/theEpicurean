...
const RistoranteAlpesLaFuga = () => (
  <RestaurantPage
    restaurantName="Ristorante Alpes & La FuGa"
    ...
    bio="Three tables in the violet Stube, with a contemporary and refined atmosphere, and the same number in the farmer's Stube, which is historic and romantic. Wherever you sit, you'll find creative and sophisticated dishes, crafted by chef Matthias Kirchler, beloved by those who favor innovation and imagination!..."
    ...
    pageTitle="Ristorante Alpes & La FuGa"
  />
);

export default RistoranteAlpesLaFuga;
