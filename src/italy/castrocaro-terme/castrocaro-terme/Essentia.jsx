...
const Essentia = () => (
  <RestaurantPage
    restaurantName="Essentia"
    address="piazza San Nicolò 2, Castrocaro Terme, 47011, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390543768260"
    website="https://essentiaristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated at the foot of the fortress in the historic centre of Castrocaro, this restaurant has an interesting young chef at the helm, Andrea Giacchini. The cuisine often (but not always) has a local influence and demonstrates remarkable technical expertise that is neither overly ostentatious nor an end in itself, but rather a way of skilfully showcasing the top-quality ingredients used...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Nicol%C3%B2%202%2C%20Castrocaro%20Terme%2C%2047011%2C%20Italy"
    pageTitle="Essentia"
  />
);
