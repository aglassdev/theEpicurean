...
const CastelToblino = () => (
  <RestaurantPage
    restaurantName="Castel Toblino"
    address="località Castel Toblino 1, Castel Toblino, 38076, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390461864036"
    website="https://www.casteltoblino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a bucolic location in the Trentino where the excellent Vino Santo is produced (we recommend rounding off your meal with a glass of the equally superb grappa), this restaurant and adjacent bar occupy a fascinating medieval castle (tours of which can be arranged) jutting out into the lake of the same name. The generous, modern meat and fish dishes are featured on various tasting menus, along with an extensive à la carte. In summer, make sure you book a table on the charming terrace overlooking the lake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Castel%20Toblino%201%2C%20Castel%20Toblino%2C%2038076%2C%20Italy"
    pageTitle="Castel Toblino"
  />
);

export default CastelToblino;
