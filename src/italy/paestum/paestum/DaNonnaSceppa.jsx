...
const DaNonnaSceppa = () => (
  <RestaurantPage
    restaurantName="Da Nonna Sceppa"
    address="via Laura 45, Paestum, 84047, Italy"
    cuisine="Campanian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390828851064"
    website="https://www.nonnasceppa.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Founded in the 1960s by Grandma Giuseppa, the inn has today become a restaurant. The management has stayed within the hands of the same family: nephews and great - nephews are spread over dining room and kitchen. Local recipes on the menu, which changes daily...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Laura%2045%2C%20Paestum%2C%2084047%2C%20Italy"
    pageTitle="Da Nonna Sceppa"
  />
);

export default DaNonnaSceppa;
