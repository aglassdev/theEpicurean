...
const CampoCedro = () => (
  <RestaurantPage
    restaurantName="Campo Cedro"
    address="via Pian d'Ovile 54, Sienna, 53100, Italy"
    cuisine="Italian Contemporary, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390577236027"
    website="https://www.campocedro.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a stone’s throw from the centre yet away from the tourist crowds, this restaurant is well worth the effort needed to find it! Here, Japanese chef Sugihara, who has more than 20 years’ experience working in Italy, creates modern and skilfully prepared Italian meat and fish dishes which are fresh and elaborate. You’ll nearly always find seafood risotto on the menu, which is made with fish, mussels and finely chopped shrimps all cooked together with rice and then sprinkled with crumbled seaweed and dotted with tomato paste. Excellent value for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pian%20d'Ovile%2054%2C%20Sienna%2C%2053100%2C%20Italy"
    pageTitle="Campo Cedro"
  />
);

export default CampoCedro;
