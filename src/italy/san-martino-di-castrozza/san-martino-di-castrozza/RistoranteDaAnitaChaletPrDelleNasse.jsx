...
const RistoranteDaAnitaChaletPrDelleNasse = () => (
  <RestaurantPage
    restaurantName="Ristorante Da Anita - Chalet Prà delle Nasse"
    address="via Cavallazza 24, località Prà delle Nasse, San Martino di Castrozza, 38054, Italy"
    cuisine="Regional Cuisine, Alpine"
    priceRange="€€"
    phoneNumber="+390439768893"
    website="https://www.ristorante-da-anita.com/ristorante-da-anita-p14.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-run restaurant is surrounded by views of the Dolomites that are particularly impressive from the outdoor terrace in summer. A historic culinary stalwart among San Martino di Castrozza restaurants, Prà delle Nasse focuses on regional mountain cuisine, although a few more personalised dishes also feature on the menu. The desserts include the grandmother’s traditional tarts alongside more contemporary options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cavallazza%2024%2C%20localit%C3%A0%20Pr%C3%A0%20delle%20Nasse%2C%20San%20Martino%20di%20Castrozza%2C%2038054%2C%20Italy"
    pageTitle="Ristorante Da Anita - Chalet Prà delle Nasse"
  />
);

export default RistoranteDaAnitaChaletPrDelleNasse;
