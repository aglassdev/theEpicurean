...
const VillaAurora = () => (
  <RestaurantPage
    restaurantName="Villa Aurora"
    address="via Ciucani 1/7, Soiano del Lago, 25080, Italy"
    cuisine="Classic Cuisine"
    priceRange="€"
    phoneNumber="+390365674101"
    website="https://www.ristorantevillaaurora.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A typical restaurant in the province of Brescia not far from Lake Garda, Villa Aurora serves Italian cuisine with an equal focus on meat and fish dishes, as well as a few traditional specialities with a light modern twist. A bastion of local cuisine, the restaurant is run by a welcoming and experienced family. Don’t miss the desserts!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ciucani%201%2F7%2C%20Soiano%20del%20Lago%2C%2025080%2C%20Italy"
    pageTitle="Villa Aurora"
  />
);
