...
const Ginevra = () => (
  <RestaurantPage
    restaurantName="Ginevra"
    address="Rupi di via XXIX Settembre 12, Ancona, 60122, Italy"
    cuisine="Mediterranean Cuisine, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390719715100"
    website="https://www.ginevrarestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the fourth floor of the Seeport hotel, this restaurant boasts a summer roof garden offering stunning sea views. The chef, a native of Ancona who trained with Gualtiero Marchesi, serves traditional local dishes prepared using ingredients from the region, as well as remaining open to the rest of the world (just like his town and its port). Lighter fare is available at the Seeport Bistrò...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rupi%20di%20via%20XXIX%20Settembre%2012%2C%20Ancona%2C%2060122%2C%20Italy"
    pageTitle="Ginevra"
  />
);

export default Ginevra;
