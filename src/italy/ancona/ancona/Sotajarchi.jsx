...
const Sotajarchi = () => (
  <RestaurantPage
    restaurantName="Sot'Ajarchi"
    address="via Marconi 93, Ancona, 60125, Italy"
    cuisine="Seafood, Cuisine from the Marches"
    priceRange="€€"
    phoneNumber="+39071202441"
    website="https://www.ristorantesotajarchi.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An informal atmosphere in a small trattoria where you can really feel at ease, perhaps in company, eating tasty seafood dishes, based on the daily fish catch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%2093%2C%20Ancona%2C%2060125%2C%20Italy"
    pageTitle="Sot'Ajarchi"
  />
);

export default Sotajarchi;
