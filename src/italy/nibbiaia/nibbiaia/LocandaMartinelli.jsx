...
const LocandaMartinelli = () => (
  <RestaurantPage
    restaurantName="Locanda Martinelli"
    address="piazza Mazzini 11, Nibbiaia, 57016, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390586740161"
    website="https://www.locandamartinelli.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s well worth leaving the coast and climbing into the foothills to get to this small restaurant serving excellent cuisine. Housed in a rustic-style house with individual furnishings, in what could be the sitting room of a private house, the restaurant serves meat and fish specialities prepared with imagination from local produce and ingredients from further afield. As well as being a wine expert, the female owner gathers herbs, flowers and berries to flavour her recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Mazzini%2011%2C%20Nibbiaia%2C%2057016%2C%20Italy"
    pageTitle="Locanda Martinelli"
  />
);

export default LocandaMartinelli;
