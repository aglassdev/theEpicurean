...
const AbOsteriaContemporanea = () => (
  <RestaurantPage
    restaurantName="AB Osteria Contemporanea"
    address="via Aquileia 5, Lavariano, 33050, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393515678542"
    website="https://abcontempo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small village just a few kilometres from Udine provides the backdrop for modern, regionally influenced cuisine with plenty of character. The renovated dining rooms have two distinct styles: the one near the entrance is friendly and relaxed; the other has a much more formal ambience. The large outdoor space is perfect for summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Aquileia%205%2C%20Lavariano%2C%2033050%2C%20Italy"
    pageTitle="AB Osteria Contemporanea"
  />
);

export default AbOsteriaContemporanea;
