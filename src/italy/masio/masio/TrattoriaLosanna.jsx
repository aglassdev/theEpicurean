...
const TrattoriaLosanna = () => (
  <RestaurantPage
    restaurantName="Trattoria Losanna"
    address="via San Rocco 40, Masio, 15024, Italy"
    cuisine="Piedmontese, Regional Cuisine"
    priceRange="€"
    phoneNumber="+390131799525"
    website="https://guide.michelin.com/en/piemonte/masio/restaurant/trattoria-losanna"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This little bastion of traditional Monferrato cuisine is situated in a rustic building on the side of a road outside Masio. Most of the dishes here are local in flavour (as is the wine), including specialities such as Russian salad, veal tongue in green sauce, braised beef marinated in Barbera wine and semifreddo al torrone dessert. The classic, comfortable dining rooms have a welcoming feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Rocco%2040%2C%20Masio%2C%2015024%2C%20Italy"
    pageTitle="Trattoria Losanna"
  />
);

export default TrattoriaLosanna;
