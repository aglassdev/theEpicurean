...
const LaCucoma = () => (
  <RestaurantPage
    restaurantName="La Cucoma"
    address="via Molinaccio 175, San Pancrazio, 48020, Italy"
    cuisine="Seafood, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+390544534147"
    website="https://www.ristorantecucoma.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a village inland, this restaurant serves some of the best fish dishes in Romagna. The focus here is on classic recipes from the Adriatic with no unnecessary frills or innovations, all prepared using the freshest fish and including raw fish dishes, fried options, spaghetti with clams and fish barbecued over a wood fire...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Molinaccio%20175%2C%20San%20Pancrazio%2C%2048020%2C%20Italy"
    pageTitle="La Cucoma"
  />
);

export default LaCucoma;
