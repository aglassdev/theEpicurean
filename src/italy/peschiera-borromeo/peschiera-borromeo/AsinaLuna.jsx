...
const AsinaLuna = () => (
  <RestaurantPage
    restaurantName="Asina Luna"
    address="via della Resistenza 23, Peschiera Borromeo, 20068, Italy"
    cuisine="Meats and Grills, Contemporary"
    priceRange="€€€"
    phoneNumber="+390255300205"
    website="https://www.asinaluna.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant with an attractive atmosphere, thanks to its profusion of wood, soft lighting and contemporary colour scheme. Meat aged for different periods takes pride of place on the menu. Sourced from different countries, it includes sweet Piedmontese Vicciola beef fed on hazelnuts and tender and delicately marbled Australian Scottona beef. Good selection of strongly flavoured and aged meat options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20della%20Resistenza%2023%2C%20Peschiera%20Borromeo%2C%2020068%2C%20Italy"
    pageTitle="Asina Luna"
  />
);

export default AsinaLuna;
