...
const DaErcole = () => (
  <RestaurantPage
    restaurantName="Da Ercole"
    address="viale Gramsci 122, Crotone, 88900, Italy"
    cuisine="Seafood, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+390962901425"
    website="https://www.ristorantedaercole.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on Crotone’s seafront, Da Ercole is a culinary institution for anyone who loves fish, with the benefit of 40 years in the business behind it! The salty tang of the Ionian sea is celebrated on an extensive menu, although if you really want to enjoy yourself to the full, let owner-chef and old-school host Ercole guide you in your choice (including some excellent raw fish dishes)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Gramsci%20122%2C%20Crotone%2C%2088900%2C%20Italy"
    pageTitle="Da Ercole"
  />
);

export default DaErcole;
