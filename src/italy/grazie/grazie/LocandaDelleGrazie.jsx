...
const LocandaDelleGrazie = () => (
  <RestaurantPage
    restaurantName="Locanda delle Grazie"
    address="via San Pio X 2, Grazie, 46010, Italy"
    cuisine="Mantuan, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+390376348038"
    website="https://guide.michelin.com/en/lombardia/grazie/restaurant/locanda-delle-grazie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of the charming village of Curtatone which overlooks the river Mincio, this restaurant has been a beacon for fans of Mantuan cuisine for many years. A few Italian favourites feature alongside the local specialities, which include pumpkin tortelli, cured meats, pike with salsa verde and slow-cooked meats, as well as sbrisolona and zabaglione desserts. Simple, yet delicious cuisine, with a focus on home-style cooking and generous portions, all at reasonable prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Pio%20X%202%2C%20Grazie%2C%2046010%2C%20Italy"
    pageTitle="Locanda delle Grazie"
  />
);

export default LocandaDelleGrazie;
