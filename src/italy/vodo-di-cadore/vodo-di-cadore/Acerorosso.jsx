...
const Acerorosso = () => (
  <RestaurantPage
    restaurantName="AceroRosso"
    address="Via Ruvignan 1, Vodo di Cadore, 32040, Italy"
    cuisine="Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+390435489653"
    website="https://www.acerorossodolomiti.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This secluded mountain chalet immersed in verdant woodland boasts a welcoming dining room with a decidedly Alpine feel thanks to the profusion of wood and a warming open fire. The cuisine is also regional in style, featuring local recipes and ingredients albeit with a contemporary touch. Popular dishes include the rack of lamb cooked at low temperature and served with creamed sweetcorn, leek fondant and its own jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Ruvignan%201%2C%20Vodo%20di%20Cadore%2C%2032040%2C%20Italy"
    pageTitle="AceroRosso"
  />
);

export default Acerorosso;
