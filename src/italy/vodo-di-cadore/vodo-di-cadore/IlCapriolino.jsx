...
const IlCapriolino = () => (
  <RestaurantPage
    restaurantName="Il Capriolino"
    address="via Nazionale 108, Vodo di Cadore, 32040, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390435489207"
    website="https://www.alcapriolo.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant restaurant has been run by the same family for years and has a history dating back over two centuries. It serves regional yet creative cuisine and has a distinctly Middle European ambience with its hunting trophies, clocks and frescoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nazionale%20108%2C%20Vodo%20di%20Cadore%2C%2032040%2C%20Italy"
    pageTitle="Il Capriolino"
  />
);

export default IlCapriolino;
