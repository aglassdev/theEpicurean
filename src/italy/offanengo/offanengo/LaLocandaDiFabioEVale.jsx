...
const LaLocandaDiFabioEVale = () => (
  <RestaurantPage
    restaurantName="La Locanda di Fabio e Vale"
    address="via Brescia 1, Offanengo, 26010, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€"
    phoneNumber="+393461483963"
    website="https://www.lalocandadifabioevale.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Young, informal and friendly owners Fabio and Vale welcome guests to their restaurant in Offanengo, just a few kilometres from Crema. A good choice for anyone looking for a change from traditional cuisine, the restaurant serves moderately creative dishes including a good selection of fish options (the Mazara del Vallo red prawns served with green gazpacho, caviar and lemon are particularly delicious)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Brescia%201%2C%20Offanengo%2C%2026010%2C%20Italy"
    pageTitle="La Locanda di Fabio e Vale"
  />
);

export default LaLocandaDiFabioEVale;
