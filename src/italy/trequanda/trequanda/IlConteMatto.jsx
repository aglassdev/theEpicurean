...
const IlConteMatto = () => (
  <RestaurantPage
    restaurantName="Il Conte Matto"
    address="via Taverne 40, Trequanda, 53020, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390577662079"
    website="https://www.contematto.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The 14th-century home of the castle gamekeeper has been transformed into a showcase of regional products with a terrace overlooking the hills and, from the rooms, glimpses of the surrounding countryside. Chef Chiara's cooking is easy to read: Tuscan and local, with an emphasis on seasonal produce from the garden and nearby farmers. The triptych of hams is already a good reason to sit at the table, delicate and firm at the same time, with perfect seasoning! Among the starters, indulge in an artichoke flan; among the main courses, the classic Florentine steak or pigeon, served whole and flavoured with vin santo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Taverne%2040%2C%20Trequanda%2C%2053020%2C%20Italy"
    pageTitle="Il Conte Matto"
  />
);

export default IlConteMatto;
