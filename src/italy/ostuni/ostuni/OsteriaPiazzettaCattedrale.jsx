...
const OsteriaPiazzettaCattedrale = () => (
  <RestaurantPage
    restaurantName="Osteria Piazzetta Cattedrale"
    address="largo Arcidiacono Trinchera 7, Ostuni, 72017, Italy"
    cuisine="Apulian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390831335026"
    website="https://www.piazzettacattedrale.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by a married couple with the wife in the kitchen and the husband front of house, this gem of a restaurant just a few metres from the cathedral stands out for its top - quality produce (mainly from Puglia), in dishes such as broad bean purée with seasonal vegetables. Other specialities include sformatino (a type of soufflé) with courgette flowers, spring onions and date purée; suckling pig with baked potato and wild greens; and warm sfogliatina pastry with vanilla cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=largo%20Arcidiacono%20Trinchera%207%2C%20Ostuni%2C%2072017%2C%20Italy"
    pageTitle="Osteria Piazzetta Cattedrale"
  />
);

export default OsteriaPiazzettaCattedrale;
