...
const Cielo = () => (
  <RestaurantPage
    restaurantName="Cielo"
    address="via Scipione Petrarolo 7, Ostuni, 72017, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390831305925"
    website="https://www.lasommita.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cielo is the gourmet restaurant at the splendid and aptly named La Sommità hotel, which is housed in a typical old mansion right at the top of this whitewashed town with its limestone steps. The restaurant offers the perfect setting for a romantic summer dinner, either among the citrus trees in the small inner courtyard or in the dining room crowned with a vaulted ceiling. Boasting a highly respectable CV, the chef from Martina Franca serves modern reinterpretations of Puglian cuisine, while the delightful terrace is perfect for an aperitif at sunset. A simpler menu is available at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Scipione%20Petrarolo%207%2C%20Ostuni%2C%2072017%2C%20Italy"
    pageTitle="Cielo"
  />
);
