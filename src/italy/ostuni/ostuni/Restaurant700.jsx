...
const Restaurant700 = () => (
  <RestaurantPage
    restaurantName="Restaurant 700"
    address="largo Michele Ayroldi Carissimo 14, Ostuni, 72017, Italy"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+390831369219"
    website="https://www.restaurant700.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated at the entrance to Ostuni’s historic centre, this restaurant is part of the luxury Paragon 700 hotel. The charming dining room combines historic features with a more modern decor, while the exclusive garden is perfect for dining alfresco in fine weather. The menu offers a concise selection of classic Italian dishes at lunchtime, while in the evening the chef conjures up more high-level and elaborate dishes showcasing strong technique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=largo%20Michele%20Ayroldi%20Carissimo%2014%2C%20Ostuni%2C%2072017%2C%20Italy"
    pageTitle="Restaurant 700"
  />
);

export default Restaurant700;
