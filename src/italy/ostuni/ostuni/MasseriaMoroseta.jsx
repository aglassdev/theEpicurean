...
const MasseriaMoroseta = () => (
  <RestaurantPage
    restaurantName="Masseria Moroseta"
    address="Contrada Lamacavallo, Ostuni, 72017, Italy"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+393760798288"
    website="https://www.masseriamoroseta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Giorgia Eugenia Goggi offers a unique and authentic gastronomic experience that focuses on fresh ingredients (mostly vegetables), many of which are sourced from small organic gardens. The 90€ menu celebrates Mediterranean cuisine to the full, with colourful dishes that are full of flavour and in which the freshness of the ingredients is allowed to shine through. The beautifully kept, rustic dining room provides an ideal setting for an unforgettable dinner, while the selection of natural Italian wines offers the perfect accompaniment to the chef’s dishes, further enhancing your dining experience. There are six comfortable guestrooms available should you wish to extend your stay and immerse yourself in these peaceful rural surroundings. Booking in advance is highly recommended given the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Contrada%20Lamacavallo%2C%20Ostuni%2C%2072017%2C%20Italy"
    pageTitle="Masseria Moroseta"
  />
);

export default MasseriaMoroseta;
