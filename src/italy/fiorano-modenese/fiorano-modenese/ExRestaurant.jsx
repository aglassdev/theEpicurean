...
const ExRestaurant = () => (
  <RestaurantPage
    restaurantName="Exé Restaurant"
    address="via Circondariale San Francesco 2, Fiorano Modenese, 41042, Italy"
    cuisine="Italian, Italian Contemporary"
    priceRange="€€"
    phoneNumber="+390536832010"
    website="https://exerestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant, elegant and contemporary-style restaurant on the ground floor of the Executive Spa Hotel boasts spacious dining rooms and an extensive menu ranging from traditional dishes to raw fish options, grilled meats (aged by the restaurant itself) and gourmet pizzas. The wine list features an impressive selection of labels, including by the glass, while the talented sommelier will delight wine-enthusiasts with his willingness to open almost any of the bottles in his cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Circondariale%20San%20Francesco%202%2C%20Fiorano%20Modenese%2C%2041042%2C%20Italy"
    pageTitle="Exé Restaurant"
  />
);

export default ExRestaurant;
