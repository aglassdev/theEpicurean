...
const LaCucinaDiDonnaCarmela = () => (
  <RestaurantPage
    restaurantName="La Cucina di Donna Carmela"
    address="contrada Grotte 7, località Carruba di Riposto, Riposto, 95018, Italy"
    cuisine="Sicilian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39095809383"
    website="https://www.donnacarmela.com/it/hotel-con-ristoranti-carruba-di-riposto/la-cucina-di-donna-carmela.html"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Grotte%207%2C%20localit%C3%A0%20Carruba%20di%20Riposto%2C%20Riposto%2C%2095018%2C%20Italy"
    pageTitle="La Cucina di Donna Carmela"
  />
);

export default LaCucinaDiDonnaCarmela;
