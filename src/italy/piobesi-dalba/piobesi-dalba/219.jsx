...
const TwoOneNine = () => (
  <RestaurantPage
    restaurantName="21.9"
    address="Località Carretta 4, Piobesi d'Alba, 12040, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€"
    phoneNumber="+390173619261"
    website="https://www.ristorante21punto9.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Carretta%204%2C%20Piobesi%20d'Alba%2C%2012040%2C%20Italy"
    pageTitle="21.9"
  />
);

export default TwoOneNine;
