...
const LeChiaviDoro = () => (
  <RestaurantPage
    restaurantName="Le Chiavi d'Oro"
    address="piazza San Francesco 7, Arezzo, 52100, Italy"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390575403313"
    website="https://www.ristorantelechiavidoro.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in Arezzo’s historic centre, this restaurant boasts an original, minimalist ambience with an elegant wood decor. The main focus here is on the cuisine, which is among the best not only in the city but also in the region. Skilful interpretations of traditional dishes, with a focus on Tuscany, where the gastronomic pleasure increases with each course...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Francesco%207%2C%20Arezzo%2C%2052100%2C%20Italy"
    pageTitle="Le Chiavi d'Oro"
  />
);

export default LeChiaviDoro;
