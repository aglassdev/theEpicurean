...
const SaffronARE = () => (
  <RestaurantPage
    ...
    address="piazza Sant'Agostino 16, Arezzo, 52100, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+393346309416"
    website="https://guide.michelin.com/en/toscana/arezzo/restaurant/saffron252973"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you like fish and you find yourself in Arezzo, then this is the place for you. Saffron serves a range of traditional and imaginative raw fish dishes inspired by different traditions, from the Mediterranean to Japan, alongside a few cooked fish options and the occasional Japanese speciality such as tempura and Japanese spaghetti and ravioli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Sant'Agostino%2016%2C%20Arezzo%2C%2052100%2C%20Italy"
    pageTitle="Saffron"
  />
);

export default SaffronARE;
