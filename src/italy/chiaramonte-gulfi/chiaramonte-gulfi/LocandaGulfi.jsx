...
const LocandaGulfi = () => (
  <RestaurantPage
    restaurantName="Locanda Gulfi"
    address="Contrada Patria, Chiaramonte Gulfi, 97012, Italy"
    cuisine="Sicilian"
    priceRange="€€"
    phoneNumber="+390932928081"
    website="https://www.gulfi.it/it/locanda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a secluded area of olive groves and vineyards, Locanda Gulfi also produces its own oil and wine, as confirmed by the view of the wine cellar from the dining room. The cuisine features an attractive selection of classic Sicilian dishes, while guestrooms are available for anyone keen to extend their stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Contrada%20Patria%2C%20Chiaramonte%20Gulfi%2C%2097012%2C%20Italy"
    pageTitle="Locanda Gulfi"
  />
);

export default LocandaGulfi;
