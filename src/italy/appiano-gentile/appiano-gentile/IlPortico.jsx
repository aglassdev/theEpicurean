...
const IlPortico = () => (
  <RestaurantPage
    restaurantName="Il Portico"
    address="piazza Libertà 36, Appiano Gentile, 22070, Italy"
    cuisine="Farm to table, Contemporary"
    priceRange="€€"
    phoneNumber="+39031931982"
    website="https://guide.michelin.com/en/lombardia/appiano-gentile/restaurant/ll-portico"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Lopriore returns to his native region with this new restaurant which offers an original format – the lunchtime menu focuses on single course options, while in the evening the tasting menus comprise an interesting combination of imaginative fish, meat and vegetable dishes which can be combined as you wish. Cuisine with an emphasis on seasonal market ingredients where locally sourced produce takes pride of place...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Libert%C3%A0%2036%2C%20Appiano%20Gentile%2C%2022070%2C%20Italy"
    pageTitle="Il Portico"
  />
);

export default IlPortico;
