...
const AnticaTrattoriaLaGrottaDal1918 = () => (
  <RestaurantPage
    restaurantName="Antica Trattoria la Grotta dal 1918"
    address="via Tignano 3, Loc. Mongardino Grotta, Sasso Marconi, 40037, Italy"
    cuisine="Emilian, Country cooking"
    priceRange="€"
    phoneNumber="+390516755110"
    website="https://www.lagrotta1918.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It takes a while to get here, along a road which wends its way through the hills, but the cuisine more than compensates for the journey. The food here is based on a careful choice of ingredients (including produce from the restaurant’s own farm) from as far away as the Apennines, with a few ingredients from elsewhere in Italy, with a focus on traditional recipes. Don’t miss the tortellini in brodo, or the game and truffles available in season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Tignano%203%2C%20Loc.%20Mongardino%20Grotta%2C%20Sasso%20Marconi%2C%2040037%2C%20Italy"
    pageTitle="Antica Trattoria la Grotta dal 1918"
  />
);

export default AnticaTrattoriaLaGrottaDal1918;
