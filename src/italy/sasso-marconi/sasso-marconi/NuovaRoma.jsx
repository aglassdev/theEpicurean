...
const NuovaRoma = () => (
  <RestaurantPage
    restaurantName="Nuova Roma"
    address="via Olivetta 87, Sasso Marconi, 40037, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390516760140"
    website="https://www.ristorantenuovaroma.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A friendly and long-established family-run restaurant on the road between Calderino and Sasso Marconi, which serves generous portions of traditional, regional cuisine with a contemporary flavour. House specialities include fresh pasta, dishes cooked on the authentic wood-fired grill, as well as classic recipes such as Bolognese cutlet. There’s also a comprehensive wine list, with a natural focus on labels from Emilia Romagna. A spacious car park and attractive terrace for summer dining complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Olivetta%2087%2C%20Sasso%20Marconi%2C%2040037%2C%20Italy"
    pageTitle="Nuova Roma"
  />
);

export default NuovaRoma;
