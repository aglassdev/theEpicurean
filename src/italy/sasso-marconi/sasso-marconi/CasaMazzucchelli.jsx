...
const CasaMazzucchelli = () => (
  <RestaurantPage
    restaurantName="Casa Mazzucchelli"
    address="via Porrettana 291, Sasso Marconi, 40037, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39051846216"
    website="https://www.casamazzucchelli.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At certain times of day, the tempting aroma of freshly baked bread greets you as soon as you step into this restaurant, leaving you in no doubt as to the nature of the restaurant’s newest venture. Other dishes are also baked in the oven here, such as wild boar served with a red wine babà and sage mayonnaise. There are two tasting menus available (Attimi di cucina and Momento contemporaneo), both of which showcase traditionally influenced cuisine full of distinct flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Porrettana%20291%2C%20Sasso%20Marconi%2C%2040037%2C%20Italy"
    pageTitle="Casa Mazzucchelli"
  />
);

export default CasaMazzucchelli;
