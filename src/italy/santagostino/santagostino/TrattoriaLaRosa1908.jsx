...
const TrattoriaLaRosa1908 = () => (
  <RestaurantPage
    restaurantName="Trattoria la Rosa 1908"
    address="via del Bosco 2, ang. via Facchini, Sant'Agostino, 44047, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+39053284098"
    website="https://www.larosa1908.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the outskirts of Ferrara, this reliable, classic-style restaurant now run by the fifth generation of the same family serves carefully prepared cuisine based around local ingredients. Highlights include truffles, sometimes served with fettuccine, butter and parmesan cheese, and the “sformato dell’Artusi” (a type of flan), served with a classic and intensely flavoured velouté...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Bosco%202%2C%20ang.%20via%20Facchini%2C%20Sant'Agostino%2C%2044047%2C%20Italy"
    pageTitle="Trattoria la Rosa 1908"
  />
);

export default TrattoriaLaRosa1908;
