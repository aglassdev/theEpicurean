...
const PodereBelvedereTuscany = () => (
  <RestaurantPage
    restaurantName="Podere Belvedere Tuscany"
    address="via San Piero a Strada 23, Pontassieve, 50065, Italy"
    cuisine="Tuscan, Creative"
    priceRange="€€€"
    phoneNumber="+393338693448"
    website="https://poderebelvederetuscany.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a tower house dating from 1700, this restaurant is surrounded by typical Tuscan scenery of olive groves and vineyards, as well as vegetable gardens and farms which produce many of the ingredients featuring in the dishes here. The friendly self-taught chef celebrates the best of Tuscan country cuisine, with a focus on meat, including grilled dishes and top-quality vegetables, as well as the occasional more creative dish – the result is cuisine of a very high standard. The restaurant also has a few guestrooms – a convenient option given the property’s attractive secluded location...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Piero%20a%20Strada%2023%2C%20Pontassieve%2C%2050065%2C%20Italy"
    pageTitle="Podere Belvedere Tuscany"
  />
);

export default PodereBelvedereTuscany;
