...
const LocandaPerbelliniAlMare = () => (
  <RestaurantPage
    restaurantName="Locanda Perbellini al Mare"
    address="Bovo Marina, Montallegro, 92010, Italy"
    cuisine="Sicilian, Contemporary"
    priceRange="€€"
    phoneNumber="+393479221759"
    website="https://www.locandaperbellinialmare.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flavors of Sicily – and not just seafood – are reimagined in a modern way, with personal touches (such as the tuna cutlet cooked and raw with soy mayonnaise and mashed potatoes), as well as vegetarian recipes inspired by the multi-starred chef Perbellini, executed with good technique and a dedication to taste. This all takes place in a modern beach establishment, complete with loungers and umbrellas. In the summertime, the windows open, and you practically all dine on the terrace, surrounded by the scent of the sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bovo%20Marina%2C%20Montallegro%2C%2092010%2C%20Italy"
    pageTitle="Locanda Perbellini al Mare"
  />
);

export default LocandaPerbelliniAlMare;
