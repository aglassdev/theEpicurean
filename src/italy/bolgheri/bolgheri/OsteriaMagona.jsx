...
const OsteriaMagona = () => (
  <RestaurantPage
    restaurantName="Osteria Magona"
    address="Località Vallone dei Messi 199, SP 16/b km 2,400, Bolgheri, 57020, Italy"
    cuisine="Tuscan, Meats and Grills"
    priceRange="€€"
    phoneNumber="+390565762173"
    website="https://www.osteriamagona.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Amidst vineyards and the renowned cypress avenue, Osteria Magona is a must-visit for meat enthusiasts and Tuscan regional cuisine aficionados. Impeccable are the famous soups, from ribollita to pappa al pomodoro, alongside gnudi and fresh pastas. The wine list offers ample room to various Bolgheri labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Vallone%20dei%20Messi%20199%2C%20SP%2016%2Fb%20km%202%2C400%2C%20Bolgheri%2C%2057020%2C%20Italy"
    pageTitle="Osteria Magona"
  />
);

export default OsteriaMagona;
