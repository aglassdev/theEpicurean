...
const OsteriaDelTasso = () => (
  <RestaurantPage
    restaurantName="Osteria del Tasso"
    address="via Bolgherese km 3,9, località San Walfredo, Bolgheri, 57020, Italy"
    cuisine="Italian, Meats and Grills"
    priceRange="€€"
    phoneNumber="+3905651828061"
    website="https://www.osteriadeltasso.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone’s throw from the famous Viale dei Cipressi avenue in one of Italy’s best-known wine-producing areas, this restaurant occupies one of the region’s most famous wineries, namely Guado al Tasso, renowned for its excellent wines. In fine weather, guests can dine in the shade of plane trees looking out over the vineyards. Simple, delicious and well-prepared cuisine, mostly traditional in style, plus specialities such as cured hams and grilled dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bolgherese%20km%203%2C9%2C%20localit%C3%A0%20San%20Walfredo%2C%20Bolgheri%2C%2057020%2C%20Italy"
    pageTitle="Osteria del Tasso"
  />
);

export default OsteriaDelTasso;
