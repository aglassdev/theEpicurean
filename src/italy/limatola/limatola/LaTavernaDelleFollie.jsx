...
const LaTavernaDelleFollie = () => (
  <RestaurantPage
    restaurantName="La Taverna delle Follie"
    address="via San Biagio 30, Limatola, 82030, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3908231454365"
    website="https://guide.michelin.com/en/campania/limatola_1849192/restaurant/la-taverna-delle-follie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a discreet sign is situated in a small village overlooked by a splendid Norman castle. Meals are served either in the simple yet comfortable dining room or in the charming outdoor space in fine weather. The reasonably priced cuisine celebrates the sea in its many varied fish and seafood dishes, which range from pasta with shellfish or seafood to fish guazzetto (a tomato-based stew) with green vegetables and even raw fish options. Among the desserts, we particularly recommend the babà...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Biagio%2030%2C%20Limatola%2C%2082030%2C%20Italy"
    pageTitle="La Taverna delle Follie"
  />
);

export default LaTavernaDelleFollie;
