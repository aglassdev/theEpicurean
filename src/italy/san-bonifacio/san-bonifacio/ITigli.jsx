...
const ITigli = () => (
  <RestaurantPage
    restaurantName="I Tigli"
    address="via Camporosolo 11, San Bonifacio, 37047, Italy"
    cuisine="Pizza, Sharing"
    priceRange="€€"
    phoneNumber="+390456102606"
    website="https://www.pizzeriaitigli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An iconic pizzeria which has brought Italy’s favourite street-food snack right up to date! With almost 30 years’ experience behind him, Simone Padoan knows how to make difficult things easy: he uses a mix of wholemeal flours and pays meticulous attention to natural leavening processes to create a dough which has a crispy crust yet soft interior. He also focuses on different types of toppings, including fish, meat and vegetables – whether your preference is for traditional or more imaginative pizzas, every option is of the highest quality. A choice of excellent desserts provides the perfect conclusion to your meal!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Camporosolo%2011%2C%20San%20Bonifacio%2C%2037047%2C%20Italy"
    pageTitle="I Tigli"
  />
);

export default ITigli;
