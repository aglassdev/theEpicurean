...
const EsCantinaristorante = () => (
  <RestaurantPage
    restaurantName="ES Cantina&Ristorante"
    address="contrada Reni, Manduria, 74024, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393512619410"
    website="https://www.gianfrancofino.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the Gianfranco Fino wine estate, this tuff building houses a restaurant on its first floor with large picture windows that look out at the vineyards and a spacious terrace offering views of the surrounding countryside. Here, chef Simone Profeta from Naples serves modern meat and fish dishes, often cooked using wines from the estate, such as in the deliciously tender braised veal cheeks served with a full-bodied ES reduction. There’s also a vegetarian menu that features organic vegetables grown in the estate’s own kitchen garden. The wine list showcases the winery’s own labels of different vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Reni%2C%20Manduria%2C%2074024%2C%20Italy"
    pageTitle="ES Cantina&Ristorante"
  />
);

export default EsCantinaristorante;
