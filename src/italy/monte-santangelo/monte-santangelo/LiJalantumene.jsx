...
const LiJalantumene = () => (
  <RestaurantPage
    restaurantName="Li Jalantuùmene"
    address="piazza de Galganis 9, Monte Sant'Angelo, 71037, Italy"
    cuisine="Apulian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390884565484"
    website="https://www.li-jalantuumene.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic restaurant is faithful to the culinary traditions of the area, with an added spirit of discovery. It is located in a charming square. Pleasant outdoor area for summertime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20de%20Galganis%209%2C%20Monte%20Sant'Angelo%2C%2071037%2C%20Italy"
    pageTitle="Li Jalantuùmene"
  />
);

export default LiJalantumene;
