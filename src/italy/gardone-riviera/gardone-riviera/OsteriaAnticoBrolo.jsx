...
const OsteriaAnticoBrolo = () => (
  <RestaurantPage
    restaurantName="Osteria Antico Brolo"
    address="via Carere 10, Gardone Riviera, 25083, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+39036521421"
    website="https://www.ristoranteanticobrolo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the upper part of the town near the Vittoriale estate, this rustic 18C building is the setting for regional cuisine prepared using seasonal ingredients. The charming small courtyard offers shade for summer dining, while the interior dining room also includes a single table on a small balcony which needs to be booked well in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Carere%2010%2C%20Gardone%20Riviera%2C%2025083%2C%20Italy"
    pageTitle="Osteria Antico Brolo"
  />
);

export default OsteriaAnticoBrolo;
