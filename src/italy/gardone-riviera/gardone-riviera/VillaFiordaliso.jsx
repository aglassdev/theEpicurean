...
const VillaFiordaliso = () => (
  <RestaurantPage
    restaurantName="Villa Fiordaliso"
    address="corso Zanardelli 150, Gardone Riviera, 25083, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+39036520158"
    website="https://www.villafiordaliso.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Villa Fiordaliso is one of the beautiful early 20C villas that line the lake front. Surrounded by verdant grounds and extending out into the lake on a pontoon, the restaurant serves creative, modern cuisine. The chef is equally at ease with fish and meat dishes, while the extensive wine list suggests that you’ll have no problem finding your favourite wine here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Zanardelli%20150%2C%20Gardone%20Riviera%2C%2025083%2C%20Italy"
    pageTitle="Villa Fiordaliso"
  />
);

export default VillaFiordaliso;
