...
const OsteriaBertaina = () => (
  <RestaurantPage
    restaurantName="Osteria Bertaina"
    address="piazza Maggiore 6, Mondovì, 12084, Italy"
    cuisine="Piedmontese, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390174330396"
    website="https://osteriabertaina.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the picturesque square in the town’s oldest medieval district and accessed through its arcaded portico, this restaurant boasts two dining rooms with an attractive nostalgic feel and ceilings decorated with early 20C frescoes. The excellent cuisine focuses on local dishes, accompanied by occasionally more creative options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Maggiore%206%2C%20Mondov%C3%AC%2C%2012084%2C%20Italy"
    pageTitle="Osteria Bertaina"
  />
);

export default OsteriaBertaina;
