...
const Nello = () => (
  <RestaurantPage
    restaurantName="Nello"
    address="Via IV Novembre 66, San Casciano in Val di Pesa, 50026, Italy"
    cuisine="Italian Contemporary, Tuscan"
    priceRange="€€"
    phoneNumber="+39055820163"
    website="https://nelloristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Michele, in the kitchen, and pastry chef Chiara, who also works front of house, have renovated this historic local address and transformed it into a restaurant offering a modern interpretation of Tuscan cuisine. On the varied and intriguing menu, you’ll find dishes such as the intense and highly technical ravioli filled with Parmesan cream (made with milk from Reggiana “red cows”) with chanterelle mushrooms and onions. The concise wine list focuses on nearby Chiantis but also includes bottles from elsewhere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20IV%20Novembre%2066%2C%20San%20Casciano%20in%20Val%20di%20Pesa%2C%2050026%2C%20Italy"
    pageTitle="Nello"
  />
);

export default Nello;
