...
const LaLocandiera = () => (
  <RestaurantPage
    restaurantName="La Locandiera"
    address="piazza Vittorio Veneto 3, Carona, 24010, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+39034577044"
    website="https://guide.michelin.com/en/lombardia/carona/restaurant/la-locandiera"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the bottom of a steep valley, a rustic restaurant that offers fine cuisine, much appreciated in the area, with a great preference for local products. Old traditional recipes are revisited with a personal touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Vittorio%20Veneto%203%2C%20Carona%2C%2024010%2C%20Italy"
    pageTitle="La Locandiera"
  />
);

export default LaLocandiera;
