...
const PierreAlexis1877 = () => (
  <RestaurantPage
    restaurantName="Pierre Alexis 1877"
    address="via Marconi 50/a, Courmayeur, 11013, Italy"
    cuisine="Traditional Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390165846700"
    website="http://www.pierrealexiscourmayeur.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%2050%2Fa%2C%20Courmayeur%2C%2011013%2C%20Italy"
    pageTitle="Pierre Alexis 1877"
  />
);

export default PierreAlexis1877;
