...
const EnotecaLarmadillo = () => (
  <RestaurantPage
    restaurantName="Enoteca L'Armadillo"
    address="strada La Palud 27, Courmayeur, 11013, Italy"
    cuisine="Fusion, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393409610226"
    website="https://guide.michelin.com/en/valle-d-aosta/courmayeur/restaurant/l-armadillo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the district of La Palud at the foot of Mont Blanc, this small wine bar serves interesting cuisine created by a talented Japanese chef who adds his own personal twist to the valley’s top-quality ingredients. Dishes include the occasional fusion option, such as capon salad with yuzu, puntarelle and black garlic, while wine is chosen directly from the shelves in the intimate dining room. Booking is recommended, especially in high season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20La%20Palud%2027%2C%20Courmayeur%2C%2011013%2C%20Italy"
    pageTitle="Enoteca L'Armadillo"
  />
);

export default EnotecaLarmadillo;
