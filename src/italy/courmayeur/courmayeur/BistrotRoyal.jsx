...
const BistrotRoyal = () => (
  <RestaurantPage
    restaurantName="Bistrot Royal"
    address="via Roma 87, Courmayeur, 11013, Italy"
    cuisine="Alpine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+390165831611"
    website="https://www.hotelroyalegolf.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the elegant setting of the Grand Hotel Royal e Golf, this restaurant with its floor-to-ceiling windows boasts superb views of the Mont Blanc chain and the Dente del Gigante. The restaurant serves some of the most interesting cuisine in this area – creative rather than local in style, refined and technically elaborate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2087%2C%20Courmayeur%2C%2011013%2C%20Italy"
    pageTitle="Bistrot Royal"
  />
);

export default BistrotRoyal;
