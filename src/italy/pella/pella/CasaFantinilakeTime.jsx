...
const CasaFantinilakeTime = () => (
  <RestaurantPage
    restaurantName="Casa Fantini/Lake Time"
    address="piazza Motta, Pella, 28010, Italy"
    cuisine="Country cooking, Contemporary"
    priceRange="€€€"
    phoneNumber="+390322969893"
    website="https://www.casafantinilaketime.com/it/il-ristorante.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the lakefront in the attractive town of Pella, this modern and welcoming restaurant occupies an old building which has been restored and furnished with a stylish and harmonious decor. Offering simpler options at lunchtime, the restaurant serves traditional cuisine reinterpreted and presented with a contemporary flavour. A lounge, garden, swimming pool and 11 guestrooms add to the exclusive appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Motta%2C%20Pella%2C%2028010%2C%20Italy"
    pageTitle="Casa Fantini/Lake Time"
  />
);

export default CasaFantinilakeTime;
