...
const Fiorfiore = () => (
  <RestaurantPage
    restaurantName="Fiorfiore"
    address="località Chioano, Todi, 06059, Italy"
    cuisine="Umbrian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390758942416"
    website="https://ristorantefiorfiore.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant occupying an elegant villa in a panoramic location with views of Todi and the surrounding countryside serves modern cuisine with its roots in Umbrian tradition. The extra-virgin olive oil comes from directly from the estate, as does some of the wine; there’s also an interesting selection of champagnes. Our inspector recommends the roast suckling pig accompanied by rosemary-flavoured potatoes, as well as the hazelnut cream, yoghurt sorbet and warm chocolate foam dessert. Quiet, comfortable guestrooms complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Chioano%2C%20Todi%2C%2006059%2C%20Italy"
    pageTitle="Fiorfiore"
  />
);

export default Fiorfiore;
