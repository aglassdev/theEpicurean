...
const LaTradizioneCucinaCasalinga = () => (
  <RestaurantPage
    restaurantName="La Tradizione - Cucina Casalinga"
    address="via Imbriani 11/13, Minervino Murge, 76013, Italy"
    cuisine="Apulian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390883691690"
    website="https://guide.michelin.com/en/puglia/minervino-murge/restaurant/la-tradizione-cucina-casalinga"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A corner of traditional Apulia to be experienced in a trattoria in the centre, in a typical and pleasantly homely atmosphere. The dishes are listed verbatim, not to be missed are the series of starters, but also the characteristic fresh pastas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Imbriani%2011%2F13%2C%20Minervino%20Murge%2C%2076013%2C%20Italy"
    pageTitle="La Tradizione - Cucina Casalinga"
  />
);

export default LaTradizioneCucinaCasalinga;
