...
const QuattroSensi = () => (
  <RestaurantPage
    restaurantName="Quattro Sensi"
    address="via del Colle 38, Brufa, 06089, Italy"
    cuisine="Umbrian, Contemporary"
    priceRange="€€€"
    phoneNumber="+390759883"
    website="https://www.borgobrufa.it/ristorazione/ristorante-i-quattro-sensi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched on a hill just a few kilometres from Torgiano, Quattro Sensi boasts a veranda with views of Perugia, which is perfect for a quick lunch, and an elegant dining room in which you can enjoy regional dishes such as pappardelle egg pasta with a Cinturello Orvietano pork ragù with orange and fennel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Colle%2038%2C%20Brufa%2C%2006089%2C%20Italy"
    pageTitle="Quattro Sensi"
  />
);

export default QuattroSensi;
