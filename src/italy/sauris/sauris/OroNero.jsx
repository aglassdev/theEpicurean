...
const OroNero = () => (
  <RestaurantPage
    restaurantName="Oro Nero"
    address="Località La Maina 10, Sauris, 33020, Italy"
    cuisine="Italian Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+390433786230"
    website="https://ristoranteoronero.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Local ingredients such as Sauris trout, Malga cheese, eggs and herbs feature on the menu at this charming restaurant with spectacular views of the surrounding peaks. In a modern dining room where the colours black and gold dominate, Andrea serves delicious creative recipes such as his signature dish of pigeon cooked two different ways with a sweet and sour bitter cherry, peanut and shallot sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20La%20Maina%2010%2C%20Sauris%2C%2033020%2C%20Italy"
    pageTitle="Oro Nero"
  />
);

export default OroNero;
