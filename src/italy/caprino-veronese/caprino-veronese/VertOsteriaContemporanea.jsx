...
const VertOsteriaContemporanea = () => (
  <RestaurantPage
    restaurantName="Vert Osteria Contemporanea"
    address="Località Bogonza, Caprino Veronese, 37013, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+393277709794"
    website="https://vertosteria.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a rustic building on the green slopes facing the lake, this restaurant has a welcoming feel with its stone and wood decor and large windows looking out at a beautiful, shaded garden where meals are served in fine weather. Delicious Italian cuisine takes pride of place on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Bogonza%2C%20Caprino%20Veronese%2C%2037013%2C%20Italy"
    pageTitle="Vert Osteria Contemporanea"
  />
);

export default VertOsteriaContemporanea;
