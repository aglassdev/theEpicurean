...
const Mistral = () => (
  <RestaurantPage
    restaurantName="Mistral"
    address="via Teresio Olivelli 1, Bellagio, 22021, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+39031956435"
    website="https://www.villaserbelloni.com/it/mistral-restaurant.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated at the tip of Bellagio’s promontory where the two branches of the lake meet, this villa occupies a superb panoramic location, with its restaurant housed in a covered veranda boasting delightful views of the opposite shore, its little villages and exclusive residences. The atmosphere here is reminiscent of a grand hotel, with background piano music in the evening and guests from all around the world. The moderately creative cuisine offers a choice of Italian dishes alongside more international options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Teresio%20Olivelli%201%2C%20Bellagio%2C%2022021%2C%20Italy"
    pageTitle="Mistral"
  />
);
