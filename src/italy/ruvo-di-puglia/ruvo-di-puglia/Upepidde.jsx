...
const Upepidde = () => (
  <RestaurantPage
    restaurantName="Upepidde"
    address="vico Sant'Agnese 2, angolo corso Cavour, Ruvo di Puglia, 70037, Italy"
    cuisine="Apulian, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+390803613879"
    website="https://www.upepidde.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Quintessentially Apulian restaurant, beginning with its ambiance: a sequence of rooms excavated within the rock of ancient Aragonese walls. The cuisine is equally inspired by local traditions, encompassing cardoncelli mushrooms, burnt wheat orecchiette, and cheeses from the Murgia hills, to name a few, with almost exclusively meat dishes along with vegetarian options and delightful sweets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vico%20Sant'Agnese%202%2C%20angolo%20corso%20Cavour%2C%20Ruvo%20di%20Puglia%2C%2070037%2C%20Italy"
    pageTitle="Upepidde"
  />
);

export default Upepidde;
