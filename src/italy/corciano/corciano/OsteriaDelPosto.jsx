...
const OsteriaDelPosto = () => (
  <RestaurantPage
    restaurantName="Osteria del Posto"
    address="via Calderini 15, loc. Chiugiana, Corciano, 06073, Italy"
    cuisine="Umbrian, Contemporary"
    priceRange="€€"
    phoneNumber="+390755173778"
    website="https://osteriadelposto.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed within an ancient mill in the village of Chiugiana, a small hamlet of Corciano, the osteria offers contemporary cuisine deeply rooted in the local area. Ingredients are carefully selected, and the wine list tells the stories of small producers, both local and national, with a special focus on artisanal and natural wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Calderini%2015%2C%20loc.%20Chiugiana%2C%20Corciano%2C%2006073%2C%20Italy"
    pageTitle="Osteria del Posto"
  />
);

export default OsteriaDelPosto;
