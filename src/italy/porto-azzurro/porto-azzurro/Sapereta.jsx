...
const Sapereta = () => (
  <RestaurantPage
    restaurantName="Sapereta"
    address="via Provinciale Ovest 73, località Mola, Porto Azzurro, 57036, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39056595033"
    website="https://www.ristorantesapereta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a historic winery, this simple, rustic - style restaurant is surrounded by a well - kept garden where farmyard animals roam freely. Don’t be fooled by appearances, however – the cuisine here is modern, with meat dishes taking pride of place on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Provinciale%20Ovest%2073%2C%20localit%C3%A0%20Mola%2C%20Porto%20Azzurro%2C%2057036%2C%20Italy"
    pageTitle="Sapereta"
  />
);

export default Sapereta;
