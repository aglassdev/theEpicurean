...
const LaCascina1899 = () => (
  <RestaurantPage
    restaurantName="La Cascina 1899"
    address="strada statale 106, Rocella Jonica, 89047, Italy"
    cuisine="Calabrian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390964866675"
    website="https://www.ristorantelacascina1899.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the main road running alongside the sea, this pleasant restaurant with a large car park occupies a late-19C building that has been transformed into an attractive, rustic-style eatery with plenty of outdoor areas and air-conditioned rooms with exposed-stone walls and wooden ceilings that provide welcome respite from the heat of summer. It’s no surprise that fish and seafood take pride of place on the menu, although meat dishes also feature. The shop next door sells regional specialities, some produced by the restaurant itself, including the famous local bergamot citrus fruit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20statale%20106%2C%20Rocella%20Jonica%2C%2089047%2C%20Italy"
    pageTitle="La Cascina 1899"
  />
);

export default LaCascina1899;
