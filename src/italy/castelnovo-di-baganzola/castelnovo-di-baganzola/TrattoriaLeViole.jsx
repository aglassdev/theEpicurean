...
const TrattoriaLeViole = () => (
  <RestaurantPage
    restaurantName="Trattoria Le Viole"
    address="strada nuova di Castelnuovo 60/a, Castelnovo di Baganzola, 43126, Italy"
    cuisine="Emilian, Modern Cuisine"
    priceRange="€"
    phoneNumber="+390521601000"
    website="https://www.trattorialevioleparma.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Regionally based cuisine with the occasional hint of creativity and a good choice of à la carte dishes are the highlights at this friendly restaurant on the outskirts of Parma. An authentic, genuine welcome, with an attractive lounge near the entrance and the warm ambience of a private home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20nuova%20di%20Castelnuovo%2060%2Fa%2C%20Castelnovo%20di%20Baganzola%2C%2043126%2C%20Italy"
    pageTitle="Trattoria Le Viole"
  />
);

export default TrattoriaLeViole;
