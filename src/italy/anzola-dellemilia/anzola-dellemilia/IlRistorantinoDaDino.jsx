...
const IlRistorantinoDaDino = () => (
  <RestaurantPage
    restaurantName="Il Ristorantino - Da Dino"
    address="via XXV Aprile 11, Anzola dell'Emilia, 40011, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39051732364"
    website="https://www.ristorantinodadino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hidden among the houses, Ristorantino da Dino is a gem with a family feel, loved by locals and discovered by passersby. The menu is broad and varied, featuring sea, land, and garden offerings. Don't miss the Zuppa Inglese – it's a dive into the authentic flavors of the past...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXV%20Aprile%2011%2C%20Anzola%20dell'Emilia%2C%2040011%2C%20Italy"
    pageTitle="Il Ristorantino - Da Dino"
  />
);

export default IlRistorantinoDaDino;
