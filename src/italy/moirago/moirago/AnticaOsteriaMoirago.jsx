...
const AnticaOsteriaMoirago = () => (
  <RestaurantPage
    restaurantName="Antica Osteria Moirago"
    address="via Pavese 4, Moirago, 20058, Italy"
    cuisine="Italian Contemporary, Seafood"
    priceRange="€€€"
    phoneNumber="+390290002174"
    website="https://anticaosteriamoirago.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old monastery in Moirago, overlooking the Naviglio Pavese canal, was founded in 1250 and converted into an inn as early as 1478. Centuries may have passed, but the tradition of hospitality continues in the building’s enclosed painted portico, as well as in its two warm and atmospheric dining rooms. The chef’s Puglian origins explain the abundant use of vegetables and raw fish dishes, while in winter the cuisine takes on a more northern Italian flavour. Good selection of wines by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pavese%204%2C%20Moirago%2C%2020058%2C%20Italy"
    pageTitle="Antica Osteria Moirago"
  />
);

export default AnticaOsteriaMoirago;
