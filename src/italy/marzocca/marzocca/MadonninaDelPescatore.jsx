...
const MadonninaDelPescatore = () => (
  <RestaurantPage
    restaurantName="Madonnina del Pescatore"
    address="via Lungomare Italia 11, Marzocca, 60019, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+39071698267"
    website="https://www.morenocedroni.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It’s now forty years since the Madonnina opened in 1984, yet chef Moreno Cedroni has not lost the creative touch that has resulted in him becoming one of the most influential chefs of his generation. Year after year, eating at La Madonnina remains a novelty: the menu succeeds like no other in reflecting past traditions and future culinary trends, especially in its fish and seafood dishes, and new dishes are added regularly, often having been researched in the laboratory next to the restaurant using specialised food technology. There are two tasting menus available: “Ricordi d'infanzia & Mariella 1984-2024” featuring chef Cedroni’s great classic dishes, and “Luca e Moreno... Il Viaggio di Marco Polo” which includes dishes with an Asian and Middle Eastern influence. The chef’s wife Mariella ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lungomare%20Italia%2011%2C%20Marzocca%2C%2060019%2C%20Italy"
    pageTitle="Madonnina del Pescatore"
  />
);

export default MadonninaDelPescatore;
