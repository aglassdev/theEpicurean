...
const AzzigheOsteriaAMet = () => (
  <RestaurantPage
    restaurantName="Azzighe • Osteria a metà"
    address="Scali del Pontino 19, Livorno, 57122, Italy"
    cuisine="Tuscan, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393490662971"
    website="https://www.azzighe.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated near the canals of Livorno’s historic centre, this restaurant has just one convivial and informal dining room. Here, the focus is on meat and fish dishes influenced by Livorno and further afield in Tuscany, as well as a few more creative options. The “cacciucchino” cappelletti pasta dish is inspired by the famous local fish soup, while the beef “francesina” main course is worth a special mention...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Scali%20del%20Pontino%2019%2C%20Livorno%2C%2057122%2C%20Italy"
    pageTitle="Azzighe • Osteria a metà"
  />
);

export default AzzigheOsteriaAMet;
