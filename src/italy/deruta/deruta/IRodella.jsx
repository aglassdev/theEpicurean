...
const IRodella = () => (
  <RestaurantPage
    restaurantName="I Rodella"
    address="strada esterna vicinale della Rocca 2, Deruta, 06053, Italy"
    cuisine="Innovative, Umbrian"
    priceRange="€€"
    phoneNumber="+390759724314"
    website="https://www.ristoranteirodella.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This complex, which also includes two junior suites and seven guestrooms, dates back to the early 17C and was commissioned by the Church as a stopping off point for travellers on their way to Rome. For many years now, the restaurant has been run by a Venetian family with twin brothers (both highly experienced) working in the kitchen and a third brother, a sommelier, at the helm in the dining room. The cuisine is inspired by local and Venetian traditions, with a modern approach to the combinations of flavours (including home-grown herbs) and to the presentation of its delicious, generous dishes. We recommend that you do as we did and follow Samuele’s advice when making your choice from the dishes prepared by Stefano and Andrea with great skill and passion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20esterna%20vicinale%20della%20Rocca%202%2C%20Deruta%2C%2006053%2C%20Italy"
    pageTitle="I Rodella"
  />
);

export default IRodella;
