...
const LocandaToscano = () => (
  <RestaurantPage
    restaurantName="Locanda Toscano"
    address="via Benedetto Musolino 22, Pizzo, 89812, Italy"
    cuisine="Contemporary, Seafood"
    priceRange="€€"
    phoneNumber="+390963531089"
    website="http://ristorantelocandatoscano.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant with delightful views seems to be perched on the cliff, whereas in fact it’s situated just a stone’s throw from the town’s main piazza and Murat castle. Although inspired by Calabria’s maritime traditions, the contemporary-style cuisine also includes a few meat dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Benedetto%20Musolino%2022%2C%20Pizzo%2C%2089812%2C%20Italy"
    pageTitle="Locanda Toscano"
  />
);

export default LocandaToscano;
