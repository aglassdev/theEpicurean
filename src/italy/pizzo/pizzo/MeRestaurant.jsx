...
const MeRestaurant = () => (
  <RestaurantPage
    restaurantName="ME Restaurant"
    address="SP per Vibo Marina, località Ponte di Ferro, Pizzo, 89812, Italy"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390963534532"
    website="https://www.merestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying an old restored farmhouse, this large, spacious and attractive restaurant is run by a couple who offer their guests Mediterranean cuisine which is full of flavour. The focus here is on the traditions of Calabria, but the chef’s native region of Campania is also evident in many of the dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SP%20per%20Vibo%20Marina%2C%20localit%C3%A0%20Ponte%20di%20Ferro%2C%20Pizzo%2C%2089812%2C%20Italy"
    pageTitle="ME Restaurant"
  />
);

export default MeRestaurant;
