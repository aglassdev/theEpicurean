...
const HosteriaToblino = () => (
  <RestaurantPage
    restaurantName="Hosteria Toblino"
    address="via Garda 3, Sarche di Madruzzo, 38070, Italy"
    cuisine="Country cooking, Contemporary"
    priceRange="€€"
    phoneNumber="+390461561113"
    website="https://www.hosteriatoblino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The most welcoming section of the extensive Cantina Toblino complex is home to the large, contemporary and minimalist-style Hosteria. Here, a young chef serves simple reinterpretations of regional dishes with a focus on zero-mile produce with the occasional yet astute use of ingredients from further afield...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Garda%203%2C%20Sarche%20di%20Madruzzo%2C%2038070%2C%20Italy"
    pageTitle="Hosteria Toblino"
  />
);

export default HosteriaToblino;
