...
const EnotecaDiCanelliCasaCrippa = () => (
  <RestaurantPage
    restaurantName="Enoteca di Canelli - Casa Crippa"
    address="corso Libertà 65/a, Canelli, 14053, Italy"
    cuisine="Modern Cuisine, Piedmontese"
    priceRange="€€"
    phoneNumber="+390141832182"
    website="https://www.casacrippa.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a late-19C palazzo, in what was a historic wine cellar right up to the late 1960s, this family-run restaurant serves carefully presented, regional cuisine with a lightly creative and contemporary twist. A good example is the “carne cruda alla monferrina” (a kind of beef tartare) served with a Parmesan cream and hazelnuts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Libert%C3%A0%2065%2Fa%2C%20Canelli%2C%2014053%2C%20Italy"
    pageTitle="Enoteca di Canelli - Casa Crippa"
  />
);

export default EnotecaDiCanelliCasaCrippa;
