...
const SanMarco = () => (
  <RestaurantPage
    restaurantName="San Marco"
    address="via Alba 136, Canelli, 14053, Italy"
    cuisine="Piedmontese, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390141823544"
    website="https://www.sanmarcoristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established restaurant in the Asti region has been open for over 70 years and is still renowned for its regional cuisine served in a classic-style dining room. Dishes include cardoons with Raschera cheese fondue, the famous agnolottini del plin (a type of ravioli), and the Piedmontese bunet which is part of a trio of desserts that includes hazelnut tart and zabaglione with Canelli muscat wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Alba%20136%2C%20Canelli%2C%2014053%2C%20Italy"
    pageTitle="San Marco"
  />
);

export default SanMarco;
