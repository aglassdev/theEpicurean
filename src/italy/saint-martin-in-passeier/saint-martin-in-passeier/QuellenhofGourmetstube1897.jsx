...
const QuellenhofGourmetstube1897 = () => (
  <RestaurantPage
    restaurantName="Quellenhof Gourmetstube 1897"
    address="via Passiria 47, Saint Martin in Passeier, 39010, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390473645474"
    website="https://www.quellenhof-gourmetstube1897.it/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A young chef and a brilliant maître-d’ work together at this restaurant, where the cuisine is full of character and has its roots firmly anchored in the region. The menu allows guests to choose from four to six courses, all prepared using local ingredients such as lamb raised on a nearby farm served with parsnips and a refined jus, or reinterpreted dumplings served with morel mushrooms and spring peas. Matteo oversees the wine list, guiding guests on a unique journey through Italian and international labels collected over the past twenty years, all offering excellent value for money. Three impressive wine cellars can be visited by guests, while fine wines and historic vintages (especially from Tuscany and Bordeaux) are evident on the wine list. Excellent bread and dessert options complete ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Passiria%2047%2C%20Saint%20Martin%20in%20Passeier%2C%2039010%2C%20Italy"
    pageTitle="Quellenhof Gourmetstube 1897"
  />
);

export default QuellenhofGourmetstube1897;
