...
const CastelFlavonHaselburg = () => (
  <RestaurantPage
    restaurantName="Castel Flavon - Haselburg"
    address="via Castel Flavon 48, Bolzano, 39100, Italy"
    cuisine="Mediterranean Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+390471402130"
    website="http://www.haselburg.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Leave the city behind and, after a short climb through a few hairpin turns, you’ll arrive at an enchanting medieval castle with a spectacular panoramic terrace. Here, the talented Michele Iaconeta heads the kitchen. A native of Puglia, his cooking captivates, whether it strikes a more Mediterranean chord or explores more northern dishes that sometimes reinterpret local traditions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castel%20Flavon%2048%2C%20Bolzano%2C%2039100%2C%20Italy"
    pageTitle="Castel Flavon - Haselburg"
  />
);

export default CastelFlavonHaselburg;
