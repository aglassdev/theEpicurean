...
const OsteriaArdenga = () => (
  <RestaurantPage
    restaurantName="Osteria Ardenga"
    address="via Maestra 6, Diolo, 43019, Italy"
    cuisine="Emilian, Country cooking"
    priceRange="€"
    phoneNumber="+390524599337"
    website="https://osteriardenga.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An authentic trattoria which is a joy to visit, where time seems to have stood still for decades. Situated on the border between two provinces, the restaurant focuses on specialities from Parma, many of which are made from home - grown produce. Homemade pickles and chutneys are also sold here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Maestra%206%2C%20Diolo%2C%2043019%2C%20Italy"
    pageTitle="Osteria Ardenga"
  />
);

export default OsteriaArdenga;
