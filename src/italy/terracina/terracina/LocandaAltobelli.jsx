...
const LocandaAltobelli = () => (
  <RestaurantPage
    restaurantName="Locanda Altobelli"
    address="via Santissima Annunziata 121, Terracina, 04019, Italy"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+393468256622"
    website="https://guide.michelin.com/en/lazio/terracina/restaurant/locanda-altobelli"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant little restaurant that differs from the many fish options in town with its traditional regional meat-based cuisine. There’s a real alchemy here between the young owner who is passionate about wine and the talented chef who boasts an impressive CV. Carefully chosen ingredients sourced directly from small local producers are the basis for its exciting, delicious dishes, while the wine list features some interesting organic wines. Small outdoor space for alfresco dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santissima%20Annunziata%20121%2C%20Terracina%2C%2004019%2C%20Italy"
    pageTitle="Locanda Altobelli"
  />
);

export default LocandaAltobelli;
