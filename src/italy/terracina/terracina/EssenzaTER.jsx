...
const EssenzaTER = () => (
  <RestaurantPage
    ...
    address="via Cavour 38, Terracina, 04019, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+390773369762"
    website="https://www.essenza.co/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Simone Nardini’s Michelin star continues to shine in Terracina in this elegant restaurant which is run by young, well-trained staff. The chef serves exciting, creative cuisine, with a careful preparation and presentation of dishes that will appeal to the eyes and tastebuds alike. There’s also an impressive wine list featuring around 800 different labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cavour%2038%2C%20Terracina%2C%2004019%2C%20Italy"
    pageTitle="Essenza"
  />
);

export default EssenzaTER;
