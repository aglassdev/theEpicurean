...
const OsteriaLaPimpinella = () => (
  <RestaurantPage
    restaurantName="Osteria La Pimpinella"
    address="Via San Rocco 70, Bra, 12042, Italy"
    cuisine="Contemporary, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+393335259801"
    website="https://www.osterialapimpinella.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20San%20Rocco%2070%2C%20Bra%2C%2012042%2C%20Italy"
    pageTitle="Osteria La Pimpinella"
  />
);

export default OsteriaLaPimpinella;
