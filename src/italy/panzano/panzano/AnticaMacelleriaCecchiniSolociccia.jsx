...
const AnticaMacelleriaCecchiniSolociccia = () => (
  <RestaurantPage
    restaurantName="Antica Macelleria Cecchini - Solociccia"
    address="via Chiantigiana 5, Panzano, 50022, Italy"
    cuisine="Meats and Grills"
    priceRange="€€"
    phoneNumber="+39055852020"
    website="https://www.dariocecchini.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the most famous butchers in Italy has now turned his hand to cooking. At two locations, Solociccia or Officina della Bistecca, the menu is unique and served at a specific time with a meat proposal or a vegetarian option. Solociccia is only open for lunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Chiantigiana%205%2C%20Panzano%2C%2050022%2C%20Italy"
    pageTitle="Antica Macelleria Cecchini - Solociccia"
  />
);

export default AnticaMacelleriaCecchiniSolociccia;
