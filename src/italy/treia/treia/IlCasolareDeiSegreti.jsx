...
const IlCasolareDeiSegreti = () => (
  <RestaurantPage
    restaurantName="Il Casolare dei Segreti"
    address="Contrada San Lorenzo 28, Treia, 62010, Italy"
    cuisine="Cuisine from the Marches, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390733216441"
    website="https://www.casolaredeisegreti.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A family - run restaurant with young, enthusiastic staff. Four rustic dining rooms provide the setting to enjoy delicious regional dishes, such as the ever - popular Marchigiana veal steak...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Contrada%20San%20Lorenzo%2028%2C%20Treia%2C%2062010%2C%20Italy"
    pageTitle="Il Casolare dei Segreti"
  />
);

export default IlCasolareDeiSegreti;
