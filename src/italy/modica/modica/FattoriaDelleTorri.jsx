...
const FattoriaDelleTorri = () => (
  <RestaurantPage
    restaurantName="Fattoria delle Torri"
    address="vico Napolitano 14, Modica, 97015, Italy"
    cuisine="Sicilian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390932751286"
    website="https://fattoriadelletorri.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small slice of paradise in the historic centre of Modica, where the daughters of owner-chef Peppe Barone continue the family culinary tradition while adding their youthful influence to the innovative and yet traditional cuisine served here. In fine weather, dine among lemon trees on the attractive outdoor terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vico%20Napolitano%2014%2C%20Modica%2C%2097015%2C%20Italy"
    pageTitle="Fattoria delle Torri"
  />
);

export default FattoriaDelleTorri;
