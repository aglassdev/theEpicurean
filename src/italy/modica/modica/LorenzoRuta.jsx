...
const LorenzoRuta = () => (
  <RestaurantPage
    restaurantName="Lorenzo Ruta"
    address="C.da Zimmardo SP45 km5, RG, Modica, 97015, Italy"
    cuisine="Contemporary, Sicilian"
    priceRange="€€€"
    phoneNumber="+393384981656"
    website="https://lorenzorutaristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a new, low-rise resort in a secluded location, this attractive, contemporary-style restaurant is run by a local chef with plenty of experience behind him, together with the women of his family, namely his wife and sommelier sister-in-law. The extensive selection here includes various tasting menus plus an à la carte, all of which showcase meat and fish dishes featuring imaginative combinations. The impressive wine list includes labels from outside Sicily and Italy, with a strong focus on French wines and champagnes in particular...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.da%20Zimmardo%20SP45%20km5%2C%20RG%2C%20Modica%2C%2097015%2C%20Italy"
    pageTitle="Lorenzo Ruta"
  />
);

export default LorenzoRuta;
