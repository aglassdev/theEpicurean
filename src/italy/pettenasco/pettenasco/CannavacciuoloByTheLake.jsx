...
const CannavacciuoloByTheLake = () => (
  <RestaurantPage
    restaurantName="Cannavacciuolo by the Lake"
    address="Via Legro 33, Pettenasco, 28028, Italy"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390323212121"
    website="https://laquabythelake.it/resort-sul-lago-d-orta-pettenasco-novara/ristorante-sul-lago-bistrot-cannavacciuolo/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated within the elegant Laqua by the Lake boutique hotel (part of the Cannavacciuolo “galaxy”), this restaurant boasts fine lake views to accompany the imaginative Mediterranean cuisine served by resident chef Giovanni Bertone. There are three tasting menus (the lake-inspired “Brezza”; the Neapolitan-influenced “Acquolina”, and a totally vegetarian menu), plus an à la carte option for anyone who wishes to choose their own individual dishes. Our inspector particularly recommends the amberjack, fennel and roe dish, as well as Antonino’s mouthwatering babà dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Legro%2033%2C%20Pettenasco%2C%2028028%2C%20Italy"
    pageTitle="Cannavacciuolo by the Lake"
  />
);

export default CannavacciuoloByTheLake;
