...
const Vignamare = () => (
  <RestaurantPage
    restaurantName="Vignamare"
    address="strada Castello, 20 - Colla Micheri, Andora, 17051, Italy"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€€"
    phoneNumber="+393517135050"
    website="https://www.peqagri.it/pages/ristorante-vignamare"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="From Andora, one climbs up the hill along a series of hairpin bends and then, having left the car in the car park, the path continues to the restaurant. Vineyards facing the sea, olive groves and maritime pines in a lush corner of Liguria form the backdrop to Vignamare, created by recovering an abandoned and unused 1970s cistern. In fine weather there is a wonderful panoramic terrace, otherwise a modern wood-panelled dining room. The talented chef Alessandro Di Giacomo, originally from Caserta, has - recently - taken the reins of the kitchen, offering two tasting courses of 7 and 9 courses, not forgetting a totally “green” one. The technique is refined and the elaborations are very Mediterranean, gathering impeccable products and raw materials from the Ligurian land (most of them coming fr..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Castello%2C%2020%20-%20Colla%20Micheri%2C%20Andora%2C%2017051%2C%20Italy"
    pageTitle="Vignamare"
  />
);

export default Vignamare;
