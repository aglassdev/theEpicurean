...
const Piacentino = () => (
  <RestaurantPage
    restaurantName="Piacentino"
    address="piazza San Francesco 19, Bobbio, 29022, Italy"
    cuisine="Emilian"
    priceRange="€€"
    phoneNumber="+390523936266"
    website="https://www.hotelpiacentino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Restaurant with pension near the old town, where you can enjoy Piacentine dishes served outdoors in nice weather and in the airy indoors dining hall during the colder months. The rooms are in two styles, one with wrought iron beds and Arte Povera furniture, the other being more modern...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Francesco%2019%2C%20Bobbio%2C%2029022%2C%20Italy"
    pageTitle="Piacentino"
  />
);

export default Piacentino;
