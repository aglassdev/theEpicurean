...
const Kuppelrain = () => (
  <RestaurantPage
    restaurantName="Kuppelrain"
    address="via Stazione 16, località Maragno, Castelbello, 39020, Italy"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390473624103"
    website="https://www.kuppelrain.com/it/ristorante"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Stazione%2016%2C%20localit%C3%A0%20Maragno%2C%20Castelbello%2C%2039020%2C%20Italy"
    pageTitle="Kuppelrain"
  />
);

export default Kuppelrain;
