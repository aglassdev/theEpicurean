...
const BistrotDonatella = () => (
  <RestaurantPage
    restaurantName="Bistrot Donatella"
    address="piazza Umberto I 1, Oviglio, 15026, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390131776907"
    website="https://www.donatellabistrot.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Umberto%20I%201%2C%20Oviglio%2C%2015026%2C%20Italy"
    pageTitle="Bistrot Donatella"
  />
);

export default BistrotDonatella;
