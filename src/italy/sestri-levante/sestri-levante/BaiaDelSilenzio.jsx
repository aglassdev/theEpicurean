...
const BaiaDelSilenzio = () => (
  <RestaurantPage
    restaurantName="Baia del Silenzio"
    address="via Cappellini 9, Sestri Levante, 16039, Italy"
    cuisine="Italian Contemporary, Ligurian"
    priceRange="€€€"
    phoneNumber="+390185480855"
    website="https://www.miramaresestrilevante.com/it/ristorante-baia-del-silenzio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a beautiful position inside the bay, the restaurant serves dishes with a contemporary twist that enhance the local products and the good ingredients. The offer is divided between the bistrot for lunch, the gourmet dinner and the wine bar. In summer you can dine alfresco on the outdoor terrace or directly on the beach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cappellini%209%2C%20Sestri%20Levante%2C%2016039%2C%20Italy"
    pageTitle="Baia del Silenzio"
  />
);

export default BaiaDelSilenzio;
