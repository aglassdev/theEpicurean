...
const BalinSestriLevante = () => (
  <RestaurantPage
    restaurantName="Balin Sestri Levante"
    address="viale Rimembranza 33, Sestri Levante, 16039, Italy"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+393499472695"
    website="https://balin.superbexperience.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An intimate restaurant on the seafront with a tiny dining room and small veranda, and a young, contemporary ambience. The Mediterranean-style cuisine is modern and creative with a focus on Ligurian ingredients to which the chef adds the occasional Asian twist, often in the sauces. Booking ahead is recommended given the limited number of tables here!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Rimembranza%2033%2C%20Sestri%20Levante%2C%2016039%2C%20Italy"
    pageTitle="Balin Sestri Levante"
  />
);

export default BalinSestriLevante;
