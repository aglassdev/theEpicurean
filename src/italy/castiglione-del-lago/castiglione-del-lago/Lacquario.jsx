...
const Lacquario = () => (
  <RestaurantPage
    restaurantName="L'Acquario"
    address="via Vittorio Emanuele 69, Castiglione del Lago, 06061, Italy"
    cuisine="Umbrian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390759652432"
    website="https://www.ristorantelacquario.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the historic center of this charming village above the lake, this spot is a great place to explore Umbrian cuisine, particularly traditional dishes featuring freshwater fish. For example? The oven-roasted medallion of porchetta-style carp, which offers a rich and succulent flavor!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vittorio%20Emanuele%2069%2C%20Castiglione%20del%20Lago%2C%2006061%2C%20Italy"
    pageTitle="L'Acquario"
  />
);

export default Lacquario;
