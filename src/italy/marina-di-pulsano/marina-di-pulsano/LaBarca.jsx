...
const LaBarca = () => (
  <RestaurantPage
    ...
    address="litoranea Salentina, Marina di Pulsano, 74026, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390995333335"
    website="https://guide.michelin.com/en/puglia/marina-di-pulsano/restaurant/la-barca"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=litoranea%20Salentina%2C%20Marina%20di%20Pulsano%2C%2074026%2C%20Italy"
    pageTitle="La Barca"
  />
);

export default LaBarca;
