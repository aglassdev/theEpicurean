...
const AllaLocanda = () => (
  <RestaurantPage
    restaurantName="Alla Locanda"
    address="strada Roma 23, Canazei, 38032, Italy"
    cuisine="Italian Contemporary, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+390462888023"
    website="https://www.locandadegliartisti.art/ristorante-alla-locanda/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A colourful, contemporary-style restaurant within the Locanda degli Artisti Art Hotel, a new address that is striking for its large art collection displayed throughout its various rooms. The cuisine here focuses on seasonal ingredients which are used to create personalised and imaginative dishes showcased on tasting menus and an à la carte. Interesting wine list, with a special emphasis on labels from the Trentino-Alto Adige region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Roma%2023%2C%20Canazei%2C%2038032%2C%20Italy"
    pageTitle="Alla Locanda"
  />
);

export default AllaLocanda;
