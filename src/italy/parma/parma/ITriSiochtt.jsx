...
const ITriSiochtt = () => (
  <RestaurantPage
    restaurantName="I Tri Siochètt"
    address="strada Farnese 74, Parma, 43125, Italy"
    cuisine="Emilian"
    priceRange="€€"
    phoneNumber="+390521929415"
    website="https://www.itrisiochett.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just beyond the city’s ring-road, this typical trattoria boasts large dining rooms with a friendly, informal atmosphere. The cuisine showcases the traditions of Parma in delicious, top-quality dishes made from predominantly local ingredients. Not-to-be-missed house specialities include torta fritta (fried pie) with mixed cured meats and zuppa inglese (a kind of trifle)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Farnese%2074%2C%20Parma%2C%2043125%2C%20Italy"
    pageTitle="I Tri Siochètt"
  />
);

export default ITriSiochtt;
