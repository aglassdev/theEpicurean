...
const OsteriaDel36 = () => (
  <RestaurantPage
    restaurantName="Osteria del 36"
    address="Strada Aurelio Saffi 26/a, Parma, 43121, Italy"
    cuisine="Emilian, Classic Cuisine"
    priceRange="€"
    phoneNumber="+390521287061"
    website="https://osteriadel36.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Strada%20Aurelio%20Saffi%2026%2Fa%2C%20Parma%2C%2043121%2C%20Italy"
    pageTitle="Osteria del 36"
  />
);

export default OsteriaDel36;
