...
const Inkiostro = () => (
  <RestaurantPage
    restaurantName="Inkiostro"
    address="via San Leonardo 124, Parma, 43122, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390521776047"
    website="https://www.ristoranteinkiostro.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Leonardo%20124%2C%20Parma%2C%2043122%2C%20Italy"
    pageTitle="Inkiostro"
  />
);

export default Inkiostro;
