...
const ParmaRotta = () => (
  <RestaurantPage
    restaurantName="Parma Rotta"
    address="strada Langhirano 158, Parma, 43124, Italy"
    cuisine="Grills"
    priceRange="€€"
    phoneNumber="+390521966738"
    website="https://www.parmarotta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, where the Parma river once broke its banks, you’ll find an attractive trattoria with pleasant dining rooms and excellent cuisine cooked over a wood and herb fire, one of the oldest culinary techniques in the world. The main courses feature meat only, with an extensive number of dishes on the menu. Among the home-made desserts, we recommend the fior di latte ice-cream, which is served with a choice of delicious sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Langhirano%20158%2C%20Parma%2C%2043124%2C%20Italy"
    pageTitle="Parma Rotta"
  />
);

export default ParmaRotta;
