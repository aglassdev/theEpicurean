...
const VitaPugliese = () => (
  <RestaurantPage
    restaurantName="Vita Pugliese"
    address="via Ospedale 15, Conversano, 70014, Italy"
    cuisine="Apulian, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+390804956929"
    website="https://www.vitapugliese.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated a stone’s throw from the castle and the cathedral in the historic centre, this restaurant boasts an attractive outdoor space in an alleyway and traditional dining rooms with barrel-vaulted ceilings. Here, enjoy authentic dishes from Puglia with the occasional creative twist and careful attention to presentation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ospedale%2015%2C%20Conversano%2C%2070014%2C%20Italy"
    pageTitle="Vita Pugliese"
  />
);

export default VitaPugliese;
