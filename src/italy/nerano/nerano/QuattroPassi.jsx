...
const QuattroPassi = () => (
  <RestaurantPage
    restaurantName="Quattro Passi"
    address="via Vespucci 13/n, Nerano, 80061, Italy"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390818081271"
    website="https://www.ristorantequattropassi.it/it/quattro-passi/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This restaurant’s 40-year-old history began with talented owner-chef Fabrizio Mellino’s grandfather, who ran a small business selling eggs from his own hens. From this, he decided to branch out and open a pizzeria “four steps” (“A Quattro Passi”) from the sea. Over time, his son Antonio transformed the pizzeria into a temple to Mediterranean cuisine, achieving two Michelin stars in the process. This compelling story continued with the arrival of Fabrizio, who had spent many years travelling (especially in France) and gaining valuable experience as a chef. The restaurant soon become legendary in southern Italy, becoming the first restaurant to achieve three Michelin stars in Campania for many years. A focus on flavour, skilful culinary techniques and top-quality ingredients results in subli..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vespucci%2013%2Fn%2C%20Nerano%2C%2080061%2C%20Italy"
    pageTitle="Quattro Passi"
  />
);

export default QuattroPassi;
