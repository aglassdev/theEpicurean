...
const Ca7 = () => (
  <RestaurantPage
    restaurantName="Ca' 7"
    address="via Cunizza da Romano 4, Bassano del Grappa, 36061, Italy"
    cuisine="Seafood, Contemporary"
    priceRange="€€€"
    phoneNumber="+390424383350"
    website="https://www.ca-sette.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a charming 18C villa, this elegant restaurant overlooks its attractive garden in a magical setting which is typical of the Veneto. The cuisine also has a regional focus, with classic recipes featuring on the menu alongside more creative dishes (fish appears more often than meat)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cunizza%20da%20Romano%204%2C%20Bassano%20del%20Grappa%2C%2036061%2C%20Italy"
    pageTitle="Ca' 7"
  />
);
