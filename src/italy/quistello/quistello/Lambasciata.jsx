...
const Lambasciata = () => (
  <RestaurantPage
    restaurantName="L'Ambasciata"
    address="piazzetta Ambasciatori del Gusto 1, Quistello, 46026, Italy"
    cuisine="Mantuan, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390376619169"
    website="https://www.ristorantelambasciata.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This has long been one of those restaurants in Italy where the opulent interior decor has no equal – at Christmas, the mirrors, rugs, silverware, chandeliers and piles of books are joined by the largest and most ornate Christmas tree that you’ll ever see in a restaurant. The cuisine created by owner-chef Matteo Ugolotti is inspired by Mantuan traditions and the restaurant’s previous famous owners, occasionally going all the way back to the Renaissance. Special mention should be made of the extraordinary chocolate salami – a dessert coated with a delicious, frothy, warm zabaglione poured from a copper pan at your table. The menu also features more modern recipes and tasting menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazzetta%20Ambasciatori%20del%20Gusto%201%2C%20Quistello%2C%2046026%2C%20Italy"
    pageTitle="L'Ambasciata"
  />
);

export default Lambasciata;
