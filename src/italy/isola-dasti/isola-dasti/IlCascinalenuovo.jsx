...
const IlCascinalenuovo = () => (
  <RestaurantPage
    restaurantName="Il Cascinalenuovo"
    address="SS 231 Asti-Alba 15, Isola d'Asti, 14057, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390141958166"
    website="https://walterferretto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having been under the watchful eye of chef Walter Ferretto for decades, Il Cascinalenuovo serves classic, seasonal cuisine which celebrates local traditions in a glorious array of Piedmontese dishes, such as the region’s famous plin (filled pasta) served in a napkin or with a roast meat sauce, tongue millefeuille and pigeon. The menu also includes more contemporary-style recipes such as the “artichoke and artichoke” dish or the lightly fried catch of the day, while the extensive and carefully curated wine list focuses largely on Piedmont. In fine weather, book a table in the attractive outdoor space overlooking the garden and swimming pool. The restaurant also offers romantic guestrooms, which are ideal for a relaxing stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SS%20231%20Asti-Alba%2015%2C%20Isola%20d'Asti%2C%2014057%2C%20Italy"
    pageTitle="Il Cascinalenuovo"
  />
);

export default IlCascinalenuovo;
