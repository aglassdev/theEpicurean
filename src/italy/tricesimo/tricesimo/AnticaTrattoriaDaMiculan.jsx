...
const AnticaTrattoriaDaMiculan = () => (
  <RestaurantPage
    restaurantName="Antica Trattoria da Miculan"
    address="piazza Libertà 16, Tricesimo, 33019, Italy"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+390432851504"
    website="https://www.trattoriamiculan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small bar busy with locals acts as a sort of “antechamber” to this typical trattoria with a summer terrace on Tricesimo’s main square. The restaurant, which boasts traditional regional features, such as the wood-burning stove known as a fogher, serves local specialities alongside a few fish dishes. In summer, there’s a tasting menu which focuses exclusively on fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Libert%C3%A0%2016%2C%20Tricesimo%2C%2033019%2C%20Italy"
    pageTitle="Antica Trattoria da Miculan"
  />
);

export default AnticaTrattoriaDaMiculan;
