...
const CasanovaPOL = () => (
  <RestaurantPage
    restaurantName="Casanova"
    address="piazza San Benedetto 5, Polignano a Mare, 70044, Italy"
    cuisine="Italian Contemporary, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+390804117431"
    website="https://www.grottapalazzese.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying the first floor of the Palazzo del Suono del Mare in the historic centre of Polignano, this luxurious restaurant with its mosaic floors and Venetian chandeliers boasts views of the sea and the coast, as well as a panoramic terrace for alfresco dining in fine weather. The cuisine focuses on the gastronomic traditions of Puglia and Italy, which are reinterpreted with exciting results...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Benedetto%205%2C%20Polignano%20a%20Mare%2C%2070044%2C%20Italy"
    pageTitle="Casanova"
  />
);

export default CasanovaPOL;
