...
const DaIumn = () => (
  <RestaurantPage
    restaurantName="Da iumén"
    address="Via Vittorio Emanuele II 26, Castelnuovo Belbo, 14043, Italy"
    cuisine="Piedmontese, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+393770289213"
    website="http://www.iumen.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 1869, five generations have reinterpreted Piedmontese tradition through a modern lens. In an elegant, intimate setting, the restaurant serves dishes that fuse history and innovation – don’t miss the potato-and-hazelnut gnocchi with robiola cream. In the warmer months, reserve a table on the panoramic terrace: the view of the town hall and the hills of Castelnuovo Belbo is pure poetry...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Vittorio%20Emanuele%20II%2026%2C%20Castelnuovo%20Belbo%2C%2014043%2C%20Italy"
    pageTitle="Da iumén"
  />
);

export default DaIumn;
