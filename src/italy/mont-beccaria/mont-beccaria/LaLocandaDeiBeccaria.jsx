...
const LaLocandaDeiBeccaria = () => (
  <RestaurantPage
    restaurantName="La Locanda dei Beccaria"
    address="via Marconi 10, Montù Beccaria, 27040, Italy"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390385262310"
    website="https://www.lalocandadeibeccaria.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the village’s historic wine cellar, this well - kept, rustic - style restaurant with typical wooden ceilings serves traditional, regional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%2010%2C%20Mont%C3%B9%20Beccaria%2C%2027040%2C%20Italy"
    pageTitle="La Locanda dei Beccaria"
  />
);

export default LaLocandaDeiBeccaria;
