...
const TrattoriaDiCampagna = () => (
  <RestaurantPage
    restaurantName="Trattoria di Campagna"
    address="Località Saint Maurice 57, Sarre, 11010, Italy"
    cuisine="Cuisine from the Aosta Valley, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390165257448"
    website="https://www.trattoriadicampagna.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This famous trattoria, now run by the third generation of the same family, serves traditional, seasonal cuisine from the Aosta valley, enhanced by the occasional imaginative and personalised touch. The new well-stocked wine cellar includes a table for a dozen guests, while sommelier Beatrice is on hand to assist guests with their choice of bottle. Excellent array of delicacies from the dessert trolley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Saint%20Maurice%2057%2C%20Sarre%2C%2011010%2C%20Italy"
    pageTitle="Trattoria di Campagna"
  />
);

export default TrattoriaDiCampagna;
