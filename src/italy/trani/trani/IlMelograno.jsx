...
const IlMelograno = () => (
  <RestaurantPage
    restaurantName="Il Melograno"
    address="via Bovio 193, Trani, 76125, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390883486966"
    website="https://www.ristoranteilmelograno.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the village centre and therefore not right by the sea, this successful, well - established restaurant is decorated in elegant contemporary style. The menu focuses on fish dishes reinterpreted with a touch of imagination...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bovio%20193%2C%20Trani%2C%2076125%2C%20Italy"
    pageTitle="Il Melograno"
  />
);

export default IlMelograno;
