...
const OsteriaFrangipane = () => (
  <RestaurantPage
    restaurantName="Osteria Frangipane"
    address="via Maraldo da Trani 5, Trani, 76125, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390883585763"
    website="https://osteriafrangipane.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owners' smiling welcome immediately puts customers at their ease, in a very pleasant contemporary tavern setting with light colours and vaulted ceilings. The Inspector recommends: codfish mantecato with walnut bread, bell pepper cream and caper mayonnaise; risotto with broad beans, hairy mussels and pecorino cheese from Foggia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Maraldo%20da%20Trani%205%2C%20Trani%2C%2076125%2C%20Italy"
    pageTitle="Osteria Frangipane"
  />
);

export default OsteriaFrangipane;
