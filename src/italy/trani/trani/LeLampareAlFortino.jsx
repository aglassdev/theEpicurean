...
const LeLampareAlFortino = () => (
  <RestaurantPage
    restaurantName="Le Lampare al Fortino"
    address="via Tiepolo, molo Sant'Antonio, Trani, 76125, Italy"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390883480308"
    website="https://www.lelamparealfortino.it/it/home/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Depending on the season, you can take a seat in two completely different but equally breathtaking settings: inside, in a former 14th century church, in the milder climate on the covered terrace overlooking the Trani harbour basin. The cuisine includes dishes with a predominantly Mediterranean character with more fish, but also some meat dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Tiepolo%2C%20molo%20Sant'Antonio%2C%20Trani%2C%2076125%2C%20Italy"
    pageTitle="Le Lampare al Fortino"
  />
);

export default LeLampareAlFortino;
