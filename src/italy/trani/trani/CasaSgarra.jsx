...
const CasaSgarra = () => (
  <RestaurantPage
    restaurantName="Casa Sgarra"
    address="lungomare C. Colombo 114, Trani, 76125, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393491867499"
    website="https://www.casasgarra.it"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A restaurant bearing the surname of three brothers who crafted this gourmet Trani address: two in the dining area, one in the kitchen. An atmosphere elegant and contemporary; the service cradles guests like family, whilst Felice Sgarra at the stove astonishes with dishes sometimes drawn from Apulian traditions, as well as those from other regions, all closely interpreted and elaborated personally. If cheese is your passion, don’t miss the remarkable trolley showcasing Piedmont and French offerings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=lungomare%20C.%20Colombo%20114%2C%20Trani%2C%2076125%2C%20Italy"
    pageTitle="Casa Sgarra"
  />
);

export default CasaSgarra;
