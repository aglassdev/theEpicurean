...
const Latelier26 = () => (
  <RestaurantPage
    restaurantName="L'Atelier 26"
    address="località Gerandin 26, Saint-Christophe, 11020, Italy"
    cuisine="French, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+3901651892015"
    website="https://www.latelier26.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a secluded location, this small gem of a restaurant boasts a skilfully restored stone dining room with a welcoming feel. The cuisine here has a clear French influence, with dishes such as snails in a Comté sauce, duck confit parmentier and apple tarte Tatin making a regular appearance on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Gerandin%2026%2C%20Saint-Christophe%2C%2011020%2C%20Italy"
    pageTitle="L'Atelier 26"
  />
);

export default Latelier26;
