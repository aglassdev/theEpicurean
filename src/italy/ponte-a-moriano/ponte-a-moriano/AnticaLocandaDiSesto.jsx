...
const AnticaLocandaDiSesto = () => (
  <RestaurantPage
    restaurantName="Antica Locanda di Sesto"
    address="via Ludovica 1660, loc. Sesto di Moriano, Ponte a Moriano, 55100, Italy"
    cuisine="Tuscan, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+390583578181"
    website="https://www.anticalocandadisesto.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The origins of this inn date back to the late 14C, making this one of the Italy’s recognised “Historic Restaurants” – and one that is still flourishing today! The dishes served here are often inspired by Tuscan peasant traditions, while the owner also runs an organic farm which produces wine, vinegar and extra-virgin olive oil. Highlights on the menu include soup with cavolo nero, spaghetti with guanciale (cured pork cheek) served on pecorino cheese, and an array of main courses barbecued on the grill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ludovica%201660%2C%20loc.%20Sesto%20di%20Moriano%2C%20Ponte%20a%20Moriano%2C%2055100%2C%20Italy"
    pageTitle="Antica Locanda di Sesto"
  />
);

export default AnticaLocandaDiSesto;
