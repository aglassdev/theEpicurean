...
const Durnwald = () => (
  <RestaurantPage
    restaurantName="Durnwald"
    address="via Nikolaus Amhof 6, località Durna in Selva, Gsies, 39030, Italy"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390474746886"
    website="https://www.restaurantdurnwald.it/it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delicious plate of Schlutzkrapfen (ravioli stuffed with spinach and ricotta) is just what’s needed after a good day’s skiing or a hike through the woods. And that’s not all – Durnwald celebrates the Alto Adige in all its glory, both in terms of its landscapes, which can be admired from the dining room windows, and its cuisine, which keeps alive the region’s authentic traditions. The owner himself is at the helm front of house – a perfect host who guides guests in their choice of food and wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nikolaus%20Amhof%206%2C%20localit%C3%A0%20Durna%20in%20Selva%2C%20Gsies%2C%2039030%2C%20Italy"
    pageTitle="Durnwald"
  />
);

export default Durnwald;
