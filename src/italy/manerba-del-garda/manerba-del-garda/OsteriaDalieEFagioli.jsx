...
const OsteriaDalieEFagioli = () => (
  <RestaurantPage
    restaurantName="Osteria Dalie e Fagioli"
    address="via Campagnola 45, Manerba del Garda, 25080, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393342233360"
    website="https://dalieefagioli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best restaurants in the region, where you’ll enjoy eclectic cuisine full of convincing flavours which is inspired by various regional traditions (especially those from Brescia, but also from elsewhere in Italy) which always hits the mark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Campagnola%2045%2C%20Manerba%20del%20Garda%2C%2025080%2C%20Italy"
    pageTitle="Osteria Dalie e Fagioli"
  />
);

export default OsteriaDalieEFagioli;
