...
const Lamberti = () => (
  <RestaurantPage
    restaurantName="Lamberti"
    address="via Gramsci 57, Alassio, 17021, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+390182642747"
    website="https://www.ristorantelamberti.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is situated just a stone’s throw from the sea in a building dating from the 1930s. It serves traditional, regional dishes made from carefully selected ingredients. Don’t miss the fish and the pesto sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gramsci%2057%2C%20Alassio%2C%2017021%2C%20Italy"
    pageTitle="Lamberti"
  />
);

export default Lamberti;
