...
const HostariaAllaTavernetta = () => (
  <RestaurantPage
    restaurantName="Hostaria alla Tavernetta"
    address="via Artico di Prampero 2, Udine, 33100, Italy"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390432501066"
    website="https://allatavernetta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fine restaurant immediately puts you at your ease thanks to a very jovial and friendly atmosphere. The lit fireplace, wood furniture with stylish linen runners and background music make for an excellent break. In addition to traditional courses such as cjarsons or the typical frico, there are more seasonal and Mediterranean fish dishes. Vegan menu available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Artico%20di%20Prampero%202%2C%20Udine%2C%2033100%2C%20Italy"
    pageTitle="Hostaria alla Tavernetta"
  />
);

export default HostariaAllaTavernetta;
