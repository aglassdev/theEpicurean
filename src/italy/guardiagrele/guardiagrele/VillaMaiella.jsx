...
const VillaMaiella = () => (
  <RestaurantPage
    restaurantName="Villa Maiella"
    address="via Sette Dolori 30, località Villa Maiella, Guardiagrele, 66016, Italy"
    cuisine="Cuisine from Abruzzo, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390871809319"
    website="https://www.villamaiella.it/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Way back in 1966, Ginetta and Arcangelo probably never dreamed for a moment that their modest tavern would become so famous. Nowadays, the Tinari family comprises mother-and-son Angela and Arcangelo in the kitchen, and Peppino and Pascal front of house, all of whom offer guests a warm welcome in their restaurant on the edge of the Parco della Maiella. Here, you’ll enjoy authentic Abruzzo dishes with the occasional surprising and creative twist on three tasting menus (chosen when you make your booking). A good choice also for beer-lovers, with over a thousand different labels available including a wide selection by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sette%20Dolori%2030%2C%20localit%C3%A0%20Villa%20Maiella%2C%20Guardiagrele%2C%2066016%2C%20Italy"
    pageTitle="Villa Maiella"
  />
);

export default VillaMaiella;
