...
const LeTreColombe = () => (
  <RestaurantPage
    restaurantName="Le Tre Colombe"
    address="località Santo Stefano 22, Fornace, 38040, Italy"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393335221610"
    website="https://www.letrecolombe.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This intimate and romantic restaurant occupies an old 19C farmhouse situated in a tiny hamlet in the Cembra valley. In the softly-lit dining rooms, chef Mara Fronza serves just one tasting menu which changes every month (guests have the choice of the main menu or a shorter version if they prefer) and showcases Italian dishes with obvious regional influences, especially in the seasonal ingredients used, all prepared with a modern twist. The famous carbonara is reinterpreted with the addition of anchovies and Crusco peppers, while the dark chocolate dessert with cherries in rum and cardamom-infused cream is truly delicious. Highly recommended!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Santo%20Stefano%2022%2C%20Fornace%2C%2038040%2C%20Italy"
    pageTitle="Le Tre Colombe"
  />
);

export default LeTreColombe;
