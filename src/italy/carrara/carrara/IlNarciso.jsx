...
const IlNarciso = () => (
  <RestaurantPage
    restaurantName="Il Narciso"
    address="viale Amerigo Vespucci 32, Carrara, 54033, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+393510025490"
    website="https://www.ristoranteilnarciso.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the Polda baths near the marina, this recently opened small restaurant on the beach serves cuisine with a contemporary yet classic flavour. The restaurant boasts excellent bread, home-made pasta, traditionally cooked dishes such as chicken casserole and creative desserts. Highly recommended, especially the terrace with its fine sea views...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Amerigo%20Vespucci%2032%2C%20Carrara%2C%2054033%2C%20Italy"
    pageTitle="Il Narciso"
  />
);

export default IlNarciso;
