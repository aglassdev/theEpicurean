...
const FiorentinoELocandaDelGiglio = () => (
  <RestaurantPage
    restaurantName="Fiorentino e Locanda del Giglio"
    address="via Luca Pacioli 60, Sansepolcro, 52037, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390575742033"
    website="https://www.ristorantefiorentino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just like the beautiful centre of Sansepolcro in which it is situated, this restaurant has much to boast about, with a history dating back over 200 years. The beautifully decorated dining rooms on the first floor of the palazzo are a picture of elegance, while the service is friendly and more informal. Traditional cuisine from inland Tuscany, plus welcoming guestrooms which add to its appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Luca%20Pacioli%2060%2C%20Sansepolcro%2C%2052037%2C%20Italy"
    pageTitle="Fiorentino e Locanda del Giglio"
  />
);

export default FiorentinoELocandaDelGiglio;
