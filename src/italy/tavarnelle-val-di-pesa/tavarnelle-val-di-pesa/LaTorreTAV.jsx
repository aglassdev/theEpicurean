...
const LaTorreTAV = () => (
  <RestaurantPage
    ...
    address="strada Spicciano 7, Tavarnelle Val di Pesa, 50028, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+39055806470"
    website="https://www.comohotels.com/it/tuscany/como-castello-del-nero/dining/la-torre"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Il Castello del Nero, the spectacular 12C residence that is home to this restaurant, stands in a magical location that includes many of the attractions that make Tuscany such a special place to visit – a breathtaking view from its summer terrace, an elegant dining room full of history, and top-quality ingredients such as extra-virgin olive oil and wine (the attractive wine cellar boasts a generous selection of the latter). However, the main attraction here is the excellent cuisine made by friendly chef Di Pirro, which is technical, creative and at the same time full of flavour, and always beautifully presented as befits the charming setting. The property is home to a kitchen garden (cultivated organically although as yet not certified organic) which boasts up to 10 varieties of tomato alon..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Spicciano%207%2C%20Tavarnelle%20Val%20di%20Pesa%2C%2050028%2C%20Italy"
    pageTitle="La Torre"
  />
);

export default LaTorreTAV;
