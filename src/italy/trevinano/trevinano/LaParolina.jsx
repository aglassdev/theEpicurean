...
const LaParolina = () => (
  <RestaurantPage
    restaurantName="La Parolina"
    address="via Giacomo Leopardi 1, Trevinano, 01021, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+390763717130"
    website="https://www.laparolina.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Just a few kilometres from Acquapendente, a must for those travelling the Via Francigena, in a residential location overlooking the bucolic valley below, Cesare and Romano's Iside offers local cuisine, rich in authentic flavours and local products, with a few technical touches, such as the iced chickpea hummus with a drizzle of local EVO oil, with incredible texture, or the lentil caviar to start. One of the highlights, when available, is the pigeon, delicate and tender, served with a succulent bruschetta with liver ragout and a dumpling in broth. The wine cellar offers good wine, some labels with a few years on their shoulders, and the terraces allow for splendid outdoor moments...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giacomo%20Leopardi%201%2C%20Trevinano%2C%2001021%2C%20Italy"
    pageTitle="La Parolina"
  />
);

export default LaParolina;
