...
const Visteria = () => (
  <RestaurantPage
    restaurantName="Visteria"
    address="piazza San Giorgio 2, Varenna, 23829, Italy"
    cuisine="Modern Cuisine, Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390341815111"
    website="https://www.rcollectionhotels.it/hotel-royal-victoria/ristorazione-hotel-4-stelle-lago-di-como/ristorante-visteria"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Royal Victoria hotel on picturesque Varenna’s small central piazza, this restaurant has just a few tables overlooking one of the most spectacular sights on Lake Como, namely the Bellagio promontory flanked on either side by the two branches of the lake. Talented chef Francesco Sarno, originally from Salerno, is at the helm in the kitchen here – the colour and intense flavours of his native Campania are evident in some of his dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Giorgio%202%2C%20Varenna%2C%2023829%2C%20Italy"
    pageTitle="Visteria"
  />
);

export default Visteria;
