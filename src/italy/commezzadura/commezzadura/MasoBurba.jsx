...
const MasoBurba = () => (
  <RestaurantPage
    restaurantName="Maso Burba"
    address="via Pietro Bernardelli 32, località Piano, Commezzadura, 38020, Italy"
    cuisine="Country cooking, Alpine"
    priceRange="€€"
    phoneNumber="+390463979991"
    website="https://masoburba.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having spent time working in top-quality restaurants, Gianpaolo Burba – alongside his partner Paola who works front of house – has returned home to the family restaurant in a small village in the Val di Sole region. Here, he makes the most of his experience and skills acquired elsewhere to showcase the best of the region’s ingredients in his beautifully presented dishes (although fish does make a rare appearance on the menu). The dining rooms, including a covered veranda, are bright, elegant and typically regional in style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pietro%20Bernardelli%2032%2C%20localit%C3%A0%20Piano%2C%20Commezzadura%2C%2038020%2C%20Italy"
    pageTitle="Maso Burba"
  />
);

export default MasoBurba;
