...
const PalazzoPetrucciPizzeria = () => (
  <RestaurantPage
    restaurantName="Palazzo Petrucci Pizzeria"
    address="piazza San Domenico Maggiore 5-7, Naples, 80134, Italy"
    cuisine="Pizza"
    priceRange="€"
    phoneNumber="+390815512460"
    website="https://www.palazzopetrucci.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right in the city centre, this pizzeria with the same name and owners as the gourmet restaurant has a contemporary, minimalist feel, plus an attractive outdoor space on the piazza. Among the excellent pizzas made from top-quality ingredients, you’ll find a few created by the young, skilful pizza chef, as well as one by chef Scarallo. Don’t miss the desserts!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20San%20Domenico%20Maggiore%205-7%2C%20Naples%2C%2080134%2C%20Italy"
    pageTitle="Palazzo Petrucci Pizzeria"
  />
);

export default PalazzoPetrucciPizzeria;
