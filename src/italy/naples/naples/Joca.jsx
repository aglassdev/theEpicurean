...
const Joca = () => (
  <RestaurantPage
    restaurantName="Joca"
    address="vico Sospiri 10/C, Naples, 80121, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390813356376"
    website="https://www.jocarestaurant.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a modern, trendy setting, chef Gianluca D'Agostino prepares creative gourmet cuisine with the occasional Campanian influence. In addition to this, in a separate part of the restaurant, guests can choose from a selection of tapas-style dishes which, despite the name, are inspired by traditional Italian and regional classics and have little to do with Spain. The gourmet menu features successful dishes such as sweetbreads, fettuccine and cod, as well as pasta with peas. The main courses include meat and fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vico%20Sospiri%2010%2FC%2C%20Naples%2C%2080121%2C%20Italy"
    pageTitle="Joca"
  />
);
