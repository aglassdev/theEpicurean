...
const DiMartinoSeaFrontPastaBar = () => (
  <RestaurantPage
    restaurantName="Di Martino Sea Front Pasta Bar"
    address="piazza Municipio 1, Naples, 80133, Italy"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3908118496287"
    website="https://www.pastadimartino.it/pages/sea-front-pasta-bar"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated opposite the Maschio Angioino (Castel Nuovo) in Naples, this restaurant was opened by a pasta producer from nearby Gragnano, making it the perfect choice for pasta-lovers. Sit at a sushi-style counter watching the chefs at work and choose from a menu that is dedicated almost entirely to pasta dishes (as well as desserts), most of which are based on traditional recipes. When ordered individually, the dishes are generously portioned; however, for a more complete overview, opt for the tasting menu which includes more courses but smaller quantities...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Municipio%201%2C%20Naples%2C%2080133%2C%20Italy"
    pageTitle="Di Martino Sea Front Pasta Bar"
  />
);

export default DiMartinoSeaFrontPastaBar;
