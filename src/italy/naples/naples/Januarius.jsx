...
const Januarius = () => (
  <RestaurantPage
    restaurantName="Januarius"
    address="via Duomo 146/148, Naples, 80138, Italy"
    cuisine="Campanian"
    priceRange="€€"
    phoneNumber="+390810145980"
    website="https://guide.michelin.com/en/campania/napoli/restaurant/januarius"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after San Gennaro (St Januarius) whose relics are said to lie in the cathedral nearby, this restaurant celebrates traditional, authentic specialities from Campania, such as octopus alla Luciana, zito pasta in a traditional ragu and salted cod with Napolitan-style endives. The entrance opens into a boutique selling top-quality ingredients (mainly charcuterie and cheeses), with two original dining rooms on either side...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Duomo%20146%2F148%2C%20Naples%2C%2080138%2C%20Italy"
    pageTitle="Januarius"
  />
);

export default Januarius;
