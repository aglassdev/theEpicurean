...
const LaLocandaGesVecchio = () => (
  <RestaurantPage
    restaurantName="La Locanda Gesù Vecchio"
    address="via Giovanni Paladino 26, Naples, 80121, Italy"
    cuisine="Campanian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390814613928"
    website="https://www.lalocandagesuvecchionapoli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated amid the picturesque alleyways of Spaccanapoli, this typical trattoria offers tables set closely together in a simple, informal dining room. Neapolitan cuisine is to the fore here, including popular specialities such as fried mozzarella, aubergine parmigiana, a variety of delicious fried dishes, bean and endive soup, pasta and peas, salted cod, meatballs and pastiera tart. A second restaurant run by the same owners and serving similar cuisine can be found at number 4 on the same street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giovanni%20Paladino%2026%2C%20Naples%2C%2080121%2C%20Italy"
    pageTitle="La Locanda Gesù Vecchio"
  />
);

export default LaLocandaGesVecchio;
