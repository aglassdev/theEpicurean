...
const EssenciaRestaurant = () => (
  <RestaurantPage
    restaurantName="Essencia Restaurant"
    address="piazza Santa Maria la Nova 9, Naples, 80134, Italy"
    cuisine="Mediterranean Cuisine, Fusion"
    priceRange="€€€"
    phoneNumber="+3908118229709"
    website="https://guide.michelin.com/en/campania/napoli/restaurant/essencia-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having spent many years living in Spain, the young chef at this quiet, elegant restaurant offers an appealing combination of Spanish and Italian dishes, resulting in his own interesting interpretations of Mediterranean cuisine. Situated in the heart of the historic centre, the restaurant has an open-view kitchen and chef’s table for four guests near the entrance, while the main dining room is on the first floor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Santa%20Maria%20la%20Nova%209%2C%20Naples%2C%2080134%2C%20Italy"
    pageTitle="Essencia Restaurant"
  />
);

export default EssenciaRestaurant;
