...
const IlRistoranteAlainDucasseNapoli = () => (
  <RestaurantPage
    restaurantName="Il Ristorante Alain Ducasse Napoli"
    address="Via Cristoforo Colombo 45, Naples, 80133, Italy"
    cuisine="Creative, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+390816041580"
    website="https://theromeocollection.com/en/romeo-napoli/restaurants-bars/il-ristorante-alain-ducasse/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Alain Ducasse, one of the great names in contemporary fine dining, has arrived in Naples, opening this restaurant in the former premises of the prestigious Ristorante Il Comandante. Situated on the 9th floor of the ROMEO hotel overlooking the port, the restaurant boasts fine views of Vesuvius and the Bay of Naples, especially at sunset when the colours are truly spectacular. Meanwhile, the modern dining room, decorated completely in black, is equally as stunning as its surroundings, as are the finishing touches added to the dishes in the dining room by the excellent serving staff. Executive chef Alessandro Lucassino, who was born in 1991 and has years of experience working with his mentor, adds a personal flavour to local recipes from Campania: by using short cooking times, he preserves th..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Cristoforo%20Colombo%2045%2C%20Naples%2C%2080133%2C%20Italy"
    pageTitle="Il Ristorante Alain Ducasse Napoli"
  />
);

export default IlRistoranteAlainDucasseNapoli;
