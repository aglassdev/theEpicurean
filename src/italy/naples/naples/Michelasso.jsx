...
const Michelasso = () => (
  <RestaurantPage
    restaurantName="Michelasso"
    address="via Santa Brigida 14/16, Naples, 80132, Italy"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+3908118658804"
    website="https://www.michelasso.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the city centre, this refined restaurant with an elegantly classic decor is perfect for a romantic, intimate dinner. The menu features meat and fish, with traditional dishes reinterpreted thanks to the chef’s expertise and proven experience. In summer, choose a table on the pleasant outdoor space overlooking the lively Via Santa Brigida...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santa%20Brigida%2014%2F16%2C%20Naples%2C%2080132%2C%20Italy"
    pageTitle="Michelasso"
  />
);

export default Michelasso;
