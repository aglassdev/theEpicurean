...
const LaNotizia53 = () => (
  <RestaurantPage
    restaurantName="La Notizia 53"
    address="via Caravaggio 53/55, Naples, 80126, Italy"
    cuisine="Pizza"
    priceRange="€"
    phoneNumber="+390817142155"
    website="http://www.pizzarialanotizia.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although situated away from the tourist centre, Enzo Coccia’s pizzeria continues to be considered one of the best places for pizza in Campania. Featuring classic Neapolitan pizzas with soft, stringy dough, the menu offers traditional and creative toppings alike. The “'mpustarella”, a five-grain and wholemeal flour roll with different fillings, more than compensates for the lack of “fritti” on the menu. The first historic restaurant at number 53 has now been joined by a second address at number 94/a nearby...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Caravaggio%2053%2F55%2C%20Naples%2C%2080126%2C%20Italy"
    pageTitle="La Notizia 53"
  />
);

export default LaNotizia53;
