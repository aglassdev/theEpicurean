...
const JContemporaryJapaneseRestaurant = () => (
  <RestaurantPage
    restaurantName="J Contemporary Japanese Restaurant"
    address="via Agostino Depretis 24, Naples, 80133, Italy"
    cuisine="Japanese"
    priceRange="€€€"
    phoneNumber="+390815800543"
    website="https://www.j-japaneserestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Arranged over several floors and in different dining rooms, this smart, elegant restaurant offers excellent service. In this modern setting with subtle lighting, enjoy typical Japanese specialities (almost exclusively fish dishes) which are showcased on an extensive menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Agostino%20Depretis%2024%2C%20Naples%2C%2080133%2C%20Italy"
    pageTitle="J Contemporary Japanese Restaurant"
  />
);

export default JContemporaryJapaneseRestaurant;
