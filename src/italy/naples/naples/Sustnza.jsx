...
const Sustnza = () => (
  <RestaurantPage
    restaurantName="Sustànza"
    address="Galleria Principe di Napoli 13, Naples, 80135, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390813795766"
    website="http://www.sustanzanapoli.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The entrance to this restaurant in the Galleria Principe di Napoli is through the 19C ScottoJonno café chantant, from where you take a lift to the restaurant’s Liberty-style dining rooms with their elegant, historic feel. In contrast, the cuisine is modern in flavour, featuring complex and elaborate dishes that have their roots in the traditions and ingredients of the entire Mediterranean (including North Africa), as well as fermented products and the occasional grilled option. The end result is a surprising experience for anyone looking for a change from the usual traditional fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Galleria%20Principe%20di%20Napoli%2013%2C%20Naples%2C%2080135%2C%20Italy"
    pageTitle="Sustànza"
  />
);

export default Sustnza;
