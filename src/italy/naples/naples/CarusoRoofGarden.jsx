...
const CarusoRoofGarden = () => (
  <RestaurantPage
    restaurantName="Caruso Roof Garden"
    address="via Partenope 45, Naples, 80121, Italy"
    cuisine="Campanian, Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390817640044"
    website="https://www.vesuvio.it/caruso/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a city that has its fair share of roof-garden eateries, this restaurant stands out as one of the most popular with fine panoramic views that take in the Castel dell'Ovo, Capri, the Sorrentine peninsula and Vesuvius... and, of course, the sea! Here, chef Emanuele Petrosino showcases the best of his cuisine on his tasting menus, which include “Suite 531” (dedicated to the legendary tenor Enrico Caruso), “Nel Blu”, “Per Mano” and “A Modo Mio”. If you’re choosing from the à la carte, we highly recommend the potato gnocchi with sea urchin, flavoured with Amalfi lemons and capers. Whatever you choose here, Campania’s fine produce takes centre stage, along with professional, attentive service and the beautiful Bay of Naples...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Partenope%2045%2C%20Naples%2C%2080121%2C%20Italy"
    pageTitle="Caruso Roof Garden"
  />
);

export default CarusoRoofGarden;
