...
const ThreeZeroCiroCascella = () => (
  <RestaurantPage
    restaurantName="3.0 Ciro Cascella"
    address="via San Pasquale 68, Naples, 80121, Italy"
    cuisine="Pizza"
    priceRange="€"
    phoneNumber="+390814976322"
    website="https://www.cirocascella.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fans of Neapolitan pizza will be in their element at this restaurant, where the pizzas are light, with a larger and softer crust, thanks to the long fermentation and leavening process – some people come here simply to eat the crust, it’s so good. There’s also a wide choice of excellent toppings, including top-quality ingredients from Campania. Gluten-free options and dough made from different flours are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Pasquale%2068%2C%20Naples%2C%2080121%2C%20Italy"
    pageTitle="3.0 Ciro Cascella"
  />
);

export default ThreeZeroCiroCascella;
