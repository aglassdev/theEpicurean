...
const LuministCafBistrot = () => (
  <RestaurantPage
    restaurantName="Luminist Cafè Bistrot"
    address="via Toledo 177, Naples, 80134, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3908119758023"
    website="https://www.giuseppeiannotti.it/Luminist"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the ground floor of the splendid Banco di Napoli building that is also home to the Gallerie d'Italia museum, this restaurant also includes a bar and pasticceria. The varied restaurant menu features international dishes (for a quicker meal), fish based around recipes from around the world, alongside more creative dishes and regional specialities from Campania. The latter, from the aubergine parmigiana to the candele pasta served with a Neapolitan ragu, and the popular babà, are truly delicious and showcase all the colours and flavours of Neapolitan cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Toledo%20177%2C%20Naples%2C%2080134%2C%20Italy"
    pageTitle="Luminist Cafè Bistrot"
  />
);

export default LuministCafBistrot;
