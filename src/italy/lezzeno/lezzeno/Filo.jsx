...
const Filo = () => (
  <RestaurantPage
    restaurantName="Filo"
    address="SP 583 - Località Bagnana 96, Lezzeno, 22025, Italy"
    cuisine="Italian Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+390315375101"
    website="https://ristorantefilo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the splendid lakeside position, the view extends to the opposite shore, Comacina Island, and Villa Balbianello. An enchanting terrace overlooking Lake Como, surrounded by greenery with hills as a backdrop like a painting, is where you can savor Mediterranean-flavored dishes. Choose from three tasting menus (Freestyle, Classics, and Vegetarian).  Or opt for the à la carte menu, with offerings such as purple prawns with goat cheese cream, berries, and bisque: an explosion of flavors!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SP%20583%20-%20Localit%C3%A0%20Bagnana%2096%2C%20Lezzeno%2C%2022025%2C%20Italy"
    pageTitle="Filo"
  />
);
