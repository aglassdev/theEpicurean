...
const ProfumiDiCousCous = () => (
  <RestaurantPage
    restaurantName="Profumi di Cous Cous"
    address="via Regina Margherita 80, San Vito lo Capo, 91010, Italy"
    cuisine="Sicilian, Seafood"
    priceRange="€€"
    phoneNumber="+390923974155"
    website="https://www.ghiblihotel.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As the name of this restaurant suggests, couscous takes pride of place on the menu, although other Sicilian specialities can also be sampled here. Delightful atmosphere, especially in summer when meals are served in the internal courtyard among the citrus trees...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Regina%20Margherita%2080%2C%20San%20Vito%20lo%20Capo%2C%2091010%2C%20Italy"
    pageTitle="Profumi di Cous Cous"
  />
);

export default ProfumiDiCousCous;
