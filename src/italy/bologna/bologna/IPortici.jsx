...
const IPortici = () => (
  <RestaurantPage
    restaurantName="I Portici"
    address="via dell'Indipendenza 69, Bologna, 40121, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390514218562"
    website="https://www.iporticihotel.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Occupying the atmospheric setting of the Eden theatre, a former late-19C musical café, this restaurant adorned with beautiful Liberty-style frescoes is the perfect backdrop for elegant, well-balanced Mediterranean-inspired dishes. Young, talented chef Nicola Annunziata offers three tasting menus of five (L’Ora Precisa), seven (La Spudorata) and nine (La Luce) courses with wine pairings recommended by the knowledgeable sommelier. If you’re looking for a quieter and more romantic ambience, book a table in the 14C icehouse, with its glass floor providing glimpses of the well-stocked wine cellar below...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dell'Indipendenza%2069%2C%20Bologna%2C%2040121%2C%20Italy"
    pageTitle="I Portici"
  />
);

export default IPortici;
