...
const AcquaPazza = () => (
  <RestaurantPage
    ...
    address="via Murri 168/d, Bologna, 40137, Italy"
    cuisine="Seafood, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+39051443422"
    website="https://guide.michelin.com/en/emilia-romagna/bologna/restaurant/acqua-pazza"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although this restaurant is not in the centre, if you’re looking for excellent fish (mostly from the Mediterranean) personally selected by the owner - chef, then it’s well worth the few minutes it takes to find a parking space here. Beautifully cooked food, which is simply prepared using top - quality produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Murri%20168%2Fd%2C%20Bologna%2C%2040137%2C%20Italy"
    pageTitle="Acqua Pazza"
  />
);

export default AcquaPazza;
