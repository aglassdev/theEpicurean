...
const AllosteriaBottega = () => (
  <RestaurantPage
    restaurantName="All'Osteria Bottega"
    address="via Santa Caterina 51b/55, Bologna, 40123, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39051585111"
    website="https://www.osteriabottega.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy top-quality Emilian cuisine at this restaurant, which focuses on the region’s most traditional, best-known and authentic recipes. Featuring a superb selection of hams and salamis, fresh pastas, meat and desserts, the menu offers a real feast for the tastebuds that will linger long in the memory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santa%20Caterina%2051b%2F55%2C%20Bologna%2C%2040123%2C%20Italy"
    pageTitle="All'Osteria Bottega"
  />
);

export default AllosteriaBottega;
