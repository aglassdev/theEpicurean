...
const OsteriaBartoliniBOL = () => (
  <RestaurantPage
    restaurantName="Osteria Bartolini"
    address="piazza Malpighi 16, Bologna, 40123, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€"
    phoneNumber="+39051262192"
    website="https://www.osteriabartolinibologna.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Under the majestic vaulted ceiling of Palazzo Dondini Ghiselli and in the shade of an old plane tree, this restaurant combines a simple ambience with an innovative concept. Here, guests can enjoy typical seafood dishes from Romagna – don’t miss the delicious sardines sautéed in oil and lemon, which are a real treat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Malpighi%2016%2C%20Bologna%2C%2040123%2C%20Italy"
    pageTitle="Osteria Bartolini"
  />
);

export default OsteriaBartoliniBOL;
