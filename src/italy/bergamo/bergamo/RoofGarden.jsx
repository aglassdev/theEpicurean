...
const RoofGarden = () => (
  <RestaurantPage
    restaurantName="Roof Garden"
    address="piazza della Repubblica 6, Bergamo, 24122, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39035366159"
    website="https://www.roofgardenrestaurant.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Make sure you ask for one of the tables next to the glass wall in this restaurant, which boasts romantic views of Bergamo’s Città Alta. The innovative, inventive cuisine is tempting and full of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Repubblica%206%2C%20Bergamo%2C%2024122%2C%20Italy"
    pageTitle="Roof Garden"
  />
);
