...
const VillaElena = () => (
  <RestaurantPage
    restaurantName="Villa Elena"
    address="via San Vigilio 56, Bergamo, 24129, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+39035260944"
    website="https://www.enricobartolini.net/ristorante-villaelena-bergamo"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated near the Città Alta in a delightful setting surrounded by hills, Villa Elena is one of the most sumptuous villas in the countryside around Bergamo. Housed in a 16C building with a medieval tower and panoramic terrace-cum-garden where guests can enjoy a pre-dinner aperitif, the restaurant boasts a stunning interior decor of stucco, marble, mirrors and frescoes. This luxurious ambience is more than equalled by the fine cuisine created by Marco Galtarossa in partnership with Enrico Bartolini (the Italian chef with the largest number of Michelin stars). The occasionally technical and elaborate dishes are sometimes divided into several courses and combined with a clever use of aromatic herbs, all of which makes this the perfect choice for a memorable meal and special occasion. The purp..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Vigilio%2056%2C%20Bergamo%2C%2024129%2C%20Italy"
    pageTitle="Villa Elena"
  />
);

export default VillaElena;
