...
const BarettoDiSanVigilio = () => (
  <RestaurantPage
    restaurantName="Baretto di San Vigilio"
    address="via al Castello 1, San Vigilio, Bergamo, 24129, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+39035253191"
    website="https://barettosanvigilio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the small square in front of the cable-car entrance, this typical bar-cum-restaurant with a retro, vaguely English feel serves generous traditional cuisine reinterpreted with a modern twist, including home-made bread and desserts. In summer, meals are served on the terrace with enchanting views of the town, while the two winter dining rooms have a rustic yet elegant feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20al%20Castello%201%2C%20San%20Vigilio%2C%20Bergamo%2C%2024129%2C%20Italy"
    pageTitle="Baretto di San Vigilio"
  />
);

export default BarettoDiSanVigilio;
