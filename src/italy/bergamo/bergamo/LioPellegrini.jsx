...
const LioPellegrini = () => (
  <RestaurantPage
    restaurantName="Lio Pellegrini"
    address="via San Tomaso 47, Bergamo, 24121, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39035247813"
    website="https://www.liopellegrini.it/site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite its location in the town centre, the attractive outdoor terrace of this restaurant offers a peaceful atmosphere with its decor of light drapes. The red - coloured dining room makes a pleasant backdrop for the modern, Mediterranean cuisine served here. Elegant ambience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Tomaso%2047%2C%20Bergamo%2C%2024121%2C%20Italy"
    pageTitle="Lio Pellegrini"
  />
);

export default LioPellegrini;
