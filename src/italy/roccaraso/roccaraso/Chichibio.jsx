...
const Chichibio = () => (
  <RestaurantPage
    restaurantName="Chichibio"
    address="via Guglielmo Marconi 1, Roccaraso, 67037, Italy"
    cuisine="Modern Cuisine, Cuisine from Abruzzo"
    priceRange="€€"
    phoneNumber="+393289054831"
    website="https://guide.michelin.com/en/abruzzo/roccaraso/restaurant/chichibio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite its lack of awards, this restaurant stands out for the quality of its cuisine. Situated in the town centre, it has a small intimate dining room with just a few tables (it’s best to book ahead) that acts as a backdrop for good-quality dishes made from local, seasonal ingredients, as well as a few modern and imaginative fish options. Highly recommended!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Guglielmo%20Marconi%201%2C%20Roccaraso%2C%2067037%2C%20Italy"
    pageTitle="Chichibio"
  />
);

export default Chichibio;
