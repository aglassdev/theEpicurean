...
const Rosselli77 = () => (
  <RestaurantPage
    restaurantName="Rosselli 77"
    address="via F.lli Rosselli 77, Cuorgnè, 10082, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390124651613"
    website="https://guide.michelin.com/en/piemonte/cuorgn/restaurant/rosselli-77"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A series of rooms teeming with warmth and atmosphere provide the backdrop for this simple and homely restaurant on the edge of town, where the chef announces dishes at your table. Although the menu can vary, pride of place is given to Piedmontese ingredients and culinary traditions, such as the cream of roasted chestnuts and mushrooms and the delicious snails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20F.lli%20Rosselli%2077%2C%20Cuorgn%C3%A8%2C%2010082%2C%20Italy"
    pageTitle="Rosselli 77"
  />
);

export default Rosselli77;
