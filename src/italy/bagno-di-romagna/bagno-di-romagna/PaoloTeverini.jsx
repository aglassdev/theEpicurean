...
const PaoloTeverini = () => (
  <RestaurantPage
    restaurantName="Paolo Teverini"
    address="via del Popolo 2, Bagno di Romagna, 47021, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390543911260"
    website="https://www.hoteltoscoromagnolo.it/it/ristoranti.php"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the charming village of Bagno di Romagna and surrounded by beautiful rolling hills, Teverini is a culinary name full of history in this area. The cuisine here demonstrates different traditions – the local region is an obvious influence (especially its mushrooms), but fish and seafood also feature along with plenty of vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Popolo%202%2C%20Bagno%20di%20Romagna%2C%2047021%2C%20Italy"
    pageTitle="Paolo Teverini"
  />
);

export default PaoloTeverini;
