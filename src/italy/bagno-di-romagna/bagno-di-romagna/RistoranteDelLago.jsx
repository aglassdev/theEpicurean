...
const RistoranteDelLago = () => (
  <RestaurantPage
    restaurantName="Ristorante del Lago"
    address="via Acquapartita 147, Bagno di Romagna, 47021, Italy"
    cuisine="Cuisine from Romagna, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390543903406"
    website="https://www.ristorantedellagoacquapartita.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Once off the main road, follow a series of twists and turns uphill to reach the village of Acquapartita, at an altitude of almost 800m, where you’ll find one of the best restaurants in the region. Here, the Bravaccini brothers are at the helm, with chef Simone creating dishes that are proudly focused on local ingredients such as mushrooms, trout and game. His signature dish of wild boar is delicious and full of flavour – the meat is sliced tartare-style so that it cooks quickly and is then served covered with soft mashed potatoes sprinkled with juniper. Front of house, his friendly and skilful brother Andrea oversees an encyclopaedic wine list – two volumes featuring almost 1 600 labels, with a focus on Italy and France (almost 40% of the wines are French). The choice of wines is as impres..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Acquapartita%20147%2C%20Bagno%20di%20Romagna%2C%2047021%2C%20Italy"
    pageTitle="Ristorante del Lago"
  />
);

export default RistoranteDelLago;
