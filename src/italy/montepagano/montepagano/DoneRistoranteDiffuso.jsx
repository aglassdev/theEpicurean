...
const DoneRistoranteDiffuso = () => (
  <RestaurantPage
    restaurantName="D.One Restaurant"
    address="Via del Borgo, 1, 64026 Montepagano TE, Italy"
    cuisine="Modern Cuisine, Country cooking"
    priceRange="€€€"
    phoneNumber="+390858944508"
    website="https://www.donerestaurant.it/"
    aliases={["D.one Ristorante Diffuso","D.One Restaurant Diffuso"]}
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Borgo%201%2C%20Montepagano%2C%2064026%2C%20Italy"
    pageTitle="D.One Restaurant"
  />
);

export default DoneRistoranteDiffuso;
