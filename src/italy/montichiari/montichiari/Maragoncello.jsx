...
const Maragoncello = () => (
  <RestaurantPage
    restaurantName="Maragoncello"
    address="via San Giovanni 1, località Vighizzolo, Montichiari, 25018, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+39030962304"
    website="https://www.ristorantemaragoncello.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a small village in the Bassa Bresciana region, this restaurant comes as something of a surprise due to its focus on fish, with the selection of raw seafood options and the good-value-for-money tasting menu particular highlights. Personalised cuisine which is full of flavour, served in modern, convivial dining rooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Giovanni%201%2C%20localit%C3%A0%20Vighizzolo%2C%20Montichiari%2C%2025018%2C%20Italy"
    pageTitle="Maragoncello"
  />
);

export default Maragoncello;
