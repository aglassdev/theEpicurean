...
const ISalotti = () => (
  <RestaurantPage
    restaurantName="I Salotti"
    address="Località Querce al Pino, SS 146, Chiusi, 53043, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390578274407"
    website="https://www.ilpatriarca.it/ristoranti/i-salotti-del-patriarca/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Querce%20al%20Pino%2C%20SS%20146%2C%20Chiusi%2C%2053043%2C%20Italy"
    pageTitle="I Salotti"
  />
);

export default ISalotti;
