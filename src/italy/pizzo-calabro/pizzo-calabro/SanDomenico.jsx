...
const SanDomenico = () => (
  <RestaurantPage
    ...
    address="via Colapesce 2, Pizzo Calabro, 89812, Italy"
    cuisine="Contemporary, Seafood"
    priceRange="€€€"
    phoneNumber="+393275971692"
    website="https://www.sandomenicopizzo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Perched high on the tufa cliffs overlooking the Costa degli Dei, this contemporary-style restaurant boasts superb views from its dining room and especially from its panoramic summer terrace. The cuisine served by the young owner-chef is as modern as the setting – dishes are light and almost exclusively focused on local fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Colapesce%202%2C%20Pizzo%20Calabro%2C%2089812%2C%20Italy"
    pageTitle="San Domenico"
  />
);

export default SanDomenico;
