...
const LordNelson = () => (
  <RestaurantPage
    restaurantName="Lord Nelson"
    address="corso Valparaiso 27, Chiavari, 16043, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390185302595"
    website="https://www.thelordnelson.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right on the seafront, this restaurant plunges its guests back in time with its polished wood, mirrors and classic decor giving it the feel of an English galleon. Mediterranean cuisine made from top-quality ingredients takes centre stage here, while the extensive wine list features some vintage labels. The American bar offering a good selection of cocktails is perfect for the winter months...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Valparaiso%2027%2C%20Chiavari%2C%2016043%2C%20Italy"
    pageTitle="Lord Nelson"
  />
);

export default LordNelson;
