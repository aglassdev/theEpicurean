...
const VineriaDerthona = () => (
  <RestaurantPage
    restaurantName="Vineria Derthona"
    address="via Lorenzo Perosi 15, Tortona, 15057, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390131812468"
    website="http://www.vineriaderthona.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of town, this secluded, busy and welcoming wine bar serves delicious Piedmontese dishes and a good selection of wines by the glass, chosen from the well-stocked wine cellar on a daily basis. House specialities include braised beef in a Barbera Colli Tortonesi sauce and gianduia chocolate semifreddo with mascarpone cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lorenzo%20Perosi%2015%2C%20Tortona%2C%2015057%2C%20Italy"
    pageTitle="Vineria Derthona"
  />
);

export default VineriaDerthona;
