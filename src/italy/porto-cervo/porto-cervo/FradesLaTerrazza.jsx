...
const FradesLaTerrazza = () => (
  <RestaurantPage
    restaurantName="Frades La Terrazza"
    address="SP94 - Località Abbiadori, Porto Cervo, 07021, Italy"
    cuisine="Mediterranean Cuisine, Sardinian"
    priceRange="€€€"
    phoneNumber="+393466366238"
    website="https://frades.eu/it/content/la-terrazza"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a panoramic location on Cala di Volpe bay, this trendy restaurant serves excellent cuisine with a focus on Sardinian specialities and other Mediterranean dishes. There’s a beautiful terrace for an aperitif, plus tapas options to share and a good selection of sparkling wines. Young and enthusiastic staff...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SP94%20-%20Localit%C3%A0%20Abbiadori%2C%20Porto%20Cervo%2C%2007021%2C%20Italy"
    pageTitle="Frades La Terrazza"
  />
);

export default FradesLaTerrazza;
