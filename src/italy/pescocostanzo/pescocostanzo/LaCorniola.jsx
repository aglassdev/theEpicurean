...
const LaCorniola = () => (
  <RestaurantPage
    restaurantName="La Corniola"
    address="via dei Mastri Lombardi 24, Pescocostanzo, 67033, Italy"
    cuisine="Modern Cuisine, Cuisine from Abruzzo"
    priceRange="€€"
    phoneNumber="+390864642470"
    website="https://www.lacorniola.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Known throughout Italy for its pillow lace, the small town of Pescocostanzo in the Parco della Maiella is one of the most beautiful in Italy. It is also home to the Relais Ducale hotel and its La Corniola restaurant, which is renowned for its excellent modern Abruzzo cuisine, including delicious, seasonal dishes made from different vegetables, potatoes and onions grown in the hotel’s own kitchen gardens. Simple yet elegant dining room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Mastri%20Lombardi%2024%2C%20Pescocostanzo%2C%2067033%2C%20Italy"
    pageTitle="La Corniola"
  />
);

export default LaCorniola;
