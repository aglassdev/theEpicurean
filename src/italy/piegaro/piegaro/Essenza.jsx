...
const Essenza = () => (
  <RestaurantPage
    restaurantName="Essenza"
    address="Località Crocicchia, Piegaro, 06066, Italy"
    cuisine="Traditional Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390758358400"
    website="https://www.borghidelleremo.it/ristorante-essenza/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Essenza is housed within the Borghi dell'Eremo resort in a stunning setting surrounded by beautiful and tranquil natural landscapes. The spacious dining room, which is flooded with natural light thanks to the picture windows that look out at the Umbrian hills, provides the backdrop for a culinary experience that focuses on traditional cuisine. Our inspector particularly recommends the exquisite Borghi saffron tagliatelle served with a rabbit ragù (the rabbits are raised on the estate’s own farm)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Crocicchia%2C%20Piegaro%2C%2006066%2C%20Italy"
    pageTitle="Essenza"
  />
);
