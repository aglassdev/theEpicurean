...
const DaPoliAllaStazione = () => (
  <RestaurantPage
    restaurantName="Da Poli alla Stazione"
    address="viale della Repubblica 10, Castelnovo di Sotto, 42024, Italy"
    cuisine="Classic Cuisine, Grills"
    priceRange="€€"
    phoneNumber="+390522682342"
    website="https://guide.michelin.com/en/emilia-romagna/castelnovo-di-sotto/restaurant/poli-alla-stazione"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the centre of a town known for its carnival and many allegorical floats, this family-run restaurant housed in an old railway station dating from the early 20C serves traditional regional dishes. The house speciality is charcoal-grilled cuisine, with an equal emphasis on meat and fish options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20della%20Repubblica%2010%2C%20Castelnovo%20di%20Sotto%2C%2042024%2C%20Italy"
    pageTitle="Da Poli alla Stazione"
  />
);

export default DaPoliAllaStazione;
