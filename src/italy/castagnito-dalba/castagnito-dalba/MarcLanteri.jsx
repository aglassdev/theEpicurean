...
const MarcLanteri = () => (
  <RestaurantPage
    restaurantName="Marc Lanteri"
    address="Via Serra 21/d, Castagnito d'Alba, 12050, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€"
    phoneNumber="+390173262172"
    website="https://www.marclanteri.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right next to the Fratelli Massucco winery, with which it shares its comfortable outdoor spaces as well as stunning views of the surrounding hills and vineyards, this restaurant is run by Marc Lanteri and Amy Bellotti, partners in life and work, who have chosen this setting for their new Piedmontese adventure. Their cuisine is full of individual character, with three tasting menus (including a vegetarian option featuring produce grown in their own garden) and dishes also available à la carte style. Local ingredients and recipes naturally take centre stage, always enhanced by small touches of colour and imagination. The wine list showcases the property’s own wines, as well as offering a choice of labels from elsewhere in Italy and further afield...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Serra%2021%2Fd%2C%20Castagnito%20d'Alba%2C%2012050%2C%20Italy"
    pageTitle="Marc Lanteri"
  />
);

export default MarcLanteri;
