...
const IlMerlo = () => (
  <RestaurantPage
    restaurantName="Il Merlo"
    address="Viale Sergio Bernardini 660, Lido di Camaiore, 55041, Italy"
    cuisine="Mediterranean Cuisine, Italian"
    priceRange="€€€"
    phoneNumber="+3905841660839"
    website="https://www.ilmerlocamaiore.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right on the beach, Il Merlo boasts a welcoming dining room decorated in elegant, contemporary style. The owner is at the helm in the kitchen, where he creates dishes with a focus on fish and seafood, such as the raw seafood platter and the salt-baked catch of the day. A few delicious meat options, such as plin pasta and pigeon, are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Viale%20Sergio%20Bernardini%20660%2C%20Lido%20di%20Camaiore%2C%2055041%2C%20Italy"
    pageTitle="Il Merlo"
  />
);

export default IlMerlo;
