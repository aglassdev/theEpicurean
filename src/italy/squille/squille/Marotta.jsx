...
const Marotta = () => (
  <RestaurantPage
    restaurantName="Marotta"
    address="via Marrochelle 52, Squille, 81010, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393495419274"
    website="https://www.marottaristorante.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestled amid the verdant hills of the Upper Caserta region, this delightful restaurant is a real gem. Young chef Domenico Marotta serves surprisingly high-quality cuisine with a focus on local ingredients and vegetables (some from the restaurant’s own kitchen garden) which he transforms into modern, minimalist yet generous dishes which are anything but predictable, and are showcased on three tasting menus and a short à la carte. We particularly enjoyed the Leccarda-style pigeon, a reinterpretation of a traditionally Umbrian dish, in which every part of the bird is used. The sommelier/head waiter is as impressive as the talented chef, as he guides guests on their culinary journey with his detailed and enthusiastic explanations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marrochelle%2052%2C%20Squille%2C%2081010%2C%20Italy"
    pageTitle="Marotta"
  />
);

export default Marotta;
