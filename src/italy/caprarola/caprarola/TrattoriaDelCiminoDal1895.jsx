...
const TrattoriaDelCiminoDal1895 = () => (
  <RestaurantPage
    restaurantName="Trattoria del Cimino dal 1895"
    address="via Filippo Nicolai 44, Caprarola, 01032, Italy"
    cuisine="Cuisine from Lazio, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390761646173"
    website="https://trattoriadelcimino.jimdofree.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the hill leading to Palazzo Farnese, this restaurant occupies the oldest building in the village, which dates back to 1370. Since 1940, the Calistri family have been delighting their guests with delicious specialities from Lazio, including excellent cured hams, fresh pasta (the amatriciana is particularly renowned), grilled meats and an impressive selection of cheeses and desserts. Excellent wines and spirits complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Filippo%20Nicolai%2044%2C%20Caprarola%2C%2001032%2C%20Italy"
    pageTitle="Trattoria del Cimino dal 1895"
  />
);

export default TrattoriaDelCiminoDal1895;
