...
const Marsupino1901 = () => (
  <RestaurantPage
    restaurantName="Marsupino 1901"
    address="via Roma Serra 20, Briaglia, 12080, Italy"
    cuisine="Piedmontese"
    priceRange="€€€"
    phoneNumber="+390174563888"
    website="https://www.trattoriamarsupino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Marsupino family has been running this trattoria enthusiastically and warmly since 1901. The chef's suggestion pays homage to the territory in accordance with tradition and the wine cellar, managed by the friendly expert Luca, is immense, with an excellent choice by the glass. Five rooms and two suites in the adjacent late nineteenth-century palazzo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%20Serra%2020%2C%20Briaglia%2C%2012080%2C%20Italy"
    pageTitle="Marsupino 1901"
  />
);

export default Marsupino1901;
