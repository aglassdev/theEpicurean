...
const Bramea = () => (
  <RestaurantPage
    restaurantName="Bramea"
    address="viale Villa d'Errico 10, Palazzo San Gervasio, 85026, Italy"
    cuisine="Creative"
    priceRange="€€"
    phoneNumber="+390972209498"
    website="https://www.bramearistorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This gourmet restaurant with just a few tables is run by two young friends, now business partners at Bramea, with one at the helm in the kitchen, the other front of house. Extensive tasting menus are the focus here, featuring creative and original dishes often made from local ingredients. The end result is fascinating and of the highest quality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Villa%20d'Errico%2010%2C%20Palazzo%20San%20Gervasio%2C%2085026%2C%20Italy"
    pageTitle="Bramea"
  />
);

export default Bramea;
