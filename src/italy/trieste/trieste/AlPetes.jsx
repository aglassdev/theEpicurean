...
const AlPetes = () => (
  <RestaurantPage
    restaurantName="Al Petes"
    address="Via dei Capitelli 5/a, Trieste, 34121, Italy"
    cuisine="Seafood, International"
    priceRange="€€€"
    phoneNumber="+390402602329"
    website="https://www.al-petes.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20dei%20Capitelli%205%2Fa%2C%20Trieste%2C%2034121%2C%20Italy"
    pageTitle="Al Petes"
  />
);

export default AlPetes;
