...
const StubeLadina = () => (
  <RestaurantPage
    restaurantName="Stube Ladina"
    address="via Precumon 24, Arabba, 32020, Italy"
    cuisine="Alpine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390436750076"
    website="https://www.alpenrosearabba.it/it/ristorante-ad-arabba/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The hotel owner is also the chef, serving carefully prepared and well - presented dishes made from regional produce in a quiet Stube - style dining room. An interesting wine list provides the icing on the cake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Precumon%2024%2C%20Arabba%2C%2032020%2C%20Italy"
    pageTitle="Stube Ladina"
  />
);

export default StubeLadina;
