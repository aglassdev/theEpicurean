...
const Laccanto = () => (
  <RestaurantPage
    restaurantName="L'Accanto"
    address="via Santa Maria Vecchia 2, loc. Seiano, Vico Equense, 80066, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390818029161"
    website="https://www.grandhotelangiolieri.it/it/dining-with-a-view/laccanto.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having left the busy coastal road behind you, you come into the peaceful and luxurious enclave of the Angiolieri hotel and its classically elegant L’Accanto restaurant. As soon as the weather allows, dinner is served outdoors on one of the most spectacular terraces in the area, overlooking the Bay of Naples and its breathtaking sunsets. The top-quality cuisine focuses mainly on the abundant recipes and ingredients of Campania...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santa%20Maria%20Vecchia%202%2C%20loc.%20Seiano%2C%20Vico%20Equense%2C%2080066%2C%20Italy"
    pageTitle="L'Accanto"
  />
);

export default Laccanto;
