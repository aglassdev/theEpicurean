...
const TorreDelSaracino = () => (
  <RestaurantPage
    restaurantName="Torre del Saracino"
    address="via Torretta 9, Vico Equense, 80069, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390818028555"
    website="https://www.torredelsaracino.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="From the coast road you take a series of hairpin bends down to Marina di Equa, the beach at Vico, where you will see this old fortified tower standing just a few metres from the sea. In the tower itself, with music playing in the background, guests can savour an aperitif accompanied by an extraordinary selection of imaginative antipasti that offer an introduction to the excellent cuisine that awaits. From here, you move into one of two dining elegant dining rooms decorated in vintage 1970s style which look out at Vesuvius and the Bay of Naples – the setting for a meal that will linger long in the memory. Gennaro Esposito is one of the best chefs in Campania, creating beautifully presented dishes of meat and fish (often in the same dish) that are not only delicious but also full of the colo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Torretta%209%2C%20Vico%20Equense%2C%2080069%2C%20Italy"
    pageTitle="Torre del Saracino"
  />
);

export default TorreDelSaracino;
