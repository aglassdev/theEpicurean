...
const AnticaOsteriaNonnaRosa = () => (
  <RestaurantPage
    restaurantName="Antica Osteria Nonna Rosa"
    address="via Laudano 1, loc. Pietrapiana, Vico Equense, 80069, Italy"
    cuisine="Campanian, Creative"
    priceRange="€€€€"
    phoneNumber="+393343917950"
    website="https://www.peppeguida.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Laudano%201%2C%20loc.%20Pietrapiana%2C%20Vico%20Equense%2C%2080069%2C%20Italy"
    pageTitle="Antica Osteria Nonna Rosa"
  />
);

export default AnticaOsteriaNonnaRosa;
