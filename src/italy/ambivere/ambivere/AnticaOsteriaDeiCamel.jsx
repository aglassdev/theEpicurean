...
const AnticaOsteriaDeiCamel = () => (
  <RestaurantPage
    restaurantName="Antica Osteria dei Camelì"
    address="via Marconi 13, Ambivere, 24030, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39035908000"
    website="https://www.anticaosteriadeicameli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying an attractive farmhouse dating back to the 16C, this restaurant boasts an interesting combination of antique elegance and modern style. The cuisine is equally impressive, offering a selection of traditional and innovative dishes that pay close attention to nutritional balance and the healthiness of the combinations of ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%2013%2C%20Ambivere%2C%2024030%2C%20Italy"
    pageTitle="Antica Osteria dei Camelì"
  />
);

export default AnticaOsteriaDeiCamel;
