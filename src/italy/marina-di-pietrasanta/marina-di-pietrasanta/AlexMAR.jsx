...
const AlexMAR = () => (
  <RestaurantPage
    restaurantName="Alex"
    address="via Versilia 157/159, Marina di Pietrasanta, 55045, Italy"
    cuisine="Mediterranean Cuisine, Italian"
    priceRange="€€€"
    phoneNumber="+390584746070"
    website="https://www.ristorantealex.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Modern, personalised dishes with something for everyone and a careful balance between meat and fish options. The three tasting menus showcase the chef’s culinary philosophy, all served in a trendy atmosphere with an ethnic touch. The wine list is one of the restaurant’s highlights, featuring an excellent selection of international labels, all of which can be purchased at the wine bar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Versilia%20157%2F159%2C%20Marina%20di%20Pietrasanta%2C%2055045%2C%20Italy"
    pageTitle="Alex"
  />
);

export default AlexMAR;
