...
const OsteriaArborina = () => (
  <RestaurantPage
    restaurantName="Osteria Arborina"
    address="frazione Annunziata 27/b, La Morra, 12064, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+390173500340"
    website="https://arborinarelais.it/osteria/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the beautiful Arborina Relais boasts modern, stylish and elegant dining rooms, the main attraction here is the restaurant’s exciting cuisine in which different culinary styles and techniques are showcased in every dish. Inspiration comes from different influences – for example, we chose a menu inspired by the 1980s (a period when Neapolitan chef Fernando Tommaso Forino was not yet born), and particularly enjoyed the mullet in vodka and the dessert trolley. We also liked the idea behind the menu as a whole, namely the no-waste focus, with all parts of the ingredients used yet always with the aim of creating enjoyable dishes. An interesting, classically extensive wine list and excellent service complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=frazione%20Annunziata%2027%2Fb%2C%20La%20Morra%2C%2012064%2C%20Italy"
    pageTitle="Osteria Arborina"
  />
);

export default OsteriaArborina;
