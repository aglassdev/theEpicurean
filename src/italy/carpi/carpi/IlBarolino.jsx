...
const IlBarolino = () => (
  <RestaurantPage
    restaurantName="Il Barolino"
    address="via Giovanni XXIII 110, Carpi, 41012, Italy"
    cuisine="Emilian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+393316217680"
    website="https://www.ilbarolinoristorante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The friendliness and Emilian genuineness of the Barolo brothers and of the whole team cheers a break here where you can enjoy the authentic regional cuisine. Parmesan cream tortellini are a must: large portions and top quality of these little pasta bundles still strictly made by hand! The room is simple and suitable above all for informal meetings among friends and colleagues...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giovanni%20XXIII%20110%2C%20Carpi%2C%2041012%2C%20Italy"
    pageTitle="Il Barolino"
  />
);

export default IlBarolino;
