...
const GlamEnricoBartolini = () => (
  <RestaurantPage
    restaurantName="Glam Enrico Bartolini"
    address="calle Tron, sestiere Santa Croce 1961, Venice, 30135, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390415235676"
    website="https://www.enricobartolini.net/i-ristoranti/glam"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The discreet and semi-hidden entrance of Palazzo Venart opens to a rare privilege, a small yet enchanting garden beautifully furnished like an orangerie! The other garden offers a more prominent view of the Grand Canal and hosts tables where coffee and after-dinner treats or spirits are served in summer. Between these green spaces lies the magnificent hotel that houses the restaurant, a collaboration between multi-starred chef Enrico Bartolini and the remarkable resident chef Donato Ascani. There are two tasting menus: Arte, orti e laguna, featuring dishes that honor Venice and its rich gastronomy, and I Classici del Glam, showcasing the chef's iconic dishes. Each dish highlights intense flavors that blend and harmonize seamlessly, a natural instinct honed with dedication and passion. We r..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=calle%20Tron%2C%20sestiere%20Santa%20Croce%201961%2C%20Venice%2C%2030135%2C%20Italy"
    pageTitle="Glam Enrico Bartolini"
  />
);

export default GlamEnricoBartolini;
