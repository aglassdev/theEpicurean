...
const CipsClub = () => (
  <RestaurantPage
    restaurantName="Cip's Club"
    address="isola della Giudecca 10, Venice, 30133, Italy"
    cuisine="Classic Cuisine, Traditional Cuisine"
    priceRange="€€€€"
    phoneNumber="+39041240801"
    website="https://www.belmond.com/it/dining/europe/italy/venice/cips-club/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the most informal and intimate restaurant of the Hotel Cipriani and comes with a coveted panoramic terrace which looks out over the Giudecca Canal, St. Mark's Square and the Doge's Palace. It's a true institution in the city and the seasonal menu of Venetian dishes includes a whole page dedicated to its signature classics...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=isola%20della%20Giudecca%2010%2C%20Venice%2C%2030133%2C%20Italy"
    pageTitle="Cip's Club"
  />
);

export default CipsClub;
