...
const TrattoriaAlPasso = () => (
  <RestaurantPage
    restaurantName="Trattoria Al Passo"
    address="via Passo Campalto 118, Venice, 30173, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+39041900470"
    website="https://guide.michelin.com/en/veneto/venezia/restaurant/trattoria-al-passo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Successive generations of the same family have run this pleasant restaurant just outside the city for over 70 years. Enjoy a selection of fish and seafood dishes (raw, grilled or fried with numerous condiments to accompany your starters) in a maritime themed dining room or on the light and airy veranda. There is a good selection of desserts to round off your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Passo%20Campalto%20118%2C%20Venice%2C%2030173%2C%20Italy"
    pageTitle="Trattoria Al Passo"
  />
);

export default TrattoriaAlPasso;
