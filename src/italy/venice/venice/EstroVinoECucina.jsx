...
const EstroVinoECucina = () => (
  <RestaurantPage
    restaurantName="Estro Vino e Cucina"
    address="calle Crosera, sestiere Dorsoduro 3778, Venice, 30123, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390414764914"
    website="https://www.estrovenezia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the somewhat more secretive Venice, a cosy wine bar that serves modern Mediterranean-style cuisine based on seasonal local produce (the fish comes from the Rialto market); on the menu there are, however, meat dishes such as milk and honey guinea fowl leg with mashed potatoes and endive. 600 labels of natural wines from sustainable viticulture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=calle%20Crosera%2C%20sestiere%20Dorsoduro%203778%2C%20Venice%2C%2030123%2C%20Italy"
    pageTitle="Estro Vino e Cucina"
  />
);

export default EstroVinoECucina;
