...
const OsteriaAlleTestiere = () => (
  <RestaurantPage
    restaurantName="Osteria alle Testiere"
    address="calle del Mondo Novo, sestiere Castello 5801, Venice, 30122, Italy"
    cuisine="Venetian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390415227220"
    website="https://www.osterialletestiere.it/?lang=it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=calle%20del%20Mondo%20Novo%2C%20sestiere%20Castello%205801%2C%20Venice%2C%2030122%2C%20Italy"
    pageTitle="Osteria alle Testiere"
  />
);

export default OsteriaAlleTestiere;
