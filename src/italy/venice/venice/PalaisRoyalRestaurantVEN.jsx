...
const PalaisRoyalRestaurantVEN = () => (
  <RestaurantPage
    restaurantName="Palais Royal Restaurant"
    address="Calle Larga 22 Marzo 2032, Venice, 30124, Italy"
    cuisine="Creative, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+39041406259"
    website="https://palaisroyalrestaurantvenezia.com/it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Calle%20Larga%2022%20Marzo%202032%2C%20Venice%2C%2030124%2C%20Italy"
    pageTitle="Palais Royal Restaurant"
  />
);

export default PalaisRoyalRestaurantVEN;
