...
const AlleCorone = () => (
  <RestaurantPage
    restaurantName="Alle Corone"
    address="campo della Fava, sestiere Castello 5527, Venice, 30122, Italy"
    cuisine="Modern Cuisine, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+390415232222"
    website="https://www.ristoranteallecorone.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Modern Mediterranean and Venetian cuisine served in three elegant dining rooms or – on request – in the wine bar surrounded by bottles of wine. Through the windows, enjoy the spectacle of gondolas passing by along the small canal outside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=campo%20della%20Fava%2C%20sestiere%20Castello%205527%2C%20Venice%2C%2030122%2C%20Italy"
    pageTitle="Alle Corone"
  />
);

export default AlleCorone;
