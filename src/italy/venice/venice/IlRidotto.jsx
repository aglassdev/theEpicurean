...
const IlRidotto = () => (
  <RestaurantPage
    restaurantName="Il Ridotto"
    address="campo S.S. Filippo e Giacomo, sestiere Castello 4509, Venice, 30122, Italy"
    cuisine="Contemporary, Meats and Seafood"
    priceRange="€€€"
    phoneNumber="+390415208280"
    website="https://www.ilridotto.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a few steps from St. Mark's Square and the Bridge of Sighs, in a small square, Il Ridotto welcomes you with a colourful and warm atmosphere. The cuisine, based on territoriality and seasonality of products, will win you over. Not to be missed is the mouthwatering and fresh white chocolate dessert of bergamot, citrus and grapefruit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=campo%20S.S.%20Filippo%20e%20Giacomo%2C%20sestiere%20Castello%204509%2C%20Venice%2C%2030122%2C%20Italy"
    pageTitle="Il Ridotto"
  />
);

export default IlRidotto;
