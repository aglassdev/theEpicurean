...
const LosteriaDiSantaMarina = () => (
  <RestaurantPage
    restaurantName="L'Osteria di Santa Marina"
    address="campo Santa Marina, sestiere di Castello 5911, Venice, 30122, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390415285239"
    website="https://osteriadisantamarina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This classy inn is managed by young professionals who serve seafood and traditional dishes, but they also offer some interesting culinary innovations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=campo%20Santa%20Marina%2C%20sestiere%20di%20Castello%205911%2C%20Venice%2C%2030122%2C%20Italy"
    pageTitle="L'Osteria di Santa Marina"
  />
);

export default LosteriaDiSantaMarina;
