...
const AnticheCarampane = () => (
  <RestaurantPage
    restaurantName="Antiche Carampane"
    address="rio Terà delle Carampane, sestiere San Polo 1911, Venice, 30125, Italy"
    cuisine="Venetian, Seafood"
    priceRange="€€€"
    phoneNumber="+390415240165"
    website="https://www.antichecarampane.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the typical floors to the wall decorations, everything here speaks to the heart to tell you about a historic trattoria where people joyfully return each time to enjoy local seafood specialities. Sarde in saor, baccalà mantecato, fried moeche (spring and autumn), cuttlefish in nero to name but a few. The recipes are crafted with skill and fidelity to tradition. In addition to the dishes listed on the menu, each day you will be verbally presented with off-menu specials. An excellent wine selection ranging from Italian to French labels with good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rio%20Ter%C3%A0%20delle%20Carampane%2C%20sestiere%20San%20Polo%201911%2C%20Venice%2C%2030125%2C%20Italy"
    pageTitle="Antiche Carampane"
  />
);

export default AnticheCarampane;
