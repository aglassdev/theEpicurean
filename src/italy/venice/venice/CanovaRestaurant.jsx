...
const CanovaRestaurant = () => (
  <RestaurantPage
    restaurantName="Canova Restaurant"
    address="sestiere San Marco 1243, Venice, 30124, Italy"
    cuisine="Contemporary"
    priceRange="€€€€"
    phoneNumber="+390415289840"
    website="https://venice.baglionihotels.com/it/ristoranti/canova-restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in an elegant hotel just behind St Mark’s Square, this gourmet restaurant is home to chef Gennaro Balice, who prepares visually impressive dishes from carefully chosen ingredients. Guests can choose from an à la carte or two tasting menus, one creative and Venetian in style, the other vegetarian. Simpler fare is available in the bistro next door or at tables on the outdoor terrace in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=sestiere%20San%20Marco%201243%2C%20Venice%2C%2030124%2C%20Italy"
    pageTitle="Canova Restaurant"
  />
);

export default CanovaRestaurant;
