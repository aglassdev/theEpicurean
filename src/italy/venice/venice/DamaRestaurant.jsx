...
const DamaRestaurant = () => (
  <RestaurantPage
    restaurantName="Dama Restaurant"
    address="Fondamenta Savorgnan 461, Cannaregio, Venice, 30121, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390410986297"
    website="https://www.cabonfadini.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cuisine served at this restaurant comes from a deep knowledge of the region, is inspired by tradition and yet constantly evolving. At Dama , guests will find creative cuisine with an equal balance of meat and fish dishes. Housed within Ca’ Bonfadini, the restaurant boasts an outstanding location overlooking Cannaregio canal, while the attractive dining room has just three elegant wooden tables that encourage sharing and can accommodate up to 10 guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fondamenta%20Savorgnan%20461%2C%20Cannaregio%2C%20Venice%2C%2030121%2C%20Italy"
    pageTitle="Dama Restaurant"
  />
);

export default DamaRestaurant;
