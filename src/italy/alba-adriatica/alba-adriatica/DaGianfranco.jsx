...
const DaGianfranco = () => (
  <RestaurantPage
    restaurantName="Da Gianfranco"
    address="via delle Orchidee 5, Alba Adriatica, 64011, Italy"
    cuisine="Meats and Grills, Seafood"
    priceRange="€€"
    phoneNumber="+390861752048"
    website="https://www.ristorantedagianfranco.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Gianfranco Verdecchia, restaurateur and heir to a family of butchers, has always cooked the food that sustained his people. After running a restaurant in Sant’Omero – a hill town known for its festival dedicated to baccalà (salt cod), a staple in the area’s cuisine – he returned to his hometown of Giulianova. Here, in a stylish, secluded space away from the sea, he has kept baccalà as the sole seafood option, devoting an entire menu to it alongside a wide selection of dishes highlighting his first love: meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20delle%20Orchidee%205%2C%20Alba%20Adriatica%2C%2064011%2C%20Italy"
    pageTitle="Da Gianfranco"
  />
);

export default DaGianfranco;
