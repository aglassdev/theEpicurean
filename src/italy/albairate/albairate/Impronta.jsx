...
const Impronta = () => (
  <RestaurantPage
    ...
    address="via Pisani Dossi 28, Albairate, 20080, Italy"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390291439075"
    website="https://ristoranteimprontaalbairate.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An elegant restaurant that has the feel of a private home, with its beautiful light-wood tables. The Sicilian origins of talented chef Andrea Colombara are reflected in his dishes, which have a strong Mediterranean flavour. Highlights on the menu include delicious mullet with caponata which is served with onions, pine nuts, capers and small vegetables in a sweet and sour sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pisani%20Dossi%2028%2C%20Albairate%2C%2020080%2C%20Italy"
    pageTitle="Impronta"
  />
);
