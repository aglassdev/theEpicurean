...
const LaTorreSPI = () => (
  <RestaurantPage
    ...
    address="piazza Castello 8, Spilimbergo, 33097, Italy"
    cuisine="Regional Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+39042750555"
    website="https://www.ristorantelatorre.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the picturesque medieval castle of Spilimbergo, this restaurant boasts a splendid façade adorned with 14C frescoes, plus two rustic yet elegant dining rooms. If you’re looking for somewhere for a romantic dinner and modern cuisine, then this is the place for you!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Castello%208%2C%20Spilimbergo%2C%2033097%2C%20Italy"
    pageTitle="La Torre"
  />
);

export default LaTorreSPI;
