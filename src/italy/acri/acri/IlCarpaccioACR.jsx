...
const IlCarpaccioACR = () => (
  <RestaurantPage
    restaurantName="Il Carpaccio"
    address="contrada Cocozzello 197/d, Acri, 87041, Italy"
    cuisine="Calabrian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390984949205"
    website="https://guide.michelin.com/en/calabria/acri/restaurant/il-carpaccio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This traditional family restaurant has been recently renovated to include an attractive veranda - style dining room overlooking the valley. Typical dishes from Calabria, fish specialities by prior arrangement, and a good wine list all add to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Cocozzello%20197%2Fd%2C%20Acri%2C%2087041%2C%20Italy"
    pageTitle="Il Carpaccio"
  />
);

export default IlCarpaccioACR;
