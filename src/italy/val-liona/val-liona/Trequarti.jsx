...
const Trequarti = () => (
  <RestaurantPage
    restaurantName="Trequarti"
    address="piazza del Donatore 3/4, Val Liona, 36044, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390444889674"
    website="https://www.ristorantetrequarti.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern and minimalist-style restaurant with three small dining rooms full of character provides the backdrop for contemporary-style cuisine which is constantly evolving. The menu includes a few snack options for those in a hurry or looking to sample a variety of dishes in smaller portions. Open at lunchtime by prior reservation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20del%20Donatore%203%2F4%2C%20Val%20Liona%2C%2036044%2C%20Italy"
    pageTitle="Trequarti"
  />
);

export default Trequarti;
