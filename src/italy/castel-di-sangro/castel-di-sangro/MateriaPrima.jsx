...
const MateriaPrima = () => (
  <RestaurantPage
    restaurantName="Materia Prima"
    address="Località Piana Santa Liberata, Castel di Sangro, 67031, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390864238030"
    website="https://ristorantemateriaprima.eu/index.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant and intimate terrace overlooks the shores of an artificial lake dedicated to sports activities. The glass windows provide the same view from the modern, sleek, and minimalist interior rooms, just like the dishes: creative, yet reminiscent of local cuisine, such as the simple but tasty Pallotta Cacio e Ova, offered among the welcome bites. There are also various daily specials according to the market. The service is friendly and attentive, with a young and motivated team overall...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Piana%20Santa%20Liberata%2C%20Castel%20di%20Sangro%2C%2067031%2C%20Italy"
