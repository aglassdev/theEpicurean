...
const TeresitaByGiardinoDiMari = () => (
  <RestaurantPage
    restaurantName="Teresita by Giardino di Mari"
    address="terrazza della Repubblica 7, Viareggio, 55049, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+3905841840038"
    website="https://www.ristoranteteresita.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the private beach club of the same name, this elegant restaurant serves fish and seafood dishes made from carefully selected and top-quality ingredients. A whole page of the menu is dedicated to oysters and raw fish options. An attractive outdoor dining space completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=terrazza%20della%20Repubblica%207%2C%20Viareggio%2C%2055049%2C%20Italy"
    pageTitle="Teresita by Giardino di Mari"
  />
);

export default TeresitaByGiardinoDiMari;
