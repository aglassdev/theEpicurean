...
const DaMiroAllaLanterna = () => (
  <RestaurantPage
    restaurantName="Da Miro alla Lanterna"
    address="via Coppino 289, Viareggio, 55049, Italy"
    cuisine="Seafood, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+390584384065"
    website="https://www.ristorantedamiro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It would be difficult for the menu at this restaurant to convey the beauty and quality of the fresh fish on display near the kitchen, where guests can make their own selection. Here, all sorts of shellfish and different fish of all shapes and sizes are transformed into delicious dishes full of flavour. Classic decor, professional service, an excellent wine selection and good value for money all add to the appeal. An address which has been delighting guests ever since 1954!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Coppino%20289%2C%20Viareggio%2C%2055049%2C%20Italy"
    pageTitle="Da Miro alla Lanterna"
  />
);

export default DaMiroAllaLanterna;
