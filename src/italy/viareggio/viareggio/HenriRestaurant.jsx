...
const HenriRestaurant = () => (
  <RestaurantPage
    restaurantName="Henri Restaurant"
    address="viale Ugo Foscolo 8/10, Viareggio, 55049, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390584841192"
    website="https://henrirestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this restaurant refers to its owner Henri Prosperi, who returned to his beloved Viareggio in 2021. This accomplished maître d' from another era will introduce you, with both charm and professionalism, to his daughter Serena’s dishes, which are finely balanced between classic and modern flavours, with the occasional French influence. The chef’s menu features meat and fish dishes, with a firm focus on luxury ingredients. The same is true of the wine list, which includes renowned labels such as Petrus and Sassicaia, as well as some of the best French and Italian sparkling wines. Welcome back, Henri!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Ugo%20Foscolo%208%2F10%2C%20Viareggio%2C%2055049%2C%20Italy"
    pageTitle="Henri Restaurant"
  />
);

export default HenriRestaurant;
