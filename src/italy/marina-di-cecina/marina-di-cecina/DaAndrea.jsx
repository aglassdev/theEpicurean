...
const DaAndrea = () => (
  <RestaurantPage
    ...
    address="viale della Vittoria 68, Marina di Cecina, 57023, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390586620143"
    website="https://www.ristorantedaandrea.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This white, modern and minimalist - style restaurant has lovely views of the Tyrrhenian sea from its dining room and summer terrace. Not surprisingly, fish and seafood take pride of place on the menu, with daily specials based on the catch of the day announced at your table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20della%20Vittoria%2068%2C%20Marina%20di%20Cecina%2C%2057023%2C%20Italy"
    pageTitle="Da Andrea"
  />
);

export default DaAndrea;
