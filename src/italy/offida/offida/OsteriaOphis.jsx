...
const OsteriaOphis = () => (
  <RestaurantPage
    restaurantName="Osteria Ophis"
    address="corso Serpente Aureo 54/b, Offida, 63073, Italy"
    cuisine="Cuisine from the Marches, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390736889920"
    website="https://www.osteriaophis.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the beautiful historic pedestrianised centre of Offida, this restaurant with a brick-vaulted ceiling is housed in the former stables of an old palazzo with a modern, inviting and intimate feel. Here, owner-chef Daniele Citeroni Maurizi skilfully reinterprets regional cuisine to create precise, imaginative dishes that are full of flavour. The stuffed cannelloni cooked on the barbecue grill are delicious, as is the veal tartare served with a warm meat, herb and vegetable jus on the side. We should also highlight the “low cost” tasting menu available for guests aged under 25...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Serpente%20Aureo%2054%2Fb%2C%20Offida%2C%2063073%2C%20Italy"
    pageTitle="Osteria Ophis"
  />
);

export default OsteriaOphis;
