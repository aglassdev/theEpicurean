...
const LaTerrazzaASO = () => (
  <RestaurantPage
    ...
    priceRange="€€"
    phoneNumber="+390423951332"
    website="https://albergoalsoleasolo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The aptly named Terrazza is a delightful open - air restaurant overlooking Asolo’s historic centre. In an elegant, fashionable ambience enjoy innovative delicacies that nonetheless make full use of the best local traditions and produce. Ideal for a romantic dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Collegio%2033%2C%20Asolo%2C%2031011%2C%20Italy"
    pageTitle="La Terrazza"
  />
);

export default LaTerrazzaASO;
