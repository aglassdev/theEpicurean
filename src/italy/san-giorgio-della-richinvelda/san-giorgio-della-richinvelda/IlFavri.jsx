...
const IlFavri = () => (
  <RestaurantPage
    restaurantName="Il Favri"
    address="via Borgo Meduna 12, San Giorgio della Richinvelda, 33095, Italy"
    cuisine="Friulian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+39042794043"
    website="https://www.ilfavri.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This inn, which has been serving food since the early 19C, boasts a warm atmosphere with a rustic feel. The beautiful garden makes a delightful setting in fine weather, while the cuisine focuses on traditional dishes from Friuli, such as “frico” (potato, onion and cheese fritter) and cured ham...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Borgo%20Meduna%2012%2C%20San%20Giorgio%20della%20Richinvelda%2C%2033095%2C%20Italy"
    pageTitle="Il Favri"
  />
);

export default IlFavri;
