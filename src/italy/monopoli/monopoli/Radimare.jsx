...
const Radimare = () => (
  <RestaurantPage
    restaurantName="Radimare"
    address="via Beato Piergiorgio Frassati 5/a, Monopoli, 70043, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390804038320"
    website="https://radimare.com/home/it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s no tasting menu at this restaurant but instead a tempting à la carte featuring modern Mediterranean cuisine based on top-quality seasonal ingredients, with fish and seafood taking centre stage. Citrus fruit and a few spices, especially ginger, are used carefully and sparingly, as are aromatic herbs which add a touch of fresh flavour to the dishes. The contemporary decor, enhanced by plants and a profusion of wood, plus friendly service add to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Beato%20Piergiorgio%20Frassati%205%2Fa%2C%20Monopoli%2C%2070043%2C%20Italy"
    pageTitle="Radimare"
  />
);

export default Radimare;
