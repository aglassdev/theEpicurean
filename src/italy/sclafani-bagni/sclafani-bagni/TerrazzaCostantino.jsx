...
const TerrazzaCostantino = () => (
  <RestaurantPage
    restaurantName="Terrazza Costantino"
    address="rione Sant'Antonio 24, Sclafani Bagni, 90020, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393391155915"
    website="https://www.terrazzacostantino.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In just a few years, young owner-chef Giuseppe Costantino has turned what was once the family trattoria into an elegant restaurant serving delicious reinterpretations of local specialities. There is just one tasting menu which features either meat or fish (although this can be discussed when you make your booking, which is essential). Given the excellent quality of the food here, this menu offers exceptional value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rione%20Sant'Antonio%2024%2C%20Sclafani%20Bagni%2C%2090020%2C%20Italy"
    pageTitle="Terrazza Costantino"
  />
);

export default TerrazzaCostantino;
