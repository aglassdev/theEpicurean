...
const LaTortuga = () => (
  <RestaurantPage
    restaurantName="La Tortuga"
    address="via XXIV Maggio 5, Gargnano, 25084, Italy"
    cuisine="Italian Contemporary, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+39036571251"
    website="https://www.ristorantelatortuga.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In Gragnano, La Tortuga has been synonymous with taste and quality for generations, with lake fish as the main attraction: zander and whitefish leading the way. Spaghetti, warm appetizers, and Mediterranean flavors enhance the mineral notes of the fish, thanks also to the scents of Garda, from lemon to extra virgin olive oil. The wine cellar is impressive, featuring gems such as Lugana Orestilla. If you're lucky, you might meet long-time customers sharing stories of their visits since 1980!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXIV%20Maggio%205%2C%20Gargnano%2C%2025084%2C%20Italy"
    pageTitle="La Tortuga"
  />
);

export default LaTortuga;
