...
const VillaFeltrinelli = () => (
  <RestaurantPage
    restaurantName="Villa Feltrinelli"
    address="via Rimembranza 38/40, Gargnano, 25084, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390365798000"
    website="https://www.ristorantevillafeltrinelli.com/it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the namesake villa, among Garda’s most spectacular hotels—water in front, mountain behind, park around—you find yourself in an exclusive enclave of silence. Begin with a garden aperitif affording breathtaking views across the lake’s opposite shoreline, then transition indoors or onto the terrace for dining. There are no options save a lengthy surprise tasting menu, crafted by Stefano Baiocco. Several dishes integrate both fish and meat, yet the vegetable realm remains a chef’s true passion, bolstered by an incredible variety of vegetables and primarily aromatic herbs, occasionally paired with more exotic ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Rimembranza%2038%2F40%2C%20Gargnano%2C%2025084%2C%20Italy"
    pageTitle="Villa Feltrinelli"
  />
);

export default VillaFeltrinelli;
