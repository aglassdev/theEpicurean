...
const CaMia = () => (
  <RestaurantPage
    restaurantName="Ca' Mia"
    address="via Cascinette 1, Alserio, 22040, Italy"
    cuisine="Italian, Creative"
    priceRange="€€"
    phoneNumber="+39031631558"
    website="https://www.camiaristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming restaurant in the hills surrounding Lake Alserio makes guests feel completely at home. The two young chefs with plenty of experience behind them create modern dishes with a preference for quick cooking methods and a focus on a wood-fired oven and barbecue, as well as fermented ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cascinette%201%2C%20Alserio%2C%2022040%2C%20Italy"
    pageTitle="Ca' Mia"
  />
);

export default CaMia;
