...
const CasaDangelo = () => (
  <RestaurantPage
    restaurantName="Casa D'Angelo"
    address="via San Nicola 5, Fara Filiorum Petri, 66010, Italy"
    cuisine="Cuisine from Abruzzo, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+39087170296"
    website="https://www.casadangelo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in what was once an old family home, this elegant restaurant serves delicious regional cuisine. The menu includes dishes that have been skilfully and imaginatively enhanced by the chef, such as warm pheasant terrine with apple, alongside more traditional fare, from cured ham to charcoal-grilled local lamb and potato gnocchi with a duck sauce. The restaurant’s own extra-virgin olive oil often adds further flavour to the dishes. The 4-course tasting menu deserves a special mention for its excellent value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Nicola%205%2C%20Fara%20Filiorum%20Petri%2C%2066010%2C%20Italy"
    pageTitle="Casa D'Angelo"
  />
);

export default CasaDangelo;
