...
const IlTrillo = () => (
  <RestaurantPage
    restaurantName="Il Trillo"
    address="via Bergiola Vecchia 30, Massa, 54100, Italy"
    cuisine="Country cooking, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39058546755"
    website="https://www.iltrillo.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the hills overlooking the town, this restaurant occupies an old house that is also home to the estate’s wine cellars. Charming setting and cuisine full of flavour, with the option of alfresco dining on the panoramic terrace in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bergiola%20Vecchia%2030%2C%20Massa%2C%2054100%2C%20Italy"
    pageTitle="Il Trillo"
  />
);

export default IlTrillo;
