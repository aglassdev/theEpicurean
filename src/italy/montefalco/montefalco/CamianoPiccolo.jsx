...
const CamianoPiccolo = () => (
  <RestaurantPage
    restaurantName="Camiano Piccolo"
    address="via Camiano Piccolo 5, Montefalco, 06036, Italy"
    cuisine="Umbrian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390742379492"
    website="https://www.camianopiccolo.com/ristorante-dell-agriturismo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a 16C farmhouse with and outdoor swimming pool, the Camiano Piccolo agriturismo stands on a hill overlooking the Umbrian countryside, 10 minutes’ drive from Montefalco. Here, chef Giuseppe Fabrizi brings the best of the region’s ingredients to the table, from vegetables grown in the restaurant’s own kitchen garden to local wines and olive oils, delicious meat and black truffles in season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Camiano%20Piccolo%205%2C%20Montefalco%2C%2006036%2C%20Italy"
    pageTitle="Camiano Piccolo"
  />
);

export default CamianoPiccolo;
