...
const MagiargOsteriaContemporanea = () => (
  <RestaurantPage
    restaurantName="Magiargè Osteria Contemporanea"
    address="via Dritta 2, Bordighera, 18012, Italy"
    cuisine="Ligurian"
    priceRange="€€"
    phoneNumber="+390184262946"
    website="https://guide.michelin.com/en/liguria/bordighera/restaurant/magiarge-osteria-contemporanea"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dining rooms in this lively, typical restaurant in the upper, historic part of Bordighera appear to be almost dug out of the rock. Here, a local chef with plenty of experience behind him creates predominantly Ligurian cuisine (and not just fish and seafood), accompanied by an excellent and extensive wine list, including labels from outside Italy and a good selection of champagnes. Attentive service completes the picture here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Dritta%202%2C%20Bordighera%2C%2018012%2C%20Italy"
    pageTitle="Magiargè Osteria Contemporanea"
  />
);

export default MagiargOsteriaContemporanea;
