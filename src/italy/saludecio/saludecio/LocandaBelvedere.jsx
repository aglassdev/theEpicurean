...
const LocandaBelvedere = () => (
  <RestaurantPage
    restaurantName="Locanda Belvedere"
    address="via San Giuseppe 736, frazione San Rocco, Saludecio, 47835, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390541982144"
    website="https://www.belvederesaludecio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Using local ingredients, this restaurant offers regional cuisine with some creative touches. Pretty and inviting rooms, tastefully decorated and with period furniture. All overlooking the valley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Giuseppe%20736%2C%20frazione%20San%20Rocco%2C%20Saludecio%2C%2047835%2C%20Italy"
    pageTitle="Locanda Belvedere"
  />
);

export default LocandaBelvedere;
