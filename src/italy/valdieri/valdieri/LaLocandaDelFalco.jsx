...
const LaLocandaDelFalco = () => (
  <RestaurantPage
    restaurantName="La Locanda del Falco"
    address="piazza Regina Elena 22, Valdieri, 12010, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390171976720"
    website="https://www.lalocandadelfalcovaldieri.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the sort of small family-run restaurant that everyone would like to have as their local, where courteous and friendly service go hand-in-hand with good traditional cuisine. Dishes such as ravioli del plin, vitello tonnato, beef tartare and veal tongue are some of the daily specials marked up on the blackboard here. The wine list comes as a pleasant surprise, with its excellent selection of labels from Piedmont and further afield...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Regina%20Elena%2022%2C%20Valdieri%2C%2012010%2C%20Italy"
    pageTitle="La Locanda del Falco"
  />
);

export default LaLocandaDelFalco;
