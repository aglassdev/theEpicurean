...
const IDueCippiDal1976 = () => (
  <RestaurantPage
    restaurantName="I Due Cippi dal 1976"
    address="piazza Vittorio Veneto 26/a, Saturnia, 58014, Italy"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+390564601074"
    website="https://www.iduecippi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The first sight to greet you when you enter this restaurant is a barbecue grill for cooking meat; the meat itself can be seen ageing nearby, with numerous cuts and meats to choose from and the famous Chianina beef taking centre stage. The small yet elegant dining rooms, welcoming ambience and friendly service all add to the appeal, as does the excellent section of wines. Meals are served outdoors in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Vittorio%20Veneto%2026%2Fa%2C%20Saturnia%2C%2058014%2C%20Italy"
    pageTitle="I Due Cippi dal 1976"
  />
);

export default IDueCippiDal1976;
