...
const MosDES = () => (
  <RestaurantPage
    restaurantName="MoS"
    address="via Porto Vecchio 28, Desenzano del Garda, 25015, Italy"
    cuisine="Contemporary, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+390309143339"
    website="https://www.ristorantemos.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The young Stefano Zanini, with plenty of experience in Italy and further afield, has injected new life into this old trattoria situated right in front of the marina in the historic heart of Desenzano. The personalised cuisine focuses on seasonal ingredients, including meat and fish from the lake and sea; one of the restaurant’s key tenets is recycling waste as much as possible. In summer, dine at one of the outdoor tables with views of the boats in the marina...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Porto%20Vecchio%2028%2C%20Desenzano%20del%20Garda%2C%2025015%2C%20Italy"
    pageTitle="MoS"
  />
);

export default MosDES;
