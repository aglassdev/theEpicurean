...
const CasaRispoli = () => (
  <RestaurantPage
    restaurantName="Casa Rispoli"
    address="piazza san Francesco 7, Cava de' Tirreni, 84013, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390899951261"
    website="https://www.casarispoli.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking a piazza surrounded by picturesque arcades in the historic centre (a walk around this district is highly recommended), this restaurant run by the Rispoli family continues to uphold its fine-dining traditions. Although a few meat dishes feature on the menu, it is its fish options (mainly traditional, such as tuna with mussels and escabeche-style aubergine) and occasionally imaginative desserts, such as the cheesecake with toffee and raspberry, that are the main attraction here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20san%20Francesco%207%2C%20Cava%20de'%20Tirreni%2C%2084013%2C%20Italy"
    pageTitle="Casa Rispoli"
  />
);

export default CasaRispoli;
