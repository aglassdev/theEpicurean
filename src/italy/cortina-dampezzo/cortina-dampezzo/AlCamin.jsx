...
const AlCamin = () => (
  <RestaurantPage
    ...
    address="località Alverà 99, Cortina d'Ampezzo, 32043, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390436862010"
    website="https://www.ristorantealcamin.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the road to Misurina lake, this friendly restaurant with a modern Alpine style offers dishes of the regional tradition with imaginative touches and modern technique. So a great deal of practicality, then, as in the beef tenderloin wrapped in speck dry-cured pork with cep mushrooms and Ampezzo-style potatoes. The chef and sommelier Fabio Pompanin manages a wine list with approximately 200 labels. In the warmer season, take advantage of the open-air service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Alver%C3%A0%2099%2C%20Cortina%20d'Ampezzo%2C%2032043%2C%20Italy"
    pageTitle="Al Camin"
  />
);

export default AlCamin;
