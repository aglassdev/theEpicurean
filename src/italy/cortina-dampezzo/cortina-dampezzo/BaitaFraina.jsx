...
const BaitaFraina = () => (
  <RestaurantPage
    restaurantName="Baita Fraina"
    address="Località Fraina 1, Cortina d'Ampezzo, 32043, Italy"
    cuisine="Country cooking, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3904363634"
    website="https://www.baitafraina.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Warm little bar rooms, reminiscent of the German wine bars or Stube, a summer terrace and well - prepared regional dishes: for those who want to escape the mundane life of Cortina for the silence of an isolated baita [mountain hut]. Delightful rooms, colourfully furnished in warm tones so you can better enjoy the silence and scents of the mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Fraina%201%2C%20Cortina%20d'Ampezzo%2C%2032043%2C%20Italy"
    pageTitle="Baita Fraina"
  />
);

export default BaitaFraina;
