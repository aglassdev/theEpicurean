...
const VecchiaMarina = () => (
  <RestaurantPage
    restaurantName="Vecchia Marina"
    address="lungomare Trento 37, Roseto degli Abruzzi, 64026, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390858931170"
    website="https://guide.michelin.com/en/abruzzo/roseto-degli-abruzzi/restaurant/vecchia-marina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Vecchia Marina is renowned in the region (and further afield) for its superb fish and seafood and excellent value for money (the tasting menu priced at under 40 euros is truly extraordinary). Situated just a stone’s throw from the beach, the restaurant has a simple, informal feel, where the full focus is on the flavour of the fresh fish served in traditional dishes such as linguine with langoustine, garlic, olive oil and rosemary, and raw fish featuring the catch of the day. As you can imagine, booking well in advance is highly recommended!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=lungomare%20Trento%2037%2C%20Roseto%20degli%20Abruzzi%2C%2064026%2C%20Italy"
    pageTitle="Vecchia Marina"
  />
);

export default VecchiaMarina;
