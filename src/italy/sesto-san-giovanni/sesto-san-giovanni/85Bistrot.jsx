...
const EightFiveBistrot = () => (
  <RestaurantPage
    restaurantName="85 Bistrot"
    address="piazza Martiri di Via Fani 85, Sesto San Giovanni, 20099, Italy"
    cuisine="Lombardian, Italian"
    priceRange="€€"
    phoneNumber="+393498985891"
    website="https://www.85bistrotsesto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple, modern, family-run trattoria with a welcoming ambience is the kind of restaurant that everyone would love to have as their local. The owner-chef, who has plenty of experience working in Milanese restaurants, is a real culinary expert who creates traditional dishes from Milan but also from further afield. Here, the popular breaded cutlet is served thick so that the delicate flavour of the veal can be enjoyed to the full...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Martiri%20di%20Via%20Fani%2085%2C%20Sesto%20San%20Giovanni%2C%2020099%2C%20Italy"
    pageTitle="85 Bistrot"
  />
);

export default EightFiveBistrot;
