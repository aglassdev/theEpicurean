...
const DoppioGusto = () => (
  <RestaurantPage
    restaurantName="Doppio Gusto"
    address="via Luigi Rizzo 1/2, Milazzo, 98057, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390909240045"
    website="https://ristorantedoppiogusto.it/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fish specialities take pride of place on the menu of this elegant, contemporary - style restaurant with friendly, informal service. Good selection of wines, also available by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Luigi%20Rizzo%201%2F2%2C%20Milazzo%2C%2098057%2C%20Italy"
    pageTitle="Doppio Gusto"
  />
);

export default DoppioGusto;
