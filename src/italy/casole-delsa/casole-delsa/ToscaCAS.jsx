...
const ToscaCAS = () => (
  <RestaurantPage
    restaurantName="Tosca"
    address="località Querceto, Casole d'Elsa, 53031, Italy"
    cuisine="Mediterranean Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+390577961501"
    website="https://guide.michelin.com/en/toscana/casole-d-elsa/restaurant/tosca435462"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant has a charming decor that combines classic elegance and typical Tuscan features such as stone arches and walls, as well as stylish sofas and comfortable armchairs. The cuisine is heavily influenced by local traditions, albeit with a fresh and innovative twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Querceto%2C%20Casole%20d'Elsa%2C%2053031%2C%20Italy"
    pageTitle="Tosca"
  />
);

export default ToscaCAS;
