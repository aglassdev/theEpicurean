...
const OsteriaMood = () => (
  <RestaurantPage
    restaurantName="Osteria Mood"
    address="via Cesare Battisti 58, San Bartolomeo al Mare, 18016, Italy"
    cuisine="Ligurian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393339980201"
    website="https://osteriamood.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a few minutes from the seafront promenade in a quiet, residential district, this restaurant with a relaxing ambience serves delicious Ligurian cuisine with a focus on organic vegetables, fish and seafood (local whenever possible), and home-made bread, desserts and fresh pasta. In summer, meals are served by the swimming pool in the garden, while in winter, the welcoming covered veranda boasts extensive sea views...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cesare%20Battisti%2058%2C%20San%20Bartolomeo%20al%20Mare%2C%2018016%2C%20Italy"
    pageTitle="Osteria Mood"
  />
);

export default OsteriaMood;
