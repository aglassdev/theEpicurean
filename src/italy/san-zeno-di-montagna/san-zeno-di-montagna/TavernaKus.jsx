...
const TavernaKus = () => (
  <RestaurantPage
    restaurantName="Taverna Kus"
    address="contrada Castello 14, San Zeno di Montagna, 37010, Italy"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+390457285667"
    website="https://www.ristoranteveronatavernakus.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive restaurant situated on the western slopes of Monte Baldo overlooking Lake Garda, with a number of rustic yet elegant and welcoming dining rooms, including a bright veranda with partial views of the lake (enjoy the full vista from the outdoor terrace). Various culinary options feature on the menu, including meat, fish and vegetarian dishes, all colourful, full of flavour and beautifully cooked and prepared using mainly local and seasonal ingredients. The well-stocked and carefully chosen wine list deserves a special mention: among the 1 000 or more bottles stored in the old giasàra (underground cellar), you’re sure to find something you’ll enjoy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Castello%2014%2C%20San%20Zeno%20di%20Montagna%2C%2037010%2C%20Italy"
    pageTitle="Taverna Kus"
  />
);

export default TavernaKus;
