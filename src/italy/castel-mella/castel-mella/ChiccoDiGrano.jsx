...
const ChiccoDiGrano = () => (
  <RestaurantPage
    restaurantName="Chicco di Grano"
    address="viale dei Caduti del Lavoro 5, Castel Mella, 25030, Italy"
    cuisine="Lombardian"
    priceRange="€€"
    phoneNumber="+390303582055"
    website="https://www.ristorantechiccodigrano.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic, welcoming restaurant (two dining rooms with exposed beams) acts as the backdrop for traditional cuisine featuring meat and fish dishes alike, often cooked on the barbecue grill. The Fiorentina steaks and chops are well aged and cooked to perfection, resulting in extraordinary flavours that will satisfy even the most demanding of palates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20dei%20Caduti%20del%20Lavoro%205%2C%20Castel%20Mella%2C%2025030%2C%20Italy"
    pageTitle="Chicco di Grano"
  />
);

export default ChiccoDiGrano;
