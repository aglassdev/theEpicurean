...
const LoStuzzichino = () => (
  <RestaurantPage
    restaurantName="Lo Stuzzichino"
    address="via Deserto 1/a, Sant'Agata sui Due Golfi, 80061, Italy"
    cuisine="Campanian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390815330010"
    website="https://www.ristorantelostuzzichino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of Sant'Agata, this welcoming, informal restaurant boasts traditional ceramics and an open-view kitchen. When ordering your meal, make sure you ask the charismatic owner, who is a real connoisseur of Campanian cuisine, for his recommendations. The regional dishes are full of memorable flavours, with a focus on vegetables, many of which are grown in the restaurant’s own kitchen garden nearby. This is somewhere you’d happily come to eat every day!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Deserto%201%2Fa%2C%20Sant'Agata%20sui%20Due%20Golfi%2C%2080061%2C%20Italy"
    pageTitle="Lo Stuzzichino"
  />
);

export default LoStuzzichino;
