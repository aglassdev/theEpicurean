...
const TenutaDelGallo = () => (
  <RestaurantPage
    restaurantName="Tenuta del Gallo"
    address="Strada degli Ortacci 34, Macchie, 05022, Italy"
    cuisine="Italian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390744987112"
    website="https://tenutadelgallo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you dine indoors in the charming, romantic dining room or outdoors with views of the surrounding countryside, you’ll enjoy traditional local cuisine and classic Italian favourites at this restaurant. Our inspectors particularly enjoyed the excellent beef carpaccio with truffles and the local guinea fowl with chickpeas. Comfortable guestrooms are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Strada%20degli%20Ortacci%2034%2C%20Macchie%2C%2005022%2C%20Italy"
    pageTitle="Tenuta del Gallo"
  />
);

export default TenutaDelGallo;
