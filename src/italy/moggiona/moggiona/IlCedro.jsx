...
const IlCedro = () => (
  <RestaurantPage
    restaurantName="Il Cedro"
    address="via di Camaldoli 20, Moggiona, 52014, Italy"
    cuisine="Tuscan"
    priceRange="€"
    phoneNumber="+390575556080"
    website="https://ristorante-il-cedro.business.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the entrance of the village of Moggiona, along the road connecting Camaldoli to Poppi, Il Cedro welcomes you with homely aromas and genuine flavors. Mariangela and Cristina – one in the dining room, the other in the kitchen – share the Tuscan tradition with enthusiasm and warmth, offering rustic dishes, sincere smiles, and a family-like atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20di%20Camaldoli%2020%2C%20Moggiona%2C%2052014%2C%20Italy"
    pageTitle="Il Cedro"
  />
);

export default IlCedro;
