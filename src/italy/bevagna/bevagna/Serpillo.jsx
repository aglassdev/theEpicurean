...
const Serpillo = () => (
  <RestaurantPage
    restaurantName="Serpillo"
    address="via di Mezzo 1, località Torre del Colle, Bevagna, 06031, Italy"
    cuisine="Italian Contemporary, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+393667118212"
    website="https://serpillo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a charming medieval village which is also home to a couple of small hotels, this attractive, rustic restaurant in an old olive mill acts as the backdrop for regional and Italian cuisine. Dishes with a touch of modern flavour are presented on a menu which, although not extensive, offers good value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20di%20Mezzo%201%2C%20localit%C3%A0%20Torre%20del%20Colle%2C%20Bevagna%2C%2006031%2C%20Italy"
    pageTitle="Serpillo"
  />
);

export default Serpillo;
