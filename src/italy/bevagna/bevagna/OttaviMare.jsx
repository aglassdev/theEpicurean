...
const OttaviMare = () => (
  <RestaurantPage
    restaurantName="Ottavi Mare"
    address="Corso Amendola 8, Bevagna, 06031, Italy"
    cuisine="Contemporary, Seafood"
    priceRange="€€"
    phoneNumber="+3907421972325"
    website="https://www.ottavimare.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Bevagna, just steps from the picturesque Piazza Filippo Silvestri, this small, welcoming, and well-cared-for restaurant offers cuisine that blends seafood flavors with Umbrian tradition, serving balanced yet never predictable dishes. There are three tasting menus, each available in full or reduced versions, allowing for a personalized culinary journey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corso%20Amendola%208%2C%20Bevagna%2C%2006031%2C%20Italy"
    pageTitle="Ottavi Mare"
  />
);

export default OttaviMare;
