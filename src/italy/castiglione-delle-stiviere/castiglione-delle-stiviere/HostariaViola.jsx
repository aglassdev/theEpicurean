...
const HostariaViola = () => (
  <RestaurantPage
    restaurantName="Hostaria Viola"
    address="via Verdi 32, Castiglione delle Stiviere, 46043, Italy"
    cuisine="Mantuan, Lombardian"
    priceRange="€€"
    phoneNumber="+390376670000"
    website="https://www.hostariaviola.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having run this simple yet welcoming restaurant for over 100 years, it’s no surprise that the family at the helm here are true connoisseurs of Mantuan culinary traditions! The menu pays tribute to the delicious cuisine of Mantova featuring a host of celebrated and lesser-known specialities, including sorbir (filled pasta in broth), excellent cured hams, pike seasoned with a Mantuan sauce (made from anchovies and capers) served with polenta or mashed potatoes and, to finish, the renowned sbrisolona cake or zabaglione ice cream. There are so many specialities, you won’t be disappointed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Verdi%2032%2C%20Castiglione%20delle%20Stiviere%2C%2046043%2C%20Italy"
    pageTitle="Hostaria Viola"
  />
);

export default HostariaViola;
