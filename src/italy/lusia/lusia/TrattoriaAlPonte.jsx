...
const TrattoriaAlPonte = () => (
  <RestaurantPage
    restaurantName="Trattoria al Ponte"
    address="via Bertolda 27, località Bornio, Lusia, 45020, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+390425669890"
    website="https://www.trattorialponte.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Meat and freshwater fish feature on the menu at this restaurant, where the chef creates traditional dishes with an imaginative twist, such as his legendary risotto (made from seasonal ingredients) and breast of guinea fowl with mustard. An oasis surrounded by greenery, situated right by a bridge, and embellished by a small illuminated pool...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bertolda%2027%2C%20localit%C3%A0%20Bornio%2C%20Lusia%2C%2045020%2C%20Italy"
    pageTitle="Trattoria al Ponte"
  />
);

export default TrattoriaAlPonte;
