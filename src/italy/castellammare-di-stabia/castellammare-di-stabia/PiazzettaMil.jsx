...
const PiazzettaMil = () => (
  <RestaurantPage
    restaurantName="Piazzetta Milù"
    address="corso Alcide De Gasperi 23, Castellammare di Stabia, 80053, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390818715779"
    website="https://piazzettamilu.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It’s impossible to describe this restaurant without mentioned the delightful welcome offered by the Izzo family, all of whom work hard to ensure that your dining experience at Piazzetta Milù is truly memorable. Maicol, who won Michelin’s Young Chef Award in 2024, is at the helm in the kitchen, where he creates one long surprise tasting menu. He skilfully blends techniques learned throughout his career in other kitchens with his own unique and creative ideas, resulting in dishes such as the delicious tagliolini made from cardoncelli mushrooms, flavoured with butter and mature parmesan cheese and sprinkled with white truffle (once the dish is finished, the sauce can be mopped up with a fake slice of bread, also made from mushroom). Your dining experience begins in the wine cellar, where the ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Alcide%20De%20Gasperi%2023%2C%20Castellammare%20di%20Stabia%2C%2080053%2C%20Italy"
    pageTitle="Piazzetta Milù"
  />
);

export default PiazzettaMil;
