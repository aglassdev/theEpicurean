...
const AlessandroFeo = () => (
  <RestaurantPage
    restaurantName="Alessandro Feo"
    address="via Angelo Lista 24, Marina di Casal Velino, 84040, Italy"
    cuisine="Campanian, Seafood"
    priceRange="€€"
    phoneNumber="+393288937083"
    website="https://www.alessandrofeoristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a beautiful stone-vaulted building (an old 17C monastery) on the town’s seafront promenade, young owner-chef Alessandro Feo has made his mark in this region that perhaps has fewer gourmet restaurants than many places elsewhere. Here, he creates dishes that combine traditional influences and classic favourites from Campania with his own individual flair and creativity. His focus is on local, seasonal ingredients, including produce from his two kitchen gardens and fish sourced from local fishermen as well as from his own ventures out to sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Angelo%20Lista%2024%2C%20Marina%20di%20Casal%20Velino%2C%2084040%2C%20Italy"
    pageTitle="Alessandro Feo"
  />
);

export default AlessandroFeo;
