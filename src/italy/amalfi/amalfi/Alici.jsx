...
const Alici = () => (
  <RestaurantPage
    restaurantName="Alici"
    address="via Giovanni Augustariccio 33, Amalfi, 84011, Italy"
    cuisine="Campanian, Contemporary"
    priceRange="€€€€"
    phoneNumber="+39089831148"
    website="https://borgosantandrea.it/it/dining/ristorante-alici/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Borgo Santandrea is a luxurious hotel along the Amalfi Coast, just outside Conca dei Marini, and Alici is its fineding, both symbols of Italian beauty. Beyond an interior dining room with vintage-style furniture, dinners always take place on the magnificent terrace with its blue and azure majolica floor, reverberating the splendour of the sky and sea. Chef Crescenzo Scotti clearly loves pleasant places: we remember him previously in Ravello and before that - with a star - on the island of Vulcano. Here he returns with skill and expertise to his favourite territory, that is, the flavours of the Amalfi Coast (sfusato amalfitano can be found in many recipes), but also those of Naples and his native Ischia, always adding a touch of fantasy. The inspector liked: “Cappuccino Mediterraneo”, that ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giovanni%20Augustariccio%2033%2C%20Amalfi%2C%2084011%2C%20Italy"
    pageTitle="Alici"
  />
);
