...
const MarinaGrande = () => (
  <RestaurantPage
    restaurantName="Marina Grande"
    address="viale delle Regioni 4, Amalfi, 84011, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39089871129"
    website="https://www.ristorantemarinagrande.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated directly on the beach, this pleasant restaurant with a contemporary decor boasts splendid sea views and a small private beach club. Although the setting obviously has a tourist feel, the traditional cuisine served here is full of flavour. We particularly recommend the “gamberi in carrozza” (shrimp) with fior di latte and a variation on puttanesca sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20delle%20Regioni%204%2C%20Amalfi%2C%2084011%2C%20Italy"
    pageTitle="Marina Grande"
  />
);

export default MarinaGrande;
