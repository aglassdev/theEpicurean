...
const MeCumpariTuriddu = () => (
  <RestaurantPage
    restaurantName="Me Cumpari Turiddu"
    address="piazza Turi Ferro 36, Catania, 95124, Italy"
    cuisine="Sicilian"
    priceRange="€"
    phoneNumber="+390957150142"
    website="https://www.mecumparituriddu.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its old chandeliers, chairs and tables, this original and attractive restaurant offers its guests a feel of traditional Sicily. The cuisine focuses on typical Sicilian specialities, as well as offering a simpler, less expensive bistro menu. There’s also a shop selling food produce and a cocktail bar, which is open non-stop from 11. 30am until the early hours of the morning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Turi%20Ferro%2036%2C%20Catania%2C%2095124%2C%20Italy"
    pageTitle="Me Cumpari Turiddu"
  />
);

export default MeCumpariTuriddu;
