...
const MateriaSpazioCucina = () => (
  <RestaurantPage
    restaurantName="Materia | Spazio Cucina"
    address="via Teatro Massimo 29, Catania, 95131, Italy"
    cuisine="Sicilian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+3909516931045"
    website="https://www.materiaspaziocucina.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Teatro%20Massimo%2029%2C%20Catania%2C%2095131%2C%20Italy"
    pageTitle="Materia | Spazio Cucina"
  />
);

export default MateriaSpazioCucina;
