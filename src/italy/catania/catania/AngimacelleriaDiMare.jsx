...
const AngimacelleriaDiMare = () => (
  <RestaurantPage
    restaurantName="Angiò-Macelleria di Mare"
    address="viale Africa 28/h, Catania, 95129, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+393351613701"
    website="https://albertoangiolucci.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Africa%2028%2Fh%2C%20Catania%2C%2095129%2C%20Italy"
    pageTitle="Angiò-Macelleria di Mare"
  />
);

export default AngimacelleriaDiMare;
