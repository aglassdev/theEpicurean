...
const ConcezioneRestaurant = () => (
  <RestaurantPage
    restaurantName="Concezione Restaurant"
    address="via Giuseppe Verdi 143, Catania, 95129, Italy"
    cuisine="Creative, Sicilian"
    priceRange="€€€"
    phoneNumber="+3909516936122"
    website="https://concezionerestaurant.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Verdi%20143%2C%20Catania%2C%2095129%2C%20Italy"
    pageTitle="Concezione Restaurant"
  />
);

export default ConcezioneRestaurant;
