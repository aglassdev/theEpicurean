...
const DoliaGaeta = () => (
  <RestaurantPage
    restaurantName="Dolia Gaeta"
    address="piazza Conca 22, Gaeta, 04024, Italy"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+39077165129"
    website="https://www.doliarestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This brand-new restaurant boasts an elegant, chic decor and a relaxed and informal ambience. The very young team here is overseen by a talented chef who prepares modern and creative dishes with a focus on fish from the local gulf, as well as elsewhere. The wine list is also particularly interesting, featuring a remarkable choice of champagnes and a special emphasis on labels from Lazio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Conca%2022%2C%20Gaeta%2C%2004024%2C%20Italy"
    pageTitle="Dolia Gaeta"
  />
);

export default DoliaGaeta;
