...
const OsteriaDellocaBianca = () => (
  <RestaurantPage
    restaurantName="Osteria dell'Oca Bianca"
    address="via Umberto I 2, Cavaglià, 13881, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390161966833"
    website="https://www.osteriadellocabianca.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of a small town, right opposite the church, this typical village osteria run by a friendly family serves traditional cuisine from the Piedmont, including goose dishes. Highlights here include the rustic, welcoming ambience, an excellent wine list, a wine cellar that can be visited, and a charming glass-fronted veranda that is used throughout the year. There are also three beautiful guestrooms reserved exclusively for guests dining at the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Umberto%20I%202%2C%20Cavagli%C3%A0%2C%2013881%2C%20Italy"
    pageTitle="Osteria dell'Oca Bianca"
  />
);

export default OsteriaDellocaBianca;
