...
const AlBorgo = () => (
  <RestaurantPage
    restaurantName="Al Borgo"
    address="via Anconetta 8, Belluno, 32100, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390437926755"
    website="https://www.alborgo.to/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed within an 18C villa in a small traditional hamlet, this restaurant with a warm rustic ambience serves regional cuisine. The Gioie del Borgo (home produced salami and sausages), barley and bean soup, and homemade ice cream are all highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Anconetta%208%2C%20Belluno%2C%2032100%2C%20Italy"
    pageTitle="Al Borgo"
  />
);

export default AlBorgo;
