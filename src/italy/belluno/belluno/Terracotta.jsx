...
const Terracotta = () => (
  <RestaurantPage
    restaurantName="Terracotta"
    address="Via Garibaldi 61, Belluno, 32100, Italy"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390437291692"
    website="https://ristoranteterracotta.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the old town, this small, cosy restaurant serves delicious cuisine, with dishes sometimes inspired by Italian and international recipes, but often revisited in a unique way. In summer, you can dine on the terrace under a beautiful wisteria tree...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Garibaldi%2061%2C%20Belluno%2C%2032100%2C%20Italy"
    pageTitle="Terracotta"
  />
);
