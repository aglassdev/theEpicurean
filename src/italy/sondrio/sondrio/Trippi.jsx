...
const Trippi = () => (
  <RestaurantPage
    restaurantName="Trippi"
    address="via Stelvio 297, loc. Montagna in Valtellina, Sondrio, 23020, Italy"
    cuisine="Cuisine from Valtellina, Lombardian"
    priceRange="€€"
    phoneNumber="+390342615584"
    website="https://www.ristorantetrippi.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established restaurant just outside Sondrio has been run for the past decade by Gianluca, whose experience injects new life into traditional dishes from the local region, as well as introducing the occasional Mediterranean twist. There’s a simpler menu at lunchtime, plus a good selection of local wines and cheeses on sale at takeaway prices near the restaurant entrance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Stelvio%20297%2C%20loc.%20Montagna%20in%20Valtellina%2C%20Sondrio%2C%2023020%2C%20Italy"
    pageTitle="Trippi"
  />
);
