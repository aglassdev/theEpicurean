...
const Between = () => (
  <RestaurantPage
    restaurantName="Between"
    address="viale Partigiani d'Italia 98/c, Rivoli, 10098, Italy"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+393286425306"
    website="https://www.betweenristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This top-quality restaurant occupies just one simple, minimalist-style dining room, where the young female chef serves a happy combination of Piedmontese ingredients and more creative dishes acquired during her time working abroad...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Partigiani%20d'Italia%2098%2Fc%2C%20Rivoli%2C%2010098%2C%20Italy"
    pageTitle="Between"
  />
);
