...
const TerreAlte = () => (
  <RestaurantPage
    restaurantName="Terre Alte"
    address="via Olmadella 11, località Balignano, Longiano, 47020, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+390547666138"
    website="https://ristoranteterrealte.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best-known addresses in this region for fish enthusiasts, this restaurant serves freshly caught fish prepared in simple, traditional dishes that allow the quality of the flavour to shine through. A good wine list (particularly champagnes) and a panoramic terrace add to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Olmadella%2011%2C%20localit%C3%A0%20Balignano%2C%20Longiano%2C%2047020%2C%20Italy"
    pageTitle="Terre Alte"
  />
);

export default TerreAlte;
