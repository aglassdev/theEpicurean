...
const DeiCantoni = () => (
  <RestaurantPage
    restaurantName="Dei Cantoni"
    address="via Santa Maria 19, Longiano, 47020, Italy"
    cuisine="Cuisine from Romagna"
    priceRange="€€"
    phoneNumber="+390547665899"
    website="https://ristorantedeicantoni.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a picturesque historic hamlet with a castle once inhabited by the Malatesta dynasty, this restaurant boasts a charming and traditional dining room. The delicious cuisine is the star of the show here, featuring imaginative dishes showcasing ingredients from the Romagna region, as well as more classic recipes such as pasta with carbonara and amatriciana sauces. All the fresh pasta is home made...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santa%20Maria%2019%2C%20Longiano%2C%2047020%2C%20Italy"
    pageTitle="Dei Cantoni"
  />
);

export default DeiCantoni;
