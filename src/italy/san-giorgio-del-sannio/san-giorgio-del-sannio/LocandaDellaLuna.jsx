...
const LocandaDellaLuna = () => (
  <RestaurantPage
    restaurantName="Locanda della Luna"
    address="via delle Oche 7, San Giorgio del Sannio, 82018, Italy"
    cuisine="Campanian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+393200478609"
    website="https://www.locandadellaluna.net"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a remote location in the Sannio, this authentic inn offers fine views from its well-kept dining room-cum-veranda and outdoor terrace. The owner-chef creates dishes with a regional flavour using produce from his own garden, without straying too far from local traditions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20delle%20Oche%207%2C%20San%20Giorgio%20del%20Sannio%2C%2082018%2C%20Italy"
    pageTitle="Locanda della Luna"
  />
);

export default LocandaDellaLuna;
