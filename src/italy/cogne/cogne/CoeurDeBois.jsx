...
const CoeurDeBois = () => (
  <RestaurantPage
    restaurantName="Coeur de Bois"
    address="viale Cavagnet 31, Cogne, 11012, Italy"
    cuisine="Cuisine from the Aosta Valley, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39016574030"
    website="https://miramonticogne.com/coeur-de-bois/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this elegant restaurant was inspired by its wooden ceiling. Surrounded by spruce decor dating from the 18C, antique furniture and paintings, enjoy interesting traditional cuisine in this excellent gourmet restaurant, which is all the more attractive thanks to its location in the Gran Paradiso national park...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Cavagnet%2031%2C%20Cogne%2C%2011012%2C%20Italy"
    pageTitle="Coeur de Bois"
  />
);

export default CoeurDeBois;
