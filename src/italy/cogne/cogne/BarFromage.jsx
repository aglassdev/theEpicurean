...
const BarFromage = () => (
  <RestaurantPage
    restaurantName="Bar à Fromage"
    address="rue Grand Paradis 20, Cogne, 11012, Italy"
    cuisine="Cuisine from the Aosta Valley, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390165749696"
    website="https://www.hotelbellevue.it/it/ristoranti/view/bar-a-fromage-restaurant-de-montagne"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosy, elegant Stube-style restaurant where the staff wear typical Aosta Valley costume and the menu features dishes with a particular focus on cheese (including an excellent fondue!) alongside traditional regional fare. Typical decor with refined, personalised furnishings and a profusion of wood...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Grand%20Paradis%2020%2C%20Cogne%2C%2011012%2C%20Italy"
    pageTitle="Bar à Fromage"
  />
);

export default BarFromage;
