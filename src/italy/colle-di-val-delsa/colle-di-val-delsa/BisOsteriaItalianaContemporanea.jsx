...
const BisOsteriaItalianaContemporanea = () => (
  <RestaurantPage
    restaurantName="Bis Osteria Italiana Contemporanea"
    address="Via 20 Settembre 50, Colle di Val d'Elsa, 53034, Italy"
    cuisine="Seasonal Cuisine, Tuscan"
    priceRange="€€"
    phoneNumber="+393387706128"
    website="https://www.osteriabis.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the glorious premises of the old Arnolfo restaurant in the old town, this restaurant is run by the same management as previously, although with a new young chef at the helm in the kitchen. The delicious yet concise menu features “Italian specialities” (the name given to all the main courses) with a focus on meat and fish, accompanied by excellent bread options (you can even order “scarpetta” dipping bread for mopping up the remains of a Cinta Senese pork sauce). The house speciality is a delicious pigeon dish. In fine weather, guests can dine on the beautiful, tranquil terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%2020%20Settembre%2050%2C%20Colle%20di%20Val%20d'Elsa%2C%2053034%2C%20Italy"
    pageTitle="Bis Osteria Italiana Contemporanea"
  />
);

export default BisOsteriaItalianaContemporanea;
