...
const Arnolfo = () => (
  <RestaurantPage
    restaurantName="Arnolfo"
    address="viale della Rimembranza 24, Colle di Val d'Elsa, 53034, Italy"
    cuisine="Creative, Country cooking"
    priceRange="€€€€"
    phoneNumber="+390577920549"
    website="https://www.arnolfo.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With sharp lines created by the use of iron and glass, this modern building is especially designed to allow guests to admire the views from wherever they’re sitting. To the rear of the dining room, the large open-view kitchen framed by a superb yellow Siena marble wall is home to chef Gaetano Trovato (Mentor Chef Award 2024) and his team. Although there are three tasting menus available, one of which is vegetarian, any of the courses can also be chosen à la carte style. We could say so much about Arnolfo’s cuisine, but we’ll limit ourselves to mentioning the bread (which has been central to this chef’s work from the very beginning), duck, Chianina beef, Valdarno chicken and the ice-cream which always features among the desserts. Our inspector particularly enjoyed the delightful amuse-bouch..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20della%20Rimembranza%2024%2C%20Colle%20di%20Val%20d'Elsa%2C%2053034%2C%20Italy"
    pageTitle="Arnolfo"
  />
);

export default Arnolfo;
