...
const LaRosina = () => (
  <RestaurantPage
    restaurantName="La Rosina"
    address="via Marchetti 4, Marostica, 36063, Italy"
    cuisine="Venetian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390424470360"
    website="https://larosina.it/ristorante"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With over 100 years of history behind it, La Rosina is still looking good, thanks to renovation work carried out a few years ago which has given the restaurant a new look. Situated in an attractive location in the hills around Marostica, this excellent restaurant is a sound choice for good food in the province of Vicenza, serving modern regional and Italian dishes which are full of flavour. Enjoy beautiful views of the surrounding hills from the guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marchetti%204%2C%20Marostica%2C%2036063%2C%20Italy"
    pageTitle="La Rosina"
  />
);

export default LaRosina;
