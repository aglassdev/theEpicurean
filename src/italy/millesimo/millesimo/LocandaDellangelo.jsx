...
const LocandaDellangelo = () => (
  <RestaurantPage
    restaurantName="Locanda dell'Angelo"
    address="via Roma 30, Millesimo, 17017, Italy"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393462290629"
    website="https://www.locandadellangelomillesimo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish, elegant restaurant occupying a historic 17C building in an attractive medieval village serves contemporary cuisine which is influenced by recipes and ingredients from Liguria and Piedmont alike. Dishes include Ligurian-style rabbit terrine with a pine nut and gravy sauce, and Piedmontese white suckling pig tomahawk on sauerkraut with a spicy, sour apple sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2030%2C%20Millesimo%2C%2017017%2C%20Italy"
    pageTitle="Locanda dell'Angelo"
  />
);

export default LocandaDellangelo;
