...
const AlbergaccioDiCastellina = () => (
  <RestaurantPage
    restaurantName="Albergaccio di Castellina"
    address="via Fiorentina 63, Castellina in Chianti, 53011, Italy"
    cuisine="Tuscan, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390577741042"
    website="https://www.ristorantealbergaccio.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic but stylish establishment is in wood and stone. Find Tuscan cuisine that leans towards imaginative dishes, without betraying regional flavours and produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Fiorentina%2063%2C%20Castellina%20in%20Chianti%2C%2053011%2C%20Italy"
    pageTitle="Albergaccio di Castellina"
  />
);

export default AlbergaccioDiCastellina;
