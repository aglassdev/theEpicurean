...
const LocandaDelMolino = () => (
  <RestaurantPage
    restaurantName="Locanda del Molino"
    address="località Montanare 10, Cortona, 52044, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390575614016"
    website="https://www.locandadelmolino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This rustic yet charming restaurant occupies an old family mill. It has attractive guestrooms that reflect the elegant simplicity of the Tuscan countryside. In the kitchen, the female chef creates traditional specialities such as fried rabbit and nettle with ricotta cheese gnudi (ravioli filling without the pasta) in a fresh tomato sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Montanare%2010%2C%20Cortona%2C%2052044%2C%20Italy"
    pageTitle="Locanda del Molino"
  />
);

export default LocandaDelMolino;
