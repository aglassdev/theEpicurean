...
const EnotecaMeucci = () => (
  <RestaurantPage
    restaurantName="Enoteca Meucci"
    address="Località Riccio 71, Cortona, 52044, Italy"
    cuisine="Tuscan, Contemporary"
    priceRange="€€"
    phoneNumber="+393331965439"
    website="https://enotecameucci.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a restored farmhouse at the foot of Cortona, this restaurant has two different dining areas: a wine bar on the ground floor where you can enjoy excellent aperitifs or buy local food produce, and a restaurant on the first floor that serves a traditional yet constantly evolving menu with a focus on seasonal ingredients. There’s also a beautiful outdoor space for summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Riccio%2071%2C%20Cortona%2C%2052044%2C%20Italy"
    pageTitle="Enoteca Meucci"
  />
);

export default EnotecaMeucci;
