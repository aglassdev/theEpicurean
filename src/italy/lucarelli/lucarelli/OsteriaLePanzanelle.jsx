...
const OsteriaLePanzanelle = () => (
  <RestaurantPage
    restaurantName="Osteria Le Panzanelle"
    address="località Lucarelli 29, Lucarelli, 53017, Italy"
    cuisine="Tuscan"
    priceRange="€€"
    phoneNumber="+390577733511"
    website="https://www.lepanzanelle.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasant rural trattoria has a simple, informal ambience, plus an attractive outdoor space in the shady garden. Wherever you sit, you’ll savour generous portions of delicious regional cuisine, including home-made pasta and excellent meat – we particularly enjoyed the pici pasta with garlic and the rabbit stuffed with spinach. Fresh fish from the island of Elba is served on Fridays, while the wine list focuses on Tuscan labels. It’s always a good idea to book ahead!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Lucarelli%2029%2C%20Lucarelli%2C%2053017%2C%20Italy"
    pageTitle="Osteria Le Panzanelle"
  />
);

export default OsteriaLePanzanelle;
