...
const OsteriaIlBagatto = () => (
  <RestaurantPage
    restaurantName="Osteria Il Bagatto"
    address="via XX Settembre 16, Limone Piemonte, 12015, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390171927543"
    website="https://www.releven11.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled amid the stone houses of Limone Piemonte, this charming gourmet restaurant is situated in a typical historic passageway. Influenced by the seasons and the chef’s creative skills, the menu includes interesting dishes such as char, gnocchi with blue goat’s cheese and delicious sweetbreads in butter with cannellini beans and cavolo nero. To accompany your meal, you might like to indulge in a bottle of vintage Barolo chosen from the concise yet carefully chosen wine list. The 2013 Michele Chiarlo Barolo Cerequio, produced in a cold and rainy year, has aged well thanks to its powerful tannins...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XX%20Settembre%2016%2C%20Limone%20Piemonte%2C%2012015%2C%20Italy"
    pageTitle="Osteria Il Bagatto"
  />
);

export default OsteriaIlBagatto;
