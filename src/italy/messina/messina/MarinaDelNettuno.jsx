...
const MarinaDelNettuno = () => (
  <RestaurantPage
    restaurantName="Marina del Nettuno"
    address="viale della Libertà-Batteria Masotto, Messina, 98121, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+393472890478"
    website="https://www.ristorantemarinadelnettuno.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As its name suggests, this restaurant and lounge bar is situated right on the jetty of the Yachting Club Messina. Elegant and minimalist - style decor, as well as creative cuisine with a focus on fish dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20della%20Libert%C3%A0-Batteria%20Masotto%2C%20Messina%2C%2098121%2C%20Italy"
    pageTitle="Marina del Nettuno"
  />
);

export default MarinaDelNettuno;
