...
const JosefStube = () => (
  <RestaurantPage
    restaurantName="Josef Stube"
    address="Località Certosa 29, Madonna di Senales, 39020, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390473679130"
    website="https://www.goldenerose.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run with passion by the two owners who continue the long family tradition in this hotel-restaurant is one of the most picturesque sights in the Val Senales. Its beautifully kept dining room is romantic and typical of the region, providing a backdrop for just a few dishes which are prepared by the chef with a focus on local ingredients. A hint of Mediterranean influence adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Certosa%2029%2C%20Madonna%20di%20Senales%2C%2039020%2C%20Italy"
    pageTitle="Josef Stube"
  />
);

export default JosefStube;
