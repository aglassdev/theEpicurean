...
const IlGiurista = () => (
  <RestaurantPage
    restaurantName="Il Giurista"
    address="via Bartolo 30, Perugia, 06122, Italy"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390753748749"
    website="http://www.ristoranteilgiurista.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bartolo%2030%2C%20Perugia%2C%2006122%2C%20Italy"
    pageTitle="Il Giurista"
  />
);

export default IlGiurista;
