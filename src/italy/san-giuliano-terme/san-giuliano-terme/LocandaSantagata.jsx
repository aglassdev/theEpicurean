...
const LocandaSantagata = () => (
  <RestaurantPage
    restaurantName="Locanda Sant'Agata"
    address="via del Brennero, SS 12 km 5,812, San Giuliano Terme, 55016, Italy"
    cuisine="Contemporary, Tuscan"
    priceRange="€€€"
    phoneNumber="+390507212532"
    website="https://www.locandasantagata.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Not far from the village, this pleasant boutique hotel is home to a friendly, well-kept restaurant surrounded by a relaxing garden where guests can enjoy alfresco dining in summer. The menu features traditional meat and fish dishes with the occasional modern, personalised twist, such as “calamarotto” – squid (calamaro) stuffed with seafood pancotto, vegetables in dry vermouth and confit plum tomatoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Brennero%2C%20SS%2012%20km%205%2C812%2C%20San%20Giuliano%20Terme%2C%2055016%2C%20Italy"
    pageTitle="Locanda Sant'Agata"
  />
);

export default LocandaSantagata;
