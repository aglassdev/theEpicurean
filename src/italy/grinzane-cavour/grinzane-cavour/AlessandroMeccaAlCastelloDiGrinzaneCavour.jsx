...
const AlessandroMeccaAlCastelloDiGrinzaneCavour = () => (
  <RestaurantPage
    restaurantName="Alessandro Mecca al Castello di Grinzane Cavour"
    address="via Castello 5, Grinzane Cavour, 12060, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393755403500"
    website="https://www.alessandromecca.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s no shortage of classic Piedmontese ingredients (such as anchovies, peppers and veal) on the menu at this restaurant, where traditional recipes are reinterpreted with a personalised and contemporary touch. Dishes from outside the region, including various fish-based options, also feature, while the restaurant aims to avoid food waste by using every single part of its ingredients where possible. The location in a splendid castle with 11C origins, once the home of Camillo Benso, count of Cavour, adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castello%205%2C%20Grinzane%20Cavour%2C%2012060%2C%20Italy"
    pageTitle="Alessandro Mecca al Castello di Grinzane Cavour"
  />
);

export default AlessandroMeccaAlCastelloDiGrinzaneCavour;
