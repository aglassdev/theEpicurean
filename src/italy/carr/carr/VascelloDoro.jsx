...
const VascelloDoro = () => (
  <RestaurantPage
    restaurantName="Vascello d'Oro"
    address="via San Giuseppe 9, Carrù, 12061, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+39017375478"
    website="https://www.vascellodoro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business since 1887, this restaurant with warm traditional decor is situated in the town famous for bue grasso (“fat ox”), which you’ll find on the menu here from November to Easter. Enjoy typical, popular dishes from the Piedmont, such as meat and vegetable filled ravioli, finanziera stew, fried dishes, Russian salad and, of course, the famous boiled meats, all skilfully prepared in the traditional way. Desserts such as hazelnut cake and bonet provide a final flourish for the tastebuds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Giuseppe%209%2C%20Carr%C3%B9%2C%2012061%2C%20Italy"
    pageTitle="Vascello d'Oro"
  />
);

export default VascelloDoro;
