...
const LaPajaraGourmet = () => (
  <RestaurantPage
    restaurantName="La Pajara Gourmet"
    address="via Venezia 28, Fiera di Primiero, 38054, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€"
    phoneNumber="+390439763171"
    website="https://www.lapajaragourmet.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the Castel Pietra hotel, this pleasant restaurant with a combination of traditional and modern decor serves contemporary-style meat (often with a regional focus) and fish dishes which represent the different origins of the restaurant owners: the husband comes from Salento, while the wife is from the mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Venezia%2028%2C%20Fiera%20di%20Primiero%2C%2038054%2C%20Italy"
    pageTitle="La Pajara Gourmet"
  />
);

export default LaPajaraGourmet;
