...
const CalviRistorante = () => (
  <RestaurantPage
    restaurantName="Calvi Ristorante"
    address="via Bari 134, Altamura, 70022, Italy"
    cuisine="Contemporary"
    priceRange="€"
    phoneNumber="+390803142942"
    website="https://www.calviristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This welcoming, contemporary-style restaurant with a large open-view kitchen serves two different types of cuisine – one regional and Mediterranean in style, the other more creative allowing the chef’s culinary skills to take centre stage. The black rice tacos with roasted eel, green beans, soya bean sprouts and spicy hummus mayo are truly delicious – definitely to be eaten with the hands!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bari%20134%2C%20Altamura%2C%2070022%2C%20Italy"
    pageTitle="Calvi Ristorante"
  />
);

export default CalviRistorante;
