...
const LaChandelle = () => (
  <RestaurantPage
    restaurantName="La Chandelle"
    address="via Piolet 1, Breuil Cervinia, 11021, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€€"
    phoneNumber="+390166948998"
    website="https://www.hotelhermitage.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Part of the famous Hotel Hermitage, this spacious, Alpine-style restaurant serves classic, unfussy cuisine alongside a selection of traditional options and luxury ingredients such as oysters, lobster and Florentine steak. Meat cooked over the grill in the evenings, fine views of the surrounding mountains and an excellent wine list complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Piolet%201%2C%20Breuil%20Cervinia%2C%2011021%2C%20Italy"
    pageTitle="La Chandelle"
  />
);

export default LaChandelle;
