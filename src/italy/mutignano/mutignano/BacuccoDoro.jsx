...
const BacuccoDoro = () => (
  <RestaurantPage
    restaurantName="Bacucco d'Oro"
    address="via del Pozzo 10, Mutignano, 64025, Italy"
    cuisine="Cuisine from Abruzzo, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+39085936227"
    website="https://guide.michelin.com/en/abruzzo/mutignano/restaurant/bacucco-d-oro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the coast, you take a winding road uphill to this family-run trattoria which boasts sea views from its terrace. Apart from the salted cod, the menu only features meat dishes, with a focus on simple, traditional Abruzzo specialties. These include arrosticini (skewered grilled meat), fragrant mushrooms, barbecued meat and delicious “pizza dogge”, the latter a type of layered dessert with sponge cake, custard, confectioner’s cream and Alkermes liqueur. The concise wine list also focuses on the Abruzzo...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Pozzo%2010%2C%20Mutignano%2C%2064025%2C%20Italy"
    pageTitle="Bacucco d'Oro"
  />
);

export default BacuccoDoro;
