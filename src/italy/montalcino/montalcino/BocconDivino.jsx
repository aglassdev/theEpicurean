...
const BocconDivino = () => (
  <RestaurantPage
    restaurantName="Boccon DiVino"
    address="via Traversa dei Monti 201, località Colombaio Tozzi, Montalcino, 53024, Italy"
    cuisine="Tuscan, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390577848233"
    website="https://www.boccondivinomontalcino.it/web/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a farmhouse on the edges of town, this restaurant has a rustic dining area with modern tables and chairs and a beautiful summer terrace with a view. Authentic local dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Traversa%20dei%20Monti%20201%2C%20localit%C3%A0%20Colombaio%20Tozzi%2C%20Montalcino%2C%2053024%2C%20Italy"
    pageTitle="Boccon DiVino"
  />
);

export default BocconDivino;
