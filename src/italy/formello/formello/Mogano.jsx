...
const Mogano = () => (
  <RestaurantPage
    restaurantName="Mogano"
    address="via del Praticello Alto 7, Formello, 00060, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+393886346424"
    website="https://www.moganorestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aiming to promote craft beers as a worthy pairing for gourmet cuisine, the Faenza family opened Mogano – a modern, elegant restaurant with a wood-inspired decor, soft lighting and just five tables, right next to their Ritual Lab brewery. One of the sons (Matteo, the chef here) greets guests before dinner with an aperitif served in the kitchen. With plenty of international culinary experience behind him, he combines Italian flavours with influences from all around the world. Despite the focus on beer, a wine list is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Praticello%20Alto%207%2C%20Formello%2C%2000060%2C%20Italy"
    pageTitle="Mogano"
  />
);

export default Mogano;
