...
const Campamac = () => (
  <RestaurantPage
    restaurantName="Campamac"
    address="strada della Valle 1, Barbaresco, 12050, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+390173635051"
    website="https://www.campamac.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A real gourmet inn which serves traditional Piedmontese dishes made from excellent ingredients alongside top-quality meats cooked on the barbecue grill. An elegant ambience with a deliberately retro feel, which is beautifully maintained and has plenty of charm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20della%20Valle%201%2C%20Barbaresco%2C%2012050%2C%20Italy"
    pageTitle="Campamac"
  />
);

export default Campamac;
