...
const LaTorreMON = () => (
  <RestaurantPage
    ...
    address="piazza Mazzini 14, Monselice, 35043, Italy"
    cuisine="Traditional Cuisine, Grills"
    priceRange="€€"
    phoneNumber="+39042973752"
    website="https://www.ristorantelatorremonselice.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooked by a medieval tower in the main town square, this restaurant is perfect for anyone keen on classic, traditional cuisine. House specialities include dishes cooked over the barbecue grill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Mazzini%2014%2C%20Monselice%2C%2035043%2C%20Italy"
    pageTitle="La Torre"
  />
);

export default LaTorreMON;
