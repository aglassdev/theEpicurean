...
const IlTuracciolo = () => (
  <RestaurantPage
    restaurantName="Il Turacciolo"
    address="piazza Vittorio Emanuele II 4, Andria, 76123, Italy"
    cuisine="Apulian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393881998889"
    website="https://guide.michelin.com/en/puglia/andria/restaurant/il-turacciolo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A characteristic and pleasant atmosphere reminiscent of an enoteca wine bar introduces one of the most intriguing culinary offerings in the area. If seeking the most typical Apulian products, this is your address!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Vittorio%20Emanuele%20II%204%2C%20Andria%2C%2076123%2C%20Italy"
    pageTitle="Il Turacciolo"
  />
);

export default IlTuracciolo;
