...
const LeBeccherie = () => (
  <RestaurantPage
    ...
    address="piazza Giannino Ancilotto 9, Treviso, 31100, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390422540871"
    website="https://www.lebeccherie.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of Treviso, what was once a stronghold of traditional cuisine is now a restaurant with contemporary appeal, where a carefully curated atmosphere is matched by sophisticated design; the most coveted tables overlook the canal, providing a particularly atmospheric setting. The gastronomic proposal combines fantasy and references to the territory; in addition to the à la carte, two tasting menus are available: We brings together a selection of the most representative dishes of chefs Beatrice Simonetti and Manuel Gobbo, while Beccherie 1962 pays homage to the sign's historic cuisine, reinterpreted with a modern twist. Among the most interesting creations is Risotto alla Cima, the restaurant's iconic dish, as well as Tiramisù...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Giannino%20Ancilotto%209%2C%20Treviso%2C%2031100%2C%20Italy"
    pageTitle="Le Beccherie"
  />
);

export default LeBeccherie;
