...
const Mardivino = () => (
  <RestaurantPage
    restaurantName="MARdiVINO"
    address="strada del Nascimben 1/a, Treviso, 31100, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390422346542"
    website="https://www.ristorantemardivino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside a recently renovated 1800s farmhouse, MARdiVINO's kitchen offers fresh seafood specialities inspired by Apulian tradition. Do not hesitate to try the barbecued rock octopus, marinated in scapece, accompanied by potato and speck mille-feuille...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20del%20Nascimben%201%2Fa%2C%20Treviso%2C%2031100%2C%20Italy"
    pageTitle="MARdiVINO"
  />
);

export default Mardivino;
