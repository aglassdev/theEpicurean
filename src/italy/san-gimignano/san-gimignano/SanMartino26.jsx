...
const SanMartino26 = () => (
  <RestaurantPage
    restaurantName="San Martino 26"
    address="via San Martino 26, San Gimignano, 53037, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€"
    phoneNumber="+390577940483"
    website="https://www.ristorantesanmartino26.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying the wine cellars of an old palazzo in the historic centre, this restaurant has a fashionable feel with just a few tables and a selection of contemporary - style dishes inspired by classic recipes (from Tuscany and elsewhere) on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Martino%2026%2C%20San%20Gimignano%2C%2053037%2C%20Italy"
    pageTitle="San Martino 26"
  />
);

export default SanMartino26;
