...
const DaPode = () => (
  <RestaurantPage
    restaurantName="Da Pode"
    address="località Sovestro 63, San Gimignano, 53037, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390577943153"
    website="https://www.dapode.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant occupies an old far that has retained some of the architectural features typical of its rural past. It serves delicious Tuscan cuisine prepared by Signora Lucia. If you are on a diet, beware!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Sovestro%2063%2C%20San%20Gimignano%2C%2053037%2C%20Italy"
    pageTitle="Da Pode"
  />
);

export default DaPode;
