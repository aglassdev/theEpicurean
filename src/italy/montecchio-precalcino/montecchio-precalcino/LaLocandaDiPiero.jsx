...
const LaLocandaDiPiero = () => (
  <RestaurantPage
    restaurantName="La Locanda di Piero"
    address="via Roma 34, strada per Dueville, Montecchio Precalcino, 36030, Italy"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+390445864827"
    website="https://lalocandadipiero.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a small country villa with the ambience of a private residence, this restaurant boasts a dining room with a welcoming fireplace in winter and a veranda full of natural light, giving it a classic feel that makes it perfect for an elegant and romantic dinner. The cuisine is distinctive and full of substance, featuring a selection of meat and fish dishes that includes classic and creative options alike...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2034%2C%20strada%20per%20Dueville%2C%20Montecchio%20Precalcino%2C%2036030%2C%20Italy"
    pageTitle="La Locanda di Piero"
  />
);

export default LaLocandaDiPiero;
