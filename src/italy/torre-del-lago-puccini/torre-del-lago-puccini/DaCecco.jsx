...
const DaCecco = () => (
  <RestaurantPage
    restaurantName="Da Cecco"
    address="piazza Belvedere Puccini 10/12, Torre del Lago Puccini, 55049, Italy"
    cuisine="Tuscan"
    priceRange="€"
    phoneNumber="+390584341022"
    website="https://ristorante-da-cecco-torre-del-lago-puccini-lu.business.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A cosylittle restaurant at the beginning of the lakefront. Mainly seafood dishes, though in the winter there is also game. Rustic atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Belvedere%20Puccini%2010%2F12%2C%20Torre%20del%20Lago%20Puccini%2C%2055049%2C%20Italy"
    pageTitle="Da Cecco"
  />
);

export default DaCecco;
