...
const Delicato = () => (
  <RestaurantPage
    restaurantName="Delicato"
    address="via Umberto I 2, Contigliano, 02043, Italy"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+390746249202"
    website="https://www.ristorantedelicato.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a picturesque medieval hilltop village in the province of Rieti on the border with Umbria, this restaurant serves cuisine that is influenced by different regions and traditions. Choose between the minimalist-style dining rooms with exposed stone walls and, in fine weather, a charming outdoor space at the foot of Contigliano’s church. Here, chef Carlotta Delicato brings out the best of local ingredients in dishes that are kept deliberately simple and unfussy yet are full of flavour. We highly recommend the “spaghettone mare e lago” with a light brunoise of courgettes. As the restaurant is situated in Lazio, guests can enjoy good local wines made by small-scale producers, such as the Cabernet Sauvignon Masseria Baroni, which is of medium intensity with broad and pronounced aromas..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Umberto%20I%202%2C%20Contigliano%2C%2002043%2C%20Italy"
    pageTitle="Delicato"
  />
);
