...
const TerrazzaFiorella = () => (
  <RestaurantPage
    restaurantName="Terrazza Fiorella"
    address="via Vincenzo Maggio 5, Massa Lubrense, 80061, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390818789832"
    website="https://arthotelvillafiorella.com/terrazza-fiorella/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the Villa Fiorella Art Hotel, this restaurant boasts a stunningly located terrace with spectacular views of the Bay of Naples and its islands. The cuisine pays tribute to Campania and its top-quality ingredients which the chef uses to create imaginative dishes reinterpreted with his own personal twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vincenzo%20Maggio%205%2C%20Massa%20Lubrense%2C%2080061%2C%20Italy"
    pageTitle="Terrazza Fiorella"
  />
);

export default TerrazzaFiorella;
