...
const CaVittoria = () => (
  <RestaurantPage
    restaurantName="Ca' Vittoria"
    address="via Roma 14, Tigliole, 14016, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390141667713"
    website="https://www.ristorantevittoria.it"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In the heart of a postcard-perfect village, the Musso family has welcomed guests for generations with the characteristic seriousness and professionalism of the Savoy tradition. Most importantly, they offer truly interesting cuisine. While grandma Gemma and mom Sandra focused on regional tradition, today Massimiliano brings a touch of creativity and international flair, enhancing Piedmontese bases with influences from elsewhere. There are two tasting menus, plus a chef's choice option, with the flexibility to select dishes à la carte, and don't forget the classic dishes served with white truffle in season. The wine list highlights great Piedmontese wines alongside younger, dynamic labels; among the Barolos, there are some bottles dating back to the 1970s...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2014%2C%20Tigliole%2C%2014016%2C%20Italy"
    pageTitle="Ca' Vittoria"
  />
);

export default CaVittoria;
