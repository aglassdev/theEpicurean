...
const Oishi = () => (
  <RestaurantPage
    ...
    address="via Mario Capuani 47, Teramo, 64100, Italy"
    cuisine="Japanese, Fusion"
    priceRange="€€"
    phoneNumber="+393913942429"
    website="https://www.oishiteramo.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="East meets West in this attractive restaurant situated in the centre of Teramo. Tribute is paid to Japan in the intimate dining room, where photos of the country adorn the walls and Japanese influences are evident in the fusion cuisine which is prepared using a blend of ingredients from Italy and further afield (raw and marinated dishes, sashimi and nigiri, sushi rolls, tempura etc). The new section entitled “temporary food” has a more seasonal feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Mario%20Capuani%2047%2C%20Teramo%2C%2064100%2C%20Italy"
    pageTitle="Oishi"
  />
);
