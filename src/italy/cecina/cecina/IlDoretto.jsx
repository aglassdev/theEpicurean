...
const IlDoretto = () => (
  <RestaurantPage
    restaurantName="Il Doretto"
    address="via Pisana Livornese 32, Cecina, 57023, Italy"
    cuisine="Classic Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+390586668363"
    website="https://guide.michelin.com/en/toscana/cecina/restaurant/il-doretto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in an attractive farmhouse, this restaurant serves seasonal cuisine that includes delicious fish and seafood (raw dishes as well as more elaborate options), alongside meat dishes, including some delicious game recipes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pisana%20Livornese%2032%2C%20Cecina%2C%2057023%2C%20Italy"
    pageTitle="Il Doretto"
  />
);

export default IlDoretto;
