...
const LaPignata = () => (
  <RestaurantPage
    restaurantName="La Pignata"
    address="viale Dei Tigli 7, Ariano Irpino, 83031, Italy"
    cuisine="Campanian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390825872571"
    website="https://sites.google.com/view/ristorante-la-pignata-2-zero/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 40 years the Ventre family have been championing the flavours of Irpinia, seeking out the region’s best seasonal ingredients. These are then used in traditional dishes such as soups, as well as in more personal reinterpretations of local specialities (their “post-modern” arancino is now renowned in the region) that nonetheless retain all their original flavour with influences from both Campania and Puglia. The pizza here is excellent and there’s also a good selection of wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Dei%20Tigli%207%2C%20Ariano%20Irpino%2C%2083031%2C%20Italy"
    pageTitle="La Pignata"
  />
);

export default LaPignata;
