...
const CalaLuna = () => (
  <RestaurantPage
    restaurantName="Cala Luna"
    address="via Vincenzo Cavallaro 12, Cefalu, 90015, Italy"
    cuisine="Contemporary, Sicilian"
    priceRange="€€€€"
    phoneNumber="+390921424144"
    website="https://lecalette.it/it/ristoranti/cala-luna/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Refined fine dining at the boutique hotel Le Calette. In the summertime, Cala Luna is hosted in a splendid garden surrounded by plants and flowers, with breathtaking views of the bay, the Caldura sea stacks, and the Rocca. The dishes are a technical and creative expression of Chef Dario Pandolfo’s experiences, who applies what he has learned working in prestigious restaurants in Italy and abroad to Sicilian ingredients and traditions. The result is a vibrant and colorful cuisine, sometimes with strong flavors, always creative and deeply Mediterranean. Green notes are evident not only in the Fiori di Luna menu, dedicated to Sicilian vegetables, herbs, and flowers, but also in the sustainable approach to using raw materials, enhancing every part of them, and focusing on reducing waste withou..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vincenzo%20Cavallaro%2012%2C%20Cefalu%2C%2090015%2C%20Italy"
    pageTitle="Cala Luna"
  />
);

export default CalaLuna;
