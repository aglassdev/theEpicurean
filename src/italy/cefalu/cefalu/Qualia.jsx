...
const Qualia = () => (
  <RestaurantPage
    restaurantName="Qualia"
    address="via Giovanni Amendola 16/b, Cefalu, 90015, Italy"
    cuisine="Italian, Sicilian"
    priceRange="€€€"
    phoneNumber="+390921820104"
    website="http://ristorantequalia.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a side street in the centre of this charming small town, this restaurant boasts a dining room with exposed brickwork and glimpses of the kitchen, plus a small outdoor space with a few tables for alfresco dining. The dishes here are full of flavour and focus on regional ingredients and fresh fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giovanni%20Amendola%2016%2Fb%2C%20Cefalu%2C%2090015%2C%20Italy"
    pageTitle="Qualia"
  />
);
