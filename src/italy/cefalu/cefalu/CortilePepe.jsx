...
const CortilePepe = () => (
  <RestaurantPage
    restaurantName="Cortile Pepe"
    address="via Nicola Botta 15, Cefalu, 90015, Italy"
    cuisine="Modern Cuisine, Country cooking"
    priceRange="€€€"
    phoneNumber="+390921421630"
    website="https://www.cortilepepe.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated among the narrow streets of the historic centre just a stone’s throw from both the cathedral and the sea, this restaurant boasts a dining room with an old, vaulted ceiling and an attractive outdoor space. Here, the chef (who has plenty of experience working in Michelin-starred restaurants) serves regional cuisine reinterpreted with elegant and modern touches that result in precise, colourful and beautifully presented dishes. Attentive, friendly and welcoming service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nicola%20Botta%2015%2C%20Cefalu%2C%2090015%2C%20Italy"
    pageTitle="Cortile Pepe"
  />
);

export default CortilePepe;
