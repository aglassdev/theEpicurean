...
const VillettaAnnessa = () => (
  <RestaurantPage
    restaurantName="Villetta Annessa"
    address="via Monte Oro 9, Riva del Garda, 38066, Italy"
    cuisine="Classic Cuisine, Grills"
    priceRange="€€€"
    phoneNumber="+390464552335"
    website="https://www.hotelvillamiravalle.com/cena-in-villetta-annessa/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Monte%20Oro%209%2C%20Riva%20del%20Garda%2C%2038066%2C%20Italy"
    pageTitle="Villetta Annessa"
  />
);

export default VillettaAnnessa;
