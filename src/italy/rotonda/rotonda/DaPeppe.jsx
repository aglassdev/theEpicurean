...
const DaPeppe = () => (
  <RestaurantPage
    restaurantName="Da Peppe"
    address="corso Garibaldi 13, Rotonda, 85048, Italy"
    cuisine="Cuisine from Basilicata, Italian"
    priceRange="€"
    phoneNumber="+393454070498"
    website="https://guide.michelin.com/en/basilicata/rotonda/restaurant/da-peppe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the historic centre of a small village in the Parco del Pollino, this long-established restaurant serves traditional and copious local dishes that are always expertly prepared. Guestrooms are also available in the family B&B of the same name...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Garibaldi%2013%2C%20Rotonda%2C%2085048%2C%20Italy"
    pageTitle="Da Peppe"
  />
);

export default DaPeppe;
