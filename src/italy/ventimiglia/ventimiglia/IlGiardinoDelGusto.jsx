...
const IlGiardinoDelGusto = () => (
  <RestaurantPage
    restaurantName="Il Giardino del Gusto"
    address="piazza XX Settembre 6/c, Ventimiglia, 18039, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390184355244"
    website="https://emanueledonalisio.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although not on the seafront, this restaurant is well worth a visit thanks to its excellent owner - chef, who has had years of experience to perfect his French culinary techniques. Exciting tasting menus with dishes which can also be ordered à la carte...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20XX%20Settembre%206%2Fc%2C%20Ventimiglia%2C%2018039%2C%20Italy"
    pageTitle="Il Giardino del Gusto"
  />
);

export default IlGiardinoDelGusto;
