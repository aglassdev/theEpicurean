...
const OsteriaFernanda = () => (
  <RestaurantPage
    restaurantName="Osteria Fernanda"
    address="via Crescenzo Del Monte 18/24, Rome, 00153, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+39065894333"
    website="https://www.osteriafernanda.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the district famous for its Porta Portese market, this restaurant run by two talented business partners is definitely worth a visit. Andrea oversees the minimalist-style dining room, while Luca demonstrates real passion in his creative cuisine made from locally sourced ingredients, as well as produce from further afield. Among the desserts, we highly recommended the Porter beer ice-cream with black garlic mousse, chocolate and tuber peelings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Crescenzo%20Del%20Monte%2018%2F24%2C%20Rome%2C%2000153%2C%20Italy"
    pageTitle="Osteria Fernanda"
  />
);

export default OsteriaFernanda;
