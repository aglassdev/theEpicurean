...
const IlRistoranteNikoRomitoROM = () => (
  <RestaurantPage
    restaurantName="Il Ristorante - Niko Romito"
    address="via di Ripetta 73, Rome, 00186, Italy"
    cuisine="Italian Contemporary, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+390636080410"
    website="https://www.bulgarihotels.com/it_IT/rome/dining/il-ristorante-niko-romito"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the fifth floor of the Hotel Bulgari with views of the Mausoleum of Augustus, this restaurant boasts a spacious terrace and an elegant, welcoming dining room with mahogany walls adorned with works of art. To reach the dining room, you pass through the lively bar, where we recommend starting your evening with an aperitif. Once at your table, the menu offers a concrete expression of three-Michelin-star chef Niko Romito’s culinary approach which focuses on lighter, elegant versions of traditional Italian dishes in a sequence of courses that take guests on a culinary tour around Italy. Spaghetti in tomato sauce, artichoke soup, saffron risotto and Piedmontese “bonet” dessert all feature on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20di%20Ripetta%2073%2C%20Rome%2C%2000186%2C%20Italy"
    pageTitle="Il Ristorante - Niko Romito"
  />
);

export default IlRistoranteNikoRomitoROM;
