...
const IlRistoranteAlainDucasseRoma = () => (
  <RestaurantPage
    restaurantName="Il Ristorante Alain Ducasse Roma"
    address="via di Ripetta 246, Rome, 00186, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+390645545000"
    website="https://theromeocollection.com/it/romeo-roma/restaurants-bar/il-ristorante-alain-ducasse/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in a 17C palazzo just a stone’s throw from the Piazza del Popolo, this restaurant run by Alain Ducasse, the chef with the most Michelin stars worldwide, is part of the Romeo hotel. The dining room, designed by architect Zaha Hadid, is panelled in ebony, while the open-view kitchen is in marble – luxury certainly takes centre stage here. The cuisine is on a par with the exquisite decor, featuring top-quality ingredients which young Jacopo Iualè transforms into dishes with a Mediterranean flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20di%20Ripetta%20246%2C%20Rome%2C%2000186%2C%20Italy"
    pageTitle="Il Ristorante Alain Ducasse Roma"
  />
);

export default IlRistoranteAlainDucasseRoma;
