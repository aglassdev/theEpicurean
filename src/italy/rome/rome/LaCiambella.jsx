...
const LaCiambella = () => (
  <RestaurantPage
    restaurantName="La Ciambella"
    address="via dell'Arco della Ciambella 20, Rome, 00186, Italy"
    cuisine="Roman, Italian"
    priceRange="€€€"
    phoneNumber="+39066832930"
    website="https://www.la-ciambella.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Originally from Testaccio, the district of Rome that is historically associated with butcher’s shops, chef Francesca Ciucci serves some of the best meat dishes in the Italian capital, including offal such as sweetbreads, a delicious Roman-style tripe dish and her own reinterpretation of “coda in carrozza” (an oxtail recipe). Meat dishes, often with a creative twist, take centre stage here, offering a delightful gastronomic experience that is not to be missed. There’s a large Travertine marble counter near the entrance, while the dining room is arranged around an open-view kitchen under a large skylight that bathes the entire room in natural light...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dell'Arco%20della%20Ciambella%2020%2C%20Rome%2C%2000186%2C%20Italy"
    pageTitle="La Ciambella"
  />
);

export default LaCiambella;
