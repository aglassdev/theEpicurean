...
const Imgo = () => (
  <RestaurantPage
    restaurantName="Imàgo"
    address="piazza Trinità dei Monti 6, Rome, 00187, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390669934726"
    website="https://www.hotelhasslerroma.com/it/ristoranti-bar/imago"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The location of this rooftop restaurant could hardly be more glamorous. Head up the most famous flight of steps in the world to the Hassler hotel, where you take a lift up to one of the Italian capital’s most celebrated restaurants. Here, you dine surrounded by floor-to-ceiling windows that offer superb views of Rome, from the twin bell towers of Trinità dei Monti church to a whole host of the city’s iconic monuments – see how many you can recognise! In the meantime, chef Andrea Antonini prepares two tasting menus that showcase his classic dishes alongside more recent creations. His cuisine is often based on recognised recipes and ingredients, while also exploring new ideas, unusual combinations and amusing reinterpretations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Trinit%C3%A0%20dei%20Monti%206%2C%20Rome%2C%2000187%2C%20Italy"
    pageTitle="Imàgo"
  />
);
