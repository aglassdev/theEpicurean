...
const Campocori = () => (
  <RestaurantPage
    restaurantName="Campocori"
    address="via di Santa Maria de' Calderari 49, Rome, 00186, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390689935351"
    website="https://www.chapter-roma.com/?page_id=3199"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant fine-dining restaurant situated within the Chapter Hotel, the brainchild of the South African designer Tristan Du Plessis, has been designed as an evening venue with a darkly lit ambience. Here, chef Alessandro Pietropaoli conjures up contemporary, cosmopolitan cuisine with a combination of Roman, Italian and international influences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20di%20Santa%20Maria%20de'%20Calderari%2049%2C%20Rome%2C%2000186%2C%20Italy"
    pageTitle="Campocori"
  />
);

export default Campocori;
