...
const IlPagliaccio = () => (
  <RestaurantPage
    restaurantName="Il Pagliaccio"
    address="via dei Banchi Vecchi 129/a, Rome, 00186, Italy"
    cuisine="Creative, Innovative"
    priceRange="€€€€"
    phoneNumber="+390668809595"
    website="https://www.ristoranteilpagliaccio.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="From the heart of Rome, we set out on a long gastronomic journey around the world, stopping in almost every continent on Earth, a journey told according to the sensibility and vision of globetrotter Anthony Genovese, a highly talented chef-patron. He brings together in a number of blind tasting courses – of varying lengths – an extraordinary wealth of experience that leaves one amazed, especially in the moments when he prepares his own fusion of Italy and Japan, as in the delicious gyoza stuffed with Piedmontese finanziera to be seasoned with broth and powder inspired by Roman-style oxtail. It all takes place in an intimate and elegant venue, supported by excellent service: maître Matteo Zappile (previously awarded by us for his dining room service), sommelier Luca Belleggia (the wine list..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Banchi%20Vecchi%20129%2Fa%2C%20Rome%2C%2000186%2C%20Italy"
    pageTitle="Il Pagliaccio"
  />
);

export default IlPagliaccio;
