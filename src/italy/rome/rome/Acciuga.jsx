...
const Acciuga = () => (
  <RestaurantPage
    restaurantName="Acciuga"
    address="via Vodice 25, Rome, 00195, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+39063723395"
    website="https://www.acciugaroma.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vodice%2025%2C%20Rome%2C%2000195%2C%20Italy"
    pageTitle="Acciuga"
  />
);

export default Acciuga;
