...
const OndaBlu = () => (
  <RestaurantPage
    restaurantName="Onda Blu"
    address="via Orsa Minore 1, San Mauro a Mare, 47030, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+390541344886"
    website="https://www.ristoranteondablu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Almost appearing to rise up directly out of the sand, this unexpectedly elegant restaurant is home to a simple yet stylish dining room with large windows overlooking the sea. Fresh fish of the highest quality takes pride of place on the menu, served in classic, traditional dishes from the Adriatic. Daily specials fresh from the market feature alongside the à la carte, such as the excellent porcini mushrooms we enjoyed on our last visit here, which were served with passatelli pasta, shrimp and scallops. Although individuals may change, an enthusiastic and professional approach is typical of the entire team here. The excellent wine list includes labels from outside Italy, with a particular focus on France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Orsa%20Minore%201%2C%20San%20Mauro%20a%20Mare%2C%2047030%2C%20Italy"
    pageTitle="Onda Blu"
  />
);

export default OndaBlu;
