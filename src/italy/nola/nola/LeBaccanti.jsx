...
const LeBaccanti = () => (
  <RestaurantPage
    restaurantName="Le Baccanti"
    address="via Puccini 5, Nola, 80035, Italy"
    cuisine="Campanian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390815122117"
    website="https://guide.michelin.com/en/campania/nola/restaurant/le-baccanti"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simple premises with two large windows overlooking its kitchens. It serves imaginative dishes where tradition and creativity become one. Informal service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Puccini%205%2C%20Nola%2C%2080035%2C%20Italy"
    pageTitle="Le Baccanti"
  />
);

export default LeBaccanti;
