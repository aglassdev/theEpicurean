...
const RearRestaurant = () => (
  <RestaurantPage
    restaurantName="Rear Restaurant"
    address="SS 7bis Km 50, Nola, 80035, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+393332111322"
    website="https://www.roworldexperience.com/rear/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a modern, elegant dining room in which an entire wall is taken up by the open-view kitchen serves varied cuisine. In addition to more elaborate dishes, there’s also a choice of street food such as fried dishes, sandwiches, Spanish prosciutto and tacos, as well as raw fish and seafood, classic and more creative options, and various fish and meat main courses, many of which are cooked over the barbecue grill. The superb wine list includes a fine array of champagnes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SS%207bis%20Km%2050%2C%20Nola%2C%2080035%2C%20Italy"
    pageTitle="Rear Restaurant"
  />
);

export default RearRestaurant;
