...
const TrattoriaPomposaAlReGras = () => (
  <RestaurantPage
    restaurantName="Trattoria Pomposa - Al Re gras"
    address="via Castel Maraldo 57, Modena, 41121, Italy"
    cuisine="Emilian, Country cooking"
    priceRange="€"
    phoneNumber="+39059214881"
    website="https://www.trattoriapomposa.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s not just the affordable prices that will keep you coming back here, as the real highlight is its flavourful Emilian cuisine, which has been given a fresh, more modern twist. Among the first courses, we can recommend the tortellini in chicken broth or with a 24-month Parmesan cream; and for the main course, a delicious tripe with bread croutons. The Lambrusco is a must on the wine list here (we can recommend a good Grasparossa di Castelvetro). In the summer, meals are served outdoors on the small Piazza della Pomposa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castel%20Maraldo%2057%2C%20Modena%2C%2041121%2C%20Italy"
    pageTitle="Trattoria Pomposa - Al Re gras"
  />
);

export default TrattoriaPomposaAlReGras;
