...
const Marcelin = () => (
  <RestaurantPage
    restaurantName="Marcelin"
    address="piazzetta della Vecchia Segheria 1, Montà, 12046, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€"
    phoneNumber="+390173975569"
    website="https://www.marcelin.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are in search of creative and innovative cuisine in this region renowned for its great gastronomic tradition, then Marcelin is the place for you. This is thanks to its occasionally complex and always beautifully presented dishes (including a few fish options). Housed on the first floor of an old sawmill, the restaurant boasts a restrained yet elegant decor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazzetta%20della%20Vecchia%20Segheria%201%2C%20Mont%C3%A0%2C%2012046%2C%20Italy"
    pageTitle="Marcelin"
  />
);

export default Marcelin;
