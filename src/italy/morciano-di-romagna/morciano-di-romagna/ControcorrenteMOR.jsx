...
const ControcorrenteMOR = () => (
  <RestaurantPage
    restaurantName="Controcorrente"
    address="via XXV Luglio 23, Morciano di Romagna, 47833, Italy"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390541988036"
    website="https://www.ristorantecontrocorrente.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming restaurant with a rustic - style dining room, a young, lively atmosphere and beautifully prepared dishes with an emphasis on fish – it is difficult not to be impressed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXV%20Luglio%2023%2C%20Morciano%20di%20Romagna%2C%2047833%2C%20Italy"
    pageTitle="Controcorrente"
  />
);

export default ControcorrenteMOR;
