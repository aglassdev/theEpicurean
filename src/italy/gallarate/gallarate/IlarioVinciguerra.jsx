...
const IlarioVinciguerra = () => (
  <RestaurantPage
    restaurantName="Ilario Vinciguerra"
    address="via Roma 1, Gallarate, 21013, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390331791597"
    website="https://www.ilariovinciguerra.it/it/home/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautiful Art Nouveau-style villa is a restaurant, bistro and lounge-bar in one – the ideal setting for a meal, whether you’re planning a business lunch or a romantic dinner. Guests will feel immediately at ease both with Ilario’s modern, Mediterranean cuisine and the vaguely private feel of the small dining rooms. There’s also an original collection of Romano Levi grappas, plus several rare labels on the wine list that will definitely appeal to wine buffs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%201%2C%20Gallarate%2C%2021013%2C%20Italy"
    pageTitle="Ilario Vinciguerra"
  />
);

export default IlarioVinciguerra;
