...
const RadiciOsteriaContemporanea = () => (
  <RestaurantPage
    restaurantName="Radici Osteria Contemporanea"
    address="via Giuseppe Mazzini 13, Gallarate, 21013, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+3903311224176"
    website="https://www.radiciosteriacontemporanea.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having moved to the pedestrianised section of historic Gallarate, Radici Osteria Contemporanea has also adopted a new look, with a lounge-bar ambience that is young and trendy, making it the perfect setting for its aperitifs and superb cocktails. The restaurant’s excellent, modern and personalised cuisine remains unchanged, however...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Mazzini%2013%2C%20Gallarate%2C%2021013%2C%20Italy"
    pageTitle="Radici Osteria Contemporanea"
  />
);

export default RadiciOsteriaContemporanea;
