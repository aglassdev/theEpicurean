...
const Emozioni = () => (
  <RestaurantPage
    restaurantName="Emozioni"
    address="via Guglielmo Marconi 129, Campobasso, 86100, Italy"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393288751903"
    website="https://www.ristoranteemozioni.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the historic center of Campobasso, you'll find two charming stone-clad dining rooms offering both land and sea cuisine. The menu is mostly detached from local traditions and freely inspired by classic Italian dishes, sometimes reimagined. It's a great gastronomic stop for those visiting the Molise capital...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Guglielmo%20Marconi%20129%2C%20Campobasso%2C%2086100%2C%20Italy"
    pageTitle="Emozioni"
  />
);
