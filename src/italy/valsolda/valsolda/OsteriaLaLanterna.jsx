...
const OsteriaLaLanterna = () => (
  <RestaurantPage
    restaurantName="Osteria la Lanterna"
    address="via Finali 1, frazione Cressogno, Valsolda, 22010, Italy"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39034469014"
    website="https://www.osterialalanterna.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the road leading to Lugano in Switzerland, this charming restaurant with elegant furnishings and a rustic decor boasts bright dining rooms and a pleasant terrace for summer dining. The dishes are prepared with a focus on locally sourced, seasonal ingredients and are inspired by traditional recipes reinterpreted in contemporary style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Finali%201%2C%20frazione%20Cressogno%2C%20Valsolda%2C%2022010%2C%20Italy"
    pageTitle="Osteria la Lanterna"
  />
);

export default OsteriaLaLanterna;
