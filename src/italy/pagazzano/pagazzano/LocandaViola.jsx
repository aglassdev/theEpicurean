...
const LocandaViola = () => (
  <RestaurantPage
    restaurantName="Locanda Viola"
    address="via Morengo 164, Pagazzano, 24040, Italy"
    cuisine="Italian Contemporary, Asian Influences"
    priceRange="€€€"
    phoneNumber="+390363703956"
    website="https://www.locandaviola.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this elegant restaurant with chairs and tables of different designs and original workmanship, it is skilful chef Filippo Moriggi’s cuisine that really captures your attention. The interesting appetisers take guests on an exotic journey, featuring options such as empanadas, fish bao (steamed buns, also available with a barbecue sauce) and Chinese dumplings. Other dishes are more typically Italian in style, with pastas, risottos and Bergamo-style mutton all on the menu. Desserts include a selection of ice-cream and affogato...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Morengo%20164%2C%20Pagazzano%2C%2024040%2C%20Italy"
    pageTitle="Locanda Viola"
  />
);

export default LocandaViola;
