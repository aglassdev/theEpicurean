...
const LaFilandaMAN = () => (
  <RestaurantPage
    restaurantName="La Filanda"
    address="via Marsala 8, Manciano, 58014, Italy"
    cuisine="Tuscan, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390564625156"
    website="https://www.lafilanda.biz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of the historic centre, this restaurant occupies an old spinning mill (filanda)  that has been completely restored without losing any of its original charm. Here, self-taught chef Barbara serves traditional dishes reinterpreted with real flair, such as the involtino di ciaffagnone filled with Maremma beef on a bed of melted pecorino cheese and crispy leek. The chef’s husband oversees the wine list, which includes a selection of Tuscan labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marsala%208%2C%20Manciano%2C%2058014%2C%20Italy"
    pageTitle="La Filanda"
  />
);

export default LaFilandaMAN;
