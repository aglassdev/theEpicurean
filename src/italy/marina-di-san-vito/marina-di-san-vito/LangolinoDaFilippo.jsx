...
const LangolinoDaFilippo = () => (
  <RestaurantPage
    restaurantName="L'Angolino da Filippo"
    address="via Sangritana 1, Marina di San Vito, 66038, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+39087261632"
    website="https://guide.michelin.com/en/abruzzo/marina-di-san-vito/restaurant/l-angolino-da-filippo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A red door just a few metres from the sea marks the entrance to this long-established restaurant (a family-run business for over a century), which boasts two small dining rooms with brick-vaulted ceilings and a lively atmosphere. Unsurprisingly, the menu focuses on fish and seafood specialities, which showcase a combination of delicious modern and traditional flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sangritana%201%2C%20Marina%20di%20San%20Vito%2C%2066038%2C%20Italy"
    pageTitle="L'Angolino da Filippo"
  />
);

export default LangolinoDaFilippo;
