...
const IlCipressoDaCioni = () => (
  <RestaurantPage
    restaurantName="Il Cipresso - Da Cioni"
    address="via Alcide De Gasperi 28, Loro Ciuffenna, 52024, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390559171127"
    website="https://guide.michelin.com/en/toscana/loro-ciuffenna/restaurant/il-cipresso-da-cioni"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Standing on a round terrace, this restaurant with a fairly plain interior serves dishes made from some of the best produce of the region – cured hams, bread, pasta and famous Tuscan meats. The restaurant also offers simple, rustic - style guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Alcide%20De%20Gasperi%2028%2C%20Loro%20Ciuffenna%2C%2052024%2C%20Italy"
    pageTitle="Il Cipresso - Da Cioni"
  />
);

export default IlCipressoDaCioni;
