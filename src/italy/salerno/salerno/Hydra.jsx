...
const Hydra = () => (
  <RestaurantPage
    restaurantName="Hydra"
    address="via Antonio Mazza 30, Salerno, 84121, Italy"
    cuisine="Campanian, Contemporary"
    priceRange="€€"
    phoneNumber="+390899958437"
    website="https://www.ristorantehydra.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the picturesque historic centre of Salerno, this is one of the city’s best restaurants. The dining room here is almost minimalist in style, yet thanks to the soft lighting and beautiful background music it has a pleasing atmosphere; in fine weather, tables are set out in a charming inner courtyard. The cuisine is Mediterranean and contemporary, with a selection of light and creative meat, fish and vegetable dishes featuring on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Antonio%20Mazza%2030%2C%20Salerno%2C%2084121%2C%20Italy"
    pageTitle="Hydra"
  />
);
