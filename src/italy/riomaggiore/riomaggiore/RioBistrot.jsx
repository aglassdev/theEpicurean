...
const RioBistrot = () => (
  <RestaurantPage
    restaurantName="Rio Bistrot"
    address="via San Giacomo 46, Riomaggiore, 19017, Italy"
    cuisine="Contemporary, Seafood"
    priceRange="€€"
    phoneNumber="+390187920616"
    website="https://guide.michelin.com/en/liguria/riomaggiore/restaurant/rio-bistrot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the street that heads down to the port in charming Riomaggiore, this lovely, well-kept restaurant offers a small selection of dishes split between Ligurian specialities and more creative options. Dine in the rustic, elegant dining room or on the outdoor terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Giacomo%2046%2C%20Riomaggiore%2C%2019017%2C%20Italy"
    pageTitle="Rio Bistrot"
  />
);

export default RioBistrot;
