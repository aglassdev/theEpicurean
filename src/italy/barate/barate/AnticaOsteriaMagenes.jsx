...
const AnticaOsteriaMagenes = () => (
  <RestaurantPage
    restaurantName="Antica Osteria Magenes"
    address="via Cavour 7, Barate, 20083, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39029085125"
    website="https://osteriamagenes.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This fascinating restaurant occupying an old house renovated in modern style comes as a surprise given its location in a small village deep in the countryside. Enjoy traditional cuisine reinterpreted in a playful and original way in the well-tended garden, where six exclusive tables provide the perfect setting for an intimate and romantic alfresco dinner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cavour%207%2C%20Barate%2C%2020083%2C%20Italy"
    pageTitle="Antica Osteria Magenes"
  />
);

export default AnticaOsteriaMagenes;
