...
const CantinaDeiCacciatori = () => (
  <RestaurantPage
    restaurantName="Cantina dei Cacciatori"
    address="località Villa Superiore 59, Monteu Roero, 12040, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+39017390815"
    website="https://www.cantinadeicacciatori.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The original sign painted on this restaurant’s façade hints at a history which dates back over a century. Situated outside the village and surrounded by sweet chestnut trees and tufa rock, what was once an old trattoria now serves typical Piedmontese specialities, such as meat and borage ravioli with butter and crispy pancetta, as well as dishes from further afield. Charming outdoor area for summer dining, plus an early - 20C wine cellar which can be visited by guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Villa%20Superiore%2059%2C%20Monteu%20Roero%2C%2012040%2C%20Italy"
    pageTitle="Cantina dei Cacciatori"
  />
);

export default CantinaDeiCacciatori;
