...
const GasthofstubeStafler = () => (
  <RestaurantPage
    restaurantName="Gasthofstube Stafler"
    address="Campo di Trens, Mules, 39040, Italy"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390472771136"
    website="https://www.stafler.com/it/hotel-gourmet-alto-adige/gasthofstube/filosofia-gasthofstube.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant situated in the splendid Stafler hotel on the road to Austria is perfect for a romantic dinner, with a comfortable Stube-style dining room and an internal garden for fine weather. Friendly and welcoming staff and traditional Tyrolean cuisine with a focus on ingredients from the Isarco valley, plus interesting personal twists added by the chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Campo%20di%20Trens%2C%20Mules%2C%2039040%2C%20Italy"
    pageTitle="Gasthofstube Stafler"
  />
);

export default GasthofstubeStafler;
