...
const LeCupole = () => (
  <RestaurantPage
    restaurantName="Le Cupole"
    address="via Aurelia Orientale 369, Rapallo, 16035, Italy"
    cuisine="Italian Contemporary, Ligurian"
    priceRange="€€€"
    phoneNumber="+390185273313"
    website="https://www.grandhotelbristol.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the sixth floor of the Grand Hotel Bristol, this restaurant is home to an experienced chef whose unique cuisine has a light modern touch and encompasses the whole of Italy, with a particular emphasis on regional specialities. Fish take pride of place on the menu, which also features vegetarian dishes and a few meat options. And last but not least, the restaurant’s roof-garden location gives it breathtaking views of the Portofino promontory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Aurelia%20Orientale%20369%2C%20Rapallo%2C%2016035%2C%20Italy"
    pageTitle="Le Cupole"
  />
);

export default LeCupole;
