...
const NunTrattoriaModerna = () => (
  <RestaurantPage
    restaurantName="Nunù Trattoria Moderna"
    address="Corso Giuseppe Garibaldi 32, Torre del Greco, 80059, Italy"
    cuisine="Traditional Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+3908118759960"
    website="https://guide.michelin.com/en/campania/torre-del-greco/restaurant/nunu-trattoria-moderna"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone’s throw from the seafront promenade, this friendly, colourful restaurant serves delicious, carefully prepared fish and meat dishes inspired by the traditions of Campania yet reinterpreted with a touch of imagination and character by skilful owner-chef Nunzio Spagnuolo. Our inspector’s favourite dish was the ravioli alla caprese with three types of tomato, provolone del Monaco cheese and basil-infused olive oil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corso%20Giuseppe%20Garibaldi%2032%2C%20Torre%20del%20Greco%2C%2080059%2C%20Italy"
    pageTitle="Nunù Trattoria Moderna"
  />
);

export default NunTrattoriaModerna;
