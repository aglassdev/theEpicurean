...
const Soprattutto = () => (
  <RestaurantPage
    restaurantName="Soprattutto"
    address="via Noalese 124, Santa Maria di Sala, 30036, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390415760404"
    website="https://guide.michelin.com/en/veneto/santa-maria-di-sala_1820856/restaurant/soprattutto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This tiny, welcoming restaurant with a bright, simple decor has long since come of age, having been opened and run by the same family for years. The wife supervises the front of house, while the husband (whose past experience includes working as a metalworker as well as a chef) is at the helm in the kitchen, where he creates classic fish dishes which are full of flavour and simply prepared from top-quality ingredients. As the restaurant is very popular with its regular clientele, booking in advance is essential – you won’t be disappointed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Noalese%20124%2C%20Santa%20Maria%20di%20Sala%2C%2030036%2C%20Italy"
    pageTitle="Soprattutto"
  />
);

export default Soprattutto;
