...
const Nicolin = () => (
  <RestaurantPage
    restaurantName="Nicolin"
    address="via Paisiello 4, località Maggianico, Lecco, 23900, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390341422122"
    website="https://www.ristorantenicolin.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Restaurant-hotel not far from the centre, but in a quiet, residential area, this is where you can find some of the best cuisine in town. The cook revisits some national dishes in a personal way, with a few seafood offerings as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Paisiello%204%2C%20localit%C3%A0%20Maggianico%2C%20Lecco%2C%2023900%2C%20Italy"
    pageTitle="Nicolin"
  />
);

export default Nicolin;
