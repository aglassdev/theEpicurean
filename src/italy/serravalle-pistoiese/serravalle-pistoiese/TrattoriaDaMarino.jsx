...
const TrattoriaDaMarino = () => (
  <RestaurantPage
    restaurantName="Trattoria da Marino"
    address="via Provinciale Lucchese 102, loc. Ponte di Serravalle, Serravalle Pistoiese, 51030, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39057351042"
    website="https://guide.michelin.com/en/toscana/serravalle-pistoiese/restaurant/trattoria-da-marino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In business for a century, this simple yet successful trattoria serves traditional Tuscan cuisine, with specialities such as ribollita stew and rabbit casserole on the menu. There’s just one informal dining room, which is overseen by capable owner Edoardo Innocenti, who delights in guiding his guests through the regional options on the menu. The tasting menu is highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Provinciale%20Lucchese%20102%2C%20loc.%20Ponte%20di%20Serravalle%2C%20Serravalle%20Pistoiese%2C%2051030%2C%20Italy"
    pageTitle="Trattoria da Marino"
  />
);

export default TrattoriaDaMarino;
