...
const Zafferano = () => (
  <RestaurantPage
    restaurantName="Zafferano"
    address="viale Icilio Vanni 1, Città della Pieve, 06062, Italy"
    cuisine="Classic Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+390578298063"
    website="https://www.hotel-vannucci.com/ristorante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Famous for its saffron, Città della Pieve is also well worth a visit to admire the Baciadonne alley (“one of the narrowest streets in Italy”) in its beautiful historic centre. This welcoming restaurant in a quiet and elegant hotel boasts an attractive veranda for summer dining that provides the perfect backdrop for delicious cuisine that is influenced by Umbria and Tuscany alike...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Icilio%20Vanni%201%2C%20Citt%C3%A0%20della%20Pieve%2C%2006062%2C%20Italy"
    pageTitle="Zafferano"
  />
);

export default Zafferano;
