...
const DaAlighiero = () => (
  <RestaurantPage
    restaurantName="Da Alighiero"
    address="via Garibaldi 8, Anghiari, 52031, Italy"
    cuisine="Tuscan"
    priceRange="€"
    phoneNumber="+390575788040"
    website="https://www.ristorantealighiero.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestled amid the cobbled streets of Anghiari, one of Italy’s most beautiful villages, this rustic-style restaurant is hidden behind a wooden door with glass panes and curtains. With its brick-vaulted ceiling, old cupboards, art on the walls and bottles everywhere, Da Alighiero has a warm, authentic ambience. The cuisine celebrates Tuscany’s classic favourites (don’t miss the tripe served in a spicy red sauce), while enthusiastic host Gianni is on hand with recommendations for the perfect wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Garibaldi%208%2C%20Anghiari%2C%2052031%2C%20Italy"
    pageTitle="Da Alighiero"
  />
);

export default DaAlighiero;
