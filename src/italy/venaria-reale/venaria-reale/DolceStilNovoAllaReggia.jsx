...
const DolceStilNovoAllaReggia = () => (
  <RestaurantPage
    restaurantName="Dolce Stil Novo alla Reggia"
    address="piazza della Repubblica 4, Venaria Reale, 10078, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+393462690588"
    website="https://dolcestilnovo.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="It could be said that this restaurant boasts a regal setting, given that its entrance stands in the inner courtyard of the Reggia di Venaria, the spectacular former residence of the House of Savoy. You then take the lift to the fourth floor and the restaurant’s dining room, elegantly furnished in 1950-60s style, and a summer terrace overlooking the garden. The cuisine here is centred around superb ingredients grown in the valleys of Piedmont, and occasionally further afield in the region and beyond, and is showcased in dishes that combine tradition and creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Repubblica%204%2C%20Venaria%20Reale%2C%2010078%2C%20Italy"
    pageTitle="Dolce Stil Novo alla Reggia"
  />
);

export default DolceStilNovoAllaReggia;
