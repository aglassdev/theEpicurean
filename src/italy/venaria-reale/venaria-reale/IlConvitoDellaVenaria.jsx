...
const IlConvitoDellaVenaria = () => (
  <RestaurantPage
    restaurantName="Il Convito della Venaria"
    address="via Andrea Mensa 37/g, Venaria Reale, 10078, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390114598392"
    website="https://www.ilconvitodellavenaria.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Andrea%20Mensa%2037%2Fg%2C%20Venaria%20Reale%2C%2010078%2C%20Italy"
    pageTitle="Il Convito della Venaria"
  />
);

export default IlConvitoDellaVenaria;
