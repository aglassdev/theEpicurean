...
const KleineFlamme = () => (
  <RestaurantPage
    restaurantName="Kleine Flamme"
    address="via Cittanuova 31, Vipiteno, 39049, Italy"
    cuisine="Fusion, Creative"
    priceRange="€€€"
    phoneNumber="+390472766065"
    website="https://kleineflamme.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his small open-view kitchen situated in the centre of this restaurant, chef Bacher Burkhard develops his vision of fusion cuisine with energy and precision, combining flavours from Italy and the Alto Adige with Asian spices and techniques to create delicious and imaginative dishes. His tuna tataki is superb, seasoned with salty lemon oil and accompanied by intriguing bitter herbs that (as Professor Montanari has noted in a recent book) are particularly popular with Italians. The chef’s wife Annelies works front of house, where she looks after guests in a friendly and professional manner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cittanuova%2031%2C%20Vipiteno%2C%2039049%2C%20Italy"
    pageTitle="Kleine Flamme"
  />
);

export default KleineFlamme;
