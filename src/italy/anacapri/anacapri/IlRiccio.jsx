...
const IlRiccio = () => (
  <RestaurantPage
    restaurantName="Il Riccio"
    address="via Gradola 4/11, Anacapri, 80071, Italy"
    cuisine="Seafood"
    priceRange="€€€€"
    phoneNumber="+390818371380"
    website="https://www.jumeirah.com/it/dine/italy/il-riccio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a few metres from the Blue Grotto and perched right above the water, Il Riccio is the quintessential Mediterranean fine-dining restaurant thanks to its tasteful and elegant decor. Undoubtedly one of Capri’s iconic addresses, it focuses uniquely on fish and seafood dishes. Whether you have a sweet tooth or not, a visit to the tempting dessert buffet to admire its array of delicacies is a must!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gradola%204%2F11%2C%20Anacapri%2C%2080071%2C%20Italy"
    pageTitle="Il Riccio"
  />
);

export default IlRiccio;
