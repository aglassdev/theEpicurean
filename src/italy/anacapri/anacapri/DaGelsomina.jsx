...
const DaGelsomina = () => (
  <RestaurantPage
    restaurantName="Da Gelsomina"
    address="Via Migliara 72, Anacapri, 80071, Italy"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+390818371499"
    website="https://www.dagelsomina.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Access to this authentic family-run trattoria is either by foot or shuttle bus (phone ahead for the latter). Just a few metres from the restaurant, enjoy breathtaking views of the Parco dei Filosofi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Migliara%2072%2C%20Anacapri%2C%2080071%2C%20Italy"
    pageTitle="Da Gelsomina"
  />
);

export default DaGelsomina;
