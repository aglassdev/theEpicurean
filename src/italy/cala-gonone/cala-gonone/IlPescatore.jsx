...
const IlPescatore = () => (
  <RestaurantPage
    restaurantName="Il Pescatore"
    address="via Acqua Dolce 7, Cala Gonone, 08022, Italy"
    cuisine="Seafood, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+39078493174"
    website="https://www.ristoranteilpescatorecalagonone.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Mediterranean-style restaurant has the evocative feel of a seaside village with its beautiful photos of the coast on the walls. It’s best to book ahead if you want one of the tables on the small terrace overlooking the sea. To avoid confusion, note that the Il Pescatore that we recommend is situated at 7, via Acqua Dolce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Acqua%20Dolce%207%2C%20Cala%20Gonone%2C%2008022%2C%20Italy"
    pageTitle="Il Pescatore"
  />
);

export default IlPescatore;
