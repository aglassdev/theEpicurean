...
const Mirkos = () => (
  <RestaurantPage
    restaurantName="Mirko's"
    address="discesa Annunziata 1, Castellammare del Golfo, 91014, Italy"
    cuisine="Mediterranean Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+390924040592"
    website="https://www.mirkosristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant, located near the steps to Cala Piccola, is run by an entire family and is beginning to earn an excellent local reputation. The son is at the helm in the kitchen. Having gained experience elsewhere for many years, he decided to start his own venture, which shows every sign of having paid off. Enjoy excellent fish and seafood specialities cooked in Mediterranean and Sicilian style in a quiet, beautifully kept dining room...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=discesa%20Annunziata%201%2C%20Castellammare%20del%20Golfo%2C%2091014%2C%20Italy"
    pageTitle="Mirko's"
  />
);

export default Mirkos;
