...
const InaltoAlfioGhezziDolomites = () => (
  <RestaurantPage
    restaurantName="InAlto Alfio Ghezzi Dolomites"
    address="via San Pellegrino 32, stazione a monte della funivia Col Margherita, Moena, 38035, Italy"
    cuisine="Regional Cuisine, Innovative"
    priceRange="€€"
    phoneNumber="+393440491503"
    website="https://www.inaltocolmargherita.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on Col Margherita at an altitude of 2 550m and accessible in winter via a cable car (from the San Pellegrino pass in Moena), this new ski bar bears the name of Alfio Ghezzi, the Michelin-starred chef at the Mart museum in Rovereto. Options include burgers and a children’s menu as well as a more elaborate and creative selection of some of the chef’s best-loved dishes. In summer the bar can also be reached on foot or by bike (for the truly athletic!) with recharging stations available for e-bikes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Pellegrino%2032%2C%20stazione%20a%20monte%20della%20funivia%20Col%20Margherita%2C%20Moena%2C%2038035%2C%20Italy"
    pageTitle="InAlto Alfio Ghezzi Dolomites"
  />
);

export default InaltoAlfioGhezziDolomites;
