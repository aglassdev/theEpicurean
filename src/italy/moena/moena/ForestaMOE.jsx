...
const ForestaMOE = () => (
  <RestaurantPage
    restaurantName="Foresta"
    address="strada de la Comunità de Fiem 42, Moena, 38035, Italy"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390462573260"
    website="https://www.hotelforesta.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in front of a dense fir wood, this restaurant comes as something of a surprise. The dishes are prepared with genuine local ingredients, resulting in food that is full of flavour. Don’t get up from the table without having tasted the pappardelle pasta with mushrooms and speck ham or the fillet of venison with a redcurrant sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20de%20la%20Comunit%C3%A0%20de%20Fiem%2042%2C%20Moena%2C%2038035%2C%20Italy"
    pageTitle="Foresta"
  />
);

export default ForestaMOE;
