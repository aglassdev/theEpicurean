...
const GustreOltrecucina = () => (
  <RestaurantPage
    restaurantName="/gu.stà.re/ oltrecucina"
    address="via Antonio Gramsci 20/b, Borgomanero, 28021, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393459778016"
    website="https://www.gustareoltrecucina.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An attractive contemporary-style restaurant right in the town centre, with a striking colour scheme and minimalist decor. The cuisine is inspired by traditional Piedmontese recipes which are reinterpreted with an imaginative touch by young, talented chef Valentina Maioni who selects top-quality ingredients and cooks with real passion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Antonio%20Gramsci%2020%2Fb%2C%20Borgomanero%2C%2028021%2C%20Italy"
    pageTitle="/gu.stà.re/ oltrecucina"
  />
);

export default GustreOltrecucina;
