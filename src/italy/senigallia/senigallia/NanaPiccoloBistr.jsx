...
const NanaPiccoloBistr = () => (
  <RestaurantPage
    restaurantName="Nana Piccolo Bistrò"
    address="via Giosuè Carducci 19, Senigallia, 60019, Italy"
    cuisine="Modern Cuisine, International"
    priceRange="€€"
    phoneNumber="+3907164999"
    website="https://www.nanapiccolobistro.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Spanish influences are evident in the cuisine served at this lively restaurant situated in the heart of this bustling town. After years spent working in Spain, the owner-chef has returned to Senigallia where he delights guests with dishes such as Iberian carbonara (made with Pata Negra ham and Manchego cheese) and potato and salted cod omelette. In high season, it’s best to book ahead and maybe even get here early to avoid parking problems – you can always work up an appetite with a stroll through Senigallia’s beautiful historic centre. Young, friendly and efficient female staff add to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giosu%C3%A8%20Carducci%2019%2C%20Senigallia%2C%2060019%2C%20Italy"
    pageTitle="Nana Piccolo Bistrò"
  />
);

export default NanaPiccoloBistr;
