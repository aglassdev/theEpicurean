...
const DelBelboDaBardon = () => (
  <RestaurantPage
    restaurantName="Del Belbo - Da Bardon"
    address="valle Asinari 25, San Marzano Oliveto, 14050, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390141831340"
    website="https://guide.michelin.com/en/piemonte/san-marzano-oliveto/restaurant/del-belbo-da-bardon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The tradition of the Monferrato region has been told for generations through simple local cuisine. Indeed, there is an inviting list on the menu in which none of the great classics are missing: peppers with bagna cauda, vitello tonnato, tagliolini with Cervere leek sauce, stewed tripe, braised veal stew with Barbera d'Asti, the sweet mattone monferrino and so on. Straightforward flavours to pair easily with an endless wine list for true fans of Langhe, Asti, all of Italy and France. All seasoned with proper customer care and pleasant outdoor service for the warm weather. Basically, the restaurant you want near home!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=valle%20Asinari%2025%2C%20San%20Marzano%20Oliveto%2C%2014050%2C%20Italy"
    pageTitle="Del Belbo - Da Bardon"
  />
);

export default DelBelboDaBardon;
