...
const TrattoriaDelBivio = () => (
  <RestaurantPage
    restaurantName="Trattoria del Bivio"
    address="localtà Cavallotti 9, Cerretto Langhe, 12050, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+390173520383"
    website="https://www.trattoriadelbivio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Alta Langa region, this old restored farmhouse is now home to an elegant restaurant with a contemporary rural feel. The cuisine has strong regional roots, although the menu also offers a few fishes dishes. Excellent food, as well as attractive guestrooms and a warm, family welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localt%C3%A0%20Cavallotti%209%2C%20Cerretto%20Langhe%2C%2012050%2C%20Italy"
    pageTitle="Trattoria del Bivio"
  />
);

export default TrattoriaDelBivio;
