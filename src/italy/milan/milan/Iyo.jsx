...
const Iyo = () => (
  <RestaurantPage
    restaurantName="Iyo"
    address="via Piero della Francesca 74, Milan, 20154, Italy"
    cuisine="Japanese, Asian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390245476898"
    website="https://www.iyo-restaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After significant refurbishment, this restaurant now has a completely new look – its black marble has been replaced by a more contemporary colour scheme that gives it a more international feel, while still maintaining a minimalism that is typically Japanese. At the entrance, guests are greeted by a small lounge and a long open-view kitchen where numerous sushi chefs can be seen at work, which then leads to a dining room decorated in soft, relaxing colours and furnished with striking round tables made from Patagonian marble. The extensive à la carte features all the classic dishes you would expect of a Japanese restaurant, including well-known versions of sushi, sashimi and tempura, alongside more creative fusion recipes which combine influences from Japan, Europe and elsewhere. There’s als..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Piero%20della%20Francesca%2074%2C%20Milan%2C%2020154%2C%20Italy"
    pageTitle="Iyo"
  />
);
