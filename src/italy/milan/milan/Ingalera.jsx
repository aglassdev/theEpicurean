...
const Ingalera = () => (
  <RestaurantPage
    restaurantName="InGalera"
    address="via Cristina Belgioioso 120, Milan, 20157, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+393343081189"
    website="https://www.ingalera.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thanks to its location inside Bollate prison, InGalera offers a unique dining experience. Here, guests eat in a room within the prison itself, while dishes – of equal quality to other restaurants in the area – are prepared with the contribution of prison inmates. In this subdued ambience, choose from meat and fish dishes, with a restricted choice at lunchtime and the option of ordering a single dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cristina%20Belgioioso%20120%2C%20Milan%2C%2020157%2C%20Italy"
    pageTitle="InGalera"
  />
);

export default Ingalera;
