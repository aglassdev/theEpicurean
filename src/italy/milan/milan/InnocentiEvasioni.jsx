...
const InnocentiEvasioni = () => (
  <RestaurantPage
    restaurantName="Innocenti Evasioni"
    address="via Giuseppe Candiani 66, Milan, 20158, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+390233001882"
    website="https://innocentievasioni.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Tommaso Arrigoni’s restaurant has a wonderful new location, where floor-to-ceiling windows in the spacious modern dining room overlook a large Mediterranean garden that is just as appealing as the Zen-inspired outdoor space at his previous venue. The chef’s colourful cuisine is showcased on three tasting menus, from which dishes can also be selected à la carte. The interesting “Delle Mezze” menu allows guests to sample several small portions of different dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Candiani%2066%2C%20Milan%2C%2020158%2C%20Italy"
    pageTitle="Innocenti Evasioni"
  />
);

export default InnocentiEvasioni;
