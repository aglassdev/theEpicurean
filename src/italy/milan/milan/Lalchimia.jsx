...
const Lalchimia = () => (
  <RestaurantPage
    restaurantName="L’Alchimia"
    address="viale Premuda 34, Milan, 20129, Italy"
    cuisine="Modern Cuisine, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390282870704"
    website="https://ristorantelalchimia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The parquet floor, wood-beamed ceiling and exposed brickwork lend a warm ambience to this restaurant, which is bright and airy during the day and romantic in the evening thanks to its soft lighting. With Giuseppe Postorino at the helm, the cuisine here includes classic recipes alongside more personalised dishes all prepared using top-quality ingredients that are typical of Italian cuisine. Additional features include a small, beautiful brick-vaulted wine cellar (open to visitors), plus an adjacent bar-bistro which serves quick lunches and excellent aperitifs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Premuda%2034%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="L’Alchimia"
  />
);

export default Lalchimia;
