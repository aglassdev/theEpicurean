...
const VoceAimoENadia = () => (
  <RestaurantPage
    restaurantName="Voce Aimo e Nadia"
    address="piazza della Scala 6, Milan, 20121, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+393493273374"
    website="https://www.aimoenadia.com/voce-aimo-e-nadia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of Milan, this restaurant owned by the historic Aimo e Nadia in Via Montecuccoli is accessed via its bar-cum-pastry shop which includes a bistro serving a selection of simpler dishes. From here, you enter the main dining room with an open-view kitchen serving excellent Italian dishes reinterpreted in contemporary style. Voce in Giardino, the restaurant’s outdoor summer dining space adorned with interesting sculptures, is a green oasis in the heart of the city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Scala%206%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Voce Aimo e Nadia"
  />
);

export default VoceAimoENadia;
