...
const Sadler = () => (
  <RestaurantPage
    restaurantName="Sadler"
    address="via dell'Annunciata 14, Milan, 20121, Italy"
    cuisine="Italian, Creative"
    priceRange="€€€€"
    phoneNumber="+390258104451"
    website="https://ristorantesadler.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Housed in the Casa Baglioni hotel, a beautiful Art Nouveau building dating from 1913, this restaurant has a contemporary feel with an elegant dining room featuring colourful armchairs. The cuisine is precise and distinctive, with a harmonious balance of traditional and innovative flavours thanks to the top-quality ingredients used. The wine list is also top-notch, featuring excellent Italian and international wines, including some rare and exclusive labels. An interesting business lunch is available at midday, while the Rooftop Bar on the seventh floor boasts 360° views of Milan and serves a selection of aperitifs designed especially by the chefs (open daily from 6pm-1am)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dell'Annunciata%2014%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Sadler"
  />
);

export default Sadler;
