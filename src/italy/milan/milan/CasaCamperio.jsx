...
const CasaCamperio = () => (
  <RestaurantPage
    restaurantName="Casa Camperio"
    address="Via Giorgio Giulini 6, Milan, 20123, Italy"
    cuisine="Italian Contemporary, Japanese"
    priceRange="€€€"
    phoneNumber="+390245484460"
    website="https://casacamperio.com/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in the basement of a centrally located office building, this welcoming restaurant serves original cuisine which has its roots in Milanese traditions yet has been updated for 21C palates, all overseen by Roberto Conti, formerly a Michelin-starred chef at Trussardi and now here as a consultant. Other dishes on the menu include Japanese-influenced options such as sushi rolls and raw dishes served as snacks for sharing. The restaurant also functions as a cocktail bar, offering a menu of twelve different house specialities, also with a Japanese flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Giorgio%20Giulini%206%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Casa Camperio"
  />
);

export default CasaCamperio;
