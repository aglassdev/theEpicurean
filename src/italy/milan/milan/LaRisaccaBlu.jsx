...
const LaRisaccaBlu = () => (
  <RestaurantPage
    restaurantName="La Risacca Blu"
    address="Viale Tunisia, angolo via Tadino, Milan, 20124, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+390220480964"
    website="https://www.larisaccablu.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The first thing you see when you enter this restaurant near the central railway station is its large display of fresh fish, all delivered daily. The menu features a selection of classic and authentic fish and seafood options, with pride of place given to its raw fish dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Viale%20Tunisia%2C%20angolo%20via%20Tadino%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="La Risacca Blu"
  />
);

export default LaRisaccaBlu;
