...
const TrattoriaDelNuovoMacello = () => (
  <RestaurantPage
    restaurantName="Trattoria del Nuovo Macello"
    address="via Cesare Lombroso 20, Milan, 20137, Italy"
    cuisine="Lombardian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390259902122"
    website="https://www.trattoriadelnuovomacello.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named after the slaughterhouse opened opposite the premises in 1927, this restaurant was taken over 30 years later by the grandfather of one of the current partners, as he was convinced that the restaurant’s busy location would contribute to its success – and he wasn’t wrong! The traditional, regional cuisine served here is reinterpreted with a contemporary flavour and includes delicious specialities such as cotoletta alla milanese made from meat matured for 40 days...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cesare%20Lombroso%2020%2C%20Milan%2C%2020137%2C%20Italy"
    pageTitle="Trattoria del Nuovo Macello"
  />
);

export default TrattoriaDelNuovoMacello;
