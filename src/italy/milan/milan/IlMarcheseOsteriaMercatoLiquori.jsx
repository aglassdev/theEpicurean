...
const IlMarcheseOsteriaMercatoLiquori = () => (
  <RestaurantPage
    restaurantName="Il Marchese - Osteria Mercato Liquori"
    address="via dei Bossi 3, Milan, 20121, Italy"
    cuisine="Roman, Italian"
    priceRange="€€€"
    phoneNumber="+390258124986"
    website="https://www.ilmarchesemilano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting a sumptuous Art Deco setting that contrasts pleasingly with the traditional cuisine served here, this restaurant is the Milanese sibling of Il Marchese in Rome which pays tribute to the famous Italian film “Il Marchese del Grillo” starring Alberto Sordi (it is also the first bar in Europe to offer more than 600 “amaro” liqueurs). The culinary philosophy here is based on traditional Roman cuisine with a contemporary flavour, including delicious specialities such as pasta with carbonara, matriciana and gricia sauces, veal saltimbocca, pork belly and much more besides!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Bossi%203%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Il Marchese - Osteria Mercato Liquori"
  />
);

export default IlMarcheseOsteriaMercatoLiquori;
