...
const QuadriBistrot = () => (
  <RestaurantPage
    restaurantName="Quadri Bistrot"
    address="Via Solferino 48, Milan, 20121, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€"
    phoneNumber="+390247755505"
    website="https://www.quadribistrot.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A modern bistro with a cocktail-bar, trendy decor, soft lighting and lounge-style background music, as well as a small outdoor space on the pavement which needs to be booked well in advance. The imaginative cuisine comes courtesy of a talented chef who creates dishes full of character from top-quality seasonal ingredients. Our inspectors particularly enjoyed the Bresse chicken stuffed with a cherry sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Solferino%2048%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Quadri Bistrot"
  />
);

export default QuadriBistrot;
