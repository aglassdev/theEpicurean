...
const Pacifico = () => (
  <RestaurantPage
    restaurantName="Pacifico"
    address="via Moscova 29, Milan, 20123, Italy"
    cuisine="Peruvian, Asian Influences"
    priceRange="€€€"
    phoneNumber="+390287244737"
    website="https://www.wearepacifico.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although its dining rooms are fairly small, this restaurant, which acts as an ambassador for Peruvian cuisine with the occasional Asian influence, has an attractive, trendy ambience and a theatrical feel. Excellent choice of ceviche – raw fish or seafood dishes marinated in lemon and flavoured with spices such as chilli pepper and coriander – which are a typical speciality of Latin American countries along the Pacific coast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Moscova%2029%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Pacifico"
  />
);
