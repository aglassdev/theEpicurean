...
const LeNoveScodelle = () => (
  <RestaurantPage
    restaurantName="Le Nove Scodelle"
    address="viale Monza 4, Milan, 20127, Italy"
    cuisine="Chinese, Sichuan"
    priceRange="€"
    phoneNumber="+393318001116"
    website="https://www.lenovescodelle.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Now available everywhere in Italy, ethnic cuisine is gradually becoming more specialised, as is the case in this restaurant serving specialities from the province of Szechuan in south-west China. Exciting and original cuisine full of spicy flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Monza%204%2C%20Milan%2C%2020127%2C%20Italy"
    pageTitle="Le Nove Scodelle"
  />
);

export default LeNoveScodelle;
