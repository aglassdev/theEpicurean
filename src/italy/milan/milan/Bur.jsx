...
const Bur = () => (
  <RestaurantPage
    restaurantName="[bu:r]"
    address="via Giuseppe Mercalli 22, Milan, 20122, Italy"
    cuisine="Creative, International"
    priceRange="€€€€"
    phoneNumber="+390262065383"
    website="https://www.restaurantboer.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Eugenio Boer offers a 100% Italian menu which focuses on local ingredients, with the aim of showcasing some of Italy’s favourite dishes while at the same time supporting small-scale producers. However, this philosophy is in no way limited to respecting traditions – on the contrary, it offers the chef the freedom to express his own creativity via a selection of dishes which combine past and present. As a result, guests can choose between a concise à la carte and two different tasting menus: “I Classici” (meat-based dishes) and “Le Aromatiche”, which changes perspective by placing aromatic plants centre stage. In short, a flexible approach which offers guests a culinary experience that will certainly make an impression!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Mercalli%2022%2C%20Milan%2C%2020122%2C%20Italy"
    pageTitle="[bu:r]"
  />
);
