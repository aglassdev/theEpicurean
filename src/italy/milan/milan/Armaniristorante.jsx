...
const Armaniristorante = () => (
  <RestaurantPage
    restaurantName="Armani/Ristorante"
    address="via Manzoni 31, Milan, 20121, Italy"
    cuisine="Italian Contemporary, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+390288838702"
    website="https://www.armanihotels.com/it/restaurant/armani-ristorante-milano/?hotel=armani-hotel-milano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Elegant and carefully prepared contemporary cuisine served on the seventh floor of a palazzo which is totally dedicated to the world of Armani. Superb views of Milan combine with a decor of black marble and backlit onyx to create an exclusive and fashionable ambience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Manzoni%2031%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Armani/Ristorante"
  />
);

export default Armaniristorante;
