...
const LaCucinaDeiFrigoriferiMilanesi = () => (
  <RestaurantPage
    restaurantName="La Cucina dei Frigoriferi Milanesi"
    address="via Piranesi 10, Milan, 20137, Italy"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+390239666784"
    website="https://www.lacucinadeifrigoriferimilanesi.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An interesting location in the artistic-cultural setting of the Frigoriferi Milanesi industrial complex for this restaurant with a modern feel both in its decor and its market cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Piranesi%2010%2C%20Milan%2C%2020137%2C%20Italy"
    pageTitle="La Cucina dei Frigoriferi Milanesi"
  />
);

export default LaCucinaDeiFrigoriferiMilanesi;
