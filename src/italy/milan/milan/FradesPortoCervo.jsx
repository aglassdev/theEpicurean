...
const FradesPortoCervo = () => (
  <RestaurantPage
    restaurantName="Frades Porto Cervo"
    address="via Giuseppe Mazzini 20, Milan, 20123, Italy"
    cuisine="Sardinian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393913863232"
    website="https://frades.eu/it/content/milano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This new Milan venture is the brainchild of three brothers who already run a restaurant and delicatessen in Porto Cervo. Elegant and extremely contemporary in style, the restaurant serves modern Sardinian cuisine, while a corner reminiscent of their delicatessen allows guests to taste the island’s hams and cheeses by the slice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Mazzini%2020%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Frades Porto Cervo"
  />
);

export default FradesPortoCervo;
