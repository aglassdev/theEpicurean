...
const Altrimnti = () => (
  <RestaurantPage
    restaurantName="Altriménti"
    address="via Monte Bianco 2/a, Milan, 20149, Italy"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+390282778751"
    website="https://altrimenti.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An informal and contemporary restaurant which is elegant and yet retains a bistro feel. The cuisine is modern with meat and fish dishes featured on the menu, as well as a good number of vegetarian options. Good wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Monte%20Bianco%202%2Fa%2C%20Milan%2C%2020149%2C%20Italy"
    pageTitle="Altriménti"
  />
);

export default Altrimnti;
