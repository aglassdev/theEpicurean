...
const LaCucinaDeMibabbo = () => (
  <RestaurantPage
    restaurantName="La Cucina de' Mibabbo"
    address="corso Lodi 19, Milan, 20135, Italy"
    cuisine="Tuscan, Meats and Grills"
    priceRange="€€"
    phoneNumber="+390245488997"
    website="https://www.mibabbo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name (“My grandfather’s cooking”) says it all: this restaurant serves cuisine from the owner’s native Tuscany, with a focus on Tuscan ingredients prepared with an updated and modern twist. Good selection of Tuscan specialities such as grilled meats and dishes cooked in a wood-fired oven in the evening, while the lunchtime menu is more restricted and Italian in feel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Lodi%2019%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="La Cucina de' Mibabbo"
  />
);

export default LaCucinaDeMibabbo;
