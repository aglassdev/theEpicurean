...
const Danielcanzian = () => (
  <RestaurantPage
    restaurantName="DanielCanzian"
    address="via Castelfidardo 7, Milan, 20121, Italy"
    cuisine="Italian Contemporary, Venetian"
    priceRange="€€€"
    phoneNumber="+390263793837"
    website="https://danielcanzian.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of Brera and refurbished in the autumn of 2019, this restaurant showcases Italian artisanal skills through its bespoke furnishings, creating a fine setting for Canzian’s superb cuisine. A great choice for anyone looking for classic Italian dishes plus a few more inventive options, all of which are prepared using the very best ingredients. Simpler fare available at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castelfidardo%207%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="DanielCanzian"
  />
);

export default Danielcanzian;
