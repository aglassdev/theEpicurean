...
const WickysInnovativeJapaneseCuisine = () => (
  <RestaurantPage
    restaurantName="Wicky's Innovative Japanese Cuisine"
    address="corso Italia 6, Milan, 20122, Italy"
    cuisine="Japanese, Asian Contemporary"
    priceRange="€€€"
    phoneNumber="+390289093781"
    website="https://wicuisine.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the contemporary, minimalist-style decor is typical of Japanese restaurants, the cuisine will come as more of a surprise, with its magical blend of classic Japanese dishes made from Mediterranean ingredients, beautifully presented and full of flavour. There are two dining rooms: one overlooking the road, and the other with an open-view kitchen and sushi bar, where the chef serves an evening tasting menu for guests happy to put their faith in his imaginative improvisational skills...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Italia%206%2C%20Milan%2C%2020122%2C%20Italy"
    pageTitle="Wicky's Innovative Japanese Cuisine"
  />
);

export default WickysInnovativeJapaneseCuisine;
