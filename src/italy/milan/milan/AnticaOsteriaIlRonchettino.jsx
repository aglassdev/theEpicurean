...
const AnticaOsteriaIlRonchettino = () => (
  <RestaurantPage
    restaurantName="Antica Osteria il Ronchettino"
    address="via Lelio Basso 9, Milan, 20142, Italy"
    cuisine="Milanese, Lombardian"
    priceRange="€€"
    phoneNumber="+393425643955"
    website="https://www.ronchettino.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name seems to originate from the broken horseshoe (ronchetto) of Napoleon, who in 1800 appears to have stayed the night here, where there was indeed a post house where horses were shoed. Later converted into a bakery, butcher’s shop, but also a trattoria with an annexed bowling alley, today it is a restaurant of rustic elegance; the regional cuisine expresses itself in specialties such as fried brains and the ever-present Milanese-style cutlet that here becomes even “imperial”, definitely to be shared...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lelio%20Basso%209%2C%20Milan%2C%2020142%2C%20Italy"
    pageTitle="Antica Osteria il Ronchettino"
  />
);

export default AnticaOsteriaIlRonchettino;
