...
const Nobuya = () => (
  <RestaurantPage
    restaurantName="Nobuya"
    address="Via San Nicolao 3/a, Milan, 20123, Italy"
    cuisine="Japanese Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393318088558"
    website="https://www.nobuya.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nobuya boasts a minimalist elegance that is typical of Japanese restaurants, with brown tables, dark wooden beams on the ceiling, attractive subdued lighting, plus an illuminated wine cabinet to add a touch of colour. Here, the talented Japanese chef creates top-quality cuisine using the freshest ingredients. At lunchtime, there’s also a lighter “Bento box” and an omakase tasting menu (“Mi affido a te”) which is completely vegetarian...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20San%20Nicolao%203%2Fa%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Nobuya"
  />
);

export default Nobuya;
