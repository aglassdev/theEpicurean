...
const Hazama = () => (
  <RestaurantPage
    restaurantName="Hazama"
    address="via Savona 41, Milan, 20144, Italy"
    cuisine="Japanese, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+390209955972"
    website="https://www.ristorantehazama.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese cuisine served in a small restaurant where both the cuisine and decor are minimalist in style. Here, young chef Satoshi Hazama creates light dishes full of Japanese flavour, all made from top-quality ingredients. The kaiseki menu served in the evening consists of seven or nine different courses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Savona%2041%2C%20Milan%2C%2020144%2C%20Italy"
    pageTitle="Hazama"
  />
);

export default Hazama;
