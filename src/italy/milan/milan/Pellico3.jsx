...
const Pellico3 = () => (
  <RestaurantPage
    restaurantName="Pellico 3"
    address="via Silvio Pellico 3, Milan, 20121, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+390288211236"
    website="https://pellico3milano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the luxury Park Hyatt hotel just a few metres from the Galleria Vittorio Emanuele, this restaurant is home to a young chef who serves elegant and occasionally complex cuisine. His dishes include sauces and traditions learned from his time working in France, as well as plenty of vegetables and Mediterranean influences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Silvio%20Pellico%203%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Pellico 3"
  />
);

export default Pellico3;
