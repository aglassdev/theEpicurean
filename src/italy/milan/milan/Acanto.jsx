...
const Acanto = () => (
  <RestaurantPage
    restaurantName="Acanto"
    address="piazza della Repubblica 17, Milan, 20124, Italy"
    cuisine="Modern Cuisine, International"
    priceRange="€€€€"
    phoneNumber="+390262302026"
    website="https://www.dorchestercollection.com/it/milan/hotel-principe-di-savoia/ristoranti-e-bar/ristorante-acanto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At Acanto, the young new chef at the helm, Matteo Gabrielli, who has experience of working abroad, focuses firmly on traditional cuisine – the risotto alla Milanese remains one of the highlights here! In a classic-style dining room inside the Principe di Savoia hotel, enjoy Italian meat and fish dishes prepared using modern techniques that allow the quality of the ingredients to shine through. Attentive, professional service adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Repubblica%2017%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Acanto"
  />
);

export default Acanto;
