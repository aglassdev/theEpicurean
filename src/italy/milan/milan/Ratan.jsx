...
const Ratan = () => (
  <RestaurantPage
    restaurantName="Ratanà"
    address="via G. de Castillia 28, Milan, 20124, Italy"
    cuisine="Italian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390287128855"
    website="https://www.ratana.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This lively, dynamic restaurant is in a converted building that once housed a cinema and later belonged to the railways. Top quality ingredients take pride of place here, while the pleasant outdoor area overlooking a small park is an added attraction...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20G.%20de%20Castillia%2028%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Ratanà"
  />
);
