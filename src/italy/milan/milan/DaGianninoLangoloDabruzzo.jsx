...
const DaGianninoLangoloDabruzzo = () => (
  <RestaurantPage
    restaurantName="Da Giannino - L'Angolo d'Abruzzo"
    address="via Rosolino Pilo 20, Milan, 20129, Italy"
    cuisine="Cuisine from Abruzzo, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390229406526"
    website="https://da-giannino-langolo-dabruzzo.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A simple and informal urban trattoria with a friendly atmosphere, tables arranged close together and typical red-and-white check tablecloths. The Abruzzo takes centre stage in the delicious cuisine served here – we particularly recommend the sagne (a type of pasta) and beans, the maccheroni alla chitarra, the roast lamb and the arrosticini (skewers of mutton)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Rosolino%20Pilo%2020%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="Da Giannino - L'Angolo d'Abruzzo"
  />
);

export default DaGianninoLangoloDabruzzo;
