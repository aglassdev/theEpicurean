...
const DimSum = () => (
  <RestaurantPage
    ...
    address="via Nino Bixio 29, Milan, 20129, Italy"
    cuisine="Cantonese, Contemporary"
    priceRange="€€€"
    phoneNumber="+390229522821"
    website="https://www.dimsummilano.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with a partially open kitchen introduces its guests to the delicious specialities of Guangzhou and Southern China in rooms full of decorative details. The small dishes which characterise the culinary traditions of these regions have been refined with just a hint of contemporary flavour. A truly authentic Chinese dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nino%20Bixio%2029%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="Dim Sum"
  />
);
