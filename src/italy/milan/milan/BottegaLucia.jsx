...
const BottegaLucia = () => (
  <RestaurantPage
    restaurantName="Bottega Lucia"
    address="via Carlo Ravizza 4, Milan, 20149, Italy"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+39024814295"
    website="https://www.bottegalucia.eu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bottega Lucia serves a cuisine which is mainly Italian in style, with the addition of a few specialities from the Iberian Peninsula and other countries. Home-made pasta, meat and fish can be enjoyed in an attractive New York-style bistro, while the American bar serves drinks and a selection of delicious, tempting snacks in the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Carlo%20Ravizza%204%2C%20Milan%2C%2020149%2C%20Italy"
    pageTitle="Bottega Lucia"
  />
);

export default BottegaLucia;
