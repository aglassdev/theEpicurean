...
const MuDimsum = () => (
  <RestaurantPage
    restaurantName="MU Dimsum"
    address="via Aminto Caretto 3, Milan, 20124, Italy"
    cuisine="Chinese Contemporary, Cantonese"
    priceRange="€€"
    phoneNumber="+393383582658"
    website="https://www.murestaurants.com/it/mu-dimsum"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Already visible from the pavement outside this restaurant, the large kitchen where its staff can be observed busy at work is testament to its success. Inside, the dining room is modern and elegant, with careful lighting effects creating a muted ambience in the evening. The extensive menu features classic Chinese dishes – in addition to different types of delicious dim sum, Peking duck also takes pride of place among the main courses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Aminto%20Caretto%203%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="MU Dimsum"
  />
);

export default MuDimsum;
