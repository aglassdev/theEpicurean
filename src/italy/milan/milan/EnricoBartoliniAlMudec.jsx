...
const EnricoBartoliniAlMudec = () => (
  <RestaurantPage
    restaurantName="Enrico Bartolini al Mudec"
    address="via Tortona 56, Milan, 20144, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390284293701"
    website="https://www.enricobartolini.net"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In his Milanese restaurant, the headquarters of the Bartolini international galaxy, the great chef – far from taking a break – continues to craft new dishes alongside resident chef Davide Boglioli, always focusing on fullness and intensity of flavors. There's nothing overly cerebral, though you can delve into the layers, references, and echoes if you wish. Or simply enjoy the perfect balance of the results. There are two tasting options: Best Of and Mudec Experience, but dishes can also be selected à la carte. During our last visit, we were particularly struck by the creaminess and harmony of the beetroot risotto with “Evoluzione” gorgonzola sauce. And speaking of cheeses, we recommend trying (off-menu) Our Tasting of 5 Creative Cheeses, with rare and intriguing pairings. All of this is se..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Tortona%2056%2C%20Milan%2C%2020144%2C%20Italy"
    pageTitle="Enrico Bartolini al Mudec"
  />
);

export default EnricoBartoliniAlMudec;
