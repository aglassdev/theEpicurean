...
const DonCarlos = () => (
  <RestaurantPage
    restaurantName="Don Carlos"
    address="via Manzoni 29, Milan, 20121, Italy"
    cuisine="Modern Cuisine, Milanese"
    priceRange="€€€€"
    phoneNumber="+390272314640"
    website="https://www.ristorantedoncarlos.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The tribute that the Grand Hotel dedicates to Giuseppe Verdi is accompanied, in the small historic rooms of the Don Carlos, by a tribute to Milanese and Italian cuisine, perhaps with a Mediterranean nuance introduced by multi-star Gennaro Esposito, here as a consultant, and carefully executed. In a succession of sketches, pictures and paintings dedicated to the world of opera, for music lovers the restaurant is a must-visit. Caruso Nuovo, on the other hand, with its bistro formula, can be an always inviting and less demanding alternative...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Manzoni%2029%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Don Carlos"
  />
);

export default DonCarlos;
