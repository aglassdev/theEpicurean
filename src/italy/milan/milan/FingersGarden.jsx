...
const FingersGarden = () => (
  <RestaurantPage
    restaurantName="Finger's Garden"
    address="via Keplero 2, Milan, 20124, Italy"
    cuisine="Fusion, Asian Contemporary"
    priceRange="€€€"
    phoneNumber="+3902606544"
    website="https://www.fingersrestaurants.com/i-ristoranti/fingers-garden/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Firmly aimed at a trendier crowd, this restaurant has soft lighting and an Oriental feel. The chef here skilfully creates a range of dishes, including raw fish options and original fusion cuisine with a hint of Brazilian flavour. Gourmet diners will be happy to give full rein to the chef on his surprise menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Keplero%202%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Finger's Garden"
  />
);

export default FingersGarden;
