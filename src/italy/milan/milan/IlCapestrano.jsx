...
const IlCapestrano = () => (
  <RestaurantPage
    restaurantName="Il Capestrano"
    address="via Gian Francesco Pizzi 14, Milan, 20141, Italy"
    cuisine="Cuisine from Abruzzo"
    priceRange="€€"
    phoneNumber="+39025693345"
    website="https://www.ilcapestrano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant takes its name from the warrior statue dating back to the 6C BC which was discovered in Capestrano (Aquila province) in 1934. The statue, carved from a single block of local stone, is one of the most mysterious finds in history. No such mystery surrounds the dishes served in this restaurant, which focuses on cuisine from the Abruzzo, including top-quality hams and cheeses produced by small-scale producers, as well as mutton, lamb, beef, barbecued lamb kebabs and other culinary delights...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Gian%20Francesco%20Pizzi%2014%2C%20Milan%2C%2020141%2C%20Italy"
    pageTitle="Il Capestrano"
  />
);

export default IlCapestrano;
