...
const LangosteriaMIL = () => (
  <RestaurantPage
    restaurantName="Langosteria"
    address="via Savona 10, Milan, 20144, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+390258111649"
    website="https://langosteria.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you are looking for fish specialities, you will find this restaurant a real revelation. Raw dishes, oysters and seafood take pride of place on the menu, alongside freshly caught fish. An excellent wine selection and a glamorous ambience complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Savona%2010%2C%20Milan%2C%2020144%2C%20Italy"
    pageTitle="Langosteria"
  />
);

export default LangosteriaMIL;
