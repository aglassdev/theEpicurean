...
const Izu = () => (
  <RestaurantPage
    restaurantName="Izu"
    address="Corso Lodi 27, Milan, 20135, Italy"
    cuisine="Japanese Contemporary, Fusion"
    priceRange="€€€"
    phoneNumber="+390259900221"
    website="https://izumilano.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Recent refurbishment at this long-standing restaurant on the city’s main square has given it the feel of an elegant bistro. Although the owners and managers here are Chinese, the cuisine focuses on Japan and includes all the usual classic options (sushi, uramaki, sashimi etc), as well as a series of “Izu special creations” and various dishes influenced by Asia and the Mediterranean alike. There’s also a good wine list (including, as you might expect, a few sakes) overseen by an experienced and knowledgeable sommelier...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corso%20Lodi%2027%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="Izu"
  />
);
