...
const AnticaOsteriaDelMare = () => (
  <RestaurantPage
    restaurantName="Antica Osteria del Mare"
    address="via Ascanio Sforza 105, Milan, 20141, Italy"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390289546534"
    website="https://www.anticaosteriadelmare.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the Naviglio away from Milan’s bustling nightlife, this rustic-style restaurant is decorated with a profusion of wood. As the name suggests, fish and seafood take pride of place on the menu, with a good choice of antipasti to whet the appetite, as well as inviting trays of raw fish dishes (shared by the whole table), followed by delicious traditional pasta and grilled options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ascanio%20Sforza%20105%2C%20Milan%2C%2020141%2C%20Italy"
    pageTitle="Antica Osteria del Mare"
  />
);

export default AnticaOsteriaDelMare;
