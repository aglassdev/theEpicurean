...
const Ceresio7 = () => (
  <RestaurantPage
    restaurantName="Ceresio 7"
    address="via Ceresio 7, Milan, 20154, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390231039221"
    website="https://www.ceresio7.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This designer-style restaurant is housed on the fourth floor of the historic ENEL palazzo, remodelled and converted into the Dsquared2 building. It combines the use of brass, marble and wood to create a successful blend of attractive colours and vintage decor. The view of Milan (even better from the long outdoor terrace with its two swimming pools) completes the picture, while the cuisine reinterprets Italian classics with a contemporary twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ceresio%207%2C%20Milan%2C%2020154%2C%20Italy"
    pageTitle="Ceresio 7"
  />
);

export default Ceresio7;
