...
const Remulass = () => (
  <RestaurantPage
    restaurantName="Remulass"
    address="via Nino Bixio 21, Milan, 20129, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390252517356"
    website="https://www.remulass.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“Cooking with roots” is the mantra at Remulass, a phrase that has inspired the restaurant’s name (“wild radish” in the local Milanese dialect). This small, lively restaurant gets very busy in the evenings when booking is highly recommended. The attractively modern and colourful dishes here always feature plenty of root vegetables and aromatic herbs. We recommend the fermented vegetables with baked ricotta and a gin dressing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nino%20Bixio%2021%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="Remulass"
  />
);

export default Remulass;
