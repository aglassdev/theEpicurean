...
const TerrazzaGallia = () => (
  <RestaurantPage
    restaurantName="Terrazza Gallia"
    address="piazza Duca d'Aosta 9, Milan, 20124, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390267853514"
    website="https://www.terrazzagallia.com/it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the seventh floor with panoramic views of the city, this restaurant is an excellent choice for a light lunch, a cocktail or an informal dinner. Two young brothers from Naples are at the helm here, creating traditional Italian and Lombardian dishes with a creative and contemporary touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Duca%20d'Aosta%209%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Terrazza Gallia"
  />
);

export default TerrazzaGallia;
