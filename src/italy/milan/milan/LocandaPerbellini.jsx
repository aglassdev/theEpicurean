...
const LocandaPerbellini = () => (
  <RestaurantPage
    restaurantName="Locanda Perbellini"
    address="via Moscova 25, Milan, 20121, Italy"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+390236631450"
    website="https://locandaperbellini.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Highly renowned in his native Verona, Michelin - starred chef Giancarlo Perbellini has now opened a restaurant in Milan, where he continues to offer traditional Italian cuisine from the north and south of the country, with a nod to new techniques and contemporary trends. Situated in the central Brera district, his warm and welcoming restaurant is small, discreet and, of course, highly elegant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Moscova%2025%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Locanda Perbellini"
  />
);

export default LocandaPerbellini;
