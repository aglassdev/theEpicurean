...
const Bites = () => (
  <RestaurantPage
    restaurantName="Bites"
    address="via Lambro 11, Milan, 20129, Italy"
    cuisine="International, Small eats"
    priceRange="€€€"
    phoneNumber="+393518668452"
    website="https://www.bitesmilano.net"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cuisine at this tiny, simply furnished restaurant includes barbecued dishes and fermented ingredients, all of which feature on a tasting menu. Guests can also choose à la carte: the small portions (as the restaurant name suggests) make it possible to taste several dishes at a reasonable cost. Booking is essential in the evening and also advisable at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lambro%2011%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="Bites"
  />
);
