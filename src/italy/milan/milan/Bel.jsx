...
const Bel = () => (
  <RestaurantPage
    restaurantName="Belé"
    address="via Angelo Fumagalli 3, Milan, 20143, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€"
    phoneNumber="+390236642933"
    website="https://beleristorante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name says it all – in Milanese dialect, “belé” means beautiful and the word is an apt description of this restaurant. Belé is charmingly lit by an old-fashioned chandelier on which the pieces of crystal create a play of light resembling an intricate and shifting lace-like pattern. The dining rooms are decorated in attractive contemporary colours, with comfortable armchairs and acoustics perfect for conversation, while the cuisine is Italian with a modern twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Angelo%20Fumagalli%203%2C%20Milan%2C%2020143%2C%20Italy"
    pageTitle="Belé"
  />
);
