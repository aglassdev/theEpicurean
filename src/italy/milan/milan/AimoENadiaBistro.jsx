...
const AimoENadiaBistro = () => (
  <RestaurantPage
    restaurantName="Aimo e Nadia BistRo"
    address="via Matteo Bandello 14, Milan, 20121, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390248026205"
    website="https://www.aimoenadia.com/bistro-aimo-e-nadia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A stylish and elegant gem, this bistro is a simpler and more informal version of the famous Michelin-starred restaurant Aimo e Nadia. The menu includes a selection of Italian recipes reinterpreted with a modern twist, together with a delicious array of plates to share which are perfect with one of the cocktails served here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Matteo%20Bandello%2014%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Aimo e Nadia BistRo"
  />
);

export default AimoENadiaBistro;
