...
const CraccoInGalleria = () => (
  <RestaurantPage
    restaurantName="Cracco in Galleria"
    address="Galleria Vittorio Emanuele II, Milan, 20121, Italy"
    cuisine="Modern Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+3902876774"
    website="https://www.ristorantecracco.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Galleria Vittorio Emanuele II is one of the most iconic sights in Milan and as such it is apt that it is home to this star of Italian cuisine, whose professional career is one of the most impressive in Italy with influences that include the culinary master Alain Ducasse and wine expert Giorgio Pinchiorri. Together with owner Carlo, resident chef Luca Sacchi creates top-quality cuisine with impeccable technique. He showcases his dishes on a carefully composed tasting menu and an à la carte, with references to contemporary Italian cuisine in dishes such as the open ravioli and reinterpretations of classic favourites, such as vitello alla Milanese (breaded veal cutlet). The wine list is an experience in itself, offering one of the best and most comprehensive selections of French wines in ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Galleria%20Vittorio%20Emanuele%20II%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Cracco in Galleria"
  />
);

export default CraccoInGalleria;
