...
const Dongi = () => (
  <RestaurantPage
    restaurantName="Dongiò"
    address="via Corio 3, Milan, 20135, Italy"
    cuisine="Calabrian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+393492761011"
    website="https://www.dongio.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you enjoy Calabrian cuisine and you want to keep to a budget, then Dongiò is the place for you! The menu here offers a good selection of regional specialities, all full of intense and satisfying flavours and served in a simple yet friendly ambience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Corio%203%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="Dongiò"
  />
);
