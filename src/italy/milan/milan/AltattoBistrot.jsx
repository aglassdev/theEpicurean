...
const AltattoBistrot = () => (
  <RestaurantPage
    restaurantName="Altatto Bistrot"
    address="via Comune Antico 15, Milan, 20125, Italy"
    cuisine="Vegetarian, Contemporary"
    priceRange="€€"
    phoneNumber="+393286641670"
    website="https://altatto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the edge of old Milan, this former bakery has been converted into a tiny restaurant serving vegetarian cuisine in a contemporary-style setting. The two tasting menus include delicious, colourful and beautifully presented dishes which can also be ordered à la carte. Booking is essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Comune%20Antico%2015%2C%20Milan%2C%2020125%2C%20Italy"
    pageTitle="Altatto Bistrot"
  />
);

export default AltattoBistrot;
