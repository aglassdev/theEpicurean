...
const LaRosaDeiVenti = () => (
  <RestaurantPage
    restaurantName="La Rosa dei Venti"
    address="via Piero della Francesca 34, Milan, 20154, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+3902347338"
    website="https://guide.michelin.com/en/lombardia/milano/restaurant/la-rosa-dei-venti"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant is perfect for anyone keen on fish prepared simply with a personal touch – and with the added bonus of providing good value for money. The restaurant belongs to the AIC network (Italian Association for Coeliacs) and therefore offers a good selection of gluten - free dishes, including bread and pasta...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Piero%20della%20Francesca%2034%2C%20Milan%2C%2020154%2C%20Italy"
    pageTitle="La Rosa dei Venti"
  />
);

export default LaRosaDeiVenti;
