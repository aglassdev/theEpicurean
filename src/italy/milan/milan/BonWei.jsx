...
const BonWei = () => (
  <RestaurantPage
    restaurantName="Bon Wei"
    address="via Castelvetro 16/18, Milan, 20154, Italy"
    cuisine="Chinese, Asian"
    priceRange="€€"
    phoneNumber="+3902341308"
    website="https://www.bon-wei.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="China on a plate! This attractive restaurant with an intriguing decor combining elegance, modern style and Asian influences serves a wide selection of Chinese specialities. Dishes include appetisers, dumplings, noodles and meat options, as well as a huge array of specialities from eight different regions, from the spicy dishes of Szechuan to the delicate flavours of Zhejiang...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castelvetro%2016%2F18%2C%20Milan%2C%2020154%2C%20Italy"
    pageTitle="Bon Wei"
  />
);

export default BonWei;
