...
const IlLiberty = () => (
  <RestaurantPage
    restaurantName="Il Liberty"
    address="viale Monte Grappa 6, Milan, 20124, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+390229011439"
    website="https://www.il-liberty.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying an Art Nouveau-style palazzo, this small restaurant with two rooms and a loft area has a friendly, welcoming atmosphere. The menu includes a selection of fish and meat dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Monte%20Grappa%206%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Il Liberty"
  />
);

export default IlLiberty;
