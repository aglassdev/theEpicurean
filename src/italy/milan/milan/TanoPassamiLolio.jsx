...
const TanoPassamiLolio = () => (
  <RestaurantPage
    restaurantName="Tano Passami l'Olio"
    address="via Francesco Petrarca 4, Milan, 20123, Italy"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+39028394139"
    website="https://www.tanopassamilolio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tano Simonato, chef-patron of this stylish modern restaurant located in a fine residential district, offers his creative cuisine that reinterprets Italian flavors in a modern key: food for him is not just nourishment, but also fun. He will then come to your table to advise you and tell you about his dishes, suggesting the best wine pairing, also thanks to a well-stocked cellar. The inspector recommends: Tiramisù of cuttlefish and potatoes, as well as Almond Cannoli stuffed with mousse of ricotta with almonds, candied lemon and chocolate drops, with citrus fruit cream and almond jam...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Francesco%20Petrarca%204%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Tano Passami l'Olio"
  />
);

export default TanoPassamiLolio;
