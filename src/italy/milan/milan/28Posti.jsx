...
const TwoEightPosti = () => (
  <RestaurantPage
    restaurantName="28 Posti"
    address="via Corsico 1, Milan, 20144, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39028392377"
    website="https://www.28posti.org"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The main focus of 28 Posti is its ethical stance, with seasonal ingredients sourced from small producers and an emphasis on making the most of each and every ingredient in order to keep food waste to a minimum – a philosophy that has been important to the restaurant for many years now. New chefs Franco Salvatore and Andrea Zazzara, both from the Abruzzi, have brought their own personal touches to cuisine which has its roots in the rich gastronomic traditions of central Italy and their native region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Corsico%201%2C%20Milan%2C%2020144%2C%20Italy"
    pageTitle="28 Posti"
  />
);

export default TwoEightPosti;
