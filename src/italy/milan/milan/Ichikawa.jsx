...
const Ichikawa = () => (
  <RestaurantPage
    restaurantName="Ichikawa"
    address="via Lazzaro Papi 18, Milan, 20135, Italy"
    cuisine="Japanese, Asian"
    priceRange="€€€"
    phoneNumber="+390247750431"
    website="https://www.ichikawa.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ichikawa is one of the culinary masters who played a part in introducing Japanese cuisine to Italy. After decades in the country working in various restaurants, this chef has finally opened his own eatery, where he serves top-quality Japanese cuisine ranging from familiar favourites such as sushi and sashimi to other less-known family dishes and street food from the land of the Rising Sun. A good place to discover the joys of Japanese cuisine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lazzaro%20Papi%2018%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="Ichikawa"
  />
);

export default Ichikawa;
