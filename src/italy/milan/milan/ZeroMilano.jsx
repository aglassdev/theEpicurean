...
const ZeroMilano = () => (
  <RestaurantPage
    restaurantName="Zero Milano"
    address="corso Magenta 87, Milan, 20123, Italy"
    cuisine="Japanese, Fusion"
    priceRange="€€€"
    phoneNumber="+390245474733"
    website="https://www.zero-milano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s absolutely zero compromise on attention and quality in this restaurant, where the cuisine is made from top-quality ingredients using all the technical expertise typical of Japanese cooking. Chef Hide is now assisted by two of his compatriots who are real sushi experts, emphasising Zero Milano’s ambition to be one of the best Japanese restaurants in Milan, with its menu featuring Japanese specialities alongside dishes with a more contemporary Western flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Magenta%2087%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Zero Milano"
  />
);

export default ZeroMilano;
