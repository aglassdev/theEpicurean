...
const LaSocietMilano = () => (
  <RestaurantPage
    restaurantName="La Società Milano"
    address="via Panfilo Castaldi 19, Milan, 20124, Italy"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+390229401119"
    website="https://lasocietamilano.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated near Porta Venezia and its lush gardens, Giulia and Andrea’s restaurant boasts a warm and original ambience. Three dining rooms adorned with tapestries and an entrance with a fine white marble fireplace act as the setting for Mediterranean cuisine with the occasional exotic twist. Don’t miss the amberjack caponata in which the ceviche flavours contrast with the sweetness of the fried breaded aubergine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Panfilo%20Castaldi%2019%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="La Società Milano"
  />
);

export default LaSocietMilano;
