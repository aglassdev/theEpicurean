...
const UnPostoAMilano = () => (
  <RestaurantPage
    restaurantName="Un Posto a Milano"
    address="via Cuccagna 2, Milan, 20135, Italy"
    cuisine="Farm to table, Italian Contemporary"
    priceRange="€€"
    phoneNumber="+39025457785"
    website="https://www.unpostoamilano.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Un Posto a Milan is a farmhouse in the city: an ideal place to spend a few hours outdoors, but also an agricultural market, a kitchen serving food, a carpentry workshop and a venue offering a host of other activities. The menu features traditional Italian dishes (sometimes given a modern twist), made with top-quality fresh, seasonal and – as far as possible – organic ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cuccagna%202%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="Un Posto a Milano"
  />
);

export default UnPostoAMilano;
