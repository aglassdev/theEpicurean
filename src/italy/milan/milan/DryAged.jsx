...
const DryAged = () => (
  <RestaurantPage
    restaurantName="Dry Aged"
    address="via Cesare Da Sesto 1, Milan, 20123, Italy"
    cuisine="Contemporary, Grills"
    priceRange="€€"
    phoneNumber="+390258107932"
    website="https://www.thedryaged.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two partners with significant experience opened this lively venue: the rooms combine modern and classic styles in an industrial-New York style decorated with works by major street artists. At the entrance, the glass counter shows off meats of different breeds to be enjoyed even charcoal grilled, but there are also other specialties: appealing dishes with a modern preparation and homemade pastas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Cesare%20Da%20Sesto%201%2C%20Milan%2C%2020123%2C%20Italy"
    pageTitle="Dry Aged"
  />
);
