...
const Morelli = () => (
  <RestaurantPage
    restaurantName="Morelli"
    address="via Aristotile Fioravanti 4, Milan, 20154, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390280010918"
    website="https://www.morellimilano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The new Milan restaurant of renowned chef Giancarlo Morelli, housed in the fascinating, new Hotel Viu. The creative gourmet dinner menu served in the stylish and discreetly lit dining room is complemented by the Bulk mixology and food bar, which serves simpler dishes throughout the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Aristotile%20Fioravanti%204%2C%20Milan%2C%2020154%2C%20Italy"
    pageTitle="Morelli"
  />
);

export default Morelli;
