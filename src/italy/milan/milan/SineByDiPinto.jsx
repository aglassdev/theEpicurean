...
const SineByDiPinto = () => (
  <RestaurantPage
    restaurantName="Sine by Di Pinto"
    address="viale Umbria 126, Milan, 20135, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390238584247"
    website="https://sinerestaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sine serves contemporary cuisine influenced by the chef’s native Naples, as well as the local region of Lombardy. The dishes are occasionally playful in style, as demonstrated by the shrimp ravioli served in various ways, including with an intensely flavoured fish stew. The chef’s speciality is his fried pizzetta with palamita fish and courgettes, while his new dishes are showcased on the exciting and creative “Sine Confini” menu, on which he demonstrates his culinary skills to the full. Attentive, courteous service and a constantly evolving wine list which includes some lesser-known labels complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Umbria%20126%2C%20Milan%2C%2020135%2C%20Italy"
    pageTitle="Sine by Di Pinto"
  />
);

export default SineByDiPinto;
