...
const LaCantinaDiManuela = () => (
  <RestaurantPage
    restaurantName="La Cantina di Manuela"
    address="via Carlo Poerio 3, Milan, 20129, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390276318892"
    website="https://www.lacantinadimanuela.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The dining room in this young, dynamic restaurant is surrounded by bottles of wine. Elaborate dishes feature on the menu, with antipasti available in the evening. At lunchtime these are replaced by various salads aimed at a business clientele in a hurry. Milanese-style cutlets are the house speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Carlo%20Poerio%203%2C%20Milan%2C%2020129%2C%20Italy"
    pageTitle="La Cantina di Manuela"
  />
);

export default LaCantinaDiManuela;
