...
const Osaka = () => (
  <RestaurantPage
    ...
    address="corso Giuseppe Garibaldi 68, Milan, 20121, Italy"
    cuisine="Japanese, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+390229060678"
    website="https://www.milanoosaka.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a short arcade on the old road from Milan to Como, this restaurant has a simple, minimalist style with a bar where diners can watch the skilful chefs slicing and preparing the fish. Set menus dominate at lunchtime, while in the evening the à la carte options include sukiyaki, a celebratory dish in Japan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Giuseppe%20Garibaldi%2068%2C%20Milan%2C%2020121%2C%20Italy"
    pageTitle="Osaka"
  />
);
