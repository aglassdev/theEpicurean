...
const Motelombroso = () => (
  <RestaurantPage
    restaurantName="Motelombroso"
    address="Alzaia Naviglio Pavese 256, Milan, 20142, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+393331855267"
    website="https://motelombroso.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An old, carefully restored road worker’s house on the Alzaia Naviglio Pavese canal is the setting for this modern, stylish restaurant where Alessandra and Matteo welcome guests in a graceful, elegant and yet informal manner. The menu features contemporary meat and fish dishes accompanied by a good choice of wines. If you’re curious about the restaurant’s name, ask the owners for an explanation: could it be something to do with the private dining room perhaps?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alzaia%20Naviglio%20Pavese%20256%2C%20Milan%2C%2020142%2C%20Italy"
    pageTitle="Motelombroso"
  />
);

export default Motelombroso;
