...
const GianninoDal1899 = () => (
  <RestaurantPage
    restaurantName="Giannino dal 1899"
    address="via Vittor Pisani 6, Milan, 20124, Italy"
    cuisine="Italian Contemporary, Milanese"
    priceRange="€€€"
    phoneNumber="+390236519520"
    website="https://gianninoristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to Piazza della Repubblica, Giannino is a historic name in city dining; in several rooms of remarkable contemporary elegance, dishes inspired mostly by Italian and Milanese tradition are served. Following this last line, we obviously recommend the risotto, both in the classic version and the riso al salto version, as well as the ossobuco, the veal chop “elephant” and the meneghina among the desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vittor%20Pisani%206%2C%20Milan%2C%2020124%2C%20Italy"
    pageTitle="Giannino dal 1899"
  />
);

export default GianninoDal1899;
