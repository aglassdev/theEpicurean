...
const BorgiaMilano = () => (
  <RestaurantPage
    restaurantName="Borgia Milano"
    address="via Giorgio Washington 56, Milan, 20146, Italy"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+390248021442"
    website="https://www.borgiamilano.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Milanese restaurant with a young talented chef at the helm boasts a breakfast area, as well as a lunchtime bistro and evening wine bar. The atmosphere in the dining room is lively and modern, allowing plenty of privacy, while the service is highly attentive to guests’ needs. This is especially true on the flagship “Psyche” menu, on which the chef creates special dishes in accordance with the guest’s personal preferences. The cuisine is creative, contemporary and technically adept as demonstrated in the carefully prepared pigeon served with hibiscus, blackberry and juniper cream. The interesting wine list includes bottles from across the globe, including some rare labels...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giorgio%20Washington%2056%2C%20Milan%2C%2020146%2C%20Italy"
    pageTitle="Borgia Milano"
  />
);

export default BorgiaMilano;
