...
const RuedaGaucha = () => (
  <RestaurantPage
    restaurantName="Rueda Gaucha"
    address="viale Europa 18, Lignano Sabbiadoro, 33054, Italy"
    cuisine="Grills, Argentinian"
    priceRange="€€"
    phoneNumber="+393385069196"
    website="https://guide.michelin.com/en/friuli-venezia-giulia/lignano-sabbiadoro/restaurant/rueda-gaucha"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is justifiably renowned for two specialities – firstly, its wide selection of cured hams including the famous Friuli prosciuttos as well as hams from further afield; and secondly, dishes (mainly meat sourced from Italy and further afield, although fish also features) cooked on the barbecue grill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Europa%2018%2C%20Lignano%20Sabbiadoro%2C%2033054%2C%20Italy"
    pageTitle="Rueda Gaucha"
  />
);

export default RuedaGaucha;
