...
const OsteriaDellaVilletta = () => (
  <RestaurantPage
    restaurantName="Osteria della Villetta"
    address="via Marconi 104, Palazzolo sull'Oglio, 25036, Italy"
    cuisine="Lombardian, Traditional Cuisine"
    priceRange="€"
    phoneNumber="+390307401899"
    website="https://www.osteriadellavilletta.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bastion of tradition for over a hundred years, Art Nouveau furnishings and a retro atmosphere are the accompaniment to Brescian classics and familiar recipes: always based on seasonal ingredients, as in the case of the many vegetables from their own garden, from which the Evo oil also comes. The wine list offers a wide selection of labels from Franciacorta, Barolo and Barbaresco: true passion of the owner Massimo!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%20104%2C%20Palazzolo%20sull'Oglio%2C%2025036%2C%20Italy"
    pageTitle="Osteria della Villetta"
  />
);

export default OsteriaDellaVilletta;
