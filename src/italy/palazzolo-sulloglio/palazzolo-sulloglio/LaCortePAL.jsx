...
const LaCortePAL = () => (
  <RestaurantPage
    ...
    address="via San Pancrazio 41, Palazzolo sull'Oglio, 25036, Italy"
    cuisine="Classic Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390307402136"
    website="https://www.ilristorantelacorte.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a tranquil street that leads to the centre of Palazzolo sull’Oglio, this stylish restaurant in a 16C palazzo boasts classic elegance and authentic cuisine which is delicious and full of flavour. Here, Aldo and his wife offer guests a warm and informal welcome, always with a smile on their lips...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Pancrazio%2041%2C%20Palazzolo%20sull'Oglio%2C%2025036%2C%20Italy"
    pageTitle="La Corte"
  />
);

export default LaCortePAL;
