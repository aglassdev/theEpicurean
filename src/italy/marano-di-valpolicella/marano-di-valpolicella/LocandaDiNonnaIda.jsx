...
const LocandaDiNonnaIda = () => (
  <RestaurantPage
    restaurantName="Locanda di Nonna Ida"
    address="Località Pontarola 12, Marano di Valpolicella, 37020, Italy"
    cuisine="Classic Cuisine, Italian"
    priceRange="€€"
    phoneNumber="+390455703508"
    website="https://www.lalocandadinonnaida.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming inn nestled amid the last vineyards of Valpolicella and the first pasturelands of the lower Lessinia region, where a young chef serves cuisine with a focus on local ingredients and classic Italian recipes with a modern twist. In summer, the terrace offers a fresh, cool setting with extensive views. The barbecued meat is superb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Localit%C3%A0%20Pontarola%2012%2C%20Marano%20di%20Valpolicella%2C%2037020%2C%20Italy"
    pageTitle="Locanda di Nonna Ida"
  />
);

export default LocandaDiNonnaIda;
