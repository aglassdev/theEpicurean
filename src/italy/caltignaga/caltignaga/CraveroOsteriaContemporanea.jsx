...
const CraveroOsteriaContemporanea = () => (
  <RestaurantPage
    restaurantName="Cravero - Osteria Contemporanea"
    address="via Novara 8, Caltignaga, 28010, Italy"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390321652696"
    website="https://www.gianpierocravero.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Warm colours such as teal and ochre give this restaurant a cosy and welcoming ambience. The cuisine here is authentic and traditional in style, with dishes based on top-quality local ingredients accompanied by a choice of regional wines. There’s also an outdoor area for summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Novara%208%2C%20Caltignaga%2C%2028010%2C%20Italy"
    pageTitle="Cravero - Osteria Contemporanea"
  />
);

export default CraveroOsteriaContemporanea;
