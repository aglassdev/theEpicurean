...
const Roma = () => (
  <RestaurantPage
    restaurantName="Roma"
    address="via Roma 15, Montoggio, 16026, Italy"
    cuisine="Ligurian, Seasonal Cuisine"
    priceRange="€"
    phoneNumber="+39010938925"
    website="https://www.romamontoggio.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2015%2C%20Montoggio%2C%2016026%2C%20Italy"
    pageTitle="Roma"
  />
);
