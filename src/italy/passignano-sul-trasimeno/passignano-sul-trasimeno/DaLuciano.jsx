...
const DaLuciano = () => (
  <RestaurantPage
    restaurantName="Da Luciano"
    address="via Nazionale 11, Passignano sul Trasimeno, 06065, Italy"
    cuisine="Italian, Seafood"
    priceRange="€€"
    phoneNumber="+39075827210"
    website="https://ristorantedaluciano.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy beautiful views of Lake Trasimeno from the outdoor terrace of this restaurant, where the menu focuses mainly on fish, alongside original ingredients such as beans and Umbrian truffles which are used in typical specialities such as tegamaccio (fish stew)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Nazionale%2011%2C%20Passignano%20sul%20Trasimeno%2C%2006065%2C%20Italy"
    pageTitle="Da Luciano"
  />
);

export default DaLuciano;
