...
const DissaporeDiAndreaCatalano = () => (
  <RestaurantPage
    restaurantName="Dissapore di Andrea Catalano"
    address="via Pietro Micca 15, Carovigno, 72012, Italy"
    cuisine="Modern Cuisine, Apulian"
    priceRange="€€€"
    phoneNumber="+393473613926"
    website="https://www.dissapore.eu"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Pietro%20Micca%2015%2C%20Carovigno%2C%2072012%2C%20Italy"
    pageTitle="Dissapore di Andrea Catalano"
  />
);

export default DissaporeDiAndreaCatalano;
