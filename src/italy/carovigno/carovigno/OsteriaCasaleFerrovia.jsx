...
const OsteriaCasaleFerrovia = () => (
  <RestaurantPage
    restaurantName="Osteria Casale Ferrovia"
    address="via Stazione 1, sulla SP 34, Carovigno, 72012, Italy"
    cuisine="Apulian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390831990025"
    website="https://www.casaleferrovia.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in what was once the 20C dwelling of an old olive mill, this restaurant boasts elegant decor, including a few antique family pieces and Art Deco - style tables. The female owner - chef prepares light and modern dishes with a regional flavour, while the wine list also showcases the best of Puglia. As the name suggests, the railway lies to the rear of the property, although there’s very little noise and no disturbance at all...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Stazione%201%2C%20sulla%20SP%2034%2C%20Carovigno%2C%2072012%2C%20Italy"
    pageTitle="Osteria Casale Ferrovia"
  />
);

export default OsteriaCasaleFerrovia;
