...
const GiSottoLarco = () => (
  <RestaurantPage
    restaurantName="Già Sotto l'Arco"
    address="corso Vittorio Emanuele 71, Carovigno, 72012, Italy"
    cuisine="Italian, Creative"
    priceRange="€€€€"
    phoneNumber="+390831996286"
    website="https://www.giasottolarco.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A historic gourmet restaurant, with an equally historic setting on the first floor of a Baroque palazzo fronting an elegant piazza. A fine staircase leads up to the simple yet stylish dining room, which is skilfully run by a father and his offspring. In the kitchen, his wife Teresa prepares creative, regional cuisine, which is showcased on a surprise menu of four, six or eight courses and which features locally sourced meat and fish. If you’d like to book the delightful table on the small terrace for just two fortunate guests, make sure you do so well in advance!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Vittorio%20Emanuele%2071%2C%20Carovigno%2C%2072012%2C%20Italy"
    pageTitle="Già Sotto l'Arco"
  />
);

export default GiSottoLarco;
