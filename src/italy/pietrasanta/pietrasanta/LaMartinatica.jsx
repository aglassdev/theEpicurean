...
const LaMartinatica = () => (
  <RestaurantPage
    restaurantName="La Martinatica"
    address="via Martinatica 20, Pietrasanta, 55045, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3905841788946"
    website="https://www.martinatica.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Housed in an old mill, this restaurant boasts a warm and welcoming dining room crowned by wood beams and elegant furnishings. The menu offers a selection of meat and fish dishes, although the latter are the main speciality of the owner-chef, who can usually be seen taking orders in the dining room. The raw seafood option demonstrates the skill and imagination of the chef, with its array of small bites which are both creative and delicious. The attractive outdoor space is perfect for summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Martinatica%2020%2C%20Pietrasanta%2C%2055045%2C%20Italy"
    pageTitle="La Martinatica"
  />
);

export default LaMartinatica;
