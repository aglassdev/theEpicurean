...
const CannavacciuoloLeCattedraliAsti = () => (
  <RestaurantPage
    restaurantName="Cannavacciuolo Le Cattedrali Asti"
    address="frazione Valleandona 1/b, Asti, 14100, Italy"
    cuisine="Creative, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+3901411858888"
    website="https://www.lecattedrali.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated in the hills outside Asti, this modern inn with guestrooms is nestled in around 18 hectares of woodland and meadows. The interior decor here is contemporary and minimalist, while the cuisine is overseen by the famous three-Michelin-star chef Antonino Cannavacciuolo, with resident chef Gianluca Renzi, who has already earned his spurs at other top-quality restaurants, at the helm in the kitchen. Originally from Rome (his focaccia is excellent!) and having trained professionally in various locations, Renzi creates cuisine that combines personal imaginative touches with regional influences, including traditional flavours from the Piedmont. The young front-of-house team includes a number of excellent female staff. The superb wine list features more than 2 000 labels, while the cheese t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=frazione%20Valleandona%201%2Fb%2C%20Asti%2C%2014100%2C%20Italy"
    pageTitle="Cannavacciuolo Le Cattedrali Asti"
  />
);

export default CannavacciuoloLeCattedraliAsti;
