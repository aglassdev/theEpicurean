...
const OMeOIlMare = () => (
  <RestaurantPage
    restaurantName="O Me O Il Mare"
    address="Via Roma 45/47, Gragnano, 80054, Italy"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390816200550"
    website="https://omeoilmare.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Roma%2045%2F47%2C%20Gragnano%2C%2080054%2C%20Italy"
    pageTitle="O Me O Il Mare"
  />
);

export default OMeOIlMare;
