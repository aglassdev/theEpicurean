...
const IlFenicotteroRosaGourmet = () => (
  <RestaurantPage
    restaurantName="Il Fenicottero Rosa Gourmet"
    address="via Emilia Ponente 23, Faenza, 48018, Italy"
    cuisine="Contemporary, Seafood"
    priceRange="€€€"
    phoneNumber="+390546622672"
    website="https://www.villa-abbondanzi.com/ristorante-fenicottero-rosa-gourmet.php"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the Villa Abbondanzi luxury hotel, this restaurant is surrounded by a large park home to a flock of flamingos (fenicottero is the Italian for flamingo). Stylish and elegant dining rooms provide the backdrop for equally impressive cuisine, which is elaborate and full of imaginative touches. The chef’s creative meat and fish dishes are showcased on various tasting menus and an à la carte, which also includes some extraordinary first courses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Emilia%20Ponente%2023%2C%20Faenza%2C%2048018%2C%20Italy"
    pageTitle="Il Fenicottero Rosa Gourmet"
  />
);

export default IlFenicotteroRosaGourmet;
