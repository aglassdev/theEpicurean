...
const Gimmys = () => (
  <RestaurantPage
    restaurantName="Gimmy's"
    address="via privata Gemelli, Aprica, 23031, Italy"
    cuisine="Italian, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390342747048"
    website="https://www.hotelarisch.com/il-ristorante/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Traditional cuisine reinterpreted with a modern twist, with a whole page of the menu dedicated to meat dishes. Meals are served in an attractive Stube-style room with a warm mountain ambience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20privata%20Gemelli%2C%20Aprica%2C%2023031%2C%20Italy"
    pageTitle="Gimmy's"
  />
);

export default Gimmys;
