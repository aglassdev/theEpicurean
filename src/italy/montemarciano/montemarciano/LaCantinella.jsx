...
const LaCantinella = () => (
  <RestaurantPage
    restaurantName="La Cantinella"
    address="località Montemarciano 70/g, Montemarciano, 52028, Italy"
    cuisine="Tuscan, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390559172705"
    website="https://guide.michelin.com/en/toscana/montemarciano/restaurant/la-cantinella154248"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nestling in the hills, this small country restaurant delights guests with its relaxed atmosphere and Tuscan cuisine reinterpreted with a light, contemporary flavour. The paccheri pasta with a sausage ragù and celeriac cream is particularly delicious. The warm welcome offered by the owner, who always greets guests with a smile, adds to the appeal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Montemarciano%2070%2Fg%2C%20Montemarciano%2C%2052028%2C%20Italy"
    pageTitle="La Cantinella"
  />
);

export default LaCantinella;
