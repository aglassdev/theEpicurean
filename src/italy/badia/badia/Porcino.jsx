...
const Porcino = () => (
  <RestaurantPage
    restaurantName="Porcino"
    address="strada Damez 2/a, Badia, 39036, Italy"
    cuisine="Alpine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+3904711808060"
    website="https://www.badiahill.com/it/ristorante-porcino/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside the modern Badia Hill hotel, patron Marco Verginer offers two tasting menus: one focused on seasonality, the other inspired by his creativity, featuring ingredients such as Wagyu beef produced in Alto Adige. The pairings are flavorful and lively, with extensive use of vegetables, often from the home garden. The result is an excellent dining experience served in a contemporary setting surrounded by glass walls that offer splendid views of the surrounding landscape. From our last summer visit, we fondly remember the delicious and fragrant amuse-bouche starters and the buffalo ricotta tortelli with red prawn and vegetable jus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Damez%202%2Fa%2C%20Badia%2C%2039036%2C%20Italy"
    pageTitle="Porcino"
  />
);
