...
const SuMurruai = () => (
  <RestaurantPage
    restaurantName="Su Murruai"
    address="via Giuseppe Garibaldi 36, Riola Sardo, 09070, Italy"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+393913249185"
    website="https://www.ristorantesumurruai.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a small village overlooking the Sinis Peninsula, the restaurant has been established within an old mill and is dedicated to 'su murruai', Sardinian for the scent of aged Vernaccia. Contemporary Mediterranean cuisine is curated by young chef Ivan Matarese, who seeks quality regional ingredients—from both the mainland and the Gulf of Oristano—to reimagine modern recipes. Additionally, some Campania influences—being the chef's origin—are evident, especially in the desserts, half of which draw inspiration from renowned Campanian sweets (reimagined pastiera and babà)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Garibaldi%2036%2C%20Riola%20Sardo%2C%2009070%2C%20Italy"
    pageTitle="Su Murruai"
  />
);

export default SuMurruai;
