...
const BcaroIlGusto = () => (
  <RestaurantPage
    restaurantName="Bàcaro Il Gusto"
    address="via Provinciale Nord 30, Fossò, 30030, Italy"
    cuisine="Venetian, Seafood"
    priceRange="€€"
    phoneNumber="+390415170035"
    website="https://guide.michelin.com/en/veneto/fosso/restaurant/bacaro-il-gusto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the central area, chef Alessio Boldrin has reinvented the Venetian bàcaro tradition. Classic cicchetti here become samples served on one large plate, entertaining the palate. Not to be outdone is the à la carte menu, which offers a wide selection of mouth-watering and satisfying dishes, such as tagliolini cacio, pepe and scampi. The wine list features a good selection of Italian and French bubbly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Provinciale%20Nord%2030%2C%20Foss%C3%B2%2C%2030030%2C%20Italy"
    pageTitle="Bàcaro Il Gusto"
  />
);

export default BcaroIlGusto;
