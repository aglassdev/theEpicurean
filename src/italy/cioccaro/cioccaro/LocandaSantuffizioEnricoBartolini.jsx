...
const LocandaSantuffizioEnricoBartolini = () => (
  <RestaurantPage
    restaurantName="Locanda Sant'Uffizio Enrico Bartolini"
    address="strada Sant'Uffizio 1, Cioccaro, 14030, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3901411710098"
    website="https://www.enricobartolini.net/ristorante-sant-uffizio"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestled amid the picturesque hills of the Monferrato region, this restaurant overseen by multi-Michelin-starred Enrico Bartolini sees Gabriele Boffa at the helm in the kitchen, a chef who is young in years but already a real connoisseur of Piedmontese cuisine. With experience in some of the world’s best restaurants behind him, Boffa has accumulated expert knowledge and remarkable technical skills. His cuisine ranges from classic regional dishes interpreted in their purest form – such as his extraordinary agnolotti del plin – to more creative options, which demonstrate a connection with the region, whether in their ingredients or recipes. The setting here is that of an old monastery converted into a smart hotel, with meals served either in an elegant dining room or in the old limonaia (wher..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20Sant'Uffizio%201%2C%20Cioccaro%2C%2014030%2C%20Italy"
    pageTitle="Locanda Sant'Uffizio Enrico Bartolini"
  />
);

export default LocandaSantuffizioEnricoBartolini;
