...
const AnticaOsteriaDelPonte = () => (
  <RestaurantPage
    restaurantName="Antica Osteria del Ponte"
    address="piazza Gaetano Negri 9, Cassinetta di Lugagnano, 20081, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+39029420034"
    website="https://www.anticaosteriadelponte.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This renowned restaurant in Lombardy has made its mark on the history of Italian cuisine and now has a new young couple at the helm and a new classic-contemporary menu. There’s also an interesting and reasonably priced three-dish menu at lunchtime, as well as the option of ordering an informal gastronomic picnic box. The beautiful natural setting of Cassinetta di Lugagnano and its canal completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Gaetano%20Negri%209%2C%20Cassinetta%20di%20Lugagnano%2C%2020081%2C%20Italy"
    pageTitle="Antica Osteria del Ponte"
  />
);

export default AnticaOsteriaDelPonte;
