...
const AnticaTrattoriaLaToppa = () => (
  <RestaurantPage
    restaurantName="Antica Trattoria La Toppa"
    address="via del Giglio 43, San Donato in Poggio, 50028, Italy"
    cuisine="Tuscan"
    priceRange="€"
    phoneNumber="+390558072900"
    website="https://guide.michelin.com/en/toscana/san-donato-in-poggio/restaurant/antica-trattoria-la-toppa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The two traditional rooms at this restaurant are perfectly in keeping with the medieval atmosphere of the beautifully preserved village of San Donato. The cuisine is obviously Tuscan in style, delighting guests with its exquisite home-made pasta expertly prepared by young chef Matteo. At certain times of the year, special dishes such as game make an appearance on the menu – the wild boar stew is not to be missed! Among the desserts, make sure you try the caramel panna cotta which is one of the best in the region. The small wine list includes a few labels from famous wineries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20del%20Giglio%2043%2C%20San%20Donato%20in%20Poggio%2C%2050028%2C%20Italy"
    pageTitle="Antica Trattoria La Toppa"
  />
);

export default AnticaTrattoriaLaToppa;
