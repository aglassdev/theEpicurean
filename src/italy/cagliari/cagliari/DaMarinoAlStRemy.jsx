...
const DaMarinoAlStRemy = () => (
  <RestaurantPage
    restaurantName="Da Marino al St Remy"
    address="via San Salvatore da Horta 7, Cagliari, 09124, Italy"
    cuisine="Mediterranean Cuisine, Sardinian"
    priceRange="€€"
    phoneNumber="+39070657377"
    website="https://www.stremy.it/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the edge of the pedestrianised area near the Bastione di Saint Remy, this restaurant is named after its charismatic owner Marino, who helps guests with their choice of menu and is happy to tell them all about the history of the restaurant (the street in front of the restaurant, for example, has not always been there). At the helm in the kitchen, his wife Silvana prepares Mediterranean dishes with a Sardinian flavour – the fish and seafood options are particularly delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Salvatore%20da%20Horta%207%2C%20Cagliari%2C%2009124%2C%20Italy"
    pageTitle="Da Marino al St Remy"
  />
);

export default DaMarinoAlStRemy;
