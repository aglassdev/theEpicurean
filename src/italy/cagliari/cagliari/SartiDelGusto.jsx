...
const SartiDelGusto = () => (
  <RestaurantPage
    restaurantName="Sarti del Gusto"
    address="via Vico II Vincenzo Sulis 1/a, Cagliari, 09124, Italy"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390706848548"
    website="https://guide.michelin.com/en/sardegna/cagliari/restaurant/sarti-del-gusto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small, beautifully maintained restaurant offering a concise selection of carefully prepared and attractively presented dishes. The cuisine here is often creative yet inspired by Sardinian traditions, with an equal focus on meat and fish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vico%20II%20Vincenzo%20Sulis%201%2Fa%2C%20Cagliari%2C%2009124%2C%20Italy"
    pageTitle="Sarti del Gusto"
  />
);

export default SartiDelGusto;
