...
const LuigiPomata = () => (
  <RestaurantPage
    restaurantName="Luigi Pomata"
    address="viale Regina Margherita 18, Cagliari, 09124, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+39070672058"
    website="https://luigipomata.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This famous classic restaurant in Cagliari serves top-quality cuisine in its modern dining rooms and on an outdoor terrace. The menu features interesting reinterpretations of Sardinian dishes among other options, including their own tuna (the house speciality), which is also available in tins to take away...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Regina%20Margherita%2018%2C%20Cagliari%2C%2009124%2C%20Italy"
    pageTitle="Luigi Pomata"
  />
);

export default LuigiPomata;
