...
const Duanima = () => (
  <RestaurantPage
    restaurantName="Duanima"
    address="via Sebastiano Satta 28, Cagliari, 09127, Italy"
    cuisine="Contemporary, Italian Contemporary"
    priceRange="€€"
    phoneNumber="+393668140691"
    website="https://www.ristoranteduanima.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a narrow and elongated dining room, amidst subdued lighting and modern furnishings, Chef Patron Luca Floris champions a truly convincing culinary line. Whether dealing with meat or fish, his recipes reflect contemporary trends whereby the harmonious blend of ingredients is easily and delightfully discernible. Occasionally, the touch is more creative, such as with raw tuna carpaccio drizzled with the renowned Japanese teriyaki sauce, wherein soya’s savoury essence shines, enhanced by sweet chutney of Sardinian camoni tomatoes; at times it’s more classic, as with the Saint-Pierre scalopp atop varying vegetable textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sebastiano%20Satta%2028%2C%20Cagliari%2C%2009127%2C%20Italy"
    pageTitle="Duanima"
  />
);

export default Duanima;
