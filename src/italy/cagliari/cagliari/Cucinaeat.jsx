...
const Cucinaeat = () => (
  <RestaurantPage
    restaurantName="CUCINA.eat"
    address="piazza Galileo Galilei 1, Cagliari, 09128, Italy"
    cuisine="Modern Cuisine"
    priceRange="€"
    phoneNumber="+390700991098"
    website="https://www.shopcucina.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the most interesting restaurants in Cagliari in terms of value for money, with a choice of classic at-table seating or the more informal, convivial option of sitting at the counter. When it comes to choosing your wine, all you need do is look around at the shelves and ask the helpful staff for recommendations. The cuisine focuses on Sardinian recipes and ingredients, as well as more classic options and even experimental dishes that feature new and original combinations. Simpler options are available at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Galileo%20Galilei%201%2C%20Cagliari%2C%2009128%2C%20Italy"
    pageTitle="CUCINA.eat"
  />
);

export default Cucinaeat;
