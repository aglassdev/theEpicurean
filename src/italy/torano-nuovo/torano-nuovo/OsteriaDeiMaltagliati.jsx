...
const OsteriaDeiMaltagliati = () => (
  <RestaurantPage
    restaurantName="Osteria dei Maltagliati"
    address="Via Regina Margherita 37, Torano Nuovo, 64010, Italy"
    cuisine="Farm to table, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+393516531769"
    website="https://guide.michelin.com/en/abruzzo/torano-nuovo_1847049/restaurant/osteria-dei-maltagliati"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a very young team led by Maicol and Federica, this rustic restaurant with an exposed-brick decor only opened a few months ago and has already made a name for itself thanks to its fine cuisine. In the dining room, the wood-fired oven and barbecue grill (the latter uses the embers from the former) take centre stage in many of the dishes, so that old, culinary techniques result in delicious cuisine that demonstrates a fine balance of traditional flavours and personalised modern twists. The lamb chops, served with freshly blanched saltwort flavoured with preserved lemon and a light garlic sauce, were truly delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Regina%20Margherita%2037%2C%20Torano%20Nuovo%2C%2064010%2C%20Italy"
    pageTitle="Osteria dei Maltagliati"
  />
);

export default OsteriaDeiMaltagliati;
