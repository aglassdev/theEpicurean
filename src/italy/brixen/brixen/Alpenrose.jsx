...
const Alpenrose = () => (
  <RestaurantPage
    restaurantName="Alpenrose"
    address="via delle Sette Chiese 1, loc. Pinzago, Brixen, 39042, Italy"
    cuisine="Regional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390472694947"
    website="https://www.alpenroses.com/it/ristorante-bressanone/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a beautiful panoramic location a few kilometres outside Bressanone, this restaurant combines regional traditions with a modern approach thanks to its classic techniques and the use of Mediterranean ingredients in some dishes. There are also elegant apartments available, plus a private wellness space, for anyone wishing to extend their stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20delle%20Sette%20Chiese%201%2C%20loc.%20Pinzago%2C%20Brixen%2C%2039042%2C%20Italy"
    pageTitle="Alpenrose"
  />
);

export default Alpenrose;
