...
const MiaRistorante = () => (
  <RestaurantPage
    restaurantName="Mia Ristorante"
    address="via Borgotufi, Castel del Giudice, 86080, Italy"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+3908651998286"
    website="https://www.miaristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you're not already in the area, plan some time to get there, traveling through a green, hilly landscape to reach Borgotufi, a diffused hotel spread among stone houses. In the former stables transformed into a restaurant, Marco Pasquarelli, a talented young chef, offers a modern take on various local ingredients, with a few seafood dishes as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Borgotufi%2C%20Castel%20del%20Giudice%2C%2086080%2C%20Italy"
    pageTitle="Mia Ristorante"
  />
);

export default MiaRistorante;
