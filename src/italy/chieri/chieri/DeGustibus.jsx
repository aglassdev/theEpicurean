...
const DeGustibus = () => (
  <RestaurantPage
    restaurantName="De Gustibus"
    address="via Martiri della Libertà 9, Chieri, 10023, Italy"
    cuisine="Mediterranean Cuisine, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+390119400713"
    website="https://www.degustibuschieri.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy modern, Mediterranean-influenced cuisine in an elegant restaurant with an attractive vintage-style ambience, where the excellent menu is announced at your table and varies according to daily availability. Very friendly and attentive service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Martiri%20della%20Libert%C3%A0%209%2C%20Chieri%2C%2010023%2C%20Italy"
    pageTitle="De Gustibus"
  />
);

export default DeGustibus;
