...
const OsteriaDid = () => (
  <RestaurantPage
    restaurantName="Osteria Didù"
    address="via Felice Cascione 70, Imperia, 18100, Italy"
    cuisine="Seafood, Ligurian"
    priceRange="€"
    phoneNumber="+390183273636"
    website="https://guide.michelin.com/en/liguria/imperia/restaurant/osteria-didu-1201493"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on an attractive pedestrian street lined with the historic palazzi of Porto San Maurizio, this simple yet pleasant restaurant offers an excellent choice of Ligurian specialities. Highlights include stuffed mussels and Genoese-style borage ravioli...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Felice%20Cascione%2070%2C%20Imperia%2C%2018100%2C%20Italy"
    pageTitle="Osteria Didù"
  />
);

export default OsteriaDid;
