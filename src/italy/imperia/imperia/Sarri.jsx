...
const Sarri = () => (
  <RestaurantPage
    restaurantName="Sarri"
    address="lungomare C. Colombo 108, Borgo Prino, Imperia, 18100, Italy"
    cuisine="Seafood, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390183754056"
    website="https://www.ristorantesarri.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This fine restaurant enjoys a pleasant location in the charming Borgo Prino, a string of houses painted in typical pastel colours right in front of the sea. The legendary mildness of the Ligurian climate makes it possible to eat outdoors often, but should that not be possible the charm of the indoor dining room, an old shed furnished with excellent contemporary taste, will be anything but an afterthought. Service is elegant and impeccable, headed gracefully by hostess Alessandra. Last but not least, the cuisine of the chef-patron, as well as husband, Andrea Sarri: the extraordinary quality of the ingredients, indicated by seasonality and sourced from the Ligurian Sea, as well as vegetables and sprouts grown in organic gardens, give rise to original proposals such as the vertical of raw foo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=lungomare%20C.%20Colombo%20108%2C%20Borgo%20Prino%2C%20Imperia%2C%2018100%2C%20Italy"
    pageTitle="Sarri"
  />
);

export default Sarri;
