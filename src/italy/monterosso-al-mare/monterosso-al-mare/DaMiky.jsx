...
const DaMiky = () => (
  <RestaurantPage
    restaurantName="Da Miky"
    address="via Fegina 104, Monterosso al Mare, 19016, Italy"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+390187817608"
    website="https://www.ristorantemiky.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated right on the seafront, Miky is one of the best restaurants for fish (including the famous Monterosso anchovies) in the region, serving cuisine which is more and more exciting and individual every year. There’s also a small shop selling local produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Fegina%20104%2C%20Monterosso%20al%20Mare%2C%2019016%2C%20Italy"
    pageTitle="Da Miky"
  />
);

export default DaMiky;
