...
const LocandaLaPosta = () => (
  <RestaurantPage
    restaurantName="Locanda La Posta"
    address="via dei Fossi 4, Cavour, 10061, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39012169989"
    website="https://www.locandalaposta.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This traditional restaurant boasts small dining rooms adorned with wooden ceilings, which were redecorated a few years ago with evocative photos and documents depicting its history. The restaurant’s interesting cuisine is also traditional in style, featuring home-made pastas, a typical boiled meat trolley (“carrello dei bolliti”), and an excellent rabbit stew served with a generous portion of peppers. The selection of delicious home-produced fare includes vegetables, preserves and pastries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dei%20Fossi%204%2C%20Cavour%2C%2010061%2C%20Italy"
    pageTitle="Locanda La Posta"
  />
);

export default LocandaLaPosta;
