...
const FuturaOsteria = () => (
  <RestaurantPage
    restaurantName="Futura Osteria"
    address="largo Garfonda 10, località Abbadia Isola, Monteriggioni, 53035, Italy"
    cuisine="Tuscan, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390577301240"
    website="https://www.futuraosteria.it/it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=largo%20Garfonda%2010%2C%20localit%C3%A0%20Abbadia%20Isola%2C%20Monteriggioni%2C%2053035%2C%20Italy"
    pageTitle="Futura Osteria"
  />
);

export default FuturaOsteria;
