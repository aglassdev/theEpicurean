...
const CastelloDiFighine = () => (
  <RestaurantPage
    restaurantName="Castello di Fighine"
    address="borgo di Fighine, San Casciano dei Bagni, 53040, Italy"
    cuisine="Contemporary"
    priceRange="€€€"
    phoneNumber="+39057856158"
    website="https://www.fighine.it/it/ristorante.html"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=borgo%20di%20Fighine%2C%20San%20Casciano%20dei%20Bagni%2C%2053040%2C%20Italy"
    pageTitle="Castello di Fighine"
  />
);

export default CastelloDiFighine;
