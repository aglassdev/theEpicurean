...
const ISetteConsoli = () => (
  <RestaurantPage
    restaurantName="I Sette Consoli"
    address="piazza Sant'Angelo 1/a, Orvieto, 05018, Italy"
    cuisine="Modern Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+390763343911"
    website="https://www.isetteconsoli.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this simple restaurant boasting an attractive outdoor summer garden and splendid views of the Duomo, chef Anna Rita focuses on carefully selected ingredients from the region and beyond. Highlights include soft egg, pan-fried courgettes and spring onions, and pecorino crumble, as well as soft veal rump, Jerusalem artichoke sauce and home-made pickled vegetables. The wine and spirits selection is particularly appealing – as an example, the Orvieto Classico Superiore Doc “Vendemmia Tardiva” is the perfect pairing for your dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Sant'Angelo%201%2Fa%2C%20Orvieto%2C%2005018%2C%20Italy"
    pageTitle="I Sette Consoli"
  />
);

export default ISetteConsoli;
