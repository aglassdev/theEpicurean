...
const Erbaluigia = () => (
  <RestaurantPage
    restaurantName="Erbaluigia"
    address="via San Frediano 10/12, Pisa, 56126, Italy"
    cuisine="Contemporary, Country cooking"
    priceRange="€€"
    phoneNumber="+39050969052"
    website="https://erbaluigia.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This attractive restaurant with a simple, minimalist decor stands almost opposite the thousand-year-old church of San Frediano. The inviting menu here focuses on regional dishes with a successful combination of traditional and modern styles, including a section dedicated to barbecue options. Meat takes pride of place, although offal, cheese and a few vegetarian options also feature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Frediano%2010%2F12%2C%20Pisa%2C%2056126%2C%20Italy"
    pageTitle="Erbaluigia"
  />
);

export default Erbaluigia;
