...
const AlPozzo = () => (
  <RestaurantPage
    restaurantName="Al Pozzo"
    address="via Chiesa 10, Mason Vicentino, 36064, Italy"
    cuisine="Seafood, Grills"
    priceRange="€€€"
    phoneNumber="+390424411816"
    website="https://www.alpozzoilristorante.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cuisine at this restaurant is almost exclusively based on fish and seafood, with three main points of focus – an extensive array of raw dishes; ageing of almost all the fish to accentuate flavour and texture (as well as making the skin pleasantly crispy); and the grilling of some courses. Top-quality ingredients and delicious desserts complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Chiesa%2010%2C%20Mason%20Vicentino%2C%2036064%2C%20Italy"
    pageTitle="Al Pozzo"
  />
);

export default AlPozzo;
