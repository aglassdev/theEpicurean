...
const JohannsMOL = () => (
  <RestaurantPage
    restaurantName="JOHANNS"
    address="Via Selva dei Molini 9, Molini di Tures, 39032, Italy"
    cuisine="Alpine, Organic"
    priceRange="€€€€"
    phoneNumber="+390474646000"
    website="https://www.amontichalets.com/it/johanns-ristorante-gourmet-by-tina-marcelli/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tina Marcelli returns to her Valle Aurina, picking up where she left off in her previous regional experience: fermentation, no waste, overall sustainability, and collaboration with local farmers and producers, sometimes even family members (such as her sister and uncle). The chef indeed wants every guest to fully embrace her culinary vision, which is why she has completely renewed the tasting menu, now offered in two distinct itineraries designed to showcase territory, technique, and emotion: “About TM” is a journey into Tina’s world, available in either seven or five courses, while “La Cucina di casa” is a four-course menu that changes daily, just like in a family home. The space is intimate and contemporary, featuring large windows overlooking the mountains, and is part of a brand-new, e..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Selva%20dei%20Molini%209%2C%20Molini%20di%20Tures%2C%2039032%2C%20Italy"
    pageTitle="JOHANNS"
  />
);

export default JohannsMOL;
