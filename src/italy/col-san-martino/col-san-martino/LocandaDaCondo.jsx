...
const LocandaDaCondo = () => (
  <RestaurantPage
    restaurantName="Locanda da Condo"
    address="via Fontana 134, Col San Martino, 31010, Italy"
    cuisine="Venetian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390438898106"
    website="https://www.locandadacondo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the delightful Prosecco wine-growing region, Condo is a well-established trattoria which has been in the same family for generations, and which remains faithful to the gastronomic traditions of the Veneto. The dining rooms are welcoming and full of character, while the elegant veranda adorned with climbing plants is an attractive option in summer. The cuisine is both excellent and good value for money, making this restaurant an excellent all-round choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Fontana%20134%2C%20Col%20San%20Martino%2C%2031010%2C%20Italy"
    pageTitle="Locanda da Condo"
  />
);

export default LocandaDaCondo;
