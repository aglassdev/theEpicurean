...
const Selvatico = () => (
  <RestaurantPage
    restaurantName="Selvatico"
    address="via Silvio Pellico 19, Rivanazzano Terme, 27055, Italy"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390383944720"
    website="https://albergoselvatico.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opened in 1912 and now run by the fourth generation of the same family, this is one of the best restaurants in the Oltrepò Pavese area. If you’re looking to sample the gastronomic delights of this region, you’ll find a whole host of delicious specialities on offer, from charcuterie and stews to boiled meats and excellent fresh pasta. Attractively furnished guestrooms with the same nostalgic feel as the restaurant are also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Silvio%20Pellico%2019%2C%20Rivanazzano%20Terme%2C%2027055%2C%20Italy"
    pageTitle="Selvatico"
  />
);

export default Selvatico;
