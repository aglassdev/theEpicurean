...
const LanzaniBottegaBistrot = () => (
  <RestaurantPage
    restaurantName="Lanzani Bottega & Bistrot"
    address="via Albertano da Brescia 41, Brescia, 25127, Italy"
    cuisine="Modern Cuisine, Italian Contemporary"
    priceRange="€€"
    phoneNumber="+39030313471"
    website="https://www.gastronomialanzani.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern restaurant (open from 7am to 11pm), once the family butcher’s, is also a delicatessen and wine boutique. It serves top-quality produce such as Pata Negra and other hams, anchovies from the Cantabrian sea, an excellent selection of cheeses and more elaborate dishes. At mealtimes, the venue transforms into a proper restaurant, with a smaller menu available at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Albertano%20da%20Brescia%2041%2C%20Brescia%2C%2025127%2C%20Italy"
    pageTitle="Lanzani Bottega & Bistrot"
  />
);

export default LanzaniBottegaBistrot;
