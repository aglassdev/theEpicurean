...
const CastelloMalvezzi = () => (
  <RestaurantPage
    restaurantName="Castello Malvezzi"
    address="via Colle San Giuseppe 1, Brescia, 25133, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+390302004224"
    website="https://www.castellomalvezzi.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant 16C hunting lodge offers a modern menu of fish dishes and regional specialities. Particular attention is paid to the excellent Calvisano caviar, with a dedicated menu. There’s an attractive outdoor dining area facing the gardens with views of the city of Brescia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Colle%20San%20Giuseppe%201%2C%20Brescia%2C%2025133%2C%20Italy"
    pageTitle="Castello Malvezzi"
  />
);

export default CastelloMalvezzi;
