...
const FormeRestaurant = () => (
  <RestaurantPage
    restaurantName="Forme Restaurant"
    address="Via Codignole 52, Brescia, 25124, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390302400353"
    website="https://formerestaurant.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Having worked in Michelin-starred restaurants such as Miramonti l'Altro, Arianna Gatti has now achieved her dream of opening her own restaurant. In this restored old building featuring designer-style details and a charming outdoor space, she serves an extensive selection of intensely flavoured dishes from her native Abruzzo and the region of Lombardy where she trained as a professional chef. A delightful all-round dining experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Codignole%2052%2C%20Brescia%2C%2025124%2C%20Italy"
    pageTitle="Forme Restaurant"
  />
);

export default FormeRestaurant;
