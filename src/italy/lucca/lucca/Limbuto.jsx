...
const Limbuto = () => (
  <RestaurantPage
    restaurantName="L'Imbuto"
    address="piazza del Collegio 8, Lucca, 55100, Italy"
    cuisine="Creative, Contemporary"
    priceRange="€€€€"
    phoneNumber="+393319308931"
    website="https://www.limbuto.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the most talked about and controversial chefs in Italy, thanks to his creative dishes and original combinations, Tomei has made his home in the former stables of the 17C Pfanner palazzo-museum. Here, guests choose the number of courses they want, let the chef know if they have any allergies and then sit back and enjoy whatever surprising dishes he creates for them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20del%20Collegio%208%2C%20Lucca%2C%2055100%2C%20Italy"
    pageTitle="L'Imbuto"
  />
);

export default Limbuto;
