...
const AlmondoTrattoria = () => (
  <RestaurantPage
    restaurantName="Almondo Trattoria"
    address="piazza Gran Madre di Dio 2/l, Turin, 10131, Italy"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+390114119684"
    website="https://www.almondotrattoria.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This simple yet charming restaurant located just a few metres from the Gran Madre church serves a fine array of regional Italian dishes. Although specialities from Piedmont understandably take pride of place, the menu takes guests on a culinary journey throughout Italy and the changing seasons, featuring dishes such as scialatielli pasta with seafood, Puglian stuffed meat rolls, and zabaglione with traditional hazelnut cake from the Langhe. There’s also a good selection of gluten-free options...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Gran%20Madre%20di%20Dio%202%2Fl%2C%20Turin%2C%2010131%2C%20Italy"
    pageTitle="Almondo Trattoria"
  />
);

export default AlmondoTrattoria;
