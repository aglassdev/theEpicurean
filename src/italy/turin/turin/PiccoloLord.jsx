...
const PiccoloLord = () => (
  <RestaurantPage
    restaurantName="Piccolo Lord"
    address="corso San Maurizio 69 bis/g, Turin, 10124, Italy"
    cuisine="Mediterranean Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+39011836145"
    website="https://www.ristorantepiccololord.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Professional service in a welcoming, modern restaurant run by a young couple. He works in the kitchen while she (having also worked as a chef in the past) runs the front of house. Delicious Mediterranean cuisine with a seasonal focus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20San%20Maurizio%2069%20bis%2Fg%2C%20Turin%2C%2010124%2C%20Italy"
    pageTitle="Piccolo Lord"
  />
);

export default PiccoloLord;
