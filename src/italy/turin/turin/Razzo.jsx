...
const Razzo = () => (
  <RestaurantPage
    ...
    address="via Andrea Doria 17/f, Turin, 10123, Italy"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+390110201580"
    website="https://vadoarazzo.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A quiet restaurant with a relaxed, young and modern feel serving contemporary cuisine prepared from seasonal, regional products. Charming romantic outdoor area with soft lighting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Andrea%20Doria%2017%2Ff%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Razzo"
  />
);

export default Razzo;
