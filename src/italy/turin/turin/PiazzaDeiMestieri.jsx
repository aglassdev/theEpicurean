...
const PiazzaDeiMestieri = () => (
  <RestaurantPage
    restaurantName="Piazza dei Mestieri"
    address="via Jacopo Durandi 13, Turin, 10144, Italy"
    cuisine="Modern Cuisine, Piedmontese"
    priceRange="€€"
    phoneNumber="+3901119709679"
    website="https://www.ristorantelapiazza.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on a redeveloped industrial site and part of a training school, this restaurant offers a more concise menu at lunchtime with lower prices than the evening, but with the same high-quality cuisine. Our inspector recommends the spaghetti with spring onion and bottarga, accompanied by one of the craft beers produced on site. There’s also an attractive terrace for alfresco dining in fine weather...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Jacopo%20Durandi%2013%2C%20Turin%2C%2010144%2C%20Italy"
    pageTitle="Piazza dei Mestieri"
  />
);

export default PiazzaDeiMestieri;
