...
const LaLimonaia = () => (
  <RestaurantPage
    restaurantName="La Limonaia"
    address="via Mario Ponzio 10/b, Turin, 10141, Italy"
    cuisine="Contemporary, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390117041887"
    website="https://www.lalimonaia.org"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant occupies a large veranda decorated with an original array of tastefully arranged objects and furnishings. The cuisine is both contemporary and exciting, featuring a few interesting fish dishes alongside regional specialities (including from outside Piedmont) such as mandilli (pasta) in a grouper stew with peas and aromatic herbs, brodetto (fish stew) “alla vastese”, and mutton cooked over charcoal embers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Mario%20Ponzio%2010%2Fb%2C%20Turin%2C%2010141%2C%20Italy"
    pageTitle="La Limonaia"
  />
);

export default LaLimonaia;
