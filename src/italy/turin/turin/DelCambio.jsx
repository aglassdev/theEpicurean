...
const DelCambio = () => (
  <RestaurantPage
    restaurantName="Del Cambio"
    address="piazza Carignano 2, Turin, 10123, Italy"
    cuisine="Classic Cuisine, Piedmontese"
    priceRange="€€€€"
    phoneNumber="+39011546690"
    website="https://delcambio.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This historic restaurant, a jewel of Piedmont and with few equals in Europe, dates back to the 18th century. The Risorgimento room retains its 19th-century charm, enhanced by meticulous restoration. The creaking of the original parquet accompanies footsteps in a place that is also part of Italy's history: Cavour once sat here, with a view of Palazzo Carignano, the first Parliament of the unified nation. Behind it, the Pistoletto room offers a simpler, more informal atmosphere. The cuisine celebrates tradition with classic Piedmontese dishes – from vitello tonnato to agnolotti del Plin – but it's in the second courses that it truly shines: the pigeon alla Maredo is unforgettable, executed with mastery and served with great professionalism. Another distinctive feature is the extensive and ca..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Carignano%202%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Del Cambio"
  />
);

export default DelCambio;
