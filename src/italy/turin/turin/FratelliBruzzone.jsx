...
const FratelliBruzzone = () => (
  <RestaurantPage
    restaurantName="Fratelli Bruzzone"
    address="via Maria Vittoria 34/a, Turin, 10123, Italy"
    cuisine="Piedmontese"
    priceRange="€"
    phoneNumber="+390117633447"
    website="https://www.fratellibruzzone.com/FB/home.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Bruzzone brothers deserve a round of applause for this restaurant and its extraordinary traditional Piedmontese cuisine. In just two small dining rooms (booking is recommended), guests can choose from an unforgettable array of dishes including anchovies in green sauce, baked onions with bagna cauda (an anchovy-based dip), superb agnolotti (stuffed pasta), tripe, chicken, bonet (a type of dessert) and hazelnut tart with zabaglione. With so much choice, it’s difficult to stop eating – and once you’ve left, you’ll want to return as soon as possible!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Maria%20Vittoria%2034%2Fa%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Fratelli Bruzzone"
  />
);

export default FratelliBruzzone;
