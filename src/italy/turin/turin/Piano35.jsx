...
const Piano35 = () => (
  <RestaurantPage
    restaurantName="Piano35"
    address="corso Inghilterra 3, Turin, 10138, Italy"
    cuisine="Italian Contemporary, Piedmontese"
    priceRange="€€€€"
    phoneNumber="+390114387800"
    website="https://www.piano35.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="On the ground floor of what has become one of the icons of Turin's urban landscape - the Intesa San Paolo skyscraper designed by Renzo Piano - you will find the dedicated entrance to the restaurant. Here you will be accompanied to the lift with which, at great speed, you will ascend to a height of 150 metres: before sitting down in the restaurant proper, do not miss a “diversion” to the panoramic terrace from which you will enjoy a splendid view of the city centre. Then, in the large and bright dining room surrounded by the greenhouse, the gastronomic choice will be presented to you in the form of three tasting courses: one dedicated to Piedmont, one to the cuisine and flavours of Italy (the maltagliati are very tasty; they are only two but huge, cooked in seafood sauce and seasoned with b..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Inghilterra%203%2C%20Turin%2C%2010138%2C%20Italy"
    pageTitle="Piano35"
  />
);

export default Piano35;
