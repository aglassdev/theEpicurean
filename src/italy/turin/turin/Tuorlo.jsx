...
const Tuorlo = () => (
  <RestaurantPage
    restaurantName="Tuorlo"
    address="via Sant'Agostino 15/b, Turin, 10122, Italy"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+3901119018061"
    website="https://www.tuorloristorante.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Decorated in elegant bistro style and skilfully renovated with contemporary furnishings, Tuorlo serves dishes based on traditional Piedmontese recipes reinterpreted with modern techniques and personal touches. Good choice of wines, plus an attractive little courtyard to the rear for relaxed summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sant'Agostino%2015%2Fb%2C%20Turin%2C%2010122%2C%20Italy"
    pageTitle="Tuorlo"
  />
);

export default Tuorlo;
