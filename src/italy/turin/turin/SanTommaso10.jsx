...
const SanTommaso10 = () => (
  <RestaurantPage
    restaurantName="San Tommaso 10"
    address="via San Tommaso 10, Turin, 10122, Italy"
    cuisine="Piedmontese, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39011534201"
    website="https://www.santommaso10.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 1895 Luigi Lavazza opened here a grocery store where he immediately began blending coffee. 129 years later the place hosts a modern restaurant with a superb kitchen run by a chef who, despite hailing from the Marche region, treats guests to one of the most authentic interpretations of Piedmontese cuisine in the city, often with a creative touch. Among the options on offer here, the trolley of antipasti is a must...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Tommaso%2010%2C%20Turin%2C%2010122%2C%20Italy"
    pageTitle="San Tommaso 10"
  />
);

export default SanTommaso10;
