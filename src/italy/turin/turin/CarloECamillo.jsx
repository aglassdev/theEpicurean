...
const CarloECamillo = () => (
  <RestaurantPage
    restaurantName="Carlo e Camillo"
    address="via Carlo Alberto 35, Turin, 10123, Italy"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390115170171"
    website="https://www.carloecamillo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This quiet and elegant bistro, the Grand Hotel Sitea’s second restaurant, offers a charming setting in which to enjoy skilfully prepared Piedmontese-influenced cuisine. The venue is also perfect for an aperitif, with excellent wines and cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Carlo%20Alberto%2035%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Carlo e Camillo"
  />
);

export default CarloECamillo;
