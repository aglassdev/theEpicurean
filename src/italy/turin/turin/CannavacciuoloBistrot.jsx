...
const CannavacciuoloBistrot = () => (
  <RestaurantPage
    restaurantName="Cannavacciuolo Bistrot"
    address="via Umberto Cosmo 6, Turin, 10131, Italy"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+390118399893"
    website="https://www.cannavacciuolobistrot.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated near the Gran Madre church in Borgo Po, this restaurant is the Turin home of the three-Michelin-starred chef from Villa Crespi Cannavacciuolo. Here, in a succession of small dining rooms decorated in elegant, modern style, Gabriele Bertoli serves contemporary-style cuisine influenced by culinary traditions from all over Italy, with a natural focus on his native Campania, to which he adds his own delightful personalised touches...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Umberto%20Cosmo%206%2C%20Turin%2C%2010131%2C%20Italy"
    pageTitle="Cannavacciuolo Bistrot"
  />
);

export default CannavacciuoloBistrot;
