...
const MammIsolaDiCapri = () => (
  <RestaurantPage
    restaurantName="Mammà Isola di Capri"
    address="Corso Castelfidardo 22, Turin, 10138, Italy"
    cuisine="Mediterranean Cuisine, Campanian"
    priceRange="€€€"
    phoneNumber="+390110243772"
    website="https://snodotorino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the multi-functional Sondo building (also home to a museum, offices and exhibition spaces), this large restaurant decorated in contemporary, post-industrial style provides the backdrop for chef Raffaele Amitrano’s Mediterranean cuisine which is strongly influenced by the flavours of Campania. His plin pasta dish pays tribute to the region and is particularly interesting thanks to ingredients such as cacio cheese, pepper and raw prawns. Make sure you arrive early if you want to visit the building and maybe even take advantage of the large sharing table...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Corso%20Castelfidardo%2022%2C%20Turin%2C%2010138%2C%20Italy"
    pageTitle="Mammà Isola di Capri"
  />
);

export default MammIsolaDiCapri;
