...
const Azotea = () => (
  <RestaurantPage
    restaurantName="Azotea"
    address="via Maria Vittoria 49/b, Turin, 10123, Italy"
    cuisine="Peruvian, Japanese"
    priceRange="€€"
    phoneNumber="+393286342213"
    website="https://azoteatorino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a central location with a small outdoor space, this restaurant boasts a striking interior with old walls, a verdant decor and climbing plants that add a South American feel. The cuisine shines the spotlight on the chef’s native Peru, with appetisers such as potted umbrine tacos and delicious yet atypical antipasti such as raw squid with saltwort and peas. Soy sauce, umeboshi, and yuyo seaweed sauce provide added exotic flavour. We highly recommend one of the excellent cocktails, such as the slightly sour Americano with yuzu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Maria%20Vittoria%2049%2Fb%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Azotea"
  />
);

export default Azotea;
