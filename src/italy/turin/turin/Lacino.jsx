...
const Lacino = () => (
  <RestaurantPage
    restaurantName="L'Acino"
    address="via San Domenico 2/a, Turin, 10121, Italy"
    cuisine="Piedmontese, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+393451392770"
    website="https://guide.michelin.com/en/piemonte/torino/restaurant/l-acino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Roman quadrilateral, in this characteristic and friendly restaurant the traditional Piedmontese cuisine is honored. The specialties include: stuffed onion, vitel tonnè, agnolotti and tajarin, tripe and stracotto. Among the desserts, the bonet and hazelnut cake with zabajone are not to be missed. They have few tables, so we advise booking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20San%20Domenico%202%2Fa%2C%20Turin%2C%2010121%2C%20Italy"
    pageTitle="L'Acino"
  />
);

export default Lacino;
