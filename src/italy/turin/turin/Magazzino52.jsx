...
const Magazzino52 = () => (
  <RestaurantPage
    restaurantName="Magazzino 52"
    address="via Giolitti 52/a, Turin, 10123, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€"
    phoneNumber="+390114271938"
    website="https://www.magazzino52.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant with characteristic brick-vaulted ceilings has retained the feel of its previous role as a warehouse. Despite the limited choice of dishes on the menu here, there is a strong focus on top-quality ingredients with recipes inspired by the Piedmont as well as the sea. The bottles of wine on display on its shelves can be purchased to take away. All-in-all, an excellent address in one of the city’s most elegant districts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giolitti%2052%2Fa%2C%20Turin%2C%2010123%2C%20Italy"
    pageTitle="Magazzino 52"
  />
);

export default Magazzino52;
