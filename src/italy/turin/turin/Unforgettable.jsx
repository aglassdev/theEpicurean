...
const Unforgettable = () => (
  <RestaurantPage
    restaurantName="Unforgettable"
    address="via Lorenzo Valerio 5/b, Turin, 10122, Italy"
    cuisine="Innovative, Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+3901118923994"
    website="https://www.unforgettabletorino.it"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Stefano Mancinelli and Sabrina Stravato are the two chefs who have taken over the reins in the kitchen at this original restaurant just a stone’s throw from the Santuario della Consolata. Although the format here remains the same (a blind tasting menu), the chefs are also making their mark on the creative cuisine, which combines typical dessert techniques and recipes with savoury elements (and vice versa) throughout the meal, as seen in the savoury potato crème caramel with onion. As previously, guests are greeted by the chefs in a small lounge and then served at a counter where they sit side by side (there are ten seats in total). Meanwhile, the volume of the background music (which is often quite loud) is adjusted to allow the staff to explain the different courses and wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Lorenzo%20Valerio%205%2Fb%2C%20Turin%2C%2010122%2C%20Italy"
    pageTitle="Unforgettable"
  />
);
