...
const LaPista = () => (
  <RestaurantPage
    restaurantName="La Pista"
    address="Centro Commerciale Lingotto - via Nizza 262, Turin, 10126, Italy"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3901119173073"
    website="https://lapistaristorante.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant is situated on the top floor of Turin’s iconic Lingotto building, the former Fiat factory, where the famous test track for cars has been transformed into a botanic garden – an interesting place to visit before your meal. Once at your table, choose from Alessandro Scardina’s three tasting menus: “Radici, gli essenziali” (traditional Piedmontese cuisine); “Botanic World” (vegetarian dishes); and “Trust” (a surprise menu where you leave all the choices to the chef). Whatever you choose, you’ll enjoy remarkable dishes that are balanced and full of substance and intense flavours. To avoid getting lost in the Lingotto shopping centre, make sure you follow the instructions you receive and take the lift to the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Centro%20Commerciale%20Lingotto%20-%20via%20Nizza%20262%2C%20Turin%2C%2010126%2C%20Italy"
    pageTitle="La Pista"
  />
);

export default LaPista;
