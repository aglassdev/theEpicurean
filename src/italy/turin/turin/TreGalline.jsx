...
const TreGalline = () => (
  <RestaurantPage
    restaurantName="Tre Galline"
    address="via Bellezia 37, Turin, 10122, Italy"
    cuisine="Piedmontese"
    priceRange="€€"
    phoneNumber="+390114366553"
    website="https://www.3galline.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bastion of traditional Piedmontese cuisine, the main dining room at this restaurant boasts a profusion of wood from its parquet flooring to the wood panelling and exposed roofbeams. The warm, hearty cuisine features local specialities such as vitello tonnato, agnolotti pasta with roast meat sauce and a selection of mixed boiled meats, as well as a cheese trolley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Bellezia%2037%2C%20Turin%2C%2010122%2C%20Italy"
    pageTitle="Tre Galline"
  />
);

export default TreGalline;
