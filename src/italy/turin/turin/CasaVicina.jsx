...
const CasaVicina = () => (
  <RestaurantPage
    restaurantName="Casa Vicina"
    address="via Ermanno Fenoglietti 20/b, Turin, 10126, Italy"
    cuisine="Piedmontese"
    priceRange="€€€€"
    phoneNumber="+390116640140"
    website="https://www.casavicina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Renowned over the years for its traditional Piedmontese cuisine, Casa Vicina is situated near the Lingotto factory (easily accessible by metro if you don’t have a car) on the top floor of the “Green Pea”, a building that showcases sustainable and environmentally friendly products. Meat dishes (including specialities such as Fassone steak in a tuna sauce, rabbit and ossobuco-filled agnolotti pasta) dominate the main courses although fish options are also available. Make sure you leave room for desserts such as ice cream, zabaglione and Ivrea tart...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Ermanno%20Fenoglietti%2020%2Fb%2C%20Turin%2C%2010126%2C%20Italy"
    pageTitle="Casa Vicina"
  />
);

export default CasaVicina;
