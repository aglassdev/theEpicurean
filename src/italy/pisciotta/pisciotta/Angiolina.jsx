...
const Angiolina = () => (
  <RestaurantPage
    restaurantName="Angiolina"
    address="via Passariello 2, località Marina di Pisciotta, Pisciotta, 84066, Italy"
    cuisine="Campanian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+393331693993"
    website="https://www.ristoranteangiolina.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This trattoria is situated at the end of the marina in Pisciotta, a location which ensures a quiet, tranquil ambience. The excellent, reasonably priced seafood cuisine is another reason that we heartily recommend eating here. With a focus on local fish, the menu features a wide array of specialities from Campania, including anchovies served in different ways (stuffed, “alla scapece”, salted and served with butter, and with spaghetti)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Passariello%202%2C%20localit%C3%A0%20Marina%20di%20Pisciotta%2C%20Pisciotta%2C%2084066%2C%20Italy"
    pageTitle="Angiolina"
  />
);

export default Angiolina;
