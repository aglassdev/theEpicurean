...
const Perbacco = () => (
  <RestaurantPage
    restaurantName="Perbacco"
    address="contrada Marina Campagna 5, Pisciotta, 84066, Italy"
    cuisine="Campanian, Home Cooking"
    priceRange="€€"
    phoneNumber="+390974973889"
    website="https://www.perbacco.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A rustic restaurant offering an authentic taste of the Cilento area, both in its setting amid lush Mediterranean vegetation and in its regional cuisine. Fish and seafood dominate the antipasti selection, while the main courses focus more on meat and vegetable dishes. Good choice of regional wines, plus the option of a few pleasant guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=contrada%20Marina%20Campagna%205%2C%20Pisciotta%2C%2084066%2C%20Italy"
    pageTitle="Perbacco"
  />
);

export default Perbacco;
