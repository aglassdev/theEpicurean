...
const ForestaMAR = () => (
  <RestaurantPage
    ...
    address="via Litoranea 2, Marina di Pisa, 56128, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3905035082"
    website="https://www.ristoranteforesta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Overlooking the Tyrrhenian Sea, all the tables at this restaurant offer sea views, whether you’re sitting in the winter dining room or on the outdoor summer terrace. The menu here focuses on top-quality fish dishes, which are classic in style, as is the background music and wine list, although the desserts have a more imaginative flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Litoranea%202%2C%20Marina%20di%20Pisa%2C%2056128%2C%20Italy"
    pageTitle="Foresta"
  />
);

export default ForestaMAR;
