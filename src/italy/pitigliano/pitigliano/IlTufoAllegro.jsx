...
const IlTufoAllegro = () => (
  <RestaurantPage
    restaurantName="Il Tufo Allegro"
    address="vicolo della Costituzione 5, Pitigliano, 58017, Italy"
    cuisine="Tuscan"
    priceRange="€€"
    phoneNumber="+393351028814"
    website="https://www.iltufoallegro.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of the Etruscan resort, close to the synagogue: Tuscan dishes, a small restaurant with a well stocked wine cellar and two dining rooms hewn out of the rock...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vicolo%20della%20Costituzione%205%2C%20Pitigliano%2C%2058017%2C%20Italy"
    pageTitle="Il Tufo Allegro"
  />
);

export default IlTufoAllegro;
