...
const OsteriaDelloStrecciolo = () => (
  <RestaurantPage
    restaurantName="Osteria dello Strecciolo"
    address="via Indipendenza 2, Robbiate, 23899, Italy"
    cuisine="Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+390399281052"
    website="https://www.osteriadellostrecciolo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the centre of the village, this popular and professionally run restaurant has an informal atmosphere. The cuisine is inspired by Mediterranean recipes and more regional traditions, with great care taken in the choice of ingredients and beautifully presented dishes. A business lunch menu is also available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Indipendenza%202%2C%20Robbiate%2C%2023899%2C%20Italy"
    pageTitle="Osteria dello Strecciolo"
  />
);

export default OsteriaDelloStrecciolo;
