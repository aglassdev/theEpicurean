...
const CibusCEG = () => (
  <RestaurantPage
    ...
    cuisine="Apulian, Country cooking"
    priceRange="€€"
    ...
    bio="Situated amid the alleyways of the historic centre, this restaurant boasts a typical atmosphere with a barrel-vaulted ceiling and internal courtyard, with tables arranged under the arcades. The cuisine focuses on carefully chosen ingredients and recipes from Puglia, making the restaurant a must if you’re visiting the region. Booking in advance is highly recommended...."
