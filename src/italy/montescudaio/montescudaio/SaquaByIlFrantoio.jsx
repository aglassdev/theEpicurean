...
const SaquaByIlFrantoio = () => (
  <RestaurantPage
    restaurantName="SaQua by Il Frantoio"
    address="viale Vittorio Veneto 40, Montescudaio, 56040, Italy"
    cuisine="Tuscan, Contemporary"
    priceRange="€€"
    phoneNumber="+390586650381"
    website="https://www.saqua.it"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=viale%20Vittorio%20Veneto%2040%2C%20Montescudaio%2C%2056040%2C%20Italy"
    pageTitle="SaQua by Il Frantoio"
  />
);

export default SaquaByIlFrantoio;
