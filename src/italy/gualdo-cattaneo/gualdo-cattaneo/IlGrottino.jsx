...
const IlGrottino = () => (
  <RestaurantPage
    restaurantName="Il Grottino"
    address="piazza Beato Ugolino 5, Gualdo Cattaneo, 06035, Italy"
    cuisine="Meats and Grills, Umbrian"
    priceRange="€€"
    phoneNumber="+390742760228"
    website="https://relaisilgrottino.com/it/home/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the old medieval village of Gualdo Cattaneo, amid the gentle valleys not far from Foligno, Il Grottino is the perfect choice for anyone keen to sample the authentic flavours of Umbrian cuisine. Here, truffles and zero-km produce take pride of place on the menu, with a particular focus on meat which is carefully cooked on the open-view barbecue grill. Alongside locally sourced produce, you’ll also find a choice of carefully selected Prussian beef. Comfortable and welcoming guestrooms complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Beato%20Ugolino%205%2C%20Gualdo%20Cattaneo%2C%2006035%2C%20Italy"
    pageTitle="Il Grottino"
  />
);

export default IlGrottino;
