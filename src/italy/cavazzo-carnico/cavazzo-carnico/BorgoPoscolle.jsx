...
const BorgoPoscolle = () => (
  <RestaurantPage
    restaurantName="Borgo Poscolle"
    address="via Poscolle 21/a, Cavazzo Carnico, 33020, Italy"
    cuisine="Traditional Cuisine"
    priceRange="€"
    phoneNumber="+393664915854"
    website="https://guide.michelin.com/en/friuli-venezia-giulia/cavazzo-carnico/restaurant/borgo-poscolle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Home - style cooking with a focus on regional specialities is served in this attractive family - run trattoria, which has its own organic vegetable garden and an educational pet therapy farm. The search for ingredients produced as close to home as possible is something of an obsession with the owner - chef, who is also passionate about his desserts. Make sure you try the millefeuille with strawberries and cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Poscolle%2021%2Fa%2C%20Cavazzo%20Carnico%2C%2033020%2C%20Italy"
    pageTitle="Borgo Poscolle"
  />
);

export default BorgoPoscolle;
