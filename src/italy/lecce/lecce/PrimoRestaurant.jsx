...
const PrimoRestaurant = () => (
  <RestaurantPage
    restaurantName="Primo Restaurant"
    address="via 47° Reggimento Fanteria 7, Lecce, 73100, Italy"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+390832243802"
    website="https://www.primorestaurant.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Primo Restaurant is home to young chef Solaika Marrocco, who was born in 1995 in nearby Gallipoli and who creates modern, highly personalised dishes which are not only a feast for the eyes but also for the palate. Guests can choose between a seven-course surprise tasting menu; an eight-course tasting menu with a focus on Puglia (traditional favourites are often reinterpreted with an imaginative twist); and an à la carte featuring some of the dishes which have proved most popular with guests since the restaurant opened. Whatever you choose, you’ll enjoy an extraordinary dining experience in one of the region’s most charming towns...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%2047%C2%B0%20Reggimento%20Fanteria%207%2C%20Lecce%2C%2073100%2C%20Italy"
    pageTitle="Primo Restaurant"
  />
);

export default PrimoRestaurant;
