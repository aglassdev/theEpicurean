...
const DuoRistorante = () => (
  <RestaurantPage
    restaurantName="Duo Ristorante"
    address="via Giuseppe Garibaldi 11, Lecce, 73100, Italy"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+390832520956"
    website="https://www.ristoranteduo.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant, intimate restaurant with subdued lighting is the perfect choice for a romantic gourmet dinner. Showcased on tasting menus and a concise à la carte, the excellent cuisine focuses on typical recipes and specialities from Puglia, often with an added personalised and creative twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Giuseppe%20Garibaldi%2011%2C%20Lecce%2C%2073100%2C%20Italy"
    pageTitle="Duo Ristorante"
  />
);

export default DuoRistorante;
