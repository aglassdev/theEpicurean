...
const CucinaRambaldi = () => (
  <RestaurantPage
    restaurantName="Cucina Rambaldi"
    address="via Sant'Ambrogio 55, Villar Dora, 10040, Italy"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390110161808"
    website="https://www.cucinarambaldi.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Regional dishes with the occasional subtle contemporary twist are to the fore here. The chef’s culinary techniques bring out all the flavour of the carefully selected and preserved ingredients, with a focus on cooking temperatures and the cut of the meat, resulting in excellent cuisine. The menu also features a few specialities from Ferrara, the chef’s native city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sant'Ambrogio%2055%2C%20Villar%20Dora%2C%2010040%2C%20Italy"
    pageTitle="Cucina Rambaldi"
  />
);

export default CucinaRambaldi;
