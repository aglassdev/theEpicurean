...
const LeColonne = () => (
  <RestaurantPage
    ...
    address="via Benefattori 7, Santa Maria Maggiore, 28857, Italy"
    cuisine="Country cooking, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+39032494893"
    website="https://www.ristorantelecolonne.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the small historic center of town, a couple with comprehensive management experience operates this well maintained, modest restaurant offering eclectic cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Benefattori%207%2C%20Santa%20Maria%20Maggiore%2C%2028857%2C%20Italy"
    pageTitle="Le Colonne"
  />
);

export default LeColonne;
