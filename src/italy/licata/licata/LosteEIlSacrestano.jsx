...
const LosteEIlSacrestano = () => (
  <RestaurantPage
    restaurantName="L'Oste e il Sacrestano"
    address="via Sant'Andrea 19, Licata, 92027, Italy"
    cuisine="Sicilian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+390922774736"
    website="https://www.losteeilsacrestano.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the historic center, this cozy restaurant boasts a Sicilian designation of origin and is adorned with intriguing and rare memorabilia on the walls. Chiara warmly welcomes guests, while Peppe is in the kitchen, offering two surprise tasting menus. The meals are characterized by generous portions and excellent market cuisine, primarily focusing on fish and vegetables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Sant'Andrea%2019%2C%20Licata%2C%2092027%2C%20Italy"
    pageTitle="L'Oste e il Sacrestano"
  />
);

export default LosteEIlSacrestano;
