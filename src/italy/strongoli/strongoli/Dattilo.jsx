...
const Dattilo = () => (
  <RestaurantPage
    restaurantName="Dattilo"
    address="Contrada Dattilo 6, Strongoli, 88816, Italy"
    cuisine="Country cooking, Creative"
    priceRange="€€€€"
    phoneNumber="+393294188323"
    website="https://www.dattilo.it"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a world of haute cuisine still dominated by male chefs, Caterina Ceraudo stands out for her authoritative presence and large personality. Her restaurant is housed in a charming agriturismo which offers simple guestrooms decorated in attractive, rustic style, a beautiful swimming pool shaded by thousand-year-old olive trees, and traditional produce such as wine, olive oil, cedro and orange marmalades, and fruit juices. All of this provides a fitting backdrop for Caterina’s modern, creative and yet unfussy cuisine which is made using local ingredients and showcased on two tasting menus and a fixed-price à la carte. The tour of the property with owner Roberto (the chef’s father), a forerunner of organic agriculture in the region who, together with his family, has dedicated his life to this..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Contrada%20Dattilo%206%2C%20Strongoli%2C%2088816%2C%20Italy"
    pageTitle="Dattilo"
  />
);

export default Dattilo;
