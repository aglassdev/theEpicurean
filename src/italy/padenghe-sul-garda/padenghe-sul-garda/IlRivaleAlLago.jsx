...
const IlRivaleAlLago = () => (
  <RestaurantPage
    restaurantName="Il Rivale al Lago"
    address="via Marconi 93, Padenghe sul Garda, 25080, Italy"
    cuisine="Italian Contemporary, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+390309995813"
    website="https://ilrivale.it/Rivale-al-lago/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated just a stone’s throw from the lake, this multi-faceted restaurant serves classic Italian dishes, often with a creative twist, alongside top-quality international ingredients such as Cantabrian anchovies and Japanese Wagyu beef. Grilled meats and vegetable dishes also make an appearance on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Marconi%2093%2C%20Padenghe%20sul%20Garda%2C%2025080%2C%20Italy"
    pageTitle="Il Rivale al Lago"
  />
);

export default IlRivaleAlLago;
