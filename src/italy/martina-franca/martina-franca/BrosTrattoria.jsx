...
const BrosTrattoria = () => (
  <RestaurantPage
    restaurantName="Bros' Trattoria"
    address="SS172, zona G, 59, Martina Franca, 74015, Italy"
    cuisine="Apulian, Grills"
    priceRange="€€"
    phoneNumber="+393516615513"
    website="https://www.brosworld.it/bros-trattoria/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sharing the entrance with Relais Villa San Martino, from the parking area you head towards romantic trulli surrounded by a small vineyard. The kitchen is orchestrated by Pellegrino and Potì from the nearby gourmet restaurant, but here tradition triumphs with flavorful dishes often cooked in a wood-fired oven. To name a few, local cured meats and cheeses, eggplant parmigiana, sagne 'ncannulate with ragù, an extraordinary tripe, and various grilled meats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=SS172%2C%20zona%20G%2C%2059%2C%20Martina%20Franca%2C%2074015%2C%20Italy"
    pageTitle="Bros' Trattoria"
  />
);

export default BrosTrattoria;
