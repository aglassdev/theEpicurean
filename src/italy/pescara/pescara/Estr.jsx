...
const Estr = () => (
  <RestaurantPage
    restaurantName="Estrò"
    address="piazza della Rinascita 23, Pescara, 65122, Italy"
    cuisine="Contemporary, Country cooking"
    priceRange="€"
    phoneNumber="+3908562388"
    website="https://guide.michelin.com/en/abruzzo/pescara/restaurant/estro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Boasting a quiet, informal and youthful atmosphere, this restaurant overlooking the main square surprises guests with its simple ideas and impressive culinary technique. It’s immediately obvious from the menu that chef Alfonso Della Croce’s favourite ingredient is meat!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20della%20Rinascita%2023%2C%20Pescara%2C%2065122%2C%20Italy"
    pageTitle="Estrò"
  />
);
