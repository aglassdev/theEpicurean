...
const PaoloGriffaAlCaffNazionale = () => (
  <RestaurantPage
    restaurantName="Paolo Griffa al Caffè Nazionale"
    address="piazza Emile Chanoux 9, Aosta, 11100, Italy"
    cuisine="Creative, Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+390165525356"
    website="https://www.paologriffa.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A historic city restaurant, overlooking Aosta's main square, has been brought back to life by the passion of young chef Paolo Griffa. It offers colourful, balanced and contemporary cuisine, available in 3, 5 or 7-course tasting menus. Always attentive to the harmony of flavours and chromatic beauty of dishes, the chef demonstrates a growing skill in handling vegetables, as evidenced by the vegetarian dishes always on the menu. The service is of an excellent standard and the wine offerings of great depth. Of course, as the name suggests, some spaces are dedicated to excellent coffee, equipped with an excellent pastry corner, making this place recommended for any time of the day, from breakfasts to aperitifs!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=piazza%20Emile%20Chanoux%209%2C%20Aosta%2C%2011100%2C%20Italy"
    pageTitle="Paolo Griffa al Caffè Nazionale"
  />
);

export default PaoloGriffaAlCaffNazionale;
