...
const AlPalazzo = () => (
  <RestaurantPage
    restaurantName="Al Palazzo"
    address="via Dei Mulini 23, Positano, 84017, Italy"
    cuisine="Mediterranean Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+39089875177"
    website="https://palazzomurat.it/it/dining/ristorante-al-palazzo-a-positano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Al Palazzo is the renowned restaurant at the Palazzo Murat hotel which is run by the Attanasio family. Dine alfresco in the restaurant’s beautiful botanical garden with its tiny vegetable patch, apart from on rare days of bad weather, when guests are served indoors in its small, elegant dining rooms. The Mediterranean cuisine includes meat and fish dishes alike, with slightly different menus at lunchtime (simpler options) and in the evening. Le Petit Murat bar is still open, offering an interesting selection of cocktails to supplement its excellent wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Dei%20Mulini%2023%2C%20Positano%2C%2084017%2C%20Italy"
    pageTitle="Al Palazzo"
  />
);

export default AlPalazzo;
