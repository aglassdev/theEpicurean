...
const OsteriaSanGiulio = () => (
  <RestaurantPage
    restaurantName="Osteria San Giulio"
    address="Via Dulzago, Badia di Dulzago, 28043, Italy"
    cuisine="Piedmontese, Country cooking"
    priceRange="€"
    phoneNumber="+39032198101"
    website="https://www.osteriasangiulio.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its delightful location in an old rural abbey, warm welcome, friendly atmosphere and excellent “home-style” cuisine which focuses on the region’s classic dishes, this restaurant appeals to all the senses. Tastings of cured hams and cheeses from the surrounding area can be arranged in the beautiful garden by prior arrangement...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Dulzago%2C%20Badia%20di%20Dulzago%2C%2028043%2C%20Italy"
    pageTitle="Osteria San Giulio"
  />
);

export default OsteriaSanGiulio;
