...
const Oscar = () => (
  <RestaurantPage
    ...
    address="via Franchini 78, Ardenza, 57128, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+390586501258"
    website="https://www.ristoranteoscar.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated amid the fascinating 19C buildings in Ardenza, a district in the south of Livorno, Oscar is an excellent choice for anyone keen to enjoy simple, classic and traditional fish dishes with a focus on good quality – the sort of place where you would be more than happy to eat every day. And surely there’s no higher compliment than that!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Franchini%2078%2C%20Ardenza%2C%2057128%2C%20Italy"
    pageTitle="Oscar"
  />
);
