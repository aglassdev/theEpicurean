...
const LocandaNelli = () => (
  <RestaurantPage
    restaurantName="Locanda Nelli"
    address="via Vittorio Veneto 15, Pietra Ligure, 17027, Italy"
    cuisine="Mediterranean Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+393313383326"
    website="https://locandanelli.metro.biz"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A friendly and welcoming little restaurant in the heart of the town’s historic centre. It’s no surprise that the specialities here focus mainly on fish and seafood, with an emphasis on Mediterranean cuisine, homemade pasta and the use of extremely fresh ingredients – the menu changes daily depending on market availability. The charming outdoor space boasts tables set out along the small pedestrianised street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Vittorio%20Veneto%2015%2C%20Pietra%20Ligure%2C%2017027%2C%20Italy"
    pageTitle="Locanda Nelli"
  />
);

export default LocandaNelli;
