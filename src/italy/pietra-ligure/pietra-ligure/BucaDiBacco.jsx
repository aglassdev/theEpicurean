...
const BucaDiBacco = () => (
  <RestaurantPage
    restaurantName="Buca di Bacco"
    address="corso Italia 149, Pietra Ligure, 17027, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+39019615307"
    website="https://guide.michelin.com/en/liguria/pietra-ligure/restaurant/buca-di-bacco"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The seafood specialities, the care in the choice of rare produce and the originality of the Proprietor characterise this establishment, situated as it is in the basement of a building...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=corso%20Italia%20149%2C%20Pietra%20Ligure%2C%2017027%2C%20Italy"
    pageTitle="Buca di Bacco"
  />
);

export default BucaDiBacco;
