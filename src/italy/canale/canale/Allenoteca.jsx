...
const Allenoteca = () => (
  <RestaurantPage
    restaurantName="All'Enoteca"
    address="via Roma 57, Canale, 12043, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€€"
    phoneNumber="+39017395857"
    website="https://www.davidepalluda.it/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Roma%2057%2C%20Canale%2C%2012043%2C%20Italy"
    pageTitle="All'Enoteca"
  />
);

export default Allenoteca;
