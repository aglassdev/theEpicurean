...
const VillaTiboldi = () => (
  <RestaurantPage
    restaurantName="Villa Tiboldi"
    address="via Case Sparse 127, località Tiboldi, Canale, 12043, Italy"
    cuisine="Piedmontese, Contemporary"
    priceRange="€€"
    phoneNumber="+390173970388"
    website="https://www.villatiboldi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delightful combination of good food and a romantic ambience in this old restored farmhouse surrounded by hills. Top - quality cuisine and a wine cellar that is well worth a visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Case%20Sparse%20127%2C%20localit%C3%A0%20Tiboldi%2C%20Canale%2C%2012043%2C%20Italy"
    pageTitle="Villa Tiboldi"
  />
);

export default VillaTiboldi;
