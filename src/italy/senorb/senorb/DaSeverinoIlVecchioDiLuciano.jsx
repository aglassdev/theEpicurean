...
const DaSeverinoIlVecchioDiLuciano = () => (
  <RestaurantPage
    restaurantName="Da Severino il Vecchio - Di Luciano"
    address="largo Abruzzi 2, ang. via Piemonte 23, Senorbì, 09040, Italy"
    cuisine="Mediterranean Cuisine"
    priceRange="€"
    phoneNumber="+390709804197"
    website="https://guide.michelin.com/en/sardegna/senorb/restaurant/da-severino-il-vecchio-di-luciano"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This historic restaurant now has new premises with a classic yet modern feel. Mediterranean cuisine with a traditional and regional influence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=largo%20Abruzzi%202%2C%20ang.%20via%20Piemonte%2023%2C%20Senorb%C3%AC%2C%2009040%2C%20Italy"
    pageTitle="Da Severino il Vecchio - Di Luciano"
  />
);

export default DaSeverinoIlVecchioDiLuciano;
