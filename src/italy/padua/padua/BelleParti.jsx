...
const BelleParti = () => (
  <RestaurantPage
    restaurantName="Belle Parti"
    address="via Belle Parti 11, Padua, 35139, Italy"
    cuisine="Classic Cuisine, Seafood"
    priceRange="€€"
    phoneNumber="+390498751822"
    website="https://www.ristorantebelleparti.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In a charming arcaded alley in the pedestrian centre, on the first floor of the historic Palazzo Prosdocimi, the warm and welcoming romance of the room will convince you that you are in the right place. Paintings, mirrors, and woodwork rival the beautiful ceiling of exposed beams, while the à la carte proposal is in tune with the seasons, offering a review of tasty and classic mostly seafood dishes (but some customisation is there, as in the case of Belle Parti's spaghetti alla chitarra, a cacio e pepe embellished with scampi), mostly regionally sourced, with good meat alternatives. Reception and service genteelly tuned to the feminine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Belle%20Parti%2011%2C%20Padua%2C%2035139%2C%20Italy"
    pageTitle="Belle Parti"
  />
);

export default BelleParti;
