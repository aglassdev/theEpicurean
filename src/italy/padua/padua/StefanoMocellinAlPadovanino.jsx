...
const StefanoMocellinAlPadovanino = () => (
  <RestaurantPage
    restaurantName="Stefano Mocellin al Padovanino"
    address="via Santa Chiara 1, Padua, 35123, Italy"
    cuisine="Creative, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+393756197434"
    website="https://padovanino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the historic centre of Padova, this restaurant is home to owner-chef Stefano Mocellin, whose colourful, creative and personalised cuisine is influenced by his past culinary experience in cities such as Milan and Venice. From Milan, for example, he has taken the legendary “cassoeula”, to which he gives a lighter touch thanks to his use of more than one type of meat (pork and duck), while his “saor” and the sardines that he uses to stuff his plin pasta are inspired by Venice. Underlying all of this is his passion for cooking over the barbecue grill, the main focus of almost all the dishes on the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Santa%20Chiara%201%2C%20Padua%2C%2035123%2C%20Italy"
    pageTitle="Stefano Mocellin al Padovanino"
  />
);

export default StefanoMocellinAlPadovanino;
