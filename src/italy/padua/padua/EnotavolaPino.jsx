...
const EnotavolaPino = () => (
  <RestaurantPage
    restaurantName="Enotavola Pino"
    address="via dell'Arco 37, Padua, 35122, Italy"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+390498762385"
    website="https://www.enotavola.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20dell'Arco%2037%2C%20Padua%2C%2035122%2C%20Italy"
    pageTitle="Enotavola Pino"
  />
);

export default EnotavolaPino;
