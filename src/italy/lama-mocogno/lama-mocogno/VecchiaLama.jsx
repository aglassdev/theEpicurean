...
const VecchiaLama = () => (
  <RestaurantPage
    restaurantName="Vecchia Lama"
    address="via XXIV Maggio 24, Lama Mocogno, 41023, Italy"
    cuisine="Emilian, Meats and Grills"
    priceRange="€"
    phoneNumber="+39053644662"
    website="https://www.ristorantevecchialama.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Enjoy a friendly welcome and excellent food in this restaurant that only serves meat dishes. The focus is on mountain specialities from Emilia, as well as truffles in season. Dine alfresco on the terrace overlooking the garden in summer. House specialities include ricotta and nettle tortelloni with porcini mushrooms and the slightly more expensive Fiorentina steak cooked on a hot stone...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20XXIV%20Maggio%2024%2C%20Lama%20Mocogno%2C%2041023%2C%20Italy"
    pageTitle="Vecchia Lama"
  />
);

export default VecchiaLama;
