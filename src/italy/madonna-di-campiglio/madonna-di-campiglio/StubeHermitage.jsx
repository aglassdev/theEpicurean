...
const StubeHermitage = () => (
  <RestaurantPage
    restaurantName="Stube Hermitage"
    address="via Castelletto Inferiore 69, Madonna di Campiglio, 38086, Italy"
    cuisine="Creative, Regional Cuisine"
    priceRange="€€€€"
    phoneNumber="+390465441558"
    website="https://stubehermitage.it/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In a quiet and secluded location inside the Biohotel Hermitage, the restaurant occupies an early 20th-century stube, a wooden treasure chest with a few tables to cradle yourself at for an evening of romance and haute cuisine. Elegance is the rule here and will envelop you, from the decidedly creative dishes to the atmosphere. Also of note is a nice selection of cheeses..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Castelletto%20Inferiore%2069%2C%20Madonna%20di%20Campiglio%2C%2038086%2C%20Italy"
    pageTitle="Stube Hermitage"
  />
);

export default StubeHermitage;
