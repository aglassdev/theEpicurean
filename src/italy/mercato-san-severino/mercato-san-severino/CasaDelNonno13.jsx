...
const CasaDelNonno13 = () => (
  <RestaurantPage
    restaurantName="Casa del Nonno 13"
    address="via Caracciolo 13, loc. Sant'Eustachio, Mercato San Severino, 84085, Italy"
    cuisine="Campanian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+39089894399"
    website="https://www.casadelnonno13.it/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Recently re-opened under new management, this charming restaurant winds its way from room to room until you finally arrive at the palazzo’s old cellars, the jewel in its crown. The cuisine here has quickly made a name for itself, focusing on strong links with regional traditions and showcasing local favourites on a menu full of tempting options, including salumi, local vegetables, pasta dishes, grilled meat options and typical local ingredients such as San Marzano tomatoes. The delicious cuisine pays tribute to the fine culinary traditions of Campania...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Caracciolo%2013%2C%20loc.%20Sant'Eustachio%2C%20Mercato%20San%20Severino%2C%2084085%2C%20Italy"
    pageTitle="Casa del Nonno 13"
  />
);

export default CasaDelNonno13;
