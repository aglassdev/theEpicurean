...
const DaGregorio = () => (
  <RestaurantPage
    restaurantName="Da Gregorio"
    address="strada provinciale 101 136, Morrano Nuovo, 05018, Italy"
    cuisine="Umbrian, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+390763215011"
    website="https://guide.michelin.com/en/umbria/morrano-nuovo/restaurant/da-gregorio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A few kilometers from Orvieto, after a series of winding roads in the village of Morrano Nuovo, an old 1980s sign will guide you to the restaurant Da Gregorio. A stop here is a must: straightforward, local cuisine with homegrown vegetables and cured meats, and a wine list celebrating small winemakers and native grape varieties. The grilled pork with maple syrup is a must-try – a true surprise on the plate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=strada%20provinciale%20101%20136%2C%20Morrano%20Nuovo%2C%2005018%2C%20Italy"
    pageTitle="Da Gregorio"
  />
);

export default DaGregorio;
