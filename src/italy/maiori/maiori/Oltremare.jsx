...
const Oltremare = () => (
  <RestaurantPage
    restaurantName="Oltremare"
    address="via Diego Taiani 3, Maiori, 84010, Italy"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+39089877699"
    website="https://www.restaurantoltremare.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the fifth floor of the Due Torri hotel, the restaurant has recently been refurbished, giving it an even more charming and atmospheric feel than before. The cuisine is creative in style, almost always using ingredients and recipes from Campania as its inspiration – a good example is the many different ways tomato is used, including tomato water distilled in an alembic still. Chef Alfonso Crisci’s recipes are complex and always full of different ingredients and colours, with a selection of delicious and generous desserts to finish your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Diego%20Taiani%203%2C%20Maiori%2C%2084010%2C%20Italy"
    pageTitle="Oltremare"
  />
);

export default Oltremare;
