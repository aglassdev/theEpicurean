...
const HostariaDelVicolo = () => (
  <RestaurantPage
    restaurantName="Hostaria del Vicolo"
    address="vicolo Sammaritano 10, Sciacca, 92019, Italy"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+39092523071"
    website="https://www.hostariadelvicolo.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a central yet secluded location, this intimate and elegant restaurant serves typical Sicilian cuisine with a focus on fish, vegetables from the kitchen garden and delicious cheeses. A good wine selection completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=vicolo%20Sammaritano%2010%2C%20Sciacca%2C%2092019%2C%20Italy"
    pageTitle="Hostaria del Vicolo"
  />
);

export default HostariaDelVicolo;
