...
const LaCorteDegliDei = () => (
  <RestaurantPage
    restaurantName="La Corte degli Dei"
    address="via Armand Diaz 26, Agerola, 80051, Italy"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+393248437579"
    website="http://www.lacortedeglidei.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Relax amid the greenery on the patio terrace at this restaurant, which is housed in an old palazzo full of timeless charm and history. The interior is as charming as the exterior, boasting delightful dining rooms teeming with character. The cuisine skilfully encompasses traditional classic favourites alongside more innovative dishes, offering guests a culinary journey that combines past and present with elegance and flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=via%20Armand%20Diaz%2026%2C%20Agerola%2C%2080051%2C%20Italy"
    pageTitle="La Corte degli Dei"
  />
);

export default LaCorteDegliDei;
