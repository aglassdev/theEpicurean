...
const WalserSchtuba = () => (
  <RestaurantPage
    restaurantName="Walser Schtuba"
    address="località Riale, Ponte, 28863, Italy"
    cuisine="Country cooking, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+393393663330"
    website="https://locandawalser.it"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This delightful Alpine - style restaurant stands in the picturesque upper section of the Val Formazza. The menu features local specialities reinterpreted with a light, modern twist. Outdoor dining in summer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=localit%C3%A0%20Riale%2C%20Ponte%2C%2028863%2C%20Italy"
    pageTitle="Walser Schtuba"
  />
);

export default WalserSchtuba;
