...
const Terrone = () => (
  <RestaurantPage
    restaurantName="Terrone"
    address="Fort St. Angelo, Birgu Waterfront, Birgu, BRG 1734, Malta"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+35627042656"
    website="https://www.terrone.com.mt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away at the tip of the small town of Vittoriosa and abutting the walls of Fort St. Angelo, Maltese-Australian chef-owner Adrian Hili has been at the helm here for over ten years. His cooking celebrates Mediterranean, Italian and Maltese traditions: the sole, for instance, is perfectly baked in a wood-fired oven and served with Castelluccio lentils from Italy, jazzed up with samphire, and paired with a small pan of homemade fries. Due to ongoing restoration work, the entrance is currently to the rear of the building (not particularly attractive), but once inside the elegant decor and alfresco dining area, which offers a partial yet captivating view of the yachts and Valletta beyond, more than compensate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fort%20St.%20Angelo%2C%20Birgu%20Waterfront%2C%20Birgu%2C%20BRG%201734%2C%20Malta"
    pageTitle="Terrone"
  />
);

export default Terrone;
