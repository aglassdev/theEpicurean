...
const Rebekahs = () => (
  <RestaurantPage
    restaurantName="Rebekah's"
    address="12, Triq it-Tgham, Mellieħa, MLH 1472, Malta"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+35679456931"
    website="https://rebekahsrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a stylish, historic edifice, nearly 300 years old, the interior of this restaurant is the epitome of refined sophistication. Chef-owner Andrew Vella concocts a Mediterranean score with a creative and personal touch. During the summer, guests can dine alfresco in the quiet, refreshing sanctuary of an inner courtyard...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%2C%20Triq%20it-Tgham%2C%20Mellie%C4%A7a%2C%20MLH%201472%2C%20Malta"
    pageTitle="Rebekah's"
  />
);

export default Rebekahs;
