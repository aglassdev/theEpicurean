...
const ZestSTJ = () => (
  <RestaurantPage
    restaurantName="Zest"
    address="25 St. George's Road, St. Julian's, STJ 3208, Malta"
    cuisine="Asian"
    priceRange="€€"
    phoneNumber="+35621387600"
    website="https://www.zestflavours.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set in a chic hotel in the bustling St Julian’s district, enthusiasts of Asian cuisine will find plenty to explore in this modern and elegant restaurant. The extensive menu covers the classics of Far Eastern cuisine: from sushi and noodles to curry-based dishes, Peking duck and bao buns - you will be spoilt for choice…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=25%20St.%20George's%20Road%2C%20St.%20Julian's%2C%20STJ%203208%2C%20Malta"
    pageTitle="Zest"
  />
);

export default ZestSTJ;
