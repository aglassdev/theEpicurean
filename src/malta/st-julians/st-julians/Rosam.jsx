...
const Rosam = () => (
  <RestaurantPage
    restaurantName="Rosamì"
    address="The Villa, Main Street, Balluta Bay, St. Julian's, STJ 1017, Malta"
    cuisine="Creative, Contemporary"
    priceRange="€€€"
    phoneNumber="+35679800823"
    website="https://rosami.xaracollection.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Overlooking Balluta Bay, Rosamì occupies a beautiful Maltese-style villa, whose first floor, pleasantly sheltered from the street below, houses a classic, stylish restaurant, with a distinctly romantic edge. The cuisine, now helmed by a youthful yet highly experienced Italian chef, showcases dishes with an international twang presented in two surprise tasting menus: one six course and the other eight, both flanked by a selection of appetisers and local cheeses from small producers - a delightful way to experience Malta’s artisanal excellence. The service is highly professional, courtesy of staff whose in-depth knowledge enables them to explain each dish with confidence. The wine list features vintages from around the world alongside local wines and an excellent selection available by the g..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Villa%2C%20Main%20Street%2C%20Balluta%20Bay%2C%20St.%20Julian's%2C%20STJ%201017%2C%20Malta"
    pageTitle="Rosamì"
  />
);

export default Rosam;
