...
const Tmun = () => (
  <RestaurantPage
    restaurantName="Tmun"
    address="Martino Garces Street, Mġarr Harbour, Gozo, Għajnsielem, GSM 2413, Malta"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+35621566276"
    website="https://tmunrestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant serves delicious Mediterranean food which is often inspired by fish caught fresh on the day. The vibe is informal with friendly, welcoming staff and there’s an attractive sunny terrace for alfresco summer dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Martino%20Garces%20Street%2C%20M%C4%A1arr%20Harbour%2C%20Gozo%2C%20G%C4%A7ajnsielem%2C%20GSM%202413%2C%20Malta"
    pageTitle="Tmun"
  />
);
