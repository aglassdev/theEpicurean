...
const LevelNineAtTheGrand = () => (
  <RestaurantPage
    restaurantName="Level Nine at The Grand"
    address="58 Triq Sant Antnin, Mġarr Harbour, Gozo, Għajnsielem, GSM 9026, Malta"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+35699301094"
    website="https://www.levelninegozo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In 2025, George Attard returned to his native island of Gozo, bringing with him a wealth of experience gleaned in prestigious, including Michelin-starred, kitchens. Perched on the top floor of the Grand Hotel Gozo, the restaurant overlooks the lively port of Mgarr. Partially visible from the contemporary dining room and in full view from the terrace, the view of the Mediterranean is truly captivating. Chef Attard crafts a distinctly modern take on Mediterranean cuisine, courtesy of dishes whose flavours are as delicate as their plating is exquisite, reflecting his solid technical foundation. His fondness for Italy clearly emerges in the first courses, which often feature house-made ravioli, cappelletti, or “plin.” To complete the experience, the wine list is savvily flanked by an enticing ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=58%20Triq%20Sant%20Antnin%2C%20M%C4%A1arr%20Harbour%2C%20Gozo%2C%20G%C4%A7ajnsielem%2C%20GSM%209026%2C%20Malta"
    pageTitle="Level Nine at The Grand"
  />
);

export default LevelNineAtTheGrand;
