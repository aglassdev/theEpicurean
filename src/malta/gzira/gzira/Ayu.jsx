...
const Ayu = () => (
  <RestaurantPage
    restaurantName="AYU"
    address="209 The Strand, Gzira, GZR 1023, Malta"
    cuisine="World Cuisine, International"
    priceRange="€"
    phoneNumber="+35621337141"
    website="https://ayu.mt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on Gzira’s seafront, the highlight of this lively venue with a youthful spirit is its cuisine which comes from all over the world. The three brothers at the helm have travelled extensively, and the menu reflects their globetrotting temperament. You’ll find delights from Morocco, Japan, Italy, Venezuela and so on. We enjoyed a starter of lamb-stuffed pitas flavoured with yoghurt and harissa sauces (from Lebanon), followed by eggplant stew with walnuts, paired with spiced rice and a raw vegetable tartare (from Iran). The simple dessert starred a patchwork of cultures: an enormous profiterole (with origins somewhere between France and Italy) filled with Mediterranean pistachio cream and crisp dark chocolate pearls from Belgium. Excellent value for money and an informal vibe make it a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=209%20The%20Strand%2C%20Gzira%2C%20GZR%201023%2C%20Malta"
    pageTitle="AYU"
  />
);
