...
const TerroirATT = () => (
  <RestaurantPage
    ...
    address="13 Triq Il-Kbira, Attard, ATD 1027, Malta"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+35679514032"
    website="https://www.terroir.mt/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a picturesque square with an old fountain, this 16C building boasts period brick walls and a rustic, romantic ambience – the cosy dining room is on the first floor and there is even a small table on the balcony (make sure you book this ahead). The cuisine focuses on local and Mediterranean ingredients, with highlights such as ricotta gnocchi with a Maltese sausage ragù, while the wine list stars a few international estates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=13%20Triq%20Il-Kbira%2C%20Attard%2C%20ATD%201027%2C%20Malta"
    pageTitle="Terroir"
  />
);

export default TerroirATT;
