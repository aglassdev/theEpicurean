...
const FernandGastrotheque = () => (
  <RestaurantPage
    restaurantName="Fernandõ Gastrotheque"
    address="17 Tigne Street, Sliema, SLM 3172, Malta"
    cuisine="Mediterranean Cuisine, Contemporary"
    priceRange="€€€"
    phoneNumber="+35679222023"
    website="https://www.fernando.com.mt/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Tucked away in one of Sliema’s quiet side streets, this small restaurant has become something of a beacon for fine dining in Malta. The kitchen is led by talented young chef Hiram Cassar, a former sous chef with valuable international experience under his belt. The menu is concise and well-structured, featuring creative dishes that aim for balance and elegance and composed around a small number of cherry-picked ingredients. Stand-out dishes include a house-made agnolotti pecorino with delica pumpkin, pine nuts and mostarda di Cremona, as well as seabass escalope with leeks, preserved lemon, capers and kombu seaweed, but it is worth bearing in mind that respect for the seasons is the backbone of this establishment. Seamless, attentive service and an excellent wine list, featuring over 700 l..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20Tigne%20Street%2C%20Sliema%2C%20SLM%203172%2C%20Malta"
    pageTitle="Fernandõ Gastrotheque"
  />
);

export default FernandGastrotheque;
