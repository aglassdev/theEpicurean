...
const LeGv = () => (
  <RestaurantPage
    restaurantName="Le GV"
    address="Thornton Street, Sliema, SLM 3143, Malta"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€"
    phoneNumber="+35679639049"
    website="https://legv.mt"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The lavish rooftop restaurant on the eleventh floor of the 1926 Le Soleil Hotel sports a theme inspired by the carriages of the Orient Express, creating a vibe that is both glamorous and historic. There is also a panoramic terrace overlooking the city for warmer months. Visible in their open kitchen, chefs Andrew Borg and David Tanti craft a selection of dishes in a concise lineup, blending creativity with international flair. While the selection may seem limited, the superlative quality is anything but... Notably, the exquisite raw amberjack flanked by a hint of sea urchin and preserved fennel and finished tableside with a frothy Sicilian pink grapefruit cream. The dessert menu features just one option, but it consists of 2 or 3 wickedly indulgent and beautifully crafted small portions (t..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Thornton%20Street%2C%20Sliema%2C%20SLM%203143%2C%20Malta"
    pageTitle="Le GV"
  />
);
