...
const AlSale = () => (
  <RestaurantPage
    restaurantName="Al Sale"
    address="32 Victory Square, Xagħra, XRA 2205, Malta"
    cuisine="Meats and Seafood"
    priceRange="€€"
    phoneNumber="+35627200509"
    website="https://guide.michelin.com/en/gozo-region/xagra/restaurant/al-sale"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This outwardly inconspicuous restaurant in the heart of Xaghra actually extends over two floors and boasts a small terrace out front. The chef-owner, who hails from Toronto, opened his independent business here in the middle of the pandemic, demonstrating his steadfast commitment and drive! If you love simple cuisine based on fresh produce, especially meat and seafood, try the prawn & scallop-filled ravioli with prawn bisque, or the delicious rack of veal with salsa verde. Everything is uncomplicated, ingredient-led and freshly prepared. An international wine list and friendly, attentive yet unstuffy service round off the overall experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32%20Victory%20Square%2C%20Xag%C4%A7ra%2C%20XRA%202205%2C%20Malta"
    pageTitle="Al Sale"
  />
);

export default AlSale;
