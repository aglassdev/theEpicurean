...
const LaPira = () => (
  <RestaurantPage
    restaurantName="La Pira"
    address="35 Merchant Street, Valletta, VLT 1171, Malta"
    cuisine="Regional Cuisine, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+35699316341"
    website="https://lapiramaltesekitchen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In historic Valletta, among the major tourist attractions, La Pira rolls out authentic Maltese cuisine, packed in flavour and served in a simple and informal setting. Among the standout dishes are pulled rabbit rigatoni, house-made stuffed pasta, Maltese stuffed marrows, pan-fried octopus and aljotta, the island’s iconic fish soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=35%20Merchant%20Street%2C%20Valletta%2C%20VLT%201171%2C%20Malta"
    pageTitle="La Pira"
  />
);

export default LaPira;
