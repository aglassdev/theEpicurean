...
const IonHarbourBySimonRogan = () => (
  <RestaurantPage
    restaurantName="ION Harbour by Simon Rogan"
    address="11 St. Barbara Bastion, Valletta, VLT 1961, Malta"
    cuisine="Contemporary, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+35699110166"
    website="https://ionharbour.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located on the seafront, on the fourth floor of the exclusive Iniala Harbour House, ION Harbour offers spot-on, friendly service led by a youthful team, breathtaking views and truly exceptional cuisine. Chef Simon Rogan, holder of three Michelin stars in his Lake District restaurant L’Enclume in the UK, signs the score. Resident chef Christian Cali executes a complex and creative menu, using produce that is grown, reared, or caught in the Maltese Islands whenever possible, in line with Rogan’s celebrated farm-to-table philosophy. Two tasting menus, Short and Full, are available, both rich in local ingredients and often highlighting individual producers. The head-spinning, 500-strong wine bin is presented through curated tasting journeys with an extensive selection available by the glass. F..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20St.%20Barbara%20Bastion%2C%20Valletta%2C%20VLT%201961%2C%20Malta"
    pageTitle="ION Harbour by Simon Rogan"
  />
);

export default IonHarbourBySimonRogan;
