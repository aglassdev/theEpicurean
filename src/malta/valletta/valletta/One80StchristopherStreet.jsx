...
const One80StchristopherStreet = () => (
  <RestaurantPage
    restaurantName="One80 St.Christopher Street"
    address="45A St. Christopher's Street, Valletta, VLT 1464, Malta"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+35627800040"
    website="https://one80.com.mt/valletta/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the heart of historic Valletta, a vibrant Mediterranean culinary experience unfolds within a low-key, bistro chic setting at One80 St. Christopher Street. Chef Vella draws on his international expertise to craft a punchy menu that showcases the breadth of Mediterranean cuisine. The range is very diverse and includes a thoughtful selection for vegetarians. Notable house specialties include the Chateaubriand for two, and for seafood lovers, a daily fresh catch that varies depending on availability. The well-curated cellar reveals an international selection with a weakness for prestigious Italian estates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45A%20St.%20Christopher's%20Street%2C%20Valletta%2C%20VLT%201464%2C%20Malta"
    pageTitle="One80 St.Christopher Street"
  />
);

export default One80StchristopherStreet;
