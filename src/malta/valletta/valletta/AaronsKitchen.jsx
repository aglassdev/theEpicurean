...
const AaronsKitchen = () => (
  <RestaurantPage
    restaurantName="Aaron´s Kitchen"
    address="107 Archbishop Street, Valletta, VLT 1446, Malta"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+35621230636"
    website="https://aaronskitchenvalletta.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Next to the picturesque Strait Street in the heart of Valletta’s historic centre, this popular hotspot offers a delightful mix of Maltese and Italian cuisines, including both surf and turf dishes. One of our favourites is Aaron’s Kitchen beef fillet wrapped in Parma ham with king prawns, brandy and bisque. All the desserts are made from scratch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=107%20Archbishop%20Street%2C%20Valletta%2C%20VLT%201446%2C%20Malta"
    pageTitle="Aaron´s Kitchen"
  />
);

export default AaronsKitchen;
