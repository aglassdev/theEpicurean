...
const Kaiseki = () => (
  <RestaurantPage
    restaurantName="Kaiseki"
    address="77, Merchants Street, Valletta, VLT 1174, Malta"
    cuisine="Mediterranean Cuisine, Asian Influences"
    priceRange="€€"
    phoneNumber="+35679446178"
    website="https://www.kaiseki.mt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you find yourself on one of the Mediterranean’s most beautiful islands and craving Mediterranean–Asian fusion cuisine, head to Noel Azzopardi’s Kaiseki. This basement restaurant sports a cosy, welcoming vibe, and the chef-owner, working alongside youthful Mark Zammit, crafts intriguing dishes such as cauliflower and goat’s cheese risotto with crunchy sunflower kernels, Iberico pork with glazed, tender meat, Japanese fried rice with char-siu and fried egg, and excellent desserts like an exotic mille-feuille with yuzu and white chocolate. Last, but not least, the informal, relaxed vibe adds a final flourish to this enjoyable experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%2C%20Merchants%20Street%2C%20Valletta%2C%20VLT%201174%2C%20Malta"
    pageTitle="Kaiseki"
  />
);
