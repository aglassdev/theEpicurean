...
const 59Republic = () => (
  <RestaurantPage
    restaurantName="59 Republic"
    address="St George's Square, Valletta, VLT 1190, Malta"
    cuisine="Classic Cuisine, International"
    priceRange="€€€"
    phoneNumber="+35679264613"
    website="https://www.fiftyninerepublic.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You can’t get more central than Fifty-nine Republic, bang in St. George’s Square, facing the Grandmaster's Palace, with a terrace for alfresco dining in the warm season (which lasts almost all year in Malta). The handsome indoor dining room, dotted with pink details (the house signature colour), is reached down a short but steep flight of stairs. The cuisine embraces international flavours and showcases top-drawer ingredients like wagyu beef, gyoza-style ravioli stuffed in lobster and Scottish scallops. And when it comes to dessert, we wholeheartedly suggest what has become an iconic extravaganza: dark chocolate and caramel mousse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=St%20George's%20Square%2C%20Valletta%2C%20VLT%201190%2C%20Malta"
    pageTitle="59 Republic"
  />
);

export default 59Republic;
