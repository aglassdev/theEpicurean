...
const KappoHarada = () => (
  <RestaurantPage
    restaurantName="Kappo Harada"
    address="290 Hokodencho, Nakagyo-ku, Kyoto, 604-0902, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752135890"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kappo-harada"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taught in the ways of old-school Japanese cooking, the owner-chef calls himself ‘a craftsman of the Showa years’. This shows in his honest, no-nonsense fare. Spring bamboo shoots join sea bream roe, simmered separately but served together; summer pike conger is paired with water shield in soup dishes; autumn matsutake mushrooms are cooked along with rice; in winter, enjoy fried dumplings made from Kyoto yam. Indicate your preferences and the chef is happy to make impromptu adjustments. Enjoy à la carte or omakase set meals as the spirit moves you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=290%20Hokodencho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0902%2C%20Japan"
    pageTitle="Kappo Harada"
  />
);

export default KappoHarada;
