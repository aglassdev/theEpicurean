...
const Coppie = () => (
  <RestaurantPage
    restaurantName="COPPIE"
    address="367 Takatsuji Inokumacho, Shimogyo-ku, Kyoto, 600-8353, Japan"
    cuisine="Contemporary"
    priceRange="¥¥"
    phoneNumber="+81753666666"
    website="https://www.instagram.com/coppie.kyoto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The aproned staff greet arriving guests as if welcoming friends into their home. The nostalgic interior of this old Japanese-style house oozes serenity. The concept is fare that complements sake and wine. The chef, not binding himself to any genre, serves up an imaginative medley of Japanese, Chinese, Western and ethnic influences. Using fermentation to impart flavour and tartness is the chef’s forte. Enjoy pairing innovative cuisine with compatible sakes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=367%20Takatsuji%20Inokumacho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8353%2C%20Japan"
    pageTitle="COPPIE"
  />
);

export default Coppie;
