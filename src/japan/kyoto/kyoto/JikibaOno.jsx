...
const JikibaOno = () => (
  <RestaurantPage
    restaurantName="Jikiba Ono"
    address="2-267 Miyagawasuji, Higashiyama-ku, Kyoto, 605-0801, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81755553018"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/jikiba-ono"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Jikiba’ is the name of the region in Amakusa, Kumamoto, where the chef was born. Attesting to the richness of the seas of Kyūshū, seafood is sourced from local waters and from the Bungo Channel. To bring out the goodness, seasoning is minimal. Appetisers, decoratively arranged sashimi and soup dishes are all decided by the chef, out of a determination to impart the flavours of the season. After these, grilled and stewed items can be selected from the menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-267%20Miyagawasuji%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0801%2C%20Japan"
    pageTitle="Jikiba Ono"
  />
);

export default JikibaOno;
