...
const RakuhokuNakayama = () => (
  <RestaurantPage
    restaurantName="Rakuhoku Nakayama"
    address="77, Kamigamo Sakuraicho, Kita-ku, Kyoto, 603-8054, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81756065188"
    website="https://www.rakuhoku-nakayama.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An omakase Japanese restaurant noted for its tempura. Appetiser platters, wanmono and simmered vegetable assortments all display a mastery honed at an Okazaki ryotei. Tempura is fried in cottonseed oil for a light presentation. For mixed rice, the house uses hill-grown rice grown by the proprietress’ family. Their love helps lift up the restaurant, with a photo of their rice terraces hanging in the interior. At lunchtime, bento comes in double-tiered carrying boxes accompanied by tempura...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=77%2C%20Kamigamo%20Sakuraicho%2C%20Kita-ku%2C%20Kyoto%2C%20603-8054%2C%20Japan"
    pageTitle="Rakuhoku Nakayama"
  />
);

export default RakuhokuNakayama;
