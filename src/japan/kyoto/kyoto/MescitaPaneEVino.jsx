...
const MescitaPaneEVino = () => (
  <RestaurantPage
    restaurantName="Mescita Pane e Vino"
    address="277 Tenjinyamacho, Nakagyo-ku, Kyoto, 604-8221, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81752023783"
    website="https://tabelog.com/kyoto/A2601/A260203/26025955/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Mescita’ is an old Tuscan word for a bar or tavern. Come here to try the steak of aged beef and organic wine. The chef sources rump, aitchbone and rib roast, which he chargrills in the Florentine style. Seasoning is restricted to salt and pepper and portions start at 200g. Order appetisers to tide you over while the beef is grilled slowly. If you still have room, the pastas are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=277%20Tenjinyamacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8221%2C%20Japan"
    pageTitle="Mescita Pane e Vino"
  />
);

export default MescitaPaneEVino;
