...
const JukuseibutaKawamura = () => (
  <RestaurantPage
    restaurantName="Jukuseibuta Kawamura"
    address="57-1 Takehana Nishinoguchicho, Yamashina-ku, Kyoto, 607-8089, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81755950295"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/jukuseibuta-kawamura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The nation’s finest pork brands cascade across the menu, so you can choose the type and grade of pork that suits you best. The best is the ‘jukusei-buta’ aged pork that gives the shop its name. Sourced from a butcher in Fushimi, the pork this restaurant handles is rested to enhance its flavour. The plaque on the wall says, ‘Timing is everything’; the pork is deep-fried twice in low-temperature oil, the cooking time expertly judged. Pork katsu curry, seasoned with ginger and spices, is also tempting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=57-1%20Takehana%20Nishinoguchicho%2C%20Yamashina-ku%2C%20Kyoto%2C%20607-8089%2C%20Japan"
    pageTitle="Jukuseibuta Kawamura"
  />
);

export default JukuseibutaKawamura;
