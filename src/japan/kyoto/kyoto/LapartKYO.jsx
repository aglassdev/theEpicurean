...
const LapartKYO = () => (
  <RestaurantPage
    ...
    address="247-3 Nishiwakamatsucho, Shimogyo-ku, Kyoto, 600-8334, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+815031837676"
    website="https://laparte.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L’aparté serves modern French cuisine by Anthony Bâcle, who has travelled the world. Using Japanese ingredients and French methods, Bâcle conjures an eclectic blend of both cuisines, creating harmony with numerous ingredients such as bean-curd skin, miso and nori seaweed. Loire wines are stocked in homage to his native region...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=247-3%20Nishiwakamatsucho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8334%2C%20Japan"
    pageTitle="L'aparté"
  />
);

export default LapartKYO;
