...
const KyoryoriHachisei = () => (
  <RestaurantPage
    restaurantName="Kyoryori Hachisei"
    address="15-2 Chudoji Maedacho, Shimogyo-ku, Kyoto, 600-8804, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752853645"
    website="https://www.hatisei.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Akiyuki Hasegawa learned from his mentor that good cooking comes from sincerity. His devotion to great dining is what sends him to the market every morning to check the ingredients. He constantly tinkers with his menu to ensure that guests can enjoy his fare no matter how many times they come. The appetisers are just as how his mentor prepared them. Meals end with takikomi-gohan (rice cooked together with other ingredients) because he loves its colourful appearance when he lifts the lid...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15-2%20Chudoji%20Maedacho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8804%2C%20Japan"
    pageTitle="Kyoryori Hachisei"
  />
);

export default KyoryoriHachisei;
