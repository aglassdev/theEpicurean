...
const OryoriMashita = () => (
  <RestaurantPage
    restaurantName="Oryori Mashita"
    address="246 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755252160"
    website="http://kyoto-mashita.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A small shop curtain flutters along the Gion shopping street. Walk along the cobblestones sprinkled with water to a quiet location where you soon forget the noise of the high street. Seasonal ingredients and dining-ware weave together the beauty of Japanese cuisine. The menu of items connected to Japan’s festivals and ceremonies is part and parcel of Japanese culture. The sincerity behind everything from the appetiser to the tea puts the mind at ease, allowing diners to fully enjoy the flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=246%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Oryori Mashita"
  />
);

export default OryoriMashita;
