...
const KyogokuKaneyo = () => (
  <RestaurantPage
    restaurantName="Kyogoku Kaneyo"
    address="456 Matsugaecho, Nakagyo-ku, Kyoto, 604-8034, Japan"
    cuisine="Unagi / Freshwater Eel"
    priceRange="¥"
    phoneNumber="+81752210669"
    website="https://kyogoku-kaneyo.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This eel restaurant has been in business for seven generations, dating back to the Meiji period. Every day finds the shop crowded with customers, many seeking its signature dish of ‘Kinshi Don’: rice covered in dipping sauce and topped with Edo-style eel and a large Kyoto-style omelette. What makes this east-west marriage of flavours work so well is the dipping sauce, a staple since the restaurant’s inception. The Kanto-style kabayaki, which involves steaming eel before grilling and dipping it in sauce, is a technique from a cook recruited from Tokyo during the founder’s generation. In both looks and taste, Kyogoku Kaneyo bears traces of Japan’s east and west...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=456%20Matsugaecho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8034%2C%20Japan"
    pageTitle="Kyogoku Kaneyo"
  />
);

export default KyogokuKaneyo;
