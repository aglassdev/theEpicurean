...
const CantonShunsaiIkki = () => (
  <RestaurantPage
    restaurantName="Canton Shunsai Ikki"
    address="17-5 Tsukimicho, Higashiyama-ku, Kyoto, 605-0829, Japan"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+81757441947"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/canton-shunsai-ikki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant holds its own niche in Chinese cuisine. The talents of the Guangdong-trained chef are on full display. Guangdong is blessed with the bounty of sea, mountain and river, as is Kyoto, and the light flavour of its cuisine, which draws out the flavour of the ingredients, work well with the food culture of the ancient capital. Shrimp wontons are dressed with Hong Kong soy sauce, Cantonese fried rice is accented with lettuce and roast pork...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17-5%20Tsukimicho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0829%2C%20Japan"
    pageTitle="Canton Shunsai Ikki"
  />
);

export default CantonShunsaiIkki;
