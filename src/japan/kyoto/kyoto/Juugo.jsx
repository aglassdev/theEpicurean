...
const Juugo = () => (
  <RestaurantPage
    restaurantName="Juu-go"
    address="71-6 Jodoji Kamiminamidacho, Sakyo-ku, Kyoto, 606-8405, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81757085367"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/juu-go"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Akiya Ishibashi tills the field, harvests the grain, kneads the buckwheat. The chef’s passion for soba permeates a menu consisting purely of soba and soba mash. ‘Think of it as cereal’, he says of his dishes rich in rustic goodness. Soba is deliciously fragrant, thick-cut and al dente. Soba mash, served with roasted buckwheat grains, is delightfully pungent. To enjoy the pure flavour of Ishibashi’s soba, try it first on its own, without seasoning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=71-6%20Jodoji%20Kamiminamidacho%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-8405%2C%20Japan"
    pageTitle="Juu-go"
  />
);

export default Juugo;
