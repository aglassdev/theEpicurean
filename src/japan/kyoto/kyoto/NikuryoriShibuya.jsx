...
const NikuryoriShibuya = () => (
  <RestaurantPage
    restaurantName="Nikuryori Shibuya"
    address="193-1 Nishikodocho, Nakagyo-ku, Kyoto, 604-0904, Japan"
    cuisine="Beef"
    priceRange="¥¥¥"
    phoneNumber="+81752218588"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/nikuryori-shibuya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef has been in the wagyu business for over half a century. He does not favour any particular region, prizing quality over brand. The menu starts with items that take full advantage of the freshness of their ingredients, such as tongue and heart. Parboiled tripe is followed by Yanagawa-style sirloin. It’s omakase, but customers can add items from the menu. The old-fashioned townhouse seems the perfect ambience for immersing in the world of wagyu. The banter between the kitchen craftsman father and the amiable hostess daughter is heartwarming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=193-1%20Nishikodocho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0904%2C%20Japan"
    pageTitle="Nikuryori Shibuya"
  />
);

export default NikuryoriShibuya;
