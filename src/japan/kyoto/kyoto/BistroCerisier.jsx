...
const BistroCerisier = () => (
  <RestaurantPage
    restaurantName="Bistro Cerisier"
    address="1-3 Tanaka Shimoyanagicho, Sakyo-ku, Kyoto, 606-8204, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81757235564"
    website="https://bistrocerisier.studio.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="French ballads warble through a retro interior, recalling the good old days. Regional cuisines such as quenelles from Lyon and cassoulet from Languedoc spill across the menu. Old-school recipes, like white asparagus with Hollandaise sauce in spring and salmis of roast mallard, bring comfort to the soul. Respect for sauces testifies to the commitment to the essence of French cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3%20Tanaka%20Shimoyanagicho%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-8204%2C%20Japan"
    pageTitle="Bistro Cerisier"
  />
);

export default BistroCerisier;
