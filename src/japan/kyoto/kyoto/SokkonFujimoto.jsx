...
const SokkonFujimoto = () => (
  <RestaurantPage
    restaurantName="Sokkon Fujimoto"
    address="580-1 Matsumotocho, Nakagyo-ku, Kyoto, 604-0982, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81757082851"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/sokkon-fujimoto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sokkon is a Zen term denoting ‘treasuring the present moment’. By so naming his restaurant, the chef professes his devotion to serving delicious flavours fresh from the kitchen. He devotes himself to the tea ceremony, flower arrangement and calligraphy to hone his aesthetic sense and sensitivity. Annual events in the ancient capital are woven throughout his menu, conveying venerable cultural traditions. Rice is available either seasoned with assorted ingredients or topped, doubling the flavour elements to satisfy stomach and palate. An extensive array of offerings expresses the spirit of graceful service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=580-1%20Matsumotocho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0982%2C%20Japan"
    pageTitle="Sokkon Fujimoto"
  />
);

export default SokkonFujimoto;
