...
const PontochoMasuda = () => (
  <RestaurantPage
    restaurantName="Pontocho Masuda"
    address="200 Shimokorikicho, Nakagyo-ku, Kyoto, 604-8016, Japan"
    cuisine="Obanzai"
    priceRange="¥¥"
    phoneNumber="+81752216816"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/pontocho-masuda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mood is the Showa era, when Pontocho was a much sleepier place. Two generations, father and son, man the kitchen, displaying their talents in ryotei cooking. ‘Obanzai’, a style of cooking beloved by Kyoto families, exudes the warmth and familiarity of the good old days. Side dishes are simply simmered and unadorned: okara (soy pulp), hijiki (black seaweed), nishin-nasu (Pacific herring with eggplant). Grilled seafood and seasonal stews are popular. ‘Daimyotaki’, dried daikon pickled and simmered in dashi, was born of the wisdom of previous generations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=200%20Shimokorikicho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8016%2C%20Japan"
    pageTitle="Pontocho Masuda"
  />
);

export default PontochoMasuda;
