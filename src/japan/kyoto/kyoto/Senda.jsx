...
const Senda = () => (
  <RestaurantPage
    restaurantName="Senda"
    address="1038-16 Kamiyagawacho, Kamigyo-ku, Kyoto, 602-8384, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81753660953"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/senda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ryuji Senda’s parents ran an eel restaurant in Fukui. Having helped with the family business from a young age, the path of a chef came naturally to him, and he made his way to Kyoto as his father and elder brother had apprenticed there. At dinner the pièce de resistance is the elegant appetiser. Senda learned from his mentors such points as how to use fresh ingredients in season and the origins and meanings of arrangements. The eel kabayaki, basted with sauce from the family recipe before broiling, is not to be missed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1038-16%20Kamiyagawacho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-8384%2C%20Japan"
    pageTitle="Senda"
  />
);
