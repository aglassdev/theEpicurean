...
const GionNishimura = () => (
  <RestaurantPage
    restaurantName="Gion Nishimura"
    address="570-160 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755252727"
    website="https://www.gion-nishimura.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The aim of this chef is to serve cuisine that is simple in appearance but makes a lasting impression. He places great store by elements the customer never sees, such as dashi combinations and knife techniques. In the eel and rolled omelette dressed in starchy sauce, for example, he creates synergistic effects by varying the dashi used for the omelette and the sauce. For the assortment of simmered vegetables, each vegetable is cut in a unique way, adding up to a harmonious whole. Customer demand has made the unforgettable sesame tofu and mackerel sushi standard dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-160%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Gion Nishimura"
  />
);

export default GionNishimura;
