...
const RestaurantHiramatsuKodaiji = () => (
  <RestaurantPage
    restaurantName="Hiramatsu Kodaiji"
    address="353 Masuyacho, Higashiyama-ku, Kyoto, 605-0826, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81755336063"
    website="https://www.hiramatsurestaurant.jp/hiramatsu-kodaiji/"
    aliases={["Restaurant Hiramatsu Kodaiji"]}
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Elegant dining with a view of Yasaka Pagoda. The cuisine is authentic French, crafted with classic techniques and sauces. Emphasis is on ingredients from Kyotanba, hewing close to the producers and topography of that township. Herbs plucked from the family garden add grace notes to flavours; French ingredients such as caviar and truffles bring refinement to the mix. Arrangements are as pretty as oil paintings, making the cuisine truly bright and beautiful...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=353%20Masuyacho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0826%2C%20Japan"
    pageTitle="Hiramatsu Kodaiji"
  />
);

export default RestaurantHiramatsuKodaiji;
