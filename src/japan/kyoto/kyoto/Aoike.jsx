...
const Aoike = () => (
  <RestaurantPage
    restaurantName="Aoike"
    address="631 Heinouchicho, Nakagyo-ku, Kyoto, 604-0884, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81752043970"
    website="http://aoike-kyoto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The star ingredients are vegetables from Kamigamo. Every morning the chef harvests them himself from his garden, and that’s when the process of imagining his creations begins. A classic example is the pressed vegetables; this dish is full of colourful vegetables, as if drawing a picture of a vegetable garden. Mushrooms and root vegetables are transformed into mousses and thick soups, bringing the bounty of the good earth to the table. The interior was crafted by the chef’s father-in-law, a sukiya carpenter. Mosaic-studded counter and Scandinavian chairs combine for a distinctly modern atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=631%20Heinouchicho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0884%2C%20Japan"
    pageTitle="Aoike"
  />
);

export default Aoike;
