...
const Totoyoshi = () => (
  <RestaurantPage
    restaurantName="Totoyoshi"
    address="666 Kanrocho, Nakagyo-ku, Kyoto, 604-0994, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757416434"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/totoyoshi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A kappo consisting of a counter in an atrium. The chef pours his skill into creations using seafood sourced from and carefully selected by his family’s fish shop. The menu offers a huge selection of dishes, encouraging you to try a variety of flavours. Portions are just right for enjoying with a tipple. Fried items are served lovingly one by one, as in a tempura restaurant. Onigiri and miso soup close out the meal, to warm you up on your way out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=666%20Kanrocho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0994%2C%20Japan"
    pageTitle="Totoyoshi"
  />
);

export default Totoyoshi;
