...
const KoryoriTakaya = () => (
  <RestaurantPage
    restaurantName="Koryori Takaya"
    address="165 Nishisakaicho, Shimogyo-ku, Kyoto, 600-8218, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81753655159"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/koryori-takaya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The charm of Koryori Takaya is that it’s a kappo, but with the comfortable familiarity of a neighbourhood eatery. Freshly cooked dishes and smiling conversation put diners in a good mood. For lunch, set meals with a variety of small side dishes are served; in the evening, the chef displays his talent with omakase, concluding with rice in earthenware pots and accompaniments. A choice of pickled tuna, grilled fish or sukiyaki makes the end of the evening fun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=165%20Nishisakaicho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8218%2C%20Japan"
    pageTitle="Koryori Takaya"
  />
);

export default KoryoriTakaya;
