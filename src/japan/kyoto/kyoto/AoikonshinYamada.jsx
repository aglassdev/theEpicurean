...
const AoikonshinYamada = () => (
  <RestaurantPage
    restaurantName="Aoikonshin Yamada"
    address="12-1 Shimogamo Nishihommachi, Sakyo-ku, Kyoto, 606-0826, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81756065729"
    website="https://www.aoikonshinyamada.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef makes the extra effort to offer gorgeous presentations of elaborately prepared cuisine. The menu, which begins with a hassun appetiser, conveys a joyous love for the seasons. In sweetfish season, come for the rock garden platter. A clear stream and waterfall are drawn in salt on a black lacquer panel. The sweetfish on the platter is posed as if swimming upstream as mist rises from the spray of the waterfall, recalling the natural beauty of the valleys surrounding Kyoto. The scene imparts cooling thoughts as you dine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12-1%20Shimogamo%20Nishihommachi%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-0826%2C%20Japan"
    pageTitle="Aoikonshin Yamada"
  />
);

export default AoikonshinYamada;
