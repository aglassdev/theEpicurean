...
const BistroYanagihara = () => (
  <RestaurantPage
    restaurantName="Bistro Yanagihara"
    address="358 Shimizucho, Nakagyo-ku, Kyoto, 604-0911, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81752317295"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/bistro-yanagihara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bistro by a chef who apprenticed in Alsace. For appetisers, he showcases his skills with choucroute of salt-pickled fermented cabbage, confit of foie gras and charcuterie of ham and sausages. His main dishes are prepared with no less care: items such as beef simmered in red wine and pâté grilled in a pastry shell have their flavours drawn out over time. Hearty portions ensure a full stomach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=358%20Shimizucho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0911%2C%20Japan"
    pageTitle="Bistro Yanagihara"
  />
);

export default BistroYanagihara;
