...
const Kiyama = () => (
  <RestaurantPage
    restaurantName="Kiyama"
    address="136 Kinuyacho, Nakagyo-ku, Kyoto, 604-0804, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81752564460"
    website="https://kiyama-kyoto.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=136%20Kinuyacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0804%2C%20Japan"
    pageTitle="Kiyama"
  />
);

export default Kiyama;
