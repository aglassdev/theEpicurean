...
const OryoriMitsuyasu = () => (
  <RestaurantPage
    restaurantName="Oryori Mitsuyasu"
    address="908-12 Koyamacho, Kamigyo-ku, Kyoto, 602-8157, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81753663138"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/oryori-mitsuyasu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The mood of a Kyoto merchant’s townhouse pervades the interior. The chef views a visit to his restaurant as a once-in-a-lifetime experience, so admission is limited to one group per day. Hassun appetisers of vegetables are prepared simply: steamed, fried, or whichever method best brings out the flavours. Buckwheat mash dressed in white miso is a staple final dish harking back to the chef’s days at a soba shop. Each dish uses as few ingredients as possible, so each one leaves an impression...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=908-12%20Koyamacho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-8157%2C%20Japan"
    pageTitle="Oryori Mitsuyasu"
  />
);

export default OryoriMitsuyasu;
