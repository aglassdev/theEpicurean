...
const Otagi = () => (
  <RestaurantPage
    restaurantName="Otagi"
    address="18 Takagamine Tsuchitenjocho, Kita-ku, Kyoto, 603-8465, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81754921771"
    website="https://otagi-kyoto.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The characters on the chopstick band read ‘Otagi’, the old name for the region. Out of devotion to his hometown, Kazuaki Baba built his restaurant on his grandmother’s land. He offers generous amounts of vegetables, grown by childhood friends living nearby. His creed is to take some liberties with tradition without exceeding the bounds of Japanese cuisine. The meal wraps up with hashed beef with rice; though many would regard this dish as Western, the dried bonito dashi soup stock, sake, sugar, miso and other ingredients used to make it are strictly Japanese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18%20Takagamine%20Tsuchitenjocho%2C%20Kita-ku%2C%20Kyoto%2C%20603-8465%2C%20Japan"
    pageTitle="Otagi"
  />
);

export default Otagi;
