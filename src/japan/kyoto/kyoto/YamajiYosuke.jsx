...
const YamajiYosuke = () => (
  <RestaurantPage
    restaurantName="Yamaji Yosuke"
    address="570-151 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81755618001"
    website="https://www.yosukeyamaji.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yamaji Yosuke prizes originality, paying homage to French cuisine while blazing his own trail in gastronomy. Yamaji named his shop after himself to assert that individuality. His apprenticeship in France gave him a precious opportunity to build relationships with chefs from all over the world, learning about the cuisines of Italy, the Middle East, China and more. The squid carbonara recalls a co-creation with a chef in Paris...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-151%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Yamaji Yosuke"
  />
);

export default YamajiYosuke;
