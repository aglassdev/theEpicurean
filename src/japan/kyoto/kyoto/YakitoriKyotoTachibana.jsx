...
const YakitoriKyotoTachibana = () => (
  <RestaurantPage
    restaurantName="Yakitori Kyoto Tachibana"
    address="B1F, 612 Tachibanacho, Nakagyo-ku, Kyoto, 604-0944, Japan"
    cuisine="Yakitori"
    priceRange="¥¥¥"
    phoneNumber="+81757416666"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/yakitori-kyoto-tachibana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tomonori Sakata turned his attention from Japanese cuisine to yakitori when he fell in love with Kyotamba chicken. Many dishes are served wrapped in skin, because of its tenderness and to bring out the flavour of the fat. Unique inspirations from Japanese cuisine include chicken meat marinated in kombu broth and chicken meatballs mixed with takikomi-gohan. In a clever twist, yakitori is served atop vegetables, which absorb flavour from the many types of skewer placed on top of them, then are grilled last...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%20612%20Tachibanacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0944%2C%20Japan"
    pageTitle="Yakitori Kyoto Tachibana"
  />
);

export default YakitoriKyotoTachibana;
