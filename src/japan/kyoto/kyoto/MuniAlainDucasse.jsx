...
const MuniAlainDucasse = () => (
  <RestaurantPage
    restaurantName="MUNI ALAIN DUCASSE"
    address="B1F, MUNI KYOTO, 3 Sagatenryuji Susukinobabacho, Ukyo-ku, Kyoto, 616-8385, Japan"
    cuisine="French"
    priceRange="¥¥¥¥"
    phoneNumber="+81758737771"
    website="https://muni.by-onko-chishin.com/cuisine/cuisine-muni-alain-ducasse/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The artistic sensibilities of Alain Ducasse find synthesis with Kyoto. The contemporary French cuisine marries French ingredients with Japanese ingredients: clams with caviar, bamboo shoots with truffles, lobster and daikon radishes cultivated in the Kyoto area. Sauce is poured at your table, completing the richly aromatic cuisine. Luxurious surroundings, exquisite cuisine and elegant service welcome you to the world of Alain Ducasse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%20MUNI%20KYOTO%2C%203%20Sagatenryuji%20Susukinobabacho%2C%20Ukyo-ku%2C%20Kyoto%2C%20616-8385%2C%20Japan"
    pageTitle="MUNI ALAIN DUCASSE"
  />
);

export default MuniAlainDucasse;
