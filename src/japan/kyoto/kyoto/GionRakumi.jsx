...
const GionRakumi = () => (
  <RestaurantPage
    restaurantName="Gion Rakumi"
    address="570-206 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755313733"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/gion-rakumi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Delicious, fun flavours’ is Gion Rakumi’s motto. The bustling of the amiable young cooks in the kitchen is a pleasing sight. Items are à la carte but no set formula is followed, so there’s no menu. Instead, guests choose ingredients from a wooden box and consult with the chef on preferred ways of preparation. Being a Gion Sasaki-run place, the quality of ingredients is uncompromising. The playfulness of presentation and pub-like joviality make the mood cheerful and lively...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-206%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Gion Rakumi"
  />
);

export default GionRakumi;
