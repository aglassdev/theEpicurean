...
const TokuhaMotonari = () => (
  <RestaurantPage
    restaurantName="Tokuha Motonari"
    address="287-5 Shingoryoguchicho, Kamigyo-ku, Kyoto, 602-0897, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81757087425"
    website="https://motonari-kyoto.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name is a four-character Confucianist proverb urging the pursuit of virtue; two of the characters in the name of the chef, Shinya Matsumoto, are the same as in the proverb. Owing to his experience as a broker in Himi and a fisherman in Noto, Matsumoto sources fish from the Hokuriku region. Unique chargrilled items are a must-try. Fish are placed in a bowl with charcoal to remove moisture and lock in their rich flavour. Ancient techniques beguile with a rustic charm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=287-5%20Shingoryoguchicho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-0897%2C%20Japan"
    pageTitle="Tokuha Motonari"
  />
);

export default TokuhaMotonari;
