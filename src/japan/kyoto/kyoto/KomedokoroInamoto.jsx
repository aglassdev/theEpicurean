...
const KomedokoroInamoto = () => (
  <RestaurantPage
    restaurantName="Komedokoro Inamoto"
    address="534-1 Yawatacho, Shimogyo-ku, Kyoto, 600-8455, Japan"
    cuisine="Izakaya"
    priceRange="¥¥"
    phoneNumber="+818040310178"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/komedokoro-inamoto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The proprietor loves rice, so he named his establishment ‘Komedokoro’, meaning ‘Place of Rice’. Taste the freshly-cooked white rice and you’ll understand why it’s so famous. Dishes are served on small plates, encouraging you to try a variety. Order the platter of side dishes and you’re sure to eat more than intended. The chef sources seafood and citrus fruits from his native Ehime. Sake and nibbles served at this ‘place of rice’ vary by the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=534-1%20Yawatacho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8455%2C%20Japan"
    pageTitle="Komedokoro Inamoto"
  />
);

export default KomedokoroInamoto;
