...
const KyoryoriFujimoto = () => (
  <RestaurantPage
    restaurantName="Kyoryori Fujimoto"
    address="72 Shimmeicho, Nakagyo-ku, Kyoto, 604-8207, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752119105"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kyoryori-fujimoto"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The wisdom of the chef’s mentor and what he learned on countless visits to markets made the restaurant what it is today. His approach is not to season but to let ingredients speak for themselves. Serving a great meal is an act of great effort: taking care of guests and serving graciously. Keen to offer a wide range of flavours, the chef incorporates an extensive list of ingredients. These efforts are rewarded when diners tell him ‘gochiso-sama deshita’ (‘thank you for all your efforts’)...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=72%20Shimmeicho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8207%2C%20Japan"
    pageTitle="Kyoryori Fujimoto"
  />
);

export default KyoryoriFujimoto;
