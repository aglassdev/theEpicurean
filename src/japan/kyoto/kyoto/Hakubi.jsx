...
const Hakubi = () => (
  <RestaurantPage
    restaurantName="hakubi"
    address="481-1 Kiyoicho, Higashiyama-ku, Kyoto, 605-0821, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81755855327"
    website="https://hakubi-kyoto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chinese cuisine with a modern interpretation. Lifting a page from the lavish entertainment of the imperial court, hakubi populates its prix fixe menus with multiple courses of small dishes. Rice vermicelli paired with caviar and chicken wing tips wrapped in foie gras signify cuisine unafraid of incorporating Western elements. Dressings of chilli sauce and mayonnaise for shrimp set up an interesting taste comparison. A whimsical spirit pervades the fare, setting the heart racing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=481-1%20Kiyoicho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0821%2C%20Japan"
    pageTitle="hakubi"
  />
);

export default Hakubi;
