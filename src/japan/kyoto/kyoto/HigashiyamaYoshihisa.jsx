...
const HigashiyamaYoshihisa = () => (
  <RestaurantPage
    restaurantName="Higashiyama Yoshihisa"
    address="422 Myohoimmaekawacho, Higashiyama-ku, Kyoto, 605-0932, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81757481216"
    website="https://www.higashiyama-yosihisa.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef thrives on innovation, embracing the principle of shuhari, the three stages of mastery. First, master the basics of Japanese cuisine; next, be creative and break the mold; finally, set out on your own to blaze a new trail. Building on the popularity of meat dishe, he experiments with using beef tongue as a soup topping. Between courses, he serves smoked cheese paired with a highball. He displays his ingredients dramatically, explaining each with a passion that captivates his guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=422%20Myohoimmaekawacho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0932%2C%20Japan"
    pageTitle="Higashiyama Yoshihisa"
  />
);

export default HigashiyamaYoshihisa;
