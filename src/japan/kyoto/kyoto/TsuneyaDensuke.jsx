...
const TsuneyaDensuke = () => (
  <RestaurantPage
    restaurantName="Tsuneya Densuke"
    address="84 Kannoncho, Nakagyo-ku, Kyoto, 604-0821, Japan"
    cuisine="Izakaya"
    priceRange="¥¥¥"
    phoneNumber="+81752553938"
    website="https://tsuneyadensuke.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu runs to over a hundred dishes. The policy of the restaurant is that every guest can eat what they like, in the quantity they like. Being spoilt for choice is part of the fun. The focus is on fish dishes, prepared in an izakaya style. Tilefish is served grilled or deep-fried; mackerel is marinated and offered as sashimi or roll sushi. À la carte items to accompany sake are a must here, as are beef dishes such as simmered beef with tofu and beef cutlets. A primer on the diversity of Japanese cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=84%20Kannoncho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0821%2C%20Japan"
    pageTitle="Tsuneya Densuke"
  />
);

export default TsuneyaDensuke;
