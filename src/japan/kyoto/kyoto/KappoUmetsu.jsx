...
const KappoUmetsu = () => (
  <RestaurantPage
    restaurantName="Kappo Umetsu"
    address="347-93 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755310929"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kappo-umetsu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kappo Umetsu offers an extensive list of à la carte dishes, the better to entertain diners. In a show of flexibility, staff cater to guests’ preferred preparation method—grilled, simmered, fried and much more. ‘Umetsu’ is the proprietor’s name, but the inclusion of ume, ‘plum’, is significant, as the shop marinates sour pickled apricots to make apricot soy sauce, which it uses to dress parboiled pike conger and beef cutlets. The proprietress in her apron and the finely coordinated service make you feel at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=347-93%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Kappo Umetsu"
  />
);

export default KappoUmetsu;
