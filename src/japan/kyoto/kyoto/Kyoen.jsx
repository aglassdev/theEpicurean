...
const Kyoen = () => (
  <RestaurantPage
    restaurantName="Kyoen"
    address="570-118 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81757441256"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kyoen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Japanese and Italian cuisine in two-part harmony. Prix fixe menus incorporating both styles are the focus, with unique twists thrown in. Soups are mostly traditional Japanese in style, pasta flavours true to Italian roots. To wrap up the meal, rice as well as beef cutlet or curry are served, ensuring a satisfying finish. Appropriately for a menu of Japanese and Western fare, both sake and wine are on offer. A banquet that leaves nothing to be desired...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-118%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Kyoen"
  />
);

export default Kyoen;
