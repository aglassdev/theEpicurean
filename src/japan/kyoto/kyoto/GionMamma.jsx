...
const GionMamma = () => (
  <RestaurantPage
    restaurantName="Gion Mamma"
    address="347-108 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755258567"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/gion-mamma"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The eye settles at once on the big sunken hearth and the pothook hanging from the ceiling. Char-grilled items take pride of place, leaving no doubt as to the shop’s selling point. The owner-chef honed his craft at a traditional restaurant in Gifu, and the influence shows in offerings such as Waragawa sweetfish in summer and mallard and bear in winter. Whatever the item, his aim is to present its true flavours. The cheerful owner-chef devotes himself to gracious service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=347-108%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Gion Mamma"
  />
);

export default GionMamma;
