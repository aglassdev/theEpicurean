...
const RyoriyaMaekawa = () => (
  <RestaurantPage
    restaurantName="Ryoriya Maekawa"
    address="405 Nambacho, Shimogyo-ku, Kyoto, 600-8027, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757440808"
    website="https://ryouriya-maekawa.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Owner-chef Koichi Maekawa’s goal is to present a ‘ryoriya’ (‘cookery’) that reflects his taste and personality, unfettered by established practice. He strives for originality while leaving core tenets of Kyoto cooking intact. In a witty touch that can’t help but make you smile, fried shrimp-shaped and -patterned yam in tomato sauce is dressed with sakura shrimps. The eatery, with its triangular ceiling reminiscent of a houseboat, is wrapped in an amusing air...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=405%20Nambacho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8027%2C%20Japan"
    pageTitle="Ryoriya Maekawa"
  />
);

export default RyoriyaMaekawa;
