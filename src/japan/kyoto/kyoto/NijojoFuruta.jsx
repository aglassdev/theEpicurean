...
const NijojoFuruta = () => (
  <RestaurantPage
    restaurantName="Nijojo Furuta"
    address="371 Furushirocho, Nakagyo-ku, Kyoto, 604-0045, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752548377"
    website="https://www.tablecheck.com/ja/shops/nijyoujyoufuruta/reserve"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef’s menu boasts creativity and variations in tempo. Anticipating toasts with beer or champagne, fried foods are served early. Sashimi is accompanied with generous condiments, in the spirit of a salad. Fish is prepared simply – chargrilled or as sakamushi – to highlight the chef’s skill in selecting choice seafood.  As a proud Shiga Prefecture native, the chef stocks sake from that region and cooks rice grown by his uncle in Hira in clay pots from Shigaraki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=371%20Furushirocho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0045%2C%20Japan"
    pageTitle="Nijojo Furuta"
  />
);

export default NijojoFuruta;
