...
const OsteriaIlCantoDelMaggio = () => (
  <RestaurantPage
    restaurantName="OSTERIA IL CANTO DEL MAGGIO"
    address="512-2 Kikuyacho, Nakagyo-ku, Kyoto, 604-8127, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81752117768"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/osteria-il-canto-del-maggio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An Italian eatery specialising in the flavours of Tuscan cuisine. The name and menu alike are an heirloom from the chef’s apprentice days. Located in the mountains outside Florence, the restaurant where Takashi Tamura learned his trade did not offer fish dishes, so nor does Tamura. Crostini of chicken liver, pappardelle of duck broth, steak à la Florentine: his dishes convey the flavours of Tuscany in homage to where he trained...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=512-2%20Kikuyacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8127%2C%20Japan"
    pageTitle="OSTERIA IL CANTO DEL MAGGIO"
  />
);

export default OsteriaIlCantoDelMaggio;
