...
const GionSenryu = () => (
  <RestaurantPage
    restaurantName="Gion Senryu"
    address="227-3 Nishinocho, Higashiyama-ku, Kyoto, 605-0088, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81755419679"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/gion-senryu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Service consists of tempura and decoratively arranged sashimi in season, with guests’ favoured tempura items added as desired – the relaxation of leaving the menu to the chef combined with the joy of choosing. The head chef is a vegetable expert, so the list of vegetables is extensive. As with wine pairings, sauces are sometimes chosen to suit particular tempura items. Rice is freshly cooked in an earthenware pot. Tendon (rice topped with tempura) and Tencha (rice served in a tea broth often with tempura) can both be enjoyed a little at a time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=227-3%20Nishinocho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0088%2C%20Japan"
    pageTitle="Gion Senryu"
  />
);

export default GionSenryu;
