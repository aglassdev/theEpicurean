...
const Oito = () => (
  <RestaurantPage
    restaurantName="Oito"
    address="253 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Oden"
    priceRange="¥¥"
    phoneNumber="+81755613575"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/oito"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The building, in the style of a townhouse, stands on Kiritoshi Alley in Gion. Portraits of maiko adorn the walls, reinforcing the geisha-district ambience. ‘Lunch Oden’ is the only item on the menu. The owner-chef is mindful of retaining familiar and comforting flavours. Lunch consists of five items of the diner’s choice, accompanied by takikomi-gohan. The choice of oden is up to the customer, but if you choose the popular beef tendon, we recommend pairing it with the tofu or konnyaku...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=253%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Oito"
  />
);
