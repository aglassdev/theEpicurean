...
const SushiRakumi = () => (
  <RestaurantPage
    restaurantName="Sushi Rakumi"
    address="332-6 Miyoshicho, Higashiyama-ku, Kyoto, 605-0081, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+819045663733"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/sushi-rakumi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The scroll, which reads ‘ikkan’ (consistency), appears behind the chef as if worn like a mantle. His experience in sushi and other Japanese cuisines shines in his omakase. Salmon roe is pureed and mixed with vinegared rice like putting a raw egg over rice. Chub mackerel pressed sushi is wrapped in dried gourd strips or perilla leaf and toasted over charcoal. Nigiri are formed with rice vinegar or red vinegar, depending on the topping—adopting the best features of sushi culture from East and West Japan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=332-6%20Miyoshicho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0081%2C%20Japan"
    pageTitle="Sushi Rakumi"
  />
);

export default SushiRakumi;
