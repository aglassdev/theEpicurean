...
const Wakasugi = () => (
  <RestaurantPage
    restaurantName="Wakasugi"
    address="5 Kinugasa Gaidocho, Kita-ku, Kyoto, 603-8372, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81756009256"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/wakasugi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Close to the World Heritage site of Kinkaku-ji Temple, a husband and wife who loved this location opened a counter-style restaurant serving traditional cuisine. Eager to add to the vitality of the region, they aimed to create an eatery where neighbours could gather; more than a Japanese-style pub, but nothing as fancy as a high-class kappo restaurant. The emphasis is on à la carte items because they want to put their customers’ wishes first. Smoked salmon and herring-roe potato salad is standard fare. Lunch is kaiseki multi-course meal style only, so the couple can chat with customers as they serve them...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20Kinugasa%20Gaidocho%2C%20Kita-ku%2C%20Kyoto%2C%20603-8372%2C%20Japan"
    pageTitle="Wakasugi"
  />
);

export default Wakasugi;
