...
const Nakazen = () => (
  <RestaurantPage
    restaurantName="Nakazen"
    address="26 Kitashirakawa Kubotacho, Sakyo-ku, Kyoto, 606-8266, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757087519"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/nakazen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The owner-chef’s mild demeanour puts us at ease. Generous portions are an expression of thanks for coming all the way out to Kitashirakawa. He hails from Ōhara, so that’s where he sources his vegetables. He obtains his seafood in season from Awaji and focuses all his talents on its preparation. Pike conger, offered in early summer, is singed and served on a block of ice for a refreshing presentation. In late autumn the appetiser is a medley of items, celebrating an abundant harvest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Kitashirakawa%20Kubotacho%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-8266%2C%20Japan"
    pageTitle="Nakazen"
  />
);

export default Nakazen;
