...
const KakoOkamoto = () => (
  <RestaurantPage
    restaurantName="Kako Okamoto"
    address="470-4 Tokiwacho, Higashiyama-ku, Kyoto, 605-0874, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755511055"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kako-okamoto"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The draw of Kako Okamoto is fine sake and prized delicacies. Appetisers are served not on a platter but one by one, freshly cooked, to complement the beverage. Spicy pilchard stew with finely chopped bonito flakes keeps the drinks going down easy. The owner-chef, who loves sake above all other drinks, offers pours from an isshobin (1.8 L bottle of sake) as if introducing his own child. Sake can also be ordered by the cup for a fun sake-tasting experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=470-4%20Tokiwacho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0874%2C%20Japan"
    pageTitle="Kako Okamoto"
  />
);

export default KakoOkamoto;
