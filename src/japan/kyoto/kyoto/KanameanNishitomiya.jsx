...
const KanameanNishitomiya = () => (
  <RestaurantPage
    restaurantName="Kanamean Nishitomiya"
    address="562 Honeyanocho, Nakagyo-ku, Kyoto, 604-6084, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81752112411"
    website="https://www.kanamean.co.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Refined traditional multi-course meals fit for a Japanese inn. Guided by the rubric that ‘tradition is just the continuation of innovation’, this is a restaurant that is open to new ideas. The evening begins when the owner-chef guides guests to the kitchen. The head chef makes lively conversation as he prepares the ingredients. He delights in exploring combinations of flavours, such as tuna with caviar and soba with truffles. Dining in a private room in the style of a tea arbor is part of the allure here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=562%20Honeyanocho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-6084%2C%20Japan"
    pageTitle="Kanamean Nishitomiya"
  />
);

export default KanameanNishitomiya;
