...
const KamoryoriTabuchi = () => (
  <RestaurantPage
    restaurantName="Kamoryori Tabuchi"
    address="33 Marutacho, Nakagyo-ku, Kyoto, 604-0077, Japan"
    cuisine="Duck Specialities"
    priceRange="¥¥¥"
    phoneNumber="+815031840339"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kamoryori-tabuchi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant is temporarily closed. It's planned to relocate in autumn. Kamo-ryori means ‘duck specialities’ and that is what this niche restaurant delivers. The shop buys ducks whole, so it can serve a wide variety of cuts. The meal starts with items such as gizzard and liver. Tenderloin is pressed between two sheets of kombu kelp; sirloin is smoked over charcoal, the fat melted into soup stock to heighten flavour. Nothing is wasted—a variety of techniques are applied to get the most out of every duck. The chopstick rests in the shape of a duck are charming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=33%20Marutacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0077%2C%20Japan"
    pageTitle="Kamoryori Tabuchi"
  />
);

export default KamoryoriTabuchi;
