...
const GionYamagishi = () => (
  <RestaurantPage
    restaurantName="Gion Yamagishi"
    address="570-154 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755510701"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/gion-yamagishi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The air of a tea arbour lingers in this kappo. Amid the spare furnishings, the staff take care to provide a comfortable dining experience. In a bid to make Japanese cuisine approachable, in addition to an omakase set meal, à la carte ordering is also available. In the evening, a prix fixe assortment is provided to which à la carte items can be added. At lunch, eager to acquaint guests with its dashi soup stock, the restaurant serves udon using Kujo leek or tofu skin. Appetisers and Kyoto sushi are also included in a welcome addition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-154%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Gion Yamagishi"
  />
);

export default GionYamagishi;
