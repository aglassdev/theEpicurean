...
const Yassan = () => (
  <RestaurantPage
    restaurantName="Yassan"
    address="347 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Beef"
    priceRange="¥¥¥"
    phoneNumber="+81755419666"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/yassan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yassan is a meat kappo of long renown. The shop is busy night after night, filling up as soon as the shop curtain is posted outside. Staff use German as a sort of code, calling tongue ‘Zunge’, heart ‘Herz’, stomach ‘Magen’ and so on. The practice began at a time when many of its regulars were German physicians. ‘Yassan’ is an affectionate contraction of the restaurant’s original owner-chef’s name, ‘Yasuo-san’. Calabashes hang from the rafters around the counter, recalling that Yasuo-san liked sake in these gourds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=347%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Yassan"
  />
);

export default Yassan;
