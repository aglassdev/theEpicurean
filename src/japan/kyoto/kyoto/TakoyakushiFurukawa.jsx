...
const TakoyakushiFurukawa = () => (
  <RestaurantPage
    restaurantName="Takoyakushi Furukawa"
    address="300 Ichirenshacho, Nakagyo-ku, Kyoto, 604-8146, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+818071062486"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/takoyakushi-furukawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="At the entrance is a branch of an izakaya chain, but walk through it to the back to find the sign and shop curtain for Takoyakushi Furukawa. The meal unfolds from the drawing of dashi stock, ensuring that you experience the beguiling aroma and taste of the basic clear stock. The menu is extensive, presenting the flavours of the season a little at a time. The meal wraps up with a rice dish such as white rice, takikomi-gohan or zosui. No effort is spared in expressing passion and pride in each dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=300%20Ichirenshacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8146%2C%20Japan"
    pageTitle="Takoyakushi Furukawa"
  />
);

export default TakoyakushiFurukawa;
