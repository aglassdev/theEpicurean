...
const RyoriyaKanemitsu = () => (
  <RestaurantPage
    restaurantName="Ryoriya Kanemitsu"
    address="368 Shijocho, Shimogyo-ku, Kyoto, 600-8441, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757440265"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/ryoriya-kanemitsu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The beams of a merchant townhouse frame a soaring atrium with table seating. As conversation sparkles around the tables, the chef focuses squarely on his cooking, showing the respect for ingredients he learned as an apprentice. The chef visits farmers in Takagamine and Kamigamo, feeling the seasons in his bones as he carefully selects his veggies. Seafood is char-grilled and garnished with vegetables. Presentation is simple, yet the chef’s unique stamp on the fare is unmistakable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=368%20Shijocho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8441%2C%20Japan"
    pageTitle="Ryoriya Kanemitsu"
  />
);

export default RyoriyaKanemitsu;
