...
const ChikuyuanTaroNoAtsumori = () => (
  <RestaurantPage
    restaurantName="Chikuyuan Taro no Atsumori"
    address="242-12 Yoancho, Kamigyo-ku, Kyoto, 602-8022, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81752562665"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/chikuyuan-taro-no-atsumori"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Soba is medicine’, says the signboard. The restaurant feels soba is so crammed with nutrients that they tout it as yakuzen, ‘medicinal cooking’, and hope that it brings good health. When ground with its husk, buckwheat acquires a dark brown cast and mysterious flavour. Don’t pass up the “Atsumori-soba”, soba boiled fresh and served hot from the pot. Soba water is poured under the bamboo steamer to keep the noodles warm. Hot dipping sauce with lashings of chopped Kujo green onion, egg and wasabi is a distinctive touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=242-12%20Yoancho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-8022%2C%20Japan"
    pageTitle="Chikuyuan Taro no Atsumori"
  />
);

export default ChikuyuanTaroNoAtsumori;
