...
const SansoKyoyamato = () => (
  <RestaurantPage
    restaurantName="Sanso Kyoyamato"
    address="359 Masuyacho, Higashiyama-ku, Kyoto, 605-0826, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81755251555"
    website="https://www.kyoyamato.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="During the short walk from the front gate to the main buildings, guests can appreciate the history of the buildings while feeling the presence of nature. Classic aesthetics pervade the entire site, from the sukiya design of the buildings to the space reflecting seasonal ceremonies and views of the garden. The chef wants every aspect of Sanso Kyoyamato to be beautiful, so he takes special care with the refinement of his food arrangements and their elegant flavours. The painstaking service of the proprietress and hostess is an agreeable presence. Diners will sense a complete work of Japanese art...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=359%20Masuyacho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0826%2C%20Japan"
    pageTitle="Sanso Kyoyamato"
  />
);

export default SansoKyoyamato;
