...
const KappoShinatomi = () => (
  <RestaurantPage
    restaurantName="Kappo Shinatomi"
    address="315-4 Shintomicho, Kamigyo-ku, Kyoto, 602-0875, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81753664736"
    website="https://shinatomi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Keen to earn the affection of locals, the chef named his restaurant after the ancient word for this part of Kyoto. Offerings are determined by customers’ à la carte preferences, the chef’s omakase menus, and how he feels that day. The quality of the seafood Kappo Shinatomi sources is top-notch, so we recommend the sashimi assortment. Boiled greens redolent with bonito stock and stewed dishes warm the soul. The meal ends with sweets prepared by the lady of the house. The couple’s personality is stamped on the ambience of this kappo restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=315-4%20Shintomicho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-0875%2C%20Japan"
    pageTitle="Kappo Shinatomi"
  />
);

export default KappoShinatomi;
