...
const GionOwatari = () => (
  <RestaurantPage
    restaurantName="Gion Owatari"
    address="570-265 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81755515252"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/gion-owatari"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Mahito Owatari’s ready smile and bold demeanour make a lasting impression. He weaves ingredients into a harmonious whole: for example, white asparagus is paired with eggs infused with the aroma of truffles. If it’s a French dish, asparagus is combined with hollandaise sauce; if Italian, Bismarck. Smoked firefly squid is complemented with young pepper leaf jelly for a Japanese treatment. Accenting with the salty tang of caviar imparts a touch of luxury...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-265%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Gion Owatari"
  />
);

export default GionOwatari;
