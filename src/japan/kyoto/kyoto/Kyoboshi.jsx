...
const Kyoboshi = () => (
  <RestaurantPage
    restaurantName="Kyoboshi"
    address="347-92 Giommachi Kitagawa, Higashiyama-ku, Kyoto, 605-0073, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81755512303"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kyoboshi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Kyoboshi serves light-battered tempura unchanged from the day its doors opened in 1947. The recipe features a unique blend of oils, handed down in secret from father to just one son, as well as use of handmade crushed salt to bring out the ingredients. Uniquely, the main ingredients alternate between seafood and vegetables, interspersed with shrimp. The first shrimp is served rare, the second cooked to an intense crescendo. The chef adjusts the flame with practiced skill, modulating the flavour of the shrimp with each serving...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=347-92%20Giommachi%20Kitagawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0073%2C%20Japan"
    pageTitle="Kyoboshi"
  />
);

export default Kyoboshi;
