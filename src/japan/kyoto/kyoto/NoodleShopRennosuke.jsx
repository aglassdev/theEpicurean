...
const NoodleShopRennosuke = () => (
  <RestaurantPage
    restaurantName="NOODLE SHOP RENNOSUKE"
    address="56-32 Murasakino Shimokashiwanocho, Kita-ku, Kyoto, 603-8313, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+819057899499"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/noodle-shop-rennosuke"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The residential neighbourhood is a maze and there’s no sign for the restaurant. A spotlight on a bowl of ramen in a showcase indicates you’ve arrived. The industrial space has the feel of a laboratory. ‘Raamen’ is a blend of Kyoto wheat noodles in a clear soup of seafood dashi stock. Thinly sliced roasted pork fillet is from Kyoto-raised swine. Blue bowls of specially ordered Kiyomizu ware set off each meal to its advantage. Custard pudding, sweetened with refined sugar, is a popular item...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=56-32%20Murasakino%20Shimokashiwanocho%2C%20Kita-ku%2C%20Kyoto%2C%20603-8313%2C%20Japan"
    pageTitle="NOODLE SHOP RENNOSUKE"
  />
);

export default NoodleShopRennosuke;
