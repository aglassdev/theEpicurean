...
const ChineseNoodlesRoku = () => (
  <RestaurantPage
    restaurantName="Chinese Noodles ROKU"
    address="2F, Good Nature Station, 318-6 Inaricho, Shimogyo-ku, Kyoto, 600-8022, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81757085199"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/chinese-noodles-roku"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ramen, soup and other Chinese foods are the soul of this ramen shop by Velrosier. The chef draws soup stock from bones of duck, chicken, venison and pork. Clear soup owes its depth to umami from a medley of dried foods; dried longan fruit, a Chinese medicinal herb, is a touch only a gourmet of Chinese cuisine would think of. The manifold layers of flavour derive from Roku’s ‘add-on’ approach to seasoning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Good%20Nature%20Station%2C%20318-6%20Inaricho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8022%2C%20Japan"
    pageTitle="Chinese Noodles ROKU"
  />
);

export default ChineseNoodlesRoku;
