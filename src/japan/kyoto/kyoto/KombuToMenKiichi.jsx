...
const KombuToMenKiichi = () => (
  <RestaurantPage
    restaurantName="Kombu to Men Kiichi"
    address="2F, 74-2 Nishiitsutsuji Higashimachi, Kamigyo-ku, Kyoto, 602-8478, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+818072277500"
    website="https://itutuji.com/kiichi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant was opened by a kelp shop with a loyal clientele in Nishijin. The deliciousness of kombu dashi is the message here, and ramen is the medium. The meal begins with an introduction to different kinds of kombu: Rishiri, Rausu, makombu. Guests are invited to sample kombu water and shredded tangled kelp. The “Kombu Ramen” is unusual in that no sauce is used in the soup. Every drop of umami is teased from the kombu, to heighten the lingering memory of its flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2074-2%20Nishiitsutsuji%20Higashimachi%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-8478%2C%20Japan"
    pageTitle="Kombu to Men Kiichi"
  />
);

export default KombuToMenKiichi;
