...
const NoguchiTsunagu = () => (
  <RestaurantPage
    restaurantName="Noguchi Tsunagu"
    address="371-4 Kiyomotocho, Higashiyama-ku, Kyoto, 605-0084, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81755613003"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/noguchi-tsunagu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The menu alternates between omakase set menus and à la carte options. The evening begins with a procession of seasonal dishes, accompanied by wagyu stew rather than soup. Choose additional items from the menu or ask for a presentation of the ingredients of the day. White rice and miso soup wrap up the meal. We recommend the deliciousness of freshly cooked rice with accompaniments such as fried fish, fried chicken or braised pork...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=371-4%20Kiyomotocho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0084%2C%20Japan"
    pageTitle="Noguchi Tsunagu"
  />
);

export default NoguchiTsunagu;
