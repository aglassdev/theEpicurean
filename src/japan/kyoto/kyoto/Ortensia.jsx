...
const Ortensia = () => (
  <RestaurantPage
    restaurantName="ortensia"
    address="274 Demizucho, Kamigyo-ku, Kyoto, 602-0862, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81752548776"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/ortensia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef has gained experience in many parts of Italy, but Sicily remains closest to his heart. Pasta made with dried tuna roe, and ‘matalotta’, a stew of whitefish and vegetables, are traditional flavours. To grow a clientele that drops in casually, ortensia is decorated in a burnt-orange tone, recalling the blood oranges of the Mezzogiorno. Familiar items such as clam sauce pasta and spaghetti peperoncino grace the menu as well...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=274%20Demizucho%2C%20Kamigyo-ku%2C%20Kyoto%2C%20602-0862%2C%20Japan"
    pageTitle="ortensia"
  />
);

export default Ortensia;
