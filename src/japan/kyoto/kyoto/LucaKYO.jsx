...
const LucaKYO = () => (
  <RestaurantPage
    restaurantName="Luca"
    address="2F, 585 Takamiyacho, Nakagyo-ku, Kyoto, 604-8056, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81757440981"
    website="https://luca-kyoto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant name comes from lucas, ‘bringer of light’ in Latin, out of chef’s desire to make it a place of bright smiles. He strives to create fare based on the classic French cuisine which so impressed him during his apprenticeship, while keeping the flavours light. Food is served colourfully garnished with vegetables of Kyoto in season. The fare is both creative and richly expressive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20585%20Takamiyacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8056%2C%20Japan"
    pageTitle="Luca"
  />
);

export default LucaKYO;
