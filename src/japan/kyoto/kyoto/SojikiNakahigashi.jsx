...
const SojikiNakahigashi = () => (
  <RestaurantPage
    restaurantName="Sojiki Nakahigashi"
    address="32-3 Jodoji Ishibashicho, Sakyo-ku, Kyoto, 606-8406, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757523500"
    website="https://soujiki-nakahigashi.jp/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Picking wild grasses and flowers, the chef harvests vegetables from the field. His ‘herbivorous cuisine’, conceived in respect and gratitude for food, uses everything and wastes nothing. Appetizer platters, served by his own hand, tell tales about the current season. The main dish is rice cooked in an old-style okudo stove and roasted dried sardines. Written by brush on the wooden tag at the entrance is the instruction is ‘Garnish rice cooked in the okudo stove with char-grilled snacks and wild grasses and flowers’. The chef’s intention when he opened his restaurant pervades his menu today...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32-3%20Jodoji%20Ishibashicho%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-8406%2C%20Japan"
    pageTitle="Sojiki Nakahigashi"
  />
);

export default SojikiNakahigashi;
