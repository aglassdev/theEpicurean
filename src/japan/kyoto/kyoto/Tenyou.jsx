...
const Tenyou = () => (
  <RestaurantPage
    restaurantName="Ten-you"
    address="299 Shimohakusancho, Nakagyo-ku, Kyoto, 604-8085, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81752127778"
    website="https://www.ten-you.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The clean-lined interior was created by a tea-house craftsman. The ground floor has private rooms in a modern Japanese style; the upper floor features counter seating with the chef holding court. Tempura is fried in cottonseed oil for a light texture. The prix fixe menu alternates between seafood and vegetables, ensuring constant variation. In a creative touch, tilefish is wrapped in perilla leaf. The restaurant is managed by a ryokan; in hope that guests will return to dine here even after their stay is over, tendon is offered at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=299%20Shimohakusancho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8085%2C%20Japan"
    pageTitle="Ten-you"
  />
);

export default Tenyou;
