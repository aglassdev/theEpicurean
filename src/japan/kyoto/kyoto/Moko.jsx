...
const Moko = () => (
  <RestaurantPage
    restaurantName="MOKO"
    address="235-2 Tamauecho, Nakagyo-ku, Kyoto, 604-0005, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81752521523"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/moko"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Alexis Moko was born in Versailles and travelled often from his country of birth to London. Though connections brought him to reside in Kyoto, his native language, culture and ingredients are all foreign to the area. It all began when, feeling disheartened, he cycled through Ōhara and encountered food producers who reignited his ambition. Vegetables and game from Ōhara are prepared in traditional fashion. Preserving classical tradition, Moko never forgets to dress his dishes with sauces...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=235-2%20Tamauecho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0005%2C%20Japan"
    pageTitle="MOKO"
  />
);
