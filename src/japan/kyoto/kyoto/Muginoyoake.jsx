...
const Muginoyoake = () => (
  <RestaurantPage
    restaurantName="Muginoyoake"
    address="12-5 Nishishichijo Kakegoshicho, Shimogyo-ku, Kyoto, 600-8881, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/muginoyoake"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef has been researching the deliciousness of ramen since he was a schoolboy. In search of a unique flavour, he made ‘Scallop and Japanese Pepper Ramen’ his signature dish. Soup of dashi drawn from chicken, pork and seafood is multilayered and satisfying. The finished Japanese pepper oil imparts a refreshing feeling, and the generous topping of scallop is pure luxury. A carefully calibrated bowl of goodness that is the gift of repeated independent study...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12-5%20Nishishichijo%20Kakegoshicho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8881%2C%20Japan"
    pageTitle="Muginoyoake"
  />
);

export default Muginoyoake;
