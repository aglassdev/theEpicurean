...
const Tokuo = () => (
  <RestaurantPage
    restaurantName="Tokuo"
    address="151 Tennocho, Shimogyo-ku, Kyoto, 600-8013, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81753513906"
    website="http://tokuwo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To usher in the next generation in kappo culture, Tokuo goes all in on à la carte items. Blanquillo, a staple of Kyoto cuisine, is served year-round: at times flame-grilled, at others deep-fried or as sakamushi (seasoned with sake and salt, then steamed). Duck meat dumplings, a heritage from the chef’s apprenticeship days, are lovingly prepared in homage to his culinary mentor. Rice enveloped in grated yam and bean curd skin has been devised as a treat that goes down easy in the summer months...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=151%20Tennocho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8013%2C%20Japan"
    pageTitle="Tokuo"
  />
);

export default Tokuo;
