...
const OkuniyaMambei = () => (
  <RestaurantPage
    restaurantName="Okuniya Mambei"
    address="534 Kikuyacho, Nakagyo-ku, Kyoto, 604-8127, Japan"
    cuisine="Unagi / Freshwater Eel"
    priceRange="¥¥"
    phoneNumber="+81752552590"
    website="https://manbei.bubu-unagi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef opened Okuniya Mambei as the third-generation owner-chef of a river-fish restaurant in Nishiki Market. He realised his dream with the help of architects, calligraphers and potters. Décor of rustic simplicity, bold and vigorous calligraphy and tricolour earthenware pots exude a unique personality. The menu consists only of large kabayaki on rice. Eel is grilled with the fat intact and served with rice freshly cooked in an earthenware pot. In true Kyoto style, the leftover rice is topped with eel tsukudani (a preserve using sweetened soy sauce) and hojicha (roasted green tea) is poured over it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=534%20Kikuyacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8127%2C%20Japan"
    pageTitle="Okuniya Mambei"
  />
);

export default OkuniyaMambei;
