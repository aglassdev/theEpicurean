...
const FunaokayamaShimizu = () => (
  <RestaurantPage
    restaurantName="Funaokayama Shimizu"
    address="20-2 Murasakino Higashifunaokacho, Kita-ku, Kyoto, 603-8228, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752863373"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/funaokayama-shimizu"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=20-2%20Murasakino%20Higashifunaokacho%2C%20Kita-ku%2C%20Kyoto%2C%20603-8228%2C%20Japan"
    pageTitle="Funaokayama Shimizu"
  />
);

export default FunaokayamaShimizu;
