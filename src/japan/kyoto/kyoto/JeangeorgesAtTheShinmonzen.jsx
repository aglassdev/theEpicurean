...
const JeangeorgesAtTheShinmonzen = () => (
  <RestaurantPage
    restaurantName="Jean-Georges at The Shinmonzen"
    address="1F, The Shinmonzen, 235 Nishinocho, Higashiyama-ku, Kyoto, 605-0088, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81756002055"
    website="https://theshinmonzen.com/jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Contemporary French cuisine that welcomes influences from other culinary cultures. The chef, Jean-Georges Vongerichten, proclaims to the world a borderless cuisine born of his experience living in Asia. Recipes come straight from the flagship restaurant in New York. Spices and herbs accentuate the aroma; the tartness of citrus brings a light note. In the warmer months when the terrace is open, the tables beside the Shirakawa River, with their views of Kyoto scenery, fill up fast...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20The%20Shinmonzen%2C%20235%20Nishinocho%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0088%2C%20Japan"
    pageTitle="Jean-Georges at The Shinmonzen"
  />
);

export default JeangeorgesAtTheShinmonzen;
