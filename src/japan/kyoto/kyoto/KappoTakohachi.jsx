...
const KappoTakohachi = () => (
  <RestaurantPage
    restaurantName="Kappo Takohachi"
    address="498 Higashigawacho, Nakagyo-ku, Kyoto, 604-8046, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81752312995"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/kappo-takohachi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ambience of mid-20th-century Japan remains along Takoyakushi Street. The cooking is as nostalgic as the shop, both a legacy from the chef’s father. Customers sit shoulder to shoulder while the owner couple work in perfect sync. The intimate space shortens the distance between people, enfolding all present in a harmonious mood. On the menu, only ingredients are listed: sea bream, squid, octopus. Ask the chef for that day’s recommendation—all part of the fun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=498%20Higashigawacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-8046%2C%20Japan"
    pageTitle="Kappo Takohachi"
  />
);

export default KappoTakohachi;
