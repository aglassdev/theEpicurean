...
const Yokoi = () => (
  <RestaurantPage
    restaurantName="YOKOI"
    address="88 Manjujinakanocho, Shimogyo-ku, Kyoto, 600-8405, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+815018089510"
    website="https://kyo-yokoi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dreaming of following in the footsteps of his sushi chef father, the chef moved to Kyoto to learn the basics of Japanese cuisine. The welcome with a cup of deep-steamed green tea is a tip of the hat to the chef’s Shizuoka roots. Clasping to heart his father’s maxim that ‘cooking is self-expression’, he expresses himself through goma-ae made with freshly roasted, freshly ground sesame. The calligraphy of the restaurant’s name was written by the chef’s mother; the vessels for sake were crafted by his father...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=88%20Manjujinakanocho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8405%2C%20Japan"
    pageTitle="YOKOI"
  />
);

export default Yokoi;
