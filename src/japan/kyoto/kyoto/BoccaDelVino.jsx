...
const BoccaDelVino = () => (
  <RestaurantPage
    restaurantName="BOCCA del VINO"
    address="138-9 Saitocho, Shimogyo-ku, Kyoto, 600-8012, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81755858267"
    website="https://locare2007.wixsite.com/boccadelvino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The quirky name, ‘mouth of wine’, reflects the chef’s fond memories of Italy, where jugs of wine graced every dinner table. The chef studied in the southern Italy, so recipes are simple, prepared with lashings of tomatoes and olive oil. Seafood features prominently in appetisers, meat and poultry in main dishes, based on the chef’s experiences. Pasta is dressed with the familiar oil, tomatoes and ragu. Comfort food that brings to mind daily life in Italy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=138-9%20Saitocho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8012%2C%20Japan"
    pageTitle="BOCCA del VINO"
  />
);

export default BoccaDelVino;
