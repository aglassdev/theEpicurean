...
const SumiyakisosaitoriyaHitomi = () => (
  <RestaurantPage
    restaurantName="Sumiyakisosaitoriya Hitomi"
    address="96 Okikucho, Sakyo-ku, Kyoto, 606-8376, Japan"
    cuisine="Yakitori"
    priceRange="¥"
    phoneNumber="+81757717818"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/sumiyakisosaitoriya-hitomi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sumiyakisosaitoriya Hitomi is full night after night and the delicious grilled chicken is only one reason for this success. The other is the character of the owner-chef. He stays in guests’ line of sight at all times as he assiduously works the Kishu-binchotan charcoal. He guides his service staff of students with fatherly kindness and makes guests feel like family. The restaurant offers baby chicken, local chicken and brand-name chicken, for their differences in taste and texture. Enjoy devotion and passion in every skewer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=96%20Okikucho%2C%20Sakyo-ku%2C%20Kyoto%2C%20606-8376%2C%20Japan"
    pageTitle="Sumiyakisosaitoriya Hitomi"
  />
);

export default SumiyakisosaitoriyaHitomi;
