...
const MiyagawachoHotta = () => (
  <RestaurantPage
    restaurantName="Miyagawacho Hotta"
    address="6-359-4 Miyagawasuji, Higashiyama-ku, Kyoto, 605-0801, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757548248"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/miyagawacho-hotta"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The look and feel of Old Kyoto permeates Miyagawacho. The owner-chef, who refined his skills in Gion, is also a qualified sommelier and holds a sake diploma, so he is an expert at pairings. While the set meal respects the basics of Japanese cuisine, the owner-chef adds playful details such as Worcestershire sauce in beef cutlet sandwiches. Shaved ice is served in summer; cocktails made from fruit benefit from the owner-chef’s bartending experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-359-4%20Miyagawasuji%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0801%2C%20Japan"
    pageTitle="Miyagawacho Hotta"
  />
);

export default MiyagawachoHotta;
