...
const JikonHiratate = () => (
  <RestaurantPage
    restaurantName="Jikon Hiratate"
    address="352-1 Shoshoiotabicho, Nakagyo-ku, Kyoto, 604-0873, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752212288"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/jikon-hiratate"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fare here isn’t omakase but it isn’t really à la carte either. Instead, in a trend that seems to be growing, a few de rigueur items are supplemented by dishes of the guest’s choice. We recommend the shiraae (salad dressed with white sesame, miso and tofu) in season. Jikon in the restaurant’s name means ‘live with all your heart in this moment’. This is a restaurant that focuses single-mindedly on cuisine, heart and soul...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=352-1%20Shoshoiotabicho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0873%2C%20Japan"
    pageTitle="Jikon Hiratate"
  />
);

export default JikonHiratate;
