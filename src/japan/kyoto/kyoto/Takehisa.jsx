...
const Takehisa = () => (
  <RestaurantPage
    restaurantName="Takehisa"
    address="141-1 Kameyacho, Nakagyo-ku, Kyoto, 604-0865, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752315622"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/takehisa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Takehisa prizes old-school techniques above all. Simmered items such as unripe plum simmered in sugar syrup and herring with eggplant are labours of patient love. Ingredients are prepared to bring out their natural flavours: edible wild plants find their way into tempura, sweetfish is salt-grilled, chestnuts brighten takikomi-gohan. In his early years, the chef was surrounded by the blessings of nature; in tribute to that experience, and to convey the changing seasons, he garnishes his dishes with leaves collected from the mountains...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=141-1%20Kameyacho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0865%2C%20Japan"
    pageTitle="Takehisa"
  />
);

export default Takehisa;
