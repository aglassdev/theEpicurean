...
const MiyagawachoTensho = () => (
  <RestaurantPage
    restaurantName="Miyagawacho Tensho"
    address="4-300-5 Miyagawasuji, Higashiyama-ku, Kyoto, 605-0801, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81757083356"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/miyagawacho-tensho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An omakase feast of tempura and other delights of Japanese cuisine. Guided by his experience at a restaurant with attached inn, the chef starts the meal with sashimi and soup dishes before proceeding to tempura. To bring out their natural aroma, the pieces are lightly battered and deep-fried in pale soy oil. Perennial favourites such as shrimp and whiting are interspersed with creative items like scallops dressed with caviar. Kakiagedon of an all-in-one shrimp and vegetable tempura blend served atop white rice brings down the curtain...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-300-5%20Miyagawasuji%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0801%2C%20Japan"
    pageTitle="Miyagawacho Tensho"
  />
);

export default MiyagawachoTensho;
