...
const ManjujiHakuran = () => (
  <RestaurantPage
    restaurantName="Manjuji Hakuran"
    address="360 Gokuishicho, Shimogyo-ku, Kyoto, 600-8429, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81756064501"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/manjuji-hakuran"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef, a native of the Goto Islands, weaves the flavours of Nagasaki into his prix fixe menus. He beguiles his guests with the fish of his native region, served as sashimi and wanmono. ‘Hatoshi’ is minced shrimp between two slices of crispy fried toast; Goto udon is a beloved local old favourite. With cultivated kappo technique, the chef turns common dishes into pictures of elegance. ‘Hakuran’ is an amalgam of his parents’ names. Sharing the charms of Nagasaki with the diners of Kyoto is an act of gratitude to his hometown...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=360%20Gokuishicho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8429%2C%20Japan"
    pageTitle="Manjuji Hakuran"
  />
);

export default ManjujiHakuran;
