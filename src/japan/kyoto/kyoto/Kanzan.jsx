...
const Kanzan = () => (
  <RestaurantPage
    restaurantName="Kanzan"
    address="465-2 Senshojicho, Shimogyo-ku, Kyoto, 600-8076, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81753537357"
    website="https://kanzan-kyoto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kazuma Yagi learned the spirit of devoted customer service at a succession of high-profile ryotei and ryokan. He thinks about his menus as he visits the fields of Shugakuin Imperial Villa in Kyoto. His vegetable takiawase impart the flavours of the season using the rich aroma of freshly harvested ingredients. The son of an antique store owner in Gion, Yagi also expresses the seasons through the elegant antique vessels on which he presents his dishes. Appetiser platters are served on rafts and baskets made by his own hands. Sincere devotion to details unseen by the eye underpins the cuisine here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=465-2%20Senshojicho%2C%20Shimogyo-ku%2C%20Kyoto%2C%20600-8076%2C%20Japan"
    pageTitle="Kanzan"
  />
);

export default Kanzan;
