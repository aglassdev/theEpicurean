...
const Mirei = () => (
  <RestaurantPage
    restaurantName="Mirei"
    address="143-2 Kameyacho, Takeyamachidori Muromachihigashiiru, Nakagyo-ku, Kyoto, 604-0865, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81752512007"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/mirei-1193056"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The French painter Jean-François Millet was the inspiration behind the restaurant's name—Western culture being a major influence in the owner-chef Yuzo Nakao's hometown of Nagasaki, an international port city for centuries. Recognising that no two people have the same tastes, he welcomes guests with a varied à la carte menu. Make a point of ordering the pureed soup of young onions, peaches, chestnuts and Kyoto yams which bursts with imagination and the colours of the seasons...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=143-2%20Kameyacho%2C%20Takeyamachidori%20Muromachihigashiiru%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0865%2C%20Japan"
    pageTitle="Mirei"
  />
);

export default Mirei;
