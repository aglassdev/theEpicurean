...
const OryoriMaeshiro = () => (
  <RestaurantPage
    restaurantName="Oryori Maeshiro"
    address="234 Owaricho, Nakagyo-ku, Kyoto, 604-0934, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81757481087"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/oryori-maeshiro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the Kyoto dialect, ‘monmona-ryori’ means ‘as it is’. As with ‘kinari-ryori’ in Osaka, fussy over-preparation is avoided. The Osaka-apprenticed chef takes to heart the words of his mentor: ‘light, sweet and deep’, and let the ingredients do the talking. Though the custom at a Kyoto kappo is to do the cooking in the back, here the chef displays all his skills for guests to see...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=234%20Owaricho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0934%2C%20Japan"
    pageTitle="Oryori Maeshiro"
  />
);

export default OryoriMaeshiro;
