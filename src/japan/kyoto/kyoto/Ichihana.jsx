...
const Ichihana = () => (
  <RestaurantPage
    restaurantName="Ichihana"
    address="264-1 Nijo Aburanokojicho, Nakagyo-ku, Kyoto, 604-0051, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81757548827"
    website="https://nijo-ichihana.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A typical lunch offering is sashimi and items served in small bowls, while the evening lineup boasts a full complement of sashimi and items served in rice and cooked individually for each guest. Ten ingredients are always available, with gomoku (‘five ingredients’) and wild plants being perennial favourites. To express the seasons through kamameshi, Ichihana offers flavours like bamboo shoots, sweetfish, mushrooms and oysters. While the rice is cooking, enjoy Kyoto flavours such as steamed wheat gluten with sweet miso sauce and steamed tilefish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=264-1%20Nijo%20Aburanokojicho%2C%20Nakagyo-ku%2C%20Kyoto%2C%20604-0051%2C%20Japan"
    pageTitle="Ichihana"
  />
);

export default Ichihana;
