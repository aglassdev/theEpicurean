...
const SushiKappoNakaichi = () => (
  <RestaurantPage
    restaurantName="Sushi Kappo Nakaichi"
    address="570-196 Giommachi Minamigawa, Higashiyama-ku, Kyoto, 605-0074, Japan"
    cuisine="Japanese, Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81755312778"
    website="https://guide.michelin.com/en/kyoto-region/kyoto/restaurant/sushi-kappo-nakaichi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first-generation chef learned the sushi trade in Tokyo; his son apprenticed in general Japanese cuisine in Kanazawa. Today many restaurants feature both sushi and general Japanese, but this was one of the first. In Kyoto, where new endeavours take a long time to catch on, Sushi Kappo Nakaichi was an immediate hit with the city’s arbiters of taste. Come for the Kyoto cuisine served on elegant vessels collected by father and son and for fish from the Seto Inland Sea...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=570-196%20Giommachi%20Minamigawa%2C%20Higashiyama-ku%2C%20Kyoto%2C%20605-0074%2C%20Japan"
    pageTitle="Sushi Kappo Nakaichi"
  />
);

export default SushiKappoNakaichi;
