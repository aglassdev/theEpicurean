...
const CucinaRegionaleYanagawa = () => (
  <RestaurantPage
    restaurantName="cucina regionale YANAGAWA"
    address="12 Shibatsukinukecho, Nara, Nara, 630-8385, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81742252305"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/cucina-regionale-yanagawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mami Yanagawa has followed the path of Italian cuisine. She enjoyed her cooking classes so much that she became a chef herself. To study Italian gastronomy in its home, Yanagawa travelled to Italy, where she learned the depth and richness of regional variation. Her choice of name for her restaurant, ‘cucina regionale’ (‘hometown cooking’) proclaims the importance she attaches to the network of local and regional producers she has cultivated. Yanagawa links Italy and Nara to showcase the appeal of hometown traditions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12%20Shibatsukinukecho%2C%20Nara%2C%20Nara%2C%20630-8385%2C%20Japan"
    pageTitle="cucina regionale YANAGAWA"
  />
);

export default CucinaRegionaleYanagawa;
