...
const IkeEdoyakiunagiAsahitei = () => (
  <RestaurantPage
    restaurantName="Ike Edoyakiunagi Asahitei"
    address="29 Haibara Shimoidani, Uda, Nara, 633-0241, Japan"
    cuisine="Unagi / Freshwater Eel"
    priceRange="¥¥"
    phoneNumber="+81745820564"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/ike-edoyakiunagi-asahitei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is a saying about the depth of skill an unagi chef needs: three years to learn how to skewer it, eight to learn how to dress it and a lifetime to learn how to grill it. While grilling unagi might be the most difficult, Hideki Morimoto was tasked with it from a young age by his father, the then owner. Edo-style grilling includes steaming beforehand and is something the father learned while training in Tokyo. He buys in mostly large unagi and far-infrared grills it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=29%20Haibara%20Shimoidani%2C%20Uda%2C%20Nara%2C%20633-0241%2C%20Japan"
    pageTitle="Ike Edoyakiunagi Asahitei"
  />
);

export default IkeEdoyakiunagiAsahitei;
