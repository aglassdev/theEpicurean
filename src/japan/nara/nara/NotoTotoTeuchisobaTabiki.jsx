...
const NotoTotoTeuchisobaTabiki = () => (
  <RestaurantPage
    restaurantName="Noto Toto Teuchisoba Tabiki"
    address="1-3-6 Horyuji Nishi, Ikarugacho, Ikoma-gun, Nara, 636-0114, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81745740438"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/noto-toto-teuchisoba-tabiki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Seiji Matsushima grows crops and makes pottery. He doesn’t just knead earth, though, he also kneads soba. The thin juwari soba set out on dishes he made himself exudes rusticity and the way of life of a self-described farmer. He grows the buckwheat berries for the sobagaki himself. Basil picked in the field in the summer is served with soba topped with a thick dashi-rich sauce, and winter yuzu is served with hot soba. Grated daikon is used in place of wasabi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-6%20Horyuji%20Nishi%2C%20Ikarugacho%2C%20Ikoma-gun%2C%20Nara%2C%20636-0114%2C%20Japan"
    pageTitle="Noto Toto Teuchisoba Tabiki"
  />
);

export default NotoTotoTeuchisobaTabiki;
