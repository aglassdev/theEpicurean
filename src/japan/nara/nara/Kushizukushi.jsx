...
const Kushizukushi = () => (
  <RestaurantPage
    restaurantName="Kushizukushi"
    address="31 Yanagimachi, Nara, Nara, 630-8353, Japan"
    cuisine="Kushiage"
    priceRange="¥"
    phoneNumber="+81742230010"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/kushizukushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The creative skewers here feature seasonal ingredients and rare ingredients, such as Japanese glass shrimp in the spring, ayu with roe in the autumn and oysters in winter. Items like vegetables pickled in sake lees and goma-dofu give you the full Nara experience. To end comes nyumen that goes down well or dashi chazuke made with rice grown by the owner-chef’s brother. Each item on the set menu is given an extra touch for texture and flavour, making it a truly appealing set meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=31%20Yanagimachi%2C%20Nara%2C%20Nara%2C%20630-8353%2C%20Japan"
    pageTitle="Kushizukushi"
  />
);

export default Kushizukushi;
