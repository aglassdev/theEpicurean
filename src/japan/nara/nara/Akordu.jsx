...
const Akordu = () => (
  <RestaurantPage
    restaurantName="akordu"
    address="70-1-3-1 Suimoncho, Nara, Nara, 630-8208, Japan"
    cuisine="Innovative"
    priceRange="¥¥¥"
    phoneNumber="+81742772525"
    website="https://akordu.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="‘Akordu’ is Basque for ‘memories’. Chef Hiroshi Kawashima reflects the history of Nara, the story behind each ingredient, and the memories of the diner in his food. A small box sits on the table; inside are several cards, each inscribed with a menu whose poetic style stirs the imagination. Kawashima’s gastronomy is deeply rooted in the land and character of Nara, while modern Spanish cuisine inspires his freewheeling imagination and technique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70-1-3-1%20Suimoncho%2C%20Nara%2C%20Nara%2C%20630-8208%2C%20Japan"
    pageTitle="akordu"
  />
);

export default Akordu;
