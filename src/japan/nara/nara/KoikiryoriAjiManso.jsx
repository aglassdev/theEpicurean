...
const KoikiryoriAjiManso = () => (
  <RestaurantPage
    restaurantName="Koikiryori Aji Manso"
    address="2F, 2-26 Tsurumai Higashimachi, Nara, Nara, 631-0021, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742474966"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/koikiryori-aji-manso"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="For drinkers, a surfeit of bar snacks; for diners, dishes of generous proportions. Koji Nagata, one of Nara’s most accomplished chefs, assembles his omakase set menus with each diner’s preferences in mind. From early summer the house specialises in pike conger; many diners come especially for the pike conger sukiyaki hotpot. Cheerful service adds to the fun. And food isn’t the only draw: works by painters and potters adorn the chic interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-26%20Tsurumai%20Higashimachi%2C%20Nara%2C%20Nara%2C%20631-0021%2C%20Japan"
    pageTitle="Koikiryori Aji Manso"
  />
);

export default KoikiryoriAjiManso;
