...
const Genmaian = () => (
  <RestaurantPage
    restaurantName="GENMAIAN"
    address="1-3-24 Horyuji Higashi, Ikarugacho, Ikoma-gun, Nara, 636-0112, Japan"
    cuisine="Japanese"
    priceRange="¥"
    phoneNumber="+81745741986"
    website="https://r.gnavi.co.jp/5ddegx0k0000/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The meals here are all based on unpolished rice. Vegetable dishes with no meat or fish are served in small pots with unpolished rice that’s been cooked in a wood-fired oven. The owner-chef calls himself a master of unpolished rice cake, his speciality being rice cake made with a mortar and pestle. He wants his customers to get to know tastes that are being lost in an age of plenty, so he seasons his dishes with soy sauce, miso and mirin made using traditional processes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-24%20Horyuji%20Higashi%2C%20Ikarugacho%2C%20Ikoma-gun%2C%20Nara%2C%20636-0112%2C%20Japan"
    pageTitle="GENMAIAN"
  />
);

export default Genmaian;
