...
const BonApptitMeshiagare = () => (
  <RestaurantPage
    restaurantName="Bon appétit Meshiagare"
    address="1 Juriincho, Nara, Nara, 630-8312, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81742275988"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/bon-appetit-meshiagare"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef honed his skills in Paris and other parts of France and uses Nara ingredients to prepare local dishes using traditional techniques he learned there. Seasonal vegetables and fruits come from Gojo City and Soni Village, and he also uses wild game caught in Tsuge. The main appetisers are homemade-style charcuterie, and the main meat dishes are roast and stew. He also incorporates ingredients like ayu and tilefish, sometimes giving the dishes a Japanese touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Juriincho%2C%20Nara%2C%20Nara%2C%20630-8312%2C%20Japan"
    pageTitle="Bon appétit Meshiagare"
  />
);

export default BonApptitMeshiagare;
