...
const Musoan = () => (
  <RestaurantPage
    restaurantName="Musoan"
    address="70-7-1-2 Suimoncho, Nara, Nara, 630-8208, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742230131"
    website="https://naramusouan.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=70-7-1-2%20Suimoncho%2C%20Nara%2C%20Nara%2C%20630-8208%2C%20Japan"
    pageTitle="Musoan"
  />
);

export default Musoan;
