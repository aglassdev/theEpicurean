...
const OryoriHirooka = () => (
  <RestaurantPage
    restaurantName="Oryori Hirooka"
    address="15 Ganrinincho, Nara, Nara, 630-8221, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742955587"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/oryori-hirooka"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The history and culture of Nara, told through the local cuisine. The chef makes a special effort to showcase the ingredients of Gojo, the city of his birth. Vegetables gathered each morning bring freshness and vibrancy to the menu; Hinohikari rice is used to make iimushi or steamed mochi rice with seasonal toppings, and takikomi-gohan, or mixed rice. The dishes, hot and fragrant, are served over a counter of Yoshino cedar. The chef enthusiastically shares the stories behind his creations, to ensure diners get a feeling for the landscape where their food comes from, and the people who grew or raised it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Ganrinincho%2C%20Nara%2C%20Nara%2C%20630-8221%2C%20Japan"
    pageTitle="Oryori Hirooka"
  />
);

export default OryoriHirooka;
