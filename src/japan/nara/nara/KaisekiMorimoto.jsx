...
const KaisekiMorimoto = () => (
  <RestaurantPage
    restaurantName="Kaiseki Morimoto"
    address="1-4-8 Yagicho, Kashihara, Nara, 634-0078, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81744223082"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/kaiseki-morimoto"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef attends to his cooking with the steadfast spirit of a craftsman. He draws encouragement from his father, who cultivates rice and vegetables, and his mother, who helps with the service. ‘Straight from kitchen to table’ is his credo; no-nonsense cooking that brings out the natural goodness of the ingredients. In his soup dishes, he prepares broth with neither salt nor soy sauce, favouring instead the natural saltiness of the ingredients to create harmony. Each item on the extensive menu is prepared with attention to detail and simple arrangements demonstrate his sincere approach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-8%20Yagicho%2C%20Kashihara%2C%20Nara%2C%20634-0078%2C%20Japan"
    pageTitle="Kaiseki Morimoto"
  />
);

export default KaisekiMorimoto;
