...
const SimpleCommeBonjour = () => (
  <RestaurantPage
    restaurantName="Simple comme Bonjour"
    address="68-3 Kawaharajocho, Tenri, Nara, 632-0016, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81743615657"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/simple-comme-bonjour"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kotaro Kawaguchi chose the path of French cuisine, following in the footsteps of his father, who was a cook on a cruise ship. He says that training at Pierre Gagnaire in Paris, a restaurant he had long admired, boosted his morale as a chef. There, he learned the techniques to create harmony between ingredients. There are no standard offerings here, as he is always inspired to offer new creations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=68-3%20Kawaharajocho%2C%20Tenri%2C%20Nara%2C%20632-0016%2C%20Japan"
    pageTitle="Simple comme Bonjour"
  />
);

export default SimpleCommeBonjour;
