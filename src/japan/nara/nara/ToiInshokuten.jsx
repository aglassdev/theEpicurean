...
const ToiInshokuten = () => (
  <RestaurantPage
    restaurantName="toi Inshokuten"
    address="30-3 Hanashibacho, Nara, Nara, 630-8266, Japan"
    cuisine="Indian"
    priceRange="¥"
    phoneNumber="+81742877014"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/toi-inshokuten"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ‘toi’ in the name of the restaurant is an acronym for ‘trip of imagination’. The destination is India, and the mission is to provide traditional Indian dishes. There are meat, fish and vegetable curries. They do things Thali teishoku-style and serve several kinds of curry of your choice on a large plate. You can also add individual items like pakora, an Indian-style tempura...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=30-3%20Hanashibacho%2C%20Nara%2C%20Nara%2C%20630-8266%2C%20Japan"
    pageTitle="toi Inshokuten"
  />
);

export default ToiInshokuten;
