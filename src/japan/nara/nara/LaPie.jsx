...
const LaPie = () => (
  <RestaurantPage
    restaurantName="LA PIE"
    address="15-3 Kasasagicho, Nara, Nara, 630-8391, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81742813170"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/la-pie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Longing to recreate the bustling mood of a Paris bistro, the chef made his dream come true in his native Nara with a restaurant that seems to blend in with the daily life of France. Seafood bouillabaisse, inspired by memories of student days in Montpellier, brings the flavours of the Mediterranean to his hometown. ‘La Pie’ is French for ‘magpie’, a bird said to be a bringer of happiness. The name is also a shout-out to the restaurant’s location, Kasasagi-cho, whose name means ‘Magpie Town’. Happiness brought by delicious cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15-3%20Kasasagicho%2C%20Nara%2C%20Nara%2C%20630-8391%2C%20Japan"
    pageTitle="LA PIE"
  />
);

export default LaPie;
