...
const MasalaAnTakumi = () => (
  <RestaurantPage
    restaurantName="Masala an TAKUMI"
    address="2281 Nakamachi, Nara, Nara, 631-0052, Japan"
    cuisine="Indian"
    priceRange="¥¥"
    phoneNumber="+81742471601"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/masala-an-takumi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As a veteran of the Indian culinary world, Chef Takumi Sakanaka is a master spice artisan. His ‘eclectic Japanese, Western and Indian’ fare is born from his Japanese sensibility and experience with French cuisine. The Masala Hassun appetizer is inspired by traditional kaiseki multi-course meals. Pâté de campagne infused with dry curry and handmade Miwa pasta are true to Nara. As the phrase on the shop curtain says, this is ‘nouvelle cuisine of India’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2281%20Nakamachi%2C%20Nara%2C%20Nara%2C%20631-0052%2C%20Japan"
    pageTitle="Masala an TAKUMI"
  />
);

export default MasalaAnTakumi;
