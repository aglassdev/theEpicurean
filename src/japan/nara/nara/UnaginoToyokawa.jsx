...
const UnaginoToyokawa = () => (
  <RestaurantPage
    restaurantName="Unagino Toyokawa"
    address="3-3-12 Tomio Motomachi, Nara, Nara, 631-0078, Japan"
    cuisine="Unagi / Freshwater Eel"
    priceRange="¥"
    phoneNumber="+81742518171"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/unagino-toyokawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef apprenticed at an unagi restaurant in Osaka after becoming enamoured of the world of unagi artisans. He took the name of his teacher’s restaurant out of gratitude and grills plump ‘aote’ unagi, Kansai-style, over bincho charcoal. There is a saying that when it comes to learning unagi, skewering technique takes three years, dressing it takes eight years and grilling it takes a lifetime to master. As such, he has devoted himself to unagi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-3-12%20Tomio%20Motomachi%2C%20Nara%2C%20Nara%2C%20631-0078%2C%20Japan"
    pageTitle="Unagino Toyokawa"
  />
);

export default UnaginoToyokawa;
