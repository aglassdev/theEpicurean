...
const WaAsuka = () => (
  <RestaurantPage
    restaurantName="Wa Asuka"
    address="4-3-15-2 Tomio Motomachi, Nara, Nara, 631-0078, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742418282"
    website="https://wa-asuka.info/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mitsuru Sakamoto opened his restaurant in Tomio, which appears in the ancient Nihon Shoki (Chronicles of Japan) . Incorporating traditional events such as the five seasonal festivals into the menu and decorating the dishes with seasonal leaves further celebrates the Japanese spirit. Yamato round eggplant is made into takiawase with herring. Yamato beef is grilled slowly over charcoal. The rice is Hinohikari from Asuka Village, from where Sakamoto hails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-3-15-2%20Tomio%20Motomachi%2C%20Nara%2C%20Nara%2C%20631-0078%2C%20Japan"
    pageTitle="Wa Asuka"
  />
);

export default WaAsuka;
