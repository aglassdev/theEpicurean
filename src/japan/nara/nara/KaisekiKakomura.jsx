...
const KaisekiKakomura = () => (
  <RestaurantPage
    restaurantName="Kaiseki Kakomura"
    address="2F, 10 Tsunofurishinyacho, Nara, Nara, 630-8223, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742241070"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/kaiseki-kakomura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inspired by the spirit of chakaiseki, Toshihiko Kakomura set out on the path of Japanese cuisine. He serves traditional kaiseki that pleases both eyes and tastebuds. The hassun always incorporates something seasonally festive and shows off his experience working at a ryotei. The chef is from Hiroshima, so prefers seafood from Setouchi, such as tai and stonefish. Holding dear the spirit of the tea ceremony, he puts care into hospitality, including setting out flowers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2010%20Tsunofurishinyacho%2C%20Nara%2C%20Nara%2C%20630-8223%2C%20Japan"
    pageTitle="Kaiseki Kakomura"
  />
);

export default KaisekiKakomura;
