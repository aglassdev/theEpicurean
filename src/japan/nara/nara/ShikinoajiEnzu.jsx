...
const ShikinoajiEnzu = () => (
  <RestaurantPage
    restaurantName="Shikinoaji Enzu"
    address="6-5-14 Omiyacho, Nara, Nara, 630-8115, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81742360634"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/shikinoaji-enzu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cheerful hospitality of the owner-chef at this kappo will put you at ease. He offers a wide selection of dishes, including tsukuri, tempura and grilled items. He serves several appetisers so you can snack on them while choosing your main dishes. Regular offerings include deep-fried mugwort fu and eggplant with dengaku miso. While not on the menu, sushi can be prepared if requested in advance. The spirit of service he shows makes this a great place to dine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-5-14%20Omiyacho%2C%20Nara%2C%20Nara%2C%20630-8115%2C%20Japan"
    pageTitle="Shikinoaji Enzu"
  />
);

export default ShikinoajiEnzu;
