...
const Nakamuraya = () => (
  <RestaurantPage
    restaurantName="nakamuraya"
    address="8-1 Minamiichicho, Nara, Nara, 630-8373, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81742936577"
    website="https://www.ayarumakan.jp/restaurant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Italy, chef Nakamura learned the importance of traditional food appropriate to the land and climate. He reflects the season with vegetables that come from the Soni Plateau, and in autumn and winter, he procures wild game such as deer and boar from Tsuge. With the set menu, he serves both handmade and dried noodles so you can enjoy the variety. The Genovese made with fresh basil in the summer is a dish that showcases his experience of training in Genoa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8-1%20Minamiichicho%2C%20Nara%2C%20Nara%2C%20630-8373%2C%20Japan"
    pageTitle="nakamuraya"
  />
);

export default Nakamuraya;
