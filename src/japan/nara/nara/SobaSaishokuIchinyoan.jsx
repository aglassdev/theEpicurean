...
const SobaSaishokuIchinyoan = () => (
  <RestaurantPage
    restaurantName="Soba Saishoku Ichinyoan"
    address="1362 Haibara Jimyo, Uda, Nara, 633-0217, Japan"
    cuisine="Soba"
    priceRange="¥¥"
    phoneNumber="+81745820053"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/soba-saishoku-ichinyoan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This old house built at the end of the Edo period is Issei Oketani’s family home. The antiques, chest of drawers and hearth make for a nostalgic air. He serves a set menu featuring soba and vegetables. The appetiser is an assortment of more than a dozen vegetable dishes and is pleasing to the eye as well as the palate. He mills mostly Hitachiaki buckwheat from Ibaraki to make the soba. The quiet location and atmospheric setting will completely refresh you...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1362%20Haibara%20Jimyo%2C%20Uda%2C%20Nara%2C%20633-0217%2C%20Japan"
    pageTitle="Soba Saishoku Ichinyoan"
  />
);

export default SobaSaishokuIchinyoan;
