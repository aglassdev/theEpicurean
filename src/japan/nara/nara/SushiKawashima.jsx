...
const SushiKawashima = () => (
  <RestaurantPage
    restaurantName="Sushi Kawashima"
    address="291-1 Ishikawacho, Kashihara, Nara, 634-0045, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81744351665"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/sushi-kawashima"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Sushi Kawashima pursues its own way in the sushi world, a route that crosses paths with the food culture of Nara. Sashimi is dressed with hishio, a koji-mould and salt-water mixture said to be the origin of soy sauce. Snacks are served with preserved so, a condensed-milk product enjoyed in ancient Japan. Yamato tachibana pepper is a seasoning made from an ancient citrus fruit. Sushi of gizzard shad with persimmon leaf testifies to the chef’s lively imagination. Nigirizushi is formed without wasabi, to bring out the flavours of the topping and sushi rice. Persimmon-leaf tea is a relaxing treat to end the meal—a nice Nara touch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=291-1%20Ishikawacho%2C%20Kashihara%2C%20Nara%2C%20634-0045%2C%20Japan"
    pageTitle="Sushi Kawashima"
  />
);

export default SushiKawashima;
