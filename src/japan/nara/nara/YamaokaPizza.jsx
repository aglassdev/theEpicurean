...
const YamaokaPizza = () => (
  <RestaurantPage
    restaurantName="YAMAOKA PIZZA"
    address="455 Onitoricho, Ikoma, Nara, 630-0237, Japan"
    cuisine="Pizza"
    priceRange="¥"
    phoneNumber="+81743770511"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/yamaoka-pizza"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=455%20Onitoricho%2C%20Ikoma%2C%20Nara%2C%20630-0237%2C%20Japan"
    pageTitle="YAMAOKA PIZZA"
  />
);

export default YamaokaPizza;
