...
const Shungyo = () => (
  <RestaurantPage
    restaurantName="SHUN-GYO"
    address="1-4-12 Omiyacho, Nara, Nara, 630-8115, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81742361011"
    website="https://shungyo.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nara food culture fused with Chinese cuisine; historic ambience paired with time-honoured foodstuffs. ‘So’, a condensed-milk product dating from the Asuka period (592–710 AD), and ‘hishio’, a Nara period (710–784 AD) condiment that uses soybean malt and barley malt, are made by hand. Peking duck, prepared with duck from Gose, showcases the chef’s extensive experience in Beijing cuisine. Seeking new ideas by studying the past, the chef revels in combining Chinese traditions with Western delicacies such as truffles and foie gras...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-12%20Omiyacho%2C%20Nara%2C%20Nara%2C%20630-8115%2C%20Japan"
    pageTitle="SHUN-GYO"
  />
);

export default Shungyo;
