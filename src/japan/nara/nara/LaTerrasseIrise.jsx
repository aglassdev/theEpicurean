...
const LaTerrasseIrise = () => (
  <RestaurantPage
    restaurantName="La Terrasse irisée"
    address="1-34-7 Ayameike Kita, Nara, Nara, 631-0032, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81742400066"
    website="https://laterrasse.jp/irisee/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The elegant dining room overlooking Ayameike pond provides a beautiful view of the sunset. Commanding the kitchen, the chef applies his experiences in Switzerland and France in harmony with Japanese ingredients. His fisherman father helps out by sending him catches from Tottori. The menu is updated monthly, showcasing the season's flavours. The restaurant’s name means ‘iridescent’, ‘rainbow-like’: a rainbow bridge linking Nara and Europe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-34-7%20Ayameike%20Kita%2C%20Nara%2C%20Nara%2C%20631-0032%2C%20Japan"
    pageTitle="La Terrasse irisée"
  />
);

export default LaTerrasseIrise;
