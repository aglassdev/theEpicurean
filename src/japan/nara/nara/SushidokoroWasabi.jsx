...
const SushidokoroWasabi = () => (
  <RestaurantPage
    restaurantName="Sushidokoro WASABI"
    address="39 Hayashikojicho, Nara, Nara, 630-8227, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81742243900"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/sushidokoro-wasabi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Born into a family that owned a sushi restaurant, the owner-chef helped her father out from a young age. The father noticed how drawn she was to sushi artisanry and provided a guiding hand. She was in her element when training and learned the techniques of those who came before. She starts with white-fleshed fish as it has a lighter taste. The restaurant is named after wasabi grown in a clean environment. Likening herself to wasabi, she put down her roots in Yamato...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=39%20Hayashikojicho%2C%20Nara%2C%20Nara%2C%20630-8227%2C%20Japan"
    pageTitle="Sushidokoro WASABI"
  />
);

export default SushidokoroWasabi;
