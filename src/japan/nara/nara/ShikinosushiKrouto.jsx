...
const ShikinosushiKrouto = () => (
  <RestaurantPage
    restaurantName="Shikinosushi KROUTO"
    address="6-9-2 Omiyacho, Nara, Nara, 630-8115, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81742357705"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/shikinosushi-krouto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yutaka Shimonaka uses over 200 different kinds of seafood throughout the year and expresses the season in his sushi. He visits fishing ports in each area and orders seasonal fish. The wide variety of snacks includes sashimi, tempura and assorted shuko. Sushi toppings are prepared in such ways as maturing or pickling them. The rice is made with akazu and rice vinegar, combining the traditions of Edomae and Kansai...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-9-2%20Omiyacho%2C%20Nara%2C%20Nara%2C%20630-8115%2C%20Japan"
    pageTitle="Shikinosushi KROUTO"
  />
);

export default ShikinosushiKrouto;
