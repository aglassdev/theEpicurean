...
const RistoranteLincontro = () => (
  <RestaurantPage
    restaurantName="Ristorante L'incontro"
    address="9 Yakushidocho, Nara, Nara, 630-8321, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81742268959"
    website="https://crocetta.nara.jp/lincontro/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef was inspired by Italian food culture, especially local cuisines. He gathers ingredients from producers in Nara and goes to the mountains to pick wild vegetables and mushrooms himself. He processes meats like uncured ham and salami himself because he wants his customers to experience the homemade taste. The linguini and tagliolini pastas are also made from scratch. He uses simple seasonings to emphasise the natural fragrance of the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Yakushidocho%2C%20Nara%2C%20Nara%2C%20630-8321%2C%20Japan"
    pageTitle="Ristorante L'incontro"
  />
);

export default RistoranteLincontro;
