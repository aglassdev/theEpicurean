...
const LaFormeDternit = () => (
  <RestaurantPage
    restaurantName="la forme d'éternité"
    address="7-2 Hanashibacho, Nara, Nara, 630-8266, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81742206933"
    website="https://www.restaurant-eternite.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In the French countryside, the chef absorbed the love of hometown; in Paris, he learned the importance of the classics. The chef has built relationships of trust with producers and uses local ingredients to convey the richness of Nara’s natural bounty. He sets great store by sauces, from his respect for the classics. His speciality is poached Gojo eggs in red wine sauce. His wife, his constant companion since his apprenticeship, will suggest wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-2%20Hanashibacho%2C%20Nara%2C%20Nara%2C%20630-8266%2C%20Japan"
    pageTitle="la forme d'éternité"
  />
);

export default LaFormeDternit;
