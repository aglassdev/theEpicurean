...
const PizzeriaTrattoriaMagazzino = () => (
  <RestaurantPage
    restaurantName="PIZZERIA TRATTORIA MAGAZZINO"
    address="172-1 Kamada, Kashiba, Nara, 639-0227, Japan"
    cuisine="Pizza"
    priceRange="¥"
    phoneNumber="+81745798815"
    website="https://magazzino.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The pizza here is prepared true to how it’s done in Naples, with chef Hironori Noda reproducing those authentic flavours. What Naples has that Nara doesn’t is an ocean so, in response, he came up with the idea of a restaurant that’s all about the fields. He grows the vegetables himself and makes them the main ingredients. The garden is his mother’s, and he harvests the vegetables himself, meaning that the bounty of Kashiba proffered here truly springs from ‘Mother Earth’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=172-1%20Kamada%2C%20Kashiba%2C%20Nara%2C%20639-0227%2C%20Japan"
    pageTitle="PIZZERIA TRATTORIA MAGAZZINO"
  />
);

export default PizzeriaTrattoriaMagazzino;
