...
const LeBois = () => (
  <RestaurantPage
    restaurantName="Le Bois"
    address="NOBORIOJI HOTEL NARA, 40-1 Noboriojicho, Nara, Nara, 630-8213, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81742252591"
    website="https://www.noborioji.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Nara and Hokkaido are co-stars in this drama of gastronomy. Hokkaido ingredients are used because of the collaboration with French restaurant in Sapporo. Through this interplay of two backgrounds, the charms of Japan's natural bounty come to the fore. Ingredients from Nara take the stage in plates garnished with vegetables and cuisine of amago trout. Seafood and potatoes arrive from the north. As the play unfolds, the diner’s knowledge of food producers and producing regions deepens...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=NOBORIOJI%20HOTEL%20NARA%2C%2040-1%20Noboriojicho%2C%20Nara%2C%20Nara%2C%20630-8213%2C%20Japan"
    pageTitle="Le Bois"
  />
);

export default LeBois;
