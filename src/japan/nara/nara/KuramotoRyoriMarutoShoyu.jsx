...
const KuramotoRyoriMarutoShoyu = () => (
  <RestaurantPage
    restaurantName="Kuramoto Ryori Maruto Shoyu"
    address="170 Iyodo, Tawaramotocho, Shiki-gun, Nara, 636-0243, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81744322064"
    website="https://maruto-shoyu.co.jp/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Japanese restaurant is located in Nara’s oldest soy brewery. The head chef works together with the 18th generation owner and prepares a menu focused on soy sauce and vegetables. Soy sauce is used with everything from the appetisers to the sweets, such as the Miwa somen with soy sauce espuma and takikomi-gohan with unrefined soy powder. The theme is modern Japanese, and some of the dishes draw inspiration from Chinese and French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=170%20Iyodo%2C%20Tawaramotocho%2C%20Shiki-gun%2C%20Nara%2C%20636-0243%2C%20Japan"
    pageTitle="Kuramoto Ryori Maruto Shoyu"
  />
);

export default KuramotoRyoriMarutoShoyu;
