...
const TempuraHattori = () => (
  <RestaurantPage
    restaurantName="Tempura Hattori"
    address="23-1 Omoricho, Nara, Nara, 630-8131, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+815088891215"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/tempura-hattori"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A chef who honed his skills at a ryotei now applies those skills to tempura. The omakase prix fixe meal begins with an assortment of appetisers. Tempura is fried in cottonseed oil for a light and airy texture. The chef’s craftsmanship shines in works such as matsukasa-age, or crispy-scaled fried sea bream, and items cured with kombu. Service alternates between seafood and vegetables, bringing variety to the flow of dishes. Unusual items such as eel and venison are born from the chef’s passion for exploring new flavours. Tencha, tempura on rice with the first brewing of broth poured over, wraps up the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=23-1%20Omoricho%2C%20Nara%2C%20Nara%2C%20630-8131%2C%20Japan"
    pageTitle="Tempura Hattori"
  />
);

export default TempuraHattori;
