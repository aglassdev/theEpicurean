...
const VillaCommunico = () => (
  <RestaurantPage
    restaurantName="VILLA COMMUNICO"
    address="486-5 Zoshicho, Nara, Nara, 630-8211, Japan"
    cuisine="Innovative"
    priceRange="¥¥¥¥"
    phoneNumber="+815031761787"
    website="https://villa-communico.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="An auberge at the foot of Mt Wakakusa. Here, at the epicentre of Nara gastronomy, the bounty of the land is used to its fullest potential. Locations of producers and producing regions are featured on the menu as a sign of respect. Inspired by Mt Wakakusa’s famous ‘burning mountain’, food is cooked over a wood flame, imparting a smoky fragrance while preserving moisture. The name COMMUNICO means ‘understanding each other’ in Italian, a prayer that food creators and diners will find mutual understanding here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=486-5%20Zoshicho%2C%20Nara%2C%20Nara%2C%20630-8211%2C%20Japan"
    pageTitle="VILLA COMMUNICO"
  />
);

export default VillaCommunico;
