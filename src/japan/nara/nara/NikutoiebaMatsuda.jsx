...
const NikutoiebaMatsuda = () => (
  <RestaurantPage
    restaurantName="Nikutoieba Matsuda"
    address="2F, 5-2-40 Naizencho, Kashihara, Nara, 634-0804, Japan"
    cuisine="Beef"
    priceRange="¥¥"
    phoneNumber="+81744240029"
    website="https://nikutoieba.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef, a butcher, prepares wagyu. The set menu meal begins with a bold, hearty meat dish. He uses mostly Yamato beef for his customers to get a feel for Nara ingredients. His creative touches include slicing it thin and pressing it between sheets of kombu and making minced meat into gyoza dumpling. Even the last dish features wagyu, and includes chopped beef and curry. Creative dishes and attractive presentations make this a popular spot...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%205-2-40%20Naizencho%2C%20Kashihara%2C%20Nara%2C%20634-0804%2C%20Japan"
    pageTitle="Nikutoieba Matsuda"
  />
);

export default NikutoiebaMatsuda;
