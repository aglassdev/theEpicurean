...
const LaCachetteNAR = () => (
  <RestaurantPage
    ...
    address="5-3-5 Nishitomigaoka, Nara, Nara, 631-0006, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81742452339"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/la-cachette-1197247"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="During the 1980s, when classics were making a comeback, the owner-chef honed his skills by going from restaurant to restaurant in Paris. Based on that experience, he seasons the dishes with salt and provides them with balance using tartness and fattiness. He emphasises uniqueness and this includes making soup with uncured ham and melon and using duck in potato dishes. He also uses sour pickled ume in putting both his French and Japanese sensibilities to work...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-3-5%20Nishitomigaoka%2C%20Nara%2C%20Nara%2C%20631-0006%2C%20Japan"
    pageTitle="La Cachette"
  />
);

export default LaCachetteNAR;
