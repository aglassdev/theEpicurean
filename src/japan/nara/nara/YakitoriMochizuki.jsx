...
const YakitoriMochizuki = () => (
  <RestaurantPage
    restaurantName="Yakitori Mochizuki"
    address="32-14 Surugamachi, Nara, Nara, 630-8357, Japan"
    cuisine="Yakitori"
    priceRange="¥¥"
    phoneNumber="+817083740936"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/yakitori-mochizuki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hirokazu Bando follows the teachings of where he trained and uses and cooks at high heat directly over the flame. He fills the roaster with bincho charcoal, leaving no spaces in between. Only a set menu is offered so that customers can enjoy a variety of skewers. He dresses whole chickens himself, so also offers rare parts such as chicken oysters and arteries. The meal starts with shuko, such as liver pâté, and proceeds to yakitori chosen to provide gradual changes in taste...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=32-14%20Surugamachi%2C%20Nara%2C%20Nara%2C%20630-8357%2C%20Japan"
    pageTitle="Yakitori Mochizuki"
  />
);

export default YakitoriMochizuki;
