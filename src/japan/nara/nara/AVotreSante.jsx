...
const AVotreSante = () => (
  <RestaurantPage
    restaurantName="A VOTRE SANTE"
    address="6-26 Shinasahigaoka, Ikoma, Nara, 630-0253, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81743758123"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/a-votre-sante"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Yaoki Tsujimura says that he wants to communicate the sights he saw in France. He recalls memories from training in southern France in the 1990s. Everything from gougère to bread and small confectionery is freshly baked. Dishes made using a generous amount of butter and garnished with sauce have a nostalgic French aroma to them. When you hear the word ‘santé, it means a fun time is about to begin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-26%20Shinasahigaoka%2C%20Ikoma%2C%20Nara%2C%20630-0253%2C%20Japan"
    pageTitle="A VOTRE SANTE"
  />
);

export default AVotreSante;
