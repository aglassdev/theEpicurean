...
const KappoRisuke = () => (
  <RestaurantPage
    restaurantName="Kappo Risuke"
    address="498-5 Kuzumotocho, Kashihara, Nara, 634-0007, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81744239307"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/kappo-risuke"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The colourful Japanese paintings and fusuma paintings are by owner-chef Toshiyuki Fukui himself. He likes fish, thus the paintings of tai, tilefish and other varieties. Most of the seating is in private rooms, so he puts much effort into kaiseki. The first highlight is the hassun and he includes more than 10 shuko for a good match with the sake. In summer, he catches the ayu himself. Having trained in Kyoto and Osaka, he also specialises in hamo dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=498-5%20Kuzumotocho%2C%20Kashihara%2C%20Nara%2C%20634-0007%2C%20Japan"
    pageTitle="Kappo Risuke"
  />
);

export default KappoRisuke;
