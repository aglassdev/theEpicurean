...
const SosakukushinomiseRindo = () => (
  <RestaurantPage
    restaurantName="Sosakukushinomise Rindo"
    address="224-1 Tsujimachi, Ikoma, Nara, 630-0212, Japan"
    cuisine="Kushiage"
    priceRange="¥¥"
    phoneNumber="+81743846669"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/sosakukushinomise-rindo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Ueda came up with creative skewers to make use of his experience in both Japanese and Western cuisine. The honekiri-treated hamo requiring very precise cuts is where his Japanese culinary skills shine. The croque monsieur is a French recipe. The menu starts with Western appetisers and incorporates surinagashi, gazpacho and other soups. The free-wheeling culinary ideas on display in the menu have you looking forward to what’s coming...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=224-1%20Tsujimachi%2C%20Ikoma%2C%20Nara%2C%20630-0212%2C%20Japan"
    pageTitle="Sosakukushinomise Rindo"
  />
);

export default SosakukushinomiseRindo;
