...
const OryoriKotan = () => (
  <RestaurantPage
    restaurantName="Oryori Kotan"
    address="6-2-17 Omiyacho, Nara, Nara, 630-8115, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81742338817"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/oryori-kotan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Kotan’ refers to having depth of taste in light foods. Owner-chef Masanori Mizukawa chose the name as one that chimes with the essence of Japanese cuisine. Embodying this idea is the dashi for the soup; its simple, refined flavour comes from kombu and dried tuna. He puts his experience of having worked as a cook at a ryotei to use in the elaborate vegetable takiawase as well. Accenting the menu is the beef hobayaki speciality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-2-17%20Omiyacho%2C%20Nara%2C%20Nara%2C%20630-8115%2C%20Japan"
    pageTitle="Oryori Kotan"
  />
);

export default OryoriKotan;
