...
const Plus = () => (
  <RestaurantPage
    restaurantName="à plus"
    address="1137 Nishikubohommachi, Gose, Nara, 639-2228, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81745403862"
    website="https://guide.michelin.com/en/nara-region/nara/restaurant/a-plus"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The restaurant shares a site occupied by a sake brewery since the days of the shoguns. A black counter reflects the Japanese interior of this refurbished traditional house. Locally grown and raised ingredients are the star of the cuisine, with Nara-style pickled vegetables, Yamato beef and vegetables all expressing the terroir of Nara. Akitsuho rice, used in sake brewing, makes an appearance in prix fixe offerings, transformed into rice dishes such as paella and risotto. Sake pairings from the unique expertise of a sake brewer are another reason to visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1137%20Nishikubohommachi%2C%20Gose%2C%20Nara%2C%20639-2228%2C%20Japan"
    pageTitle="à plus"
  />
);
