...
const Terada = () => (
  <RestaurantPage
    restaurantName="Terada"
    address="2F, 2-35 Tamatsukurimotomachi, Tennoji-ku, Osaka, 543-0014, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81661913237"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/terada"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="‘Good old traditions and colourful, fun Japanese cuisine’ is the credo of owner-chef Shigeru Terada. He works traditional festivals or events into each of his hassun, which he serves with a ready smile. The reason he chooses contemporary plates and bowls is so diners can experience a journey through the present with the artists. Fresh vegetables arrive from his parents in Mie Prefecture, the images on the coaster are painted by his mother, and his elder brother designed the interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-35%20Tamatsukurimotomachi%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0014%2C%20Japan"
    pageTitle="Terada"
  />
);

export default Terada;
