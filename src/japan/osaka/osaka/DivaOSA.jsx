...
const DivaOSA = () => (
  <RestaurantPage
    restaurantName="DIVA"
    address="6-1-29 Tenjimbashi, Kita-ku, Osaka, 530-0041, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81668825676"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/diva-1242557"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Countertop French dining by a single skilled chef. The name was chosen out of the chef’s fondness for films. The style here is a three-plate prix fixe menu of appetiser, main course and dessert. For each of the three, guests choose from a pleasingly extensive list. Old-school French cuisine that proudly upholds tradition with classic technique and bold flair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-1-29%20Tenjimbashi%2C%20Kita-ku%2C%20Osaka%2C%20530-0041%2C%20Japan"
    pageTitle="DIVA"
  />
);

export default DivaOSA;
