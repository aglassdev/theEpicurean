...
const AgnelDor = () => (
  <RestaurantPage
    restaurantName="agnel d'or"
    address="2-4-4 Nishihommachi, Nishi-ku, Osaka, 550-0005, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81649811974"
    website="https://www.agneldor.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Cooking is the art of teasing out the pure flavour of each ingredient. For example, a main dish could be paired with clear consommé drawn from mushrooms or seafood. A delicate finish, light on fats and oils, brings out the pure flavour of each ingredient. Dishes prepared using Japanese ingredients such as Pacific saury, groundnuts and lily bulbs are arranged on vessels produced by modern artists. In France, the chef learned the importance of originality. His inquisitive mind creates uniqueness in his work...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4-4%20Nishihommachi%2C%20Nishi-ku%2C%20Osaka%2C%20550-0005%2C%20Japan"
    pageTitle="agnel d'or"
  />
);

export default AgnelDor;
