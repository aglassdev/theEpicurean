...
const SushishoNehachi = () => (
  <RestaurantPage
    restaurantName="Sushisho Nehachi"
    address="4-1-70 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+819032781109"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushisho-nehachi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The delightfully varied omakase menu begins with a snack. Bright perilla spikes and grilled soy marinated fish show the chef’s experience. Nigiri is painstakingly crafted, sparing neither effort nor inventiveness. Clams are broiled to a pungent fragrance, sweet shrimp comes with roe marinated in soy sauce. The vinegar for the rice is coupled with roasted sesame seeds for an inviting aroma. The name means ‘sushi smile’, conveying the chef’s desire that patrons enjoy the restaurant in a relaxed mood...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-1-70%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Sushisho Nehachi"
  />
);

export default SushishoNehachi;
