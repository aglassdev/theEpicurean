...
const Sawada = () => (
  <RestaurantPage
    restaurantName="Sawada"
    address="4-2-50 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+819045767699"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sawada-1210686"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With a spirit of gratitude, Toshimitsu Sawada explains his menu like a storyteller. Like the chef, the hostess and apprentice pour their souls into their work, creating food to satisfy hearts as well as stomachs. Appetiser platters expressing scenes of mountain villages and hotpots for sharing attest to Sawada’s schooling in the restaurants of Shiga. Rice dishes in clay pots are deliciously accompanied and come with noodles. A delight from beginning to end...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-2-50%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Sawada"
  />
);

export default Sawada;
