...
const KitashinchiFukutateiTheUkai = () => (
  <RestaurantPage
    restaurantName="Kitashinchi Fukutatei"
    address="B1F, 1-11-19 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Steakhouse"
    priceRange="¥¥¥"
    phoneNumber="+81663418588"
    website="https://bliss-dining.com/"
    aliases={["Kitashinchi Fukutatei The UKAI"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The steaks at Kitashinchi Fukutatei are grilled by the double action of Bincho charcoal flame stoked in a furnace and far-infrared photothermal heat. Beef is Japanese Black wagyu, heifer only. Tasting and comparing different cuts, such as tenderloin, rump and aitchbone, is part of the fun. To ensure you fully enjoy the fragrant, delicate quality of the meat, seasoning is limited to salt and pepper. While the meat is being patiently grilled, tuck into wagyu consommé soup and appetisers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%201-11-19%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Kitashinchi Fukutatei"
  />
);

export default KitashinchiFukutateiTheUkai;
