...
const TempuraFukana = () => (
  <RestaurantPage
    restaurantName="Tempura Fukana"
    address="B1F, 2-1-25 Dojima, Kita-ku, Osaka, 530-0003, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81666908278"
    website="https://tempura-fukana.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Helping his mother with the cooking as a little boy was the chef’s gateway into the world of Japanese cuisine. He learned the craft at a hotel, where he was entrusted with tempura; later he went independent, fulfilling his dream. The sign was written by his mother, a calligraphy instructor. The chef’s aim is to serve tempura so light, you wouldn’t know it’s deep-fried. Pieces are lightly coated and aromatic when fried. Points of pride include tempura using sea urchin and nori, as well as wagyu beef fillet wrapped in perilla leaf...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-1-25%20Dojima%2C%20Kita-ku%2C%20Osaka%2C%20530-0003%2C%20Japan"
    pageTitle="Tempura Fukana"
  />
);

export default TempuraFukana;
