...
const AozoraBlue = () => (
  <RestaurantPage
    restaurantName="Aozora blue"
    address="4-5-8 Hiranomachi, Chuo-ku, Osaka, 541-0046, Japan"
    cuisine="Udon"
    priceRange="¥"
    phoneNumber="+81647088812"
    website="https://www.aozora.blue/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This distinctive udon is prepared using the techniques of handmade soba, which the chef mastered before switching to udon. Unpolished wheat is ground on a millstone. The experience of the soba craftsman lives in the principle of ‘freshly ground, freshly rolled, freshly boiled’. We recommend the Arabiki Zaru Udon (coarse-ground udon served on a wicker basket). Salt and wasabi accompany the dish, and the meal ends with udon water (not soba water, as is the practice elsewhere). Alcoholic drinks and snacks are selected to befit an udon meal. The chef’s discovery of wheat changed his life; the paths of both soba and udon are long and narrow...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-5-8%20Hiranomachi%2C%20Chuo-ku%2C%20Osaka%2C%20541-0046%2C%20Japan"
    pageTitle="Aozora blue"
  />
);

export default AozoraBlue;
