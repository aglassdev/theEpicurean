...
const KashiwayaOsakaKitashinchi = () => (
  <RestaurantPage
    restaurantName="Kashiwaya Osaka Kitashinchi"
    address="5F, 1-7-4 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+818061030979"
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%201-7-4%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Kashiwaya Osaka Kitashinchi"
  />
);

export default KashiwayaOsakaKitashinchi;
