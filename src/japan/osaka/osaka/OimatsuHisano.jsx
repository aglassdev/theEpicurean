...
const OimatsuHisano = () => (
  <RestaurantPage
    restaurantName="Oimatsu Hisano"
    address="4-8-3 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81663146202"
    website="https://www.oimatsuhisano.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="To stick close to the seasons with his cuisine, the chef gathers flavours from every part of Japan. Sourcing rare vegetables and fruits testifies to his boundless curiosity. The menu is full of creative flair to delight diners. Eschewing the customary dependence on soy sauce, sashimi platters are paired with fish-broth dipping sauce. Freshly cooked rice is seasoned with salt and soy sauce to elicit a pure sweetness. The chef experiments with novel techniques, but always respects the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-8-3%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Oimatsu Hisano"
  />
);

export default OimatsuHisano;
