...
const KamigataRainbow = () => (
  <RestaurantPage
    restaurantName="Kamigata Rainbow"
    address="4-6-3 Katsuyama, Tennoji-ku, Osaka, 543-0043, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81677082669"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kamigata-rainbow"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A rainbow-coloured awning marks Kamigata Rainbow, a shop that pursues individuality even in ramen. The type of noodle differs for each type of ramen, creating unity in each. Soy sauce is redolent with lashings of small, dried sardines. In the curry ramen, curry paste floating in the soup changes delightfully as it melts. The menu includes items limited to each season, tickling one’s curiosity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-6-3%20Katsuyama%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0043%2C%20Japan"
    pageTitle="Kamigata Rainbow"
  />
);

export default KamigataRainbow;
