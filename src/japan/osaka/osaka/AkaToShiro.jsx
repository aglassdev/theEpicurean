...
const AkaToShiro = () => (
  <RestaurantPage
    restaurantName="AKA to SHIRO"
    address="3F, 1-1-41 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+81664421277"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/aka-to-shiro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef uses two types of vinegared rice: red-vinegared rice for tuna and blue-backed fish, and white-vinegared rice for shrimp and white-fleshed fish. The red vinegar is a style popular in the Kanto region, while the ‘white’ vinegar (rice vinegar with sugar) is a Kansai speciality with strong roots in oshizushi. The combination of red and white, east and west, creates a dialogue between variations, respecting the spirit of each. Aka to Shiro also means ‘red and white’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%201-1-41%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="AKA to SHIRO"
  />
);

export default AkaToShiro;
