...
const Kushiage010 = () => (
  <RestaurantPage
    restaurantName="kushiage 010"
    address="4F, 1-1-41 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Kushiage"
    priceRange="¥¥"
    phoneNumber="+81661318878"
    website="https://kushiage010.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These creative kushiage incorporate culinary influences from many countries. The sheer variety is endlessly fun. For your first skewer, you might start with angel shrimp from New Caledonia. The samgyeopsal (grilled pork-belly slices) wrapped in perilla and Korean lettuce is spiced with gochujang for a real Korean treat. Karaage, marinated in a sauce of spices such as star anise and five-spice powder and sprinkled with tapioca flour, fills the air with the fragrance of Taiwan...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%201-1-41%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="kushiage 010"
  />
);

export default Kushiage010;
