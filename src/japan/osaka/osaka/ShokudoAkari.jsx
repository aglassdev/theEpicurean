...
const ShokudoAkari = () => (
  <RestaurantPage
    restaurantName="Shokudo Akari"
    address="2F, 1-6-27 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Izakaya"
    priceRange="¥¥"
    phoneNumber="+81663413791"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/shokudo-akari"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Akari shines out of a detached house in the entertainment district. The nest of criss-crossing wooden poles hung from the ceiling represent the handheld pine torches of the Oto Fire Festival in Wakayama, as well as the flame of the chef’s passion for cooking. Expect everything from familiar favourites such as gingered chicken liver, potato salad and deep-fried horse mackerel, to seasonal flavours. Naturally, this true son of Wakayama takes pride in grilling with Kishu Bincho charcoal. Every February 6, the chef returns to his native prefecture to take part in the Fire Festival...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-6-27%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Shokudo Akari"
  />
);

export default ShokudoAkari;
