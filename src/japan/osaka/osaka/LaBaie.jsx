...
const LaBaie = () => (
  <RestaurantPage
    restaurantName="La Baie"
    address="5F, The Ritz-Carlton, Osaka, 2-5-25 Umeda, Kita-ku, Osaka, 530-0001, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81663437020"
    website="https://labaie.ritzcarltonosaka.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A dining room fit for a noble mansion, décor of stunning symmetry and graceful service by the waitstaff create a moment cocooned in splendour. Commanding the kitchen is Christophe Gibert, a native of Bretagne. Accustomed to life by the sea, Gibert makes extensive use of seaweed. His preparations, with their strong accent on sauces, convey his spirit of respect for classic cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%20The%20Ritz-Carlton%2C%20Osaka%2C%202-5-25%20Umeda%2C%20Kita-ku%2C%20Osaka%2C%20530-0001%2C%20Japan"
    pageTitle="La Baie"
  />
);

export default LaBaie;
