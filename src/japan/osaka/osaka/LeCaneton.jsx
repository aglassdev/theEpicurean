...
const LeCaneton = () => (
  <RestaurantPage
    restaurantName="Le Caneton"
    address="2-6-23 Uehommachinishi, Chuo-ku, Osaka, 542-0062, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81667611717"
    website="https://www.le-caneton.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name is French for ‘duckling’, reflecting the chef’s passionate pursuit of duck and foie gras cuisine. He places the accent on prix fixe, the better to ensure perfection in each dish. Playful amuse-bouche are dramatically presented on a high-tea stand. For the main course, Osaka duck is naturally de rigueur. His wife, the pâtissière of the establishment, flexes her talents in the dessert department...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-6-23%20Uehommachinishi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0062%2C%20Japan"
    pageTitle="Le Caneton"
  />
);

export default LeCaneton;
