...
const IchijuNisaiUenoMinoten = () => (
  <RestaurantPage
    restaurantName="Ichiju Nisai Ueno Minoten"
    address="2-5 Minokoen, Mino, Osaka, 562-0002, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81727450699"
    website="https://ichijunisai-ueno.net/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef avoids the formalities of tea ceremony cuisine, as he wants diners to enjoy their meal and not feel self-conscious. He follows the principle of ‘one bowl of soup and two side dishes’. Appetiser platters are garnished with seasonal flowers and leaves, creating a bright and cheerful presentation. The tempura combo is an essential menu item. Depending on the room, the cook may fry each tempura item individually. Serenaded by the murmuring of the Minō River, dine with relish on the bounty of nature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-5%20Minokoen%2C%20Mino%2C%20Osaka%2C%20562-0002%2C%20Japan"
    pageTitle="Ichiju Nisai Ueno Minoten"
  />
);

export default IchijuNisaiUenoMinoten;
