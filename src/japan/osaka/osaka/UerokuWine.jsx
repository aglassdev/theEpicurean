...
const UerokuWine = () => (
  <RestaurantPage
    restaurantName="Ueroku wine"
    address="4-15 Higashikozucho, Tennoji-ku, Osaka, 543-0021, Japan"
    cuisine="Spanish"
    priceRange="¥¥"
    phoneNumber="+815013955207"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/ueroku-wine"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Spanish restaurant by Bordeaux vintner. Spain has two coasts, the Mediterranean and the Atlantic, and Japan is surrounded by seas on all four sides. These geographical features define the food culture and cooking on tap at Ueroku wine. The chef parlays Japan’s unique seafood into cuisine with a distinctive character. A selection of wines from many countries, including the owner’s own, Clos Leo, is available for your enjoyment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-15%20Higashikozucho%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0021%2C%20Japan"
    pageTitle="Ueroku wine"
  />
);

export default UerokuWine;
