...
const Rakushin = () => (
  <RestaurantPage
    restaurantName="Rakushin"
    address="1-6-27 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81664512323"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/rakushin"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name means ‘spirit of fun’, as he loves nothing more than to cook and enjoy good food. Through interacting with chefs overseas, Chef Katayama learns creative touches to add to his menu. The addition of Western elements flows from the same experience. At the same time, he never forgets reverence for tradition. Lacquered wooden trays and dishes garnished with flowers convey the season. Self-expressive yet respectful of traditional boundaries, Chef Katayama’s goal is the evolution of Japanese cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-6-27%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Rakushin"
  />
);

export default Rakushin;
