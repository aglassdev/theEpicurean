...
const OimatsuTempuraSuzuki = () => (
  <RestaurantPage
    restaurantName="OIMATSU Tempura Suzuki"
    address="4-4-2 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81663359633"
    website="https://oimatsu-tempura-suzuki.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The tempura here shows an awareness of the start and end of each ingredient’s season, reflecting the chef’s experience in Japanese cuisine. Thinly battered items are lightly fried in safflower oil to convey their flavour plainly and honestly. Tiger prawn and cod milt are wrapped in perilla leaves for added fragrance. Wagyu fillet is grilled to a rosy pink with consummate skill. Red pickled ginger added to kakiage (all-in-one seafood and vegetable tempura blend) is a unique touch that is pure Osaka...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-4-2%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="OIMATSU Tempura Suzuki"
  />
);

export default OimatsuTempuraSuzuki;
