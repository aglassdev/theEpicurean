...
const YakitoriMatsuoka = () => (
  <RestaurantPage
    restaurantName="Yakitori Matsuoka"
    address="1-4-17 Tohei, Chuo-ku, Osaka, 542-0063, Japan"
    cuisine="Yakitori"
    priceRange="¥¥¥"
    phoneNumber="+818097472200"
    website="https://www.yakitori-matsuoka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cuisine rich with the fertile imagination of Hiroki Matsuoka expresses a spirit of relentless curiosity. Free-range chickens from Kagoshima are aged to draw out their flavour. In addition to the usual salt and sauce, the chef brushes yakitori with a fragrant oil he prepares himself. The menu intersperses skewers with chicken items such as stews and soups. Meals wrap up with rice served in earthenware pots or ramen in chicken broth. Admiring the chef’s skill and forwards-looking imagination is part of the fun...."
    ...
    pageTitle="Yakitori Matsuoka"
  />
);

export default YakitoriMatsuoka;
