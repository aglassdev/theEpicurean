...
const KoryuKeishin = () => (
  <RestaurantPage
    restaurantName="Koryu Keishin"
    address="1-5-1 Dojima, Kita-ku, Osaka, 530-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81663475660"
    website="https://www.koryu.net/keishin/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In classic Naniwa (Osaka) kappo style, Koryu Keishin offers an extensive à la carte menu, prepared from Kansai ingredients. The pride of the house is its clear soup made with makombu kelp stock. Vegetables are used in generous measure: summer dishes include vinegared eel and Kema cucumber, while in winter yam from Tondabayashi is deep-fried in a batter made from powdered rice crackers. Char-grilled seafood from Osaka Bay and Kawachi duck are a delight. This sister shop of Koryu is on a quest for ‘the new flavours of Naniwa’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5-1%20Dojima%2C%20Kita-ku%2C%20Osaka%2C%20530-0003%2C%20Japan"
    pageTitle="Koryu Keishin"
  />
);

export default KoryuKeishin;
