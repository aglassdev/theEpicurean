...
const Sennarizushi = () => (
  <RestaurantPage
    restaurantName="Sennarizushi"
    address="5-5-13 Sugahara, Higashiyodogawa-ku, Osaka, 533-0022, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81663227799"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sennarizushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Until the previous generation, the shop had focused on sushi deliveries, but the current owner transformed it into a sushi restaurant. He changed the sushi, too, reflecting his training in the Edomae style. Sushi is served omakase style, but the chef also picks up on guests’ preferences and chooses pieces accordingly; if the guest likes to drink, he increases the number of small dishes that go well with sake. Seafood items from Osaka Bay, such as sea bream, sand shrimp, and egg cockle, are woven into the mix. Sushi is formed using red-vinegar rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-5-13%20Sugahara%2C%20Higashiyodogawa-ku%2C%20Osaka%2C%20533-0022%2C%20Japan"
    pageTitle="Sennarizushi"
  />
);

export default Sennarizushi;
