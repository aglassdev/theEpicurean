...
const Diffrence = () => (
  <RestaurantPage
    restaurantName="Différence"
    address="1-16-12 Utsubohommachi, Nishi-ku, Osaka, 550-0004, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81664791140"
    website="https://difference.upper.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The inspiration for the name ‘Différence’, is a desire to provide a space to spend time away from the quotidian cares of life. The uniform white of the dining room, with its otherworldly milieu, reflects this aesthetic. The concept is ‘French with a sense of Japan’, so the focus is on food grown and raised in Japan. Desserts infused with vegetables to impart a sense of season and pastries combining two favourite Japanese confections, yokan and daifuku, are unique touches. Enjoy flavours and dining a little different from the ordinary...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-16-12%20Utsubohommachi%2C%20Nishi-ku%2C%20Osaka%2C%20550-0004%2C%20Japan"
    pageTitle="Différence"
  />
);
