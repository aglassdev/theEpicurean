...
const OsteriaLaCicerchia = () => (
  <RestaurantPage
    restaurantName="Osteria La Cicerchia"
    address="3F, 2-3-4 Kyomachibori, Nishi-ku, Osaka, 550-0003, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81664410731"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/osteria-la-cicerchia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The ‘Marches cuisine specialty restaurant’ certificate from Italy proudly adorns the wall, and indeed the gastronomy of this region on Italy’s Adriatic coast is what the chef excels in. Meat-stuffed olive fritti, homemade salsiccia and rabbit-and-tomato stew are all staples of the Marchese dining board. Cicerchia beans are a classic legume grown in the town where the chef stayed. Their flavour can be tasted in her minestrone soup...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%202-3-4%20Kyomachibori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0003%2C%20Japan"
    pageTitle="Osteria La Cicerchia"
  />
);

export default OsteriaLaCicerchia;
