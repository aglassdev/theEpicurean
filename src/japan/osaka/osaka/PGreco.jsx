...
const PGreco = () => (
  <RestaurantPage
    restaurantName="P greco"
    address="4-1-20 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81668091800"
    website="https://www.pgreco.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In Italy, the chef experienced the fierce pride the Italians have in their home regions. Deeply impressed by the unique cuisines of people who produce and consume locally all their lives, he set his sights on combining Japanese sensibilities with Italian cooking. One example is anago carpaccio: deboned conger eel accompanied by tomato and bagna càuda. The focus on seafood derives from his love of the bounty of the sea, learned at his grandmother’s house in Okinoshima...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-1-20%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="P greco"
  />
);

export default PGreco;
