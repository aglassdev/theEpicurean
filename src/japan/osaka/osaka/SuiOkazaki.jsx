...
const SuiOkazaki = () => (
  <RestaurantPage
    restaurantName="Sui Okazaki"
    address="2F, 1-16-20 Higashishinsaibashi, Chuo-ku, Osaka, 542-0083, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81662278578"
    website="https://www.sui-okazaki.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When he took over the restaurant, the chef inherited its teachings, preserving the forms of traditional multi-course meals while expressing his own imagination. Experience in Kyoto cuisine shines in soup stock of ma-kombu and Rishiri kombu. Pickled mackerel is paired with fruit, highlighting the tartness in both. His inspiration for pursuing the gastronomic life came, he says, from the way appetiser platters express the shifting seasons. To celebrate those seasons, dishes are cheerfully garnished...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-16-20%20Higashishinsaibashi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0083%2C%20Japan"
    pageTitle="Sui Okazaki"
  />
);

export default SuiOkazaki;
