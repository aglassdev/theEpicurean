...
const Taian = () => (
  <RestaurantPage
    restaurantName="Taian"
    address="1-21-2 Shimanochi, Chuo-ku, Osaka, 542-0082, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81661200790"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/taian"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The ‘tai’ means ‘big’; the ‘an’ means ‘hut’. Hitoshi Takahata named his restaurant to denote the passion that enfolds his little shop with a big, bold spirit. In his ryotei fare, presented in a counter kappo style, he displays his depth of experience through appetiser platters with rare flavours and gracefully crafted soups. Spareribs grilled in dipping sauce and grilled conger eel plated in a whirlpool arrangement interweave the chef’s dexterity in both presentation and grilling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-21-2%20Shimanochi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0082%2C%20Japan"
    pageTitle="Taian"
  />
);

export default Taian;
