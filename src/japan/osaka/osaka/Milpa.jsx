...
const Milpa = () => (
  <RestaurantPage
    restaurantName="milpa"
    address="1-16-25 Kitahorie, Nishi-ku, Osaka, 550-0014, Japan"
    cuisine="Mexican, Contemporary"
    priceRange="¥¥¥¥"
    phoneNumber="+81643948383"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/milpa"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This is the place to sample modern Mexican cuisine. Respect for the traditions of the motherland are palpable as Japanese ingredients and modern techniques move the genre forward. Corn, the staple food, along with cacao and chili peppers, is sourced from Mexico, and, following tradition, the food is cooked over a wood-fired grill. Milpa is the name in the Nahuatl (Aztec) language for a farming system that enriches the earth; the chef likens cooking techniques to farming, cultivating a new Mexican culinary culture in Osaka...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-16-25%20Kitahorie%2C%20Nishi-ku%2C%20Osaka%2C%20550-0014%2C%20Japan"
    pageTitle="milpa"
  />
);
