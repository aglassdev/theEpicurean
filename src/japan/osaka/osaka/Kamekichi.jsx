...
const Kamekichi = () => (
  <RestaurantPage
    restaurantName="Kamekichi"
    address="1-3-13 Yariyamachi, Chuo-ku, Osaka, 540-0027, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81669470063"
    website="https://www.kamekichi-b.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef wanted his guests to feel comfortable around him, so he named his restaurant after his own nickname. French country favourites fill the menu, including quiche Lorraine, cassoulet and beef cheek simmered in red wine. Game in season, such as mallard and Daurian partridge, are a delight. À la carte items at dinner are generously portioned for sharing. Sauces prepared with liberal amounts of butter and cream are the true pleasure of French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-13%20Yariyamachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0027%2C%20Japan"
    pageTitle="Kamekichi"
  />
);

export default Kamekichi;
