...
const SushiSanshin = () => (
  <RestaurantPage
    restaurantName="Sushi Sanshin"
    address="2-7-14 Uchikyuhojimachi, Chuo-ku, Osaka, 540-0013, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81667670677"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushi-sanshin"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Situated in a quiet residential district, Sushi Sanshin is open only at lunchtime. The naturally lit interior presents an austere charm. The chef is schooled in the old ways of sushi-making, but weaves in a few tricks of his own. For example, tiger prawn, filleted ‘double door’ style, is dressed prawn miso rather with than the conventional wasabi. The tamagoyaki, placed on top of the rice like a horse's saddle, hides a small amount of fish flakes underneath. Norimaki made with herbs to evoke vegetable flavours is a speciality found only here. Pursuit of the new, tempered by respect for the classics...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-7-14%20Uchikyuhojimachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0013%2C%20Japan"
    pageTitle="Sushi Sanshin"
  />
);

export default SushiSanshin;
