...
const GrandRocher = () => (
  <RestaurantPage
    restaurantName="Grand rocher"
    address="4-3-9 Fushimimachi, Chuo-ku, Osaka, 541-0044, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81662101561"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/grand-rocher"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Through the glass façade we spy a marble interior oozing elegance, right down to the decorative plates from Hermès. The chef fashions French cuisine from Japanese ingredients. Sauces, for example, are flavoured with sake and yuzu citrus; and Japanese mustard is used in place of European mustard. We recommend a table if you’d like to linger; the counter to enjoy the performance in the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-3-9%20Fushimimachi%2C%20Chuo-ku%2C%20Osaka%2C%20541-0044%2C%20Japan"
    pageTitle="Grand rocher"
  />
);

export default GrandRocher;
