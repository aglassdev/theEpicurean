...
const Ptimo = () => (
  <RestaurantPage
    restaurantName="Óptimo"
    address="2-6-6 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Spanish"
    priceRange="¥¥"
    phoneNumber="+81644009113"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/optimo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Óptimo’ means ‘best’ or ‘ideal’. With the warmth of its interior and service, the restaurant aims to be the best place for guests to dine. The diverse range of dining styles—tapas, à la carte, prix fixe—aims to ensure the ideal experience for each guest. Favourites here include a richly flavoured gratin of crab and callos, which is a stew of simmered honeycomb tripe and beans. Rice dishes simmered in a savoury broth, such as ‘arroz meloso’ and ‘arroz caldoso’, are also crowd-pleasers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-6-6%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Óptimo"
  />
);

export default Ptimo;
