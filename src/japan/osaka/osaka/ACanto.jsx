...
const ACanto = () => (
  <RestaurantPage
    restaurantName="a canto"
    address="3-1-10 Uchikyuhojimachi, Chuo-ku, Osaka, 540-0013, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81671756383"
    website="https://www.a-canto.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef’s creed is to weave seasonal elements and refinement into his cuisine. Each item is simple yet distinctive. Bavettine of dried mullet roe and lime is a signature dish using handmade pasta. Pastas showcase the assured touch of a craftsman who was in charge of that department at Enoteca Pinchiorri in Florence. The name means ‘at your side’, as the chef hopes it can be familiar presence for diners who crave the warmth of Italian cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-1-10%20Uchikyuhojimachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0013%2C%20Japan"
    pageTitle="a canto"
  />
);
