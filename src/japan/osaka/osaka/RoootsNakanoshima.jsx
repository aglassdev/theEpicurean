...
const RoootsNakanoshima = () => (
  <RestaurantPage
    restaurantName="Rooots Nakanoshima"
    address="6-1-45 Nakanoshima, Kita-ku, Osaka, 530-0005, Japan"
    cuisine="Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81677770822"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/rooots-nakanoshima"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At this sister location to a Hiroshima restaurant, a chef who honed his skills in Italy displays his talents. Ingredients are from around the Kinki region as well as the chef's beloved Hiroshima. Italian fare is the base, overlaid with French influences from the flagship restaurant, resulting in a seamless blend of French and Italian recipes. Potato gnocchi is the signature dish. Its culinary roots, so important that the name is spelled with an extra ‘o’, extend deep into both Hiroshima and Nakanoshima...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-1-45%20Nakanoshima%2C%20Kita-ku%2C%20Osaka%2C%20530-0005%2C%20Japan"
    pageTitle="Rooots Nakanoshima"
  />
);

export default RoootsNakanoshima;
