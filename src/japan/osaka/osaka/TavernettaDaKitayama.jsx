...
const TavernettaDaKitayama = () => (
  <RestaurantPage
    restaurantName="TAVERNETTA da KITAYAMA"
    address="1-6 Ishigatsujicho, Tennoji-ku, Osaka, 543-0031, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81667773784"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/tavernetta-da-kitayama"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In Italian, ‘tavernetta’ denotes a casual eatery, so the atmosphere here is informal and relaxing. Traditional Italian fare is listed on a blackboard. Tripe stewed in tomato, marlin baked in herb-seasoned breadcrumbs and mushroom pappardelle offer the flavours of a village in the north of Italy. The signature dish is beef, pork or lamb grilled in slabs. The menu changes based on supply. Servings are big enough for two, making them nice to share...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-6%20Ishigatsujicho%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0031%2C%20Japan"
    pageTitle="TAVERNETTA da KITAYAMA"
  />
);

export default TavernettaDaKitayama;
