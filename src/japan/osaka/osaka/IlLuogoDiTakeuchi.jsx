...
const IlLuogoDiTakeuchi = () => (
  <RestaurantPage
    restaurantName="il luogo di TAKEUCHI"
    address="5-1-26 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81664510151"
    website="https://www.takeuchi-italia.jp"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This is the main branch of Takeuchi, which operates a number of casual Italian trattorias. The owner-chef holds court in the kitchen, directing his cooking staff. At noontime a simple pasta lunch is served, but a full range of à la carte dishes are offered in the evening. The range of pastas is impressive, and the eatery does not skimp on tomato and cream sauces. The aroma of fish and wagyu grilling over charcoal is also compelling...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-1-26%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="il luogo di TAKEUCHI"
  />
);

export default IlLuogoDiTakeuchi;
