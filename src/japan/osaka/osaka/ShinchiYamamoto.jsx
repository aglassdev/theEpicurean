...
const ShinchiYamamoto = () => (
  <RestaurantPage
    restaurantName="Shinchi Yamamoto"
    address="1-1-13 Dojima, Kita-ku, Osaka, 530-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81661478227"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/shinchi-yamamoto"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef treats his guests to seasonal cuisine of unstinting luxury. The feast begins with bamboo shoots, sweetfish, matsutake mushrooms and crab, representing the four seasons. The spectacle of the kitchen from the counter captivates the heart. For soup dishes, the basic soup stock is drawn directly before the customer. Items grilled on the charcoal brazier or cooked in pots are likewise prepared in view of the customer. Arrangements are simple, to give the ingredients top billing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-1-13%20Dojima%2C%20Kita-ku%2C%20Osaka%2C%20530-0003%2C%20Japan"
    pageTitle="Shinchi Yamamoto"
  />
);

export default ShinchiYamamoto;
