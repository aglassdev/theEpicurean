...
const BistrotNeuf = () => (
  <RestaurantPage
    restaurantName="bistrot neuf"
    address="1-4-17 Tohei, Chuo-ku, Osaka, 542-0063, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+817040866010"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/bistrot-neuf-1242628"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The stylish, retro interior of this bistro is decorated with pop posters from France. The name can mean ‘nine’ or ‘new’ – because the chef hopes guests will visit this nine-tsubo (30 sqm) space feeling fresh and new each time. Standards include oeufs mayonnaise, pâté de campagne and beef cheek stewed in red wine. The chef’s experience in Italian cuisine brings pasta to the table as well. Portions are generous, the better to enjoy sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-17%20Tohei%2C%20Chuo-ku%2C%20Osaka%2C%20542-0063%2C%20Japan"
    pageTitle="bistrot neuf"
  />
);

export default BistrotNeuf;
