...
const LeLogisH = () => (
  <RestaurantPage
    restaurantName="Le Logis h"
    address="1-2-3 Higashitemma, Kita-ku, Osaka, 530-0044, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81668813855"
    website="https://www.lelogish.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef’s attention focuses on spices, herbs and fruit. These are used freely in everything from appetisers to dessert. Foie gras offerings drive home the concept with creative use of fruits and spices. Millefeuille and tarte Tatin are prepared with a playful spirit. Only a chef who apprenticed in Périgord, famous for its foie gras, could imagine dishes that are this much fun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2-3%20Higashitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0044%2C%20Japan"
    pageTitle="Le Logis h"
  />
);

export default LeLogisH;
