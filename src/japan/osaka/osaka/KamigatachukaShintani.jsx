...
const KamigatachukaShintani = () => (
  <RestaurantPage
    restaurantName="Kamigatachuka SHINTANI"
    address="1-4-21 Nakazaki, Kita-ku, Osaka, 530-0016, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81674106334"
    website="https://www.kamigata-shintani.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Weave Kansai food culture and Chinese tradition together and you get Kamigatachuka. Ingredients from the Kinki region are prepared using Chinese and Japanese techniques; continuing the theme, items are served on Chinese and Japanese plates and bowls. Vegetarian cuisine, dubbed ‘Naniwa’ (‘vegetable garden’), brings to mind the Kawachi Plain’s fame as a vegetable-producing region. The fare is the self-expression of a chef who was born in Osaka and grew up in a family that ran a Chinese restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-21%20Nakazaki%2C%20Kita-ku%2C%20Osaka%2C%20530-0016%2C%20Japan"
    pageTitle="Kamigatachuka SHINTANI"
  />
);

export default KamigatachukaShintani;
