...
const LaKanro = () => (
  <RestaurantPage
    restaurantName="La Kanro"
    address="3-9 Tenjinnishimachi, Kita-ku, Osaka, 530-0045, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/la-kanro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef is always trying to think up flavours that people won’t tire of. The set menus consist of a large number of items in small portions, and he keeps the use of oil and salt to a minimum. He adds a touch of sourness or bitterness with vinegar and herbs to bring balance to the dishes. In the spring, the signature dish is lobster spring rolls garnished with flowers; in autumn, it’s cold tournedos Rossini...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-9%20Tenjinnishimachi%2C%20Kita-ku%2C%20Osaka%2C%20530-0045%2C%20Japan"
    pageTitle="La Kanro"
  />
);

export default LaKanro;
