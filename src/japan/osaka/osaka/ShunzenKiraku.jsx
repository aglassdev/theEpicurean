...
const ShunzenKiraku = () => (
  <RestaurantPage
    restaurantName="Shunzen Kiraku"
    address="1-3-16 Tohei, Chuo-ku, Osaka, 542-0063, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+819032389696"
    website="https://www.shunzen-kiraku.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Japanese restaurant is in the style of a Naniwa (Osaka) kappo. The procession starts with a combination platter of seafood, vegetables and sushi. The menu ranges from grilled and simmered items that hew close to the basics to offerings with a creative spin such as bisques and frites. The chef’s greatest joy is concocting dishes that connect on an emotional level: indicate a preference and he is happy to prepare your dish the way you like it. He keeps in his heart the teaching of his mentor: the true measure of a chef is the ability to tailor each dish to the taste of the diner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-16%20Tohei%2C%20Chuo-ku%2C%20Osaka%2C%20542-0063%2C%20Japan"
    pageTitle="Shunzen Kiraku"
  />
);

export default ShunzenKiraku;
