...
const Genso = () => (
  <RestaurantPage
    restaurantName="genso"
    address="2-7-18 Inari, Naniwa-ku, Osaka, 556-0023, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81665670555"
    website="https://www.genso-osaka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The venue, a remodelled ironworks, exudes an industrial vibe. Guests are greeted with cuisine styled on the concept of the four elements of fire, earth, wind and water, represented on the menu by elemental symbols of ancient Greece. A platter of vegetables, each grilled with a variety of techniques, represents cuisine of the earth; soup redolent with herbs and other ingredients expresses water; and so on, with each item conceptually linked to a classical element...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-7-18%20Inari%2C%20Naniwa-ku%2C%20Osaka%2C%20556-0023%2C%20Japan"
    pageTitle="genso"
  />
);

export default Genso;
