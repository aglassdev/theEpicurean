...
const SakeyaSakanaYoshimura = () => (
  <RestaurantPage
    restaurantName="Sakeya Sakana Yoshimura"
    address="1-13-21 Tenjimbashi, Kita-ku, Osaka, 530-0041, Japan"
    cuisine="Izakaya"
    priceRange="¥¥"
    phoneNumber="+81663534460"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sakeya-sakana-yoshimura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This kappo izakaya is run by a sake-loving couple. The husband tends the kitchen, the wife warms the sake. The menu, crafted to double as bar snacks, is dominated by seafood. Jellied conger eel broth, vegetables seasoned with vinegar and miso and freshly deep-fried tofu are standard fare. Attention is paid to details: seaweed is toasted over charcoal, dried bonito shaved just before serving. The intimate pub seats three guests at the most; on certain days, it’s exclusively for a single tippler...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-13-21%20Tenjimbashi%2C%20Kita-ku%2C%20Osaka%2C%20530-0041%2C%20Japan"
    pageTitle="Sakeya Sakana Yoshimura"
  />
);

export default SakeyaSakanaYoshimura;
