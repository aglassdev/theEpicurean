...
const SushiIchiei = () => (
  <RestaurantPage
    restaurantName="Sushi Ichiei"
    address="B1F, 1-6-10 Sennichimae, Chuo-ku, Osaka, 542-0074, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81662131307"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushi-ichiei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inheriting his father’s dream of independence, the chef followed him along the path of the sushi master. The signature item on the omakase menu is tsukuri of botan shrimp. The arrival of ginger wrapped in nori signals the transition from appetizers to sushi. Nigiri are orthodox, though the choice of sweet shrimp hits a distinctive note. The chef’s assured technique shows even in the thick rolled omelette. ‘Ichiei’ means something like ‘forever’, capturing his hope that you will treasure your encounter with his shop and remain a friend to it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%201-6-10%20Sennichimae%2C%20Chuo-ku%2C%20Osaka%2C%20542-0074%2C%20Japan"
    pageTitle="Sushi Ichiei"
  />
);

export default SushiIchiei;
