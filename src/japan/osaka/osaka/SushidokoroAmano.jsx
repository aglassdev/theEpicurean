...
const SushidokoroAmano = () => (
  <RestaurantPage
    restaurantName="Sushidokoro Amano"
    address="1-13-2 Shitennoji, Tennoji-ku, Osaka, 543-0051, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81667967575"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushidokoro-amano"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The movements of the owner-chef’s fingers as he works are a marvel to watch. This deftness is apparent in his side dishes and sushi. His knife technique, informed by a deep understanding of the characteristics of each fish, raises the flavour to a new level. Sushi rice is changed frequently to maintain just the right temperature, that of the human body. Rice is gathered in the palm of the hand as if capturing air. Wasabi, applied with the index finger, is apportioned just right, as is the nikiri. Formed with practiced economy of movement, each nigiri is formed perfectly for true flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-13-2%20Shitennoji%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0051%2C%20Japan"
    pageTitle="Sushidokoro Amano"
  />
);

export default SushidokoroAmano;
