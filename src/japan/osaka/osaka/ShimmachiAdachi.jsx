...
const ShimmachiAdachi = () => (
  <RestaurantPage
    restaurantName="Shimmachi Adachi"
    address="3-8-10 Shimmachi, Nishi-ku, Osaka, 550-0013, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81677084127"
    website="https://www.instagram.com/shinmachi_adachi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef weaves the culture of everyday Japanese life, including events such as New Year, the setsubun bean-scattering ceremony and the Doll Festival, into his creations. The practices of each event are explained on the menu, so that ancient customs may never be forgotten. Each season is honoured with its proper ingredients, as well as serving-ware decorations and arrangements based on seasonal themes. At the harvest moon, cuisine is served on lacquerware bowls decorated with images of susuki (Silvergrass) and plates bearing harvest motifs such as rabbits and the moon, and garnished with ears of susuki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-8-10%20Shimmachi%2C%20Nishi-ku%2C%20Osaka%2C%20550-0013%2C%20Japan"
    pageTitle="Shimmachi Adachi"
  />
);

export default ShimmachiAdachi;
