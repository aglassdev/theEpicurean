...
const NishitemmaIchigaya = () => (
  <RestaurantPage
    restaurantName="Nishitemma Ichigaya"
    address="2-10-9 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+817074627788"
    website="https://ichigaya.savor-japanese-restaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nishitemma Ichigaya upholds the traditions of Osaka while incorporating new influences. Creative inspiration and painstaking attention to detail are the watchwords here. Use of ma-kombu kelp to enliven the broth of soup dishes pays tribute to Semba merchant food culture. Traditional vegetables of Osaka showcase the attractions of that great commercial city. From time to time, French methods are employed as well. The seafood with miso sauce américain is a flavour found only here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-10-9%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Nishitemma Ichigaya"
  />
);

export default NishitemmaIchigaya;
