...
const Anu = () => (
  <RestaurantPage
    restaurantName="anu"
    address="2-4-25 Doshin, Kita-ku, Osaka, 530-0035, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81648004888"
    website="https://anu-osaka.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The open kitchen is a blur of motion. Chef and kitchen team are united in creating dishes that fulfil the potential of their ingredients. To dispel preconceptions, the menu lists ingredients only. Their speciality onions are a lucky happenstance, a flavour created when onions got burnt by mistake. The appeal of each dish is enhanced with stories about their producing regions and encounters with their producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4-25%20Doshin%2C%20Kita-ku%2C%20Osaka%2C%20530-0035%2C%20Japan"
    pageTitle="anu"
  />
);
