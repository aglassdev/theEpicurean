...
const Prestau = () => (
  <RestaurantPage
    restaurantName="PRESTAU"
    address="2-17-17 Shimmachi, Nishi-ku, Osaka, 550-0013, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81665569006"
    website="https://prestau-osaka.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant’s name is a portmanteau of ‘impress’ combined with ‘restaurant’. The concept is a ‘restaurant that touches the heartstrings’, and PRESTAU aims to do just that. His experience in Kobe leads the chef to favour ingredients from Hyogo Prefecture, served on Tambayaki flatware. Preparing each item to its best advantage is his top priority. This is Italian cuisine in a modern style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-17-17%20Shimmachi%2C%20Nishi-ku%2C%20Osaka%2C%20550-0013%2C%20Japan"
    pageTitle="PRESTAU"
  />
);

export default Prestau;
