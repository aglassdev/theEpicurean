...
const IlCentrino = () => (
  <RestaurantPage
    restaurantName="il Centrino"
    address="1-2-2 Kawarayamachi, Chuo-ku, Osaka, 542-0066, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81667625901"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/il-centrino"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="During his time in Italy, the chef was struck by the pride the locals had in their agricultural produce, which is deeply rooted in the natural and spiritual features of the land. He reflects on the places he travelled to, paying respect to local cuisines. Having apprenticed in Piemonte and Veneto, he specialises in the techniques of northern Italy, but expresses his own creative sensibility as well. The arrangements are simple and modern, and the flavours are subtle and light...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2-2%20Kawarayamachi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0066%2C%20Japan"
    pageTitle="il Centrino"
  />
);

export default IlCentrino;
