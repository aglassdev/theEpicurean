...
const Koryu = () => (
  <RestaurantPage
    restaurantName="Koryu"
    address="3-3-3 Uchiawajimachi, Chuo-ku, Osaka, 540-0038, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+815031723474"
    website="https://www.koryu.net/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A willow tree bending to describe an arc is the symbol of the restaurant and the meaning of its name. In this modern sukiya-type interior, the arc bends toward a wickerwork ceiling. Koryu’s location on the river’s edge reminds you that Osaka is known as the ‘City of Water’. The aim of the house is to be true to its Naniwa (Osaka) roots. The sumptuously arranged “Naniwa” sashimi platter is a remarkable sight. Traditional vegetables also befit the Osaka cuisine. Like the willow tree, Koryu applies a supple creative spirit to a solid foundation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-3-3%20Uchiawajimachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0038%2C%20Japan"
    pageTitle="Koryu"
  />
);

export default Koryu;
