...
const ChukasobaUemachi = () => (
  <RestaurantPage
    restaurantName="Chukasoba Uemachi"
    address="A-22 Uemachi, Chuo-ku, Osaka, 540-0005, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81667625311"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/chukasoba-uemachi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The first thing you notice at Uemachi are the constant queues outside the door. The shop took the name of the neighbourhood as it aims to be a place beloved by locals. Its signature ramen dishes are ‘Shoyu’ (soy sauce) and ‘Shio’ (salt). The broth derives its richness from its meat base; the flavour of dried fermented fish and crunchy sardines add depth. Insisting on noodles with a satisfying finish, the shop kneads its own. The fare is somehow nostalgic, in both taste and presentation...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=A-22%20Uemachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0005%2C%20Japan"
    pageTitle="Chukasoba Uemachi"
  />
);

export default ChukasobaUemachi;
