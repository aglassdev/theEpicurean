...
const KatamachiKawaguchi = () => (
  <RestaurantPage
    restaurantName="Katamachi Kawaguchi"
    address="1-3-11 Katamachi, Miyakojima-ku, Osaka, 534-0025, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81661361770"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/katamachi-kawaguchi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The low-profile exterior, small billboard and stripped-down accoutrements express an understated Japanese architecture aesthetic. The goal here is cuisine of which one never tires. Rishiri kombu kelp is selected for the dashi stock drawn for soups, reassuring with its light flavour. Fermented seasonings are handmade fish sauces, provide the subtle seasoning that enhances other flavours. Relying on patient craftsmanship rather than fancy ingredients, Katamachi Kawaguchi impresses with technique and singular character...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-11%20Katamachi%2C%20Miyakojima-ku%2C%20Osaka%2C%20534-0025%2C%20Japan"
    pageTitle="Katamachi Kawaguchi"
  />
);

export default KatamachiKawaguchi;
