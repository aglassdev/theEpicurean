...
const Teruya = () => (
  <RestaurantPage
    restaurantName="Teruya"
    address="2-1-24 Ueshio, Chuo-ku, Osaka, 542-0064, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+818056387455"
    website="https://www.teruya-osaka.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The care shown to guests by the couple who manage this kappo is heartwarming. The aroma and flavour of dashi soup stock are the focus of the fare, owing to the chef’s background in Kyoto cuisine. In the dashi of Osaka water and ma-kombu kelp, sweetness stands out. Salted and dried grey mullet roe is prepared at year’s end and served year-round, to be spread on iimushi, which is served between courses. Valuing simplicity, the chef creates impressions through combinations of ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-1-24%20Ueshio%2C%20Chuo-ku%2C%20Osaka%2C%20542-0064%2C%20Japan"
    pageTitle="Teruya"
  />
);

export default Teruya;
