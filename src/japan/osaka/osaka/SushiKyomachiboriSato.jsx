...
const SushiKyomachiboriSato = () => (
  <RestaurantPage
    restaurantName="Sushi Kyomachibori Sato"
    address="B1F, 1-8-22 Kyomachibori, Nishi-ku, Osaka, 550-0003, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81664413933"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushi-kyomachibori-sato"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Snacks and nigiri testify to the chef’s experience in Japanese cuisine. The meal begins simply, with handmade tofu or pureed vegetable soup. Tilefish scales are scored before the fish is grilled to make it look like a pinecone; pike conger and longtooth grouper are served as shabu-shabu, adding hot dishes to the mix. Sushi toppings such as Orient clams and simmered conger eel attest to old-school craftsmanship. Keen to offer a wide range of flavours, the chef offers smaller portions of nigiri enhanced with red vinegar and salt...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%201-8-22%20Kyomachibori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0003%2C%20Japan"
    pageTitle="Sushi Kyomachibori Sato"
  />
);

export default SushiKyomachiboriSato;
