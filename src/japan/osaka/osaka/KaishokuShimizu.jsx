...
const KaishokuShimizu = () => (
  <RestaurantPage
    restaurantName="Kaishoku Shimizu"
    address="1F, Shin Daibiru, 1-2-1 Dojimahama, Kita-ku, Osaka, 530-0004, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81663433140"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kaishoku-shimizu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Toshihiro Shimizu has always been passionate about his culinary research. Artistic presentation and ingenious twists are offered without fanfare. Emulating the principles of kaiseki, he uses rice in his amuse-bouche between courses. Appetisers are garnished with leaves, connoting the seasons’ constant shifting. The restaurant name expresses his desire that his customers heartily enjoy their meal. While preserving the fundamental character of Japanese cuisine, he assembles his menu with an original approach...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20Shin%20Daibiru%2C%201-2-1%20Dojimahama%2C%20Kita-ku%2C%20Osaka%2C%20530-0004%2C%20Japan"
    pageTitle="Kaishoku Shimizu"
  />
);

export default KaishokuShimizu;
