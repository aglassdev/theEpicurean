...
const MashinoKen = () => (
  <RestaurantPage
    restaurantName="Mashino Ken"
    address="2F, 1-3-6 Awajimachi, Chuo-ku, Osaka, 541-0047, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81662104449"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/mashino-ken"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The cuisine of Hong Kong touched off a journey of exploration into the depth and richness of Chinese cooking. The chef studied each region’s history and culture to plumb the origins of each. His passion shines as he explains the roots of each cuisine, referring to his own experiences and the menu in Cantonese. Peking duck as standard fare ensures he never forgets where he came from. Patient work making miso and rolling dough drive his zeal for constant improvement...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-3-6%20Awajimachi%2C%20Chuo-ku%2C%20Osaka%2C%20541-0047%2C%20Japan"
    pageTitle="Mashino Ken"
  />
);

export default MashinoKen;
