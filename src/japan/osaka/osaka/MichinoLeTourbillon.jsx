...
const MichinoLeTourbillon = () => (
  <RestaurantPage
    restaurantName="Michino Le Tourbillon"
    address="6-9-11 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81664516566"
    website="https://www.michino.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The raison d'être of his restaurant is service, explains Tadashi Michino. Put another way, the true purpose of the restaurant is not to enrich oneself but to do what is right for others. Just as other phenomena are constantly changing, Michino’s cuisine never repeats itself; tomorrow a different wind will blow. Today, Michino’s whirlwind (or ‘tourbillon’) is a cuisine whose sensibilities follow the rules of nature. Desserts, made by his wife, are a fresh new wind...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-9-11%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Michino Le Tourbillon"
  />
);

export default MichinoLeTourbillon;
