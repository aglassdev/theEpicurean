...
const PonteVecchio = () => (
  <RestaurantPage
    restaurantName="PONTE VECCHIO"
    address="1-8-16 Kitahama, Chuo-ku, Osaka, 541-0041, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81662297770"
    website="https://www.ponte-vecchio.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Daisuke Yamane insists on originality in everything about his restaurant. Leather seating, show plates of Venetian glass and silverware are all designed by the chef. One intriguing offering, inspired by Yamane’s days in Italy, is ‘the world’s most luxurious pauper food’, a dish made with potatoes and caviar. Each ingredient complements the other, converging in a harmonious whole...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-8-16%20Kitahama%2C%20Chuo-ku%2C%20Osaka%2C%20541-0041%2C%20Japan"
    pageTitle="PONTE VECCHIO"
  />
);

export default PonteVecchio;
