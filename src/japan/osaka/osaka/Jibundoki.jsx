...
const Jibundoki = () => (
  <RestaurantPage
    restaurantName="JIBUNDOKI"
    address="4-5-11 Minamikyuhojimachi, Chuo-ku, Osaka, 541-0058, Japan"
    cuisine="Teppanyaki, Okonomiyaki"
    priceRange="¥¥"
    phoneNumber="+81662531661"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/jibundoki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef pours his creativity into teppanyaki dishes of incredible variety. In true Osaka style, both pork and mixed okonomiyaki are available. Though the batter is thick, the finished texture is light. Imaginative grilled skewers hint at the cuisines of many countries, with offerings such as nama-fu, salmon tartare and tteokbokki. All items are served in bite-sized pieces, so patrons can enjoy sampling a variety of flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-5-11%20Minamikyuhojimachi%2C%20Chuo-ku%2C%20Osaka%2C%20541-0058%2C%20Japan"
    pageTitle="JIBUNDOKI"
  />
);

export default Jibundoki;
