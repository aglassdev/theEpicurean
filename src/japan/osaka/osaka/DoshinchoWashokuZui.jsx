...
const DoshinchoWashokuZui = () => (
  <RestaurantPage
    restaurantName="Doshincho Washoku Zui"
    address="2-4-13 Doshin, Kita-ku, Osaka, 530-0035, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81648001551"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/doshincho-washoku-zui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Zui’ means ‘fresh and lively’, which applies equally well to both fare and chef. His cheerful personality and energetic expression reflect his passion for cuisine and service. As a restaurateur who studied in Kyoto, the chef makes Rishiri kombu and light-coloured dried bonito flakes the foundation on which he works. Each dish is restricted to just two ingredients, so each component leaves a strong impression. He is especially adept at pairing ingredients with their own dashi, as seen in the sea bream sashimi accompanied by a jellied broth of sea bream dashi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4-13%20Doshin%2C%20Kita-ku%2C%20Osaka%2C%20530-0035%2C%20Japan"
    pageTitle="Doshincho Washoku Zui"
  />
);

export default DoshinchoWashokuZui;
