...
const TreLaise = () => (
  <RestaurantPage
    restaurantName="Être à l'aise"
    address="1-26-2 Uemachi, Chuo-ku, Osaka, 540-0005, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81667623993"
    website="https://www.etrealaise.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The intimate dining space wraps you in the warmth exuded by the couple at its heart. The chef’s cuisine and the wine pairings of his sommelier wife are a perfect match. French duck and lamb are dressed in rich sauces, their flavours supported by patiently prepared consommé and soup stock. The couple work in tandem like a well-oiled machine to put their guests at ease...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-26-2%20Uemachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0005%2C%20Japan"
    pageTitle="Être à l'aise"
  />
);

export default TreLaise;
