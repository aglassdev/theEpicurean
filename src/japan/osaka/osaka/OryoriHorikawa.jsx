...
const OryoriHorikawa = () => (
  <RestaurantPage
    restaurantName="Oryori Horikawa"
    address="4-8-17 Temma, Kita-ku, Osaka, 530-0043, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81671739388"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/oryori-horikawa"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-8-17%20Temma%2C%20Kita-ku%2C%20Osaka%2C%20530-0043%2C%20Japan"
    pageTitle="Oryori Horikawa"
  />
);

export default OryoriHorikawa;
