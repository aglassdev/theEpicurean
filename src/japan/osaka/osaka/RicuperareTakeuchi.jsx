...
const RicuperareTakeuchi = () => (
  <RestaurantPage
    restaurantName="ricuperare TAKEUCHI"
    address="1-4-3 Tosabori, Nishi-ku, Osaka, 550-0001, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81644004969"
    website="https://www.takeuchi-italia.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wood, charcoal and straw all fuel the cooking flames at this trattoria. The aim is to find the perfect flame for each ingredient. Beef is grilled over a wood fire for its moisture, a charcoal fire for its heat; for duck and bonito, straw is burned for its fragrance. True to its name, which means ‘recover’, the restaurant wastes nothing, using meat and vegetable ends to make breads and sauces. It also means to restore guests in both health and spirit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-3%20Tosabori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0001%2C%20Japan"
    pageTitle="ricuperare TAKEUCHI"
  />
);

export default RicuperareTakeuchi;
