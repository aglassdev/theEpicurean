...
const Kurubushi = () => (
  <RestaurantPage
    restaurantName="Kurubushi"
    address="4-12 Naniwacho, Kita-ku, Osaka, 530-0022, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81661478550"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kurubushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef of an izakaya opened this kappo as a sister establishment. He favours items with a salty taste, the better to keep the sake flowing. Vintage Japanese serving vessels and antique Western glasses delight the eye. The meal wraps up with seasonal takikomi-gohan or curry rice—with free refills, a welcome bonus. Omakase cooking bursting with creativity—enjoy it to your heart’s content...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-12%20Naniwacho%2C%20Kita-ku%2C%20Osaka%2C%20530-0022%2C%20Japan"
    pageTitle="Kurubushi"
  />
);

export default Kurubushi;
