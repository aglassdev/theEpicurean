...
const XiangHua = () => (
  <RestaurantPage
    restaurantName="xiang hua"
    address="1-13-8 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+819039208585"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/xiang-hua"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="True to its name, which means ‘serving the cuisine of every region of China’, the menu features a rich variety of regional dishes. The background to the recipes is a tale worth telling. As the chef used to teach at a cooking school, he is well-versed in his craft. He follows Confucius’s teaching of ‘Bù shí bù shí’, that people should eat foods in season. Tour the regional cuisines of China and taste its many fascinating flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-13-8%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="xiang hua"
  />
);

export default XiangHua;
