...
const KushikatsuGojoya = () => (
  <RestaurantPage
    restaurantName="Kushikatsu Gojoya"
    address="2-1-11 Uchihiranomachi, Chuo-ku, Osaka, 540-0037, Japan"
    cuisine="Kushiage"
    priceRange="¥"
    phoneNumber="+81669455045"
    website="https://94katu5jyoya.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The tempo in the kitchen is lively as cooks deep-fry these imaginative skewers. Order the omakase, which only ends when your belly is full. An amazing 25 types of skewers are normally available—you’ll want to see them all. Korean kimchi, Indian curry, Italian tomato sauce and so on take you on a journey from country to country. A fusion of Osaka’s fried foods with traditional cuisines of the world...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-1-11%20Uchihiranomachi%2C%20Chuo-ku%2C%20Osaka%2C%20540-0037%2C%20Japan"
    pageTitle="Kushikatsu Gojoya"
  />
);

export default KushikatsuGojoya;
