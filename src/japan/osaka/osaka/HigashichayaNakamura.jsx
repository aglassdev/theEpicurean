...
const HigashichayaNakamura = () => (
  <RestaurantPage
    restaurantName="Higashichaya Nakamura"
    address="1-25-8 Honjohigashi, Kita-ku, Osaka, 531-0074, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81661473686"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/higashichaya-nakamura"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The star of the menu is the bounty of the Hokuriku region. Seafood is delivered from the chef’s native Ishikawa Prefecture; seafood from every part of Ishikawa express the shifting seasons: Noto abalone, Nanao egg cockles, Chirihama oysters, and Kanaiwa male snow crab. As he cooks on an earthen charcoal brazier, the chef holds forth on their particular qualities and the passion of the fishermen with whom he does business. The restaurant name derives from the historic Higashi Chaya district of Kanazawa. From behind the counter, the chef waxes eloquent on the charms of his birthplace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-25-8%20Honjohigashi%2C%20Kita-ku%2C%20Osaka%2C%20531-0074%2C%20Japan"
    pageTitle="Higashichaya Nakamura"
  />
);

export default HigashichayaNakamura;
