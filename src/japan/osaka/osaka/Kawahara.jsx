...
const Kawahara = () => (
  <RestaurantPage
    restaurantName="Kawahara"
    address="2-4-21 Toyosaki, Kita-ku, Osaka, 531-0072, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81661314668"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kawahara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The interior of the restaurant, an old family home, exudes warmth. The affable owner-chef, Koji Kawahara, is creative too, as his menu abounds with ingenuity. Rishiri kombu kelp is used only for soup dishes, ensuring an elegantly flavoursome broth. In cooked items, however, ma-kombu is favoured, to bring out flavour. In an innovative touch, fish is marinated in miso before frying. An assortment of items come together in a single dish, creating a unique expression that adds variety to the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4-21%20Toyosaki%2C%20Kita-ku%2C%20Osaka%2C%20531-0072%2C%20Japan"
    pageTitle="Kawahara"
  />
);

export default Kawahara;
