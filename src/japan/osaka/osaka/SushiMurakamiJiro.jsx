...
const SushiMurakamiJiro = () => (
  <RestaurantPage
    restaurantName="Sushi Murakami Jiro"
    address="1-5-7 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81663413988"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushi-murakami-jiro"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Twice every evening, the chef and his wife present ‘Murakami theatre’, a comedy act. This gregarious couple are the star attraction at their restaurant. The husband is a sushi craftsman, gathering fish from throughout Japan with a keen eye for quality. The soy sauce and red vinegar from sake lees are sourced from his hometown, as human connections are important to him. Working with focused passion, he starts the nigiri with marinated tuna. The repartee between husband and wife makes for a lively and friendly atmosphere. There’s no script for this performance, which soon has patrons grinning...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5-7%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Sushi Murakami Jiro"
  />
);

export default SushiMurakamiJiro;
