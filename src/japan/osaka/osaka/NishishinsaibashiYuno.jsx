...
const NishishinsaibashiYuno = () => (
  <RestaurantPage
    restaurantName="Nishishinsaibashi Yuno"
    address="1-10-35 Nishishinsaibashi, Chuo-ku, Osaka, 542-0086, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81662813690"
    website="https://yuuno-nisishinsaibashi.gorp.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Dreaming up cuisine that matches the food to the guest is the mission of this Naniwa kappo. The menu’s called ‘Yuno’s omakase’ proclaiming a free-and-easy approach that strays from the norms of Japanese cuisine. Sashimi assortments are paired with onion dipping sauce or condiments; grilled items are dressed with vegetable sauces. Fishbone broth used in hot-pot fare attests to the restaurant’s spirit of wasting nothing. Come to enjoy the chef’s playful spirit and flavours of Osaka expressed through quality ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-10-35%20Nishishinsaibashi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0086%2C%20Japan"
    pageTitle="Nishishinsaibashi Yuno"
  />
);

export default NishishinsaibashiYuno;
