...
const Tenboshi = () => (
  <RestaurantPage
    restaurantName="Tenboshi"
    address="7-10-9 Tenjimbashi, Kita-ku, Osaka, 531-0041, Japan"
    cuisine="Tempura"
    priceRange="¥¥"
    phoneNumber="+81648018855"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/tenboshi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tenboshi is managed by Numata, a developer of tempura restaurants. The chain has several locations, but this one is popular for its prices and casual style. Born in Amakusa, the chef gets many ingredients from his native Kumamoto, as well as other parts of Kyushu. Tempura, fried in a blended of fresh-pressed sesame and cottonseed oils, is light and airy. Providing seafood and vegetables alternately, with dipping sauces to set off each item to advantage, is one way to show off individuality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-10-9%20Tenjimbashi%2C%20Kita-ku%2C%20Osaka%2C%20531-0041%2C%20Japan"
    pageTitle="Tenboshi"
  />
);

export default Tenboshi;
