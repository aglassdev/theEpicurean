...
const SushidokoroKurosugiShinkan = () => (
  <RestaurantPage
    restaurantName="Sushidokoro Kurosugi Shinkan"
    address="10F, 1-10-22 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81663470919"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushidokoro-kurosugi-shinkan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The focus is on à la carte out of a desire to be customers’ regular haunt. Fish is carefully prepared, with red vinegar for the sushi rice, in deference to the history of nigiri. White-fleshed fish is pressed between sheets of kombu; sweet shrimp is marinated with miso for an added twist. In response to customer requests for lighter flavours, young onion sprouts and cabbage are offered as toppings. ‘Shinkan’ in the name means, very roughly, ‘pouring my heart into every morsel of sushi’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%201-10-22%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Sushidokoro Kurosugi Shinkan"
  />
);

export default SushidokoroKurosugiShinkan;
