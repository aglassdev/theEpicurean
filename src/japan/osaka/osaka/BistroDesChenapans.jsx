...
const BistroDesChenapans = () => (
  <RestaurantPage
    restaurantName="Bistro des Chenapans"
    address="2-14-1 Kyomachibori, Nishi-ku, Osaka, 550-0003, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81661473666"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/bistro-des-chenapans"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef of this bistro takes pride in his meat cuisine, having studied meat processing in Paris. Casual prix fixe menus of hamburger steak and the like are popular at lunchtime. In the evening, guests can dine à la carte from the charcuterie, cassoulet and so forth. In a bow to the chef’s roots in Shiga Prefecture, Omi beef is used in the steak and fries. Meat is drizzled in oil as it grills to bring out its aroma, and seasoned simply with salt and pepper...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-14-1%20Kyomachibori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0003%2C%20Japan"
    pageTitle="Bistro des Chenapans"
  />
);

export default BistroDesChenapans;
