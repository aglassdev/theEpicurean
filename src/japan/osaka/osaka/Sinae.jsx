...
const Sinae = () => (
  <RestaurantPage
    restaurantName="SINAE"
    address="2F, 2-4-12 Fushimimachi, Chuo-ku, Osaka, 541-0044, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81662016556"
    website="https://sinae.jp"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="‘Sinae’ is an acronym for ‘simple, natural, essence’. These principles support the cuisine of Kazuhiko Daito, who values the natural features of the region where he works. The pure white vessels express the notion of ‘French cuisine, but in a uniquely Japanese style’. Daito transforms Japan-grown ingredients using traditional techniques, as exemplified by his bisque of Japanese tiger prawn. Platters with a wide variety of root vegetables roasted or fried remind us of the warmth and bounty of the earth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-4-12%20Fushimimachi%2C%20Chuo-ku%2C%20Osaka%2C%20541-0044%2C%20Japan"
    pageTitle="SINAE"
  />
);

export default Sinae;
