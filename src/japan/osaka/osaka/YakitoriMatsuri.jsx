...
const YakitoriMatsuri = () => (
  <RestaurantPage
    restaurantName="Yakitori Matsuri"
    address="2-2-33 Dojima, Kita-ku, Osaka, 530-0003, Japan"
    cuisine="Yakitori"
    priceRange="¥¥¥"
    phoneNumber="+81664597785"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/yakitori-matsuri"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant stands on the site of Yakitori Ichimatsu, the restaurant where the chef apprenticed, hence the name – a word formed by taking one character from Ichimatsu and one from the word meaning ‘hometown’. The omakase menu begins with flavour-rich chicken ham. Seasoning shifts from salty to sweet dipping sauce, offering a variation from light to rich flavours. Yakitori chicken is delicate, gauged according to the size of the chunks when bitten and the texture on the teeth...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-2-33%20Dojima%2C%20Kita-ku%2C%20Osaka%2C%20530-0003%2C%20Japan"
    pageTitle="Yakitori Matsuri"
  />
);

export default YakitoriMatsuri;
