...
const UkitachoIma = () => (
  <RestaurantPage
    restaurantName="Ukitacho Ima"
    address="2-5-27 Ukida, Kita-ku, Osaka, 530-0021, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81644004802"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/ukitacho-ima"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef spent years fine-tuning his skills in a Japanese restaurant in Hozenji Yokocho. While treasuring the lessons he learned there, he now blazes his own culinary trail. Mindful of how knife technique can affect the flavour of sashimi, he practises daily and his grounded approach to cooking is reassuring to watch. Bringing together everything he has learned over his career, he expresses it in cuisine of the ‘here and now’. Rather than just copy his mentor, the chef treads his own path in the gastronomic world...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-5-27%20Ukida%2C%20Kita-ku%2C%20Osaka%2C%20530-0021%2C%20Japan"
    pageTitle="Ukitacho Ima"
  />
);

export default UkitachoIma;
