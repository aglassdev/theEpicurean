...
const Quintocanto = () => (
  <RestaurantPage
    restaurantName="QUINTOCANTO"
    address="3-6-32 Nakanoshima, Kita-ku, Osaka, 530-0005, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81664791811"
    website="https://quinto-canto.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="QUINTOCANTO is a cucina creativa, respectful of Italian tradition yet creative. The chef delves deep into Italian hometown cooking and presents his results with a contemporary feel. While offering perennial favourites such as Catalana of foie gras and spaghetti pomodoro, the restaurant is always conjuring new and creative menu items. Like every restaurant managed by the Salone Group, QUINTOCANTO strives to be a salon that provides guests with graceful service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-6-32%20Nakanoshima%2C%20Kita-ku%2C%20Osaka%2C%20530-0005%2C%20Japan"
    pageTitle="QUINTOCANTO"
  />
);

export default Quintocanto;
