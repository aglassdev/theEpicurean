...
const OryoriYamada = () => (
  <RestaurantPage
    restaurantName="Oryori Yamada"
    address="4F, 4-7-7 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+818040139336"
    website="https://www.oryori-yamada.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Great ingenuity is poured into the menu to fill it with creative cuisine. Sashimi is garnished with condiments such as deep-fried onions and coarsely grated daikon. Fish cuisine is accented with sauces of mushrooms and vegetables. As a born-and-bred Osakan, the chef gravitates toward Naniwa’s traditional vegetables. The meal wraps up with three types of rice dishes: white rice and several accompaniments, pickled fish on rice and seasonal mixed rice. The generosity of free refills ensures that guests leave satisfied...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%204-7-7%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Oryori Yamada"
  />
);

export default OryoriYamada;
