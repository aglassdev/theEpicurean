...
const KyomachiboriNakamura = () => (
  <RestaurantPage
    restaurantName="Kyomachibori Nakamura"
    address="1-17-9 Kyomachibori, Nishi-ku, Osaka, 550-0003, Japan"
    cuisine="Tonkatsu"
    priceRange="¥¥"
    phoneNumber="+817012449662"
    website="https://www.instagram.com/@kyoumachibori_nakamura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The allure of tonkatsu in prix fixe dining. A wide range of cuts, including tenderloin, shoulder and ham, are served by the slice. Pork is deep-fried in lard at low temperatures, slow cooked in the lingering heat to produce meat overflowing with juiciness. Multiple brands of pork loin are on offer, so you can compare the texture of the meat and how the fat melts in the mouth. The meal ends with either katsudon or minced-pork cutlet curry. There’s more to fried pork than you ever realised...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-17-9%20Kyomachibori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0003%2C%20Japan"
    pageTitle="Kyomachibori Nakamura"
  />
);

export default KyomachiboriNakamura;
