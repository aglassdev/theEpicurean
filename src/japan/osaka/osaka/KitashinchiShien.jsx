...
const KitashinchiShien = () => (
  <RestaurantPage
    restaurantName="Kitashinchi Shien"
    address="2F, 1-7-19 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Yakitori"
    priceRange="¥¥"
    phoneNumber="+81663410611"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kitashinchi-shien"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Only prix fixe menus using chicken from Kyushu, prized for its quality, richness and texture, are available. Appetisers and stews, served first, are meticulously prepared, worthy of a much more formal restaurant. Zucchini smothered in Italian cheese suggests snow-clad landscapes of purest white. Chicken wings are lightly scored to make them easier to eat. A serving of white rice brings the meal to a close...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-7-19%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Kitashinchi Shien"
  />
);

export default KitashinchiShien;
