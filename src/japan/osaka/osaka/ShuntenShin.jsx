...
const ShuntenShin = () => (
  <RestaurantPage
    restaurantName="Shunten Shin"
    address="3-8-10 Ueshio, Tennoji-ku, Osaka, 543-0002, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+818024713998"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/shunten-shin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For this owner-chef, the tempura must have a refined aroma and not be oily, so the batter is applied thinly and the cooking oil used is mainly sesame and corn oil. Red aubergine is not soaked with oil all the way through, to preserve its vibrant juiciness. Asparagus tips and stalks are served at different times, calculated to ensure the right firmness for each. The most famous among them is the bowl of rice topped with tempura made from egg yolk, and raw uni...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-8-10%20Ueshio%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0002%2C%20Japan"
    pageTitle="Shunten Shin"
  />
);

export default ShuntenShin;
