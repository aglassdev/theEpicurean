...
const SobakiriKarani = () => (
  <RestaurantPage
    restaurantName="Sobakiri Karani"
    address="2-11-26 Sagisu, Fukushima-ku, Osaka, 553-0002, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81647962286"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sobakiri-karani"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sobakiri Karani worked with a woodworking artist to create the interior using re-used wooden materials. Large tables with mismatched chairs and unique ceiling paintings express a whimsical spirit. The menu’s appetisers, including tofu pickled in unrefined sake and duck-and-onion miso, tempts one to a cup of sake. Soba is coarse-ground and cut into both thin and thick noodles, furnishing variety in finish and flavours. Enjoy soba the way you like it in a congenial atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-11-26%20Sagisu%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0002%2C%20Japan"
    pageTitle="Sobakiri Karani"
  />
);

export default SobakiriKarani;
