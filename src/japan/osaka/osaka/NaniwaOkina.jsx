...
const NaniwaOkina = () => (
  <RestaurantPage
    restaurantName="Naniwa Okina"
    address="4-1-18 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81663615457"
    website="https://naniwa-okina.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The third-generation owner-chef decided to switch from machine-rolled to hand-rolled soba, so he learned the technique from a master. After thoroughly straining the soba, but without over-cooling it, he cuts the noodles neither thin nor thick, but just right. Dipping sauce is medium-salty to bring out the aroma of the buckwheat seeds, and the dish is arranged beautifully. A full range of snacks are on offer. We hope Japan will always have soba shops like this one...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-1-18%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Naniwa Okina"
  />
);

export default NaniwaOkina;
