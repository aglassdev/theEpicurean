...
const HommachiSeimenjoChukasobakobo = () => (
  <RestaurantPage
    restaurantName="Hommachi Seimenjo Chukasobakobo"
    address="B2F, Semba Centar Bldg Nigokan, 1-3-2 Sembachuo, Chuo-ku, Osaka, 541-0055, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81647087717"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/hommachi-seimenjo-chukasobakobo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="When you visit this ramen shop launched by a dried foods wholesaler, take note of the soup, which epitomises the brilliance of the dashi soup stock. Its well-rounded fragrance derives from multiple types of dried fish flakes. Kombu kelp, pike conger and chicken bones each add layers of flavour, creating body and finish. Heightening the taste are two types of noodles made on the premises: flat noodles to soak up the soup, round ones for their texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B2F%2C%20Semba%20Centar%20Bldg%20Nigokan%2C%201-3-2%20Sembachuo%2C%20Chuo-ku%2C%20Osaka%2C%20541-0055%2C%20Japan"
    pageTitle="Hommachi Seimenjo Chukasobakobo"
  />
);

export default HommachiSeimenjoChukasobakobo;
