...
const WashokuIikura = () => (
  <RestaurantPage
    restaurantName="Washoku Iikura"
    address="3-7-20 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81663146747"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/washoku-iikura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The range of menu items at this cosy Japanese restaurant has become extensive out of an urge to provide gracious service. Boiled, simmered and grilled items are here, of course, but the chef loves trying different ways of serving a single ingredient. Simmered conger eel, rich in flavour, becomes tempura; beef cutlet in dark-brown miso sauce is so popular it is standard fare among regular customers. For tipplers, bar snacks are served in small bowls, tailored to customers’ tastes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-7-20%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Washoku Iikura"
  />
);

export default WashokuIikura;
