...
const TonkatsuFujii = () => (
  <RestaurantPage
    restaurantName="Tonkatsu Fujii"
    address="1-11-5 Sembayashi, Asahi-ku, Osaka, 535-0012, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+818037732929"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/tonkatsu-fujii"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef came over from the world of French cuisine to fry tonkatsu. Ingredients and cooking techniques are a complex mix of various elements, creating flavours found nowhere else. Wielding a blend of multiple oils, the chef lends his skills as a baker to the coating. Red wine accentuates the sauce. Experience inspires the ideas of this chef, who was indelibly impressed by the tonkatsu craftsmen of Tokyo. A chance meeting that changed a life, resulting in beautiful flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-11-5%20Sembayashi%2C%20Asahi-ku%2C%20Osaka%2C%20535-0012%2C%20Japan"
    pageTitle="Tonkatsu Fujii"
  />
);

export default TonkatsuFujii;
