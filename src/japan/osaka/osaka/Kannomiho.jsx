...
const Kannomiho = () => (
  <RestaurantPage
    restaurantName="Kannomiho"
    address="2-2-14 Andojimachi, Chuo-ku, Osaka, 542-0061, Japan"
    cuisine="Izakaya"
    priceRange="¥¥"
    phoneNumber="+81672222510"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kannomiho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Open the menu and the first line reads, ‘Kannomiho is the shop run by Miho, who loves warmed sake’. Miho offers home-style seasonal fare accompanied by sake and all its appeal. Seared duck is a year-round favourite. As cup follows cup, unwind as the sake warms you right through. Songs of the Showa (postwar) era pipe through the dining room. With sake cup in hand, guests leisurely soak in the pub-like atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-2-14%20Andojimachi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0061%2C%20Japan"
    pageTitle="Kannomiho"
  />
);

export default Kannomiho;
