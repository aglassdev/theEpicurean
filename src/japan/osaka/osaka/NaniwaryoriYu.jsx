...
const NaniwaryoriYu = () => (
  <RestaurantPage
    restaurantName="Naniwaryori Yu"
    address="1-9-17 Higashitemma, Kita-ku, Osaka, 530-0044, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81662328558"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/naniwaryori-yu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Located close to the beloved Osaka Temmangu Shrine, the ‘Yu’ in the restaurant’s name is a character in the name of the chef’s mentor. Apprenticing at an old-school Osaka kappo, the chef learned not only cooking skills but also the bold spirit of a chef who holds court behind the counter. Courteous yet charming, his gregarious manner keeps the conversation flowing. The format is omakase, but with the flexibility to indulge diners’ whims...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-9-17%20Higashitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0044%2C%20Japan"
    pageTitle="Naniwaryori Yu"
  />
);

export default NaniwaryoriYu;
