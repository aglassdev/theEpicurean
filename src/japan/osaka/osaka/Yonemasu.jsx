...
const Yonemasu = () => (
  <RestaurantPage
    restaurantName="Yonemasu"
    address="1-9-16 Oyodominami, Kita-ku, Osaka, 531-0075, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81663451107"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/yonemasu"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-9-16%20Oyodominami%2C%20Kita-ku%2C%20Osaka%2C%20531-0075%2C%20Japan"
    pageTitle="Yonemasu"
  />
);

export default Yonemasu;
