...
const OryoriNonohara = () => (
  <RestaurantPage
    restaurantName="Oryori Nonohara"
    address="7-17-11 Fukushima, Fukushima-ku, Osaka, 553-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81676501955"
    website="https://www.oryori-nonohara.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant weaves the culture and traditional ceremonies of Japan into its menu. In the seventh lunar month, to celebrate Tanabata, the Star Festival, wanmono is served in lacquer bowls featuring the Milky Way in powdered precious metal. Other tableware also reflects the seasons. One wanmono item features a pairing of hamo and samatsu mushroom in a dish that recalls the tale of Hikoboshi and Orihime: the stars Altair and Vega, two lovers destined to meet but once a year. Sweets include umegae mochi, from Dazaifu Tenmangu Shrine in Fukuoka. Tea from the Yame area of Fukuoka is served in homage to the chef’s hometown...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-17-11%20Fukushima%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0003%2C%20Japan"
    pageTitle="Oryori Nonohara"
  />
);

export default OryoriNonohara;
