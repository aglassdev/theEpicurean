...
const AuSoleilCouchant = () => (
  <RestaurantPage
    restaurantName="au soleil couchant"
    address="1-14-25 Shitennoji, Tennoji-ku, Osaka, 543-0051, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81667768616"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/au-soleil-couchant"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The French tricolour flies over the district of Yuhigaoka. ‘Au soleil couchant’ means ‘at the setting sun’, a homage to this couple’s apprenticeship in Lyon and to Yuhigaoka, which means ‘hill of the setting sun’. The chef as culinary artisan commands the kitchen, while his pâtissière wife serves customers. As in any good bistro, portions are generous. Pleasingly, vegetables are used in abundance. Respect for tradition and true French spirit permeate the establishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-14-25%20Shitennoji%2C%20Tennoji-ku%2C%20Osaka%2C%20543-0051%2C%20Japan"
    pageTitle="au soleil couchant"
  />
);

export default AuSoleilCouchant;
