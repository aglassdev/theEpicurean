...
const PitakGohan = () => (
  <RestaurantPage
    restaurantName="PITAK GOHAN"
    address="2-2-13 Nakazaki, Kita-ku, Osaka, 530-0016, Japan"
    cuisine="Thai"
    priceRange="¥¥"
    phoneNumber="+81674106513"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/pitak-gohan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Pitak from Bangkok offers food from his native Thailand. Exotic aromas of herbs, spices and fish sauce thrill our souls. Temptations include salad of ground pork and glass noodles, a Thai-style grilled chicken dressed with coriander known as gai yang, and curry stir-fry with seafood and egg. The generous portions of the à la carte dishes encourage diners to share. The everyday flavours of Thailand live and breathe down this Nakazakicho alley...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-2-13%20Nakazaki%2C%20Kita-ku%2C%20Osaka%2C%20530-0016%2C%20Japan"
    pageTitle="PITAK GOHAN"
  />
);

export default PitakGohan;
