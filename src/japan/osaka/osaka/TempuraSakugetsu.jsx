...
const TempuraSakugetsu = () => (
  <RestaurantPage
    restaurantName="Tempura Sakugetsu"
    address="2-9-26 Shimanochi, Chuo-ku, Osaka, 542-0082, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81667558303"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/tempura-sakugetsu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant under the aegis of Shunsaiten Tsuchiya. The name means ‘new moon’, signifying a new beginning, and indeed Sakugetsu takes tempura in new directions while respecting tradition. The chef entrusted with this restaurant has his own approach, firmly emphasising the quality of the tempura pieces themselves. Those pieces are deep-fried in cottonseed oil mixed with sesame oil. In one innovation, the chef eschews the use of tempura paper, instead draining oil through skilled technique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-9-26%20Shimanochi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0082%2C%20Japan"
    pageTitle="Tempura Sakugetsu"
  />
);

export default TempuraSakugetsu;
