...
const LeNez = () => (
  <RestaurantPage
    restaurantName="Le Nez"
    address="2F, 1-3-29 Higashishinsaibashi, Chuo-ku, Osaka, 542-0083, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81662438500"
    website="http://lenez-osaka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hideyo Dezaki draws seasonal scenes using finger foods. His set menu, themed around a given aroma, begin with an amuse-gueule called ‘Hakoniwa’ or ‘miniature garden.’ Dezaki uses ingredients from his native Wakayama Prefecture, conveying his memories of home through scent. One example is the consommé, which combines foie gras, symbolic of French cuisine, with plums from his native Minabe...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-3-29%20Higashishinsaibashi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0083%2C%20Japan"
    pageTitle="Le Nez"
  />
);

export default LeNez;
