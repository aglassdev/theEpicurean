...
const Varier = () => (
  <RestaurantPage
    restaurantName="Varier"
    address="2F, Nakanoshima Daibiru, 3-3-23 Nakanoshima, Kita-ku, Osaka, 530-6102, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81648030999"
    website="https://www.restaurant-varier.com/index.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Varier’ is French for ‘change’. The restaurant’s name echoes Minoru Takai’s creed of continually moving forwards. Prix fixe menus change monthly, matching step with the shifting seasons. Takai weaves a story with ingredients that speak of their native lands, such as chicken and ume from Wakayama, or pork and sweet potatoes from Kagoshima. To cultivate the talents of the next generation of chefs, recipes are conceived as a team. ‘Modest spirit, humble heart’ is the driving force at Varier...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Nakanoshima%20Daibiru%2C%203-3-23%20Nakanoshima%2C%20Kita-ku%2C%20Osaka%2C%20530-6102%2C%20Japan"
    pageTitle="Varier"
  />
);

export default Varier;
