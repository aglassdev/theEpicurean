...
const KitashinchiKushikatsuBon = () => (
  <RestaurantPage
    restaurantName="Kitashinchi Kushikatsu Bon"
    address="B1F, 1-3-16 Dojima, Kita-ku, Osaka, 530-0003, Japan"
    cuisine="Kushiage"
    priceRange="¥¥¥"
    phoneNumber="+81663440400"
    website="http://www.kitchen-dan.jp"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kitashinchi Kushikatsu Bon serves skewers of unstinting luxury, including chateaubriand and foie gras. Creative combinations of delicacies, such as ‘pregnant kombu’ (kombu kelp with Pacific herring roe attached) with sea urchin and caviar or name-brand pork with truffles, are especially fun. To ensure a light palate, items are coated in powder-fine breadcrumbs and deep-fried in cottonseed oil. Osaka soul food, enriched with uniquely conceived ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%201-3-16%20Dojima%2C%20Kita-ku%2C%20Osaka%2C%20530-0003%2C%20Japan"
    pageTitle="Kitashinchi Kushikatsu Bon"
  />
);

export default KitashinchiKushikatsuBon;
