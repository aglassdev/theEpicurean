...
const DaidokoroKamiya = () => (
  <RestaurantPage
    restaurantName="Daidokoro Kamiya"
    address="1-10-12 Kyomachibori, Nishi-ku, Osaka, 550-0003, Japan"
    cuisine="Izakaya"
    priceRange="¥¥"
    phoneNumber="+817028314275"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/daidokoro-kamiya"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Seafood dishes and appetizers are the selling points at Daidokoro Kamiya. White-fleshed fish, an indispensable part of Osaka cuisine, is the essential component here. Potato salad is prepared with vegetables in season, while “Heshiko Pepe” is an udon noodle dish stir-fried with garlic and heshiko (fish pickled in rice-bran paste), inspired by spaghetti peperoncino. Ingredients gathered from every corner of Japan are supplemented with items from overseas, such as Australian lamb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-10-12%20Kyomachibori%2C%20Nishi-ku%2C%20Osaka%2C%20550-0003%2C%20Japan"
    pageTitle="Daidokoro Kamiya"
  />
);

export default DaidokoroKamiya;
