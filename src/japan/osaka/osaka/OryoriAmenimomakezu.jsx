...
const OryoriAmenimomakezu = () => (
  <RestaurantPage
    restaurantName="Oryori Amenimomakezu"
    address="4-10-17 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+81668097180"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/oryori-amenimomakezu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On a narrow alley off Oimatsu-dori, the backlit sign saying ‘Ame ni mo makezu’ (Be not Defeated by the Rain) arrests the eye. The script has a character all its own, as the owner-chef wrote it himself using chopsticks dipped in charcoal. Fare is prepared with plenty of fermented seasonings to complement the sake. Grilled fish is marinated in malted rice; chicken liver garnished with rice-bran bread. The way of living shown in Miyazawa Kenji’s masterpiece is manifested in the food on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-10-17%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Oryori Amenimomakezu"
  />
);

export default OryoriAmenimomakezu;
