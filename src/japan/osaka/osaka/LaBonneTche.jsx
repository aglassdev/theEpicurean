...
const LaBonneTche = () => (
  <RestaurantPage
    restaurantName="La bonne tâche"
    address="4-1-8 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81663121777"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/la-bonne-tache"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Red bell-pepper mousse, smoked salmon, roast duck; ever since it opened, the fare here has been simple, out of respect for the ingredients. The chef seeks to draw closer to perfection every day, advancing in his craft. Cooking skill, recipes and spirituality are all things he learned as an apprentice. Cast your eye around the kitchen and notice how all the pots and pans are gleaming. Respect for the tools of his trade drive the chef to keep honing his technique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-1-8%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="La bonne tâche"
  />
);

export default LaBonneTche;
