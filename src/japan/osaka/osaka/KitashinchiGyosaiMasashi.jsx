...
const KitashinchiGyosaiMasashi = () => (
  <RestaurantPage
    restaurantName="Kitashinchi Gyosai Masashi"
    address="2F, 1-5-26 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81663440398"
    website="https://masashi-kitashinchi.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Looking at the extensive menu, it’s fun to ask the chef which items he recommends. The cuisine runs the gamut from old-school Japanese to creative Western dishes. Grilled celery with vinegar and miso dressing, bite-sized beef cutlets and crab cream croquettes are popular year-round. Like an Osaka kappo, the chef is happy to adjust salt and portion size to suit customer tastes; like a ryotei, items are beautifully plated on attractive serving-ware...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-5-26%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Kitashinchi Gyosai Masashi"
  />
);

export default KitashinchiGyosaiMasashi;
