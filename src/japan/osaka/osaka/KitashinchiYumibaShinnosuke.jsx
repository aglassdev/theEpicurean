...
const KitashinchiYumibaShinnosuke = () => (
  <RestaurantPage
    restaurantName="Kitashinchi Yumiba Shinnosuke"
    address="7F, 1-5-21 Sonezakishinchi, Kita-ku, Osaka, 530-0002, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81644009780"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/kitashinchi-yumiba-shinnosuke"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef prizes nothing more than the temperature and aroma of his cooking. All dishes are prepared and served fresh, so counter seating is arranged around the preparation surface. In a twist, the sashimi is served with unconventional dressings such as nori seaweed soy sauce and monkfish liver with ponzu. Char-grilled beef and, in winter, shabu-shabu of bear and boar are prepared in front of customers. To finish, a selection of takikomi-gohan, rice seasoned with various ingredients, allows diners to enjoy comparing flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%201-5-21%20Sonezakishinchi%2C%20Kita-ku%2C%20Osaka%2C%20530-0002%2C%20Japan"
    pageTitle="Kitashinchi Yumiba Shinnosuke"
  />
);

export default KitashinchiYumibaShinnosuke;
