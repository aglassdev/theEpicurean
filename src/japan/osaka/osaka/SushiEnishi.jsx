...
const SushiEnishi = () => (
  <RestaurantPage
    restaurantName="Sushi Enishi"
    address="11-1 Kurosakicho, Kita-ku, Osaka, 530-0023, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81642567255"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/sushi-enishi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef learned Japanese cooking at his childhood home, a restaurant with attached inn; destiny led him down the path of the sushi master. Fish is from the markets of Temma and Kizu. Dashi soup stock is drawn from kombu kelp and dried bonito flakes; the addition of vegetables stems from his experience in other disciplines of Japanese cuisine. To modulate the flavours, sushi topping temperatures are varied and the tartness of citrus is used. The service is an experience of a lifetime, even if you’re a first-time guest. The shop’s name, enishi, or ‘connection’, signals the importance the chef places on human relationships...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11-1%20Kurosakicho%2C%20Kita-ku%2C%20Osaka%2C%20530-0023%2C%20Japan"
    pageTitle="Sushi Enishi"
  />
);

export default SushiEnishi;
