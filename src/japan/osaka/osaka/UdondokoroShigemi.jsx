...
const UdondokoroShigemi = () => (
  <RestaurantPage
    restaurantName="Udondokoro Shigemi"
    address="4-7-7 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Udon"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/udondokoro-shigemi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef’s top recommendation is the ‘hiyakake’: nothing but udon noodles in a golden-yellow broth. The dashi is Kansai-style, made with makombu seaweed for umami and finely chopped round herring and mackerel for flavour. Noodles are prepared with techniques learned in Kagawa. The cool broth brings out the supple body and elasticity of the noodles, showing how the goodness of each supports the other. The donburi bowl here brings together the udon cultures of Osaka and Kagawa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-7-7%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Udondokoro Shigemi"
  />
);

export default UdondokoroShigemi;
