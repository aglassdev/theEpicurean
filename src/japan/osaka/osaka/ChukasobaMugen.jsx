...
const ChukasobaMugen = () => (
  <RestaurantPage
    restaurantName="Chukasoba Mugen"
    address="5-5-10 Ebie, Fukushima-ku, Osaka, 553-0001, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/chukasoba-mugen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="While eating ramen, salt water from the noodles gradually dilutes the soup. You can experience this for yourself. First, pour a little of the soup into a separate bowl. Finish the noodles in the original bowl, then try sipping the reserved soup—the difference in taste will amaze you. The harmony created by a bowl of ramen goes beyond taste. The slurping of noodles forms a duet with the classical music in the background. The joy of ramen knows no bounds: ‘mugen’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-5-10%20Ebie%2C%20Fukushima-ku%2C%20Osaka%2C%20553-0001%2C%20Japan"
    pageTitle="Chukasoba Mugen"
  />
);

export default ChukasobaMugen;
