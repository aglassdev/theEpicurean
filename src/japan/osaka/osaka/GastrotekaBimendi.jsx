...
const GastrotekaBimendi = () => (
  <RestaurantPage
    restaurantName="gastroteka bimendi"
    address="1-5-9 Utsubohommachi, Nishi-ku, Osaka, 550-0004, Japan"
    cuisine="Spanish"
    priceRange="¥¥"
    phoneNumber="+81664791506"
    website="https://www.etxola.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This bar offers pinchos and tapas, or Spanish cuisine served on small plates. A casual place to enjoy Basque home cooking along with drinks from Spain. The Basque Country is rich with the blessings of mountains and sea, so the range of offerings covers a wide gamut. Each item is simple, the portions generous. Though a continent apart, Spain and Japan share a love of honest cooking in which natural flavours come to the fore...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5-9%20Utsubohommachi%2C%20Nishi-ku%2C%20Osaka%2C%20550-0004%2C%20Japan"
    pageTitle="gastroteka bimendi"
  />
);

export default GastrotekaBimendi;
