...
const NishitemmaNakamura = () => (
  <RestaurantPage
    restaurantName="Nishitemma Nakamura"
    address="4-5-25 Nishitemma, Kita-ku, Osaka, 530-0047, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81675068218"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/nishitemma-nakamura"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At a traditional Japanese restaurant, Akemi Nakamura discovered the elegance of traditional multi-course meals; at a kappo, she acquired a gift for adapting cuisine to the needs of the moment. She even devoted herself to flower arrangement to better understand the spirit of gracious service. This accumulation of experiences is encapsulated in her appetisers, beautiful presentations that highlight the flavours of each ingredient. Dishes of depth and complexity emerge one by one from the kitchen, garnished with flowers and leaves of the season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-5-25%20Nishitemma%2C%20Kita-ku%2C%20Osaka%2C%20530-0047%2C%20Japan"
    pageTitle="Nishitemma Nakamura"
  />
);

export default NishitemmaNakamura;
