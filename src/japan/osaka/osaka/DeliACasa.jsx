...
const DeliACasa = () => (
  <RestaurantPage
    restaurantName="DELI a Casa"
    address="1-2-5 Kawarayamachi, Chuo-ku, Osaka, 542-0066, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+818023937488"
    website="https://guide.michelin.com/en/osaka-region/osaka/restaurant/deli-a-casa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The daily fare and hometown cooking of Italy mould the concept here, following the owner-chef’s passion to get people to know the cuisine he grew to love in that country. A beguiling array of appetisers are served on small dishes, after the style of a mix-and-match antipasto misto. Enjoy them bit by bit, like a tour of the regions of Italy. Simple dishes, lovingly prepared, reach deep into the soul...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2-5%20Kawarayamachi%2C%20Chuo-ku%2C%20Osaka%2C%20542-0066%2C%20Japan"
    pageTitle="DELI a Casa"
  />
);

export default DeliACasa;
