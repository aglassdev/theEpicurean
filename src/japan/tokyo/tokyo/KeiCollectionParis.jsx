...
const KeiCollectionParis = () => (
  <RestaurantPage
    restaurantName="KEI Collection PARIS"
    address="49F, Toranomon Hills Station Tower, 2-6-2 Toranomon, Minato-ku, Tokyo, 105-5549, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81368112577"
    website="https://www.kei-collection.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A project by Kei Kobayashi – the chef who charmed the Paris culinary community. Billing his restaurant as a ‘grill with gastronomy’, he sends out his new wave in cuisine from the top of a skyscraper. In a first for him, KEI Collection PARIS focuses on à la carte items. Appetisers boast a spirit of playful creativity. Wagyu beef is grilled with grass over a traditional charcoal stove. The stylish interior and lights glittering like jewels create a real sense of being in the heart of the big city...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=49F%2C%20Toranomon%20Hills%20Station%20Tower%2C%202-6-2%20Toranomon%2C%20Minato-ku%2C%20Tokyo%2C%20105-5549%2C%20Japan"
    pageTitle="KEI Collection PARIS"
  />
);

export default KeiCollectionParis;
