...
const ChukasobaGinzaHachigou = () => (
  <RestaurantPage
    restaurantName="Chukasoba Ginza Hachigou"
    ...
    bio="Aiming to provide a full-course meal in a bowl, the chef infuses Chinese soba with his experience in French cuisine for a unique touch. Most revolutionary is the absence of sauce. The soup is crafted by extracting flavours as if for a consommé and then perfectly balancing them with the saltiness of cured ham. The wontons are filled with a paste of foie gras and truffles. He combines all the Western ingredients he has mastered over the years into a single bowl...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-14-2%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Chukasoba Ginza Hachigou"
  />
);

export default ChukasobaGinzaHachigou;
