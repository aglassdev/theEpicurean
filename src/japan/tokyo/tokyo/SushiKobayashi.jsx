...
const SushiKobayashi = () => (
  <RestaurantPage
    restaurantName="Sushi Kobayashi"
    address="8-2-10 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81362523288"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-kobayashi"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8-2-10%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Sushi Kobayashi"
  />
);

export default SushiKobayashi;
