...
const LeMondeGourmand = () => (
  <RestaurantPage
    restaurantName="Le Monde Gourmand"
    address="2-17-15 Midorigaoka, Meguro-ku, Tokyo, 152-0034, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81357268657"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/le-monde-gourmand"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef is experienced in the gastronomic ways of both Tokyo and Paris. Intent on reaching new heights while broadening the base of French cuisine, he opened a bistro. He showcases his talents with items baked in pie pastry. Beef simmered in red wine and potato au gratin highlight the appeal of regional cuisines. ‘Le Monde Gourmand’ translates as ‘the world of the food lover’, and as the name suggests, this is the place to sample the world of fine dining in a casual setting...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-17-15%20Midorigaoka%2C%20Meguro-ku%2C%20Tokyo%2C%20152-0034%2C%20Japan"
    pageTitle="Le Monde Gourmand"
  />
);

export default LeMondeGourmand;
