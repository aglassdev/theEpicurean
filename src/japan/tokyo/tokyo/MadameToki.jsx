...
const MadameToki = () => (
  <RestaurantPage
    restaurantName="Madame Toki"
    address="14-7 Hachiyamacho, Shibuya-ku, Tokyo, 150-0035, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81334612263"
    website="https://www.madame-toki.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Western-style brick house with red roof tiles catches the eye. Marble floors, antique furniture and chandeliers make it like visiting the villa of some European noble. The cuisine is simple and modern, scrupulously prepared and pleasing to the eye. A trolley arrives for you to choose your dessert, creating a moment of indulgence. The proprietress leads her excellent team of service staff...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14-7%20Hachiyamacho%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0035%2C%20Japan"
    pageTitle="Madame Toki"
  />
);

export default MadameToki;
