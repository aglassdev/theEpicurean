...
const Saucer = () => (
  <RestaurantPage
    restaurantName="Saucer"
    address="B1F, 2-7-10 Ebisunishi, Shibuya-ku, Tokyo, 150-0021, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81367127713"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/saucer"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The name is French: saucer used as a verb, to pour sauce or to drizzle sauce on bread. The standard fare is what the chef terms ‘saucer’: freshly baked bread on one plate and a sauce on the other. Consommé drawn over a period of three days is a key ingredient. Morel mushrooms in spring and sweetfish in summer impart seasonal flavours. As an apprentice, the chef was appointed saucier, sauce master; his confidence shines in his work today...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-7-10%20Ebisunishi%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0021%2C%20Japan"
    pageTitle="Saucer"
  />
);
