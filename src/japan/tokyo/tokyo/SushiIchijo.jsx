...
const SushiIchijo = () => (
  <RestaurantPage
    restaurantName="Sushi Ichijo"
    address="3-1-3 Higashinihombashi, Chuo-ku, Tokyo, 103-0004, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81366611335"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-ichijo"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef defends the traditions and skills of Edo-style sushi while showing creativity with some innovations of his own. Japanese halfbeak and horse mackerel are accented with ginger and mirin–soy reduction; simmered conger eel is served both salted and dipped in eel sauce for taste comparison. Nigiri is shaped using rice seasoned with red vinegar—a showcase of techniques cultivated over years of experience. Treading the path of the sushi chef was a dream in his teenage years. Steady devotion to craft is a lesson learned from sushi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-1-3%20Higashinihombashi%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0004%2C%20Japan"
    pageTitle="Sushi Ichijo"
  />
);

export default SushiIchijo;
