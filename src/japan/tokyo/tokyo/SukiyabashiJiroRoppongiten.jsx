...
const SukiyabashiJiroRoppongiten = () => (
  <RestaurantPage
    restaurantName="Sukiyabashi Jiro Roppongiten"
    address="3F, Roppongi Hills Residence B, 6-12-2 Roppongi, Minato-ku, Tokyo, 106-0032, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81354136626"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sukiyabashi-jiro-roppongiten"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="These days more and more guests are asking where the fish are caught. ‘If we could eat sushi where it’s caught, we wouldn’t need markets!’ retorts chef Takashi Ono. Discernment is a faculty built only slowly through long years of experience and knowledge. Along the way Ono has cultivated bonds of trust with seafood brokers, enabling him to source quality. The markets are the classic tale of ‘giri’ and ‘ninjo’, human connections forged in duty and loyalty. Sushi in purest form, stripped to its essence...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Roppongi%20Hills%20Residence%20B%2C%206-12-2%20Roppongi%2C%20Minato-ku%2C%20Tokyo%2C%20106-0032%2C%20Japan"
    pageTitle="Sukiyabashi Jiro Roppongiten"
  />
);

export default SukiyabashiJiroRoppongiten;
