...
const EspritCKeiGinza = () => (
  <RestaurantPage
    restaurantName="ESPRIT C. KEI GINZA"
    address="11F, 7-8-17 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81362746611"
    website="https://www.maisonkei.jp/esprit_c/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kei Kobayashi, renowned for his 3 Michelin Stars in Paris, moves onto the next stage with this harmonious blend of tradition and modernity in Ginza. Based on the concept of a ‘gourmet laboratory’, he offers à la carte dishes bursting with creativity. The C. in the restaurant name stands for both ‘cuisine’ and ‘creation’. The spirit of KEI breathes new life into French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11F%2C%207-8-17%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="ESPRIT C. KEI GINZA"
  />
);

export default EspritCKeiGinza;
