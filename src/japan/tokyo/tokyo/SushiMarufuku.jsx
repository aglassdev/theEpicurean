...
const SushiMarufuku = () => (
  <RestaurantPage
    restaurantName="Sushi Marufuku"
    address="3-17-4 Nishiogiminami, Suginami-ku, Tokyo, 167-0053, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81333346029"
    website="https://sushimarufuku.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aged sushi prepared with originality and passion. Yutaka Isayama rests fish to bring out aroma, tenderness and flavour, focusing closely on ageing technique to impart a certain wildness of taste. Snacks are interspersed so as not to jade the palate with a succession of intensely flavoured sushi toppings. Aged sushi pairs well with sake, so ask the proprietress, an accomplished sake sommelier, for suggestions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-17-4%20Nishiogiminami%2C%20Suginami-ku%2C%20Tokyo%2C%20167-0053%2C%20Japan"
    pageTitle="Sushi Marufuku"
  />
);

export default SushiMarufuku;
