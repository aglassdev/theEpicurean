...
const TsunokamizakaKoshiba = () => (
  <RestaurantPage
    restaurantName="Tsunokamizaka Koshiba"
    address="2F, 15 Arakicho, Shinjuku-ku, Tokyo, 160-0007, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81362730195"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tsunokamizaka-koshiba"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef learned his trade from a master of the Kansai school, and that experience shines in his dashi stock enriched with kombu kelp and his amuse-bouche of rod-shaped pressed sushi of chub mackerel. Appetisers are indispensable to the menu out of respect for time-honoured craftsmanship, but also to delight guests with a cornucopia of drinking snacks. A wide variety of grilled items and rice dishes offers plenty of choice. Diner satisfaction is the top priority here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%2015%20Arakicho%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0007%2C%20Japan"
    pageTitle="Tsunokamizaka Koshiba"
  />
);

export default TsunokamizakaKoshiba;
