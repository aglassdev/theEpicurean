...
const CommeLaMaison = () => (
  <RestaurantPage
    restaurantName="COMME À LA MAISON"
    address="6-4-15 Akasaka, Minato-ku, Tokyo, 107-0052, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81335053345"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/comme-a-la-maison"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yuji Wakui faithfully recreates the cuisine of southwestern France, taught to him by a chef from Landes. From pâté de campagne to terrine de foie gras and duck confit, all are prepared with heartfelt affection. But Wakui reserves a special fondness for soupe de garbure, a simmered mélange of ham, duck, white kidney beans and other ingredients that spreads the flavours of Landes to a ready audience in Tokyo. Unwavering faithfulness to tradition wordlessly expresses Wakui’s gratitude to his mentor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-4-15%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-0052%2C%20Japan"
    pageTitle="COMME À LA MAISON"
  />
);

export default CommeLaMaison;
