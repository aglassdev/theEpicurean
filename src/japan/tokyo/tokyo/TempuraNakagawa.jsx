...
const TempuraNakagawa = () => (
  <RestaurantPage
    restaurantName="Tempura Nakagawa"
    address="2-14-2 Tsukiji, Chuo-ku, Tokyo, 104-0045, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81335467335"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tempura-nakagawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef learned his tempura from a master versed in the old ways. The first tiger prawn is fried at just the right heat to bring out its aroma; the second is served rare to elicit sweetness. Conger eel is fragrantly fried with minimum sesame oil. Nakagawa’s trademark theory is that ‘tempura is a process of drying-out’, by which he means ingredients are steamed and grilled in their batter to remove moisture, bringing their flavour to the fore...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-14-2%20Tsukiji%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0045%2C%20Japan"
    pageTitle="Tempura Nakagawa"
  />
);

export default TempuraNakagawa;
