...
const AkasakaShimabukuro = () => (
  <RestaurantPage
    restaurantName="Akasaka Shimabukuro"
    address="3F, 3-21-8 Akasaka, Minato-ku, Tokyo, 107-0052, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81362777290"
    website="https://shimabukuro.tokyo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Chinese character for ‘food’ combines the characters for ‘person’ and ‘good’, hence the saying of Akasaka Shimabukuro, ‘food makes us better’. With gratitude for the bonds he forms with guests and those around him, the chef follows his own culinary path. The mellow flavour of the clear broth used in wanmono derives from shaved bonito flakes. Soba with dried mullet roe, interposed between menu items, and juwari soba, served at the end, are house creations using native species of buckwheat. The calligraphy on the wall says ‘go-en’, ‘personal connections’, echoing the restaurant’s whole-hearted devotion to its craft...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%203-21-8%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-0052%2C%20Japan"
    pageTitle="Akasaka Shimabukuro"
  />
);

export default AkasakaShimabukuro;
