...
const Myojaku = () => (
  <RestaurantPage
    restaurantName="Myojaku"
    address="B1F, 3-2-34 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+815031013945"
    website="https://myoujyaku.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hidetoshi Nakamura’s cuisine embodies harmony, subtlety, and purity. With minimal seasoning, he captures each ingredient’s subtle trace in water—using pristine submarine spring water drawn from deep beneath the ocean floor. Mountain and sea are intimately linked through water. Nakamura reminds us that we are a part of the magnificent connection between Nature and her laws. This elegant aesthetic, of beauty through simplicity, exudes modesty, returning us to a spirit of gratitude for the natural world...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%203-2-34%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Myojaku"
  />
);

export default Myojaku;
