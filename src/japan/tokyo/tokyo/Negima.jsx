...
const Negima = () => (
  <RestaurantPage
    restaurantName="Negima"
    address="B1F, 2-31-19 Kitaotsuka, Toshima-ku, Tokyo, 170-0004, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+818087398566"
    website="https://negimakitaike.gorp.jp"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-31-19%20Kitaotsuka%2C%20Toshima-ku%2C%20Tokyo%2C%20170-0004%2C%20Japan"
    pageTitle="Negima"
  />
);

export default Negima;
