...
const LesCopainsDeDominiqueBouchet = () => (
  <RestaurantPage
    restaurantName="Les Copains de DOMINIQUE BOUCHET"
    address="B1F, 5-1-8 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81362646566"
    website="https://www.lescopains.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bistro by Dominique Bouchet. The theme is ‘bistronomy’: a bistro with added gastronomic enhancements. Favourites such as pâté en croûte and steak frites are everyday standards in France. Lobster macaroni is a Bouchet speciality that captures the hearts of Parisian epicures. Savour the profundity of French cuisine from popular fare to modern haute cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%205-1-8%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Les Copains de DOMINIQUE BOUCHET"
  />
);

export default LesCopainsDeDominiqueBouchet;
