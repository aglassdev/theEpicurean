...
const GendaisaryoGinzaFugetsudo = () => (
  <RestaurantPage
    restaurantName="Gendaisaryo Ginza Fugetsudo"
    address="2F, 6-6-1 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81335712900"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/gendaisaryo-ginza-fugetsudo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A restaurant by one of Tokyo’s most venerable confectionary shops. Classic French is the theme here, with both meals and desserts sticking close to tradition, many selected from old cookbooks. Pâté en croute is a popular appetiser. White-fleshed fish is served meunière, meats roasted or wrapped in pastry, again showing a penchant for the traditional. Enjoy them all with sauces, the soul of French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%206-6-1%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Gendaisaryo Ginza Fugetsudo"
  />
);

export default GendaisaryoGinzaFugetsudo;
