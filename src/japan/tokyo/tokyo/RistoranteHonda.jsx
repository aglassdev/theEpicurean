...
const RistoranteHonda = () => (
  <RestaurantPage
    restaurantName="Ristorante HONDA"
    address="2-12-35 Kitaaoyama, Minato-ku, Tokyo, 107-0061, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81354143723"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ristorante-honda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Seasonal foodstuffs are the theme at this modern Italian restaurant. Tetsuya Honda’s culinary creations link the traditional cuisine of Italy with the seasons of Japan. The speciality, ‘Sea Urchin Tagliolini’, uses no cream, relying instead on lashings of sea urchin to achieve a rich, satisfying flavour. Honda strives to elicit the flavour of each ingredient...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-12-35%20Kitaaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0061%2C%20Japan"
    pageTitle="Ristorante HONDA"
  />
);

export default RistoranteHonda;
