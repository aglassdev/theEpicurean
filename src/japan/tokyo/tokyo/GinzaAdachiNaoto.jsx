...
const GinzaAdachiNaoto = () => (
  <RestaurantPage
    restaurantName="Ginza Adachi Naoto"
    address="2F, 7-6-5 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81335727088"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ginza-adachi-naoto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This restaurant values traditional techniques honed at a ryotei. The painstakingly prepared appetisers are a must-try. Seasonal iimushi, mochi rice topped with fish and steamed, is served as an amuse-bouche, paired with seasonal tastes such as sea urchin, salmon roe and chestnut. Instead of rice, the meal closes with konnyaku soba (devil’s-tongue noodles), to relieve uncomfortable fullness after the meal. Meticulous food preparation eloquently conveys the spirit and feeling of the owner-chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%207-6-5%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Adachi Naoto"
  />
);

export default GinzaAdachiNaoto;
