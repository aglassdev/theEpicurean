...
const JimbochoGokita = () => (
  <RestaurantPage
    restaurantName="Jimbocho Gokita"
    address="2-4-9 Nishikanda, Chiyoda-ku, Tokyo, 101-0065, Japan"
    cuisine="Yakitori, French"
    priceRange="¥¥¥"
    phoneNumber="+81362724365"
    website="https://jinbocho-gokita.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yuto Gokita is pioneering yakitori eaten with French sauces. In place of yakitori dipping sauce, Gokita favours Madeira and red-wine sauces prepared from chicken bones and calf broth. Skewers of chicken breast and shrimp are smothered in sauces of crustaceans. Skewers of chicken meatballs are accented with herb butter for a Bourgogne flavour. Reservations are required for the set menu which includes wood-grilled pigeon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-4-9%20Nishikanda%2C%20Chiyoda-ku%2C%20Tokyo%2C%20101-0065%2C%20Japan"
    pageTitle="Jimbocho Gokita"
  />
);

export default JimbochoGokita;
