...
const ShunkeianArakaki = () => (
  <RestaurantPage
    restaurantName="Shunkeian Arakaki"
    address="3-5-10 Minato, Chuo-ku, Tokyo, 104-0043, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+819077164125"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/shunkeian-arakaki"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A sanshin, the three-stringed lute of Okinawa, decorates the restaurant; a pot of awamori (Okinawan rice liquor) adorns the counter. Chef Kaname Arakaki is fiercely proud of his Okinawan roots. From his experience in Japanese cuisine, he creates appetisers, bowls of stew and amuse-bouches. Dishes are served in Yachimun pottery and Ryukyu lacquerware; tempura is accompanied by sea salt from Okinawa. At the entrance, a shiisaa, or Okinawan lion, quietly watches over...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-5-10%20Minato%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0043%2C%20Japan"
    pageTitle="Shunkeian Arakaki"
  />
);

export default ShunkeianArakaki;
