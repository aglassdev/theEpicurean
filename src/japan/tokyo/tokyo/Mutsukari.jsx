...
const Mutsukari = () => (
  <RestaurantPage
    restaurantName="Mutsukari"
    address="6F, 5-5-19 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81355686266"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/mutsukari"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef leads his team of cooks like the lead goose guiding its flock in flight. Clad in red armbands and snow-white kitchen uniforms, the kitchen team embodies the spirit of Japan. The accent on vegetables echoes the chef’s experience in shojin-ryori, the vegetarian regimen of Buddhist monks. Mutsukari’s repertoire varies widely, from ohitashi, a boiled vegetable side dish, and nikogori, jellied broth of meat or fish, to various deep-fried and grilled foods. Sashimi is dressed with a vinegar and nori jelly. Casual variations make for delightful idiosyncrasies...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%205-5-19%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Mutsukari"
  />
);

export default Mutsukari;
