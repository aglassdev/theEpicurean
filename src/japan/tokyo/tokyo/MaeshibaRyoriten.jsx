...
const MaeshibaRyoriten = () => (
  <RestaurantPage
    restaurantName="Maeshiba Ryoriten"
    address="B1F, 4-7-5 Tamagawa, Setagaya-ku, Tokyo, 158-0094, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81357979830"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/maeshiba-ryoriten-1205458"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The speciality is charcoal-grilled beef and sauce only. On this, the French cuisine of Taira Maeshiba is focused. Ingredients whose producers are listed by name, finely disciplined flame-tending techniques, and traditional yet distinctive sauces combine to form menus only Chef Maeshiba could compose. The fare is simple, the work meticulous...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%204-7-5%20Tamagawa%2C%20Setagaya-ku%2C%20Tokyo%2C%20158-0094%2C%20Japan"
    pageTitle="Maeshiba Ryoriten"
  />
);

export default MaeshibaRyoriten;
