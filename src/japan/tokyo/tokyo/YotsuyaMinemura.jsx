...
const YotsuyaMinemura = () => (
  <RestaurantPage
    restaurantName="Yotsuya Minemura"
    address="2F, 3-21 Arakicho, Shinjuku-ku, Tokyo, 160-0007, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81353154958"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/yotsuya-minemura"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The menu at this intimate counter kappo gives free rein to the skills and experience the chef acquired as an apprentice. The omakase set meal is a medley of sushi, soba noodles and other Japanese dishes. Graceful soup dishes and decoratively arranged sashimi are served, then steamed seafood sushi, and the meal ends with handmade 100% buckwheat soba. In an intriguing touch, a rolled omelette, created as a sushi artist would, is served as dessert. Culinary variety to entice any diner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%203-21%20Arakicho%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0007%2C%20Japan"
    pageTitle="Yotsuya Minemura"
  />
);

export default YotsuyaMinemura;
