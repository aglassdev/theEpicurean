...
const OryoriHoriuchi = () => (
  <RestaurantPage
    restaurantName="Oryori Horiuchi"
    address="9-15 Arakicho, Shinjuku-ku, Tokyo, 160-0007, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81332262337"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/oryori-horiuchi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The starting point for Mrs. Sayaka Horiuchi is her early life lived amid natural beauty. Considering that ‘the mountains water the village and feed the ocean,’ the dishes are prepared with a spirit of gratitude for ingredients from land and sea. Horiuchi nurtures relations with food producers nationwide who share her vision. Local vegetables are from farmers in Nerima, clams from fishermen in Kyoto. Her famous chicken offal stew is home cooking from her native Yamanashi Prefecture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9-15%20Arakicho%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0007%2C%20Japan"
    pageTitle="Oryori Horiuchi"
  />
);

export default OryoriHoriuchi;
