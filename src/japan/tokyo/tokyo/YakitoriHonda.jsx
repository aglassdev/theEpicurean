...
const YakitoriHonda = () => (
  <RestaurantPage
    restaurantName="Yakitori Honda"
    address="3-5-1 Minato, Chuo-ku, Tokyo, 104-0043, Japan"
    cuisine="Yakitori"
    priceRange="¥¥¥"
    phoneNumber="+81355402223"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/yakitori-honda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The boundless curiosity of Chef Takuya Honda shines in his yakitori. The Hinai chicken he uses is aged to bring out the umami. Honda constantly tinkers with his fare through trial and error to elicit the best flavour from each cut. Unimpressed by the usual, narrow choice of salt or sauce, he broadens the selection to include condiments like condensed soy sauce, balsamic soy sauce, and rice vinegar with herbs. The chef similarly puts effort into recommending the best wine pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-5-1%20Minato%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0043%2C%20Japan"
    pageTitle="Yakitori Honda"
  />
);

export default YakitoriHonda;
