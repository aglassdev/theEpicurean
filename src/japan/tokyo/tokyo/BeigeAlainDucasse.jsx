...
const BeigeAlainDucasse = () => (
  <RestaurantPage
    restaurantName="BEIGE Alain Ducasse"
    address="10F, Chanel Ginza Bldg, 3-5-3 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81351595500"
    website="https://beige-tokyo.com/"
    aliases={["Beige Alain Ducasse at Chanel Ginza"]}
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A restaurant produced by an international giant of the culinary world. In an astute reading of the times, he was among the first to include generous amounts of vegetables and cereals in his creations, dialing back the fats and sugars. As a result, both flavour and postprandial feeling are light. BEIGE Alain Ducasse preaches l’art de vivre through gastronomy in an emporium that exudes elegance, from the beige interior to the Jacquard fabrics and the design inspired by Coco Chanel...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%203-5-3%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="BEIGE Alain Ducasse"
  />
);

export default BeigeAlainDucasse;
