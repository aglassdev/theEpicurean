...
const EdomaeShinsaku = () => (
  <RestaurantPage
    restaurantName="Edomae Shinsaku"
    address="6F, 2-10-11 Nihombashiningyocho, Chuo-ku, Tokyo, 103-0013, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81356158728"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/edomae-shinsaku"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This tempura is the product of research on the theories of steaming, desiccation and roasting. Fish are rested to remove moisture and concentrate umami. Low-temperature frying is adopted to desiccate the pieces. Batter is made fragrant and dark brown through the Maillard reaction, resulting in tempura that seems somehow more grilled than fried. Uniquely, each piece is placed before the guest by hand, as in a sushi shop. The quest for ever-better technique is Edomae Shinsaku’s path to uniqueness...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6F%2C%202-10-11%20Nihombashiningyocho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0013%2C%20Japan"
    pageTitle="Edomae Shinsaku"
  />
);

export default EdomaeShinsaku;
