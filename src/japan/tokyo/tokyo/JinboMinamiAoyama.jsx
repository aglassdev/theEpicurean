...
const JinboMinamiAoyama = () => (
  <RestaurantPage
    restaurantName="JINBO MINAMI AOYAMA"
    address="4-11-13 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81368045955"
    website="https://jinbo-ma.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Yoshinaga Jinbo’s modern Italian cuisine paints scenes of the fields on the plate. His travels take him to farms across Japan, distilling the essence of the land into his cooking. The bagna càuda channels the breath of the seasons, capturing nature’s pulse. As an Ibaraki Food Ambassador, he carries the expectations of his hometown and forges a path to the future. Each dish reflects the farmers’ passion and his own deep commitment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-11-13%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="JINBO MINAMI AOYAMA"
  />
);

export default JinboMinamiAoyama;
