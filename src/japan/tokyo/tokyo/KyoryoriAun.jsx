...
const KyoryoriAun = () => (
  <RestaurantPage
    restaurantName="Kyoryori Aun"
    address="1-33-6 Tomigaya, Shibuya-ku, Tokyo, 151-0063, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+815036286763"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/kyoryori-aun"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Seasonal menus are supported by dashi broth drawn from ripened Rishiri kombu. Chef Eiji Onoyama uses dashi in everything, from appetizers to the final takikomi-gohan, rice seasoned with various ingredients. sashimi dishes are prepared in a jellied dashi broth style. They may be complemented with ume or nori seaweed, depending on the type of fish. Egg-yolk soy sauce is the secret ingredient that brings out the umami in tuna sushi. While the soup and takiawase add inflection, the focus is on the power of dashi broth to accentuate the flavour of the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-33-6%20Tomigaya%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0063%2C%20Japan"
    pageTitle="Kyoryori Aun"
  />
);

export default KyoryoriAun;
