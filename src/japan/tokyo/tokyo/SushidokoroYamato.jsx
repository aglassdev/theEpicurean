...
const SushidokoroYamato = () => (
  <RestaurantPage
    restaurantName="Sushidokoro Yamato"
    address="3-7-2 Tsukiji, Chuo-ku, Tokyo, 104-0045, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81335436311"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushidokoro-yamato"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The spare interior reminds us of a tea hut, its shelves casually stocked with water jugs used in the tea ceremony. On one earthen wall, an implement used to pierce bags of rice to take samples hangs like a flower arrangement. Omakase set menus place the accent on nigiri. First up is gizzard shad, an item notoriously difficult to get right. Boiled squid, conger eel and egg follow, each accomplished in proper sushi shop fashion. Refined, no-nonsense sushi, the way it’s meant to be...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-7-2%20Tsukiji%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0045%2C%20Japan"
    pageTitle="Sushidokoro Yamato"
  />
);

export default SushidokoroYamato;
