...
const Ryugin = () => (
  <RestaurantPage
    restaurantName="RyuGin"
    address="7F, Tokyo Midtown Hibiya, 1-1-2 Yurakucho, Chiyoda-ku, Tokyo, 100-0006, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81366300007"
    website="https://www.nihonryori-ryugin.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Seiji Yamamoto charts the vastness of Japanese cuisine. He handles his knives and tends his charcoal grill with relentlessly honed technique. He elucidates the properties of each ingredient and the best ways to prepare it with a scientific eye, displaying unwavering resolve. His winter menu is replete with fugu items, products of years of experience and passion for Japanese cuisine. Disarming frankness shines in Yamamoto’s favourite expression: ‘I’m a chef because I love cooking.’..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%20Tokyo%20Midtown%20Hibiya%2C%201-1-2%20Yurakucho%2C%20Chiyoda-ku%2C%20Tokyo%2C%20100-0006%2C%20Japan"
    pageTitle="RyuGin"
  />
);

export default Ryugin;
