...
const IlGiotto = () => (
  <RestaurantPage
    restaurantName="IL GiOTTO"
    address="5-21-9 Komazawa, Setagaya-ku, Tokyo, 154-0012, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81368059229"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/il-giotto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this white-walled detached house facing Komazawa-Koen Avenue, with its cosy, wood-lined interior, sounds of food preparation from the open kitchen, and the atmosphere of a shop run by a couple, guests feel invited into a home. Chef Naofumi Takahashi specializes in meat dishes, such as bruschetta with home-cured ham and simmered tripe. He takes special pride in his slow-aged, char-grilled meats. Beef, aged to enhance umami, is seasoned with salt and pepper...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-21-9%20Komazawa%2C%20Setagaya-ku%2C%20Tokyo%2C%20154-0012%2C%20Japan"
    pageTitle="IL GiOTTO"
  />
);

export default IlGiotto;
