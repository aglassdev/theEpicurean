...
const FuguClubMiyawakiBettei = () => (
  <RestaurantPage
    restaurantName="Fugu Club miyawaki Bettei"
    address="6-7-7 Tsukiji, Chuo-ku, Tokyo, 104-0045, Japan"
    cuisine="Fugu / Pufferfish"
    priceRange="¥¥¥"
    phoneNumber="+81362641879"
    website="https://fugu-club.com/fuguclub-bettei/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Takashi Miyawaki is taking fugu (blowfish) cuisine to a new level. Thick-cut sashimi is dressed with caviar and olive oil; skin and milt become spring rolls. While the fare is strictly Japanese, Western ingredients and oils are added to good effect. Even pots of stew are served individually, for a special twist. Prices are set quite reasonably to ensure people see fugu as accessible. Now a much-loved dish especially on celebratory occasions, fugu brings happiness through eating...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-7-7%20Tsukiji%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0045%2C%20Japan"
    pageTitle="Fugu Club miyawaki Bettei"
  />
);

export default FuguClubMiyawakiBettei;
