...
const ChisoKoryu = () => (
  <RestaurantPage
    restaurantName="Chiso Koryu"
    address="5F, 5-14-14 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81368763389"
    website="https://chisou-koryu.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant’s name declares that its food is created, not merely prepared, and indeed the cuisine here is infused with imagination. Kazuki Takagi spares no effort to furnish a delightfully creative bill of fare, casting his magic on ingredients from around the country. Puffer fish spring rolls, monaka wafer cake filled with monkfish liver and smoked daikon pickles testify to his inventive spirit. Sesame tofu and sea bream on rice with Japanese tea poured over it follow tradition...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%205-14-14%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Chiso Koryu"
  />
);

export default ChisoKoryu;
