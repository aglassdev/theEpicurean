...
const HritageByKeiKobayashi = () => (
  <RestaurantPage
    restaurantName="Héritage by Kei Kobayashi"
    address="45F, The Ritz-Carlton, Tokyo, 9-7-1 Akasaka, Minato-ku, Tokyo, 107-6245, Japan"
    cuisine="French, French Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81364348711"
    website="https://www.heritagebykei.com/ja"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=45F%2C%20The%20Ritz-Carlton%2C%20Tokyo%2C%209-7-1%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-6245%2C%20Japan"
    pageTitle="Héritage by Kei Kobayashi"
  />
);

export default HritageByKeiKobayashi;
