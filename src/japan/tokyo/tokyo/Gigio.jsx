...
const Gigio = () => (
  <RestaurantPage
    restaurantName="Gigio"
    address="4-24-19 Wakabayashi, Setagaya-ku, Tokyo, 154-0023, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81368054949"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/gigio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A trattoria where à la carte dining is encouraged with a comprehensive menu of regional cuisines. Pici served with tomato ragú laden with garlic and vegetable sformato are all flavours learned in the Italian countryside. A marble bar counter and Tuscan-style stone walls create a stylish space inspired by interiors in Tuscany. Steps from Shoin Shrine, this is Italian food culture with deep roots in daily life...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-24-19%20Wakabayashi%2C%20Setagaya-ku%2C%20Tokyo%2C%20154-0023%2C%20Japan"
    pageTitle="Gigio"
  />
);
