...
const SushiKourin = () => (
  <RestaurantPage
    restaurantName="SUSHI KOURIN"
    address="B1F, 11-10 Kamiyamacho, Shibuya-ku, Tokyo, 150-0047, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+81364079516"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-kourin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To encourage diners to drop in casually, the chef even accepts orders for single pieces. A blackboard crammed with lists of sushi items and snacks shows his commitment to service. This is the joy of the local sushi shop, where you can choose your items as you sit face-to-face with the chef. While easy to order, each item is still painstakingly prepared. He hangs out his shop curtain at 3 PM, so guests can start drinking while it’s still light out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%2011-10%20Kamiyamacho%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0047%2C%20Japan"
    pageTitle="SUSHI KOURIN"
  />
);

export default SushiKourin;
