...
const KasumichoYamagami = () => (
  <RestaurantPage
    restaurantName="Kasumicho Yamagami"
    address="3F, 4-2-13 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81354661270"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/kasumicho-yamagami"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Tomoaki Yamagami prunes back and seeks simplicity, so that fresh items are all the more striking for their concise arrangement. While the service style is omakase, a degree of freedom is mixed in, as guests can choose from multiple grilled items and rice dishes in earthenware pots. Seasoning respects the ingredients; guests’ feelings are inquired into and faithfully expressed in the menu. A harmonious atmosphere and reserved service convey the essence of Japanese dining culture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%204-2-13%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Kasumicho Yamagami"
  />
);

export default KasumichoYamagami;
