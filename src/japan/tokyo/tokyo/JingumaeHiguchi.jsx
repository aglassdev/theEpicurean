...
const JingumaeHiguchi = () => (
  <RestaurantPage
    restaurantName="Jingumae Higuchi"
    address="2-19-12 Jingumae, Shibuya-ku, Tokyo, 150-0001, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81334027038"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/jingumae-higuchi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef’s grandparents’ house once stood on this land. He harboured a lifelong dream of becoming a sushi artisan; the first knife he ever held was a gift from his grandfather. Never forgetting the spirit of the novice, the chef takes an honest, no-nonsense approach to his ingredients. “Letting the ingredients do the talking is not the same as doing nothing,” he says—and indeed, the chef devotes great time and effort to food preparation. As an apprentice, he learned from his mentor that cooking means thinking for yourself. The work of the old days inspires today’s creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-19-12%20Jingumae%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0001%2C%20Japan"
    pageTitle="Jingumae Higuchi"
  />
);

export default JingumaeHiguchi;
