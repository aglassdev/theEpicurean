...
const ShuteiTanaka = () => (
  <RestaurantPage
    restaurantName="Shutei Tanaka"
    address="3-25-7 Sumida, Sumida-ku, Tokyo, 131-0031, Japan"
    cuisine="Yakitori"
    priceRange="¥¥"
    phoneNumber="+81336176615"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/shutei-tanaka"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A competitive performance in yakitori run by two brothers, both hailing from other disciplines of Japanese cuisine. Dinner is served prix fixe, with the brothers taking turns serving. Chicken skewers are mainly served salted, keeping the focus on the flavour of the locally raised chicken. As the name ‘Shutei’, meaning something like pub, suggests, the neatly cut snacks and yakitori keep the sake going down smoothly. A number of choices are available for the final dish. Enjoy the ‘baton relay’ of the oyakodon, with the younger brother grilling the chicken and the elder brother wrapping it in egg...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-25-7%20Sumida%2C%20Sumida-ku%2C%20Tokyo%2C%20131-0031%2C%20Japan"
    pageTitle="Shutei Tanaka"
  />
);

export default ShuteiTanaka;
