...
const ShinjikoShijimiChukasobaKohaku = () => (
  <RestaurantPage
    restaurantName="Shinjiko Shijimi Chukasoba Kohaku"
    address="2-1-3 Nishirokugo, Ota-ku, Tokyo, 144-0056, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81366900893"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/shinjiko-shijimi-chukasoba-kohaku"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After taking over his mother’s restaurant, the owner-chef opened his doors in the town where he was born and raised. The key to the flavour lies in the shijimi clams from Lake Shinji in Shimane Prefecture, after which the restaurant is named. The soup utilizes the umami of the shellfish’s succinic acid. To enjoy the true taste of the broth, we recommend the salt-flavoured option. The names of the fishermen who caught each day's clams are written on the blackboard, showing respect for both ingredients and producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-1-3%20Nishirokugo%2C%20Ota-ku%2C%20Tokyo%2C%20144-0056%2C%20Japan"
    pageTitle="Shinjiko Shijimi Chukasoba Kohaku"
  />
);

export default ShinjikoShijimiChukasobaKohaku;
