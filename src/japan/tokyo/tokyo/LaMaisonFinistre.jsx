...
const LaMaisonFinistre = () => (
  <RestaurantPage
    restaurantName="La maison finistère"
    address="2F, 3-1-1 Ebisu, Shibuya-ku, Tokyo, 150-0013, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81367219874"
    website="https://maison-finistere.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Finistère is the westernmost department  of Bretagne. Chef Tomomitsu Oki named his restaurant after this region, where he and his friends burnished their culinary skills in their youth. Duck, lamb and lobster flown in from France are prepared in classic style. Ingredients are judiciously salted, while sauces are suffused with butter and cream for depth and richness. An homage to the traditional flavours of French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%203-1-1%20Ebisu%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0013%2C%20Japan"
    pageTitle="La maison finistère"
  />
);

export default LaMaisonFinistre;
