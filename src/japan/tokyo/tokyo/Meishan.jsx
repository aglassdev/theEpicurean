...
const Meishan = () => (
  <RestaurantPage
    restaurantName="Meishan"
    address="37-39 Yokoteramachi, Shinjuku-ku, Tokyo, 162-0831, Japan"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+81332602658"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/meishan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two sisters run this Sichuan restaurant, the elder tending flame and wok in the kitchen, the younger serving guests plates of steaming fare. Stir-fried vegetables, served with pickled vegetables and fermented tofu, are home-style favourites. Steamed chicken and mapo tofu use spices to bring out the flavours of the ingredients. Framed Chinese paper-cutout art adorns the walls; the music of the erhu sets the mood. The reverence for Chinese culture and food is unmistakable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=37-39%20Yokoteramachi%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0831%2C%20Japan"
    pageTitle="Meishan"
  />
);

export default Meishan;
