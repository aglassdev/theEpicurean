...
const BistrotVivienne = () => (
  <RestaurantPage
    restaurantName="Bistrot Vivienne"
    address="4-13-19 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81362732830"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/bistrot-vivienne"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A bistro run by a sommelier and chef. Keen to impart a sense of everyday life in France, the partners focus on charcuterie and hometown cooking. Populating the menu are delights such as cassoulet, quenelle and beef cheek simmered in wine. Respecting the classics, dishes baked in pie pastry are also included. In keeping with the regional tenor of the bistro, wines of every region are here for the asking; pair them with dishes of the same region for the consummate mariage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-13-19%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Bistrot Vivienne"
  />
);

export default BistrotVivienne;
