...
const HyakuyakuByTokuyamazushi = () => (
  <RestaurantPage
    restaurantName="Hyakuyaku by Tokuyamazush"
    address="9F, 4-4-2 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81355799760"
    website="https://salt-group.jp/shop/hyakuyaku/"
    aliases={["Hyakuyaku by Tokuyamazushi"]}
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A Shiga-born chef with deep expertise in fermentation oversees the cuisine, weaving the umami of fermentation into the kaiseki experience while preserving ancient culinary traditions. A staple of the menu is funazushi, a local specialty of Omi, known for its distinctive flavour from fish and rice cured in salt. To make it more approachable, it is paired with a consommé jelly of bear and venison, accented with honey. Seasonal highlights include winter bear hotpot, celebrating the bounty of game meats...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9F%2C%204-4-2%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Hyakuyaku by Tokuyamazush"
  />
);

export default HyakuyakuByTokuyamazushi;
