...
const ArakichoKintsugi = () => (
  <RestaurantPage
    restaurantName="Arakicho Kintsugi"
    address="B1F, 3-3-6 Yotsuya, Shinjuku-ku, Tokyo, 160-0004, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81367098704"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/arakicho-kintsugi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An intimate Japanese restaurant that fits well among the string of watering holes in the Arakicho area of Shinjuku. The two who run it are experts in cuisine and sake. Set menus are plotted with the tastes of sake drinkers in mind. One piece at a time, in small quantities, is an enjoyable way to dine. As the sake flows, boiled greens, sushi, fried items and other items are served with varying degrees of preparation and temperature. A seasonal selection of steamed items on rice ends the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%203-3-6%20Yotsuya%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0004%2C%20Japan"
    pageTitle="Arakicho Kintsugi"
  />
);

export default ArakichoKintsugi;
