...
const SushiRyujiroTOK = () => (
  <RestaurantPage
    restaurantName="Sushi Ryujiro"
    address="2-11-11 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81363845865"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-ryujiro"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The omakase set menu begins with medium-fatty tuna, a single piece of sushi that epitomises the pride of the sushi artisan. It testifies to the passion with which he prepares his tuna, celebrates the strong bond of trust between him and his wholesaler, encapsulates his gratitude for human relationships and embodies the teachings of his mentor. Items such as kappamaki, a sushi roll stuffed with lashings of cucumber, and rolled omelette in hot dashi attest to character as well as skill. The bustle of the cooks’ activity behind the counter brings satisfaction to the soul as well as the belly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-11-11%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="Sushi Ryujiro"
  />
);

export default SushiRyujiroTOK;
