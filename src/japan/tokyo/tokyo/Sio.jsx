...
const Sio = () => (
  <RestaurantPage
    restaurantName="sio"
    address="1-35-3 Uehara, Shibuya-ku, Tokyo, 151-0064, Japan"
    cuisine="Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81368047607"
    website="https://sio-yoyogiuehara.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Remixed music plays in the background of a dining room which has the feel of a vintage café. The venue is popular for its simple, casual style. The young, close-knit team puts guests at ease with their friendly service. Cuisine is based on French fare but interweaves influences from Italian and Japanese cooking. This is genre-free cuisine born of multinational creativity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-35-3%20Uehara%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0064%2C%20Japan"
    pageTitle="sio"
  />
);
