...
const HarukaMurooka = () => (
  <RestaurantPage
    restaurantName="Haruka Murooka"
    address="1-21-9 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="Creative"
    priceRange="¥¥¥"
    phoneNumber="+81364349168"
    website="https://harukamurooka.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dessert prix fixe by a restaurant pâtissière. Named after the owner, ‘Haruka’ comes from ‘fragrance of spring’, expressing her desire to move guests’ souls. Generous portions of fresh fruits from producers throughout Japan brighten the palate, with a vegetable dish served between the dessert courses. Each item is a work of delicate beauty, honouring the aesthetic heritage of the chef’s sculptor father and art lecturer mother...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-21-9%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="Haruka Murooka"
  />
);

export default HarukaMurooka;
