...
const AsakusaHirayama = () => (
  <RestaurantPage
    restaurantName="Asakusa Hirayama"
    address="1-3-14 Nishiasakusa, Taito-ku, Tokyo, 111-0035, Japan"
    cuisine="Soba"
    priceRange="¥¥"
    phoneNumber="+81358306857"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/asakusa-hirayama"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Asakusa Hirayama hangs out its shop curtain near Kappabashi; the calligraphy is done by the chef’s grandmother, a calligraphy teacher, expressing her joy in her grandson becoming an independent restaurateur. The counter seating harks back to his background as a kappo cook and his cheerful demeanour makes guests feel welcome. Soba is preceded by standards like jellied broth of conger eel or stew of duck breast. Tempura items are deep-fried one by one, as good as you’d find in a tempura specialty shop. The 100% buckwheat soba noodles, prepared with homemade flour made with unpolished buckwheat, are richly flavoursome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-14%20Nishiasakusa%2C%20Taito-ku%2C%20Tokyo%2C%20111-0035%2C%20Japan"
    pageTitle="Asakusa Hirayama"
  />
);

export default AsakusaHirayama;
