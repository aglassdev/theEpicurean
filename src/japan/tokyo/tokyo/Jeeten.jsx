...
const Jeeten = () => (
  <RestaurantPage
    restaurantName="jeeten"
    address="3-2-3 Nishihara, Shibuya-ku, Tokyo, 151-0066, Japan"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+81334699333"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/jeeten"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The billboard says ‘Chinese home cooking, Yoshida style’ and refers to nourishing Chinese food, based on yakuzen (medicinal food). Having experienced the healing power of Chinese cuisine, the owner-chef strives to devise dishes that restore bodily vigour. Helpful comments on the menu detail the effects of each, such as how mapo tofu stimulates the appetite, or sweet and sour pork with black vinegar relieves fatigue. The Beatles and other classics play in the background, making everyone feel at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-2-3%20Nishihara%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0066%2C%20Japan"
    pageTitle="jeeten"
  />
);

export default Jeeten;
