...
const WakiyaIchiemicharo = () => (
  <RestaurantPage
    restaurantName="Wakiya Ichiemicharo"
    address="6-11-10 Akasaka, Minato-ku, Tokyo, 107-0052, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81355748861"
    website="https://www.wakiya.co.jp/restaurants/ichiemi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The flagship restaurant of Yuji Wakiya, renowned pioneer of nouvelle chinois cuisine. With “tradition and creativity” as his motto, Wakiya professes a new style of Chinese cooking. The starter, ‘Nine Joys Assorted Appetiser’, is so named because nine is a number believed to bring good luck in China. The restaurant name means ‘once a day, let’s relax, laugh and have tea’. Cuisine and hospitality to bring a smile to your face...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-11-10%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-0052%2C%20Japan"
    pageTitle="Wakiya Ichiemicharo"
  />
);

export default WakiyaIchiemicharo;
