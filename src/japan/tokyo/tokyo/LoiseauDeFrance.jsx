...
const LoiseauDeFrance = () => (
  <RestaurantPage
    restaurantName="Loiseau de France"
    address="15 Ichigayafunagawaramachi, Shinjuku-ku, Tokyo, 162-0826, Japan"
    cuisine="French, Traditional Cuisine"
    priceRange="¥¥"
    phoneNumber="+81362807803"
    website="https://ldf-tokyo.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside Institut Français de Tokyo, time flows slowly, the bustle of the city forgotten. The chalk-white building, designed to suggest a small village in the south of France, gently enfolds a courtyard. Poached eggs in red wine sauce and beef simmered in red wine bring a taste of Saulieu, in Burgundy’s Côte d’Or. Desserts are classic sweets selected from a trolley, as tradition dictates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Ichigayafunagawaramachi%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0826%2C%20Japan"
    pageTitle="Loiseau de France"
  />
);

export default LoiseauDeFrance;
