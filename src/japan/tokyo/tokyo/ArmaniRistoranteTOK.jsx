...
const ArmaniRistoranteTOK = () => (
  <RestaurantPage
    restaurantName="ARMANI / RISTORANTE"
    address="10F, 5-5-4 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Italian, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81362747005"
    website="https://www.armani.com/ja-jp/armani-restaurant/experience/armani-ristorante-tokyo-ginza/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pale gold creates a bright and showy dining room. The aesthetic of fashion designer Giorgio Armani is on display throughout, from the décor to the cutlery. The menu is influenced by every region of Italy. Seafood is prepared using olive oil, in the style of southern Italy, while cutlets and stuffed pasta dishes represent the cuisine of northern Italy, offering a delightful variation. The focus on ingredients from Japan is to express the seasons of this country...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%205-5-4%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="ARMANI / RISTORANTE"
  />
);

export default ArmaniRistoranteTOK;
