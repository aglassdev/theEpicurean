...
const TempuraMaehira = () => (
  <RestaurantPage
    restaurantName="Tempura Maehira"
    address="4F, 2-8-16 Azabujuban, Minato-ku, Tokyo, 106-0045, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81364351996"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tempura-maehira"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%202-8-16%20Azabujuban%2C%20Minato-ku%2C%20Tokyo%2C%20106-0045%2C%20Japan"
    pageTitle="Tempura Maehira"
  />
);

export default TempuraMaehira;
