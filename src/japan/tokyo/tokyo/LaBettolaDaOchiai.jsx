...
const LaBettolaDaOchiai = () => (
  <RestaurantPage
    restaurantName="LA BETTOLA da Ochiai"
    address="1-21-2 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81335675656"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/la-bettola-da-ochiai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘La Bettola’ is Italian for ‘the dining hall’. With its casual atmosphere and fare that is good value for money, this trattoria draws throngs of guests day after day. The menu is crammed with regional cuisines and seasonal dishes. The prix fixe selection allows a choice of items—you’ll find it hard to make up your mind. For the appetiser, we recommend the combination platter, generous in both portions and variety. Sea urchin spaghetti is a perennial favourite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-21-2%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="LA BETTOLA da Ochiai"
  />
);

export default LaBettolaDaOchiai;
