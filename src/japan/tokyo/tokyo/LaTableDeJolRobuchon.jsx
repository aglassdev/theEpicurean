...
const LaTableDeJolRobuchon = () => (
  <RestaurantPage
    restaurantName="LA TABLE de Joël Robuchon"
    address="Yebisu Garden Place, 1-13-1 Mita, Meguro-ku, Tokyo, 153-0062, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81354241338"
    website="https://www.robuchon.jp/shop-list/latable"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A dining room in black and lavender, appointed in the style of a French chateau. The theme here is intimacy: Joël Robuchon done casual. The menu includes seasonal specialities and hometown cooking in a contemporary style, with preparations both simple and modern. Attentive service brightens the mood as the cuisine inspires lively conversation. Experience the true joy of gourmet dining...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Yebisu%20Garden%20Place%2C%201-13-1%20Mita%2C%20Meguro-ku%2C%20Tokyo%2C%20153-0062%2C%20Japan"
    pageTitle="LA TABLE de Joël Robuchon"
  />
);

export default LaTableDeJolRobuchon;
