...
const LeJardinDeKamo = () => (
  <RestaurantPage
    restaurantName="Le Jardin de Kamo"
    address="8-6 Nihombashihakozakicho, Chuo-ku, Tokyo, 103-0015, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber=""
    website="https://le-jardin-de-kamo.jimdofree.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name was chosen by the executive chef of Le Jardin des Sens, a restaurant in Montpellier. Highlighting the connection, Chef Kamoda proudly serves the cuisine of southern France. To suggest the flavours of the Mediterranean, he favours ingredients from the Seto Inland Sea. Following the teachings of his mentors, he refines seafood by pairing it with citrus fruits, herbs and spices. The stucco interior and warm service parlay the spirit of the south of France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8-6%20Nihombashihakozakicho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0015%2C%20Japan"
    pageTitle="Le Jardin de Kamo"
  />
);

export default LeJardinDeKamo;
