...
const SushiIchigo = () => (
  <RestaurantPage
    restaurantName="Sushi Ichigo"
    address="4-18-7 Kasuya, Setagaya-ku, Tokyo, 157-0063, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81333075591"
    website="https://www.sushi-ichigo.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A chance encounter with a single book sparked a lifelong connection with sushi for this chef. His omakase unfolds like a ninjo rakugo performance—beginning with light snacks, before moving into the main story: sushi. The sushi itself progresses like a narrative, a light opening act with squid, building through tuna, cresting with gizzard shad, and tapering off with egg to end the meal. Occasionally, the chef interjects a playful remark to his guests, much like a rakugo performer engaging the audience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-18-7%20Kasuya%2C%20Setagaya-ku%2C%20Tokyo%2C%20157-0063%2C%20Japan"
    pageTitle="Sushi Ichigo"
  />
);

export default SushiIchigo;
