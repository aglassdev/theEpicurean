...
const SignatureTOK = () => (
  <RestaurantPage
    ...
    website="https://www.mandarinoriental.com/ja/tokyo/nihonbashi/dine/signature"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pâté en croûte, fish bouillabaisse, lamb baked in pie crust: SIGNATURE breathes modern elements into recipes interwoven with French history. The chef reveres French sauces, while using herbs and vinegar for a light finish. From the dining room, decorated in blue throughout, the view is exhilarating. The service team’s pleasant demeanour also puts the mind at ease...."
