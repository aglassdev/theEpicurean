...
const TokyoChineseIchirin = () => (
  <RestaurantPage
    restaurantName="Tokyo Chinese Ichirin"
    address="1-5-8 Tsukiji, Chuo-ku, Tokyo, 104-0045, Japan"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+81335426663"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tokyo-chinese-ichirin"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sichuan cuisine that strives for a mellow spiciness. The evening prix fixe offering, which combines steamed spicy chicken with liver paté, is highly original. We recommend adding some of the distinctive à la carte items, such as shrimp chili sauce made with whole large shrimp, or fried egg and crab as airy as a soufflé. Weekday lunches are a set menu of twice-cooked pork and dandan noodles. A popular place, so queues form at times...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5-8%20Tsukiji%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0045%2C%20Japan"
    pageTitle="Tokyo Chinese Ichirin"
  />
);

export default TokyoChineseIchirin;
