...
const YakitoriOmino = () => (
  <RestaurantPage
    restaurantName="Yakitori Omino"
    address="1-38-4 Oshiage, Sumida-ku, Tokyo, 131-0045, Japan"
    cuisine="Yakitori"
    priceRange="¥¥¥"
    phoneNumber="+81356191892"
    website="https://www.yakitori-omino.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-38-4%20Oshiage%2C%20Sumida-ku%2C%20Tokyo%2C%20131-0045%2C%20Japan"
    pageTitle="Yakitori Omino"
  />
);

export default YakitoriOmino;
