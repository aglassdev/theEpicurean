...
const TempuraWineShino = () => (
  <RestaurantPage
    restaurantName="TEMPURA & WINE SHINO"
    address="2F, 4-2-15 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81366898733"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tempura-wine-shino"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners enter from the ground-floor café. Ascending the staircase beside the piano takes you to a space like the darkness lit by the full moon. ‘Tempura with wine’ is the concept here, with the focus on à la carte dining, with food presentation accompanied by descriptions of the day’s tempura. Among the natural wines are those based on agricultural methods that track the movements of celestial bodies. The atmosphere is mystical, as if tilting a glass of wine in the company of the moon...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%204-2-15%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="TEMPURA & WINE SHINO"
  />
);

export default TempuraWineShino;
