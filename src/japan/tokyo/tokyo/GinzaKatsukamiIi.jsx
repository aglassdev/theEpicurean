...
const GinzaKatsukamiIi = () => (
  <RestaurantPage
    restaurantName="GINZA KATSUKAMI II"
    address="4F, Kojun Bldg, 6-8-7 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Tonkatsu"
    priceRange="¥¥"
    phoneNumber="+81362646775"
    website="https://katsukami.com/ginza-katsukami_jp_02.html"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Service at this tonkatsu restaurant is prix fixe only. Along with the familiar fillet and pork loin cutlets, you’ll find rare cuts such as rump and round tip, fried one slice at a time. Several name-brand pork varieties are available to taste and compare, each one tender and succulent. A few unexpected entries, such as minced pork burgers, add whimsy into the mix. It’s a concept that makes sense: unique prix fixe menus of tonkatsu, each item served piping hot from the kitchen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%20Kojun%20Bldg%2C%206-8-7%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="GINZA KATSUKAMI II"
  />
);

export default GinzaKatsukamiIi;
