...
const RamenMatsui = () => (
  <RestaurantPage
    restaurantName="RAMEN MATSUI"
    address="4-25-10 Yotsuya, Shinjuku-ku, Tokyo, 160-0004, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ramen-matsui"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The husband boils the noodles; the wife garnishes them with spring onion and fermented bamboo shoots. Between them, they bring alpha and omega together to complete each bowl of ramen. Flavours are based on soy sauce, salt and dried sardines. To bring out the aroma, pure rice sake is added to chicken or seafood dashi soup stock. Several types of fragrant oil are used, deepening the flavour experience. Kombu kelp, scallops and wheat flour, all from Hokkaido, infuse the husband’s love of his homeland...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-25-10%20Yotsuya%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0004%2C%20Japan"
    pageTitle="RAMEN MATSUI"
  />
);

export default RamenMatsui;
