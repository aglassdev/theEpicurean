...
const Largent = () => (
  <RestaurantPage
    restaurantName="L'ARGENT"
    address="2F, Tokyo Club Bldg, 3-2-6 Kasumigaseki, Chiyoda-ku, Tokyo, 100-0013, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81362688427"
    website="https://largent.tokyo/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Applying experience in Paris and Copenhagen, the chef layers Scandinavian innovation on top of Japanese ingredients and the French classics. One embodiment of these influences is the foie gras torchon, an encounter between Kakegawa tea from the chef’s hometown and foie gras. Mushrooms delivered from producers in Shizuoka Prefecture are fermented and made into a soup. Modern French cuisine bursting with creativity, the chef’s roots and the bounty of food producers overlay each other to form a winning combination...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Tokyo%20Club%20Bldg%2C%203-2-6%20Kasumigaseki%2C%20Chiyoda-ku%2C%20Tokyo%2C%20100-0013%2C%20Japan"
    pageTitle="L'ARGENT"
  />
);
