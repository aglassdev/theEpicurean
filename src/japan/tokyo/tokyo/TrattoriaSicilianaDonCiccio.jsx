...
const TrattoriaSicilianaDonCiccio = () => (
  <RestaurantPage
    restaurantName="TRATTORIA SICILIANA Don Ciccio"
    address="1-2-6 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="Italian"
    priceRange="¥¥¥"
    phoneNumber="+81358431393"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/trattoria-siciliana-don-ciccio"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Don Ciccio’ is the nickname of a Sicilian Cosa Nostra boss in The Godfather. Used by those close to the Don, ‘Ciccio’ means ‘broad-shouldered gentleman’. The restaurant's name reflects the chef's aspiration of becoming a beloved ‘Don’ or culinary figure. He is a pioneer, dedicated to spreading the joy of Sicilian cuisine. This ‘Don Corleone of Sicilian cuisine’ conveys the flavours of the Mediterranean with lemons and herbs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-2-6%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="TRATTORIA SICILIANA Don Ciccio"
  />
);

export default TrattoriaSicilianaDonCiccio;
