...
const Kuhara = () => (
  <RestaurantPage
    restaurantName="Kuhara"
    address="2-25-38 Higashi, Shibuya-ku, Tokyo, 150-0011, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+815055963472"
    website="https://k-kuhara.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The friendly couple who run Kuhara—the chef a disciple of Japanese cuisine, the proprietress a welcoming figure in kappo wear—make us instantly feel at home. The signature fare is duck. In addition to salt-grilled duck, they offer chilled breast stew in summer, and a hot duck stew called jibuni in winter. Dried baby fish with soy and pepper on rice and Kokusho miso soup of root vegetables are must-try items. Unripe pepper is gathered by the couple and their children when they visit her hometown in Tochigi Prefecture. Kokusho miso soup brings back memories for the chef, who sampled it when he applied to a restaurant specialising in shojin ryori...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-25-38%20Higashi%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0011%2C%20Japan"
    pageTitle="Kuhara"
  />
);

export default Kuhara;
