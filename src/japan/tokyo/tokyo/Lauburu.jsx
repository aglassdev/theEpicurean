...
const Lauburu = () => (
  <RestaurantPage
    restaurantName="LAUBURU"
    address="6-8-18 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81334981314"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/lauburu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The number ‘64’ on the door refers to France’s 64th department: Pyrénées-Atlantiques, in the Basque Country. A devotee of pork culture, Shinichiro Sakurai is a lover of all things Basque, especially its pork cuisine. Having learned from charcuterie, Chef Sakurai places pork dishes front and centre: pâté and pig’s-head terrine as appetisers, boudin noir as a main dish. The Basque spirit lives and breathes in this back alley off Kotto-dori Street...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-8-18%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="LAUBURU"
  />
);

export default Lauburu;
