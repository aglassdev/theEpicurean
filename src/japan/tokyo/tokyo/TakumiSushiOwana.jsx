...
const TakumiSushiOwana = () => (
  <RestaurantPage
    restaurantName="Takumi Sushi Owana"
    address="4F, 1-17-17 Ebisuminami, Shibuya-ku, Tokyo, 150-0022, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81357252020"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/takumi-sushi-owana"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kenji Oana and his fellow artisans work with practiced synchrony, alternating servings of nigiri and drinking snacks. Rice is seasoned with either red or white vinegar; sushi of tuna and pickled daikon radish is shaped like o-hagi (rice cakes coated with sweet red bean paste), a legacy inherited from his mentor along with the shop’s name. Snacks are delightfully inventive: baked and steeped barracuda and eggplant, for example, or conger eel grilled with Saikyo miso. Never knowing what to expect accentuates the fun...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%201-17-17%20Ebisuminami%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0022%2C%20Japan"
    pageTitle="Takumi Sushi Owana"
  />
);

export default TakumiSushiOwana;
