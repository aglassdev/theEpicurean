...
const TachiguisushiSushikawa = () => (
  <RestaurantPage
    restaurantName="Tachiguisushi Sushikawa"
    address="1-62-6 Sasazuka, Shibuya-ku, Tokyo, 151-0073, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+819092603611"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tachiguisushi-sushikawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sushi got its start as hawker food that flourished in Edo (old Tokyo). To impart a feeling for that culture, Tachiguisushi Sushikawa is a standup sushi bar (and is what the name means). No drinking snacks; this is nigiri only, which you can order piece by piece according to your taste. Sushi toppings display an old-school craftsmanship. The chef harbours doubts about the recent trend of taking sushi up-market, which is why he recreated the atmosphere of a real-deal, no-nonsense sushi joint. A sushi local where regulars come to chat with the chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-62-6%20Sasazuka%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0073%2C%20Japan"
    pageTitle="Tachiguisushi Sushikawa"
  />
);

export default TachiguisushiSushikawa;
