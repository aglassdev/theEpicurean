...
const Tompachitei = () => (
  <RestaurantPage
    restaurantName="Tompachitei"
    address="4-3-4 Ueno, Taito-ku, Tokyo, 110-0005, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81338314209"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tompachitei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This popular spot lies in a back-alley near Ameya-Yokocho. Defending the restaurant’s noren is its third-generation chef, who grew up in this part of Ueno but sharpened his skills in Europe. Tonkatsu here is primarily pork loin cutlets. Applying his knowledge of Western techniques, the chef fries thick cuts of pork in relatively cool lard over a gentle flame. With rock salt, Worcestershire sauce, tonkatsu sauce and soy sauce on offer, it’s fun to compare how each tastes. Be prepared to queue first...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-3-4%20Ueno%2C%20Taito-ku%2C%20Tokyo%2C%20110-0005%2C%20Japan"
    pageTitle="Tompachitei"
  />
);

export default Tompachitei;
