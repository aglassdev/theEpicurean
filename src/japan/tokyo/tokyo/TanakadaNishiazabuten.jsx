...
const TanakadaNishiazabuten = () => (
  <RestaurantPage
    restaurantName="Tanakada Nishiazabuten"
    address="2-2-2 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Izakaya"
    priceRange="¥¥¥"
    phoneNumber="+81364470490"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tanakada-nishiazabuten"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From the Rosanjin crockery to the retro Showa-era coasters, Tadaaki Tanaka’s restaurant is an interplay between authenticity and playfulness. The comments on the menu are easy to understand, enticing with delicious descriptions. When the chef exclaims “Tabetenshai!” meaning “let’s eat” in the Hakata dialect, it makes you want to eat what you like, as much as you like. The courteous staff of this high-grade izakaya, a step above a kappo but not quite a ryotei, ensure you’ll enjoy your visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-2-2%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Tanakada Nishiazabuten"
  />
);

export default TanakadaNishiazabuten;
