...
const KandanishikichoSushiTakaharu = () => (
  <RestaurantPage
    restaurantName="Kandanishikicho Sushi Takaharu"
    address="1-17-5 Kandanishikicho, Chiyoda-ku, Tokyo, 101-0054, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81335189218"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/kandanishikicho-sushi-takaharu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Novel ideas meet time-honoured craftsmanship. The signature snack is cream croquette of tiger prawn, dressed in a reduction of shrimp miso. Deep-fried items are also offered, bringing a satisfaction rarely found at sushi shops. For its part, the sushi is prepared traditionally: brined, marinated or simmered. In part because of his language skills, the chef was tapped to cater a dinner meeting between the Japanese and American leaders...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-17-5%20Kandanishikicho%2C%20Chiyoda-ku%2C%20Tokyo%2C%20101-0054%2C%20Japan"
    pageTitle="Kandanishikicho Sushi Takaharu"
  />
);

export default KandanishikichoSushiTakaharu;
