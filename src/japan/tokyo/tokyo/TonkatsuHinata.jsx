...
const TonkatsuHinata = () => (
  <RestaurantPage
    restaurantName="Tonkatsu Hinata"
    address="2-13-9 Takadanobaba, Shinjuku-ku, Tokyo, 169-0075, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81363802424"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tonkatsu-hinata"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tonkatsu Hinata sources pork from two prestigious brands with different flavour profiles. Both are selected for the sweetness of their fat, tender meat, pleasantly firm texture, and abundant flavour. The shop buys pig carcasses whole, so it can offer a wide variety of cuts, including not only loin and tenderloin but also prime rib and rump. Order the evening prix fixe meal and you’ll enjoy the privilege of tasting rarer cuts— rump cap, pork jowl and eye-of-round— fried one after another...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-13-9%20Takadanobaba%2C%20Shinjuku-ku%2C%20Tokyo%2C%20169-0075%2C%20Japan"
    pageTitle="Tonkatsu Hinata"
  />
);

export default TonkatsuHinata;
