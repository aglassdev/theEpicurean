...
const Lclaireur = () => (
  <RestaurantPage
    restaurantName="L’éclaireur"
    address="6-6 Daikanyamacho, Shibuya-ku, Tokyo, 150-0034, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81368090711"
    website="https://leclaireur.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ichiei Taguma was taught that a great chef is one who creates a new culinary culture. He tinkered and tested throughout his apprenticeship, honing his creativity, an experience that led him to where he is today. When he became independent, Taguma decided to focus on wood-fired cooking. Smoking by skilful tending of flame is the key to his presentation of creative French cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-6%20Daikanyamacho%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0034%2C%20Japan"
    pageTitle="L’éclaireur"
  />
);

export default Lclaireur;
