...
const NishiazabuNoguchi = () => (
  <RestaurantPage
    restaurantName="Nishiazabu Noguchi"
    address="1-10-16 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81354145570"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/nishiazabu-noguchi"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Honest Japanese cuisine, overlaid with inspirations from the chef. Keen to ensure everyone’s satisfaction, Nishiazabu Noguchi offers an extensive menu. The delicate broth in soup dishes gets its flavour from kombu. Tsukuri are dressed in salt water flavoured with sudachi to bring out the fragrance of the seafood. For the main event, white rice, takikomi-gohan (rice with a variety of ingredients) and unadon (rice topped with eel) are all served, enhancing satisfaction. Devotion to the spirit of service shines in the generous free rice refills...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-10-16%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Nishiazabu Noguchi"
  />
);

export default NishiazabuNoguchi;
