...
const MatsukiTOK = () => (
  <RestaurantPage
    restaurantName="MATSUKI"
    address="2-23-3 Nakano, Nakano-ku, Tokyo, 164-0001, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+817032743730"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/matsuki-1206333"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The husband-and-wife team of chefs make you feel at home. Inspired by life in the south of France, the couple strive to recreate the unpretentious flavours of the countryside. Vegetable soup, fragrant with basil, encapsulates the memories of both chefs. With onion tarts, stewed beef à la Provençal and couscous, visions of everyday life in France float before your eyes. Accompany your meal with one of their select organic wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-23-3%20Nakano%2C%20Nakano-ku%2C%20Tokyo%2C%20164-0001%2C%20Japan"
    pageTitle="MATSUKI"
  />
);

export default MatsukiTOK;
