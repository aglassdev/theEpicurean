...
const Eman = () => (
  <RestaurantPage
    restaurantName="eman"
    address="1-3-6 Shirakawa, Koto-ku, Tokyo, 135-0021, Japan"
    cuisine="Spanish"
    priceRange="¥¥¥"
    phoneNumber="+81362403644"
    website="https://eman.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Drawing inspiration from Japan’s four seasons, the chef fuses ingredients with the cuisines of various regions of Spain. His choice to take the path of Spanish cuisine was set when he tried paella as a student. Obsessed with reproducing this epiphany for his guests, the chef offers Spanish and Japanese rice cuisine in tandem. Clams on rice is a Basque recipe, arranged in Fukagawa-meshi style. A deep dive into the hometown cuisines of Spain and Japan, in the heart of Kiyosumi Shirakawa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-3-6%20Shirakawa%2C%20Koto-ku%2C%20Tokyo%2C%20135-0021%2C%20Japan"
    pageTitle="eman"
  />
);
