...
const Sassa = () => (
  <RestaurantPage
    restaurantName="Sassa"
    address="5-13-6 Hiro, Shibuya-ku, Tokyo, 150-0012, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+817083067946"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sassa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kaiseki prepared with a sushi chef’s sensibility. Abalone risotto is a luxury, prepared with generous lashings of boiled abalone. In an original interpretation, tuna is sliced thin, to complement the light soy sauce. Rice is prepared a sushi chef’s way, cooked with a minimum of water to bring out the flavour when eaten. Pu-erh tea is served after dinner, reflecting the chef’s culinary experience in Shanghai. Bursting with passion and ambition to innovate, Sassa is moving Japanese cuisine forward...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-13-6%20Hiro%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0012%2C%20Japan"
    pageTitle="Sassa"
  />
);
