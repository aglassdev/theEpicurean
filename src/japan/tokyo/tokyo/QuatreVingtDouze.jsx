...
const QuatreVingtDouze = () => (
  <RestaurantPage
    restaurantName="Quatre Vingt Douze"
    address="2F, 1-9-5 Funabashi, Setagaya-ku, Tokyo, 156-0055, Japan"
    cuisine="French, French Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+817085133122"
    website="https://quatrevingtdouze.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="French cuisine overlays ingredients of varying flavours and textures to express a medley of tastes. That defining characteristic, says the chef, is the wellspring of his creative drive and the key to his approach in assembling his menu. Fruits, herbs and spices are all deployed to good effect and with a light touch to create his flavours. Fish and meat dishes always come with sauces, paying homage to the classics. The proprietress is in charge of the desserts. An intimate eatery from a couple who support each other like a synchronized team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-9-5%20Funabashi%2C%20Setagaya-ku%2C%20Tokyo%2C%20156-0055%2C%20Japan"
    pageTitle="Quatre Vingt Douze"
  />
);

export default QuatreVingtDouze;
