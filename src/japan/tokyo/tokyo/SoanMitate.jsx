...
const SoanMitate = () => (
  <RestaurantPage
    restaurantName="Soan Mitate"
    address="2F, 2-8-12 Azabujuban, Minato-ku, Tokyo, 106-0045, Japan"
    cuisine="Soba"
    priceRange="¥¥¥"
    phoneNumber="+81367226702"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/soan-mitate"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mitate means ‘the three freshes’: freshly ground, freshly kneaded and freshly boiled. Like the chef, most of the ingredients come from Toyama, and his experience with Japanese cuisine is evident. The set menu includes buckwheat-flour galettes of tuna and caviar as well as an assortment of delicacies served before the soba, which is are slender, cleanly cut 100% buckwheat noodles. Watching his practiced movements as he prepares the soba is an added entertainment. An impressive list of champagnes is also offered...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-8-12%20Azabujuban%2C%20Minato-ku%2C%20Tokyo%2C%20106-0045%2C%20Japan"
    pageTitle="Soan Mitate"
  />
);

export default SoanMitate;
