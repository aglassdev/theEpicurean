...
const KagurazakaIshikawa = () => (
  <RestaurantPage
    restaurantName="Kagurazaka Ishikawa"
    address="5-37 Kagurazaka, Shinjuku-ku, Tokyo, 162-0825, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+815031385225"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/kagurazaka-ishikawa"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Hideki Ishikawa’s guiding principle is ‘mui-shizen’: serve cuisine that is true to nature, free from artifice. Flavours are light, respecting each ingredient. Simplicity makes presentations all the more impressive, with consideration for harmony among flavours. Niigata rice is cooked fresh and served in earthen bowls, imparting the taste of the chef’s homeland. Kitchen and service staff work together with the practised solidarity of a well-rehearsed team...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-37%20Kagurazaka%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0825%2C%20Japan"
    pageTitle="Kagurazaka Ishikawa"
  />
);

export default KagurazakaIshikawa;
