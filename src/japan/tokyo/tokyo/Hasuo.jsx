...
const Hasuo = () => (
  <RestaurantPage
    restaurantName="HASUO"
    address="5-10-3 Hiro, Shibuya-ku, Tokyo, 150-0012, Japan"
    cuisine="Korean"
    priceRange="¥¥¥"
    phoneNumber="+81364564377"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/hasuo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The fare here is New Korean: traditional Korean cooking with a modern interpretation. The chef applies the techniques and sensibilities he learned studying Western cooking. Banchan with 16 side dishes is a revelation. The Imperial Crepe adhering to the five flavours and five colours, is a brightly coloured treat. Ganjang-gejang, sauce-marinated blue crab, is marinated lightly to suit modern tastes. Hasuo proclaims a new Korean cuisine, raising the food of the chef’s Korean homeland to a new level...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-10-3%20Hiro%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0012%2C%20Japan"
    pageTitle="HASUO"
  />
);

export default Hasuo;
