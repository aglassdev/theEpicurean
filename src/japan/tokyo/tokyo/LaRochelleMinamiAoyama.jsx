...
const LaRochelleMinamiAoyama = () => (
  <RestaurantPage
    restaurantName="La Rochelle Minami Aoyama"
    address="3-14-23 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81334785645"
    website="https://www.la-rochelle.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of Hiroyuki Sakai, the famed ‘Iron Chef’ of French cuisine. With the teachings of his mentor in his heart, Sakai was inspired in the port town of Rochelle to create his ‘French à la kaiseki’. The cuisine of Chef Takashi Kawashima is a colourful assemblage of dishes with a classic base infused with modern elements. The Anton Molnar painting on the wall pays tribute to the intersection of the past with the modern...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-14-23%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="La Rochelle Minami Aoyama"
  />
);

export default LaRochelleMinamiAoyama;
