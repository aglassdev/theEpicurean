...
const LaMaisonConfortable = () => (
  <RestaurantPage
    restaurantName="La Maison Confortable"
    address="4F, 3-7-4 Azabujuban, Minato-ku, Tokyo, 106-0045, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81368094433"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/la-maison-confortable"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Yosuke Akasaka studied for years under Pierre Gagnaire. From this legend of the French culinary world, Akasaka inherited the avant-garde sensibility that inspires his creativity. Combining seafood with meat and vegetables with fruit, Akasaka teases out unexpected qualities of the ingredients with which he works. While Gagnaire chose a table for his logo, Akasaka favours a house for his motif. The subtext is the same: a space that evokes the feelings of home, comfort and belonging; hence the name of the restaurant...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%203-7-4%20Azabujuban%2C%20Minato-ku%2C%20Tokyo%2C%20106-0045%2C%20Japan"
    pageTitle="La Maison Confortable"
  />
);

export default LaMaisonConfortable;
