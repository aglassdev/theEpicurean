...
const GinzaSushiIchidaiYugo = () => (
  <RestaurantPage
    restaurantName="Ginza Sushi Ichidai Yugo"
    address="4-14-15 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81362284593"
    website="https://www.ginzasushiichidai-yugo.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A white sign with an ebony rim. The characters seem to float, suggesting a personality that is strong yet gentle. The name is written on the noren in hiragana, exuding warmth: plain white surrounded by dyed cloth. Hearing that the restaurant is in Ginza, not far from the Kabukiza Theatre, we might expect to pay a premium, but the shop's philosophy is that sushi should be enjoyed casually, and the prices reflect that. The long, thin shape of the sushi adds substance to each piece. ‘Barachirashi’, sushi rice with items mixed in and sprinkled on top, is a lunchtime favourite...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-14-15%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Sushi Ichidai Yugo"
  />
);

export default GinzaSushiIchidaiYugo;
