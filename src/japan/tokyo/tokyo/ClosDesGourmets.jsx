...
const ClosDesGourmets = () => (
  <RestaurantPage
    restaurantName="Clos Des Gourmets"
    address="2F, 3-18-4 Shirokanedai, Minato-ku, Tokyo, 108-0071, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81362772358"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/clos-des-gourmets"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In his primary school graduation yearbook, the future chef wrote, “I want to be a chef”. He studied gastronomy in Paris, developing his most intimate relationships with a restaurant in the 7th arrondissement. The chef’s culinary philosophy, his restaurant’s name and his signature cuisine are all inherited from his mentor. One representative dish is tête de cochon, grilled cuts from a pig’s head. In this intimate eatery, guests are in close proximity with the chef, as if invited by a friend...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%203-18-4%20Shirokanedai%2C%20Minato-ku%2C%20Tokyo%2C%20108-0071%2C%20Japan"
    pageTitle="Clos Des Gourmets"
  />
);

export default ClosDesGourmets;
