...
const Lature = () => (
  <RestaurantPage
    restaurantName="LATURE"
    address="B1F, 2-2-2 Shibuya, Shibuya-ku, Tokyo, 150-0002, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81364505297"
    website="https://www.lature.jp/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Takuto Murota procures ingredients himself, hunting game in the mountains and growing vegetables in his home garden. Harmonious coexistence with nature is the theme of his cooking and nowhere is this conviction more evident than in his game dishes. Meat is grilled, bones and entrails made into sauces; nothing edible is wasted. Venison blood macarons have become emblematic of LATURE. Classic cuisine with a touch of modern sensibility conveys respect for life...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-2-2%20Shibuya%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0002%2C%20Japan"
    pageTitle="LATURE"
  />
);

export default Lature;
