...
const GinzaHabsburgVeilchen = () => (
  <RestaurantPage
    restaurantName="GINZA HABSBURG VEILCHEN"
    address="7F, 7-8-7 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Austrian"
    priceRange="¥¥¥"
    phoneNumber="+81355373226"
    website="https://ginza-habsburg.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Shingo Kanda is spreading Austrian culinary culture. Giving top billing to the cuisine of Vienna, Kanda serves traditional fare from each state of Austria. Wiener schnitzel and boiled ham are typical Viennese specialities. Kanda happily explains where he gets his recipes and tells anecdotes, explaining a cuisine unfamiliar to many of his diners. This dining experience is sure to spark your desire to visit Austria...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%207-8-7%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="GINZA HABSBURG VEILCHEN"
  />
);

export default GinzaHabsburgVeilchen;
