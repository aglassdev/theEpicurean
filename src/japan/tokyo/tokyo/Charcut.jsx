...
const Charcut = () => (
  <RestaurantPage
    restaurantName="CHARCUT"
    address="B1F, 1-11-5 Toranomon, Minato-ku, Tokyo, 105-0001, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81362054177"
    website="https://charcut.exblog.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The speciality here is charcuterie. Having learned his craft in a delicatessen in Lyons, Chef Takehiko Machisuji applies the knowledge and techniques of his mentors with patience and diligence. His accomplishment shines in appetisers such as salami, sausage and terrine. Dishes such as soupe de poisson, quenelle and choucroute convey the wonder of regional cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%201-11-5%20Toranomon%2C%20Minato-ku%2C%20Tokyo%2C%20105-0001%2C%20Japan"
    pageTitle="CHARCUT"
  />
);

export default Charcut;
