...
const TohakuanKaribe = () => (
  <RestaurantPage
    restaurantName="Tohakuan Karibe"
    address="4-23-19 Kasuya, Setagaya-ku, Tokyo, 157-0063, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81368798998"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tohakuan-karibe"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With the temperament of an artist, the chef places everything in its proper proportion. Gathering unpolished buckwheat from Nagano and Niigata, he grinds the two together, checking moisture by hand to produce nihachi and juwari noodles. Soba and broth are served in harmony: as seiro, accompanied by soup redolent of katsuobushi, or as kake, steeped in hot katsuobushi broth. Side dishes are soba-shop favourites, such as Pacific herring simmered for days or seafood and buckwheat flour wrapped in nori and deep-fried...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-23-19%20Kasuya%2C%20Setagaya-ku%2C%20Tokyo%2C%20157-0063%2C%20Japan"
    pageTitle="Tohakuan Karibe"
  />
);

export default TohakuanKaribe;
