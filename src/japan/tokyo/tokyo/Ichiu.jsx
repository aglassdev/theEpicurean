...
const Ichiu = () => (
  <RestaurantPage
    restaurantName="Ichiu"
    address="2-22 Kagurazaka, Shinjuku-ku, Tokyo, 162-0825, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81362807047"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ichiu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A door of cedar bark, roof tiles for a nameplate, and a rope curtain with the same diagonals as the ceiling. ‘Ichiu’ means ‘under one roof’, and the ceiling is shaped like a roof to emphasise this point. The menu is faithful to the spirit of Chef Koichi Hamano, a man experienced in Japanese cuisine, particularly sushi. The evening begins with a cup of sake; soup and steamed dishes are then served. After the sushi, takikomi gohan - rice with a variety of ingredients concludes the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-22%20Kagurazaka%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0825%2C%20Japan"
    pageTitle="Ichiu"
  />
);

export default Ichiu;
