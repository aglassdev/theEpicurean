...
const TrattoriaBucamassimo = () => (
  <RestaurantPage
    restaurantName="TRATTORIA BUCA'MASSIMO"
    address="1-24-11 Tomioka, Koto-ku, Tokyo, 135-0047, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81358099022"
    website="https://bucamassimo.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘A backstreet Italian eatery’ is how this trattoria bills itself. The chef professes his love of Tuscany through his cooking, which includes crostini of chicken-liver paste; beef tripe simmered in the Florentine style; Pici, akin to a thick spaghetti, in tomato ragú is a Sienese primo piatto. The meat elegantly grilled over charcoal flame is best enjoyed with a bottle of red wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-24-11%20Tomioka%2C%20Koto-ku%2C%20Tokyo%2C%20135-0047%2C%20Japan"
    pageTitle="TRATTORIA BUCA'MASSIMO"
  />
);

export default TrattoriaBucamassimo;
