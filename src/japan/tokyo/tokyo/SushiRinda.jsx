...
const SushiRinda = () => (
  <RestaurantPage
    restaurantName="Sushi Rinda"
    address="2-24-12 Shimomeguro, Meguro-ku, Tokyo, 153-0064, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81364203343"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-rinda"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The unconventional restaurant name is in honour of the owner-chef’s daughter; probe further, and you find that Rinda is also the name of a song by the chef’s favourite rock band. With such rock-star inspirations, it’s no wonder that the young cooks are such a blur of motion. The fatty flesh of tuna is sliced thin and piled high before the sushi is moulded so the fat will melt faster. ‘Rindamaki’ is a sumptuous roll sushi of tuna, sea urchin and salmon roe. The lively enthusiasm of the restaurant’s team is sure to lift your spirits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-24-12%20Shimomeguro%2C%20Meguro-ku%2C%20Tokyo%2C%20153-0064%2C%20Japan"
    pageTitle="Sushi Rinda"
  />
);

export default SushiRinda;
