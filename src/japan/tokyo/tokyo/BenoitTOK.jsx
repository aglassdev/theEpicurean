...
const BenoitTOK = () => (
  <RestaurantPage
    restaurantName="Benoit"
    address="10F, La Porte Aoyama, 5-51-8 Jingumae, Shibuya-ku, Tokyo, 150-0001, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81364194181"
    website="https://www.benoit-tokyo.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Tokyo outpost of Benoit, which was founded in Paris in 1912. The cuisine of this bistro that co-stars French and Japanese influences is overseen by Alain Ducasse. The menu is prix fixe, but diners can choose items to their liking. Dishes bequeathed by the Paris flagship, such as oven-baked escargot and terrine, stand alongside regional fare made with ingredients from across Japan. Antique-accented décor and attentive service convey an unmistakeably French esprit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%20La%20Porte%20Aoyama%2C%205-51-8%20Jingumae%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0001%2C%20Japan"
    pageTitle="Benoit"
  />
);

export default BenoitTOK;
