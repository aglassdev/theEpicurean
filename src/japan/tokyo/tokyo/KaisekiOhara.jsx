...
const KaisekiOhara = () => (
  <RestaurantPage
    restaurantName="Kaiseki Ohara"
    address="2F, 1 Arakicho, Shinjuku-ku, Tokyo, 160-0007, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81363805223"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/kaiseki-ohara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The husband and wife in chef’s whites welcome you to their Japanese restaurant. They learned their skills at a chakaiseki (tea ceremony cuisine) establishment. While he works his culinary magic, the proprietress makes confectioneries and serves guests. Decoratively arranged sashimi of white-fleshed fish is served with a mix of rich and light soy sauce; hassun appetisers are laden with rich varieties of seafood. The spirit of the house shines in dishes that are uncluttered, meticulously crafted and honest...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201%20Arakicho%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0007%2C%20Japan"
    pageTitle="Kaiseki Ohara"
  />
);

export default KaisekiOhara;
