...
const TakahashiTOK = () => (
  <RestaurantPage
    ...
    address="1-7-6 Morishita, Koto-ku, Tokyo, 135-0004, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81366596095"
    website="https://www.rest-takahashi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After studying kaiseki cuisine, the chef moved to Singapore to spread awareness of Japanese cuisine. He returned out of renewed appreciation for the quality of Japanese ingredients. Exceptionally particular about his ingredients, the chef refuses to trust them unless he inspects them at market himself. He learned the basics at famous restaurants in Japan, then acquired hospitality skills from his experience overseas. Both qualities reveal themselves in his fare and service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-7-6%20Morishita%2C%20Koto-ku%2C%20Tokyo%2C%20135-0004%2C%20Japan"
    pageTitle="Takahashi"
  />
);

export default TakahashiTOK;
