...
const GinzaNominokojiYamagishi = () => (
  <RestaurantPage
    restaurantName="Ginza Nominokoji Yamagishi"
    address="10F, 7-3-6 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Izakaya"
    priceRange="¥¥¥"
    phoneNumber="+81355373510"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ginza-nominokoji-yamagishi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This izakaya was opened by one of Kyoto’s most popular kappo. Ingredients are sourced from Nishiki Market, ‘Kyoto’s kitchen’, and even the water is famed water from the ancient capital. Service begins with a set of four items, such as decoratively arranged sashimi and soup dishes, followed by à la carte items to the customer’s taste such as oden, baked gyoza dumplings and squid fried noodles. Curry rice and ramen are typical ending dishes. The shop stays open late, so drop in without worrying too much about the time...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=10F%2C%207-3-6%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Nominokoji Yamagishi"
  />
);

export default GinzaNominokojiYamagishi;
