...
const Sugita = () => (
  <RestaurantPage
    restaurantName="Sugita"
    address="3-8-3 Kotobuki, Taito-ku, Tokyo, 111-0042, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81338445529"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sugita"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Tonkatsu is food for the masses’, explains the second-generation chef, as he aims to serve up fare that is familiar and comforting. Copper pots polished till gleaming and plain wooden counters display a craftsman’s spirit. Two pots are used: one containing hot oil and the other cooler oil. Pork loin is shorn of extra fat and thinly battered. Tonkatsu is the star attraction, so no meat is added to the pork miso soup. As the chef works, a photo of his father in chef’s whites watches over him...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-8-3%20Kotobuki%2C%20Taito-ku%2C%20Tokyo%2C%20111-0042%2C%20Japan"
    pageTitle="Sugita"
  />
);

export default Sugita;
