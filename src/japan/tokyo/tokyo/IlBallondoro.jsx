...
const IlBallondoro = () => (
  <RestaurantPage
    restaurantName="IL BALLOND'ORO"
    address="1-24-10 Ebisu, Shibuya-ku, Tokyo, 150-0013, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81354228977"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/il-ballond-oro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The walls are adorned with commemorative photographs and uniforms of Italian football players. The trattoria is named after the Ballon d'Or award presented to the top football players. The chef’s “Golden Risotto” glistens with the colour of saffron and is a testament to his past dreams of becoming a pro footballer. The menu is full of traditional dishes picked up from his travels throughout Italy from north to south...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-24-10%20Ebisu%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0013%2C%20Japan"
    pageTitle="IL BALLOND'ORO"
  />
);

export default IlBallondoro;
