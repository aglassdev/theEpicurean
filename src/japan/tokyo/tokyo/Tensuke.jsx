...
const Tensuke = () => (
  <RestaurantPage
    restaurantName="Tensuke"
    address="3-22-7 Koenjikita, Suginami-ku, Tokyo, 166-0002, Japan"
    cuisine="Tempura"
    priceRange="¥"
    phoneNumber="+81332238505"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tensuke"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-22-7%20Koenjikita%2C%20Suginami-ku%2C%20Tokyo%2C%20166-0002%2C%20Japan"
    pageTitle="Tensuke"
  />
);

export default Tensuke;
