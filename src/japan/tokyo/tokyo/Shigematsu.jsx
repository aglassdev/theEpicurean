...
const Shigematsu = () => (
  <RestaurantPage
    restaurantName="SHIGEMATSU"
    address="4F, 6-5-6 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81335756386"
    website="https://ginza-shigematsu.jp/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Shigeyuki Matsubara layers flavour upon flavour to draw out the individuality of each dish. He creates his sharply flavoursome dashi through extravagant use of dried bonito and tuna shavings. White miso is added to lightly deep-fried oysters and lotus-root dumplings are enriched with beef, creating multi-layered flavour profiles. Matsubara handled the design of the restaurant himself and the original imagination of the chef completes both the cuisine and the interior...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%206-5-6%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="SHIGEMATSU"
  />
);

export default Shigematsu;
