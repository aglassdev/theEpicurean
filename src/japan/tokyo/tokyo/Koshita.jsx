...
const Koshita = () => (
  <RestaurantPage
    restaurantName="Koshita"
    address="4-3-20 Kudankita, Chiyoda-ku, Tokyo, 102-0073, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+815017246003"
    website="https://koshita2025.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The counter of ancient buried cedar is an heirloom from the chef’s honoured mentor. On a foundation of technique cultivated in his apprenticeship, he builds unique combinations of foodstuffs and techniques to place his own stamp on his craft. For wanmono, broth is drawn from two types of makombu seaweed, multiplying the flavours. Flame-broiled items are paired with pureed vegetable soup. Ingredients unfamiliar to Japanese cuisine are enthusiastically added to the repertoire. Expressing freedom of spirit, the chef is resplendent in black shirt and bowtie...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-3-20%20Kudankita%2C%20Chiyoda-ku%2C%20Tokyo%2C%20102-0073%2C%20Japan"
    pageTitle="Koshita"
  />
);

export default Koshita;
