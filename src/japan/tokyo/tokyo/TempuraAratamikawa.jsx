...
const TempuraAratamikawa = () => (
  <RestaurantPage
    restaurantName="Tempura Aratamikawa"
    address="2F, 2-15-6 Nishishimbashi, Minato-ku, Tokyo, 105-0003, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥"
    phoneNumber="+81369102023"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tempura-aratamikawa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A warm light envelops an interior appointed in the stately Taisho Romanticist style. The shop’s name and the certificate of mastery are in the handwriting of the chef’s mentor. The chef studied theories and techniques from one of the world’s foremost practitioners of tempura. Tempura pieces, such as the irreplaceable Edomae standards of shrimp, sillago and conger eel, seem almost grilled rather than fried in hot oil. While obsessively following his mentor’s teachings, the chef is pursuing ‘a new way of tempura’ with innovations he learned as an apprentice, such as serving some fish that are not deep-fried...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-15-6%20Nishishimbashi%2C%20Minato-ku%2C%20Tokyo%2C%20105-0003%2C%20Japan"
    pageTitle="Tempura Aratamikawa"
  />
);

export default TempuraAratamikawa;
