...
const LeCabaret = () => (
  <RestaurantPage
    restaurantName="Le cabaret"
    address="8-8 Motoyoyogicho, Shibuya-ku, Tokyo, 151-0062, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81334697466"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/le-cabaret-1194236"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A place to enjoy organic wine and bistro fare. The blackboard menu is filled with charcuterie such as salami and rillettes, a plentiful serving of crudités, and steak frites. Portions of this classic French cuisine are generous, perfect for sharing a plate. Signatures of wine growers who have visited the restaurant hang on the wall, telling a tale of ongoing exchange...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=8-8%20Motoyoyogicho%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0062%2C%20Japan"
    pageTitle="Le cabaret"
  />
);

export default LeCabaret;
