...
const NotoKanazawanosachiGinzaFuruta = () => (
  <RestaurantPage
    restaurantName="Noto Kanazawanosachi Ginza Furuta"
    address="5-10-11 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥"
    phoneNumber="+818098257505"
    website="https://noto-jidaiya.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The couple in charge of this restaurant want to tell the world about the wealth of food from Ishikawa Prefecture. Fish arriving from Nanao, the proprietress’ place of birth, is prepared by her husband, the owner-chef. In addition to vinegared mozuku seaweed and rosy sea perch cooked whole, the restaurant serves mountain treats such as vegetables from Kaga and edible wild plants from the Noto Peninsula. The couple tour farms and sake breweries, building warm relations with producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-10-11%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Noto Kanazawanosachi Ginza Furuta"
  />
);

export default NotoKanazawanosachiGinzaFuruta;
