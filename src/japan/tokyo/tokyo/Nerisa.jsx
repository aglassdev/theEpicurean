...
const Nerisa = () => (
  <RestaurantPage
    restaurantName="nerisa"
    address="6-7-6 Koyama, Shinagawa-ku, Tokyo, 142-0062, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81367706348"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/nerisa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tonnato of veal, hand-rolled tajarin pasta, agnolotti: Chef's experience with the cuisine of Piedmont is everywhere on display. He stays faithful to the recipes he learned, because he wants guests to know the taste of true Piemontese cuisine, but he links Italy to Japan by incorporating local ingredients. The accent in cooking is on simplicity and his personality shines in his line-up of ingredient-focused fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-7-6%20Koyama%2C%20Shinagawa-ku%2C%20Tokyo%2C%20142-0062%2C%20Japan"
    pageTitle="nerisa"
  />
);

export default Nerisa;
