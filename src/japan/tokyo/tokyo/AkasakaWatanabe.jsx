...
const AkasakaWatanabe = () => (
  <RestaurantPage
    restaurantName="Akasaka Watanabe"
    address="2F, 2-17-59 Akasaka, Minato-ku, Tokyo, 107-0052, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81364265872"
    website="https://www.akasaka-watanabe.net/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dressed in white and sporting a bow tie, Yujiro Watanabe greets his guests with a smile. His spirit of graceful service is ‘delicious, fun and welcoming’. Sesame ground in a large bowl, karasumi (salted and dried grey mullet roe) shaved before customers’ eyes and the staging of the kitchen are three shared moments. Rice from Niigata, produced by his sister and her husband, is used. Sea bream chazuke (green tea poured over rice) is a legacy from his mentor. The gratitude is palpable, the conversation lively...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-17-59%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-0052%2C%20Japan"
    pageTitle="Akasaka Watanabe"
  />
);

export default AkasakaWatanabe;
