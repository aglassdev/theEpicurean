...
const SushidokoroShigeru = () => (
  <RestaurantPage
    restaurantName="Sushidokoro Shigeru"
    address="15 Funamachi, Shinjuku-ku, Tokyo, 160-0006, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+81332261588"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushidokoro-shigeru"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef chose to hang his noren in his native Shinjuku out of his passion to offer ‘a sushi restaurant for the masses’, where guests can enjoy themselves in a casual atmosphere. For many diners, the draw is the omakase set menus. Putting to work his experience across various genres of Japanese cuisine, the chef begins the meal with steamed items, followed by grilled and simmered dishes. As he prepares nigiri sushi, the chef’s knife work is quick, practiced and sure. ‘Torotaku’, a dish of beaten tuna and pickled daikon, is a perennial favourite. The customer-oriented use of high-quality food at reasonable prices is welcome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=15%20Funamachi%2C%20Shinjuku-ku%2C%20Tokyo%2C%20160-0006%2C%20Japan"
    pageTitle="Sushidokoro Shigeru"
  />
);

export default SushidokoroShigeru;
