...
const NodaiwaAzabuIikuraHonten = () => (
  <RestaurantPage
    restaurantName="Nodaiwa Azabu Iikura Honten"
    address="1-5-4 Higashiazabu, Minato-ku, Tokyo, 106-0044, Japan"
    cuisine="Unagi / Freshwater Eel"
    priceRange="¥¥"
    phoneNumber="+81335837852"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/nodaiwa-azabu-Iikura-honten-1194124"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-5-4%20Higashiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0044%2C%20Japan"
    pageTitle="Nodaiwa Azabu Iikura Honten"
  />
);

export default NodaiwaAzabuIikuraHonten;
