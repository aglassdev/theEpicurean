...
const LugdunumBouchonLyonnais = () => (
  <RestaurantPage
    restaurantName="LUGDUNUM Bouchon Lyonnais"
    address="4-3-7 Kagurazaka, Shinjuku-ku, Tokyo, 162-0825, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81364261201"
    website="https://lyondelyon.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This ‘Little Lyons’ down a Kagurazaka alley entertains guests with the regional cuisine chef Christophe Paucod remembers from his hometown. The famed quenelle is paired with buttered rice in the style of a doria. Homemade sausages are used in miniature hamburgers. The interior, a faithful recreation of Bouchon, a Lyons restaurant, wraps guests in the warm feeling of travelling in France...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-3-7%20Kagurazaka%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0825%2C%20Japan"
    pageTitle="LUGDUNUM Bouchon Lyonnais"
  />
);

export default LugdunumBouchonLyonnais;
