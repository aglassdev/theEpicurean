...
const NishiazabuShangu = () => (
  <RestaurantPage
    restaurantName="NISHIAZABU SHANGU"
    address="2F, 3-13-10 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥¥"
    phoneNumber="+81334786811"
    website="https://shangu.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The kitchen can be seen from the counter seating, making dining a theatrical experience. The chef commands his team while working his wok with consummate skill. Testifying that the appeal of Cantonese cuisine lies in seafood and dried items, the menu is laced with ingredients such as spiny lobster, abalone, dried scallop abductor and dried mushrooms. After dinner, guests can relocate to the lounge to bask in the afterglow of the performance. Desserts, a mix of Chinese and Western patisserie treats, close the evening...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%203-13-10%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="NISHIAZABU SHANGU"
  />
);

export default NishiazabuShangu;
