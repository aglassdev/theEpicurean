...
const ShinHarada = () => (
  <RestaurantPage
    restaurantName="Shin Harada"
    address="12F, 2-6-5 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Italian"
    priceRange="¥¥¥¥"
    phoneNumber="+81335356667"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/aroma-fresca"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Italian dining by Shinji Harada, a chef who prizes aroma. The elegant dining room is a refreshing white. As you’re seated, you’ll notice how high the table is – the purpose is to draw the aroma of the food that much closer. Shinji Harada’s cherished theory of ‘shortest distance to the ingredients’ means not only bringing out the flavour of domestic ingredients but also bringing face and plate closer together...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=12F%2C%202-6-5%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Shin Harada"
  />
);

export default ShinHarada;
