...
const TempuraKakiageYukimura = () => (
  <RestaurantPage
    restaurantName="Tempura Kakiage Yukimura"
    address="6-13-13 Shimbashi, Minato-ku, Tokyo, 105-0004, Japan"
    cuisine="Tempura"
    priceRange="¥"
    phoneNumber="+81367215343"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tempura-kakiage-yukimura"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Cheerful, fun, exciting’ sums up the credo of the owner-chef. The convivial atmosphere and friendly service attracts customers of every generation. The menu reflects this positive attitude, with bowls of rice with toppings, teishoku set meals and à la carte items available at both lunch and dinner. The dish of fame is the kakiage-don, a bowl of rice loaded up with shrimp. The chef treasures the advice he learned as an apprentice: ‘Offer top-rate food at third-rate prices’. He’s always smiling, trading jokes with his guests...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-13-13%20Shimbashi%2C%20Minato-ku%2C%20Tokyo%2C%20105-0004%2C%20Japan"
    pageTitle="Tempura Kakiage Yukimura"
  />
);

export default TempuraKakiageYukimura;
