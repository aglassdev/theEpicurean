...
const Katsuyoshi = () => (
  <RestaurantPage
    restaurantName="Katsuyoshi"
    address="3-4-11 Nihombashiningyocho, Chuo-ku, Tokyo, 103-0013, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81362310641"
    website="https://www.katuyoshi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You’ll find Katsuyoshi in a back-alley of Ningyocho. The interior of the shop, a refurbished traditional home, uses recycled wood to convey a retro feel. In the kitchen, you’ll see two copper pots. When deep-frying pork cutlets, the owner-chef uses hotter oil for some dishes and cooler oil for others. Fried seafood morsels such as scallop and tiger prawn are popular. If you get a seat at the counter, you can watch the chef’s work, which starts with preparing the meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-4-11%20Nihombashiningyocho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0013%2C%20Japan"
    pageTitle="Katsuyoshi"
  />
);

export default Katsuyoshi;
