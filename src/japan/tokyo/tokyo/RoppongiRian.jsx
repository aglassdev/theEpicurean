...
const RoppongiRian = () => (
  <RestaurantPage
    restaurantName="ROPPONGI RIAN"
    address="4F, 6-2-6 Roppongi, Minato-ku, Tokyo, 106-0032, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81362715563"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/roppongi-rian"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The concept of this kappo is ‘as much as you want of what you want’. Seasonal fruits and vegetables are lined up on the counter, ready to be cooked by your preferred method. The head chef honed his craft in Kyoto, so he uses rice and water from Kyotango. Pike conger and oysters are sourced from Nagasaki, reflecting his Amakusa roots. The champon served to close out the meal is a recipe from his mother, who runs a shop specialising in this noodle dish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4F%2C%206-2-6%20Roppongi%2C%20Minato-ku%2C%20Tokyo%2C%20106-0032%2C%20Japan"
    pageTitle="ROPPONGI RIAN"
  />
);

export default RoppongiRian;
