...
const GinzaKitagawa = () => (
  <RestaurantPage
    restaurantName="Ginza Kitagawa"
    address="3F, 2-10-11 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81362642872"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ginza-kitagawa"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The young kitchen team is a blur of motion at this counter kappo establishment. Believing that dining should be fun, the owner greets guests warmly, fostering a congenial atmosphere. The menu sparkles with originality. Oil-cooked dishes, a must-try, extend beyond deep-fried foods. Tsukuri are par-cooked in oil, in a technique known as aburadoshi. Tempura is fried before your eyes, so their aroma and sizzle reach you before the food does. Kakiage, tempura shrimp over rice in a clay pot, draws the meal to a close...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%202-10-11%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Kitagawa"
  />
);

export default GinzaKitagawa;
