...
const EdomaeShibahama = () => (
  <RestaurantPage
    restaurantName="Edomae Shibahama"
    address="2-22-23 Shiba, Minato-ku, Tokyo, 105-0014, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81334536888"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/edomae-shibahama"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-22-23%20Shiba%2C%20Minato-ku%2C%20Tokyo%2C%20105-0014%2C%20Japan"
    pageTitle="Edomae Shibahama"
  />
);

export default EdomaeShibahama;
