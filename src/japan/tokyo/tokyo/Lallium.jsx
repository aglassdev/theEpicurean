...
const Lallium = () => (
  <RestaurantPage
    restaurantName="L'allium"
    address="B1F, 4-9-23 Shirokanedai, Minato-ku, Tokyo, 108-0071, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81364564378"
    website="https://www.restaurant-lallium.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The basement dining room has the air of a concert hall. The conductor, on stage in his brightly lit kitchen, is Chef Yoshiaki Shindo. To ensure that the character is unmistakably French, caviar, foie gras and truffles are staple offerings. Poêle of foie gras is the centrepiece of the prix fixe menu. Guests are encouraged to choose their meat and fish, reflecting the restaurant’s core commitment to freedom of choice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%204-9-23%20Shirokanedai%2C%20Minato-ku%2C%20Tokyo%2C%20108-0071%2C%20Japan"
    pageTitle="L'allium"
  />
);

export default Lallium;
