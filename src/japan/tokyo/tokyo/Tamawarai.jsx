...
const Tamawarai = () => (
  <RestaurantPage
    restaurantName="Tamawarai"
    address="5-23-3 Jingumae, Shibuya-ku, Tokyo, 150-0001, Japan"
    cuisine="Soba"
    priceRange="¥¥¥"
    phoneNumber="+81354850025"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tamawarai"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef is of the view that soba’s deliciousness is determined by its flour. He grinds husked buckwheat both from his garden and from farmers in Ibaraki Prefecture, catching every iota of the fresh-ground aroma. Coarse ground seiro (soba served on bamboo wicker) is full of wild flavour. Tofu soba, inspired by staff meals, and hot seiro with hot tsuyu sauce and beaten egg, are unique taste experiences. Evening service is prix fixe only, with treats such as buckwheat mash and rolled omelettes included...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-23-3%20Jingumae%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0001%2C%20Japan"
    pageTitle="Tamawarai"
  />
);

export default Tamawarai;
