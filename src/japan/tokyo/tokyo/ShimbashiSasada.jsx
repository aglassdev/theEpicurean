...
const ShimbashiSasada = () => (
  <RestaurantPage
    restaurantName="Shimbashi Sasada"
    address="1-23-7 Nishishimbashi, Minato-ku, Tokyo, 105-0003, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81335075501"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/shimbashi-sasada"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With his expertise refined at a Kyoto cuisine restaurant, the chef emphasises seasonal ingredients, showcasing his experience in dishes that highlight their finest qualities. He starts with delicacies and aemono appetisers designed to enhance the enjoyment of sake. The warm boiled wild mustard greens with deep-fried tofu is a Sasada speciality perfected over many years. All the dishes are carefully prepared with a focus on simplicity, showcasing the chef’s humble personality and dedication to his craft...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-23-7%20Nishishimbashi%2C%20Minato-ku%2C%20Tokyo%2C%20105-0003%2C%20Japan"
    pageTitle="Shimbashi Sasada"
  />
);

export default ShimbashiSasada;
