...
const Matsunozushi = () => (
  <RestaurantPage
    restaurantName="Matsunozushi"
    address="2-16-12 Minaminagasaki, Toshima-ku, Tokyo, 171-0052, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+81339513588"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/matsunozushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sushi items lined up inside a glass display case ooze Showa-era ambience. A sushi shop of the old school, and that’s how the chef likes it. Cutting and serving the sushi himself, the chef offers everything from omakase set menus to à la carte. Tuna is marinated in soy sauce; conger eel is coated in a thick, sweet eel sauce; and egg is served ‘kurakake’ or ‘saddle-style’: layered into a cake and split over a bite-sized mound of vinegared rice. The character for ‘sushi’ combines the characters for ‘fish’ and ‘delicious’. The pursuit of essential Edo style expresses the chef’s pride in his craft better than any words...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-16-12%20Minaminagasaki%2C%20Toshima-ku%2C%20Tokyo%2C%20171-0052%2C%20Japan"
    pageTitle="Matsunozushi"
  />
);

export default Matsunozushi;
