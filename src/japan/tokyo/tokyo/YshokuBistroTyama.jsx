...
const YshokuBistroTyama = () => (
  <RestaurantPage
    restaurantName="YŌSHOKU BISTRO TŌYAMA"
    address="1-11-13 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Yoshoku"
    priceRange="¥¥"
    phoneNumber="+81368043969"
    website="https://ueno-tooyama.jp/nishiazabu-tooyama/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The symbol of YŌSHOKU BISTRO TŌYAMA is a mural of Chef Tadayoshi Toyama at work in the kitchen. The interior is enfolded in warm wood panelling, the blackboard menu a touch of bistro charm. Yoshoku in ‘Yoshoku bistro’ means Western-influenced cooking, and the name references Toyama’s longstanding love affair with Western dishes and his experience studying French cuisine. The accent here is on dishes that pair well with wine. From yoshoku to French, the chef’s time and effort are rewarded with the depth of his menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-11-13%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="YŌSHOKU BISTRO TŌYAMA"
  />
);

export default YshokuBistroTyama;
