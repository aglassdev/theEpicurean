...
const SobaOsame = () => (
  <RestaurantPage
    restaurantName="Soba Osame"
    address="3-21-5 Shimochiai, Shinjuku-ku, Tokyo, 161-0033, Japan"
    cuisine="Soba"
    priceRange="¥¥"
    phoneNumber="+81369082362"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/soba-osame"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With close cooperation with food producers as his creed, the chef devotes himself to his 100% buckwheat juwari soba. He only uses ingredients native to Japan, to convey the charm of old-school soba. Depending where his ingredients come from, his soba may be served on a wickerwork tray, and may be either coarse-ground or ground with husks included. His inquiring mind drives him to check each day’s soba, adjusting thickness and serving temperature according to its nature. His diligent application is raising soba to new levels, as his many regulars would agree...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-21-5%20Shimochiai%2C%20Shinjuku-ku%2C%20Tokyo%2C%20161-0033%2C%20Japan"
    pageTitle="Soba Osame"
  />
);

export default SobaOsame;
