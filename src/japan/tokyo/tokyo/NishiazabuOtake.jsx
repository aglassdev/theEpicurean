...
const NishiazabuOtake = () => (
  <RestaurantPage
    restaurantName="Nishiazabu Otake"
    address="1-4-23 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81364592833"
    website="https://www.nishiazabu-otake.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef practises ‘cuisine that lingers in the soul’ that he learned at a ryotei, or traditional high-end Japanese restaurant, in Gifu Prefecture. Croquettes, a perennial favourite, are as seasonal as they are whimsical, stuffed with hair crab in spring and porcini mushrooms in autumn. Char-grilled fare includes meat as well as fish, enhancing satisfaction. Uniquely, Nishiazabu Otake serves game such as winter duck and Asian black bear, sent by hunters in Gifu. Definitely Japanese cuisine, yet free of convention...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4-23%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Nishiazabu Otake"
  />
);

export default NishiazabuOtake;
