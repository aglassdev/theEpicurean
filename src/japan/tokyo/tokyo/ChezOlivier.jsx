...
const ChezOlivier = () => (
  <RestaurantPage
    restaurantName="Chez Olivier"
    address="4-1-10 Kudanminami, Chiyoda-ku, Tokyo, 102-0074, Japan"
    cuisine="French, Contemporary"
    priceRange="¥¥¥"
    phoneNumber="+81362689933"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/chez-olivier"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The French-born chef named this restaurant, which means ‘Olivier’s House’. He personally selects the wines and brings out the food, treating customers like guests in his own home. He uses ingredients from both France and Japan out of his wish to be a bridge between the two countries. In autumn, diners can enjoy fusion cuisine of French escargot ravioli and Japanese awabi and mushrooms. The dishes, rich with French esprit, are also a feast for the eyes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-1-10%20Kudanminami%2C%20Chiyoda-ku%2C%20Tokyo%2C%20102-0074%2C%20Japan"
    pageTitle="Chez Olivier"
  />
);

export default ChezOlivier;
