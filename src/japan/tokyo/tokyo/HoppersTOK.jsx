...
const HoppersTOK = () => (
  <RestaurantPage
    ...
    address="7-1 Nihombashikabutocho, Chuo-ku, Tokyo, 103-0026, Japan"
    cuisine="Sri Lankan"
    priceRange="¥¥"
    phoneNumber="+81368901547"
    website="https://hoppers.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Love of spices inspires the chef of this house of Sri Lankan cuisine. When he says the national dish of Sri Lanka is ‘rice and curry’, he doesn’t just mean rice with curry. The phrase refers specifically to a set menu of several types of curry, side dishes, and rice. In keeping with tradition, the curry is made with Maldive fish, a type of shaved bonito. Distinctively, the rice is a mixture of basmati rice and Japanese rice...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-1%20Nihombashikabutocho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0026%2C%20Japan"
    pageTitle="HOPPERS"
  />
);

export default HoppersTOK;
