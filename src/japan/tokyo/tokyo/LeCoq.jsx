...
const LeCoq = () => (
  <RestaurantPage
    restaurantName="Le Coq"
    address="2-7-2 Ebisunishi, Shibuya-ku, Tokyo, 150-0021, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81337701915"
    website="https://lecoq.co.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Simple cuisine that emphasises ingredients leaves a lasting impression of flavours and arrangements. Thick-cut smoked salmon is one example. A veteran chef, Mitsuhiro Hiruma focuses his skills on delicious preparations with nothing extraneous. The restaurant’s name is French for ‘rooster’, the symbol and national bird of France. Having honed his technique in local restaurants, Hiruma expresses this precious experience in his cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-7-2%20Ebisunishi%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0021%2C%20Japan"
    pageTitle="Le Coq"
  />
);

export default LeCoq;
