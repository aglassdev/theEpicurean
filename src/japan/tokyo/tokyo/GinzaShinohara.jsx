...
const GinzaShinohara = () => (
  <RestaurantPage
    restaurantName="Ginza Shinohara"
    address="B1F, 2-8-17 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81362630345"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ginza-shinohara"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In Kyoto, the chef acquired knowledge of Japanese cuisine; in his native Shiga, the uniqueness of fondly remembered country cooking. The sprouting of flowering plants, the spirit of wild animals, the shifting of the seasons in the rural hillscapes, all have their say in the menu. The vividly colourful hassun platters are lavish yet delicate. The intention in hot-pot cooking is to bring a party together through the magic of a single flavour. Gracious service, sparing no detail, is the true pleasure here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-8-17%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Shinohara"
  />
);

export default GinzaShinohara;
