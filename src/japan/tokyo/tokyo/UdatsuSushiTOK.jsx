...
const UdatsuSushiTOK = () => (
  <RestaurantPage
    restaurantName="UDATSU SUSHI"
    address="2-48-10 Kamimeguro, Meguro-ku, Tokyo, 153-0051, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+815035505938"
    website="https://www.udatsu-sushi.jp/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A fresh intersection between sushi and art. The walls of this modern space are hung with paintings by artists, giving the feeling of dining in a gallery. Bright and colourful side dishes include herb rolls, smoked tuna and veggie rolls. Nigiri technique hews close to the basics, but with some tempura-inspired creative touches, such as sea urchin and fried nori. A sushi restaurant for a new age...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-48-10%20Kamimeguro%2C%20Meguro-ku%2C%20Tokyo%2C%20153-0051%2C%20Japan"
    pageTitle="UDATSU SUSHI"
  />
);

export default UdatsuSushiTOK;
