...
const BouquetDeFrance = () => (
  <RestaurantPage
    restaurantName="Bouquet de France"
    address="2F, 7-10-3 Roppongi, Minato-ku, Tokyo, 106-0032, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81334971488"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/bouquet-de-france"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“The countryside is the foundation of French cuisine”, says Hidetoshi Imoto. He pours his labours into the flavours of rural France, such as cassoulet, a stew from Languedoc, and baeckeoffe, an Alsatian casserole. The charcuterie of pork pâtés and sausages is indispensable in expressing its home culture. Proprietress Yoko Harada’s amiable service relaxes guests with a cheerful, homelike atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%207-10-3%20Roppongi%2C%20Minato-ku%2C%20Tokyo%2C%20106-0032%2C%20Japan"
    pageTitle="Bouquet de France"
  />
);

export default BouquetDeFrance;
