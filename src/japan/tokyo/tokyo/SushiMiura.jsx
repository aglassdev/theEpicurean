...
const SushiMiura = () => (
  <RestaurantPage
    restaurantName="Sushi Miura"
    address="6-19-46 Akasaka, Minato-ku, Tokyo, 107-0052, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+819088940020"
    website="https://sushimiura-japan.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-19-46%20Akasaka%2C%20Minato-ku%2C%20Tokyo%2C%20107-0052%2C%20Japan"
    pageTitle="Sushi Miura"
  />
);

export default SushiMiura;
