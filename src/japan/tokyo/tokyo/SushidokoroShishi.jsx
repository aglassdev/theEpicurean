...
const SushidokoroShishi = () => (
  <RestaurantPage
    restaurantName="Sushidokoro Shishi"
    address="2F, 1-10-10 Omorikita, Ota-ku, Tokyo, 143-0016, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81366258306"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushidokoro-shishi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Service is omakase prix fixe, with plenty of items. Snacks and nigiri alternate, so the drinks go down smoothly. Our first item, ‘Totomame’, is boiled salmon roe, a Niigata speciality placed on top of chawanmushi to give a taste of home. Rice, salt and sake are sourced from Niigata as well, proclaiming the attractions of the Echigo region. Tuna, from an esteemed wholesaler, is a special point of pride, and three pieces are served in succession...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%201-10-10%20Omorikita%2C%20Ota-ku%2C%20Tokyo%2C%20143-0016%2C%20Japan"
    pageTitle="Sushidokoro Shishi"
  />
);

export default SushidokoroShishi;
