...
const Tomidokoro = () => (
  <RestaurantPage
    restaurantName="Tomidokoro"
    address="6-13-3 Shimbashi, Minato-ku, Tokyo, 105-0004, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81368760646"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tomidokoro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A place to feed on sushi to your heart’s content. The owner-chef, a man of few words, focuses strictly on sushi to maintain the proper tempo. True to his Obihiro roots, he cooks ancient varieties of Hokkaido rice in a broad-brimmed hagama pot. Fish is cut thick, so guests can enjoy the flavour to the fullest, and vinegared rice servings are generous to match. Standard lunchtime items are a bargain. The chef is generous both in sushi and in spirit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-13-3%20Shimbashi%2C%20Minato-ku%2C%20Tokyo%2C%20105-0004%2C%20Japan"
    pageTitle="Tomidokoro"
  />
);

export default Tomidokoro;
