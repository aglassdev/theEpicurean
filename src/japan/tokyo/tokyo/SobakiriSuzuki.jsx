...
const SobakiriSuzuki = () => (
  <RestaurantPage
    restaurantName="Sobakiri Suzuki"
    address="4-43-32 Minamioizumi, Nerima-ku, Tokyo, 178-0064, Japan"
    cuisine="Soba"
    priceRange="¥"
    phoneNumber="+81353872010"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sobakiri-suzuki"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tucked away in a quiet residential neighbourhood, this soba shop welcomes guests only at lunchtime. The interior is done entirely in natural materials such as wood and stone, lending a homespun feel. Service is friendly and welcoming, placing the heart at ease. The menu consists solely of sobazen a set meal including fine soba noodles, appetisers, and soba-gaki. For those who prefer something sweet, the soba-gaki can be substituted with soba zenzai, a red bean soup made with the same buckwheat dough in dessert form. Quantities are limited so reservations are a must and can be made by phone from around 9:30 a.m. on the day...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-43-32%20Minamioizumi%2C%20Nerima-ku%2C%20Tokyo%2C%20178-0064%2C%20Japan"
    pageTitle="Sobakiri Suzuki"
  />
);

export default SobakiriSuzuki;
