...
const SosakumenkoboNakiryu = () => (
  <RestaurantPage
    restaurantName="Sosakumenkobo NAKIRYU"
    address="2-34-4 Minamiotsuka, Toshima-ku, Tokyo, 170-0005, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber="+81363041811"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sosakumenkobo-nakiryu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="‘Nakiryu’ means ‘roaring dragon’. The name is rich with meaning: it’s a reference to the dragon of Yakushido Hall in the Nikko Toshogu Shrine, to hopes for business growth, and to the couple who craft bowls of ramen together in perfect sync, both born in the Year of the Dragon. Dandan noodles create a synergy of flavours—layering meat miso, Chinese sesame paste, and chilli oil for a deep, amplified umami. Soy-sauce ramen owes its elegant flavour to its soup, drawn from whole chicken and oysters. À la carte items such as steamed chicken with spicy sauce and shrimp wontons exemplify experience with Chinese cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-34-4%20Minamiotsuka%2C%20Toshima-ku%2C%20Tokyo%2C%20170-0005%2C%20Japan"
    pageTitle="Sosakumenkobo NAKIRYU"
  />
);

export default SosakumenkoboNakiryu;
