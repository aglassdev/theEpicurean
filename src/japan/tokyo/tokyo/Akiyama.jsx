...
const Akiyama = () => (
  <RestaurantPage
    restaurantName="Akiyama"
    address="6-5-3 Shirokane, Minato-ku, Tokyo, 108-0072, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81362770723"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/akiyama"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The gentle disposition of owner-chef Hideto Akiyama pervades the menu and his attentive and quick-witted flow of service is part of the appeal. For guests who prefer to drink, he offers snacks, while he provides a wider variety of dishes to guests who are here to dine. Dishes are generously accompanied by marinated tuna, beef simmered in soy sauce and mirin, and dried young sardines seasoned with soy and Japanese pepper. White rice cooked in earthenware pots closes out the meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-5-3%20Shirokane%2C%20Minato-ku%2C%20Tokyo%2C%20108-0072%2C%20Japan"
    pageTitle="Akiyama"
  />
);
