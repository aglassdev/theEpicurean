...
const SushiKanesho = () => (
  <RestaurantPage
    restaurantName="Sushi Kanesho"
    address="3-33-9 Asakusa, Taito-ku, Tokyo, 111-0032, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81338716081"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-kanesho"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Akira Watanabe inherited old-school sushi traditions but learned from his mentor the spirit of adding his own novel spin. Vinegared sushi rice is regarded as the most important component of great sushi, and Watanabe’s evolved over time through trial and error. The chef displays judgment and skill as he serves gizzard shad first, and his simmered conger eel and kurakake egg (egg straddling the rice like a saddle) reflect his personality. He confides that he tries to ‘investigate the old and understand the new’...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-33-9%20Asakusa%2C%20Taito-ku%2C%20Tokyo%2C%20111-0032%2C%20Japan"
    pageTitle="Sushi Kanesho"
  />
);

export default SushiKanesho;
