...
const NishiazabuSushiShin = () => (
  <RestaurantPage
    restaurantName="Nishiazabu Sushi Shin"
    address="4-18-20 Nishiazabu, Minato-ku, Tokyo, 106-0031, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥¥"
    phoneNumber="+81354850031"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/nishiazabu-sushi-shin"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The movements are those of one immersed in the world of nigiri. On the fingertips of the left hand balances a piece of fish; clutched in the right, a fistful of sushi rice; the tip of the forefinger applies wasabi. Pushing, occasionally pulling, and scoring in delicate strokes, the single-edged knife crafts hidden incisions to help flavour soak in and heat travel through. Gracefully flowing motion, fine-tuned through daily practice, is the simplicity that holds countless truths. The spirit of nigirizushi is in capable hands with Shintaro Suzuki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-18-20%20Nishiazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0031%2C%20Japan"
    pageTitle="Nishiazabu Sushi Shin"
  />
);

export default NishiazabuSushiShin;
