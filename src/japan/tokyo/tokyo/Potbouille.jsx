...
const Potbouille = () => (
  <RestaurantPage
    restaurantName="Pot-Bouille"
    address="5-22-1 Hiro, Shibuya-ku, Tokyo, 150-0012, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81354226286"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/pot-bouille"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The softly lit counter creates a stylish mood conducive to gatherings of friends. French favourites such as rillettes and ratatouille share the menu with international items like tripe, shrimp spring rolls and tom yam goong ramen, stoking the imagination. The restaurant’s name is French for ‘hodgepodge’, an apt metaphor for Pot-Bouille’s medley of gastronomic influences, somehow in perfect harmony. A free-spirited style all its own...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5-22-1%20Hiro%2C%20Shibuya-ku%2C%20Tokyo%2C%20150-0012%2C%20Japan"
    pageTitle="Pot-Bouille"
  />
);

export default Potbouille;
