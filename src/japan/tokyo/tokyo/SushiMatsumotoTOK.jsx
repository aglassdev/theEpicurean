...
const SushiMatsumotoTOK = () => (
  <RestaurantPage
    restaurantName="Sushi Matsumoto"
    address="1-49-14 Itabashi, Itabashi-ku, Tokyo, 173-0004, Japan"
    cuisine="Sushi"
    priceRange="¥¥¥"
    phoneNumber="+81359441435"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/sushi-matsumoto-1208306"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The atmosphere is relaxed, with jazz playing in the background. To ensure the most enjoyable sake experience, the chef alternates between snacks and nigiri. This is a great place to try a variety of sakes, served in glasses and accompanied by an extensive selection of snacks and sushi. Toro (fatty tuna) is served first, so that the heat of the freshly cooked vinegared rice melts the fat.  Fresh-toasted nori and tea served in Nambu ironware teapots show commitment without compromise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-49-14%20Itabashi%2C%20Itabashi-ku%2C%20Tokyo%2C%20173-0004%2C%20Japan"
    pageTitle="Sushi Matsumoto"
  />
);

export default SushiMatsumotoTOK;
