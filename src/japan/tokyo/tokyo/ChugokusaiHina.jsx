...
const ChugokusaiHina = () => (
  <RestaurantPage
    restaurantName="Chugokusai HINA"
    address="3F, 2-16-12 Kamimeguro, Meguro-ku, Tokyo, 153-0051, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81364127274"
    website="https://chugokusai-hina.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Counter-style Chinese committed to natural deliciousness. The husband, schooled in the kitchens of Yokohama and Shanghai, focuses on the cooking, while his wife serves guests. The inherent flavours of the ingredients are held paramount, interpreting the seasons of Japan through Chinese cuisine. Each dish is seasoned with restraint and elegance. In a novel twist, instead of Shaoxing wine, items are paired with well-aged Japanese sake or organic wine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%202-16-12%20Kamimeguro%2C%20Meguro-ku%2C%20Tokyo%2C%20153-0051%2C%20Japan"
    pageTitle="Chugokusai HINA"
  />
);

export default ChugokusaiHina;
