...
const TachiguiSushiTonari = () => (
  <RestaurantPage
    restaurantName="Tachigui Sushi Tonari"
    address="2F, 2-8-7 Azabujuban, Minato-ku, Tokyo, 106-0045, Japan"
    cuisine="Sushi"
    priceRange="¥¥"
    phoneNumber="+81364539950"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tachigui-sushi-tonari"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sushi Tonari means ‘sushi next door’, and indeed Tachigui Sushi Tonari is tucked away next to its flagship restaurant. The intimate space, quick turnover and experience of the youthful staff achieve a comfortable informality. Ordering is refreshingly casual, too: requesting one piece at a time is fine. The prevailing theme is ‘vinegar and sushi’. Rice seasoned with rice vinegar harmonises beautifully with the oil of the fish. Reservations, orders and billing are all managed on a digital system. Standing and eating, Edo’s street-stall dining culture, updated for the modern era...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%202-8-7%20Azabujuban%2C%20Minato-ku%2C%20Tokyo%2C%20106-0045%2C%20Japan"
    pageTitle="Tachigui Sushi Tonari"
  />
);

export default TachiguiSushiTonari;
