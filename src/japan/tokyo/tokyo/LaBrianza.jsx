...
const LaBrianza = () => (
  <RestaurantPage
    restaurantName="La Brianza"
    address="3F, Roppongi Hills Residence C, 6-12-3 Roppongi, Minato-ku, Tokyo, 106-0032, Japan"
    cuisine="Italian"
    priceRange="¥¥"
    phoneNumber="+81368045719"
    website="https://la-brianza.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Here, Italian recipes meet Japanese ingredients. The fish carpaccio is subtly flavoured with kelp, while the focaccia is served with a yuzu pepper sauce; the risotto is made with Japanese rice. Both Italian and Japanese cuisines celebrate the four seasons, incorporating unique flavours into every dish. While set menus remain the focus, La Brianza also offers à la carte dishes in the evening, allowing diners to tailor their culinary journey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Roppongi%20Hills%20Residence%20C%2C%206-12-3%20Roppongi%2C%20Minato-ku%2C%20Tokyo%2C%20106-0032%2C%20Japan"
    pageTitle="La Brianza"
  />
);

export default LaBrianza;
