...
const OryoriKatsushi = () => (
  <RestaurantPage
    restaurantName="Oryori Katsushi"
    address="3F, 8-7-19 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81368822111"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/oryori-katsushi"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The owner-chef’s obsession with dashi soup stock was learnt from his mentor, a Kansai native. He mixes dashi of dried bonito flakes, kombu kelp and clams to impart depth and richness. This dashi is found throughout: in savoury egg custard, soup dishes, hot pots and other Japanese favourites. The chef’s choice of career is down to the influence of his brother, a sushi chef, and this brotherly bond is shown in his vinegared rice, simmered abalone liver sauce and pressed chub mackerel sushi. The menu is a stage on a fascinating journey that we’re going to keep watching...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%208-7-19%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Oryori Katsushi"
  />
);

export default OryoriKatsushi;
