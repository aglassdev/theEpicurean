...
const Leau = () => (
  <RestaurantPage
    restaurantName="L'EAU"
    address="B1F, 2-14-14 Minamiaoyama, Minato-ku, Tokyo, 107-0062, Japan"
    cuisine="French"
    priceRange="¥¥¥"
    phoneNumber="+81358430140"
    website="https://leau.tokyo/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The whole restaurant is a canvas on which Takamitsu Shimizu expresses his love of nature. Driftwood and charcoal adorn the stone walls and the cuisine celebrates the seasons, stirring the senses. ‘Water, Leaf, Soil, Tree,’ an amuse bouche, drives this concept home. On dishes moulded in the shapes of mosses and plants are served bite-sized pieces of the bounty of mountain and sea. The appeal of each producing region and producer is on display here, appreciated through the chef’s own filter...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%202-14-14%20Minamiaoyama%2C%20Minato-ku%2C%20Tokyo%2C%20107-0062%2C%20Japan"
    pageTitle="L'EAU"
  />
);
