...
const HibinoChukashokudo = () => (
  <RestaurantPage
    restaurantName="Hibino Chukashokudo"
    address="1-33-11 Uehara, Shibuya-ku, Tokyo, 151-0064, Japan"
    cuisine="Chinese"
    priceRange="¥¥"
    phoneNumber="+81357909655"
    website="https://hibino-chuuka.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Inside a modern space enveloped in the warmth of wood, the concept is togetherness, complementing daily life in Yoyogi Uehara. Based on Sichuan and Cantonese cuisines, the restaurant offers set meals like mapo tofu and boiled chicken during the day, and an à la carte menu in the evening. Like side dishes at home, the small dishes allow you to sample a variety of flavours. The whole crispy chicken is perfect for sharing. Friendly service makes for a pleasant experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-33-11%20Uehara%2C%20Shibuya-ku%2C%20Tokyo%2C%20151-0064%2C%20Japan"
    pageTitle="Hibino Chukashokudo"
  />
);

export default HibinoChukashokudo;
