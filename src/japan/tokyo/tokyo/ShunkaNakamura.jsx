...
const ShunkaNakamura = () => (
  <RestaurantPage
    restaurantName="Shunka Nakamura"
    address="2-11-7 Higashinihombashi, Chuo-ku, Tokyo, 103-0004, Japan"
    cuisine="Chinese"
    priceRange="¥¥¥"
    phoneNumber="+81358469830"
    website="https://syunka-nakamura.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Relentless curiosity is the driving force of this chef. After going to Hong Kong to study Cantonese cuisine, he then worked at a kappo to learn about Japanese food. He calls the marriage of these two shunka, which roughly translates as ‘Chinese food with a seasonal sensibility’. Spring rolls of pike conger or conger eel are one example. The steamed chicken is a secret recipe passed on from his Hong Kong mentor. He presents the home-cooked flavours that Hongkongers love...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-11-7%20Higashinihombashi%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0004%2C%20Japan"
    pageTitle="Shunka Nakamura"
  />
);

export default ShunkaNakamura;
