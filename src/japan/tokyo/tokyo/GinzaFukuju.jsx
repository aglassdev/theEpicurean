...
const GinzaFukuju = () => (
  <RestaurantPage
    restaurantName="Ginza Fukuju"
    address="5F, 8-8-19 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81335718596"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/ginza-fukuju"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Katsuhiro Onodera unearths exquisite flavours by combining the barest minimum of ingredients. The starting point for his creativity is his Tohoku hometown of Kesennuma, where he grew up surrounded by mountains on one side and ocean on the other. Turban shell and bamboo shoot soup, served in seashells, is a homegrown greeting to welcome the spring. Crab baked in the shell and hot pots are somehow hearty and delicate at the same time. The dishes engage all five senses, leaving lasting memories of what you ate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5F%2C%208-8-19%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Ginza Fukuju"
  />
);

export default GinzaFukuju;
