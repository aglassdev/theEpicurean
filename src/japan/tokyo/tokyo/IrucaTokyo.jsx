...
const IrucaTokyo = () => (
  <RestaurantPage
    restaurantName="IRUCA TOKYO"
    address="4-12-12 Roppongi, Minato-ku, Tokyo, 106-0032, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/iruca-tokyo"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef displays his originality in each bowl as he pursues a unique interpretation of ramen. Broths of clam, spiny lobster, free-range chicken and beef combine to create a soup of satisfying depth. Paste of porcini mushrooms and truffles switches up the flavour of soy-sauce ramen. Salt ramen is infused with yuzu flavoured butter to impart a creamy fragrance. ‘Iruca’ comes from the Japanese for ‘dolphin’, a symbol of peace and a message of friendship to spread across the oceans...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-12-12%20Roppongi%2C%20Minato-ku%2C%20Tokyo%2C%20106-0032%2C%20Japan"
    pageTitle="IRUCA TOKYO"
  />
);

export default IrucaTokyo;
