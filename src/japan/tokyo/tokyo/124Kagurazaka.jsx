...
const OneTwoFourKagurazaka = () => (
  <RestaurantPage
    restaurantName="124. KAGURAZAKA"
    address="3F, 12-4 Wakamiyacho, Shinjuku-ku, Tokyo, 162-0827, Japan"
    cuisine="Yakitori"
    priceRange="¥¥"
    phoneNumber="+81344002124"
    website="https://124-kagurazaka.com/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The numbers in the name are both the address of the shop and the birthday of a member of staff. The first skewer is chicken heart, because the deep, rich flavour of this cut makes a strong impression. norimaki (bite-size chunks wrapped in nori seaweed) of chicken tenderloin, cooked vegetable salads and deep-fried tofu intersperse the omakase set meal, varying the tone and providing items that pair agreeably with sake. Ramen in chicken broth closes out the presentation. Served in dragon-pattern bowls with nori to evoke a certain sense of nostalgia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%2012-4%20Wakamiyacho%2C%20Shinjuku-ku%2C%20Tokyo%2C%20162-0827%2C%20Japan"
    pageTitle="124. KAGURAZAKA"
  />
);

export default OneTwoFourKagurazaka;
