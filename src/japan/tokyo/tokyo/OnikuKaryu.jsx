...
const OnikuKaryu = () => (
  <RestaurantPage
    restaurantName="Oniku Karyu"
    address="7F, 1-14-6 Ginza, Chuo-ku, Tokyo, 104-0061, Japan"
    cuisine="Beef"
    priceRange="¥¥¥¥"
    phoneNumber="+81362644129"
    website="https://www.karyu-tokyo.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The chef’s love of beef began when he was a boy, when his father would cook thick-cut steaks for him. He is a beef evangelist, proclaiming its appeal to the world. His decision to create a ‘meat kappo’ arose from his training in kaiseki. Wagyu beef is used in every Japanese preparation style, including nigiri sushi, char-grilled and shabu-shabu. The beauty of the traditional building, the kimono-clad service and the colourful dinnerware all add to the ambience. Through beef cuisine, Oniku Karyu is spreading the word about Japanese culture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7F%2C%201-14-6%20Ginza%2C%20Chuo-ku%2C%20Tokyo%2C%20104-0061%2C%20Japan"
    pageTitle="Oniku Karyu"
  />
);

export default OnikuKaryu;
