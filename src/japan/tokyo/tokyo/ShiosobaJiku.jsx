...
const ShiosobaJiku = () => (
  <RestaurantPage
    restaurantName="Shiosoba Jiku"
    address="4-14-7 Takaidohigashi, Suginami-ku, Tokyo, 168-0072, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/shiosoba-jiku"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef heard the call to the culinary life one day while riding his father’s motorcycle on a long tour around the Seto Inland Sea. When he happened upon a ramen shop along the way, the taste of the salty soba touched his soul. He combines a clear seafood broth with homemade noodles crafted with aroma in mind. The ceiling decoration recalls the roof of an old-time food stall, honouring how ramen culture spread in his native Hiroshima Prefecture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4-14-7%20Takaidohigashi%2C%20Suginami-ku%2C%20Tokyo%2C%20168-0072%2C%20Japan"
    pageTitle="Shiosoba Jiku"
  />
);

export default ShiosobaJiku;
