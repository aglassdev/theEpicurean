...
const MotoazabuKushima = () => (
  <RestaurantPage
    restaurantName="Motoazabu Kushima"
    address="B1F, 3-11-2 Motoazabu, Minato-ku, Tokyo, 106-0046, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥"
    phoneNumber="+81362715516"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/motoazabu-kushima"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Omakase set menus are woven from Japanese Black wagyu beef and seasonal cuisine. Homemade corned beef, shabu-shabu and char-grilled items are perennial favourites here, their flavours deftly highlighted by the chef’s kappo skills. The chef sources his beef from Miyazaki to showcase the attractions of his home region. To vary the pace and tone, mushrooms, puffer fish, crab and other seasonal delights are interspersed. A freewheeling menu brings both joy and satisfaction...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=B1F%2C%203-11-2%20Motoazabu%2C%20Minato-ku%2C%20Tokyo%2C%20106-0046%2C%20Japan"
    pageTitle="Motoazabu Kushima"
  />
);

export default MotoazabuKushima;
