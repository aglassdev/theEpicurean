...
const Lamitie = () => (
  <RestaurantPage
    restaurantName="L'AMITIE"
    address="2-9-12 Takadanobaba, Shinjuku-ku, Tokyo, 169-0075, Japan"
    cuisine="French"
    priceRange="¥¥"
    phoneNumber="+81352725010"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/l-amitie-1194223"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Apprenticing at a bistro in Paris, the chef was captivated by its lively energy. At L'AMITIE, he has put down roots in Takadanobaba with this intimate diner where you can feel like part of the daily life of France. Offerings include meat terrine À la campagne, cassoulet and beef cheek simmered in red wine. À la carte items are prepared for two, so you can enjoy sharing. Savour Gallic culinary culture and the ambience of the French countryside...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-9-12%20Takadanobaba%2C%20Shinjuku-ku%2C%20Tokyo%2C%20169-0075%2C%20Japan"
    pageTitle="L'AMITIE"
  />
);

export default Lamitie;
