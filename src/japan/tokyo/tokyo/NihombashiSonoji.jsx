...
const NihombashiSonoji = () => (
  <RestaurantPage
    restaurantName="Nihombashi Sonoji"
    address="2-22-11 Nihombashiningyocho, Chuo-ku, Tokyo, 103-0013, Japan"
    cuisine="Tempura"
    priceRange="¥¥¥¥"
    phoneNumber="+81356431566"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/nihombashi-sonoji"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The motto on the noren, ‘After having tempura, finish with soba’, declares the personality of Sonoji. The chef learned the arts of both soba and tempura when he ran a shop in his native Shizuoka. For tempura pieces, he focuses on the bounty of Shizuoka’s Suruga Bay and traditional Edo seafood. Vegetables shipped directly from farmers accentuate each season. The soba served at the end of the meal is topped with kakiage of sakura shrimp, ‘the jewel of Suruga Bay’. The unique menu reflects each stage on the chef’s gastronomic journey...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-22-11%20Nihombashiningyocho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0013%2C%20Japan"
    pageTitle="Nihombashi Sonoji"
  />
);

export default NihombashiSonoji;
