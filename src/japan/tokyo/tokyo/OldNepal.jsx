...
const OldNepal = () => (
  <RestaurantPage
    restaurantName="OLD NEPAL"
    address="1-42-11 Gotokuji, Setagaya-ku, Tokyo, 154-0021, Japan"
    cuisine="Nepali"
    priceRange="¥¥¥"
    phoneNumber="+81364136618"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/old-nepal"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant’s name is a shout-out to the culinary culture of Nepal in the good old days. Street scenes of the capital Kathmandu adorn the walls. Keen to convey the mood of old Nepal, the chef uses his own experiences to spin tales on the theme of journeys. Of particular note in his set menu is the creative flair of appetisers. They’re followed by Dal bhat, a dish enjoyed by mixing the flavours of lentil soup, rice and curries – a Nepalese journey of the palate...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-42-11%20Gotokuji%2C%20Setagaya-ku%2C%20Tokyo%2C%20154-0021%2C%20Japan"
    pageTitle="OLD NEPAL"
  />
);

export default OldNepal;
