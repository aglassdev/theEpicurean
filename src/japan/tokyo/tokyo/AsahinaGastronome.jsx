...
const AsahinaGastronome = () => (
  <RestaurantPage
    restaurantName="ASAHINA Gastronome"
    address="1-4 Nihombashikabutocho, Chuo-ku, Tokyo, 103-0026, Japan"
    cuisine="French"
    priceRange="¥¥¥¥"
    phoneNumber="+81358479600"
    website="https://asahinagastronome.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Satoru Asahina pursues a gastronomy of ‘traditional heritage with modern innovation’. He delves into the history of French cuisine to reconstruct ancient recipes with his own interpretations. The prix fixe meal begins with a colourful amuse-bouche and proceeds to plates adorned with multi-layered culinary creations. Consommé pressed through a siphon with a flourish and desserts paraded on trolleys catch the eye. Classic cuisine tuned up to point to the future...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-4%20Nihombashikabutocho%2C%20Chuo-ku%2C%20Tokyo%2C%20103-0026%2C%20Japan"
    pageTitle="ASAHINA Gastronome"
  />
);

export default AsahinaGastronome;
