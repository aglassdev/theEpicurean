...
const HijirizakaWakei = () => (
  <RestaurantPage
    restaurantName="Hijirizaka Wakei"
    address="3-4-2 Mita, Minato-ku, Tokyo, 108-0073, Japan"
    cuisine="Japanese"
    priceRange="¥¥¥¥"
    phoneNumber="+81334860149"
    website="https://wakei.tokyo/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3-4-2%20Mita%2C%20Minato-ku%2C%20Tokyo%2C%20108-0073%2C%20Japan"
    pageTitle="Hijirizaka Wakei"
  />
);

export default HijirizakaWakei;
