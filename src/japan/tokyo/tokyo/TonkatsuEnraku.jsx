...
const TonkatsuEnraku = () => (
  <RestaurantPage
    restaurantName="Tonkatsu Enraku"
    address="6-1-4 Ikegami, Ota-ku, Tokyo, 146-0082, Japan"
    cuisine="Tonkatsu"
    priceRange="¥"
    phoneNumber="+81337548243"
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/tonkatsu-enraku"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The veteran owner-chef has devoted his life to tonkatsu pork cutlets. As he fries pork loin and fillet, he concentrates on the changing colour of the coatings and the hiss of oil in the copper pot. Cabbage is chopped by hand as the pork sizzles. Deft, precise movements calculated with the final result in mind reassure guests. Craftsmanship learned the old-fashioned way, through patient repetition of the master’s lessons, reflects a stance of uncompromising commitment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6-1-4%20Ikegami%2C%20Ota-ku%2C%20Tokyo%2C%20146-0082%2C%20Japan"
    pageTitle="Tonkatsu Enraku"
  />
);

export default TonkatsuEnraku;
