...
const JapaneseRamenGokan = () => (
  <RestaurantPage
    restaurantName="Japanese Ramen Gokan"
    address="2-57-2 Higashiikebukuro, Toshima-ku, Tokyo, 170-0013, Japan"
    cuisine="Ramen"
    priceRange="¥"
    phoneNumber=""
    website="https://guide.michelin.com/en/tokyo-region/tokyo/restaurant/japanese-ramen-gokan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The food looks great, the aroma whets the appetite, the flavour captivates: this ramen sets all five senses tingling. The word ‘Japanese’ in the shop’s name indicates that this is authentic Japan-made ramen; the name is written in Latin script to proclaim Japan’s comfort food to the world. Flavours of each region come together in a single bowl: salt ramen with shijimi and hamaguri clams; soy-sauce ramen with free-range chicken and kombu. Ceramic bowls handmade by a potter are used instead of porcelain. From ingredients to dining ware, the shop revisits the bounty and wonder of Japanese food culture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2-57-2%20Higashiikebukuro%2C%20Toshima-ku%2C%20Tokyo%2C%20170-0013%2C%20Japan"
    pageTitle="Japanese Ramen Gokan"
  />
);

export default JapaneseRamenGokan;
