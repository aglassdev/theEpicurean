...
const Fani = () => (
  <RestaurantPage
    restaurantName="Fani"
    address="51 Grand Rue, Roeser, 3394, Luxembourg"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+35226650660"
    website="https://ristorantefani.lu/Fani.lu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="La cucina italiana has no secrets for Roberti Fani. After earning a Michelin star in his homeland, he has moved shop to the country town of Roeser. On the ground-floor of a rather ordinary residential complex, he has opened a cosy, stylish establishment depicted by seamless professional service and a first-rate sommelier. Chef Fani loves popping out into the dining room, to grate truffles for example. This seasoned chef unveils his immense know-how in a deceptively simple and effortless manner, while his brigade of young chefs add their own creative spin. You might taste warm shrimp in a cream sauce, a warm shellfish mayonnaise and a plankton cream. The chef may also treat you to a mouthwatering risotto of herbs, fried capers and a zest of citrus fruit. Do not be misled, the apparent simpl..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51%20Grand%20Rue%2C%20Roeser%2C%203394%2C%20Luxembourg"
    pageTitle="Fani"
  />
);
