...
const HostellerieStafelter = () => (
  <RestaurantPage
    restaurantName="Hostellerie Stafelter"
    address="rue de Dommeldange 1, Walferdange, 7222, Luxembourg"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+352203397"
    website="https://www.hostellerie-stafelter.lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tom Brosius is the culinary guardian of this modern, elegant hotel. He sources excellent market-fresh produce and locally grown ingredients which are assembled using modern techniques. Varied and delicious, with an appetising vegetarian menu. Comfortable guestrooms...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20Dommeldange%201%2C%20Walferdange%2C%207222%2C%20Luxembourg"
    pageTitle="Hostellerie Stafelter"
  />
);

export default HostellerieStafelter;
