...
const Apdikt = () => (
  <RestaurantPage
    restaurantName="Apdikt"
    address="1 rue des Martyrs, Steinfort, 8442, Luxembourg"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+35226305087"
    website="https://www.restaurantapdikt.lu/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Crispy parcels of grey shrimps with a frothy espuma of cod and samphire. The signature appetiser illustrates the high-flying nature of the experience you can expect in this former apothecary, which sports an authentic herringbone parquet floor and subtle references to mangas and comic strips. Chef Mathieu Van Wetteren voluntarily preserves the mystery of his surprise menu.Painstaking and with an eye for detail, he doesn’t however fall into the trap of overworking his recipes. His creativity aims more for simplicity and purity, rather than fussy frills. A rich millefeuille of celeriac cooked in hay and a noisette emulsion, or confit of salmon trout, cooked in soy and mirin, paired with a gutsy beurre blanc flavoured with trout roe, all of which is smoked and marinated in a fermented daikon ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20rue%20des%20Martyrs%2C%20Steinfort%2C%208442%2C%20Luxembourg"
    pageTitle="Apdikt"
  />
);

export default Apdikt;
