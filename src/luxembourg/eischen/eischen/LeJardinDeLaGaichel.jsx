...
const LeJardinDeLaGaichel = () => (
  <RestaurantPage
    restaurantName="Le Jardin de la Gaichel"
    address="Maison 5, Eischen, 8469, Luxembourg"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+352390129"
    website="https://www.lagaichel.lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Le cosy Jardin de la Gaichel est en parfaite harmonie avec son environnement boisé (un cadre idéal pour passer une nuitée !). La cuisine d’inspiration bretonne va droit au but. Fruits de mer (sur réservation), foie gras, canard découpé en salle… Une vraie cuisine de produits classique...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maison%205%2C%20Eischen%2C%208469%2C%20Luxembourg"
    pageTitle="Le Jardin de la Gaichel"
  />
);

export default LeJardinDeLaGaichel;
