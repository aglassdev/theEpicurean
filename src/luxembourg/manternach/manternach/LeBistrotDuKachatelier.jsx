...
const LeBistrotDuKachatelier = () => (
  <RestaurantPage
    restaurantName="Le bistrot du Kachatelier"
    address="2, A Lambett, Manternach, 6850, Luxembourg"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+352267895950"
    website="https://kachatelier-manternach.lu"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%2C%20A%20Lambett%2C%20Manternach%2C%206850%2C%20Luxembourg"
    pageTitle="Le bistrot du Kachatelier"
  />
);

export default LeBistrotDuKachatelier;
