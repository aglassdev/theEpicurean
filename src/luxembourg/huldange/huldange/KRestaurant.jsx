...
const KRestaurant = () => (
  <RestaurantPage
    restaurantName="K restaurant"
    address="2 Stawelerstrooss, Huldange, 9964, Luxembourg"
    cuisine="Home Cooking, Grills"
    priceRange="€€"
    phoneNumber="+352979056"
    website="https://krestaurant.lu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The imposing K gives you a choice of a modern setting, a more elegant, classical room and a terrace. The fantastic range of dishes is further proof that everyone will find something to suit their palate. From classical dishes and brasserie fare to more elaborate recipes, all prepared generously and, wherever possible, at the last minute. Go on! Treat your taste buds!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20Stawelerstrooss%2C%20Huldange%2C%209964%2C%20Luxembourg"
    pageTitle="K restaurant"
  />
);

export default KRestaurant;
