...
const Cmo = () => (
  <RestaurantPage
    restaurantName="Cômo"
    address="19 rue des Remparts, Esch-sur-Alzette, 4303, Luxembourg"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3525427231"
    website="https://comoresto.lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It is no coincidence that charming Renato Favaro named his restaurant after his birthplace. Inspired by his roots and genuine Mediterranean trattoria traditions, his lasagne alla bolognese and fettucine l ragù are to die for! A talented chef who works only with the very best produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=19%20rue%20des%20Remparts%2C%20Esch-sur-Alzette%2C%204303%2C%20Luxembourg"
    pageTitle="Cômo"
  />
);
