...
const GuillouCampagne = () => (
  <RestaurantPage
    restaurantName="Guillou Campagne"
    address="17 rue de la Résistance, Schouweiler, 4996, Luxembourg"
    cuisine="Classic French"
    priceRange="€€€"
    phoneNumber="+352370008"
    website="https://www.guilloucampagne.lu/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Fans of Gallic fare adore Guillou Campagne. This family-run restaurant was for many years in the hands of Pierrick Guillou and the chefs he trained continue to pay tribute to his legacy on a daily basis. Lysianne and Katell, his widow and daughter, also continue to uphold the family tradition of hospitality in this old stone edifice flanked by an exquisite garden terrace. Authenticity and intensity are the watchwords of Guillou Campagne, so you can expect lashings of cream and butter and ingredients such as foie gras and scallops. The focus is primarily on wholesome, hearty flavours, rather than on fancy or fussy plating. Examples include a hunger-obliterating meat pie of pork, veal and foie gras, smothered in a hearty périgourdine sauce flanked by a green salad tossed in a divine dressing..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=17%20rue%20de%20la%20R%C3%A9sistance%2C%20Schouweiler%2C%204996%2C%20Luxembourg"
    pageTitle="Guillou Campagne"
  />
);

export default GuillouCampagne;
