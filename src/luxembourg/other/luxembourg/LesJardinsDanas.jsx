...
const LesJardinsDanas = () => (
  <RestaurantPage
    restaurantName="Les Jardins d'Anaïs"
    address="2 place Sainte Cunégonde, 1367, Luxembourg"
    cuisine="Creative French"
    priceRange="€€€€"
    phoneNumber="+35228998000"
    website="https://www.jardinsdanais.lu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="These gardens are the epitome of posh elegance from the conservatory overlooking the lush greenery to the guestrooms, without forgetting the champagne trolley. All of which doesn’t prevent the chef from occasionally erring from the path of classicism and giving a free rein to his creative streak. Fillet of smoked sturgeon is paired with a striking gin and caviar sorbet and subtly offset by asparagus, foie gras and grapefruit. Bold, daring, spot-on cuisine!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20place%20Sainte%20Cun%C3%A9gonde%2C%201367%2C%20Luxembourg"
    pageTitle="Les Jardins d'Anaïs"
  />
);

export default LesJardinsDanas;
