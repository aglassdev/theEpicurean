...
const Ryd = () => (
  <RestaurantPage
    restaurantName="Ryôdô"
    address="27 rue Raymond Poincaré, 2342, Luxembourg"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+35227769285"
    website="https://ryodoes.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Ryôdô celebrates and embodies Japanese art de vivre in the heart of Luxemburg’s suburbs. The luminous interior and light wooden furnishings are suitably minimalist and the food is exquisitely served by women attired in kimonos. It is rare to experience such respect for tradition outside Japan and one well worth savouring. The lunchtime score is either à la carte or a range of kaiseki and bento menus, while in the evening, you can choose between Sushi, Vegan or Tasting menus. Chef Ryôdô Kajiwara delicately blends Japanese subtlety with French exuberance, calling upon the pure-bred intensity of outstanding produce, such as A5 wagyu and obsiblue, further underscored by marinades and sauces. Diners are invited to season the tempura of langoustines and tofu, which is surprisingly both crunchy a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27%20rue%20Raymond%20Poincar%C3%A9%2C%202342%2C%20Luxembourg"
    pageTitle="Ryôdô"
  />
);
