...
const BrasserieDesJardins = () => (
  <RestaurantPage
    restaurantName="Brasserie des Jardins"
    address="27b boulevard Marcel Cahen, 1311, Luxembourg"
    cuisine="Traditional Cuisine, Classic French"
    priceRange="€€"
    phoneNumber="+35226259348"
    website="https://brasseriedesjardins.lu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If only we lived next-door to this modern brasserie… Slick, seamless service, a peaceful patio and a traditional lineup crafted by expert hands. The calf’s liver, cooked to perfection, is paired with a shallot sauce, the salmon, raw, cooked or smoked, glistens in an unusual starter, flanked by, among others, kiwi, mango and a coulis of red beetroot: the chef clearly knows his business. The knockout wine list further confirms the establishment’s commitment to fine produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=27b%20boulevard%20Marcel%20Cahen%2C%201311%2C%20Luxembourg"
    pageTitle="Brasserie des Jardins"
  />
);

export default BrasserieDesJardins;
