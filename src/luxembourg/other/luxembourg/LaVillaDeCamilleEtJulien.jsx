...
const LaVillaDeCamilleEtJulien = () => (
  <RestaurantPage
    restaurantName="La Villa de Camille et Julien"
    address="5 rue de Pulvermühl, 2090, Luxembourg"
    cuisine="French, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+35228993993"
    website="https://www.lavilla.lu/fr"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Camille Tardif and Julien Lucas’ knock-out villa is a genuine ode to top-drawer Gallic ingredients. Only the best produce, like Brittany lobster and Provence asparagus, gets onto the table. Chef Lucas learnt the ropes in top French restaurants, notably with Joël Robuchon, as you will quickly taste in his high-flying repertory. His steadfast commitment to sustainable development and his love of Luxemburg produce demonstrate how in tune with his era he is. His delicate craftsmanship and flawless technique can be appreciated in dishes like hare à la royale crafted to textbook perfection: strong gamey meat in a rich sauce with a hint of chocolate and a subtle salad. Julien Lucas exalts the intense flavours of pedigree Gallic cuisine with a scattering of contemporary details, such as fruity cit..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=5%20rue%20de%20Pulverm%C3%BChl%2C%202090%2C%20Luxembourg"
    pageTitle="La Villa de Camille et Julien"
  />
);

export default LaVillaDeCamilleEtJulien;
