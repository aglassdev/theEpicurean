...
const RtisserieArdennaise = () => (
  <RestaurantPage
    restaurantName="Rôtisserie Ardennaise"
    address="1 Avenue du 10 Septembre, 2551, Luxembourg"
    cuisine="Country cooking, Farm to table"
    priceRange="€€€"
    phoneNumber="+352450974"
    website="https://www.rotisserie-ardennaise.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glittering light fixtures and colourful chairs set the scene in this buzzy brasserie, whose watchwords are tradition and emotion. The ingredient is the star of the chef’s distinctive cuisine. He modernises traditional classics, creating contrasts and playing on textures. Spit roasted chicken (also take-away) is one of the house specialties...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Avenue%20du%2010%20Septembre%2C%202551%2C%20Luxembourg"
    pageTitle="Rôtisserie Ardennaise"
  />
);

export default RtisserieArdennaise;
