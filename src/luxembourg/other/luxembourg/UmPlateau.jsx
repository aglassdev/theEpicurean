...
const UmPlateau = () => (
  <RestaurantPage
    restaurantName="Um Plateau"
    address="6 Plateau Altmünster, 1123, Luxembourg"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+35226478426"
    website="https://www.umplateau.lu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Um Plateau is casual, smart and hip. Start with a glass of wine in the lively bar, before perusing the menu which offers a fine choice of dishes to share. Tataki, ceviche, gnocchi cacio e pepe, crunchy sweetbread… A traditional repertory that whisks you off on a culinary festival spanning the Mediterranean and Asia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Plateau%20Altm%C3%BCnster%2C%201123%2C%20Luxembourg"
    pageTitle="Um Plateau"
  />
);

export default UmPlateau;
