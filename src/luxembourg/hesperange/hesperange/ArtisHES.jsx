...
const ArtisHES = () => (
  <RestaurantPage
    restaurantName="Artis"
    address="407 Route de Thionville, Hesperange, 5887, Luxembourg"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+35227858899"
    website="https://www.artis-restaurant.lu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Hao Guo entirely redesigned the interior of Artis with a brand-new colour scheme of soft shades and a cornucopia of contemporary comforts. The food is emblematic of the veteran chef’s experiences in top establishments in Belgium and abroad. While the backbone of his cuisine may be Gallic, he doesn’t hesitate to add international influences. For example, his bouillabaisse reveals the full depth of the salty seafood and is underscored with a rich, yet subtle stock. Chef Guo has an undeniable knack for sauces and his culinary technique is second to none. The extensive menu impresses, as does the spot-on selection of French and Luxembourg wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=407%20Route%20de%20Thionville%2C%20Hesperange%2C%205887%2C%20Luxembourg"
    pageTitle="Artis"
  />
);

export default ArtisHES;
