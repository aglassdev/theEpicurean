...
const FieldsByRenMathieu = () => (
  <RestaurantPage
    restaurantName="Fields by René Mathieu"
    address="6 Rue de Trèves, Findel, 2632, Luxembourg"
    cuisine="Seasonal Cuisine, Vegetarian"
    priceRange="€€€€"
    phoneNumber="+3522883951"
    website="https://fields.lu/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="René Mathieu has set up shop in the Airfield Hotel as he pursues his work with plants. This champion of Luxembourg’s terroir and of the rich plant world continues to grow without disavowing his ambitious or innovative streak. His unorthodox approach to vegetables, herbs and fruits is truly impressive. He presents the raw ingredients of each of his dishes, explaining their qualities and how he cooks them. Chef Mathieu endeavours to shine the spotlight on authentic natural flavours, underscoring them subtly and intensely. His sauces further enhance each dish, adding suave smoky notes which are the baseline of his menu. He might grill leek hearts in the oven before pressing them and then cooking them over an open fire, hence the succulent smoky edge or he may pair a cream of green leek with f..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=6%20Rue%20de%20Tr%C3%A8ves%2C%20Findel%2C%202632%2C%20Luxembourg"
    pageTitle="Fields by René Mathieu"
  />
);

export default FieldsByRenMathieu;
