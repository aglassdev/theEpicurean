...
const BlueBayMarcelRavin = () => (
  <RestaurantPage
    restaurantName="Blue Bay Marcel Ravin"
    address="40 avenue Princesse-Grace, Monaco, 98000, Principality of Monaco"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+37798060035"
    website="https://www.montecarlosbm.com/fr/restaurant-monaco/le-blue-bay"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="After moving from Martinique to Monaco and from Alsace to Belgium, Marcel Ravin, who exhibits a distinct culinary personality, signs off on creative cuisine that transports us to the West Indies. With flawless technical prowess (superb sauces), he recounts his personal history, including his happy youth spent in Martinique. He references the dishes cooked by his grandmother (calalou, blaff, next day's bread), which he reinterprets with panache, incorporating the fine ingredients of these parts: poultry and veal from Piedmont, fish from the Mediterranean, vegetables and aromatic herbs from the kitchen garden. An appealing cuisine bursting with West Indian flavours, nicely rounded off by the fruity and spicy creations of pastry chef Floriane Grand. Sit back and enjoy this culinary experience..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=40%20avenue%20Princesse-Grace%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Blue Bay Marcel Ravin"
  />
);

export default BlueBayMarcelRavin;
