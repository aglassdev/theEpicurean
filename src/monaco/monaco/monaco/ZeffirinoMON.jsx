...
const ZeffirinoMON = () => (
  <RestaurantPage
    ...
    address="11 rue du Portier, Monaco, 98000, Principality of Monaco"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+37797770304"
    website="https://zeffirino-restaurant.com/monaco/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just a stone's throw from the Japanese Garden, this relaxed place, with its warm retro Italian chic (lamps on tables, almond green walls, cane benches and chairs) is dedicated to pasta. The central kitchen and its fresh pasta-making station take pride of place in the restaurant. The authentic Genoese pesto (basil, pine nuts, Pecorino, Parmesan, olive oil and a hint of garlic) is made here according to time-honoured tradition. The quality of every ingredient is top-notch. Here, Riccardo Giraudi, also the creator of the Beefbar brand, pays tribute to Genoese chef Zeffirino Belloni, renowned for his pesto…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=11%20rue%20du%20Portier%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Zeffirino"
  />
);

export default ZeffirinoMON;
