...
const CafDeParis = () => (
  <RestaurantPage
    ...
    address="Place du Casino, Monaco, 98000, Principality of Monaco"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+37798067623"
    website="https://www.montecarlosbm.com/fr/restaurant-monaco/le-cafe-de-paris"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This refurbishment project is the first by renowned British architects, David Collins Studio, in Monaco and the result is spectacular! The firm has intelligently and respectfully preserved the pared-back Art deco spirit so dear to the Café de Paris’ regulars, thus creating an exquisite setting of wrought iron, mosaics and stained glass for chef Victor Marion’s new twist on brasserie classics. Egg mayonnaise with caviar, pâté en croûte, sole meunière and the iconic Crêpe Suzette (which was invented here!), flambéed at the table and served with orange zests in syrup for added decadence… Open morning ‘til night 7 days a week...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20du%20Casino%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Café de Paris"
  />
);

export default CafDeParis;
