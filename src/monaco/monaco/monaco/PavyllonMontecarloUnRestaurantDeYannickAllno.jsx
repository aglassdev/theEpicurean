...
const PavyllonMontecarloUnRestaurantDeYannickAllno = () => (
  <RestaurantPage
    restaurantName="Pavyllon Monte-Carlo, un restaurant de Yannick Alléno"
    address="Square Beaumarchais, Monaco, 98000, Principality of Monaco"
    cuisine="Modern Cuisine, Creative"
    priceRange="€€€€"
    phoneNumber="+37798069898"
    website="https://www.montecarlosbm.com/fr/restaurant-monaco/pavyllon-monte-carlo-restaurant-yannick-alleno"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Yannick Alleno’s gourmet counter food, after finding favour with Parisian city slickers, has set up shop in the Hermitage Hotel in Monte Carlo with the same sure-fire recipes. Namely, gourmet fare that boldly asserts a distinctive unorthodox culinary identity. The open kitchen faces the terrace and the impressive tasting counter in metallic wood, in an elegant blue colour scheme that echoes the nearby sea. In terms of food, the accent is on the seasons and wellbeing, anchored in plants, seafood and low-sugar desserts. In fine weather, meals are served on the Mediterranean garden patio commanding a view of the deep blue sea as a bonus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Square%20Beaumarchais%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Pavyllon Monte-Carlo, un restaurant de Yannick Alléno"
  />
);

export default PavyllonMontecarloUnRestaurantDeYannickAllno;
