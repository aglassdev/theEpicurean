...
const BeefbarMON = () => (
  <RestaurantPage
    ...
    address="42 quai Jean-Charles-Rey, port de Fontvieille, Monaco, 98000, Principality of Monaco"
    cuisine="Meats and Grills"
    priceRange="€€€"
    phoneNumber="+37797770929"
    website="https://beefbar.com/monaco/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="On the docks of Fontvieille Marina, this trendy meat bar serves quality beef (Wagyu, Black Angus and some from France) but also street food, gourmet salads and a few fish dishes. It has a trendy decor and is very popular with local diners. Check out the impressive meat maturation display cases...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=42%20quai%20Jean-Charles-Rey%2C%20port%20de%20Fontvieille%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Beefbar"
  />
);

export default BeefbarMON;
