...
const LesAmbassadeursByChristopheCussac = () => (
  <RestaurantPage
    restaurantName="Les Ambassadeurs by Christophe Cussac"
    address="Hôtel Métropole Monte-Carlo, 4 avenue de la Madone, Monaco, 98000, Principality of Monaco"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+37793151510"
    website="https://metropole.com/fr/pages/restaurant-montecarlo/le-restaurant-les-ambassadeurs-by-christophe-cussac/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The Métropole Monte Carlo Hotel, an iconic Belle Epoque extravaganza (1886), has been entirely revamped by Jacques Garcia, including the luxurious restaurant that sports the graphic palette so dear to the interior designer (bronze, ivory, warm yellow and gold). At the helm, virtuoso chef Christophe Cussac (former disciple of Joël Robuchon who ran the two-star restaurant before it closed for works) brilliantly navigates between a pure-bred Gallic culinary line-up and more modern recipes, all of which with the Mediterranean as baseline. Examples of the chef’s consummate skill include two sweet juicy langoustine tails, green beans and a Maltaise sauce. His high-flying, meticulous cuisine, depicted by spot on seasoning, cooking and plating, gives rise to dishes that are the quintessence of har..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=H%C3%B4tel%20M%C3%A9tropole%20Monte-Carlo%2C%204%20avenue%20de%20la%20Madone%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Les Ambassadeurs by Christophe Cussac"
  />
);

export default LesAmbassadeursByChristopheCussac;
