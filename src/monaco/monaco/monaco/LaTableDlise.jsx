...
const LaTableDlise = () => (
  <RestaurantPage
    restaurantName="La Table d'Élise"
    address="2 rue du Portier, Monaco, 98000, Principality of Monaco"
    cuisine="Traditional Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+37793302070"
    website="https://www.latabledelise.mc"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This swish, fashionable brasserie, located a stone's throw from Monaco’s Japanese Garden and the Grimaldi Forum, welcomes diners in a modern, spacious interior with pop music playing in the background. The Provençal cuisine, prepared with fine seasonal ingredients, is spot on, unfussy, generous and tasty. It is always a pleasure to watch the action in the open-plan kitchen. Excellent lunch deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2%20rue%20du%20Portier%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="La Table d'Élise"
  />
);

export default LaTableDlise;
