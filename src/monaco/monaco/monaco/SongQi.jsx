...
const SongQi = () => (
  <RestaurantPage
    restaurantName="Song Qi"
    address="7 avenue Princesse-Grace, Monaco, 98000, Principality of Monaco"
    cuisine="Asian, Chinese"
    priceRange="€€€"
    phoneNumber="+37799993333"
    website="https://www.song-qi.mc/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite Grimaldi Forum, this swanky, gourmet Chinese restaurant has opted for premium materials and a serene atmosphere. The appetising menu offers a vast array of Chinese cuisine from Peking soup with smoked chicken to crispy dragon prawns with Chinese mustard or the classic dim sum. Bookings advisable!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7%20avenue%20Princesse-Grace%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Song Qi"
  />
);

export default SongQi;
