...
const LabysseMontecarlo = () => (
  <RestaurantPage
    restaurantName="L'Abysse Monte-Carlo"
    address="Square Beaumarchais, Monaco, 98000, Principality of Monaco"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+37798069494"
    website="https://www.montecarlosbm.com/fr/restaurant/labysse-monte-carlo"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Chef Yannick Alléno has implemented the magic formula of his sushi counter – which has already proved to be a hit – in this luxury hotel. In the erstwhile restaurant area of Le Vistamar, the completely modernised dining room (20 covers) and the light wood counter (10 seats) are wholly done out in white tones, with pale pink seats providing pops of colour. The master sushi chef prepares to order delicate compositions and superb sushi, and Yannick Alléno's personal touch makes itself felt in the original creations of highly elegant sauces and jus. A high-calibre culinary offering inspired by a deep dive into the Mediterranean sea...."
    ...
    pageTitle="L'Abysse Monte-Carlo"
  />
);

export default LabysseMontecarlo;
