...
const Yoshi = () => (
  <RestaurantPage
    ...
    address="4 avenue de la Madone, Monaco, 98000, Principality of Monaco"
    cuisine="Japanese"
    priceRange="€€€€"
    phoneNumber="+37793151313"
    website="https://www.metropole.com/fr/restaurant-montecarlo/yoshi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Monte-Carlo is famous for its casino, its princely family, its clay tennis courts and its high-flying restaurants! That of the Hotel Métropole pays tribute to Japanese cuisine with premium ingredients and flawless technique. Aromatic soups, sushi and maki are crafted with a focus on yoshi (goodness) by chef Takeo Yamazaki, whose cuisine, which is more fusion in style than authentically Japanese, has adapted to suit his international clientele. Examples include ghindara no saiko yaki (fillet of black cod marinated and cooked in sake and wrapped in a Japanese magnolia leaf) or ebi shinjo, kombu-flavoured shrimp balls. Slick, sophisticated service...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20avenue%20de%20la%20Madone%2C%20Monaco%2C%2098000%2C%20Principality%20of%20Monaco"
    pageTitle="Yoshi"
  />
);
