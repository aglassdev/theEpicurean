...
const ChanSengKei = () => (
  <RestaurantPage
    restaurantName="Chan Seng Kei"
    address="21 Rua Caetano, Coloane, Macau"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85328882021"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/chan-seng-kei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This semi open-air restaurant, next to an ancient church, has been open for over 80 years; dining under banyan trees in dai pai dong style on a balmy day is quite an experience. Seafood is the highlight as the owner works closely with local fishermen to secure the best catch. Another signature, scallion oil chicken, boasts golden colour, silky flesh and bouncy skin. Robust meaty flavours intertwine with scallion aromas to make every bite unforgettable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=21%20Rua%20Caetano%2C%20Coloane%2C%20Macau"
    pageTitle="Chan Seng Kei"
  />
);

export default ChanSengKei;
