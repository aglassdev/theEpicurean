...
const LaiHeen = () => (
  <RestaurantPage
    ...
    address="51F, The Ritz-Carlton, Galaxy, Estrada da Baía de Nossa Senhora da Esperança, Cotai, Macau"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85388866868"
    website="https://www.laiheenmacau.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="If you’re looking to impress, you can’t fail with this Cantonese restaurant atop a skyscraping hotel. The stunningly ornate room is supremely comfortable, as are the private rooms that can be joined into one big one. Chef Ho has years of experience and his tasty creations boast a modern aesthetic, a match for the sumptuous surroundings. Try their double-boiled soups, honey-glazed Iberico char siu, and Australian veal with ginger and scallion...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=51F%2C%20The%20Ritz-Carlton%2C%20Galaxy%2C%20Estrada%20da%20Ba%C3%ADa%20de%20Nossa%20Senhora%20da%20Esperan%C3%A7a%2C%20Cotai%2C%20Macau"
    pageTitle="Lai Heen"
  />
);
