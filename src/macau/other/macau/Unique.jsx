...
const Unique = () => (
  <RestaurantPage
    restaurantName="Unique"
    address="Shop J, GF, Fai Tat Building, Rua do Comandante João Belo, Macau, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328220456"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/unique-1240825"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(The restaurant is temporarily closed.) Seven varieties of xiao long bao are available, ranging from the traditional pork filling to novelties like cheese and black truffle. The nicely pleated soupy dumplings are made to order and taste even better with chili oil...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20J%2C%20GF%2C%20Fai%20Tat%20Building%2C%20Rua%20do%20Comandante%20Jo%C3%A3o%20Belo%2C%20Macau%2C%20Macau"
    pageTitle="Unique"
  />
);
