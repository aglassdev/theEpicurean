...
const Kika = () => (
  <RestaurantPage
    restaurantName="Kika"
    address="GF, 11A Travessa da Sé, Macau, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328920957"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/kika"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Pop in for an artisan Japanese gelato. Customers are spoiled for exotic choices here – crown melon from Shizuoka, Hokkaido 3.6 milk, Hojicha, and, of course, their famous ultra-strong matcha green tea for die-hard tea lovers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2011A%20Travessa%20da%20S%C3%A9%2C%20Macau%2C%20Macau"
    pageTitle="Kika"
  />
);
