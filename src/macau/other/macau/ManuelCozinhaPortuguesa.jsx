...
const ManuelCozinhaPortuguesa = () => (
  <RestaurantPage
    restaurantName="Manuel Cozinha Portuguesa"
    address="90 Rua de Femão Mendes Pinto, Taipa, Macau"
    cuisine="Portuguese"
    priceRange="$$"
    phoneNumber="+85328827571"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/manuel-cozinha-portuguesa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a spot of renovation for cosier feel, authenticity and hospitality remain the establishment’s hallmark. The friendly owner-chef has revamped the traditional Portuguese menu, now arranged by key ingredient. Using only top-notch seasonal produce, most dishes are barbecued traditionally. Grilled codfish and fried rice with squid ink are the must-tries. Check out the daily specials on the blackboard before ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=90%20Rua%20de%20Fem%C3%A3o%20Mendes%20Pinto%2C%20Taipa%2C%20Macau"
    pageTitle="Manuel Cozinha Portuguesa"
  />
);

export default ManuelCozinhaPortuguesa;
