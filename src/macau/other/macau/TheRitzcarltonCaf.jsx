...
const TheRitzcarltonCaf = () => (
  <RestaurantPage
    restaurantName="The Ritz-Carlton Café"
    address="GF, The Ritz-Carlton, Galaxy, Estrada da Baía de Nossa Senhora da Esperança, Cotai, Macau"
    cuisine="French"
    priceRange="$$"
    phoneNumber="+85388866868"
    website="https://www.ritzcarltoncafemacau.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tiles, mirrors and marble are used to great effect in this lively French brasserie with an all-day dining concept. It prides itself not only on its friendly service, but also on the lineup of French classics. Crusty and golden, their baguette gets the meal off to a good start, tailed by snails in garlic herb butter that are both tender and boldly flavoured. In addition to the à la carte, there is also a seasonal set menu available...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20The%20Ritz-Carlton%2C%20Galaxy%2C%20Estrada%20da%20Ba%C3%ADa%20de%20Nossa%20Senhora%20da%20Esperan%C3%A7a%2C%20Cotai%2C%20Macau"
    pageTitle="The Ritz-Carlton Café"
  />
);

export default TheRitzcarltonCaf;
