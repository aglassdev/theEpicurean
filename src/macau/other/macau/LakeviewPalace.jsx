...
const LakeviewPalace = () => (
  <RestaurantPage
    restaurantName="Lakeview Palace"
    address="GF, West Esplanade, Wynn Palace, Avenida da Nave Desportiva, Cotai, Macau"
    cuisine="Jiangzhe, Sichuan"
    priceRange="$$$"
    phoneNumber="+85388893663"
    website="https://www.wynnresortsmacau.com/en/wynn-palace/dining/lakeview-palace"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The emerald green and gold room sports panoramic windows so guests can admire the musical fountain while dining. The chef, who worked in Jiangsu, Zhejiang and Shanghai for years, melds the rounded flavours of Jiangnan fare with Sichuanese mala seasoning and Cantonese subtlety and freshness. His eight-treasure roast duck is a hybrid between the Huaiyang and Cantonese varieties – sticky rice is wrapped in crispy duck skin and topped with caviar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20West%20Esplanade%2C%20Wynn%20Palace%2C%20Avenida%20da%20Nave%20Desportiva%2C%20Cotai%2C%20Macau"
    pageTitle="Lakeview Palace"
  />
);

export default LakeviewPalace;
