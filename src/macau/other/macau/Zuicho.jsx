...
const Zuicho = () => (
  <RestaurantPage
    restaurantName="Zuicho"
    address="Shop 302, 3F, The Karl Lagerfeld, Grand Lisboa Palace Resort, Rua do Tiro, Cotai, Macau"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+85388811330"
    website="https://www.grandlisboapalace.com/en/restaurants-n-bars/zuicho"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Just like its namesake in Hong Kong, Zuicho specialises in kappo cuisine. With an illustrious career spanning over 30 years, chef Kinomoto rolls out three omakase menus that show attention to detail, meticulous care and exceptional skill. All the ingredients are flown in from Japan, like Hokkaido bafun uni and tuna belly in the hand roll, as well as Satsuma A5 Wagyu from Kagoshima – the tenderloin is deep-fried and sirloin is used in sukiyaki...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20302%2C%203F%2C%20The%20Karl%20Lagerfeld%2C%20Grand%20Lisboa%20Palace%20Resort%2C%20Rua%20do%20Tiro%2C%20Cotai%2C%20Macau"
    pageTitle="Zuicho"
  />
);

export default Zuicho;
