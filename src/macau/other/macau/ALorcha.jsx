...
const ALorcha = () => (
  <RestaurantPage
    restaurantName="A Lorcha"
    address="289 Rua do Almirante Sergio, Macau, Macau"
    cuisine="Portuguese"
    priceRange="$$"
    phoneNumber="+85328313193"
    website="https://www.alorcha.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Business is booming at this friendly restaurant near Barra Temple with a retro nautical theme – locals and tourists just can't get enough of its hearty Portuguese fare. Start with the obligatory salted cod fritter. Besides barbecue dishes cooked over a charcoal grill, the extensive menu includes specialities such as sautéed pork and clams Alentejo style, mixed seafood rice, and Macanese coconut and turmeric chicken. Reservations recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=289%20Rua%20do%20Almirante%20Sergio%2C%20Macau%2C%20Macau"
    pageTitle="A Lorcha"
  />
);

export default ALorcha;
