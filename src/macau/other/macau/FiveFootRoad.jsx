...
const FiveFootRoad = () => (
  <RestaurantPage
    restaurantName="Five Foot Road"
    address="GF, MGM Cotai, Avenida da Nave Desportiva, Cotai, Macau"
    cuisine="Sichuan"
    priceRange="$$"
    phoneNumber="+85388062358"
    website="https://www.mgm.mo/en/cotai/dining/five-foot-road"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The room is aptly decorated with glass murals depicting a Sichuan landscape in ink painting style. The experienced head chef leads a team of Sichuan natives who roll out a diverse range of taste profiles featuring Sichuan spices. Their fried giant white shrimp with chillies pickled in-house boasts bouncy flesh and savoury umami thanks to the fermentation process. The perfumed oil used in Sichuan boiled dishes strikes a balance between numbing heat and aromas...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20MGM%20Cotai%2C%20Avenida%20da%20Nave%20Desportiva%2C%20Cotai%2C%20Macau"
    pageTitle="Five Foot Road"
  />
);

export default FiveFootRoad;
