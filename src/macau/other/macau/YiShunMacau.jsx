...
const YiShunMacau = () => (
  <RestaurantPage
    restaurantName="Yi Shun (Macau)"
    address="381 Avenida de Almeida Ribeiro, Macau, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328583384"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/yi-shun-macau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A longstanding shop offering traditional desserts, such as pineapple with crushed ice and sweet lotus seed soup with egg. Milk custard and ginger milk pudding are house specialties, to which you can add lotus seeds or red beans for extra flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=381%20Avenida%20de%20Almeida%20Ribeiro%2C%20Macau%2C%20Macau"
    pageTitle="Yi Shun (Macau)"
  />
);

export default YiShunMacau;
