...
const Twelve25 = () => (
  <RestaurantPage
    restaurantName="Twelve25"
    address="Shop A-F, GF, Praia Peninsula, Rua Um de Fái Chi Kei, Macau"
    cuisine="French Contemporary"
    priceRange="$$$"
    phoneNumber="+85368821165"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/twelve25"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef rolls out a neo-French score with unorthodox ingredients from around the world, such as marble goby confit in a herb butter that is stuffed with mashed potato and topped with caviar. Beads of tangy champagne sauce are piped around the fish to cut through the richness. To experience the chef’s artistry and creativity, order the 6-course tasting menu; even better with the well-curated wine pairing. Certain items need pre-ordering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20A-F%2C%20GF%2C%20Praia%20Peninsula%2C%20Rua%20Um%20de%20F%C3%A1i%20Chi%20Kei%2C%20Macau"
    pageTitle="Twelve25"
  />
);

export default Twelve25;
