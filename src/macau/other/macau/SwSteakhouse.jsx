...
const SwSteakhouse = () => (
  <RestaurantPage
    restaurantName="SW Steakhouse"
    address="GF, North Esplanade, Wynn Palace, Avenida da Nave Desportiva, Cotai, Macau"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+85388893663"
    website="https://www.wynnresortsmacau.com/en/wynn-palace/dining/sw-steakhouse"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The room is designed like an auditorium, with all tables providing a decent view of the stage. Multimedia shows are put on every half hour for a total experience of art, sound, technology and gastronomy. On top of classics like oysters on the half shell, crab cake, and beef tartare; beef steak cooked in the 1200°F grill is certainly a highlight. Choose among USDA prime, Aussie Black Angus, pureblood and crossbred Wagyu from Japan, NZ and the U.S...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20North%20Esplanade%2C%20Wynn%20Palace%2C%20Avenida%20da%20Nave%20Desportiva%2C%20Cotai%2C%20Macau"
    pageTitle="SW Steakhouse"
  />
);

export default SwSteakhouse;
