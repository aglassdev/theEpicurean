...
const VingKeiMacau = () => (
  <RestaurantPage
    restaurantName="Ving Kei (Macau)"
    address="GF, 47 Rua da Tercena, Macau, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328921152"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/ving-kei-macau"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Apart from the signature cold or hot tofu pudding and soy milk, it also provides tofu products, squid and noodles...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%2047%20Rua%20da%20Tercena%2C%20Macau%2C%20Macau"
    pageTitle="Ving Kei (Macau)"
  />
);

export default VingKeiMacau;
