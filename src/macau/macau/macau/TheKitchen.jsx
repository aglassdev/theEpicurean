...
const TheKitchen = () => (
  <RestaurantPage
    restaurantName="The Kitchen"
    address="3F, Grand Lisboa Hotel, Avenida de Lisboa, Macau, Macau"
    cuisine="Steakhouse"
    priceRange="$$$"
    phoneNumber="+85388037777"
    website="https://www.grandlisboahotels.com/en/dining/the-kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Beef is the star of the show at this handsome, masculine dining room which also houses a sushi bar, a salad bar and a live fish tank. Choose from prime cuts from the U. S. and Wagyu from Kagoshima and Australia; then have it seared on an open flame to your desired 'doneness' and pair it with one of the 17,000-plus wine labels from around the world. Bread is baked daily and appetisers are made in the open kitchen à la minute...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Grand%20Lisboa%20Hotel%2C%20Avenida%20de%20Lisboa%2C%20Macau%2C%20Macau"
