...
const NgaoKeiKaLeiChonMacau = () => (
  <RestaurantPage
    restaurantName="Ngao Kei Ka Lei Chon (Macau)"
    address="GF, 1 Rua de Cinco de Outubro, Macau, Macau"
    cuisine="Noodles and Congee"
    priceRange="$"
    phoneNumber="+85328956129"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/ngao-kei-ka-lei-chon"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%201%20Rua%20de%20Cinco%20de%20Outubro%2C%20Macau%2C%20Macau"
    pageTitle="Ngao Kei Ka Lei Chon (Macau)"
  />
);

export default NgaoKeiKaLeiChonMacau;
