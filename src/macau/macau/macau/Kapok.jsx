...
const Kapok = () => (
  <RestaurantPage
    restaurantName="Kapok"
    address="60 Rua de Hong Chau, Taipa, Macau"
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85328833333"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/kapok"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With ceiling fans, bowl pendant lights and Lingnan-style stained glass, the room is the epitome of yesteryear glamour. The menu is likewise dominated by traditionally made Cantonese favourites - diced pork fat gives har gow extra depth of flavour and the white sugar sponge is perfectly proofed without a hint of sourness. Don’t miss their green chillies stuffed with minced dace, double-boiled soups or seafood dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=60%20Rua%20de%20Hong%20Chau%2C%20Taipa%2C%20Macau"
    pageTitle="Kapok"
  />
);

export default Kapok;
