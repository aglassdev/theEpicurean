...
const LordStowsBakeryRuaDoTassara = () => (
  <RestaurantPage
    restaurantName="Lord Stow's Bakery (Rua do Tassara)"
    address="1 Rua do Tassara, Coloane Town Square, Coloane, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328882534"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/lord-stow-s-bakery-rua-do-tassara"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For over 30 years, the store has prided itself on its Portuguese egg tarts that have a crisp shell and silky, smooth filling. Tarts are made from scratch, baked throughout the day and sold fresh from the oven. Takeout only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20Rua%20do%20Tassara%2C%20Coloane%20Town%20Square%2C%20Coloane%2C%20Macau"
    pageTitle="Lord Stow's Bakery (Rua do Tassara)"
  />
);

export default LordStowsBakeryRuaDoTassara;
