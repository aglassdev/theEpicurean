...
const TheMews = () => (
  <RestaurantPage
    restaurantName="The Mews"
    address="1F, The Londoner, Estrada do lstmo, Cotai, Macau"
    cuisine="Thai"
    priceRange="$$$"
    phoneNumber="+85381188822"
    website="https://www.londonermacao.com/macau-restaurants/the-mews.html?_ga=2.262843407.2087803095.1763013573-1849608999.1763013573"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Diners are bowled over by the high-ceilinged room adorned in colourful lanterns and wood carving, all of which on a mews (stabling for horses in historic London) theme. The native Thai kitchen team reinvents specialities from their homeland with a contemporary spin. Try the mouthwateringly juicy grilled Wagyu beef with red curry and chakram leaves, or the tangy sunflower chicken tom kha soup. Thai-inspired nibbles and cocktails are also highly recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20The%20Londoner%2C%20Estrada%20do%20lstmo%2C%20Cotai%2C%20Macau"
    pageTitle="The Mews"
  />
);

export default TheMews;
