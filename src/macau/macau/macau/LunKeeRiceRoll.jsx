...
const LunKeeRiceRoll = () => (
  <RestaurantPage
    restaurantName="Lun Kee Rice Roll"
    address="26 Rua Do Tarrafeiro, Macau, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85366852245"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/lun-kee-rice-roll"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Since 2011, this simple shop has been serving rice rolls made and steamed to order. His spring onion and whisked egg rice roll is simple but delicious, boasting bouncy texture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=26%20Rua%20Do%20Tarrafeiro%2C%20Macau%2C%20Macau"
    pageTitle="Lun Kee Rice Roll"
  />
);

export default LunKeeRiceRoll;
