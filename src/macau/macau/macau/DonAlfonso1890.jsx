...
const DonAlfonso1890 = () => (
  <RestaurantPage
    restaurantName="Don Alfonso 1890"
    address="Shop 307, 3F, Palazzo Versace, Grand Lisboa Palace Resort, Rua do Tiro, Cotai, Macau"
    cuisine="Italian"
    priceRange="$$$$"
    phoneNumber="+85388811390"
    website="https://www.grandlisboapalace.com/en/restaurants-n-bars/don-alfonso-1890"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This family-owned haute cuisine brand from the Amalfi Coast opened this outpost in Macau to celebrate Italian home-style cooking. Versace’s signature glammed up, glitzy design provides the perfect foil to the equally decadent score. The kitchen pays homage to southern Italian food with vibrant flavours, courtesy of fresh produce from the family's own organic farm – try their handmade tagliolini with parmigiano reggiano and white truffle...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20307%2C%203F%2C%20Palazzo%20Versace%2C%20Grand%20Lisboa%20Palace%20Resort%2C%20Rua%20do%20Tiro%2C%20Cotai%2C%20Macau"
    pageTitle="Don Alfonso 1890"
  />
);

export default DonAlfonso1890;
