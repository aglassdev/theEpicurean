...
const ImperialCourt = () => (
  <RestaurantPage
    ...
    address={"Avenida Dr. Sun Yat-Sen, n.o 1101, 1 Andar (L2) do Hotel \"MGM MACAU\", Macau, Macao"}
    cuisine="Cantonese"
    priceRange="$$"
    phoneNumber="+85388022361"
    website="https://www.mgm.mo/en/macau/dining/imperial-court"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A recurring dragon theme ties this sleek, contemporary room together – from the carved dragon entwined around a marble pillar to the dragon glass sculpture adorning each table. Imported gourmet ingredients are used to great effect in the unmistakably Cantonese menu. In addition to Scottish razor clam salad in fresh galangal sauce, black truffles and foie gras deftly meld Cantonese techniques and Western influences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20MGM%20Macau%2C%20Avenida%20Dr.%20Sun%20Yat%20Sen%2C%20NAPE%2C%20Macau%2C%20Macau"
    pageTitle="Imperial Court"
  />
);

export default ImperialCourt;
