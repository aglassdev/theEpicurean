...
const SushiKinetsu = () => (
  <RestaurantPage
    restaurantName="Sushi Kinetsu"
    address="1F, Nüwa, City of Dreams, Estrada do Istmo, Cotai, Macau"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85328920880"
    website="https://www.cityofdreamsmacau.com/tc/dine/asian/sushi-kinetsu"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Formerly Shinji by Kanesaka that shut its doors amid COVID-19, the upmarket omakase Japanese restaurant has been reincarnated as Sushi Kinetsu. Regulars can rest easy that their sushi are made the same way as before by the same kitchen team. Fish is flown in from Japan three times a week. The rice from Yamagata is cooked in spring water from Kagoshima before being dressed in a light-tasting vinegar. Two menus available; booking essential...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1F%2C%20N%C3%BCwa%2C%20City%20of%20Dreams%2C%20Estrada%20do%20Istmo%2C%20Cotai%2C%20Macau"
    pageTitle="Sushi Kinetsu"
  />
);

export default SushiKinetsu;
