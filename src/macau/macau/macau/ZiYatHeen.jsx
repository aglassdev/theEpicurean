...
const ZiYatHeen = () => (
  <RestaurantPage
    restaurantName="Zi Yat Heen"
    address="GF, Four Seasons Hotel, Estrada da Baía de Nossa Senhora da Esperança, Cotai, Macau"
    cuisine="Cantonese"
    priceRange="$$$"
    phoneNumber="+85328818888"
    website="https://www.fourseasons.com/macau/dining/restaurants/zi_yat_heen"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="This spacious and elegant yet intimate restaurant has a glass-clad wine cellar at its centre. The chef champions a cooking style with reduced amounts of seasoning so as to allow the true flavours of the first-rate ingredients to shine through. Cantonese classics such as succulent honey-glazed char siu with the perfect ratio of fat to lean meat sit alongside novel creations that meld various culinary influences. The dim sum lunch is also a delight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Four%20Seasons%20Hotel%2C%20Estrada%20da%20Ba%C3%ADa%20de%20Nossa%20Senhora%20da%20Esperan%C3%A7a%2C%20Cotai%2C%20Macau"
    pageTitle="Zi Yat Heen"
  />
);

export default ZiYatHeen;
