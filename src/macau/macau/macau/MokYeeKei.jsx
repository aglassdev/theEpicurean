...
const MokYeeKei = () => (
  <RestaurantPage
    restaurantName="Mok Yee Kei"
    address="9 Rua do Cunha, Taipa, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85366695194"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/mok-yee-kei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Offering Serradura pudding and ice cream. The signature durian ice cream comes with Musang King, D24 and Mon Tong choices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20Rua%20do%20Cunha%2C%20Taipa%2C%20Macau"
    pageTitle="Mok Yee Kei"
  />
);

export default MokYeeKei;
