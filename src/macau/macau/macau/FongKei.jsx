...
const FongKei = () => (
  <RestaurantPage
    restaurantName="Fong Kei"
    address="14 Rua do Cunha, Taipa, Macau"
    cuisine="Street Food"
    priceRange="$"
    phoneNumber="+85328827142"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/fong-kei"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A longstanding shop offering Chinese cakes and biscuits. The almond cakes and egg rolls stand out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=14%20Rua%20do%20Cunha%2C%20Taipa%2C%20Macau"
    pageTitle="Fong Kei"
  />
);

export default FongKei;
