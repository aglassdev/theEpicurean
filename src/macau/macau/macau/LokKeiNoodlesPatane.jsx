...
const LokKeiNoodlesPatane = () => (
  <RestaurantPage
    restaurantName="Lok Kei Noodles (Patane)"
    address="1-D Travessa da Saudade, Macau, Macau"
    cuisine="Noodles and Congee"
    priceRange="$"
    phoneNumber="+85328559627"
    website="https://guide.michelin.com/en/macau-region/macau/restaurant/luk-kei-noodle"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This busy shop next to the Chun Lei pier still kneads the noodles with a bamboo pole like in bygone days. The owner’s wife then cooks them perfectly, thus explaining their bouncy texture. The broth simmered with an array of seasonal fish boasts depth and sweetness. Dried prawn roe sprinkled on tossed noodles is toasted by the owner himself, imparting umami and aroma. Also try the crab congee and deep-fried wontons with crispy dace balls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1-D%20Travessa%20da%20Saudade%2C%20Macau%2C%20Macau"
    pageTitle="Lok Kei Noodles (Patane)"
  />
);

export default LokKeiNoodlesPatane;
