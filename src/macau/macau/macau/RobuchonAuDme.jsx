...
const RobuchonAuDme = () => (
  <RestaurantPage
    restaurantName="Robuchon au Dôme"
    address="43F, Grand Lisboa Hotel, Avenida de Lisboa, Macau, Macau"
    ...
    bio="The location at the top of the Grand Lisboa Hotel makes for breathtaking views and is a terrific setting for the restaurant's renowned contemporary French cuisine. Whether as part of the set menu or à la carte, the dishes are intricate, beautifully plated and boast an array of intense flavours. The stunning dessert trolley provides a fitting finale, and the wine list is one of the best in Asia...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=43F%2C%20Grand%20Lisboa%20Hotel%2C%20Avenida%20de%20Lisboa%2C%20Macau%2C%20Macau"
    pageTitle="Robuchon au Dôme"
  />
);

export default RobuchonAuDme;
