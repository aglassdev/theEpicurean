...
const AlainDucasseAtMorpheus = () => (
  <RestaurantPage
    restaurantName="Alain Ducasse at Morpheus"
    address="3F, Morpheus, City of Dreams, Estrada do Istmo, Cotai, Macau"
    cuisine="French Contemporary"
    priceRange="$$$$"
    phoneNumber="+85388683432"
    website="https://www.cityofdreamsmacau.com/en/dine/international/alain-ducasse-at-morpheus"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Water, glass and mood lighting are combined dramatically to create a unique space that is both stylish and intimate, as befits its striking host hotel. The 6-course signature menu can be broken down with a minimum of 3 courses. Every dish is the quintessence of flavour, balance and high-flying gourmet technique. Those familiar with other restaurants headed by renowned French chef Alain Ducasse around the world will recognise his inimitable hallmark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=3F%2C%20Morpheus%2C%20City%20of%20Dreams%2C%20Estrada%20do%20Istmo%2C%20Cotai%2C%20Macau"
    pageTitle="Alain Ducasse at Morpheus"
  />
);

export default AlainDucasseAtMorpheus;
