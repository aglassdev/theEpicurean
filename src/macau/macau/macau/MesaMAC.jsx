...
const MesaMAC = () => (
  <RestaurantPage
    restaurantName="Mesa"
    address="Shop 301, 3F, The Karl Lagerfeld, Grand Lisboa Palace Resort, Rua do Tiro, Cotai, Macau"
    cuisine="Portuguese, Contemporary"
    priceRange="$$$"
    phoneNumber="+85388811800"
    website="https://www.grandlisboapalace.com/en/restaurants-n-bars/mesa"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mesa, which marks iconic chef José Avillez’ inaugural restaurant in the Far East, champions a modern, refined take on Portuguese food. At the helm, the head chef, a disciple of Avillez, faithfully interprets the master’s vision with a menu that highlights the ingredients and craftsmanship. His umami-loaded seafood rice with caviar takes classic arroz de marisco to new heights. Ask the sommelier to help you navigate the wine list of over 250 Portuguese vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%20301%2C%203F%2C%20The%20Karl%20Lagerfeld%2C%20Grand%20Lisboa%20Palace%20Resort%2C%20Rua%20do%20Tiro%2C%20Cotai%2C%20Macau"
    pageTitle="Mesa"
  />
);

export default MesaMAC;
