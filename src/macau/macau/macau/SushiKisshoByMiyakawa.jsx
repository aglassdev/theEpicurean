...
const SushiKisshoByMiyakawa = () => (
  <RestaurantPage
    restaurantName="Sushi Kissho by Miyakawa"
    address="2F, Raffles, Galaxy, Estrada da Baía de Nossa Senhora da Esperança, Cotai, Macau"
    cuisine="Sushi"
    priceRange="$$$$"
    phoneNumber="+85388832221"
    website="https://www.galaxymacau.com/dining/restaurants/sushi-kissho-miyakawa"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The first overseas outpost of the legendary Hokkaido establishment, Sushi Miyakawa is open for dinner only with an omakase menu comprised of 10 Edomae-style sushi, appetisers, miso soup and dessert items. Three types of rice from Hokkaido and Akita prefectures are dressed in a blend of three red vinegars and are perfectly paired with the freshest seasonal catch, mostly from Hokkaido. With only 10 counter seats and one room, reservations are recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=2F%2C%20Raffles%2C%20Galaxy%2C%20Estrada%20da%20Ba%C3%ADa%20de%20Nossa%20Senhora%20da%20Esperan%C3%A7a%2C%20Cotai%2C%20Macau"
    pageTitle="Sushi Kissho by Miyakawa"
  />
);

export default SushiKisshoByMiyakawa;
