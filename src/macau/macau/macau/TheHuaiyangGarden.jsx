...
const TheHuaiyangGarden = () => (
  <RestaurantPage
    restaurantName="The Huaiyang Garden"
    address="Shop 2206a & 2208, 2F, The Londoner, Estrada do Istmo, Cotai, Macau"
    cuisine="Huaiyang"
    priceRange="$$$"
    phoneNumber="+85381188822"
    website="https://www.londonermacao.com/macau-restaurants/huaiyang-garden.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The room has a Jiangnan garden theme, with perforated screens imitating patterned windows commonly seen in Suzhou architecture. Helmed by the renowned culinary master Chef Zhou, the kitchen team excels in sophisticated Huaiyang fare incorporating fresh river fish shipped from the region twice a week, such as stir-fried shrimps with roe and tomalley, or Liangxi-style crispy eel. Dingsheng cake with date filling is a great way to end your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shop%202206a%20%26%202208%2C%202F%2C%20The%20Londoner%2C%20Estrada%20do%20Istmo%2C%20Cotai%2C%20Macau"
    pageTitle="The Huaiyang Garden"
  />
);

export default TheHuaiyangGarden;
