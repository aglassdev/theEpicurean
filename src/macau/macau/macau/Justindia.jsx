...
const Justindia = () => (
  <RestaurantPage
    restaurantName="Justindia"
    address="GF, Block AK, Edifício Jardim Fu Tat, 59 Rua De Bruxelas, Macau, Macau"
    cuisine="Indian"
    priceRange="$$"
    phoneNumber="+85362083100"
    website="https://www.justindiamacau.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After helming an iconic Indian restaurant in Macau for 10+ years, Keralan-born chef Justin Paul opened his own 20-seater with a bar counter. At lunch, set menus offer great value delicacies spanning northern to southern India. The experience is more formal at dinner – alongside various à la carte options, there is a 10-course tasting menu which showcases the full breadth of the chef’s creativity, courtesy of mouth-watering plating...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=GF%2C%20Block%20AK%2C%20Edif%C3%ADcio%20Jardim%20Fu%20Tat%2C%2059%20Rua%20De%20Bruxelas%2C%20Macau%2C%20Macau"
    pageTitle="Justindia"
  />
);

export default Justindia;
