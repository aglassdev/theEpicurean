...
const PlatnGourmet = () => (
  <RestaurantPage
    restaurantName="Platán Gourmet"
    address="Kastély tér 6, Tata, 2890, Hungary"
    cuisine="Creative, Hungarian"
    priceRange="€€€€"
    phoneNumber="+36205486876"
    website="https://platangourmet.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Your evening starts with an aperitif and snacks at the Chef's Table, before you are shown through to a barrel-vaulted cellar with an open kitchen. Here, the team work with calm efficiency and meticulous precision to create a 12 course tasting menu composed of highly sophisticated dishes packed with deep, well-balanced flavours and bags of personality. The setting beneath the castle is magical; for the full experience, stay the night in one of the nearby bedrooms and make the most of their spa...."
    ...
    pageTitle="Platán Gourmet"
  />
);

export default PlatnGourmet;
