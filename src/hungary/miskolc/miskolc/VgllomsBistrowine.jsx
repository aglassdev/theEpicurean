...
const VgllomsBistrowine = () => (
  <RestaurantPage
    restaurantName="Végállomás Bistro&Wine"
    address="Kiss tábornok u 50-52, Miskolc, 3534, Hungary"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+3646402952"
    website="https://vegallomasetterem.hu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It might be tucked away in the suburbs, but this neighbourhood bistro is so highly regarded that plenty of people come from further afield. The cosy terrace has its own wooden bar, and the split-level interior has a relaxed, traditional feel. The ever-evolving menu of seasonal dishes offers something for everyone, and the lunchtime options are great value; keep an eye out for the Bird’s milk and orange egg white foam dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kiss%20t%C3%A1bornok%20u%2050-52%2C%20Miskolc%2C%203534%2C%20Hungary"
    pageTitle="Végállomás Bistro&Wine"
  />
);

export default VgllomsBistrowine;
