...
const Gr = () => (
  <RestaurantPage
    ...
    bio="A góré is a barn used to dry cereals, and that was this sleek restaurant’s former function – although it's hard to imagine following its chic refurbishment. Climb the stairs to the raised dining area beneath the beams and enjoy the view out through the floor-to-ceiling windows; alternatively, enjoy an al fresco experience on the covered terrace. At the heart of the three tasting menus are strong classical foundations but unique additions offer innovation and originality, with fermentation techniques featuring highly. GÓRÉ is remotely set in a sleepy village, so the comfy bedrooms are a bonus...."
