...
const Szaletly = () => (
  <RestaurantPage
    restaurantName="Szaletly"
    address="Stefánia Utca 93, Budapest, 1146, Hungary"
    cuisine="Hungarian"
    priceRange="€€"
    phoneNumber="+36309393932"
    website="https://szaletly.hu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Whether you’re after a drink, a snack or a full meal, this neighbourhood spot is for you if you’re after a laid-back vibe. It’s a spacious place, with a large terrace-cum-garden to boot, but the efficient team cope well with the numbers. Dishes offer a diverse range of influences, but there’s always a Hungarian vein running through their hearts. The tasting menus with matching wines are worth ordering, the gödöllő chicken breast is delicious and, for dessert, it has to be the esterházy. You can even buy a post-dessert ice cream for the way home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stef%C3%A1nia%20Utca%2093%2C%20Budapest%2C%201146%2C%20Hungary"
    pageTitle="Szaletly"
  />
);

export default Szaletly;
