...
const 94KonyhaBar = () => (
  <RestaurantPage
    restaurantName="94' Konyha & Bar"
    address="Falk Miksa utca 10, Budapest, 1055, Hungary"
    cuisine="Vietnamese"
    priceRange="€€"
    phoneNumber="+36709439494"
    website="https://places.neery.net/en/land/94'"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="It would be easy to pass by this unassuming restaurant, but to do so would be a mistake, as inside a warm welcome and great value food awaits. A central bar divides the pared-back room in two, while a rear window offers tantalising glimpses into the kitchen. The super-fresh, vibrantly flavoured cooking has a clear Vietnamese heart, with dishes including a tasty pho and creations such as their own 94' Gohan – a blend of beef, fried rice and XO sauce – but you’ll find some other Asian flavours at play here too. The ‘Lunch Break’ menu is a particular steal and always be sure to finish with a Vietnamese coffee...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Falk%20Miksa%20utca%2010%2C%20Budapest%2C%201055%2C%20Hungary"
    pageTitle="94' Konyha & Bar"
  />
);

export default 94KonyhaBar;
