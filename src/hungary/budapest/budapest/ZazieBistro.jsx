...
const ZazieBistro = () => (
  <RestaurantPage
    restaurantName="Zazie Bistro"
    address="Dombóvári utca 28, MOL Campus, Budapest, 1117, Hungary"
    cuisine="Hungarian"
    priceRange="€€"
    phoneNumber="+36704532500"
    website="https://zaziebistro.hu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Zazie Bistro sits within the tallest skyscraper in Budapest, the MOL Campus, and offers some great views out over the city. It’s a spacious place that incorporates a large open restaurant, a terrace and even a café. The chef brings with him plenty of experience, which shines through in the well-executed, classically inspired, rustic dishes. These could include chilled fruit soups in the summer, or a top-class schnitzel with deliciously creamy potato salad – with the potatoes supplied by the chef’s brother-in-law. There’s also a great value business lunch on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domb%C3%B3v%C3%A1ri%20utca%2028%2C%20MOL%20Campus%2C%20Budapest%2C%201117%2C%20Hungary"
    pageTitle="Zazie Bistro"
  />
);

export default ZazieBistro;
