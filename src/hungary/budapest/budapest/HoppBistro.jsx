...
const HoppBistro = () => (
  <RestaurantPage
    restaurantName="Hoppá! Bistro"
    address="Október 6. utca 15, Budapest, 1051, Hungary"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+36706763185"
    website="https://hoppabistro.hu"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This contemporary eatery stands out amongst the myriad choices on vibrant Október Street, both for its smooth service and its modern, well-presented cooking – and it's certainly a popular spot. Large blackboards announce the daily specials, which see traditional Hungarian recipes brought up-to-date, and the excellent value lunch menu is always a hit. Local beers and wines complete the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Okt%C3%B3ber%206.%20utca%2015%2C%20Budapest%2C%201051%2C%20Hungary"
    pageTitle="Hoppá! Bistro"
  />
);

export default HoppBistro;
