...
const CutBarrel = () => (
  <RestaurantPage
    restaurantName="Cut & Barrel"
    address="Pacsirtamező Utca 41, Budapest, 1031, Hungary"
    cuisine="Meats and Grills, Latin American"
    priceRange="€€€"
    phoneNumber="+36707964711"
    website="https://cutandbarrel.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set away from the city centre in the old Goldberger textile factory, this lovely warehouse conversion comprises a wine shop, an impressive bar, a large dining room with a terrace and a smaller anteroom offering counter dining. The stunning shop comes complete with an incredible selection of wines from around the country – including from the owner’s vineyard (Haraszthy Wines in Etyek) – as well as a Harley Davidson, a Porsche and a Rolls Royce. The food has a strong Latin American base but it’s their own charcuterie and succulent steaks from the Josper grill that lead the way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pacsirtamez%C5%91%20Utca%2041%2C%20Budapest%2C%201031%2C%20Hungary"
    pageTitle="Cut & Barrel"
  />
);

export default CutBarrel;
