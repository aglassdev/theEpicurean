...
const FelixKitchenBar = () => (
  <RestaurantPage
    restaurantName="FELIX Kitchen & Bar"
    address="Ybl Miklós Tér 9, Budapest, 1013, Hungary"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+36307355041"
    website="https://felixbudapest.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Felix sits behind the breathtaking neo-renaissance façade of the former Várkert Kiosk, in a building which once pumped water to the Royal Palace. It’s a plush place, with a stunningly restored ceiling and an air-conditioned terrace. The luxurious menu sees caviar sitting alongside signature dishes and grills...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ybl%20Mikl%C3%B3s%20T%C3%A9r%209%2C%20Budapest%2C%201013%2C%20Hungary"
    pageTitle="FELIX Kitchen & Bar"
  />
);

export default FelixKitchenBar;
