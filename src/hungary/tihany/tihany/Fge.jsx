...
const Fge = () => (
  <RestaurantPage
    restaurantName="füge"
    address="Tihany Yacht Club, Rév utca 7, Tihany, 8237, Hungary"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+36707429224"
    website="https://fugetihany.hu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re visiting in season, make for this bright lakeside restaurant with a chilled vibe. Many of the yachts in the nearby private mooring belong to regular guests, who have crossed Lake Balaton to enjoy either modern Asian-inspired dishes, or pizzas fresh from the oven located on the attractive terrace. Attentive service and bedrooms – some with balconies and water views – make this a great all-round package...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tihany%20Yacht%20Club%2C%20R%C3%A9v%20utca%207%2C%20Tihany%2C%208237%2C%20Hungary"
    pageTitle="füge"
  />
);
