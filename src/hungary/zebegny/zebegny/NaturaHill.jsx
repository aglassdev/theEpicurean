...
const NaturaHill = () => (
  <RestaurantPage
    restaurantName="Natura Hill"
    address="Külterület 0157/84 hrsz, Zebegény, 2627, Hungary"
    cuisine="Modern Cuisine, Hungarian"
    priceRange="€€€"
    phoneNumber="+36301756424"
    website="https://naturahill.hu/en/restaurant"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="It’s all in the name at this sustainably led restaurant. The climb up the steep, narrow lane to the two-hectare estate results in breathtaking Danube Bend views, which become all the more special at sunset. The kitchen follows a ‘slow food’ ethos; ingredients from their nearby farm and the local area underpin the cooking, and menus evolve twice a day as new produce arrives. Dishes are fresh, unfussy and vibrantly flavoured – come for the ‘Spontaneous Bistro Lunch’ or the tasting menu at dinner. An overnight stay is a must, with the holistic experience also including a sauna and wellness centre...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=K%C3%BClter%C3%BClet%200157%2F84%20hrsz%2C%20Zebeg%C3%A9ny%2C%202627%2C%20Hungary"
    pageTitle="Natura Hill"
  />
);

export default NaturaHill;
