...
const Nesta = () => (
  <RestaurantPage
    restaurantName="Nesta"
    address="Bergensesteenweg 500, Sint-Pieters-Leeuw, 1600, Belgium"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+3223613466"
    website="https://www.nesta.style"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As you enter the lifestyle boutique, you will notice the snug restaurant at the rear leading into a pretty garden, where, as you sit on the patio, you may even be forgiven for thinking you’re in Italy! Chef Kayes Ghourabi soaks his recipes in Italian sunshine as recognisable Mediterranean aromas and flavours unfold and captivate our tastebuds. Examples include a pedigree vitello tonnato or a breast of duck with a hazelnut crumble and a drizzling of subtle cooking juices. Bang on every time and always open to new twists...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bergensesteenweg%20500%2C%20Sint-Pieters-Leeuw%2C%201600%2C%20Belgium"
    pageTitle="Nesta"
  />
);
