...
const AugustWijnbar = () => (
  <RestaurantPage
    restaurantName="August Wijnbar"
    address="Alfred Algoetstraat 2b, Sint-Kwintens-Lennik, 1750, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3225324220"
    website="https://www.augustwijnbar.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sam Verstuyf’s pleasantly hip eatery, August, is infectiously lively and gloriously unstuffy. Pajottenland produce takes pride of place in the youthful chef’s creations, to which he adds a dash of originality. Fascinating flavours, a passion for veggies and sophisticated side dishes, without forgetting finely balanced sauces. His creativity knows no bounds. Even better, the fascinating wine list is not only enticing but also at drinker-friendly prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alfred%20Algoetstraat%202b%2C%20Sint-Kwintens-Lennik%2C%201750%2C%20Belgium"
    pageTitle="August Wijnbar"
  />
);

export default AugustWijnbar;
