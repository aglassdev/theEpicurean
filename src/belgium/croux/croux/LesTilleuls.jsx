...
const LesTilleuls = () => (
  <RestaurantPage
    ...
    address="place Communale 2, Céroux, 1341, Belgium"
    cuisine="Home Cooking"
    priceRange="€€"
    phoneNumber="+3210453585"
    website="https://tilleuls.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The former village hall of Céroux-Mousty has been turned into a welcoming bistro. Marc Volkaerts has thrown all his experience and enthusiasm into his own individual version of classical cuisine, such as tartare steak or duck shepherd’s pie, adding a personal and distinctive spin to consummately bistronomic dishes. Masterful!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20Communale%202%2C%20C%C3%A9roux%2C%201341%2C%20Belgium"
    pageTitle="Les Tilleuls"
  />
);

export default LesTilleuls;
