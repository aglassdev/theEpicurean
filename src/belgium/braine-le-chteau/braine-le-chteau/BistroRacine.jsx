...
const BistroRacine = () => (
  <RestaurantPage
    restaurantName="Bistro Racine"
    address="place de la Station 3, Braine-le-Château, 1440, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3223661051"
    website="https://www.bistroracine.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Bistro Racine is proof that, contrary to popular belief, a MICHELIN star isn’t always about fancy fine dining. One immediately feels at home in this setting that mixes modern and authentic fixtures and fittings and in which the open kitchen plays the star role. Jimmy Collodoro regales diners with premium produce. The market-fresh, seasonal dishes, chalked up on a slate, change regularly, without forgetting firm fixtures, like beef grilled in a Mibrasa charcoal oven. The food is finely crafted and refreshingly straightforward. Unexpected details add a humorous twist, illustrated by a creamy risotto of celeriac underscored by salty slices of mature mimolette and a vibrant sprinkling of cardamon powder. Playful, surprising and heroically legible food that hits the spot every time, courtesy of..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20de%20la%20Station%203%2C%20Braine-le-Ch%C3%A2teau%2C%201440%2C%20Belgium"
    pageTitle="Bistro Racine"
  />
);

export default BistroRacine;
