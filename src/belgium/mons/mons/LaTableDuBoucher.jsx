...
const LaTableDuBoucher = () => (
  <RestaurantPage
    restaurantName="La Table du Boucher"
    address="rue d'Havré 49, Mons, 7000, Belgium"
    cuisine="Meats and Grills, Classic French"
    priceRange="€€"
    phoneNumber="+3265316838"
    website="https://www.latableduboucher.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20d'Havr%C3%A9%2049%2C%20Mons%2C%207000%2C%20Belgium"
    pageTitle="La Table du Boucher"
  />
);

export default LaTableDuBoucher;
