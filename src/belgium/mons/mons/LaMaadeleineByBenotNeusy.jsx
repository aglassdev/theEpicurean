...
const LaMaadeleineByBenotNeusy = () => (
  <RestaurantPage
    restaurantName="La Maadeleine by Benoît Neusy"
    address="rue de la Halle 42, Mons, 7000, Belgium"
    cuisine="Modern Cuisine, Seafood"
    priceRange="€€€"
    phoneNumber="+32472783463"
    website="https://www.lamaadeleine.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The crisp minimalist lines and natural dune coloured palette of La MAAdeleine bear the distinctive hallmark of MAArchitects. Seasoned chef Benoît Neusy unveils the full gamut of his delicate score, as he shines the spotlight on fish and seafood, as well as surf ‘n turf dishes. He may enhance textbook vol-au-vent (crisp melt-in-the-mouth puff pastry and a velvety sauce to die for) by adding crispy calf’s sweetbread and prawns to the traditional chicken filling. The chef often adds playful touches to full-bodied, familiar flavours, illustrated by cod prepared in a crust of mimolette cheese. Neusy has managed to progress and evolve, whilst remaining true to the heart-warming culinary signature that has earned him so many faithful and enthusiastic followers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20la%20Halle%2042%2C%20Mons%2C%207000%2C%20Belgium"
    pageTitle="La Maadeleine by Benoît Neusy"
  />
);

export default LaMaadeleineByBenotNeusy;
