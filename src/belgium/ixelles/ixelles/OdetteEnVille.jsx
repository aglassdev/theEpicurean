...
const OdetteEnVille = () => (
  <RestaurantPage
    restaurantName="Odette en Ville"
    address="rue du Châtelain 25, Ixelles, 1050, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3226402626"
    website="https://www.odetteenville.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Odette is a well-known eatery of the trendy Châtelain neighbourhood. The stylish 1920’s townhouse aims to combine British style, Parisian sensuality and New York glamour. The highly varied menu is equally fascinating: both classical and international, with an accent on the ingredient. Crunchy nems in a spicy sauce, al dente taglioni in lemon with pink shrimps, scallops and foie gras in a duck stock: a festival for fine food lovers. And why not treat yourself to one of the swish designer-inspired guestrooms to finish your evening in the lap of luxury?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Ch%C3%A2telain%2025%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Odette en Ville"
  />
);

export default OdetteEnVille;
