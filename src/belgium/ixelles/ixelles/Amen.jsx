...
const Amen = () => (
  <RestaurantPage
    restaurantName="Amen"
    address="rue Franz Merjay 165, Ixelles, 1050, Belgium"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+3222171019"
    website="https://amen.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Two-star chef Pascal Devalkeneer (Le Chalet de la Forêt) has a knack for picking the best produce. From the contemporary dishes and intense flavours to the range of textures, his dishes are masterpieces of culinary art. Amen!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Franz%20Merjay%20165%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Amen"
  />
);
