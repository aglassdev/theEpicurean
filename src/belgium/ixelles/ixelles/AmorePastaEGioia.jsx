...
const AmorePastaEGioia = () => (
  <RestaurantPage
    restaurantName="Amore, Pasta e Gioia"
    address="Rue de la Crêche 11, Ixelles, 1050, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3227850045"
    website="https://amore-pasta-gioia.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name of this family-run osteria rather says it all! In the company of Giuseppe and Karina in the kitchen and Kevin in the dining room, you know you are in the hands of a team you can trust. Start with an array of flavoursome antipasti, like beef carpaccio and shavings of parmesan laced in a tangy dressing, followed by a dish of house-made pasta, like al dente tagliatelle in a gutsy meat sauce. Next what about a succulent Angus rib steak alla tagliata? Each dish is packed in indulgent Italian scents and flavours and rather than fussy frills, you can expect familiar, heartwarming flavours. Go there your eyes closed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Cr%C3%AAche%2011%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Amore, Pasta e Gioia"
  />
);

export default AmorePastaEGioia;
