...
const NonbeDaigaku = () => (
  <RestaurantPage
    restaurantName="Nonbe Daigaku"
    address="avenue Adolphe Buyl 31, Ixelles, 1050, Belgium"
    cuisine="Japanese, Sushi"
    priceRange="€€€"
    phoneNumber="+3226492149"
    website="https://nonbedaigaku.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you like eating Japanese, you shouldn’t miss this modest venue. The very experienced chef has mastered the subtlety and nuances that are typical of the cuisine of his home country. You can see him at work behind the sushi bar, driven and precise, creating a delicious variety of flavours and textures...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20Adolphe%20Buyl%2031%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Nonbe Daigaku"
  />
);

export default NonbeDaigaku;
