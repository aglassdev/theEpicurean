...
const ToucanBrasserie = () => (
  <RestaurantPage
    restaurantName="Toucan Brasserie"
    address="avenue Louis Lepoutre 1, Ixelles, 1050, Belgium"
    cuisine="French, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3223453017"
    website="https://toucan.brussels/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The buzzy vibe of the Châtelain district sets the scene in this modern take on a traditional brasserie, embellished with a design twist. The locals flock here for its friendly, casual atmosphere and its wholesome no-nonsense nosh. Flawlessly fresh oysters, platters of seafood, melt-in-the-mouth steak, terrine or andouillette: the focus is on top-quality traditional fare served generously...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20Louis%20Lepoutre%201%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Toucan Brasserie"
  />
);

export default ToucanBrasserie;
