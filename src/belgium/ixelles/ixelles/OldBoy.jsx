...
const OldBoy = () => (
  <RestaurantPage
    restaurantName="Old Boy"
    address="rue de Tenbosch 110, Ixelles, 1050, Belgium"
    cuisine="Asian, Fusion"
    priceRange="€€"
    phoneNumber="+32471256803"
    website="https://oldboyrestaurant.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Old Boy is the epitome of smoky, flame-licked Southeast Asian vibes, but with Belgian ingredients from local producers of the likes of Le Monde des Mille Couleurs and Dierendonck. The result is sparkling, lively fusion cuisine that spans Bangkok, Thailand and China, embodied by thrilling, fire-driven street food and carefully-calibrated spices. A grilled duck breast acquires a whole new dimension courtesy of green curry sauce, coconut milk, and Thai basil. The interior is cool, hip and packed with buzzy vibrancy. A refreshing trendy interior, a spot-on natural wine list and a mouth-watering menu. Book ahead for dinner — it is often packed to the seams...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20Tenbosch%20110%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Old Boy"
  />
);

export default OldBoy;
