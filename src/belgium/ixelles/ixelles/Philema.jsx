...
const Philema = () => (
  <RestaurantPage
    restaurantName="Philema"
    address="chaussée de Waterloo 437, Ixelles, 1050, Belgium"
    cuisine="Greek"
    priceRange="€€"
    phoneNumber="+3223445876"
    website="https://www.philema.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A gourmet festival of summertime flavours awaits you at Manos Makrygiannakis. The chef, who hails from Crete, shines the spotlight on ingredients that are steeped in Mediterranean spices and aromas. Authentic food based on top-quality produce (on sale at the shop). A friendly vibe depicts this establishment, ideal to share a delicate spanakopita, grilled cuttlefish and melt-in-the-mouth baklava with friends. A Greek feast!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Waterloo%20437%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Philema"
  />
);

export default Philema;
