...
const OsteriaBolognese = () => (
  <RestaurantPage
    restaurantName="Osteria Bolognese"
    address="rue de la Paix 49, Ixelles, 1050, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3226085154"
    website="https://osteriabolognese.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Giacomo’s mission is to redress the hackneyed image of ‘spag bol’ and his mouth-watering tagliatelle con ragù alla bolognese does just that! All his ingredients are sourced direct from Emilia Romagna, ensuring an explosion of flavour in the mouth. Our inspectors were treated to taglioni with flash fried bresaola, a syrupy balsamic vinegar packed in bitter-sweet flavours and spicy rucola. A buzzy, vibrant vibe depicts this delightful osteria that will introduce you to the authentic cuisine of Bologna...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20la%20Paix%2049%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Osteria Bolognese"
  />
);

export default OsteriaBolognese;
