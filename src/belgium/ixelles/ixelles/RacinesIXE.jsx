...
const RacinesIXE = () => (
  <RestaurantPage
    ...
    address="chaussée d'Ixelles 353, Ixelles, 1050, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3226429590"
    website="https://www.racinesbruxelles.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Leave the noisy Chaussée d'Ixelles and walk past the grocery counter into this delightfully vintage restaurant, which is awash in Mediterranean details and boasts an delightful terrace. Welcome to this authentic Italian establishment, where the chef will take you on a culinary journey from the north to the south of the Boot. Try the house-made tagliolini with parmesan and earthy cavolo nero, or the intensely flavoursome San Marzano tomato flan, drizzled with olive oil. The chef's creative and meticulous take on traditional recipes shines through. Featuring an impressive range of Italian labels, the wine list is well worth exploring...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20d'Ixelles%20353%2C%20Ixelles%2C%201050%2C%20Belgium"
    pageTitle="Racines"
  />
);

export default RacinesIXE;
