...
const Jacqueline = () => (
  <RestaurantPage
    restaurantName="Jacqueline"
    address="Van Colenstraat 8, Boechout, 2530, Belgium"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+3232843033"
    website="https://www.restaurantjacqueline.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former butchery is named after the grandmother of Evelien Swiers, who is in charge of the kitchen you can see behind the original counter. Good humoured Raf supervises the dining room, which sports a gentrified workshop vibe. Evelien’s delicious, no-frills cuisine revolves around a menu of four or five dishes. Guinea fowl from Maison Garat is cooked in a frying pan and underscored by a knockout jus enriched in miso, while chicory adds a fresh note with a mandarin sabayon. At Jacqueline, the food is rustic, gutsy and wholesome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Van%20Colenstraat%208%2C%20Boechout%2C%202530%2C%20Belgium"
    pageTitle="Jacqueline"
  />
);
