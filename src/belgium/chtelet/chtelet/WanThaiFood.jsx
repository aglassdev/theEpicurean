...
const WanThaiFood = () => (
  <RestaurantPage
    restaurantName="Wan Thai Food"
    address="Rue du Commerce 4, Châtelet, 6200, Belgium"
    cuisine="Thai"
    priceRange="€€"
    phoneNumber="+3271553933"
    website="https://www.wanthaifood.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal at Wan Thai Food is an education in just how irresistible authentic Thai cuisine can be. The decor featuring plenty of wood and bamboo, lanterns, Buddha statues and other Asian-inspired touches has a distinct street food feel. The extensive menu features all the classic dishes of the genre, freshly prepared by chef Wanna. Tempting options include handmade chicken gyoza served with an exquisite umami-rich soy sauce, as well as a rich fruity and spicy curry with perfectly seared scallops. The delicious sauces are definitely worth a mention! Why not add a refreshing cocktail to your order for an extra exotic kick?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Commerce%204%2C%20Ch%C3%A2telet%2C%206200%2C%20Belgium"
    pageTitle="Wan Thai Food"
  />
);

export default WanThaiFood;
