...
const LentreDeux = () => (
  <RestaurantPage
    restaurantName="L'Entre D'Eux"
    address="rue Saint-Antoine 84, Pont-à-Celles, 6230, Belgium"
    cuisine="French Contemporary"
    priceRange="€€"
    phoneNumber="+3271957668"
    website="https://www.lentredeuxpac.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The restaurant of chef Caroline Druine and your master of ceremonies, Alexandre, is warm and inviting and exudes a lovely home-from-home feel. The small garden patio, near the pear trees, is ideal for alfresco summer dining. The culinary focus is on local produce, decadent flavours and painstaking craftswomanship. The chef may wrap a juicy ballotine of pheasant in a cabbage leaf, which she then stuffs with sweet chestnuts and pumpkin. A punchy cognac sauce and a few well-chosen side dishes add the finishing touch to this rich seasonal dish. The savvily curated wine list is definitely worth spending time over, all the more so as it stars a fine selection of organic vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Saint-Antoine%2084%2C%20Pont-%C3%A0-Celles%2C%206230%2C%20Belgium"
    pageTitle="L'Entre D'Eux"
  />
);

export default LentreDeux;
