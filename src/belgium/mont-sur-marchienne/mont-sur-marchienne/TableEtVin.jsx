...
const TableEtVin = () => (
  <RestaurantPage
    restaurantName="Table et Vin"
    address="Avenue Paul Pastur 122, Mont-sur-Marchienne, 6032, Belgium"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+3271878918"
    website="https://tableetvin.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Shelves laden with innumerable wine bottles immediately catch the eye as you enter this inviting gourmet eatery-cum-wine cellar. Master sommelier Thierry Jacques welcomes you warmly before sharing the secrets of his lovingly curated selection. Next, chef Husson takes the stage, rolling out a spot-on, wholehearted repertory that is showcased in a set menu with a wide range of choices. Examples include melt-in-the-mouth pig's feet with a terrine of foie gras, lentils, a powerful stock and tarragon that adds an invigorating kick. Food from a bygone era, oozing with wholesome, big-boned flavours. Passion and know-how set the scene at Table et Vin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Paul%20Pastur%20122%2C%20Mont-sur-Marchienne%2C%206032%2C%20Belgium"
    pageTitle="Table et Vin"
  />
);

export default TableEtVin;
