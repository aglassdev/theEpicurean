...
const TPachthuis = () => (
  <RestaurantPage
    restaurantName="'t Pachthuis"
    address="Gentse Steenweg 264, Zottegem, 9620, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+32493916351"
    website="https://www.tpachthuis.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the walls of this characterful villa hides a romantic restaurant and a lovely garden patio – ideal for lunch or dinner in summertime! Chef De Keyser shares his fondness for classicism as you will quickly remark when you taste his sauces. However, he is not averse to a dash of originality thanks to subtle combinations of flavours and modern influences. Excellent value for pleasure!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gentse%20Steenweg%20264%2C%20Zottegem%2C%209620%2C%20Belgium"
    pageTitle="'t Pachthuis"
  />
);

export default TPachthuis;
