...
const UnMaxDeGot = () => (
  <RestaurantPage
    restaurantName="Un Max de Goût"
    address="quai de l'Ourthe 17, Comblain-au-Pont, 4170, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3243691708"
    website="https://maxdegout.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Maxime Zimmer is a chef who is going from strength to strength as he finetunes his sophisticated palette. Foodies have long known his Ardennes establishment, whose contemporary elegance blends seamlessly into the picturesque landscape of the Ourthe that meanders outdoors and where this young master chef is thriving. The ingredient-focused lineup of this artisan relies on produce from local suppliers and his own creative flair, as he transforms familiar ingredients into fascinating dishes.He may start by searing a rib-eye steak to give it a crisp crust, before smoking it over the barbecue and then pairing it with a powerful sauce of crushed pepper corns and celeriac soaked in cognac. Similarly, he highlights the numerous facets of celeriac by way of different preparations: cooked in a salt ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=quai%20de%20l'Ourthe%2017%2C%20Comblain-au-Pont%2C%204170%2C%20Belgium"
    pageTitle="Un Max de Goût"
  />
);

export default UnMaxDeGot;
