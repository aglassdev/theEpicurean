...
const LeCirque = () => (
  <RestaurantPage
    ...
    address="Nieuwe Baan 88b, Belsele, 9111, Belgium"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3232960202"
    website="https://www.lecirque.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come in, come in - take a seat and enjoy and the show! Do not be misled by the apparently low - key interior - the climax of the performance comes on the plate! The chef is a fervent disciple of modern culinary techniques and masterfully produces recipes whose texture, structure and colour are both stunning and delicious. A treat for your taste buds!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwe%20Baan%2088b%2C%20Belsele%2C%209111%2C%20Belgium"
    pageTitle="Le Cirque"
  />
);

export default LeCirque;
