...
const DeHuifkar = () => (
  <RestaurantPage
    restaurantName="De Huifkar"
    address="Koninklijke Baan 142, Koksijde, 8670, Belgium"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+3258511668"
    website="https://www.dehuifkar.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fish and lobster are the specialties of this vintage-modern restaurant. Admire the quality and freshness of the produce in the lobster tank at the entrance. The chef is keen on classical recipes and generous flavours, depicted by timeless dishes such as monkfish with shrimp, local-style poached cod, without forgetting Belgium’s family favourite, veal kidneys in mustard sauce. Affordable gastronomy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Koninklijke%20Baan%20142%2C%20Koksijde%2C%208670%2C%20Belgium"
    pageTitle="De Huifkar"
  />
);

export default DeHuifkar;
