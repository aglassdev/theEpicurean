...
const Lessentiel = () => (
  <RestaurantPage
    restaurantName="l'Essentiel"
    address="rue Roger Clément 32, Temploux, 5020, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3281568616"
    website="https://www.lessentiel.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A meal at l'Essentiel is an opportunity to explore an idyllic valley of the Namur countryside. A 17C tannery has been turned into an exquisite eatery dripping in cachet that boasts a romantic décor and a well-oiled front-of-house team. The establishment’s excellent value-for-money is another of its appeals. You should know that chef Raphaël Adam is nothing if not generous – you will have a choice of ten sorts of house-made bread, a huge cheese platter and a wickedly tempting lineup of fresh pastries to accompany your coffee at the end of the meal. Big-boned rich flavours are the hallmark if chef Adam, who likes to play on contrasts without ever overdoing it. Examples of his deft craftsmanship include perfectly cooked lobster with crispy sweetbread, spring veggies and a bearnaise sauce of l..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Roger%20Cl%C3%A9ment%2032%2C%20Temploux%2C%205020%2C%20Belgium"
    pageTitle="l'Essentiel"
  />
);
