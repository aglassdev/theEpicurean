...
const LesEleveurs = () => (
  <RestaurantPage
    restaurantName="Les Eleveurs"
    address="Suikerkaai 1a, Halle, 1500, Belgium"
    cuisine="Classic Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+3223611340"
    website="https://www.les-eleveurs.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Les Eleveurs hotel restaurant, a landmark of Halle since 1897, has been run by the De Brouwer family since its foundation. Today, Annelies and Julian are breathing new life into their family heritage. Master Jochen Heyvaerts can be relied upon to ply you with excellent wine tips in addition to seamless service, while chef Borsy orchestrates the highly popular traditional culinary score, adding his own personal melody as he celebrates Pajottenland specialties. The extensive menu ranges from family favourites such as quenelles of pike and melt-in-the-mouth Iberico loin of pork with gherkins and crispy crackling to a bona fide tournedos Rossini. Go there your eyes closed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Suikerkaai%201a%2C%20Halle%2C%201500%2C%20Belgium"
    pageTitle="Les Eleveurs"
  />
);

export default LesEleveurs;
