...
const CuisineNous = () => (
  <RestaurantPage
    restaurantName="Cuisine & Nous"
    address="Avenue Joseph Wauters 2, Tilff, 4130, Belgium"
    cuisine="French Contemporary"
    priceRange="€€"
    phoneNumber="+3243683683"
    website="https://www.cuisineetnous.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Cuisine & Nous is a no-nonsense eatery, known for its warm, welcoming vibe. Modern materials adorn the characterful walls of this Ardennes edifice. The enthusiastic chef enjoys reworking Gallic recipes, adding his own hallmark signature. Fancy a duck breast in a popcorn crust? His no-holds barred approach to cooking is underscored by his superlative culinary expertise. Exemplary value for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Joseph%20Wauters%202%2C%20Tilff%2C%204130%2C%20Belgium"
    pageTitle="Cuisine & Nous"
  />
);

export default CuisineNous;
