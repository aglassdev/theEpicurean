...
const Le13 = () => (
  <RestaurantPage
    restaurantName="Le 13"
    address="rue des Alliés 17, Libramont, 6800, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3261278132"
    website="https://www.le13.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fashionably revamped manor house: Panton chairs, designer lighting, fashionable colours and a large wall board that forms the menu. Contemporary cuisine and terrace facing the station...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20des%20Alli%C3%A9s%2017%2C%20Libramont%2C%206800%2C%20Belgium"
    pageTitle="Le 13"
  />
);
