...
const Robertissimo = () => (
  <RestaurantPage
    restaurantName="Robertissimo"
    address="voie de l'Ardenne 58b, Embourg, 4053, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3243657212"
    website="https://www.lerobertissimo.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Be forewarned – once you have experienced the joyful vibe and flair of this lively establishment, you will be yearning to return again and again! The big-hearted chef skilfully and generously rustles up genuine Italian fare: immaculately cooked calf’s liver in a gutsy jus served with al dente pasta in butter. Bravissimo for this autentico banquet of Italian delicacies designed to appeal to discerning foodies!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=voie%20de%20l'Ardenne%2058b%2C%20Embourg%2C%204053%2C%20Belgium"
    pageTitle="Robertissimo"
  />
);

export default Robertissimo;
