...
const Castor = () => (
  <RestaurantPage
    restaurantName="Castor"
    address="Kortrijkseweg 164, Beveren-Leie, 8791, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3256190121"
    website="https://www.cas-tor.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Purity is the name of the game at Castor. The elegant yet brutalist-looking cube on Kortrijkseweg is home to a modern interior of wood, glass and concrete. Stefanie sets the tone of the restaurant’s classy front-of-house style, while Maarten Bouckaert surprises the diner right from the appetisers. From the ingredients and the sauces to the savvy blend of exotic flavours, the chef unveils his talent at every step. Stints with culinary virtuosos of the likes of Peter Goossens enabled him to hone his skills, which he now deploys with tact and sensitivity. Examples: pork cheeks braised in Rodenbach beer and paired with tagliatelle of cuttlefish, cockles and mussels, together with a knockout gravy of briny cuttlefish, a reduction of beer and crispy tempura tentacles. A feast of culinary delicac..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kortrijkseweg%20164%2C%20Beveren-Leie%2C%208791%2C%20Belgium"
    pageTitle="Castor"
  />
);
