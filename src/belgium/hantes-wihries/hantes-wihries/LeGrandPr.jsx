...
const LeGrandPr = () => (
  <RestaurantPage
    restaurantName="Le Grand Pré"
    address="Rue du Grand Pré 13A, Hantes-Wihéries, 6560, Belgium"
    cuisine="French, Creative French"
    priceRange="€€"
    phoneNumber="+32499276405"
    website="https://www.legrandpre.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sprawling meadows encircle this old riverside stone farmstead, so it isn’t surprising that the country vibe has wound its tendrils into the interior. This friendly eatery takes pride in sourcing local Walloon produce that is crafted into a lineup of pedigree seasonal Gallic fare, like saddle of lamb, cooked rare in a herby crust, garnished with a subtle rosemary gravy and potato salad. The splendid wine list boasts over 400 references and is definitely worth a gander. A meal at the Grand Pré makes the perfect ending to a tour of this beautiful rural region. Country life at its best!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Grand%20Pr%C3%A9%2013A%2C%20Hantes-Wih%C3%A9ries%2C%206560%2C%20Belgium"
    pageTitle="Le Grand Pré"
  />
);

export default LeGrandPr;
