...
const BachtenDeLeie = () => (
  <RestaurantPage
    restaurantName="Bachten De Leie"
    address="Staatsbaan 280, Zulte, 9870, Belgium"
    cuisine="Meats and Grills, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3256185799"
    website="https://bachtendeleie.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Burnished copper saucepans and a striking colour scheme set the stylish scene in this welcoming restaurant. The youthful chef, Louis Wauters, is a butcher’s son and proud of it. You will sample perfectly cooked rib of beef with a silky béarnaise sauce and French fries, but the chef is also keen to pamper fish and seafood amateurs. Flavour and generosity are the watchwords here...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Staatsbaan%20280%2C%20Zulte%2C%209870%2C%20Belgium"
    pageTitle="Bachten De Leie"
  />
);

export default BachtenDeLeie;
