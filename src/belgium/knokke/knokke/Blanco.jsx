...
const Blanco = () => (
  <RestaurantPage
    restaurantName="Blanco"
    address="Keith Haringplein 7, Knokke, 8300, Belgium"
    cuisine="Mexican"
    priceRange="€€"
    phoneNumber="+3250684060"
    website="https://www.blanco-knokke.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="David and Celine describe Blanco as “highly Instagrammable” and the trendy interior definitely ticks all the boxes: fashionable, spacious and buzzy! After a refreshing cocktail, you will sample dishes of Mexican inspiration: flavoursome tacos, subtly spicy chipotle, home-made ajo blanco (white gazpacho) and fish from the North Sea. A genuine culinary adventure…..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Keith%20Haringplein%207%2C%20Knokke%2C%208300%2C%20Belgium"
    pageTitle="Blanco"
  />
);
