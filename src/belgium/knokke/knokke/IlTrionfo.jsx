...
const IlTrionfo = () => (
  <RestaurantPage
    restaurantName="Il Trionfo"
    address="P. Parmentierlaan 203, Knokke, 8300, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+3250604080"
    website="https://iltrionfo.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Il Trionfo is both an elegant restaurant and a family story. The father and daughter-in-law preside front-of-house, and their enthusiasm is infectious. He also has some fantastic wine recommendations up his sleeve. Upon entering the restaurant, you will catch a glimpse of the mother and son at work in the kitchen. You can opt for the more creative set menu or order à la carte from a selection of traditional robust Mediterranean classics like vitello tonnato and spaghetti vongole. Don't miss the osso buco – the meat is unbelievably tender, and that typically rich tomato sauce is simply divine. The quintessence of Italian generosity!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=P.%20Parmentierlaan%20203%2C%20Knokke%2C%208300%2C%20Belgium"
    pageTitle="Il Trionfo"
  />
);

export default IlTrionfo;
