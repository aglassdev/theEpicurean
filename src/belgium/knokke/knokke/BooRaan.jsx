...
const BooRaan = () => (
  <RestaurantPage
    restaurantName="Boo Raan"
    address="Edward Verheyestraat 17, Knokke, 8300, Belgium"
    cuisine="Thai, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+32476303048"
    website="https://booraan.be"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Boo Raan is the best Thai restaurant in Benelux. The buzzy vibe of this exotic establishment, traditionally appointed in bamboo, immediately incites you to take a seat as you drool over the menu. The real show takes place in the open kitchen, in which Dokkoon Kapueak and her all-women team craft a wide range of authentic dishes from northern and southern Thailand to order. The chef’s grandmother taught her all about spices from how to subtly balance sweet-sour flavours to how to enhance the main ingredient. Her pad thai kai is a festival of bouncy noodles, spicy wok beef in a riot of herbs and a masterful blend of sweet and spicy notes: the quintessence of authentic. A banquet of fresh ingredients, spices, unctuosity and emotions… Close your eyes as you take a bite and you may well find yo..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Edward%20Verheyestraat%2017%2C%20Knokke%2C%208300%2C%20Belgium"
    pageTitle="Boo Raan"
  />
);

export default BooRaan;
