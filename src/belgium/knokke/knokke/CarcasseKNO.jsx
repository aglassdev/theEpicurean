...
const CarcasseKNO = () => (
  <RestaurantPage
    ...
    address="Oosthoekplein 1, Knokke, 8300, Belgium"
    cuisine="Meats and Grills, Grills"
    priceRange="€€€€"
    phoneNumber="+3250897676"
    website="https://www.carcasse.be/carcasse"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An artisan butcher, Hendrik Dierendonck chose to open the first offshoot of his meat-lover’s establishment in Knokke’s Oosthoekplein. On entering, your eye is first drawn to the refrigerated counter and massive glazed aging cabinet, before it is distracted by the chefs in the open-plan kitchen as they craft outstanding produce that is Dierendonck’s signature. Delicacies such as Oedslach ribeye and tongue of Belgian red cattle are enhanced by subtle side dishes that add a wealth of nuances and refreshing notes. Grilled melt-in-the-mouth Menapii pork cutlet is coated in a creamy emulsion of tarragon and other fresh herbs and served on fregula seasoned with the same herbs and a mousse of thyme and coarsely ground hazelnuts. Diners are invited, even encouraged to share dishes, giving you more ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oosthoekplein%201%2C%20Knokke%2C%208300%2C%20Belgium"
    pageTitle="Carcasse"
  />
);

export default CarcasseKNO;
