...
const Escabche = () => (
  <RestaurantPage
    restaurantName="Escabèche"
    address="Dumortierlaan 94, Knokke, 8300, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3250607650"
    website="https://www.escabeche.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The trendy welcoming interior of Escabèche is a hit with the inhabitants of Knokke. They pop in to chat with the friendly hostess, Lisbeth, and to sample the delicacies rustled up by chef Verhasselt, a virtuoso in the art of enhancing first-class ingredients. Blessedly free of fancy frills, you can expect a wholesome lineup of pedigree Gallic nosh, flanked by subtle side dishes and occasionally jazzed up with Mediterranean or Oriental twists. The extensive appetising menu ranges from a hamachi-based festival of Asian flavours to a juicy fillet of turbot in a Dijon mustard sauce or the gamey earthiness of pheasant à la brabançonne during game season. The vast menu is heaven for foodies!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dumortierlaan%2094%2C%20Knokke%2C%208300%2C%20Belgium"
    pageTitle="Escabèche"
  />
);

export default Escabche;
