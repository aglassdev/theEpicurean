...
const SelGris = () => (
  <RestaurantPage
    restaurantName="Sel Gris"
    address="Zeedijk 314, Knokke, 8301, Belgium"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+3250514937"
    website="https://www.selgris.be/nl"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Twenty shades of grey comprise the suave, understated interior of Sel Gris, whose cosy comfort is underscored by designer fixtures and luxury finishings. However, the windows take centre stage here, as the restaurant stands on the dike and commands a knockout view of the beach and the North Sea, which are a source of inspiration for Frederik Deceuninck, whose enthusiasm can be tasted right from the appetisers. He mingles creativity and delicacy in expertly crafted recipes, often presented in several plates with a meticulous sense of detail. A few examples of his fascinating dishes: a subtle, elegant association of salmon and asparagus or pheasant served with a champagne and foie gras sauce. Frederick’s culinary flair reaches its summum in the vegetables, acidic flavours and Asian inspirati..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zeedijk%20314%2C%20Knokke%2C%208301%2C%20Belgium"
    pageTitle="Sel Gris"
  />
);

export default SelGris;
