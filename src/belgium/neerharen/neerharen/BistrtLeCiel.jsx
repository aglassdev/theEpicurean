...
const BistrtLeCiel = () => (
  <RestaurantPage
    restaurantName="Bistrôt Le Ciel"
    address="Paalsteenlaan 90, Neerharen, 3620, Belgium"
    cuisine="Classic French, Italian Contemporary"
    priceRange="€€€"
    phoneNumber="+3289739770"
    website="https://labutteauxbois.be/en/restaurants-bar/#leciel"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Paalsteenlaan%2090%2C%20Neerharen%2C%203620%2C%20Belgium"
    pageTitle="Bistrôt Le Ciel"
  />
);

export default BistrtLeCiel;
