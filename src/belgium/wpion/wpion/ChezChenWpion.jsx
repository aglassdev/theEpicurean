...
const ChezChenWpion = () => (
  <RestaurantPage
    restaurantName="Chez Chen Wépion"
    address="chaussée de Dinant 873, Wépion, 5100, Belgium"
    cuisine="Chinese"
    priceRange="€€"
    phoneNumber="+3281747441"
    website="https://chezchenwepion.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chinese restaurant on the banks of the Meuse. Exterior made from local stone, bright dining room with just a hint of an Asian feel to it, view of the river thanks to the large bay windows...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Dinant%20873%2C%20W%C3%A9pion%2C%205100%2C%20Belgium"
    pageTitle="Chez Chen Wépion"
  />
);

export default ChezChenWpion;
