...
const DeCuylhoeve = () => (
  <RestaurantPage
    restaurantName="De Cuylhoeve"
    address="Hollandsebaan 7, Geel, 2440, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3214585735"
    website="https://www.cuylhoeve.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="De Cuylhoeve enjoys a truly magical setting in the heart of the Campine Forest, providing the perfect stage for this romantic restaurant. Start with a glass of bubbly from the impressive list of champagnes, before sampling chef Bart Janssens’ masterful know-how. He finds his inspiration in pedigree French recipes, to which he adds his own more modern spin, sharing his passion for first-class produce along the way...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hollandsebaan%207%2C%20Geel%2C%202440%2C%20Belgium"
    pageTitle="De Cuylhoeve"
  />
);

export default DeCuylhoeve;
