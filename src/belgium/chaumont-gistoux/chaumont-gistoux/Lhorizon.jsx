...
const Lhorizon = () => (
  <RestaurantPage
    restaurantName="L'Horizon"
    address="rue du Moulin 50, Chaumont-Gistoux, 1325, Belgium"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3210227565"
    website="https://www.restaurantlhorizon.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'Horizon is definitely in tune with the zeitgeist. A fashionable interior and meticulously laid tables set the scene. The chef’s Italian roots, Asian influences and regional produce, such as poultry and herbs, are combined in dishes that cater to modern tastes. Delicate, well-prepared cuisine, fully worthy of a visit...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Moulin%2050%2C%20Chaumont-Gistoux%2C%201325%2C%20Belgium"
    pageTitle="L'Horizon"
  />
);

export default Lhorizon;
