...
const LorangerieDeMoulbaix = () => (
  <RestaurantPage
    restaurantName="L'Orangerie de Moulbaix"
    address="Place Henri Stourme 1, Moulbaix, 7812, Belgium"
    cuisine="French"
    priceRange="€€€"
    phoneNumber="+3268800133"
    website="https://www.orangeriemoulbaix.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bright and airy orangery at Moulbaix Castle presents itself as a tasteful blend of the old and the new. The terrace overlooking the vines, the castle and the windmill in the distance are simply idyllic! Maxence Bouralha and Charles-Maxime Legrand, the chef duo behind Quai no. 4, join forces with Philippe Lartigue to create meticulously prepared hearty French brasserie classics. Think sautéed mushrooms with finely chopped shallot topped with an indulgent potato emulsion, an œuf parfait (slow-cooked egg) that really lives up to its name, as well a touch of orange to provide a bright and zesty finish. Other tempting options are prawn croquettes, vol-au-vent or andouillette. The extensive menu is sure to please...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20Henri%20Stourme%201%2C%20Moulbaix%2C%207812%2C%20Belgium"
    pageTitle="L'Orangerie de Moulbaix"
  />
);

export default LorangerieDeMoulbaix;
