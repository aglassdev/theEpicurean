...
const Resto136 = () => (
  <RestaurantPage
    restaurantName="Resto 136"
    address="Vrijheid 136, Hoogstraten, 2320, Belgium"
    cuisine="French, Asian Influences"
    priceRange="€€€"
    phoneNumber="+32485574667"
    website="https://www.resto136.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Make a beeline for this peacock blue townhouse at number 136 where you will be pampered by Niels and Laura. Their elegant contemporary establishment upholds tradition and while the chef clearly enjoys mixing spicy Asian flavours with Mediterranean extravagance, he is equally capable of winning you over with a flawless piece of cod flanked by knockout beurre blanc and creamy mashed potato...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vrijheid%20136%2C%20Hoogstraten%2C%202320%2C%20Belgium"
    pageTitle="Resto 136"
  />
);

export default Resto136;
