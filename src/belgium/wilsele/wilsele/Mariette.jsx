...
const Mariette = () => (
  <RestaurantPage
    restaurantName="Mariette"
    address="Weggevoerdenstraat 152, Wilsele, 3012, Belgium"
    cuisine="French, Belgian"
    priceRange="€€"
    phoneNumber="+3216812442"
    website="https://www.bistromariette.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dad and son-in-law in the kitchen, mum and daughter in the front of house: Mariette is the quintessence of a family-run establishment. Adorned in elegant details, it also boasts a lovely patio in the garden. A Franco-Belgian lineup with the occasional international twist sets the tone of the varied menu, many dishes of which are ideal for sharing. The quality of the ingredients, like the turbot and scallops, is superlative. The juicy pheasant is fork-tender and served with lightly caramelised endives, hand-rolled fritters and a cognac sauce. A warm authentic vibe and big-boned family favourites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Weggevoerdenstraat%20152%2C%20Wilsele%2C%203012%2C%20Belgium"
    pageTitle="Mariette"
  />
);

export default Mariette;
