...
const Quadras = () => (
  <RestaurantPage
    restaurantName="Quadras"
    address="Malmedyer Straße 53, Saint Vith, 4780, Belgium"
    cuisine="Creative, French Contemporary"
    priceRange="€€€"
    phoneNumber="+3280228022"
    website="https://www.restaurant-quadras.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Fleeing the limelight and media hype, Ricarda Grommes devotes herself body and soul to her elegant, trendy establishment, where you can feel and taste her quest for perfection. Ricarda’s inventive streak shines through in knockout appetisers and it is obvious that she attaches great importance to presentation, demonstrating a consummate grasp of modern techniques. Each dish is intelligently crafted and underscored by side dishes. The chef navigates effortlessly between French tradition and Eastern precision and you will taste regional produce and exotic ingredients. For example, she may coat scallops in white sesame seeds and pair them with raviolis stuffed with a gutsy pumpkin cream, chunks of pumpkin and a creamy sauce enhanced by pickles in vegetable oil. Ricarda Grommes’ cuisine is the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Malmedyer%20Stra%C3%9Fe%2053%2C%20Saint%20Vith%2C%204780%2C%20Belgium"
    pageTitle="Quadras"
  />
);
