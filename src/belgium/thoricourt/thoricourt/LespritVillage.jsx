...
const LespritVillage = () => (
  <RestaurantPage
    restaurantName="L'Esprit Village"
    address="Place Obert de Thieusies 10, Thoricourt, 7830, Belgium"
    cuisine="French, Farm to table"
    priceRange="€€"
    phoneNumber="+3267850029"
    website="https://www.lespritdevillage.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Christine and Pascal couldn’t have found a better name for their establishment. Everything from the warm greeting and service to the wholesome, rustic fare smacks of genuine sincerity. Chef Pascal forgoes fancy frills in favour of generous dishes piled high with top-notch familiar ingredients. He may underscore the full flavour of Iberico ham with a gutsy gravy, while the salty tang of clams is paired with a velvety pumpkin purée and a spicy cream of piquillo pimentos. A market-fresh menu that hits the spot every time – the epitome of a country village eatery!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20Obert%20de%20Thieusies%2010%2C%20Thoricourt%2C%207830%2C%20Belgium"
    pageTitle="L'Esprit Village"
  />
);

export default LespritVillage;
