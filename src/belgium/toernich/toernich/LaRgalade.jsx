...
const LaRgalade = () => (
  <RestaurantPage
    restaurantName="La Régalade"
    address="Burewee 26, Toernich, 6700, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3263226554"
    website="https://www.laregalade.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Peaceful, relaxed and friendly describe both the village of Toernich and the Régalade restaurant. The chef rustles up immaculately prepared contemporary fare whose value for money cannot be beaten...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Burewee%2026%2C%20Toernich%2C%206700%2C%20Belgium"
    pageTitle="La Régalade"
  />
);

export default LaRgalade;
