...
const CouleurRouge = () => (
  <RestaurantPage
    restaurantName="Couleur Rouge"
    address="Gospertstraße 22, Eupen, 4700, Belgium"
    cuisine="Fusion, Asian Influences"
    priceRange="€€"
    phoneNumber="+3287647951"
    website="https://www.couleurrouge.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Wonton, mashed potato with wasabi illustrate the happy marriage between Asian sophistication and French gastronomy. Save room for the splendid platter of Belgian cheeses. The delightful terrace will almost make you forget you are in the heart of Eupen!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gospertstra%C3%9Fe%2022%2C%20Eupen%2C%204700%2C%20Belgium"
    pageTitle="Couleur Rouge"
  />
);

export default CouleurRouge;
