...
const LaBottega = () => (
  <RestaurantPage
    ...
    address="Gospertstraße 29, Eupen, 4700, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3287652078"
    website="https://labottega.biz/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The best Italian restaurant of Eupen is on Gospertstraße. Traditional pizza, succulent lasagne and yummy Gamberoni prawn and pasta. The kitchen team combines generosity and wholehearted authenticity, without forgetting the odd, unorthodox twist. The delicatessen counter is a great success...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gospertstra%C3%9Fe%2029%2C%20Eupen%2C%204700%2C%20Belgium"
    pageTitle="La Bottega"
  />
);

export default LaBottega;
