...
const AtelierNoun = () => (
  <RestaurantPage
    restaurantName="Atelier Noun"
    address="Dorpstraat 252, Leefdaal, 3061, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3216849007"
    website="https://www.ateliernoun.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bert and Sandra’s workshop sports a cosy, lounge vibe, underscored by Scandinavian accents and a splendid leafy al fresco area. The couple’s passion can be felt throughout the restaurant and Bert adores rustling up fascinating modern recipes, scattered with Asian nuances and incisive, acidic notes. Paradise for foodies!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpstraat%20252%2C%20Leefdaal%2C%203061%2C%20Belgium"
    pageTitle="Atelier Noun"
  />
);

export default AtelierNoun;
