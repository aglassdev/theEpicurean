...
const DeOogappel = () => (
  <RestaurantPage
    restaurantName="De Oogappel"
    address="Appelmarkt 3, Veurne, 8630, Belgium"
    cuisine="Sharing"
    priceRange="€€€"
    phoneNumber="+3258288646"
    website="https://www.restaurantdeoogappel.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 1760’s edifice, graced in period floors and wardrobes, is now the venue of a friendly bistro serving traditional fare to the joy of discerning gourmets. The appetising menu of starters to share displays a more modern twist with Asian influences. We recommend the crispy sweetbread 'fine champagne' – the house signature dish. Go there your eyes closed...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Appelmarkt%203%2C%20Veurne%2C%208630%2C%20Belgium"
    pageTitle="De Oogappel"
  />
);

export default DeOogappel;
