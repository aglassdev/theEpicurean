...
const LaCroustade = () => (
  <RestaurantPage
    restaurantName="La Croustade"
    address="rue Hodiamont 13, Heusy, 4802, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3287226839"
    website="https://www.croustade.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Lovingly tended flowerbeds, a delightful cottage garden and goldfish in the pond - dining on the terrace of this exquisite country house is heavenly in fine weather. Every month, chef Thierry composes a new menu that demonstrates his classical training and know-how. He freely delves into the cottage garden to enhance dishes such as mint-crusted rack of lamb and pan-fried foie gras...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Hodiamont%2013%2C%20Heusy%2C%204802%2C%20Belgium"
    pageTitle="La Croustade"
  />
);

export default LaCroustade;
