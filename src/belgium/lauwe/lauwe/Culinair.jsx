...
const Culinair = () => (
  <RestaurantPage
    restaurantName="Culinair"
    address="Dronckaertstraat 508, Lauwe, 8930, Belgium"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3256426733"
    website="https://www.restaurantculinair.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The refined interior and gracious welcome are a foretaste of the exquisite culinary experience awaiting the diner. You will be able to observe the chef at work, wielding modern culinary techniques as he updates classical dishes. The same desire to pamper guests is palpable in the modern B&B of the Culinair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dronckaertstraat%20508%2C%20Lauwe%2C%208930%2C%20Belgium"
    pageTitle="Culinair"
  />
);

export default Culinair;
