...
const DeGoudenMuts = () => (
  <RestaurantPage
    restaurantName="De Gouden Muts"
    address="Gevaertlaan 64, Zoerle-Parwijs, 2260, Belgium"
    cuisine="French Contemporary"
    priceRange="€€€€"
    phoneNumber="+3216562608"
    website="https://www.degoudenmuts.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant villa is so cosy and inviting, and with the warm welcome extended by Evi, your charming maître d', you are sure to feel right at home. In the open kitchen, chef Rudy puts his own spin on French and Belgian recipes, adding in the requisite zing and occasional Japanese nuances. For instance, he uses miso to enhance flavours, but he also stays true to tradition with dishes such as pigeon cooked on the bone and served with beetroot and foie gras. He takes a detailed approach to his cooking, and his rich sauces are a key part of his dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gevaertlaan%2064%2C%20Zoerle-Parwijs%2C%202260%2C%20Belgium"
    pageTitle="De Gouden Muts"
  />
);

export default DeGoudenMuts;
