...
const LesFrresLouise = () => (
  <RestaurantPage
    restaurantName="Les Frères Louise"
    address="Rue de Renaix 162, Ellezelles, 7890, Belgium"
    cuisine="Classic Cuisine, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+32495237306"
    website="https://www.les-freres-louise.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautifully renovated miller's house (1737) has retained its classic soul and rustic charm – open fireplaces, rotating art collection, selection of cigars and pipe tobacco, and a lovely courtyard terrace. You will be treated like an old friend as you tuck into timeless classics made with the finest ingredients, such as partridge shot by a local hunter and soufflé generously infused with Grand Marnier. This restaurant is known for its freshly cooked fries, delicious sauces, masterful cooking on the charcoal grill and large à la carte menu. The sommelier has a penchant for German wines, and his passion is infectious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20Renaix%20162%2C%20Ellezelles%2C%207890%2C%20Belgium"
    pageTitle="Les Frères Louise"
  />
);

export default LesFrresLouise;
