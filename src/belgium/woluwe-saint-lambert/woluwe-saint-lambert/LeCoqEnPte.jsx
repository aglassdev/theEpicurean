...
const LeCoqEnPte = () => (
  <RestaurantPage
    restaurantName="Le Coq en Pâte"
    address="Tomberg 259, Woluwe-Saint-Lambert, 1200, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3227621971"
    website="https://lecoqenpate.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The Bacchetta family has been regaling diners since 1972 in their stylish establishment. You will taste the best of fine Italian fare in the company of a loyal band of regulars. Chef Olivier delves into Mediterranean tradition, adding a creative spin that combines visual flair and a love of contrasts. His veal alla Milanese and his asparagus risotto are second to none. The lunchtime set menu is a firm favourite with the regulars...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tomberg%20259%2C%20Woluwe-Saint-Lambert%2C%201200%2C%20Belgium"
    pageTitle="Le Coq en Pâte"
  />
);

export default LeCoqEnPte;
