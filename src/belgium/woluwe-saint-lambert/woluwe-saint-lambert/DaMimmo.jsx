...
const DaMimmo = () => (
  <RestaurantPage
    restaurantName="Da Mimmo"
    address="avenue du Roi Chevalier 24, Woluwe-Saint-Lambert, 1200, Belgium"
    cuisine="Italian Contemporary"
    priceRange="€€€€"
    phoneNumber="+3227715860"
    website="https://www.da-mimmo.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Da Mimmo is the epitome of Italian-style sophistication. As soon as you venture over the threshold of this elegant restaurant and meet the charismatic maître d', you know you are in good hands! Chef Louis Verstrepen and his team showcase beautifully presented dishes that embody a creative approach to Italian culinary tradition. His cooking is highly technical and precise. He is not afraid to throw bold flavours together, and his use of diverse textures adds a sense of playfulness. For example, he cooks guinea fowl to perfection so that it is succulent with crispy skin. Then he combines it with maize in various guises, polenta with truffle, a wonderful croquette stuffed with the guinea fowl's giblets and an exquisite poultry sauce. The sommelier's carefully chosen wines perfectly complement..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20du%20Roi%20Chevalier%2024%2C%20Woluwe-Saint-Lambert%2C%201200%2C%20Belgium"
    pageTitle="Da Mimmo"
  />
);

export default DaMimmo;
