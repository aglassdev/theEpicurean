...
const HofTerDoest = () => (
  <RestaurantPage
    restaurantName="Hof Ter Doest"
    address="Ter Doeststraat 4, Lissewege, 8380, Belgium"
    cuisine="Grills, Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+3250544082"
    website="https://www.terdoest.be/nl/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ter%20Doeststraat%204%2C%20Lissewege%2C%208380%2C%20Belgium"
    pageTitle="Hof Ter Doest"
  />
);

export default HofTerDoest;
