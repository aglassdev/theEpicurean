...
const LeGrandVerre = () => (
  <RestaurantPage
    restaurantName="Le Grand Verre"
    address="Place aux Foires 26, Durbuy, 6940, Belgium"
    cuisine="Modern French, International"
    priceRange="€€€€"
    phoneNumber="+3286650333"
    website="https://www.legrandverre.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Surrealist art by Marcel Duchamp and Jacques Charlier sets the distinctive arty scene in this colourful restaurant, enhanced by a warm welcome and a cornucopia of luxury details. Head for the patio in fine weather to make the most of the historic village of Durbuy. Rather than surrealistic, the food embodies the essence of a Michelin one-star establishment: taste! Renowned chef Wout Bru lets his ingenious creations and deftly crafted dishes speak for themselves, zooming in on outstanding produce, which he flanks with unexpected combinations oozing with Mediterranean charm. Langoustine, cooked to perfection, is paired with a big-boned court-bouillon and the salty, buttery flavours of caviar. Various textures of cauliflower add an earthy edge, while a white wine sauce of crunchy samphire add..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20aux%20Foires%2026%2C%20Durbuy%2C%206940%2C%20Belgium"
    pageTitle="Le Grand Verre"
  />
);

export default LeGrandVerre;
