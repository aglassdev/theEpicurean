...
const LaBrusserie = () => (
  <RestaurantPage
    restaurantName="La Bru'sserie"
    address="rue du Comte Théodule d'Ursel 14, Durbuy, 6940, Belgium"
    cuisine="World Cuisine, International"
    priceRange="€€€"
    phoneNumber="+3286650334"
    website="https://www.sanglier-durbuy.be/fr/restaurants/la-brusserie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this trendy joint, Wout Bru takes your taste buds on a whirlwind trip around the world. The extensive menu features dishes from Provence, Asia and Latin America without forgetting Belgium. The mouth - watering choice fully lives up to its promise of intense and subtle savours!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Comte%20Th%C3%A9odule%20d'Ursel%2014%2C%20Durbuy%2C%206940%2C%20Belgium"
    pageTitle="La Bru'sserie"
  />
);

export default LaBrusserie;
