...
const BrasserieJulie = () => (
  <RestaurantPage
    restaurantName="Brasserie Julie"
    address="Dorpsplein 3, Sint-Martens-Bodegem, 1700, Belgium"
    cuisine="Home Cooking, Creative French"
    priceRange="€€€"
    phoneNumber="+3228807431"
    website="https://www.brasseriejulie.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thomas Locus is determined to create an immersive experience for his patrons whether they are dining in his cosy contemporary farmstead or on the comfortable garden terrace, or indeed spending the night at his bucolic B&B. Quality is the name of the game here. The entrepreneurial chef even runs a wine shop and, a little further down the road, another restaurant, Agnes. A meal at Brasserie Julie simply has to start with some of the international appetisers available for sharing. Almejas à la marinera, nobashi shrimp with shichimi… What a feast! It is immediately clear that chef Locus has his own unique way of approaching the classics – a few choice ingredients and creative sides suffice to create an intense taste experience. This is ingredient-led cuisine through and through, by a chef who ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsplein%203%2C%20Sint-Martens-Bodegem%2C%201700%2C%20Belgium"
    pageTitle="Brasserie Julie"
  />
);

export default BrasserieJulie;
