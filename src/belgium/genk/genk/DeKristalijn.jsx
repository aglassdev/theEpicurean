...
const DeKristalijn = () => (
  <RestaurantPage
    restaurantName="De Kristalijn"
    address="Wiemesmeerstraat 105, Genk, 3600, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3289355828"
    website="https://www.dekristalijn.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="De Kristalijn cannot fail but catch the eye. The modern edifice in which it is housed seems to hover over the surrounding golf course. Floor-to-ceiling windows command knockout views, while trendy furnishings and designer lighting underscore the establishment’s stylish character. Seasoned chef Koen Somers weaves his magic in the entirely open-plan kitchen as he crafts food depicted by purebred technique and generous ingredients. The chef harnesses his creative streak in a painstaking and precise approach to cooking. Premium seabass is cooked in its skin for crispiness and flanked with a medley of salsify and apple soufflé, stuffed with potatoes and dressed in caviar. The exquisite butter sauce is further intensified and exalted by dashi and bonito flakes. The chef cannot be equalled for hi..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Wiemesmeerstraat%20105%2C%20Genk%2C%203600%2C%20Belgium"
    pageTitle="De Kristalijn"
  />
);

export default DeKristalijn;
