...
const LaCuisineDunGourmand = () => (
  <RestaurantPage
    restaurantName="La Cuisine d'un Gourmand"
    address="avenue Général Gracia 8, Profondeville, 5170, Belgium"
    cuisine="Creative, Creative French"
    priceRange="€€"
    phoneNumber="+3281570775"
    website="https://www.lacuisinedungourmand.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ambitious John Maes is a genuine good food lover. His mission in life is to source the best regional ingredients, to unfetter his creativity and to please or surprise his patrons with subtle fare. Outstanding quality at affordable prices. The tasteful, modern interior commands a fine view of the river Meuse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20G%C3%A9n%C3%A9ral%20Gracia%208%2C%20Profondeville%2C%205170%2C%20Belgium"
    pageTitle="La Cuisine d'un Gourmand"
  />
);

export default LaCuisineDunGourmand;
