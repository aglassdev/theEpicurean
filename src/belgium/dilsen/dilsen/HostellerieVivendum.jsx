...
const HostellerieVivendum = () => (
  <RestaurantPage
    restaurantName="Hostellerie Vivendum"
    address="Vissersstraat 2, Dilsen, 3650, Belgium"
    cuisine="Modern Cuisine, Modern French"
    priceRange="€€€"
    phoneNumber="+3289360790"
    website="https://www.restaurant-vivendum.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Welcome to Dilsen, a picture postcard perfect village of Limburg, whose peaceful ambience also reigns in the Vivendum Hostelry. Established in an elegant 18C presbytery, the venue has been modernised while carefully preserving its historic cachet. The terrace overlooking the Oude Maas, is one of the finest of the region! Alex Clevers masterfully blends his classical training with a creative bent. A fan of Thai cuisine, he delicately mixes exotic flavours with local produce and traditions. His passion for exoticism, which is far from skin-deep, underpins his entire approach to food. For example, he might serve nobashi shrimps, cooked or tartare, adding a subtle fresh note with a papaya salad and a coconut and lime sauce, whose rich velvety intensity may well bring to mind tom kha kai recipe..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vissersstraat%202%2C%20Dilsen%2C%203650%2C%20Belgium"
    pageTitle="Hostellerie Vivendum"
  />
);

export default HostellerieVivendum;
