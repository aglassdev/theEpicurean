...
const Klaver = () => (
  <RestaurantPage
    restaurantName="Klaver"
    address="Poperingseweg 230, Ieper, 8908, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3257378683"
    website="https://restaurantklaver.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="According to chef Korneel Verhulst, there is no reason you can’t start your meal with fries, even in a fine dining establishment. So should you wish to kick off with piping hot French fries and a caper mayonnaise, then go for it! Such is the down-to-earth outlook of this friendly, welcoming establishment. Before finishing your meal with a pancake and coffee, try out the chef’s main courses, some of which are enhanced with Japanese notes. Finely diced kohlrabi, seasoned with a sushi dressing garnish a tartare of Holstein beef, grated Belper Knolle cheese, caviar and curry. Klaver adds a brand-new youthful dimension to fine dining, embodied by Grace, your charming hostess...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Poperingseweg%20230%2C%20Ieper%2C%208908%2C%20Belgium"
    pageTitle="Klaver"
  />
);

export default Klaver;
