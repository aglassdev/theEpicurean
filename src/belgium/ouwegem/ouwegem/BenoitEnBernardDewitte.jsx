...
const BenoitEnBernardDewitte = () => (
  <RestaurantPage
    restaurantName="Benoit en Bernard Dewitte"
    address="Beertegemstraat 52, Ouwegem, 9750, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3293845652"
    website="https://www.restaurantdewitte.be"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Tranquillity is the watchword of Benoit and Bernard Dewitte. The relaxed zen vibe of their villa sports a fun blend of trendy rustic and soothing pastel tones while a delicious summer holiday buzz sets the scene in the exquisite garden. This fantastic setting provides the perfect foil for chef Benoit’s pared-back culinary style as he effortlessly deploys the light touch that has become his signature. He frequently calls upon veggies and spices to create harmonies of fascinating delicacy. Nothing leaves the kitchen that hasn’t been endlessly pondered and puzzled over. For example, he may pair juicy trout and cauliflower with a smoked cauliflower cream, cauliflower couscous laced in ginger and lemongrass and a gutsy vin jaune sauce. Medium rare lamb may be served with al dente spring peas, w..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Beertegemstraat%2052%2C%20Ouwegem%2C%209750%2C%20Belgium"
    pageTitle="Benoit en Bernard Dewitte"
  />
);

export default BenoitEnBernardDewitte;
