...
const LaFleurDeThym = () => (
  <RestaurantPage
    restaurantName="La Fleur de Thym"
    address="route de Liège 34, Houffalize, 6660, Belgium"
    cuisine="Creative French, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3261289708"
    website="https://www.lafleurdethym.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="David et Olivia vous emportent dans une aventure ardennaise moderne. Les bois de cerf sont bien sûr au rendez-vous, mais dans un décor intime et élégant, aux accents colorés. La cuisine est résolument au goût du jour, surtout dans son exécution. Le chef David respecte les saveurs familières de ses produits, qu’il glorifie avec un grand savoir-faire...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=route%20de%20Li%C3%A8ge%2034%2C%20Houffalize%2C%206660%2C%20Belgium"
    pageTitle="La Fleur de Thym"
  />
);

export default LaFleurDeThym;
