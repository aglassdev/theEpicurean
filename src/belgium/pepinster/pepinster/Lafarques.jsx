...
const Lafarques = () => (
  <RestaurantPage
    restaurantName="Lafarques"
    address="chemin des Douys 20, Pepinster, 4860, Belgium"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+3287840177"
    website="https://www.lafarques.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This heritage country mansion, gleaming with classy elegance, will take your breath away. Both the surrounding countryside and the stylish guestrooms are exquisite. The cordon bleu chef allows the (preferably local) ingredients to shout their name, whilst seeking to generously and delicately enhance their traditional flavours. Don’t miss the game in season...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chemin%20des%20Douys%2020%2C%20Pepinster%2C%204860%2C%20Belgium"
    pageTitle="Lafarques"
  />
);

export default Lafarques;
