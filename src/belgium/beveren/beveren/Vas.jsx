...
const Vas = () => (
  <RestaurantPage
    restaurantName="VAS"
    address="Gentseweg 536, Beveren, 9120, Belgium"
    cuisine="Farm to table, Creative French"
    priceRange="€€€"
    phoneNumber="+32468537043"
    website="https://www.restaurantvas.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jolien and Robby have moved shop, but retained their win-win formula. Near the Gentseweg highway, VAS occupies an attractive street corner edifice whose interior sports a range of elegant materials and a tasteful colour scheme. The bubbly front-of-house team sets the scene as you peruse the interesting Franco-Belgian repertory dotted with trendy, spot-on twists. Fillet of duck cooked rare might be flanked by a champagne sauce and a creamy gravy jazzed up with hints of sea buckthorn for added vibrancy together with a velvety purée and a range of textured kohlrabi. VAS is the quintessence of warm and welcoming, enhanced by a festival of familiar family favourites underscored by feelgood flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gentseweg%20536%2C%20Beveren%2C%209120%2C%20Belgium"
    pageTitle="VAS"
  />
);
