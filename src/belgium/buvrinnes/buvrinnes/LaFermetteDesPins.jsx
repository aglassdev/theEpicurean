...
const LaFermetteDesPins = () => (
  <RestaurantPage
    restaurantName="La Fermette des Pins"
    address="rue du Lustre 39, Buvrinnes, 7133, Belgium"
    cuisine="Classic Cuisine, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+3264341718"
    website="https://lafermettedespins.be/en"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="“What you see is what you get” could well be the baseline of this lovely farmstead depicted by old oak rafters, bare brick walls and a terrace that makes the most of its idyllic rural setting. The seasoned chef has perfected the art of sourcing first-class local produce. His eggs are perfectly cooked at exactly 62°C and garnished with a flavoursome espuma of mashed potato and crunchy chicory, unless you wouldn’t prefer a much-loved Belgian staple: steak, fresh fries and a pepper sauce? One thing is certain: everything here bears the hallmark of tradition. All that remains is to choose between the different menus!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Lustre%2039%2C%20Buvrinnes%2C%207133%2C%20Belgium"
    pageTitle="La Fermette des Pins"
  />
);

export default LaFermetteDesPins;
