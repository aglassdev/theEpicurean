...
const BrasserieBoulevard = () => (
  <RestaurantPage
    restaurantName="Brasserie Boulevard"
    address="Kortrijksesteenweg 175, Sint-Martens-Latem, 9830, Belgium"
    cuisine="Belgian, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3292791200"
    website="https://blvd.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This swanky, spacious brasserie flooded in light is invariably packed to the seams. Thomas endeavours to ensure that your dining experience is as pleasant as it is flavoursome. Classic brasserie fare enhanced with a few spontaneous personal touches. The inspiring choice ranges from snacks to share, luxury vol-au-vent or trendier recipes…...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kortrijksesteenweg%20175%2C%20Sint-Martens-Latem%2C%209830%2C%20Belgium"
    pageTitle="Brasserie Boulevard"
  />
);

export default BrasserieBoulevard;
