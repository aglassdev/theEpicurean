...
const Baarle90 = () => (
  <RestaurantPage
    restaurantName="Baarle 90"
    address="Baarle Frankrijkstraat 90, Sint-Martens-Latem, 9830, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3292810520"
    website="https://www.baarle90.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal at Baarle 90, which boasts an idyllic view of the River Leie, is the opportunity for a fine dining experience. The terrace is out of this world and the interior pleasantly trendy. European recipes tinged with Belgian influences, such as shrimp fritters, steak tartare and sole prepared with textbook expertise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Baarle%20Frankrijkstraat%2090%2C%20Sint-Martens-Latem%2C%209830%2C%20Belgium"
    pageTitle="Baarle 90"
  />
);

export default Baarle90;
