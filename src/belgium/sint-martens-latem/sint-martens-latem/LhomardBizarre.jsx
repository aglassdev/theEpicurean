...
const LhomardBizarre = () => (
  <RestaurantPage
    restaurantName="L'homard Bizarre"
    address="Kortrijksesteenweg 259, Sint-Martens-Latem, 9830, Belgium"
    cuisine="Seafood, Classic French"
    priceRange="€€€"
    phoneNumber="+3292812922"
    website="https://www.homard-bizarre.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="L'Homard Bizarre translates as the bizarre lobster, but there is nothing at all outlandish about this elegant, cosily decorated villa. The chef does, however, have a predilection for lobster! As he is a champion of classic cuisine, his menu features timeless dishes such as fried foie gras with diced apple, or ultra-fresh lobster Bellevue with house-made sauces and a crisp salad. As ever, seafood lovers and meat enthusiasts are treated to a host of full flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kortrijksesteenweg%20259%2C%20Sint-Martens-Latem%2C%209830%2C%20Belgium"
    pageTitle="L'homard Bizarre"
  />
);

export default LhomardBizarre;
