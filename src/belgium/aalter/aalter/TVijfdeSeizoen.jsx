...
const TVijfdeSeizoen = () => (
  <RestaurantPage
    restaurantName="'t Vijfde Seizoen"
    address="Stationsstraat 9, Aalter, 9880, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3293517460"
    website="https://www.tvijfdeseizoen.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Broes Tavernier hails his suppliers as “heroes”, which speaks volumes for his commitment to locally sourced produce. From asparagus and fish from the North Sea to partridges, he unfailingly selects the best. His creative, high-flying approach to cooking aims to let the ingredients shout their name. We recommend the insightful wine-food pairing suggestions. After a fine meal in this friendly establishment (great patio), pop into Eetalage and take a few goodies home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Stationsstraat%209%2C%20Aalter%2C%209880%2C%20Belgium"
    pageTitle="'t Vijfde Seizoen"
  />
);

export default TVijfdeSeizoen;
