...
const LartDeVivre = () => (
  <RestaurantPage
    ...
    address="avenue Reine Astrid 53, Spa, 4900, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3287770444"
    website="https://www.artdevivre.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Notable's house cultivates the art of living by way of a pleasant setting and a lovely, modern, à la carte menu with a splash of creativity. Set menus described to you; homemade cakes and desserts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20Reine%20Astrid%2053%2C%20Spa%2C%204900%2C%20Belgium"
    pageTitle="L'Art de Vivre"
  />
);

export default LartDeVivre;
