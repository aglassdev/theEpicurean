...
const LaubergeSPA = () => (
  <RestaurantPage
    ...
    address="place du Monument 3, Spa, 4900, Belgium"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+3287774410"
    website="https://aubergedespa.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The mix of leather, wood panelling, copper and glass gives L'Auberge the look and feel of an authentic brasserie. Located in Spa's bustling town centre, this restaurant has plenty of regulars, who come to savour traditional Belgian cuisine. The menu features hearty classics such as mussels in white wine (also available in half portions), veal kidneys à la liégeoise, crêpes mikado – the generous flavours will leave you feeling warm and satisfied. The guestrooms are worth a look if you're considering a longer stay...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20du%20Monument%203%2C%20Spa%2C%204900%2C%20Belgium"
    pageTitle="L'Auberge"
  />
);

export default LaubergeSPA;
