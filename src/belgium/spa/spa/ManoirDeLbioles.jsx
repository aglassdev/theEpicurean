...
const ManoirDeLbioles = () => (
  <RestaurantPage
    restaurantName="Manoir de Lébioles"
    address="Domaine de Lébioles 1/5, Spa, 4900, Belgium"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3287791900"
    website="https://www.manoirdelebioles.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef working at this manor house creates his own personal style of up - to - the - minute cuisine using the highest quality ingredients. Chic, modern decor and lovely panoramic terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Domaine%20de%20L%C3%A9bioles%201%2F5%2C%20Spa%2C%204900%2C%20Belgium"
    pageTitle="Manoir de Lébioles"
  />
);

export default ManoirDeLbioles;
