...
const Lineau = () => (
  <RestaurantPage
    restaurantName="Lin’eau"
    address="Koen Lisardestraat 19, Sint-Baafs-Vijve, 8710, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3256290092"
    website="https://www.restaurantlineau.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former flax factory (1907) is steeped in history, as is illustrated by the bare stone walls, authentic details and photos. This heritage is cleverly set off by trendy influences and personal works of art. A young couple is behind the helm, rustling up modern, painstakingly devised, international recipes, flanked by infused sauces and varied textures. The epitome of culinary delicacy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Koen%20Lisardestraat%2019%2C%20Sint-Baafs-Vijve%2C%208710%2C%20Belgium"
    pageTitle="Lin’eau"
  />
);

export default Lineau;
