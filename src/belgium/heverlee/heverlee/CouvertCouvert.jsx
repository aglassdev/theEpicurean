...
const CouvertCouvert = () => (
  <RestaurantPage
    restaurantName="Couvert Couvert"
    address="St-Jansbergsesteenweg 171, Heverlee, 3001, Belgium"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3216296979"
    website="https://www.couvertcouvert.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Couvert Couvert is the ambitious story of Folmer and Folmer. Brothers Laurent and Vincent greet guests in a softly lit, airy venue of Scandinavian inspiration. The interior is stylish, the terrace peaceful and the service attentive, however the singularity of this restaurant resides in the brothers’ highly individual creative streak. Together they perform a culinary show of cutting-edge precision and strewn with daring. For example, they may pair a crispy skinned breast of guinea fowl with a warm salad of artichoke hearts, pistachio, sweet earthy vernal grass and hints of walnuts and hay, while a suavely sweet sauce adds the final flourish. The chefs enjoy playing with the acidity of fruit and herbs (some of which are almost unknown) to conjure up flavours of great depth. The dishes of the..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=St-Jansbergsesteenweg%20171%2C%20Heverlee%2C%203001%2C%20Belgium"
    pageTitle="Couvert Couvert"
  />
);

export default CouvertCouvert;
