...
const LeJulien = () => (
  <RestaurantPage
    restaurantName="Le Julien"
    address="Prinsenstraat 9, Lotenhulle, 9880, Belgium"
    cuisine="French, Modern French"
    priceRange="€€€€"
    phoneNumber="+3293244311"
    website="https://lejulien.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Davy Devlieghere is back in his native village in the company of Marie-Julie, your hostess. This tastefully restored farmstead oozing with character sports a luxurious vibe and a tasteful colour scheme to celebrate French fine dining. First-class ingredients, like Anjou pigeon and sole, are allowed to shout their name thanks to last-minute preparations and rich sauces. The chef is a fan of wholesome, big-boned recipes, although he isn’t averse to sneaking in the odd exotic note.He may pair a warm tartare of langoustine with a frothy langoustine bisque and a tapenade of piquillo pepper, fresh spinach pasta and a shellfish oil of piquillo and capers. The chef’s polished craftsmanship and generous nature are escorted by a series of more modern twists and contrasts that add a kick to each dish..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Prinsenstraat%209%2C%20Lotenhulle%2C%209880%2C%20Belgium"
    pageTitle="Le Julien"
  />
);

export default LeJulien;
