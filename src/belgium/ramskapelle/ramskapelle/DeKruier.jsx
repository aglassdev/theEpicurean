...
const DeKruier = () => (
  <RestaurantPage
    restaurantName="De Kruier"
    address="Ramskapellestraat 66, Ramskapelle, 8301, Belgium"
    cuisine="Classic Cuisine, Belgian"
    priceRange="€€"
    phoneNumber="+3250515313"
    website="https://www.kruier.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This picture postcard restaurant stands in the shade of an 1897 windmill in a manicured garden. You can count on the Callant brothers to rustle up a delicious line-up of authentic Belgian dishes, calling on flawlessly fresh, deftly cooked ingredients. The extensive à la carte menu traverses the annals of traditional cuisine to the delight of good food lovers. In summertime, the alfresco terrace is the place to be...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ramskapellestraat%2066%2C%20Ramskapelle%2C%208301%2C%20Belgium"
    pageTitle="De Kruier"
  />
);

export default DeKruier;
