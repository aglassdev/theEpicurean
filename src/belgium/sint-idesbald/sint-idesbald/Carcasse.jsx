...
const Carcasse = () => (
  <RestaurantPage
    restaurantName="Carcasse"
    address="Henri Christiaenlaan 5, Sint-Idesbald, 8670, Belgium"
    cuisine="Meats and Grills"
    priceRange="€€€€"
    phoneNumber="+3258517249"
    website="https://www.carcasse.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="At Hendrik Dierendonck’s establishment, the meat comes straight from the butchers to the plate – in fact, Carcasse is literally the extension of his shop in Saint Idesbald. The hip interior provides the perfect foil to the raw vibe of a butcher’s shop. The soundtrack features guitars strumming, but the star of the show is clearly red meat. A glazed ageing cabinet takes pride of place in the centre, while runners on the ceiling bear witness to a bygone era when the carcasses were shunted overhead. A long communal table is designed to encourage diners to share this experience. The exceptional cuts of meat of this renowned butcher are consummately and creatively prepared, perfectly seasoned and cooked in a Josper charcoal oven by chef Timon Michiels. The perfect place to find out more about h..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Henri%20Christiaenlaan%205%2C%20Sint-Idesbald%2C%208670%2C%20Belgium"
    pageTitle="Carcasse"
  />
);

export default Carcasse;
