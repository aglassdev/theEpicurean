...
const EpicesEtNous = () => (
  <RestaurantPage
    restaurantName="Epices et Nous"
    address="chaussée de Marche 561, Erpent, 5101, Belgium"
    cuisine="Traditional Cuisine, Modern French"
    priceRange="€€"
    phoneNumber="+3281313224"
    website="https://www.epicesetnous.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Delvigne regularly calls upon oriental spices to add subtlety to his recipes. For example, a saffron sauce adds depth to a stew of megrim and lobster. Spices form the backbone of his cooking, oozing in generosity and free of fatuitous frills. Everything is crafted from scratch and the extensive menu further adds to the appeal. Finally, the casual serene vibe is delightfully contagious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Marche%20561%2C%20Erpent%2C%205101%2C%20Belgium"
    pageTitle="Epices et Nous"
  />
);

export default EpicesEtNous;
