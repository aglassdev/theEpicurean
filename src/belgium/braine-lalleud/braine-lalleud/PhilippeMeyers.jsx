...
const PhilippeMeyers = () => (
  <RestaurantPage
    restaurantName="Philippe Meyers"
    address="rue Doyen Van Belle 6, Braine-l'Alleud, 1420, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3223848318"
    website="https://www.philippe-meyers.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Philippe and Valerie Meyers are sincere, warm-hearted folks, adjectives that also depict the interior design of their dinky eatery which showcases a magnificent collection of Michelin Guides. Valérie plays the role of hostess with great spontaneity and adores waxing lyrical about the chef’s passion for Walloon produce and his ability to tell a tale with just a few ingredients. Take for example his signature dish of speck, cooked for 17 hours, which he pairs with lemon-flavoured Eau de Villée, seared, still translucent langoustine tails and a gutsy sauce of hoisin and confit lemons. Alternatively, how about a lovingly reduced (and highly addictive) gravy rich in suave green pepper notes to enhance a dish of crispy sweetbread? Authentic generosity is the baseline of the attractively priced m..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Doyen%20Van%20Belle%206%2C%20Braine-l'Alleud%2C%201420%2C%20Belgium"
    pageTitle="Philippe Meyers"
  />
);

export default PhilippeMeyers;
