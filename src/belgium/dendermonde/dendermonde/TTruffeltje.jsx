...
const TTruffeltje = () => (
  <RestaurantPage
    restaurantName="'t Truffeltje"
    address="Bogaerdstraat 20, Dendermonde, 9200, Belgium"
    cuisine="Modern French, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3252224590"
    website="https://truffeltje.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="’t Truffeltje has enjoyed a stellar reputation ever since Pol and Greta first opened the restaurant back in 1988. Chef Marien demonstrates his mastery of French culinary technique, deploying his consummate know-how and choosing only the best produce. Subtle exotic influences add an occasional stylish twist...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bogaerdstraat%2020%2C%20Dendermonde%2C%209200%2C%20Belgium"
    pageTitle="'t Truffeltje"
  />
);

export default TTruffeltje;
