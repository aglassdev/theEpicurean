...
const Steeg = () => (
  <RestaurantPage
    restaurantName="Steeg"
    address="Guldenhoofdstraat 2, Dendermonde, 9200, Belgium"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+3252343373"
    website="https://steeg.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The narrow lane leading to this buzzy eatery, near the Grand-Place of Dendermonde, would be quite at home on a historical movie set. Willem Vervaet once again demonstrates his love of live fire cooking and his creative flair. First, he grills scallops, before pairing them with raw celeriac seasoned with parsley and capers, and then adding a final flourish by way of a divine baked apple sauce. This chef enchants and surprises with nuances of grilled fruit and veggies. The menu is a treasure trove of playful combinations that never cease to intrigue and delight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Guldenhoofdstraat%202%2C%20Dendermonde%2C%209200%2C%20Belgium"
    pageTitle="Steeg"
  />
);
