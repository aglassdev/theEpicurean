...
const DeFarmasie = () => (
  <RestaurantPage
    restaurantName="De Farmasie"
    address="Antwerpsesteenweg 223, Vosselaar, 2350, Belgium"
    cuisine="Modern French, Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+3214713272"
    website="https://www.defarmasie.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A good meal is just what the doctor ordered! So, book a table in this establishment, whose black and white colour scheme is quirkily adorned with a 17C pharmacy cabinet and wainscoting in tribute to its former vocation. Chef Verheyen, a keen “farm to table” adept and a past master of subtle flavours, is capable of jazzing up salty mackerel with ponzu, underscoring juicy local poultry with a veal gravy or turning out an immaculately cooked rib steak from his wood-burning oven. Generosity is the keyword of this restaurant as the extensive menu demonstrates...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Antwerpsesteenweg%20223%2C%20Vosselaar%2C%202350%2C%20Belgium"
    pageTitle="De Farmasie"
  />
);

export default DeFarmasie;
