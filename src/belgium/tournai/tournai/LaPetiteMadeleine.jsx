...
const LaPetiteMadeleine = () => (
  <RestaurantPage
    restaurantName="la petite Madeleine"
    address="rue de la Madeleine 19, Tournai, 7500, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3269840187"
    website="https://www.lapetitemadeleine.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the authentic historic façade lies a contemporary interior, adorned with arty photos and boasting a fine terrace to the rear. Chef Dufranne enjoys surprising diners with his original recipes and generous helpings. Each dish is a treasure trove of meticulously prepared ingredients and fascinating combinations...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20la%20Madeleine%2019%2C%20Tournai%2C%207500%2C%20Belgium"
    pageTitle="la petite Madeleine"
  />
);

export default LaPetiteMadeleine;
