...
const Lincontournable = () => (
  <RestaurantPage
    restaurantName="L'Incontournable"
    address="avenue du Rond-Point 3a, Rochefort, 5580, Belgium"
    cuisine="French Contemporary"
    priceRange="€€"
    phoneNumber="+3284222373"
    website="https://wallux.com/lincontournable-rochefort"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="What does it take to create a Bib Gourmand restaurant? Fresh ingredients, sourced locally if possible (here, they are listed on the menu). Consummate technique. This could be the ability to whip up a classic pepper sauce to accompany a fillet of venison, or slightly more playful ideas such as Jerusalem artichoke and chorizo croquettes combined with scallops and a butter sauce with orange. Of course, value for money is also key. And that is precisely why this warm and welcoming restaurant, with father Stéphane in the kitchen and son Loïk front-of-house, is such an exemplary Bib...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20du%20Rond-Point%203a%2C%20Rochefort%2C%205580%2C%20Belgium"
    pageTitle="L'Incontournable"
  />
);

export default Lincontournable;
