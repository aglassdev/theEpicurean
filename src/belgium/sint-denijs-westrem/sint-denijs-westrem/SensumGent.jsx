...
const SensumGent = () => (
  <RestaurantPage
    restaurantName="Sensum Gent"
    address="Kortrijksesteenweg 1026, Sint-Denijs-Westrem, 9051, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3292461146"
    website="https://sensumgent.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The interior of this eye-catching mansion on the outskirts of Ghent is more than a match for its magnificent exterior. The revamp, which has preserved the edifice’s period elegance and historic character, sports a wealth of luxurious contemporary details that are the height of tasteful. Chef Maurice and your hostess and sommelier, Deborah, celebrate life with their guests from start to finish courtesy of a fine dining experience and knockout wines. The chef goes out of his way to source outstanding ingredients with the occasional passing nod to his Zeeland roots. His extensive technical background means that he is at home with a wide range of culinary methods, unusual combinations and international flavours. For example, he might pair king crab with a gutsy beurre blanc of shellfish and a ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kortrijksesteenweg%201026%2C%20Sint-Denijs-Westrem%2C%209051%2C%20Belgium"
    pageTitle="Sensum Gent"
  />
);

export default SensumGent;
