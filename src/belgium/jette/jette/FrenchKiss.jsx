...
const FrenchKiss = () => (
  <RestaurantPage
    restaurantName="French Kiss"
    address="rue Léopold I 470, Jette, 1090, Belgium"
    cuisine="Meats and Grills, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3224252293"
    website="https://www.restaurantfrenchkiss.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pleasant restaurant renowned for its excellent grilled dishes and impressive wine list. Dining area with a low ceiling and bright paintings adding colour to the brick walls...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20L%C3%A9opold%20I%20470%2C%20Jette%2C%201090%2C%20Belgium"
    pageTitle="French Kiss"
  />
);
