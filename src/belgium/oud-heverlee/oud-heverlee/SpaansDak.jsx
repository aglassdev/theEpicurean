...
const SpaansDak = () => (
  <RestaurantPage
    restaurantName="Spaans Dak"
    address="Maurits Noëstraat 2, Oud-Heverlee, 3050, Belgium"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+3216473333"
    website="https://spaansdak.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The view from this 16C manor house over Zoet Water is quite simply stunning and the modern wing, done up in designer-inspired vibe, also commands a splendid view. The food is modern and meticulously crafted in a bid to create succulent contrasts with the core ingredient. The three-course menu is one of the highlights of this splendid establishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maurits%20No%C3%ABstraat%202%2C%20Oud-Heverlee%2C%203050%2C%20Belgium"
    pageTitle="Spaans Dak"
  />
);

export default SpaansDak;
