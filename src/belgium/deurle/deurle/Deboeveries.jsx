...
const Deboeveries = () => (
  <RestaurantPage
    restaurantName="Deboeveries"
    address="Lijnstraat 2, Deurle, 9831, Belgium"
    cuisine="Seasonal Cuisine, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3292823391"
    website="https://www.deboeveries.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The regulars to this characterful farmstead (awesome terrace!) know that on Fridays, sole, the house specialty, takes pride of place on chef Bert Deboeverie’s menu. The food is steeped in with flavour and rich in clever contemporary combinations. Choice of menus - the all-inclusive formula is highly recommended. Fine selection of mainly French tipples...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lijnstraat%202%2C%20Deurle%2C%209831%2C%20Belgium"
    pageTitle="Deboeveries"
  />
);

export default Deboeveries;
