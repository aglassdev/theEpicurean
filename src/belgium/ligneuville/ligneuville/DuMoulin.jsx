...
const DuMoulin = () => (
  <RestaurantPage
    restaurantName="Du Moulin"
    address="Grand'Rue 28, Ligneuville, 4960, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€"
    phoneNumber="+3280570081"
    website="https://www.hoteldumoulin.be/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The wood-burning fire in the cosy sitting room is the epitome of an Ardennes inn. This nostalgic charm is enhanced by the classical cooking of Jean Goire, who brooks no concessions. He pays tribute to his region, working closely with carefully selected suppliers. His culinary expertise unveils a deep-rooted respect and steadfast commitment to flavours that are gutsy, rustic and traditional to the core...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Grand'Rue%2028%2C%20Ligneuville%2C%204960%2C%20Belgium"
    pageTitle="Du Moulin"
  />
);

export default DuMoulin;
