...
const Lepelem = () => (
  <RestaurantPage
    restaurantName="Lepelem"
    address="Brugse Baan 16, Vlissegem, 8420, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3259447731"
    website="https://www.lepelem.be/restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ellen and Christopher have gradually turned a former tearoom into a smart restaurant. An exquisite home-from-home vibe and a wine list that will knock your socks off are among its standouts. Christopher enthusiastically offers diners the possibility of composing their own à la carte menu. He has a knack for juggling familiar flavours with complex preparations, depicted by hand-shelled shrimps with a creamy burrata, pickled watermelon and a fragrant dashi, or juicy, melt-in-the-mouth turbot flanked by a silky bearnaise sauce. Unbeatable quality-for-pleasure ratio...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brugse%20Baan%2016%2C%20Vlissegem%2C%208420%2C%20Belgium"
    pageTitle="Lepelem"
  />
);

export default Lepelem;
