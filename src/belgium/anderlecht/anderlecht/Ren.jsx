...
const Ren = () => (
  <RestaurantPage
    restaurantName="René"
    address="place de la Résistance 14, Anderlecht, 1070, Belgium"
    cuisine="Belgian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3225232876"
    website="https://guide.michelin.com/en/bruxelles-capitale/anderlecht/restaurant/rene"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="René takes us back to a time when life was simple. This former chippy, upgraded into a natty vintage bistro, shines the spotlight on down-to-earth Belgian classics. Mussels stuffed with parsley and garlic butter, rare steak with fresh béarnaise sauce and nourishing stews are all served with heaps of French fries. Huge helpings of searingly good food! What’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20de%20la%20R%C3%A9sistance%2014%2C%20Anderlecht%2C%201070%2C%20Belgium"
    pageTitle="René"
  />
);
