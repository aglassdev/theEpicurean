...
const LaBrouette = () => (
  <RestaurantPage
    restaurantName="La Brouette"
    address="boulevard Prince de Liège 61, Anderlecht, 1070, Belgium"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+3225225169"
    website="https://www.labrouette.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Herman Dedapper welcomes you with open arms to his neighbourhood restaurant, decorated in warm colours and adorned with his own photo work. He is an excellent sommelier and loves to share his passion for wine. The chef’s generous, French - inspired dishes are sourced from high - quality produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=boulevard%20Prince%20de%20Li%C3%A8ge%2061%2C%20Anderlecht%2C%201070%2C%20Belgium"
    pageTitle="La Brouette"
  />
);

export default LaBrouette;
