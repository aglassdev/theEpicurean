...
const TableRase = () => (
  <RestaurantPage
    restaurantName="Table Rase"
    address="Avenue René Lange 18, Polleur, 4910, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3287220522"
    website="https://www.table-rase.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Ludovic and Clarisse tick all the boxes when it comes to good food, starting with the eater-friendly prices of their welcoming eatery. Chef Ludovic enjoys shining the spotlight on his region, as he jazzes up immaculately crafted dishes with acidic, savoury or other subtle touches. He cleverly mixes smoked eel, foie gras and red beetroot in a punchy celery and wasabi jus. A “clean slate” for a fresh beginning with the distinctive signature of a veteran chef...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Ren%C3%A9%20Lange%2018%2C%20Polleur%2C%204910%2C%20Belgium"
    pageTitle="Table Rase"
  />
);

export default TableRase;
