...
const Cosma = () => (
  <RestaurantPage
    restaurantName="Cosma"
    address="Befferstraat 24, Mechelen, 2800, Belgium"
    cuisine="Sharing, Contemporary"
    priceRange="€€"
    phoneNumber="+3215670070"
    website="https://www.cosma.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The bright, hip, relaxed vibe of this restaurant immediately sets everyone at ease. This enthusiasm is further enhanced when you take a glance at the menu which sports a wide range of dishes to be shared, countless vegetarian suggestions and excellent side dishes – bravo! An unusual formula and heart-warming international influences...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Befferstraat%2024%2C%20Mechelen%2C%202800%2C%20Belgium"
    pageTitle="Cosma"
  />
);

export default Cosma;
