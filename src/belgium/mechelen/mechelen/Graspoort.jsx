...
const Graspoort = () => (
  <RestaurantPage
    restaurantName="Graspoort"
    address="Begijnenstraat 28, Mechelen, 2800, Belgium"
    cuisine="Creative French, Fusion"
    priceRange="€€€"
    phoneNumber="+3215219710"
    website="https://graspoort.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Graffiti on the walls and a homemade tropical tree hung with brightly coloured leaves set the scene in this fun, offbeat eatery. Thibault Van Stratum cooks instinctively and frequently finds his inspiration in Asia. Highly creative fusion cuisine brimming in influences, illustrated by croaker and marinated mussels jazzed up by smoked oil-perfumed dashi...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Begijnenstraat%2028%2C%20Mechelen%2C%202800%2C%20Belgium"
    pageTitle="Graspoort"
  />
);

export default Graspoort;
