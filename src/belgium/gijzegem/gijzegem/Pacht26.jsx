...
const Pacht26 = () => (
  <RestaurantPage
    restaurantName="Pacht 26"
    address="Pachthofstraat 26, Gijzegem, 9308, Belgium"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+32499736027"
    website="https://www.pacht26.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stefaan, chef and sommelier, is an enthusiastic foodie and wine connoisseur. He regularly scours eastern Europe to enrich his wine list. The many regulars to his friendly, welcoming establishment applaud the wine formula which reveals the full scope of his creativity. Each dish is a consummate blend of character and delicacy with legible ingredients such as duck’s liver and beetroot, depicted in fresh, subtle nuances...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Pachthofstraat%2026%2C%20Gijzegem%2C%209308%2C%20Belgium"
    pageTitle="Pacht 26"
  />
);

export default Pacht26;
