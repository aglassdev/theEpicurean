...
const Octopus = () => (
  <RestaurantPage
    restaurantName="Octopus"
    address="Walckierstraat 8, De Panne, 8660, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3258411680"
    website="https://www.aufiletdesole.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Claude and Sylvie bend over backwards to pamper guests in their seafood eatery near the seawall. Sylvie’s warm welcome and service are framed by distinctive artwork (of octopi), while Claude sensitively adds a new spin to a classical repertory, all of which in a playful vein. Grilled pork fritters, pedigree vol-au-vent, fish from the North Sea (his passion) or rice pudding with strawberries: it is always a pleasure to return to the Octopus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Walckierstraat%208%2C%20De%20Panne%2C%208660%2C%20Belgium"
    pageTitle="Octopus"
  />
);
