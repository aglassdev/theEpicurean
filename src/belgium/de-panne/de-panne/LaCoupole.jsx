...
const LaCoupole = () => (
  <RestaurantPage
    restaurantName="La Coupole"
    address="Nieuwpoortlaan 9, De Panne, 8660, Belgium"
    cuisine="Seafood"
    priceRange="€€"
    phoneNumber="+3258415454"
    website="https://www.la-coupole.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="La Coupole has been a blue - chip value since 1989. Diners enjoy the low - key, trendy atmosphere. The lobster and fish specialties are served by chef Bonnez’ brother, further proof of the establishment’s quality. Excellent wines...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwpoortlaan%209%2C%20De%20Panne%2C%208660%2C%20Belgium"
    pageTitle="La Coupole"
  />
);

export default LaCoupole;
