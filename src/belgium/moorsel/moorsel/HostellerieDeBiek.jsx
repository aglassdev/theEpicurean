...
const HostellerieDeBiek = () => (
  <RestaurantPage
    restaurantName="Hostellerie De Biek"
    address="Moorsel-Dorp 3, Moorsel, 9310, Belgium"
    cuisine="Country cooking"
    priceRange="€€€"
    phoneNumber="+3253607640"
    website="https://www.hostelleriedebiek.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We wager that before you even set foot in this family-run eatery, you will have fallen in love with the authentic Flemish village. The immense windows of the former brewery overlook the village and a sheltered terrace, while the striking interior sports timber rafters and brick walls. Before relaxing in one of the comfortable guestrooms, treat yourself to something from the extensive menu. Brabançon-style pheasant or bouchot mussels served in a spicy nduja and red curry sauce: the chef adds a kick to Belgian classics thanks to playful, creative inventions. A knockout lineup of regional produce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Moorsel-Dorp%203%2C%20Moorsel%2C%209310%2C%20Belgium"
    pageTitle="Hostellerie De Biek"
  />
);

export default HostellerieDeBiek;
