...
const WillemHiele = () => (
  <RestaurantPage
    restaurantName="Willem Hiele"
    address="Kapittelstraat 71, Oudenburg, 8460, Belgium"
    cuisine="Creative, Seasonal Cuisine"
    priceRange="€€€€"
    phoneNumber="+32468006699"
    website="https://restaurant.willemhiele.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Unconventional Willem Hiele has set up shop in this architectural behemoth by Jacques Moeschal. Polders dominate De Keignaert nature reserve and are also a major feature of this imposing brutalist edifice. The 1960s-70s design further accentuates the minimalist character of this former private residence, in which chef Hiele invites you to sample his favourite dishes. He translates the harsh character of the sea and nature into dishes that bear his highly personal and delicate hallmark. Intense sauces, vinaigrettes and a smoky live fire focus showcase regional delicacies such as North Sea fish and veggies. Examples include hare from the polders on the bone, cooked in bay leaf, goose fat, butter and rosemary. Aged cherries, black trumpet mushrooms and a knock-out hare and Schaerbeek cherry s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kapittelstraat%2071%2C%20Oudenburg%2C%208460%2C%20Belgium"
    pageTitle="Willem Hiele"
  />
);

export default WillemHiele;
