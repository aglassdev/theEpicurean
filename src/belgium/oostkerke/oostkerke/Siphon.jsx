...
const Siphon = () => (
  <RestaurantPage
    restaurantName="Siphon"
    address="Damse Vaart-Oost 1, Oostkerke, 8340, Belgium"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+3250620202"
    website="https://www.siphon.be/nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Be it with sorrel, meunière or à la crème, people flock to this characterful restaurant from near and far to enjoy the house speciality, eel. They also offer grilled lobster and steak, as a quick look at their menu, an ode to tradition, will confirm. Siphon has become something of a culinary landmark in the region, further backed up by an intelligent wine list...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Damse%20Vaart-Oost%201%2C%20Oostkerke%2C%208340%2C%20Belgium"
    pageTitle="Siphon"
  />
);
