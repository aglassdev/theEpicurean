...
const LaCuisineDeYannick = () => (
  <RestaurantPage
    restaurantName="La Cuisine de Yannick"
    address="En Féronstrée 111, Liège, 4000, Belgium"
    cuisine="Traditional Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+32499214205"
    website="https://guide.michelin.com/en/liege/liege/restaurant/la-cuisine-de-yannick"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Red and white tablecloths set the warm bistro scene, reinforced by a soundtrack starring the likes of Jacques Brel and Georges Brassens and, above all, the personality of exuberant, fun-loving Joelle in the front of house. It is the perfect spot to (re)discover the importance of home-made cooking and the sheer strength of traditional flavours. The regularly renewed menu shines the spotlight on a line-up of classics ranging from beef tongue in Madeira sauce to a consummately crafted, oozing with taste kidney stew. The reasonably priced wine list is equally awesome...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=En%20F%C3%A9ronstr%C3%A9e%20111%2C%20Li%C3%A8ge%2C%204000%2C%20Belgium"
    pageTitle="La Cuisine de Yannick"
  />
);

export default LaCuisineDeYannick;
