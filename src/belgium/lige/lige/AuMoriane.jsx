...
const AuMoriane = () => (
  <RestaurantPage
    restaurantName="Au Moriane"
    address="En Neuvice 55, Liège, 4000, Belgium"
    cuisine="Creative, Modern French"
    priceRange="€€€"
    phoneNumber="+3243589112"
    website="https://aumoriane.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This 1693 edifice adds a contemporary touch to the historic character of En Neuvice lane by way of bare stone walls and modern comforts. The exquisitely presented food is the handiwork of a gifted chef who demonstrates his international eclecticism, delving freely into the establishment’s cottage garden for his fruit and veggies. The accent is on tradition first and foremost...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=En%20Neuvice%2055%2C%20Li%C3%A8ge%2C%204000%2C%20Belgium"
    pageTitle="Au Moriane"
  />
);

export default AuMoriane;
