...
const Bartholomeus = () => (
  <RestaurantPage
    restaurantName="Bartholomeus"
    address="Zeedijk 267, Heist, 8301, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3250517576"
    website="https://www.restaurantbartholomeus.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Bart Desmidt, with his right-hand man Philip and the gracious Sandra, invite you to sample a fantastic feast of flavours in Bartholomeus, a swanky restaurant with Japanese overtones. Admire the cheerful chefs seamlessly working together in the open kitchen. The 18 seats around the counter are reserved for connoisseurs of high-flying cuisine. There is a single set menu and Sandra can be relied upon for judicious wine-food pairings, delving into a splendid cellar with a stellar selection of wines by the glass. The cast of exceptional ingredients features stars such as turbot, truffle and scallops, all of which are crafted with consummate know-how. Creative, bang-on dishes designed to showcase the ingredient, courtesy of deceptively simple recipes that combine creativity and intensity. In an ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zeedijk%20267%2C%20Heist%2C%208301%2C%20Belgium"
    pageTitle="Bartholomeus"
  />
);

export default Bartholomeus;
