...
const LaBaita = () => (
  <RestaurantPage
    ...
    address="Kloosterstraat 23, Neerpelt, 3910, Belgium"
    cuisine="Italian Contemporary"
    priceRange="€€"
    phoneNumber="+32467016202"
    website="https://www.ristorantelabaita.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Authentic aromas and flavours of linguine alla Genovese, thickly cut wagyu picanha, grilled rare or a modern take on cannoli: this enchanting restaurant celebrates all the facets of Italian cuisine. Chef Sandro gets a kick out of mixing techniques and textures, adding his own distinctive hallmark to each dish, whilst remaining true to his homeland’s culinary roots – the chef hails from Marche...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kloosterstraat%2023%2C%20Neerpelt%2C%203910%2C%20Belgium"
    pageTitle="La Baita"
  />
);

export default LaBaita;
