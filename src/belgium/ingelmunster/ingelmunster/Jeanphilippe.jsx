...
const Jeanphilippe = () => (
  <RestaurantPage
    restaurantName="Jean-Philippe"
    address="Bruggestraat 97, Ingelmunster, 8770, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3251690707"
    website="https://www.jean-philippe.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Jean-Philippe and Sara-Sofia have crafted a cosy cocoon in this townhouse. Artwork by Isidoor Goddeeris underscores the restaurant’s classy interior and reflects the chef’s love of seafood. The couple’s experience shines through in every detail. Sara-Sofia seamlessly manages the front of house, while presenting her latest cocktails. Jean-Philippe draws on his flawless technical background as he works with outstanding ingredients. Examples include wild seabass, grilled to keep the skin crispy and flanked by different textures of fennel, a baby artichoke and characterful crab bisque. This consummate chef, a master of delicacy, has a way with flavour and gutsy sauces that is second to none...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bruggestraat%2097%2C%20Ingelmunster%2C%208770%2C%20Belgium"
    pageTitle="Jean-Philippe"
  />
);

export default Jeanphilippe;
