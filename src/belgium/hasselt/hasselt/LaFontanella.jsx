...
const LaFontanella = () => (
  <RestaurantPage
    restaurantName="La Fontanella"
    address="Maastrichterstraat 60, Hasselt, 3500, Belgium"
    cuisine="Italian Contemporary"
    priceRange="€€"
    phoneNumber="+3211228255"
    website="https://la-fontanella-hasselt.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The family-run La Fontanella, which opened back in 1977, is today in the hands of the second generation. The visitor is immediately struck by the elegant warmth of the premises, depicted by artwork, soft lighting and bouquets of fresh flowers. The entire team is cheerful and good-natured, particularly when they liberally scatter shavings of white alba truffle on your taglioni alla parmigiana. In addition to reverently crafting a purebred Italian lineup (the house specialty is osso bucco), the chef enjoys adding contemporary twists, together with nods to Belgian cuisine, like pheasant à la brabançonne in autumn. Highly popular so bookings are advised...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maastrichterstraat%2060%2C%20Hasselt%2C%203500%2C%20Belgium"
    pageTitle="La Fontanella"
  />
);

export default LaFontanella;
