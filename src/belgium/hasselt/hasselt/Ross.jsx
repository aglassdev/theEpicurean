...
const Ross = () => (
  <RestaurantPage
    restaurantName="ROSS"
    address="Het Dorp 34, Hasselt, 3500, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3211182793"
    website="https://www.rosshasselt.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Glenn Ross often waves a hi to guests from his kitchen opening onto the buzzy dining room. The trendy vibe is the perfect foil for creative Gallic cuisine, paired with exotic delicacies and modern techniques. Perennial favourites like bavette steak and chocolate tart are heart-warmingly nostalgic, albeit stamped with the chef’s subtle personal hallmark...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Het%20Dorp%2034%2C%20Hasselt%2C%203500%2C%20Belgium"
    pageTitle="ROSS"
  />
);
