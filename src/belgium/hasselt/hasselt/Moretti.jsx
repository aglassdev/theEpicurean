...
const Moretti = () => (
  <RestaurantPage
    restaurantName="Moretti"
    address="Havermarkt 23, Hasselt, 3500, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+32470429770"
    website="https://www.osteriamoretti.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Check out the goodies lined up in La Cantina delicatessen before taking a seat on the terrace or indoors, in the cosy dining room laid out around an open-plan kitchen. Moretti knows how to put on a show of mouthwatering dishes that illustrate the manifold facets of Italian cucina. Tiana and Alexander curate a concise menu at lunchtime with a wide range of pasta dishes and a more modern lineup in the evenings. Textbook perfect vitello tonnato, homemade pasta flanked by an aromatic sauce and painstakingly crafted desserts: if you’re hankering for an authentic escapade to sunny Italy, make a beeline to Moretti...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Havermarkt%2023%2C%20Hasselt%2C%203500%2C%20Belgium"
    pageTitle="Moretti"
  />
);
