...
const MaPassion = () => (
  <RestaurantPage
    restaurantName="Ma Passion"
    address="Diksmuidsesteenweg 159, Roeselare, 8800, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3251698318"
    website="https://www.ma-passion.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Kris and elegant Sandra share a passion for fine food and fine wine! This handsome townhouse with a lovely patio tastefully blends old and new with an inimitable Belgian knack for colours and materials. The chef voluntarily tries his hand at different styles, mixing the classical flavours of foie gras and sweetbread with subtle sauces and fresh, acidic side dishes, demonstrating his playful side and virtuoso talent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Diksmuidsesteenweg%20159%2C%20Roeselare%2C%208800%2C%20Belgium"
    pageTitle="Ma Passion"
  />
);

export default MaPassion;
