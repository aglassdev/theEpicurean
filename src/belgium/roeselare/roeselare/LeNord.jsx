...
const LeNord = () => (
  <RestaurantPage
    restaurantName="Le Nord"
    address="Noordstraat 217, Roeselare, 8800, Belgium"
    cuisine="French Contemporary"
    priceRange="€€€"
    phoneNumber="+3251251590"
    website="https://www.lenord.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind a spruce conventional façade, the Bistro le Nord bills itself as a characterful, contemporary eatery. A modern vibe, Mediterranean influences and the jubilant owner Dimitri set the scene indoors. The kitchen brigade rolls out Franco-Belgian family favourites enriched with subtle international and southern European influences. Examples include red mullet with a beurre blanc enhanced by kalamata olives, or a juicy cockerel, lacquered char siu style and flanked by citrus fruits...."
