...
const Boury = () => (
  <RestaurantPage
    restaurantName="Boury"
    address="Rumbeeksesteenweg 300, Roeselare, 8800, Belgium"
    cuisine="Creative French"
    priceRange="€€€€"
    phoneNumber="+3251626462"
    website="https://www.restaurantboury.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 3, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="In their brick villa, Tim Boury and Inge Waeles have clearly puzzled and pondered over each tiny detail from the attentive service and felicitous wine-food pairings to the fashionably stylish interior and the gorgeous patio and bar. The buzzy casual vibe is ample proof that perfection is not necessarily starched and stuffy. Chef Boury’s painstaking recipes mingle classicism with creative peps and he cannot be equalled for his ability to enhance exceptional ingredients, particularly those from his region whose praises he frequently sings. His cuisine attains a pinnacle of high-flying virtuosity, whether by the complexity of flavours and textures or by a prodigious sauce that hits the spot every time. Take for example the three variations on a langoustine that our inspectors sampled. They ki..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rumbeeksesteenweg%20300%2C%20Roeselare%2C%208800%2C%20Belgium"
    pageTitle="Boury"
  />
);

export default Boury;
