...
const VillaSingha = () => (
  <RestaurantPage
    restaurantName="Villa Singha"
    address="rue des Trois Ponts 22, Auderghem, 1160, Belgium"
    cuisine="Thai, Asian"
    priceRange="€"
    phoneNumber="+3226756734"
    website="https://www.singha.be/html/home.htm"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Villa Singha has been upholding and celebrating Thai traditions for over thirty years. A characteristic Thai decor and references to the mythological lion, Singha, set the exotic scene, further enhanced by an extensive succulent menu. Crispy Popiah fried spring rolls, Thai dumplings stuffed with ground pork or fried cod in a ginger chili sauce are a few of the generously crafted and spicy, yet balanced dishes. A word of advice – don’t forget to book, although, if the worse comes to the worst, you can always order a take-away!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20des%20Trois%20Ponts%2022%2C%20Auderghem%2C%201160%2C%20Belgium"
    pageTitle="Villa Singha"
  />
);

export default VillaSingha;
