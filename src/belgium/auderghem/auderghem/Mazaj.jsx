...
const Mazaj = () => (
  <RestaurantPage
    restaurantName="Maza'j"
    address="boulevard du Souverain 145, Auderghem, 1160, Belgium"
    cuisine="Lebanese, Middle Eastern"
    priceRange="€€"
    phoneNumber="+3226755510"
    website="https://www.mazaj.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Maza'j serves dishes bursting with bold colours and exciting flavours. The tables here are decked with authentic Lebanese specialities that delight diners with their distinctive spiciness and generosity. Velvety hummus with pine nuts, barbecued minced lamb with a delicately sweet bell pepper confit, an array of vegetables elevated by a blend of aromatic herbs… You and your dining companions can look forward to sharing a real feast in a convivial atmosphere. Experience the richness of Lebanese culinary tradition!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=boulevard%20du%20Souverain%20145%2C%20Auderghem%2C%201160%2C%20Belgium"
    pageTitle="Maza'j"
  />
);

export default Mazaj;
