...
const Nyde = () => (
  <RestaurantPage
    restaurantName="Nyde"
    address="Tongersesteenweg 30, Borgloon, 3840, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3212393237"
    website="https://www.nyde.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The decision to call their restaurant Nyde, which means “to enjoy” in Danish, was far from ingenuous. Chef Céline, flanked by Martijn, your host, bend over backwards to make sure their guests enjoy their meal. The restaurant, whose vibe is serene and boasts a gorgeous patio to the rear, offers a set menu and a selection of cocktails and mocktails and insightful food-wine pairings. Céline underscores each ingredient’s purity as she seeks to sensitively enhance their flavours. She may garnish a lemon-flavoured mackerel tartare with a delicate concoction of diced cucumber and briny oysters, all of which is further offset by a lemon and cucumber dressing. Feelgood food that is guaranteed to lift your spirits...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tongersesteenweg%2030%2C%20Borgloon%2C%203840%2C%20Belgium"
    pageTitle="Nyde"
  />
);
