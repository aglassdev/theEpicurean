...
const LaStrada = () => (
  <RestaurantPage
    ...
    address="Rijksweg 634, Opgrimbie, 3630, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+3289766912"
    website="https://www.restaurantlastrada.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Contemporary restaurant faithful to Italy’s culinary heritage. Chef Pierro hails from Umbria and Tuscan cuisine has no secrets from him. His truffle recipes are standout. His son, Valentino, adds his youthful enthusiasm in the kitchen, while Myriame’s gracious welcome completes this family affair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rijksweg%20634%2C%20Opgrimbie%2C%203630%2C%20Belgium"
    pageTitle="La Strada"
  />
);

export default LaStrada;
