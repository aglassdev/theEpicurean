...
const LaPetiteGayole = () => (
  <RestaurantPage
    restaurantName="La Petite Gayole"
    address="Place de Thuillies 12, Thuillies, 6536, Belgium"
    cuisine="Traditional Cuisine, French"
    priceRange="€€"
    phoneNumber="+3271955643"
    website="https://lapetitegayole.restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This characterful establishment in the picturesque village of Thuillies has become a beacon for all self-respecting fans of traditional nosh. A soundtrack of French ballads, an attractive wooden counter and vintage posters on the walls set the nostalgic scene indoors. The menu stars a patriotic lineup of Belgian staples including vol-au-vent of crunchy sweetbread and fresh fries, juicy kidneys and a dessert of French toast that is the ultimate comfort food. Wholehearted, much-loved family cooking oozing in bountiful generosity and fantastic flavours. We recommend the specials chalked up on the slate that offer outstanding taste for money!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Place%20de%20Thuillies%2012%2C%20Thuillies%2C%206536%2C%20Belgium"
    pageTitle="La Petite Gayole"
  />
);

export default LaPetiteGayole;
