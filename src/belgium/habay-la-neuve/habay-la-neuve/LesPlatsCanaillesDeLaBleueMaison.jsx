...
const LesPlatsCanaillesDeLaBleueMaison = () => (
  <RestaurantPage
    restaurantName="Les Plats Canailles de la Bleue Maison"
    address="rue du Pont d'Oye 7, Habay-la-Neuve, 6720, Belgium"
    cuisine="French, Farm to table"
    priceRange="€€€"
    phoneNumber="+3263424270"
    website="https://www.forgesdupontdoye.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The picture postcard scene features a blue-shuttered gingerbread house poised between two rivers. The exquisite neo-rustic interior exudes a romantic vibe. Brice and Martin Thiry have added gusto and verve to this family business. They favour local produce and juggle with modern flavours such as acidity whilst respecting the ethos of traditional recipes. So, fancy sharing a rib of beef, carved in front of you, washed down with a glass of full-bodied wine? Good food and good vibes are the backbone of this endearing eatery...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Pont%20d'Oye%207%2C%20Habay-la-Neuve%2C%206720%2C%20Belgium"
    pageTitle="Les Plats Canailles de la Bleue Maison"
  />
);

export default LesPlatsCanaillesDeLaBleueMaison;
