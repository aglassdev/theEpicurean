...
const CommeChezSoi = () => (
  <RestaurantPage
    restaurantName="Comme chez Soi"
    address="place Rouppe 23, Brussels, 1000, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+3225122921"
    website="https://www.commechezsoi.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A meal at Comme chez Soi is like biting into a slice of gastronomic history. The emblematic Art nouveau Horta interior, appointed with stained glass and elegant details, is classy and characterful, while the wine cellar (Riwyne) offers a more contemporary “private dining” experience. The rich legacy of this establishment, founded in 1926, owes much to Pierre Wynants. The fourth generation, Laurence and Lionel Rigolet and their son Loïc, is now pursuing the story. Together they continue to serve the house’s signature dishes, like mousse of Ardennes ham or sole fillets in a creamy Riesling and shrimp sauce. Chef Rigolet lavishes great care and attention on the plating, to which he adds an exotic twist, particularly in the set menu. His consummate mastery of sauces and his knowledge of outsta..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20Rouppe%2023%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Comme chez Soi"
  />
);

export default CommeChezSoi;
