...
const Chaga = () => (
  <RestaurantPage
    restaurantName="Chaga"
    address="Avenue Marnix 21, Brussels, 1000, Belgium"
    cuisine="French Contemporary"
    priceRange="€€€€"
    phoneNumber="+3226154050"
    website="https://chagarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Come treat yourself to an elevated gourmet experience on the top floor of the Faubourg 21 boutique hotel. Maison Sarah Lavoine has infused a bold designer edge, courtesy of noble materials and colour, to this luxurious historic townhouse, whose windows overlook Brussels Park. Right from the word go, the staff bends over backwards to pamper guests and veteran chef Kevin Lejeune is also devoted to excellence. Equipped with an enviable CV, the virtuoso chef meticulously adds a unique twist to each dish by way of distinctive flavours. He may cook John Dory in kombu, flanked by a seaweed cream or pair Corrèze suckling veal with a gutsy gravy and Mediterranean sides like a rich cream of mature parmesan. Everything at Chaga has definitely been puzzled and pondered over endlessly!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Marnix%2021%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Chaga"
  />
);
