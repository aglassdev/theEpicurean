...
const Um = () => (
  <RestaurantPage
    restaurantName="Umā"
    address="Rue de la Reinette 8, Brussels, 1000, Belgium"
    cuisine="Fusion, International"
    priceRange="€€"
    phoneNumber="+3224255115"
    website="https://uma-restaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Umā stands on a quiet side street near the bustling Porte de Namur. Its white-washed outer brick facade and modern artwork indoors are inviting and attractive. In an open kitchen, the chef skilfully blends frank Japanese cuisine with gutsy South-American accents in a suave bistronomic lineup. He adds his hallmark signature courtesy of subtle spicy notes. Examples include a sashimi of red tuna in a subtle stock perfumed with shiso oil and dashi or a medium rare fillet of duck with subtle sides of curry and vadouvan - intensity meets variety. Both the varied à la carte menu and the succulent set menu offer an opportunity to sample this establishment’s distinctive, drool-worthy fare...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20la%20Reinette%208%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Umā"
  />
);
