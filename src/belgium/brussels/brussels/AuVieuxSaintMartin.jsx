...
const AuVieuxSaintMartin = () => (
  <RestaurantPage
    restaurantName="Au Vieux Saint Martin"
    address="place du Grand Sablon 38, Brussels, 1000, Belgium"
    cuisine="Belgian"
    priceRange="€€€"
    phoneNumber="+3225126476"
    website="https://auvieuxsaintmartin.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20du%20Grand%20Sablon%2038%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Au Vieux Saint Martin"
  />
);

export default AuVieuxSaintMartin;
