...
const AuxArmesDeBruxelles = () => (
  <RestaurantPage
    restaurantName="Aux Armes de Bruxelles"
    address="rue des Bouchers 13, Brussels, 1000, Belgium"
    cuisine="Belgian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3225115550"
    website="https://auxarmesdebruxelles.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This institution in the heart of historic Brussels immerses you in the Ilot Sacré district. Its traditional brasserie décor dripping in Art nouveau character and the table service in period costume are a hit every time. The varied menu is a compendium of Belgian favourites: eels in sorrel sauce or veal kidneys in mustard, served with piping hot crunchy fries, and finishing with decadent crêpes Comédie française (Grand Marnier liqueur plus vanilla ice cream) – scrumptious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20des%20Bouchers%2013%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Aux Armes de Bruxelles"
  />
);

export default AuxArmesDeBruxelles;
