...
const Gioia = () => (
  <RestaurantPage
    restaurantName="Gioia"
    address="Rue Belliard 36, Brussels, 1040, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3226810328"
    website="https://gioia.kitchen"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although the sound of traffic may be somewhat deafening outside, venture into this swish restaurant done up in tasteful light colours, taking a seat on the exquisite rear terrace when the weather is fine. The homemade pasta is out of this world! Rich flavours, fresh ingredients and Italy’s renowned “simplicity” are the hallmarks of this establishment. A new spin on familiar family favourites...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Belliard%2036%2C%20Brussels%2C%201040%2C%20Belgium"
    pageTitle="Gioia"
  />
);

export default Gioia;
