...
const PalaisRoyalByDavidMartin = () => (
  <RestaurantPage
    restaurantName="Palais Royal by David Martin"
    address="Rue Royale 103, Brussels, 1000, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3225931001"
    website="https://palaisroyal.brussels/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As soon as the doorman ushers you into the luxurious Corinthia Hotel, you will be entranced by its period charm. The restored stained-glass dome of the Palm Court is truly magnificent, while the dining room immerses you in an exquisite Belle époque ambience. A marble fireplace and lovingly restored details set the scene in the spacious restaurant, which also offers privacy and intimacy. David Martin has trained a team that invites you to sample subtle creations enhanced by familiar Japanese flavours in a vibe that is both classy and casual. Whether it be endives paired with floral hibiscus flower or a fish cake underscored by a briny nori and mentaiko sauce, you can expect a culinary banquet that intelligently combines a few carefully chosen ingredients to create a genuine explosion of fla..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Royale%20103%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Palais Royal by David Martin"
  />
);

export default PalaisRoyalByDavidMartin;
