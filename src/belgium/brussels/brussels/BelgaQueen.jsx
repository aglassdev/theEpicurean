...
const BelgaQueen = () => (
  <RestaurantPage
    ...
    address="Rue du Fossé aux Loups 32, Brussels, 1000, Belgium"
    cuisine="Belgian, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3224555555"
    website="https://www.belgaqueenbrussels.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Following a superlative makeover, the Belga Queen, an iconic culinary landmark of Brussels, is ready to write a new chapter of its story. This majestic edifice, which started out as a bank in the 18C, is famous for its remarkable architecture, boasting dome-shaped windows and imposing columns. Brasserie classics rub shoulders with more up-to-the-minute dishes on the menu, while the seafood bar reflects the chef’s passion. His North Sea waterzooi is made with seabass and plaice, together with crunchy veggies, a subtle velvety fish soup and briny touches of mussels and shrimp. Finish your meal in style with a Brussels waffle, made from scratch on demand. The Belga Queen is back!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Foss%C3%A9%20aux%20Loups%2032%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Belga Queen"
  />
);

export default BelgaQueen;
