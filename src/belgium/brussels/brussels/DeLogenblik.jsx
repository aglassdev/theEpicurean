...
const DeLogenblik = () => (
  <RestaurantPage
    restaurantName="De l'Ogenblik"
    address="Galerie des Princes 1, Brussels, 1000, Belgium"
    cuisine="Classic Cuisine, Belgian"
    priceRange="€€"
    phoneNumber="+3225116151"
    website="https://ogenblik.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A loyal band of regulars add a warm, friendly vibe to this former café, which has lost none of its authentic charm since it first opened its doors back in 1969. Classical repertory, bistro dishes and a fine selection of seasonal suggestions...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Galerie%20des%20Princes%201%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="De l'Ogenblik"
  />
);

export default DeLogenblik;
