...
const BrasserieDeLaPatinoire = () => (
  <RestaurantPage
    restaurantName="Brasserie de la Patinoire"
    address="chemin du Gymnase 1, Brussels, 1000, Belgium"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+3226497002"
    website="https://www.brasseriedelapatinoire.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A grandiose Normandy-inspired edifice sets the scene for this characterful luxurious brasserie at the entrance to Bois de la Cambre, which can be admired from the spacious terrace. The chef favours nostalgic recipes, with the occasional more modern touch. A patriotic line-up of Belgian brasserie classics takes the limelight on the menu, including shrimp fritters, sole meunière and vol-au-vent. The shellfish bar, open all year round, is heaven for seafood lovers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chemin%20du%20Gymnase%201%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Brasserie de la Patinoire"
  />
);

export default BrasserieDeLaPatinoire;
