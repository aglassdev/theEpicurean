...
const OsteriaRomana = () => (
  <RestaurantPage
    ...
    address="Avenue Legrand 11, Brussels, 1000, Belgium"
    cuisine="Roman"
    priceRange="€€€"
    phoneNumber="+3226481395"
    website="https://www.osteriaromana.be"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20Legrand%2011%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Osteria Romana"
  />
);

export default OsteriaRomana;
