...
const LaVillaLorraineByYvesMattagne = () => (
  <RestaurantPage
    restaurantName="La Villa Lorraine by Yves Mattagne"
    address="Avenue du Vivier d'Oie 75, Brussels, 1000, Belgium"
    cuisine="Modern Cuisine, Classic Cuisine"
    priceRange="€€€€"
    phoneNumber="+3223743163"
    website="https://www.lavillalorraine.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The swish Villa Lorraine would be quite at home in London or Paris. This long-standing culinary beacon has kept up with the times, as is demonstrated by the trendy lounge interior which serves a range of dishes to share, often of Asian inspiration, such as crispy rice and a Belgian-style tartare of red tuna. It is a pleasure to watch the final touches being added to dishes on the eye-catching counter. The stylish restaurant, graced with a beautiful tree, is the epitome of luxurious urbanity and cutting-edge design.Exceptional produce like Burgaud duck, seabass and chicken from La Cour d’Armoise farm are crafted classically yet with a refreshing edge. Examples include a juicy chicken breast with aromatic black truffle, while a big-boned gravy, a subtle ravioli stuffed with mashed celeriac a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20du%20Vivier%20d'Oie%2075%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="La Villa Lorraine by Yves Mattagne"
  />
);

export default LaVillaLorraineByYvesMattagne;
