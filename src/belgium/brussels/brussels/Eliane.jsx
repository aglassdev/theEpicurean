...
const Eliane = () => (
  <RestaurantPage
    restaurantName="Eliane"
    address="Rue Saint-Laurent 36, Brussels, 1000, Belgium"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber=""
    website="https://www.elianerestaurant.be"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Kobe Desramaults is on a permanent quest for renewal. This maverick chef, who hit the headlines at In De Wulf and Chambre Séparée, has begun a new adventure in the heart of Brussels. Eliane, which is named after his grandmother, exudes a smart lounge vibe. From the swish service and made-to-measure skillets to the open kitchen counter and funky soundtrack, chef Desramaults has fine-tuned every detail of his establishment.The food showcases Kobe’s creative streak and virtuoso technique. You can expect a festival of big-boned appetisers and dishes, in which he aims to highlight the essence and purity of the often-local ingredient. Examples include a velvety risotto enriched in vin jaune and flanked by briny oysters or a magnificent red mullet cooked on a binchotan and paired with a punchy st..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Saint-Laurent%2036%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="Eliane"
  />
);

export default Eliane;
