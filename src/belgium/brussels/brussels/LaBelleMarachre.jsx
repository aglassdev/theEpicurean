...
const LaBelleMarachre = () => (
  <RestaurantPage
    restaurantName="La Belle Maraîchère"
    address="place Sainte-Catherine 11a, Brussels, 1000, Belgium"
    cuisine="Seafood, Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3225129759"
    website="https://www.labellemaraichere.com/en/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Depuis 1973, les gourmets apprécient ce restaurant traditionnel où la famille Devreker choie ses hôtes. On y redécouvre le temps où Sainte Catherine était le quartier le plus prisé de Bruxelles pour les restaurants. Croquettes de crevettes, homard, gibier, sauces intenses et bien d’autres plats y sont préparés dans les règles de l’art. Pas de chichis, mais une cuisine chaleureuse et savoureuse...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=place%20Sainte-Catherine%2011a%2C%20Brussels%2C%201000%2C%20Belgium"
    pageTitle="La Belle Maraîchère"
  />
);

export default LaBelleMarachre;
