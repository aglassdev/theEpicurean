...
const AtelierMaple = () => (
  <RestaurantPage
    restaurantName="Atelier Maple"
    address="Karel De Preterlei 210, Borgerhout, 2140, Belgium"
    cuisine="Creative, Farm to table"
    priceRange="€€€€"
    phoneNumber="+3232958090"
    website="https://ateliermaple.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Authentic details, such as a stunning glazed dome, and a plush, yet cosy ambience depict this stylish Art nouveau edifice. Chef Tynes crafts cosmopolitan fare, adding his own spin to pedigree French dishes, thanks in particular to Asian and Indonesian influences. Splendid terrace...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Karel%20De%20Preterlei%20210%2C%20Borgerhout%2C%202140%2C%20Belgium"
    pageTitle="Atelier Maple"
  />
);

export default AtelierMaple;
