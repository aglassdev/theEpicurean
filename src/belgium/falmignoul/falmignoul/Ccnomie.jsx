...
const Ccnomie = () => (
  <RestaurantPage
    restaurantName="CCnomie"
    address="rue Haute 38, Falmignoul, 5500, Belgium"
    cuisine="Country cooking, Farm to table"
    priceRange="€€"
    phoneNumber="+3282222495"
    website="https://www.ccnomie.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="David Coisman seeks to add his signature originality and generosity to regional produce. Rather than gimmicky combinations, he woos us with consummate skill and familiar flavours, adding a fresh twist to pheasant or steak with shallots thanks to inventive side dishes. One thing is certain: a visit to this restaurant, established in a restored 1800 barn on the family farm is synonymous with a festival of flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Haute%2038%2C%20Falmignoul%2C%205500%2C%20Belgium"
    pageTitle="CCnomie"
  />
);

export default Ccnomie;
