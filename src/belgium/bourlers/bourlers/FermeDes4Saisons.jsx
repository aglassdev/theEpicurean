...
const FermeDes4Saisons = () => (
  <RestaurantPage
    restaurantName="Ferme des 4 saisons"
    address="rue de Scourmont 8b, Bourlers, 6464, Belgium"
    cuisine="Traditional Cuisine, Modern French"
    priceRange="€€"
    phoneNumber="+3260214246"
    website="https://ferme4saisons.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A menu rich in exemplary classical dishes and first - class brasserie fare will set your taste buds tingling, an inspired, innovative chef and an authentic, jazzed up interior combining contemporary and rustic details. Franck and Cathy have breathed new life and vitality into their parents’ brasserie!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20Scourmont%208b%2C%20Bourlers%2C%206464%2C%20Belgium"
    pageTitle="Ferme des 4 saisons"
  />
);

export default FermeDes4Saisons;
