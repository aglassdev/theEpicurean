...
const JeuxDeGots = () => (
  <RestaurantPage
    restaurantName="Jeux de Goûts"
    address="Rue de Bohan 91, Orchimont, 5550, Belgium"
    cuisine="Seasonal Cuisine, Country cooking"
    priceRange="€€"
    phoneNumber="+3261415095"
    website="https://jeuxdegouts.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Fanny and Jérôme bend over backwards to nurture the warm cosy vibe of their establishment, which also offers a few convenient guestrooms. Fanny’s indefectible good cheer and Jérôme’s infectious enthusiasm in his open kitchen set the stage for this culinary performance. The chef shines the spotlight on regional and local producers, with a weakness for veggies. He adds a modern twist to recipes that pay tribute to the region’s traditions and generous character. For example, he might pair slowly cooked lobster with cucumber perfumed in sesame seeds, a buttery sauce of subtle wasabi nuances and a powerful lobster bisque. Unbeatable value for money...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20Bohan%2091%2C%20Orchimont%2C%205550%2C%20Belgium"
    pageTitle="Jeux de Goûts"
  />
);

export default JeuxDeGots;
