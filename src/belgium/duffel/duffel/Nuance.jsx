...
const Nuance = () => (
  <RestaurantPage
    restaurantName="Nuance"
    address="Kiliaanstraat 8, Duffel, 2570, Belgium"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+3215634265"
    website="https://resto-nuance.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Thierry Theys’ cuisine is the pinnacle of “nuanced”. Despite his youth, he has already made a name for himself on the Belgian fine dining scene and owes his reputation to highly individual recipes. Right from the first bite, he unveils his high-flying precision and technical craftsmanship. Not afraid of challenges, each dish is rich in emotion. For example, he may prepare North Sea crab with finger lime, avocado and a subtle sweet-sour flavoured stem lettuce. He may enhance suckling veal, simply grilled, with a barigoule sauce and a gravy jazzed up by kimchi. This chef knows how to nurture and draw out the distinctive character and tiniest details of outstanding ingredients. Suave, delicate food that suits our modern tastebuds. The mind-blowing experience is further enhanced by a fantastic..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kiliaanstraat%208%2C%20Duffel%2C%202570%2C%20Belgium"
    pageTitle="Nuance"
  />
);
