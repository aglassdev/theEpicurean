...
const CadreCulinaire = () => (
  <RestaurantPage
    restaurantName="Cadre Culinaire"
    address="rue des Rôtisseurs 4, Huy, 4500, Belgium"
    cuisine="Modern French"
    priceRange="€€"
    phoneNumber="+3285255525"
    website="https://www.cadre-culinaire.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In addition to hailing from Alsace, Grégory Baruthio avows a passion for pastries, as you will soon realise, and his Gugelhupf is truly second to none! Ever enthusiastic, the chef dons his apron to enhance ingredients that suit the modern palate without losing sight of high-precision cooking and traditional generosity. A welcoming establishment with eater friendly prices...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20des%20R%C3%B4tisseurs%204%2C%20Huy%2C%204500%2C%20Belgium"
    pageTitle="Cadre Culinaire"
  />
);

export default CadreCulinaire;
