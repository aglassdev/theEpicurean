...
const AFoodAffair = () => (
  <RestaurantPage
    restaurantName="a food affair"
    address="Hoogstraat 58, Gent, 9000, Belgium"
    cuisine="Asian"
    priceRange="€€€"
    phoneNumber="+3292241805"
    website="https://www.afoodaffair.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As soon as you set foot in this eatery of oriental inspiration, you will feel the serene vibe, further enhanced by the exquisite terrace to the rear. Chef Locquet shares his passion for Thailand and Vietnam. Traditional recipes made with first-class ingredients and dishes that shout the talent and deft touch of their chef. An Asian excursion steeped in subtlety and enthusiasm...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hoogstraat%2058%2C%20Gent%2C%209000%2C%20Belgium"
    pageTitle="a food affair"
  />
);

export default AFoodAffair;
