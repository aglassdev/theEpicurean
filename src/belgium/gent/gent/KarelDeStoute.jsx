...
const KarelDeStoute = () => (
  <RestaurantPage
    restaurantName="Karel De Stoute"
    address="Vrouwebroerstraat 2, Gent, 9000, Belgium"
    cuisine="Modern French, Farm to table"
    priceRange="€€€"
    phoneNumber="+3292241735"
    website="https://restkareldestoute.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Karel De Stoute is steeped in character, as you will see from the elegant décor of this edifice in the heart of the Patershol district, but also in the plate. Your charming hostess, Lien, is proud to present the menu of creative chef Thomas, who is as attentive to the flavour of his food as to its presentation. Fascinating, cheerful and delicious...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vrouwebroerstraat%202%2C%20Gent%2C%209000%2C%20Belgium"
    pageTitle="Karel De Stoute"
  />
);

export default KarelDeStoute;
