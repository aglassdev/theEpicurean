...
const LysDor = () => (
  <RestaurantPage
    restaurantName="Lys d'Or"
    address="Charles de Kerchovelaan 81, Gent, 9000, Belgium"
    cuisine="French, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3294301130"
    website="https://lysdor.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Black marble, a blue and gold colour scheme and a grand piano set the scene in this stylish, modern venue, providing the perfect foil to the elegant, classical cuisine by chef Wattenberge. The purity of the produce is enhanced by consummate technique. Star ingredients include turbot, sole from the North Sea and pigeon from Anjou...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Charles%20de%20Kerchovelaan%2081%2C%20Gent%2C%209000%2C%20Belgium"
    pageTitle="Lys d'Or"
  />
);

export default LysDor;
