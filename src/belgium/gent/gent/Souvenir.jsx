...
const Souvenir = () => (
  <RestaurantPage
    restaurantName="Souvenir"
    address="Brabantdam 134, Gent, 9000, Belgium"
    cuisine="Creative, Organic"
    priceRange="€€€"
    phoneNumber="+3293356073"
    website="https://souvenir.gent/"
    tags={[{ name: "Green Star" }]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Vilhjalmur Sigurdarson’s relationship with nature is highly personal and his cooking is inspired by the seasons: bountiful in summer, earthy in winter. Sustainable before all else, his producers have become friends and the chef crafts their ingredients with passion. Veggies take the limelight, with the occasional fish from the North Sea. His creativity seems to know no bounds and while each dish highlights only a few ingredients, their intensity speaks volumes for his consummate, often off-kilter technique. Whether fermented, smoked, marinaded or grilled, veg takes on a whole new dimension, flanked by exquisite sauces. We tasted a cabbage sauce underscored with spicy sorrel and tarragon notes that added a sensual dimension to the different textures and varieties of cabbage, illustrating th..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brabantdam%20134%2C%20Gent%2C%209000%2C%20Belgium"
    pageTitle="Souvenir"
  />
);
