...
const LaBrasserieDeLaGare = () => (
  <RestaurantPage
    restaurantName="La Brasserie de la Gare"
    address="chaussée de Gand 1430, Berchem-Sainte-Agathe, 1082, Belgium"
    cuisine="Belgian, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3224691009"
    website="https://www.brasseriedelagare.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="To get a real taste of authentic Brussels, head for this historic café, whose pores ooze vintage charm with a bustling, almost boisterous brouhaha to match. The chef pays tribute to tradition with a patriotic line-up of no-nonsense Belgian classics, such as shrimp fritters, steak and fries and dame blanche (vanilla ice cream and hot chocolate sauce). The Brasserie de la Gare provides conclusive evidence that some things never change!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Gand%201430%2C%20Berchem-Sainte-Agathe%2C%201082%2C%20Belgium"
    pageTitle="La Brasserie de la Gare"
  />
);

export default LaBrasserieDeLaGare;
