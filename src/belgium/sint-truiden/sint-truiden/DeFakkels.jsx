...
const DeFakkels = () => (
  <RestaurantPage
    restaurantName="De Fakkels"
    address="Hasseltsesteenweg 61, Sint-Truiden, 3800, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3211687634"
    website="https://www.defakkels.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Seppe Bleus and Liese Bams have taken over the business and welcome you to De Fakkels 2.0. They have kept its soul intact, so the imposing building still exudes warmth and a sense of romance. Goose feather lampshades, designer lighting and wooden ornaments make for a unique setting. In a bid to keep up with the times, the menu features exciting new combinations, such as the bright and zesty interplay of calamansi and orange with ultra-fresh scallops. The depth of his sauces, like the rich game sauce that graces the venison fillet, is testament to the chef's culinary mastery. This long-established haven for foodies is in good hands...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hasseltsesteenweg%2061%2C%20Sint-Truiden%2C%203800%2C%20Belgium"
    pageTitle="De Fakkels"
  />
);

export default DeFakkels;
