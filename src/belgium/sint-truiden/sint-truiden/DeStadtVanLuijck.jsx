...
const DeStadtVanLuijck = () => (
  <RestaurantPage
    restaurantName="De Stadt van Luijck"
    address="Schepen Dejonghstraat 12, Sint-Truiden, 3800, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3211190969"
    website="https://www.destadtvanluijck.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A meal in this former solicitor’s home oozing in character will be one to remember. The stylish interior, which sports a refined Renaissance slant, and the garden are a treat for the eye. Your tastebuds will be pampered by chef Warren Vandevelde who demonstrates just how much his carefully crafted cuisine is in line with the zeitgeist. The chef works tirelessly to create surprising associations, constantly adding new twists to familiar flavours. For example, he may pair a tartare of warm langoustine with a tomato coulis, a langoustine bisque and sea lavender oil. The lunchtime menu is not be missed!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Schepen%20Dejonghstraat%2012%2C%20Sint-Truiden%2C%203800%2C%20Belgium"
    pageTitle="De Stadt van Luijck"
  />
);

export default DeStadtVanLuijck;
