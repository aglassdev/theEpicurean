...
const LangeloRosso = () => (
  <RestaurantPage
    restaurantName="L'Angelo Rosso"
    address="Brustem-Dorp 154, Sint-Truiden, 3800, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+3211591600"
    website="https://www.angelorosso.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Welcome to the lair of the Catania family. Filippo welcomes patrons to a smart restaurant flanked by a lovely garden terrace. Chef Roberta, his partner, conjures up a feast of pedigree Italian classics with a modern spin. She has a preference for simplicity, creating intense flavours steeped in Mediterranean exuberance, illustrated by taglioni al dente served with a peppery velvet parmesan sauce, crispy pancetta, a 63° boiled egg and a lavish grating of truffle. You may be interested to know that sgroppino sorbet (vodka, prosecco and lemon) is served before the main course. As for the titbits served with coffee – they are truly squisito!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Brustem-Dorp%20154%2C%20Sint-Truiden%2C%203800%2C%20Belgium"
    pageTitle="L'Angelo Rosso"
  />
);

export default LangeloRosso;
