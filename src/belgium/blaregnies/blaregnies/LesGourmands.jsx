...
const LesGourmands = () => (
  <RestaurantPage
    restaurantName="Les Gourmands"
    address="rue de Sars 15, Blaregnies, 7040, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3265568632"
    website="https://www.les-gourmands.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Les Gourmands is run by foodies for foodies. The charming authentic interior is ideally suited to the classical fare of Didier Bernard, assisted by Lydia Glacé, who is in charge of the decadent desserts. The gifted duo, who were awarded their first Michelin star in 1996, are committed body and soul to celebrating premium produce. You may taste Burgaud duck, respectfully and delicately cooked to medium rare, flanked by a spicy duck gravy that is divinely paired with orange marmalade or a big-boned duck shepherd’s pie oozing with buttery flavours. Les Gourmands excels in the art of adding a contemporary spin to time-honoured recipes and remains scrupulously faithful to old school technique, while catering to today’s palates and slipping in the odd Mediterranean nuance from time to time. This..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20Sars%2015%2C%20Blaregnies%2C%207040%2C%20Belgium"
    pageTitle="Les Gourmands"
  />
);

export default LesGourmands;
