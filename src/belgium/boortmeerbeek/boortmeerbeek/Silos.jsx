...
const Silos = () => (
  <RestaurantPage
    restaurantName="Silo's"
    address="Leuvensesteenweg 350, Boortmeerbeek, 3190, Belgium"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+3215511111"
    website="https://silos.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Silo’s is breathing life into the annex of the former malt house of Boortmeerbeek. The slick, well-oiled operations of this trendy luxury brasserie work like clockwork, seamlessly catering to large numbers of diners. The food is equally spot on, featuring updated versions of brasserie classics such as bouillabaisse and Clamart pigeon steeped in knockout flavours. Generous, voluntarily unfussy recipes that hit the nail on the head every time. The extensive menu and wine list, (including wines by the glass), ensures that there is something to tickle everyone’s fancy!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Leuvensesteenweg%20350%2C%20Boortmeerbeek%2C%203190%2C%20Belgium"
    pageTitle="Silo's"
  />
);
