...
const LeRoannay = () => (
  <RestaurantPage
    restaurantName="Le Roannay"
    address="Rue de Spa 155, Francorchamps, 4970, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3287275311"
    website="https://roannay.be"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The iconic Le Roannay Hotel has been treated to a top-to-toe revamp. The guestrooms, wellness facilities and restaurant are now the picture of stylish contemporary luxury. The exquisite bar is located in a historic barn beneath timber rafters and the heliport is open for business again. The food demonstrates inherent respect for the past with a modern twist.Talented Matthieu Vande Velde is blossoming under the guidance of master chef David Martin. Strewn with Asian notes, Matthieu’s creativity is perfectly paired with familiar family favourites. He exalts the ingredient, thanks to lashings of high-precision technique, resulting in dishes such as melt-in-the-mouth Anjou pigeon with generously seasoned thighs and a creamy sauce made from the intestines. Vande Velde’s flair and knack for sauc..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20de%20Spa%20155%2C%20Francorchamps%2C%204970%2C%20Belgium"
    pageTitle="Le Roannay"
  />
);

export default LeRoannay;
