...
const AuxPetitsOignons = () => (
  <RestaurantPage
    restaurantName="Aux petits oignons"
    address="chaussée de Tirlemont 260, Jodoigne, 1370, Belgium"
    cuisine="Modern French, French"
    priceRange="€€€"
    phoneNumber="+3210760078"
    website="https://www.auxpetitsoignons.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Every detail of Stéphane Lefebvre’s aptly named establishment has been endlessly fine-tuned, as the top-to-toe renovation demonstrates. Brightly welcoming, the contemporary interior mingles Scandinavian influences with discreet nods to the Seventies. The attentive table service and cosy vibe instantly make you feel at home. Chef Lefebvre has harnessed his creative talent in a bid to celebrate flavour and ingeniously balances a dish’s bitterness or acidity with a few well-judged side dishes. His attention to detail shines the spotlight on outstanding ingredients such as Piétrain pork and Ardennes game. He might pair immaculately cooked scallops with sweet parsnips, subtly smoky eel and an exquisite drizzle of watercress, without forgetting the final flourish of tartare of smoked scallops, a..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Tirlemont%20260%2C%20Jodoigne%2C%201370%2C%20Belgium"
    pageTitle="Aux petits oignons"
  />
);

export default AuxPetitsOignons;
