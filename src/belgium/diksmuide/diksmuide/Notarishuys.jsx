...
const Notarishuys = () => (
  <RestaurantPage
    restaurantName="Notarishuys"
    address="Koning Albertstraat 39, Diksmuide, 8600, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3251500335"
    website="https://www.notarishuys.be/nl/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This former solicitor’s house is ideally located to explore the Westhoek region. You will stay in comfortable rooms, eat in a romantic restaurant and admire the venerable copper beech tree from the pretty patio in the garden. Chef Boussemaere blends tradition and modernity, turning out dishes whose rich familiar flavours are also a masterclass in culinary subtlety...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Koning%20Albertstraat%2039%2C%20Diksmuide%2C%208600%2C%20Belgium"
    pageTitle="Notarishuys"
  />
);

export default Notarishuys;
