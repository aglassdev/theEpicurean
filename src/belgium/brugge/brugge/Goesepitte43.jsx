...
const Goesepitte43 = () => (
  <RestaurantPage
    restaurantName="Goesepitte 43"
    address="Goezeputstraat 43, Brugge, 8000, Belgium"
    cuisine="Farm to table, Modern French"
    priceRange="€€€"
    phoneNumber="+3250660223"
    website="https://www.goesepitte43.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Step into the picturesque Goezeputstraat 43 and be transported to a jungle paradise, complete with a living moss wall and monkeys! Chef Jan Supply likes to come to the table in person to serve his dishes. These are characterised by a deft use of the Mibrasa charcoal oven, rich sauces and intriguing vegetable creations. This is bistronomy with that little bit extra, as evidenced by the hand-whipped lobster béarnaise that elevates smoky filet pur to new heights. Be sure to try the crêpe normande, a house classic...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Goezeputstraat%2043%2C%20Brugge%2C%208000%2C%20Belgium"
    pageTitle="Goesepitte 43"
  />
);

export default Goesepitte43;
