...
const Tougou = () => (
  <RestaurantPage
    restaurantName="Tou.Gou"
    address="Smedenstraat 47, Brugge, 8000, Belgium"
    cuisine="Farm to table, Creative French"
    priceRange="€€"
    phoneNumber="+3250705802"
    website="https://www.tougou.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Thibault and Jade’s establishment is a treasure trove of culinary delights. In their tastefully appointed HQ, kick off with wholesome starters like pâté en croûte or marbled ham, before continuing with flawlessly fresh brill paired with a tangy nantaise sauce and briny clams, unless you wouldn’t prefer pheasant à la brabançonne. The veteran chef, a true disciple of text-book Gallic fare, nonetheless enjoys adding the odd international twist. Big-boned flavours, hearty helpings, culinary proficiency. A seat at the counter is highly recommended as are bookings. They also offer a take-away catering service with a selection of dishes to be enjoyed at home - must be booked in advance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Smedenstraat%2047%2C%20Brugge%2C%208000%2C%20Belgium"
    pageTitle="Tou.Gou"
  />
);

export default Tougou;
