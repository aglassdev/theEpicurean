...
const ZetjoeByGeertVanHecke = () => (
  <RestaurantPage
    restaurantName="Zet'Joe by Geert Van Hecke"
    address="Langestraat 11, Brugge, 8000, Belgium"
    cuisine="Creative French"
    priceRange="€€€€"
    phoneNumber="+3250338259"
    website="https://www.zetjoe.be"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Geert Van Hecke, who boasted three Michelin stars for twenty years at the Karmeliet, is definitely worthy of the title “Godfather of Belgian gastronomy”. Zet’Joe is more casual and a little bit like walking into the chef’s home. A warm interior and an impressive art collection instantly set the scene. Mireille, his delightful partner in the dining room, wields the cheese trolley with impressive dexterity. Van Hecke harnesses his consummate knowhow and sensitivity to enhancing first-rate ingredients. A silky last-minute béarnaise sauce, made with carrot and orange jus, coaxes out the full flavour of lightly seared scallops, further flanked by an awesome millefeuille of aniseed-flavoured earthy veggies. The chef effortlessly deploys his culinary wizardry and insights in a truly classy act. I..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Langestraat%2011%2C%20Brugge%2C%208000%2C%20Belgium"
    pageTitle="Zet'Joe by Geert Van Hecke"
  />
);

export default ZetjoeByGeertVanHecke;
