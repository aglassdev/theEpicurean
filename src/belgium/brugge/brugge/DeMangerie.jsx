...
const DeMangerie = () => (
  <RestaurantPage
    restaurantName="De Mangerie"
    address="Oude Burg 20, Brugge, 8000, Belgium"
    cuisine="World Cuisine"
    priceRange="€€€"
    phoneNumber="+3250339336"
    website="https://www.mangerie.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Kristof Deprez is keen to share his love of Asia. As soon as you venture over the threshold of the Mangerie, it feels like you are on holiday. The chef rustles up local Belgian dishes with oriental influences, creating a finely balanced, tempting menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Oude%20Burg%2020%2C%20Brugge%2C%208000%2C%20Belgium"
    pageTitle="De Mangerie"
  />
);

export default DeMangerie;
