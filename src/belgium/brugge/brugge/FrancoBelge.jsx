...
const FrancoBelge = () => (
  <RestaurantPage
    restaurantName="Franco Belge"
    address="Langestraat 109, Brugge, 8000, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3250695648"
    website="https://restaurantfrancobelge.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The trendy, cutting-edge establishment of Tomas Puype is a culinary treasure trove, enhanced by an alfresco dining space to the rear and a theatrically visible kitchen, where you can see the ingredients respectfully, generously and traditionally curated. The chef is a genuine craftsman with a keen eye for detail and a love of vegetables. Succulent breast of guinea fowl with crispy skin is served with al dente green asparagus, morel mushrooms and a subtle jus of guinea fowl and tarragon. Highly popular at lunchtime...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Langestraat%20109%2C%20Brugge%2C%208000%2C%20Belgium"
    pageTitle="Franco Belge"
  />
);

export default FrancoBelge;
