...
const CtPrfr = () => (
  <RestaurantPage
    restaurantName="Côté Préféré"
    address="Dorpsstraat 47, Jabbeke, 8490, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3250685695"
    website="https://coteprefere.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A delicious slab of turbot cooked on the bone with a beurre noisette, al dente asparagus and a creamy morel sauce. Such are some of Tim Versyck’s emblematic recipes. The ingredient rules in his mainly classical repertory, albeit with the occasional international spin. The chef sources his produce locally, particularly fish from the North Sea and veggies, meat and poultry from the polders of West Flanders. The bright contemporary interior aims to pay tribute to the earthy, wholesome terroir of Flanders...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dorpsstraat%2047%2C%20Jabbeke%2C%208490%2C%20Belgium"
    pageTitle="Côté Préféré"
  />
);

export default CtPrfr;
