...
const ColonelLouise = () => (
  <RestaurantPage
    restaurantName="Colonel Louise"
    address="rue Jean Stas 24, Saint-Gilles, 1060, Belgium"
    cuisine="Meats and Grills, Modern French"
    priceRange="€€€"
    phoneNumber="+3225385736"
    website="https://www.colonelbrussels.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Red meat lovers fall head over heels with this swish brasserie on a street corner near Avenue Louise. As soon as you cross the threshold, you are struck by the array of cured meats on the counter. You must then decide whether you want Aubrac, Wagyu or Holstein beef, before you dig into impeccably cooked steak flanked by fresh sauces and fries cooked in beef tallow as tradition demands. The menu also features a host of other delicacies ranging from bone marrow to vitello tonnato and crispy sweetbread. Perfect for a single dish, lunch or a full-blown dinner – what’s not to like?..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Jean%20Stas%2024%2C%20Saint-Gilles%2C%201060%2C%20Belgium"
    pageTitle="Colonel Louise"
  />
);

export default ColonelLouise;
