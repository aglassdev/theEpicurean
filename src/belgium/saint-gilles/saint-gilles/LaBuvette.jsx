...
const LaBuvette = () => (
  <RestaurantPage
    restaurantName="La Buvette"
    address="chaussée d'Alsemberg 108, Saint-Gilles, 1060, Belgium"
    cuisine="Modern Cuisine, Organic"
    priceRange="€€€"
    phoneNumber="+3225341303"
    website="https://la-buvette.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="We wager that this restaurant will quickly become your favourite watering hole. The vintage interior of this former butcher’s shop oozes character and appeal, further enhanced by reasonably priced bistronomic fare. The single set menu overflows with elegant sauces and creative flair...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20d'Alsemberg%20108%2C%20Saint-Gilles%2C%201060%2C%20Belgium"
    pageTitle="La Buvette"
  />
);

export default LaBuvette;
