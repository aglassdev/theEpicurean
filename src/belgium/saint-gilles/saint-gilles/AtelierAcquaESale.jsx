...
const AtelierAcquaESale = () => (
  <RestaurantPage
    restaurantName="Atelier Acqua e Sale"
    address="Rue Defacqz 86, Saint-Gilles, 1060, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+3224254666"
    website="https://www.atelieracquaesale.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The younger sibling of Dolce Amaro is a friendly eatery overflowing in authentic Italian hospitality. The opposite of fussy and pretentious, the food is fresh, hits the spot every time and is served generously. Vitello tonnato de paccheri al ragu to start, followed by a lovingly and patiently simmered ossobuco, finishing with a semifreddo… The pinnacle of Italian simplicity!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20Defacqz%2086%2C%20Saint-Gilles%2C%201060%2C%20Belgium"
    pageTitle="Atelier Acqua e Sale"
  />
);

export default AtelierAcquaESale;
