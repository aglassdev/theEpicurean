...
const DolceAmaro = () => (
  <RestaurantPage
    restaurantName="Dolce Amaro"
    address="chaussée de Charleroi 115, Saint-Gilles, 1060, Belgium"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+3225381700"
    website="https://www.dolceamaro.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Charleroi%20115%2C%20Saint-Gilles%2C%201060%2C%20Belgium"
    pageTitle="Dolce Amaro"
  />
);

export default DolceAmaro;
