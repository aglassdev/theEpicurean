...
const LaRoseraie = () => (
  <RestaurantPage
    restaurantName="La Roseraie"
    address="route de Limet 80, Modave, 4577, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3285411360"
    website="https://www.laroseraiemodave.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A meal at La Roseraie is synonymous with a treat for all five senses. The experience starts with the drive through the lovely Ardennes countryside to this handsome 19C edifice, followed by the vision of the landscaped garden, home to welcoming guestrooms and pretty cottages, the champagne bar and the elegant restaurant, depicted by an exquisite blend of luxury details and home-from-home hospitality. Marie Trignon has respectfully and masterfully taken over the reins from her father.You can expect a classical culinary repertory, flanked by a flair for sourcing the best ingredients, without forgetting a passion for spices and a creative streak rich in delicacy. Chef Trignon enhances a fillet of red mullet with a curcuma-flavoured tabouleh, a tomato salad rich in refreshing hints of coriander..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=route%20de%20Limet%2080%2C%20Modave%2C%204577%2C%20Belgium"
    pageTitle="La Roseraie"
  />
);

export default LaRoseraie;
