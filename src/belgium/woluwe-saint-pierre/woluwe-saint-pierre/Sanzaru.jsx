...
const Sanzaru = () => (
  <RestaurantPage
    restaurantName="Sanzaru"
    address="avenue de Tervueren 292, Woluwe-Saint-Pierre, 1150, Belgium"
    cuisine="Modern Cuisine, Farm to table"
    priceRange="€€€"
    phoneNumber="+3227730080"
    website="https://www.sanzaru.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Behind the Cubist-inspired façade lies a pleasant establishment adorned in colourful murals, which provides the perfect setting to sample modern cuisine of Japanese and Peruvian inspiration. This whirlwind of subtle flavours, alternating between spicy and acidic, is combined harmoniously. Don’t miss the Mizaru cocktail bar upstairs...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20de%20Tervueren%20292%2C%20Woluwe-Saint-Pierre%2C%201150%2C%20Belgium"
    pageTitle="Sanzaru"
  />
);

export default Sanzaru;
