...
const BistroBerto = () => (
  <RestaurantPage
    restaurantName="Bistro Berto"
    address="Zuiderlaan 17, Waregem, 8790, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3256922221"
    website="https://www.bistroberto.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zuiderlaan%2017%2C%20Waregem%2C%208790%2C%20Belgium"
    pageTitle="Bistro Berto"
  />
);

export default BistroBerto;
