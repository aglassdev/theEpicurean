...
const Bachtekerke = () => (
  <RestaurantPage
    restaurantName="Bachtekerke"
    address="Bachtekerkestraat 9, Bachte-Maria-Leerne, 9800, Belgium"
    cuisine="Modern French, Farm to table"
    priceRange="€€€"
    phoneNumber="+3292735300"
    website="https://www.bachtekerke.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Bachtekerke is undeniably smart, but its pride and joy is its fantastic summer terrace on the banks of the Leie, protected by large parasols and enclosed by drift wood fencing – you will almost feel like you are on an island! The chef has no equal for generous cuisine, rich in flavour and variety. A hit with foodies of all sorts...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bachtekerkestraat%209%2C%20Bachte-Maria-Leerne%2C%209800%2C%20Belgium"
    pageTitle="Bachtekerke"
  />
);

export default Bachtekerke;
