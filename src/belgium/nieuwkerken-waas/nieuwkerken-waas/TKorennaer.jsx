...
const TKorennaer = () => (
  <RestaurantPage
    restaurantName="'t Korennaer"
    address="Nieuwkerkenstraat 4, Nieuwkerken-Waas, 9100, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3237780845"
    website="https://www.korennaer.be/nl/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="(Temporarily closed. Pop-up in Boutique Hotel Azur at De Haan) Edwin Van Goethem is always on the move. Since the opening of 't Korennaer in 1997, he has continued to evolve. With a sure hand, he enriches his cuisine with subtle international influences. These range from Japanese seasonings to elements of North African culinary tradition. Thanks to trusted suppliers such as butcher Hendrik Dierendonck and asparagus grower Els Vercauteren, top-notch ingredient quality is guaranteed. The chef lets the natural flavours take centre stage in dishes that are very much on trend. First-rate produce such as hop shoots and wagyu meat are elevated with rich sauces, exotic condiments and garnishes that keep diners on their toes. He serves venison fillet, for example, with a fabulous sauce based on sea..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nieuwkerkenstraat%204%2C%20Nieuwkerken-Waas%2C%209100%2C%20Belgium"
    pageTitle="'t Korennaer"
  />
);

export default TKorennaer;
