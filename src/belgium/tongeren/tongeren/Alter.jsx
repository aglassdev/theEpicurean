...
const Alter = () => (
  <RestaurantPage
    restaurantName="Alter"
    address="Bilzersteenweg 366, Tongeren, 3700, Belgium"
    cuisine="Creative"
    priceRange="€€€€"
    ...
    bio="Alter means “different” or “other”, which illustrates Jo Grootaers’ career. He was just 19 when he became the chef of the Altermezzo brasserie, gradually forging his own culinary signature to the point of being awarded a Michelin star. Today he and his partner, Lana in charge of the front-of-house, are at the helm of this restaurant, established in the former village school, which has been treated to a hip, designer makeover. The couple’s shared passion can be tasted in the fine wines and remarkably delicate, creative cuisine. The chef’s attention to detail and genuine passion for the ingredient are particularly notable in the exquisite plating. For example, raw langoustine is presented in a tartlet with wafer-thin slices of pumpkin, a subtle bitter crème of mandarin, a drizzle of verbena ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bilzersteenweg%20366%2C%20Tongeren%2C%203700%2C%20Belgium"
    pageTitle="Alter"
  />
);
