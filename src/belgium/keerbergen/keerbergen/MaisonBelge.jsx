...
const MaisonBelge = () => (
  <RestaurantPage
    restaurantName="Maison Belge"
    address="Haachtsebaan 150, Keerbergen, 3140, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3215681067"
    website="https://www.maisonbelge.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A subtle sprinkling of vintage details lends this modern brasserie a pleasant homely feel; the terrace is delightful. The chef specialises in traditional, Belgian in particular, classics, to which she adds her own light, fresh hallmark signature...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Haachtsebaan%20150%2C%20Keerbergen%2C%203140%2C%20Belgium"
    pageTitle="Maison Belge"
  />
);

export default MaisonBelge;
