...
const YokaTomo = () => (
  <RestaurantPage
    restaurantName="Yoka Tomo"
    address="Avenue Félix Marchal 28, Schaerbeek, 1030, Belgium"
    cuisine="Japanese"
    priceRange="€€"
    phoneNumber="+32475409960"
    website="https://yokatomo.brussels"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A friendly restaurant in a residential neighbourhood with limited seating and a chef who crafts dishes from Southern Japan in his open-plan kitchen. Rather than decadent ingredients, you can expect authentic craftsmanship and seasonings that stimulate the tastebuds. Crispy chicken with a sweet-sour sauce is paired with crunchy vegetables and a rémoulade sauce in a tasty, almost addictive dish. Tomoyuki Ohara has no qualms about surprising us, whilst religiously respecting Japanese culinary traditions. Truly irresistible!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenue%20F%C3%A9lix%20Marchal%2028%2C%20Schaerbeek%2C%201030%2C%20Belgium"
    pageTitle="Yoka Tomo"
  />
);

export default YokaTomo;
