...
const Dafspanning = () => (
  <RestaurantPage
    restaurantName="d'Afspanning"
    address="Bloemendalestraat 2, Beernem, 8730, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+3250683887"
    website="https://www.afspanning.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bloemendalestraat%202%2C%20Beernem%2C%208730%2C%20Belgium"
    pageTitle="d'Afspanning"
  />
);

export default Dafspanning;
