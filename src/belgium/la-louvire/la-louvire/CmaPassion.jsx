...
const CmaPassion = () => (
  <RestaurantPage
    restaurantName="Céma Passion"
    address="avenue Gambetta 63, La Louvière, 7100, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3264663826"
    website="https://www.cemapassion.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu features modern French cuisine, which is rich in enthusiasm and sophistication. Seasonal produce takes pride of place on the inventive menu. A genuine culinary experience...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20Gambetta%2063%2C%20La%20Louvi%C3%A8re%2C%207100%2C%20Belgium"
    pageTitle="Céma Passion"
  />
);

export default CmaPassion;
