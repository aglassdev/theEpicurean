...
const LeConfessionnal = () => (
  <RestaurantPage
    restaurantName="Le Confessionnal"
    address="rue Rémy Himmer 4, Dinant, 5500, Belgium"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+3282224522"
    website="https://www.leconfessionnal.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Opposite Leffe Abbey, this nostalgic neighbourhood bolthole provides a showcase for the owner’s passion for flea markets. Red and white checked tablecloths, decorative soup tureens and silverware set the friendly scene. The traditional fare oozes with the charm of yesteryear and the regularly changing menu offers an array of hearty, traditional dishes, such as duck leg à la bourguignonne or roast shoulder of lamb with garlic confit. Hunger obliterating food free of fussy frills and a treasure trove of French wines at prices that make sense...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20R%C3%A9my%20Himmer%204%2C%20Dinant%2C%205500%2C%20Belgium"
    pageTitle="Le Confessionnal"
  />
);

export default LeConfessionnal;
