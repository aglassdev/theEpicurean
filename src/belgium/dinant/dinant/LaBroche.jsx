...
const LaBroche = () => (
  <RestaurantPage
    restaurantName="La Broche"
    address="rue Grande 22, Dinant, 5500, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3282228281"
    website="https://www.labroche.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cosy restaurant has been a culinary landmark of Dinant since 1998. The secret of its success resides in the cheerful, heartfelt welcome of your hostess and the indulgent French culinary score of chef Éric Fieuw. Éric enjoys adding an Asian spin and unexpected notes to a classical lineup. For example, he might prepare fillets of seabass in a crumble with sweet mint in a daring but delicious association. This dish is further enhanced by rich, velvety mashed potato, leeks and a creamy fish sauce. Save room for pudding - the chef is a trained pastry cook! One last word of advice: the lunch menu is definitely worth writing home about!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Grande%2022%2C%20Dinant%2C%205500%2C%20Belgium"
    pageTitle="La Broche"
  />
);

export default LaBroche;
