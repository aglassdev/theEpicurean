...
const EddyVraie = () => (
  <RestaurantPage
    restaurantName="Eddy Vraie"
    address="route de Namur 64, Wanfercée-Baulet, 6224, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3271814894"
    website="https://www.eddyvraie.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Eddy’s last name (True) is emblematic of his powerful, authentic cooking. No pointless frills or fuss. Generous helpings of good wholesome food await the hungry diner...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=route%20de%20Namur%2064%2C%20Wanferc%C3%A9e-Baulet%2C%206224%2C%20Belgium"
    pageTitle="Eddy Vraie"
  />
);

export default EddyVraie;
