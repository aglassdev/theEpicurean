...
const Cuisineznous = () => (
  <RestaurantPage
    restaurantName="Cuisinez-Nous"
    address="rue de la Gare 138, Bertrix, 6880, Belgium"
    cuisine="Classic French"
    priceRange="€€"
    phoneNumber="+3261502464"
    website="https://www.cuisineznous.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In this tasteful townhouse, Alain and Céline further confirm their excellent reputation acquired at the Rosa restaurant. Céline caters to diners’ every whim in the dining room, while Alain deploys his talents in a traditional French repertory...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20de%20la%20Gare%20138%2C%20Bertrix%2C%206880%2C%20Belgium"
    pageTitle="Cuisinez-Nous"
  />
);

export default Cuisineznous;
