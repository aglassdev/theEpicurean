...
const Innesto = () => (
  <RestaurantPage
    restaurantName="Innesto"
    address="Kapelhof 13, Zonhoven, 3520, Belgium"
    cuisine="Creative"
    priceRange="€€€€"
    phoneNumber="+3211496747"
    website="https://www.innesto.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Innesto is the epitome of modern elegance, and the spruce interior sports a stylish black and white colour scheme, while marble details add a luxurious note. In fine weather, make a beeline for the patio. The front-of-house team is constantly on the ball to make sure you lack for nothing. You will see Koen Verjans in the glazed open kitchen, rolling out his obvious passion for outstanding ingredients as he deploys his creativity and technical background. He is particularly keen on mixing textures of vegetables to underscore their intensity, while sauces add an extra dimension to each dish. He may add a kick to Dombes duck with a gutsy compote of speck and onion, a beurre noisette hollandaise sauce and a big-boned spicy gravy. A medley of potato dishes then chips in with a playful final not..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kapelhof%2013%2C%20Zonhoven%2C%203520%2C%20Belgium"
    pageTitle="Innesto"
  />
);

export default Innesto;
