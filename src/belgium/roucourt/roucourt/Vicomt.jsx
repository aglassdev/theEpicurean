...
const Vicomt = () => (
  <RestaurantPage
    restaurantName="Vicomté"
    address="Rue d'Arondeau 29, Roucourt, 7601, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3269221689"
    website="https://www.domainedarondeau.com/vicomte/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Vicomté begins to weave its magical date-night romanticism right from the first glimpse of the Arrondeau estate and castle, whose wrought-iron conservatory, elegant ornamentation and enchanting water feature bring to mind an Impressionist painting…. Quentin Gallopyn further enhances this appealing portrait with a culinary ode to premium produce.In addition to knife-edged precision, Gallopyn expresses a fondness for rich, fruity flavours and his distinctive cuisine is often strewn with bold touches. Examples include medium rare melt-in-the-mouth fillet of lamb paired with pumpkin and bitter black and white sesame seeds. He may also flank eel with a slice of Morteau sausage and a medley of Cévennes onions in an infusion of sausage and eel skin, meat gravy and chunks of onion. Delicious!Take ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20d'Arondeau%2029%2C%20Roucourt%2C%207601%2C%20Belgium"
    pageTitle="Vicomté"
  />
);

export default Vicomt;
