...
const RestaurantVos = () => (
  <RestaurantPage
    restaurantName="Restaurant VOS"
    address="Groenstraat 29, Lokeren, 9160, Belgium"
    cuisine="Modern French, Creative French"
    priceRange="€€€"
    phoneNumber="+3293481436"
    website="https://www.restaurantvos.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This trendy joint is unusually located in a tennis club. The Audenaert brothers have successfully taken up the challenge. The youthful chefs’ hallmark can be tasted in mouth - watering dishes. Tasty, creative and flawlessly crafted...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Groenstraat%2029%2C%20Lokeren%2C%209160%2C%20Belgium"
    pageTitle="Restaurant VOS"
  />
);

export default RestaurantVos;
