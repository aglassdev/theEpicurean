...
const Seir = () => (
  <RestaurantPage
    restaurantName="Seir"
    address="Geelsebaan 40, Kasterlee, 2460, Belgium"
    cuisine="Creative French, Modern French"
    priceRange="€€€€"
    phoneNumber="+3214690061"
    website="https://www.seir.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The sunny conservatory of this swish restaurant immediately catches the eye. The leather-seated lounge is ideal to sip a drink while admiring chef Thomas at work. An accomplished artist, he composes his visual masterpieces right on the counter. Intelligent combinations, precise and meticulous cooking. This youthful chef gives a free rein to his creative flair and is clearly determined to go places! A genuine treat for the senses...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geelsebaan%2040%2C%20Kasterlee%2C%202460%2C%20Belgium"
    pageTitle="Seir"
  />
);
