...
const Potiron = () => (
  <RestaurantPage
    restaurantName="Potiron"
    address="Geelsebaan 73, Kasterlee, 2460, Belgium"
    cuisine="Farm to table, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3214850425"
    website="https://www.potiron.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Friendly Dirk and Sophie aren’t shy of demonstrating their phenomenal know-how. They smoke their own salmon, the ice cream is homemade, and they are justly proud of their 3-acre vegetable garden (visits by appointment). Vegetables and aromatic herbs add a playful twist and authentic purity to updated recipes. Distinctive French cuisine that eschews jargon and fancy frills...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Geelsebaan%2073%2C%20Kasterlee%2C%202460%2C%20Belgium"
    pageTitle="Potiron"
  />
);

export default Potiron;
