...
const SenseWAA = () => (
  <RestaurantPage
    ...
    address="Fortenstraat 62, Waasmunster, 9250, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3252397557"
    website="https://www.restaurantsense.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Classy, stylish, attention to detail, flavoursome – words fail us to describe Sense. The experience of veteran chef Michiel De Bruyn and the charm of your hostess, Frederika Vandeleur, are devoted to satisfying the expectations of their discerning diners. The restaurant’s pared down elegance and muted vibe provide the backdrop to a seamless performance without forgetting unusual food-wine pairings that are definitely worth writing home about. Chef Michiel’s minimalist approach seeks to enhance the ingredient: Zeebrugge sole, Guilvinec langoustine, frog’s legs from Dombes - only the best gets onto the menu here. The chef enhances such delicacies courtesy of classical techniques, like spit-roasting, but is equally at home with a Binchotan barbecue to fine-tune each individual texture. He mig..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fortenstraat%2062%2C%20Waasmunster%2C%209250%2C%20Belgium"
    pageTitle="Sense"
  />
);

export default SenseWAA;
