...
const MamyLouise = () => (
  <RestaurantPage
    restaurantName="Mamy Louise"
    address="chaussée de Bruxelles 410, Wavre, 1300, Belgium"
    cuisine="Traditional Cuisine, French"
    priceRange="€€"
    phoneNumber="+3210242174"
    website="https://www.mamylouise.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This elegant edifice, built out of wood, glass and steel, is home to a brasserie, a cocktail bar with a terrace, lounges and meeting rooms. The equally varied menu ranges from shrimp fritters and sole meunière to veal kidneys and ossobuco in a lineup of Franco-Belgian inspiration, dotted with a few Italian classics, all of which is underscored by a love of cooking and generous helpings. There is something for everyone at Mamy Louise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Bruxelles%20410%2C%20Wavre%2C%201300%2C%20Belgium"
    pageTitle="Mamy Louise"
  />
);

export default MamyLouise;
