...
const Lapropos = () => (
  <RestaurantPage
    restaurantName="l'Apropos"
    address="rue Bonry 146, Neupré, 4120, Belgium"
    cuisine="Mediterranean Cuisine, Farm to table"
    priceRange="€€"
    phoneNumber="+3243821300"
    website="https://resto-lapropos.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="After a facelift, L’Apropos now sports a warm, bright interior with colourful artwork. Chef Fournier shares his love of world, Mediterranean, Asian and North - African food, which he skilfully mixes and prepares, demonstrating a flawless sense of balance...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Bonry%20146%2C%20Neupr%C3%A9%2C%204120%2C%20Belgium"
    pageTitle="l'Apropos"
  />
);

export default Lapropos;
