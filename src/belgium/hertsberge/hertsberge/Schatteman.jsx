...
const Schatteman = () => (
  <RestaurantPage
    restaurantName="Schatteman"
    address="Kruisstraat 13, Hertsberge, 8020, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+32479823109"
    website="https://www.restaurantschatteman.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This imposing villa tucked away in the woods is a real gem. Modern artwork, a log burning fire and a wine cellar depict the stylish scene. While Marieke attentively spoils guests in the dining room, Gregory demonstrates his inventive flair in the kitchen. His creativity frequently surprises diners, but always subtly and delicately...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kruisstraat%2013%2C%20Hertsberge%2C%208020%2C%20Belgium"
    pageTitle="Schatteman"
  />
);

export default Schatteman;
