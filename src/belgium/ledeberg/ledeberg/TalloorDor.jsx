...
const TalloorDor = () => (
  <RestaurantPage
    restaurantName="Talloor d'Or"
    address="Ledebergplein 20, Ledeberg, 9050, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3292231948"
    website="https://www.talloordor.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You will immediately feel at home in the tasteful interior of the Talloor d’Or. Seated at the counter, you can admire the chef at work, rustling up contemporary dishes in keeping with the establishment’s vibe. Subtle vegetable dishes, fine sauces and a few citrus notes enhance and underscore the main ingredient. Seasoned Matthias and Nikki give free rein to their creative bent...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ledebergplein%2020%2C%20Ledeberg%2C%209050%2C%20Belgium"
    pageTitle="Talloor d'Or"
  />
);

export default TalloorDor;
