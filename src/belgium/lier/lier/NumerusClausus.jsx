...
const NumerusClausus = () => (
  <RestaurantPage
    restaurantName="Numerus Clausus"
    address="Keldermansstraat 2, Lier, 2500, Belgium"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+3234805162"
    website="https://www.numerusclausus.be/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Keldermansstraat%202%2C%20Lier%2C%202500%2C%20Belgium"
    pageTitle="Numerus Clausus"
  />
);

export default NumerusClausus;
