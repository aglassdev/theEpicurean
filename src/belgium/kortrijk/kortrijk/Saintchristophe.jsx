...
const Saintchristophe = () => (
  <RestaurantPage
    restaurantName="Saint-Christophe"
    address="Minister Tacklaan 5, Kortrijk, 8500, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3256200337"
    website="https://www.stchristophe.be/nl/home"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This handsome town house boasts a classical interior with high ceilings, a pastel brown colour scheme and a delightful terrace. The chef places great importance on the quality of his ingredients, which he incorporates into modern flavoursome recipes that are rich in character. We wholeheartedly recommend the formula and the all-inclusive menus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Minister%20Tacklaan%205%2C%20Kortrijk%2C%208500%2C%20Belgium"
    pageTitle="Saint-Christophe"
  />
);

export default Saintchristophe;
