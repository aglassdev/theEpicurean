...
const RestaurantDirkjanDecock = () => (
  <RestaurantPage
    restaurantName="Restaurant Dirkjan Decock"
    address="Groeningelaan 22, Kortrijk, 8500, Belgium"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3256404040"
    website="https://www.restaurantdirkjandecock.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Dirkjan and Hilde warmly welcome guests to their stylish establishment depicted by a cosy, tranquil vibe and flanked by an exquisite patio. Chef Decock enthusiastically gets on with the job in his open-plan kitchen. He works with top-notch ingredients, creatively preparing vegetables and also adding the odd hint of exoticism to jazz up the dishes. Stripped-back, subtle and fascinating food...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Groeningelaan%2022%2C%20Kortrijk%2C%208500%2C%20Belgium"
    pageTitle="Restaurant Dirkjan Decock"
  />
);

export default RestaurantDirkjanDecock;
