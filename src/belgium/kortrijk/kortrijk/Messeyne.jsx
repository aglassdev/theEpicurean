...
const Messeyne = () => (
  <RestaurantPage
    restaurantName="Messeyne"
    address="Groeningestraat 17, Kortrijk, 8500, Belgium"
    cuisine="Creative, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3256212166"
    website="https://www.restaurantmesseyne.be/nl"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The locals adore this cosy restaurant and its terrace in the adjacent gardens. The French cuisine is up - to - the - minute, full of flavour and unfussy...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Groeningestraat%2017%2C%20Kortrijk%2C%208500%2C%20Belgium"
    pageTitle="Messeyne"
  />
);

export default Messeyne;
