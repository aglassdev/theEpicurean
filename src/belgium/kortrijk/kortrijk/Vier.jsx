...
const Vier = () => (
  <RestaurantPage
    restaurantName="Vier"
    address="Groeningestraat 4, Kortrijk, 8500, Belgium"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+32468577009"
    website="https://www.vierkortrijk.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Concrete, black and turquoise set the unusual scene in this imposing, yet nonetheless cosy venue. Fine produce such as cottage garden veggies and black chicken from Burgundy takes pride of place in the cooking of chef Bas. Natural, simple and seasonal sum up his ethos, all of which flanked by knockout sauces and at prices that make sense in the heart of Kortrijk!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Groeningestraat%204%2C%20Kortrijk%2C%208500%2C%20Belgium"
    pageTitle="Vier"
  />
);
