...
const Vorace = () => (
  <RestaurantPage
    restaurantName="Vorace"
    address="Ry Del Vau 2a, Gesves, 5340, Belgium"
    cuisine="French, Creative"
    priceRange="€€"
    phoneNumber="+32473120821"
    website="https://www.vorace.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Noé Pellet has opened his restaurant in the family home, thus preserving a casual vibe and a warm vintage ambience. The menu embodies this food lover’s devotion to the ingredient and avoidance of unnecessary frills. Each dish is emblematic of both how much he loves his work and his creative streak at the service of indulgent flavours. He fries the cèpes in butter, serving them with a vin jaune glazed cream of mushrooms, garlic cream, fried parsley, dried ham, enoki mushrooms and quail eggs. You can trust the wine tips of Elisa who clearly has a weakness for organic vintages and never misses an opportunity to suggest excellent pairings. Bookings essential!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ry%20Del%20Vau%202a%2C%20Gesves%2C%205340%2C%20Belgium"
    pageTitle="Vorace"
  />
);

export default Vorace;
