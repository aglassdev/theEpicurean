...
const LeBoutonDor = () => (
  <RestaurantPage
    restaurantName="Le Bouton d'Or"
    address="chaussée de Bruxelles 135, Casteau, 7061, Belgium"
    cuisine="Farm to table, Seasonal Cuisine"
    priceRange="€€"
    phoneNumber="+3265723627"
    website="https://www.leboutondor.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The soul of this friendly restaurant bears the hallmark of a love of nature. The veggies come from a neighbouring farmer and the chef hunts the game himself. Generous, unfussy cooking at its best. Partridge is one of the chef’s iconic specialties. The lady of the house can be trusted to suggest flawless wine-food pairings...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20Bruxelles%20135%2C%20Casteau%2C%207061%2C%20Belgium"
    pageTitle="Le Bouton d'Or"
  />
);

export default LeBoutonDor;
