...
const UnTempsPourSoi = () => (
  <RestaurantPage
    restaurantName="Un temps pour Soi"
    address="Thier du Moulin 46, Villers-le-Bouillet, 4530, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3285255855"
    website="https://www.untempspoursoi.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The countryside around Villers-le-Bouillet is ideal for a weekend getaway and what could be better than this elegant stone building and its romantic patio? The seasoned chef rustles up appetising food, sprinkled with crunchy, spicy, incisive and acidic notes. In a word: the epitome of market-fresh, wholesome cooking...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Thier%20du%20Moulin%2046%2C%20Villers-le-Bouillet%2C%204530%2C%20Belgium"
    pageTitle="Un temps pour Soi"
  />
);

export default UnTempsPourSoi;
