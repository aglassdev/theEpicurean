...
const Kommilfoo = () => (
  <RestaurantPage
    restaurantName="Kommilfoo"
    address="Vlaamse Kaai 17, Antwerpen, 2000, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3232373000"
    website="https://www.restaurantkommilfoo.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Olivier de Vinck de Winnezeele is a self-taught chef. It all started with a student job to pay for his studies, which soon turned into a fully-fledged passion for cooking. He then learned the ropes in top houses, mainly in Spain, before founding Kommilfoo in 1998 with Inge, your hostess. The spacious interior is depicted by an elegant peaceful vibe. A blue-chip establishment in Antwerp’s trendy Zuid district and the guarantee of outstanding produce. Creative and talented, Vinck de Winnezeele has a knack for adding a new spin to recipes, courtesy of his work on structure and his surprisingly delicate side dishes. Examples of the chef’s boundless versatility include medium rare lamb cutlets with crispy fat, paired with spicy couscous and a gutsy rosemary gravy or a wickedly tempting and subt..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vlaamse%20Kaai%2017%2C%20Antwerpen%2C%202000%2C%20Belgium"
    pageTitle="Kommilfoo"
  />
);

export default Kommilfoo;
