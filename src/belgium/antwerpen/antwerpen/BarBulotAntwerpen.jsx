...
const BarBulotAntwerpen = () => (
  <RestaurantPage
    restaurantName="Bar Bulot Antwerpen"
    address="Lange Gasthuisstraat 41, Antwerpen, 2000, Belgium"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+3233692596"
    website="https://barbulot.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hip, cosmopolitan brasserie, Antwerp’s outpost of Bruge’s Bar Bulot, has found refuge in the lavish Botanic Sanctuary Hotel. Timeless classics such as asparagus à la flamande, vol-au-vent of Bresse chicken, sweetbread and shrimp are revamped to tempt and tickle today’s tastebuds. Top-notch ingredients and contemporary flavours, by way of exotic spices, add character to each dish. Heaven for discerning foodies!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Gasthuisstraat%2041%2C%20Antwerpen%2C%202000%2C%20Belgium"
    pageTitle="Bar Bulot Antwerpen"
  />
);

export default BarBulotAntwerpen;
