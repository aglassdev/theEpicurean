...
const HetGebaar = () => (
  <RestaurantPage
    restaurantName="Het Gebaar"
    address="Leopoldstraat 24, Antwerpen, 2000, Belgium"
    cuisine="Creative, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+3232323710"
    website="https://www.hetgebaar.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Roger van Damme’s reputation for stellar desserts needs no introduction and this is the place to sample his creations from a truly wicked dame blanche (vanilla ice cream and hot chocolate) to a tiramisu to die for! But the pastry chef is also a wizard savoury chef, as a trip to his modern “gingerbread house” near Stadsschouwburg will convince you. Following a swish revamp, Het Gebaar - opened in 1994 - sports a luxurious, yet casual vibe. Van Damme’s attention to detail is visible at every stage of your meal and nothing leaves the kitchen that hasn’t been puzzled over and preened to perfection. His distinctive, supremely elegant recipes celebrate familiar flavours, albeit with a creative twist. His talent for traditional dishes such as Beef Wellington is second to none thanks to his consum..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Leopoldstraat%2024%2C%20Antwerpen%2C%202000%2C%20Belgium"
    pageTitle="Het Gebaar"
  />
);

export default HetGebaar;
