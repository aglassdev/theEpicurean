...
const Nathan = () => (
  <RestaurantPage
    restaurantName="Nathan"
    address="Lange Koepoortstraat 13, Antwerpen, 2000, Belgium"
    cuisine="Modern French"
    priceRange="€€€€"
    phoneNumber="+3232842813"
    website="https://www.restaurant-nathan.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nathan Van Echelpoel and your hostess, Eva Van de Peer, appreciate beauty, as the tasteful marble and dark wooden fixtures and fittings confirm and their eatery embodies Belgian flair for interior decoration with a Scandinavian ethos. As if art directed, each exquisitely plated dish is emblematic of this painstaking attention to the detail. Virtuoso chef Van Echelpoel mixes his classical culinary training with a playful contemporary streak, jazzing up familiar flavours with acidic Asian notes. He may serve sardines raw or in a vibrant salty tartare, flanked by subtle side dishes such as an emulsion of plankton, finely sliced kohlrabi and a punchy dressing based on Greek yoghurt with a crispy chermoula mayonnaise. Delicacy is second nature to Van Echelpoel who constantly seeks to create and..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lange%20Koepoortstraat%2013%2C%20Antwerpen%2C%202000%2C%20Belgium"
    pageTitle="Nathan"
  />
);
