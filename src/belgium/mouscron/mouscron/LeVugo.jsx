...
const LeVugo = () => (
  <RestaurantPage
    restaurantName="le Vugo"
    address="Rue du Phénix 29, Mouscron, 7700, Belgium"
    cuisine="Modern French, Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+3256344955"
    website="https://www.levugorestaurant.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="An excellent choice for a gourmet dining experience at outstanding value for money. A contemporary, relatively intimist interior provides the setting for up-to-the-minute cuisine. The chef plays with textures, whilst allowing the generous ingredient to shout its name loud and clear...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Ph%C3%A9nix%2029%2C%20Mouscron%2C%207700%2C%20Belgium"
    pageTitle="le Vugo"
  />
);

export default LeVugo;
