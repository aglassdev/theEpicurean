...
const Bonnettis = () => (
  <RestaurantPage
    restaurantName="Bonnetti’s"
    address="Bosstraat 160, Hamont, 3930, Belgium"
    cuisine="Fusion, Sharing"
    priceRange="€€€"
    phoneNumber="+3211916557"
    website="https://www.bonnettis.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mark Bonneu unveils a culinary score whose Spanish heritage is mixed with international overtones. The extensive menu rolls out an enticing selection of dishes to share, snacks and more high-flying creations. He might pair scallops and turnips with miso, for example. Texels lamb is jazzed up with a rosemary-flavoured gravy, a cream of chickpeas and carrots, unless you wouldn’t prefer an empanada of pork cheeks or a pan con tomate? The imposing edifice, which sports a pleasing light colour scheme, sings an ode to throbbing flavours and mouthwatering aromas. Even better, you can leave with a bottle of wine and/or a few delicacies to nibble at home...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bosstraat%20160%2C%20Hamont%2C%203930%2C%20Belgium"
    pageTitle="Bonnetti’s"
  />
);

export default Bonnettis;
