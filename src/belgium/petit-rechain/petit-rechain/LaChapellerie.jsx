...
const LaChapellerie = () => (
  <RestaurantPage
    restaurantName="La Chapellerie"
    address="chaussée de la Seigneurie 13, Petit-Rechain, 4800, Belgium"
    cuisine="Farm to table"
    priceRange="€€"
    phoneNumber="+3287315741"
    website="https://www.restaurantlachapellerie.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Sophie’s grandparents were hatmakers (hence the name), but Sophie’s love was cooking. In a tastefully refurbished brick townhouse, she turns out comfortingly familiar dishes, oozing with elegance. Spot-on cooking, a sprinkling of creativity and punchy, powerful sauces are combined in well-balanced dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20de%20la%20Seigneurie%2013%2C%20Petit-Rechain%2C%204800%2C%20Belgium"
    pageTitle="La Chapellerie"
  />
);

export default LaChapellerie;
