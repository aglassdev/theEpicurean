...
const LePassage = () => (
  <RestaurantPage
    restaurantName="Le Passage"
    address="avenue Jean et Pierre Carsoel 17, Uccle, 1180, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€€"
    phoneNumber="+3223746694"
    website="https://lepassage.be/fr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This establishment and its lunchtime set menu are a favourite with the locals, such is chef Rocky Renaud’s reputation for creativity and flair, mingling tradition with modernity. Distinctive food with bold international accents!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20Jean%20et%20Pierre%20Carsoel%2017%2C%20Uccle%2C%201180%2C%20Belgium"
    pageTitle="Le Passage"
  />
);

export default LePassage;
