...
const LaBrancheDolivier = () => (
  <RestaurantPage
    restaurantName="La Branche d'Olivier"
    address="rue Engeland 172, Uccle, 1180, Belgium"
    cuisine="Classic Cuisine"
    priceRange="€€"
    phoneNumber="+3223744705"
    website="https://www.labranchedolivier.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its old tiled floor and leather seats, patinated woodwork, plus the peaceful terrace overlooking Kinsendaal Nature Reserve, this charming bistro is full of character. The many regulars come here to feast on classics such as foie gras maison, cod fillet in a chorizo crust with a saffron white wine sauce, and chocolate mousse for dessert. It is not without good reason that chef Demurger is hailed as a great sauce maker and rôtisseur. This Bib Gourmand restaurant is all about craftsmanship and generosity...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20Engeland%20172%2C%20Uccle%2C%201180%2C%20Belgium"
    pageTitle="La Branche d'Olivier"
  />
);

export default LaBrancheDolivier;
