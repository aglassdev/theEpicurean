...
const CaffAlDente = () => (
  <RestaurantPage
    restaurantName="Caffè Al Dente"
    address="rue du Doyenné 87, Uccle, 1180, Belgium"
    cuisine="Italian"
    priceRange="€€"
    phoneNumber="+3223434523"
    website="https://caffealdente.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The smart, marble - decked interior of the Caffè Al Dente oozes with the warmth and authenticity of Italy. The chef knows his classics and works with top - rate produce. Equally fine wines. Pop next - door to the boutique when you finish your meal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20du%20Doyenn%C3%A9%2087%2C%20Uccle%2C%201180%2C%20Belgium"
    pageTitle="Caffè Al Dente"
  />
);

export default CaffAlDente;
