...
const LeChaletDeLaFort = () => (
  <RestaurantPage
    restaurantName="Le Chalet de la Forêt"
    address="drêve de Lorraine 43, Uccle, 1180, Belgium"
    cuisine="Creative, Modern French"
    priceRange="€€€€"
    phoneNumber="+3223745416"
    website="https://www.lechaletdelaforet.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Pascal Devalkeneer’s chalet is magnificently set on the edge of the Sonian Forest and the chalet’s terrace makes the most of this fantastic natural environment. The restaurant overlooking the chef’s cottage garden oozes luxurious elegance to which you should add well-oiled, slick service and, above all, chef Devalkeneer’s personal stamp on each dish. His blend of classicism and creativity reveals surgical precision, as well as a quest for subtlety and generosity. He scours the countryside of Belgium and France for the best ingredients from Aveyron lamb to abalone from the Brittany coast and honey from his own beehives, with which he crafts an amazing floral dessert starter… He works with exceptional ingredients, flanking them with intriguing side dishes to create a felicitous festival of f..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=dr%C3%AAve%20de%20Lorraine%2043%2C%20Uccle%2C%201180%2C%20Belgium"
    pageTitle="Le Chalet de la Forêt"
  />
);

export default LeChaletDeLaFort;
