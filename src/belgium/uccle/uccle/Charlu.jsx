...
const Charlu = () => (
  <RestaurantPage
    restaurantName="Charlu"
    address="Chaussée de Saint-Job 676, Uccle, 1180, Belgium"
    cuisine="French"
    priceRange="€€"
    phoneNumber="+3223742610"
    website="https://resto-charlu.be"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This imposing 1920’s villa in the heart of the Saint Job neighbourhood is home to a genuine temple of bistronomy. Wainscoting, mirrors and tightly packed tables set the scene. The working language is French in both the menu and the wine list, the owner’s passion about which he frequently waxes lyrical. Hearty wholesome recipes from southwest France are what you can expect, like textbook cassoulet made with proper duck confit, smoked ham and Toulouse sausage, unless you wouldn’t prefer fritters of pig’s trotters or crispy sweetbread. Traditional down to the core and crafted with love is the ethos of Charlu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chauss%C3%A9e%20de%20Saint-Job%20676%2C%20Uccle%2C%201180%2C%20Belgium"
    pageTitle="Charlu"
  />
);

export default Charlu;
