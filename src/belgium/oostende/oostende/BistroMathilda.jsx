...
const BistroMathilda = () => (
  <RestaurantPage
    restaurantName="Bistro Mathilda"
    address="Leopold II-laan 1, Oostende, 8400, Belgium"
    cuisine="Farm to table"
    priceRange="€€€"
    phoneNumber="+3259510670"
    website="https://www.bistromathilda.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This modern bistro is much more than a pleasant trendy interior. The chef’s influences are wide ranging with a focus on first class ingredients. Bistro Mathilda brings the promise of a fine meal!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Leopold%20II-laan%201%2C%20Oostende%2C%208400%2C%20Belgium"
    pageTitle="Bistro Mathilda"
  />
);

export default BistroMathilda;
