...
const BrasserieDavid = () => (
  <RestaurantPage
    restaurantName="Brasserie David"
    address="Christinastraat 45, Oostende, 8400, Belgium"
    cuisine="Contemporary"
    priceRange="€€"
    phoneNumber="+32476739966"
    website="https://guide.michelin.com/en/west-vlaanderen/oostende/restaurant/brasserie-david"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The menu of David Dewaele’s friendly brasserie showcases all the traditional delicacies of this coastline. The entirely open-plan kitchen allows you to admire his work as he prepares sole, seabass and shrimp. The side dishes are creatively crafted and add an extra whoomph to each dish. Ideal to sample Belgian favourites with a sprinkling of originality...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Christinastraat%2045%2C%20Oostende%2C%208400%2C%20Belgium"
    pageTitle="Brasserie David"
  />
);

export default BrasserieDavid;
