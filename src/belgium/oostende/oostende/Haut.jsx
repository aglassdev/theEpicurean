...
const Haut = () => (
  <RestaurantPage
    restaurantName="HAUT"
    address="Leopold III-Laan 2 28.01, Oostende, 8400, Belgium"
    cuisine="Modern French, Asian Influences"
    priceRange="€€€€"
    phoneNumber="+3259468400"
    website="https://hautrestaurant.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The 28th floor of SKY Towers is entirely given over to Belgium’s highest restaurant. This high-flying establishment’s natural serenity and jaw-dropping view over the North Sea and the coast are worth a trip in their own right, particularly for the truly spectacular sunsets. Dimitri Proost endeavours to transcribe the amazing landscape into his cuisine, whilst adding a few typically Japanese notes.Examples include juicy, tender seabass in a dashi made from the fish bones, which he pairs with briny shellfish and a smoked butter mousseline sauce. Equally noteworthy are his vibrant work with North Sea crab and Bresse poultry which is crafted four different ways, including a juicy breast flavoured with truffle!The culinary lineup is a genuine ode to outstanding ingredients that are allowed to s..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Leopold%20III-Laan%202%2028.01%2C%20Oostende%2C%208400%2C%20Belgium"
    pageTitle="HAUT"
  />
);
