...
const Storm = () => (
  <RestaurantPage
    restaurantName="Storm"
    address="Hendrik Baelskaai 21, Oostende, 8400, Belgium"
    cuisine="Modern French, Seafood"
    priceRange="€€€"
    phoneNumber="+3259280261"
    website="https://www.stormoostende.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Storms do not prevent fishing boats from mooring in front of the door. The experienced chef pays them tribute with a host of delicacies, using modern techniques (including a passing nod to Asia and Scandinavia). However, relax, the cosy interior and cheerful staff will ensure you weather this storm in style...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hendrik%20Baelskaai%2021%2C%20Oostende%2C%208400%2C%20Belgium"
    pageTitle="Storm"
  />
);
