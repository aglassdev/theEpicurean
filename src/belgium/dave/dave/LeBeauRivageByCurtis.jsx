...
const LeBeauRivageByCurtis = () => (
  <RestaurantPage
    restaurantName="Le Beau Rivage by Curtis"
    address="Rue du Rivage 8, Dave, 5100, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3281633664"
    website="https://www.curtismaquet.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Curtis Maquet has breathed a new lease of life into the Beau Rivage, a culinary landmark of Namur that is idyllically located on the banks of the Meuse. Relax in the stylish interior as you sample the repertory of a young chef who learned the ropes at the Table de Maxime. Delicate, expressive cuisine that revolves around the ingredient and is steeped in familiar, elegant and powerful flavours.The chef demonstrates his know-how with a breast of Miéral duck, cooked medium rare with a lovely crispy skin. This is flanked by a sweet, spicy Vadouvan jus and a medley of winter side dishes such as finely diced beetroot for a fresh, crisp note. His shepherd’s pie of duck legs and fluffy mashed potato is to die for. Curtis adds a personal stamp and lashings of generosity to purebred Gallic recipes.E..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Rue%20du%20Rivage%208%2C%20Dave%2C%205100%2C%20Belgium"
    pageTitle="Le Beau Rivage by Curtis"
  />
);

export default LeBeauRivageByCurtis;
