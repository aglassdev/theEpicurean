...
const DeRefugie = () => (
  <RestaurantPage
    restaurantName="De Refugie"
    address="Kapucijnenstraat 75, Tienen, 3300, Belgium"
    cuisine="Farm to table, French"
    priceRange="€€"
    phoneNumber="+3216824532"
    website="https://derefugie.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Franco-Belgian foodies are in seventh heaven in this eatery in a friendly neighbourhood. You are first greeted by your gracious hostess, before you sample the manifold talents of chef Van Vlemmeren. He prepares the food to order each time and cannot be faulted for his exquisite sauces or impeccable technique. The sole is gently sautéed in butter, the butter sauce is sprinkled with parsley and the crispy fries are piping hot. Good food worth writing home about - the epitome of bistronomic dining!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Kapucijnenstraat%2075%2C%20Tienen%2C%203300%2C%20Belgium"
    pageTitle="De Refugie"
  />
);

export default DeRefugie;
