...
const Melchior = () => (
  <RestaurantPage
    restaurantName="Melchior"
    address="Veemarkt 47, Tienen, 3300, Belgium"
    cuisine="Modern French, Fusion"
    priceRange="€€€€"
    phoneNumber="+3216355474"
    website="https://www.melchi-or.be/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Melchior would be just the ticket for a fashion shoot. Old brick walls and high ceilings bear witness to the edifice’s historic legacy, while huge lamps and a Scandinavian interior design edge impart a trendy vibe, as does the graffiti on the terrace. It is here that Gilles Melchior showcases his high-flying skill and ability to fusion knife-edge Japanese techniques with classical finesse. The chef’s sauces, dressings and gravies are out of this world. A past master of traditional techniques, he knows just how to balance his creativity and is constantly broadening his culinary scope to incorporate Asian ingredients. He might enhance Balfego tuna with a dashi sauce and side dishes such as confit of white radish, finger lime and nori flavoured mayonnaise. He is equally at home with a medium ..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Veemarkt%2047%2C%20Tienen%2C%203300%2C%20Belgium"
    pageTitle="Melchior"
  />
);

export default Melchior;
