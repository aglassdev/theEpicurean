...
const LeMondeEstPetit = () => (
  <RestaurantPage
    restaurantName="Le Monde est Petit"
    address="rue des Bataves 65, Etterbeek, 1040, Belgium"
    cuisine="Creative French"
    priceRange="€€€"
    phoneNumber="+3227324434"
    website="https://www.lemondeestpetit.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stylish and intimate restaurant enjoys a pleasant location between Montgomery and Cinquantenaire Park. The market determines what's on the menu here. Chef Loïc Villers incorporates delicious produce into well-thought-out dishes that are as international as his diners. Think quail ballotines stuffed with a delicate farce containing pistachio, a parsnip cream, grapes and juices from the meat. This cuisine is all about pleasure and celebrates the genuine flavours of the ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=rue%20des%20Bataves%2065%2C%20Etterbeek%2C%201040%2C%20Belgium"
    pageTitle="Le Monde est Petit"
  />
);

export default LeMondeEstPetit;
