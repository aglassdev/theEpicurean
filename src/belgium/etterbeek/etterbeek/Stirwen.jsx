...
const Stirwen = () => (
  <RestaurantPage
    restaurantName="Stirwen"
    address="chaussée Saint-Pierre 15, Etterbeek, 1040, Belgium"
    cuisine="Modern French"
    priceRange="€€€"
    phoneNumber="+3226408541"
    website="https://www.stirwen.be/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Stirwen has long been high on the favourite contact list of Brussels’ discerning foodies. They flock to the well-heeled European district to take a seat in this stylish establishment dripping in luxurious comfort, ready to sample pedigree Gallic cuisine with a new spin rolled out by chef François-Xavier Lambory. This lover of fine produce regularly pops out into the dining room to patiently share his recipes such as hare à la royale, or explain how he devises a delicious game menu or how to enhance scallops with a zest of lemon juice, sour cream and an ice cream of green celery. Guaranteed to hit the spot every time!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=chauss%C3%A9e%20Saint-Pierre%2015%2C%20Etterbeek%2C%201040%2C%20Belgium"
    pageTitle="Stirwen"
  />
);

export default Stirwen;
