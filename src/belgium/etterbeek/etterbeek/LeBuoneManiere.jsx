...
const LeBuoneManiere = () => (
  <RestaurantPage
    restaurantName="Le Buone Maniere"
    address="avenue de Tervueren 59, Etterbeek, 1040, Belgium"
    cuisine="Italian"
    priceRange="€€€€"
    phoneNumber="+3227626105"
    website="https://www.buonemaniere.brussels/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Maurizio Zizza’s hard work and dedication has firmly established his stylish restaurant, which boasts a splendid terrace to the rear, on the culinary scene of Brussels. Zizza, who is assisted by Martin Denis, enjoys serving the food himself. Together they subtly rework an authentic Italian lineup, adding a new spin, illustrated by vitello tonnato that is rich in characteristic flavours while sporting playful textures or by a ‘light’ tiramisu flavoured with marsala. Family favourites with the odd kick and ubiquitous elegance are the hallmark of this fine establishment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=avenue%20de%20Tervueren%2059%2C%20Etterbeek%2C%201040%2C%20Belgium"
    pageTitle="Le Buone Maniere"
  />
);

export default LeBuoneManiere;
