...
const Be = () => (
  <RestaurantPage
    restaurantName="Beç"
    address="Copríncep François Mitterrand 2, Escaldes-Engordany, AD700, Andorra"
    cuisine="Traditional Cuisine"
    priceRange="€€€"
    phoneNumber="+376828667"
    website="https://www.becrestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="If you’re looking for a spectacular setting in which to eat near the Caldea spa, this restaurant in a shopping district just two minutes’ walk away could be the place. To a welcoming contemporary backdrop featuring a profusion of wood and an open-view kitchen, enjoy an updated take on traditional cuisine. Standout dishes include aged beef loin tartare, pigs’ trotters stuffed with prawns from Sant Carles and several seasonal specialities such as Maresme peas with wild mushrooms and white prawns...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Copr%C3%ADncep%20Fran%C3%A7ois%20Mitterrand%202%2C%20Escaldes-Engordany%2C%20AD700%2C%20Andorra"
    pageTitle="Beç"
  />
);
