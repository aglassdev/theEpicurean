...
const Kkosnt = () => (
  <RestaurantPage
    restaurantName="Kökosnøt"
    address="Avinguda d’Enclar 94, Andorra la Vella, AD500, Andorra"
    cuisine="Contemporary, Creative"
    priceRange="€€€"
    phoneNumber="+376862268"
    website="https://sites.google.com/view/restaurantkokokosnot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="(Temporarily closed due to relocation) A restaurant that continues to gain a loyal following thanks to its welcoming ambience, its high-quality ingredients and the professionalism of its staff. Delicious, creative cuisine plus a splendid wine cellar...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avinguda%20d%E2%80%99Enclar%2094%2C%20Andorra%20la%20Vella%2C%20AD500%2C%20Andorra"
    pageTitle="Kökosnøt"
  />
);

export default Kkosnt;
