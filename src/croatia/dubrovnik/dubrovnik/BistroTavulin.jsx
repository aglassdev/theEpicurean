...
const BistroTavulin = () => (
  <RestaurantPage
    restaurantName="Bistro Tavulin"
    address="Cvijete Zuzorić 1, Dubrovnik, 20000, Croatia"
    cuisine="Traditional Cuisine, Classic Cuisine"
    priceRange="€€"
    phoneNumber="+38520323977"
    website="https://www.bistrotavulin.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Although this restaurant is admittedly aimed at tourists given its central location in the heart of Dubrovnik, the cuisine here is prepared using fresh, local ingredients which result in pleasing, elegantly presented dishes that are full of flavour. The superb agnolotti pasta stuffed with Adriatic prawns, accompanied by a beurre blanc and parsley-flavoured oil, is delicious and beautifully prepared...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cvijete%20Zuzori%C4%87%201%2C%20Dubrovnik%2C%2020000%2C%20Croatia"
    pageTitle="Bistro Tavulin"
  />
);

export default BistroTavulin;
