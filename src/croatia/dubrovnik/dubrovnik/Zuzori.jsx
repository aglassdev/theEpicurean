...
const Zuzori = () => (
  <RestaurantPage
    restaurantName="Zuzori"
    address="Cvijete Zuzoric 2, Dubrovnik, 20000, Croatia"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+38520324076"
    website="https://zuzori.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small restaurant within the city’s medieval walls has a welcoming and informal atmosphere. The menu is imaginative and includes fresh seafood from the Adriatic, pasta dishes, light salads and vegetarian options with a pleasing contemporary touch. The attractive outdoor dining area in an alleyway in the historic centre allows guests to experience all the magic of Dubrovnik...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cvijete%20Zuzoric%202%2C%20Dubrovnik%2C%2020000%2C%20Croatia"
    pageTitle="Zuzori"
  />
);

export default Zuzori;
