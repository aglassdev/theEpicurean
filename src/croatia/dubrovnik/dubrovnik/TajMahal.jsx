...
const TajMahal = () => (
  <RestaurantPage
    ...
    address="Nikole Gučetića 2, Dubrovnik, 20000, Croatia"
    cuisine="Balkan, Meats and Grills"
    priceRange="€€"
    phoneNumber="+38520323221"
    website="https://www.tajmahal-dubrovnik.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Despite the name, the Taj Mahal's cuisine pays homage to Bosnia and Balkan traditions. In the heart of Dubrovnik's Old Town, this restaurant is a landmark for those seeking authentic, rich and tantalizing flavours served in a convivial and unpretentious atmosphere. The extensive and varied menu simply tells the story of Bosnian culinary tradition: a couple of pages are devoted to traditional dishes, alongside tasty grilled meats (from their own butcher shop), flavourful vegetables, and specialities prepared according to family recipes. Not to be missed is the homemade plum baklava made by the owner's mother – a real treat. The friendly and attentive service is always ready to advise and guide you in your choice, helping you navigate your way through the many proposals. In addition to wines..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nikole%20Gu%C4%8Deti%C4%87a%202%2C%20Dubrovnik%2C%2020000%2C%20Croatia"
    pageTitle="Taj Mahal"
  />
);
