...
const KonobaBuina = () => (
  <RestaurantPage
    restaurantName="Konoba Buščina"
    address="Buščina 18, Umag, 52470, Croatia"
    cuisine="Traditional Cuisine, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+38552732088"
    website="https://konoba-buscina.hr/hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This beautiful rustic-style inn occupying a country house just outside Umag has been in business for 30 years. Here, traditional meat and fish ingredients such as scallops, langoustine, Boscarin beef, Istrian ham and truffles inspire simple, generous dishes which showcase the best of the region. Friendly service and pleasantly informal atmosphere...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bu%C5%A1%C4%8Dina%2018%2C%20Umag%2C%2052470%2C%20Croatia"
    pageTitle="Konoba Buščina"
  />
);

export default KonobaBuina;
