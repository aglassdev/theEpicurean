...
const MarinaNOV = () => (
  <RestaurantPage
    restaurantName="Marina"
    address="Ulica Sv. Antona 38, Novigrad, 52466, Croatia"
    cuisine="Creative"
    priceRange="€€€"
    phoneNumber="+385998121267"
    website="https://www.marinarestaurant.eu/hr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Intimate and refined, this elegant restaurant offers a extensive view of the small marina. It is an ideal address for lovers of seafood cuisine, offered exclusively through two tasting menus of 6 or 8 courses. The talented chef-patron Marina Gaši creates dishes with a creative and contemporary touch, always respecting the quality and finesse of the excellent raw ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ulica%20Sv.%20Antona%2038%2C%20Novigrad%2C%2052466%2C%20Croatia"
    pageTitle="Marina"
  />
);

export default MarinaNOV;
