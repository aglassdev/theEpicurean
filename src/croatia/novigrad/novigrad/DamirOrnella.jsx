...
const DamirOrnella = () => (
  <RestaurantPage
    restaurantName="Damir & Ornella"
    address="Zidine 5, Novigrad, 52466, Croatia"
    cuisine="Seafood, Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+38552758134"
    website="https://damir-ornela.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The welcoming ambience and the quality of the ingredients used are the trump cards of this family-run restaurant, which serves delicious fish and seafood. Raw marinated fish is the house speciality, including scampi, prawns, squid, cuttlefish, marinated sole and a few pasta dishes. The concise menu is announced at your table, a sure guarantee of fresh ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Zidine%205%2C%20Novigrad%2C%2052466%2C%20Croatia"
    pageTitle="Damir & Ornella"
  />
);

export default DamirOrnella;
