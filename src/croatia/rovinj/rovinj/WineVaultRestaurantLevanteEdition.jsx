...
const WineVaultRestaurantLevanteEdition = () => (
  <RestaurantPage
    restaurantName="Wine Vault Restaurant - Levante Edition"
    address="Ul. Antonia Smareglie 3, Rovinj, 52210, Croatia"
    cuisine="Regional Cuisine, Contemporary"
    priceRange="€€€€"
    phoneNumber="+385992733837"
    website="https://www.maistra.com/hotel-monte-mulini-rovinj/sub/restaurant-wine-vault"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the luxurious “adult only” Monte Mulini hotel, this restaurant with a beautiful terrace serves local cuisine prepared using regional produce alongside a few Asian ingredients – guests choose the number of courses they want from the menu. Careful attention is paid to wine pairing, with an impressive selection of local labels, including sparkling wines and a good choice of champagnes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ul.%20Antonia%20Smareglie%203%2C%20Rovinj%2C%2052210%2C%20Croatia"
    pageTitle="Wine Vault Restaurant - Levante Edition"
  />
);

export default WineVaultRestaurantLevanteEdition;
