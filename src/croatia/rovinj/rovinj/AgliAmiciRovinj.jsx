...
const AgliAmiciRovinj = () => (
  <RestaurantPage
    restaurantName="Agli Amici Rovinj"
    address="Šetalište Vijeća Europe 1-2, Rovinj, 52210, Croatia"
    cuisine="Italian Contemporary, Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+385998051910"
    website="https://www.maistra.com/grand-park-hotel-rovinj/sub/agli-amici-rovinj"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 2, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The restaurant is situated in a stunning seafront location along the elegant promenade of the modern Marina. A charming corner, enhanced by a spacious terrace – where dinner begins with refined finger food – and breathtaking views of the blue sea dotted with lush green islets. As evening falls, the illuminated silhouette of the Church of St. Euphemia adds a touch of magic to the atmosphere. The kitchen is helmed by Simone De Lucca, under the supervision of Emanuele Scarello, chef of the renowned two-Michelin-starred Agli Amici in Udine. The menu offers two tasting journeys: Rovinj and Istria, dedicated respectively to the sea and the land. From both, individual à la carte dishes can be selected, all sharing a commitment to the excellence of the raw materials and precise, thoughtful prepara..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C5%A0etali%C5%A1te%20Vije%C4%87a%20Europe%201-2%2C%20Rovinj%2C%2052210%2C%20Croatia"
    pageTitle="Agli Amici Rovinj"
  />
);

export default AgliAmiciRovinj;
