...
const ZinfandelFoodWineBistro = () => (
  <RestaurantPage
    restaurantName="Zinfandel Food & Wine bistro"
    address="Marulićeva ul. 2, Split, 21000, Croatia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+38521355135"
    website="https://www.zinfandelfoodandwinebar.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a narrow street in the old town, this busy, welcoming restaurant is open from breakfast to dinner, when live music adds to the atmosphere. The menu is focused on Dalmatian cuisine with seasonal and fresh ingredients. The well-curated wine list covers the whole of Croatia, with around 15 wines also available by the glass...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Maruli%C4%87eva%20ul.%202%2C%20Split%2C%2021000%2C%20Croatia"
    pageTitle="Zinfandel Food & Wine bistro"
  />
);

export default ZinfandelFoodWineBistro;
