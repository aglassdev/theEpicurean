...
const Kuina = () => (
  <RestaurantPage
    restaurantName="K.užina"
    address="Ul. Kraj Svete Marije 1, Split, 21000, Croatia"
    cuisine="Mediterranean Cuisine, Regional Cuisine"
    priceRange="€€"
    phoneNumber="+385916060973"
    website="https://restaurantk-uzina.hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in a quiet alley near Split's central square, the restaurant has a fantastic location: central yet peaceful. Externally it may go unnoticed, but the interior features elegant details, and the courtyard has a large, tranquil outdoor patio. The restaurant offers a wide à la carte selection, capable of satisfying all tastes. The small, open kitchen is run by a talented chef whose offerings are fresh and thoughtful, with dishes that combine regional and modern influences. The presentation is pleasing, the portions are generous, and the value for money is attractive. The service, always friendly and attentive, makes guests feel welcome and cared for...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ul.%20Kraj%20Svete%20Marije%201%2C%20Split%2C%2021000%2C%20Croatia"
    pageTitle="K.užina"
  />
);

export default Kuina;
