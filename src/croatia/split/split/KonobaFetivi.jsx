...
const KonobaFetivi = () => (
  <RestaurantPage
    restaurantName="Konoba Fetivi"
    address="Tomića Stine 4, Split, 21000, Croatia"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+38521355152"
    website="https://www.facebook.com/KonobaFetivi/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A very popular restaurant in the city, which is well worth a visit for its traditional cuisine served in a simple yet beautifully kept dining room. The menu features unpretentious Mediterranean fish dishes and traditional meat specialities, with ingredients purchased fresh from the local market every day. Among the desserts, don’t miss the delicious dried fig and walnut cake. The friendly welcome from all the staff is an added attraction!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Tomi%C4%87a%20Stine%204%2C%20Split%2C%2021000%2C%20Croatia"
    pageTitle="Konoba Fetivi"
  />
);

export default KonobaFetivi;
