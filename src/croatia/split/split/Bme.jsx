...
const Bme = () => (
  <RestaurantPage
    restaurantName="BÒME"
    address="Ul. Dinka Šimunovića 14a, Split, 21000, Croatia"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+385996519383"
    website="https://bome.hr"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the lively and densely populated Trstenik neighborhood, this small, well-kept restaurant stands out for its colorful, elegant furnishings, as well as a pleasant covered terrace for dining during the warmer months. In the kitchen, chef and owner Mario Omrčen offers a modern Mediterranean cuisine, characterized by well-balanced flavors and textures that play a fundamental role. In the dining room, the young, dynamic Franciska will make you feel at home, providing a precise and attentive service. The wine list is also very interesting, featuring a selection of small Croatian producers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ul.%20Dinka%20%C5%A0imunovi%C4%87a%2014a%2C%20Split%2C%2021000%2C%20Croatia"
    pageTitle="BÒME"
  />
);
