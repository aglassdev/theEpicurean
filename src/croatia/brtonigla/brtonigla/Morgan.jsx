...
const Morgan = () => (
  <RestaurantPage
    restaurantName="Morgan"
    address="Bracanija 1, Brtonigla, 52474, Croatia"
    cuisine="Traditional Cuisine, Seasonal Cuisine"
    priceRange="€€€"
    phoneNumber="+38552774520"
    website="https://www.morgan.hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the green heart of Istria, this long-established, family-run hotel-restaurant boasts a welcoming dining room plus an attractive summer terrace looking out at the countryside. The regional cuisine served here closely follows the seasons, with game, mushrooms and truffles making an appearance in autumn, and vegetables and fresh cheeses in spring. Throughout the year, you can enjoy delicious Istrian hams and homemade pasta, including the tasty asparagus-filled ravioli served with grilled asparagus...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Bracanija%201%2C%20Brtonigla%2C%2052474%2C%20Croatia"
    pageTitle="Morgan"
  />
);
