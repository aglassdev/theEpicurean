...
const ZlatneGorice = () => (
  <RestaurantPage
    restaurantName="Zlatne Gorice"
    address="Ul. Banjščina 104, Varaždin Breg, 42204, Croatia"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+38542666054"
    website="https://www.zlatne-gorice.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in a picturesque and relaxing setting of rolling hills, vineyards and charming villas, this restaurant is part of a wine estate. The cuisine focuses on regional specialities with an emphasis on meat, including a wide array of grilled dishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ul.%20Banj%C5%A1%C4%8Dina%20104%2C%20Vara%C5%BEdin%20Breg%2C%2042204%2C%20Croatia"
    pageTitle="Zlatne Gorice"
  />
);

export default ZlatneGorice;
