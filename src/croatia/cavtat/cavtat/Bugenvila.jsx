...
const Bugenvila = () => (
  <RestaurantPage
    restaurantName="Bugenvila"
    address="Put dr. Ante Starčevića 9, Cavtat, 20210, Croatia"
    cuisine="Mediterranean Cuisine"
    priceRange="€€€"
    phoneNumber="+38520479949"
    website="https://www.bugenvila.eu/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This long-established restaurant situated in the charming village of Cavtat stands on the seafront promenade facing the harbour. Its delightful terrace adorned with sweetly scented bougainvillea, geraniums and jasmine has a truly romantic feel, while the cuisine served here focuses on authentic, unfussy Mediterranean dishes made from high-quality meat and fish. Booking ahead is recommended...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Put%20dr.%20Ante%20Star%C4%8Devi%C4%87a%209%2C%20Cavtat%2C%2020210%2C%20Croatia"
    pageTitle="Bugenvila"
  />
);

export default Bugenvila;
