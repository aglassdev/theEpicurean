...
const Tekka = () => (
  <RestaurantPage
    restaurantName="Tekka"
    address="Radnička cesta 37b, Zagreb, 10000, Croatia"
    cuisine="Japanese, Asian"
    priceRange="€€"
    phoneNumber="+38516389398"
    website="https://tekka.hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A small Japanese restaurant with a modern feel and an open-view kitchen that allows guests to watch the chefs at work. Traditional Japanese specialities such as nigiri, uramaki, hosomaki and sashimi are to the fore, as well as tempura and teppanyaki and other Asian options including stir-fries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Radni%C4%8Dka%20cesta%2037b%2C%20Zagreb%2C%2010000%2C%20Croatia"
    pageTitle="Tekka"
  />
);

export default Tekka;
