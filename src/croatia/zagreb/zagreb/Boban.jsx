...
const Boban = () => (
  <RestaurantPage
    restaurantName="Boban"
    address="Gajeva 9, Zagreb, 10 000, Croatia"
    cuisine="Traditional Cuisine"
    priceRange="€€"
    phoneNumber="+38514811549"
    website="https://www.boban.hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the heart of the pedestrianised area of the historic centre, Boban is a delightful, recently renovated restaurant which serves Mediterranean-style Italian cuisine. The starters are particularly delicious, while the main courses include fish, seafood and meat dishes. There’s also a good wine selection, with an emphasis on champagnes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gajeva%209%2C%20Zagreb%2C%2010%20000%2C%20Croatia"
    pageTitle="Boban"
  />
);
