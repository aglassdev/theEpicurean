...
const Zinfandels = () => (
  <RestaurantPage
    restaurantName="Zinfandel's"
    address="Mihanovićeva Ulica 1, Zagreb, 10000, Croatia"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+38514566644"
    website="https://www.zinfandels.hr/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated in the Hotel Esplanade, which dates back to 1925 and is one of the most luxurious hotels in Zagreb, Zifandel's cuisine has been overseen by chef Ana Grgić for the past ten years. She reinterprets Mediterranean traditions in a creative and personalised style, with a focus on local, seasonal ingredients...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Mihanovi%C4%87eva%20Ulica%201%2C%20Zagreb%2C%2010000%2C%20Croatia"
    pageTitle="Zinfandel's"
  />
);

export default Zinfandels;
