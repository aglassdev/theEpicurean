...
const RestaurantMare = () => (
  <RestaurantPage
    restaurantName="Restaurant Mare"
    address="Lučica 11, Trogir, 21220, Croatia"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+385917884384"
    website="https://www.maretrogir.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated on the island of Čiovo, just a 5-minute walk from the historic centre of Trogir, this restaurant is part of the Hotel Bifora Heritage, a 14C building that was restored in 2016. Here, chef Robert Predag Zmire uses modern techniques to create delicious cuisine from fine ingredients. Although fish takes centre stage, there’s also a choice of meat dishes and a few vegan options. The dishes are carefully prepared and full of flavour, including options such as cuttlefish tagliatelle with a wild herb pesto, sea asparagus, lemon pearls and prawn chips, and the extremely fresh sea bass ikejime served with celery and a parsley sauce. Although the wine list is not particularly extensive, it offers good value for money and includes many Croatian wines available by the glass. A welcoming resta..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lu%C4%8Dica%2011%2C%20Trogir%2C%2021220%2C%20Croatia"
    pageTitle="Restaurant Mare"
  />
);

export default RestaurantMare;
