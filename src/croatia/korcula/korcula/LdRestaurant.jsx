...
const LdRestaurant = () => (
  <RestaurantPage
    restaurantName="LD Restaurant"
    address="Don Pavla Poše 1-6, Korcula, 20260, Croatia"
    cuisine="Modern Cuisine, Mediterranean Cuisine"
    priceRange="€€€€"
    phoneNumber="+38520601726"
    website="https://www.ldrestaurant.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="With the freshest catch, seasonal vegetables and local extra virgin olive oil, Marko Gajski builds a refined cuisine that cleverly combines Dalmatian ingredients, Eastern suggestions, French-style sauces and well-calibrated fermentations. The creative and flavourful dishes are the result of solid technique and recount a personal and consistent gastronomic journey. The service, which is always professional and attentive, takes place in the elegant contemporary room on the second floor, or – during the summer season – a few metres from the sea, with a romantic view of the water and surrounding islands. The restaurant's iconic dishes include shrimp gyoza with mousseline sauce and daikon – a refined and appealing dish that is always on the tasting menu. A vegetarian menu is also available. The..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Don%20Pavla%20Po%C5%A1e%201-6%2C%20Korcula%2C%2020260%2C%20Croatia"
    pageTitle="LD Restaurant"
  />
);

export default LdRestaurant;
