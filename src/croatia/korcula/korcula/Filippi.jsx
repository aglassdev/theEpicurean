...
const Filippi = () => (
  <RestaurantPage
    restaurantName="Filippi"
    address="Šetalište Petra Kanavelića, Korcula, 20260, Croatia"
    cuisine="Mediterranean Cuisine, Regional Cuisine"
    priceRange="€€€"
    phoneNumber="+38598275701"
    website="https://www.restaurantfilippi.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Along the Old Town promenade, the open-air service overlooks the Pelješac channel and the islands of the Korčula archipelago, shaded by large Calabrian pines that add to the atmosphere. The cuisine, Mediterranean, classic and straightforward, is entrusted to chef Ivan Uglik who, with his commitment and knowledge of the craft, carries on the restaurant's usual high standard, focusing on high-quality regional and seasonal products. In addition to the classic five-course tasting menu, you can choose from a three- or four-course à la carte selection or opt for a five-course vegan menu. The small but carefully curated wine list focuses on the areas of Korčula, Hvar and Pelješac, with an emphasis on lesser-known producers. Excellent sea bass fillet with mashed peas, fennel and potatoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C5%A0etali%C5%A1te%20Petra%20Kanaveli%C4%87a%2C%20Korcula%2C%2020260%2C%20Croatia"
    pageTitle="Filippi"
  />
);

export default Filippi;
