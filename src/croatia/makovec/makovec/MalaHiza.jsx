...
const MalaHiza = () => (
  <RestaurantPage
    restaurantName="Mala Hiza"
    address="Balogovec, 1, Mačkovec, 40000, Croatia"
    cuisine="Regional Cuisine"
    priceRange="€€"
    phoneNumber="+38540341101"
    website="https://mala-hiza.hr/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Occupying a late-19C house surrounded by a beautiful garden with a fountain and small stream, this friendly restaurant run by its owner-chef and his family boasts a romantic ambience. The cuisine is regional in style, with a focus on local ingredients and dishes accompanied by local wines. Appetisers include stuffed pasta, while meat options (especially beef and lamb) dominate the main courses. To finish your meal in style, why not try the gibanica, a popular local dessert made with layers of shortcrust pastry, fresh cheese, eggs and pumpkin...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Balogovec%2C%201%2C%20Ma%C4%8Dkovec%2C%2040000%2C%20Croatia"
    pageTitle="Mala Hiza"
  />
);

export default MalaHiza;
