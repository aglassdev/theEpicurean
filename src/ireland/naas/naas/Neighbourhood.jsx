...
const Neighbourhood = () => (
  <RestaurantPage
    restaurantName="Neighbourhood"
    address="1 North Main Street, Naas, W91 RH96, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+35345954466"
    website="https://www.neighbourhoodnaas.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A pool of young but experienced talent came together to create this contemporary restaurant out of a former pub on the town's main street. The menu is so appealing you’ll have trouble choosing; all the dishes, which rely on superb produce, are comforting and satisfying, with some of the larger options designed for sharing. The bar upstairs offers a small plates menu as an alternative dining option. The service team are full of energy and really help to bring the room alive...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=1%20North%20Main%20Street%2C%20Naas%2C%20W91%20RH96%2C%20Ireland"
    pageTitle="Neighbourhood"
  />
);
