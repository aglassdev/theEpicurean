...
const Babade = () => (
  <RestaurantPage
    restaurantName="Baba'de"
    address="The Mews, Baltimore, P81 TC64, Ireland"
    cuisine="Turkish"
    priceRange="€€"
    phoneNumber="+3532848112"
    website="https://www.babade.ie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a name meaning ‘Baby Dede’, this second Baltimore venture from Chef Ahmet Dede is an ode to his family and comes with all the homespun charm you’d expect. Located mere feet away from his acclaimed flagship restaurant, this is a more relaxed affair but the great value sharing plates retain the older sibling’s ethos of Turkish flavours married with Irish produce. Each dish – from a unique take on oyster chowder to Ahmet’s signature ‘içli köfte’ – is bright, fresh and wholly satisfying...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Mews%2C%20Baltimore%2C%20P81%20TC64%2C%20Ireland"
    pageTitle="Baba'de"
  />
);

export default Babade;
