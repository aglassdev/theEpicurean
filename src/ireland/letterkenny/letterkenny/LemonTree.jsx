...
const LemonTree = () => (
  <RestaurantPage
    restaurantName="Lemon Tree"
    address="Unit 32-34, The Courtyard Shopping Centre, Lower Main Street, Letterkenny, F92 EK13, Ireland"
    cuisine="Regional Cuisine"
    priceRange="€"
    phoneNumber="+353749125788"
    website="https://www.thelemontreerestaurant.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="One of the best things about a proper local restaurant like this is that you come away feeling well fed and well looked after. The Lemon Tree is a true family-run place, with siblings and cousins working together to deliver a heartening experience. It's run with great pride and big, beaming smiles to ensure you feel welcome, while the clean, modern cooking delivers on the restaurant's mission to show off the best produce from County Donegal, whether that be meat, fish or vegetables from Ballyholey Farm up the road. The salted caramel tart is a delicious way to finish...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%2032-34%2C%20The%20Courtyard%20Shopping%20Centre%2C%20Lower%20Main%20Street%2C%20Letterkenny%2C%20F92%20EK13%2C%20Ireland"
    pageTitle="Lemon Tree"
  />
);
