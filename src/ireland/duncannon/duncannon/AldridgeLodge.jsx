...
const AldridgeLodge = () => (
  <RestaurantPage
    restaurantName="Aldridge Lodge"
    address="Aldridge Lodge, Duncannon, Y34 W650, Ireland"
    cuisine="Country cooking"
    priceRange="€€"
    phoneNumber="+35351389116"
    website="https://www.aldridgelodge.com"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Aldridge%20Lodge%2C%20Duncannon%2C%20Y34%20W650%2C%20Ireland"
    pageTitle="Aldridge Lodge"
  />
);

export default AldridgeLodge;
