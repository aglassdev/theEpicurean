...
const Landline = () => (
  <RestaurantPage
    restaurantName="Landline"
    address="Shelbourne Street, Kenmare, V93 X3XY, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+353646641200"
    website="https://www.parkkenmare.com/dining/landline"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated within the grand Park Hotel, overlooking Kenmare Bay, this elegant dining room comes with the added bonus of being decorated with original paintings by Irish artist Sean Scully – the restaurant is even named after one of his works. The kitchen showcases a bounty of prime Irish produce, embellishing it with precise, well-judged accompaniments – a lovely mussel and dulse sauce with halibut is a prime example. Oenophiles will appreciate the strong choice of classic vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Shelbourne%20Street%2C%20Kenmare%2C%20V93%20X3XY%2C%20Ireland"
    pageTitle="Landline"
  />
);
