...
const ThePullman = () => (
  <RestaurantPage
    restaurantName="The Pullman"
    address="Glenlo Abbey Hotel & Estate, Bushypark, Galway, H91 XD8K, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+35391519600"
    website="https://www.glenloabbeyhotel.ie/the-pullman.html"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A pair of lovingly restored Orient Express carriages dating back nearly 100 years are the impossibly elegant setting for Chef Angelo Vagiotis’ exquisite cooking. Settled on the Glenlo Abbey Estate, the views over the golf course and Lough Corrib cement this as a memory-making experience. Playing just as important a role is the food, showcasing the best Irish produce in beautifully balanced dishes like wild turbot with Oscietra caviar and a champagne and vanilla sauce. The service is equally delightful, as unstuffy as it is attentive. For an intimate celebration, book the individual 'Agatha Christie' compartment...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Glenlo%20Abbey%20Hotel%20%26%20Estate%2C%20Bushypark%2C%20Galway%2C%20H91%20XD8K%2C%20Ireland"
    pageTitle="The Pullman"
  />
);

export default ThePullman;
