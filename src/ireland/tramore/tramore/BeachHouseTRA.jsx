...
const BeachHouseTRA = () => (
  <RestaurantPage
    ...
    address="Turkey Road, Tramore, X91 Y521, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+35351338270"
    website="https://beachhousetramore.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Situated enviably close to the beach in a small seaside town on Ireland's south coast is a double-fronted Victorian residence looking out over an attractive garden – and in the basement, its owners lovingly run this sweet bistro. The concise menu of classic, flavour-packed dishes understandably gives seafood prime billing; the fish and chips is one of the best versions of the dish you can find, with super-fresh fish that changes depending on the day's catch, served with perfectly crisped chips. The cellar wine list has some interesting vintages...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Turkey%20Road%2C%20Tramore%2C%20X91%20Y521%2C%20Ireland"
    pageTitle="Beach House"
  />
);

export default BeachHouseTRA;
