...
const SaintFrancisProvisions = () => (
  <RestaurantPage
    restaurantName="Saint Francis Provisions"
    address="Short Quay, Kinsale, P17 T880, Ireland"
    cuisine="Mediterranean Cuisine"
    priceRange="€€"
    phoneNumber="+353830168652"
    website="https://saintfrancisprovisions.squarespace.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There's just something so loveable about this laid-back little restaurant in the centre of a colourful coastal town. That's largely down to the friendly and genuine service team, along with a wonderful buzz inside the small dining room that holds just 15 seats – the heated terrace is also a great place to sit. The concise, daily changing menu offers a range of Mediterranean-inspired sharing plates such as cod with confit red pepper; top local produce is an underlying theme, as are punchy flavours and a welcome simplicity. An all-natural wine list completes the picture...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Short%20Quay%2C%20Kinsale%2C%20P17%20T880%2C%20Ireland"
    pageTitle="Saint Francis Provisions"
  />
);

export default SaintFrancisProvisions;
