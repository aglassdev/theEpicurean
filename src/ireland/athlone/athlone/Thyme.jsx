...
const Thyme = () => (
  <RestaurantPage
    restaurantName="Thyme"
    address="Custume Place, Strand Street, Athlone, N37F1W4, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+353906478850"
    website="https://www.thymerestaurant.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The chef-owner here is one who’s constantly reinvesting in his beloved restaurant and is always on the search for great new local suppliers – whether that’s fresh vegetables or free-range pork – and the pride he has in his establishment is palpable. The two menus showcase the locality well, with dishes that are satisfying and flavoursome. Do try the cheeses, which are accompanied by homemade crackers made using grains from the brewery next door...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Custume%20Place%2C%20Strand%20Street%2C%20Athlone%2C%20N37F1W4%2C%20Ireland"
    pageTitle="Thyme"
  />
);
