...
const Adrift = () => (
  <RestaurantPage
    restaurantName="Adrift"
    address="Dunmore House, Dunmore, P85 HC03, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€"
    phoneNumber="+353238833352"
    website="https://www.dunmorehousehotel.ie/adrift-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by the fourth generation of the owners’ family, this restaurant is set in an enviable position on the ground floor of the Dunmore House Hotel with views out over Clonakilty Bay. As you'd expect in such a location, fish and shellfish – such as Galley Head lobster – play a large role in the menu, as does other locally sourced produce and ingredients from their own organic kitchen garden. This is all fashioned into bright, fresh-tasting dishes that have an appealing lack of fuss and deliver on flavour...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Dunmore%20House%2C%20Dunmore%2C%20P85%20HC03%2C%20Ireland"
    pageTitle="Adrift"
  />
);

export default Adrift;
