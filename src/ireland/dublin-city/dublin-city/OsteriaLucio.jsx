...
const OsteriaLucio = () => (
  <RestaurantPage
    restaurantName="Osteria Lucio"
    address="The Malting Tower, Grand Canal Dock, Clanwilliam Terrace, Dublin City, D02 DW90, Ireland"
    cuisine="Italian"
    priceRange="€€€"
    phoneNumber="+35316624198"
    website="https://osterialucio.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located under the railway arches, this elegant restaurant comes with a lively ambience and a roll-call of recognisable Italian dishes. You could start proceedings with bruschetta or arancini before moving onto a choice of pastas, while suckling pig cooked 'al forno' has become something of a signature. Each dish is prepared with care using quality produce and in turn delivers plenty of flavour. The food is accompanied by an all-Italian wine list and a good selection of cocktails...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Malting%20Tower%2C%20Grand%20Canal%20Dock%2C%20Clanwilliam%20Terrace%2C%20Dublin%20City%2C%20D02%20DW90%2C%20Ireland"
    pageTitle="Osteria Lucio"
  />
);

export default OsteriaLucio;
