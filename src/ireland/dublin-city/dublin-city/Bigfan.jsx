...
const Bigfan = () => (
  <RestaurantPage
    restaurantName="BIGFAN"
    address="16 Aungier Street, Dublin City, D02 X044, Ireland"
    cuisine="Asian, Chinese"
    priceRange="€€"
    phoneNumber="+35315388886"
    website="https://www.bigfan.ie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With is colourful décor, bright lights and a loud, lively atmosphere, BIGFAN is Big Fun, so start with a cocktail, tick plenty of dishes on the list on your table, tuck in and enjoy. The authentic small plates take their influences from China and Taiwan; so expect dumplings, bao buns and xiao chi all delivering a wonderful freshness and generosity. The traditional 'Couples Beef', for instance, utilising overlooked offal ingredients, uses a brilliantly judged combination of condiments to elevate the produce. It's all excellent value for money and the efficient service team are a delight...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=16%20Aungier%20Street%2C%20Dublin%20City%2C%20D02%20X044%2C%20Ireland"
    pageTitle="BIGFAN"
  />
);
