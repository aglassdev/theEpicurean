...
const ThePigsEar = () => (
  <RestaurantPage
    restaurantName="The Pig's Ear"
    address="4 Nassau Street, Dublin City, D02 YX74, Ireland"
    cuisine="Irish"
    priceRange="€€"
    phoneNumber="+35316703865"
    website="https://www.thepigsear.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="For a traditional taste of Ireland, you need look no further. Chef-Owner Stephen McAllister has dived deep into his grandmother's recipe book and centuries of Irish history for the latest incarnation of his welcoming restaurant, which occupies a tall and narrow townhouse overlooking Trinity College Park. The menu combines a love of classic, soul-warming cooking with a playful touch, resulting in dishes like Boxty Pancake and Dublin Lawyer Lobster Omelette – while the quality produce and careful execution are evident in full-flavoured options like the Tongue 'n' Cheek Suet Pudding...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=4%20Nassau%20Street%2C%20Dublin%20City%2C%20D02%20YX74%2C%20Ireland"
    pageTitle="The Pig's Ear"
  />
);

export default ThePigsEar;
