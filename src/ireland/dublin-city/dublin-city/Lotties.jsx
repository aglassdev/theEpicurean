...
const Lotties = () => (
  <RestaurantPage
    restaurantName="Lottie's"
    address="7-9 Rathgar Road, Rathmines, Dublin City, D06 R971, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+35315585969"
    website="https://lotties.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There’s a terrific buzz in the air at this stylish brasserie-style restaurant, where the unfussy cooking is a fine accompaniment to the lively surroundings. Irish produce is the bedrock of the menu, in hearty, flavour-packed dishes like Andarl Farm pork chop with cabbage & violet mustard, parsnip and a cider jus. The early evening menu is a steal and an extensive choice of cocktails are on hand to kick things off...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=7-9%20Rathgar%20Road%2C%20Rathmines%2C%20Dublin%20City%2C%20D06%20R971%2C%20Ireland"
    pageTitle="Lottie's"
  />
);
