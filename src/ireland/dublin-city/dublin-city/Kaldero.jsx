...
const Kaldero = () => (
  <RestaurantPage
    restaurantName="Kaldero"
    address="Unit 4B, Stephen’s Green Shopping Centre, King Street South, Dublin 2, Dublin City, D02 HD30, Ireland"
    cuisine="Filipino"
    priceRange="€€"
    phoneNumber="+35314782152"
    website="https://kaldero.ie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Keep your eye out for this Filipino restaurant’s discrete entrance as you walk down King St South, because to miss its warm atmosphere and flavour-packed cooking would be a crying shame. Situated in a welcoming basement, its best seats are near the open kitchen, where you can feel the infectious buzz of the chefs. The menu is designed for sharing, so bring a few friends and try as many of the Filipino-Irish chef’s dishes as possible; look out for big, punchy flavours in the likes of ‘Dynamite Lumpia’ – chillis stuffed with pork mince...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Unit%204B%2C%20Stephen%E2%80%99s%20Green%20Shopping%20Centre%2C%20King%20Street%20South%2C%20Dublin%202%2C%20Dublin%20City%2C%20D02%20HD30%2C%20Ireland"
    pageTitle="Kaldero"
  />
);

export default Kaldero;
