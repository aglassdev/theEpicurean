...
const MrFox = () => (
  <RestaurantPage
    restaurantName="Mr Fox"
    address="38 Parnell Square West, Dublin City, DO1 X9TO, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+35318747778"
    website="https://www.mrfox.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A welcoming restaurant with a charming team and a lovely tiled floor, set in the basement of a striking red-brick Georgian house. The well-priced set menu showcases wonderful Irish produce and the tasty, modern dishes are skilfully enhanced by global flavours...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=38%20Parnell%20Square%20West%2C%20Dublin%20City%2C%20DO1%20X9TO%2C%20Ireland"
    pageTitle="Mr Fox"
  />
);

export default MrFox;
