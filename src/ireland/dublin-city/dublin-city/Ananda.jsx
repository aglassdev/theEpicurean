...
const Ananda = () => (
  <RestaurantPage
    restaurantName="Ananda"
    address="Cinema Building, Sandyford Road, Dundrum Town Centre, Dublin City, D16 VK54, Ireland"
    cuisine="Indian"
    priceRange="€€"
    phoneNumber="+35312960099"
    website="https://www.anandarestaurant.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Its name means ‘bliss’ and this smart Indian restaurant certainly feels like a haven from the bustling shopping centre in which it sits. Accessed via a narrow entrance, it's a sizeable place inside with a swish cocktail bar – and is stylishly decorated with attractive fretwork and vibrant art. The combination of accomplished, original cooking and assured, attentive service makes for a great all-round package. The ‘Railway Journey’ tasting menu is encouraged and is certainly the way to go if you want to sample as much of the cooking as possible...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cinema%20Building%2C%20Sandyford%20Road%2C%20Dundrum%20Town%20Centre%2C%20Dublin%20City%2C%20D16%20VK54%2C%20Ireland"
    pageTitle="Ananda"
  />
);

export default Ananda;
