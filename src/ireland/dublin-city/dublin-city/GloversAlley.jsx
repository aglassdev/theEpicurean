...
const GloversAlley = () => (
  <RestaurantPage
    restaurantName="Glovers Alley"
    address="The Fitzwilliam Hotel, 127-128 St. Stephen’s Green, Dublin City, D02 HE18, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+35312440733"
    website="https://gloversalley.com/"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Set in a prime spot on the second floor of The Fitzwilliam Hotel, overlooking St Stephen’s Green, is this chic, elegant restaurant with subtle 1930s overtones. Pink and green hues and pretty flower arrangements bring a certain softness to the surroundings; in contrast, Andy McFadden’s cooking is characterised by boldness – both in its flavours and textures – and his experience shines through in skilfully prepared, artfully presented dishes that put subtle creative twists on the classics, such as a mini 'pastilla' of squab pigeon or île flottante with the addition of delicate forced rhubarb...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=The%20Fitzwilliam%20Hotel%2C%20127-128%20St.%20Stephen%E2%80%99s%20Green%2C%20Dublin%20City%2C%20D02%20HE18%2C%20Ireland"
    pageTitle="Glovers Alley"
  />
);

export default GloversAlley;
