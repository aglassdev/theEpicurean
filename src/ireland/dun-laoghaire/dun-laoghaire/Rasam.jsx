...
const Rasam = () => (
  <RestaurantPage
    restaurantName="Rasam"
    address="18-19 Glasthule Road, Dun Laoghaire, A96 H2N1, Ireland"
    cuisine="Indian"
    priceRange="€€"
    phoneNumber="+35312300600"
    website="https://www.rasam.ie"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The scent of roses greets you as you head up to the surprisingly plush lounge and contemporary restaurant. Fresh, authentic dishes come in original combinations and they dry roast and blend their own spices. You must order the breads; the peshwari naan is delicious!..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=18-19%20Glasthule%20Road%2C%20Dun%20Laoghaire%2C%20A96%20H2N1%2C%20Ireland"
    pageTitle="Rasam"
  />
);
