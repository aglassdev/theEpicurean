...
const TheBishopsButtery = () => (
  <RestaurantPage
    restaurantName="The Bishop's Buttery"
    address="Cashel Palace Hotel, Main Street, Cashel, E25 EF61, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+3536262002"
    website="https://www.cashelpalacehotel.ie/dining/the-bishops-buttery"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="A vaulted ceiling and flagstone floors combine with sumptuous, colourful furnishings at this striking restaurant packed with both character and luxury. It helps, of course, that it’s located in the cellars of Cashel Palace, a magnificent Palladian manor house which was once home to the Archbishops of Cashel. The various sitting rooms are ideal for a pre-dinner drink, but it's hard to look past a pint of the black stuff in the intimate Guinness Bar. The cooking puts local suppliers to the fore, extracting superb natural flavours from the likes of beef fillet from the town butcher...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Cashel%20Palace%20Hotel%2C%20Main%20Street%2C%20Cashel%2C%20E25%20EF61%2C%20Ireland"
    pageTitle="The Bishop's Buttery"
  />
);

export default TheBishopsButtery;
