...
const TheMorrisonRoom = () => (
  <RestaurantPage
    restaurantName="The Morrison Room"
    address="Carton House, Carton Demesne, Maynooth, W23 TD98, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€€€"
    phoneNumber="+35315052000"
    website="https://www.cartonhouse.com/dining/the-morrison-room"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="We all need a little luxury in our lives and this beautiful restaurant in the heart of the impressive Carton House mansion ticks all the boxes. The breathtaking room features a high curved ceiling, Greek Corinthian columns, ornate plaster cornicing and sweeping banquettes, while the menu matches it for opulence with an abundance of first-rate produce, be it Union Hall crab or Achill lamb. The cooking is rooted in the chefs’ strong classical technique, but some wildcard flavour combinations work wonders thanks to their fine judgement...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carton%20House%2C%20Carton%20Demesne%2C%20Maynooth%2C%20W23%20TD98%2C%20Ireland"
    pageTitle="The Morrison Room"
  />
);

export default TheMorrisonRoom;
