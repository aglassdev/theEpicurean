...
const VaughansAnchorInn = () => (
  <RestaurantPage
    restaurantName="Vaughan's Anchor Inn"
    address="Main Street, Liscannor, V95 FN5R, Ireland"
    cuisine="Seafood"
    priceRange="€€€"
    phoneNumber="+353657081548"
    website="https://www.vaughans.ie"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Main%20Street%2C%20Liscannor%2C%20V95%20FN5R%2C%20Ireland"
    pageTitle="Vaughan's Anchor Inn"
  />
);

export default VaughansAnchorInn;
