...
const BonAppetit = () => (
  <RestaurantPage
    restaurantName="Bon Appetit"
    address="9 St. James's Terrace, Malahide, K36 KR66, Ireland"
    cuisine="Modern Cuisine"
    priceRange="€€"
    phoneNumber="+35318450314"
    website="https://www.bonappetit.ie/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This smart Georgian terraced house near the harbour is home to a contemporary brasserie with a lively atmosphere. Modern dishes have a classical French base and plenty of Asian influences. The intimate cellar bar offers afternoon tea, with brunch available at weekends...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=9%20St.%20James's%20Terrace%2C%20Malahide%2C%20K36%20KR66%2C%20Ireland"
    pageTitle="Bon Appetit"
  />
);
