...
const OpheliaELS = () => (
  <RestaurantPage
    restaurantName="Ophelia"
    address="Carr. Tijuana-Ensenada 103, El Sauzal de Rodríguez, 22760, Mexico"
    cuisine="Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+526461758365"
    website="https://guide.michelin.com/en/baja-california/el-sauzal-de-rodriguez_2059793/restaurant/ophelia-1210917"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="El Sauzal de Rodríguez's restaurants are typically laser-focused on seafood, but Ophelia offers something a little different. This spot with light walls, wood ceiling, and dark tiled floor, features a Mediterranean-themed menu with items ranging from salads, pastas, and pizza to entrees like roasted octopus, fish in mole, roasted quail, and lamb shank. Lasana de Susana, named for the chef's mother, is presented in a cast iron skillet. Its layers of fresh pasta are loaded with a coarsely ground meat ragu studded with diced mushrooms, and a rich cheese for a deliciously comforting dish that is accompanied by a refreshing green salad with sliced cucumber and cherry tomatoes in a creamy cilantro dressing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Tijuana-Ensenada%20103%2C%20El%20Sauzal%20de%20Rodr%C3%ADguez%2C%2022760%2C%20Mexico"
    pageTitle="Ophelia"
  />
);

export default OpheliaELS;
