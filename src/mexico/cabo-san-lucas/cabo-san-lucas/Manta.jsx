...
const Manta = () => (
  <RestaurantPage
    restaurantName="Manta"
    address="Carr. Federal 1 Km. 5, Fracc. A, L-21, Cabo San Lucas, 23456, Mexico"
    cuisine="Mexican, Fusion"
    priceRange="$$$$"
    phoneNumber="+526241630010"
    website="https://www.mantarestaurant.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set within the Cape Hotel in a stunning space that frames picture-perfect views of Cabo's famed Lands End, this modern dining room under Enrique Olvera's umbrella isn't just impressing with its good looks. The contemporary Mexican cuisine is punctuated by clear Peruvian and Japanese influences. Offered as a tasting menu and à la carte, expect bold dishes from a kitchen that's unafraid of bringing the heat. Begin with sashimi or a Peruvian ceviche before savoring a refreshing melon salad with diced honeydew and cantaloupe in a leche de tigre fueled by yuzu. Next, a sweet potato with a tamarind and soy crust in an almond mole is at once simple and elegant. From Korean fried chicken and tempura fish tacos to cochinita served in bao buns, Asian accents run from beginning to end on the à la car..."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Federal%201%20Km.%205%2C%20Fracc.%20A%2C%20L-21%2C%20Cabo%20San%20Lucas%2C%2023456%2C%20Mexico"
    pageTitle="Manta"
  />
);
