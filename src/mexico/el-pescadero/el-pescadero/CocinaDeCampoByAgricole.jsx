...
const CocinaDeCampoByAgricole = () => (
  <RestaurantPage
    restaurantName="Cocina de Campo by Agricole"
    address="Carr. a Los Cabos Km. 59, El Pescadero, 23310, Mexico"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+526122173734"
    website="https://agricole.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in El Pescadero along the highway that leads from Cabo to Todo Santos, this multi- concept space includes a farm shop, as well as a full-service restaurant, set outside within the garden. The contemporary menu leans Mexican with Californian elements, and the cooking is simplified to allow the ingredients to take center stage. Take the tomatoes, for instance. Layered slices topped with Kalamata olives over a coarse basil pesto prove that the best dishes don't need much intervention. Batter-dipped fried fish or the shaved ribeye are winning taco choices. Then, for dessert, the soft vanilla cake with fresh strawberries and cream sauce is a must. The cocktail menu is strong and creative...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20a%20Los%20Cabos%20Km.%2059%2C%20El%20Pescadero%2C%2023310%2C%20Mexico"
    pageTitle="Cocina de Campo by Agricole"
  />
);

export default CocinaDeCampoByAgricole;
