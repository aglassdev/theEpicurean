...
const TaqueraLosMilanesos = () => (
  <RestaurantPage
    restaurantName="Taquería Los Milanesos"
    address="Veracruz 156, Álvaro Obregón, 01080, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525515202208"
    website="https://guide.michelin.com/en/ciudad-de-mexico/alvaro-obregon_2003790/restaurant/taqueria-los-milanesos"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Far from any tourists, find this taqueria by looking for the orange awning, then following the yellow walkway hung with colorful flags overhead. Or, you could just follow the heady scent of meat. It's a simple space where you'll almost walk through the kitchen to the smattering of tables in the dining room, but you're not here for ambience; you're here for the tacos. These are Milanese-style tacos with breaded and fried pork cutlets sliced into thin strips and piled high atop tender corn tortillas. The meat is flavorful and tender, and with a squeeze of lime and house-made spicy green or smoky red salsa, it's a terrific treat. You won't go home hungry but do come with cash...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Veracruz%20156%2C%20%C3%81lvaro%20Obreg%C3%B3n%2C%2001080%2C%20Mexico"
    pageTitle="Taquería Los Milanesos"
  />
);

export default TaqueraLosMilanesos;
