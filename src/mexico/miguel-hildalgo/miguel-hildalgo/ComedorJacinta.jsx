...
const ComedorJacinta = () => (
  <RestaurantPage
    restaurantName="Comedor Jacinta"
    address="Virgilio 40, Polanco, Miguel Hildalgo, 11550, Mexico"
    cuisine="Mexican, Traditional Cuisine"
    priceRange="$$"
    phoneNumber="+525550866965"
    website="http://www.comedorjacinta.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This cozy restaurant is owned by the renowned chef Edgar Núñez. Here, the premise is traditional cuisine that draws on his childhood memories. The dishes are simple, but tasty, with excellent technique and abundant portions--all at a reasonable price. The menu has a botaneria section, with dishes based on corn, and another section with molcajetes, or dishes made in this traditional mortar from Mesoamerica, accompanied by guacamole and handmade tortillas. Some of the outstanding items include tostada de callo de hacha, tacos de tuétano, and huachinango zarandeado. Flan de cajeta is the perfect dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Virgilio%2040%2C%20Polanco%2C%20Miguel%20Hildalgo%2C%2011550%2C%20Mexico"
    pageTitle="Comedor Jacinta"
  />
);

export default ComedorJacinta;
