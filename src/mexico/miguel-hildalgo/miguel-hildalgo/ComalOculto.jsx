...
const ComalOculto = () => (
  <RestaurantPage
    restaurantName="Comal Oculto"
    address="Gral. Gómez Pedraza 37, San Miguel Chapultepec, Miguel Hildalgo, 11850, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525589882557"
    website="https://guide.michelin.com/en/ciudad-de-mexico/miguel-hidalgo_1999281/restaurant/comal-oculto"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed.On a breezy, tree-lined street in San Miguel Chapultepec, everyone sits shoulder to shoulder at a single communal table stretching the length of two parking spaces. The convivial setting suits this unassuming restaurant, which offers an all-day menu of comforting classics that revolve largely around the comal. A single chef weighs, presses, and griddles everything to order. The gordita especial, packed with chicharron and tender, shredded carnitas, is a favorite. Late night out? Swing for the chilaquiles chamorro with salsa verde and kick it up a notch with the fiery salsa on the table. Other hits include crispy flautas stuffed with melting cheese and a picturesque enmolada covered in a sweet mole poblano. Expect a wait come weekend brunch...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Gral.%20G%C3%B3mez%20Pedraza%2037%2C%20San%20Miguel%20Chapultepec%2C%20Miguel%20Hildalgo%2C%2011850%2C%20Mexico"
    pageTitle="Comal Oculto"
  />
);

export default ComalOculto;
