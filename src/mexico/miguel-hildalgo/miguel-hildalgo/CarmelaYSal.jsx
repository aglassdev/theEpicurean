...
const CarmelaYSal = () => (
  <RestaurantPage
    restaurantName="Carmela y Sal"
    address="Torre Virreyes, Calle Pedregal N. 24, Miguel Hildalgo, 11040, Mexico"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+525520777107"
    website="https://www.carmelaysal.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Carmela y Sal is Chef Gabriela Ruiz Lugo's love letter to her Tabasco roots. She shares so much of her personality in this welcoming, modern restaurant where a kind staff ensures an enjoyable experience. This isn't food that you'll find on every corner. Its distinct personality is memorable, and you'll be back in no time for another terrific meal. Don't miss dishes like the broccoli with spicy sauces, cheese and black piquin chili. Short rib con chirmol is packed with flavor, thanks to the generous sauce, and is a hearty dish intended for big appetites. Mostachón is a simple dessert to round things out...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Torre%20Virreyes%2C%20Calle%20Pedregal%20N.%2024%2C%20Miguel%20Hildalgo%2C%2011040%2C%20Mexico"
    pageTitle="Carmela y Sal"
  />
);

export default CarmelaYSal;
