...
const LaBarraDeFran = () => (
  <RestaurantPage
    restaurantName="La Barra de Fran"
    address="Emilio Castelar, 185, Polanco, Miguel Hildalgo, 11560, Mexico"
    cuisine="Spanish"
    priceRange="$$"
    phoneNumber="+525552806650"
    website="https://www.labarradefran.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Just in case you're unsure of the offerings inside La Barra de Fran, a bull's head is posted right at the entrance as a good reminder that the soul of this place, and its flavors, are decidedly Spanish. It's fashioned after Spain's famed tapas bars, and it's a perfect place to go for a fun night out. Taste the likes of patatas bravas, anchovies on lightly toasted bread with a little oil and tomato, gambas al ajillo, flan, and other classic Spanish food that is all sized for sharing, so be sure to bring a friend—or make a new one...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Emilio%20Castelar%2C%20185%2C%20Polanco%2C%20Miguel%20Hildalgo%2C%2011560%2C%20Mexico"
    pageTitle="La Barra de Fran"
  />
);

export default LaBarraDeFran;
