...
const ErRreUnBistr = () => (
  <RestaurantPage
    restaurantName="Er Rre un Bistró"
    address="Polanco 8, Polanco, Miguel Hildalgo, 11560, Mexico"
    cuisine="International, Contemporary"
    priceRange="$$"
    phoneNumber="+525589741091"
    website="https://www.errreunbistro.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Paying a visit to the National Museum of Anthropology? Plan ahead so you can stop in for a meal at this welcoming spot that enjoys close proximity to the museum. It's small, so reservations are recommended if you want to snag a seat in this classic bistro. It's ideal for a night out with friends, while the bar is always a good choice for those who enjoy watching the chefs at work.The menu is as small as the setting, offering a roster of internationally influenced dishes. Grilled sardines have a Mediterranean flair; Italian influences prevail in pasta dishes; and crêpes suzette shows off a French touch, but all dishes are enhanced with Mexican products...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Polanco%208%2C%20Polanco%2C%20Miguel%20Hildalgo%2C%2011560%2C%20Mexico"
    pageTitle="Er Rre un Bistró"
  />
);

export default ErRreUnBistr;
