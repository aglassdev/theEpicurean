...
const DeckmansEnElMogor = () => (
  <RestaurantPage
    restaurantName="Deckman's En El Mogor"
    address="Carr. Tecate Km 85.5, San Antonio de Las Minas, Valle de Guadalupe, 22766, Mexico"
    cuisine="Mexican"
    priceRange="$$$$"
    phoneNumber="+526461883960"
    website="https://www.deckmans.com/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="It's a short drive off the main road to the Cavas del Mogor property, home of this flagship restaurant. As is common in this region, the dining space is outdoors, built on a platform with tables shaded by trees and a roof lit with cafe lights. In the middle, a live fire kitchen takes center stage. Drew Deckman's cooking is contemporary Mexican, as in a tempura fried soft shell crab on a bed of dressed arugula and sorrel leaves with avocado purée and a Pilsner foam. Main dishes, like the short rib or smoked chicken with potatoes and sauerkraut, lean hearty. Ingredients are top notch and there is a strong commitment to sustainability. Just up the hill is Baja Omakase, Deckman's ode to local sourced fish with Mexican sake...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Tecate%20Km%2085.5%2C%20San%20Antonio%20de%20Las%20Minas%2C%20Valle%20de%20Guadalupe%2C%2022766%2C%20Mexico"
    pageTitle="Deckman's En El Mogor"
  />
);

export default DeckmansEnElMogor;
