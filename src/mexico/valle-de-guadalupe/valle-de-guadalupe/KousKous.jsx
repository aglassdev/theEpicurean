...
const KousKous = () => (
  <RestaurantPage
    restaurantName="Kous Kous"
    address="Carr. Tecate Ensenada, Km 73.30, Valle de Guadalupe, 22750, Mexico"
    cuisine="Moroccan"
    priceRange="$$"
    phoneNumber="+526461516043"
    website="https://www.kouskousdelvalle.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This stunning restaurant with dramatic views may seem like other outdoor spots in the area but keep down the path and a lively space draped with curtains and Moroccan lamps soon appears, revealing the singular experience. Come for an unexpected yet memorable meal spotlighting Moroccan cuisine. There is plenty of heart and loads of flavor in this family-style selection where guests take their pick of protein for the tagine. Kick the meal off with flatbread, made in-house, along with a refreshing cucumber salad. From the chicken with olives to the honey lamb, the tagine offerings are exceptional, but their namesake couscous, with caramelized onions, garbanzo beans and golden raisins, almost steals the show...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Tecate%20Ensenada%2C%20Km%2073.30%2C%20Valle%20de%20Guadalupe%2C%2022750%2C%20Mexico"
    pageTitle="Kous Kous"
  />
);

export default KousKous;
