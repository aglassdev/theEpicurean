...
const Damiana = () => (
  <RestaurantPage
    restaurantName="Damiana"
    address="Viñedos de la Reina, México 3 Supermanzana, Km. 71, Valle de Guadalupe, 22034, Mexico"
    cuisine="Mexican, Fusion"
    priceRange="$$$$"
    phoneNumber="+526463456950"
    website="https://www.damianarestaurant.com"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Damiana boasts a stunning setting, nestled on the Viñedos de la Reina property. Two rows of trees provide shade for the tables lined up on the patio for those who want to dine outdoors. Chef Esteban Lluis celebrates the local valley's products in his multicourse tasting menu that is contemporary Mexican at its core. The kitchen plays with presentation and expectations in fun and creative ways. The dishes are bold and brilliantly executed, as in the perfectly cooked, crispy duck served over pickled cabbage and sided by carrot purée and duck confit wrapped in Swiss chard. Desserts make a lasting impression, especially the pumpkin crème brûlée on a mandarin dacquoise cake or the guava flan with crispy phyllo sheets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Vi%C3%B1edos%20de%20la%20Reina%2C%20M%C3%A9xico%203%20Supermanzana%2C%20Km.%2071%2C%20Valle%20de%20Guadalupe%2C%2022034%2C%20Mexico"
    pageTitle="Damiana"
  />
);

export default Damiana;
