...
const Primitivo = () => (
  <RestaurantPage
    restaurantName="Primitivo"
    address="Carr. Tecate-Ensenada Km. 89, Valle de Guadalupe, 22755, Mexico"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+526469478523"
    website="https://primitivorestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Indeed, the name says it all at this rugged space that's down a dirt road, past a fence draped with wine bottles. and situated under a sprawling oak tree that is three centuries old. The kitchen is anchored by a large fire pit where ingredients are cooked in cast-iron dishes or directly on the flame. Chef Carolina Jimenéz brings a unique approach to this rustic menu rooted in local sourcing. There are oysters to start before guests pick a protein, then savor multiple courses sized for sharing and utilizing every part of the fish or animal. The cooking is earnest, focused, and clever. Dessert is a must, especially that fudgy, flourless chocolate cake with candied orange peel and a quenelle of smoked lavender ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Tecate-Ensenada%20Km.%2089%2C%20Valle%20de%20Guadalupe%2C%2022755%2C%20Mexico"
    pageTitle="Primitivo"
  />
);
