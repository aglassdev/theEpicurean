...
const Vernculo = () => (
  <RestaurantPage
    ...
    address="Av. Cto. Frida Kahlo 303, Valle Oriente, San Pedro Garza García, 66260, Mexico"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+528110388043"
    website="https://www.vernaculo.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Hugo Guajardo showcases Noreste Mexican cuisine here, with local ingredients bolstering traditional recipes cooked over a live fire. Tortillas are made in-house, so take a seat and have some freshly made tostadas and salsa brought to your table as you peruse the seasonally minded menu. Tacos filled with adobo-marinated and fire-roasted pork belly are a sure thing, especially when accompanied by the spicy red salsa and a kicky piquin chile. Carne zaraza is a dry-brined skirt steak that is enlivened with charred onion atop fresh corn tortillas. The accompanying watercress and cilantro salad is as refreshing as the steak is juicy. End the meal with a pastry, like their tarta de nuez, that's served warm with a scoop of piñón ice cream on top...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Cto.%20Frida%20Kahlo%20303%2C%20Valle%20Oriente%2C%20San%20Pedro%20Garza%20Garc%C3%ADa%2C%2066260%2C%20Mexico"
    pageTitle="Vernáculo"
  />
);

export default Vernculo;
