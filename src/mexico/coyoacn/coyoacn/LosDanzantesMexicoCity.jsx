...
const LosDanzantesMexicoCity = () => (
  <RestaurantPage
    restaurantName="Los Danzantes Mexico City"
    address="Parque Centenario 12, Jardín Centenario, Coyoacán, 04000, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$"
    phoneNumber="+525543567185"
    website="https://www.losdanzantescoyoacan.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in downtown Coyoacan, Los Danzantes is often busy with a mix of locals and foreigners. Set in a historic building, this restaurant shines a spotlight on contemporary Mexican cuisine, and the menu is packed with a wide variety of dishes. Chef Alejandro Piñom knows what works--the hoja santa with a base of goat cheese and a miltomate sauce with chile, has been on the menu for more than two decades. Filete de res en chichilo has a hint of smoke from the grill but it's the mole that stands out. Empanada de membrillo pairs quince and cheese for a pleasant taste. Their sister spot in Oaxaca shares the same name but offers a different style and menu...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Parque%20Centenario%2012%2C%20Jard%C3%ADn%20Centenario%2C%20Coyoac%C3%A1n%2C%2004000%2C%20Mexico"
    pageTitle="Los Danzantes Mexico City"
  />
);

export default LosDanzantesMexicoCity;
