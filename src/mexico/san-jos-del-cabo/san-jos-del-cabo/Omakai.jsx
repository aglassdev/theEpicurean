...
const Omakai = () => (
  <RestaurantPage
    restaurantName="Omakai"
    address="Ignacio Zaragoza 1311, San José del Cabo, 23400, Mexico"
    cuisine="Japanese"
    priceRange="$$$$"
    phoneNumber="+526241599383"
    website="https://www.omakai.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located near the heart of San Jose del Cabo, Omakai sports a serene Mexican minimalist design while putting Japanese cuisine front and center. There are three menus to choose from, but whether you choose the teppanyaki tasting menu, the omakase, or select from the a la carte offerings, you can't go wrong. Those who opt for the omakase will find good quality, with many of the fish sourced from the local waters of La Paz and Ensenada. House-made pork belly gyoza are executed flawlessly, while the nigiri leans traditional at first, becoming more complex as the meal progresses. Seared salmon topped with a truffle sauce is decadently delicious. The meal concludes with a charming vanilla ice cream on squares of coffee jelly...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ignacio%20Zaragoza%201311%2C%20San%20Jos%C3%A9%20del%20Cabo%2C%2023400%2C%20Mexico"
    pageTitle="Omakai"
  />
);

export default Omakai;
