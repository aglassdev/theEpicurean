...
const TacosPiedra1 = () => (
  <RestaurantPage
    restaurantName="Tacos Piedra 1"
    address="Lirios 1830, Calle Cerro De La Silla, Monterrey, 64810, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+528115657320"
    website="https://guide.michelin.com/en/nuevo-leon/monterrey_2041973/restaurant/tacos-piedra-1"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located in the Colonia Tecnologico, this long-standing taqueria is best known for one thing—tacos mañaneros, or morning tacos. Order, then find a seat in their clean, organized dining room set with red plastic chairs and tables. They're open early if you're hankering for a breakfast taco filled with eggs and potatoes, but don't skip the chicharron a la Mexicana or their barbacoa, available on corn or flour tortillas. It's all over by 2:00pm, so don't wait too long, and don't forget cash...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Lirios%201830%2C%20Calle%20Cerro%20De%20La%20Silla%2C%20Monterrey%2C%2064810%2C%20Mexico"
    pageTitle="Tacos Piedra 1"
  />
);

export default TacosPiedra1;
