...
const TacosDoaMaryLaGritona = () => (
  <RestaurantPage
    restaurantName="Tacos Doña Mary La Gritona"
    address="Av. Francisco I. Madero Ote, Centro, Monterrey, 64000, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+528112777280"
    website="https://guide.michelin.com/en/nuevo-leon/monterrey_2041973/restaurant/tacos-dona-mary-la-gritona"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Read the menu and be ready to order at this spot named after Doña Mary, affectionately known as la gritona or the yeller because she gently scolds people who slow down the line. Family-run, this taqueria has been around for over two decades. Order outside, get your tacos, then cross the street and sit inside with plastic chairs and tables.Your first decision will be flour or corn tortillas, but there is no wrong choice since both are made fresh onsite. Toppings include onion, cilantro and your choice of three salsas that range from mild to spicy—don't miss the salsa molcajeteada—and while offerings vary by the day, don't leave without trying the tacos de barbacoa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Francisco%20I.%20Madero%20Ote%2C%20Centro%2C%20Monterrey%2C%2064000%2C%20Mexico"
    pageTitle="Tacos Doña Mary La Gritona"
  />
);

export default TacosDoaMaryLaGritona;
