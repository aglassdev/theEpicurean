...
const KoliCocinaDeOrigen = () => (
  <RestaurantPage
    restaurantName="KOLI Cocina de Origen"
    address="Río Amazonas 225, Colonia Del Valle, Monterrey, 66220, Mexico"
    cuisine="Mexican, Creative"
    priceRange="$$$$"
    phoneNumber="+528196887333"
    website="https://www.koli.mx"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The three Rivera-Río brothers (Rodrigo, Daniel, and Patricio) combine their talents here, overseeing the culinary, pastry, and front-of-house efforts for this singular establishment. More than perhaps any other, this restaurant embodies the new face of Norteño cuisine, celebrating local ingredients and traditional dishes with a menu that is simultaneously inventive, playful, and bold. A sense of pride in local traditions and ingredients is apparent throughout their immersive tasting menu, whether it’s a suckling pig paired with a distinctive mole neolonés, or an exceptionally tender, reimagined take on cabrito, paired with plum and foie gras. Cocktail pairings, whether with or without alcohol, are both thoughtful and memorable...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=R%C3%ADo%20Amazonas%20225%2C%20Colonia%20Del%20Valle%2C%20Monterrey%2C%2066220%2C%20Mexico"
    pageTitle="KOLI Cocina de Origen"
  />
);

export default KoliCocinaDeOrigen;
