...
const Jabalina = () => (
  <RestaurantPage
    restaurantName="Jabalina"
    address="C. Padre Mier 859, Barrio Antiguo, Centro, Monterrey, 64000, Mexico"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+528125722060"
    website="https://guide.michelin.com/en/nuevo-leon/monterrey_2041973/restaurant/jabalina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They've opened elsewhere, but this location in Barrio Antiguo is the original. Sit indoors in the dining room with tall ceilings and raised beds with plants, or outside on the patio with a nice view of their parrilla and bar. Come hungry or with a group, as the plates are large and you'll want to enjoy a leisurely al fresco meal with a cocktail in hand. While there's plenty to choose from, don't miss the arrachera tacos, with three large flour tortillas with a cheese crust and topped with chopped arrachera and guacamole. Chicharrón mixto served with guacamole and quesadillas is another hit. Carrot cake with salted caramel sauce and a scoop of toasted coconut ice cream and cashews is an enticing dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.%20Padre%20Mier%20859%2C%20Barrio%20Antiguo%2C%20Centro%2C%20Monterrey%2C%2064000%2C%20Mexico"
    pageTitle="Jabalina"
  />
);

export default Jabalina;
