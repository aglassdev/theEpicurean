...
const TacosElCompadre = () => (
  <RestaurantPage
    restaurantName="Tacos El Compadre"
    address="Nicolás Bravo S/N, Maria Luisa, Centro, Monterrey, 64000, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+528116002086"
    website="https://guide.michelin.com/en/nuevo-leon/monterrey_2041973/restaurant/tacos-el-compadre"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="They may be known locally as tacos del muerto, since they're across the street from a cemetery, but this longstanding, family-owned taqueria has been getting it right for over fifty years. The third generation is now running the show here, where you'll choose between flour or corn tortillas and your filling—seared on the plancha with oil to brown and crisp the tortillas. While there are a few options, don't leave without trying their tender taco de picadillo filled with potato and ground beef; taco de pierna with chopped pork shank stewed with red chile; or the signature taco de cabeza, with flavorful, chopped beef head meat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Nicol%C3%A1s%20Bravo%20S%2FN%2C%20Maria%20Luisa%2C%20Centro%2C%20Monterrey%2C%2064000%2C%20Mexico"
    pageTitle="Tacos El Compadre"
  />
);

export default TacosElCompadre;
