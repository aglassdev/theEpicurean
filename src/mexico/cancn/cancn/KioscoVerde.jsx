...
const KioscoVerde = () => (
  <RestaurantPage
    restaurantName="Kiosco Verde"
    address="Av. López Portillo SM. 84 Lote 14, Cancún, 77520, Mexico"
    cuisine="Seafood, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+529981988402"
    website="https://restaurant-kiosco-verde.blogspot.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Octavio Santiago continues a longstanding family tradition at Kiosco Verde. This simple but welcoming kiosk was founded by his father in 1974 and is located along the road that crosses Puerto Juarez. The detailed menu is complemented by specials written on the blackboard, but all focus on seafood from the local market and highlight the regional style. The dishes are as tasty as they are colorful, as in the Argentine-style empanadas stuffed with lobster meat and chimichurri sided by baked potatoes, fried leek julienne and aguacate, along with chile hummus. Pulpo zarandeado is another winning dish, and with generous portions you'll be hard-pressed to order dessert—but don't skip it. The specials, like the dreamy panna cotta, are worth it...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20L%C3%B3pez%20Portillo%20SM.%2084%20Lote%2014%2C%20Canc%C3%BAn%2C%2077520%2C%20Mexico"
    pageTitle="Kiosco Verde"
  />
);

export default KioscoVerde;
