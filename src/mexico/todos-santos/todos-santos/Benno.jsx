...
const Benno = () => (
  <RestaurantPage
    restaurantName="Benno"
    address="Carr. Federal No. 19KM 54+800, Playa Punta Lobos, Todos Santos, 23300, Mexico"
    cuisine="Mexican, Mediterranean Cuisine"
    priceRange="$$$"
    phoneNumber="+526121751530"
    website="https://www.bunkhousehotels.com/hotel-san-cristobal/eat-drink/benno"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This dining room of the Hotel San Cristóbal in Todos Santos feels a bit in the middle of nowhere but commands a prized perch along the Baja coast. Benno embraces an easy-breezy indoor/outdoor vibe. The patio area faces the pool and the beach; time it right and you get a stunning view of the sunset.Breakfast is offered, and evening fare incudes simple, straightforward cooking in preparations like ceviche, grilled local cheese, roasted chicken and house-made pasta. The pesca en mole verde, or catch of the day, may be yellowtail; it is served with a smooth textured, mild, herb and pumpkin seed sauce and very fresh vegetables. The churros are cleverly done as bite-sized pieces, accompanied by house-made dulce de leche and warm chocolate sauce for dipping...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Federal%20No.%2019KM%2054%2B800%2C%20Playa%20Punta%20Lobos%2C%20Todos%20Santos%2C%2023300%2C%20Mexico"
    pageTitle="Benno"
  />
);

export default Benno;
