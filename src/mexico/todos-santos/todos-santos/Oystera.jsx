...
const Oystera = () => (
  <RestaurantPage
    restaurantName="Oystera"
    address="C. Benito Juarez, Ignacio Zaragoza y Santos Degollado, Todos Santos, 23300, Mexico"
    cuisine="Seafood, Mexican"
    priceRange="$$$$"
    phoneNumber="+526122280621"
    website="https://santaterra.mx/oystera"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Oystera is located in the heart of Todos Santos, in a massive and rather grand building that is built on the former site of a sugar mill. The oyster bar takes center stage, with the dining space surrounding the bar. A patio out back takes advantage of the view. Chef Poncho Cadena, a Sonoran native, oversees a seafood-focused, Mexican menu spotlighting contemporary, even ambitious, cooking. As might be expected, oysters are a must. Try the half-dozen selection, with all six sourced from Baja waters and served with their version of cocktail sauce, a mignonette and Baja-style ponzu sauce. If raw isn't to your liking, try the plump, fried oysters with habanero aïoli. Beyond the bi-valves, a marinated tuna tostada or the catch of the day would round out your meal nicely...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.%20Benito%20Juarez%2C%20Ignacio%20Zaragoza%20y%20Santos%20Degollado%2C%20Todos%20Santos%2C%2023300%2C%20Mexico"
    pageTitle="Oystera"
  />
);

export default Oystera;
