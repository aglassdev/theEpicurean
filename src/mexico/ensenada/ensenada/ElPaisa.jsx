...
const ElPaisa = () => (
  <RestaurantPage
    restaurantName="El Paisa"
    address="Av. 20 De Noviembre 1043, Ensenada, 22800, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/baja-california/ensenada_2059847/restaurant/el-paisa"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%2020%20De%20Noviembre%201043%2C%20Ensenada%2C%2022800%2C%20Mexico"
    pageTitle="El Paisa"
  />
);

export default ElPaisa;
