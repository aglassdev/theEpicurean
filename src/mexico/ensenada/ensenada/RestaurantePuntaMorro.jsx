...
const RestaurantePuntaMorro = () => (
  <RestaurantPage
    restaurantName="Restaurante Punta Morro"
    address="Carr. Tijuana Km 106, Ensenada, Ensenada, 22870, Mexico"
    cuisine="Mexican"
    priceRange="$$$$"
    phoneNumber="+526461783507"
    website="https://www.hotelpuntamorro.com/restaurante-bar-hotel-punta-morro"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This hotel dining room has an enviable location facing the ocean. The room is intimate in scale and boasts a wall of windows offering a gorgeous view. Time it right and you can watch the sun set while enjoying dinner.The menu offers a range of items to please various palates including vegetarian items, house-made pasta and grilled steaks. Yet this team's cuisine also has a creative streak. The empanadas Baja are a highly recommended starter; made from blue corn masa they are delicately crisped and stuffed with finely diced lobster that is seasoned chorizo-style. Seafood preparations are a specialty of Ensenada, but the grilled quail, coming from the Valle de Guadalupe, is simply grilled and accompanied by a luscious sun-dried chili and beer sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Tijuana%20Km%20106%2C%20Ensenada%2C%20Ensenada%2C%2022870%2C%20Mexico"
    pageTitle="Restaurante Punta Morro"
  />
);

export default RestaurantePuntaMorro;
