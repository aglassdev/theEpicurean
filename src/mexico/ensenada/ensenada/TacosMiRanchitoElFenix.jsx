...
const TacosMiRanchitoElFenix = () => (
  <RestaurantPage
    restaurantName="Tacos Mi Ranchito El Fenix"
    address="C Sexta y Espinoza 603, Zona Centro, Ensenada, 22830, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+526461174326"
    website="https://guide.michelin.com/en/baja-california/ensenada_2059847/restaurant/tacos-mi-ranchito-el-fenix"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Tacos Mi Ranchito El Fenix is a streetside kiosk done up in white and red tile. This perch offers a handful of counter seats, as well as two tables off to the side. The counter surrounds the prep area where one corner is devoted to the frying of the fish fillets for the signature taco here, the taco pescado. This crispy, delicious treat is served unadorned and invites dressing up from the various garnishes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C%20Sexta%20y%20Espinoza%20603%2C%20Zona%20Centro%2C%20Ensenada%2C%2022830%2C%20Mexico"
    pageTitle="Tacos Mi Ranchito El Fenix"
  />
);

export default TacosMiRanchitoElFenix;
