...
const BrumaWineGarden = () => (
  <RestaurantPage
    restaurantName="Bruma Wine Garden"
    address="Valle de Guadalupe, Carr. Avinicola La Cetto, Fraccionamiento, A-B, P74, Francisco Zarco, Ensenada, 22760, Mexico"
    cuisine="Contemporary"
    priceRange="$$$$"
    phoneNumber="+526462455063"
    website="https://www.brumawineresort.com/gastronomia"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Run by Chef David Castro Hussong, this spot is located on the Bruma winery property. Entirely outside, the lovely tree-covered space welcomes guests to take a seat at the oversized communal table or a few smaller tables flanking the sides. A contemporary menu echoes the casual setting. Starters like ceviche or cauliflower with mole are followed up by hearty main dishes like short rib with shiitake and noodles. The pizzas are a popular choice, and though far from traditional Italian, the Mexican spin (think tender beef birria with chile morita) are very successful. Don't sleep on dessert, especially the flaky banana tart that delivers on flavor and, like many other dishes, is sized for sharing...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Valle%20de%20Guadalupe%2C%20Carr.%20Avinicola%20La%20Cetto%2C%20Fraccionamiento%2C%20A-B%2C%20P74%2C%20Francisco%20Zarco%2C%20Ensenada%2C%2022760%2C%20Mexico"
    pageTitle="Bruma Wine Garden"
  />
);

export default BrumaWineGarden;
