...
const Madre = () => (
  <RestaurantPage
    ...
    address="C. Octava 444, Zona Centro, Ensenada, 22800, Mexico"
    cuisine="Mexican"
    priceRange="$$$"
    phoneNumber="+526461837588"
    website="https://guide.michelin.com/en/baja-california/ensenada_2059847/restaurant/madre-1210925"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Comfortable and amiable, Madre is from chefs and partners Miguel Bahena and Carolina Verdugo. Found in a white stucco home with a terra-cotta tiled roof, the dining area's layout features two small rooms and a bar area with the kitchen on display at the back. Decorative elements include polished wood plank floors, tables dressed in cloth runners and light walls accented with artwork.The concise menu offers seafood starters, such as the pepita and-sesame crusted shrimp plated with a chileatole sauce made from shrimp stock and slivers of nopal and onion. Pasta and roasted meats round out the menu, such as the duck breast presented with a crisped skin and sauced with a house-made mole coloradito...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.%20Octava%20444%2C%20Zona%20Centro%2C%20Ensenada%2C%2022800%2C%20Mexico"
    pageTitle="Madre"
  />
);
