...
const LeChique = () => (
  <RestaurantPage
    ...
    address="Hotel Xcaret Arte, Carr. Chetumal-Puerto Juárez, Km. 282 L21-3 Colonia Rancho Xcaret, Playa del Carmen, 77710, Mexico"
    cuisine="Contemporary, Mexican"
    priceRange="$$$$"
    phoneNumber="+529988728450"
    website="https://www.instagram.com/lechiquerestaurant?igsh=cjdyN3dhYXYyNzEx"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="Nestled inside the Azul Beach Resort, Le Chique headed by Chef Jonatán Gómez Luna, presents a thoroughly charming experience. The space, service, and presentation all display a high polish, and there is a distinct theatrical sense that lends an air of special occasion to this spot. The tasting menu spans Mexico's regions, showing a clear sense of style and personality while consistently impressing with creativity, excellent ingredients, strong technique, and impactful flavors. A fruit and foie gras salad nestled in an orange or a huitlacoche-stuffed donut with poblano and epazote sauce are just some of the first bites that set the meal off on a luxurious start. A dazzling array of seafood arrives in style, followed by heartier compositions and a lengthy procession of sweets...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Hotel%20Xcaret%20Arte%2C%20Carr.%20Chetumal-Puerto%20Ju%C3%A1rez%2C%20Km.%20282%20L21-3%20Colonia%20Rancho%20Xcaret%2C%20Playa%20del%20Carmen%2C%2077710%2C%20Mexico"
    pageTitle="Le Chique"
  />
);

export default LeChique;
