...
const Buul = () => (
  <RestaurantPage
    restaurantName="Bu’ul"
    address="Carr. Federal Cancún - Tulum, Punta Maroma Km. 51, Playa del Carmen, 77710, Mexico"
    cuisine="Mexican, Creative"
    priceRange="$$$$"
    phoneNumber="+529983870044"
    website="https://maroma.chablehotels.com/cuisine/buul/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A journey through the jungle, past the private villas that make up the Chablé Maroma, will bring you to this enclave, serving singular cuisine that celebrates native ingredients and flavors. To that effect, sophisticated permutations of corn, beans, and chiles are threaded through the menu, as in a salbute made from puffed fried masa, filled with chunks of spiny lobster and crunchy green apple, dressed with an earthy, complex recado rojo sauce. A main course of luxurious creamy rice—enriched with Ocosingo cheese and accented with nutty, herbaceous pipián verde alongside earthy venison longaniza—offers an unapologetically Mexican answer to risotto. Finish with a wonderfully intense molten cake of Oaxacan chocolate—ideally paired with a sip of mezcal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Carr.%20Federal%20Canc%C3%BAn%20-%20Tulum%2C%20Punta%20Maroma%20Km.%2051%2C%20Playa%20del%20Carmen%2C%2077710%2C%20Mexico"
    pageTitle="Bu’ul"
  />
);
