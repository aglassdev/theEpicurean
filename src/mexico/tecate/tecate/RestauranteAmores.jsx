...
const RestauranteAmores = () => (
  <RestaurantPage
    restaurantName="Restaurante Amores"
    address="Presidente Adolfo de La Huerta 63, Primera Sección, Tecate, 21400, Mexico"
    cuisine="Mexican"
    priceRange="$$$"
    phoneNumber="+526656547052"
    website="https://restauranteamores.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Restaurante Amores is lovingly run by Chefs Marcelo Hisaki and Reyna Venegas with their team. The cuisine here is offered as a prix-fixe and diners can choose from a few options. There is an element of surprise at play, as the items are not specifically described until they are presented on the table, with many compositions featuring the day's local product. A fish course may feature Pacific Dover sole from Ensenada, pan seared and dressed with an herb and caper pipián and bouquet of asparagus; while the meat choice can include lamb, done as barbacoa and presented as a sope with black bean puree. Dessert brings the meal to an impressive close, as in a block of warm lemon curd cake accompanied by a quenelle of berry ripple ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Presidente%20Adolfo%20de%20La%20Huerta%2063%2C%20Primera%20Secci%C3%B3n%2C%20Tecate%2C%2021400%2C%20Mexico"
    pageTitle="Restaurante Amores"
  />
);

export default RestauranteAmores;
