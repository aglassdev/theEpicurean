...
const Atarraya = () => (
  <RestaurantPage
    restaurantName="Atarraya"
    address="Guerrero 633 Brisas de Zicatela, La Punta, Brisas de Zicatela, 70934, Mexico"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+528112777802"
    website="https://restaurante.covermanager.com/atarraya/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Is there a cooler restaurant in Puerto Escondido? Channeling the sleekness of a Japanese zen garden, the outdoor space is picture-perfect and built out with handsome wood beams, a backlit bar, and an old tree that stretches across the dining room. The cooking is familiar fare, seasoned and presented with the right amount of care: Crisp tostadas stacked with pan-fried ribeye, squares of tuna rolled in sesame seeds, and vibrant salsas that upgrade everything they touch. You could make a meal out of the appetizers alone or press on with a chile relleno stuffed with vegetables and blanketed in a smooth manzano pepper sauce. Though the cocktail offerings are succinct and stick largely to the classics, the bartenders shake and stir with notable skill...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Guerrero%20633%20Brisas%20de%20Zicatela%2C%20La%20Punta%2C%20Brisas%20de%20Zicatela%2C%2070934%2C%20Mexico"
    pageTitle="Atarraya"
  />
);

export default Atarraya;
