...
const EnveroEnElValle = () => (
  <RestaurantPage
    restaurantName="Envero en el Valle"
    address="Callejon Emiliano Zapata, Carretera Tecate, El Porvenir, 22750, Mexico"
    cuisine="Mexican"
    priceRange="$$$$"
    phoneNumber="+526461030653"
    website="https://envero-en-el-valle.negocio.site/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Add this gorgeous outdoor restaurant to your must-visit list. Located at the Las Nubes winery, you'll enjoy dramatic, sweeping views of The Valley from your table, while overhead, sun shades and café lights add to the ambience.The kitchen team makes good use of local produce and seafood while also favoring grilled meats for this contemporary Mexican cuisine, available both à la carte and as a tasting menu. Polenta finished on the plancha has a nice, crispy exterior before being topped with shredded braised beef and stewed cherry tomatoes. Local crab shines in a house-made taco served with a bright orange salsa, then thick slices of grilled New York strip steak with an excellent char is served with peanut Jalisco-style mole, a nod to the chef's heritage...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Callejon%20Emiliano%20Zapata%2C%20Carretera%20Tecate%2C%20El%20Porvenir%2C%2022750%2C%20Mexico"
    pageTitle="Envero en el Valle"
  />
);

export default EnveroEnElValle;
