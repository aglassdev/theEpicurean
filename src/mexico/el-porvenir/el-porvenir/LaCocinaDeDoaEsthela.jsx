...
const LaCocinaDeDoaEsthela = () => (
  <RestaurantPage
    restaurantName="La Cocina de Doña Esthela"
    address="Rancho San Marcos, El Porvenir, 22755, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+526461568453"
    website="https://guide.michelin.com/en/baja-california/el-porvenir_2059721/restaurant/la-cocina-de-dona-esthela"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="From chef/owner Blanca Esthela Martínez Bueno, what began with humble roots in 2008 making burritos for local vineyard workers has evolved into one of the most famous restaurants in the Valle de Guadalupe. It's loaded with charm, from the heavy wood tables to the boisterous crowd of visitors and locals. Breakfast is served all day, and while a no-reservations policy means a wait, it's worth it to sample dialed-in cooking with hearty portions. Get the café de olla and dig into the menu where you'll find huevos of all kinds alongside chilaquiles and gorditas rellenas. House specialties include fluffy elote pancakes and a Sinaloan-style, dried shredded beef with egg, sliced peppers, and onions with stewed beans that beg to be sopped up with housemade tortillas...."
    ...
    pageTitle="La Cocina de Doña Esthela"
  />
);

export default LaCocinaDeDoaEsthela;
