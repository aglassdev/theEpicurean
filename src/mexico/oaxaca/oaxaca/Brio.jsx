...
const Brio = () => (
  <RestaurantPage
    restaurantName="Brio"
    address="Armenta y López 300, Centro, Oaxaca, 68000, Mexico"
    cuisine="Mexican, Mediterranean Cuisine"
    priceRange="$$"
    phoneNumber="+529515692497"
    website="https://www.briooaxaca.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its terraced setting overlooking a church in the center of the city, Brio looks and feels very Oaxacan. It's fitting, then, that the menu echoes the tribute to the region with its focus on local dishes and ingredients given a hint of Mediterranean flair. The wood-fired grill is the centerpiece, with all proteins kissed by the flames. Begin with an appetizer such as the roasted beet salad set atop chile de agua cream sauce and chamomile honey alongside sliced tomatoes and apples. Then, bone-in pork chop benefits from the wood fire, but the peanut mole is the last word. Crème brûlée is given a twist here, infused with poleo for a brightness not often seen...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Armenta%20y%20L%C3%B3pez%20300%2C%20Centro%2C%20Oaxaca%2C%2068000%2C%20Mexico"
    pageTitle="Brio"
  />
);
