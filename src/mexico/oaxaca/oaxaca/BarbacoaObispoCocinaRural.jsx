...
const BarbacoaObispoCocinaRural = () => (
  <RestaurantPage
    restaurantName="Barbacoa Obispo Cocina Rural"
    address="Calz. San Felipe del Agua 327, San Felipe, Agencia Municipal de San Felipe del Agua, Oaxaca, 68026, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+529514555522"
    website="https://www.instagram.com/obispococinarural?igsh=ZWJ2aGdqeGNlOXpt"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="The name slightly gives it away, as barbacoa cooked underground in a hot stone-lined oven is certainly a big deal here. However, Barbacoa Obispo Cocina Rural, where Oaxacan cuisine is front and center, also shines a spotlight on birria and jabali, which can be served as memelas, blandos, quesadillas, or tlayudas, as well as tacos al vapor. Decisions aren't easy with so many tempting offerings, but hits include barbacoa blandos (your choice of meat), surtidos (with a blend of cuts), or meat-filled tetelas. Of course, their weekly specials designed for sharing at the table are also a good idea. You may be stuffed, but nothing closes out a meal here quite like a cafe de olla sided by a concha with whipped cream and strawberries...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Calz.%20San%20Felipe%20del%20Agua%20327%2C%20San%20Felipe%2C%20Agencia%20Municipal%20de%20San%20Felipe%20del%20Agua%2C%20Oaxaca%2C%2068026%2C%20Mexico"
    pageTitle="Barbacoa Obispo Cocina Rural"
  />
);

export default BarbacoaObispoCocinaRural;
