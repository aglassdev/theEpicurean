...
const Crudo = () => (
  <RestaurantPage
    restaurantName="Crudo"
    address="Av. Benito Juárez 309, Oaxaca, 68000, Mexico"
    cuisine="Fusion, Mexican"
    priceRange="$$$$"
    phoneNumber="+529514622482"
    website="https://guide.michelin.com/en/oaxaca/oaxaca-de-juarez_2056768/restaurant/crudo-1208519"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There is nothing quite like this intimate counter, certainly in Oaxaca and possibly beyond. Chef Ricardo Arellano has crafted a creative omakase that fuses Japanese flavors with local ingredients and preparations. What does that look like? It means nixtamalized papaya might come with your kampachi. Or maybe tuna will arrive seared with binchotan and set in a chicory leaf brushed in charred onion puree. An eel handroll is dressed in a smoky-sweet puree made from the pulp of agave. The menu is on the lighter side but the lasting impression and ingenuity is nonetheless impressive and at no point feels forced or generic. Locals have yet to warm to the place, so visitors shouldn’t be surprised when they’re seated with fellow travelers...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Benito%20Ju%C3%A1rez%20309%2C%20Oaxaca%2C%2068000%2C%20Mexico"
    pageTitle="Crudo"
  />
);
