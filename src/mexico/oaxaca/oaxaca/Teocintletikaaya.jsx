...
const Teocintletikaaya = () => (
  <RestaurantPage
    restaurantName="Teocintle-Tika'aya"
    address="Av. de la Independencia 12, Oaxaca, 69600, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$$$"
    phoneNumber="+529513130485"
    website="https://guide.michelin.com/en/oaxaca/oaxaca-de-juarez_2056768/restaurant/teocintle-tika-aya"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20de%20la%20Independencia%2012%2C%20Oaxaca%2C%2069600%2C%20Mexico"
    pageTitle="Teocintle-Tika'aya"
  />
);

export default Teocintletikaaya;
