...
const Nois = () => (
  <RestaurantPage
    restaurantName="Nois"
    address="Avenida José María Morelos 701, Centro, Oaxaca, 68000, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$$"
    phoneNumber="+529514219917"
    website="https://nois.com.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are several ways to experience this ambitious, two-story restaurant. The ground floor is a chic lounge where bartenders shake and stir potent, boozy drinks. Up the winding staircase, find an open kitchen committed to crafting a serious tasting menu focused on seafood. To be clear, this is a team that likes to take risks and keep diners on their toes. Familiar ingredients like Oaxacan cheese, chintextle, starfruit, and hoja santa are deployed in imaginative, daring ways. Recent highlights include wild-caught tuna tataki rolled in vegetable ash as well as a refreshingly homey buffalo taco brushed in a rich demi-glace. Gracious, personable servers round out this satisfying, thoughtful experience in the heart of Oaxaca...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Avenida%20Jos%C3%A9%20Mar%C3%ADa%20Morelos%20701%2C%20Centro%2C%20Oaxaca%2C%2068000%2C%20Mexico"
    pageTitle="Nois"
  />
);
