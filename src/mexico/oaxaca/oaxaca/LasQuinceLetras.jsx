...
const LasQuinceLetras = () => (
  <RestaurantPage
    restaurantName="Las Quince Letras"
    address="C. de Mariano Abasolo 300, Oaxaca, 68000, Mexico"
    cuisine="Mexican, Regional Cuisine"
    priceRange="$$"
    phoneNumber="+529515143769"
    website="https://lasquinceletras.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Mole is everywhere at Chef Celia Florián’s restaurant, which opened in 1992. You can find it served with plantains, inside large empanadas, and on top of enchiladas. But from amarillo to coloradito to verde, the one that shines brightest is her mole negro. Black as night, smoky, and tantalizingly charred, it needs nothing more except for a tortilla or a bit of rice. This recipe and many others have deep roots: Florián grew up on a farm in La Ciénega and learned to cook from her mother and grandmother. Another highlight is the wonderful garnachas istmenas, crispy masa cakes topped with tender shredded beef buried under a pile of pickled cabbage. Still to this day, Florián enjoys global recognition for her contributions to Oaxacan cuisine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.%20de%20Mariano%20Abasolo%20300%2C%20Oaxaca%2C%2068000%2C%20Mexico"
    pageTitle="Las Quince Letras"
  />
);

export default LasQuinceLetras;
