...
const TaqueriaLosCocuyos = () => (
  <RestaurantPage
    restaurantName="Taqueria Los Cocuyos"
    address="Simón Bolívar 67, Centro, Cuauhtémoc, 06000, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525555184231"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/taqueria-los-cocuyos"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This taqueria in Centro Historico has been a mainstay since 1980. Standing by a cauldron of meats bubbling away, a chef at the front wields a cleaver with lightning speed. An expansive dining room speaks to just how busy this place gets. Offerings are numerous but recent highlights include tender, melting cabeza as well as the classic al pastor, both finished tableside with salsas and a squeeze of lime. Swing for the suadero later in the evening when the meats have had plenty of time to braise...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sim%C3%B3n%20Bol%C3%ADvar%2067%2C%20Centro%2C%20Cuauht%C3%A9moc%2C%2006000%2C%20Mexico"
    pageTitle="Taqueria Los Cocuyos"
  />
);

export default TaqueriaLosCocuyos;
