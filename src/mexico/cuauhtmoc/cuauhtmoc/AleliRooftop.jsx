...
const AleliRooftop = () => (
  <RestaurantPage
    restaurantName="Aleli Rooftop"
    address="Sinaloa 141, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Spanish, Mexican"
    priceRange="$$"
    phoneNumber="+525519739913"
    website="https://www.alelirooftop.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="As its name suggests, Aleli is indeed located on the rooftop, so while the location may not be a surprise, the food is. You'll soon see (and smell) why, as the embers from the grill permeate the air. It's certainly worth snagging a seat at the bar to watch the cook at work on the grill. The menu of traditional Mexican cuisine may not be extensive, but it proudly displays dishes that stand out for their flavor, quality products and presentation. Highlights include brocheta de camarón, pan de papa a la brasa, lomo de pescado zarandeado, and of course the much-loved cheesecake asado. Cocktails and wine complete the sunny picture, but perhaps even more smile-inducing is the palatable price...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Sinaloa%20141%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Aleli Rooftop"
  />
);

export default AleliRooftop;
