...
const Gaba = () => (
  <RestaurantPage
    restaurantName="Gaba"
    address="Av. Mazatlán 190, Colonia Condesa, Cuauhtémoc, 06170, Mexico"
    cuisine="Mexican"
    priceRange="$$$"
    phoneNumber="+525591078494"
    website="https://www.gaba.com.mx"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With its concrete flooring, chunky wood chairs with woven leather seating, and exposed brick wall, this La Condesa restaurant is loaded with charm that's amplified by the warm staff. While its intimate in scale, there's nothing timid about the cooking. By day, it's a cafe with an approachable menu, but by night it comes alive with Chef Victor Toriz's bold and unexpected plates designed for sharing. From the textures to the flavor combinations, his unabashed personality comes shining through in dishes like roasted and fresh grapes in a spiced crème fraîche. Charred cabbage with caramelized cabbage purée with nori oil, roasted and pickled raisins and a house-made granola is yet another unexpected dish. For dessert, cake topped with avocado mousse and horchata ice cream is highly original...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Mazatl%C3%A1n%20190%2C%20Colonia%20Condesa%2C%20Cuauht%C3%A9moc%2C%2006170%2C%20Mexico"
    pageTitle="Gaba"
  />
);
