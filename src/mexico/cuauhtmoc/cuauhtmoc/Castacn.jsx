...
const Castacn = () => (
  <RestaurantPage
    restaurantName="Castacán"
    address="C. Puebla 387, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525593570596"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/castacan"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="There are two reasons to make a beeline to this Roma Norte restaurant and they're both focused on pork. This spot's large staff welcomes diners at both lunch and dinner, but everyone is focused on the food. Cochinita pibil and lechon tacos compete for your attention, so get both. Good quality tortillas get things off to a good start. The slow-roasted, marinated pork that's shredded and enhanced with pickled red onions is top notch, while the lechon tacos plate tender, roast suckling pig with pieces of crispy skin for a standout bite. A wide range of salsas is on offer, from spicy habanero and a sesame aioli to mild yogurt sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C.%20Puebla%20387%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Castacán"
  />
);

export default Castacn;
