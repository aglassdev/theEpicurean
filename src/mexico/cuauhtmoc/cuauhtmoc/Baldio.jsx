...
const Baldio = () => (
  <RestaurantPage
    restaurantName="Baldio"
    address="Antonio Solá 26, Colonia Condesa, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican, European"
    priceRange="$$"
    phoneNumber="+525543649852"
    website="https://www.baldio.mx/"
    tags={[{ name: "Green Star" }]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taking inspiration from London's Silo, where Chef Max MacLean previously worked, Baldio is zeroing in on zero waste. It's all about a holistic approach to sustainability, going beyond the locally caught freshwater fish and vegetables from chinampas farms to include in-house water purification and recycled corn husk paper for printing. Green practices aside, this restaurant doesn't pull any punches when it comes to cooking. Fire-roasted carrots and broccoli over a bed of creamy pipián make for the perfect opener before moving on to main dishes like their pork, grilled over a live fire and accompanied by a flavorful pataxte mole. Finish with the rich and creamy tarta de chocolate dusted with starfruit powder...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Antonio%20Sol%C3%A1%2026%2C%20Colonia%20Condesa%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Baldio"
  />
);

export default Baldio;
