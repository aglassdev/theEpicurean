...
const RicosTacosToluca = () => (
  <RestaurantPage
    restaurantName="Ricos Tacos Toluca"
    address="López 103, Centro, Cuauhtémoc, 06000, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+527224747771"
    website="https://www.instagram.com/ricostacostoluca_?igsh=MjN5Zm56OXh2ODdm"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In more than two decades, this taqueria has moved three times. It's now situated in the Centro Histórico of Mexico City near the Mercado De San Juan. There are just a few red stools, so come early or you'll eat standing up. This taqueria specializes in handmade Toluca-style chorizo and sausages. Sample individually to appreciate the flavors and unique characters of each chorizo or mix them for an equally satisfying experience. Top with grilled or fresh onions, French fries, cilantro and various salsas. Obispo is a large pork-based sausage, seared ever so slightly for a delicate crisp, while chorizo tamarindo is diced then grilled and delivers a subtle sweetness and terrific flavor...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=L%C3%B3pez%20103%2C%20Centro%2C%20Cuauht%C3%A9moc%2C%2006000%2C%20Mexico"
    pageTitle="Ricos Tacos Toluca"
  />
);
