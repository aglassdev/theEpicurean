...
const Merotoro = () => (
  <RestaurantPage
    restaurantName="MeroToro"
    address="Av. Ámsterdam 204, Hipódromo, Cuauhtémoc, 06100, Mexico"
    cuisine="Contemporary, Mexican"
    priceRange="$$"
    phoneNumber="+5255647799"
    website="https://www.merotoro.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Located on a tree-lined street surrounded by restaurants in the Condesa neighborhood, MeroToro delights guests with its cozy environs. The terrace is a nice spot, while indoors, the contemporary styling is particularly inviting. Chef Jair Téllez plates simple, straightforward, and flavorful dishes based on the cuisine of Baja, California. The menu balances meat and seafood, and a tasting menu is also on offer. Dishes that never fail to impress include the tostada de ceviche de pescado, jaiba suave rebozada, and arroz cremoso con camarón, while meat eaters will be delighted by rabo de res braseado. Desserts such as pastel de chocolate, crema de téjate, and helado de yogurt seal the deal...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20%C3%81msterdam%20204%2C%20Hip%C3%B3dromo%2C%20Cuauht%C3%A9moc%2C%2006100%2C%20Mexico"
    pageTitle="MeroToro"
  />
);

export default Merotoro;
