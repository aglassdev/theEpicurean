...
const CaracolDeMar = () => (
  <RestaurantPage
    restaurantName="Caracol de Mar"
    address="Campeche 340, Col. Condesa, Cuauhtémoc, 06100, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$"
    phoneNumber="+525559498304"
    website="https://caracoldemar.com.mx"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Set on a corner in Hipódromo, you'll check in outside then climb a beautiful wooden spiral staircase to the second-floor dining room where floor-to-ceiling windows and vaulted ceiling lend a contemporary flair. A colorful art installation echoes the neighborhood's creative spirit, also seen in this kitchen's contemporary Mexican dishes. Most of the dishes are designed for sharing, making it an ideal spot for a group. Don't miss the tostada de coco, a blue corn tostada piled with avocado, chintextle, and coconut with a subtle savory flavor that is as stunning as it is surprising. For dessert, nothing beats the chocolate tamal with coconut crumble and hoja santa ice cream...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Campeche%20340%2C%20Col.%20Condesa%2C%20Cuauht%C3%A9moc%2C%2006100%2C%20Mexico"
    pageTitle="Caracol de Mar"
  />
);

export default CaracolDeMar;
