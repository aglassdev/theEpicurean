...
const Pigeon = () => (
  <RestaurantPage
    restaurantName="Pigeon"
    address="Plaza Rio De Janeiro 56, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="International"
    priceRange="$$"
    phoneNumber="+525521244598"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/pigeon"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This pleasing cafe from Chef Mercedes Bernal is found in Roma Norte and boasts a corner location at the Edificio Río de Janeiro. The look evokes Art Deco style with bold patterned tiled flooring, marble tables, leather banquettes, pale walls, and warm lighting. The amiable service team enhances the good vibes here.The menu offers broad appeal in its offerings of charcuterie, steamed mussels with French fries, and pork schnitzel. There is also creativity at work in items such as the vegetable-focused plate of roasted carrots with macha sauce on creamy tofu; and the loosely cooked short grain rice seasoned with turmeric, topped with spiced shrimp, and drizzled with tzatziki sauce...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Plaza%20Rio%20De%20Janeiro%2056%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Pigeon"
  />
);
