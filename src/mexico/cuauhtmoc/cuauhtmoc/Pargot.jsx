...
const Pargot = () => (
  <RestaurantPage
    restaurantName="Pargot"
    address="Córdoba 212, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican, Creative"
    priceRange="$$"
    phoneNumber="+525634704481"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/pargot"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Alexis Ayala's Pargot features a short list of impressively prepared items arranged from small to large. His cuisine displays a Mexican foundation enhanced by creative flourishes. Case in point? Very fresh fish, sourced from Baja California, is transformed into the likes of kebbe crudo dressed with grasshopper XO sauce; or a tostada layered with creamy leek pate, chili ash and avocado puree. Heartier plates have featured a blue crab bisque risotto; or lamb terrine...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=C%C3%B3rdoba%20212%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Pargot"
  />
);

export default Pargot;
