...
const TacosLosAlexis = () => (
  <RestaurantPage
    restaurantName="Tacos Los Alexis"
    address="Chiapas 46, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican, Creative"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/tacos-los-alexis"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef Alexis Ayala's taqueria is located next door to his sister spot, Pargot, and the set-up is similar, with a thoughtfully done interior prep area and a handful of tables arranged under a covered sidewalk.Tacos Los Alexis offers a short list of varied preparations that include volcanoes, costras, as well as delightful tacos. The vegetarian taco is an elegant preparation featuring an excellent yellow masa tortilla topped with huitlacoche wrapped in crisped cheese...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Chiapas%2046%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Tacos Los Alexis"
  />
);

export default TacosLosAlexis;
