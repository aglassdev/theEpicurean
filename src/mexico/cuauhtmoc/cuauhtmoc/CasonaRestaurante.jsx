...
const CasonaRestaurante = () => (
  <RestaurantPage
    restaurantName="Casona Restaurante"
    address="Casona Roma Norte, C. Durango 280, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Contemporary"
    priceRange="$$$"
    phoneNumber="+525511178660"
    website="https://casonaroma.com/casona-restaurant/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Aquiles is the all-day dining concept inside the Casona Roma Norte but this isn't your average hotel restaurant. This stylish spot just off the lobby is loaded with natural light, and a wall enhanced with a floral mural and live greenery adds to the uplifting ambience. Breakfast and lunch are on offer, but dinner is when the à la carte takes center stage. The cooking is contemporary with Mexican ingredients and inflections. His uncomplicated style is best seen in starters like steak tartare or tortilla soup. Like every good hotel restaurant worth its salt, the burger is a good mainstay, while other main dishes range from hearty braised short rib to lighter dishes like fish en papillote...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Casona%20Roma%20Norte%2C%20C.%20Durango%20280%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Casona Restaurante"
  />
);

export default CasonaRestaurante;
