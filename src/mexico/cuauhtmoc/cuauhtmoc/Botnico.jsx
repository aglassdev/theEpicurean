...
const Botnico = () => (
  <RestaurantPage
    restaurantName="Botánico"
    address="Alfonso Reyes 217, Hipódromo, Cuauhtémoc, 06100, Mexico"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+525552712152"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/botanico"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Upon first glance, it may not look like much, but the exterior belies the oasis found within. Tall cacti, a lake stocked with fish and a convivial atmosphere make this a natural choice for date night, but this laidback spot is equally well suited to families and groups too. Everyone enjoys being here as they connect over plates like homemade ravioli with blue crab and a pumpkin cream base, or a simple grilled fish with al dente vegetables. Crème brûlée delivers a strange-sounding surprise with the addition of Kalamata olive, but it's a convincing finale...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Alfonso%20Reyes%20217%2C%20Hip%C3%B3dromo%2C%20Cuauht%C3%A9moc%2C%2006100%2C%20Mexico"
    pageTitle="Botánico"
  />
);

export default Botnico;
