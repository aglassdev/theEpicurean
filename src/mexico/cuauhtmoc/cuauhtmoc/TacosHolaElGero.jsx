...
const TacosHolaElGero = () => (
  <RestaurantPage
    restaurantName="Tacos Hola El Güero"
    address="Ámsterdam 135, Hipódromo, Cuauhtémoc, 06100, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525618668923"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/tacos-hola-el-guero"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This longstanding taqueria in Condesa has been open since 1968 and features a large selection of guisado (stewed) tacos with hearty meat and vegetarian fillings, all kept warm in large ceramic pots. It's an order at the counter-style spot with just a few small tables outside. Choose between one or two tortillas and various toppings. Standouts include the picadillo, with well-seasoned ground meat and potatoes topped with creamy green salsa with avocado and cotija cheese, and the chorizo con papa, with two larger corn tortillas topped with a chorizo and potato mixture, black beans, cotija cheese, and a semi-spicy salsa...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=%C3%81msterdam%20135%2C%20Hip%C3%B3dromo%2C%20Cuauht%C3%A9moc%2C%2006100%2C%20Mexico"
    pageTitle="Tacos Hola El Güero"
  />
);

export default TacosHolaElGero;
