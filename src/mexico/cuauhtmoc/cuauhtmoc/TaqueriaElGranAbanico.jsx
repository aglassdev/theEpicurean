...
const TaqueriaElGranAbanico = () => (
  <RestaurantPage
    restaurantName="Taqueria El Gran Abanico"
    address="Gutiérrez Nájera S/N, Tránsito, Cuauhtémoc, 06820, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525580781884"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/taqueria-el-gran-abanico"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="You won't need to check your map to find this spot, as this bi-level space has a line that stretches down the block. Don't worry, as the line moves quickly at this locals' favorite. The large menu offers plenty of choices, but all eyes are on the tacos, especially their signature carnitas piled high on a double layer of soft corn tortillas. Other tacos to consider include the costilla de res, a tender bone-in beef rib that's packed with flavor. Portions are generous and prices are fair at this unfussy taqueria that runs on cash only...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Guti%C3%A9rrez%20N%C3%A1jera%20S%2FN%2C%20Tr%C3%A1nsito%2C%20Cuauht%C3%A9moc%2C%2006820%2C%20Mexico"
    pageTitle="Taqueria El Gran Abanico"
  />
);

export default TaqueriaElGranAbanico;
