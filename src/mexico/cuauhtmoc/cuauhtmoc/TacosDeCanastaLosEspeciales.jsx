...
const TacosDeCanastaLosEspeciales = () => (
  <RestaurantPage
    restaurantName="Tacos de Canasta Los Especiales"
    address="Av. Francisco I. Madero 71, Centro, Cuauhtémoc, 06000, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber=""
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/tacos-de-canasta-los-especiales"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="A line forms in the street for this taco spot just half a block off the Zócalo. Bring cash, then order at the small entrance where you'll be given tokens to give to the taquero to indicate how many tacos you've ordered. While the menu is limited (you'll choose from potato, beans, carne en adobo, and chicharrón with salsa verde), these are some of the least expensive tacos you can find, so go ahead and order with abandon.The line moves quickly and once you're inside, the dining room is deceptively large. Sit or stand, but don't skip the salsas, pickles, sliced cabbage, and guacamole to top off your tacos...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Francisco%20I.%20Madero%2071%2C%20Centro%2C%20Cuauht%C3%A9moc%2C%2006000%2C%20Mexico"
    pageTitle="Tacos de Canasta Los Especiales"
  />
);

export default TacosDeCanastaLosEspeciales;
