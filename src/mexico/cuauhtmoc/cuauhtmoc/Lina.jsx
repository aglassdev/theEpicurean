...
const Lina = () => (
  <RestaurantPage
    restaurantName="Lina"
    address="Av. Yucatán 147, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$$"
    phoneNumber="+525555747004"
    website="https://lina.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="With a welcoming vibe and an open kitchen, this quaint spot in Roma bursts with contemporary charm. The service is all heart here, where Chef Mariana Villegas Martínez draws on her experiences and travels to inspire her contemporary Mexican cooking. From the seasonal products highlighted to the harmony of flavors, this is cooking that shows great care and thoughtfulness. Far from flashy, it's straightforward but skillful, perhaps best seen in a plate of beautifully charred squash sided by a smoky pine nut sauce. Chicken with crispy skin is set with roasted peaches and a mushroom medley, but it's the rich mole coloradito that makes the dish especially memorable. Close out with a fruit-layered tres leches for a real treat...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Yucat%C3%A1n%20147%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Lina"
  />
);
