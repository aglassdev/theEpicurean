...
const La89 = () => (
  <RestaurantPage
    restaurantName="La 89"
    address="Colima 134, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525531126173"
    website="https://guide.michelin.com/en/ciudad-de-mexico/cuauhtemoc_1995126/restaurant/la-89"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="In beautiful Roma Norte, head to this brightly lit nook for an excellent selection of carne asada tacos, birria, and tortas. Nothing is rushed or done without care, as the kitchen takes its time grilling everything to order. Quesabirria is a winner with and without the delicate consommé. Carne asada features excellent sear and seasoning. Also not to be missed are the fantastic tortas, built on excellent bread and layered with precision. The sparse dining room is a simple affair of plastic stools and metal tables...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Colima%20134%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="La 89"
  />
);
