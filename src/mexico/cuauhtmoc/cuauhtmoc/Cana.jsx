...
const Cana = () => (
  <RestaurantPage
    restaurantName="Cana"
    address="Liverpool 9, Juárez, Cuauhtémoc, 06600, Mexico"
    cuisine="Contemporary, International"
    priceRange="$$"
    phoneNumber="+525579092913"
    website="https://canacdmx.com"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Light-filled with a classically elegant look, Cana is at once cozy and bustling with a bistro atmosphere that is inviting yet informal. Just right for date night, it's also a perfect pick for a night out with friends. No matter what you settle on, you're sure to have a pleasant experience here.The small menu of contemporary Mexican cuisine is based on seasonal and local produce with well-presented dishes ranging from croquetas de bacalao and arroz meloso con calamar y almejas to magret de pato, zanahorias y farro and cheesecake de camembert y compota de guayaba...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Liverpool%209%2C%20Ju%C3%A1rez%2C%20Cuauht%C3%A9moc%2C%2006600%2C%20Mexico"
    pageTitle="Cana"
  />
);
