...
const BellaAurora = () => (
  <RestaurantPage
    restaurantName="Bella Aurora"
    address="Puebla 242, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Italian"
    priceRange="$$$"
    phoneNumber="+525587906824"
    website="https://bellaaurora.mx/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This sister concept from the same people behind Rosetta and Lardo is a comforting spot for all-day dining in Roma Norte. From its pink exterior to its greenery-filled interior, Bella Aurora is cute and chic without a whisper of pretension. Come for breakfast, where the bakery items are the ones to beat, while at lunch and dinner the focus is on contemporary Italian fare. It's all good, executed with an attention to detail and great care. Begin with their pulpo, lightly pickled and tossed with potato for an enjoyable first course. Pasta is always a winner, especially the conchiglie tossed with tuna ragout with chili and Kalamata olives. Main dishes and pizza are also on offer, but with tiramisu to a cheese course with herb and blueberry focaccia, do save room for dessert...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Puebla%20242%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Bella Aurora"
  />
);

export default BellaAurora;
