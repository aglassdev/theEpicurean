...
const Limosneros = () => (
  <RestaurantPage
    restaurantName="Limosneros"
    address="Ignacio Allende 3, Centro, Cuauhtémoc, 06010, Mexico"
    cuisine="Mexican, Traditional Cuisine"
    priceRange="$$"
    phoneNumber="+525555215576"
    website="https://www.limosneros.com.mx"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Taking its name from the limosneros walls built in ancient times, this centrally located spot is perfectly poised for downtown dwellers and visitors. From the remnants of an old fountain in the entrance hall to the walls hung with mirrors from Tlayacapan, Puebla talavera, and Huichol embroidery, this place is loaded with charm. This kitchen has a clear respect for tradition, even reviving old recipes, but it's all done with an infusion of contemporary flair. Opt for the tasting menu and you'll be rewarded with a tour of their flavorful, well-prepared cuisine, or choose the unusual-but-intriguing taco tasting, which also includes a sweet offering...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Ignacio%20Allende%203%2C%20Centro%2C%20Cuauht%C3%A9moc%2C%2006010%2C%20Mexico"
    pageTitle="Limosneros"
  />
);

export default Limosneros;
