...
const TaqueriaLosParados = () => (
  <RestaurantPage
    restaurantName="Taqueria Los Parados"
    address="Av. Monterrey 333, Roma Sur, Cuauhtémoc, 06760, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525585960191"
    website="https://www.los-parados.com/"
    tags={[]}
    awards={[
    ...
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Av.%20Monterrey%20333%2C%20Roma%20Sur%2C%20Cuauht%C3%A9moc%2C%2006760%2C%20Mexico"
    pageTitle="Taqueria Los Parados"
  />
);

export default TaqueriaLosParados;
