...
const Martnez = () => (
  <RestaurantPage
    restaurantName="Martínez"
    address="Puebla 90, Roma Norte, Cuauhtémoc, 06700, Mexico"
    cuisine="Contemporary"
    priceRange="$$"
    phoneNumber="+525593550017"
    website="https://www.martinez.rest"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Chef/owner Lucho Martinez was inspired to open this eponymous restaurant by his daughter, Emilia, who once shared that her favorite thing to do in Paris was eat in the bistros with him. It sparked an idea—why not recreate that feeling right here in Mexico City—and Martinez is just that: a small restaurant with good food and wine.The ambience is young and bustling. Order at the bar and you'll get a sneak peek into the kitchen. The concise menu features a list of tasty dishes with nods to Mexican, French and even Japanese cuisine. Pollo a la parrilla is a main course hit, while chocolate cake with vanilla ice cream is spot on...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Puebla%2090%2C%20Roma%20Norte%2C%20Cuauht%C3%A9moc%2C%2006700%2C%20Mexico"
    pageTitle="Martínez"
  />
);

export default Martnez;
