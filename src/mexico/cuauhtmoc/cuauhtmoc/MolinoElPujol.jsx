...
const MolinoElPujol = () => (
  <RestaurantPage
    restaurantName="Molino El Pujol"
    address="Benjamín Hill, 146, Hipódromo Condesa, Cuauhtémoc, 06100, Mexico"
    cuisine="Mexican"
    priceRange="$"
    phoneNumber="+525543862283"
    website="https://pujol.com.mx/molino-el-pujol/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This small spot in La Condesa feels like a chic neighborhood place with polished concrete and white tiled walls. It saves most of its precious real estate for the kitchen though there is a wood counter with six seats along with an additional handful of seats outside. The concise menu is focused on items made from corn nixtamalized daily on-site (think tamales, tacos, chilaquiles, and enfrijoladas). There are also items to take home like the excellent tortillas—grab them warm if you are lucky. The tamal de calabaza is a freshly steamed orb of flavorful yellow masa studded with bits of tender pumpkin and plated with a petite salad dressed with candied pumpkin seeds...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Benjam%C3%ADn%20Hill%2C%20146%2C%20Hip%C3%B3dromo%20Condesa%2C%20Cuauht%C3%A9moc%2C%2006100%2C%20Mexico"
    pageTitle="Molino El Pujol"
  />
);

export default MolinoElPujol;
