...
const EsquinaComn = () => (
  <RestaurantPage
    restaurantName="Esquina Común"
    address="Fernando Montes De Oca, 86, Condesa, Cuauhtémoc, 06140, Mexico"
    cuisine="Mexican, Creative"
    priceRange="$$"
    phoneNumber=""
    website="https://www.instagram.com/esquinacomun?igsh=YzVjaTkzOGZzbjB5"
    tags={[]}
    awards={[
      { name: "Michelin Stars", count: 1, year: "2025", organization: "Guide Michelin" }
    ].filter(Boolean)}
    bio="The address may no longer be a secret, but reservations at this hot spot are closely guarded (and only available by direct messaging on Instagram). The covered rooftop setting is enhanced with bountiful greenery and a lovely, relaxed vibe.Chef Ana Dolores González and a young, talented team cook with plenty of personality and a solid foundation of strong technique and good ingredients. Styled like a tasting menu and portioned for two, these dishes are impressive. Items of note include the pescado del dia, which may be grilled cod set in a luscious green mole with crushed ripe plantain, fava beans, and pumpkin seeds. Staying on theme, the masa and plantain tamal de pescado is filled with chile red-tinted fish with a flavorful salsa macha...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Fernando%20Montes%20De%20Oca%2C%2086%2C%20Condesa%2C%20Cuauht%C3%A9moc%2C%2006140%2C%20Mexico"
    pageTitle="Esquina Común"
  />
);

export default EsquinaComn;
