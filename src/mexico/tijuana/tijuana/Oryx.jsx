...
const Oryx = () => (
  <RestaurantPage
    restaurantName="Oryx"
    address="Blvd. Agua Caliente 10750, Int. 84, Tijuana, 22015, Mexico"
    cuisine="Mexican, Contemporary"
    priceRange="$$"
    phoneNumber="+526647547562"
    website="https://oryxrestaurante.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="This Tijuana favorite is the domain of Chef Ruffo Ibarra. The dining room boasts a dressed-up industrial look with dark earthy colors, exposed red brick walls, wood and tiled flooring, metal beams and warm lighting.The menu is a contemporary take on Mexican cuisine and lists an extensive selection of items including chilled seafood starters and grilled steaks. Consomé de camarón con hongas is presented with chopped raw shrimp, then filled tableside with a hot, deeply flavorful shrimp broth which gently poaches the shrimp. Golden-brown, crisped striped bass shares the plate with creamy onion puree, bits of fried kale and some salsa verde. The stack of churros, served warm and accompanied by bourbon ice cream, make for a fine ending...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Blvd.%20Agua%20Caliente%2010750%2C%20Int.%2084%2C%20Tijuana%2C%2022015%2C%20Mexico"
    pageTitle="Oryx"
  />
);
