...
const Mision19 = () => (
  <RestaurantPage
    restaurantName="Mision 19"
    address="Via Corporativo, 2, Misión de San Javier 10643, Zona Urbana Rio, Tijuana, 22010, Mexico"
    cuisine="Mexican"
    priceRange="$$$"
    phoneNumber="+526646342493"
    website="https://mision19.com/"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Note: This restaurant is temporarily closed.The name is a reference to the 18 Catholic missions that exist in Baja California. Their mission is a bit more down-to-earth: To celebrate the area's food. Located on the second floor of Vía Corporativo, Mexico's second self-sustainable building, the restaurant strives for sustainability by utilizing products that do not travel more than 200km from farm to table. Noteworthy dishes include aguachile, featuring slivers of local rockot dressed with salsa verde and avocado puree. Lechon prensado is an enticing roasted pork plated with a zesty roasted tomatillo salsa as well as reduced pork jus. It is a feast in itself, perhaps best accompanied by a rich tinta from one of the Valle de Guadalupe labels on offer...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Via%20Corporativo%2C%202%2C%20Misi%C3%B3n%20de%20San%20Javier%2010643%2C%20Zona%20Urbana%20Rio%2C%20Tijuana%2C%2022010%2C%20Mexico"
    pageTitle="Mision 19"
  />
);

export default Mision19;
