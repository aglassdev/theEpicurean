...
const CarmelitaMolinoYCocina = () => (
  <RestaurantPage
    restaurantName="Carmelita Molino y Cocina"
    address="Jiménez 7771, Independencia, Tijuana, 22055, Mexico"
    cuisine="Mexican"
    priceRange="$$"
    phoneNumber="+526646861084"
    website="https://guide.michelin.com/en/baja-california/tijuana_2061688/restaurant/carmelita-molino-y-cocina"
    tags={[]}
    awards={[
      
    ].filter(Boolean)}
    bio="Named for Chef José Figueroa's grandmother, who inspired his love of cooking, this charming Tijuana dining room has an airy vibe with warm-toned wood furnishings, tile-and-concrete flooring, and a screen-covered roof. Corn is revered here and is sourced from small family farms around Mexico, then nixtamalized and ground in-house. Tortillas are prepared on the comal up front for the tacos and tostadas that comprise the menu, while ceviche, and egg dishes round it out. You can't go wrong with chilaquiles dressed with salsa borracha, but don't sleep on the tamal of the day. It's big, prepared in a banana leaf, and may be filled with braised beef rib and roasted local cherry tomatoes...."
    googleMapsEmbed="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=Jim%C3%A9nez%207771%2C%20Independencia%2C%20Tijuana%2C%2022055%2C%20Mexico"
    pageTitle="Carmelita Molino y Cocina"
  />
);

export default CarmelitaMolinoYCocina;
